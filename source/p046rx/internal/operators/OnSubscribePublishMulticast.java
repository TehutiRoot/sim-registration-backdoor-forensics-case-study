...
public final class OnSubscribePublishMulticast<T> extends AtomicInteger implements Observable.OnSubscribe<T>, Observer<T>, Subscription {
    ...
    /* loaded from: classes7.dex */
    public static final class C13493a extends Subscriber {

        /* renamed from: a */
        public final OnSubscribePublishMulticast f78042a;

        public C13493a(OnSubscribePublishMulticast onSubscribePublishMulticast) {
            this.f78042a = onSubscribePublishMulticast;
        }

        @Override // p046rx.Observer
        public void onCompleted() {
            this.f78042a.onCompleted();
        }

        @Override // p046rx.Observer
        public void onError(Throwable th2) {
            this.f78042a.onError(th2);
        }

        @Override // p046rx.Observer
        public void onNext(Object obj) {
            this.f78042a.onNext(obj);
        }

        @Override // p046rx.Subscriber, p046rx.observers.AssertableSubscriber
        public void setProducer(Producer producer) {
            this.f78042a.setProducer(producer);
        }
    }
