...
public final class OperatorZip<R> implements Observable.Operator<R, Observable<?>[]> {
    ...
    public static final class Zip<R> extends AtomicLong {
        ...
        /* loaded from: classes7.dex */
        public final class C13702a extends Subscriber {

            /* renamed from: a */
            public final RxRingBuffer f78926a = RxRingBuffer.getSpmcInstance();
        ...
        public void start(Observable[] observableArr, AtomicLong atomicLong) {
            ...
            for (int i = 0; i < observableArr.length; i++) {
                C13702a c13702a = new C13702a();
                objArr[i] = c13702a;
                this.childSubscription.add(c13702a);
            }
            this.requested = atomicLong;
            this.subscribers = objArr;
            for (int i2 = 0; i2 < observableArr.length; i2++) {
                observableArr[i2].unsafeSubscribe((C13702a) objArr[i2]);
            }
        }
            ...
            if (objArr != null && getAndIncrement() == 0) {
                ...
                while (true) {
                    ...
                    for (int i = 0; i < length; i++) {
                        RxRingBuffer rxRingBuffer = ((C13702a) objArr[i]).f78926a;
                    ...
                    if (z && atomicLong.get() > 0) {
                        try {
                            ...
                            for (Object obj : objArr) {
                                RxRingBuffer rxRingBuffer2 = ((C13702a) obj).f78926a;
                                rxRingBuffer2.poll();
                            ...
                            if (this.emitted > THRESHOLD) {
                                for (Object obj2 : objArr) {
                                    ((C13702a) obj2).requestMore(this.emitted);
                                }
                                this.emitted = 0;
                            }
                        } catch (Throwable th2) {
    ...
    public final class C13703a extends Subscriber {
        ...
        /* renamed from: a */
        public final Subscriber f78928a;

        /* renamed from: b */
        public final Zip f78929b;

        /* renamed from: c */
        public final ZipProducer f78930c;

        /* renamed from: d */
        public boolean f78931d;

        public C13703a(Subscriber subscriber, Zip zip, ZipProducer zipProducer) {
            this.f78928a = subscriber;
            this.f78929b = zip;
            this.f78930c = zipProducer;
        }
        ...
        public void onNext(Observable[] observableArr) {
            if (observableArr != null && observableArr.length != 0) {
                this.f78931d = true;
                this.f78929b.start(observableArr, this.f78930c);
                return;
            }
            this.f78928a.onCompleted();
        }
    ...
    public Subscriber<? super Observable[]> call(Subscriber<? super R> subscriber) {
        Zip zip = new Zip(subscriber, this.f78925a);
        ZipProducer zipProducer = new ZipProducer(zip);
        C13703a c13703a = new C13703a(subscriber, zip, zipProducer);
        subscriber.add(c13703a);
        subscriber.setProducer(zipProducer);
        return c13703a;
    }

    public OperatorZip(Func2 func2) {
        this.f78925a = Functions.fromFunc(func2);
    }

    public OperatorZip(Func3 func3) {
        this.f78925a = Functions.fromFunc(func3);
    }

    public OperatorZip(Func4 func4) {
        this.f78925a = Functions.fromFunc(func4);
    }

    public OperatorZip(Func5 func5) {
        this.f78925a = Functions.fromFunc(func5);
    }

    public OperatorZip(Func6 func6) {
        this.f78925a = Functions.fromFunc(func6);
    }

    public OperatorZip(Func7 func7) {
        this.f78925a = Functions.fromFunc(func7);
    }

    public OperatorZip(Func8 func8) {
        this.f78925a = Functions.fromFunc(func8);
    }

    public OperatorZip(Func9 func9) {
        this.f78925a = Functions.fromFunc(func9);
    }
}
