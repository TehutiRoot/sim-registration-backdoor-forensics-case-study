...
public final class EContextFormFragment extends OmiseFragment {
    ...
    @NotNull
    private final Lazy type$delegate = LazyKt__LazyJVMKt.lazy(new C5602l());
    @NotNull
    private final Lazy fullNameEdit$delegate = LazyKt__LazyJVMKt.lazy(new C5594d());
    @NotNull
    private final Lazy emailEdit$delegate = LazyKt__LazyJVMKt.lazy(new C5591a());
    @NotNull
    private final Lazy phoneNumberEdit$delegate = LazyKt__LazyJVMKt.lazy(new C5598h());
    @NotNull
    private final Lazy fullNameErrorText$delegate = LazyKt__LazyJVMKt.lazy(new C5595e());
    @NotNull
    private final Lazy emailErrorText$delegate = LazyKt__LazyJVMKt.lazy(new C5592b());
    @NotNull
    private final Lazy phoneNumberErrorText$delegate = LazyKt__LazyJVMKt.lazy(new C5599i());
    @NotNull
    private final Lazy submitButton$delegate = LazyKt__LazyJVMKt.lazy(new C5600j());
    @NotNull
    private final Lazy formInputWithErrorTexts$delegate = LazyKt__LazyJVMKt.lazy(new C5593c());

    @Metadata(m28851d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bR\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\t"}, m28850d2 = {"Lco/omise/android/ui/EContextFormFragment$Companion;", "", "()V", "EXTRA_ECONTEXT_TYPE", "", "newInstance", "Lco/omise/android/ui/EContextFormFragment;", "eContext", "Lco/omise/android/models/SupportedEcontext;", "sdk_productionRelease"}, m28849k = 1, m28848mv = {1, 7, 1}, m28846xi = 48)
    ...
    /* loaded from: classes3.dex */
    public static final class C5591a extends Lambda implements Function0 {
        ...
        public final OmiseEditText invoke() {
            return (OmiseEditText) EContextFormFragment.this._$_findCachedViewById(C5511R.C5514id.edit_email);
        }
    }

    /* renamed from: co.omise.android.ui.EContextFormFragment$b */
    /* loaded from: classes3.dex */
    public static final class C5592b extends Lambda implements Function0 {
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C5592b() {
            super(0);
            EContextFormFragment.this = r1;
        ...
        public final TextView invoke() {
            return (TextView) EContextFormFragment.this._$_findCachedViewById(C5511R.C5514id.text_email_error);
        }
    }

    /* renamed from: co.omise.android.ui.EContextFormFragment$c */
    /* loaded from: classes3.dex */
    public static final class C5593c extends Lambda implements Function0 {
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C5593c() {
            super(0);
            EContextFormFragment.this = r1;
    ...
    /* loaded from: classes3.dex */
    public static final class C5594d extends Lambda implements Function0 {
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C5594d() {
            super(0);
            EContextFormFragment.this = r1;
        ...
        /* renamed from: a */
        public final OmiseEditText invoke() {
            return (OmiseEditText) EContextFormFragment.this._$_findCachedViewById(C5511R.C5514id.edit_full_name);
        }
    }

    /* renamed from: co.omise.android.ui.EContextFormFragment$e */
    /* loaded from: classes3.dex */
    public static final class C5595e extends Lambda implements Function0 {
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C5595e() {
            super(0);
            EContextFormFragment.this = r1;
        ...
        /* renamed from: a */
        public final TextView invoke() {
            return (TextView) EContextFormFragment.this._$_findCachedViewById(C5511R.C5514id.text_full_name_error);
        }
    }

    /* renamed from: co.omise.android.ui.EContextFormFragment$f */
    /* loaded from: classes3.dex */
    public /* synthetic */ class C5596f extends FunctionReferenceImpl implements Function0 {
        public C5596f(Object obj) {
            super(0, obj, EContextFormFragment.class, "updateSubmitButton", "updateSubmitButton()V", 0);
        }

        /* renamed from: a */
        public final void m51200a() {
    ...
    /* loaded from: classes3.dex */
    public /* synthetic */ class C5597g extends FunctionReferenceImpl implements Function0 {
        public C5597g(Object obj) {
            super(0, obj, EContextFormFragment.class, "submitForm", "submitForm()V", 0);
        }

        /* renamed from: a */
        public final void m51199a() {
    ...
    /* loaded from: classes3.dex */
    public static final class C5598h extends Lambda implements Function0 {
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C5598h() {
            super(0);
            EContextFormFragment.this = r1;
        ...
        /* renamed from: a */
        public final OmiseEditText invoke() {
            return (OmiseEditText) EContextFormFragment.this._$_findCachedViewById(C5511R.C5514id.edit_phone_number);
        }
    }

    /* renamed from: co.omise.android.ui.EContextFormFragment$i */
    /* loaded from: classes3.dex */
    public static final class C5599i extends Lambda implements Function0 {
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C5599i() {
            super(0);
            EContextFormFragment.this = r1;
        ...
        /* renamed from: a */
        public final TextView invoke() {
            return (TextView) EContextFormFragment.this._$_findCachedViewById(C5511R.C5514id.text_phone_number_error);
        }
    }

    /* renamed from: co.omise.android.ui.EContextFormFragment$j */
    /* loaded from: classes3.dex */
    public static final class C5600j extends Lambda implements Function0 {
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C5600j() {
            super(0);
            EContextFormFragment.this = r1;
        ...
        public final Button invoke() {
            return (Button) EContextFormFragment.this._$_findCachedViewById(C5511R.C5514id.button_submit);
        }
    }

    /* renamed from: co.omise.android.ui.EContextFormFragment$k */
    /* loaded from: classes3.dex */
    public static final class C5601k extends Lambda implements Function1 {
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C5601k() {
            super(1);
            EContextFormFragment.this = r1;
        ...
        /* renamed from: a */
        public final void m51195a(Object obj) {
        ...
        public /* bridge */ /* synthetic */ Object invoke(Object obj) {
            m51195a(((Result) obj).m74096unboximpl());
            return Unit.INSTANCE;
        }
    }
    ...
    /* loaded from: classes3.dex */
    public static final class C5602l extends Lambda implements Function0 {
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C5602l() {
            super(0);
            EContextFormFragment.this = r1;
    ...
    /* renamed from: m */
    public static /* synthetic */ void m51206m(EContextFormFragment eContextFormFragment, View view, boolean z) {
    ...
    public final void submitForm() {
        ...
        paymentCreatorRequester.request(build, new C5601k());
    }
            ...
            if (Intrinsics.areEqual(pair.getFirst(), omiseEditText)) {
                ...
                if (!z && !omiseEditText.isValid()) {
                    if (Intrinsics.areEqual(omiseEditText, getFullNameEdit())) {
                        string = getString(C5511R.C5518string.error_invalid_full_name);
                    } else if (Intrinsics.areEqual(omiseEditText, getEmailEdit())) {
                        string = getString(C5511R.C5518string.error_invalid_email);
                    } else if (Intrinsics.areEqual(omiseEditText, getPhoneNumberEdit())) {
                        string = getString(C5511R.C5518string.error_invalid_phone_number);
                    } else {
                        string = getString(C5511R.C5518string.error_unknown_without_reason);
                    }
    ...
    public final void updateSubmitButton() {
        ...
        ArrayList arrayList = new ArrayList(AbstractC10176es.collectionSizeOrDefault(formInputWithErrorTexts, 10));
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        return inflater.inflate(C5511R.C5515layout.fragment_econtext_form, viewGroup, false);
    }
    ...
    public void onViewCreated(@NotNull View view, @Nullable Bundle bundle) {
        ...
        if (Intrinsics.areEqual(type, SupportedEcontext.ConvenienceStore.INSTANCE)) {
            string = getString(C5511R.C5518string.title_convenience_store);
        } else if (Intrinsics.areEqual(type, SupportedEcontext.PayEasy.INSTANCE)) {
            string = getString(C5511R.C5518string.title_pay_easy);
        } else if (Intrinsics.areEqual(type, SupportedEcontext.Netbanking.INSTANCE)) {
            string = getString(C5511R.C5518string.title_netbank);
        } else if (type == null) {
            string = getString(C5511R.C5518string.econtext_title);
        } else {
        ...
        while (it.hasNext()) {
            Pair pair = (Pair) it.next();
            ((OmiseEditText) pair.getFirst()).setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: ML
                {
                    EContextFormFragment.this = this;
                }

                @Override // android.view.View.OnFocusChangeListener
                public final void onFocusChange(View view2, boolean z) {
                    EContextFormFragment.m51206m(EContextFormFragment.this, view2, z);
                }
            });
            EditTextExtensionsKt.setOnAfterTextChangeListener((EditText) pair.getFirst(), new C5596f(this));
        }
        ViewExtensionsKt.setOnClickListener(getSubmitButton(), new C5597g(this));
    }
