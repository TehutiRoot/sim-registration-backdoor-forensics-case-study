...
public final class FpxEmailFormFragment extends OmiseFragment {
    ...
    @NotNull
    private final Lazy emailEdit$delegate = LazyKt__LazyJVMKt.lazy(new C5606a());
    @NotNull
    private final Lazy submitButton$delegate = LazyKt__LazyJVMKt.lazy(new C5609d());
    @NotNull
    private final String allowedEmailFormat = "\\A[\\w+\\-.]+@[a-z\\d\\-.]+\\.[a-z]{2,}\\z";

    /* renamed from: co.omise.android.ui.FpxEmailFormFragment$a */
    /* loaded from: classes3.dex */
    public static final class C5606a extends Lambda implements Function0 {
        public C5606a() {
            super(0);
        }
        ...
        public final OmiseEditText invoke() {
            return (OmiseEditText) FpxEmailFormFragment.this._$_findCachedViewById(C5511R.C5514id.edit_email);
        }
    }

    /* renamed from: co.omise.android.ui.FpxEmailFormFragment$b */
    /* loaded from: classes3.dex */
    public /* synthetic */ class C5607b extends FunctionReferenceImpl implements Function0 {
        public C5607b(Object obj) {
            super(0, obj, FpxEmailFormFragment.class, "updateSubmitButton", "updateSubmitButton()V", 0);
        }

        /* renamed from: a */
        public final void m51190a() {
    ...
    /* loaded from: classes3.dex */
    public /* synthetic */ class C5608c extends FunctionReferenceImpl implements Function0 {
        public C5608c(Object obj) {
            super(0, obj, FpxEmailFormFragment.class, "submitForm", "submitForm()V", 0);
        }

        /* renamed from: a */
        public final void m51189a() {
    ...
    /* loaded from: classes3.dex */
    public static final class C5609d extends Lambda implements Function0 {
        public C5609d() {
            super(0);
        }
        ...
        public final Button invoke() {
            return (Button) FpxEmailFormFragment.this._$_findCachedViewById(C5511R.C5514id.button_submit);
        }
    }
    ...
    */
    public final void submitForm() {
        ...
        L14:
            ...
            boolean r3 = p000.AbstractC20204hN1.equals$default(r3, r6, r4, r5, r1)
            if (r3 == 0) goto L14
            goto L31
        L30:
            r2 = r1
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        return inflater.inflate(C5511R.C5515layout.fragment_fpx_email_form, viewGroup, false);
    }
    ...
    public void onViewCreated(@NotNull View view, @Nullable Bundle bundle) {
        ...
        EditTextExtensionsKt.setOnAfterTextChangeListener(getEmailEdit(), new C5607b(this));
        ViewExtensionsKt.setOnClickListener(getSubmitButton(), new C5608c(this));
    }
