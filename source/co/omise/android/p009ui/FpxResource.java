...
@Metadata(m28851d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\r\b\u0000\u0018\u0000 \u00142\u00020\u0001:\u0001\u0014B=\u0012\b\b\u0001\u0010\u0002\u001a\u00020\u0003\u0012\n\b\u0002\u0010\u0004\u001a\u0004\u0018\u00010\u0005\u0012\b\b\u0003\u0010\u0006\u001a\u00020\u0003\u0012\n\b\u0002\u0010\u0007\u001a\u0004\u0018\u00010\b\u0012\n\b\u0002\u0010\t\u001a\u0004\u0018\u00010\u0005¢\u0006\u0002\u0010\nR\u0013\u0010\t\u001a\u0004\u0018\u00010\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\fR\u0018\u0010\u0007\u001a\u0004\u0018\u00010\bX\u0096\u0004¢\u0006\n\n\u0002\u0010\u000f\u001a\u0004\b\r\u0010\u000eR\u0014\u0010\u0002\u001a\u00020\u0003X\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0010\u0010\u0011R\u0014\u0010\u0006\u001a\u00020\u0003X\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0012\u0010\u0011R\u0016\u0010\u0004\u001a\u0004\u0018\u00010\u0005X\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0013\u0010\f¨\u0006\u0015"}, m28850d2 = {"Lco/omise/android/ui/FpxResource;", "Lco/omise/android/ui/OmiseListItem;", "iconRes", "", MessageBundle.TITLE_ENTRY, "", "indicatorIconRes", "enabled", "", "bankCode", "(ILjava/lang/String;ILjava/lang/Boolean;Ljava/lang/String;)V", "getBankCode", "()Ljava/lang/String;", "getEnabled", "()Ljava/lang/Boolean;", "Ljava/lang/Boolean;", "getIconRes", "()Ljava/lang/Integer;", "getIndicatorIconRes", "getTitle", "Companion", "sdk_productionRelease"}, m28849k = 1, m28848mv = {1, 7, 1}, m28846xi = 48)
/* renamed from: co.omise.android.ui.FpxResource */
/* loaded from: classes3.dex */
public final class FpxResource implements OmiseListItem {
    @NotNull
    ...
    @Metadata(m28851d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\b\u001a\u00020\t2\b\u0010\n\u001a\u0004\u0018\u00010\u000bR\u0017\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048F¢\u0006\u0006\u001a\u0004\b\u0006\u0010\u0007¨\u0006\f"}, m28850d2 = {"Lco/omise/android/ui/FpxResource$Companion;", "", "()V", "all", "", "Lco/omise/android/ui/FpxResource;", "getAll", "()Ljava/util/List;", "getBankImageFromCode", "", "code", "", "sdk_productionRelease"}, m28849k = 1, m28848mv = {1, 7, 1}, m28846xi = 48)
    /* renamed from: co.omise.android.ui.FpxResource$Companion */
    /* loaded from: classes3.dex */
    public static final class Companion {
        ...
        @NotNull
        public final List<FpxResource> getAll() {
            FpxResource fpxResource;
            Collection<KClass<?>> nestedClasses = Reflection.getOrCreateKotlinClass(FpxResource.class).getNestedClasses();
            ArrayList arrayList = new ArrayList();
            Iterator<T> it = nestedClasses.iterator();
            while (it.hasNext()) {
                Object objectInstance = ((KClass) it.next()).getObjectInstance();
                if (objectInstance instanceof FpxResource) {
                    fpxResource = (FpxResource) objectInstance;
                } else {
                    fpxResource = null;
                }
                if (fpxResource != null) {
                    arrayList.add(fpxResource);
                }
            }
            return arrayList;
        }
        ...
        public final int getBankImageFromCode(@Nullable String str) {
            if (str != null) {
                switch (str.hashCode()) {
                    ...
                    case 3029367:
                        if (str.equals("bocm")) {
                            return C5511R.C5513drawable.payment_bocm;
                        }
                        break;
                    case 3053691:
                        if (str.equals("cimb")) {
    ...
    public FpxResource(@DrawableRes int i, @Nullable String str, @DrawableRes int i2, @Nullable Boolean bool, @Nullable String str2) {
        this.iconRes = i;
        this.title = str;
    ...
    public /* synthetic */ FpxResource(int i, String str, int i2, Boolean bool, String str2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(i, (i3 & 2) != 0 ? null : str, (i3 & 4) != 0 ? C5511R.C5513drawable.ic_redirect : i2, (i3 & 8) != 0 ? Boolean.FALSE : bool, (i3 & 16) != 0 ? null : str2);
    }
}
