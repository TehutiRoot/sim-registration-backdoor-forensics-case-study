...
@Metadata(m28851d1 = {"\u0000,\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\u0002\u001a#\u0010\u0000\u001a\u0004\u0018\u00010\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u0082@ø\u0001\u0000¢\u0006\u0002\u0010\u0006\u001a4\u0010\u0007\u001a\u00020\b*\u00020\u00032\u0006\u0010\t\u001a\u00020\u00052\f\u0010\n\u001a\b\u0012\u0004\u0012\u00020\u00010\u000b2\b\b\u0002\u0010\f\u001a\u00020\r2\b\b\u0002\u0010\u000e\u001a\u00020\r\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\u000f"}, m28850d2 = {"retrieveToken", "Lco/omise/android/models/Token;", "client", "Lco/omise/android/api/Client;", "tokenID", "", "(Lco/omise/android/api/Client;Ljava/lang/String;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "observeTokenUntilChargeStatusChanged", "", "id", ServiceSpecificExtraArgs.CastExtraArgs.LISTENER, "Lco/omise/android/api/RequestListener;", "interval", "", "timeout", "sdk_productionRelease"}, m28849k = 2, m28848mv = {1, 7, 1}, m28846xi = 48)
/* loaded from: classes.dex */
public final class ClientExtensionsKt {

    /* renamed from: co.omise.android.extensions.ClientExtensionsKt$a */
    /* loaded from: classes.dex */
    public static final class C5521a extends SuspendLambda implements Function2 {
        ...
        /* renamed from: c */
        final /* synthetic */ long f40235c;

        /* renamed from: d */
        final /* synthetic */ RequestListener f40236d;

        /* renamed from: e */
        final /* synthetic */ long f40237e;

        /* renamed from: f */
        final /* synthetic */ Client f40238f;
        ...
        /* loaded from: classes.dex */
        public static final class C5522a extends SuspendLambda implements Function2 {

            /* renamed from: a */
            int f40240a;

            /* renamed from: b */
            final /* synthetic */ Deferred f40241b;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C5522a(Deferred deferred, Continuation continuation) {
                super(2, continuation);
                this.f40241b = deferred;
            }

            @Override // kotlin.jvm.functions.Function2
            /* renamed from: a */
            public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
                return ((C5522a) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation create(Object obj, Continuation continuation) {
                return new C5522a(this.f40241b, continuation);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i != 0) {
                    ...
                    ResultKt.throwOnFailure(obj);
                    Deferred deferred = this.f40241b;
                    this.f40240a = 1;
        ...
        /* loaded from: classes.dex */
        public static final class C5523b extends SuspendLambda implements Function2 {
            ...
            /* renamed from: c */
            final /* synthetic */ Ref.BooleanRef f40244c;

            /* renamed from: d */
            final /* synthetic */ long f40245d;

            /* renamed from: e */
            final /* synthetic */ Ref.ObjectRef f40246e;

            /* renamed from: f */
            final /* synthetic */ Client f40247f;

            /* renamed from: g */
            final /* synthetic */ String f40248g;

            /* renamed from: h */
            final /* synthetic */ RequestListener f40249h;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C5523b(Ref.BooleanRef booleanRef, long j, Ref.ObjectRef objectRef, Client client, String str, RequestListener requestListener, Continuation continuation) {
                super(2, continuation);
                this.f40244c = booleanRef;
                this.f40245d = j;
                this.f40246e = objectRef;
                this.f40247f = client;
                this.f40248g = str;
                this.f40249h = requestListener;
            }

            @Override // kotlin.jvm.functions.Function2
            /* renamed from: a */
            public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
                return ((C5523b) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation create(Object obj, Continuation continuation) {
                return new C5523b(this.f40244c, this.f40245d, this.f40246e, this.f40247f, this.f40248g, this.f40249h, continuation);
            }
            ...
            */
            public final java.lang.Object invokeSuspend(java.lang.Object r9) {
                /*
                    ...
                    if (r2 == r4) goto L20
                    if (r2 != r3) goto L18
                    java.lang.Object r2 = r8.f40242a
                ...
                L24:
                    kotlin.ResultKt.throwOnFailure(r9)
                L27:
                    kotlin.jvm.internal.Ref$BooleanRef r9 = r8.f40244c
                ...
                L30:
                    ...
                    return r1
                L3d:
                    kotlin.jvm.internal.Ref$ObjectRef r2 = r8.f40246e
                    co.omise.android.api.Client r9 = r8.f40247f
                    java.lang.String r6 = r8.f40248g
                    r8.f40242a = r2
                    r8.f40243b = r3
                ...
                L4e:
                    r2.element = r9
                    kotlin.jvm.internal.Ref$ObjectRef r9 = r8.f40246e
                    T r9 = r9.element
                    if (r9 == 0) goto L27
                ...
                L72:
                    ...
                    if (r9 == 0) goto L87
                    co.omise.android.api.RequestListener r0 = r8.f40249h
                    r0.onRequestSucceed(r9)
                    kotlin.Unit r5 = kotlin.Unit.INSTANCE
                L87:
                    return r5
                */
                throw new UnsupportedOperationException("Method not decompiled: co.omise.android.extensions.ClientExtensionsKt.C5521a.C5523b.invokeSuspend(java.lang.Object):java.lang.Object");
            }
        }

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C5521a(long j, RequestListener requestListener, long j2, Client client, String str, Continuation continuation) {
            super(2, continuation);
            this.f40235c = j;
            this.f40236d = requestListener;
            this.f40237e = j2;
            this.f40238f = client;
            this.f40239g = str;
        }
        ...
        /* renamed from: a */
        public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
            return ((C5521a) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation create(Object obj, Continuation continuation) {
            C5521a c5521a = new C5521a(this.f40235c, this.f40236d, this.f40237e, this.f40238f, this.f40239g, continuation);
            c5521a.f40234b = obj;
            return c5521a;
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r14) {
            /*
                ...
                if (r1 == 0) goto L1d
                if (r1 != r2) goto L15
                java.lang.Object r0 = r13.f40234b
            ...
            L1d:
                ...
                java.lang.Object r14 = r13.f40234b
                r3 = r14
                ...
                long r6 = r13.f40237e
                co.omise.android.api.Client r9 = r13.f40238f
                java.lang.String r10 = r13.f40239g
                co.omise.android.api.RequestListener r11 = r13.f40236d
                r12 = 0
                r4 = r1
                r8 = r14
                ...
                long r3 = r13.f40235c     // Catch: kotlinx.coroutines.TimeoutCancellationException -> L5d
                ...
                r13.f40234b = r14     // Catch: kotlinx.coroutines.TimeoutCancellationException -> L5d
                r13.f40233a = r2     // Catch: kotlinx.coroutines.TimeoutCancellationException -> L5d
            ...
            L5f:
                ...
                if (r14 == 0) goto L6a
                co.omise.android.api.RequestListener r0 = r13.f40236d
                r0.onRequestSucceed(r14)
            L6a:
                kotlin.Unit r14 = kotlin.Unit.INSTANCE
                return r14
            */
            throw new UnsupportedOperationException("Method not decompiled: co.omise.android.extensions.ClientExtensionsKt.C5521a.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }

    /* renamed from: co.omise.android.extensions.ClientExtensionsKt$b */
    /* loaded from: classes.dex */
    public static final class C5524b extends ContinuationImpl {
        ...
        public C5524b(Continuation continuation) {
            super(continuation);
        }
    ...
    public static final void observeTokenUntilChargeStatusChanged(@NotNull Client client, @NotNull String id2, @NotNull RequestListener<Token> listener, long j, long j2) {
        ...
        AbstractC1552Vc.m65753e(GlobalScope.INSTANCE, null, null, new C5521a(j2, listener, j, client, id2, null), 3, null);
    }
    ...
    */
    public static final java.lang.Object retrieveToken(co.omise.android.api.Client r4, java.lang.String r5, kotlin.coroutines.Continuation<? super co.omise.android.models.Token> r6) {
        /*
            boolean r0 = r6 instanceof co.omise.android.extensions.ClientExtensionsKt.C5524b
            if (r0 == 0) goto L13
            r0 = r6
            co.omise.android.extensions.ClientExtensionsKt$b r0 = (co.omise.android.extensions.ClientExtensionsKt.C5524b) r0
            int r1 = r0.f40251b
        ...
        L13:
            ...
            r0.<init>(r6)
        L18:
            java.lang.Object r6 = r0.f40250a
            java.lang.Object r1 = p000.AbstractC18812Yf0.getCOROUTINE_SUSPENDED()
            int r2 = r0.f40251b
            r3 = 1
            if (r2 == 0) goto L35
        ...
        L35:
            ...
            r0.f40251b = r3     // Catch: java.lang.Throwable -> L29 co.omise.android.models.APIError -> L2b
