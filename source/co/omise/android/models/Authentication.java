...
public final class Authentication implements Model {
    ...
    public static final class AuthenticationRequestBuilder extends RequestBuilder<Authentication> {
        ...
        @Metadata(m28851d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u000e\n\u0002\u0010\u000b\n\u0002\b\u0004\b\u0086\b\u0018\u00002\u00020\u0001B%\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0003\u0012\u0006\u0010\u0007\u001a\u00020\b¢\u0006\u0002\u0010\tJ\t\u0010\u0011\u001a\u00020\u0003HÆ\u0003J\t\u0010\u0012\u001a\u00020\u0005HÆ\u0003J\t\u0010\u0013\u001a\u00020\u0003HÆ\u0003J\t\u0010\u0014\u001a\u00020\bHÆ\u0003J1\u0010\u0015\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u00052\b\b\u0002\u0010\u0006\u001a\u00020\u00032\b\b\u0002\u0010\u0007\u001a\u00020\bHÆ\u0001J\u0013\u0010\u0016\u001a\u00020\u00172\b\u0010\u0018\u001a\u0004\u0018\u00010\u0001HÖ\u0003J\t\u0010\u0019\u001a\u00020\bHÖ\u0001J\t\u0010\u001a\u001a\u00020\u0003HÖ\u0001R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000bR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\f\u0010\rR\u0011\u0010\u0007\u001a\u00020\b¢\u0006\b\n\u0000\u001a\u0004\b\u000e\u0010\u000fR\u0011\u0010\u0006\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0010\u0010\u000b¨\u0006\u001b"}, m28850d2 = {"Lco/omise/android/models/Authentication$AuthenticationRequestBuilder$AReq;", "", "sdkAppID", "", "sdkEphemPubKey", "Lco/omise/android/models/Authentication$AuthenticationRequestBuilder$SdkEphemPubKey;", "sdkTransID", "sdkMaxTimeout", "", "(Ljava/lang/String;Lco/omise/android/models/Authentication$AuthenticationRequestBuilder$SdkEphemPubKey;Ljava/lang/String;I)V", "getSdkAppID", "()Ljava/lang/String;", "getSdkEphemPubKey", "()Lco/omise/android/models/Authentication$AuthenticationRequestBuilder$SdkEphemPubKey;", "getSdkMaxTimeout", "()I", "getSdkTransID", "component1", "component2", "component3", "component4", "copy", "equals", "", "other", "hashCode", "toString", "sdk_productionRelease"}, m28849k = 1, m28848mv = {1, 7, 1}, m28846xi = 48)
        /* loaded from: classes3.dex */
        ...
        public static final class SdkEphemPubKey {
            ...
            public static /* synthetic */ SdkEphemPubKey copy$default(SdkEphemPubKey sdkEphemPubKey, String str, String str2, String str3, String str4, int i, Object obj) {
                ...
                if ((i & 2) != 0) {
                    str2 = sdkEphemPubKey.f40253x;
                }
                if ((i & 4) != 0) {
                    str3 = sdkEphemPubKey.f40254y;
                }
                if ((i & 8) != 0) {
            ...
            public boolean equals(@Nullable Object obj) {
                ...
                if (obj instanceof SdkEphemPubKey) {
                    ...
                    return Intrinsics.areEqual(this.kty, sdkEphemPubKey.kty) && Intrinsics.areEqual(this.f40253x, sdkEphemPubKey.f40253x) && Intrinsics.areEqual(this.f40254y, sdkEphemPubKey.f40254y) && Intrinsics.areEqual(this.crv, sdkEphemPubKey.crv);
                }
                return false;
            }
            ...
            public int hashCode() {
                String str = this.kty;
                int hashCode = (str == null ? 0 : str.hashCode()) * 31;
                String str2 = this.f40253x;
                int hashCode2 = (hashCode + (str2 == null ? 0 : str2.hashCode())) * 31;
                String str3 = this.f40254y;
                int hashCode3 = (hashCode2 + (str3 == null ? 0 : str3.hashCode())) * 31;
            ...
            @NotNull
            public String toString() {
                return "SdkEphemPubKey(kty=" + this.kty + ", x=" + this.f40253x + ", y=" + this.f40254y + ", crv=" + this.crv + CoreConstants.RIGHT_PARENTHESIS_CHAR;
            }
    ...
    @Metadata(m28851d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0000\n\u0002\u0010\u000e\n\u0002\b\n\b\u0086\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u001b\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\n\b\u0002\u0010\u0004\u001a\u0004\u0018\u00010\u0003¢\u0006\u0002\u0010\u0005R\u0013\u0010\u0004\u001a\u0004\u0018\u00010\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\b\u0010\u0007j\u0002\b\tj\u0002\b\nj\u0002\b\u000bj\u0002\b\f¨\u0006\r"}, m28850d2 = {"Lco/omise/android/models/Authentication$AuthenticationStatus;", "", "value", "", "message", "(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V", "getMessage", "()Ljava/lang/String;", "getValue", "SUCCESS", Constant.QueryTransactionStatus.FAILED, "CHALLENGE_V1", "CHALLENGE", "sdk_productionRelease"}, m28849k = 1, m28848mv = {1, 7, 1}, m28846xi = 48)
    /* loaded from: classes3.dex */
