...
public final class GooglePay {
    ...
    public GooglePay(@NotNull String pKey, @NotNull ArrayList<String> cardNetworks, long j, @NotNull String currencyCode, @NotNull String merchantId, boolean z, boolean z2) {
        ...
        this.allowedCardAuthMethods = new JSONArray((Collection) AbstractC10108ds.listOf("PAN_ONLY"));
    ...
    private final JSONArray allowedCardNetworks() {
        HashMap hashMapOf = AbstractC11687a.hashMapOf(TuplesKt.m28844to("American Express", "AMEX"), TuplesKt.m28844to("JCB", "JCB"), TuplesKt.m28844to("MasterCard", "MASTERCARD"), TuplesKt.m28844to("Visa", "VISA"));
    ...
    private final JSONObject gatewayTokenizationSpecification() {
        ...
        jSONObject.put("parameters", new JSONObject(AbstractC11687a.mapOf(TuplesKt.m28844to("gateway", this.gateway), TuplesKt.m28844to("gatewayMerchantId", this.pKey))));
        return jSONObject;
    }
    ...
    private final boolean isTestMode() {
        return AbstractC20204hN1.startsWith$default(this.pKey, "pkey_test_", false, 2, null);
    }
