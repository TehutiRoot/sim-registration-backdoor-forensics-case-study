...
public final class CompressorRegistry {
    ...
    /* renamed from: b */
    public static final CompressorRegistry f63127b = new CompressorRegistry(new Codec.Gzip(), Codec.Identity.NONE);

    /* renamed from: a */
    public final ConcurrentMap f63128a = new ConcurrentHashMap();

    public CompressorRegistry(Compressor... compressorArr) {
        for (Compressor compressor : compressorArr) {
            this.f63128a.put(compressor.getMessageEncoding(), compressor);
        }
    }
    ...
    public Compressor lookupCompressor(String str) {
        return (Compressor) this.f63128a.get(str);
    }
    ...
    public void register(Compressor compressor) {
        ...
        this.f63128a.put(messageEncoding, compressor);
    }
}
