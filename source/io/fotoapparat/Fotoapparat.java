...
public final class Fotoapparat {
    ...
    /* renamed from: g */
    public static final CameraExecutor f62897g = new CameraExecutor(null, 1, null);

    /* renamed from: a */
    public final CameraExecutor f62898a;

    /* renamed from: b */
    public final Logger f62899b;

    /* renamed from: c */
    public final Function1 f62900c;

    /* renamed from: d */
    public final Display f62901d;

    /* renamed from: e */
    public final Device f62902e;

    /* renamed from: f */
    public final Lazy f62903f;

    @Metadata(m28851d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n¢\u0006\u0002\b\u0004"}, m28850d2 = {"<anonymous>", "", "it", "Lio/fotoapparat/exception/camera/CameraException;", "invoke"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
    /* renamed from: io.fotoapparat.Fotoapparat$1 */
    /* loaded from: classes5.dex */
    public static final class C104921 extends Lambda implements Function1<CameraException, Unit> {
        public static final C104921 INSTANCE = new C104921();
    ...
    @Metadata(m28851d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0007R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\t"}, m28850d2 = {"Lio/fotoapparat/Fotoapparat$Companion;", "", "()V", "EXECUTOR", "Lio/fotoapparat/concurrent/CameraExecutor;", JsonPOJOBuilder.DEFAULT_WITH_PREFIX, "Lio/fotoapparat/FotoapparatBuilder;", CoreConstants.CONTEXT_SCOPE_VALUE, "Landroid/content/Context;", "fotoapparat_release"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    /* loaded from: classes5.dex */
    ...
    /* renamed from: a */
    public final OrientationSensor m30566a() {
        return (OrientationSensor) this.f62903f.getValue();
    }

    @NotNull
    public final Fotoapparat autoFocus() {
        this.f62899b.recordMethod();
        focus();
        return this;
    }
    ...
    public final PendingResult<FocusResult> focus() {
        this.f62899b.recordMethod();
        return PendingResult.Companion.fromFuture$fotoapparat_release(this.f62898a.execute(new CameraExecutor.Operation(true, new Fotoapparat$focus$future$1(this.f62902e))), this.f62899b);
    }

    @NotNull
    public final PendingResult<Capabilities> getCapabilities() {
        this.f62899b.recordMethod();
        return PendingResult.Companion.fromFuture$fotoapparat_release(this.f62898a.execute(new CameraExecutor.Operation(true, new Fotoapparat$getCapabilities$future$1(this.f62902e))), this.f62899b);
    }

    @NotNull
    public final PendingResult<CameraParameters> getCurrentParameters() {
        this.f62899b.recordMethod();
        return PendingResult.Companion.fromFuture$fotoapparat_release(this.f62898a.execute(new CameraExecutor.Operation(true, new Fotoapparat$getCurrentParameters$future$1(this.f62902e))), this.f62899b);
    }
    ...
    public final boolean isAvailable(@NotNull Function1<? super Iterable<? extends LensPosition>, ? extends LensPosition> selector) {
        ...
        return this.f62902e.canSelectCamera(selector);
    }

    @NotNull
    public final Future<Unit> setZoom(@FloatRange(from = 0.0d, m64743to = 1.0d) float f) {
        return this.f62898a.execute(new CameraExecutor.Operation(true, new Fotoapparat$setZoom$1(this, f)));
    }

    public final void start() {
        this.f62899b.recordMethod();
        this.f62898a.execute(new CameraExecutor.Operation(false, new Fotoapparat$start$1(this), 1, null));
    }

    public final void stop() {
        this.f62899b.recordMethod();
        this.f62898a.cancelTasks();
        this.f62898a.execute(new CameraExecutor.Operation(false, new Fotoapparat$stop$1(this), 1, null));
    }
    ...
    public final void switchTo(@NotNull Function1<? super Iterable<? extends LensPosition>, ? extends LensPosition> lensPosition, @NotNull CameraConfiguration cameraConfiguration) {
        ...
        this.f62899b.recordMethod();
        this.f62898a.execute(new CameraExecutor.Operation(true, new Fotoapparat$switchTo$1(this, lensPosition, cameraConfiguration)));
    }

    @NotNull
    public final PhotoResult takePicture() {
        this.f62899b.recordMethod();
        return PhotoResult.Companion.fromFuture$fotoapparat_release(this.f62898a.execute(new CameraExecutor.Operation(true, new Fotoapparat$takePicture$future$1(this.f62902e))), this.f62899b);
    }

    @NotNull
    public final Future<Unit> updateConfiguration(@NotNull Configuration newConfiguration) {
        Intrinsics.checkNotNullParameter(newConfiguration, "newConfiguration");
        return this.f62898a.execute(new CameraExecutor.Operation(true, new Fotoapparat$updateConfiguration$1(this, newConfiguration)));
    }
    ...
    public Fotoapparat(@NotNull Context context, @NotNull CameraRenderer view, @Nullable FocalPointSelector focalPointSelector, @NotNull Function1<? super Iterable<? extends LensPosition>, ? extends LensPosition> lensPosition, @NotNull ScaleType scaleType, @NotNull CameraConfiguration cameraConfiguration, @NotNull Function1<? super CameraException, Unit> cameraErrorCallback, @NotNull CameraExecutor executor, @NotNull Logger logger) {
        ...
        this.f62898a = executor;
        this.f62899b = logger;
        this.f62900c = ErrorCallbacksKt.onMainThread(cameraErrorCallback);
        Display display = new Display(context);
        this.f62901d = display;
        this.f62902e = new Device(logger, display, scaleType, view, focalPointSelector, executor, 0, cameraConfiguration, lensPosition, 64, null);
        this.f62903f = LazyKt__LazyJVMKt.lazy(new Fotoapparat$orientationSensor$2(context, this));
        logger.recordMethod();
    }
    ...
    public /* synthetic */ Fotoapparat(Context context, CameraRenderer cameraRenderer, FocalPointSelector focalPointSelector, Function1 function1, ScaleType scaleType, CameraConfiguration cameraConfiguration, Function1 function12, CameraExecutor cameraExecutor, Logger logger, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, cameraRenderer, (i & 4) != 0 ? null : focalPointSelector, (i & 8) != 0 ? SelectorsKt.firstAvailable(LensPositionSelectorsKt.back(), LensPositionSelectorsKt.front(), LensPositionSelectorsKt.external()) : function1, (i & 16) != 0 ? ScaleType.CenterCrop : scaleType, (i & 32) != 0 ? CameraConfiguration.Companion.m74065default() : cameraConfiguration, (i & 64) != 0 ? C104921.INSTANCE : function12, (i & 128) != 0 ? f62897g : cameraExecutor, (i & 256) != 0 ? LoggersKt.none() : logger);
    }
}
