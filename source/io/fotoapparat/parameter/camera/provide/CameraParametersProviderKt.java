...
public final class CameraParametersProviderKt {
    /* renamed from: a */
    public static final int m30511a(Function1 function1, IntRange intRange) {
    ...
    /* renamed from: b */
    public static final Object m30510b(Function1 function1, Set set) {
        if (function1 != null) {
    ...
    /* renamed from: c */
    public static final Function1 m30509c(Resolution resolution, Function1 function1) {
    ...
    public static final CameraParameters getCameraParameters(@NotNull Capabilities capabilities, @NotNull CameraConfiguration cameraConfiguration) {
        ...
        if (invoke != null) {
            if (pictureResolutions.contains(invoke)) {
                ...
                Function1 m30509c = m30509c(resolution, cameraConfiguration.getPreviewResolution());
                    ...
                    if (flashModes.contains(invoke2)) {
                        ...
                        if (invoke3 != null) {
                            if (focusModes.contains(invoke3)) {
                                ...
                                int m30511a = m30511a(cameraConfiguration.getJpegQuality(), capabilities.getJpegQualityRange());
                                int m30511a2 = m30511a(cameraConfiguration.getExposureCompensation(), capabilities.getExposureCompensationRange());
                                    ...
                                    if (previewFpsRanges.contains(invoke4)) {
                                        ...
                                        if (invoke5 != null) {
                                            if (antiBandingModes.contains(invoke5)) {
                                                ...
                                                Parameter parameter = (Parameter) m30509c.invoke(previewResolutions);
                                                if (parameter != null) {
                                                    if (previewResolutions.contains(parameter)) {
                                                        return new CameraParameters(flash, focusMode2, m30511a, m30511a2, fpsRange, antiBandingMode2, (Integer) m30510b(cameraConfiguration.getSensorSensitivity(), capabilities.getSensorSensitivities()), resolution, (Resolution) parameter);
                                                    }
