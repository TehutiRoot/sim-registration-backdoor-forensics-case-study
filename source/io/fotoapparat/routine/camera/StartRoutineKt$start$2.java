...
@Metadata(m28851d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n¢\u0006\u0002\b\u0004"}, m28850d2 = {"<anonymous>", "", "focalRequest", "Lio/fotoapparat/hardware/metering/FocalRequest;", "invoke"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
...
public final class StartRoutineKt$start$2 extends Lambda implements Function1<FocalRequest, Unit> {
    ...
    @Metadata(m28851d1 = {"\u0000\b\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001H\n¢\u0006\u0002\b\u0002"}, m28850d2 = {"<anonymous>", "Lio/fotoapparat/result/FocusResult;", "invoke"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
    /* renamed from: io.fotoapparat.routine.camera.StartRoutineKt$start$2$1 */
    /* loaded from: classes5.dex */
    public static final class C104971 extends Lambda implements Function0<FocusResult> {
        final /* synthetic */ FocalRequest $focalRequest;
        final /* synthetic */ Device $this_start;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C104971(Device device2, FocalRequest focalRequest) {
            super(0);
    ...
    public final void invoke2(@NotNull FocalRequest focalRequest) {
        ...
        this.$this_start.getExecutor$fotoapparat_release().execute(new CameraExecutor.Operation(true, new C104971(this.$this_start, focalRequest)));
    }
}
