...
public final class Fotoapparat$setZoom$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ float $zoomLevel;
    final /* synthetic */ Fotoapparat this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public Fotoapparat$setZoom$1(Fotoapparat fotoapparat, float f) {
        super(0);
    ...
    public final void invoke2() {
        Logger logger;
        Device device2;
        logger = this.this$0.f62899b;
        logger.recordMethod();
        device2 = this.this$0.f62902e;
        UpdateZoomLevelRoutineKt.updateZoomLevel(device2, this.$zoomLevel);
    }
}
