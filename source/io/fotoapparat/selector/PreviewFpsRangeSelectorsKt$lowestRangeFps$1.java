...
public final class PreviewFpsRangeSelectorsKt$lowestRangeFps$1 extends Lambda implements Function1<Iterable<? extends FpsRange>, FpsRange> {
    ...
    public final FpsRange invoke2(@NotNull Iterable<FpsRange> iterable) {
        ...
        return (FpsRange) CollectionsKt___CollectionsKt.minWithOrNull(iterable, CompareFpsRangeByBounds.INSTANCE);
    }
