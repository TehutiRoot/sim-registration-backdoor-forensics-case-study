...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u00012\n\u0010\u0002\u001a\u0006\u0012\u0002\b\u00030\u0003H\n¢\u0006\u0004\b\u0004\u0010\u0005"}, m28850d2 = {"<anonymous>", "", "it", "Ljava/util/concurrent/Future;", "invoke", "(Ljava/util/concurrent/Future;)Ljava/lang/Boolean;"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
...
public final class CameraExecutor$cleanUpCancelledTasks$1 extends Lambda implements Function1<Future<?>, Boolean> {
    ...
    public final Boolean invoke(@NotNull Future<?> it) {
        ...
        m30558d = this.this$0.m30558d(it);
        return Boolean.valueOf(!m30558d);
    }
}
