...
public final class AwaitBroadcastChannel<T> implements BroadcastChannel<T>, Deferred<Boolean> {
    ...
    public ChildHandle attachChild(@NotNull ChildJob child) {
        ...
        return this.f62956b.attachChild(child);
    }

    @Override // kotlinx.coroutines.Deferred
    @Nullable
    public Object await(@NotNull Continuation<? super Boolean> continuation) {
        return this.f62956b.await(continuation);
    }
    ...
    public boolean close(@Nullable Throwable th2) {
        return this.f62955a.close(th2);
    }

    @Override // kotlin.coroutines.CoroutineContext.Element, kotlin.coroutines.CoroutineContext
    public <R> R fold(R r, @NotNull Function2<? super R, ? super CoroutineContext.Element, ? extends R> operation) {
        Intrinsics.checkNotNullParameter(operation, "operation");
        return (R) this.f62956b.fold(r, operation);
    }
    ...
    public CancellationException getCancellationException() {
        return this.f62956b.getCancellationException();
    }

    @Override // kotlinx.coroutines.Job
    @NotNull
    public Sequence<Job> getChildren() {
        return this.f62956b.getChildren();
    }
    ...
    public Boolean getCompleted() {
        return (Boolean) this.f62956b.getCompleted();
    }
    ...
    public Throwable getCompletionExceptionOrNull() {
        return this.f62956b.getCompletionExceptionOrNull();
    }

    @Override // kotlin.coroutines.CoroutineContext.Element
    @NotNull
    public CoroutineContext.Key<?> getKey() {
        return this.f62956b.getKey();
    }

    @Override // kotlinx.coroutines.Deferred
    @NotNull
    public SelectClause1<Boolean> getOnAwait() {
        return (SelectClause1<T>) this.f62956b.getOnAwait();
    }

    @Override // kotlinx.coroutines.Job
    @NotNull
    public SelectClause0 getOnJoin() {
        return this.f62956b.getOnJoin();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    @NotNull
    public SelectClause2<T, SendChannel<T>> getOnSend() {
        return this.f62955a.getOnSend();
    }
    ...
    */
    public final java.lang.Object getValue(@org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super T> r5) {
        ...
        L35:
            kotlin.ResultKt.throwOnFailure(r5)
            kotlinx.coroutines.CompletableDeferred r5 = r4.f62956b
            r0.L$0 = r4
            r0.label = r3
        ...
        L45:
            r0 = r4
        L46:
            kotlinx.coroutines.channels.ConflatedBroadcastChannel r5 = r0.f62955a
    ...
    public void invokeOnClose(@NotNull Function1<? super Throwable, Unit> handler) {
        ...
        this.f62955a.invokeOnClose(handler);
    }
    ...
    public DisposableHandle invokeOnCompletion(@NotNull Function1<? super Throwable, Unit> handler) {
        Intrinsics.checkNotNullParameter(handler, "handler");
        return this.f62956b.invokeOnCompletion(handler);
    }

    @Override // kotlinx.coroutines.Job
    public boolean isActive() {
        return this.f62956b.isActive();
    }

    @Override // kotlinx.coroutines.Job
    public boolean isCancelled() {
        return this.f62956b.isCancelled();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    public boolean isClosedForSend() {
        return this.f62955a.isClosedForSend();
    }

    @Override // kotlinx.coroutines.Job
    public boolean isCompleted() {
        return this.f62956b.isCompleted();
    }

    @Override // kotlinx.coroutines.Job
    @Nullable
    public Object join(@NotNull Continuation<? super Unit> continuation) {
        return this.f62956b.join(continuation);
    }
    ...
    public CoroutineContext minusKey(@NotNull CoroutineContext.Key<?> key) {
        Intrinsics.checkNotNullParameter(key, "key");
        return this.f62956b.minusKey(key);
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    public boolean offer(T t) {
        this.f62956b.complete(Boolean.TRUE);
        return ChannelResult.m74684isSuccessimpl(this.f62955a.mo74066trySendJP2dKIU(t));
    }

    @Override // kotlinx.coroutines.channels.BroadcastChannel
    @NotNull
    public ReceiveChannel<T> openSubscription() {
        return this.f62955a.openSubscription();
    }
    ...
    public CoroutineContext plus(@NotNull CoroutineContext context) {
        ...
        return this.f62956b.plus(context);
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    @Nullable
    public Object send(T t, @NotNull Continuation<? super Unit> continuation) {
        this.f62956b.complete(Boxing.boxBoolean(true));
        Object send = this.f62955a.send(t, continuation);
    ...
    public boolean start() {
        return this.f62956b.start();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    @NotNull
    /* renamed from: trySend-JP2dKIU  reason: not valid java name */
    public Object mo74066trySendJP2dKIU(T t) {
        return this.f62955a.mo74066trySendJP2dKIU(t);
    }
    ...
    public AwaitBroadcastChannel(@NotNull ConflatedBroadcastChannel<T> channel, @NotNull CompletableDeferred<Boolean> deferred) {
        ...
        this.f62955a = channel;
        this.f62956b = deferred;
    }

    @Override // kotlinx.coroutines.channels.BroadcastChannel, kotlinx.coroutines.Job
    public void cancel(@Nullable CancellationException cancellationException) {
        this.f62955a.cancel(cancellationException);
        this.f62956b.cancel(cancellationException);
    }
    ...
    public DisposableHandle invokeOnCompletion(boolean z, boolean z2, @NotNull Function1<? super Throwable, Unit> handler) {
        Intrinsics.checkNotNullParameter(handler, "handler");
        return this.f62956b.invokeOnCompletion(z, z2, handler);
    }
    ...
    public Job plus(@NotNull Job other) {
        ...
        return this.f62956b.plus(other);
    }

    @Override // kotlinx.coroutines.channels.BroadcastChannel, kotlinx.coroutines.Job
    public /* synthetic */ boolean cancel(Throwable th2) {
        JobKt.cancel(this.f62956b, (th2 == null || (r1 = th2.getMessage()) == null) ? "" : "", th2);
        return this.f62955a.close(th2);
    }
