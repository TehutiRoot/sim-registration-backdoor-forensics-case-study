...
public abstract class Single<T> implements SingleSource<T> {
    ...
    /* renamed from: b */
    public static Single m30104b(Flowable flowable) {
    ...
    public static <T> Single<T> fromFuture(Future<? extends T> future) {
        return m30104b(Flowable.fromFuture(future));
    }
    ...
    /* renamed from: a */
    public final Single m30106a(long j, TimeUnit timeUnit, Scheduler scheduler, SingleSource singleSource) {
    ...
    @CheckReturnValue
    /* renamed from: as */
    public final <R> R m30105as(@NonNull SingleConverter<T, ? extends R> singleConverter) {
    ...
    public final Single<T> timeout(long j, TimeUnit timeUnit) {
        return m30106a(j, timeUnit, Schedulers.computation(), null);
    }

    @SchedulerSupport(SchedulerSupport.NONE)
    @CheckReturnValue
    /* renamed from: to */
    public final <R> R m30103to(Function<? super Single<T>, R> function) {
        try {
    ...
    public static <T> Single<T> fromFuture(Future<? extends T> future, long j, TimeUnit timeUnit) {
        return m30104b(Flowable.fromFuture(future, j, timeUnit));
    }
    ...
    public final Single<T> retry(long j) {
        return m30104b(toFlowable().retry(j));
    }
    ...
    public final Single<T> timeout(long j, TimeUnit timeUnit, Scheduler scheduler) {
        return m30106a(j, timeUnit, scheduler, null);
    }
    ...
    public static <T> Single<T> fromFuture(Future<? extends T> future, long j, TimeUnit timeUnit, Scheduler scheduler) {
        return m30104b(Flowable.fromFuture(future, j, timeUnit, scheduler));
    }
    ...
    public final Single<T> retry(BiPredicate<? super Integer, ? super Throwable> biPredicate) {
        return m30104b(toFlowable().retry(biPredicate));
    }
    ...
    public final Single<T> timeout(long j, TimeUnit timeUnit, Scheduler scheduler, SingleSource<? extends T> singleSource) {
        ObjectHelper.requireNonNull(singleSource, "other is null");
        return m30106a(j, timeUnit, scheduler, singleSource);
    }
    ...
    public static <T> Single<T> fromFuture(Future<? extends T> future, Scheduler scheduler) {
        return m30104b(Flowable.fromFuture(future, scheduler));
    }
    ...
    public final Single<T> retry(long j, Predicate<? super Throwable> predicate) {
        return m30104b(toFlowable().retry(j, predicate));
    }
    ...
    public final Single<T> retry(Predicate<? super Throwable> predicate) {
        return m30104b(toFlowable().retry(predicate));
    }
    ...
    public final Single<T> timeout(long j, TimeUnit timeUnit, SingleSource<? extends T> singleSource) {
        ObjectHelper.requireNonNull(singleSource, "other is null");
        return m30106a(j, timeUnit, Schedulers.computation(), singleSource);
    }
