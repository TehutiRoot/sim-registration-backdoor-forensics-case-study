...
public abstract class ParallelFlowable<T> {
    ...
    @NonNull
    /* renamed from: as */
    public final <R> R m29877as(@NonNull ParallelFlowableConverter<T, R> parallelFlowableConverter) {
    ...
    @NonNull
    /* renamed from: to */
    public final <U> U m29876to(@NonNull Function<? super ParallelFlowable<T>, U> function) {
        try {
