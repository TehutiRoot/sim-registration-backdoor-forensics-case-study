...
public abstract class Completable implements CompletableSource {
    ...
    /* renamed from: b */
    public static Completable m30123b(Publisher publisher, int i, boolean z) {
    ...
    /* renamed from: d */
    public static NullPointerException m30121d(Throwable th2) {
    ...
    /* renamed from: a */
    public final Completable m30125a(Consumer consumer, Consumer consumer2, Action action, Action action2, Action action3, Action action4) {
    ...
    @CheckReturnValue
    /* renamed from: as */
    public final <R> R m30124as(@NonNull CompletableConverter<? extends R> completableConverter) {
    ...
    /* renamed from: c */
    public final Completable m30122c(long j, TimeUnit timeUnit, Scheduler scheduler, CompletableSource completableSource) {
    ...
    public final Completable doAfterTerminate(Action action) {
        ...
        return m30125a(emptyConsumer, emptyConsumer2, action2, action2, action, action2);
    }
    ...
    public final Completable doOnComplete(Action action) {
        ...
        Consumer emptyConsumer2 = Functions.emptyConsumer();
        Action action2 = Functions.EMPTY_ACTION;
        return m30125a(emptyConsumer, emptyConsumer2, action, action2, action2, action2);
    }
    ...
    public final Completable doOnDispose(Action action) {
        ...
        Consumer emptyConsumer2 = Functions.emptyConsumer();
        Action action2 = Functions.EMPTY_ACTION;
        return m30125a(emptyConsumer, emptyConsumer2, action2, action2, action2, action);
    }
    ...
    public final Completable doOnError(Consumer<? super Throwable> consumer) {
        ...
        return m30125a(emptyConsumer, consumer, action, action, action, action);
    }
    ...
    public final Completable doOnSubscribe(Consumer<? super Disposable> consumer) {
        Consumer emptyConsumer = Functions.emptyConsumer();
        Action action = Functions.EMPTY_ACTION;
        return m30125a(consumer, emptyConsumer, action, action, action, action);
    }
    ...
    public final Completable doOnTerminate(Action action) {
        ...
        Consumer emptyConsumer2 = Functions.emptyConsumer();
        Action action2 = Functions.EMPTY_ACTION;
        return m30125a(emptyConsumer, emptyConsumer2, action2, action, action2, action2);
    }
    ...
    public final Completable timeout(long j, TimeUnit timeUnit) {
        return m30122c(j, timeUnit, Schedulers.computation(), null);
    }

    @SchedulerSupport(SchedulerSupport.NONE)
    @CheckReturnValue
    /* renamed from: to */
    public final <U> U m30120to(Function<? super Completable, U> function) {
        try {
    ...
    public final Completable timeout(long j, TimeUnit timeUnit, CompletableSource completableSource) {
        ObjectHelper.requireNonNull(completableSource, "other is null");
        return m30122c(j, timeUnit, Schedulers.computation(), completableSource);
    }
    ...
    public static Completable error(Throwable th2) {
        ...
        return RxJavaPlugins.onAssembly(new CompletableError(th2));
    }
    ...
    public static Completable merge(Publisher<? extends CompletableSource> publisher) {
        return m30123b(publisher, Integer.MAX_VALUE, false);
    }
    ...
    public static Completable mergeDelayError(Publisher<? extends CompletableSource> publisher) {
        return m30123b(publisher, Integer.MAX_VALUE, true);
    }
    ...
    public static Completable merge(Publisher<? extends CompletableSource> publisher, int i) {
        return m30123b(publisher, i, false);
    }
    ...
    public static Completable mergeDelayError(Publisher<? extends CompletableSource> publisher, int i) {
        return m30123b(publisher, i, true);
    }
    ...
    public final Completable timeout(long j, TimeUnit timeUnit, Scheduler scheduler) {
        return m30122c(j, timeUnit, scheduler, null);
    }
    ...
    public final Completable timeout(long j, TimeUnit timeUnit, Scheduler scheduler, CompletableSource completableSource) {
        ObjectHelper.requireNonNull(completableSource, "other is null");
        return m30122c(j, timeUnit, scheduler, completableSource);
    }
