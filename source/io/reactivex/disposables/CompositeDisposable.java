...
public final class CompositeDisposable implements Disposable, DisposableContainer {
    ...
    /* renamed from: a */
    public OpenHashSet f63816a;

    /* renamed from: b */
    public volatile boolean f63817b;

    public CompositeDisposable() {
    }

    /* renamed from: a */
    public void m30098a(OpenHashSet openHashSet) {
        Object[] keys;
        if (openHashSet == null) {
            return;
        }
    ...
    public boolean add(@NonNull Disposable disposable) {
        ...
        if (!this.f63817b) {
            synchronized (this) {
                try {
                    if (!this.f63817b) {
                        OpenHashSet openHashSet = this.f63816a;
                        if (openHashSet == null) {
                            openHashSet = new OpenHashSet();
                            this.f63816a = openHashSet;
                        }
    ...
    public CompositeDisposable(@NonNull Disposable... disposableArr) {
        ObjectHelper.requireNonNull(disposableArr, "disposables is null");
        this.f63816a = new OpenHashSet(disposableArr.length + 1);
        for (Disposable disposable : disposableArr) {
            ObjectHelper.requireNonNull(disposable, "A Disposable in the disposables array is null");
            this.f63816a.add(disposable);
        }
    }
