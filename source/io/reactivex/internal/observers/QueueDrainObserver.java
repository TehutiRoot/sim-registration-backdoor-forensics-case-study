...
public abstract class QueueDrainObserver<T, U, V> extends AbstractC20969lr1 implements Observer<T>, ObservableQueueDrain<U, V> {
    ...
    public final boolean enter() {
        if (this.f76785a.getAndIncrement() == 0) {
            return true;
        }
        return false;
    }
    ...
    public final boolean fastEnter() {
        if (this.f76785a.get() != 0 || !this.f76785a.compareAndSet(0, 1)) {
            return false;
        }
        return true;
    }
    ...
    public final int leave(int i) {
        return this.f76785a.addAndGet(i);
    }
}
