...
public enum NotificationLite {
    ...
    public static final class ErrorNotification implements Serializable {
        ...
        public boolean equals(Object obj) {
            if (obj instanceof ErrorNotification) {
                return ObjectHelper.equals(this.f66125e, ((ErrorNotification) obj).f66125e);
            }
            return false;
        }

        public int hashCode() {
            return this.f66125e.hashCode();
        }

        public String toString() {
            return "NotificationLite.Error[" + this.f66125e + "]";
        }
    }
    ...
    public static <T> boolean accept(Object obj, Subscriber<? super T> subscriber) {
        if (obj == COMPLETE) {
            ...
            subscriber.onError(((ErrorNotification) obj).f66125e);
            return true;
        } else {
    ...
    public static Throwable getError(Object obj) {
        return ((ErrorNotification) obj).f66125e;
    }
    ...
    public static <T> boolean accept(Object obj, Observer<? super T> observer) {
        if (obj == COMPLETE) {
            ...
            observer.onError(((ErrorNotification) obj).f66125e);
            return true;
        } else {
            observer.onNext(obj);
            return false;
