...
public final class ParallelFromPublisher<T> extends ParallelFlowable<T> {
    ...
    /* renamed from: a */
    public final Publisher f65778a;
    ...
    public static final class ParallelDispatcher<T> extends AtomicInteger implements FlowableSubscriber<T> {
        ...
        /* loaded from: classes5.dex */
        public final class C11102a implements Subscription {
            ...
            public void cancel() {
                if (ParallelDispatcher.this.requests.compareAndSet(this.f65781a + this.f65782b, 0L, 1L)) {
            ...
            public void request(long j) {
                ...
                if (SubscriptionHelper.validate(j)) {
                    ...
                    do {
                        j2 = atomicLongArray.get(this.f65781a);
                        if (j2 == Long.MAX_VALUE) {
                            return;
                        }
                    } while (!atomicLongArray.compareAndSet(this.f65781a, j2, BackpressureHelper.addCap(j2, j)));
                    if (ParallelDispatcher.this.subscriberCount.get() == this.f65782b) {
        ...
        public void setupSubscribers() {
            ...
            while (i < length && !this.cancelled) {
                ...
                subscriberArr[i].onSubscribe(new C11102a(i, length));
                i = i2;
            }
        }
    }
    ...
    public void subscribe(Subscriber<? super T>[] subscriberArr) {
        ...
        this.f65778a.subscribe(new ParallelDispatcher(subscriberArr, this.f65780c));
    }
}
