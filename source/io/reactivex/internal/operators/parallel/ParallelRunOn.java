...
public final class ParallelRunOn<T> extends ParallelFlowable<T> {
    ...
    /* renamed from: a */
    public final ParallelFlowable f65829a;

    /* renamed from: b */
    public final Scheduler f65830b;
    ...
    /* loaded from: classes5.dex */
    public final class C11109a implements SchedulerMultiWorkerSupport.WorkerCallback {

        /* renamed from: a */
        public final Subscriber[] f65832a;

        /* renamed from: b */
        public final Subscriber[] f65833b;

        public C11109a(Subscriber[] subscriberArr, Subscriber[] subscriberArr2) {
            this.f65832a = subscriberArr;
            this.f65833b = subscriberArr2;
        }

        @Override // io.reactivex.internal.schedulers.SchedulerMultiWorkerSupport.WorkerCallback
        public void onWorker(int i, Scheduler.Worker worker) {
            ParallelRunOn.this.m29930a(i, this.f65832a, this.f65833b, worker);
        }
    }

    public ParallelRunOn(ParallelFlowable<? extends T> parallelFlowable, Scheduler scheduler, int i) {
        this.f65829a = parallelFlowable;
        this.f65830b = scheduler;
        this.f65831c = i;
    }

    /* renamed from: a */
    public void m29930a(int i, Subscriber[] subscriberArr, Subscriber[] subscriberArr2, Scheduler.Worker worker) {
        Subscriber subscriber = subscriberArr[i];
        SpscArrayQueue spscArrayQueue = new SpscArrayQueue(this.f65831c);
        if (subscriber instanceof ConditionalSubscriber) {
            subscriberArr2[i] = new RunOnConditionalSubscriber((ConditionalSubscriber) subscriber, this.f65831c, spscArrayQueue, worker);
        } else {
            subscriberArr2[i] = new RunOnSubscriber(subscriber, this.f65831c, spscArrayQueue, worker);
        }
    }

    @Override // io.reactivex.parallel.ParallelFlowable
    public int parallelism() {
        return this.f65829a.parallelism();
    }
    ...
    public void subscribe(Subscriber<? super T>[] subscriberArr) {
        ...
        Scheduler scheduler = this.f65830b;
        if (scheduler instanceof SchedulerMultiWorkerSupport) {
            ((SchedulerMultiWorkerSupport) scheduler).createWorkers(length, new C11109a(subscriberArr, subscriberArr2));
        } else {
            for (int i = 0; i < length; i++) {
                m29930a(i, subscriberArr, subscriberArr2, this.f65830b.createWorker());
            }
        }
        this.f65829a.subscribe(subscriberArr2);
    }
}
