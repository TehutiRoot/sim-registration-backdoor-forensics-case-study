...
public final class FlowableSubscribeOn<T> extends AbstractC0567I {

    /* renamed from: b */
    public final Scheduler f64556b;
    ...
    public static final class SubscribeOnSubscriber<T> extends AtomicReference<Thread> implements FlowableSubscriber<T>, Subscription, Runnable {
        ...
        /* loaded from: classes5.dex */
        public static final class RunnableC10897a implements Runnable {

            /* renamed from: a */
            public final Subscription f64558a;

            /* renamed from: b */
            public final long f64559b;

            public RunnableC10897a(Subscription subscription, long j) {
                this.f64558a = subscription;
                this.f64559b = j;
            }

            @Override // java.lang.Runnable
            public void run() {
                this.f64558a.request(this.f64559b);
            }
        }
        ...
        public void requestUpstream(long j, Subscription subscription) {
            if (!this.nonScheduledRequests && Thread.currentThread() != get()) {
                this.worker.schedule(new RunnableC10897a(subscription, j));
            } else {
    ...
    public FlowableSubscribeOn(Flowable<T> flowable, Scheduler scheduler, boolean z) {
        super(flowable);
        this.f64556b = scheduler;
        this.f64557c = z;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super T> subscriber) {
        Scheduler.Worker createWorker = this.f64556b.createWorker();
        SubscribeOnSubscriber subscribeOnSubscriber = new SubscribeOnSubscriber(subscriber, createWorker, this.source, this.f64557c);
