...
public final class FlowableUsing<T, D> extends Flowable<T> {
    ...
    /* renamed from: b */
    public final Callable f64625b;

    /* renamed from: c */
    public final Function f64626c;

    /* renamed from: d */
    public final Consumer f64627d;
    ...
    public FlowableUsing(Callable<? extends D> callable, Function<? super D, ? extends Publisher<? extends T>> function, Consumer<? super D> consumer, boolean z) {
        this.f64625b = callable;
        this.f64626c = function;
        this.f64627d = consumer;
        this.f64628e = z;
    }
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        try {
            Object call = this.f64625b.call();
            try {
                ((Publisher) ObjectHelper.requireNonNull(this.f64626c.apply(call), "The sourceSupplier returned a null Publisher")).subscribe(new UsingSubscriber(subscriber, call, this.f64627d, this.f64628e));
            } catch (Throwable th2) {
                Exceptions.throwIfFatal(th2);
                try {
                    this.f64627d.accept(call);
