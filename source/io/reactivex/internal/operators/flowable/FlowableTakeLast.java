...
public final class FlowableTakeLast<T> extends AbstractC0567I {
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new TakeLastSubscriber(subscriber, this.f64569b));
    }
}
