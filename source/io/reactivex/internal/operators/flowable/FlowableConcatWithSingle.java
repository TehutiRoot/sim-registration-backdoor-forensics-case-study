...
public final class FlowableConcatWithSingle<T> extends AbstractC0567I {

    /* renamed from: b */
    public final SingleSource f64170b;
    ...
    public FlowableConcatWithSingle(Flowable<T> flowable, SingleSource<? extends T> singleSource) {
        super(flowable);
        this.f64170b = singleSource;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new ConcatWithSubscriber(subscriber, this.f64170b));
    }
}
