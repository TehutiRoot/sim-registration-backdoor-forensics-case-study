...
public final class FlowableOnBackpressureDrop<T> extends AbstractC0567I implements Consumer<T> {

    /* renamed from: b */
    public final Consumer f64407b;
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new BackpressureDropSubscriber(subscriber, this.f64407b));
    }

    public FlowableOnBackpressureDrop(Flowable<T> flowable, Consumer<? super T> consumer) {
        super(flowable);
        this.f64407b = consumer;
    }
}
