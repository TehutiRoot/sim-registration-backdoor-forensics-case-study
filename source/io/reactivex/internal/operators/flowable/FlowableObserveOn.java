...
public final class FlowableObserveOn<T> extends AbstractC0567I {

    /* renamed from: b */
    public final Scheduler f64396b;
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        Scheduler.Worker createWorker = this.f64396b.createWorker();
        if (subscriber instanceof ConditionalSubscriber) {
            this.source.subscribe((FlowableSubscriber<? super Object>) new ObserveOnConditionalSubscriber((ConditionalSubscriber) subscriber, createWorker, this.f64397c, this.f64398d));
        } else {
            this.source.subscribe((FlowableSubscriber<? super Object>) new ObserveOnSubscriber(subscriber, createWorker, this.f64397c, this.f64398d));
        }
    }
}
