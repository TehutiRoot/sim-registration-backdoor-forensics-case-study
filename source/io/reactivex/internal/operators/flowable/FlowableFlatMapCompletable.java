...
public final class FlowableFlatMapCompletable<T> extends AbstractC0567I {

    /* renamed from: b */
    public final Function f64280b;

    /* renamed from: c */
    public final int f64281c;
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new FlatMapCompletableMainSubscriber(subscriber, this.f64280b, this.f64282d, this.f64281c));
    }
}
