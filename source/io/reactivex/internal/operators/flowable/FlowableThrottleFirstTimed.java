...
public final class FlowableThrottleFirstTimed<T> extends AbstractC0567I {
    ...
    /* renamed from: d */
    public final Scheduler f64591d;
    ...
    public FlowableThrottleFirstTimed(Flowable<T> flowable, long j, TimeUnit timeUnit, Scheduler scheduler) {
        ...
        this.f64591d = scheduler;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new DebounceTimedSubscriber(new SerializedSubscriber(subscriber), this.f64589b, this.f64590c, this.f64591d.createWorker()));
    }
}
