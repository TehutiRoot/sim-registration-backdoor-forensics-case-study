...
public final class FlowableMapNotification<T, R> extends AbstractC0567I {

    /* renamed from: b */
    public final Function f64388b;

    /* renamed from: c */
    public final Function f64389c;

    /* renamed from: d */
    public final Callable f64390d;
    ...
    public FlowableMapNotification(Flowable<T> flowable, Function<? super T, ? extends R> function, Function<? super Throwable, ? extends R> function2, Callable<? extends R> callable) {
        super(flowable);
        this.f64388b = function;
        this.f64389c = function2;
        this.f64390d = callable;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super R> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new MapNotificationSubscriber(subscriber, this.f64388b, this.f64389c, this.f64390d));
    }
}
