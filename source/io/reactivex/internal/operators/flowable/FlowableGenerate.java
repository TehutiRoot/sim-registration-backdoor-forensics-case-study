...
public final class FlowableGenerate<T, S> extends Flowable<T> {
    ...
    /* renamed from: b */
    public final Callable f64311b;

    /* renamed from: c */
    public final BiFunction f64312c;

    /* renamed from: d */
    public final Consumer f64313d;
    ...
    public FlowableGenerate(Callable<S> callable, BiFunction<S, Emitter<T>, S> biFunction, Consumer<? super S> consumer) {
        this.f64311b = callable;
        this.f64312c = biFunction;
        this.f64313d = consumer;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super T> subscriber) {
        try {
            subscriber.onSubscribe(new GeneratorSubscription(subscriber, this.f64312c, this.f64313d, this.f64311b.call()));
        } catch (Throwable th2) {
            Exceptions.throwIfFatal(th2);
