...
public final class FlowableRangeLong extends Flowable<Long> {
    ...
    public void subscribeActual(Subscriber<? super Long> subscriber) {
        if (subscriber instanceof ConditionalSubscriber) {
            subscriber.onSubscribe(new RangeConditionalSubscription((ConditionalSubscriber) subscriber, this.f64441b, this.f64442c));
        } else {
            subscriber.onSubscribe(new RangeSubscription(subscriber, this.f64441b, this.f64442c));
        }
    }
}
