...
public final class FlowableDebounceTimed<T> extends AbstractC0567I {

    /* renamed from: b */
    public final long f64184b;

    /* renamed from: c */
    public final TimeUnit f64185c;

    /* renamed from: d */
    public final Scheduler f64186d;
    ...
    public FlowableDebounceTimed(Flowable<T> flowable, long j, TimeUnit timeUnit, Scheduler scheduler) {
        super(flowable);
        this.f64184b = j;
        this.f64185c = timeUnit;
        this.f64186d = scheduler;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new DebounceTimedSubscriber(new SerializedSubscriber(subscriber), this.f64184b, this.f64185c, this.f64186d.createWorker()));
    }
}
