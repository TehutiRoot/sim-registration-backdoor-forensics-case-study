...
public final class FlowableRetryWhen<T> extends AbstractC0567I {

    /* renamed from: b */
    public final Function f64495b;
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        ...
        try {
            Publisher publisher = (Publisher) ObjectHelper.requireNonNull(this.f64495b.apply(serialized), "handler returned a null Publisher");
