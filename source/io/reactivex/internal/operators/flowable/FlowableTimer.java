...
public final class FlowableTimer extends Flowable<Long> {
    ...
    /* renamed from: b */
    public final Scheduler f64614b;

    /* renamed from: c */
    public final long f64615c;

    /* renamed from: d */
    public final TimeUnit f64616d;
    ...
    public void subscribeActual(Subscriber<? super Long> subscriber) {
        ...
        timerSubscriber.setResource(this.f64614b.scheduleDirect(timerSubscriber, this.f64615c, this.f64616d));
    }
}
