...
public final class FlowableConcatWithCompletable<T> extends AbstractC0567I {

    /* renamed from: b */
    public final CompletableSource f64168b;

    public FlowableConcatWithCompletable(Flowable<T> flowable, CompletableSource completableSource) {
        super(flowable);
        this.f64168b = completableSource;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new ConcatWithSubscriber(subscriber, this.f64168b));
    }
