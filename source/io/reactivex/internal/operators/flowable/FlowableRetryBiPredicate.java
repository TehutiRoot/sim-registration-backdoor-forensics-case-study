...
public final class FlowableRetryBiPredicate<T> extends AbstractC0567I {

    /* renamed from: b */
    public final BiPredicate f64490b;
    ...
    public static final class RetryBiSubscriber<T> extends AtomicInteger implements FlowableSubscriber<T> {
        ...
        /* renamed from: sa */
        final SubscriptionArbiter f64491sa;
        ...
        public RetryBiSubscriber(Subscriber<? super T> subscriber, BiPredicate<? super Integer, ? super Throwable> biPredicate, SubscriptionArbiter subscriptionArbiter, Publisher<? extends T> publisher) {
            ...
            this.f64491sa = subscriptionArbiter;
        ...
        public void onSubscribe(Subscription subscription) {
            this.f64491sa.setSubscription(subscription);
        }

        public void subscribeNext() {
            if (getAndIncrement() == 0) {
                int i = 1;
                while (!this.f64491sa.isCancelled()) {
                    long j = this.produced;
                    if (j != 0) {
                        this.produced = 0L;
                        this.f64491sa.produced(j);
                    }
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        ...
        new RetryBiSubscriber(subscriber, this.f64490b, subscriptionArbiter, this.source).subscribeNext();
    }
}
