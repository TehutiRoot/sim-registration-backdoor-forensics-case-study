...
public final class FlowableOnBackpressureBufferStrategy<T> extends AbstractC0567I {

    /* renamed from: b */
    public final long f64403b;

    /* renamed from: c */
    public final Action f64404c;

    /* renamed from: d */
    public final BackpressureOverflowStrategy f64405d;
            ...
            synchronized (deque) {
                try {
                    ...
                    if (deque.size() == this.bufferSize) {
                        int i = C10875a.f64406a[this.strategy.ordinal()];
                        z2 = true;
                        if (i != 1) {
                            if (i == 2) {
                                deque.poll();
    ...
    /* loaded from: classes5.dex */
    public static /* synthetic */ class C10875a {
        ...
        static {
            ...
            try {
                f64406a[BackpressureOverflowStrategy.DROP_OLDEST.ordinal()] = 2;
    ...
    public FlowableOnBackpressureBufferStrategy(Flowable<T> flowable, long j, Action action, BackpressureOverflowStrategy backpressureOverflowStrategy) {
        ...
        this.f64403b = j;
        this.f64404c = action;
        this.f64405d = backpressureOverflowStrategy;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new OnBackpressureBufferStrategySubscriber(subscriber, this.f64404c, this.f64405d, this.f64403b));
    }
}
