...
public final class FlowableTake<T> extends AbstractC0567I {

    /* renamed from: b */
    public final long f64568b;
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new TakeSubscriber(subscriber, this.f64568b));
    }
}
