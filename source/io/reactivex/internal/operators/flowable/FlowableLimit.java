...
public final class FlowableLimit<T> extends AbstractC0567I {

    /* renamed from: b */
    public final long f64384b;
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new LimitSubscriber(subscriber, this.f64384b));
    }
}
