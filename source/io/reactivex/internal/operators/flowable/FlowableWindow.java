...
public final class FlowableWindow<T> extends AbstractC0567I {
    ...
    public void subscribeActual(Subscriber<? super Flowable<T>> subscriber) {
        ...
        if (j == j2) {
            this.source.subscribe((FlowableSubscriber<? super Object>) new WindowExactSubscriber(subscriber, this.f64629b, this.f64631d));
        } else if (j > j2) {
            this.source.subscribe((FlowableSubscriber<? super Object>) new WindowSkipSubscriber(subscriber, this.f64629b, this.f64630c, this.f64631d));
        } else {
            this.source.subscribe((FlowableSubscriber<? super Object>) new WindowOverlapSubscriber(subscriber, this.f64629b, this.f64630c, this.f64631d));
        }
    }
}
