...
public final class FlowableFlattenIterable<T, R> extends AbstractC0567I {

    /* renamed from: b */
    public final Function f64298b;
    ...
    public void subscribeActual(Subscriber<? super R> subscriber) {
        ...
        if (flowable instanceof Callable) {
            try {
                ...
                try {
                    FlowableFromIterable.subscribe(subscriber, ((Iterable) this.f64298b.apply(call)).iterator());
                    return;
                } catch (Throwable th2) {
        ...
        flowable.subscribe((FlowableSubscriber<? super Object>) new FlattenIterableSubscriber(subscriber, this.f64298b, this.f64299c));
    }
}
