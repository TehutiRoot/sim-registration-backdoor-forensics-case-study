...
public final class FlowableAny<T> extends AbstractC0567I {

    /* renamed from: b */
    public final Predicate f64041b;
    ...
    public FlowableAny(Flowable<T> flowable, Predicate<? super T> predicate) {
        super(flowable);
        this.f64041b = predicate;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super Boolean> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new AnySubscriber(subscriber, this.f64041b));
    }
}
