...
public final class FlowableReduce<T> extends AbstractC0567I {

    /* renamed from: b */
    public final BiFunction f64443b;
    ...
    public FlowableReduce(Flowable<T> flowable, BiFunction<T, T, T> biFunction) {
        super(flowable);
        this.f64443b = biFunction;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new ReduceSubscriber(subscriber, this.f64443b));
    }
}
