...
public final class FlowableConcatMap<T, R> extends AbstractC0567I {

    /* renamed from: b */
    public final Function f64148b;

    /* renamed from: c */
    public final int f64149c;

    /* renamed from: d */
    public final ErrorMode f64150d;

    /* loaded from: classes5.dex */
    public static abstract class BaseConcatMapSubscriber<T, R> extends AtomicInteger implements FlowableSubscriber<T>, InterfaceC10826b, Subscription {
        ...
        @Override // io.reactivex.internal.operators.flowable.FlowableConcatMap.InterfaceC10826b
    ...
    public static final class ConcatMapDelayed<T, R> extends BaseConcatMapSubscriber<T, R> {
                                ...
                                try {
                                    ...
                                    if (publisher instanceof Callable) {
                                        ...
                                        if (obj == null) {
                                            ...
                                            concatMapInner.setSubscription(new C10827c(obj, concatMapInner));
                                        }
                                    } else {
                                        this.active = true;
        ...
        @Override // io.reactivex.internal.operators.flowable.FlowableConcatMap.BaseConcatMapSubscriber, io.reactivex.internal.operators.flowable.FlowableConcatMap.InterfaceC10826b
                                    ...
                                    if (publisher instanceof Callable) {
                                        try {
                                            ...
                                            if (call == null) {
                                                ...
                                                this.active = true;
                                                ConcatMapInner<R> concatMapInner = this.inner;
                                                concatMapInner.setSubscription(new C10827c(call, concatMapInner));
                                            }
                                        } catch (Throwable th2) {
                                            Exceptions.throwIfFatal(th2);
                                            this.upstream.cancel();
    ...
    public static final class ConcatMapInner<R> extends SubscriptionArbiter implements FlowableSubscriber<R> {
        ...
        final InterfaceC10826b parent;
        long produced;

        public ConcatMapInner(InterfaceC10826b interfaceC10826b) {
            super(false);
            this.parent = interfaceC10826b;
        }
    ...
    /* loaded from: classes5.dex */
    public static /* synthetic */ class C10825a {
        ...
        static {
            ...
            try {
                f64151a[ErrorMode.END.ordinal()] = 2;
    ...
    /* loaded from: classes5.dex */
    public interface InterfaceC10826b {
        void innerComplete();
    ...
    /* loaded from: classes5.dex */
    public static final class C10827c implements Subscription {

        /* renamed from: a */
        public final Subscriber f64152a;
        ...
        public C10827c(Object obj, Subscriber subscriber) {
            this.f64153b = obj;
            this.f64152a = subscriber;
        }
        ...
        public void request(long j) {
            if (j > 0 && !this.f64154c) {
                this.f64154c = true;
                Subscriber subscriber = this.f64152a;
                subscriber.onNext(this.f64153b);
    ...
    public FlowableConcatMap(Flowable<T> flowable, Function<? super T, ? extends Publisher<? extends R>> function, int i, ErrorMode errorMode) {
        super(flowable);
        this.f64148b = function;
        this.f64149c = i;
        this.f64150d = errorMode;
    }
    ...
    public static <T, R> Subscriber<T> subscribe(Subscriber<? super R> subscriber, Function<? super T, ? extends Publisher<? extends R>> function, int i, ErrorMode errorMode) {
        int i2 = C10825a.f64151a[errorMode.ordinal()];
        if (i2 != 1) {
            if (i2 != 2) {
    ...
    public void subscribeActual(Subscriber<? super R> subscriber) {
        if (FlowableScalarXMap.tryScalarXMapSubscribe(this.source, subscriber, this.f64148b)) {
            return;
        }
        this.source.subscribe(subscribe(subscriber, this.f64148b, this.f64149c, this.f64150d));
    }
}
