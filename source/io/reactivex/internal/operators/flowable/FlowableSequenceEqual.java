...
public final class FlowableSequenceEqual<T> extends Flowable<Boolean> {
    ...
    /* renamed from: b */
    public final Publisher f64514b;

    /* renamed from: c */
    public final Publisher f64515c;

    /* renamed from: d */
    public final BiPredicate f64516d;

    /* renamed from: e */
    public final int f64517e;

    /* loaded from: classes5.dex */
    public static final class EqualCoordinator<T> extends DeferredScalarSubscription<Boolean> implements InterfaceC10892a {
    ...
    public static final class EqualSubscriber<T> extends AtomicReference<Subscription> implements FlowableSubscriber<T> {
        ...
        final int limit;
        final InterfaceC10892a parent;
        final int prefetch;
        long produced;
        volatile SimpleQueue<T> queue;
        int sourceMode;

        public EqualSubscriber(InterfaceC10892a interfaceC10892a, int i) {
            this.parent = interfaceC10892a;
            this.limit = i - (i >> 2);
            this.prefetch = i;
        }
    ...
    public FlowableSequenceEqual(Publisher<? extends T> publisher, Publisher<? extends T> publisher2, BiPredicate<? super T, ? super T> biPredicate, int i) {
        this.f64514b = publisher;
        this.f64515c = publisher2;
        this.f64516d = biPredicate;
        this.f64517e = i;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super Boolean> subscriber) {
        EqualCoordinator equalCoordinator = new EqualCoordinator(subscriber, this.f64517e, this.f64516d);
        subscriber.onSubscribe(equalCoordinator);
        equalCoordinator.subscribe(this.f64514b, this.f64515c);
    }
}
