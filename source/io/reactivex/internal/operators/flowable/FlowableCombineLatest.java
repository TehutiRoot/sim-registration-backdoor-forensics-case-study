...
public final class FlowableCombineLatest<T, R> extends Flowable<R> {
    ...
    /* renamed from: b */
    public final Publisher[] f64140b;

    /* renamed from: c */
    public final Iterable f64141c;

    /* renamed from: d */
    public final Function f64142d;

    /* renamed from: e */
    public final int f64143e;

    /* renamed from: f */
    public final boolean f64144f;
    ...
    /* loaded from: classes5.dex */
    public final class C10824a implements Function {
        public C10824a() {
        }

        @Override // io.reactivex.functions.Function
        public Object apply(Object obj) {
            return FlowableCombineLatest.this.f64142d.apply(new Object[]{obj});
        }
    }
    ...
    public FlowableCombineLatest(@NonNull Publisher<? extends T>[] publisherArr, @NonNull Function<? super Object[], ? extends R> function, int i, boolean z) {
        this.f64140b = publisherArr;
        this.f64141c = null;
        this.f64142d = function;
        this.f64143e = i;
        this.f64144f = z;
    }
    ...
    public void subscribeActual(Subscriber<? super R> subscriber) {
        int length;
        Publisher<? extends T>[] publisherArr = this.f64140b;
        if (publisherArr == null) {
            publisherArr = new Publisher[8];
            try {
                Iterator it = (Iterator) ObjectHelper.requireNonNull(this.f64141c.iterator(), "The iterator returned is null");
                length = 0;
                while (it.hasNext()) {
                    try {
                        try {
        ...
        if (i == 0) {
            ...
            publisherArr[0].subscribe(new FlowableMap.C10874b(subscriber, new C10824a()));
        } else {
            CombineLatestCoordinator combineLatestCoordinator = new CombineLatestCoordinator(subscriber, this.f64142d, i, this.f64143e, this.f64144f);
