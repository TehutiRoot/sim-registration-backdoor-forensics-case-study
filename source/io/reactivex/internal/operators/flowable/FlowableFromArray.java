...
public final class FlowableFromArray<T> extends Flowable<T> {
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        if (subscriber instanceof ConditionalSubscriber) {
            subscriber.onSubscribe(new ArrayConditionalSubscription((ConditionalSubscriber) subscriber, this.f64300b));
        } else {
            subscriber.onSubscribe(new ArraySubscription(subscriber, this.f64300b));
        }
    }
}
