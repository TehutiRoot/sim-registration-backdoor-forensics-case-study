...
public final class FlowableSkipLastTimed<T> extends AbstractC0567I {

    /* renamed from: b */
    public final long f64545b;

    /* renamed from: c */
    public final TimeUnit f64546c;

    /* renamed from: d */
    public final Scheduler f64547d;
    ...
    public FlowableSkipLastTimed(Flowable<T> flowable, long j, TimeUnit timeUnit, Scheduler scheduler, int i, boolean z) {
        super(flowable);
        this.f64545b = j;
        this.f64546c = timeUnit;
        this.f64547d = scheduler;
        this.f64548e = i;
        this.f64549f = z;
    }
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new SkipLastTimedSubscriber(subscriber, this.f64545b, this.f64546c, this.f64547d, this.f64548e, this.f64549f));
    }
}
