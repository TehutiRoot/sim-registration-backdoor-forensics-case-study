...
public final class FlowableConcatArray<T> extends Flowable<T> {
    ...
    /* renamed from: b */
    public final Publisher[] f64146b;
    ...
    public FlowableConcatArray(Publisher<? extends T>[] publisherArr, boolean z) {
        this.f64146b = publisherArr;
        this.f64147c = z;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super T> subscriber) {
        ConcatArraySubscriber concatArraySubscriber = new ConcatArraySubscriber(this.f64146b, this.f64147c, subscriber);
