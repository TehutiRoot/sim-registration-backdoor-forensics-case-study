...
public final class FlowableFlatMapCompletableCompletable<T> extends Completable implements FuseToFlowable<T> {
    ...
    /* renamed from: a */
    public final Flowable f64283a;

    /* renamed from: b */
    public final Function f64284b;
    ...
    public FlowableFlatMapCompletableCompletable(Flowable<T> flowable, Function<? super T, ? extends CompletableSource> function, boolean z, int i) {
        this.f64283a = flowable;
        this.f64284b = function;
        this.f64286d = z;
        this.f64285c = i;
    }
    ...
    public Flowable<T> fuseToFlowable() {
        return RxJavaPlugins.onAssembly(new FlowableFlatMapCompletable(this.f64283a, this.f64284b, this.f64286d, this.f64285c));
    }

    @Override // io.reactivex.Completable
    public void subscribeActual(CompletableObserver completableObserver) {
        this.f64283a.subscribe((FlowableSubscriber) new FlatMapCompletableMainSubscriber(completableObserver, this.f64284b, this.f64286d, this.f64285c));
    }
}
