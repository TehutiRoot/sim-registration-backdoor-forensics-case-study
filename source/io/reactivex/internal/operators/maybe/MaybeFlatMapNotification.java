...
public final class MaybeFlatMapNotification<T, R> extends AbstractC1716Y {

    /* renamed from: a */
    public final Function f64807a;

    /* renamed from: b */
    public final Function f64808b;

    /* renamed from: c */
    public final Callable f64809c;
    ...
    public static final class FlatMapMaybeObserver<T, R> extends AtomicReference<Disposable> implements MaybeObserver<T>, Disposable {
        ...
        /* loaded from: classes5.dex */
        public final class C10936a implements MaybeObserver {
            public C10936a() {
            }
        ...
        public void onComplete() {
            try {
                ((MaybeSource) ObjectHelper.requireNonNull(this.onCompleteSupplier.call(), "The onCompleteSupplier returned a null MaybeSource")).subscribe(new C10936a());
            } catch (Exception e) {
        ...
        public void onError(Throwable th2) {
            try {
                ((MaybeSource) ObjectHelper.requireNonNull(this.onErrorMapper.apply(th2), "The onErrorMapper returned a null MaybeSource")).subscribe(new C10936a());
            } catch (Exception e) {
                Exceptions.throwIfFatal(e);
        ...
        public void onSuccess(T t) {
            try {
                ((MaybeSource) ObjectHelper.requireNonNull(this.onSuccessMapper.apply(t), "The onSuccessMapper returned a null MaybeSource")).subscribe(new C10936a());
            } catch (Exception e) {
                Exceptions.throwIfFatal(e);
                this.downstream.onError(e);
            }
    ...
    public MaybeFlatMapNotification(MaybeSource<T> maybeSource, Function<? super T, ? extends MaybeSource<? extends R>> function, Function<? super Throwable, ? extends MaybeSource<? extends R>> function2, Callable<? extends MaybeSource<? extends R>> callable) {
        super(maybeSource);
        this.f64807a = function;
        this.f64808b = function2;
        this.f64809c = callable;
    }

    @Override // io.reactivex.Maybe
    public void subscribeActual(MaybeObserver<? super R> maybeObserver) {
        this.source.subscribe(new FlatMapMaybeObserver(maybeObserver, this.f64807a, this.f64808b, this.f64809c));
    }
}
