...
public final class MaybeFlatten<T, R> extends AbstractC1716Y {

    /* renamed from: a */
    public final Function f64819a;
    ...
    public static final class FlatMapMaybeObserver<T, R> extends AtomicReference<Disposable> implements MaybeObserver<T>, Disposable {
        ...
        /* loaded from: classes5.dex */
        public final class C10939a implements MaybeObserver {
            public C10939a() {
            }
        ...
        public void onSuccess(T t) {
            try {
                ...
                if (!isDisposed()) {
                    maybeSource.subscribe(new C10939a());
                }
            } catch (Exception e) {
    ...
    public void subscribeActual(MaybeObserver<? super R> maybeObserver) {
        this.source.subscribe(new FlatMapMaybeObserver(maybeObserver, this.f64819a));
    }
}
