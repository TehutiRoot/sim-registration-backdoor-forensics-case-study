...
public final class MaybeZipArray<T, R> extends Maybe<R> {
    ...
    /* renamed from: a */
    public final MaybeSource[] f64907a;

    /* renamed from: b */
    public final Function f64908b;
    ...
    /* loaded from: classes5.dex */
    public final class C10957a implements Function {
        public C10957a() {
        }

        @Override // io.reactivex.functions.Function
        public Object apply(Object obj) {
            return ObjectHelper.requireNonNull(MaybeZipArray.this.f64908b.apply(new Object[]{obj}), "The zipper returned a null value");
        }
    }

    public MaybeZipArray(MaybeSource<? extends T>[] maybeSourceArr, Function<? super Object[], ? extends R> function) {
        this.f64907a = maybeSourceArr;
        this.f64908b = function;
    }

    @Override // io.reactivex.Maybe
    public void subscribeActual(MaybeObserver<? super R> maybeObserver) {
        MaybeSource[] maybeSourceArr = this.f64907a;
        int length = maybeSourceArr.length;
        if (length == 1) {
            maybeSourceArr[0].subscribe(new MaybeMap.C10947a(maybeObserver, new C10957a()));
            return;
        }
        ZipCoordinator zipCoordinator = new ZipCoordinator(maybeObserver, length, this.f64908b);
