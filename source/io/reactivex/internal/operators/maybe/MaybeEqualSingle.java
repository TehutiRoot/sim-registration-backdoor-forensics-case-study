...
public final class MaybeEqualSingle<T> extends Single<Boolean> {
    ...
    /* renamed from: a */
    public final MaybeSource f64776a;

    /* renamed from: b */
    public final MaybeSource f64777b;

    /* renamed from: c */
    public final BiPredicate f64778c;
    ...
    public MaybeEqualSingle(MaybeSource<? extends T> maybeSource, MaybeSource<? extends T> maybeSource2, BiPredicate<? super T, ? super T> biPredicate) {
        this.f64776a = maybeSource;
        this.f64777b = maybeSource2;
        this.f64778c = biPredicate;
    }

    @Override // io.reactivex.Single
    public void subscribeActual(SingleObserver<? super Boolean> singleObserver) {
        EqualCoordinator equalCoordinator = new EqualCoordinator(singleObserver, this.f64778c);
        singleObserver.onSubscribe(equalCoordinator);
        equalCoordinator.subscribe(this.f64776a, this.f64777b);
    }
}
