...
public final class MaybeTimeoutMaybe<T, U> extends AbstractC1716Y {

    /* renamed from: a */
    public final MaybeSource f64887a;

    /* renamed from: b */
    public final MaybeSource f64888b;
    ...
    public MaybeTimeoutMaybe(MaybeSource<T> maybeSource, MaybeSource<U> maybeSource2, MaybeSource<? extends T> maybeSource3) {
        super(maybeSource);
        this.f64887a = maybeSource2;
        this.f64888b = maybeSource3;
    }

    @Override // io.reactivex.Maybe
    public void subscribeActual(MaybeObserver<? super T> maybeObserver) {
        TimeoutMainMaybeObserver timeoutMainMaybeObserver = new TimeoutMainMaybeObserver(maybeObserver, this.f64888b);
        maybeObserver.onSubscribe(timeoutMainMaybeObserver);
        this.f64887a.subscribe(timeoutMainMaybeObserver.other);
