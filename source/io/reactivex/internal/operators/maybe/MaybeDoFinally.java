...
public final class MaybeDoFinally<T> extends AbstractC1716Y {

    /* renamed from: a */
    public final Action f64767a;
    ...
    public void subscribeActual(MaybeObserver<? super T> maybeObserver) {
        this.source.subscribe(new DoFinallyObserver(maybeObserver, this.f64767a));
    }
}
