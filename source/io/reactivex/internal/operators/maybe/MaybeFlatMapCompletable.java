...
public final class MaybeFlatMapCompletable<T> extends Completable {
    ...
    /* renamed from: a */
    public final MaybeSource f64794a;

    /* renamed from: b */
    public final Function f64795b;
    ...
    public MaybeFlatMapCompletable(MaybeSource<T> maybeSource, Function<? super T, ? extends CompletableSource> function) {
        this.f64794a = maybeSource;
        this.f64795b = function;
    }

    @Override // io.reactivex.Completable
    public void subscribeActual(CompletableObserver completableObserver) {
        FlatMapCompletableObserver flatMapCompletableObserver = new FlatMapCompletableObserver(completableObserver, this.f64795b);
        completableObserver.onSubscribe(flatMapCompletableObserver);
        this.f64794a.subscribe(flatMapCompletableObserver);
    }
}
