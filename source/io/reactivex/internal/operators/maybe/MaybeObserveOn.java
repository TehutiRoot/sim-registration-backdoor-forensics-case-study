...
public final class MaybeObserveOn<T> extends AbstractC1716Y {

    /* renamed from: a */
    public final Scheduler f64853a;
    ...
    public MaybeObserveOn(MaybeSource<T> maybeSource, Scheduler scheduler) {
        super(maybeSource);
        this.f64853a = scheduler;
    }

    @Override // io.reactivex.Maybe
    public void subscribeActual(MaybeObserver<? super T> maybeObserver) {
        this.source.subscribe(new ObserveOnMaybeObserver(maybeObserver, this.f64853a));
    }
}
