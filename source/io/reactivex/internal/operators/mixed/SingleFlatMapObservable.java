...
public final class SingleFlatMapObservable<T, R> extends Observable<R> {
    ...
    /* renamed from: a */
    public final SingleSource f64981a;

    /* renamed from: b */
    public final Function f64982b;
    ...
    public SingleFlatMapObservable(SingleSource<T> singleSource, Function<? super T, ? extends ObservableSource<? extends R>> function) {
        this.f64981a = singleSource;
        this.f64982b = function;
    }

    @Override // io.reactivex.Observable
    public void subscribeActual(Observer<? super R> observer) {
        FlatMapObserver flatMapObserver = new FlatMapObserver(observer, this.f64982b);
        observer.onSubscribe(flatMapObserver);
        this.f64981a.subscribe(flatMapObserver);
    }
}
