...
public final class MaybeFlatMapPublisher<T, R> extends Flowable<R> {
    ...
    /* renamed from: b */
    public final MaybeSource f64950b;

    /* renamed from: c */
    public final Function f64951c;

    public MaybeFlatMapPublisher(MaybeSource<T> maybeSource, Function<? super T, ? extends Publisher<? extends R>> function) {
        this.f64950b = maybeSource;
        this.f64951c = function;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super R> subscriber) {
        this.f64950b.subscribe(new FlatMapPublisherSubscriber(subscriber, this.f64951c));
    }
