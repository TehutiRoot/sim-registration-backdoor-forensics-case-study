...
public final class ObservableSwitchMapSingle<T, R> extends Observable<R> {
    ...
    /* renamed from: a */
    public final Observable f64978a;

    /* renamed from: b */
    public final Function f64979b;
    ...
    public ObservableSwitchMapSingle(Observable<T> observable, Function<? super T, ? extends SingleSource<? extends R>> function, boolean z) {
        this.f64978a = observable;
        this.f64979b = function;
        this.f64980c = z;
    }

    @Override // io.reactivex.Observable
    public void subscribeActual(Observer<? super R> observer) {
        if (!AbstractC21210nE1.m26148c(this.f64978a, this.f64979b, observer)) {
            this.f64978a.subscribe(new SwitchMapSingleMainObserver(observer, this.f64979b, this.f64980c));
        }
    }
}
