...
public final class ObservableConcatMapSingle<T, R> extends Observable<R> {
    ...
    /* renamed from: a */
    public final Observable f64960a;

    /* renamed from: b */
    public final Function f64961b;

    /* renamed from: c */
    public final ErrorMode f64962c;
    ...
    public ObservableConcatMapSingle(Observable<T> observable, Function<? super T, ? extends SingleSource<? extends R>> function, ErrorMode errorMode, int i) {
        this.f64960a = observable;
        this.f64961b = function;
        this.f64962c = errorMode;
        this.f64963d = i;
    }

    @Override // io.reactivex.Observable
    public void subscribeActual(Observer<? super R> observer) {
        if (!AbstractC21210nE1.m26148c(this.f64960a, this.f64961b, observer)) {
            this.f64960a.subscribe(new ConcatMapSingleMainObserver(observer, this.f64961b, this.f64963d, this.f64962c));
        }
    }
}
