...
public final class ObservableConcatMapMaybe<T, R> extends Observable<R> {
    ...
    /* renamed from: a */
    public final Observable f64956a;

    /* renamed from: b */
    public final Function f64957b;

    /* renamed from: c */
    public final ErrorMode f64958c;
    ...
    public ObservableConcatMapMaybe(Observable<T> observable, Function<? super T, ? extends MaybeSource<? extends R>> function, ErrorMode errorMode, int i) {
        this.f64956a = observable;
        this.f64957b = function;
        this.f64958c = errorMode;
        this.f64959d = i;
    }

    @Override // io.reactivex.Observable
    public void subscribeActual(Observer<? super R> observer) {
        if (!AbstractC21210nE1.m26149b(this.f64956a, this.f64957b, observer)) {
            this.f64956a.subscribe(new ConcatMapMaybeMainObserver(observer, this.f64957b, this.f64959d, this.f64958c));
        }
    }
}
