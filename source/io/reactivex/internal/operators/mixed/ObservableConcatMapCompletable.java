...
public final class ObservableConcatMapCompletable<T> extends Completable {
    ...
    /* renamed from: a */
    public final Observable f64952a;

    /* renamed from: b */
    public final Function f64953b;

    /* renamed from: c */
    public final ErrorMode f64954c;
    ...
    public ObservableConcatMapCompletable(Observable<T> observable, Function<? super T, ? extends CompletableSource> function, ErrorMode errorMode, int i) {
        this.f64952a = observable;
        this.f64953b = function;
        this.f64954c = errorMode;
        this.f64955d = i;
    }

    @Override // io.reactivex.Completable
    public void subscribeActual(CompletableObserver completableObserver) {
        if (!AbstractC21210nE1.m26150a(this.f64952a, this.f64953b, completableObserver)) {
            this.f64952a.subscribe(new ConcatMapCompletableObserver(completableObserver, this.f64953b, this.f64954c, this.f64955d));
        }
    }
}
