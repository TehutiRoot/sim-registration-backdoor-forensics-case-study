...
public final class ObservableConcatMapEager<T, R> extends AbstractC11091a {

    /* renamed from: a */
    public final Function f65136a;

    /* renamed from: b */
    public final ErrorMode f65137b;
    ...
    public ObservableConcatMapEager(ObservableSource<T> observableSource, Function<? super T, ? extends ObservableSource<? extends R>> function, ErrorMode errorMode, int i, int i2) {
        ...
        this.f65136a = function;
        this.f65137b = errorMode;
        this.f65138c = i;
        this.f65139d = i2;
    }
    ...
    public void subscribeActual(Observer<? super R> observer) {
        this.source.subscribe(new ConcatMapEagerMainObserver(observer, this.f65136a, this.f65138c, this.f65139d, this.f65137b));
    }
}
