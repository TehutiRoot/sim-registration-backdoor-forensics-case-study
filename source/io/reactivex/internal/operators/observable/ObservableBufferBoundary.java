...
public final class ObservableBufferBoundary<T, U extends Collection<? super T>, Open, Close> extends AbstractC11091a {

    /* renamed from: a */
    public final Callable f65044a;

    /* renamed from: b */
    public final ObservableSource f65045b;

    /* renamed from: c */
    public final Function f65046c;
    ...
    public ObservableBufferBoundary(ObservableSource<T> observableSource, ObservableSource<? extends Open> observableSource2, Function<? super Open, ? extends ObservableSource<? extends Close>> function, Callable<U> callable) {
        ...
        this.f65045b = observableSource2;
        this.f65046c = function;
        this.f65044a = callable;
    }

    @Override // io.reactivex.Observable
    public void subscribeActual(Observer<? super U> observer) {
        BufferBoundaryObserver bufferBoundaryObserver = new BufferBoundaryObserver(observer, this.f65045b, this.f65046c, this.f65044a);
