...
public final class ObservableRetryWhen<T> extends AbstractC11091a {

    /* renamed from: a */
    public final Function f65473a;
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        try {
            ObservableSource observableSource = (ObservableSource) ObjectHelper.requireNonNull(this.f65473a.apply(serialized), "The handler returned a null ObservableSource");
