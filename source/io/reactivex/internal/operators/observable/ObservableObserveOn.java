...
public final class ObservableObserveOn<T> extends AbstractC11091a {

    /* renamed from: a */
    public final Scheduler f65392a;
    ...
    public void subscribeActual(Observer<? super T> observer) {
        Scheduler scheduler = this.f65392a;
        if (scheduler instanceof TrampolineScheduler) {
            this.source.subscribe(observer);
            return;
        }
        this.source.subscribe(new ObserveOnObserver(observer, scheduler.createWorker(), this.f65393b, this.f65394c));
    }
}
