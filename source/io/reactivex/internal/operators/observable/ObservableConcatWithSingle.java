...
public final class ObservableConcatWithSingle<T> extends AbstractC11091a {

    /* renamed from: a */
    public final SingleSource f65142a;
    ...
    public ObservableConcatWithSingle(Observable<T> observable, SingleSource<? extends T> singleSource) {
        super(observable);
        this.f65142a = singleSource;
    }

    @Override // io.reactivex.Observable
    public void subscribeActual(Observer<? super T> observer) {
        this.source.subscribe(new ConcatWithObserver(observer, this.f65142a));
    }
}
