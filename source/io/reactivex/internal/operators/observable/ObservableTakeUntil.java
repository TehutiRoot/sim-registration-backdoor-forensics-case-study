...
public final class ObservableTakeUntil<T, U> extends AbstractC11091a {

    /* renamed from: a */
    public final ObservableSource f65582a;
    ...
    public ObservableTakeUntil(ObservableSource<T> observableSource, ObservableSource<? extends U> observableSource2) {
        ...
        this.f65582a = observableSource2;
    }
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        this.f65582a.subscribe(takeUntilMainObserver.otherObserver);
