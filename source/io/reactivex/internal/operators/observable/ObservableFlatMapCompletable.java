...
public final class ObservableFlatMapCompletable<T> extends AbstractC11091a {

    /* renamed from: a */
    public final Function f65265a;
    ...
    public ObservableFlatMapCompletable(ObservableSource<T> observableSource, Function<? super T, ? extends CompletableSource> function, boolean z) {
        ...
        this.f65265a = function;
        this.f65266b = z;
    }

    @Override // io.reactivex.Observable
    public void subscribeActual(Observer<? super T> observer) {
        this.source.subscribe(new FlatMapCompletableMainObserver(observer, this.f65265a, this.f65266b));
    }
}
