...
public final class BlockingObservableIterable<T> implements Iterable<T> {
    ...
    /* renamed from: a */
    public final ObservableSource f64983a;
    ...
    public BlockingObservableIterable(ObservableSource<? extends T> observableSource, int i) {
        this.f64983a = observableSource;
        this.f64984b = i;
    }

    @Override // java.lang.Iterable
    public Iterator<T> iterator() {
        BlockingObservableIterator blockingObservableIterator = new BlockingObservableIterator(this.f64984b);
        this.f64983a.subscribe(blockingObservableIterator);
