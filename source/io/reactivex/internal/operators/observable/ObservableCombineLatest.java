...
public final class ObservableCombineLatest<T, R> extends Observable<R> {
    ...
    /* renamed from: a */
    public final ObservableSource[] f65128a;

    /* renamed from: b */
    public final Iterable f65129b;

    /* renamed from: c */
    public final Function f65130c;
    ...
    public ObservableCombineLatest(ObservableSource<? extends T>[] observableSourceArr, Iterable<? extends ObservableSource<? extends T>> iterable, Function<? super Object[], ? extends R> function, int i, boolean z) {
        this.f65128a = observableSourceArr;
        this.f65129b = iterable;
        this.f65130c = function;
        this.f65131d = i;
        this.f65132e = z;
    }
    ...
    public void subscribeActual(Observer<? super R> observer) {
        int length;
        ObservableSource<? extends T>[] observableSourceArr = this.f65128a;
        if (observableSourceArr == null) {
            observableSourceArr = new Observable[8];
            length = 0;
            for (ObservableSource<? extends T> observableSource : this.f65129b) {
        ...
        if (i == 0) {
            ...
            new LatestCoordinator(observer, this.f65130c, i, this.f65131d, this.f65132e).subscribe(observableSourceArr);
        }
    }
}
