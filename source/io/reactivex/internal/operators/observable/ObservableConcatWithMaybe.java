...
public final class ObservableConcatWithMaybe<T> extends AbstractC11091a {

    /* renamed from: a */
    public final MaybeSource f65141a;
    ...
    public ObservableConcatWithMaybe(Observable<T> observable, MaybeSource<? extends T> maybeSource) {
        super(observable);
        this.f65141a = maybeSource;
    }

    @Override // io.reactivex.Observable
    public void subscribeActual(Observer<? super T> observer) {
        this.source.subscribe(new ConcatWithObserver(observer, this.f65141a));
    }
}
