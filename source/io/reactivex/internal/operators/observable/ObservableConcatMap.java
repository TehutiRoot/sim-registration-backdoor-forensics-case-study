...
public final class ObservableConcatMap<T, U> extends AbstractC11091a {

    /* renamed from: a */
    public final Function f65133a;

    /* renamed from: b */
    public final int f65134b;

    /* renamed from: c */
    public final ErrorMode f65135c;
    ...
    public ObservableConcatMap(ObservableSource<T> observableSource, Function<? super T, ? extends ObservableSource<? extends U>> function, int i, ErrorMode errorMode) {
        ...
        this.f65133a = function;
        this.f65135c = errorMode;
        this.f65134b = Math.max(8, i);
    }

    @Override // io.reactivex.Observable
    public void subscribeActual(Observer<? super U> observer) {
        boolean z;
        if (ObservableScalarXMap.tryScalarXMapSubscribe(this.source, observer, this.f65133a)) {
            return;
        }
        if (this.f65135c == ErrorMode.IMMEDIATE) {
            this.source.subscribe(new SourceObserver(new SerializedObserver(observer), this.f65133a, this.f65134b));
            return;
        }
        ObservableSource<Object> observableSource = this.source;
        Function function = this.f65133a;
        int i = this.f65134b;
        if (this.f65135c == ErrorMode.END) {
            z = true;
        } else {
            z = false;
        }
