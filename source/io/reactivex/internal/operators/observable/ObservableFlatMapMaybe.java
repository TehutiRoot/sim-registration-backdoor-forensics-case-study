...
public final class ObservableFlatMapMaybe<T, R> extends AbstractC11091a {

    /* renamed from: a */
    public final Function f65270a;
    ...
    public ObservableFlatMapMaybe(ObservableSource<T> observableSource, Function<? super T, ? extends MaybeSource<? extends R>> function, boolean z) {
        ...
        this.f65270a = function;
        this.f65271b = z;
    }

    @Override // io.reactivex.Observable
    public void subscribeActual(Observer<? super R> observer) {
        this.source.subscribe(new FlatMapMaybeObserver(observer, this.f65270a, this.f65271b));
    }
}
