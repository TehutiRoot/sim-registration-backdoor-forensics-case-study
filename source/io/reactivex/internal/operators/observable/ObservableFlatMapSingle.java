...
public final class ObservableFlatMapSingle<T, R> extends AbstractC11091a {

    /* renamed from: a */
    public final Function f65272a;
    ...
    public ObservableFlatMapSingle(ObservableSource<T> observableSource, Function<? super T, ? extends SingleSource<? extends R>> function, boolean z) {
        ...
        this.f65272a = function;
        this.f65273b = z;
    }

    @Override // io.reactivex.Observable
    public void subscribeActual(Observer<? super R> observer) {
        this.source.subscribe(new FlatMapSingleObserver(observer, this.f65272a, this.f65273b));
    }
}
