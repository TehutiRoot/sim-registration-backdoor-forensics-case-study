...
public final class ObservableConcatWithCompletable<T> extends AbstractC11091a {

    /* renamed from: a */
    public final CompletableSource f65140a;
    ...
    public ObservableConcatWithCompletable(Observable<T> observable, CompletableSource completableSource) {
        super(observable);
        this.f65140a = completableSource;
    }

    @Override // io.reactivex.Observable
    public void subscribeActual(Observer<? super T> observer) {
        this.source.subscribe(new ConcatWithObserver(observer, this.f65140a));
    }
}
