...
public final class ObservableFlatMap<T, U> extends AbstractC11091a {
    ...
    public static final class MergeObserver<T, U> extends AtomicInteger implements Disposable, Observer<T> {
        ...
        public boolean addInner(InnerObserver<T, U> innerObserver) {
            ...
            } while (!AbstractC17300An1.m69050a(this.observers, innerObserverArr, innerObserverArr2));
            return true;
        }
    ...
    public void subscribeActual(Observer<? super U> observer) {
        if (ObservableScalarXMap.tryScalarXMapSubscribe(this.source, observer, this.f65260a)) {
            return;
        }
        this.source.subscribe(new MergeObserver(observer, this.f65260a, this.f65261b, this.f65262c, this.f65263d));
    }
}
