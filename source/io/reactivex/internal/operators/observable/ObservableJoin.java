...
public final class ObservableJoin<TLeft, TRight, TLeftEnd, TRightEnd, R> extends AbstractC11091a {

    /* renamed from: a */
    public final ObservableSource f65361a;

    /* renamed from: b */
    public final Function f65362b;

    /* renamed from: c */
    public final Function f65363c;

    /* renamed from: d */
    public final BiFunction f65364d;

    /* loaded from: classes5.dex */
    public static final class JoinDisposable<TLeft, TRight, TLeftEnd, TRightEnd, R> extends AtomicInteger implements Disposable, ObservableGroupJoin.InterfaceC11009a {
    ...
    public ObservableJoin(ObservableSource<TLeft> observableSource, ObservableSource<? extends TRight> observableSource2, Function<? super TLeft, ? extends ObservableSource<TLeftEnd>> function, Function<? super TRight, ? extends ObservableSource<TRightEnd>> function2, BiFunction<? super TLeft, ? super TRight, ? extends R> biFunction) {
        ...
        this.f65361a = observableSource2;
        this.f65362b = function;
        this.f65363c = function2;
        this.f65364d = biFunction;
    }

    @Override // io.reactivex.Observable
    public void subscribeActual(Observer<? super R> observer) {
        JoinDisposable joinDisposable = new JoinDisposable(observer, this.f65362b, this.f65363c, this.f65364d);
        ...
        this.f65361a.subscribe(leftRightObserver2);
    }
}
