...
public final class ObservableRepeatWhen<T> extends AbstractC11091a {

    /* renamed from: a */
    public final Function f65452a;
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        try {
            ObservableSource observableSource = (ObservableSource) ObjectHelper.requireNonNull(this.f65452a.apply(serialized), "The handler returned a null ObservableSource");
