...
public final class ObservableRetryBiPredicate<T> extends AbstractC11091a {

    /* renamed from: a */
    public final BiPredicate f65470a;
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        new RetryBiObserver(observer, this.f65470a, sequentialDisposable, this.source).subscribeNext();
    }
}
