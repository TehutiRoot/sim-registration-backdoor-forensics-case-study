...
public final class ObservableRepeatUntil<T> extends AbstractC11091a {

    /* renamed from: a */
    public final BooleanSupplier f65451a;
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        new RepeatUntilObserver(observer, this.f65451a, sequentialDisposable, this.source).subscribeNext();
    }
}
