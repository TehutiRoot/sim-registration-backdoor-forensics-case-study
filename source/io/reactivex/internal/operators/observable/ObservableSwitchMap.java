...
public final class ObservableSwitchMap<T, R> extends AbstractC11091a {

    /* renamed from: a */
    public final Function f65564a;

    /* renamed from: b */
    public final int f65565b;

    /* renamed from: c */
    public final boolean f65566c;
        ...
        */
        ...
        public void onNext(T t) {
            ...
            try {
                ...
                } while (!AbstractC17300An1.m69050a(this.active, switchMapInnerObserver, switchMapInnerObserver3));
    ...
    public void subscribeActual(Observer<? super R> observer) {
        if (ObservableScalarXMap.tryScalarXMapSubscribe(this.source, observer, this.f65564a)) {
            return;
        }
        this.source.subscribe(new SwitchMapObserver(observer, this.f65564a, this.f65565b, this.f65566c));
    }
}
