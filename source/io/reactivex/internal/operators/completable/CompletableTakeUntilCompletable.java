...
public final class CompletableTakeUntilCompletable extends Completable {
    ...
    /* renamed from: a */
    public final Completable f63977a;

    /* renamed from: b */
    public final CompletableSource f63978b;
    ...
    public CompletableTakeUntilCompletable(Completable completable, CompletableSource completableSource) {
        this.f63977a = completable;
        this.f63978b = completableSource;
    }
    ...
    public void subscribeActual(CompletableObserver completableObserver) {
        ...
        this.f63978b.subscribe(takeUntilMainObserver.other);
        this.f63977a.subscribe(takeUntilMainObserver);
    }
}
