...
public final class CompletableSubscribeOn extends Completable {
    ...
    /* renamed from: b */
    public final Scheduler f63976b;
    ...
    public CompletableSubscribeOn(CompletableSource completableSource, Scheduler scheduler) {
        ...
        this.f63976b = scheduler;
    }

    @Override // io.reactivex.Completable
    public void subscribeActual(CompletableObserver completableObserver) {
        SubscribeOnObserver subscribeOnObserver = new SubscribeOnObserver(completableObserver, this.f63975a);
        completableObserver.onSubscribe(subscribeOnObserver);
        subscribeOnObserver.task.replace(this.f63976b.scheduleDirect(subscribeOnObserver));
    }
}
