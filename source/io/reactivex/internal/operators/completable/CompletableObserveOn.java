...
public final class CompletableObserveOn extends Completable {
    ...
    /* renamed from: a */
    public final CompletableSource f63957a;

    /* renamed from: b */
    public final Scheduler f63958b;
    ...
    public CompletableObserveOn(CompletableSource completableSource, Scheduler scheduler) {
        this.f63957a = completableSource;
        this.f63958b = scheduler;
    }

    @Override // io.reactivex.Completable
    public void subscribeActual(CompletableObserver completableObserver) {
        this.f63957a.subscribe(new ObserveOnCompletableObserver(completableObserver, this.f63958b));
    }
}
