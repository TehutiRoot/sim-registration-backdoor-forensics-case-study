...
public final class CompletableMergeArray extends Completable {
    ...
    /* renamed from: a */
    public final CompletableSource[] f63949a;
    ...
    public CompletableMergeArray(CompletableSource[] completableSourceArr) {
        this.f63949a = completableSourceArr;
    }
    ...
    public void subscribeActual(CompletableObserver completableObserver) {
        ...
        InnerCompletableObserver innerCompletableObserver = new InnerCompletableObserver(completableObserver, new AtomicBoolean(), compositeDisposable, this.f63949a.length + 1);
        completableObserver.onSubscribe(compositeDisposable);
        for (CompletableSource completableSource : this.f63949a) {
