...
public final class SingleUnsubscribeOn<T> extends Single<T> {
    ...
    /* renamed from: a */
    public final SingleSource f65990a;

    /* renamed from: b */
    public final Scheduler f65991b;
    ...
    public static final class UnsubscribeOnSingleObserver<T> extends AtomicReference<Disposable> implements SingleObserver<T>, Disposable, Runnable {
        ...
        public void run() {
            this.f65992ds.dispose();
        }
    }

    public SingleUnsubscribeOn(SingleSource<T> singleSource, Scheduler scheduler) {
        this.f65990a = singleSource;
        this.f65991b = scheduler;
    }

    @Override // io.reactivex.Single
    public void subscribeActual(SingleObserver<? super T> singleObserver) {
        this.f65990a.subscribe(new UnsubscribeOnSingleObserver(singleObserver, this.f65991b));
    }
}
