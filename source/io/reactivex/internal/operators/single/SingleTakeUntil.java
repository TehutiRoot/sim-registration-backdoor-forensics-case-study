...
public final class SingleTakeUntil<T, U> extends Single<T> {
    ...
    /* renamed from: a */
    public final SingleSource f65978a;

    /* renamed from: b */
    public final Publisher f65979b;
    ...
    public SingleTakeUntil(SingleSource<T> singleSource, Publisher<U> publisher) {
        this.f65978a = singleSource;
        this.f65979b = publisher;
    }
    ...
    public void subscribeActual(SingleObserver<? super T> singleObserver) {
        ...
        this.f65979b.subscribe(takeUntilMainObserver.other);
        this.f65978a.subscribe(takeUntilMainObserver);
    }
}
