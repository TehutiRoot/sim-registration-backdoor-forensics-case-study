...
public final class SingleResumeNext<T> extends Single<T> {
    ...
    /* renamed from: a */
    public final SingleSource f65974a;

    /* renamed from: b */
    public final Function f65975b;
    ...
    public SingleResumeNext(SingleSource<? extends T> singleSource, Function<? super Throwable, ? extends SingleSource<? extends T>> function) {
        this.f65974a = singleSource;
        this.f65975b = function;
    }

    @Override // io.reactivex.Single
    public void subscribeActual(SingleObserver<? super T> singleObserver) {
        this.f65974a.subscribe(new ResumeMainSingleObserver(singleObserver, this.f65975b));
    }
}
