...
public final class SingleZipArray<T, R> extends Single<R> {
    ...
    /* renamed from: a */
    public final SingleSource[] f65997a;

    /* renamed from: b */
    public final Function f65998b;
    ...
    /* loaded from: classes5.dex */
    public final class C11133a implements Function {
        public C11133a() {
        }

        @Override // io.reactivex.functions.Function
        public Object apply(Object obj) {
            return ObjectHelper.requireNonNull(SingleZipArray.this.f65998b.apply(new Object[]{obj}), "The zipper returned a null value");
        }
    }

    public SingleZipArray(SingleSource<? extends T>[] singleSourceArr, Function<? super Object[], ? extends R> function) {
        this.f65997a = singleSourceArr;
        this.f65998b = function;
    }

    @Override // io.reactivex.Single
    public void subscribeActual(SingleObserver<? super R> singleObserver) {
        SingleSource[] singleSourceArr = this.f65997a;
        int length = singleSourceArr.length;
        if (length == 1) {
            singleSourceArr[0].subscribe(new SingleMap.C11131a(singleObserver, new C11133a()));
            return;
        }
        ZipCoordinator zipCoordinator = new ZipCoordinator(singleObserver, length, this.f65998b);
