...
public final class SingleDoOnDispose<T> extends Single<T> {
    ...
    /* renamed from: a */
    public final SingleSource f65897a;

    /* renamed from: b */
    public final Action f65898b;
    ...
    public SingleDoOnDispose(SingleSource<T> singleSource, Action action) {
        this.f65897a = singleSource;
        this.f65898b = action;
    }

    @Override // io.reactivex.Single
    public void subscribeActual(SingleObserver<? super T> singleObserver) {
        this.f65897a.subscribe(new DoOnDisposeObserver(singleObserver, this.f65898b));
    }
}
