...
public final class SingleFlatMapIterableFlowable<T, R> extends Flowable<R> {
    ...
    /* renamed from: b */
    public final SingleSource f65934b;

    /* renamed from: c */
    public final Function f65935c;
    ...
    public static final class FlatMapIterableObserver<T, R> extends BasicIntQueueSubscription<R> implements SingleObserver<T> {
        ...
        /* renamed from: it */
        volatile Iterator<? extends R> f65936it;
        ...
        public void drain() {
            ...
            Iterator<? extends R> it = this.f65936it;
    ...
    public SingleFlatMapIterableFlowable(SingleSource<T> singleSource, Function<? super T, ? extends Iterable<? extends R>> function) {
        this.f65934b = singleSource;
        this.f65935c = function;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super R> subscriber) {
        this.f65934b.subscribe(new FlatMapIterableObserver(subscriber, this.f65935c));
    }
}
