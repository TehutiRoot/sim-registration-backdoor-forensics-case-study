...
public final class SingleZipIterable<T, R> extends Single<R> {
    ...
    /* loaded from: classes5.dex */
    public final class C11134a implements Function {
        public C11134a() {
        }

        @Override // io.reactivex.functions.Function
        public Object apply(Object obj) {
            return ObjectHelper.requireNonNull(SingleZipIterable.this.f66001b.apply(new Object[]{obj}), "The zipper returned a null value");
        }
    }

    public SingleZipIterable(Iterable<? extends SingleSource<? extends T>> iterable, Function<? super Object[], ? extends R> function) {
        this.f66000a = iterable;
    ...
    public void subscribeActual(SingleObserver<? super R> singleObserver) {
        ...
        try {
            int i = 0;
            for (SingleSource singleSource : this.f66000a) {
            ...
            if (i == 0) {
                ...
                singleSourceArr[0].subscribe(new SingleMap.C11131a(singleObserver, new C11134a()));
            } else {
                SingleZipArray.ZipCoordinator zipCoordinator = new SingleZipArray.ZipCoordinator(singleObserver, i, this.f66001b);
