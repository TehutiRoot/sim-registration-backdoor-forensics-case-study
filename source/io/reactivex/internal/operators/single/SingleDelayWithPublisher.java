...
public final class SingleDelayWithPublisher<T, U> extends Single<T> {
    ...
    /* renamed from: a */
    public final SingleSource f65873a;

    /* renamed from: b */
    public final Publisher f65874b;
    ...
    public SingleDelayWithPublisher(SingleSource<T> singleSource, Publisher<U> publisher) {
        this.f65873a = singleSource;
        this.f65874b = publisher;
    }

    @Override // io.reactivex.Single
    public void subscribeActual(SingleObserver<? super T> singleObserver) {
        this.f65874b.subscribe(new OtherSubscriber(singleObserver, this.f65873a));
    }
}
