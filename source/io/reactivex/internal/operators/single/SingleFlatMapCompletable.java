...
public final class SingleFlatMapCompletable<T> extends Completable {
    ...
    /* renamed from: a */
    public final SingleSource f65932a;

    /* renamed from: b */
    public final Function f65933b;
    ...
    public SingleFlatMapCompletable(SingleSource<T> singleSource, Function<? super T, ? extends CompletableSource> function) {
        this.f65932a = singleSource;
        this.f65933b = function;
    }

    @Override // io.reactivex.Completable
    public void subscribeActual(CompletableObserver completableObserver) {
        FlatMapCompletableObserver flatMapCompletableObserver = new FlatMapCompletableObserver(completableObserver, this.f65933b);
        completableObserver.onSubscribe(flatMapCompletableObserver);
        this.f65932a.subscribe(flatMapCompletableObserver);
    }
}
