...
public final class SingleFlatMapIterableObservable<T, R> extends Observable<R> {
    ...
    /* renamed from: a */
    public final SingleSource f65937a;

    /* renamed from: b */
    public final Function f65938b;
    ...
    public static final class FlatMapIterableObserver<T, R> extends BasicIntQueueDisposable<R> implements SingleObserver<T> {
        ...
        /* renamed from: it */
        volatile Iterator<? extends R> f65939it;
        ...
        public R poll() throws Exception {
            Iterator<? extends R> it = this.f65939it;
            if (it == null) {
                return null;
            }
    ...
    public SingleFlatMapIterableObservable(SingleSource<T> singleSource, Function<? super T, ? extends Iterable<? extends R>> function) {
        this.f65937a = singleSource;
        this.f65938b = function;
    }

    @Override // io.reactivex.Observable
    public void subscribeActual(Observer<? super R> observer) {
        this.f65937a.subscribe(new FlatMapIterableObserver(observer, this.f65938b));
    }
}
