...
public final class SingleDelayWithObservable<T, U> extends Single<T> {
    ...
    /* renamed from: a */
    public final SingleSource f65871a;

    /* renamed from: b */
    public final ObservableSource f65872b;
    ...
    public SingleDelayWithObservable(SingleSource<T> singleSource, ObservableSource<U> observableSource) {
        this.f65871a = singleSource;
        this.f65872b = observableSource;
    }

    @Override // io.reactivex.Single
    public void subscribeActual(SingleObserver<? super T> singleObserver) {
        this.f65872b.subscribe(new OtherSubscriber(singleObserver, this.f65871a));
    }
}
