...
public final class SingleDelayWithSingle<T, U> extends Single<T> {
    ...
    /* renamed from: a */
    public final SingleSource f65875a;

    /* renamed from: b */
    public final SingleSource f65876b;
    ...
    public SingleDelayWithSingle(SingleSource<T> singleSource, SingleSource<U> singleSource2) {
        this.f65875a = singleSource;
        this.f65876b = singleSource2;
    }

    @Override // io.reactivex.Single
    public void subscribeActual(SingleObserver<? super T> singleObserver) {
        this.f65876b.subscribe(new OtherObserver(singleObserver, this.f65875a));
    }
}
