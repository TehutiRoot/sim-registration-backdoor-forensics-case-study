...
public final class SingleFlatMapPublisher<T, R> extends Flowable<R> {
    ...
    /* renamed from: b */
    public final SingleSource f65944b;

    /* renamed from: c */
    public final Function f65945c;

    public SingleFlatMapPublisher(SingleSource<T> singleSource, Function<? super T, ? extends Publisher<? extends R>> function) {
        this.f65944b = singleSource;
        this.f65945c = function;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super R> subscriber) {
        this.f65944b.subscribe(new SingleFlatMapPublisherObserver(subscriber, this.f65945c));
    }
