...
public abstract class QueueDrainSubscriber<T, U, V> extends AbstractC21313nr1 implements FlowableSubscriber<T>, QueueDrain<U, V> {
    ...
    public final boolean enter() {
        if (this.f72951a.getAndIncrement() == 0) {
            return true;
        }
        return false;
    }
    ...
    public final boolean fastEnter() {
        if (this.f72951a.get() != 0 || !this.f72951a.compareAndSet(0, 1)) {
            return false;
        }
        return true;
    }
    ...
    public final int leave(int i) {
        return this.f72951a.addAndGet(i);
    }

    @Override // io.reactivex.internal.util.QueueDrain
    public final long produced(long j) {
        return this.f72068b.addAndGet(-j);
    }

    @Override // io.reactivex.internal.util.QueueDrain
    public final long requested() {
        return this.f72068b.get();
    }

    public final void requested(long j) {
        if (SubscriptionHelper.validate(j)) {
            BackpressureHelper.add(this.f72068b, j);
        }
    }
}
