...
public final class FlowableKt {
    ...
    /* loaded from: classes5.dex */
    public static final class C11171b implements Function {

        /* renamed from: a */
        public static final C11171b f66256a = new C11171b();
    ...
    /* loaded from: classes5.dex */
    public static final class C11172c implements Function {

        /* renamed from: a */
        public static final C11172c f66257a = new C11172c();
    ...
    /* loaded from: classes5.dex */
    public static final class C11173d implements Function {

        /* renamed from: a */
        public static final C11173d f66258a = new C11173d();
    ...
    /* loaded from: classes5.dex */
    public static final class C11174e implements Function {

        /* renamed from: a */
        public static final C11174e f66259a = new C11174e();
    ...
    /* loaded from: classes5.dex */
    public static final class C11175f implements Function {

        /* renamed from: a */
        public static final C11175f f66260a = new C11175f();
    ...
    /* loaded from: classes5.dex */
    public static final class C11176g implements Function {

        /* renamed from: a */
        public static final C11176g f66261a = new C11176g();
    ...
    /* renamed from: a */
    public static final Iterable m29843a(Iterator it) {
    ...
    public static final <T> Flowable<T> concatAll(@NotNull Flowable<Flowable<T>> concatAll) {
        ...
        Flowable<T> flowable = (Flowable<T>) concatAll.concatMap(C11170a.f66255a);
    ...
    public static final <T> Flowable<T> mergeAll(@NotNull Flowable<Flowable<T>> mergeAll) {
        ...
        Flowable<T> flowable = (Flowable<T>) mergeAll.flatMap(C11171b.f66256a);
    ...
    public static final <T> Flowable<T> switchLatest(@NotNull Flowable<Flowable<T>> switchLatest) {
        ...
        Flowable<T> flowable = (Flowable<T>) switchLatest.switchMap(C11172c.f66257a);
    ...
    public static final <A, B> Single<Map<A, B>> toMap(@NotNull Flowable<Pair<A, B>> toMap) {
        ...
        Single<Map<A, B>> single = (Single<Map<A, B>>) toMap.toMap(C11173d.f66258a, C11174e.f66259a);
    ...
    public static final <A, B> Single<Map<A, Collection<B>>> toMultimap(@NotNull Flowable<Pair<A, B>> toMultimap) {
        ...
        Single<Map<A, Collection<B>>> single = (Single<Map<A, Collection<B>>>) toMultimap.toMultimap(C11175f.f66260a, C11176g.f66261a);
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r1v0, types: [v30] */
    @NotNull
    @SchedulerSupport(SchedulerSupport.NONE)
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static final <T, R> Flowable<Pair<T, R>> combineLatest(@NotNull Flowable<T> combineLatest, @NotNull Flowable<R> flowable) {
        ...
        if (flowableKt$combineLatest$2 != null) {
            flowableKt$combineLatest$2 = new C22552v30(flowableKt$combineLatest$2);
        }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r1v0, types: [w30] */
    @NotNull
    @SchedulerSupport(SchedulerSupport.NONE)
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static final <T, R, U> Flowable<Triple<T, R, U>> combineLatest(@NotNull Flowable<T> combineLatest, @NotNull Flowable<R> flowable1, @NotNull Flowable<U> flowable2) {
        ...
        if (flowableKt$combineLatest$3 != null) {
            flowableKt$combineLatest$3 = new C22724w30(flowableKt$combineLatest$3);
        }
    ...
    public static final <T> Flowable<T> toFlowable(@NotNull Iterator<? extends T> toFlowable) {
        Intrinsics.checkParameterIsNotNull(toFlowable, "$this$toFlowable");
        return toFlowable(m29843a(toFlowable));
    }
