...
public final class ObservablesKt {
    ...
    /* loaded from: classes5.dex */
    public static final class C11203b implements Function3 {

        /* renamed from: a */
        public static final C11203b f66343a = new C11203b();
    ...
    /* loaded from: classes5.dex */
    public static final class C11204c implements BiFunction {

        /* renamed from: a */
        public static final C11204c f66344a = new C11204c();
    ...
    public static final <T, U> Observable<Pair<T, U>> withLatestFrom(@NotNull Observable<T> withLatestFrom, @NotNull ObservableSource<U> other) {
        Intrinsics.checkParameterIsNotNull(withLatestFrom, "$this$withLatestFrom");
        Intrinsics.checkParameterIsNotNull(other, "other");
        Observable<Pair<T, U>> observable = (Observable<Pair<T, U>>) withLatestFrom.withLatestFrom(other, C11202a.f66342a);
    ...
    public static final <T, U> Observable<Pair<T, U>> zipWith(@NotNull Observable<T> zipWith, @NotNull ObservableSource<U> other) {
        Intrinsics.checkParameterIsNotNull(zipWith, "$this$zipWith");
        Intrinsics.checkParameterIsNotNull(other, "other");
        Observable<Pair<T, U>> observable = (Observable<Pair<T, U>>) zipWith.zipWith(other, C11204c.f66344a);
    ...
    public static final <T, T1, T2> Observable<Triple<T, T1, T2>> withLatestFrom(@NotNull Observable<T> withLatestFrom, @NotNull ObservableSource<T1> o1, @NotNull ObservableSource<T2> o2) {
        ...
        Intrinsics.checkParameterIsNotNull(o1, "o1");
        Intrinsics.checkParameterIsNotNull(o2, "o2");
        Observable<Triple<T, T1, T2>> observable = (Observable<Triple<T, T1, T2>>) withLatestFrom.withLatestFrom(o1, o2, C11203b.f66343a);
