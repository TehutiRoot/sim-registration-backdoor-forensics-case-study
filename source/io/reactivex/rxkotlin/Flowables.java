...
public final class Flowables {
    ...
    /* loaded from: classes5.dex */
    public static final class C11177a implements BiFunction {

        /* renamed from: a */
        public static final C11177a f66266a = new C11177a();
    ...
    /* loaded from: classes5.dex */
    public static final class C11178b implements Function3 {

        /* renamed from: a */
        public static final C11178b f66267a = new C11178b();
    ...
    /* loaded from: classes5.dex */
    public static final class C11179c implements BiFunction {

        /* renamed from: a */
        public static final C11179c f66268a = new C11179c();
    ...
    /* loaded from: classes5.dex */
    public static final class C11180d implements Function3 {

        /* renamed from: a */
        public static final C11180d f66269a = new C11180d();
    ...
    public final <T1, T2> Flowable<Pair<T1, T2>> combineLatest(@NotNull Flowable<T1> source1, @NotNull Flowable<T2> source2) {
        Intrinsics.checkParameterIsNotNull(source1, "source1");
        Intrinsics.checkParameterIsNotNull(source2, "source2");
        Flowable<Pair<T1, T2>> combineLatest = Flowable.combineLatest(source1, source2, C11177a.f66266a);
    ...
    public final <T1, T2> Flowable<Pair<T1, T2>> zip(@NotNull Flowable<T1> source1, @NotNull Flowable<T2> source2) {
        Intrinsics.checkParameterIsNotNull(source1, "source1");
        Intrinsics.checkParameterIsNotNull(source2, "source2");
        Flowable<Pair<T1, T2>> zip = Flowable.zip(source1, source2, C11179c.f66268a);
    ...
    public final <T1, T2, T3> Flowable<Triple<T1, T2, T3>> zip(@NotNull Flowable<T1> source1, @NotNull Flowable<T2> source2, @NotNull Flowable<T3> source3) {
        ...
        Intrinsics.checkParameterIsNotNull(source2, "source2");
        Intrinsics.checkParameterIsNotNull(source3, "source3");
        Flowable<Triple<T1, T2, T3>> zip = Flowable.zip(source1, source2, source3, C11180d.f66269a);
    ...
    public final <T1, T2, T3> Flowable<Triple<T1, T2, T3>> combineLatest(@NotNull Flowable<T1> source1, @NotNull Flowable<T2> source2, @NotNull Flowable<T3> source3) {
        ...
        Intrinsics.checkParameterIsNotNull(source2, "source2");
        Intrinsics.checkParameterIsNotNull(source3, "source3");
        Flowable<Triple<T1, T2, T3>> combineLatest = Flowable.combineLatest(source1, source2, source3, C11178b.f66267a);
