...
public final class Singles {
    ...
    /* renamed from: io.reactivex.rxkotlin.Singles$b */
    /* loaded from: classes5.dex */
    public static final class C11208b implements Function3 {

        /* renamed from: a */
        public static final C11208b f66353a = new C11208b();
    ...
    public final <T, U> Single<Pair<T, U>> zip(@NotNull SingleSource<T> s1, @NotNull SingleSource<U> s2) {
        Intrinsics.checkParameterIsNotNull(s1, "s1");
        Intrinsics.checkParameterIsNotNull(s2, "s2");
        Single<Pair<T, U>> zip = Single.zip(s1, s2, C11207a.f66352a);
    ...
    @CheckReturnValue
    @NotNull
    public final <T1, T2, T3, R> Single<R> zip(@NotNull SingleSource<T1> s1, @NotNull SingleSource<T2> s2, @NotNull SingleSource<T3> s3, @NotNull final kotlin.jvm.functions.Function3<? super T1, ? super T2, ? super T3, ? extends R> zipper) {
        Intrinsics.checkParameterIsNotNull(s1, "s1");
        Intrinsics.checkParameterIsNotNull(s2, "s2");
    ...
    public final <T1, T2, T3> Single<Triple<T1, T2, T3>> zip(@NotNull SingleSource<T1> s1, @NotNull SingleSource<T2> s2, @NotNull SingleSource<T3> s3) {
        ...
        Intrinsics.checkParameterIsNotNull(s2, "s2");
        Intrinsics.checkParameterIsNotNull(s3, "s3");
        Single<Triple<T1, T2, T3>> zip = Single.zip(s1, s2, s3, C11208b.f66353a);
