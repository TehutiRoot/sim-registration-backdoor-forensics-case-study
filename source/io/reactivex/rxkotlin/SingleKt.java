...
@Metadata(m28852bv = {1, 0, 3}, m28851d1 = {"\u0000$\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u001c\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u001a#\u0010\u0000\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0001\"\n\b\u0000\u0010\u0002\u0018\u0001*\u00020\u0003*\u0006\u0012\u0002\b\u00030\u0001H\u0086\b\u001a(\u0010\u0004\u001a\b\u0012\u0004\u0012\u0002H\u00060\u0005\"\b\b\u0000\u0010\u0006*\u00020\u0003*\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00060\b0\u0007H\u0007\u001a(\u0010\t\u001a\b\u0012\u0004\u0012\u0002H\u00060\u0005\"\b\b\u0000\u0010\u0006*\u00020\u0003*\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00060\u00010\u0005H\u0007\u001a(\u0010\t\u001a\b\u0012\u0004\u0012\u0002H\u00060\n\"\b\b\u0000\u0010\u0006*\u00020\u0003*\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00060\u00010\nH\u0007¨\u0006\u000b"}, m28850d2 = {"cast", "Lio/reactivex/Single;", "R", "", "concatAll", "Lio/reactivex/Flowable;", "T", "", "Lio/reactivex/SingleSource;", "mergeAllSingles", "Lio/reactivex/Observable;", "rxkotlin"}, m28849k = 2, m28848mv = {1, 1, 15})
/* loaded from: classes5.dex */
public final class SingleKt {

    /* renamed from: io.reactivex.rxkotlin.SingleKt$a */
    /* loaded from: classes5.dex */
    public static final class C11205a implements Function {

        /* renamed from: a */
        public static final C11205a f66350a = new C11205a();
    ...
    /* loaded from: classes5.dex */
    public static final class C11206b implements Function {

        /* renamed from: a */
        public static final C11206b f66351a = new C11206b();
    ...
    public static final <T> Observable<T> mergeAllSingles(@NotNull Observable<Single<T>> mergeAllSingles) {
        ...
        Observable<T> observable = (Observable<T>) mergeAllSingles.flatMapSingle(C11205a.f66350a);
    ...
    public static final <T> Flowable<T> mergeAllSingles(@NotNull Flowable<Single<T>> mergeAllSingles) {
        Intrinsics.checkParameterIsNotNull(mergeAllSingles, "$this$mergeAllSingles");
        Flowable<T> flowable = (Flowable<T>) mergeAllSingles.flatMapSingle(C11206b.f66351a);
