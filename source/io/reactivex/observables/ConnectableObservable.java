...
public abstract class ConnectableObservable<T> extends Observable<T> {
    ...
    /* renamed from: d */
    public final ConnectableObservable m29881d() {
    ...
    public Observable<T> refCount() {
        return RxJavaPlugins.onAssembly(new ObservableRefCount(m29881d()));
    }
    ...
    public final Observable<T> refCount(int i, long j, TimeUnit timeUnit, Scheduler scheduler) {
        ...
        return RxJavaPlugins.onAssembly(new ObservableRefCount(m29881d(), i, j, timeUnit, scheduler));
    }
}
