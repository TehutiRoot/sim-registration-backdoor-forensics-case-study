...
public abstract class ConnectableFlowable<T> extends Flowable<T> {
    ...
    /* renamed from: e */
    public final ConnectableFlowable m30096e() {
    ...
    public Flowable<T> refCount() {
        return RxJavaPlugins.onAssembly(new FlowableRefCount(m30096e()));
    }
    ...
    public final Flowable<T> refCount(int i, long j, TimeUnit timeUnit, Scheduler scheduler) {
        ...
        return RxJavaPlugins.onAssembly(new FlowableRefCount(m30096e(), i, j, timeUnit, scheduler));
    }
}
