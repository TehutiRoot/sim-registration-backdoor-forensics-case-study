...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    /* loaded from: classes5.dex */
    public static /* synthetic */ class C10740a {
        ...
        static {
            ...
            try {
                f63794a[BackpressureStrategy.LATEST.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f63794a[BackpressureStrategy.MISSING.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f63794a[BackpressureStrategy.ERROR.ordinal()] = 4;
    ...
    /* renamed from: a */
    public final Observable m30111a(Consumer consumer, Consumer consumer2, Action action, Action action2) {
    ...
    @CheckReturnValue
    /* renamed from: as */
    public final <R> R m30110as(@NonNull ObservableConverter<T, ? extends R> observableConverter) {
        return (R) ((ObservableConverter) ObjectHelper.requireNonNull(observableConverter, "converter is null")).apply(this);
    }

    /* renamed from: b */
    public final Observable m30109b(long j, TimeUnit timeUnit, ObservableSource observableSource, Scheduler scheduler) {
    ...
    /* renamed from: c */
    public final Observable m30108c(ObservableSource observableSource, Function function, ObservableSource observableSource2) {
    ...
    public final Observable<T> doAfterTerminate(Action action) {
        ...
        return m30111a(Functions.emptyConsumer(), Functions.emptyConsumer(), Functions.EMPTY_ACTION, action);
    }
    ...
    public final Observable<T> doOnComplete(Action action) {
        return m30111a(Functions.emptyConsumer(), Functions.emptyConsumer(), action, Functions.EMPTY_ACTION);
    }
    ...
    public final Observable<T> doOnEach(Consumer<? super Notification<T>> consumer) {
        ...
        return m30111a(Functions.notificationOnNext(consumer), Functions.notificationOnError(consumer), Functions.notificationOnComplete(consumer), Functions.EMPTY_ACTION);
    }
    ...
    public final Observable<T> doOnError(Consumer<? super Throwable> consumer) {
        ...
        return m30111a(emptyConsumer, consumer, action, action);
    }
    ...
    public final Observable<T> doOnNext(Consumer<? super T> consumer) {
        Consumer emptyConsumer = Functions.emptyConsumer();
        Action action = Functions.EMPTY_ACTION;
        return m30111a(consumer, emptyConsumer, action, action);
    }
    ...
    public final Observable<T> doOnTerminate(Action action) {
        ...
        return m30111a(Functions.emptyConsumer(), Functions.actionConsumer(action), action, Functions.EMPTY_ACTION);
    }
    ...
    public final <V> Observable<T> timeout(Function<? super T, ? extends ObservableSource<V>> function) {
        return m30108c(null, function, null);
    }
    ...
    @CheckReturnValue
    /* renamed from: to */
    public final <R> R m30107to(Function<? super Observable<T>, R> function) {
        try {
    ...
    public final Flowable<T> toFlowable(BackpressureStrategy backpressureStrategy) {
        ...
        int i = C10740a.f63794a[backpressureStrategy.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
                    if (i != 4) {
    ...
    public final <V> Observable<T> timeout(Function<? super T, ? extends ObservableSource<V>> function, ObservableSource<? extends T> observableSource) {
        ObjectHelper.requireNonNull(observableSource, "other is null");
        return m30108c(null, function, observableSource);
    }
    ...
    public static <T> Observable<T> error(Throwable th2) {
        ...
        return error(Functions.justCallable(th2));
    }
    ...
    public final Observable<T> timeout(long j, TimeUnit timeUnit) {
        return m30109b(j, timeUnit, null, Schedulers.computation());
    }
    ...
    public final Observable<T> timeout(long j, TimeUnit timeUnit, ObservableSource<? extends T> observableSource) {
        ObjectHelper.requireNonNull(observableSource, "other is null");
        return m30109b(j, timeUnit, observableSource, Schedulers.computation());
    }
    ...
    public final Observable<T> doOnEach(Observer<? super T> observer) {
        ObjectHelper.requireNonNull(observer, "observer is null");
        return m30111a(ObservableInternalHelper.observerOnNext(observer), ObservableInternalHelper.observerOnError(observer), ObservableInternalHelper.observerOnComplete(observer), Functions.EMPTY_ACTION);
    }
    ...
    public final Observable<T> timeout(long j, TimeUnit timeUnit, Scheduler scheduler, ObservableSource<? extends T> observableSource) {
        ObjectHelper.requireNonNull(observableSource, "other is null");
        return m30109b(j, timeUnit, observableSource, scheduler);
    }
    ...
    public final Observable<T> timeout(long j, TimeUnit timeUnit, Scheduler scheduler) {
        return m30109b(j, timeUnit, null, scheduler);
    }
    ...
    public final <U, V> Observable<T> timeout(ObservableSource<U> observableSource, Function<? super T, ? extends ObservableSource<V>> function) {
        ...
        return m30108c(observableSource, function, null);
    }
    ...
    public final <U, V> Observable<T> timeout(ObservableSource<U> observableSource, Function<? super T, ? extends ObservableSource<V>> function, ObservableSource<? extends T> observableSource2) {
        ...
        return m30108c(observableSource, function, observableSource2);
    }
