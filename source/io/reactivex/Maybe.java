...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    public static <T> Maybe<T> error(Throwable th2) {
        ...
        return RxJavaPlugins.onAssembly(new MaybeError(th2));
    }
    ...
    @CheckReturnValue
    /* renamed from: as */
    public final <R> R m30113as(@NonNull MaybeConverter<T, ? extends R> maybeConverter) {
    ...
    public final Maybe<T> doAfterTerminate(Action action) {
        ...
        return RxJavaPlugins.onAssembly(new MaybePeek(this, emptyConsumer, emptyConsumer2, emptyConsumer3, action2, (Action) ObjectHelper.requireNonNull(action, "onAfterTerminate is null"), action2));
    }
    ...
    public final Maybe<T> doOnSuccess(Consumer<? super T> consumer) {
        Consumer emptyConsumer = Functions.emptyConsumer();
        Action action = Functions.EMPTY_ACTION;
        return RxJavaPlugins.onAssembly(new MaybePeek(this, Functions.emptyConsumer(), (Consumer) ObjectHelper.requireNonNull(consumer, "onSuccess is null"), emptyConsumer, action, action, action));
    }
    ...
    @NonNull
    /* renamed from: to */
    public final <R> R m30112to(Function<? super Maybe<T>, R> function) {
        try {
