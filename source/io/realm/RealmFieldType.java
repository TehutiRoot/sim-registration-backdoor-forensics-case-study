...
public enum RealmFieldType {
    ...
    INTEGER_LIST(128),
    BOOLEAN_LIST(129),
    STRING_LIST(es.dmoral.toasty.BuildConfig.VERSION_CODE),
    BINARY_LIST(132),
    DATE_LIST(136),
    FLOAT_LIST(137),
    DOUBLE_LIST(138),
    ...
    INTEGER_SET(256),
    BOOLEAN_SET(257),
    STRING_SET(WGL4Names.NUMBER_OF_MAC_GLYPHS),
    BINARY_SET(260),
    DATE_SET(264),
    FLOAT_SET(265),
    DOUBLE_SET(266),
    ...
    static {
        ...
        for (int i2 = 0; i2 < length; i2 += i) {
            RealmFieldType realmFieldType = values[i2];
            int i3 = realmFieldType.nativeValue;
            if (i3 < 128) {
                basicTypes[i3] = realmFieldType;
                i = 1;
            } else if (i3 < 256) {
                listTypes[i3 - 128] = realmFieldType;
                i = 1;
            } else {
                if (i3 < 512) {
                    setTypes[i3 - 256] = realmFieldType;
                } else {
                    mapTypes[i3 + WorkInfo.STOP_REASON_UNKNOWN] = realmFieldType;
                }
                i = 1;
            }
        }
    ...
    public static RealmFieldType fromNativeValue(int i) {
        ...
        if (512 <= i) {
            int i4 = i + WorkInfo.STOP_REASON_UNKNOWN;
