...
public abstract class MutableRealmInteger implements Comparable<MutableRealmInteger>, ManageableObject {
    ...
    /* loaded from: classes5.dex */
    public static final class C11236a extends MutableRealmInteger {

        /* renamed from: a */
        public Long f66510a;

        public C11236a(Long l) {
            this.f66510a = l;
        }
        ...
        public void increment(long j) {
            Long l = this.f66510a;
            if (l != null) {
                this.f66510a = Long.valueOf(l.longValue() + j);
                return;
            }
