...
@DebugMetadata(m28801c = "io.realm.internal.coroutines.InternalFlowFactory$changesetFrom$2", m28800f = "InternalFlowFactory.kt", m28799i = {}, m28798l = {266, 292}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
...
public final class InternalFlowFactory$changesetFrom$2 extends SuspendLambda implements Function2<ProducerScope<? super CollectionChange<RealmResults<T>>>, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes5.dex */
    public static final class C113301 extends Lambda implements Function0<Unit> {
        public static final C113301 INSTANCE = new C113301();
    ...
    /* loaded from: classes5.dex */
    public static final class C113312 extends Lambda implements Function0<Unit> {
        ...
        public C113312(DynamicRealm dynamicRealm, RealmResults<T> realmResults, OrderedRealmCollectionChangeListener<RealmResults<T>> orderedRealmCollectionChangeListener) {
            super(0);
    ...
    /* renamed from: a */
    public static /* synthetic */ void m29503a(ProducerScope producerScope, InternalFlowFactory internalFlowFactory, RealmResults realmResults, OrderedCollectionChangeSet orderedCollectionChangeSet) {
        m74068invokeSuspend$lambda0(producerScope, internalFlowFactory, realmResults, orderedCollectionChangeSet);
    }

    /* renamed from: invokeSuspend$lambda-0 */
    public static final void m74068invokeSuspend$lambda0(ProducerScope producerScope, InternalFlowFactory internalFlowFactory, RealmResults realmResults, OrderedCollectionChangeSet orderedCollectionChangeSet) {
        boolean z;
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (!this.$results.isValid()) {
            C113301 c113301 = C113301.INSTANCE;
            this.label = 1;
            if (ProduceKt.awaitClose(producerScope, c113301, this) == coroutine_suspended) {
        ...
        OrderedRealmCollectionChangeListener orderedRealmCollectionChangeListener = new OrderedRealmCollectionChangeListener() { // from class: io.realm.internal.coroutines.b
            ...
            public final void onChange(Object obj2, OrderedCollectionChangeSet orderedCollectionChangeSet) {
                InternalFlowFactory$changesetFrom$2.m29503a(ProducerScope.this, internalFlowFactory, (RealmResults) obj2, orderedCollectionChangeSet);
            }
        };
        ...
        C113312 c113312 = new C113312(dynamicRealm, this.$results, orderedRealmCollectionChangeListener);
        this.label = 2;
        if (ProduceKt.awaitClose(producerScope, c113312, this) == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Unit.INSTANCE;
    }
