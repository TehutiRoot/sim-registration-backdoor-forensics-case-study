...
@Metadata(m28851d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00030\u0002H\u008a@"}, m28850d2 = {"<anonymous>", "", "Lkotlinx/coroutines/channels/ProducerScope;", "Lio/realm/Realm;"}, m28849k = 3, m28848mv = {1, 6, 0}, m28846xi = 48)
@DebugMetadata(m28801c = "io.realm.internal.coroutines.InternalFlowFactory$from$1", m28800f = "InternalFlowFactory.kt", m28799i = {}, m28798l = {64}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
...
public final class InternalFlowFactory$from$1 extends SuspendLambda implements Function2<ProducerScope<? super Realm>, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes5.dex */
    public static final class C113401 extends Lambda implements Function0<Unit> {
        final /* synthetic */ Realm $flowRealm;
        final /* synthetic */ RealmChangeListener<Realm> $listener;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C113401(Realm realm, RealmChangeListener<Realm> realmChangeListener) {
            super(0);
    ...
    /* renamed from: a */
    public static /* synthetic */ void m29498a(ProducerScope producerScope, InternalFlowFactory internalFlowFactory, Realm realm, Realm realm2) {
        m74073invokeSuspend$lambda0(producerScope, internalFlowFactory, realm, realm2);
    }

    /* renamed from: invokeSuspend$lambda-0 */
    public static final void m74073invokeSuspend$lambda0(ProducerScope producerScope, InternalFlowFactory internalFlowFactory, Realm realm, Realm realm2) {
        boolean z;
        if (CoroutineScopeKt.isActive(producerScope)) {
            ...
            producerScope.mo74066trySendJP2dKIU(realm2);
        }
    }
        ...
        if (i != 0) {
            ...
            RealmChangeListener<Realm> realmChangeListener = new RealmChangeListener() { // from class: io.realm.internal.coroutines.g
                ...
                public final void onChange(Object obj2) {
                    InternalFlowFactory$from$1.m29498a(ProducerScope.this, internalFlowFactory, realm, (Realm) obj2);
                }
            };
            ...
            C113401 c113401 = new C113401(flowRealm, realmChangeListener);
            this.label = 1;
            if (ProduceKt.awaitClose(producerScope, c113401, this) == coroutine_suspended) {
