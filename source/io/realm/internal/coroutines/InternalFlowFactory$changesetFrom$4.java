...
@DebugMetadata(m28801c = "io.realm.internal.coroutines.InternalFlowFactory$changesetFrom$4", m28800f = "InternalFlowFactory.kt", m28799i = {}, m28798l = {467, 495}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
...
public final class InternalFlowFactory$changesetFrom$4 extends SuspendLambda implements Function2<ProducerScope<? super CollectionChange<RealmList<T>>>, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes5.dex */
    public static final class C113341 extends Lambda implements Function0<Unit> {
        public static final C113341 INSTANCE = new C113341();
    ...
    /* loaded from: classes5.dex */
    public static final class C113352 extends Lambda implements Function0<Unit> {
        ...
        public C113352(DynamicRealm dynamicRealm, RealmList<T> realmList, OrderedRealmCollectionChangeListener<RealmList<T>> orderedRealmCollectionChangeListener) {
            super(0);
    ...
    /* renamed from: a */
    public static /* synthetic */ void m29501a(ProducerScope producerScope, InternalFlowFactory internalFlowFactory, RealmList realmList, OrderedCollectionChangeSet orderedCollectionChangeSet) {
        m74070invokeSuspend$lambda0(producerScope, internalFlowFactory, realmList, orderedCollectionChangeSet);
    }

    /* renamed from: invokeSuspend$lambda-0 */
    public static final void m74070invokeSuspend$lambda0(ProducerScope producerScope, InternalFlowFactory internalFlowFactory, RealmList realmList, OrderedCollectionChangeSet orderedCollectionChangeSet) {
        boolean z;
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (!this.$list.isValid()) {
            C113341 c113341 = C113341.INSTANCE;
            this.label = 1;
            if (ProduceKt.awaitClose(producerScope, c113341, this) == coroutine_suspended) {
        ...
        OrderedRealmCollectionChangeListener orderedRealmCollectionChangeListener = new OrderedRealmCollectionChangeListener() { // from class: io.realm.internal.coroutines.d
            ...
            public final void onChange(Object obj2, OrderedCollectionChangeSet orderedCollectionChangeSet) {
                InternalFlowFactory$changesetFrom$4.m29501a(ProducerScope.this, internalFlowFactory, (RealmList) obj2, orderedCollectionChangeSet);
            }
        };
        ...
        C113352 c113352 = new C113352(dynamicRealm, this.$list, orderedRealmCollectionChangeListener);
        this.label = 2;
        if (ProduceKt.awaitClose(producerScope, c113352, this) == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Unit.INSTANCE;
    }
