...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\b\b\u0000\u0010\u0002*\u00020\u0003*\b\u0012\u0004\u0012\u0002H\u00020\u0004H\u008a@"}, m28850d2 = {"<anonymous>", "", "T", "Lio/realm/RealmModel;", "Lkotlinx/coroutines/channels/ProducerScope;"}, m28849k = 3, m28848mv = {1, 6, 0}, m28846xi = 48)
@DebugMetadata(m28801c = "io.realm.internal.coroutines.InternalFlowFactory$from$7", m28800f = "InternalFlowFactory.kt", m28799i = {}, m28798l = {517, 545}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
...
public final class InternalFlowFactory$from$7 extends SuspendLambda implements Function2<ProducerScope<? super T>, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes5.dex */
    public static final class C113501 extends Lambda implements Function0<Unit> {
        public static final C113501 INSTANCE = new C113501();
    ...
    /* loaded from: classes5.dex */
    public static final class C113512 extends Lambda implements Function0<Unit> {
        final /* synthetic */ Realm $flowRealm;
        final /* synthetic */ RealmChangeListener<T> $listener;
        final /* synthetic */ RealmModel $realmObject;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C113512(Realm realm, RealmModel realmModel, RealmChangeListener realmChangeListener) {
            super(0);
    ...
    /* renamed from: a */
    public static /* synthetic */ void m29492a(ProducerScope producerScope, InternalFlowFactory internalFlowFactory, RealmModel realmModel) {
        m74079invokeSuspend$lambda0(producerScope, internalFlowFactory, realmModel);
    }

    /* renamed from: invokeSuspend$lambda-0 */
    public static final void m74079invokeSuspend$lambda0(ProducerScope producerScope, InternalFlowFactory internalFlowFactory, RealmModel realmModel) {
        boolean z;
        if (CoroutineScopeKt.isActive(producerScope)) {
            ...
            producerScope.mo74066trySendJP2dKIU(realmModel);
        }
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.$realm.isClosed()) {
            C113501 c113501 = C113501.INSTANCE;
            this.label = 1;
            if (ProduceKt.awaitClose(producerScope, c113501, this) == coroutine_suspended) {
        ...
        RealmChangeListener realmChangeListener = new RealmChangeListener() { // from class: io.realm.internal.coroutines.m
            ...
            public final void onChange(Object obj2) {
                InternalFlowFactory$from$7.m29492a(ProducerScope.this, internalFlowFactory, (RealmModel) obj2);
            }
        };
        ...
        if (RealmObject.isLoaded(this.$realmObject)) {
            ...
            if (z) {
                ...
                producerScope.mo74066trySendJP2dKIU(this.$realmObject);
            }
        }
        C113512 c113512 = new C113512(realm, this.$realmObject, realmChangeListener);
        this.label = 2;
        if (ProduceKt.awaitClose(producerScope, c113512, this) == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Unit.INSTANCE;
    }
