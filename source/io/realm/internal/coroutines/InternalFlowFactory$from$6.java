...
@DebugMetadata(m28801c = "io.realm.internal.coroutines.InternalFlowFactory$from$6", m28800f = "InternalFlowFactory.kt", m28799i = {}, m28798l = {415, WebSocket.DEFAULT_WSS_PORT}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
...
public final class InternalFlowFactory$from$6 extends SuspendLambda implements Function2<ProducerScope<? super RealmList<T>>, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes5.dex */
    public static final class C113481 extends Lambda implements Function0<Unit> {
        public static final C113481 INSTANCE = new C113481();
    ...
    /* loaded from: classes5.dex */
    public static final class C113492 extends Lambda implements Function0<Unit> {
        final /* synthetic */ DynamicRealm $flowRealm;
        final /* synthetic */ RealmChangeListener<RealmList<T>> $listener;
        final /* synthetic */ RealmList<T> $realmList;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C113492(DynamicRealm dynamicRealm, RealmList<T> realmList, RealmChangeListener<RealmList<T>> realmChangeListener) {
            super(0);
    ...
    /* renamed from: a */
    public static /* synthetic */ void m29493a(ProducerScope producerScope, InternalFlowFactory internalFlowFactory, RealmList realmList) {
        m74078invokeSuspend$lambda0(producerScope, internalFlowFactory, realmList);
    }

    /* renamed from: invokeSuspend$lambda-0 */
    public static final void m74078invokeSuspend$lambda0(ProducerScope producerScope, InternalFlowFactory internalFlowFactory, RealmList realmList) {
        boolean z;
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (!this.$realmList.isValid()) {
            C113481 c113481 = C113481.INSTANCE;
            this.label = 1;
            if (ProduceKt.awaitClose(producerScope, c113481, this) == coroutine_suspended) {
        ...
        RealmChangeListener realmChangeListener = new RealmChangeListener() { // from class: io.realm.internal.coroutines.l
            ...
            public final void onChange(Object obj2) {
                InternalFlowFactory$from$6.m29493a(ProducerScope.this, internalFlowFactory, (RealmList) obj2);
            }
        };
        ...
        C113492 c113492 = new C113492(dynamicRealm, this.$realmList, realmChangeListener);
        this.label = 2;
        if (ProduceKt.awaitClose(producerScope, c113492, this) == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Unit.INSTANCE;
    }
