...
public class ObjectServerFacade {
    ...
    /* renamed from: a */
    public static final ObjectServerFacade f66679a = new ObjectServerFacade();

    /* renamed from: b */
    public static ObjectServerFacade f66680b;
    ...
    static {
        f66680b = null;
        try {
            f66680b = (ObjectServerFacade) Class.forName("io.realm.internal.SyncObjectServerFacade").getDeclaredConstructor(null).newInstance(null);
    ...
    public static ObjectServerFacade getSyncFacadeIfPossible() {
        ObjectServerFacade objectServerFacade = f66680b;
