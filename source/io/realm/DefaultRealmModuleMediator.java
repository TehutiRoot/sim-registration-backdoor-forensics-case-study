...
class DefaultRealmModuleMediator extends RealmProxyMediator {
    ...
    /* renamed from: a */
    public static final Set f66491a;

    static {
        HashSet hashSet = new HashSet(2);
        hashSet.add(SettingModel.class);
        hashSet.add(CacheModel.class);
        f66491a = Collections.unmodifiableSet(hashSet);
    }
    ...
    public RealmModel copyOrUpdate(Realm realm, RealmModel realmModel, boolean z, Map map, Set set) {
        ...
        if (cls.equals(SettingModel.class)) {
            return (RealmModel) cls.cast(th_co_dtac_android_dtacone_model_database_SettingModelRealmProxy.copyOrUpdate(realm, (th_co_dtac_android_dtacone_model_database_SettingModelRealmProxy.C11484a) realm.getSchema().m29584d(SettingModel.class), (SettingModel) realmModel, z, map, set));
        }
        if (cls.equals(CacheModel.class)) {
            return (RealmModel) cls.cast(th_co_dtac_android_dtacone_model_database_CacheModelRealmProxy.copyOrUpdate(realm, (th_co_dtac_android_dtacone_model_database_CacheModelRealmProxy.C11482a) realm.getSchema().m29584d(CacheModel.class), (CacheModel) realmModel, z, map, set));
        }
