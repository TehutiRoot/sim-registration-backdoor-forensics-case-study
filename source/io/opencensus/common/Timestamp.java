...
public abstract class Timestamp implements Comparable<Timestamp> {
    /* renamed from: a */
    public static long m30270a(long j, long j2) {
        return BigDecimal.valueOf(j).divide(BigDecimal.valueOf(j2), 0, RoundingMode.FLOOR).longValue();
    }

    /* renamed from: b */
    public static long m30269b(long j, long j2) {
        return j - (m30270a(j, j2) * j2);
    }

    /* renamed from: c */
    public static Timestamp m30268c(long j, long j2) {
        return create(AbstractC21420oT1.m25919a(j, m30270a(j2, 1000000000L)), (int) m30269b(j2, 1000000000L));
    }
    ...
    public static Timestamp fromMillis(long j) {
        return create(m30270a(j, 1000L), (int) (((int) m30269b(j, 1000L)) * 1000000));
    }

    public Timestamp addDuration(Duration duration) {
        return m30267d(duration.getSeconds(), duration.getNanos());
    }
    ...
    /* renamed from: d */
    public final Timestamp m30267d(long j, long j2) {
        if ((j | j2) == 0) {
            return this;
        }
        return m30268c(AbstractC21420oT1.m25919a(AbstractC21420oT1.m25919a(getSeconds(), j), j2 / 1000000000), getNanos() + (j2 % 1000000000));
    }
    ...
    public int compareTo(Timestamp timestamp) {
        int m25918b = AbstractC21420oT1.m25918b(getSeconds(), timestamp.getSeconds());
        return m25918b != 0 ? m25918b : AbstractC21420oT1.m25918b(getNanos(), timestamp.getNanos());
    }
}
