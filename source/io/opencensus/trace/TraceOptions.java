...
public final class TraceOptions {
    ...
    public static final class Builder {
        ...
        public TraceOptions build() {
            return TraceOptions.fromByte(this.f63690a);
        }
        ...
        public Builder setIsSampled(boolean z) {
            if (z) {
                this.f63690a = (byte) (this.f63690a | 1);
            } else {
                this.f63690a = (byte) (this.f63690a & (-2));
            }
            return this;
        }
    }
    ...
    public static TraceOptions fromLowerBase16(CharSequence charSequence, int i) {
        return new TraceOptions(AbstractC10235fb.m31294c(charSequence, i));
    }

    /* renamed from: a */
    public final boolean m30152a(int i) {
        if ((i & this.f63689a) != 0) {
            return true;
        }
        return false;
    ...
    public void copyLowerBase16To(char[] cArr, int i) {
        AbstractC10235fb.m31292e(this.f63689a, cArr, i);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if ((obj instanceof TraceOptions) && this.f63689a == ((TraceOptions) obj).f63689a) {
            return true;
        }
        return false;
    }
    ...
    public byte[] getBytes() {
        return new byte[]{this.f63689a};
    }

    public int hashCode() {
        return Arrays.hashCode(new byte[]{this.f63689a});
    }
    ...
    public static Builder builder(TraceOptions traceOptions) {
        return new Builder(traceOptions.f63689a);
    }
