...
import io.opencensus.trace.C10729h;
...
public abstract class NetworkEvent extends BaseMessageEvent {
    ...
    public static abstract class Builder {
        /* renamed from: a */
        public abstract Builder mo30132a(long j);
    ...
    public static Builder builder(Type type, long j) {
        return new C10729h.C10731b().m30131b((Type) Utils.checkNotNull(type, "type")).mo30132a(j).setUncompressedMessageSize(0L).setCompressedMessageSize(0L);
    }
