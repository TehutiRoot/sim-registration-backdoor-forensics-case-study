...
public final class Status {
    ...
    /* renamed from: a */
    public final CanonicalCode f63683a;

    /* renamed from: b */
    public final String f63684b;

    /* renamed from: c */
    public static final List f63682c = m30154b();

    /* renamed from: OK */
    public static final Status f63681OK = CanonicalCode.OK.toStatus();
    ...
    public enum CanonicalCode {
        ...
        public Status toStatus() {
            return (Status) Status.f63682c.get(this.value);
        }
    ...
    public Status(CanonicalCode canonicalCode, String str) {
        this.f63683a = (CanonicalCode) Utils.checkNotNull(canonicalCode, "canonicalCode");
        this.f63684b = str;
    }

    /* renamed from: b */
    public static List m30154b() {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (this.f63683a == status.f63683a && Utils.equalsObjects(this.f63684b, status.f63684b)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return Arrays.hashCode(new Object[]{this.f63683a, this.f63684b});
    }

    public boolean isOk() {
        if (CanonicalCode.OK == this.f63683a) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return "Status{canonicalCode=" + this.f63683a + ", description=" + this.f63684b + "}";
    }

    public Status withDescription(@Nullable String str) {
        if (Utils.equalsObjects(this.f63684b, str)) {
            return this;
        }
        return new Status(this.f63683a, str);
    }
}
