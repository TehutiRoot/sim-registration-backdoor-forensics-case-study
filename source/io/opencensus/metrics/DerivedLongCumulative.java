...
public abstract class DerivedLongCumulative {
    ...
    /* loaded from: classes5.dex */
    public static final class C10584a extends DerivedLongCumulative {

        /* renamed from: a */
        public final int f63522a;

        public C10584a(String str, String str2, String str3, List list) {
            ...
            this.f63522a = list.size();
        }

        /* renamed from: b */
        public static C10584a m30254b(String str, String str2, String str3, List list) {
            return new C10584a(str, str2, str3, list);
        }
    ...
    /* renamed from: a */
    public static DerivedLongCumulative m30255a(String str, String str2, String str3, List list) {
        return C10584a.m30254b(str, str2, str3, list);
    }
