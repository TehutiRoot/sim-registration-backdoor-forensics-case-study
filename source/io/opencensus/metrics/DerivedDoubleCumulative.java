...
public abstract class DerivedDoubleCumulative {
    ...
    /* loaded from: classes5.dex */
    public static final class C10582a extends DerivedDoubleCumulative {

        /* renamed from: a */
        public final int f63520a;

        public C10582a(String str, String str2, String str3, List list) {
            ...
            this.f63520a = list.size();
        }

        /* renamed from: b */
        public static C10582a m30258b(String str, String str2, String str3, List list) {
            return new C10582a(str, str2, str3, list);
        }
    ...
    /* renamed from: a */
    public static DerivedDoubleCumulative m30259a(String str, String str2, String str3, List list) {
        return C10582a.m30258b(str, str2, str3, list);
    }
