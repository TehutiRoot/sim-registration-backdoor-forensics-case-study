...
public abstract class SequenceScope<T> {
    ...
    public final Object yieldAll(@NotNull Iterable<? extends T> iterable, @NotNull Continuation<? super Unit> continuation) {
        Object yieldAll;
        return (!((iterable instanceof Collection) && ((Collection) iterable).isEmpty()) && (yieldAll = yieldAll(iterable.iterator(), continuation)) == AbstractC18812Yf0.getCOROUTINE_SUSPENDED()) ? yieldAll : Unit.INSTANCE;
    }
    ...
    public final Object yieldAll(@NotNull Sequence<? extends T> sequence, @NotNull Continuation<? super Unit> continuation) {
        ...
        return yieldAll == AbstractC18812Yf0.getCOROUTINE_SUSPENDED() ? yieldAll : Unit.INSTANCE;
    }
}
