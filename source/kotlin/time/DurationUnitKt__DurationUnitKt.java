...
public abstract class DurationUnitKt__DurationUnitKt extends DurationUnitKt__DurationUnitJvmKt {
        ...
        if (hashCode != 100) {
            if (hashCode != 104) {
                if (hashCode != 109) {
                    ...
                    } else if (shortName.equals(OperatorName.CLOSE_AND_STROKE)) {
                        return DurationUnit.SECONDS;
                    }
                } else if (shortName.equals(OperatorName.MOVE_TO)) {
                    return DurationUnit.MINUTES;
                }
            } else if (shortName.equals(OperatorName.CLOSE_PATH)) {
                return DurationUnit.HOURS;
            }
