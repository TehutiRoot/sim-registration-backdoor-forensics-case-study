...
public final class ComparisonsKt__ComparisonsKt$thenComparator$1<T> implements Comparator {
    ...
    /* renamed from: a */
    public final /* synthetic */ Comparator f68177a;

    /* renamed from: b */
    public final /* synthetic */ Function2 f68178b;

    public ComparisonsKt__ComparisonsKt$thenComparator$1(Comparator<T> comparator, Function2<? super T, ? super T, Integer> function2) {
        this.f68177a = comparator;
        this.f68178b = function2;
    }

    @Override // java.util.Comparator
    public final int compare(T t, T t2) {
        int compare = this.f68177a.compare(t, t2);
        if (compare == 0) {
            return ((Number) this.f68178b.invoke(t, t2)).intValue();
        }
        return compare;
    }
}
