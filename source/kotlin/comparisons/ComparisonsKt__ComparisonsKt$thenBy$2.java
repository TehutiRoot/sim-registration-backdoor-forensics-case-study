...
public final class ComparisonsKt__ComparisonsKt$thenBy$2<T> implements Comparator {
    ...
    /* renamed from: a */
    public final /* synthetic */ Comparator f68169a;

    /* renamed from: b */
    public final /* synthetic */ Comparator f68170b;
    ...
    public ComparisonsKt__ComparisonsKt$thenBy$2(Comparator<T> comparator, Comparator<Object> comparator2, Function1<? super T, Object> function1) {
        ...
        this.f68170b = comparator2;
        this.f68171c = function1;
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // java.util.Comparator
    public final int compare(T t, T t2) {
        int compare = this.f68169a.compare(t, t2);
        if (compare == 0) {
            Comparator comparator = this.f68170b;
            Function1 function1 = this.f68171c;
