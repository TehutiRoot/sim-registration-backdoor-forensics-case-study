...
public final class ComparisonsKt__ComparisonsKt$thenBy$1<T> implements Comparator {
    ...
    /* renamed from: a */
    public final /* synthetic */ Comparator f68167a;

    /* renamed from: b */
    public final /* synthetic */ Function1 f68168b;
    ...
    public final int compare(T t, T t2) {
        int compare = this.f68167a.compare(t, t2);
        if (compare == 0) {
            Function1 function1 = this.f68168b;
            return AbstractC16857uu.compareValues((Comparable) function1.invoke(t), (Comparable) function1.invoke(t2));
        }
        return compare;
    }
}
