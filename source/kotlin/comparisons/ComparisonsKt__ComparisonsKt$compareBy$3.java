...
public final class ComparisonsKt__ComparisonsKt$compareBy$3<T> implements Comparator {
    ...
    /* renamed from: a */
    public final /* synthetic */ Comparator f68162a;

    /* renamed from: b */
    public final /* synthetic */ Function1 f68163b;

    public ComparisonsKt__ComparisonsKt$compareBy$3(Comparator<Object> comparator, Function1<? super T, Object> function1) {
        this.f68162a = comparator;
        this.f68163b = function1;
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // java.util.Comparator
    public final int compare(T t, T t2) {
        Comparator comparator = this.f68162a;
        Function1 function1 = this.f68163b;
