...
public final class ComparisonsKt__ComparisonsKt$compareByDescending$2<T> implements Comparator {
    ...
    /* renamed from: a */
    public final /* synthetic */ Comparator f68165a;

    /* renamed from: b */
    public final /* synthetic */ Function1 f68166b;
    ...
    public ComparisonsKt__ComparisonsKt$compareByDescending$2(Comparator<Object> comparator, Function1<? super T, Object> function1) {
        this.f68165a = comparator;
        this.f68166b = function1;
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // java.util.Comparator
    public final int compare(T t, T t2) {
        Comparator comparator = this.f68165a;
        Function1 function1 = this.f68166b;
