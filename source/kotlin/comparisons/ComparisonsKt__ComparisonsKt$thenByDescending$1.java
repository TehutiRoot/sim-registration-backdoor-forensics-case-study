...
public final class ComparisonsKt__ComparisonsKt$thenByDescending$1<T> implements Comparator {
    ...
    /* renamed from: a */
    public final /* synthetic */ Comparator f68172a;

    /* renamed from: b */
    public final /* synthetic */ Function1 f68173b;
    ...
    public ComparisonsKt__ComparisonsKt$thenByDescending$1(Comparator<T> comparator, Function1<? super T, ? extends Comparable<?>> function1) {
        this.f68172a = comparator;
        this.f68173b = function1;
    }

    @Override // java.util.Comparator
    public final int compare(T t, T t2) {
        int compare = this.f68172a.compare(t, t2);
        if (compare == 0) {
            Function1 function1 = this.f68173b;
