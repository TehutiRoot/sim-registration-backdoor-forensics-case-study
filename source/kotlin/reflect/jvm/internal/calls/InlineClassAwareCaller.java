...
public final class InlineClassAwareCaller<M extends Member> implements Caller<M> {
    ...
    /* renamed from: a */
    public final Caller f68500a;

    /* renamed from: b */
    public final boolean f68501b;

    /* renamed from: c */
    public final C11732a f68502c;
    ...
    public static final class C11732a {
        ...
        /* renamed from: a */
        public final IntRange f68503a;

        /* renamed from: b */
        public final Method[] f68504b;

        /* renamed from: c */
        public final Method f68505c;

        public C11732a(IntRange argumentRange, Method[] unbox, Method method) {
            Intrinsics.checkNotNullParameter(argumentRange, "argumentRange");
            Intrinsics.checkNotNullParameter(unbox, "unbox");
            this.f68503a = argumentRange;
            this.f68504b = unbox;
            this.f68505c = method;
        }

        /* renamed from: a */
        public final IntRange m28638a() {
            return this.f68503a;
        }

        /* renamed from: b */
        public final Method[] m28637b() {
            return this.f68504b;
        }

        /* renamed from: c */
        public final Method m28636c() {
            return this.f68505c;
        }
    }
    ...
    */
    ...
    public Object call(@NotNull Object[] args) {
        ...
        C11732a c11732a = this.f68502c;
        IntRange m28638a = c11732a.m28638a();
        Method[] m28637b = c11732a.m28637b();
        Method m28636c = c11732a.m28636c();
        Object[] copyOf = Arrays.copyOf(args, args.length);
        Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(this, size)");
        int first = m28638a.getFirst();
        int last = m28638a.getLast();
        if (first <= last) {
            while (true) {
                Method method = m28637b[first];
        ...
        Object call = this.f68500a.call(copyOf);
        if (m28636c != null && (invoke = m28636c.invoke(null, call)) != null) {
            return invoke;
        }
        return call;
    }
    ...
    @Override // kotlin.reflect.jvm.internal.calls.Caller
    public M getMember() {
        return (M) this.f68500a.getMember();
    }

    @Override // kotlin.reflect.jvm.internal.calls.Caller
    @NotNull
    public List<Type> getParameterTypes() {
        return this.f68500a.getParameterTypes();
    }

    @Override // kotlin.reflect.jvm.internal.calls.Caller
    @NotNull
    public Type getReturnType() {
        return this.f68500a.getReturnType();
    }
}
