...
public final class InlineClassManglingRulesKt {
    /* renamed from: a */
    public static final boolean m27744a(ClassDescriptor classDescriptor) {
        return Intrinsics.areEqual(DescriptorUtilsKt.getFqNameSafe(classDescriptor), StandardNames.RESULT_FQ_NAME);
    }

    /* renamed from: b */
    public static final boolean m27743b(KotlinType kotlinType) {
        ...
        return m27742c(TypeUtilsKt.getRepresentativeUpperBound(typeParameterDescriptor));
    }

    /* renamed from: c */
    public static final boolean m27742c(KotlinType kotlinType) {
        if (!isInlineClassThatRequiresMangling(kotlinType) && !m27743b(kotlinType)) {
            return false;
        }
        return true;
    }
    ...
    public static final boolean isInlineClassThatRequiresMangling(@NotNull DeclarationDescriptor declarationDescriptor) {
        ...
        return InlineClassesUtilsKt.isInlineClass(declarationDescriptor) && !m27744a((ClassDescriptor) declarationDescriptor);
    }
