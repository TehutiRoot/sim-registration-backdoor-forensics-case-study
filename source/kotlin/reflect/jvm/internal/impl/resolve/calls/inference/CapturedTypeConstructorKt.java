...
public final class CapturedTypeConstructorKt {
    /* renamed from: a */
    public static final TypeProjection m27759a(TypeProjection typeProjection, TypeParameterDescriptor typeParameterDescriptor) {
    ...
    public static final TypeSubstitution wrapWithCapturingSubstitution(@NotNull final TypeSubstitution typeSubstitution, final boolean z) {
        ...
        if (typeSubstitution instanceof IndexedParametersSubstitution) {
            ...
            ArrayList arrayList = new ArrayList(AbstractC10176es.collectionSizeOrDefault(zip, 10));
            for (Pair pair : zip) {
                arrayList.add(m27759a((TypeProjection) pair.getFirst(), (TypeParameterDescriptor) pair.getSecond()));
            }
        ...
        return new DelegatedTypeSubstitution(typeSubstitution) { // from class: kotlin.reflect.jvm.internal.impl.resolve.calls.inference.CapturedTypeConstructorKt$wrapWithCapturingSubstitution$2
            ...
            public TypeProjection get(@NotNull KotlinType key) {
                ...
                m27759a = CapturedTypeConstructorKt.m27759a(typeProjection, typeParameterDescriptor);
                return m27759a;
            }
        };
    }
