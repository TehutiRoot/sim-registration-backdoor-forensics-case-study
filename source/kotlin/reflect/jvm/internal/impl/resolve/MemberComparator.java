...
public class MemberComparator implements Comparator<DeclarationDescriptor> {
    ...
    /* renamed from: a */
    public static final DescriptorRenderer f69869a = DescriptorRenderer.Companion.withOptions(new C11942a());
    ...
    public static class NameAndTypeMemberComparator implements Comparator<DeclarationDescriptor> {
        ...
        /* renamed from: b */
        public static Integer m27791b(DeclarationDescriptor declarationDescriptor, DeclarationDescriptor declarationDescriptor2) {
            int m27790c = m27790c(declarationDescriptor2) - m27790c(declarationDescriptor);
            if (m27790c != 0) {
                return Integer.valueOf(m27790c);
            }
        ...
        /* renamed from: c */
        public static int m27790c(DeclarationDescriptor declarationDescriptor) {
        ...
        public int compare(DeclarationDescriptor declarationDescriptor, DeclarationDescriptor declarationDescriptor2) {
            Integer m27791b = m27791b(declarationDescriptor, declarationDescriptor2);
            if (m27791b != null) {
                return m27791b.intValue();
            }
            return 0;
        }
    }
    ...
    /* loaded from: classes6.dex */
    public static class C11942a implements Function1 {
    ...
    public int compare(DeclarationDescriptor declarationDescriptor, DeclarationDescriptor declarationDescriptor2) {
        int ordinal;
        Integer m27791b = NameAndTypeMemberComparator.m27791b(declarationDescriptor, declarationDescriptor2);
        if (m27791b != null) {
            return m27791b.intValue();
        }
        if ((declarationDescriptor instanceof TypeAliasDescriptor) && (declarationDescriptor2 instanceof TypeAliasDescriptor)) {
            DescriptorRenderer descriptorRenderer = f69869a;
            ...
            if (extensionReceiverParameter != null) {
                DescriptorRenderer descriptorRenderer2 = f69869a;
            ...
            for (int i = 0; i < Math.min(valueParameters.size(), valueParameters2.size()); i++) {
                DescriptorRenderer descriptorRenderer3 = f69869a;
            ...
            for (int i2 = 0; i2 < Math.min(typeParameters.size(), typeParameters2.size()); i2++) {
                ...
                for (int i3 = 0; i3 < upperBounds.size(); i3++) {
                    DescriptorRenderer descriptorRenderer4 = f69869a;
        ...
        DescriptorRenderer descriptorRenderer5 = f69869a;
