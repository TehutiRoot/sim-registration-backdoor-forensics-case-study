...
public final class ConstantValueFactory {
    ...
    /* renamed from: a */
    public final ArrayValue m27756a(List list, ModuleDescriptor moduleDescriptor, PrimitiveType primitiveType) {
        ArrayList arrayList = new ArrayList();
        for (Object obj : CollectionsKt___CollectionsKt.toList(list)) {
    ...
    public final ConstantValue<?> createConstantValue(@Nullable Object obj, @Nullable ModuleDescriptor moduleDescriptor) {
        ...
        if (obj instanceof byte[]) {
            return m27756a(ArraysKt___ArraysKt.toList((byte[]) obj), moduleDescriptor, PrimitiveType.BYTE);
        }
        if (obj instanceof short[]) {
            return m27756a(ArraysKt___ArraysKt.toList((short[]) obj), moduleDescriptor, PrimitiveType.SHORT);
        }
        if (obj instanceof int[]) {
            return m27756a(ArraysKt___ArraysKt.toList((int[]) obj), moduleDescriptor, PrimitiveType.INT);
        }
        if (obj instanceof long[]) {
            return m27756a(ArraysKt___ArraysKt.toList((long[]) obj), moduleDescriptor, PrimitiveType.LONG);
        }
        if (obj instanceof char[]) {
            return m27756a(ArraysKt___ArraysKt.toList((char[]) obj), moduleDescriptor, PrimitiveType.CHAR);
        }
        if (obj instanceof float[]) {
            return m27756a(ArraysKt___ArraysKt.toList((float[]) obj), moduleDescriptor, PrimitiveType.FLOAT);
        }
        if (obj instanceof double[]) {
            return m27756a(ArraysKt___ArraysKt.toList((double[]) obj), moduleDescriptor, PrimitiveType.DOUBLE);
        }
        if (obj instanceof boolean[]) {
            return m27756a(ArraysKt___ArraysKt.toList((boolean[]) obj), moduleDescriptor, PrimitiveType.BOOLEAN);
        }
        if (obj == null) {
