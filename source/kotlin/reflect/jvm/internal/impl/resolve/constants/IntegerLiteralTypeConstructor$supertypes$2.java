...
public final class IntegerLiteralTypeConstructor$supertypes$2 extends Lambda implements Function0<List<SimpleType>> {
    ...
    public final List<SimpleType> invoke() {
        ...
        simpleType = this.this$0.f69910d;
        List<SimpleType> mutableListOf = CollectionsKt__CollectionsKt.mutableListOf(TypeSubstitutionKt.replace$default(defaultType, AbstractC10108ds.listOf(new TypeProjectionImpl(variance, simpleType)), null, 2, null));
        m27754b = this.this$0.m27754b();
        if (!m27754b) {
