...
public final class KClassValue extends ConstantValue<Value> {
    ...
    public static final class Companion {
        ...
        public final ConstantValue<?> create(@NotNull KotlinType argumentType) {
            ...
            while (KotlinBuiltIns.isArray(kotlinType)) {
                kotlinType = ((TypeProjection) CollectionsKt___CollectionsKt.single((List<? extends Object>) kotlinType.getArguments())).getType();
    ...
    public static abstract class Value {
        ...
        public static final class LocalClass extends Value {
            ...
            /* renamed from: a */
            public final KotlinType f69915a;
            ...
            public boolean equals(@Nullable Object obj) {
                ...
                return (obj instanceof LocalClass) && Intrinsics.areEqual(this.f69915a, ((LocalClass) obj).f69915a);
            }
            ...
            public String toString() {
                return "LocalClass(type=" + this.f69915a + CoreConstants.RIGHT_PARENTHESIS_CHAR;
            }
        }
        ...
        public static final class NormalClass extends Value {
            ...
            /* renamed from: a */
            public final ClassLiteralValue f69916a;
            ...
            public boolean equals(@Nullable Object obj) {
                ...
                return (obj instanceof NormalClass) && Intrinsics.areEqual(this.f69916a, ((NormalClass) obj).f69916a);
            }

            public final int getArrayDimensions() {
                return this.f69916a.getArrayNestedness();
            }

            @NotNull
            public final ClassId getClassId() {
                return this.f69916a.getClassId();
            }
            ...
            @NotNull
            public String toString() {
                return "NormalClass(value=" + this.f69916a + CoreConstants.RIGHT_PARENTHESIS_CHAR;
            }
        }
    ...
    public KotlinType getType(@NotNull ModuleDescriptor module) {
        ...
        return KotlinTypeFactory.simpleNotNullType(empty, kClass, AbstractC10108ds.listOf(new TypeProjectionImpl(getArgumentType(module))));
    }
