...
public final class CliSealedClassInheritorsProvider extends SealedClassInheritorsProvider {
    ...
    /* renamed from: a */
    public static final void m27807a(ClassDescriptor classDescriptor, LinkedHashSet linkedHashSet, MemberScope memberScope, boolean z) {
            ...
            if (declarationDescriptor instanceof ClassDescriptor) {
                ...
                if (classDescriptor2 != null) {
                    ...
                    if (z) {
                        ...
                        m27807a(classDescriptor, linkedHashSet, unsubstitutedInnerClassesScope, z);
                    }
                }
            }
        }
    ...
    public Collection<ClassDescriptor> computeSealedSubclasses(@NotNull ClassDescriptor sealedClass, boolean z) {
        ...
        if (declarationDescriptor2 instanceof PackageFragmentDescriptor) {
            m27807a(sealedClass, linkedHashSet, ((PackageFragmentDescriptor) declarationDescriptor2).getMemberScope(), z);
        }
        ...
        m27807a(sealedClass, linkedHashSet, unsubstitutedInnerClassesScope, true);
