...
public final class DescriptorEquivalenceForOverrides {
    ...
    /* renamed from: b */
    public static final boolean m27805b(boolean z, CallableDescriptor a, CallableDescriptor b, TypeConstructor c1, TypeConstructor c2) {
        ...
        if ((declarationDescriptor instanceof TypeParameterDescriptor) && (declarationDescriptor2 instanceof TypeParameterDescriptor)) {
            return INSTANCE.areTypeParametersEquivalent((TypeParameterDescriptor) declarationDescriptor, (TypeParameterDescriptor) declarationDescriptor2, z, new C11940xd7e650be(a, b));
        }
        return false;
    }
    ...
    public final boolean areCallableDescriptorsEquivalent(@NotNull CallableDescriptor a, @NotNull CallableDescriptor b, boolean z, boolean z2, boolean z3, @NotNull KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        if ((Intrinsics.areEqual(a.getContainingDeclaration(), b.getContainingDeclaration()) && (!z || !Intrinsics.areEqual(m27802e(a), m27802e(b)))) || DescriptorUtils.isLocal(a) || DescriptorUtils.isLocal(b) || !m27803d(a, b, C11939xc15c0bd8.INSTANCE, z)) {
            return false;
        }
        OverridingUtil create = OverridingUtil.create(kotlinTypeRefiner, new C12208lG(z, a, b));
    ...
    public final boolean areEquivalent(@Nullable DeclarationDescriptor declarationDescriptor, @Nullable DeclarationDescriptor declarationDescriptor2, boolean z, boolean z2) {
        if ((declarationDescriptor instanceof ClassDescriptor) && (declarationDescriptor2 instanceof ClassDescriptor)) {
            return m27804c((ClassDescriptor) declarationDescriptor, (ClassDescriptor) declarationDescriptor2);
        }
        if ((declarationDescriptor instanceof TypeParameterDescriptor) && (declarationDescriptor2 instanceof TypeParameterDescriptor)) {
    ...
    /* renamed from: c */
    public final boolean m27804c(ClassDescriptor classDescriptor, ClassDescriptor classDescriptor2) {
        return Intrinsics.areEqual(classDescriptor.getTypeConstructor(), classDescriptor2.getTypeConstructor());
    }

    /* renamed from: d */
    public final boolean m27803d(DeclarationDescriptor declarationDescriptor, DeclarationDescriptor declarationDescriptor2, Function2 function2, boolean z) {
    ...
    /* renamed from: e */
    public final SourceElement m27802e(CallableDescriptor callableDescriptor) {
    ...
    public final boolean areTypeParametersEquivalent(@NotNull TypeParameterDescriptor a, @NotNull TypeParameterDescriptor b, boolean z, @NotNull Function2<? super DeclarationDescriptor, ? super DeclarationDescriptor, Boolean> equivalentCallables) {
        ...
        return !Intrinsics.areEqual(a.getContainingDeclaration(), b.getContainingDeclaration()) && m27803d(a, b, equivalentCallables, z) && a.getIndex() == b.getIndex();
    }
}
