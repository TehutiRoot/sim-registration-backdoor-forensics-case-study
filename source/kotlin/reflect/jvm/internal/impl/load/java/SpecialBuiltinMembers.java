...
public final class SpecialBuiltinMembers {
    /* renamed from: a */
    public static final CallableMemberDescriptor m28407a(CallableMemberDescriptor callableMemberDescriptor) {
    ...
    public static final String getJvmMethodNameIfSpecial(@NotNull CallableMemberDescriptor callableMemberDescriptor) {
        ...
        CallableMemberDescriptor m28407a = m28407a(callableMemberDescriptor);
        if (m28407a == null || (propertyIfAccessor = DescriptorUtilsKt.getPropertyIfAccessor(m28407a)) == null) {
            return null;
        }
