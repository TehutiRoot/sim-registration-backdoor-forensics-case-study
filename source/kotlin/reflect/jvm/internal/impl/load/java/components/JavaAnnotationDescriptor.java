...
public class JavaAnnotationDescriptor implements AnnotationDescriptor, PossiblyExternalAnnotationDescriptor {
    ...
    /* renamed from: f */
    public static final /* synthetic */ KProperty[] f69021f = {Reflection.property1(new PropertyReference1Impl(Reflection.getOrCreateKotlinClass(JavaAnnotationDescriptor.class), "type", "getType()Lorg/jetbrains/kotlin/types/SimpleType;"))};

    /* renamed from: a */
    public final FqName f69022a;

    /* renamed from: b */
    public final SourceElement f69023b;

    /* renamed from: c */
    public final NotNullLazyValue f69024c;

    /* renamed from: d */
    public final JavaAnnotationArgument f69025d;
    ...
    public JavaAnnotationDescriptor(@NotNull LazyJavaResolverContext c, @Nullable JavaAnnotation javaAnnotation, @NotNull FqName fqName) {
        ...
        this.f69023b = NO_SOURCE;
        this.f69024c = c.getStorageManager().createLazyValue(new JavaAnnotationDescriptor$type$2(c, this));
        ...
        this.f69025d = javaAnnotationArgument;
        boolean z = false;
    ...
    public SimpleType getType() {
        return (SimpleType) StorageKt.getValue(this.f69024c, this, f69021f[0]);
    }
}
