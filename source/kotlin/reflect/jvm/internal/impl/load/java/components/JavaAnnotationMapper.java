...
public final class JavaAnnotationMapper {
    ...
    /* renamed from: a */
    public static final Name f69028a;

    /* renamed from: b */
    public static final Name f69029b;

    /* renamed from: c */
    public static final Name f69030c;

    /* renamed from: d */
    public static final Map f69031d;
    ...
    static {
        ...
        f69030c = identifier3;
        f69031d = AbstractC11687a.mapOf(TuplesKt.m28844to(StandardNames.FqNames.target, JvmAnnotationNames.TARGET_ANNOTATION), TuplesKt.m28844to(StandardNames.FqNames.retention, JvmAnnotationNames.RETENTION_ANNOTATION), TuplesKt.m28844to(StandardNames.FqNames.mustBeDocumented, JvmAnnotationNames.DOCUMENTED_ANNOTATION));
    }
    ...
    public final AnnotationDescriptor findMappedJavaAnnotation(@NotNull FqName kotlinName, @NotNull JavaAnnotationOwner annotationOwner, @NotNull LazyJavaResolverContext c) {
        ...
        FqName fqName = (FqName) f69031d.get(kotlinName);
