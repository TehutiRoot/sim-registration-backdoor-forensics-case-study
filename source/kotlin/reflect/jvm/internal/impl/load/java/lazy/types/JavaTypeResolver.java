...
public final class JavaTypeResolver {
    ...
    /* renamed from: a */
    public final LazyJavaResolverContext f69198a;

    /* renamed from: b */
    public final TypeParameterResolver f69199b;

    /* renamed from: c */
    public final RawProjectionComputer f69200c;

    /* renamed from: d */
    public final TypeParameterUpperBoundEraser f69201d;
    ...
    public JavaTypeResolver(@NotNull LazyJavaResolverContext c, @NotNull TypeParameterResolver typeParameterResolver) {
        ...
        this.f69198a = c;
        this.f69199b = typeParameterResolver;
        RawProjectionComputer rawProjectionComputer = new RawProjectionComputer();
        this.f69200c = rawProjectionComputer;
        this.f69201d = new TypeParameterUpperBoundEraser(rawProjectionComputer, null, 2, null);
    }

    /* renamed from: k */
    public static final ErrorType m28316k(JavaClassifierType javaClassifierType) {
    ...
    /* renamed from: a */
    public final boolean m28326a(JavaClassifierType javaClassifierType, ClassDescriptor classDescriptor) {
        Variance variance;
    ...
    */
    public final java.util.List m28325b(kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClassifierType r9, kotlin.reflect.jvm.internal.impl.load.java.lazy.types.JavaTypeAttributes r10, kotlin.reflect.jvm.internal.impl.types.TypeConstructor r11) {
        /*
            r8 = this;
            boolean r0 = r9.isRaw()
            r1 = 1
        ...
        L25:
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r0, r2)
            if (r1 == 0) goto L33
            java.util.List r9 = r8.m28324c(r9, r0, r11, r10)
            return r9
        L33:
            int r10 = r0.size()
            ...
            int r10 = p000.AbstractC10176es.collectionSizeOrDefault(r0, r1)
            r9.<init>(r10)
        ...
        L83:
            ...
            int r11 = p000.AbstractC10176es.collectionSizeOrDefault(r9, r1)
            r10.<init>(r11)
        ...
        L9a:
            ...
            kotlin.reflect.jvm.internal.impl.types.TypeProjection r11 = r8.m28315l(r11, r2, r1)
            r10.add(r11)
            goto L9a
        Ld1:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.reflect.jvm.internal.impl.load.java.lazy.types.JavaTypeResolver.m28325b(kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClassifierType, kotlin.reflect.jvm.internal.impl.load.java.lazy.types.JavaTypeAttributes, kotlin.reflect.jvm.internal.impl.types.TypeConstructor):java.util.List");
    }

    /* renamed from: c */
    public final List m28324c(JavaClassifierType javaClassifierType, List list, TypeConstructor typeConstructor, JavaTypeAttributes javaTypeAttributes) {
        ...
        for (TypeParameterDescriptor typeParameterDescriptor : list2) {
            if (TypeUtilsKt.hasTypeParameterRecursiveBounds(typeParameterDescriptor, null, javaTypeAttributes.getVisitedTypeParameters())) {
                ...
                computeProjection = this.f69200c.computeProjection(typeParameterDescriptor, javaTypeAttributes.markIsRaw(javaClassifierType.isRaw()), this.f69201d, new LazyWrappedType(this.f69198a.getStorageManager(), new JavaTypeResolver$computeRawTypeArguments$1$erasedUpperBound$1(this, typeParameterDescriptor, javaTypeAttributes, typeConstructor, javaClassifierType)));
            }
    ...
    /* renamed from: d */
    public final SimpleType m28323d(JavaClassifierType javaClassifierType, JavaTypeAttributes javaTypeAttributes, SimpleType simpleType) {
        TypeAttributes defaultAttributes;
        if (simpleType == null || (defaultAttributes = simpleType.getAttributes()) == null) {
            defaultAttributes = TypeAttributesKt.toDefaultAttributes(new LazyJavaAnnotations(this.f69198a, javaClassifierType, false, 4, null));
        }
        TypeAttributes typeAttributes = defaultAttributes;
        TypeConstructor m28322e = m28322e(javaClassifierType, javaTypeAttributes);
        TypeConstructor typeConstructor = null;
        if (m28322e == null) {
            return null;
        }
        boolean m28319h = m28319h(javaTypeAttributes);
        if (simpleType != null) {
            typeConstructor = simpleType.getConstructor();
        }
        if (Intrinsics.areEqual(typeConstructor, m28322e) && !javaClassifierType.isRaw() && m28319h) {
            return simpleType.makeNullableAsSpecified(true);
        }
        return KotlinTypeFactory.simpleType$default(typeAttributes, m28322e, m28325b(javaClassifierType, javaTypeAttributes, m28322e), m28319h, (KotlinTypeRefiner) null, 16, (Object) null);
    }

    /* renamed from: e */
    public final TypeConstructor m28322e(JavaClassifierType javaClassifierType, JavaTypeAttributes javaTypeAttributes) {
        TypeConstructor typeConstructor;
        JavaClassifier classifier = javaClassifierType.getClassifier();
        if (classifier == null) {
            return m28321f(javaClassifierType);
        }
        if (classifier instanceof JavaClass) {
            JavaClass javaClass = (JavaClass) classifier;
            FqName fqName = javaClass.getFqName();
            if (fqName != null) {
                ClassDescriptor m28318i = m28318i(javaClassifierType, javaTypeAttributes, fqName);
                if (m28318i == null) {
                    m28318i = this.f69198a.getComponents().getModuleClassResolver().resolveClass(javaClass);
                }
                if (m28318i == null || (typeConstructor = m28318i.getTypeConstructor()) == null) {
                    return m28321f(javaClassifierType);
                }
            ...
            TypeParameterDescriptor resolveTypeParameter = this.f69199b.resolveTypeParameter((JavaTypeParameter) classifier);
    ...
    /* renamed from: f */
    public final TypeConstructor m28321f(JavaClassifierType javaClassifierType) {
        ...
        TypeConstructor typeConstructor = this.f69198a.getComponents().getDeserializedDescriptorResolver().getComponents().getNotFoundClasses().getClass(classId, AbstractC10108ds.listOf(0)).getTypeConstructor();
        Intrinsics.checkNotNullExpressionValue(typeConstructor, "c.components.deserialize…istOf(0)).typeConstructor");
        return typeConstructor;
    }

    /* renamed from: g */
    public final boolean m28320g(Variance variance, TypeParameterDescriptor typeParameterDescriptor) {
    ...
    /* renamed from: h */
    public final boolean m28319h(JavaTypeAttributes javaTypeAttributes) {
    ...
    /* renamed from: i */
    public final ClassDescriptor m28318i(JavaClassifierType javaClassifierType, JavaTypeAttributes javaTypeAttributes, FqName fqName) {
        FqName fqName2;
        if (javaTypeAttributes.isForAnnotationParameter()) {
            fqName2 = JavaTypeResolverKt.f69202a;
            if (Intrinsics.areEqual(fqName, fqName2)) {
                return this.f69198a.getComponents().getReflectionTypes().getKClass();
            }
        }
        JavaToKotlinClassMapper javaToKotlinClassMapper = JavaToKotlinClassMapper.INSTANCE;
        ClassDescriptor mapJavaToKotlin$default = JavaToKotlinClassMapper.mapJavaToKotlin$default(javaToKotlinClassMapper, fqName, this.f69198a.getModule().getBuiltIns(), null, 4, null);
        if (mapJavaToKotlin$default == null) {
            return null;
        }
        if (javaToKotlinClassMapper.isReadOnly(mapJavaToKotlin$default) && (javaTypeAttributes.getFlexibility() == JavaTypeFlexibility.FLEXIBLE_LOWER_BOUND || javaTypeAttributes.getHowThisTypeIsUsed() == TypeUsage.SUPERTYPE || m28326a(javaClassifierType, mapJavaToKotlin$default))) {
    ...
    /* renamed from: j */
    public final KotlinType m28317j(JavaClassifierType javaClassifierType, JavaTypeAttributes javaTypeAttributes) {
        boolean z;
        ...
        if (!isRaw && !z) {
            SimpleType m28323d = m28323d(javaClassifierType, javaTypeAttributes, null);
            if (m28323d == null) {
                return m28316k(javaClassifierType);
            }
            return m28323d;
        }
        SimpleType m28323d2 = m28323d(javaClassifierType, javaTypeAttributes.withFlexibility(JavaTypeFlexibility.FLEXIBLE_LOWER_BOUND), null);
        if (m28323d2 == null) {
            return m28316k(javaClassifierType);
        }
        SimpleType m28323d3 = m28323d(javaClassifierType, javaTypeAttributes.withFlexibility(JavaTypeFlexibility.FLEXIBLE_UPPER_BOUND), m28323d2);
        if (m28323d3 == null) {
            return m28316k(javaClassifierType);
        }
        if (isRaw) {
            return new RawTypeImpl(m28323d2, m28323d3);
        }
        return KotlinTypeFactory.flexibleType(m28323d2, m28323d3);
    }

    /* renamed from: l */
    public final TypeProjection m28315l(JavaType javaType, JavaTypeAttributes javaTypeAttributes, TypeParameterDescriptor typeParameterDescriptor) {
        Variance variance;
        ...
        if (javaType instanceof JavaWildcardType) {
            ...
            if (bound != null && !m28320g(variance, typeParameterDescriptor)) {
                AnnotationDescriptor extractNullabilityAnnotationOnBoundedWildcard = UtilsKt.extractNullabilityAnnotationOnBoundedWildcard(this.f69198a, javaWildcardType);
    ...
    public final KotlinType transformArrayType(@NotNull JavaArrayType arrayType, @NotNull JavaTypeAttributes attr, boolean z) {
        ...
        LazyJavaAnnotations lazyJavaAnnotations = new LazyJavaAnnotations(this.f69198a, arrayType, true);
        if (primitiveType != null) {
            SimpleType it = this.f69198a.getModule().getBuiltIns().getPrimitiveArrayKotlinType(primitiveType);
        ...
        if (attr.isForAnnotationParameter()) {
            ...
            SimpleType arrayType2 = this.f69198a.getModule().getBuiltIns().getArrayType(variance, transformJavaType, lazyJavaAnnotations);
            Intrinsics.checkNotNullExpressionValue(arrayType2, "c.module.builtIns.getArr…mponentType, annotations)");
            return arrayType2;
        }
        SimpleType arrayType3 = this.f69198a.getModule().getBuiltIns().getArrayType(Variance.INVARIANT, transformJavaType, lazyJavaAnnotations);
        Intrinsics.checkNotNullExpressionValue(arrayType3, "c.module.builtIns.getArr…mponentType, annotations)");
        return KotlinTypeFactory.flexibleType(arrayType3, this.f69198a.getModule().getBuiltIns().getArrayType(Variance.OUT_VARIANCE, transformJavaType, lazyJavaAnnotations).makeNullableAsSpecified(true));
    }
    ...
    public final KotlinType transformJavaType(@Nullable JavaType javaType, @NotNull JavaTypeAttributes attr) {
        ...
        if (javaType instanceof JavaPrimitiveType) {
            ...
            if (type != null) {
                unitType = this.f69198a.getModule().getBuiltIns().getPrimitiveKotlinType(type);
            } else {
                unitType = this.f69198a.getModule().getBuiltIns().getUnitType();
            }
            Intrinsics.checkNotNullExpressionValue(unitType, "{\n                val pr…ns.unitType\n            }");
            return unitType;
        } else if (javaType instanceof JavaClassifierType) {
            return m28317j((JavaClassifierType) javaType, attr);
        } else {
            ...
            if (javaType instanceof JavaWildcardType) {
                ...
                if (bound == null || (transformJavaType = transformJavaType(bound, attr)) == null) {
                    SimpleType defaultBound = this.f69198a.getModule().getBuiltIns().getDefaultBound();
                    Intrinsics.checkNotNullExpressionValue(defaultBound, "c.module.builtIns.defaultBound");
                    return defaultBound;
                }
                return transformJavaType;
            } else if (javaType == null) {
                SimpleType defaultBound2 = this.f69198a.getModule().getBuiltIns().getDefaultBound();
