...
public final class JavaTargetAnnotationDescriptor$allValueArguments$2 extends Lambda implements Function0<Map<Name, ? extends ConstantValue<? extends Object>>> {
    ...
    public final Map<Name, ? extends ConstantValue<? extends Object>> invoke() {
        ...
        if (firstArgument instanceof JavaArrayAnnotationArgument) {
            ...
            mapJavaTargetArguments$descriptors_jvm = firstArgument instanceof JavaEnumValueAnnotationArgument ? JavaAnnotationTargetMapper.INSTANCE.mapJavaTargetArguments$descriptors_jvm(AbstractC10108ds.listOf(this.this$0.getFirstArgument())) : null;
        }
        Map<Name, ? extends ConstantValue<? extends Object>> mapOf = mapJavaTargetArguments$descriptors_jvm != null ? AbstractC18515Tn0.mapOf(TuplesKt.m28844to(JavaAnnotationMapper.INSTANCE.getTARGET_ANNOTATION_ALLOWED_TARGETS$descriptors_jvm(), mapJavaTargetArguments$descriptors_jvm)) : null;
        return mapOf == null ? AbstractC11687a.emptyMap() : mapOf;
    }
}
