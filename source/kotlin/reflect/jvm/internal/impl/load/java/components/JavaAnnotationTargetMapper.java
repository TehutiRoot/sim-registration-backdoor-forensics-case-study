...
public final class JavaAnnotationTargetMapper {
    ...
    /* renamed from: a */
    public static final Map f69032a = AbstractC11687a.mapOf(TuplesKt.m28844to("PACKAGE", EnumSet.noneOf(KotlinTarget.class)), TuplesKt.m28844to("TYPE", EnumSet.of(KotlinTarget.CLASS, KotlinTarget.FILE)), TuplesKt.m28844to("ANNOTATION_TYPE", EnumSet.of(KotlinTarget.ANNOTATION_CLASS)), TuplesKt.m28844to("TYPE_PARAMETER", EnumSet.of(KotlinTarget.TYPE_PARAMETER)), TuplesKt.m28844to("FIELD", EnumSet.of(KotlinTarget.FIELD)), TuplesKt.m28844to("LOCAL_VARIABLE", EnumSet.of(KotlinTarget.LOCAL_VARIABLE)), TuplesKt.m28844to("PARAMETER", EnumSet.of(KotlinTarget.VALUE_PARAMETER)), TuplesKt.m28844to("CONSTRUCTOR", EnumSet.of(KotlinTarget.CONSTRUCTOR)), TuplesKt.m28844to("METHOD", EnumSet.of(KotlinTarget.FUNCTION, KotlinTarget.PROPERTY_GETTER, KotlinTarget.PROPERTY_SETTER)), TuplesKt.m28844to("TYPE_USE", EnumSet.of(KotlinTarget.TYPE)));

    /* renamed from: b */
    public static final Map f69033b = AbstractC11687a.mapOf(TuplesKt.m28844to("RUNTIME", KotlinRetention.RUNTIME), TuplesKt.m28844to("CLASS", KotlinRetention.BINARY), TuplesKt.m28844to("SOURCE", KotlinRetention.SOURCE));
    ...
    public final Set<KotlinTarget> mapJavaTargetArgumentByName(@Nullable String str) {
        EnumSet enumSet = (EnumSet) f69032a.get(str);
        if (enumSet == null) {
            return DG1.emptySet();
        }
        return enumSet;
    ...
    public final ConstantValue<?> mapJavaTargetArguments$descriptors_jvm(@NotNull List<? extends JavaAnnotationArgument> arguments) {
        ...
        for (JavaEnumValueAnnotationArgument javaEnumValueAnnotationArgument : arrayList) {
            ...
            AbstractC10410hs.addAll(arrayList2, javaAnnotationTargetMapper.mapJavaTargetArgumentByName(str));
        }
