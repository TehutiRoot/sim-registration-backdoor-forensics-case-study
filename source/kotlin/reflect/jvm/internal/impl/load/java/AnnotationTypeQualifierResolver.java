...
public final class AnnotationTypeQualifierResolver extends AbstractAnnotationTypeQualifierResolver<AnnotationDescriptor> {
    ...
    /* renamed from: l */
    public final List m28429l(ConstantValue constantValue) {
        if (constantValue instanceof ArrayValue) {
            ArrayList arrayList = new ArrayList();
            Iterator<T> it = ((ArrayValue) constantValue).getValue().iterator();
            while (it.hasNext()) {
                AbstractC10410hs.addAll(arrayList, m28429l((ConstantValue) it.next()));
            }
            return arrayList;
        } else if (constantValue instanceof EnumValue) {
            return AbstractC10108ds.listOf(((EnumValue) constantValue).getEnumEntryName().getIdentifier());
        } else {
    ...
    public Iterable<String> enumArguments(@NotNull AnnotationDescriptor annotationDescriptor, boolean z) {
        ...
        for (Map.Entry<Name, ConstantValue<?>> entry : allValueArguments.entrySet()) {
            ...
            if (z && !Intrinsics.areEqual(key, JvmAnnotationNames.DEFAULT_ANNOTATION_MEMBER_NAME)) {
                m28429l = CollectionsKt__CollectionsKt.emptyList();
            } else {
                m28429l = m28429l(value);
            }
            AbstractC10410hs.addAll(arrayList, m28429l);
        }
        return arrayList;
    }
