...
public class Flags {
    ...
    public static abstract class FlagField<E> {
        ...
        public static FlagField after(FlagField flagField, Internal.EnumLite[] enumLiteArr) {
            return new C11891b(flagField.offset + flagField.bitWidth, enumLiteArr);
        }
    ...
    /* loaded from: classes6.dex */
    public static class C11891b extends FlagField {

        /* renamed from: a */
        public final Internal.EnumLite[] f69538a;

        public C11891b(int i, Internal.EnumLite[] enumLiteArr) {
            super(i, m28060b(enumLiteArr));
            this.f69538a = enumLiteArr;
        }

        /* renamed from: a */
        private static /* synthetic */ void m28061a(int i) {
            throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "enumEntries", "kotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags$EnumLiteFlagField", "bitWidth"));
        }

        /* renamed from: b */
        public static int m28060b(Object[] objArr) {
            if (objArr == null) {
                m28061a(0);
            }
        ...
        public Internal.EnumLite get(int i) {
            ...
            for (Internal.EnumLite enumLite : this.f69538a) {
    ...
    */
    public static /* synthetic */ void m28062a(int r5) {
        /*
            r0 = 3
        ...
        L4e:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.reflect.jvm.internal.impl.metadata.deserialization.Flags.m28062a(int):void");
    }
