...
public class BitEncoding {
    ...
    /* renamed from: a */
    public static final boolean f69566a;
    ...
    static {
        ...
        f69566a = "true".equals(str);
    }

    /* renamed from: a */
    public static /* synthetic */ void m28031a(int i) {
    ...
    /* renamed from: b */
    public static void m28030b(byte[] bArr, int i) {
        if (bArr == null) {
            m28031a(4);
        }
    ...
    /* renamed from: c */
    public static byte[] m28029c(String[] strArr) {
        if (strArr == null) {
            m28031a(11);
        }
        int i = 0;
    ...
    /* renamed from: d */
    public static byte[] m28028d(byte[] bArr) {
        if (bArr == null) {
            m28031a(13);
        }
    ...
    public static byte[] decodeBytes(@NotNull String[] strArr) {
        ...
        if (strArr.length > 0 && !strArr[0].isEmpty()) {
            ...
            if (charAt == 0) {
                byte[] stringsToBytes = UtfEncodingKt.stringsToBytes(m28027e(strArr));
                if (stringsToBytes == null) {
                    m28031a(8);
                }
                return stringsToBytes;
            } else if (charAt == 65535) {
                strArr = m28027e(strArr);
            }
        }
        byte[] m28029c = m28029c(strArr);
        m28030b(m28029c, 127);
        return m28028d(m28029c);
    }

    /* renamed from: e */
    public static String[] m28027e(String[] strArr) {
        if (strArr == null) {
            m28031a(9);
        }
