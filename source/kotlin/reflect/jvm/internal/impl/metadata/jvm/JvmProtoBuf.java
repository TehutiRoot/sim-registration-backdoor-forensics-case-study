...
public final class JvmProtoBuf {
    ...
    public static final class JvmFieldSignature extends GeneratedMessageLite implements JvmFieldSignatureOrBuilder {
        public static Parser<JvmFieldSignature> PARSER = new C11892a();
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<JvmFieldSignature, Builder> implements JvmFieldSignatureOrBuilder {
            ...
            /* renamed from: b */
            public static Builder m28055b() {
                return new Builder();
            }

            /* renamed from: c */
            private void m28054c() {
            }
            ...
            public JvmFieldSignature buildPartial() {
                ...
                jvmFieldSignature.name_ = this.f69545c;
                if ((i & 2) == 2) {
                    i2 |= 2;
                }
                jvmFieldSignature.desc_ = this.f69546d;
            ...
            public Builder clone() {
                return m28055b().mergeFrom(buildPartial());
            }
        ...
        /* loaded from: classes6.dex */
        public static class C11892a extends AbstractParser {
    ...
    public static final class JvmMethodSignature extends GeneratedMessageLite implements JvmMethodSignatureOrBuilder {
        public static Parser<JvmMethodSignature> PARSER = new C11893a();
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<JvmMethodSignature, Builder> implements JvmMethodSignatureOrBuilder {
            ...
            /* renamed from: b */
            public static Builder m28051b() {
                return new Builder();
            }

            /* renamed from: c */
            private void m28050c() {
            }
            ...
            public JvmMethodSignature buildPartial() {
                ...
                jvmMethodSignature.name_ = this.f69548c;
                if ((i & 2) == 2) {
                    i2 |= 2;
                }
                jvmMethodSignature.desc_ = this.f69549d;
            ...
            @Override // kotlin.reflect.jvm.internal.impl.protobuf.GeneratedMessageLite.Builder, kotlin.reflect.jvm.internal.impl.protobuf.AbstractMessageLite.Builder
            public Builder clone() {
                return m28051b().mergeFrom(buildPartial());
            }
        ...
        /* loaded from: classes6.dex */
        public static class C11893a extends AbstractParser {
            @Override // kotlin.reflect.jvm.internal.impl.protobuf.Parser
            /* renamed from: c */
    ...
    public static final class JvmPropertySignature extends GeneratedMessageLite implements JvmPropertySignatureOrBuilder {
        public static Parser<JvmPropertySignature> PARSER = new C11894a();
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<JvmPropertySignature, Builder> implements JvmPropertySignatureOrBuilder {
            ...
            /* renamed from: c */
            public JvmFieldSignature f69551c = JvmFieldSignature.getDefaultInstance();

            /* renamed from: d */
            public JvmMethodSignature f69552d = JvmMethodSignature.getDefaultInstance();

            /* renamed from: e */
            public JvmMethodSignature f69553e = JvmMethodSignature.getDefaultInstance();

            /* renamed from: f */
            public JvmMethodSignature f69554f = JvmMethodSignature.getDefaultInstance();

            /* renamed from: g */
            public JvmMethodSignature f69555g = JvmMethodSignature.getDefaultInstance();
            ...
            /* renamed from: b */
            public static Builder m28047b() {
                return new Builder();
            }

            /* renamed from: c */
            private void m28046c() {
            }
            ...
            public JvmPropertySignature buildPartial() {
                ...
                jvmPropertySignature.field_ = this.f69551c;
                if ((i & 2) == 2) {
                    i2 |= 2;
                }
                jvmPropertySignature.syntheticMethod_ = this.f69552d;
                if ((i & 4) == 4) {
                    i2 |= 4;
                }
                jvmPropertySignature.getter_ = this.f69553e;
                if ((i & 8) == 8) {
                    i2 |= 8;
                }
                jvmPropertySignature.setter_ = this.f69554f;
                if ((i & 16) == 16) {
                    i2 |= 16;
                }
                jvmPropertySignature.delegateMethod_ = this.f69555g;
            ...
            public Builder mergeDelegateMethod(JvmMethodSignature jvmMethodSignature) {
                if ((this.f69550b & 16) == 16 && this.f69555g != JvmMethodSignature.getDefaultInstance()) {
                    this.f69555g = JvmMethodSignature.newBuilder(this.f69555g).mergeFrom(jvmMethodSignature).buildPartial();
                } else {
                    this.f69555g = jvmMethodSignature;
                }
                this.f69550b |= 16;
                return this;
            }
            ...
            public Builder mergeField(JvmFieldSignature jvmFieldSignature) {
                if ((this.f69550b & 1) == 1 && this.f69551c != JvmFieldSignature.getDefaultInstance()) {
                    this.f69551c = JvmFieldSignature.newBuilder(this.f69551c).mergeFrom(jvmFieldSignature).buildPartial();
                } else {
                    this.f69551c = jvmFieldSignature;
                }
                this.f69550b |= 1;
                return this;
            }
            ...
            public Builder mergeGetter(JvmMethodSignature jvmMethodSignature) {
                if ((this.f69550b & 4) == 4 && this.f69553e != JvmMethodSignature.getDefaultInstance()) {
                    this.f69553e = JvmMethodSignature.newBuilder(this.f69553e).mergeFrom(jvmMethodSignature).buildPartial();
                } else {
                    this.f69553e = jvmMethodSignature;
                }
                this.f69550b |= 4;
                return this;
            }
            ...
            public Builder mergeSetter(JvmMethodSignature jvmMethodSignature) {
                if ((this.f69550b & 8) == 8 && this.f69554f != JvmMethodSignature.getDefaultInstance()) {
                    this.f69554f = JvmMethodSignature.newBuilder(this.f69554f).mergeFrom(jvmMethodSignature).buildPartial();
                } else {
                    this.f69554f = jvmMethodSignature;
                }
                this.f69550b |= 8;
                return this;
            }
            ...
            public Builder mergeSyntheticMethod(JvmMethodSignature jvmMethodSignature) {
                if ((this.f69550b & 2) == 2 && this.f69552d != JvmMethodSignature.getDefaultInstance()) {
                    this.f69552d = JvmMethodSignature.newBuilder(this.f69552d).mergeFrom(jvmMethodSignature).buildPartial();
                } else {
                    this.f69552d = jvmMethodSignature;
                }
                this.f69550b |= 2;
                return this;
            }
            ...
            @Override // kotlin.reflect.jvm.internal.impl.protobuf.GeneratedMessageLite.Builder, kotlin.reflect.jvm.internal.impl.protobuf.AbstractMessageLite.Builder
            public Builder clone() {
                return m28047b().mergeFrom(buildPartial());
            }
        ...
        /* loaded from: classes6.dex */
        public static class C11894a extends AbstractParser {
            @Override // kotlin.reflect.jvm.internal.impl.protobuf.Parser
            /* renamed from: c */
        ...
        public int getSerializedSize() {
            ...
            if ((this.bitField0_ & 1) == 1) {
                i = CodedOutputStream.computeMessageSize(1, this.field_);
            } else {
                i = 0;
            }
            if ((this.bitField0_ & 2) == 2) {
            ...
            if ((this.bitField0_ & 16) == 16) {
                i += CodedOutputStream.computeMessageSize(5, this.delegateMethod_);
            }
            int size = i + this.unknownFields.size();
            this.memoizedSerializedSize = size;
            return size;
    ...
    public static final class StringTableTypes extends GeneratedMessageLite implements StringTableTypesOrBuilder {
        public static Parser<StringTableTypes> PARSER = new C11897a();
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<StringTableTypes, Builder> implements StringTableTypesOrBuilder {
            ...
            /* renamed from: c */
            public List f69557c = Collections.emptyList();

            /* renamed from: d */
            public List f69558d = Collections.emptyList();
            ...
            public StringTableTypes buildPartial() {
                ...
                if ((this.f69556b & 1) == 1) {
                    this.f69557c = Collections.unmodifiableList(this.f69557c);
                    this.f69556b &= -2;
                }
                stringTableTypes.record_ = this.f69557c;
                if ((this.f69556b & 2) == 2) {
                    this.f69558d = Collections.unmodifiableList(this.f69558d);
                    this.f69556b &= -3;
                }
                stringTableTypes.localName_ = this.f69558d;
                return stringTableTypes;
            }

            /* renamed from: c */
            public final void m28042c() {
                if ((this.f69556b & 2) != 2) {
                    this.f69558d = new ArrayList(this.f69558d);
                    this.f69556b |= 2;
                }
            }

            /* renamed from: d */
            public final void m28041d() {
                if ((this.f69556b & 1) != 1) {
                    this.f69557c = new ArrayList(this.f69557c);
                    this.f69556b |= 1;
                }
            }
            ...
            @Override // kotlin.reflect.jvm.internal.impl.protobuf.GeneratedMessageLite.Builder, kotlin.reflect.jvm.internal.impl.protobuf.AbstractMessageLite.Builder
            public Builder clone() {
                return m28043b().mergeFrom(buildPartial());
            }
            ...
            public Builder mergeFrom(StringTableTypes stringTableTypes) {
                ...
                if (!stringTableTypes.record_.isEmpty()) {
                    if (this.f69557c.isEmpty()) {
                        this.f69557c = stringTableTypes.record_;
                        this.f69556b &= -2;
                    } else {
                        m28041d();
                        this.f69557c.addAll(stringTableTypes.record_);
                    }
                }
                if (!stringTableTypes.localName_.isEmpty()) {
                    if (this.f69558d.isEmpty()) {
                        this.f69558d = stringTableTypes.localName_;
                        this.f69556b &= -3;
                    } else {
                        m28042c();
                        this.f69558d.addAll(stringTableTypes.localName_);
                    }
                }
        ...
        public static final class Record extends GeneratedMessageLite implements RecordOrBuilder {
            public static Parser<Record> PARSER = new C11896a();
            ...
            public static final class Builder extends GeneratedMessageLite.Builder<Record, Builder> implements RecordOrBuilder {
                ...
                /* renamed from: c */
                public int f69560c = 1;

                /* renamed from: e */
                public Object f69562e = "";

                /* renamed from: f */
                public Operation f69563f = Operation.NONE;

                /* renamed from: g */
                public List f69564g = Collections.emptyList();

                /* renamed from: h */
                public List f69565h = Collections.emptyList();
                ...
                /* renamed from: b */
                public static Builder m28038b() {
                    return new Builder();
                }

                /* renamed from: e */
                private void m28035e() {
                }
                ...
                public Record buildPartial() {
                    ...
                    record.range_ = this.f69560c;
                    if ((i & 2) == 2) {
                        i2 |= 2;
                    }
                    record.predefinedIndex_ = this.f69561d;
                    if ((i & 4) == 4) {
                        i2 |= 4;
                    }
                    record.string_ = this.f69562e;
                    if ((i & 8) == 8) {
                        i2 |= 8;
                    }
                    record.operation_ = this.f69563f;
                    if ((this.f69559b & 16) == 16) {
                        this.f69564g = Collections.unmodifiableList(this.f69564g);
                        this.f69559b &= -17;
                    }
                    record.substringIndex_ = this.f69564g;
                    if ((this.f69559b & 32) == 32) {
                        this.f69565h = Collections.unmodifiableList(this.f69565h);
                        this.f69559b &= -33;
                    }
                    record.replaceChar_ = this.f69565h;
                    record.bitField0_ = i2;
                    return record;
                }

                /* renamed from: c */
                public final void m28037c() {
                    if ((this.f69559b & 32) != 32) {
                        this.f69565h = new ArrayList(this.f69565h);
                        this.f69559b |= 32;
                    }
                }

                /* renamed from: d */
                public final void m28036d() {
                    if ((this.f69559b & 16) != 16) {
                        this.f69564g = new ArrayList(this.f69564g);
                        this.f69559b |= 16;
                    }
                }
                ...
                @Override // kotlin.reflect.jvm.internal.impl.protobuf.GeneratedMessageLite.Builder, kotlin.reflect.jvm.internal.impl.protobuf.AbstractMessageLite.Builder
                public Builder clone() {
                    return m28038b().mergeFrom(buildPartial());
                }
                ...
                public Builder mergeFrom(Record record) {
                    ...
                    if (record.hasString()) {
                        this.f69559b |= 4;
                        this.f69562e = record.string_;
                    }
                    if (record.hasOperation()) {
                        setOperation(record.getOperation());
                    }
                    if (!record.substringIndex_.isEmpty()) {
                        if (this.f69564g.isEmpty()) {
                            this.f69564g = record.substringIndex_;
                            this.f69559b &= -17;
                        } else {
                            m28036d();
                            this.f69564g.addAll(record.substringIndex_);
                        }
                    }
                    if (!record.replaceChar_.isEmpty()) {
                        if (this.f69565h.isEmpty()) {
                            this.f69565h = record.replaceChar_;
                            this.f69559b &= -33;
                        } else {
                            m28037c();
                            this.f69565h.addAll(record.replaceChar_);
                        }
                    }
            ...
            public enum Operation implements Internal.EnumLite {
                ...
                private static Internal.EnumLiteMap<Operation> internalValueMap = new C11895a();
                private final int value;

                /* renamed from: kotlin.reflect.jvm.internal.impl.metadata.jvm.JvmProtoBuf$StringTableTypes$Record$Operation$a */
                /* loaded from: classes6.dex */
                public static class C11895a implements Internal.EnumLiteMap {
            ...
            /* loaded from: classes6.dex */
            public static class C11896a extends AbstractParser {
                @Override // kotlin.reflect.jvm.internal.impl.protobuf.Parser
                /* renamed from: c */
            ...
            public int getSerializedSize() {
                ...
                if ((this.bitField0_ & 1) == 1) {
                    i = CodedOutputStream.computeInt32Size(1, this.range_);
                } else {
                    i = 0;
                }
                if ((this.bitField0_ & 2) == 2) {
        ...
        /* loaded from: classes6.dex */
        public static class C11897a extends AbstractParser {
            @Override // kotlin.reflect.jvm.internal.impl.protobuf.Parser
            /* renamed from: c */
