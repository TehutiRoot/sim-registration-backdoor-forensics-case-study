...
public class JvmNameResolverBase implements NameResolver {
    ...
    /* renamed from: d */
    public static final String f69578d;

    /* renamed from: e */
    public static final List f69579e;

    /* renamed from: f */
    public static final Map f69580f;

    /* renamed from: a */
    public final String[] f69581a;

    /* renamed from: b */
    public final Set f69582b;
    ...
    public JvmNameResolverBase(@NotNull String[] strings, @NotNull Set<Integer> localNameIndices, @NotNull List<JvmProtoBuf.StringTableTypes.Record> records) {
        ...
        this.f69581a = strings;
        this.f69582b = localNameIndices;
        this.f69583c = records;
    }
    ...
    public String getString(int i) {
        String string;
        JvmProtoBuf.StringTableTypes.Record record = (JvmProtoBuf.StringTableTypes.Record) this.f69583c.get(i);
        if (record.hasString()) {
        ...
        if (record.getReplaceCharCount() >= 2) {
            ...
            string2 = AbstractC20204hN1.replace$default(string2, (char) replaceCharList.get(0).intValue(), (char) replaceCharList.get(1).intValue(), false, 4, (Object) null);
        }
        ...
        if (i2 != 2) {
            if (i2 == 3) {
                ...
                string3 = AbstractC20204hN1.replace$default(string4, '$', '.', false, 4, (Object) null);
            }
        } else {
            Intrinsics.checkNotNullExpressionValue(string3, "string");
            string3 = AbstractC20204hN1.replace$default(string3, '$', '.', false, 4, (Object) null);
        }
        Intrinsics.checkNotNullExpressionValue(string3, "string");
        return string3;
    }
    ...
    public boolean isLocalClassName(int i) {
        return this.f69582b.contains(Integer.valueOf(i));
    }
}
