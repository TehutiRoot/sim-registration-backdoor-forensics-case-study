...
public final class AnnotationDeserializer {
    ...
    /* renamed from: a */
    public final ModuleDescriptor f70003a;

    /* renamed from: b */
    public final NotFoundClasses f70004b;
    ...
    public AnnotationDeserializer(@NotNull ModuleDescriptor module, @NotNull NotFoundClasses notFoundClasses) {
        ...
        this.f70003a = module;
        this.f70004b = notFoundClasses;
    }

    /* renamed from: a */
    public final boolean m27727a(ConstantValue constantValue, KotlinType kotlinType, ProtoBuf.Annotation.Argument.Value value) {
        int i;
        ...
        if (i != 10) {
            if (i != 13) {
                return Intrinsics.areEqual(constantValue.getType(this.f70003a), kotlinType);
            }
            if ((constantValue instanceof ArrayValue) && ((ArrayValue) constantValue).getValue().size() == value.getArrayElementList().size()) {
                KotlinType arrayElementType = m27726b().getArrayElementType(kotlinType);
                ...
                if (!(indices instanceof Collection) || !((Collection) indices).isEmpty()) {
                    ...
                    while (it.hasNext()) {
                        ...
                        if (!m27727a(arrayValue.getValue().get(nextInt), arrayElementType, arrayElement)) {
                            return false;
                        }
                    }
                }
    ...
    /* renamed from: b */
    public final KotlinBuiltIns m27726b() {
        return this.f70003a.getBuiltIns();
    }

    /* renamed from: c */
    public final Pair m27725c(ProtoBuf.Annotation.Argument argument, Map map, NameResolver nameResolver) {
        ...
        return new Pair(name, m27723e(type, value, nameResolver));
    }

    /* renamed from: d */
    public final ClassDescriptor m27724d(ClassId classId) {
        return FindClassInModuleKt.findNonGenericClassAcrossDependencies(this.f70003a, classId, this.f70004b);
    }
    ...
    public final AnnotationDescriptor deserializeAnnotation(@NotNull ProtoBuf.Annotation proto, @NotNull NameResolver nameResolver) {
        ...
        ClassDescriptor m27724d = m27724d(NameResolverUtilKt.getClassId(nameResolver, proto.getId()));
        Map emptyMap = AbstractC11687a.emptyMap();
        if (proto.getArgumentCount() != 0 && !ErrorUtils.isError(m27724d) && DescriptorUtils.isAnnotationClass(m27724d)) {
            Collection<ClassConstructorDescriptor> constructors = m27724d.getConstructors();
            ...
            if (classConstructorDescriptor != null) {
                ...
                for (ProtoBuf.Annotation.Argument it : argumentList) {
                    ...
                    Pair m27725c = m27725c(it, linkedHashMap, nameResolver);
                    if (m27725c != null) {
                        arrayList.add(m27725c);
                    }
                }
                emptyMap = AbstractC11687a.toMap(arrayList);
            }
        }
        return new AnnotationDescriptorImpl(m27724d.getDefaultType(), emptyMap, SourceElement.NO_SOURCE);
    }

    /* renamed from: e */
    public final ConstantValue m27723e(KotlinType kotlinType, ProtoBuf.Annotation.Argument.Value value, NameResolver nameResolver) {
        ConstantValue<?> resolveValue = resolveValue(kotlinType, value, nameResolver);
        if (!m27727a(resolveValue, kotlinType, value)) {
            resolveValue = null;
        }
        ...
        switch (i) {
            ...
            case 13:
                ...
                for (ProtoBuf.Annotation.Argument.Value it : list) {
                    SimpleType anyType = m27726b().getAnyType();
