...
public final class DeserializedTypeAliasDescriptor extends AbstractTypeAliasDescriptor implements DeserializedMemberDescriptor {
    ...
    /* renamed from: h */
    public final StorageManager f70167h;

    /* renamed from: i */
    public final ProtoBuf.TypeAlias f70168i;

    /* renamed from: j */
    public final NameResolver f70169j;

    /* renamed from: k */
    public final TypeTable f70170k;

    /* renamed from: l */
    public final VersionRequirementTable f70171l;

    /* renamed from: m */
    public final DeserializedContainerSource f70172m;

    /* renamed from: n */
    public Collection f70173n;

    /* renamed from: o */
    public SimpleType f70174o;

    /* renamed from: p */
    public SimpleType f70175p;

    /* renamed from: q */
    public List f70176q;

    /* renamed from: r */
    public SimpleType f70177r;
    ...
    */
    ...
    public SimpleType getDefaultType() {
        SimpleType simpleType = this.f70177r;
        if (simpleType == null) {
    ...
    public SimpleType getExpandedType() {
        SimpleType simpleType = this.f70175p;
        if (simpleType != null) {
            return simpleType;
        }
    ...
    public List<TypeParameterDescriptor> getTypeConstructorTypeParameters() {
        List<TypeParameterDescriptor> list = this.f70176q;
        if (list == null) {
    ...
    public SimpleType getUnderlyingType() {
        SimpleType simpleType = this.f70174o;
        if (simpleType != null) {
            return simpleType;
        }
    ...
    public final void initialize(@NotNull List<? extends TypeParameterDescriptor> declaredTypeParameters, @NotNull SimpleType underlyingType, @NotNull SimpleType expandedType) {
        ...
        this.f70174o = underlyingType;
        this.f70175p = expandedType;
        this.f70176q = TypeParameterUtilsKt.computeConstructorTypeParameters(this);
        this.f70177r = computeDefaultType();
        this.f70173n = getTypeAliasConstructors();
    }
