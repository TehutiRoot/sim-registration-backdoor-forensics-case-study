...
public final class MemberDeserializer$getAnnotations$1 extends Lambda implements Function0<List<? extends AnnotationDescriptor>> {
    ...
    public final List<? extends AnnotationDescriptor> invoke() {
        ...
        if (m27718a != null) {
            ...
            list = CollectionsKt___CollectionsKt.toList(deserializationContext2.getComponents().getAnnotationAndConstantLoader().loadCallableAnnotations(m27718a, messageLite, annotatedCallableKind));
        } else {
            list = null;
        }
