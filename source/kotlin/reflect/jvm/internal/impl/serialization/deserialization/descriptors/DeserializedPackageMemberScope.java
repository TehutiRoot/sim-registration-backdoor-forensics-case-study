...
public class DeserializedPackageMemberScope extends DeserializedMemberScope {
    ...
    /* renamed from: f */
    public final PackageFragmentDescriptor f70154f;

    /* renamed from: g */
    public final String f70155g;

    /* renamed from: h */
    public final FqName f70156h;
    ...
    */
    ...
    public ClassId createClassId(@NotNull Name name) {
        ...
        return new ClassId(this.f70156h, name);
    }
        ...
        if (!super.hasClass(name)) {
            ...
            if (!(fictitiousClassDescriptorFactories instanceof Collection) || !((Collection) fictitiousClassDescriptorFactories).isEmpty()) {
                for (ClassDescriptorFactory classDescriptorFactory : fictitiousClassDescriptorFactories) {
                    if (classDescriptorFactory.shouldCreateClass(this.f70156h, name)) {
                        return true;
                    }
                }
            }
    ...
    public void recordLookup(@NotNull Name name, @NotNull LookupLocation location) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(location, "location");
        UtilsKt.record(getC().getComponents().getLookupTracker(), location, this.f70154f, name);
    }
    ...
    public List<DeclarationDescriptor> getContributedDescriptors(@NotNull DescriptorKindFilter kindFilter, @NotNull Function1<? super Name, Boolean> nameFilter) {
        ...
        for (ClassDescriptorFactory classDescriptorFactory : fictitiousClassDescriptorFactories) {
            AbstractC10410hs.addAll(arrayList, classDescriptorFactory.getAllContributedClassesIfPossible(this.f70156h));
        }
