...
public class SubpackagesScope extends MemberScopeImpl {
    ...
    public Collection<DeclarationDescriptor> getContributedDescriptors(@NotNull DescriptorKindFilter kindFilter, @NotNull Function1<? super Name, Boolean> nameFilter) {
        ...
        if (this.f68852b.isRoot() && kindFilter.getExcludes().contains(DescriptorKindExclude.TopLevelPackages.INSTANCE)) {
            return CollectionsKt__CollectionsKt.emptyList();
        }
        Collection<FqName> subPackagesOf = this.f68851a.getSubPackagesOf(this.f68852b, nameFilter);
    ...
    public final PackageViewDescriptor getPackage(@NotNull Name name) {
        ...
        ModuleDescriptor moduleDescriptor = this.f68851a;
        FqName child = this.f68852b.child(name);
    ...
    public String toString() {
        return "subpackages of " + this.f68852b + " from " + this.f68851a;
    }
}
