...
public abstract class DeclarationDescriptorImpl extends AnnotatedImpl implements DeclarationDescriptor {
    ...
    /* renamed from: a */
    private static /* synthetic */ void m28532a(int i) {
    ...
    public static String toString(@NotNull DeclarationDescriptor declarationDescriptor) {
        ...
        try {
            ...
            String str2 = declarationDescriptor.getClass().getSimpleName() + HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR + declarationDescriptor.getName();
            if (str2 == null) {
                m28532a(6);
            }
            return str2;
