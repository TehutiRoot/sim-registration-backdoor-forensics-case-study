...
public final class C11782x39a25915 extends Lambda implements Function0<CompositePackageFragmentProvider> {
    final /* synthetic */ ModuleDescriptorImpl this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C11782x39a25915(ModuleDescriptorImpl moduleDescriptorImpl) {
        super(0);
    ...
    public final CompositePackageFragmentProvider invoke() {
        ...
        moduleDependencies = this.this$0.f68787i;
        ...
        if (moduleDependencies != null) {
            ...
            for (ModuleDescriptorImpl moduleDescriptorImpl3 : list) {
                packageFragmentProvider = moduleDescriptorImpl3.f68788j;
        ...
        m28493b = moduleDescriptorImpl.m28493b();
        sb.append(m28493b);
