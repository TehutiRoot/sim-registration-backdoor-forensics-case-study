...
public class ClassDescriptorImpl extends ClassDescriptorBase {
    ...
    /* renamed from: g */
    public final Modality f68698g;

    /* renamed from: h */
    public final ClassKind f68699h;

    /* renamed from: i */
    public final TypeConstructor f68700i;

    /* renamed from: j */
    public MemberScope f68701j;

    /* renamed from: k */
    public Set f68702k;

    /* renamed from: l */
    public ClassConstructorDescriptor f68703l;
    ...
    public ClassDescriptorImpl(@NotNull DeclarationDescriptor declarationDescriptor, @NotNull Name name, @NotNull Modality modality, @NotNull ClassKind classKind, @NotNull Collection<KotlinType> collection, @NotNull SourceElement sourceElement, boolean z, @NotNull StorageManager storageManager) {
        ...
        this.f68698g = modality;
        this.f68699h = classKind;
        this.f68700i = new ClassTypeConstructorImpl(this, Collections.emptyList(), collection, storageManager);
    }

    /* renamed from: a */
    private static /* synthetic */ void m28533a(int i) {
        String str;
        int i2;
        switch (i) {
            case 9:
    ...
    public ClassKind getKind() {
        ClassKind classKind = this.f68699h;
        if (classKind == null) {
            m28533a(15);
        }
        return classKind;
    ...
    public Modality getModality() {
        Modality modality = this.f68698g;
        if (modality == null) {
            m28533a(16);
        }
        return modality;
    ...
    public TypeConstructor getTypeConstructor() {
        TypeConstructor typeConstructor = this.f68700i;
    ...
    public MemberScope getUnsubstitutedMemberScope(@NotNull KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        MemberScope memberScope = this.f68701j;
        if (memberScope == null) {
            m28533a(13);
        }
        return memberScope;
    ...
    public final void initialize(@NotNull MemberScope memberScope, @NotNull Set<ClassConstructorDescriptor> set, @Nullable ClassConstructorDescriptor classConstructorDescriptor) {
        ...
        this.f68701j = memberScope;
        this.f68702k = set;
        this.f68703l = classConstructorDescriptor;
    }
