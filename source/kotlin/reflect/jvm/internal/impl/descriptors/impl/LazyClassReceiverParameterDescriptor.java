...
public class LazyClassReceiverParameterDescriptor extends AbstractReceiverParameterDescriptor {
    ...
    /* renamed from: c */
    public final ClassDescriptor f68761c;

    /* renamed from: d */
    public final ImplicitClassReceiver f68762d;
    ...
    public LazyClassReceiverParameterDescriptor(@NotNull ClassDescriptor classDescriptor) {
        ...
        this.f68761c = classDescriptor;
        this.f68762d = new ImplicitClassReceiver(classDescriptor, null);
    }

    /* renamed from: a */
    private static /* synthetic */ void m28500a(int i) {
    ...
    public DeclarationDescriptor getContainingDeclaration() {
        ClassDescriptor classDescriptor = this.f68761c;
        if (classDescriptor == null) {
            m28500a(2);
        }
    ...
    public ReceiverValue getValue() {
        ImplicitClassReceiver implicitClassReceiver = this.f68762d;
    ...
    public String toString() {
        return "class " + this.f68761c.getName() + "::this";
    }
}
