...
public enum KotlinTarget {
    ...
    static {
        ...
        PROPERTY_SETTER_LIST = AbstractC10108ds.listOf(kotlinTarget7);
        KotlinTarget kotlinTarget8 = PROPERTY_GETTER;
        PROPERTY_GETTER_LIST = AbstractC10108ds.listOf(kotlinTarget8);
        FUNCTION_LIST = AbstractC10108ds.listOf(FUNCTION);
        KotlinTarget kotlinTarget9 = FILE;
        FILE_LIST = AbstractC10108ds.listOf(kotlinTarget9);
        AnnotationUseSiteTarget annotationUseSiteTarget = AnnotationUseSiteTarget.CONSTRUCTOR_PARAMETER;
        KotlinTarget kotlinTarget10 = VALUE_PARAMETER;
        USE_SITE_MAPPING = AbstractC11687a.mapOf(TuplesKt.m28844to(annotationUseSiteTarget, kotlinTarget10), TuplesKt.m28844to(AnnotationUseSiteTarget.FIELD, kotlinTarget6), TuplesKt.m28844to(AnnotationUseSiteTarget.PROPERTY, kotlinTarget5), TuplesKt.m28844to(AnnotationUseSiteTarget.FILE, kotlinTarget9), TuplesKt.m28844to(AnnotationUseSiteTarget.PROPERTY_GETTER, kotlinTarget8), TuplesKt.m28844to(AnnotationUseSiteTarget.PROPERTY_SETTER, kotlinTarget7), TuplesKt.m28844to(AnnotationUseSiteTarget.RECEIVER, kotlinTarget10), TuplesKt.m28844to(AnnotationUseSiteTarget.SETTER_PARAMETER, kotlinTarget10), TuplesKt.m28844to(AnnotationUseSiteTarget.PROPERTY_DELEGATE_FIELD, kotlinTarget6));
    }
