...
public final class TypeParameterUtilsKt {
    /* renamed from: a */
    public static final PossiblyInnerType m28553a(KotlinType kotlinType, ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters, int i) {
        ...
        return new PossiblyInnerType(classifierDescriptorWithTypeParameters, subList, m28553a(kotlinType, classifierDescriptorWithTypeParameters2, size));
    }

    /* renamed from: b */
    public static final C0893Ml m28552b(TypeParameterDescriptor typeParameterDescriptor, DeclarationDescriptor declarationDescriptor, int i) {
        return new C0893Ml(typeParameterDescriptor, declarationDescriptor, i);
    }
    ...
    public static final PossiblyInnerType buildPossiblyInnerType(@NotNull KotlinType kotlinType) {
        ...
        return m28553a(kotlinType, classifierDescriptorWithTypeParameters, 0);
    }
    ...
    public static final List<TypeParameterDescriptor> computeConstructorTypeParameters(@NotNull ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters) {
        ...
        List list2 = SequencesKt___SequencesKt.toList(SequencesKt___SequencesKt.flatMap(SequencesKt___SequencesKt.filter(SequencesKt___SequencesKt.takeWhile(DescriptorUtilsKt.getParents(classifierDescriptorWithTypeParameters), C11761x246a49e2.INSTANCE), C11762x246a49e3.INSTANCE), C11763x246a49e4.INSTANCE));
        ...
        ArrayList arrayList = new ArrayList(AbstractC10176es.collectionSizeOrDefault(plus, 10));
        for (TypeParameterDescriptor it2 : plus) {
            Intrinsics.checkNotNullExpressionValue(it2, "it");
            arrayList.add(m28552b(it2, classifierDescriptorWithTypeParameters, declaredTypeParameters.size()));
        }
