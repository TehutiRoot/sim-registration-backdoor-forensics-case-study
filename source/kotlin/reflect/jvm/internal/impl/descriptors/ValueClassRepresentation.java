...
public abstract class ValueClassRepresentation<Type extends SimpleTypeMarker> {
    ...
    public final <Other extends SimpleTypeMarker> ValueClassRepresentation<Other> mapUnderlyingType(@NotNull Function1<? super Type, ? extends Other> transform) {
        ...
        if (this instanceof InlineClassRepresentation) {
            ...
            ArrayList arrayList = new ArrayList(AbstractC10176es.collectionSizeOrDefault(underlyingPropertyNamesToTypes, 10));
            Iterator<T> it = underlyingPropertyNamesToTypes.iterator();
            while (it.hasNext()) {
                Pair pair = (Pair) it.next();
                arrayList.add(TuplesKt.m28844to((Name) pair.component1(), transform.invoke((SimpleTypeMarker) pair.component2())));
            }
