...
public final class ReflectJavaTypeParameter extends ReflectJavaElement implements ReflectJavaAnnotationOwner, JavaTypeParameter {
    ...
    /* renamed from: a */
    public final TypeVariable f68922a;

    public ReflectJavaTypeParameter(@NotNull TypeVariable<?> typeVariable) {
        Intrinsics.checkNotNullParameter(typeVariable, "typeVariable");
        this.f68922a = typeVariable;
    }

    public boolean equals(@Nullable Object obj) {
        if ((obj instanceof ReflectJavaTypeParameter) && Intrinsics.areEqual(this.f68922a, ((ReflectJavaTypeParameter) obj).f68922a)) {
            return true;
        }
        return false;
    }
    ...
    public AnnotatedElement getElement() {
        TypeVariable typeVariable = this.f68922a;
    ...
    @NotNull
    public Name getName() {
        Name identifier = Name.identifier(this.f68922a.getName());
    ...
    public String toString() {
        return ReflectJavaTypeParameter.class.getName() + ": " + this.f68922a;
    }
    ...
    public List<ReflectJavaClassifierType> getUpperBounds() {
        Type[] bounds = this.f68922a.getBounds();
