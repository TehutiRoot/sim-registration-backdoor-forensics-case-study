...
public abstract class ReflectJavaMember extends ReflectJavaElement implements ReflectJavaAnnotationOwner, ReflectJavaModifierListOwner, JavaMember {
    ...
    public final List<JavaValueParameter> getValueParameters(@NotNull Type[] parameterTypes, @NotNull Annotation[][] parameterAnnotations, boolean z) {
        ...
        List m28442b = Java8ParameterNamesLoader.f68892a.m28442b(getMember());
        if (m28442b != null) {
            i = m28442b.size() - parameterTypes.length;
        } else {
            i = 0;
        }
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            if (m28442b != null) {
                str = (String) CollectionsKt___CollectionsKt.getOrNull(m28442b, i2 + i);
                if (str == null) {
