...
public final class ClassId {
    ...
    /* renamed from: a */
    public final FqName f69592a;

    /* renamed from: b */
    public final FqName f69593b;
    ...
    */
    public static /* synthetic */ void m28021a(int r10) {
        /*
            r0 = 9
            r1 = 7
            r2 = 6
        ...
        Lb2:
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.reflect.jvm.internal.impl.name.ClassId.m28021a(int):void");
    }
    ...
    public FqName asSingleFqName() {
        if (this.f69592a.isRoot()) {
            FqName fqName = this.f69593b;
            if (fqName == null) {
                m28021a(9);
            }
            return fqName;
        }
        return new FqName(this.f69592a.asString() + "." + this.f69593b.asString());
    }

    @NotNull
    public String asString() {
        if (this.f69592a.isRoot()) {
            String asString = this.f69593b.asString();
            if (asString == null) {
                m28021a(13);
            }
            return asString;
        }
        String str = this.f69592a.asString().replace('.', '/') + RemoteSettings.FORWARD_SLASH_STRING + this.f69593b.asString();
        if (str == null) {
            m28021a(14);
        }
        return str;
    ...
    public ClassId createNestedClassId(@NotNull Name name) {
        ...
        return new ClassId(getPackageFqName(), this.f69593b.child(name), this.f69594c);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f69592a.equals(classId.f69592a) && this.f69593b.equals(classId.f69593b) && this.f69594c == classId.f69594c) {
            return true;
        }
        return false;
    }
    ...
    public ClassId getOuterClassId() {
        FqName parent = this.f69593b.parent();
        if (parent.isRoot()) {
            return null;
        }
        return new ClassId(getPackageFqName(), parent, this.f69594c);
    }

    @NotNull
    public FqName getPackageFqName() {
        FqName fqName = this.f69592a;
        if (fqName == null) {
            m28021a(5);
        }
        return fqName;
    ...
    public Name getShortClassName() {
        Name shortName = this.f69593b.shortName();
        if (shortName == null) {
            m28021a(7);
        }
        return shortName;
    ...
    public int hashCode() {
        return (((this.f69592a.hashCode() * 31) + this.f69593b.hashCode()) * 31) + Boolean.valueOf(this.f69594c).hashCode();
    }
    ...
    public boolean isNestedClass() {
        return !this.f69593b.parent().isRoot();
    }
