...
public final class CodedOutputStream {
    ...
    /* renamed from: a */
    public final byte[] f69713a;

    /* renamed from: b */
    public final int f69714b;

    /* renamed from: e */
    public final OutputStream f69717e;

    /* renamed from: d */
    public int f69716d = 0;
    ...
    public CodedOutputStream(OutputStream outputStream, byte[] bArr) {
        this.f69717e = outputStream;
        this.f69713a = bArr;
        this.f69714b = bArr.length;
    }

    /* renamed from: a */
    public static int m27989a(int i) {
        if (i > 4096) {
            return 4096;
        }
        return i;
    ...
    public static int computeTagSize(int i) {
        return computeRawVarint32Size(WireFormat.m27943b(i, 0));
    }
    ...
    /* renamed from: b */
    public final void m27988b() {
        OutputStream outputStream = this.f69717e;
        if (outputStream != null) {
            outputStream.write(this.f69713a, 0, this.f69715c);
            this.f69715c = 0;
            return;
        }
    ...
    public void writeTag(int i, int i2) throws IOException {
        writeRawVarint32(WireFormat.m27943b(i, i2));
    }
    ...
    public void writeRawBytes(byte[] bArr, int i, int i2) throws IOException {
        ...
        int i4 = this.f69715c;
        if (i3 - i4 >= i2) {
            System.arraycopy(bArr, i, this.f69713a, i4, i2);
            this.f69715c += i2;
            this.f69716d += i2;
            return;
        }
        int i5 = i3 - i4;
        System.arraycopy(bArr, i, this.f69713a, i4, i5);
        int i6 = i + i5;
        int i7 = i2 - i5;
        this.f69715c = this.f69714b;
        this.f69716d += i5;
        m27988b();
        if (i7 <= this.f69714b) {
            System.arraycopy(bArr, i6, this.f69713a, 0, i7);
            this.f69715c = i7;
        } else {
            this.f69717e.write(bArr, i6, i7);
        }
        this.f69716d += i7;
    }
    ...
    public void writeRawBytes(ByteString byteString, int i, int i2) throws IOException {
        ...
        int i4 = this.f69715c;
        if (i3 - i4 >= i2) {
            byteString.copyTo(this.f69713a, i, i4, i2);
            this.f69715c += i2;
            this.f69716d += i2;
            return;
        }
        int i5 = i3 - i4;
        byteString.copyTo(this.f69713a, i, i4, i5);
        int i6 = i + i5;
        int i7 = i2 - i5;
        this.f69715c = this.f69714b;
        this.f69716d += i5;
        m27988b();
        if (i7 <= this.f69714b) {
            byteString.copyTo(this.f69713a, i6, 0, i7);
            this.f69715c = i7;
        } else {
            byteString.m28001b(this.f69717e, i6, i7);
        }
        this.f69716d += i7;
    }
}
