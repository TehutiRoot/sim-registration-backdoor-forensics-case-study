...
public final class FunctionTypesKt {
    /* renamed from: a */
    public static final FunctionClassKind m28633a(FqNameUnsafe fqNameUnsafe) {
    ...
    /* renamed from: b */
    public static final boolean m28632b(KotlinType kotlinType) {
    ...
    public static final int contextFunctionTypeParamsCount(@NotNull KotlinType kotlinType) {
        ...
        ConstantValue constantValue = (ConstantValue) AbstractC11687a.getValue(findAnnotation.getAllValueArguments(), StandardNames.CONTEXT_FUNCTION_TYPE_PARAMETER_COUNT_NAME);
    ...
    public static final List<KotlinType> getContextReceiverTypesFromFunctionType(@NotNull KotlinType kotlinType) {
        ...
        ArrayList arrayList = new ArrayList(AbstractC10176es.collectionSizeOrDefault(subList, 10));
    ...
    public static final List<TypeProjection> getFunctionTypeArgumentProjections(@Nullable KotlinType kotlinType, @NotNull List<? extends KotlinType> contextReceiverTypes, @NotNull List<? extends KotlinType> parameterTypes, @Nullable List<Name> list, @NotNull KotlinType returnType, @NotNull KotlinBuiltIns builtIns) {
        ...
        for (Object obj : parameterTypes) {
            ...
            if (name != null) {
                ...
                kotlinType3 = TypeUtilsKt.replaceAnnotations(kotlinType3, Annotations.Companion.create(CollectionsKt___CollectionsKt.plus(kotlinType3.getAnnotations(), new BuiltInAnnotationDescriptor(builtIns, fqName, AbstractC18515Tn0.mapOf(TuplesKt.m28844to(identifier, new StringValue(asString)))))));
            }
    ...
    public static final FunctionClassKind getFunctionalClassKind(@NotNull DeclarationDescriptor declarationDescriptor) {
        ...
        return m28633a(DescriptorUtilsKt.getFqNameUnsafe(declarationDescriptor));
    }
    ...
    public static final boolean isBuiltinExtensionFunctionalType(@NotNull KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        if (isBuiltinFunctionalType(kotlinType) && m28632b(kotlinType)) {
            return true;
        }
        return false;
    }
    ...
    public static final Annotations withContextReceiversFunctionAnnotation(@NotNull Annotations annotations, @NotNull KotlinBuiltIns builtIns, int i) {
        ...
        if (!annotations.hasAnnotation(fqName)) {
            return Annotations.Companion.create(CollectionsKt___CollectionsKt.plus(annotations, new BuiltInAnnotationDescriptor(builtIns, fqName, AbstractC18515Tn0.mapOf(TuplesKt.m28844to(StandardNames.CONTEXT_FUNCTION_TYPE_PARAMETER_COUNT_NAME, new IntValue(i))))));
        }
        return annotations;
    }
    ...
    public static final Annotations withExtensionFunctionAnnotation(@NotNull Annotations annotations, @NotNull KotlinBuiltIns builtIns) {
        ...
        if (!annotations.hasAnnotation(fqName)) {
            return Annotations.Companion.create(CollectionsKt___CollectionsKt.plus(annotations, new BuiltInAnnotationDescriptor(builtIns, fqName, AbstractC11687a.emptyMap())));
        }
        return annotations;
    }
}
