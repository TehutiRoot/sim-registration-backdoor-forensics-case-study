...
public final class BuiltInFictitiousFunctionClassFactory implements ClassDescriptorFactory {
    ...
    /* renamed from: a */
    public final StorageManager f68551a;

    /* renamed from: b */
    public final ModuleDescriptor f68552b;
    ...
    public ClassDescriptor createClass(@NotNull ClassId classId) {
        ...
        for (Object obj : this.f68552b.getPackage(packageFqName).getFragments()) {
        ...
        return new FunctionClassDescriptor(this.f68551a, packageFragmentDescriptor, component1, component2);
    }
    ...
    public boolean shouldCreateClass(@NotNull FqName packageFqName, @NotNull Name name) {
        ...
        if ((!AbstractC20204hN1.startsWith$default(asString, "Function", false, 2, null) && !AbstractC20204hN1.startsWith$default(asString, "KFunction", false, 2, null) && !AbstractC20204hN1.startsWith$default(asString, "SuspendFunction", false, 2, null) && !AbstractC20204hN1.startsWith$default(asString, "KSuspendFunction", false, 2, null)) || FunctionClassKind.Companion.parseClassName(asString, packageFqName) == null) {
            return false;
        }
        return true;
    }
