...
public final class FunctionClassScope extends GivenFunctionsMemberScope {
    ...
    public List<FunctionDescriptor> computeDeclaredFunctions() {
        ...
        if (i != 1) {
            ...
            return AbstractC10108ds.listOf(FunctionInvokeDescriptor.Factory.create((FunctionClassDescriptor) getContainingClass(), true));
        }
        return AbstractC10108ds.listOf(FunctionInvokeDescriptor.Factory.create((FunctionClassDescriptor) getContainingClass(), false));
    }
}
