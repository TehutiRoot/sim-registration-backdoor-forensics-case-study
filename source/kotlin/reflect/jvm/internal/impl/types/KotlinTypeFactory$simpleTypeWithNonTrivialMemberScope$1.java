...
public final class KotlinTypeFactory$simpleTypeWithNonTrivialMemberScope$1 extends Lambda implements Function1<KotlinTypeRefiner, SimpleType> {
    ...
    public final SimpleType invoke(@NotNull KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        m27567b = KotlinTypeFactory.INSTANCE.m27567b(this.$constructor, kotlinTypeRefiner, this.$arguments);
        if (m27567b == null) {
            return null;
        }
        ...
        return KotlinTypeFactory.simpleTypeWithNonTrivialMemberScope(typeAttributes, m27565b, this.$arguments, this.$nullable, this.$memberScope);
    }
}
