...
public final class CapturedTypeApproximationKt {
    ...
    /* renamed from: a */
    public static final KotlinType m27510a(KotlinType kotlinType, KotlinType kotlinType2) {
    ...
    public static final ApproximationBounds<KotlinType> approximateCapturedTypes(@NotNull KotlinType type) {
        ...
        if (CapturedTypeConstructorKt.isCaptured(type)) {
            ...
            KotlinType m27510a = m27510a(type2, type);
            ...
            if (i != 2) {
                if (i == 3) {
                    ...
                    return new ApproximationBounds<>(m27510a(nothingType, type), m27510a);
                }
            ...
            return new ApproximationBounds<>(m27510a, nullableAnyType);
            ...
            for (Pair pair : CollectionsKt___CollectionsKt.zip(type.getArguments(), parameters)) {
                ...
                QV1 m27506e = m27506e(typeProjection, typeParameter);
                if (typeProjection.isStarProjection()) {
                    arrayList.add(m27506e);
                    arrayList2.add(m27506e);
                } else {
                    ApproximationBounds m27509b = m27509b(m27506e);
                    arrayList.add((QV1) m27509b.component1());
                    arrayList2.add((QV1) m27509b.component2());
                }
            }
            boolean z = false;
            ...
            if (z) {
                m27508c = TypeUtilsKt.getBuiltIns(type).getNothingType();
                Intrinsics.checkNotNullExpressionValue(m27508c, "type.builtIns.nothingType");
            } else {
                m27508c = m27508c(type, arrayList);
            }
            return new ApproximationBounds<>(m27508c, m27508c(type, arrayList2));
        } else {
    ...
    public static final TypeProjection approximateCapturedTypesIfNecessary(@Nullable TypeProjection typeProjection, boolean z) {
        ...
        if (!TypeUtils.contains(type, C12006x21acc51c.INSTANCE)) {
            return typeProjection;
        }
        ...
        return m27507d(typeProjection);
    }

    /* renamed from: b */
    public static final ApproximationBounds m27509b(QV1 qv1) {
        ApproximationBounds<KotlinType> approximateCapturedTypes = approximateCapturedTypes(qv1.m66558a());
        ApproximationBounds<KotlinType> approximateCapturedTypes2 = approximateCapturedTypes(qv1.m66557b());
        return new ApproximationBounds(new QV1(qv1.m66556c(), approximateCapturedTypes.component2(), approximateCapturedTypes2.component1()), new QV1(qv1.m66556c(), approximateCapturedTypes.component1(), approximateCapturedTypes2.component2()));
    }

    /* renamed from: c */
    public static final KotlinType m27508c(KotlinType kotlinType, List list) {
        kotlinType.getArguments().size();
        list.size();
        List<QV1> list2 = list;
        ArrayList arrayList = new ArrayList(AbstractC10176es.collectionSizeOrDefault(list2, 10));
        for (QV1 qv1 : list2) {
            arrayList.add(m27505f(qv1));
        }
        return TypeSubstitutionKt.replace$default(kotlinType, arrayList, null, null, 6, null);
    }

    /* renamed from: d */
    public static final TypeProjection m27507d(TypeProjection typeProjection) {
    ...
    /* renamed from: e */
    public static final QV1 m27506e(TypeProjection typeProjection, TypeParameterDescriptor typeParameterDescriptor) {
        ...
        if (i != 1) {
            if (i != 2) {
                if (i == 3) {
                    ...
                    return new QV1(typeParameterDescriptor, nothingType, type);
                }
            ...
            return new QV1(typeParameterDescriptor, type2, nullableAnyType);
        }
        KotlinType type3 = typeProjection.getType();
        Intrinsics.checkNotNullExpressionValue(type3, "type");
        KotlinType type4 = typeProjection.getType();
        Intrinsics.checkNotNullExpressionValue(type4, "type");
        return new QV1(typeParameterDescriptor, type3, type4);
    }

    /* renamed from: f */
    public static final TypeProjection m27505f(QV1 qv1) {
        qv1.m66555d();
        if (!Intrinsics.areEqual(qv1.m66558a(), qv1.m66557b())) {
            Variance variance = qv1.m66556c().getVariance();
            Variance variance2 = Variance.IN_VARIANCE;
            if (variance != variance2) {
                if (KotlinBuiltIns.isNothing(qv1.m66558a()) && qv1.m66556c().getVariance() != variance2) {
                    return new TypeProjectionImpl(m27504g(qv1, Variance.OUT_VARIANCE), qv1.m66557b());
                }
                if (KotlinBuiltIns.isNullableAny(qv1.m66557b())) {
                    return new TypeProjectionImpl(m27504g(qv1, variance2), qv1.m66558a());
                }
                return new TypeProjectionImpl(m27504g(qv1, Variance.OUT_VARIANCE), qv1.m66557b());
            }
        }
        return new TypeProjectionImpl(qv1.m66558a());
    }

    /* renamed from: g */
    public static final Variance m27504g(QV1 qv1, Variance variance) {
        if (variance == qv1.m66556c().getVariance()) {
