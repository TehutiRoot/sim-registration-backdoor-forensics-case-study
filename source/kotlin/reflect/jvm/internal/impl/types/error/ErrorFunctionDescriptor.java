...
public final class ErrorFunctionDescriptor extends SimpleFunctionDescriptorImpl {
    ...
    public ErrorFunctionDescriptor(@NotNull ClassDescriptor containingDeclaration) {
        ...
        initialize((ReceiverParameterDescriptor) null, (ReceiverParameterDescriptor) null, CollectionsKt__CollectionsKt.emptyList(), CollectionsKt__CollectionsKt.emptyList(), CollectionsKt__CollectionsKt.emptyList(), (KotlinType) ErrorUtils.createErrorType(ErrorTypeKind.RETURN_TYPE_FOR_FUNCTION, new String[0]), Modality.OPEN, DescriptorVisibilities.PUBLIC);
    }
