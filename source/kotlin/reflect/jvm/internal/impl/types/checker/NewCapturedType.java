...
public final class NewCapturedType extends SimpleType implements CapturedTypeMarker {
    ...
    /* renamed from: b */
    public final CaptureStatus f70304b;

    /* renamed from: c */
    public final NewCapturedTypeConstructor f70305c;

    /* renamed from: d */
    public final UnwrappedType f70306d;

    /* renamed from: e */
    public final TypeAttributes f70307e;

    /* renamed from: f */
    public final boolean f70308f;

    /* renamed from: g */
    public final boolean f70309g;
    ...
    public SimpleType replaceAttributes(@NotNull TypeAttributes newAttributes) {
        ...
        return new NewCapturedType(this.f70304b, getConstructor(), this.f70306d, newAttributes, isMarkedNullable(), this.f70309g);
    }
    ...
    public NewCapturedType(@NotNull CaptureStatus captureStatus, @NotNull NewCapturedTypeConstructor constructor, @Nullable UnwrappedType unwrappedType, @NotNull TypeAttributes attributes, boolean z, boolean z2) {
        ...
        this.f70304b = captureStatus;
        this.f70305c = constructor;
        this.f70306d = unwrappedType;
        this.f70307e = attributes;
        this.f70308f = z;
        this.f70309g = z2;
    }
    ...
    public NewCapturedType makeNullableAsSpecified(boolean z) {
        return new NewCapturedType(this.f70304b, getConstructor(), this.f70306d, getAttributes(), z, false, 32, null);
    }
    ...
    public NewCapturedType refine(@NotNull KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        CaptureStatus captureStatus = this.f70304b;
        NewCapturedTypeConstructor refine = getConstructor().refine(kotlinTypeRefiner);
        UnwrappedType unwrappedType = this.f70306d;
