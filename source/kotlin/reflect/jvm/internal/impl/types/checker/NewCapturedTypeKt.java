...
public final class NewCapturedTypeKt {
    /* renamed from: a */
    public static final List m27522a(UnwrappedType unwrappedType, CaptureStatus captureStatus) {
    ...
    /* renamed from: b */
    public static final SimpleType m27521b(UnwrappedType unwrappedType, List list) {
    ...
    public static final SimpleType captureFromArguments(@NotNull SimpleType type, @NotNull CaptureStatus status) {
        ...
        List m27522a = m27522a(type, status);
        if (m27522a != null) {
            return m27521b(type, m27522a);
        }
        return null;
    }
}
