...
@Metadata(m28851d1 = {"\u0000\b\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001H\n¢\u0006\u0002\b\u0002"}, m28850d2 = {"<anonymous>", "Ljava/lang/reflect/Type;", "invoke"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
...
public final class KParameterImpl$type$1 extends Lambda implements Function0<Type> {
    ...
    public final Type invoke() {
        ...
        if ((m28674a instanceof ReceiverParameterDescriptor) && Intrinsics.areEqual(UtilKt.getInstanceReceiverParameter(this.this$0.getCallable().getDescriptor()), m28674a) && this.this$0.getCallable().getDescriptor().getKind() == CallableMemberDescriptor.Kind.FAKE_OVERRIDE) {
            ...
            throw new KotlinReflectionInternalError("Cannot determine receiver Java type of inherited declaration: " + m28674a);
        }
