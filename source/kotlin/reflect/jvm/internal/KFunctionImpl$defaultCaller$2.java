...
public final class KFunctionImpl$defaultCaller$2 extends Lambda implements Function0<Caller<? extends Executable>> {
    ...
    public final Caller<? extends Executable> invoke() {
        ...
        if (genericDeclaration instanceof Constructor) {
            ...
            caller = kFunctionImpl.m28685e((Constructor) genericDeclaration, kFunctionImpl.getDescriptor(), true);
            ...
            if (this.this$0.getDescriptor().getAnnotations().findAnnotation(UtilKt.getJVM_STATIC()) != null) {
                ...
                if (!((ClassDescriptor) containingDeclaration).isCompanionObject()) {
                    caller = this.this$0.m28683g((Method) genericDeclaration);
                }
            }
            caller = this.this$0.m28682h((Method) genericDeclaration);
        } else {
            caller = null;
        }
        if (caller != null) {
