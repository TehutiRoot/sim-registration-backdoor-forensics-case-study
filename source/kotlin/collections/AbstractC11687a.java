...
public abstract class AbstractC11687a extends AbstractC18515Tn0 {
    @NotNull
    ...
    public static <K, V> V getValue(@NotNull Map<K, ? extends V> map, K k) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        return (V) AbstractC18451Sn0.getOrImplicitDefaultNullable(map, k);
    }

    @NotNull
    public static <K, V> HashMap<K, V> hashMapOf(@NotNull Pair<? extends K, ? extends V>... pairs) {
        Intrinsics.checkNotNullParameter(pairs, "pairs");
        HashMap<K, V> hashMap = new HashMap<>(AbstractC18515Tn0.mapCapacity(pairs.length));
    ...
    public static final <K, V> LinkedHashMap<K, V> linkedMapOf(@NotNull Pair<? extends K, ? extends V>... pairs) {
        Intrinsics.checkNotNullParameter(pairs, "pairs");
        return (LinkedHashMap) toMap(pairs, new LinkedHashMap(AbstractC18515Tn0.mapCapacity(pairs.length)));
    }
    ...
    public static <K, V> Map<K, V> mapOf(@NotNull Pair<? extends K, ? extends V>... pairs) {
        Intrinsics.checkNotNullParameter(pairs, "pairs");
        if (pairs.length > 0) {
            return toMap(pairs, new LinkedHashMap(AbstractC18515Tn0.mapCapacity(pairs.length)));
        }
        return emptyMap();
    }
    ...
    public static <K, V> Map<K, V> mutableMapOf(@NotNull Pair<? extends K, ? extends V>... pairs) {
        Intrinsics.checkNotNullParameter(pairs, "pairs");
        LinkedHashMap linkedHashMap = new LinkedHashMap(AbstractC18515Tn0.mapCapacity(pairs.length));
    ...
    public static final <K, V> Map<K, V> optimizeReadOnlyMap(@NotNull Map<K, ? extends V> map) {
        ...
        if (size != 0) {
            if (size == 1) {
                return AbstractC18515Tn0.toSingletonMap(map);
            }
            return map;
        }
        return emptyMap();
    ...
    public static <K, V> Map<K, V> plus(@NotNull Map<? extends K, ? extends V> map, @NotNull Pair<? extends K, ? extends V> pair) {
        ...
        if (map.isEmpty()) {
            return AbstractC18515Tn0.mapOf(pair);
        }
    ...
    public static <K, V> Map<K, V> toMap(@NotNull Iterable<? extends Pair<? extends K, ? extends V>> iterable) {
        ...
        if (iterable instanceof Collection) {
            ...
            if (size != 0) {
                if (size != 1) {
                    return toMap(iterable, new LinkedHashMap(AbstractC18515Tn0.mapCapacity(collection.size())));
                }
                return AbstractC18515Tn0.mapOf(iterable instanceof List ? (Pair<? extends K, ? extends V>) ((List) iterable).get(0) : iterable.iterator().next());
            }
            return emptyMap();
        }
    ...
    public static final <K, V> Map<K, V> minus(@NotNull Map<? extends K, ? extends V> map, @NotNull Iterable<? extends K> keys) {
        ...
        Map mutableMap = toMutableMap(map);
        AbstractC10410hs.removeAll(mutableMap.keySet(), keys);
        return optimizeReadOnlyMap(mutableMap);
    }
    ...
    public static <K, V> Map<K, V> toMap(@NotNull Pair<? extends K, ? extends V>[] pairArr) {
        ...
        if (length != 0) {
            if (length != 1) {
                return toMap(pairArr, new LinkedHashMap(AbstractC18515Tn0.mapCapacity(pairArr.length)));
            }
            return AbstractC18515Tn0.mapOf(pairArr[0]);
        }
        return emptyMap();
    }
