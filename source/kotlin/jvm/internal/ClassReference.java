...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
    ...
    /* renamed from: b */
    public static final Map f68264b;

    /* renamed from: c */
    public static final HashMap f68265c;

    /* renamed from: d */
    public static final HashMap f68266d;

    /* renamed from: e */
    public static final HashMap f68267e;

    /* renamed from: f */
    public static final Map f68268f;

    /* renamed from: a */
    public final Class f68269a;

    @Metadata(m28851d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0010\u000b\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0014\u0010\u000f\u001a\u0004\u0018\u00010\n2\n\u0010\u0010\u001a\u0006\u0012\u0002\b\u00030\u0005J\u0014\u0010\u0011\u001a\u0004\u0018\u00010\n2\n\u0010\u0010\u001a\u0006\u0012\u0002\b\u00030\u0005J\u001c\u0010\u0012\u001a\u00020\u00132\b\u0010\u0014\u001a\u0004\u0018\u00010\u00012\n\u0010\u0010\u001a\u0006\u0012\u0002\b\u00030\u0005R&\u0010\u0003\u001a\u001a\u0012\u0010\u0012\u000e\u0012\n\b\u0001\u0012\u0006\u0012\u0002\b\u00030\u00060\u0005\u0012\u0004\u0012\u00020\u00070\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R*\u0010\b\u001a\u001e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n0\tj\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n`\u000bX\u0082\u0004¢\u0006\u0002\n\u0000R*\u0010\f\u001a\u001e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n0\tj\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n`\u000bX\u0082\u0004¢\u0006\u0002\n\u0000R*\u0010\r\u001a\u001e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n0\tj\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n`\u000bX\u0082\u0004¢\u0006\u0002\n\u0000R\u001a\u0010\u000e\u001a\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n0\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0015"}, m28850d2 = {"Lkotlin/jvm/internal/ClassReference$Companion;", "", "()V", "FUNCTION_CLASSES", "", "Ljava/lang/Class;", "Lkotlin/Function;", "", "classFqNames", "Ljava/util/HashMap;", "", "Lkotlin/collections/HashMap;", "primitiveFqNames", "primitiveWrapperFqNames", "simpleNames", "getClassQualifiedName", "jClass", "getClassSimpleName", "isInstance", "", "value", "kotlin-stdlib"}, m28849k = 1, m28848mv = {1, 9, 0}, m28846xi = 48)
    ...
    public static final class Companion {
        ...
        public final String getClassQualifiedName(@NotNull Class<?> jClass) {
            ...
            if (jClass.isArray()) {
                ...
                if (componentType.isPrimitive() && (str = (String) ClassReference.f68267e.get(componentType.getName())) != null) {
                    str2 = str + "Array";
                }
                if (str2 == null) {
            ...
            String str3 = (String) ClassReference.f68267e.get(jClass.getName());
            if (str3 == null) {
        ...
        */
        ...
        public final boolean isInstance(@Nullable Object obj, @NotNull Class<?> jClass) {
            Intrinsics.checkNotNullParameter(jClass, "jClass");
            Map map = ClassReference.f68264b;
    ...
    static {
        ...
        for (Object obj : listOf) {
            ...
            arrayList.add(TuplesKt.m28844to((Class) obj, Integer.valueOf(i)));
            i = i2;
        }
        f68264b = AbstractC11687a.toMap(arrayList);
        ...
        for (String str : values) {
            ...
            Pair m28844to = TuplesKt.m28844to(sb.toString(), str + ".Companion");
            hashMap3.put(m28844to.getFirst(), m28844to.getSecond());
        }
        for (Map.Entry entry : f68264b.entrySet()) {
            int intValue = ((Number) entry.getValue()).intValue();
            hashMap3.put(((Class) entry.getKey()).getName(), "kotlin.Function" + intValue);
        }
        f68267e = hashMap3;
        LinkedHashMap linkedHashMap = new LinkedHashMap(AbstractC18515Tn0.mapCapacity(hashMap3.size()));
