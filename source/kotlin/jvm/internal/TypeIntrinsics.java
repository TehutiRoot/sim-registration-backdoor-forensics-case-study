...
public class TypeIntrinsics {
    /* renamed from: a */
    public static Throwable m28727a(Throwable th2) {
        return Intrinsics.m28732c(th2, TypeIntrinsics.class.getName());
    }
    ...
    public static boolean isFunctionOfArity(Object obj, int i) {
        if ((obj instanceof Function) && getFunctionArity(obj) == i) {
            return true;
        }
        return false;
    }
    ...
    public static void throwCce(Object obj, String str) {
        String name = obj == null ? AbstractJsonLexerKt.NULL : obj.getClass().getName();
    ...
    public static ClassCastException throwCce(ClassCastException classCastException) {
        throw ((ClassCastException) m28727a(classCastException));
    }
}
