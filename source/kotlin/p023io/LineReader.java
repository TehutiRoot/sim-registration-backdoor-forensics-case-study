...
public final class LineReader {
    ...
    /* renamed from: a */
    public static CharsetDecoder f68223a;

    /* renamed from: b */
    public static boolean f68224b;

    /* renamed from: c */
    public static final byte[] f68225c;

    /* renamed from: d */
    public static final char[] f68226d;

    /* renamed from: e */
    public static final ByteBuffer f68227e;

    /* renamed from: f */
    public static final CharBuffer f68228f;

    /* renamed from: g */
    public static final StringBuilder f68229g;
    ...
    static {
        ...
        f68228f = wrap2;
        f68229g = new StringBuilder();
    }

    /* renamed from: a */
    public final int m28773a() {
        ByteBuffer byteBuffer = f68227e;
        byteBuffer.compact();
    ...
    /* renamed from: b */
    public final int m28772b(boolean z) {
        while (true) {
            CharsetDecoder charsetDecoder = f68223a;
            if (charsetDecoder == null) {
                Intrinsics.throwUninitializedPropertyAccessException("decoder");
                charsetDecoder = null;
            }
            ByteBuffer byteBuffer = f68227e;
            CharBuffer charBuffer = f68228f;
    ...
    /* renamed from: c */
    public final int m28771c(int i, int i2) {
        ByteBuffer byteBuffer = f68227e;
        byteBuffer.limit(i);
        f68228f.position(i2);
        int m28772b = m28772b(true);
        CharsetDecoder charsetDecoder = f68223a;
        if (charsetDecoder == null) {
            Intrinsics.throwUninitializedPropertyAccessException("decoder");
            charsetDecoder = null;
    ...
    /* renamed from: f */
    public final void m28768f(Charset charset) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:35:0x007a, code lost:
        r0 = kotlin.p023io.LineReader.f68226d;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:43:0x0092, code lost:
        r0 = kotlin.p023io.LineReader.f68229g;
     */
    /* JADX WARN: Code restructure failed: missing block: B:44:0x0098, code lost:
        if (r0.length() != 0) goto L40;
     */
    /* JADX WARN: Code restructure failed: missing block: B:47:0x00a2, code lost:
        return new java.lang.String(kotlin.p023io.LineReader.f68226d, 0, r10);
     */
    /* JADX WARN: Code restructure failed: missing block: B:48:0x00a3, code lost:
        r0.append(kotlin.p023io.LineReader.f68226d, 0, r10);
        r10 = r0.toString();
    ...
    */
    public final synchronized java.lang.String readLine(@org.jetbrains.annotations.NotNull java.io.InputStream r10, @org.jetbrains.annotations.NotNull java.nio.charset.Charset r11) {
        /*
            ...
            java.nio.charset.CharsetDecoder r0 = kotlin.p023io.LineReader.f68223a     // Catch: java.lang.Throwable -> L19
            r1 = 0
            if (r0 == 0) goto L26
            if (r0 != 0) goto L1c
        ...
        L1c:
            ...
            if (r0 != 0) goto L29
        L26:
            r9.m28768f(r11)     // Catch: java.lang.Throwable -> L19
        L29:
            r11 = 0
            r0 = 0
            r2 = 0
        L2c:
            ...
            r6 = 10
            if (r3 != r5) goto L4a
            java.lang.StringBuilder r10 = kotlin.p023io.LineReader.f68229g     // Catch: java.lang.Throwable -> L19
            ...
            return r1
        L45:
            int r10 = r9.m28771c(r0, r2)     // Catch: java.lang.Throwable -> L19
            goto L78
        L4a:
            byte[] r5 = kotlin.p023io.LineReader.f68225c     // Catch: java.lang.Throwable -> L19
            int r7 = r0 + 1
            byte r8 = (byte) r3     // Catch: java.lang.Throwable -> L19
            r5[r0] = r8     // Catch: java.lang.Throwable -> L19
            if (r3 == r6) goto L5c
            if (r7 == r4) goto L5c
            boolean r0 = kotlin.p023io.LineReader.f68224b     // Catch: java.lang.Throwable -> L19
            if (r0 != 0) goto L5a
            goto L5c
        L5a:
            r0 = r7
            goto L2c
        L5c:
            java.nio.ByteBuffer r0 = kotlin.p023io.LineReader.f68227e     // Catch: java.lang.Throwable -> L19
            r0.limit(r7)     // Catch: java.lang.Throwable -> L19
            java.nio.CharBuffer r3 = kotlin.p023io.LineReader.f68228f     // Catch: java.lang.Throwable -> L19
            r3.position(r2)     // Catch: java.lang.Throwable -> L19
            int r2 = r9.m28772b(r11)     // Catch: java.lang.Throwable -> L19
            if (r2 <= 0) goto Lbf
            char[] r3 = kotlin.p023io.LineReader.f68226d     // Catch: java.lang.Throwable -> L19
            int r5 = r2 + (-1)
        ...
        L78:
            if (r10 <= 0) goto L92
            char[] r0 = kotlin.p023io.LineReader.f68226d     // Catch: java.lang.Throwable -> L19
            int r1 = r10 + (-1)
        ...
        L91:
            r10 = r1
        L92:
            java.lang.StringBuilder r0 = kotlin.p023io.LineReader.f68229g     // Catch: java.lang.Throwable -> L19
            int r1 = r0.length()     // Catch: java.lang.Throwable -> L19
            if (r1 != 0) goto La3
            java.lang.String r0 = new java.lang.String     // Catch: java.lang.Throwable -> L19
            char[] r1 = kotlin.p023io.LineReader.f68226d     // Catch: java.lang.Throwable -> L19
        ...
        La3:
            ...
            int r1 = r0.length()     // Catch: java.lang.Throwable -> L19
            if (r1 <= r4) goto Lba
            r9.m28769e()     // Catch: java.lang.Throwable -> L19
        Lba:
            r0.setLength(r11)     // Catch: java.lang.Throwable -> L19
            monitor-exit(r9)
            return r10
        Lbf:
            int r0 = r9.m28773a()     // Catch: java.lang.Throwable -> L19
            goto L2c
        Lc5:
