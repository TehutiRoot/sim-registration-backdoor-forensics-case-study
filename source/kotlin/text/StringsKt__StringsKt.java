...
public abstract class StringsKt__StringsKt extends AbstractC20204hN1 {
    /* renamed from: c */
    public static final Pair m27439c(CharSequence charSequence, Collection collection, int i, boolean z, boolean z2) {
        ...
        if (!z && collection.size() == 1) {
            ...
            return TuplesKt.m28844to(Integer.valueOf(lastIndexOf$default), str);
        }
        if (!z2) {
            downTo = new IntRange(AbstractC11719c.coerceAtLeast(i, 0), charSequence.length());
        } else {
            downTo = AbstractC11719c.downTo(AbstractC11719c.coerceAtMost(i, getLastIndex(charSequence)), 0);
        }
        if (charSequence instanceof String) {
                ...
                while (true) {
                    ...
                    while (true) {
                        if (it.hasNext()) {
                            ...
                            if (AbstractC20204hN1.regionMatches(str2, 0, (String) charSequence, first, str2.length(), z)) {
                                break;
                            }
                        } else {
                            obj2 = null;
                    ...
                    if (str3 != null) {
                        return TuplesKt.m28844to(Integer.valueOf(first), str3);
                    }
                    if (first == last) {
                        break;
                    }
            ...
            if ((step2 > 0 && first2 <= last2) || (step2 < 0 && last2 <= first2)) {
                while (true) {
                    ...
                    if (str5 != null) {
                        return TuplesKt.m28844to(Integer.valueOf(first2), str5);
                    }
                    if (first2 == last2) {
                        break;
                    }
    ...
    public static final String commonPrefixWith(@NotNull CharSequence charSequence, @NotNull CharSequence other, boolean z) {
        ...
        int i = 0;
        while (i < min && AbstractC5403bp.equals(charSequence.charAt(i), other.charAt(i), z)) {
            i++;
        }
        int i2 = i - 1;
    ...
    public static final String commonSuffixWith(@NotNull CharSequence charSequence, @NotNull CharSequence other, boolean z) {
        ...
        int i = 0;
        while (i < min && AbstractC5403bp.equals(charSequence.charAt((length2 - i) - 1), other.charAt((length - i) - 1), z)) {
            i++;
        }
    ...
    public static boolean contains(@NotNull CharSequence charSequence, @NotNull CharSequence other, boolean z) {
        ...
        } else if (m27437e(charSequence, other, 0, charSequence.length(), z, false, 16, null) < 0) {
            return false;
        }
        return true;
    }
    ...
    public static final boolean contentEqualsIgnoreCaseImpl(@Nullable CharSequence charSequence, @Nullable CharSequence charSequence2) {
        if ((charSequence instanceof String) && (charSequence2 instanceof String)) {
            return AbstractC20204hN1.equals((String) charSequence, (String) charSequence2, true);
        }
        ...
        for (int i = 0; i < length; i++) {
            if (!AbstractC5403bp.equals(charSequence.charAt(i), charSequence2.charAt(i), true)) {
                return false;
            }
        }
        return true;
    ...
    /* renamed from: d */
    public static final int m27438d(CharSequence charSequence, CharSequence charSequence2, int i, int i2, boolean z, boolean z2) {
        IntProgression downTo;
        if (!z2) {
            downTo = new IntRange(AbstractC11719c.coerceAtLeast(i, 0), AbstractC11719c.coerceAtMost(i2, charSequence.length()));
        } else {
            downTo = AbstractC11719c.downTo(AbstractC11719c.coerceAtMost(i, getLastIndex(charSequence)), AbstractC11719c.coerceAtLeast(i2, 0));
        }
        if ((charSequence instanceof String) && (charSequence2 instanceof String)) {
            int first = downTo.getFirst();
            int last = downTo.getLast();
            int step = downTo.getStep();
            if ((step > 0 && first <= last) || (step < 0 && last <= first)) {
                while (!AbstractC20204hN1.regionMatches((String) charSequence2, 0, (String) charSequence, first, charSequence2.length(), z)) {
                    if (first != last) {
                        first += step;
                    } else {
                        return -1;
    ...
    /* renamed from: e */
    public static /* synthetic */ int m27437e(CharSequence charSequence, CharSequence charSequence2, int i, int i2, boolean z, boolean z2, int i3, Object obj) {
        boolean z3;
        if ((i3 & 16) != 0) {
            z3 = false;
        } else {
        ...
        return m27438d(charSequence, charSequence2, i, i2, z, z3);
    }

    public static final boolean endsWith(@NotNull CharSequence charSequence, char c, boolean z) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        return charSequence.length() > 0 && AbstractC5403bp.equals(charSequence.charAt(getLastIndex(charSequence)), c, z);
    }
    ...
    /* renamed from: f */
    public static final Sequence m27436f(CharSequence charSequence, char[] cArr, int i, boolean z, int i2) {
    ...
    @Nullable
    public static Pair<Integer, String> findAnyOf(@NotNull CharSequence charSequence, @NotNull Collection<String> strings, int i, boolean z) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(strings, "strings");
        return m27439c(charSequence, strings, i, z, false);
    }
    ...
    public static final Pair<Integer, String> findLastAnyOf(@NotNull CharSequence charSequence, @NotNull Collection<String> strings, int i, boolean z) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(strings, "strings");
        return m27439c(charSequence, strings, i, z, true);
    }
    ...
    /* renamed from: g */
    public static final Sequence m27435g(CharSequence charSequence, String[] strArr, int i, boolean z, int i2) {
        requireNonNegativeLimit(i2);
    ...
    /* renamed from: h */
    public static /* synthetic */ Sequence m27434h(CharSequence charSequence, char[] cArr, int i, boolean z, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        return m27436f(charSequence, cArr, i, z, i2);
    }
    ...
    /* renamed from: i */
    public static /* synthetic */ Sequence m27433i(CharSequence charSequence, String[] strArr, int i, boolean z, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        return m27435g(charSequence, strArr, i, z, i2);
    }
    ...
    public static final int indexOfAny(@NotNull CharSequence charSequence, @NotNull char[] chars, int i, boolean z) {
        ...
        ?? it = new IntRange(AbstractC11719c.coerceAtLeast(i, 0), getLastIndex(charSequence)).iterator();
        while (it.hasNext()) {
            int nextInt = it.nextInt();
            char charAt = charSequence.charAt(nextInt);
            for (char c : chars) {
                if (AbstractC5403bp.equals(c, charAt, z)) {
                    return nextInt;
                }
            }
        }
    ...
    public static final CharIterator iterator(@NotNull final CharSequence charSequence) {
        ...
        return new CharIterator() { // from class: kotlin.text.StringsKt__StringsKt$iterator$1
            ...
            public boolean hasNext() {
                if (this.f70544a < charSequence.length()) {
                    return true;
                }
                return false;
            }
    ...
    /* renamed from: j */
    public static final List m27432j(CharSequence charSequence, String str, boolean z, int i) {
        boolean z2;
        ...
        if (indexOf != -1 && i != 1) {
            ...
            int i3 = 10;
            if (z2) {
                i3 = AbstractC11719c.coerceAtMost(i, 10);
            }
        ...
        return AbstractC10108ds.listOf(charSequence.toString());
    }
    ...
    public static final int lastIndexOfAny(@NotNull CharSequence charSequence, @NotNull char[] chars, int i, boolean z) {
        ...
        for (int coerceAtMost = AbstractC11719c.coerceAtMost(i, getLastIndex(charSequence)); -1 < coerceAtMost; coerceAtMost--) {
    ...
    public static final boolean regionMatchesImpl(@NotNull CharSequence charSequence, int i, @NotNull CharSequence other, int i2, int i3, boolean z) {
        ...
        for (int i4 = 0; i4 < i3; i4++) {
            if (!AbstractC5403bp.equals(charSequence.charAt(i + i4), other.charAt(i2 + i4), z)) {
                return false;
            }
        }
        return true;
    ...
    public static final List<String> split(@NotNull CharSequence charSequence, @NotNull String[] delimiters, boolean z, int i) {
        ...
        if (delimiters.length == 1) {
            ...
            if (str.length() != 0) {
                return m27432j(charSequence, str, z, i);
            }
        }
        Iterable<IntRange> asIterable = SequencesKt___SequencesKt.asIterable(m27433i(charSequence, delimiters, 0, z, i, 2, null));
        ArrayList arrayList = new ArrayList(AbstractC10176es.collectionSizeOrDefault(asIterable, 10));
    ...
    public static final Sequence<String> splitToSequence(@NotNull CharSequence charSequence, @NotNull String[] delimiters, boolean z, int i) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(delimiters, "delimiters");
        return SequencesKt___SequencesKt.map(m27433i(charSequence, delimiters, 0, z, i, 2, null), new StringsKt__StringsKt$splitToSequence$1(charSequence));
    }
    ...
    public static final boolean startsWith(@NotNull CharSequence charSequence, char c, boolean z) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        return charSequence.length() > 0 && AbstractC5403bp.equals(charSequence.charAt(0), c, z);
    }
    ...
    public static final boolean endsWith(@NotNull CharSequence charSequence, @NotNull CharSequence suffix, boolean z) {
        ...
        if (!z && (charSequence instanceof String) && (suffix instanceof String)) {
            return AbstractC20204hN1.endsWith$default((String) charSequence, (String) suffix, false, 2, null);
        }
    ...
    public static final Sequence<String> splitToSequence(@NotNull CharSequence charSequence, @NotNull char[] delimiters, boolean z, int i) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(delimiters, "delimiters");
        return SequencesKt___SequencesKt.map(m27434h(charSequence, delimiters, 0, z, i, 2, null), new StringsKt__StringsKt$splitToSequence$2(charSequence));
    }
    ...
    public static final boolean startsWith(@NotNull CharSequence charSequence, @NotNull CharSequence prefix, boolean z) {
        ...
        if (!z && (charSequence instanceof String) && (prefix instanceof String)) {
            return AbstractC20204hN1.startsWith$default((String) charSequence, (String) prefix, false, 2, null);
        }
    ...
    public static int indexOf(@NotNull CharSequence charSequence, @NotNull String string, int i, boolean z) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(string, "string");
        if (!z && (charSequence instanceof String)) {
            return ((String) charSequence).indexOf(string, i);
        }
        return m27437e(charSequence, string, i, charSequence.length(), z, false, 16, null);
    }
    ...
    public static final int lastIndexOf(@NotNull CharSequence charSequence, @NotNull String string, int i, boolean z) {
        ...
        return m27438d(charSequence, string, i, 0, z, true);
    }
    ...
    public static final boolean startsWith(@NotNull CharSequence charSequence, @NotNull CharSequence prefix, int i, boolean z) {
        ...
        Intrinsics.checkNotNullParameter(prefix, "prefix");
        if (!z && (charSequence instanceof String) && (prefix instanceof String)) {
            return AbstractC20204hN1.startsWith$default((String) charSequence, (String) prefix, i, false, 4, null);
        }
    ...
    public static final int indexOfAny(@NotNull CharSequence charSequence, @NotNull Collection<String> strings, int i, boolean z) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(strings, "strings");
        Pair m27439c = m27439c(charSequence, strings, i, z, false);
        if (m27439c != null) {
            return ((Number) m27439c.getFirst()).intValue();
        }
        return -1;
    }
    ...
    public static final int lastIndexOfAny(@NotNull CharSequence charSequence, @NotNull Collection<String> strings, int i, boolean z) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(strings, "strings");
        Pair m27439c = m27439c(charSequence, strings, i, z, true);
        if (m27439c != null) {
            return ((Number) m27439c.getFirst()).intValue();
        }
        return -1;
    ...
    public static final List<String> split(@NotNull CharSequence charSequence, @NotNull char[] delimiters, boolean z, int i) {
        ...
        Intrinsics.checkNotNullParameter(delimiters, "delimiters");
        if (delimiters.length == 1) {
            return m27432j(charSequence, String.valueOf(delimiters[0]), z, i);
        }
        Iterable<IntRange> asIterable = SequencesKt___SequencesKt.asIterable(m27434h(charSequence, delimiters, 0, z, i, 2, null));
        ArrayList arrayList = new ArrayList(AbstractC10176es.collectionSizeOrDefault(asIterable, 10));
        for (IntRange intRange : asIterable) {
            arrayList.add(substring(charSequence, intRange));
        }
    ...
    public static CharSequence trim(@NotNull CharSequence charSequence) {
        ...
        boolean z = false;
        while (i <= length) {
            boolean isWhitespace = AbstractC12026a.isWhitespace(charSequence.charAt(!z ? i : length));
            if (z) {
                if (!isWhitespace) {
                    break;
                }
    ...
    public static final CharSequence trimEnd(@NotNull CharSequence charSequence) {
        ...
        if (length >= 0) {
            while (true) {
                int i = length - 1;
                if (!AbstractC12026a.isWhitespace(charSequence.charAt(length))) {
                    return charSequence.subSequence(0, length + 1);
                }
                if (i < 0) {
                    break;
    ...
    public static final CharSequence trimStart(@NotNull CharSequence charSequence) {
        ...
        int length = charSequence.length();
        for (int i = 0; i < length; i++) {
            if (!AbstractC12026a.isWhitespace(charSequence.charAt(i))) {
                return charSequence.subSequence(i, charSequence.length());
            }
        }
        return "";
