...
public final class HexExtensionsKt {
    ...
    /* renamed from: a */
    public static final long m27462a(long j, int i, int i2) {
        if (i > 0) {
            long j2 = i;
            return (j * j2) + (i2 * (j2 - 1));
        }
    ...
    /* renamed from: b */
    public static final int m27461b(String str, String str2, int i, int i2, String str3) {
        int length = str2.length() + i;
        if (length <= i2 && AbstractC20204hN1.regionMatches(str, i, str2, 0, str2.length(), true)) {
            return length;
        }
        ...
        sb.append(i);
        sb.append(", but was ");
        int coerceAtMost = AbstractC11719c.coerceAtMost(length, i2);
    ...
    /* renamed from: c */
    public static final void m27460c(String str, int i, int i2, int i3, boolean z) {
        String str2;
        int i4 = i2 - i;
        if (z) {
            if (i4 == i3) {
        ...
        Intrinsics.checkNotNullExpressionValue(substring, "substring(...)");
        throw new NumberFormatException("Expected " + str2 + TokenParser.f74560SP + i3 + " hexadecimal digits at index " + i + ", but was " + substring + " of length " + i4);
    }

    /* renamed from: d */
    public static final int m27459d(String str, int i, int i2) {
        if (str.charAt(i) == '\r') {
            int i3 = i + 1;
    ...
    /* renamed from: e */
    public static final int m27458e(String str, int i) {
        int i2;
        char charAt = str.charAt(i);
        if (charAt <= 127 && (i2 = f70506a[charAt]) >= 0) {
            return i2;
        }
    ...
    /* renamed from: f */
    public static final byte m27457f(String str, int i, int i2, HexFormat hexFormat) {
        return (byte) m27453j(str, i, i2, hexFormat, 2);
    }
    ...
    public static final int formattedStringLength(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        if (i > 0) {
            ...
            if (AbstractC11719c.intRangeContains((ClosedRange<Integer>) new IntRange(0, Integer.MAX_VALUE), j)) {
                return (int) j;
            }
            throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m74150toStringimpl(ULong.m74146constructorimpl(j))));
        }
        throw new IllegalArgumentException("Failed requirement.".toString());
    }

    /* renamed from: g */
    public static final byte[] m27456g(String str, int i, int i2, HexFormat hexFormat) {
        int i3 = i;
        ...
        while (i3 < i2) {
            if (i5 == bytesPerLine) {
                i3 = m27459d(str, i3, i2);
                i5 = 0;
            } else if (i6 == bytesPerGroup) {
                i3 = m27461b(str, groupSeparator, i3, i2, "group separator");
            } else {
                if (i6 != 0) {
                    i3 = m27461b(str, str2, i3, i2, "byte separator");
                }
                i5++;
                i6++;
                int m27461b = m27461b(str, bytePrefix, i3, i2, "byte prefix");
                m27460c(str, m27461b, AbstractC11719c.coerceAtMost(m27461b + 2, i2), 2, true);
                bArr[i4] = (byte) ((m27458e(str, m27461b) << 4) | m27458e(str, m27461b + 1));
                i3 = m27461b(str, byteSuffix, m27461b + 2, i2, "byte suffix");
                i4++;
                str2 = str2;
            }
            i6 = 0;
            i5++;
            i6++;
            int m27461b2 = m27461b(str, bytePrefix, i3, i2, "byte prefix");
            m27460c(str, m27461b2, AbstractC11719c.coerceAtMost(m27461b2 + 2, i2), 2, true);
            bArr[i4] = (byte) ((m27458e(str, m27461b2) << 4) | m27458e(str, m27461b2 + 1));
            i3 = m27461b(str, byteSuffix, m27461b2 + 2, i2, "byte suffix");
            i4++;
            str2 = str2;
        }
    ...
    /* renamed from: h */
    public static final int m27455h(String str, int i, int i2, HexFormat hexFormat) {
        return (int) m27453j(str, i, i2, hexFormat, 8);
    }
    ...
    public static final byte hexToByte(@NotNull String str, @NotNull HexFormat format) {
        ...
        return m27457f(str, 0, str.length(), format);
    }
    ...
    public static final byte[] hexToByteArray(@NotNull String str, @NotNull HexFormat format) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        Intrinsics.checkNotNullParameter(format, "format");
        return m27456g(str, 0, str.length(), format);
    }
    ...
    public static final int hexToInt(@NotNull String str, @NotNull HexFormat format) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        Intrinsics.checkNotNullParameter(format, "format");
        return m27455h(str, 0, str.length(), format);
    }
    ...
    public static final long hexToLong(@NotNull String str, @NotNull HexFormat format) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        Intrinsics.checkNotNullParameter(format, "format");
        return m27454i(str, 0, str.length(), format);
    }
    ...
    public static final short hexToShort(@NotNull String str, @NotNull HexFormat format) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        Intrinsics.checkNotNullParameter(format, "format");
        return m27452k(str, 0, str.length(), format);
    }
    ...
    /* renamed from: i */
    public static final long m27454i(String str, int i, int i2, HexFormat hexFormat) {
        return m27453j(str, i, i2, hexFormat, 16);
    }

    /* renamed from: j */
    public static final long m27453j(String str, int i, int i2, HexFormat hexFormat, int i3) {
        ...
        if (prefix.length() + suffix.length() < i2 - i) {
            int m27461b = m27461b(str, prefix, i, i2, "prefix");
            int length = i2 - suffix.length();
            m27461b(str, suffix, length, i2, "suffix");
            m27460c(str, m27461b, length, i3, false);
            long j = 0;
            while (m27461b < length) {
                j = (j << 4) | m27458e(str, m27461b);
                m27461b++;
            }
            return j;
        }
    ...
    /* renamed from: k */
    public static final short m27452k(String str, int i, int i2, HexFormat hexFormat) {
        return (short) m27453j(str, i, i2, hexFormat, 4);
    }

    /* renamed from: l */
    public static final String m27451l(long j, HexFormat hexFormat, int i) {
        String str;
        if ((i & 3) == 0) {
    ...
    /* renamed from: m */
    public static final long m27450m(long j, long j2, int i) {
        if (j <= 0 || j2 <= 0) {
            return 0L;
        }
        long j3 = i;
    ...
    public static final int parsedByteArrayMaxSize(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        if (i > 0) {
            long j = i6 + 2 + i7;
            long m27462a2 = m27462a(j, i3, i5);
            if (i2 <= i3) {
                m27462a = m27462a(j, i2, i5);
            } else {
                m27462a = m27462a(m27462a2, i2 / i3, i4);
                int i10 = i2 % i3;
                if (i10 != 0) {
                    m27462a = m27462a + i4 + m27462a(j, i10, i5);
                }
            }
            long j2 = i;
            long m27450m = m27450m(j2, m27462a, 1);
            long j3 = j2 - ((m27462a + 1) * m27450m);
            long m27450m2 = m27450m(j3, m27462a2, i4);
            long j4 = j3 - ((m27462a2 + i4) * m27450m2);
            long m27450m3 = m27450m(j4, j, i5);
            if (j4 - ((j + i5) * m27450m3) > 0) {
                i9 = i2;
                i8 = 1;
            } else {
                i8 = 0;
            ...
            return (int) ((m27450m * i9) + (m27450m2 * i3) + m27450m3 + i8);
        }
        throw new IllegalArgumentException("Failed requirement.".toString());
    }
