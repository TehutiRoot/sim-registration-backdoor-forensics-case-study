...
public final class _ByteStringKt {
    ...
    /* renamed from: b */
    public static final int m25803b(char c) {
        if ('0' <= c && c < ':') {
            return c - '0';
        }
        if ('a' <= c && c < 'g') {
    ...
    public static final ByteString commonDecodeHex(@NotNull String str) {
        ...
        if (str.length() % 2 == 0) {
            ...
            for (int i = 0; i < length; i++) {
                int i2 = i * 2;
                bArr[i] = (byte) ((m25803b(str.charAt(i2)) << 4) + m25803b(str.charAt(i2 + 1)));
            }
    ...
    public static final String commonToString(@NotNull ByteString byteString) {
        ...
        if (byteString.getData$okio().length != 0) {
            int m25804a = m25804a(byteString.getData$okio(), 64);
            if (m25804a == -1) {
