...
public class JvmSystemFileSystem extends FileSystem {
    ...
    /* renamed from: b */
    public final void m25835b(Path path) {
        if (!exists(path)) {
            return;
        }
    ...
    /* renamed from: c */
    public final void m25834c(Path path) {
        if (exists(path)) {
            return;
        }
    ...
    public List<Path> list(@NotNull Path dir) {
        Intrinsics.checkNotNullParameter(dir, "dir");
        List<Path> m25836a = m25836a(dir, true);
        Intrinsics.checkNotNull(m25836a);
        return m25836a;
    }
    ...
    public Sink sink(@NotNull Path file, boolean z) {
        ...
        m28940q = AbstractC20711kK0.m28940q(file.toFile(), false, 1, null);
        return m28940q;
    }
