...
public final class ZipFileSystem extends FileSystem {
    ...
    public ZipFileSystem(@NotNull Path zipPath, @NotNull FileSystem fileSystem, @NotNull Map<Path, ZipEntry> entries, @Nullable String str) {
        ...
        this.f72884a = zipPath;
        this.f72885b = fileSystem;
        this.f72886c = entries;
        this.f72887d = str;
    }

    /* renamed from: b */
    private final List m25823b(Path path, boolean z) {
        ZipEntry zipEntry = (ZipEntry) this.f72886c.get(m25824a(path));
        if (zipEntry == null) {
            if (!z) {
                return null;
            }
    ...
    /* renamed from: a */
    public final Path m25824a(Path path) {
        return f72883f.resolve(path, true);
    }
    ...
    public Path canonicalize(@NotNull Path path) {
        ...
        Path m25824a = m25824a(path);
        if (this.f72886c.containsKey(m25824a)) {
            return m25824a;
        }
    ...
    public List<Path> list(@NotNull Path dir) {
        Intrinsics.checkNotNullParameter(dir, "dir");
        List<Path> m25823b = m25823b(dir, true);
        Intrinsics.checkNotNull(m25823b);
        return m25823b;
    }
    ...
    public FileMetadata metadataOrNull(@NotNull Path path) {
        ...
        FileHandle openReadOnly = this.f72885b.openReadOnly(this.f72884a);
        try {
    ...
    public Source source(@NotNull Path file) throws IOException {
        BufferedSource bufferedSource;
        Intrinsics.checkNotNullParameter(file, "file");
        ZipEntry zipEntry = (ZipEntry) this.f72886c.get(m25824a(file));
        if (zipEntry != null) {
            FileHandle openReadOnly = this.f72885b.openReadOnly(this.f72884a);
            Throwable th2 = null;
            try {
