...
public final class Log {
    ...
    /* renamed from: b */
    private final Creator f42807b;
    @SerializedName("browser")
    @Nullable

    /* renamed from: c */
    private final Browser f42808c;
    @SerializedName("pages")
    @Nullable

    /* renamed from: d */
    private final List<Page> f42809d;
    @SerializedName(RemoteConfigConstants.ResponseFieldKey.ENTRIES)
    @NotNull

    /* renamed from: e */
    private final List<Entry> f42810e;
    ...
    public Log(@NotNull String version, @NotNull Creator creator, @Nullable Browser browser, @Nullable List<Page> list, @NotNull List<Entry> entries, @Nullable String str) {
        ...
        this.f42806a = version;
        this.f42807b = creator;
        this.f42808c = browser;
        this.f42809d = list;
        this.f42810e = entries;
        this.f42811f = str;
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof Log) {
            Log log = (Log) obj;
            return Intrinsics.areEqual(this.f42806a, log.f42806a) && Intrinsics.areEqual(this.f42807b, log.f42807b) && Intrinsics.areEqual(this.f42808c, log.f42808c) && Intrinsics.areEqual(this.f42809d, log.f42809d) && Intrinsics.areEqual(this.f42810e, log.f42810e) && Intrinsics.areEqual(this.f42811f, log.f42811f);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        Browser browser = this.f42808c;
        int hashCode2 = (hashCode + (browser == null ? 0 : browser.hashCode())) * 31;
        List<Page> list = this.f42809d;
        int hashCode3 = (((hashCode2 + (list == null ? 0 : list.hashCode())) * 31) + this.f42810e.hashCode()) * 31;
    ...
    public String toString() {
        ...
        Creator creator = this.f42807b;
        Browser browser = this.f42808c;
        List<Page> list = this.f42809d;
        List<Entry> list2 = this.f42810e;
        String str2 = this.f42811f;
    ...
    */
    public Log(@org.jetbrains.annotations.NotNull java.util.List<com.chuckerteam.chucker.internal.data.entity.HttpTransaction> r10, @org.jetbrains.annotations.NotNull com.chuckerteam.chucker.internal.data.har.log.Creator r11) {
        /*
            ...
            r0 = 10
            int r0 = p000.AbstractC10176es.collectionSizeOrDefault(r10, r0)
            r5.<init>(r0)
