...
public final class Cache {
    ...
    /* renamed from: a */
    private final SecondaryRequest f42833a;
    @SerializedName("beforeRequest")
    @Nullable

    /* renamed from: b */
    private final SecondaryRequest f42834b;
    ...
    public static /* synthetic */ Cache copy$default(Cache cache, SecondaryRequest secondaryRequest, SecondaryRequest secondaryRequest2, String str, int i, Object obj) {
        if ((i & 1) != 0) {
            secondaryRequest = cache.f42833a;
        }
        if ((i & 2) != 0) {
            secondaryRequest2 = cache.f42834b;
        }
        if ((i & 4) != 0) {
            str = cache.f42835c;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof Cache) {
            ...
            return Intrinsics.areEqual(this.f42833a, cache.f42833a) && Intrinsics.areEqual(this.f42834b, cache.f42834b) && Intrinsics.areEqual(this.f42835c, cache.f42835c);
        }
        return false;
    }
    ...
    public int hashCode() {
        SecondaryRequest secondaryRequest = this.f42833a;
        int hashCode = (secondaryRequest == null ? 0 : secondaryRequest.hashCode()) * 31;
        SecondaryRequest secondaryRequest2 = this.f42834b;
    ...
    public Cache(@Nullable SecondaryRequest secondaryRequest, @Nullable SecondaryRequest secondaryRequest2, @Nullable String str) {
        this.f42833a = secondaryRequest;
        this.f42834b = secondaryRequest2;
        this.f42835c = str;
    }
