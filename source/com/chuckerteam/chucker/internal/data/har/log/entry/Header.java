...
public final class Header {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof Header) {
            ...
            return Intrinsics.areEqual(this.f42836a, header.f42836a) && Intrinsics.areEqual(this.f42837b, header.f42837b) && Intrinsics.areEqual(this.f42838c, header.f42838c);
        }
        return false;
    }
