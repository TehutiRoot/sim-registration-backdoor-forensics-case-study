...
public final class TeeSource implements Source {
    ...
    public TeeSource(@NotNull Source upstream, @NotNull Sink sideStream) {
        ...
        this.f42979a = upstream;
        this.f42980b = sideStream;
        this.f42981c = new Buffer();
    }

    /* renamed from: b */
    public final void m49894b(Buffer buffer, long j) {
        buffer.copyTo(this.f42981c, buffer.size() - j, j);
        try {
            this.f42980b.write(this.f42981c, j);
    ...
    public long read(@NotNull Buffer sink, long j) {
        ...
        long read = this.f42979a.read(sink, j);
        if (read == -1) {
            m49893d();
            return -1L;
        }
