...
@Metadata(m28851d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0005\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u000e\u0010\u0003\u001a\n \u0004*\u0004\u0018\u0001H\u0002H\u0002H\n¢\u0006\u0004\b\u0005\u0010\u0006"}, m28850d2 = {"<anonymous>", "", "T", "new", "kotlin.jvm.PlatformType", "invoke", "(Ljava/lang/Object;)V"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
...
public final class LiveDataUtilsKt$distinctUntilChanged$2 extends Lambda implements Function1<T, Unit> {
    ...
    /* renamed from: a */
    public static /* synthetic */ void m49924a(Ref.ObjectRef objectRef, Function2 function2, Object obj, MediatorLiveData mediatorLiveData) {
        invoke$lambda$0(objectRef, function2, obj, mediatorLiveData);
    }
    ...
    public final void invoke2(final T t) {
        ...
        executor.execute(new Runnable() { // from class: com.chuckerteam.chucker.internal.support.a
            ...
            public final void run() {
                LiveDataUtilsKt$distinctUntilChanged$2.m49924a(Ref.ObjectRef.this, function2, t, mediatorLiveData);
            }
        });
    }
}
