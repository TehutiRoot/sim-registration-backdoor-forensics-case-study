...
public final class TransactionDetailsSharable implements Sharable {
    ...
    public Source toSharableContent(@NotNull Context context) {
        ...
        String formatHeaders = formatUtils.formatHeaders(this.f42985a.getParsedRequestHeaders(), false);
        if (!AbstractC20204hN1.isBlank(formatHeaders)) {
            buffer.writeUtf8(formatHeaders);
            buffer.writeUtf8("\n");
        }
        String requestBody = this.f42985a.getRequestBody();
        if (requestBody != null && !AbstractC20204hN1.isBlank(requestBody)) {
            string = this.f42985a.getFormattedRequestBody();
        } else {
            if (this.f42985a.isResponseBodyEncoded()) {
        ...
        String formatHeaders2 = formatUtils.formatHeaders(this.f42985a.getParsedResponseHeaders(), false);
        if (!AbstractC20204hN1.isBlank(formatHeaders2)) {
            buffer.writeUtf8(formatHeaders2);
            buffer.writeUtf8("\n");
        }
        String responseBody = this.f42985a.getResponseBody();
        if (responseBody != null && !AbstractC20204hN1.isBlank(responseBody)) {
            string2 = this.f42985a.getFormattedResponseBody();
        } else {
            if (this.f42985a.isResponseBodyEncoded()) {
