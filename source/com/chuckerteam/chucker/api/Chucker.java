...
public final class Chucker {
    ...
    /* renamed from: a */
    public static final boolean f42750a = true;

    /* renamed from: b */
    public static Logger f42751b = new Logger() { // from class: com.chuckerteam.chucker.api.Chucker$logger$1

        /* renamed from: a */
        public final String f42752a = "Chucker";
        ...
        public void warn(@NotNull String message, @Nullable Throwable th2) {
            Intrinsics.checkNotNullParameter(message, "message");
            Log.w(this.f42752a, message, th2);
        }
    };
    ...
    public final void createShortcut$com_github_ChuckerTeam_Chucker_library(@NotNull Context context) {
        ...
        ShortcutInfo build;
        Intrinsics.checkNotNullParameter(context, "context");
        if (Build.VERSION.SDK_INT >= 25 && (m875a = AbstractC22770wI1.m875a(ContextCompat.getSystemService(context, AbstractC20878lI1.m26528a()))) != null) {
            ...
            if (!(list instanceof Collection) || !list.isEmpty()) {
                for (Object obj : list) {
                    id2 = DH1.m68669a(obj).getId();
                    if (Intrinsics.areEqual(id2, "chuckerShortcutId")) {
                        return;
                    }
                }
            }
            shortLabel = HH1.m68110a(context, "chuckerShortcutId").setShortLabel(context.getString(R.string.chucker_shortcut_label));
            ...
            try {
                m875a.addDynamicShortcuts(AbstractC10108ds.listOf(build));
