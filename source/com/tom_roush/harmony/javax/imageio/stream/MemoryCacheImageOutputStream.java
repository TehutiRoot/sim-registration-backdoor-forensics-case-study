...
public class MemoryCacheImageOutputStream extends ImageOutputStreamImpl {
    ...
    /* renamed from: f */
    public OutputStream f59703f;

    /* renamed from: g */
    public RandomAccessMemoryCache f59704g = new RandomAccessMemoryCache();

    public MemoryCacheImageOutputStream(OutputStream outputStream) {
        if (outputStream != null) {
            this.f59703f = outputStream;
            return;
        }
    ...
    public void flushBefore(long j) throws IOException {
        ...
        this.f59704g.getData(this.f59703f, (int) (flushedPosition2 - flushedPosition), flushedPosition);
        this.f59704g.freeBefore(flushedPosition2);
        this.f59703f.flush();
    }
    ...
    @Override // com.tom_roush.harmony.javax.imageio.stream.ImageInputStreamImpl, com.tom_roush.harmony.javax.imageio.stream.ImageInputStream
    public long length() {
        return this.f59704g.length();
    }

    @Override // com.tom_roush.harmony.javax.imageio.stream.ImageInputStreamImpl, com.tom_roush.harmony.javax.imageio.stream.ImageInputStream
    public int read() throws IOException {
        this.bitOffset = 0;
        int data = this.f59704g.getData(this.streamPos);
        if (data >= 0) {
            this.streamPos++;
        }
        return data;
    ...
    public void write(int i) throws IOException {
        flushBits();
        this.f59704g.putData(i, this.streamPos);
        this.streamPos++;
    }
    ...
    public int read(byte[] bArr, int i, int i2) throws IOException {
        this.bitOffset = 0;
        int data = this.f59704g.getData(bArr, i, i2, this.streamPos);
        if (data > 0) {
            this.streamPos += data;
        }
        return data;
    ...
    public void write(byte[] bArr, int i, int i2) throws IOException {
        flushBits();
        this.f59704g.putData(bArr, i, i2, this.streamPos);
        this.streamPos += i2;
    }
}
