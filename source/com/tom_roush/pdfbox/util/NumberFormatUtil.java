...
public class NumberFormatUtil {
    ...
    /* renamed from: a */
    public static final long[] f60856a;

    /* renamed from: b */
    public static final int[] f60857b;
    ...
    /* renamed from: a */
    public static int m32078a(long j, int i, boolean z, byte[] bArr, int i2) {
        long j2;
    ...
    /* renamed from: b */
    public static int m32077b(long j) {
        int i = 0;
        while (true) {
            long[] jArr = f60856a;
            if (i < jArr.length - 1) {
    ...
    public static int formatFloatFast(float f, int i, byte[] bArr) {
        ...
        if (!Float.isNaN(f) && !Float.isInfinite(f) && f <= 9.223372E18f && f > -9.223372E18f && i <= 5) {
            ...
            long j4 = j3;
            int m32078a = m32078a(j, m32077b(j), false, bArr, i2);
            if (j4 > 0 && i > 0) {
                bArr[m32078a] = 46;
                return m32078a(j4, i - 1, true, bArr, m32078a + 1);
            }
            return m32078a;
        }
        return -1;
