...
public class PDFMergerUtility {
    ...
    /* renamed from: c */
    public OutputStream f59969c;

    /* renamed from: d */
    public boolean f59970d = false;

    /* renamed from: e */
    public PDDocumentInformation f59971e = null;

    /* renamed from: f */
    public PDMetadata f59972f = null;

    /* renamed from: g */
    public DocumentMergeMode f59973g = DocumentMergeMode.PDFBOX_LEGACY_MODE;

    /* renamed from: h */
    public AcroFormMergeMode f59974h = AcroFormMergeMode.PDFBOX_LEGACY_MODE;

    /* renamed from: i */
    public int f59975i = 1;

    /* renamed from: a */
    public final List f59967a = new ArrayList();
    ...
    /* renamed from: e */
    public static Map m32723e(PDNameTreeNode pDNameTreeNode) {
        ...
        if (kids != null) {
            for (PDNameTreeNode pDNameTreeNode2 : kids) {
                linkedHashMap.putAll(m32723e(pDNameTreeNode2));
            }
        }
    ...
    /* renamed from: f */
    public static Map m32722f(PDNumberTreeNode pDNumberTreeNode) {
        LinkedHashMap linkedHashMap;
        ...
        if (kids != null) {
            for (PDNumberTreeNode pDNumberTreeNode2 : kids) {
                linkedHashMap.putAll(m32722f(pDNumberTreeNode2));
            }
        }
        return linkedHashMap;
    }
    ...
    /* renamed from: a */
    public final void m32727a(PDFCloneUtility pDFCloneUtility, PDAcroForm pDAcroForm, PDAcroForm pDAcroForm2) {
        COSArray cOSArray;
        ...
        if (fields != null && !fields.isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                if (field == null) {
                    ...
                    m32717k(pDFCloneUtility, field, next);
                }
            }
    ...
    */
    ...
    /* renamed from: b */
    public final void m32726b(PDFCloneUtility pDFCloneUtility, PDAcroForm pDAcroForm, PDAcroForm pDAcroForm2) {
        COSArray cOSArray;
        List<PDField> fields = pDAcroForm2.getFields();
        if (fields != null && !fields.isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                if (partialName.startsWith("dummyFieldName")) {
                    ...
                    if (substring.matches("\\d+")) {
                        this.f59975i = Math.max(this.f59975i, Integer.parseInt(substring) + 1);
                    }
                }
            }
            COSBase item = pDAcroForm.getCOSObject().getItem(COSName.FIELDS);
            ...
            for (PDField pDField : pDAcroForm2.getFields()) {
                ...
                if (pDAcroForm.getField(pDField.getFullyQualifiedName()) != null) {
                    COSName cOSName = COSName.f59833T;
    ...
    /* renamed from: c */
    public final void m32725c(COSDictionary cOSDictionary) {
        cOSDictionary.removeItem(COSName.f59782F);
        cOSDictionary.removeItem(COSName.f59805MK);
        cOSDictionary.removeItem(COSName.f59815P);
    ...
    /* renamed from: d */
    public final void m32724d(COSDictionary cOSDictionary, boolean z) {
        if (z) {
            cOSDictionary.removeItem(COSName.f59771DA);
        }
        cOSDictionary.removeItem(COSName.f59786FT);
        cOSDictionary.removeItem(COSName.f59833T);
        cOSDictionary.removeItem(COSName.f59843V);
    }

    /* renamed from: g */
    public final boolean m32721g(COSArray cOSArray) {
        for (int i = 0; i < cOSArray.size(); i++) {
            COSBase object = cOSArray.getObject(i);
            if (!(object instanceof COSDictionary)) {
                return false;
            }
            COSName cOSName = ((COSDictionary) object).getCOSName(COSName.f59824S);
    ...
    /* renamed from: h */
    public final boolean m32720h(PDAcroForm pDAcroForm) {
    ...
    /* renamed from: i */
    public final void m32719i(MemoryUsageSetting memoryUsageSetting) {
        PDDocument pDDocument;
        MemoryUsageSetting memoryUsageSetting2;
        PDDocument load;
        if (this.f59967a.size() > 0) {
            ArrayList<PDDocument> arrayList = new ArrayList(this.f59967a.size());
            try {
                if (memoryUsageSetting != null) {
                    memoryUsageSetting2 = memoryUsageSetting.getPartitionedCopy(this.f59967a.size() + 1);
                } else {
                    memoryUsageSetting2 = MemoryUsageSetting.setupMainMemoryOnly();
                }
                pDDocument = new PDDocument(memoryUsageSetting2);
                try {
                    for (Object obj : this.f59967a) {
                    ...
                    PDDocumentInformation pDDocumentInformation = this.f59971e;
                    if (pDDocumentInformation != null) {
                        pDDocument.setDocumentInformation(pDDocumentInformation);
                    }
                    if (this.f59972f != null) {
                        pDDocument.getDocumentCatalog().setMetadata(this.f59972f);
                    }
                    OutputStream outputStream = this.f59969c;
                    if (outputStream == null) {
                        pDDocument.save(this.f59968b);
                    } else {
    ...
    /* renamed from: j */
    public final void m32718j(PDFCloneUtility pDFCloneUtility, PDDocumentCatalog pDDocumentCatalog, PDDocumentCatalog pDDocumentCatalog2) {
        try {
            ...
            if (acroForm == null && acroForm2 != null) {
                ...
                AcroFormMergeMode acroFormMergeMode = this.f59974h;
                if (acroFormMergeMode == AcroFormMergeMode.PDFBOX_LEGACY_MODE) {
                    m32726b(pDFCloneUtility, acroForm, acroForm2);
                } else if (acroFormMergeMode == AcroFormMergeMode.JOIN_FORM_FIELDS_MODE) {
                    m32727a(pDFCloneUtility, acroForm, acroForm2);
                }
            }
        } catch (IOException e) {
            if (this.f59970d) {
    ...
    /* renamed from: k */
    public final void m32717k(PDFCloneUtility pDFCloneUtility, PDField pDField, PDField pDField2) {
    ...
    /* renamed from: l */
    public final void m32716l(PDFCloneUtility pDFCloneUtility, PDStructureTreeRoot pDStructureTreeRoot, PDStructureTreeRoot pDStructureTreeRoot2) {
        ...
        Map m32723e = m32723e(iDTree);
        Map<String, PDStructureElement> m32723e2 = m32723e(iDTree2);
        for (Map.Entry entry : m32723e.entrySet()) {
            if (m32723e2.containsKey(entry.getKey())) {
                Log.w("PdfBox-Android", "key " + ((String) entry.getKey()) + " already exists in destination IDTree");
            } else {
                m32723e2.put(entry.getKey(), new PDStructureElement((COSDictionary) pDFCloneUtility.cloneForNewDocument(((PDStructureElement) entry.getValue()).getCOSObject())));
            }
        }
        PDNameTreeNode<PDStructureElement> pDStructureElementNameTreeNode = new PDStructureElementNameTreeNode();
        pDStructureElementNameTreeNode.setNames(m32723e2);
        pDStructureTreeRoot2.setIDTree(pDStructureElementNameTreeNode);
    }

    /* renamed from: m */
    public final void m32715m(COSDictionary cOSDictionary, COSDictionary cOSDictionary2, Set set) {
    ...
    /* renamed from: n */
    public final void m32714n(PDFCloneUtility pDFCloneUtility, PDStructureTreeRoot pDStructureTreeRoot, PDStructureTreeRoot pDStructureTreeRoot2) {
        COSArray cOSArray;
        ...
        if (cOSArray3.size() == 1 && (cOSArray3.getObject(0) instanceof COSDictionary)) {
            ...
            if (COSName.DOCUMENT.equals(cOSDictionary.getCOSName(COSName.f59824S)) && (cOSArray = cOSDictionary.getCOSArray(COSName.f59797K)) != null && m32721g(cOSArray)) {
                cOSArray.addAll(cOSArray2);
                m32704x(cOSArray, cOSDictionary, COSName.PART);
                return;
            }
        }
        COSName cOSName = null;
        if (cOSArray3.size() == 0) {
            m32704x(cOSArray2, pDStructureTreeRoot2.getCOSObject(), null);
            pDStructureTreeRoot2.setK(cOSArray2);
            return;
        }
        cOSArray3.addAll(cOSArray2);
        COSDictionary cOSDictionary2 = new COSDictionary();
        if (m32721g(cOSArray3)) {
            cOSName = COSName.PART;
        }
        m32704x(cOSArray3, cOSDictionary2, cOSName);
        cOSDictionary2.setItem(COSName.f59797K, (COSBase) cOSArray3);
        cOSDictionary2.setItem(COSName.f59815P, pDStructureTreeRoot2);
        cOSDictionary2.setItem(COSName.f59824S, COSName.DOCUMENT);
        pDStructureTreeRoot2.setK(cOSDictionary2);
    }

    /* renamed from: o */
    public final void m32713o(PDDocumentCatalog pDDocumentCatalog, PDDocumentCatalog pDDocumentCatalog2) {
        String language;
    ...
    /* renamed from: p */
    public final void m32712p(PDDocumentCatalog pDDocumentCatalog, PDDocumentCatalog pDDocumentCatalog2) {
        boolean z;
    ...
    /* renamed from: q */
    public final void m32711q(PDFCloneUtility pDFCloneUtility, PDDocumentCatalog pDDocumentCatalog, PDDocumentCatalog pDDocumentCatalog2) {
    ...
    /* renamed from: r */
    public final void m32710r(PDStructureTreeRoot pDStructureTreeRoot, PDStructureTreeRoot pDStructureTreeRoot2) {
    ...
    /* renamed from: s */
    public final void m32709s(PDDocumentCatalog pDDocumentCatalog, PDDocumentCatalog pDDocumentCatalog2) {
        ...
        m32715m(viewerPreferences.getCOSObject(), viewerPreferences2.getCOSObject(), Collections.emptySet());
    ...
    /* renamed from: t */
    public final void m32708t(MemoryUsageSetting memoryUsageSetting) {
        PDDocument load;
    ...
    /* renamed from: u */
    public final void m32707u(PDFCloneUtility pDFCloneUtility, COSArray cOSArray, Map map) {
        for (int i = 0; i < cOSArray.size(); i++) {
            COSBase object = cOSArray.getObject(i);
            if (object instanceof COSArray) {
                m32707u(pDFCloneUtility, (COSArray) object, map);
            } else if (object instanceof COSDictionary) {
                m32706v(pDFCloneUtility, (COSDictionary) object, map);
            }
        }
    }

    /* renamed from: v */
    public final void m32706v(PDFCloneUtility pDFCloneUtility, COSDictionary cOSDictionary, Map map) {
        COSName cOSName = COSName.f59816PG;
        ...
        if (dictionaryObject instanceof COSDictionary) {
            ...
            if (map.containsKey(cOSDictionary3)) {
                ...
                if (item instanceof COSObject) {
                    ...
                    sb.append(", T: ");
                    sb.append(cOSDictionary3.getNameAsString(COSName.f59833T));
                } else {
                    StringBuilder sb2 = new StringBuilder();
                    ...
                    sb2.append(", T: ");
                    sb2.append(cOSDictionary3.getNameAsString(COSName.f59833T));
                }
                cOSDictionary.setItem(cOSName2, pDFCloneUtility.cloneForNewDocument(dictionaryObject));
            }
        }
        COSBase dictionaryObject2 = cOSDictionary.getDictionaryObject(COSName.f59797K);
        if (dictionaryObject2 instanceof COSArray) {
            m32707u(pDFCloneUtility, (COSArray) dictionaryObject2, map);
        } else if (dictionaryObject2 instanceof COSDictionary) {
            m32706v(pDFCloneUtility, (COSDictionary) dictionaryObject2, map);
        }
    }

    /* renamed from: w */
    public final void m32705w(PDFCloneUtility pDFCloneUtility, Map map, Map map2) {
        for (COSObjectable cOSObjectable : map.values()) {
            if (cOSObjectable != null) {
                ...
                if (cOSObject instanceof COSArray) {
                    m32707u(pDFCloneUtility, (COSArray) cOSObject, map2);
                } else {
                    m32706v(pDFCloneUtility, (COSDictionary) cOSObject, map2);
                }
            }
        }
    }
    ...
    /* renamed from: x */
    public final void m32704x(COSArray cOSArray, COSDictionary cOSDictionary, COSName cOSName) {
        for (int i = 0; i < cOSArray.size(); i++) {
            COSBase object = cOSArray.getObject(i);
            if (object instanceof COSDictionary) {
                COSDictionary cOSDictionary2 = (COSDictionary) object;
                cOSDictionary2.setItem(COSName.f59815P, (COSBase) cOSDictionary);
                if (cOSName != null) {
                    cOSDictionary2.setItem(COSName.f59824S, (COSBase) cOSName);
                }
            }
        }
    }
    ...
    /* renamed from: y */
    public final void m32703y(PDPage pDPage, int i) {
