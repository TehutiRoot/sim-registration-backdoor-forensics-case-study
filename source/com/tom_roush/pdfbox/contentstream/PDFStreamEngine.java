...
public abstract class PDFStreamEngine {
    ...
    /* renamed from: b */
    public Matrix f59712b;

    /* renamed from: c */
    public Matrix f59713c;

    /* renamed from: e */
    public PDResources f59715e;

    /* renamed from: f */
    public PDPage f59716f;

    /* renamed from: g */
    public boolean f59717g;

    /* renamed from: h */
    public Matrix f59718h;

    /* renamed from: a */
    public final Map f59711a = new HashMap(80);

    /* renamed from: d */
    public Deque f59714d = new ArrayDeque();

    /* renamed from: i */
    public int f59719i = 0;

    /* renamed from: a */
    public final void m32798a(PDRectangle pDRectangle) {
        if (pDRectangle != null) {
    ...
    public final void addOperator(OperatorProcessor operatorProcessor) {
        ...
        this.f59711a.put(operatorProcessor.getName(), operatorProcessor);
    }

    public void applyTextAdjustment(float f, float f2) throws IOException {
        this.f59712b.concatenate(Matrix.getTranslateInstance(f, f2));
    }

    /* renamed from: b */
    public final void m32797b(PDPage pDPage) {
        if (pDPage != null) {
            this.f59716f = pDPage;
            this.f59714d.clear();
            this.f59714d.push(new PDGraphicsState(pDPage.getCropBox()));
            this.f59712b = null;
            this.f59713c = null;
            this.f59715e = null;
            this.f59718h = pDPage.getMatrix();
            return;
        }
    ...
    /* renamed from: c */
    public final void m32796c(PDResources pDResources) {
        this.f59715e = pDResources;
    }

    /* renamed from: d */
    public final void m32795d(PDContentStream pDContentStream) {
        PDResources m32793f = m32793f(pDContentStream);
        Deque<PDGraphicsState> saveGraphicsStack = saveGraphicsStack();
        Matrix matrix = this.f59718h;
        PDGraphicsState graphicsState = getGraphicsState();
        graphicsState.getCurrentTransformationMatrix().concatenate(pDContentStream.getMatrix());
        this.f59718h = graphicsState.getCurrentTransformationMatrix().m74062clone();
        m32798a(pDContentStream.getBBox());
        m32794e(pDContentStream);
        this.f59718h = matrix;
    ...
    public void decreaseLevel() {
        int i = this.f59719i - 1;
        this.f59719i = i;
        if (i < 0) {
            StringBuilder sb = new StringBuilder();
            sb.append("level is ");
            sb.append(this.f59719i);
        }
    }

    /* renamed from: e */
    public final void m32794e(PDContentStream pDContentStream) {
    ...
    /* renamed from: f */
    public final PDResources m32793f(PDContentStream pDContentStream) {
        PDResources pDResources = this.f59715e;
        PDResources resources = pDContentStream.getResources();
        if (resources != null) {
            this.f59715e = resources;
        } else if (this.f59715e == null) {
            PDResources resources2 = this.f59716f.getResources();
            this.f59715e = resources2;
            if (resources2 == null) {
                this.f59715e = new PDResources();
            }
        }
        return pDResources;
    }
    ...
    public PDGraphicsState getGraphicsState() {
        return (PDGraphicsState) this.f59714d.peek();
    }
    ...
    public void processAnnotation(PDAnnotation pDAnnotation, PDAppearanceStream pDAppearanceStream) throws IOException {
        PDResources m32793f = m32793f(pDAppearanceStream);
        Deque<PDGraphicsState> saveGraphicsStack = saveGraphicsStack();
        ...
        if (rectangle != null && rectangle.getWidth() > 0.0f && rectangle.getHeight() > 0.0f && bBox != null && bBox.getWidth() > 0.0f && bBox.getHeight() > 0.0f) {
            ...
            m32798a(bBox);
            this.f59718h = concatenate.m74062clone();
            m32794e(pDAppearanceStream);
        }
        restoreGraphicsStack(saveGraphicsStack);
        m32796c(m32793f);
    }
    ...
    public void processTransparencyGroup(PDTransparencyGroup pDTransparencyGroup) throws IOException {
        if (this.f59716f != null) {
            PDResources m32793f = m32793f(pDTransparencyGroup);
            Deque<PDGraphicsState> saveGraphicsStack = saveGraphicsStack();
            Matrix matrix = this.f59718h;
            PDGraphicsState graphicsState = getGraphicsState();
            this.f59718h = graphicsState.getCurrentTransformationMatrix().m74062clone();
            ...
            m32798a(pDTransparencyGroup.getBBox());
            m32794e(pDTransparencyGroup);
            this.f59718h = matrix;
            restoreGraphicsStack(saveGraphicsStack);
            m32796c(m32793f);
            return;
    ...
    public void processType3Stream(PDType3CharProc pDType3CharProc, Matrix matrix) throws IOException {
        if (this.f59716f != null) {
            PDResources m32793f = m32793f(pDType3CharProc);
            Deque<PDGraphicsState> saveGraphicsStack = saveGraphicsStack();
            ...
            Matrix matrix2 = this.f59712b;
            this.f59712b = new Matrix();
            Matrix matrix3 = this.f59713c;
            this.f59713c = new Matrix();
            m32794e(pDType3CharProc);
            this.f59712b = matrix2;
            this.f59713c = matrix3;
            restoreGraphicsStack(saveGraphicsStack);
            m32796c(m32793f);
            return;
        }
    ...
    public void registerOperatorProcessor(String str, OperatorProcessor operatorProcessor) {
        operatorProcessor.setContext(this);
        this.f59711a.put(str, operatorProcessor);
    }
    ...
    public final Deque<PDGraphicsState> saveGraphicsStack() {
        Deque<PDGraphicsState> deque = this.f59714d;
        ArrayDeque arrayDeque = new ArrayDeque();
        this.f59714d = arrayDeque;
        arrayDeque.add(deque.peek().m74060clone());
        return deque;
    }

    public void saveGraphicsState() {
        Deque deque = this.f59714d;
        deque.push(((PDGraphicsState) deque.peek()).m74060clone());
    }
    ...
    public void showText(byte[] bArr) throws IOException {
        ...
        while (byteArrayInputStream.available() > 0) {
            ...
            Matrix multiply = matrix.multiply(this.f59712b).multiply(graphicsState.getCurrentTransformationMatrix());
            if (font.isVertical()) {
            ...
            this.f59712b.concatenate(Matrix.getTranslateInstance(f3, f2));
        }
    }
    ...
    public final void processTilingPattern(PDTilingPattern pDTilingPattern, PDColor pDColor, PDColorSpace pDColorSpace, Matrix matrix) throws IOException {
        PDResources m32793f = m32793f(pDTilingPattern);
        Matrix matrix2 = this.f59718h;
        this.f59718h = Matrix.concatenate(matrix2, matrix);
        Deque<PDGraphicsState> saveGraphicsStack = saveGraphicsStack();
        RectF rectF = new RectF();
        pDTilingPattern.getBBox().transform(matrix).computeBounds(rectF, true);
        this.f59714d.push(new PDGraphicsState(new PDRectangle(rectF.left, rectF.top, rectF.width(), rectF.height())));
        PDGraphicsState graphicsState = getGraphicsState();
        ...
        m32798a(pDTilingPattern.getBBox());
        Matrix matrix3 = this.f59712b;
        Matrix matrix4 = this.f59713c;
        m32794e(pDTilingPattern);
        this.f59712b = matrix3;
        this.f59713c = matrix4;
        this.f59718h = matrix2;
        restoreGraphicsStack(saveGraphicsStack);
        m32796c(m32793f);
    }
    ...
    public void processOperator(Operator operator, List<COSBase> list) throws IOException {
        OperatorProcessor operatorProcessor = (OperatorProcessor) this.f59711a.get(operator.getName());
