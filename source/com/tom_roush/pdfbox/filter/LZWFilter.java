...
public class LZWFilter extends Filter {
    ...
    /* renamed from: a */
    public final int m32778a(int i, int i2) {
        if (i >= 2048 - i2) {
            return 12;
        }
        if (i >= 1024 - i2) {
    ...
    /* renamed from: b */
    public final void m32777b(List list, long j, MemoryCacheImageInputStream memoryCacheImageInputStream) {
        if (j >= 0) {
            if (j < list.size()) {
                return;
            }
    ...
    /* renamed from: d */
    public final void m32775d(InputStream inputStream, OutputStream outputStream, int i) {
                ...
                try {
                    ...
                    if (readBits == 257) {
                        ...
                        if (readBits < arrayList.size()) {
                            ...
                            if (j != -1) {
                                m32777b(arrayList, j, memoryCacheImageInputStream);
    ...
    public DecodeResult decode(InputStream inputStream, OutputStream outputStream, COSDictionary cOSDictionary, int i) throws IOException {
        ...
        m32775d(inputStream, Predictor.m32769e(outputStream, decodeParams), i2);
        return new DecodeResult(cOSDictionary);
    }

    /* renamed from: e */
    public final int m32774e(List list, byte[] bArr) {
        int i = 0;
        int i2 = -1;
    ...
    public void encode(InputStream inputStream, OutputStream outputStream, COSDictionary cOSDictionary) throws IOException {
        ...
        while (true) {
            ...
            if (bArr == null) {
                ...
                int m32774e = m32774e(m32776c, bArr);
                if (m32774e == -1) {
                    int m32778a = m32778a(m32776c.size() - 1, 1);
                    memoryCacheImageOutputStream.writeBits(i, m32778a);
                    m32776c.add(bArr);
                    if (m32776c.size() == 4096) {
                        memoryCacheImageOutputStream.writeBits(256L, m32778a);
                        m32776c = m32776c();
                    }
                    bArr = new byte[]{b};
                } else {
        ...
        if (i != -1) {
            memoryCacheImageOutputStream.writeBits(i, m32778a(m32776c.size() - 1, 1));
        }
        memoryCacheImageOutputStream.writeBits(257L, m32778a(m32776c.size(), 1));
