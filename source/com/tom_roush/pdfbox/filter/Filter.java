...
public abstract class Filter {
    ...
    public COSDictionary getDecodeParams(COSDictionary cOSDictionary, int i) {
        COSBase dictionaryObject = cOSDictionary.getDictionaryObject(COSName.f59782F, COSName.FILTER);
        COSBase dictionaryObject2 = cOSDictionary.getDictionaryObject(COSName.f59775DP, COSName.DECODE_PARMS);
        ...
        if (z && (dictionaryObject2 instanceof COSArray)) {
            ...
            sb.append(dictionaryObject2.getClass().getName());
        }
