...
public class PDActionLaunch extends PDAction {
    ...
    /* loaded from: classes5.dex */
    public static /* synthetic */ class C9951a {
        ...
        static {
            ...
            try {
                f60569a[OpenMode.SAME_WINDOW.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f60569a[OpenMode.NEW_WINDOW.ordinal()] = 3;
    ...
    public String getD() {
        return this.action.getString(COSName.f59770D);
    }

    public String getF() {
        return this.action.getString(COSName.f59782F);
    }
    ...
    public String getO() {
        return this.action.getString(COSName.f59809O);
    }
    ...
    public String getP() {
        return this.action.getString(COSName.f59815P);
    }
    ...
    public void setD(String str) {
        this.action.setString(COSName.f59770D, str);
    }

    public void setF(String str) {
        this.action.setString(COSName.f59782F, str);
    }
    ...
    public void setO(String str) {
        this.action.setString(COSName.f59809O, str);
    }
    ...
    public void setP(String str) {
        this.action.setString(COSName.f59815P, str);
    }
    ...
    public void setOpenInNewWindow(OpenMode openMode) {
        ...
        int i = C9951a.f60569a[openMode.ordinal()];
        if (i == 1) {
            getCOSObject().removeItem(COSName.NEW_WINDOW);
        } else if (i == 2) {
