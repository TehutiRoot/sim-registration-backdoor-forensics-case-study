...
public class PDActionRemoteGoTo extends PDAction {
    ...
    /* loaded from: classes5.dex */
    public static /* synthetic */ class C9952a {
        ...
        static {
            ...
            try {
                f60570a[OpenMode.SAME_WINDOW.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f60570a[OpenMode.NEW_WINDOW.ordinal()] = 3;
    ...
    public COSBase getD() {
        return this.action.getDictionaryObject(COSName.f59770D);
    }

    public PDFileSpecification getFile() throws IOException {
        return PDFileSpecification.createFS(this.action.getDictionaryObject(COSName.f59782F));
    }
    ...
    public void setD(COSBase cOSBase) {
        this.action.setItem(COSName.f59770D, cOSBase);
    }

    public void setFile(PDFileSpecification pDFileSpecification) {
        this.action.setItem(COSName.f59782F, pDFileSpecification);
    }
    ...
    public void setOpenInNewWindow(OpenMode openMode) {
        ...
        int i = C9952a.f60570a[openMode.ordinal()];
        if (i == 1) {
            getCOSObject().removeItem(COSName.NEW_WINDOW);
        } else if (i == 2) {
