    ...
    public void generateNormalAppearance() {
        ...
        try {
            try {
                ...
                pDAppearanceContentStream.setBorderLine(m32331w, pDAnnotationSquareCircle.getBorderStyle(), pDAnnotationSquareCircle.getBorder());
                ...
                if (borderEffect != null && borderEffect.getStyle().equals("C")) {
                    C12399nq c12399nq = new C12399nq(pDAppearanceContentStream, borderEffect.getIntensity(), m32331w, m32341s());
                    c12399nq.m26022m(pDAnnotationSquareCircle.getRectDifference());
                    ...
                    PDRectangle m32340t = m32340t(pDAnnotationSquareCircle, m32331w);
                    pDAppearanceContentStream.addRect(m32340t.getLowerLeftX(), m32340t.getLowerLeftY(), m32340t.getWidth(), m32340t.getHeight());
                }
                pDAppearanceContentStream.drawShape(m32331w, strokingColorOnDemand, nonStrokingColorOnDemand);
            } catch (IOException e) {
                e.getMessage();
            }
