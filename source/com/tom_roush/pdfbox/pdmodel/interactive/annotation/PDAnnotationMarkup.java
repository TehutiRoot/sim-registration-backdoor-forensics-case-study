...
public class PDAnnotationMarkup extends PDAnnotation {
    ...
    /* renamed from: b */
    public PDAppearanceHandler f60581b;
    ...
    public float[] getCallout() {
        COSBase dictionaryObject = getCOSObject().getDictionaryObject(COSName.f59766CL);
    ...
    public float getConstantOpacity() {
        return getCOSObject().getFloat(COSName.f59762CA, 1.0f);
    }
    ...
    public String getDefaultAppearance() {
        return getCOSObject().getString(COSName.f59771DA);
    }

    public String getDefaultStyleString() {
        return getCOSObject().getString(COSName.f59777DS);
    }

    public String getEndPointEndingStyle() {
        COSBase dictionaryObject = getCOSObject().getDictionaryObject(COSName.f59800LE);
        if (dictionaryObject instanceof COSArray) {
    ...
    public String getIntent() {
        return getCOSObject().getNameAsString(COSName.f59794IT);
    }
    ...
    public String getLineEndingStyle() {
        return getCOSObject().getNameAsString(COSName.f59800LE, "None");
    }
    ...
    public int getQ() {
        return getCOSObject().getInt(COSName.f59818Q, 0);
    }

    public PDRectangle getRectDifference() {
        COSBase dictionaryObject = getCOSObject().getDictionaryObject(COSName.f59821RD);
        if (dictionaryObject instanceof COSArray) {
    ...
    public String getReplyType() {
        return getCOSObject().getNameAsString(StandardStructureTypes.f60293RT, "R");
    }

    public String getRichContents() {
        COSBase dictionaryObject = getCOSObject().getDictionaryObject(COSName.f59820RC);
    ...
    public String getTitlePopup() {
        return getCOSObject().getString(COSName.f59833T);
    }
    ...
    public final void setCallout(float[] fArr) {
        ...
        getCOSObject().setItem(COSName.f59766CL, (COSBase) cOSArray);
    }

    public void setConstantOpacity(float f) {
        getCOSObject().setFloat(COSName.f59762CA, f);
    }
    ...
    public void setCustomAppearanceHandler(PDAppearanceHandler pDAppearanceHandler) {
        this.f60581b = pDAppearanceHandler;
    }
    ...
    public void setDefaultStyleString(String str) {
        getCOSObject().setString(COSName.f59777DS, str);
    }
    ...
    public void setIntent(String str) {
        getCOSObject().setName(COSName.f59794IT, str);
    }
    ...
    public final void setLineEndingStyle(String str) {
        getCOSObject().setName(COSName.f59800LE, str);
    }
    ...
    public void setReplyType(String str) {
        getCOSObject().setName(StandardStructureTypes.f60293RT, str);
    }

    public void setRichContents(String str) {
        getCOSObject().setItem(COSName.f59820RC, (COSBase) new COSString(str));
    }
    ...
    public void setTitlePopup(String str) {
        getCOSObject().setString(COSName.f59833T, str);
    }
    ...
    public void constructAppearances(PDDocument pDDocument) {
        ...
        PDAppearanceHandler pDAppearanceHandler = this.f60581b;
