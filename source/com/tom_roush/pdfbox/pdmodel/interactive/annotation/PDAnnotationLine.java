...
public class PDAnnotationLine extends PDAnnotationMarkup {
    ...
    /* renamed from: c */
    public PDAppearanceHandler f60579c;
    ...
    public float getCaptionHorizontalOffset() {
        COSArray cOSArray = (COSArray) getCOSObject().getDictionaryObject(COSName.f59767CO);
        if (cOSArray != null) {
    ...
    public String getCaptionPositioning() {
        return getCOSObject().getNameAsString(COSName.f59768CP);
    }
    ...
    public float getLeaderLineLength() {
        return getCOSObject().getFloat(COSName.f59802LL, 0.0f);
    }
    ...
    public float[] getLine() {
        return ((COSArray) getCOSObject().getDictionaryObject(COSName.f59798L)).toFloatArray();
    }
    ...
    public void setCaptionHorizontalOffset(float f) {
        ...
        COSName cOSName = COSName.f59767CO;
    ...
    public void setCaptionPositioning(String str) {
        getCOSObject().setName(COSName.f59768CP, str);
    }
    ...
    public void setCustomAppearanceHandler(PDAppearanceHandler pDAppearanceHandler) {
        this.f60579c = pDAppearanceHandler;
    }
    ...
    public void setLeaderLineLength(float f) {
        getCOSObject().setFloat(COSName.f59802LL, f);
    }
    ...
    public void setLine(float[] fArr) {
        ...
        getCOSObject().setItem(COSName.f59798L, (COSBase) cOSArray);
    }
    ...
    public void constructAppearances(PDDocument pDDocument) {
        PDAppearanceHandler pDAppearanceHandler = this.f60579c;
