...
public class PDNumberFormatDictionary implements COSObjectable {
    ...
    /* renamed from: a */
    public COSDictionary f60733a;

    public PDNumberFormatDictionary() {
        COSDictionary cOSDictionary = new COSDictionary();
        this.f60733a = cOSDictionary;
    ...
    public String getThousandsSeparator() {
        return getCOSObject().getString(StandardStructureTypes.f60293RT, ",");
    }
    ...
    public void setThousandsSeparator(String str) {
        getCOSObject().setString(StandardStructureTypes.f60293RT, str);
    }
