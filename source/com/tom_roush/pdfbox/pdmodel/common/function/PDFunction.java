...
public abstract class PDFunction implements COSObjectable {
    ...
    /* renamed from: a */
    public PDStream f60185a;

    /* renamed from: b */
    public COSDictionary f60186b;

    /* renamed from: c */
    public COSArray f60187c = null;

    /* renamed from: d */
    public COSArray f60188d = null;

    /* renamed from: e */
    public int f60189e = -1;

    /* renamed from: f */
    public int f60190f = -1;
    ...
    /* renamed from: a */
    public final COSArray m32551a() {
        if (this.f60187c == null) {
            this.f60187c = (COSArray) getCOSObject().getDictionaryObject(COSName.DOMAIN);
        }
        return this.f60187c;
    }
    ...
    public int getNumberOfOutputParameters() {
        if (this.f60190f == -1) {
            this.f60190f = getRangeValues().size() / 2;
        }
        return this.f60190f;
    }
    ...
    public COSArray getRangeValues() {
        if (this.f60188d == null) {
            this.f60188d = (COSArray) getCOSObject().getDictionaryObject(COSName.RANGE);
        }
        return this.f60188d;
    }
    ...
    public COSDictionary getCOSObject() {
        PDStream pDStream = this.f60185a;
        if (pDStream != null) {
