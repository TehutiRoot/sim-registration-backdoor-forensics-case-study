...
public class COSDictionaryMap<K, V> implements Map<K, V> {
    ...
    /* renamed from: a */
    public final COSDictionary f60149a;

    /* renamed from: b */
    public final Map f60150b;

    public COSDictionaryMap(Map<K, V> map, COSDictionary cOSDictionary) {
        this.f60150b = map;
        this.f60149a = cOSDictionary;
    }
    ...
    public boolean containsKey(Object obj) {
        return this.f60150b.containsKey(obj);
    }

    @Override // java.util.Map
    public boolean containsValue(Object obj) {
        return this.f60150b.containsValue(obj);
    }

    @Override // java.util.Map
    public Set<Map.Entry<K, V>> entrySet() {
        return Collections.unmodifiableSet(this.f60150b.entrySet());
    }

    @Override // java.util.Map
    public boolean equals(Object obj) {
        if (obj instanceof COSDictionaryMap) {
            return ((COSDictionaryMap) obj).f60149a.equals(this.f60149a);
        }
        return false;
    }
    ...
    @Override // java.util.Map
    public Set<K> keySet() {
        return this.f60150b.keySet();
    }

    @Override // java.util.Map
    public V put(K k, V v) {
        this.f60149a.setItem(COSName.getPDFName((String) k), ((COSObjectable) v).getCOSObject());
        return (V) this.f60150b.put(k, v);
    }
    ...
    public V remove(Object obj) {
        this.f60149a.removeItem(COSName.getPDFName((String) obj));
        return (V) this.f60150b.remove(obj);
    }

    @Override // java.util.Map
    public int size() {
        return this.f60149a.size();
    }

    public String toString() {
        return this.f60150b.toString();
    }

    @Override // java.util.Map
    public Collection<V> values() {
        return this.f60150b.values();
    }
}
