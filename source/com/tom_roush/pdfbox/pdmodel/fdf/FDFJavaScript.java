...
public class FDFJavaScript implements COSObjectable {
    ...
    /* renamed from: a */
    public final COSDictionary f60336a;

    public FDFJavaScript() {
        this.f60336a = new COSDictionary();
    }

    public String getAfter() {
        COSBase dictionaryObject = this.f60336a.getDictionaryObject(COSName.AFTER);
    ...
    public String getBefore() {
        COSBase dictionaryObject = this.f60336a.getDictionaryObject(COSName.BEFORE);
        if (dictionaryObject instanceof COSString) {
            return ((COSString) dictionaryObject).getString();
        }
        if (dictionaryObject instanceof COSStream) {
    ...
    public Map<String, PDActionJavaScript> getDoc() {
        ...
        COSArray cOSArray = this.f60336a.getCOSArray(COSName.DOC);
        if (cOSArray == null) {
            return null;
        }
        int i = 0;
    ...
    public void setAfter(String str) {
        this.f60336a.setItem(COSName.AFTER, (COSBase) new COSString(str));
    }

    public void setBefore(String str) {
        this.f60336a.setItem(COSName.BEFORE, (COSBase) new COSString(str));
    }
    ...
    public void setDoc(Map<String, PDActionJavaScript> map) {
        ...
        this.f60336a.setItem(COSName.DOC, (COSBase) cOSArray);
    }
