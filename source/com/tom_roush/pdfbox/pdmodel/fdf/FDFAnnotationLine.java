...
public class FDFAnnotationLine extends FDFAnnotation {
    ...
    public float getCaptionHorizontalOffset() {
        COSArray cOSArray = (COSArray) this.annot.getDictionaryObject(COSName.f59767CO);
        if (cOSArray != null) {
    ...
    public String getCaptionStyle() {
        return this.annot.getString(COSName.f59768CP);
    }
    ...
    public float getLeaderLength() {
        return this.annot.getFloat(COSName.f59802LL);
    }
    ...
    public float[] getLine() {
        COSArray cOSArray = (COSArray) this.annot.getDictionaryObject(COSName.f59798L);
        if (cOSArray != null) {
    ...
    public void setCaptionStyle(String str) {
        this.annot.setString(COSName.f59768CP, str);
    }
    ...
    public void setLeaderLength(float f) {
        this.annot.setFloat(COSName.f59802LL, f);
    }
    ...
    public void setLine(float[] fArr) {
        ...
        this.annot.setItem(COSName.f59798L, (COSBase) cOSArray);
    }
