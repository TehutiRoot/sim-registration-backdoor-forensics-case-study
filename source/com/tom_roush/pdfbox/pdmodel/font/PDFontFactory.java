...
public final class PDFontFactory {
    /* renamed from: a */
    public static PDCIDFont m32430a(COSDictionary cOSDictionary, PDType0Font pDType0Font) {
    ...
    public static PDFont createFont(COSDictionary cOSDictionary, ResourceCache resourceCache) throws IOException {
        ...
        if (COSName.TYPE1.equals(cOSName4)) {
            ...
            if (!COSName.CID_FONT_TYPE0.equals(cOSName4)) {
                if (!COSName.CID_FONT_TYPE2.equals(cOSName4)) {
                    Log.w("PdfBox-Android", "Invalid font subtype '" + cOSName4 + OperatorName.SHOW_TEXT_LINE);
                    return new PDType1Font(cOSDictionary);
                }
