...
public abstract class PDCIDFont implements COSObjectable, PDFontLike, PDVectorFont {
    ...
    /* renamed from: c */
    public float f60353c;
    protected final COSDictionary dict;

    /* renamed from: g */
    public PDFontDescriptor f60357g;
    protected final PDType0Font parent;

    /* renamed from: d */
    public final Map f60354d = new HashMap();

    /* renamed from: e */
    public final Map f60355e = new HashMap();

    /* renamed from: f */
    public float[] f60356f = {880.0f, -1000.0f};
    ...
    /* renamed from: a */
    public final Vector m32459a(int i) {
        return new Vector(m32457c(i) / 2.0f, this.f60356f[0]);
    }

    /* renamed from: b */
    public final float m32458b() {
        if (this.f60352b == 0.0f) {
            COSBase dictionaryObject = this.dict.getDictionaryObject(COSName.f59779DW);
            if (dictionaryObject instanceof COSNumber) {
                this.f60352b = ((COSNumber) dictionaryObject).floatValue();
            } else {
                this.f60352b = 1000.0f;
            }
        }
        return this.f60352b;
    }
    ...
    /* renamed from: c */
    public final float m32457c(int i) {
        Float f = (Float) this.f60351a.get(Integer.valueOf(i));
        if (f == null) {
            f = Float.valueOf(m32458b());
        }
        return f.floatValue();
    }
    ...
    public final void m32455e() {
        ...
        if (dictionaryObject instanceof COSArray) {
            ...
            if ((object instanceof COSNumber) && (object2 instanceof COSNumber)) {
                this.f60356f[0] = ((COSNumber) object).floatValue();
                this.f60356f[1] = ((COSNumber) object2).floatValue();
            }
        }
        COSBase dictionaryObject2 = this.dict.getDictionaryObject(COSName.f59847W2);
            ...
            while (i < cOSArray2.size()) {
                ...
                if (object3 instanceof COSArray) {
                    ...
                    for (int i3 = 0; i3 < cOSArray3.size(); i3 += 3) {
                        ...
                        this.f60354d.put(Integer.valueOf(intValue), Float.valueOf(((COSNumber) cOSArray3.getObject(i3)).floatValue()));
                        this.f60355e.put(Integer.valueOf(intValue), new Vector(((COSNumber) cOSArray3.getObject(i3 + 1)).floatValue(), ((COSNumber) cOSArray3.getObject(i3 + 2)).floatValue()));
                    }
                } else {
                    ...
                    for (int intValue3 = cOSNumber.intValue(); intValue3 <= intValue2; intValue3++) {
                        this.f60354d.put(Integer.valueOf(intValue3), Float.valueOf(cOSNumber2.floatValue()));
                        this.f60355e.put(Integer.valueOf(intValue3), new Vector(cOSNumber3.floatValue(), cOSNumber4.floatValue()));
                    }
                    i2 = i4;
                }
                i = i2 + 1;
    ...
    /* renamed from: f */
    public final void m32454f() {
        this.f60351a = new HashMap();
        COSBase dictionaryObject = this.dict.getDictionaryObject(COSName.f59846W);
        if (dictionaryObject instanceof COSArray) {
            COSArray cOSArray = (COSArray) dictionaryObject;
                    ...
                    if (object2 instanceof COSArray) {
                        ...
                        for (int i4 = 0; i4 < size2; i4++) {
                            ...
                            if (object3 instanceof COSNumber) {
                                this.f60351a.put(Integer.valueOf(intValue + i4), Float.valueOf(((COSNumber) object3).floatValue()));
                            } else {
                        ...
                        if ((object2 instanceof COSNumber) && (object4 instanceof COSNumber)) {
                            ...
                            for (int intValue3 = cOSNumber.intValue(); intValue3 <= intValue2; intValue3++) {
                                this.f60351a.put(Integer.valueOf(intValue3), Float.valueOf(floatValue));
                            }
                        } else {
    ...
    public float getAverageFontWidth() {
        float f;
        if (this.f60353c == 0.0f) {
            Map map = this.f60351a;
            int i = 0;
            if (map != null) {
                f = 0.0f;
            ...
            float f3 = this.f60353c;
            if (f3 <= 0.0f || Float.isNaN(f3)) {
                this.f60353c = m32458b();
            }
        }
        return this.f60353c;
    }
    ...
    public PDFontDescriptor getFontDescriptor() {
        ...
        if (this.f60357g == null && (cOSDictionary = (COSDictionary) this.dict.getDictionaryObject(COSName.FONT_DESC)) != null) {
            this.f60357g = new PDFontDescriptor(cOSDictionary);
        }
        return this.f60357g;
    }
    ...
    public Vector getPositionVector(int i) {
        ...
        Vector vector = (Vector) this.f60355e.get(Integer.valueOf(codeToCID));
        if (vector == null) {
            return m32459a(codeToCID);
        }
        return vector;
    }

    public float getVerticalDisplacementVectorY(int i) {
        Float f = (Float) this.f60354d.get(Integer.valueOf(codeToCID(i)));
        if (f == null) {
            f = Float.valueOf(this.f60356f[1]);
        }
        return f.floatValue();
    }
    ...
    public float getWidth(int i) throws IOException {
        return m32457c(codeToCID(i));
    }

    @Override // com.tom_roush.pdfbox.pdmodel.font.PDFontLike
    public boolean hasExplicitWidth(int i) throws IOException {
        if (this.f60351a.get(Integer.valueOf(codeToCID(i))) != null) {
            return true;
        }
        return false;
    }
