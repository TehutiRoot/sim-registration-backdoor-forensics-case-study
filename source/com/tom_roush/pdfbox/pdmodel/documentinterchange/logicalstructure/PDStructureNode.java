...
public abstract class PDStructureNode implements COSObjectable {
    ...
    /* renamed from: a */
    public final COSDictionary f60272a;

    public PDStructureNode(String str) {
        COSDictionary cOSDictionary = new COSDictionary();
        this.f60272a = cOSDictionary;
    ...
    /* renamed from: a */
    public final COSObjectable m32527a(COSDictionary cOSDictionary) {
        String nameAsString = cOSDictionary.getNameAsString(COSName.TYPE);
        if (nameAsString != null && !PDStructureElement.TYPE.equals(nameAsString)) {
    ...
    public List<Object> getKids() {
        ...
        COSBase dictionaryObject = getCOSObject().getDictionaryObject(COSName.f59797K);
    ...
    public void setKids(List<Object> list) {
        getCOSObject().setItem(COSName.f59797K, (COSBase) COSArrayList.converterToCOSArray(list));
    }
    ...
    public void insertBefore(COSBase cOSBase, Object obj) {
        ...
        COSName cOSName = COSName.f59797K;
