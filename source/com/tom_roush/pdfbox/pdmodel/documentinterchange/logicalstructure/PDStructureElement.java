...
public class PDStructureElement extends PDStructureNode {
    ...
    /* renamed from: b */
    private PDStructureTreeRoot m32528b() {
    ...
    private Map getRoleMap() {
        PDStructureTreeRoot m32528b = m32528b();
        if (m32528b != null) {
            return m32528b.getRoleMap();
        }
        return null;
    }
    ...
    public void addAttribute(PDAttributeObject pDAttributeObject) {
        COSArray cOSArray;
        COSName cOSName = COSName.f59748A;
    ...
    public String getElementIdentifier() {
        return getCOSObject().getString(COSName.f59791ID);
    }

    public String getExpandedForm() {
        return getCOSObject().getString(COSName.f59780E);
    }
    ...
    public PDPage getPage() {
        COSBase dictionaryObject = getCOSObject().getDictionaryObject(COSName.f59816PG);
        if (dictionaryObject instanceof COSDictionary) {
    ...
    public String getStructureType() {
        return getCOSObject().getNameAsString(COSName.f59824S);
    }
    ...
    public void setElementIdentifier(String str) {
        getCOSObject().setString(COSName.f59791ID, str);
    }

    public void setExpandedForm(String str) {
        getCOSObject().setString(COSName.f59780E, str);
    }
    ...
    public final void setParent(PDStructureNode pDStructureNode) {
        getCOSObject().setItem(COSName.f59815P, pDStructureNode);
    }
