...
public abstract class PDAttributeObject extends PDDictionaryWrapper {
    ...
    /* renamed from: b */
    public PDStructureElement f60267b;
    ...
    public static PDAttributeObject create(COSDictionary cOSDictionary) {
        String nameAsString = cOSDictionary.getNameAsString(COSName.f59809O);
    ...
    /* renamed from: a */
    public final boolean m32529a(COSBase cOSBase, COSBase cOSBase2) {
        if (cOSBase == null) {
            if (cOSBase2 != null) {
                return true;
            }
    ...
    public String getOwner() {
        return getCOSObject().getNameAsString(COSName.f59809O);
    }
    ...
    public void potentiallyNotifyChanged(COSBase cOSBase, COSBase cOSBase2) {
        if (m32529a(cOSBase, cOSBase2)) {
            notifyChanged();
        }
    }

    public void setOwner(String str) {
        getCOSObject().setName(COSName.f59809O, str);
    }

    public void setStructureElement(PDStructureElement pDStructureElement) {
        this.f60267b = pDStructureElement;
    }
