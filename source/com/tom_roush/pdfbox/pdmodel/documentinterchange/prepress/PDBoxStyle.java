...
public class PDBoxStyle implements COSObjectable {
    ...
    /* renamed from: a */
    public final COSDictionary f60279a;

    public PDBoxStyle() {
        this.f60279a = new COSDictionary();
    }

    public PDColor getGuidelineColor() {
        COSDictionary cOSDictionary = this.f60279a;
        ...
        if (cOSArray == null) {
            ...
            cOSArray.add((COSBase) cOSInteger);
            cOSArray.add((COSBase) cOSInteger);
            this.f60279a.setItem(cOSName, (COSBase) cOSArray);
        }
        return new PDColor(cOSArray.toFloatArray(), PDDeviceRGB.INSTANCE);
    }

    public String getGuidelineStyle() {
        return this.f60279a.getNameAsString(COSName.f59824S, "S");
    }

    public float getGuidelineWidth() {
        return this.f60279a.getFloat(COSName.f59846W, 1.0f);
    }
    ...
    public void setGuideLineColor(PDColor pDColor) {
        ...
        this.f60279a.setItem(COSName.f59759C, (COSBase) cOSArray);
    }

    public void setGuidelineStyle(String str) {
        this.f60279a.setName(COSName.f59824S, str);
    }

    public void setGuidelineWidth(float f) {
        this.f60279a.setFloat(COSName.f59846W, f);
    }
    ...
    public void setLineDashPattern(COSArray cOSArray) {
        ...
        this.f60279a.setItem(COSName.f59770D, (COSBase) cOSArray);
    }
