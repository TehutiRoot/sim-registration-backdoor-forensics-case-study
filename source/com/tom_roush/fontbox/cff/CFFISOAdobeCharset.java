...
public final class CFFISOAdobeCharset extends CFFCharset {
    ...
    /* renamed from: g */
    public static final Object[][] f59256g;

    /* renamed from: h */
    public static final CFFISOAdobeCharset f59257h;
    ...
    static {
        ...
        f59256g = objArr;
        f59257h = new CFFISOAdobeCharset();
        int length = objArr.length;
        int i = 0;
        int i2 = 0;
        while (i < length) {
            Object[] objArr2 = objArr[i];
            f59257h.addSID(i2, ((Integer) objArr2[0]).intValue(), objArr2[1].toString());
            i++;
            i2++;
        }
    }
