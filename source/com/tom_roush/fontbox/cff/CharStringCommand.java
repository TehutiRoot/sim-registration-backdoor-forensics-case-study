...
public class CharStringCommand {
    ...
    /* renamed from: a */
    public final void m33026a(Key key) {
        this.f59308a = key;
    }
    ...
    public static class Key {
        ...
        /* renamed from: a */
        public final void m33025a(int[] iArr) {
            this.f59309a = iArr;
        }
        ...
        public boolean equals(Object obj) {
            ...
            Key key = (Key) obj;
            int[] iArr = this.f59309a;
            int i = iArr[0];
            if (i == 12) {
                int[] iArr2 = key.f59309a;
                if (iArr2[0] == 12) {
    ...
    public CharStringCommand(int i, int i2) {
        m33026a(new Key(i, i2));
    }

    public CharStringCommand(int[] iArr) {
        m33026a(new Key(iArr));
    }
}
