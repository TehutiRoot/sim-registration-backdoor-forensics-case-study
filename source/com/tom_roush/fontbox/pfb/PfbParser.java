...
public class PfbParser {
    ...
    /* renamed from: c */
    public static final int[] f59363c = {1, 2, 1};
    ...
    public PfbParser(String str) throws IOException {
        ...
        try {
            m32962a(m32961b(bufferedInputStream));
    ...
    /* renamed from: a */
    public final void m32962a(byte[] bArr) {
        ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(bArr);
        this.f59364a = new byte[bArr.length - 18];
        this.f59365b = new int[f59363c.length];
        int i = 0;
        int i2 = 0;
        while (true) {
            int[] iArr = f59363c;
                        ...
                        if (read >= 0) {
                            ...
                            if (i2 < bArr2.length) {
                                if (read <= bArr2.length - i2) {
                                    ...
                                    throw new IOException("PFB record size (" + read + ") doesn't fit in buffer, position: " + i2 + ", total length: " + this.f59364a.length);
                                }
                            } else {
    ...
    /* renamed from: b */
    public final byte[] m32961b(InputStream inputStream) {
    ...
    public InputStream getInputStream() {
        return new ByteArrayInputStream(this.f59364a);
    }
    ...
    public byte[] getSegment1() {
        return Arrays.copyOfRange(this.f59364a, 0, this.f59365b[0]);
    }

    public byte[] getSegment2() {
        byte[] bArr = this.f59364a;
        int[] iArr = this.f59365b;
        int i = iArr[0];
        return Arrays.copyOfRange(bArr, i, iArr[1] + i);
    }

    public int size() {
        return this.f59364a.length;
    }

    public PfbParser(InputStream inputStream) throws IOException {
        m32962a(m32961b(inputStream));
    }
