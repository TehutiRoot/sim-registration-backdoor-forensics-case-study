...
public class ShapeDataParser implements N02 {
    public static final ShapeDataParser INSTANCE = new ShapeDataParser();

    /* renamed from: a */
    public static final JsonReader.Options f41552a = JsonReader.Options.m50685of(OperatorName.CURVE_TO, OperatorName.CURVE_TO_REPLICATE_INITIAL_POINT, "i", "o");
    ...
    public ShapeData parse(JsonReader jsonReader, float f) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            int selectName = jsonReader.selectName(f41552a);
            if (selectName == 0) {
                z = jsonReader.nextBoolean();
            } else if (selectName == 1) {
                list = AbstractC23002xh0.m410f(jsonReader, f);
            } else if (selectName == 2) {
                list2 = AbstractC23002xh0.m410f(jsonReader, f);
            } else if (selectName != 3) {
                jsonReader.skipName();
                jsonReader.skipValue();
            } else {
                list3 = AbstractC23002xh0.m410f(jsonReader, f);
            }
        }
