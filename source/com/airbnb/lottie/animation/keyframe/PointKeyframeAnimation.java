...
public class PointKeyframeAnimation extends AbstractC18114Nh0 {

    /* renamed from: g */
    public final PointF f41194g;

    public PointKeyframeAnimation(List<Keyframe<PointF>> list) {
        super(list);
        this.f41194g = new PointF();
    }
    ...
    public PointF getValue(Keyframe<PointF> keyframe, float f, float f2, float f3) {
        ...
        if (pointF3 != null && (pointF = keyframe.endValue) != null) {
            ...
            if (lottieValueCallback == 0 || (pointF2 = (PointF) lottieValueCallback.getValueInternal(keyframe.startFrame, keyframe.endFrame.floatValue(), pointF4, pointF5, f, m50877b(), getProgress())) == null) {
                PointF pointF6 = this.f41194g;
                float f4 = pointF4.x;
