...
@DebugMetadata(m28801c = "com.airbnb.lottie.compose.LottieAnimatableImpl$animate$2", m28800f = "LottieAnimatable.kt", m28799i = {}, m28798l = {269}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
...
public final class LottieAnimatableImpl$animate$2 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(m28801c = "com.airbnb.lottie.compose.LottieAnimatableImpl$animate$2$1", m28800f = "LottieAnimatable.kt", m28799i = {}, m28798l = {277}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
    /* renamed from: com.airbnb.lottie.compose.LottieAnimatableImpl$animate$2$1 */
    /* loaded from: classes3.dex */
    public static final class C56921 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ LottieCancellationBehavior $cancellationBehavior;
        final /* synthetic */ int $iteration;
        final /* synthetic */ int $iterations;
        ...
        public C56921(LottieCancellationBehavior lottieCancellationBehavior, Job job, int i, int i2, LottieAnimatableImpl lottieAnimatableImpl, Continuation<? super C56921> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C56921(this.$cancellationBehavior, this.$parentJob, this.$iterations, this.$iteration, this.this$0, continuation);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(@org.jetbrains.annotations.NotNull java.lang.Object r4) {
            ...
            L1a:
                ...
                int[] r1 = com.airbnb.lottie.compose.LottieAnimatableImpl$animate$2.C56921.WhenMappings.$EnumSwitchMapping$0
                int r4 = r4.ordinal()
                r4 = r1[r4]
                if (r4 != r2) goto L34
            ...
            L36:
                ...
                r3.label = r2
                java.lang.Object r4 = com.airbnb.lottie.compose.LottieAnimatableImpl.m50851a(r1, r4, r3)
                if (r4 != r0) goto L41
                return r0
            L41:
                ...
                return r4
            */
            throw new UnsupportedOperationException("Method not decompiled: com.airbnb.lottie.compose.LottieAnimatableImpl$animate$2.C56921.invokeSuspend(java.lang.Object):java.lang.Object");
        }

        @Override // kotlin.jvm.functions.Function2
        @Nullable
        public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C56921) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        try {
            if (i != 0) {
                ...
                this.this$0.m50829w(this.$iterations);
                this.this$0.m50855B(this.$reverseOnRepeat);
                this.this$0.m50854C(this.$speed);
                this.this$0.m50832t(this.$clipSpec);
                this.this$0.m50831u(this.$composition);
                this.this$0.m50852E(this.$initialProgress);
                this.this$0.m50853D(this.$useCompositionFrameRate);
                ...
                if (this.$composition == null) {
                    ...
                    C56921 c56921 = new C56921(this.$cancellationBehavior, JobKt.getJob(getContext()), this.$iterations, this.$iteration, this.this$0, null);
                    this.label = 1;
                    if (BuildersKt.withContext(coroutineContext, c56921, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    LottieAnimatableImpl lottieAnimatableImpl = this.this$0;
                    m50837o = lottieAnimatableImpl.m50837o();
                    lottieAnimatableImpl.m50852E(m50837o);
                    this.this$0.m50827y(false);
                    this.this$0.m50830v(this.$iterations);
                    return Unit.INSTANCE;
                }
            }
