...
public final class AnimateLottieCompositionAsStateKt {
        ...
        if (i4 > 0) {
            if (!Float.isInfinite(f2) && !Float.isNaN(f2)) {
                ...
                if (rememberedValue == Composer.Companion.getEmpty()) {
                    rememberedValue = AbstractC19508dK1.m31891g(Boolean.valueOf(z6), null, 2, null);
    ...
    /* renamed from: b */
    public static final void m50857b(MutableState mutableState, boolean z) {
