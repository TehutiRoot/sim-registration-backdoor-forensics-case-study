...
public final class RememberLottieCompositionKt {
    ...
    /* loaded from: classes3.dex */
    public static final class C5703b implements LottieListener {

        /* renamed from: a */
        public final /* synthetic */ CancellableContinuation f41276a;

        public C5703b(CancellableContinuation cancellableContinuation) {
            this.f41276a = cancellableContinuation;
        }

        @Override // com.airbnb.lottie.LottieListener
        /* renamed from: a */
        public final void onResult(Throwable e) {
            if (!this.f41276a.isCompleted()) {
                CancellableContinuation cancellableContinuation = this.f41276a;
                Result.Companion companion = Result.Companion;
                Intrinsics.checkNotNullExpressionValue(e, "e");
                cancellableContinuation.resumeWith(Result.m74087constructorimpl(ResultKt.createFailure(e)));
            }
        }
    }

    /* renamed from: a */
    public static final Object m50815a(LottieTask lottieTask, Continuation continuation) {
        CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(IntrinsicsKt__IntrinsicsJvmKt.intercepted(continuation), 1);
        cancellableContinuationImpl.initCancellability();
        lottieTask.addListener(new C5702a(cancellableContinuationImpl)).addFailureListener(new C5703b(cancellableContinuationImpl));
    ...
    /* renamed from: b */
    public static final String m50814b(String str) {
        if (!AbstractC20204hN1.isBlank(str) && !AbstractC20204hN1.startsWith$default(str, ".", false, 2, null)) {
    ...
    /* renamed from: c */
    public static final String m50813c(String str) {
    ...
    /* renamed from: d */
    public static final Object m50812d(Context context, LottieComposition lottieComposition, String str, String str2, Continuation continuation) {
    ...
    /* renamed from: e */
    public static final Object m50811e(Context context, LottieComposition lottieComposition, String str, Continuation continuation) {
    ...
    */
    public static final java.lang.Object m50810f(android.content.Context r6, com.airbnb.lottie.compose.LottieCompositionSpec r7, java.lang.String r8, java.lang.String r9, java.lang.String r10, java.lang.String r11, kotlin.coroutines.Continuation r12) {
        /*
            Method dump skipped, instructions count: 204
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.airbnb.lottie.compose.RememberLottieCompositionKt.m50810f(android.content.Context, com.airbnb.lottie.compose.LottieCompositionSpec, java.lang.String, java.lang.String, java.lang.String, java.lang.String, kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* renamed from: g */
    public static final LottieTask m50809g(Context context, LottieCompositionSpec lottieCompositionSpec, String str, boolean z) {
        if (lottieCompositionSpec instanceof LottieCompositionSpec.RawRes) {
            if (Intrinsics.areEqual(str, "__LottieInternalDefaultCacheKey__")) {
                return LottieCompositionFactory.fromRawRes(context, ((LottieCompositionSpec.RawRes) lottieCompositionSpec).m74020unboximpl());
            }
            return LottieCompositionFactory.fromRawRes(context, ((LottieCompositionSpec.RawRes) lottieCompositionSpec).m74020unboximpl(), str);
        } else if (lottieCompositionSpec instanceof LottieCompositionSpec.Url) {
            if (Intrinsics.areEqual(str, "__LottieInternalDefaultCacheKey__")) {
                return LottieCompositionFactory.fromUrl(context, ((LottieCompositionSpec.Url) lottieCompositionSpec).m74027unboximpl());
            }
            return LottieCompositionFactory.fromUrl(context, ((LottieCompositionSpec.Url) lottieCompositionSpec).m74027unboximpl(), str);
            ...
            FileInputStream fileInputStream = new FileInputStream(file.m74006unboximpl());
            if (AbstractC20204hN1.endsWith$default(file.m74006unboximpl(), "zip", false, 2, null)) {
                ZipInputStream zipInputStream = new ZipInputStream(fileInputStream);
                if (Intrinsics.areEqual(str, "__LottieInternalDefaultCacheKey__")) {
                    str = file.m74006unboximpl();
                }
            ...
            if (Intrinsics.areEqual(str, "__LottieInternalDefaultCacheKey__")) {
                return LottieCompositionFactory.fromAsset(context, ((LottieCompositionSpec.Asset) lottieCompositionSpec).m73992unboximpl());
            }
            return LottieCompositionFactory.fromAsset(context, ((LottieCompositionSpec.Asset) lottieCompositionSpec).m73992unboximpl(), str);
        } else if (lottieCompositionSpec instanceof LottieCompositionSpec.JsonString) {
            if (Intrinsics.areEqual(str, "__LottieInternalDefaultCacheKey__")) {
                str = String.valueOf(((LottieCompositionSpec.JsonString) lottieCompositionSpec).m74013unboximpl().hashCode());
            }
            return LottieCompositionFactory.fromJsonString(((LottieCompositionSpec.JsonString) lottieCompositionSpec).m74013unboximpl(), str);
            ...
            InputStream openInputStream = context.getContentResolver().openInputStream(contentProvider.m73999unboximpl());
            if (Intrinsics.areEqual(str, "__LottieInternalDefaultCacheKey__")) {
                str = contentProvider.m73999unboximpl().toString();
            }
    ...
    /* renamed from: h */
    public static final void m50808h(LottieImageAsset lottieImageAsset) {
        if (lottieImageAsset.getBitmap() != null) {
            return;
        }
        String filename = lottieImageAsset.getFileName();
        Intrinsics.checkNotNullExpressionValue(filename, "filename");
        if (AbstractC20204hN1.startsWith$default(filename, "data:", false, 2, null) && StringsKt__StringsKt.indexOf$default((CharSequence) filename, "base64,", 0, false, 6, (Object) null) > 0) {
            try {
    ...
    /* renamed from: i */
    public static final void m50807i(Context context, LottieImageAsset lottieImageAsset, String str) {
    ...
    /* renamed from: j */
    public static final void m50806j(Context context, Font font, String str, String str2) {
        ...
        try {
            ...
            try {
                ...
                font.setTypeface(m50804l(typefaceWithDefaultStyle, style));
            } catch (Exception e) {
    ...
    /* renamed from: k */
    public static final LottieCompositionResultImpl m50805k(MutableState mutableState) {
        return (LottieCompositionResultImpl) mutableState.getValue();
    }

    /* renamed from: l */
    public static final Typeface m50804l(Typeface typeface, String str) {
        int i = 0;
    ...
    public static final LottieCompositionResult rememberLottieComposition(@NotNull LottieCompositionSpec spec, @Nullable String str, @Nullable String str2, @Nullable String str3, @Nullable String str4, @Nullable Function3<? super Integer, ? super Throwable, ? super Continuation<? super Boolean>, ? extends Object> function3, @Nullable Composer composer, int i, int i2) {
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = AbstractC19508dK1.m31891g(new LottieCompositionResultImpl(), null, 2, null);
        ...
        if (changed2 || rememberedValue2 == Composer.Companion.getEmpty()) {
            composer.updateRememberedValue(m50809g(context, spec, str8, true));
        }
        composer.endReplaceableGroup();
        ...
        LottieCompositionResultImpl m50805k = m50805k(mutableState);
        composer.endReplaceableGroup();
        return m50805k;
    }
}
