...
public final class LottieAnimationKt$LottieAnimation$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public LottieAnimationKt$LottieAnimation$1(LottieComposition lottieComposition, Function0<Float> function0, Modifier modifier, boolean z, boolean z2, boolean z3, RenderMode renderMode, boolean z4, LottieDynamicProperties lottieDynamicProperties, Alignment alignment, ContentScale contentScale, boolean z5, Map<String, ? extends Typeface> map, int i, int i2, int i3) {
        super(2);
