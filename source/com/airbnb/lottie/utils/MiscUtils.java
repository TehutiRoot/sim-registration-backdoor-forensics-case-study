...
public class MiscUtils {
    ...
    /* renamed from: a */
    public static final PointF f41612a = new PointF();

    /* renamed from: a */
    public static int m50648a(int i, int i2) {
        boolean z;
        int i3 = i / i2;
        if ((i ^ i2) >= 0) {
            z = true;
    ...
    /* renamed from: b */
    public static int m50647b(float f, float f2) {
        return m50646c((int) f, (int) f2);
    }

    /* renamed from: c */
    public static int m50646c(int i, int i2) {
        return i - (i2 * m50648a(i, i2));
    }
    ...
    public static double lerp(double d, double d2, @FloatRange(from = 0.0d, m64743to = 1.0d) double d3) {
        return d + (d3 * (d2 - d));
    }
    ...
    public static float lerp(float f, float f2, @FloatRange(from = 0.0d, m64743to = 1.0d) float f3) {
        return f + (f3 * (f2 - f));
    }
    ...
    public static int lerp(int i, int i2, @FloatRange(from = 0.0d, m64743to = 1.0d) float f) {
        return (int) (i + (f * (i2 - i)));
    }
}
