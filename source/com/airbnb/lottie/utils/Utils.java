...
public final class Utils {
    ...
    /* renamed from: a */
    public static final ThreadLocal f41613a = new C5722a();

    /* renamed from: b */
    public static final ThreadLocal f41614b = new C5723b();

    /* renamed from: c */
    public static final ThreadLocal f41615c = new C5724c();

    /* renamed from: d */
    public static final ThreadLocal f41616d = new C5725d();

    /* renamed from: e */
    public static final float f41617e = (float) (Math.sqrt(2.0d) / 2.0d);

    /* renamed from: com.airbnb.lottie.utils.Utils$a */
    /* loaded from: classes3.dex */
    public class C5722a extends ThreadLocal {
    ...
    /* renamed from: com.airbnb.lottie.utils.Utils$b */
    /* loaded from: classes3.dex */
    public class C5723b extends ThreadLocal {
        @Override // java.lang.ThreadLocal
        /* renamed from: a */
    ...
    /* renamed from: com.airbnb.lottie.utils.Utils$c */
    /* loaded from: classes3.dex */
    public class C5724c extends ThreadLocal {
        @Override // java.lang.ThreadLocal
        /* renamed from: a */
        public Path initialValue() {
            return new Path();
    ...
    /* renamed from: com.airbnb.lottie.utils.Utils$d */
    /* loaded from: classes3.dex */
    public class C5725d extends ThreadLocal {
        @Override // java.lang.ThreadLocal
        /* renamed from: a */
    ...
    public static void saveLayerCompat(Canvas canvas, RectF rectF, Paint paint, int i) {
        C5655L.beginSection("Utils#saveLayer");
        if (Build.VERSION.SDK_INT < 23) {
            canvas.saveLayer(rectF, paint, i);
        } else {
            canvas.saveLayer(rectF, paint);
        }
        C5655L.endSection("Utils#saveLayer");
    }

    public static void applyTrimPathIfNeeded(Path path, float f, float f2, float f3) {
        C5655L.beginSection("applyTrimPathIfNeeded");
        PathMeasure pathMeasure = (PathMeasure) f41613a.get();
        Path path2 = (Path) f41614b.get();
        Path path3 = (Path) f41615c.get();
        pathMeasure.setPath(path, false);
        float length = pathMeasure.getLength();
        if (f == 1.0f && f2 == 0.0f) {
            C5655L.endSection("applyTrimPathIfNeeded");
            ...
            if (min >= length && max >= length) {
                min = MiscUtils.m50647b(min, length);
                max = MiscUtils.m50647b(max, length);
            }
            if (min < 0.0f) {
                min = MiscUtils.m50647b(min, length);
            }
