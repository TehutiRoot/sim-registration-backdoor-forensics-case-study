...
public final class ViewScrollChangeEvent {
    ...
    public static /* synthetic */ ViewScrollChangeEvent copy$default(ViewScrollChangeEvent viewScrollChangeEvent, View view, int i, int i2, int i3, int i4, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            view = viewScrollChangeEvent.f58278a;
        }
        if ((i5 & 2) != 0) {
            i = viewScrollChangeEvent.f58279b;
        }
        int i6 = i;
        if ((i5 & 4) != 0) {
            i2 = viewScrollChangeEvent.f58280c;
        }
        int i7 = i2;
        if ((i5 & 8) != 0) {
            i3 = viewScrollChangeEvent.f58281d;
        }
        int i8 = i3;
        if ((i5 & 16) != 0) {
            i4 = viewScrollChangeEvent.f58282e;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        if (this != obj) {
            if (obj instanceof ViewScrollChangeEvent) {
                ...
                return Intrinsics.areEqual(this.f58278a, viewScrollChangeEvent.f58278a) && this.f58279b == viewScrollChangeEvent.f58279b && this.f58280c == viewScrollChangeEvent.f58280c && this.f58281d == viewScrollChangeEvent.f58281d && this.f58282e == viewScrollChangeEvent.f58282e;
            }
            return false;
        }
        return true;
    ...
    public int hashCode() {
        View view = this.f58278a;
        return ((((((((view != null ? view.hashCode() : 0) * 31) + this.f58279b) * 31) + this.f58280c) * 31) + this.f58281d) * 31) + this.f58282e;
    }

    @NotNull
    public String toString() {
        return "ViewScrollChangeEvent(view=" + this.f58278a + ", scrollX=" + this.f58279b + ", scrollY=" + this.f58280c + ", oldScrollX=" + this.f58281d + ", oldScrollY=" + this.f58282e + ")";
    }
}
