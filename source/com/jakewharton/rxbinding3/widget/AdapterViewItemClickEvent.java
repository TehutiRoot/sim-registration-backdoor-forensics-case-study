...
public final class AdapterViewItemClickEvent {
    ...
    public static /* synthetic */ AdapterViewItemClickEvent copy$default(AdapterViewItemClickEvent adapterViewItemClickEvent, AdapterView adapterView, View view, int i, long j, int i2, Object obj) {
        ...
        if ((i2 & 1) != 0) {
            adapterView2 = adapterViewItemClickEvent.f58293a;
        }
        if ((i2 & 2) != 0) {
            view = adapterViewItemClickEvent.f58294b;
        }
        View view2 = view;
        if ((i2 & 4) != 0) {
            i = adapterViewItemClickEvent.f58295c;
        }
        int i3 = i;
        if ((i2 & 8) != 0) {
            j = adapterViewItemClickEvent.f58296d;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        if (this != obj) {
            if (obj instanceof AdapterViewItemClickEvent) {
                ...
                return Intrinsics.areEqual(this.f58293a, adapterViewItemClickEvent.f58293a) && Intrinsics.areEqual(this.f58294b, adapterViewItemClickEvent.f58294b) && this.f58295c == adapterViewItemClickEvent.f58295c && this.f58296d == adapterViewItemClickEvent.f58296d;
            }
            return false;
        }
        return true;
    ...
    public int hashCode() {
        AdapterView adapterView = this.f58293a;
        int hashCode = (adapterView != null ? adapterView.hashCode() : 0) * 31;
        View view = this.f58294b;
        int hashCode2 = view != null ? view.hashCode() : 0;
        long j = this.f58296d;
        return ((((hashCode + hashCode2) * 31) + this.f58295c) * 31) + ((int) (j ^ (j >>> 32)));
    }

    @NotNull
    public String toString() {
        return "AdapterViewItemClickEvent(view=" + this.f58293a + ", clickedView=" + this.f58294b + ", position=" + this.f58295c + ", id=" + this.f58296d + ")";
    }
}
