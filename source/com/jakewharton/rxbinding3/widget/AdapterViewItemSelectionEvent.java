...
public final class AdapterViewItemSelectionEvent extends AdapterViewSelectionEvent {
    ...
    public static /* synthetic */ AdapterViewItemSelectionEvent copy$default(AdapterViewItemSelectionEvent adapterViewItemSelectionEvent, AdapterView adapterView, View view, int i, long j, int i2, Object obj) {
        ...
        if ((i2 & 2) != 0) {
            view = adapterViewItemSelectionEvent.f58302b;
        }
        View view2 = view;
        if ((i2 & 4) != 0) {
            i = adapterViewItemSelectionEvent.f58303c;
        }
        int i3 = i;
        if ((i2 & 8) != 0) {
            j = adapterViewItemSelectionEvent.f58304d;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        if (this != obj) {
            if (obj instanceof AdapterViewItemSelectionEvent) {
                ...
                return Intrinsics.areEqual(getView(), adapterViewItemSelectionEvent.getView()) && Intrinsics.areEqual(this.f58302b, adapterViewItemSelectionEvent.f58302b) && this.f58303c == adapterViewItemSelectionEvent.f58303c && this.f58304d == adapterViewItemSelectionEvent.f58304d;
            }
            return false;
        }
        return true;
    ...
    public int hashCode() {
        ...
        View view2 = this.f58302b;
        int hashCode2 = view2 != null ? view2.hashCode() : 0;
        long j = this.f58304d;
        return ((((hashCode + hashCode2) * 31) + this.f58303c) * 31) + ((int) (j ^ (j >>> 32)));
    }

    @NotNull
    public String toString() {
        return "AdapterViewItemSelectionEvent(view=" + getView() + ", selectedView=" + this.f58302b + ", position=" + this.f58303c + ", id=" + this.f58304d + ")";
    }
}
