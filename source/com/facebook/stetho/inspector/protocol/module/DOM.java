...
public class DOM implements ChromeDevtoolsDomain {
    ...
    public final class DocumentUpdateListener implements Document.UpdateListener {
        ...
        public void onInspectRequested(Object obj) {
            ...
            if (nodeIdForElement == null) {
                LogUtil.m49806d("DocumentProvider.Listener.onInspectRequested() called for a non-mapped node: element=%s", obj);
                return;
            }
    ...
    public static class RGBAColor {
        ...
        public int getColor() {
            ...
            return Color.argb((int) b, this.f43089r, this.f43088g, this.f43087b);
        }
    }
    ...
    public GetSearchResultsResponse getSearchResults(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        if (str == null) {
            LogUtil.m49791w("searchId may not be null");
            return null;
        }
        List<Integer> list = this.mSearchResults.get(str);
        if (list == null) {
            LogUtil.m49791w(OperatorName.SHOW_TEXT_LINE_AND_SPACE + getSearchResultsRequest.searchId + "\" is not a valid reference to a search result");
            return null;
        }
    ...
    public void highlightNode(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        if (highlightNodeRequest.nodeId == null) {
            LogUtil.m49791w("DOM.highlightNode was not given a nodeId; JS objectId is not supported");
            return;
        }
        final RGBAColor rGBAColor = highlightNodeRequest.highlightConfig.contentColor;
        if (rGBAColor == null) {
            LogUtil.m49791w("DOM.highlightNode was not given a color to highlight with");
        } else {
