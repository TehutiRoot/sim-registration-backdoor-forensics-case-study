...
public final class PrettyPrinterDisplayType {
    ...
    static {
        PrettyPrinterDisplayType prettyPrinterDisplayType = new PrettyPrinterDisplayType(JsonFactory.FORMAT_NAME_JSON, 0, Page.ResourceType.XHR);
        ...
        PrettyPrinterDisplayType prettyPrinterDisplayType3 = new PrettyPrinterDisplayType(Constant.CampaignType.TYPE_TEXT, 2, resourceType);
