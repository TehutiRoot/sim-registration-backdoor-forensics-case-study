...
public final class Document extends ThreadBoundProxy {
            ...
            private Accumulator<Object> insertedElements = new Accumulator<Object>() { // from class: com.facebook.stetho.inspector.elements.Document.5.1
                ...
                public void store(Object obj) {
                    if (update.isElementChanged(obj)) {
                        C60165.this.listenerInsertedElements.add(obj);
                    }
                }
            };
            ...
            while (!this.mCachedUpdateQueue.isEmpty()) {
                ...
                while (i < size) {
                    ...
                    if (obj != null) {
                        ...
                        LogUtil.m49802e("%s.getChildren() emitted a null child at position %s for element %s", nodeDescriptor.getClass().getName(), Integer.toString(i), remove);
    ...
    public void updateTree() {
        ...
        String l = Long.toString(SystemClock.elapsedRealtime() - elapsedRealtime);
        if (isEmpty) {
            str = " (no changes)";
        } else {
            str = "";
        }
        LogUtil.m49806d("Document.updateTree() completed in %s ms%s", l, str);
    }
