    ...
    public Database.ExecuteSQLResponse executeSQL(SqliteDatabaseDescriptor sqliteDatabaseDescriptor, String str, BaseDatabaseDriver.ExecuteResultHandler<Database.ExecuteSQLResponse> executeResultHandler) throws SQLiteException {
        ...
        try {
            ...
            if (c == 0 || c == 1) {
                ...
                Database.ExecuteSQLResponse executeSQLResponse3 = (Database.ExecuteSQLResponse) executeRawQuery(openDatabase, str, executeResultHandler);
                openDatabase.close();
                return executeSQLResponse3;
            } else {
                Database.ExecuteSQLResponse executeSQLResponse4 = (Database.ExecuteSQLResponse) executeSelect(openDatabase, str, executeResultHandler);
                openDatabase.close();
