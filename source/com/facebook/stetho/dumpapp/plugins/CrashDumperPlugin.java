    ...
    private void doUncaughtException(Iterator<String> it) throws DumpException {
        ...
        try {
            ...
            if (tryGetDeclaredConstructor != null) {
                th2 = (Throwable) tryGetDeclaredConstructor.newInstance("Uncaught exception triggered by Stetho");
            } else {
                th2 = (Throwable) cls.getDeclaredConstructor(null).newInstance(null);
            }
