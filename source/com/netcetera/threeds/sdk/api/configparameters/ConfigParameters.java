...
public class ConfigParameters {
    ...
    public void addParam(String str, String str2, String str3) throws InvalidInputException {
        ...
        values = i % 128;
        if (i % 2 != 0) {
            C9621nj.ThreeDS2Service(str2, "paramName");
            C9621nj.ThreeDS2Service(str3, "paramValue");
            String values2 = C9669om.values(str);
            String values3 = C9669om.values(str2);
        ...
        C9621nj.ThreeDS2Service(str2, "paramName");
        C9621nj.ThreeDS2Service(str3, "paramValue");
        String values4 = C9669om.values(str);
        C9669om.values(str2);
