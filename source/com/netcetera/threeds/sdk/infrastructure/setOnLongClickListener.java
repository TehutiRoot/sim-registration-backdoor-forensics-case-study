...
public class setOnLongClickListener implements setDarkTextColor.valueOf {
    private final setDarkTextColor values;

    public setOnLongClickListener(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.Transaction(this.values);
    }
}
