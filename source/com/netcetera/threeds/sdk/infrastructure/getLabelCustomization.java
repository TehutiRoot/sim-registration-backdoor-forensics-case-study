...
public class getLabelCustomization implements setDarkTextColor.valueOf {
    private final setDarkTextColor ThreeDS2Service;
    private final setDarkTextColor.ThreeDS2Service values;

    public getLabelCustomization(setDarkTextColor setdarktextcolor, setDarkTextColor.ThreeDS2Service threeDS2Service) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.dinersSchemeConfiguration(this.ThreeDS2Service, this.values);
    }
}
