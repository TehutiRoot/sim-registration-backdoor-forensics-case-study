...
public class ChallengeStatusReceiver implements close {
    ...
    private final C9582lz values;

    public ChallengeStatusReceiver(setAcsRefNumber setacsrefnumber, RuntimeErrorEvent runtimeErrorEvent, ChallengeParameters challengeParameters, C9582lz c9582lz) {
    ...
    public static close values(setAcsRefNumber setacsrefnumber, ChallengeParameters challengeParameters, C9582lz c9582lz) {
        ChallengeStatusReceiver challengeStatusReceiver = new ChallengeStatusReceiver(setacsrefnumber, timedout.valueOf(), challengeParameters, c9582lz);
        int i = getSDKVersion;
        int i2 = (i & 11) + (i | 11);
        get = i2 % 128;
        if (i2 % 2 == 0) {
