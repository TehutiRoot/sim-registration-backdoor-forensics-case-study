...
public class C9248an extends AbstractC9759x {
    private static int ThreeDS2ServiceInstance = 1;
    private static int values;

    public C9248an(Context context, AbstractC9758w abstractC9758w, AbstractC9758w abstractC9758w2) {
    ...
    public boolean valueOf() {
        ...
        values = i5 % 128;
        int i6 = i5 % 2;
        AbstractC9758w<View> abstractC9758w = this.valueOf;
        if (i6 == 0) {
            return get(abstractC9758w);
        }
        get(abstractC9758w);
        throw null;
    }
