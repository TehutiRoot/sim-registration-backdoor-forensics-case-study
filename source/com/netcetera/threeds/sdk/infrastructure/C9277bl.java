...
public class C9277bl extends AbstractC9758w<LinearLayout> implements save, writeReplace {
    ...
    private final InterfaceC9513jq onError;
    ...
    public C9277bl(Context context, InterfaceC9513jq interfaceC9513jq, String str) {
        super(context);
        this.onError = interfaceC9513jq;
    ...
    public LinearLayout values(Context context) {
        ...
        this.initialize.setMinHeight(C9375et.getSDKInfo);
        ...
        C9377ev.get(this.initialize, this.onError);
        onCompleted = (ThreeDS2Service$InitializationCallback + 25) % 128;
        return linearLayout;
    }

    public static C9277bl ThreeDS2ServiceInstance(Context context, InterfaceC9513jq interfaceC9513jq) {
        Object[] objArr = new Object[1];
        ...
        C9277bl c9277bl = new C9277bl(context, interfaceC9513jq, ((String) objArr[0]).intern());
    ...
    /* JADX WARN: Code restructure failed: missing block: B:9:0x0019, code lost:
        ...
        r0 = new com.netcetera.threeds.sdk.infrastructure.C9273bi(r4.initialize.getText().toString());
        r2 = com.netcetera.threeds.sdk.infrastructure.C9277bl.ThreeDS2Service$InitializationCallback + 31;
        com.netcetera.threeds.sdk.infrastructure.C9277bl.onCompleted = r2 % 128;
     */
    ...
    */
    public com.netcetera.threeds.sdk.infrastructure.isEmpty get() {
        /*
            r4 = this;
            int r0 = com.netcetera.threeds.sdk.infrastructure.C9277bl.onCompleted
            int r0 = r0 + 19
            int r1 = r0 % 128
            com.netcetera.threeds.sdk.infrastructure.C9277bl.ThreeDS2Service$InitializationCallback = r1
            int r0 = r0 % 2
            r1 = 0
            r2 = 0
            if (r0 != 0) goto L15
        ...
        L19:
            ...
            r0.<init>(r2)
            int r2 = com.netcetera.threeds.sdk.infrastructure.C9277bl.ThreeDS2Service$InitializationCallback
            int r2 = r2 + 31
            int r3 = r2 % 128
            com.netcetera.threeds.sdk.infrastructure.C9277bl.onCompleted = r3
            int r2 = r2 % 2
            if (r2 != 0) goto L3a
            return r0
        L3a:
        ...
        L3b:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.netcetera.threeds.sdk.infrastructure.C9277bl.get():com.netcetera.threeds.sdk.infrastructure.isEmpty");
    }
    ...
    public void valueOf(InterfaceC9370eo interfaceC9370eo) {
        ...
        interfaceC9370eo.values(((String) objArr[0]).intern(), valueOf2);
    ...
    public void values(InterfaceC9373er interfaceC9373er) {
        ...
        String valueOf2 = interfaceC9373er.valueOf(((String) objArr[0]).intern(), null);
