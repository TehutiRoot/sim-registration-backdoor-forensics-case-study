...
public class setLeftTopRightBottom implements setDarkTextColor.valueOf {
    private final setDarkTextColor ThreeDS2ServiceInstance;

    public setLeftTopRightBottom(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.runtimeError(this.ThreeDS2ServiceInstance);
    }
}
