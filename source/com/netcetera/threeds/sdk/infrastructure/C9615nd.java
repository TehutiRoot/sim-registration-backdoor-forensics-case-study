...
/* renamed from: com.netcetera.threeds.sdk.infrastructure.nd */
/* loaded from: classes5.dex */
public final class C9615nd {
    public static char ThreeDS2Service = 33409;
    public static char ThreeDS2ServiceInstance = 54309;
    public static char get = 22369;
    private static int getSDKVersion = 1;
    public static char valueOf = 44478;
    ...
    public static boolean get(String[] strArr, String str, boolean z) {
        ...
        int i = 0;
        while (i < length) {
            getSDKVersion = (values + 57) % 128;
            String str2 = strArr[i];
            if ((z && values(str, str2)) || !(!C9669om.valueOf(str, str2))) {
                return true;
            }
            i++;
            values = (getSDKVersion + 115) % 128;
        }
        return false;
    }
    ...
    */
    private static void valueOf(java.lang.String r12, int r13, java.lang.Object[] r14) {
        ...
        L28:
            ...
            int r9 = r8 + r4
            int r10 = r8 << 4
            char r11 = com.netcetera.threeds.sdk.infrastructure.C9615nd.valueOf     // Catch: java.lang.Throwable -> L5b
            int r10 = r10 + r11
            r9 = r9 ^ r10
            int r10 = r8 >>> 5
            char r11 = com.netcetera.threeds.sdk.infrastructure.C9615nd.ThreeDS2Service     // Catch: java.lang.Throwable -> L5b
            int r10 = r10 + r11
            r9 = r9 ^ r10
            int r7 = r7 - r9
            ...
            int r9 = r7 + r4
            int r10 = r7 << 4
            char r11 = com.netcetera.threeds.sdk.infrastructure.C9615nd.ThreeDS2ServiceInstance     // Catch: java.lang.Throwable -> L5b
            int r10 = r10 + r11
            r9 = r9 ^ r10
            int r7 = r7 >>> 5
            char r10 = com.netcetera.threeds.sdk.infrastructure.C9615nd.get     // Catch: java.lang.Throwable -> L5b
            int r7 = r7 + r10
            r7 = r7 ^ r9
            int r8 = r8 - r7
        ...
        L77:
            ...
            throw r12
        */
        throw new UnsupportedOperationException("Method not decompiled: com.netcetera.threeds.sdk.infrastructure.C9615nd.valueOf(java.lang.String, int, java.lang.Object[]):void");
    }

    public static boolean values(String str, String str2) {
        values = (getSDKVersion + 113) % 128;
        Object[] objArr = new Object[1];
        valueOf("캫퐴", (KeyEvent.getMaxKeyCode() >> 16) + 1, objArr);
        String values2 = C9669om.values(str, ((String) objArr[0]).intern());
        Object[] objArr2 = new Object[1];
        valueOf("캫퐴", 1 - ((Process.getThreadPriority(0) + 20) >> 6), objArr2);
        boolean valueOf2 = C9669om.valueOf(values2, C9669om.values(str2, ((String) objArr2[0]).intern()));
        getSDKVersion = (values + 75) % 128;
        return valueOf2;
    }
}
