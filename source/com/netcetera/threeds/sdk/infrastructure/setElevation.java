...
public class setElevation implements setDarkTextColor.valueOf {
    public static final setElevation values = new setElevation();

    @Override // com.netcetera.threeds.sdk.infrastructure.setDarkTextColor.valueOf
    public getHeadingTextColor values() {
        return setDarkTextColor.setOnCreateContextMenuListener();
    }
}
