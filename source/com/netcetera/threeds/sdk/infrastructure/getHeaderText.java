...
public class getHeaderText implements setDarkTextColor.valueOf {
    private final setDarkTextColor get;

    public getHeaderText(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.ids(this.get);
    }
}
