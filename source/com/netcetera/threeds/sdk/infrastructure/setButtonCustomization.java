...
public class setButtonCustomization implements setDarkTextColor.valueOf {
    private final setDarkTextColor ThreeDS2Service;

    public setButtonCustomization(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.getSchemeName(this.ThreeDS2Service);
    }
}
