...
public class C9495iz implements InterfaceC9500jd {
    private static int ThreeDS2Service = 1;
    private static int valueOf;
    private final C9504jh get;
    private final C9501je values;

    public C9495iz(C9501je c9501je, C9504jh c9504jh) {
        this.values = c9501je;
        this.get = c9504jh;
    }

    public static InterfaceC9500jd get() {
        C9495iz c9495iz = new C9495iz(new C9501je(), C9504jh.valueOf());
    ...
    public List<setCustomSelectionActionModeCallback> ThreeDS2Service(C9623nl c9623nl) {
        ...
        List<setCustomSelectionActionModeCallback> ThreeDS2Service2 = this.get.ThreeDS2Service(c9623nl);
    ...
    @Override // com.netcetera.threeds.sdk.infrastructure.InterfaceC9500jd
