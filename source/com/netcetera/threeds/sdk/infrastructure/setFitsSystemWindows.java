...
public class setFitsSystemWindows implements setDarkTextColor.valueOf {
    private final setDarkTextColor ThreeDS2Service;

    public setFitsSystemWindows(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.useBridgingExtension(this.ThreeDS2Service);
    }
}
