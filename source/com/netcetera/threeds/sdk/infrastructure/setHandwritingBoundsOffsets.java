...
public class setHandwritingBoundsOffsets implements setDarkTextColor.valueOf {
    private final setDarkTextColor values;

    public setHandwritingBoundsOffsets(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.getValue(this.values);
    }
}
