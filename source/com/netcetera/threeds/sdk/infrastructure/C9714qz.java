...
public class C9714qz {
    private static int ThreeDS2Service = 0;
    public static long get = -6581427077085852039L;
    private static int values = 1;

    public static <K extends Key> K ThreeDS2Service(Key key, Class<K> cls) throws C9728rm {
        int i = values + 17;
        ...
        try {
            ...
            throw new C9728rm("Invalid key " + e);
        }
    }

    public static void get(byte[] bArr, String str) throws C9728rm {
        int i = values + 35;
        int i2 = i % 128;
        ThreeDS2Service = i2;
        if (i % 2 == 0) {
            ...
            throw new C9728rm("An explicit content encryption key cannot be used with " + str);
        }
        throw null;
    }

    public static void valueOf(Key key) throws C9728rm {
        int i = values;
        int i2 = i + 43;
        ThreeDS2Service = i2 % 128;
        if (i2 % 2 == 0) {
            ...
            throw new C9728rm("The key must not be null.");
        }
        throw null;
    }

    public static void values(Key key) throws C9728rm {
        ...
        if (key != null) {
            if (!(!(key instanceof RSAKey))) {
                ...
                if (bitLength < 2048) {
                    throw new C9728rm("An RSA key of size 2048 bits or larger MUST be used with the all JOSE RSA algorithms (given key was only " + bitLength + " bits).");
                }
            }
        ...
        throw new C9728rm("The RSA key must not be null.");
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:15:0x0096, code lost:
        throw new com.netcetera.threeds.sdk.infrastructure.C9728rm("Invalid key for JWE " + r11 + ", expected a " + com.netcetera.threeds.sdk.infrastructure.C9725rj.get(r12) + " bit key but a " + com.netcetera.threeds.sdk.infrastructure.C9725rj.get(r10) + " bit key was provided.");
     */
    /* JADX WARN: Code restructure failed: missing block: B:16:0x0097, code lost:
        com.netcetera.threeds.sdk.infrastructure.C9714qz.values = (com.netcetera.threeds.sdk.infrastructure.C9714qz.ThreeDS2Service + 83) % 128;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:19:0x00de, code lost:
        throw new com.netcetera.threeds.sdk.infrastructure.C9728rm(r12.toString());
     */
    ...
    */
    public static void ThreeDS2Service(java.security.Key r10, java.lang.String r11, int r12) throws com.netcetera.threeds.sdk.infrastructure.C9728rm {
        /*
            int r0 = com.netcetera.threeds.sdk.infrastructure.C9714qz.values
            int r0 = r0 + 5
            int r1 = r0 % 128
            com.netcetera.threeds.sdk.infrastructure.C9714qz.ThreeDS2Service = r1
            int r0 = r0 % 2
        ...
        L65:
            ...
            r2.append(r11)
            int r11 = com.netcetera.threeds.sdk.infrastructure.C9725rj.get(r12)
            r2.append(r11)
            java.lang.String r11 = " bit key but a "
            r2.append(r11)
            int r10 = com.netcetera.threeds.sdk.infrastructure.C9725rj.get(r10)
            r2.append(r10)
            ...
            throw r0
        L97:
            int r10 = com.netcetera.threeds.sdk.infrastructure.C9714qz.ThreeDS2Service
            int r10 = r10 + 83
            int r10 = r10 % 128
            com.netcetera.threeds.sdk.infrastructure.C9714qz.values = r10
            return
        La0:
            ...
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.netcetera.threeds.sdk.infrastructure.C9714qz.ThreeDS2Service(java.security.Key, java.lang.String, int):void");
    }
    ...
    */
    private static void ThreeDS2Service(java.lang.String r8, int r9, java.lang.Object[] r10) {
        ...
        L6:
            ...
            monitor-enter(r0)
            long r1 = com.netcetera.threeds.sdk.infrastructure.C9714qz.get     // Catch: java.lang.Throwable -> L3a
        ...
        L14:
            ...
            long r6 = com.netcetera.threeds.sdk.infrastructure.C9714qz.get     // Catch: java.lang.Throwable -> L3a
            long r4 = r4 * r6
            long r2 = r2 ^ r4
        ...
        L48:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.netcetera.threeds.sdk.infrastructure.C9714qz.ThreeDS2Service(java.lang.String, int, java.lang.Object[]):void");
    }
}
