...
public class ToolbarCustomization implements setDarkTextColor.valueOf {
    private final setDarkTextColor ThreeDS2ServiceInstance;

    public ToolbarCustomization(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.getEncryptionCertificateKid(this.ThreeDS2ServiceInstance);
    }
}
