...
public class C9372eq implements InterfaceC9371ep, Serializable {
    private static int get = 0;
    private static int valueOf = 1;
    private HashMap<String, Serializable> ThreeDS2Service = new HashMap<>();

    @Override // com.netcetera.threeds.sdk.infrastructure.InterfaceC9370eo
    ...
    @Override // com.netcetera.threeds.sdk.infrastructure.InterfaceC9373er
    ...
    private <T extends Serializable> T get(String str, T t) {
        ...
        int i2 = ((i | 16) << 1) - (i ^ 16);
        get = ((~i2) + (i2 << 1)) % 128;
        T t2 = (T) C9664oh.ThreeDS2Service(this.ThreeDS2Service.get(str), t);
        int i3 = get;
        int i4 = i3 & 13;
