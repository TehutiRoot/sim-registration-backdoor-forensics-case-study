...
class C9492iv implements setSelected.ThreeDS2Service {
    ...
    private final C9491iu get;
    private final com.netcetera.threeds.sdk.api.transaction.challenge.ChallengeParameters valueOf;
    private final int values;

    public C9492iv(C9491iu c9491iu, Activity activity, com.netcetera.threeds.sdk.api.transaction.challenge.ChallengeParameters challengeParameters, com.netcetera.threeds.sdk.api.transaction.challenge.ChallengeStatusReceiver challengeStatusReceiver, int i) {
        this.get = c9491iu;
