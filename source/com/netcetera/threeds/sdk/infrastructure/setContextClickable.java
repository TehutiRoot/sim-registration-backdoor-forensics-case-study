...
public class setContextClickable implements setDarkTextColor.valueOf {
    private final setDarkTextColor ThreeDS2ServiceInstance;

    public setContextClickable(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.SchemeConfiguration$Builder(this.ThreeDS2ServiceInstance);
    }
}
