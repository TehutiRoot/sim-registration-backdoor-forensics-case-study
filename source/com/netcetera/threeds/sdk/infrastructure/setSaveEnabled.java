...
public class setSaveEnabled implements setDarkTextColor.valueOf {
    private final setDarkTextColor values;

    public setSaveEnabled(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.valueOf(this.values);
    }
}
