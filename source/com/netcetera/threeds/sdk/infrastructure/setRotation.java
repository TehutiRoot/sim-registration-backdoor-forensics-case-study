...
public class setRotation implements setDarkTextColor.valueOf {
    public static final setRotation valueOf = new setRotation();

    @Override // com.netcetera.threeds.sdk.infrastructure.setDarkTextColor.valueOf
    public getHeadingTextColor values() {
        return setDarkTextColor.setContentCaptureSession();
    }
}
