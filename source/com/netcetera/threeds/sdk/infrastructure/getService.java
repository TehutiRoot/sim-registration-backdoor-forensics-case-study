...
public class getService implements setDarkTextColor.valueOf {
    private final setDarkTextColor.ThreeDS2Service ThreeDS2ServiceInstance;
    private final setDarkTextColor valueOf;

    public getService(setDarkTextColor setdarktextcolor, setDarkTextColor.ThreeDS2Service threeDS2Service) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.amexConfiguration(this.valueOf, this.ThreeDS2ServiceInstance);
    }
}
