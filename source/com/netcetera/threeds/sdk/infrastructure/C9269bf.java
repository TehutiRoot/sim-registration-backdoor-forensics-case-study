...
public class C9269bf extends AbstractC9758w<LinearLayout> implements save, writeReplace {
    ...
    private final InterfaceC9511jo initialize;
            ...
            */
            private static void valueOf(java.lang.String r8, int r9, java.lang.Object[] r10) {
                ...
                L6:
                    ...
                    monitor-enter(r0)
                    long r1 = com.netcetera.threeds.sdk.infrastructure.C9269bf.C92705.ThreeDS2ServiceInstance     // Catch: java.lang.Throwable -> L3a
                ...
                L14:
                    ...
                    long r6 = com.netcetera.threeds.sdk.infrastructure.C9269bf.C92705.ThreeDS2ServiceInstance     // Catch: java.lang.Throwable -> L3a
                    long r4 = r4 * r6
                    long r2 = r2 ^ r4
                ...
                L48:
                    ...
                    throw r8
                */
                throw new UnsupportedOperationException("Method not decompiled: com.netcetera.threeds.sdk.infrastructure.C9269bf.C92705.valueOf(java.lang.String, int, java.lang.Object[]):void");
            }
        };
        ConfigParameters = (onCompleted + 95) % 128;
    }

    public C9269bf(Context context, InterfaceC9511jo interfaceC9511jo) {
        super(context);
        this.initialize = interfaceC9511jo;
        this.ThreeDS2Service$InitializationCallback = new HashSet();
        this.createTransaction = new HashSet();
    }

    public static /* synthetic */ void ThreeDS2Service(C9269bf c9269bf, String[] strArr, int i, String[] strArr2, CompoundButton compoundButton, boolean z) {
        int i2 = ConfigParameters + 67;
        onCompleted = i2 % 128;
        int i3 = i2 % 2;
        c9269bf.ThreeDS2Service(strArr, i, strArr2, compoundButton, z);
        if (i3 != 0) {
            int i4 = 82 / 0;
        }
    ...
    public void valueOf(setAllCaps setallcaps) {
        ...
        if (SchemeConfiguration != null) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                ...
                int i5 = C9375et.ThreeDS2ServiceInstance;
                checkBox.setPadding(0, i5, 0, i5);
                checkBox.setMinHeight(C9375et.getSDKInfo);
                checkBox.setText(strArr[i4]);
                checkBox.setOnCheckedChangeListener(new C9271bg(this, strArr2, i4, strArr));
                ArrayList<String> arrayList = getWarnings;
                if (i4 < arrayList.size()) {
                    values(checkBox, arrayList.get(i4));
                }
                C9377ev.values(checkBox, this.initialize);
    ...
    public void values(InterfaceC9373er interfaceC9373er) {
        ...
        List<String> list = interfaceC9373er.get(((String) objArr[0]).intern(), new ArrayList());
        if (list.isEmpty()) {
            return;
        }
        for (int i = 0; i < this.onError.getChildCount(); i++) {
            ...
            for (String str : list) {
                ...
                if (C9669om.valueOf(str, checkBox.getText())) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:9:0x0023, code lost:
        ...
        r2 = com.netcetera.threeds.sdk.infrastructure.C9669om.values(r0, ((java.lang.String) r3[0]).intern());
        com.netcetera.threeds.sdk.infrastructure.C9269bf.onCompleted = (com.netcetera.threeds.sdk.infrastructure.C9269bf.ConfigParameters + 57) % 128;
     */
    ...
    */
    public com.netcetera.threeds.sdk.infrastructure.isEmpty get() {
        /*
            r6 = this;
            int r0 = com.netcetera.threeds.sdk.infrastructure.C9269bf.ConfigParameters
            int r0 = r0 + 7
            int r1 = r0 % 128
            com.netcetera.threeds.sdk.infrastructure.C9269bf.onCompleted = r1
            int r0 = r0 % 2
            r1 = 0
            java.lang.String r2 = ""
            if (r0 == 0) goto L1b
        ...
        L23:
            ...
            java.lang.String r2 = com.netcetera.threeds.sdk.infrastructure.C9669om.values(r0, r1)
            int r0 = com.netcetera.threeds.sdk.infrastructure.C9269bf.ConfigParameters
            int r0 = r0 + 57
            int r0 = r0 % 128
            com.netcetera.threeds.sdk.infrastructure.C9269bf.onCompleted = r0
        L52:
            com.netcetera.threeds.sdk.infrastructure.bi r0 = new com.netcetera.threeds.sdk.infrastructure.bi
            r0.<init>(r2)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.netcetera.threeds.sdk.infrastructure.C9269bf.get():com.netcetera.threeds.sdk.infrastructure.isEmpty");
    }
    ...
    public LinearLayout ThreeDS2Service(Context context) {
        ...
        linearLayout.setPadding(i, C9375et.ThreeDS2Service, i, 0);
        linearLayout.setLayoutParams(layoutParams);
        LinearLayout linearLayout2 = new LinearLayout(context);
        this.onError = linearLayout2;
        linearLayout2.setLayoutParams(C9378ex.valueOf());
    ...
    public void valueOf(InterfaceC9370eo interfaceC9370eo) {
        ...
        if (i % 2 != 0) {
            ...
            interfaceC9370eo.ThreeDS2Service(((String) objArr[0]).intern(), new ArrayList(this.createTransaction));
    ...
    */
    private static void valueOf(int r6, int[] r7, java.lang.String r8, java.lang.String r9, java.lang.Object[] r10) {
        ...
        L10:
            ...
            monitor-enter(r0)
            char[] r1 = com.netcetera.threeds.sdk.infrastructure.C9269bf.get     // Catch: java.lang.Throwable -> L42
            int r2 = com.netcetera.threeds.sdk.infrastructure.C9269bf.ThreeDS2Service     // Catch: java.lang.Throwable -> L42
            boolean r3 = com.netcetera.threeds.sdk.infrastructure.C9269bf.valueOf     // Catch: java.lang.Throwable -> L42
            r4 = 0
            if (r3 == 0) goto L4d
        ...
        L44:
            ...
            return
        L4d:
            boolean r9 = com.netcetera.threeds.sdk.infrastructure.C9269bf.ThreeDS2ServiceInstance     // Catch: java.lang.Throwable -> L42
            if (r9 == 0) goto L7e
        ...
        Lab:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.netcetera.threeds.sdk.infrastructure.C9269bf.valueOf(int, int[], java.lang.String, java.lang.String, java.lang.Object[]):void");
    }
}
