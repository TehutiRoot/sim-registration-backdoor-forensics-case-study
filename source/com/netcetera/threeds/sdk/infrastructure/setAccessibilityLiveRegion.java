...
public class setAccessibilityLiveRegion implements setDarkTextColor.valueOf {
    private final setDarkTextColor ThreeDS2Service;
    private final setDarkTextColor.ThreeDS2Service values;

    public setAccessibilityLiveRegion(setDarkTextColor setdarktextcolor, setDarkTextColor.ThreeDS2Service threeDS2Service) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.ThreeDS2Service$InitializationCallback(this.ThreeDS2Service, this.values);
    }
}
