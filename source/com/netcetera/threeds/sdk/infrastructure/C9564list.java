...
public class C9564list extends AbstractC9758w<Toolbar> {
    ...
    private final InterfaceC9512jp initialize;
    private final InterfaceC9507jk onCompleted;
    private forEach onError;

    static {
        get();
        ThreeDS2ServiceInstance = C9624nm.valueOf(56);
        getWarnings = C9624nm.valueOf(4);
    ...
    public C9564list(Context context, InterfaceC9512jp interfaceC9512jp, InterfaceC9507jk interfaceC9507jk) {
        super(context);
        this.initialize = interfaceC9512jp;
        this.onCompleted = interfaceC9507jk;
    }
    ...
    public static /* synthetic */ void values(C9564list c9564list, View view) {
        ConfigParameters = (createTransaction + 19) % 128;
        c9564list.valueOf(view);
    ...
    public Toolbar ThreeDS2Service(Context context) {
        ...
        button.setOnClickListener(new View$OnClickListenerC9756u(this));
        ...
        C9377ev.values(textView, this.initialize);
        textView.setText(this.initialize.ThreeDS2Service());
        C9377ev.values(button, (InterfaceC9514jr) this.onCompleted);
        C9377ev.values(button, this.onCompleted);
    ...
    private /* synthetic */ void valueOf(View view) {
        ...
        foreach.ThreeDS2ServiceInstance(new C9273bi(((String) objArr[0]).intern()));
    ...
    */
    private static void valueOf(int r6, int[] r7, java.lang.String r8, java.lang.String r9, java.lang.Object[] r10) {
        ...
        L10:
            ...
            monitor-enter(r0)
            char[] r1 = com.netcetera.threeds.sdk.infrastructure.C9564list.values     // Catch: java.lang.Throwable -> L42
            int r2 = com.netcetera.threeds.sdk.infrastructure.C9564list.get     // Catch: java.lang.Throwable -> L42
            boolean r3 = com.netcetera.threeds.sdk.infrastructure.C9564list.ThreeDS2Service     // Catch: java.lang.Throwable -> L42
            r4 = 0
            if (r3 == 0) goto L4d
        ...
        L44:
            ...
            return
        L4d:
            boolean r9 = com.netcetera.threeds.sdk.infrastructure.C9564list.valueOf     // Catch: java.lang.Throwable -> L42
            if (r9 == 0) goto L7e
        ...
        Lab:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.netcetera.threeds.sdk.infrastructure.C9564list.valueOf(int, int[], java.lang.String, java.lang.String, java.lang.Object[]):void");
    }
