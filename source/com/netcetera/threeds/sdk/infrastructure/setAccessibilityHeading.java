...
public class setAccessibilityHeading implements setDarkTextColor.valueOf {
    private final setDarkTextColor get;

    public setAccessibilityHeading(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.addParam(this.get);
    }
}
