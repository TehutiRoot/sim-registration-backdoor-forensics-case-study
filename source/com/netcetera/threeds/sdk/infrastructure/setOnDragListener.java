...
public class setOnDragListener implements setDarkTextColor.valueOf {
    private final setDarkTextColor valueOf;

    public setOnDragListener(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.encryptionPublicKeyFromAssetCertificate(this.valueOf);
    }
}
