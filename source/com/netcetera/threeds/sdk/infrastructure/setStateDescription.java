...
public class setStateDescription implements setDarkTextColor.valueOf {
    private final setDarkTextColor.ThreeDS2Service ThreeDS2ServiceInstance;
    private final setDarkTextColor valueOf;

    public setStateDescription(setDarkTextColor setdarktextcolor, setDarkTextColor.ThreeDS2Service threeDS2Service) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.onError(this.valueOf, this.ThreeDS2ServiceInstance);
    }
}
