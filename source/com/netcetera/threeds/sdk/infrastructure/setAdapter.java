...
class setAdapter implements Runnable {
    private final setWebViewClient.ThreeDS2ServiceInstance ThreeDS2Service;
    private final setId get;

    public setAdapter(setWebViewClient.ThreeDS2ServiceInstance threeDS2ServiceInstance, setId setid) {
    ...
    public void run() {
        this.ThreeDS2Service.ThreeDS2ServiceInstance(this.get);
    }
}
