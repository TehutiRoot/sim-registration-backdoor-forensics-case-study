...
public class C9650np implements InterfaceC9652ns, Serializable {
    ...
    private void values(get getVar, String str, Object... objArr) {
        ...
        try {
            if (i % 2 != 0) {
                if (C9669om.ThreeDS2ServiceInstance(str) && objArr != null && objArr.length > 0) {
    ...
    @Override // com.netcetera.threeds.sdk.infrastructure.InterfaceC9652ns
    public void ThreeDS2ServiceInstance(String str) {
        Logger logger = this.ThreeDS2Service;
        Objects.requireNonNull(logger);
        get(str, new C9658ny(logger));
    ...
    public void ThreeDS2Service(String str, Object... objArr) {
        values(new C9657nx(this), str, objArr);
        int i = cleanup + 113;
        getSDKVersion = i % 128;
        if (i % 2 != 0) {
            throw null;
    ...
    public void valueOf(String str, Object... objArr) {
        values(new C9654nu(this), str, objArr);
        cleanup = (getSDKVersion + 95) % 128;
    }

    @Override // com.netcetera.threeds.sdk.infrastructure.InterfaceC9652ns
    public void valueOf(String str, C9613nb c9613nb) {
        if (c9613nb.ThreeDS2ServiceInstance()) {
            ...
            try {
                try {
                    ...
                    get(String.format(((String) objArr2[0]).intern(), invoke, C9668ol.get(bytes)), C9656nw.values);
    ...
    private String values(String str) {
        ...
        try {
            C9651nr ThreeDS2Service = C9651nr.ThreeDS2Service(str);
            Object[] objArr = new Object[1];
    ...
    */
    private static void valueOf(int r6, int[] r7, java.lang.String r8, java.lang.String r9, java.lang.Object[] r10) {
        ...
        L10:
            ...
            monitor-enter(r0)
            char[] r1 = com.netcetera.threeds.sdk.infrastructure.C9650np.ThreeDS2ServiceInstance     // Catch: java.lang.Throwable -> L42
            int r2 = com.netcetera.threeds.sdk.infrastructure.C9650np.valueOf     // Catch: java.lang.Throwable -> L42
            boolean r3 = com.netcetera.threeds.sdk.infrastructure.C9650np.get     // Catch: java.lang.Throwable -> L42
            r4 = 0
            if (r3 == 0) goto L4d
        ...
        L44:
            ...
            return
        L4d:
            boolean r9 = com.netcetera.threeds.sdk.infrastructure.C9650np.values     // Catch: java.lang.Throwable -> L42
            if (r9 == 0) goto L7e
        ...
        Lab:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.netcetera.threeds.sdk.infrastructure.C9650np.valueOf(int, int[], java.lang.String, java.lang.String, java.lang.Object[]):void");
    }

    private void values(C9651nr c9651nr, String str) {
        getSDKVersion = (cleanup + 17) % 128;
        if (c9651nr.getWarnings(str)) {
            cleanup = (getSDKVersion + 91) % 128;
            c9651nr.ThreeDS2Service(str, C9669om.get('*', c9651nr.values(str).length()));
        }
    }
}
