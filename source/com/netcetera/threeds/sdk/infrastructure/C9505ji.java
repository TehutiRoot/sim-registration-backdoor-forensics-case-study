...
public class C9505ji implements setSubtitleTextColor<setCustomSelectionActionModeCallback, C9651nr> {
    ...
    public setCustomSelectionActionModeCallback ThreeDS2Service(C9651nr c9651nr) {
        ...
        String values2 = c9651nr.values(((String) objArr2[0]).intern());
        Object[] objArr3 = new Object[1];
        ThreeDS2Service(new int[]{1765575280, -515118293}, (-16777214) - Color.rgb(0, 0, 0), objArr3);
        String values3 = c9651nr.values(((String) objArr3[0]).intern());
        Object[] objArr4 = new Object[1];
        ThreeDS2Service(new int[]{1356790975, 934164416}, TextUtils.lastIndexOf("", '0', 0, 0) + 5, objArr4);
        setTitleMarginStart settitlemarginstart = new setTitleMarginStart(sDKInfo, values2, values3, c9651nr.values(((String) objArr4[0]).intern()));
    ...
    public /* synthetic */ setCustomSelectionActionModeCallback valueOf(C9651nr c9651nr) {
        ...
        if (i % 2 == 0) {
            setCustomSelectionActionModeCallback ThreeDS2Service2 = ThreeDS2Service(c9651nr2);
            ThreeDS2ServiceInstance = (ThreeDS2Service + 43) % 128;
            return ThreeDS2Service2;
        }
        ThreeDS2Service(c9651nr2);
        throw null;
    }
