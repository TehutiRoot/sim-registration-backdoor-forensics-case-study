...
public class getAcsSignedContent implements getValue {
    ...
    public close ThreeDS2ServiceInstance(com.netcetera.threeds.sdk.api.configparameters.ConfigParameters configParameters, C9582lz c9582lz) throws setId {
        ...
        try {
            ...
            close values = ChallengeStatusReceiver.values(ThreeDS2Service, completedVar, c9582lz);
            int i = initialize;
            int i2 = i & 17;
            int i3 = (i | 17) & (~i2);
            int i4 = -(-(i2 << 1));
