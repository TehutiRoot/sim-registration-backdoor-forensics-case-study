...
public class setScrollY implements setDarkTextColor.valueOf {
    private final setDarkTextColor valueOf;

    public setScrollY(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.setThreeDSRequestorAppURL(this.valueOf);
    }
}
