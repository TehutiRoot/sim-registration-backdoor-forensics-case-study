...
public class setOutlineSpotShadowColor implements setDarkTextColor.valueOf {
    private final setDarkTextColor values;

    public setOutlineSpotShadowColor(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.doChallenge(this.values);
    }
}
