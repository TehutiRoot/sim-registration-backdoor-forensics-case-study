...
public class getDarkBorderColor implements setDarkTextColor.valueOf {
    private final setDarkTextColor valueOf;
    private final setDarkTextColor.ThreeDS2Service values;

    public getDarkBorderColor(setDarkTextColor setdarktextcolor, setDarkTextColor.ThreeDS2Service threeDS2Service) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.get(this.valueOf, this.values);
    }
}
