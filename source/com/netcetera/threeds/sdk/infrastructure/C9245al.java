...
public class C9245al extends storeToXML {
    public static long ThreeDS2Service = 9011076704917796986L;
    private static int get = 0;
    private static int values = 1;

    public C9245al(Context context, InterfaceC9511jo interfaceC9511jo) {
    ...
    public keys ThreeDS2ServiceInstance(keys keysVar) {
        C9303ci c9303ci = new C9303ci(keysVar, putAll.values);
        get = (values + 77) % 128;
        return c9303ci;
    }
    ...
    public keys values(keys keysVar) {
        C9303ci c9303ci = new C9303ci(keysVar, putAll.ThreeDS2Service);
        int i = values + 69;
        get = i % 128;
        if (i % 2 == 0) {
            return c9303ci;
    ...
    */
    private static void values(java.lang.String r8, int r9, java.lang.Object[] r10) {
        ...
        L6:
            ...
            monitor-enter(r0)
            long r1 = com.netcetera.threeds.sdk.infrastructure.C9245al.ThreeDS2Service     // Catch: java.lang.Throwable -> L3a
        ...
        L14:
            ...
            long r6 = com.netcetera.threeds.sdk.infrastructure.C9245al.ThreeDS2Service     // Catch: java.lang.Throwable -> L3a
            long r4 = r4 * r6
            long r2 = r2 ^ r4
        ...
        L48:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.netcetera.threeds.sdk.infrastructure.C9245al.values(java.lang.String, int, java.lang.Object[]):void");
    }
