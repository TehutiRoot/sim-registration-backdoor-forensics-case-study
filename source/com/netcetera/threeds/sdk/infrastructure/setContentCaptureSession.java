...
public class setContentCaptureSession implements setDarkTextColor.valueOf {
    private final setDarkTextColor ThreeDS2Service;

    public setContentCaptureSession(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.build(this.ThreeDS2Service);
    }
}
