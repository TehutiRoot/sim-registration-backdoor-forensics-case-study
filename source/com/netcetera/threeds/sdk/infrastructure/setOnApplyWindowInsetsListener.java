...
public class setOnApplyWindowInsetsListener implements setDarkTextColor.valueOf {
    private final setDarkTextColor valueOf;

    public setOnApplyWindowInsetsListener(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.ThreeDS2Service(this.valueOf);
    }
}
