...
public class openContextMenu implements setDarkTextColor.valueOf {
    private final setDarkTextColor valueOf;

    public openContextMenu(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.getType(this.valueOf);
    }
}
