...
public class setSoundEffectsEnabled implements setDarkTextColor.valueOf {
    private final setDarkTextColor get;

    public setSoundEffectsEnabled(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.encryptionPublicKey(this.get);
    }
}
