...
public class setWindowInsetsAnimationCallback implements setDarkTextColor.valueOf {
    private final setDarkTextColor valueOf;

    public setWindowInsetsAnimationCallback(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.restrictedParameters(this.valueOf);
    }
}
