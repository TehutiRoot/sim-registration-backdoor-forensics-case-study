...
public class getHeadingTextFontName implements setDarkTextColor.valueOf {
    private final setDarkTextColor valueOf;

    public getHeadingTextFontName(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.rootPublicKey(this.valueOf);
    }
}
