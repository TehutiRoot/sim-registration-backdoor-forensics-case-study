...
public class setImportantForAutofill implements setDarkTextColor.valueOf {
    private final setDarkTextColor ThreeDS2Service;

    public setImportantForAutofill(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.CertificateInfo$CertificateType(this.ThreeDS2Service);
    }
}
