...
public class getTextBoxCustomization implements setDarkTextColor.valueOf {
    private final setDarkTextColor get;
    private final setDarkTextColor.ThreeDS2Service values;

    public getTextBoxCustomization(setDarkTextColor setdarktextcolor, setDarkTextColor.ThreeDS2Service threeDS2Service) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.getWarnings(this.get, this.values);
    }
}
