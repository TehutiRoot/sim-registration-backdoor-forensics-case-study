...
class setMenu implements setSubtitleTextColor<setTitleMargin, C9651nr> {
    ...
    */
    ...
    public setTitleMargin ThreeDS2ServiceInstance(C9651nr c9651nr) {
        ...
        setTitleMargin settitlemargin = setSubtitle.get(values2, values3, c9651nr.values(((String) objArr3[0]).intern()));
