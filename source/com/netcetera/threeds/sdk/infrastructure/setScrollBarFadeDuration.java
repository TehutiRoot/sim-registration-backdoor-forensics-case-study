...
public class setScrollBarFadeDuration implements setDarkTextColor.valueOf {
    private final setDarkTextColor.ThreeDS2Service ThreeDS2Service;
    private final setDarkTextColor ThreeDS2ServiceInstance;

    public setScrollBarFadeDuration(setDarkTextColor setdarktextcolor, setDarkTextColor.ThreeDS2Service threeDS2Service) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.build(this.ThreeDS2ServiceInstance, this.ThreeDS2Service);
    }
}
