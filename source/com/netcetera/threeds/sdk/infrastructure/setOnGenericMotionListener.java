...
public class setOnGenericMotionListener implements setDarkTextColor.valueOf {
    private final setDarkTextColor ThreeDS2ServiceInstance;

    public setOnGenericMotionListener(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.getName(this.ThreeDS2ServiceInstance);
    }
}
