...
public class setRotationY implements setDarkTextColor.valueOf {
    public static final setRotationY valueOf = new setRotationY();

    @Override // com.netcetera.threeds.sdk.infrastructure.setDarkTextColor.valueOf
    public getHeadingTextColor values() {
        return setDarkTextColor.setDrawingCacheQuality();
    }
}
