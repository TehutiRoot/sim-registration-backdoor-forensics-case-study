...
public class C9613nb {
    ...
    public C9613nb(boolean z, boolean z2) {
        this.initialize = z;
        this.getWarnings = z2;
    }
    ...
    public static C9613nb values(com.netcetera.threeds.sdk.api.configparameters.ConfigParameters configParameters) {
        Object[] objArr = new Object[1];
        ...
        C9613nb c9613nb = new C9613nb(Boolean.parseBoolean((String) C9669om.ThreeDS2Service(configParameters.getParamValue(null, ((String) objArr[0]).intern()), String.valueOf(Boolean.TRUE))), Boolean.parseBoolean((String) C9669om.ThreeDS2Service(configParameters.getParamValue(null, ((String) objArr2[0]).intern()), String.valueOf(Boolean.FALSE))));
    ...
    */
    private static void get(java.lang.String r12, int r13, java.lang.Object[] r14) {
        ...
        L28:
            ...
            int r9 = r8 + r4
            int r10 = r8 << 4
            char r11 = com.netcetera.threeds.sdk.infrastructure.C9613nb.ThreeDS2ServiceInstance     // Catch: java.lang.Throwable -> L5b
            int r10 = r10 + r11
            r9 = r9 ^ r10
            int r10 = r8 >>> 5
            char r11 = com.netcetera.threeds.sdk.infrastructure.C9613nb.ThreeDS2Service     // Catch: java.lang.Throwable -> L5b
            int r10 = r10 + r11
            r9 = r9 ^ r10
            int r7 = r7 - r9
            ...
            int r9 = r7 + r4
            int r10 = r7 << 4
            char r11 = com.netcetera.threeds.sdk.infrastructure.C9613nb.values     // Catch: java.lang.Throwable -> L5b
            int r10 = r10 + r11
            r9 = r9 ^ r10
            int r7 = r7 >>> 5
            char r10 = com.netcetera.threeds.sdk.infrastructure.C9613nb.valueOf     // Catch: java.lang.Throwable -> L5b
            int r7 = r7 + r10
            r7 = r7 ^ r9
            int r8 = r8 - r7
        ...
        L77:
            ...
            throw r12
        */
        throw new UnsupportedOperationException("Method not decompiled: com.netcetera.threeds.sdk.infrastructure.C9613nb.get(java.lang.String, int, java.lang.Object[]):void");
    }
}
