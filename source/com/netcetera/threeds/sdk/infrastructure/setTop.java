...
public class setTop implements setDarkTextColor.valueOf {
    public static final setTop valueOf = new setTop();

    @Override // com.netcetera.threeds.sdk.infrastructure.setDarkTextColor.valueOf
    public getHeadingTextColor values() {
        return setDarkTextColor.setSystemGestureExclusionRects();
    }
}
