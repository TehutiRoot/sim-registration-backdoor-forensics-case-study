...
abstract class AbstractC9721rf {
    protected SecureRandom get;
    protected String valueOf;

    public AbstractC9721rf(String str, SecureRandom secureRandom) {
        this.valueOf = str;
    ...
    public KeyPairGenerator valueOf() throws C9727rl {
        String ThreeDS2Service = ThreeDS2Service();
        try {
            ...
            throw new C9727rl("Couldn't find " + ThreeDS2Service + " KeyPairGenerator! " + e, e);
        } catch (NoSuchProviderException e2) {
            throw new C9727rl("Cannot get KeyPairGenerator instance with provider " + this.valueOf, e2);
        }
    }

    public KeyFactory values() throws C9727rl {
        String ThreeDS2Service = ThreeDS2Service();
        try {
            String str = this.valueOf;
            if (str == null) {
            ...
            throw new C9727rl("Couldn't find " + ThreeDS2Service + " KeyFactory! " + e, e);
        } catch (NoSuchProviderException e2) {
            throw new C9727rl("Cannot get KeyFactory instance with provider " + this.valueOf, e2);
        }
    }
}
