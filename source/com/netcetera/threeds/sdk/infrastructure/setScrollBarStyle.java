...
public class setScrollBarStyle implements setDarkTextColor.valueOf {
    private final setDarkTextColor ThreeDS2ServiceInstance;

    public setScrollBarStyle(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.Transaction$BridgingMessageExtensionVersion(this.ThreeDS2ServiceInstance);
    }
}
