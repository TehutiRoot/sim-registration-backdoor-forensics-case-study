...
public class setHasTransientState implements setDarkTextColor.valueOf {
    private final setDarkTextColor values;

    public setHasTransientState(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.getThreeDSRequestorAppURL(this.values);
    }
}
