...
public class setPressed implements setDarkTextColor.valueOf {
    private final setDarkTextColor values;

    public setPressed(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.SDKRuntimeException(this.values);
    }
}
