...
public abstract class ResourceReader implements ResourceIds {
    ...
    /* renamed from: b */
    public final Map f58627b = new HashMap();

    /* renamed from: c */
    public final SparseArray f58628c = new SparseArray();
    ...
    public static class Drawables extends ResourceReader {
        ...
        public String getLocalClassName(Context context) {
            return this.f58629d + ".R$drawable";
        }
    ...
    /* renamed from: a */
    public static void m33570a(Class cls, String str, Map map) {
        Field[] fields;
        try {
            ...
            MPLog.m33456e("MixpanelAPI.RsrcReader", "Can't read built-in id names from " + cls.getName(), e);
        }
    }
    ...
    public int idFromName(String str) {
        return ((Integer) this.f58627b.get(str)).intValue();
    }

    public void initialize() {
        this.f58627b.clear();
        this.f58628c.clear();
        m33570a(getSystemClass(), "android", this.f58627b);
        String localClassName = getLocalClassName(this.f58626a);
        try {
            m33570a(Class.forName(localClassName), null, this.f58627b);
        } catch (ClassNotFoundException unused) {
            MPLog.m33451w("MixpanelAPI.RsrcReader", "Can't load names for Android view ids from '" + localClassName + "', ids by name will not be available in the events editor.");
            MPLog.m33455i("MixpanelAPI.RsrcReader", "You may be missing a Resources class for your package due to your proguard configuration, or you may be using an applicationId in your build that isn't the same as the package declared in your AndroidManifest.xml file.\nIf you're using proguard, you can fix this issue by adding the following to your proguard configuration:\n\n-keep class **.R$* {\n    <fields>;\n}\n\nIf you're not using proguard, or if your proguard configuration already contains the directive above, you can add the following to your AndroidManifest.xml file to explicitly point the Mixpanel library to the appropriate library for your resources class:\n\n<meta-data android:name=\"com.mixpanel.android.MPConfig.ResourcePackageName\" android:value=\"YOUR_PACKAGE_NAME\" />\n\nwhere YOUR_PACKAGE_NAME is the same string you use for the \"package\" attribute in your <manifest> tag.");
        }
        for (Map.Entry entry : this.f58627b.entrySet()) {
            this.f58628c.put(((Integer) entry.getValue()).intValue(), entry.getKey());
        }
    }

    @Override // com.mixpanel.android.mpmetrics.ResourceIds
    public boolean knownIdName(String str) {
        return this.f58627b.containsKey(str);
    }

    @Override // com.mixpanel.android.mpmetrics.ResourceIds
    public String nameForId(int i) {
        return (String) this.f58628c.get(i);
    }
}
