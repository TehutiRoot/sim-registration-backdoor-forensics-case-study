...
public class Draft_76 extends Draft_75 {
    ...
    /* renamed from: d */
    public static final byte[] f58446d = {-1, 0};

    /* renamed from: b */
    public boolean f58447b = false;

    /* renamed from: c */
    public final Random f58448c = new Random();

    /* renamed from: a */
    public static String m33684a() {
    ...
    /* renamed from: b */
    public static byte[] m33683b(String str) {
        try {
    ...
    public static byte[] createChallenge(String str, String str2, byte[] bArr) throws InvalidHandshakeException {
        byte[] m33683b = m33683b(str);
        byte[] m33683b2 = m33683b(str2);
        try {
            return MessageDigest.getInstance(MessageDigestAlgorithms.MD5).digest(new byte[]{m33683b[0], m33683b[1], m33683b[2], m33683b[3], m33683b2[0], m33683b2[1], m33683b2[2], m33683b2[3], bArr[0], bArr[1], bArr[2], bArr[3], bArr[4], bArr[5], bArr[6], bArr[7]});
    ...
    public ByteBuffer createBinaryFrame(Framedata framedata) {
        if (framedata.getOpcode() == Framedata.Opcode.CLOSING) {
            return ByteBuffer.wrap(f58446d);
        }
    ...
    public ClientHandshakeBuilder postProcessHandshakeRequestAsClient(ClientHandshakeBuilder clientHandshakeBuilder) {
        ...
        clientHandshakeBuilder.put("Sec-WebSocket-Key1", m33684a());
        clientHandshakeBuilder.put("Sec-WebSocket-Key2", m33684a());
        if (!clientHandshakeBuilder.hasFieldValue(HttpHeaders.ORIGIN)) {
            clientHandshakeBuilder.put(HttpHeaders.ORIGIN, "random" + this.f58448c.nextInt());
        }
        byte[] bArr = new byte[8];
        this.f58448c.nextBytes(bArr);
            ...
            if (this.currentFrame == null) {
                ...
                if (byteBuffer.remaining() <= this.currentFrame.remaining()) {
                    ...
                    if (!this.currentFrame.hasRemaining()) {
                        if (Arrays.equals(this.currentFrame.array(), f58446d)) {
