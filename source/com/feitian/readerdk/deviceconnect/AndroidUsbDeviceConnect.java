...
public class AndroidUsbDeviceConnect implements IDeviceConnect {
    ...
    /* renamed from: a */
    public UsbManager f43551a;

    /* renamed from: b */
    public UsbDevice f43552b;

    /* renamed from: c */
    public UsbInterface f43553c;

    /* renamed from: g */
    public UsbEndpoint f43557g;

    /* renamed from: h */
    public UsbEndpoint f43558h;

    /* renamed from: i */
    public UsbEndpoint f43559i;

    /* renamed from: j */
    public Handler f43560j;
    ...
    /* renamed from: f */
    public boolean f43556f = true;

    /* renamed from: l */
    public AndroidUsbDeviceConnect f43562l = null;

    /* renamed from: k */
    public C6153a f43561k = new C6153a();

    /* renamed from: com.feitian.readerdk.deviceconnect.AndroidUsbDeviceConnect$a */
    /* loaded from: classes3.dex */
    public class C6153a extends Thread {
        ...
        public void run() {
            while (true) {
                ...
                if (androidUsbDeviceConnect.f43560j != null) {
                    int checkCardStatues = androidUsbDeviceConnect.checkCardStatues(0);
                    this.f43563a = checkCardStatues;
                    if (checkCardStatues == 61441) {
                        return;
                    }
                    if (3 == checkCardStatues) {
                        AndroidUsbDeviceConnect.this.f43560j.obtainMessage(C6150DK.CARD_STATUS, 3, -1).sendToTarget();
                    } else if (1 == checkCardStatues) {
                        AndroidUsbDeviceConnect.this.f43560j.obtainMessage(C6150DK.CARD_STATUS, 1, -1).sendToTarget();
                    } else {
                        AndroidUsbDeviceConnect.this.f43560j.obtainMessage(C6150DK.CARD_STATUS, 2, -1).sendToTarget();
                    }
                } else {
                    return;
                }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:12:0x002f, code lost:
        return com.feitian.readerdk.Tool.C6150DK.RETURN_ERROR;
     */
    ...
    */
    public int IDeviceRead(byte[] r7, int[] r8) {
        ...
        L0:
            ...
            android.hardware.usb.UsbEndpoint r3 = r6.f43557g     // Catch: java.lang.Exception -> L31
            ...
            java.lang.String r4 = com.feitian.readerdk.Tool.C6151Tool.byte2HexStr(r7, r2)     // Catch: java.lang.Exception -> L31
            r6.m49343a(r3, r4)     // Catch: java.lang.Exception -> L31
            r3 = 10
            if (r2 >= r3) goto L1f
            return r0
        L1f:
    ...
    public int IDeviceWrite(byte[] bArr, int i) {
        try {
            m49343a("usb write", C6151Tool.byte2HexStr(bArr, i));
            this.mConnection.bulkTransfer(this.f43558h, bArr, i, Constants.MAX_URL_LENGTH);
            return 0;
    ...
    /* renamed from: a */
    public void m49343a(String str, String str2) {
    }

    public int checkCardStatues(int i) {
        byte[] bArr = new byte[16];
        try {
            if (this.mConnection.bulkTransfer(this.f43559i, bArr, 16, i) == 2) {
                byte b = bArr[1];
                if ((b & 255) == 2) {
                    return 3;
                }
    ...
    public int close() {
        ...
        if (usbDeviceConnection != null) {
            usbDeviceConnection.releaseInterface(this.f43553c);
    ...
    public int getProductId() {
        UsbDevice usbDevice = this.f43552b;
        if (usbDevice == null) {
            return C6150DK.RETURN_ERROR;
        }
    ...
    public int open() {
        int i;
        if (this.f43552b.getVendorId() != 2414) {
            return 61443;
        }
        close();
        UsbInterface usbInterface = this.f43552b.getInterface(0);
        this.f43553c = usbInterface;
        ...
        while (true) {
            ...
            UsbEndpoint endpoint = this.f43553c.getEndpoint(i2);
            int direction = endpoint.getDirection();
            int type = endpoint.getType();
            if (2 == type) {
                if (direction == 0) {
                    this.f43558h = endpoint;
                } else if (128 == direction) {
                    this.f43557g = endpoint;
                }
            } else if (3 == type && 128 == direction) {
                this.f43559i = endpoint;
            }
            i2++;
        }
        if (this.f43557g == null || this.f43558h == null) {
            return C6150DK.RETURN_ERROR;
        }
        UsbDeviceConnection openDevice = this.f43551a.openDevice(this.f43552b);
        this.mConnection = openDevice;
        if (openDevice == null) {
            return C6150DK.RETURN_ERROR;
        }
        openDevice.claimInterface(this.f43553c, true);
        byte[] bArr = new byte[256];
        int controlTransfer = this.mConnection.controlTransfer(128, 6, 769, 0, bArr, 256, Constants.MAX_URL_LENGTH);
        this.f43555e = "";
        if (controlTransfer < 2) {
            this.f43555e = String.valueOf("") + "FT CCID Card";
        } else if ((bArr[1] & 255) == 3) {
            for (int i3 = 2; i3 < (bArr[0] & 255); i3 += 2) {
                this.f43555e = String.valueOf(this.f43555e) + ((char) bArr[i3]);
            }
        } else {
            this.f43555e = String.valueOf("") + "FT CCID Card";
        }
        if (this.mConnection.controlTransfer(128, 6, 770, 0, bArr, 256, Constants.MAX_URL_LENGTH) < 2) {
            this.f43554d = String.valueOf(this.f43554d) + EnvironmentCompat.MEDIA_UNKNOWN;
        } else if ((bArr[1] & 255) == 3) {
            for (i = 2; i < (bArr[0] & 255); i += 2) {
                this.f43554d = String.valueOf(this.f43554d) + ((char) bArr[i]);
            }
        } else {
            this.f43554d = String.valueOf(this.f43554d) + EnvironmentCompat.MEDIA_UNKNOWN;
        }
