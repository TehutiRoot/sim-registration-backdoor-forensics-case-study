...
import com.fasterxml.jackson.core.p011io.SegmentedStringWriter;
...
public class ObjectMapper extends ObjectCodec implements Versioned, Serializable {
    ...
    public static class DefaultTypeResolverBuilder extends StdTypeResolverBuilder implements Serializable {
        ...
        public boolean useForType(JavaType javaType) {
            ...
            int i = C6084c.f43272a[this._appliesFor.ordinal()];
            if (i != 1) {
                if (i != 2) {
                    if (i != 3) {
    ...
    /* loaded from: classes3.dex */
    public class C6082a implements Module.SetupContext {
        public C6082a() {
        }
    ...
    /* loaded from: classes3.dex */
    public static class C6083b implements PrivilegedAction {

        /* renamed from: a */
        public final /* synthetic */ ClassLoader f43270a;

        /* renamed from: b */
        public final /* synthetic */ Class f43271b;

        public C6083b(ClassLoader classLoader, Class cls) {
            this.f43270a = classLoader;
            this.f43271b = cls;
        }
        ...
        public ServiceLoader run() {
            ClassLoader classLoader = this.f43270a;
            if (classLoader == null) {
                return ServiceLoader.load(this.f43271b);
            }
            return ServiceLoader.load(this.f43271b, classLoader);
        }
    }

    /* renamed from: com.fasterxml.jackson.databind.ObjectMapper$c */
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C6084c {
        ...
        static {
            ...
            try {
                f43272a[DefaultTyping.OBJECT_AND_NON_CONCRETE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f43272a[DefaultTyping.NON_FINAL.ordinal()] = 3;
    ...
    private static <T> ServiceLoader<T> secureGetServiceLoader(Class<T> cls, ClassLoader classLoader) {
        ...
        return (ServiceLoader) AccessController.doPrivileged(new C6083b(classLoader, cls));
    }
    ...
    public JsonNode _readTreeAndClose(JsonParser jsonParser) throws IOException {
        ...
        try {
            ...
            if (currentToken == null && (currentToken = jsonParser.nextToken()) == null) {
                ...
                JsonDeserializer<Object> _findRootDeserializer = _findRootDeserializer(createDeserializationContext, javaType);
                if (deserializationConfig.useRootWrapping()) {
                    deserialize = _unwrapAndDeserialize(jsonParser, createDeserializationContext, deserializationConfig, javaType, _findRootDeserializer);
                } else {
                    deserialize = _findRootDeserializer.deserialize(jsonParser, createDeserializationContext);
                    if (deserializationConfig.isEnabled(DeserializationFeature.FAIL_ON_TRAILING_TOKENS)) {
                        _verifyNoTrailingTokens(jsonParser, createDeserializationContext, javaType);
                    }
                }
    ...
    public ObjectMapper enableDefaultTypingAsProperty(DefaultTyping defaultTyping, String str) {
        return setDefaultTyping(new DefaultTypeResolverBuilder(defaultTyping).init(JsonTypeInfo.EnumC6075Id.CLASS, (TypeIdResolver) null).inclusion(JsonTypeInfo.EnumC6074As.PROPERTY).typeProperty(str));
    }
    ...
    public <T> T treeToValue(TreeNode treeNode, Class<T> cls) throws JsonProcessingException {
        ...
        if (treeNode.asToken() == JsonToken.VALUE_EMBEDDED_OBJECT && (treeNode instanceof POJONode) && ((t = (T) ((POJONode) treeNode).getPojo()) == null || cls.isInstance(t))) {
            return t;
        }
    ...
    public ObjectMapper enableDefaultTyping(DefaultTyping defaultTyping) {
        return enableDefaultTyping(defaultTyping, JsonTypeInfo.EnumC6074As.WRAPPER_ARRAY);
    }
    ...
    public ObjectMapper enableDefaultTyping(DefaultTyping defaultTyping, JsonTypeInfo.EnumC6074As enumC6074As) {
        if (enumC6074As != JsonTypeInfo.EnumC6074As.EXTERNAL_PROPERTY) {
            return setDefaultTyping(new DefaultTypeResolverBuilder(defaultTyping).init(JsonTypeInfo.EnumC6075Id.CLASS, (TypeIdResolver) null).inclusion(enumC6074As));
        }
        throw new IllegalArgumentException("Cannot use includeAs of " + enumC6074As);
    }
