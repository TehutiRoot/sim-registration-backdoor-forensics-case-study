...
public abstract class JsonNode extends JsonSerializable.Base implements TreeNode, Iterable<JsonNode> {
    ...
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C6081a {
        ...
        static {
            ...
            try {
                f43268a[JsonNodeType.OBJECT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f43268a[JsonNodeType.MISSING.ordinal()] = 3;
    ...
    public final boolean isValueNode() {
        int i = C6081a.f43268a[getNodeType().ordinal()];
        if (i != 1 && i != 2 && i != 3) {
            return true;
        }
        return false;
    ...
    @Override // com.fasterxml.jackson.core.TreeNode
    /* renamed from: at */
    public final JsonNode mo49492at(JsonPointer jsonPointer) {
        ...
        return _at.mo49492at(jsonPointer.tail());
    }
    ...
    @Override // com.fasterxml.jackson.core.TreeNode
    /* renamed from: at */
    public final JsonNode mo49491at(String str) {
        return mo49492at(JsonPointer.compile(str));
    }
}
