...
public abstract class PrimitiveArrayDeserializers<T> extends StdDeserializer<T> implements ContextualDeserializer {
    ...
    public static final class ByteDeser extends PrimitiveArrayDeserializers<byte[]> {
        ...
        /* JADX WARN: Removed duplicated region for block: B:45:0x008d A[Catch: Exception -> 0x007a, TRY_LEAVE, TryCatch #2 {Exception -> 0x007a, blocks: (B:26:0x005d, B:28:0x0065, B:30:0x0069, B:33:0x006e, B:35:0x0072, B:37:0x0076, B:40:0x007c, B:43:0x008a, B:45:0x008d, B:41:0x0081, B:42:0x0086), top: B:60:0x005d }] */
        @Override // com.fasterxml.jackson.databind.JsonDeserializer
        /*
        ...
        */
        public byte[] deserialize(com.fasterxml.jackson.core.JsonParser r7, com.fasterxml.jackson.databind.DeserializationContext r8) throws java.io.IOException {
            ...
            L4e:
                ...
                r3 = 0
            L5d:
                com.fasterxml.jackson.core.JsonToken r4 = r7.nextToken()     // Catch: java.lang.Exception -> L7a
                com.fasterxml.jackson.core.JsonToken r5 = com.fasterxml.jackson.core.JsonToken.END_ARRAY     // Catch: java.lang.Exception -> L7a
                if (r4 == r5) goto L9e
                com.fasterxml.jackson.core.JsonToken r5 = com.fasterxml.jackson.core.JsonToken.VALUE_NUMBER_INT     // Catch: java.lang.Exception -> L7a
                if (r4 == r5) goto L86
                com.fasterxml.jackson.core.JsonToken r5 = com.fasterxml.jackson.core.JsonToken.VALUE_NUMBER_FLOAT     // Catch: java.lang.Exception -> L7a
                if (r4 != r5) goto L6e
                goto L86
            L6e:
                com.fasterxml.jackson.core.JsonToken r5 = com.fasterxml.jackson.core.JsonToken.VALUE_NULL     // Catch: java.lang.Exception -> L7a
                if (r4 != r5) goto L81
                com.fasterxml.jackson.databind.deser.NullValueProvider r4 = r6._nuller     // Catch: java.lang.Exception -> L7a
                if (r4 == 0) goto L7c
            ...
            L7a:
                ...
                goto La5
            L7c:
                r6._verifyNullForPrimitive(r8)     // Catch: java.lang.Exception -> L7a
                r4 = 0
                goto L8a
            L81:
                byte r4 = r6._parseBytePrimitive(r7, r8)     // Catch: java.lang.Exception -> L7a
                goto L8a
            L86:
            ...
            L8a:
                ...
                if (r3 < r5) goto L95
                java.lang.Object r5 = r0.appendCompletedChunk(r1, r3)     // Catch: java.lang.Exception -> L7a
