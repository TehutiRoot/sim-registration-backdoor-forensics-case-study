...
public class NumberDeserializers {
    ...
    /* renamed from: a */
    public static final HashSet f43319a = new HashSet();
    ...
    public static class BigIntegerDeserializer extends StdScalarDeserializer<BigInteger> {
        ...
        public BigInteger deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
            ...
            if (currentTokenId != 3) {
                if (currentTokenId != 6) {
                    if (currentTokenId == 7) {
                        int i = C6097a.f43320a[jsonParser.getNumberType().ordinal()];
                        if (i == 1 || i == 2 || i == 3) {
    ...
    public static /* synthetic */ class C6097a {
        ...
        static {
            ...
            try {
                f43320a[JsonParser.NumberType.LONG.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f43320a[JsonParser.NumberType.BIG_INTEGER.ordinal()] = 3;
