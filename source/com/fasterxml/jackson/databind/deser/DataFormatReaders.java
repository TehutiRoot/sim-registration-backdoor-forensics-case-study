...
public class DataFormatReaders {
    ...
    /* renamed from: a */
    public final Match m49480a(AccessorForReader accessorForReader) {
    ...
    public Match findFormat(InputStream inputStream) throws IOException {
        return m49480a(new AccessorForReader(inputStream, new byte[this._maxInputLookahead]));
    }
    ...
    public Match findFormat(byte[] bArr) throws IOException {
        return m49480a(new AccessorForReader(bArr));
    }
    ...
    public Match findFormat(byte[] bArr, int i, int i2) throws IOException {
        return m49480a(new AccessorForReader(bArr, i, i2));
    }
}
