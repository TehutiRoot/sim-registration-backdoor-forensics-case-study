...
public class BeanDeserializer extends BeanDeserializerBase implements Serializable {
    ...
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C6087a {
        ...
        static {
            ...
            try {
                f43275a[JsonToken.VALUE_NUMBER_INT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f43275a[JsonToken.VALUE_NUMBER_FLOAT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f43275a[JsonToken.VALUE_EMBEDDED_OBJECT.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f43275a[JsonToken.VALUE_TRUE.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f43275a[JsonToken.VALUE_FALSE.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f43275a[JsonToken.VALUE_NULL.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f43275a[JsonToken.START_ARRAY.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f43275a[JsonToken.FIELD_NAME.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f43275a[JsonToken.END_OBJECT.ordinal()] = 10;
    ...
    /* loaded from: classes3.dex */
    public static class C6088b extends ReadableObjectId.Referring {

        /* renamed from: c */
        public final DeserializationContext f43276c;

        /* renamed from: d */
        public final SettableBeanProperty f43277d;

        /* renamed from: e */
        public Object f43278e;

        public C6088b(DeserializationContext deserializationContext, UnresolvedForwardReference unresolvedForwardReference, JavaType javaType, PropertyValueBuffer propertyValueBuffer, SettableBeanProperty settableBeanProperty) {
            super(unresolvedForwardReference, javaType);
            this.f43276c = deserializationContext;
            this.f43277d = settableBeanProperty;
        }

        /* renamed from: a */
        public void m49483a(Object obj) {
            this.f43278e = obj;
        }
        ...
        public void handleResolvedForwardReference(Object obj, Object obj2) {
            if (this.f43278e == null) {
                DeserializationContext deserializationContext = this.f43276c;
                SettableBeanProperty settableBeanProperty = this.f43277d;
                deserializationContext.reportInputMismatch(settableBeanProperty, "Cannot resolve ObjectId forward reference using property '%s' (of type %s): Bean not yet resolved", settableBeanProperty.getName(), this.f43277d.getDeclaringClass().getName());
            }
            this.f43277d.set(this.f43278e, obj2);
        }
    }
    ...
    private C6088b handleUnresolvedReference(DeserializationContext deserializationContext, SettableBeanProperty settableBeanProperty, PropertyValueBuffer propertyValueBuffer, UnresolvedForwardReference unresolvedForwardReference) throws JsonMappingException {
        C6088b c6088b = new C6088b(deserializationContext, unresolvedForwardReference, settableBeanProperty.getType(), propertyValueBuffer, settableBeanProperty);
        unresolvedForwardReference.getRoid().appendReferring(c6088b);
        return c6088b;
    }
    ...
    public final Object _deserializeOther(JsonParser jsonParser, DeserializationContext deserializationContext, JsonToken jsonToken) throws IOException {
        switch (C6087a.f43275a[jsonToken.ordinal()]) {
            case 1:
    ...
    public Object _deserializeUsingPropertyBased(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        ArrayList<C6088b> arrayList = null;
        ...
        while (currentToken == JsonToken.FIELD_NAME) {
            ...
            if (!startBuilding.readIdProperty(currentName)) {
                ...
                if (findCreatorProperty != null) {
                    if (cls != null && !findCreatorProperty.visibleInView(cls)) {
                    ...
                    if (find != null) {
                        try {
                            ...
                            C6088b handleUnresolvedReference = handleUnresolvedReference(deserializationContext, find, startBuilding, e2);
                            if (arrayList == null) {
    ...
    public Object deserializeFromNull(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        if (jsonParser.requiresCustomCodec()) {
            ...
            asParser.nextToken();
            if (this._vanillaProcessing) {
                deserializeFromObject = vanillaDeserialize(asParser, deserializationContext, JsonToken.END_OBJECT);
            } else {
    ...
    public JsonDeserializer<Object> unwrappingDeserializer(NameTransformer nameTransformer) {
        ...
        if (this._currentlyTransforming == nameTransformer) {
            return this;
        }
