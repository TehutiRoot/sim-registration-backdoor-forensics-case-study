...
public abstract class BasicDeserializerFactory extends DeserializerFactory implements Serializable {
    ...
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C6086a {
        ...
        static {
            ...
            try {
                f43274a[JsonCreator.Mode.PROPERTIES.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f43274a[JsonCreator.Mode.DEFAULT.ordinal()] = 3;
    ...
    private JavaType _mapAbstractType2(DeserializationConfig deserializationConfig, JavaType javaType) throws JsonMappingException {
        ...
        if (this._factoryConfig.hasAbstractTypeResolvers()) {
            for (AbstractTypeResolver abstractTypeResolver : this._factoryConfig.abstractTypeResolvers()) {
                ...
                if (ClassUtil.rawClass(findTypeMapping) != rawClass) {
    ...
    */
    public void _addDeserializerConstructors(com.fasterxml.jackson.databind.DeserializationContext r29, com.fasterxml.jackson.databind.BeanDescription r30, com.fasterxml.jackson.databind.introspect.VisibilityChecker<?> r31, com.fasterxml.jackson.databind.AnnotationIntrospector r32, com.fasterxml.jackson.databind.deser.impl.CreatorCollector r33, java.util.Map<com.fasterxml.jackson.databind.introspect.AnnotatedWithParams, com.fasterxml.jackson.databind.introspect.BeanPropertyDefinition[]> r34) throws com.fasterxml.jackson.databind.JsonMappingException {
        /*
    ...
    public void _addDeserializerFactoryMethods(DeserializationContext deserializationContext, BeanDescription beanDescription, VisibilityChecker<?> visibilityChecker, AnnotationIntrospector annotationIntrospector, CreatorCollector creatorCollector, Map<AnnotatedWithParams, BeanPropertyDefinition[]> map) throws JsonMappingException {
        ...
        while (true) {
            ...
            if (findCreatorAnnotation == null) {
                if (parameterCount == 1 && visibilityChecker.isCreatorVisible(next)) {
                ...
                if (parameterCount == 0) {
                    ...
                    int i4 = C6086a.f43274a[findCreatorAnnotation.ordinal()];
                    if (i4 != 1) {
                        if (i4 != 2) {
                ...
                if (!_checkIfCreatorPropertyBased(annotationIntrospector, creator, propertyDef)) {
                    ...
                    while (i5 < paramCount) {
                        ...
                        if (beanPropertyDefinitionArr == null) {
                            beanPropertyDefinition = annotatedParameter;
                        } else {
                        ...
                        if (beanPropertyDefinition == 0) {
                            fullName = annotatedParameter;
                        } else {
    ...
    public SettableBeanProperty constructCreatorProperty(DeserializationContext deserializationContext, BeanDescription beanDescription, PropertyName propertyName, int i, AnnotatedParameter annotatedParameter, JacksonInject.Value value) throws JsonMappingException {
        ...
        CreatorProperty creatorProperty = new CreatorProperty(propertyName, resolveMemberAndTypeAnnotations, std.getWrapperName(), typeDeserializer2, beanDescription.getClassAnnotations(), annotatedParameter, i, id2, propertyMetadata);
        ...
        if (findDeserializerFromAnnotation != null) {
            return creatorProperty.withValueDeserializer(deserializationContext.handlePrimaryContextualization(findDeserializerFromAnnotation, creatorProperty, resolveMemberAndTypeAnnotations));
        }
    ...
    public JsonDeserializer<?> createCollectionDeserializer(DeserializationContext deserializationContext, CollectionType collectionType, BeanDescription beanDescription) throws JsonMappingException {
        ...
        if (_findCustomCollectionDeserializer == null) {
            ...
            if (_findCustomCollectionDeserializer == null) {
                ...
                if (!findValueInstantiator.canCreateUsingDefault() && collectionType.hasRawClass(ArrayBlockingQueue.class)) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:25:0x0091, code lost:
        if (r21.isAbstract() != false) goto L28;
     */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    /* JADX WARN: Type inference failed for: r0v19, types: [com.fasterxml.jackson.databind.deser.std.EnumMapDeserializer] */
    ...
    /* JADX WARN: Type inference failed for: r0v6, types: [com.fasterxml.jackson.databind.JsonDeserializer] */
