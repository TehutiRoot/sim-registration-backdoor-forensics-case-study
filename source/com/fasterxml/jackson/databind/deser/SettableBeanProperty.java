...
public abstract class SettableBeanProperty extends ConcreteBeanPropertyBase implements Serializable {
    ...
    public SettableBeanProperty withSimpleName(String str) {
        PropertyName withSimpleName;
        PropertyName propertyName = this._propName;
        if (propertyName == null) {
            withSimpleName = new PropertyName(str);
        } else {
            withSimpleName = propertyName.withSimpleName(str);
        }
        if (withSimpleName == this._propName) {
            return this;
        }
        return withName(withSimpleName);
    }
