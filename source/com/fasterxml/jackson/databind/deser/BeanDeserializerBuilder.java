...
public class BeanDeserializerBuilder {
    ...
    /* renamed from: a */
    public static HashMap m49482a(HashMap hashMap) {
        if (hashMap == null) {
            return null;
        }
    ...
    /* renamed from: b */
    public static List m49481b(List list) {
        if (list == null) {
            return null;
        }
    ...
    public void addInjectable(PropertyName propertyName, JavaType javaType, Annotations annotations, AnnotatedMember annotatedMember, Object obj) {
        ...
        if (canOverrideAccessModifiers && this._config.isEnabled(MapperFeature.OVERRIDE_PUBLIC_ACCESS_MODIFIERS)) {
            z = true;
        } else {
            z = false;
        }
    ...
    public BeanDeserializerBuilder(BeanDeserializerBuilder beanDeserializerBuilder) {
        ...
        this._injectables = m49481b(beanDeserializerBuilder._injectables);
        this._backRefProperties = m49482a(beanDeserializerBuilder._backRefProperties);
