                    ...
                    if (startBuilding.assignParameter(findCreatorProperty, findCreatorProperty.deserialize(jsonParser, deserializationContext))) {
                        try {
                            ...
                            if (obj.getClass() != this._beanType.getRawClass()) {
                                ...
                                return deserializationContext.reportBadDefinition(javaType, String.format("Cannot support implicit polymorphic deserialization for POJOs-as-Arrays style: nominal type %s, actual type %s", javaType.getRawClass().getName(), obj.getClass().getName()));
                            }
                        } catch (Exception e2) {
