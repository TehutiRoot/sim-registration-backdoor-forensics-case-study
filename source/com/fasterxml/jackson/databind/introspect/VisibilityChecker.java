...
public interface VisibilityChecker<T extends VisibilityChecker<T>> {
    ...
    public static class Std implements VisibilityChecker<Std>, Serializable {
        ...
        public Std withVisibility(PropertyAccessor propertyAccessor, JsonAutoDetect.Visibility visibility) {
            switch (C6116a.f43366a[propertyAccessor.ordinal()]) {
                case 1:
    ...
    /* renamed from: com.fasterxml.jackson.databind.introspect.VisibilityChecker$a */
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C6116a {
        ...
        static {
            ...
            try {
                f43366a[PropertyAccessor.SETTER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f43366a[PropertyAccessor.CREATOR.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f43366a[PropertyAccessor.FIELD.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f43366a[PropertyAccessor.IS_GETTER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f43366a[PropertyAccessor.ALL.ordinal()] = 6;
