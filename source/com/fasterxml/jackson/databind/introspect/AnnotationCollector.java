...
public abstract class AnnotationCollector {
    ...
    /* loaded from: classes3.dex */
    public static class C6100a extends AnnotationCollector {

        /* renamed from: a */
        public static final C6100a f43342a = new C6100a(null);

        public C6100a(Object obj) {
            super(obj);
        }

        @Override // com.fasterxml.jackson.databind.introspect.AnnotationCollector
        public AnnotationCollector addOrOverride(Annotation annotation) {
            return new C6102c(this._data, annotation.annotationType(), annotation);
        }
    ...
    /* loaded from: classes3.dex */
    public static class C6101b extends AnnotationCollector {

        /* renamed from: a */
        public final HashMap f43343a;

        public C6101b(Object obj, Class cls, Annotation annotation, Class cls2, Annotation annotation2) {
            super(obj);
            HashMap hashMap = new HashMap();
            this.f43343a = hashMap;
        ...
        @Override // com.fasterxml.jackson.databind.introspect.AnnotationCollector
        public AnnotationCollector addOrOverride(Annotation annotation) {
            this.f43343a.put(annotation.annotationType(), annotation);
            return this;
        }
        ...
        public AnnotationMap asAnnotationMap() {
            ...
            for (Annotation annotation : this.f43343a.values()) {
        ...
        @Override // com.fasterxml.jackson.databind.introspect.AnnotationCollector
        public Annotations asAnnotations() {
            if (this.f43343a.size() == 2) {
                Iterator it = this.f43343a.entrySet().iterator();
            ...
            return new AnnotationMap(this.f43343a);
        }

        @Override // com.fasterxml.jackson.databind.introspect.AnnotationCollector
        public boolean isPresent(Annotation annotation) {
            return this.f43343a.containsKey(annotation.annotationType());
        }
    }

    /* renamed from: com.fasterxml.jackson.databind.introspect.AnnotationCollector$c */
    /* loaded from: classes3.dex */
    public static class C6102c extends AnnotationCollector {

        /* renamed from: a */
        public Class f43344a;

        /* renamed from: b */
        public Annotation f43345b;

        public C6102c(Object obj, Class cls, Annotation annotation) {
            super(obj);
            this.f43344a = cls;
            this.f43345b = annotation;
        }

        @Override // com.fasterxml.jackson.databind.introspect.AnnotationCollector
        public AnnotationCollector addOrOverride(Annotation annotation) {
            Class<? extends Annotation> annotationType = annotation.annotationType();
            Class<? extends Annotation> cls = this.f43344a;
            if (cls == annotationType) {
                this.f43345b = annotation;
                return this;
            }
            return new C6101b(this._data, cls, this.f43345b, annotationType, annotation);
        }

        @Override // com.fasterxml.jackson.databind.introspect.AnnotationCollector
        public AnnotationMap asAnnotationMap() {
            return AnnotationMap.m49441of(this.f43344a, this.f43345b);
        }

        @Override // com.fasterxml.jackson.databind.introspect.AnnotationCollector
        public Annotations asAnnotations() {
            return new OneAnnotation(this.f43344a, this.f43345b);
        }

        @Override // com.fasterxml.jackson.databind.introspect.AnnotationCollector
        public boolean isPresent(Annotation annotation) {
            if (annotation.annotationType() == this.f43344a) {
                return true;
            }
            return false;
        }
