...
public class JacksonAnnotationIntrospector extends AnnotationIntrospector implements Serializable {
    ...
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C6103a {
        ...
        static {
            ...
            try {
                f43347a[JsonSerialize.Inclusion.NON_NULL.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f43347a[JsonSerialize.Inclusion.NON_DEFAULT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f43347a[JsonSerialize.Inclusion.NON_EMPTY.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f43347a[JsonSerialize.Inclusion.DEFAULT_INCLUSION.ordinal()] = 5;
    ...
    private JsonInclude.Value _refinePropertyInclusion(Annotated annotated, JsonInclude.Value value) {
        ...
        if (jsonSerialize != null) {
            int i = C6103a.f43347a[jsonSerialize.include().ordinal()];
            if (i != 1) {
                if (i != 2) {
                    if (i != 3) {
                        if (i == 4) {
    ...
    public TypeResolverBuilder<?> _findTypeResolver(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) {
        ...
        if (jsonTypeResolver != null) {
            ...
            if (jsonTypeInfo.use() == JsonTypeInfo.EnumC6075Id.NONE) {
        ...
        JsonTypeInfo.EnumC6074As include = jsonTypeInfo.include();
        if (include == JsonTypeInfo.EnumC6074As.EXTERNAL_PROPERTY && (annotated instanceof AnnotatedClass)) {
            include = JsonTypeInfo.EnumC6074As.PROPERTY;
        }
    ...
    public JavaType refineDeserializationType(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) throws JsonMappingException {
        ...
        if (jsonDeserialize == null) {
            ...
            _classIfExplicit = _classIfExplicit(jsonDeserialize.m49485as());
        }
    ...
    public JavaType refineSerializationType(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) throws JsonMappingException {
        ...
        if (jsonSerialize == null) {
            ...
            _classIfExplicit = _classIfExplicit(jsonSerialize.m49484as());
        }
