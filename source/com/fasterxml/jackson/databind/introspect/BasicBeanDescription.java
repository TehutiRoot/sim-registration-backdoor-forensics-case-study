...
public class BasicBeanDescription extends BeanDescription {
    ...
    /* renamed from: a */
    public static final Class[] f43346a = new Class[0];
    ...
    public AnnotatedMember findAnyGetter() throws IllegalArgumentException {
        ...
        if (pOJOPropertiesCollector == null) {
            ...
            anyGetter = pOJOPropertiesCollector.getAnyGetter();
        }
        ...
        for (BeanPropertyDefinition beanPropertyDefinition : _properties()) {
            ...
            if (findReferenceType != null && findReferenceType.isBackReference()) {
                ...
                if (arrayList == null) {
                    ...
                    throw new IllegalArgumentException("Multiple back-reference properties with name '" + name + OperatorName.SHOW_TEXT_LINE);
                }
    ...
    public Class<?>[] findDefaultViews() {
        ...
        if (!this._defaultViewsResolved) {
            ...
            if (annotationIntrospector == null) {
                ...
                findViews = annotationIntrospector.findViews(this._classInfo);
            }
    ...
    public Set<String> getIgnoredPropertyNames() {
        ...
        POJOPropertiesCollector pOJOPropertiesCollector = this._propCollector;
        if (pOJOPropertiesCollector == null) {
            ignoredPropertyNames = null;
        } else {
            ignoredPropertyNames = pOJOPropertiesCollector.getIgnoredPropertyNames();
        }
