...
public abstract class DefaultSerializerProvider extends SerializerProvider implements Serializable {
    ...
    public JsonSchema generateJsonSchema(Class<?> cls) throws JsonMappingException {
        ...
        if (findValueSerializer instanceof SchemaAware) {
            defaultSchemaNode = ((SchemaAware) findValueSerializer).getSchema(this, null);
        } else {
    ...
    public boolean includeFilterSuppressNulls(Object obj) throws JsonMappingException {
        ...
        try {
            ...
            reportBadDefinition(obj.getClass(), String.format("Problem determining whether filter of type '%s' should filter out `null` values: (%s) %s", obj.getClass().getName(), th2.getClass().getName(), th2.getMessage()), th2);
            return false;
        }
    }
