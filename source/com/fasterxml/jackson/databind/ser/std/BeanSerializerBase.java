...
public abstract class BeanSerializerBase extends StdSerializer<Object> implements ContextualSerializer, ResolvableSerializer, JsonFormatVisitable, SchemaAware {
    ...
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C6133a {
        ...
        static {
            ...
            try {
                f43420a[JsonFormat.Shape.NUMBER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f43420a[JsonFormat.Shape.NUMBER_INT.ordinal()] = 3;
        ...
        if (findFormatOverrides != null && findFormatOverrides.hasShape()) {
            ...
            if (shape != JsonFormat.Shape.ANY && shape != this._serializationShape) {
                if (this._handledType.isEnum()) {
                    int i2 = C6133a.f43420a[shape.ordinal()];
                    if (i2 == 1 || i2 == 2 || i2 == 3) {
    ...
    public JsonNode getSchema(SerializerProvider serializerProvider, Type type) throws JsonMappingException {
        ...
        if (jsonSerializableSchema != null && (m49404id = jsonSerializableSchema.m49404id()) != null && m49404id.length() > 0) {
            createSchemaNode.put("id", m49404id);
        }
