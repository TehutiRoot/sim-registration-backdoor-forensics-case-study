...
public class MapSerializer extends ContainerSerializer<Map<?, ?>> implements ContextualSerializer {
    ...
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C6135a {
        ...
        static {
            ...
            try {
                f43423a[JsonInclude.Include.NON_ABSENT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f43423a[JsonInclude.Include.NON_EMPTY.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f43423a[JsonInclude.Include.CUSTOM.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f43423a[JsonInclude.Include.NON_NULL.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f43423a[JsonInclude.Include.ALWAYS.ordinal()] = 6;
