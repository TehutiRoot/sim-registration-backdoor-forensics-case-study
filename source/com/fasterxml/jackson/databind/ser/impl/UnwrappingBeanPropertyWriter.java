...
public class UnwrappingBeanPropertyWriter extends BeanPropertyWriter implements Serializable {
    ...
    /* loaded from: classes3.dex */
    public class C6132a extends JsonFormatVisitorWrapper.Base {

        /* renamed from: a */
        public final /* synthetic */ JsonObjectFormatVisitor f43417a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C6132a(SerializerProvider serializerProvider, JsonObjectFormatVisitor jsonObjectFormatVisitor) {
            super(serializerProvider);
            this.f43417a = jsonObjectFormatVisitor;
        }
    ...
    public void depositSchemaProperty(JsonObjectFormatVisitor jsonObjectFormatVisitor, SerializerProvider serializerProvider) throws JsonMappingException {
        ...
        if (unwrappingSerializer.isUnwrappingSerializer()) {
            unwrappingSerializer.acceptJsonFormatVisitor(new C6132a(serializerProvider, jsonObjectFormatVisitor), getType());
        } else {
