...
public class AsPropertyTypeDeserializer extends AsArrayTypeDeserializer {
    ...
    protected final JsonTypeInfo.EnumC6074As _inclusion;
    ...
    public AsPropertyTypeDeserializer(JavaType javaType, TypeIdResolver typeIdResolver, String str, boolean z, JavaType javaType2) {
        this(javaType, typeIdResolver, str, z, javaType2, JsonTypeInfo.EnumC6074As.PROPERTY);
    }
    ...
    public AsPropertyTypeDeserializer(JavaType javaType, TypeIdResolver typeIdResolver, String str, boolean z, JavaType javaType2, JsonTypeInfo.EnumC6074As enumC6074As) {
        super(javaType, typeIdResolver, str, z, javaType2);
        this._inclusion = enumC6074As;
    }
