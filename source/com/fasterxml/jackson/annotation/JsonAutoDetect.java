...
public @interface JsonAutoDetect {
    ...
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C6073a {

        /* renamed from: a */
        public static final /* synthetic */ int[] f43094a;

        /* renamed from: b */
        public static final /* synthetic */ int[] f43095b;
        ...
        static {
            ...
            try {
                f43095b[PropertyAccessor.FIELD.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f43095b[PropertyAccessor.GETTER.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f43095b[PropertyAccessor.IS_GETTER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f43095b[PropertyAccessor.NONE.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f43095b[PropertyAccessor.SETTER.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f43095b[PropertyAccessor.ALL.ordinal()] = 7;
            ...
            try {
                f43094a[Visibility.NONE.ordinal()] = 2;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f43094a[Visibility.NON_PRIVATE.ordinal()] = 3;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f43094a[Visibility.PROTECTED_AND_PUBLIC.ordinal()] = 4;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f43094a[Visibility.PUBLIC_ONLY.ordinal()] = 5;
    ...
    public static class Value implements JacksonAnnotationValue<JsonAutoDetect>, Serializable {
        ...
        private static boolean _equals(Value value, Value value2) {
            if (value._fieldVisibility == value2._fieldVisibility && value._getterVisibility == value2._getterVisibility && value._isGetterVisibility == value2._isGetterVisibility && value._setterVisibility == value2._setterVisibility && value._creatorVisibility == value2._creatorVisibility) {
                return true;
            }
            return false;
        }
        ...
        public static Value construct(PropertyAccessor propertyAccessor, Visibility visibility) {
            ...
            int i = C6073a.f43095b[propertyAccessor.ordinal()];
            if (i != 1) {
                if (i == 2) {
