...
public final class JsonStringEncoder {
    ...
    /* renamed from: a */
    public static final char[] f43113a = CharTypes.copyHexChars();

    /* renamed from: b */
    public static final byte[] f43114b = CharTypes.copyHexBytes();

    /* renamed from: c */
    public static final JsonStringEncoder f43115c = new JsonStringEncoder();

    /* renamed from: d */
    public static int m49767d(int i, int i2) {
    ...
    /* renamed from: e */
    public static void m49766e(int i) {
    ...
    /* renamed from: a */
    public final int m49770a(int i, int i2, ByteArrayBuilder byteArrayBuilder, int i3) {
    ...
    /* renamed from: b */
    public final int m49769b(int i, char[] cArr) {
        cArr[1] = (char) i;
        return 2;
    }

    /* renamed from: c */
    public final int m49768c(int i, char[] cArr) {
    ...
    */
    public char[] quoteAsString(java.lang.String r13) {
        ...
        L24:
            ...
            r10 = r1[r7]
            if (r10 >= 0) goto L33
            int r7 = r12.m49768c(r7, r6)
            goto L37
        L33:
            int r7 = r12.m49769b(r10, r6)
        L37:
            int r10 = r8 + r7
            int r11 = r0.length
            if (r10 <= r11) goto L53
    ...
    public byte[] quoteAsUTF8(String str) {
        ...
        loop0: while (true) {
            ...
            if (charAt2 <= 127) {
                i5 = m49770a(charAt2, iArr[charAt2], byteArrayBuilder, i5);
                ...
                if (charAt2 <= 2047) {
                    ...
                    if (charAt2 >= 55296 && charAt2 <= 57343) {
                        ...
                        int i8 = i4 + 2;
                        int m49767d = m49767d(charAt2, str.charAt(i7));
                        if (m49767d > 1114111) {
                            m49766e(m49767d);
                        }
                        int i9 = i5 + 1;
                        bArr[i5] = (byte) ((m49767d >> 18) | C6150DK.ERROR_RECEIVE_LRC);
                        if (i9 >= bArr.length) {
                            bArr = byteArrayBuilder.finishCurrentSegment();
                            i9 = 0;
                        }
                        int i10 = i9 + 1;
                        bArr[i9] = (byte) (((m49767d >> 12) & 63) | 128);
                        if (i10 >= bArr.length) {
                            bArr = byteArrayBuilder.finishCurrentSegment();
                            i10 = 0;
                        }
                        int i11 = i10 + 1;
                        bArr[i10] = (byte) (((m49767d >> 6) & 63) | 128);
                        i2 = (m49767d & 63) | 128;
                        i = i11;
                        i7 = i8;
                    } else {
    ...
    */
    public void quoteAsString(java.lang.CharSequence r9, java.lang.StringBuilder r10) {
        ...
        L1e:
            ...
            r7 = r0[r5]
            if (r7 >= 0) goto L2d
            int r5 = r8.m49768c(r5, r4)
            goto L31
        L2d:
            int r5 = r8.m49769b(r7, r4)
        L31:
            r10.append(r4, r3, r5)
            r5 = r6
            goto Lc
