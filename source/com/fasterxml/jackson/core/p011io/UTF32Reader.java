...
public class UTF32Reader extends Reader {
    ...
    /* renamed from: NC */
    protected static final char f43134NC = 0;
    ...
    /* renamed from: d */
    public final boolean m49747d(int i) {
        int read;
        int read2;
    ...
    /* renamed from: g */
    public final void m49746g(char[] cArr, int i, int i2) {
        throw new ArrayIndexOutOfBoundsException("read(buf," + i + "," + i2 + "), cbuf[" + cArr.length + "]");
    }

    /* renamed from: i */
    public final void m49745i(int i, int i2, String str) {
    ...
    /* renamed from: j */
    public final void m49744j() {
        throw new IOException("Strange I/O stream, returned 0 bytes on read");
    }

    /* renamed from: k */
    public final void m49743k(int i, int i2) {
    ...
    public int read(char[] cArr, int i, int i2) throws IOException {
        ...
        if (c != 0) {
            ...
            if (i8 < 4 && !m49747d(i8)) {
                ...
                m49743k(this._length - this._ptr, 4);
            }
            i3 = i;
        }
        ...
        while (i3 < i7) {
            ...
            if (i4 != 0) {
                ...
                int i13 = i5 | ((i12 - 1) << 16);
                if (i12 > 16) {
                    m49745i(i13, i3 - i, String.format(" (above 0x%08x)", Integer.valueOf((int) LAST_VALID_UNICODE_CHAR)));
                }
                i6 = i3 + 1;
