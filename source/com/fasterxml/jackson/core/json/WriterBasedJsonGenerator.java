...
public class WriterBasedJsonGenerator extends JsonGeneratorImpl {
    ...
    /* renamed from: k */
    private int m49587k(InputStream inputStream, byte[] bArr, int i, int i2, int i3) {
        int i4 = 0;
        while (i < i2) {
            bArr[i4] = bArr[i];
            i4++;
    ...
    /* renamed from: q */
    private void m49581q(String str) {
    ...
    /* renamed from: r */
    private void m49580r(char[] cArr, int i, int i2) {
        if (this._outputTail >= this._outputEnd) {
            _flushBuffer();
        }
        char[] cArr2 = this._outputBuffer;
    ...
    */
    public final void m49597A(int r9, int r10) {
        /*
            r8 = this;
        ...
        L3a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.json.WriterBasedJsonGenerator.m49597A(int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void m49596B(char[] r9, int r10, int r11, int r12) {
        /*
            r8 = this;
            int r11 = r11 + r10
        ...
        L4f:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.json.WriterBasedJsonGenerator.m49596B(char[], int, int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void m49595C(int r12) {
        /*
            r11 = this;
        ...
        L52:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.json.WriterBasedJsonGenerator.m49595C(int):void");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void m49594D(char[] r11, int r12, int r13) {
        /*
            r10 = this;
            int r13 = r13 + r12
        ...
        L63:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.json.WriterBasedJsonGenerator.m49594D(char[], int, int):void");
    }

    /* renamed from: E */
    public final void m49593E(String str) {
    ...
    /* renamed from: g */
    public final void m49590g(char c, int i) {
        String value;
        int i2;
        if (i >= 0) {
            ...
            cArr2[i5] = '\\';
            int i6 = i5 + 2;
            cArr2[i5 + 1] = AbstractJsonLexerKt.UNICODE_ESC;
            if (c > 255) {
                int i7 = c >> '\b';
                int i8 = i5 + 3;
    ...
    /* renamed from: i */
    public final int m49589i(char[] cArr, int i, int i2, char c, int i3) {
        String value;
        int i4;
        if (i3 >= 0) {
            if (i > 1 && i < i2) {
    ...
    /* renamed from: j */
    public final void m49588j(char c, int i) {
        String value;
        int i2;
        if (i >= 0) {
            int i3 = this._outputTail;
            ...
            if (i5 >= 6) {
                ...
                this._outputHead = i6;
                cArr3[i6] = '\\';
                cArr3[i5 - 5] = AbstractJsonLexerKt.UNICODE_ESC;
                if (c > 255) {
                    int i7 = c >> '\b';
                    char[] cArr4 = HEX_CHARS;
    ...
    /* renamed from: l */
    public final void m49586l(SerializableString serializableString) {
    ...
    /* renamed from: m */
    public final void m49585m(String str) {
        _flushBuffer();
    ...
    /* renamed from: t */
    public final void m49578t(int i) {
        char[] cArr;
        char c;
        ...
        while (i2 < i) {
            ...
            i2++;
            i3 = m49589i(this._outputBuffer, i2, i, c, iArr[c]);
        }
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void m49577u(int r13, int r14) {
        /*
            r12 = this;
        ...
        L2d:
            ...
            r9 = r13
            r11 = r4
            int r3 = r6.m49589i(r7, r8, r9, r10, r11)
            goto Lc
        L3a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.json.WriterBasedJsonGenerator.m49577u(int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void m49576v(int r15) {
        /*
            r14 = this;
        ...
        L43:
            ...
            r11 = r15
            r13 = r6
            int r5 = r8.m49589i(r9, r10, r11, r12, r13)
            goto L16
        L50:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.json.WriterBasedJsonGenerator.m49576v(int):void");
    }

    /* renamed from: w */
    public final void m49575w(String str) {
        int length = str.length();
        int i = this._outputEnd;
        if (length > i) {
            m49585m(str);
    ...
    /* renamed from: x */
    public final void m49574x(char[] cArr, int i, int i2) {
        if (this._characterEscapes != null) {
            m49594D(cArr, i, i2);
            return;
        }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void m49573y(int r7) {
        /*
            r6 = this;
        ...
        L36:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.json.WriterBasedJsonGenerator.m49573y(int):void");
    }

    /* renamed from: z */
    public final void m49572z(SerializableString serializableString) {
        char[] asQuotedChars = serializableString.asQuotedChars();
    ...
    public void writeString(Reader reader, int i) throws IOException {
        ...
        this._outputTail = i3 + 1;
        cArr[i3] = this._quoteChar;
        char[] m49592b = m49592b();
        while (i2 > 0) {
            int read = reader.read(m49592b, 0, Math.min(i2, m49592b.length));
            if (read <= 0) {
                break;
            }
            if (this._outputTail + i >= this._outputEnd) {
    ...
    public final int _writeBinary(Base64Variant base64Variant, InputStream inputStream, byte[] bArr, int i) throws IOException, JsonGenerationException {
        ...
        while (true) {
            ...
            if (i6 > i4) {
                i7 = m49587k(inputStream, bArr, i6, i7, i5);
                if (i7 < 3) {
                    i6 = 0;
                    break;
                }
        ...
        if (i5 <= 0 || (m49587k = m49587k(inputStream, bArr, i6, i7, i5)) <= 0) {
            return i5;
        }
        if (this._outputTail > i2) {
            _flushBuffer();
    ...
    public final int _writeBinary(Base64Variant base64Variant, InputStream inputStream, byte[] bArr) throws IOException, JsonGenerationException {
        ...
        while (true) {
            if (i4 > i3) {
                i5 = m49587k(inputStream, bArr, i4, i5, bArr.length);
                if (i5 < 3) {
                    break;
                }
                i3 = i5 - 3;
