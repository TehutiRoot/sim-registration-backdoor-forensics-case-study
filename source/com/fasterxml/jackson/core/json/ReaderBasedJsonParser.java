...
public class ReaderBasedJsonParser extends ParserBase {
    ...
    /* renamed from: a */
    public static final int f43149a = JsonParser.Feature.ALLOW_TRAILING_COMMA.getMask();

    /* renamed from: b */
    public static final int f43150b = JsonParser.Feature.ALLOW_NUMERIC_LEADING_ZEROS.getMask();

    /* renamed from: c */
    public static final int f43151c = JsonParser.Feature.ALLOW_NON_NUMERIC_NUMBERS.getMask();

    /* renamed from: d */
    public static final int f43152d = JsonParser.Feature.ALLOW_MISSING_VALUES.getMask();

    /* renamed from: e */
    public static final int f43153e = JsonParser.Feature.ALLOW_SINGLE_QUOTES.getMask();

    /* renamed from: f */
    public static final int f43154f = JsonParser.Feature.ALLOW_UNQUOTED_FIELD_NAMES.getMask();

    /* renamed from: g */
    public static final int f43155g = JsonParser.Feature.ALLOW_COMMENTS.getMask();

    /* renamed from: h */
    public static final int f43156h = JsonParser.Feature.ALLOW_YAML_COMMENTS.getMask();
    ...
    /* renamed from: B */
    public final boolean m49732B() {
        if ((this._features & f43156h) == 0) {
            return false;
        }
        m49709y();
        return true;
    ...
    /* renamed from: G */
    public final void m49727G(int i) {
    ...
    public String _handleOddName(int i) throws IOException {
        ...
        if (i == 39 && (this._features & f43153e) != 0) {
            return _parseAposName();
        }
        if ((this._features & f43154f) == 0) {
        ...
        if (i2 < i4) {
            ...
            this._inputPtr = i2;
            return m49724j(this._inputPtr - 1, i3, inputCodeLatin1JsNames);
        }
        this._inputPtr = i2;
        return m49724j(this._inputPtr - 1, i3, inputCodeLatin1JsNames);
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:26:0x004a, code lost:
        if ((r3._features & com.fasterxml.jackson.core.json.ReaderBasedJsonParser.f43152d) == 0) goto L18;
     */
    ...
    */
    public com.fasterxml.jackson.core.JsonToken _handleOddValue(int r4) throws java.io.IOException {
        ...
        L45:
            int r0 = r3._features
            int r2 = com.fasterxml.jackson.core.json.ReaderBasedJsonParser.f43152d
            r0 = r0 & r2
            if (r0 == 0) goto L92
            int r4 = r3._inputPtr
            int r4 = r4 - r1
        ...
        L54:
            ...
            int r1 = r3._features
            int r2 = com.fasterxml.jackson.core.json.ReaderBasedJsonParser.f43151c
            r1 = r1 & r2
            if (r1 == 0) goto L67
        ...
        L86:
            int r0 = r3._features
            int r1 = com.fasterxml.jackson.core.json.ReaderBasedJsonParser.f43153e
            r0 = r0 & r1
            if (r0 == 0) goto L92
                            ...
                            if (m49714t != 116) {
                                if (m49714t != 123) {
                                    switch (m49714t) {
                                        ...
                                        case 56:
                                        case 57:
                                            _parseNegNumber = _parsePosNumber(m49714t);
                                            break;
                                        default:
                                            _parseNegNumber = _handleOddValue(m49714t);
                                            break;
                                    }
                                } else {
    ...
    public final JsonToken _parseFloatThatStartsWithPeriod() throws IOException {
        ...
        int i = this._inputPtr;
        return m49719o(46, i - 1, i, false, 0);
    }
        ...
        if (c <= '9' && c >= '0') {
            ...
            while (i4 < i3) {
                ...
                if (c2 >= '0' && c2 <= '9') {
                    ...
                    this._inputPtr = i6;
                    return m49719o(c2, i2, i6, true, i5);
                }
            }
            return m49717q(true, i2);
        }
    ...
    public final JsonToken _parsePosNumber(int i) throws IOException {
        ...
        while (i2 < i4) {
            ...
            if (c >= '0' && c <= '9') {
                ...
                this._inputPtr = i6;
                return m49719o(c, i3, i6, false, i5);
            }
        }
        this._inputPtr = i3;
        return m49717q(false, i3);
    ...
    public int _readBinary(Base64Variant base64Variant, OutputStream outputStream, byte[] bArr) throws IOException {
        ...
        while (true) {
            ...
            if (c > ' ') {
                ...
                if (decodeBase64Char3 < 0) {
                    ...
                    if (decodeBase64Char3 == -2) {
                        ...
                        if (!base64Variant.usesPaddingChar(c4) && _decodeBase64Escape(base64Variant, c4, i) != -2) {
                            throw reportInvalidBase64Char(base64Variant, c4, i, "expected padding character '" + base64Variant.getPaddingChar() + OperatorName.SHOW_TEXT_LINE);
                        }
                        bArr[i2] = (byte) (i6 >> 4);
                        i2++;
                    }
                ...
                int i14 = (i10 << 6) | decodeBase64Char4;
                bArr[i2] = (byte) (i14 >> 16);
                int i15 = i2 + 2;
    ...
    /* renamed from: g */
    public final void m49726g(String str, int i, int i2) {
    ...
    */
    ...
    /* renamed from: i */
    public final void m49725i(int i) {
        if (i == 93) {
            m49731C();
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.String m49724j(int r5, int r6, int[] r7) {
        /*
            r4 = this;
        ...
        L69:
            ...
            goto L17
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.json.ReaderBasedJsonParser.m49724j(int, int, int[]):java.lang.String");
    }

    /* renamed from: k */
    public final void m49723k(int i) {
        this._currToken = JsonToken.FIELD_NAME;
        m49731C();
        if (i != 34) {
            if (i != 91) {
    ...
    /* renamed from: l */
    public final void m49722l(String str, int i) {
        int i2;
        char c;
        int length = str.length();
        do {
    ...
    /* renamed from: m */
    public final JsonToken m49721m() {
    ...
    /* renamed from: n */
    public final JsonToken m49720n(int i) {
        if (i == 34) {
            this._tokenIncomplete = true;
    ...
    public final Boolean nextBooleanValue() throws IOException {
        ...
        if (nextToken != null) {
            int m49781id = nextToken.m49781id();
            if (m49781id == 9) {
                return Boolean.TRUE;
            }
            if (m49781id == 10) {
    ...
    public boolean nextFieldName(SerializableString serializableString) throws IOException {
        ...
        if (m49708z != 93 && m49708z != 125) {
            if (this._parsingContext.expectComma()) {
                m49708z = m49711w(m49708z);
                if ((this._features & f43149a) != 0 && (m49708z == 93 || m49708z == 125)) {
                    m49725i(m49708z);
                    return false;
                }
            }
            ...
            if (m49708z == 34) {
                ...
                if (i2 + length + 4 < this._inputEnd) {
                    ...
                    if (this._inputBuffer[i3] == '\"') {
                        ...
                        m49723k(m49712v(i2 + 1));
                        return true;
                    }
                }
            }
            return _isNextTokenNameMaybe(m49708z, serializableString.getValue());
        }
        m49725i(m49708z);
        return false;
    }
        ...
        if (m49708z != 93 && m49708z != 125) {
            ...
            if (inObject) {
                ...
                if (m49708z == 34) {
                    ...
                    _handleOddName = _handleOddName(m49708z);
                }
                this._parsingContext.setCurrentName(_handleOddName);
                this._currToken = jsonToken3;
                m49708z = m49714t();
                            ...
                            if (m49708z != 116) {
                                if (m49708z != 123) {
                                    if (m49708z != 125) {
                                        if (m49708z != 45) {
                                            if (m49708z != 46) {
                                                switch (m49708z) {
                                                    ...
                                                    case 56:
                                                    case 57:
                                                        jsonToken = _parsePosNumber(m49708z);
                                                        break;
                                                    default:
                                                        jsonToken = _handleOddValue(m49708z);
                                                        break;
                                                }
                                            } else {
                                        ...
                                        _reportUnexpectedChar(m49708z, "expected a value");
                                    }
                                } else {
                                    if (!inObject) {
                                        this._parsingContext = this._parsingContext.createChildObjectContext(this._tokenInputRow, this._tokenInputCol);
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InitCodeVariables
        ...
        */
    /* renamed from: o */
    public final com.fasterxml.jackson.core.JsonToken m49719o(
    /*  JADX ERROR: JadxRuntimeException in pass: InitCodeVariables
        jadx.core.utils.exceptions.JadxRuntimeException: Several immutable types in one variable: [int, char], vars: [r10v0 ??, r10v1 ??, r10v18 ??, r10v12 ??, r10v6 ??, r10v5 ??, r10v3 ??, r10v10 ??, r10v9 ??]
        	at jadx.core.dex.visitors.InitCodeVariables.setCodeVarType(InitCodeVariables.java:107)
        	at jadx.core.dex.visitors.InitCodeVariables.setCodeVar(InitCodeVariables.java:83)
    ...
    /* renamed from: p */
    public final String m49718p(int i, int i2, int i3) {
    ...
    /* renamed from: q */
    public final JsonToken m49717q(boolean z, int i) {
        int i2;
        char nextChar;
        boolean z2;
        int i3;
    ...
    */
    public final void m49715s() {
        ...
        L55:
            ...
            goto L0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.json.ReaderBasedJsonParser.m49715s():void");
    }
    ...
    /* renamed from: t */
    public final int m49714t() {
        int i = this._inputPtr;
        if (i + 4 >= this._inputEnd) {
            return m49713u(false);
        }
        char[] cArr = this._inputBuffer;
        char c = cArr[i];
        if (c == ':') {
    ...
    /* renamed from: u */
    public final int m49713u(boolean z) {
        while (true) {
            if (this._inputPtr >= this._inputEnd && !_loadMore()) {
    ...
    /* renamed from: v */
    public final int m49712v(int i) {
        boolean z;
        char[] cArr = this._inputBuffer;
        int i2 = i + 1;
        char c = cArr[i];
    ...
    /* renamed from: w */
    public final int m49711w(int i) {
        if (i != 44) {
    ...
    /* renamed from: x */
    public final void m49710x() {
        if ((this._features & f43155g) == 0) {
    ...
    public String nextFieldName() throws IOException {
        ...
        if (m49708z != 93 && m49708z != 125) {
            ...
            m49730D();
            String _parseName = m49708z == 34 ? _parseName() : _handleOddName(m49708z);
