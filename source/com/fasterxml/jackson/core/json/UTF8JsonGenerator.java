...
import com.fasterxml.jackson.core.p011io.CharacterEscapes;
import com.fasterxml.jackson.core.p011io.IOContext;
import com.fasterxml.jackson.core.p011io.NumberOutput;
...
public class UTF8JsonGenerator extends JsonGeneratorImpl {
    ...
    /* renamed from: a */
    public static final byte[] f43167a = CharTypes.copyHexBytes();

    /* renamed from: b */
    public static final byte[] f43168b = {110, 117, 108, 108};

    /* renamed from: c */
    public static final byte[] f43169c = {116, 114, 117, 101};

    /* renamed from: d */
    public static final byte[] f43170d = {102, 97, 108, 115, 101};
    ...
    /* renamed from: A */
    public final void m49671A(char[] cArr, int i, int i2) {
        ...
        while (i < i2) {
            ...
            if (c <= 127) {
                ...
                int i7 = i3 + 1;
                bArr[i3] = (byte) ((c >> 6) | CertificateHolderAuthorization.CVCA);
                i3 += 2;
                bArr[i7] = (byte) ((c & '?') | 128);
            } else {
                i3 = m49660d(c, i3);
    ...
    /* renamed from: B */
    public final void m49670B(String str, int i, int i2) {
        if (this._outputTail + ((i2 - i) * 6) > this._outputEnd) {
            _flushBuffer();
        }
        int i3 = this._outputTail;
        ...
        while (i < i2) {
            ...
            if (charAt <= 127) {
                ...
                if (i6 == 0) {
                    ...
                    i3 = m49652o(charAt, i3);
                }
            } else if (charAt > i4) {
                i3 = m49652o(charAt, i3);
            } else if (charAt <= 2047) {
                int i8 = i3 + 1;
                bArr[i3] = (byte) ((charAt >> 6) | CertificateHolderAuthorization.CVCA);
                i3 += 2;
                bArr[i8] = (byte) ((charAt & '?') | 128);
            } else {
                i3 = m49660d(charAt, i3);
            }
            i = i5;
        }
        this._outputTail = i3;
    ...
    /* renamed from: C */
    public final void m49669C(char[] cArr, int i, int i2) {
        if (this._outputTail + ((i2 - i) * 6) > this._outputEnd) {
            _flushBuffer();
        }
        int i3 = this._outputTail;
    ...
    /* renamed from: D */
    public final void m49668D(String str, int i, int i2) {
        do {
    ...
    /* renamed from: E */
    public final void m49667E(String str, boolean z) {
        if (z) {
    ...
    /* renamed from: F */
    public final void m49666F(char[] cArr, int i, int i2) {
        do {
            int min = Math.min(this._outputMaxContiguous, i2);
            if (this._outputTail + min > this._outputEnd) {
                _flushBuffer();
    ...
    /* renamed from: G */
    public final void m49665G(byte[] bArr, int i, int i2) {
        int[] iArr = this._outputEscapes;
        int i3 = i + i2;
        int i4 = i;
        while (i4 < i3) {
    ...
    /* renamed from: H */
    public final void m49664H(byte[] bArr, int i, int i2) {
        int i3;
    ...
    /* renamed from: I */
    public final void m49663I(byte[] bArr, int i, int i2) {
        do {
            int min = Math.min(this._outputMaxContiguous, i2);
            m49665G(bArr, i, min);
            i += min;
    ...
    /* renamed from: J */
    public final void m49662J(SerializableString serializableString) {
        int appendQuotedUTF8 = serializableString.appendQuotedUTF8(this._outputBuffer, this._outputTail);
        if (appendQuotedUTF8 < 0) {
            m49657j(serializableString.asQuotedUTF8());
        } else {
    ...
    public final void _outputSurrogates(int i, int i2) throws IOException {
        ...
        int i4 = i3 + 1;
        this._outputTail = i4;
        bArr[i3] = (byte) ((_decodeSurrogate >> 18) | C6150DK.ERROR_RECEIVE_LRC);
        int i5 = i3 + 2;
        this._outputTail = i5;
    ...
    public final void _writePPFieldName(String str) throws IOException {
        ...
        if (length <= this._outputMaxContiguous) {
            ...
            m49642y(this._charBuffer, 0, length);
        } else {
            m49666F(this._charBuffer, 0, length);
        }
        if (this._outputTail >= this._outputEnd) {
            _flushBuffer();
        }
    ...
    /* renamed from: b */
    public final int m49661b(byte[] bArr, int i, int i2, byte[] bArr2, int i3) {
    ...
    /* renamed from: d */
    public final int m49660d(int i, int i2) {
        byte[] bArr = this._outputBuffer;
        if (i >= 55296 && i <= 57343) {
            bArr[i2] = 92;
            bArr[i2 + 1] = 117;
    ...
    /* renamed from: g */
    public final int m49659g(int i, char[] cArr, int i2, int i3) {
        if (i >= 55296 && i <= 57343) {
            if (i2 >= i3 || cArr == null) {
    ...
    /* renamed from: i */
    public final int m49658i(InputStream inputStream, byte[] bArr, int i, int i2, int i3) {
        int i4 = 0;
        while (i < i2) {
            bArr[i4] = bArr[i];
            i4++;
    ...
    /* renamed from: j */
    public final void m49657j(byte[] bArr) {
    ...
    /* renamed from: k */
    public final void m49656k(byte[] bArr, int i, int i2) {
        if (this._outputTail + i2 > this._outputEnd) {
            _flushBuffer();
            if (i2 > 512) {
    ...
    /* renamed from: l */
    public final int m49655l(byte[] bArr, int i, SerializableString serializableString, int i2) {
        byte[] asUnquotedUTF8 = serializableString.asUnquotedUTF8();
        int length = asUnquotedUTF8.length;
        if (length > 6) {
            return m49661b(bArr, i, this._outputEnd, asUnquotedUTF8, i2);
        }
    ...
    /* renamed from: m */
    public final void m49654m(String str, int i, int i2) {
        if (this._outputTail + ((i2 - i) * 6) > this._outputEnd) {
            _flushBuffer();
        }
        int i3 = this._outputTail;
        ...
        while (i < i2) {
            ...
            if (charAt <= 127) {
                ...
                if (i6 == 0) {
                    ...
                    i3 = m49655l(bArr, i3, escapeSequence, i2 - i5);
                } else {
                    i3 = m49652o(charAt, i3);
                }
            } else if (charAt > i4) {
                ...
                if (escapeSequence2 != null) {
                    i3 = m49655l(bArr, i3, escapeSequence2, i2 - i5);
                } else if (charAt <= 2047) {
                    int i8 = i3 + 1;
                    bArr[i3] = (byte) ((charAt >> 6) | CertificateHolderAuthorization.CVCA);
                    i3 += 2;
    ...
    /* renamed from: n */
    public final void m49653n(char[] cArr, int i, int i2) {
        if (this._outputTail + ((i2 - i) * 6) > this._outputEnd) {
            _flushBuffer();
        }
        int i3 = this._outputTail;
    ...
    /* renamed from: o */
    public final int m49652o(int i, int i2) {
        int i3;
        byte[] bArr = this._outputBuffer;
        bArr[i2] = 92;
        int i4 = i2 + 2;
    ...
    /* renamed from: p */
    public final void m49651p() {
        if (this._outputTail + 4 >= this._outputEnd) {
            _flushBuffer();
        }
        System.arraycopy(f43168b, 0, this._outputBuffer, this._outputTail, 4);
        this._outputTail += 4;
    }

    /* renamed from: q */
    public final void m49650q(int i) {
    ...
    /* renamed from: r */
    public final void m49649r(long j) {
    ...
    /* renamed from: s */
    public final void m49648s(String str) {
        if (this._outputTail >= this._outputEnd) {
            _flushBuffer();
        }
        byte[] bArr = this._outputBuffer;
    ...
    /* renamed from: t */
    public final void m49647t(char[] cArr, int i, int i2) {
        if (this._outputTail >= this._outputEnd) {
            _flushBuffer();
        }
        byte[] bArr = this._outputBuffer;
    ...
    /* renamed from: u */
    public final void m49646u(short s) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:7:0x000e, code lost:
        ...
        r3 = r2 + 1;
        r5._outputTail = r3;
        r1[r2] = (byte) ((r0 >> 6) | org.bouncycastle.asn1.eac.CertificateHolderAuthorization.CVCA);
        r5._outputTail = r2 + 2;
        r1[r3] = (byte) ((r0 & '?') | 128);
     */
    /* JADX WARN: Code restructure failed: missing block: B:8:0x0029, code lost:
        r7 = m49659g(r0, r6, r7, r8);
     */
    /* renamed from: v */
    /*
    ...
    */
    public final void m49645v(char[] r6, int r7, int r8) {
        /*
            r5 = this;
        L0:
            if (r7 >= r8) goto L3d
        ...
        L3d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.json.UTF8JsonGenerator.m49645v(char[], int, int):void");
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:11:0x0020, code lost:
        ...
        r5 = r4 + 1;
        r7._outputTail = r5;
        r1[r4] = (byte) ((r9 >> 6) | org.bouncycastle.asn1.eac.CertificateHolderAuthorization.CVCA);
        r7._outputTail = r4 + 2;
        r1[r5] = (byte) ((r9 & '?') | 128);
        r9 = r2;
     */
    /* JADX WARN: Code restructure failed: missing block: B:12:0x0039, code lost:
        r9 = m49659g(r9, r8, r2, r10);
     */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void m49644w(char[] r8, int r9, int r10) {
        /*
            r7 = this;
        ...
        L18:
            ...
            goto L5
        L39:
            int r9 = r7.m49659g(r9, r8, r2, r10)
            goto L5
        L3e:
        ...
        L52:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.json.UTF8JsonGenerator.m49644w(char[], int, int):void");
    }
    ...
    public void writeFieldName(String str) throws IOException {
        ...
        if (length <= this._outputMaxContiguous) {
            ...
            m49643x(str, 0, length);
        } else {
            m49668D(str, 0, length);
        }
        if (this._outputTail >= this._outputEnd) {
            _flushBuffer();
        }
    ...
    public void writeRawValue(SerializableString serializableString) throws IOException {
        ...
        if (appendUnquotedUTF8 < 0) {
            m49657j(serializableString.asUnquotedUTF8());
        } else {
    ...
    /* renamed from: x */
    public final void m49643x(String str, int i, int i2) {
        int i3 = i2 + i;
        int i4 = this._outputTail;
        byte[] bArr = this._outputBuffer;
        int[] iArr = this._outputEscapes;
    ...
    /* renamed from: y */
    public final void m49642y(char[] cArr, int i, int i2) {
        int i3 = i2 + i;
        int i4 = this._outputTail;
        byte[] bArr = this._outputBuffer;
        int[] iArr = this._outputEscapes;
    ...
    /* renamed from: z */
    public final void m49641z(String str, int i, int i2) {
        if (this._outputTail + ((i2 - i) * 6) > this._outputEnd) {
            _flushBuffer();
        }
        int i3 = this._outputTail;
    ...
    public final int _writeBinary(Base64Variant base64Variant, InputStream inputStream, byte[] bArr, int i) throws IOException, JsonGenerationException {
        ...
        while (true) {
            ...
            if (i6 > i4) {
                i7 = m49658i(inputStream, bArr, i6, i7, i5);
                if (i7 < 3) {
                    i6 = 0;
                    break;
                }
        ...
        if (i5 <= 0 || (m49658i = m49658i(inputStream, bArr, i6, i7, i5)) <= 0) {
            return i5;
        }
        if (this._outputTail > i2) {
            _flushBuffer();
    ...
    */
    ...
    public void writeRaw(char c) throws IOException {
        ...
        if (c <= 127) {
            ...
            int i3 = i2 + 1;
            this._outputTail = i3;
            bArr[i2] = (byte) ((c >> 6) | CertificateHolderAuthorization.CVCA);
    ...
    public final int _writeBinary(Base64Variant base64Variant, InputStream inputStream, byte[] bArr) throws IOException, JsonGenerationException {
        ...
        while (true) {
            if (i4 > i3) {
                i5 = m49658i(inputStream, bArr, i4, i5, bArr.length);
                if (i5 < 3) {
                    break;
                }
                i3 = i5 - 3;
