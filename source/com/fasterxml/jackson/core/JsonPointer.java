...
public class JsonPointer {
    ...
    /* renamed from: a */
    public static void m49785a(StringBuilder sb, char c) {
        if (c == '0') {
            c = '~';
        } else if (c == '1') {
            c = '/';
    ...
    /* renamed from: b */
    public static void m49784b(StringBuilder sb, String str) {
        int length = str.length();
    ...
    /* renamed from: c */
    public static String m49783c(JsonPointer jsonPointer, String str) {
        if (jsonPointer == null) {
    ...
    /* renamed from: d */
    public static final int m49782d(String str) {
        int length = str.length();
    ...
    public static JsonPointer forPath(JsonStreamContext jsonStreamContext, boolean z) {
        ...
        while (jsonStreamContext != null) {
            if (jsonStreamContext.inObject()) {
                ...
                jsonPointer = new JsonPointer(m49783c(jsonPointer, currentName), currentName, jsonPointer);
                ...
                jsonPointer = new JsonPointer(m49783c(jsonPointer, valueOf), valueOf, currentIndex, jsonPointer);
            }
            jsonStreamContext = jsonStreamContext.getParent();
        }
        if (jsonPointer == null) {
    ...
    public JsonPointer(String str, String str2, JsonPointer jsonPointer) {
        ...
        this._matchingElementIndex = m49782d(str2);
    }
