...
public class FilteringParserDelegate extends JsonParserDelegate {
                    ...
                    if (m49781id != 3) {
                        if (m49781id != 4) {
                            if (m49781id != 5) {
                                ...
                                TokenFilter tokenFilter2 = TokenFilter.INCLUDE_ALL;
                                if (tokenFilter == tokenFilter2) {
                                    return m49777b(tokenFilterContext);
                                }
    ...
    /* renamed from: b */
    public final JsonToken m49777b(TokenFilterContext tokenFilterContext) {
    ...
    public final int currentTokenId() {
        ...
        return jsonToken.m49781id();
    }

    /* renamed from: d */
    public final boolean m49776d() {
                    ...
                    if (m49781id != 4) {
                        if (m49781id != 5) {
                            ...
                            if (tokenFilter == tokenFilter2) {
                                this._currToken = nextToken;
                                return nextToken;
                            } else if (tokenFilter != null && (((checkValue = this._headContext.checkValue(tokenFilter)) == tokenFilter2 || (checkValue != null && checkValue.includeValue(this.delegate))) && m49776d())) {
                                this._currToken = nextToken;
                                return nextToken;
                            }
                        } else {
