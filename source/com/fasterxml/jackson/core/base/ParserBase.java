...
public abstract class ParserBase extends ParserMinimalBase {
    ...
    public void _handleEOF() throws JsonParseException {
        ...
        if (!this._parsingContext.inRoot()) {
            ...
            _reportInvalidEOF(String.format(": expected close marker for %s (start marker at %s)", str, this._parsingContext.getStartLocation(_getSourceReference())), null);
        }
    }
    ...
    /* renamed from: b */
    public final void m49779b(int i) {
        try {
            if (i == 16) {
    ...
    /* renamed from: d */
    public final void m49778d(int i) {
