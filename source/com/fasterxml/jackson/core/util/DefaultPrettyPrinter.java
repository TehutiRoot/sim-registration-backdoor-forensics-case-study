...
public class DefaultPrettyPrinter implements PrettyPrinter, Instantiatable<DefaultPrettyPrinter>, Serializable {
    public static final SerializedString DEFAULT_ROOT_VALUE_SEPARATOR = new SerializedString(HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR);
    ...
    public static class FixedSpaceIndenter extends NopIndenter {
        ...
        public void writeIndentation(JsonGenerator jsonGenerator, int i) throws IOException {
            jsonGenerator.writeRaw(TokenParser.f74560SP);
        }
    }
    ...
    public DefaultPrettyPrinter withSeparators(Separators separators) {
        ...
        this._objectFieldValueSeparatorWithSpaces = HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR + separators.getObjectFieldValueSeparator() + HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR;
        return this;
    }
