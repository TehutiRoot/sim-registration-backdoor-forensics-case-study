...
public abstract class JsonGenerator implements Closeable, Flushable, Versioned {
    ...
    public static /* synthetic */ class C6076a {
        ...
        static {
            ...
            try {
                f43099a[WritableTypeId.Inclusion.PAYLOAD_PROPERTY.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f43099a[WritableTypeId.Inclusion.METADATA_PROPERTY.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f43099a[WritableTypeId.Inclusion.WRAPPER_OBJECT.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f43099a[WritableTypeId.Inclusion.WRAPPER_ARRAY.ordinal()] = 5;
    ...
    public void copyCurrentEvent(JsonParser jsonParser) throws IOException {
        ...
        if (currentToken == null) {
            ...
            m49781id = currentToken.m49781id();
        }
        switch (m49781id) {
            case -1:
    ...
    public WritableTypeId writeTypePrefix(WritableTypeId writableTypeId) throws IOException {
        String valueOf;
        Object obj = writableTypeId.f43244id;
        ...
        if (canWriteTypeId()) {
            ...
            int i = C6076a.f43099a[inclusion.ordinal()];
            if (i != 1 && i != 2) {
                if (i != 3) {
                    if (i != 4) {
                        writeStartArray();
    ...
    public WritableTypeId writeTypeSuffix(WritableTypeId writableTypeId) throws IOException {
        ...
        if (writableTypeId.wrapperWritten) {
            int i = C6076a.f43099a[writableTypeId.include.ordinal()];
            if (i != 1) {
                if (i != 2 && i != 3) {
                    if (i != 5) {
                        writeEndObject();
