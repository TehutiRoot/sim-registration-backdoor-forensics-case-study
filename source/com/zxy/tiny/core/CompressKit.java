...
public final class CompressKit {
    ...
    /* loaded from: classes5.dex */
    public static /* synthetic */ class C10020a {
        ...
        static {
            ...
            try {
                f60965a[Bitmap.Config.ARGB_4444.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f60965a[Bitmap.Config.ALPHA_8.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f60965a[Bitmap.Config.RGB_565.ordinal()] = 4;
    ...
    public static Bitmap.Config filterConfig(Bitmap.Config config) {
        ...
        int i = C10020a.f60965a[config.ordinal()];
        if (i != 1 && i != 2 && i != 3) {
            if (i == 4) {
