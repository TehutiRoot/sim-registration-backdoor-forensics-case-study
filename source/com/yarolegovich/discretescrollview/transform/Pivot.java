...
public class Pivot {
    ...
    /* loaded from: classes5.dex */
    public enum EnumC9999X {
        LEFT { // from class: com.yarolegovich.discretescrollview.transform.Pivot.X.1
            @Override // com.yarolegovich.discretescrollview.transform.Pivot.EnumC9999X
            public Pivot create() {
    ...
    /* loaded from: classes5.dex */
    public enum EnumC10003Y {
        TOP { // from class: com.yarolegovich.discretescrollview.transform.Pivot.Y.1
            @Override // com.yarolegovich.discretescrollview.transform.Pivot.EnumC10003Y
            public Pivot create() {
