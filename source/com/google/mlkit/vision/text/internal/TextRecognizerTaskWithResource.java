...
public class TextRecognizerTaskWithResource extends MLTask<Text, InputImage> {
    ...
    /* renamed from: h */
    public static boolean f57173h = true;

    /* renamed from: c */
    public final InterfaceC18975aG2 f57175c;

    /* renamed from: d */
    public final zzuc f57176d;

    /* renamed from: e */
    public final zzue f57177e;

    /* renamed from: f */
    public final TextRecognizerOptionsInterface f57178f;

    /* renamed from: i */
    public static final ImageUtils f57174i = ImageUtils.getInstance();

    /* renamed from: g */
    public static final TaskQueue f57172g = new TaskQueue();
    ...
    */
    public TextRecognizerTaskWithResource(com.google.android.gms.internal.mlkit_vision_text_common.zzuc r3, p000.InterfaceC18975aG2 r4, com.google.mlkit.vision.text.TextRecognizerOptionsInterface r5) {
        /*
            r2 = this;
            ...
            goto L13
        L10:
            com.google.mlkit.common.sdkinternal.TaskQueue r0 = com.google.mlkit.vision.text.internal.TextRecognizerTaskWithResource.f57172g
            goto L18
        L13:
        ...
        L18:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.mlkit.vision.text.internal.TextRecognizerTaskWithResource.<init>(com.google.android.gms.internal.mlkit_vision_text_common.zzuc, aG2, com.google.mlkit.vision.text.TextRecognizerOptionsInterface):void");
    }

    /* renamed from: c */
    public final /* synthetic */ zztr m37172c(long j, zzou zzouVar, InputImage inputImage) {
        zzob zzobVar;
        zzot zzotVar;
        ...
        zzohVar.zzd(zzouVar);
        zzohVar.zze(Boolean.valueOf(f57173h));
        Boolean bool = Boolean.TRUE;
        zzohVar.zza(bool);
        zzohVar.zzb(bool);
        zzrxVar.zzd(zzohVar.zzf());
        ImageUtils imageUtils = f57174i;
        ...
        zzsaVar.zza(LoggingUtils.m37175a(this.f57178f.getLoggingLanguageOption()));
        zzrxVar.zze(zzsaVar.zzc());
        zzrz zzf = zzrxVar.zzf();
        zzow zzowVar = new zzow();
        if (this.f57178f.getIsThickClient()) {
    ...
    /* renamed from: d */
    public final /* synthetic */ zztr m37171d(zzes zzesVar, int i, zznw zznwVar) {
        zzot zzotVar;
        zzow zzowVar = new zzow();
        if (this.f57178f.getIsThickClient()) {
            zzotVar = zzot.TYPE_THICK;
    ...
    /* renamed from: e */
    public final void m37170e(final zzou zzouVar, long j, final InputImage inputImage) {
        final long elapsedRealtime = SystemClock.elapsedRealtime() - j;
        this.f57176d.zzf(new zzub() { // from class: com.google.mlkit.vision.text.internal.zzq
            @Override // com.google.android.gms.internal.mlkit_vision_text_common.zzub
            public final zztr zza() {
                return TextRecognizerTaskWithResource.this.m37172c(elapsedRealtime, zzouVar, inputImage);
            }
        }, zzov.ON_DEVICE_TEXT_DETECT);
        zzeq zzeqVar = new zzeq();
        zzeqVar.zza(zzouVar);
        zzeqVar.zzb(Boolean.valueOf(f57173h));
        zzsa zzsaVar = new zzsa();
        zzsaVar.zza(LoggingUtils.m37175a(this.f57178f.getLoggingLanguageOption()));
        ...
        final zzuc zzucVar = this.f57176d;
        workerThreadExecutor.execute(new Runnable() { // from class: com.google.android.gms.internal.mlkit_vision_text_common.zzua
            ...
            public final void run() {
                zzuc.this.m46666e(zzovVar, zzd, elapsedRealtime, zzrVar);
            }
        });
        long currentTimeMillis = System.currentTimeMillis();
        this.f57177e.zzc(this.f57178f.getLoggingEventId(), zzouVar.zza(), currentTimeMillis - elapsedRealtime, currentTimeMillis);
    }
    ...
    public final synchronized Text run(@NonNull InputImage inputImage) throws MlKitException {
        ...
        try {
            mo407a = this.f57175c.mo407a(inputImage);
            m37170e(zzou.NO_ERROR, elapsedRealtime, inputImage);
            f57173h = false;
            ...
            m37170e(zzouVar, elapsedRealtime, inputImage);
            throw e;
        }
        return mo407a;
    }
