...
public final class zzk extends MLTask {
    ...
    /* renamed from: i */
    public static final ImageUtils f57080i = ImageUtils.getInstance();

    /* renamed from: j */
    public static boolean f57081j = true;

    /* renamed from: c */
    public final BarcodeScannerOptions f57082c;

    /* renamed from: d */
    public final KD2 f57083d;

    /* renamed from: e */
    public final zztx f57084e;

    /* renamed from: f */
    public final zztz f57085f;

    /* renamed from: g */
    public final BitmapInStreamingChecker f57086g = new BitmapInStreamingChecker();

    /* renamed from: h */
    public boolean f57087h;

    public zzk(MlKitContext mlKitContext, BarcodeScannerOptions barcodeScannerOptions, KD2 kd2, zztx zztxVar) {
        ...
        this.f57082c = barcodeScannerOptions;
        this.f57083d = kd2;
        this.f57084e = zztxVar;
        this.f57085f = zztz.zza(mlKitContext.getApplicationContext());
    }

    /* renamed from: c */
    public final /* synthetic */ zztm m37199c(long j, zzpj zzpjVar, zzcs zzcsVar, zzcs zzcsVar2, InputImage inputImage) {
        zzoq zzoqVar;
        zzpi zzpiVar;
        ...
        zzowVar.zzd(zzpjVar);
        zzowVar.zze(Boolean.valueOf(f57081j));
        Boolean bool = Boolean.TRUE;
        zzowVar.zza(bool);
        zzowVar.zzb(bool);
        zzpxVar.zzh(zzowVar.zzf());
        zzpxVar.zzi(zzb.zzc(this.f57082c));
        zzpxVar.zze(zzcsVar.zzf());
        zzpxVar.zzf(zzcsVar2.zzf());
        int format = inputImage.getFormat();
        int mobileVisionImageSize = f57080i.getMobileVisionImageSize(inputImage);
    ...
    /* renamed from: d */
    public final /* synthetic */ zztm m37198d(zzfv zzfvVar, int i, zzol zzolVar) {
        zzpi zzpiVar;
        zzpl zzplVar = new zzpl();
        if (this.f57087h) {
            zzpiVar = zzpi.TYPE_THICK;
    ...
    /* renamed from: e */
    public final void m37197e(final zzpj zzpjVar, long j, final InputImage inputImage, List list) {
        int i;
        ...
        this.f57084e.zzf(new zztw() { // from class: com.google.mlkit.vision.barcode.internal.zzi
            @Override // com.google.android.gms.internal.mlkit_vision_barcode.zztw
            public final zztm zza() {
                return zzk.this.m37199c(elapsedRealtime, zzpjVar, zzcsVar, zzcsVar2, inputImage);
            }
        }, zzpk.ON_DEVICE_BARCODE_DETECT);
        zzft zzftVar = new zzft();
        zzftVar.zze(zzpjVar);
        zzftVar.zzf(Boolean.valueOf(f57081j));
        zzftVar.zzg(zzb.zzc(this.f57082c));
        zzftVar.zzc(zzcsVar.zzf());
        zzftVar.zzd(zzcsVar2.zzf());
        final zzfv zzh = zzftVar.zzh();
        final zzj zzjVar = new zzj(this);
        final zztx zztxVar = this.f57084e;
        ...
        MLTaskExecutor.workerThreadExecutor().execute(new Runnable() { // from class: com.google.android.gms.internal.mlkit_vision_barcode.zztu
            ...
            public final void run() {
                zztx.this.m46984e(zzpkVar, zzh, elapsedRealtime, zzjVar);
            }
        });
        long currentTimeMillis = System.currentTimeMillis();
        boolean z = this.f57087h;
        long j2 = currentTimeMillis - elapsedRealtime;
        zztz zztzVar = this.f57085f;
        if (true != z) {
            i = 24301;
        } else {
            i = 24302;
    ...
    public final synchronized List run(@NonNull InputImage inputImage) throws MlKitException {
        ...
        this.f57086g.check(inputImage);
        try {
            mo874a = this.f57083d.mo874a(inputImage);
            m37197e(zzpj.NO_ERROR, elapsedRealtime, inputImage, mo874a);
            f57081j = false;
            ...
            m37197e(zzpjVar, elapsedRealtime, inputImage, null);
            throw e;
        }
        return mo874a;
    }
