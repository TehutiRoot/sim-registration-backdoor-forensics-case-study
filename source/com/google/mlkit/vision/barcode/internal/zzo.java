...
public final class zzo implements BarcodeSource {
    ...
    /* renamed from: a */
    public static Barcode.CalendarDateTime m37195a(com.google.android.gms.internal.mlkit_vision_barcode.zzj zzjVar) {
        if (zzjVar == null) {
            return null;
        }
    ...
    public final Barcode.CalendarEvent getCalendarEvent() {
        com.google.android.gms.internal.mlkit_vision_barcode.zzk zzkVar = this.f57089a.zzl;
        if (zzkVar == null) {
            return null;
        }
        return new Barcode.CalendarEvent(zzkVar.zza, zzkVar.zzb, zzkVar.zzc, zzkVar.zzd, zzkVar.zze, m37195a(zzkVar.zzf), m37195a(zzkVar.zzg));
    }
    ...
    public final Point[] getCornerPoints() {
        return this.f57089a.zze;
    }

    @Override // com.google.mlkit.vision.barcode.common.internal.BarcodeSource
    @Nullable
    public final String getDisplayValue() {
        return this.f57089a.zzc;
    }

    @Override // com.google.mlkit.vision.barcode.common.internal.BarcodeSource
    @Nullable
    public final Barcode.DriverLicense getDriverLicense() {
        com.google.android.gms.internal.mlkit_vision_barcode.zzm zzmVar = this.f57089a.zzn;
        if (zzmVar == null) {
            return null;
        }
    ...
    public final int getFormat() {
        return this.f57089a.zza;
    }

    @Override // com.google.mlkit.vision.barcode.common.internal.BarcodeSource
    @Nullable
    public final Barcode.GeoPoint getGeoPoint() {
        com.google.android.gms.internal.mlkit_vision_barcode.zzo zzoVar = this.f57089a.zzk;
        if (zzoVar != null) {
    ...
    public final byte[] getRawBytes() {
        return this.f57089a.zzo;
    }

    @Override // com.google.mlkit.vision.barcode.common.internal.BarcodeSource
    @Nullable
    public final String getRawValue() {
        return this.f57089a.zzb;
    }

    @Override // com.google.mlkit.vision.barcode.common.internal.BarcodeSource
    @Nullable
    public final Barcode.Sms getSms() {
        zzr zzrVar = this.f57089a.zzh;
        if (zzrVar != null) {
    ...
    public final int getValueType() {
        return this.f57089a.zzd;
    }

    @Override // com.google.mlkit.vision.barcode.common.internal.BarcodeSource
    @Nullable
    public final Barcode.WiFi getWifi() {
        zzt zztVar = this.f57089a.zzi;
        if (zztVar != null) {
