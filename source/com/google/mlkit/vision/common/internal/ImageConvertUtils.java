...
public class ImageConvertUtils {
    ...
    /* renamed from: a */
    public static final ImageConvertUtils f57102a = new ImageConvertUtils();

    /* renamed from: a */
    public static byte[] m37190a(byte[] bArr, int i, int i2) {
    ...
    /* renamed from: b */
    public static final void m37189b(Image.Plane plane, int i, int i2, byte[] bArr, int i3, int i4) {
    ...
    public static Bitmap yv12ToBitmap(@NonNull ByteBuffer byteBuffer, int i, int i2, int i3) throws MlKitException {
        byte[] m37190a = m37190a(yv12ToNv21Buffer(byteBuffer, true).array(), i, i2);
        Bitmap decodeByteArray = BitmapFactory.decodeByteArray(m37190a, 0, m37190a.length);
    ...
    public Bitmap nv21ToBitmap(@NonNull ByteBuffer byteBuffer, int i, int i2, int i3) throws MlKitException {
        byte[] m37190a = m37190a(byteBufferToByteArray(byteBuffer), i, i2);
        Bitmap decodeByteArray = BitmapFactory.decodeByteArray(m37190a, 0, m37190a.length);
        return zza(decodeByteArray, i3, decodeByteArray.getWidth(), decodeByteArray.getHeight());
    }
    ...
    public ByteBuffer yuv420ThreePlanesToNV21(@NonNull Image.Plane[] planeArr, int i, int i2) {
        ...
        if (z) {
            ...
            m37189b(planeArr[0], i, i2, bArr, 0, 1);
            m37189b(planeArr[1], i, i2, bArr, i3 + 1, 2);
            m37189b(planeArr[2], i, i2, bArr, i3, 2);
        }
        return ByteBuffer.wrap(bArr);
    }
}
