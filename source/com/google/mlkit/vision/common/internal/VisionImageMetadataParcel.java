...
public class VisionImageMetadataParcel extends AbstractSafeParcelable {
    ...
    public VisionImageMetadataParcel(@SafeParcelable.Param(m48388id = 1) int i, @SafeParcelable.Param(m48388id = 2) int i2, @SafeParcelable.Param(m48388id = 3) int i3, @SafeParcelable.Param(m48388id = 4) long j, @SafeParcelable.Param(m48388id = 5) int i4) {
        this.width = i;
        this.height = i2;
        this.zza = i3;
