...
public class ModelUtils {
    ...
    /* renamed from: a */
    public static final GmsLogger f56870a = new GmsLogger("ModelUtils", "");
    ...
    public static abstract class ModelLoggingInfo {
        /* renamed from: a */
        public static ModelLoggingInfo m37251a(long j, String str, boolean z) {
            return new C8817b(j, zzu.zzb(str), z);
        }
    ...
    /* renamed from: a */
    public static String m37253a(Context context, String str, boolean z) {
        AutoMLManifest parseManifestFile = parseManifestFile(str, z, context);
        if (parseManifestFile == null) {
            f56870a.m48406e("ModelUtils", "Failed to parse manifest file.");
            return null;
        }
    ...
    /* renamed from: b */
    public static String m37252b(InputStream inputStream) {
        int i;
        try {
            ...
            f56870a.m48406e("ModelUtils", "Failed to read model file");
            return null;
        } catch (NoSuchAlgorithmException unused2) {
            f56870a.m48406e("ModelUtils", "Do not have SHA-256 algorithm");
            return null;
        }
    }
    ...
    */
    ...
    public static String getSHA256(@NonNull File file) {
        try {
            ...
            String m37252b = m37252b(fileInputStream);
            fileInputStream.close();
            return m37252b;
        } catch (IOException e) {
            f56870a.m48406e("ModelUtils", "Failed to create FileInputStream for model: ".concat(e.toString()));
            return null;
        }
    }
    ...
    */
    public static com.google.mlkit.common.internal.model.ModelUtils.AutoMLManifest parseManifestFile(@androidx.annotation.NonNull java.lang.String r5, boolean r6, @androidx.annotation.NonNull android.content.Context r7) {
        /*
            ...
            com.google.android.gms.common.internal.GmsLogger r1 = com.google.mlkit.common.internal.model.ModelUtils.f56870a
        ...
        L22:
            ...
            if (r3 != 0) goto L35
        L2d:
            com.google.android.gms.common.internal.GmsLogger r5 = com.google.mlkit.common.internal.model.ModelUtils.f56870a
        ...
        L66:
            ...
            r1.m48408d(r2, r5)     // Catch: java.io.IOException -> L3f org.json.JSONException -> L41
        ...
        Laa:
            com.google.android.gms.common.internal.GmsLogger r6 = com.google.mlkit.common.internal.model.ModelUtils.f56870a
    ...
    public static boolean zza(@NonNull File file, @NonNull String str) {
        ...
        f56870a.m48408d("ModelUtils", "Calculated hash value is: ".concat(String.valueOf(sha256)));
