...
public class MlKitThreadPool extends zzav {
    ...
    /* renamed from: b */
    public static final ThreadLocal f56920b = new ThreadLocal();

    /* renamed from: a */
    public final ThreadPoolExecutor f56921a;
            ...
            public final Thread newThread(final Runnable runnable) {
                return defaultThreadFactory.newThread(new Runnable() { // from class: com.google.mlkit.common.sdkinternal.zzk
                    ...
                    public final void run() {
                        MlKitThreadPool.m37237c(runnable);
                    }
                });
            }
        });
        this.f56921a = threadPoolExecutor;
        threadPoolExecutor.allowCoreThreadTimeOut(true);
    }

    /* renamed from: a */
    public static /* synthetic */ void m37238a(Runnable runnable) {
        m37236d((Deque) f56920b.get(), runnable);
    }

    /* renamed from: c */
    public static /* synthetic */ void m37237c(Runnable runnable) {
        f56920b.set(new ArrayDeque());
        runnable.run();
    }

    /* renamed from: d */
    public static void m37236d(Deque deque, Runnable runnable) {
    ...
    public final void execute(@NonNull final Runnable runnable) {
        Deque deque = (Deque) f56920b.get();
        if (deque != null && deque.size() <= 1) {
            m37236d(deque, runnable);
        } else {
            this.f56921a.execute(new Runnable() { // from class: com.google.mlkit.common.sdkinternal.zzi
                @Override // java.lang.Runnable
                public final void run() {
                    MlKitThreadPool.m37238a(runnable);
                }
            });
        }
    }
