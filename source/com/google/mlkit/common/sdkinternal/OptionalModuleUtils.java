...
public class OptionalModuleUtils {
    ...
    /* renamed from: a */
    public static final zzai f56928a;

    /* renamed from: b */
    public static final zzai f56929b;
    ...
    static {
        ...
        f56929b = zzahVar2.zzb();
    }

    /* renamed from: a */
    public static Feature[] m37233a(Map map, List list) {
    ...
    public static boolean areAllRequiredModulesAvailable(@NonNull Context context, @NonNull List<String> list) {
        if (GoogleApiAvailabilityLight.getInstance().getApkVersion(context) >= 221500000) {
            return areAllRequiredModulesAvailable(context, m37233a(f56929b, list));
        }
        try {
            for (String str : list) {
    ...
    public static void requestDownload(@NonNull Context context, @NonNull List<String> list) {
        if (GoogleApiAvailabilityLight.getInstance().getApkVersion(context) >= 221500000) {
            requestDownload(context, m37233a(f56928a, list));
            return;
        }
