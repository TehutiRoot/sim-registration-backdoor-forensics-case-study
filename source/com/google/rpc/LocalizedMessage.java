...
public final class LocalizedMessage extends GeneratedMessageLite<LocalizedMessage, Builder> implements LocalizedMessageOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<LocalizedMessage, Builder> implements LocalizedMessageOrBuilder {
        ...
        public Builder clearLocale() {
            copyOnWrite();
            ((LocalizedMessage) this.instance).m34893I();
            return this;
        }

        public Builder clearMessage() {
            copyOnWrite();
            ((LocalizedMessage) this.instance).m34892J();
            return this;
        }
        ...
        public Builder setLocale(String str) {
            copyOnWrite();
            ((LocalizedMessage) this.instance).m34891K(str);
            return this;
        }

        public Builder setLocaleBytes(ByteString byteString) {
            copyOnWrite();
            ((LocalizedMessage) this.instance).m34890L(byteString);
            return this;
        }

        public Builder setMessage(String str) {
            copyOnWrite();
            ((LocalizedMessage) this.instance).m34889M(str);
            return this;
        }

        public Builder setMessageBytes(ByteString byteString) {
            copyOnWrite();
            ((LocalizedMessage) this.instance).m34888N(byteString);
            return this;
        }
    ...
    public static /* synthetic */ class C8982a {
        ...
        static {
            ...
            try {
                f57542a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f57542a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f57542a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f57542a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f57542a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f57542a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: I */
    public final void m34893I() {
        this.locale_ = getDefaultInstance().getLocale();
    }

    /* renamed from: J */
    public final void m34892J() {
        this.message_ = getDefaultInstance().getMessage();
    }

    /* renamed from: K */
    public final void m34891K(String str) {
        str.getClass();
        this.locale_ = str;
    }

    /* renamed from: L */
    public final void m34890L(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.locale_ = byteString.toStringUtf8();
    }

    /* renamed from: M */
    public final void m34889M(String str) {
        str.getClass();
        this.message_ = str;
    }

    /* renamed from: N */
    public final void m34888N(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C8982a.f57542a[methodToInvoke.ordinal()]) {
            case 1:
