...
public final class RetryInfo extends GeneratedMessageLite<RetryInfo, Builder> implements RetryInfoOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<RetryInfo, Builder> implements RetryInfoOrBuilder {
        ...
        public Builder clearRetryDelay() {
            copyOnWrite();
            ((RetryInfo) this.instance).m34785F();
            return this;
        }
        ...
        public Builder mergeRetryDelay(Duration duration) {
            copyOnWrite();
            ((RetryInfo) this.instance).m34784G(duration);
            return this;
        }

        public Builder setRetryDelay(Duration duration) {
            copyOnWrite();
            ((RetryInfo) this.instance).m34783H(duration);
            return this;
        }
        ...
        public Builder setRetryDelay(Duration.Builder builder) {
            copyOnWrite();
            ((RetryInfo) this.instance).m34783H(builder.build());
            return this;
        }
    }
    ...
    /* renamed from: F */
    public final void m34785F() {
        this.retryDelay_ = null;
    }

    /* renamed from: G */
    public final void m34784G(Duration duration) {
        duration.getClass();
    ...
    /* renamed from: H */
    public final void m34783H(Duration duration) {
        duration.getClass();
        this.retryDelay_ = duration;
    }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C8987a.f57547a[methodToInvoke.ordinal()]) {
            case 1:
