...
public final class DebugInfo extends GeneratedMessageLite<DebugInfo, Builder> implements DebugInfoOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<DebugInfo, Builder> implements DebugInfoOrBuilder {
        public /* synthetic */ Builder(C8978a c8978a) {
            this();
        }

        public Builder addAllStackEntries(Iterable<String> iterable) {
            copyOnWrite();
            ((DebugInfo) this.instance).m34953K(iterable);
            return this;
        }

        public Builder addStackEntries(String str) {
            copyOnWrite();
            ((DebugInfo) this.instance).m34952L(str);
            return this;
        }

        public Builder addStackEntriesBytes(ByteString byteString) {
            copyOnWrite();
            ((DebugInfo) this.instance).m34951M(byteString);
            return this;
        }

        public Builder clearDetail() {
            copyOnWrite();
            ((DebugInfo) this.instance).m34950N();
            return this;
        }

        public Builder clearStackEntries() {
            copyOnWrite();
            ((DebugInfo) this.instance).m34949O();
            return this;
        }
        ...
        public Builder setDetail(String str) {
            copyOnWrite();
            ((DebugInfo) this.instance).m34947Q(str);
            return this;
        }

        public Builder setDetailBytes(ByteString byteString) {
            copyOnWrite();
            ((DebugInfo) this.instance).m34946R(byteString);
            return this;
        }

        public Builder setStackEntries(int i, String str) {
            copyOnWrite();
            ((DebugInfo) this.instance).m34945S(i, str);
            return this;
        }
    ...
    /* loaded from: classes5.dex */
    public static /* synthetic */ class C8978a {
        ...
        static {
            ...
            try {
                f57538a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f57538a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f57538a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f57538a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f57538a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f57538a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: K */
    public final void m34953K(Iterable iterable) {
        m34948P();
        AbstractMessageLite.addAll(iterable, (List) this.stackEntries_);
    }

    /* renamed from: L */
    public final void m34952L(String str) {
        str.getClass();
        m34948P();
    ...
    /* renamed from: M */
    public final void m34951M(ByteString byteString) {
    ...
    /* renamed from: N */
    public final void m34950N() {
        this.detail_ = getDefaultInstance().getDetail();
    }

    /* renamed from: O */
    public final void m34949O() {
        this.stackEntries_ = GeneratedMessageLite.emptyProtobufList();
    }

    /* renamed from: P */
    public final void m34948P() {
    ...
    /* renamed from: Q */
    public final void m34947Q(String str) {
        str.getClass();
        this.detail_ = str;
    }

    /* renamed from: R */
    public final void m34946R(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.detail_ = byteString.toStringUtf8();
    }

    /* renamed from: S */
    public final void m34945S(int i, String str) {
        str.getClass();
        m34948P();
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C8978a.f57538a[methodToInvoke.ordinal()]) {
            case 1:
