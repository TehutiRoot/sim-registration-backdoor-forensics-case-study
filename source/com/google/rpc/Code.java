...
public enum Code implements Internal.EnumLite {
    ...
    private static final Internal.EnumLiteMap<Code> internalValueMap = new Internal.EnumLiteMap() { // from class: com.google.rpc.Code.a
    ...
    /* loaded from: classes5.dex */
    public static final class C8977b implements Internal.EnumVerifier {

        /* renamed from: a */
        public static final Internal.EnumVerifier f57537a = new C8977b();

        @Override // com.google.protobuf.Internal.EnumVerifier
        public boolean isInRange(int i) {
            if (Code.forNumber(i) != null) {
                return true;
            }
            return false;
        }
