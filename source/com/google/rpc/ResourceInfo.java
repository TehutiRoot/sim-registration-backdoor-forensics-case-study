...
public final class ResourceInfo extends GeneratedMessageLite<ResourceInfo, Builder> implements ResourceInfoOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<ResourceInfo, Builder> implements ResourceInfoOrBuilder {
        public /* synthetic */ Builder(C8986a c8986a) {
            this();
        }

        public Builder clearDescription() {
            copyOnWrite();
            ((ResourceInfo) this.instance).m34801O();
            return this;
        }

        public Builder clearOwner() {
            copyOnWrite();
            ((ResourceInfo) this.instance).m34800P();
            return this;
        }

        public Builder clearResourceName() {
            copyOnWrite();
            ((ResourceInfo) this.instance).m34799Q();
            return this;
        }

        public Builder clearResourceType() {
            copyOnWrite();
            ((ResourceInfo) this.instance).m34798R();
            return this;
        }
        ...
        public Builder setDescription(String str) {
            copyOnWrite();
            ((ResourceInfo) this.instance).m34797S(str);
            return this;
        }

        public Builder setDescriptionBytes(ByteString byteString) {
            copyOnWrite();
            ((ResourceInfo) this.instance).m34796T(byteString);
            return this;
        }

        public Builder setOwner(String str) {
            copyOnWrite();
            ((ResourceInfo) this.instance).m34795U(str);
            return this;
        }

        public Builder setOwnerBytes(ByteString byteString) {
            copyOnWrite();
            ((ResourceInfo) this.instance).m34794V(byteString);
            return this;
        }

        public Builder setResourceName(String str) {
            copyOnWrite();
            ((ResourceInfo) this.instance).m34793W(str);
            return this;
        }

        public Builder setResourceNameBytes(ByteString byteString) {
            copyOnWrite();
            ((ResourceInfo) this.instance).m34792X(byteString);
            return this;
        }

        public Builder setResourceType(String str) {
            copyOnWrite();
            ((ResourceInfo) this.instance).m34791Y(str);
            return this;
        }

        public Builder setResourceTypeBytes(ByteString byteString) {
            copyOnWrite();
            ((ResourceInfo) this.instance).m34790Z(byteString);
            return this;
        }
    ...
    /* loaded from: classes5.dex */
    public static /* synthetic */ class C8986a {
        ...
        static {
            ...
            try {
                f57546a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f57546a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f57546a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f57546a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f57546a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f57546a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: S */
    public void m34797S(String str) {
        str.getClass();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: T */
    public void m34796T(ByteString byteString) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: W */
    public void m34793W(String str) {
        str.getClass();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: X */
    public void m34792X(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
    ...
    /* renamed from: P */
    public final void m34800P() {
        this.owner_ = getDefaultInstance().getOwner();
    }

    /* renamed from: R */
    public final void m34798R() {
        this.resourceType_ = getDefaultInstance().getResourceType();
    }

    /* renamed from: U */
    public final void m34795U(String str) {
        str.getClass();
        this.owner_ = str;
    }

    /* renamed from: V */
    public final void m34794V(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.owner_ = byteString.toStringUtf8();
    }

    /* renamed from: Y */
    public final void m34791Y(String str) {
        str.getClass();
        this.resourceType_ = str;
    }

    /* renamed from: Z */
    public final void m34790Z(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C8986a.f57546a[methodToInvoke.ordinal()]) {
            case 1:
