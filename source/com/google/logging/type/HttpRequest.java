...
public final class HttpRequest extends GeneratedMessageLite<HttpRequest, Builder> implements HttpRequestOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<HttpRequest, Builder> implements HttpRequestOrBuilder {
        public /* synthetic */ Builder(C8797a c8797a) {
            this();
        }

        public Builder clearCacheFillBytes() {
            copyOnWrite();
            ((HttpRequest) this.instance).m37387o0();
            return this;
        }

        public Builder clearCacheHit() {
            copyOnWrite();
            ((HttpRequest) this.instance).m37386p0();
            return this;
        }

        public Builder clearCacheLookup() {
            copyOnWrite();
            ((HttpRequest) this.instance).m37385q0();
            return this;
        }

        public Builder clearCacheValidatedWithOriginServer() {
            copyOnWrite();
            ((HttpRequest) this.instance).m37384r0();
            return this;
        }

        public Builder clearLatency() {
            copyOnWrite();
            ((HttpRequest) this.instance).m37383s0();
            return this;
        }

        public Builder clearProtocol() {
            copyOnWrite();
            ((HttpRequest) this.instance).m37382t0();
            return this;
        }

        public Builder clearReferer() {
            copyOnWrite();
            ((HttpRequest) this.instance).m37381u0();
            return this;
        }

        public Builder clearRemoteIp() {
            copyOnWrite();
            ((HttpRequest) this.instance).m37380v0();
            return this;
        }

        public Builder clearRequestMethod() {
            copyOnWrite();
            ((HttpRequest) this.instance).m37379w0();
            return this;
        }

        public Builder clearRequestSize() {
            copyOnWrite();
            ((HttpRequest) this.instance).m37378x0();
            return this;
        }

        public Builder clearRequestUrl() {
            copyOnWrite();
            ((HttpRequest) this.instance).m37377y0();
            return this;
        }

        public Builder clearResponseSize() {
            copyOnWrite();
            ((HttpRequest) this.instance).m37376z0();
            return this;
        }

        public Builder clearServerIp() {
            copyOnWrite();
            ((HttpRequest) this.instance).m37452A0();
            return this;
        }

        public Builder clearStatus() {
            copyOnWrite();
            ((HttpRequest) this.instance).m37450B0();
            return this;
        }

        public Builder clearUserAgent() {
            copyOnWrite();
            ((HttpRequest) this.instance).m37448C0();
            return this;
        }
        ...
        public Builder mergeLatency(Duration duration) {
            copyOnWrite();
            ((HttpRequest) this.instance).m37446D0(duration);
            return this;
        }

        public Builder setCacheFillBytes(long j) {
            copyOnWrite();
            ((HttpRequest) this.instance).m37444E0(j);
            return this;
        }

        public Builder setCacheHit(boolean z) {
            copyOnWrite();
            ((HttpRequest) this.instance).m37442F0(z);
            return this;
        }

        public Builder setCacheLookup(boolean z) {
            copyOnWrite();
            ((HttpRequest) this.instance).m37440G0(z);
            return this;
        }

        public Builder setCacheValidatedWithOriginServer(boolean z) {
            copyOnWrite();
            ((HttpRequest) this.instance).m37438H0(z);
            return this;
        }

        public Builder setLatency(Duration duration) {
            copyOnWrite();
            ((HttpRequest) this.instance).m37436I0(duration);
            return this;
        }

        public Builder setProtocol(String str) {
            copyOnWrite();
            ((HttpRequest) this.instance).m37434J0(str);
            return this;
        }

        public Builder setProtocolBytes(ByteString byteString) {
            copyOnWrite();
            ((HttpRequest) this.instance).m37432K0(byteString);
            return this;
        }

        public Builder setReferer(String str) {
            copyOnWrite();
            ((HttpRequest) this.instance).m37430L0(str);
            return this;
        }

        public Builder setRefererBytes(ByteString byteString) {
            copyOnWrite();
            ((HttpRequest) this.instance).m37428M0(byteString);
            return this;
        }

        public Builder setRemoteIp(String str) {
            copyOnWrite();
            ((HttpRequest) this.instance).m37426N0(str);
            return this;
        }

        public Builder setRemoteIpBytes(ByteString byteString) {
            copyOnWrite();
            ((HttpRequest) this.instance).m37424O0(byteString);
            return this;
        }

        public Builder setRequestMethod(String str) {
            copyOnWrite();
            ((HttpRequest) this.instance).m37422P0(str);
            return this;
        }

        public Builder setRequestMethodBytes(ByteString byteString) {
            copyOnWrite();
            ((HttpRequest) this.instance).m37420Q0(byteString);
            return this;
        }

        public Builder setRequestSize(long j) {
            copyOnWrite();
            ((HttpRequest) this.instance).m37418R0(j);
            return this;
        }

        public Builder setRequestUrl(String str) {
            copyOnWrite();
            ((HttpRequest) this.instance).m37416S0(str);
            return this;
        }

        public Builder setRequestUrlBytes(ByteString byteString) {
            copyOnWrite();
            ((HttpRequest) this.instance).m37414T0(byteString);
            return this;
        }

        public Builder setResponseSize(long j) {
            copyOnWrite();
            ((HttpRequest) this.instance).m37412U0(j);
            return this;
        }

        public Builder setServerIp(String str) {
            copyOnWrite();
            ((HttpRequest) this.instance).m37410V0(str);
            return this;
        }

        public Builder setServerIpBytes(ByteString byteString) {
            copyOnWrite();
            ((HttpRequest) this.instance).m37408W0(byteString);
            return this;
        }

        public Builder setStatus(int i) {
            copyOnWrite();
            ((HttpRequest) this.instance).m37406X0(i);
            return this;
        }

        public Builder setUserAgent(String str) {
            copyOnWrite();
            ((HttpRequest) this.instance).m37404Y0(str);
            return this;
        }

        public Builder setUserAgentBytes(ByteString byteString) {
            copyOnWrite();
            ((HttpRequest) this.instance).m37402Z0(byteString);
            return this;
        }
        ...
        public Builder setLatency(Duration.Builder builder) {
            copyOnWrite();
            ((HttpRequest) this.instance).m37436I0(builder.build());
            return this;
        }
    }
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C8797a {
        ...
        static {
            ...
            try {
                f56856a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f56856a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f56856a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f56856a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f56856a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f56856a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: B0 */
    public void m37450B0() {
        this.status_ = 0;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: J0 */
    public void m37434J0(String str) {
        str.getClass();
        this.protocol_ = str;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: K0 */
    public void m37432K0(ByteString byteString) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: t0 */
    public void m37382t0() {
        this.protocol_ = getDefaultInstance().getProtocol();
    }

    /* renamed from: A0 */
    public final void m37452A0() {
        this.serverIp_ = getDefaultInstance().getServerIp();
    }

    /* renamed from: C0 */
    public final void m37448C0() {
        this.userAgent_ = getDefaultInstance().getUserAgent();
    }

    /* renamed from: D0 */
    public final void m37446D0(Duration duration) {
        duration.getClass();
    ...
    /* renamed from: E0 */
    public final void m37444E0(long j) {
        this.cacheFillBytes_ = j;
    }

    /* renamed from: F0 */
    public final void m37442F0(boolean z) {
        this.cacheHit_ = z;
    }

    /* renamed from: G0 */
    public final void m37440G0(boolean z) {
        this.cacheLookup_ = z;
    }

    /* renamed from: H0 */
    public final void m37438H0(boolean z) {
        this.cacheValidatedWithOriginServer_ = z;
    }

    /* renamed from: I0 */
    public final void m37436I0(Duration duration) {
        duration.getClass();
        this.latency_ = duration;
    }

    /* renamed from: L0 */
    public final void m37430L0(String str) {
        str.getClass();
        this.referer_ = str;
    }

    /* renamed from: M0 */
    public final void m37428M0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.referer_ = byteString.toStringUtf8();
    }

    /* renamed from: N0 */
    public final void m37426N0(String str) {
        str.getClass();
        this.remoteIp_ = str;
    }

    /* renamed from: O0 */
    public final void m37424O0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.remoteIp_ = byteString.toStringUtf8();
    }

    /* renamed from: P0 */
    public final void m37422P0(String str) {
        str.getClass();
        this.requestMethod_ = str;
    }

    /* renamed from: Q0 */
    public final void m37420Q0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.requestMethod_ = byteString.toStringUtf8();
    }

    /* renamed from: R0 */
    public final void m37418R0(long j) {
        this.requestSize_ = j;
    }

    /* renamed from: S0 */
    public final void m37416S0(String str) {
        str.getClass();
        this.requestUrl_ = str;
    }

    /* renamed from: T0 */
    public final void m37414T0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.requestUrl_ = byteString.toStringUtf8();
    }

    /* renamed from: U0 */
    public final void m37412U0(long j) {
        this.responseSize_ = j;
    }

    /* renamed from: V0 */
    public final void m37410V0(String str) {
        str.getClass();
        this.serverIp_ = str;
    }

    /* renamed from: W0 */
    public final void m37408W0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.serverIp_ = byteString.toStringUtf8();
    }

    /* renamed from: X0 */
    public final void m37406X0(int i) {
        this.status_ = i;
    }

    /* renamed from: Y0 */
    public final void m37404Y0(String str) {
        str.getClass();
        this.userAgent_ = str;
    }

    /* renamed from: Z0 */
    public final void m37402Z0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C8797a.f56856a[methodToInvoke.ordinal()]) {
            case 1:
    ...
    /* renamed from: o0 */
    public final void m37387o0() {
        this.cacheFillBytes_ = 0L;
    }

    /* renamed from: p0 */
    public final void m37386p0() {
        this.cacheHit_ = false;
    }

    /* renamed from: q0 */
    public final void m37385q0() {
        this.cacheLookup_ = false;
    }

    /* renamed from: r0 */
    public final void m37384r0() {
        this.cacheValidatedWithOriginServer_ = false;
    }

    /* renamed from: s0 */
    public final void m37383s0() {
        this.latency_ = null;
    }

    /* renamed from: u0 */
    public final void m37381u0() {
        this.referer_ = getDefaultInstance().getReferer();
    }

    /* renamed from: v0 */
    public final void m37380v0() {
        this.remoteIp_ = getDefaultInstance().getRemoteIp();
    }

    /* renamed from: w0 */
    public final void m37379w0() {
        this.requestMethod_ = getDefaultInstance().getRequestMethod();
    }

    /* renamed from: x0 */
    public final void m37378x0() {
        this.requestSize_ = 0L;
    }

    /* renamed from: y0 */
    public final void m37377y0() {
        this.requestUrl_ = getDefaultInstance().getRequestUrl();
    }

    /* renamed from: z0 */
    public final void m37376z0() {
