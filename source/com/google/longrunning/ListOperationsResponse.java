...
public final class ListOperationsResponse extends GeneratedMessageLite<ListOperationsResponse, Builder> implements ListOperationsResponseOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<ListOperationsResponse, Builder> implements ListOperationsResponseOrBuilder {
        public /* synthetic */ Builder(C8804a c8804a) {
            this();
        }

        public Builder addAllOperations(Iterable<? extends Operation> iterable) {
            copyOnWrite();
            ((ListOperationsResponse) this.instance).m37320L(iterable);
            return this;
        }

        public Builder addOperations(Operation operation) {
            copyOnWrite();
            ((ListOperationsResponse) this.instance).m37318N(operation);
            return this;
        }

        public Builder clearNextPageToken() {
            copyOnWrite();
            ((ListOperationsResponse) this.instance).m37317O();
            return this;
        }

        public Builder clearOperations() {
            copyOnWrite();
            ((ListOperationsResponse) this.instance).m37316P();
            return this;
        }
        ...
        public Builder removeOperations(int i) {
            copyOnWrite();
            ((ListOperationsResponse) this.instance).m37314R(i);
            return this;
        }

        public Builder setNextPageToken(String str) {
            copyOnWrite();
            ((ListOperationsResponse) this.instance).m37313S(str);
            return this;
        }

        public Builder setNextPageTokenBytes(ByteString byteString) {
            copyOnWrite();
            ((ListOperationsResponse) this.instance).m37312T(byteString);
            return this;
        }

        public Builder setOperations(int i, Operation operation) {
            copyOnWrite();
            ((ListOperationsResponse) this.instance).m37311U(i, operation);
            return this;
        }
        ...
        public Builder addOperations(int i, Operation operation) {
            copyOnWrite();
            ((ListOperationsResponse) this.instance).m37319M(i, operation);
            return this;
        }

        public Builder setOperations(int i, Operation.Builder builder) {
            copyOnWrite();
            ((ListOperationsResponse) this.instance).m37311U(i, builder.build());
            return this;
        }

        public Builder addOperations(Operation.Builder builder) {
            copyOnWrite();
            ((ListOperationsResponse) this.instance).m37318N(builder.build());
            return this;
        }

        public Builder addOperations(int i, Operation.Builder builder) {
            copyOnWrite();
            ((ListOperationsResponse) this.instance).m37319M(i, builder.build());
            return this;
        }
    }
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C8804a {
        ...
        static {
            ...
            try {
                f56862a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f56862a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f56862a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f56862a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f56862a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f56862a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: L */
    public final void m37320L(Iterable iterable) {
        m37315Q();
        AbstractMessageLite.addAll(iterable, (List) this.operations_);
    }

    /* renamed from: M */
    public final void m37319M(int i, Operation operation) {
        operation.getClass();
        m37315Q();
    ...
    /* renamed from: N */
    public final void m37318N(Operation operation) {
        operation.getClass();
        m37315Q();
    ...
    /* renamed from: O */
    public final void m37317O() {
        this.nextPageToken_ = getDefaultInstance().getNextPageToken();
    }

    /* renamed from: P */
    public final void m37316P() {
        this.operations_ = GeneratedMessageLite.emptyProtobufList();
    }

    /* renamed from: Q */
    public final void m37315Q() {
    ...
    /* renamed from: R */
    public final void m37314R(int i) {
        m37315Q();
        this.operations_.remove(i);
    }

    /* renamed from: S */
    public final void m37313S(String str) {
        str.getClass();
        this.nextPageToken_ = str;
    }

    /* renamed from: T */
    public final void m37312T(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.nextPageToken_ = byteString.toStringUtf8();
    }

    /* renamed from: U */
    public final void m37311U(int i, Operation operation) {
        operation.getClass();
        m37315Q();
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C8804a.f56862a[methodToInvoke.ordinal()]) {
            case 1:
