...
public final class Fraction extends GeneratedMessageLite<Fraction, Builder> implements FractionOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Fraction, Builder> implements FractionOrBuilder {
        public /* synthetic */ Builder(C9002a c9002a) {
            this();
        }

        public Builder clearDenominator() {
            copyOnWrite();
            ((Fraction) this.instance).m34404G();
            return this;
        }

        public Builder clearNumerator() {
            copyOnWrite();
            ((Fraction) this.instance).m34403H();
            return this;
        }
        ...
        public Builder setDenominator(long j) {
            copyOnWrite();
            ((Fraction) this.instance).m34402I(j);
            return this;
        }

        public Builder setNumerator(long j) {
            copyOnWrite();
            ((Fraction) this.instance).m34401J(j);
            return this;
        }
    ...
    public static /* synthetic */ class C9002a {
        ...
        static {
            ...
            try {
                f57560a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f57560a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f57560a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f57560a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f57560a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f57560a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: G */
    public final void m34404G() {
        this.denominator_ = 0L;
    }

    /* renamed from: H */
    public final void m34403H() {
        this.numerator_ = 0L;
    }

    /* renamed from: I */
    public final void m34402I(long j) {
        this.denominator_ = j;
    }

    /* renamed from: J */
    public final void m34401J(long j) {
        this.numerator_ = j;
    }

    @Override // com.google.protobuf.GeneratedMessageLite
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C9002a.f57560a[methodToInvoke.ordinal()]) {
            case 1:
                return new Fraction();
            case 2:
