...
public final class Quaternion extends GeneratedMessageLite<Quaternion, Builder> implements QuaternionOrBuilder {
    ...
    /* renamed from: w_ */
    private double f57564w_;

    /* renamed from: x_ */
    private double f57565x_;

    /* renamed from: y_ */
    private double f57566y_;

    /* renamed from: z_ */
    private double f57567z_;

    /* loaded from: classes5.dex */
    public static final class Builder extends GeneratedMessageLite.Builder<Quaternion, Builder> implements QuaternionOrBuilder {
        public /* synthetic */ Builder(C9006a c9006a) {
            this();
        }

        public Builder clearW() {
            copyOnWrite();
            ((Quaternion) this.instance).m34292K();
            return this;
        }

        public Builder clearX() {
            copyOnWrite();
            ((Quaternion) this.instance).m34291L();
            return this;
        }

        public Builder clearY() {
            copyOnWrite();
            ((Quaternion) this.instance).m34290M();
            return this;
        }

        public Builder clearZ() {
            copyOnWrite();
            ((Quaternion) this.instance).m34289N();
            return this;
        }
        ...
        public Builder setW(double d) {
            copyOnWrite();
            ((Quaternion) this.instance).m34288O(d);
            return this;
        }

        public Builder setX(double d) {
            copyOnWrite();
            ((Quaternion) this.instance).m34287P(d);
            return this;
        }

        public Builder setY(double d) {
            copyOnWrite();
            ((Quaternion) this.instance).m34286Q(d);
            return this;
        }

        public Builder setZ(double d) {
            copyOnWrite();
            ((Quaternion) this.instance).m34285R(d);
            return this;
        }
    ...
    /* loaded from: classes5.dex */
    public static /* synthetic */ class C9006a {
        ...
        static {
            ...
            try {
                f57568a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f57568a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f57568a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f57568a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f57568a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f57568a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: K */
    public final void m34292K() {
        this.f57564w_ = 0.0d;
    }

    /* renamed from: L */
    public final void m34291L() {
        this.f57565x_ = 0.0d;
    }

    /* renamed from: M */
    public final void m34290M() {
        this.f57566y_ = 0.0d;
    }

    /* renamed from: N */
    public final void m34289N() {
        this.f57567z_ = 0.0d;
    }

    /* renamed from: O */
    public final void m34288O(double d) {
        this.f57564w_ = d;
    }

    /* renamed from: P */
    public final void m34287P(double d) {
        this.f57565x_ = d;
    }

    /* renamed from: Q */
    public final void m34286Q(double d) {
        this.f57566y_ = d;
    }

    /* renamed from: R */
    public final void m34285R(double d) {
        this.f57567z_ = d;
    }

    @Override // com.google.protobuf.GeneratedMessageLite
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C9006a.f57568a[methodToInvoke.ordinal()]) {
            case 1:
    ...
    @Override // com.google.type.QuaternionOrBuilder
    public double getW() {
        return this.f57564w_;
    }

    @Override // com.google.type.QuaternionOrBuilder
    public double getX() {
        return this.f57565x_;
    }

    @Override // com.google.type.QuaternionOrBuilder
    public double getY() {
        return this.f57566y_;
    }

    @Override // com.google.type.QuaternionOrBuilder
    public double getZ() {
        return this.f57567z_;
    }
