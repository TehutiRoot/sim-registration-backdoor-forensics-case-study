...
public final class TimeOfDay extends GeneratedMessageLite<TimeOfDay, Builder> implements TimeOfDayOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<TimeOfDay, Builder> implements TimeOfDayOrBuilder {
        public /* synthetic */ Builder(C9007a c9007a) {
            this();
        }

        public Builder clearHours() {
            copyOnWrite();
            ((TimeOfDay) this.instance).m34275K();
            return this;
        }

        public Builder clearMinutes() {
            copyOnWrite();
            ((TimeOfDay) this.instance).m34274L();
            return this;
        }

        public Builder clearNanos() {
            copyOnWrite();
            ((TimeOfDay) this.instance).m34273M();
            return this;
        }

        public Builder clearSeconds() {
            copyOnWrite();
            ((TimeOfDay) this.instance).m34272N();
            return this;
        }
        ...
        public Builder setHours(int i) {
            copyOnWrite();
            ((TimeOfDay) this.instance).m34271O(i);
            return this;
        }

        public Builder setMinutes(int i) {
            copyOnWrite();
            ((TimeOfDay) this.instance).m34270P(i);
            return this;
        }

        public Builder setNanos(int i) {
            copyOnWrite();
            ((TimeOfDay) this.instance).m34269Q(i);
            return this;
        }

        public Builder setSeconds(int i) {
            copyOnWrite();
            ((TimeOfDay) this.instance).m34268R(i);
            return this;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: O */
    public void m34271O(int i) {
        this.hours_ = i;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: P */
    public void m34270P(int i) {
        this.minutes_ = i;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: Q */
    public void m34269Q(int i) {
        this.nanos_ = i;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: R */
    public void m34268R(int i) {
        this.seconds_ = i;
    }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C9007a.f57569a[methodToInvoke.ordinal()]) {
            case 1:
