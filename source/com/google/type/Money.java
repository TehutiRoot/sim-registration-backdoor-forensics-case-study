...
public final class Money extends GeneratedMessageLite<Money, Builder> implements MoneyOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Money, Builder> implements MoneyOrBuilder {
        public /* synthetic */ Builder(C9004a c9004a) {
            this();
        }

        public Builder clearCurrencyCode() {
            copyOnWrite();
            ((Money) this.instance).m34383J();
            return this;
        }

        public Builder clearNanos() {
            copyOnWrite();
            ((Money) this.instance).m34382K();
            return this;
        }

        public Builder clearUnits() {
            copyOnWrite();
            ((Money) this.instance).m34381L();
            return this;
        }
        ...
        public Builder setCurrencyCode(String str) {
            copyOnWrite();
            ((Money) this.instance).m34380M(str);
            return this;
        }

        public Builder setCurrencyCodeBytes(ByteString byteString) {
            copyOnWrite();
            ((Money) this.instance).m34379N(byteString);
            return this;
        }

        public Builder setNanos(int i) {
            copyOnWrite();
            ((Money) this.instance).m34378O(i);
            return this;
        }

        public Builder setUnits(long j) {
            copyOnWrite();
            ((Money) this.instance).m34377P(j);
            return this;
        }
    ...
    public static /* synthetic */ class C9004a {
        ...
        static {
            ...
            try {
                f57562a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f57562a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f57562a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f57562a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f57562a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f57562a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: J */
    public final void m34383J() {
        this.currencyCode_ = getDefaultInstance().getCurrencyCode();
    }

    /* renamed from: L */
    public final void m34381L() {
        this.units_ = 0L;
    }

    /* renamed from: M */
    public final void m34380M(String str) {
        str.getClass();
        this.currencyCode_ = str;
    }

    /* renamed from: N */
    public final void m34379N(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.currencyCode_ = byteString.toStringUtf8();
    }

    /* renamed from: P */
    public final void m34377P(long j) {
        this.units_ = j;
    }

    @Override // com.google.protobuf.GeneratedMessageLite
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C9004a.f57562a[methodToInvoke.ordinal()]) {
            case 1:
                return new Money();
            case 2:
