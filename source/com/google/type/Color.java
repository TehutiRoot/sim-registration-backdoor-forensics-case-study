...
public final class Color extends GeneratedMessageLite<Color, Builder> implements ColorOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Color, Builder> implements ColorOrBuilder {
        ...
        public Builder clearAlpha() {
            copyOnWrite();
            ((Color) this.instance).m34500L();
            return this;
        }

        public Builder clearBlue() {
            copyOnWrite();
            ((Color) this.instance).m34499M();
            return this;
        }

        public Builder clearGreen() {
            copyOnWrite();
            ((Color) this.instance).m34498N();
            return this;
        }

        public Builder clearRed() {
            copyOnWrite();
            ((Color) this.instance).m34497O();
            return this;
        }
        ...
        public Builder mergeAlpha(FloatValue floatValue) {
            copyOnWrite();
            ((Color) this.instance).m34496P(floatValue);
            return this;
        }

        public Builder setAlpha(FloatValue floatValue) {
            copyOnWrite();
            ((Color) this.instance).m34495Q(floatValue);
            return this;
        }

        public Builder setBlue(float f) {
            copyOnWrite();
            ((Color) this.instance).m34494R(f);
            return this;
        }

        public Builder setGreen(float f) {
            copyOnWrite();
            ((Color) this.instance).m34493S(f);
            return this;
        }

        public Builder setRed(float f) {
            copyOnWrite();
            ((Color) this.instance).m34492T(f);
            return this;
        }
        ...
        public Builder setAlpha(FloatValue.Builder builder) {
            copyOnWrite();
            ((Color) this.instance).m34495Q(builder.build());
            return this;
        }
    }
    ...
    /* renamed from: L */
    public final void m34500L() {
        this.alpha_ = null;
    }

    /* renamed from: M */
    public final void m34499M() {
        this.blue_ = 0.0f;
    }

    /* renamed from: N */
    public final void m34498N() {
        this.green_ = 0.0f;
    }

    /* renamed from: O */
    public final void m34497O() {
        this.red_ = 0.0f;
    }

    /* renamed from: P */
    public final void m34496P(FloatValue floatValue) {
        floatValue.getClass();
    ...
    /* renamed from: Q */
    public final void m34495Q(FloatValue floatValue) {
        floatValue.getClass();
        this.alpha_ = floatValue;
    }

    /* renamed from: R */
    public final void m34494R(float f) {
        this.blue_ = f;
    }

    /* renamed from: S */
    public final void m34493S(float f) {
        this.green_ = f;
    }

    /* renamed from: T */
    public final void m34492T(float f) {
        this.red_ = f;
    }

    @Override // com.google.protobuf.GeneratedMessageLite
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C8996a.f57555a[methodToInvoke.ordinal()]) {
            case 1:
                return new Color();
            case 2:
