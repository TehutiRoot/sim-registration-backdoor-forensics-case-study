...
public final class Functions {
    ...
    public static class ForMapWithDefault<K, V> implements Function<K, V>, Serializable {
        ...
        public V apply(K k) {
            ...
            return (V) AbstractC21740qJ0.m23515a(v);
        }
    ...
    public static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        /* renamed from: f */
        private final Function<A, ? extends B> f52745f;

        /* renamed from: g */
        private final Function<B, C> f52746g;

        public FunctionComposition(Function<B, C> function, Function<A, ? extends B> function2) {
            this.f52746g = (Function) Preconditions.checkNotNull(function);
            this.f52745f = (Function) Preconditions.checkNotNull(function2);
        }

        @Override // com.google.common.base.Function
        public C apply(A a) {
            return this.f52746g.apply(this.f52745f.apply(a));
        }
        ...
        public boolean equals(@CheckForNull Object obj) {
            ...
            if (!this.f52745f.equals(functionComposition.f52745f) || !this.f52746g.equals(functionComposition.f52746g)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f52745f.hashCode() ^ this.f52746g.hashCode();
        }

        public String toString() {
            return this.f52746g + "(" + this.f52745f + ")";
        }
    }
