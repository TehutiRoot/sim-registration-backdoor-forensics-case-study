...
public final class Preconditions {
    /* renamed from: a */
    public static String m41312a(int i, int i2, String str) {
        if (i < 0) {
    ...
    /* renamed from: b */
    public static String m41311b(int i, int i2, String str) {
        if (i < 0) {
            return Strings.lenientFormat("%s (%s) must not be negative", str, Integer.valueOf(i));
        }
        if (i2 >= 0) {
    ...
    public static void checkPositionIndexes(int i, int i2, int i3) {
        ...
        throw new IndexOutOfBoundsException(m41310c(i, i2, i3));
    }
    ...
    public static int checkElementIndex(int i, int i2, String str) {
        if (i < 0 || i >= i2) {
            throw new IndexOutOfBoundsException(m41312a(i, i2, str));
        }
        return i;
    }
    ...
    public static int checkPositionIndex(int i, int i2, String str) {
        if (i < 0 || i > i2) {
            throw new IndexOutOfBoundsException(m41311b(i, i2, str));
        }
        return i;
    }
