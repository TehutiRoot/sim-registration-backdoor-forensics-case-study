...
public enum CaseFormat {
    LOWER_HYPHEN(CharMatcher.m41340is('-'), HelpFormatter.DEFAULT_OPT_PREFIX) { // from class: com.google.common.base.CaseFormat.1
    ...
    LOWER_UNDERSCORE(CharMatcher.m41340is('_'), "_") { // from class: com.google.common.base.CaseFormat.2
        @Override // com.google.common.base.CaseFormat
        public String convert(CaseFormat caseFormat, String str) {
    ...
    UPPER_UNDERSCORE(CharMatcher.m41340is('_'), "_") { // from class: com.google.common.base.CaseFormat.5
        @Override // com.google.common.base.CaseFormat
        public String convert(CaseFormat caseFormat, String str) {
            if (caseFormat == CaseFormat.LOWER_HYPHEN) {
    ...
    public static final class StringConverter extends Converter<String, String> implements Serializable {
        ...
        public String doBackward(String str) {
            return this.targetFormat.m41348to(this.sourceFormat, str);
        }

        @Override // com.google.common.base.Converter
        public String doForward(String str) {
            return this.sourceFormat.m41348to(this.targetFormat, str);
        }
    }
    ...
    /* renamed from: to */
    public final String m41348to(CaseFormat caseFormat, String str) {
