...
public class Finalizer implements Runnable {
    ...
    /* renamed from: d */
    public static final Logger f52810d = Logger.getLogger(Finalizer.class.getName());

    /* renamed from: e */
    public static final Constructor f52811e;

    /* renamed from: f */
    public static final Field f52812f;

    /* renamed from: a */
    public final WeakReference f52813a;

    /* renamed from: b */
    public final PhantomReference f52814b;

    /* renamed from: c */
    public final ReferenceQueue f52815c;

    static {
        Field field;
        Constructor m41239c = m41239c();
        f52811e = m41239c;
        if (m41239c == null) {
            field = m41237f();
        } else {
    ...
    public Finalizer(Class cls, ReferenceQueue referenceQueue, PhantomReference phantomReference) {
        this.f52815c = referenceQueue;
        this.f52813a = new WeakReference(cls);
        this.f52814b = phantomReference;
    }

    /* renamed from: c */
    public static Constructor m41239c() {
        try {
    ...
    /* renamed from: f */
    public static Field m41237f() {
        try {
            Field declaredField = Thread.class.getDeclaredField("inheritableThreadLocals");
            declaredField.setAccessible(true);
            return declaredField;
        } catch (Throwable unused) {
            f52810d.log(Level.INFO, "Couldn't access Thread.inheritableThreadLocals. Reference finalizer threads will inherit thread local values.");
            return null;
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:20:0x005b, code lost:
        com.google.common.base.internal.Finalizer.f52810d.log(java.util.logging.Level.INFO, "Failed to clear thread local values inherited by reference finalizer thread.", r5);
     */
    ...
    */
    public static void startFinalizer(java.lang.Class<?> r5, java.lang.ref.ReferenceQueue<java.lang.Object> r6, java.lang.ref.PhantomReference<java.lang.Object> r7) {
        /*
            ...
            java.lang.reflect.Constructor r6 = com.google.common.base.internal.Finalizer.f52811e
            r7 = 0
            if (r6 == 0) goto L47
            r2 = 0
        ...
        L3d:
            r6 = move-exception
            java.util.logging.Logger r2 = com.google.common.base.internal.Finalizer.f52810d
        ...
        L4f:
            r6.setDaemon(r0)
            java.lang.reflect.Field r5 = com.google.common.base.internal.Finalizer.f52812f     // Catch: java.lang.Throwable -> L5a
            if (r5 == 0) goto L64
            r5.set(r6, r7)     // Catch: java.lang.Throwable -> L5a
            goto L64
        L5a:
            r5 = move-exception
            java.util.logging.Logger r7 = com.google.common.base.internal.Finalizer.f52810d
    ...
    /* renamed from: a */
    public final boolean m41241a(Reference reference) {
        Reference poll;
        Method m41238d = m41238d();
        if (m41238d == null || !m41240b(reference, m41238d)) {
            return false;
        }
        do {
            poll = this.f52815c.poll();
            if (poll == null) {
                return true;
            }
        } while (m41240b(poll, m41238d));
        return false;
    }

    /* renamed from: b */
    public final boolean m41240b(Reference reference, Method method) {
        reference.clear();
        if (reference == this.f52814b) {
            return false;
        }
        try {
            ...
            f52810d.log(Level.SEVERE, "Error cleaning up after reference.", th2);
            return true;
        }
    }

    /* renamed from: d */
    public final Method m41238d() {
        Class cls = (Class) this.f52813a.get();
        if (cls == null) {
            return null;
        }
        try {
    ...
    public void run() {
        while (m41241a(this.f52815c.remove())) {
        }
    }
}
