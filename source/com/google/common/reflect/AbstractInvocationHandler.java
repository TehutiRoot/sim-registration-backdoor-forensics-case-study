...
public abstract class AbstractInvocationHandler implements InvocationHandler {
    ...
    /* renamed from: a */
    public static final Object[] f54085a = new Object[0];

    /* renamed from: a */
    public static boolean m39797a(Object obj, Class cls) {
    ...
    public final Object invoke(Object obj, Method method, @CheckForNull Object[] objArr) throws Throwable {
        ...
        if (objArr.length == 1 && method.getName().equals("equals") && method.getParameterTypes()[0] == Object.class) {
            ...
            return Boolean.valueOf((m39797a(obj2, obj.getClass()) && equals(Proxy.getInvocationHandler(obj2))) ? false : false);
