...
public abstract class ImmutableSortedSet<E> extends ImmutableSet<E> implements NavigableSet<E>, InterfaceC21400oK1 {
    ...
    public static final class Builder<E> extends ImmutableSet.Builder<E> {
        ...
        /* renamed from: f */
        public final Comparator f53198f;

        public Builder(Comparator<? super E> comparator) {
            this.f53198f = (Comparator) Preconditions.checkNotNull(comparator);
        }

        /* JADX WARN: Multi-variable type inference failed */
        @Override // com.google.common.collect.ImmutableSet.Builder, com.google.common.collect.ImmutableCollection.AbstractC7620a, com.google.common.collect.ImmutableCollection.Builder
        ...
        /* renamed from: f */
        public Builder mo40855e(ImmutableSet.Builder builder) {
            super.mo40855e(builder);
            return this;
        }
        ...
        public ImmutableSortedSet<E> build() {
            ImmutableSortedSet<E> construct = ImmutableSortedSet.construct(this.f53198f, this.f53140b, this.f53139a);
    ...
    public static <E> ImmutableSortedSet<E> copyOfSorted(SortedSet<E> sortedSet) {
        Comparator m23698a = AbstractC21572pK1.m23698a(sortedSet);
        ImmutableList copyOf = ImmutableList.copyOf((Collection) sortedSet);
        if (copyOf.isEmpty()) {
            return emptySet(m23698a);
        }
        return new RegularImmutableSortedSet(copyOf, m23698a);
    }
    ...
    public static <E> RegularImmutableSortedSet<E> emptySet(Comparator<? super E> comparator) {
        ...
        return new RegularImmutableSortedSet<>(ImmutableList.m40998of(), comparator);
    }
    ...
    /* renamed from: of */
    public static <E> ImmutableSortedSet<E> m40868of() {
    ...
    public static <E> Collector<E, ?, ImmutableSortedSet<E>> toImmutableSortedSet(Comparator<? super E> comparator) {
        return AbstractC7963f.m40291y0(comparator);
    }
    ...
    @Override // java.util.SortedSet, p000.InterfaceC21400oK1
    ...
    /* JADX WARN: Incorrect types in method signature: <E::Ljava/lang/Comparable<-TE;>;>(TE;)Lcom/google/common/collect/ImmutableSortedSet<TE;>; */
    /* renamed from: of */
    public static ImmutableSortedSet m40867of(Comparable comparable) {
        return new RegularImmutableSortedSet(ImmutableList.m40997of(comparable), Ordering.natural());
    }
    ...
    /* renamed from: of */
    public static ImmutableSortedSet m40866of(Comparable comparable, Comparable comparable2) {
    ...
    /* renamed from: of */
    public static ImmutableSortedSet m40865of(Comparable comparable, Comparable comparable2, Comparable comparable3) {
    ...
    /* renamed from: of */
    public static ImmutableSortedSet m40864of(Comparable comparable, Comparable comparable2, Comparable comparable3, Comparable comparable4) {
    ...
    /* renamed from: of */
    public static ImmutableSortedSet m40863of(Comparable comparable, Comparable comparable2, Comparable comparable3, Comparable comparable4, Comparable comparable5) {
    ...
    /* renamed from: of */
    public static ImmutableSortedSet m40862of(Comparable comparable, Comparable comparable2, Comparable comparable3, Comparable comparable4, Comparable comparable5, Comparable comparable6, Comparable... comparableArr) {
    ...
    public static <E> ImmutableSortedSet<E> copyOf(Comparator<? super E> comparator, Iterable<? extends E> iterable) {
        ...
        if (AbstractC21572pK1.m23697b(comparator, iterable) && (iterable instanceof ImmutableSortedSet)) {
        ...
        return construct(comparator, m40845f.length, m40845f);
    }
    ...
    @Deprecated
    /* renamed from: of */
    public static <E> ImmutableSortedSet<E> m40861of(E e) {
        throw new UnsupportedOperationException();
    }
    ...
    @Deprecated
    /* renamed from: of */
    public static <E> ImmutableSortedSet<E> m40860of(E e, E e2) {
        throw new UnsupportedOperationException();
    }
    ...
    @Deprecated
    /* renamed from: of */
    public static <E> ImmutableSortedSet<E> m40859of(E e, E e2, E e3) {
        throw new UnsupportedOperationException();
    }
    ...
    @Deprecated
    /* renamed from: of */
    public static <E> ImmutableSortedSet<E> m40858of(E e, E e2, E e3, E e4) {
        throw new UnsupportedOperationException();
    }
    ...
    @Deprecated
    /* renamed from: of */
    public static <E> ImmutableSortedSet<E> m40857of(E e, E e2, E e3, E e4, E e5) {
        throw new UnsupportedOperationException();
    }
    ...
    @Deprecated
    /* renamed from: of */
    public static <E> ImmutableSortedSet<E> m40856of(E e, E e2, E e3, E e4, E e5, E e6, E... eArr) {
        throw new UnsupportedOperationException();
    }
}
