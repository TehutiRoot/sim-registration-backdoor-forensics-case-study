...
public class ImmutableSetMultimap<K, V> extends ImmutableMultimap<K, V> implements SetMultimap<K, V> {
    ...
    public static final class Builder<K, V> extends ImmutableMultimap.Builder<K, V> {
        ...
        public int mo40917c(int i, Iterable iterable) {
            if (iterable instanceof Set) {
                return Math.max(i, ((Set) iterable).size());
            }
            return i;
        }
        ...
        public ImmutableCollection.Builder mo40916d(int i) {
            Comparator comparator = this.f53161c;
            if (comparator == null) {
        ...
        /* renamed from: e */
        public Builder m40915e(ImmutableMultimap.Builder builder) {
        ...
        public ImmutableSetMultimap<K, V> build() {
            ...
            return ImmutableSetMultimap.fromMapBuilderEntries(entrySet, this.f53161c);
        }
    ...
    public static final class C7639a {
        ...
        /* renamed from: a */
        public static final AbstractC7983m.C7985b f53189a = AbstractC7983m.m40221a(ImmutableSetMultimap.class, "emptySet");
    }
    ...
    public static <T, K, V> Collector<T, ?, ImmutableSetMultimap<K, V>> flatteningToImmutableSetMultimap(Function<? super T, ? extends K> function, Function<? super T, ? extends Stream<? extends V>> function2) {
        return AbstractC7963f.m40362E(function, function2);
    }
    ...
    /* renamed from: of */
    public static <K, V> ImmutableSetMultimap<K, V> m40923of() {
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        if (readInt >= 0) {
            ...
            for (int i2 = 0; i2 < readInt; i2++) {
                ...
                if (readInt2 > 0) {
                    ...
                    for (int i3 = 0; i3 < readInt2; i3++) {
                        ...
                        valuesBuilder.add((ImmutableSet.Builder) readObject2);
                    }
            ...
            try {
                ...
                C7639a.f53189a.m40209b(this, emptySet(comparator));
                return;
    ...
    public static <T, K, V> Collector<T, ?, ImmutableSetMultimap<K, V>> toImmutableSetMultimap(Function<? super T, ? extends K> function, Function<? super T, ? extends V> function2) {
        return AbstractC7963f.m40297v0(function, function2);
    }
    ...
    /* renamed from: of */
    public static <K, V> ImmutableSetMultimap<K, V> m40922of(K k, V v) {
        Builder builder = builder();
    ...
    /* renamed from: of */
    public static <K, V> ImmutableSetMultimap<K, V> m40921of(K k, V v, K k2, V v2) {
        Builder builder = builder();
        builder.put((Builder) k, (K) v);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableSetMultimap<K, V> m40920of(K k, V v, K k2, V v2, K k3, V v3) {
        Builder builder = builder();
        builder.put((Builder) k, (K) v);
        builder.put((Builder) k2, (K) v2);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableSetMultimap<K, V> m40919of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4) {
        Builder builder = builder();
        builder.put((Builder) k, (K) v);
        builder.put((Builder) k2, (K) v2);
        builder.put((Builder) k3, (K) v3);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableSetMultimap<K, V> m40918of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5) {
        Builder builder = builder();
        builder.put((Builder) k, (K) v);
        builder.put((Builder) k2, (K) v2);
        builder.put((Builder) k3, (K) v3);
