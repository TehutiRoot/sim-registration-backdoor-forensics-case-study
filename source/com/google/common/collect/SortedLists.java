...
public abstract class SortedLists {
    ...
    /* renamed from: a */
    public static int m40535a(List list, Function function, Comparable comparable, KeyPresentBehavior keyPresentBehavior, KeyAbsentBehavior keyAbsentBehavior) {
        Preconditions.checkNotNull(comparable);
        return m40534b(list, function, comparable, Ordering.natural(), keyPresentBehavior, keyAbsentBehavior);
    }

    /* renamed from: b */
    public static int m40534b(List list, Function function, Object obj, Comparator comparator, KeyPresentBehavior keyPresentBehavior, KeyAbsentBehavior keyAbsentBehavior) {
        return m40533c(Lists.transform(list, function), obj, comparator, keyPresentBehavior, keyAbsentBehavior);
    }

    /* renamed from: c */
    public static int m40533c(List list, Object obj, Comparator comparator, KeyPresentBehavior keyPresentBehavior, KeyAbsentBehavior keyAbsentBehavior) {
