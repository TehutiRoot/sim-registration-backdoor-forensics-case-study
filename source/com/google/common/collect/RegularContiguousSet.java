...
public final class RegularContiguousSet<C extends Comparable> extends ContiguousSet<C> {
    ...
    public static final class SerializedForm<C extends Comparable> implements Serializable {
        ...
        public /* synthetic */ SerializedForm(Range range, DiscreteDomain discreteDomain, C7835a c7835a) {
    ...
    /* loaded from: classes4.dex */
    public class C7835a extends AbstractSequentialIterator {

        /* renamed from: b */
        public final Comparable f53501b;

        public C7835a(Comparable comparable) {
            super(comparable);
            this.f53501b = RegularContiguousSet.this.last();
        }

        @Override // com.google.common.collect.AbstractSequentialIterator
        /* renamed from: a */
        public Comparable computeNext(Comparable comparable) {
            if (RegularContiguousSet.equalsOrThrow(comparable, this.f53501b)) {
                return null;
            }
    ...
    /* loaded from: classes4.dex */
    public class C7836b extends AbstractSequentialIterator {

        /* renamed from: b */
        public final Comparable f53503b;

        public C7836b(Comparable comparable) {
            super(comparable);
            this.f53503b = RegularContiguousSet.this.first();
        }

        @Override // com.google.common.collect.AbstractSequentialIterator
        /* renamed from: a */
        public Comparable computeNext(Comparable comparable) {
            if (RegularContiguousSet.equalsOrThrow(comparable, this.f53503b)) {
                return null;
            }
