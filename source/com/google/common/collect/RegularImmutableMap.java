...
public final class RegularImmutableMap<K, V> extends ImmutableMap<K, V> {
    ...
    private static Object createHashTable(Object[] objArr, int i, int i2, int i3) {
        ImmutableMap.Builder.C7624a c7624a = null;
        if (i == 1) {
            Object obj = objArr[i3];
            Objects.requireNonNull(obj);
            Object obj2 = objArr[i3 ^ 1];
            Objects.requireNonNull(obj2);
            AbstractC5406bs.m51815a(obj, obj2);
            return null;
        }
        int i4 = i2 - 1;
        int i5 = -1;
        if (i2 <= 128) {
            ...
            for (int i7 = 0; i7 < i; i7++) {
                ...
                AbstractC5406bs.m51815a(obj3, obj4);
                int m903c = AbstractC22736w70.m903c(obj3.hashCode());
                while (true) {
                    int i10 = m903c & i4;
                    ...
                    if (i11 == 255) {
                        ...
                        c7624a = new ImmutableMap.Builder.C7624a(obj3, obj4, obj5);
                        objArr[i12] = obj4;
                        break;
                    } else {
                        m903c = i10 + 1;
            ...
            return i6 == i ? bArr : new Object[]{bArr, Integer.valueOf(i6), c7624a};
        } else if (i2 <= 32768) {
            ...
            for (int i14 = 0; i14 < i; i14++) {
                ...
                AbstractC5406bs.m51815a(obj6, obj7);
                int m903c2 = AbstractC22736w70.m903c(obj6.hashCode());
                while (true) {
                    int i17 = m903c2 & i4;
                    ...
                    if (i18 == 65535) {
                        ...
                        c7624a = new ImmutableMap.Builder.C7624a(obj6, obj7, obj8);
                        objArr[i19] = obj7;
                        break;
                    } else {
                        m903c2 = i17 + 1;
            ...
            return i13 == i ? sArr : new Object[]{sArr, Integer.valueOf(i13), c7624a};
        } else {
            int[] iArr = new int[i2];
            Arrays.fill(iArr, -1);
            int i20 = 0;
            ...
            while (i20 < i) {
                ...
                AbstractC5406bs.m51815a(obj9, obj10);
                int m903c3 = AbstractC22736w70.m903c(obj9.hashCode());
                while (true) {
                    int i24 = m903c3 & i4;
                    int i25 = iArr[i24];
                    if (i25 == i5) {
                        ...
                        c7624a = new ImmutableMap.Builder.C7624a(obj9, obj10, obj11);
                        objArr[i26] = obj10;
                        break;
                    } else {
                        m903c3 = i24 + 1;
            ...
            return i21 == i ? iArr : new Object[]{iArr, Integer.valueOf(i21), c7624a};
        }
    }
    ...
    public static Object createHashTableOrThrow(Object[] objArr, int i, int i2, int i3) {
        ...
        throw ((ImmutableMap.Builder.C7624a) ((Object[]) createHashTable)[2]).m40960a();
    }
    ...
    public static <K, V> RegularImmutableMap<K, V> create(int i, Object[] objArr, ImmutableMap.Builder<K, V> builder) {
        ...
        if (createHashTable instanceof Object[]) {
            ...
            ImmutableMap.Builder.C7624a c7624a = (ImmutableMap.Builder.C7624a) objArr2[2];
            if (builder != null) {
                builder.f53147e = c7624a;
    ...
    public static Object get(@CheckForNull Object obj, Object[] objArr, int i, int i2, @CheckForNull Object obj2) {
        ...
        if (i == 1) {
            ...
            if (obj instanceof byte[]) {
                ...
                int m903c = AbstractC22736w70.m903c(obj2.hashCode());
                while (true) {
                    int i3 = m903c & length;
                    int i4 = bArr[i3] & 255;
                    if (i4 == 255) {
                ...
                int m903c2 = AbstractC22736w70.m903c(obj2.hashCode());
                while (true) {
                    int i5 = m903c2 & length2;
                ...
                int m903c3 = AbstractC22736w70.m903c(obj2.hashCode());
                while (true) {
                    int i7 = m903c3 & length3;
                    int i8 = iArr[i7];
                    if (i8 == -1) {
                        return null;
                    }
