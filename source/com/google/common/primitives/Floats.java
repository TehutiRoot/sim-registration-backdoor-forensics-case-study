...
public final class Floats extends AbstractC18934a30 {
    ...
    public static class FloatArrayAsList extends AbstractList<Float> implements RandomAccess, Serializable {
        ...
        public boolean contains(@CheckForNull Object obj) {
            if ((obj instanceof Float) && Floats.m39853d(this.array, ((Float) obj).floatValue(), this.start, this.end) != -1) {
                return true;
            }
            return false;
        }
        ...
        public int indexOf(@CheckForNull Object obj) {
            int m39853d;
            if ((obj instanceof Float) && (m39853d = Floats.m39853d(this.array, ((Float) obj).floatValue(), this.start, this.end)) >= 0) {
                return m39853d - this.start;
            }
            return -1;
        }
        ...
        public int lastIndexOf(@CheckForNull Object obj) {
            int m39852e;
            if ((obj instanceof Float) && (m39852e = Floats.m39852e(this.array, ((Float) obj).floatValue(), this.start, this.end)) >= 0) {
                return m39852e - this.start;
            }
            return -1;
        }
    ...
    /* renamed from: c */
    public static int m39854c(long j) {
        boolean z;
        int i = (int) j;
        if (j == i) {
            z = true;
    ...
    public static float[] concat(float[]... fArr) {
        ...
        float[] fArr3 = new float[m39854c(j)];
        int i = 0;
        for (float[] fArr4 : fArr) {
            System.arraycopy(fArr4, 0, fArr3, i, fArr4.length);
            i += fArr4.length;
        }
        return fArr3;
    }
    ...
    /* renamed from: d */
    public static int m39853d(float[] fArr, float f, int i, int i2) {
        while (i < i2) {
            if (fArr[i] == f) {
                return i;
            }
    ...
    /* renamed from: e */
    public static int m39852e(float[] fArr, float f, int i, int i2) {
    ...
    public static int indexOf(float[] fArr, float f) {
        return m39853d(fArr, f, 0, fArr.length);
    }
    ...
    public static int lastIndexOf(float[] fArr, float f) {
        return m39852e(fArr, f, 0, fArr.length);
    }
    ...
    public static Float tryParse(String str) {
        if (Doubles.f54070a.matcher(str).matches()) {
            try {
