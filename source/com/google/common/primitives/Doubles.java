...
public final class Doubles extends AbstractC1746YJ {
    public static final int BYTES = 8;

    /* renamed from: a */
    public static final Pattern f54070a = m39859d();
    ...
    public static class DoubleArrayAsList extends AbstractList<Double> implements RandomAccess, Serializable {
        ...
        public boolean contains(@CheckForNull Object obj) {
            if ((obj instanceof Double) && Doubles.m39858e(this.array, ((Double) obj).doubleValue(), this.start, this.end) != -1) {
                return true;
            }
            return false;
        }
        ...
        public int indexOf(@CheckForNull Object obj) {
            int m39858e;
            if ((obj instanceof Double) && (m39858e = Doubles.m39858e(this.array, ((Double) obj).doubleValue(), this.start, this.end)) >= 0) {
                return m39858e - this.start;
            }
            return -1;
        }
        ...
        public int lastIndexOf(@CheckForNull Object obj) {
            int m39857f;
            if ((obj instanceof Double) && (m39857f = Doubles.m39857f(this.array, ((Double) obj).doubleValue(), this.start, this.end)) >= 0) {
                return m39857f - this.start;
            }
            return -1;
        }
    ...
    /* renamed from: c */
    public static int m39860c(long j) {
        boolean z;
        int i = (int) j;
        if (j == i) {
            z = true;
    ...
    public static double[] concat(double[]... dArr) {
        ...
        double[] dArr3 = new double[m39860c(j)];
        int i = 0;
        for (double[] dArr4 : dArr) {
            System.arraycopy(dArr4, 0, dArr3, i, dArr4.length);
            i += dArr4.length;
        }
        return dArr3;
    }
    ...
    /* renamed from: e */
    public static int m39858e(double[] dArr, double d, int i, int i2) {
        while (i < i2) {
            if (dArr[i] == d) {
                return i;
            }
    ...
    /* renamed from: f */
    public static int m39857f(double[] dArr, double d, int i, int i2) {
    ...
    public static int indexOf(double[] dArr, double d) {
        return m39858e(dArr, d, 0, dArr.length);
    }
    ...
    public static int lastIndexOf(double[] dArr, double d) {
        return m39857f(dArr, d, 0, dArr.length);
    }
    ...
    public static Double tryParse(String str) {
        if (f54070a.matcher(str).matches()) {
            try {
