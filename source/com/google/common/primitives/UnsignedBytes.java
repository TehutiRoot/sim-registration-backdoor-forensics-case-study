...
public final class UnsignedBytes {
    ...
    public static class LexicographicalComparatorHolder {
        ...
        /* renamed from: a */
        public static final String f54080a = LexicographicalComparatorHolder.class.getName() + "$UnsafeComparator";

        /* renamed from: b */
        public static final Comparator f54081b = m39802a();
        ...
        public enum UnsafeComparator implements Comparator<byte[]> {
            ...
            /* loaded from: classes4.dex */
            public class C8134a implements PrivilegedExceptionAction {
            ...
            private static Unsafe getUnsafe() {
                try {
                    try {
                        ...
                        return (Unsafe) AccessController.doPrivileged(new C8134a());
                    }
        ...
        /* renamed from: a */
        public static Comparator m39802a() {
            try {
                Object[] enumConstants = Class.forName(f54080a).getEnumConstants();
                Objects.requireNonNull(enumConstants);
                return (Comparator) enumConstants[0];
            } catch (Throwable unused) {
                return UnsignedBytes.m39803b();
            }
        }
    }

    /* renamed from: a */
    public static byte m39804a(byte b) {
        return (byte) (b ^ 128);
    }

    /* renamed from: b */
    public static Comparator m39803b() {
    ...
    public static Comparator<byte[]> lexicographicalComparator() {
        return LexicographicalComparatorHolder.f54081b;
    }
    ...
    public static void sort(byte[] bArr, int i, int i2) {
        ...
        for (int i3 = i; i3 < i2; i3++) {
            bArr[i3] = m39804a(bArr[i3]);
        }
        Arrays.sort(bArr, i, i2);
        while (i < i2) {
            bArr[i] = m39804a(bArr[i]);
            i++;
        }
    }
