...
public final class Longs {
    ...
    public static class LongArrayAsList extends AbstractList<Long> implements RandomAccess, Serializable {
        ...
        public boolean contains(@CheckForNull Object obj) {
            if ((obj instanceof Long) && Longs.m39813d(this.array, ((Long) obj).longValue(), this.start, this.end) != -1) {
                return true;
            }
            return false;
        }
        ...
        public int indexOf(@CheckForNull Object obj) {
            int m39813d;
            if ((obj instanceof Long) && (m39813d = Longs.m39813d(this.array, ((Long) obj).longValue(), this.start, this.end)) >= 0) {
                return m39813d - this.start;
            }
            return -1;
        }
        ...
        public int lastIndexOf(@CheckForNull Object obj) {
            int m39812e;
            if ((obj instanceof Long) && (m39812e = Longs.m39812e(this.array, ((Long) obj).longValue(), this.start, this.end)) >= 0) {
                return m39812e - this.start;
            }
            return -1;
        }
    ...
    public static final class C8133a {
        ...
        /* renamed from: a */
        public static final byte[] f54077a;
        ...
        /* renamed from: a */
        public static int m39811a(char c) {
            if (c < 128) {
                return f54077a[c];
            }
            return -1;
    ...
    /* renamed from: c */
    public static int m39814c(long j) {
        boolean z;
        int i = (int) j;
        if (j == i) {
            z = true;
    ...
    /* renamed from: d */
    public static int m39813d(long[] jArr, long j, int i, int i2) {
        while (i < i2) {
            if (jArr[i] == j) {
                return i;
            }
    ...
    /* renamed from: e */
    public static int m39812e(long[] jArr, long j, int i, int i2) {
    ...
    public static int indexOf(long[] jArr, long j) {
        return m39813d(jArr, j, 0, jArr.length);
    }
    ...
    public static int lastIndexOf(long[] jArr, long j) {
        return m39812e(jArr, j, 0, jArr.length);
    }
    ...
    */
    ...
    public static Long tryParse(String str, int i) {
        ...
        if (i >= 2 && i <= 36) {
            ...
            int i3 = i2 + 1;
            int m39811a = C8133a.m39811a(str.charAt(i2));
            if (m39811a < 0 || m39811a >= i) {
                return null;
            }
            long j = -m39811a;
            long j2 = i;
            ...
            while (i3 < str.length()) {
                int i4 = i3 + 1;
                int m39811a2 = C8133a.m39811a(str.charAt(i3));
                if (m39811a2 < 0 || m39811a2 >= i || j < j3) {
                    return null;
                }
                long j4 = j * j2;
                long j5 = m39811a2;
