...
public final class ImmutableDoubleArray implements Serializable {
    ...
    /* renamed from: of */
    public static ImmutableDoubleArray m39851of() {
        return EMPTY;
    }
    ...
    /* renamed from: of */
    public static ImmutableDoubleArray m39850of(double d) {
    ...
    public static final class Builder {
        ...
        /* renamed from: a */
        public double[] f54071a;

        /* renamed from: b */
        public int f54072b = 0;

        public Builder(int i) {
            this.f54071a = new double[i];
        }

        /* renamed from: b */
        public static int m39842b(int i, int i2) {
            if (i2 >= 0) {
                int i3 = i + (i >> 1) + 1;
                if (i3 < i2) {
        ...
        /* renamed from: a */
        public final void m39843a(int i) {
            int i2 = this.f54072b + i;
            double[] dArr = this.f54071a;
            if (i2 > dArr.length) {
                this.f54071a = Arrays.copyOf(dArr, m39842b(dArr.length, i2));
            }
        }
        ...
        public Builder addAll(double[] dArr) {
            m39843a(dArr.length);
            System.arraycopy(dArr, 0, this.f54071a, this.f54072b, dArr.length);
            this.f54072b += dArr.length;
            return this;
        }
        ...
        public ImmutableDoubleArray build() {
            ...
            return new ImmutableDoubleArray(this.f54071a, 0, this.f54072b);
        }
        ...
        public Builder addAll(ImmutableDoubleArray immutableDoubleArray) {
            m39843a(immutableDoubleArray.length());
            System.arraycopy(immutableDoubleArray.array, immutableDoubleArray.start, this.f54071a, this.f54072b, immutableDoubleArray.length());
            this.f54072b += immutableDoubleArray.length();
            return this;
        }
    }
    ...
    /* renamed from: of */
    public static ImmutableDoubleArray m39849of(double d, double d2) {
    ...
    /* renamed from: of */
    public static ImmutableDoubleArray m39848of(double d, double d2, double d3) {
    ...
    /* renamed from: of */
    public static ImmutableDoubleArray m39847of(double d, double d2, double d3, double d4) {
        return new ImmutableDoubleArray(new double[]{d, d2, d3, d4});
    }

    /* renamed from: of */
    public static ImmutableDoubleArray m39846of(double d, double d2, double d3, double d4, double d5) {
        return new ImmutableDoubleArray(new double[]{d, d2, d3, d4, d5});
    }

    /* renamed from: of */
    public static ImmutableDoubleArray m39845of(double d, double d2, double d3, double d4, double d5, double d6) {
        return new ImmutableDoubleArray(new double[]{d, d2, d3, d4, d5, d6});
    }

    /* renamed from: of */
    public static ImmutableDoubleArray m39844of(double d, double... dArr) {
