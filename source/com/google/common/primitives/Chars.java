...
public final class Chars {
    ...
    public static class CharArrayAsList extends AbstractList<Character> implements RandomAccess, Serializable {
        ...
        public boolean contains(@CheckForNull Object obj) {
            if ((obj instanceof Character) && Chars.m39864d(this.array, ((Character) obj).charValue(), this.start, this.end) != -1) {
                return true;
            }
            return false;
        }
        ...
        public int indexOf(@CheckForNull Object obj) {
            int m39864d;
            if ((obj instanceof Character) && (m39864d = Chars.m39864d(this.array, ((Character) obj).charValue(), this.start, this.end)) >= 0) {
                return m39864d - this.start;
            }
            return -1;
        }
        ...
        public int lastIndexOf(@CheckForNull Object obj) {
            int m39863e;
            if ((obj instanceof Character) && (m39863e = Chars.m39863e(this.array, ((Character) obj).charValue(), this.start, this.end)) >= 0) {
                return m39863e - this.start;
            }
            return -1;
        }
        ...
        public Character set(int i, Character ch2) {
            ...
            int i2 = this.start;
            char c = cArr[i2 + i];
            cArr[i2 + i] = ((Character) Preconditions.checkNotNull(ch2)).charValue();
    ...
    /* renamed from: c */
    public static int m39865c(long j) {
        boolean z;
        int i = (int) j;
        if (j == i) {
            z = true;
    ...
    public static char[] concat(char[]... cArr) {
        ...
        char[] cArr3 = new char[m39865c(j)];
        int i = 0;
        for (char[] cArr4 : cArr) {
            System.arraycopy(cArr4, 0, cArr3, i, cArr4.length);
            i += cArr4.length;
        }
        return cArr3;
    }
    ...
    /* renamed from: d */
    public static int m39864d(char[] cArr, char c, int i, int i2) {
        while (i < i2) {
            if (cArr[i] == c) {
                return i;
            }
    ...
    /* renamed from: e */
    public static int m39863e(char[] cArr, char c, int i, int i2) {
    ...
    public static int indexOf(char[] cArr, char c) {
        return m39864d(cArr, c, 0, cArr.length);
    }
    ...
    public static int lastIndexOf(char[] cArr, char c) {
        return m39863e(cArr, c, 0, cArr.length);
    }
