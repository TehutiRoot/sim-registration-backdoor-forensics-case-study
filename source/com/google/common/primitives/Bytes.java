...
public final class Bytes {
    ...
    public static class ByteArrayAsList extends AbstractList<Byte> implements RandomAccess, Serializable {
        ...
        public boolean contains(@CheckForNull Object obj) {
            if ((obj instanceof Byte) && Bytes.m39869d(this.array, ((Byte) obj).byteValue(), this.start, this.end) != -1) {
                return true;
            }
            return false;
        }
        ...
        public int indexOf(@CheckForNull Object obj) {
            int m39869d;
            if ((obj instanceof Byte) && (m39869d = Bytes.m39869d(this.array, ((Byte) obj).byteValue(), this.start, this.end)) >= 0) {
                return m39869d - this.start;
            }
            return -1;
        }
        ...
        public int lastIndexOf(@CheckForNull Object obj) {
            int m39868e;
            if ((obj instanceof Byte) && (m39868e = Bytes.m39868e(this.array, ((Byte) obj).byteValue(), this.start, this.end)) >= 0) {
                return m39868e - this.start;
            }
            return -1;
        }
    ...
    /* renamed from: c */
    public static int m39870c(long j) {
        boolean z;
        int i = (int) j;
        if (j == i) {
            z = true;
    ...
    /* renamed from: d */
    public static int m39869d(byte[] bArr, byte b, int i, int i2) {
        while (i < i2) {
            if (bArr[i] == b) {
                return i;
            }
    ...
    /* renamed from: e */
    public static int m39868e(byte[] bArr, byte b, int i, int i2) {
    ...
    public static int indexOf(byte[] bArr, byte b) {
        return m39869d(bArr, b, 0, bArr.length);
    }

    public static int lastIndexOf(byte[] bArr, byte b) {
        return m39868e(bArr, b, 0, bArr.length);
    }
