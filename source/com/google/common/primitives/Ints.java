...
public final class Ints extends AbstractC20247hg0 {
    ...
    public static class IntArrayAsList extends AbstractList<Integer> implements RandomAccess, Serializable {
        ...
        public boolean contains(@CheckForNull Object obj) {
            if ((obj instanceof Integer) && Ints.m39818d(this.array, ((Integer) obj).intValue(), this.start, this.end) != -1) {
                return true;
            }
            return false;
        }
        ...
        public int indexOf(@CheckForNull Object obj) {
            int m39818d;
            if ((obj instanceof Integer) && (m39818d = Ints.m39818d(this.array, ((Integer) obj).intValue(), this.start, this.end)) >= 0) {
                return m39818d - this.start;
            }
            return -1;
        }
        ...
        public int lastIndexOf(@CheckForNull Object obj) {
            int m39817e;
            if ((obj instanceof Integer) && (m39817e = Ints.m39817e(this.array, ((Integer) obj).intValue(), this.start, this.end)) >= 0) {
                return m39817e - this.start;
            }
            return -1;
        }
    ...
    /* renamed from: c */
    public static int m39819c(long j) {
        boolean z;
        int i = (int) j;
        if (j == i) {
            z = true;
    ...
    public static int constrainToRange(int i, int i2, int i3) {
        ...
        Preconditions.checkArgument(z, "min (%s) must be less than or equal to max (%s)", i2, i3);
    ...
    /* renamed from: d */
    public static int m39818d(int[] iArr, int i, int i2, int i3) {
        while (i2 < i3) {
            if (iArr[i2] == i) {
                return i2;
            }
    ...
    /* renamed from: e */
    public static int m39817e(int[] iArr, int i, int i2, int i3) {
    ...
    public static int indexOf(int[] iArr, int i) {
        return m39818d(iArr, i, 0, iArr.length);
    }
    ...
    public static int lastIndexOf(int[] iArr, int i) {
        return m39817e(iArr, i, 0, iArr.length);
    }
