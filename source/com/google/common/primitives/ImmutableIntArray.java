...
public final class ImmutableIntArray implements Serializable {
    ...
    /* renamed from: of */
    public static ImmutableIntArray m39841of() {
        return EMPTY;
    }
    ...
    /* renamed from: of */
    public static ImmutableIntArray m39840of(int i) {
    ...
    public static final class Builder {
        ...
        public Builder(int i) {
            this.f54073a = new int[i];
        }

        /* renamed from: b */
        public static int m39832b(int i, int i2) {
            if (i2 >= 0) {
                int i3 = i + (i >> 1) + 1;
                if (i3 < i2) {
        ...
        /* renamed from: a */
        public final void m39833a(int i) {
            int i2 = this.f54074b + i;
            int[] iArr = this.f54073a;
            if (i2 > iArr.length) {
                this.f54073a = Arrays.copyOf(iArr, m39832b(iArr.length, i2));
            }
        }
        ...
        public Builder addAll(int[] iArr) {
            m39833a(iArr.length);
            System.arraycopy(iArr, 0, this.f54073a, this.f54074b, iArr.length);
            this.f54074b += iArr.length;
            return this;
        }
        ...
        public ImmutableIntArray build() {
            ...
            return new ImmutableIntArray(this.f54073a, 0, this.f54074b);
        }
        ...
        public Builder addAll(ImmutableIntArray immutableIntArray) {
            m39833a(immutableIntArray.length());
            System.arraycopy(immutableIntArray.array, immutableIntArray.start, this.f54073a, this.f54074b, immutableIntArray.length());
            this.f54074b += immutableIntArray.length();
            return this;
        }
    }
    ...
    /* renamed from: of */
    public static ImmutableIntArray m39839of(int i, int i2) {
        return new ImmutableIntArray(new int[]{i, i2});
    }

    /* renamed from: of */
    public static ImmutableIntArray m39838of(int i, int i2, int i3) {
        return new ImmutableIntArray(new int[]{i, i2, i3});
    }

    /* renamed from: of */
    public static ImmutableIntArray m39837of(int i, int i2, int i3, int i4) {
        return new ImmutableIntArray(new int[]{i, i2, i3, i4});
    }

    /* renamed from: of */
    public static ImmutableIntArray m39836of(int i, int i2, int i3, int i4, int i5) {
        return new ImmutableIntArray(new int[]{i, i2, i3, i4, i5});
    }

    /* renamed from: of */
    public static ImmutableIntArray m39835of(int i, int i2, int i3, int i4, int i5, int i6) {
        return new ImmutableIntArray(new int[]{i, i2, i3, i4, i5, i6});
    }

    /* renamed from: of */
    public static ImmutableIntArray m39834of(int i, int... iArr) {
