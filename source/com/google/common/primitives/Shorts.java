...
public final class Shorts extends II1 {
    ...
    public static class ShortArrayAsList extends AbstractList<Short> implements RandomAccess, Serializable {
        ...
        public boolean contains(@CheckForNull Object obj) {
            if ((obj instanceof Short) && Shorts.m39806d(this.array, ((Short) obj).shortValue(), this.start, this.end) != -1) {
                return true;
            }
            return false;
        }
        ...
        public int indexOf(@CheckForNull Object obj) {
            int m39806d;
            if ((obj instanceof Short) && (m39806d = Shorts.m39806d(this.array, ((Short) obj).shortValue(), this.start, this.end)) >= 0) {
                return m39806d - this.start;
            }
            return -1;
        }
        ...
        public int lastIndexOf(@CheckForNull Object obj) {
            int m39805e;
            if ((obj instanceof Short) && (m39805e = Shorts.m39805e(this.array, ((Short) obj).shortValue(), this.start, this.end)) >= 0) {
                return m39805e - this.start;
            }
            return -1;
        }
    ...
    /* renamed from: c */
    public static int m39807c(long j) {
        boolean z;
        int i = (int) j;
        if (j == i) {
            z = true;
    ...
    public static short[] concat(short[]... sArr) {
        ...
        short[] sArr3 = new short[m39807c(j)];
        int i = 0;
        for (short[] sArr4 : sArr) {
            System.arraycopy(sArr4, 0, sArr3, i, sArr4.length);
            i += sArr4.length;
        }
        return sArr3;
    }
    ...
    /* renamed from: d */
    public static int m39806d(short[] sArr, short s, int i, int i2) {
        while (i < i2) {
            if (sArr[i] == s) {
                return i;
            }
    ...
    /* renamed from: e */
    public static int m39805e(short[] sArr, short s, int i, int i2) {
    ...
    public static int indexOf(short[] sArr, short s) {
        return m39806d(sArr, s, 0, sArr.length);
    }
    ...
    public static int lastIndexOf(short[] sArr, short s) {
        return m39805e(sArr, s, 0, sArr.length);
    }
