...
public final class CombinedFuture extends AggregateFuture {
    ...
    /* renamed from: p */
    public CombinedFutureInterruptibleTask f54309p;
    ...
    public final class AsyncCallableInterruptibleTask extends CombinedFutureInterruptibleTask<ListenableFuture<Object>> {
        ...
        public ListenableFuture<Object> m74051runInterruptibly() throws Exception {
    ...
    public abstract class CombinedFutureInterruptibleTask<T> extends InterruptibleTask<T> {
        ...
        public final void afterRanInterruptiblyFailure(Throwable th2) {
            CombinedFuture.this.f54309p = null;
    ...
    public CombinedFuture(ImmutableCollection immutableCollection, boolean z, Executor executor, AsyncCallable asyncCallable) {
        ...
        this.f54309p = new AsyncCallableInterruptibleTask(asyncCallable, executor);
        m39607O();
    }

    @Override // com.google.common.util.concurrent.AggregateFuture
    /* renamed from: J */
    public void mo39363J(int i, Object obj) {
    }

    @Override // com.google.common.util.concurrent.AggregateFuture
    /* renamed from: M */
    public void mo39362M() {
        CombinedFutureInterruptibleTask combinedFutureInterruptibleTask = this.f54309p;
    ...
    public CombinedFuture(ImmutableCollection immutableCollection, boolean z, Executor executor, Callable callable) {
        super(immutableCollection, z, false);
        this.f54309p = new CallableInterruptibleTask(callable, executor);
        m39607O();
    }
}
