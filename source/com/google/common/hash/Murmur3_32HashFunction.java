...
public final class Murmur3_32HashFunction extends AbstractC0710K implements Serializable {

    /* renamed from: C1 */
    private static final int f53855C1 = -862048943;

    /* renamed from: C2 */
    private static final int f53856C2 = 461845907;
    ...
    static final HashFunction GOOD_FAST_HASH_32 = new Murmur3_32HashFunction(Hashing.f53838a, true);

    /* renamed from: com.google.common.hash.Murmur3_32HashFunction$a */
    /* loaded from: classes4.dex */
    public static final class C8066a extends AbstractC0776L {
        ...
        /* renamed from: d */
        public int f53860d = 0;

        /* renamed from: e */
        public boolean f53861e = false;
        ...
        /* renamed from: a */
        public final void m40037a(int i, long j) {
            long j2 = this.f53858b;
            ...
            this.f53860d += i;
            if (i3 >= 32) {
                this.f53857a = Murmur3_32HashFunction.mixH1(this.f53857a, Murmur3_32HashFunction.mixK1((int) j4));
                this.f53858b >>>= 32;
                this.f53859c -= 32;
            }
        }
        ...
        public HashCode hash() {
            Preconditions.checkState(!this.f53861e);
            this.f53861e = true;
            int mixK1 = this.f53857a ^ Murmur3_32HashFunction.mixK1((int) this.f53858b);
            this.f53857a = mixK1;
            return Murmur3_32HashFunction.fmix(mixK1, this.f53860d);
        }
        ...
        public Hasher putString(CharSequence charSequence, Charset charset) {
            if (StandardCharsets.UTF_8.equals(charset)) {
                ...
                while (true) {
                    ...
                    m40037a(4, (charAt2 << '\b') | charAt | (charAt3 << 16) | (charAt4 << 24));
                    i = i2;
                }
                while (i < length) {
                    ...
                    if (charAt5 < 128) {
                        ...
                        m40037a(2, Murmur3_32HashFunction.charToTwoUtf8Bytes(charAt5));
                    } else if (charAt5 < 55296 || charAt5 > 57343) {
                        m40037a(3, Murmur3_32HashFunction.charToThreeUtf8Bytes(charAt5));
                    } else {
                        int codePointAt = Character.codePointAt(charSequence, i);
                        if (codePointAt != charAt5) {
                            i++;
                            m40037a(4, Murmur3_32HashFunction.codePointToFourUtf8Bytes(codePointAt));
                        } else {
        ...
        public Hasher putBytes(byte[] bArr, int i, int i2) {
            ...
            while (true) {
                ...
                m40037a(4, Murmur3_32HashFunction.getIntLittleEndian(bArr, i3 + i));
                i3 = i4;
            }
            while (i3 < i2) {
                putByte(bArr[i + i3]);
    ...
    public static int mixK1(int i) {
        return Integer.rotateLeft(i * f53855C1, 15) * f53856C2;
    }
