...
public final class Funnels {
    ...
    /* loaded from: classes4.dex */
    public static class C8045a extends OutputStream {

        /* renamed from: a */
        public final PrimitiveSink f53837a;

        public C8045a(PrimitiveSink primitiveSink) {
            this.f53837a = (PrimitiveSink) Preconditions.checkNotNull(primitiveSink);
        }

        public String toString() {
            return "Funnels.asOutputStream(" + this.f53837a + ")";
        }

        @Override // java.io.OutputStream
        public void write(int i) {
            this.f53837a.putByte((byte) i);
        }

        @Override // java.io.OutputStream
        public void write(byte[] bArr) {
            this.f53837a.putBytes(bArr);
        }

        @Override // java.io.OutputStream
        public void write(byte[] bArr, int i, int i2) {
            this.f53837a.putBytes(bArr, i, i2);
        }
    }

    public static OutputStream asOutputStream(PrimitiveSink primitiveSink) {
        return new C8045a(primitiveSink);
    }
