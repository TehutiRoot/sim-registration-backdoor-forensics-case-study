...
public final class BloomFilter<T> implements Predicate<T>, Serializable {
    ...
    private final BloomFilterStrategies.C8042a bits;
    ...
    public static class SerialForm<T> implements Serializable {
        ...
        public SerialForm(BloomFilter<T> bloomFilter) {
            this.data = BloomFilterStrategies.C8042a.m40055h(((BloomFilter) bloomFilter).bits.f53833a);
        ...
        public Object readResolve() {
            return new BloomFilter(new BloomFilterStrategies.C8042a(this.data), this.numHashFunctions, this.funnel, this.strategy);
        }
    }

    /* loaded from: classes4.dex */
    public interface Strategy extends Serializable {
        <T> boolean mightContain(T t, Funnel<? super T> funnel, int i, BloomFilterStrategies.C8042a c8042a);

        int ordinal();

        <T> boolean put(T t, Funnel<? super T> funnel, int i, BloomFilterStrategies.C8042a c8042a);
    }
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        BloomFilterStrategies.C8042a c8042a = new BloomFilterStrategies.C8042a(LongMath.checkedMultiply(readInt, 64L));
                        for (int i3 = 0; i3 < readInt; i3++) {
                            c8042a.m40057f(i3, dataInputStream.readLong());
                        }
                        return new BloomFilter<>(c8042a, i2, funnel, bloomFilterStrategies);
                    } catch (Exception e2) {
                        e = e2;
                        b = readByte;
                        i = readInt;
    ...
    public long approximateElementCount() {
        double m40061b = this.bits.m40061b();
        return DoubleMath.roundToLong(((-Math.log1p(-(this.bits.m40062a() / m40061b))) * m40061b) / this.numHashFunctions, RoundingMode.HALF_UP);
    }

    @VisibleForTesting
    public long bitSize() {
        return this.bits.m40061b();
    }

    public BloomFilter<T> copy() {
        return new BloomFilter<>(this.bits.m40060c(), this.numHashFunctions, this.funnel, this.strategy);
    }
    ...
    public double expectedFpp() {
        return Math.pow(this.bits.m40062a() / bitSize(), this.numHashFunctions);
    }
    ...
    public void putAll(BloomFilter<T> bloomFilter) {
        ...
        this.bits.m40058e(bloomFilter.bits);
    }
    ...
    public void writeTo(OutputStream outputStream) throws IOException {
        ...
        dataOutputStream.writeInt(this.bits.f53833a.length());
        for (int i = 0; i < this.bits.f53833a.length(); i++) {
            dataOutputStream.writeLong(this.bits.f53833a.get(i));
        }
    }

    private BloomFilter(BloomFilterStrategies.C8042a c8042a, int i, Funnel<? super T> funnel, Strategy strategy) {
        ...
        this.bits = (BloomFilterStrategies.C8042a) Preconditions.checkNotNull(c8042a);
    ...
    public static <T> BloomFilter<T> create(Funnel<? super T> funnel, long j, double d, Strategy strategy) {
        ...
        try {
            return new BloomFilter<>(new BloomFilterStrategies.C8042a(optimalNumOfBits), optimalNumOfHashFunctions(j, optimalNumOfBits), funnel, strategy);
