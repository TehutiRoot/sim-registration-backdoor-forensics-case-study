...
public final class BigIntegerMath {
    ...
    /* renamed from: a */
    public static final BigInteger f53984a = new BigInteger("16a09e667f3bcc908b2fb1366ea957d3e3adec17512775099da2f590b0667322a", 16);

    /* renamed from: b */
    public static final double f53985b = Math.log(10.0d);

    /* renamed from: c */
    public static final double f53986c = Math.log(2.0d);

    /* renamed from: com.google.common.math.BigIntegerMath$a */
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C8115a {
        ...
        static {
            ...
            try {
                f53987a[RoundingMode.DOWN.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f53987a[RoundingMode.FLOOR.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f53987a[RoundingMode.UP.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f53987a[RoundingMode.CEILING.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f53987a[RoundingMode.HALF_DOWN.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f53987a[RoundingMode.HALF_UP.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f53987a[RoundingMode.HALF_EVEN.ordinal()] = 8;
    ...
    /* loaded from: classes4.dex */
    public static class C8116b extends AbstractC22280tT1 {

        /* renamed from: a */
        public static final C8116b f53988a = new C8116b();

        @Override // p000.AbstractC22280tT1
        /* renamed from: f */
        public BigInteger mo22415a(BigInteger bigInteger, BigInteger bigInteger2) {
            return bigInteger.subtract(bigInteger2);
        }

        @Override // p000.AbstractC22280tT1
        /* renamed from: g */
        public double mo22413c(BigInteger bigInteger) {
            return AbstractC1671XJ.m65524a(bigInteger);
        }

        @Override // p000.AbstractC22280tT1
        /* renamed from: h */
        public int mo22412d(BigInteger bigInteger) {
            return bigInteger.signum();
        }

        @Override // p000.AbstractC22280tT1
        /* renamed from: i */
        public BigInteger mo22411e(double d, RoundingMode roundingMode) {
            return DoubleMath.roundToBigInteger(d, roundingMode);
        }
    }

    /* renamed from: a */
    public static boolean m39970a(BigInteger bigInteger) {
    ...
    /* renamed from: b */
    public static BigInteger m39969b(List list) {
        return m39968c(list, 0, list.size());
    }
    ...
    /* renamed from: c */
    public static BigInteger m39968c(List list, int i, int i2) {
        int i3 = i2 - i;
        if (i3 != 0) {
            if (i3 != 1) {
                if (i3 != 2) {
                    if (i3 != 3) {
                        int i4 = (i2 + i) >>> 1;
                        return m39968c(list, i, i4).multiply(m39968c(list, i4, i2));
                    }
    ...
    /* renamed from: d */
    public static BigInteger m39967d(BigInteger bigInteger) {
        return DoubleMath.roundToBigInteger(Math.sqrt(AbstractC1671XJ.m65524a(bigInteger)), RoundingMode.HALF_EVEN);
    }
    ...
    /* renamed from: e */
    public static BigInteger m39966e(BigInteger bigInteger) {
        BigInteger shiftLeft;
        int log2 = log2(bigInteger, RoundingMode.FLOOR);
        if (log2 < 1023) {
            shiftLeft = m39967d(bigInteger);
        } else {
            int i = (log2 - 52) & (-2);
            shiftLeft = m39967d(bigInteger.shiftRight(i)).shiftLeft(i >> 1);
        }
    ...
    public static BigInteger factorial(int i) {
        ...
        return m39969b(arrayList).shiftLeft(numberOfTrailingZeros);
    }
    ...
    public static int log10(BigInteger bigInteger, RoundingMode roundingMode) {
        int i;
        boolean z;
        AbstractC21312nr0.m25999j("x", bigInteger);
        if (m39970a(bigInteger)) {
            return LongMath.log10(bigInteger.longValue(), roundingMode);
        }
        int log2 = (int) ((log2(bigInteger, RoundingMode.FLOOR) * f53986c) / f53985b);
        ...
        switch (C8115a.f53987a[roundingMode.ordinal()]) {
            case 1:
                if (i == 0) {
                    z = true;
                } else {
    ...
    public static int log2(BigInteger bigInteger, RoundingMode roundingMode) {
        AbstractC21312nr0.m25999j("x", (BigInteger) Preconditions.checkNotNull(bigInteger));
        int bitLength = bigInteger.bitLength();
        int i = bitLength - 1;
        switch (C8115a.f53987a[roundingMode.ordinal()]) {
            case 1:
                AbstractC21312nr0.m25998k(isPowerOfTwo(bigInteger));
                break;
            case 2:
            case 3:
                break;
            ...
            case 8:
                if (i < 256) {
                    if (bigInteger.compareTo(f53984a.shiftRight(256 - i)) <= 0) {
                        return i;
                    }
                    return bitLength;
    ...
    public static double roundToDouble(BigInteger bigInteger, RoundingMode roundingMode) {
        return C8116b.f53988a.m22414b(bigInteger, roundingMode);
    }

    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    @GwtIncompatible
    public static BigInteger sqrt(BigInteger bigInteger, RoundingMode roundingMode) {
        AbstractC21312nr0.m26002g("x", bigInteger);
        if (m39970a(bigInteger)) {
            return BigInteger.valueOf(LongMath.sqrt(bigInteger.longValue(), roundingMode));
        }
        BigInteger m39966e = m39966e(bigInteger);
        switch (C8115a.f53987a[roundingMode.ordinal()]) {
            case 1:
                AbstractC21312nr0.m25998k(m39966e.pow(2).equals(bigInteger));
                break;
            case 2:
            case 3:
                break;
            case 4:
            case 5:
                int intValue = m39966e.intValue();
                if (intValue * intValue != bigInteger.intValue() || !m39966e.pow(2).equals(bigInteger)) {
                    return m39966e.add(BigInteger.ONE);
                }
                return m39966e;
            case 6:
            case 7:
            case 8:
                if (m39966e.pow(2).add(m39966e).compareTo(bigInteger) < 0) {
                    return m39966e.add(BigInteger.ONE);
                }
                return m39966e;
            default:
