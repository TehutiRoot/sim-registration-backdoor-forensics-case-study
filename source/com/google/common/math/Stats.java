...
public final class Stats implements Serializable {
    ...
    /* renamed from: of */
    public static Stats m39930of(Iterable<? extends Number> iterable) {
    ...
    public double populationVariance() {
        ...
        return AbstractC1671XJ.m65523b(this.sumOfSquaresOfDeltas) / count();
    }
    ...
    public double sampleVariance() {
        ...
        return AbstractC1671XJ.m65523b(this.sumOfSquaresOfDeltas) / (this.count - 1);
    }
    ...
    public static double meanOf(Iterator<? extends Number> it) {
        ...
        while (it.hasNext()) {
            ...
            j++;
            doubleValue = (Doubles.isFinite(doubleValue2) && Doubles.isFinite(doubleValue)) ? doubleValue + ((doubleValue2 - doubleValue) / j) : StatsAccumulator.m39925a(doubleValue, doubleValue2);
        }
        return doubleValue;
    }

    /* renamed from: of */
    public static Stats m39929of(Iterator<? extends Number> it) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
    ...
    /* renamed from: of */
    public static Stats m39928of(double... dArr) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
    ...
    public static double meanOf(double... dArr) {
        ...
        for (int i = 1; i < dArr.length; i++) {
            double d2 = dArr[i];
            d = (Doubles.isFinite(d2) && Doubles.isFinite(d)) ? d + ((d2 - d) / (i + 1)) : StatsAccumulator.m39925a(d, d2);
        }
        return d;
    }

    /* renamed from: of */
    public static Stats m39927of(int... iArr) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
    ...
    /* renamed from: of */
    public static Stats m39926of(long... jArr) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
