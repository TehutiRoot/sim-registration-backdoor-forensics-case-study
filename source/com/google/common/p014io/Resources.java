...
public final class Resources {
    ...
    /* loaded from: classes4.dex */
    public class C8112a implements LineProcessor {

        /* renamed from: a */
        public final List f53981a = Lists.newArrayList();
    ...
    /* loaded from: classes4.dex */
    public static final class C8113b extends ByteSource {

        /* renamed from: a */
        public final URL f53982a;

        public /* synthetic */ C8113b(URL url, C8112a c8112a) {
            this(url);
        }

        @Override // com.google.common.p014io.ByteSource
        public InputStream openStream() {
            return this.f53982a.openStream();
        }

        public String toString() {
            return "Resources.asByteSource(" + this.f53982a + ")";
        }

        public C8113b(URL url) {
            this.f53982a = (URL) Preconditions.checkNotNull(url);
        }
    }

    public static ByteSource asByteSource(URL url) {
        return new C8113b(url, null);
    }
    ...
    public static List<String> readLines(URL url, Charset charset) throws IOException {
        return (List) readLines(url, charset, new C8112a());
    }
