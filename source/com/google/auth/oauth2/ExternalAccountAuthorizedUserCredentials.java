...
public class ExternalAccountAuthorizedUserCredentials extends GoogleCredentials {
    ...
    public static class Builder extends GoogleCredentials.Builder {
        ...
        /* renamed from: d */
        public HttpTransportFactory f52439d;
        ...
        public Builder setHttpTransportFactory(HttpTransportFactory httpTransportFactory) {
            this.f52439d = httpTransportFactory;
            return this;
        }
        ...
        public Builder(ExternalAccountAuthorizedUserCredentials externalAccountAuthorizedUserCredentials) {
            ...
            this.f52439d = externalAccountAuthorizedUserCredentials.transportFactory;
            this.f52440e = externalAccountAuthorizedUserCredentials.audience;
            this.f52441f = externalAccountAuthorizedUserCredentials.refreshToken;
            this.f52442g = externalAccountAuthorizedUserCredentials.tokenUrl;
            this.f52443h = externalAccountAuthorizedUserCredentials.tokenInfoUrl;
            this.f52444i = externalAccountAuthorizedUserCredentials.revokeUrl;
            this.f52445j = externalAccountAuthorizedUserCredentials.clientId;
            this.f52446k = externalAccountAuthorizedUserCredentials.clientSecret;
        }
    ...
    public AccessToken refreshAccessToken() throws IOException {
        if (canRefresh()) {
            try {
                ...
                execute.disconnect();
                String m68789j = CJ0.m68789j(genericData, "access_token", PARSE_ERROR_PREFIX);
                Date date = new Date(this.clock.currentTimeMillis() + (CJ0.m68794e(genericData, "expires_in", PARSE_ERROR_PREFIX) * 1000));
                String m68790i = CJ0.m68790i(genericData, "refresh_token", PARSE_ERROR_PREFIX);
                if (m68790i != null && m68790i.trim().length() > 0) {
                    this.refreshToken = m68790i;
                }
                return AccessToken.newBuilder().setExpirationTime(date).setTokenValue(m68789j).build();
    ...
    private ExternalAccountAuthorizedUserCredentials(Builder builder) {
        super(builder);
        HttpTransportFactory httpTransportFactory = (HttpTransportFactory) MoreObjects.firstNonNull(builder.f52439d, OAuth2Credentials.getFromServiceLoader(HttpTransportFactory.class, CJ0.f694e));
        this.transportFactory = httpTransportFactory;
        this.transportFactoryClassName = httpTransportFactory.getClass().getName();
        this.audience = builder.f52440e;
        this.refreshToken = builder.f52441f;
        this.tokenUrl = builder.f52442g;
        this.tokenInfoUrl = builder.f52443h;
        this.revokeUrl = builder.f52444i;
        this.clientId = builder.f52445j;
        this.clientSecret = builder.f52446k;
