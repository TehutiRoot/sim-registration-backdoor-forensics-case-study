...
public class ImpersonatedCredentials extends GoogleCredentials implements ServiceAccountSigner, IdTokenProvider {
    ...
    public static class Builder extends GoogleCredentials.Builder {
        ...
        /* renamed from: d */
        public GoogleCredentials f52465d;
        ...
        /* renamed from: i */
        public HttpTransportFactory f52470i;

        /* renamed from: j */
        public String f52471j;

        /* renamed from: k */
        public Calendar f52472k;

        public Builder() {
            this.f52469h = 3600;
            this.f52472k = Calendar.getInstance();
        }
        ...
        public Builder setHttpTransportFactory(HttpTransportFactory httpTransportFactory) {
            this.f52470i = httpTransportFactory;
            return this;
        }
        ...
        public Builder setSourceCredentials(GoogleCredentials googleCredentials) {
            this.f52465d = googleCredentials;
            return this;
        }
        ...
        public Builder(ImpersonatedCredentials impersonatedCredentials) {
            ...
            this.f52469h = 3600;
            this.f52472k = Calendar.getInstance();
            this.f52465d = impersonatedCredentials.sourceCredentials;
            this.f52466e = impersonatedCredentials.targetPrincipal;
            this.f52467f = impersonatedCredentials.delegates;
            this.f52468g = impersonatedCredentials.scopes;
            this.f52469h = impersonatedCredentials.lifetime;
            this.f52470i = impersonatedCredentials.transportFactory;
            this.f52471j = impersonatedCredentials.iamEndpointOverride;
        }
    }
    ...
    public IdToken idTokenWithAudience(String str, List<IdTokenProvider.Option> list) throws IOException {
        ...
        return AbstractC7376e.m41489b(getAccount(), this.sourceCredentials, this.transportFactory.create(), str, z, ImmutableMap.m40975of("delegates", this.delegates), getMetricsCredentialType());
    }
    ...
    public AccessToken refreshAccessToken() throws IOException {
        ...
        JsonObjectParser jsonObjectParser = new JsonObjectParser(CJ0.f695f);
        ...
        HttpRequest buildPostRequest = createRequestFactory.buildPostRequest(genericUrl, new JsonHttpContent(jsonObjectParser.getJsonFactory(), ImmutableMap.m40973of("delegates", (String) list, Action.SCOPE_ATTRIBUTE, (String) list2, "lifetime", this.lifetime + OperatorName.CLOSE_AND_STROKE)));
        ...
        try {
            ...
            execute.disconnect();
            String m68789j = CJ0.m68789j(genericData, "accessToken", "Expected to find an accessToken");
            String m68789j2 = CJ0.m68789j(genericData, "expireTime", "Expected to find an expireTime");
            SimpleDateFormat simpleDateFormat = new SimpleDateFormat(RFC3339);
            simpleDateFormat.setCalendar(this.calendar);
            try {
                return new AccessToken(m68789j, simpleDateFormat.parse(m68789j2));
    ...
    public byte[] sign(byte[] bArr) {
        return AbstractC7376e.m41486e(getAccount(), this.sourceCredentials, this.transportFactory.create(), bArr, ImmutableMap.m40975of("delegates", this.delegates));
    }
    ...
    private ImpersonatedCredentials(Builder builder) throws IOException {
        ...
        this.transportFactory = (HttpTransportFactory) MoreObjects.firstNonNull(builder.getHttpTransportFactory(), OAuth2Credentials.getFromServiceLoader(HttpTransportFactory.class, CJ0.f694e));
        this.iamEndpointOverride = builder.f52471j;
