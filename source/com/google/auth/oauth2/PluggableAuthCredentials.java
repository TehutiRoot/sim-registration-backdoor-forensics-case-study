...
public class PluggableAuthCredentials extends ExternalAccountCredentials {
    ...
    public static class Builder extends ExternalAccountCredentials.Builder {
        ...
        /* renamed from: d */
        public ExecutableHandler f52496d;
        ...
        public Builder setExecutableHandler(ExecutableHandler executableHandler) {
            this.f52496d = executableHandler;
            return this;
        }
        ...
        public Builder(PluggableAuthCredentials pluggableAuthCredentials) {
            ...
            this.f52496d = pluggableAuthCredentials.handler;
        }
    ...
    /* loaded from: classes4.dex */
    public class C7356a implements ExecutableHandler.ExecutableOptions {

        /* renamed from: a */
        public final /* synthetic */ String f52497a;

        /* renamed from: b */
        public final /* synthetic */ Map f52498b;

        /* renamed from: c */
        public final /* synthetic */ int f52499c;

        /* renamed from: d */
        public final /* synthetic */ String f52500d;

        public C7356a(String str, Map map, int i, String str2) {
            this.f52497a = str;
            this.f52498b = map;
            this.f52499c = i;
            this.f52500d = str2;
    ...
    public PluggableAuthCredentials(Builder builder) {
        ...
        if (builder.f52496d != null) {
            this.handler = builder.f52496d;
        } else {
            this.handler = new C7377f(getEnvironmentProvider());
        }
    }
    ...
    public String retrieveSubjectToken() throws IOException {
        ...
        return this.handler.mo41485a(new C7356a(command, hashMap, timeoutMs, outputFilePath));
    }
