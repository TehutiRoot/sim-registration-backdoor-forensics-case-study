...
public class IdentityPoolCredentials extends ExternalAccountCredentials {
    ...
    public static class Builder extends ExternalAccountCredentials.Builder {
        ...
        /* renamed from: d */
        public IdentityPoolSubjectTokenSupplier f52464d;
        ...
        public Builder setSubjectTokenSupplier(IdentityPoolSubjectTokenSupplier identityPoolSubjectTokenSupplier) {
            this.f52464d = identityPoolSubjectTokenSupplier;
            return this;
        }
        ...
        public Builder(IdentityPoolCredentials identityPoolCredentials) {
            ...
            if (this.credentialSource == null) {
                this.f52464d = identityPoolCredentials.subjectTokenSupplier;
            }
        }
    ...
    public IdentityPoolCredentials(Builder builder) {
        ...
        if (builder.f52464d != null && identityPoolCredentialSource != null) {
        ...
        if (builder.f52464d != null) {
            this.subjectTokenSupplier = builder.f52464d;
