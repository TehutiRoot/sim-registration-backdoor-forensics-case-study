...
public class IdToken extends AccessToken implements Serializable {
    ...
    public static IdToken create(String str) throws IOException {
        return create(str, CJ0.f695f);
    }

    private void readObject(ObjectInputStream objectInputStream) throws ClassNotFoundException, IOException {
        this.jsonWebSignature = JsonWebSignature.parse(CJ0.f695f, (String) objectInputStream.readObject());
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!Objects.equals(super.getTokenValue(), idToken.getTokenValue()) || !Objects.equals(this.jsonWebSignature.getHeader(), idToken.jsonWebSignature.getHeader()) || !Objects.equals(this.jsonWebSignature.getPayload(), idToken.jsonWebSignature.getPayload())) {
            return false;
        }
        return true;
    }
