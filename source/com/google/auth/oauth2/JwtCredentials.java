...
public class JwtCredentials extends Credentials implements JwtProvider {
    ...
    public static class Builder {
        ...
        /* renamed from: a */
        public PrivateKey f52473a;

        /* renamed from: b */
        public String f52474b;

        /* renamed from: c */
        public JwtClaims f52475c;

        /* renamed from: d */
        public Clock f52476d = Clock.SYSTEM;

        /* renamed from: e */
        public Long f52477e = Long.valueOf(TimeUnit.HOURS.toSeconds(1));

        /* renamed from: a */
        public Clock m41644a() {
            return this.f52476d;
        }

        /* renamed from: b */
        public Builder m41643b(Clock clock) {
            this.f52476d = (Clock) Preconditions.checkNotNull(clock);
            return this;
        }
        ...
        public Builder setJwtClaims(JwtClaims jwtClaims) {
            this.f52475c = (JwtClaims) Preconditions.checkNotNull(jwtClaims);
            return this;
        }

        @CanIgnoreReturnValue
        public Builder setLifeSpanSeconds(Long l) {
            this.f52477e = (Long) Preconditions.checkNotNull(l);
            return this;
        }

        @CanIgnoreReturnValue
        public Builder setPrivateKey(PrivateKey privateKey) {
            this.f52473a = (PrivateKey) Preconditions.checkNotNull(privateKey);
            return this;
        }
    ...
    public void refresh() throws IOException {
        ...
        synchronized (this.lock) {
            try {
                ...
                try {
                    this.jwt = JsonWebSignature.signUsingRsaSha256(this.privateKey, CJ0.f695f, header, payload);
    ...
    private JwtCredentials(Builder builder) {
        ...
        this.clock = (Clock) Preconditions.checkNotNull(builder.m41644a());
    }
}
