...
public class MaterialRadioButton extends AppCompatRadioButton {
    ...
    /* renamed from: g */
    public static final int f50470g = R.style.Widget_MaterialComponents_CompoundButton_RadioButton;

    /* renamed from: h */
    public static final int[][] f50471h = {new int[]{16842910, 16842912}, new int[]{16842910, -16842912}, new int[]{-16842910, 16842912}, new int[]{-16842910, -16842912}};

    /* renamed from: e */
    public ColorStateList f50472e;
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.f50472e == null) {
            ...
            this.f50472e = new ColorStateList(iArr, iArr2);
        }
        return this.f50472e;
    }
    ...
    public void onAttachedToWindow() {
        ...
        if (this.f50473f && CompoundButtonCompat.getButtonTintList(this) == null) {
    ...
    */
    public MaterialRadioButton(@androidx.annotation.NonNull android.content.Context r8, @androidx.annotation.Nullable android.util.AttributeSet r9, int r10) {
        /*
            r7 = this;
            int r4 = com.google.android.material.radiobutton.MaterialRadioButton.f50470g
