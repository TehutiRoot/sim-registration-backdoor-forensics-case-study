...
public interface CircularRevealWidget extends CircularRevealHelper.Delegate {
    ...
    public static class CircularRevealEvaluator implements TypeEvaluator<RevealInfo> {
        ...
        /* renamed from: a */
        public final RevealInfo f49569a = new RevealInfo();

        @Override // android.animation.TypeEvaluator
        @NonNull
        public RevealInfo evaluate(float f, @NonNull RevealInfo revealInfo, @NonNull RevealInfo revealInfo2) {
            this.f49569a.set(MathUtils.lerp(revealInfo.centerX, revealInfo2.centerX, f), MathUtils.lerp(revealInfo.centerY, revealInfo2.centerY, f), MathUtils.lerp(revealInfo.radius, revealInfo2.radius, f));
            return this.f49569a;
        }
    }
