...
public final class CircularRevealCompat {
    ...
    /* loaded from: classes4.dex */
    public class C6883a extends AnimatorListenerAdapter {

        /* renamed from: a */
        public final /* synthetic */ CircularRevealWidget f49555a;

        public C6883a(CircularRevealWidget circularRevealWidget) {
            this.f49555a = circularRevealWidget;
        }

        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        public void onAnimationEnd(Animator animator) {
            this.f49555a.destroyCircularRevealCache();
        }

        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        public void onAnimationStart(Animator animator) {
            this.f49555a.buildCircularRevealCache();
        }
    }
    ...
    public static Animator.AnimatorListener createCircularRevealListener(@NonNull CircularRevealWidget circularRevealWidget) {
        return new C6883a(circularRevealWidget);
    }
