...
public class FabTransformationSheetBehavior extends FabTransformationBehavior {
    ...
    /* renamed from: y */
    public final void m43539y(View view, boolean z) {
        boolean z2;
        ...
        if (z) {
            this.f51298i = new HashMap(childCount);
        }
        for (int i = 0; i < childCount; i++) {
            ...
            if (childAt != view && !z2) {
                if (!z) {
                    Map map = this.f51298i;
                    if (map != null && map.containsKey(childAt)) {
                        ViewCompat.setImportantForAccessibility(childAt, ((Integer) this.f51298i.get(childAt)).intValue());
                    }
                } else {
                    this.f51298i.put(childAt, Integer.valueOf(childAt.getImportantForAccessibility()));
