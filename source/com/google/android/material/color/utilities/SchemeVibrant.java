...
public class SchemeVibrant extends DynamicScheme {
    ...
    /* renamed from: a */
    public static final double[] f49686a = {0.0d, 41.0d, 61.0d, 101.0d, 131.0d, 181.0d, 251.0d, 301.0d, 360.0d};

    /* renamed from: b */
    public static final double[] f49687b = {18.0d, 15.0d, 10.0d, 12.0d, 15.0d, 18.0d, 15.0d, 12.0d, 12.0d};

    /* renamed from: c */
    public static final double[] f49688c = {35.0d, 30.0d, 20.0d, 25.0d, 30.0d, 35.0d, 30.0d, 25.0d, 25.0d};
    ...
    */
    public SchemeVibrant(com.google.android.material.color.utilities.Hct r12, boolean r13, double r14) {
        /*
            ...
            double[] r0 = com.google.android.material.color.utilities.SchemeVibrant.f49686a
            double[] r1 = com.google.android.material.color.utilities.SchemeVibrant.f49687b
            ...
            double[] r1 = com.google.android.material.color.utilities.SchemeVibrant.f49688c
