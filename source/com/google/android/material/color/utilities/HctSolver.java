...
public class HctSolver {
    ...
    /* renamed from: b */
    public static double[] m45294b(double d, double d2) {
        int m45291e;
        int m45290f;
        double[][] m45293c = m45293c(d, d2);
        double[] dArr = m45293c[0];
        double m45288h = m45288h(dArr);
        double[] dArr2 = m45293c[1];
        for (int i = 0; i < 3; i++) {
            double d3 = dArr[i];
            double d4 = dArr2[i];
            if (d3 != d4) {
                if (d3 < d4) {
                    m45291e = m45290f(m45279q(d3));
                    m45290f = m45291e(m45279q(dArr2[i]));
                } else {
                    m45291e = m45291e(m45279q(d3));
                    m45290f = m45290f(m45279q(dArr2[i]));
                }
                int i2 = m45291e;
                int i3 = m45290f;
                for (int i4 = 0; i4 < 8 && Math.abs(i3 - i2) > 1; i4++) {
                    int floor = (int) Math.floor((i2 + i3) / 2.0d);
                    double[] m45280p = m45280p(dArr, f49633d[floor], dArr2, i);
                    double m45288h2 = m45288h(m45280p);
                    if (m45295a(m45288h, d2, m45288h2)) {
                        dArr2 = m45280p;
                        i3 = floor;
                    } else {
                        dArr = m45280p;
        ...
        return m45283m(dArr, dArr2);
    }

    /* renamed from: c */
    public static double[][] m45293c(double d, double d2) {
        ...
        boolean z2 = true;
        for (int i = 0; i < 12; i++) {
            double[] m45282n = m45282n(d, i);
            if (m45282n[0] >= 0.0d) {
                double m45288h = m45288h(m45282n);
                if (!z) {
                    dArr = m45282n;
                    dArr2 = dArr;
                    d3 = m45288h;
                    d4 = d3;
                    z = true;
                } else if (z2 || m45295a(d3, m45288h, d4)) {
                    if (m45295a(d3, d2, m45288h)) {
                        dArr2 = m45282n;
                        d4 = m45288h;
                    } else {
                        dArr = m45282n;
    ...
    /* renamed from: d */
    public static double m45292d(double d) {
        double pow = Math.pow(Math.abs(d), 0.42d);
        return ((MathUtils.signum(d) * 400.0d) * pow) / (pow + 27.13d);
    }

    /* renamed from: e */
    public static int m45291e(double d) {
        return (int) Math.ceil(d - 0.5d);
    }

    /* renamed from: f */
    public static int m45290f(double d) {
        return (int) Math.floor(d - 0.5d);
    }

    /* renamed from: g */
    public static int m45289g(double d, double d2, double d3) {
        double d4;
        double sqrt = Math.sqrt(d3) * 11.0d;
        ViewingConditions viewingConditions = ViewingConditions.DEFAULT;
        double d5 = 1.0d;
        double pow = 1.0d / Math.pow(1.64d - Math.pow(0.29d, viewingConditions.getN()), 0.73d);
        double cos = (Math.cos(d + 2.0d) + 3.8d) * 0.25d * 3846.153846153846d * viewingConditions.m44942c() * viewingConditions.m44941d();
        ...
        while (i < 5) {
            ...
            double aw = (viewingConditions.getAw() * Math.pow(d6, (d5 / viewingConditions.m44944a()) / viewingConditions.m44940e())) / viewingConditions.getNbb();
            double d9 = (((0.305d + aw) * 23.0d) * pow2) / (((23.0d * d8) + ((pow2 * 11.0d) * cos2)) + ((pow2 * 108.0d) * sin));
            double d10 = d9 * cos2;
            double d11 = d9 * sin;
            double d12 = aw * 460.0d;
            double[] matrixMultiply = MathUtils.matrixMultiply(new double[]{m45286j((((451.0d * d10) + d12) + (288.0d * d11)) / 1403.0d), m45286j(((d12 - (891.0d * d10)) - (261.0d * d11)) / 1403.0d), m45286j(((d12 - (d10 * 220.0d)) - (d11 * 6300.0d)) / 1403.0d)}, f49631b);
    ...
    /* renamed from: h */
    public static double m45288h(double[] dArr) {
        double[] matrixMultiply = MathUtils.matrixMultiply(dArr, f49630a);
        double m45292d = m45292d(matrixMultiply[0]);
        double m45292d2 = m45292d(matrixMultiply[1]);
        double m45292d3 = m45292d(matrixMultiply[2]);
        return Math.atan2(((m45292d + m45292d2) - (m45292d3 * 2.0d)) / 9.0d, (((m45292d * 11.0d) + ((-12.0d) * m45292d2)) + m45292d3) / 11.0d);
    }

    /* renamed from: i */
    public static double m45287i(double d, double d2, double d3) {
        return (d2 - d) / (d3 - d);
    }

    /* renamed from: j */
    public static double m45286j(double d) {
        double abs = Math.abs(d);
        return MathUtils.signum(d) * Math.pow(Math.max(0.0d, (27.13d * abs) / (400.0d - abs)), 2.380952380952381d);
    }

    /* renamed from: k */
    public static boolean m45285k(double d) {
        return 0.0d <= d && d <= 100.0d;
    }

    /* renamed from: l */
    public static double[] m45284l(double[] dArr, double d, double[] dArr2) {
        double d2 = dArr[0];
        double d3 = dArr[1];
        double d4 = dArr[2];
    ...
    /* renamed from: m */
    public static double[] m45283m(double[] dArr, double[] dArr2) {
        return new double[]{(dArr[0] + dArr2[0]) / 2.0d, (dArr[1] + dArr2[1]) / 2.0d, (dArr[2] + dArr2[2]) / 2.0d};
    }

    /* renamed from: n */
    public static double[] m45282n(double d, int i) {
        double d2;
        double[] dArr = f49632c;
        double d3 = dArr[0];
        double d4 = dArr[1];
        ...
        if (i < 4) {
            ...
            return m45285k(d7) ? new double[]{d7, d2, d6} : new double[]{-1.0d, -1.0d, -1.0d};
        } else if (i < 8) {
            double d8 = ((d - (d3 * d6)) - (d5 * d2)) / d4;
            return m45285k(d8) ? new double[]{d6, d8, d2} : new double[]{-1.0d, -1.0d, -1.0d};
        } else {
            double d9 = ((d - (d3 * d2)) - (d4 * d6)) / d5;
            return m45285k(d9) ? new double[]{d2, d6, d9} : new double[]{-1.0d, -1.0d, -1.0d};
        }
    }

    /* renamed from: o */
    public static double m45281o(double d) {
        return (d + 25.132741228718345d) % 6.283185307179586d;
    }

    /* renamed from: p */
    public static double[] m45280p(double[] dArr, double d, double[] dArr2, int i) {
        return m45284l(dArr, m45287i(dArr[i], d, dArr2[i]), dArr2);
    }

    /* renamed from: q */
    public static double m45279q(double d) {
        double pow;
        double d2 = d / 100.0d;
        if (d2 <= 0.0031308d) {
            pow = d2 * 12.92d;
    ...
    public static int solveToInt(double d, double d2, double d3) {
        if (d2 >= 1.0E-4d && d3 >= 1.0E-4d && d3 <= 99.9999d) {
            ...
            int m45289g = m45289g(sanitizeDegreesDouble, d2, yFromLstar);
            if (m45289g != 0) {
                return m45289g;
            }
            return ColorUtils.argbFromLinrgb(m45294b(yFromLstar, sanitizeDegreesDouble));
        }
