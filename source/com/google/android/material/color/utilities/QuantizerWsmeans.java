...
public final class QuantizerWsmeans {
    ...
    /* loaded from: classes4.dex */
    public static final class C6893a implements Comparable {

        /* renamed from: a */
        public int f49635a = -1;

        /* renamed from: b */
        public double f49636b = -1.0d;

        @Override // java.lang.Comparable
        /* renamed from: a */
        public int compareTo(C6893a c6893a) {
            return Double.valueOf(this.f49636b).compareTo(Double.valueOf(c6893a.f49636b));
        }
    }
    ...
    public static Map<Integer, Integer> quantize(int[] iArr, int[] iArr2, int i) {
        ...
        C6893a[][] c6893aArr = new C6893a[min];
        for (int i14 = 0; i14 < min; i14++) {
            c6893aArr[i14] = new C6893a[min];
            for (int i15 = 0; i15 < min; i15++) {
                c6893aArr[i14][i15] = new C6893a();
            }
        }
            ...
            if (i16 < 10) {
                ...
                while (i17 < min) {
                    ...
                    while (i19 < min) {
                        ...
                        C6893a c6893a = c6893aArr[i19][i17];
                        c6893a.f49636b = distance;
                        c6893a.f49635a = i17;
                        C6893a c6893a2 = c6893aArr[i17][i19];
                        c6893a2.f49636b = distance;
                        c6893a2.f49635a = i19;
                        i4 = 1;
                        i19++;
                        iArr8 = iArr9;
                    ...
                    int[] iArr10 = iArr8;
                    int i20 = i16;
                    Arrays.sort(c6893aArr[i17]);
                    for (int i21 = 0; i21 < min; i21 += i4) {
                        iArr7[i17][i21] = c6893aArr[i17][i21].f49635a;
                    }
                    iArr8 = iArr10;
                    i16 = i20;
                    i17 = i18;
                ...
                while (i23 < i5) {
                    ...
                    int i27 = 0;
                    while (i27 < min) {
                        C6893a[][] c6893aArr2 = c6893aArr;
                        int i28 = i5;
                        if (c6893aArr[i25][i27].f49636b < 4.0d * distance2) {
                        ...
                        i27++;
                        i5 = i28;
                        c6893aArr = c6893aArr2;
                    }
                    C6893a[][] c6893aArr3 = c6893aArr;
                    int i29 = i5;
                    ...
                    iArr7 = iArr12;
                    i5 = i29;
                    c6893aArr = c6893aArr3;
                }
                int[][] iArr13 = iArr7;
                C6893a[][] c6893aArr4 = c6893aArr;
                int i30 = i5;
                if (i24 == 0 && i22 != 0) {
                    iArr3 = iArr11;
                    break;
