...
public class ColorUtils {
    ...
    /* renamed from: a */
    public static final double[][] f49616a = {new double[]{0.41233895d, 0.35762064d, 0.18051042d}, new double[]{0.2126d, 0.7152d, 0.0722d}, new double[]{0.01932141d, 0.11916382d, 0.95034478d}};

    /* renamed from: b */
    public static final double[][] f49617b = {new double[]{3.2413774792388685d, -1.5376652402851851d, -0.49885366846268053d}, new double[]{-0.9691452513005321d, 1.8758853451067872d, 0.04156585616912061d}, new double[]{0.05562093689691305d, -0.20395524564742123d, 1.0571799111220335d}};

    /* renamed from: c */
    public static final double[] f49618c = {95.047d, 100.0d, 108.883d};

    /* renamed from: a */
    public static double m45338a(double d) {
    ...
    public static int argbFromLab(double d, double d2, double d3) {
        ...
        return argbFromXyz(m45337b((d2 / 500.0d) + d4) * dArr[0], m45337b(d4) * dArr[1], m45337b(d5) * dArr[2]);
    }
    ...
    /* renamed from: b */
    public static double m45337b(double d) {
        double d2 = d * d * d;
    ...
    public static double[] labFromArgb(int i) {
        ...
        double[] dArr5 = f49618c;
        double d4 = d / dArr5[0];
        double d5 = d2 / dArr5[1];
        double m45338a = m45338a(d4);
        double m45338a2 = m45338a(d5);
        return new double[]{(116.0d * m45338a2) - 16.0d, (m45338a - m45338a2) * 500.0d, (m45338a2 - m45338a(d3 / dArr5[2])) * 200.0d};
    }
    ...
    public static double lstarFromArgb(int i) {
        return (m45338a(xyzFromArgb(i)[1] / 100.0d) * 116.0d) - 16.0d;
    }

    public static double lstarFromY(double d) {
        return (m45338a(d / 100.0d) * 116.0d) - 16.0d;
    }
    ...
    public static double[] xyzFromArgb(int i) {
        return MathUtils.matrixMultiply(new double[]{linearized(redFromArgb(i)), linearized(greenFromArgb(i)), linearized(blueFromArgb(i))}, f49616a);
    }

    public static double yFromLstar(double d) {
        return m45337b((d + 16.0d) / 116.0d) * 100.0d;
    }
}
