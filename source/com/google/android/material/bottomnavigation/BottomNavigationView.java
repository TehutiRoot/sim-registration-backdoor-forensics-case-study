...
public class BottomNavigationView extends NavigationBarView {
    ...
    /* loaded from: classes4.dex */
    public class C6831a implements ViewUtils.OnApplyWindowInsetsListener {
        public C6831a() {
        }
    ...
    /* renamed from: d */
    public final void m45672d(Context context) {
    ...
    /* renamed from: e */
    public final void m45671e() {
        ViewUtils.doOnApplyWindowInsets(this, new C6831a());
    }

    /* renamed from: f */
    public final int m45670f(int i) {
    ...
    public BottomNavigationView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
        ...
        if (obtainTintedStyledAttributes.getBoolean(R.styleable.BottomNavigationView_compatShadowEnabled, true) && m45669g()) {
            m45672d(context2);
        }
