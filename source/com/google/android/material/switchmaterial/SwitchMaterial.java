...
public class SwitchMaterial extends SwitchCompat {
    ...
    /* renamed from: b0 */
    public static final int f50889b0 = R.style.Widget_MaterialComponents_CompoundButton_Switch;

    /* renamed from: c0 */
    public static final int[][] f50890c0 = {new int[]{16842910, 16842912}, new int[]{16842910, -16842912}, new int[]{-16842910, 16842912}, new int[]{-16842910, -16842912}};

    /* renamed from: U */
    public final ElevationOverlayProvider f50891U;

    /* renamed from: V */
    public ColorStateList f50892V;

    /* renamed from: W */
    public ColorStateList f50893W;

    /* renamed from: a0 */
    public boolean f50894a0;
    ...
    private ColorStateList getMaterialThemeColorsThumbTintList() {
        if (this.f50892V == null) {
            ...
            if (this.f50891U.isThemeElevationOverlayEnabled()) {
                dimension += ViewUtils.getParentAbsoluteElevation(this);
            }
            int compositeOverlayIfNeeded = this.f50891U.compositeOverlayIfNeeded(color, dimension);
            int[][] iArr = f50890c0;
            ...
            this.f50892V = new ColorStateList(iArr, iArr2);
        }
        return this.f50892V;
    }

    private ColorStateList getMaterialThemeColorsTrackTintList() {
        if (this.f50893W == null) {
            int[][] iArr = f50890c0;
            int[] iArr2 = new int[iArr.length];
            int color = MaterialColors.getColor(this, R.attr.colorSurface);
            int color2 = MaterialColors.getColor(this, R.attr.colorControlActivated);
            ...
            this.f50893W = new ColorStateList(iArr, iArr2);
        }
        return this.f50893W;
    }

    public boolean isUseMaterialThemeColors() {
        return this.f50894a0;
    }

    @Override // android.widget.TextView, android.view.View
    public void onAttachedToWindow() {
        super.onAttachedToWindow();
        if (this.f50894a0 && getThumbTintList() == null) {
            setThumbTintList(getMaterialThemeColorsThumbTintList());
        }
        if (this.f50894a0 && getTrackTintList() == null) {
    ...
    */
    public SwitchMaterial(@androidx.annotation.NonNull android.content.Context r7, @androidx.annotation.Nullable android.util.AttributeSet r8, int r9) {
        /*
            r6 = this;
            int r4 = com.google.android.material.switchmaterial.SwitchMaterial.f50889b0
