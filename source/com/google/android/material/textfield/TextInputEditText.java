...
public class TextInputEditText extends AppCompatEditText {
    ...
    /* renamed from: a */
    public final String m43856a(TextInputLayout textInputLayout) {
        String str;
    ...
    /* renamed from: b */
    public final boolean m43855b(TextInputLayout textInputLayout) {
        if (textInputLayout != null && this.f51009b) {
            return true;
        }
        return false;
    }
    ...
    public void getFocusedRect(@Nullable Rect rect) {
        ...
        TextInputLayout textInputLayout = getTextInputLayout();
        if (m43855b(textInputLayout) && rect != null) {
            textInputLayout.getFocusedRect(this.f51008a);
            rect.bottom = this.f51008a.bottom;
        }
    }
    ...
    public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (Build.VERSION.SDK_INT < 23 && textInputLayout != null) {
            accessibilityNodeInfo.setText(m43856a(textInputLayout));
        }
    }
    ...
    public boolean requestRectangleOnScreen(@Nullable Rect rect) {
        TextInputLayout textInputLayout = getTextInputLayout();
        if (m43855b(textInputLayout) && rect != null) {
            this.f51008a.set(rect.left, rect.top, rect.right, rect.bottom + (textInputLayout.getHeight() - getHeight()));
            return super.requestRectangleOnScreen(this.f51008a);
        }
