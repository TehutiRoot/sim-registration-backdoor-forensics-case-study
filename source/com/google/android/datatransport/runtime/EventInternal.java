...
import com.google.android.datatransport.runtime.C6264a;
...
public abstract class EventInternal {
    ...
    public static Builder builder() {
        return new C6264a.C6266b().setAutoMetadata(new HashMap());
    }
    ...
    public Builder toBuilder() {
        return new C6264a.C6266b().setTransportName(getTransportName()).setCode(getCode()).setProductId(getProductId()).setPseudonymousId(getPseudonymousId()).setExperimentIdsClear(getExperimentIdsClear()).setExperimentIdsEncrypted(getExperimentIdsEncrypted()).setEncodedPayload(getEncodedPayload()).setEventMillis(getEventMillis()).setUptimeMillis(getUptimeMillis()).setAutoMetadata(new HashMap(getAutoMetadata()));
    }
}
