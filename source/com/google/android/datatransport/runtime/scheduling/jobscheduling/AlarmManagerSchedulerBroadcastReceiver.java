...
public class AlarmManagerSchedulerBroadcastReceiver extends BroadcastReceiver {
    /* renamed from: a */
    public static /* synthetic */ void m49103a() {
        m49102b();
    }

    /* renamed from: b */
    public static /* synthetic */ void m49102b() {
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        TransportRuntime.getInstance().getUploader().upload(priority.build(), i, new Runnable() { // from class: C2
            @Override // java.lang.Runnable
            public final void run() {
                AlarmManagerSchedulerBroadcastReceiver.m49103a();
            }
        });
    }
}
