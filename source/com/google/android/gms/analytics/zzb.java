...
public final class zzb extends zzbt implements zzt {
    ...
    /* renamed from: d */
    public static DecimalFormat f44399d;

    /* renamed from: a */
    public final zzbx f44400a;

    /* renamed from: b */
    public final String f44401b;

    /* renamed from: c */
    public final Uri f44402c;

    public zzb(zzbx zzbxVar, String str) {
        super(zzbxVar);
        Preconditions.checkNotEmpty(str);
        this.f44400a = zzbxVar;
        this.f44401b = str;
        this.f44402c = m48740b(str);
    }

    /* renamed from: b */
    public static Uri m48740b(String str) {
        Preconditions.checkNotEmpty(str);
    ...
    /* renamed from: d */
    public static String m48739d(double d) {
        if (f44399d == null) {
            f44399d = new DecimalFormat("0.######");
        }
        return f44399d.format(d);
    }

    /* renamed from: g */
    public static void m48738g(Map map, String str, String str2) {
    ...
    /* renamed from: i */
    public static void m48737i(Map map, String str, boolean z) {
        if (z) {
            map.put(str, "1");
        }
    }
    ...
    */
    ...
    public final void zze(zzh zzhVar) {
        ...
        if (TextUtils.isEmpty(zzbgVar.zzf())) {
        ...
        } else if (!this.f44400a.zzc().getAppOptOut()) {
            ...
            zzd.put("_v", zzbv.zzb);
            zzd.put("tid", this.f44401b);
            if (this.f44400a.zzc().isDryRunEnabled()) {
            ...
            zzd.put("_s", String.valueOf(zzs().zza(new zzbz(0L, zzbgVar.zze(), this.f44401b, !TextUtils.isEmpty(zzbgVar.zzd()), 0L, hashMap))));
