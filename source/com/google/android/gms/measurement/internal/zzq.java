...
public final class zzq extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValue = "true", m48389id = 9)
    public final boolean zzh;
    @SafeParcelable.Field(m48389id = 10)
    public final boolean zzi;
    @SafeParcelable.Field(defaultValueUnchecked = "Integer.MIN_VALUE", m48389id = 11)
    ...
    @SafeParcelable.Field(defaultValue = "true", m48389id = 16)
    public final boolean zzo;
    @SafeParcelable.Field(m48389id = 18)
    public final boolean zzp;
    @Nullable
    @SafeParcelable.Field(m48389id = 19)
    public final String zzq;
    @Nullable
    @SafeParcelable.Field(m48389id = 21)
    public final Boolean zzr;
    @SafeParcelable.Field(m48389id = 22)
    public final long zzs;
    @Nullable
    @SafeParcelable.Field(m48389id = 23)
    public final List zzt;
    @Nullable
    @SafeParcelable.Field(m48389id = 24)
    public final String zzu;
    @SafeParcelable.Field(defaultValue = "", m48389id = 25)
    public final String zzv;
    @SafeParcelable.Field(defaultValue = "", m48389id = 26)
    public final String zzw;
    @Nullable
    @SafeParcelable.Field(m48389id = 27)
