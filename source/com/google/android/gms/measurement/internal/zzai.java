...
public final class zzai {
    ...
    /* renamed from: b */
    public static Boolean m46351b(String str) {
        if (str == null) {
            return null;
        }
    ...
    public static zzai zza(Bundle bundle) {
        ...
        for (zzah zzahVar : zzah.values()) {
            enumMap.put((EnumMap) zzahVar, (zzah) m46351b(bundle.getString(zzahVar.zzd)));
        }
    ...
    public static String zzg(Bundle bundle) {
        ...
        String string;
        for (zzah zzahVar : zzah.values()) {
            if (bundle.containsKey(zzahVar.zzd) && (string = bundle.getString(zzahVar.zzd)) != null && m46351b(string) == null) {
                return string;
            }
        }
        return null;
    ...
    public final boolean equals(Object obj) {
        ...
        for (zzah zzahVar : zzah.values()) {
            if (m46352a((Boolean) this.f48250a.get(zzahVar)) != m46352a((Boolean) zzaiVar.f48250a.get(zzahVar))) {
                return false;
            }
        }
        return true;
    ...
    public final int hashCode() {
        int i = 17;
        for (Boolean bool : this.f48250a.values()) {
            i = (i * 31) + m46352a(bool);
        }
        return i;
    }
    ...
    public final String toString() {
        ...
        for (int i = 0; i < length; i++) {
            ...
            sb.append("=");
            Boolean bool = (Boolean) this.f48250a.get(zzahVar);
            if (bool == null) {
    ...
    public final zzai zzc(zzai zzaiVar) {
        ...
        for (zzah zzahVar : zzah.values()) {
            Boolean bool = (Boolean) this.f48250a.get(zzahVar);
            Boolean bool2 = (Boolean) zzaiVar.f48250a.get(zzahVar);
            if (bool == null) {
                bool = bool2;
            } else if (bool2 != null) {
    ...
    public final zzai zzd(zzai zzaiVar) {
        ...
        for (zzah zzahVar : zzah.values()) {
            Boolean bool = (Boolean) this.f48250a.get(zzahVar);
            if (bool == null) {
                bool = (Boolean) zzaiVar.f48250a.get(zzahVar);
            }
            enumMap.put((EnumMap) zzahVar, (zzah) bool);
        }
        return new zzai(enumMap);
    ...
    public final Boolean zze() {
        return (Boolean) this.f48250a.get(zzah.AD_STORAGE);
    }

    public final Boolean zzf() {
        return (Boolean) this.f48250a.get(zzah.ANALYTICS_STORAGE);
    }
    ...
    public final String zzh() {
        ...
        int length = zzahVarArr.length;
        for (int i = 0; i < 2; i++) {
            Boolean bool = (Boolean) this.f48250a.get(zzahVarArr[i]);
            if (bool == null) {
                c = '-';
    ...
    public final boolean zzk(zzai zzaiVar) {
        return zzl(zzaiVar, (zzah[]) this.f48250a.keySet().toArray(new zzah[0]));
    }
