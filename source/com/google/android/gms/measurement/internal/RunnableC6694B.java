...
public final class RunnableC6694B implements Runnable {

    /* renamed from: a */
    public final URL f48061a;

    /* renamed from: b */
    public final String f48062b;

    /* renamed from: c */
    public final /* synthetic */ zzih f48063c;

    /* renamed from: d */
    public final zzfw f48064d;

    public RunnableC6694B(zzih zzihVar, String str, URL url, byte[] bArr, Map map, zzfw zzfwVar, byte[] bArr2) {
        this.f48063c = zzihVar;
        Preconditions.checkNotEmpty(str);
        Preconditions.checkNotNull(url);
        Preconditions.checkNotNull(zzfwVar);
        this.f48061a = url;
        this.f48064d = zzfwVar;
        this.f48062b = str;
    }

    /* renamed from: a */
    public final /* synthetic */ void m46380a(int i, Exception exc, byte[] bArr, Map map) {
        zzfw zzfwVar = this.f48064d;
        zzfwVar.zza.m46276c(this.f48062b, i, exc, bArr, map);
    }

    /* renamed from: b */
    public final void m46379b(final int i, final Exception exc, final byte[] bArr, final Map map) {
        this.f48063c.zzs.zzaz().zzp(new Runnable() { // from class: com.google.android.gms.measurement.internal.zzif
            {
                RunnableC6694B.this = this;
            }

            @Override // java.lang.Runnable
            public final void run() {
                RunnableC6694B.this.m46380a(i, exc, bArr, map);
            }
        });
    }
    ...
    */
    public final void run() {
        /*
            r9 = this;
            com.google.android.gms.measurement.internal.zzih r0 = r9.f48063c
            r0.zzax()
            r0 = 0
            r1 = 0
            com.google.android.gms.measurement.internal.zzih r2 = r9.f48063c     // Catch: java.lang.Throwable -> L80 java.io.IOException -> L82
            java.net.URL r3 = r9.f48061a     // Catch: java.lang.Throwable -> L80 java.io.IOException -> L82
        ...
        L9b:
            ...
            r3.disconnect()
        La0:
            r9.m46379b(r2, r0, r1, r4)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.RunnableC6694B.run():void");
    }
}
