...
public final class Objects {
    ...
    public static final class ToStringHelper {
        ...
        public String toString() {
            ...
            sb.append(this.f45113b.getClass().getSimpleName());
            sb.append('{');
            int size = this.f45112a.size();
            for (int i = 0; i < size; i++) {
                sb.append((String) this.f45112a.get(i));
                if (i < size - 1) {
                    sb.append(", ");
                }
            }
