...
public final class zaaa extends Button {
    ...
    /* renamed from: a */
    public static final int m48384a(int i, int i2, int i3, int i4) {
        if (i != 0) {
            if (i != 1) {
                if (i == 2) {
                    return i4;
    ...
    public final void zaa(Resources resources, int i, int i2) {
        ...
        Drawable wrap = DrawableCompat.wrap(resources.getDrawable(m48384a));
        ...
        setTextColor((ColorStateList) Preconditions.checkNotNull(resources.getColorStateList(m48384a(i2, i8, i9, i9))));
        if (i != 0) {
            if (i != 1) {
                if (i == 2) {
