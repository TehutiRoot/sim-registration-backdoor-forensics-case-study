...
public final class Preconditions {
    /* renamed from: a */
    public static String m48398a(String str, Object... objArr) {
        int indexOf;
    ...
    public static double checkArgumentInRange(double d, double d2, double d3, @NonNull String str) {
        if (d >= d2) {
            ...
            throw new IllegalArgumentException(m48398a("%s is out of range of [%f, %f] (too high)", str, Double.valueOf(d2), Double.valueOf(d3)));
        }
        throw new IllegalArgumentException(m48398a("%s is out of range of [%f, %f] (too low)", str, Double.valueOf(d2), Double.valueOf(d3)));
    }
    ...
    public static float checkArgumentInRange(float f, float f2, float f3, @NonNull String str) {
        if (f >= f2) {
            ...
            throw new IllegalArgumentException(m48398a("%s is out of range of [%f, %f] (too high)", str, Float.valueOf(f2), Float.valueOf(f3)));
        }
        throw new IllegalArgumentException(m48398a("%s is out of range of [%f, %f] (too low)", str, Float.valueOf(f2), Float.valueOf(f3)));
    }
    ...
    public static int checkArgumentInRange(int i, int i2, int i3, @NonNull String str) {
        if (i >= i2) {
            ...
            throw new IllegalArgumentException(m48398a("%s is out of range of [%d, %d] (too high)", str, Integer.valueOf(i2), Integer.valueOf(i3)));
        }
        throw new IllegalArgumentException(m48398a("%s is out of range of [%d, %d] (too low)", str, Integer.valueOf(i2), Integer.valueOf(i3)));
    }
    ...
    public static long checkArgumentInRange(long j, long j2, long j3, @NonNull String str) {
        if (j >= j2) {
            ...
            throw new IllegalArgumentException(m48398a("%s is out of range of [%d, %d] (too high)", str, Long.valueOf(j2), Long.valueOf(j3)));
        }
        throw new IllegalArgumentException(m48398a("%s is out of range of [%d, %d] (too low)", str, Long.valueOf(j2), Long.valueOf(j3)));
    }
}
