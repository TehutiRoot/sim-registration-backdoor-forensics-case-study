...
public abstract class GmsClient<T extends IInterface> extends BaseGmsClient<T> implements Api.Client, zaj {
    ...
    /* renamed from: C */
    public final ClientSettings f45090C;

    /* renamed from: D */
    public final Set f45091D;

    /* renamed from: E */
    public final Account f45092E;
    ...
    public GmsClient(@NonNull Context context, @NonNull Handler handler, int i, @NonNull ClientSettings clientSettings) {
        ...
        this.f45090C = (ClientSettings) Preconditions.checkNotNull(clientSettings);
        this.f45092E = clientSettings.getAccount();
        this.f45091D = m48411o(clientSettings.getAllRequestedScopes());
    }
    ...
    /* renamed from: o */
    public final Set m48411o(Set set) {
    ...
    public GmsClient(@NonNull Context context, @NonNull Looper looper, @NonNull GmsClientSupervisor gmsClientSupervisor, @NonNull GoogleApiAvailability googleApiAvailability, int i, @NonNull ClientSettings clientSettings, @Nullable ConnectionCallbacks connectionCallbacks, @Nullable OnConnectionFailedListener onConnectionFailedListener) {
        super(context, looper, gmsClientSupervisor, googleApiAvailability, i, connectionCallbacks == null ? null : new C6353a(connectionCallbacks), onConnectionFailedListener == null ? null : new C6354b(onConnectionFailedListener), clientSettings.zac());
        this.f45090C = clientSettings;
        this.f45092E = clientSettings.getAccount();
        this.f45091D = m48411o(clientSettings.getAllRequestedScopes());
    }
}
