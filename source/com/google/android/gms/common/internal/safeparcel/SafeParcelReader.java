...
public class SafeParcelReader {
    ...
    /* renamed from: a */
    public static void m48395a(Parcel parcel, int i, int i2, int i3) {
        if (i2 == i3) {
            return;
        }
    ...
    /* renamed from: b */
    public static void m48394b(Parcel parcel, int i, int i2) {
