...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    /* renamed from: c */
    public static final Object f44660c = new Object();

    /* renamed from: d */
    public static final GoogleApiAvailability f44661d = new GoogleApiAvailability();
    ...
    /* renamed from: a */
    public final Dialog m48635a(Context context, int i, zag zagVar, DialogInterface.OnCancelListener onCancelListener, DialogInterface.OnClickListener onClickListener) {
    ...
    /* renamed from: b */
    public final void m48634b(Activity activity, Dialog dialog, String str, DialogInterface.OnCancelListener onCancelListener) {
        try {
    ...
    /* renamed from: c */
    public final void m48633c(Context context, int i, String str, PendingIntent pendingIntent) {
        int i2;
        String str2;
        ...
        if (i == 18) {
            ...
            if (PlatformVersion.isAtLeastO()) {
                ...
                if (str2 == null) {
                    ...
                    if (notificationChannel == null) {
                        notificationManager.createNotificationChannel(TI0.m66215a("com.google.android.gms.availability", string, 4));
                    } else {
            ...
            if (i != 1 && i != 2 && i != 3) {
                ...
                GooglePlayServicesUtilLight.f44664a.set(false);
                i2 = 10436;
            }
    ...
    /* renamed from: d */
    public final void m48632d(Context context) {
        new T82(this, context).sendEmptyMessageDelayed(1, 120000L);
    }
    ...
    public void showErrorNotification(@NonNull Context context, int i) {
        m48633c(context, i, null, getErrorResolutionPendingIntent(context, i, 0, OperatorName.ENDPATH));
    }
    ...
    public final Dialog zab(@NonNull Activity activity, @NonNull DialogInterface.OnCancelListener onCancelListener) {
        ...
        m48634b(activity, create, "GooglePlayServicesUpdatingDialog", onCancelListener);
        return create;
    }
    ...
    public final boolean zag(@NonNull Activity activity, @NonNull LifecycleFragment lifecycleFragment, int i, int i2, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        Dialog m48635a = m48635a(activity, i, zag.zad(lifecycleFragment, getErrorResolutionIntent(activity, i, "d"), 2), onCancelListener, null);
        if (m48635a == null) {
            return false;
        }
        m48634b(activity, m48635a, GooglePlayServicesUtil.GMS_ERROR_DIALOG, onCancelListener);
        return true;
    }
    ...
    public final boolean zah(@NonNull Context context, @NonNull ConnectionResult connectionResult, int i) {
        ...
        m48633c(context, connectionResult.getErrorCode(), null, PendingIntent.getActivity(context, 0, GoogleApiActivity.zaa(context, errorResolutionPendingIntent, i, true), zap.zaa | 134217728));
        return true;
    }
    ...
    public Dialog getErrorDialog(@NonNull Activity activity, int i, int i2, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        return m48635a(activity, i, zag.zab(activity, getErrorResolutionIntent(activity, i, "d"), i2), onCancelListener, null);
    }
    ...
    public boolean showErrorDialogFragment(@NonNull Activity activity, int i, int i2, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        ...
        m48634b(activity, errorDialog, GooglePlayServicesUtil.GMS_ERROR_DIALOG, onCancelListener);
        return true;
    }
    ...
    public void showErrorNotification(@NonNull Context context, @NonNull ConnectionResult connectionResult) {
        m48633c(context, connectionResult.getErrorCode(), null, getErrorResolutionPendingIntent(context, connectionResult));
    }
    ...
    public boolean showErrorDialogFragment(@NonNull Activity activity, int i, @NonNull ActivityResultLauncher<IntentSenderRequest> activityResultLauncher, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        Dialog m48635a = m48635a(activity, i, null, onCancelListener, new E82(this, activity, i, activityResultLauncher));
        if (m48635a == null) {
            return false;
        }
        m48634b(activity, m48635a, GooglePlayServicesUtil.GMS_ERROR_DIALOG, onCancelListener);
    ...
    public Dialog getErrorDialog(@NonNull Fragment fragment, int i, int i2, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        return m48635a(fragment.requireContext(), i, zag.zac(fragment, getErrorResolutionIntent(fragment.requireContext(), i, "d"), i2), onCancelListener, null);
    }
}
