...
public final class zae extends zag {
    ...
    /* renamed from: b */
    public final WeakReference f45018b;

    public zae(ImageView imageView, int i) {
        super(Uri.EMPTY, i);
        Asserts.checkNotNull(imageView);
        this.f45018b = new WeakReference(imageView);
    }
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        ImageView imageView = (ImageView) this.f45018b.get();
        ImageView imageView2 = (ImageView) ((zae) obj).f45018b.get();
