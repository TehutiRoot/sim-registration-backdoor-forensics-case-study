...
public final class zzos extends AbstractSafeParcelable {
    ...
    public zzos(@SafeParcelable.Param(m48388id = 1) int i, @SafeParcelable.Param(m48388id = 2) List list) {
        this.f47239a = i;
        this.f47240b = list;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        SafeParcelWriter.writeInt(parcel, 1, this.f47239a);
        SafeParcelWriter.writeTypedList(parcel, 2, this.f47240b, false);
