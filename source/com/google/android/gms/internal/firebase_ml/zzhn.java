...
public final class zzhn implements zzjm {
    public static final String MEDIA_TYPE = new zzgz("application/x-www-form-urlencoded").zza(zziw.UTF_8).zzfz();

    /* renamed from: a */
    public static Object m47905a(Type type, List list, String str) {
                    ...
                    if (zzar.length() != 0) {
                        ...
                        if (zzao != null) {
                            ...
                            if (zzjs.zzc(zza)) {
                                ...
                                zzisVar.zza(zzao.zzig(), zzb, m47905a(zzb, asList, zzar2));
                                ...
                                collection.add(m47905a(zze, asList, zzar2));
                            } else {
                                zzao.zzb(obj, m47905a(zza, asList, zzar2));
                            }
                        } else if (map != null) {
