...
public final class zzjs {
    /* renamed from: a */
    public static IllegalArgumentException m47887a(Exception exc, Class cls) {
    ...
    /* renamed from: b */
    public static ParameterizedType m47886b(Type type, Class cls) {
        Class<?> cls2;
    ...
    /* renamed from: c */
    public static Type m47885c(Type type, Class cls, int i) {
        Type zza;
        ParameterizedType m47886b = m47886b(type, cls);
        if (m47886b == null) {
            return null;
        }
        Type type2 = m47886b.getActualTypeArguments()[i];
    ...
    public static Type zze(Type type) {
        return m47885c(type, Iterable.class, 0);
    }
    ...
    public static Type zzf(Type type) {
        return m47885c(type, Map.class, 1);
    }
    ...
    public static Type zza(List<Type> list, TypeVariable<?> typeVariable) {
        ...
        if (genericDeclaration instanceof Class) {
            ...
            while (parameterizedType == null) {
                ...
                parameterizedType = m47886b(list.get(size), cls);
            }
