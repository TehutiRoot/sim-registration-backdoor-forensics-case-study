...
public final class zzsp implements zzqc<List<FirebaseVisionFace>, zzsn>, zzqx {
    ...
    /* renamed from: g */
    public static volatile Boolean f46030g;

    /* renamed from: h */
    public static AtomicBoolean f46031h = new AtomicBoolean(true);

    /* renamed from: a */
    public final Context f46032a;

    /* renamed from: b */
    public final FirebaseVisionFaceDetectorOptions f46033b;

    /* renamed from: c */
    public final zzqo f46034c;

    /* renamed from: d */
    public FaceDetector f46035d;

    /* renamed from: e */
    public FaceDetector f46036e;

    /* renamed from: f */
    public final zzsg f46037f = new zzsg();
    ...
    public zzsp(@NonNull zzqn zzqnVar, @NonNull FirebaseVisionFaceDetectorOptions firebaseVisionFaceDetectorOptions) {
        ...
        this.f46032a = zzqnVar.getApplicationContext();
        this.f46033b = firebaseVisionFaceDetectorOptions;
        this.f46034c = zzqo.zza(zzqnVar, 1);
    }

    /* renamed from: e */
    public static void m47479e(List list) {
    ...
    /* renamed from: a */
    public final /* synthetic */ zznq.zzad.zza m47483a(long j, zzoa zzoaVar, int i, int i2, zzsn zzsnVar) {
        return zznq.zzad.zzmg().zzb((zznq.zzap) ((zzxh) zznq.zzap.zznd().zzd(zznq.zzaf.zzmk().zzj(j).zzk(zzoaVar).zzae(f46031h.get()).zzaf(true).zzag(true)).zzc(this.f46033b.zzrd()).zzbp(i).zzbq(i2).zzj(zzsi.zzc(zzsnVar)).zzvn()));
    }
    ...
    */
    ...
    /* renamed from: c */
    public final synchronized List m47481c(FaceDetector faceDetector, zzsn zzsnVar, long j) {
        ArrayList arrayList;
        boolean z;
        try {
            if (this.f46036e != null) {
                if (f46030g == null) {
                    if (DynamiteModule.getLocalVersion(this.f46032a, "com.google.android.gms.vision.dynamite.face") > 0) {
                        z = true;
                    } else {
                        z = false;
                    }
                    f46030g = Boolean.valueOf(z);
                }
                if (!f46030g.booleanValue()) {
            ...
            if (faceDetector.isOperational()) {
                ...
                m47480d(zzoa.MODEL_NOT_DOWNLOADED, j, zzsnVar, 0, 0);
    ...
    /* renamed from: d */
    public final synchronized void m47480d(final zzoa zzoaVar, long j, final zzsn zzsnVar, final int i, final int i2) {
        final long elapsedRealtime = SystemClock.elapsedRealtime() - j;
        this.f46034c.zza(new zzqw(this, elapsedRealtime, zzoaVar, i, i2, zzsnVar) { // from class: yJ2

            /* renamed from: a */
            public final zzsp f108689a;

            /* renamed from: b */
            public final long f108690b;

            /* renamed from: c */
            public final zzoa f108691c;
            ...
            /* renamed from: f */
            public final zzsn f108694f;

            {
                this.f108689a = this;
                this.f108690b = elapsedRealtime;
                this.f108691c = zzoaVar;
                this.f108692d = i;
                this.f108693e = i2;
                this.f108694f = zzsnVar;
            }

            @Override // com.google.android.gms.internal.firebase_ml.zzqw
            public final zznq.zzad.zza zzov() {
                return this.f108689a.m47483a(this.f108690b, this.f108691c, this.f108692d, this.f108693e, this.f108694f);
            }
        }, zzoe.ON_DEVICE_FACE_DETECT);
        zzqu zzquVar = C23290zJ2.f109035a;
        this.f46034c.zza((zznq.zzd.zza) ((zzxh) zznq.zzd.zza.zzkm().zze(zzoaVar).zzq(f46031h.get()).zzd(zzsi.zzc(zzsnVar)).zzas(i).zzat(i2).zzb(this.f46033b.zzrd()).zzvn()), elapsedRealtime, zzoe.AGGREGATED_ON_DEVICE_FACE_DETECTION, zzquVar);
    }
    ...
    public final synchronized void release() {
        try {
            FaceDetector faceDetector = this.f46035d;
            if (faceDetector != null) {
                faceDetector.release();
                this.f46035d = null;
            }
            FaceDetector faceDetector2 = this.f46036e;
    ...
    public final synchronized void zzow() {
        try {
            if (this.f46033b.getContourMode() == 2) {
                if (this.f46036e == null) {
                    this.f46036e = new FaceDetector.Builder(this.f46032a).setLandmarkType(2).setMode(2).setTrackingEnabled(false).setProminentFaceOnly(true).build();
                }
                if ((this.f46033b.getLandmarkMode() == 2 || this.f46033b.getClassificationMode() == 2 || this.f46033b.getPerformanceMode() == 2) && this.f46035d == null) {
                    this.f46035d = new FaceDetector.Builder(this.f46032a).setLandmarkType(zzsi.zzcb(this.f46033b.getLandmarkMode())).setClassificationType(zzsi.zzcd(this.f46033b.getClassificationMode())).setMode(zzsi.zzcc(this.f46033b.getPerformanceMode())).setMinFaceSize(this.f46033b.getMinFaceSize()).setTrackingEnabled(this.f46033b.isTrackingEnabled()).build();
                }
            } else if (this.f46035d == null) {
                this.f46035d = new FaceDetector.Builder(this.f46032a).setLandmarkType(zzsi.zzcb(this.f46033b.getLandmarkMode())).setClassificationType(zzsi.zzcd(this.f46033b.getClassificationMode())).setMode(zzsi.zzcc(this.f46033b.getPerformanceMode())).setMinFaceSize(this.f46033b.getMinFaceSize()).setTrackingEnabled(this.f46033b.isTrackingEnabled()).build();
            }
        } catch (Throwable th2) {
            throw th2;
