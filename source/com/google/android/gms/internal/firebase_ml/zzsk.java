...
public final class zzsk {
    ...
    /* renamed from: a */
    public static final zzsk f46027a = new zzsk();

    /* renamed from: a */
    public static void m47485a(Image.Plane plane, int i, int i2, byte[] bArr, int i3, int i4) {
    ...
    public static ByteBuffer zza(Image.Plane[] planeArr, int i, int i2) {
        ...
        if (z) {
            ...
            m47485a(planeArr[0], i, i2, bArr, 0, 1);
            m47485a(planeArr[1], i, i2, bArr, i3 + 1, 2);
            m47485a(planeArr[2], i, i2, bArr, i3, 2);
        }
