...
public final class zzsj extends AbstractSafeParcelable {
    ...
    public zzsj(@SafeParcelable.Param(m48388id = 1) int i, @SafeParcelable.Param(m48388id = 2) int i2, @SafeParcelable.Param(m48388id = 3) int i3, @SafeParcelable.Param(m48388id = 4) long j, @SafeParcelable.Param(m48388id = 5) int i4) {
        this.width = i;
        this.height = i2;
        this.f46026a = i3;
        this.zzbuz = j;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        SafeParcelWriter.writeInt(parcel, 3, this.f46026a);
