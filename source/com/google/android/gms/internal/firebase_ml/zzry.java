...
public final class zzry {
    /* renamed from: a */
    public static int m47491a(Integer num) {
        if (num == null) {
            return 0;
        }
        return num.intValue();
    ...
    public static Rect zza(@Nullable zzkp zzkpVar, float f) {
        ...
        for (zzlm zzlmVar : zzkpVar.zziu()) {
            i3 = Math.min(m47491a(zzlmVar.zzjb()), i3);
            i4 = Math.min(m47491a(zzlmVar.zzjc()), i4);
            i = Math.max(m47491a(zzlmVar.zzjb()), i);
            i2 = Math.max(m47491a(zzlmVar.zzjc()), i2);
        }
