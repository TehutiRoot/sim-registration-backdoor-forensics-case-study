...
public abstract class zzag extends zzac implements List, RandomAccess {
    private static final zzak zza = new C21782qb2(zzai.zza, 0);
    ...
    public static zzag zzj(Iterable iterable) {
        ...
        zzadVar.zzb(next);
        zzadVar.zzc(it);
        zzadVar.f108434c = true;
        return zzi(zzadVar.f108432a, zzadVar.f108433b);
    }
