...
public final class zzcb {
    ...
    static {
        ...
        for (zzcb zzcbVar52 : values) {
            zzjb[zzcbVar52.f45558id] = zzcbVar52;
        }
    }
    ...
    private zzcb(String str, int i, int i2, zzcd zzcdVar, zzcq zzcqVar) {
        ...
        this.zziy = zzcdVar;
        this.zzix = zzcqVar;
        int i4 = AbstractC6397e.f45469a[zzcdVar.ordinal()];
        boolean z = true;
        this.zziz = (i4 == 1 || i4 == 2) ? zzcqVar.zzbq() : null;
        this.zzja = (zzcdVar != zzcd.SCALAR || (i3 = AbstractC6397e.f45470b[zzcqVar.ordinal()]) == 1 || i3 == 2 || i3 == 3) ? false : false;
    }
