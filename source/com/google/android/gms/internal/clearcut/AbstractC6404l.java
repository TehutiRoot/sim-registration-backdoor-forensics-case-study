...
public abstract class AbstractC6404l {
    /* renamed from: d */
    public static void m48217d(CharSequence charSequence, ByteBuffer byteBuffer) {
    ...
    /* renamed from: a */
    public abstract int mo48215a(int i, byte[] bArr, int i2, int i3);

    /* renamed from: b */
    public abstract int mo48214b(CharSequence charSequence, byte[] bArr, int i, int i2);

    /* renamed from: c */
    public abstract void mo48213c(CharSequence charSequence, ByteBuffer byteBuffer);

    /* renamed from: e */
    public final boolean m48216e(byte[] bArr, int i, int i2) {
        return mo48215a(0, bArr, i, i2) == 0;
    }
}
