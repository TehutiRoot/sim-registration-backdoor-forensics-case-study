...
public final class zzn extends AbstractSafeParcelable {
    ...
    public zzn(@SafeParcelable.Param(m48388id = 2) int i, @SafeParcelable.Param(m48388id = 3) String str, @SafeParcelable.Param(m48388id = 4) String str2, @SafeParcelable.Param(m48388id = 5) String str3) {
        this.zza = i;
        this.zzb = str;
        this.zzc = str2;
        this.zzd = str3;
