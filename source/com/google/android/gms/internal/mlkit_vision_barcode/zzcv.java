...
public abstract class zzcv extends zzcq implements List, RandomAccess {
    private static final zzdy zza = new C18241Pg2(zzdn.zza, 0);
    ...
    public final zzdy listIterator(int i) {
        zzbc.zzb(i, size(), FirebaseAnalytics.Param.INDEX);
        if (isEmpty()) {
            return zza;
        }
        return new C18241Pg2(this, i);
    }
}
