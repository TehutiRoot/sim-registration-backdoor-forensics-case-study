...
public abstract class zzbi extends zzbf implements List, RandomAccess {
    private static final zzby zza = new C21447oe2(zzbo.zza, 0);
    public static final /* synthetic */ int zzd = 0;

    public static zzbi zzg(Object[] objArr, int i) {
        if (i == 0) {
            return zzbo.zza;
        }
        return new zzbo(objArr, i);
    }
    ...
    public zzbi subList(int i, int i2) {
        ...
        return new zzbh(this, i, i3);
    }

    @Override // java.util.List
    /* renamed from: zzh */
    public final zzby listIterator(int i) {
        zzba.zzb(i, size(), FirebaseAnalytics.Param.INDEX);
        if (isEmpty()) {
            return zza;
        }
        return new C21447oe2(this, i);
    }
}
