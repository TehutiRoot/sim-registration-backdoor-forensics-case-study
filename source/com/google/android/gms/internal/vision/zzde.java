...
public final class zzde {
    /* renamed from: a */
    public static String m46545a(int i, int i2, String str) {
        if (i < 0) {
    ...
    public static int zzb(int i, int i2) {
        if (i < 0 || i > i2) {
            throw new IndexOutOfBoundsException(m46545a(i, i2, FirebaseAnalytics.Param.INDEX));
        }
        return i;
    }
    ...
    public static void zza(int i, int i2, int i3) {
        ...
        if (i < 0 || i2 < i || i2 > i3) {
            if (i < 0 || i > i3) {
                m46545a = m46545a(i, i3, "start index");
            } else if (i2 >= 0 && i2 <= i3) {
                m46545a = zzdg.zza("end index (%s) must not be less than start index (%s)", Integer.valueOf(i2), Integer.valueOf(i));
            } else {
                m46545a = m46545a(i2, i3, "end index");
            }
            throw new IndexOutOfBoundsException(m46545a);
        }
    }
}
