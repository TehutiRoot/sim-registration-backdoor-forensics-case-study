...
public class zaa implements IInterface {
    ...
    public final Parcel zaa() {
        ...
        obtain.writeInterfaceToken(this.f45443b);
        return obtain;
    }
    ...
    public final Parcel zab(int i, Parcel parcel) throws RemoteException {
        ...
        try {
            try {
                this.f45442a.transact(2, parcel, obtain, 0);
    ...
    public final void zac(int i, Parcel parcel) throws RemoteException {
        Parcel obtain = Parcel.obtain();
        try {
            this.f45442a.transact(i, parcel, obtain, 0);
            obtain.readException();
        } finally {
            parcel.recycle();
            obtain.recycle();
    ...
    public final void zad(int i, Parcel parcel) throws RemoteException {
        try {
            this.f45442a.transact(1, parcel, null, 1);
        } finally {
            parcel.recycle();
        }
    }
