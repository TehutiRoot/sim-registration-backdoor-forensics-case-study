...
final class zzum extends zzuq {
    ...
    public zzum(byte[] bArr, int i, int i2) {
        super(null);
    ...
    public final void zzK(byte b) throws IOException {
        try {
            ...
            throw new zzun(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zzc), Integer.valueOf(this.zzb), 1), e);
        }
    }
    ...
    public final void zze(byte[] bArr, int i, int i2) throws IOException {
        try {
            ...
            throw new zzun(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zzc), Integer.valueOf(this.zzb), Integer.valueOf(i2)), e);
        }
    }
    ...
    public final void zzr(String str) throws IOException {
        ...
        try {
            ...
            if (zzD2 == zzD) {
                int i2 = i + zzD2;
                this.zzc = i2;
                int zzb = zzaaz.zzb(str, this.zza, i2, this.zzb - i2);
                this.zzc = i;
                zzu((zzb - i) - zzD2);
                this.zzc = zzb;
                return;
    ...
    public final void zzw(long j) throws IOException {
        ...
        while (true) {
            ...
            if ((j & (-128)) == 0) {
                ...
                int i4 = this.zzc;
                this.zzc = 1 + i4;
                zzaau.zzn(bArr3, i4, (byte) i3);
                return;
            }
            byte[] bArr4 = this.zza;
            int i5 = this.zzc;
            this.zzc = i5 + 1;
            zzaau.zzn(bArr4, i5, (byte) ((i3 & 127) | 128));
            j >>>= 7;
        }
    }
}
