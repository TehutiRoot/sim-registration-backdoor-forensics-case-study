...
public abstract class zzst extends zzsq implements List, RandomAccess {
    ...
    public static zzst zzg(Object[] objArr, int i) {
        if (i == 0) {
            return zzsz.zza;
        }
        return new zzsz(objArr, i);
    }
    ...
    @Override // java.util.List
    /* renamed from: zzf */
    public zzst subList(int i, int i2) {
        zzsl.zzc(i, i2, size());
        int i3 = i2 - i;
        if (i3 == size()) {
            return this;
        ...
        return new zzss(this, i, i3);
    }

    @Override // java.util.List
    /* renamed from: zzh */
    public final zztj listIterator(int i) {
        zzsl.zzb(i, size(), FirebaseAnalytics.Param.INDEX);
        if (isEmpty()) {
            return zza;
        }
        return new zzsr(this, i);
    }
}
