...
public interface zzzs {
    void zzA(List list) throws IOException;

    void zzB(List list) throws IOException;

    void zzC(List list) throws IOException;

    void zzD(List list) throws IOException;

    @Deprecated
    void zzE(List list, zzzt zzztVar, zzxf zzxfVar) throws IOException;

    void zzF(List list) throws IOException;

    void zzG(List list) throws IOException;

    void zzH(List list, zzzt zzztVar, zzxf zzxfVar) throws IOException;

    void zzI(List list) throws IOException;

    void zzJ(List list) throws IOException;

    void zzK(List list) throws IOException;

    void zzL(List list) throws IOException;

    void zzN(List list) throws IOException;

    void zzO(List list) throws IOException;

    boolean zzP() throws IOException;

    boolean zzQ() throws IOException;
    ...
    zzud zzp() throws IOException;

    @Deprecated
    Object zzr(Class cls, zzxf zzxfVar) throws IOException;

    Object zzs(Class cls, zzxf zzxfVar) throws IOException;

    String zzt() throws IOException;

    String zzu() throws IOException;

    void zzv(Object obj, zzzt zzztVar, zzxf zzxfVar) throws IOException;

    void zzw(Object obj, zzzt zzztVar, zzxf zzxfVar) throws IOException;
