...
public abstract class zzxn {
    ...
    public static zzxf zzb(Class cls) {
        String format;
        ClassLoader classLoader = zzxn.class.getClassLoader();
        if (cls.equals(zzxf.class)) {
            format = zzb;
        } else if (cls.getPackage().equals(zzxn.class.getPackage())) {
        ...
        try {
            try {
                try {
                    return (zzxf) cls.cast(((zzxn) Class.forName(format, true, classLoader).getConstructor(null).newInstance(null)).zza());
