...
public enum zzaby implements zzxx {
    ST_NOT_SPECIFIED(0),
    ST_NOT_REQUIRED(999),
    ...
    ST_FITBIT_ID(1113),
    ST_SPII_ID(BasicMarqueeKt.f12794b),
    ...
    ST_VOICE(2407),
    ST_THIRD_PARTY_DATA(Constants.MAX_URL_LENGTH),
    ST_TIMESTAMP(2100),
    ...
    private static final zzxy zzaQ = new zzxy() { // from class: com.google.android.gms.internal.gtm.zzabw
                                            ...
                                            switch (i) {
                                                ...
                                                default:
                                                    switch (i) {
                                                        ...
                                                        default:
                                                            switch (i) {
                                                                case BasicMarqueeKt.f12794b /* 1200 */:
                                                                    return ST_SPII_ID;
                                                                case 1201:
    ...
    public final String toString() {
        return Integer.toString(this.zzaS);
    }
