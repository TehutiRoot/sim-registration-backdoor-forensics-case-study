...
public final class zzuf extends zzuj {
    ...
    public /* synthetic */ zzuf(byte[] bArr, int i, int i2, boolean z, zzue zzueVar) {
        super(null);
    ...
    public final zzud zzw() throws IOException {
        ...
        if (zzj > 0) {
            ...
            int i2 = this.zzh;
            if (zzj <= i - i2) {
                zzud zzl = zzud.zzl(this.zze, i2, zzj);
                this.zzh += zzj;
                return zzl;
            }
        }
        if (zzj != 0) {
            if (zzj > 0) {
                ...
                if (zzj <= i3 - i4) {
                    int i5 = zzj + i4;
                    this.zzh = i5;
                    return new zzua(Arrays.copyOfRange(this.zze, i4, i5));
                }
            }
            if (zzj <= 0) {
                throw zzyg.zzf();
    ...
    public final String zzx() throws IOException {
        ...
        if (zzj > 0) {
            ...
            int i2 = this.zzh;
            if (zzj <= i - i2) {
                String str = new String(this.zze, i2, zzj, zzye.zzb);
                this.zzh += zzj;
                return str;
            }
        }
    ...
    public final String zzy() throws IOException {
        ...
        if (zzj > 0) {
            ...
            int i2 = this.zzh;
            if (zzj <= i - i2) {
                String zzd = zzaaz.zzd(this.zze, i2, zzj);
                this.zzh += zzj;
                return zzd;
            }
        }
