...
abstract class zzaau {
    static final long zza;
    static final boolean zzb;
    private static final Unsafe zzc;
    private static final Class zzd;
    private static final boolean zze;
    private static final zzaat zzf;
    ...
    static {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.gtm.zzaau.<clinit>():void");
    }
    ...
    public static void zzD(Object obj, long j, byte b) {
        zzaat zzaatVar = zzf;
        long j2 = (-4) & j;
        int i = zzaatVar.zza.getInt(obj, j2);
        int i2 = ((~((int) j)) & 3) << 3;
        zzaatVar.zza.putInt(obj, j2, ((255 & b) << i2) | (i & (~(255 << i2))));
    }
    ...
    public static void zzE(Object obj, long j, byte b) {
        ...
        long j2 = (-4) & j;
        int i = (((int) j) & 3) << 3;
        zzaatVar.zza.putInt(obj, j2, ((255 & b) << i) | (zzaatVar.zza.getInt(obj, j2) & (~(255 << i))));
    }
    ...
    public static Unsafe zzg() {
        try {
            return (Unsafe) AccessController.doPrivileged(new zzaaq());
        } catch (Throwable unused) {
            return null;
        }
    }
    ...
    public static /* bridge */ /* synthetic */ void zzh(Throwable th2) {
        Logger.getLogger(zzaau.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th2.toString()));
    }
