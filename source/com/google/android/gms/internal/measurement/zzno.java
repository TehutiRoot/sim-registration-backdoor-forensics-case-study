...
public final class zzno implements zznn {
    ...
    static {
        ...
        zzf = zza2.zze("measurement.config.url_scheme", UriUtil.HTTPS_SCHEME);
        ...
        zzp = zza2.zzd("measurement.upload.refresh_blacklisted_config_interval", CoreConstants.MILLIS_IN_ONE_WEEK);
        zzq = zza2.zzd("measurement.config.cache_time.service", CoreConstants.MILLIS_IN_ONE_HOUR);
        zzr = zza2.zzd("measurement.service_client.idle_disconnect_millis", CoroutineLiveDataKt.DEFAULT_TIMEOUT);
        zzs = zza2.zze("measurement.log_tag.service", "FA-SVC");
        zzt = zza2.zzd("measurement.upload.stale_data_deletion_interval", 86400000L);
        zzu = zza2.zzd("measurement.sdk.attribution.cache.ttl", CoreConstants.MILLIS_IN_ONE_WEEK);
        ...
        zzy = zza2.zzd("measurement.upload.interval", CoreConstants.MILLIS_IN_ONE_HOUR);
        ...
        zzK = zza2.zzd("measurement.upload.retry_time", ComponentTracker.DEFAULT_TIMEOUT);
        zzL = zza2.zze("measurement.upload.url", "https://app-measurement.com/a");
        zzM = zza2.zzd("measurement.upload.window_interval", CoreConstants.MILLIS_IN_ONE_HOUR);
    }
