...
public final class zzbk extends zzaw {
    public zzbk() {
        this.f46241a.add(zzbl.ASSIGN);
        this.f46241a.add(zzbl.CONST);
        this.f46241a.add(zzbl.CREATE_ARRAY);
        this.f46241a.add(zzbl.CREATE_OBJECT);
        this.f46241a.add(zzbl.EXPRESSION_LIST);
        this.f46241a.add(zzbl.GET);
        this.f46241a.add(zzbl.GET_INDEX);
        this.f46241a.add(zzbl.GET_PROPERTY);
        this.f46241a.add(zzbl.NULL);
        this.f46241a.add(zzbl.SET_PROPERTY);
        this.f46241a.add(zzbl.TYPEOF);
        this.f46241a.add(zzbl.UNDEFINED);
        this.f46241a.add(zzbl.VAR);
    }
        ...
        if (ordinal != 3) {
                                ...
                                if (ordinal != 17) {
                                    if (ordinal != 18) {
                                        ...
                                        if (list.size() % 2 == 0) {
                                            ...
                                            while (i < list.size() - 1) {
                                                zzap zzb5 = zzgVar.zzb((zzap) list.get(i));
                                                zzap zzb6 = zzgVar.zzb((zzap) list.get(i + 1));
            ...
            if (list.size() % 2 == 0) {
                for (int i2 = 0; i2 < list.size() - 1; i2 += 2) {
                    zzap zzb12 = zzgVar.zzb((zzap) list.get(i2));
                    if (zzb12 instanceof zzat) {
                        zzgVar.zzf(zzb12.zzi(), zzgVar.zzb((zzap) list.get(i2 + 1)));
                    } else {
