...
public final class zzl extends zzam {
    ...
    /* renamed from: b */
    public final zzab f46337b;

    public zzl(zzab zzabVar) {
        this.f46337b = zzabVar;
    }
    ...
    public final zzap zzbN(String str, zzg zzgVar, List list) {
        ...
        if (c != 0) {
            ...
            return zzi.zzb(this.f46337b.zzb().zzc(zzgVar.zzb((zzap) list.get(0)).zzi()));
        }
        zzh.zzh("getEventName", 0, list);
        return new zzat(this.f46337b.zzb().zzd());
    }
}
