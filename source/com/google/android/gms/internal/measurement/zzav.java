...
public final class zzav extends zzaw {
    public zzav() {
        this.f46241a.add(zzbl.BITWISE_AND);
        this.f46241a.add(zzbl.BITWISE_LEFT_SHIFT);
        this.f46241a.add(zzbl.BITWISE_NOT);
        this.f46241a.add(zzbl.BITWISE_OR);
        this.f46241a.add(zzbl.BITWISE_RIGHT_SHIFT);
        this.f46241a.add(zzbl.BITWISE_UNSIGNED_RIGHT_SHIFT);
        this.f46241a.add(zzbl.BITWISE_XOR);
    }
