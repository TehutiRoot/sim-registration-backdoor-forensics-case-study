...
public final class zzst {
    ...
    /* renamed from: a */
    public static final GmsLogger f46508a = new GmsLogger("RemoteModelUtils", "");
    ...
    public static zznc zza(RemoteModel remoteModel, SharedPrefManager sharedPrefManager, zzsj zzsjVar) {
        ...
        if (zzsjVar.zzg()) {
            ...
            if (modelDownloadBeginTimeMs == 0) {
                f46508a.m48400w("RemoteModelUtils", "Model downloaded without its beginning time recorded.");
            } else {
