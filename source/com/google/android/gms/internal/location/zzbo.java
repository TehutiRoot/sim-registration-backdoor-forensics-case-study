...
public final class zzbo {
    ...
    /* renamed from: a */
    public static final SimpleDateFormat f46176a;

    /* renamed from: b */
    public static final SimpleDateFormat f46177b;

    /* renamed from: c */
    public static final StringBuilder f46178c;

    static {
        Locale locale = Locale.ROOT;
        f46176a = new SimpleDateFormat("MM-dd HH:mm:ss.SSS", locale);
        f46177b = new SimpleDateFormat("MM-dd HH:mm:ss", locale);
        f46178c = new StringBuilder(33);
    }
