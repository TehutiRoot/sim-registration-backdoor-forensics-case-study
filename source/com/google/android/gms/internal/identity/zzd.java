...
public final class zzd extends zzf {
    ...
    /* renamed from: b */
    public Activity f46135b;

    public zzd(int i, Activity activity) {
        this.f46134a = i;
        this.f46135b = activity;
    }
    ...
    public final void zzc(int i, Bundle bundle) {
        ...
        if (i == 1) {
            ...
            Activity activity = this.f46135b;
            if (activity == null || (createPendingResult = activity.createPendingResult(this.f46134a, intent, 1073741824)) == null) {
                return;
            }
            try {
        ...
        if (connectionResult.hasResolution()) {
            try {
                connectionResult.startResolutionForResult((Activity) Preconditions.checkNotNull(this.f46135b), this.f46134a);
                return;
        ...
        try {
            PendingIntent createPendingResult2 = ((Activity) Preconditions.checkNotNull(this.f46135b)).createPendingResult(this.f46134a, new Intent(), 1073741824);
