...
public final class CameraPosition extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public static final class Builder {
        ...
        public CameraPosition build() {
            return new CameraPosition(this.f47897a, this.f47898b, this.f47899c, this.f47900d);
        }

        @NonNull
        public Builder target(@NonNull LatLng latLng) {
            this.f47897a = (LatLng) Preconditions.checkNotNull(latLng, "location must not be null.");
            return this;
        }
        ...
        public Builder(@NonNull CameraPosition cameraPosition) {
            ...
            this.f47897a = cameraPosition2.target;
            this.f47898b = cameraPosition2.zoom;
            this.f47899c = cameraPosition2.tilt;
            this.f47900d = cameraPosition2.bearing;
        }
    }

    @SafeParcelable.Constructor
    public CameraPosition(@NonNull @SafeParcelable.Param(m48388id = 2) LatLng latLng, @SafeParcelable.Param(m48388id = 3) float f, @SafeParcelable.Param(m48388id = 4) float f2, @SafeParcelable.Param(m48388id = 5) float f3) {
        boolean z;
