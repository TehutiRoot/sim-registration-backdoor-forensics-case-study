...
public final class GoogleAuthUtil extends zzd {
    ...
    /* renamed from: d */
    public static final String f44437d = zzd.KEY_CALLER_UID;

    /* renamed from: e */
    public static final String f44438e = zzd.KEY_ANDROID_PACKAGE_NAME;
    ...
    /* renamed from: g */
    public static TokenData m48725g(Context context, Account account, String str, Bundle bundle) {
        if (bundle == null) {
            bundle = new Bundle();
        }
        try {
    ...
    public static String getTokenWithNotification(Context context, Account account, String str, Bundle bundle) throws IOException, UserRecoverableNotifiedException, GoogleAuthException {
        ...
        return m48725g(context, account, str, bundle).zzb();
    }
