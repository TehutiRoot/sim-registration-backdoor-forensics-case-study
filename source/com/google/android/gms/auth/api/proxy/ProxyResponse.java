...
public class ProxyResponse extends AbstractSafeParcelable {
    ...
    /* renamed from: b */
    public static Bundle m48719b(Map map) {
    ...
    public static ProxyResponse createErrorProxyResponse(int i, PendingIntent pendingIntent, int i2, Map<String, String> map, byte[] bArr) {
        return new ProxyResponse(1, i, pendingIntent, i2, m48719b(map), bArr);
    }
    ...
    public Map<String, String> getHeaders() {
        ...
        for (String str : this.f44510b.keySet()) {
            hashMap.put(str, this.f44510b.getString(str));
        }
        return hashMap;
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        SafeParcelWriter.writeBundle(parcel, 4, this.f44510b, false);
        SafeParcelWriter.writeByteArray(parcel, 5, this.body, false);
        SafeParcelWriter.writeInt(parcel, 1000, this.f44509a);
