...
public final class LocationResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    /* renamed from: a */
    public final List f47769a;

    /* renamed from: b */
    public static final List f47768b = Collections.emptyList();
    @NonNull
    ...
    */
    public boolean equals(@androidx.annotation.Nullable java.lang.Object r10) {
        /*
            ...
            r2 = 31
            if (r0 < r2) goto L16
            java.util.List r0 = r9.f47769a
            java.util.List r10 = r10.f47769a
            boolean r10 = r0.equals(r10)
            return r10
        L16:
            java.util.List r0 = r9.f47769a
            int r0 = r0.size()
            java.util.List r2 = r10.f47769a
            int r2 = r2.size()
            if (r0 == r2) goto L25
            return r1
        L25:
    ...
    public Location getLastLocation() {
        int size = this.f47769a.size();
        if (size == 0) {
            return null;
        }
        return (Location) this.f47769a.get(size - 1);
    }
    ...
    public int hashCode() {
        return Objects.hashCode(this.f47769a);
    }

    @NonNull
    public String toString() {
        return "LocationResult".concat(String.valueOf(this.f47769a));
    }
