        ...
        public final boolean zza(int i, @NonNull Parcel parcel, @NonNull Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 7:
                    boolean zzs = zzs();
                    parcel2.writeNoException();
                    ClassLoader classLoader = zzc.f45666a;
                ...
                case 11:
                    boolean zzt = zzt();
                    parcel2.writeNoException();
                    ClassLoader classLoader2 = zzc.f45666a;
                ...
                case 13:
                    boolean zzu = zzu();
                    parcel2.writeNoException();
                    ClassLoader classLoader3 = zzc.f45666a;
                    parcel2.writeInt(zzu ? 1 : 0);
                    return true;
                case 14:
                    boolean zzv = zzv();
                    parcel2.writeNoException();
                    ClassLoader classLoader4 = zzc.f45666a;
                    parcel2.writeInt(zzv ? 1 : 0);
                    return true;
                case 15:
                    boolean zzw = zzw();
                    parcel2.writeNoException();
                    ClassLoader classLoader5 = zzc.f45666a;
                    parcel2.writeInt(zzw ? 1 : 0);
                    return true;
                case 16:
                    boolean zzx = zzx();
                    parcel2.writeNoException();
                    ClassLoader classLoader6 = zzc.f45666a;
                    parcel2.writeInt(zzx ? 1 : 0);
                    return true;
                case 17:
                    boolean zzy = zzy();
                    parcel2.writeNoException();
                    ClassLoader classLoader7 = zzc.f45666a;
                    parcel2.writeInt(zzy ? 1 : 0);
                    return true;
                case 18:
                    boolean zzz = zzz();
                    parcel2.writeNoException();
                    ClassLoader classLoader8 = zzc.f45666a;
                    parcel2.writeInt(zzz ? 1 : 0);
                    return true;
                case 19:
                    boolean zzA = zzA();
                    parcel2.writeNoException();
                    ClassLoader classLoader9 = zzc.f45666a;
