...
public final class zzfu {
    ...
    public static com.google.android.gms.internal.gtm.zzam zzb(Object obj) {
        ...
        if (obj instanceof String) {
            ...
            if (obj == null) {
                cls = AbstractJsonLexerKt.NULL;
            } else {
                cls = obj.getClass().toString();
            }
            "Converting to Value from unknown object type: ".concat(String.valueOf(cls));
            return zzh;
        }
        zzg2.zzo(z);
        ...
        switch (zzamVar.zzh().ordinal()) {
            ...
            case 2:
                if (zzamVar.zzc() != zzamVar.zzd()) {
                    "Converting an invalid value to object: ".concat(zzamVar.toString());
                    return null;
                }
            ...
            default:
                "Failed to convert a value of type: ".concat(String.valueOf(zzamVar.zzh()));
                return null;
        }
    }
