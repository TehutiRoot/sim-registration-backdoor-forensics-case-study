...
public final class PaymentMethodTokenizationParameters extends AbstractSafeParcelable {
    ...
    public final class Builder {
        ...
        public Builder addParameter(@NonNull String str, @NonNull String str2) {
            ...
            PaymentMethodTokenizationParameters.this.f48834b.putString(str, str2);
            return this;
        }
        ...
        public Builder setPaymentMethodTokenizationType(int i) {
            PaymentMethodTokenizationParameters.this.f48833a = i;
            return this;
        }
    }

    public PaymentMethodTokenizationParameters() {
        this.f48834b = new Bundle();
    }
    ...
    public Bundle getParameters() {
        return new Bundle(this.f48834b);
    }
    ...
    public void writeToParcel(@NonNull Parcel parcel, int i) {
        ...
        SafeParcelWriter.writeInt(parcel, 2, this.f48833a);
        SafeParcelWriter.writeBundle(parcel, 3, this.f48834b, false);
