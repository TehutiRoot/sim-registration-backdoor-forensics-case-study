...
public final class LandmarkParcel extends AbstractSafeParcelable {
    ...
    @UsedByNative("wrapper.cc")
    public LandmarkParcel(@SafeParcelable.Param(m48388id = 1) int i, @SafeParcelable.Param(m48388id = 2) float f, @SafeParcelable.Param(m48388id = 3) float f2, @SafeParcelable.Param(m48388id = 4) int i2) {
        this.f48690a = i;
        this.zza = f;
        this.zzb = f2;
        this.zzc = i2;
    ...
    public final void writeToParcel(@RecentlyNonNull Parcel parcel, int i) {
        ...
        SafeParcelWriter.writeInt(parcel, 1, this.f48690a);
