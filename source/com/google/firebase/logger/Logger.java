...
public abstract class Logger {
    ...
    /* renamed from: d */
    public static final ConcurrentHashMap f55573d = new ConcurrentHashMap();
    ...
    public static final class Companion {
        ...
        public final Logger getLogger(@NotNull String tag, boolean z, @NotNull Level minLevel) {
            ...
            Intrinsics.checkNotNullParameter(tag, "tag");
            Intrinsics.checkNotNullParameter(minLevel, "minLevel");
            ConcurrentHashMap concurrentHashMap = Logger.f55573d;
        ...
        public final FakeLogger setupFakeLogger(@NotNull String tag, boolean z, @NotNull Level minLevel) {
            ...
            Logger.f55573d.put(tag, fakeLogger);
            return fakeLogger;
        }
    ...
    public static final class FakeLogger extends Logger {
        ...
        public FakeLogger(@NotNull String tag, boolean z, @NotNull Level minLevel) {
            ...
            Intrinsics.checkNotNullParameter(tag, "tag");
            Intrinsics.checkNotNullParameter(minLevel, "minLevel");
            this.f55577e = new ArrayList();
        }

        /* renamed from: c */
        public final String m38584c(Level level, String str, Object[] objArr, Throwable th2) {
            if (objArr.length != 0) {
                StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
            ...
            if (th2 != null) {
                String str2 = level + TokenParser.f74560SP + str + TokenParser.f74560SP + Log.getStackTraceString(th2);
                if (str2 != null) {
                    return str2;
                }
            }
            return level + TokenParser.f74560SP + str;
        }
        ...
        public final boolean hasLogMessageThat(@NotNull Function1<? super String, Boolean> predicate) {
            ...
            List<? super String> list = this.f55577e;
            if ((list instanceof Collection) && list.isEmpty()) {
                return false;
            }
            for (Object obj : list) {
        ...
        public int log(@NotNull Level level, @NotNull String format, @NotNull Object[] args, @Nullable Throwable th2) {
            ...
            Intrinsics.checkNotNullParameter(format, "format");
            Intrinsics.checkNotNullParameter(args, "args");
            String m38584c = m38584c(level, format, args, th2);
            System.out.println((Object) ("Log: " + m38584c));
            this.f55577e.add(m38584c);
            return m38584c.length();
        }
    }

    @Metadata(m28851d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0000\n\u0002\u0010\b\n\u0002\b\t\b\u0086\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u000f\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004R\u0014\u0010\u0002\u001a\u00020\u0003X\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006j\u0002\b\u0007j\u0002\b\bj\u0002\b\tj\u0002\b\nj\u0002\b\u000b¨\u0006\f"}, m28850d2 = {"Lcom/google/firebase/logger/Logger$Level;", "", LogFactory.PRIORITY_KEY, "", "(Ljava/lang/String;II)V", "getPriority$com_google_firebase_firebase_common", "()I", "VERBOSE", "DEBUG", "INFO", "WARN", "ERROR", "com.google.firebase-firebase-common"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    /* loaded from: classes4.dex */
    public enum Level {
        VERBOSE(2),
        DEBUG(3),
    ...
    /* renamed from: b */
    public static /* synthetic */ int m38585b(Logger logger, Level level, String str, Object[] objArr, Throwable th2, int i, Object obj) {
        if (obj == null) {
            if ((i & 4) != 0) {
                objArr = new Object[0];
            }
            return logger.m38586a(level, str, objArr, th2);
        }
    ...
    /* renamed from: a */
    public final int m38586a(Level level, String str, Object[] objArr, Throwable th2) {
        if (this.f55575b && (this.f55576c.getPriority$com_google_firebase_firebase_common() <= level.getPriority$com_google_firebase_firebase_common() || Log.isLoggable(this.f55574a, level.getPriority$com_google_firebase_firebase_common()))) {
    ...
    public final int debug(@NotNull String format, @NotNull Object[] args, @Nullable Throwable th2) {
        Intrinsics.checkNotNullParameter(format, "format");
        Intrinsics.checkNotNullParameter(args, "args");
        return m38586a(Level.DEBUG, format, args, th2);
    }
    ...
    public final int error(@NotNull String format, @NotNull Object[] args, @Nullable Throwable th2) {
        Intrinsics.checkNotNullParameter(format, "format");
        Intrinsics.checkNotNullParameter(args, "args");
        return m38586a(Level.ERROR, format, args, th2);
    }
    ...
    public final int info(@NotNull String format, @NotNull Object[] args, @Nullable Throwable th2) {
        Intrinsics.checkNotNullParameter(format, "format");
        Intrinsics.checkNotNullParameter(args, "args");
        return m38586a(Level.INFO, format, args, th2);
    }
    ...
    public final int verbose(@NotNull String format, @NotNull Object[] args, @Nullable Throwable th2) {
        Intrinsics.checkNotNullParameter(format, "format");
        Intrinsics.checkNotNullParameter(args, "args");
        return m38586a(Level.VERBOSE, format, args, th2);
    }
