...
public class RolloutAssignmentList {
    ...
    /* renamed from: a */
    public final List f54917a = new ArrayList();
    ...
    public synchronized List<RolloutAssignment> getRolloutAssignmentList() {
        return Collections.unmodifiableList(new ArrayList(this.f54917a));
    }

    @CanIgnoreReturnValue
    public synchronized boolean updateRolloutAssignmentList(List<RolloutAssignment> list) {
        this.f54917a.clear();
        if (list.size() > this.f54918b) {
            Logger logger = Logger.getLogger();
            logger.m39132w("Ignored 0 entries when adding rollout assignments. Maximum allowable: " + this.f54918b);
            return this.f54917a.addAll(list.subList(0, this.f54918b));
        }
        return this.f54917a.addAll(list);
    }
}
