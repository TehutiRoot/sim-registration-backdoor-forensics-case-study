...
public class AbtRegistrar implements ComponentRegistrar {
    ...
    /* renamed from: a */
    public static /* synthetic */ AbtComponent m39284a(ComponentContainer componentContainer) {
    ...
    public List<Component<?>> getComponents() {
        return Arrays.asList(Component.builder(AbtComponent.class).name(LIBRARY_NAME).add(Dependency.required(Context.class)).add(Dependency.optionalProvider(AnalyticsConnector.class)).factory(new ComponentFactory() { // from class: y0
            @Override // com.google.firebase.components.ComponentFactory
            public final Object create(ComponentContainer componentContainer) {
                return AbtRegistrar.m39284a(componentContainer);
            }
