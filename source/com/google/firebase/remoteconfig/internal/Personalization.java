...
public class Personalization {
    ...
    /* renamed from: a */
    public final Provider f56459a;

    /* renamed from: b */
    public final Map f56460b = Collections.synchronizedMap(new HashMap());

    public Personalization(Provider<AnalyticsConnector> provider) {
        this.f56459a = provider;
    }

    public void logArmActive(@NonNull String str, @NonNull ConfigContainer configContainer) {
        JSONObject optJSONObject;
        AnalyticsConnector analyticsConnector = (AnalyticsConnector) this.f56459a.get();
        ...
        synchronized (this.f56460b) {
            try {
                if (optString.equals(this.f56460b.get(str))) {
                    return;
                }
                this.f56460b.put(str, optString);
