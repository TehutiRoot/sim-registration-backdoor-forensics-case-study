...
public final class AndroidApplicationInfo {
    ...
    /* renamed from: e */
    public final ProcessDetails f56484e;

    /* renamed from: f */
    public final List f56485f;
    ...
    public AndroidApplicationInfo(@NotNull String packageName, @NotNull String versionName, @NotNull String appBuildVersion, @NotNull String deviceManufacturer, @NotNull ProcessDetails currentProcessDetails, @NotNull List<ProcessDetails> appProcessDetails) {
        ...
        this.f56480a = packageName;
        this.f56481b = versionName;
        this.f56482c = appBuildVersion;
        this.f56483d = deviceManufacturer;
        this.f56484e = currentProcessDetails;
        this.f56485f = appProcessDetails;
    }
    ...
    public static /* synthetic */ AndroidApplicationInfo copy$default(AndroidApplicationInfo androidApplicationInfo, String str, String str2, String str3, String str4, ProcessDetails processDetails, List list, int i, Object obj) {
        if ((i & 1) != 0) {
            str = androidApplicationInfo.f56480a;
        }
        if ((i & 2) != 0) {
            str2 = androidApplicationInfo.f56481b;
        }
        String str5 = str2;
        if ((i & 4) != 0) {
            str3 = androidApplicationInfo.f56482c;
        }
        String str6 = str3;
        if ((i & 8) != 0) {
            str4 = androidApplicationInfo.f56483d;
        }
        String str7 = str4;
        if ((i & 16) != 0) {
            processDetails = androidApplicationInfo.f56484e;
        }
        ProcessDetails processDetails2 = processDetails;
        List list2 = list;
        if ((i & 32) != 0) {
            list2 = androidApplicationInfo.f56485f;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof AndroidApplicationInfo) {
            ...
            return Intrinsics.areEqual(this.f56480a, androidApplicationInfo.f56480a) && Intrinsics.areEqual(this.f56481b, androidApplicationInfo.f56481b) && Intrinsics.areEqual(this.f56482c, androidApplicationInfo.f56482c) && Intrinsics.areEqual(this.f56483d, androidApplicationInfo.f56483d) && Intrinsics.areEqual(this.f56484e, androidApplicationInfo.f56484e) && Intrinsics.areEqual(this.f56485f, androidApplicationInfo.f56485f);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((this.f56480a.hashCode() * 31) + this.f56481b.hashCode()) * 31) + this.f56482c.hashCode()) * 31) + this.f56483d.hashCode()) * 31) + this.f56484e.hashCode()) * 31) + this.f56485f.hashCode();
    }

    @NotNull
    public String toString() {
        return "AndroidApplicationInfo(packageName=" + this.f56480a + ", versionName=" + this.f56481b + ", appBuildVersion=" + this.f56482c + ", deviceManufacturer=" + this.f56483d + ", currentProcessDetails=" + this.f56484e + ", appProcessDetails=" + this.f56485f + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
}
