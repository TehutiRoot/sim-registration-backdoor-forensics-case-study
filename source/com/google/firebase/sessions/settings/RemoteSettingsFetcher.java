...
public final class RemoteSettingsFetcher implements CrashlyticsSettingsFetcher {
    ...
    /* renamed from: a */
    public final ApplicationInfo f56615a;

    /* renamed from: b */
    public final CoroutineContext f56616b;

    /* renamed from: c */
    public final String f56617c;

    @Metadata(m28851d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0006"}, m28850d2 = {"Lcom/google/firebase/sessions/settings/RemoteSettingsFetcher$Companion;", "", "()V", "FIREBASE_PLATFORM", "", "FIREBASE_SESSIONS_BASE_URL_STRING", "com.google.firebase-firebase-sessions"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    /* loaded from: classes4.dex */
    ...
    public RemoteSettingsFetcher(@NotNull ApplicationInfo appInfo, @NotNull CoroutineContext blockingDispatcher, @NotNull String baseUrl) {
        ...
        this.f56615a = appInfo;
        this.f56616b = blockingDispatcher;
        this.f56617c = baseUrl;
    }

    /* renamed from: a */
    public final URL m37602a() {
        return new URL(new Uri.Builder().scheme(UriUtil.HTTPS_SCHEME).authority(this.f56617c).appendPath("spi").appendPath("v2").appendPath("platforms").appendPath("android").appendPath("gmp").appendPath(this.f56615a.getAppId()).appendPath("settings").appendQueryParameter("build_version", this.f56615a.getAndroidAppInfo().getAppBuildVersion()).appendQueryParameter("display_version", this.f56615a.getAndroidAppInfo().getVersionName()).build().toString());
    }
    ...
    public Object doConfigFetch(@NotNull Map<String, String> map, @NotNull Function2<? super JSONObject, ? super Continuation<? super Unit>, ? extends Object> function2, @NotNull Function2<? super String, ? super Continuation<? super Unit>, ? extends Object> function22, @NotNull Continuation<? super Unit> continuation) {
        Object withContext = BuildersKt.withContext(this.f56616b, new RemoteSettingsFetcher$doConfigFetch$2(this, map, function2, function22, null), continuation);
