...
public final class ProcessDetails {
    ...
    public static /* synthetic */ ProcessDetails copy$default(ProcessDetails processDetails, String str, int i, int i2, boolean z, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            str = processDetails.f56536a;
        }
        if ((i3 & 2) != 0) {
            i = processDetails.f56537b;
        }
        if ((i3 & 4) != 0) {
            i2 = processDetails.f56538c;
        }
        if ((i3 & 8) != 0) {
            z = processDetails.f56539d;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof ProcessDetails) {
            ...
            return Intrinsics.areEqual(this.f56536a, processDetails.f56536a) && this.f56537b == processDetails.f56537b && this.f56538c == processDetails.f56538c && this.f56539d == processDetails.f56539d;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((((this.f56536a.hashCode() * 31) + this.f56537b) * 31) + this.f56538c) * 31;
    ...
    public String toString() {
        return "ProcessDetails(processName=" + this.f56536a + ", pid=" + this.f56537b + ", importance=" + this.f56538c + ", isDefaultProcess=" + this.f56539d + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
}
