...
public final class SessionDetails {
    ...
    public SessionDetails(@NotNull String sessionId, @NotNull String firstSessionId, int i, long j) {
        ...
        this.f56558a = sessionId;
        this.f56559b = firstSessionId;
        this.f56560c = i;
        this.f56561d = j;
    }
    ...
    public static /* synthetic */ SessionDetails copy$default(SessionDetails sessionDetails, String str, String str2, int i, long j, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            str = sessionDetails.f56558a;
        }
        if ((i2 & 2) != 0) {
            str2 = sessionDetails.f56559b;
        }
        String str3 = str2;
        if ((i2 & 4) != 0) {
            i = sessionDetails.f56560c;
        }
        int i3 = i;
        if ((i2 & 8) != 0) {
            j = sessionDetails.f56561d;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof SessionDetails) {
            ...
            return Intrinsics.areEqual(this.f56558a, sessionDetails.f56558a) && Intrinsics.areEqual(this.f56559b, sessionDetails.f56559b) && this.f56560c == sessionDetails.f56560c && this.f56561d == sessionDetails.f56561d;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((this.f56558a.hashCode() * 31) + this.f56559b.hashCode()) * 31) + this.f56560c) * 31) + AbstractC17792Ig1.m67882a(this.f56561d);
    }

    @NotNull
    public String toString() {
        return "SessionDetails(sessionId=" + this.f56558a + ", firstSessionId=" + this.f56559b + ", sessionIndex=" + this.f56560c + ", sessionStartTimestampUs=" + this.f56561d + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
}
