...
@Keep
@Metadata(m28851d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0006\b\u0001\u0018\u0000 \n2\u00020\u0001:\u0001\u000bB\u0007¢\u0006\u0004\b\u0002\u0010\u0003J=\u0010\b\u001a0\u0012,\u0012*\u0012\u000e\b\u0001\u0012\n \u0007*\u0004\u0018\u00010\u00060\u0006 \u0007*\u0014\u0012\u000e\b\u0001\u0012\n \u0007*\u0004\u0018\u00010\u00060\u0006\u0018\u00010\u00050\u00050\u0004H\u0016¢\u0006\u0004\b\b\u0010\t¨\u0006\f"}, m28850d2 = {"Lcom/google/firebase/sessions/FirebaseSessionsRegistrar;", "Lcom/google/firebase/components/ComponentRegistrar;", "<init>", "()V", "", "Lcom/google/firebase/components/Component;", "", "kotlin.jvm.PlatformType", "getComponents", "()Ljava/util/List;", "Companion", PDPageLabelRange.STYLE_LETTERS_LOWER, "com.google.firebase-firebase-sessions"}, m28849k = 1, m28848mv = {1, 8, 0})
/* loaded from: classes4.dex */
public final class FirebaseSessionsRegistrar implements ComponentRegistrar {
    @NotNull
    private static final C8652a Companion = new C8652a(null);
    @NotNull
    ...
    public static final class C8652a {
        public /* synthetic */ C8652a(DefaultConstructorMarker defaultConstructorMarker) {
            this();
        }
    ...
    /* renamed from: a */
    public static /* synthetic */ SessionDatastore m37644a(ComponentContainer componentContainer) {
        return getComponents$lambda$4(componentContainer);
    }

    /* renamed from: b */
    public static /* synthetic */ SessionLifecycleServiceBinder m37643b(ComponentContainer componentContainer) {
        return getComponents$lambda$5(componentContainer);
    }

    /* renamed from: c */
    public static /* synthetic */ SessionsSettings m37642c(ComponentContainer componentContainer) {
        return getComponents$lambda$3(componentContainer);
    }

    /* renamed from: d */
    public static /* synthetic */ SessionFirelogPublisher m37641d(ComponentContainer componentContainer) {
        return getComponents$lambda$2(componentContainer);
    }

    /* renamed from: e */
    public static /* synthetic */ SessionGenerator m37640e(ComponentContainer componentContainer) {
        return getComponents$lambda$1(componentContainer);
    }

    /* renamed from: f */
    public static /* synthetic */ FirebaseSessions m37639f(ComponentContainer componentContainer) {
    ...
    public List<Component<? extends Object>> getComponents() {
        ...
        Component build = add2.add(Dependency.required(qualified3)).add(Dependency.required(sessionLifecycleServiceBinder)).factory(new ComponentFactory() { // from class: q20
            @Override // com.google.firebase.components.ComponentFactory
            public final Object create(ComponentContainer componentContainer) {
                return FirebaseSessionsRegistrar.m37639f(componentContainer);
            }
        }).eagerInDefaultApp().build();
        Component build2 = Component.builder(SessionGenerator.class).name("session-generator").factory(new ComponentFactory() { // from class: r20
            @Override // com.google.firebase.components.ComponentFactory
            public final Object create(ComponentContainer componentContainer) {
                return FirebaseSessionsRegistrar.m37640e(componentContainer);
            }
        }).build();
        ...
        return CollectionsKt__CollectionsKt.listOf((Object[]) new Component[]{build, build2, add3.add(Dependency.required(qualified4)).add(Dependency.required(qualified2)).add(Dependency.requiredProvider(transportFactory)).add(Dependency.required(qualified3)).factory(new ComponentFactory() { // from class: s20
            @Override // com.google.firebase.components.ComponentFactory
            public final Object create(ComponentContainer componentContainer) {
                return FirebaseSessionsRegistrar.m37641d(componentContainer);
            }
        }).build(), Component.builder(SessionsSettings.class).name("sessions-settings").add(Dependency.required(qualified)).add(Dependency.required(blockingDispatcher)).add(Dependency.required(qualified3)).add(Dependency.required(qualified4)).factory(new ComponentFactory() { // from class: t20
            @Override // com.google.firebase.components.ComponentFactory
            public final Object create(ComponentContainer componentContainer) {
                return FirebaseSessionsRegistrar.m37642c(componentContainer);
            }
        }).build(), Component.builder(SessionDatastore.class).name("sessions-datastore").add(Dependency.required(qualified)).add(Dependency.required(qualified3)).factory(new ComponentFactory() { // from class: u20
            @Override // com.google.firebase.components.ComponentFactory
            public final Object create(ComponentContainer componentContainer) {
                return FirebaseSessionsRegistrar.m37644a(componentContainer);
            }
        }).build(), Component.builder(SessionLifecycleServiceBinder.class).name("sessions-service-binder").add(Dependency.required(qualified)).factory(new ComponentFactory() { // from class: v20
            @Override // com.google.firebase.components.ComponentFactory
            public final Object create(ComponentContainer componentContainer) {
                return FirebaseSessionsRegistrar.m37643b(componentContainer);
            }
