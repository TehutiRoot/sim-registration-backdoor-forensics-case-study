...
import com.google.firebase.installations.local.C8527a;
...
public abstract class PersistedInstallationEntry {
    ...
    public static Builder builder() {
        return new C8527a.C8529b().setTokenCreationEpochInSecs(0L).setRegistrationStatus(PersistedInstallation.RegistrationStatus.ATTEMPT_MIGRATION).setExpiresInSecs(0L);
    }
