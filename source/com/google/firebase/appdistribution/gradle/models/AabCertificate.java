...
public final class AabCertificate {
    ...
    public AabCertificate(@NotNull String certificateHashMd5, @NotNull String certificateHashSha1, @NotNull String certificateHashSha256) {
        ...
        this.f54606a = certificateHashMd5;
        this.f54607b = certificateHashSha1;
        this.f54608c = certificateHashSha256;
    }
    ...
    public static /* synthetic */ AabCertificate copy$default(AabCertificate aabCertificate, String str, String str2, String str3, int i, Object obj) {
        if ((i & 1) != 0) {
            str = aabCertificate.f54606a;
        }
        if ((i & 2) != 0) {
            str2 = aabCertificate.f54607b;
        }
        if ((i & 4) != 0) {
            str3 = aabCertificate.f54608c;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof AabCertificate) {
            ...
            return Intrinsics.areEqual(this.f54606a, aabCertificate.f54606a) && Intrinsics.areEqual(this.f54607b, aabCertificate.f54607b) && Intrinsics.areEqual(this.f54608c, aabCertificate.f54608c);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((this.f54606a.hashCode() * 31) + this.f54607b.hashCode()) * 31) + this.f54608c.hashCode();
    }

    @NotNull
    public String toString() {
        return "AabCertificate(certificateHashMd5=" + this.f54606a + ", certificateHashSha1=" + this.f54607b + ", certificateHashSha256=" + this.f54608c + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
}
