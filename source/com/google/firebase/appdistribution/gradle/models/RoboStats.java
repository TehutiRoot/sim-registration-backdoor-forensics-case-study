...
public final class RoboStats {
    ...
    public static /* synthetic */ RoboStats copy$default(RoboStats roboStats, Integer num, String str, Integer num2, Boolean bool, int i, Object obj) {
        if ((i & 1) != 0) {
            num = roboStats.f54639a;
        }
        if ((i & 2) != 0) {
            str = roboStats.f54640b;
        }
        if ((i & 4) != 0) {
            num2 = roboStats.f54641c;
        }
        if ((i & 8) != 0) {
            bool = roboStats.f54642d;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof RoboStats) {
            ...
            return Intrinsics.areEqual(this.f54639a, roboStats.f54639a) && Intrinsics.areEqual(this.f54640b, roboStats.f54640b) && Intrinsics.areEqual(this.f54641c, roboStats.f54641c) && Intrinsics.areEqual(this.f54642d, roboStats.f54642d);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        String str = this.f54640b;
        int hashCode2 = (hashCode + (str == null ? 0 : str.hashCode())) * 31;
        Integer num2 = this.f54641c;
        int hashCode3 = (hashCode2 + (num2 == null ? 0 : num2.hashCode())) * 31;
        Boolean bool = this.f54642d;
        return hashCode3 + (bool != null ? bool.hashCode() : 0);
    }

    @NotNull
    public String toString() {
        return "RoboStats(actionsPerformed=" + this.f54639a + ", crawlDuration=" + this.f54640b + ", distinctVisitedScreens=" + this.f54641c + ", mainActivityCrawlTimedOut=" + this.f54642d + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
