...
public final class ErrorPayload {
    ...
    public static /* synthetic */ ErrorPayload copy$default(ErrorPayload errorPayload, String str, int i, String str2, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            str = errorPayload.f54623a;
        }
        if ((i2 & 2) != 0) {
            i = errorPayload.f54624b;
        }
        if ((i2 & 4) != 0) {
            str2 = errorPayload.f54625c;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof ErrorPayload) {
            ...
            return Intrinsics.areEqual(this.f54623a, errorPayload.f54623a) && this.f54624b == errorPayload.f54624b && Intrinsics.areEqual(this.f54625c, errorPayload.f54625c);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode = (((str == null ? 0 : str.hashCode()) * 31) + this.f54624b) * 31;
    ...
    public String toString() {
        return "ErrorPayload(message=" + this.f54623a + ", code=" + this.f54624b + ", status=" + this.f54625c + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
