...
public final class Release {
    ...
    public Release(@NotNull String name, @NotNull String displayVersion, @NotNull String buildVersion, @NotNull String firebaseConsoleUri, @NotNull String testingUri, @NotNull String binaryDownloadUri) {
        ...
        this.f54650a = name;
        this.f54651b = displayVersion;
        this.f54652c = buildVersion;
        this.f54653d = firebaseConsoleUri;
        this.f54654e = testingUri;
        this.f54655f = binaryDownloadUri;
    }
    ...
    public static /* synthetic */ Release copy$default(Release release, String str, String str2, String str3, String str4, String str5, String str6, int i, Object obj) {
        ...
        if ((i & 2) != 0) {
            str2 = release.f54651b;
        }
        String str7 = str2;
        if ((i & 4) != 0) {
            str3 = release.f54652c;
        }
        String str8 = str3;
        if ((i & 8) != 0) {
            str4 = release.f54653d;
        }
        String str9 = str4;
        if ((i & 16) != 0) {
            str5 = release.f54654e;
        }
        String str10 = str5;
        if ((i & 32) != 0) {
            str6 = release.f54655f;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof Release) {
            ...
            return Intrinsics.areEqual(this.f54650a, release.f54650a) && Intrinsics.areEqual(this.f54651b, release.f54651b) && Intrinsics.areEqual(this.f54652c, release.f54652c) && Intrinsics.areEqual(this.f54653d, release.f54653d) && Intrinsics.areEqual(this.f54654e, release.f54654e) && Intrinsics.areEqual(this.f54655f, release.f54655f);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((this.f54650a.hashCode() * 31) + this.f54651b.hashCode()) * 31) + this.f54652c.hashCode()) * 31) + this.f54653d.hashCode()) * 31) + this.f54654e.hashCode()) * 31) + this.f54655f.hashCode();
    }

    @NotNull
    public String toString() {
        return "Release(name=" + this.f54650a + ", displayVersion=" + this.f54651b + ", buildVersion=" + this.f54652c + ", firebaseConsoleUri=" + this.f54653d + ", testingUri=" + this.f54654e + ", binaryDownloadUri=" + this.f54655f + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
}
