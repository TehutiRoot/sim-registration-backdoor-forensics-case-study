...
public final class WrappedResponse {
    ...
    public static /* synthetic */ WrappedResponse copy$default(WrappedResponse wrappedResponse, UploadStatus uploadStatus, Release release, int i, Object obj) {
        if ((i & 1) != 0) {
            uploadStatus = wrappedResponse.f54660a;
        }
        if ((i & 2) != 0) {
            release = wrappedResponse.f54661b;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof WrappedResponse) {
            ...
            return this.f54660a == wrappedResponse.f54660a && Intrinsics.areEqual(this.f54661b, wrappedResponse.f54661b);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.f54660a.hashCode() * 31) + this.f54661b.hashCode();
    }

    @NotNull
    public String toString() {
        return "WrappedResponse(status=" + this.f54660a + ", release=" + this.f54661b + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
}
