...
public final class FirebaseAppDistribution {
    ...
    public static final void addTesters(@NotNull TesterManagementOptions options) {
        ...
        try {
            new ApiService(firebaseAppDistribution.m39264a(firebaseAppDistribution.m39263b(options))).batchAddTesters(options.getProjectNumber(), options.getEmails());
    ...
    public static final void removeTesters(@NotNull TesterManagementOptions options) {
        ...
        FirebaseAppDistribution firebaseAppDistribution = INSTANCE;
        try {
            new ApiService(firebaseAppDistribution.m39264a(firebaseAppDistribution.m39263b(options))).batchRemoveTesters(options.getProjectNumber(), options.getEmails());
        } catch (HttpResponseException e) {
    ...
    public static final void uploadDistribution(@NotNull UploadDistributionOptions options) {
        Intrinsics.checkNotNullParameter(options, "options");
        FirebaseAppDistribution firebaseAppDistribution = INSTANCE;
        AuthenticatedHttpClient m39264a = firebaseAppDistribution.m39264a(firebaseAppDistribution.m39262c(options));
        new FirebaseAppDistributionUpload(options, new ApiService(m39264a), new UploadService(m39264a), null, null, 24, null).uploadDistribution();
    }

    /* renamed from: a */
    public final AuthenticatedHttpClient m39264a(Credential credential) {
        boolean z;
        try {
    ...
    /* renamed from: b */
    public final Credential m39263b(TesterManagementOptions testerManagementOptions) {
    ...
    /* renamed from: c */
    public final Credential m39262c(UploadDistributionOptions uploadDistributionOptions) {
