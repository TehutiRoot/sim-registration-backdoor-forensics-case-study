...
public final class AppDistributionEnvironmentImpl implements AppDistributionEnvironment {
    ...
    /* renamed from: a */
    public static final Logger f54568a;

    @Metadata(m28851d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0016\u0010\u0003\u001a\n \u0005*\u0004\u0018\u00010\u00040\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0006"}, m28850d2 = {"Lcom/google/firebase/appdistribution/gradle/AppDistributionEnvironmentImpl$Companion;", "", "()V", "logger", "Lorg/gradle/api/logging/Logger;", "kotlin.jvm.PlatformType", "appdistribution-gradle"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    /* loaded from: classes4.dex */
    ...
    static {
        ...
        Companion = companion;
        f54568a = Logging.getLogger(companion.getClass());
    }
    ...
    public GoogleCredential getFirebaseCliLoginCredentials(@NotNull HttpTransport transport) {
        ...
        try {
            ...
            f54568a.debug("Failed to authenticate with Firebase CLI credentials", e);
        }
        return null;
    }
}
