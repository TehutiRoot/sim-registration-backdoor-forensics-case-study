...
public final class ApiEndpoints {
    ...
    /* renamed from: a */
    public static final String f54563a = System.getProperty("FIREBASE_APP_DISTRIBUTION_API_URL", "https://firebaseappdistribution.googleapis.com");

    /* renamed from: b */
    public static final List f54564b = AbstractC10108ds.listOf("https://www.googleapis.com/auth/cloud-platform");
    ...
    public static final GenericUrl getScottyUploadEndpoint(@NotNull String appName) {
        ...
        return new GenericUrl(f54563a + "/upload/v1/" + appName + "/releases:upload");
    }

    @NotNull
    public final GenericUrl getAabInfo(@NotNull String appName) {
        Intrinsics.checkNotNullParameter(appName, "appName");
        return new GenericUrl(f54563a + "/v1/" + appName + "/aabInfo");
    }

    @NotNull
    public final GenericUrl getBatchAddTestersEndpoint(long j) {
        return new GenericUrl(f54563a + "/v1/projects/" + j + "/testers:batchAdd");
    }

    @NotNull
    public final GenericUrl getBatchRemoveTestersEndpoint(long j) {
        return new GenericUrl(f54563a + "/v1/projects/" + j + "/testers:batchRemove");
    }
    ...
    public final GenericUrl getCreateReleaseNotesEndpoint(@NotNull String releaseName) {
        ...
        return new GenericUrl(f54563a + "/v1/" + releaseName + "?updateMask=release_notes.text");
    }

    @NotNull
    public final GenericUrl getCreateReleaseTestEndpoint(@NotNull String releaseName) {
        Intrinsics.checkNotNullParameter(releaseName, "releaseName");
        return new GenericUrl(f54563a + "/v1alpha/" + releaseName + "/tests");
    }

    @NotNull
    public final GenericUrl getDistributeReleaseEndpoint(@NotNull String releaseName) {
        Intrinsics.checkNotNullParameter(releaseName, "releaseName");
        return new GenericUrl(f54563a + "/v1/" + releaseName + ":distribute");
    }
    ...
    public final GenericUrl getReleaseTestEndpoint(@NotNull String releaseTestName) {
        ...
        return new GenericUrl(f54563a + "/v1alpha/" + releaseTestName);
    }

    @NotNull
    public final GenericUrl getUploadStatusEndpoint(@NotNull String operationName) {
        Intrinsics.checkNotNullParameter(operationName, "operationName");
        return new GenericUrl(f54563a + "/v1/" + operationName);
    }
}
