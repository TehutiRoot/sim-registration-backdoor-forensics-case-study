...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n¢\u0006\u0004\b\u0004\u0010\u0005"}, m28850d2 = {"<anonymous>", "", "releaseTestName", "", "invoke", "(Ljava/lang/String;)Ljava/lang/Boolean;"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
...
public final class TestLookup$pollForReleaseTests$1 extends Lambda implements Function1<String, Boolean> {
    ...
    public final Boolean invoke(@NotNull String releaseTestName) {
        ...
        m39256b = this.this$0.m39256b(this.$apiService, releaseTestName);
        return Boolean.valueOf(m39256b);
    }
}
