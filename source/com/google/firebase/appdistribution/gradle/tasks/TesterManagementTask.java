...
public abstract class TesterManagementTask extends DefaultTask {
    ...
    public final TesterManagementOptions getOptions() {
        Long l = (Long) this.f54662a.getOrNull();
        if (l != null) {
            return new TesterManagementOptions(l.longValue(), (String) this.f54663b.getOrNull(), (String) this.f54664c.getOrNull(), (String) this.f54665d.getOrNull(), null, 16, null);
        }
    ...
    public final void setProjectNumber(@NotNull String projectNumber) {
        ...
        try {
            this.f54662a.set(Long.valueOf(Long.parseLong(projectNumber)));
    ...
    public final void setServiceCredentialsFile(@NotNull String serviceCredentialsFilePath) {
        ...
        this.f54665d.set(serviceCredentialsFilePath);
    }
}
