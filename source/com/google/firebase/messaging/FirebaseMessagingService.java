...
public class FirebaseMessagingService extends EnhancedIntentService {
    ...
    /* renamed from: g */
    public static final Queue f55632g = new ArrayDeque(10);
    ...
    public Intent getStartCommandIntent(Intent intent) {
        return ServiceStarter.m38448b().m38447c();
    }
    ...
    /* renamed from: i */
    public final boolean m38494i(String str) {
    ...
    /* renamed from: j */
    public final void m38493j(Intent intent) {
        ...
        if (NotificationParams.isNotification(extras)) {
            ...
            ExecutorService m31108e = AbstractC10308gW.m31108e();
            try {
                if (new C8551a(this, notificationParams, m31108e).m38443a()) {
                    return;
                }
                m31108e.shutdown();
    ...
    /* renamed from: k */
    public final String m38492k(Intent intent) {
    ...
    /* renamed from: l */
    public final Rpc m38491l(Context context) {
        if (this.f55633f == null) {
            this.f55633f = new Rpc(context.getApplicationContext());
        }
        return this.f55633f;
    }

    /* renamed from: m */
    public final void m38490m(Intent intent) {
        if (!m38494i(intent.getStringExtra(Constants.MessagePayloadKeys.MSGID))) {
            m38489n(intent);
        }
        m38491l(this).messageHandled(new CloudMessage(intent));
    }

    /* renamed from: n */
    public final void m38489n(Intent intent) {
        ...
        switch (c) {
            ...
            case 1:
                ...
                return;
            case 2:
                onSendError(m38492k(intent), new SendException(intent.getStringExtra(Constants.IPC_BUNDLE_KEY_SEND_ERROR)));
                return;
            case 3:
