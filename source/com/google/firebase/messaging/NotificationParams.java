...
public class NotificationParams {
    ...
    public NotificationParams(@NonNull Bundle bundle) {
        if (bundle != null) {
            this.f55637a = new Bundle(bundle);
            return;
        }
    ...
    /* renamed from: a */
    public static int m38463a(String str) {
    ...
    /* renamed from: f */
    public static boolean m38458f(String str) {
    ...
    /* renamed from: g */
    public static boolean m38457g(String str) {
    ...
    /* renamed from: h */
    public static String m38456h(String str) {
    ...
    /* renamed from: j */
    public static String m38454j(String str) {
        if (str.startsWith(Constants.MessageNotificationKeys.NOTIFICATION_PREFIX)) {
    ...
    public int[] m38462b() {
        ...
        try {
            if (jSONArray.length() == 3) {
                iArr[0] = m38463a(jSONArray.optString(0));
    ...
    public Integer getInteger(String str) {
        ...
        if (!TextUtils.isEmpty(string)) {
            try {
                ...
                Log.w("NotificationParams", "Couldn't parse value of " + m38454j(str) + "(" + string + ") into an int");
                return null;
            }
        }
        return null;
    ...
    public JSONArray getJSONArray(String str) {
        ...
        if (!TextUtils.isEmpty(string)) {
            try {
                ...
                Log.w("NotificationParams", "Malformed JSON for key " + m38454j(str) + ": " + string + ", falling back to default");
                return null;
            }
        }
        return null;
    ...
    public String getLocalizedString(Resources resources, String str, String str2) {
        ...
        if (identifier == 0) {
            Log.w("NotificationParams", m38454j(str2 + Constants.MessageNotificationKeys.TEXT_RESOURCE_SUFFIX) + " resource not found: " + str2 + " Default value will be used.");
            return null;
        }
        ...
        try {
            ...
            Log.w("NotificationParams", "Missing format argument for " + m38454j(str2) + ": " + Arrays.toString(localizationArgsForKey) + " Default value will be used.", e);
            return null;
        }
    }
    ...
    public Long getLong(String str) {
        ...
        if (!TextUtils.isEmpty(string)) {
            try {
                ...
                Log.w("NotificationParams", "Couldn't parse value of " + m38454j(str) + "(" + string + ") into a long");
                return null;
            }
        }
        return null;
    ...
    public String getString(String str) {
        return this.f55637a.getString(m38455i(str));
    }
    ...
    /* renamed from: i */
    public final String m38455i(String str) {
        if (!this.f55637a.containsKey(str) && str.startsWith(Constants.MessageNotificationKeys.NOTIFICATION_PREFIX)) {
            String m38456h = m38456h(str);
            if (this.f55637a.containsKey(m38456h)) {
                return m38456h;
            }
        }
        return str;
    ...
    public Bundle paramsForAnalyticsIntent() {
        Bundle bundle = new Bundle(this.f55637a);
        for (String str : this.f55637a.keySet()) {
            if (!m38458f(str)) {
                bundle.remove(str);
            }
        }
    ...
    public static boolean isNotification(Bundle bundle) {
        return "1".equals(bundle.getString(Constants.MessageNotificationKeys.ENABLE_NOTIFICATION)) || "1".equals(bundle.getString(m38456h(Constants.MessageNotificationKeys.ENABLE_NOTIFICATION)));
    }
}
