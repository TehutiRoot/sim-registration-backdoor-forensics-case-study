...
public final class FirebaseAnalytics {
    ...
    /* renamed from: c */
    public static volatile FirebaseAnalytics f54542c;

    /* renamed from: a */
    public final zzee f54543a;

    /* renamed from: b */
    public ExecutorService f54544b;
    ...
    public static FirebaseAnalytics getInstance(@NonNull Context context) {
        if (f54542c == null) {
            synchronized (FirebaseAnalytics.class) {
                try {
                    if (f54542c == null) {
                        f54542c = new FirebaseAnalytics(zzee.zzg(context, null, null, null, null));
                    }
                } finally {
                }
            }
        ...
        try {
            synchronized (FirebaseAnalytics.class) {
                if (this.f54544b == null) {
                    this.f54544b = new S92(this, 0, 1, 30L, TimeUnit.SECONDS, new ArrayBlockingQueue(100));
                }
                executorService = this.f54544b;
            }
            return Tasks.call(executorService, new CallableC21616pd2(this));
        } catch (RuntimeException e) {
            this.f54543a.zzA(5, "Failed to schedule task for getAppInstanceId", null, null, null);
    ...
    public void setAnalyticsCollectionEnabled(boolean z) {
        this.f54543a.zzK(Boolean.valueOf(z));
    }
