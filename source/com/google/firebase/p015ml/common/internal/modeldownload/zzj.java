...
public class zzj {
    ...
    /* renamed from: c */
    public static final GmsLogger f55773c = new GmsLogger("ModelLoader", "");

    /* renamed from: a */
    public final zzai f55774a;

    /* renamed from: b */
    public final zzl f55775b;
    @Nullable
    @VisibleForTesting
    ...
    public zzj(@Nullable zzai zzaiVar, @Nullable zzf zzfVar, @NonNull zzl zzlVar) {
        ...
        this.f55774a = zzaiVar;
        this.zzbns = zzfVar;
        this.f55775b = zzlVar;
    }

    /* renamed from: a */
    public final synchronized boolean m38387a(zzm zzmVar, List list) {
        zzai zzaiVar = this.f55774a;
        if (zzaiVar != null) {
            try {
                ...
                if (load != null) {
                    try {
                        zzmVar.zza(load);
                        f55773c.m48408d("ModelLoader", "Remote model source is loaded successfully");
                        return true;
                ...
                f55773c.m48408d("ModelLoader", "Remote model source can NOT be loaded, try local model.");
    ...
    /* renamed from: b */
    public final synchronized boolean m38386b(zzm zzmVar, List list) {
        MappedByteBuffer load;
        zzf zzfVar = this.zzbns;
        if (zzfVar != null && (load = zzfVar.load()) != null) {
            try {
                zzmVar.zza(load);
                f55773c.m48408d("ModelLoader", "Local model source is loaded successfully");
                return true;
            } catch (RuntimeException e) {
    ...
    */
    public final java.lang.String m38385c() {
        /*
            r5 = this;
        ...
        L30:
            r0 = 0
        L31:
            com.google.firebase.ml.common.internal.modeldownload.zzai r1 = r5.f55774a
            if (r1 != 0) goto L38
        ...
        L40:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.p015ml.common.internal.modeldownload.zzj.m38385c():java.lang.String");
    }
    ...
    public final synchronized void zza(zzm zzmVar) throws FirebaseMLException {
        ...
        if (z) {
            this.f55775b.zze(arrayList);
            this.zzbnu = zzo.zzboc;
            return;
        }
        try {
            z2 = m38386b(zzmVar, arrayList);
        } catch (Exception e3) {
            e = e3;
        }
        if (z2) {
        ...
        if (exc != null) {
            String valueOf = String.valueOf(m38385c());
            if (valueOf.length() != 0) {
            ...
            String valueOf2 = String.valueOf(m38385c());
            ...
            String valueOf3 = String.valueOf(m38385c());
