...
public class FirebaseVisionObject {
    ...
    /* renamed from: a */
    public final Rect f56005a;

    /* renamed from: b */
    public final Integer f56006b;

    /* renamed from: c */
    public final Float f56007c;
    ...
    public FirebaseVisionObject(@NonNull zzj zzjVar) {
        ...
        this.f56005a = new Rect(iArr[0], iArr[1], iArr[2], iArr[3]);
        this.f56006b = zzjVar.zzbww;
        this.f56007c = zzjVar.confidence;
        this.f56008d = zzjVar.category;
    }
