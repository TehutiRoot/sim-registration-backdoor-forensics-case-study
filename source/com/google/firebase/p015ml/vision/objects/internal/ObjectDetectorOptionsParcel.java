...
public class ObjectDetectorOptionsParcel extends AbstractSafeParcelable {
    ...
    public ObjectDetectorOptionsParcel(@SafeParcelable.Param(m48388id = 1) int i, @SafeParcelable.Param(m48388id = 2) boolean z, @SafeParcelable.Param(m48388id = 3) boolean z2) {
        this.zzbwx = i;
        this.zzbwy = z;
        this.zzbwz = z2;
    }
