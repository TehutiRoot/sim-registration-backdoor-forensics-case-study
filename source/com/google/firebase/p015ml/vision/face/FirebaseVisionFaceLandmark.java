...
public class FirebaseVisionFaceLandmark {
    ...
    /* renamed from: b */
    public final FirebaseVisionPoint f55981b;
    ...
    public FirebaseVisionFaceLandmark(int i, FirebaseVisionPoint firebaseVisionPoint) {
        this.f55980a = i;
        this.f55981b = firebaseVisionPoint;
    }
    ...
    public String toString() {
        return zzmc.zzaz("FirebaseVisionFaceLandmark").zzb("type", this.f55980a).zzh("position", this.f55981b).toString();
    }
}
