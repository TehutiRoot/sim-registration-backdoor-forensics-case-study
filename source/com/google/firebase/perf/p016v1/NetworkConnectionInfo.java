...
public final class NetworkConnectionInfo extends GeneratedMessageLite<NetworkConnectionInfo, Builder> implements NetworkConnectionInfoOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<NetworkConnectionInfo, Builder> implements NetworkConnectionInfoOrBuilder {
        public /* synthetic */ Builder(C8601a c8601a) {
            this();
        }

        public Builder clearMobileSubtype() {
            copyOnWrite();
            ((NetworkConnectionInfo) this.instance).m38011G();
            return this;
        }

        public Builder clearNetworkType() {
            copyOnWrite();
            ((NetworkConnectionInfo) this.instance).m38010H();
            return this;
        }
        ...
        public Builder setMobileSubtype(MobileSubtype mobileSubtype) {
            copyOnWrite();
            ((NetworkConnectionInfo) this.instance).m38009I(mobileSubtype);
            return this;
        }

        public Builder setNetworkType(NetworkType networkType) {
            copyOnWrite();
            ((NetworkConnectionInfo) this.instance).m38008J(networkType);
            return this;
        }
    ...
    public enum MobileSubtype implements Internal.EnumLite {
        ...
        private static final Internal.EnumLiteMap<MobileSubtype> internalValueMap = new C8597a();
        private final int value;

        /* renamed from: com.google.firebase.perf.v1.NetworkConnectionInfo$MobileSubtype$a */
        /* loaded from: classes4.dex */
        public class C8597a implements Internal.EnumLiteMap {
        ...
        /* loaded from: classes4.dex */
        public static final class C8598b implements Internal.EnumVerifier {

            /* renamed from: a */
            public static final Internal.EnumVerifier f56297a = new C8598b();
    ...
    public enum NetworkType implements Internal.EnumLite {
        ...
        private static final Internal.EnumLiteMap<NetworkType> internalValueMap = new C8599a();
        private final int value;

        /* renamed from: com.google.firebase.perf.v1.NetworkConnectionInfo$NetworkType$a */
        /* loaded from: classes4.dex */
        public class C8599a implements Internal.EnumLiteMap {
            @Override // com.google.protobuf.Internal.EnumLiteMap
            /* renamed from: a */
        ...
        /* loaded from: classes4.dex */
        public static final class C8600b implements Internal.EnumVerifier {

            /* renamed from: a */
            public static final Internal.EnumVerifier f56298a = new C8600b();
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C8601a {
        ...
        static {
            ...
            try {
                f56299a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f56299a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f56299a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f56299a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f56299a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f56299a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: G */
    public final void m38011G() {
        this.bitField0_ &= -3;
        this.mobileSubtype_ = 0;
    }

    /* renamed from: H */
    public final void m38010H() {
        this.bitField0_ &= -2;
        this.networkType_ = -1;
    }

    /* renamed from: I */
    public final void m38009I(MobileSubtype mobileSubtype) {
        this.mobileSubtype_ = mobileSubtype.getNumber();
        this.bitField0_ |= 2;
    }

    /* renamed from: J */
    public final void m38008J(NetworkType networkType) {
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C8601a.f56299a[methodToInvoke.ordinal()]) {
            case 1:
