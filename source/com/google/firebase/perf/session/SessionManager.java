...
public class SessionManager extends AppStateUpdateHandler {
    ...
    /* renamed from: a */
    public static /* synthetic */ void m38211a(SessionManager sessionManager, Context context, PerfSession perfSession) {
    ...
    public void setApplicationContext(final Context context) {
        ...
        this.syncInitFuture = Executors.newSingleThreadExecutor().submit(new Runnable() { // from class: iG1
            @Override // java.lang.Runnable
            public final void run() {
                SessionManager.m38211a(SessionManager.this, context, perfSession);
            }
        });
    }
