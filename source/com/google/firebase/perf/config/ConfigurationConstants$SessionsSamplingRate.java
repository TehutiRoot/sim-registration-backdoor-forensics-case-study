...
public final class ConfigurationConstants$SessionsSamplingRate extends AbstractC17229zw {

    /* renamed from: a */
    public static ConfigurationConstants$SessionsSamplingRate f56114a;
    ...
    public static synchronized ConfigurationConstants$SessionsSamplingRate getInstance() {
        ...
        synchronized (ConfigurationConstants$SessionsSamplingRate.class) {
            try {
                if (f56114a == null) {
                    f56114a = new ConfigurationConstants$SessionsSamplingRate();
                }
                configurationConstants$SessionsSamplingRate = f56114a;
            } catch (Throwable th2) {
                throw th2;
            }
        }
