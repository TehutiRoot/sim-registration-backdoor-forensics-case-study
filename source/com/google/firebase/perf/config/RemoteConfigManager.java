...
public class RemoteConfigManager {
    ...
    /* renamed from: a */
    public static /* synthetic */ void m38282a(RemoteConfigManager remoteConfigManager, Exception exc) {
        remoteConfigManager.m38279xc904e814(exc);
    }

    /* renamed from: b */
    public static /* synthetic */ void m38281b(RemoteConfigManager remoteConfigManager, Boolean bool) {
        remoteConfigManager.m38280xc904e813(bool);
    }
    ...
    public /* synthetic */ void m38280xc904e813(Boolean bool) {
    ...
    public /* synthetic */ void m38279xc904e814(Exception exc) {
    ...
    private void triggerFirebaseRemoteConfigFetchAndActivateOnSuccessfulFetch() {
        ...
        this.firebaseRemoteConfig.fetchAndActivate().addOnSuccessListener(this.executor, new OnSuccessListener() { // from class: pv1
            {
            ...
            public final void onSuccess(Object obj) {
                RemoteConfigManager.m38281b(RemoteConfigManager.this, (Boolean) obj);
            }
        }).addOnFailureListener(this.executor, new OnFailureListener() { // from class: qv1
            {
                RemoteConfigManager.this = this;
            }
            ...
            public final void onFailure(Exception exc) {
                RemoteConfigManager.m38282a(RemoteConfigManager.this, exc);
            }
        });
    }
    ...
    public Optional<Boolean> getBoolean(String str) {
        ...
        if (remoteConfigValue != null) {
            try {
                return Optional.m38156of(Boolean.valueOf(remoteConfigValue.asBoolean()));
    ...
    public Optional<Double> getDouble(String str) {
        ...
        if (remoteConfigValue != null) {
            try {
                return Optional.m38156of(Double.valueOf(remoteConfigValue.asDouble()));
            } catch (IllegalArgumentException unused) {
                if (!remoteConfigValue.asString().isEmpty()) {
                    logger.debug("Could not parse value: '%s' for key: '%s'.", remoteConfigValue.asString(), str);
                }
    ...
    public Optional<Long> getLong(String str) {
        ...
        if (remoteConfigValue != null) {
            try {
                return Optional.m38156of(Long.valueOf(remoteConfigValue.asLong()));
            } catch (IllegalArgumentException unused) {
                if (!remoteConfigValue.asString().isEmpty()) {
                    logger.debug("Could not parse value: '%s' for key: '%s'.", remoteConfigValue.asString(), str);
                }
    ...
    public Optional<String> getString(String str) {
        ...
        FirebaseRemoteConfigValue remoteConfigValue = getRemoteConfigValue(str);
        if (remoteConfigValue != null) {
            return Optional.m38156of(remoteConfigValue.asString());
        }
        return Optional.absent();
    }
