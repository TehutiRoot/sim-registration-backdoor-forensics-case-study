...
public final class C$Gson$Types {
    ...
    /* renamed from: a */
    public static final Type[] f56696a = new Type[0];
    ...
    public static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public ParameterizedTypeImpl(Type type, Type type2, Type... typeArr) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                C$Gson$Types.m37569a(this.typeArguments[i]);
    ...
    public static final class WildcardTypeImpl implements WildcardType, Serializable {
        ...
        public WildcardTypeImpl(Type[] typeArr, Type[] typeArr2) {
            ...
            if (typeArr2.length == 1) {
                ...
                C$Gson$Types.m37569a(typeArr2[0]);
            ...
            C$Gson$Types.m37569a(typeArr[0]);
        ...
        public Type[] getLowerBounds() {
            ...
            return type != null ? new Type[]{type} : C$Gson$Types.f56696a;
        }
    ...
    /* renamed from: a */
    public static void m37569a(Type type) {
        boolean z;
    ...
    /* renamed from: b */
    public static Class m37568b(TypeVariable typeVariable) {
    ...
    /* renamed from: c */
    public static boolean m37567c(Object obj, Object obj2) {
    ...
    /* renamed from: d */
    public static Type m37566d(Type type, Class cls, Class cls2) {
        if (cls2 == cls) {
            return type;
        }
        if (cls2.isInterface()) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (cls2.isAssignableFrom(cls3)) {
                    return m37566d(cls.getGenericInterfaces()[i], interfaces[i], cls2);
                }
            }
        }
        if (!cls.isInterface()) {
            while (cls != Object.class) {
                ...
                if (cls2.isAssignableFrom(superclass)) {
                    return m37566d(cls.getGenericSuperclass(), superclass, cls2);
                }
                cls = superclass;
            }
        }
    ...
    /* renamed from: e */
    public static Type m37565e(Type type, Class cls, Class cls2) {
        if (type instanceof WildcardType) {
            type = ((WildcardType) type).getUpperBounds()[0];
        }
        C$Gson$Preconditions.checkArgument(cls2.isAssignableFrom(cls));
        return resolve(type, cls, m37566d(type, cls, cls2));
    }
    ...
    public static boolean equals(Type type, Type type2) {
        ...
        if (type instanceof ParameterizedType) {
            ...
            if (m37567c(parameterizedType.getOwnerType(), parameterizedType2.getOwnerType()) && parameterizedType.getRawType().equals(parameterizedType2.getRawType()) && Arrays.equals(parameterizedType.getActualTypeArguments(), parameterizedType2.getActualTypeArguments())) {
                return true;
            }
            return false;
        } else if (type instanceof GenericArrayType) {
    ...
    /* renamed from: f */
    public static int m37564f(Object[] objArr, Object obj) {
    ...
    */
    public static java.lang.reflect.Type m37563g(java.lang.reflect.Type r9, java.lang.Class r10, java.lang.reflect.Type r11, java.util.Map r12) {
        /*
            r0 = 0
        L1:
        ...
        L17:
            ...
            r0 = r1
        L1f:
            java.lang.reflect.Type r11 = m37562h(r9, r10, r1)
            if (r11 != r1) goto L1
            goto Ldf
        L27:
            ...
            java.lang.reflect.Type r9 = m37563g(r9, r10, r11, r12)
            boolean r10 = m37567c(r11, r9)
            if (r10 == 0) goto L45
            r11 = r1
            goto Ldf
        L45:
        ...
        L4c:
            ...
            java.lang.reflect.Type r9 = m37563g(r9, r10, r1, r12)
            boolean r10 = m37567c(r1, r9)
            if (r10 == 0) goto L62
            goto Ldf
        L62:
            java.lang.reflect.GenericArrayType r9 = arrayOf(r9)
        ...
        L67:
            ...
            java.lang.reflect.Type r4 = m37563g(r9, r10, r1, r12)
            boolean r1 = m37567c(r4, r1)
            r1 = r1 ^ r3
        ...
        L81:
            if (r2 >= r6) goto La0
            r7 = r5[r2]
            java.lang.reflect.Type r7 = m37563g(r9, r10, r7, r12)
            r8 = r5[r2]
            boolean r8 = m37567c(r7, r8)
            if (r8 != 0) goto L9d
            if (r1 != 0) goto L9b
        ...
        Lab:
            ...
            if (r5 != r3) goto Lcb
            r3 = r1[r2]
            java.lang.reflect.Type r9 = m37563g(r9, r10, r3, r12)
            r10 = r1[r2]
            if (r9 == r10) goto Ldf
        ...
        Lcb:
            ...
            if (r1 != r3) goto Ldf
            r1 = r4[r2]
            java.lang.reflect.Type r9 = m37563g(r9, r10, r1, r12)     // Catch: java.lang.Throwable -> Ldd
            r10 = r4[r2]
            if (r9 == r10) goto Ldf
        ...
        Le4:
            return r11
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.C$Gson$Types.m37563g(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type, java.util.Map):java.lang.reflect.Type");
    }
    ...
    public static Type getCollectionElementType(Type type, Class<?> cls) {
        Type m37565e = m37565e(type, cls, Collection.class);
        if (m37565e instanceof ParameterizedType) {
            return ((ParameterizedType) m37565e).getActualTypeArguments()[0];
        }
        return Object.class;
    }
    ...
    public static Type[] getMapKeyAndValueTypes(Type type, Class<?> cls) {
        ...
        Type m37565e = m37565e(type, cls, Map.class);
        return m37565e instanceof ParameterizedType ? ((ParameterizedType) m37565e).getActualTypeArguments() : new Type[]{Object.class, Object.class};
    }
    ...
    /* renamed from: h */
    public static Type m37562h(Type type, Class cls, TypeVariable typeVariable) {
        Class m37568b = m37568b(typeVariable);
        if (m37568b == null) {
            return typeVariable;
        }
        Type m37566d = m37566d(type, cls, m37568b);
        if (m37566d instanceof ParameterizedType) {
            return ((ParameterizedType) m37566d).getActualTypeArguments()[m37564f(m37568b.getTypeParameters(), typeVariable)];
        }
        return typeVariable;
    }
    ...
    public static Type resolve(Type type, Class<?> cls, Type type2) {
        return m37563g(type, cls, type2, new HashMap());
    }
    ...
    public static WildcardType subtypeOf(Type type) {
        ...
        return new WildcardTypeImpl(typeArr, f56696a);
    }
