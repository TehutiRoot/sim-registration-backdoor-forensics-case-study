...
public final class TypeAdapters {
    ...
    public static final class EnumTypeAdapter<T extends Enum<T>> extends TypeAdapter<T> {
        ...
        /* loaded from: classes4.dex */
        public class C8785a implements PrivilegedAction {

            /* renamed from: a */
            public final /* synthetic */ Class f56815a;

            public C8785a(Class cls) {
                this.f56815a = cls;
            }
            ...
            /* renamed from: a */
            public Field[] run() {
                Field[] declaredFields = this.f56815a.getDeclaredFields();
        ...
        public EnumTypeAdapter(Class<T> cls) {
            Field[] fieldArr;
            try {
                for (Field field : (Field[]) AccessController.doPrivileged(new C8785a(cls))) {
    ...
    public static /* synthetic */ class C8786a {
        ...
        static {
            ...
            try {
                f56817a[JsonToken.STRING.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f56817a[JsonToken.BOOLEAN.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f56817a[JsonToken.BEGIN_ARRAY.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f56817a[JsonToken.BEGIN_OBJECT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f56817a[JsonToken.NULL.ordinal()] = 6;
    ...
    static {
        ...
        TypeAdapter<BitSet> nullSafe2 = new TypeAdapter<BitSet>() { // from class: com.google.gson.internal.bind.TypeAdapters.2
            ...
            public BitSet read(JsonReader jsonReader) throws IOException {
                ...
                while (peek != JsonToken.END_ARRAY) {
                    int i2 = C8786a.f56817a[peek.ordinal()];
                    boolean z = true;
                    if (i2 == 1 || i2 == 2) {
        ...
        TypeAdapter<JsonElement> typeAdapter15 = new TypeAdapter<JsonElement>() { // from class: com.google.gson.internal.bind.TypeAdapters.28
            private JsonElement readTerminal(JsonReader jsonReader, JsonToken jsonToken) throws IOException {
                int i = C8786a.f56817a[jsonToken.ordinal()];
                if (i != 1) {
                    if (i != 2) {
                        if (i != 3) {
                            if (i == 6) {
            ...
            public JsonElement read(JsonReader jsonReader) throws IOException {
                if (jsonReader instanceof JsonTreeReader) {
                    return ((JsonTreeReader) jsonReader).m37526B();
                }
                JsonToken peek = jsonReader.peek();
