...
public final class DefaultDateTypeAdapter<T extends Date> extends TypeAdapter<T> {
    ...
    public static abstract class DateType<T extends Date> {
        public static final DateType<Date> DATE = new C8735a(Date.class);
        ...
        /* loaded from: classes4.dex */
        public class C8735a extends DateType {
            public C8735a(Class cls) {
                super(cls);
            }
        ...
        /* renamed from: a */
        public final TypeAdapterFactory m37532a(DefaultDateTypeAdapter defaultDateTypeAdapter) {
            return TypeAdapters.newFactory(this.f56756a, defaultDateTypeAdapter);
        }

        public final TypeAdapterFactory createAdapterFactory(String str) {
            return m37532a(new DefaultDateTypeAdapter(this, str));
        }

        public abstract T deserialize(Date date);

        public final TypeAdapterFactory createAdapterFactory(int i, int i2) {
            return m37532a(new DefaultDateTypeAdapter(this, i, i2));
        }
    }
