...
public final class SqlTypesSupport {
    ...
    /* loaded from: classes4.dex */
    public class C8794a extends DefaultDateTypeAdapter.DateType {
        public C8794a(Class cls) {
            super(cls);
        }
    ...
    /* loaded from: classes4.dex */
    public class C8795b extends DefaultDateTypeAdapter.DateType {
        public C8795b(Class cls) {
            super(cls);
        }
    ...
    static {
        ...
        if (z) {
            DATE_DATE_TYPE = new C8794a(java.sql.Date.class);
            TIMESTAMP_DATE_TYPE = new C8795b(Timestamp.class);
