...
public final class HttpBody extends GeneratedMessageLite<HttpBody, Builder> implements HttpBodyOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<HttpBody, Builder> implements HttpBodyOrBuilder {
        public /* synthetic */ Builder(C7213a c7213a) {
            this();
        }

        public Builder addAllExtensions(Iterable<? extends Any> iterable) {
            copyOnWrite();
            ((HttpBody) this.instance).m42802N(iterable);
            return this;
        }

        public Builder addExtensions(Any any) {
            copyOnWrite();
            ((HttpBody) this.instance).m42800P(any);
            return this;
        }

        public Builder clearContentType() {
            copyOnWrite();
            ((HttpBody) this.instance).m42799Q();
            return this;
        }

        public Builder clearData() {
            copyOnWrite();
            ((HttpBody) this.instance).m42798R();
            return this;
        }

        public Builder clearExtensions() {
            copyOnWrite();
            ((HttpBody) this.instance).m42797S();
            return this;
        }
        ...
        public Builder removeExtensions(int i) {
            copyOnWrite();
            ((HttpBody) this.instance).m42795U(i);
            return this;
        }

        public Builder setContentType(String str) {
            copyOnWrite();
            ((HttpBody) this.instance).m42794V(str);
            return this;
        }

        public Builder setContentTypeBytes(ByteString byteString) {
            copyOnWrite();
            ((HttpBody) this.instance).m42793W(byteString);
            return this;
        }

        public Builder setData(ByteString byteString) {
            copyOnWrite();
            ((HttpBody) this.instance).m42792X(byteString);
            return this;
        }

        public Builder setExtensions(int i, Any any) {
            copyOnWrite();
            ((HttpBody) this.instance).m42791Y(i, any);
            return this;
        }
        ...
        public Builder addExtensions(int i, Any any) {
            copyOnWrite();
            ((HttpBody) this.instance).m42801O(i, any);
            return this;
        }

        public Builder setExtensions(int i, Any.Builder builder) {
            copyOnWrite();
            ((HttpBody) this.instance).m42791Y(i, builder.build());
            return this;
        }

        public Builder addExtensions(Any.Builder builder) {
            copyOnWrite();
            ((HttpBody) this.instance).m42800P(builder.build());
            return this;
        }

        public Builder addExtensions(int i, Any.Builder builder) {
            copyOnWrite();
            ((HttpBody) this.instance).m42801O(i, builder.build());
            return this;
        }
    }
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C7213a {
        ...
        static {
            ...
            try {
                f51619a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f51619a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f51619a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f51619a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f51619a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f51619a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: N */
    public final void m42802N(Iterable iterable) {
        m42796T();
        AbstractMessageLite.addAll(iterable, (List) this.extensions_);
    }

    /* renamed from: O */
    public final void m42801O(int i, Any any) {
        any.getClass();
        m42796T();
    ...
    /* renamed from: P */
    public final void m42800P(Any any) {
        any.getClass();
        m42796T();
    ...
    /* renamed from: Q */
    public final void m42799Q() {
        this.contentType_ = getDefaultInstance().getContentType();
    }

    /* renamed from: R */
    public final void m42798R() {
        this.data_ = getDefaultInstance().getData();
    }

    /* renamed from: S */
    public final void m42797S() {
        this.extensions_ = GeneratedMessageLite.emptyProtobufList();
    }

    /* renamed from: T */
    public final void m42796T() {
    ...
    /* renamed from: U */
    public final void m42795U(int i) {
        m42796T();
        this.extensions_.remove(i);
    }

    /* renamed from: V */
    public final void m42794V(String str) {
        str.getClass();
        this.contentType_ = str;
    }

    /* renamed from: W */
    public final void m42793W(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.contentType_ = byteString.toStringUtf8();
    }

    /* renamed from: X */
    public final void m42792X(ByteString byteString) {
        byteString.getClass();
        this.data_ = byteString;
    }

    /* renamed from: Y */
    public final void m42791Y(int i, Any any) {
        any.getClass();
        m42796T();
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C7213a.f51619a[methodToInvoke.ordinal()]) {
            case 1:
                return new HttpBody();
            case 2:
