...
public final class Backend extends GeneratedMessageLite<Backend, Builder> implements BackendOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Backend, Builder> implements BackendOrBuilder {
        public /* synthetic */ Builder(C7194a c7194a) {
            this();
        }

        public Builder addAllRules(Iterable<? extends BackendRule> iterable) {
            copyOnWrite();
            ((Backend) this.instance).m43286I(iterable);
            return this;
        }

        public Builder addRules(BackendRule backendRule) {
            copyOnWrite();
            ((Backend) this.instance).m43284K(backendRule);
            return this;
        }

        public Builder clearRules() {
            copyOnWrite();
            ((Backend) this.instance).m43283L();
            return this;
        }
        ...
        public Builder removeRules(int i) {
            copyOnWrite();
            ((Backend) this.instance).m43281N(i);
            return this;
        }

        public Builder setRules(int i, BackendRule backendRule) {
            copyOnWrite();
            ((Backend) this.instance).m43280O(i, backendRule);
            return this;
        }
        ...
        public Builder addRules(int i, BackendRule backendRule) {
            copyOnWrite();
            ((Backend) this.instance).m43285J(i, backendRule);
            return this;
        }

        public Builder setRules(int i, BackendRule.Builder builder) {
            copyOnWrite();
            ((Backend) this.instance).m43280O(i, builder.build());
            return this;
        }

        public Builder addRules(BackendRule.Builder builder) {
            copyOnWrite();
            ((Backend) this.instance).m43284K(builder.build());
            return this;
        }

        public Builder addRules(int i, BackendRule.Builder builder) {
            copyOnWrite();
            ((Backend) this.instance).m43285J(i, builder.build());
            return this;
        }
    }
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C7194a {
        ...
        static {
            ...
            try {
                f51603a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f51603a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f51603a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f51603a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f51603a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f51603a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: I */
    public void m43286I(Iterable iterable) {
        m43282M();
    ...
    /* renamed from: J */
    public final void m43285J(int i, BackendRule backendRule) {
    ...
    /* renamed from: K */
    public final void m43284K(BackendRule backendRule) {
        backendRule.getClass();
        m43282M();
    ...
    /* renamed from: O */
    public final void m43280O(int i, BackendRule backendRule) {
        backendRule.getClass();
        m43282M();
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C7194a.f51603a[methodToInvoke.ordinal()]) {
            case 1:
                return new Backend();
            case 2:
