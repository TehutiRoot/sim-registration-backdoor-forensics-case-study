...
public final class LabelDescriptor extends GeneratedMessageLite<LabelDescriptor, Builder> implements LabelDescriptorOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<LabelDescriptor, Builder> implements LabelDescriptorOrBuilder {
        ...
        public Builder clearDescription() {
            copyOnWrite();
            ((LabelDescriptor) this.instance).m42689L();
            return this;
        }

        public Builder clearKey() {
            copyOnWrite();
            ((LabelDescriptor) this.instance).m42688M();
            return this;
        }

        public Builder clearValueType() {
            copyOnWrite();
            ((LabelDescriptor) this.instance).m42687N();
            return this;
        }
        ...
        public Builder setDescription(String str) {
            copyOnWrite();
            ((LabelDescriptor) this.instance).m42686O(str);
            return this;
        }

        public Builder setDescriptionBytes(ByteString byteString) {
            copyOnWrite();
            ((LabelDescriptor) this.instance).m42685P(byteString);
            return this;
        }

        public Builder setKey(String str) {
            copyOnWrite();
            ((LabelDescriptor) this.instance).m42684Q(str);
            return this;
        }

        public Builder setKeyBytes(ByteString byteString) {
            copyOnWrite();
            ((LabelDescriptor) this.instance).m42683R(byteString);
            return this;
        }

        public Builder setValueType(ValueType valueType) {
            copyOnWrite();
            ((LabelDescriptor) this.instance).m42682S(valueType);
            return this;
        }

        public Builder setValueTypeValue(int i) {
            copyOnWrite();
            ((LabelDescriptor) this.instance).m42681T(i);
            return this;
        }
    ...
    public enum ValueType implements Internal.EnumLite {
        ...
        public static final class C7217b implements Internal.EnumVerifier {
            ...
            /* renamed from: a */
            public static final Internal.EnumVerifier f51622a = new C7217b();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: O */
    public void m42686O(String str) {
        str.getClass();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: P */
    public void m42685P(ByteString byteString) {
    ...
    /* renamed from: M */
    public final void m42688M() {
        this.key_ = getDefaultInstance().getKey();
    }

    /* renamed from: N */
    public final void m42687N() {
        this.valueType_ = 0;
    }

    /* renamed from: Q */
    public final void m42684Q(String str) {
        str.getClass();
        this.key_ = str;
    }

    /* renamed from: R */
    public final void m42683R(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.key_ = byteString.toStringUtf8();
    }

    /* renamed from: S */
    public final void m42682S(ValueType valueType) {
        this.valueType_ = valueType.getNumber();
    }

    /* renamed from: T */
    public final void m42681T(int i) {
        this.valueType_ = i;
    }

    @Override // com.google.protobuf.GeneratedMessageLite
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C7218a.f51623a[methodToInvoke.ordinal()]) {
            case 1:
