...
public final class AuthRequirement extends GeneratedMessageLite<AuthRequirement, Builder> implements AuthRequirementOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<AuthRequirement, Builder> implements AuthRequirementOrBuilder {
        ...
        public Builder clearAudiences() {
            copyOnWrite();
            ((AuthRequirement) this.instance).m43356I();
            return this;
        }

        public Builder clearProviderId() {
            copyOnWrite();
            ((AuthRequirement) this.instance).m43355J();
            return this;
        }
        ...
        public Builder setAudiences(String str) {
            copyOnWrite();
            ((AuthRequirement) this.instance).m43354K(str);
            return this;
        }

        public Builder setAudiencesBytes(ByteString byteString) {
            copyOnWrite();
            ((AuthRequirement) this.instance).m43353L(byteString);
            return this;
        }

        public Builder setProviderId(String str) {
            copyOnWrite();
            ((AuthRequirement) this.instance).m43352M(str);
            return this;
        }

        public Builder setProviderIdBytes(ByteString byteString) {
            copyOnWrite();
            ((AuthRequirement) this.instance).m43351N(byteString);
            return this;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: K */
    public void m43354K(String str) {
        str.getClass();
        this.audiences_ = str;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: L */
    public void m43353L(ByteString byteString) {
    ...
    /* renamed from: J */
    public final void m43355J() {
        this.providerId_ = getDefaultInstance().getProviderId();
    }

    /* renamed from: M */
    public final void m43352M(String str) {
        str.getClass();
        this.providerId_ = str;
    }

    /* renamed from: N */
    public final void m43351N(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C7191a.f51600a[methodToInvoke.ordinal()]) {
            case 1:
