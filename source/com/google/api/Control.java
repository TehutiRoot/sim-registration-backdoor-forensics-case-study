...
public final class Control extends GeneratedMessageLite<Control, Builder> implements ControlOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Control, Builder> implements ControlOrBuilder {
        public /* synthetic */ Builder(C7204a c7204a) {
            this();
        }

        public Builder clearEnvironment() {
            copyOnWrite();
            ((Control) this.instance).m43089F();
            return this;
        }
        ...
        public Builder setEnvironment(String str) {
            copyOnWrite();
            ((Control) this.instance).m43088G(str);
            return this;
        }

        public Builder setEnvironmentBytes(ByteString byteString) {
            copyOnWrite();
            ((Control) this.instance).m43087H(byteString);
            return this;
        }
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C7204a {
    ...
    /* renamed from: F */
    public final void m43089F() {
        this.environment_ = getDefaultInstance().getEnvironment();
    }

    /* renamed from: G */
    public final void m43088G(String str) {
        str.getClass();
        this.environment_ = str;
    }

    /* renamed from: H */
    public final void m43087H(ByteString byteString) {
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C7204a.f51611a[methodToInvoke.ordinal()]) {
            case 1:
                return new Control();
            case 2:
