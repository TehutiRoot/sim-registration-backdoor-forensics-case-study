...
public final class ResourceDescriptor extends GeneratedMessageLite<ResourceDescriptor, Builder> implements ResourceDescriptorOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<ResourceDescriptor, Builder> implements ResourceDescriptorOrBuilder {
        public /* synthetic */ Builder(C7249a c7249a) {
            this();
        }

        public Builder addAllPattern(Iterable<String> iterable) {
            copyOnWrite();
            ((ResourceDescriptor) this.instance).m42211W(iterable);
            return this;
        }

        public Builder addPattern(String str) {
            copyOnWrite();
            ((ResourceDescriptor) this.instance).m42210X(str);
            return this;
        }

        public Builder addPatternBytes(ByteString byteString) {
            copyOnWrite();
            ((ResourceDescriptor) this.instance).m42209Y(byteString);
            return this;
        }

        public Builder clearHistory() {
            copyOnWrite();
            ((ResourceDescriptor) this.instance).m42208Z();
            return this;
        }

        public Builder clearNameField() {
            copyOnWrite();
            ((ResourceDescriptor) this.instance).m42207a0();
            return this;
        }

        public Builder clearPattern() {
            copyOnWrite();
            ((ResourceDescriptor) this.instance).m42206b0();
            return this;
        }

        public Builder clearPlural() {
            copyOnWrite();
            ((ResourceDescriptor) this.instance).m42205c0();
            return this;
        }

        public Builder clearSingular() {
            copyOnWrite();
            ((ResourceDescriptor) this.instance).m42204d0();
            return this;
        }

        public Builder clearType() {
            copyOnWrite();
            ((ResourceDescriptor) this.instance).m42203e0();
            return this;
        }
        ...
        public Builder setHistory(History history) {
            copyOnWrite();
            ((ResourceDescriptor) this.instance).m42201g0(history);
            return this;
        }

        public Builder setHistoryValue(int i) {
            copyOnWrite();
            ((ResourceDescriptor) this.instance).m42200h0(i);
            return this;
        }

        public Builder setNameField(String str) {
            copyOnWrite();
            ((ResourceDescriptor) this.instance).m42199i0(str);
            return this;
        }

        public Builder setNameFieldBytes(ByteString byteString) {
            copyOnWrite();
            ((ResourceDescriptor) this.instance).m42198j0(byteString);
            return this;
        }

        public Builder setPattern(int i, String str) {
            copyOnWrite();
            ((ResourceDescriptor) this.instance).m42197k0(i, str);
            return this;
        }

        public Builder setPlural(String str) {
            copyOnWrite();
            ((ResourceDescriptor) this.instance).m42196l0(str);
            return this;
        }

        public Builder setPluralBytes(ByteString byteString) {
            copyOnWrite();
            ((ResourceDescriptor) this.instance).m42195m0(byteString);
            return this;
        }

        public Builder setSingular(String str) {
            copyOnWrite();
            ((ResourceDescriptor) this.instance).m42194n0(str);
            return this;
        }

        public Builder setSingularBytes(ByteString byteString) {
            copyOnWrite();
            ((ResourceDescriptor) this.instance).m42193o0(byteString);
            return this;
        }

        public Builder setType(String str) {
            copyOnWrite();
            ((ResourceDescriptor) this.instance).m42192p0(str);
            return this;
        }

        public Builder setTypeBytes(ByteString byteString) {
            copyOnWrite();
            ((ResourceDescriptor) this.instance).m42191q0(byteString);
            return this;
        }
    ...
    public enum History implements Internal.EnumLite {
        ...
        private static final Internal.EnumLiteMap<History> internalValueMap = new C7247a();
        private final int value;

        /* renamed from: com.google.api.ResourceDescriptor$History$a */
        /* loaded from: classes4.dex */
        public class C7247a implements Internal.EnumLiteMap {
        ...
        /* loaded from: classes4.dex */
        public static final class C7248b implements Internal.EnumVerifier {

            /* renamed from: a */
            public static final Internal.EnumVerifier f51649a = new C7248b();
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C7249a {
        ...
        static {
            ...
            try {
                f51650a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f51650a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f51650a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f51650a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f51650a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f51650a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: p0 */
    public void m42192p0(String str) {
        str.getClass();
        this.type_ = str;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: q0 */
    public void m42191q0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.type_ = byteString.toStringUtf8();
    }

    /* renamed from: W */
    public final void m42211W(Iterable iterable) {
        m42202f0();
        AbstractMessageLite.addAll(iterable, (List) this.pattern_);
    }

    /* renamed from: X */
    public final void m42210X(String str) {
        str.getClass();
        m42202f0();
    ...
    /* renamed from: Y */
    public final void m42209Y(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        m42202f0();
    ...
    /* renamed from: g0 */
    public final void m42201g0(History history) {
    ...
    /* renamed from: h0 */
    public final void m42200h0(int i) {
        this.history_ = i;
    }

    /* renamed from: i0 */
    public final void m42199i0(String str) {
        str.getClass();
        this.nameField_ = str;
    }

    /* renamed from: j0 */
    public final void m42198j0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.nameField_ = byteString.toStringUtf8();
    }

    /* renamed from: k0 */
    public final void m42197k0(int i, String str) {
        str.getClass();
        m42202f0();
    ...
    /* renamed from: l0 */
    public final void m42196l0(String str) {
        str.getClass();
        this.plural_ = str;
    }

    /* renamed from: m0 */
    public final void m42195m0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.plural_ = byteString.toStringUtf8();
    }

    /* renamed from: n0 */
    public final void m42194n0(String str) {
        str.getClass();
        this.singular_ = str;
    }

    /* renamed from: o0 */
    public final void m42193o0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
