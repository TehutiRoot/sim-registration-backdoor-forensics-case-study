...
public final class Endpoint extends GeneratedMessageLite<Endpoint, Builder> implements EndpointOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Endpoint, Builder> implements EndpointOrBuilder {
        public /* synthetic */ Builder(C7209a c7209a) {
            this();
        }
        ...
        public Builder addAliases(String str) {
            copyOnWrite();
            ((Endpoint) this.instance).m42853U(str);
            return this;
        }
        ...
        public Builder addAliasesBytes(ByteString byteString) {
            copyOnWrite();
            ((Endpoint) this.instance).m42852V(byteString);
            return this;
        }
        ...
        public Builder addAllAliases(Iterable<String> iterable) {
            copyOnWrite();
            ((Endpoint) this.instance).m42851W(iterable);
            return this;
        }

        public Builder addAllFeatures(Iterable<String> iterable) {
            copyOnWrite();
            ((Endpoint) this.instance).m42850X(iterable);
            return this;
        }

        public Builder addFeatures(String str) {
            copyOnWrite();
            ((Endpoint) this.instance).m42849Y(str);
            return this;
        }

        public Builder addFeaturesBytes(ByteString byteString) {
            copyOnWrite();
            ((Endpoint) this.instance).m42848Z(byteString);
            return this;
        }
        ...
        public Builder clearAliases() {
            copyOnWrite();
            ((Endpoint) this.instance).m42847a0();
            return this;
        }

        public Builder clearAllowCors() {
            copyOnWrite();
            ((Endpoint) this.instance).m42846b0();
            return this;
        }

        public Builder clearFeatures() {
            copyOnWrite();
            ((Endpoint) this.instance).m42845c0();
            return this;
        }

        public Builder clearName() {
            copyOnWrite();
            ((Endpoint) this.instance).m42844d0();
            return this;
        }

        public Builder clearTarget() {
            copyOnWrite();
            ((Endpoint) this.instance).m42843e0();
            return this;
        }
        ...
        public Builder setAliases(int i, String str) {
            copyOnWrite();
            ((Endpoint) this.instance).m42840h0(i, str);
            return this;
        }

        public Builder setAllowCors(boolean z) {
            copyOnWrite();
            ((Endpoint) this.instance).m42839i0(z);
            return this;
        }

        public Builder setFeatures(int i, String str) {
            copyOnWrite();
            ((Endpoint) this.instance).m42838j0(i, str);
            return this;
        }

        public Builder setName(String str) {
            copyOnWrite();
            ((Endpoint) this.instance).m42837k0(str);
            return this;
        }

        public Builder setNameBytes(ByteString byteString) {
            copyOnWrite();
            ((Endpoint) this.instance).m42836l0(byteString);
            return this;
        }

        public Builder setTarget(String str) {
            copyOnWrite();
            ((Endpoint) this.instance).m42835m0(str);
            return this;
        }

        public Builder setTargetBytes(ByteString byteString) {
            copyOnWrite();
            ((Endpoint) this.instance).m42834n0(byteString);
            return this;
        }
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C7209a {
        ...
        static {
            ...
            try {
                f51616a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f51616a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f51616a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f51616a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f51616a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f51616a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: U */
    public final void m42853U(String str) {
        str.getClass();
        m42842f0();
    ...
    /* renamed from: V */
    public final void m42852V(ByteString byteString) {
    ...
    /* renamed from: W */
    public final void m42851W(Iterable iterable) {
        m42842f0();
        AbstractMessageLite.addAll(iterable, (List) this.aliases_);
    }

    /* renamed from: X */
    public final void m42850X(Iterable iterable) {
        m42841g0();
        AbstractMessageLite.addAll(iterable, (List) this.features_);
    }

    /* renamed from: Y */
    public final void m42849Y(String str) {
        str.getClass();
        m42841g0();
    ...
    /* renamed from: Z */
    public final void m42848Z(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        m42841g0();
    ...
    /* renamed from: a0 */
    public final void m42847a0() {
        this.aliases_ = GeneratedMessageLite.emptyProtobufList();
    }

    /* renamed from: b0 */
    public final void m42846b0() {
        this.allowCors_ = false;
    }

    /* renamed from: c0 */
    public final void m42845c0() {
        this.features_ = GeneratedMessageLite.emptyProtobufList();
    }

    /* renamed from: d0 */
    public final void m42844d0() {
        this.name_ = getDefaultInstance().getName();
    }

    @Override // com.google.protobuf.GeneratedMessageLite
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C7209a.f51616a[methodToInvoke.ordinal()]) {
            case 1:
                return new Endpoint();
            case 2:
    ...
    /* renamed from: e0 */
    public final void m42843e0() {
        this.target_ = getDefaultInstance().getTarget();
    }

    /* renamed from: f0 */
    public final void m42842f0() {
    ...
    /* renamed from: h0 */
    public final void m42840h0(int i, String str) {
        str.getClass();
        m42842f0();
    ...
    /* renamed from: i0 */
    public final void m42839i0(boolean z) {
        this.allowCors_ = z;
    }

    /* renamed from: j0 */
    public final void m42838j0(int i, String str) {
        str.getClass();
        m42841g0();
    ...
    /* renamed from: k0 */
    public final void m42837k0(String str) {
        str.getClass();
        this.name_ = str;
    }

    /* renamed from: l0 */
    public final void m42836l0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.name_ = byteString.toStringUtf8();
    }

    /* renamed from: m0 */
    public final void m42835m0(String str) {
        str.getClass();
        this.target_ = str;
    }

    /* renamed from: n0 */
    public final void m42834n0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
