...
public final class MetricDescriptor extends GeneratedMessageLite<MetricDescriptor, Builder> implements MetricDescriptorOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<MetricDescriptor, Builder> implements MetricDescriptorOrBuilder {
        public /* synthetic */ Builder(C7229a c7229a) {
            this();
        }

        public Builder addAllLabels(Iterable<? extends LabelDescriptor> iterable) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42539j0(iterable);
            return this;
        }

        public Builder addLabels(LabelDescriptor labelDescriptor) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42537l0(labelDescriptor);
            return this;
        }

        public Builder clearDescription() {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42536m0();
            return this;
        }

        public Builder clearDisplayName() {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42535n0();
            return this;
        }

        public Builder clearLabels() {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42534o0();
            return this;
        }

        public Builder clearLaunchStage() {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42533p0();
            return this;
        }

        public Builder clearMetadata() {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42532q0();
            return this;
        }

        public Builder clearMetricKind() {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42531r0();
            return this;
        }

        public Builder clearName() {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42530s0();
            return this;
        }

        public Builder clearType() {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42529t0();
            return this;
        }

        public Builder clearUnit() {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42528u0();
            return this;
        }

        public Builder clearValueType() {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42527v0();
            return this;
        }
        ...
        public Builder mergeMetadata(MetricDescriptorMetadata metricDescriptorMetadata) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42525x0(metricDescriptorMetadata);
            return this;
        }

        public Builder removeLabels(int i) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42524y0(i);
            return this;
        }

        public Builder setDescription(String str) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42523z0(str);
            return this;
        }

        public Builder setDescriptionBytes(ByteString byteString) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42590A0(byteString);
            return this;
        }

        public Builder setDisplayName(String str) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42588B0(str);
            return this;
        }

        public Builder setDisplayNameBytes(ByteString byteString) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42586C0(byteString);
            return this;
        }

        public Builder setLabels(int i, LabelDescriptor labelDescriptor) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42584D0(i, labelDescriptor);
            return this;
        }

        public Builder setLaunchStage(LaunchStage launchStage) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42582E0(launchStage);
            return this;
        }

        public Builder setLaunchStageValue(int i) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42580F0(i);
            return this;
        }

        public Builder setMetadata(MetricDescriptorMetadata metricDescriptorMetadata) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42578G0(metricDescriptorMetadata);
            return this;
        }

        public Builder setMetricKind(MetricKind metricKind) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42576H0(metricKind);
            return this;
        }

        public Builder setMetricKindValue(int i) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42574I0(i);
            return this;
        }

        public Builder setName(String str) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42572J0(str);
            return this;
        }

        public Builder setNameBytes(ByteString byteString) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42570K0(byteString);
            return this;
        }

        public Builder setType(String str) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42568L0(str);
            return this;
        }

        public Builder setTypeBytes(ByteString byteString) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42566M0(byteString);
            return this;
        }

        public Builder setUnit(String str) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42564N0(str);
            return this;
        }

        public Builder setUnitBytes(ByteString byteString) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42562O0(byteString);
            return this;
        }

        public Builder setValueType(ValueType valueType) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42560P0(valueType);
            return this;
        }

        public Builder setValueTypeValue(int i) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42558Q0(i);
            return this;
        }
        ...
        public Builder addLabels(int i, LabelDescriptor labelDescriptor) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42538k0(i, labelDescriptor);
            return this;
        }

        public Builder setLabels(int i, LabelDescriptor.Builder builder) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42584D0(i, builder.build());
            return this;
        }

        public Builder setMetadata(MetricDescriptorMetadata.Builder builder) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42578G0(builder.build());
            return this;
        }

        public Builder addLabels(LabelDescriptor.Builder builder) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42537l0(builder.build());
            return this;
        }

        public Builder addLabels(int i, LabelDescriptor.Builder builder) {
            copyOnWrite();
            ((MetricDescriptor) this.instance).m42538k0(i, builder.build());
            return this;
        }
    }
    ...
    public static final class MetricDescriptorMetadata extends GeneratedMessageLite<MetricDescriptorMetadata, Builder> implements MetricDescriptorMetadataOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<MetricDescriptorMetadata, Builder> implements MetricDescriptorMetadataOrBuilder {
            ...
            public Builder clearIngestDelay() {
                copyOnWrite();
                ((MetricDescriptorMetadata) this.instance).m42512L();
                return this;
            }
            ...
            public Builder clearLaunchStage() {
                copyOnWrite();
                ((MetricDescriptorMetadata) this.instance).m42511M();
                return this;
            }

            public Builder clearSamplePeriod() {
                copyOnWrite();
                ((MetricDescriptorMetadata) this.instance).m42510N();
                return this;
            }
            ...
            public Builder mergeIngestDelay(Duration duration) {
                copyOnWrite();
                ((MetricDescriptorMetadata) this.instance).m42509O(duration);
                return this;
            }

            public Builder mergeSamplePeriod(Duration duration) {
                copyOnWrite();
                ((MetricDescriptorMetadata) this.instance).m42508P(duration);
                return this;
            }

            public Builder setIngestDelay(Duration duration) {
                copyOnWrite();
                ((MetricDescriptorMetadata) this.instance).m42507Q(duration);
                return this;
            }
            ...
            public Builder setLaunchStage(LaunchStage launchStage) {
                copyOnWrite();
                ((MetricDescriptorMetadata) this.instance).m42506R(launchStage);
                return this;
            }
            ...
            public Builder setLaunchStageValue(int i) {
                copyOnWrite();
                ((MetricDescriptorMetadata) this.instance).m42505S(i);
                return this;
            }

            public Builder setSamplePeriod(Duration duration) {
                copyOnWrite();
                ((MetricDescriptorMetadata) this.instance).m42504T(duration);
                return this;
            }
            ...
            public Builder setIngestDelay(Duration.Builder builder) {
                copyOnWrite();
                ((MetricDescriptorMetadata) this.instance).m42507Q(builder.build());
                return this;
            }

            public Builder setSamplePeriod(Duration.Builder builder) {
                copyOnWrite();
                ((MetricDescriptorMetadata) this.instance).m42504T(builder.build());
                return this;
            }
        }
        ...
        /* renamed from: L */
        public final void m42512L() {
            this.ingestDelay_ = null;
        }

        /* renamed from: M */
        public final void m42511M() {
            this.launchStage_ = 0;
        }

        /* renamed from: N */
        public final void m42510N() {
            this.samplePeriod_ = null;
        }

        /* renamed from: O */
        public final void m42509O(Duration duration) {
            duration.getClass();
        ...
        /* renamed from: P */
        public final void m42508P(Duration duration) {
            duration.getClass();
        ...
        /* renamed from: Q */
        public final void m42507Q(Duration duration) {
            duration.getClass();
            this.ingestDelay_ = duration;
        }

        /* renamed from: R */
        public final void m42506R(LaunchStage launchStage) {
            this.launchStage_ = launchStage.getNumber();
        }

        /* renamed from: S */
        public final void m42505S(int i) {
            this.launchStage_ = i;
        }

        /* renamed from: T */
        public final void m42504T(Duration duration) {
            duration.getClass();
            this.samplePeriod_ = duration;
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C7229a.f51632a[methodToInvoke.ordinal()]) {
                case 1:
    ...
    public enum MetricKind implements Internal.EnumLite {
        ...
        private static final Internal.EnumLiteMap<MetricKind> internalValueMap = new C7225a();
        private final int value;

        /* renamed from: com.google.api.MetricDescriptor$MetricKind$a */
        /* loaded from: classes4.dex */
        public class C7225a implements Internal.EnumLiteMap {
        ...
        /* loaded from: classes4.dex */
        public static final class C7226b implements Internal.EnumVerifier {

            /* renamed from: a */
            public static final Internal.EnumVerifier f51630a = new C7226b();
    ...
    public enum ValueType implements Internal.EnumLite {
        ...
        private static final Internal.EnumLiteMap<ValueType> internalValueMap = new C7227a();
        private final int value;

        /* renamed from: com.google.api.MetricDescriptor$ValueType$a */
        /* loaded from: classes4.dex */
        public class C7227a implements Internal.EnumLiteMap {
            @Override // com.google.protobuf.Internal.EnumLiteMap
            /* renamed from: a */
        ...
        /* loaded from: classes4.dex */
        public static final class C7228b implements Internal.EnumVerifier {

            /* renamed from: a */
            public static final Internal.EnumVerifier f51631a = new C7228b();
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C7229a {
        ...
        static {
            ...
            try {
                f51632a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f51632a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f51632a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f51632a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f51632a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f51632a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: A0 */
    public void m42590A0(ByteString byteString) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: B0 */
    public void m42588B0(String str) {
        str.getClass();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: C0 */
    public void m42586C0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: D0 */
    public void m42584D0(int i, LabelDescriptor labelDescriptor) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: E0 */
    public void m42582E0(LaunchStage launchStage) {
        this.launchStage_ = launchStage.getNumber();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: F0 */
    public void m42580F0(int i) {
        this.launchStage_ = i;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: J0 */
    public void m42572J0(String str) {
        str.getClass();
        this.name_ = str;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: K0 */
    public void m42570K0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: j0 */
    public void m42539j0(Iterable iterable) {
        m42526w0();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: k0 */
    public void m42538k0(int i, LabelDescriptor labelDescriptor) {
        labelDescriptor.getClass();
        m42526w0();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: l0 */
    public void m42537l0(LabelDescriptor labelDescriptor) {
        labelDescriptor.getClass();
        m42526w0();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: m0 */
    public void m42536m0() {
        this.description_ = getDefaultInstance().getDescription();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: n0 */
    public void m42535n0() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: o0 */
    public void m42534o0() {
        this.labels_ = GeneratedMessageLite.emptyProtobufList();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: p0 */
    public void m42533p0() {
        this.launchStage_ = 0;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: s0 */
    public void m42530s0() {
        this.name_ = getDefaultInstance().getName();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: v0 */
    public void m42527v0() {
        this.valueType_ = 0;
    }

    /* renamed from: w0 */
    private void m42526w0() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: z0 */
    public void m42523z0(String str) {
        str.getClass();
        this.description_ = str;
    }

    /* renamed from: G0 */
    public final void m42578G0(MetricDescriptorMetadata metricDescriptorMetadata) {
        metricDescriptorMetadata.getClass();
        this.metadata_ = metricDescriptorMetadata;
    }

    /* renamed from: H0 */
    public final void m42576H0(MetricKind metricKind) {
        this.metricKind_ = metricKind.getNumber();
    }

    /* renamed from: I0 */
    public final void m42574I0(int i) {
        this.metricKind_ = i;
    }

    /* renamed from: L0 */
    public final void m42568L0(String str) {
        str.getClass();
        this.type_ = str;
    }

    /* renamed from: M0 */
    public final void m42566M0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.type_ = byteString.toStringUtf8();
    }

    /* renamed from: N0 */
    public final void m42564N0(String str) {
        str.getClass();
        this.unit_ = str;
    }

    /* renamed from: O0 */
    public final void m42562O0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.unit_ = byteString.toStringUtf8();
    }

    /* renamed from: P0 */
    public final void m42560P0(ValueType valueType) {
    ...
    /* renamed from: q0 */
    public final void m42532q0() {
        this.metadata_ = null;
    }

    /* renamed from: r0 */
    public final void m42531r0() {
        this.metricKind_ = 0;
    }

    /* renamed from: t0 */
    public final void m42529t0() {
        this.type_ = getDefaultInstance().getType();
    }

    /* renamed from: u0 */
    public final void m42528u0() {
        this.unit_ = getDefaultInstance().getUnit();
    }

    /* renamed from: x0 */
    public final void m42525x0(MetricDescriptorMetadata metricDescriptorMetadata) {
        metricDescriptorMetadata.getClass();
