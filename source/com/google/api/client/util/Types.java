...
public class Types {
    ...
    /* loaded from: classes4.dex */
    public static class C7321a implements Iterable {

        /* renamed from: a */
        public final /* synthetic */ Object f52353a;

        /* renamed from: com.google.api.client.util.Types$a$a */
        /* loaded from: classes4.dex */
        public class C7322a implements Iterator {

            /* renamed from: a */
            public final int f52354a;

            /* renamed from: b */
            public int f52355b = 0;

            public C7322a() {
                this.f52354a = Array.getLength(C7321a.this.f52353a);
            }

            @Override // java.util.Iterator
            public boolean hasNext() {
                if (this.f52355b < this.f52354a) {
                    return true;
                }
                return false;
            }
            ...
            public Object next() {
                if (hasNext()) {
                    Object obj = C7321a.this.f52353a;
                    int i = this.f52355b;
                    this.f52355b = i + 1;
    ...
    /* renamed from: a */
    public static Type m41694a(Type type, Class cls, int i) {
    ...
    /* renamed from: b */
    public static IllegalArgumentException m41693b(Exception exc, Class cls) {
    ...
    public static Type getIterableParameter(Type type) {
        return m41694a(type, Iterable.class, 0);
    }

    public static Type getMapValueParameter(Type type) {
        return m41694a(type, Map.class, 1);
    }
