...
public abstract class AbstractDataStore<V extends Serializable> implements DataStore<V> {
    ...
    /* renamed from: a */
    public final DataStoreFactory f52380a;

    /* renamed from: b */
    public final String f52381b;

    public AbstractDataStore(DataStoreFactory dataStoreFactory, String str) {
        this.f52380a = (DataStoreFactory) Preconditions.checkNotNull(dataStoreFactory);
        this.f52381b = (String) Preconditions.checkNotNull(str);
    }
