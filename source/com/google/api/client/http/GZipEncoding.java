...
public class GZipEncoding implements HttpEncoding {
    ...
    /* loaded from: classes4.dex */
    public class C7292a extends BufferedOutputStream {
        public C7292a(OutputStream outputStream) {
            super(outputStream);
        }
    ...
    public void encode(StreamingContent streamingContent, OutputStream outputStream) throws IOException {
        GZIPOutputStream gZIPOutputStream = new GZIPOutputStream(new C7292a(outputStream));
