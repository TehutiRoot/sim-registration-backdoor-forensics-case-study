...
public class MockHttpClient extends DefaultHttpClient {
    ...
    /* renamed from: com.google.api.client.testing.http.apache.MockHttpClient$a */
    /* loaded from: classes4.dex */
    public class C7302a implements RequestDirector {
        public C7302a() {
        }

        @Override // org.apache.http.client.RequestDirector
        public HttpResponse execute(HttpHost httpHost, HttpRequest httpRequest, HttpContext httpContext) {
            return new BasicHttpResponse(HttpVersion.HTTP_1_1, MockHttpClient.this.f52250v, (String) null);
        }
    }
