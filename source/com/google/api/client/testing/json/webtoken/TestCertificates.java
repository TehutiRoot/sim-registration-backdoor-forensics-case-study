...
public class TestCertificates {
    ...
    /* renamed from: a */
    public static JsonWebSignature f52262a = null;
    ...
    public static class CertData {
        ...
        public byte[] getDer() throws IOException {
            return PemReader.readFirstSectionAndClose(new StringReader(this.f52263a), "CERTIFICATE").getBase64DecodedBytes();
        }
    ...
    public static JsonWebSignature getJsonWebSignature() throws IOException {
        if (f52262a == null) {
            ...
            f52262a = new JsonWebSignature(header, payload, Base64.decodeBase64(JWS_SIGNATURE.substring(indexOf + 1)), StringUtils.getBytesUtf8(JWS_SIGNATURE.substring(0, indexOf)));
        }
        return f52262a;
    }
}
