...
public class GoogleAuthorizationCodeFlow extends AuthorizationCodeFlow {
    ...
    /* renamed from: p */
    public final String f51803p;

    /* renamed from: q */
    public final String f51804q;

    /* loaded from: classes4.dex */
    public static class Builder extends AuthorizationCodeFlow.Builder {

        /* renamed from: p */
        public String f51805p;
    ...
    public GoogleAuthorizationCodeFlow(Builder builder) {
        super(builder);
        this.f51804q = builder.f51806q;
        this.f51803p = builder.f51805p;
    }

    @Override // com.google.api.client.auth.oauth2.AuthorizationCodeFlow
    public GoogleAuthorizationCodeRequestUrl newAuthorizationUrl() {
        return new GoogleAuthorizationCodeRequestUrl(getAuthorizationServerEncodedUrl(), getClientId(), "", getScopes()).setAccessType(this.f51804q).setApprovalPrompt(this.f51803p);
    }
