...
public class MockGoogleCredential extends GoogleCredential {
    ...
    /* renamed from: u */
    public static final String f52005u = String.format("{\"access_token\": \"%s\", \"expires_in\":  %s, \"refresh_token\": \"%s\", \"token_type\": \"%s\"}", ACCESS_TOKEN, "3600", REFRESH_TOKEN, AuthHttpConstants.BEARER);

    /* renamed from: com.google.api.client.googleapis.testing.auth.oauth2.MockGoogleCredential$b */
    /* loaded from: classes4.dex */
    public static class C7286b implements HttpExecuteInterceptor {
        public C7286b() {
        }
    ...
    public static MockHttpTransport newMockHttpTransportWithSampleTokenResponse() {
        return new MockHttpTransport.Builder().setLowLevelHttpRequest(new MockLowLevelHttpRequest().setResponse(new MockLowLevelHttpResponse().setContentType(Json.MEDIA_TYPE).setContent(f52005u))).build();
    }
    ...
    public static class Builder extends GoogleCredential.Builder {
        ...
        public MockGoogleCredential build() {
            ...
            if (getClientAuthentication() == null) {
                setClientAuthentication((HttpExecuteInterceptor) new C7286b());
            }
