...
public final class LogDescriptor extends GeneratedMessageLite<LogDescriptor, Builder> implements LogDescriptorOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<LogDescriptor, Builder> implements LogDescriptorOrBuilder {
        public /* synthetic */ Builder(C7221a c7221a) {
            this();
        }

        public Builder addAllLabels(Iterable<? extends LabelDescriptor> iterable) {
            copyOnWrite();
            ((LogDescriptor) this.instance).m42662R(iterable);
            return this;
        }

        public Builder addLabels(LabelDescriptor labelDescriptor) {
            copyOnWrite();
            ((LogDescriptor) this.instance).m42660T(labelDescriptor);
            return this;
        }

        public Builder clearDescription() {
            copyOnWrite();
            ((LogDescriptor) this.instance).m42659U();
            return this;
        }

        public Builder clearDisplayName() {
            copyOnWrite();
            ((LogDescriptor) this.instance).m42658V();
            return this;
        }

        public Builder clearLabels() {
            copyOnWrite();
            ((LogDescriptor) this.instance).m42657W();
            return this;
        }

        public Builder clearName() {
            copyOnWrite();
            ((LogDescriptor) this.instance).m42656X();
            return this;
        }
        ...
        public Builder removeLabels(int i) {
            copyOnWrite();
            ((LogDescriptor) this.instance).m42654Z(i);
            return this;
        }

        public Builder setDescription(String str) {
            copyOnWrite();
            ((LogDescriptor) this.instance).m42653a0(str);
            return this;
        }

        public Builder setDescriptionBytes(ByteString byteString) {
            copyOnWrite();
            ((LogDescriptor) this.instance).m42652b0(byteString);
            return this;
        }

        public Builder setDisplayName(String str) {
            copyOnWrite();
            ((LogDescriptor) this.instance).m42651c0(str);
            return this;
        }

        public Builder setDisplayNameBytes(ByteString byteString) {
            copyOnWrite();
            ((LogDescriptor) this.instance).m42650d0(byteString);
            return this;
        }

        public Builder setLabels(int i, LabelDescriptor labelDescriptor) {
            copyOnWrite();
            ((LogDescriptor) this.instance).m42649e0(i, labelDescriptor);
            return this;
        }

        public Builder setName(String str) {
            copyOnWrite();
            ((LogDescriptor) this.instance).m42648f0(str);
            return this;
        }

        public Builder setNameBytes(ByteString byteString) {
            copyOnWrite();
            ((LogDescriptor) this.instance).m42647g0(byteString);
            return this;
        }
        ...
        public Builder addLabels(int i, LabelDescriptor labelDescriptor) {
            copyOnWrite();
            ((LogDescriptor) this.instance).m42661S(i, labelDescriptor);
            return this;
        }

        public Builder setLabels(int i, LabelDescriptor.Builder builder) {
            copyOnWrite();
            ((LogDescriptor) this.instance).m42649e0(i, builder.build());
            return this;
        }

        public Builder addLabels(LabelDescriptor.Builder builder) {
            copyOnWrite();
            ((LogDescriptor) this.instance).m42660T(builder.build());
            return this;
        }

        public Builder addLabels(int i, LabelDescriptor.Builder builder) {
            copyOnWrite();
            ((LogDescriptor) this.instance).m42661S(i, builder.build());
            return this;
        }
    }
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C7221a {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: a0 */
    public void m42653a0(String str) {
        str.getClass();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: b0 */
    public void m42652b0(ByteString byteString) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: f0 */
    public void m42648f0(String str) {
        str.getClass();
        this.name_ = str;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: g0 */
    public void m42647g0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
    ...
    /* renamed from: R */
    public final void m42662R(Iterable iterable) {
        m42655Y();
        AbstractMessageLite.addAll(iterable, (List) this.labels_);
    }

    /* renamed from: S */
    public final void m42661S(int i, LabelDescriptor labelDescriptor) {
    ...
    /* renamed from: T */
    public final void m42660T(LabelDescriptor labelDescriptor) {
        labelDescriptor.getClass();
        m42655Y();
    ...
    /* renamed from: V */
    public final void m42658V() {
        this.displayName_ = getDefaultInstance().getDisplayName();
    }

    /* renamed from: W */
    public final void m42657W() {
        this.labels_ = GeneratedMessageLite.emptyProtobufList();
    }

    /* renamed from: Y */
    public final void m42655Y() {
    ...
    /* renamed from: Z */
    public final void m42654Z(int i) {
        m42655Y();
        this.labels_.remove(i);
    }

    /* renamed from: c0 */
    public final void m42651c0(String str) {
        str.getClass();
        this.displayName_ = str;
    }

    /* renamed from: d0 */
    public final void m42650d0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C7221a.f51626a[methodToInvoke.ordinal()]) {
            case 1:
    ...
    /* renamed from: e0 */
    public final void m42649e0(int i, LabelDescriptor labelDescriptor) {
        labelDescriptor.getClass();
        m42655Y();
