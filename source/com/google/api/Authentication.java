...
public final class Authentication extends GeneratedMessageLite<Authentication, Builder> implements AuthenticationOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Authentication, Builder> implements AuthenticationOrBuilder {
        public /* synthetic */ Builder(C7192a c7192a) {
            this();
        }

        public Builder addAllProviders(Iterable<? extends AuthProvider> iterable) {
            copyOnWrite();
            ((Authentication) this.instance).m43337O(iterable);
            return this;
        }

        public Builder addAllRules(Iterable<? extends AuthenticationRule> iterable) {
            copyOnWrite();
            ((Authentication) this.instance).m43336P(iterable);
            return this;
        }

        public Builder addProviders(AuthProvider authProvider) {
            copyOnWrite();
            ((Authentication) this.instance).m43334R(authProvider);
            return this;
        }

        public Builder addRules(AuthenticationRule authenticationRule) {
            copyOnWrite();
            ((Authentication) this.instance).m43332T(authenticationRule);
            return this;
        }

        public Builder clearProviders() {
            copyOnWrite();
            ((Authentication) this.instance).m43331U();
            return this;
        }

        public Builder clearRules() {
            copyOnWrite();
            ((Authentication) this.instance).m43330V();
            return this;
        }
        ...
        public Builder removeProviders(int i) {
            copyOnWrite();
            ((Authentication) this.instance).m43327Y(i);
            return this;
        }

        public Builder removeRules(int i) {
            copyOnWrite();
            ((Authentication) this.instance).m43326Z(i);
            return this;
        }

        public Builder setProviders(int i, AuthProvider authProvider) {
            copyOnWrite();
            ((Authentication) this.instance).m43325a0(i, authProvider);
            return this;
        }

        public Builder setRules(int i, AuthenticationRule authenticationRule) {
            copyOnWrite();
            ((Authentication) this.instance).m43324b0(i, authenticationRule);
            return this;
        }
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C7192a {
        ...
        static {
            ...
            try {
                f51601a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f51601a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f51601a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f51601a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f51601a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f51601a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: O */
    public final void m43337O(Iterable iterable) {
        m43329W();
        AbstractMessageLite.addAll(iterable, (List) this.providers_);
    }

    /* renamed from: P */
    public final void m43336P(Iterable iterable) {
        m43328X();
        AbstractMessageLite.addAll(iterable, (List) this.rules_);
    }

    /* renamed from: Q */
    public final void m43335Q(int i, AuthProvider authProvider) {
    ...
    /* renamed from: R */
    public final void m43334R(AuthProvider authProvider) {
        authProvider.getClass();
        m43329W();
    ...
    /* renamed from: S */
    public final void m43333S(int i, AuthenticationRule authenticationRule) {
    ...
    /* renamed from: T */
    public final void m43332T(AuthenticationRule authenticationRule) {
        authenticationRule.getClass();
        m43328X();
    ...
    /* renamed from: U */
    public final void m43331U() {
        this.providers_ = GeneratedMessageLite.emptyProtobufList();
    }

    /* renamed from: V */
    public final void m43330V() {
        this.rules_ = GeneratedMessageLite.emptyProtobufList();
    }

    /* renamed from: W */
    public final void m43329W() {
    ...
    /* renamed from: Y */
    public final void m43327Y(int i) {
        m43329W();
        this.providers_.remove(i);
    }

    /* renamed from: Z */
    public final void m43326Z(int i) {
        m43328X();
        this.rules_.remove(i);
    }

    /* renamed from: a0 */
    public final void m43325a0(int i, AuthProvider authProvider) {
        authProvider.getClass();
        m43329W();
    ...
    /* renamed from: b0 */
    public final void m43324b0(int i, AuthenticationRule authenticationRule) {
        authenticationRule.getClass();
        m43328X();
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C7192a.f51601a[methodToInvoke.ordinal()]) {
            case 1:
