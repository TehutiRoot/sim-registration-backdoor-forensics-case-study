...
public final class Logging extends GeneratedMessageLite<Logging, Builder> implements LoggingOrBuilder {
    ...
    public static final class LoggingDestination extends GeneratedMessageLite<LoggingDestination, Builder> implements LoggingDestinationOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<LoggingDestination, Builder> implements LoggingDestinationOrBuilder {
            ...
            public Builder addAllLogs(Iterable<String> iterable) {
                copyOnWrite();
                ((LoggingDestination) this.instance).m42610K(iterable);
                return this;
            }

            public Builder addLogs(String str) {
                copyOnWrite();
                ((LoggingDestination) this.instance).m42609L(str);
                return this;
            }

            public Builder addLogsBytes(ByteString byteString) {
                copyOnWrite();
                ((LoggingDestination) this.instance).m42608M(byteString);
                return this;
            }

            public Builder clearLogs() {
                copyOnWrite();
                ((LoggingDestination) this.instance).m42607N();
                return this;
            }

            public Builder clearMonitoredResource() {
                copyOnWrite();
                ((LoggingDestination) this.instance).m42606O();
                return this;
            }
            ...
            public Builder setLogs(int i, String str) {
                copyOnWrite();
                ((LoggingDestination) this.instance).m42604Q(i, str);
                return this;
            }

            public Builder setMonitoredResource(String str) {
                copyOnWrite();
                ((LoggingDestination) this.instance).m42603R(str);
                return this;
            }

            public Builder setMonitoredResourceBytes(ByteString byteString) {
                copyOnWrite();
                ((LoggingDestination) this.instance).m42602S(byteString);
                return this;
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* renamed from: R */
        public void m42603R(String str) {
            str.getClass();
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* renamed from: S */
        public void m42602S(ByteString byteString) {
        ...
        /* renamed from: K */
        public final void m42610K(Iterable iterable) {
            m42605P();
            AbstractMessageLite.addAll(iterable, (List) this.logs_);
        }

        /* renamed from: L */
        public final void m42609L(String str) {
            str.getClass();
            m42605P();
            this.logs_.add(str);
        }
        ...
        /* renamed from: M */
        public final void m42608M(ByteString byteString) {
            AbstractMessageLite.checkByteStringIsUtf8(byteString);
            m42605P();
        ...
        /* renamed from: N */
        public final void m42607N() {
            this.logs_ = GeneratedMessageLite.emptyProtobufList();
        }

        /* renamed from: P */
        public final void m42605P() {
        ...
        /* renamed from: Q */
        public final void m42604Q(int i, String str) {
            str.getClass();
            m42605P();
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C7222a.f51627a[methodToInvoke.ordinal()]) {
                case 1:
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C7222a {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: O */
    public void m42633O(Iterable iterable) {
        m42625W();
    ...
    /* renamed from: P */
    public final void m42632P(Iterable iterable) {
        m42624X();
        AbstractMessageLite.addAll(iterable, (List) this.producerDestinations_);
    }

    /* renamed from: Q */
    public final void m42631Q(int i, LoggingDestination loggingDestination) {
    ...
    /* renamed from: R */
    public final void m42630R(LoggingDestination loggingDestination) {
        loggingDestination.getClass();
        m42625W();
    ...
    /* renamed from: S */
    public final void m42629S(int i, LoggingDestination loggingDestination) {
        loggingDestination.getClass();
        m42624X();
    ...
    /* renamed from: T */
    public final void m42628T(LoggingDestination loggingDestination) {
        loggingDestination.getClass();
        m42624X();
    ...
    /* renamed from: Z */
    public final void m42622Z(int i) {
        m42624X();
        this.producerDestinations_.remove(i);
    }

    /* renamed from: a0 */
    public final void m42621a0(int i, LoggingDestination loggingDestination) {
        loggingDestination.getClass();
        m42625W();
    ...
    /* renamed from: b0 */
    public final void m42620b0(int i, LoggingDestination loggingDestination) {
        loggingDestination.getClass();
        m42624X();
