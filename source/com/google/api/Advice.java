...
public final class Advice extends GeneratedMessageLite<Advice, Builder> implements AdviceOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Advice, Builder> implements AdviceOrBuilder {
        public /* synthetic */ Builder(C7189a c7189a) {
            this();
        }

        public Builder clearDescription() {
            copyOnWrite();
            ((Advice) this.instance).m43410F();
            return this;
        }
        ...
        public Builder setDescription(String str) {
            copyOnWrite();
            ((Advice) this.instance).m43409G(str);
            return this;
        }

        public Builder setDescriptionBytes(ByteString byteString) {
            copyOnWrite();
            ((Advice) this.instance).m43408H(byteString);
            return this;
        }
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C7189a {
        ...
        static {
            ...
            try {
                f51598a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f51598a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f51598a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f51598a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f51598a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f51598a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: F */
    public final void m43410F() {
        this.description_ = getDefaultInstance().getDescription();
    }

    /* renamed from: G */
    public final void m43409G(String str) {
        str.getClass();
        this.description_ = str;
    }

    /* renamed from: H */
    public final void m43408H(ByteString byteString) {
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C7189a.f51598a[methodToInvoke.ordinal()]) {
            case 1:
                return new Advice();
            case 2:
