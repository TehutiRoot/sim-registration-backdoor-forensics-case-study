...
public final class Viewport extends GeneratedMessageLite<Viewport, Builder> implements ViewportOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Viewport, Builder> implements ViewportOrBuilder {
        public /* synthetic */ Builder(C8670a c8670a) {
            this();
        }

        public Builder clearHigh() {
            copyOnWrite();
            ((Viewport) this.instance).m37587I();
            return this;
        }

        public Builder clearLow() {
            copyOnWrite();
            ((Viewport) this.instance).m37586J();
            return this;
        }
        ...
        public Builder mergeHigh(LatLng latLng) {
            copyOnWrite();
            ((Viewport) this.instance).m37585K(latLng);
            return this;
        }

        public Builder mergeLow(LatLng latLng) {
            copyOnWrite();
            ((Viewport) this.instance).m37584L(latLng);
            return this;
        }

        public Builder setHigh(LatLng latLng) {
            copyOnWrite();
            ((Viewport) this.instance).m37583M(latLng);
            return this;
        }

        public Builder setLow(LatLng latLng) {
            copyOnWrite();
            ((Viewport) this.instance).m37582N(latLng);
            return this;
        }
        ...
        public Builder setHigh(LatLng.Builder builder) {
            copyOnWrite();
            ((Viewport) this.instance).m37583M(builder.build());
            return this;
        }

        public Builder setLow(LatLng.Builder builder) {
            copyOnWrite();
            ((Viewport) this.instance).m37582N(builder.build());
            return this;
        }
    }
    ...
    public static /* synthetic */ class C8670a {
        ...
        static {
            ...
            try {
                f56635a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f56635a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f56635a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f56635a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f56635a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f56635a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: I */
    public final void m37587I() {
        this.high_ = null;
    }

    /* renamed from: J */
    public final void m37586J() {
        this.low_ = null;
    }

    /* renamed from: K */
    public final void m37585K(LatLng latLng) {
        latLng.getClass();
    ...
    /* renamed from: L */
    public final void m37584L(LatLng latLng) {
        latLng.getClass();
    ...
    /* renamed from: M */
    public final void m37583M(LatLng latLng) {
        latLng.getClass();
        this.high_ = latLng;
    }

    /* renamed from: N */
    public final void m37582N(LatLng latLng) {
        latLng.getClass();
        this.low_ = latLng;
    }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C8670a.f56635a[methodToInvoke.ordinal()]) {
            case 1:
                return new Viewport();
            case 2:
