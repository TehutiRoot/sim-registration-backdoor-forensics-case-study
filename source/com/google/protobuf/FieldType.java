...
public final class FieldType {
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C8880a {

        /* renamed from: a */
        public static final /* synthetic */ int[] f57336a;

        /* renamed from: b */
        public static final /* synthetic */ int[] f57337b;
        ...
        static {
            ...
            try {
                f57337b[JavaType.MESSAGE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f57337b[JavaType.STRING.ordinal()] = 3;
            ...
            try {
                f57336a[Collection.VECTOR.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f57336a[Collection.SCALAR.ordinal()] = 3;
    ...
    static {
        ...
        for (FieldType fieldType : values) {
            VALUES[fieldType.f57335id] = fieldType;
        }
    }
    ...
    private FieldType(String str, int i, int i2, Collection collection, JavaType javaType) {
        ...
        int i4 = C8880a.f57336a[collection.ordinal()];
        boolean z = true;
        if (i4 != 1) {
            if (i4 != 2) {
        ...
        this.primitiveScalar = (collection != Collection.SCALAR || (i3 = C8880a.f57337b[javaType.ordinal()]) == 1 || i3 == 2 || i3 == 3) ? false : false;
    }
