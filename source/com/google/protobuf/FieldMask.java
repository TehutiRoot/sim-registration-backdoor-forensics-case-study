...
public final class FieldMask extends GeneratedMessageLite<FieldMask, Builder> implements FieldMaskOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<FieldMask, Builder> implements FieldMaskOrBuilder {
        public /* synthetic */ Builder(C8878a c8878a) {
            this();
        }

        public Builder addAllPaths(Iterable<String> iterable) {
            copyOnWrite();
            ((FieldMask) this.instance).m35887H(iterable);
            return this;
        }

        public Builder addPaths(String str) {
            copyOnWrite();
            ((FieldMask) this.instance).m35886I(str);
            return this;
        }

        public Builder addPathsBytes(ByteString byteString) {
            copyOnWrite();
            ((FieldMask) this.instance).m35885J(byteString);
            return this;
        }

        public Builder clearPaths() {
            copyOnWrite();
            ((FieldMask) this.instance).m35884K();
            return this;
        }
        ...
        public Builder setPaths(int i, String str) {
            copyOnWrite();
            ((FieldMask) this.instance).m35882M(i, str);
            return this;
        }
    ...
    public static /* synthetic */ class C8878a {
        ...
        static {
            ...
            try {
                f57328a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f57328a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f57328a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f57328a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f57328a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f57328a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: H */
    public final void m35887H(Iterable iterable) {
        m35883L();
        AbstractMessageLite.addAll(iterable, (List) this.paths_);
    }

    /* renamed from: I */
    public final void m35886I(String str) {
        str.getClass();
        m35883L();
        this.paths_.add(str);
    }
    ...
    /* renamed from: J */
    public final void m35885J(ByteString byteString) {
    ...
    /* renamed from: K */
    public final void m35884K() {
        this.paths_ = GeneratedMessageLite.emptyProtobufList();
    }

    /* renamed from: L */
    public final void m35883L() {
    ...
    /* renamed from: M */
    public final void m35882M(int i, String str) {
        str.getClass();
        m35883L();
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C8878a.f57328a[methodToInvoke.ordinal()]) {
            case 1:
