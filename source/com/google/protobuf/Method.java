...
public final class Method extends GeneratedMessageLite<Method, Builder> implements MethodOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Method, Builder> implements MethodOrBuilder {
        public /* synthetic */ Builder(C8898a c8898a) {
            this();
        }

        public Builder addAllOptions(Iterable<? extends Option> iterable) {
            copyOnWrite();
            ((Method) this.instance).m35710Y(iterable);
            return this;
        }

        public Builder addOptions(Option option) {
            copyOnWrite();
            ((Method) this.instance).m35708a0(option);
            return this;
        }

        public Builder clearName() {
            copyOnWrite();
            ((Method) this.instance).m35707b0();
            return this;
        }

        public Builder clearOptions() {
            copyOnWrite();
            ((Method) this.instance).m35706c0();
            return this;
        }

        public Builder clearRequestStreaming() {
            copyOnWrite();
            ((Method) this.instance).m35705d0();
            return this;
        }

        public Builder clearRequestTypeUrl() {
            copyOnWrite();
            ((Method) this.instance).m35704e0();
            return this;
        }

        public Builder clearResponseStreaming() {
            copyOnWrite();
            ((Method) this.instance).m35703f0();
            return this;
        }

        public Builder clearResponseTypeUrl() {
            copyOnWrite();
            ((Method) this.instance).m35702g0();
            return this;
        }

        public Builder clearSyntax() {
            copyOnWrite();
            ((Method) this.instance).m35701h0();
            return this;
        }
        ...
        public Builder removeOptions(int i) {
            copyOnWrite();
            ((Method) this.instance).m35699j0(i);
            return this;
        }

        public Builder setName(String str) {
            copyOnWrite();
            ((Method) this.instance).m35698k0(str);
            return this;
        }

        public Builder setNameBytes(ByteString byteString) {
            copyOnWrite();
            ((Method) this.instance).m35697l0(byteString);
            return this;
        }

        public Builder setOptions(int i, Option option) {
            copyOnWrite();
            ((Method) this.instance).m35696m0(i, option);
            return this;
        }

        public Builder setRequestStreaming(boolean z) {
            copyOnWrite();
            ((Method) this.instance).m35695n0(z);
            return this;
        }

        public Builder setRequestTypeUrl(String str) {
            copyOnWrite();
            ((Method) this.instance).m35694o0(str);
            return this;
        }

        public Builder setRequestTypeUrlBytes(ByteString byteString) {
            copyOnWrite();
            ((Method) this.instance).m35693p0(byteString);
            return this;
        }

        public Builder setResponseStreaming(boolean z) {
            copyOnWrite();
            ((Method) this.instance).m35692q0(z);
            return this;
        }

        public Builder setResponseTypeUrl(String str) {
            copyOnWrite();
            ((Method) this.instance).m35691r0(str);
            return this;
        }

        public Builder setResponseTypeUrlBytes(ByteString byteString) {
            copyOnWrite();
            ((Method) this.instance).m35690s0(byteString);
            return this;
        }

        public Builder setSyntax(Syntax syntax) {
            copyOnWrite();
            ((Method) this.instance).m35689t0(syntax);
            return this;
        }

        public Builder setSyntaxValue(int i) {
            copyOnWrite();
            ((Method) this.instance).m35688u0(i);
            return this;
        }
        ...
        public Builder addOptions(int i, Option option) {
            copyOnWrite();
            ((Method) this.instance).m35709Z(i, option);
            return this;
        }

        public Builder setOptions(int i, Option.Builder builder) {
            copyOnWrite();
            ((Method) this.instance).m35696m0(i, builder.build());
            return this;
        }

        public Builder addOptions(Option.Builder builder) {
            copyOnWrite();
            ((Method) this.instance).m35708a0(builder.build());
            return this;
        }

        public Builder addOptions(int i, Option.Builder builder) {
            copyOnWrite();
            ((Method) this.instance).m35709Z(i, builder.build());
            return this;
        }
    }
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C8898a {
        ...
        static {
            ...
            try {
                f57392a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f57392a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f57392a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f57392a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f57392a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f57392a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: Y */
    public void m35710Y(Iterable iterable) {
        m35700i0();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: Z */
    public void m35709Z(int i, Option option) {
        option.getClass();
        m35700i0();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: a0 */
    public void m35708a0(Option option) {
        option.getClass();
        m35700i0();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: b0 */
    public void m35707b0() {
        this.name_ = getDefaultInstance().getName();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: c0 */
    public void m35706c0() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: h0 */
    public void m35701h0() {
        this.syntax_ = 0;
    }

    /* renamed from: i0 */
    private void m35700i0() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: k0 */
    public void m35698k0(String str) {
        str.getClass();
        this.name_ = str;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: l0 */
    public void m35697l0(ByteString byteString) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: m0 */
    public void m35696m0(int i, Option option) {
        option.getClass();
        m35700i0();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: t0 */
    public void m35689t0(Syntax syntax) {
        this.syntax_ = syntax.getNumber();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: u0 */
    public void m35688u0(int i) {
        this.syntax_ = i;
    }

    /* renamed from: d0 */
    public final void m35705d0() {
        this.requestStreaming_ = false;
    }

    @Override // com.google.protobuf.GeneratedMessageLite
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C8898a.f57392a[methodToInvoke.ordinal()]) {
            case 1:
                return new Method();
            case 2:
    ...
    /* renamed from: e0 */
    public final void m35704e0() {
        this.requestTypeUrl_ = getDefaultInstance().getRequestTypeUrl();
    }

    /* renamed from: f0 */
    public final void m35703f0() {
        this.responseStreaming_ = false;
    }

    /* renamed from: g0 */
    public final void m35702g0() {
    ...
    /* renamed from: n0 */
    public final void m35695n0(boolean z) {
        this.requestStreaming_ = z;
    }

    /* renamed from: o0 */
    public final void m35694o0(String str) {
        str.getClass();
        this.requestTypeUrl_ = str;
    }

    /* renamed from: p0 */
    public final void m35693p0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.requestTypeUrl_ = byteString.toStringUtf8();
    }

    /* renamed from: q0 */
    public final void m35692q0(boolean z) {
        this.responseStreaming_ = z;
    }

    /* renamed from: r0 */
    public final void m35691r0(String str) {
        str.getClass();
        this.responseTypeUrl_ = str;
    }

    /* renamed from: s0 */
    public final void m35690s0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
