...
public final class Option extends GeneratedMessageLite<Option, Builder> implements OptionOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Option, Builder> implements OptionOrBuilder {
        public /* synthetic */ Builder(C8903a c8903a) {
            this();
        }

        public Builder clearName() {
            copyOnWrite();
            ((Option) this.instance).m35666I();
            return this;
        }

        public Builder clearValue() {
            copyOnWrite();
            ((Option) this.instance).m35665J();
            return this;
        }
        ...
        public Builder mergeValue(Any any) {
            copyOnWrite();
            ((Option) this.instance).m35664K(any);
            return this;
        }

        public Builder setName(String str) {
            copyOnWrite();
            ((Option) this.instance).m35663L(str);
            return this;
        }

        public Builder setNameBytes(ByteString byteString) {
            copyOnWrite();
            ((Option) this.instance).m35662M(byteString);
            return this;
        }

        public Builder setValue(Any any) {
            copyOnWrite();
            ((Option) this.instance).m35661N(any);
            return this;
        }
        ...
        public Builder setValue(Any.Builder builder) {
            copyOnWrite();
            ((Option) this.instance).m35661N(builder.build());
            return this;
        }
    }
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C8903a {
        ...
        static {
            ...
            try {
                f57397a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f57397a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f57397a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f57397a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f57397a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f57397a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: L */
    public void m35663L(String str) {
        str.getClass();
        this.name_ = str;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: M */
    public void m35662M(ByteString byteString) {
    ...
    /* renamed from: K */
    public final void m35664K(Any any) {
        any.getClass();
    ...
    /* renamed from: N */
    public final void m35661N(Any any) {
        any.getClass();
        this.value_ = any;
    }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C8903a.f57397a[methodToInvoke.ordinal()]) {
            case 1:
                return new Option();
            case 2:
