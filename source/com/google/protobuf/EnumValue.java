...
public final class EnumValue extends GeneratedMessageLite<EnumValue, Builder> implements EnumValueOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<EnumValue, Builder> implements EnumValueOrBuilder {
        public /* synthetic */ Builder(C8869a c8869a) {
            this();
        }

        public Builder addAllOptions(Iterable<? extends Option> iterable) {
            copyOnWrite();
            ((EnumValue) this.instance).m35993N(iterable);
            return this;
        }

        public Builder addOptions(Option option) {
            copyOnWrite();
            ((EnumValue) this.instance).m35991P(option);
            return this;
        }

        public Builder clearName() {
            copyOnWrite();
            ((EnumValue) this.instance).m35990Q();
            return this;
        }

        public Builder clearNumber() {
            copyOnWrite();
            ((EnumValue) this.instance).m35989R();
            return this;
        }

        public Builder clearOptions() {
            copyOnWrite();
            ((EnumValue) this.instance).m35988S();
            return this;
        }
        ...
        public Builder removeOptions(int i) {
            copyOnWrite();
            ((EnumValue) this.instance).m35986U(i);
            return this;
        }

        public Builder setName(String str) {
            copyOnWrite();
            ((EnumValue) this.instance).m35985V(str);
            return this;
        }

        public Builder setNameBytes(ByteString byteString) {
            copyOnWrite();
            ((EnumValue) this.instance).m35984W(byteString);
            return this;
        }

        public Builder setNumber(int i) {
            copyOnWrite();
            ((EnumValue) this.instance).m35983X(i);
            return this;
        }

        public Builder setOptions(int i, Option option) {
            copyOnWrite();
            ((EnumValue) this.instance).m35982Y(i, option);
            return this;
        }
        ...
        public Builder addOptions(int i, Option option) {
            copyOnWrite();
            ((EnumValue) this.instance).m35992O(i, option);
            return this;
        }

        public Builder setOptions(int i, Option.Builder builder) {
            copyOnWrite();
            ((EnumValue) this.instance).m35982Y(i, builder.build());
            return this;
        }

        public Builder addOptions(Option.Builder builder) {
            copyOnWrite();
            ((EnumValue) this.instance).m35991P(builder.build());
            return this;
        }

        public Builder addOptions(int i, Option.Builder builder) {
            copyOnWrite();
            ((EnumValue) this.instance).m35992O(i, builder.build());
            return this;
        }
    }
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C8869a {
        ...
        static {
            ...
            try {
                f57292a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f57292a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f57292a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f57292a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f57292a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f57292a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: N */
    public void m35993N(Iterable iterable) {
        m35987T();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: O */
    public void m35992O(int i, Option option) {
        option.getClass();
        m35987T();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: P */
    public void m35991P(Option option) {
        option.getClass();
        m35987T();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: V */
    public void m35985V(String str) {
        str.getClass();
        this.name_ = str;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: W */
    public void m35984W(ByteString byteString) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: X */
    public void m35983X(int i) {
        this.number_ = i;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: Y */
    public void m35982Y(int i, Option option) {
        option.getClass();
        m35987T();
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C8869a.f57292a[methodToInvoke.ordinal()]) {
            case 1:
