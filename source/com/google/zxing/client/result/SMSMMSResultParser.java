...
public final class SMSMMSResultParser extends ResultParser {
    /* renamed from: g */
    public static void m34186g(Collection collection, Collection collection2, String str) {
    ...
    public SMSParsedResult parse(Result result) {
        ...
        if (m34188e == null || m34188e.isEmpty()) {
            z = false;
            str = null;
        } else {
            str2 = (String) m34188e.get("subject");
            str = (String) m34188e.get("body");
            z = true;
        }
        ...
        while (true) {
            ...
            if (indexOf2 > i) {
                m34186g(arrayList, arrayList2, substring.substring(i2, indexOf2));
                i = indexOf2;
            } else {
                m34186g(arrayList, arrayList2, substring.substring(i2));
