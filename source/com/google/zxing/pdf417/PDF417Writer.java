...
public final class PDF417Writer implements Writer {
    /* renamed from: a */
    public static BitMatrix m33987a(PDF417 pdf417, String str, int i, int i2, int i3, int i4) {
        boolean z;
        boolean z2;
        boolean z3;
        ...
        if (z ^ z2) {
            scaledMatrix = m33985c(scaledMatrix);
            z3 = true;
        } else {
            z3 = false;
        }
        ...
        if (length > 1) {
            ...
            if (z3) {
                scaledMatrix2 = m33985c(scaledMatrix2);
            }
            return m33986b(scaledMatrix2, i4);
        }
        return m33986b(scaledMatrix, i4);
    }

    /* renamed from: b */
    public static BitMatrix m33986b(byte[][] bArr, int i) {
        int i2 = i * 2;
    ...
    /* renamed from: c */
    public static byte[][] m33985c(byte[][] bArr) {
    ...
    public BitMatrix encode(String str, BarcodeFormat barcodeFormat, int i, int i2, Map<EncodeHintType, ?> map) throws WriterException {
        ...
        if (barcodeFormat == BarcodeFormat.PDF_417) {
            ...
            return m33987a(pdf417, str, i3, i, i2, i4);
        }
