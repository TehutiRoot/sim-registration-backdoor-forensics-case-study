...
public class SymbolInfo {
    ...
    /* renamed from: g */
    public static final SymbolInfo[] f57828g;

    /* renamed from: h */
    public static SymbolInfo[] f57829h;
    ...
    /* renamed from: c */
    public static SymbolInfo m34077c(int i, SymbolShapeHint symbolShapeHint, boolean z) {
        return lookup(i, symbolShapeHint, null, null, z);
    }

    public static SymbolInfo lookup(int i) {
        return m34077c(i, SymbolShapeHint.FORCE_NONE, true);
    }
    ...
    public int getCodewordCount() {
        return this.f57831b + this.f57832c;
    }
    ...
    public int getInterleavedBlockCount() {
        return this.f57831b / this.f57834e;
    }

    public final int getSymbolDataHeight() {
        return m34078b() * this.matrixHeight;
    }

    public final int getSymbolDataWidth() {
        return m34079a() * this.matrixWidth;
    }

    public final int getSymbolHeight() {
        return getSymbolDataHeight() + (m34078b() << 1);
    }

    public final int getSymbolWidth() {
        return getSymbolDataWidth() + (m34079a() << 1);
    }
    ...
    public static SymbolInfo lookup(int i, SymbolShapeHint symbolShapeHint) {
        return m34077c(i, symbolShapeHint, true);
    }

    public static SymbolInfo lookup(int i, boolean z, boolean z2) {
        return m34077c(i, z ? SymbolShapeHint.FORCE_NONE : SymbolShapeHint.FORCE_SQUARE, z2);
    }
    ...
    public static SymbolInfo lookup(int i, SymbolShapeHint symbolShapeHint, Dimension dimension, Dimension dimension2, boolean z) {
        ...
        for (SymbolInfo symbolInfo : f57829h) {
            if (!(symbolShapeHint == SymbolShapeHint.FORCE_SQUARE && symbolInfo.f57830a) && ((symbolShapeHint != SymbolShapeHint.FORCE_RECTANGLE || symbolInfo.f57830a) && ((dimension == null || (symbolInfo.getSymbolWidth() >= dimension.getWidth() && symbolInfo.getSymbolHeight() >= dimension.getHeight())) && ((dimension2 == null || (symbolInfo.getSymbolWidth() <= dimension2.getWidth() && symbolInfo.getSymbolHeight() <= dimension2.getHeight())) && i <= symbolInfo.f57831b)))) {
                return symbolInfo;
            }
        }
        if (z) {
