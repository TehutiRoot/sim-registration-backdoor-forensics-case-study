...
public class Code93Writer extends OneDimensionalCodeWriter {
    ...
    /* renamed from: b */
    public static int m34047b(String str, int i) {
        int i2 = 0;
        int i3 = 1;
    ...
    /* renamed from: c */
    private static void m34046c(int i, int[] iArr) {
    ...
    public boolean[] encode(String str) {
        ...
        if (length <= 80) {
            ...
            m34046c(Code93Reader.f57863d[47], iArr);
            int appendPattern = appendPattern(zArr, 0, iArr, true);
            for (int i = 0; i < length; i++) {
                m34046c(Code93Reader.f57863d["0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%abcd*".indexOf(str.charAt(i))], iArr);
                appendPattern += appendPattern(zArr, appendPattern, iArr, true);
            }
            int m34047b = m34047b(str, 20);
            int[] iArr2 = Code93Reader.f57863d;
            m34046c(iArr2[m34047b], iArr);
            int appendPattern2 = appendPattern + appendPattern(zArr, appendPattern, iArr, true);
            m34046c(iArr2[m34047b(str + "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%abcd*".charAt(m34047b), 15)], iArr);
            int appendPattern3 = appendPattern2 + appendPattern(zArr, appendPattern2, iArr, true);
            m34046c(iArr2[47], iArr);
