...
public final class Code39Writer extends OneDimensionalCodeWriter {
    /* renamed from: b */
    public static void m34054b(int i, int[] iArr) {
    ...
    public boolean[] encode(String str) {
        ...
        if (length <= 80) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                ...
                if (indexOf >= 0) {
                    m34054b(Code39Reader.f57856e[indexOf], iArr);
            ...
            m34054b(Code39Reader.f57857f, iArr);
            ...
            for (int i4 = 0; i4 < length; i4++) {
                m34054b(Code39Reader.f57856e["0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. *$/+%".indexOf(str.charAt(i4))], iArr);
