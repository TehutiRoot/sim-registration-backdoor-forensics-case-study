...
public abstract class AbstractRSSReader extends OneDReader {
    ...
    /* renamed from: a */
    public final int[] f57893a = new int[4];

    /* renamed from: c */
    public final float[] f57895c = new float[4];

    /* renamed from: d */
    public final float[] f57896d = new float[4];

    public AbstractRSSReader() {
        int[] iArr = new int[8];
        this.f57894b = iArr;
        this.f57897e = new int[iArr.length / 2];
        this.f57898f = new int[iArr.length / 2];
    }
