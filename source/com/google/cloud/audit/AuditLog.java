...
public final class AuditLog extends GeneratedMessageLite<AuditLog, Builder> implements AuditLogOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<AuditLog, Builder> implements AuditLogOrBuilder {
        public /* synthetic */ Builder(C7380a c7380a) {
            this();
        }

        public Builder addAllAuthorizationInfo(Iterable<? extends AuthorizationInfo> iterable) {
            copyOnWrite();
            ((AuditLog) this.instance).m41403l0(iterable);
            return this;
        }

        public Builder addAuthorizationInfo(AuthorizationInfo authorizationInfo) {
            copyOnWrite();
            ((AuditLog) this.instance).m41401n0(authorizationInfo);
            return this;
        }

        public Builder clearAuthenticationInfo() {
            copyOnWrite();
            ((AuditLog) this.instance).m41400o0();
            return this;
        }

        public Builder clearAuthorizationInfo() {
            copyOnWrite();
            ((AuditLog) this.instance).m41399p0();
            return this;
        }

        public Builder clearMethodName() {
            copyOnWrite();
            ((AuditLog) this.instance).m41398q0();
            return this;
        }

        public Builder clearNumResponseItems() {
            copyOnWrite();
            ((AuditLog) this.instance).m41397r0();
            return this;
        }

        public Builder clearRequest() {
            copyOnWrite();
            ((AuditLog) this.instance).m41396s0();
            return this;
        }

        public Builder clearRequestMetadata() {
            copyOnWrite();
            ((AuditLog) this.instance).m41395t0();
            return this;
        }

        public Builder clearResourceName() {
            copyOnWrite();
            ((AuditLog) this.instance).m41394u0();
            return this;
        }

        public Builder clearResponse() {
            copyOnWrite();
            ((AuditLog) this.instance).m41393v0();
            return this;
        }

        public Builder clearServiceData() {
            copyOnWrite();
            ((AuditLog) this.instance).m41392w0();
            return this;
        }

        public Builder clearServiceName() {
            copyOnWrite();
            ((AuditLog) this.instance).m41391x0();
            return this;
        }

        public Builder clearStatus() {
            copyOnWrite();
            ((AuditLog) this.instance).m41390y0();
            return this;
        }
        ...
        public Builder mergeAuthenticationInfo(AuthenticationInfo authenticationInfo) {
            copyOnWrite();
            ((AuditLog) this.instance).m41460A0(authenticationInfo);
            return this;
        }

        public Builder mergeRequest(Struct struct) {
            copyOnWrite();
            ((AuditLog) this.instance).m41458B0(struct);
            return this;
        }

        public Builder mergeRequestMetadata(RequestMetadata requestMetadata) {
            copyOnWrite();
            ((AuditLog) this.instance).m41456C0(requestMetadata);
            return this;
        }

        public Builder mergeResponse(Struct struct) {
            copyOnWrite();
            ((AuditLog) this.instance).m41454D0(struct);
            return this;
        }

        public Builder mergeServiceData(Any any) {
            copyOnWrite();
            ((AuditLog) this.instance).m41452E0(any);
            return this;
        }

        public Builder mergeStatus(Status status) {
            copyOnWrite();
            ((AuditLog) this.instance).m41450F0(status);
            return this;
        }

        public Builder removeAuthorizationInfo(int i) {
            copyOnWrite();
            ((AuditLog) this.instance).m41448G0(i);
            return this;
        }

        public Builder setAuthenticationInfo(AuthenticationInfo authenticationInfo) {
            copyOnWrite();
            ((AuditLog) this.instance).m41446H0(authenticationInfo);
            return this;
        }

        public Builder setAuthorizationInfo(int i, AuthorizationInfo authorizationInfo) {
            copyOnWrite();
            ((AuditLog) this.instance).m41444I0(i, authorizationInfo);
            return this;
        }

        public Builder setMethodName(String str) {
            copyOnWrite();
            ((AuditLog) this.instance).m41442J0(str);
            return this;
        }

        public Builder setMethodNameBytes(ByteString byteString) {
            copyOnWrite();
            ((AuditLog) this.instance).m41440K0(byteString);
            return this;
        }

        public Builder setNumResponseItems(long j) {
            copyOnWrite();
            ((AuditLog) this.instance).m41438L0(j);
            return this;
        }

        public Builder setRequest(Struct struct) {
            copyOnWrite();
            ((AuditLog) this.instance).m41436M0(struct);
            return this;
        }

        public Builder setRequestMetadata(RequestMetadata requestMetadata) {
            copyOnWrite();
            ((AuditLog) this.instance).m41434N0(requestMetadata);
            return this;
        }

        public Builder setResourceName(String str) {
            copyOnWrite();
            ((AuditLog) this.instance).m41432O0(str);
            return this;
        }

        public Builder setResourceNameBytes(ByteString byteString) {
            copyOnWrite();
            ((AuditLog) this.instance).m41430P0(byteString);
            return this;
        }

        public Builder setResponse(Struct struct) {
            copyOnWrite();
            ((AuditLog) this.instance).m41428Q0(struct);
            return this;
        }

        public Builder setServiceData(Any any) {
            copyOnWrite();
            ((AuditLog) this.instance).m41426R0(any);
            return this;
        }

        public Builder setServiceName(String str) {
            copyOnWrite();
            ((AuditLog) this.instance).m41424S0(str);
            return this;
        }

        public Builder setServiceNameBytes(ByteString byteString) {
            copyOnWrite();
            ((AuditLog) this.instance).m41422T0(byteString);
            return this;
        }

        public Builder setStatus(Status status) {
            copyOnWrite();
            ((AuditLog) this.instance).m41420U0(status);
            return this;
        }
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C7380a {
        ...
        static {
            ...
            try {
                f52676a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f52676a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f52676a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f52676a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f52676a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f52676a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: A0 */
    public final void m41460A0(AuthenticationInfo authenticationInfo) {
    ...
    /* renamed from: B0 */
    public final void m41458B0(Struct struct) {
        struct.getClass();
    ...
    /* renamed from: C0 */
    public final void m41456C0(RequestMetadata requestMetadata) {
    ...
    /* renamed from: D0 */
    public final void m41454D0(Struct struct) {
        struct.getClass();
    ...
    /* renamed from: E0 */
    public final void m41452E0(Any any) {
        any.getClass();
    ...
    /* renamed from: F0 */
    public final void m41450F0(Status status) {
        status.getClass();
    ...
    /* renamed from: G0 */
    public final void m41448G0(int i) {
        m41389z0();
        this.authorizationInfo_.remove(i);
    }

    /* renamed from: H0 */
    public final void m41446H0(AuthenticationInfo authenticationInfo) {
        authenticationInfo.getClass();
        this.authenticationInfo_ = authenticationInfo;
    }

    /* renamed from: I0 */
    public final void m41444I0(int i, AuthorizationInfo authorizationInfo) {
    ...
    /* renamed from: J0 */
    public final void m41442J0(String str) {
        str.getClass();
        this.methodName_ = str;
    }

    /* renamed from: K0 */
    public final void m41440K0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.methodName_ = byteString.toStringUtf8();
    }

    /* renamed from: L0 */
    public final void m41438L0(long j) {
        this.numResponseItems_ = j;
    }

    /* renamed from: M0 */
    public final void m41436M0(Struct struct) {
        struct.getClass();
        this.request_ = struct;
    }

    /* renamed from: N0 */
    public final void m41434N0(RequestMetadata requestMetadata) {
        requestMetadata.getClass();
        this.requestMetadata_ = requestMetadata;
    }

    /* renamed from: O0 */
    public final void m41432O0(String str) {
        str.getClass();
        this.resourceName_ = str;
    }

    /* renamed from: P0 */
    public final void m41430P0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.resourceName_ = byteString.toStringUtf8();
    }

    /* renamed from: Q0 */
    public final void m41428Q0(Struct struct) {
        struct.getClass();
        this.response_ = struct;
    }

    /* renamed from: R0 */
    public final void m41426R0(Any any) {
        any.getClass();
        this.serviceData_ = any;
    }

    /* renamed from: S0 */
    public final void m41424S0(String str) {
        str.getClass();
        this.serviceName_ = str;
    }

    /* renamed from: T0 */
    public final void m41422T0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.serviceName_ = byteString.toStringUtf8();
    }

    /* renamed from: U0 */
    public final void m41420U0(Status status) {
        status.getClass();
        this.status_ = status;
    }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C7380a.f52676a[methodToInvoke.ordinal()]) {
            case 1:
                return new AuditLog();
            case 2:
    ...
    /* renamed from: l0 */
    public final void m41403l0(Iterable iterable) {
        m41389z0();
        AbstractMessageLite.addAll(iterable, (List) this.authorizationInfo_);
    }

    /* renamed from: m0 */
    public final void m41402m0(int i, AuthorizationInfo authorizationInfo) {
        authorizationInfo.getClass();
        m41389z0();
    ...
    /* renamed from: n0 */
    public final void m41401n0(AuthorizationInfo authorizationInfo) {
        authorizationInfo.getClass();
        m41389z0();
    ...
    /* renamed from: o0 */
    public final void m41400o0() {
        this.authenticationInfo_ = null;
    }

    /* renamed from: p0 */
    public final void m41399p0() {
        this.authorizationInfo_ = GeneratedMessageLite.emptyProtobufList();
    }

    /* renamed from: q0 */
    public final void m41398q0() {
        this.methodName_ = getDefaultInstance().getMethodName();
    }

    /* renamed from: r0 */
    public final void m41397r0() {
        this.numResponseItems_ = 0L;
    }

    /* renamed from: s0 */
    public final void m41396s0() {
        this.request_ = null;
    }

    /* renamed from: t0 */
    public final void m41395t0() {
        this.requestMetadata_ = null;
    }

    /* renamed from: u0 */
    public final void m41394u0() {
        this.resourceName_ = getDefaultInstance().getResourceName();
    }

    /* renamed from: v0 */
    public final void m41393v0() {
        this.response_ = null;
    }

    /* renamed from: w0 */
    public final void m41392w0() {
        this.serviceData_ = null;
    }

    /* renamed from: x0 */
    public final void m41391x0() {
        this.serviceName_ = getDefaultInstance().getServiceName();
    }

    /* renamed from: y0 */
    public final void m41390y0() {
        this.status_ = null;
    }

    /* renamed from: z0 */
    public final void m41389z0() {
