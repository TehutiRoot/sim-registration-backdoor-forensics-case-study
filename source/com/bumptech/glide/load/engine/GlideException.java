...
public final class GlideException extends Exception {
    ...
    private void printStackTrace(Appendable appendable) {
        ...
        appendCauses(getCauses(), new C5786a(appendable));
    }

    /* renamed from: com.bumptech.glide.load.engine.GlideException$a */
    /* loaded from: classes3.dex */
    public static final class C5786a implements Appendable {

        /* renamed from: a */
        public final Appendable f41957a;

        /* renamed from: b */
        public boolean f41958b = true;

        public C5786a(Appendable appendable) {
            this.f41957a = appendable;
        }

        /* renamed from: a */
        public final CharSequence m50436a(CharSequence charSequence) {
        ...
        public Appendable append(char c) {
            ...
            this.f41958b = c == '\n';
            this.f41957a.append(c);
            return this;
        }

        @Override // java.lang.Appendable
        public Appendable append(CharSequence charSequence) {
            CharSequence m50436a = m50436a(charSequence);
            return append(m50436a, 0, m50436a.length());
        }
        ...
        public Appendable append(CharSequence charSequence, int i, int i2) {
            ...
            if (m50436a.length() > 0 && m50436a.charAt(i2 - 1) == '\n') {
                z = true;
            }
            this.f41958b = z;
            this.f41957a.append(m50436a, i, i2);
            return this;
        }
    }
}
