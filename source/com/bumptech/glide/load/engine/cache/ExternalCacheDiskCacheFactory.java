...
public final class ExternalCacheDiskCacheFactory extends DiskLruCacheFactory {
    ...
    /* loaded from: classes3.dex */
    public class C5803a implements DiskLruCacheFactory.CacheDirectoryGetter {
        ...
        public C5803a(Context context, String str) {
        ...
        public File getCacheDirectory() {
            File externalCacheDir = this.f42045a.getExternalCacheDir();
            if (externalCacheDir == null) {
                return null;
            }
            if (this.f42046b != null) {
                return new File(externalCacheDir, this.f42046b);
            }
    ...
    public ExternalCacheDiskCacheFactory(Context context, String str, int i) {
        super(new C5803a(context, str), i);
    }
}
