...
public abstract class BaseGlideUrlLoader<Model> implements ModelLoader<Model, InputStream> {
    ...
    /* renamed from: a */
    public final ModelLoader f42264a;

    /* renamed from: b */
    public final ModelCache f42265b;
    ...
    /* renamed from: a */
    public static List m50257a(Collection collection) {
    ...
    public ModelLoader.LoadData<InputStream> buildLoadData(@NonNull Model model, int i, int i2, @NonNull Options options) {
        GlideUrl glideUrl;
        ModelCache modelCache = this.f42265b;
        if (modelCache != null) {
        ...
        if (glideUrl == null) {
            ...
            ModelCache modelCache2 = this.f42265b;
            if (modelCache2 != null) {
        ...
        ModelLoader.LoadData<InputStream> buildLoadData = this.f42264a.buildLoadData(glideUrl, i, i2, options);
        if (buildLoadData != null && !alternateUrls.isEmpty()) {
            return new ModelLoader.LoadData<>(buildLoadData.sourceKey, m50257a(alternateUrls), buildLoadData.fetcher);
        }
    ...
    public BaseGlideUrlLoader(ModelLoader<GlideUrl, InputStream> modelLoader, @Nullable ModelCache<Model, GlideUrl> modelCache) {
        this.f42264a = modelLoader;
        this.f42265b = modelCache;
    }
}
