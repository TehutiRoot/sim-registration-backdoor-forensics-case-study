...
public class MediaStoreImageThumbLoader implements ModelLoader<Uri, InputStream> {
    ...
    public static class Factory implements ModelLoaderFactory<Uri, InputStream> {
        ...
        public ModelLoader<Uri, InputStream> build(MultiModelLoaderFactory multiModelLoaderFactory) {
            return new MediaStoreImageThumbLoader(this.f42269a);
        }
    ...
    public MediaStoreImageThumbLoader(Context context) {
        this.f42268a = context.getApplicationContext();
    }
    ...
    public ModelLoader.LoadData<InputStream> buildLoadData(@NonNull Uri uri, int i, int i2, @NonNull Options options) {
        if (MediaStoreUtil.isThumbnailSize(i, i2)) {
            return new ModelLoader.LoadData<>(new ObjectKey(uri), ThumbFetcher.buildImageFetcher(this.f42268a, uri));
        }
        return null;
    }
