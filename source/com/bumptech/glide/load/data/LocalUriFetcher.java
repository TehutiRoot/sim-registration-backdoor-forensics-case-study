...
public abstract class LocalUriFetcher<T> implements DataFetcher<T> {
    ...
    /* renamed from: b */
    public final ContentResolver f41871b;

    /* renamed from: c */
    public Object f41872c;

    public LocalUriFetcher(ContentResolver contentResolver, Uri uri) {
        this.f41871b = contentResolver;
        this.f41870a = uri;
    }
    ...
    public final void loadData(@NonNull Priority priority, @NonNull DataFetcher.DataCallback<? super T> dataCallback) {
        try {
            T loadResource = loadResource(this.f41870a, this.f41871b);
            this.f41872c = loadResource;
