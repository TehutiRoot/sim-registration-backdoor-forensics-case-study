...
public class BitmapDrawableTranscoder implements ResourceTranscoder<Bitmap, BitmapDrawable> {
    ...
    /* renamed from: a */
    public final Resources f42464a;
    ...
    public Resource<BitmapDrawable> transcode(@NonNull Resource<Bitmap> resource, @NonNull Options options) {
        return LazyBitmapDrawableResource.obtain(this.f42464a, resource);
    }
    ...
    public BitmapDrawableTranscoder(@NonNull Resources resources) {
        this.f42464a = (Resources) Preconditions.checkNotNull(resources);
    }
}
