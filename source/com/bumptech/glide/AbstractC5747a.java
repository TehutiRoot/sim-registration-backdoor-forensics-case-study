...
public abstract class AbstractC5747a {
    ...
    /* loaded from: classes3.dex */
    public class C5748a implements GlideSuppliers.GlideSupplier {

        /* renamed from: a */
        public boolean f41753a;

        /* renamed from: b */
        public final /* synthetic */ Glide f41754b;

        /* renamed from: c */
        public final /* synthetic */ List f41755c;

        /* renamed from: d */
        public final /* synthetic */ AppGlideModule f41756d;

        public C5748a(Glide glide, List list, AppGlideModule appGlideModule) {
            this.f41754b = glide;
            this.f41755c = list;
            this.f41756d = appGlideModule;
        }
        ...
        public Registry get() {
            if (!this.f41753a) {
                ...
                this.f41753a = true;
                try {
                    return AbstractC5747a.m50579a(this.f41754b, this.f41755c, this.f41756d);
                } finally {
                    this.f41753a = false;
                    Trace.endSection();
                }
    ...
    /* renamed from: a */
    public static Registry m50579a(Glide glide, List list, AppGlideModule appGlideModule) {
        BitmapPool bitmapPool = glide.getBitmapPool();
        ArrayPool arrayPool = glide.getArrayPool();
        Context applicationContext = glide.m50624d().getApplicationContext();
        GlideExperiments experiments = glide.m50624d().getExperiments();
        Registry registry = new Registry();
        m50578b(applicationContext, registry, bitmapPool, arrayPool, experiments);
        m50577c(applicationContext, glide, registry, list, appGlideModule);
        return registry;
    }

    /* renamed from: b */
    public static void m50578b(Context context, Registry registry, BitmapPool bitmapPool, ArrayPool arrayPool, GlideExperiments glideExperiments) {
        ...
        if (i >= 28 && glideExperiments.isEnabled(GlideBuilder.C5730c.class)) {
    ...
    /* renamed from: c */
    public static void m50577c(Context context, Glide glide, Registry registry, List list, AppGlideModule appGlideModule) {
    ...
    /* renamed from: d */
    public static GlideSuppliers.GlideSupplier m50576d(Glide glide, List list, AppGlideModule appGlideModule) {
        return new C5748a(glide, list, appGlideModule);
    }
}
