...
public abstract class AbstractC18115Nh1 implements MetricInstrument {
    ...
    public AbstractC18115Nh1(int i, String str, String str2, String str3, List list, List list2, boolean z) {
        this.index = i;
        this.name = str;
