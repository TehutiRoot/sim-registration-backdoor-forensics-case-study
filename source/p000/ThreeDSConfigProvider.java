...
public final class ThreeDSConfigProvider {
    ...
    public final Object getThreeDSConfigs(@NotNull Continuation<? super NetceteraConfig> continuation) {
        return this.f6080b.send(new NetceteraConfig.NetceteraConfigRequestBuilder().configUrl(createThreeDSConfigUrl(this.f6079a.getAuthorizedURLString())).build(), continuation);
    }
}
