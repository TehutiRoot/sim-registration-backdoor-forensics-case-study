...
public final class C20082gi1 {

    /* renamed from: a */
    public static final C20082gi1 f62234a = new C20082gi1();

    /* renamed from: b */
    public static final Path f62235b;

    /* renamed from: c */
    public static final Path f62236c;
    ...
    /* renamed from: a */
    public final Path m31058a(Path path, Path base) {
        Path normalize;
        Path normalize2;
        Path relativize;
        int nameCount;
        ...
        if (Intrinsics.areEqual(normalize2, normalize) || !Intrinsics.areEqual(normalize, f62235b)) {
            String obj = relativize.toString();
            fileSystem = relativize.getFileSystem();
            separator = fileSystem.getSeparator();
            Intrinsics.checkNotNullExpressionValue(separator, "getSeparator(...)");
            if (AbstractC20204hN1.endsWith$default(obj, separator, false, 2, null)) {
