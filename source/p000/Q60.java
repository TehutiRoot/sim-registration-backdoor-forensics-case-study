...
public abstract class Q60 {
    /* renamed from: a */
    public static C1148a m66682a(C1148a c1148a, int i, int i2, boolean z, int i3) {
        if (c1148a != null) {
            return c1148a;
        }
        if (z) {
            return new C1148a(i, i3, i2);
        }
        return new C1148a(i, i2);
    }

    /* renamed from: b */
    public static Shader m66681b(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        if (name.equals("gradient")) {
            ...
            C1148a m66682a = m66682a(m66680c(resources, xmlPullParser, attributeSet, theme), namedColor, namedColor3, hasAttribute, namedColor2);
            if (namedInt != 1) {
                if (namedInt != 2) {
                    return new LinearGradient(namedFloat, namedFloat2, namedFloat3, namedFloat4, m66682a.f4958a, m66682a.f4959b, m66679d(namedInt2));
                }
                return new SweepGradient(namedFloat5, namedFloat6, m66682a.f4958a, m66682a.f4959b);
            } else if (namedFloat7 > 0.0f) {
                return new RadialGradient(namedFloat5, namedFloat6, namedFloat7, m66682a.f4958a, m66682a.f4959b, m66679d(namedInt2));
            } else {
    ...
    */
    public static p000.Q60.C1148a m66680c(android.content.res.Resources r8, org.xmlpull.v1.XmlPullParser r9, android.util.AttributeSet r10, android.content.res.Resources.Theme r11) {
        /*
            int r0 = r9.getDepth()
            r1 = 1
            int r0 = r0 + r1
        ...
        L91:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.Q60.m66680c(android.content.res.Resources, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet, android.content.res.Resources$Theme):Q60$a");
    }

    /* renamed from: d */
    public static Shader.TileMode m66679d(int i) {
        if (i != 1) {
            if (i != 2) {
    ...
    public static final class C1148a {
        ...
        public C1148a(List list, List list2) {
            int size = list.size();
            this.f4958a = new int[size];
            this.f4959b = new float[size];
            for (int i = 0; i < size; i++) {
                this.f4958a[i] = ((Integer) list.get(i)).intValue();
                this.f4959b[i] = ((Float) list2.get(i)).floatValue();
            }
        }

        public C1148a(int i, int i2) {
            this.f4958a = new int[]{i, i2};
            this.f4959b = new float[]{0.0f, 1.0f};
        }

        public C1148a(int i, int i2, int i3) {
            this.f4958a = new int[]{i, i2, i3};
            this.f4959b = new float[]{0.0f, 0.5f, 1.0f};
        }
    }
}
