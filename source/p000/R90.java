...
public abstract /* synthetic */ class R90 {
    /* renamed from: a */
    public static FileVisitResult m66494a(IOFileFilter iOFileFilter, Path path, BasicFileAttributes basicFileAttributes) {
        boolean z;
        File file;
        if (path != null) {
            file = path.toFile();
    ...
    /* renamed from: b */
    public static IOFileFilter m66493b(IOFileFilter iOFileFilter, IOFileFilter iOFileFilter2) {
        return new AndFileFilter(iOFileFilter, iOFileFilter2);
    }

    /* renamed from: c */
    public static boolean m66492c(IOFileFilter iOFileFilter, Path path) {
    ...
    /* renamed from: d */
    public static IOFileFilter m66491d(IOFileFilter iOFileFilter) {
        return new NotFileFilter(iOFileFilter);
    }

    /* renamed from: e */
    public static IOFileFilter m66490e(IOFileFilter iOFileFilter, IOFileFilter iOFileFilter2) {
