...
public class C22939xH1 extends BG1 {
    public C22939xH1(BaseRealm baseRealm, OsSet osSet, Class cls) {
    ...
    public boolean mo588F(Object obj) {
        return this.f340b.remove((Short) obj);
    }
    ...
    @Override // p000.BG1
    /* renamed from: K */
    public boolean mo585a(Short sh) {
        return this.f340b.add(sh);
    }
