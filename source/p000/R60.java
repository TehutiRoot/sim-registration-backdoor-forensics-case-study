...
public abstract class R60 {
    ...
    /* renamed from: a */
    public static final JsonReader.Options f5267a = JsonReader.Options.m50685of("nm", OperatorName.NON_STROKING_GRAY, "o", "t", OperatorName.CLOSE_AND_STROKE, "e", PDPageLabelRange.STYLE_ROMAN_LOWER, "hd");

    /* renamed from: b */
    public static final JsonReader.Options f5268b = JsonReader.Options.m50685of("p", OperatorName.NON_STROKING_CMYK);

    /* renamed from: a */
    public static GradientFill m66503a(JsonReader jsonReader, LottieComposition lottieComposition) {
        ...
        while (jsonReader.hasNext()) {
            switch (jsonReader.selectName(f5267a)) {
                case 0:
                ...
                case 1:
                    ...
                    int i = -1;
                    while (jsonReader.hasNext()) {
                        int selectName = jsonReader.selectName(f5268b);
                        if (selectName != 0) {
                            if (selectName != 1) {
                                jsonReader.skipName();
                                jsonReader.skipValue();
                            } else {
                                animatableGradientColorValue = AnimatableValueParser.m50706e(jsonReader, lottieComposition, i);
                            }
                        } else {
