...
public abstract class AbstractC18132Nn1 extends Sampler {
    /* renamed from: a */
    public static AbstractC18132Nn1 m67173a(double d) {
        boolean z;
        long j;
        ...
        return new C0923N8(d, j);
    }

    /* renamed from: b */
    public abstract long mo67172b();

    /* renamed from: c */
    public abstract double mo67171c();

    @Override // io.opencensus.trace.Sampler
    public final String getDescription() {
        return String.format("ProbabilitySampler{%.6f}", Double.valueOf(mo67171c()));
    }
    ...
    public final boolean shouldSample(SpanContext spanContext, Boolean bool, TraceId traceId, SpanId spanId, String str, List list) {
        ...
        if (Math.abs(traceId.getLowerLong()) < mo67172b()) {
            return true;
        }
        return false;
    }
