...
public abstract class AbstractC22173sr1 {
    protected static final String POSTFIX = "?=";
    protected static final String PREFIX = "=?";
    protected static final char SEP = '?';
    protected final Charset charset;

    public AbstractC22173sr1(Charset charset) {
    ...
    public String encodeText(String str, String str2) throws EncoderException {
        if (str == null) {
            return null;
        }
