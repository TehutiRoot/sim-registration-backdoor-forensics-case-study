...
public abstract class AbstractC20204hN1 extends AbstractC20032gN1 {
    ...
    public static int compareTo(@NotNull String str, @NotNull String other, boolean z) {
        Intrinsics.checkNotNullParameter(str, "<this>");
    ...
    public static boolean isBlank(@NotNull CharSequence charSequence) {
        ...
        if (charSequence.length() != 0) {
            ...
            if (!(indices instanceof Collection) || !((Collection) indices).isEmpty()) {
                ...
                while (it.hasNext()) {
                    if (!AbstractC12026a.isWhitespace(charSequence.charAt(((IntIterator) it).nextInt()))) {
                        return false;
                    }
                }
            }
    ...
    public static final String replace(@NotNull String str, char c, char c2, boolean z) {
        ...
        for (int i = 0; i < str.length(); i++) {
            ...
            if (AbstractC5403bp.equals(charAt, c, z)) {
                charAt = c2;
            }
            sb.append(charAt);
        }
    ...
    @NotNull
    public static String replaceFirst(@NotNull String str, @NotNull String oldValue, @NotNull String newValue, boolean z) {
        Intrinsics.checkNotNullParameter(str, "<this>");
    ...
    @NotNull
    public static String replace(@NotNull String str, @NotNull String oldValue, @NotNull String newValue, boolean z) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        Intrinsics.checkNotNullParameter(oldValue, "oldValue");
        Intrinsics.checkNotNullParameter(newValue, "newValue");
        int i = 0;
        ...
        int coerceAtLeast = AbstractC11719c.coerceAtLeast(length, 1);
