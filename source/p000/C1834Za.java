...
public class C1834Za {
    ...
    public C1834Za(Float f, boolean z) {
        this.f8058b = z;
        this.f8057a = f;
    }

    /* renamed from: a */
    public static C1834Za m65220a(Context context) {
        boolean z = false;
        Float f = null;
        try {
            ...
            Logger.getLogger().m39137e("An error occurred getting battery state.", e);
        }
        return new C1834Za(f, z);
    }
    ...
    public int m65218c() {
        Float f;
        if (this.f8058b && (f = this.f8057a) != null) {
