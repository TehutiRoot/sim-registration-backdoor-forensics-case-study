...
public abstract class KB2 {
    ...
    /* renamed from: a */
    public static final zzv f3136a = zzv.zza("\n");

    /* renamed from: b */
    public static final Comparator f3137b = new Comparator() { // from class: com.google.mlkit.vision.text.internal.zzf
        @Override // java.util.Comparator
        public final int compare(Object obj, Object obj2) {
            zzv zzvVar = KB2.f3136a;
            return ((Integer) ((Map.Entry) obj).getValue()).compareTo((Integer) ((Map.Entry) obj2).getValue());
        }
    };

    /* renamed from: a */
    public static Text m67632a(zzl[] zzlVarArr, final Matrix matrix) {
        int i = 1;
        ...
        while (i3 < sparseArray.size()) {
            ...
            List zza = zzbu.zza(zzb, new zzu() { // from class: com.google.mlkit.vision.text.internal.zzh
                ...
                public final Object zza(Object obj) {
                    ...
                    zzv zzvVar = KB2.f3136a;
                    List m30852b = AbstractC20231ha2.m30852b(zzlVar2.zzb);
                    ...
                    String str3 = str;
                    Rect m30853a = AbstractC20231ha2.m30853a(m30852b);
                    ...
                    return new Text.Line(str3, m30853a, m30852b, str4, matrix2, zzbu.zza(Arrays.asList(zzlVar2.zza), new zzu() { // from class: com.google.mlkit.vision.text.internal.zzj
                        @Override // com.google.android.gms.internal.mlkit_vision_text_common.zzu
                        public final Object zza(Object obj2) {
                            ...
                            zzv zzvVar2 = KB2.f3136a;
                            List m30852b2 = AbstractC20231ha2.m30852b(zzrVar.zzb);
                            ...
                            String str7 = str5;
                            Rect m30853a2 = AbstractC20231ha2.m30853a(m30852b2);
                            if (zzy.zzb(zzrVar.zzf)) {
                                str6 = "und";
                            } else {
                                str6 = zzrVar.zzf;
                            }
                            return new Text.Element(str7, m30853a2, m30852b2, str6, matrix2, zzrVar.zze, zzrVar.zzb.zze, zzbk.zzh());
                        }
            ...
            zzbhVar4.zza(new Text.TextBlock(f3136a.zzb(zzbu.zza(list2, new zzu() { // from class: com.google.mlkit.vision.text.internal.zzi
                @Override // com.google.android.gms.internal.mlkit_vision_text_common.zzu
                public final Object zza(Object obj) {
                    return ((Text.Line) obj).getText();
                }
            })), AbstractC20231ha2.m30853a(asList), asList, m67631b(list2), matrix, list2));
            i3 = i15 + 1;
            zzbhVar = zzbhVar4;
        ...
        return new Text(f3136a.zzb(zzbu.zza(zzb2, new zzu() { // from class: com.google.mlkit.vision.text.internal.zzg
            @Override // com.google.android.gms.internal.mlkit_vision_text_common.zzu
            public final Object zza(Object obj) {
    ...
    /* renamed from: b */
    public static String m67631b(List list) {
        int i;
        ...
        if (!entrySet.isEmpty()) {
            String str = (String) ((Map.Entry) Collections.max(entrySet, f3137b)).getKey();
            if (!zzy.zzb(str)) {
                return str;
            }
            return "und";
