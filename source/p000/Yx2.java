...
public final class Yx2 implements ObjectEncoder {
    ...
    /* renamed from: a */
    public static final Yx2 f7918a = new Yx2();

    /* renamed from: b */
    public static final FieldDescriptor f7919b;

    /* renamed from: c */
    public static final FieldDescriptor f7920c;

    static {
        FieldDescriptor.Builder builder = FieldDescriptor.builder("maxResults");
        zzfc zzfcVar = new zzfc();
        zzfcVar.zza(1);
        f7919b = builder.withProperty(zzfcVar.zzb()).build();
        FieldDescriptor.Builder builder2 = FieldDescriptor.builder("modelType");
        zzfc zzfcVar2 = new zzfc();
        zzfcVar2.zza(2);
        f7920c = builder2.withProperty(zzfcVar2.zzb()).build();
    }
