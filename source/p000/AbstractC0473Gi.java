...
public abstract class AbstractC0473Gi {
    ...
    public static class C0474a {
        @DoNotInline
        /* renamed from: a */
        public static CaptureRequest.Builder m68213a(@NonNull CameraDevice cameraDevice, @NonNull TotalCaptureResult totalCaptureResult) throws CameraAccessException {
            return cameraDevice.createReprocessCaptureRequest(totalCaptureResult);
        }
    }

    /* renamed from: a */
    public static void m68218a(CaptureConfig captureConfig, CaptureRequest.Builder builder) {
    ...
    /* renamed from: b */
    public static void m68217b(CaptureRequest.Builder builder, Config config) {
        ...
        for (Config.Option option : build.listOptions()) {
            ...
            try {
                ...
                Logger.m63228e("Camera2CaptureRequestBuilder", "CaptureRequest.Key is not supported: " + key);
            }
        }
    }

    /* renamed from: c */
    public static CaptureRequest m68216c(CaptureConfig captureConfig, CameraDevice cameraDevice, Map map) {
        CaptureRequest.Builder createCaptureRequest;
        if (cameraDevice == null) {
            return null;
        }
        List<Surface> m68214e = m68214e(captureConfig.getSurfaces(), map);
        if (m68214e.isEmpty()) {
            return null;
        }
        ...
        if (Build.VERSION.SDK_INT >= 23 && captureConfig.getTemplateType() == 5 && cameraCaptureResult != null && (cameraCaptureResult.getCaptureResult() instanceof TotalCaptureResult)) {
            Logger.m63230d("Camera2CaptureRequestBuilder", "createReprocessCaptureRequest");
            createCaptureRequest = C0474a.m68213a(cameraDevice, (TotalCaptureResult) cameraCaptureResult.getCaptureResult());
        } else {
            Logger.m63230d("Camera2CaptureRequestBuilder", "createCaptureRequest");
            createCaptureRequest = cameraDevice.createCaptureRequest(captureConfig.getTemplateType());
        }
        m68217b(createCaptureRequest, captureConfig.getImplementationOptions());
        m68218a(captureConfig, createCaptureRequest);
    ...
    /* renamed from: d */
    public static CaptureRequest m68215d(CaptureConfig captureConfig, CameraDevice cameraDevice) {
        if (cameraDevice == null) {
            return null;
        }
    ...
    /* renamed from: e */
    public static List m68214e(List list, Map map) {
