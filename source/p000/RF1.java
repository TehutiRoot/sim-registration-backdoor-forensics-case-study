...
public abstract /* synthetic */ class RF1 {
    /* renamed from: a */
    public static final KSerializer m66487a(SerializersModule serializersModule, GenericArrayType genericArrayType, boolean z) {
    ...
    /* renamed from: b */
    public static final Class m66486b(Type type) {
    ...
    /* renamed from: c */
    public static final KSerializer m66485c(SerializersModule serializersModule, Class cls, List list) {
    ...
    /* renamed from: d */
    public static final KSerializer m66484d(Type type) {
        Intrinsics.checkNotNullParameter(type, "type");
        return SerializersKt.serializer(SerializersModuleBuildersKt.EmptySerializersModule(), type);
    }

    /* renamed from: e */
    public static final KSerializer m66483e(SerializersModule serializersModule, Type type) {
        Intrinsics.checkNotNullParameter(serializersModule, "<this>");
        Intrinsics.checkNotNullParameter(type, "type");
        KSerializer m66482f = m66482f(serializersModule, type, true);
        if (m66482f != null) {
            return m66482f;
        }
        PlatformKt.serializerNotRegistered(m66486b(type));
        throw new KotlinNothingValueException();
    }

    /* renamed from: f */
    public static final KSerializer m66482f(SerializersModule serializersModule, Type type, boolean z) {
        ArrayList<KSerializer> arrayList;
        if (type instanceof GenericArrayType) {
            return m66487a(serializersModule, (GenericArrayType) type, z);
        }
        if (type instanceof Class) {
            return m66478j(serializersModule, (Class) type, z);
        }
        if (type instanceof ParameterizedType) {
            ...
            if (Set.class.isAssignableFrom(cls)) {
                ...
                if (Map.class.isAssignableFrom(cls)) {
                    ...
                    return m66485c(serializersModule, cls, arrayList2);
                }
            } else {
            ...
            Object first = ArraysKt___ArraysKt.first(upperBounds);
            Intrinsics.checkNotNullExpressionValue(first, "first(...)");
            return m66481g(serializersModule, (Type) first, false, 2, null);
        } else {
            throw new IllegalArgumentException("type should be an instance of Class<?>, GenericArrayType, ParametrizedType or WildcardType, but actual argument " + type + " has type " + Reflection.getOrCreateKotlinClass(type.getClass()));
        }
    }
    ...
    /* renamed from: g */
    public static /* synthetic */ KSerializer m66481g(SerializersModule serializersModule, Type type, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return m66482f(serializersModule, type, z);
    }

    /* renamed from: h */
    public static final KSerializer m66480h(Type type) {
        Intrinsics.checkNotNullParameter(type, "type");
        return SerializersKt.serializerOrNull(SerializersModuleBuildersKt.EmptySerializersModule(), type);
    }

    /* renamed from: i */
    public static final KSerializer m66479i(SerializersModule serializersModule, Type type) {
        Intrinsics.checkNotNullParameter(serializersModule, "<this>");
        Intrinsics.checkNotNullParameter(type, "type");
        return m66482f(serializersModule, type, false);
    }

    /* renamed from: j */
    public static final KSerializer m66478j(SerializersModule serializersModule, Class cls, boolean z) {
        KSerializer<Object> serializerOrNull;
        ...
        return m66485c(serializersModule, cls, CollectionsKt__CollectionsKt.emptyList());
    }
}
