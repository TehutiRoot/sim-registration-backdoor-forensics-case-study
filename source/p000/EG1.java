...
public abstract class EG1 extends DG1 {
    @NotNull
    public static <T> Set<T> minus(@NotNull Set<? extends T> set, T t) {
        Intrinsics.checkNotNullParameter(set, "<this>");
        LinkedHashSet linkedHashSet = new LinkedHashSet(AbstractC18515Tn0.mapCapacity(set.size()));
        boolean z = false;
        for (T t2 : set) {
            boolean z2 = true;
    ...
    public static <T> Set<T> plus(@NotNull Set<? extends T> set, T t) {
        Intrinsics.checkNotNullParameter(set, "<this>");
        LinkedHashSet linkedHashSet = new LinkedHashSet(AbstractC18515Tn0.mapCapacity(set.size() + 1));
    ...
    public static final <T> Set<T> plus(@NotNull Set<? extends T> set, @NotNull T[] elements) {
        ...
        LinkedHashSet linkedHashSet = new LinkedHashSet(AbstractC18515Tn0.mapCapacity(set.size() + elements.length));
        linkedHashSet.addAll(set);
        AbstractC10410hs.addAll(linkedHashSet, elements);
        return linkedHashSet;
    }
    ...
    public static final <T> Set<T> minus(@NotNull Set<? extends T> set, @NotNull T[] elements) {
        ...
        AbstractC10410hs.removeAll(linkedHashSet, elements);
        return linkedHashSet;
    }
    ...
    public static <T> Set<T> plus(@NotNull Set<? extends T> set, @NotNull Iterable<? extends T> elements) {
        ...
        Intrinsics.checkNotNullParameter(set, "<this>");
        Intrinsics.checkNotNullParameter(elements, "elements");
        Integer collectionSizeOrNull = AbstractC10176es.collectionSizeOrNull(elements);
        if (collectionSizeOrNull != null) {
            size = set.size() + collectionSizeOrNull.intValue();
        } else {
            size = set.size() * 2;
        }
        LinkedHashSet linkedHashSet = new LinkedHashSet(AbstractC18515Tn0.mapCapacity(size));
        linkedHashSet.addAll(set);
        AbstractC10410hs.addAll(linkedHashSet, elements);
        return linkedHashSet;
    }
    ...
    public static final <T> Set<T> plus(@NotNull Set<? extends T> set, @NotNull Sequence<? extends T> elements) {
        Intrinsics.checkNotNullParameter(set, "<this>");
        Intrinsics.checkNotNullParameter(elements, "elements");
        LinkedHashSet linkedHashSet = new LinkedHashSet(AbstractC18515Tn0.mapCapacity(set.size() * 2));
        linkedHashSet.addAll(set);
        AbstractC10410hs.addAll(linkedHashSet, elements);
        return linkedHashSet;
    }
