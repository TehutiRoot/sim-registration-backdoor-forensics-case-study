...
public abstract class AbstractC0821Li {
    /* renamed from: a */
    public static InterfaceC0757Ki m67501a(Camera2OutputConfigImpl camera2OutputConfigImpl) {
        ...
        if (camera2OutputConfigImpl.getSurfaceSharingOutputConfigs() != null) {
            for (Camera2OutputConfigImpl camera2OutputConfigImpl2 : camera2OutputConfigImpl.getSurfaceSharingOutputConfigs()) {
                arrayList.add(m67501a(camera2OutputConfigImpl2));
            }
        }
        if (camera2OutputConfigImpl instanceof SurfaceOutputConfigImpl) {
            ...
            return SurfaceOutputConfig.m62571a(surfaceOutputConfigImpl.getId(), surfaceOutputConfigImpl.getSurfaceGroupId(), surfaceOutputConfigImpl.getPhysicalCameraId(), arrayList, surfaceOutputConfigImpl.getSurface());
            ...
            return ImageReaderOutputConfig.m62579a(imageReaderOutputConfigImpl.getId(), imageReaderOutputConfigImpl.getSurfaceGroupId(), imageReaderOutputConfigImpl.getPhysicalCameraId(), arrayList, imageReaderOutputConfigImpl.getSize(), imageReaderOutputConfigImpl.getImageFormat(), imageReaderOutputConfigImpl.getMaxImages());
            ...
            return MultiResolutionImageReaderOutputConfig.m62577a(multiResolutionImageReaderOutputConfigImpl.getId(), multiResolutionImageReaderOutputConfigImpl.getSurfaceGroupId(), multiResolutionImageReaderOutputConfigImpl.getPhysicalCameraId(), arrayList, multiResolutionImageReaderOutputConfigImpl.getImageFormat(), multiResolutionImageReaderOutputConfigImpl.getMaxImages());
        } else {
