...
public final class RealmObservable {
    ...
    @NotNull
    public final Observable<Boolean> call(@NotNull RealmConfiguration configuration, @NotNull final Consumer<Realm> function) {
