...
public final class District {
    ...
    public static /* synthetic */ District copy$default(District district, long j, String str, String str2, long j2, int i, Object obj) {
        ...
        long j3 = j;
        if ((i & 2) != 0) {
            str = district.f83483b;
        }
        String str3 = str;
        if ((i & 4) != 0) {
            str2 = district.f83484c;
        }
        String str4 = str2;
        if ((i & 8) != 0) {
            j2 = district.f83485d;
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof District) {
            ...
            return this.f83482a == district.f83482a && Intrinsics.areEqual(this.f83483b, district.f83483b) && Intrinsics.areEqual(this.f83484c, district.f83484c) && this.f83485d == district.f83485d;
        }
        return false;
    }
    ...
    public int hashCode() {
        int m67882a = AbstractC17792Ig1.m67882a(this.f83482a) * 31;
        String str = this.f83483b;
        int hashCode = (m67882a + (str == null ? 0 : str.hashCode())) * 31;
        String str2 = this.f83484c;
        return ((hashCode + (str2 != null ? str2.hashCode() : 0)) * 31) + AbstractC17792Ig1.m67882a(this.f83485d);
    }
