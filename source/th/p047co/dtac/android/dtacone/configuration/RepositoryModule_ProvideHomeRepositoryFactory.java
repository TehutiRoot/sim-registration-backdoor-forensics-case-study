...
public final class RepositoryModule_ProvideHomeRepositoryFactory implements Factory<HomeRepository> {
    ...
    /* renamed from: a */
    public final RepositoryModule f83192a;

    /* renamed from: b */
    public final Provider f83193b;

    /* renamed from: c */
    public final Provider f83194c;

    /* renamed from: d */
    public final Provider f83195d;

    /* renamed from: e */
    public final Provider f83196e;

    /* renamed from: f */
    public final Provider f83197f;
    ...
    public RepositoryModule_ProvideHomeRepositoryFactory(RepositoryModule repositoryModule, Provider<RTRApiRx2> provider, Provider<OneCampaignApi> provider2, Provider<RtrRx2Repository> provider3, Provider<TemporaryCache> provider4, Provider<PreferencesViewModel> provider5) {
        this.f83192a = repositoryModule;
        this.f83193b = provider;
        this.f83194c = provider2;
        this.f83195d = provider3;
        this.f83196e = provider4;
        this.f83197f = provider5;
    }
    ...
    public HomeRepository get() {
        return provideHomeRepository(this.f83192a, (RTRApiRx2) this.f83193b.get(), (OneCampaignApi) this.f83194c.get(), (RtrRx2Repository) this.f83195d.get(), (TemporaryCache) this.f83196e.get(), (PreferencesViewModel) this.f83197f.get());
    }
}
