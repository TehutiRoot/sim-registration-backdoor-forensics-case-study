...
public final class RoomModule_ProvideSubDistrictDaoFactory implements Factory<SubDistrictDao> {
    ...
    public SubDistrictDao get() {
        return provideSubDistrictDao(this.f83213a, (RoomLocationDatabase) this.f83214b.get());
    }
}
