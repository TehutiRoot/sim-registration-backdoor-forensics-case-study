...
@Metadata(m28851d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\b\u0007\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0003J\u0010\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0002H\u0016¨\u0006\u0007"}, m28850d2 = {"Lth/co/dtac/android/dtacone/app_one/util/validation/OneForgotPasswordRule;", "Lth/co/dtac/android/dtacone/util/validation/ValidationRule;", "Lth/co/dtac/android/dtacone/app_one/util/model/OneForgotPassword;", "()V", "validate", "", "value", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
/* renamed from: th.co.dtac.android.dtacone.app_one.util.validation.OneForgotPasswordRule */
/* loaded from: classes7.dex */
public final class OneForgotPasswordRule implements ValidationRule<OneForgotPassword> {
    public static final int $stable = 0;

    @Override // th.p047co.dtac.android.dtacone.util.validation.ValidationRule
    public void validate(@NotNull OneForgotPassword value) {
        Intrinsics.checkNotNullParameter(value, "value");
        String verifyOTP = value.getVerifyOTP();
        if (verifyOTP != null && verifyOTP.length() != 0) {
            String verifyOTP2 = value.getVerifyOTP();
            boolean z = false;
            int length = verifyOTP2 != null ? verifyOTP2.length() : 0;
            if (length == 0) {
                throw new ValidatedRuleException(R.string.one_forgot_validate_empty_otp_input);
            }
            if (length == 4) {
            ...
            throw new ValidatedRuleException(R.string.one_regis_4_otp);
        }
        throw new ValidatedRuleException(R.string.mnp_otp_verify_please_enter_otp);
    }
}
