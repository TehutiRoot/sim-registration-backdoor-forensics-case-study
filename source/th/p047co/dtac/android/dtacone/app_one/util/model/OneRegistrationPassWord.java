...
public final class OneRegistrationPassWord {
    ...
    public static /* synthetic */ OneRegistrationPassWord copy$default(OneRegistrationPassWord oneRegistrationPassWord, String str, String str2, int i, Object obj) {
        if ((i & 1) != 0) {
            str = oneRegistrationPassWord.f82417a;
        }
        if ((i & 2) != 0) {
            str2 = oneRegistrationPassWord.f82418b;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof OneRegistrationPassWord) {
            ...
            return Intrinsics.areEqual(this.f82417a, oneRegistrationPassWord.f82417a) && Intrinsics.areEqual(this.f82418b, oneRegistrationPassWord.f82418b);
        }
        return false;
    }
