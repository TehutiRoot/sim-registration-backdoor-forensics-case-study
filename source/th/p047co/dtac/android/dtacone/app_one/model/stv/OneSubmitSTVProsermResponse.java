...
public final class OneSubmitSTVProsermResponse implements Parcelable {
    ...
    /* renamed from: d */
    private final String f82250d;
    @SerializedName("data")
    @Nullable

    /* renamed from: e */
    private final Data f82251e;
    @SerializedName("replaceMessage")
    @Nullable

    /* renamed from: f */
    private final List<String> f82252f;
    @SerializedName("desc")
    @Nullable

    /* renamed from: g */
    private final String f82253g;
    ...
    public static final class Data implements Parcelable {
        ...
        /* renamed from: d */
        private final String f82257d;
        @SerializedName("trackingId")
        @Nullable

        /* renamed from: e */
        private final String f82258e;
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            if (obj instanceof Data) {
                Data data = (Data) obj;
                return Intrinsics.areEqual(this.f82254a, data.f82254a) && Intrinsics.areEqual(this.f82255b, data.f82255b) && Intrinsics.areEqual(this.f82256c, data.f82256c) && Intrinsics.areEqual(this.f82257d, data.f82257d) && Intrinsics.areEqual(this.f82258e, data.f82258e);
            }
            return false;
        }
        ...
        public int hashCode() {
            ...
            String str2 = this.f82255b;
            int hashCode2 = (hashCode + (str2 == null ? 0 : str2.hashCode())) * 31;
            String str3 = this.f82256c;
            int hashCode3 = (hashCode2 + (str3 == null ? 0 : str3.hashCode())) * 31;
            String str4 = this.f82257d;
            int hashCode4 = (hashCode3 + (str4 == null ? 0 : str4.hashCode())) * 31;
            String str5 = this.f82258e;
        ...
        public void writeToParcel(@NotNull Parcel out, int i) {
            ...
            out.writeString(this.f82257d);
            out.writeString(this.f82258e);
        }
    ...
    public static /* synthetic */ OneSubmitSTVProsermResponse copy$default(OneSubmitSTVProsermResponse oneSubmitSTVProsermResponse, String str, String str2, String str3, String str4, Data data, List list, String str5, int i, Object obj) {
        if ((i & 1) != 0) {
            str = oneSubmitSTVProsermResponse.f82247a;
        }
        if ((i & 2) != 0) {
            str2 = oneSubmitSTVProsermResponse.f82248b;
        }
        String str6 = str2;
        if ((i & 4) != 0) {
            str3 = oneSubmitSTVProsermResponse.f82249c;
        }
        String str7 = str3;
        if ((i & 8) != 0) {
            str4 = oneSubmitSTVProsermResponse.f82250d;
        }
        String str8 = str4;
        if ((i & 16) != 0) {
            data = oneSubmitSTVProsermResponse.f82251e;
        }
        Data data2 = data;
        List<String> list2 = list;
        if ((i & 32) != 0) {
            list2 = oneSubmitSTVProsermResponse.f82252f;
        }
        List list3 = list2;
        if ((i & 64) != 0) {
            str5 = oneSubmitSTVProsermResponse.f82253g;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof OneSubmitSTVProsermResponse) {
            ...
            return Intrinsics.areEqual(this.f82247a, oneSubmitSTVProsermResponse.f82247a) && Intrinsics.areEqual(this.f82248b, oneSubmitSTVProsermResponse.f82248b) && Intrinsics.areEqual(this.f82249c, oneSubmitSTVProsermResponse.f82249c) && Intrinsics.areEqual(this.f82250d, oneSubmitSTVProsermResponse.f82250d) && Intrinsics.areEqual(this.f82251e, oneSubmitSTVProsermResponse.f82251e) && Intrinsics.areEqual(this.f82252f, oneSubmitSTVProsermResponse.f82252f) && Intrinsics.areEqual(this.f82253g, oneSubmitSTVProsermResponse.f82253g);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode = (str == null ? 0 : str.hashCode()) * 31;
        String str2 = this.f82248b;
        int hashCode2 = (hashCode + (str2 == null ? 0 : str2.hashCode())) * 31;
        String str3 = this.f82249c;
        int hashCode3 = (hashCode2 + (str3 == null ? 0 : str3.hashCode())) * 31;
        String str4 = this.f82250d;
        int hashCode4 = (hashCode3 + (str4 == null ? 0 : str4.hashCode())) * 31;
        Data data = this.f82251e;
        int hashCode5 = (hashCode4 + (data == null ? 0 : data.hashCode())) * 31;
        List<String> list = this.f82252f;
        int hashCode6 = (hashCode5 + (list == null ? 0 : list.hashCode())) * 31;
        String str5 = this.f82253g;
    ...
    public void writeToParcel(@NotNull Parcel out, int i) {
        Intrinsics.checkNotNullParameter(out, "out");
        out.writeString(this.f82247a);
        out.writeString(this.f82248b);
        out.writeString(this.f82249c);
        out.writeString(this.f82250d);
        Data data = this.f82251e;
        if (data == null) {
            out.writeInt(0);
        } else {
        ...
        out.writeStringList(this.f82252f);
        out.writeString(this.f82253g);
    }
