...
public final class StvProsermOnline {
    ...
    /* renamed from: a */
    public OneStvRecommendPackageResp f82294a;

    /* renamed from: b */
    public String f82295b;

    /* renamed from: c */
    public BalanceResponse f82296c;

    /* renamed from: d */
    public SimRCollectionResponse f82297d;

    /* renamed from: e */
    public String f82298e;
    ...
    public static /* synthetic */ StvProsermOnline copy$default(StvProsermOnline stvProsermOnline, OneStvRecommendPackageResp oneStvRecommendPackageResp, String str, BalanceResponse balanceResponse, SimRCollectionResponse simRCollectionResponse, String str2, int i, Object obj) {
        if ((i & 1) != 0) {
            oneStvRecommendPackageResp = stvProsermOnline.f82294a;
        }
        if ((i & 2) != 0) {
            str = stvProsermOnline.f82295b;
        }
        String str3 = str;
        if ((i & 4) != 0) {
            balanceResponse = stvProsermOnline.f82296c;
        }
        BalanceResponse balanceResponse2 = balanceResponse;
        if ((i & 8) != 0) {
            simRCollectionResponse = stvProsermOnline.f82297d;
        }
        SimRCollectionResponse simRCollectionResponse2 = simRCollectionResponse;
        if ((i & 16) != 0) {
            str2 = stvProsermOnline.f82298e;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof StvProsermOnline) {
            ...
            return Intrinsics.areEqual(this.f82294a, stvProsermOnline.f82294a) && Intrinsics.areEqual(this.f82295b, stvProsermOnline.f82295b) && Intrinsics.areEqual(this.f82296c, stvProsermOnline.f82296c) && Intrinsics.areEqual(this.f82297d, stvProsermOnline.f82297d) && Intrinsics.areEqual(this.f82298e, stvProsermOnline.f82298e);
        }
        return false;
    }
