...
public final class PackagesItem {
    ...
    /* renamed from: d */
    private final String f82269d;
    @SerializedName("ussdCode")
    @Nullable

    /* renamed from: e */
    private final String f82270e;
    @SerializedName(MessageBundle.TITLE_ENTRY)
    @Nullable

    /* renamed from: f */
    private final String f82271f;
    @SerializedName("descriptions")
    @Nullable

    /* renamed from: g */
    private final List<String> f82272g;
    @SerializedName("commissionValue")
    @Nullable

    /* renamed from: h */
    private final Double f82273h;
    @SerializedName("poqItemProductOfferingId")
    @Nullable

    /* renamed from: i */
    private final String f82274i;
    @SerializedName(FirebaseAnalytics.Param.PRICE)
    @Nullable

    /* renamed from: j */
    private final String f82275j;
    @SerializedName("poqItemId")
    @Nullable

    /* renamed from: k */
    private final String f82276k;
    @SerializedName("name")
    @Nullable

    /* renamed from: l */
    private final String f82277l;
    @SerializedName("typeImage")
    @Nullable

    /* renamed from: m */
    private final String f82278m;
    @SerializedName("commission")
    @Nullable

    /* renamed from: n */
    private final String f82279n;
    @SerializedName("validity")
    @Nullable

    /* renamed from: o */
    private final String f82280o;
    @SerializedName("commissionColor")
    @Nullable

    /* renamed from: p */
    private final String f82281p;
    @SerializedName("net")
    @Nullable

    /* renamed from: q */
    private final String f82282q;
    @SerializedName("priceLabel")
    @Nullable

    /* renamed from: r */
    private final String f82283r;
    @SerializedName("seq")
    @Nullable

    /* renamed from: s */
    private final Integer f82284s;
    @SerializedName("categoryId")
    @Nullable

    /* renamed from: t */
    private final String f82285t;
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof PackagesItem) {
            ...
            return Intrinsics.areEqual(this.f82266a, packagesItem.f82266a) && Intrinsics.areEqual(this.f82267b, packagesItem.f82267b) && Intrinsics.areEqual(this.f82268c, packagesItem.f82268c) && Intrinsics.areEqual(this.f82269d, packagesItem.f82269d) && Intrinsics.areEqual(this.f82270e, packagesItem.f82270e) && Intrinsics.areEqual(this.f82271f, packagesItem.f82271f) && Intrinsics.areEqual(this.f82272g, packagesItem.f82272g) && Intrinsics.areEqual((Object) this.f82273h, (Object) packagesItem.f82273h) && Intrinsics.areEqual(this.f82274i, packagesItem.f82274i) && Intrinsics.areEqual(this.f82275j, packagesItem.f82275j) && Intrinsics.areEqual(this.f82276k, packagesItem.f82276k) && Intrinsics.areEqual(this.f82277l, packagesItem.f82277l) && Intrinsics.areEqual(this.f82278m, packagesItem.f82278m) && Intrinsics.areEqual(this.f82279n, packagesItem.f82279n) && Intrinsics.areEqual(this.f82280o, packagesItem.f82280o) && Intrinsics.areEqual(this.f82281p, packagesItem.f82281p) && Intrinsics.areEqual(this.f82282q, packagesItem.f82282q) && Intrinsics.areEqual(this.f82283r, packagesItem.f82283r) && Intrinsics.areEqual(this.f82284s, packagesItem.f82284s) && Intrinsics.areEqual(this.f82285t, packagesItem.f82285t);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        String str2 = this.f82267b;
        int hashCode2 = (hashCode + (str2 == null ? 0 : str2.hashCode())) * 31;
        String str3 = this.f82268c;
        int hashCode3 = (hashCode2 + (str3 == null ? 0 : str3.hashCode())) * 31;
        String str4 = this.f82269d;
        int hashCode4 = (hashCode3 + (str4 == null ? 0 : str4.hashCode())) * 31;
        String str5 = this.f82270e;
        int hashCode5 = (hashCode4 + (str5 == null ? 0 : str5.hashCode())) * 31;
        String str6 = this.f82271f;
        int hashCode6 = (hashCode5 + (str6 == null ? 0 : str6.hashCode())) * 31;
        List<String> list = this.f82272g;
        int hashCode7 = (hashCode6 + (list == null ? 0 : list.hashCode())) * 31;
        Double d = this.f82273h;
        int hashCode8 = (hashCode7 + (d == null ? 0 : d.hashCode())) * 31;
        String str7 = this.f82274i;
        int hashCode9 = (hashCode8 + (str7 == null ? 0 : str7.hashCode())) * 31;
        String str8 = this.f82275j;
        int hashCode10 = (hashCode9 + (str8 == null ? 0 : str8.hashCode())) * 31;
        String str9 = this.f82276k;
        int hashCode11 = (hashCode10 + (str9 == null ? 0 : str9.hashCode())) * 31;
        String str10 = this.f82277l;
        int hashCode12 = (hashCode11 + (str10 == null ? 0 : str10.hashCode())) * 31;
        String str11 = this.f82278m;
        int hashCode13 = (hashCode12 + (str11 == null ? 0 : str11.hashCode())) * 31;
        String str12 = this.f82279n;
        int hashCode14 = (hashCode13 + (str12 == null ? 0 : str12.hashCode())) * 31;
        String str13 = this.f82280o;
        int hashCode15 = (hashCode14 + (str13 == null ? 0 : str13.hashCode())) * 31;
        String str14 = this.f82281p;
        int hashCode16 = (hashCode15 + (str14 == null ? 0 : str14.hashCode())) * 31;
        String str15 = this.f82282q;
        int hashCode17 = (hashCode16 + (str15 == null ? 0 : str15.hashCode())) * 31;
        String str16 = this.f82283r;
        int hashCode18 = (hashCode17 + (str16 == null ? 0 : str16.hashCode())) * 31;
        Integer num = this.f82284s;
        int hashCode19 = (hashCode18 + (num == null ? 0 : num.hashCode())) * 31;
        String str17 = this.f82285t;
