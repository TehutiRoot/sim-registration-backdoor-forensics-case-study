...
public final class CheckPrivilegeResponse {
    ...
    /* renamed from: a */
    private final Integer f81802a;
    @SerializedName("otherPaymentCode")
    @Nullable

    /* renamed from: b */
    private final String f81803b;
    @SerializedName("returnCode")
    @Nullable

    /* renamed from: c */
    private final String f81804c;
    ...
    /* renamed from: e */
    private final String f81806e;
    @SerializedName("isTccActivate")
    @Nullable

    /* renamed from: f */
    private final Boolean f81807f;
    @SerializedName("dhopReceive")
    @Nullable

    /* renamed from: g */
    private final String f81808g;
    @SerializedName("privilegeUsedList")
    @Nullable

    /* renamed from: h */
    private final List<String> f81809h;
    @SerializedName("otherPaymentAmount")
    @Nullable

    /* renamed from: i */
    private final Integer f81810i;
    @SerializedName("promotionSetCode")
    @Nullable

    /* renamed from: j */
    private final String f81811j;
    @SerializedName("remainPrivilege")
    @Nullable

    /* renamed from: k */
    private final Integer f81812k;
    @SerializedName("depositDocNo")
    @Nullable

    /* renamed from: l */
    private final String f81813l;
    @SerializedName("shopReceive")
    @Nullable

    /* renamed from: m */
    private final String f81814m;
    @SerializedName("promotionSet_Code")
    @Nullable

    /* renamed from: n */
    private final String f81815n;
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof CheckPrivilegeResponse) {
            ...
            return Intrinsics.areEqual(this.f81802a, checkPrivilegeResponse.f81802a) && Intrinsics.areEqual(this.f81803b, checkPrivilegeResponse.f81803b) && Intrinsics.areEqual(this.f81804c, checkPrivilegeResponse.f81804c) && Intrinsics.areEqual(this.f81805d, checkPrivilegeResponse.f81805d) && Intrinsics.areEqual(this.f81806e, checkPrivilegeResponse.f81806e) && Intrinsics.areEqual(this.f81807f, checkPrivilegeResponse.f81807f) && Intrinsics.areEqual(this.f81808g, checkPrivilegeResponse.f81808g) && Intrinsics.areEqual(this.f81809h, checkPrivilegeResponse.f81809h) && Intrinsics.areEqual(this.f81810i, checkPrivilegeResponse.f81810i) && Intrinsics.areEqual(this.f81811j, checkPrivilegeResponse.f81811j) && Intrinsics.areEqual(this.f81812k, checkPrivilegeResponse.f81812k) && Intrinsics.areEqual(this.f81813l, checkPrivilegeResponse.f81813l) && Intrinsics.areEqual(this.f81814m, checkPrivilegeResponse.f81814m) && Intrinsics.areEqual(this.f81815n, checkPrivilegeResponse.f81815n);
        }
        return false;
    }
    ...
    public int hashCode() {
        Integer num = this.f81802a;
        int hashCode = (num == null ? 0 : num.hashCode()) * 31;
        String str = this.f81803b;
        int hashCode2 = (hashCode + (str == null ? 0 : str.hashCode())) * 31;
        String str2 = this.f81804c;
        int hashCode3 = (hashCode2 + (str2 == null ? 0 : str2.hashCode())) * 31;
        String str3 = this.f81805d;
        int hashCode4 = (hashCode3 + (str3 == null ? 0 : str3.hashCode())) * 31;
        String str4 = this.f81806e;
        int hashCode5 = (hashCode4 + (str4 == null ? 0 : str4.hashCode())) * 31;
        Boolean bool = this.f81807f;
        int hashCode6 = (hashCode5 + (bool == null ? 0 : bool.hashCode())) * 31;
        String str5 = this.f81808g;
        int hashCode7 = (hashCode6 + (str5 == null ? 0 : str5.hashCode())) * 31;
        List<String> list = this.f81809h;
        int hashCode8 = (hashCode7 + (list == null ? 0 : list.hashCode())) * 31;
        Integer num2 = this.f81810i;
        int hashCode9 = (hashCode8 + (num2 == null ? 0 : num2.hashCode())) * 31;
        String str6 = this.f81811j;
        int hashCode10 = (hashCode9 + (str6 == null ? 0 : str6.hashCode())) * 31;
        Integer num3 = this.f81812k;
        int hashCode11 = (hashCode10 + (num3 == null ? 0 : num3.hashCode())) * 31;
        String str7 = this.f81813l;
        int hashCode12 = (hashCode11 + (str7 == null ? 0 : str7.hashCode())) * 31;
        String str8 = this.f81814m;
        int hashCode13 = (hashCode12 + (str8 == null ? 0 : str8.hashCode())) * 31;
        String str9 = this.f81815n;
