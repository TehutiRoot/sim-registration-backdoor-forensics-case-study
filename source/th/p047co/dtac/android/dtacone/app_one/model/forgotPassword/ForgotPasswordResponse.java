...
public final class ForgotPasswordResponse implements Parcelable {
    ...
    /* renamed from: f */
    private final String f81699f;
    @SerializedName("data")
    @Nullable

    /* renamed from: g */
    private final Data f81700g;
    ...
    @StabilityInferred(parameters = 0)
    @Parcelize
    @Metadata(m28851d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\b\b\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0006\b\u0087\b\u0018\u00002\u00020\u0001B\u0013\u0012\n\b\u0002\u0010\u0003\u001a\u0004\u0018\u00010\u0002¢\u0006\u0004\b\u0004\u0010\u0005J\u0012\u0010\u0006\u001a\u0004\u0018\u00010\u0002HÆ\u0003¢\u0006\u0004\b\u0006\u0010\u0007J\u001c\u0010\b\u001a\u00020\u00002\n\b\u0002\u0010\u0003\u001a\u0004\u0018\u00010\u0002HÆ\u0001¢\u0006\u0004\b\b\u0010\tJ\u0010\u0010\n\u001a\u00020\u0002HÖ\u0001¢\u0006\u0004\b\n\u0010\u0007J\u0010\u0010\f\u001a\u00020\u000bHÖ\u0001¢\u0006\u0004\b\f\u0010\rJ\u001a\u0010\u0011\u001a\u00020\u00102\b\u0010\u000f\u001a\u0004\u0018\u00010\u000eHÖ\u0003¢\u0006\u0004\b\u0011\u0010\u0012J\u0010\u0010\u0013\u001a\u00020\u000bHÖ\u0001¢\u0006\u0004\b\u0013\u0010\rJ \u0010\u0018\u001a\u00020\u00172\u0006\u0010\u0015\u001a\u00020\u00142\u0006\u0010\u0016\u001a\u00020\u000bHÖ\u0001¢\u0006\u0004\b\u0018\u0010\u0019R\u001c\u0010\u0003\u001a\u0004\u0018\u00010\u00028\u0006X\u0087\u0004¢\u0006\f\n\u0004\b\u001a\u0010\u001b\u001a\u0004\b\u001c\u0010\u0007¨\u0006\u001d"}, m28850d2 = {"Lth/co/dtac/android/dtacone/app_one/model/forgotPassword/ForgotPasswordResponse$Data;", "Landroid/os/Parcelable;", "", NotificationCompat.CATEGORY_STATUS, "<init>", "(Ljava/lang/String;)V", "component1", "()Ljava/lang/String;", "copy", "(Ljava/lang/String;)Lth/co/dtac/android/dtacone/app_one/model/forgotPassword/ForgotPasswordResponse$Data;", "toString", "", "hashCode", "()I", "", "other", "", "equals", "(Ljava/lang/Object;)Z", "describeContents", "Landroid/os/Parcel;", "parcel", "flags", "", "writeToParcel", "(Landroid/os/Parcel;I)V", PDPageLabelRange.STYLE_LETTERS_LOWER, "Ljava/lang/String;", "getStatus", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0})
    ...
    public static final class Data implements Parcelable {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            return (obj instanceof Data) && Intrinsics.areEqual(this.f81701a, ((Data) obj).f81701a);
        }
    ...
    public static /* synthetic */ ForgotPasswordResponse copy$default(ForgotPasswordResponse forgotPasswordResponse, String str, String str2, String str3, String str4, List list, String str5, Data data, int i, Object obj) {
        if ((i & 1) != 0) {
            str = forgotPasswordResponse.f81694a;
        }
        if ((i & 2) != 0) {
            str2 = forgotPasswordResponse.f81695b;
        }
        String str6 = str2;
        if ((i & 4) != 0) {
            str3 = forgotPasswordResponse.f81696c;
        }
        String str7 = str3;
        if ((i & 8) != 0) {
            str4 = forgotPasswordResponse.f81697d;
        }
        String str8 = str4;
        List<String> list2 = list;
        if ((i & 16) != 0) {
            list2 = forgotPasswordResponse.f81698e;
        }
        List list3 = list2;
        if ((i & 32) != 0) {
            str5 = forgotPasswordResponse.f81699f;
        }
        String str9 = str5;
        if ((i & 64) != 0) {
            data = forgotPasswordResponse.f81700g;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof ForgotPasswordResponse) {
            ...
            return Intrinsics.areEqual(this.f81694a, forgotPasswordResponse.f81694a) && Intrinsics.areEqual(this.f81695b, forgotPasswordResponse.f81695b) && Intrinsics.areEqual(this.f81696c, forgotPasswordResponse.f81696c) && Intrinsics.areEqual(this.f81697d, forgotPasswordResponse.f81697d) && Intrinsics.areEqual(this.f81698e, forgotPasswordResponse.f81698e) && Intrinsics.areEqual(this.f81699f, forgotPasswordResponse.f81699f) && Intrinsics.areEqual(this.f81700g, forgotPasswordResponse.f81700g);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        String str3 = this.f81696c;
        int hashCode3 = (hashCode2 + (str3 == null ? 0 : str3.hashCode())) * 31;
        String str4 = this.f81697d;
        int hashCode4 = (hashCode3 + (str4 == null ? 0 : str4.hashCode())) * 31;
        List<String> list = this.f81698e;
        int hashCode5 = (hashCode4 + (list == null ? 0 : list.hashCode())) * 31;
        String str5 = this.f81699f;
        int hashCode6 = (hashCode5 + (str5 == null ? 0 : str5.hashCode())) * 31;
        Data data = this.f81700g;
    ...
    public void writeToParcel(@NotNull Parcel out, int i) {
        Intrinsics.checkNotNullParameter(out, "out");
        out.writeString(this.f81694a);
        out.writeString(this.f81695b);
        out.writeString(this.f81696c);
        out.writeString(this.f81697d);
        out.writeStringList(this.f81698e);
        out.writeString(this.f81699f);
        Data data = this.f81700g;
        if (data == null) {
            out.writeInt(0);
            return;
