...
public final class OnePermissionActivationResponse implements Parcelable {
    ...
    /* renamed from: a */
    private final String f81845a;
    @SerializedName("code")
    @Nullable

    /* renamed from: b */
    private final String f81846b;
    @SerializedName("codeType")
    @Nullable

    /* renamed from: c */
    private final String f81847c;
    ...
    /* renamed from: e */
    private final Data f81849e;
    @SerializedName("replaceMessage")
    @Nullable

    /* renamed from: f */
    private final List<String> f81850f;
    @SerializedName("desc")
    @Nullable

    /* renamed from: g */
    private final String f81851g;
    ...
    @StabilityInferred(parameters = 0)
    @Parcelize
    @Metadata(m28851d1 = {"\u0000B\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0006\b\u0087\b\u0018\u00002\u00020\u0001B\u0019\u0012\u0010\b\u0002\u0010\u0004\u001a\n\u0012\u0004\u0012\u00020\u0003\u0018\u00010\u0002¢\u0006\u0004\b\u0005\u0010\u0006J\u0018\u0010\u0007\u001a\n\u0012\u0004\u0012\u00020\u0003\u0018\u00010\u0002HÆ\u0003¢\u0006\u0004\b\u0007\u0010\bJ\"\u0010\t\u001a\u00020\u00002\u0010\b\u0002\u0010\u0004\u001a\n\u0012\u0004\u0012\u00020\u0003\u0018\u00010\u0002HÆ\u0001¢\u0006\u0004\b\t\u0010\nJ\u0010\u0010\f\u001a\u00020\u000bHÖ\u0001¢\u0006\u0004\b\f\u0010\rJ\u0010\u0010\u000f\u001a\u00020\u000eHÖ\u0001¢\u0006\u0004\b\u000f\u0010\u0010J\u001a\u0010\u0014\u001a\u00020\u00132\b\u0010\u0012\u001a\u0004\u0018\u00010\u0011HÖ\u0003¢\u0006\u0004\b\u0014\u0010\u0015J\u0010\u0010\u0016\u001a\u00020\u000eHÖ\u0001¢\u0006\u0004\b\u0016\u0010\u0010J \u0010\u001b\u001a\u00020\u001a2\u0006\u0010\u0018\u001a\u00020\u00172\u0006\u0010\u0019\u001a\u00020\u000eHÖ\u0001¢\u0006\u0004\b\u001b\u0010\u001cR\"\u0010\u0004\u001a\n\u0012\u0004\u0012\u00020\u0003\u0018\u00010\u00028\u0006X\u0087\u0004¢\u0006\f\n\u0004\b\u001d\u0010\u001e\u001a\u0004\b\u001f\u0010\b¨\u0006 "}, m28850d2 = {"Lth/co/dtac/android/dtacone/app_one/model/prepaid_registration/OnePermissionActivationResponse$Data;", "Landroid/os/Parcelable;", "", "Lth/co/dtac/android/dtacone/app_one/model/prepaid_registration/OnePermissionsItem;", "permissions", "<init>", "(Ljava/util/List;)V", "component1", "()Ljava/util/List;", "copy", "(Ljava/util/List;)Lth/co/dtac/android/dtacone/app_one/model/prepaid_registration/OnePermissionActivationResponse$Data;", "", "toString", "()Ljava/lang/String;", "", "hashCode", "()I", "", "other", "", "equals", "(Ljava/lang/Object;)Z", "describeContents", "Landroid/os/Parcel;", "parcel", "flags", "", "writeToParcel", "(Landroid/os/Parcel;I)V", PDPageLabelRange.STYLE_LETTERS_LOWER, "Ljava/util/List;", "getPermissions", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0})
    ...
    public static final class Data implements Parcelable {
        ...
        /* renamed from: a */
        private final List<OnePermissionsItem> f81852a;
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            return (obj instanceof Data) && Intrinsics.areEqual(this.f81852a, ((Data) obj).f81852a);
        }
        ...
        public int hashCode() {
            List<OnePermissionsItem> list = this.f81852a;
            if (list == null) {
                return 0;
            }
    ...
    public static /* synthetic */ OnePermissionActivationResponse copy$default(OnePermissionActivationResponse onePermissionActivationResponse, String str, String str2, String str3, String str4, Data data, List list, String str5, int i, Object obj) {
        if ((i & 1) != 0) {
            str = onePermissionActivationResponse.f81845a;
        }
        if ((i & 2) != 0) {
            str2 = onePermissionActivationResponse.f81846b;
        }
        String str6 = str2;
        if ((i & 4) != 0) {
            str3 = onePermissionActivationResponse.f81847c;
        }
        String str7 = str3;
        if ((i & 8) != 0) {
            str4 = onePermissionActivationResponse.f81848d;
        }
        String str8 = str4;
        if ((i & 16) != 0) {
            data = onePermissionActivationResponse.f81849e;
        }
        Data data2 = data;
        List<String> list2 = list;
        if ((i & 32) != 0) {
            list2 = onePermissionActivationResponse.f81850f;
        }
        List list3 = list2;
        if ((i & 64) != 0) {
            str5 = onePermissionActivationResponse.f81851g;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof OnePermissionActivationResponse) {
            ...
            return Intrinsics.areEqual(this.f81845a, onePermissionActivationResponse.f81845a) && Intrinsics.areEqual(this.f81846b, onePermissionActivationResponse.f81846b) && Intrinsics.areEqual(this.f81847c, onePermissionActivationResponse.f81847c) && Intrinsics.areEqual(this.f81848d, onePermissionActivationResponse.f81848d) && Intrinsics.areEqual(this.f81849e, onePermissionActivationResponse.f81849e) && Intrinsics.areEqual(this.f81850f, onePermissionActivationResponse.f81850f) && Intrinsics.areEqual(this.f81851g, onePermissionActivationResponse.f81851g);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        String str2 = this.f81846b;
        int hashCode2 = (hashCode + (str2 == null ? 0 : str2.hashCode())) * 31;
        String str3 = this.f81847c;
        int hashCode3 = (hashCode2 + (str3 == null ? 0 : str3.hashCode())) * 31;
        String str4 = this.f81848d;
        int hashCode4 = (hashCode3 + (str4 == null ? 0 : str4.hashCode())) * 31;
        Data data = this.f81849e;
        int hashCode5 = (hashCode4 + (data == null ? 0 : data.hashCode())) * 31;
        List<String> list = this.f81850f;
        int hashCode6 = (hashCode5 + (list == null ? 0 : list.hashCode())) * 31;
        String str5 = this.f81851g;
    ...
    public void writeToParcel(@NotNull Parcel out, int i) {
        Intrinsics.checkNotNullParameter(out, "out");
        out.writeString(this.f81845a);
        out.writeString(this.f81846b);
        out.writeString(this.f81847c);
        out.writeString(this.f81848d);
        Data data = this.f81849e;
        if (data == null) {
            out.writeInt(0);
        } else {
        ...
        out.writeStringList(this.f81850f);
        out.writeString(this.f81851g);
    }
