...
public final class OneProfitReportResponse {
    ...
    /* renamed from: e */
    private final OneProfitReportDataResponse f82010e;
    @SerializedName("replaceMessage")
    @Nullable

    /* renamed from: f */
    private final List<String> f82011f;
    @SerializedName("desc")
    @Nullable

    /* renamed from: g */
    private final String f82012g;
    ...
    public static /* synthetic */ OneProfitReportResponse copy$default(OneProfitReportResponse oneProfitReportResponse, String str, String str2, String str3, String str4, OneProfitReportDataResponse oneProfitReportDataResponse, List list, String str5, int i, Object obj) {
        if ((i & 1) != 0) {
            str = oneProfitReportResponse.f82006a;
        }
        if ((i & 2) != 0) {
            str2 = oneProfitReportResponse.f82007b;
        }
        String str6 = str2;
        if ((i & 4) != 0) {
            str3 = oneProfitReportResponse.f82008c;
        }
        String str7 = str3;
        if ((i & 8) != 0) {
            str4 = oneProfitReportResponse.f82009d;
        }
        String str8 = str4;
        if ((i & 16) != 0) {
            oneProfitReportDataResponse = oneProfitReportResponse.f82010e;
        }
        OneProfitReportDataResponse oneProfitReportDataResponse2 = oneProfitReportDataResponse;
        List<String> list2 = list;
        if ((i & 32) != 0) {
            list2 = oneProfitReportResponse.f82011f;
        }
        List list3 = list2;
        if ((i & 64) != 0) {
            str5 = oneProfitReportResponse.f82012g;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof OneProfitReportResponse) {
            ...
            return Intrinsics.areEqual(this.f82006a, oneProfitReportResponse.f82006a) && Intrinsics.areEqual(this.f82007b, oneProfitReportResponse.f82007b) && Intrinsics.areEqual(this.f82008c, oneProfitReportResponse.f82008c) && Intrinsics.areEqual(this.f82009d, oneProfitReportResponse.f82009d) && Intrinsics.areEqual(this.f82010e, oneProfitReportResponse.f82010e) && Intrinsics.areEqual(this.f82011f, oneProfitReportResponse.f82011f) && Intrinsics.areEqual(this.f82012g, oneProfitReportResponse.f82012g);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        String str4 = this.f82009d;
        int hashCode4 = (hashCode3 + (str4 == null ? 0 : str4.hashCode())) * 31;
        OneProfitReportDataResponse oneProfitReportDataResponse = this.f82010e;
        int hashCode5 = (hashCode4 + (oneProfitReportDataResponse == null ? 0 : oneProfitReportDataResponse.hashCode())) * 31;
        List<String> list = this.f82011f;
        int hashCode6 = (hashCode5 + (list == null ? 0 : list.hashCode())) * 31;
        String str5 = this.f82012g;
    ...
    public OneProfitReportResponse(@Nullable String str, @Nullable String str2, @Nullable String str3, @Nullable String str4, @Nullable OneProfitReportDataResponse oneProfitReportDataResponse, @Nullable List<String> list, @Nullable String str5) {
        ...
        this.f82008c = str3;
        this.f82009d = str4;
        this.f82010e = oneProfitReportDataResponse;
        this.f82011f = list;
        this.f82012g = str5;
    }
