...
@Metadata(m28851d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\n\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\b\b\u0087\b\u0018\u00002\u00020\u0001B\u001f\u0012\n\b\u0002\u0010\u0003\u001a\u0004\u0018\u00010\u0002\u0012\n\b\u0002\u0010\u0004\u001a\u0004\u0018\u00010\u0002¢\u0006\u0004\b\u0005\u0010\u0006J\u0012\u0010\u0007\u001a\u0004\u0018\u00010\u0002HÆ\u0003¢\u0006\u0004\b\u0007\u0010\bJ\u0012\u0010\t\u001a\u0004\u0018\u00010\u0002HÆ\u0003¢\u0006\u0004\b\t\u0010\bJ(\u0010\n\u001a\u00020\u00002\n\b\u0002\u0010\u0003\u001a\u0004\u0018\u00010\u00022\n\b\u0002\u0010\u0004\u001a\u0004\u0018\u00010\u0002HÆ\u0001¢\u0006\u0004\b\n\u0010\u000bJ\u0010\u0010\f\u001a\u00020\u0002HÖ\u0001¢\u0006\u0004\b\f\u0010\bJ\u0010\u0010\u000e\u001a\u00020\rHÖ\u0001¢\u0006\u0004\b\u000e\u0010\u000fJ\u001a\u0010\u0012\u001a\u00020\u00112\b\u0010\u0010\u001a\u0004\u0018\u00010\u0001HÖ\u0003¢\u0006\u0004\b\u0012\u0010\u0013R\u001c\u0010\u0003\u001a\u0004\u0018\u00010\u00028\u0006X\u0087\u0004¢\u0006\f\n\u0004\b\u0014\u0010\u0015\u001a\u0004\b\u0016\u0010\bR\u001c\u0010\u0004\u001a\u0004\u0018\u00010\u00028\u0006X\u0087\u0004¢\u0006\f\n\u0004\b\u0017\u0010\u0015\u001a\u0004\b\u0018\u0010\b¨\u0006\u0019"}, m28850d2 = {"Lth/co/dtac/android/dtacone/app_one/model/prepaid_registration/OnePrepaidRegisterTQueryCampaignRequest;", "", "", "itemId", "flow", "<init>", "(Ljava/lang/String;Ljava/lang/String;)V", "component1", "()Ljava/lang/String;", "component2", "copy", "(Ljava/lang/String;Ljava/lang/String;)Lth/co/dtac/android/dtacone/app_one/model/prepaid_registration/OnePrepaidRegisterTQueryCampaignRequest;", "toString", "", "hashCode", "()I", "other", "", "equals", "(Ljava/lang/Object;)Z", PDPageLabelRange.STYLE_LETTERS_LOWER, "Ljava/lang/String;", "getItemId", OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, "getFlow", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0})
...
public final class OnePrepaidRegisterTQueryCampaignRequest {
    ...
    /* renamed from: a */
    private final String f81911a;
    @SerializedName("flow")
    @Nullable

    /* renamed from: b */
    private final String f81912b;
    ...
    public static /* synthetic */ OnePrepaidRegisterTQueryCampaignRequest copy$default(OnePrepaidRegisterTQueryCampaignRequest onePrepaidRegisterTQueryCampaignRequest, String str, String str2, int i, Object obj) {
        if ((i & 1) != 0) {
            str = onePrepaidRegisterTQueryCampaignRequest.f81911a;
        }
        if ((i & 2) != 0) {
            str2 = onePrepaidRegisterTQueryCampaignRequest.f81912b;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof OnePrepaidRegisterTQueryCampaignRequest) {
            ...
            return Intrinsics.areEqual(this.f81911a, onePrepaidRegisterTQueryCampaignRequest.f81911a) && Intrinsics.areEqual(this.f81912b, onePrepaidRegisterTQueryCampaignRequest.f81912b);
        }
        return false;
    }
    ...
    public int hashCode() {
        String str = this.f81911a;
        int hashCode = (str == null ? 0 : str.hashCode()) * 31;
        String str2 = this.f81912b;
