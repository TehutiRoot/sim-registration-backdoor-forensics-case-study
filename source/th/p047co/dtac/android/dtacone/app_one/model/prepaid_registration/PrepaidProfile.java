...
public final class PrepaidProfile {
    ...
    /* renamed from: i */
    private String f81965i;
    @SerializedName("statusCode")
    @Nullable

    /* renamed from: j */
    private final String f81966j;
    @SerializedName("idNumberShow")
    @Nullable

    /* renamed from: k */
    private String f81967k;
    @SerializedName("reRegisterFlag")

    /* renamed from: l */
    private boolean f81968l;
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof PrepaidProfile) {
            ...
            return Intrinsics.areEqual(this.f81957a, prepaidProfile.f81957a) && Intrinsics.areEqual(this.f81958b, prepaidProfile.f81958b) && Intrinsics.areEqual(this.f81959c, prepaidProfile.f81959c) && Intrinsics.areEqual(this.f81960d, prepaidProfile.f81960d) && Intrinsics.areEqual(this.f81961e, prepaidProfile.f81961e) && Intrinsics.areEqual(this.f81962f, prepaidProfile.f81962f) && Intrinsics.areEqual(this.f81963g, prepaidProfile.f81963g) && Intrinsics.areEqual(this.f81964h, prepaidProfile.f81964h) && Intrinsics.areEqual(this.f81965i, prepaidProfile.f81965i) && Intrinsics.areEqual(this.f81966j, prepaidProfile.f81966j) && Intrinsics.areEqual(this.f81967k, prepaidProfile.f81967k) && this.f81968l == prepaidProfile.f81968l;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        String str8 = this.f81964h;
        int hashCode8 = (hashCode7 + (str8 == null ? 0 : str8.hashCode())) * 31;
        String str9 = this.f81965i;
        int hashCode9 = (hashCode8 + (str9 == null ? 0 : str9.hashCode())) * 31;
        String str10 = this.f81966j;
        int hashCode10 = (hashCode9 + (str10 == null ? 0 : str10.hashCode())) * 31;
        String str11 = this.f81967k;
        int hashCode11 = (hashCode10 + (str11 != null ? str11.hashCode() : 0)) * 31;
        boolean z = this.f81968l;
        int i = z;
        if (z != 0) {
            i = 1;
        }
