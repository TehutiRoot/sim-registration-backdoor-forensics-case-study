...
public final class OneChannelTopicResponse {
    ...
    public static final class Data {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            return (obj instanceof Data) && Intrinsics.areEqual(this.f81612a, ((Data) obj).f81612a);
        }
    ...
    public static /* synthetic */ OneChannelTopicResponse copy$default(OneChannelTopicResponse oneChannelTopicResponse, String str, String str2, String str3, String str4, List list, List list2, String str5, int i, Object obj) {
        if ((i & 1) != 0) {
            str = oneChannelTopicResponse.f81605a;
        }
        if ((i & 2) != 0) {
            str2 = oneChannelTopicResponse.f81606b;
        }
        String str6 = str2;
        if ((i & 4) != 0) {
            str3 = oneChannelTopicResponse.f81607c;
        }
        String str7 = str3;
        if ((i & 8) != 0) {
            str4 = oneChannelTopicResponse.f81608d;
        }
        String str8 = str4;
        List<String> list3 = list;
        if ((i & 16) != 0) {
            list3 = oneChannelTopicResponse.f81609e;
        }
        List list4 = list3;
        List<String> list5 = list2;
        if ((i & 32) != 0) {
            list5 = oneChannelTopicResponse.f81610f;
        }
        List list6 = list5;
        if ((i & 64) != 0) {
            str5 = oneChannelTopicResponse.f81611g;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof OneChannelTopicResponse) {
            ...
            return Intrinsics.areEqual(this.f81605a, oneChannelTopicResponse.f81605a) && Intrinsics.areEqual(this.f81606b, oneChannelTopicResponse.f81606b) && Intrinsics.areEqual(this.f81607c, oneChannelTopicResponse.f81607c) && Intrinsics.areEqual(this.f81608d, oneChannelTopicResponse.f81608d) && Intrinsics.areEqual(this.f81609e, oneChannelTopicResponse.f81609e) && Intrinsics.areEqual(this.f81610f, oneChannelTopicResponse.f81610f) && Intrinsics.areEqual(this.f81611g, oneChannelTopicResponse.f81611g);
        }
        return false;
    }
    ...
    public int hashCode() {
        String str = this.f81605a;
        int hashCode = (str == null ? 0 : str.hashCode()) * 31;
        String str2 = this.f81606b;
        int hashCode2 = (hashCode + (str2 == null ? 0 : str2.hashCode())) * 31;
        String str3 = this.f81607c;
        int hashCode3 = (hashCode2 + (str3 == null ? 0 : str3.hashCode())) * 31;
        String str4 = this.f81608d;
        int hashCode4 = (hashCode3 + (str4 == null ? 0 : str4.hashCode())) * 31;
        List<String> list = this.f81609e;
        int hashCode5 = (hashCode4 + (list == null ? 0 : list.hashCode())) * 31;
        List<String> list2 = this.f81610f;
        int hashCode6 = (hashCode5 + (list2 == null ? 0 : list2.hashCode())) * 31;
        String str5 = this.f81611g;
