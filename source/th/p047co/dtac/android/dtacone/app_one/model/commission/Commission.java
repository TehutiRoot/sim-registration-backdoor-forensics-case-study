...
public final class Commission implements Parcelable {
    ...
    /* renamed from: g */
    private final String f81619g;
    @SerializedName("paidDateCurrentLabel")
    @Nullable

    /* renamed from: h */
    private final String f81620h;
    @SerializedName("commissionLabel")
    @Nullable

    /* renamed from: i */
    private final String f81621i;
    @SerializedName("paidDate")
    @Nullable

    /* renamed from: j */
    private final String f81622j;
    @SerializedName("paidTypeValue")
    @Nullable

    /* renamed from: k */
    private final String f81623k;
    @SerializedName("commissionDate")
    @Nullable

    /* renamed from: l */
    private final String f81624l;
    @SerializedName("cashPaidTypeBankName")
    @Nullable

    /* renamed from: m */
    private final String f81625m;
    @SerializedName("payByCommissionTypeList")
    @Nullable

    /* renamed from: n */
    private final List<PayByCommissionTypeListItem> f81626n;
    @SerializedName("paidTypeLabel")
    @Nullable

    /* renamed from: o */
    private final String f81627o;
    @SerializedName("cashPaidTypeBankAccountNumber")
    @Nullable

    /* renamed from: p */
    private final String f81628p;
    @SerializedName("withholdTaxLabel")
    @Nullable

    /* renamed from: q */
    private final String f81629q;
    @SerializedName("vatLabel")
    @Nullable

    /* renamed from: r */
    private final String f81630r;
    @NotNull
    public static final CREATOR CREATOR = new CREATOR(null);
    public static final int $stable = 8;

    @Metadata(m28851d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0003J\u0010\u0010\u0004\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0006H\u0016J\u001d\u0010\u0007\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00020\b2\u0006\u0010\t\u001a\u00020\nH\u0016¢\u0006\u0002\u0010\u000b¨\u0006\f"}, m28850d2 = {"Lth/co/dtac/android/dtacone/app_one/model/commission/Commission$CREATOR;", "Landroid/os/Parcelable$Creator;", "Lth/co/dtac/android/dtacone/app_one/model/commission/Commission;", "()V", "createFromParcel", "parcel", "Landroid/os/Parcel;", "newArray", "", "size", "", "(I)[Lth/co/dtac/android/dtacone/app_one/model/commission/Commission;", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof Commission) {
            ...
            return Intrinsics.areEqual(this.f81613a, commission.f81613a) && Intrinsics.areEqual(this.f81614b, commission.f81614b) && Intrinsics.areEqual(this.f81615c, commission.f81615c) && Intrinsics.areEqual(this.f81616d, commission.f81616d) && Intrinsics.areEqual(this.f81617e, commission.f81617e) && Intrinsics.areEqual(this.f81618f, commission.f81618f) && Intrinsics.areEqual(this.f81619g, commission.f81619g) && Intrinsics.areEqual(this.f81620h, commission.f81620h) && Intrinsics.areEqual(this.f81621i, commission.f81621i) && Intrinsics.areEqual(this.f81622j, commission.f81622j) && Intrinsics.areEqual(this.f81623k, commission.f81623k) && Intrinsics.areEqual(this.f81624l, commission.f81624l) && Intrinsics.areEqual(this.f81625m, commission.f81625m) && Intrinsics.areEqual(this.f81626n, commission.f81626n) && Intrinsics.areEqual(this.f81627o, commission.f81627o) && Intrinsics.areEqual(this.f81628p, commission.f81628p) && Intrinsics.areEqual(this.f81629q, commission.f81629q) && Intrinsics.areEqual(this.f81630r, commission.f81630r);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        String str3 = this.f81615c;
        int hashCode3 = (hashCode2 + (str3 == null ? 0 : str3.hashCode())) * 31;
        String str4 = this.f81616d;
        int hashCode4 = (hashCode3 + (str4 == null ? 0 : str4.hashCode())) * 31;
        String str5 = this.f81617e;
        int hashCode5 = (hashCode4 + (str5 == null ? 0 : str5.hashCode())) * 31;
        String str6 = this.f81618f;
        int hashCode6 = (hashCode5 + (str6 == null ? 0 : str6.hashCode())) * 31;
        String str7 = this.f81619g;
        int hashCode7 = (hashCode6 + (str7 == null ? 0 : str7.hashCode())) * 31;
        String str8 = this.f81620h;
        int hashCode8 = (hashCode7 + (str8 == null ? 0 : str8.hashCode())) * 31;
        String str9 = this.f81621i;
        int hashCode9 = (hashCode8 + (str9 == null ? 0 : str9.hashCode())) * 31;
        String str10 = this.f81622j;
        int hashCode10 = (hashCode9 + (str10 == null ? 0 : str10.hashCode())) * 31;
        String str11 = this.f81623k;
        int hashCode11 = (hashCode10 + (str11 == null ? 0 : str11.hashCode())) * 31;
        String str12 = this.f81624l;
        int hashCode12 = (hashCode11 + (str12 == null ? 0 : str12.hashCode())) * 31;
        String str13 = this.f81625m;
        int hashCode13 = (hashCode12 + (str13 == null ? 0 : str13.hashCode())) * 31;
        List<PayByCommissionTypeListItem> list = this.f81626n;
        int hashCode14 = (hashCode13 + (list == null ? 0 : list.hashCode())) * 31;
        String str14 = this.f81627o;
        int hashCode15 = (hashCode14 + (str14 == null ? 0 : str14.hashCode())) * 31;
        String str15 = this.f81628p;
        int hashCode16 = (hashCode15 + (str15 == null ? 0 : str15.hashCode())) * 31;
        String str16 = this.f81629q;
        int hashCode17 = (hashCode16 + (str16 == null ? 0 : str16.hashCode())) * 31;
        String str17 = this.f81630r;
