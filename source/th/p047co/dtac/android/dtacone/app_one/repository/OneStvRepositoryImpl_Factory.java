...
public final class OneStvRepositoryImpl_Factory implements Factory<OneStvRepositoryImpl> {
    ...
    /* renamed from: a */
    public final Provider f82368a;

    /* renamed from: b */
    public final Provider f82369b;

    /* renamed from: c */
    public final Provider f82370c;

    /* renamed from: d */
    public final Provider f82371d;
    ...
    public OneStvRepositoryImpl_Factory(Provider<RTRApiRx2> provider, Provider<RtrRx2Repository> provider2, Provider<ConfigurationRepository> provider3, Provider<PreferencesViewModel> provider4) {
        ...
        this.f82370c = provider3;
        this.f82371d = provider4;
    }
    ...
    public OneStvRepositoryImpl get() {
        return newInstance((RTRApiRx2) this.f82368a.get(), (RtrRx2Repository) this.f82369b.get(), (ConfigurationRepository) this.f82370c.get(), (PreferencesViewModel) this.f82371d.get());
    }
}
