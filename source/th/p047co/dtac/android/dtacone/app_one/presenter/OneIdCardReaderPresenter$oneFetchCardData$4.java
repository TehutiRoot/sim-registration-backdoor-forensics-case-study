...
/* renamed from: th.co.dtac.android.dtacone.app_one.presenter.OneIdCardReaderPresenter$oneFetchCardData$4 */
/* loaded from: classes7.dex */
public final class OneIdCardReaderPresenter$oneFetchCardData$4 extends Lambda implements Function1<IdCardInformationCollection, Unit> {
    final /* synthetic */ OneIdCardReaderPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneIdCardReaderPresenter$oneFetchCardData$4(OneIdCardReaderPresenter oneIdCardReaderPresenter) {
        super(1);
