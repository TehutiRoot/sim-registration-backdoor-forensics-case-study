...
public final class OneOutlineTextBoxKt {
    ...
    */
    ...
    /* renamed from: a */
    public static final void m19826a(Composer composer, int i) {
        ...
        if (i == 0 && startRestartGroup.getSkipping()) {
            ...
            ThemeKt.OneTheme(null, false, ComposableSingletons$OneOutlineTextBoxKt.INSTANCE.m74940getLambda1$app_prodRelease(), startRestartGroup, 384, 3);
            if (ComposerKt.isTraceInProgress()) {
    ...
    /* renamed from: b */
    public static final FocusState m19825b(MutableState mutableState) {
        return (FocusState) mutableState.getValue();
    }

    /* renamed from: c */
    public static final void m19824c(MutableState mutableState, FocusState focusState) {
