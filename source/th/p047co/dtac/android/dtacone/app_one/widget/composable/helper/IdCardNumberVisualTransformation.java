...
public final class IdCardNumberVisualTransformation implements VisualTransformation {
    ...
    /* renamed from: a */
    public final IdCardNumberVisualTransformation$idCardNumberOffsetMapping$1 f82907a = new OffsetMapping() { // from class: th.co.dtac.android.dtacone.app_one.widget.composable.helper.IdCardNumberVisualTransformation$idCardNumberOffsetMapping$1
    ...
    public TransformedText filter(@NotNull AnnotatedString text) {
        ...
        return new TransformedText(new AnnotatedString(str, null, null, 6, null), this.f82907a);
    }
}
