...
public final class OneTextInputLayoutCredit extends FrameLayout implements TextWatcher, View.OnFocusChangeListener {
    ...
    /* renamed from: a */
    public boolean f82845a;

    /* renamed from: b */
    public OnTextChangListener f82846b;

    /* renamed from: c */
    public boolean f82847c;

    /* renamed from: d */
    public final CompositeDisposable f82848d;

    /* renamed from: e */
    public final LayoutInflater f82849e;

    /* renamed from: f */
    public final TypedArray f82850f;

    @Metadata(m28851d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\u0012\u0010\u0002\u001a\u00020\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005H&¨\u0006\u0006"}, m28850d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/OneTextInputLayoutCredit$OnTextChangListener;", "", "afterTextChanged", "", OperatorName.CLOSE_AND_STROKE, "Landroid/text/Editable;", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    public OneTextInputLayoutCredit(@NotNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.f82848d = new CompositeDisposable();
        Object systemService = context.getSystemService("layout_inflater");
        Intrinsics.checkNotNull(systemService, "null cannot be cast to non-null type android.view.LayoutInflater");
        this.f82849e = (LayoutInflater) systemService;
        ...
        this.f82850f = obtainStyledAttributes;
        m19869o();
    }

    /* renamed from: a */
    public static /* synthetic */ String m19883a(Function1 function1, Object obj) {
        return m19874j(function1, obj);
    }

    public static final /* synthetic */ void access$setIgnoreNextTextChange$p(OneTextInputLayoutCredit oneTextInputLayoutCredit, boolean z) {
        oneTextInputLayoutCredit.f82845a = z;
    }

    /* renamed from: b */
    public static /* synthetic */ CardType m19882b(Function1 function1, Object obj) {
        return m19872l(function1, obj);
    }

    /* renamed from: c */
    public static /* synthetic */ CardType m19881c(Function1 function1, Object obj) {
        return m19871m(function1, obj);
    }

    /* renamed from: d */
    public static /* synthetic */ CharSequence m19880d(String str, CharSequence charSequence, int i, int i2, Spanned spanned, int i3, int i4) {
        return m19867q(str, charSequence, i, i2, spanned, i3, i4);
    }

    /* renamed from: e */
    public static /* synthetic */ void m19879e(Function1 function1, Object obj) {
        m19864t(function1, obj);
    }

    /* renamed from: f */
    public static /* synthetic */ void m19878f(OneEditText oneEditText, View view) {
        m19868p(oneEditText, view);
    }

    /* renamed from: g */
    public static /* synthetic */ void m19877g(Function1 function1, Object obj) {
        m19863u(function1, obj);
    }

    /* renamed from: j */
    public static final String m19874j(Function1 tmp0, Object obj) {
        Intrinsics.checkNotNullParameter(tmp0, "$tmp0");
        return (String) tmp0.invoke(obj);
    }

    /* renamed from: l */
    public static final CardType m19872l(Function1 tmp0, Object obj) {
        Intrinsics.checkNotNullParameter(tmp0, "$tmp0");
        return (CardType) tmp0.invoke(obj);
    }

    /* renamed from: m */
    public static final CardType m19871m(Function1 tmp0, Object obj) {
        Intrinsics.checkNotNullParameter(tmp0, "$tmp0");
        return (CardType) tmp0.invoke(obj);
    }

    /* renamed from: p */
    public static final void m19868p(OneEditText oneEditText, View view) {
        Intrinsics.checkNotNullParameter(oneEditText, "$oneEditText");
        oneEditText.setText("");
    }

    /* renamed from: q */
    public static final CharSequence m19867q(String digits, CharSequence charSequence, int i, int i2, Spanned spanned, int i3, int i4) {
    ...
    /* renamed from: t */
    public static final void m19864t(Function1 tmp0, Object obj) {
        Intrinsics.checkNotNullParameter(tmp0, "$tmp0");
        tmp0.invoke(obj);
    }

    /* renamed from: u */
    public static final void m19863u(Function1 tmp0, Object obj) {
        Intrinsics.checkNotNullParameter(tmp0, "$tmp0");
        tmp0.invoke(obj);
    }
    ...
    public final void blockCopyPaste() {
        ...
        oneEditText.setUpdateListener(new OneEditText.UpdateListener() { // from class: th.co.dtac.android.dtacone.app_one.widget.OneTextInputLayoutCredit$blockCopyPaste$1
            ...
            @Override // th.p047co.dtac.android.dtacone.app_one.widget.OneEditText.UpdateListener
            public void onPaste() {
                OneTextInputLayoutCredit.access$setIgnoreNextTextChange$p(OneTextInputLayoutCredit.this, true);
    ...
    /* renamed from: h */
    public final void m19876h(CardType cardType) {
        int m19866r = m19866r(cardType);
        ...
        ((ImageView) findViewById).setImageResource(m19866r);
    }

    /* renamed from: i */
    public final Observable m19875i() {
        View findViewById = findViewById(R.id.edtText);
        Intrinsics.checkNotNullExpressionValue(findViewById, "findViewById(R.id.edtText)");
        ...
        Observable<R> map = debounce.map(new Function() { // from class: ue1
            @Override // io.reactivex.functions.Function
            public final Object apply(Object obj) {
                return OneTextInputLayoutCredit.m19883a(oneTextInputLayoutCredit$creditNumberChange$1, obj);
            }
        });
    ...
    /* renamed from: k */
    public final Observable m19873k() {
        Observable m19875i = m19875i();
        ...
        Observable map = m19875i.map(new Function() { // from class: se1
            @Override // io.reactivex.functions.Function
            public final Object apply(Object obj) {
                return OneTextInputLayoutCredit.m19881c(Function1.this, obj);
            }
        });
        ...
        return map.onErrorReturn(new Function() { // from class: te1
            @Override // io.reactivex.functions.Function
            public final Object apply(Object obj) {
                return OneTextInputLayoutCredit.m19882b(Function1.this, obj);
            }
        }).observeOn(AndroidSchedulers.mainThread());
    }

    /* renamed from: n */
    public final void m19870n(Editable editable) {
        if (editable == null) {
            return;
        }
    ...
    /* renamed from: o */
    public final void m19869o() {
        CharSequence text;
        addView(this.f82849e.inflate(R.layout.one_text_input_layout_credit, (ViewGroup) null));
        if (this.f82850f.hasValue(R.styleable.OneTextInputLayoutText_isCopyPaste) && !this.f82850f.getBoolean(R.styleable.OneTextInputLayoutText_isCopyPaste, true)) {
            blockCopyPaste();
        }
        View findViewById = findViewById(R.id.right_icon);
        Intrinsics.checkNotNullExpressionValue(findViewById, "findViewById(R.id.right_icon)");
        ...
        ((ImageView) findViewById).setOnClickListener(new View.OnClickListener() { // from class: oe1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                OneTextInputLayoutCredit.m19878f(OneEditText.this, view);
            }
        });
        oneTextInputLayout.setTypeface(ResourcesCompat.getFont(getContext(), R.font.one_font_style));
        CharSequence text2 = this.f82850f.getText(R.styleable.OneTextInputLayoutText_input_text);
        if (text2 != null) {
            oneEditText.setText(text2);
        }
        oneEditText.setTextSize(this.f82850f.getDimension(R.styleable.OneTextInputLayoutText_input_size, 18.0f));
        CharSequence text3 = this.f82850f.getText(R.styleable.OneTextInputLayoutText_input_hint);
        if (text3 != null) {
            oneTextInputLayout.setHint(text3);
        }
        int i = this.f82850f.getInt(R.styleable.OneTextInputLayoutText_input_maxLength, 0);
        if (i > 0) {
            oneEditText.setFilters(new InputFilter.LengthFilter[]{new InputFilter.LengthFilter(i)});
        }
        int i2 = this.f82850f.getInt(R.styleable.OneTextInputLayoutText_android_inputType, 0);
        if (i2 != 0) {
            oneEditText.setInputType(i2);
        }
        if (this.f82850f.hasValue(R.styleable.OneTextInputLayoutText_is_enable)) {
            if (this.f82850f.getBoolean(R.styleable.OneTextInputLayoutText_is_enable, true)) {
                ViewEnableKt.toEnable(oneEditText);
            } else {
                ViewEnableKt.toDisable(oneEditText);
            }
        }
        if (this.f82850f.hasValue(R.styleable.OneTextInputLayoutText_android_imeOptions)) {
            oneEditText.setImeOptions(this.f82850f.getInt(R.styleable.OneTextInputLayoutText_android_imeOptions, 0));
        }
        if (this.f82850f.hasValue(R.styleable.OneTextInputLayoutText_isDigitNumber) && this.f82850f.getBoolean(R.styleable.OneTextInputLayoutText_isDigitNumber, false)) {
            setDigitNumber();
        }
        if (this.f82850f.hasValue(R.styleable.OneTextInputLayoutText_digits_text) && (text = this.f82850f.getText(R.styleable.OneTextInputLayoutText_digits_text)) != null) {
    ...
    /* renamed from: r */
    public final int m19866r(CardType cardType) {
        Integer num = (Integer) AbstractC11687a.mapOf(TuplesKt.m28844to(CardType.VISA, Integer.valueOf(R.drawable.ic_icon_visa)), TuplesKt.m28844to(CardType.JCB, Integer.valueOf(R.drawable.ic_icon_jcb)), TuplesKt.m28844to(CardType.MASTER_CARD, Integer.valueOf(R.drawable.ic_icon_mastercard))).get(cardType);
        if (num != null) {
            return num.intValue();
        }
    ...
    /* renamed from: s */
    public final void m19865s() {
        CompositeDisposable compositeDisposable = this.f82848d;
        Observable m19873k = m19873k();
        ...
        Consumer consumer = new Consumer() { // from class: qe1
            ...
            public final void accept(Object obj) {
                OneTextInputLayoutCredit.m19879e(oneTextInputLayoutCredit$validationFrom$1, obj);
            }
        };
        ...
        compositeDisposable.add(m19873k.subscribe(consumer, new Consumer() { // from class: re1
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                OneTextInputLayoutCredit.m19877g(oneTextInputLayoutCredit$validationFrom$2, obj);
            }
        }));
    }
    ...
    public final void setDigit(@NotNull final String digits) {
        Intrinsics.checkNotNullParameter(digits, "digits");
        InputFilter[] inputFilterArr = {new InputFilter() { // from class: pe1
            @Override // android.text.InputFilter
            public final CharSequence filter(CharSequence charSequence, int i, int i2, Spanned spanned, int i3, int i4) {
                return OneTextInputLayoutCredit.m19880d(digits, charSequence, i, i2, spanned, i3, i4);
            }
        }};
        View findViewById = findViewById(R.id.edtText);
        Intrinsics.checkNotNullExpressionValue(findViewById, "findViewById(R.id.edtText)");
