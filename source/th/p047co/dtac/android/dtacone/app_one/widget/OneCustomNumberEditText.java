...
public final class OneCustomNumberEditText extends OneCustomInteractiveEditText implements OneEditText.UpdateListener {
    ...
    /* renamed from: l */
    public boolean f82779l;

    /* renamed from: m */
    public boolean f82780m;

    /* renamed from: n */
    public boolean f82781n;

    /* renamed from: o */
    public boolean f82782o;
    ...
    public void onTextChangeAction(@Nullable CharSequence charSequence, int i, int i2, int i3) {
        boolean z;
        if (getDrawables() != null && this.f82779l) {
    ...
    public OneCustomNumberEditText(@NotNull Context context, @NotNull AttributeSet attrs) {
        ...
        try {
            this.f82781n = obtainStyledAttributes.getBoolean(R.styleable.DtacClearableEditText_capital, false);
            this.f82779l = obtainStyledAttributes.getBoolean(R.styleable.DtacClearableEditText_showClearButton, true);
            this.f82780m = obtainStyledAttributes.getBoolean(R.styleable.DtacClearableEditText_autoFormat, false);
            this.f82782o = obtainStyledAttributes.getBoolean(R.styleable.DtacClearableEditText_emojiExclude, false);
