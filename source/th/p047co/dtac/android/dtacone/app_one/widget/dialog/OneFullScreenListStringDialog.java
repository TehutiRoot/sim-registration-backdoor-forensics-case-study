...
public final class OneFullScreenListStringDialog extends BaseDialogFragment {
    ...
    @Metadata(m28851d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\bf\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&¨\u0006\u0006"}, m28850d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/dialog/OneFullScreenListStringDialog$Listener;", "", "onChooseDataStringItem", "", "item", "", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    @Metadata(m28851d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0002\b\t\b\u0086\u0004\u0018\u00002\f\u0012\b\u0012\u00060\u0002R\u00020\u00030\u0001B)\u0012\u0016\u0010\u0007\u001a\u0012\u0012\u0004\u0012\u00020\u00050\u0004j\b\u0012\u0004\u0012\u00020\u0005`\u0006\u0012\b\u0010\b\u001a\u0004\u0018\u00010\u0005¢\u0006\u0004\b\t\u0010\nJ#\u0010\u000f\u001a\u00060\u0002R\u00020\u00032\u0006\u0010\f\u001a\u00020\u000b2\u0006\u0010\u000e\u001a\u00020\rH\u0016¢\u0006\u0004\b\u000f\u0010\u0010J#\u0010\u0014\u001a\u00020\u00132\n\u0010\u0011\u001a\u00060\u0002R\u00020\u00032\u0006\u0010\u0012\u001a\u00020\rH\u0016¢\u0006\u0004\b\u0014\u0010\u0015J\u000f\u0010\u0016\u001a\u00020\rH\u0016¢\u0006\u0004\b\u0016\u0010\u0017R$\u0010\u0007\u001a\u0012\u0012\u0004\u0012\u00020\u00050\u0004j\b\u0012\u0004\u0012\u00020\u0005`\u00068\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0018\u0010\u0019R\u0016\u0010\b\u001a\u0004\u0018\u00010\u00058\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u001a\u0010\u001b¨\u0006\u001c"}, m28850d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/dialog/OneFullScreenListStringDialog$RVDataAdapter;", "Landroidx/recyclerview/widget/RecyclerView$Adapter;", "Lth/co/dtac/android/dtacone/app_one/widget/dialog/OneFullScreenListStringDialog$ViewHolder;", "Lth/co/dtac/android/dtacone/app_one/widget/dialog/OneFullScreenListStringDialog;", "Ljava/util/ArrayList;", "", "Lkotlin/collections/ArrayList;", "datas", "markerData", "<init>", "(Lth/co/dtac/android/dtacone/app_one/widget/dialog/OneFullScreenListStringDialog;Ljava/util/ArrayList;Ljava/lang/String;)V", "Landroid/view/ViewGroup;", "parent", "", "viewType", "onCreateViewHolder", "(Landroid/view/ViewGroup;I)Lth/co/dtac/android/dtacone/app_one/widget/dialog/OneFullScreenListStringDialog$ViewHolder;", "holder", "position", "", "onBindViewHolder", "(Lth/co/dtac/android/dtacone/app_one/widget/dialog/OneFullScreenListStringDialog$ViewHolder;I)V", "getItemCount", "()I", PDPageLabelRange.STYLE_LETTERS_LOWER, "Ljava/util/ArrayList;", OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, "Ljava/lang/String;", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0})
    ...
    public final class RVDataAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        /* renamed from: a */
        public final ArrayList f82978a;

        /* renamed from: b */
        public final String f82979b;

        /* renamed from: c */
        public final /* synthetic */ OneFullScreenListStringDialog f82980c;
        ...
        public RVDataAdapter(@NotNull OneFullScreenListStringDialog oneFullScreenListStringDialog, @Nullable ArrayList<String> datas, String str) {
            ...
            this.f82980c = oneFullScreenListStringDialog;
            this.f82978a = datas;
            this.f82979b = str;
        }
        ...
        public void onBindViewHolder(@NotNull ViewHolder holder, int i) {
            ...
            String str2 = this.f82979b;
            if (str2 != null && Intrinsics.areEqual(str2, str)) {
                tvDataString.setTextColor(ContextCompat.getColor(this.f82980c.requireContext(), this.f82980c.m19742p()));
                holder.getLayoutText().setBackgroundResource(this.f82980c.m19740r());
            } else {
                tvDataString.setTextColor(ContextCompat.getColor(this.f82980c.requireContext(), R.color.jet_back));
    ...
    public final class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        /* renamed from: b */
        public final LinearLayoutCompat f82982b;

        /* renamed from: c */
        public final OneFontTextView f82983c;

        /* renamed from: d */
        public final View f82984d;

        /* renamed from: e */
        public final /* synthetic */ OneFullScreenListStringDialog f82985e;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public ViewHolder(@NotNull OneFullScreenListStringDialog oneFullScreenListStringDialog, View v) {
            super(v);
            Intrinsics.checkNotNullParameter(v, "v");
            this.f82985e = oneFullScreenListStringDialog;
            ...
            this.f82982b = (LinearLayoutCompat) findViewById2;
            ...
            this.f82983c = (OneFontTextView) findViewById3;
        ...
        public void onClick(@NotNull View v) {
            Intrinsics.checkNotNullParameter(v, "v");
            Listener listener = this.f82985e.f82977a;
            if (listener != null) {
                Object tag = v.getTag();
                Intrinsics.checkNotNull(tag, "null cannot be cast to non-null type kotlin.String");
                listener.onChooseDataStringItem((String) tag);
            }
            this.f82985e.dismiss();
        }
    }

    /* renamed from: n */
    public static /* synthetic */ void m19744n(OneFullScreenListStringDialog oneFullScreenListStringDialog, View view) {
        m19739s(oneFullScreenListStringDialog, view);
    }

    /* renamed from: s */
    public static final void m19739s(OneFullScreenListStringDialog this$0, View view) {
    ...
    public final void initialView(@NotNull View view) {
        ...
        recyclerView.setAdapter(new RVDataAdapter(this, m19743o(), m19741q()));
        recyclerView.scrollToPosition(CollectionsKt___CollectionsKt.indexOf((List<? extends String>) m19743o(), m19741q()));
        ...
        ((AppCompatImageView) findViewById3).setOnClickListener(new View.OnClickListener() { // from class: bT0
            {
                OneFullScreenListStringDialog.this = this;
            }

            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                OneFullScreenListStringDialog.m19744n(OneFullScreenListStringDialog.this, view2);
            }
        });
    }

    /* renamed from: o */
    public final ArrayList m19743o() {
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        if (targetFragment != null && (targetFragment instanceof Listener)) {
            this.f82977a = (Listener) targetFragment;
        }
        return inflate;
    }

    /* renamed from: p */
    public final int m19742p() {
        Bundle arguments = getArguments();
        if (arguments != null) {
