...
public final class PagerIndicatorKt {
    ...
    public static final void PagerPreview(@Nullable Composer composer, int i) {
        ...
        if (i == 0 && startRestartGroup.getSkipping()) {
            ...
            composer2 = startRestartGroup;
            PagerKt.m69676HorizontalPagerxYaah8o(rememberPagerState, null, null, null, 0, 0.0f, companion2.getTop(), null, false, false, null, null, ComposableSingletons$PagerIndicatorKt.INSTANCE.m74945getLambda1$app_prodRelease(), startRestartGroup, 1572864, 384, 4030);
            Color.Companion companion4 = Color.Companion;
            m74949ScrollingPagerIndicatorP3dhf8A(rememberPagerState, companion4.m71768getMagenta0d7_KjU(), SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), companion4.m71765getGray0d7_KjU(), 0, C3641Dp.m73658constructorimpl(16), C3641Dp.m73658constructorimpl(10), C3641Dp.m73658constructorimpl(8), composer2, 14355888, 16);
    ...
    */
    ...
    public static final void ScrollingPagerIndicatorPreview1(@Nullable Composer composer, int i) {
        ...
        if (i == 0 && startRestartGroup.getSkipping()) {
            ...
            int i4 = 0;
            while (i4 < 10) {
                PagerState rememberPagerState = PagerStateKt.rememberPagerState(i4, 0.0f, C14180xb0bb60aa.INSTANCE, startRestartGroup, 384, 2);
                if (i4 % 2 == 0) {
                ...
                m74949ScrollingPagerIndicatorP3dhf8A(rememberPagerState, colorResource, PaddingKt.m69533paddingqDBjuR0$default(SizeKt.fillMaxWidth$default(Modifier.Companion, 0.0f, 1, null), 0.0f, 0.0f, 0.0f, C3641Dp.m73658constructorimpl(16), 7, null), 0L, 0, 0.0f, 0.0f, 0.0f, startRestartGroup, 384, 248);
                i4++;
        ...
        if (i == 0 && startRestartGroup.getSkipping()) {
            ...
            while (i4 < 4) {
                ...
                if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                    rememberedValue = new C14181x5707b916(4);
