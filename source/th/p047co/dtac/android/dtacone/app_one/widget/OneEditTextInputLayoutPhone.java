...
public final class OneEditTextInputLayoutPhone extends LinearLayout {
    ...
    /* renamed from: a */
    public OnTextChangListener f82786a;

    /* renamed from: b */
    public TextView f82787b;

    /* renamed from: c */
    public FrameLayout f82788c;

    /* renamed from: d */
    public OneClearableEditText f82789d;

    /* renamed from: e */
    public ImageView f82790e;

    /* renamed from: f */
    public TextView f82791f;

    /* renamed from: g */
    public TextView f82792g;

    /* renamed from: h */
    public String f82793h;

    /* renamed from: i */
    public String f82794i;

    /* renamed from: j */
    public String f82795j;

    /* renamed from: k */
    public String f82796k;

    /* renamed from: l */
    public boolean f82797l;

    /* renamed from: m */
    public boolean f82798m;

    /* renamed from: n */
    public boolean f82799n;
    ...
    @Metadata(m28851d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\u0012\u0010\u0002\u001a\u00020\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005H&¨\u0006\u0006"}, m28850d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/OneEditTextInputLayoutPhone$OnTextChangListener;", "", "afterTextChanged", "", OperatorName.CLOSE_AND_STROKE, "Landroid/text/Editable;", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    /* renamed from: a */
    public static /* synthetic */ void m19906a(OneEditTextInputLayoutPhone oneEditTextInputLayoutPhone, View view) {
        m19899h(oneEditTextInputLayoutPhone, view);
    }

    public static final /* synthetic */ void access$animateLabel(OneEditTextInputLayoutPhone oneEditTextInputLayoutPhone, boolean z) {
        oneEditTextInputLayoutPhone.m19903d(z);
    }

    public static final /* synthetic */ ImageView access$getClearButton$p(OneEditTextInputLayoutPhone oneEditTextInputLayoutPhone) {
        return oneEditTextInputLayoutPhone.f82790e;
    }

    public static final /* synthetic */ TextView access$getLabelTextView$p(OneEditTextInputLayoutPhone oneEditTextInputLayoutPhone) {
        return oneEditTextInputLayoutPhone.f82787b;
    }

    public static final /* synthetic */ OnTextChangListener access$getListener$p(OneEditTextInputLayoutPhone oneEditTextInputLayoutPhone) {
        return oneEditTextInputLayoutPhone.f82786a;
    }

    public static final /* synthetic */ void access$updateClearButtonVisibility(OneEditTextInputLayoutPhone oneEditTextInputLayoutPhone) {
        oneEditTextInputLayoutPhone.m19898i();
    }

    /* renamed from: b */
    public static /* synthetic */ void m19905b(OneEditTextInputLayoutPhone oneEditTextInputLayoutPhone, OneClearableEditText oneClearableEditText, View view, boolean z) {
        m19900g(oneEditTextInputLayoutPhone, oneClearableEditText, view, z);
    }

    /* renamed from: c */
    public static /* synthetic */ void m19904c(OneEditTextInputLayoutPhone oneEditTextInputLayoutPhone, Function0 function0, View view) {
        m19901f(oneEditTextInputLayoutPhone, function0, view);
    }

    /* renamed from: f */
    public static final void m19901f(OneEditTextInputLayoutPhone this$0, Function0 listener, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(listener, "$listener");
        OneClearableEditText oneClearableEditText = this$0.f82789d;
        ...
        OneClearableEditText oneClearableEditText3 = this$0.f82789d;
    ...
    /* renamed from: g */
    public static final void m19900g(OneEditTextInputLayoutPhone this$0, OneClearableEditText this_apply, View view, boolean z) {
        boolean z2;
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    /* renamed from: h */
    public static final void m19899h(OneEditTextInputLayoutPhone this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        OneClearableEditText oneClearableEditText = this$0.f82789d;
        OneClearableEditText oneClearableEditText2 = null;
        if (oneClearableEditText == null) {
    ...
    private final void setupViews(AttributeSet attributeSet) {
        ...
        textView.setTextColor(this.f82800o);
        textView.setText(this.f82793h);
        textView.setVisibility(4);
        textView.setAlpha(0.0f);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-1, -2);
        layoutParams.setMargins(0, 0, 0, m19902e(4));
        textView.setLayoutParams(layoutParams);
        textView.setTypeface(ResourcesCompat.getFont(textView.getContext(), R.font.one_font_style));
        this.f82787b = textView;
        addView(textView);
        FrameLayout frameLayout = new FrameLayout(getContext());
        frameLayout.setLayoutParams(new LinearLayout.LayoutParams(-1, -2));
        this.f82788c = frameLayout;
        View view = null;
        if (attributeSet != null) {
            Context context = getContext();
            Intrinsics.checkNotNullExpressionValue(context, "context");
            final OneClearableEditText oneClearableEditText = new OneClearableEditText(context, attributeSet);
            oneClearableEditText.setHint(this.f82794i);
            oneClearableEditText.setInputType(3);
            oneClearableEditText.setShowClearButton(false);
            FrameLayout.LayoutParams layoutParams2 = new FrameLayout.LayoutParams(-1, -2);
            oneClearableEditText.setPadding(oneClearableEditText.getPaddingLeft(), oneClearableEditText.getPaddingTop(), m19902e(48), oneClearableEditText.getPaddingBottom());
            oneClearableEditText.setLayoutParams(layoutParams2);
            oneClearableEditText.setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: FS0
                @Override // android.view.View.OnFocusChangeListener
                public final void onFocusChange(View view2, boolean z) {
                    OneEditTextInputLayoutPhone.m19905b(OneEditTextInputLayoutPhone.this, oneClearableEditText, view2, z);
                }
            });
            oneClearableEditText.addTextChangedListener(new TextWatcher() { // from class: th.co.dtac.android.dtacone.app_one.widget.OneEditTextInputLayoutPhone$setupViews$3$1$2
                ...
                public void afterTextChanged(@Nullable Editable editable) {
                    boolean z;
                    OneEditTextInputLayoutPhone.OnTextChangListener access$getListener$p = OneEditTextInputLayoutPhone.access$getListener$p(OneEditTextInputLayoutPhone.this);
                    if (access$getListener$p != null) {
                        access$getListener$p.afterTextChanged(editable);
                    }
                    ...
                    OneEditTextInputLayoutPhone.access$animateLabel(oneEditTextInputLayoutPhone, z);
                    OneEditTextInputLayoutPhone.access$updateClearButtonVisibility(OneEditTextInputLayoutPhone.this);
            ...
            try {
                oneClearableEditText.setTextColor(ResourcesCompat.getColor(oneClearableEditText.getResources(), this.f82801p, null));
                oneClearableEditText.setFocusColor(this.f82801p);
                oneClearableEditText.setBackgroundResource(this.f82803r);
                oneClearableEditText.setHighlightColor(ResourcesCompat.getColor(oneClearableEditText.getResources(), this.f82804s, null));
                oneClearableEditText.setTextAndCompoundColor(this.f82801p);
                oneClearableEditText.setLinkTextColor(ResourcesCompat.getColor(oneClearableEditText.getResources(), this.f82801p, null));
                if (Build.VERSION.SDK_INT >= 29) {
                    oneClearableEditText.setTextCursorDrawable(this.f82802q);
                } else {
                    try {
                        Field declaredField = TextView.class.getDeclaredField("mCursorDrawableRes");
                        Intrinsics.checkNotNullExpressionValue(declaredField, "TextView::class.java.get…eld(\"mCursorDrawableRes\")");
                        declaredField.setAccessible(true);
                        OneClearableEditText oneClearableEditText2 = this.f82789d;
                        if (oneClearableEditText2 == null) {
                            Intrinsics.throwUninitializedPropertyAccessException("editText");
                            oneClearableEditText2 = null;
                        }
                        declaredField.set(oneClearableEditText2, Integer.valueOf(this.f82802q));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
            ...
            this.f82789d = oneClearableEditText;
        }
        FrameLayout frameLayout2 = this.f82788c;
        if (frameLayout2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("editTextContainer");
            frameLayout2 = null;
        }
        OneClearableEditText oneClearableEditText3 = this.f82789d;
        if (oneClearableEditText3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("editText");
        ...
        FrameLayout.LayoutParams layoutParams3 = new FrameLayout.LayoutParams(m19902e(40), m19902e(40));
        layoutParams3.gravity = 8388629;
        layoutParams3.setMargins(0, 0, m19902e(4), 0);
        imageView.setLayoutParams(layoutParams3);
        imageView.setVisibility(8);
        imageView.setOnClickListener(new View.OnClickListener() { // from class: GS0
            {
                OneEditTextInputLayoutPhone.this = this;
            }

            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                OneEditTextInputLayoutPhone.m19906a(OneEditTextInputLayoutPhone.this, view2);
            }
        });
        ...
        this.f82790e = imageView;
        FrameLayout frameLayout3 = this.f82788c;
        if (frameLayout3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("editTextContainer");
            frameLayout3 = null;
        }
        ImageView imageView2 = this.f82790e;
        if (imageView2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("clearButton");
            imageView2 = null;
        }
        frameLayout3.addView(imageView2);
        View view2 = this.f82788c;
        if (view2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("editTextContainer");
        } else {
            view = view2;
        ...
        textView2.setTextColor(this.f82805t);
        textView2.setText(this.f82795j);
        if (this.f82798m && this.f82795j.length() > 0) {
            i = 0;
        } else {
            i = 8;
        }
    ...
    public final void clearError() {
        ...
        TextView textView = this.f82792g;
        ...
        if (this.f82798m && this.f82795j.length() > 0) {
            TextView textView2 = this.f82791f;
            if (textView2 == null) {
    ...
    /* renamed from: d */
    public final void m19903d(boolean z) {
        if (this.f82793h.length() == 0) {
            return;
        }
        TextView textView = null;
        if (z) {
            TextView textView2 = this.f82787b;
            if (textView2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("labelTextView");
                textView2 = null;
            }
            if (textView2.getVisibility() != 0) {
                TextView textView3 = this.f82787b;
                if (textView3 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("labelTextView");
                    textView3 = null;
                }
                textView3.setVisibility(0);
                TextView textView4 = this.f82787b;
                if (textView4 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("labelTextView");
                    textView4 = null;
                }
                textView4.setAlpha(0.0f);
                TextView textView5 = this.f82787b;
                if (textView5 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("labelTextView");
                    textView5 = null;
                }
                ObjectAnimator ofFloat = ObjectAnimator.ofFloat(textView5, "alpha", 0.0f, 1.0f);
                TextView textView6 = this.f82787b;
                if (textView6 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("labelTextView");
                    textView6 = null;
                }
                ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(textView6, "translationX", 20.0f, 0.0f);
                TextView textView7 = this.f82787b;
                if (textView7 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("labelTextView");
                } else {
                    textView = textView7;
    ...
    /* renamed from: e */
    public final int m19902e(int i) {
    ...
    */
    public final void m19898i() {
        /*
            Method dump skipped, instructions count: 362
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: th.p047co.dtac.android.dtacone.app_one.widget.OneEditTextInputLayoutPhone.m19898i():void");
    }
    ...
    public final boolean isClearButtonVisible() {
        ImageView imageView = this.f82790e;
        if (imageView == null) {
            Intrinsics.throwUninitializedPropertyAccessException("clearButton");
            imageView = null;
        }
    ...
    public final boolean isLabelVisible() {
        TextView textView = this.f82787b;
        if (textView == null) {
            Intrinsics.throwUninitializedPropertyAccessException("labelTextView");
            textView = null;
        }
    ...
    public final void setClearButtonClickListener(@NotNull final Function0<Unit> listener) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: ES0
            ...
            public final void onClick(View view) {
                OneEditTextInputLayoutPhone.m19904c(OneEditTextInputLayoutPhone.this, listener, view);
            }
        });
    }
    ...
    public final void setError(@Nullable String str) {
        ...
        if (str != null && str.length() > 0) {
            ...
            TextView textView2 = this.f82792g;
            if (textView2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("errorTextView");
                textView2 = null;
            }
            textView2.setVisibility(0);
            TextView textView3 = this.f82791f;
            if (textView3 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("helperTextView");
                textView3 = null;
            }
    ...
    public final void setHelperText(@NotNull String helper) {
        ...
        this.f82795j = helper;
        TextView textView = this.f82791f;
    ...
    */
    public final void setLabelText(@org.jetbrains.annotations.NotNull java.lang.String r4) {
        /*
            ...
            r3.f82793h = r4
            android.widget.TextView r0 = r3.f82787b
        ...
        L12:
            r0.setText(r4)
            java.lang.String r4 = r3.f82793h
            int r4 = r4.length()
            if (r4 <= 0) goto L48
            th.co.dtac.android.dtacone.app_one.widget.OneClearableEditText r4 = r3.f82789d
        ...
        L43:
            ...
            goto L61
        L48:
            android.widget.TextView r4 = r3.f82787b
            if (r4 != 0) goto L50
            kotlin.jvm.internal.Intrinsics.throwUninitializedPropertyAccessException(r1)
            r4 = r2
        L50:
    ...
    public OneEditTextInputLayoutPhone(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.f82796k = "";
        this.f82799n = true;
        this.f82800o = ContextCompat.getColor(context, 17170444);
        this.f82801p = R.color.grayishBrown48;
        this.f82802q = R.drawable.text_cursor_gray;
        this.f82803r = R.drawable.selector_rectangle_red;
        this.f82804s = R.color.highlightColorRed;
        this.f82805t = ContextCompat.getColor(context, 17170432);
        this.f82806u = ContextCompat.getColor(context, 17170454);
        setOrientation(1);
        ...
        try {
            ...
            this.f82793h = string == null ? "" : string;
            String string2 = obtainStyledAttributes.getString(R.styleable.OneEditTextInputLayout_hintText);
            this.f82794i = string2 == null ? "" : string2;
            String string3 = obtainStyledAttributes.getString(R.styleable.OneEditTextInputLayout_helperText);
            if (string3 != null) {
                str = string3;
            }
            this.f82795j = str;
            this.f82798m = obtainStyledAttributes.getBoolean(R.styleable.OneEditTextInputLayout_helperTextEnabled, false);
            this.f82797l = obtainStyledAttributes.getBoolean(R.styleable.OneEditTextInputLayout_errorEnabled, false);
            this.f82799n = obtainStyledAttributes.getBoolean(R.styleable.OneEditTextInputLayout_showInputLayoutClearButton, true);
            this.f82800o = obtainStyledAttributes.getColor(R.styleable.OneEditTextInputLayout_labelTextColor, this.f82800o);
            this.f82805t = obtainStyledAttributes.getColor(R.styleable.OneEditTextInputLayout_helperTextColor, this.f82805t);
            this.f82806u = obtainStyledAttributes.getColor(R.styleable.OneEditTextInputLayout_errorTextColor, this.f82806u);
