...
public final class OneTextInputLayoutText extends FrameLayout implements TextWatcher, View.OnFocusChangeListener {
    ...
    /* renamed from: a */
    public boolean f82867a;

    /* renamed from: b */
    public OnTextChangListener f82868b;

    /* renamed from: c */
    public boolean f82869c;

    /* renamed from: d */
    public Boolean f82870d;

    /* renamed from: e */
    public final LayoutInflater f82871e;

    /* renamed from: f */
    public final TypedArray f82872f;

    /* renamed from: g */
    public final OneEditText f82873g;

    @Metadata(m28851d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\u0012\u0010\u0002\u001a\u00020\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005H&¨\u0006\u0006"}, m28850d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/OneTextInputLayoutText$OnTextChangListener;", "", "afterTextChanged", "", OperatorName.CLOSE_AND_STROKE, "Landroid/text/Editable;", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    public OneTextInputLayoutText(@NotNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.f82870d = Boolean.TRUE;
        Object systemService = context.getSystemService("layout_inflater");
        Intrinsics.checkNotNull(systemService, "null cannot be cast to non-null type android.view.LayoutInflater");
        this.f82871e = (LayoutInflater) systemService;
        ...
        this.f82872f = obtainStyledAttributes;
        m19854c();
        this.f82873g = (OneEditText) findViewById(R.id.edtText);
    }

    /* renamed from: a */
    public static /* synthetic */ void m19856a(OneEditText oneEditText, View view) {
        m19853d(oneEditText, view);
    }

    public static final /* synthetic */ void access$setIgnoreNextTextChange$p(OneTextInputLayoutText oneTextInputLayoutText, boolean z) {
        oneTextInputLayoutText.f82867a = z;
    }

    /* renamed from: b */
    public static /* synthetic */ CharSequence m19855b(String str, CharSequence charSequence, int i, int i2, Spanned spanned, int i3, int i4) {
        return m19852e(str, charSequence, i, i2, spanned, i3, i4);
    }

    /* renamed from: d */
    public static final void m19853d(OneEditText oneEditText, View view) {
        Intrinsics.checkNotNullParameter(oneEditText, "$oneEditText");
        oneEditText.setText("");
    }

    /* renamed from: e */
    public static final CharSequence m19852e(String digits, CharSequence charSequence, int i, int i2, Spanned spanned, int i3, int i4) {
    ...
    public void afterTextChanged(@Nullable Editable editable) {
        ...
        OnTextChangListener onTextChangListener = this.f82868b;
        ...
        if (i > 0 && Intrinsics.areEqual(this.f82870d, Boolean.TRUE) && this.f82869c) {
    ...
    public final void blockCopyPaste() {
        ...
        oneEditText.setUpdateListener(new OneEditText.UpdateListener() { // from class: th.co.dtac.android.dtacone.app_one.widget.OneTextInputLayoutText$blockCopyPaste$1
            ...
            @Override // th.p047co.dtac.android.dtacone.app_one.widget.OneEditText.UpdateListener
            public void onPaste() {
                OneTextInputLayoutText.access$setIgnoreNextTextChange$p(OneTextInputLayoutText.this, true);
    ...
    /* renamed from: c */
    public final void m19854c() {
        CharSequence text;
        addView(this.f82871e.inflate(R.layout.one_text_input_layout_text, (ViewGroup) null));
        if (this.f82872f.hasValue(R.styleable.OneTextInputLayoutText_isCopyPaste) && !this.f82872f.getBoolean(R.styleable.OneTextInputLayoutText_isCopyPaste, true)) {
            blockCopyPaste();
        }
        View findViewById = findViewById(R.id.btnClearText);
        Intrinsics.checkNotNullExpressionValue(findViewById, "findViewById(R.id.btnClearText)");
        ...
        ((ImageView) findViewById).setOnClickListener(new View.OnClickListener() { // from class: xe1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                OneTextInputLayoutText.m19856a(OneEditText.this, view);
            }
        });
        oneTextInputLayout.setTypeface(ResourcesCompat.getFont(getContext(), R.font.one_font_style));
        CharSequence text2 = this.f82872f.getText(R.styleable.OneTextInputLayoutText_input_text);
        if (text2 != null) {
            oneEditText.setText(text2);
        }
        oneEditText.setTextSize(this.f82872f.getDimension(R.styleable.OneTextInputLayoutText_input_size, 18.0f));
        CharSequence text3 = this.f82872f.getText(R.styleable.OneTextInputLayoutText_input_hint);
        if (text3 != null) {
            oneTextInputLayout.setHint(text3);
        }
        int i = this.f82872f.getInt(R.styleable.OneTextInputLayoutText_input_maxLength, 0);
        if (i > 0) {
            oneEditText.setFilters(new InputFilter.LengthFilter[]{new InputFilter.LengthFilter(i)});
        }
        int i2 = this.f82872f.getInt(R.styleable.OneTextInputLayoutText_android_inputType, 0);
        if (i2 != 0) {
            oneEditText.setInputType(i2);
        }
        if (this.f82872f.hasValue(R.styleable.OneTextInputLayoutText_is_enable)) {
            if (this.f82872f.getBoolean(R.styleable.OneTextInputLayoutText_is_enable, true)) {
                ViewEnableKt.toEnable(oneEditText);
            } else {
                ViewEnableKt.toDisable(oneEditText);
            }
        }
        if (this.f82872f.hasValue(R.styleable.OneTextInputLayoutText_isShowClear)) {
            this.f82870d = Boolean.valueOf(this.f82872f.getBoolean(R.styleable.OneTextInputLayoutText_isShowClear, true));
        }
        if (this.f82872f.hasValue(R.styleable.OneTextInputLayoutText_android_imeOptions)) {
            oneEditText.setImeOptions(this.f82872f.getInt(R.styleable.OneTextInputLayoutText_android_imeOptions, 0));
        }
        if (this.f82872f.hasValue(R.styleable.OneTextInputLayoutText_isDigitNumber) && this.f82872f.getBoolean(R.styleable.OneTextInputLayoutText_isDigitNumber, false)) {
            setDigitNumber();
        }
        if (this.f82872f.hasValue(R.styleable.OneTextInputLayoutText_digits_text) && (text = this.f82872f.getText(R.styleable.OneTextInputLayoutText_digits_text)) != null) {
    ...
    public void onFocusChange(@Nullable View view, boolean z) {
        ...
        if (z) {
            ...
            if (i > 0 && Intrinsics.areEqual(this.f82870d, Boolean.TRUE)) {
                ViewVisibleExtKt.toVisible(imageView);
                return;
            } else {
                ViewVisibleExtKt.toGone(imageView);
    ...
    public final void setDigit(@NotNull final String digits) {
        Intrinsics.checkNotNullParameter(digits, "digits");
        InputFilter[] inputFilterArr = {new InputFilter() { // from class: ye1
            @Override // android.text.InputFilter
            public final CharSequence filter(CharSequence charSequence, int i, int i2, Spanned spanned, int i3, int i4) {
                return OneTextInputLayoutText.m19855b(digits, charSequence, i, i2, spanned, i3, i4);
            }
        }};
        View findViewById = findViewById(R.id.edtText);
        Intrinsics.checkNotNullExpressionValue(findViewById, "findViewById(R.id.edtText)");
