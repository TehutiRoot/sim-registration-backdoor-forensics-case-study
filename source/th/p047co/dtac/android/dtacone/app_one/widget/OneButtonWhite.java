...
@Metadata(m28851d1 = {"\u0000N\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0007\u0018\u00002\u00020\u0001B\u0011\b\u0016\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005B\u0019\b\u0016\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0007\u001a\u00020\u0006¢\u0006\u0004\b\u0004\u0010\bB!\b\u0016\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0007\u001a\u00020\u0006\u0012\u0006\u0010\n\u001a\u00020\t¢\u0006\u0004\b\u0004\u0010\u000bJ\u0015\u0010\u000f\u001a\u00020\u000e2\u0006\u0010\r\u001a\u00020\f¢\u0006\u0004\b\u000f\u0010\u0010J\u000f\u0010\u0011\u001a\u00020\u000eH\u0002¢\u0006\u0004\b\u0011\u0010\u0012R\u0016\u0010\u0015\u001a\u00020\u00138\u0002@\u0002X\u0082.¢\u0006\u0006\n\u0004\b\u0011\u0010\u0014R\u0014\u0010\u0019\u001a\u00020\u00168\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0017\u0010\u0018R\u0014\u0010\u001d\u001a\u00020\u001a8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u001b\u0010\u001cR\u0016\u0010!\u001a\u00020\u001e8\u0002@\u0002X\u0082.¢\u0006\u0006\n\u0004\b\u001f\u0010 ¨\u0006\""}, m28850d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/OneButtonWhite;", "Landroid/widget/FrameLayout;", "Landroid/content/Context;", CoreConstants.CONTEXT_SCOPE_VALUE, "<init>", "(Landroid/content/Context;)V", "Landroid/util/AttributeSet;", "attrs", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "", "defStyleAttr", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "", TextBundle.TEXT_ENTRY, "", "setText", "(Ljava/lang/String;)V", PDPageLabelRange.STYLE_LETTERS_LOWER, "()V", "Landroid/content/res/TypedArray;", "Landroid/content/res/TypedArray;", "attributes", "Landroid/view/LayoutInflater;", OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, "Landroid/view/LayoutInflater;", "inflater", "Landroid/view/View;", OperatorName.CURVE_TO, "Landroid/view/View;", Promotion.ACTION_VIEW, "Lth/co/dtac/android/dtacone/app_one/widget/OneFontTextView;", "d", "Lth/co/dtac/android/dtacone/app_one/widget/OneFontTextView;", "tvBtn", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0})
...
public final class OneButtonWhite extends FrameLayout {
    ...
    /* renamed from: a */
    public TypedArray f82754a;

    /* renamed from: b */
    public final LayoutInflater f82755b;

    /* renamed from: c */
    public final View f82756c;

    /* renamed from: d */
    public OneFontTextView f82757d;
    ...
    public OneButtonWhite(@NotNull Context context) {
        ...
        this.f82756c = inflate;
        m19908a();
    }

    /* renamed from: a */
    public final void m19908a() {
        View findViewById = this.f82756c.findViewById(R.id.tvBtn);
        Intrinsics.checkNotNullExpressionValue(findViewById, "view.findViewById(R.id.tvBtn)");
        this.f82757d = (OneFontTextView) findViewById;
        TypedArray typedArray = this.f82754a;
        ...
        if (typedArray.hasValue(R.styleable.OneButton_android_text)) {
            OneFontTextView oneFontTextView = this.f82757d;
            if (oneFontTextView == null) {
                Intrinsics.throwUninitializedPropertyAccessException("tvBtn");
                oneFontTextView = null;
            }
            Context context = getContext();
            TypedArray typedArray3 = this.f82754a;
            if (typedArray3 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("attributes");
                typedArray3 = null;
            }
        ...
        TypedArray typedArray4 = this.f82754a;
        if (typedArray4 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("attributes");
            typedArray4 = null;
        }
        if (typedArray4.hasValue(R.styleable.OneButton_android_textSize)) {
            OneFontTextView oneFontTextView2 = this.f82757d;
            if (oneFontTextView2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("tvBtn");
                oneFontTextView2 = null;
            }
            TypedArray typedArray5 = this.f82754a;
            if (typedArray5 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("attributes");
                typedArray5 = null;
            }
        ...
        TypedArray typedArray6 = this.f82754a;
        if (typedArray6 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("attributes");
            typedArray6 = null;
        }
        if (typedArray6.hasValue(R.styleable.OneButton_android_textColor)) {
            OneFontTextView oneFontTextView3 = this.f82757d;
            if (oneFontTextView3 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("tvBtn");
                oneFontTextView3 = null;
            }
            TypedArray typedArray7 = this.f82754a;
            if (typedArray7 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("attributes");
            } else {
    ...
    public OneButtonWhite(@NotNull Context context, @NotNull AttributeSet attrs) {
        ...
        this.f82754a = obtainStyledAttributes;
        m19908a();
    }
