...
public final class OneInfoDialogBox extends BaseDialogFragment {
    ...
    @Metadata(m28851d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u0004R\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000¨\u0006\b"}, m28850d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/dialog/OneInfoDialogBox$Companion;", "", "()V", "MESSAGE", "", "newInstance", "Lth/co/dtac/android/dtacone/app_one/widget/dialog/OneInfoDialogBox;", "message", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    /* renamed from: n */
    public static /* synthetic */ void m19738n(OneInfoDialogBox oneInfoDialogBox, View view) {
        m19736p(oneInfoDialogBox, view);
    }

    /* renamed from: o */
    private final String m19737o() {
        String str;
    ...
    /* renamed from: p */
    public static final void m19736p(OneInfoDialogBox this$0, View view) {
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        if (oneFontTextView != null) {
            oneFontTextView.setText(m19737o());
        }
        OneFontButton oneFontButton = (OneFontButton) inflate.findViewById(R.id.btnOk);
        if (oneFontButton != null) {
            oneFontButton.setOnClickListener(new View.OnClickListener() { // from class: WT0
                {
                    OneInfoDialogBox.this = this;
                }

                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    OneInfoDialogBox.m19738n(OneInfoDialogBox.this, view);
                }
            });
        }
        return inflate;
