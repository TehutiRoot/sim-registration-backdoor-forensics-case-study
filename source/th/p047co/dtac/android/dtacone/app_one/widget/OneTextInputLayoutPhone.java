...
public final class OneTextInputLayoutPhone extends FrameLayout implements TextWatcher, View.OnFocusChangeListener, OneEditText.UpdateListener {
    ...
    /* renamed from: c */
    public boolean f82863c;

    /* renamed from: d */
    public OnTextChangListener f82864d;

    /* renamed from: e */
    public final LayoutInflater f82865e;

    /* renamed from: f */
    public final TypedArray f82866f;

    @Metadata(m28851d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\u0012\u0010\u0002\u001a\u00020\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005H&¨\u0006\u0006"}, m28850d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/OneTextInputLayoutPhone$OnTextChangListener;", "", "afterTextChanged", "", OperatorName.CLOSE_AND_STROKE, "Landroid/text/Editable;", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    public OneTextInputLayoutPhone(@NotNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.f82861a = Boolean.TRUE;
        Object systemService = context.getSystemService("layout_inflater");
        Intrinsics.checkNotNull(systemService, "null cannot be cast to non-null type android.view.LayoutInflater");
        this.f82865e = (LayoutInflater) systemService;
        ...
        this.f82866f = obtainStyledAttributes;
        m19858b();
    }

    /* renamed from: a */
    public static /* synthetic */ void m19859a(OneEditText oneEditText, View view) {
        m19857c(oneEditText, view);
    }

    /* renamed from: b */
    private final void m19858b() {
        addView(this.f82865e.inflate(R.layout.one_text_input_layout_phone, (ViewGroup) null));
        ...
        ((ImageView) findViewById).setOnClickListener(new View.OnClickListener() { // from class: we1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                OneTextInputLayoutPhone.m19859a(OneEditText.this, view);
            }
        });
        ...
        if (this.f82866f.hasValue(R.styleable.OneTextInputLayoutPhone_is_enable)) {
            if (this.f82866f.getBoolean(R.styleable.OneTextInputLayoutPhone_is_enable, true)) {
                ViewEnableKt.toEnable(oneEditText);
            } else {
                ViewEnableKt.toDisable(oneEditText);
            }
        }
        if (this.f82866f.hasValue(R.styleable.OneTextInputLayoutPhone_input_hint)) {
            oneTextInputLayout.setHint(this.f82866f.getText(R.styleable.OneTextInputLayoutPhone_input_hint));
        }
        if (this.f82866f.hasValue(R.styleable.OneTextInputLayoutPhone_isShowClear)) {
            this.f82861a = Boolean.valueOf(this.f82866f.getBoolean(R.styleable.OneTextInputLayoutPhone_isShowClear, true));
        }
        if (this.f82866f.hasValue(R.styleable.OneTextInputLayoutPhone_isBlockPaste)) {
            this.f82862b = this.f82866f.getBoolean(R.styleable.OneTextInputLayoutPhone_isBlockPaste, false);
        }
        if (this.f82866f.hasValue(R.styleable.OneTextInputLayoutPhone_android_imeOptions)) {
            oneEditText.setImeOptions(this.f82866f.getInt(R.styleable.OneTextInputLayoutPhone_android_imeOptions, 0));
        }
    }

    /* renamed from: c */
    public static final void m19857c(OneEditText edtPhoneNumber, View view) {
    ...
    public void afterTextChanged(@Nullable Editable editable) {
        int i;
        OnTextChangListener onTextChangListener = this.f82864d;
        ...
        if (i > 0 && Intrinsics.areEqual(this.f82861a, Boolean.TRUE) && this.f82863c) {
    ...
    public void onFocusChange(@Nullable View view, boolean z) {
        ...
        if (z) {
            ...
            if (i > 0 && Intrinsics.areEqual(this.f82861a, Boolean.TRUE)) {
                ViewVisibleExtKt.toVisible(imageView);
                return;
            } else {
                ViewVisibleExtKt.toGone(imageView);
