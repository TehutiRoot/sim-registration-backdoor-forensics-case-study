...
public final class OneDialogRemainingPackages extends DialogFragment {
    ...
    private final void binding(View view) {
        ...
        this.f82965a = (RecyclerView) findViewById;
        ...
        this.f82966b = (OneButtonBlue) findViewById2;
    }

    private final void initView() {
        ThemeColorModel m19751p = m19751p();
        OneButtonBlue oneButtonBlue = null;
        if (m19751p != null) {
            OneButtonBlue oneButtonBlue2 = this.f82966b;
            if (oneButtonBlue2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("btnOk");
                oneButtonBlue2 = null;
            }
            oneButtonBlue2.setButtonBackground(m19751p.getButtonBackground());
        }
        OneButtonBlue oneButtonBlue3 = this.f82966b;
        if (oneButtonBlue3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("btnOk");
        } else {
            oneButtonBlue = oneButtonBlue3;
        }
        oneButtonBlue.setOnClickListener(new View.OnClickListener() { // from class: AS0
            {
                OneDialogRemainingPackages.this = this;
            }

            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                OneDialogRemainingPackages.m19753n(OneDialogRemainingPackages.this, view);
            }
        });
    }

    /* renamed from: n */
    public static /* synthetic */ void m19753n(OneDialogRemainingPackages oneDialogRemainingPackages, View view) {
        m19750q(oneDialogRemainingPackages, view);
    }

    /* renamed from: q */
    public static final void m19750q(OneDialogRemainingPackages this$0, View view) {
    ...
    /* renamed from: r */
    private final void m19749r() {
        RecyclerView recyclerView = this.f82965a;
        ...
        recyclerView.setAdapter(new OneRemainingPackagesAdapter(context, m19751p(), m19752o()));
    }

    /* renamed from: o */
    public final ArrayList m19752o() {
    ...
    /* renamed from: p */
    public final ThemeColorModel m19751p() {
        Object obj;
        Object parcelable;
        Bundle arguments = getArguments();
