...
public final class OnePasswordDialogSuccess extends AppCompatDialog {
    ...
    /* renamed from: f */
    public final Callback f82987f;

    /* renamed from: g */
    public final Integer f82988g;

    /* renamed from: h */
    public final Integer f82989h;

    /* renamed from: i */
    public ImageView f82990i;

    /* renamed from: j */
    public OneButtonBlue f82991j;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final int $stable = 8;

    @Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\b\u0010\u0002\u001a\u00020\u0003H&¨\u0006\u0004"}, m28850d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/dialog/OnePasswordDialogSuccess$Callback;", "", "onButtonClick", "", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    @Metadata(m28851d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002¨\u0006\u0003"}, m28850d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/dialog/OnePasswordDialogSuccess$Companion;", "", "()V", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    /* renamed from: f */
    public static /* synthetic */ void m19732f(OnePasswordDialogSuccess onePasswordDialogSuccess, View view) {
        m19731g(onePasswordDialogSuccess, view);
    }

    /* renamed from: g */
    public static final void m19731g(OnePasswordDialogSuccess this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Callback callback = this$0.f82987f;
        if (callback != null) {
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        this.f82991j = (OneButtonBlue) findViewById(R.id.btnOK);
        this.f82990i = (ImageView) findViewById(R.id.iconSuccess);
        OneButtonBlue oneButtonBlue = this.f82991j;
        if (oneButtonBlue != null) {
            oneButtonBlue.setOnClickListener(new View.OnClickListener() { // from class: h01
                {
                    OnePasswordDialogSuccess.this = this;
                }

                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    OnePasswordDialogSuccess.m19732f(OnePasswordDialogSuccess.this, view);
                }
            });
        }
        if (this.f82988g != null && (imageView = this.f82990i) != null) {
            imageView.setImageResource(this.f82988g.intValue());
        }
        Integer num = this.f82989h;
        if (num != null) {
            int intValue = num.intValue();
            OneButtonBlue oneButtonBlue2 = this.f82991j;
