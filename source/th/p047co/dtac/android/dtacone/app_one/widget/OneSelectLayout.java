...
@Metadata(m28851d1 = {"\u0000>\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0007\u0018\u00002\u00020\u0001B\u0019\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\b\u0010\u0005\u001a\u0004\u0018\u00010\u0004¢\u0006\u0004\b\u0006\u0010\u0007J\r\u0010\t\u001a\u00020\b¢\u0006\u0004\b\t\u0010\nJ\u0017\u0010\r\u001a\u00020\f2\b\u0010\u000b\u001a\u0004\u0018\u00010\b¢\u0006\u0004\b\r\u0010\u000eJ\u0017\u0010\u0011\u001a\u00020\f2\b\b\u0002\u0010\u0010\u001a\u00020\u000f¢\u0006\u0004\b\u0011\u0010\u0012J\u000f\u0010\u0013\u001a\u00020\fH\u0002¢\u0006\u0004\b\u0013\u0010\u0014R\u0014\u0010\u0017\u001a\u00020\u00158\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0013\u0010\u0016R\u0014\u0010\u001b\u001a\u00020\u00188\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0019\u0010\u001a¨\u0006\u001c"}, m28850d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/OneSelectLayout;", "Landroid/widget/FrameLayout;", "Landroid/content/Context;", CoreConstants.CONTEXT_SCOPE_VALUE, "Landroid/util/AttributeSet;", "attrs", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "", "getValueText", "()Ljava/lang/String;", TextBundle.TEXT_ENTRY, "", "setValueText", "(Ljava/lang/String;)V", "", "lines", "setMaxLine", "(I)V", PDPageLabelRange.STYLE_LETTERS_LOWER, "()V", "Landroid/view/LayoutInflater;", "Landroid/view/LayoutInflater;", "inflater", "Landroid/content/res/TypedArray;", OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, "Landroid/content/res/TypedArray;", "attributes", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0})
...
public final class OneSelectLayout extends FrameLayout {
    ...
    /* renamed from: a */
    public final LayoutInflater f82838a;

    /* renamed from: b */
    public final TypedArray f82839b;
    ...
    public OneSelectLayout(@NotNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.f82838a = (LayoutInflater) systemService;
        ...
        this.f82839b = obtainStyledAttributes;
        m19886a();
    }
    ...
    /* renamed from: a */
    public final void m19886a() {
        addView(this.f82838a.inflate(R.layout.one_select_layout, (ViewGroup) null));
        ...
        CharSequence text = this.f82839b.getText(R.styleable.OneSelectLayout_title_text);
        if (text != null) {
            textView.setText(text);
        }
        CharSequence text2 = this.f82839b.getText(R.styleable.OneSelectLayout_hint_text);
        if (text2 != null) {
            textView3.setText(text2);
        }
        CharSequence text3 = this.f82839b.getText(R.styleable.OneSelectLayout_max_line);
        if (text3 != null) {
