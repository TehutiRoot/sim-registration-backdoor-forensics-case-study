...
public final class OneTextInputSaveState extends View.BaseSavedState {
    ...
    @Metadata(m28851d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0014\u0010\u0003\u001a\u0006\u0012\u0002\b\u00030\u00048\u0006X\u0087\u0004¢\u0006\u0002\n\u0000¨\u0006\u0005"}, m28850d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/OneTextInputSaveState$Companion;", "", "()V", "CREATOR", "Landroid/os/Parcelable$Creator;", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    public OneTextInputSaveState(@NotNull Parcel source) {
        super(source);
        Intrinsics.checkNotNullParameter(source, "source");
        this.f82878a = source.readString();
        this.f82879b = source.readString();
        this.f82880c = source.readBundle(OneTextInputSaveState.class.getClassLoader());
    }
    ...
    public void writeToParcel(@NotNull Parcel out, int i) {
        ...
        out.writeString(this.f82878a);
        out.writeString(this.f82879b);
        out.writeParcelable(this.f82880c, 0);
    }
