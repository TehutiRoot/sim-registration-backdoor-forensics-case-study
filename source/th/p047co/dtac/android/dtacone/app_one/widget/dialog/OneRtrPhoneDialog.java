...
public final class OneRtrPhoneDialog extends DialogFragment {
    ...
    /* renamed from: a */
    public RecyclerView f82998a;

    /* renamed from: b */
    public OneFontTextView f82999b;

    /* renamed from: c */
    public ImageView f83000c;

    /* renamed from: d */
    public OneButtonRed f83001d;

    /* renamed from: e */
    public final Lazy f83002e = LazyKt__LazyJVMKt.lazy(OneRtrPhoneDialog$oneRtrAndPhoneAdapter$2.INSTANCE);

    /* renamed from: f */
    public SimData f83003f;

    /* renamed from: g */
    public Function1 f83004g;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final int $stable = 8;

    @Metadata(m28851d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bR\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\t"}, m28850d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/dialog/OneRtrPhoneDialog$Companion;", "", "()V", "EXTRA_TYPE", "", "newInstance", "Lth/co/dtac/android/dtacone/app_one/widget/dialog/OneRtrPhoneDialog;", "registrationType", "Lth/co/dtac/android/dtacone/app_one/util/enum/RegistrationType;", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    private final void binding(View view) {
        ...
        this.f82998a = (RecyclerView) findViewById;
        View findViewById2 = view.findViewById(R.id.title);
        Intrinsics.checkNotNullExpressionValue(findViewById2, "view.findViewById(R.id.title)");
        this.f82999b = (OneFontTextView) findViewById2;
        View findViewById3 = view.findViewById(R.id.close);
        Intrinsics.checkNotNullExpressionValue(findViewById3, "view.findViewById(R.id.close)");
        this.f83000c = (ImageView) findViewById3;
        ...
        this.f83001d = (OneButtonRed) findViewById4;
    }

    private final void initView() {
        m19723r();
        RecyclerView recyclerView = this.f82998a;
        ...
        recyclerView.setAdapter(m19726o());
        OneRtrAndPhoneAdapter m19726o = m19726o();
        m19726o.setOnSelectItem(new OneRtrPhoneDialog$initView$2$1(this));
        m19726o.setLastSelected(this.f83003f);
        ImageView imageView = this.f83000c;
        if (imageView == null) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: Nb1
            {
                OneRtrPhoneDialog.this = this;
            }

            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                OneRtrPhoneDialog.m19727n(OneRtrPhoneDialog.this, view);
            }
        });
        OneButtonRed oneButtonRed2 = this.f83001d;
    ...
    /* renamed from: n */
    public static /* synthetic */ void m19727n(OneRtrPhoneDialog oneRtrPhoneDialog, View view) {
        m19725p(oneRtrPhoneDialog, view);
    }

    /* renamed from: p */
    public static final void m19725p(OneRtrPhoneDialog this$0, View view) {
    ...
    /* renamed from: o */
    public final OneRtrAndPhoneAdapter m19726o() {
        return (OneRtrAndPhoneAdapter) this.f83002e.getValue();
    }
    ...
    public final void m19724q() {
        ...
        if (getArguments() != null && requireArguments().containsKey("EXTRA_TYPE")) {
            ...
            String str = "";
            if (i == 1) {
                OneFontTextView oneFontTextView = this.f82999b;
            ...
            OneFontTextView oneFontTextView2 = this.f82999b;
            ...
            OneButtonRed oneButtonRed3 = this.f83001d;
    ...
    public final void m19723r() {
        ...
        if (getArguments() != null && requireArguments().containsKey("EXTRA_TYPE")) {
            ...
            if (i == 1) {
                m19726o().setType(RegistrationType.PhoneMultiple);
            } else {
                m19726o().setType(RegistrationType.RtrCodeMultiple);
            }
        }
    }
    ...
    public final void setData(@NotNull ArrayList<SimData> res) {
        ...
        if (this.f83003f == null) {
            this.f83003f = (SimData) CollectionsKt___CollectionsKt.firstOrNull((List<? extends Object>) res);
        }
        m19726o().setData(CollectionsKt___CollectionsKt.toList(res));
        m19726o().notifyDataSetChanged();
    }

    public final void setLastSelectedItem(@Nullable SimData simData) {
        this.f83003f = simData;
    }

    public final void setOnButtonClick(@Nullable Function1<? super SimData, Unit> function1) {
        this.f83004g = function1;
    }
}
