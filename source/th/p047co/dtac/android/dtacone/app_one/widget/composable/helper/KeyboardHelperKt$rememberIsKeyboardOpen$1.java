...
@DebugMetadata(m28801c = "th.co.dtac.android.dtacone.app_one.widget.composable.helper.KeyboardHelperKt$rememberIsKeyboardOpen$1", m28800f = "KeyboardHelper.kt", m28799i = {}, m28798l = {37}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
...
public final class KeyboardHelperKt$rememberIsKeyboardOpen$1 extends SuspendLambda implements Function2<ProduceStateScope<Boolean>, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes7.dex */
    public static final class C141841 extends Lambda implements Function0<Unit> {
        final /* synthetic */ ViewTreeObserver.OnGlobalLayoutListener $listener;
        final /* synthetic */ ViewTreeObserver $viewTreeObserver;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C141841(ViewTreeObserver viewTreeObserver, ViewTreeObserver.OnGlobalLayoutListener onGlobalLayoutListener) {
            super(0);
    ...
    /* renamed from: a */
    public static /* synthetic */ void m19809a(ProduceStateScope produceStateScope, View view) {
        invokeSuspend$lambda$0(produceStateScope, view);
    }
        ...
        if (i != 0) {
            ...
            ViewTreeObserver.OnGlobalLayoutListener onGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() { // from class: th.co.dtac.android.dtacone.app_one.widget.composable.helper.a
                ...
                public final void onGlobalLayout() {
                    KeyboardHelperKt$rememberIsKeyboardOpen$1.m19809a(produceStateScope, view);
                }
            };
            viewTreeObserver.addOnGlobalLayoutListener(onGlobalLayoutListener);
            C141841 c141841 = new C141841(viewTreeObserver, onGlobalLayoutListener);
            this.label = 1;
            if (produceStateScope.awaitDispose(c141841, this) == coroutine_suspended) {
