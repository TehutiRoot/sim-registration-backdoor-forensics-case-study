...
public final class OneErrorDialogBox extends AppCompatDialog {
    ...
    /* renamed from: f */
    public final Context f82973f;

    /* renamed from: g */
    public final Callback f82974g;

    /* renamed from: h */
    public RelativeLayout f82975h;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final int $stable = 8;

    @Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\b\u0010\u0002\u001a\u00020\u0003H&¨\u0006\u0004"}, m28850d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/dialog/OneErrorDialogBox$Callback;", "", "onButtonClick", "", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    @Metadata(m28851d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002¨\u0006\u0003"}, m28850d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/dialog/OneErrorDialogBox$Companion;", "", "()V", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    public static final /* synthetic */ Context access$getMContext$p(OneErrorDialogBox oneErrorDialogBox) {
        return oneErrorDialogBox.f82973f;
    }

    public static final /* synthetic */ RelativeLayout access$getRelativeLayout$p(OneErrorDialogBox oneErrorDialogBox) {
        return oneErrorDialogBox.f82975h;
    }

    /* renamed from: f */
    public static /* synthetic */ void m19746f(OneErrorDialogBox oneErrorDialogBox, View view) {
        m19745g(oneErrorDialogBox, view);
    }

    /* renamed from: g */
    public static final void m19745g(OneErrorDialogBox this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Callback callback = this$0.f82974g;
        if (callback != null) {
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        DisplayMetrics displayMetrics = this.f82973f.getResources().getDisplayMetrics();
        ...
        if (relativeLayout != null && (viewTreeObserver = relativeLayout.getViewTreeObserver()) != null) {
            viewTreeObserver.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: th.co.dtac.android.dtacone.app_one.widget.dialog.OneErrorDialogBox$onCreate$1
                ...
                public void onGlobalLayout() {
                    ...
                    RelativeLayout access$getRelativeLayout$p = OneErrorDialogBox.access$getRelativeLayout$p(OneErrorDialogBox.this);
                    if (access$getRelativeLayout$p != null && (viewTreeObserver2 = access$getRelativeLayout$p.getViewTreeObserver()) != null) {
                        viewTreeObserver2.removeOnGlobalLayoutListener(this);
                    }
                    RelativeLayout access$getRelativeLayout$p2 = OneErrorDialogBox.access$getRelativeLayout$p(OneErrorDialogBox.this);
                    if (access$getRelativeLayout$p2 != null) {
                        i = access$getRelativeLayout$p2.getWidth();
                    } else {
                        i = 0;
                    }
                    DisplayMetrics displayMetrics2 = OneErrorDialogBox.access$getMContext$p(OneErrorDialogBox.this).getResources().getDisplayMetrics();
                    ...
                    if (i >= ScreenSizeHelper.getWidthScreenSizePixel(displayMetrics2)) {
                        RelativeLayout access$getRelativeLayout$p3 = OneErrorDialogBox.access$getRelativeLayout$p(OneErrorDialogBox.this);
                        if (access$getRelativeLayout$p3 != null) {
                            layoutParams2 = access$getRelativeLayout$p3.getLayoutParams();
                        } else {
                            layoutParams2 = null;
                        }
                        if (layoutParams2 != null) {
                            layoutParams2.width = (int) (OneErrorDialogBox.access$getMContext$p(OneErrorDialogBox.this).getResources().getDisplayMetrics().widthPixels * 0.9d);
                        }
                        RelativeLayout access$getRelativeLayout$p4 = OneErrorDialogBox.access$getRelativeLayout$p(OneErrorDialogBox.this);
                        if (access$getRelativeLayout$p4 != null) {
                            access$getRelativeLayout$p4.setLayoutParams(layoutParams2);
                        }
                    }
                }
            });
        ...
        if (oneFontButton != null) {
            oneFontButton.setOnClickListener(new View.OnClickListener() { // from class: HS0
                {
                    OneErrorDialogBox.this = this;
                }

                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    OneErrorDialogBox.m19746f(OneErrorDialogBox.this, view);
                }
            });
        }
    }
    ...
    public OneErrorDialogBox(@NotNull Context mContext, boolean z, @Nullable DialogInterface.OnCancelListener onCancelListener, @Nullable Callback callback) {
        ...
        this.f82973f = mContext;
        this.f82974g = callback;
