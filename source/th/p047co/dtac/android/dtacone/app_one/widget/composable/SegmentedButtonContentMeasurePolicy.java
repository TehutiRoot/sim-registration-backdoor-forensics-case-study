...
public final class SegmentedButtonContentMeasurePolicy implements MultiContentMeasurePolicy {
    ...
    /* renamed from: a */
    public final CoroutineScope f82899a;

    /* renamed from: b */
    public final AnimationSpec f82900b;

    /* renamed from: c */
    public Animatable f82901c;

    /* renamed from: d */
    public Integer f82902d;
    ...
    public /* synthetic */ int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
        return AbstractC19667eG0.m31587a(this, intrinsicMeasureScope, list, i);
    }

    @Override // androidx.compose.p003ui.layout.MultiContentMeasurePolicy
    public /* synthetic */ int maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
        return AbstractC19667eG0.m31586b(this, intrinsicMeasureScope, list, i);
    }
    ...
    */
    public androidx.compose.p003ui.layout.MeasureResult mo72842measure3p2s80s(@org.jetbrains.annotations.NotNull androidx.compose.p003ui.layout.MeasureScope r20, @org.jetbrains.annotations.NotNull java.util.List<? extends java.util.List<? extends androidx.compose.p003ui.layout.Measurable>> r21, long r22) {
        /*
            Method dump skipped, instructions count: 435
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: th.p047co.dtac.android.dtacone.app_one.widget.composable.SegmentedButtonContentMeasurePolicy.mo72842measure3p2s80s(androidx.compose.ui.layout.MeasureScope, java.util.List, long):androidx.compose.ui.layout.MeasureResult");
    }

    @Override // androidx.compose.p003ui.layout.MultiContentMeasurePolicy
    public /* synthetic */ int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
        return AbstractC19667eG0.m31585c(this, intrinsicMeasureScope, list, i);
    }

    @Override // androidx.compose.p003ui.layout.MultiContentMeasurePolicy
    public /* synthetic */ int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
        return AbstractC19667eG0.m31584d(this, intrinsicMeasureScope, list, i);
    }

    public final void setAnimatable(@Nullable Animatable<Integer, AnimationVector1D> animatable) {
        this.f82901c = animatable;
    }
}
