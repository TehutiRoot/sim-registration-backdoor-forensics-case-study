...
public final class OneVerifyKYCNewDialog extends BaseDialogFragment {
    ...
    @Metadata(m28851d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\bf\u0018\u00002\u00020\u0001J\b\u0010\u0002\u001a\u00020\u0003H&J\b\u0010\u0004\u001a\u00020\u0003H&¨\u0006\u0005"}, m28850d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/dialog/OneVerifyKYCNewDialog$OnButtonClickListener;", "", "onCancel", "", "onConfirm", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    private final void binding(View view) {
        ...
        this.f83005a = (OneFontTextView) findViewById;
        ...
        this.f83006b = (OneFontButton) findViewById2;
        ...
        this.f83007c = (OneFontButton) findViewById3;
    }

    /* renamed from: n */
    public static /* synthetic */ void m19722n(OneVerifyKYCNewDialog oneVerifyKYCNewDialog, View view) {
        m19718r(oneVerifyKYCNewDialog, view);
    }

    /* renamed from: o */
    public static /* synthetic */ void m19721o(OneVerifyKYCNewDialog oneVerifyKYCNewDialog, View view) {
        m19717s(oneVerifyKYCNewDialog, view);
    }

    /* renamed from: q */
    private final String m19719q() {
        String str;
    ...
    /* renamed from: r */
    public static final void m19718r(OneVerifyKYCNewDialog this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.dismiss();
        OnButtonClickListener onButtonClickListener = this$0.f83010f;
    ...
    /* renamed from: s */
    public static final void m19717s(OneVerifyKYCNewDialog this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.dismiss();
        OnButtonClickListener onButtonClickListener = this$0.f83010f;
        if (onButtonClickListener != null) {
    ...
    private final void setTheme() {
        OneFontButton oneFontButton = this.f83006b;
        if (oneFontButton == null) {
            Intrinsics.throwUninitializedPropertyAccessException("btnOk");
            oneFontButton = null;
        }
        oneFontButton.setBackgroundResource(m19720p());
    }
    ...
    public void onViewCreated(@NotNull View view, @Nullable Bundle bundle) {
        ...
        OneFontButton oneFontButton2 = this.f83006b;
        if (oneFontButton2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("btnOk");
            oneFontButton2 = null;
        }
        oneFontButton2.setOnClickListener(new View.OnClickListener() { // from class: Df1
            {
                OneVerifyKYCNewDialog.this = this;
            }

            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                OneVerifyKYCNewDialog.m19722n(OneVerifyKYCNewDialog.this, view2);
            }
        });
        OneFontButton oneFontButton3 = this.f83007c;
        if (oneFontButton3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("btnCancel");
            oneFontButton3 = null;
        }
        oneFontButton3.setOnClickListener(new View.OnClickListener() { // from class: Ef1
            {
                OneVerifyKYCNewDialog.this = this;
            }
            ...
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                OneVerifyKYCNewDialog.m19721o(OneVerifyKYCNewDialog.this, view2);
            }
        });
        if (m19719q().length() > 0) {
            OneFontTextView oneFontTextView2 = this.f83005a;
            if (oneFontTextView2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("tvKycMessage");
            } else {
                oneFontTextView = oneFontTextView2;
            }
            oneFontTextView.setText(m19719q());
        }
    }

    /* renamed from: p */
    public final int m19720p() {
        Bundle arguments = getArguments();
        if (arguments != null) {
