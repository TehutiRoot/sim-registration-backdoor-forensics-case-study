...
public final class OneRegistrationViewModel_Factory implements Factory<OneRegistrationViewModel> {
    ...
    /* renamed from: a */
    public final Provider f82650a;

    /* renamed from: b */
    public final Provider f82651b;

    /* renamed from: c */
    public final Provider f82652c;

    /* renamed from: d */
    public final Provider f82653d;
    ...
    public OneRegistrationViewModel_Factory(Provider<OneRegistrationRepository> provider, Provider<Rx2ThreadService> provider2, Provider<OneErrorService> provider3, Provider<TemporaryCache> provider4) {
        this.f82650a = provider;
        this.f82651b = provider2;
        this.f82652c = provider3;
        this.f82653d = provider4;
    }
    ...
    public OneRegistrationViewModel get() {
        return newInstance((OneRegistrationRepository) this.f82650a.get(), (Rx2ThreadService) this.f82651b.get(), (OneErrorService) this.f82652c.get(), (TemporaryCache) this.f82653d.get());
    }
}
