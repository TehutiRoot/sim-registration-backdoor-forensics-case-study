...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u00012\u000e\u0010\u0002\u001a\n \u0004*\u0004\u0018\u00010\u00030\u0003H\n¢\u0006\u0002\b\u0005"}, m28850d2 = {"<anonymous>", "", "response", "Lth/co/dtac/android/dtacone/view/appOne/buyDol/model/response/OnePrepaidStatusResponse;", "kotlin.jvm.PlatformType", "invoke"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
/* renamed from: th.co.dtac.android.dtacone.app_one.viewmodel.stv.OneStvProsermOnlineViewModel$acceptBuyDOLConsent$3 */
/* loaded from: classes7.dex */
public final class OneStvProsermOnlineViewModel$acceptBuyDOLConsent$3 extends Lambda implements Function1<OnePrepaidStatusResponse, Unit> {
    final /* synthetic */ String $feature;
    final /* synthetic */ OneStvProsermOnlineViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneStvProsermOnlineViewModel$acceptBuyDOLConsent$3(OneStvProsermOnlineViewModel oneStvProsermOnlineViewModel, String str) {
        super(1);
    ...
    public final void invoke2(OnePrepaidStatusResponse onePrepaidStatusResponse) {
        ...
        MutableLiveData m19914x0;
        if (Intrinsics.areEqual(onePrepaidStatusResponse.getStatus(), Status.getSUCCESS())) {
            m19914x0 = this.this$0.m19914x0();
            m19914x0.setValue(Resource.Companion.success(this.$feature));
            return;
        }
        serverErrorService = this.this$0.f82691g;
