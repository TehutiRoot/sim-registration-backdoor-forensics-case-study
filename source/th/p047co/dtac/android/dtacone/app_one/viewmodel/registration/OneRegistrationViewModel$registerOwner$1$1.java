...
/* renamed from: th.co.dtac.android.dtacone.app_one.viewmodel.registration.OneRegistrationViewModel$registerOwner$1$1 */
/* loaded from: classes7.dex */
public final class OneRegistrationViewModel$registerOwner$1$1 extends Lambda implements Function1<Disposable, Unit> {
    final /* synthetic */ Boolean $isLoading;
    final /* synthetic */ OneRegistrationViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneRegistrationViewModel$registerOwner$1$1(Boolean bool, OneRegistrationViewModel oneRegistrationViewModel) {
        super(1);
        this.$isLoading = bool;
