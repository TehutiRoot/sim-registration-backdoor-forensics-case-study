...
public final class OneRegistrationViewModel$requestOtpPhoneOnline$2 extends Lambda implements Function1<RequestOtpResponse, Unit> {
    ...
    public final void invoke2(RequestOtpResponse requestOtpResponse) {
        MutableLiveData m20011w;
        MutableLiveData m20050H;
        MutableLiveData m20049I;
        m20011w = this.this$0.m20011w();
        m20011w.setValue(requestOtpResponse.getHref());
        this.this$0.getLiveDataState().setValue(StatusResource.SUCCESS);
        this.this$0.getVerifyOnlineToken().setValue(null);
        if (Intrinsics.areEqual(this.$refresh, Boolean.TRUE)) {
            m20049I = this.this$0.m20049I();
            m20049I.setValue(Resource.Companion.success(null));
            return;
        }
        m20050H = this.this$0.m20050H();
        m20050H.setValue(Resource.Companion.success(null));
    }
}
