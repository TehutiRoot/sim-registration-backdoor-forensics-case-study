...
/* renamed from: th.co.dtac.android.dtacone.app_one.viewmodel.registration.OneRegistrationViewModel$verifyOTP$1 */
/* loaded from: classes7.dex */
public final class OneRegistrationViewModel$verifyOTP$1 extends Lambda implements Function1<Disposable, Unit> {
    final /* synthetic */ OneRegistrationViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneRegistrationViewModel$verifyOTP$1(OneRegistrationViewModel oneRegistrationViewModel) {
        super(1);
