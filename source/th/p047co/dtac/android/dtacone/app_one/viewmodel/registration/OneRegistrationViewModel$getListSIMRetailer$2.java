...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u00012\u000e\u0010\u0002\u001a\n \u0004*\u0004\u0018\u00010\u00030\u0003H\n¢\u0006\u0002\b\u0005"}, m28850d2 = {"<anonymous>", "", "it", "Lth/co/dtac/android/dtacone/app_one/model/registration/ListSIMRetailerResponse;", "kotlin.jvm.PlatformType", "invoke"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
...
public final class OneRegistrationViewModel$getListSIMRetailer$2 extends Lambda implements Function1<ListSIMRetailerResponse, Unit> {
    ...
    public final void invoke2(ListSIMRetailerResponse listSIMRetailerResponse) {
            ...
            for (RetailerProfileItem retailerProfileItem : retailerProfile) {
                ...
                if (simRList != null) {
                    for (String str : simRList) {
                        ...
                        oneRegistrationRepository = oneRegistrationViewModel.f82618b;
        ...
        m20053E = this.this$0.m20053E();
        m20053E.setValue(Resource.Companion.success(arrayList));
    }
}
