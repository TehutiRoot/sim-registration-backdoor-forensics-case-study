...
/* renamed from: th.co.dtac.android.dtacone.app_one.viewmodel.forgotpassword.OneForgotPasswordViewModel$verifyOTP$1 */
/* loaded from: classes7.dex */
public final class OneForgotPasswordViewModel$verifyOTP$1 extends Lambda implements Function1<Disposable, Unit> {
    final /* synthetic */ OneForgotPasswordViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneForgotPasswordViewModel$verifyOTP$1(OneForgotPasswordViewModel oneForgotPasswordViewModel) {
        super(1);
