...
public final class OneGetPricePlansRequest {
    ...
    public static /* synthetic */ OneGetPricePlansRequest copy$default(OneGetPricePlansRequest oneGetPricePlansRequest, String str, String str2, String str3, String str4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return oneGetPricePlansRequest.copy(str, str2, str3, str4);
    }
    ...
    @NotNull
    public final OneGetPricePlansRequest copy(@Nullable String str, @Nullable String str2, @Nullable String str3, @Nullable String str4) {
        return new OneGetPricePlansRequest(str, str2, str3, str4);
    }
    ...
    public String toString() {
        ...
        String str3 = this.activityFunctionType;
        String str4 = this.dtrCode;
        return "OneGetPricePlansRequest(propositionCode=" + str + ", activityFunction=" + str2 + ", activityFunctionType=" + str3 + ", dtrCode=" + str4 + ")";
    }

    public OneGetPricePlansRequest(@Nullable String str, @Nullable String str2, @Nullable String str3, @Nullable String str4) {
    ...
    public /* synthetic */ OneGetPricePlansRequest(String str, String str2, String str3, String str4, int i, DefaultConstructorMarker defaultConstructorMarker) {
