...
public final class DynamicSpecificVerticalItemDecorator extends RecyclerView.ItemDecoration {
    ...
    public DynamicSpecificVerticalItemDecorator(@NotNull Context context, int i, int i2, int i3, int i4, int i5, int i6) {
        ...
        this.f84719a = (int) TypedValue.applyDimension(1, i, displayMetrics);
        this.f84720b = (int) TypedValue.applyDimension(1, i2, displayMetrics);
        this.f84721c = (int) TypedValue.applyDimension(1, i3, displayMetrics);
        this.f84722d = (int) TypedValue.applyDimension(1, i4, displayMetrics);
        this.f84723e = (int) TypedValue.applyDimension(1, i5, displayMetrics);
        this.f84724f = (int) TypedValue.applyDimension(1, i6, displayMetrics);
    }
    ...
    public void getItemOffsets(@NotNull Rect outRect, @NotNull View view, @NotNull RecyclerView parent, @NotNull RecyclerView.State state) {
        ...
        if (childAdapterPosition == 0) {
            outRect.top = this.f84719a;
        } else {
            outRect.top = this.f84723e;
        }
        RecyclerView.Adapter adapter = parent.getAdapter();
        if (adapter != null && childAdapterPosition == adapter.getItemCount() - 1) {
            outRect.bottom = this.f84720b;
        } else {
            outRect.bottom = this.f84724f;
        }
        outRect.left = this.f84721c;
        outRect.right = this.f84722d;
    }
}
