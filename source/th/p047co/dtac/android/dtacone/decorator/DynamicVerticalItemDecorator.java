...
public final class DynamicVerticalItemDecorator extends RecyclerView.ItemDecoration {
    ...
    public DynamicVerticalItemDecorator(@NotNull Context context, int i, int i2, int i3) {
        ...
        this.f84729a = (int) TypedValue.applyDimension(1, i3, displayMetrics);
        this.f84730b = (int) TypedValue.applyDimension(1, i2, displayMetrics);
        this.f84731c = (int) TypedValue.applyDimension(1, i, displayMetrics);
    }
    ...
    public void getItemOffsets(@NotNull Rect outRect, @NotNull View view, @NotNull RecyclerView parent, @NotNull RecyclerView.State state) {
        ...
        if (childAdapterPosition == 0) {
            outRect.top = this.f84731c;
        } else {
            outRect.top = this.f84729a;
        }
        RecyclerView.Adapter adapter = parent.getAdapter();
        if (adapter != null && childAdapterPosition == adapter.getItemCount() - 1) {
            outRect.bottom = this.f84731c;
        }
        int i = this.f84730b;
        outRect.left = i;
        outRect.right = i;
