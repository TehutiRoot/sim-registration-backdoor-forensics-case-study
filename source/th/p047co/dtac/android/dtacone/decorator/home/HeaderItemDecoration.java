...
public final class HeaderItemDecoration extends RecyclerView.ItemDecoration {
    ...
    /* renamed from: c */
    public final Function1 f84734c;
    ...
    public HeaderItemDecoration(@NotNull Context context, int i, @NotNull RecyclerView parent, @NotNull Function1<? super Integer, Boolean> isHeader) {
        ...
        if (adapter != null) {
            adapter.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() { // from class: th.co.dtac.android.dtacone.decorator.home.HeaderItemDecoration.1
                {
                    HeaderItemDecoration.this = this;
                }

                @Override // androidx.recyclerview.widget.RecyclerView.AdapterDataObserver
                public void onChanged() {
                    HeaderItemDecoration.this.f84735d = null;
                }
            });
        }
        parent.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: th.co.dtac.android.dtacone.decorator.home.HeaderItemDecoration$special$$inlined$doOnEachNextLayout$1
            ...
            public final void onLayoutChange(View view, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
                ...
                HeaderItemDecoration.access$setCurrentHeader$p(HeaderItemDecoration.this, null);
            }
        });
        parent.addOnItemTouchListener(new RecyclerView.SimpleOnItemTouchListener() { // from class: th.co.dtac.android.dtacone.decorator.home.HeaderItemDecoration.3
            ...
            public boolean onInterceptTouchEvent(@NotNull RecyclerView recyclerView, @NotNull MotionEvent motionEvent) {
                ...
                Pair pair = HeaderItemDecoration.this.f84735d;
    ...
    public static final /* synthetic */ void access$setCurrentHeader$p(HeaderItemDecoration headerItemDecoration, Pair pair) {
        headerItemDecoration.f84735d = pair;
    }

    /* renamed from: a */
    public final void m19518a(Canvas canvas, View view) {
        canvas.save();
    ...
    /* renamed from: b */
    public final void m19517b(ViewGroup viewGroup, View view) {
        view.measure(ViewGroup.getChildMeasureSpec(View.MeasureSpec.makeMeasureSpec(viewGroup.getWidth(), 1073741824), viewGroup.getPaddingLeft() + viewGroup.getPaddingRight(), view.getLayoutParams().width), ViewGroup.getChildMeasureSpec(View.MeasureSpec.makeMeasureSpec(viewGroup.getHeight(), 0), viewGroup.getPaddingTop() + viewGroup.getPaddingBottom(), view.getLayoutParams().height));
        view.layout(0, 0, view.getMeasuredWidth(), view.getMeasuredHeight());
    }

    /* renamed from: c */
    public final View m19516c(RecyclerView recyclerView, int i) {
    ...
    /* renamed from: d */
    public final int m19515d(int i) {
        while (!((Boolean) this.f84734c.invoke(Integer.valueOf(i))).booleanValue()) {
            i--;
            if (i < 0) {
                return 0;
            }
    ...
    /* renamed from: e */
    public final View m19514e(int i, RecyclerView recyclerView) {
        RecyclerView.ViewHolder viewHolder;
        Pair pair;
        ...
        int m19515d = m19515d(i);
        RecyclerView.Adapter adapter = recyclerView.getAdapter();
        if (adapter == null) {
            return null;
        }
        int itemViewType = adapter.getItemViewType(m19515d);
        Pair pair2 = this.f84735d;
        if (pair2 != null && ((Number) pair2.getFirst()).intValue() == m19515d && (pair = this.f84735d) != null && (viewHolder2 = (RecyclerView.ViewHolder) pair.getSecond()) != null && viewHolder2.getItemViewType() == itemViewType) {
            Pair pair3 = this.f84735d;
        ...
        if (viewHolder != null) {
            ...
            if (adapter3 != null) {
                adapter3.onBindViewHolder(viewHolder, m19515d);
            }
            View view = viewHolder.itemView;
            Intrinsics.checkNotNullExpressionValue(view, "headerHolder.itemView");
            m19517b(recyclerView, view);
            this.f84735d = TuplesKt.m28844to(Integer.valueOf(m19515d), viewHolder);
        }
        if (viewHolder == null) {
            return null;
        }
    ...
    /* renamed from: f */
    public final void m19513f(Canvas canvas, View view, View view2) {
        canvas.save();
    ...
    public void getItemOffsets(@NotNull Rect outRect, @NotNull View view, @NotNull RecyclerView parent, @NotNull RecyclerView.State state) {
        ...
        DisplayMetrics displayMetrics = this.f84732a.getResources().getDisplayMetrics();
        RecyclerView.Adapter adapter = parent.getAdapter();
        if (adapter != null && childAdapterPosition == adapter.getItemCount() - 1) {
            outRect.bottom = (int) TypedValue.applyDimension(1, this.f84733b, displayMetrics);
        }
    }
    ...
    public void onDrawOver(@NotNull Canvas c, @NotNull RecyclerView parent, @NotNull RecyclerView.State state) {
        ...
        if (childAt == null || (childAdapterPosition = parent.getChildAdapterPosition(childAt)) == -1 || (m19514e = m19514e(childAdapterPosition, parent)) == null || (m19516c = m19516c(parent, m19514e.getBottom())) == null) {
            return;
        }
        if (((Boolean) this.f84734c.invoke(Integer.valueOf(parent.getChildAdapterPosition(m19516c)))).booleanValue()) {
            m19513f(c, m19514e, m19516c);
        } else {
            m19518a(c, m19514e);
        }
    }
