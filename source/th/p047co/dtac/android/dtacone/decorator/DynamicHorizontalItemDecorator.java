...
public final class DynamicHorizontalItemDecorator extends RecyclerView.ItemDecoration {
    ...
    public DynamicHorizontalItemDecorator(@NotNull Context context, int i, int i2, int i3) {
        Intrinsics.checkNotNullParameter(context, "context");
        DisplayMetrics displayMetrics = context.getResources().getDisplayMetrics();
        this.f84716a = (int) TypedValue.applyDimension(1, i3, displayMetrics);
        this.f84717b = (int) TypedValue.applyDimension(1, i2, displayMetrics);
        this.f84718c = (int) TypedValue.applyDimension(1, i, displayMetrics);
    }
    ...
    public void getItemOffsets(@NotNull Rect outRect, @NotNull View view, @NotNull RecyclerView parent, @NotNull RecyclerView.State state) {
        ...
        if (childAdapterPosition == 0) {
            outRect.left = this.f84718c;
        } else {
            outRect.left = this.f84717b;
        }
        RecyclerView.Adapter adapter = parent.getAdapter();
        if (adapter != null && childAdapterPosition == adapter.getItemCount() - 1) {
            outRect.right = this.f84718c;
        }
        int i = this.f84716a;
        outRect.top = i;
        outRect.bottom = i;
