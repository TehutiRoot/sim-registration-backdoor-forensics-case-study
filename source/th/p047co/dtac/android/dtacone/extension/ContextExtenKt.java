...
public final class ContextExtenKt {
    /* renamed from: a */
    public static /* synthetic */ void m19506a(Activity activity, String str) {
        m19504c(activity, str);
    }

    /* renamed from: b */
    public static final void m19505b(Activity activity) {
    ...
    /* renamed from: c */
    public static final void m19504c(Activity this_showToastCenterLong, String message) {
    ...
    public static final void showToastCenterLong(@NotNull final Activity activity, @NotNull final String message) {
        ...
        new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: hy
            ...
            public final void run() {
                ContextExtenKt.m19506a(activity, message);
            }
        });
    }
