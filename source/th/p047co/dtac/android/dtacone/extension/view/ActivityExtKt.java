...
public final class ActivityExtKt {
    /* renamed from: a */
    public static /* synthetic */ void m19468a(Dialog dialog, View view) {
        m19451r(dialog, view);
    }

    /* renamed from: b */
    public static /* synthetic */ void m19467b(Dialog dialog, View view) {
        m19452q(dialog, view);
    }
    ...
    public static final Dialog buildConfirmDialogWithImage(@NotNull Context context, @NotNull String title, int i, @NotNull String message, @NotNull String textButtonLeft, @NotNull String textButtonRight, @NotNull Function0<Unit> handlerButtonLeft, @NotNull Function0<Unit> handlerButtonRight) {
        ...
        if (!AbstractC20204hN1.isBlank(textButtonLeft)) {
            buttonNo.setText(textButtonLeft);
        }
        if (!AbstractC20204hN1.isBlank(textButtonRight)) {
    ...
    /* renamed from: c */
    public static /* synthetic */ void m19466c(Dialog dialog, Function0 function0, View view) {
        m19459j(dialog, function0, view);
    }
    ...
    public static final Dialog createConfirmDialog(@NotNull Activity activity, @NotNull String title, @NotNull String message, @NotNull Function0<Unit> handler) {
        ...
        return m19460i(activity, title, message, null, null, null, null, null, null, handler, null, 1528, null);
    }
    ...
    public static final Dialog createConfirmDialog2Action(@NotNull Activity activity, @NotNull String title, @NotNull String message, @Nullable String str, @NotNull String textButtonLeft, @NotNull String textButtonRight, @NotNull Function0<Unit> handlerButtonLeft, @NotNull Function0<Unit> handlerButtonRight) {
        ...
        Intrinsics.checkNotNullParameter(handlerButtonLeft, "handlerButtonLeft");
        Intrinsics.checkNotNullParameter(handlerButtonRight, "handlerButtonRight");
        return m19460i(activity, title, message, textButtonLeft, textButtonRight, null, null, null, handlerButtonLeft, handlerButtonRight, str, 224, null);
    }
    ...
    public static final Dialog createConfirmDialogHtmlText(@NotNull Activity activity, @NotNull String title, @NotNull String message, @NotNull Function0<Unit> handler) {
        ...
        Intrinsics.checkNotNullParameter(message, "message");
        Intrinsics.checkNotNullParameter(handler, "handler");
        return m19456m(activity, title, message, null, null, null, null, null, handler, 248, null);
    }
    ...
    public static final Dialog createConfirmDialogTwoAction(@NotNull Activity activity, @NotNull String title, @NotNull String message, @NotNull String textLeftButton, @NotNull String textRightButton, @NotNull Function0<Unit> handlerButtonLeft, @NotNull Function0<Unit> handlerButtonRight) {
        ...
        Intrinsics.checkNotNullParameter(handlerButtonLeft, "handlerButtonLeft");
        Intrinsics.checkNotNullParameter(handlerButtonRight, "handlerButtonRight");
        return m19460i(activity, title, message, textLeftButton, textRightButton, null, null, null, handlerButtonLeft, handlerButtonRight, null, 1248, null);
    }
    ...
    public static final Dialog createDialogConfirmPackage(@NotNull Activity activity, @NotNull ConfirmPackageDialog confirmInfo, @NotNull final Function0<Unit> handler) {
        ...
        button.setOnClickListener(new View.OnClickListener() { // from class: S1
            ...
            public final void onClick(View view) {
                ActivityExtKt.m19465d(dialog, handler, view);
            }
        });
        button2.setOnClickListener(new View.OnClickListener() { // from class: T1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ActivityExtKt.m19467b(dialog, view);
            }
        });
        return dialog;
    }
    ...
    public static final Dialog createDialogDeviceSimInfo(@NotNull Activity activity, @Nullable List<SIMInfo> list, @Nullable List<SIMInfo> list2) {
        ...
        dtacFontButton.setOnClickListener(new View.OnClickListener() { // from class: R1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ActivityExtKt.m19468a(dialog, view);
            }
        });
        return dialog;
    }
    ...
    /* renamed from: d */
    public static /* synthetic */ void m19465d(Dialog dialog, Function0 function0, View view) {
        m19453p(dialog, function0, view);
    }

    /* renamed from: e */
    public static /* synthetic */ void m19464e(Dialog dialog, Function0 function0, View view) {
        m19455n(dialog, function0, view);
    }

    /* renamed from: f */
    public static /* synthetic */ void m19463f(Dialog dialog, Function0 function0, View view) {
        m19454o(dialog, function0, view);
    }

    /* renamed from: g */
    public static /* synthetic */ void m19462g(Dialog dialog, Function0 function0, View view) {
        m19458k(dialog, function0, view);
    }
    ...
    /* renamed from: h */
    public static final Dialog m19461h(Context context, String str, String str2, String str3, String str4, Float f, Float f2, Boolean bool, final Function0 function0, final Function0 function02, String str5) {
        ...
        if (!AbstractC20204hN1.isBlank(str3)) {
            button2.setText(str3);
        }
        if (!AbstractC20204hN1.isBlank(str4)) {
            button.setText(str4);
        }
        button.setOnClickListener(new View.OnClickListener() { // from class: N1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ActivityExtKt.m19466c(dialog, function02, view);
            }
        });
        button2.setOnClickListener(new View.OnClickListener() { // from class: O1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ActivityExtKt.m19462g(dialog, function0, view);
            }
        });
        return dialog;
    }
    ...
    /* renamed from: i */
    public static /* synthetic */ Dialog m19460i(Context context, String str, String str2, String str3, String str4, Float f, Float f2, Boolean bool, Function0 function0, Function0 function02, String str5, int i, Object obj) {
        if ((i & 2) != 0) {
            str = "";
        }
        if ((i & 4) != 0) {
        ...
        return m19461h(context, str, str2, str3, str4, f, f2, bool, function0, function02, str5);
    }

    /* renamed from: j */
    public static final void m19459j(Dialog this_apply, Function0 handlerButtonRight, View view) {
    ...
    /* renamed from: k */
    public static final void m19458k(Dialog this_apply, Function0 handlerButtonLeft, View view) {
        Intrinsics.checkNotNullParameter(this_apply, "$this_apply");
        Intrinsics.checkNotNullParameter(handlerButtonLeft, "$handlerButtonLeft");
        this_apply.dismiss();
    ...
    /* renamed from: l */
    public static final Dialog m19457l(Context context, String str, String str2, String str3, String str4, Float f, Float f2, final Function0 function0, final Function0 function02) {
        final Dialog dialog = new Dialog(context);
        dialog.setContentView(R.layout.dialog_confirm);
        Window window = dialog.getWindow();
        if (window != null) {
        ...
        dtacFontTextView2.setText(Html.fromHtml(AbstractC20204hN1.replace$default(str2, "\n", "<br>", false, 4, (Object) null)));
        if (f != null) {
        ...
        button.setOnClickListener(new View.OnClickListener() { // from class: P1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ActivityExtKt.m19464e(dialog, function02, view);
            }
        });
        button2.setOnClickListener(new View.OnClickListener() { // from class: Q1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ActivityExtKt.m19463f(dialog, function0, view);
            }
        });
        return dialog;
    }
    ...
    /* renamed from: m */
    public static /* synthetic */ Dialog m19456m(Context context, String str, String str2, String str3, String str4, Float f, Float f2, Function0 function0, Function0 function02, int i, Object obj) {
        if ((i & 2) != 0) {
            str = "";
        }
        if ((i & 4) != 0) {
        ...
        return m19457l(context, str, str2, str3, str4, f, f2, function0, function02);
    }

    /* renamed from: n */
    public static final void m19455n(Dialog this_apply, Function0 handlerButtonRight, View view) {
        Intrinsics.checkNotNullParameter(this_apply, "$this_apply");
        Intrinsics.checkNotNullParameter(handlerButtonRight, "$handlerButtonRight");
        this_apply.dismiss();
        handlerButtonRight.invoke();
    ...
    /* renamed from: o */
    public static final void m19454o(Dialog this_apply, Function0 handlerButtonLeft, View view) {
        Intrinsics.checkNotNullParameter(this_apply, "$this_apply");
        Intrinsics.checkNotNullParameter(handlerButtonLeft, "$handlerButtonLeft");
        this_apply.dismiss();
        handlerButtonLeft.invoke();
    ...
    /* renamed from: p */
    public static final void m19453p(Dialog this_apply, Function0 handler, View view) {
        Intrinsics.checkNotNullParameter(this_apply, "$this_apply");
        Intrinsics.checkNotNullParameter(handler, "$handler");
        this_apply.dismiss();
        handler.invoke();
    ...
    /* renamed from: q */
    public static final void m19452q(Dialog this_apply, View view) {
        Intrinsics.checkNotNullParameter(this_apply, "$this_apply");
        this_apply.dismiss();
    }

    /* renamed from: r */
    public static final void m19451r(Dialog this_apply, View view) {
        Intrinsics.checkNotNullParameter(this_apply, "$this_apply");
        this_apply.dismiss();
    }
    ...
    public static final Dialog createConfirmDialog(@NotNull Activity activity, @NotNull String title, @NotNull String message, @NotNull String textLeftButton, @NotNull String textRightButton, @NotNull Function0<Unit> handler) {
        ...
        Intrinsics.checkNotNullParameter(textRightButton, "textRightButton");
        Intrinsics.checkNotNullParameter(handler, "handler");
        return m19460i(activity, title, message, textLeftButton, textRightButton, null, null, null, null, handler, null, 1504, null);
    }
    ...
    public static final Dialog createConfirmDialogHtmlText(@NotNull Activity activity, @NotNull String title, @NotNull String message, @Nullable Float f, @Nullable Float f2, @NotNull Function0<Unit> handler) {
        ...
        Intrinsics.checkNotNullParameter(message, "message");
        Intrinsics.checkNotNullParameter(handler, "handler");
        return m19456m(activity, title, message, null, null, f, f2, null, handler, SyslogConstants.LOG_LOCAL3, null);
    }
    ...
    public static final Dialog createConfirmDialog(@NotNull Activity activity, @NotNull String title, @NotNull String message, @NotNull String textLeftButton, @NotNull String textRightButton, @Nullable Float f, @Nullable Float f2, @Nullable Boolean bool, @NotNull Function0<Unit> handlerButtonLeft, @NotNull Function0<Unit> handlerButtonRight) {
        ...
        Intrinsics.checkNotNullParameter(handlerButtonLeft, "handlerButtonLeft");
        Intrinsics.checkNotNullParameter(handlerButtonRight, "handlerButtonRight");
        return m19460i(activity, title, message, textLeftButton, textRightButton, f, f2, bool, handlerButtonLeft, handlerButtonRight, null, 1024, null);
    }
}
