...
/* renamed from: th.co.dtac.android.dtacone.databinding.ZIncludeMrtrInputAddressPassportReceiptBinding */
/* loaded from: classes7.dex */
public final class ZIncludeMrtrInputAddressPassportReceiptBinding implements ViewBinding {

    /* renamed from: a */
    public final LinearLayout f84633a;
    @NonNull
    ...
    @NonNull
    public static ZIncludeMrtrInputAddressPassportReceiptBinding bind(@NonNull View view) {
        int i = R.id.btnNext;
                                ...
                                if (dtacFontTextView2 != null) {
                                    ...
                                    if (dtacFontTextView3 != null) {
                                        ...
                                        if (dtacFontTextView4 != null) {
                                            ...
                                            return new ZIncludeMrtrInputAddressPassportReceiptBinding(linearLayout, dtacFontButton, dtacClearableEditText, dtacClearableEditText2, dtacClearableEditText3, dtacClearableEditText4, dtacFontTextView, dtacFontTextView2, dtacFontTextView3, dtacFontTextView4, linearLayout);
                                        }
                                    }
                                }
                            }
    ...
    @NonNull
    public static ZIncludeMrtrInputAddressPassportReceiptBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static ZIncludeMrtrInputAddressPassportReceiptBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.z_include_mrtr_input_address_passport_receipt, viewGroup, false);
        if (z) {
