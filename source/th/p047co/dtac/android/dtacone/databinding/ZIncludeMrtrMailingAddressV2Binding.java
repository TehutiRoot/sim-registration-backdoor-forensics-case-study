...
/* renamed from: th.co.dtac.android.dtacone.databinding.ZIncludeMrtrMailingAddressV2Binding */
/* loaded from: classes7.dex */
public final class ZIncludeMrtrMailingAddressV2Binding implements ViewBinding {

    /* renamed from: a */
    public final LinearLayout f84636a;
    @NonNull
    ...
    @NonNull
    public static ZIncludeMrtrMailingAddressV2Binding bind(@NonNull View view) {
                                        ...
                                        if (dtacFontTextView4 != null) {
                                            ...
                                            if (radioGroup != null) {
                                                ...
                                                if (dtacFontTextView5 != null) {
                                                    return new ZIncludeMrtrMailingAddressV2Binding(linearLayout, dtacClearableEditText, dtacClearableEditText2, dtacPhoneNumberEditText, dtacRadioButton, dtacRadioButton2, dtacFontTextView, dtacFontTextView2, dtacFontTextView3, dtacFontTextView4, radioGroup, linearLayout, dtacFontTextView5);
                                                }
                                            }
                                        }
                                    }
    ...
    @NonNull
    public static ZIncludeMrtrMailingAddressV2Binding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static ZIncludeMrtrMailingAddressV2Binding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.z_include_mrtr_mailing_address_v2, viewGroup, false);
        if (z) {
