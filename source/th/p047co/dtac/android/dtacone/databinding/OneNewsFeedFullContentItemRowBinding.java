...
/* renamed from: th.co.dtac.android.dtacone.databinding.OneNewsFeedFullContentItemRowBinding */
/* loaded from: classes7.dex */
public final class OneNewsFeedFullContentItemRowBinding implements ViewBinding {

    /* renamed from: a */
    public final DtacCardView f84498a;
    @NonNull
    ...
    public OneNewsFeedFullContentItemRowBinding(DtacCardView dtacCardView, DtacCardView dtacCardView2, OneIncludeLikeBinding oneIncludeLikeBinding, AdjustableImageView adjustableImageView, AppCompatImageView appCompatImageView, LinearLayout linearLayout, OneFontTextView oneFontTextView, OneFontTextView oneFontTextView2, OneFontTextView oneFontTextView3, OneFontTextView oneFontTextView4) {
        this.f84498a = dtacCardView;
    ...
    @NonNull
    public static OneNewsFeedFullContentItemRowBinding bind(@NonNull View view) {
                            ...
                            if (oneFontTextView2 != null) {
                                ...
                                if (oneFontTextView3 != null) {
                                    ...
                                    if (oneFontTextView4 != null) {
                                        return new OneNewsFeedFullContentItemRowBinding(dtacCardView, dtacCardView, bind, adjustableImageView, appCompatImageView, linearLayout, oneFontTextView, oneFontTextView2, oneFontTextView3, oneFontTextView4);
                                    }
                                }
                            }
                        }
    ...
    @NonNull
    public static OneNewsFeedFullContentItemRowBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static OneNewsFeedFullContentItemRowBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.one_news_feed_full_content_item_row, viewGroup, false);
        if (z) {
