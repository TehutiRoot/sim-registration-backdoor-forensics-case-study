...
/* renamed from: th.co.dtac.android.dtacone.databinding.FragmentOnePrepaidSummaryBinding */
/* loaded from: classes7.dex */
public final class FragmentOnePrepaidSummaryBinding implements ViewBinding {

    /* renamed from: a */
    public final ConstraintLayout f84086a;
    @NonNull
    public final OneFontTextView btnRegister;
    @NonNull
    public final OneFontTextView btnRegisterFamilySim;
    @NonNull
    public final OneFontTextView btnRegisterWithActivate;
    @NonNull
    ...
    @NonNull
    public final LinearLayoutCompat layoutPaymentBillInfo;
    @NonNull
    ...
    public FragmentOnePrepaidSummaryBinding(ConstraintLayout constraintLayout, OneFontTextView oneFontTextView, OneFontTextView oneFontTextView2, OneFontTextView oneFontTextView3, ImageView imageView, LinearLayoutCompat linearLayoutCompat, LinearLayoutCompat linearLayoutCompat2, ConstraintLayout constraintLayout2, LinearLayoutCompat linearLayoutCompat3, LinearLayoutCompat linearLayoutCompat4, ConstraintLayout constraintLayout3, ConstraintLayout constraintLayout4, LinearLayoutCompat linearLayoutCompat5, OneFontTextView oneFontTextView4, OneFontTextView oneFontTextView5, OneFontTextView oneFontTextView6, OneFontTextView oneFontTextView7, OneFontTextView oneFontTextView8, OneFontTextView oneFontTextView9, OneFontTextView oneFontTextView10, OneFontTextView oneFontTextView11, OneFontTextView oneFontTextView12, OneFontTextView oneFontTextView13, OneFontTextView oneFontTextView14, OneFontTextView oneFontTextView15, OneFontTextView oneFontTextView16, OneFontTextView oneFontTextView17, OneFontTextView oneFontTextView18, OneFontTextView oneFontTextView19, OneFontTextView oneFontTextView20, OneFontTextView oneFontTextView21, OneFontTextView oneFontTextView22, OneFontTextView oneFontTextView23, OneFontTextView oneFontTextView24, OneFontTextView oneFontTextView25, OneFontTextView oneFontTextView26, OneFontTextView oneFontTextView27, OneFontTextView oneFontTextView28, OneFontTextView oneFontTextView29) {
        ...
        this.layoutPaymentBillInfo = linearLayoutCompat3;
        this.layoutPrepaidSubmit = linearLayoutCompat4;
        this.layoutReceipt = constraintLayout3;
        this.layoutRegistInfo = constraintLayout4;
        this.slideImage = linearLayoutCompat5;
        this.tvAddMorePhoto = oneFontTextView4;
        this.tvCardNumber = oneFontTextView5;
        this.tvCardNumberLabel = oneFontTextView6;
        this.tvCardType = oneFontTextView7;
        this.tvCardTypeLabel = oneFontTextView8;
        this.tvPaymentBackCard = oneFontTextView9;
        this.tvPaymentBackCardLabel = oneFontTextView10;
        this.tvPaymentBillAddress = oneFontTextView11;
        this.tvPaymentBillAddressLabel = oneFontTextView12;
        this.tvPaymentBranchCode = oneFontTextView13;
        this.tvPaymentBranchCodeLabel = oneFontTextView14;
        this.tvPaymentCardNumber = oneFontTextView15;
        this.tvPaymentCardNumberLabel = oneFontTextView16;
        this.tvPaymentCash = oneFontTextView17;
        this.tvPaymentCashLabel = oneFontTextView18;
        this.tvPaymentChannel = oneFontTextView19;
        this.tvPaymentChannelLabel = oneFontTextView20;
        this.tvPaymentCreditCard = oneFontTextView21;
        this.tvPaymentCreditCardLabel = oneFontTextView22;
        this.tvPaymentDataType = oneFontTextView23;
        this.tvPaymentDataTypeLabel = oneFontTextView24;
        this.tvPaymentReceipt = oneFontTextView25;
        this.tvPaymentReceiptLabel = oneFontTextView26;
        this.tvPhoneNumber = oneFontTextView27;
        this.tvPhoneNumberLabel = oneFontTextView28;
        this.tvPhotoCount = oneFontTextView29;
    }

    @NonNull
    public static FragmentOnePrepaidSummaryBinding bind(@NonNull View view) {
    ...
    @NonNull
    public static FragmentOnePrepaidSummaryBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static FragmentOnePrepaidSummaryBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.fragment_one_prepaid_summary, viewGroup, false);
        if (z) {
