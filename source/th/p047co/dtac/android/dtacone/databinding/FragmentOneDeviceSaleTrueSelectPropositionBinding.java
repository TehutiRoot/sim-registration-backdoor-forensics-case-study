...
/* renamed from: th.co.dtac.android.dtacone.databinding.FragmentOneDeviceSaleTrueSelectPropositionBinding */
/* loaded from: classes7.dex */
public final class FragmentOneDeviceSaleTrueSelectPropositionBinding implements ViewBinding {

    /* renamed from: a */
    public final ConstraintLayout f83945a;
    @NonNull
    ...
    @NonNull
    public static FragmentOneDeviceSaleTrueSelectPropositionBinding bind(@NonNull View view) {
    ...
    @NonNull
    public static FragmentOneDeviceSaleTrueSelectPropositionBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static FragmentOneDeviceSaleTrueSelectPropositionBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.fragment_one_device_sale_true_select_proposition, viewGroup, false);
        if (z) {
