...
/* renamed from: th.co.dtac.android.dtacone.databinding.FragmentOnePostpaidTrueProtectBinding */
/* loaded from: classes7.dex */
public final class FragmentOnePostpaidTrueProtectBinding implements ViewBinding {

    /* renamed from: a */
    public final NestedScrollView f84048a;
    @NonNull
    ...
    @NonNull
    public static FragmentOnePostpaidTrueProtectBinding bind(@NonNull View view) {
                                                                            ...
                                                                            if (oneFontTextView7 != null) {
                                                                                ...
                                                                                if (oneFontTextView8 != null) {
                                                                                    ...
                                                                                    if (oneFontTextView9 != null) {
                                                                                        return new FragmentOnePostpaidTrueProtectBinding((NestedScrollView) view, imageView, linearLayoutCompat, cardView, linearLayoutCompat2, linearLayoutCompat3, cardView2, linearLayoutCompat4, linearLayoutCompat5, oneFontButton, oneFontButton2, oneFontButton3, oneFontTextView, oneFontTextView2, oneFontTextView3, oneFontTextView4, oneFontTextView5, oneFontTextView6, oneFontTextView7, oneFontTextView8, oneFontTextView9);
                                                                                    }
                                                                                }
                                                                            }
                                                                        }
    ...
    @NonNull
    public static FragmentOnePostpaidTrueProtectBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static FragmentOnePostpaidTrueProtectBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.fragment_one_postpaid_true_protect, viewGroup, false);
        if (z) {
