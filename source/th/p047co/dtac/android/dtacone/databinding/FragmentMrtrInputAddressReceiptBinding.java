...
/* renamed from: th.co.dtac.android.dtacone.databinding.FragmentMrtrInputAddressReceiptBinding */
/* loaded from: classes7.dex */
public final class FragmentMrtrInputAddressReceiptBinding implements ViewBinding {

    /* renamed from: a */
    public final LinearLayoutCompat f83784a;
    @NonNull
    ...
    @NonNull
    public static FragmentMrtrInputAddressReceiptBinding bind(@NonNull View view) {
                ...
                if (findChildViewById3 != null) {
                    ...
                    if (dtacTabLayout != null) {
                        ...
                        if (wrapContentViewPager != null) {
                            return new FragmentMrtrInputAddressReceiptBinding((LinearLayoutCompat) view, bind, constraintLayout, bind2, bind3, dtacTabLayout, wrapContentViewPager);
                        }
                    }
                }
            }
    ...
    @NonNull
    public static FragmentMrtrInputAddressReceiptBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static FragmentMrtrInputAddressReceiptBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.fragment_mrtr_input_address_receipt, viewGroup, false);
        if (z) {
