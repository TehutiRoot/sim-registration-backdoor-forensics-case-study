...
/* renamed from: th.co.dtac.android.dtacone.databinding.FragmentOneTrueCampaignListBinding */
/* loaded from: classes7.dex */
public final class FragmentOneTrueCampaignListBinding implements ViewBinding {

    /* renamed from: a */
    public final FrameLayout f84129a;
    @NonNull
    ...
    public FragmentOneTrueCampaignListBinding(FrameLayout frameLayout, OneFontButton oneFontButton, ImageView imageView, LinearLayout linearLayout, LinearLayout linearLayout2, LinearLayout linearLayout3, LinearLayout linearLayout4, LinearLayout linearLayout5, NestedScrollView nestedScrollView, RecyclerView recyclerView, RecyclerView recyclerView2, RecyclerView recyclerView3, OneSwipeRefresh oneSwipeRefresh, OneFontTextView oneFontTextView, OneFontTextView oneFontTextView2, OneFontTextView oneFontTextView3) {
        this.f84129a = frameLayout;
    ...
    @NonNull
    public static FragmentOneTrueCampaignListBinding bind(@NonNull View view) {
                                                        ...
                                                        if (oneFontTextView != null) {
                                                            ...
                                                            if (oneFontTextView2 != null) {
                                                                ...
                                                                if (oneFontTextView3 != null) {
                                                                    return new FragmentOneTrueCampaignListBinding((FrameLayout) view, oneFontButton, imageView, linearLayout, linearLayout2, linearLayout3, linearLayout4, linearLayout5, nestedScrollView, recyclerView, recyclerView2, recyclerView3, oneSwipeRefresh, oneFontTextView, oneFontTextView2, oneFontTextView3);
                                                                }
                                                            }
                                                        }
                                                    }
    ...
    @NonNull
    public static FragmentOneTrueCampaignListBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static FragmentOneTrueCampaignListBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.fragment_one_true_campaign_list, viewGroup, false);
        if (z) {
