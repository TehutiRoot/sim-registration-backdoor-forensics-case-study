...
/* renamed from: th.co.dtac.android.dtacone.databinding.ZIncludeMrtrMailingAddressV3Binding */
/* loaded from: classes7.dex */
public final class ZIncludeMrtrMailingAddressV3Binding implements ViewBinding {

    /* renamed from: a */
    public final LinearLayout f84637a;
    @NonNull
    ...
    @NonNull
    public static ZIncludeMrtrMailingAddressV3Binding bind(@NonNull View view) {
                                        ...
                                        if (dtacFontTextView4 != null) {
                                            ...
                                            if (radioGroup != null) {
                                                ...
                                                if (dtacFontTextView5 != null) {
                                                    return new ZIncludeMrtrMailingAddressV3Binding(linearLayout, dtacClearableEditText, dtacClearableEditText2, dtacPhoneNumberEditText, dtacRadioButton, dtacRadioButton2, dtacFontTextView, dtacFontTextView2, dtacFontTextView3, dtacFontTextView4, radioGroup, linearLayout, dtacFontTextView5);
                                                }
                                            }
                                        }
                                    }
    ...
    @NonNull
    public static ZIncludeMrtrMailingAddressV3Binding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static ZIncludeMrtrMailingAddressV3Binding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.z_include_mrtr_mailing_address_v3, viewGroup, false);
        if (z) {
