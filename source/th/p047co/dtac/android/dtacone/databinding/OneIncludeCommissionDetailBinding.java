...
/* renamed from: th.co.dtac.android.dtacone.databinding.OneIncludeCommissionDetailBinding */
/* loaded from: classes7.dex */
public final class OneIncludeCommissionDetailBinding implements ViewBinding {

    /* renamed from: a */
    public final ConstraintLayout f84466a;
    @NonNull
    ...
    @NonNull
    public static OneIncludeCommissionDetailBinding bind(@NonNull View view) {
            ...
            if (oneFontTextView2 != null) {
                ...
                if (oneFontTextView3 != null) {
                    ...
                    if (guideline != null) {
                        ...
                        if (guideline2 != null && (findChildViewById = ViewBindings.findChildViewById(view, (i = R.id.line_sep))) != null) {
                                                        ...
                                                        if (oneFontTextView9 != null) {
                                                            ...
                                                            if (oneFontTextView10 != null) {
                                                                ...
                                                                if (oneFontTextView11 != null) {
                                                                    return new OneIncludeCommissionDetailBinding((ConstraintLayout) view, oneFontTextView, oneFontTextView2, oneFontTextView3, guideline, guideline2, findChildViewById, recyclerView, linearLayoutCompat, oneFontTextView4, oneFontTextView5, oneFontTextView6, oneFontTextView7, oneFontTextView8, oneFontTextView9, oneFontTextView10, oneFontTextView11);
                                                                }
                                                            }
                                                        }
                                                    }
    ...
    @NonNull
    public static OneIncludeCommissionDetailBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static OneIncludeCommissionDetailBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.one_include_commission_detail, viewGroup, false);
        if (z) {
