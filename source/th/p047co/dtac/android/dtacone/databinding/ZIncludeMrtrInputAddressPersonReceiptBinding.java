...
/* renamed from: th.co.dtac.android.dtacone.databinding.ZIncludeMrtrInputAddressPersonReceiptBinding */
/* loaded from: classes7.dex */
public final class ZIncludeMrtrInputAddressPersonReceiptBinding implements ViewBinding {

    /* renamed from: a */
    public final LinearLayout f84634a;
    @NonNull
    public final DtacFontButton btnNext;
    @NonNull
    public final DtacClearableEditText edtAddress;
    @NonNull
    public final DtacClearableEditText edtBranchCode;
    @NonNull
    public final DtacClearableEditText edtName;
    @NonNull
    public final DtacClearableEditText edtPersonCardID;
    @NonNull
    ...
    @NonNull
    public static ZIncludeMrtrInputAddressPersonReceiptBinding bind(@NonNull View view) {
        int i = R.id.btnNext;
                                ...
                                if (dtacFontTextView2 != null) {
                                    ...
                                    if (dtacFontTextView3 != null) {
                                        ...
                                        if (dtacFontTextView4 != null) {
                                            ...
                                            return new ZIncludeMrtrInputAddressPersonReceiptBinding(linearLayout, dtacFontButton, dtacClearableEditText, dtacClearableEditText2, dtacClearableEditText3, dtacClearableEditText4, dtacFontTextView, dtacFontTextView2, dtacFontTextView3, dtacFontTextView4, linearLayout);
                                        }
                                    }
                                }
                            }
    ...
    @NonNull
    public static ZIncludeMrtrInputAddressPersonReceiptBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static ZIncludeMrtrInputAddressPersonReceiptBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.z_include_mrtr_input_address_person_receipt, viewGroup, false);
        if (z) {
