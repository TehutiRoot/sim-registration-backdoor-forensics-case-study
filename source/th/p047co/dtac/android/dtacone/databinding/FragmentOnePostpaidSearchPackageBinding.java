...
/* renamed from: th.co.dtac.android.dtacone.databinding.FragmentOnePostpaidSearchPackageBinding */
/* loaded from: classes7.dex */
public final class FragmentOnePostpaidSearchPackageBinding implements ViewBinding {

    /* renamed from: a */
    public final ConstraintLayout f84044a;
    @NonNull
    ...
    @NonNull
    public static FragmentOnePostpaidSearchPackageBinding bind(@NonNull View view) {
                            ...
                            if (oneFontTextView != null) {
                                ...
                                if (oneFontTextView2 != null) {
                                    ...
                                    if (oneFontTextView3 != null) {
                                        ...
                                        if (progressBar != null) {
                                            return new FragmentOnePostpaidSearchPackageBinding((ConstraintLayout) view, imageView, constraintLayout, constraintLayout2, oneEditText, recyclerView, oneFontTextView, oneFontTextView2, oneFontTextView3, progressBar);
                                        }
                                    }
                                }
                            }
    ...
    @NonNull
    public static FragmentOnePostpaidSearchPackageBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static FragmentOnePostpaidSearchPackageBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.fragment_one_postpaid_search_package, viewGroup, false);
        if (z) {
