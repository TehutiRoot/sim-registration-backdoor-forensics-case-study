...
/* renamed from: th.co.dtac.android.dtacone.databinding.OnePostpaidTruePackageItemBinding */
/* loaded from: classes7.dex */
public final class OnePostpaidTruePackageItemBinding implements ViewBinding {

    /* renamed from: a */
    public final DtacCardView f84512a;
    @NonNull
    ...
    @NonNull
    public static OnePostpaidTruePackageItemBinding bind(@NonNull View view) {
    ...
    @NonNull
    public static OnePostpaidTruePackageItemBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static OnePostpaidTruePackageItemBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.one_postpaid_true_package_item, viewGroup, false);
        if (z) {
