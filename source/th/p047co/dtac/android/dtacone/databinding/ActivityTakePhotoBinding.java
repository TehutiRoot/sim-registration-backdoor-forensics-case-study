...
/* renamed from: th.co.dtac.android.dtacone.databinding.ActivityTakePhotoBinding */
/* loaded from: classes7.dex */
public final class ActivityTakePhotoBinding implements ViewBinding {

    /* renamed from: a */
    public final CoordinatorLayout f83590a;
    @NonNull
    public final FrameLayout contentLayout;

    public ActivityTakePhotoBinding(CoordinatorLayout coordinatorLayout, FrameLayout frameLayout) {
        this.f83590a = coordinatorLayout;
    ...
    public static ActivityTakePhotoBinding bind(@NonNull View view) {
        ...
        if (frameLayout != null) {
            return new ActivityTakePhotoBinding((CoordinatorLayout) view, frameLayout);
        }
