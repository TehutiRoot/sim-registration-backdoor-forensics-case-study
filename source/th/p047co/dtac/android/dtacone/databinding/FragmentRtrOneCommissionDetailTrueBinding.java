...
/* renamed from: th.co.dtac.android.dtacone.databinding.FragmentRtrOneCommissionDetailTrueBinding */
/* loaded from: classes7.dex */
public final class FragmentRtrOneCommissionDetailTrueBinding implements ViewBinding {

    /* renamed from: a */
    public final NestedScrollView f84173a;
    @NonNull
    ...
    @NonNull
    public final OneIncludeCommissionDetailTrueBinding scDetail;
    @NonNull
    ...
    public FragmentRtrOneCommissionDetailTrueBinding(NestedScrollView nestedScrollView, CardView cardView, OneFontTextView oneFontTextView, ImageView imageView, OneFontTextView oneFontTextView2, View view, ConstraintLayout constraintLayout, OneFontTextView oneFontTextView3, OneFontTextView oneFontTextView4, OneFontTextView oneFontTextView5, OneFontTextView oneFontTextView6, ConstraintLayout constraintLayout2, OneFontTextView oneFontTextView7, OneFontTextView oneFontTextView8, OneFontTextView oneFontTextView9, OneFontTextView oneFontTextView10, OneFontTextView oneFontTextView11, ImageView imageView2, NestedScrollView nestedScrollView2, Guideline guideline, OneFontTextView oneFontTextView12, OneFontTextView oneFontTextView13, OneFontTextView oneFontTextView14, OneCommProfileBoxBinding oneCommProfileBoxBinding, OneIncludeCommissionDetailTrueBinding oneIncludeCommissionDetailTrueBinding, ConstraintLayout constraintLayout3, LinearLayout linearLayout, ConstraintLayout constraintLayout4, OneFontTextView oneFontTextView15) {
        this.f84173a = nestedScrollView;
        ...
        this.scDetail = oneIncludeCommissionDetailTrueBinding;
    ...
    @NonNull
    public static FragmentRtrOneCommissionDetailTrueBinding bind(@NonNull View view) {
                                                                                ...
                                                                                if (oneFontTextView13 != null) {
                                                                                    ...
                                                                                    if (oneFontTextView14 != null && (findChildViewById2 = ViewBindings.findChildViewById(view, (i = R.id.retailer_profile_box))) != null) {
                                                                                        ...
                                                                                        if (findChildViewById3 != null) {
                                                                                            OneIncludeCommissionDetailTrueBinding bind2 = OneIncludeCommissionDetailTrueBinding.bind(findChildViewById3);
                                                                                            i = R.id.scHeader;
    ...
    @NonNull
    public static FragmentRtrOneCommissionDetailTrueBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static FragmentRtrOneCommissionDetailTrueBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.fragment_rtr_one_commission_detail_true, viewGroup, false);
        if (z) {
