...
/* renamed from: th.co.dtac.android.dtacone.databinding.FragmentRtrOnePerformanceCommissionTrueBinding */
/* loaded from: classes7.dex */
public final class FragmentRtrOnePerformanceCommissionTrueBinding implements ViewBinding {

    /* renamed from: a */
    public final LinearLayout f84178a;
    @NonNull
    ...
    @NonNull
    public static FragmentRtrOnePerformanceCommissionTrueBinding bind(@NonNull View view) {
                                    ...
                                    if (nestedScrollView != null) {
                                        ...
                                        if (oneFontTextView4 != null) {
                                            ...
                                            if (oneFontTextView5 != null && (findChildViewById2 = ViewBindings.findChildViewById(view, (i = R.id.scDetail))) != null) {
                                                OneIncludeCommissionDetailTrueBinding bind3 = OneIncludeCommissionDetailTrueBinding.bind(findChildViewById2);
                                                i = R.id.scHeader;
    ...
    @NonNull
    public static FragmentRtrOnePerformanceCommissionTrueBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static FragmentRtrOnePerformanceCommissionTrueBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.fragment_rtr_one_performance_commission_true, viewGroup, false);
        if (z) {
