...
/* renamed from: th.co.dtac.android.dtacone.databinding.OnePre2postPackageItemRowBinding */
/* loaded from: classes7.dex */
public final class OnePre2postPackageItemRowBinding implements ViewBinding {

    /* renamed from: a */
    public final DtacCardView f84514a;
    @NonNull
    ...
    @NonNull
    public final RecyclerView rvDescList;
    @NonNull
    ...
    public OnePre2postPackageItemRowBinding(DtacCardView dtacCardView, AppCompatImageView appCompatImageView, LinearLayout linearLayout, LinearLayout linearLayout2, DtacCardView dtacCardView2, RelativeLayout relativeLayout, LinearLayout linearLayout3, OneFontTextView oneFontTextView, OneFontTextView oneFontTextView2, RelativeLayout relativeLayout2, RecyclerView recyclerView, LinearLayout linearLayout4, OneFontTextView oneFontTextView3, OneFontTextView oneFontTextView4, OneFontTextView oneFontTextView5, OneFontTextView oneFontTextView6, OneFontTextView oneFontTextView7, OneFontTextView oneFontTextView8, OneFontTextView oneFontTextView9, OneFontTextView oneFontTextView10, OneFontTextView oneFontTextView11, OneFontTextView oneFontTextView12, OneFontTextView oneFontTextView13, LinearLayout linearLayout5, LinearLayout linearLayout6) {
        this.f84514a = dtacCardView;
        ...
        this.tvStorage = oneFontTextView8;
        this.tvStorageUnit = oneFontTextView9;
        this.tvVoice = oneFontTextView10;
        this.tvVoiceUnit = oneFontTextView11;
        this.tvWifi = oneFontTextView12;
        this.tvWifiUnit = oneFontTextView13;
        this.voiceBox = linearLayout5;
        this.wifiBox = linearLayout6;
    }

    @NonNull
    public static OnePre2postPackageItemRowBinding bind(@NonNull View view) {
                                                                                        ...
                                                                                        if (oneFontTextView13 != null) {
                                                                                            ...
                                                                                            if (linearLayout5 != null) {
                                                                                                ...
                                                                                                if (linearLayout6 != null) {
                                                                                                    return new OnePre2postPackageItemRowBinding(dtacCardView, appCompatImageView, linearLayout, linearLayout2, dtacCardView, relativeLayout, linearLayout3, oneFontTextView, oneFontTextView2, relativeLayout2, recyclerView, linearLayout4, oneFontTextView3, oneFontTextView4, oneFontTextView5, oneFontTextView6, oneFontTextView7, oneFontTextView8, oneFontTextView9, oneFontTextView10, oneFontTextView11, oneFontTextView12, oneFontTextView13, linearLayout5, linearLayout6);
                                                                                                }
                                                                                            }
                                                                                        }
                                                                                    }
    ...
    @NonNull
    public static OnePre2postPackageItemRowBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static OnePre2postPackageItemRowBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.one_pre2post_package_item_row, viewGroup, false);
        if (z) {
