...
public final class PlaceCheckMarkerInfoAdapter implements GoogleMap.InfoWindowAdapter {
    ...
    /* renamed from: a */
    public final Activity f81173a;

    /* renamed from: b */
    public final CheckDtacAtHomeResponse f81174b;

    /* renamed from: c */
    public final double f81175c;
    ...
    public PlaceCheckMarkerInfoAdapter(@NotNull Activity context, @NotNull CheckDtacAtHomeResponse response, double d) {
        ...
        this.f81173a = context;
        this.f81174b = response;
        this.f81175c = d;
    }
    ...
    public View getInfoWindow(@NotNull Marker p0) {
        Intrinsics.checkNotNullParameter(p0, "p0");
        View inflate = this.f81173a.getLayoutInflater().inflate(R.layout.info_window_dtac_at_home, (ViewGroup) null);
        ...
        if (this.f81174b.getResult()) {
            ...
            Double latitude = this.f81174b.getLatitude();
            Double longitude = this.f81174b.getLongitude();
            ...
            Double latitude2 = this.f81174b.getLatitude();
            Double longitude2 = this.f81174b.getLongitude();
            tvCheckPlaceValue.setText(latitude2 + ", " + longitude2);
        }
        if (this.f81175c > 0.0d) {
            String format = new DecimalFormat("###,###,##0.00").format(this.f81175c);
            Intrinsics.checkNotNullExpressionValue(format, "formatter.format(distance)");
            String string = this.f81173a.getString(R.string.away);
            String string2 = this.f81173a.getString(R.string.meters);
