...
@Metadata(m28851d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010!\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0002\u0010\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0019\b\u0007\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0001'BG\u0012\u0006\u0010\u0004\u001a\u00020\u0003\u0012\u000e\b\u0002\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005\u0012\u0012\u0010\u000b\u001a\u000e\u0012\u0004\u0012\u00020\t\u0012\u0004\u0012\u00020\n0\b\u0012\u0012\u0010\f\u001a\u000e\u0012\u0004\u0012\u00020\t\u0012\u0004\u0012\u00020\n0\b¢\u0006\u0004\b\r\u0010\u000eJ\u001f\u0010\u0012\u001a\u00020\u00022\u0006\u0010\u0010\u001a\u00020\u000f2\u0006\u0010\u0011\u001a\u00020\tH\u0016¢\u0006\u0004\b\u0012\u0010\u0013J\u000f\u0010\u0014\u001a\u00020\tH\u0016¢\u0006\u0004\b\u0014\u0010\u0015J\u001f\u0010\u0018\u001a\u00020\n2\u0006\u0010\u0016\u001a\u00020\u00022\u0006\u0010\u0017\u001a\u00020\tH\u0016¢\u0006\u0004\b\u0018\u0010\u0019R\"\u0010\u0004\u001a\u00020\u00038\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\u001a\u0010\u001b\u001a\u0004\b\u001c\u0010\u001d\"\u0004\b\u001e\u0010\u001fR\u001c\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\u00060\u00058\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b \u0010!R \u0010\u000b\u001a\u000e\u0012\u0004\u0012\u00020\t\u0012\u0004\u0012\u00020\n0\b8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\"\u0010#R#\u0010\f\u001a\u000e\u0012\u0004\u0012\u00020\t\u0012\u0004\u0012\u00020\n0\b8\u0006¢\u0006\f\n\u0004\b$\u0010#\u001a\u0004\b%\u0010&¨\u0006("}, m28850d2 = {"Lth/co/dtac/android/dtacone/adapter/take_photo/PhotoListAdapter;", "Landroidx/recyclerview/widget/RecyclerView$Adapter;", "Lth/co/dtac/android/dtacone/adapter/take_photo/PhotoListAdapter$PhotoViewHolder;", "Landroid/content/Context;", CoreConstants.CONTEXT_SCOPE_VALUE, "", "Lth/co/dtac/android/dtacone/model/take_photo/PhotoItem;", "photoListItems", "Lkotlin/Function1;", "", "", "scrollToPosition", "onClick", "<init>", "(Landroid/content/Context;Ljava/util/List;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function1;)V", "Landroid/view/ViewGroup;", "parent", "viewType", "onCreateViewHolder", "(Landroid/view/ViewGroup;I)Lth/co/dtac/android/dtacone/adapter/take_photo/PhotoListAdapter$PhotoViewHolder;", "getItemCount", "()I", "holder", "position", "onBindViewHolder", "(Lth/co/dtac/android/dtacone/adapter/take_photo/PhotoListAdapter$PhotoViewHolder;I)V", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroid/content/Context;", "getContext", "()Landroid/content/Context;", "setContext", "(Landroid/content/Context;)V", OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, "Ljava/util/List;", OperatorName.CURVE_TO, "Lkotlin/jvm/functions/Function1;", "d", "getOnClick", "()Lkotlin/jvm/functions/Function1;", "PhotoViewHolder", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0})
...
public final class PhotoListAdapter extends RecyclerView.Adapter<PhotoViewHolder> {
    ...
    /* renamed from: a */
    public Context f81551a;

    /* renamed from: b */
    public List f81552b;

    /* renamed from: c */
    public final Function1 f81553c;

    /* renamed from: d */
    public final Function1 f81554d;

    @StabilityInferred(parameters = 0)
    @Metadata(m28851d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0007\b\u0007\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005JE\u0010\u000e\u001a\u00020\u000b2\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\b2\u0012\u0010\f\u001a\u000e\u0012\u0004\u0012\u00020\b\u0012\u0004\u0012\u00020\u000b0\n2\u0012\u0010\r\u001a\u000e\u0012\u0004\u0012\u00020\b\u0012\u0004\u0012\u00020\u000b0\n¢\u0006\u0004\b\u000e\u0010\u000fR\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0010\u0010\u0011¨\u0006\u0012"}, m28850d2 = {"Lth/co/dtac/android/dtacone/adapter/take_photo/PhotoListAdapter$PhotoViewHolder;", "Landroidx/recyclerview/widget/RecyclerView$ViewHolder;", "Lth/co/dtac/android/dtacone/databinding/PhotoListItemBinding;", "binding", "<init>", "(Lth/co/dtac/android/dtacone/databinding/PhotoListItemBinding;)V", "Lth/co/dtac/android/dtacone/model/take_photo/PhotoItem;", "item", "", "position", "Lkotlin/Function1;", "", "scrollToPosition", "onClick", "bind", "(Lth/co/dtac/android/dtacone/model/take_photo/PhotoItem;ILkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function1;)V", PDPageLabelRange.STYLE_LETTERS_LOWER, "Lth/co/dtac/android/dtacone/databinding/PhotoListItemBinding;", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0})
    ...
    public static final class PhotoViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: a */
        public final PhotoListItemBinding f81555a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public PhotoViewHolder(@NotNull PhotoListItemBinding binding) {
            super(binding.getRoot());
            Intrinsics.checkNotNullParameter(binding, "binding");
            this.f81555a = binding;
        }

        /* renamed from: b */
        public static /* synthetic */ void m20208b(PhotoItem photoItem, Function1 function1, PhotoViewHolder photoViewHolder, View view) {
            m20207c(photoItem, function1, photoViewHolder, view);
        }

        /* renamed from: c */
        public static final void m20207c(PhotoItem item, Function1 onClick, PhotoViewHolder this$0, View view) {
        ...
        public final void bind(@NotNull final PhotoItem item, int i, @NotNull Function1<? super Integer, Unit> scrollToPosition, @NotNull final Function1<? super Integer, Unit> onClick) {
            ...
            Intrinsics.checkNotNullParameter(onClick, "onClick");
            this.f81555a.textViewLabel.setText(item.getTitle());
            ImageView imageView = this.f81555a.dotRequire;
            if (item.isRequired()) {
                i2 = 0;
            } else {
                i2 = 8;
            ...
            ImageView imageView2 = this.f81555a.imageViewPhoto;
            if (item.getSrc() != null) {
                if (Intrinsics.areEqual(item.getFrameType(), OptionalModuleUtils.FACE)) {
                    Glide.with(imageView2).m74039load(item.getSrc()).apply((BaseRequestOptions<?>) new RequestOptions().transforms(new CenterCrop(), new RoundedCorners(12)).autoClone()).into(imageView2);
                } else {
                    Glide.with(imageView2).m74039load(item.getSrc()).into(imageView2);
                }
            ...
            FrameLayout frameLayout = this.f81555a.framePhoto;
            if (item.getSrc() != null) {
                z = true;
            } else {
                z = false;
            ...
            ImageView view = this.f81555a.imageCamera;
            ...
            DtacFontTextView dtacFontTextView = this.f81555a.textViewLabel;
            if (item.isActive()) {
            ...
            this.itemView.setOnClickListener(new View.OnClickListener() { // from class: qk1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    PhotoListAdapter.PhotoViewHolder.m20208b(item, onClick, this, view2);
                }
            });
        }
    }
    ...
    public final void setContext(@NotNull Context context) {
        ...
        this.f81551a = context;
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public void onBindViewHolder(@NotNull PhotoViewHolder holder, int i) {
        Intrinsics.checkNotNullParameter(holder, "holder");
        holder.bind((PhotoItem) this.f81552b.get(i), i, this.f81553c, new PhotoListAdapter$onBindViewHolder$1(this));
    }
    ...
    public PhotoListAdapter(@NotNull Context context, @NotNull List<PhotoItem> photoListItems, @NotNull Function1<? super Integer, Unit> scrollToPosition, @NotNull Function1<? super Integer, Unit> onClick) {
        ...
        Intrinsics.checkNotNullParameter(onClick, "onClick");
        this.f81551a = context;
        this.f81552b = photoListItems;
        this.f81553c = scrollToPosition;
        this.f81554d = onClick;
    }
}
