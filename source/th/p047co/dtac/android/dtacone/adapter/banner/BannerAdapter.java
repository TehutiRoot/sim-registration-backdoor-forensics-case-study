...
public final class BannerAdapter extends PagerAdapter {
    ...
    /* renamed from: c */
    public final Context f80990c;

    /* renamed from: d */
    public final List f80991d;

    /* renamed from: e */
    public final Callback f80992e;

    /* renamed from: f */
    public LayoutInflater f80993f;

    @Metadata(m28851d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\b\u0010\u0002\u001a\u00020\u0003H&J\u0010\u0010\u0004\u001a\u00020\u00032\u0006\u0010\u0005\u001a\u00020\u0006H&¨\u0006\u0007"}, m28850d2 = {"Lth/co/dtac/android/dtacone/adapter/banner/BannerAdapter$Callback;", "", "closeMission", "", "onClickMissionItem", "resultMissionItem", "Lth/co/dtac/android/dtacone/model/newsfeed/ResultMissionItem;", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    /* renamed from: b */
    public static /* synthetic */ void m20448b(BannerAdapter bannerAdapter, View view) {
        m20445e(bannerAdapter, view);
    }

    /* renamed from: c */
    public static /* synthetic */ void m20447c(BannerAdapter bannerAdapter, ResultMissionItem resultMissionItem, View view) {
        m20446d(bannerAdapter, resultMissionItem, view);
    }

    /* renamed from: d */
    public static final void m20446d(BannerAdapter this$0, ResultMissionItem resultMissionItem, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.f80992e.onClickMissionItem(resultMissionItem);
    }

    /* renamed from: e */
    public static final void m20445e(BannerAdapter this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.f80992e.closeMission();
    }
    ...
    public Object instantiateItem(@NotNull ViewGroup container, int i) {
        ...
        Intrinsics.checkNotNullParameter(container, "container");
        View inflate = this.f80993f.inflate(R.layout.item_banner, container, false);
        ...
        if (resultMissionItem != null) {
            ...
            imageView.setOnClickListener(new View.OnClickListener() { // from class: fa
                {
                    BannerAdapter.this = this;
                }

                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    BannerAdapter.m20447c(BannerAdapter.this, resultMissionItem, view);
                }
            });
        }
        imageView2.setOnClickListener(new View.OnClickListener() { // from class: ga
            ...
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                BannerAdapter.m20448b(BannerAdapter.this, view);
            }
        });
    ...
    public BannerAdapter(@NotNull Context context, @Nullable List<ResultMissionItem> list, @NotNull Callback onClickMissionItem) {
        ...
        this.f80991d = list;
        this.f80992e = onClickMissionItem;
        Object systemService = context.getSystemService("layout_inflater");
        Intrinsics.checkNotNull(systemService, "null cannot be cast to non-null type android.view.LayoutInflater");
        this.f80993f = (LayoutInflater) systemService;
    }
}
