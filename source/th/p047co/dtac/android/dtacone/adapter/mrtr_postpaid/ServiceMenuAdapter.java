...
public final class ServiceMenuAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    /* renamed from: b */
    public final Function1 f81261b;

    @StabilityInferred(parameters = 0)
    @Metadata(m28851d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0000\b\u0007\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\"\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\b2\u0012\u0010\t\u001a\u000e\u0012\u0004\u0012\u00020\u000b\u0012\u0004\u0012\u00020\u00060\n¨\u0006\f"}, m28850d2 = {"Lth/co/dtac/android/dtacone/adapter/mrtr_postpaid/ServiceMenuAdapter$ViewHolder;", "Landroidx/recyclerview/widget/RecyclerView$ViewHolder;", "itemView", "Landroid/view/View;", "(Landroid/view/View;)V", "bindView", "", NotificationCompat.CATEGORY_SERVICE, "Lth/co/dtac/android/dtacone/model/customerenquiry/ServiceList;", ServiceSpecificExtraArgs.CastExtraArgs.LISTENER, "Lkotlin/Function1;", "", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    public static final class ViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: b */
        public static /* synthetic */ void m20346b(Function1 function1, ServiceList serviceList, View view) {
            m20345c(function1, serviceList, view);
        }

        /* renamed from: c */
        public static final void m20345c(Function1 listener, ServiceList service, View view) {
        ...
        public final void bindView(@NotNull final ServiceList service, @NotNull final Function1<? super String, Unit> listener) {
            ...
            this.itemView.setOnClickListener(new View.OnClickListener() { // from class: hG1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    ServiceMenuAdapter.ViewHolder.m20346b(listener, service, view2);
                }
            });
        }
    }
    ...
    public final void setNewServiceList(@NotNull List<ServiceList> serviceList) {
        ...
        this.f81260a = serviceList;
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public void onBindViewHolder(@NotNull ViewHolder holder, int i) {
        Intrinsics.checkNotNullParameter(holder, "holder");
        holder.bindView((ServiceList) this.f81260a.get(i), this.f81261b);
    }
