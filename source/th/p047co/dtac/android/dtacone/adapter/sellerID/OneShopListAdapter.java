...
public final class OneShopListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static final class ShopListViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: a */
        public final ConstraintLayout f81505a;

        /* renamed from: b */
        public final OneFontTextView f81506b;

        /* renamed from: c */
        public final OneFontTextView f81507c;

        /* renamed from: d */
        public final ImageView f81508d;

        /* renamed from: e */
        public final View f81509e;
        ...
        public ShopListViewHolder(@NotNull View view) {
            ...
            this.f81505a = (ConstraintLayout) findViewById;
            ...
            this.f81506b = (OneFontTextView) findViewById2;
            ...
            this.f81507c = (OneFontTextView) findViewById3;
            View findViewById4 = view.findViewById(R.id.ivNext);
            Intrinsics.checkNotNull(findViewById4, "null cannot be cast to non-null type android.widget.ImageView");
            this.f81508d = (ImageView) findViewById4;
    ...
    public OneShopListAdapter(@NotNull ArrayList<ShopData> shopList, @NotNull Function0<String> getSearchText, @NotNull Function2<? super String, ? super String, Unit> onClickShop) {
        ...
        this.f81501a = shopList;
        this.f81502b = getSearchText;
        this.f81503c = onClickShop;
    }

    /* renamed from: a */
    public static /* synthetic */ void m20246a(OneShopListAdapter oneShopListAdapter, ShopData shopData, View view) {
        m20244c(oneShopListAdapter, shopData, view);
    }

    /* renamed from: c */
    public static final void m20244c(OneShopListAdapter this$0, ShopData data, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(data, "$data");
        Function2 function2 = this$0.f81503c;
    ...
    /* renamed from: b */
    public final SpannableString m20245b(Context context, String str, String str2) {
    ...
    public void onBindViewHolder(@NotNull RecyclerView.ViewHolder holder, int i) {
        ...
        if (holder instanceof ShopListViewHolder) {
            String str = (String) this.f81502b.invoke();
            ...
            tvSellerName.setText(m20245b(context, rtrName, str));
            OneFontTextView tvSellerId = shopListViewHolder.getTvSellerId();
            Context context3 = this.f81504d;
            if (context3 == null) {
                Intrinsics.throwUninitializedPropertyAccessException(CoreConstants.CONTEXT_SCOPE_VALUE);
            } else {
                context2 = context3;
            ...
            tvSellerId.setText(m20245b(context2, str2, str));
            shopListViewHolder.getOneShopItem().setOnClickListener(new View.OnClickListener() { // from class: yc1
                {
                    OneShopListAdapter.this = this;
                }

                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    OneShopListAdapter.m20246a(OneShopListAdapter.this, shopData, view);
                }
            });
            if (i == this.f81501a.size() - 1) {
