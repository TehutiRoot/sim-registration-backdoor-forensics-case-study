...
@Metadata(m28851d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0006\n\u0002\u0010\u0002\n\u0002\b\u0006\b\u0007\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0001\u0017B\u001f\u0012\u0016\u0010\u0006\u001a\u0012\u0012\u0004\u0012\u00020\u00040\u0003j\b\u0012\u0004\u0012\u00020\u0004`\u0005¢\u0006\u0004\b\u0007\u0010\bJ\u001f\u0010\r\u001a\u00020\u00022\u0006\u0010\n\u001a\u00020\t2\u0006\u0010\f\u001a\u00020\u000bH\u0016¢\u0006\u0004\b\r\u0010\u000eJ\u000f\u0010\u000f\u001a\u00020\u000bH\u0016¢\u0006\u0004\b\u000f\u0010\u0010J\u001f\u0010\u0013\u001a\u00020\u00122\u0006\u0010\u0011\u001a\u00020\u00022\u0006\u0010\f\u001a\u00020\u000bH\u0016¢\u0006\u0004\b\u0013\u0010\u0014R$\u0010\u0006\u001a\u0012\u0012\u0004\u0012\u00020\u00040\u0003j\b\u0012\u0004\u0012\u00020\u0004`\u00058\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0015\u0010\u0016¨\u0006\u0018"}, m28850d2 = {"Lth/co/dtac/android/dtacone/adapter/report/DetailProfitReportAdapter;", "Landroidx/recyclerview/widget/RecyclerView$Adapter;", "Lth/co/dtac/android/dtacone/adapter/report/DetailProfitReportAdapter$ViewHolder;", "Ljava/util/ArrayList;", "Lth/co/dtac/android/dtacone/model/rtr_performance/ProfitDetailReport$Data;", "Lkotlin/collections/ArrayList;", FirebaseAnalytics.Param.ITEMS, "<init>", "(Ljava/util/ArrayList;)V", "Landroid/view/ViewGroup;", "parent", "", "position", "onCreateViewHolder", "(Landroid/view/ViewGroup;I)Lth/co/dtac/android/dtacone/adapter/report/DetailProfitReportAdapter$ViewHolder;", "getItemCount", "()I", "viewHolder", "", "onBindViewHolder", "(Lth/co/dtac/android/dtacone/adapter/report/DetailProfitReportAdapter$ViewHolder;I)V", PDPageLabelRange.STYLE_LETTERS_LOWER, "Ljava/util/ArrayList;", "ViewHolder", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0})
...
public final class DetailProfitReportAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public static final class ViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: a */
        public final RvCommissionReportDetailItemBinding f81449a;
        ...
        @Metadata(m28851d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\n\u0002\u0010\b\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u0086T¢\u0006\u0002\n\u0000¨\u0006\u0007"}, m28850d2 = {"Lth/co/dtac/android/dtacone/adapter/report/DetailProfitReportAdapter$ViewHolder$Companion;", "", "()V", "animatedDuration", "", "hiddenSubProdHeight", "", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
        ...
        public ViewHolder(@NotNull RvCommissionReportDetailItemBinding binding) {
            ...
            this.f81449a = binding;
        }

        /* renamed from: b */
        public static /* synthetic */ void m20262b(ViewHolder viewHolder, View view) {
            m20259e(viewHolder, view);
        }

        /* renamed from: c */
        public static /* synthetic */ void m20261c(ViewHolder viewHolder, View view) {
            m20260d(viewHolder, view);
        }

        /* renamed from: d */
        public static final void m20260d(ViewHolder this$0, View view) {
            Intrinsics.checkNotNullParameter(this$0, "this$0");
            this$0.m20258f();
        }

        /* renamed from: e */
        public static final void m20259e(ViewHolder this$0, View view) {
            Intrinsics.checkNotNullParameter(this$0, "this$0");
            this$0.m20258f();
        }
        ...
        public final void bind(@NotNull ProfitDetailReport.Data item) {
            ...
            this.f81449a.ivTypeIcon.setImageResource(m20257g(item.getProdType()));
            this.f81449a.tvTypeTitle.setText(item.getProdLabel());
            this.f81449a.tvDateAt.setText(item.getAsOfDataLabel());
            this.f81449a.tvTotal.setText(item.getInfoValueLabel1());
            this.f81449a.tvLeftLabel.setText(item.getInfoLabel2());
            this.f81449a.tvLeftValue.setText(item.getInfoValueLabel2());
            this.f81449a.tvRightLabel.setText(item.getInfoLabel3());
            this.f81449a.tvRightValue.setText(item.getInfoValueLabel3());
            if (item.getSubProd() != null) {
                ImageView imageView = this.f81449a.ivExpand;
                ...
                if (!item.getSubProd().isEmpty()) {
                    RecyclerView recyclerView = this.f81449a.rvDetailItems;
                    recyclerView.setLayoutManager(new LinearLayoutManager(recyclerView.getContext(), 1, false));
                    recyclerView.setAdapter(new ProfitDetailSubProdAdapter(item.getSubProd()));
                    this.f81449a.ivExpand.setOnClickListener(new View.OnClickListener() { // from class: oG
                        {
                            DetailProfitReportAdapter.ViewHolder.this = this;
                        }

                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            DetailProfitReportAdapter.ViewHolder.m20261c(DetailProfitReportAdapter.ViewHolder.this, view);
                        }
                    });
                    this.f81449a.vgExpandBox.setOnClickListener(new View.OnClickListener() { // from class: pG
                        {
                            DetailProfitReportAdapter.ViewHolder.this = this;
                        }
                        ...
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            DetailProfitReportAdapter.ViewHolder.m20262b(DetailProfitReportAdapter.ViewHolder.this, view);
                        }
                    });
                }
            }
        ...
        /* renamed from: f */
        public final void m20258f() {
            int measuredHeight;
            Animation loadAnimation;
            int height = this.f81449a.innerContainer.getHeight();
            if (this.f81450b) {
                measuredHeight = (int) (((float) hiddenSubProdHeight) * this.itemView.getContext().getResources().getDisplayMetrics().density);
            } else {
                this.f81449a.innerContainer.getLayoutParams().height = -2;
                this.f81449a.innerContainer.measure(View.MeasureSpec.makeMeasureSpec(this.f81449a.innerContainer.getWidth(), 1073741824), View.MeasureSpec.makeMeasureSpec(0, 0));
                measuredHeight = this.f81449a.innerContainer.getMeasuredHeight();
            }
            ConstraintLayout constraintLayout = this.f81449a.innerContainer;
            ...
            this.f81450b = true ^ this.f81450b;
            this.f81449a.ivExpand.startAnimation(loadAnimation);
            this.f81449a.innerContainer.startAnimation(expandAnimation);
        }

        /* renamed from: g */
        public final int m20257g(String str) {
            switch (str.hashCode()) {
                case -224762042:
    ...
    public int getItemCount() {
        return this.f81448a.size();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public void onBindViewHolder(@NotNull ViewHolder viewHolder, int i) {
        Intrinsics.checkNotNullParameter(viewHolder, "viewHolder");
        Object obj = this.f81448a.get(i);
