...
public final class CommissionHistoryAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public static final class ViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: a */
        public final ImageView f81434a;

        /* renamed from: b */
        public final DtacFontTextView f81435b;

        /* renamed from: c */
        public final DtacFontTextView f81436c;

        /* renamed from: d */
        public final DtacFontTextView f81437d;

        /* renamed from: e */
        public final DtacFontTextView f81438e;

        /* renamed from: f */
        public final DtacFontTextView f81439f;

        /* renamed from: g */
        public final DtacFontTextView f81440g;

        /* renamed from: h */
        public final DtacFontTextView f81441h;

        /* renamed from: i */
        public final DtacFontTextView f81442i;

        /* renamed from: j */
        public final View f81443j;

        /* renamed from: k */
        public final View f81444k;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public ViewHolder(@NotNull View parent) {
            super(parent);
            Intrinsics.checkNotNullParameter(parent, "parent");
            this.f81434a = (ImageView) parent.findViewById(R.id.barPaidStatus);
            this.f81435b = (DtacFontTextView) parent.findViewById(R.id.barCommissionDate);
            this.f81436c = (DtacFontTextView) parent.findViewById(R.id.paidDate);
            this.f81437d = (DtacFontTextView) parent.findViewById(R.id.totalCommission);
            this.f81438e = (DtacFontTextView) parent.findViewById(R.id.paidTypeLabel);
            this.f81439f = (DtacFontTextView) parent.findViewById(R.id.dtacOnlinePaidTypeLabel);
            this.f81440g = (DtacFontTextView) parent.findViewById(R.id.paidTypeValue);
            this.f81441h = (DtacFontTextView) parent.findViewById(R.id.dtacOnlinePaidTypeValue);
            this.f81442i = (DtacFontTextView) parent.findViewById(R.id.barWarnningMessage);
            this.f81443j = parent.findViewById(R.id.commissionHistoryHeader);
            this.f81444k = parent.findViewById(R.id.body);
        }
    ...
    @Metadata(m28851d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0002\bf\u0018\u00002\u00020\u0001J*\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00052\u0006\u0010\u0007\u001a\u00020\b2\b\u0010\t\u001a\u0004\u0018\u00010\u0005H&¨\u0006\n"}, m28850d2 = {"Lth/co/dtac/android/dtacone/adapter/report/CommissionHistoryAdapter$onClickItemListener;", "", "onClickItem", "", TypedValues.CycleType.S_WAVE_PERIOD, "", "paidStatus", "hasPdf", "", "paidErrorMessage", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    public CommissionHistoryAdapter(@NotNull Context context, @NotNull onClickItemListener listener, @NotNull List<CommissionHistoryCollection> commissions) {
        ...
        this.f81431b = listener;
        this.f81432c = commissions;
        this.f81433d = "Y";
    }

    /* renamed from: a */
    public static /* synthetic */ void m20266a(CommissionHistoryAdapter commissionHistoryAdapter, CommissionHistoryCollection commissionHistoryCollection, View view) {
        m20265b(commissionHistoryAdapter, commissionHistoryCollection, view);
    }

    /* renamed from: b */
    public static final void m20265b(CommissionHistoryAdapter this$0, CommissionHistoryCollection commissionInfo, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(commissionInfo, "$commissionInfo");
        this$0.f81431b.onClickItem(commissionInfo.getCommissionPeriod(), commissionInfo.getPaidStatus(), Intrinsics.areEqual(commissionInfo.getFlagGeneratedPdf(), this$0.f81433d), commissionInfo.getPaidErrorMessage());
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemCount() {
        return this.f81432c.size();
    }
    ...
    public void onBindViewHolder(@NotNull ViewHolder holder, int i) {
        ...
        final CommissionHistoryCollection commissionHistoryCollection = (CommissionHistoryCollection) this.f81432c.get(i);
        ...
        switch (paidStatus.hashCode()) {
            case -1042972608:
                if (paidStatus.equals("Invalid Profile")) {
                    holder.getBarPaidStatus().setImageDrawable(ContextCompat.getDrawable(this.f81430a, R.drawable.ic_paid_fail));
                    break;
                }
                holder.getBarPaidStatus().setImageDrawable(ContextCompat.getDrawable(this.f81430a, R.drawable.ic_paid_fail));
                break;
            case 2479852:
                if (paidStatus.equals("Paid")) {
                    holder.getBarPaidStatus().setImageDrawable(ContextCompat.getDrawable(this.f81430a, R.drawable.ic_paid_success));
                    break;
                }
                holder.getBarPaidStatus().setImageDrawable(ContextCompat.getDrawable(this.f81430a, R.drawable.ic_paid_fail));
                break;
            ...
            case 1157381589:
                if (paidStatus.equals("In-Progress")) {
                    holder.getBarPaidStatus().setImageDrawable(ContextCompat.getDrawable(this.f81430a, R.drawable.ic_wait_calculate));
                    break;
                }
                holder.getBarPaidStatus().setImageDrawable(ContextCompat.getDrawable(this.f81430a, R.drawable.ic_paid_fail));
                break;
        ...
        holder.getBody().setOnClickListener(new View.OnClickListener() { // from class: eu
            {
                CommissionHistoryAdapter.this = this;
            }

            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                CommissionHistoryAdapter.m20266a(CommissionHistoryAdapter.this, commissionHistoryCollection, view);
            }
        });
    }
