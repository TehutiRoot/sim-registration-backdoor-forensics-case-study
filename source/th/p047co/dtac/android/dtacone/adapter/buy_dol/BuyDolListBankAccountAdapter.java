...
public final class BuyDolListBankAccountAdapter extends RecyclerView.Adapter<BankAccountViewHolder> {
    ...
    public static final class BankAccountViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: a */
        public TextView f81011a;

        /* renamed from: b */
        public TextView f81012b;

        /* renamed from: c */
        public ImageView f81013c;

        /* renamed from: d */
        public CardView f81014d;

        /* renamed from: e */
        public RadioButton f81015e;

        /* renamed from: f */
        public RadioGroup f81016f;
        ...
        public BankAccountViewHolder(@NotNull ZBankAccountItemRowBinding binding) {
            ...
            this.f81012b = dtacFontTextView2;
            ...
            this.f81013c = appCompatImageView;
        ...
        public final void setTvAccountNumber(@NotNull TextView textView) {
            ...
            this.f81012b = textView;
        }

        public final void setTvName(@NotNull TextView textView) {
            Intrinsics.checkNotNullParameter(textView, "<set-?>");
            this.f81011a = textView;
        }
    }
    ...
    public BuyDolListBankAccountAdapter(@NotNull BuyDolDirectAccounts directAccounts, @NotNull Context context) {
        ...
        this.f81007a = directAccounts;
        this.f81008b = context;
    }

    /* renamed from: a */
    public static /* synthetic */ void m20438a(BankAccountViewHolder bankAccountViewHolder, DirectAccount directAccount, BuyDolListBankAccountAdapter buyDolListBankAccountAdapter, View view) {
        m20433f(bankAccountViewHolder, directAccount, buyDolListBankAccountAdapter, view);
    }

    /* renamed from: b */
    public static /* synthetic */ void m20437b(BuyDolListBankAccountAdapter buyDolListBankAccountAdapter, DirectAccount directAccount, RadioGroup radioGroup, int i) {
        m20434e(buyDolListBankAccountAdapter, directAccount, radioGroup, i);
    }

    /* renamed from: d */
    private final String m20435d(String str) {
    ...
    /* renamed from: e */
    public static final void m20434e(BuyDolListBankAccountAdapter this$0, DirectAccount directAccount, RadioGroup radioGroup, int i) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        RadioGroup radioGroup2 = this$0.f81009c;
        if (radioGroup2 != radioGroup && radioGroup2 != null) {
            radioGroup2.clearCheck();
        }
        this$0.f81009c = radioGroup;
        if (directAccount != null) {
            this$0.m20432g(directAccount);
        }
    }

    /* renamed from: f */
    public static final void m20433f(BankAccountViewHolder holder, DirectAccount directAccount, BuyDolListBankAccountAdapter this$0, View view) {
    ...
    /* renamed from: c */
    public final void m20436c(DirectAccount directAccount, BankAccountViewHolder bankAccountViewHolder) {
        String str;
        int i;
        ...
        bankAccountViewHolder.getIvBankBand().setImageDrawable(ContextCompat.getDrawable(this.f81008b, i));
    }

    /* renamed from: g */
    public final void m20432g(DirectAccount directAccount) {
        this.f81010d = directAccount;
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemCount() {
        List<DirectAccount> directAccounts = this.f81007a.getDirectAccounts();
    ...
    public void onBindViewHolder(@NotNull final BankAccountViewHolder holder, int i) {
        ...
        if (directAccount != null) {
            m20436c(directAccount, holder);
        }
        holder.getTvName().setText(m20435d((directAccount == null || (r2 = directAccount.getBankCode()) == null) ? "" : ""));
        ...
        holder.getRdbGroup().setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: Ie
            {
                BuyDolListBankAccountAdapter.this = this;
            }

            @Override // android.widget.RadioGroup.OnCheckedChangeListener
            public final void onCheckedChanged(RadioGroup radioGroup, int i2) {
                BuyDolListBankAccountAdapter.m20437b(BuyDolListBankAccountAdapter.this, directAccount, radioGroup, i2);
            }
        });
        ...
        holder.getCreditCardView().setOnClickListener(new View.OnClickListener() { // from class: Je
            ...
            public final void onClick(View view) {
                BuyDolListBankAccountAdapter.m20438a(holder, directAccount, this, view);
            }
        });
    }
