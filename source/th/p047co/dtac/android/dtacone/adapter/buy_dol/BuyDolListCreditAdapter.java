...
public final class BuyDolListCreditAdapter extends RecyclerView.Adapter<BuyDolCreditViewHolder> {
    ...
    /* renamed from: a */
    public final OnBuyDolSelectItem f81017a;

    /* renamed from: b */
    public final OnDeleteCard f81018b;

    /* renamed from: c */
    public final String f81019c;

    /* renamed from: d */
    public final ArrayList f81020d;

    /* renamed from: e */
    public final Context f81021e;

    /* renamed from: f */
    public RadioGroup f81022f;

    @Metadata(m28851d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0005\b\u0086\u0004\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005J\u0015\u0010\t\u001a\u00020\b2\u0006\u0010\u0007\u001a\u00020\u0006¢\u0006\u0004\b\t\u0010\nR\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u000b\u0010\f¨\u0006\r"}, m28850d2 = {"Lth/co/dtac/android/dtacone/adapter/buy_dol/BuyDolListCreditAdapter$BuyDolCreditViewHolder;", "Landroidx/recyclerview/widget/RecyclerView$ViewHolder;", "Lth/co/dtac/android/dtacone/databinding/ZCreditCardItemRowBinding;", "binding", "<init>", "(Lth/co/dtac/android/dtacone/adapter/buy_dol/BuyDolListCreditAdapter;Lth/co/dtac/android/dtacone/databinding/ZCreditCardItemRowBinding;)V", "Lth/co/dtac/android/dtacone/model/buy_dol/CreditCard;", "item", "", "bind", "(Lth/co/dtac/android/dtacone/model/buy_dol/CreditCard;)V", PDPageLabelRange.STYLE_LETTERS_LOWER, "Lth/co/dtac/android/dtacone/databinding/ZCreditCardItemRowBinding;", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0})
    ...
    public final class BuyDolCreditViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: a */
        public final ZCreditCardItemRowBinding f81023a;

        /* renamed from: b */
        public final /* synthetic */ BuyDolListCreditAdapter f81024b;
        ...
        public BuyDolCreditViewHolder(@NotNull BuyDolListCreditAdapter buyDolListCreditAdapter, ZCreditCardItemRowBinding binding) {
            ...
            this.f81024b = buyDolListCreditAdapter;
            this.f81023a = binding;
        }

        /* renamed from: b */
        public static /* synthetic */ void m20429b(ZCreditCardItemRowBinding zCreditCardItemRowBinding, BuyDolListCreditAdapter buyDolListCreditAdapter, BuyDolCreditViewHolder buyDolCreditViewHolder, View view) {
            m20424g(zCreditCardItemRowBinding, buyDolListCreditAdapter, buyDolCreditViewHolder, view);
        }

        /* renamed from: c */
        public static /* synthetic */ void m20428c(BuyDolListCreditAdapter buyDolListCreditAdapter, BuyDolCreditViewHolder buyDolCreditViewHolder, RadioGroup radioGroup, int i) {
            m20426e(buyDolListCreditAdapter, buyDolCreditViewHolder, radioGroup, i);
        }

        /* renamed from: d */
        public static /* synthetic */ void m20427d(BuyDolListCreditAdapter buyDolListCreditAdapter, CreditCard creditCard, BuyDolCreditViewHolder buyDolCreditViewHolder, View view) {
            m20425f(buyDolListCreditAdapter, creditCard, buyDolCreditViewHolder, view);
        }

        /* renamed from: e */
        public static final void m20426e(BuyDolListCreditAdapter this$0, BuyDolCreditViewHolder this$1, RadioGroup radioGroup, int i) {
            RadioGroup radioGroup2;
            Intrinsics.checkNotNullParameter(this$0, "this$0");
            Intrinsics.checkNotNullParameter(this$1, "this$1");
            if (this$0.f81022f != radioGroup && (radioGroup2 = this$0.f81022f) != null) {
                radioGroup2.clearCheck();
            }
            this$0.f81022f = radioGroup;
            this$0.m20430b(this$1.getAbsoluteAdapterPosition());
        }

        /* renamed from: f */
        public static final void m20425f(BuyDolListCreditAdapter this$0, CreditCard item, BuyDolCreditViewHolder this$1, View view) {
            Intrinsics.checkNotNullParameter(this$0, "this$0");
            Intrinsics.checkNotNullParameter(item, "$item");
            Intrinsics.checkNotNullParameter(this$1, "this$1");
            OnDeleteCard onDeleteCard = this$0.f81018b;
            String str = this$0.f81019c;
        ...
        /* renamed from: g */
        public static final void m20424g(ZCreditCardItemRowBinding this_apply, BuyDolListCreditAdapter this$0, BuyDolCreditViewHolder this$1, View view) {
        ...
        public final void bind(@NotNull final CreditCard item) {
            Intrinsics.checkNotNullParameter(item, "item");
            final ZCreditCardItemRowBinding zCreditCardItemRowBinding = this.f81023a;
            final BuyDolListCreditAdapter buyDolListCreditAdapter = this.f81024b;
            buyDolListCreditAdapter.m20431a(item, zCreditCardItemRowBinding);
            ...
            zCreditCardItemRowBinding.rdbGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: Re
                ...
                public final void onCheckedChanged(RadioGroup radioGroup, int i) {
                    BuyDolListCreditAdapter.BuyDolCreditViewHolder.m20428c(buyDolListCreditAdapter, this, radioGroup, i);
                }
            });
            ...
            zCreditCardItemRowBinding.ivDelete.setOnClickListener(new View.OnClickListener() { // from class: Se
                ...
                public final void onClick(View view) {
                    BuyDolListCreditAdapter.BuyDolCreditViewHolder.m20427d(buyDolListCreditAdapter, item, this, view);
                }
            });
            zCreditCardItemRowBinding.bankAccountCardView.setOnClickListener(new View.OnClickListener() { // from class: Te
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    BuyDolListCreditAdapter.BuyDolCreditViewHolder.m20429b(ZCreditCardItemRowBinding.this, buyDolListCreditAdapter, this, view);
                }
            });
        }
    }
    ...
    public BuyDolListCreditAdapter(@NotNull OnBuyDolSelectItem<CreditCard> buyDolSelectCardListener, @NotNull OnDeleteCard<String> deleteCard, @NotNull String accountCode, @NotNull ArrayList<CreditCard> cards, @NotNull Context context) {
        ...
        this.f81017a = buyDolSelectCardListener;
        this.f81018b = deleteCard;
        this.f81019c = accountCode;
        this.f81020d = cards;
        this.f81021e = context;
    }

    /* renamed from: a */
    public final void m20431a(CreditCard creditCard, ZCreditCardItemRowBinding zCreditCardItemRowBinding) {
        String str;
        int i;
        ...
        zCreditCardItemRowBinding.ivBankBand.setImageDrawable(ContextCompat.getDrawable(this.f81021e, i));
    }

    /* renamed from: b */
    public final void m20430b(int i) {
        Object obj = this.f81020d.get(i);
        Intrinsics.checkNotNullExpressionValue(obj, "cards[position]");
        CreditCard creditCard = (CreditCard) obj;
        this.f81017a.onBuyDolSelectItem(new CreditCard(creditCard.getName(), creditCard.getCardNumber(), creditCard.getBrand(), creditCard.getBank(), creditCard.getCardToken()));
    }

    public final void clearSelectedCard() {
        RadioGroup radioGroup = this.f81022f;
        if (radioGroup != null) {
            if (radioGroup != null) {
