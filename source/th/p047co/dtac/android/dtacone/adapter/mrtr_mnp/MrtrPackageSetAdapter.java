...
public final class MrtrPackageSetAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    /* renamed from: b */
    public final ArrayList f81244b;

    /* renamed from: c */
    public OnClickItemPackageSet f81245c;

    /* renamed from: d */
    public int f81246d;

    @Metadata(m28851d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&¨\u0006\u0006"}, m28850d2 = {"Lth/co/dtac/android/dtacone/adapter/mrtr_mnp/MrtrPackageSetAdapter$OnClickItemPackageSet;", "", "onClickPackage", "", "packages", "Lth/co/dtac/android/dtacone/model/mrtr_mnp/package_set/response/PackageSetListItem;", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    public final class PackageSetItemViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: a */
        public final DtacCardView f81247a;

        /* renamed from: b */
        public final TextView f81248b;

        /* renamed from: c */
        public final RelativeLayout f81249c;

        /* renamed from: d */
        public final TextView f81250d;

        /* renamed from: e */
        public final LinearLayoutCompat f81251e;

        /* renamed from: f */
        public final TextView f81252f;

        /* renamed from: g */
        public final LinearLayoutCompat f81253g;

        /* renamed from: h */
        public final TextView f81254h;

        /* renamed from: i */
        public final LinearLayoutCompat f81255i;

        /* renamed from: j */
        public final TextView f81256j;

        /* renamed from: k */
        public final /* synthetic */ MrtrPackageSetAdapter f81257k;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public PackageSetItemViewHolder(@NotNull MrtrPackageSetAdapter mrtrPackageSetAdapter, View view) {
            super(view);
            Intrinsics.checkNotNullParameter(view, "view");
            this.f81257k = mrtrPackageSetAdapter;
            ...
            this.f81251e = (LinearLayoutCompat) findViewById5;
            View findViewById6 = view.findViewById(R.id.tvVoiceDataValue);
            Intrinsics.checkNotNull(findViewById6, "null cannot be cast to non-null type android.widget.TextView");
            this.f81252f = (TextView) findViewById6;
            ...
            this.f81253g = (LinearLayoutCompat) findViewById7;
            View findViewById8 = view.findViewById(R.id.tvVoiceBoxValue);
            Intrinsics.checkNotNull(findViewById8, "null cannot be cast to non-null type android.widget.TextView");
            this.f81254h = (TextView) findViewById8;
            ...
            this.f81255i = (LinearLayoutCompat) findViewById9;
            View findViewById10 = view.findViewById(R.id.tvWifiDataValue);
            Intrinsics.checkNotNull(findViewById10, "null cannot be cast to non-null type android.widget.TextView");
            this.f81256j = (TextView) findViewById10;
        }
    ...
    public MrtrPackageSetAdapter(@NotNull Context mContext, @NotNull ArrayList<PackageSetListItem> packageList) {
        ...
        this.f81243a = mContext;
        this.f81244b = packageList;
    }

    /* renamed from: a */
    public static /* synthetic */ void m20352a(MrtrPackageSetAdapter mrtrPackageSetAdapter, PackageSetListItem packageSetListItem, View view) {
        m20349d(mrtrPackageSetAdapter, packageSetListItem, view);
    }

    /* renamed from: d */
    public static final void m20349d(MrtrPackageSetAdapter this$0, PackageSetListItem packages, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(packages, "$packages");
        OnClickItemPackageSet onClickItemPackageSet = this$0.f81245c;
    ...
    /* renamed from: b */
    public final PackageSetItemViewHolder m20351b(ViewGroup viewGroup) {
    ...
    /* renamed from: c */
    public final void m20350c(PackageSetItemViewHolder packageSetItemViewHolder, int i) {
        if (packageSetItemViewHolder.getAdapterPosition() > this.f81246d) {
            packageSetItemViewHolder.getCardViewPackageItem().startAnimation(AnimationUtils.loadAnimation(this.f81243a, R.anim.slide_up));
            this.f81246d = packageSetItemViewHolder.getAdapterPosition();
        }
        Object obj = this.f81244b.get(i);
        ...
        packageSetItemViewHolder.getCardViewPackageItem().setOnClickListener(new View.OnClickListener() { // from class: ry0
            {
                MrtrPackageSetAdapter.this = this;
            }

            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                MrtrPackageSetAdapter.m20352a(MrtrPackageSetAdapter.this, packageSetListItem, view);
            }
        });
    }
    ...
    public void onBindViewHolder(@NotNull RecyclerView.ViewHolder holder, int i) {
        ...
        if (holder instanceof PackageSetItemViewHolder) {
            m20350c((PackageSetItemViewHolder) holder, i);
        }
    }
