...
public final class ESimNumberListAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public static final class ViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: a */
        public final DtacFontTextView f81190a;
        ...
        public ViewHolder(@NotNull View itemView) {
            ...
            this.f81190a = (DtacFontTextView) findViewById;
        }

        /* renamed from: b */
        public static /* synthetic */ void m20366b(OnClickItemListener onClickItemListener, TelephoneNumberListItem telephoneNumberListItem, View view) {
            m20365c(onClickItemListener, telephoneNumberListItem, view);
        }

        /* renamed from: c */
        public static final void m20365c(OnClickItemListener listener, TelephoneNumberListItem telephoneNumberListItem, View view) {
        ...
        public final void bind(@Nullable final TelephoneNumberListItem telephoneNumberListItem, @NotNull final OnClickItemListener<? super TelephoneNumberListItem> listener) {
            Intrinsics.checkNotNullParameter(listener, "listener");
            this.f81190a.setText((telephoneNumberListItem == null || (r1 = telephoneNumberListItem.getDisplayTelephoneNumber()) == null) ? "" : "");
            this.itemView.setOnClickListener(new View.OnClickListener() { // from class: wN
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    ESimNumberListAdapter.ViewHolder.m20366b(listener, telephoneNumberListItem, view);
                }
            });
        }
    }
    ...
    public ESimNumberListAdapter(@NotNull Activity activity, @Nullable List<TelephoneNumberListItem> list, @NotNull OnClickItemListener<? super TelephoneNumberListItem> listener) {
        ...
        Intrinsics.checkNotNullParameter(listener, "listener");
        this.f81187a = activity;
        this.f81188b = list;
        this.f81189c = listener;
    }
    ...
    public void onBindViewHolder(@NotNull ViewHolder holder, int i) {
        ...
        List list = this.f81188b;
        holder.bind(list != null ? (TelephoneNumberListItem) list.get(i) : null, this.f81189c);
    }
    ...
    public ViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int i) {
        ...
        View view = LayoutInflater.from(this.f81187a).inflate(R.layout.item_esim_select_number, parent, false);
