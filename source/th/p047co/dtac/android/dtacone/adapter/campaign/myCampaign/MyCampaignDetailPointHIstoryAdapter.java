...
public final class MyCampaignDetailPointHIstoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    /* renamed from: b */
    public final LoadImageUtil f81079b;

    /* renamed from: c */
    public final List f81080c;

    /* renamed from: d */
    public final boolean f81081d;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final int $stable = 8;

    @Metadata(m28851d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0005"}, m28850d2 = {"Lth/co/dtac/android/dtacone/adapter/campaign/myCampaign/MyCampaignDetailPointHIstoryAdapter$Companion;", "", "()V", "VIEW_TYPE_NORMAL", "", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    public final class MyCampaignPointHistoryItemViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: a */
        public final RelativeLayout f81082a;

        /* renamed from: b */
        public final RelativeLayout f81083b;

        /* renamed from: c */
        public final RecyclerView f81084c;

        /* renamed from: d */
        public final ImageView f81085d;

        /* renamed from: e */
        public final TextView f81086e;

        /* renamed from: f */
        public final TextView f81087f;

        /* renamed from: g */
        public final TextView f81088g;

        /* renamed from: h */
        public final TextView f81089h;

        /* renamed from: i */
        public final TextView f81090i;

        /* renamed from: j */
        public final ImageView f81091j;

        /* renamed from: k */
        public final RecyclerView f81092k;

        /* renamed from: l */
        public final /* synthetic */ MyCampaignDetailPointHIstoryAdapter f81093l;
        ...
        public MyCampaignPointHistoryItemViewHolder(@NotNull MyCampaignDetailPointHIstoryAdapter myCampaignDetailPointHIstoryAdapter, View view) {
            ...
            this.f81092k = (RecyclerView) findViewById11;
        }
    ...
    public MyCampaignDetailPointHIstoryAdapter(@NotNull Context context, @NotNull LoadImageUtil loadImageUtil, @NotNull List<CampaignDetailHistoryItem> historyPointList, boolean z) {
        ...
        this.f81079b = loadImageUtil;
        this.f81080c = historyPointList;
        this.f81081d = z;
    }

    /* renamed from: a */
    private final void m20408a(int i, ImageView imageView) {
        Glide.with(this.f81078a).clear(imageView);
        Glide.with(this.f81078a).m74043load(Integer.valueOf(i)).fitCenter().into(imageView);
    }

    /* renamed from: b */
    private final void m20407b(String str, ImageView imageView) {
        Glide.with(this.f81078a).clear(imageView);
        Glide.with(this.f81078a).m74044load((Object) this.f81079b.getGlideUrlByIdWithHeader(str)).skipMemoryCache(true).transition(DrawableTransitionOptions.withCrossFade()).error(ContextCompat.getDrawable(this.f81078a, R.drawable.image_default)).diskCacheStrategy(DiskCacheStrategy.DATA).into(imageView);
    }

    /* renamed from: c */
    public final void m20406c(MyCampaignPointHistoryItemViewHolder myCampaignPointHistoryItemViewHolder, List list) {
        myCampaignPointHistoryItemViewHolder.getLayoutDescription().setVisibility(0);
        setAdapter(new HistoryDescriptionAdapter(this.f81078a, list));
        myCampaignPointHistoryItemViewHolder.getRecyclerItemDescription().setLayoutManager(new LinearLayoutManager(this.f81078a, 1, false));
    ...
    public void onBindViewHolder(@NotNull RecyclerView.ViewHolder holder, int i) {
        ...
        CampaignDetailHistoryItem campaignDetailHistoryItem = (CampaignDetailHistoryItem) this.f81080c.get(i);
        if (holder instanceof MyCampaignPointHistoryItemViewHolder) {
            if (AbstractC20204hN1.equals$default(campaignDetailHistoryItem.getPointType(), Constant.CampaignType.HISTORY_TYPE_ADJUST, false, 2, null)) {
                if (this.f81081d) {
                ...
                m20408a(i3, myCampaignPointHistoryItemViewHolder.getIvHistoryIcon());
                ...
                m20406c(myCampaignPointHistoryItemViewHolder, displayPointDetail);
            } else if (AbstractC20204hN1.equals$default(campaignDetailHistoryItem.getPointType(), Constant.CampaignType.HISTORY_TYPE_REDEEM, false, 2, null)) {
                MyCampaignPointHistoryItemViewHolder myCampaignPointHistoryItemViewHolder2 = (MyCampaignPointHistoryItemViewHolder) holder;
                m20408a(R.drawable.ic_gift_circle, myCampaignPointHistoryItemViewHolder2.getIvHistoryIcon());
            ...
            } else if (AbstractC20204hN1.equals$default(campaignDetailHistoryItem.getPointType(), Constant.CampaignType.HISTORY_TYPE_POINT, false, 2, null)) {
                if (this.f81081d) {
                ...
                m20408a(i2, myCampaignPointHistoryItemViewHolder3.getIvHistoryIcon());
                ...
                m20406c(myCampaignPointHistoryItemViewHolder3, displayPointDetail2);
            } else {
            ...
            if (campaignDetailHistoryItem.getDisplayImage() != null) {
                ...
                if (imageId != null) {
                    m20407b(imageId, myCampaignPointHistoryItemViewHolder5.getIvGetReward());
                }
                ...
                myCampaignPointHistoryItemViewHolder5.getRecyclerReward().setLayoutManager(new LinearLayoutManager(this.f81078a, 1, false));
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int i) {
        ...
        View view = LayoutInflater.from(this.f81078a).inflate(R.layout.item_my_campaign_detail_point_history, parent, false);
