...
public final class OwnerListAdapter extends RecyclerView.Adapter<OwnerListViewHolder> {
    ...
    public final class OwnerListViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: a */
        public final ZOwnerListItemRowBinding f81228a;

        /* renamed from: b */
        public final /* synthetic */ OwnerListAdapter f81229b;
        ...
        public OwnerListViewHolder(@NotNull OwnerListAdapter ownerListAdapter, ZOwnerListItemRowBinding binding) {
            ...
            this.f81229b = ownerListAdapter;
            this.f81228a = binding;
        }

        /* renamed from: b */
        public static /* synthetic */ void m20357b(OnClickOwner onClickOwner, OwnerCollection ownerCollection, View view) {
            m20356c(onClickOwner, ownerCollection, view);
        }

        /* renamed from: c */
        public static final void m20356c(OnClickOwner onClickOwner, OwnerCollection ownerCollection, View view) {
        ...
        public final void bind(@Nullable final OwnerCollection ownerCollection, @Nullable final OnClickOwner onClickOwner) {
            ...
            String str2;
            String userId;
            ZOwnerListItemRowBinding zOwnerListItemRowBinding = this.f81228a;
            OwnerListAdapter ownerListAdapter = this.f81229b;
            if (ownerListAdapter.f81227d >= getAbsoluteAdapterPosition()) {
                ...
                ownerListAdapter.f81227d = getAbsoluteAdapterPosition();
            }
            ...
            zOwnerListItemRowBinding.cardviewInactivityListUser.setOnClickListener(new View.OnClickListener() { // from class: bh1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    OwnerListAdapter.OwnerListViewHolder.m20357b(onClickOwner, ownerCollection, view);
                }
            });
        }
    ...
    public int getItemCount() {
        ...
        OwnerListCollection ownerListCollection = this.f81225b;
    ...
    public void onBindViewHolder(@NotNull OwnerListViewHolder holder, int i) {
        ...
        OwnerListCollection ownerListCollection = this.f81225b;
        holder.bind((ownerListCollection == null || (owners = ownerListCollection.getOwners()) == null) ? null : owners.get(i), this.f81226c);
    }
