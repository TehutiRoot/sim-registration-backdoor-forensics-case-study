...
public final class OwnerTransactionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    /* renamed from: a */
    public final OwnerTransactionCollection f81230a;

    /* renamed from: b */
    public final OnClickretry f81231b;
    ...
    @Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\b\u0010\u0002\u001a\u00020\u0003H&¨\u0006\u0004"}, m28850d2 = {"Lth/co/dtac/android/dtacone/adapter/inactive_user/OwnerTransactionAdapter$OnClickretry;", "", "onretry", "", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    public static final class OwnerErrorViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: a */
        public final ZErrorViewRecycleBinding f81234a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OwnerErrorViewHolder(@NotNull ZErrorViewRecycleBinding binding) {
            super(binding.getRoot());
            Intrinsics.checkNotNullParameter(binding, "binding");
            this.f81234a = binding;
        }

        /* renamed from: b */
        public static /* synthetic */ void m20354b(OnClickretry onClickretry, View view) {
            m20353c(onClickretry, view);
        }

        /* renamed from: c */
        public static final void m20353c(OnClickretry onClickRetry, View view) {
        ...
        public final void bind(@NotNull final OnClickretry onClickRetry) {
            Intrinsics.checkNotNullParameter(onClickRetry, "onClickRetry");
            this.f81234a.btnRetryHistorySell.setOnClickListener(new View.OnClickListener() { // from class: fh1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    OwnerTransactionAdapter.OwnerErrorViewHolder.m20354b(onClickRetry, view);
                }
            });
        }
    }
    ...
    public static final class OwnerHeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: a */
        public final RtrHistoryHeaderBinding f81235a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OwnerHeaderViewHolder(@NotNull RtrHistoryHeaderBinding binding) {
            super(binding.getRoot());
            Intrinsics.checkNotNullParameter(binding, "binding");
            this.f81235a = binding;
        }

        public final void bind(@NotNull OwnerTransactionCollection.Summary summary) {
            Intrinsics.checkNotNullParameter(summary, "summary");
            this.f81235a.listTitle.setText(summary.getListTitle());
            this.f81235a.listValue.setText(summary.getListValue());
            this.f81235a.totalTitle.setText(summary.getTotalTitle());
            this.f81235a.totalValue.setText(summary.getTotalValue());
            this.f81235a.title.setText(summary.getTitle());
        }
    }

    @StabilityInferred(parameters = 0)
    @Metadata(m28851d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0005\b\u0007\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005J\u001f\u0010\u000b\u001a\u00020\n2\u0006\u0010\u0007\u001a\u00020\u00062\b\u0010\t\u001a\u0004\u0018\u00010\b¢\u0006\u0004\b\u000b\u0010\fR\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\r\u0010\u000e¨\u0006\u000f"}, m28850d2 = {"Lth/co/dtac/android/dtacone/adapter/inactive_user/OwnerTransactionAdapter$OwnerTransactionViewHolder;", "Landroidx/recyclerview/widget/RecyclerView$ViewHolder;", "Lth/co/dtac/android/dtacone/databinding/ZOwnerTransactionItemRowBinding;", "binding", "<init>", "(Lth/co/dtac/android/dtacone/databinding/ZOwnerTransactionItemRowBinding;)V", "Lth/co/dtac/android/dtacone/model/inactive_user/OwnerTransactionCollection$LastTransaction;", "ownerTransaction", "", "isUserLan", "", "bind", "(Lth/co/dtac/android/dtacone/model/inactive_user/OwnerTransactionCollection$LastTransaction;Ljava/lang/Boolean;)V", PDPageLabelRange.STYLE_LETTERS_LOWER, "Lth/co/dtac/android/dtacone/databinding/ZOwnerTransactionItemRowBinding;", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0})
    ...
    public static final class OwnerTransactionViewHolder extends RecyclerView.ViewHolder {
        ...
        public final void bind(@NotNull OwnerTransactionCollection.LastTransaction ownerTransaction, @Nullable Boolean bool) {
            ...
            DtacFontTextView dtacFontTextView = this.f81236a.tvTransactionPhoneNumber;
            ...
            DtacFontTextView dtacFontTextView2 = this.f81236a.tvTransactionTime;
            ...
            DtacFontTextView dtacFontTextView3 = this.f81236a.tvTransactionOwnerTitle;
            ...
            DtacFontTextView dtacFontTextView4 = this.f81236a.tvTransactionOwnerValue;
            ...
            DtacFontTextView dtacFontTextView5 = this.f81236a.tvTransactionType;
            String displayType = ownerTransaction.getDisplayType();
            if (displayType == null) {
                displayType = "";
            }
            dtacFontTextView5.setText(displayType);
            DtacFontTextView dtacFontTextView6 = this.f81236a.tvTransactionAmount;
            ...
            AppCompatImageView appCompatImageView = this.f81236a.ivImageType;
            ...
            DtacFontTextView dtacFontTextView7 = this.f81236a.tvTransactionAmount;
            ...
            DtacFontTextView dtacFontTextView8 = this.f81236a.tvTransactionUnit;
            ...
            DtacFontTextView dtacFontTextView9 = this.f81236a.tvTransactionName;
            ...
            DtacFontTextView dtacFontTextView10 = this.f81236a.tvTransactionName;
            ...
            if (Intrinsics.areEqual(featureCode, PermissionConstant.M_EXPR_PACK)) {
                DtacFontTextView dtacFontTextView11 = this.f81236a.tvTransactionOption;
                ...
                this.f81236a.tvTransactionOption.setText(ownerTransaction.getDisplayExpireOption());
            } else if (Intrinsics.areEqual(featureCode, PermissionConstant.M_FAMI_SIM)) {
                DtacFontTextView dtacFontTextView12 = this.f81236a.tvTransactionName;
                ...
                DtacFontTextView dtacFontTextView13 = this.f81236a.tvTransactionName;
                ...
                DtacFontTextView dtacFontTextView14 = this.f81236a.tvTransactionOption;
    ...
    public OwnerTransactionAdapter(@NotNull OwnerTransactionCollection ownTransactions, @NotNull OnClickretry onClickRetry, boolean z, @Nullable Boolean bool) {
        ...
        Intrinsics.checkNotNullParameter(onClickRetry, "onClickRetry");
        this.f81230a = ownTransactions;
        this.f81231b = onClickRetry;
        this.f81232c = z;
        this.f81233d = bool;
    }

    /* renamed from: a */
    private final RecyclerView.ViewHolder m20355a(int i, ViewGroup viewGroup) {
        if (!this.f81230a.getLastTransactions().isEmpty()) {
            if (i == 0) {
    ...
    public final void addLasttransection(@NotNull OwnerTransactionCollection ownTransaction) {
        ...
        this.f81230a.getLastTransactions().addAll(ownTransaction.getLastTransactions());
    ...
    public int getItemCount() {
        ...
        if (this.f81230a.getLastTransactions().size() == 0) {
            return 2;
        }
        return 1 + this.f81230a.getLastTransactions().size();
    }
    ...
    public void onBindViewHolder(@NotNull RecyclerView.ViewHolder holder, int i) {
        ...
        OwnerTransactionCollection.Summary summary = this.f81230a.getSummary();
        if (holder instanceof OwnerTransactionViewHolder) {
            OwnerTransactionCollection.LastTransaction lastTransaction = this.f81230a.getLastTransactions().get(i - 1);
            Intrinsics.checkNotNullExpressionValue(lastTransaction, "ownTransactions.lastTransactions.get(position - 1)");
            ((OwnerTransactionViewHolder) holder).bind(lastTransaction, this.f81233d);
            ...
            ((OwnerErrorViewHolder) holder).bind(this.f81231b);
        }
    }
