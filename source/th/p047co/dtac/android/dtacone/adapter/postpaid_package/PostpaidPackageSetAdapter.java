...
public class PostpaidPackageSetAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    /* renamed from: b */
    public final int f81395b = 1;

    /* renamed from: c */
    public final int f81396c = 2;

    /* renamed from: d */
    public Context f81397d;

    /* renamed from: e */
    public OnClickPackage f81398e;
    ...
    public PostpaidPackageSetAdapter(Context context) {
        this.f81397d = context;
    }

    /* renamed from: a */
    public static /* synthetic */ void m20284a(PostpaidPackageSetAdapter postpaidPackageSetAdapter, PackageSet packageSet, View view) {
        postpaidPackageSetAdapter.m20283b(packageSet, view);
    }

    /* renamed from: b */
    public final /* synthetic */ void m20283b(PackageSet packageSet, View view) {
        this.f81398e.onClickPackageItem(packageSet);
    }

    /* renamed from: c */
    public final void m20282c(PackageViewHolder packageViewHolder, PackageSet packageSet) {
        int i;
        int i2;
        int i3;
        int i4;
        ...
        for (int i6 = 0; i6 < packageDescription.size(); i6++) {
            if (StringUtil.hasText(packageDescription.get(i6))) {
                ...
                sb.append(str2);
                String string = this.f81397d.getString(R.string.dot);
    ...
    public int getItemViewType(int i) {
        if (this.f81394a.get(i) instanceof String) {
            return 1;
        }
        return 2;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        m20282c(packageViewHolder, packageSet);
        if (this.f81398e != null) {
            packageViewHolder.getRelativeLayoutPackageBox().setOnClickListener(new View.OnClickListener() { // from class: sl1
                {
                    PostpaidPackageSetAdapter.this = this;
                }

                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    PostpaidPackageSetAdapter.m20284a(PostpaidPackageSetAdapter.this, packageSet, view);
                }
            });
        }
    }
