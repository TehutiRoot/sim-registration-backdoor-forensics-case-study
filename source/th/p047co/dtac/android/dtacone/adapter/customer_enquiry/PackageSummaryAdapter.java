...
public final class PackageSummaryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    /* renamed from: b */
    public final Selected f81142b;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final int $stable = 8;

    @Metadata(m28851d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\b\u0010\u0005\u001a\u0004\u0018\u00010\u0006¨\u0006\u0007"}, m28850d2 = {"Lth/co/dtac/android/dtacone/adapter/customer_enquiry/PackageSummaryAdapter$Companion;", "", "()V", "getVisibility", "", "packagesType", "Lth/co/dtac/android/dtacone/adapter/customer_enquiry/PACKAGE_SUMMARY;", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    public static final class MainPackageSummaryAdapterViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: a */
        public final Context f81143a;

        /* renamed from: b */
        public final DtacFontTextView f81144b;

        /* renamed from: c */
        public final DtacFontTextView f81145c;

        /* renamed from: d */
        public final DtacFontTextView f81146d;

        /* renamed from: e */
        public final ImageView f81147e;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public MainPackageSummaryAdapterViewHolder(@NotNull View itemView) {
            super(itemView);
            Intrinsics.checkNotNullParameter(itemView, "itemView");
            this.f81143a = itemView.getContext();
            this.f81144b = (DtacFontTextView) itemView.findViewById(R.id.tvPackageName);
            this.f81145c = (DtacFontTextView) itemView.findViewById(R.id.tvDateTitle);
            this.f81146d = (DtacFontTextView) itemView.findViewById(R.id.tvDisplayDate);
            this.f81147e = (ImageView) itemView.findViewById(R.id.remove);
        }
        ...
        public final void bind(@NotNull PackageItem packageItem, @NotNull Selected selected) {
            ...
            DtacFontTextView dtacFontTextView = this.f81144b;
            ...
            this.f81146d.setText(packageItem.getDisplayPackageDate());
            this.f81147e.setVisibility(PackageSummaryAdapter.Companion.getVisibility(packageItem.getType()));
            ImageView remove = this.f81147e;
    ...
    public static final class NextPackageSummaryAdapterViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: a */
        public final Context f81148a;

        /* renamed from: b */
        public final DtacFontTextView f81149b;

        /* renamed from: c */
        public final DtacFontTextView f81150c;

        /* renamed from: d */
        public final DtacFontTextView f81151d;

        /* renamed from: e */
        public final ImageView f81152e;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public NextPackageSummaryAdapterViewHolder(@NotNull View itemView) {
            super(itemView);
            Intrinsics.checkNotNullParameter(itemView, "itemView");
            this.f81148a = itemView.getContext();
            this.f81149b = (DtacFontTextView) itemView.findViewById(R.id.tvPackageName);
            this.f81150c = (DtacFontTextView) itemView.findViewById(R.id.tvDateTitle);
            this.f81151d = (DtacFontTextView) itemView.findViewById(R.id.tvDisplayDate);
            this.f81152e = (ImageView) itemView.findViewById(R.id.remove);
        }

        public final void bind(@NotNull PackageItem packageItem, @NotNull Selected selected) {
            Intrinsics.checkNotNullParameter(packageItem, "packageItem");
            Intrinsics.checkNotNullParameter(selected, "selected");
            DtacFontTextView dtacFontTextView = this.f81149b;
            String packageCode = packageItem.getPackageCode();
            String packageDescription = packageItem.getPackageDescription();
            dtacFontTextView.setText("[" + packageCode + "] " + packageDescription);
            this.f81150c.setText(this.f81148a.getResources().getString(R.string.start_date_pack));
            this.f81150c.setTextColor(ContextCompat.getColor(this.f81148a, R.color.warmGray));
            this.f81150c.setBackgroundResource(R.drawable.background_white_btn_grayd8_border);
            this.f81151d.setText(packageItem.getDisplayPackageDate());
            this.f81152e.setVisibility(PackageSummaryAdapter.Companion.getVisibility(packageItem.getType()));
            ImageView remove = this.f81152e;
            Intrinsics.checkNotNullExpressionValue(remove, "remove");
        ...
        public final void setColorTextPackageName() {
            this.f81149b.setTextColor(ContextCompat.getColor(this.f81148a, R.color.skyBlueDtac));
        }
    }

    @Metadata(m28851d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\bf\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&J\u0010\u0010\u0006\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&¨\u0006\u0007"}, m28850d2 = {"Lth/co/dtac/android/dtacone/adapter/customer_enquiry/PackageSummaryAdapter$Selected;", "", "onItemClickAdditionalPackages", "", "item", "Lth/co/dtac/android/dtacone/model/customerenquiry/PackageItem;", "onItemClickMainPackages", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    public PackageSummaryAdapter(@NotNull List<PackageItem> listPackage, @NotNull Selected selected) {
        ...
        Intrinsics.checkNotNullParameter(selected, "selected");
        this.f81141a = listPackage;
        this.f81142b = selected;
    }
    ...
    public int getItemViewType(int i) {
        int i2;
        PACKAGE_SUMMARY page = ((PackageItem) this.f81141a.get(i)).getPage();
        if (page == null) {
            i2 = -1;
        } else {
    ...
    public void onBindViewHolder(@NotNull RecyclerView.ViewHolder holder, int i) {
        ...
        PackageItem packageItem = (PackageItem) this.f81141a.get(i);
        if (holder instanceof NextPackageSummaryAdapterViewHolder) {
            ...
            ((NextPackageSummaryAdapterViewHolder) holder).bind(packageItem, this.f81142b);
        } else if (holder instanceof MainPackageSummaryAdapterViewHolder) {
            ((MainPackageSummaryAdapterViewHolder) holder).bind(packageItem, this.f81142b);
        }
    }
