...
public final class SubscriberListItemAdapter extends RecyclerView.Adapter<SubscriberItemViewHolder> {
    ...
    public static final class SubscriberItemViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: b */
        public static /* synthetic */ void m20381b(Function1 function1, SubscriberListModel subscriberListModel, View view) {
            m20380c(function1, subscriberListModel, view);
        }

        /* renamed from: c */
        public static final void m20380c(Function1 listener, SubscriberListModel item, View view) {
        ...
        public final void bind(@NotNull final SubscriberListModel item, @NotNull final Function1<? super String, Unit> listener) {
            ...
            bind$lambda$1.setOnClickListener(new View.OnClickListener() { // from class: LO1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    SubscriberListItemAdapter.SubscriberItemViewHolder.m20381b(Function1.this, item, view);
                }
            });
            Intrinsics.checkNotNullExpressionValue(bind$lambda$1, "bind$lambda$1");
            m20378e(bind$lambda$1, item);
            m20379d(item);
        }

        /* renamed from: d */
        public final void m20379d(SubscriberListModel subscriberListModel) {
        ...
        /* renamed from: e */
        public final void m20378e(View view, SubscriberListModel subscriberListModel) {
    ...
    public SubscriberListItemAdapter(@NotNull List<SubscriberListModel> list, @NotNull Function1<? super String, Unit> onSelect) {
        ...
        this.f81156a = list;
        this.f81157b = onSelect;
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemCount() {
        return this.f81156a.size();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public void onBindViewHolder(@NotNull SubscriberItemViewHolder holder, int i) {
        Intrinsics.checkNotNullParameter(holder, "holder");
        holder.bind((SubscriberListModel) this.f81156a.get(i), this.f81157b);
    }
