...
@Metadata(m28851d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\b\n\u0002\u0010\u0002\n\u0002\b\t\b\u0007\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0001\u001bB\u001f\u0012\b\b\u0001\u0010\u0004\u001a\u00020\u0003\u0012\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005¢\u0006\u0004\b\b\u0010\tJ\u001f\u0010\r\u001a\u00020\u00022\u0006\u0010\u000b\u001a\u00020\n2\u0006\u0010\f\u001a\u00020\u0003H\u0016¢\u0006\u0004\b\r\u0010\u000eJ\u000f\u0010\u000f\u001a\u00020\u0003H\u0016¢\u0006\u0004\b\u000f\u0010\u0010J\u001f\u0010\u0014\u001a\u00020\u00132\u0006\u0010\u0011\u001a\u00020\u00022\u0006\u0010\u0012\u001a\u00020\u0003H\u0016¢\u0006\u0004\b\u0014\u0010\u0015R\u0017\u0010\u0004\u001a\u00020\u00038\u0006¢\u0006\f\n\u0004\b\u0016\u0010\u0017\u001a\u0004\b\u0018\u0010\u0010R\u001a\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\u00060\u00058\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0019\u0010\u001a¨\u0006\u001c"}, m28850d2 = {"Lth/co/dtac/android/dtacone/adapter/customer_enquiry/SubscriberInfoAdapter;", "Landroidx/recyclerview/widget/RecyclerView$Adapter;", "Lth/co/dtac/android/dtacone/adapter/customer_enquiry/SubscriberInfoAdapter$ViewHolder;", "", "idLayout", "", "Lth/co/dtac/android/dtacone/model/customerenquiry/BSubsInfo;", FirebaseAnalytics.Param.ITEMS, "<init>", "(ILjava/util/List;)V", "Landroid/view/ViewGroup;", "parent", "viewType", "onCreateViewHolder", "(Landroid/view/ViewGroup;I)Lth/co/dtac/android/dtacone/adapter/customer_enquiry/SubscriberInfoAdapter$ViewHolder;", "getItemCount", "()I", "viewHolder", "position", "", "onBindViewHolder", "(Lth/co/dtac/android/dtacone/adapter/customer_enquiry/SubscriberInfoAdapter$ViewHolder;I)V", PDPageLabelRange.STYLE_LETTERS_LOWER, "I", "getIdLayout", OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, "Ljava/util/List;", "ViewHolder", "app_prodRelease"}, m28849k = 1, m28848mv = {1, 8, 0})
...
public final class SubscriberInfoAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public static final class ViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: a */
        public final BlacklistSubscriberInfoItemBinding f81155a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public ViewHolder(@NotNull BlacklistSubscriberInfoItemBinding binding) {
            super(binding.getRoot());
            Intrinsics.checkNotNullParameter(binding, "binding");
            this.f81155a = binding;
        }

        /* renamed from: b */
        public final int m20383b(String str) {
        ...
        public final void bind(@NotNull BSubsInfo item) {
            ...
            this.f81155a.valueSubscriberNumber.setText(StringExtKt.maskText(PhoneNumberExtKt.toPretty(item.getSubscriberNumber()), Constant.PHONE_FORMAT));
            this.f81155a.valueName.setText(item.getName());
            this.f81155a.valueCompanyName.setText(item.getCompanyName());
            DtacFontTextView dtacFontTextView = this.f81155a.valueSubscriberStatus;
            dtacFontTextView.setText(dtacFontTextView.getContext().getString(m20382c(item.getSubscriberStatus())));
            dtacFontTextView.setTextColor(ContextCompat.getColor(dtacFontTextView.getContext(), m20383b(item.getSubscriberStatus())));
        }

        /* renamed from: c */
        public final int m20382c(String str) {
            if (Intrinsics.areEqual(str, "S")) {
    ...
    public int getItemCount() {
        return this.f81154b.size();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public void onBindViewHolder(@NotNull ViewHolder viewHolder, int i) {
        Intrinsics.checkNotNullParameter(viewHolder, "viewHolder");
        viewHolder.bind((BSubsInfo) this.f81154b.get(i));
    }
