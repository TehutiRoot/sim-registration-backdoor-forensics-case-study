...
/* renamed from: th.co.dtac.android.dtacone.adapter.customer_enquiry.PackageSummaryAdapter$NextPackageSummaryAdapterViewHolder$bind$1 */
/* loaded from: classes7.dex */
public final class PackageSummaryAdapter$NextPackageSummaryAdapterViewHolder$bind$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ PackageItem $packageItem;
    final /* synthetic */ PackageSummaryAdapter.Selected $selected;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PackageSummaryAdapter$NextPackageSummaryAdapterViewHolder$bind$1(PackageItem packageItem, PackageSummaryAdapter.Selected selected) {
        super(0);
