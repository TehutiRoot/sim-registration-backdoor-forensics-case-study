...
public class SaleReportAdapter extends RecyclerView.Adapter<SaleReportViewHolder> {
    ...
    /* renamed from: a */
    public WeakReference f81483a;

    /* renamed from: b */
    public SaleReportListCollection f81484b;

    /* renamed from: c */
    public OnClickItemSaleReport f81485c;
    ...
    public SaleReportAdapter(Context context) {
        this.f81483a = new WeakReference(context);
    }

    /* renamed from: a */
    public static /* synthetic */ void m20254a(SaleReportAdapter saleReportAdapter, RtrPerformanceCollection rtrPerformanceCollection, View view) {
        saleReportAdapter.m20253b(rtrPerformanceCollection, view);
    }

    /* renamed from: b */
    public final /* synthetic */ void m20253b(RtrPerformanceCollection rtrPerformanceCollection, View view) {
        this.f81485c.onClickSaleReport(rtrPerformanceCollection);
    }

    /* renamed from: c */
    public final void m20252c(SaleReportViewHolder saleReportViewHolder, final RtrPerformanceCollection rtrPerformanceCollection) {
        int i;
        ...
        saleReportViewHolder.f81488c.setImageDrawable(ContextCompat.getDrawable((Context) this.f81483a.get(), i));
        ...
        if (rtrPerformanceCollection.getReports() != null && rtrPerformanceCollection.getReports().size() > 0) {
            saleReportViewHolder.f81486a.setOnClickListener(new View.OnClickListener() { // from class: jD1
                {
                    SaleReportAdapter.this = this;
                }

                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    SaleReportAdapter.m20254a(SaleReportAdapter.this, rtrPerformanceCollection, view);
                }
            });
