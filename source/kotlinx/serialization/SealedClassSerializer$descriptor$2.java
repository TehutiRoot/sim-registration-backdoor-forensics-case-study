...
public final class SealedClassSerializer$descriptor$2 extends Lambda implements Function0<SerialDescriptor> {
    ...
    /* loaded from: classes6.dex */
    public static final class C121571 extends Lambda implements Function1<ClassSerialDescriptorBuilder, Unit> {
        final /* synthetic */ SealedClassSerializer<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C121571(SealedClassSerializer<T> sealedClassSerializer) {
            super(1);
    ...
    public final SerialDescriptor invoke() {
        return SerialDescriptorsKt.buildSerialDescriptor(this.$serialName, PolymorphicKind.SEALED.INSTANCE, new SerialDescriptor[0], new C121571(this.this$0));
    }
}
