...
public final class JsonElementMarker {
    ...
    public final int nextUnmarkedIndex$kotlinx_serialization_json() {
        return this.f71384a.nextUnmarkedIndex();
    }
}
