...
public final class StreamingJsonEncoder extends AbstractEncoder implements JsonEncoder {
    ...
    public StreamingJsonEncoder(@NotNull Composer composer, @NotNull Json json, @NotNull WriteMode mode, @Nullable JsonEncoder[] jsonEncoderArr) {
        ...
        this.f71416a = composer;
        this.f71417b = json;
        this.f71418c = mode;
        this.f71419d = jsonEncoderArr;
        this.f71420e = getJson().getSerializersModule();
        this.f71421f = getJson().getConfiguration();
    ...
    /* renamed from: a */
    public final void m26607a(SerialDescriptor serialDescriptor) {
        this.f71416a.nextItem();
    ...
    public CompositeEncoder beginStructure(@NotNull SerialDescriptor descriptor) {
        ...
        if (c != 0) {
            this.f71416a.print(c);
            this.f71416a.indent();
        }
        if (this.f71423h != null) {
            m26607a(descriptor);
            this.f71423h = null;
        }
        if (this.f71418c == switchMode) {
            return this;
        }
        JsonEncoder[] jsonEncoderArr = this.f71419d;
        if (jsonEncoderArr == null || (jsonEncoder = jsonEncoderArr[switchMode.ordinal()]) == null) {
            return new StreamingJsonEncoder(this.f71416a, getJson(), switchMode, this.f71419d);
        }
        return jsonEncoder;
    }
    ...
    public void encodeDouble(double d) {
        if (this.f71422g) {
            ...
            this.f71416a.print(d);
        }
        if (!this.f71421f.getAllowSpecialFloatingPointValues()) {
            if (Double.isInfinite(d) || Double.isNaN(d)) {
                throw JsonExceptionsKt.InvalidFloatingPointEncoded(Double.valueOf(d), this.f71416a.writer.toString());
            }
        }
    }
    ...
    public boolean encodeElement(@NotNull SerialDescriptor descriptor, int i) {
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
        int i2 = WhenMappings.$EnumSwitchMapping$0[this.f71418c.ordinal()];
        if (i2 != 1) {
            boolean z = false;
            if (i2 != 2) {
                if (i2 != 3) {
                    if (!this.f71416a.getWritingFirst()) {
                        this.f71416a.print(',');
                    }
                    this.f71416a.nextItem();
            ...
            } else if (!this.f71416a.getWritingFirst()) {
                if (i % 2 == 0) {
                    this.f71416a.print(',');
                    this.f71416a.nextItem();
                    z = true;
    ...
    public void encodeFloat(float f) {
        if (this.f71422g) {
            ...
            this.f71416a.print(f);
        }
        if (!this.f71421f.getAllowSpecialFloatingPointValues()) {
            if (Float.isInfinite(f) || Float.isNaN(f)) {
                throw JsonExceptionsKt.InvalidFloatingPointEncoded(Float.valueOf(f), this.f71416a.writer.toString());
            }
        }
    }
    ...
    public Encoder encodeInline(@NotNull SerialDescriptor descriptor) {
        ...
        if (StreamingJsonEncoderKt.isUnsignedNumber(descriptor)) {
            Composer composer = this.f71416a;
            if (!(composer instanceof ComposerForUnsignedNumbers)) {
                composer = new ComposerForUnsignedNumbers(composer.writer, this.f71422g);
            }
            return new StreamingJsonEncoder(composer, getJson(), this.f71418c, (JsonEncoder[]) null);
        } else if (StreamingJsonEncoderKt.isUnquotedLiteral(descriptor)) {
            Composer composer2 = this.f71416a;
            if (!(composer2 instanceof ComposerForUnquotedLiterals)) {
                composer2 = new ComposerForUnquotedLiterals(composer2.writer, this.f71422g);
            }
            return new StreamingJsonEncoder(composer2, getJson(), this.f71418c, (JsonEncoder[]) null);
        } else {
    ...
    public void encodeLong(long j) {
        if (this.f71422g) {
            ...
            this.f71416a.print(j);
        }
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeNull() {
        this.f71416a.print(AbstractJsonLexerKt.NULL);
    }
    ...
    public <T> void encodeNullableSerializableElement(@NotNull SerialDescriptor descriptor, int i, @NotNull SerializationStrategy<? super T> serializer, @Nullable T t) {
        ...
        if (t != null || this.f71421f.getExplicitNulls()) {
    ...
    */
    ...
    public void encodeString(@NotNull String value) {
        ...
        this.f71416a.printQuoted(value);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.CompositeEncoder
    public void endStructure(@NotNull SerialDescriptor descriptor) {
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
        if (this.f71418c.end != 0) {
            this.f71416a.unIndent();
            this.f71416a.nextItemIfNotFirst();
            this.f71416a.print(this.f71418c.end);
        }
    }
    ...
    public boolean shouldEncodeElementDefault(@NotNull SerialDescriptor descriptor, int i) {
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
        return this.f71421f.getEncodeDefaults();
    }
