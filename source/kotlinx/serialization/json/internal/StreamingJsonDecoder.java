...
public class StreamingJsonDecoder extends AbstractDecoder implements JsonDecoder, ChunkedDecoder {
    ...
    /* renamed from: a */
    public final Json f71409a;

    /* renamed from: b */
    public final WriteMode f71410b;

    /* renamed from: c */
    public final SerializersModule f71411c;

    /* renamed from: d */
    public int f71412d;

    /* renamed from: e */
    public DiscriminatorHolder f71413e;

    /* renamed from: f */
    public final JsonConfiguration f71414f;

    /* renamed from: g */
    public final JsonElementMarker f71415g;
    @JvmField
    @NotNull
    public final AbstractJsonLexer lexer;

    @Metadata(m28851d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\b\u0000\u0018\u00002\u00020\u0001B\u000f\u0012\b\u0010\u0002\u001a\u0004\u0018\u00010\u0003¢\u0006\u0002\u0010\u0004R\u0014\u0010\u0002\u001a\u0004\u0018\u00010\u00038\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000¨\u0006\u0005"}, m28850d2 = {"Lkotlinx/serialization/json/internal/StreamingJsonDecoder$DiscriminatorHolder;", "", "discriminatorToSkip", "", "(Ljava/lang/String;)V", "kotlinx-serialization-json"}, m28849k = 1, m28848mv = {1, 9, 0}, m28846xi = 48)
    /* loaded from: classes6.dex */
    ...
    public StreamingJsonDecoder(@NotNull Json json, @NotNull WriteMode mode, @NotNull AbstractJsonLexer lexer, @NotNull SerialDescriptor descriptor, @Nullable DiscriminatorHolder discriminatorHolder) {
        ...
        this.f71410b = mode;
        this.lexer = lexer;
        this.f71411c = json.getSerializersModule();
        this.f71412d = -1;
        this.f71413e = discriminatorHolder;
        JsonConfiguration configuration = json.getConfiguration();
        this.f71414f = configuration;
        if (configuration.getExplicitNulls()) {
            jsonElementMarker = null;
        } else {
            jsonElementMarker = new JsonElementMarker(descriptor);
        }
        this.f71415g = jsonElementMarker;
    }

    /* renamed from: a */
    public final void m26616a() {
    ...
    /* renamed from: b */
    public final boolean m26615b(SerialDescriptor serialDescriptor, int i) {
        String peekString;
        Json json = this.f71409a;
        ...
        if (elementDescriptor.isNullable() || !this.lexer.tryConsumeNull(true)) {
            ...
            if ((elementDescriptor.isNullable() && this.lexer.tryConsumeNull(false)) || (peekString = this.lexer.peekString(this.f71414f.isLenient())) == null || JsonNamesMapKt.getJsonNameIndex(elementDescriptor, json, peekString) != -3) {
                return false;
            }
    ...
    public CompositeDecoder beginStructure(@NotNull SerialDescriptor descriptor) {
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
        WriteMode switchMode = WriteModeKt.switchMode(this.f71409a, descriptor);
        this.lexer.path.pushDescriptor(descriptor);
        this.lexer.consumeNextToken(switchMode.begin);
        m26616a();
        int i = WhenMappings.$EnumSwitchMapping$0[switchMode.ordinal()];
        if (i != 1 && i != 2 && i != 3) {
            if (this.f71410b == switchMode && this.f71409a.getConfiguration().getExplicitNulls()) {
                return this;
            }
            return new StreamingJsonDecoder(this.f71409a, switchMode, this.lexer, descriptor, this.f71413e);
        }
        return new StreamingJsonDecoder(this.f71409a, switchMode, this.lexer, descriptor, this.f71413e);
    }

    /* renamed from: c */
    public final int m26614c() {
        ...
        if (this.lexer.canConsumeValue()) {
            ...
            this.f71412d = i2;
            return i2;
        } else if (!tryConsumeComma || this.f71409a.getConfiguration().getAllowTrailingComma()) {
            return -1;
        } else {
    ...
    public final int m26613d() {
        ...
        if (this.lexer.canConsumeValue()) {
            ...
            int i4 = this.f71412d + 1;
            this.f71412d = i4;
            return i4;
        } else if (!z2 || this.f71409a.getConfiguration().getAllowTrailingComma()) {
            return -1;
        } else {
    ...
    public double decodeDouble() {
        ...
        try {
            ...
            if (!this.f71409a.getConfiguration().getAllowSpecialFloatingPointValues() && (Double.isInfinite(parseDouble) || Double.isNaN(parseDouble))) {
    ...
    public int decodeElementIndex(@NotNull SerialDescriptor descriptor) {
        int m26613d;
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
        int i = WhenMappings.$EnumSwitchMapping$0[this.f71410b.ordinal()];
        if (i != 2) {
            if (i != 4) {
                m26613d = m26614c();
            } else {
                m26613d = m26612e(descriptor);
            }
        } else {
            m26613d = m26613d();
        }
        if (this.f71410b != WriteMode.MAP) {
            this.lexer.path.updateDescriptorIndex(m26613d);
        }
        return m26613d;
    }
    ...
    public float decodeFloat() {
        ...
        try {
            ...
            if (!this.f71409a.getConfiguration().getAllowSpecialFloatingPointValues() && (Float.isInfinite(parseFloat) || Float.isNaN(parseFloat))) {
    ...
    public Decoder decodeInline(@NotNull SerialDescriptor descriptor) {
        ...
        if (StreamingJsonEncoderKt.isUnsignedNumber(descriptor)) {
            return new JsonDecoderForUnsignedTypes(this.lexer, this.f71409a);
        }
    ...
    public JsonElement decodeJsonElement() {
        return new JsonTreeReader(this.f71409a.getConfiguration(), this.lexer).read();
    }
    ...
    public boolean decodeNotNullMark() {
        boolean z;
        JsonElementMarker jsonElementMarker = this.f71415g;
    ...
    public <T> T decodeSerializableElement(@NotNull SerialDescriptor descriptor, int i, @NotNull DeserializationStrategy<? extends T> deserializer, @Nullable T t) {
        ...
        if (this.f71410b == WriteMode.MAP && (i & 1) == 0) {
            z = true;
        } else {
            z = false;
        }
    ...
    public <T> T decodeSerializableValue(@NotNull DeserializationStrategy<? extends T> deserializer) {
        Intrinsics.checkNotNullParameter(deserializer, "deserializer");
        try {
            if ((deserializer instanceof AbstractPolymorphicSerializer) && !this.f71409a.getConfiguration().getUseArrayPolymorphism()) {
                String classDiscriminator = PolymorphicKt.classDiscriminator(deserializer.getDescriptor(), this.f71409a);
                String peekLeadingMatchingValue = this.lexer.peekLeadingMatchingValue(classDiscriminator, this.f71414f.isLenient());
                ...
                try {
                    ...
                    this.f71413e = new DiscriminatorHolder(classDiscriminator);
    ...
    public void decodeStringChunked(@NotNull Function1<? super String, Unit> consumeChunk) {
        ...
        this.lexer.consumeStringChunked(this.f71414f.isLenient(), consumeChunk);
    }

    /* renamed from: e */
    public final int m26612e(SerialDescriptor serialDescriptor) {
        int jsonNameIndex;
        boolean z;
        boolean tryConsumeComma = this.lexer.tryConsumeComma();
        while (true) {
            boolean z2 = true;
            if (this.lexer.canConsumeValue()) {
                String m26611f = m26611f();
                this.lexer.consumeNextToken(':');
                jsonNameIndex = JsonNamesMapKt.getJsonNameIndex(serialDescriptor, this.f71409a, m26611f);
                if (jsonNameIndex != -3) {
                    if (!this.f71414f.getCoerceInputValues() || !m26615b(serialDescriptor, jsonNameIndex)) {
                        break;
                    }
                ...
                if (z2) {
                    tryConsumeComma = m26610g(m26611f);
                } else {
                    tryConsumeComma = z;
                }
            } else if (tryConsumeComma && !this.f71409a.getConfiguration().getAllowTrailingComma()) {
        ...
        JsonElementMarker jsonElementMarker2 = this.f71415g;
    ...
    public void endStructure(@NotNull SerialDescriptor descriptor) {
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
        if (this.f71409a.getConfiguration().getIgnoreUnknownKeys() && descriptor.getElementsCount() == 0) {
            m26609h(descriptor);
        }
        if (this.lexer.tryConsumeComma() && !this.f71409a.getConfiguration().getAllowTrailingComma()) {
            JsonExceptionsKt.invalidTrailingComma(this.lexer, "");
            throw new KotlinNothingValueException();
        }
        this.lexer.consumeNextToken(this.f71410b.end);
        this.lexer.path.popDescriptor();
    }

    /* renamed from: f */
    public final String m26611f() {
        if (this.f71414f.isLenient()) {
            return this.lexer.consumeStringLenientNotNull();
        }
    ...
    /* renamed from: g */
    public final boolean m26610g(String str) {
        if (!this.f71414f.getIgnoreUnknownKeys() && !m26608i(this.f71413e, str)) {
            this.lexer.failOnUnknownKey(str);
        } else {
            this.lexer.skipElement(this.f71414f.isLenient());
        }
    ...
    /* renamed from: h */
    public final void m26609h(SerialDescriptor serialDescriptor) {
        do {
        } while (decodeElementIndex(serialDescriptor) != -1);
    }

    /* renamed from: i */
    public final boolean m26608i(DiscriminatorHolder discriminatorHolder, String str) {
