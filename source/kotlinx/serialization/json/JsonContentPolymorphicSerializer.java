...
public abstract class JsonContentPolymorphicSerializer<T> implements KSerializer<T> {
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull T value) {
        ...
        SerializationStrategy<T> polymorphic = encoder.getSerializersModule().getPolymorphic((KClass<? super KClass<? super T>>) this.f71327a, (KClass<? super T>) value);
        if (polymorphic == null && (polymorphic = SerializersKt.serializerOrNull(Reflection.getOrCreateKotlinClass(value.getClass()))) == null) {
            m26688a(Reflection.getOrCreateKotlinClass(value.getClass()), this.f71327a);
