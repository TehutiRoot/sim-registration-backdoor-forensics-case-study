...
public final class JsonBuilder {
    ...
    /* renamed from: f */
    public boolean f71298f;

    /* renamed from: g */
    public String f71299g;

    /* renamed from: h */
    public boolean f71300h;

    /* renamed from: i */
    public boolean f71301i;

    /* renamed from: j */
    public String f71302j;

    /* renamed from: k */
    public ClassDiscriminatorMode f71303k;

    /* renamed from: l */
    public boolean f71304l;

    /* renamed from: m */
    public boolean f71305m;

    /* renamed from: n */
    public JsonNamingStrategy f71306n;
    ...
    /* renamed from: q */
    public SerializersModule f71309q;

    public JsonBuilder(@NotNull Json json) {
        Intrinsics.checkNotNullParameter(json, "json");
        this.f71293a = json.getConfiguration().getEncodeDefaults();
        this.f71294b = json.getConfiguration().getExplicitNulls();
        this.f71295c = json.getConfiguration().getIgnoreUnknownKeys();
        this.f71296d = json.getConfiguration().isLenient();
        this.f71297e = json.getConfiguration().getAllowStructuredMapKeys();
        this.f71298f = json.getConfiguration().getPrettyPrint();
        this.f71299g = json.getConfiguration().getPrettyPrintIndent();
        this.f71300h = json.getConfiguration().getCoerceInputValues();
        this.f71301i = json.getConfiguration().getUseArrayPolymorphism();
        this.f71302j = json.getConfiguration().getClassDiscriminator();
        this.f71303k = json.getConfiguration().getClassDiscriminatorMode();
        this.f71304l = json.getConfiguration().getAllowSpecialFloatingPointValues();
        this.f71305m = json.getConfiguration().getUseAlternativeNames();
        this.f71306n = json.getConfiguration().getNamingStrategy();
        this.f71307o = json.getConfiguration().getDecodeEnumsCaseInsensitive();
        this.f71308p = json.getConfiguration().getAllowTrailingComma();
        this.f71309q = json.getSerializersModule();
    }
    ...
    public final JsonConfiguration build$kotlinx_serialization_json() {
        if (this.f71301i) {
            if (Intrinsics.areEqual(this.f71302j, "type")) {
                if (this.f71303k != ClassDiscriminatorMode.POLYMORPHIC) {
        ...
        if (!this.f71298f) {
            if (!Intrinsics.areEqual(this.f71299g, "    ")) {
                throw new IllegalArgumentException("Indent should not be specified when default printing mode is used".toString());
            }
        } else if (!Intrinsics.areEqual(this.f71299g, "    ")) {
            String str = this.f71299g;
            for (int i = 0; i < str.length(); i++) {
                char charAt = str.charAt(i);
                if (charAt != ' ' && charAt != '\t' && charAt != '\r' && charAt != '\n') {
                    throw new IllegalArgumentException(("Only whitespace, tab, newline and carriage return are allowed as pretty print symbols. Had " + this.f71299g).toString());
                }
            }
        }
        return new JsonConfiguration(this.f71293a, this.f71295c, this.f71296d, this.f71297e, this.f71298f, this.f71294b, this.f71299g, this.f71300h, this.f71301i, this.f71302j, this.f71304l, this.f71305m, this.f71306n, this.f71307o, this.f71308p, this.f71303k);
    }
    ...
    public final void setClassDiscriminatorMode(@NotNull ClassDiscriminatorMode classDiscriminatorMode) {
        ...
        this.f71303k = classDiscriminatorMode;
    }
    ...
    public final void setNamingStrategy(@Nullable JsonNamingStrategy jsonNamingStrategy) {
        this.f71306n = jsonNamingStrategy;
    }
    ...
    public final void setSerializersModule(@NotNull SerializersModule serializersModule) {
        ...
        this.f71309q = serializersModule;
    }
