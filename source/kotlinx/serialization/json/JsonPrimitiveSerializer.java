...
public final class JsonPrimitiveSerializer implements KSerializer<JsonPrimitive> {
    ...
    /* renamed from: a */
    public static final SerialDescriptor f71348a = SerialDescriptorsKt.buildSerialDescriptor$default("kotlinx.serialization.json.JsonPrimitive", PrimitiveKind.STRING.INSTANCE, new SerialDescriptor[0], null, 8, null);
    ...
    public void serialize(@NotNull Encoder encoder, @NotNull JsonPrimitive value) {
        ...
        if (value instanceof JsonNull) {
            ...
            encoder.encodeSerializableValue(C20422ih0.f62868a, (JsonLiteral) value);
        }
    }
}
