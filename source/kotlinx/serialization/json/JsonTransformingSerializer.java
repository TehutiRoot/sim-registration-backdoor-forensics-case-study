...
public abstract class JsonTransformingSerializer<T> implements KSerializer<T> {
    ...
    public final T deserialize(@NotNull Decoder decoder) {
        ...
        return (T) asJsonDecoder.getJson().decodeFromJsonElement(this.f71349a, transformDeserialize(asJsonDecoder.decodeJsonElement()));
    }

    @Override // kotlinx.serialization.KSerializer, kotlinx.serialization.SerializationStrategy, kotlinx.serialization.DeserializationStrategy
    @NotNull
    public SerialDescriptor getDescriptor() {
        return this.f71349a.getDescriptor();
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull T value) {
        ...
        asJsonEncoder.encodeJsonElement(transformSerialize(TreeJsonEncoderKt.writeJson(asJsonEncoder.getJson(), value, this.f71349a)));
    }
