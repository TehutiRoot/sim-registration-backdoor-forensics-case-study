...
public final class WrappedSerialDescriptor implements SerialDescriptor {
    ...
    public List<Annotation> getElementAnnotations(int i) {
        return this.f71165b.getElementAnnotations(i);
    }
    ...
    public SerialDescriptor getElementDescriptor(int i) {
        return this.f71165b.getElementDescriptor(i);
    }
    ...
    public int getElementIndex(@NotNull String name) {
        ...
        return this.f71165b.getElementIndex(name);
    }
    ...
    public String getElementName(int i) {
        return this.f71165b.getElementName(i);
    }

    @Override // kotlinx.serialization.descriptors.SerialDescriptor
    public int getElementsCount() {
        return this.f71165b.getElementsCount();
    }

    @Override // kotlinx.serialization.descriptors.SerialDescriptor
    @NotNull
    public SerialKind getKind() {
        return this.f71165b.getKind();
    }
    ...
    public boolean isElementOptional(int i) {
        return this.f71165b.isElementOptional(i);
    }

    @Override // kotlinx.serialization.descriptors.SerialDescriptor
    public boolean isInline() {
        return this.f71165b.isInline();
    }

    @Override // kotlinx.serialization.descriptors.SerialDescriptor
    public boolean isNullable() {
        return this.f71165b.isNullable();
    }
}
