...
public final class SerialDescriptorsKt {
    ...
    public static final SerialDescriptor PrimitiveSerialDescriptor(@NotNull String serialName, @NotNull PrimitiveKind kind) {
        ...
        if (!AbstractC20204hN1.isBlank(serialName)) {
