...
public final class EnumSerializer<T extends Enum<T>> implements KSerializer<T> {
    ...
    /* renamed from: a */
    public final Enum[] f71195a;

    /* renamed from: b */
    public SerialDescriptor f71196b;

    /* renamed from: c */
    public final Lazy f71197c;

    public EnumSerializer(@NotNull String serialName, @NotNull T[] values) {
        Intrinsics.checkNotNullParameter(serialName, "serialName");
        Intrinsics.checkNotNullParameter(values, "values");
        this.f71195a = values;
        this.f71197c = LazyKt__LazyJVMKt.lazy(new EnumSerializer$descriptor$2(this, serialName));
    }

    /* renamed from: a */
    public final SerialDescriptor m26711a(String str) {
        EnumDescriptor enumDescriptor = new EnumDescriptor(str, this.f71195a.length);
        for (Enum r4 : this.f71195a) {
    ...
    public SerialDescriptor getDescriptor() {
        return (SerialDescriptor) this.f71197c.getValue();
    }
    ...
    public T deserialize(@NotNull Decoder decoder) {
        ...
        if (decodeEnum >= 0) {
            Enum[] enumArr = this.f71195a;
            if (decodeEnum < enumArr.length) {
                return (T) enumArr[decodeEnum];
            }
        }
        throw new SerializationException(decodeEnum + " is not among valid " + getDescriptor().getSerialName() + " enum values, values size is " + this.f71195a.length);
    }

    public void serialize(@NotNull Encoder encoder, @NotNull T value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        int indexOf = ArraysKt___ArraysKt.indexOf((T[]) this.f71195a, value);
        if (indexOf != -1) {
        ...
        String arrays = Arrays.toString(this.f71195a);
