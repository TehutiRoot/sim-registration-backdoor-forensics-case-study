...
public final class StringSerializer implements KSerializer<String> {
    ...
    /* renamed from: a */
    public static final SerialDescriptor f71262a = new PrimitiveSerialDescriptor("kotlin.String", PrimitiveKind.STRING.INSTANCE);
