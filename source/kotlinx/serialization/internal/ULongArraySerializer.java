...
public final class ULongArraySerializer extends PrimitiveArraySerializer<ULong, ULongArray, ULongArrayBuilder> implements KSerializer<ULongArray> {
    ...
    public /* bridge */ /* synthetic */ int collectionSize(Object obj) {
        return m74742collectionSizeQwZRm1k(((ULongArray) obj).m74168unboximpl());
    }

    /* renamed from: collectionSize-QwZRm1k  reason: not valid java name */
    public int m74742collectionSizeQwZRm1k(@NotNull long[] collectionSize) {
        Intrinsics.checkNotNullParameter(collectionSize, "$this$collectionSize");
        return ULongArray.m74160getSizeimpl(collectionSize);
    }

    @Override // kotlinx.serialization.internal.PrimitiveArraySerializer
    public /* bridge */ /* synthetic */ ULongArray empty() {
        return ULongArray.m74152boximpl(m74743emptyY2RjT0g());
    }

    @NotNull
    /* renamed from: empty-Y2RjT0g  reason: not valid java name */
    public long[] m74743emptyY2RjT0g() {
        return ULongArray.m74153constructorimpl(0);
    }

    @Override // kotlinx.serialization.internal.AbstractCollectionSerializer
    public /* bridge */ /* synthetic */ Object toBuilder(Object obj) {
        return m74744toBuilderQwZRm1k(((ULongArray) obj).m74168unboximpl());
    }

    @NotNull
    /* renamed from: toBuilder-QwZRm1k  reason: not valid java name */
    public ULongArrayBuilder m74744toBuilderQwZRm1k(@NotNull long[] toBuilder) {
    ...
    public /* bridge */ /* synthetic */ void writeContent(CompositeEncoder compositeEncoder, ULongArray uLongArray, int i) {
        m74745writeContent0q3Fkuo(compositeEncoder, uLongArray.m74168unboximpl(), i);
    }

    /* renamed from: writeContent-0q3Fkuo  reason: not valid java name */
    public void m74745writeContent0q3Fkuo(@NotNull CompositeEncoder encoder, @NotNull long[] content, int i) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(content, "content");
        for (int i2 = 0; i2 < i; i2++) {
            encoder.encodeInlineElement(getDescriptor(), i2).encodeLong(ULongArray.m74159getsVKNKU(content, i2));
        }
    }
    ...
    public void readElement(@NotNull CompositeDecoder decoder, int i, @NotNull ULongArrayBuilder builder, boolean z) {
        ...
        builder.m74740appendVKZWuLQ$kotlinx_serialization_core(ULong.m74146constructorimpl(decoder.decodeInlineElement(getDescriptor(), i).decodeLong()));
    }
}
