...
public final class NullableSerializer<T> implements KSerializer<T> {
    ...
    public T deserialize(@NotNull Decoder decoder) {
        ...
        if (decoder.decodeNotNullMark()) {
            return (T) decoder.decodeSerializableValue(this.f71230a);
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj != null && NullableSerializer.class == obj.getClass() && Intrinsics.areEqual(this.f71230a, ((NullableSerializer) obj).f71230a)) {
            return true;
        }
        return false;
    }
    ...
    public void serialize(@NotNull Encoder encoder, @Nullable T t) {
        ...
        if (t != null) {
            ...
            encoder.encodeSerializableValue(this.f71230a, t);
            return;
        }
        encoder.encodeNull();
    }
