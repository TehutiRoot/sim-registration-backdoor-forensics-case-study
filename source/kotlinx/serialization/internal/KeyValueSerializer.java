...
public abstract class KeyValueSerializer<K, V, R> implements KSerializer<R> {
    ...
    /* renamed from: a */
    public final KSerializer f71208a;

    /* renamed from: b */
    public final KSerializer f71209b;
    ...
    public void serialize(@NotNull Encoder encoder, R r) {
        ...
        beginStructure.encodeSerializableElement(getDescriptor(), 0, this.f71208a, getKey(r));
        beginStructure.encodeSerializableElement(getDescriptor(), 1, this.f71209b, getValue(r));
    ...
    public KeyValueSerializer(KSerializer kSerializer, KSerializer kSerializer2) {
        this.f71208a = kSerializer;
        this.f71209b = kSerializer2;
    }
}
