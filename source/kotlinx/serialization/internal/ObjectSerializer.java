...
public final class ObjectSerializer<T> implements KSerializer<T> {
    ...
    /* renamed from: a */
    public final Object f71232a;

    /* renamed from: b */
    public List f71233b;

    /* renamed from: c */
    public final Lazy f71234c;

    public ObjectSerializer(@NotNull String serialName, @NotNull T objectInstance) {
        Intrinsics.checkNotNullParameter(serialName, "serialName");
        Intrinsics.checkNotNullParameter(objectInstance, "objectInstance");
        this.f71232a = objectInstance;
        this.f71233b = CollectionsKt__CollectionsKt.emptyList();
        this.f71234c = LazyKt__LazyJVMKt.lazy(LazyThreadSafetyMode.PUBLICATION, (Function0) new ObjectSerializer$descriptor$2(serialName, this));
    }
    ...
    public SerialDescriptor getDescriptor() {
        return (SerialDescriptor) this.f71234c.getValue();
    }
    ...
    public ObjectSerializer(@NotNull String serialName, @NotNull T objectInstance, @NotNull Annotation[] classAnnotations) {
        ...
        this.f71233b = ArraysKt___ArraysJvmKt.asList(classAnnotations);
    }
}
