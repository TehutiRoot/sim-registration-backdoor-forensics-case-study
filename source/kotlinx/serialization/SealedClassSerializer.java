...
public final class SealedClassSerializer<T> extends AbstractPolymorphicSerializer<T> {
    ...
    /* renamed from: a */
    public final KClass f71127a;

    /* renamed from: b */
    public List f71128b;

    /* renamed from: c */
    public final Lazy f71129c;

    /* renamed from: d */
    public final Map f71130d;

    /* renamed from: e */
    public final Map f71131e;
    ...
    public SealedClassSerializer(@NotNull String serialName, @NotNull KClass<T> baseClass, @NotNull KClass<? extends T>[] subclasses, @NotNull KSerializer<? extends T>[] subclassSerializers) {
        ...
        this.f71127a = baseClass;
        this.f71128b = CollectionsKt__CollectionsKt.emptyList();
        this.f71129c = LazyKt__LazyJVMKt.lazy(LazyThreadSafetyMode.PUBLICATION, (Function0) new SealedClassSerializer$descriptor$2(serialName, this));
        if (subclasses.length == subclassSerializers.length) {
            Map map = AbstractC11687a.toMap(ArraysKt___ArraysKt.zip(subclasses, subclassSerializers));
            this.f71130d = map;
    ...
    public DeserializationStrategy<T> findPolymorphicSerializerOrNull(@NotNull CompositeDecoder decoder, @Nullable String str) {
        ...
        KSerializer kSerializer = (KSerializer) this.f71131e.get(str);
    ...
    public SerialDescriptor getDescriptor() {
        return (SerialDescriptor) this.f71129c.getValue();
    }
    ...
    public SerializationStrategy<T> findPolymorphicSerializerOrNull(@NotNull Encoder encoder, @NotNull T value) {
        ...
        SerializationStrategy<T> serializationStrategy = (KSerializer) this.f71130d.get(Reflection.getOrCreateKotlinClass(value.getClass()));
    ...
    public SealedClassSerializer(@NotNull String serialName, @NotNull KClass<T> baseClass, @NotNull KClass<? extends T>[] subclasses, @NotNull KSerializer<? extends T>[] subclassSerializers, @NotNull Annotation[] classAnnotations) {
        ...
        this.f71128b = ArraysKt___ArraysJvmKt.asList(classAnnotations);
    }
}
