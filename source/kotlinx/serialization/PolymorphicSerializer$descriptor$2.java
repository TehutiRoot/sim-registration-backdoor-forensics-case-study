...
public final class PolymorphicSerializer$descriptor$2 extends Lambda implements Function0<SerialDescriptor> {
    ...
    /* loaded from: classes6.dex */
    public static final class C121561 extends Lambda implements Function1<ClassSerialDescriptorBuilder, Unit> {
        final /* synthetic */ PolymorphicSerializer<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C121561(PolymorphicSerializer<T> polymorphicSerializer) {
            super(1);
    ...
    public final SerialDescriptor invoke() {
        return ContextAwareKt.withContext(SerialDescriptorsKt.buildSerialDescriptor("kotlinx.serialization.Polymorphic", PolymorphicKind.OPEN.INSTANCE, new SerialDescriptor[0], new C121561(this.this$0)), this.this$0.getBaseClass());
    }
}
