...
public final class ContextualSerializer<T> implements KSerializer<T> {
    ...
    public ContextualSerializer(@NotNull KClass<T> serializableClass, @Nullable KSerializer<T> kSerializer, @NotNull KSerializer<?>[] typeArgumentsSerializers) {
        ...
        this.f71120a = serializableClass;
        this.f71121b = kSerializer;
        this.f71122c = ArraysKt___ArraysJvmKt.asList(typeArgumentsSerializers);
        this.f71123d = ContextAwareKt.withContext(SerialDescriptorsKt.buildSerialDescriptor("kotlinx.serialization.ContextualSerializer", SerialKind.CONTEXTUAL.INSTANCE, new SerialDescriptor[0], new ContextualSerializer$descriptor$1(this)), serializableClass);
    }

    /* renamed from: a */
    public final KSerializer m26738a(SerializersModule serializersModule) {
        KSerializer<T> contextual = serializersModule.getContextual(this.f71120a, this.f71122c);
        if (contextual == null && (contextual = this.f71121b) == null) {
            Platform_commonKt.serializerNotRegistered(this.f71120a);
    ...
    public T deserialize(@NotNull Decoder decoder) {
        ...
        return (T) decoder.decodeSerializableValue(m26738a(decoder.getSerializersModule()));
    }
    ...
    public void serialize(@NotNull Encoder encoder, @NotNull T value) {
        ...
        encoder.encodeSerializableValue(m26738a(encoder.getSerializersModule()), value);
    }
