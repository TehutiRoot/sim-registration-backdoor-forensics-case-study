...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        public static /* synthetic */ boolean close$default(SendChannel sendChannel, Throwable th2, int i, Object obj) {
            if (obj == null) {
                if ((i & 1) != 0) {
                    th2 = null;
                }
        ...
        public static <E> boolean offer(@NotNull SendChannel<? super E> sendChannel, E e) {
            Object mo74066trySendJP2dKIU = sendChannel.mo74066trySendJP2dKIU(e);
            if (ChannelResult.m74684isSuccessimpl(mo74066trySendJP2dKIU)) {
                return true;
            }
    ...
    Object mo74066trySendJP2dKIU(E e);
}
