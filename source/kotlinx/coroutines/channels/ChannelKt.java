...
public final class ChannelKt {
    ...
    public static final <T> T m74670getOrElseWpGqRn0(@NotNull Object obj, @NotNull Function1<? super Throwable, ? extends T> function1) {
        if (obj instanceof ChannelResult.Failed) {
            return function1.invoke(ChannelResult.m74678exceptionOrNullimpl(obj));
        }
        return obj;
    }
    ...
    public static final <T> Object m74671onClosedWpGqRn0(@NotNull Object obj, @NotNull Function1<? super Throwable, Unit> function1) {
        if (obj instanceof ChannelResult.Closed) {
            function1.invoke(ChannelResult.m74678exceptionOrNullimpl(obj));
        }
        return obj;
    }
    ...
    public static final <T> Object m74672onFailureWpGqRn0(@NotNull Object obj, @NotNull Function1<? super Throwable, Unit> function1) {
        if (obj instanceof ChannelResult.Failed) {
            function1.invoke(ChannelResult.m74678exceptionOrNullimpl(obj));
        }
        return obj;
    ...
    public static final <T> Object m74673onSuccessWpGqRn0(@NotNull Object obj, @NotNull Function1<? super T, Unit> function1) {
        if (!(obj instanceof ChannelResult.Failed)) {
