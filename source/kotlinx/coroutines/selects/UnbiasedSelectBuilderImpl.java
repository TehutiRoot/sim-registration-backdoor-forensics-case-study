...
public final class UnbiasedSelectBuilderImpl<R> extends UnbiasedSelectImplementation<R> {
    ...
    public final Object initSelectResult() {
        if (!this.f71091h.isCompleted()) {
            AbstractC1552Vc.m65753e(CoroutineScopeKt.CoroutineScope(getContext()), null, CoroutineStart.UNDISPATCHED, new UnbiasedSelectBuilderImpl$initSelectResult$1(this, null), 1, null);
            return this.f71091h.getResult();
        }
        return this.f71091h.getResult();
    }
}
