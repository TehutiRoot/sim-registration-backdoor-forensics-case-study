...
public final class ThreadLocalElement<T> implements ThreadContextElement<T> {
    ...
    /* renamed from: b */
    public final ThreadLocal f71028b;

    /* renamed from: c */
    public final CoroutineContext.Key f71029c;

    public ThreadLocalElement(T t, @NotNull ThreadLocal<T> threadLocal) {
        this.f71027a = t;
        this.f71028b = threadLocal;
        this.f71029c = new ThreadLocalKey(threadLocal);
    }
    ...
    public String toString() {
        return "ThreadLocal(value=" + this.f71027a + ", threadLocal = " + this.f71028b + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.ThreadContextElement
    public T updateThreadContext(@NotNull CoroutineContext coroutineContext) {
        T t = (T) this.f71028b.get();
        this.f71028b.set(this.f71027a);
        return t;
    }
}
