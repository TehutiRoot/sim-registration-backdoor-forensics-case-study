...
public final class TimeKt {
    ...
    */
    public static final long m26739a(java.time.Duration r5) {
        /*
            java.time.Duration r0 = p000.ZS1.m65232a()
            int r0 = p000.BJ0.m68921a(r5, r0)
            if (r0 > 0) goto Ld
            r0 = 0
            return r0
        Ld:
            java.time.temporal.ChronoUnit r0 = p000.AbstractC19007aT1.m65097a()
            java.time.Duration r0 = p000.AbstractC19184bT1.m52008a(r0)
            int r0 = p000.BJ0.m68921a(r5, r0)
            if (r0 > 0) goto L1e
            r0 = 1
            return r0
        L1e:
            long r0 = p000.AbstractC19356cT1.m51682a(r5)
            ...
            int r4 = (r0 > r2 ? 1 : (r0 == r2 ? 0 : -1))
            if (r4 != 0) goto L3d
            int r0 = p000.AbstractC19528dT1.m31863a(r5)
        ...
        L3d:
            ...
            goto L47
        L43:
            long r0 = p000.AbstractC19700eT1.m31534a(r5)
        L47:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.time.TimeKt.m26739a(java.time.Duration):long");
    }

    @FlowPreview
    @NotNull
    public static final <T> Flow<T> debounce(@NotNull Flow<? extends T> flow, @NotNull Duration duration) {
        return FlowKt.debounce(flow, m26739a(duration));
    }

    @Nullable
    public static final Object delay(@NotNull Duration duration, @NotNull Continuation<? super Unit> continuation) {
        Object delay = DelayKt.delay(m26739a(duration), continuation);
    ...
    public static final <R> void onTimeout(@NotNull SelectBuilder<? super R> selectBuilder, @NotNull Duration duration, @NotNull Function1<? super Continuation<? super R>, ? extends Object> function1) {
        OnTimeoutKt.onTimeout(selectBuilder, m26739a(duration), function1);
    }

    @FlowPreview
    @NotNull
    public static final <T> Flow<T> sample(@NotNull Flow<? extends T> flow, @NotNull Duration duration) {
        return FlowKt.sample(flow, m26739a(duration));
    }
    ...
    public static final <T> Object withTimeout(@NotNull Duration duration, @NotNull Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, @NotNull Continuation<? super T> continuation) {
        return TimeoutKt.withTimeout(m26739a(duration), function2, continuation);
    }
    ...
    public static final <T> Object withTimeoutOrNull(@NotNull Duration duration, @NotNull Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, @NotNull Continuation<? super T> continuation) {
        return TimeoutKt.withTimeoutOrNull(m26739a(duration), function2, continuation);
    }
}
