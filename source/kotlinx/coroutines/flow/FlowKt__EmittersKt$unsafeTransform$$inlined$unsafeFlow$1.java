...
public final class FlowKt__EmittersKt$unsafeTransform$$inlined$unsafeFlow$1 implements Flow<Object> {
    ...
    /* renamed from: a */
    public final /* synthetic */ Flow f70794a;

    /* renamed from: b */
    public final /* synthetic */ Function3 f70795b;

    public FlowKt__EmittersKt$unsafeTransform$$inlined$unsafeFlow$1(Flow flow, Function3 function3) {
        this.f70794a = flow;
        this.f70795b = function3;
    }
    ...
    public Object collect(@NotNull FlowCollector<? super Object> flowCollector, @NotNull Continuation<? super Unit> continuation) {
        Object collect = this.f70794a.collect(new FlowKt__EmittersKt$unsafeTransform$1$1(this.f70795b, flowCollector), continuation);
    ...
    public Object collect$$forInline(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        ...
        InlineMarker.mark(5);
        Flow flow = this.f70794a;
        FlowKt__EmittersKt$unsafeTransform$1$1 flowKt__EmittersKt$unsafeTransform$1$1 = new FlowKt__EmittersKt$unsafeTransform$1$1(this.f70795b, flowCollector);
        InlineMarker.mark(0);
