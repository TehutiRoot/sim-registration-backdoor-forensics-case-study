...
public final class SafeCollector<T> extends ContinuationImpl implements FlowCollector<T>, CoroutineStackFrame {
    ...
    public SafeCollector(@NotNull FlowCollector<? super T> flowCollector, @NotNull CoroutineContext coroutineContext) {
        super(II0.f2478a, EmptyCoroutineContext.INSTANCE);
    ...
    private final void exceptionTransparencyViolated(DownstreamExceptionContext downstreamExceptionContext, Object obj) {
        throw new IllegalStateException(StringsKt__IndentKt.trimIndent("\n            Flow exception transparency is violated:\n                Previous 'emit' call has thrown exception " + downstreamExceptionContext.f70972e + ", but then emission attempt of value '" + obj + "' has been detected.\n                Emissions from 'catch' blocks are prohibited in order to avoid unspecified behaviour, 'Flow.catch' operator can be used instead.\n                For a more detailed explanation, please refer to Flow documentation.\n            ").toString());
    }
    ...
    public Object emit(T t, @NotNull Continuation<? super Unit> continuation) {
        try {
            ...
            return emit == AbstractC18812Yf0.getCOROUTINE_SUSPENDED() ? emit : Unit.INSTANCE;
        } catch (Throwable th2) {
    ...
    public Object invokeSuspend(@NotNull Object obj) {
        ...
        if (m74090exceptionOrNullimpl != null) {
            this.lastEmissionContext = new DownstreamExceptionContext(m74090exceptionOrNullimpl, getContext());
        }
        Continuation<? super Unit> continuation = this.completion;
    ...
    private final Object emit(Continuation<? super Unit> continuation, T t) {
        ...
        if (!Intrinsics.areEqual(invoke, AbstractC18812Yf0.getCOROUTINE_SUSPENDED())) {
