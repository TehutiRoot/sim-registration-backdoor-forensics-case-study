...
public final class ChannelLimitedFlowMerge<T> extends ChannelFlow<T> {
    ...
    public Object collectTo(@NotNull ProducerScope<? super T> producerScope, @NotNull Continuation<? super Unit> continuation) {
        ...
        for (Flow flow : this.f70958a) {
            AbstractC1552Vc.m65753e(producerScope, null, null, new ChannelLimitedFlowMerge$collectTo$2$1(flow, sendingCollector, null), 3, null);
        }
    ...
    public ChannelFlow<T> create(@NotNull CoroutineContext coroutineContext, int i, @NotNull BufferOverflow bufferOverflow) {
        return new ChannelLimitedFlowMerge(this.f70958a, coroutineContext, i, bufferOverflow);
    }
