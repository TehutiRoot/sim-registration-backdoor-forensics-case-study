...
public final class FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1 implements Flow<Object> {
    ...
    /* renamed from: a */
    public final /* synthetic */ Flow[] f70913a;

    /* renamed from: b */
    public final /* synthetic */ Function2 f70914b;

    public FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1(Flow[] flowArr, Function2 function2) {
        this.f70913a = flowArr;
        this.f70914b = function2;
    }
    ...
    public Object collect(@NotNull FlowCollector<? super Object> flowCollector, @NotNull Continuation<? super Unit> continuation) {
        Function0 m26901p;
        Flow[] flowArr = this.f70913a;
        m26901p = FlowKt__ZipKt.m26901p();
        Intrinsics.needClassReification();
        Object combineInternal = CombineKt.combineInternal(flowCollector, flowArr, m26901p, new FlowKt__ZipKt$combineUnsafe$1$1(this.f70914b, null), continuation);
    ...
    public Object collect$$forInline(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        ...
        m26901p = FlowKt__ZipKt.m26901p();
        Intrinsics.needClassReification();
        FlowKt__ZipKt$combineUnsafe$1$1 flowKt__ZipKt$combineUnsafe$1$1 = new FlowKt__ZipKt$combineUnsafe$1$1(this.f70914b, null);
        InlineMarker.mark(0);
        CombineKt.combineInternal(flowCollector, flowArr, m26901p, flowKt__ZipKt$combineUnsafe$1$1, continuation);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
