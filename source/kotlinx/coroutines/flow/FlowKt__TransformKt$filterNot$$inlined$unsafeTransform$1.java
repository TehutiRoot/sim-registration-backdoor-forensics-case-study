...
public final class FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1 implements Flow<Object> {
    ...
    /* renamed from: a */
    public final /* synthetic */ Flow f70868a;

    /* renamed from: b */
    public final /* synthetic */ Function2 f70869b;
    ...
    /* loaded from: classes6.dex */
    public static final class C121052<T> implements FlowCollector {

        /* renamed from: a */
        public final /* synthetic */ FlowCollector f70870a;

        /* renamed from: b */
        public final /* synthetic */ Function2 f70871b;

        @Metadata(m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = SyslogConstants.LOG_LOCAL6)
        @DebugMetadata(m28801c = "kotlinx.coroutines.flow.FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1$2", m28800f = "Transform.kt", m28799i = {0, 0}, m28798l = {223, 223}, m28797m = "emit", m28796n = {"value", "$this$filterNot_u24lambda_u241"}, m28795s = {"L$0", "L$1"})
        @SourceDebugExtension({"SMAP\nEmitters.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Emitters.kt\nkotlinx/coroutines/flow/FlowKt__EmittersKt$unsafeTransform$1$1$emit$1\n*L\n1#1,222:1\n*E\n"})
        /* renamed from: kotlinx.coroutines.flow.FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1$2$1 */
        /* loaded from: classes6.dex */
        public static final class C121061 extends ContinuationImpl {
            Object L$0;
            Object L$1;
            int label;
            /* synthetic */ Object result;

            public C121061(Continuation continuation) {
                super(continuation);
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                return C121052.this.emit(null, this);
            }
        }

        public C121052(FlowCollector flowCollector, Function2 function2) {
            this.f70870a = flowCollector;
            this.f70871b = function2;
        }
        ...
        */
        public final java.lang.Object emit(T r7, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
            /*
                r6 = this;
                boolean r0 = r8 instanceof kotlinx.coroutines.flow.FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1.C121052.C121061
                if (r0 == 0) goto L13
                r0 = r8
                kotlinx.coroutines.flow.FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1$2$1 r0 = (kotlinx.coroutines.flow.FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1.C121052.C121061) r0
                int r1 = r0.label
            ...
            L3e:
                kotlin.ResultKt.throwOnFailure(r8)
                kotlinx.coroutines.flow.FlowCollector r8 = r6.f70870a
                kotlin.jvm.functions.Function2 r2 = r6.f70871b
                r0.L$0 = r7
                r0.L$1 = r8
                r0.label = r4
            ...
            L6c:
                ...
                return r7
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1.C121052.emit(java.lang.Object, kotlin.coroutines.Continuation):java.lang.Object");
        }

        @Nullable
        public final Object emit$$forInline(Object obj, @NotNull Continuation continuation) {
            InlineMarker.mark(4);
            new C121061(continuation);
            InlineMarker.mark(5);
            FlowCollector flowCollector = this.f70870a;
            if (!((Boolean) this.f70871b.invoke(obj, continuation)).booleanValue()) {
                InlineMarker.mark(0);
    ...
    public FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1(Flow flow, Function2 function2) {
        this.f70868a = flow;
        this.f70869b = function2;
    }

    @Override // kotlinx.coroutines.flow.Flow
    @Nullable
    public Object collect(@NotNull FlowCollector<? super Object> flowCollector, @NotNull Continuation continuation) {
        Object collect = this.f70868a.collect(new C121052(flowCollector, this.f70869b), continuation);
    ...
    public Object collect$$forInline(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        ...
        InlineMarker.mark(5);
        Flow flow = this.f70868a;
        C121052 c121052 = new C121052(flowCollector, this.f70869b);
        InlineMarker.mark(0);
        flow.collect(c121052, continuation);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
