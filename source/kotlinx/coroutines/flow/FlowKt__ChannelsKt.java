...
public abstract /* synthetic */ class FlowKt__ChannelsKt {
    /* renamed from: b */
    public static final Flow m27056b(final BroadcastChannel broadcastChannel) {
        return new Flow<Object>() { // from class: kotlinx.coroutines.flow.FlowKt__ChannelsKt$asFlow$$inlined$unsafeFlow$1
            ...
            public Object collect(@NotNull FlowCollector<? super Object> flowCollector, @NotNull Continuation<? super Unit> continuation) {
                ...
                if (emitAll == AbstractC18812Yf0.getCOROUTINE_SUSPENDED()) {
                    return emitAll;
                }
    ...
    /* renamed from: c */
    public static final Flow m27055c(ReceiveChannel receiveChannel) {
        return new C1340So(receiveChannel, true, null, 0, null, 28, null);
    }

    /* renamed from: d */
    public static final Object m27054d(FlowCollector flowCollector, ReceiveChannel receiveChannel, Continuation continuation) {
        Object m27053e = m27053e(flowCollector, receiveChannel, true, continuation);
    ...
    */
    public static final java.lang.Object m27053e(kotlinx.coroutines.flow.FlowCollector r6, kotlinx.coroutines.channels.ReceiveChannel r7, boolean r8, kotlin.coroutines.Continuation r9) {
        /*
        ...
        La4:
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__ChannelsKt.m27053e(kotlinx.coroutines.flow.FlowCollector, kotlinx.coroutines.channels.ReceiveChannel, boolean, kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* renamed from: f */
    public static final ReceiveChannel m27052f(Flow flow, CoroutineScope coroutineScope) {
        return ChannelFlowKt.asChannelFlow(flow).produceImpl(coroutineScope);
    }

    /* renamed from: g */
    public static final Flow m27051g(ReceiveChannel receiveChannel) {
        return new C1340So(receiveChannel, false, null, 0, null, 28, null);
    }
}
