...
public final class FlowKt__TransformKt$map$$inlined$unsafeTransform$1 implements Flow<Object> {
    ...
    /* renamed from: a */
    public final /* synthetic */ Flow f70874a;

    /* renamed from: b */
    public final /* synthetic */ Function2 f70875b;
    ...
    /* loaded from: classes6.dex */
    public static final class C121102<T> implements FlowCollector {

        /* renamed from: a */
        public final /* synthetic */ FlowCollector f70876a;

        /* renamed from: b */
        public final /* synthetic */ Function2 f70877b;

        @Metadata(m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = SyslogConstants.LOG_LOCAL6)
        @DebugMetadata(m28801c = "kotlinx.coroutines.flow.FlowKt__TransformKt$map$$inlined$unsafeTransform$1$2", m28800f = "Transform.kt", m28799i = {}, m28798l = {223, 223}, m28797m = "emit", m28796n = {}, m28795s = {})
        @SourceDebugExtension({"SMAP\nEmitters.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Emitters.kt\nkotlinx/coroutines/flow/FlowKt__EmittersKt$unsafeTransform$1$1$emit$1\n*L\n1#1,222:1\n*E\n"})
        /* renamed from: kotlinx.coroutines.flow.FlowKt__TransformKt$map$$inlined$unsafeTransform$1$2$1 */
        /* loaded from: classes6.dex */
        public static final class C121111 extends ContinuationImpl {
            Object L$0;
            int label;
            /* synthetic */ Object result;

            public C121111(Continuation continuation) {
                super(continuation);
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                return C121102.this.emit(null, this);
            }
        }

        public C121102(FlowCollector flowCollector, Function2 function2) {
            this.f70876a = flowCollector;
            this.f70877b = function2;
        }
        ...
        */
        public final java.lang.Object emit(T r7, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
            /*
                r6 = this;
                boolean r0 = r8 instanceof kotlinx.coroutines.flow.FlowKt__TransformKt$map$$inlined$unsafeTransform$1.C121102.C121111
                if (r0 == 0) goto L13
                r0 = r8
                kotlinx.coroutines.flow.FlowKt__TransformKt$map$$inlined$unsafeTransform$1$2$1 r0 = (kotlinx.coroutines.flow.FlowKt__TransformKt$map$$inlined$unsafeTransform$1.C121102.C121111) r0
                int r1 = r0.label
            ...
            L3c:
                kotlin.ResultKt.throwOnFailure(r8)
                kotlinx.coroutines.flow.FlowCollector r8 = r6.f70876a
                kotlin.jvm.functions.Function2 r2 = r6.f70877b
                r0.L$0 = r8
                r0.label = r4
            ...
            L5d:
                ...
                return r7
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__TransformKt$map$$inlined$unsafeTransform$1.C121102.emit(java.lang.Object, kotlin.coroutines.Continuation):java.lang.Object");
        }
        ...
        public final Object emit$$forInline(Object obj, @NotNull Continuation continuation) {
            InlineMarker.mark(4);
            new C121111(continuation);
            InlineMarker.mark(5);
            FlowCollector flowCollector = this.f70876a;
            Object invoke = this.f70877b.invoke(obj, continuation);
            InlineMarker.mark(0);
    ...
    public FlowKt__TransformKt$map$$inlined$unsafeTransform$1(Flow flow, Function2 function2) {
        this.f70874a = flow;
        this.f70875b = function2;
    }

    @Override // kotlinx.coroutines.flow.Flow
    @Nullable
    public Object collect(@NotNull FlowCollector<? super Object> flowCollector, @NotNull Continuation continuation) {
        Object collect = this.f70874a.collect(new C121102(flowCollector, this.f70875b), continuation);
    ...
    public Object collect$$forInline(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        ...
        InlineMarker.mark(5);
        Flow flow = this.f70874a;
        C121102 c121102 = new C121102(flowCollector, this.f70875b);
        InlineMarker.mark(0);
        flow.collect(c121102, continuation);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
