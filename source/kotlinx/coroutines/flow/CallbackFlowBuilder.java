...
public final class CallbackFlowBuilder extends C1410To {

    /* renamed from: b */
    public final Function2 f70755b;
    ...
    @Override // p000.C1410To, kotlinx.coroutines.flow.internal.ChannelFlow
    /*
    ...
    */
    ...
    public ChannelFlow create(CoroutineContext coroutineContext, int i, BufferOverflow bufferOverflow) {
        return new CallbackFlowBuilder(this.f70755b, coroutineContext, i, bufferOverflow);
    }
