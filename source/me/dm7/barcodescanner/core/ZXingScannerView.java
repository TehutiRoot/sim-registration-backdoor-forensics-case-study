...
public class ZXingScannerView extends BarcodeScannerView {
    ...
    /* renamed from: i */
    public MultiFormatReader f71969i;

    /* renamed from: j */
    public List f71970j;

    /* renamed from: k */
    public ResultHandler f71971k;
    ...
    /* loaded from: classes6.dex */
    public class RunnableC12305a implements Runnable {

        /* renamed from: a */
        public final /* synthetic */ byte[] f71972a;
        ...
        /* renamed from: d */
        public final /* synthetic */ Result f71975d;

        public RunnableC12305a(byte[] bArr, int i, int i2, Result result) {
            this.f71972a = bArr;
            this.f71973b = i;
            this.f71974c = i2;
            this.f71975d = result;
        ...
        public void run() {
            ResultHandler resultHandler = ZXingScannerView.this.f71971k;
            ZXingScannerView.this.f71971k = null;
            ZXingScannerView.this.stopCameraPreview();
            if (resultHandler != null) {
                resultHandler.handleResult(this.f71975d, ZXingScannerView.this.m26230e(ZXingScannerView.this.m26228g(this.f71972a, this.f71973b, this.f71974c)));
            }
        }
    }
    ...
    /* renamed from: e */
    public final byte[] m26230e(Bitmap bitmap) {
        try {
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
    ...
    /* renamed from: f */
    public final void m26229f() {
        EnumMap enumMap = new EnumMap(DecodeHintType.class);
        enumMap.put((EnumMap) DecodeHintType.POSSIBLE_FORMATS, (DecodeHintType) getFormats());
        MultiFormatReader multiFormatReader = new MultiFormatReader();
        this.f71969i = multiFormatReader;
        multiFormatReader.setHints(enumMap);
    }

    /* renamed from: g */
    public final Bitmap m26228g(byte[] bArr, int i, int i2) {
        Rect framingRectInPreview = getFramingRectInPreview(i, i2);
    ...
    */
    public void onPreviewFrame(byte[] r10, android.hardware.Camera r11) {
        /*
            r9 = this;
            me.dm7.barcodescanner.core.ZXingScannerView$ResultHandler r0 = r9.f71971k
            if (r0 != 0) goto L5
            return
        L5:
        ...
        L40:
            ...
            com.google.zxing.MultiFormatReader r10 = r9.f71969i     // Catch: java.lang.Throwable -> L5d java.lang.ArrayIndexOutOfBoundsException -> L64 java.lang.NullPointerException -> L6a com.google.zxing.ReaderException -> L6d
            ...
            com.google.zxing.MultiFormatReader r0 = r9.f71969i     // Catch: java.lang.RuntimeException -> L35
        ...
        L5d:
            r10 = move-exception
            com.google.zxing.MultiFormatReader r11 = r9.f71969i     // Catch: java.lang.RuntimeException -> L35
            r11.reset()     // Catch: java.lang.RuntimeException -> L35
            throw r10     // Catch: java.lang.RuntimeException -> L35
        L64:
            com.google.zxing.MultiFormatReader r10 = r9.f71969i     // Catch: java.lang.RuntimeException -> L35
        L66:
