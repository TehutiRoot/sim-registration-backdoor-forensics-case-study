...
public class TestPagerIndicator extends View implements IPagerIndicator {
    ...
    /* renamed from: d */
    public RectF f72352d;

    /* renamed from: e */
    public RectF f72353e;
    ...
    public TestPagerIndicator(Context context) {
        super(context);
        this.f72352d = new RectF();
        this.f72353e = new RectF();
        m26082a(context);
    }

    /* renamed from: a */
    private void m26082a(Context context) {
        Paint paint = new Paint(1);
        this.f72349a = paint;
        paint.setStyle(Paint.Style.STROKE);
        this.f72350b = SupportMenu.CATEGORY_MASK;
        this.f72351c = -16711936;
    }
    ...
    public void onDraw(Canvas canvas) {
        this.f72349a.setColor(this.f72350b);
        canvas.drawRect(this.f72352d, this.f72349a);
        this.f72349a.setColor(this.f72351c);
        canvas.drawRect(this.f72353e, this.f72349a);
    }
    ...
    public void onPageScrolled(int i, float f, int i2) {
        List list = this.f72354f;
        if (list != null && !list.isEmpty()) {
            PositionData imitativePositionData = FragmentContainerHelper.getImitativePositionData(this.f72354f, i);
            PositionData imitativePositionData2 = FragmentContainerHelper.getImitativePositionData(this.f72354f, i + 1);
            RectF rectF = this.f72352d;
