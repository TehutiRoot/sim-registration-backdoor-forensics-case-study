...
public class Duration {
    ...
    /* renamed from: b */
    public static final Pattern f40170b = Pattern.compile("([0-9]*(.[0-9]+)?)\\s*(|milli(second)?|second(e)?|minute|hour|day)s?", 2);
    ...
    public static Duration valueOf(String str) {
        Matcher matcher = f40170b.matcher(str);
        if (!matcher.matches()) {
    ...
    public String toString() {
        ...
        if (j < 1000) {
            ...
            sb = new StringBuilder();
            sb.append(this.f40171a / 1000);
            str = " seconds";
        } else if (j < CoreConstants.MILLIS_IN_ONE_HOUR) {
            sb = new StringBuilder();
            sb.append(this.f40171a / 60000);
            str = " minutes";
        } else {
            sb = new StringBuilder();
            sb.append(this.f40171a / CoreConstants.MILLIS_IN_ONE_HOUR);
            str = " hours";
        }
        sb.append(str);
        return sb.toString();
