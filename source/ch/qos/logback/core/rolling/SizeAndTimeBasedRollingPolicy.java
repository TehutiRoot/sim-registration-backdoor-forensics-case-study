...
public class SizeAndTimeBasedRollingPolicy<E> extends TimeBasedRollingPolicy<E> {
    ...
    /* renamed from: p */
    public FileSize f40049p;

    public void setMaxFileSize(FileSize fileSize) {
        this.f40049p = fileSize;
    }
    ...
    public void start() {
        ...
        if (this.f40049p == null) {
            ...
            addInfo("Archive files will be limited to [" + this.f40049p + "] each.");
            sizeAndTimeBasedFNATP.setMaxFileSize(this.f40049p);
            this.f40061n = sizeAndTimeBasedFNATP;
            if (isUnboundedTotalSizeCap() || this.totalSizeCap.getSize() >= this.f40049p.getSize()) {
                super.start();
                return;
            }
            str = "totalSizeCap of [" + this.totalSizeCap + "] is smaller than maxFileSize [" + this.f40049p + "] which is non-sensical";
        }
        addError(str);
    }
