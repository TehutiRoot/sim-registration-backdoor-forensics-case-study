...
public class FileFilterUtil {
    ...
    /* loaded from: classes.dex */
    public static class C5488a implements FilenameFilter {

        /* renamed from: a */
        public final /* synthetic */ String f40075a;

        public C5488a(String str) {
            this.f40075a = str;
        }

        @Override // java.io.FilenameFilter
        public boolean accept(File file, String str) {
            return str.matches(this.f40075a);
        }
    }
    ...
    public static File[] filesInFolderMatchingStemRegex(File file, String str) {
        return file == null ? new File[0] : (file.exists() && file.isDirectory()) ? file.listFiles(new C5488a(str)) : new File[0];
    }
