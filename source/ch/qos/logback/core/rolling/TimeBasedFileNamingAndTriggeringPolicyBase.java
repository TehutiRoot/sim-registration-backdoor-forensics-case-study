...
public abstract class TimeBasedFileNamingAndTriggeringPolicyBase<E> extends ContextAwareBase implements TimeBasedFileNamingAndTriggeringPolicy<E> {
    ...
    /* renamed from: c */
    public static String f40052c = "http://logback.qos.ch/codes.html#rfa_collision_in_dateFormat";
    protected String elapsedPeriodsFileName;
    protected long nextCheck;

    /* renamed from: rc */
    protected RollingCalendar f40053rc;
    ...
    public void computeNextCheck() {
        this.nextCheck = this.f40053rc.getNextTriggeringDate(this.dateInCurrentPeriod).getTime();
    }
    ...
    public String getCurrentPeriodsFileNameWithoutCompressionSuffix() {
        return this.tbrp.f40054g.convert(this.dateInCurrentPeriod);
    }
    ...
    public void start() {
        DateTokenConverter<Object> primaryDateTokenConverter = this.tbrp.f40039c.getPrimaryDateTokenConverter();
        if (primaryDateTokenConverter == null) {
            throw new IllegalStateException("FileNamePattern [" + this.tbrp.f40039c.getPattern() + "] does not contain a valid DateToken");
        }
        this.f40053rc = primaryDateTokenConverter.getTimeZone() != null ? new RollingCalendar(primaryDateTokenConverter.getDatePattern(), primaryDateTokenConverter.getTimeZone(), Locale.US) : new RollingCalendar(primaryDateTokenConverter.getDatePattern());
        addInfo("The date pattern is '" + primaryDateTokenConverter.getDatePattern() + "' from file name pattern '" + this.tbrp.f40039c.getPattern() + "'.");
        this.f40053rc.printPeriodicity(this);
        if (!this.f40053rc.isCollisionFree()) {
