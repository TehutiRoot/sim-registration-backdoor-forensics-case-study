...
public class Transform {
    ...
    /* renamed from: a */
    public static final int f39754a = 3;

    /* renamed from: b */
    public static final Pattern f39755b = Pattern.compile("[\u0000-\b\u000b\f\u000e-\u001f<>&'\"]");
    ...
    public static String escapeTags(String str) {
        return (str == null || str.length() == 0 || !f39755b.matcher(str).find()) ? str : escapeTags(new StringBuffer(str));
    }
