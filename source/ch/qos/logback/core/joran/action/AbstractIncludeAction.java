...
public abstract class AbstractIncludeAction extends Action {
    ...
    /* renamed from: b */
    public final URL m51528b(String str) {
        StringBuilder sb;
        String str2;
        try {
            URL url = new URL(str);
    ...
    public void begin(InterpretationContext interpretationContext, String str, Attributes attributes) throws ActionException {
        this.f39759c = null;
        this.f39760d = OptionHelper.toBoolean(attributes.getValue("optional"), false);
        if (m51527d(attributes)) {
            try {
                URL m51525i = m51525i(interpretationContext, attributes);
                if (m51525i != null) {
                    processInclude(interpretationContext, m51525i);
                }
            } catch (JoranException e) {
                optionalWarning("Error while parsing " + this.f39759c, e);
            }
        }
    }
    ...
    /* renamed from: d */
    public final boolean m51527d(Attributes attributes) {
        String format;
    ...
    /* renamed from: g */
    public final URL m51526g(String str) {
    ...
    /* renamed from: i */
    public final URL m51525i(InterpretationContext interpretationContext, Attributes attributes) {
        String value = attributes.getValue("file");
        String value2 = attributes.getValue(ImagesContract.URL);
        String value3 = attributes.getValue("resource");
    ...
    /* renamed from: j */
    public final URL m51524j(String str) {
