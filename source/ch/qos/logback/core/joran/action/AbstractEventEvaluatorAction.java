...
public abstract class AbstractEventEvaluatorAction extends Action {
    ...
    /* renamed from: c */
    public EventEvaluator f39757c;

    /* renamed from: d */
    public boolean f39758d = false;
        ...
        if (OptionHelper.isEmpty(value)) {
            ...
            if (!OptionHelper.isEmpty(value2)) {
                try {
                    ...
                    this.f39757c = eventEvaluator;
                    eventEvaluator.setContext(this.context);
                    this.f39757c.setName(value2);
                    interpretationContext.pushObject(this.f39757c);
    ...
    public void end(InterpretationContext interpretationContext, String str) {
        ...
        EventEvaluator eventEvaluator = this.f39757c;
        if (eventEvaluator instanceof LifeCycle) {
            eventEvaluator.start();
            addInfo("Starting evaluator named [" + this.f39757c.getName() + "]");
        }
        if (interpretationContext.peekObject() != this.f39757c) {
        ...
        try {
            ...
            if (map == null) {
                ...
                map.put(this.f39757c.getName(), this.f39757c);
            }
        } catch (Exception e) {
            addError("Could not set evaluator named [" + this.f39757c + "].", e);
        }
    }
