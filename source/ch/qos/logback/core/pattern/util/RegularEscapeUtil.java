...
public class RegularEscapeUtil implements IEscapeUtil {
    ...
    /* renamed from: a */
    public String m51410a(String str) {
    ...
    public void escape(String str, StringBuffer stringBuffer, char c, int i) {
        ...
        if (str.indexOf(c) >= 0 || c == '\\') {
            ...
            if (c == 'n') {
                ...
                c2 = TokenParser.f74557CR;
            } else if (c != 't') {
                String m51410a = m51410a(str);
                throw new IllegalArgumentException("Illegal char '" + c + " at column " + i + ". Only \\\\, \\_" + m51410a + ", \\t, \\n, \\r combinations are allowed as escape characters.");
            } else {
                c2 = '\t';
            }
