...
public class DuplicateMessageFilter extends TurboFilter {
    ...
    /* renamed from: e */
    public LRUMessageCache f39668e;

    @Override // ch.qos.logback.classic.turbo.TurboFilter
    public FilterReply decide(Marker marker, Logger logger, Level level, String str, Object[] objArr, Throwable th2) {
        return this.f39668e.getMessageCountAndThenIncrement(str) <= this.allowedRepetitions ? FilterReply.NEUTRAL : FilterReply.DENY;
    }
    ...
    public void start() {
        this.f39668e = new LRUMessageCache(this.cacheSize);
        super.start();
    }
