...
public class SimpleSSLSocketServer extends SimpleSocketServer {
    ...
    /* renamed from: h */
    public final ServerSocketFactory f39570h;
    ...
    public SimpleSSLSocketServer(LoggerContext loggerContext, int i, SSLContext sSLContext) {
        ...
        this.f39570h = new ConfigurableSSLServerSocketFactory(sSLParametersConfiguration, sSLContext.getServerSocketFactory());
    }
}
