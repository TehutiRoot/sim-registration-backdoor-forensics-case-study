...
public class PatternLayout extends PatternLayoutBase<ILoggingEvent> {
    ...
    static {
        ...
        hashMap.put(PDPageLabelRange.STYLE_ROMAN_LOWER, RelativeTimeConverter.class.getName());
        ...
        hashMap.put(OperatorName.CURVE_TO, LoggerConverter.class.getName());
        hashMap.put(OperatorName.MOVE_TO, MessageConverter.class.getName());
        hashMap.put(NotificationCompat.CATEGORY_MESSAGE, MessageConverter.class.getName());
        ...
        hashMap.put(FirebaseAnalytics.Param.METHOD, MethodOfCallerConverter.class.getName());
        ...
        hashMap.put("file", FileOfCallerConverter.class.getName());
        ...
        hashMap.put(OperatorName.ENDPATH, LineSeparatorConverter.class.getName());
