...
public class HTMLLayout extends HTMLLayoutBase<ILoggingEvent> {
    ...
    /* renamed from: g */
    public IThrowableRenderer f39540g;

    public HTMLLayout() {
        this.pattern = "%date%thread%level%logger%mdc%msg";
        this.f39540g = new DefaultThrowableRenderer();
    ...
    /* renamed from: d */
    public final void m51630d(StringBuilder sb, Converter converter, ILoggingEvent iLoggingEvent) {
        sb.append("<td class=\"");
    ...
    public String doLayout(ILoggingEvent iLoggingEvent) {
        ...
        for (Converter converter = this.head; converter != null; converter = converter.getNext()) {
            m51630d(sb, converter, iLoggingEvent);
        }
        sb.append("</tr>");
        sb.append(CoreConstants.LINE_SEPARATOR);
        if (iLoggingEvent.getThrowableProxy() != null) {
            this.f39540g.render(sb, iLoggingEvent);
        }
        return sb.toString();
    }
    ...
    public void setThrowableRenderer(IThrowableRenderer<ILoggingEvent> iThrowableRenderer) {
        this.f39540g = iThrowableRenderer;
    }
