...
public final class CrossfadeDrawable extends Drawable implements Drawable.Callback, Animatable2Compat {
    ...
    /* renamed from: k */
    public Drawable f40563k;

    /* renamed from: l */
    public final Drawable f40564l;

    @Metadata(m28851d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\b"}, m28850d2 = {"Lcoil/drawable/CrossfadeDrawable$Companion;", "", "()V", "DEFAULT_DURATION", "", "STATE_DONE", "STATE_RUNNING", "STATE_START", "coil-base_release"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    /* loaded from: classes3.dex */
    ...
    /* renamed from: a */
    public final int m51082a(Integer num, Integer num2) {
        int i;
        int i2 = -1;
        if (!this.f40556d && ((num != null && num.intValue() == -1) || (num2 != null && num2.intValue() == -1))) {
            return -1;
        }
        if (num != null) {
            i = num.intValue();
    ...
    /* renamed from: b */
    public final void m51081b() {
        this.f40562j = 2;
        this.f40563k = null;
        List list = this.f40557e;
        int size = list.size();
    ...
    public void draw(@NotNull Canvas canvas) {
        ...
        int i = this.f40562j;
        if (i == 0) {
            Drawable drawable2 = this.f40563k;
            if (drawable2 != null) {
                drawable2.setAlpha(this.f40561i);
                save = canvas.save();
                try {
            ...
            Drawable drawable3 = this.f40564l;
            if (drawable3 != null) {
                drawable3.setAlpha(this.f40561i);
                save = canvas.save();
                try {
            ...
            double uptimeMillis = (SystemClock.uptimeMillis() - this.f40560h) / this.f40554b;
            double coerceIn = AbstractC11719c.coerceIn(uptimeMillis, 0.0d, 1.0d);
            int i2 = this.f40561i;
            ...
            if (!z && (drawable = this.f40563k) != null) {
            ...
            Drawable drawable4 = this.f40564l;
            if (drawable4 != null) {
    ...
    public ColorFilter getColorFilter() {
        ...
        if (i != 0) {
            if (i != 1) {
                if (i != 2 || (drawable = this.f40564l) == null) {
                    return null;
                }
                return drawable.getColorFilter();
            }
            Drawable drawable2 = this.f40564l;
            if (drawable2 != null && (colorFilter = drawable2.getColorFilter()) != null) {
                return colorFilter;
            }
            Drawable drawable3 = this.f40563k;
            if (drawable3 == null) {
                return null;
            }
            return drawable3.getColorFilter();
        }
        Drawable drawable4 = this.f40563k;
        if (drawable4 == null) {
            return null;
        }
    ...
    public int getOpacity() {
        Drawable drawable = this.f40563k;
        Drawable drawable2 = this.f40564l;
        int i = this.f40562j;
        if (i == 0) {
            if (drawable == null) {
    ...
    public void registerAnimationCallback(@NotNull Animatable2Compat.AnimationCallback animationCallback) {
        this.f40557e.add(animationCallback);
    }
    ...
    public void start() {
        ...
        this.f40562j = 1;
        this.f40560h = SystemClock.uptimeMillis();
        List list = this.f40557e;
        int size = list.size();
        for (int i = 0; i < size; i++) {
    ...
    public boolean unregisterAnimationCallback(@NotNull Animatable2Compat.AnimationCallback animationCallback) {
        return this.f40557e.remove(animationCallback);
    }
    ...
    public final void updateBounds$coil_base_release(@NotNull Drawable drawable, @NotNull Rect rect) {
        ...
        if (intrinsicWidth > 0 && intrinsicHeight > 0) {
            ...
            double computeSizeMultiplier = DecodeUtils.computeSizeMultiplier(intrinsicWidth, intrinsicHeight, width, height, this.f40553a);
            double d = 2;
            int roundToInt = AbstractC21140mr0.roundToInt((width - (intrinsicWidth * computeSizeMultiplier)) / d);
            int roundToInt2 = AbstractC21140mr0.roundToInt((height - (computeSizeMultiplier * intrinsicHeight)) / d);
    ...
    public CrossfadeDrawable(@Nullable Drawable drawable, @Nullable Drawable drawable2, @NotNull Scale scale, int i, boolean z, boolean z2) {
        ...
        this.f40558f = m51082a(drawable != null ? Integer.valueOf(drawable.getIntrinsicWidth()) : null, drawable2 != null ? Integer.valueOf(drawable2.getIntrinsicWidth()) : null);
        this.f40559g = m51082a(drawable != null ? Integer.valueOf(drawable.getIntrinsicHeight()) : null, drawable2 != null ? Integer.valueOf(drawable2.getIntrinsicHeight()) : null);
        this.f40561i = 255;
        this.f40563k = drawable != null ? drawable.mutate() : null;
