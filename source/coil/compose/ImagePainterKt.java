...
public final class ImagePainterKt {
    ...
    public static final AsyncImagePainter rememberImagePainter(@Nullable Object obj, @NotNull ImageLoader imageLoader, @Nullable Composer composer, int i) {
        ...
        AsyncImagePainter m73957rememberAsyncImagePainter5jETZwI = AsyncImagePainterKt.m73957rememberAsyncImagePainter5jETZwI(obj, imageLoader, null, null, null, 0, composer, 72, 60);
    ...
    public static final AsyncImagePainter rememberImagePainter(@Nullable Object obj, @NotNull ImageLoader imageLoader, @NotNull Function1<? super ImageRequest.Builder, Unit> function1, @Nullable Composer composer, int i) {
        ...
        AsyncImagePainter m73957rememberAsyncImagePainter5jETZwI = AsyncImagePainterKt.m73957rememberAsyncImagePainter5jETZwI(data.build(), imageLoader, null, null, null, 0, composer, 72, 60);
        composer.endReplaceableGroup();
        return m73957rememberAsyncImagePainter5jETZwI;
    }
    ...
    public static final AsyncImagePainter rememberImagePainter(@NotNull ImageRequest imageRequest, @NotNull ImageLoader imageLoader, @Nullable Composer composer, int i) {
        ...
        AsyncImagePainter m73957rememberAsyncImagePainter5jETZwI = AsyncImagePainterKt.m73957rememberAsyncImagePainter5jETZwI(imageRequest, imageLoader, null, null, null, 0, composer, 72, 60);
        composer.endReplaceableGroup();
        return m73957rememberAsyncImagePainter5jETZwI;
    }
