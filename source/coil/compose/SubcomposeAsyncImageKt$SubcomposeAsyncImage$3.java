...
public final class SubcomposeAsyncImageKt$SubcomposeAsyncImage$3 extends Lambda implements Function3<BoxWithConstraintsScope, Composer, Integer, Unit> {
    ...
    public final void invoke(@NotNull BoxWithConstraintsScope boxWithConstraintsScope, @Nullable Composer composer, int i) {
        ...
        ((ConstraintsSizeResolver) this.$sizeResolver).m73959setConstraintsBRTryo0(boxWithConstraintsScope.mo69493getConstraintsmsEJaDk());
        this.$content.invoke(new C20972ls1(boxWithConstraintsScope, this.$painter, this.$contentDescription, this.$alignment, this.$contentScale, this.$alpha, this.$colorFilter), composer, Integer.valueOf(this.$$dirty1 & 112));
        if (ComposerKt.isTraceInProgress()) {
