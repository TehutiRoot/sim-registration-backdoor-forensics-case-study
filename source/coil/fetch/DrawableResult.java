...
public final class DrawableResult extends FetchResult {
    ...
    public static /* synthetic */ DrawableResult copy$default(DrawableResult drawableResult, Drawable drawable, boolean z, DataSource dataSource, int i, Object obj) {
        if ((i & 1) != 0) {
            drawable = drawableResult.f40575a;
        }
        if ((i & 2) != 0) {
            z = drawableResult.f40576b;
        }
        if ((i & 4) != 0) {
            dataSource = drawableResult.f40577c;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof DrawableResult) {
            ...
            if (Intrinsics.areEqual(this.f40575a, drawableResult.f40575a) && this.f40576b == drawableResult.f40576b && this.f40577c == drawableResult.f40577c) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return (((this.f40575a.hashCode() * 31) + AbstractC1705Xp.m65430a(this.f40576b)) * 31) + this.f40577c.hashCode();
    }
