...
public final class RealImageLoader implements ImageLoader {
    ...
    /* renamed from: b */
    public final DefaultRequestOptions f40408b;

    /* renamed from: c */
    public final Lazy f40409c;

    /* renamed from: d */
    public final Lazy f40410d;

    /* renamed from: e */
    public final Lazy f40411e;

    /* renamed from: f */
    public final EventListener.Factory f40412f;

    /* renamed from: g */
    public final ComponentRegistry f40413g;

    /* renamed from: h */
    public final ImageLoaderOptions f40414h;

    /* renamed from: i */
    public final Logger f40415i;

    /* renamed from: j */
    public final CoroutineScope f40416j = CoroutineScopeKt.CoroutineScope(SupervisorKt.SupervisorJob$default((Job) null, 1, (Object) null).plus(Dispatchers.getMain().getImmediate()).plus(new RealImageLoader$special$$inlined$CoroutineExceptionHandler$1(CoroutineExceptionHandler.Key, this)));

    /* renamed from: k */
    public final SystemCallbacks f40417k;

    /* renamed from: l */
    public final RequestService f40418l;

    /* renamed from: m */
    public final ComponentRegistry f40419m;

    /* renamed from: n */
    public final List f40420n;

    /* renamed from: o */
    public final AtomicBoolean f40421o;

    @Metadata(m28851d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0007X\u0082T¢\u0006\u0002\n\u0000¨\u0006\b"}, m28850d2 = {"Lcoil/RealImageLoader$Companion;", "", "()V", "REQUEST_TYPE_ENQUEUE", "", "REQUEST_TYPE_EXECUTE", "TAG", "", "coil-base_release"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    /* loaded from: classes3.dex */
    ...
    */
    public final java.lang.Object m51148a(coil.request.ImageRequest r21, int r22, kotlin.coroutines.Continuation r23) {
        /*
            Method dump skipped, instructions count: 466
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: coil.RealImageLoader.m51148a(coil.request.ImageRequest, int, kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* renamed from: b */
    public final void m51147b(ImageRequest imageRequest, EventListener eventListener) {
        Logger logger = this.f40415i;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void m51146c(coil.request.ErrorResult r7, coil.target.Target r8, coil.EventListener r9) {
        /*
            r6 = this;
            coil.request.ImageRequest r0 = r7.getRequest()
            coil.util.Logger r1 = r6.f40415i
            if (r1 == 0) goto L36
            int r2 = r1.getLevel()
            r3 = 4
            if (r2 > r3) goto L36
        ...
        L75:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: coil.RealImageLoader.m51146c(coil.request.ErrorResult, coil.target.Target, coil.EventListener):void");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void m51145d(coil.request.SuccessResult r7, coil.target.Target r8, coil.EventListener r9) {
        /*
            r6 = this;
            coil.request.ImageRequest r0 = r7.getRequest()
            coil.decode.DataSource r1 = r7.getDataSource()
            coil.util.Logger r2 = r6.f40415i
            if (r2 == 0) goto L41
            int r3 = r2.getLevel()
            r4 = 4
            if (r3 > r4) goto L41
        ...
        L80:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: coil.RealImageLoader.m51145d(coil.request.SuccessResult, coil.target.Target, coil.EventListener):void");
    }
    ...
    public Disposable enqueue(@NotNull ImageRequest imageRequest) {
        ...
        m65756b = AbstractC1552Vc.m65756b(this.f40416j, null, null, new RealImageLoader$enqueue$job$1(this, imageRequest, null), 3, null);
        if (imageRequest.getTarget() instanceof ViewTarget) {
            return Utils.getRequestManager(((ViewTarget) imageRequest.getTarget()).getView()).getDisposable(m65756b);
        }
        return new OneShotDisposable(m65756b);
    }
    ...
    public DiskCache getDiskCache() {
        return (DiskCache) this.f40410d.getValue();
    }
    ...
    public MemoryCache getMemoryCache() {
        return (MemoryCache) this.f40409c.getValue();
    }
    ...
    public void shutdown() {
        if (this.f40421o.getAndSet(true)) {
            return;
        }
        CoroutineScopeKt.cancel$default(this.f40416j, null, 1, null);
        this.f40417k.shutdown();
