...
public final class RealWeakMemoryCache implements WeakMemoryCache {
    ...
    /* renamed from: a */
    public final LinkedHashMap f40632a = new LinkedHashMap();

    /* renamed from: b */
    public int f40633b;

    @Metadata(m28851d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0005"}, m28850d2 = {"Lcoil/memory/RealWeakMemoryCache$Companion;", "", "()V", "CLEAN_UP_INTERVAL", "", "coil-base_release"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    /* loaded from: classes3.dex */
    ...
    @Metadata(m28851d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010$\n\u0002\u0010\u000e\n\u0002\b\u0013\b\u0001\u0018\u00002\u00020\u0001B9\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\f\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004\u0012\u0012\u0010\t\u001a\u000e\u0012\u0004\u0012\u00020\b\u0012\u0004\u0012\u00020\u00010\u0007\u0012\u0006\u0010\n\u001a\u00020\u0002¢\u0006\u0004\b\u000b\u0010\fR\u0017\u0010\u0003\u001a\u00020\u00028\u0006¢\u0006\f\n\u0004\b\r\u0010\u000e\u001a\u0004\b\u000f\u0010\u0010R\u001d\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0006¢\u0006\f\n\u0004\b\u0011\u0010\u0012\u001a\u0004\b\u0013\u0010\u0014R#\u0010\t\u001a\u000e\u0012\u0004\u0012\u00020\b\u0012\u0004\u0012\u00020\u00010\u00078\u0006¢\u0006\f\n\u0004\b\u0015\u0010\u0016\u001a\u0004\b\u0017\u0010\u0018R\u0017\u0010\n\u001a\u00020\u00028\u0006¢\u0006\f\n\u0004\b\u0019\u0010\u000e\u001a\u0004\b\u001a\u0010\u0010¨\u0006\u001b"}, m28850d2 = {"Lcoil/memory/RealWeakMemoryCache$InternalValue;", "", "", "identityHashCode", "Ljava/lang/ref/WeakReference;", "Landroid/graphics/Bitmap;", "bitmap", "", "", "extras", "size", "<init>", "(ILjava/lang/ref/WeakReference;Ljava/util/Map;I)V", PDPageLabelRange.STYLE_LETTERS_LOWER, "I", "getIdentityHashCode", "()I", OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, "Ljava/lang/ref/WeakReference;", "getBitmap", "()Ljava/lang/ref/WeakReference;", OperatorName.CURVE_TO, "Ljava/util/Map;", "getExtras", "()Ljava/util/Map;", "d", "getSize", "coil-base_release"}, m28849k = 1, m28848mv = {1, 8, 0})
    @VisibleForTesting
    /* loaded from: classes3.dex */
    ...
    public final void cleanUp$coil_base_release() {
        ...
        this.f40633b = 0;
        Iterator it = this.f40632a.values().iterator();
        while (it.hasNext()) {
    ...
    public synchronized MemoryCache.Value get(@NotNull MemoryCache.Key key) {
        ...
        try {
            ArrayList arrayList = (ArrayList) this.f40632a.get(key);
    ...
    public synchronized Set<MemoryCache.Key> getKeys() {
        return CollectionsKt___CollectionsKt.toSet(this.f40632a.keySet());
    }

    @Override // coil.memory.WeakMemoryCache
    public synchronized boolean remove(@NotNull MemoryCache.Key key) {
        boolean z;
        if (this.f40632a.remove(key) != null) {
            z = true;
        } else {
            z = false;
        }
    ...
    public synchronized void set(@NotNull MemoryCache.Key key, @NotNull Bitmap bitmap, @NotNull Map<String, ? extends Object> map, int i) {
        try {
            LinkedHashMap linkedHashMap = this.f40632a;
