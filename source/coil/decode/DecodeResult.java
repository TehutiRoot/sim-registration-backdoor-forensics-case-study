...
public final class DecodeResult {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof DecodeResult) {
            ...
            if (Intrinsics.areEqual(this.f40482a, decodeResult.f40482a) && this.f40483b == decodeResult.f40483b) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return (this.f40482a.hashCode() * 31) + AbstractC1705Xp.m65430a(this.f40483b);
    }
