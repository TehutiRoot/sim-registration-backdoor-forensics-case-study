...
@Metadata(m28851d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0004\u001a\u0019\u0010\u0003\u001a\u00020\u00022\b\u0010\u0001\u001a\u0004\u0018\u00010\u0000H\u0000¢\u0006\u0004\b\u0003\u0010\u0004\"\u0014\u0010\b\u001a\u00020\u00058\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0006\u0010\u0007¨\u0006\t"}, m28850d2 = {"Lcoil/util/Logger;", "logger", "Lcoil/util/HardwareBitmapService;", "HardwareBitmapService", "(Lcoil/util/Logger;)Lcoil/util/HardwareBitmapService;", "", PDPageLabelRange.STYLE_LETTERS_LOWER, "Z", "IS_DEVICE_BLOCKED", "coil-base_release"}, m28849k = 2, m28848mv = {1, 8, 0})
...
public final class HardwareBitmaps {
    ...
    /* renamed from: a */
    public static final boolean f40855a;
    ...
    static {
        ...
        if (i != 26) {
            ...
            if (str2 != null) {
                if (AbstractC20204hN1.startsWith$default(StringsKt__StringsKt.removePrefix(str2, (CharSequence) "SAMSUNG-"), "SM-", false, 2, null)) {
                    z = true;
                } else {
