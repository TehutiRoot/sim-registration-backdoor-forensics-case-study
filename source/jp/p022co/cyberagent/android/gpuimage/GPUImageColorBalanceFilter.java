...
public class GPUImageColorBalanceFilter extends GPUImageFilter {
    ...
    public GPUImageColorBalanceFilter() {
        ...
        this.f67439i = new float[]{0.0f, 0.0f, 0.0f};
        this.f67440j = new float[]{0.0f, 0.0f, 0.0f};
        this.f67441k = new float[]{0.0f, 0.0f, 0.0f};
        this.f67442l = true;
    }
    ...
    public void onInit() {
        super.onInit();
        this.f67435e = GLES20.glGetUniformLocation(getProgram(), "shadowsShift");
        this.f67436f = GLES20.glGetUniformLocation(getProgram(), "midtonesShift");
        this.f67437g = GLES20.glGetUniformLocation(getProgram(), "highlightsShift");
        this.f67438h = GLES20.glGetUniformLocation(getProgram(), "preserveLuminosity");
    }

    @Override // jp.p022co.cyberagent.android.gpuimage.GPUImageFilter
    public void onInitialized() {
        super.onInitialized();
        setMidtones(this.f67440j);
        setShowdows(this.f67439i);
        setHighlights(this.f67441k);
        setPreserveLuminosity(this.f67442l);
    }

    public void setHighlights(float[] fArr) {
        this.f67441k = fArr;
        setFloatVec3(this.f67437g, fArr);
    }

    public void setMidtones(float[] fArr) {
        this.f67440j = fArr;
        setFloatVec3(this.f67436f, fArr);
    }

    public void setPreserveLuminosity(boolean z) {
        this.f67442l = z;
        setInteger(this.f67438h, z ? 1 : 0);
    }

    public void setShowdows(float[] fArr) {
        this.f67439i = fArr;
        setFloatVec3(this.f67435e, fArr);
    }
}
