...
public class GPUImageBilateralFilter extends GPUImageFilter {
    ...
    /* renamed from: a */
    public final void m29105a(float f, float f2) {
        setFloatVec2(this.f67416g, new float[]{1.0f / f, 1.0f / f2});
    }

    @Override // jp.p022co.cyberagent.android.gpuimage.GPUImageFilter
    public void onInit() {
        super.onInit();
        this.f67415f = GLES20.glGetUniformLocation(getProgram(), "distanceNormalizationFactor");
        this.f67416g = GLES20.glGetUniformLocation(getProgram(), "singleStepOffset");
    }

    @Override // jp.p022co.cyberagent.android.gpuimage.GPUImageFilter
    public void onInitialized() {
        super.onInitialized();
        setDistanceNormalizationFactor(this.f67414e);
    }
