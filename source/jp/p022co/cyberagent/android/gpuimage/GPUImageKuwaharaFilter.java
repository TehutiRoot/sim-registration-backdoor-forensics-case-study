...
/* renamed from: jp.co.cyberagent.android.gpuimage.GPUImageKuwaharaFilter */
...
public class GPUImageKuwaharaFilter extends GPUImageFilter {
    ...
    public void onInit() {
        super.onInit();
        this.f67522f = GLES20.glGetUniformLocation(getProgram(), "radius");
    }

    @Override // jp.p022co.cyberagent.android.gpuimage.GPUImageFilter
    public void onInitialized() {
        super.onInitialized();
        setRadius(this.f67521e);
    }

    public void setRadius(int i) {
        this.f67521e = i;
        setInteger(this.f67522f, i);
    }

    public GPUImageKuwaharaFilter(int i) {
        super(GPUImageFilter.NO_FILTER_VERTEX_SHADER, KUWAHARA_FRAGMENT_SHADER);
        this.f67521e = i;
    }
}
