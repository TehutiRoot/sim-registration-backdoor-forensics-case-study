...
public class GPUImage3x3ConvolutionFilter extends GPUImage3x3TextureSamplingFilter {
    ...
    public void onInit() {
        super.onInit();
        this.f67407l = GLES20.glGetUniformLocation(getProgram(), "convolutionMatrix");
        setConvolutionKernel(this.f67406k);
    }

    public void setConvolutionKernel(float[] fArr) {
        this.f67406k = fArr;
        setUniformMatrix3f(this.f67407l, fArr);
    }
