...
public class GPUImageLaplacianFilter extends GPUImage3x3TextureSamplingFilter {
    ...
    private void setConvolutionKernel(float[] fArr) {
        this.f67523k = fArr;
        setUniformMatrix3f(this.f67524l, fArr);
    }
    ...
    public void onInit() {
        super.onInit();
        this.f67524l = GLES20.glGetUniformLocation(getProgram(), "convolutionMatrix");
        setConvolutionKernel(this.f67523k);
    }
