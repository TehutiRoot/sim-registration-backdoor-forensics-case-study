...
public class GPUImageTransformFilter extends GPUImageFilter {
    ...
    /* renamed from: g */
    public float[] f67633g;

    /* renamed from: h */
    public float[] f67634h;

    /* renamed from: i */
    public boolean f67635i;

    /* renamed from: j */
    public boolean f67636j;
    ...
    public void onInit() {
        super.onInit();
        this.f67631e = GLES20.glGetUniformLocation(getProgram(), "transformMatrix");
        this.f67632f = GLES20.glGetUniformLocation(getProgram(), "orthographicMatrix");
        setUniformMatrix4f(this.f67631e, this.f67634h);
        setUniformMatrix4f(this.f67632f, this.f67633g);
    }
    ...
    public void onOutputSizeChanged(int i, int i2) {
        ...
        if (!this.f67635i) {
            float f = i2;
            float f2 = i;
            Matrix.orthoM(this.f67633g, 0, -1.0f, 1.0f, ((-1.0f) * f) / f2, (f * 1.0f) / f2, -1.0f, 1.0f);
            setUniformMatrix4f(this.f67632f, this.f67633g);
        }
    }
    ...
    public void setAnchorTopLeft(boolean z) {
        this.f67636j = z;
        setIgnoreAspectRatio(this.f67635i);
    }

    public void setIgnoreAspectRatio(boolean z) {
        this.f67635i = z;
        if (z) {
            Matrix.orthoM(this.f67633g, 0, -1.0f, 1.0f, -1.0f, 1.0f, -1.0f, 1.0f);
            setUniformMatrix4f(this.f67632f, this.f67633g);
            return;
        }
    ...
    public void setTransform3D(float[] fArr) {
        this.f67634h = fArr;
        setUniformMatrix4f(this.f67631e, fArr);
    }
}
