...
public class GPUImageCrosshatchFilter extends GPUImageFilter {
    ...
    /* renamed from: e */
    public float f67449e;

    /* renamed from: f */
    public int f67450f;

    /* renamed from: g */
    public float f67451g;
    ...
    public void onInit() {
        super.onInit();
        this.f67450f = GLES20.glGetUniformLocation(getProgram(), "crossHatchSpacing");
        this.f67452h = GLES20.glGetUniformLocation(getProgram(), "lineWidth");
    }

    @Override // jp.p022co.cyberagent.android.gpuimage.GPUImageFilter
    public void onInitialized() {
        super.onInitialized();
        setCrossHatchSpacing(this.f67449e);
        setLineWidth(this.f67451g);
    }
    ...
    public void setCrossHatchSpacing(float f) {
        ...
        setFloat(this.f67450f, this.f67449e);
    }

    public void setLineWidth(float f) {
        this.f67451g = f;
        setFloat(this.f67452h, f);
    }
