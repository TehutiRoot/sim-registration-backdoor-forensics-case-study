...
public class GPUImageHalftoneFilter extends GPUImageFilter {
    ...
    /* renamed from: g */
    public float f67509g;

    /* renamed from: h */
    public float f67510h;
    ...
    public void onInit() {
        super.onInit();
        this.f67507e = GLES20.glGetUniformLocation(getProgram(), "fractionalWidthOfPixel");
        this.f67508f = GLES20.glGetUniformLocation(getProgram(), "aspectRatio");
        setFractionalWidthOfAPixel(this.f67509g);
    }
    ...
    public void setAspectRatio(float f) {
        this.f67510h = f;
        setFloat(this.f67508f, f);
    }

    public void setFractionalWidthOfAPixel(float f) {
        this.f67509g = f;
        setFloat(this.f67507e, f);
    }
