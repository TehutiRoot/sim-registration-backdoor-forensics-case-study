...
public class GPUImageSharpenFilter extends GPUImageFilter {
    ...
    public void onInit() {
        super.onInit();
        this.f67593e = GLES20.glGetUniformLocation(getProgram(), "sharpness");
        this.f67595g = GLES20.glGetUniformLocation(getProgram(), "imageWidthFactor");
        this.f67596h = GLES20.glGetUniformLocation(getProgram(), "imageHeightFactor");
        setSharpness(this.f67594f);
    }

    @Override // jp.p022co.cyberagent.android.gpuimage.GPUImageFilter
    public void onOutputSizeChanged(int i, int i2) {
        super.onOutputSizeChanged(i, i2);
        setFloat(this.f67595g, 1.0f / i);
        setFloat(this.f67596h, 1.0f / i2);
    }

    public void setSharpness(float f) {
        this.f67594f = f;
        setFloat(this.f67593e, f);
    }
