...
public abstract class ParameterHandler<T> {
    ...
    public static final class Body<T> extends ParameterHandler<T> {
        ...
        public void apply(RequestBuilder requestBuilder, @Nullable T t) {
            ...
            throw Utils.parameterError(this.method, this.f77343p, "Body parameter value must not be null.", new Object[0]);
        }
    }
            ...
            if (map != null) {
                for (Map.Entry<String, T> entry : map.entrySet()) {
                    ...
                    if (key != null) {
                        ...
                        throw Utils.parameterError(this.method, this.f77344p, "Field map contained null key.", new Object[0]);
                    }
                }
                return;
            }
            throw Utils.parameterError(this.method, this.f77344p, "Field map was null.", new Object[0]);
        }
    }
            ...
            if (map != null) {
                for (Map.Entry<String, T> entry : map.entrySet()) {
                    ...
                    if (key != null) {
                        ...
                        throw Utils.parameterError(this.method, this.f77345p, "Header map contained null key.", new Object[0]);
                    }
                }
                return;
            }
            throw Utils.parameterError(this.method, this.f77345p, "Header map was null.", new Object[0]);
        }
    }
    ...
    public static final class Headers extends ParameterHandler<okhttp3.Headers> {
        ...
        public void apply(RequestBuilder requestBuilder, @Nullable okhttp3.Headers headers) {
            ...
            throw Utils.parameterError(this.method, this.f77346p, "Headers parameter must not be null.", new Object[0]);
        }
    }
            ...
            if (map != null) {
                for (Map.Entry<String, T> entry : map.entrySet()) {
                    ...
                    if (key != null) {
                        T value = entry.getValue();
                        if (value != null) {
                            requestBuilder.addPart(okhttp3.Headers.m25874of(HttpHeaders.CONTENT_DISPOSITION, "form-data; name=\"" + key + OperatorName.SHOW_TEXT_LINE_AND_SPACE, "Content-Transfer-Encoding", this.transferEncoding), this.valueConverter.convert(value));
                        } else {
                            Method method = this.method;
                            int i = this.f77348p;
                        ...
                        throw Utils.parameterError(this.method, this.f77348p, "Part map contained null key.", new Object[0]);
                    }
                }
                return;
            }
            throw Utils.parameterError(this.method, this.f77348p, "Part map was null.", new Object[0]);
        }
    }
            ...
            if (map != null) {
                for (Map.Entry<String, T> entry : map.entrySet()) {
                    ...
                    if (key != null) {
                        ...
                        throw Utils.parameterError(this.method, this.f77350p, "Query map contained null key.", new Object[0]);
                    }
                }
                return;
            }
            throw Utils.parameterError(this.method, this.f77350p, "Query map was null", new Object[0]);
        }
    }
    ...
    public static final class RelativeUrl extends ParameterHandler<Object> {
        ...
        public void apply(RequestBuilder requestBuilder, @Nullable Object obj) {
            ...
            throw Utils.parameterError(this.method, this.f77351p, "@Url parameter is null.", new Object[0]);
        }
    }
