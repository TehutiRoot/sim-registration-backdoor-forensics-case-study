...
public final class DefaultCallAdapterFactory extends CallAdapter.Factory {
    ...
    public static final class ExecutorCallbackCall<T> implements Call<T> {
        ...
        /* loaded from: classes5.dex */
        public class C132711 implements Callback<T> {
            final /* synthetic */ Callback val$callback;

            public C132711(Callback callback) {
                ExecutorCallbackCall.this = r1;
                this.val$callback = callback;
            }

            /* renamed from: a */
            public static /* synthetic */ void m23301a(C132711 c132711, Callback callback, Throwable th2) {
                c132711.lambda$onFailure$1(callback, th2);
            }

            /* renamed from: b */
            public static /* synthetic */ void m23300b(C132711 c132711, Callback callback, Response response) {
                c132711.lambda$onResponse$0(callback, response);
            }
            ...
            public void onFailure(Call<T> call, final Throwable th2) {
                ...
                executor.execute(new Runnable() { // from class: retrofit2.b
                    {
                        DefaultCallAdapterFactory.ExecutorCallbackCall.C132711.this = this;
                    }

                    @Override // java.lang.Runnable
                    public final void run() {
                        DefaultCallAdapterFactory.ExecutorCallbackCall.C132711.m23301a(DefaultCallAdapterFactory.ExecutorCallbackCall.C132711.this, callback, th2);
                    }
                });
            }
            ...
            public void onResponse(Call<T> call, final Response<T> response) {
                ...
                executor.execute(new Runnable() { // from class: retrofit2.a
                    @Override // java.lang.Runnable
                    public final void run() {
                        DefaultCallAdapterFactory.ExecutorCallbackCall.C132711.m23300b(DefaultCallAdapterFactory.ExecutorCallbackCall.C132711.this, callback, response);
                    }
                });
            }
        }
        ...
        public void enqueue(Callback<T> callback) {
            ...
            this.delegate.enqueue(new C132711(callback));
        }
