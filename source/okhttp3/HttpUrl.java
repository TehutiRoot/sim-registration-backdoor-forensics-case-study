...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        @Metadata(m28851d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\u0007\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J \u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\u0006H\u0002J \u0010\n\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\u0006H\u0002J \u0010\u000b\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\u0006H\u0002J\u001c\u0010\f\u001a\u00020\u0006*\u00020\u00042\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\u0006H\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0080T¢\u0006\u0002\n\u0000¨\u0006\r"}, m28850d2 = {"Lokhttp3/HttpUrl$Builder$Companion;", "", "()V", "INVALID_HOST", "", "parsePort", "", "input", "pos", "limit", "portColonOffset", "schemeDelimiterOffset", "slashCount", "okhttp"}, m28849k = 1, m28848mv = {1, 6, 0}, m28846xi = 48)
        /* loaded from: classes6.dex */
        ...
        private final boolean isDot(String str) {
            if (Intrinsics.areEqual(str, ".") || AbstractC20204hN1.equals(str, "%2e", true)) {
                return true;
            }
            return false;
        }
        ...
        private final boolean isDotDot(String str) {
            if (Intrinsics.areEqual(str, CallerDataConverter.DEFAULT_RANGE_DELIMITER) || AbstractC20204hN1.equals(str, "%2e.", true) || AbstractC20204hN1.equals(str, ".%2e", true) || AbstractC20204hN1.equals(str, "%2e%2e", true)) {
                return true;
            }
            return false;
        }
        ...
        private final void push(String str, int i, int i2, boolean z, boolean z2) {
            String canonicalize$okhttp$default = Companion.canonicalize$okhttp$default(HttpUrl.Companion, str, i, i2, HttpUrl.PATH_SEGMENT_ENCODE_SET, z2, false, false, false, null, C6150DK.ERROR_RECEIVE_LRC, null);
        ...
        public final Builder addEncodedQueryParameter(@NotNull String encodedName, @Nullable String str) {
            ...
            if (str == null) {
                ...
                canonicalize$okhttp$default = Companion.canonicalize$okhttp$default(companion, str, 0, 0, HttpUrl.QUERY_COMPONENT_REENCODE_SET, true, false, true, false, null, Primes.SMALL_FACTOR_LIMIT, null);
            }
            ...
            if (str != null) {
                ...
                if (str2 != null) {
                    ...
                    if (list2 == null) {
                        ...
                        arrayList = new ArrayList(AbstractC10176es.collectionSizeOrDefault(list3, 10));
        ...
        public final Builder encodedPath(@NotNull String encodedPath) {
            ...
            if (AbstractC20204hN1.startsWith$default(encodedPath, RemoteSettings.FORWARD_SLASH_STRING, false, 2, null)) {
        ...
        public final Builder parse$okhttp(@Nullable HttpUrl httpUrl, @NotNull String str) {
            ...
            if (schemeDelimiterOffset != -1) {
                if (AbstractC20204hN1.startsWith(input, "https:", indexOfFirstNonAsciiWhitespace$default, true)) {
                    this.scheme = UriUtil.HTTPS_SCHEME;
                    indexOfFirstNonAsciiWhitespace$default += 6;
                } else if (AbstractC20204hN1.startsWith(input, "http:", indexOfFirstNonAsciiWhitespace$default, true)) {
                    this.scheme = "http";
                ...
                while (true) {
                    ...
                    if (c == c2 || c == c4 || c == '/' || c == '\\' || c == c3) {
                        ...
                        if (!z2) {
                            ...
                            String canonicalize$okhttp$default = Companion.canonicalize$okhttp$default(companion2, str, i4, delimiterOffset2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, C6150DK.ERROR_RECEIVE_LRC, null);
                            if (z3) {
                            ...
                            if (delimiterOffset2 != delimiterOffset) {
                                i2 = delimiterOffset;
                                this.encodedPassword = Companion.canonicalize$okhttp$default(companion2, str, delimiterOffset2 + 1, delimiterOffset, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, C6150DK.ERROR_RECEIVE_LRC, null);
                                z = true;
                            } else {
                                i2 = delimiterOffset;
                                z = z2;
                            ...
                            sb2.append("%40");
                            i3 = indexOfLastNonAsciiWhitespace$default;
                            sb2.append(Companion.canonicalize$okhttp$default(HttpUrl.Companion, str, i4, i2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, C6150DK.ERROR_RECEIVE_LRC, null));
            ...
            if (delimiterOffset3 < i6 && input.charAt(delimiterOffset3) == '#') {
                this.encodedFragment = Companion.canonicalize$okhttp$default(HttpUrl.Companion, str, delimiterOffset3 + 1, i6, "", true, false, false, true, null, SyslogConstants.LOG_LOCAL6, null);
            }
            return this;
        }
        ...
        public final Builder scheme(@NotNull String scheme) {
            ...
            if (AbstractC20204hN1.equals(scheme, "http", true)) {
                setScheme$okhttp("http");
            } else if (AbstractC20204hN1.equals(scheme, UriUtil.HTTPS_SCHEME, true)) {
                setScheme$okhttp(UriUtil.HTTPS_SCHEME);
            } else {
        ...
        */
        public java.lang.String toString() {
            ...
            L54:
                ...
                r4 = 0
                r5 = 0
                boolean r1 = kotlin.text.StringsKt__StringsKt.contains$default(r1, r2, r5, r3, r4)
                if (r1 == 0) goto L7c
                r1 = 91
                r0.append(r1)
                java.lang.String r1 = r6.getHost$okhttp()
    ...
    public static final class Companion {
        ...
        */
        ...
        public final HttpUrl m74831deprecated_get(@NotNull String url) {
        ...
        public final HttpUrl m74834deprecated_parse(@NotNull String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return parse(url);
        }
        ...
        public final int defaultPort(@NotNull String scheme) {
            ...
            if (Intrinsics.areEqual(scheme, UriUtil.HTTPS_SCHEME)) {
                return com.mixpanel.android.java_websocket.WebSocket.DEFAULT_WSS_PORT;
            }
            return -1;
        }
        ...
        public final void toQueryString$okhttp(@NotNull List<String> list, @NotNull StringBuilder out) {
            Intrinsics.checkNotNullParameter(list, "<this>");
            Intrinsics.checkNotNullParameter(out, "out");
            IntProgression step = AbstractC11719c.step(AbstractC11719c.until(0, list.size()), 2);
        ...
        @Nullable
        /* renamed from: -deprecated_get  reason: not valid java name */
        public final HttpUrl m74833deprecated_get(@NotNull URL url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        @Nullable
        /* renamed from: -deprecated_get  reason: not valid java name */
        public final HttpUrl m74832deprecated_get(@NotNull URI uri) {
    ...
    public HttpUrl(@NotNull String scheme, @NotNull String username, @NotNull String password, @NotNull String host, int i, @NotNull List<String> pathSegments, @Nullable List<String> list, @Nullable String str, @NotNull String url) {
        ...
        this.fragment = str;
        this.url = url;
        this.isHttps = Intrinsics.areEqual(scheme, UriUtil.HTTPS_SCHEME);
    }
    ...
    public final String m74812deprecated_encodedFragment() {
    ...
    public final String m74813deprecated_encodedPassword() {
    ...
    public final String m74814deprecated_encodedPath() {
        return encodedPath();
    }
    ...
    public final List<String> m74815deprecated_encodedPathSegments() {
    ...
    public final String m74816deprecated_encodedQuery() {
        return encodedQuery();
    }
    ...
    public final String m74817deprecated_encodedUsername() {
    ...
    public final String m74818deprecated_fragment() {
    ...
    public final String m74819deprecated_host() {
        return this.host;
    }
    ...
    public final String m74820deprecated_password() {
    ...
    public final List<String> m74821deprecated_pathSegments() {
    ...
    public final int m74822deprecated_pathSize() {
        return pathSize();
    }
    ...
    public final int m74823deprecated_port() {
        return this.port;
    }
    ...
    public final String m74824deprecated_query() {
        return query();
    }
    ...
    public final Set<String> m74825deprecated_queryParameterNames() {
    ...
    public final int m74826deprecated_querySize() {
        return querySize();
    }
    ...
    public final String m74827deprecated_scheme() {
        return this.scheme;
    }
    ...
    public final URI m74828deprecated_uri() {
        return uri();
    }
    ...
    public final URL m74829deprecated_url() {
        return url();
    }
    ...
    public final String m74830deprecated_username() {
    ...
    public final String encodedPassword() {
        ...
        String substring = this.url.substring(StringsKt__StringsKt.indexOf$default((CharSequence) this.url, ':', this.scheme.length() + 3, false, 4, (Object) null) + 1, indexOf$default);
        Intrinsics.checkNotNullExpressionValue(substring, "this as java.lang.String…ing(startIndex, endIndex)");
        return substring;
    }
    ...
    public final Set<String> queryParameterNames() {
        ...
        IntProgression step = AbstractC11719c.step(AbstractC11719c.until(0, this.queryNamesAndValues.size()), 2);
        int first = step.getFirst();
        int last = step.getLast();
        int step2 = step.getStep();
        if ((step2 > 0 && first <= last) || (step2 < 0 && last <= first)) {
