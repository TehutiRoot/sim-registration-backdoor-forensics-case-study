...
public class FormatUtils {
    ...
    /* renamed from: a */
    public static final double f76226a = Math.log(10.0d);

    /* renamed from: a */
    public static String m23981a(String str, int i) {
        String concat;
        int i2 = i + 32;
        if (str.length() <= i + 35) {
            concat = str;
    ...
    /* renamed from: b */
    public static int m23980b(CharSequence charSequence, int i) {
    ...
    public static int calculateDigitCount(long j) {
        if (j < 0) {
            ...
            return 1 + ((int) (Math.log(j) / f76226a));
        }
    }
    ...
    public static void writePaddedInteger(Writer writer, int i, int i2) throws IOException {
        ...
        if (i < 10) {
            ...
            if (i < 1000) {
                ...
                log = i < 10000 ? 4 : ((int) (Math.log(i) / f76226a)) + 1;
            }
            while (i2 > log) {
                writer.write(48);
                i2--;
    ...
    public static void writePaddedInteger(Writer writer, long j, int i) throws IOException {
        ...
        if (i2 == j) {
            ...
            int log = ((int) (Math.log(j) / f76226a)) + 1;
            while (i > log) {
                writer.write(48);
                i--;
            }
