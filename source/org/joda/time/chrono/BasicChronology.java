...
public abstract class BasicChronology extends AssembledChronology {
    ...
    public static class C12977a extends PreciseDateTimeField {
        ...
        public String getAsText(int i, Locale locale) {
            return B50.m69014h(locale).m69006p(i);
        }

        @Override // org.joda.time.field.BaseDateTimeField, org.joda.time.DateTimeField
        public int getMaximumTextLength(Locale locale) {
            return B50.m69014h(locale).m69010l();
        }

        @Override // org.joda.time.field.BaseDateTimeField, org.joda.time.DateTimeField
        public long set(long j, String str, Locale locale) {
            return set(j, B50.m69014h(locale).m69007o(str));
        }
    }
    ...
    private C12978b getYearInfo(int i) {
        ...
        if (c12978b == null || c12978b.f76098a != i) {
