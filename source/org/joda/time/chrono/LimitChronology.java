...
public final class LimitChronology extends AssembledChronology {
    ...
    /* loaded from: classes5.dex */
    public class C12981a extends DecoratedDateTimeField {

        /* renamed from: c */
        public final DurationField f76112c;

        /* renamed from: d */
        public final DurationField f76113d;

        /* renamed from: e */
        public final DurationField f76114e;

        public C12981a(DateTimeField dateTimeField, DurationField durationField, DurationField durationField2, DurationField durationField3) {
            super(dateTimeField, dateTimeField.getType());
            this.f76112c = durationField;
            this.f76113d = durationField2;
            this.f76114e = durationField3;
        }
    ...
    private DateTimeField convertField(DateTimeField dateTimeField, HashMap<Object, Object> hashMap) {
        ...
        C12981a c12981a = new C12981a(dateTimeField, convertField(dateTimeField.getDurationField(), hashMap), convertField(dateTimeField.getRangeDurationField(), hashMap), convertField(dateTimeField.getLeapDurationField(), hashMap));
        hashMap.put(dateTimeField, c12981a);
        return c12981a;
    }
}
