...
public abstract class AssembledChronology extends BaseChronology {
    ...
    public static final class Fields {
        ...
        /* renamed from: a */
        public static boolean m24052a(DateTimeField dateTimeField) {
        ...
        /* renamed from: b */
        public static boolean m24051b(DurationField durationField) {
    ...
    private void setFields() {
        ...
        int i3 = 0;
        if (chronology2 != null) {
            if (this.iHourOfDay == chronology2.hourOfDay() && this.iMinuteOfHour == this.iBase.minuteOfHour() && this.iSecondOfMinute == this.iBase.secondOfMinute() && this.iMillisOfSecond == this.iBase.millisOfSecond()) {
                i = 1;
            } else {
                i = 0;
            }
