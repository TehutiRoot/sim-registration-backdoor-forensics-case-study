...
public final class C12992j extends DecoratedDateTimeField {

    /* renamed from: c */
    public final BasicChronology f76132c;

    public C12992j(DateTimeField dateTimeField, BasicChronology basicChronology) {
        super(dateTimeField, DateTimeFieldType.yearOfEra());
        this.f76132c = basicChronology;
    }
