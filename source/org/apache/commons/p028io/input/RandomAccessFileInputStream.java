...
public class RandomAccessFileInputStream extends AbstractInputStream {
    ...
    /* renamed from: c */
    public final RandomAccessFile f73409c;
    ...
    public static class Builder extends AbstractStreamBuilder<RandomAccessFileInputStream, Builder> {
        ...
        public RandomAccessFileInputStream get() throws IOException {
            return new RandomAccessFileInputStream(getRandomAccessFile(), this.f73410k);
        }
    ...
    public long availableLong() throws IOException {
        ...
        return this.f73409c.length() - this.f73409c.getFilePointer();
    }
    ...
    public long skip(long j) throws IOException {
        ...
        long filePointer = this.f73409c.getFilePointer();
        long length = this.f73409c.length();
        ...
        if (j2 > 0) {
            this.f73409c.seek(j2);
        }
        return this.f73409c.getFilePointer() - filePointer;
    }
    ...
    public RandomAccessFileInputStream(RandomAccessFile randomAccessFile, boolean z) {
        ...
        this.f73409c = randomAccessFile;
        this.f73408b = z;
    }

    @Override // java.io.InputStream
    public int read(byte[] bArr) throws IOException {
        return this.f73409c.read(bArr);
    }

    @Override // java.io.InputStream
    public int read(byte[] bArr, int i, int i2) throws IOException {
        return this.f73409c.read(bArr, i, i2);
    }
}
