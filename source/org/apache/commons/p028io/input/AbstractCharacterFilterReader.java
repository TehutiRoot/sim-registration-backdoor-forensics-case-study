...
public abstract class AbstractCharacterFilterReader extends FilterReader {
    protected static final IntPredicate SKIP_NONE = new IntPredicate() { // from class: A
        ...
        public final boolean test(int i) {
            return AbstractCharacterFilterReader.m25162b(i);
        }
    };

    /* renamed from: a */
    public final IntPredicate f73323a;
    ...
    /* renamed from: b */
    public static /* synthetic */ boolean m25162b(int i) {
        return m25161d(i);
    }

    /* renamed from: d */
    public static /* synthetic */ boolean m25161d(int i) {
        return false;
    }

    public boolean filter(int i) {
        boolean test;
        test = this.f73323a.test(i);
        return test;
    }
    ...
    public AbstractCharacterFilterReader(Reader reader, IntPredicate intPredicate) {
        super(reader);
        this.f73323a = intPredicate == null ? SKIP_NONE : intPredicate;
    }
