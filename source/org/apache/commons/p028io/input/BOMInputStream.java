...
public class BOMInputStream extends ProxyInputStream {
    ...
    /* renamed from: l */
    public static final Comparator f73325l;

    /* renamed from: d */
    public final List f73326d;

    /* renamed from: e */
    public ByteOrderMark f73327e;
    ...
    public static class Builder extends ProxyInputStream.AbstractBuilder<BOMInputStream, Builder> {
        ...
        /* renamed from: n */
        public static final ByteOrderMark[] f73334n = {ByteOrderMark.UTF_8};

        /* renamed from: l */
        public ByteOrderMark[] f73335l = f73334n;
        ...
        public Builder setByteOrderMarks(ByteOrderMark... byteOrderMarkArr) {
            ...
            if (byteOrderMarkArr != null) {
                ...
                byteOrderMarkArr2 = f73334n;
            }
            this.f73335l = byteOrderMarkArr2;
            return this;
        }
    ...
    /* renamed from: d */
    public static /* synthetic */ boolean m25159d(BOMInputStream bOMInputStream, ByteOrderMark byteOrderMark) {
        return bOMInputStream.m25157i(byteOrderMark);
    }

    /* renamed from: g */
    public final ByteOrderMark m25158g() {
        Stream stream;
        Stream filter;
        Optional findFirst;
        Object orElse;
        stream = this.f73326d.stream();
        filter = stream.filter(new Predicate() { // from class: U9
            {
                BOMInputStream.this = this;
            }

            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return BOMInputStream.m25159d(BOMInputStream.this, (ByteOrderMark) obj);
            }
        });
    ...
    public ByteOrderMark getBOM() throws IOException {
        if (this.f73330h == null) {
            this.f73329g = 0;
            this.f73330h = new int[((ByteOrderMark) this.f73326d.get(0)).length()];
            int i = 0;
            while (true) {
                int[] iArr = this.f73330h;
                if (i >= iArr.length) {
                    break;
                }
                iArr[i] = ((FilterInputStream) this).in.read();
                afterRead(this.f73330h[i]);
                this.f73329g++;
                if (this.f73330h[i] < 0) {
                    break;
                }
            ...
            ByteOrderMark m25158g = m25158g();
            this.f73327e = m25158g;
            if (m25158g != null && !this.f73331i) {
                if (m25158g.length() < this.f73330h.length) {
                    this.f73328f = this.f73327e.length();
                } else {
                    this.f73329g = 0;
                }
            }
    ...
    public String getBOMCharsetName() throws IOException {
        getBOM();
        ByteOrderMark byteOrderMark = this.f73327e;
    ...
    /* renamed from: i */
    public final boolean m25157i(ByteOrderMark byteOrderMark) {
        for (int i = 0; i < byteOrderMark.length(); i++) {
            if (byteOrderMark.get(i) != this.f73330h[i]) {
                return false;
            }
        }
        return true;
    ...
    public int read() throws IOException {
        m25092b();
        int m25156j = m25156j();
        return m25156j >= 0 ? m25156j : ((FilterInputStream) this).in.read();
    }

    @Override // org.apache.commons.p028io.input.ProxyInputStream, java.io.FilterInputStream, java.io.InputStream
    public synchronized void reset() throws IOException {
        try {
            this.f73328f = this.f73333k;
            if (this.f73332j) {
                this.f73330h = null;
            }
    ...
    public BOMInputStream(Builder builder) {
        super(builder);
        if (IOUtils.length(builder.f73335l) != 0) {
            this.f73331i = builder.f73336m;
            List asList = Arrays.asList(builder.f73335l);
            asList.sort(f73325l);
            this.f73326d = asList;
            return;
        }
    ...
    public boolean hasBOM(ByteOrderMark byteOrderMark) throws IOException {
        if (this.f73326d.contains(byteOrderMark)) {
    ...
    public BOMInputStream(InputStream inputStream) {
        this(inputStream, false, Builder.f73334n);
    }

    @Deprecated
    public BOMInputStream(InputStream inputStream, boolean z) {
        this(inputStream, z, Builder.f73334n);
    }
