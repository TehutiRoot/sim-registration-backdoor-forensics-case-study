...
public abstract class AbstractOrigin<T, B extends AbstractOrigin<T, B>> extends AbstractSupplier<T, B> {
    ...
    public static class ByteArrayOrigin extends AbstractOrigin<byte[], ByteArrayOrigin> {
        ...
        public InputStream getInputStream(OpenOption... openOptionArr) throws IOException {
            return new ByteArrayInputStream((byte[]) this.f73267a);
        }
        ...
        public long size() throws IOException {
            return ((byte[]) this.f73267a).length;
        }
    }
    ...
    public static class CharSequenceOrigin extends AbstractOrigin<CharSequence, CharSequenceOrigin> {
        ...
        @Override // org.apache.commons.p028io.build.AbstractOrigin
        public byte[] getByteArray() {
            return ((CharSequence) this.f73267a).toString().getBytes(Charset.defaultCharset());
        }
        ...
        @Override // org.apache.commons.p028io.build.AbstractOrigin
        public long size() throws IOException {
            return ((CharSequence) this.f73267a).length();
        }
    }
    ...
    public static class FileOrigin extends AbstractOrigin<File, FileOrigin> {
        ...
        public byte[] getByteArray(long j, int i) throws IOException {
            RandomAccessFile create = RandomAccessFileMode.READ_ONLY.create((File) this.f73267a);
            try {
    ...
    public static class InputStreamOrigin extends AbstractOrigin<InputStream, InputStreamOrigin> {
        ...
        public byte[] getByteArray() throws IOException {
            return IOUtils.toByteArray((InputStream) this.f73267a);
        }
    ...
    public static class OutputStreamOrigin extends AbstractOrigin<OutputStream, OutputStreamOrigin> {
        ...
        public Writer getWriter(Charset charset, OpenOption... openOptionArr) throws IOException {
            return new OutputStreamWriter((OutputStream) this.f73267a, charset);
        }
    }
    ...
    public static class PathOrigin extends AbstractOrigin<Path, PathOrigin> {
        ...
        public byte[] getByteArray(final long j, final int i) throws IOException {
            return (byte[]) RandomAccessFileMode.READ_ONLY.apply(AbstractC21393oI0.m25938a(this.f73267a), new IOFunction() { // from class: m0
                ...
                public final Object apply(Object obj) {
                    byte[] read;
                    read = RandomAccessFiles.read((RandomAccessFile) obj, j, i);
                    return read;
                }
        ...
        public File getFile() {
            File file;
            file = AbstractC21393oI0.m25938a(get()).toFile();
            return file;
        }

        @Override // org.apache.commons.p028io.build.AbstractOrigin
        public Path getPath() {
            return AbstractC21393oI0.m25938a(get());
        }
    }
    ...
    public static class ReaderOrigin extends AbstractOrigin<Reader, ReaderOrigin> {
        ...
        @Override // org.apache.commons.p028io.build.AbstractOrigin
        public byte[] getByteArray() throws IOException {
            return IOUtils.toByteArray((Reader) this.f73267a, Charset.defaultCharset());
        }

        @Override // org.apache.commons.p028io.build.AbstractOrigin
        public CharSequence getCharSequence(Charset charset) throws IOException {
            return IOUtils.toString((Reader) this.f73267a);
        }

        @Override // org.apache.commons.p028io.build.AbstractOrigin
        public InputStream getInputStream(OpenOption... openOptionArr) throws IOException {
            return ((ReaderInputStream.Builder) ReaderInputStream.builder().setReader((Reader) this.f73267a)).setCharset(Charset.defaultCharset()).get();
        }
    ...
    public static class WriterOrigin extends AbstractOrigin<Writer, WriterOrigin> {
        ...
        public OutputStream getOutputStream(OpenOption... openOptionArr) throws IOException {
            return ((WriterOutputStream.Builder) WriterOutputStream.builder().setWriter((Writer) this.f73267a)).setCharset(Charset.defaultCharset()).get();
        }
    ...
    /* renamed from: a */
    public final String m25311a() {
        return getClass().getSimpleName();
    }

    @Override // org.apache.commons.p028io.function.IOSupplier
    public T get() {
        return (T) this.f73267a;
    }
    ...
    public File getFile() {
        throw new UnsupportedOperationException(String.format("%s#getFile() for %s origin %s", m25311a(), this.f73267a.getClass().getSimpleName(), this.f73267a));
    }
    ...
    public Path getPath() {
        throw new UnsupportedOperationException(String.format("%s#getPath() for %s origin %s", m25311a(), this.f73267a.getClass().getSimpleName(), this.f73267a));
    }
    ...
    public String toString() {
        return m25311a() + "[" + this.f73267a.toString() + "]";
    }

    public byte[] getByteArray(long j, int i) throws IOException {
        int i2;
        byte[] byteArray = getByteArray();
        int m26572a = AbstractC12188l0.m26572a(j);
        if (m26572a >= 0 && i >= 0 && (i2 = m26572a + i) >= 0 && i2 <= byteArray.length) {
            return Arrays.copyOfRange(byteArray, m26572a, i2);
        }
        throw new IllegalArgumentException("Couldn't read array (start: " + m26572a + ", length: " + i + ", data length: " + byteArray.length + ").");
    }
    ...
    public static abstract class AbstractRandomAccessFileOrigin<T extends RandomAccessFile, B extends AbstractRandomAccessFileOrigin<T, B>> extends AbstractOrigin<T, B> {
        ...
        @Override // org.apache.commons.p028io.build.AbstractOrigin
        public byte[] getByteArray() throws IOException {
            long length = ((RandomAccessFile) this.f73267a).length();
            if (length <= 2147483647L) {
                return RandomAccessFiles.read((RandomAccessFile) this.f73267a, 0L, (int) length);
            }
        ...
        @Override // org.apache.commons.p028io.build.AbstractOrigin
        public InputStream getInputStream(OpenOption... openOptionArr) throws IOException {
            return BufferedFileChannelInputStream.builder().setFileChannel(((RandomAccessFile) this.f73267a).getChannel()).get();
        }

        @Override // org.apache.commons.p028io.build.AbstractOrigin
        public OutputStream getOutputStream(OpenOption... openOptionArr) throws IOException {
            return ((RandomAccessFileOutputStream.Builder) RandomAccessFileOutputStream.builder().setRandomAccessFile((RandomAccessFile) this.f73267a)).get();
        }
        ...
        @Override // org.apache.commons.p028io.build.AbstractOrigin
        public long size() throws IOException {
            return ((RandomAccessFile) this.f73267a).length();
        }

        @Override // org.apache.commons.p028io.build.AbstractOrigin
        public byte[] getByteArray(long j, int i) throws IOException {
            return RandomAccessFiles.read((RandomAccessFile) this.f73267a, j, i);
        }
    }
}
