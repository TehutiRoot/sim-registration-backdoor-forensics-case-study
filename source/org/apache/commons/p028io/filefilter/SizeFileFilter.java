...
public class SizeFileFilter extends AbstractFileFilter implements Serializable {
    ...
    /* renamed from: a */
    public static /* synthetic */ FileVisitResult m25243a(SizeFileFilter sizeFileFilter, Path path) {
    ...
    public FileVisitResult accept(final Path path, BasicFileAttributes basicFileAttributes) {
        return get(new IOSupplier() { // from class: JJ1
            {
                SizeFileFilter.this = this;
            }
            ...
            public final Object get() {
                return SizeFileFilter.m25243a(SizeFileFilter.this, path);
            }
