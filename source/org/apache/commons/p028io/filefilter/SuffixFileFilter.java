...
public class SuffixFileFilter extends AbstractFileFilter implements Serializable {
    ...
    /* renamed from: a */
    public static /* synthetic */ boolean m25242a(SuffixFileFilter suffixFileFilter, String str, String str2) {
    ...
    private boolean accept(final String str) {
        ...
        anyMatch = of.anyMatch(new Predicate() { // from class: TO1
            {
                SuffixFileFilter.this = this;
            }

            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return SuffixFileFilter.m25242a(SuffixFileFilter.this, str, (String) obj);
            }
        });
        return anyMatch;
    }
