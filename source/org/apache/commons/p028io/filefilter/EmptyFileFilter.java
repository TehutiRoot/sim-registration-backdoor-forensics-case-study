...
public class EmptyFileFilter extends AbstractFileFilter implements Serializable {
    ...
    /* renamed from: a */
    public static /* synthetic */ FileVisitResult m25255a(EmptyFileFilter emptyFileFilter, Path path) {
        return emptyFileFilter.lambda$accept$0(path);
    }
    ...
    public FileVisitResult accept(final Path path, BasicFileAttributes basicFileAttributes) {
        ...
        return get(new IOSupplier() { // from class: pR
            {
                EmptyFileFilter.this = this;
            }
            ...
            public final Object get() {
                return EmptyFileFilter.m25255a(EmptyFileFilter.this, path);
            }
