...
public class HiddenFileFilter extends AbstractFileFilter implements Serializable {
    ...
    /* renamed from: a */
    public static /* synthetic */ FileVisitResult m25252a(HiddenFileFilter hiddenFileFilter, Path path) {
    ...
    public FileVisitResult accept(final Path path, BasicFileAttributes basicFileAttributes) {
        return get(new IOSupplier() { // from class: M70
            {
                HiddenFileFilter.this = this;
            }
            ...
            public final Object get() {
                return HiddenFileFilter.m25252a(HiddenFileFilter.this, path);
            }
