...
public class WildcardFileFilter extends AbstractFileFilter implements Serializable {
    ...
    public static class Builder extends AbstractSupplier<WildcardFileFilter, Builder> {
        ...
        /* renamed from: b */
        public IOCase f73319b = IOCase.SENSITIVE;

        public Builder setIoCase(IOCase iOCase) {
            this.f73319b = IOCase.value(iOCase, IOCase.SENSITIVE);
            return this;
        }
        ...
        public WildcardFileFilter get() {
            return new WildcardFileFilter(this.f73319b, this.f73318a);
        }

        public Builder setWildcards(String... strArr) {
            this.f73318a = (String[]) WildcardFileFilter.requireWildcards(strArr);
            return this;
        }
    }

    /* renamed from: a */
    public static /* synthetic */ boolean m25240a(WildcardFileFilter wildcardFileFilter, String str, String str2) {
    ...
    private boolean accept(final String str) {
        ...
        anyMatch = of.anyMatch(new Predicate() { // from class: W32
            {
                WildcardFileFilter.this = this;
            }

            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return WildcardFileFilter.m25240a(WildcardFileFilter.this, str, (String) obj);
            }
        });
        return anyMatch;
    }
