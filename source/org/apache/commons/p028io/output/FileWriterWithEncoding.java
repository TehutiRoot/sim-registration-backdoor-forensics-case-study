...
public class FileWriterWithEncoding extends ProxyWriter {
    ...
    public static class Builder extends AbstractStreamBuilder<FileWriterWithEncoding, Builder> {
        ...
        /* renamed from: l */
        public CharsetEncoder f73564l = super.getCharset().newEncoder();
        ...
        public Builder setCharsetEncoder(CharsetEncoder charsetEncoder) {
            this.f73564l = charsetEncoder;
            return this;
        }

        @Override // org.apache.commons.p028io.function.IOSupplier
        public FileWriterWithEncoding get() throws IOException {
            if (this.f73564l != null && getCharset() != null && !this.f73564l.charset().equals(getCharset())) {
                throw new IllegalStateException(String.format("Mismatched Charset(%s) and CharsetEncoder(%s)", getCharset(), this.f73564l.charset()));
            }
            Object obj = this.f73564l;
            if (obj == null) {
                obj = getCharset();
            }
            return new FileWriterWithEncoding(FileWriterWithEncoding.m24936d(checkOrigin().getFile(), obj, this.f73563k));
        }
    }
    ...
    */
    public static java.io.OutputStreamWriter m24936d(java.io.File r2, java.lang.Object r3, boolean r4) {
        /*
        ...
        L46:
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.commons.p028io.output.FileWriterWithEncoding.m24936d(java.io.File, java.lang.Object, boolean):java.io.OutputStreamWriter");
    }
    ...
    public FileWriterWithEncoding(File file, CharsetEncoder charsetEncoder, boolean z) throws IOException {
        this(m24936d(file, charsetEncoder, z));
    }
