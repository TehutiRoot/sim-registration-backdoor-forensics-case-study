...
public class EndianUtils {
    /* renamed from: a */
    public static int m25428a(InputStream inputStream) {
    ...
    /* renamed from: b */
    public static void m25427b(byte[] bArr, int i, int i2) {
        int i3 = i + i2;
        if (bArr.length >= i3) {
            return;
        }
    ...
    public static int readSwappedInteger(InputStream inputStream) throws IOException {
        return (m25428a(inputStream) & 255) + ((m25428a(inputStream) & 255) << 8) + ((m25428a(inputStream) & 255) << 16) + ((m25428a(inputStream) & 255) << 24);
    }

    public static short readSwappedShort(InputStream inputStream) throws IOException {
        return (short) ((m25428a(inputStream) & 255) + ((m25428a(inputStream) & 255) << 8));
    }

    public static int readSwappedUnsignedShort(InputStream inputStream) throws IOException {
        return (m25428a(inputStream) & 255) + ((m25428a(inputStream) & 255) << 8);
    }

    public static long readSwappedLong(InputStream inputStream) throws IOException {
        byte[] bArr = new byte[8];
        for (int i = 0; i < 8; i++) {
            bArr[i] = (byte) m25428a(inputStream);
        }
        return readSwappedLong(bArr, 0);
    }

    public static long readSwappedUnsignedInteger(InputStream inputStream) throws IOException {
        return ((m25428a(inputStream) & 255) << 24) + (((m25428a(inputStream) & 255) + ((m25428a(inputStream) & 255) << 8) + ((m25428a(inputStream) & 255) << 16)) & BodyPartID.bodyIdMax);
    }
