...
public class CompositeFileComparator extends AbstractC0495H implements Serializable {
    ...
    /* renamed from: a */
    public static /* synthetic */ boolean m25301a(Integer num) {
        return lambda$compare$2(num);
    }

    /* renamed from: b */
    public static /* synthetic */ Comparator[] m25300b(int i) {
        return lambda$new$0(i);
    }

    /* renamed from: c */
    public static /* synthetic */ Integer m25299c(File file, File file2, Comparator comparator) {
    ...
    public int compare(final File file, final File file2) {
        ...
        map = of.map(new Function() { // from class: sv
            ...
            public final Object apply(Object obj) {
                return CompositeFileComparator.m25299c(file, file2, (Comparator) obj);
            }
        });
        filter = map.filter(new Predicate() { // from class: tv
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return CompositeFileComparator.m25301a((Integer) obj);
            }
        });
        ...
        if (iterable != null) {
            ...
            array = stream.toArray(new IntFunction() { // from class: rv
                ...
                public final Object apply(int i) {
                    return CompositeFileComparator.m25300b(i);
                }
            });
