...
public class DeletingPathVisitor extends CountingPathVisitor {
    ...
    /* renamed from: f */
    public final String[] f73296f;

    /* renamed from: g */
    public final boolean f73297g;

    /* renamed from: h */
    public final LinkOption[] f73298h;
    ...
    /* renamed from: e */
    private boolean m25292e(Path path) {
        if (Arrays.binarySearch(this.f73296f, PathUtils.getFileNameString(path)) < 0) {
            return true;
        }
        return false;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f73297g == deletingPathVisitor.f73297g && Arrays.equals(this.f73296f, deletingPathVisitor.f73296f)) {
            return true;
        }
        return false;
    }
    ...
    @Override // org.apache.commons.p028io.file.CountingPathVisitor
    public int hashCode() {
        return (((super.hashCode() * 31) + Arrays.hashCode(this.f73296f)) * 31) + Objects.hash(Boolean.valueOf(this.f73297g));
    }
    ...
    public DeletingPathVisitor(Counters.PathCounters pathCounters, LinkOption[] linkOptionArr, DeleteOption[] deleteOptionArr, String... strArr) {
        ...
        Arrays.sort(strArr2);
        this.f73296f = strArr2;
        this.f73297g = StandardDeleteOption.overrideReadOnly(deleteOptionArr);
        this.f73298h = linkOptionArr == null ? PathUtils.noFollowLinkOptionArray() : (LinkOption[]) linkOptionArr.clone();
    }
    ...
    public FileVisitResult visitFile2(Path path, BasicFileAttributes basicFileAttributes) throws IOException {
        ...
        if (m25292e(path)) {
            exists = Files.exists(path, this.f73298h);
            if (exists) {
                if (this.f73297g) {
                    PathUtils.setReadOnly(path, false, this.f73298h);
                }
                Files.deleteIfExists(path);
            }
