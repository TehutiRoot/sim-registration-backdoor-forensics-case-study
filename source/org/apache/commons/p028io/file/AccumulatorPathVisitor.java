...
public class AccumulatorPathVisitor extends CountingPathVisitor {
    ...
    /* renamed from: f */
    public final List f73278f;

    /* renamed from: g */
    public final List f73279g;

    public AccumulatorPathVisitor() {
        super(Counters.noopPathCounters());
        this.f73278f = new ArrayList();
        this.f73279g = new ArrayList();
    }
    ...
    /* renamed from: e */
    public final void m25298e(List list, Path path) {
        Path normalize;
    ...
    public boolean equals(Object obj) {
        ...
        if (Objects.equals(this.f73278f, accumulatorPathVisitor.f73278f) && Objects.equals(this.f73279g, accumulatorPathVisitor.f73279g)) {
            return true;
        }
        return false;
    }
