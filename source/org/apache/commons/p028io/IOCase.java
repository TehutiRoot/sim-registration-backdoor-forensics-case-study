...
public enum IOCase {
    ...
    /* renamed from: a */
    public static /* synthetic */ boolean m25337a(String str, IOCase iOCase) {
        return lambda$forName$0(str, iOCase);
    }

    /* renamed from: b */
    public static /* synthetic */ IllegalArgumentException m25336b(String str) {
    ...
    public static IOCase forName(final String str) {
        ...
        filter = of.filter(new Predicate() { // from class: I90
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return IOCase.m25337a(str, (IOCase) obj);
            }
        });
        findFirst = filter.findFirst();
        orElseThrow = findFirst.orElseThrow(new Supplier() { // from class: J90
            @Override // java.util.function.Supplier
            public final Object get() {
                return IOCase.m25336b(str);
            }
        });
