...
/* renamed from: org.apache.commons.io.FileSystem */
...
public enum FileSystem {
    ...
    FileSystem(int i, boolean z, boolean z2, int i2, int i3, int[] iArr, String[] strArr, boolean z3, boolean z4, char c) {
        ...
        this.nameSeparatorOther = FilenameUtils.m25351d(c);
    }

    /* renamed from: a */
    public static /* synthetic */ int m25423a(FileSystem fileSystem, char c, int i) {
        return fileSystem.lambda$toLegalFileName$0(c, i);
    }

    /* renamed from: b */
    public static /* synthetic */ boolean m25422b(FileSystem fileSystem, int i) {
        return fileSystem.isIllegalFileNameChar(i);
    }
    ...
    public boolean isIllegalFileNameChar(int i) {
        if (Arrays.binarySearch(this.illegalFileNameChars, i) >= 0) {
            return true;
        }
        return false;
    }
    ...
    public boolean isLegalFileName(CharSequence charSequence) {
        ...
        noneMatch = chars.noneMatch(new IntPredicate() { // from class: rX
            {
                FileSystem.this = this;
            }

            @Override // java.util.function.IntPredicate
            public final boolean test(int i) {
                return FileSystem.m25422b(FileSystem.this, i);
            }
        });
        return noneMatch;
    }
    ...
    public String toLegalFileName(String str, final char c) {
        ...
        if (isIllegalFileNameChar(c)) {
            ...
            throw new IllegalArgumentException(String.format("The replacement character '%s' cannot be one of the %s illegal characters: %s", valueOf, name(), Arrays.toString(this.illegalFileNameChars)));
        }
        ...
        chars = str.chars();
        map = chars.map(new IntUnaryOperator() { // from class: qX
            {
                FileSystem.this = this;
            }
            ...
            public final int applyAsInt(int i2) {
                return FileSystem.m25423a(FileSystem.this, c, i2);
            }
        });
        array = map.toArray();
    ...
    public CharSequence trimExtension(CharSequence charSequence) {
        int indexOf = indexOf(charSequence, 46, 0);
        if (indexOf >= 0) {
