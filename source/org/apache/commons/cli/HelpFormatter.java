...
public class HelpFormatter {
    ...
    /* renamed from: a */
    public final Function f72972a;

    /* renamed from: b */
    public final PrintWriter f72973b;

    /* renamed from: c */
    public final boolean f72974c;
    ...
    public static class Builder implements Supplier<HelpFormatter> {
        ...
        /* renamed from: d */
        public static final Function f72976d = new Function() { // from class: L70
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return HelpFormatter.Builder.m25715a((Option) obj);
            }
        };

        /* renamed from: a */
        public Function f72977a = f72976d;

        /* renamed from: b */
        public PrintWriter f72978b = HelpFormatter.m25719g();

        /* renamed from: c */
        public boolean f72979c;

        /* renamed from: a */
        public static /* synthetic */ String m25715a(Option option) {
            return m25714b(option);
        }

        /* renamed from: b */
        public static /* synthetic */ String m25714b(Option option) {
        ...
        public Builder setPrintWriter(PrintWriter printWriter) {
            ...
            this.f72978b = printWriter;
            return this;
        }

        public Builder setShowDeprecated(boolean z) {
            return setShowDeprecated(z ? f72976d : null);
        }
        ...
        public HelpFormatter get() {
            return new HelpFormatter(this.f72977a, this.f72978b, this.f72979c);
        }

        public Builder setShowDeprecated(Function<Option, String> function) {
            this.f72977a = function;
            return this;
        }
    }
    ...
    /* renamed from: a */
    public static /* synthetic */ Integer m25725a(int i, Option option) {
        return m25717i(i, option);
    }
    ...
    /* renamed from: g */
    public static PrintWriter m25719g() {
    ...
    /* renamed from: i */
    public static /* synthetic */ Integer m25717i(int i, Option option) {
    ...
    /* renamed from: c */
    public final void m25723c(StringBuilder sb, Option option, boolean z) {
        String str;
        String argName;
        if (!z) {
            sb.append("[");
    ...
    /* renamed from: d */
    public final void m25722d(StringBuilder sb, OptionGroup optionGroup) {
        ...
        while (it.hasNext()) {
            m25723c(sb, (Option) it.next(), true);
            if (it.hasNext()) {
                sb.append(" | ");
            }
        }
    ...
    /* renamed from: e */
    public Appendable m25721e(Appendable appendable, int i, Options options, int i2, int i3) {
        int i4;
        Object apply;
        String since;
        String str;
        ...
        if (this.f72974c) {
            ...
            m25720f(appendable, i, i6, sb2.toString());
        ...
        while (it.hasNext()) {
            ...
            if (this.f72972a != null && next.isDeprecated()) {
                apply = this.f72972a.apply(next);
                sb3.append(((String) apply).trim());
            } else if (next.getDescription() != null) {
                sb3.append(next.getDescription());
            }
            m25720f(appendable, i, i6, sb3.toString());
            if (it.hasNext()) {
                appendable.append(getNewLine());
            }
            i7 = i8;
    ...
    /* renamed from: f */
    public Appendable m25720f(Appendable appendable, int i, int i2, String str) {
    ...
    */
    ...
    /* renamed from: h */
    public final int m25718h(Options options) {
        Stream stream;
        Stream map;
        Optional max;
        Object orElse;
        stream = options.getOptions().stream();
        map = stream.map(new Function() { // from class: J70
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return HelpFormatter.m25725a(r1, (Option) obj);
            }
        });
        max = map.max(new Comparator() { // from class: K70
            @Override // java.util.Comparator
    ...
    /* renamed from: j */
    public final Appendable m25716j(Appendable appendable, int i, int i2, String str) {
        try {
            ...
            while (true) {
                ...
                m25720f(appendable, i, i2, readLine);
            }
    ...
    public void printOptions(PrintWriter printWriter, int i, Options options, int i2, int i3) {
        try {
            printWriter.println(m25721e(new StringBuilder(), i, options, i2, i3));
        } catch (IOException e) {
            throw I70.m67995a(e);
        }
    }
    ...
    public void printWrapped(PrintWriter printWriter, int i, int i2, String str) {
        printWriter.println(m25716j(new StringBuilder(str.length()), i, i2, str));
    }

    public StringBuffer renderOptions(StringBuffer stringBuffer, int i, Options options, int i2, int i3) {
        try {
            return (StringBuffer) m25721e(stringBuffer, i, options, i2, i3);
        } catch (IOException e) {
            throw I70.m67995a(e);
        }
    }
    ...
    public StringBuffer renderWrappedText(StringBuffer stringBuffer, int i, int i2, String str) {
        try {
            return (StringBuffer) m25720f(stringBuffer, i, i2, str);
        } catch (IOException e) {
            throw I70.m67995a(e);
        }
    }
    ...
    public HelpFormatter(Function function, PrintWriter printWriter, boolean z) {
        ...
        this.f72975d = DEFAULT_LONG_OPT_SEPARATOR;
        this.f72972a = function;
        this.f72973b = printWriter;
        this.f72974c = z;
    }
        ...
        while (it.hasNext()) {
            ...
            if (optionGroup != null) {
                if (!arrayList.contains(optionGroup)) {
                    ...
                    m25722d(sb, optionGroup);
                }
            } else {
                m25723c(sb, option, option.isRequired());
            }
            if (it.hasNext()) {
                sb.append(TokenParser.f74560SP);
            }
