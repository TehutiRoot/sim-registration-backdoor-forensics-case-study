...
public class URLCodec implements BinaryEncoder, BinaryDecoder, StringEncoder, StringDecoder {
    ...
    /* renamed from: a */
    public static final BitSet f73227a = new BitSet(256);
    @Deprecated
        ...
        while (i < bArr.length) {
            ...
            if (b == 43) {
                ...
                try {
                    ...
                    i += 2;
                    byteArrayOutputStream.write((char) ((m68132a << 4) + H02.m68132a(bArr[i])));
    ...
    public static final byte[] encodeUrl(BitSet bitSet, byte[] bArr) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (bitSet.get(i2)) {
                ...
                char m68131b = H02.m68131b(i2 >> 4);
                char m68131b2 = H02.m68131b(i2);
