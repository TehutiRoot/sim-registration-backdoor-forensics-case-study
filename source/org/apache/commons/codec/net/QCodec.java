...
public class QCodec extends AbstractC22173sr1 implements StringEncoder, StringDecoder {

    /* renamed from: b */
    public static final BitSet f73222b;

    /* renamed from: a */
    public boolean f73223a;
    ...
    public byte[] doEncoding(byte[] bArr) {
        ...
        byte[] encodeQuotedPrintable = QuotedPrintableCodec.encodeQuotedPrintable(f73222b, bArr);
        if (this.f73223a) {
