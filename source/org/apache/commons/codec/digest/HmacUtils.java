...
public final class HmacUtils {
    ...
    public byte[] hmac(ByteBuffer byteBuffer) {
        this.f73091a.update(byteBuffer);
        return this.f73091a.doFinal();
    }
    ...
    public byte[] hmac(InputStream inputStream) throws IOException {
        ...
        while (true) {
            int read = inputStream.read(bArr, 0, 1024);
            if (read > -1) {
                this.f73091a.update(bArr, 0, read);
            } else {
                return this.f73091a.doFinal();
            }
        }
    ...
    public byte[] hmac(String str) {
        return this.f73091a.doFinal(StringUtils.getBytesUtf8(str));
    }
}
