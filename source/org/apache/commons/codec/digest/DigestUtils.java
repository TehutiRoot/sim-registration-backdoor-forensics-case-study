...
public class DigestUtils {
    ...
    /* renamed from: a */
    public final MessageDigest f73090a;
    ...
    /* renamed from: a */
    public static MessageDigest m25608a(String str) {
        return MessageDigest.getInstance(str);
    }

    /* renamed from: b */
    public static MessageDigest m25607b(MessageDigest messageDigest, FileChannel fileChannel) {
    ...
    public byte[] digest(byte[] bArr) {
        return updateDigest(this.f73090a, bArr).digest();
    }

    public byte[] digest(ByteBuffer byteBuffer) {
        return updateDigest(this.f73090a, byteBuffer).digest();
    }

    public byte[] digest(File file) throws IOException {
        return updateDigest(this.f73090a, file).digest();
    }
    ...
    public byte[] digest(InputStream inputStream) throws IOException {
        return updateDigest(this.f73090a, inputStream).digest();
    }

    public byte[] digest(Path path, OpenOption... openOptionArr) throws IOException {
        return updateDigest(this.f73090a, path, openOptionArr).digest();
    }

    public byte[] digest(String str) {
        return updateDigest(this.f73090a, str).digest();
    }
    ...
    public static MessageDigest updateDigest(MessageDigest messageDigest, RandomAccessFile randomAccessFile) throws IOException {
        return m25607b(messageDigest, randomAccessFile.getChannel());
    }
