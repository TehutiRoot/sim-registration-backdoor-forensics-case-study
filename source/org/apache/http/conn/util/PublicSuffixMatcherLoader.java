...
public final class PublicSuffixMatcherLoader {
    ...
    /* renamed from: a */
    public static volatile PublicSuffixMatcher f73860a;

    /* renamed from: a */
    public static PublicSuffixMatcher m24772a(InputStream inputStream) {
            ...
            synchronized (PublicSuffixMatcherLoader.class) {
                if (f73860a == null) {
                    ...
                    if (resource != null) {
                        ...
                        f73860a = new PublicSuffixMatcher(DomainType.ICANN, Arrays.asList("com"), null);
                    }
                }
            }
        }
    ...
    public static PublicSuffixMatcher load(File file) throws IOException {
        ...
        try {
            return m24772a(fileInputStream);
        } finally {
