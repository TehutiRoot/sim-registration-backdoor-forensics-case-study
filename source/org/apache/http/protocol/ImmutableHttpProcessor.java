...
public final class ImmutableHttpProcessor implements HttpProcessor {
    ...
    /* renamed from: a */
    public final HttpRequestInterceptor[] f74619a;

    /* renamed from: b */
    public final HttpResponseInterceptor[] f74620b;
    ...
    public ImmutableHttpProcessor(HttpRequestInterceptor[] httpRequestInterceptorArr, HttpResponseInterceptor[] httpResponseInterceptorArr) {
        if (httpRequestInterceptorArr != null) {
            ...
            this.f74619a = httpRequestInterceptorArr2;
            System.arraycopy(httpRequestInterceptorArr, 0, httpRequestInterceptorArr2, 0, length);
        } else {
            this.f74619a = new HttpRequestInterceptor[0];
        }
        if (httpResponseInterceptorArr != null) {
            ...
            this.f74620b = httpResponseInterceptorArr2;
            System.arraycopy(httpResponseInterceptorArr, 0, httpResponseInterceptorArr2, 0, length2);
            return;
        }
        this.f74620b = new HttpResponseInterceptor[0];
    }

    @Override // org.apache.http.HttpRequestInterceptor
    public void process(HttpRequest httpRequest, HttpContext httpContext) throws IOException, HttpException {
        for (HttpRequestInterceptor httpRequestInterceptor : this.f74619a) {
    ...
    public void process(HttpResponse httpResponse, HttpContext httpContext) throws IOException, HttpException {
        for (HttpResponseInterceptor httpResponseInterceptor : this.f74620b) {
    ...
    public ImmutableHttpProcessor(List<HttpRequestInterceptor> list, List<HttpResponseInterceptor> list2) {
        if (list != null) {
            this.f74619a = (HttpRequestInterceptor[]) list.toArray(new HttpRequestInterceptor[list.size()]);
        } else {
            this.f74619a = new HttpRequestInterceptor[0];
        }
        if (list2 != null) {
            this.f74620b = (HttpResponseInterceptor[]) list2.toArray(new HttpResponseInterceptor[list2.size()]);
        } else {
            this.f74620b = new HttpResponseInterceptor[0];
        }
    }
    ...
    public ImmutableHttpProcessor(HttpRequestInterceptorList httpRequestInterceptorList, HttpResponseInterceptorList httpResponseInterceptorList) {
        if (httpRequestInterceptorList != null) {
            ...
            this.f74619a = new HttpRequestInterceptor[requestInterceptorCount];
            for (int i = 0; i < requestInterceptorCount; i++) {
                this.f74619a[i] = httpRequestInterceptorList.getRequestInterceptor(i);
            }
        } else {
            this.f74619a = new HttpRequestInterceptor[0];
        }
        if (httpResponseInterceptorList != null) {
            ...
            this.f74620b = new HttpResponseInterceptor[responseInterceptorCount];
            for (int i2 = 0; i2 < responseInterceptorCount; i2++) {
                this.f74620b[i2] = httpResponseInterceptorList.getResponseInterceptor(i2);
            }
            return;
        }
        this.f74620b = new HttpResponseInterceptor[0];
