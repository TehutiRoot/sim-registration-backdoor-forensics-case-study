...
public class UriPatternMatcher<T> {
    ...
    /* renamed from: a */
    public final Map f74629a = new LinkedHashMap();

    public synchronized Set<Map.Entry<String, T>> entrySet() {
        return new HashSet(this.f74629a.entrySet());
    }
    ...
    public synchronized T lookup(String str) {
        ...
        try {
            ...
            t = (T) this.f74629a.get(str);
            if (t == null) {
                String str2 = null;
                for (String str3 : this.f74629a.keySet()) {
