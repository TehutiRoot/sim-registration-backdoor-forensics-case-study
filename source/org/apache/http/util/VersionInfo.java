...
public class VersionInfo {
    ...
    /* renamed from: e */
    public final String f74649e;

    public VersionInfo(String str, String str2, String str3, String str4, String str5) {
        Args.notNull(str, "Package identifier");
        this.f74645a = str;
        this.f74646b = str2 == null ? UNAVAILABLE : str2;
        this.f74647c = str3 == null ? UNAVAILABLE : str3;
        this.f74648d = str4 == null ? UNAVAILABLE : str4;
        this.f74649e = str5 == null ? UNAVAILABLE : str5;
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder(this.f74645a.length() + 20 + this.f74646b.length() + this.f74647c.length() + this.f74648d.length() + this.f74649e.length());
        sb.append("VersionInfo(");
        sb.append(this.f74645a);
        sb.append(':');
        sb.append(this.f74646b);
        if (!UNAVAILABLE.equals(this.f74647c)) {
            sb.append(':');
            sb.append(this.f74647c);
        }
        if (!UNAVAILABLE.equals(this.f74648d)) {
            sb.append(':');
            sb.append(this.f74648d);
        }
        sb.append(CoreConstants.RIGHT_PARENTHESIS_CHAR);
        if (!UNAVAILABLE.equals(this.f74649e)) {
            sb.append('@');
            sb.append(this.f74649e);
        }
        return sb.toString();
    }
