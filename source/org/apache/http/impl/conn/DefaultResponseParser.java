...
public class DefaultResponseParser extends AbstractMessageParser<HttpMessage> {
    ...
    /* renamed from: f */
    public final Log f74249f;

    /* renamed from: g */
    public final HttpResponseFactory f74250g;

    /* renamed from: h */
    public final CharArrayBuffer f74251h;

    /* renamed from: i */
    public final int f74252i;

    public DefaultResponseParser(SessionInputBuffer sessionInputBuffer, LineParser lineParser, HttpResponseFactory httpResponseFactory, HttpParams httpParams) {
        super(sessionInputBuffer, lineParser, httpParams);
        this.f74249f = LogFactory.getLog(getClass());
        Args.notNull(httpResponseFactory, "Response factory");
        this.f74250g = httpResponseFactory;
        this.f74251h = new CharArrayBuffer(128);
        this.f74252i = getMaxGarbageLines(httpParams);
    }
    ...
    */
    public org.apache.http.HttpMessage parseHead(org.apache.http.p030io.SessionInputBuffer r8) throws java.io.IOException, org.apache.http.HttpException {
        /*
            ...
            r1 = 0
        L2:
            org.apache.http.util.CharArrayBuffer r2 = r7.f74251h
            r2.clear()
            org.apache.http.util.CharArrayBuffer r2 = r7.f74251h
        ...
        L1b:
            ...
            org.apache.http.util.CharArrayBuffer r5 = r7.f74251h
            int r5 = r5.length()
            r4.<init>(r0, r5)
            org.apache.http.message.LineParser r5 = r7.lineParser
            org.apache.http.util.CharArrayBuffer r6 = r7.f74251h
            boolean r5 = r5.hasProtocolVersion(r6, r4)
            if (r5 == 0) goto L40
            org.apache.http.message.LineParser r8 = r7.lineParser
            org.apache.http.util.CharArrayBuffer r0 = r7.f74251h
            org.apache.http.StatusLine r8 = r8.parseStatusLine(r0, r4)
            org.apache.http.HttpResponseFactory r0 = r7.f74250g
            r1 = 0
        ...
        L40:
            ...
            int r2 = r7.f74252i
            if (r1 >= r2) goto L6d
            org.apache.commons.logging.Log r2 = r7.f74249f
            ...
            r3.append(r4)
            org.apache.http.util.CharArrayBuffer r4 = r7.f74251h
