...
import org.apache.http.impl.p029io.AbstractMessageParser;
...
public class DefaultHttpResponseParser extends AbstractMessageParser<HttpResponse> {
    ...
    /* renamed from: f */
    public final Log f74240f;

    /* renamed from: g */
    public final HttpResponseFactory f74241g;

    /* renamed from: h */
    public final CharArrayBuffer f74242h;

    @Deprecated
    public DefaultHttpResponseParser(SessionInputBuffer sessionInputBuffer, LineParser lineParser, HttpResponseFactory httpResponseFactory, HttpParams httpParams) {
        super(sessionInputBuffer, lineParser, httpParams);
        this.f74240f = LogFactory.getLog(getClass());
        Args.notNull(httpResponseFactory, "Response factory");
        this.f74241g = httpResponseFactory;
        this.f74242h = new CharArrayBuffer(128);
    }
    ...
    */
    public org.apache.http.HttpResponse parseHead(org.apache.http.p030io.SessionInputBuffer r8) throws java.io.IOException, org.apache.http.HttpException {
        /*
            r7 = this;
            r0 = 0
            r1 = 0
        L2:
            org.apache.http.util.CharArrayBuffer r2 = r7.f74242h
            r2.clear()
            org.apache.http.util.CharArrayBuffer r2 = r7.f74242h
        ...
        L1b:
            ...
            org.apache.http.util.CharArrayBuffer r5 = r7.f74242h
            int r5 = r5.length()
            r4.<init>(r0, r5)
            org.apache.http.message.LineParser r5 = r7.lineParser
            org.apache.http.util.CharArrayBuffer r6 = r7.f74242h
            boolean r5 = r5.hasProtocolVersion(r6, r4)
            if (r5 == 0) goto L40
            org.apache.http.message.LineParser r8 = r7.lineParser
            org.apache.http.util.CharArrayBuffer r0 = r7.f74242h
            org.apache.http.StatusLine r8 = r8.parseStatusLine(r0, r4)
            org.apache.http.HttpResponseFactory r0 = r7.f74241g
            r1 = 0
        ...
        L40:
            ...
            if (r2 != 0) goto L71
            org.apache.commons.logging.Log r2 = r7.f74240f
            ...
            r3.append(r4)
            org.apache.http.util.CharArrayBuffer r4 = r7.f74242h
    ...
    public DefaultHttpResponseParser(SessionInputBuffer sessionInputBuffer, LineParser lineParser, HttpResponseFactory httpResponseFactory, MessageConstraints messageConstraints) {
        ...
        this.f74240f = LogFactory.getLog(getClass());
        this.f74241g = httpResponseFactory == null ? DefaultHttpResponseFactory.INSTANCE : httpResponseFactory;
        this.f74242h = new CharArrayBuffer(128);
    }
