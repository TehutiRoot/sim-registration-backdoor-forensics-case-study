...
public abstract class AbstractClientConnAdapter implements ManagedClientConnection, HttpContext {
    ...
    /* renamed from: a */
    public final ClientConnectionManager f74197a;

    /* renamed from: b */
    public volatile OperatedClientConnection f74198b;

    /* renamed from: c */
    public volatile boolean f74199c = false;

    /* renamed from: d */
    public volatile boolean f74200d = false;

    /* renamed from: e */
    public volatile long f74201e = Long.MAX_VALUE;

    public AbstractClientConnAdapter(ClientConnectionManager clientConnectionManager, OperatedClientConnection operatedClientConnection) {
        this.f74197a = clientConnectionManager;
        this.f74198b = operatedClientConnection;
    }
    ...
    public synchronized void abortConnection() {
        ...
        this.f74197a.releaseConnection(this, this.f74201e, TimeUnit.MILLISECONDS);
    }
    ...
    public void setIdleDuration(long j, TimeUnit timeUnit) {
        if (j > 0) {
            this.f74201e = timeUnit.toMillis(j);
        } else {
            this.f74201e = -1L;
        }
    }
