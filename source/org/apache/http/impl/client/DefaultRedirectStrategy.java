...
public class DefaultRedirectStrategy implements RedirectStrategy {
    ...
    public URI getLocationURI(HttpRequest httpRequest, HttpResponse httpResponse, HttpContext httpContext) throws ProtocolException {
        ...
        if (firstHeader != null) {
            ...
            if (this.f74071a.isDebugEnabled()) {
                Log log = this.f74071a;
    ...
    public boolean isRedirectable(String str) {
        if (Arrays.binarySearch(this.f74072b, str) >= 0) {
            return true;
        }
        return false;
    }
    ...
    public DefaultRedirectStrategy(String[] strArr) {
        this.f74071a = LogFactory.getLog(getClass());
        String[] strArr2 = (String[]) strArr.clone();
        Arrays.sort(strArr2);
        this.f74072b = strArr2;
    }
}
