...
public abstract class CloseableHttpClient implements HttpClient, Closeable {
    ...
    /* renamed from: a */
    public final Log f74063a = LogFactory.getLog(getClass());

    /* renamed from: b */
    public static HttpHost m24679b(HttpUriRequest httpUriRequest) {
    ...
    public CloseableHttpResponse execute(HttpUriRequest httpUriRequest, HttpContext httpContext) throws IOException, ClientProtocolException {
        ...
        return doExecute(m24679b(httpUriRequest), httpUriRequest, httpContext);
    }
    ...
    public <T> T execute(HttpUriRequest httpUriRequest, ResponseHandler<? extends T> responseHandler, HttpContext httpContext) throws IOException, ClientProtocolException {
        return (T) execute(m24679b(httpUriRequest), httpUriRequest, responseHandler, httpContext);
    }
        ...
        try {
            try {
                ...
                try {
                    ...
                    this.f74063a.warn("Error consuming content after an exception.", e2);
                }
                throw e;
            }
        } finally {
