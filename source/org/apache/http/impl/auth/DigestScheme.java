...
public class DigestScheme extends RFC2617Scheme {
    ...
    /* renamed from: a1 */
    private String f73931a1;

    /* renamed from: a2 */
    private String f73932a2;
    ...
    private Header createDigestHeader(Credentials credentials, HttpRequest httpRequest) throws AuthenticationException {
        ...
        if (c != 65535) {
            ...
            try {
                ...
                String encode2 = encode(createMessageDigest.digest(EncodingUtils.getBytes(this.f73931a1, parameter8)));
                if (c == 2) {
                    ...
                    if (c == 1) {
                        ...
                        if (entity != null && !entity.isRepeatable()) {
                            ...
                            this.f73932a2 = parameter5 + ':' + str5;
                            c = 2;
                        } else {
                            str6 = "auth";
                            W80 w80 = new W80(createMessageDigest);
                            if (entity != null) {
                                try {
                                    entity.writeTo(w80);
                                } catch (IOException e) {
                            ...
                            w80.close();
                            this.f73932a2 = parameter5 + ':' + str5 + ':' + encode(w80.m65657b());
                        }
                    } else {
                        str6 = "auth";
                        this.f73932a2 = parameter5 + ':' + str5;
                ...
                String encode3 = encode(createMessageDigest.digest(EncodingUtils.getBytes(this.f73932a2, parameter8)));
                if (c == 0) {
                    sb2.setLength(0);
                    sb2.append(encode2);
                    sb2.append(':');
    ...
    public String getA1() {
        return this.f73931a1;
    }

    public String getA2() {
        return this.f73932a2;
    }
