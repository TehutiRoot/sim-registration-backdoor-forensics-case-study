...
public abstract class AbstractHttpServerConnection implements HttpServerConnection {
    ...
    /* renamed from: c */
    public SessionInputBuffer f73889c = null;

    /* renamed from: d */
    public SessionOutputBuffer f73890d = null;

    /* renamed from: e */
    public EofSensor f73891e = null;

    /* renamed from: f */
    public HttpMessageParser f73892f = null;

    /* renamed from: g */
    public HttpMessageWriter f73893g = null;

    /* renamed from: h */
    public HttpConnectionMetricsImpl f73894h = null;

    /* renamed from: a */
    public final EntitySerializer f73887a = createEntitySerializer();

    /* renamed from: b */
    public final EntityDeserializer f73888b = createEntityDeserializer();
    ...
    public void init(SessionInputBuffer sessionInputBuffer, SessionOutputBuffer sessionOutputBuffer, HttpParams httpParams) {
        this.f73889c = (SessionInputBuffer) Args.notNull(sessionInputBuffer, "Input session buffer");
        this.f73890d = (SessionOutputBuffer) Args.notNull(sessionOutputBuffer, "Output session buffer");
        if (sessionInputBuffer instanceof EofSensor) {
            this.f73891e = (EofSensor) sessionInputBuffer;
        }
        this.f73892f = createRequestParser(sessionInputBuffer, createHttpRequestFactory(), httpParams);
        this.f73893g = createResponseWriter(sessionOutputBuffer, httpParams);
        this.f73894h = createConnectionMetrics(sessionInputBuffer.getMetrics(), sessionOutputBuffer.getMetrics());
    }

    public boolean isEof() {
        EofSensor eofSensor = this.f73891e;
    ...
    public boolean isStale() {
        ...
        try {
            this.f73889c.isDataAvailable(1);
            return isEof();
    ...
    public void receiveRequestEntity(HttpEntityEnclosingRequest httpEntityEnclosingRequest) throws HttpException, IOException {
        ...
        assertOpen();
        httpEntityEnclosingRequest.setEntity(this.f73888b.deserialize(this.f73889c, httpEntityEnclosingRequest));
    }

    @Override // org.apache.http.HttpServerConnection
    public HttpRequest receiveRequestHeader() throws HttpException, IOException {
        assertOpen();
        HttpRequest httpRequest = (HttpRequest) this.f73892f.parse();
        this.f73894h.incrementRequestCount();
        return httpRequest;
    }
    ...
    public void sendResponseEntity(HttpResponse httpResponse) throws HttpException, IOException {
        ...
        this.f73887a.serialize(this.f73890d, httpResponse, httpResponse.getEntity());
    }
    ...
    public void sendResponseHeader(HttpResponse httpResponse) throws HttpException, IOException {
        ...
        assertOpen();
        this.f73893g.write(httpResponse);
        if (httpResponse.getStatusLine().getStatusCode() >= 200) {
            this.f73894h.incrementResponseCount();
        }
    }
}
