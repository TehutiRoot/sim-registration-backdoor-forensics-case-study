...
public class RFC2109Spec extends CookieSpecBase {
    ...
    /* renamed from: c */
    public static final String[] f74373c = {"EEE, dd MMM yyyy HH:mm:ss zzz", "EEE, dd-MMM-yy HH:mm:ss zzz", "EEE MMM d HH:mm:ss yyyy"};
    ...
    public RFC2109Spec(String[] strArr, boolean z) {
        super(new RFC2109VersionHandler(), new C12605a(), new RFC2109DomainHandler(), new BasicMaxAgeHandler(), new BasicSecureHandler(), new BasicCommentHandler(), new BasicExpiresHandler(strArr != null ? (String[]) strArr.clone() : f74373c));
        this.f74374b = z;
    }

    /* renamed from: a */
    public final List m24604a(List list) {
    ...
    /* renamed from: b */
    public final List m24603b(List list) {
        Iterator it = list.iterator();
