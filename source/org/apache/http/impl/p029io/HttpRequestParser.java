...
public class HttpRequestParser extends AbstractMessageParser<HttpMessage> {
    ...
    /* renamed from: f */
    public final HttpRequestFactory f74495f;

    /* renamed from: g */
    public final CharArrayBuffer f74496g;
    ...
    public HttpRequestParser(SessionInputBuffer sessionInputBuffer, LineParser lineParser, HttpRequestFactory httpRequestFactory, HttpParams httpParams) {
        ...
        this.f74495f = (HttpRequestFactory) Args.notNull(httpRequestFactory, "Request factory");
        this.f74496g = new CharArrayBuffer(128);
    }
    ...
    public HttpMessage parseHead(SessionInputBuffer sessionInputBuffer) throws IOException, HttpException, ParseException {
        this.f74496g.clear();
        if (sessionInputBuffer.readLine(this.f74496g) != -1) {
            return this.f74495f.newHttpRequest(this.lineParser.parseRequestLine(this.f74496g, new ParserCursor(0, this.f74496g.length())));
        }
