...
public class ResponseContentEncoding implements HttpResponseInterceptor {
    ...
    /* renamed from: a */
    public final Lookup f73728a;

    /* renamed from: b */
    public final boolean f73729b;

    public ResponseContentEncoding(Lookup<InputStreamFactory> lookup, boolean z) {
        this.f73728a = lookup == null ? RegistryBuilder.create().register("gzip", GZIPInputStreamFactory.getInstance()).register("x-gzip", GZIPInputStreamFactory.getInstance()).register("deflate", DeflateInputStreamFactory.getInstance()).build() : lookup;
        this.f73729b = z;
    }
    ...
    public void process(HttpResponse httpResponse, HttpContext httpContext) throws HttpException, IOException {
        ...
        if (HttpClientContext.adapt(httpContext).getRequestConfig().isContentCompressionEnabled() && entity != null && entity.getContentLength() != 0 && (contentEncoding = entity.getContentEncoding()) != null) {
            for (HeaderElement headerElement : contentEncoding.getElements()) {
                ...
                InputStreamFactory inputStreamFactory = (InputStreamFactory) this.f73728a.lookup(lowerCase);
                ...
                } else if (!HTTP.IDENTITY_CODING.equals(lowerCase) && !this.f73729b) {
