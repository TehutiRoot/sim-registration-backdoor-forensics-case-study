...
public final class AuthSchemeRegistry implements Lookup<AuthSchemeProvider> {
    ...
    /* renamed from: a */
    public final ConcurrentHashMap f73631a = new ConcurrentHashMap();
    ...
    public class C12557a implements AuthSchemeProvider {
        ...
        /* renamed from: a */
        public final /* synthetic */ String f73632a;
        ...
        public AuthScheme create(HttpContext httpContext) {
            return AuthSchemeRegistry.this.getAuthScheme(this.f73632a, ((HttpRequest) httpContext.getAttribute("http.request")).getParams());
        }
    }

    public AuthScheme getAuthScheme(String str, HttpParams httpParams) throws IllegalStateException {
        Args.notNull(str, "Name");
        AuthSchemeFactory authSchemeFactory = (AuthSchemeFactory) this.f73631a.get(str.toLowerCase(Locale.ENGLISH));
    ...
    public List<String> getSchemeNames() {
        return new ArrayList(this.f73631a.keySet());
    }
    ...
    public void register(String str, AuthSchemeFactory authSchemeFactory) {
        ...
        this.f73631a.put(str.toLowerCase(Locale.ENGLISH), authSchemeFactory);
    }
    ...
    public void setItems(Map<String, AuthSchemeFactory> map) {
        ...
        this.f73631a.clear();
        this.f73631a.putAll(map);
    }

    public void unregister(String str) {
        Args.notNull(str, "Name");
        this.f73631a.remove(str.toLowerCase(Locale.ENGLISH));
    }
