...
public class BasicBSONObject extends LinkedHashMap<String, Object> implements BSONObject {
    ...
    private static BasicBSONObject canonicalizeBSONObject(BSONObject bSONObject) {
        ...
        while (it.hasNext()) {
            ...
            basicBSONObject.put((BasicBSONObject) str, (String) canonicalize(bSONObject.get(str)));
        }
    ...
    public void putAll(Map map) {
        for (Map.Entry entry : map.entrySet()) {
            put((BasicBSONObject) entry.getKey().toString(), (String) entry.getValue());
        }
    }
    ...
    public void putAll(BSONObject bSONObject) {
        for (String str : bSONObject.keySet()) {
            put((BasicBSONObject) str, (String) bSONObject.get(str));
        }
    }
