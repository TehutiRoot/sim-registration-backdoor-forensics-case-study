...
public abstract class OutputBuffer extends OutputStream implements BsonOutput {
    /* renamed from: b */
    public final int m24178b(String str, boolean z) {
        ...
        while (i < length) {
            ...
            if (codePointAt < 128) {
                ...
                write((byte) ((codePointAt >> 6) + CertificateHolderAuthorization.CVCA));
                ...
                write((byte) ((codePointAt >> 18) + C6150DK.ERROR_RECEIVE_LRC));
    ...
    @Override // java.io.OutputStream, java.io.Closeable, java.lang.AutoCloseable, org.bson.p044io.BsonOutput
    public void close() {
    }
    ...
    public void writeString(String str) {
        writeInt(0);
        int m24178b = m24178b(str, false);
        writeInt32((getPosition() - m24178b) - 4, m24178b);
    }
