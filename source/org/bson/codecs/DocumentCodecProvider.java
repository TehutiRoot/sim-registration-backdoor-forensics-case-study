...
public class DocumentCodecProvider implements CodecProvider {
    ...
    /* renamed from: a */
    public final BsonTypeClassMap f75830a;

    /* renamed from: b */
    public final Transformer f75831b;
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.f75830a.equals(documentCodecProvider.f75830a)) {
            return false;
        }
        Transformer transformer = this.f75831b;
        Transformer transformer2 = documentCodecProvider.f75831b;
    ...
    public <T> Codec<T> get(Class<T> cls, CodecRegistry codecRegistry) {
        ...
        if (cls == Document.class) {
            return new DocumentCodec(codecRegistry, this.f75830a, this.f75831b);
        }
        return null;
    }
    ...
    public int hashCode() {
        int i;
        int hashCode = this.f75830a.hashCode() * 31;
        Transformer transformer = this.f75831b;
        if (transformer != null) {
    ...
    public DocumentCodecProvider(BsonTypeClassMap bsonTypeClassMap, Transformer transformer) {
        this.f75830a = (BsonTypeClassMap) Assertions.notNull("bsonTypeClassMap", bsonTypeClassMap);
        this.f75831b = transformer;
    }
}
