...
public class BsonValueCodec implements Codec<BsonValue> {
    ...
    /* renamed from: a */
    public final CodecRegistry f75815a;
    ...
    public BsonValueCodec(CodecRegistry codecRegistry) {
        this.f75815a = codecRegistry;
    }

    @Override // org.bson.codecs.Decoder
    public BsonValue decode(BsonReader bsonReader, DecoderContext decoderContext) {
        return (BsonValue) this.f75815a.get(BsonValueCodecProvider.getClassForBsonType(bsonReader.getCurrentBsonType())).decode(bsonReader, decoderContext);
    }

    @Override // org.bson.codecs.Encoder
    public void encode(BsonWriter bsonWriter, BsonValue bsonValue, EncoderContext encoderContext) {
        encoderContext.encodeWithChildContext(this.f75815a.get(bsonValue.getClass()), bsonWriter, bsonValue);
    }
}
