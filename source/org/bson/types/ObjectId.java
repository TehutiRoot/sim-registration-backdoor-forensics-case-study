...
public final class ObjectId implements Comparable<ObjectId>, Serializable {
    ...
    public Date getDate() {
        return new Date((this.timestamp & BodyPartID.bodyIdMax) * 1000);
    }
    ...
    @Deprecated
    public long getTime() {
        return (this.timestamp & BodyPartID.bodyIdMax) * 1000;
    }
    ...
    public void putToByteBuffer(ByteBuffer byteBuffer) {
        ...
        Assertions.isTrueArgument("buffer.remaining() >=12", z);
