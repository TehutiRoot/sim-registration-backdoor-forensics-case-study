...
public class EventRecodingLogger implements Logger {
    ...
    private void recordEvent_0Args(Level level, Marker marker, String str, Throwable th2) {
        recordEvent(level, marker, str, null, th2);
    }
    ...
    public void debug(String str, Throwable th2) {
        recordEvent_0Args(Level.DEBUG, null, str, th2);
    }

    @Override // org.slf4j.Logger
    public void error(String str, Throwable th2) {
        recordEvent_0Args(Level.ERROR, null, str, th2);
    }

    @Override // org.slf4j.Logger
    public void info(String str, Throwable th2) {
        recordEvent_0Args(Level.INFO, null, str, th2);
    }

    @Override // org.slf4j.Logger
    public void trace(String str, Throwable th2) {
        recordEvent_0Args(Level.TRACE, null, str, th2);
    }

    @Override // org.slf4j.Logger
    public void warn(String str, Throwable th2) {
        recordEvent_0Args(Level.WARN, null, str, th2);
    }
