...
public class RainbowPrivateKey extends ASN1Object {
    ...
    /* renamed from: b1 */
    private byte[] f75476b1;

    /* renamed from: b2 */
    private byte[] f75477b2;
    private byte[][] invA1;
    private byte[][] invA2;
    ...
    private RainbowPrivateKey(ASN1Sequence aSN1Sequence) {
        ...
        this.f75476b1 = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence.getObjectAt(2)).getObjectAt(0)).getOctets();
        ...
        this.f75477b2 = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence.getObjectAt(4)).getObjectAt(0)).getOctets();
        this.f75478vi = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence.getObjectAt(5)).getObjectAt(0)).getOctets();
        ...
        int length = this.f75478vi.length - 1;
        this.layers = new Layer[length];
        int i10 = 0;
        while (i10 < length) {
            byte[] bArr5 = this.f75478vi;
            int i11 = i10 + 1;
    ...
    public short[] getB1() {
        return RainbowUtil.convertArray(this.f75476b1);
    }

    public short[] getB2() {
        return RainbowUtil.convertArray(this.f75477b2);
    }
    ...
    public int[] getVi() {
        return RainbowUtil.convertArraytoInt(this.f75478vi);
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector3.add(new DEROctetString(this.f75476b1));
        ...
        aSN1EncodableVector5.add(new DEROctetString(this.f75477b2));
        aSN1EncodableVector.add(new DERSequence(aSN1EncodableVector5));
        ASN1EncodableVector aSN1EncodableVector6 = new ASN1EncodableVector();
        aSN1EncodableVector6.add(new DEROctetString(this.f75478vi));
        ...
        for (int i3 = 0; i3 < this.layers.length; i3++) {
            ...
            for (byte[][] bArr3 : convertArray) {
                ...
                while (true) {
                    if (i4 < bArr3.length) {
                        aSN1EncodableVector10.add(new DEROctetString(bArr3[i4]));
                        i4++;
                    }
                }
            ...
            for (byte[][] bArr4 : convertArray2) {
                ...
                while (true) {
                    if (i5 < bArr4.length) {
                        aSN1EncodableVector12.add(new DEROctetString(bArr4[i5]));
                        i5++;
                    }
                }
            ...
            for (byte[] bArr5 : convertArray3) {
                aSN1EncodableVector13.add(new DEROctetString(bArr5));
            }
    ...
    public RainbowPrivateKey(short[][] sArr, short[] sArr2, short[][] sArr3, short[] sArr4, int[] iArr, Layer[] layerArr) {
        ...
        this.f75476b1 = RainbowUtil.convertArray(sArr2);
        this.invA2 = RainbowUtil.convertArray(sArr3);
        this.f75477b2 = RainbowUtil.convertArray(sArr4);
        this.f75478vi = RainbowUtil.convertIntArray(iArr);
