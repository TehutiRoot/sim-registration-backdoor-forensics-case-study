...
public class McEliecePrivateKey extends ASN1Object {
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f75468n));
        aSN1EncodableVector.add(new ASN1Integer(this.f75467k));
    ...
    private McEliecePrivateKey(ASN1Sequence aSN1Sequence) {
        this.f75468n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).intValueExact();
        this.f75467k = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).intValueExact();
