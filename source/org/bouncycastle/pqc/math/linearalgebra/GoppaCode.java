...
public final class GoppaCode {
    ...
    public static class MaMaPe {
        ...
        /* renamed from: h */
        private GF2Matrix f75594h;

        /* renamed from: p */
        private Permutation f75595p;

        /* renamed from: s */
        private GF2Matrix f75596s;

        public MaMaPe(GF2Matrix gF2Matrix, GF2Matrix gF2Matrix2, Permutation permutation) {
            this.f75596s = gF2Matrix;
            this.f75594h = gF2Matrix2;
            this.f75595p = permutation;
        }
    ...
    public static class MatrixSet {
        ...
        /* renamed from: g */
        private GF2Matrix f75597g;
        private int[] setJ;

        public MatrixSet(GF2Matrix gF2Matrix, int[] iArr) {
            this.f75597g = gF2Matrix;
            this.setJ = iArr;
        }
