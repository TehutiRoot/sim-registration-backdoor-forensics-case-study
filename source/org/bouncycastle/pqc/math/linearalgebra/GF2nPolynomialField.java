...
public class GF2nPolynomialField extends GF2nField {
    ...
    public int[] getPc() throws RuntimeException {
        if (this.isPentanomial) {
            int[] iArr = new int[3];
            System.arraycopy(this.f75592pc, 0, iArr, 0, 3);
            return iArr;
        }
