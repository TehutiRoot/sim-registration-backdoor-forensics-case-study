...
public class GF2Matrix extends Matrix {
    ...
    private void assignRandomLowerTriangularMatrix(int i, SecureRandom secureRandom) {
        ...
        int i2 = (i + 31) >>> 5;
        this.length = i2;
        this.matrix = (int[][]) Array.newInstance(Integer.TYPE, i, i2);
    ...
    public Matrix computeInverse() {
        ...
        if (i == this.numColumns) {
            int[][] iArr = (int[][]) Array.newInstance(Integer.TYPE, i, this.length);
    ...
    public GF2Matrix getLeftSubMatrix() {
        ...
        if (i > i2) {
            int i3 = (i2 + 31) >> 5;
            int[][] iArr = (int[][]) Array.newInstance(Integer.TYPE, i2, i3);
            int i4 = this.numRows;
            int i5 = (1 << (i4 & 31)) - 1;
            if (i5 == 0) {
                i5 = -1;
    ...
    public GF2Matrix(byte[] bArr) {
        ...
        if (i > 0) {
            ...
            if (i2 == bArr.length - 8) {
                int i4 = (OS2IP + 31) >>> 5;
                this.length = i4;
                this.matrix = (int[][]) Array.newInstance(Integer.TYPE, i, i4);
