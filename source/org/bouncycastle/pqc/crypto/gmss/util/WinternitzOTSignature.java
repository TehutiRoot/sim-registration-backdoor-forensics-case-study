        ...
        if (8 % i5 == 0) {
            ...
            for (int i11 = 0; i11 < i3; i11++) {
                for (int i12 = 0; i12 < i7; i12++) {
                    ...
                    bArr3[i11] = (byte) (bArr3[i11] >>> this.f75491w);
                    i10++;
                }
            }
            int i14 = (this.messagesize << this.f75491w) - i9;
            while (i4 < this.checksumsize) {
                hashPrivateKeyBlock(i10, i14 & i8, bArr2, this.mdsize * i10);
                int i15 = this.f75491w;
                i14 >>>= i15;
                i10++;
                i4 += i15;
            }
            ...
            while (i18 < i16) {
                long j = 0;
                for (int i22 = 0; i22 < this.f75491w; i22++) {
            ...
            int i25 = this.mdsize % this.f75491w;
            long j3 = 0;
            ...
            while (i28 < i27) {
                ...
                int i30 = this.f75491w;
                j3 >>>= i30;
                i20++;
                i28 += i30;
            }
            int i31 = (this.messagesize << this.f75491w) - i21;
            while (i4 < this.checksumsize) {
                hashPrivateKeyBlock(i20, i31 & i17, bArr2, this.mdsize * i20);
                int i32 = this.f75491w;
                i31 >>>= i32;
                i20++;
                i4 += i32;
            }
            ...
            int i48 = (this.messagesize << this.f75491w) - i38;
            int i49 = 0;
