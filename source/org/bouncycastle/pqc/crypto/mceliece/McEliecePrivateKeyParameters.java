...
public class McEliecePrivateKeyParameters extends McElieceKeyParameters {
    ...
    /* renamed from: p1 */
    private Permutation f75552p1;

    /* renamed from: p2 */
    private Permutation f75553p2;
    ...
    public McEliecePrivateKeyParameters(int i, int i2, GF2mField gF2mField, PolynomialGF2mSmallM polynomialGF2mSmallM, Permutation permutation, Permutation permutation2, GF2Matrix gF2Matrix) {
        ...
        this.sInv = gF2Matrix;
        this.f75552p1 = permutation;
        this.f75553p2 = permutation2;
        this.f75549h = GoppaCode.createCanonicalCheckMatrix(gF2mField, polynomialGF2mSmallM);
    ...
    public McEliecePrivateKeyParameters(int i, int i2, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5, byte[] bArr6, byte[][] bArr7) {
        ...
        this.f75552p1 = new Permutation(bArr4);
        this.f75553p2 = new Permutation(bArr5);
        this.f75549h = new GF2Matrix(bArr6);
