                ...
                if (oTSHashAddress != null) {
                    ...
                    for (int i3 = 0; i3 < i; i3++) {
                        ...
                        if (Math.floor(i2 / (1 << i3)) % 2.0d == 0.0d) {
                            ...
                            XMSSNode randomizeHash = XMSSNodeUtil.randomizeHash(wOTSPlus, xMSSNodeArr[0], xMSSReducedSignature.getAuthPath().get(i3), hashTreeAddress);
                            ...
                            XMSSNode randomizeHash2 = XMSSNodeUtil.randomizeHash(wOTSPlus, xMSSReducedSignature.getAuthPath().get(i3), xMSSNodeArr[0], hashTreeAddress);
