...
public class LMSSignature implements Encodable {
    ...
    /* renamed from: q */
    private final int f75511q;

    /* renamed from: y */
    private final byte[][] f75512y;
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f75511q != lMSSignature.f75511q) {
            return false;
        }
        ...
        if (lMOtsSignature == null ? lMSSignature.otsSignature == null : lMOtsSignature.equals(lMSSignature.otsSignature)) {
            ...
            if (lMSigParameters == null ? lMSSignature.parameter == null : lMSigParameters.equals(lMSSignature.parameter)) {
                return Arrays.deepEquals(this.f75512y, lMSSignature.f75512y);
            }
            return false;
        }
        return false;
    ...
    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(this.f75511q).bytes(this.otsSignature.getEncoded()).u32str(this.parameter.getType()).bytes(this.f75512y).build();
    }
    ...
    public int hashCode() {
        int i = this.f75511q * 31;
        LMOtsSignature lMOtsSignature = this.otsSignature;
        int hashCode = (i + (lMOtsSignature != null ? lMOtsSignature.hashCode() : 0)) * 31;
        LMSigParameters lMSigParameters = this.parameter;
        return ((hashCode + (lMSigParameters != null ? lMSigParameters.hashCode() : 0)) * 31) + Arrays.deepHashCode(this.f75512y);
    }
}
