...
public class HSSPublicKeyParameters extends LMSKeyParameters implements LMSContextBasedVerifier {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f75493l != hSSPublicKeyParameters.f75493l) {
            return false;
        }
    ...
    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(this.f75493l).bytes(this.lmsPublicKey.getEncoded()).build();
    }
    ...
    public int hashCode() {
        return (this.f75493l * 31) + this.lmsPublicKey.hashCode();
    }
