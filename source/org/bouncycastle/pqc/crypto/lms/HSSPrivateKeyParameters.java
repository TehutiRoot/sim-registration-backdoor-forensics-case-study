...
public class HSSPrivateKeyParameters extends LMSKeyParameters implements LMSContextBasedSigner {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f75492l == hSSPrivateKeyParameters.f75492l && this.isShard == hSSPrivateKeyParameters.isShard && this.indexLimit == hSSPrivateKeyParameters.indexLimit && this.index == hSSPrivateKeyParameters.index && this.keys.equals(hSSPrivateKeyParameters.keys)) {
    ...
    public HSSPrivateKeyParameters extractKeyShard(int i) {
        ...
        synchronized (this) {
            try {
                ...
                long j2 = this.index;
                this.index = j + j2;
                makeCopy = makeCopy(new HSSPrivateKeyParameters(this.f75492l, new ArrayList(getKeys()), new ArrayList(getSig()), j2, j2 + j, true));
                resetKeyToIndex();
            } catch (Throwable th2) {
                throw th2;
            }
    ...
    public synchronized byte[] getEncoded() throws IOException {
        Composer bool;
        try {
            bool = Composer.compose().u32str(0).u32str(this.f75492l).u64str(this.index).u64str(this.indexLimit).bool(this.isShard);
    ...
    public synchronized HSSPublicKeyParameters getPublicKey() {
        return new HSSPublicKeyParameters(this.f75492l, getRootKey().getPublicKey());
    }
    ...
    public int hashCode() {
        ...
        long j2 = this.index;
        return (((((((((this.f75492l * 31) + (this.isShard ? 1 : 0)) * 31) + this.keys.hashCode()) * 31) + this.sig.hashCode()) * 31) + ((int) (j ^ (j >>> 32)))) * 31) + ((int) (j2 ^ (j2 >>> 32)));
    }
