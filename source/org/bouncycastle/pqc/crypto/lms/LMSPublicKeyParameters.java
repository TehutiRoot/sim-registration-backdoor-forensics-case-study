...
public class LMSPublicKeyParameters extends LMSKeyParameters implements LMSContextBasedVerifier {
    ...
    /* renamed from: I */
    private final byte[] f75509I;

    /* renamed from: T1 */
    private final byte[] f75510T1;
    ...
    public LMSPublicKeyParameters(LMSigParameters lMSigParameters, LMOtsParameters lMOtsParameters, byte[] bArr, byte[] bArr2) {
        ...
        this.f75509I = Arrays.clone(bArr2);
        this.f75510T1 = Arrays.clone(bArr);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.parameterSet.equals(lMSPublicKeyParameters.parameterSet) && this.lmOtsType.equals(lMSPublicKeyParameters.lmOtsType) && Arrays.areEqual(this.f75509I, lMSPublicKeyParameters.f75509I)) {
            return Arrays.areEqual(this.f75510T1, lMSPublicKeyParameters.f75510T1);
        }
        return false;
    }
    ...
    public LMSContext generateOtsContext(LMSSignature lMSSignature) {
        ...
        if (lMSSignature.getOtsSignature().getType().getType() == type) {
            return new LMOtsPublicKey(LMOtsParameters.getParametersForType(type), this.f75509I, lMSSignature.getQ(), null).createOtsContext(lMSSignature);
        }
    ...
    public byte[] getI() {
        return Arrays.clone(this.f75509I);
    }
    ...
    public byte[] getT1() {
        return Arrays.clone(this.f75510T1);
    }

    public int hashCode() {
        return (((((this.parameterSet.hashCode() * 31) + this.lmOtsType.hashCode()) * 31) + Arrays.hashCode(this.f75509I)) * 31) + Arrays.hashCode(this.f75510T1);
    }

    public boolean matchesT1(byte[] bArr) {
        return Arrays.constantTimeAreEqual(this.f75510T1, bArr);
    }
    ...
    public byte[] toByteArray() {
        return Composer.compose().u32str(this.parameterSet.getType()).u32str(this.lmOtsType.getType()).bytes(this.f75509I).bytes(this.f75510T1).build();
    }
