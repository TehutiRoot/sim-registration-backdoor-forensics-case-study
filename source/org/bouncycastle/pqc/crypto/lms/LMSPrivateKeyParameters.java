...
public class LMSPrivateKeyParameters extends LMSKeyParameters implements LMSContextBasedSigner {
    ...
    /* renamed from: T1 */
    private static CacheKey f75506T1;
    private static CacheKey[] internedKeys;

    /* renamed from: I */
    private final byte[] f75507I;
    ...
    private LMSPrivateKeyParameters(LMSPrivateKeyParameters lMSPrivateKeyParameters, int i, int i2) {
        ...
        this.f75508q = i;
        this.f75507I = lMSPrivateKeyParameters.f75507I;
        this.maxQ = i2;
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f75508q == lMSPrivateKeyParameters.f75508q && this.maxQ == lMSPrivateKeyParameters.maxQ && Arrays.areEqual(this.f75507I, lMSPrivateKeyParameters.f75507I)) {
    ...
    public LMOtsPrivateKey getCurrentOTSKey() {
        ...
        synchronized (this) {
            try {
                ...
                lMOtsPrivateKey = new LMOtsPrivateKey(this.otsParameters, this.f75507I, i, this.masterSecret);
            } catch (Throwable th2) {
                throw th2;
            }
        }
    ...
    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(0).u32str(this.parameters.getType()).u32str(this.otsParameters.getType()).bytes(this.f75507I).u32str(this.f75508q).u32str(this.maxQ).u32str(this.masterSecret.length).bytes(this.masterSecret).build();
    }

    public byte[] getI() {
        return Arrays.clone(this.f75507I);
    }
        ...
        synchronized (this) {
            try {
                if (this.publicKey == null) {
                    this.publicKey = new LMSPublicKeyParameters(this.parameters, this.otsParameters, findT(f75506T1), this.f75507I);
                }
    ...
    public long getUsagesRemaining() {
        return this.maxQ - this.f75508q;
    }

    public int hashCode() {
        int hashCode = ((this.f75508q * 31) + Arrays.hashCode(this.f75507I)) * 31;
        LMSigParameters lMSigParameters = this.parameters;
    ...
    public LMSPrivateKeyParameters(LMSigParameters lMSigParameters, LMOtsParameters lMOtsParameters, int i, byte[] bArr, int i2, byte[] bArr2) {
        ...
        this.f75508q = i;
        this.f75507I = Arrays.clone(bArr);
        this.maxQ = i2;
