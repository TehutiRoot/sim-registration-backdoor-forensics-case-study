...
public class RainbowSigner implements MessageSigner {
    ...
    /* renamed from: cf */
    private ComputeInField f75572cf = new ComputeInField();
    RainbowKeyParameters key;
    private SecureRandom random;
    int signableDocumentLength;

    /* renamed from: x */
    private short[] f75573x;

    private short[] initSign(Layer[] layerArr, short[] sArr) {
        short[] sArr2 = new short[sArr.length];
        short[] multiplyMatrix = this.f75572cf.multiplyMatrix(((RainbowPrivateKeyParameters) this.key).getInvA1(), this.f75572cf.addVect(((RainbowPrivateKeyParameters) this.key).getB1(), sArr));
        for (int i = 0; i < layerArr[0].getVi(); i++) {
            this.f75573x[i] = (short) this.random.nextInt();
            short[] sArr3 = this.f75573x;
    ...
    public byte[] generateSignature(byte[] bArr) {
        ...
        this.f75573x = new short[((RainbowPrivateKeyParameters) this.key).getInvA2().length];
        ...
        while (true) {
            try {
                ...
                for (int i3 = 0; i3 < length; i3++) {
                    ...
                    short[] solveEquation = this.f75572cf.solveEquation(layers[i3].plugInVinegars(this.f75573x), sArr);
                    if (solveEquation == null) {
                        throw new Exception("LES is not solveable!");
                    }
                    for (int i5 = 0; i5 < solveEquation.length; i5++) {
                        this.f75573x[layers[i3].getVi() + i5] = solveEquation[i5];
                    }
                }
                short[] multiplyMatrix = this.f75572cf.multiplyMatrix(((RainbowPrivateKeyParameters) this.key).getInvA2(), this.f75572cf.addVect(((RainbowPrivateKeyParameters) this.key).getB2(), this.f75573x));
