...
public class LongArray implements Cloneable {
    ...
    private static int bitLength(long j) {
        ...
        if (i4 == 0) {
            ...
            int i6 = i3 >>> 24;
            i = i6 == 0 ? bitLengths[i4] + 16 : bitLengths[i6] + Ascii.CAN;
        }
        return i2 + i;
    }
    ...
    private static long interleave2_32to64(int i) {
        ...
        return (i2 & BodyPartID.bodyIdMax) | ((((sArr[i >>> 24] << 16) | s) & BodyPartID.bodyIdMax) << 32);
    }
    ...
    private static long interleave3_13to65(int i) {
        ...
        return (iArr[i & 127] & BodyPartID.bodyIdMax) | ((iArr[i >>> 7] & BodyPartID.bodyIdMax) << 35);
    }
    ...
    private static long interleave3_21to63(int i) {
        ...
        int i2 = iArr[i & 127];
        int i3 = iArr[(i >>> 7) & 127];
        return (i2 & BodyPartID.bodyIdMax) | ((iArr[i >>> 14] & BodyPartID.bodyIdMax) << 42) | ((i3 & BodyPartID.bodyIdMax) << 21);
    }

    private static long interleave4_16to64(int i) {
        int[] iArr = INTERLEAVE4_TABLE;
        return (iArr[i & 255] & BodyPartID.bodyIdMax) | ((iArr[i >>> 8] & BodyPartID.bodyIdMax) << 32);
    }
    ...
    private static void reduceWordWise(long[] jArr, int i, int i2, int i3, int i4, int[] iArr) {
        ...
        if (j3 != 0) {
            jArr[i10] = (j3 << i9) ^ j2;
            reduceWord(jArr, i, i3, j3, i4, iArr);
        }
    }
    ...
    private static void squareInPlace(long[] jArr, int i, int i2, int[] iArr) {
        ...
        while (true) {
            ...
            long j = jArr[i];
            jArr[i3 - 1] = interleave2_32to64((int) (j >>> 32));
            i3 -= 2;
    ...
    public LongArray modInverse(int i, int[] iArr) {
        ...
        while (true) {
            ...
            int i7 = 1 - i6;
            longArrayArr[i6].addShiftedByBitsSafe(longArrayArr[i7], iArr2[i7], i5);
            int degreeFrom = longArrayArr[i6].degreeFrom(i4);
            if (degreeFrom == 0) {
                return longArrayArr2[i7];
            }
            int i8 = iArr3[i7];
            longArrayArr2[i6].addShiftedByBitsSafe(longArrayArr2[i7], i8, i5);
            int i9 = i8 + i5;
            if (i9 > i2) {
                i2 = i9;
            } else if (i9 == i2) {
                i2 = longArrayArr2[i6].degreeFrom(i2);
            }
            i5 += degreeFrom - i4;
            i4 = degreeFrom;
        }
    ...
    public LongArray modMultiply(LongArray longArray, int i, int[] iArr) {
        ...
        if (i7 == 1) {
            ...
            return reduceResult(jArr2, 0, i9, i, iArr);
        }
        int i10 = (i3 + 70) >>> 6;
        ...
        while (i17 < i7) {
            ...
            while (true) {
                i4 = i16;
                int i19 = iArr2[((int) j2) & 15];
                int i20 = iArr2[((int) (j2 >>> 4)) & 15];
                i5 = i17;
                addBoth(jArr7, i18, jArr4, i19, jArr5, i20, i10);
                j2 >>>= 8;
                if (j2 == 0) {
                    break;
                }
        ...
        while (true) {
            i16 -= i9;
            if (i16 == 0) {
                return reduceResult(jArr7, 0, i9, i, iArr);
            }
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i, int[] iArr) {
        ...
        if (i5 == 1) {
            ...
            multiplyWord(j, longArray3.m_ints, i6, jArr, 0);
            return reduceResult(jArr, 0, i7, i, iArr);
        }
        int i8 = (i3 + 78) >>> 6;
        int i9 = i8 * 8;
        int[] iArr2 = new int[16];
        ...
        int i12 = i9;
        interleave(longArray2.m_ints, 0, jArr2, 0, i5, 4);
        System.arraycopy(longArray3.m_ints, 0, jArr2, i5, i6);
        int i13 = i5;
        int i14 = 1;
        while (i14 < 8) {
            int i15 = i13 + i8;
            shiftUp(jArr2, i5, jArr2, i15, i8, i14);
            i14++;
            i13 = i15;
        }
        int i16 = 0;
        ...
        while (true) {
            ...
            while (true) {
                int i19 = i5;
                long j2 = jArr2[i18] >>> i16;
                int i20 = 0;
                while (true) {
                    int i21 = ((int) j2) & i17;
                    if (i21 != 0) {
                        add(jArr2, iArr2[i21] + i18, jArr2, i19, i8);
                    }
                    i20++;
                    if (i20 == 8) {
                        break;
        ...
        while (true) {
            int i23 = i22 - 1;
            if (i23 <= 1) {
                return reduceResult(jArr2, iArr2[1], i7, i, iArr);
            }
            if ((i23 & 1) == 0) {
                addShiftedUp(jArr2, iArr2[i23 >>> 1], jArr2, iArr2[i23], i7, 16);
            } else {
                distribute(jArr2, iArr2[i23], iArr2[i22 - 2], iArr2[1], i7);
            }
            i22 = i23;
        }
    }
    ...
    public LongArray modMultiplyLD(LongArray longArray, int i, int[] iArr) {
        ...
        if (i5 == 1) {
            ...
            return reduceResult(jArr2, 0, i7, i, iArr);
        }
        int i8 = (i3 + 70) >>> 6;
        int[] iArr2 = new int[16];
        int i9 = i8 << 4;
        ...
        while (i10 < 16) {
            ...
            if ((i10 & 1) == 0) {
                ...
                jArr = jArr3;
                i4 = i9;
                add(jArr, i8, jArr3, i11 - i8, jArr, i11, i8);
            }
            i10++;
            i9 = i4;
            jArr3 = jArr;
        ...
        for (int i13 = 56; i13 >= 0; i13 -= 8) {
            for (int i14 = 1; i14 < i5; i14 += 2) {
                int i15 = (int) (jArr6[i14] >>> i13);
                addBoth(jArr7, i14 - 1, jArr4, iArr2[i15 & 15], jArr5, iArr2[(i15 >>> 4) & 15], i8);
            }
            shiftUp(jArr7, 0, i7, 8);
        }
        for (int i16 = 56; i16 >= 0; i16 -= 8) {
            for (int i17 = 0; i17 < i5; i17 += 2) {
                int i18 = (int) (jArr6[i17] >>> i16);
                addBoth(jArr7, i17, jArr4, iArr2[i18 & 15], jArr5, iArr2[(i18 >>> 4) & 15], i8);
            }
            if (i16 > 0) {
                shiftUp(jArr7, 0, i7, 8);
            }
        }
        return reduceResult(jArr7, 0, i7, i, iArr);
    }
    ...
    public LongArray multiply(LongArray longArray, int i, int[] iArr) {
        ...
        for (int i15 = 0; i15 < i5; i15++) {
            ...
            long j2 = jArr6[i15];
            while (true) {
                addBoth(jArr7, i16, jArr4, iArr2[((int) j2) & 15], jArr5, iArr2[((int) (j2 >>> 4)) & 15], i8);
                j2 >>>= 8;
                if (j2 == 0) {
                    break;
                }
