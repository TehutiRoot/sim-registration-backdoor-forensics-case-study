...
public abstract class ECPoint {
    ...
    /* renamed from: x */
    protected ECFieldElement f75342x;

    /* renamed from: y */
    protected ECFieldElement f75343y;

    /* renamed from: zs */
    protected ECFieldElement[] f75344zs;
    ...
    public static abstract class AbstractF2m extends ECPoint {
        ...
        public boolean satisfiesCurveEquation() {
            ...
            ECFieldElement eCFieldElement = this.f75342x;
            ECFieldElement a = curve.getA();
            ECFieldElement b = curve.getB();
            int coordinateSystem = curve.getCoordinateSystem();
            if (coordinateSystem != 6) {
                ECFieldElement eCFieldElement2 = this.f75343y;
                ECFieldElement multiply = eCFieldElement2.add(eCFieldElement).multiply(eCFieldElement2);
                if (coordinateSystem != 0) {
                    if (coordinateSystem != 1) {
                        throw new IllegalStateException("unsupported coordinate system");
                    }
                    ECFieldElement eCFieldElement3 = this.f75344zs[0];
            ...
            ECFieldElement eCFieldElement4 = this.f75344zs[0];
            boolean isOne = eCFieldElement4.isOne();
            if (eCFieldElement.isZero()) {
                ECFieldElement square = this.f75343y.square();
                if (!isOne) {
                    b = b.multiply(eCFieldElement4.square());
                }
                return square.equals(b);
            }
            ECFieldElement eCFieldElement5 = this.f75343y;
        ...
        public AbstractF2m tau() {
            ...
            if (coordinateSystem != 0) {
                ...
                createRawPoint = curve.createRawPoint(eCFieldElement.square(), this.f75343y.square(), new ECFieldElement[]{this.f75344zs[0].square()});
                return (AbstractF2m) createRawPoint;
            }
            createRawPoint = curve.createRawPoint(eCFieldElement.square(), this.f75343y.square());
            return (AbstractF2m) createRawPoint;
        }
        ...
        public AbstractF2m tauPow(int i) {
            ...
            if (coordinateSystem != 0) {
                ...
                createRawPoint = curve.createRawPoint(eCFieldElement.squarePow(i), this.f75343y.squarePow(i), new ECFieldElement[]{this.f75344zs[0].squarePow(i)});
                return (AbstractF2m) createRawPoint;
            }
            createRawPoint = curve.createRawPoint(eCFieldElement.squarePow(i), this.f75343y.squarePow(i));
            return (AbstractF2m) createRawPoint;
        }
    ...
    public static class F2m extends AbstractF2m {
        ...
        public ECPoint add(ECPoint eCPoint) {
            ...
            ECCurve curve = getCurve();
            int coordinateSystem = curve.getCoordinateSystem();
            ECFieldElement eCFieldElement7 = this.f75342x;
            ECFieldElement eCFieldElement8 = eCPoint.f75342x;
            if (coordinateSystem == 0) {
                ECFieldElement eCFieldElement9 = this.f75343y;
                ECFieldElement eCFieldElement10 = eCPoint.f75343y;
                ...
                ECFieldElement eCFieldElement11 = this.f75343y;
                ECFieldElement eCFieldElement12 = this.f75344zs[0];
                ECFieldElement eCFieldElement13 = eCPoint.f75343y;
                ECFieldElement eCFieldElement14 = eCPoint.f75344zs[0];
                ...
                ECFieldElement eCFieldElement15 = this.f75343y;
                ECFieldElement eCFieldElement16 = this.f75344zs[0];
                ECFieldElement eCFieldElement17 = eCPoint.f75343y;
                ECFieldElement eCFieldElement18 = eCPoint.f75344zs[0];
        ...
        public ECPoint negate() {
            ...
            if (curveCoordinateSystem != 0) {
                if (curveCoordinateSystem == 1) {
                    return new F2m(this.curve, eCFieldElement, this.f75343y.add(eCFieldElement), new ECFieldElement[]{this.f75344zs[0]});
                    ...
                    return new F2m(this.curve, eCFieldElement, this.f75343y.addOne());
                }
            }
            return new F2m(this.curve, eCFieldElement, this.f75343y.add(eCFieldElement));
        }
        ...
        public ECPoint twice() {
            ...
            int coordinateSystem = curve.getCoordinateSystem();
            if (coordinateSystem == 0) {
                ECFieldElement add2 = this.f75343y.divide(eCFieldElement).add(eCFieldElement);
                ...
                ECFieldElement eCFieldElement4 = this.f75343y;
                ECFieldElement eCFieldElement5 = this.f75344zs[0];
        ...
        public ECPoint twicePlus(ECPoint eCPoint) {
            ...
            ECFieldElement eCFieldElement2 = eCPoint.f75342x;
            ECFieldElement eCFieldElement3 = eCPoint.f75344zs[0];
            if (eCFieldElement2.isZero() || !eCFieldElement3.isOne()) {
                return twice().add(eCPoint);
            }
            ECFieldElement eCFieldElement4 = this.f75343y;
            ECFieldElement eCFieldElement5 = this.f75344zs[0];
            ECFieldElement eCFieldElement6 = eCPoint.f75343y;
            ECFieldElement square = eCFieldElement.square();
    ...
    /* loaded from: classes6.dex */
    public static class C12827Fp extends AbstractFp {
        public C12827Fp(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2) {
            super(eCCurve, eCFieldElement, eCFieldElement2);
        }
        ...
        */
        public org.bouncycastle.math.p041ec.ECPoint add(org.bouncycastle.math.p041ec.ECPoint r17) {
            /*
                Method dump skipped, instructions count: 532
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.math.p041ec.ECPoint.C12827Fp.add(org.bouncycastle.math.ec.ECPoint):org.bouncycastle.math.ec.ECPoint");
        }
        ...
        @Override // org.bouncycastle.math.p041ec.ECPoint
        public ECPoint detach() {
            return new C12827Fp(null, getAffineXCoord(), getAffineYCoord());
        }
        ...
        public ECFieldElement getJacobianModifiedW() {
            ECFieldElement[] eCFieldElementArr = this.f75344zs;
        ...
        public ECPoint negate() {
            ...
            ECCurve curve = getCurve();
            return curve.getCoordinateSystem() != 0 ? new C12827Fp(curve, this.f75342x, this.f75343y.negate(), this.f75344zs) : new C12827Fp(curve, this.f75342x, this.f75343y.negate());
        }
        ...
        public ECPoint threeTimes() {
            ...
            ECFieldElement eCFieldElement = this.f75343y;
            if (eCFieldElement.isZero()) {
                return this;
            }
            ECCurve curve = getCurve();
            ...
            ECFieldElement eCFieldElement2 = this.f75342x;
            ...
            return new C12827Fp(curve, add2, eCFieldElement2.subtract(add2).multiply(subtract2).subtract(eCFieldElement));
        }
        ...
        public ECPoint timesPow2(int i) {
            ...
            if (i >= 0) {
                ...
                if (coordinateSystem == 0) {
                    ...
                    return new C12827Fp(curve, eCFieldElement2.multiply(square2), eCFieldElement.multiply(square2.multiply(invert)));
                } else if (coordinateSystem != 1) {
                    if (coordinateSystem != 2) {
                        if (coordinateSystem == 4) {
                            return new C12827Fp(curve, eCFieldElement2, eCFieldElement, new ECFieldElement[]{fromBigInteger, a});
                        }
                        throw new IllegalStateException("unsupported coordinate system");
                    }
                    return new C12827Fp(curve, eCFieldElement2, eCFieldElement, new ECFieldElement[]{fromBigInteger});
                } else {
                    return new C12827Fp(curve, eCFieldElement2.multiply(fromBigInteger), eCFieldElement, new ECFieldElement[]{fromBigInteger.multiply(fromBigInteger.square())});
                }
            }
        ...
        public ECPoint twice() {
            ...
            int coordinateSystem = curve.getCoordinateSystem();
            ECFieldElement eCFieldElement3 = this.f75342x;
            if (coordinateSystem == 0) {
                ...
                return new C12827Fp(curve, subtract, divide.multiply(eCFieldElement3.subtract(subtract)).subtract(eCFieldElement2));
            } else if (coordinateSystem == 1) {
                ECFieldElement eCFieldElement4 = this.f75344zs[0];
                boolean isOne = eCFieldElement4.isOne();
                ECFieldElement a = curve.getA();
                ...
                return new C12827Fp(curve, multiply3, four.subtract(subtract2).multiply(add).subtract(two(two2.square())), new ECFieldElement[]{two(isOne ? two(two2) : two.square()).multiply(multiply2)});
            } else if (coordinateSystem != 2) {
                if (coordinateSystem == 4) {
                ...
                return new C12827Fp(curve, subtract3, subtract4, new ECFieldElement[]{two3});
            }
        }

        public C12827Fp twiceJacobianModified(boolean z) {
            ECFieldElement eCFieldElement = this.f75342x;
            ECFieldElement eCFieldElement2 = this.f75343y;
            ECFieldElement eCFieldElement3 = this.f75344zs[0];
            ...
            return new C12827Fp(getCurve(), subtract, subtract2, new ECFieldElement[]{two, two4});
        }
        ...
        public ECPoint twicePlus(ECPoint eCPoint) {
            ...
            ECFieldElement eCFieldElement2 = this.f75342x;
            ECFieldElement eCFieldElement3 = eCPoint.f75342x;
            ECFieldElement eCFieldElement4 = eCPoint.f75343y;
            ...
            return new C12827Fp(curve, add, eCFieldElement2.subtract(add).multiply(subtract4).subtract(eCFieldElement));
        }
        ...
        public C12827Fp(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr) {
            super(eCCurve, eCFieldElement, eCFieldElement2, eCFieldElementArr);
        }
    }
    ...
    public boolean implIsValid(final boolean z, final boolean z2) {
        ...
        return !((ValidityPrecompInfo) getCurve().precompute(this, "bc_validity", new PreCompCallback() { // from class: org.bouncycastle.math.ec.ECPoint.1
            ...
            @Override // org.bouncycastle.math.p041ec.PreCompCallback
    ...
    public boolean isInfinity() {
        if (this.f75342x != null && this.f75343y != null) {
            ECFieldElement[] eCFieldElementArr = this.f75344zs;
    ...
    public boolean isNormalized() {
        int curveCoordinateSystem = getCurveCoordinateSystem();
        return curveCoordinateSystem == 0 || curveCoordinateSystem == 5 || isInfinity() || this.f75344zs[0].isOne();
    }
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.f75344zs.length; i++) {
            stringBuffer.append(',');
            stringBuffer.append(this.f75344zs[i]);
        }
    ...
    public ECPoint(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr) {
        ...
        this.curve = eCCurve;
        this.f75342x = eCFieldElement;
        this.f75343y = eCFieldElement2;
        this.f75344zs = eCFieldElementArr;
    }
