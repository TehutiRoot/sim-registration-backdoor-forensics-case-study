...
public abstract class WNafUtil {
    ...
    public static WNafPreCompInfo precompute(final ECPoint eCPoint, final int i, final boolean z) {
        ...
        return (WNafPreCompInfo) curve.precompute(eCPoint, PRECOMP_NAME, new PreCompCallback() { // from class: org.bouncycastle.math.ec.WNafUtil.2
            ...
            /* JADX WARN: Removed duplicated region for block: B:111:0x00f2 A[LOOP:0: B:110:0x00f0->B:111:0x00f2, LOOP_END] */
            @Override // org.bouncycastle.math.p041ec.PreCompCallback
            /*
                Code decompiled incorrectly, please refer to instructions dump.
                To view partially-correct code enable 'Show inconsistent code' option in preferences
            */
            public org.bouncycastle.math.p041ec.PreCompInfo precompute(org.bouncycastle.math.p041ec.PreCompInfo r14) {
                /*
                    Method dump skipped, instructions count: 301
                    To view this dump change 'Code comments level' option to 'DEBUG'
                */
                throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.math.p041ec.WNafUtil.C128302.precompute(org.bouncycastle.math.ec.PreCompInfo):org.bouncycastle.math.ec.PreCompInfo");
            }
        });
    }
