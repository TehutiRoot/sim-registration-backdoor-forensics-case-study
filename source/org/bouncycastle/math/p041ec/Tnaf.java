...
public class Tnaf {
    ...
    public static BigInteger norm(byte b, ZTauElement zTauElement) {
        BigInteger subtract;
        BigInteger bigInteger = zTauElement.f75345u;
        BigInteger multiply = bigInteger.multiply(bigInteger);
        BigInteger multiply2 = zTauElement.f75345u.multiply(zTauElement.f75346v);
        BigInteger bigInteger2 = zTauElement.f75346v;
    ...
    public static ZTauElement partModReduction(BigInteger bigInteger, int i, byte b, BigInteger[] bigIntegerArr, byte b2, byte b3) {
        ...
        return new ZTauElement(bigInteger.subtract(add.multiply(round.f75345u)).subtract(BigInteger.valueOf(2L).multiply(bigIntegerArr[1]).multiply(round.f75346v)), bigIntegerArr[1].multiply(round.f75345u).subtract(bigIntegerArr[0].multiply(round.f75346v)));
    }
    ...
    */
    ...
    public static byte[] tauAdicWNaf(byte b, ZTauElement zTauElement, byte b2, BigInteger bigInteger, BigInteger bigInteger2, ZTauElement[] zTauElementArr) {
        ...
        BigInteger shiftRight = bigInteger.shiftRight(1);
        BigInteger bigInteger3 = zTauElement.f75345u;
        BigInteger bigInteger4 = zTauElement.f75346v;
        int i = 0;
        while (true) {
            ...
            if (bigInteger3.testBit(0)) {
                ...
                if (z) {
                    bigInteger3 = bigInteger3.subtract(zTauElementArr[intValue].f75345u);
                    bigInteger4 = bigInteger4.subtract(zTauElementArr[intValue].f75346v);
                } else {
                    bigInteger3 = bigInteger3.add(zTauElementArr[intValue].f75345u);
                    bigInteger4 = bigInteger4.add(zTauElementArr[intValue].f75346v);
                }
            } else {
                bArr[i] = 0;
            }
