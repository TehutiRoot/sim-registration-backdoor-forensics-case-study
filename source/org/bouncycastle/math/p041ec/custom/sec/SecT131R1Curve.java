...
public class SecT131R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT131R1Curve() {
        ...
        this.f75327a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("07A11B09A76B562144418FF3FF8C2570B8")));
        this.f75328b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("0217C05610884B63B9C6C7291678F9D341")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat192.copy64(((SecT131FieldElement) eCPoint.getRawXCoord()).f75418x, 0, jArr, i3);
            Nat192.copy64(((SecT131FieldElement) eCPoint.getRawYCoord()).f75418x, 0, jArr, i3 + 3);
            i3 += 6;
        }
