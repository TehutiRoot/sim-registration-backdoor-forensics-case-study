...
public class SecP160R2FieldElement extends ECFieldElement.AbstractFp {
    ...
    /* renamed from: Q */
    public static final BigInteger f75373Q = new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC73"));

    /* renamed from: x */
    protected int[] f75374x;

    public SecP160R2FieldElement() {
        this.f75374x = Nat160.create();
    }

    @Override // org.bouncycastle.math.p041ec.ECFieldElement
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        int[] create = Nat160.create();
        SecP160R2Field.add(this.f75374x, ((SecP160R2FieldElement) eCFieldElement).f75374x, create);
    ...
    public ECFieldElement addOne() {
        int[] create = Nat160.create();
        SecP160R2Field.addOne(this.f75374x, create);
        return new SecP160R2FieldElement(create);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat160.create();
        SecP160R2Field.inv(((SecP160R2FieldElement) eCFieldElement).f75374x, create);
        SecP160R2Field.multiply(create, this.f75374x, create);
        return new SecP160R2FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP160R2FieldElement) {
            return Nat160.m24430eq(this.f75374x, ((SecP160R2FieldElement) obj).f75374x);
        }
        return false;
    }
    ...
    public int getFieldSize() {
        return f75373Q.bitLength();
    }

    public int hashCode() {
        return f75373Q.hashCode() ^ Arrays.hashCode(this.f75374x, 0, 5);
    }

    @Override // org.bouncycastle.math.p041ec.ECFieldElement
    public ECFieldElement invert() {
        int[] create = Nat160.create();
        SecP160R2Field.inv(this.f75374x, create);
        return new SecP160R2FieldElement(create);
    }

    @Override // org.bouncycastle.math.p041ec.ECFieldElement
    public boolean isOne() {
        return Nat160.isOne(this.f75374x);
    }

    @Override // org.bouncycastle.math.p041ec.ECFieldElement
    public boolean isZero() {
        return Nat160.isZero(this.f75374x);
    }

    @Override // org.bouncycastle.math.p041ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat160.create();
        SecP160R2Field.multiply(this.f75374x, ((SecP160R2FieldElement) eCFieldElement).f75374x, create);
        return new SecP160R2FieldElement(create);
    }
    ...
    public ECFieldElement negate() {
        int[] create = Nat160.create();
        SecP160R2Field.negate(this.f75374x, create);
        return new SecP160R2FieldElement(create);
    }

    @Override // org.bouncycastle.math.p041ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f75374x;
    ...
    public ECFieldElement square() {
        int[] create = Nat160.create();
        SecP160R2Field.square(this.f75374x, create);
        return new SecP160R2FieldElement(create);
    }
    ...
    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat160.create();
        SecP160R2Field.subtract(this.f75374x, ((SecP160R2FieldElement) eCFieldElement).f75374x, create);
        return new SecP160R2FieldElement(create);
    }

    @Override // org.bouncycastle.math.p041ec.ECFieldElement
    public boolean testBitZero() {
        return Nat160.getBit(this.f75374x, 0) == 1;
    }

    @Override // org.bouncycastle.math.p041ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat160.toBigInteger(this.f75374x);
    }

    public SecP160R2FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f75373Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP160R2FieldElement");
        }
        this.f75374x = SecP160R2Field.fromBigInteger(bigInteger);
    }
