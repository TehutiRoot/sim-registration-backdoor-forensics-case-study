...
public class SecT571R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecT571FieldElement secT571FieldElement4 = (SecT571FieldElement) this.f75342x;
        ...
        SecT571FieldElement secT571FieldElement6 = (SecT571FieldElement) this.f75343y;
        SecT571FieldElement secT571FieldElement7 = (SecT571FieldElement) this.f75344zs[0];
        ...
        long[] precompMultiplicand = secT571FieldElement7.isOne() ? null : SecT571Field.precompMultiplicand(secT571FieldElement7.f75425x);
        if (precompMultiplicand == null) {
            jArr = secT571FieldElement5.f75425x;
            jArr2 = secT571FieldElement8.f75425x;
        } else {
            SecT571Field.multiplyPrecomp(secT571FieldElement5.f75425x, precompMultiplicand, create642);
            SecT571Field.multiplyPrecomp(secT571FieldElement8.f75425x, precompMultiplicand, create644);
            jArr = create642;
            jArr2 = create644;
        }
        long[] precompMultiplicand2 = secT571FieldElement9.isOne() ? null : SecT571Field.precompMultiplicand(secT571FieldElement9.f75425x);
        if (precompMultiplicand2 == null) {
            jArr3 = secT571FieldElement4.f75425x;
            jArr4 = secT571FieldElement6.f75425x;
        } else {
            SecT571Field.multiplyPrecomp(secT571FieldElement4.f75425x, precompMultiplicand2, create64);
            SecT571Field.multiplyPrecomp(secT571FieldElement6.f75425x, precompMultiplicand2, create643);
            jArr3 = create64;
            jArr4 = create643;
        }
        ...
        if (secT571FieldElement5.isZero()) {
            ...
            SecT571Field.multiply(create64, create642, secT571FieldElement.f75425x);
            if (secT571FieldElement.isZero()) {
                return new SecT571R1Point(curve, secT571FieldElement, SecT571R1Curve.SecT571R1_B_SQRT);
            }
            SecT571FieldElement secT571FieldElement11 = new SecT571FieldElement(create643);
            SecT571Field.multiplyPrecomp(create644, precompMultiplicand3, secT571FieldElement11.f75425x);
            if (precompMultiplicand2 != null) {
                long[] jArr5 = secT571FieldElement11.f75425x;
            ...
            SecT571Field.add(secT571FieldElement6.f75425x, secT571FieldElement7.f75425x, create644);
            SecT571Field.multiplyAddToExt(create644, secT571FieldElement11.f75425x, createExt64);
            SecT571FieldElement secT571FieldElement12 = new SecT571FieldElement(create644);
            SecT571Field.reduce(createExt64, secT571FieldElement12.f75425x);
            if (precompMultiplicand != null) {
                long[] jArr6 = secT571FieldElement11.f75425x;
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecT571FieldElement secT571FieldElement = (SecT571FieldElement) this.f75342x;
        if (secT571FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecT571FieldElement secT571FieldElement2 = (SecT571FieldElement) this.f75343y;
        SecT571FieldElement secT571FieldElement3 = (SecT571FieldElement) this.f75344zs[0];
        long[] create64 = Nat576.create64();
        long[] create642 = Nat576.create64();
        long[] precompMultiplicand = secT571FieldElement3.isOne() ? null : SecT571Field.precompMultiplicand(secT571FieldElement3.f75425x);
        long[] jArr2 = secT571FieldElement2.f75425x;
        if (precompMultiplicand == null) {
            jArr = secT571FieldElement3.f75425x;
        } else {
            SecT571Field.multiplyPrecomp(jArr2, precompMultiplicand, create64);
            SecT571Field.square(secT571FieldElement3.f75425x, create642);
            jArr2 = create64;
            jArr = create642;
        }
        long[] create643 = Nat576.create64();
        SecT571Field.square(secT571FieldElement2.f75425x, create643);
        ...
        SecT571Field.square(create643, secT571FieldElement4.f75425x);
        SecT571FieldElement secT571FieldElement5 = new SecT571FieldElement(create643);
        if (precompMultiplicand != null) {
            long[] jArr3 = secT571FieldElement5.f75425x;
            SecT571Field.multiply(jArr3, jArr, jArr3);
        }
        long[] jArr4 = secT571FieldElement.f75425x;
        if (precompMultiplicand != null) {
        ...
        SecT571Field.addBothTo(secT571FieldElement4.f75425x, secT571FieldElement5.f75425x, create642);
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        SecT571FieldElement secT571FieldElement4 = (SecT571FieldElement) this.f75343y;
        SecT571FieldElement secT571FieldElement5 = (SecT571FieldElement) this.f75344zs[0];
        SecT571FieldElement secT571FieldElement6 = (SecT571FieldElement) eCPoint.getRawYCoord();
        long[] create64 = Nat576.create64();
        long[] create642 = Nat576.create64();
        long[] create643 = Nat576.create64();
        long[] create644 = Nat576.create64();
        SecT571Field.square(secT571FieldElement.f75425x, create64);
        SecT571Field.square(secT571FieldElement4.f75425x, create642);
        SecT571Field.square(secT571FieldElement5.f75425x, create643);
        SecT571Field.multiply(secT571FieldElement4.f75425x, secT571FieldElement5.f75425x, create644);
        SecT571Field.addBothTo(create643, create642, create644);
        long[] precompMultiplicand = SecT571Field.precompMultiplicand(create643);
        SecT571Field.multiplyPrecomp(secT571FieldElement6.f75425x, precompMultiplicand, create643);
        ...
        SecT571Field.multiplyPrecomp(secT571FieldElement2.f75425x, precompMultiplicand, create64);
        ...
        if (Nat576.isZero64(create642)) {
            ...
            SecT571Field.square(create643, secT571FieldElement7.f75425x);
            long[] jArr = secT571FieldElement7.f75425x;
            SecT571Field.multiply(jArr, create64, jArr);
            SecT571FieldElement secT571FieldElement8 = new SecT571FieldElement(create64);
            SecT571Field.multiply(create643, create642, secT571FieldElement8.f75425x);
            long[] jArr2 = secT571FieldElement8.f75425x;
            ...
            SecT571Field.add(create643, create642, secT571FieldElement9.f75425x);
            long[] jArr3 = secT571FieldElement9.f75425x;
            SecT571Field.square(jArr3, jArr3);
            Nat.zero64(18, createExt64);
            SecT571Field.multiplyAddToExt(secT571FieldElement9.f75425x, create644, createExt64);
            SecT571Field.addOne(secT571FieldElement6.f75425x, create644);
            SecT571Field.multiplyAddToExt(create644, secT571FieldElement8.f75425x, createExt64);
            SecT571Field.reduce(createExt64, secT571FieldElement9.f75425x);
