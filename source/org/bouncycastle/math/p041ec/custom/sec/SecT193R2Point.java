...
/* renamed from: org.bouncycastle.math.ec.custom.sec.SecT193R2Point */
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElement4.isZero()) {
                return new SecT193R2Point(curve, eCFieldElement4, curve.getB().sqrt());
            }
            ...
            if (multiply3.isZero()) {
                return new SecT193R2Point(curve, multiply3, curve.getB().sqrt());
            }
        ...
        return new SecT193R2Point(curve, eCFieldElement4, eCFieldElement6, new ECFieldElement[]{eCFieldElement5});
    }
