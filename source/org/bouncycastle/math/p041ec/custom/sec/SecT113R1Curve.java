...
public class SecT113R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT113R1Curve() {
        ...
        this.f75327a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("003088250CA6E7C7FE649CE85820F7")));
        this.f75328b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("00E8BEE4D3E2260744188BE0E9C723")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat128.copy64(((SecT113FieldElement) eCPoint.getRawXCoord()).f75417x, 0, jArr, i3);
            Nat128.copy64(((SecT113FieldElement) eCPoint.getRawYCoord()).f75417x, 0, jArr, i3 + 2);
            i3 += 4;
        }
