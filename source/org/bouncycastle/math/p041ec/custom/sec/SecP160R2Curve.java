...
public class SecP160R2Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f75370q = SecP160R2FieldElement.f75373Q;
    ...
    public SecP160R2Curve() {
        ...
        this.f75327a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC70")));
        this.f75328b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("B4E134D3FB59EB8BAB57274904664D5AF50388BA")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat160.copy(((SecP160R2FieldElement) eCPoint.getRawXCoord()).f75374x, 0, iArr, i3);
            Nat160.copy(((SecP160R2FieldElement) eCPoint.getRawYCoord()).f75374x, 0, iArr, i3 + 5);
            i3 += 10;
        }
