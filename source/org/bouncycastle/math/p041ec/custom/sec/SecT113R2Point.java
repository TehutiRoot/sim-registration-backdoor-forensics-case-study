...
/* renamed from: org.bouncycastle.math.ec.custom.sec.SecT113R2Point */
...
public class SecT113R2Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        ECFieldElement eCFieldElement8 = this.f75343y;
        ECFieldElement eCFieldElement9 = this.f75344zs[0];
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElement4.isZero()) {
                return new SecT113R2Point(curve, eCFieldElement4, curve.getB().sqrt());
            }
            ...
            if (multiply3.isZero()) {
                return new SecT113R2Point(curve, multiply3, curve.getB().sqrt());
            }
        ...
        return new SecT113R2Point(curve, eCFieldElement4, eCFieldElement6, new ECFieldElement[]{eCFieldElement5});
    }
    ...
    public ECPoint negate() {
        ...
        ECFieldElement eCFieldElement2 = this.f75343y;
        ECFieldElement eCFieldElement3 = this.f75344zs[0];
        return new SecT113R2Point(this.curve, eCFieldElement, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[]{eCFieldElement3});
    }
    ...
    public ECPoint twice() {
        ...
        if (add.isZero()) {
            return new SecT113R2Point(curve, add, curve.getB().sqrt());
        }
        ...
        return new SecT113R2Point(curve, square2, eCFieldElement.squarePlusProduct(add, multiply).add(square2).add(multiply2), new ECFieldElement[]{multiply2});
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        if (square4.isZero()) {
            ...
            return new SecT113R2Point(curve, multiplyPlusProduct, curve.getB().sqrt());
        } else {
            ECFieldElement multiply2 = multiplyPlusProduct.square().multiply(multiply);
            ECFieldElement multiply3 = multiplyPlusProduct.multiply(square4).multiply(square3);
            return new SecT113R2Point(curve, multiply2, multiplyPlusProduct.add(square4).square().multiplyPlusProduct(add, addOne, multiply3), new ECFieldElement[]{multiply3});
        }
    }

    public SecT113R2Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr) {
