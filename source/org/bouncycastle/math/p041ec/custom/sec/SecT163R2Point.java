...
/* renamed from: org.bouncycastle.math.ec.custom.sec.SecT163R2Point */
...
public class SecT163R2Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElement4.isZero()) {
                return new SecT163R2Point(curve, eCFieldElement4, curve.getB().sqrt());
            }
            ...
            if (multiply3.isZero()) {
                return new SecT163R2Point(curve, multiply3, curve.getB().sqrt());
            }
        ...
        return new SecT163R2Point(curve, eCFieldElement4, eCFieldElement6, new ECFieldElement[]{eCFieldElement5});
    }
    ...
    public ECPoint negate() {
        ...
        ECFieldElement eCFieldElement2 = this.f75343y;
        ECFieldElement eCFieldElement3 = this.f75344zs[0];
        return new SecT163R2Point(this.curve, eCFieldElement, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[]{eCFieldElement3});
    }
