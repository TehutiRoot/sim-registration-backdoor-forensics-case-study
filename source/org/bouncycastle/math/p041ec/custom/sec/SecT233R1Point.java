...
/* renamed from: org.bouncycastle.math.ec.custom.sec.SecT233R1Point */
...
public class SecT233R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElement4.isZero()) {
                return new SecT233R1Point(curve, eCFieldElement4, curve.getB().sqrt());
            }
        ...
        return new SecT233R1Point(curve, eCFieldElement4, eCFieldElement6, new ECFieldElement[]{eCFieldElement5});
    }
    ...
    public ECPoint twice() {
        ...
        return new SecT233R1Point(curve, square2, eCFieldElement.squarePlusProduct(add, multiply).add(square2).add(multiply2), new ECFieldElement[]{multiply2});
    }
