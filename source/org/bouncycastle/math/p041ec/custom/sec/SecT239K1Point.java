...
/* renamed from: org.bouncycastle.math.ec.custom.sec.SecT239K1Point */
...
public class SecT239K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (multiply3.isZero()) {
                return new SecT239K1Point(curve, multiply3, curve.getB());
            }
        ...
        return new SecT239K1Point(curve, eCFieldElement4, eCFieldElement6, new ECFieldElement[]{eCFieldElement5});
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        if (square4.isZero()) {
            ...
            return new SecT239K1Point(curve, multiplyPlusProduct, curve.getB());
        } else {
            ECFieldElement multiply2 = multiplyPlusProduct.square().multiply(multiply);
            ECFieldElement multiply3 = multiplyPlusProduct.multiply(square4).multiply(square3);
            return new SecT239K1Point(curve, multiply2, multiplyPlusProduct.add(square4).square().multiplyPlusProduct(add, addOne, multiply3), new ECFieldElement[]{multiply3});
        }
    }
