...
public class SecP128R1Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f75358q = SecP128R1FieldElement.f75361Q;
    ...
    public SecP128R1Curve() {
        ...
        this.f75327a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFDFFFFFFFFFFFFFFFFFFFFFFFC")));
        this.f75328b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("E87579C11079F43DD824993C2CEE5ED3")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat128.copy(((SecP128R1FieldElement) eCPoint.getRawXCoord()).f75362x, 0, iArr, i3);
            Nat128.copy(((SecP128R1FieldElement) eCPoint.getRawYCoord()).f75362x, 0, iArr, i3 + 4);
            i3 += 8;
        }
            ...
            public ECPoint lookup(int i5) {
                ...
                for (int i7 = 0; i7 < i2; i7++) {
                    ...
                    for (int i9 = 0; i9 < 4; i9++) {
                        ...
                        create2[i9] = create2[i9] ^ (iArr2[(i6 + 4) + i9] & i8);
                    }
                    i6 += 8;
                }
