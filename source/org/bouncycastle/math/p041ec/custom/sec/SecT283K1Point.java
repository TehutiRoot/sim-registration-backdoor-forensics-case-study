...
/* renamed from: org.bouncycastle.math.ec.custom.sec.SecT283K1Point */
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElement4.isZero()) {
                return new SecT283K1Point(curve, eCFieldElement4, curve.getB());
            }
            ...
            if (multiply3.isZero()) {
                return new SecT283K1Point(curve, multiply3, curve.getB());
            }
        ...
        return new SecT283K1Point(curve, eCFieldElement4, eCFieldElement6, new ECFieldElement[]{eCFieldElement5});
    }
