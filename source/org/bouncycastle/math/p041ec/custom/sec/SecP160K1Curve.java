...
public class SecP160K1Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f75363q = SecP160R2FieldElement.f75373Q;
    ...
    public SecP160K1Curve() {
        ...
        this.f75327a = fromBigInteger(ECConstants.ZERO);
        this.f75328b = fromBigInteger(BigInteger.valueOf(7L));
