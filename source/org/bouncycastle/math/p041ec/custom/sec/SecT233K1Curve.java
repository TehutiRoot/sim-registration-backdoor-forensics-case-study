...
import org.bouncycastle.math.p041ec.WTauNafMultiplier;
...
public class SecT233K1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT233K1Curve() {
        ...
        this.f75327a = fromBigInteger(BigInteger.valueOf(0L));
        this.f75328b = fromBigInteger(BigInteger.valueOf(1L));
