...
public class SecP256K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP256K1FieldElement secP256K1FieldElement = (SecP256K1FieldElement) this.f75342x;
        SecP256K1FieldElement secP256K1FieldElement2 = (SecP256K1FieldElement) this.f75343y;
        ...
        SecP256K1FieldElement secP256K1FieldElement5 = (SecP256K1FieldElement) this.f75344zs[0];
        ...
        if (isOne) {
            iArr = secP256K1FieldElement3.f75401x;
            iArr2 = secP256K1FieldElement4.f75401x;
        } else {
            SecP256K1Field.square(secP256K1FieldElement5.f75401x, create2);
            SecP256K1Field.multiply(create2, secP256K1FieldElement3.f75401x, create);
            SecP256K1Field.multiply(create2, secP256K1FieldElement5.f75401x, create2);
            SecP256K1Field.multiply(create2, secP256K1FieldElement4.f75401x, create2);
            iArr = create;
            iArr2 = create2;
        }
        boolean isOne2 = secP256K1FieldElement6.isOne();
        if (isOne2) {
            iArr3 = secP256K1FieldElement.f75401x;
            iArr4 = secP256K1FieldElement2.f75401x;
        } else {
            SecP256K1Field.square(secP256K1FieldElement6.f75401x, create3);
            SecP256K1Field.multiply(create3, secP256K1FieldElement.f75401x, createExt);
            SecP256K1Field.multiply(create3, secP256K1FieldElement6.f75401x, create3);
            SecP256K1Field.multiply(create3, secP256K1FieldElement2.f75401x, create3);
            iArr3 = createExt;
            iArr4 = create3;
        }
        ...
        SecP256K1Field.square(create, secP256K1FieldElement7.f75401x);
        int[] iArr5 = secP256K1FieldElement7.f75401x;
        ...
        SecP256K1Field.subtract(create2, secP256K1FieldElement7.f75401x, secP256K1FieldElement8.f75401x);
        SecP256K1Field.multiplyAddToExt(secP256K1FieldElement8.f75401x, create, createExt);
        SecP256K1Field.reduce(createExt, secP256K1FieldElement8.f75401x);
        SecP256K1FieldElement secP256K1FieldElement9 = new SecP256K1FieldElement(create4);
        if (!isOne) {
            int[] iArr6 = secP256K1FieldElement9.f75401x;
            SecP256K1Field.multiply(iArr6, secP256K1FieldElement5.f75401x, iArr6);
        }
        if (!isOne2) {
            int[] iArr7 = secP256K1FieldElement9.f75401x;
            SecP256K1Field.multiply(iArr7, secP256K1FieldElement6.f75401x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP256K1Point(this.curve, this.f75342x, this.f75343y.negate(), this.f75344zs);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP256K1FieldElement secP256K1FieldElement = (SecP256K1FieldElement) this.f75343y;
        if (secP256K1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP256K1FieldElement secP256K1FieldElement2 = (SecP256K1FieldElement) this.f75342x;
        SecP256K1FieldElement secP256K1FieldElement3 = (SecP256K1FieldElement) this.f75344zs[0];
        int[] create = Nat256.create();
        SecP256K1Field.square(secP256K1FieldElement.f75401x, create);
        int[] create2 = Nat256.create();
        SecP256K1Field.square(create, create2);
        int[] create3 = Nat256.create();
        SecP256K1Field.square(secP256K1FieldElement2.f75401x, create3);
        SecP256K1Field.reduce32(Nat256.addBothTo(create3, create3, create3), create3);
        SecP256K1Field.multiply(create, secP256K1FieldElement2.f75401x, create);
        ...
        SecP256K1Field.square(create3, secP256K1FieldElement4.f75401x);
        int[] iArr = secP256K1FieldElement4.f75401x;
        SecP256K1Field.subtract(iArr, create, iArr);
        int[] iArr2 = secP256K1FieldElement4.f75401x;
        SecP256K1Field.subtract(iArr2, create, iArr2);
        SecP256K1FieldElement secP256K1FieldElement5 = new SecP256K1FieldElement(create);
        SecP256K1Field.subtract(create, secP256K1FieldElement4.f75401x, secP256K1FieldElement5.f75401x);
        int[] iArr3 = secP256K1FieldElement5.f75401x;
        SecP256K1Field.multiply(iArr3, create3, iArr3);
        int[] iArr4 = secP256K1FieldElement5.f75401x;
        ...
        SecP256K1Field.twice(secP256K1FieldElement.f75401x, secP256K1FieldElement6.f75401x);
        if (!secP256K1FieldElement3.isOne()) {
            int[] iArr5 = secP256K1FieldElement6.f75401x;
            SecP256K1Field.multiply(iArr5, secP256K1FieldElement3.f75401x, iArr5);
        }
