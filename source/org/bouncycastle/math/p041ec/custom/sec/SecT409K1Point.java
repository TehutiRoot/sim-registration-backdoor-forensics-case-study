...
/* renamed from: org.bouncycastle.math.ec.custom.sec.SecT409K1Point */
...
public class SecT409K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElement4.isZero()) {
                return new SecT409K1Point(curve, eCFieldElement4, curve.getB());
            }
            ...
            if (multiply3.isZero()) {
                return new SecT409K1Point(curve, multiply3, curve.getB());
            }
        ...
        return new SecT409K1Point(curve, eCFieldElement4, eCFieldElement6, new ECFieldElement[]{eCFieldElement5});
    }
    ...
    public ECPoint negate() {
        ...
        ECFieldElement eCFieldElement2 = this.f75343y;
        ECFieldElement eCFieldElement3 = this.f75344zs[0];
        return new SecT409K1Point(this.curve, eCFieldElement, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[]{eCFieldElement3});
    }
    ...
    public ECPoint twice() {
        ...
        if (add.isZero()) {
            return new SecT409K1Point(curve, add, curve.getB());
        }
        ...
        return new SecT409K1Point(curve, square2, square3.add(add).add(square).multiply(square3).add(eCFieldElement3).add(square2).add(multiply), new ECFieldElement[]{multiply});
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        if (square4.isZero()) {
            ...
            return new SecT409K1Point(curve, multiplyPlusProduct, curve.getB());
        } else {
            ECFieldElement multiply2 = multiplyPlusProduct.square().multiply(multiply);
            ECFieldElement multiply3 = multiplyPlusProduct.multiply(square4).multiply(square3);
            return new SecT409K1Point(curve, multiply2, multiplyPlusProduct.add(square4).square().multiplyPlusProduct(add, addOne, multiply3), new ECFieldElement[]{multiply3});
        }
    }
