...
public class SecP384R1FieldElement extends ECFieldElement.AbstractFp {
    ...
    /* renamed from: Q */
    public static final BigInteger f75411Q = new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFF0000000000000000FFFFFFFF"));

    /* renamed from: x */
    protected int[] f75412x;

    public SecP384R1FieldElement() {
        this.f75412x = Nat.create(12);
    }

    @Override // org.bouncycastle.math.p041ec.ECFieldElement
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        int[] create = Nat.create(12);
        SecP384R1Field.add(this.f75412x, ((SecP384R1FieldElement) eCFieldElement).f75412x, create);
    ...
    public ECFieldElement addOne() {
        int[] create = Nat.create(12);
        SecP384R1Field.addOne(this.f75412x, create);
        return new SecP384R1FieldElement(create);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat.create(12);
        SecP384R1Field.inv(((SecP384R1FieldElement) eCFieldElement).f75412x, create);
        SecP384R1Field.multiply(create, this.f75412x, create);
        return new SecP384R1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP384R1FieldElement) {
            return Nat.m24432eq(12, this.f75412x, ((SecP384R1FieldElement) obj).f75412x);
        }
        return false;
    }
    ...
    public int getFieldSize() {
        return f75411Q.bitLength();
    }

    public int hashCode() {
        return f75411Q.hashCode() ^ Arrays.hashCode(this.f75412x, 0, 12);
    }

    @Override // org.bouncycastle.math.p041ec.ECFieldElement
    public ECFieldElement invert() {
        int[] create = Nat.create(12);
        SecP384R1Field.inv(this.f75412x, create);
        return new SecP384R1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p041ec.ECFieldElement
    public boolean isOne() {
        return Nat.isOne(12, this.f75412x);
    }

    @Override // org.bouncycastle.math.p041ec.ECFieldElement
    public boolean isZero() {
        return Nat.isZero(12, this.f75412x);
    }

    @Override // org.bouncycastle.math.p041ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat.create(12);
        SecP384R1Field.multiply(this.f75412x, ((SecP384R1FieldElement) eCFieldElement).f75412x, create);
        return new SecP384R1FieldElement(create);
    }
    ...
    public ECFieldElement negate() {
        int[] create = Nat.create(12);
        SecP384R1Field.negate(this.f75412x, create);
        return new SecP384R1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p041ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f75412x;
        ...
        if (Nat.m24432eq(12, iArr, create2)) {
            return new SecP384R1FieldElement(create);
        }
        return null;
    }
    ...
    public ECFieldElement square() {
        int[] create = Nat.create(12);
        SecP384R1Field.square(this.f75412x, create);
        return new SecP384R1FieldElement(create);
    }
    ...
    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat.create(12);
        SecP384R1Field.subtract(this.f75412x, ((SecP384R1FieldElement) eCFieldElement).f75412x, create);
        return new SecP384R1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p041ec.ECFieldElement
    public boolean testBitZero() {
        return Nat.getBit(this.f75412x, 0) == 1;
    }

    @Override // org.bouncycastle.math.p041ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat.toBigInteger(12, this.f75412x);
    }

    public SecP384R1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f75411Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP384R1FieldElement");
        }
        this.f75412x = SecP384R1Field.fromBigInteger(bigInteger);
    }
