...
/* renamed from: org.bouncycastle.math.ec.custom.sec.SecT409R1Point */
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElement4.isZero()) {
                return new SecT409R1Point(curve, eCFieldElement4, curve.getB().sqrt());
            }
        ...
        return new SecT409R1Point(curve, eCFieldElement4, eCFieldElement6, new ECFieldElement[]{eCFieldElement5});
    }
