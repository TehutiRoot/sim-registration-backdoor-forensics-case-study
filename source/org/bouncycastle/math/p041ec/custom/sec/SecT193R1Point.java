...
/* renamed from: org.bouncycastle.math.ec.custom.sec.SecT193R1Point */
...
public class SecT193R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElement4.isZero()) {
                return new SecT193R1Point(curve, eCFieldElement4, curve.getB().sqrt());
            }
            ...
            if (multiply3.isZero()) {
                return new SecT193R1Point(curve, multiply3, curve.getB().sqrt());
            }
        ...
        return new SecT193R1Point(curve, eCFieldElement4, eCFieldElement6, new ECFieldElement[]{eCFieldElement5});
    }
    ...
    public ECPoint negate() {
        ...
        ECFieldElement eCFieldElement2 = this.f75343y;
        ECFieldElement eCFieldElement3 = this.f75344zs[0];
        return new SecT193R1Point(this.curve, eCFieldElement, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[]{eCFieldElement3});
    }
    ...
    public ECPoint twice() {
        ...
        if (add.isZero()) {
            return new SecT193R1Point(curve, add, curve.getB().sqrt());
        }
        ...
        return new SecT193R1Point(curve, square2, eCFieldElement.squarePlusProduct(add, multiply).add(square2).add(multiply2), new ECFieldElement[]{multiply2});
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        if (square4.isZero()) {
            ...
            return new SecT193R1Point(curve, multiplyPlusProduct, curve.getB().sqrt());
        } else {
            ECFieldElement multiply2 = multiplyPlusProduct.square().multiply(multiply);
            ECFieldElement multiply3 = multiplyPlusProduct.multiply(square4).multiply(square3);
            return new SecT193R1Point(curve, multiply2, multiplyPlusProduct.add(square4).square().multiplyPlusProduct(add, addOne, multiply3), new ECFieldElement[]{multiply3});
        }
    }
