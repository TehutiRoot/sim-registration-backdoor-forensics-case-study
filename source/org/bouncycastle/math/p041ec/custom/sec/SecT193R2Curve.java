...
public class SecT193R2Curve extends ECCurve.AbstractF2m {
    ...
    public SecT193R2Curve() {
        ...
        this.f75327a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("0163F35A5137C2CE3EA6ED8667190B0BC43ECD69977702709B")));
        this.f75328b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("00C9BB9E8927D4D64C377E2AB2856A5B16E3EFB7F61D4316AE")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat256.copy64(((SecT193FieldElement) eCPoint.getRawXCoord()).f75420x, 0, jArr, i3);
            Nat256.copy64(((SecT193FieldElement) eCPoint.getRawYCoord()).f75420x, 0, jArr, i3 + 4);
            i3 += 8;
        }
    ...
    @Override // org.bouncycastle.math.p041ec.ECCurve.AbstractF2m
