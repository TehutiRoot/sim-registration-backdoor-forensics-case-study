...
public class SecP256K1Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f75397q = SecP256K1FieldElement.f75400Q;
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat256.copy(((SecP256K1FieldElement) eCPoint.getRawXCoord()).f75401x, 0, iArr, i3);
            Nat256.copy(((SecP256K1FieldElement) eCPoint.getRawYCoord()).f75401x, 0, iArr, i3 + 8);
            i3 += 16;
        }
