...
public class SecP256K1FieldElement extends ECFieldElement.AbstractFp {
    ...
    /* renamed from: Q */
    public static final BigInteger f75400Q = new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFC2F"));

    /* renamed from: x */
    protected int[] f75401x;

    public SecP256K1FieldElement() {
        this.f75401x = Nat256.create();
    }

    @Override // org.bouncycastle.math.p041ec.ECFieldElement
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        SecP256K1Field.add(this.f75401x, ((SecP256K1FieldElement) eCFieldElement).f75401x, create);
    ...
    public ECFieldElement addOne() {
        int[] create = Nat256.create();
        SecP256K1Field.addOne(this.f75401x, create);
        return new SecP256K1FieldElement(create);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        SecP256K1Field.inv(((SecP256K1FieldElement) eCFieldElement).f75401x, create);
        SecP256K1Field.multiply(create, this.f75401x, create);
        return new SecP256K1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP256K1FieldElement) {
            return Nat256.m24427eq(this.f75401x, ((SecP256K1FieldElement) obj).f75401x);
        }
        return false;
    }
    ...
    public int getFieldSize() {
        return f75400Q.bitLength();
    }

    public int hashCode() {
        return f75400Q.hashCode() ^ Arrays.hashCode(this.f75401x, 0, 8);
    }

    @Override // org.bouncycastle.math.p041ec.ECFieldElement
    public ECFieldElement invert() {
        int[] create = Nat256.create();
        SecP256K1Field.inv(this.f75401x, create);
        return new SecP256K1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p041ec.ECFieldElement
    public boolean isOne() {
        return Nat256.isOne(this.f75401x);
    }

    @Override // org.bouncycastle.math.p041ec.ECFieldElement
    public boolean isZero() {
        return Nat256.isZero(this.f75401x);
    }

    @Override // org.bouncycastle.math.p041ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        SecP256K1Field.multiply(this.f75401x, ((SecP256K1FieldElement) eCFieldElement).f75401x, create);
        return new SecP256K1FieldElement(create);
    }
    ...
    public ECFieldElement negate() {
        int[] create = Nat256.create();
        SecP256K1Field.negate(this.f75401x, create);
        return new SecP256K1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p041ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f75401x;
        ...
        if (Nat256.m24427eq(iArr, create)) {
    ...
    public ECFieldElement square() {
        int[] create = Nat256.create();
        SecP256K1Field.square(this.f75401x, create);
        return new SecP256K1FieldElement(create);
    }
    ...
    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        SecP256K1Field.subtract(this.f75401x, ((SecP256K1FieldElement) eCFieldElement).f75401x, create);
        return new SecP256K1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p041ec.ECFieldElement
    public boolean testBitZero() {
        return Nat256.getBit(this.f75401x, 0) == 1;
    }

    @Override // org.bouncycastle.math.p041ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat256.toBigInteger(this.f75401x);
    }

    public SecP256K1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f75400Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP256K1FieldElement");
        }
        this.f75401x = SecP256K1Field.fromBigInteger(bigInteger);
    }
