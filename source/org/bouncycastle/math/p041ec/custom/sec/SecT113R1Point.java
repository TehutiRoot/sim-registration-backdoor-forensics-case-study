...
public class SecT113R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (multiply3.isZero()) {
                return new SecT113R1Point(curve, multiply3, curve.getB().sqrt());
            }
        ...
        return new SecT113R1Point(curve, eCFieldElement4, eCFieldElement6, new ECFieldElement[]{eCFieldElement5});
    }
