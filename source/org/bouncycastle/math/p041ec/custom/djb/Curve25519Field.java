...
public class Curve25519Field {
    ...
    /* renamed from: M */
    private static final long f75348M = 4294967295L;

    /* renamed from: P7 */
    private static final int f75350P7 = Integer.MAX_VALUE;
    private static final int PInv = 19;

    /* renamed from: P */
    static final int[] f75349P = {-19, -1, -1, -1, -1, -1, -1, Integer.MAX_VALUE};
    ...
    public static void half(int[] iArr, int[] iArr2) {
        ...
        Nat256.add(iArr, f75349P, iArr2);
        Nat.shiftDownBit(8, iArr2, 0);
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f75349P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(8, iArr, f75349P) == 0);
    }
