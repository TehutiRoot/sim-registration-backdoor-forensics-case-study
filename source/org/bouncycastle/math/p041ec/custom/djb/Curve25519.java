...
public class Curve25519 extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f75347q = Curve25519FieldElement.f75351Q;
    ...
    public Curve25519() {
        ...
        this.f75327a = fromBigInteger(C_a);
        this.f75328b = fromBigInteger(C_b);
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat256.copy(((Curve25519FieldElement) eCPoint.getRawXCoord()).f75352x, 0, iArr, i3);
            Nat256.copy(((Curve25519FieldElement) eCPoint.getRawYCoord()).f75352x, 0, iArr, i3 + 8);
            i3 += 16;
        }
