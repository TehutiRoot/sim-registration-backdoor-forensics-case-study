...
public class PKCS12KeyStoreSpi extends KeyStoreSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers, BCKeyStore {
    ...
    public class CertId {
        ...
        public CertId(PublicKey publicKey) {
            this.f75278id = PKCS12KeyStoreSpi.this.createSubjectKeyId(publicKey).getKeyIdentifier();
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof CertId) {
                return Arrays.areEqual(this.f75278id, ((CertId) obj).f75278id);
            }
            return false;
        }

        public int hashCode() {
            return Arrays.hashCode(this.f75278id);
        }
    ...
    */
    ...
    public byte[] cryptData(boolean z, AlgorithmIdentifier algorithmIdentifier, char[] cArr, boolean z2, byte[] bArr) throws IOException {
        ...
        int i = z ? 1 : 2;
        if (algorithm.m24543on(PKCSObjectIdentifiers.pkcs_12PbeIds)) {
