...
public final class DESede {
    ...
    public static class KeyGenerator extends BaseKeyGenerator {
        ...
        public KeyGenerator() {
            super("DESede", CertificateHolderAuthorization.CVCA, new DESedeKeyGenerator());
    ...
    public static class KeyGenerator3 extends BaseKeyGenerator {
        public KeyGenerator3() {
            super("DESede3", CertificateHolderAuthorization.CVCA, new DESedeKeyGenerator());
        }
    }
    ...
    public static class PBEWithSHAAndDES3Key extends BaseBlockCipher {
        public PBEWithSHAAndDES3Key() {
            super(new CBCBlockCipher(new DESedeEngine()), 2, 1, CertificateHolderAuthorization.CVCA, 8);
        }
    }
    ...
    public static class PBEWithSHAAndDES3KeyFactory extends DES.DESPBEKeyFactory {
        public PBEWithSHAAndDES3KeyFactory() {
            super("PBEwithSHAandDES3Key-CBC", PKCSObjectIdentifiers.pbeWithSHAAnd3_KeyTripleDES_CBC, true, 2, 1, CertificateHolderAuthorization.CVCA, 64);
        }
    }
