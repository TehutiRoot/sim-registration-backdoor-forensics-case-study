...
public class BCDSTU4145PrivateKey implements ECPrivateKey, org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    /* renamed from: d */
    private transient BigInteger f75265d;
    ...
    */
    public byte[] getEncoded() {
        ...
        La3:
            ...
            if (r0 == 0) goto Lc2
            org.bouncycastle.asn1.pkcs.PrivateKeyInfo r0 = new org.bouncycastle.asn1.pkcs.PrivateKeyInfo     // Catch: java.io.IOException -> Ldd
            ...
            org.bouncycastle.asn1.ASN1ObjectIdentifier r5 = org.bouncycastle.asn1.p033ua.UAObjectIdentifiers.dstu4145be     // Catch: java.io.IOException -> Ldd
            org.bouncycastle.asn1.ASN1Primitive r1 = r1.toASN1Primitive()     // Catch: java.io.IOException -> Ldd
            r4.<init>(r5, r1)     // Catch: java.io.IOException -> Ldd
            org.bouncycastle.asn1.ASN1Primitive r1 = r3.toASN1Primitive()     // Catch: java.io.IOException -> Ldd
            r0.<init>(r4, r1)     // Catch: java.io.IOException -> Ldd
            goto Ld6
        Lc2:
            org.bouncycastle.asn1.pkcs.PrivateKeyInfo r0 = new org.bouncycastle.asn1.pkcs.PrivateKeyInfo     // Catch: java.io.IOException -> Ldd
            org.bouncycastle.asn1.x509.AlgorithmIdentifier r4 = new org.bouncycastle.asn1.x509.AlgorithmIdentifier     // Catch: java.io.IOException -> Ldd
            org.bouncycastle.asn1.ASN1ObjectIdentifier r5 = org.bouncycastle.asn1.p034x9.X9ObjectIdentifiers.id_ecPublicKey     // Catch: java.io.IOException -> Ldd
            org.bouncycastle.asn1.ASN1Primitive r1 = r1.toASN1Primitive()     // Catch: java.io.IOException -> Ldd
            r4.<init>(r5, r1)     // Catch: java.io.IOException -> Ldd
            org.bouncycastle.asn1.ASN1Primitive r1 = r3.toASN1Primitive()     // Catch: java.io.IOException -> Ldd
            r0.<init>(r4, r1)     // Catch: java.io.IOException -> Ldd
    ...
    public String toString() {
        return ECUtil.privateKeyToString(this.algorithm, this.f75265d, engineGetSpec());
    }
    ...
    public BCDSTU4145PrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f75265d = eCPrivateKeyParameters.getD();
        this.ecSpec = null;
    }
    ...
    public BCDSTU4145PrivateKey(ECPrivateKey eCPrivateKey) {
        this.algorithm = "DSTU4145";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f75265d = eCPrivateKey.getS();
    ...
    public BCDSTU4145PrivateKey(ECPrivateKeySpec eCPrivateKeySpec) {
        this.algorithm = "DSTU4145";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f75265d = eCPrivateKeySpec.getS();
    ...
    public BCDSTU4145PrivateKey(BCDSTU4145PrivateKey bCDSTU4145PrivateKey) {
        this.algorithm = "DSTU4145";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f75265d = bCDSTU4145PrivateKey.f75265d;
    ...
    public BCDSTU4145PrivateKey(org.bouncycastle.jce.spec.ECPrivateKeySpec eCPrivateKeySpec) {
        this.algorithm = "DSTU4145";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f75265d = eCPrivateKeySpec.getD();
