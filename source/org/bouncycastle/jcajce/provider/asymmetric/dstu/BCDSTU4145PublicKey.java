...
import org.bouncycastle.asn1.p033ua.DSTU4145BinaryField;
import org.bouncycastle.asn1.p033ua.DSTU4145ECBinary;
import org.bouncycastle.asn1.p033ua.DSTU4145NamedCurves;
import org.bouncycastle.asn1.p033ua.DSTU4145Params;
import org.bouncycastle.asn1.p033ua.DSTU4145PointEncoder;
import org.bouncycastle.asn1.p033ua.UAObjectIdentifiers;
...
public class BCDSTU4145PublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            ...
            if (this.dstuParams != null) {
                ...
                convertToSpec = this.dstuParams.isNamedCurve() ? new ECNamedCurveSpec(this.dstuParams.getNamedCurve().getId(), convertCurve, convertPoint, eCParameterSpec.getN(), eCParameterSpec.getH()) : new ECParameterSpec(convertCurve, convertPoint, eCParameterSpec.getN(), eCParameterSpec.getH().intValue());
            } else {
    ...
    public org.bouncycastle.math.p041ec.ECPoint getQ() {
        org.bouncycastle.math.p041ec.ECPoint q = this.ecPublicKey.getQ();
