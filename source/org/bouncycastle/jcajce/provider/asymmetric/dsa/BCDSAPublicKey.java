...
public class BCDSAPublicKey implements DSAPublicKey {
    ...
    /* renamed from: y */
    private BigInteger f75264y;

    public BCDSAPublicKey(DSAPublicKey dSAPublicKey) {
        this.f75264y = dSAPublicKey.getY();
        this.dsaSpec = dSAPublicKey.getParams();
        this.lwKeyParams = new DSAPublicKeyParameters(this.f75264y, DSAUtil.toDSAParameters(this.dsaSpec));
    }
    ...
    public String toString() {
        ...
        stringBuffer.append(DSAUtil.generateKeyFingerprint(this.f75264y, getParams()));
        stringBuffer.append("]");
    ...
    public BCDSAPublicKey(DSAPublicKeySpec dSAPublicKeySpec) {
        this.f75264y = dSAPublicKeySpec.getY();
    ...
    public BCDSAPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        try {
            this.f75264y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
    ...
    public BCDSAPublicKey(DSAPublicKeyParameters dSAPublicKeyParameters) {
        this.f75264y = dSAPublicKeyParameters.getY();
