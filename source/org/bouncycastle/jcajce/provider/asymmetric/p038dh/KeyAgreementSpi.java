...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    public byte[] bigIntToBytes(BigInteger bigInteger) {
        int bitLength = (this.f75261p.bitLength() + 7) / 8;
    ...
    public Key engineDoPhase(Key key, boolean z) throws InvalidKeyException, IllegalStateException {
        if (this.f75262x != null) {
            if (key instanceof DHPublicKey) {
                DHPublicKey dHPublicKey = (DHPublicKey) key;
                if (dHPublicKey.getParams().getG().equals(this.f75260g) && dHPublicKey.getParams().getP().equals(this.f75261p)) {
                    BigInteger y = dHPublicKey.getY();
                    if (y != null && y.compareTo(TWO) >= 0) {
                        BigInteger bigInteger = this.f75261p;
                        ...
                        if (y.compareTo(bigInteger.subtract(bigInteger2)) < 0) {
                            if (this.unifiedAgreement != null) {
                                ...
                                BigInteger modPow = y.modPow(this.f75262x, this.f75261p);
    ...
    public void engineInit(Key key, SecureRandom secureRandom) throws InvalidKeyException {
        ...
        this.f75261p = dHPrivateKey.getParams().getP();
        this.f75260g = dHPrivateKey.getParams().getG();
    ...
    public void engineInit(Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (algorithmParameterSpec == null) {
            ...
            this.f75261p = dHParameterSpec.getP();
            this.f75260g = dHParameterSpec.getG();
