...
abstract class X509CRLImpl extends X509CRL {
    ...
    /* renamed from: c */
    protected CertificateList f75276c;
    ...
    private void checkSignature(PublicKey publicKey, Signature signature, ASN1Encodable aSN1Encodable, byte[] bArr) throws NoSuchAlgorithmException, SignatureException, InvalidKeyException, CRLException {
        ...
        try {
            ...
            this.f75276c.getTBSCertList().encodeTo(bufferedOutputStream, ASN1Encoding.DER);
    ...
    private void doVerify(PublicKey publicKey, SignatureCreator signatureCreator) throws CRLException, NoSuchAlgorithmException, InvalidKeyException, SignatureException, NoSuchProviderException {
        if (!this.f75276c.getSignatureAlgorithm().equals(this.f75276c.getTBSCertList().getSignature())) {
            throw new CRLException("Signature algorithm on CertificateList does not match TBSCertList.");
        }
        int i = 0;
        if ((publicKey instanceof CompositePublicKey) && X509SignatureUtil.isCompositeAlgorithm(this.f75276c.getSignatureAlgorithm())) {
            List<PublicKey> publicKeys = ((CompositePublicKey) publicKey).getPublicKeys();
            ASN1Sequence aSN1Sequence = ASN1Sequence.getInstance(this.f75276c.getSignatureAlgorithm().getParameters());
            ASN1Sequence aSN1Sequence2 = ASN1Sequence.getInstance(DERBitString.getInstance(this.f75276c.getSignature()).getBytes());
            boolean z = false;
        ...
        } else if (!X509SignatureUtil.isCompositeAlgorithm(this.f75276c.getSignatureAlgorithm())) {
            ...
            ASN1Sequence aSN1Sequence3 = ASN1Sequence.getInstance(this.f75276c.getSignatureAlgorithm().getParameters());
            ASN1Sequence aSN1Sequence4 = ASN1Sequence.getInstance(DERBitString.getInstance(this.f75276c.getSignature()).getBytes());
            boolean z2 = false;
    ...
    private Set getExtensionOIDs(boolean z) {
        ...
        if (getVersion() != 2 || (extensions = this.f75276c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f75276c.getRevokedCertificateEnumeration();
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f75276c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
            throw new CRLException(e.toString());
        }
    }
    ...
    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f75276c.getIssuer().toASN1Primitive()));
    }

    @Override // java.security.cert.X509CRL
    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f75276c.getIssuer().getEncoded());
    ...
    public Date getNextUpdate() {
        Time nextUpdate = this.f75276c.getNextUpdate();
        if (nextUpdate == null) {
            return null;
        }
    ...
    public String getSigAlgOID() {
        return this.f75276c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public byte[] getSignature() {
        return this.f75276c.getSignature().getOctets();
    }

    @Override // java.security.cert.X509CRL
    public byte[] getTBSCertList() throws CRLException {
        try {
            return this.f75276c.getTBSCertList().getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
            throw new CRLException(e.toString());
        }
    }
    ...
    public Date getThisUpdate() {
        return this.f75276c.getThisUpdate().getDate();
    }

    @Override // java.security.cert.X509CRL
    public int getVersion() {
        return this.f75276c.getVersionNumber();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        if (certificate.getType().equals("X.509")) {
            Enumeration revokedCertificateEnumeration = this.f75276c.getRevokedCertificateEnumeration();
            X500Name issuer2 = this.f75276c.getIssuer();
    ...
    public String toString() {
        ...
        Extensions extensions = this.f75276c.getTBSCertList().getExtensions();
        if (extensions != null) {
            Enumeration oids = extensions.oids();
    ...
    public byte[] getExtensionValue(String str) {
        ASN1OctetString extensionValue = getExtensionValue(this.f75276c, str);
        if (extensionValue != null) {
            try {
