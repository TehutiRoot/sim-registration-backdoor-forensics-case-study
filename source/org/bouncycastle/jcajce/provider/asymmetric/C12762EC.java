...
import org.bouncycastle.jcajce.provider.asymmetric.p039ec.KeyFactorySpi;
...
public class C12762EC {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            registerOid(configurableProvider, aSN1ObjectIdentifier11, "EC", new KeyFactorySpi.C12769EC());
            registerOid(configurableProvider, aSN1ObjectIdentifier2, "EC", new KeyFactorySpi.C12769EC());
            ...
            registerOid(configurableProvider, aSN1ObjectIdentifier3, "EC", new KeyFactorySpi.C12769EC());
            registerOid(configurableProvider, aSN1ObjectIdentifier4, "EC", new KeyFactorySpi.C12769EC());
            registerOid(configurableProvider, aSN1ObjectIdentifier5, "EC", new KeyFactorySpi.C12769EC());
            registerOid(configurableProvider, aSN1ObjectIdentifier6, "EC", new KeyFactorySpi.C12769EC());
            registerOid(configurableProvider, aSN1ObjectIdentifier7, "EC", new KeyFactorySpi.C12769EC());
            registerOid(configurableProvider, aSN1ObjectIdentifier8, "EC", new KeyFactorySpi.C12769EC());
            registerOid(configurableProvider, aSN1ObjectIdentifier9, "EC", new KeyFactorySpi.C12769EC());
            registerOid(configurableProvider, aSN1ObjectIdentifier10, "EC", new KeyFactorySpi.C12769EC());
            ...
            if (!Properties.isOverrideSet("org.bouncycastle.ec.disable_mqv")) {
                ...
                registerOid(configurableProvider, aSN1ObjectIdentifier, "EC", new KeyFactorySpi.C12769EC());
