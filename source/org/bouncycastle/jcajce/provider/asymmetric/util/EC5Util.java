...
import org.bouncycastle.asn1.p034x9.ECNamedCurveTable;
import org.bouncycastle.asn1.p034x9.X962Parameters;
import org.bouncycastle.asn1.p034x9.X9ECParameters;
import org.bouncycastle.crypto.p035ec.CustomNamedCurves;
...
public class EC5Util {
    ...
    static {
        ...
        customCurves.put(new ECCurve.C12824Fp(curve.getField().getCharacteristic(), curve.getA().toBigInteger(), curve.getB().toBigInteger(), curve.getOrder(), curve.getCofactor()), curve);
    }
    ...
    public static ECPoint convertPoint(org.bouncycastle.math.p041ec.ECPoint eCPoint) {
        org.bouncycastle.math.p041ec.ECPoint normalize = eCPoint.normalize();
    ...
    public static ECCurve convertCurve(EllipticCurve ellipticCurve) {
        ...
        if (field instanceof ECFieldFp) {
            ECCurve.C12824Fp c12824Fp = new ECCurve.C12824Fp(((ECFieldFp) field).getP(), a, b);
            return customCurves.containsKey(c12824Fp) ? (ECCurve) customCurves.get(c12824Fp) : c12824Fp;
        }
    ...
    public static org.bouncycastle.math.p041ec.ECPoint convertPoint(ECParameterSpec eCParameterSpec, ECPoint eCPoint) {
    ...
    public static org.bouncycastle.jce.spec.ECParameterSpec convertSpec(ECParameterSpec eCParameterSpec) {
        ...
        org.bouncycastle.math.p041ec.ECPoint convertPoint = convertPoint(convertCurve, eCParameterSpec.getGenerator());
    ...
    public static org.bouncycastle.math.p041ec.ECPoint convertPoint(ECCurve eCCurve, ECPoint eCPoint) {
