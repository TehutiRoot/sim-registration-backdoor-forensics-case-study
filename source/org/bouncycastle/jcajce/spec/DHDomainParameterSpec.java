...
public class DHDomainParameterSpec extends DHParameterSpec {
    ...
    /* renamed from: j */
    private final BigInteger f75288j;

    /* renamed from: m */
    private final int f75289m;

    /* renamed from: q */
    private final BigInteger f75290q;
    ...
    public DHParameters getDomainParameters() {
        return new DHParameters(getP(), getG(), this.f75290q, this.f75289m, getL(), this.f75288j, this.validationParameters);
    }
    ...
    public DHDomainParameterSpec(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4, int i, int i2) {
        ...
        this.f75290q = bigInteger2;
        this.f75288j = bigInteger4;
        this.f75289m = i;
    }
