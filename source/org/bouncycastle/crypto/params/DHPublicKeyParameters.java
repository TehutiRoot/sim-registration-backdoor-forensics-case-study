...
public class DHPublicKeyParameters extends DHKeyParameters {
    ...
    /* renamed from: y */
    private BigInteger f75187y;

    public DHPublicKeyParameters(BigInteger bigInteger, DHParameters dHParameters) {
        super(false, dHParameters);
        this.f75187y = validate(bigInteger, dHParameters);
    }
    ...
    public boolean equals(Object obj) {
        return (obj instanceof DHPublicKeyParameters) && ((DHPublicKeyParameters) obj).getY().equals(this.f75187y) && super.equals(obj);
    }
    ...
    @Override // org.bouncycastle.crypto.params.DHKeyParameters
    public int hashCode() {
        return this.f75187y.hashCode() ^ super.hashCode();
    }
}
