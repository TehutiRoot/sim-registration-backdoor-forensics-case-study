...
public class DHParameters implements CipherParameters {
    ...
    /* renamed from: g */
    private BigInteger f75180g;

    /* renamed from: j */
    private BigInteger f75181j;
    ...
    /* renamed from: p */
    private BigInteger f75184p;

    /* renamed from: q */
    private BigInteger f75185q;
    ...
    public boolean equals(Object obj) {
        if (obj instanceof DHParameters) {
            ...
            return dHParameters.getP().equals(this.f75184p) && dHParameters.getG().equals(this.f75180g);
        }
        return false;
    }
    ...
    public DHParameters(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, int i, int i2, BigInteger bigInteger4, DHValidationParameters dHValidationParameters) {
        ...
        this.f75180g = bigInteger2;
        this.f75184p = bigInteger;
        this.f75185q = bigInteger3;
        this.f75183m = i;
        this.f75182l = i2;
        this.f75181j = bigInteger4;
