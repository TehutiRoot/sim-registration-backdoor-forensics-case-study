...
public class DSTU7624Mac implements Mac {
    ...
    private void processBlock(byte[] bArr, int i) {
        xor(this.f75080c, 0, bArr, i, this.cTemp);
        this.engine.processBlock(this.cTemp, 0, this.f75080c, 0);
    }
    ...
    public int doFinal(byte[] bArr, int i) throws DataLengthException, IllegalStateException {
        ...
        if (i2 % bArr2.length == 0) {
            xor(this.f75080c, 0, bArr2, 0, this.cTemp);
            xor(this.cTemp, 0, this.kDelta, 0, this.f75080c);
            DSTU7624Engine dSTU7624Engine = this.engine;
            byte[] bArr3 = this.f75080c;
            dSTU7624Engine.processBlock(bArr3, 0, bArr3, 0);
            int i3 = this.macSize;
            if (i3 + i <= bArr.length) {
                System.arraycopy(this.f75080c, 0, bArr, i, i3);
                reset();
                return this.macSize;
            }
    ...
    @Override // org.bouncycastle.crypto.Mac
    public void reset() {
        Arrays.fill(this.f75080c, (byte) 0);
