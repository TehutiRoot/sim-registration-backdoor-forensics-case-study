...
public class JPAKEExample {
    ...
    public static void main(String[] strArr) throws CryptoException {
        ...
        printStream.println("");
        printStream.println("(Secret passwords used by Alice and Bob: \"" + HintConstants.AUTOFILL_HINT_PASSWORD + "\" and \"" + HintConstants.AUTOFILL_HINT_PASSWORD + "\")\n");
        SHA256Digest sHA256Digest = new SHA256Digest();
        ...
        sb2.append("g^{x3}=");
        sb2.append(createRound1PayloadToSend2.getGx1().toString(16));
        ...
        sb3.append("B=");
        sb3.append(createRound2PayloadToSend2.getA().toString(16));
