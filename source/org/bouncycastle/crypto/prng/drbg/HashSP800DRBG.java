...
public class HashSP800DRBG implements SP80090DRBG {
    ...
    /* renamed from: _C */
    private byte[] f75247_C;

    /* renamed from: _V */
    private byte[] f75248_V;
    ...
    public int generate(byte[] bArr, byte[] bArr2, boolean z) {
        ...
        if (length <= 262144) {
            ...
            if (bArr2 != null) {
                byte[] bArr3 = this.f75248_V;
                byte[] bArr4 = new byte[bArr3.length + 1 + bArr2.length];
                bArr4[0] = 2;
                System.arraycopy(bArr3, 0, bArr4, 1, bArr3.length);
                System.arraycopy(bArr2, 0, bArr4, this.f75248_V.length + 1, bArr2.length);
                addTo(this.f75248_V, hash(bArr4));
            }
            byte[] hashgen = hashgen(this.f75248_V, length);
            byte[] bArr5 = this.f75248_V;
            byte[] bArr6 = new byte[bArr5.length + 1];
            System.arraycopy(bArr5, 0, bArr6, 1, bArr5.length);
            bArr6[0] = 3;
            addTo(this.f75248_V, hash(bArr6));
            addTo(this.f75248_V, this.f75247_C);
            addTo(this.f75248_V, new byte[]{(byte) (j >> 24), (byte) (j >> 16), (byte) (j >> 8), (byte) this._reseedCounter});
            this._reseedCounter++;
    ...
    public void reseed(byte[] bArr) {
        byte[] hash_df = Utils.hash_df(this._digest, Arrays.concatenate(ONE, this.f75248_V, getEntropy(), bArr), this._seedLength);
        this.f75248_V = hash_df;
        byte[] bArr2 = new byte[hash_df.length + 1];
        bArr2[0] = 0;
        System.arraycopy(hash_df, 0, bArr2, 1, hash_df.length);
        this.f75247_C = Utils.hash_df(this._digest, bArr2, this._seedLength);
        this._reseedCounter = 1L;
    }
}
