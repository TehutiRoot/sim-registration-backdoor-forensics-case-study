...
public class HMacSP800DRBG implements SP80090DRBG {
    ...
    /* renamed from: _K */
    private byte[] f75245_K;

    /* renamed from: _V */
    private byte[] f75246_V;
    ...
    private void hmac_DRBG_Update_Func(byte[] bArr, byte b) {
        this._hMac.init(new KeyParameter(this.f75245_K));
        Mac mac = this._hMac;
        byte[] bArr2 = this.f75246_V;
        mac.update(bArr2, 0, bArr2.length);
        this._hMac.update(b);
        if (bArr != null) {
            this._hMac.update(bArr, 0, bArr.length);
        }
        this._hMac.doFinal(this.f75245_K, 0);
        this._hMac.init(new KeyParameter(this.f75245_K));
        Mac mac2 = this._hMac;
        byte[] bArr3 = this.f75246_V;
        mac2.update(bArr3, 0, bArr3.length);
        this._hMac.doFinal(this.f75246_V, 0);
    }
