...
public class DualECSP800DRBG implements SP80090DRBG {
    ...
    /* renamed from: _P */
    private ECPoint f75242_P;

    /* renamed from: _Q */
    private ECPoint f75243_Q;
    private ECCurve.C12824Fp _curve;
    ...
    static {
        ...
        nistPoints = r2;
        ECCurve.C12824Fp c12824Fp = (ECCurve.C12824Fp) NISTNamedCurves.getByName("P-256").getCurve();
        ECCurve.C12824Fp c12824Fp2 = (ECCurve.C12824Fp) NISTNamedCurves.getByName("P-384").getCurve();
        ECCurve.C12824Fp c12824Fp3 = (ECCurve.C12824Fp) NISTNamedCurves.getByName("P-521").getCurve();
        DualECPoints[] dualECPointsArr = {new DualECPoints(128, c12824Fp.createPoint(bigInteger, bigInteger2), c12824Fp.createPoint(bigInteger3, bigInteger4), 1), new DualECPoints(CertificateHolderAuthorization.CVCA, c12824Fp2.createPoint(bigInteger5, bigInteger6), c12824Fp2.createPoint(bigInteger7, bigInteger8), 1), new DualECPoints(256, c12824Fp3.createPoint(bigInteger9, bigInteger10), c12824Fp3.createPoint(bigInteger11, bigInteger12), 1)};
    }
    ...
    public int generate(byte[] bArr, byte[] bArr2, boolean z) {
        ...
        BigInteger bigInteger = bArr2 != null ? new BigInteger(1, xor(this.f75244_s, Utils.hash_df(this._digest, bArr2, this._seedlen))) : new BigInteger(1, this.f75244_s);
        int i = 0;
        Arrays.fill(bArr, (byte) 0);
        int i2 = 0;
        for (int i3 = 0; i3 < length2; i3++) {
            bigInteger = getScalarMultipleXCoord(this.f75242_P, bigInteger);
            byte[] byteArray = getScalarMultipleXCoord(this.f75243_Q, bigInteger).toByteArray();
        ...
        if (i2 < bArr.length) {
            bigInteger = getScalarMultipleXCoord(this.f75242_P, bigInteger);
            byte[] byteArray2 = getScalarMultipleXCoord(this.f75243_Q, bigInteger).toByteArray();
        ...
        this.f75244_s = BigIntegers.asUnsignedByteArray(this._sLength, getScalarMultipleXCoord(this.f75242_P, bigInteger));
        return length;
    }
    ...
    public void reseed(byte[] bArr) {
        ...
        this.f75244_s = Utils.hash_df(this._digest, Arrays.concatenate(pad8(this.f75244_s, this._seedlen), getEntropy(), bArr), this._seedlen);
        this._reseedCounter = 0L;
    }

    /* JADX WARN: Code restructure failed: missing block: B:20:0x0076, code lost:
        if (r2.f75242_P == null) goto L22;
     */
    ...
    */
    public DualECSP800DRBG(org.bouncycastle.crypto.prng.drbg.DualECPoints[] r3, org.bouncycastle.crypto.Digest r4, int r5, org.bouncycastle.crypto.prng.EntropySource r6, byte[] r7, byte[] r8) {
        ...
        L71:
            ...
            goto L2f
        L74:
            org.bouncycastle.math.ec.ECPoint r3 = r2.f75242_P
            if (r3 == 0) goto L8a
