...
public class X931RNG {
    ...
    /* renamed from: DT */
    private final byte[] f75235DT;

    /* renamed from: I */
    private final byte[] f75236I;

    /* renamed from: R */
    private final byte[] f75237R;

    /* renamed from: V */
    private byte[] f75238V;
    ...
    public X931RNG(BlockCipher blockCipher, byte[] bArr, EntropySource entropySource) {
        ...
        this.f75236I = new byte[blockCipher.getBlockSize()];
        this.f75237R = new byte[blockCipher.getBlockSize()];
    }
    ...
    public int generate(byte[] bArr, boolean z) {
        ...
        if (z || this.f75238V == null) {
            byte[] entropy = this.entropySource.getEntropy();
            this.f75238V = entropy;
            if (entropy.length != this.engine.getBlockSize()) {
                throw new IllegalStateException("Insufficient entropy returned");
            }
        }
        int length = bArr.length / this.f75237R.length;
        for (int i = 0; i < length; i++) {
            this.engine.processBlock(this.f75235DT, 0, this.f75236I, 0);
            process(this.f75237R, this.f75236I, this.f75238V);
            process(this.f75238V, this.f75237R, this.f75236I);
            byte[] bArr2 = this.f75237R;
            System.arraycopy(bArr2, 0, bArr, bArr2.length * i, bArr2.length);
            increment(this.f75235DT);
        }
        int length2 = bArr.length - (this.f75237R.length * length);
        if (length2 > 0) {
            this.engine.processBlock(this.f75235DT, 0, this.f75236I, 0);
            process(this.f75237R, this.f75236I, this.f75238V);
            process(this.f75238V, this.f75237R, this.f75236I);
            byte[] bArr3 = this.f75237R;
