...
public class VMPCRandomGenerator implements RandomGenerator {
    ...
    public void addSeedMaterial(byte[] bArr) {
        for (byte b : bArr) {
            byte[] bArr2 = this.f75232P;
            byte b2 = this.f75234s;
            byte b3 = this.f75233n;
            byte b4 = bArr2[(b2 + bArr2[b3 & 255] + b) & 255];
            this.f75234s = b4;
            byte b5 = bArr2[b3 & 255];
            bArr2[b3 & 255] = bArr2[b4 & 255];
            bArr2[b4 & 255] = b5;
            this.f75233n = (byte) ((b3 + 1) & 255);
        }
    }

    @Override // org.bouncycastle.crypto.prng.RandomGenerator
    public void nextBytes(byte[] bArr, int i, int i2) {
        synchronized (this.f75232P) {
            int i3 = i2 + i;
            while (i != i3) {
                try {
                    byte[] bArr2 = this.f75232P;
                    byte b = this.f75234s;
                    byte b2 = this.f75233n;
