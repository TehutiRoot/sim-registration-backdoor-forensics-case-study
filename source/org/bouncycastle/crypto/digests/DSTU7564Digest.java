...
public class DSTU7564Digest implements ExtendedDigest, Memoable {
    ...
    /* renamed from: P */
    private void m24537P(long[] jArr) {
    ...
    /* renamed from: Q */
    private void m24536Q(long[] jArr) {
        for (int i = 0; i < this.rounds; i++) {
    ...
    private void processBlock(byte[] bArr, int i) {
        ...
        m24537P(this.tempState1);
        m24536Q(this.tempState2);
