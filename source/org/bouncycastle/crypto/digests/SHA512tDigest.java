...
public class SHA512tDigest extends LongDigest {
    ...
    */
    ...
    public int doFinal(byte[] bArr, int i) {
        finish();
        longToBigEndian(this.f74823H1, bArr, i, this.digestLength);
        longToBigEndian(this.f74824H2, bArr, i + 8, this.digestLength - 8);
        longToBigEndian(this.f74825H3, bArr, i + 16, this.digestLength - 16);
        longToBigEndian(this.f74826H4, bArr, i + 24, this.digestLength - 24);
        longToBigEndian(this.f74827H5, bArr, i + 32, this.digestLength - 32);
        longToBigEndian(this.f74828H6, bArr, i + 40, this.digestLength - 40);
        longToBigEndian(this.f74829H7, bArr, i + 48, this.digestLength - 48);
        longToBigEndian(this.f74830H8, bArr, i + 56, this.digestLength - 56);
        reset();
    ...
    public void reset() {
        super.reset();
        this.f74823H1 = this.H1t;
        this.f74824H2 = this.H2t;
        this.f74825H3 = this.H3t;
        this.f74826H4 = this.H4t;
        this.f74827H5 = this.H5t;
        this.f74828H6 = this.H6t;
        this.f74829H7 = this.H7t;
        this.f74830H8 = this.H8t;
    }
