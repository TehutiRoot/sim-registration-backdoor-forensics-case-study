...
public class KDFFeedbackBytesGenerator implements MacDerivationFunction {
    ...
    /* renamed from: h */
    private final int f75074h;
    private byte[] ios;

    /* renamed from: iv */
    private byte[] f75075iv;

    /* renamed from: k */
    private byte[] f75076k;
    ...
    public KDFFeedbackBytesGenerator(Mac mac) {
        ...
        this.f75074h = macSize;
        this.f75076k = new byte[macSize];
    }

    private void generateNext() {
        if (this.generatedBytes == 0) {
            Mac mac = this.prf;
            byte[] bArr = this.f75075iv;
            mac.update(bArr, 0, bArr.length);
        } else {
            Mac mac2 = this.prf;
            byte[] bArr2 = this.f75076k;
            mac2.update(bArr2, 0, bArr2.length);
        }
        if (this.useCounter) {
            int i = (this.generatedBytes / this.f75074h) + 1;
            byte[] bArr3 = this.ios;
        ...
        this.prf.doFinal(this.f75076k, 0);
    }
    ...
    public int generateBytes(byte[] bArr, int i, int i2) throws DataLengthException, IllegalArgumentException {
        ...
        System.arraycopy(this.f75076k, i7, bArr, i, min);
        ...
        while (true) {
            ...
            generateNext();
            min = Math.min(this.f75074h, i8);
            System.arraycopy(this.f75076k, 0, bArr, i, min);
            this.generatedBytes += min;
            i8 -= min;
        }
    }
    ...
    public void init(DerivationParameters derivationParameters) {
        ...
        if (kDFFeedbackParameters.useCounter()) {
            BigInteger multiply = TWO.pow(r).multiply(BigInteger.valueOf(this.f75074h));
            if (multiply.compareTo(INTEGER_MAX) != 1) {
                i = multiply.intValue();
            }
        }
        this.maxSizeExcl = i;
        this.f75075iv = kDFFeedbackParameters.getIV();
