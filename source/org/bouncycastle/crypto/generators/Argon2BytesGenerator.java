...
public class Argon2BytesGenerator {
    ...
    public static class Block {
        ...
        /* renamed from: v */
        private final long[] f75060v;

        private Block() {
            this.f75060v = new long[128];
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void copyBlock(Block block) {
            System.arraycopy(block.f75060v, 0, this.f75060v, 0, 128);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void xor(Block block, Block block2) {
            long[] jArr = this.f75060v;
            long[] jArr2 = block.f75060v;
            long[] jArr3 = block2.f75060v;
            for (int i = 0; i < 128; i++) {
        ...
        public void fromBytes(byte[] bArr) {
            ...
            Pack.littleEndianToLong(bArr, 0, this.f75060v);
        }
        ...
        public void toBytes(byte[] bArr) {
            ...
            Pack.longToLittleEndian(this.f75060v, bArr, 0);
        }
    ...
    public static class FillBlock {
        ...
        private FillBlock() {
            this.f75061R = new Block();
            this.f75062Z = new Block();
        ...
        private void applyBlake() {
            for (int i = 0; i < 8; i++) {
                int i2 = i * 16;
                Argon2BytesGenerator.roundFunction(this.f75062Z, i2, i2 + 1, i2 + 2, i2 + 3, i2 + 4, i2 + 5, i2 + 6, i2 + 7, i2 + 8, i2 + 9, i2 + 10, i2 + 11, i2 + 12, i2 + 13, i2 + 14, i2 + 15);
            }
            for (int i3 = 0; i3 < 8; i3++) {
                int i4 = i3 * 2;
                Argon2BytesGenerator.roundFunction(this.f75062Z, i4, i4 + 1, i4 + 16, i4 + 17, i4 + 32, i4 + 33, i4 + 48, i4 + 49, i4 + 64, i4 + 65, i4 + 80, i4 + 81, i4 + 96, i4 + 97, i4 + 112, i4 + 113);
            }
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void fillBlock(Block block, Block block2) {
            this.f75062Z.copyBlock(block);
            applyBlake();
            block2.xor(block, this.f75062Z);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void fillBlockWithXor(Block block, Block block2, Block block3) {
            this.f75061R.xor(block, block2);
            this.f75062Z.copyBlock(this.f75061R);
            applyBlake();
            block3.xorWith(this.f75061R, this.f75062Z);
        }
        ...
        public void fillBlock(Block block, Block block2, Block block3) {
            ...
            this.f75062Z.copyBlock(this.f75061R);
            applyBlake();
            block3.xor(this.f75061R, this.f75062Z);
        }
    }
    ...
    /* renamed from: F */
    private static void m24446F(long[] jArr, int i, int i2, int i3, int i4) {
    ...
    private void fillSegment(FillBlock fillBlock, Position position) {
        ...
        while (i2 < this.segmentLength) {
            long pseudoRandom = getPseudoRandom(fillBlock, i2, block, block2, i4, isDataIndependentAddressing);
    ...
    private long getPseudoRandom(FillBlock fillBlock, int i, Block block, Block block2, int i2, boolean z) {
        if (z) {
            ...
            return block.f75060v[i3];
        }
        return this.memory[i2].f75060v[0];
    }
    ...
    private void initAddressBlocks(FillBlock fillBlock, Position position, Block block, Block block2) {
        block.f75060v[0] = intToLong(position.pass);
        block.f75060v[1] = intToLong(position.lane);
        block.f75060v[2] = intToLong(position.slice);
        block.f75060v[3] = intToLong(this.memory.length);
        block.f75060v[4] = intToLong(this.parameters.getIterations());
        block.f75060v[5] = intToLong(this.parameters.getType());
    ...
    private static void quarterRound(long[] jArr, int i, int i2, int i3, int i4) {
        ...
        long rotateRight = Longs.rotateRight(jArr[i3] ^ j3, i4);
        jArr[i] = j3;
        jArr[i3] = rotateRight;
    }
    ...
    public static void roundFunction(Block block, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, int i13, int i14, int i15, int i16) {
        long[] jArr = block.f75060v;
        m24446F(jArr, i, i5, i9, i13);
        m24446F(jArr, i2, i6, i10, i14);
        m24446F(jArr, i3, i7, i11, i15);
        m24446F(jArr, i4, i8, i12, i16);
        m24446F(jArr, i, i6, i11, i16);
        m24446F(jArr, i2, i7, i12, i13);
        m24446F(jArr, i3, i8, i9, i14);
        m24446F(jArr, i4, i5, i10, i15);
    }
