...
public class KDFCounterBytesGenerator implements MacDerivationFunction {
    ...
    /* renamed from: h */
    private final int f75069h;
    private byte[] ios;

    /* renamed from: k */
    private byte[] f75070k;
    ...
    public KDFCounterBytesGenerator(Mac mac) {
        ...
        this.f75069h = macSize;
        this.f75070k = new byte[macSize];
    }

    private void generateNext() {
        int i = (this.generatedBytes / this.f75069h) + 1;
        byte[] bArr = this.ios;
        ...
        this.prf.doFinal(this.f75070k, 0);
    }
    ...
    public int generateBytes(byte[] bArr, int i, int i2) throws DataLengthException, IllegalArgumentException {
        ...
        System.arraycopy(this.f75070k, i7, bArr, i, min);
        ...
        while (true) {
            ...
            generateNext();
            min = Math.min(this.f75069h, i8);
            System.arraycopy(this.f75070k, 0, bArr, i, min);
            this.generatedBytes += min;
            i8 -= min;
        }
    }
    ...
    public void init(DerivationParameters derivationParameters) {
        ...
        BigInteger multiply = TWO.pow(r).multiply(BigInteger.valueOf(this.f75069h));
