...
public class KDFDoublePipelineIterationBytesGenerator implements MacDerivationFunction {
    ...
    /* renamed from: a */
    private byte[] f75071a;
    private byte[] fixedInputData;
    private int generatedBytes;

    /* renamed from: h */
    private final int f75072h;
    private byte[] ios;

    /* renamed from: k */
    private byte[] f75073k;
    ...
    public KDFDoublePipelineIterationBytesGenerator(Mac mac) {
        ...
        this.f75072h = macSize;
        this.f75071a = new byte[macSize];
        this.f75073k = new byte[macSize];
    }
    ...
    private void generateNext() {
        if (this.generatedBytes == 0) {
            ...
            this.prf.doFinal(this.f75071a, 0);
        } else {
            Mac mac2 = this.prf;
            byte[] bArr2 = this.f75071a;
            mac2.update(bArr2, 0, bArr2.length);
            this.prf.doFinal(this.f75071a, 0);
        }
        Mac mac3 = this.prf;
        byte[] bArr3 = this.f75071a;
        mac3.update(bArr3, 0, bArr3.length);
        if (this.useCounter) {
            int i = (this.generatedBytes / this.f75072h) + 1;
            byte[] bArr4 = this.ios;
        ...
        this.prf.doFinal(this.f75073k, 0);
    }
    ...
    public int generateBytes(byte[] bArr, int i, int i2) throws DataLengthException, IllegalArgumentException {
        ...
        System.arraycopy(this.f75073k, i7, bArr, i, min);
        ...
        while (true) {
            ...
            generateNext();
            min = Math.min(this.f75072h, i8);
            System.arraycopy(this.f75073k, 0, bArr, i, min);
            this.generatedBytes += min;
            i8 -= min;
        }
    }
    ...
    public void init(DerivationParameters derivationParameters) {
        ...
        if (kDFDoublePipelineIterationParameters.useCounter()) {
            BigInteger multiply = TWO.pow(r).multiply(BigInteger.valueOf(this.f75072h));
