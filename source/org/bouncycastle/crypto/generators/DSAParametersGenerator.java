...
public class DSAParametersGenerator {
        ...
        while (true) {
            ...
            if (isProbablePrime(bigInteger)) {
                ...
                while (i6 < 4096) {
                    ...
                    if (subtract.bitLength() == this.f75067L && isProbablePrime(subtract)) {
    ...
    private DSAParameters generateParameters_FIPS186_3() {
        ...
        byte[] bArr = new byte[this.f75068N / 8];
        int i2 = this.f75067L;
        ...
        loop0: while (true) {
            ...
            bit = new BigInteger(1, bArr3).mod(ONE.shiftLeft(this.f75068N - 1)).setBit(0).setBit(this.f75068N - 1);
            if (isProbablePrime(bit)) {
                byte[] clone = Arrays.clone(bArr);
                int i7 = this.f75067L * 4;
                i = 0;
                while (i < i7) {
    ...
    public void init(int i, int i2, SecureRandom secureRandom) {
        this.f75067L = i;
        this.f75068N = getDefaultN(i);
        this.certainty = i2;
        this.iterations = Math.max(getMinimumIterations(this.f75067L), (i2 + 1) / 2);
