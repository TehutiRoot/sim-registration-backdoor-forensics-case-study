...
public class PKCS12ParametersGenerator extends PBEParametersGenerator {
    ...
    public PKCS12ParametersGenerator(Digest digest) {
        ...
        if (digest instanceof ExtendedDigest) {
            this.f75077u = digest.getDigestSize();
            this.f75078v = ((ExtendedDigest) digest).getByteLength();
            return;
        }
    ...
    private byte[] generateDerivedKey(int i, int i2) {
        ...
        int i10 = this.f75078v;
        byte[] bArr10 = new byte[i10];
        int i11 = this.f75077u;
        ...
        while (i13 <= i12) {
            ...
            if (i13 == i12) {
                int i18 = i13 - 1;
                int i19 = this.f75077u;
                System.arraycopy(bArr11, 0, bArr4, i18 * i19, i2 - (i18 * i19));
            } else {
                System.arraycopy(bArr11, 0, bArr4, (i13 - 1) * this.f75077u, i11);
            }
            i13++;
            i4 = 0;
        }
