...
public class JPAKEPrimeOrderGroup {
    ...
    /* renamed from: g */
    private final BigInteger f74755g;

    /* renamed from: p */
    private final BigInteger f74756p;

    /* renamed from: q */
    private final BigInteger f74757q;
    ...
    public JPAKEPrimeOrderGroup(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, boolean z) {
        ...
        this.f74756p = bigInteger;
        this.f74757q = bigInteger2;
        this.f74755g = bigInteger3;
    }
}
