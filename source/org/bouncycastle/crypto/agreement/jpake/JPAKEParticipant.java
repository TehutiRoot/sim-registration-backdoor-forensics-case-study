...
public class JPAKEParticipant {
    ...
    /* renamed from: b */
    private BigInteger f74749b;
    private final Digest digest;

    /* renamed from: g */
    private final BigInteger f74750g;
    ...
    /* renamed from: p */
    private final BigInteger f74751p;
    private final String participantId;
    private String partnerParticipantId;
    private char[] password;

    /* renamed from: q */
    private final BigInteger f74752q;
    private final SecureRandom random;
    private int state;

    /* renamed from: x1 */
    private BigInteger f74753x1;

    /* renamed from: x2 */
    private BigInteger f74754x2;
    ...
    public BigInteger calculateKeyingMaterial() {
        ...
        if (i >= 50) {
            ...
            this.password = null;
            BigInteger calculateKeyingMaterial = JPAKEUtil.calculateKeyingMaterial(this.f74751p, this.f74752q, this.gx4, this.f74754x2, calculateS, this.f74749b);
            this.f74753x1 = null;
            this.f74754x2 = null;
            this.f74749b = null;
            this.state = 50;
    ...
    public JPAKERound1Payload createRound1PayloadToSend() {
        ...
        this.f74753x1 = JPAKEUtil.generateX1(this.f74752q, this.random);
        this.f74754x2 = JPAKEUtil.generateX2(this.f74752q, this.random);
        this.gx1 = JPAKEUtil.calculateGx(this.f74751p, this.f74750g, this.f74753x1);
        this.gx2 = JPAKEUtil.calculateGx(this.f74751p, this.f74750g, this.f74754x2);
        BigInteger[] calculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f74751p, this.f74752q, this.f74750g, this.gx1, this.f74753x1, this.participantId, this.digest, this.random);
        BigInteger[] calculateZeroKnowledgeProof2 = JPAKEUtil.calculateZeroKnowledgeProof(this.f74751p, this.f74752q, this.f74750g, this.gx2, this.f74754x2, this.participantId, this.digest, this.random);
        this.state = 10;
    ...
    public JPAKERound2Payload createRound2PayloadToSend() {
        ...
        if (i >= 30) {
            ...
            BigInteger calculateGA = JPAKEUtil.calculateGA(this.f74751p, this.gx1, this.gx3, this.gx4);
            BigInteger calculateX2s = JPAKEUtil.calculateX2s(this.f74752q, this.f74754x2, JPAKEUtil.calculateS(this.password));
            BigInteger calculateA = JPAKEUtil.calculateA(this.f74751p, this.f74752q, calculateGA, calculateX2s);
            BigInteger[] calculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f74751p, this.f74752q, calculateGA, calculateA, calculateX2s, this.participantId, this.digest, this.random);
            this.state = 30;
    ...
    public void validateRound1PayloadReceived(JPAKERound1Payload jPAKERound1Payload) throws CryptoException {
        ...
        JPAKEUtil.validateZeroKnowledgeProof(this.f74751p, this.f74752q, this.f74750g, this.gx3, knowledgeProofForX1, jPAKERound1Payload.getParticipantId(), this.digest);
        JPAKEUtil.validateZeroKnowledgeProof(this.f74751p, this.f74752q, this.f74750g, this.gx4, knowledgeProofForX2, jPAKERound1Payload.getParticipantId(), this.digest);
        this.state = 20;
    }
    ...
    public void validateRound2PayloadReceived(JPAKERound2Payload jPAKERound2Payload) throws CryptoException {
        ...
        if (i >= 40) {
            ...
            BigInteger calculateGA = JPAKEUtil.calculateGA(this.f74751p, this.gx3, this.gx1, this.gx2);
            this.f74749b = jPAKERound2Payload.getA();
            ...
            JPAKEUtil.validateZeroKnowledgeProof(this.f74751p, this.f74752q, calculateGA, this.f74749b, knowledgeProofForX2s, jPAKERound2Payload.getParticipantId(), this.digest);
            this.state = 40;
        }
    }
    ...
    public JPAKEParticipant(String str, char[] cArr, JPAKEPrimeOrderGroup jPAKEPrimeOrderGroup, Digest digest, SecureRandom secureRandom) {
        ...
        this.f74751p = jPAKEPrimeOrderGroup.getP();
        this.f74752q = jPAKEPrimeOrderGroup.getQ();
        this.f74750g = jPAKEPrimeOrderGroup.getG();
        this.digest = digest;
