...
public final class DERMacData {
    ...
    /* loaded from: classes6.dex */
    public static /* synthetic */ class C127451 {
    ...
    public static final class Builder {
        ...
        public DERMacData build() {
            int i = C127451.$SwitchMap$org$bouncycastle$crypto$util$DERMacData$Type[this.type.ordinal()];
            if (i == 1 || i == 2) {
    ...
    public /* synthetic */ DERMacData(byte[] bArr, C127451 c127451) {
        this(bArr);
    }
}
