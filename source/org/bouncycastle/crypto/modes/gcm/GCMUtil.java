...
public abstract class GCMUtil {
    ...
    /* renamed from: E1 */
    private static final int f75154E1 = -520093696;
    ...
    public static void multiply(long[] jArr, long[] jArr2) {
        ...
        long j3 = jArr2[0];
        long j4 = jArr2[1];
        long reverse = org.bouncycastle.util.Longs.reverse(j);
        long reverse2 = org.bouncycastle.util.Longs.reverse(j2);
        long reverse3 = org.bouncycastle.util.Longs.reverse(j3);
        long reverse4 = org.bouncycastle.util.Longs.reverse(j4);
        long reverse5 = org.bouncycastle.util.Longs.reverse(implMul64(reverse, reverse3));
        long implMul64 = implMul64(j, j3) << 1;
        long reverse6 = org.bouncycastle.util.Longs.reverse(implMul64(reverse2, reverse4));
        ...
        long j6 = implMul643 >>> 2;
        long j7 = (implMul643 << 57) ^ ((implMul643 << 63) ^ (implMul643 << 62));
        jArr[0] = reverse5 ^ ((j6 ^ ((implMul643 >>> 1) ^ implMul643)) ^ (implMul643 >>> 7));
        jArr[1] = j7 ^ ((org.bouncycastle.util.Longs.reverse(implMul64(reverse ^ reverse2, reverse3 ^ reverse4)) ^ ((implMul64 ^ reverse5) ^ reverse6)) ^ (((j5 ^ (j5 >>> 1)) ^ (j5 >>> 2)) ^ (j5 >>> 7)));
    }
