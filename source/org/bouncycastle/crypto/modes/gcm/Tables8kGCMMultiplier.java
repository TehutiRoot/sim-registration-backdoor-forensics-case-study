...
public class Tables8kGCMMultiplier implements GCMMultiplier {
    ...
    /* renamed from: H */
    private byte[] f75159H;

    /* renamed from: T */
    private long[][][] f75160T;

    @Override // org.bouncycastle.crypto.modes.gcm.GCMMultiplier
    public void init(byte[] bArr) {
        if (this.f75160T == null) {
            this.f75160T = (long[][][]) Array.newInstance(Long.TYPE, 32, 16, 2);
        } else if (Arrays.areEqual(this.f75159H, bArr)) {
            return;
        }
        this.f75159H = Arrays.clone(bArr);
        for (int i = 0; i < 32; i++) {
            long[][][] jArr = this.f75160T;
            long[][] jArr2 = jArr[i];
            if (i == 0) {
                GCMUtil.asLongs(this.f75159H, jArr2[1]);
                long[] jArr3 = jArr2[1];
