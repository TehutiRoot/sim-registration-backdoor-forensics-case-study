...
public class GCMBlockCipher implements AEADBlockCipher {
    ...
    /* renamed from: H */
    private byte[] f75132H;

    /* renamed from: J0 */
    private byte[] f75133J0;

    /* renamed from: S */
    private byte[] f75134S;
    private byte[] S_at;
    ...
    private void initCipher() {
        ...
        if (this.atLengthPre > 0) {
            System.arraycopy(this.S_atPre, 0, this.f75134S, 0, 16);
        }
    }
    ...
    private void processBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        if (this.forEncryption) {
            ...
            gHASHBlock(this.f75134S, bArr3);
            System.arraycopy(bArr3, 0, bArr2, i2, 16);
        } else {
            gHASHBlock(this.f75134S, bArr, i);
    ...
    private void processPartial(byte[] bArr, int i, int i2, byte[] bArr2, int i3) {
        ...
        if (this.forEncryption) {
            ...
            gHASHPartial(this.f75134S, bArr, i, i2);
        } else {
            gHASHPartial(this.f75134S, bArr, i, i2);
            GCMUtil.xor(bArr, i, bArr3, 0, i2);
        }
    ...
    public int doFinal(byte[] bArr, int i) throws IllegalStateException, InvalidCipherTextException {
        ...
        if (j2 > this.atLengthPre) {
            ...
            if (this.exp == null) {
                ...
                basicGCMExponentiator.init(this.f75132H);
            }
            this.exp.exponentiateX(j3, bArr2);
            GCMUtil.multiply(this.S_at, bArr2);
            GCMUtil.xor(this.f75134S, this.S_at);
        }
        byte[] bArr3 = new byte[16];
        ...
        this.cipher.processBlock(this.f75133J0, 0, bArr4, 0);
        GCMUtil.xor(bArr4, this.f75134S);
        int i5 = this.macSize;
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (keyParameter != null) {
            ...
            this.multiplier.init(this.f75132H);
            this.exp = null;
        } else if (this.f75132H == null) {
        ...
        if (bArr5.length == 12) {
            ...
            gHASHBlock(this.f75133J0, bArr6);
        }
        this.f75134S = new byte[16];
        ...
        this.atLength = 0L;
        this.atLengthPre = 0L;
        this.counter = Arrays.clone(this.f75133J0);
