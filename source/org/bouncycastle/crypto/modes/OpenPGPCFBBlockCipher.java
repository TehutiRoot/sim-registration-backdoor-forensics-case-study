...
public class OpenPGPCFBBlockCipher implements BlockCipher {
    ...
    /* renamed from: FR */
    private byte[] f75147FR;
    private byte[] FRE;

    /* renamed from: IV */
    private byte[] f75148IV;
    ...
    public OpenPGPCFBBlockCipher(BlockCipher blockCipher) {
        ...
        this.f75148IV = new byte[blockSize];
        this.f75147FR = new byte[blockSize];
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) throws DataLengthException, IllegalStateException {
        ...
        if (i + i6 <= bArr.length) {
            if (i2 + i6 <= bArr2.length) {
                ...
                if (i7 > i6) {
                    byte b = bArr[i];
                    this.f75147FR[i6 - 2] = b;
                    bArr2[i2] = encryptByte(b, i6 - 2);
                    byte b2 = bArr[i + 1];
                    byte[] bArr3 = this.f75147FR;
                    int i10 = this.blockSize;
                    bArr3[i10 - 1] = b2;
                    bArr2[i2 + 1] = encryptByte(b2, i10 - 1);
                    this.cipher.processBlock(this.f75147FR, 0, this.FRE, 0);
                    while (i8 < this.blockSize) {
                        byte b3 = bArr[i + i8];
                        int i11 = i8 - 2;
                        this.f75147FR[i11] = b3;
                ...
                if (i5 > i4) {
                    ...
                    if (i5 != 0) {
                        if (i5 == i4) {
                            ...
                            byte[] bArr6 = this.f75147FR;
                            System.arraycopy(bArr6, 2, bArr6, 0, this.blockSize - 2);
                            System.arraycopy(bArr2, i2, this.f75147FR, this.blockSize - 2, 2);
                            this.cipher.processBlock(this.f75147FR, 0, this.FRE, 0);
                            while (true) {
                                i3 = this.blockSize;
                                if (i6 >= i3) {
    ...
    public void reset() {
        this.count = 0;
        byte[] bArr = this.f75148IV;
        byte[] bArr2 = this.f75147FR;
