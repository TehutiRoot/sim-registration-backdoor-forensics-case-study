...
public class KGCMBlockCipher implements AEADBlockCipher {
    ...
    public KGCMBlockCipher(BlockCipher blockCipher) {
        ...
        this.f75144iv = new byte[blockSize];
        this.multiplier = createDefaultMultiplier(blockSize);
        this.f75143b = new long[blockSize >>> 3];
        this.macBlock = null;
    }
    ...
    private void calculateMac(byte[] bArr, int i, int i2, int i3) {
        int i4 = i + i2;
        while (i < i4) {
            xorWithInput(this.f75143b, bArr, i);
            this.multiplier.multiplyH(this.f75143b);
            i += this.blockSize;
        }
        long j = (BodyPartID.bodyIdMax & i2) << 3;
        long[] jArr = this.f75143b;
        jArr[0] = ((i3 & BodyPartID.bodyIdMax) << 3) ^ jArr[0];
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof AEADParameters) {
            ...
            byte[] bArr = this.f75144iv;
            Arrays.fill(bArr, (byte) 0);
            System.arraycopy(nonce, 0, this.f75144iv, bArr.length - nonce.length, nonce.length);
            ...
            byte[] bArr3 = this.f75144iv;
            Arrays.fill(bArr3, (byte) 0);
            System.arraycopy(iv, 0, this.f75144iv, bArr3.length - iv.length, iv.length);
            this.initialAssociatedText = null;
            this.macSize = this.blockSize;
            keyParameter = (KeyParameter) parametersWithIV.getParameters();
        }
        this.macBlock = new byte[this.blockSize];
        this.ctrEngine.init(true, new ParametersWithIV(keyParameter, this.f75144iv));
