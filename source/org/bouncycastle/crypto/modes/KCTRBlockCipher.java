...
public class KCTRBlockCipher extends StreamBlockCipher {
    ...
    public KCTRBlockCipher(BlockCipher blockCipher) {
        ...
        this.f75142iv = new byte[blockCipher.getBlockSize()];
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        byte[] bArr = this.f75142iv;
        Arrays.fill(bArr, (byte) 0);
        System.arraycopy(iv, 0, this.f75142iv, bArr.length - iv.length, iv.length);
    ...
    public void reset() {
        if (this.initialised) {
            this.engine.processBlock(this.f75142iv, 0, this.ofbV, 0);
        }
        this.engine.reset();
        this.byteCount = 0;
    }
