...
public class NoekeonEngine implements BlockCipher {
    ...
    /* renamed from: k */
    private final int[] f75016k = new int[4];
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        Pack.bigEndianToInt(((KeyParameter) cipherParameters).getKey(), 0, this.f75016k, 0, 4);
        if (z) {
            return;
        }
        int[] iArr = this.f75016k;
