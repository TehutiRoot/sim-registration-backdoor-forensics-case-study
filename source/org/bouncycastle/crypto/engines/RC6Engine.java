...
public class RC6Engine implements BlockCipher {
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        while (i5 >= 1) {
            ...
            i5--;
            int i7 = i4;
            i4 = rotateRight(bytesToWord4 - this.f75023_S[i6], rotateLeft2) ^ rotateLeft;
            bytesToWord4 = i3;
            i3 = rotateRight(bytesToWord2 - this.f75023_S[i6 + 1], rotateLeft) ^ rotateLeft2;
            bytesToWord2 = i7;
        }
        int[] iArr2 = this.f75023_S;
    ...
    private int encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        while (i5 <= 20) {
            ...
            int i6 = i5 * 2;
            int rotateLeft3 = rotateLeft(bytesToWord3 ^ rotateLeft2, rotateLeft) + this.f75023_S[i6 + 1];
            i5++;
            bytesToWord3 = i4;
            i4 = rotateLeft(bytesToWord ^ rotateLeft, rotateLeft2) + this.f75023_S[i6];
            bytesToWord = i3;
            i3 = rotateLeft3;
        }
        int[] iArr2 = this.f75023_S;
