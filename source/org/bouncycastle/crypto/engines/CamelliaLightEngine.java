...
public class CamelliaLightEngine implements BlockCipher {
    ...
    private static final byte[] SBOX1 = {112, -126, 44, -20, -77, 39, -64, -27, -28, -123, 87, 53, -22, 12, -82, 65, 35, ByteSourceJsonBootstrapper.UTF8_BOM_1, 107, -109, 69, Ascii.f52684EM, -91, Framer.ENTER_FRAME_PREFIX, -19, 14, 79, 78, Ascii.f52687GS, 101, -110, -67, -122, -72, -81, -113, 124, -21, Ascii.f52695US, -50, 62, 48, -36, Framer.STDIN_REQUEST_FRAME_PREFIX, 94, -59, 11, Ascii.SUB, -90, -31, 57, -54, -43, 71, 93, Base64.padSymbol, -39, 1, 90, -42, 81, 86, 108, 77, -117, 13, -102, 102, -5, -52, -80, Framer.STDIN_FRAME_PREFIX, 116, 18, 43, 32, -16, -79, -124, -103, -33, 76, -53, -62, 52, 126, 118, 5, 109, -73, -87, Framer.STDOUT_FRAME_PREFIX, -47, Ascii.ETB, 4, -41, Ascii.DC4, 88, 58, 97, -34, Ascii.ESC, 17, Ascii.f52686FS, Framer.STDERR_FRAME_PREFIX, 15, -100, Ascii.SYN, 83, Ascii.CAN, -14, 34, -2, 68, -49, -78, -61, -75, 122, -111, 36, 8, -24, -88, 96, -4, 105, 80, -86, -48, -96, 125, -95, -119, 98, -105, 84, 91, Ascii.f52691RS, -107, -32, -1, 100, -46, 16, -60, 0, 72, -93, -9, 117, -37, -118, 3, -26, -38, 9, Utf8.REPLACEMENT_BYTE, -35, -108, -121, 92, -125, 2, -51, 74, -112, 51, 115, 103, -10, -13, -99, Byte.MAX_VALUE, ByteSourceJsonBootstrapper.UTF8_BOM_3, -30, 82, -101, -40, 38, -56, 55, -58, 59, -127, -106, 111, 75, 19, -66, 99, 46, -23, 121, -89, -116, -97, 110, PSSSigner.TRAILER_IMPLICIT, -114, 41, -11, -7, -74, 47, -3, -76, 89, Framer.EXIT_FRAME_PREFIX, -104, 6, 106, -25, 70, 113, -70, -44, 37, -85, 66, -120, -94, -115, -6, 114, 7, -71, 85, -8, -18, -84, 10, 54, 73, 42, 104, 60, 56, -15, -92, SignedBytes.MAX_POWER_OF_TWO, 40, -45, 123, ByteSourceJsonBootstrapper.UTF8_BOM_2, -55, 67, -63, Ascii.NAK, -29, -83, -12, 119, -57, Byte.MIN_VALUE, -98};
    private int[] subkey = new int[96];

    /* renamed from: kw */
    private int[] f74985kw = new int[8];

    /* renamed from: ke */
    private int[] f74984ke = new int[12];
    ...
    private void camelliaF2(int[] iArr, int[] iArr2, int i) {
        ...
        int sbox42 = ((bArr[(i5 >>> 24) & 255] & 255) << 24) | sbox4(i5 & 255) | (sbox3((i5 >>> 8) & 255) << 8) | (sbox2((i5 >>> 16) & 255) << 16);
    ...
    private int processBlock192or256(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        camelliaF2(this.state, this.subkey, 28);
        camelliaF2(this.state, this.subkey, 32);
        camelliaFLs(this.state, this.f74984ke, 8);
    ...
    private void setKey(boolean z, byte[] bArr) {
        ...
        if (this._keyis128) {
            ...
            if (z) {
                ...
                iArr6[18] = iArr4[2];
                iArr6[19] = iArr4[3];
                roldq(17, iArr, 0, this.f74984ke, 4);
                ...
                roldq(15, iArr2, 0, this.f74984ke, 0);
                ...
                roldq(17, iArr2, 0, this.f74985kw, 4);
                return;
            }
            iArr5[4] = iArr[0];
            iArr5[5] = iArr[1];
            ...
            iArr9[16] = iArr4[0];
            iArr9[17] = iArr4[1];
            decroldq(17, iArr, 0, this.f74984ke, 0);
            ...
            decroldq(15, iArr2, 0, this.f74984ke, 4);
            ...
            roldq(17, iArr2, 0, this.f74985kw, 0);
            return;
        }
        for (int i3 = 0; i3 < 4; i3++) {
        ...
        if (z) {
            ...
            roldq(15, iArr, 0, this.f74984ke, 4);
            roldq(17, iArr, 0, this.subkey, 32);
            roldqo32(34, iArr, 0, this.subkey, 44);
            roldq(15, iArr, 4, this.subkey, 4);
            roldq(15, iArr, 4, this.f74984ke, 0);
            ...
            roldqo32(51, iArr3, 0, this.f74985kw, 4);
            return;
        }
        iArr12[4] = iArr[0];
        iArr12[5] = iArr[1];
        ...
        roldqo32(51, iArr3, 0, this.f74985kw, 0);
    }
