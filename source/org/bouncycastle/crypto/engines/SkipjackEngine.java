...
public class SkipjackEngine implements BlockCipher {
    ...
    /* renamed from: g */
    private int m24455g(int i, int i2) {
        int i3 = i2 & 255;
        short[] sArr = ftable;
    ...
    /* renamed from: h */
    private int m24454h(int i, int i2) {
        int i3 = i2 & 255;
        int i4 = (i2 >> 8) & 255;
        short[] sArr = ftable;
