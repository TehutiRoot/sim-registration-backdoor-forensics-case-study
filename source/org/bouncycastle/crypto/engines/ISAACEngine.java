...
public class ISAACEngine implements StreamCipher {
    ...
    /* renamed from: a */
    private int f75013a = 0;

    /* renamed from: b */
    private int f75014b = 0;

    /* renamed from: c */
    private int f75015c = 0;
    private int index = 0;
    ...
    private void isaac() {
        ...
        for (int i5 = 0; i5 < 256; i5++) {
            ...
            if (i7 == 0) {
                ...
                int i8 = this.f75013a + iArr[(i5 + 128) & 255];
                this.f75013a = i8;
                int i9 = iArr[(i6 >>> 2) & 255] + i8 + this.f75014b;
                iArr[i5] = i9;
            ...
            this.f75013a = i ^ i2;
            int i82 = this.f75013a + iArr[(i5 + 128) & 255];
            this.f75013a = i82;
            int i92 = iArr[(i6 >>> 2) & 255] + i82 + this.f75014b;
            iArr[i5] = i92;
