...
public class GOST3412_2015Engine implements BlockCipher {
    ...
    /* renamed from: PI */
    private static final byte[] f75004PI = {-4, -18, -35, 17, -49, 110, Framer.STDOUT_FRAME_PREFIX, Ascii.SYN, -5, -60, -6, -38, 35, -59, 4, 77, -23, 119, -16, -37, -109, 46, -103, -70, Ascii.ETB, 54, -15, ByteSourceJsonBootstrapper.UTF8_BOM_2, Ascii.DC4, -51, Framer.STDIN_REQUEST_FRAME_PREFIX, -63, -7, Ascii.CAN, 101, 90, -30, 92, ByteSourceJsonBootstrapper.UTF8_BOM_1, Framer.ENTER_FRAME_PREFIX, -127, Ascii.f52686FS, 60, 66, -117, 1, -114, 79, 5, -124, 2, -82, -29, 106, -113, -96, 6, 11, -19, -104, Byte.MAX_VALUE, -44, -45, Ascii.f52695US, -21, 52, 44, 81, -22, -56, 72, -85, -14, 42, 104, -94, -3, 58, -50, -52, -75, 112, 14, 86, 8, 12, 118, 18, ByteSourceJsonBootstrapper.UTF8_BOM_3, 114, 19, 71, -100, -73, 93, -121, Ascii.NAK, -95, -106, 41, 16, 123, -102, -57, -13, -111, Framer.EXIT_FRAME_PREFIX, 111, -99, -98, -78, -79, Framer.STDERR_FRAME_PREFIX, 117, Ascii.f52684EM, Base64.padSymbol, -1, 53, -118, 126, 109, 84, -58, Byte.MIN_VALUE, -61, -67, 13, 87, -33, -11, 36, -87, 62, -88, 67, -55, -41, 121, -42, -10, 124, 34, -71, 3, -32, 15, -20, -34, 122, -108, -80, PSSSigner.TRAILER_IMPLICIT, -36, -24, 40, 80, 78, 51, 10, 74, -89, -105, 96, 115, Ascii.f52691RS, 0, 98, 68, Ascii.SUB, -72, 56, -126, 100, -97, 38, 65, -83, 69, 70, -110, 39, 94, 85, 47, -116, -93, -91, 125, 105, -43, -107, 59, 7, 88, -77, SignedBytes.MAX_POWER_OF_TWO, -122, -84, Ascii.f52687GS, -9, 48, 55, 107, -28, -120, -39, -25, -119, -31, Ascii.ESC, -125, 73, 76, Utf8.REPLACEMENT_BYTE, -8, -2, -115, 83, -86, -112, -54, -40, -123, 97, 32, 113, 103, -92, Framer.STDIN_FRAME_PREFIX, 43, 9, 91, -53, -101, 37, -48, -66, -27, 108, 82, 89, -90, 116, -46, -26, -12, -76, -64, -47, 102, -81, -62, 57, 75, 99, -74};
    private static final byte[] inversePI = {-91, Framer.STDIN_FRAME_PREFIX, Framer.STDERR_FRAME_PREFIX, -113, 14, 48, 56, -64, 84, -26, -98, 57, 85, 126, 82, -111, 100, 3, 87, 90, Ascii.f52686FS, 96, 7, Ascii.CAN, Framer.ENTER_FRAME_PREFIX, 114, -88, -47, 41, -58, -92, Utf8.REPLACEMENT_BYTE, -32, 39, -115, 12, -126, -22, -82, -76, -102, 99, 73, -27, 66, -28, Ascii.NAK, -73, -56, 6, 112, -99, 65, 117, Ascii.f52684EM, -55, -86, -4, 77, ByteSourceJsonBootstrapper.UTF8_BOM_3, 42, 115, -124, -43, -61, -81, 43, -122, -89, -79, -78, 91, 70, -45, -97, -3, -44, 15, -100, 47, -101, 67, ByteSourceJsonBootstrapper.UTF8_BOM_1, -39, 121, -74, 83, Byte.MAX_VALUE, -63, -16, 35, -25, 37, 94, -75, Ascii.f52691RS, -94, -33, -90, -2, -84, 34, -7, -30, 74, PSSSigner.TRAILER_IMPLICIT, 53, -54, -18, Framer.EXIT_FRAME_PREFIX, 5, 107, 81, -31, 89, -93, -14, 113, 86, 17, 106, -119, -108, 101, -116, ByteSourceJsonBootstrapper.UTF8_BOM_2, 119, 60, 123, 40, -85, -46, Framer.STDOUT_FRAME_PREFIX, -34, -60, Framer.STDIN_REQUEST_FRAME_PREFIX, -52, -49, 118, 44, -72, -40, 46, 54, -37, 105, -77, Ascii.DC4, -107, -66, 98, -95, 59, Ascii.SYN, 102, -23, 92, 108, 109, -83, 55, 97, 75, -71, -29, -70, -15, -96, -123, -125, -38, 71, -59, -80, 51, -6, -106, 111, 110, -62, -10, 80, -1, 93, -87, -114, Ascii.ETB, Ascii.ESC, -105, 125, -20, 88, -9, Ascii.f52695US, -5, 124, 9, 13, 122, 103, 69, -121, -36, -24, 79, Ascii.f52687GS, 78, 4, -21, -8, -13, 62, Base64.padSymbol, -67, -118, -120, -35, -51, 11, 19, -104, 2, -109, Byte.MIN_VALUE, -112, -48, 36, 52, -53, -19, -12, -50, -103, 16, 68, SignedBytes.MAX_POWER_OF_TWO, -110, 58, 1, 38, 18, Ascii.SUB, 72, 104, -11, -127, -117, -57, -42, 32, 10, 8, 0, 76, -41, 116};
    ...
    /* renamed from: C */
    private void m24477C(byte[] bArr, int i) {
        Arrays.clear(bArr);
        bArr[15] = (byte) i;
        m24475L(bArr);
    }
    ...
    /* renamed from: F */
    private void m24476F(byte[] bArr, byte[] bArr2, byte[] bArr3) {
    ...
    private void GOST3412_2015Func(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        if (this.forEncryption) {
            ...
            m24472X(bArr4, bArr3[0]);
        }
        System.arraycopy(bArr4, 0, bArr2, i2, 16);
    }

    /* renamed from: L */
    private void m24475L(byte[] bArr) {
        for (int i = 0; i < 16; i++) {
            m24474R(bArr);
        }
    }
    ...
    /* renamed from: R */
    private void m24474R(byte[] bArr) {
        byte m24471l = m24471l(bArr);
        System.arraycopy(bArr, 0, bArr, 1, 15);
        bArr[0] = m24471l;
    }

    /* renamed from: S */
    private void m24473S(byte[] bArr) {
        for (int i = 0; i < bArr.length; i++) {
            bArr[i] = f75004PI[unsignedByte(bArr[i])];
        }
    }

    /* renamed from: X */
    private void m24472X(byte[] bArr, byte[] bArr2) {
        for (int i = 0; i < bArr.length; i++) {
    ...
    private void generateSubKeys(byte[] bArr) {
        ...
        for (int i5 = 1; i5 < 5; i5++) {
            for (int i6 = 1; i6 <= 8; i6++) {
                m24477C(bArr7, ((i5 - 1) * 8) + i6);
                m24476F(bArr7, bArr2, bArr3);
            }
            int i7 = i5 * 2;
    ...
    /* renamed from: l */
    private byte m24471l(byte[] bArr) {
        byte b = bArr[15];
        for (int i = 14; i >= 0; i--) {
