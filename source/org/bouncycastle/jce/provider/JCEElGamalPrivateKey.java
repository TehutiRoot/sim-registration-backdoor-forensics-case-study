...
public class JCEElGamalPrivateKey implements ElGamalPrivateKey, DHPrivateKey, PKCS12BagAttributeCarrier {
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        this.f75298x = (BigInteger) objectInputStream.readObject();
    ...
    public JCEElGamalPrivateKey(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        this.f75298x = ASN1Integer.getInstance(privateKeyInfo.parsePrivateKey()).getValue();
    ...
    public JCEElGamalPrivateKey(ElGamalPrivateKeyParameters elGamalPrivateKeyParameters) {
        this.f75298x = elGamalPrivateKeyParameters.getX();
