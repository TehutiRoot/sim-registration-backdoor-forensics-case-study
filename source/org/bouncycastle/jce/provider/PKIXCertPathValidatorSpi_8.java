    ...
    public CertPathValidatorResult engineValidate(CertPath certPath, CertPathParameters certPathParameters) throws CertPathValidatorException, InvalidAlgorithmParameterException {
        ...
        try {
            ...
            for (PKIXCertPathChecker pKIXCertPathChecker : build.getCertPathCheckers()) {
                ...
                if (!AbstractC22143sh1.m22559a(pKIXCertPathChecker)) {
                    ...
                    if (build.getTargetConstraints() == null || build.getTargetConstraints().match((Certificate) ((X509Certificate) certificates.get(0)))) {
                        ...
                        while (size2 >= 0) {
                            ...
                            try {
                                ...
                                RFC3280CertPathUtilities.processCertA(certPath, build, validityDate, pKIXCertRevocationChecker2, i14, cAPublicKey, z2, ca, trustedCert);
                                RFC3280CertPathUtilities.processCertBC(certPath, i14, pKIXNameConstraintValidator2, this.isForCRLCheck);
                                PKIXPolicyNode processCertE = RFC3280CertPathUtilities.processCertE(certPath, i14, RFC3280CertPathUtilities.processCertD(certPath, i14, hashSet4, pKIXPolicyNode, arrayListArr2, i9, this.isForCRLCheck));
                                RFC3280CertPathUtilities.processCertF(certPath, i14, processCertE, i15);
                                if (i12 != i13) {
                                    if (x509Certificate2 == null || x509Certificate2.getVersion() != 1) {
                                        RFC3280CertPathUtilities.prepareNextCertA(certPath, i14);
                                        arrayListArr = arrayListArr2;
                                        PKIXPolicyNode prepareCertB = RFC3280CertPathUtilities.prepareCertB(certPath, i14, arrayListArr, processCertE, 1);
                                        RFC3280CertPathUtilities.prepareNextCertG(certPath, i14, pKIXNameConstraintValidator2);
                                        int prepareNextCertH1 = RFC3280CertPathUtilities.prepareNextCertH1(certPath, i14, i15);
                                        int prepareNextCertH2 = RFC3280CertPathUtilities.prepareNextCertH2(certPath, i14, 1);
                                        int prepareNextCertH3 = RFC3280CertPathUtilities.prepareNextCertH3(certPath, i14, i9);
                                        i15 = RFC3280CertPathUtilities.prepareNextCertI1(certPath, i14, prepareNextCertH1);
                                        i3 = RFC3280CertPathUtilities.prepareNextCertI2(certPath, i14, prepareNextCertH2);
                                        i2 = RFC3280CertPathUtilities.prepareNextCertJ(certPath, i14, prepareNextCertH3);
                                        RFC3280CertPathUtilities.prepareNextCertK(certPath, i14);
                                        i8 = RFC3280CertPathUtilities.prepareNextCertM(certPath, i14, RFC3280CertPathUtilities.prepareNextCertL(certPath, i14, i8));
                                        ...
                                        RFC3280CertPathUtilities.prepareNextCertO(certPath, i14, hashSet2, arrayList);
                        ...
                        PKIXPolicyNode wrapupCertG = RFC3280CertPathUtilities.wrapupCertG(certPath, pKIXExtendedParameters3, initialPolicies, i17, arrayListArr, pKIXPolicyNode, hashSet4);
