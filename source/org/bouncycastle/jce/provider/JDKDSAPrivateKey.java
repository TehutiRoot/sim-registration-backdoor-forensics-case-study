...
public class JDKDSAPrivateKey implements DSAPrivateKey, PKCS12BagAttributeCarrier {
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        this.f75300x = (BigInteger) objectInputStream.readObject();
    ...
    private void writeObject(ObjectOutputStream objectOutputStream) throws IOException {
        objectOutputStream.writeObject(this.f75300x);
    ...
    public JDKDSAPrivateKey(DSAPrivateKey dSAPrivateKey) {
        this.f75300x = dSAPrivateKey.getX();
        this.dsaSpec = dSAPrivateKey.getParams();
    }

    public JDKDSAPrivateKey(DSAPrivateKeySpec dSAPrivateKeySpec) {
        this.f75300x = dSAPrivateKeySpec.getX();
    ...
    public JDKDSAPrivateKey(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        this.f75300x = ASN1Integer.getInstance(privateKeyInfo.parsePrivateKey()).getValue();
    ...
    public JDKDSAPrivateKey(DSAPrivateKeyParameters dSAPrivateKeyParameters) {
        this.f75300x = dSAPrivateKeyParameters.getX();
