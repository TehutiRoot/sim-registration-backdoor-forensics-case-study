                    ...
                    if (build.getTargetConstraints() == null || build.getTargetConstraints().match((Certificate) ((X509Certificate) certificates.get(0)))) {
                        ...
                        while (size2 >= 0) {
                            ...
                            try {
                                ...
                                RFC3280CertPathUtilities.processCertA(certPath, build, validityDate, provCrlRevocationChecker2, i16, r7, z2, x500Name, trustedCert);
                                ...
                                if (x500Name != i14) {
                                    if (x509Certificate2 == null || x509Certificate2.getVersion() != 1) {
                                        ...
                                        PKIXPolicyNode prepareCertB = RFC3280CertPathUtilities.prepareCertB(certPath, i16, arrayListArr, processCertE, 1);
                                        ...
                                        int prepareNextCertH2 = RFC3280CertPathUtilities.prepareNextCertH2(certPath, i16, 1);
                        ...
                        int i18 = size2;
                        int i19 = i18 + 1;
                        int wrapupCertB = RFC3280CertPathUtilities.wrapupCertB(certPath, i19, RFC3280CertPathUtilities.wrapupCertA(i11, x509Certificate));
                        ...
                        PKIXPolicyNode wrapupCertG = RFC3280CertPathUtilities.wrapupCertG(certPath, pKIXExtendedParameters3, initialPolicies, i19, arrayListArr4, pKIXPolicyNode, hashSet4);
