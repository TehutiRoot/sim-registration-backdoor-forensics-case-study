...
public class X509CRLObject extends X509CRL {
    ...
    /* renamed from: c */
    private CertificateList f75305c;
    ...
    private void doVerify(PublicKey publicKey, Signature signature) throws CRLException, NoSuchAlgorithmException, InvalidKeyException, SignatureException {
        if (!this.f75305c.getSignatureAlgorithm().equals(this.f75305c.getTBSCertList().getSignature())) {
    ...
    private Set getExtensionOIDs(boolean z) {
        ...
        if (getVersion() != 2 || (extensions = this.f75305c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f75305c.getRevokedCertificateEnumeration();
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CRL) {
            if (obj instanceof X509CRLObject) {
                ...
                return this.f75305c.equals(x509CRLObject.f75305c);
            }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f75305c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    public byte[] getExtensionValue(String str) {
        Extension extension;
        Extensions extensions = this.f75305c.getTBSCertList().getExtensions();
    ...
    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f75305c.getIssuer().toASN1Primitive()));
    }

    @Override // java.security.cert.X509CRL
    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f75305c.getIssuer().getEncoded());
    ...
    public Date getNextUpdate() {
        if (this.f75305c.getNextUpdate() != null) {
            return this.f75305c.getNextUpdate().getDate();
        }
        return null;
    }
    ...
    public String getSigAlgOID() {
        return this.f75305c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public byte[] getSignature() {
        return this.f75305c.getSignature().getOctets();
    }

    @Override // java.security.cert.X509CRL
    public byte[] getTBSCertList() throws CRLException {
        try {
            return this.f75305c.getTBSCertList().getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
            throw new CRLException(e.toString());
        }
    }
    ...
    public Date getThisUpdate() {
        return this.f75305c.getThisUpdate().getDate();
    }

    @Override // java.security.cert.X509CRL
    public int getVersion() {
        return this.f75305c.getVersionNumber();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        if (certificate.getType().equals("X.509")) {
            Enumeration revokedCertificateEnumeration = this.f75305c.getRevokedCertificateEnumeration();
            X500Name issuer2 = this.f75305c.getIssuer();
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:43:0x0184 -> B:16:0x00b6). Please submit an issue!!! */
    @Override // java.security.cert.CRL
