...
import org.bouncycastle.asn1.p034x9.X962Parameters;
import org.bouncycastle.asn1.p034x9.X9ECParameters;
import org.bouncycastle.asn1.p034x9.X9ECPoint;
import org.bouncycastle.asn1.p034x9.X9IntegerConverter;
...
public class JCEECPublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    public JCEECPublicKey(String str, ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.ecSpec = params;
        this.f75297q = EC5Util.convertPoint(params, eCPublicKeySpec.getW());
    }
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        if (algorithm.getAlgorithm().equals((ASN1Primitive) CryptoProObjectIdentifiers.gostR3410_2001)) {
            ...
            try {
                ...
                this.f75297q = curve2.decodePoint(bArr);
        ...
        if (x962Parameters.isNamedCurve()) {
            ...
            this.f75297q = new X9ECPoint(curve, dEROctetString).getPoint();
        } else {
    ...
    public byte[] getEncoded() {
        ...
        if (this.algorithm.equals("ECGOST3410")) {
            ...
            BigInteger bigInteger = this.f75297q.getAffineXCoord().toBigInteger();
            BigInteger bigInteger2 = this.f75297q.getAffineYCoord().toBigInteger();
    ...
    public ECPoint getQ() {
        return this.ecSpec == null ? this.f75297q.getDetachedPoint() : this.f75297q;
    }

    @Override // java.security.interfaces.ECPublicKey
    public java.security.spec.ECPoint getW() {
        return EC5Util.convertPoint(this.f75297q);
    }
    ...
    public String toString() {
        ...
        stringBuffer.append(this.f75297q.getAffineXCoord().toBigInteger().toString(16));
        stringBuffer.append(lineSeparator);
        stringBuffer.append("            Y: ");
        stringBuffer.append(this.f75297q.getAffineYCoord().toBigInteger().toString(16));
        stringBuffer.append(lineSeparator);
    ...
    public JCEECPublicKey(String str, ECPublicKeyParameters eCPublicKeyParameters) {
        this.algorithm = str;
        this.f75297q = eCPublicKeyParameters.getQ();
        this.ecSpec = null;
    }
    ...
    public JCEECPublicKey(String str, JCEECPublicKey jCEECPublicKey) {
        this.algorithm = str;
        this.f75297q = jCEECPublicKey.f75297q;
    ...
    public JCEECPublicKey(String str, org.bouncycastle.jce.spec.ECPublicKeySpec eCPublicKeySpec) {
        ECParameterSpec eCParameterSpec;
        this.algorithm = str;
        this.f75297q = eCPublicKeySpec.getQ();
        if (eCPublicKeySpec.getParams() != null) {
            ...
            if (this.f75297q.getCurve() == null) {
                this.f75297q = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa().getCurve().createPoint(this.f75297q.getAffineXCoord().toBigInteger(), this.f75297q.getAffineYCoord().toBigInteger());
            }
    ...
    public JCEECPublicKey(ECPublicKey eCPublicKey) {
        ...
        this.ecSpec = params;
        this.f75297q = EC5Util.convertPoint(params, eCPublicKey.getW());
    }
