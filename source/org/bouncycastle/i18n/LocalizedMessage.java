...
public class LocalizedMessage {
    ...
    /* renamed from: id */
    protected final String f75254id;
    ...
    public String formatWithTimeZone(String str, Object[] objArr, Locale locale, TimeZone timeZone) {
        MessageFormat messageFormat = new MessageFormat(HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR);
    ...
    public String toString() {
        ...
        stringBuffer.append(this.f75254id);
