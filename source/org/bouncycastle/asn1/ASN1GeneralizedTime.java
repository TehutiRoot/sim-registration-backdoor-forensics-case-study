...
public class ASN1GeneralizedTime extends ASN1Primitive {
    ...
    private String calculateGMTOffset(String str) {
        ...
        int i2 = (rawOffset - (DateTimeConstants.MILLIS_PER_HOUR * i)) / 60000;
        try {
    ...
    public String getTime() {
        ...
        char charAt = fromByteArray.charAt(length2 - 6);
        if ((charAt == '-' || charAt == '+') && fromByteArray.indexOf("GMT") == length2 - 9) {
            return fromByteArray;
        }
        int length3 = fromByteArray.length();
        int i = length3 - 5;
