...
public class X9FieldElement extends ASN1Object {
    ...
    /* renamed from: f */
    protected ECFieldElement f74746f;
    ...
    public ASN1Primitive toASN1Primitive() {
        return new DEROctetString(converter.integerToBytes(this.f74746f.toBigInteger(), converter.getByteLength(this.f74746f)));
    }

    public X9FieldElement(BigInteger bigInteger, ASN1OctetString aSN1OctetString) {
        this(new ECFieldElement.C12825Fp(bigInteger, new BigInteger(1, aSN1OctetString.getOctets())));
    }

    public X9FieldElement(ECFieldElement eCFieldElement) {
        this.f74746f = eCFieldElement;
    }
}
