...
public class PKCS12PBEParams extends ASN1Object {
    ...
    /* renamed from: iv */
    ASN1OctetString f74686iv;

    private PKCS12PBEParams(ASN1Sequence aSN1Sequence) {
        this.f74686iv = (ASN1OctetString) aSN1Sequence.getObjectAt(0);
    ...
    public byte[] getIV() {
        return this.f74686iv.getOctets();
    }
