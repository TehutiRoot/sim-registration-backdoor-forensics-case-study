...
public class RecipientIdentifier extends ASN1Object implements ASN1Choice {
    ...
    /* renamed from: id */
    private ASN1Encodable f74655id;

    public RecipientIdentifier(ASN1OctetString aSN1OctetString) {
        this.f74655id = new DERTaggedObject(false, 0, aSN1OctetString);
    }
    ...
    public ASN1Encodable getId() {
        ASN1Encodable aSN1Encodable = this.f74655id;
    ...
    public boolean isTagged() {
        return this.f74655id instanceof ASN1TaggedObject;
    }

    @Override // org.bouncycastle.asn1.ASN1Object, org.bouncycastle.asn1.ASN1Encodable
    public ASN1Primitive toASN1Primitive() {
        return this.f74655id.toASN1Primitive();
    }

    public RecipientIdentifier(ASN1Primitive aSN1Primitive) {
        this.f74655id = aSN1Primitive;
    }

    public RecipientIdentifier(IssuerAndSerialNumber issuerAndSerialNumber) {
        this.f74655id = issuerAndSerialNumber;
    }
}
