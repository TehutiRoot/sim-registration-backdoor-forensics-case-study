...
public abstract class PublicKeyDataObject extends ASN1Object {
    public static PublicKeyDataObject getInstance(Object obj) {
        ...
        if (obj != null) {
            ...
            return ASN1ObjectIdentifier.getInstance(aSN1Sequence.getObjectAt(0)).m24543on(EACObjectIdentifiers.id_TA_ECDSA) ? new ECDSAPublicKey(aSN1Sequence) : new RSAPublicKey(aSN1Sequence);
        }
        return null;
    }
