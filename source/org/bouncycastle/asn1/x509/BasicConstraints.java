...
public class BasicConstraints extends ASN1Object {
    ...
    /* renamed from: cA */
    ASN1Boolean f74715cA;
    ASN1Integer pathLenConstraint;

    public BasicConstraints(int i) {
        this.f74715cA = ASN1Boolean.getInstance(false);
        this.pathLenConstraint = null;
        this.f74715cA = ASN1Boolean.getInstance(true);
    ...
    public boolean isCA() {
        ASN1Boolean aSN1Boolean = this.f74715cA;
    ...
    private BasicConstraints(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.getObjectAt(0) instanceof ASN1Boolean) {
            this.f74715cA = ASN1Boolean.getInstance(aSN1Sequence.getObjectAt(0));
        } else {
            this.f74715cA = null;
            this.pathLenConstraint = ASN1Integer.getInstance(aSN1Sequence.getObjectAt(0));
        }
        if (aSN1Sequence.size() > 1) {
            if (this.f74715cA == null) {
