...
public class PKIXNameConstraintValidator implements NameConstraintValidator {
    ...
    */
    ...
    private Set intersectIPRange(byte[] bArr, byte[] bArr2) {
        ...
        return compareTo(max(minMaxIPs[0], minMaxIPs[2]), min(minMaxIPs[1], minMaxIPs[3])) == 1 ? Collections.EMPTY_SET : Collections.singleton(ipWithSubnetMask(m24542or(minMaxIPs[0], minMaxIPs[2]), m24542or(bArr4, bArr6)));
    }
    ...
    /* renamed from: or */
    private static byte[] m24542or(byte[] bArr, byte[] bArr2) {
