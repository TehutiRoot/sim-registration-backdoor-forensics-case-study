...
public class IDEACBCPar extends ASN1Object {
    ...
    /* renamed from: iv */
    ASN1OctetString f74678iv;

    private IDEACBCPar(ASN1Sequence aSN1Sequence) {
        this.f74678iv = aSN1Sequence.size() == 1 ? (ASN1OctetString) aSN1Sequence.getObjectAt(0) : null;
    }
    ...
    public byte[] getIV() {
        ASN1OctetString aSN1OctetString = this.f74678iv;
    ...
    public IDEACBCPar(byte[] bArr) {
        this.f74678iv = new DEROctetString(bArr);
    }
}
