...
public final class MediaMetadataCompat implements Parcelable {
    ...
    /* renamed from: d */
    public static final ArrayMap f8523d;
    ...
    /* renamed from: a */
    public final Bundle f8527a;

    /* renamed from: b */
    public Object f8528b;

    /* renamed from: c */
    public MediaDescriptionCompat f8529c;
    ...
    /* loaded from: classes.dex */
    public static class C1947a implements Parcelable.Creator {
    ...
    static {
        ...
        f8524e = new String[]{METADATA_KEY_TITLE, METADATA_KEY_ARTIST, METADATA_KEY_ALBUM, METADATA_KEY_ALBUM_ARTIST, METADATA_KEY_WRITER, METADATA_KEY_AUTHOR, METADATA_KEY_COMPOSER};
        f8525f = new String[]{METADATA_KEY_DISPLAY_ICON, METADATA_KEY_ART, METADATA_KEY_ALBUM_ART};
        f8526g = new String[]{METADATA_KEY_DISPLAY_ICON_URI, METADATA_KEY_ART_URI, METADATA_KEY_ALBUM_ART_URI};
        CREATOR = new C1947a();
    }
    ...
    public static MediaMetadataCompat fromMediaMetadata(Object obj) {
        if (obj != null) {
            ...
            MediaMetadataCompatApi21.m64975b(obj, obtain, 0);
            obtain.setDataPosition(0);
            MediaMetadataCompat createFromParcel = CREATOR.createFromParcel(obtain);
            obtain.recycle();
            createFromParcel.f8528b = obj;
    ...
    public boolean containsKey(String str) {
        return this.f8527a.containsKey(str);
    }
    ...
    public Bitmap getBitmap(String str) {
        try {
            return (Bitmap) this.f8527a.getParcelable(str);
        } catch (Exception e) {
    ...
    public MediaDescriptionCompat getDescription() {
        ...
        Bitmap bitmap;
        Uri uri2;
        MediaDescriptionCompat mediaDescriptionCompat = this.f8529c;
        ...
        if (this.f8527a.containsKey(METADATA_KEY_BT_FOLDER_TYPE)) {
            bundle.putLong(MediaDescriptionCompat.EXTRA_BT_FOLDER_TYPE, getLong(METADATA_KEY_BT_FOLDER_TYPE));
        }
        if (this.f8527a.containsKey(METADATA_KEY_DOWNLOAD_STATUS)) {
    ...
    public long getLong(String str) {
        return this.f8527a.getLong(str, 0L);
    }
    ...
    public Object getMediaMetadata() {
        if (this.f8528b == null) {
            ...
            obtain.setDataPosition(0);
            this.f8528b = MediaMetadataCompatApi21.m64976a(obtain);
            obtain.recycle();
        }
        return this.f8528b;
    }
    ...
    public RatingCompat getRating(String str) {
        try {
            return RatingCompat.fromRating(this.f8527a.getParcelable(str));
        } catch (Exception e) {
    ...
    public String getString(String str) {
        CharSequence charSequence = this.f8527a.getCharSequence(str);
    ...
    public CharSequence getText(String str) {
        return this.f8527a.getCharSequence(str);
    }

    public Set<String> keySet() {
        return this.f8527a.keySet();
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeBundle(this.f8527a);
    }
    ...
    public static final class Builder {
        ...
        /* renamed from: a */
        public final Bundle f8530a;

        public Builder() {
            this.f8530a = new Bundle();
        }

        /* renamed from: a */
        public final Bitmap m64979a(Bitmap bitmap, int i) {
            float f = i;
        ...
        public MediaMetadataCompat build() {
            return new MediaMetadataCompat(this.f8530a);
        }

        public Builder putBitmap(String str, Bitmap bitmap) {
            ArrayMap arrayMap = MediaMetadataCompat.f8523d;
            if (arrayMap.containsKey(str) && ((Integer) arrayMap.get(str)).intValue() != 2) {
                throw new IllegalArgumentException("The " + str + " key cannot be used to put a Bitmap");
            }
            this.f8530a.putParcelable(str, bitmap);
            return this;
        }
        ...
        public Builder putRating(String str, RatingCompat ratingCompat) {
            ...
            this.f8530a.putParcelable(str, (Parcelable) ratingCompat.getRating());
            return this;
        }
        ...
        public Builder putString(String str, String str2) {
            ...
            this.f8530a.putCharSequence(str, str2);
            return this;
        }
        ...
        public Builder putText(String str, CharSequence charSequence) {
            ...
            this.f8530a.putCharSequence(str, charSequence);
            return this;
        }

        public Builder(MediaMetadataCompat mediaMetadataCompat) {
            Bundle bundle = new Bundle(mediaMetadataCompat.f8527a);
            this.f8530a = bundle;
        ...
        public Builder(MediaMetadataCompat mediaMetadataCompat, int i) {
            ...
            for (String str : this.f8530a.keySet()) {
                Object obj = this.f8530a.get(str);
                if (obj instanceof Bitmap) {
                    Bitmap bitmap = (Bitmap) obj;
                    if (bitmap.getHeight() > i || bitmap.getWidth() > i) {
                        putBitmap(str, m64979a(bitmap, i));
                    }
                }
            }
        }
    ...
    public MediaMetadataCompat(Parcel parcel) {
        this.f8527a = parcel.readBundle(MediaSessionCompat.class.getClassLoader());
    }
}
