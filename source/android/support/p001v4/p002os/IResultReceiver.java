...
public interface IResultReceiver extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IResultReceiver {
        ...
        /* loaded from: classes.dex */
        public static class C2004a implements IResultReceiver {

            /* renamed from: a */
            public IBinder f8630a;

            public C2004a(IBinder iBinder) {
                this.f8630a = iBinder;
            }
            ...
            public void send(int i, Bundle bundle) {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    _Parcel.m64806d(obtain, bundle, 0);
                    this.f8630a.transact(1, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i != 1598968902) {
                ...
                send(parcel.readInt(), (Bundle) _Parcel.m64807c(parcel, Bundle.CREATOR));
                return true;
            }
    ...
    public static class _Parcel {
        /* renamed from: c */
        public static Object m64807c(Parcel parcel, Parcelable.Creator creator) {
            if (parcel.readInt() != 0) {
        ...
        /* renamed from: d */
        public static void m64806d(Parcel parcel, Parcelable parcelable, int i) {
            if (parcelable != null) {
                parcel.writeInt(1);
