...
public interface INotificationSideChannel extends IInterface {
    ...
    public static abstract class Stub extends Binder implements INotificationSideChannel {
        ...
        /* loaded from: classes.dex */
        public static class C1924a implements INotificationSideChannel {

            /* renamed from: a */
            public IBinder f8442a;

            public C1924a(IBinder iBinder) {
                this.f8442a = iBinder;
            }
            ...
            public void cancel(String str, int i, String str2) {
                ...
                try {
                    ...
                    this.f8442a.transact(2, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void cancelAll(String str) {
                ...
                try {
                    obtain.writeInterfaceToken(INotificationSideChannel.DESCRIPTOR);
                    obtain.writeString(str);
                    this.f8442a.transact(3, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void notify(String str, int i, String str2, Notification notification) {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    obtain.writeString(str2);
                    _Parcel.m65016d(obtain, notification, 0);
                    this.f8442a.transact(1, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i != 1598968902) {
                if (i != 1) {
                    ...
                    notify(parcel.readString(), parcel.readInt(), parcel.readString(), (Notification) _Parcel.m65017c(parcel, Notification.CREATOR));
                }
                return true;
            }
    ...
    public static class _Parcel {
        /* renamed from: c */
        public static Object m65017c(Parcel parcel, Parcelable.Creator creator) {
            if (parcel.readInt() != 0) {
        ...
        /* renamed from: d */
        public static void m65016d(Parcel parcel, Parcelable parcelable, int i) {
            if (parcelable != null) {
                parcel.writeInt(1);
