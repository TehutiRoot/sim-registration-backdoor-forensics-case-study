...
public interface IEngagementSignalsCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IEngagementSignalsCallback {
        ...
        /* loaded from: classes.dex */
        public static class C1920a implements IEngagementSignalsCallback {

            /* renamed from: a */
            public IBinder f8438a;

            public C1920a(IBinder iBinder) {
                this.f8438a = iBinder;
            }
            ...
            public void onGreatestScrollPercentageIncreased(int i, Bundle bundle) {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    _Parcel.m65032d(obtain, bundle, 0);
                    this.f8438a.transact(3, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onSessionEnded(boolean z, Bundle bundle) {
                ...
                try {
                    ...
                    _Parcel.m65032d(obtain, bundle, 0);
                    this.f8438a.transact(4, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onVerticalScrollEvent(boolean z, Bundle bundle) {
                ...
                try {
                    ...
                    obtain.writeInt(z ? 1 : 0);
                    _Parcel.m65032d(obtain, bundle, 0);
                    this.f8438a.transact(2, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i != 2) {
                if (i != 3) {
                    ...
                    onSessionEnded(z, (Bundle) _Parcel.m65033c(parcel, Bundle.CREATOR));
                } else {
                    onGreatestScrollPercentageIncreased(parcel.readInt(), (Bundle) _Parcel.m65033c(parcel, Bundle.CREATOR));
                }
            } else {
                if (parcel.readInt() != 0) {
                    z = true;
                }
                onVerticalScrollEvent(z, (Bundle) _Parcel.m65033c(parcel, Bundle.CREATOR));
            }
            return true;
        }
    }
    ...
    public static class _Parcel {
        /* renamed from: c */
        public static Object m65033c(Parcel parcel, Parcelable.Creator creator) {
            if (parcel.readInt() != 0) {
        ...
        /* renamed from: d */
        public static void m65032d(Parcel parcel, Parcelable parcelable, int i) {
            if (parcelable != null) {
                parcel.writeInt(1);
