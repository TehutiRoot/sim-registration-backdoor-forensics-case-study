...
public interface ICustomTabsCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICustomTabsCallback {
        ...
        /* loaded from: classes.dex */
        public static class C1918a implements ICustomTabsCallback {

            /* renamed from: a */
            public IBinder f8436a;

            public C1918a(IBinder iBinder) {
                this.f8436a = iBinder;
            }
            ...
            public void extraCallback(String str, Bundle bundle) {
                ...
                try {
                    ...
                    _Parcel.m65042d(obtain, bundle, 0);
            ...
            public Bundle extraCallbackWithResult(String str, Bundle bundle) {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    _Parcel.m65042d(obtain, bundle, 0);
                    this.f8436a.transact(7, obtain, obtain2, 0);
                    obtain2.readException();
                    return (Bundle) _Parcel.m65043c(obtain2, Bundle.CREATOR);
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
            ...
            public void onActivityLayout(int i, int i2, int i3, int i4, int i5, Bundle bundle) {
                ...
                try {
                    ...
                    obtain.writeInt(i5);
                    _Parcel.m65042d(obtain, bundle, 0);
                    this.f8436a.transact(10, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onActivityResized(int i, int i2, Bundle bundle) {
                ...
                try {
                    ...
                    obtain.writeInt(i2);
                    _Parcel.m65042d(obtain, bundle, 0);
                    this.f8436a.transact(8, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onMessageChannelReady(Bundle bundle) {
                ...
                try {
                    obtain.writeInterfaceToken(ICustomTabsCallback.DESCRIPTOR);
                    _Parcel.m65042d(obtain, bundle, 0);
                    this.f8436a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onMinimized(Bundle bundle) {
                ...
                try {
                    obtain.writeInterfaceToken(ICustomTabsCallback.DESCRIPTOR);
                    _Parcel.m65042d(obtain, bundle, 0);
                    this.f8436a.transact(11, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onPostMessage(String str, Bundle bundle) {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    _Parcel.m65042d(obtain, bundle, 0);
                    this.f8436a.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onUnminimized(Bundle bundle) {
                ...
                try {
                    obtain.writeInterfaceToken(ICustomTabsCallback.DESCRIPTOR);
                    _Parcel.m65042d(obtain, bundle, 0);
                    this.f8436a.transact(12, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onWarmupCompleted(Bundle bundle) {
                ...
                try {
                    obtain.writeInterfaceToken(ICustomTabsCallback.DESCRIPTOR);
                    _Parcel.m65042d(obtain, bundle, 0);
                    this.f8436a.transact(9, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                case 2:
                    onNavigationEvent(parcel.readInt(), (Bundle) _Parcel.m65043c(parcel, Bundle.CREATOR));
                    break;
                case 3:
                    extraCallback(parcel.readString(), (Bundle) _Parcel.m65043c(parcel, Bundle.CREATOR));
                    break;
                case 4:
                    onMessageChannelReady((Bundle) _Parcel.m65043c(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
                    break;
                case 5:
                    onPostMessage(parcel.readString(), (Bundle) _Parcel.m65043c(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
                    break;
                case 6:
                    int readInt = parcel.readInt();
                    Uri uri = (Uri) _Parcel.m65043c(parcel, Uri.CREATOR);
                    if (parcel.readInt() != 0) {
                        z = true;
                    } else {
                        z = false;
                    }
                    onRelationshipValidationResult(readInt, uri, z, (Bundle) _Parcel.m65043c(parcel, Bundle.CREATOR));
                    break;
                case 7:
                    Bundle extraCallbackWithResult = extraCallbackWithResult(parcel.readString(), (Bundle) _Parcel.m65043c(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
                    _Parcel.m65042d(parcel2, extraCallbackWithResult, 1);
                    break;
                case 8:
                    onActivityResized(parcel.readInt(), parcel.readInt(), (Bundle) _Parcel.m65043c(parcel, Bundle.CREATOR));
                    break;
                case 9:
                    onWarmupCompleted((Bundle) _Parcel.m65043c(parcel, Bundle.CREATOR));
                    break;
                case 10:
                    onActivityLayout(parcel.readInt(), parcel.readInt(), parcel.readInt(), parcel.readInt(), parcel.readInt(), (Bundle) _Parcel.m65043c(parcel, Bundle.CREATOR));
                    break;
                case 11:
                    onMinimized((Bundle) _Parcel.m65043c(parcel, Bundle.CREATOR));
                    break;
                case 12:
                    onUnminimized((Bundle) _Parcel.m65043c(parcel, Bundle.CREATOR));
                    break;
                default:
    ...
    public static class _Parcel {
        /* renamed from: c */
        public static Object m65043c(Parcel parcel, Parcelable.Creator creator) {
            if (parcel.readInt() != 0) {
        ...
        /* renamed from: d */
        public static void m65042d(Parcel parcel, Parcelable parcelable, int i) {
            if (parcelable != null) {
                parcel.writeInt(1);
