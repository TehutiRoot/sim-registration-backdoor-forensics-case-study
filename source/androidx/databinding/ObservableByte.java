...
public class ObservableByte extends AbstractC4289a implements Parcelable, Serializable {
    public static final Parcelable.Creator<ObservableByte> CREATOR = new C4264a();
    static final long serialVersionUID = 1;
    private byte mValue;

    /* renamed from: androidx.databinding.ObservableByte$a */
    /* loaded from: classes2.dex */
    public class C4264a implements Parcelable.Creator {
