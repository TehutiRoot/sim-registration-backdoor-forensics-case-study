...
public class CalendarViewBindingAdapter {
    ...
    /* loaded from: classes2.dex */
    public class C4293a implements CalendarView.OnDateChangeListener {

        /* renamed from: a */
        public final /* synthetic */ CalendarView.OnDateChangeListener f34554a;

        /* renamed from: b */
        public final /* synthetic */ InverseBindingListener f34555b;

        public C4293a(CalendarView.OnDateChangeListener onDateChangeListener, InverseBindingListener inverseBindingListener) {
            this.f34554a = onDateChangeListener;
            this.f34555b = inverseBindingListener;
        }

        @Override // android.widget.CalendarView.OnDateChangeListener
        public void onSelectedDayChange(CalendarView calendarView, int i, int i2, int i3) {
            CalendarView.OnDateChangeListener onDateChangeListener = this.f34554a;
            if (onDateChangeListener != null) {
                onDateChangeListener.onSelectedDayChange(calendarView, i, i2, i3);
            }
            this.f34555b.onChange();
        }
    }
    ...
    public static void setListeners(CalendarView calendarView, CalendarView.OnDateChangeListener onDateChangeListener, InverseBindingListener inverseBindingListener) {
        if (inverseBindingListener == null) {
            ...
            calendarView.setOnDateChangeListener(new C4293a(onDateChangeListener, inverseBindingListener));
        }
    }
}
