...
public class ViewBindingAdapter {
    ...
    /* loaded from: classes2.dex */
    public class View$OnAttachStateChangeListenerC4306a implements View.OnAttachStateChangeListener {

        /* renamed from: a */
        public final /* synthetic */ OnViewAttachedToWindow f34587a;

        /* renamed from: b */
        public final /* synthetic */ OnViewDetachedFromWindow f34588b;

        public View$OnAttachStateChangeListenerC4306a(OnViewAttachedToWindow onViewAttachedToWindow, OnViewDetachedFromWindow onViewDetachedFromWindow) {
            this.f34587a = onViewAttachedToWindow;
            this.f34588b = onViewDetachedFromWindow;
        }

        @Override // android.view.View.OnAttachStateChangeListener
        public void onViewAttachedToWindow(View view) {
            OnViewAttachedToWindow onViewAttachedToWindow = this.f34587a;
        ...
        public void onViewDetachedFromWindow(View view) {
            OnViewDetachedFromWindow onViewDetachedFromWindow = this.f34588b;
    ...
    /* renamed from: a */
    public static int m56290a(float f) {
        int i = (int) (0.5f + f);
        if (i != 0) {
            return i;
        }
    ...
    public static void setOnAttachStateChangeListener(View view, OnViewDetachedFromWindow onViewDetachedFromWindow, OnViewAttachedToWindow onViewAttachedToWindow) {
        View$OnAttachStateChangeListenerC4306a view$OnAttachStateChangeListenerC4306a;
        if (onViewDetachedFromWindow == null && onViewAttachedToWindow == null) {
            view$OnAttachStateChangeListenerC4306a = null;
        } else {
            view$OnAttachStateChangeListenerC4306a = new View$OnAttachStateChangeListenerC4306a(onViewAttachedToWindow, onViewDetachedFromWindow);
        }
        View.OnAttachStateChangeListener onAttachStateChangeListener = (View.OnAttachStateChangeListener) ListenerUtil.trackListener(view, view$OnAttachStateChangeListenerC4306a, R.id.onAttachStateChangeListener);
        if (onAttachStateChangeListener != null) {
            view.removeOnAttachStateChangeListener(onAttachStateChangeListener);
        }
        if (view$OnAttachStateChangeListenerC4306a != null) {
            view.addOnAttachStateChangeListener(view$OnAttachStateChangeListenerC4306a);
        }
    }
    ...
    public static void setPadding(View view, float f) {
        int m56290a = m56290a(f);
        view.setPadding(m56290a, m56290a, m56290a, m56290a);
    }

    @BindingAdapter({"android:paddingBottom"})
    public static void setPaddingBottom(View view, float f) {
        view.setPadding(view.getPaddingLeft(), view.getPaddingTop(), view.getPaddingRight(), m56290a(f));
    }

    @BindingAdapter({"android:paddingEnd"})
    public static void setPaddingEnd(View view, float f) {
        view.setPaddingRelative(view.getPaddingStart(), view.getPaddingTop(), m56290a(f), view.getPaddingBottom());
    }

    @BindingAdapter({"android:paddingLeft"})
    public static void setPaddingLeft(View view, float f) {
        view.setPadding(m56290a(f), view.getPaddingTop(), view.getPaddingRight(), view.getPaddingBottom());
    }

    @BindingAdapter({"android:paddingRight"})
    public static void setPaddingRight(View view, float f) {
        view.setPadding(view.getPaddingLeft(), view.getPaddingTop(), m56290a(f), view.getPaddingBottom());
    }

    @BindingAdapter({"android:paddingStart"})
    public static void setPaddingStart(View view, float f) {
        view.setPaddingRelative(m56290a(f), view.getPaddingTop(), view.getPaddingEnd(), view.getPaddingBottom());
    }

    @BindingAdapter({"android:paddingTop"})
    public static void setPaddingTop(View view, float f) {
        view.setPadding(view.getPaddingLeft(), m56290a(f), view.getPaddingRight(), view.getPaddingBottom());
    }
