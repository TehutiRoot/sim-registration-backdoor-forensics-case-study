...
public class AbsListViewBindingAdapter {
    ...
    /* loaded from: classes2.dex */
    public class C4291a implements AbsListView.OnScrollListener {

        /* renamed from: a */
        public final /* synthetic */ OnScrollStateChanged f34547a;

        /* renamed from: b */
        public final /* synthetic */ OnScroll f34548b;

        public C4291a(OnScrollStateChanged onScrollStateChanged, OnScroll onScroll) {
            this.f34547a = onScrollStateChanged;
            this.f34548b = onScroll;
        }

        @Override // android.widget.AbsListView.OnScrollListener
        public void onScroll(AbsListView absListView, int i, int i2, int i3) {
            OnScroll onScroll = this.f34548b;
            if (onScroll != null) {
        ...
        public void onScrollStateChanged(AbsListView absListView, int i) {
            OnScrollStateChanged onScrollStateChanged = this.f34547a;
    ...
    public static void setOnScroll(AbsListView absListView, OnScroll onScroll, OnScrollStateChanged onScrollStateChanged) {
        absListView.setOnScrollListener(new C4291a(onScrollStateChanged, onScroll));
    }
}
