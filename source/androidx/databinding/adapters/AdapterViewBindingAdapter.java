...
public class AdapterViewBindingAdapter {
    ...
    public static class OnItemSelectedComponentListener implements AdapterView.OnItemSelectedListener {
        ...
        /* renamed from: a */
        public final OnItemSelected f34549a;

        /* renamed from: b */
        public final OnNothingSelected f34550b;

        /* renamed from: c */
        public final InverseBindingListener f34551c;
        ...
        public OnItemSelectedComponentListener(OnItemSelected onItemSelected, OnNothingSelected onNothingSelected, InverseBindingListener inverseBindingListener) {
            this.f34549a = onItemSelected;
            this.f34550b = onNothingSelected;
            this.f34551c = inverseBindingListener;
        }

        @Override // android.widget.AdapterView.OnItemSelectedListener
        public void onItemSelected(AdapterView<?> adapterView, View view, int i, long j) {
            OnItemSelected onItemSelected = this.f34549a;
            if (onItemSelected != null) {
                onItemSelected.onItemSelected(adapterView, view, i, j);
            }
            InverseBindingListener inverseBindingListener = this.f34551c;
        ...
        public void onNothingSelected(AdapterView<?> adapterView) {
            OnNothingSelected onNothingSelected = this.f34550b;
