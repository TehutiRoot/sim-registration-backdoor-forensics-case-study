...
public class AutoCompleteTextViewBindingAdapter {
    ...
    /* loaded from: classes2.dex */
    public class C4292a implements AutoCompleteTextView.Validator {

        /* renamed from: a */
        public final /* synthetic */ IsValid f34552a;

        /* renamed from: b */
        public final /* synthetic */ FixText f34553b;

        public C4292a(IsValid isValid, FixText fixText) {
            this.f34552a = isValid;
            this.f34553b = fixText;
        }

        @Override // android.widget.AutoCompleteTextView.Validator
        public CharSequence fixText(CharSequence charSequence) {
            FixText fixText = this.f34553b;
            if (fixText != null) {
    ...
    public static void setValidator(AutoCompleteTextView autoCompleteTextView, FixText fixText, IsValid isValid) {
        if (fixText == null && isValid == null) {
            ...
            autoCompleteTextView.setValidator(new C4292a(isValid, fixText));
        }
    }
}
