...
public class ObservableArrayMap<K, V> extends ArrayMap<K, V> implements ObservableMap<K, V> {
    ...
    /* renamed from: k */
    public transient MapChangeRegistry f34499k;
    ...
    public void addOnMapChangedCallback(ObservableMap.OnMapChangedCallback<? extends ObservableMap<K, V>, K, V> onMapChangedCallback) {
        if (this.f34499k == null) {
            this.f34499k = new MapChangeRegistry();
        }
        this.f34499k.add(onMapChangedCallback);
    }
    ...
    /* renamed from: j */
    public final void m56353j(Object obj) {
        MapChangeRegistry mapChangeRegistry = this.f34499k;
