...
public final class WorkDatabase_Impl extends WorkDatabase {
    ...
    /* renamed from: m */
    public volatile WorkSpecDao f38330m;

    /* renamed from: n */
    public volatile DependencyDao f38331n;

    /* renamed from: o */
    public volatile WorkTagDao f38332o;

    /* renamed from: p */
    public volatile SystemIdInfoDao f38333p;

    /* renamed from: q */
    public volatile WorkNameDao f38334q;

    /* renamed from: r */
    public volatile WorkProgressDao f38335r;

    /* renamed from: s */
    public volatile PreferenceDao f38336s;

    /* renamed from: t */
    public volatile RawWorkInfoDao f38337t;

    /* renamed from: androidx.work.impl.WorkDatabase_Impl$a */
    /* loaded from: classes.dex */
    public class C5224a extends RoomOpenHelper.Delegate {
        public C5224a(int i) {
            super(i);
        }
    ...
    public SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration databaseConfiguration) {
        return databaseConfiguration.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(databaseConfiguration.context).name(databaseConfiguration.name).callback(new RoomOpenHelper(databaseConfiguration, new C5224a(20), "7d73d21f1bd82c9e5268b6dcf9fde2cb", "3071c8717539de5d5353f4c8cd59a032")).build());
    }
    ...
    public DependencyDao dependencyDao() {
        ...
        synchronized (this) {
            try {
                if (this.f38331n == null) {
                    this.f38331n = new DependencyDao_Impl(this);
                }
                dependencyDao = this.f38331n;
            } catch (Throwable th2) {
                throw th2;
            }
        }
    ...
    public List<Migration> getAutoMigrations(@NonNull Map<Class<? extends AutoMigrationSpec>, AutoMigrationSpec> map) {
        return Arrays.asList(new C19639e62(), new C19811f62(), new C19983g62(), new C20155h62(), new C20327i62(), new C20499j62());
    }
    ...
    public PreferenceDao preferenceDao() {
        ...
        synchronized (this) {
            try {
                if (this.f38336s == null) {
                    this.f38336s = new PreferenceDao_Impl(this);
                }
                preferenceDao = this.f38336s;
            } catch (Throwable th2) {
                throw th2;
            }
        }
    ...
    public RawWorkInfoDao rawWorkInfoDao() {
        ...
        synchronized (this) {
            try {
                if (this.f38337t == null) {
                    this.f38337t = new RawWorkInfoDao_Impl(this);
                }
                rawWorkInfoDao = this.f38337t;
            } catch (Throwable th2) {
                throw th2;
            }
        }
    ...
    public SystemIdInfoDao systemIdInfoDao() {
        ...
        synchronized (this) {
            try {
                if (this.f38333p == null) {
                    this.f38333p = new SystemIdInfoDao_Impl(this);
                }
                systemIdInfoDao = this.f38333p;
            } catch (Throwable th2) {
                throw th2;
            }
        }
    ...
    public WorkNameDao workNameDao() {
        ...
        synchronized (this) {
            try {
                if (this.f38334q == null) {
                    this.f38334q = new WorkNameDao_Impl(this);
                }
                workNameDao = this.f38334q;
            } catch (Throwable th2) {
                throw th2;
            }
        }
    ...
    public WorkProgressDao workProgressDao() {
        ...
        synchronized (this) {
            try {
                if (this.f38335r == null) {
                    this.f38335r = new WorkProgressDao_Impl(this);
                }
                workProgressDao = this.f38335r;
            } catch (Throwable th2) {
                throw th2;
            }
        }
    ...
    public WorkSpecDao workSpecDao() {
        ...
        synchronized (this) {
            try {
                if (this.f38330m == null) {
                    this.f38330m = new WorkSpecDao_Impl(this);
                }
                workSpecDao = this.f38330m;
            } catch (Throwable th2) {
                throw th2;
            }
        }
    ...
    public WorkTagDao workTagDao() {
        ...
        synchronized (this) {
            try {
                if (this.f38332o == null) {
                    this.f38332o = new WorkTagDao_Impl(this);
                }
                workTagDao = this.f38332o;
            } catch (Throwable th2) {
                throw th2;
            }
        }
