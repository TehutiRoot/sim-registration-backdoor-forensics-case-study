...
public final class SystemIdInfo {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof SystemIdInfo) {
            ...
            return Intrinsics.areEqual(this.workSpecId, systemIdInfo.workSpecId) && this.f38578a == systemIdInfo.f38578a && this.systemId == systemIdInfo.systemId;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((this.workSpecId.hashCode() * 31) + this.f38578a) * 31) + this.systemId;
    }

    @NotNull
    public String toString() {
        return "SystemIdInfo(workSpecId=" + this.workSpecId + ", generation=" + this.f38578a + ", systemId=" + this.systemId + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
}
