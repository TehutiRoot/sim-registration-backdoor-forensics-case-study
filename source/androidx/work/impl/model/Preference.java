...
public final class Preference {
    ...
    public static /* synthetic */ Preference copy$default(Preference preference, String str, Long l, int i, Object obj) {
        if ((i & 1) != 0) {
            str = preference.f38566a;
        }
        if ((i & 2) != 0) {
            l = preference.f38567b;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof Preference) {
            ...
            return Intrinsics.areEqual(this.f38566a, preference.f38566a) && Intrinsics.areEqual(this.f38567b, preference.f38567b);
        }
        return false;
    }
    ...
    public String toString() {
        return "Preference(key=" + this.f38566a + ", value=" + this.f38567b + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
