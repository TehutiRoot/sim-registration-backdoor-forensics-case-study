...
@Metadata(m28851d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010$\n\u0002\u0018\u0002\n\u0002\b\u0007\bÇ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0017\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u0004H\u0007¢\u0006\u0004\b\u0007\u0010\bJ!\u0010\u000b\u001a\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n0\t2\u0006\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\u000b\u0010\fJ\u0015\u0010\r\u001a\u00020\n2\u0006\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\r\u0010\u000eJ\u0015\u0010\u000f\u001a\u00020\n2\u0006\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\u000f\u0010\u000eJ\u0017\u0010\u0010\u001a\u00020\n2\u0006\u0010\u0005\u001a\u00020\u0004H\u0003¢\u0006\u0004\b\u0010\u0010\u000e¨\u0006\u0011"}, m28850d2 = {"Landroidx/work/impl/WorkDatabasePathHelper;", "", "<init>", "()V", "Landroid/content/Context;", CoreConstants.CONTEXT_SCOPE_VALUE, "", "migrateDatabase", "(Landroid/content/Context;)V", "", "Ljava/io/File;", "migrationPaths", "(Landroid/content/Context;)Ljava/util/Map;", "getDefaultDatabasePath", "(Landroid/content/Context;)Ljava/io/File;", "getDatabasePath", PDPageLabelRange.STYLE_LETTERS_LOWER, "work-runtime_release"}, m28849k = 1, m28848mv = {1, 8, 0})
...
public final class WorkDatabasePathHelper {
    ...
    public static final void migrateDatabase(@NotNull Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 23 && defaultDatabasePath.exists()) {
            ...
            str = WorkDatabasePathHelperKt.f38328a;
            ...
            for (Map.Entry<File, File> entry : workDatabasePathHelper.migrationPaths(context).entrySet()) {
                ...
                if (key.exists()) {
                    if (value.exists()) {
                        ...
                        str4 = WorkDatabasePathHelperKt.f38328a;
                    ...
                    str3 = WorkDatabasePathHelperKt.f38328a;
    ...
    /* renamed from: a */
    public final File m52330a(Context context) {
    ...
    public final Map<File, File> migrationPaths(@NotNull Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            strArr = WorkDatabasePathHelperKt.f38329b;
            LinkedHashMap linkedHashMap = new LinkedHashMap(AbstractC11719c.coerceAtLeast(AbstractC18515Tn0.mapCapacity(strArr.length), 16));
            for (String str : strArr) {
                Pair m28844to = TuplesKt.m28844to(new File(defaultDatabasePath.getPath() + str), new File(databasePath.getPath() + str));
                linkedHashMap.put(m28844to.getFirst(), m28844to.getSecond());
            }
            return AbstractC11687a.plus(linkedHashMap, TuplesKt.m28844to(defaultDatabasePath, databasePath));
        }
