...
@Metadata(m28851d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\u001a\u0011\u0010\u0002\u001a\u00020\u0001*\u00020\u0000¢\u0006\u0004\b\u0002\u0010\u0003\u001a#\u0010\n\u001a\u00020\t2\n\u0010\u0006\u001a\u00060\u0004j\u0002`\u00052\u0006\u0010\b\u001a\u00020\u0007H\u0002¢\u0006\u0004\b\n\u0010\u000b¨\u0006\f"}, m28850d2 = {"Landroidx/work/WorkQuery;", "Landroidx/sqlite/db/SupportSQLiteQuery;", "toRawQuery", "(Landroidx/work/WorkQuery;)Landroidx/sqlite/db/SupportSQLiteQuery;", "Ljava/lang/StringBuilder;", "Lkotlin/text/StringBuilder;", "builder", "", "count", "", PDPageLabelRange.STYLE_LETTERS_LOWER, "(Ljava/lang/StringBuilder;I)V", "work-runtime_release"}, m28849k = 2, m28848mv = {1, 8, 0})
@JvmName(name = "RawQueries")
@SourceDebugExtension({"SMAP\nRawQueries.kt\nKotlin\n*S Kotlin\n*F\n+ 1 RawQueries.kt\nandroidx/work/impl/utils/RawQueries\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n+ 3 ArraysJVM.kt\nkotlin/collections/ArraysKt__ArraysJVMKt\n+ 4 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,73:1\n1549#2:74\n1620#2,3:75\n1549#2:78\n1620#2,3:79\n37#3,2:82\n1#4:84\n*S KotlinDebug\n*F\n+ 1 RawQueries.kt\nandroidx/work/impl/utils/RawQueries\n*L\n35#1:74\n35#1:75,3\n43#1:78\n43#1:79,3\n64#1:82,2\n*E\n"})
/* loaded from: classes.dex */
public final class RawQueries {
    /* renamed from: a */
    public static final void m52160a(StringBuilder sb, int i) {
        if (i <= 0) {
            return;
        }
    ...
    public static final SupportSQLiteQuery toRawQuery(@NotNull WorkQuery workQuery) {
        ...
        if (!ids.isEmpty()) {
            ...
            ArrayList arrayList3 = new ArrayList(AbstractC10176es.collectionSizeOrDefault(list2, 10));
            for (UUID uuid : list2) {
                arrayList3.add(uuid.toString());
            }
            sb.append(str2 + " id IN (");
            m52160a(sb, workQuery.getIds().size());
            sb.append(")");
        ...
        if (!tags.isEmpty()) {
            ...
            m52160a(sb, workQuery.getTags().size());
            sb.append("))");
        ...
        if (!uniqueWorkNames.isEmpty()) {
            ...
            m52160a(sb, workQuery.getUniqueWorkNames().size());
            sb.append("))");
