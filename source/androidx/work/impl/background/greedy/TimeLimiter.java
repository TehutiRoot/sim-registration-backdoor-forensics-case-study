...
public final class TimeLimiter {
    ...
    /* renamed from: a */
    public static /* synthetic */ void m52285a(TimeLimiter timeLimiter, StartStopToken startStopToken) {
        m52284b(timeLimiter, startStopToken);
    }

    /* renamed from: b */
    public static final void m52284b(TimeLimiter this$0, StartStopToken token) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(token, "$token");
        this$0.f38418b.stopWork(token, 3);
    }

    public final void cancel(@NotNull StartStopToken token) {
        Runnable runnable;
        Intrinsics.checkNotNullParameter(token, "token");
        synchronized (this.f38420d) {
            runnable = (Runnable) this.f38421e.remove(token);
        }
        if (runnable != null) {
            this.f38417a.cancel(runnable);
        }
    }

    public final void track(@NotNull final StartStopToken token) {
        Intrinsics.checkNotNullParameter(token, "token");
        Runnable runnable = new Runnable() { // from class: fT1
            {
                TimeLimiter.this = this;
            }

            @Override // java.lang.Runnable
            public final void run() {
                TimeLimiter.m52285a(TimeLimiter.this, token);
            }
        };
        synchronized (this.f38420d) {
            Runnable runnable2 = (Runnable) this.f38421e.put(token, runnable);
        }
        this.f38417a.scheduleWithDelay(this.f38419c, runnable);
    }
    ...
    public TimeLimiter(@NotNull RunnableScheduler runnableScheduler, @NotNull WorkLauncher launcher, long j) {
        Intrinsics.checkNotNullParameter(runnableScheduler, "runnableScheduler");
        Intrinsics.checkNotNullParameter(launcher, "launcher");
        this.f38417a = runnableScheduler;
        this.f38418b = launcher;
        this.f38419c = j;
        this.f38420d = new Object();
