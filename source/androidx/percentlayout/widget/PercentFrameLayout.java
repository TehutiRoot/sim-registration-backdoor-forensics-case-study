...
public class PercentFrameLayout extends FrameLayout {
    ...
    /* renamed from: a */
    public final PercentLayoutHelper f36470a;

    public PercentFrameLayout(Context context) {
        super(context);
        this.f36470a = new PercentLayoutHelper(this);
    }

    @Override // android.widget.FrameLayout, android.view.ViewGroup, android.view.View
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        super.onLayout(z, i, i2, i3, i4);
        this.f36470a.restoreOriginalParams();
    }

    @Override // android.widget.FrameLayout, android.view.View
    public void onMeasure(int i, int i2) {
        this.f36470a.adjustChildren(i, i2);
        super.onMeasure(i, i2);
        if (this.f36470a.handleMeasuredStateTooSmall()) {
            super.onMeasure(i, i2);
        }
    }
    ...
    public static class LayoutParams extends FrameLayout.LayoutParams implements PercentLayoutHelper.PercentLayoutParams {
        ...
        /* renamed from: a */
        public PercentLayoutHelper.PercentLayoutInfo f36471a;

        public LayoutParams(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            this.f36471a = PercentLayoutHelper.getPercentLayoutInfo(context, attributeSet);
        }

        @Override // androidx.percentlayout.widget.PercentLayoutHelper.PercentLayoutParams
        public PercentLayoutHelper.PercentLayoutInfo getPercentLayoutInfo() {
            if (this.f36471a == null) {
                this.f36471a = new PercentLayoutHelper.PercentLayoutInfo();
            }
            return this.f36471a;
        }
        ...
        public LayoutParams(LayoutParams layoutParams) {
            ...
            this.f36471a = layoutParams.f36471a;
        }
    }
