...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    /* renamed from: i */
    public final DisplayMetrics f36805i;

    /* renamed from: k */
    public float f36807k;
    ...
    /* renamed from: j */
    public boolean f36806j = false;
    protected int mInterimTargetDx = 0;
    protected int mInterimTargetDy = 0;

    @SuppressLint({"UnknownNullness"})
    public LinearSmoothScroller(Context context) {
        this.f36805i = context.getResources().getDisplayMetrics();
    }

    /* renamed from: c */
    public final int m53511c(int i, int i2) {
        int i3 = i - i2;
        if (i * i3 <= 0) {
            return 0;
        }
    ...
    public int calculateTimeForScrolling(int i) {
        return (int) Math.ceil(Math.abs(i) * m53510d());
    }

    /* renamed from: d */
    public final float m53510d() {
        if (!this.f36806j) {
            this.f36807k = calculateSpeedPerPixel(this.f36805i);
            this.f36806j = true;
        }
        return this.f36807k;
    }
    ...
    public void onSeekTargetStep(int i, int i2, RecyclerView.State state, RecyclerView.SmoothScroller.Action action) {
        ...
        this.mInterimTargetDx = m53511c(this.mInterimTargetDx, i);
        int m53511c = m53511c(this.mInterimTargetDy, i2);
        this.mInterimTargetDy = m53511c;
        if (this.mInterimTargetDx == 0 && m53511c == 0) {
