...
public class SimpleCursorAdapter extends ResourceCursorAdapter {
    ...
    /* renamed from: e */
    public CursorToStringConverter f34433e;

    /* renamed from: f */
    public ViewBinder f34434f;

    /* renamed from: g */
    public String[] f34435g;
    ...
    public SimpleCursorAdapter(Context context, int i, Cursor cursor, String[] strArr, int[] iArr) {
        ...
        this.mTo = iArr;
        this.f34435g = strArr;
        m56430b(cursor, strArr);
    }

    /* renamed from: b */
    public final void m56430b(Cursor cursor, String[] strArr) {
        if (cursor != null) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        boolean z;
        ViewBinder viewBinder = this.f34434f;
        int[] iArr = this.mTo;
    ...
    public CharSequence convertToString(Cursor cursor) {
        CursorToStringConverter cursorToStringConverter = this.f34433e;
    ...
    public void setCursorToStringConverter(CursorToStringConverter cursorToStringConverter) {
        this.f34433e = cursorToStringConverter;
    }
