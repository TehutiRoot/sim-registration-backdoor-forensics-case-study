...
public final class ShareTarget {
    ...
    public static final class FileFormField {
        ...
        /* renamed from: a */
        public static FileFormField m63984a(Bundle bundle) {
            if (bundle == null) {
                return null;
            }
    ...
    public static class Params {
        ...
        /* renamed from: a */
        public static Params m63982a(Bundle bundle) {
            ...
            if (parcelableArrayList != null) {
                ...
                for (Bundle bundle2 : parcelableArrayList) {
                    arrayList.add(FileFormField.m63984a(bundle2));
                }
            }
        ...
        public Bundle m63981b() {
            ...
            if (this.files != null) {
                ...
                for (FileFormField fileFormField : this.files) {
                    arrayList.add(fileFormField.m63983b());
                }
    ...
    public static ShareTarget fromBundle(@NonNull Bundle bundle) {
        ...
        Params m63982a = Params.m63982a(bundle.getBundle(KEY_PARAMS));
        if (string != null && m63982a != null) {
            return new ShareTarget(string, string2, string3, m63982a);
        }
        return null;
    }
    ...
    public Bundle toBundle() {
        ...
        bundle.putBundle(KEY_PARAMS, this.params.m63981b());
        return bundle;
    }
}
