...
public abstract class AbstractC2113a {
    ...
    /* loaded from: classes.dex */
    public static class ExecutorC2114a implements Executor {

        /* renamed from: a */
        public final Object f9049a = new Object();

        /* renamed from: b */
        public final Queue f9050b = new ArrayDeque();

        /* renamed from: c */
        public final Executor f9051c;

        /* renamed from: d */
        public Runnable f9052d;

        public ExecutorC2114a(Executor executor) {
            this.f9051c = executor;
        }

        /* renamed from: a */
        public static /* synthetic */ void m64565a(ExecutorC2114a executorC2114a, Runnable runnable) {
            executorC2114a.m64564c(runnable);
        }

        /* renamed from: c */
        public final /* synthetic */ void m64564c(Runnable runnable) {
            try {
                runnable.run();
            } finally {
                m64563d();
        ...
        public void m64563d() {
            synchronized (this.f9049a) {
                try {
                    Runnable runnable = (Runnable) this.f9050b.poll();
                    this.f9052d = runnable;
                    if (runnable != null) {
                        this.f9051c.execute(runnable);
                    }
                } catch (Throwable th2) {
                    throw th2;
                }
        ...
        public void execute(final Runnable runnable) {
            synchronized (this.f9049a) {
                try {
                    this.f9050b.add(new Runnable() { // from class: b6
                        {
                            AbstractC2113a.ExecutorC2114a.this = this;
                        }

                        @Override // java.lang.Runnable
                        public final void run() {
                            AbstractC2113a.ExecutorC2114a.m64565a(AbstractC2113a.ExecutorC2114a.this, runnable);
                        }
                    });
                    if (this.f9052d == null) {
                        m64563d();
    ...
    /* loaded from: classes.dex */
    public static class ExecutorC2115b implements Executor {
        @Override // java.util.concurrent.Executor
    ...
    /* renamed from: a */
    public static void m64568a(Context context, String str) {
        if (str.equals("")) {
    ...
    */
    public static java.lang.String m64567b(android.content.Context r9) {
        /*
        ...
        L72:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.app.AbstractC2113a.m64567b(android.content.Context):java.lang.String");
    }

    /* renamed from: c */
    public static void m64566c(Context context) {
        if (Build.VERSION.SDK_INT >= 33) {
            ComponentName componentName = new ComponentName(context, "androidx.appcompat.app.AppLocalesMetadataHolderService");
            if (context.getPackageManager().getComponentEnabledSetting(componentName) != 1) {
                if (AppCompatDelegate.getApplicationLocales().isEmpty()) {
                    String m64567b = m64567b(context);
                    Object systemService = context.getSystemService("locale");
                    if (systemService != null) {
                        AppCompatDelegate.C2083b.m64685b(systemService, AppCompatDelegate.C2082a.m64687a(m64567b));
                    }
                }
