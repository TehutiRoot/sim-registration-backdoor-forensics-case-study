...
public class VectorEnabledTintResources extends AbstractC18024Lx1 {
    ...
    /* renamed from: b */
    public final WeakReference f10031b;

    public VectorEnabledTintResources(@NonNull Context context, @NonNull Resources resources) {
        super(resources);
        this.f10031b = new WeakReference(context);
    }
    ...
    @Override // p000.AbstractC18024Lx1, android.content.res.Resources
    ...
    public Drawable getDrawable(int i) throws Resources.NotFoundException {
        Context context = (Context) this.f10031b.get();
        if (context != null) {
            return ResourceManagerInternal.get().m64240p(context, this, i);
        }
        return m67451a(i);
    }
