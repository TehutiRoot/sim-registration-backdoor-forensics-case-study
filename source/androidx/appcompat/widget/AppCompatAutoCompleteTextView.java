...
public class AppCompatAutoCompleteTextView extends AutoCompleteTextView implements TintableBackgroundView, EmojiCompatConfigurationView, TintableCompoundDrawablesView {
    ...
    /* renamed from: d */
    public static final int[] f9574d = {16843126};

    /* renamed from: a */
    public final C13159q5 f9575a;

    /* renamed from: b */
    public final C1432U5 f9576b;

    /* renamed from: c */
    public final C0716K5 f9577c;
    ...
    /* renamed from: a */
    public void m64360a(C0716K5 c0716k5) {
    ...
    public void drawableStateChanged() {
        ...
        C13159q5 c13159q5 = this.f9575a;
        if (c13159q5 != null) {
            c13159q5.m23544b();
        }
        C1432U5 c1432u5 = this.f9576b;
        if (c1432u5 != null) {
            c1432u5.m66126b();
        }
    }
    ...
    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f9576b.m66117k();
    }

    @Override // androidx.appcompat.widget.EmojiCompatConfigurationView
    public boolean isEmojiCompatEnabled() {
        return this.f9577c.m67644c();
    }

    @Override // android.widget.TextView, android.view.View
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        return this.f9577c.m67642e(AbstractC0845M5.m67428a(super.onCreateInputConnection(editorInfo), editorInfo, this), editorInfo);
    }
    ...
    public void setEmojiCompatEnabled(boolean z) {
        this.f9577c.m67641f(z);
    }

    @Override // android.widget.TextView
    public void setKeyListener(@Nullable KeyListener keyListener) {
        super.setKeyListener(this.f9577c.m67646a(keyListener));
    }
    ...
    public void setSupportCompoundDrawablesTintList(@Nullable ColorStateList colorStateList) {
        this.f9576b.m66105w(colorStateList);
        this.f9576b.m66126b();
    }
    ...
    public AppCompatAutoCompleteTextView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getContext(), attributeSet, f9574d, i, 0);
        if (obtainStyledAttributes.hasValue(0)) {
            setDropDownBackgroundDrawable(obtainStyledAttributes.getDrawable(0));
        }
        obtainStyledAttributes.recycle();
        C13159q5 c13159q5 = new C13159q5(this);
        this.f9575a = c13159q5;
