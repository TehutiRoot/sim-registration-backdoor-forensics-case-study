...
public class ComponentActivity extends androidx.core.app.ComponentActivity implements ContextAware, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, OnBackPressedDispatcherOwner, ActivityResultRegistryOwner, ActivityResultCaller, OnConfigurationChangedProvider, OnTrimMemoryProvider, OnNewIntentProvider, OnMultiWindowModeChangedProvider, OnPictureInPictureModeChangedProvider, MenuHost, FullyDrawnReporterOwner {
    ...
    final InterfaceExecutorC2020j mReportFullyDrawnExecutor;
    final SavedStateRegistryController mSavedStateRegistryController;
    private ViewModelStore mViewModelStore;

    /* renamed from: androidx.activity.ComponentActivity$a */
    /* loaded from: classes.dex */
    public class C2009a extends ActivityResultRegistry {
        ...
        public class RunnableC2010a implements Runnable {
            ...
            /* renamed from: b */
            public final /* synthetic */ ActivityResultContract.SynchronousResult f8645b;

            public RunnableC2010a(int i, ActivityResultContract.SynchronousResult synchronousResult) {
                C2009a.this = r1;
                this.f8644a = i;
                this.f8645b = synchronousResult;
            }

            @Override // java.lang.Runnable
            public void run() {
                C2009a.this.dispatchResult(this.f8644a, this.f8645b.getValue());
            }
        }
        ...
        public class RunnableC2011b implements Runnable {
            ...
            /* renamed from: b */
            public final /* synthetic */ IntentSender.SendIntentException f8648b;

            public RunnableC2011b(int i, IntentSender.SendIntentException sendIntentException) {
                C2009a.this = r1;
                this.f8647a = i;
                this.f8648b = sendIntentException;
            }

            @Override // java.lang.Runnable
            public void run() {
                C2009a.this.dispatchResult(this.f8647a, 0, new Intent().setAction(ActivityResultContracts.StartIntentSenderForResult.ACTION_INTENT_SENDER_REQUEST).putExtra(ActivityResultContracts.StartIntentSenderForResult.EXTRA_SEND_INTENT_EXCEPTION, this.f8648b));
            }
        }
        ...
        public void onLaunch(int i, ActivityResultContract activityResultContract, Object obj, ActivityOptionsCompat activityOptionsCompat) {
            Bundle bundle;
            Bundle bundle2;
            ...
            if (synchronousResult != null) {
                new Handler(Looper.getMainLooper()).post(new RunnableC2010a(i, synchronousResult));
                return;
            }
            ...
            if (ActivityResultContracts.RequestMultiplePermissions.ACTION_REQUEST_PERMISSIONS.equals(createIntent.getAction())) {
                ...
                try {
                    ...
                    new Handler(Looper.getMainLooper()).post(new RunnableC2011b(i, e));
                }
            } else {
    ...
    /* loaded from: classes.dex */
    public class C2012b implements LifecycleEventObserver {
        public C2012b() {
            ComponentActivity.this = r1;
        }
    ...
    /* loaded from: classes.dex */
    public class C2013c implements LifecycleEventObserver {
        public C2013c() {
            ComponentActivity.this = r1;
        }
        ...
        public void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
            if (event == Lifecycle.Event.ON_DESTROY) {
                ...
                ComponentActivity.this.mReportFullyDrawnExecutor.mo64787g();
            }
        }
    }
    ...
    /* loaded from: classes.dex */
    public class C2014d implements LifecycleEventObserver {
        public C2014d() {
            ComponentActivity.this = r1;
        }
    ...
    /* loaded from: classes.dex */
    public class C2016f implements LifecycleEventObserver {
        public C2016f() {
            ComponentActivity.this = r1;
        }
        ...
        public void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
            if (event == Lifecycle.Event.ON_CREATE && Build.VERSION.SDK_INT >= 33) {
                ComponentActivity.this.mOnBackPressedDispatcher.setOnBackInvokedDispatcher(C2018h.m64791a((ComponentActivity) lifecycleOwner));
            }
        }
    }
    ...
    /* loaded from: classes.dex */
    public static class C2017g {
        /* renamed from: a */
        public static void m64792a(View view) {
    ...
    /* loaded from: classes.dex */
    public static class C2018h {
        @DoNotInline
        /* renamed from: a */
        public static OnBackInvokedDispatcher m64791a(Activity activity) {
    ...
    /* loaded from: classes.dex */
    public static final class C2019i {

        /* renamed from: a */
        public Object f8655a;

        /* renamed from: b */
        public ViewModelStore f8656b;
    }

    /* renamed from: androidx.activity.ComponentActivity$j */
    /* loaded from: classes.dex */
    public interface InterfaceExecutorC2020j extends Executor {
        /* renamed from: b */
        void mo64789b(View view);
    ...
    /* loaded from: classes.dex */
    public class ViewTreeObserver$OnDrawListenerC2021k implements InterfaceExecutorC2020j, ViewTreeObserver.OnDrawListener, Runnable {

        /* renamed from: b */
        public Runnable f8658b;

        /* renamed from: a */
        public final long f8657a = SystemClock.uptimeMillis() + 10000;

        /* renamed from: c */
        public boolean f8659c = false;

        public ViewTreeObserver$OnDrawListenerC2021k() {
            ComponentActivity.this = r5;
        }

        /* renamed from: a */
        public static /* synthetic */ void m64790a(ViewTreeObserver$OnDrawListenerC2021k viewTreeObserver$OnDrawListenerC2021k) {
            viewTreeObserver$OnDrawListenerC2021k.m64788c();
        }

        @Override // androidx.activity.ComponentActivity.InterfaceExecutorC2020j
        /* renamed from: b */
        public void mo64789b(View view) {
            if (!this.f8659c) {
                this.f8659c = true;
        ...
        /* renamed from: c */
        public final /* synthetic */ void m64788c() {
            Runnable runnable = this.f8658b;
            if (runnable != null) {
                runnable.run();
                this.f8658b = null;
            }
        ...
        public void execute(Runnable runnable) {
            ...
            decorView.postOnAnimation(new Runnable() { // from class: Tu
                {
                    ComponentActivity.ViewTreeObserver$OnDrawListenerC2021k.this = this;
                }

                @Override // java.lang.Runnable
                public final void run() {
                    ComponentActivity.ViewTreeObserver$OnDrawListenerC2021k.m64790a(ComponentActivity.ViewTreeObserver$OnDrawListenerC2021k.this);
                }
            });
        }
        ...
        public void onDraw() {
            ...
            } else if (SystemClock.uptimeMillis() > this.f8657a) {
                this.f8659c = false;
                ComponentActivity.this.getWindow().getDecorView().post(this);
            }
        }
    ...
    public ComponentActivity() {
        ...
        this.mMenuHostHelper = new MenuHostHelper(new Runnable() { // from class: Pu
            {
        ...
        InterfaceExecutorC2020j m64796e = m64796e();
        this.mReportFullyDrawnExecutor = m64796e;
        this.mFullyDrawnReporter = new FullyDrawnReporter(m64796e, new Function0() { // from class: Qu
            {
                ComponentActivity.this = this;
            }
            ...
            public final Object invoke() {
                return ComponentActivity.m64797d(ComponentActivity.this);
            }
        });
        this.mNextLocalRequestCode = new AtomicInteger();
        this.mActivityResultRegistry = new C2009a();
        ...
        if (getLifecycle() != null) {
            ...
            getLifecycle().addObserver(new C2012b());
            getLifecycle().addObserver(new C2013c());
            getLifecycle().addObserver(new C2014d());
            create.performAttach();
            SavedStateHandleSupport.enableSavedStateHandles(this);
            if (i <= 23) {
                getLifecycle().addObserver(new C22474ud0(this));
            }
            getSavedStateRegistry().registerSavedStateProvider(ACTIVITY_RESULT_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: Ru
                @Override // androidx.savedstate.SavedStateRegistry.SavedStateProvider
                public final Bundle saveState() {
                    return ComponentActivity.m64798c(ComponentActivity.this);
                }
            });
            addOnContextAvailableListener(new OnContextAvailableListener() { // from class: Su
                {
                    ComponentActivity.this = this;
                }
                ...
                public final void onContextAvailable(Context context) {
                    ComponentActivity.m64799b(ComponentActivity.this, context);
                }
            });
            return;
        }
    ...
    /* renamed from: b */
    public static /* synthetic */ void m64799b(ComponentActivity componentActivity, Context context) {
        componentActivity.m64793h(context);
    }

    /* renamed from: c */
    public static /* synthetic */ Bundle m64798c(ComponentActivity componentActivity) {
        return componentActivity.m64794g();
    }

    /* renamed from: d */
    public static /* synthetic */ Unit m64797d(ComponentActivity componentActivity) {
        return componentActivity.m64795f();
    }

    @Override // android.app.Activity
    public void addContentView(@SuppressLint({"UnknownNullness", "MissingNullability"}) View view, @SuppressLint({"UnknownNullness", "MissingNullability"}) ViewGroup.LayoutParams layoutParams) {
        initializeViewTreeOwners();
        this.mReportFullyDrawnExecutor.mo64789b(getWindow().getDecorView());
    ...
    /* renamed from: e */
    public final InterfaceExecutorC2020j m64796e() {
        return new ViewTreeObserver$OnDrawListenerC2021k();
    }

    public void ensureViewModelStore() {
        if (this.mViewModelStore == null) {
            C2019i c2019i = (C2019i) getLastNonConfigurationInstance();
            if (c2019i != null) {
                this.mViewModelStore = c2019i.f8656b;
            }
            if (this.mViewModelStore == null) {
    ...
    /* renamed from: f */
    public final /* synthetic */ Unit m64795f() {
        reportFullyDrawn();
        return null;
    }

    /* renamed from: g */
    public final /* synthetic */ Bundle m64794g() {
    ...
    public final OnBackPressedDispatcher getOnBackPressedDispatcher() {
        if (this.mOnBackPressedDispatcher == null) {
            this.mOnBackPressedDispatcher = new OnBackPressedDispatcher(new RunnableC2015e());
            getLifecycle().addObserver(new C2016f());
        }
    ...
    /* renamed from: h */
    public final /* synthetic */ void m64793h(Context context) {
    ...
    public final Object onRetainNonConfigurationInstance() {
        ...
        if (viewModelStore == null && (c2019i = (C2019i) getLastNonConfigurationInstance()) != null) {
            viewModelStore = c2019i.f8656b;
        }
        if (viewModelStore == null && onRetainCustomNonConfigurationInstance == null) {
            return null;
        }
        C2019i c2019i2 = new C2019i();
        c2019i2.f8655a = onRetainCustomNonConfigurationInstance;
        c2019i2.f8656b = viewModelStore;
        return c2019i2;
    }
