...
public final class C2035x54146ae extends Lambda implements Function1<View, View> {
    public static final C2035x54146ae INSTANCE = new C2035x54146ae();

    public C2035x54146ae() {
        super(1);
    }
