...
public final class EdgeToEdge {
    ...
    /* renamed from: a */
    public static final int f8664a = Color.argb(230, 255, 255, 255);

    /* renamed from: b */
    public static final int f8665b = Color.argb(128, 27, 27, 27);

    /* renamed from: c */
    public static InterfaceC1241RQ f8666c;
    ...
    public static /* synthetic */ void enable$default(ComponentActivity componentActivity, SystemBarStyle systemBarStyle, SystemBarStyle systemBarStyle2, int i, Object obj) {
        ...
        if ((i & 2) != 0) {
            systemBarStyle2 = SystemBarStyle.Companion.auto$default(SystemBarStyle.Companion, f8664a, f8665b, null, 4, null);
        }
    ...
    public static final void enable(@NotNull ComponentActivity componentActivity, @NotNull SystemBarStyle statusBarStyle, @NotNull SystemBarStyle navigationBarStyle) {
        ...
        InterfaceC1241RQ interfaceC1241RQ = f8666c;
        if (interfaceC1241RQ == null) {
            int i = Build.VERSION.SDK_INT;
            if (i >= 29) {
                interfaceC1241RQ = new C1177QQ();
            } else if (i >= 26) {
                interfaceC1241RQ = new C0943NQ();
            } else if (i >= 23) {
                interfaceC1241RQ = new C0869MQ();
            } else {
                interfaceC1241RQ = new C0803LQ();
                f8666c = interfaceC1241RQ;
            }
        }
        InterfaceC1241RQ interfaceC1241RQ2 = interfaceC1241RQ;
        Window window = componentActivity.getWindow();
        Intrinsics.checkNotNullExpressionValue(window, "window");
        interfaceC1241RQ2.mo66456a(statusBarStyle, navigationBarStyle, window, decorView, booleanValue, booleanValue2);
    }
}
