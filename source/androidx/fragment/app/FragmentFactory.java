...
public class FragmentFactory {
    ...
    /* renamed from: a */
    public static final SimpleArrayMap f35452a = new SimpleArrayMap();

    /* renamed from: a */
    public static boolean m54451a(ClassLoader classLoader, String str) {
        try {
            return Fragment.class.isAssignableFrom(m54450b(classLoader, str));
    ...
    /* renamed from: b */
    public static Class m54450b(ClassLoader classLoader, String str) {
        SimpleArrayMap simpleArrayMap = f35452a;
    ...
    public static Class<? extends Fragment> loadFragmentClass(@NonNull ClassLoader classLoader, @NonNull String str) {
        try {
            return m54450b(classLoader, str);
