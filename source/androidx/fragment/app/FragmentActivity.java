...
public class FragmentActivity extends ComponentActivity implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    public FragmentActivity() {
        this.mFragments = FragmentController.createController(new C4586a());
    ...
    /* renamed from: i */
    public static /* synthetic */ void m54463i(FragmentActivity fragmentActivity, Context context) {
        fragmentActivity.m54455q(context);
    }

    /* renamed from: j */
    public static /* synthetic */ void m54462j(FragmentActivity fragmentActivity, Configuration configuration) {
        fragmentActivity.m54457o(configuration);
    }

    /* renamed from: l */
    public static /* synthetic */ void m54460l(FragmentActivity fragmentActivity, Intent intent) {
        fragmentActivity.m54456p(intent);
    }

    /* renamed from: m */
    private void m54459m() {
        getSavedStateRegistry().registerSavedStateProvider(LIFECYCLE_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: K40
            @Override // androidx.savedstate.SavedStateRegistry.SavedStateProvider
            public final Bundle saveState() {
                Bundle m54458n;
                m54458n = FragmentActivity.this.m54458n();
                return m54458n;
            }
        });
        addOnConfigurationChangedListener(new Consumer() { // from class: L40
            {
                FragmentActivity.this = this;
            }

            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
                FragmentActivity.m54462j(FragmentActivity.this, (Configuration) obj);
            }
        });
        addOnNewIntentListener(new Consumer() { // from class: M40
            {
                FragmentActivity.this = this;
            }
            ...
            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
                FragmentActivity.m54460l(FragmentActivity.this, (Intent) obj);
            }
        });
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: N40
            {
                FragmentActivity.this = this;
            }
            ...
            public final void onContextAvailable(Context context) {
                FragmentActivity.m54463i(FragmentActivity.this, context);
            }
        });
    }

    /* renamed from: r */
    public static boolean m54454r(FragmentManager fragmentManager, Lifecycle.State state) {
        boolean z = false;
        for (Fragment fragment : fragmentManager.getFragments()) {
            if (fragment != null) {
                if (fragment.getHost() != null) {
                    z |= m54454r(fragment.getChildFragmentManager(), state);
                }
                C4637l c4637l = fragment.mViewLifecycleOwner;
                if (c4637l != null && c4637l.getLifecycle().getCurrentState().isAtLeast(Lifecycle.State.STARTED)) {
                    fragment.mViewLifecycleOwner.m54168f(state);
                    z = true;
                }
    ...
    public void markFragmentsCreated() {
        do {
        } while (m54454r(getSupportFragmentManager(), Lifecycle.State.CREATED));
    }

    /* renamed from: n */
    public final /* synthetic */ Bundle m54458n() {
    ...
    /* renamed from: o */
    public final /* synthetic */ void m54457o(Configuration configuration) {
    ...
    /* renamed from: p */
    public final /* synthetic */ void m54456p(Intent intent) {
        this.mFragments.noteStateNotSaved();
    }

    /* renamed from: q */
    public final /* synthetic */ void m54455q(Context context) {
