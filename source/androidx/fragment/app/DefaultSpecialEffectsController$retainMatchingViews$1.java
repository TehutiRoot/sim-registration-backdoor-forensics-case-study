...
@Metadata(m28851d1 = {"\u0000\u001a\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010'\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u00012\"\u0010\u0002\u001a\u001e\u0012\f\u0012\n \u0005*\u0004\u0018\u00010\u00040\u0004\u0012\f\u0012\n \u0005*\u0004\u0018\u00010\u00060\u00060\u0003H\n¢\u0006\u0004\b\u0007\u0010\b"}, m28850d2 = {"<anonymous>", "", "entry", "", "", "kotlin.jvm.PlatformType", "Landroid/view/View;", "invoke", "(Ljava/util/Map$Entry;)Ljava/lang/Boolean;"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
...
public final class DefaultSpecialEffectsController$retainMatchingViews$1 extends Lambda implements Function1<Map.Entry<String, View>, Boolean> {
    ...
    public final Boolean invoke(@NotNull Map.Entry<String, View> entry) {
        ...
        return Boolean.valueOf(CollectionsKt___CollectionsKt.contains(this.$names, ViewCompat.getTransitionName(entry.getValue())));
    }
}
