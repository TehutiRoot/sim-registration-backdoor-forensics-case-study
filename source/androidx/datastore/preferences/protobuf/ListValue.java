...
public final class ListValue extends GeneratedMessageLite<ListValue, Builder> implements ListValueOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<ListValue, Builder> implements ListValueOrBuilder {
        public /* synthetic */ Builder(C4384a c4384a) {
            this();
        }

        public Builder addAllValues(Iterable<? extends Value> iterable) {
            copyOnWrite();
            ((ListValue) this.instance).m55696A(iterable);
            return this;
        }

        public Builder addValues(Value value) {
            copyOnWrite();
            ((ListValue) this.instance).m55692E(value);
            return this;
        }

        public Builder clearValues() {
            copyOnWrite();
            ((ListValue) this.instance).m55691F();
            return this;
        }
        ...
        public Builder removeValues(int i) {
            copyOnWrite();
            ((ListValue) this.instance).m55689H(i);
            return this;
        }

        public Builder setValues(int i, Value value) {
            copyOnWrite();
            ((ListValue) this.instance).m55687J(i, value);
            return this;
        }
        ...
        public Builder addValues(int i, Value value) {
            copyOnWrite();
            ((ListValue) this.instance).m55694C(i, value);
            return this;
        }

        public Builder setValues(int i, Value.Builder builder) {
            copyOnWrite();
            ((ListValue) this.instance).m55688I(i, builder);
            return this;
        }

        public Builder addValues(Value.Builder builder) {
            copyOnWrite();
            ((ListValue) this.instance).m55693D(builder);
            return this;
        }

        public Builder addValues(int i, Value.Builder builder) {
            copyOnWrite();
            ((ListValue) this.instance).m55695B(i, builder);
            return this;
        }
    }
    ...
    public static /* synthetic */ class C4384a {
        ...
        static {
            ...
            try {
                f34842a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f34842a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f34842a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f34842a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f34842a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f34842a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: A */
    public final void m55696A(Iterable iterable) {
        m55690G();
        AbstractMessageLite.addAll(iterable, (List) this.values_);
    }

    /* renamed from: B */
    public final void m55695B(int i, Value.Builder builder) {
        m55690G();
        this.values_.add(i, builder.build());
    }

    /* renamed from: C */
    public final void m55694C(int i, Value value) {
        value.getClass();
        m55690G();
    ...
    /* renamed from: D */
    public final void m55693D(Value.Builder builder) {
        m55690G();
        this.values_.add(builder.build());
    }

    /* renamed from: E */
    public final void m55692E(Value value) {
        value.getClass();
        m55690G();
    ...
    /* renamed from: F */
    public final void m55691F() {
        this.values_ = GeneratedMessageLite.emptyProtobufList();
    }

    /* renamed from: G */
    public final void m55690G() {
    ...
    /* renamed from: H */
    public final void m55689H(int i) {
        m55690G();
        this.values_.remove(i);
    }

    /* renamed from: I */
    public final void m55688I(int i, Value.Builder builder) {
        m55690G();
        this.values_.set(i, builder.build());
    }

    /* renamed from: J */
    public final void m55687J(int i, Value value) {
        value.getClass();
        m55690G();
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C4384a.f34842a[methodToInvoke.ordinal()]) {
            case 1:
