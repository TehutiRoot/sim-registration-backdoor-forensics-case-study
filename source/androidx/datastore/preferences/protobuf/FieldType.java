...
public final class FieldType {
    ...
    public static /* synthetic */ class C4369a {
        ...
        static {
            ...
            try {
                f34797b[JavaType.MESSAGE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f34797b[JavaType.STRING.ordinal()] = 3;
            ...
            try {
                f34796a[Collection.VECTOR.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f34796a[Collection.SCALAR.ordinal()] = 3;
    ...
    static {
        ...
        for (FieldType fieldType52 : values) {
            VALUES[fieldType52.f34795id] = fieldType52;
        }
    }
    ...
    private FieldType(String str, int i, int i2, Collection collection, JavaType javaType) {
        ...
        int i4 = C4369a.f34796a[collection.ordinal()];
        boolean z = true;
        if (i4 != 1) {
            if (i4 != 2) {
        ...
        this.primitiveScalar = (collection != Collection.SCALAR || (i3 = C4369a.f34797b[javaType.ordinal()]) == 1 || i3 == 2 || i3 == 3) ? false : false;
    }
