...
public final class UInt32Value extends GeneratedMessageLite<UInt32Value, Builder> implements UInt32ValueOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<UInt32Value, Builder> implements UInt32ValueOrBuilder {
        public /* synthetic */ Builder(C4405a c4405a) {
            this();
        }

        public Builder clearValue() {
            copyOnWrite();
            ((UInt32Value) this.instance).m55472t();
            return this;
        }
        ...
        public Builder setValue(int i) {
            copyOnWrite();
            ((UInt32Value) this.instance).m55471u(i);
            return this;
        }
    ...
    /* loaded from: classes2.dex */
    public static /* synthetic */ class C4405a {
        ...
        static {
            ...
            try {
                f34888a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f34888a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f34888a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f34888a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f34888a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f34888a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: of */
    public static UInt32Value m55476of(int i) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: u */
    public void m55471u(int i) {
        this.value_ = i;
    }

    @Override // androidx.datastore.preferences.protobuf.GeneratedMessageLite
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C4405a.f34888a[methodToInvoke.ordinal()]) {
            case 1:
