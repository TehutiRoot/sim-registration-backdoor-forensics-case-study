...
public final class StringValue extends GeneratedMessageLite<StringValue, Builder> implements StringValueOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<StringValue, Builder> implements StringValueOrBuilder {
        public /* synthetic */ Builder(C4398a c4398a) {
            this();
        }

        public Builder clearValue() {
            copyOnWrite();
            ((StringValue) this.instance).m55566u();
            return this;
        }
        ...
        public Builder setValue(String str) {
            copyOnWrite();
            ((StringValue) this.instance).m55565v(str);
            return this;
        }

        public Builder setValueBytes(ByteString byteString) {
            copyOnWrite();
            ((StringValue) this.instance).m55564w(byteString);
            return this;
        }
    ...
    public static /* synthetic */ class C4398a {
        ...
        static {
            ...
            try {
                f34871a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f34871a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f34871a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f34871a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f34871a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f34871a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: of */
    public static StringValue m55571of(String str) {
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C4398a.f34871a[methodToInvoke.ordinal()]) {
            case 1:
    ...
    /* renamed from: v */
    public final void m55565v(String str) {
        str.getClass();
        this.value_ = str;
    }

    /* renamed from: w */
    public final void m55564w(ByteString byteString) {
        byteString.getClass();
