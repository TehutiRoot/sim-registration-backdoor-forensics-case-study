...
public final class SourceContext extends GeneratedMessageLite<SourceContext, Builder> implements SourceContextOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<SourceContext, Builder> implements SourceContextOrBuilder {
        public /* synthetic */ Builder(C4397a c4397a) {
            this();
        }

        public Builder clearFileName() {
            copyOnWrite();
            ((SourceContext) this.instance).m55574u();
            return this;
        }
        ...
        public Builder setFileName(String str) {
            copyOnWrite();
            ((SourceContext) this.instance).m55573v(str);
            return this;
        }

        public Builder setFileNameBytes(ByteString byteString) {
            copyOnWrite();
            ((SourceContext) this.instance).m55572w(byteString);
            return this;
        }
    ...
    /* renamed from: androidx.datastore.preferences.protobuf.SourceContext$a */
    /* loaded from: classes2.dex */
    public static /* synthetic */ class C4397a {
        ...
        static {
            ...
            try {
                f34870a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f34870a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f34870a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f34870a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f34870a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f34870a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C4397a.f34870a[methodToInvoke.ordinal()]) {
            case 1:
    ...
    /* renamed from: u */
    public final void m55574u() {
        this.fileName_ = getDefaultInstance().getFileName();
    }

    /* renamed from: v */
    public final void m55573v(String str) {
        str.getClass();
        this.fileName_ = str;
    }

    /* renamed from: w */
    public final void m55572w(ByteString byteString) {
        byteString.getClass();
