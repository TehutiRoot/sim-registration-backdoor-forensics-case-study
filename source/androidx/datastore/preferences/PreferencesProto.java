...
public final class PreferencesProto {
    ...
    public static final class PreferenceMap extends GeneratedMessageLite<PreferenceMap, Builder> implements PreferenceMapOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<PreferenceMap, Builder> implements PreferenceMapOrBuilder {
            public /* synthetic */ Builder(C4329a c4329a) {
                this();
            }

            public Builder clearPreferences() {
                copyOnWrite();
                ((PreferenceMap) this.instance).m56270s().clear();
                return this;
            }
            ...
            public Builder putAllPreferences(Map<String, Value> map) {
                copyOnWrite();
                ((PreferenceMap) this.instance).m56270s().putAll(map);
                return this;
            }
            ...
            public Builder putPreferences(String str, Value value) {
                ...
                value.getClass();
                copyOnWrite();
                ((PreferenceMap) this.instance).m56270s().put(str, value);
                return this;
            }
            ...
            public Builder removePreferences(String str) {
                str.getClass();
                copyOnWrite();
                ((PreferenceMap) this.instance).m56270s().remove(str);
                return this;
            }
        ...
        /* renamed from: androidx.datastore.preferences.PreferencesProto$PreferenceMap$a */
        /* loaded from: classes2.dex */
        public static final class C4328a {

            /* renamed from: a */
            public static final MapEntryLite f34649a = MapEntryLite.newDefaultInstance(WireFormat.FieldType.STRING, "", WireFormat.FieldType.MESSAGE, Value.getDefaultInstance());
        }
        ...
        public boolean containsPreferences(String str) {
            str.getClass();
            return m56268u().containsKey(str);
        }

        @Override // androidx.datastore.preferences.protobuf.GeneratedMessageLite
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C4329a.f34650a[methodToInvoke.ordinal()]) {
                case 1:
                    return new PreferenceMap();
                case 2:
                    return new Builder(null);
                case 3:
                    return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0001\u0001\u0000\u0000\u0001\u0001\u0001\u0001\u0000\u0000\u00012", new Object[]{"preferences_", C4328a.f34649a});
                case 4:
                    return DEFAULT_INSTANCE;
                case 5:
        ...
        @Override // androidx.datastore.preferences.PreferencesProto.PreferenceMapOrBuilder
        public Map<String, Value> getPreferencesMap() {
            return Collections.unmodifiableMap(m56268u());
        }

        @Override // androidx.datastore.preferences.PreferencesProto.PreferenceMapOrBuilder
        public Value getPreferencesOrDefault(String str, Value value) {
            str.getClass();
            MapFieldLite m56268u = m56268u();
            if (m56268u.containsKey(str)) {
                return (Value) m56268u.get(str);
            }
            return value;
        }
        ...
        /* renamed from: s */
        public final Map m56270s() {
            return m56269t();
        }

        /* renamed from: t */
        public final MapFieldLite m56269t() {
        ...
        /* renamed from: u */
        public final MapFieldLite m56268u() {
            return this.preferences_;
        }
    ...
    public static final class StringSet extends GeneratedMessageLite<StringSet, Builder> implements StringSetOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<StringSet, Builder> implements StringSetOrBuilder {
            ...
            public Builder addAllStrings(Iterable<String> iterable) {
                copyOnWrite();
                ((StringSet) this.instance).m56259w(iterable);
                return this;
            }

            public Builder addStrings(String str) {
                copyOnWrite();
                ((StringSet) this.instance).m56258x(str);
                return this;
            }

            public Builder addStringsBytes(ByteString byteString) {
                copyOnWrite();
                ((StringSet) this.instance).m56257y(byteString);
                return this;
            }

            public Builder clearStrings() {
                copyOnWrite();
                ((StringSet) this.instance).m56256z();
                return this;
            }
            ...
            public Builder setStrings(int i, String str) {
                copyOnWrite();
                ((StringSet) this.instance).m56266B(i, str);
                return this;
            }
        ...
        /* renamed from: B */
        public final void m56266B(int i, String str) {
            str.getClass();
            m56267A();
        ...
        /* renamed from: w */
        public final void m56259w(Iterable iterable) {
            m56267A();
            AbstractMessageLite.addAll(iterable, (List) this.strings_);
        }

        /* renamed from: x */
        public final void m56258x(String str) {
            str.getClass();
            m56267A();
        ...
        /* renamed from: y */
        public final void m56257y(ByteString byteString) {
            byteString.getClass();
            m56267A();
    ...
    public static final class Value extends GeneratedMessageLite<Value, Builder> implements ValueOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<Value, Builder> implements ValueOrBuilder {
            ...
            public Builder clearBoolean() {
                copyOnWrite();
                ((Value) this.instance).m56246J();
                return this;
            }

            public Builder clearDouble() {
                copyOnWrite();
                ((Value) this.instance).m56245K();
                return this;
            }

            public Builder clearFloat() {
                copyOnWrite();
                ((Value) this.instance).m56244L();
                return this;
            }

            public Builder clearInteger() {
                copyOnWrite();
                ((Value) this.instance).m56243M();
                return this;
            }

            public Builder clearLong() {
                copyOnWrite();
                ((Value) this.instance).m56242N();
                return this;
            }

            public Builder clearString() {
                copyOnWrite();
                ((Value) this.instance).m56241O();
                return this;
            }

            public Builder clearStringSet() {
                copyOnWrite();
                ((Value) this.instance).m56240P();
                return this;
            }

            public Builder clearValue() {
                copyOnWrite();
                ((Value) this.instance).m56239Q();
                return this;
            }
            ...
            public Builder mergeStringSet(StringSet stringSet) {
                copyOnWrite();
                ((Value) this.instance).m56238R(stringSet);
                return this;
            }

            public Builder setBoolean(boolean z) {
                copyOnWrite();
                ((Value) this.instance).m56237S(z);
                return this;
            }

            public Builder setDouble(double d) {
                copyOnWrite();
                ((Value) this.instance).m56236T(d);
                return this;
            }

            public Builder setFloat(float f) {
                copyOnWrite();
                ((Value) this.instance).m56235U(f);
                return this;
            }

            public Builder setInteger(int i) {
                copyOnWrite();
                ((Value) this.instance).m56234V(i);
                return this;
            }

            public Builder setLong(long j) {
                copyOnWrite();
                ((Value) this.instance).m56233W(j);
                return this;
            }

            public Builder setString(String str) {
                copyOnWrite();
                ((Value) this.instance).m56232X(str);
                return this;
            }

            public Builder setStringBytes(ByteString byteString) {
                copyOnWrite();
                ((Value) this.instance).m56231Y(byteString);
                return this;
            }

            public Builder setStringSet(StringSet stringSet) {
                copyOnWrite();
                ((Value) this.instance).m56229a0(stringSet);
                return this;
            }
            ...
            public Builder setStringSet(StringSet.Builder builder) {
                copyOnWrite();
                ((Value) this.instance).m56230Z(builder);
                return this;
            }
        }
        ...
        /* renamed from: Q */
        public final void m56239Q() {
            this.valueCase_ = 0;
            this.value_ = null;
        }

        /* renamed from: R */
        public final void m56238R(StringSet stringSet) {
            stringSet.getClass();
        ...
        /* renamed from: S */
        public final void m56237S(boolean z) {
            this.valueCase_ = 1;
            this.value_ = Boolean.valueOf(z);
        }

        /* renamed from: T */
        public final void m56236T(double d) {
            this.valueCase_ = 7;
            this.value_ = Double.valueOf(d);
        }

        /* renamed from: U */
        public final void m56235U(float f) {
            this.valueCase_ = 2;
            this.value_ = Float.valueOf(f);
        }

        /* renamed from: V */
        public final void m56234V(int i) {
            this.valueCase_ = 3;
            this.value_ = Integer.valueOf(i);
        }

        /* renamed from: W */
        public final void m56233W(long j) {
            this.valueCase_ = 4;
            this.value_ = Long.valueOf(j);
        }

        /* renamed from: X */
        public final void m56232X(String str) {
            str.getClass();
            this.valueCase_ = 5;
            this.value_ = str;
        }
        ...
        /* renamed from: Y */
        public final void m56231Y(ByteString byteString) {
            byteString.getClass();
            this.valueCase_ = 5;
        ...
        /* renamed from: Z */
        public final void m56230Z(StringSet.Builder builder) {
            this.value_ = builder.build();
            this.valueCase_ = 6;
        }

        /* renamed from: a0 */
        public final void m56229a0(StringSet stringSet) {
            stringSet.getClass();
            this.value_ = stringSet;
            this.valueCase_ = 6;
        }
    ...
    /* loaded from: classes2.dex */
    public static /* synthetic */ class C4329a {
        ...
        static {
            ...
            try {
                f34650a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f34650a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f34650a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f34650a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f34650a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f34650a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
