...
public final class SharedPreferencesMigration<T> implements DataMigration<T> {
    ...
    /* renamed from: e */
    public final Lazy f34637e;

    /* renamed from: f */
    public final Set f34638f;

    @Metadata(m28851d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@"}, m28850d2 = {"<anonymous>", "", "T", "it"}, m28849k = 3, m28848mv = {1, 5, 1}, m28846xi = 48)
    @DebugMetadata(m28801c = "androidx.datastore.migrations.SharedPreferencesMigration$1", m28800f = "SharedPreferencesMigration.kt", m28799i = {}, m28798l = {}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
    /* renamed from: androidx.datastore.migrations.SharedPreferencesMigration$1 */
    /* loaded from: classes2.dex */
    final class C43231 extends SuspendLambda implements Function2<Object, Continuation<? super Boolean>, Object> {
        int label;

        public C43231(Continuation<? super C43231> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C43231(continuation);
        }
        ...
        public final Object invoke(Object obj, @Nullable Continuation<? super Boolean> continuation) {
            return ((C43231) create(obj, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }

    @Metadata(m28851d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@"}, m28850d2 = {"<anonymous>", "", "T", "it"}, m28849k = 3, m28848mv = {1, 5, 1}, m28846xi = 48)
    @DebugMetadata(m28801c = "androidx.datastore.migrations.SharedPreferencesMigration$2", m28800f = "SharedPreferencesMigration.kt", m28799i = {}, m28798l = {}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
    /* renamed from: androidx.datastore.migrations.SharedPreferencesMigration$2 */
    /* loaded from: classes2.dex */
    public static final class C43242 extends SuspendLambda implements Function2<T, Continuation<? super Boolean>, Object> {
        int label;

        public C43242(Continuation<? super C43242> continuation) {
            super(2, continuation);
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C43242(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Continuation<? super Boolean> continuation) {
            return invoke2((C43242) obj, continuation);
        }
        ...
        public final Object invoke2(T t, @Nullable Continuation<? super Boolean> continuation) {
            return ((C43242) create(t, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }

    @Metadata(m28851d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@"}, m28850d2 = {"<anonymous>", "", "T", "it"}, m28849k = 3, m28848mv = {1, 5, 1}, m28846xi = 48)
    @DebugMetadata(m28801c = "androidx.datastore.migrations.SharedPreferencesMigration$3", m28800f = "SharedPreferencesMigration.kt", m28799i = {}, m28798l = {}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
    /* renamed from: androidx.datastore.migrations.SharedPreferencesMigration$3 */
    /* loaded from: classes2.dex */
    public static final class C43253 extends SuspendLambda implements Function2<T, Continuation<? super Boolean>, Object> {
        int label;

        public C43253(Continuation<? super C43253> continuation) {
            super(2, continuation);
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C43253(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Continuation<? super Boolean> continuation) {
            return invoke2((C43253) obj, continuation);
        }
        ...
        /* renamed from: invoke  reason: avoid collision after fix types in other method */
        public final Object invoke2(T t, @Nullable Continuation<? super Boolean> continuation) {
            return ((C43253) create(t, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }

    @Metadata(m28851d1 = {"\u0000\b\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002H\n"}, m28850d2 = {"<anonymous>", "Landroid/content/SharedPreferences;", "T"}, m28849k = 3, m28848mv = {1, 5, 1}, m28846xi = 48)
    /* renamed from: androidx.datastore.migrations.SharedPreferencesMigration$4 */
    /* loaded from: classes2.dex */
    public static final class C43264 extends Lambda implements Function0<SharedPreferences> {
        final /* synthetic */ Context $context;
        final /* synthetic */ String $sharedPreferencesName;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C43264(Context context, String str) {
            super(0);
    ...
    public static final class C4327a {
        ...
        /* renamed from: a */
        public static final C4327a f34639a = new C4327a();

        @JvmStatic
        @DoNotInline
        /* renamed from: a */
        public static final boolean m56274a(@NotNull Context context, @NotNull String name) {
    ...
    /* renamed from: a */
    public final void m56278a(Context context, String str) {
        if (Build.VERSION.SDK_INT >= 24) {
            if (!C4327a.m56274a(context, str)) {
                throw new IOException(Intrinsics.stringPlus("Unable to delete SharedPreferences: ", str));
            }
            return;
        }
        File m56275d = m56275d(context, str);
        File m56276c = m56276c(m56275d);
        m56275d.delete();
        m56276c.delete();
    }

    /* renamed from: b */
    public final SharedPreferences m56277b() {
        return (SharedPreferences) this.f34637e.getValue();
    }

    /* renamed from: c */
    public final File m56276c(File file) {
    ...
    public Object cleanUp(@NotNull Continuation<? super Unit> continuation) throws IOException {
        ...
        Context context;
        String str;
        SharedPreferences.Editor edit = m56277b().edit();
        Set<String> set = this.f34638f;
        if (set == null) {
            edit.clear();
        } else {
            for (String str2 : set) {
        ...
        if (edit.commit()) {
            if (m56277b().getAll().isEmpty() && (context = this.f34635c) != null && (str = this.f34636d) != null) {
                m56278a(context, str);
            }
            Set set2 = this.f34638f;
            if (set2 == null) {
                unit = null;
            } else {
                set2.clear();
            ...
            if (unit == AbstractC18812Yf0.getCOROUTINE_SUSPENDED()) {
                return unit;
            }
    ...
    /* renamed from: d */
    public final File m56275d(Context context, String str) {
    ...
    public Object migrate(T t, @NotNull Continuation<? super T> continuation) {
        return this.f34634b.invoke(new SharedPreferencesView(m56277b(), this.f34638f), t, continuation);
    }
    ...
    */
    public java.lang.Object shouldMigrate(T r5, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super java.lang.Boolean> r6) {
        ...
        L35:
            kotlin.ResultKt.throwOnFailure(r6)
            kotlin.jvm.functions.Function2 r6 = r4.f34633a
            r0.L$0 = r4
            r0.label = r3
        ...
        L46:
            ...
            return r5
        L54:
            java.util.Set r6 = r5.f34638f
            if (r6 != 0) goto L6e
            android.content.SharedPreferences r5 = r5.m56277b()
    ...
    public SharedPreferencesMigration(Function0 function0, Set set, Function2 function2, Function3 function3, Context context, String str) {
        this.f34633a = function2;
        this.f34634b = function3;
        this.f34635c = context;
        this.f34636d = str;
        this.f34637e = LazyKt__LazyJVMKt.lazy(function0);
        this.f34638f = set == SharedPreferencesMigrationKt.getMIGRATE_ALL_KEYS() ? null : CollectionsKt___CollectionsKt.toMutableSet(set);
    }
    ...
    public /* synthetic */ SharedPreferencesMigration(Function0 function0, Set set, Function2 function2, Function3 function3, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(function0, (i & 2) != 0 ? SharedPreferencesMigrationKt.getMIGRATE_ALL_KEYS() : set, (i & 4) != 0 ? new C43242(null) : function2, function3);
    }
    ...
    public /* synthetic */ SharedPreferencesMigration(Context context, String str, Set set, Function2 function2, Function3 function3, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, str, (i & 4) != 0 ? SharedPreferencesMigrationKt.getMIGRATE_ALL_KEYS() : set, (i & 8) != 0 ? new C43253(null) : function2, function3);
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    @JvmOverloads
    public SharedPreferencesMigration(@NotNull Context context, @NotNull String sharedPreferencesName, @NotNull Set<String> keysToMigrate, @NotNull Function2<? super T, ? super Continuation<? super Boolean>, ? extends Object> shouldRunMigration, @NotNull Function3<? super SharedPreferencesView, ? super T, ? super Continuation<? super T>, ? extends Object> migrate) {
        this(new C43264(context, sharedPreferencesName), keysToMigrate, shouldRunMigration, migrate, context, sharedPreferencesName);
        Intrinsics.checkNotNullParameter(context, "context");
        Intrinsics.checkNotNullParameter(sharedPreferencesName, "sharedPreferencesName");
        Intrinsics.checkNotNullParameter(keysToMigrate, "keysToMigrate");
        Intrinsics.checkNotNullParameter(shouldRunMigration, "shouldRunMigration");
