...
public final class ClickableElement extends ModifierNodeElement<C2788a> {
    ...
    /* renamed from: e */
    public final Role f12811e;

    /* renamed from: f */
    public final Function0 f12812f;
    ...
    /* renamed from: d */
    public C2788a create() {
        return new C2788a(this.f12808b, this.f12809c, this.f12810d, this.f12811e, this.f12812f, null);
    }

    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    /* renamed from: e */
    public void update(C2788a node) {
        Intrinsics.checkNotNullParameter(node, "node");
        node.m61528j(this.f12808b, this.f12809c, this.f12810d, this.f12811e, this.f12812f);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(this.f12808b, clickableElement.f12808b) && this.f12809c == clickableElement.f12809c && Intrinsics.areEqual(this.f12810d, clickableElement.f12810d) && Intrinsics.areEqual(this.f12811e, clickableElement.f12811e) && Intrinsics.areEqual(this.f12812f, clickableElement.f12812f)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int i;
        int hashCode = ((this.f12808b.hashCode() * 31) + AbstractC1705Xp.m65430a(this.f12809c)) * 31;
        ...
        Role role = this.f12811e;
        if (role != null) {
            i2 = Role.m73066hashCodeimpl(role.m73068unboximpl());
        }
        return ((i3 + i2) * 31) + this.f12812f.hashCode();
    }
    ...
    public ClickableElement(MutableInteractionSource interactionSource, boolean z, String str, Role role, Function0 onClick) {
        ...
        this.f12808b = interactionSource;
        this.f12809c = z;
        this.f12810d = str;
        this.f12811e = role;
        this.f12812f = onClick;
    }
}
