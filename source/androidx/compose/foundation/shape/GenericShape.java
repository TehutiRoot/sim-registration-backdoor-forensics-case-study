...
public final class GenericShape implements Shape {
    ...
    public Outline mo69357createOutlinePq9zytI(long j, @NotNull LayoutDirection layoutDirection, @NotNull Density density) {
        ...
        this.f13948a.invoke(Path, Size.m71559boximpl(j), layoutDirection);
        Path.close();
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (genericShape != null) {
            function3 = genericShape.f13948a;
        }
        return Intrinsics.areEqual(function3, this.f13948a);
    }
