...
public final class CutCornerShape extends CornerBasedShape {
    ...
    public Outline mo69700createOutlineLjSzlW0(long j, float f, float f2, float f3, float f4, @NotNull LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m71571getWidthimpl(j) - f, 0.0f);
        Path.lineTo(Size.m71571getWidthimpl(j), f);
        if (layoutDirection == layoutDirection2) {
            f6 = f3;
        } else {
            f6 = f4;
        }
        Path.lineTo(Size.m71571getWidthimpl(j), Size.m71568getHeightimpl(j) - f6);
        Path.lineTo(Size.m71571getWidthimpl(j) - f6, Size.m71568getHeightimpl(j));
        if (layoutDirection == layoutDirection2) {
            f3 = f4;
        }
        Path.lineTo(f3, Size.m71568getHeightimpl(j));
        Path.lineTo(0.0f, Size.m71568getHeightimpl(j) - f3);
        Path.close();
