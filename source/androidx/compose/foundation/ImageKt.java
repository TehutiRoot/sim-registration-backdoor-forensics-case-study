...
public final class ImageKt {
    ...
    public static final /* synthetic */ void Image(ImageBitmap bitmap, String str, Modifier modifier, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, Composer composer, int i, int i2) {
        ...
        m69363Image5hnEew(bitmap, str, companion, center, fit, f2, colorFilter2, FilterQuality.Companion.m71827getLowfv9h1I(), composer, (i & 112) | 8 | (i & 896) | (i & 7168) | (57344 & i) | (458752 & i) | (i & 3670016), 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m69363Image5hnEew(@NotNull ImageBitmap bitmap, @Nullable String str, @Nullable Modifier modifier, @Nullable Alignment alignment, @Nullable ContentScale contentScale, float f, @Nullable ColorFilter colorFilter, int i, @Nullable Composer composer, int i2, int i3) {
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = BitmapPainterKt.m72239BitmapPainterQZhYCtY$default(bitmap, 0L, 0L, i4, 6, null);
    ...
    public static final void Image(@NotNull Painter painter, @Nullable String str, @Nullable Modifier modifier, @Nullable Alignment alignment, @Nullable ContentScale contentScale, float f, @Nullable ColorFilter colorFilter, @Nullable Composer composer, int i, int i2) {
        ...
        ImageKt$Image$2 imageKt$Image$2 = ImageKt$Image$2.f12863a;
        ...
        Updater.m71400setimpl(m71393constructorimpl, imageKt$Image$2, companion3.getSetMeasurePolicy());
