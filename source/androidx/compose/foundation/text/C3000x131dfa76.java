...
public final class C3000x131dfa76 extends Lambda implements Function2<PointerInputChange, Offset, Unit> {
    final /* synthetic */ TextDragObserver $observer;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C3000x131dfa76(TextDragObserver textDragObserver) {
        super(2);
    ...
    public /* bridge */ /* synthetic */ Unit invoke(PointerInputChange pointerInputChange, Offset offset) {
        m69744invokeUv8p0NA(pointerInputChange, offset.m71512unboximpl());
        return Unit.INSTANCE;
    }

    /* renamed from: invoke-Uv8p0NA  reason: not valid java name */
    public final void m69744invokeUv8p0NA(@NotNull PointerInputChange pointerInputChange, long j) {
