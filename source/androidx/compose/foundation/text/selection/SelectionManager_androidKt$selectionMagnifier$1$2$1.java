...
public final class SelectionManager_androidKt$selectionMagnifier$1$2$1 extends Lambda implements Function1<Function0<? extends Offset>, Modifier> {
    ...
    /* loaded from: classes.dex */
    public static final class C30451 extends Lambda implements Function1<Density, Offset> {
        final /* synthetic */ Function0<Offset> $center;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C30451(Function0<Offset> function0) {
            super(1);
        ...
        public /* bridge */ /* synthetic */ Offset invoke(Density density) {
            return Offset.m71491boximpl(m69879invoketuRUvjQ(density));
        }

        /* renamed from: invoke-tuRUvjQ  reason: not valid java name */
        public final long m69879invoketuRUvjQ(@NotNull Density magnifier) {
    ...
    /* loaded from: classes.dex */
    public static final class C30462 extends Lambda implements Function1<DpSize, Unit> {
        final /* synthetic */ Density $density;
        final /* synthetic */ MutableState<IntSize> $magnifierSize$delegate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C30462(Density density, MutableState<IntSize> mutableState) {
            super(1);
        ...
        public /* bridge */ /* synthetic */ Unit invoke(DpSize dpSize) {
            m69880invokeEaSLcWc(dpSize.m73764unboximpl());
            return Unit.INSTANCE;
        }

        /* renamed from: invoke-EaSLcWc  reason: not valid java name */
        public final void m69880invokeEaSLcWc(long j) {
            MutableState<IntSize> mutableState = this.$magnifierSize$delegate;
            Density density = this.$density;
            SelectionManager_androidKt$selectionMagnifier$1.invoke$lambda$2(mutableState, IntSizeKt.IntSize(density.mo69432roundToPx0680j_4(DpSize.m73756getWidthD9Ej5fM(j)), density.mo69432roundToPx0680j_4(DpSize.m73754getHeightD9Ej5fM(j))));
        }
    }
    ...
    public final Modifier invoke2(@NotNull Function0<Offset> center) {
        ...
        return MagnifierKt.magnifier$default(Modifier.Companion, new C30451(center), null, 0.0f, MagnifierStyle.Companion.getTextDefault(), new C30462(this.$density, this.$magnifierSize$delegate), 6, null);
    }
}
