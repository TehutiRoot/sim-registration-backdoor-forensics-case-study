...
public final class SelectionContainerKt$SelectionContainer$5 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public SelectionContainerKt$SelectionContainer$5(Modifier modifier, Selection selection, Function1<? super Selection, Unit> function1, Function2<? super Composer, ? super Integer, Unit> function2, int i, int i2) {
        super(2);
