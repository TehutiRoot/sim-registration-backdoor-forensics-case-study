...
public interface Selectable {
    ...
    long mo69835getHandlePositiondBAh8RU(@NotNull Selection selection, boolean z);
    ...
    long mo69836getRangeOfLineContainingjx7JFs(int i);
    ...
    Pair<Selection, Boolean> mo69837updateSelectionqCDeeow(long j, long j2, @Nullable Offset offset, boolean z, @NotNull LayoutCoordinates layoutCoordinates, @NotNull SelectionAdjustment selectionAdjustment, @Nullable Selection selection);
}
