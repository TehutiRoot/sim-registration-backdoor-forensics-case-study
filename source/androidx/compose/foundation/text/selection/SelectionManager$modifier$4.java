...
public final class SelectionManager$modifier$4 extends Lambda implements Function1<KeyEvent, Boolean> {
    ...
    public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
        return m69873invokeZmokQxo(keyEvent.m72593unboximpl());
    }

    @NotNull
    /* renamed from: invoke-ZmokQxo  reason: not valid java name */
    public final Boolean m69873invokeZmokQxo(@NotNull android.view.KeyEvent it) {
        boolean z;
        Intrinsics.checkNotNullParameter(it, "it");
        if (SelectionManager_androidKt.m69877isCopyKeyEventZmokQxo(it)) {
