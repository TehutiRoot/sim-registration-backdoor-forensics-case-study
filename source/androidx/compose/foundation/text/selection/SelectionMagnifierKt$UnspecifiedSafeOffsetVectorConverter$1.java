...
public final class SelectionMagnifierKt$UnspecifiedSafeOffsetVectorConverter$1 extends Lambda implements Function1<Offset, AnimationVector2D> {
    ...
    public /* bridge */ /* synthetic */ AnimationVector2D invoke(Offset offset) {
        return m69852invokek4lQ0M(offset.m71512unboximpl());
    }

    @NotNull
    /* renamed from: invoke-k-4lQ0M  reason: not valid java name */
    public final AnimationVector2D m69852invokek4lQ0M(long j) {
        AnimationVector2D animationVector2D;
        if (!OffsetKt.m71521isSpecifiedk4lQ0M(j)) {
            animationVector2D = SelectionMagnifierKt.f14243a;
