...
public final class MultiWidgetSelectionDelegate implements Selectable {
    ...
    /* renamed from: b */
    public final Function0 f14221b;

    /* renamed from: c */
    public final Function0 f14222c;

    /* renamed from: d */
    public TextLayoutResult f14223d;
    ...
    public MultiWidgetSelectionDelegate(long j, @NotNull Function0<? extends LayoutCoordinates> coordinatesCallback, @NotNull Function0<TextLayoutResult> layoutResultCallback) {
        ...
        this.f14220a = j;
        this.f14221b = coordinatesCallback;
        this.f14222c = layoutResultCallback;
        this.f14224e = -1;
    }

    /* renamed from: a */
    public final synchronized int m61005a(TextLayoutResult textLayoutResult) {
        int lineCount;
        try {
            if (this.f14223d != textLayoutResult) {
                if (textLayoutResult.getDidOverflowHeight() && !textLayoutResult.getMultiParagraph().getDidExceedMaxLines()) {
                    lineCount = AbstractC11719c.coerceAtMost(textLayoutResult.getLineForVerticalPosition(IntSize.m73817getHeightimpl(textLayoutResult.m73190getSizeYbymL2g())), textLayoutResult.getLineCount() - 1);
                    while (textLayoutResult.getLineTop(lineCount) >= IntSize.m73817getHeightimpl(textLayoutResult.m73190getSizeYbymL2g())) {
                        lineCount--;
                    }
                    this.f14224e = textLayoutResult.getLineEnd(lineCount, true);
                    this.f14223d = textLayoutResult;
                }
    ...
    public Rect getBoundingBox(int i) {
        TextLayoutResult textLayoutResult = (TextLayoutResult) this.f14222c.invoke();
        ...
        return textLayoutResult.getBoundingBox(AbstractC11719c.coerceIn(i, 0, length - 1));
    }

    @Override // androidx.compose.foundation.text.selection.Selectable
    /* renamed from: getHandlePosition-dBAh8RU  reason: not valid java name */
    public long mo69835getHandlePositiondBAh8RU(@NotNull Selection selection, boolean z) {
        ...
        return TextSelectionDelegateKt.getSelectionHandleCoordinates(textLayoutResult, AbstractC11719c.coerceIn(end.getOffset(), 0, m61005a(textLayoutResult)), z, selection.getHandlesCrossed());
    }
    ...
    public int getLastVisibleOffset() {
        ...
        return m61005a(textLayoutResult);
    }

    @Override // androidx.compose.foundation.text.selection.Selectable
    @Nullable
    public LayoutCoordinates getLayoutCoordinates() {
        LayoutCoordinates layoutCoordinates = (LayoutCoordinates) this.f14221b.invoke();
    ...
    public long mo69836getRangeOfLineContainingjx7JFs(int i) {
        TextLayoutResult textLayoutResult = (TextLayoutResult) this.f14222c.invoke();
        if (textLayoutResult == null) {
            return TextRange.Companion.m73221getZerod9O1mEE();
        }
        int m61005a = m61005a(textLayoutResult);
        if (m61005a < 1) {
            return TextRange.Companion.m73221getZerod9O1mEE();
        }
        int lineForOffset = textLayoutResult.getLineForOffset(AbstractC11719c.coerceIn(i, 0, m61005a - 1));
    ...
    public Selection getSelectAllSelection() {
        ...
        return MultiWidgetSelectionDelegateKt.m69838access$getAssembledSelectionInfovJH6DeI(TextRangeKt.TextRange(0, textLayoutResult.getLayoutInput().getText().length()), false, getSelectableId(), textLayoutResult);
    }
    ...
    public Pair<Selection, Boolean> mo69837updateSelectionqCDeeow(long j, long j2, @Nullable Offset offset, boolean z, @NotNull LayoutCoordinates containerLayoutCoordinates, @NotNull SelectionAdjustment adjustment, @Nullable Selection selection) {
        Offset offset2;
        ...
        long mo72817localPositionOfR5De75A = containerLayoutCoordinates.mo72817localPositionOfR5De75A(layoutCoordinates, Offset.Companion.m71518getZeroF1C5BW0());
        long m71506minusMKHz9U = Offset.m71506minusMKHz9U(j, mo72817localPositionOfR5De75A);
        long m71506minusMKHz9U2 = Offset.m71506minusMKHz9U(j2, mo72817localPositionOfR5De75A);
        if (offset != null) {
            offset2 = Offset.m71491boximpl(Offset.m71506minusMKHz9U(offset.m71512unboximpl(), mo72817localPositionOfR5De75A));
        } else {
            offset2 = null;
        }
        return MultiWidgetSelectionDelegateKt.m69840getTextSelectionInfoyM0VcXU(textLayoutResult, m71506minusMKHz9U, m71506minusMKHz9U2, offset2, getSelectableId(), adjustment, selection, z);
    }
}
