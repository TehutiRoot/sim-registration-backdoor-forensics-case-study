...
public final class SelectionManager_androidKt$selectionMagnifier$1 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    /* loaded from: classes.dex */
    public static final class C30441 extends Lambda implements Function0<Offset> {
        final /* synthetic */ MutableState<IntSize> $magnifierSize$delegate;
        final /* synthetic */ SelectionManager $manager;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C30441(SelectionManager selectionManager, MutableState<IntSize> mutableState) {
            super(0);
        ...
        public /* bridge */ /* synthetic */ Offset invoke() {
            return Offset.m71491boximpl(m69878invokeF1C5BW0());
        }

        /* renamed from: invoke-F1C5BW0  reason: not valid java name */
        public final long m69878invokeF1C5BW0() {
            return SelectionManagerKt.m69875calculateSelectionMagnifierCenterAndroidO0kMr_c(this.$manager, SelectionManager_androidKt$selectionMagnifier$1.invoke$lambda$1(this.$magnifierSize$delegate));
        }
    }
    ...
    public final Modifier invoke(@NotNull Modifier composed, @Nullable Composer composer, int i) {
        ...
        C30441 c30441 = new C30441(this.$manager, mutableState);
        ...
        composer.endReplaceableGroup();
        Modifier animatedSelectionMagnifier = SelectionMagnifierKt.animatedSelectionMagnifier(composed, c30441, (Function1) rememberedValue2);
        if (ComposerKt.isTraceInProgress()) {
