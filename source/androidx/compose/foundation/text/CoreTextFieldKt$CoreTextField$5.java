...
public final class CoreTextFieldKt$CoreTextField$5 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    /* loaded from: classes.dex */
    public static final class C29801 extends Lambda implements Function2<Composer, Integer, Unit> {
        final /* synthetic */ BringIntoViewRequester $bringIntoViewRequester;
        final /* synthetic */ Modifier $cursorModifier;
        final /* synthetic */ Density $density;
        final /* synthetic */ Modifier $drawModifier;
        ...
        /* loaded from: classes.dex */
        public static final class C29811 extends Lambda implements Function2<Composer, Integer, Unit> {
            final /* synthetic */ Density $density;
            final /* synthetic */ TextFieldSelectionManager $manager;
            final /* synthetic */ int $maxLines;
            final /* synthetic */ OffsetMapping $offsetMapping;
            ...
            public C29811(TextFieldSelectionManager textFieldSelectionManager, TextFieldState textFieldState, boolean z, boolean z2, Function1<? super TextLayoutResult, Unit> function1, TextFieldValue textFieldValue, OffsetMapping offsetMapping, Density density, int i) {
                super(2);
            ...
            public final void invoke(@Nullable Composer composer, int i) {
                ...
                MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.foundation.text.CoreTextFieldKt.CoreTextField.5.1.1.2
                    ...
                    public /* synthetic */ int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i3) {
                        return AbstractC22344tr0.m1366a(this, intrinsicMeasureScope, list, i3);
                    }
                    ...
                    public MeasureResult mo69194measure3p2s80s(@NotNull MeasureScope measure, @NotNull List<? extends Measurable> measurables, long j) {
                        ...
                        try {
                            ...
                            Triple<Integer, Integer, TextLayoutResult> m69783layout_EkL_Y$foundation_release = TextFieldDelegate.Companion.m69783layout_EkL_Y$foundation_release(TextFieldState.this.getTextDelegate(), j, measure.getLayoutDirection(), textLayoutResult);
                            int intValue = m69783layout_EkL_Y$foundation_release.component1().intValue();
                            int intValue2 = m69783layout_EkL_Y$foundation_release.component2().intValue();
                            TextLayoutResult component3 = m69783layout_EkL_Y$foundation_release.component3();
                            if (!Intrinsics.areEqual(textLayoutResult, component3)) {
                                ...
                                CoreTextFieldKt.m61074c(TextFieldState.this, textFieldValue, offsetMapping);
                            }
                            ...
                            textFieldState3.m69799setMinHeightForSingleLineField0680j_4(density2.mo69435toDpu2uoSUM(i3));
                            return measure.layout(intValue, intValue2, AbstractC11687a.mapOf(TuplesKt.m28844to(AlignmentLineKt.getFirstBaseline(), Integer.valueOf(AbstractC21140mr0.roundToInt(component3.getFirstBaseline()))), TuplesKt.m28844to(AlignmentLineKt.getLastBaseline(), Integer.valueOf(AbstractC21140mr0.roundToInt(component3.getLastBaseline())))), CoreTextFieldKt$CoreTextField$5$1$1$2$measure$2.INSTANCE);
                        } catch (Throwable th2) {
                            createNonObservableSnapshot.dispose();
                            throw th2;
                        }
                    ...
                    public /* synthetic */ int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i3) {
                        return AbstractC22344tr0.m1364c(this, intrinsicMeasureScope, list, i3);
                    }

                    @Override // androidx.compose.p003ui.layout.MeasurePolicy
                    public /* synthetic */ int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i3) {
                        return AbstractC22344tr0.m1363d(this, intrinsicMeasureScope, list, i3);
                    }
                };
                ...
                CoreTextFieldKt.m61075b(textFieldSelectionManager, z, composer, 8);
        ...
        public final void invoke(@Nullable Composer composer, int i) {
            ...
            SimpleLayoutKt.SimpleLayout(BringIntoViewRequesterKt.bringIntoViewRequester(TextFieldSizeKt.textFieldMinSize(TextFieldScrollKt.textFieldScroll(HeightInLinesModifierKt.heightInLines(SizeKt.m69552heightInVpY3zN4$default(Modifier.Companion, this.$state.m69798getMinHeightForSingleLineFieldD9Ej5fM(), 0.0f, 2, null), this.$textStyle, this.$minLines, this.$maxLines), this.$scrollerPosition, this.$value, this.$visualTransformation, new CoreTextFieldKt$CoreTextField$5$1$coreTextFieldModifier$1(this.$state)).then(this.$cursorModifier).then(this.$drawModifier), this.$textStyle).then(this.$onPositionedModifier).then(this.$magnifierModifier), this.$bringIntoViewRequester), ComposableLambdaKt.composableLambda(composer, -363167407, true, new C29811(this.$manager, this.$state, this.$showHandleAndMagnifier, this.$readOnly, this.$onTextLayout, this.$value, this.$offsetMapping, this.$density, this.$maxLines)), composer, 48, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
