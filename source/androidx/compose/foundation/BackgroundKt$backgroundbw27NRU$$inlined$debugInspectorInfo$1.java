...
public final class BackgroundKt$backgroundbw27NRU$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.setValue(Color.m71725boximpl(this.$color$inlined));
        inspectorInfo.getProperties().set(TypedValues.Custom.S_COLOR, Color.m71725boximpl(this.$color$inlined));
