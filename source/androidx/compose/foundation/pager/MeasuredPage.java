...
public final class MeasuredPage implements PageInfo {
    ...
    /* renamed from: f */
    public final Alignment.Horizontal f13833f;

    /* renamed from: g */
    public final Alignment.Vertical f13834g;

    /* renamed from: h */
    public final LayoutDirection f13835h;
    ...
    /* renamed from: a */
    public final int m61127a(Placeable placeable) {
        if (this.f13837j) {
    ...
    /* renamed from: b */
    public final long m61126b(int i) {
        int[] iArr = this.f13839l;
        int i2 = i * 2;
    ...
    public final void place(@NotNull Placeable.PlacementScope scope) {
        ...
        if (this.f13841n != Integer.MIN_VALUE) {
            int size = this.f13830c.size();
            for (int i = 0; i < size; i++) {
                Placeable placeable = (Placeable) this.f13830c.get(i);
                long m61126b = m61126b(i);
                if (this.f13836i) {
                    if (this.f13837j) {
                        m73776getXimpl = IntOffset.m73776getXimpl(m61126b);
                    } else {
                        m73776getXimpl = (this.f13841n - IntOffset.m73776getXimpl(m61126b)) - m61127a(placeable);
                    }
                    if (this.f13837j) {
                        m73777getYimpl = (this.f13841n - IntOffset.m73777getYimpl(m61126b)) - m61127a(placeable);
                    } else {
                        m73777getYimpl = IntOffset.m73777getYimpl(m61126b);
                    }
                    m61126b = IntOffsetKt.IntOffset(m73776getXimpl, m73777getYimpl);
                }
                long j = this.f13831d;
                long IntOffset = IntOffsetKt.IntOffset(IntOffset.m73776getXimpl(m61126b) + IntOffset.m73776getXimpl(j), IntOffset.m73777getYimpl(m61126b) + IntOffset.m73777getYimpl(j));
                if (this.f13837j) {
                    Placeable.PlacementScope.m72853placeWithLayeraW9wM$default(scope, placeable, IntOffset, 0.0f, null, 6, null);
                } else {
                    Placeable.PlacementScope.m72852placeRelativeWithLayeraW9wM$default(scope, placeable, IntOffset, 0.0f, null, 6, null);
                }
            }
            return;
        }
    ...
    public final void position(int i, int i2, int i3) {
        ...
        for (int i5 = 0; i5 < size; i5++) {
            ...
            if (this.f13837j) {
                int[] iArr = this.f13839l;
                Alignment.Horizontal horizontal = this.f13833f;
                if (horizontal != null) {
                    iArr[i6] = horizontal.align(placeable.getWidth(), i2, this.f13835h);
                    this.f13839l[i6 + 1] = i;
                ...
                int[] iArr2 = this.f13839l;
                iArr2[i6] = i;
                int i7 = i6 + 1;
                Alignment.Vertical vertical = this.f13834g;
                if (vertical != null) {
    ...
    public MeasuredPage(int i, int i2, List placeables, long j, Object key, Orientation orientation, Alignment.Horizontal horizontal, Alignment.Vertical vertical, LayoutDirection layoutDirection, boolean z) {
        ...
        this.f13828a = i;
        this.f13829b = i2;
        this.f13830c = placeables;
        this.f13831d = j;
        this.f13832e = key;
        this.f13833f = horizontal;
        this.f13834g = vertical;
        this.f13835h = layoutDirection;
        this.f13836i = z;
        this.f13837j = orientation == Orientation.Vertical;
        int size = placeables.size();
        int i3 = 0;
        for (int i4 = 0; i4 < size; i4++) {
            Placeable placeable = (Placeable) placeables.get(i4);
            i3 = Math.max(i3, !this.f13837j ? placeable.getHeight() : placeable.getWidth());
        }
        this.f13838k = i3;
        this.f13839l = new int[this.f13830c.size() * 2];
        this.f13841n = Integer.MIN_VALUE;
    }
}
