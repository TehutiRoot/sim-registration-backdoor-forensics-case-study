...
public final class PagerMeasureKt {
    ...
    public static final List m61120a(LazyLayoutMeasureScope lazyLayoutMeasureScope, List list, List list2, List list3, int i, int i2, int i3, int i4, int i5, Orientation orientation, boolean z, Density density, int i6, int i7) {
        ...
        if (z2) {
            if (list2.isEmpty() && list3.isEmpty()) {
                ...
                Arrangement.HorizontalOrVertical m69481spacedBy0680j_4 = Arrangement.Absolute.INSTANCE.m69481spacedBy0680j_4(lazyLayoutMeasureScope.mo69435toDpu2uoSUM(i7));
                if (orientation == Orientation.Vertical) {
                    m69481spacedBy0680j_4.arrange(density, i9, iArr, iArr2);
                } else {
                    m69481spacedBy0680j_4.arrange(density, i9, iArr, LayoutDirection.Ltr, iArr2);
                }
                ...
                if ((step > 0 && first <= last) || (step < 0 && last <= first)) {
                    while (true) {
                        int i13 = iArr2[first];
                        MeasuredPage measuredPage = (MeasuredPage) list.get(m61119b(first, z, size));
                        if (z) {
    ...
    /* renamed from: b */
    public static final int m61119b(int i, boolean z, int i2) {
        return !z ? i : (i2 - i) - 1;
    }

    /* renamed from: c */
    public static final List m61118c(int i, int i2, int i3, List list, Function1 function1) {
    ...
    /* renamed from: d */
    public static final List m61117d(int i, int i2, List list, Function1 function1) {
    ...
    /* renamed from: e */
    public static final MeasuredPage m61116e(LazyLayoutMeasureScope lazyLayoutMeasureScope, int i, long j, PagerLazyLayoutItemProvider pagerLazyLayoutItemProvider, long j2, Orientation orientation, Alignment.Horizontal horizontal, Alignment.Vertical vertical, LayoutDirection layoutDirection, boolean z, int i2) {
        return new MeasuredPage(i, i2, lazyLayoutMeasureScope.mo69642measure0kLqBqw(i, j), j2, pagerLazyLayoutItemProvider.getKey(i), orientation, horizontal, vertical, layoutDirection, z, null);
    }

    @NotNull
    /* renamed from: measurePager-ntgEbfI  reason: not valid java name */
    public static final PagerMeasureResult m69681measurePagerntgEbfI(@NotNull LazyLayoutMeasureScope measurePager, int i, @NotNull PagerLazyLayoutItemProvider pagerItemProvider, int i2, int i3, int i4, int i5, int i6, int i7, float f, long j, @NotNull Orientation orientation, @Nullable Alignment.Vertical vertical, @Nullable Alignment.Horizontal horizontal, boolean z, long j2, int i8, int i9, @NotNull List<Integer> pinnedPages, @NotNull Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> layout) {
        int i10;
        int i11;
        int i12;
        ...
        if (i3 >= 0) {
            if (i4 >= 0) {
                int coerceAtLeast = AbstractC11719c.coerceAtLeast(i8 + i5, 0);
                if (i <= 0) {
                    return new PagerMeasureResult(CollectionsKt__CollectionsKt.emptyList(), 0, i8, i5, i4, orientation, -i3, i2 + i4, false, 0.0f, null, null, 0, false, layout.invoke(Integer.valueOf(Constraints.m73628getMinWidthimpl(j)), Integer.valueOf(Constraints.m73627getMinHeightimpl(j)), PagerMeasureKt$measurePager$2.INSTANCE));
                }
                Orientation orientation2 = Orientation.Vertical;
                long Constraints$default = ConstraintsKt.Constraints$default(0, orientation == orientation2 ? Constraints.m73626getMaxWidthimpl(j) : i8, 0, orientation != orientation2 ? Constraints.m73625getMaxHeightimpl(j) : i8, 5, null);
                int i29 = i6;
                if (i29 >= i) {
                    i29 = i - 1;
                    i10 = 0;
                ...
                while (i33 < 0 && i29 > 0) {
                    ...
                    MeasuredPage m61116e = m61116e(measurePager, i35, Constraints$default, pagerItemProvider, j2, orientation, horizontal, vertical, measurePager.getLayoutDirection(), z, i8);
                    arrayDeque5.add(0, m61116e);
                    i34 = Math.max(i34, m61116e.getCrossAxisSize());
                    i33 += i36;
                    i32 = i32;
                ...
                int i41 = i2;
                int i42 = i41 + i4;
                int coerceAtLeast2 = AbstractC11719c.coerceAtLeast(i42, 0);
                int i43 = -i40;
                ...
                while (true) {
                    if (i44 >= i46) {
                        ...
                        int i57 = i34;
                        int i58 = i39;
                        MeasuredPage m61116e2 = m61116e(measurePager, i44, Constraints$default, pagerItemProvider, j2, orientation, horizontal, vertical, measurePager.getLayoutDirection(), z, i8);
                        i50 += i51;
                        if (i50 > i58 || i53 == i54 - 1) {
                            int max = Math.max(i57, m61116e2.getCrossAxisSize());
                            arrayDeque3 = arrayDeque8;
                            arrayDeque3.add(m61116e2);
                            i28 = i52;
                            i57 = max;
                        } else {
                            i28 = i53 + 1;
                ...
                if (i17 < i41) {
                    ...
                    while (i64 < i61 && i62 > 0) {
                        ...
                        MeasuredPage m61116e3 = m61116e(measurePager, i65, Constraints$default, pagerItemProvider, j2, orientation, horizontal, vertical, measurePager.getLayoutDirection(), z, i8);
                        arrayDeque9.add(0, m61116e3);
                        i63 = Math.max(i63, m61116e3.getCrossAxisSize());
                        i64 += i15;
                        i61 = i3;
                        i19 = i19;
                ...
                float f2 = (AbstractC21140mr0.getSign(AbstractC21140mr0.roundToInt(f)) != AbstractC21140mr0.getSign(i23) || Math.abs(AbstractC21140mr0.roundToInt(f)) < Math.abs(i23)) ? f : i23;
                if (i24 >= 0) {
                    int i69 = -i24;
                    ...
                    int i72 = i22;
                    int i73 = i21;
                    List m61117d = m61117d(i25, i9, pinnedPages, new PagerMeasureKt$measurePager$extraPagesBefore$1(measurePager, Constraints$default, pagerItemProvider, j2, orientation, horizontal, vertical, z, i8));
                    int size3 = m61117d.size();
                    int i74 = i72;
                    for (int i75 = 0; i75 < size3; i75++) {
                        i74 = Math.max(i74, ((MeasuredPage) m61117d.get(i75)).getCrossAxisSize());
                    }
                    MeasuredPage measuredPage4 = measuredPage;
                    ArrayDeque arrayDeque10 = arrayDeque2;
                    List m61118c = m61118c(((MeasuredPage) arrayDeque2.last()).getIndex(), i16, i9, pinnedPages, new PagerMeasureKt$measurePager$extraPagesAfter$1(measurePager, Constraints$default, pagerItemProvider, j2, orientation, horizontal, vertical, z, i8));
                    int size4 = m61118c.size();
                    int i76 = i74;
                    for (int i77 = 0; i77 < size4; i77++) {
                        i76 = Math.max(i76, ((MeasuredPage) m61118c.get(i77)).getCrossAxisSize());
                    }
                    boolean z2 = Intrinsics.areEqual(measuredPage4, arrayDeque10.first()) && m61117d.isEmpty() && m61118c.isEmpty();
                    ...
                    int m73640constrainWidthK40F9xA = ConstraintsKt.m73640constrainWidthK40F9xA(j3, i27);
                    if (orientation == orientation3) {
                        i76 = i73;
                    }
                    int m73639constrainHeightK40F9xA = ConstraintsKt.m73639constrainHeightK40F9xA(j3, i76);
                    int i78 = i20;
                    List m61120a = m61120a(measurePager, arrayDeque10, m61117d, m61118c, m73640constrainWidthK40F9xA, m73639constrainHeightK40F9xA, i73, i2, i69, orientation, z, measurePager, i5, i8);
                    if (z2) {
                        arrayList = m61120a;
                    } else {
                        ArrayList arrayList2 = new ArrayList(m61120a.size());
                        int size5 = m61120a.size();
                        for (int i79 = 0; i79 < size5; i79++) {
                            Object obj2 = m61120a.get(i79);
                    ...
                    int i80 = orientation == Orientation.Vertical ? m73639constrainHeightK40F9xA : m73640constrainWidthK40F9xA;
                    ...
                    return new PagerMeasureResult(arrayList, i, i8, i5, i4, orientation, i31, i18, z, f2, measuredPage4, (MeasuredPage) obj, i26, i78 < i16 || i73 > i2, layout.invoke(Integer.valueOf(m73640constrainWidthK40F9xA), Integer.valueOf(m73639constrainHeightK40F9xA), new PagerMeasureKt$measurePager$6(m61120a)));
                }
                throw new IllegalArgumentException("Failed requirement.".toString());
            }
            throw new IllegalArgumentException("Failed requirement.".toString());
