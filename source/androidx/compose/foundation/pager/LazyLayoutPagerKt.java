...
public final class LazyLayoutPagerKt {
    ...
    */
    ...
    /* renamed from: b */
    public static final Function0 m61128b(PagerState pagerState, Function4 function4, Function1 function1, Function0 function0, Composer composer, int i) {
        ...
        if (z || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new PropertyReference0Impl(SnapshotStateKt.derivedStateOf(SnapshotStateKt.referentialEqualityPolicy(), new C2959xe24e2a4e(SnapshotStateKt.derivedStateOf(SnapshotStateKt.referentialEqualityPolicy(), new C2958xa1a4dd96(rememberUpdatedState, function1, function0)), pagerState))) { // from class: androidx.compose.foundation.pager.LazyLayoutPagerKt$rememberPagerItemProviderLambda$1$1
