...
public final class PagerScrollPosition {
    ...
    /* renamed from: a */
    public final MutableIntState f13872a;

    /* renamed from: b */
    public final MutableIntState f13873b;

    /* renamed from: c */
    public final MutableIntState f13874c;
    ...
    /* renamed from: f */
    public final LazyLayoutNearestRangeState f13877f;
    ...
    /* renamed from: a */
    public final void m61115a(int i) {
        this.f13874c.setIntValue(i);
    }

    /* renamed from: b */
    public final void m61114b(int i, int i2) {
        if (i >= 0.0f) {
            setFirstVisiblePage(i);
            this.f13877f.update(i);
            m61115a(i2);
            return;
        }
    ...
    public final int getCurrentPage() {
        return this.f13873b.getIntValue();
    }

    public final int getFirstVisiblePage() {
        return this.f13872a.getIntValue();
    }
    ...
    public final int getScrollOffset() {
        return this.f13874c.getIntValue();
    }
    ...
    public final void setCurrentPage(int i) {
        this.f13873b.setIntValue(i);
    }

    public final void setFirstVisiblePage(int i) {
        this.f13872a.setIntValue(i);
    }
    ...
    public final void updateFromMeasureResult(@NotNull PagerMeasureResult measureResult) {
        ...
        this.f13876e = obj;
        if (this.f13875d || measureResult.getPagesCount() > 0) {
            this.f13875d = true;
            ...
            if (firstVisiblePageOffset >= 0.0f) {
                ...
                m61114b(i, firstVisiblePageOffset);
    ...
    public PagerScrollPosition(int i, int i2) {
        this.f13872a = SnapshotIntStateKt.mutableIntStateOf(i);
        this.f13873b = SnapshotIntStateKt.mutableIntStateOf(i);
        this.f13874c = SnapshotIntStateKt.mutableIntStateOf(i2);
        this.f13877f = new LazyLayoutNearestRangeState(i, 30, 100);
    }
