...
public final class PagerLazyLayoutItemProvider implements LazyLayoutItemProvider {
    ...
    public PagerLazyLayoutItemProvider(@NotNull PagerState state, @NotNull LazyLayoutIntervalContent<PagerIntervalContent> intervalContent, @NotNull LazyLayoutKeyIndexMap keyIndexMap) {
        ...
        this.f13853a = state;
        this.f13854b = intervalContent;
        this.f13855c = keyIndexMap;
        this.f13856d = PagerScopeImpl.INSTANCE;
    }
    ...
    public void Item(int i, @NotNull Object key, @Nullable Composer composer, int i2) {
        ...
        LazyLayoutPinnableItemKt.LazyLayoutPinnableItem(key, i, this.f13853a.getPinnedPages$foundation_release(), ComposableLambdaKt.composableLambda(startRestartGroup, 1142237095, true, new PagerLazyLayoutItemProvider$Item$1(this, i)), startRestartGroup, ((i2 << 3) & 112) | 3592);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.areEqual(this.f13854b, ((PagerLazyLayoutItemProvider) obj).f13854b);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutItemProvider
    public /* synthetic */ Object getContentType(int i) {
        return AbstractC22145si0.m22558a(this, i);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutItemProvider
    public int getIndex(@NotNull Object key) {
        Intrinsics.checkNotNullParameter(key, "key");
        return this.f13855c.getIndex(key);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutItemProvider
    public int getItemCount() {
        return this.f13854b.getItemCount();
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutItemProvider
    @NotNull
    public Object getKey(int i) {
        Object key = this.f13855c.getKey(i);
        if (key == null) {
            return this.f13854b.getKey(i);
        }
        return key;
    }
