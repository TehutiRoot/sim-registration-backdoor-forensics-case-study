...
public final class LazyDslKt$LazyColumn$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public LazyDslKt$LazyColumn$1(Modifier modifier, LazyListState lazyListState, PaddingValues paddingValues, boolean z, Arrangement.Vertical vertical, Alignment.Horizontal horizontal, FlingBehavior flingBehavior, boolean z2, Function1<? super LazyListScope, Unit> function1, int i, int i2) {
        super(2);
