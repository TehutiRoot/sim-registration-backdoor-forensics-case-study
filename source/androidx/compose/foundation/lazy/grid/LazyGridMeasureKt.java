...
public final class LazyGridMeasureKt {
        ...
        if (z3) {
            if (list2.isEmpty() && list3.isEmpty()) {
                ...
                for (int i9 = 0; i9 < size2; i9++) {
                    iArr[i9] = ((LazyGridMeasuredLine) list.get(m61239b(i9, z2, size2))).getMainAxisSize();
                }
                ...
                if ((step > 0 && first <= last) || (step < 0 && last <= first)) {
                    while (true) {
                        int i11 = iArr2[first];
                        LazyGridMeasuredLine lazyGridMeasuredLine = (LazyGridMeasuredLine) list.get(m61239b(first, z2, size2));
                        if (z2) {
                            i11 = (i6 - i11) - lazyGridMeasuredLine.getMainAxisSize();
                        }
                        AbstractC10410hs.addAll(arrayList, lazyGridMeasuredLine.position(i11, i, i2));
                        if (first == last) {
                            break;
                        }
                        first += step;
            ...
            for (int i15 = 0; i15 < size4; i15++) {
                ...
                AbstractC10410hs.addAll(arrayList, lazyGridMeasuredLine2.position(i14, i, i2));
    ...
    /* renamed from: b */
    public static final int m61239b(int i, boolean z, int i2) {
        return !z ? i : (i2 - i) - 1;
    }
