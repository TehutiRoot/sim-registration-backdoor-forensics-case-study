...
public final class LazyGridDslKt$rememberRowHeightSums$1$1 extends Lambda implements Function2<Density, Constraints, LazyGridSlots> {
    ...
    public /* bridge */ /* synthetic */ LazyGridSlots invoke(Density density, Constraints constraints) {
        return m69620invoke0kLqBqw(density, constraints.m73632unboximpl());
    }

    @NotNull
    /* renamed from: invoke-0kLqBqw  reason: not valid java name */
    public final LazyGridSlots m69620invoke0kLqBqw(@NotNull Density $receiver, long j) {
        ...
        if (Constraints.m73625getMaxHeightimpl(j) != Integer.MAX_VALUE) {
            ...
            int[] intArray = CollectionsKt___CollectionsKt.toIntArray(gridCells.calculateCrossAxisCellSizes($receiver, m73625getMaxHeightimpl, $receiver.mo69432roundToPx0680j_4(vertical.mo69484getSpacingD9Ej5fM())));
            int[] iArr = new int[intArray.length];
            vertical.arrange($receiver, m73625getMaxHeightimpl, intArray, iArr);
