...
public final class LazyGridStateKt {
    ...
    public static final LazyGridState rememberLazyGridState(int i, int i2, @Nullable Composer composer, int i3, int i4) {
        ...
        LazyGridState lazyGridState = (LazyGridState) RememberSaveableKt.m71406rememberSaveable(objArr, saver, (String) null, (Function0<? extends Object>) rememberedValue, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
