...
public final class LazyGridScrollPosition {
    ...
    /* renamed from: a */
    public final MutableIntState f13551a;

    /* renamed from: b */
    public final MutableIntState f13552b;

    /* renamed from: c */
    public boolean f13553c;

    /* renamed from: d */
    public Object f13554d;

    /* renamed from: e */
    public final LazyLayoutNearestRangeState f13555e;
    ...
    /* renamed from: a */
    public final void m61234a(int i) {
        this.f13551a.setIntValue(i);
    }

    /* renamed from: b */
    public final void m61233b(int i) {
        this.f13552b.setIntValue(i);
    }

    /* renamed from: c */
    public final void m61232c(int i, int i2) {
        if (i >= 0.0f) {
            m61234a(i);
            this.f13555e.update(i);
            m61233b(i2);
            return;
        }
    ...
    public final int getIndex() {
        return this.f13551a.getIntValue();
    }
    ...
    public final int getScrollOffset() {
        return this.f13552b.getIntValue();
    }
    ...
    public final void updateFromMeasureResult(@NotNull LazyGridMeasureResult measureResult) {
        ...
        this.f13554d = obj;
        if (this.f13553c || measureResult.getTotalItemsCount() > 0) {
            this.f13553c = true;
            ...
            if (firstVisibleLineScrollOffset >= 0.0f) {
                ...
                m61232c(i, firstVisibleLineScrollOffset);
                return;
            }
    ...
    public final int updateScrollPositionIfTheFirstItemWasMoved(@NotNull LazyGridItemProvider itemProvider, int i) {
        ...
        int findIndexByKey = LazyLayoutItemProviderKt.findIndexByKey(itemProvider, this.f13554d, i);
        if (i != findIndexByKey) {
            m61234a(findIndexByKey);
            this.f13555e.update(i);
        }
    ...
    public LazyGridScrollPosition(int i, int i2) {
        this.f13551a = SnapshotIntStateKt.mutableIntStateOf(i);
        this.f13552b = SnapshotIntStateKt.mutableIntStateOf(i2);
        this.f13555e = new LazyLayoutNearestRangeState(i, 90, 200);
    }
