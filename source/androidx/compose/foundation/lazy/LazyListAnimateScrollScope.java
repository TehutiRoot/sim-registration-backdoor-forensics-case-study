...
public final class LazyListAnimateScrollScope implements LazyAnimateScrollScope {
    ...
    public float expectedDistanceTo(int i, int i2) {
        LazyListLayoutInfo layoutInfo = this.f13353a.getLayoutInfo();
    ...
    public Density getDensity() {
        return this.f13353a.getDensity$foundation_release();
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyAnimateScrollScope
    public int getFirstVisibleItemIndex() {
        return this.f13353a.getFirstVisibleItemIndex();
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyAnimateScrollScope
    public int getFirstVisibleItemScrollOffset() {
        return this.f13353a.getFirstVisibleItemScrollOffset();
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyAnimateScrollScope
    public int getItemCount() {
        return this.f13353a.getLayoutInfo().getTotalItemsCount();
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyAnimateScrollScope
    public int getLastVisibleItemIndex() {
        LazyListItemInfo lazyListItemInfo = (LazyListItemInfo) CollectionsKt___CollectionsKt.lastOrNull((List<? extends Object>) this.f13353a.getLayoutInfo().getVisibleItemsInfo());
    ...
    public Integer getTargetItemOffset(int i) {
        ...
        List<LazyListItemInfo> visibleItemsInfo = this.f13353a.getLayoutInfo().getVisibleItemsInfo();
        int size = visibleItemsInfo.size();
        int i2 = 0;
        while (true) {
            if (i2 < size) {
    ...
    public Object scroll(@NotNull Function2<? super ScrollScope, ? super Continuation<? super Unit>, ? extends Object> function2, @NotNull Continuation<? super Unit> continuation) {
        Object m67770e = JE1.m67770e(this.f13353a, null, function2, continuation, 1, null);
    ...
    public void snapToItem(@NotNull ScrollScope scrollScope, int i, int i2) {
        ...
        this.f13353a.snapToItemIndexInternal$foundation_release(i, i2);
    }
}
