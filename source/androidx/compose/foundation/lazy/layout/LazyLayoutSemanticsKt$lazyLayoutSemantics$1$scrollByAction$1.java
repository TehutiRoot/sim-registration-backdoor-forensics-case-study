...
public final class LazyLayoutSemanticsKt$lazyLayoutSemantics$1$scrollByAction$1 extends Lambda implements Function2<Float, Float, Boolean> {
    ...
    @DebugMetadata(m28801c = "androidx.compose.foundation.lazy.layout.LazyLayoutSemanticsKt$lazyLayoutSemantics$1$scrollByAction$1$1", m28800f = "LazyLayoutSemantics.kt", m28799i = {}, m28798l = {99}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
    /* renamed from: androidx.compose.foundation.lazy.layout.LazyLayoutSemanticsKt$lazyLayoutSemantics$1$scrollByAction$1$1 */
    /* loaded from: classes.dex */
    public static final class C29361 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ float $delta;
        final /* synthetic */ LazyLayoutSemanticState $state;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C29361(LazyLayoutSemanticState lazyLayoutSemanticState, float f, Continuation<? super C29361> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C29361(this.$state, this.$delta, continuation);
        }
        ...
        public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C29361) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public final Boolean invoke(float f, float f2) {
        ...
        AbstractC1552Vc.m65753e(this.$coroutineScope, null, null, new C29361(this.$state, f, null), 3, null);
        return Boolean.TRUE;
    }
}
