...
public final class LazyLayoutItemContentFactory {
    ...
    public final class CachedItemContent {
        ...
        /* renamed from: d */
        public Function2 f13637d;

        /* renamed from: e */
        public final /* synthetic */ LazyLayoutItemContentFactory f13638e;

        public CachedItemContent(LazyLayoutItemContentFactory lazyLayoutItemContentFactory, int i, Object key, Object obj) {
            Intrinsics.checkNotNullParameter(key, "key");
            this.f13638e = lazyLayoutItemContentFactory;
            this.f13634a = key;
            this.f13635b = obj;
            this.f13636c = i;
        }
        ...
        /* renamed from: c */
        public final Function2 m61207c() {
            return ComposableLambdaKt.composableLambdaInstance(1403994769, true, new C2929xbaaa624f(this.f13638e, this));
        }

        /* renamed from: d */
        public final Function2 m61206d() {
            Function2 function2 = this.f13637d;
            if (function2 == null) {
                Function2 m61207c = m61207c();
                this.f13637d = m61207c;
                return m61207c;
            }
            return function2;
        }
        ...
        /* renamed from: e */
        public final Object m61205e() {
            return this.f13635b;
        }

        /* renamed from: f */
        public final int m61204f() {
            return this.f13636c;
        }

        /* renamed from: g */
        public final Object m61203g() {
            return this.f13634a;
        }
    }
    ...
    public LazyLayoutItemContentFactory(@NotNull SaveableStateHolder saveableStateHolder, @NotNull Function0<? extends LazyLayoutItemProvider> itemProvider) {
        ...
        this.f13631a = saveableStateHolder;
        this.f13632b = itemProvider;
        this.f13633c = new LinkedHashMap();
    }

    @NotNull
    public final Function2<Composer, Integer, Unit> getContent(int i, @NotNull Object key, @Nullable Object obj) {
        Intrinsics.checkNotNullParameter(key, "key");
        CachedItemContent cachedItemContent = (CachedItemContent) this.f13633c.get(key);
        if (cachedItemContent != null && cachedItemContent.m61204f() == i && Intrinsics.areEqual(cachedItemContent.m61205e(), obj)) {
            return cachedItemContent.m61206d();
        }
        CachedItemContent cachedItemContent2 = new CachedItemContent(this, i, key, obj);
        this.f13633c.put(key, cachedItemContent2);
        return cachedItemContent2.m61206d();
    }
    ...
    public final Object getContentType(@Nullable Object obj) {
        ...
        CachedItemContent cachedItemContent = (CachedItemContent) this.f13633c.get(obj);
        if (cachedItemContent != null) {
            return cachedItemContent.m61205e();
        }
        LazyLayoutItemProvider lazyLayoutItemProvider = (LazyLayoutItemProvider) this.f13632b.invoke();
