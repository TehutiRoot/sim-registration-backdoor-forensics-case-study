...
public final class C2953x583b0d6 extends Lambda implements Function1<LazyStaggeredGridLaneInfo.C2951a, Integer> {
    final /* synthetic */ Comparable $key;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2953x583b0d6(Comparable comparable) {
        super(1);
        this.$key = comparable;
    }
