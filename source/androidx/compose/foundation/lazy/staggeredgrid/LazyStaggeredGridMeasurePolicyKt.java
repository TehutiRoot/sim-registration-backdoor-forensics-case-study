...
public final class LazyStaggeredGridMeasurePolicyKt {
    ...
    /* renamed from: a */
    public static final float m61148a(PaddingValues paddingValues, Orientation orientation, boolean z, LayoutDirection layoutDirection) {
        ...
        if (i != 1) {
            ...
            return paddingValues.mo69159calculateTopPaddingD9Ej5fM();
        } else {
            return paddingValues.mo69156calculateBottomPaddingD9Ej5fM();
        }
    }

    /* renamed from: b */
    public static final float m61147b(PaddingValues paddingValues, Orientation orientation, boolean z, LayoutDirection layoutDirection) {
        int i = WhenMappings.$EnumSwitchMapping$0[orientation.ordinal()];
        if (i != 1) {
            if (i == 2) {
                if (z) {
    ...
    /* renamed from: c */
    public static final float m61146c(PaddingValues paddingValues, Orientation orientation, LayoutDirection layoutDirection) {
        int i = WhenMappings.$EnumSwitchMapping$0[orientation.ordinal()];
        if (i != 1) {
            if (i == 2) {
                return paddingValues.mo69159calculateTopPaddingD9Ej5fM();
    ...
    */
    public static final kotlin.jvm.functions.Function2<androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.p003ui.unit.Constraints, androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasureResult> m69659rememberStaggeredGridMeasurePolicynbWgWpA(@org.jetbrains.annotations.NotNull androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridState r14, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function0<? extends androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridItemProvider> r15, @org.jetbrains.annotations.NotNull androidx.compose.foundation.layout.PaddingValues r16, boolean r17, @org.jetbrains.annotations.NotNull androidx.compose.foundation.gestures.Orientation r18, float r19, float r20, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function2<? super androidx.compose.p003ui.unit.Density, ? super androidx.compose.p003ui.unit.Constraints, androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridSlots> r21, @org.jetbrains.annotations.Nullable androidx.compose.runtime.Composer r22, int r23) {
        /*
            r4 = r14
            r3 = r15
            r5 = r16
        ...
        L3f:
            ...
            androidx.compose.ui.unit.Dp r10 = androidx.compose.p003ui.unit.C3641Dp.m73656boximpl(r19)
            androidx.compose.ui.unit.Dp r11 = androidx.compose.p003ui.unit.C3641Dp.m73656boximpl(r20)
