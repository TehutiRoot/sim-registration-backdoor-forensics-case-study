...
public final class BorderModifierNode extends DelegatingNode {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:25:0x00d8, code lost:
        if (androidx.compose.p003ui.graphics.ImageBitmapConfig.m71913equalsimpl(r14, r4) != false) goto L38;
     */
    ...
    */
    public final androidx.compose.p003ui.draw.DrawResult m61611c(androidx.compose.p003ui.draw.CacheDrawScope r46, androidx.compose.p003ui.graphics.Brush r47, androidx.compose.p003ui.graphics.Outline.Generic r48, boolean r49, float r50) {
        /*
            Method dump skipped, instructions count: 657
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.BorderModifierNode.m61611c(androidx.compose.ui.draw.CacheDrawScope, androidx.compose.ui.graphics.Brush, androidx.compose.ui.graphics.Outline$Generic, boolean, float):androidx.compose.ui.draw.DrawResult");
    }

    /* renamed from: d */
    public final DrawResult m61610d(CacheDrawScope cacheDrawScope, Brush brush, Outline.Rounded rounded, long j, long j2, boolean z, float f) {
        Path m61615b;
        if (RoundRectKt.isSimple(rounded.getRoundRect())) {
            return cacheDrawScope.onDrawWithContent(new BorderModifierNode$drawRoundRectBorder$1(z, brush, rounded.getRoundRect().m71552getTopLeftCornerRadiuskKHJgLs(), f / 2, f, j, j2, new Stroke(f, 0.0f, 0, 0, null, 30, null)));
        }
        if (this.f12798p == null) {
            this.f12798p = new C10160ec(null, null, null, null, 15, null);
        }
        C10160ec c10160ec = this.f12798p;
        Intrinsics.checkNotNull(c10160ec);
        m61615b = BorderKt.m61615b(c10160ec.m31520g(), rounded.getRoundRect(), f, z);
        return cacheDrawScope.onDrawWithContent(new BorderModifierNode$drawRoundRectBorder$2(m61615b, brush));
    }
    ...
    public final float m69330getWidthD9Ej5fM() {
        return this.f12799q;
    }

    public final void setBrush(@NotNull Brush value) {
        Intrinsics.checkNotNullParameter(value, "value");
        if (!Intrinsics.areEqual(this.f12800r, value)) {
            this.f12800r = value;
            this.f12802t.invalidateDrawCache();
        }
    }

    public final void setShape(@NotNull Shape value) {
        Intrinsics.checkNotNullParameter(value, "value");
        if (!Intrinsics.areEqual(this.f12801s, value)) {
            this.f12801s = value;
            this.f12802t.invalidateDrawCache();
        }
    }
    ...
    public final void m69331setWidth0680j_4(float f) {
        if (!C3641Dp.m73663equalsimpl0(this.f12799q, f)) {
            this.f12799q = f;
            this.f12802t.invalidateDrawCache();
        }
    }
    ...
    public BorderModifierNode(float f, Brush brushParameter, Shape shapeParameter) {
        ...
        this.f12799q = f;
        this.f12800r = brushParameter;
        this.f12801s = shapeParameter;
        this.f12802t = (CacheDrawModifierNode) delegate(DrawModifierKt.CacheDrawModifierNode(new BorderModifierNode$drawWithCacheModifierNode$1(this)));
    }
}
