...
public final class MagnifierKt$magnifier$4$4$1 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    ...
    /* renamed from: androidx.compose.foundation.MagnifierKt$magnifier$4$4$1$1 */
    /* loaded from: classes.dex */
    public static final class C27801 extends Lambda implements Function0<Offset> {
        final /* synthetic */ State<Offset> $sourceCenterInRoot$delegate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C27801(State<Offset> state) {
            super(0);
        ...
        public /* bridge */ /* synthetic */ Offset invoke() {
            return Offset.m71491boximpl(m69365invokeF1C5BW0());
        }

        /* renamed from: invoke-F1C5BW0  reason: not valid java name */
        public final long m69365invokeF1C5BW0() {
    ...
    public final void invoke2(@NotNull SemanticsPropertyReceiver semantics) {
        ...
        semantics.set(MagnifierKt.getMagnifierPositionInRoot(), new C27801(this.$sourceCenterInRoot$delegate));
    }
}
