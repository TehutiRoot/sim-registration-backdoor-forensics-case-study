...
public final class TransformableStateKt {
    ...
    public static final Object m69455animatePanByubNVwUQ(@NotNull TransformableState transformableState, long j, @NotNull AnimationSpec<Offset> animationSpec, @NotNull Continuation<? super Unit> continuation) {
        Ref.LongRef longRef = new Ref.LongRef();
        longRef.element = Offset.Companion.m71518getZeroF1C5BW0();
        Object m65492a = XU1.m65492a(transformableState, null, new TransformableStateKt$animatePanBy$2(longRef, j, animationSpec, null), continuation, 1, null);
        if (m65492a == AbstractC18812Yf0.getCOROUTINE_SUSPENDED()) {
            return m65492a;
        }
    ...
    public static /* synthetic */ Object m69456animatePanByubNVwUQ$default(TransformableState transformableState, long j, AnimationSpec animationSpec, Continuation continuation, int i, Object obj) {
        if ((i & 2) != 0) {
            animationSpec = new SpringSpec(0.0f, 200.0f, null, 5, null);
        }
        return m69455animatePanByubNVwUQ(transformableState, j, animationSpec, continuation);
    }
    ...
    public static final Object animateRotateBy(@NotNull TransformableState transformableState, float f, @NotNull AnimationSpec<Float> animationSpec, @NotNull Continuation<? super Unit> continuation) {
        Object m65492a = XU1.m65492a(transformableState, null, new TransformableStateKt$animateRotateBy$2(new Ref.FloatRef(), f, animationSpec, null), continuation, 1, null);
        if (m65492a == AbstractC18812Yf0.getCOROUTINE_SUSPENDED()) {
            return m65492a;
        }
        return Unit.INSTANCE;
    ...
    public static final Object animateZoomBy(@NotNull TransformableState transformableState, float f, @NotNull AnimationSpec<Float> animationSpec, @NotNull Continuation<? super Unit> continuation) {
        if (f > 0.0f) {
            ...
            Object m65492a = XU1.m65492a(transformableState, null, new TransformableStateKt$animateZoomBy$3(floatRef, f, animationSpec, null), continuation, 1, null);
            if (m65492a == AbstractC18812Yf0.getCOROUTINE_SUSPENDED()) {
                return m65492a;
            }
            return Unit.INSTANCE;
    ...
    public static final Object m69457panByd4ec7I(@NotNull TransformableState transformableState, long j, @NotNull Continuation<? super Unit> continuation) {
        Object m65492a = XU1.m65492a(transformableState, null, new TransformableStateKt$panBy$2(j, null), continuation, 1, null);
        if (m65492a == AbstractC18812Yf0.getCOROUTINE_SUSPENDED()) {
            return m65492a;
        }
        return Unit.INSTANCE;
    ...
    public static final Object rotateBy(@NotNull TransformableState transformableState, float f, @NotNull Continuation<? super Unit> continuation) {
        Object m65492a = XU1.m65492a(transformableState, null, new TransformableStateKt$rotateBy$2(f, null), continuation, 1, null);
        if (m65492a == AbstractC18812Yf0.getCOROUTINE_SUSPENDED()) {
            return m65492a;
        }
        return Unit.INSTANCE;
    ...
    public static final Object stopTransformation(@NotNull TransformableState transformableState, @NotNull MutatePriority mutatePriority, @NotNull Continuation<? super Unit> continuation) {
        ...
        if (transform == AbstractC18812Yf0.getCOROUTINE_SUSPENDED()) {
            return transform;
        }
        return Unit.INSTANCE;
    }
    ...
    public static final Object zoomBy(@NotNull TransformableState transformableState, float f, @NotNull Continuation<? super Unit> continuation) {
        Object m65492a = XU1.m65492a(transformableState, null, new TransformableStateKt$zoomBy$2(f, null), continuation, 1, null);
        if (m65492a == AbstractC18812Yf0.getCOROUTINE_SUSPENDED()) {
            return m65492a;
        }
        return Unit.INSTANCE;
