...
@Metadata(m28851d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0007\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0004\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001*\u00020\u0000H\u008a@¢\u0006\u0004\b\u0004\u0010\u0005"}, m28850d2 = {"Lkotlinx/coroutines/CoroutineScope;", "LL4;", "", "Landroidx/compose/animation/core/AnimationVector1D;", "<anonymous>", "(Lkotlinx/coroutines/CoroutineScope;)LL4;"}, m28849k = 3, m28848mv = {1, 8, 0})
@DebugMetadata(m28801c = "androidx.compose.foundation.gestures.snapping.SnapFlingBehavior$fling$result$1", m28800f = "SnapFlingBehavior.kt", m28799i = {}, m28798l = {133, 135}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
/* loaded from: classes.dex */
public final class SnapFlingBehavior$fling$result$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super C0781L4>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (abs <= Math.abs(f)) {
            ...
            this.label = 1;
            obj = snapFlingBehavior.m61446e(scrollScope, f2, function1, this);
        ...
        this.label = 2;
        obj = snapFlingBehavior2.m61448c(scrollScope2, f3, function12, this);
        if (obj == coroutine_suspended) {
            return coroutine_suspended;
        }
        return (C0781L4) obj;
    ...
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super C0781L4> continuation) {
