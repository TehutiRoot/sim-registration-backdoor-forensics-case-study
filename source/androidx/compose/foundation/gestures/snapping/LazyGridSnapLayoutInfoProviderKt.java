...
public final class LazyGridSnapLayoutInfoProviderKt {
    ...
    public static final SnapLayoutInfoProvider SnapLayoutInfoProvider(@NotNull final LazyGridState lazyGridState, @NotNull final SnapPositionInLayout positionInLayout) {
        ...
        return new SnapLayoutInfoProvider() { // from class: androidx.compose.foundation.gestures.snapping.LazyGridSnapLayoutInfoProviderKt$SnapLayoutInfoProvider$1
            /* renamed from: a */
            public final LazyGridLayoutInfo m61453a() {
                return LazyGridState.this.getLayoutInfo();
            }

            /* renamed from: b */
            public final List m61452b() {
            ...
            public float calculateApproachOffset(@NotNull Density density, float f) {
                ...
                float coerceAtLeast = AbstractC11719c.coerceAtLeast(Math.abs(DecayAnimationSpecKt.calculateTargetValue(SplineBasedDecayKt.splineBasedDecay(density), 0.0f, f)) - calculateSnapStepSize(density), 0.0f);
            ...
            public float calculateSnapStepSize(@NotNull Density density) {
                ...
                if (!m61452b().isEmpty()) {
                    int i2 = 0;
                    if (m61453a().getOrientation() == Orientation.Vertical) {
                        List m61452b = m61452b();
                        int size = m61452b.size();
                        i = 0;
                        while (i2 < size) {
                            i += IntSize.m73817getHeightimpl(((LazyGridItemInfo) m61452b.get(i2)).mo69624getSizeYbymL2g());
                            i2++;
                        }
                    } else {
                        List m61452b2 = m61452b();
                        int size2 = m61452b2.size();
                        i = 0;
                        while (i2 < size2) {
                            i += IntSize.m73818getWidthimpl(((LazyGridItemInfo) m61452b2.get(i2)).mo69624getSizeYbymL2g());
                            i2++;
                        }
                    }
                    return i / m61452b().size();
                }
                return 0.0f;
            }
            ...
            public float calculateSnappingOffset(@NotNull Density density, float f) {
                Intrinsics.checkNotNullParameter(density, "<this>");
                List<LazyGridItemInfo> visibleItemsInfo = m61453a().getVisibleItemsInfo();
                ...
                for (int i = 0; i < size; i++) {
                    LazyGridItemInfo lazyGridItemInfo = visibleItemsInfo.get(i);
                    float calculateDistanceToDesiredSnapPosition = SnapPositionInLayoutKt.calculateDistanceToDesiredSnapPosition(density, LazyGridSnapLayoutInfoProviderKt.getSingleAxisViewportSize(m61453a()), m61453a().getBeforeContentPadding(), m61453a().getAfterContentPadding(), LazyGridSnapLayoutInfoProviderKt.sizeOnMainAxis(lazyGridItemInfo, m61453a().getOrientation()), LazyGridSnapLayoutInfoProviderKt.offsetOnMainAxis(lazyGridItemInfo, m61453a().getOrientation()), lazyGridItemInfo.getIndex(), snapPositionInLayout);
    ...
    public static final int getSingleAxisViewportSize(@NotNull LazyGridLayoutInfo lazyGridLayoutInfo) {
        ...
        if (lazyGridLayoutInfo.getOrientation() == Orientation.Vertical) {
            return IntSize.m73817getHeightimpl(lazyGridLayoutInfo.mo69626getViewportSizeYbymL2g());
        }
        return IntSize.m73818getWidthimpl(lazyGridLayoutInfo.mo69626getViewportSizeYbymL2g());
    }
    ...
    public static final int offsetOnMainAxis(@NotNull LazyGridItemInfo lazyGridItemInfo, @NotNull Orientation orientation) {
        ...
        if (orientation == Orientation.Vertical) {
            return IntOffset.m73777getYimpl(lazyGridItemInfo.mo69623getOffsetnOccac());
        }
        return IntOffset.m73776getXimpl(lazyGridItemInfo.mo69623getOffsetnOccac());
    }
    ...
    public static final int sizeOnMainAxis(@NotNull LazyGridItemInfo lazyGridItemInfo, @NotNull Orientation orientation) {
        ...
        Intrinsics.checkNotNullParameter(orientation, "orientation");
        if (orientation == Orientation.Vertical) {
            return IntSize.m73817getHeightimpl(lazyGridItemInfo.mo69624getSizeYbymL2g());
        }
        return IntSize.m73818getWidthimpl(lazyGridItemInfo.mo69624getSizeYbymL2g());
    }
}
