...
public final class DraggableElement extends ModifierNodeElement<DraggableNode> {
    ...
    public DraggableElement(@NotNull DraggableState state, @NotNull Function1<? super PointerInputChange, Boolean> canDrag, @NotNull Orientation orientation, boolean z, @Nullable MutableInteractionSource mutableInteractionSource, @NotNull Function0<Boolean> startDragImmediately, @NotNull Function3<? super CoroutineScope, ? super Offset, ? super Continuation<? super Unit>, ? extends Object> onDragStarted, @NotNull Function3<? super CoroutineScope, ? super Velocity, ? super Continuation<? super Unit>, ? extends Object> onDragStopped, boolean z2) {
        ...
        this.f12970b = state;
        this.f12971c = canDrag;
        this.f12972d = orientation;
        this.f12973e = z;
        this.f12974f = mutableInteractionSource;
        this.f12975g = startDragImmediately;
        this.f12976h = onDragStarted;
        this.f12977i = onDragStopped;
        this.f12978j = z2;
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (Intrinsics.areEqual(this.f12970b, draggableElement.f12970b) && Intrinsics.areEqual(this.f12971c, draggableElement.f12971c) && this.f12972d == draggableElement.f12972d && this.f12973e == draggableElement.f12973e && Intrinsics.areEqual(this.f12974f, draggableElement.f12974f) && Intrinsics.areEqual(this.f12975g, draggableElement.f12975g) && Intrinsics.areEqual(this.f12976h, draggableElement.f12976h) && Intrinsics.areEqual(this.f12977i, draggableElement.f12977i) && this.f12978j == draggableElement.f12978j) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int i;
        int hashCode = ((((((this.f12970b.hashCode() * 31) + this.f12971c.hashCode()) * 31) + this.f12972d.hashCode()) * 31) + AbstractC1705Xp.m65430a(this.f12973e)) * 31;
        MutableInteractionSource mutableInteractionSource = this.f12974f;
        if (mutableInteractionSource != null) {
            i = mutableInteractionSource.hashCode();
        } else {
            i = 0;
        }
        return ((((((((hashCode + i) * 31) + this.f12975g.hashCode()) * 31) + this.f12976h.hashCode()) * 31) + this.f12977i.hashCode()) * 31) + AbstractC1705Xp.m65430a(this.f12978j);
    }
    ...
    public void inspectableProperties(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("canDrag", this.f12971c);
        inspectorInfo.getProperties().set("orientation", this.f12972d);
        inspectorInfo.getProperties().set("enabled", Boolean.valueOf(this.f12973e));
        inspectorInfo.getProperties().set("reverseDirection", Boolean.valueOf(this.f12978j));
        inspectorInfo.getProperties().set("interactionSource", this.f12974f);
        inspectorInfo.getProperties().set("startDragImmediately", this.f12975g);
        inspectorInfo.getProperties().set("onDragStarted", this.f12976h);
        inspectorInfo.getProperties().set("onDragStopped", this.f12977i);
        inspectorInfo.getProperties().set(RemoteConfigConstants.ResponseFieldKey.STATE, this.f12970b);
    }
    ...
    public DraggableNode create() {
        return new DraggableNode(this.f12970b, this.f12971c, this.f12972d, this.f12973e, this.f12974f, this.f12975g, this.f12976h, this.f12977i, this.f12978j);
    }

    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    public void update(@NotNull DraggableNode node) {
        Intrinsics.checkNotNullParameter(node, "node");
        node.update(this.f12970b, this.f12971c, this.f12972d, this.f12973e, this.f12974f, this.f12975g, this.f12976h, this.f12977i, this.f12978j);
    }
}
