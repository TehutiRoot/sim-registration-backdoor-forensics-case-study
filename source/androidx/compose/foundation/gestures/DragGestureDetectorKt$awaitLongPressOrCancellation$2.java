...
@DebugMetadata(m28801c = "androidx.compose.foundation.gestures.DragGestureDetectorKt$awaitLongPressOrCancellation$2", m28800f = "DragGestureDetector.kt", m28799i = {0, 0, 1, 1, 1}, m28798l = {811, 828}, m28797m = "invokeSuspend", m28796n = {"$this$withTimeout", "finished", "$this$withTimeout", "event", "finished"}, m28795s = {"L$0", "I$0", "L$0", "L$1", "I$0"})
