...
@DebugMetadata(m28801c = "androidx.compose.foundation.gestures.DefaultFlingBehavior$performFling$2", m28800f = "Scrollable.kt", m28799i = {0}, m28798l = {TypedValues.MotionType.TYPE_EASING}, m28797m = "invokeSuspend", m28796n = {"velocityLeft"}, m28795s = {"L$0"})
...
public final class DefaultFlingBehavior$performFling$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Float>, Object> {
    ...
    /* loaded from: classes.dex */
    public static final class C27931 extends Lambda implements Function1<AnimationScope<Float, AnimationVector1D>, Unit> {
        ...
        public C27931(Ref.FloatRef floatRef, ScrollScope scrollScope, Ref.FloatRef floatRef2, DefaultFlingBehavior defaultFlingBehavior) {
            super(1);
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i != 0) {
            ...
            if (Math.abs(this.$initialVelocity) > 1.0f) {
                ...
                decayAnimationSpec = this.this$0.f12949a;
                C27931 c27931 = new C27931(floatRef3, this.$this_performFling, floatRef2, this.this$0);
                this.L$0 = floatRef2;
                this.label = 1;
                if (SuspendAnimationKt.animateDecay$default(AnimationState$default, decayAnimationSpec, false, c27931, this, 2, null) == coroutine_suspended) {
