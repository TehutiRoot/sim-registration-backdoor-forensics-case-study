...
@DebugMetadata(m28801c = "androidx.compose.foundation.gestures.ScrollableKt$pointerScrollable$3$1", m28800f = "Scrollable.kt", m28799i = {}, m28798l = {}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
...
public final class ScrollableKt$pointerScrollable$3$1 extends SuspendLambda implements Function3<CoroutineScope, Velocity, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(m28801c = "androidx.compose.foundation.gestures.ScrollableKt$pointerScrollable$3$1$1", m28800f = "Scrollable.kt", m28799i = {}, m28798l = {286}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
    /* renamed from: androidx.compose.foundation.gestures.ScrollableKt$pointerScrollable$3$1$1 */
    /* loaded from: classes.dex */
    public static final class C28061 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ State<ScrollingLogic> $scrollLogic;
        final /* synthetic */ long $velocity;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C28061(State<ScrollingLogic> state, long j, Continuation<? super C28061> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C28061(this.$scrollLogic, this.$velocity, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i != 0) {
                ...
                this.label = 1;
                if (this.$scrollLogic.getValue().m61472g(j, this) == coroutine_suspended) {
        ...
        public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C28061) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public /* bridge */ /* synthetic */ Object invoke(CoroutineScope coroutineScope, Velocity velocity, Continuation<? super Unit> continuation) {
        return m69444invokeLuvzFrg(coroutineScope, velocity.m73892unboximpl(), continuation);
    }

    @Nullable
    /* renamed from: invoke-LuvzFrg  reason: not valid java name */
    public final Object m69444invokeLuvzFrg(@NotNull CoroutineScope coroutineScope, long j, @Nullable Continuation<? super Unit> continuation) {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ResultKt.throwOnFailure(obj);
            AbstractC1552Vc.m65753e(this.$nestedScrollDispatcher.getValue().getCoroutineScope(), null, null, new C28061(this.$scrollLogic, this.J$0, null), 3, null);
            return Unit.INSTANCE;
        }
        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
    }
