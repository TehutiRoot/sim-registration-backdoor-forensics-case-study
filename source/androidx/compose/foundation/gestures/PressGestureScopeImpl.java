...
public final class PressGestureScopeImpl implements PressGestureScope, Density {
    ...
    /* renamed from: a */
    public final /* synthetic */ Density f12999a;
    ...
    /* renamed from: d */
    public final Mutex f13002d;

    public PressGestureScopeImpl(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        this.f12999a = density;
        this.f13002d = MutexKt.Mutex(false);
    }

    /* renamed from: a */
    public final void m61485a() {
        this.f13001c = true;
        Mutex.DefaultImpls.unlock$default(this.f13002d, null, 1, null);
    }
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.Object m61483c(kotlin.coroutines.Continuation r5) {
        /*
            r4 = this;
        ...
        L35:
            kotlin.ResultKt.throwOnFailure(r5)
            kotlinx.coroutines.sync.Mutex r5 = r4.f13002d
            r0.L$0 = r4
            r0.label = r3
            r2 = 0
        ...
        L47:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.PressGestureScopeImpl.m61483c(kotlin.coroutines.Continuation):java.lang.Object");
    }

    @Override // androidx.compose.p003ui.unit.Density
    public float getDensity() {
        return this.f12999a.getDensity();
    }

    @Override // androidx.compose.p003ui.unit.Density
    public float getFontScale() {
        return this.f12999a.getFontScale();
    }

    @Override // androidx.compose.p003ui.unit.Density
    /* renamed from: roundToPx--R2X_6o  reason: not valid java name */
    public int mo69431roundToPxR2X_6o(long j) {
        return this.f12999a.mo69431roundToPxR2X_6o(j);
    }

    @Override // androidx.compose.p003ui.unit.Density
    /* renamed from: roundToPx-0680j_4  reason: not valid java name */
    public int mo69432roundToPx0680j_4(float f) {
        return this.f12999a.mo69432roundToPx0680j_4(f);
    }

    @Override // androidx.compose.p003ui.unit.Density
    /* renamed from: toDp-GaN1DYA  reason: not valid java name */
    public float mo69433toDpGaN1DYA(long j) {
        return this.f12999a.mo69433toDpGaN1DYA(j);
    }

    @Override // androidx.compose.p003ui.unit.Density
    /* renamed from: toDp-u2uoSUM  reason: not valid java name */
    public float mo69434toDpu2uoSUM(float f) {
        return this.f12999a.mo69434toDpu2uoSUM(f);
    }

    @Override // androidx.compose.p003ui.unit.Density
    /* renamed from: toDpSize-k-rfVVM  reason: not valid java name */
    public long mo69436toDpSizekrfVVM(long j) {
        return this.f12999a.mo69436toDpSizekrfVVM(j);
    }

    @Override // androidx.compose.p003ui.unit.Density
    /* renamed from: toPx--R2X_6o  reason: not valid java name */
    public float mo69437toPxR2X_6o(long j) {
        return this.f12999a.mo69437toPxR2X_6o(j);
    }

    @Override // androidx.compose.p003ui.unit.Density
    /* renamed from: toPx-0680j_4  reason: not valid java name */
    public float mo69438toPx0680j_4(float f) {
        return this.f12999a.mo69438toPx0680j_4(f);
    }

    @Override // androidx.compose.p003ui.unit.Density
    public Rect toRect(DpRect dpRect) {
        Intrinsics.checkNotNullParameter(dpRect, "<this>");
        return this.f12999a.toRect(dpRect);
    }

    @Override // androidx.compose.p003ui.unit.Density
    /* renamed from: toSize-XkaWNTQ  reason: not valid java name */
    public long mo69439toSizeXkaWNTQ(long j) {
        return this.f12999a.mo69439toSizeXkaWNTQ(j);
    }

    @Override // androidx.compose.p003ui.unit.Density
    /* renamed from: toSp-0xMU5do  reason: not valid java name */
    public long mo69440toSp0xMU5do(float f) {
        return this.f12999a.mo69440toSp0xMU5do(f);
    }

    @Override // androidx.compose.p003ui.unit.Density
    /* renamed from: toSp-kPz2Gy4  reason: not valid java name */
    public long mo69441toSpkPz2Gy4(float f) {
        return this.f12999a.mo69441toSpkPz2Gy4(f);
    }
    ...
    */
    public java.lang.Object tryAwaitRelease(kotlin.coroutines.Continuation r6) {
        ...
        L36:
            kotlin.ResultKt.throwOnFailure(r6)
            boolean r6 = r5.f13000b
            if (r6 != 0) goto L55
            boolean r6 = r5.f13001c
            if (r6 != 0) goto L55
            kotlinx.coroutines.sync.Mutex r6 = r5.f13002d
            r0.L$0 = r5
            r0.label = r4
    ...
    public float mo69435toDpu2uoSUM(int i) {
        return this.f12999a.mo69435toDpu2uoSUM(i);
    }

    @Override // androidx.compose.p003ui.unit.Density
    /* renamed from: toSp-kPz2Gy4  reason: not valid java name */
    public long mo69442toSpkPz2Gy4(int i) {
        return this.f12999a.mo69442toSpkPz2Gy4(i);
    }
}
