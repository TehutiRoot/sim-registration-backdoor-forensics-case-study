...
@DebugMetadata(m28801c = "androidx.compose.foundation.gestures.DefaultScrollableState$scroll$2", m28800f = "ScrollableState.kt", m28799i = {}, m28798l = {178}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
...
public final class DefaultScrollableState$scroll$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(m28801c = "androidx.compose.foundation.gestures.DefaultScrollableState$scroll$2$1", m28800f = "ScrollableState.kt", m28799i = {}, m28798l = {181}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
    /* renamed from: androidx.compose.foundation.gestures.DefaultScrollableState$scroll$2$1 */
    /* loaded from: classes.dex */
    public static final class C27941 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ Function2<ScrollScope, Continuation<? super Unit>, Object> $block;
        ...
        public C27941(DefaultScrollableState defaultScrollableState, Function2<? super ScrollScope, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super C27941> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C27941 c27941 = new C27941(this.this$0, this.$block, continuation);
            c27941.L$0 = obj;
            return c27941;
        }
        ...
        public final Object invoke(@NotNull ScrollScope scrollScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C27941) create(scrollScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            try {
                if (i != 0) {
                    ...
                    mutableState2 = this.this$0.f12955d;
                ...
                mutableState3 = this.this$0.f12955d;
                mutableState3.setValue(Boxing.boxBoolean(false));
                return Unit.INSTANCE;
            } catch (Throwable th2) {
                mutableState = this.this$0.f12955d;
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i != 0) {
            ...
            ResultKt.throwOnFailure(obj);
            mutatorMutex = this.this$0.f12954c;
            scrollScope = this.this$0.f12953b;
            MutatePriority mutatePriority = this.$scrollPriority;
            C27941 c27941 = new C27941(this.this$0, this.$block, null);
            this.label = 1;
            if (mutatorMutex.mutateWith(scrollScope, mutatePriority, c27941, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        }
        return Unit.INSTANCE;
