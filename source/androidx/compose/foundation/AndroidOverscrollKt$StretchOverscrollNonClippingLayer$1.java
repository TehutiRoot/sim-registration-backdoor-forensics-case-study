...
public final class AndroidOverscrollKt$StretchOverscrollNonClippingLayer$1 extends Lambda implements Function3<MeasureScope, Measurable, Constraints, MeasureResult> {
    ...
    /* renamed from: androidx.compose.foundation.AndroidOverscrollKt$StretchOverscrollNonClippingLayer$1$1 */
    /* loaded from: classes.dex */
    public static final class C27681 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
        final /* synthetic */ int $extraSizePx;
        final /* synthetic */ Placeable $placeable;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C27681(Placeable placeable, int i) {
            super(1);
    ...
    public /* bridge */ /* synthetic */ MeasureResult invoke(MeasureScope measureScope, Measurable measurable, Constraints constraints) {
        return m69316invoke3p2s80s(measureScope, measurable, constraints.m73632unboximpl());
    }

    @NotNull
    /* renamed from: invoke-3p2s80s  reason: not valid java name */
    public final MeasureResult m69316invoke3p2s80s(@NotNull MeasureScope layout, @NotNull Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(layout, "$this$layout");
        ...
        return MeasureScope.CC.m59532q(layout, mo72811measureBRTryo0.getMeasuredWidth() - mo69432roundToPx0680j_4, mo72811measureBRTryo0.getMeasuredHeight() - mo69432roundToPx0680j_4, null, new C27681(mo72811measureBRTryo0, mo69432roundToPx0680j_4), 4, null);
    }
}
