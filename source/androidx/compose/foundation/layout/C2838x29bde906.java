...
public final class C2838x29bde906 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public C2838x29bde906(AlignmentLine alignmentLine, float f, float f2) {
        super(1);
    ...
    public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("before", C3641Dp.m73656boximpl(this.$before$inlined));
        inspectorInfo.getProperties().set("after", C3641Dp.m73656boximpl(this.$after$inlined));
    }
}
