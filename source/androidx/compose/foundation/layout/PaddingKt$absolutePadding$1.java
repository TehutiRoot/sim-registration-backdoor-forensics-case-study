...
public final class PaddingKt$absolutePadding$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke2(@NotNull InspectorInfo $receiver) {
        ...
        $receiver.getProperties().set("left", C3641Dp.m73656boximpl(this.$left));
        $receiver.getProperties().set("top", C3641Dp.m73656boximpl(this.$top));
        $receiver.getProperties().set("right", C3641Dp.m73656boximpl(this.$right));
