...
public final class WrapContentNode$measure$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke2(@NotNull Placeable.PlacementScope layout) {
        ...
        Placeable.PlacementScope.m72850place70tqf50$default(layout, this.$placeable, ((IntOffset) this.this$0.m61302a().invoke(IntSize.m73810boximpl(IntSizeKt.IntSize(this.$wrapperWidth - this.$placeable.getWidth(), this.$wrapperHeight - this.$placeable.getHeight())), this.$this_measure.getLayoutDirection())).m73785unboximpl(), 0.0f, 2, null);
    }
}
