...
public final class Arrangement {
    ...
    /* renamed from: a */
    public static final Horizontal f13080a = new Horizontal() { // from class: androidx.compose.foundation.layout.Arrangement$Start$1
        ...
        public /* synthetic */ float mo69484getSpacingD9Ej5fM() {
            return AbstractC0717K6.m67639a(this);
        }
    ...
    /* renamed from: b */
    public static final Horizontal f13081b = new Horizontal() { // from class: androidx.compose.foundation.layout.Arrangement$End$1
        @Override // androidx.compose.foundation.layout.Arrangement.Horizontal
        public void arrange(@NotNull Density density, int i, @NotNull int[] sizes, @NotNull LayoutDirection layoutDirection, @NotNull int[] outPositions) {
            Intrinsics.checkNotNullParameter(density, "<this>");
            Intrinsics.checkNotNullParameter(sizes, "sizes");
    ...
    /* renamed from: c */
    public static final Vertical f13082c = new Vertical() { // from class: androidx.compose.foundation.layout.Arrangement$Top$1
        ...
        /* renamed from: getSpacing-D9Ej5fM */
        public /* synthetic */ float mo69484getSpacingD9Ej5fM() {
            return AbstractC0846M6.m67427a(this);
        }
    ...
    /* renamed from: d */
    public static final Vertical f13083d = new Vertical() { // from class: androidx.compose.foundation.layout.Arrangement$Bottom$1
        @Override // androidx.compose.foundation.layout.Arrangement.Vertical
        public void arrange(@NotNull Density density, int i, @NotNull int[] sizes, @NotNull int[] outPositions) {
            Intrinsics.checkNotNullParameter(density, "<this>");
            Intrinsics.checkNotNullParameter(sizes, "sizes");
    ...
    /* renamed from: e */
    public static final HorizontalOrVertical f13084e = new HorizontalOrVertical() { // from class: androidx.compose.foundation.layout.Arrangement$Center$1

        /* renamed from: a */
        public final float f13098a = C3641Dp.m73658constructorimpl(0);
        ...
        /* renamed from: getSpacing-D9Ej5fM */
        public float mo69484getSpacingD9Ej5fM() {
            return this.f13098a;
        }
    ...
    /* renamed from: f */
    public static final HorizontalOrVertical f13085f = new HorizontalOrVertical() { // from class: androidx.compose.foundation.layout.Arrangement$SpaceEvenly$1

        /* renamed from: a */
        public final float f13101a = C3641Dp.m73658constructorimpl(0);
    ...
    /* renamed from: g */
    public static final HorizontalOrVertical f13086g = new HorizontalOrVertical() { // from class: androidx.compose.foundation.layout.Arrangement$SpaceBetween$1

        /* renamed from: a */
        public final float f13100a = C3641Dp.m73658constructorimpl(0);
    ...
    /* renamed from: h */
    public static final HorizontalOrVertical f13087h = new HorizontalOrVertical() { // from class: androidx.compose.foundation.layout.Arrangement$SpaceAround$1

        /* renamed from: a */
        public final float f13099a = C3641Dp.m73658constructorimpl(0);
    ...
    public static final class Absolute {
        ...
        /* renamed from: a */
        public static final Horizontal f13088a = new Horizontal() { // from class: androidx.compose.foundation.layout.Arrangement$Absolute$Left$1
            @Override // androidx.compose.foundation.layout.Arrangement.Horizontal
            public void arrange(@NotNull Density density, int i, @NotNull int[] sizes, @NotNull LayoutDirection layoutDirection, @NotNull int[] outPositions) {
                Intrinsics.checkNotNullParameter(density, "<this>");
                Intrinsics.checkNotNullParameter(sizes, "sizes");
        ...
        /* renamed from: b */
        public static final Horizontal f13089b = new Horizontal() { // from class: androidx.compose.foundation.layout.Arrangement$Absolute$Center$1
            @Override // androidx.compose.foundation.layout.Arrangement.Horizontal
            public void arrange(@NotNull Density density, int i, @NotNull int[] sizes, @NotNull LayoutDirection layoutDirection, @NotNull int[] outPositions) {
                Intrinsics.checkNotNullParameter(density, "<this>");
                Intrinsics.checkNotNullParameter(sizes, "sizes");
        ...
        /* renamed from: c */
        public static final Horizontal f13090c = new Horizontal() { // from class: androidx.compose.foundation.layout.Arrangement$Absolute$Right$1
            @Override // androidx.compose.foundation.layout.Arrangement.Horizontal
            public void arrange(@NotNull Density density, int i, @NotNull int[] sizes, @NotNull LayoutDirection layoutDirection, @NotNull int[] outPositions) {
                Intrinsics.checkNotNullParameter(density, "<this>");
                Intrinsics.checkNotNullParameter(sizes, "sizes");
        ...
        /* renamed from: d */
        public static final Horizontal f13091d = new Horizontal() { // from class: androidx.compose.foundation.layout.Arrangement$Absolute$SpaceBetween$1
            @Override // androidx.compose.foundation.layout.Arrangement.Horizontal
            public void arrange(@NotNull Density density, int i, @NotNull int[] sizes, @NotNull LayoutDirection layoutDirection, @NotNull int[] outPositions) {
                Intrinsics.checkNotNullParameter(density, "<this>");
                Intrinsics.checkNotNullParameter(sizes, "sizes");
        ...
        /* renamed from: e */
        public static final Horizontal f13092e = new Horizontal() { // from class: androidx.compose.foundation.layout.Arrangement$Absolute$SpaceEvenly$1
            @Override // androidx.compose.foundation.layout.Arrangement.Horizontal
            public void arrange(@NotNull Density density, int i, @NotNull int[] sizes, @NotNull LayoutDirection layoutDirection, @NotNull int[] outPositions) {
                Intrinsics.checkNotNullParameter(density, "<this>");
                Intrinsics.checkNotNullParameter(sizes, "sizes");
        ...
        /* renamed from: f */
        public static final Horizontal f13093f = new Horizontal() { // from class: androidx.compose.foundation.layout.Arrangement$Absolute$SpaceAround$1
            @Override // androidx.compose.foundation.layout.Arrangement.Horizontal
            public void arrange(@NotNull Density density, int i, @NotNull int[] sizes, @NotNull LayoutDirection layoutDirection, @NotNull int[] outPositions) {
                Intrinsics.checkNotNullParameter(density, "<this>");
                Intrinsics.checkNotNullParameter(sizes, "sizes");
        ...
        public final Horizontal aligned(@NotNull Alignment.Horizontal alignment) {
            ...
            return new SpacedAligned(C3641Dp.m73658constructorimpl(0), false, new Arrangement$Absolute$aligned$1(alignment), null);
        }
        ...
        public final HorizontalOrVertical m69481spacedBy0680j_4(float f) {
        ...
        public final Horizontal m69482spacedByD5KLDUw(float f, @NotNull Alignment.Horizontal alignment) {
            Intrinsics.checkNotNullParameter(alignment, "alignment");
        ...
        @NotNull
        /* renamed from: spacedBy-D5KLDUw  reason: not valid java name */
        public final Vertical m69483spacedByD5KLDUw(float f, @NotNull Alignment.Vertical alignment) {
            Intrinsics.checkNotNullParameter(alignment, "alignment");
            return new SpacedAligned(f, false, new Arrangement$Absolute$spacedBy$2(alignment), null);
        }
    }

    @Metadata(m28851d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0015\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\bg\u0018\u00002\u00020\u0001J,\u0010\u0006\u001a\u00020\u0007*\u00020\b2\u0006\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u000e2\u0006\u0010\u000f\u001a\u00020\fH&R\u001d\u0010\u0002\u001a\u00020\u00038VX\u0096\u0004ø\u0001\u0000ø\u0001\u0001ø\u0001\u0002¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005ø\u0001\u0003\u0082\u0002\u0015\n\u0002\b\u0019\n\u0005\b¡\u001e0\u0001\n\u0002\b!\n\u0004\b!0\u0001¨\u0006\u0010À\u0006\u0003"}, m28850d2 = {"Landroidx/compose/foundation/layout/Arrangement$Horizontal;", "", "spacing", "Landroidx/compose/ui/unit/Dp;", "getSpacing-D9Ej5fM", "()F", "arrange", "", "Landroidx/compose/ui/unit/Density;", "totalSize", "", "sizes", "", "layoutDirection", "Landroidx/compose/ui/unit/LayoutDirection;", "outPositions", "foundation-layout_release"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    @Stable
    ...
    public interface Horizontal {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
            public static float m69485getSpacingD9Ej5fM(@NotNull Horizontal horizontal) {
                float m67639a;
                m67639a = AbstractC0717K6.m67639a(horizontal);
                return m67639a;
            }
        }
    ...
    @Metadata(m28851d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\bg\u0018\u00002\u00020\u00012\u00020\u0002R\u001d\u0010\u0003\u001a\u00020\u00048VX\u0096\u0004ø\u0001\u0000ø\u0001\u0001ø\u0001\u0002¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006ø\u0001\u0003\u0082\u0002\u0015\n\u0002\b\u0019\n\u0005\b¡\u001e0\u0001\n\u0002\b!\n\u0004\b!0\u0001¨\u0006\u0007À\u0006\u0003"}, m28850d2 = {"Landroidx/compose/foundation/layout/Arrangement$HorizontalOrVertical;", "Landroidx/compose/foundation/layout/Arrangement$Horizontal;", "Landroidx/compose/foundation/layout/Arrangement$Vertical;", "spacing", "Landroidx/compose/ui/unit/Dp;", "getSpacing-D9Ej5fM", "()F", "foundation-layout_release"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    @Stable
    ...
    public interface HorizontalOrVertical extends Horizontal, Vertical {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
            public static float m69486getSpacingD9Ej5fM(@NotNull HorizontalOrVertical horizontalOrVertical) {
                float m67547a;
                m67547a = AbstractC0783L6.m67547a(horizontalOrVertical);
                return m67547a;
            }
        }
    ...
    public static final class SpacedAligned implements HorizontalOrVertical {
        ...
        /* renamed from: c */
        public final Function2 f13096c;
        ...
        public static /* synthetic */ SpacedAligned m69487copy8Feqmps$default(SpacedAligned spacedAligned, float f, boolean z, Function2 function2, int i, Object obj) {
            if ((i & 1) != 0) {
                f = spacedAligned.f13094a;
            }
            if ((i & 2) != 0) {
                z = spacedAligned.f13095b;
            }
            if ((i & 4) != 0) {
                function2 = spacedAligned.f13096c;
            }
            return spacedAligned.m69489copy8Feqmps(f, z, function2);
        }
        ...
        public void arrange(@NotNull Density density, int i, @NotNull int[] sizes, @NotNull LayoutDirection layoutDirection, @NotNull int[] outPositions) {
            ...
            int mo69432roundToPx0680j_4 = density.mo69432roundToPx0680j_4(this.f13094a);
            boolean z = this.f13095b && layoutDirection == LayoutDirection.Rtl;
            ...
            if (!z) {
                ...
                while (i4 < length) {
                    ...
                    outPositions[i5] = min;
                    int min2 = Math.min(mo69432roundToPx0680j_4, (i - min) - i6);
                ...
                while (-1 < length2) {
                    ...
                    int min4 = Math.min(mo69432roundToPx0680j_4, (i - min3) - i8);
                    length2--;
                    i3 = min4;
            ...
            int i9 = i2 - i3;
            Function2 function2 = this.f13096c;
        ...
        public final float m69488component1D9Ej5fM() {
            return this.f13094a;
        }
        ...
        public final SpacedAligned m69489copy8Feqmps(float f, boolean z, @Nullable Function2<? super Integer, ? super LayoutDirection, Integer> function2) {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            if (obj instanceof SpacedAligned) {
                ...
                return C3641Dp.m73663equalsimpl0(this.f13094a, spacedAligned.f13094a) && this.f13095b == spacedAligned.f13095b && Intrinsics.areEqual(this.f13096c, spacedAligned.f13096c);
            }
            return false;
        }
        ...
        public final float m69490getSpaceD9Ej5fM() {
            return this.f13094a;
        }
        ...
        /* JADX WARN: Multi-variable type inference failed */
        public int hashCode() {
            int m73664hashCodeimpl = C3641Dp.m73664hashCodeimpl(this.f13094a) * 31;
            boolean z = this.f13095b;
            int i = z;
            if (z != 0) {
                i = 1;
            }
            int i2 = (m73664hashCodeimpl + i) * 31;
            Function2 function2 = this.f13096c;
        ...
        public String toString() {
            ...
            sb.append((Object) C3641Dp.m73669toStringimpl(this.f13094a));
            sb.append(", ");
    ...
    @Metadata(m28851d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0015\n\u0002\b\u0002\bg\u0018\u00002\u00020\u0001J$\u0010\u0006\u001a\u00020\u0007*\u00020\b2\u0006\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\fH&R\u001d\u0010\u0002\u001a\u00020\u00038VX\u0096\u0004ø\u0001\u0000ø\u0001\u0001ø\u0001\u0002¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005ø\u0001\u0003\u0082\u0002\u0015\n\u0002\b\u0019\n\u0005\b¡\u001e0\u0001\n\u0002\b!\n\u0004\b!0\u0001¨\u0006\u000eÀ\u0006\u0003"}, m28850d2 = {"Landroidx/compose/foundation/layout/Arrangement$Vertical;", "", "spacing", "Landroidx/compose/ui/unit/Dp;", "getSpacing-D9Ej5fM", "()F", "arrange", "", "Landroidx/compose/ui/unit/Density;", "totalSize", "", "sizes", "", "outPositions", "foundation-layout_release"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    @Stable
    ...
    public interface Vertical {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
            public static float m69491getSpacingD9Ej5fM(@NotNull Vertical vertical) {
                float m67427a;
                m67427a = AbstractC0846M6.m67427a(vertical);
                return m67427a;
            }
        }
    ...
    public final Horizontal aligned(@NotNull Alignment.Horizontal alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
        return new SpacedAligned(C3641Dp.m73658constructorimpl(0), true, new Arrangement$aligned$1(alignment), null);
    }
    ...
    public final void placeCenter$foundation_layout_release(int i, @NotNull int[] size, @NotNull int[] outPosition, boolean z) {
        ...
        if (!z) {
            ...
            while (i2 < length) {
                int i6 = size[i2];
                outPosition[i5] = AbstractC21140mr0.roundToInt(f);
                f += i6;
                i2++;
                i5++;
            }
        ...
        while (true) {
            ...
            if (-1 < length2) {
                int i7 = size[length2];
                outPosition[length2] = AbstractC21140mr0.roundToInt(f);
                f += i7;
            } else {
                return;
            }
    ...
    public final void placeSpaceAround$foundation_layout_release(int i, @NotNull int[] size, @NotNull int[] outPosition, boolean z) {
        ...
        if (!z) {
            ...
            while (i2 < length) {
                int i6 = size[i2];
                outPosition[i5] = AbstractC21140mr0.roundToInt(f2);
                f2 += i6 + f;
                i2++;
                i5++;
            }
        ...
        for (int length2 = size.length - 1; -1 < length2; length2--) {
            int i7 = size[length2];
            outPosition[length2] = AbstractC21140mr0.roundToInt(f2);
            f2 += i7 + f;
        }
    }
    ...
    public final void placeSpaceEvenly$foundation_layout_release(int i, @NotNull int[] size, @NotNull int[] outPosition, boolean z) {
        ...
        for (int length3 = size.length - 1; -1 < length3; length3--) {
            int i7 = size[length3];
            outPosition[length3] = AbstractC21140mr0.roundToInt(f2);
            f2 += i7 + length;
        }
    }
    ...
    @NotNull
    /* renamed from: spacedBy-0680j_4  reason: not valid java name */
    public final HorizontalOrVertical m69478spacedBy0680j_4(float f) {
    ...
    @NotNull
    /* renamed from: spacedBy-D5KLDUw  reason: not valid java name */
    public final Horizontal m69479spacedByD5KLDUw(float f, @NotNull Alignment.Horizontal alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
    ...
    @NotNull
    /* renamed from: spacedBy-D5KLDUw  reason: not valid java name */
    public final Vertical m69480spacedByD5KLDUw(float f, @NotNull Alignment.Vertical alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
    ...
    public final Vertical aligned(@NotNull Alignment.Vertical alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
        return new SpacedAligned(C3641Dp.m73658constructorimpl(0), false, new Arrangement$aligned$2(alignment), null);
    }
}
