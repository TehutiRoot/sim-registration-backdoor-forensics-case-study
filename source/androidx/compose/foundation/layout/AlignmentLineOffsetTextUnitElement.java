...
final class AlignmentLineOffsetTextUnitElement extends ModifierNodeElement<C0361F2> {
    ...
    /* renamed from: e */
    public final Function1 f13069e;
    ...
    /* renamed from: d */
    public C0361F2 create() {
        return new C0361F2(this.f13066b, this.f13067c, this.f13068d, null);
    }

    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    /* renamed from: e */
    public void update(C0361F2 node) {
        Intrinsics.checkNotNullParameter(node, "node");
        node.setAlignmentLine(this.f13066b);
        node.m68430b(this.f13067c);
        node.m68431a(this.f13068d);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (alignmentLineOffsetTextUnitElement != null && Intrinsics.areEqual(this.f13066b, alignmentLineOffsetTextUnitElement.f13066b) && TextUnit.m73836equalsimpl0(this.f13067c, alignmentLineOffsetTextUnitElement.f13067c) && TextUnit.m73836equalsimpl0(this.f13068d, alignmentLineOffsetTextUnitElement.f13068d)) {
            return true;
        }
        return false;
    }
    ...
    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    public int hashCode() {
        return (((this.f13066b.hashCode() * 31) + TextUnit.m73840hashCodeimpl(this.f13067c)) * 31) + TextUnit.m73840hashCodeimpl(this.f13068d);
    }

    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        Intrinsics.checkNotNullParameter(inspectorInfo, "<this>");
        this.f13069e.invoke(inspectorInfo);
    }
    ...
    public AlignmentLineOffsetTextUnitElement(AlignmentLine alignmentLine, long j, long j2, Function1 inspectorInfo) {
        ...
        this.f13066b = alignmentLine;
        this.f13067c = j;
        this.f13068d = j2;
        this.f13069e = inspectorInfo;
    }
}
