...
public final class C2839x79f276d2 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public C2839x79f276d2(AlignmentLine alignmentLine, long j, long j2) {
        super(1);
    ...
    public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("before", TextUnit.m73829boximpl(this.$before$inlined));
        inspectorInfo.getProperties().set("after", TextUnit.m73829boximpl(this.$after$inlined));
    }
}
