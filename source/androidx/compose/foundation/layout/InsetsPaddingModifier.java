...
public final class InsetsPaddingModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer, ModifierLocalProvider<WindowInsets> {
    ...
    /* renamed from: c */
    public final WindowInsets f13158c;

    /* renamed from: d */
    public final MutableState f13159d;

    /* renamed from: e */
    public final MutableState f13160e;
    ...
    public InsetsPaddingModifier(@NotNull WindowInsets insets, @NotNull Function1<? super InspectorInfo, Unit> inspectorInfo) {
        ...
        this.f13159d = m31891g;
        m31891g2 = AbstractC19508dK1.m31891g(insets, null, 2, null);
        this.f13160e = m31891g2;
    }

    /* renamed from: e */
    private final WindowInsets m61391e() {
        return (WindowInsets) this.f13159d.getValue();
    }

    /* renamed from: g */
    private final void m61389g(WindowInsets windowInsets) {
        this.f13159d.setValue(windowInsets);
    }
    ...
    /* renamed from: d */
    public final WindowInsets m61392d() {
        return (WindowInsets) this.f13160e.getValue();
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.areEqual(((InsetsPaddingModifier) obj).f13158c, this.f13158c);
    }

    /* renamed from: f */
    public final void m61390f(WindowInsets windowInsets) {
        this.f13160e.setValue(windowInsets);
    }
    ...
    public MeasureResult mo69160measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measure, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        int left = m61391e().getLeft(measure, measure.getLayoutDirection());
        int top = m61391e().getTop(measure);
        int right = m61391e().getRight(measure, measure.getLayoutDirection()) + left;
        int bottom = m61391e().getBottom(measure) + top;
        Placeable mo72811measureBRTryo0 = measurable.mo72811measureBRTryo0(ConstraintsKt.m73642offsetNN6EwU(j, -right, -bottom));
        return MeasureScope.CC.m59532q(measure, ConstraintsKt.m73640constrainWidthK40F9xA(j, mo72811measureBRTryo0.getWidth() + right), ConstraintsKt.m73639constrainHeightK40F9xA(j, mo72811measureBRTryo0.getHeight() + bottom), null, new InsetsPaddingModifier$measure$1(mo72811measureBRTryo0, left, top), 4, null);
    }
    ...
    public void onModifierLocalsUpdated(@NotNull ModifierLocalReadScope scope) {
        ...
        m61389g(WindowInsetsKt.exclude(this.f13158c, windowInsets));
        m61390f(WindowInsetsKt.union(windowInsets, this.f13158c));
    }
