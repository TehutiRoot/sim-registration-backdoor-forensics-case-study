...
final class AspectRatioElement extends ModifierNodeElement<AspectRatioNode> {
    ...
    public AspectRatioNode create() {
        return new AspectRatioNode(this.f13102b, this.f13103c);
    }
    ...
    public void update(AspectRatioNode node) {
        ...
        node.m61423b(this.f13102b);
        node.m61422c(this.f13103c);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (aspectRatioElement != null && this.f13102b == aspectRatioElement.f13102b && this.f13103c == ((AspectRatioElement) obj).f13103c) {
            return true;
        }
        return false;
    }
    ...
    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    public int hashCode() {
        return (Float.floatToIntBits(this.f13102b) * 31) + AbstractC1705Xp.m65430a(this.f13103c);
    }

    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        Intrinsics.checkNotNullParameter(inspectorInfo, "<this>");
        this.f13104d.invoke(inspectorInfo);
    }
}
