...
public final class ColumnKt {
    ...
    static {
        ...
        f13115a = RowColumnImplKt.m69542rowColumnMeasurePolicyTDGSqEk(layoutOrientation, ColumnKt$DefaultColumnMeasurePolicy$1.INSTANCE, mo69484getSpacingD9Ej5fM, SizeMode.Wrap, horizontal$foundation_layout_release);
    }
    ...
    public static final MeasurePolicy columnMeasurePolicy(@NotNull Arrangement.Vertical verticalArrangement, @NotNull Alignment.Horizontal horizontalAlignment, @Nullable Composer composer, int i) {
        ...
        if (Intrinsics.areEqual(verticalArrangement, Arrangement.INSTANCE.getTop()) && Intrinsics.areEqual(horizontalAlignment, Alignment.Companion.getStart())) {
            ...
            if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                LayoutOrientation layoutOrientation = LayoutOrientation.Vertical;
                float mo69484getSpacingD9Ej5fM = verticalArrangement.mo69484getSpacingD9Ej5fM();
                ...
                rememberedValue = RowColumnImplKt.m69542rowColumnMeasurePolicyTDGSqEk(layoutOrientation, new ColumnKt$columnMeasurePolicy$1$1(verticalArrangement), mo69484getSpacingD9Ej5fM, SizeMode.Wrap, horizontal$foundation_layout_release);
