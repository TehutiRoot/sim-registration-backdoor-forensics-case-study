...
public final class RowKt {
    ...
    static {
        ...
        f13240a = RowColumnImplKt.m69542rowColumnMeasurePolicyTDGSqEk(layoutOrientation, RowKt$DefaultRowMeasurePolicy$1.INSTANCE, mo69484getSpacingD9Ej5fM, SizeMode.Wrap, vertical$foundation_layout_release);
    }
    ...
    public static final MeasurePolicy rowMeasurePolicy(@NotNull Arrangement.Horizontal horizontalArrangement, @NotNull Alignment.Vertical verticalAlignment, @Nullable Composer composer, int i) {
        ...
        if (Intrinsics.areEqual(horizontalArrangement, Arrangement.INSTANCE.getStart()) && Intrinsics.areEqual(verticalAlignment, Alignment.Companion.getTop())) {
            ...
            if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                LayoutOrientation layoutOrientation = LayoutOrientation.Horizontal;
                float mo69484getSpacingD9Ej5fM = horizontalArrangement.mo69484getSpacingD9Ej5fM();
                ...
                rememberedValue = RowColumnImplKt.m69542rowColumnMeasurePolicyTDGSqEk(layoutOrientation, new RowKt$rowMeasurePolicy$1$1(horizontalArrangement), mo69484getSpacingD9Ej5fM, SizeMode.Wrap, vertical$foundation_layout_release);
