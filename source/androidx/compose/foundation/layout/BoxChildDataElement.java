...
public final class BoxChildDataElement extends ModifierNodeElement<C13939sc> {
    ...
    public BoxChildDataElement(Alignment alignment, boolean z, Function1 inspectorInfo) {
        ...
        this.f13108c = z;
        this.f13109d = inspectorInfo;
    }

    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    /* renamed from: d */
    public C13939sc create() {
        return new C13939sc(this.f13107b, this.f13108c);
    }

    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    /* renamed from: e */
    public void update(C13939sc node) {
        Intrinsics.checkNotNullParameter(node, "node");
        node.m22566d(this.f13107b);
        node.m22565e(this.f13108c);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (boxChildDataElement != null && Intrinsics.areEqual(this.f13107b, boxChildDataElement.f13107b) && this.f13108c == boxChildDataElement.f13108c) {
            return true;
        }
        return false;
    }
    ...
    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    public int hashCode() {
        return (this.f13107b.hashCode() * 31) + AbstractC1705Xp.m65430a(this.f13108c);
    }

    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        Intrinsics.checkNotNullParameter(inspectorInfo, "<this>");
        this.f13109d.invoke(inspectorInfo);
    }
}
