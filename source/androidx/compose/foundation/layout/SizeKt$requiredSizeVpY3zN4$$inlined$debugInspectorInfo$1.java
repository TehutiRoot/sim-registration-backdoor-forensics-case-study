...
public final class SizeKt$requiredSizeVpY3zN4$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("width", C3641Dp.m73656boximpl(this.$width$inlined));
        inspectorInfo.getProperties().set("height", C3641Dp.m73656boximpl(this.$height$inlined));
    }
}
