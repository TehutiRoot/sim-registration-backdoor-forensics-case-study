...
public final class ScrollState$scrollableState$1 extends Lambda implements Function1<Float, Float> {
    ...
    public final Float invoke(float f) {
        float f2;
        f2 = this.this$0.f12914e;
        float value = this.this$0.getValue() + f + f2;
        float coerceIn = AbstractC11719c.coerceIn(value, 0.0f, this.this$0.getMaxValue());
        boolean z = !(value == coerceIn);
        float value2 = coerceIn - this.this$0.getValue();
        int roundToInt = AbstractC21140mr0.roundToInt(value2);
        ScrollState scrollState = this.this$0;
        scrollState.m61539a(scrollState.getValue() + roundToInt);
        this.this$0.f12914e = value2 - roundToInt;
        if (z) {
            f = value2;
        }
