...
public final class BorderKt {
    ...
    public static final Modifier border(@NotNull Modifier modifier, @NotNull BorderStroke border, @NotNull Shape shape) {
        ...
        return m69328borderziNgDLE(modifier, border.m69338getWidthD9Ej5fM(), border.getBrush(), shape);
    }
    ...
    public static final Modifier m69326borderxT4_qwU(@NotNull Modifier border, float f, long j, @NotNull Shape shape) {
        Intrinsics.checkNotNullParameter(border, "$this$border");
        Intrinsics.checkNotNullParameter(shape, "shape");
        return m69328borderziNgDLE(border, f, new SolidColor(j, null), shape);
    }

    /* renamed from: border-xT4_qwU$default */
    public static /* synthetic */ Modifier m69327borderxT4_qwU$default(Modifier modifier, float f, long j, Shape shape, int i, Object obj) {
        if ((i & 4) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        return m69326borderxT4_qwU(modifier, f, j, shape);
    }

    @NotNull
    /* renamed from: border-ziNgDLE */
    public static final Modifier m69328borderziNgDLE(@NotNull Modifier border, float f, @NotNull Brush brush, @NotNull Shape shape) {
        Intrinsics.checkNotNullParameter(border, "$this$border");
    ...
    /* renamed from: c */
    public static final DrawResult m61614c(CacheDrawScope cacheDrawScope) {
        return cacheDrawScope.onDrawWithContent(BorderKt$drawContentWithoutBorder$1.INSTANCE);
    }

    /* renamed from: d */
    public static final DrawResult m61613d(CacheDrawScope cacheDrawScope, Brush brush, long j, long j2, boolean z, float f) {
        long j3;
        long j4;
        DrawStyle stroke;
        if (z) {
        ...
        if (z) {
            j4 = cacheDrawScope.m71423getSizeNHjbRc();
        } else {
            j4 = j2;
        }
        if (z) {
    ...
    /* renamed from: e */
    public static final long m61612e(long j, float f) {
        return CornerRadiusKt.CornerRadius(Math.max(0.0f, CornerRadius.m71477getXimpl(j) - f), Math.max(0.0f, CornerRadius.m71478getYimpl(j) - f));
    }
}
