...
public final class BringIntoViewRequesterImpl implements BringIntoViewRequester {
    ...
    /* renamed from: a */
    public final MutableVector f13937a = new MutableVector(new BringIntoViewRequesterNode[16], 0);

    /* renamed from: a */
    public final MutableVector m61093a() {
        return this.f13937a;
    }
    ...
    */
    public java.lang.Object bringIntoView(androidx.compose.p003ui.geometry.Rect r7, kotlin.coroutines.Continuation r8) {
        ...
        L3e:
            kotlin.ResultKt.throwOnFailure(r8)
            androidx.compose.runtime.collection.MutableVector r8 = r6.f13937a
            int r2 = r8.getSize()
            if (r2 <= 0) goto L69
