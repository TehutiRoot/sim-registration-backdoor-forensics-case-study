...
@Metadata(m28851d1 = {"\u0000\u0014\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\b\u0012\u0004\u0012\u00020\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00040\u0003H\n¢\u0006\u0002\b\u0005"}, m28850d2 = {"<anonymous>", "Landroidx/compose/animation/core/FiniteAnimationSpec;", "Landroidx/compose/ui/unit/IntOffset;", "Landroidx/compose/animation/core/Transition$Segment;", "Landroidx/compose/animation/EnterExitState;", "invoke"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
...
public final class SlideModifier$transitionSpec$1 extends Lambda implements Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<IntOffset>> {
    ...
    public final FiniteAnimationSpec<IntOffset> invoke(@NotNull Transition.Segment<EnterExitState> segment) {
        ...
        if (segment.isTransitioningTo(enterExitState, enterExitState2)) {
            Slide slide = (Slide) this.this$0.m61716d().getValue();
            if (slide == null || (animationSpec2 = slide.getAnimationSpec()) == null) {
                springSpec3 = EnterExitTransitionKt.f12365d;
                return springSpec3;
            }
            return animationSpec2;
        } else if (!segment.isTransitioningTo(enterExitState2, EnterExitState.PostExit)) {
            springSpec = EnterExitTransitionKt.f12365d;
            return springSpec;
        } else {
            Slide slide2 = (Slide) this.this$0.m61715e().getValue();
            if (slide2 == null || (animationSpec = slide2.getAnimationSpec()) == null) {
                springSpec2 = EnterExitTransitionKt.f12365d;
                return springSpec2;
            }
