...
public final class AnimatedEnterExitMeasurePolicy implements MeasurePolicy {
    ...
    /* renamed from: a */
    public final AnimatedVisibilityScopeImpl f12349a;
    ...
    public MeasureResult mo69194measure3p2s80s(MeasureScope measure, List measurables, long j) {
        ...
        this.f12349a.getTargetSize$animation_release().setValue(IntSize.m73810boximpl(IntSizeKt.IntSize(i, i2)));
        return MeasureScope.CC.m59532q(measure, i, i2, null, new AnimatedEnterExitMeasurePolicy$measure$1(arrayList), 4, null);
    }
