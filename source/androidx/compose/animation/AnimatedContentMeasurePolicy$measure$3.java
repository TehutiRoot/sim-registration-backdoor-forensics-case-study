...
public final class AnimatedContentMeasurePolicy$measure$3 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke2(@NotNull Placeable.PlacementScope layout) {
        ...
        for (Placeable placeable : placeableArr) {
            if (placeable != null) {
                long mo71407alignKFBX0sM = animatedContentMeasurePolicy.m61759a().getContentAlignment$animation_release().mo71407alignKFBX0sM(IntSizeKt.IntSize(placeable.getWidth(), placeable.getHeight()), IntSizeKt.IntSize(i, i2), LayoutDirection.Ltr);
                Placeable.PlacementScope.place$default(layout, placeable, IntOffset.m73776getXimpl(mo71407alignKFBX0sM), IntOffset.m73777getYimpl(mo71407alignKFBX0sM), 0.0f, 4, null);
            }
        }
    }
}
