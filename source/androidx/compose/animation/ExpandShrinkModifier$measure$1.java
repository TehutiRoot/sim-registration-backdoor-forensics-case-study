...
public final class ExpandShrinkModifier$measure$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke2(@NotNull Placeable.PlacementScope layout) {
        ...
        Placeable.PlacementScope.place$default(layout, this.$placeable, IntOffset.m73776getXimpl(this.$offset) + IntOffset.m73776getXimpl(this.$offsetDelta), IntOffset.m73777getYimpl(this.$offset) + IntOffset.m73777getYimpl(this.$offsetDelta), 0.0f, 4, null);
    }
}
