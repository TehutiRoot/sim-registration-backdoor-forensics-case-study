...
public final class AnimatedVisibilityKt$AnimatedVisibility$6 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public AnimatedVisibilityKt$AnimatedVisibility$6(ColumnScope columnScope, boolean z, Modifier modifier, EnterTransition enterTransition, ExitTransition exitTransition, String str, Function3<? super AnimatedVisibilityScope, ? super Composer, ? super Integer, Unit> function3, int i, int i2) {
        super(2);
