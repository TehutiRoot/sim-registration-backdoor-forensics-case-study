...
public final class ChangeSize {
    ...
    /* loaded from: classes.dex */
    public static final class C27281 extends Lambda implements Function1<IntSize, IntSize> {
        public static final C27281 INSTANCE = new C27281();
        ...
        public /* bridge */ /* synthetic */ IntSize invoke(IntSize intSize) {
            return IntSize.m73810boximpl(m69215invokemzRDjE0(intSize.m73822unboximpl()));
        }

        /* renamed from: invoke-mzRDjE0  reason: not valid java name */
        public final long m69215invokemzRDjE0(long j) {
    ...
    public static /* synthetic */ ChangeSize copy$default(ChangeSize changeSize, Alignment alignment, Function1 function1, FiniteAnimationSpec finiteAnimationSpec, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
            alignment = changeSize.f12353a;
        }
        if ((i & 2) != 0) {
            function1 = changeSize.f12354b;
        }
        if ((i & 4) != 0) {
            finiteAnimationSpec = changeSize.f12355c;
        }
        if ((i & 8) != 0) {
            z = changeSize.f12356d;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof ChangeSize) {
            ...
            return Intrinsics.areEqual(this.f12353a, changeSize.f12353a) && Intrinsics.areEqual(this.f12354b, changeSize.f12354b) && Intrinsics.areEqual(this.f12355c, changeSize.f12355c) && this.f12356d == changeSize.f12356d;
        }
        return false;
    }
    ...
    public String toString() {
        return "ChangeSize(alignment=" + this.f12353a + ", size=" + this.f12354b + ", animationSpec=" + this.f12355c + ", clip=" + this.f12356d + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
    ...
    public /* synthetic */ ChangeSize(Alignment alignment, Function1 function1, FiniteAnimationSpec finiteAnimationSpec, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(alignment, (i & 2) != 0 ? C27281.INSTANCE : function1, finiteAnimationSpec, (i & 8) != 0 ? true : z);
    }
}
