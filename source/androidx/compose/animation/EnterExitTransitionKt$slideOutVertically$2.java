...
public final class EnterExitTransitionKt$slideOutVertically$2 extends Lambda implements Function1<IntSize, IntOffset> {
    ...
    public /* bridge */ /* synthetic */ IntOffset invoke(IntSize intSize) {
        return IntOffset.m73767boximpl(m69233invokemHKZG7I(intSize.m73822unboximpl()));
    }

    /* renamed from: invoke-mHKZG7I  reason: not valid java name */
    public final long m69233invokemHKZG7I(long j) {
        return IntOffsetKt.IntOffset(0, this.$targetOffsetY.invoke(Integer.valueOf(IntSize.m73817getHeightimpl(j))).intValue());
    }
}
