...
@Metadata(m28851d1 = {"\u0000\u0012\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\b\u0012\u0004\u0012\u00020\u00020\u0001\"\u0004\b\u0000\u0010\u0003*\b\u0012\u0004\u0012\u0002H\u00030\u0004H\n¢\u0006\u0002\b\u0005"}, m28850d2 = {"<anonymous>", "Landroidx/compose/animation/core/FiniteAnimationSpec;", "Landroidx/compose/ui/unit/IntSize;", "S", "Landroidx/compose/animation/core/Transition$Segment;", "invoke"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
...
public final class AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$1 extends Lambda implements Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>> {
    ...
    public final FiniteAnimationSpec<IntSize> invoke(@NotNull Transition.Segment<S> animate) {
        FiniteAnimationSpec<IntSize> mo69181createAnimationSpecTemP2vQ;
        ...
        long m73822unboximpl2 = state2 != null ? ((IntSize) state2.getValue()).m73822unboximpl() : IntSize.Companion.m73823getZeroYbymL2g();
        SizeTransform sizeTransform = (SizeTransform) this.this$1.m61750c().getValue();
        return (sizeTransform == null || (mo69181createAnimationSpecTemP2vQ = sizeTransform.mo69181createAnimationSpecTemP2vQ(m73822unboximpl, m73822unboximpl2)) == null) ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : mo69181createAnimationSpecTemP2vQ;
    }
}
