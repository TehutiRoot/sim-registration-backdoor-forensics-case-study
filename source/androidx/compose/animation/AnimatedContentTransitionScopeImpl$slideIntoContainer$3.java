...
public final class AnimatedContentTransitionScopeImpl$slideIntoContainer$3 extends Lambda implements Function1<Integer, Integer> {
    ...
    public final Integer invoke(int i) {
        ...
        int m73817getHeightimpl = IntSize.m73817getHeightimpl(m61753d);
        AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl = this.this$0;
        long IntSize = IntSizeKt.IntSize(i, i);
        m61753d2 = this.this$0.m61753d();
        m61756a = animatedContentTransitionScopeImpl.m61756a(IntSize, m61753d2);
        return function1.invoke(Integer.valueOf(m73817getHeightimpl - IntOffset.m73777getYimpl(m61756a)));
    }
}
