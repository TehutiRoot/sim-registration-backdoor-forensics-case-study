...
public final class AnimatedVectorPainterResources_androidKt {
    ...
    public static final Painter m61658a(AnimatedImageVector animatedImageVector, boolean z, Function4 function4, Composer composer, int i) {
        ...
        VectorPainter m72265rememberVectorPaintervIP8VLU = VectorPainterKt.m72265rememberVectorPaintervIP8VLU(animatedImageVector.getImageVector().m72245getDefaultWidthD9Ej5fM(), animatedImageVector.getImageVector().m72244getDefaultHeightD9Ej5fM(), animatedImageVector.getImageVector().getViewportWidth(), animatedImageVector.getImageVector().getViewportHeight(), animatedImageVector.getImageVector().getName(), animatedImageVector.getImageVector().m72247getTintColor0d7_KjU(), animatedImageVector.getImageVector().m72246getTintBlendMode0nO6VwU(), true, ComposableLambdaKt.composableLambda(composer, 10512245, true, new C2754xeaba97da(z, animatedImageVector, i, function4)), composer, 113246208, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final Painter rememberAnimatedVectorPainter(@NotNull AnimatedImageVector animatedImageVector, boolean z, @Nullable Composer composer, int i) {
        ...
        Painter m61658a = m61658a(animatedImageVector, z, ComposableSingletons$AnimatedVectorPainterResources_androidKt.INSTANCE.m69309getLambda1$animation_graphics_release(), composer, (i & 112) | (i & 14) | 384);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
