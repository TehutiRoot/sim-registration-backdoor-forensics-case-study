...
@Metadata(m28851d1 = {"\u0000\u0018\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010!\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\u0010\u0000\u001a\u00020\u00012\b\u0010\u0002\u001a\u0004\u0018\u00010\u00012\u0012\u0010\u0003\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00060\u00050\u0004H\n¢\u0006\u0002\b\u0007"}, m28850d2 = {"<anonymous>", "Landroidx/compose/animation/graphics/vector/compat/ValueType;", "valueType", "keyframes", "", "Landroidx/compose/animation/graphics/vector/Keyframe;", "", "invoke"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    public final ValueType invoke(@Nullable ValueType valueType, @NotNull List<Keyframe<Object>> keyframes) {
        ...
        while (!XmlPullParserUtils_androidKt.isAtEnd(xmlPullParser) && (xmlPullParser.getEventType() != 3 || !Intrinsics.areEqual(xmlPullParser.getName(), "propertyValuesHolder"))) {
            if (xmlPullParser.getEventType() == 2 && Intrinsics.areEqual(xmlPullParser.getName(), "keyframe")) {
                m61645g = XmlAnimatorParser_androidKt.m61645g(resources, theme, attributeSet, valueType, easing);
                Keyframe<Object> keyframe = (Keyframe) m61645g.component1();
                ValueType valueType4 = (ValueType) m61645g.component2();
                if (valueType3 == null) {
        ...
        if (valueType3 == null) {
            if (valueType == null) {
                valueType2 = XmlAnimatorParser_androidKt.f12753a;
                return valueType2;
            }
            return valueType;
        }
