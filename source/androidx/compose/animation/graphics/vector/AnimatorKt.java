...
@Metadata(m28851d1 = {"\u0000\u001c\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0007\n\u0002\b\u0005\n\u0002\u0010\b\n\u0002\b\u0003\u001a9\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00010\u00002\f\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00010\u00002\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00010\u00002\u0006\u0010\u0005\u001a\u00020\u0004H\u0002¢\u0006\u0004\b\u0006\u0010\u0007\u001a'\u0010\b\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00012\u0006\u0010\u0003\u001a\u00020\u00012\u0006\u0010\u0005\u001a\u00020\u0004H\u0002¢\u0006\u0004\b\b\u0010\t\"\u0014\u0010\u000b\u001a\u00020\n8\u0000X\u0080T¢\u0006\u0006\n\u0004\b\u000b\u0010\f¨\u0006\r"}, m28850d2 = {"", "Landroidx/compose/ui/graphics/vector/PathNode;", "start", "stop", "", "fraction", OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, "(Ljava/util/List;Ljava/util/List;F)Ljava/util/List;", PDPageLabelRange.STYLE_LETTERS_LOWER, "(Landroidx/compose/ui/graphics/vector/PathNode;Landroidx/compose/ui/graphics/vector/PathNode;F)Landroidx/compose/ui/graphics/vector/PathNode;", "", "RepeatCountInfinite", "I", "animation-graphics_release"}, m28849k = 2, m28848mv = {1, 8, 0})
...
public final class AnimatorKt {
    ...
    /* renamed from: a */
    public static final PathNode m61656a(PathNode pathNode, PathNode pathNode2, float f) {
    ...
    /* renamed from: b */
    public static final List m61655b(List list, List list2, float f) {
        List list3 = list;
        Iterator it = list3.iterator();
        List list4 = list2;
        Iterator it2 = list4.iterator();
        ArrayList arrayList = new ArrayList(Math.min(AbstractC10176es.collectionSizeOrDefault(list3, 10), AbstractC10176es.collectionSizeOrDefault(list4, 10)));
        while (it.hasNext() && it2.hasNext()) {
            arrayList.add(m61656a((PathNode) it.next(), (PathNode) it2.next(), f));
        }
        return arrayList;
    }
}
