...
@Metadata(m28851d1 = {"\u0000\f\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\b\u0012\u0004\u0012\u00020\u00020\u0001H\n¢\u0006\u0002\b\u0003"}, m28850d2 = {"<anonymous>", "", "Landroidx/compose/ui/graphics/vector/PathNode;", "invoke"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
...
public final class PathPropertyValues$createState$1$1 extends Lambda implements Function0<List<? extends PathNode>> {
    ...
    public final List<? extends PathNode> invoke() {
        List<? extends PathNode> m61653b;
        m61653b = this.this$0.m61653b(this.$timeState.getValue().floatValue());
        return m61653b;
    }
}
