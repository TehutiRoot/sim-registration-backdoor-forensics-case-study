...
public final class FloatSpringSpec implements FloatAnimationSpec {
    ...
    /* renamed from: d */
    public final SpringSimulation f12525d;
    ...
    public long getDurationNanos(float f, float f2, float f3) {
        float stiffness = this.f12525d.getStiffness();
        float dampingRatio = this.f12525d.getDampingRatio();
        float f4 = f - f2;
    ...
    public float getValueFromNanos(long j, float f, float f2, float f3) {
        this.f12525d.setFinalPosition(f2);
        return Motion.m69272getValueimpl(this.f12525d.m69278updateValuesIJZedt4$animation_core_release(f, f3, j / 1000000));
    }

    @Override // androidx.compose.animation.core.FloatAnimationSpec
    public float getVelocityFromNanos(long j, float f, float f2, float f3) {
        this.f12525d.setFinalPosition(f2);
        return Motion.m69273getVelocityimpl(this.f12525d.m69278updateValuesIJZedt4$animation_core_release(f, f3, j / 1000000));
    }
