...
public final class AnimateAsStateKt {
    ...
    public static final State<C3641Dp> m69251animateDpAsStateAjpBEmI(float f, @Nullable AnimationSpec<C3641Dp> animationSpec, @Nullable String str, @Nullable Function1<? super C3641Dp, Unit> function1, @Nullable Composer composer, int i, int i2) {
        SpringSpec springSpec;
        String str2;
        Function1<? super C3641Dp, Unit> function12;
        ...
        int i3 = i << 6;
        State<C3641Dp> animateValueAsState = animateValueAsState(C3641Dp.m73656boximpl(f), VectorConvertersKt.getVectorConverter(C3641Dp.Companion), springSpec, null, str2, function12, composer, (i & 14) | ((i << 3) & 896) | (57344 & i3) | (i3 & 458752), 8);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final /* synthetic */ State m69252animateDpAsStateKz89ssw(float f, AnimationSpec animationSpec, Function1 function1, Composer composer, int i, int i2) {
        composer.startReplaceableGroup(704104481);
        if ((i2 & 2) != 0) {
            animationSpec = f12422b;
        }
        ...
        State animateValueAsState = animateValueAsState(C3641Dp.m73656boximpl(f), VectorConvertersKt.getVectorConverter(C3641Dp.Companion), animationSpec2, null, null, function12, composer, (i & 14) | ((i << 3) & 896) | ((i << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final State<Float> animateFloatAsState(float f, @Nullable AnimationSpec<Float> animationSpec, float f2, @Nullable String str, @Nullable Function1<? super Float, Unit> function1, @Nullable Composer composer, int i, int i2) {
        ...
        AnimationSpec<Float> animationSpec2 = (i2 & 2) != 0 ? f12421a : animationSpec;
    ...
    public static final State<Integer> animateIntAsState(int i, @Nullable AnimationSpec<Integer> animationSpec, @Nullable String str, @Nullable Function1<? super Integer, Unit> function1, @Nullable Composer composer, int i2, int i3) {
        ...
        SpringSpec springSpec = (i3 & 2) != 0 ? f12426f : animationSpec;
    ...
    public static final /* synthetic */ State m69253animateIntOffsetAsState8f6pmRE(long j, AnimationSpec animationSpec, Function1 function1, Composer composer, int i, int i2) {
        SpringSpec springSpec;
        ...
        State animateValueAsState = animateValueAsState(IntOffset.m73767boximpl(j), VectorConvertersKt.getVectorConverter(IntOffset.Companion), springSpec, null, null, function12, composer, (i & 14) | ((i << 3) & 896) | ((i << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final State<IntOffset> m69254animateIntOffsetAsStateHyPO7BM(long j, @Nullable AnimationSpec<IntOffset> animationSpec, @Nullable String str, @Nullable Function1<? super IntOffset, Unit> function1, @Nullable Composer composer, int i, int i2) {
        SpringSpec springSpec;
        String str2;
        ...
        int i3 = i << 6;
        State<IntOffset> animateValueAsState = animateValueAsState(IntOffset.m73767boximpl(j), VectorConvertersKt.getVectorConverter(IntOffset.Companion), springSpec, null, str2, function12, composer, (i & 14) | ((i << 3) & 896) | (57344 & i3) | (i3 & 458752), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final State<IntSize> m69255animateIntSizeAsState4goxYXU(long j, @Nullable AnimationSpec<IntSize> animationSpec, @Nullable String str, @Nullable Function1<? super IntSize, Unit> function1, @Nullable Composer composer, int i, int i2) {
        SpringSpec springSpec;
        String str2;
        ...
        int i3 = i << 6;
        State<IntSize> animateValueAsState = animateValueAsState(IntSize.m73810boximpl(j), VectorConvertersKt.getVectorConverter(IntSize.Companion), springSpec, null, str2, function12, composer, (i & 14) | ((i << 3) & 896) | (57344 & i3) | (i3 & 458752), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m69256animateIntSizeAsStatezTRF_AQ(long j, AnimationSpec animationSpec, Function1 function1, Composer composer, int i, int i2) {
        SpringSpec springSpec;
        Function1 function12;
        ...
        State animateValueAsState = animateValueAsState(IntSize.m73810boximpl(j), VectorConvertersKt.getVectorConverter(IntSize.Companion), springSpec, null, null, function12, composer, (i & 14) | ((i << 3) & 896) | ((i << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final State<Offset> m69257animateOffsetAsState7362WCg(long j, @Nullable AnimationSpec<Offset> animationSpec, @Nullable String str, @Nullable Function1<? super Offset, Unit> function1, @Nullable Composer composer, int i, int i2) {
        SpringSpec springSpec;
        String str2;
        ...
        int i3 = i << 6;
        State<Offset> animateValueAsState = animateValueAsState(Offset.m71491boximpl(j), VectorConvertersKt.getVectorConverter(Offset.Companion), springSpec, null, str2, function12, composer, (i & 14) | ((i << 3) & 896) | (57344 & i3) | (i3 & 458752), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m69258animateOffsetAsStateN6fFfp4(long j, AnimationSpec animationSpec, Function1 function1, Composer composer, int i, int i2) {
        SpringSpec springSpec;
        Function1 function12;
        ...
        State animateValueAsState = animateValueAsState(Offset.m71491boximpl(j), VectorConvertersKt.getVectorConverter(Offset.Companion), springSpec, null, null, function12, composer, (i & 14) | ((i << 3) & 896) | ((i << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final State<Rect> animateRectAsState(@NotNull Rect targetValue, @Nullable AnimationSpec<Rect> animationSpec, @Nullable String str, @Nullable Function1<? super Rect, Unit> function1, @Nullable Composer composer, int i, int i2) {
        ...
        SpringSpec springSpec = (i2 & 2) != 0 ? f12425e : animationSpec;
    ...
    public static final /* synthetic */ State m69259animateSizeAsStateLjSzlW0(long j, AnimationSpec animationSpec, Function1 function1, Composer composer, int i, int i2) {
        SpringSpec springSpec;
        Function1 function12;
        ...
        State animateValueAsState = animateValueAsState(Size.m71559boximpl(j), VectorConvertersKt.getVectorConverter(Size.Companion), springSpec, null, null, function12, composer, (i & 14) | ((i << 3) & 896) | ((i << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final State<Size> m69260animateSizeAsStateYLp_XPw(long j, @Nullable AnimationSpec<Size> animationSpec, @Nullable String str, @Nullable Function1<? super Size, Unit> function1, @Nullable Composer composer, int i, int i2) {
        SpringSpec springSpec;
        String str2;
        ...
        int i3 = i << 6;
        State<Size> animateValueAsState = animateValueAsState(Size.m71559boximpl(j), VectorConvertersKt.getVectorConverter(Size.Companion), springSpec, null, str2, function12, composer, (i & 14) | ((i << 3) & 896) | (57344 & i3) | (i3 & 458752), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    /* renamed from: b */
    public static final AnimationSpec m61703b(State state) {
