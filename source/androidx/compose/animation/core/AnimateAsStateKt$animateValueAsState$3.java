...
/*  JADX ERROR: JadxRuntimeException in pass: ClassModifier
    ...
    */
@Metadata(m28851d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\b\b\u0001\u0010\u0003*\u00020\u0004*\u00020\u0005H\u008a@"}, m28850d2 = {"<anonymous>", "", "T", ExifInterface.GPS_MEASUREMENT_INTERRUPTED, "Landroidx/compose/animation/core/AnimationVector;", "Lkotlinx/coroutines/CoroutineScope;"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
@DebugMetadata(m28801c = "androidx.compose.animation.core.AnimateAsStateKt$animateValueAsState$3", m28800f = "AnimateAsState.kt", m28799i = {0}, m28798l = {HttpStatus.SC_INSUFFICIENT_SPACE_ON_RESOURCE}, m28797m = "invokeSuspend", m28796n = {"$this$LaunchedEffect"}, m28795s = {"L$0"})
...
public final class AnimateAsStateKt$animateValueAsState$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    @Metadata(m28851d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\b\b\u0001\u0010\u0003*\u00020\u0004*\u00020\u0005H\u008a@"}, m28850d2 = {"<anonymous>", "", "T", ExifInterface.GPS_MEASUREMENT_INTERRUPTED, "Landroidx/compose/animation/core/AnimationVector;", "Lkotlinx/coroutines/CoroutineScope;"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
    @DebugMetadata(m28801c = "androidx.compose.animation.core.AnimateAsStateKt$animateValueAsState$3$1", m28800f = "AnimateAsState.kt", m28799i = {}, m28798l = {428}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
    /* renamed from: androidx.compose.animation.core.AnimateAsStateKt$animateValueAsState$3$1 */
    /* loaded from: classes.dex */
    public static final class C27331 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ State<AnimationSpec<T>> $animSpec$delegate;
        final /* synthetic */ Animatable<T, V> $animatable;
        final /* synthetic */ State<Function1<T, Unit>> $listener$delegate;
        ...
        public C27331(T t, Animatable<T, V> animatable, State<? extends AnimationSpec<T>> state, State<? extends Function1<? super T, Unit>> state2, Continuation<? super C27331> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C27331(this.$newTarget, this.$animatable, this.$animSpec$delegate, this.$listener$delegate, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i != 0) {
                ...
                if (!Intrinsics.areEqual(this.$newTarget, this.$animatable.getTargetValue())) {
                    ...
                    m61703b = AnimateAsStateKt.m61703b(this.$animSpec$delegate);
                    this.label = 1;
                    if (Animatable.animateTo$default(animatable, obj2, m61703b, null, null, this, 12, null) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                }
                return Unit.INSTANCE;
            }
            m61704a = AnimateAsStateKt.m61704a(this.$listener$delegate);
            if (m61704a != null) {
                m61704a.invoke(this.$animatable.getValue());
            }
            return Unit.INSTANCE;
        }
    ...
    */
    public final java.lang.Object invokeSuspend(@org.jetbrains.annotations.NotNull java.lang.Object r14) {
        ...
        L3d:
            ...
            java.lang.Object r5 = r5.mo74669tryReceivePtdJZtk()
            java.lang.Object r5 = kotlinx.coroutines.channels.ChannelResult.m74679getOrNullimpl(r5)
            if (r5 != 0) goto L57
            r7 = r4
            goto L58
        L57:
