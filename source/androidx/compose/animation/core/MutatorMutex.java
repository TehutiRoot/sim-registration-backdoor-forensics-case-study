...
public final class MutatorMutex {
    ...
    public static final class C2744a {
        ...
        /* renamed from: a */
        public final MutatePriority f12562a;

        /* renamed from: b */
        public final Job f12563b;

        public C2744a(MutatePriority priority, Job job) {
            Intrinsics.checkNotNullParameter(priority, "priority");
            Intrinsics.checkNotNullParameter(job, "job");
            this.f12562a = priority;
            this.f12563b = job;
        }

        /* renamed from: a */
        public final boolean m61692a(C2744a other) {
            Intrinsics.checkNotNullParameter(other, "other");
            if (this.f12562a.compareTo(other.f12562a) >= 0) {
                return true;
            }
            return false;
        }
        ...
        /* renamed from: b */
        public final void m61691b() {
            this.f12563b.cancel((CancellationException) new MutationInterruptedException());
        }
    }
    ...
    /* renamed from: a */
    public final void m61693a(C2744a c2744a) {
        C2744a c2744a2;
        do {
            c2744a2 = (C2744a) this.f12560a.get();
            if (c2744a2 != null && !c2744a.m61692a(c2744a2)) {
                throw new CancellationException("Current mutation had a higher priority");
            }
        } while (!AbstractC17300An1.m69050a(this.f12560a, c2744a2, c2744a));
        if (c2744a2 != null) {
            c2744a2.m61691b();
        }
    }
