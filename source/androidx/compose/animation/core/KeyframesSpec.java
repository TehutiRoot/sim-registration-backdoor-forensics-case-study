...
public final class KeyframesSpec<T> implements DurationBasedAnimationSpec<T> {
    ...
    public static final class KeyframesSpecConfig<T> {
        ...
        /* renamed from: a */
        public int f12553a = 300;

        /* renamed from: c */
        public final Map f12555c = new LinkedHashMap();

        @NotNull
        /* renamed from: at */
        public final KeyframeEntity<T> m61694at(T t, int i) {
            KeyframeEntity<T> keyframeEntity = new KeyframeEntity<>(t, null, 2, null);
            this.f12555c.put(Integer.valueOf(i), keyframeEntity);
            return keyframeEntity;
        }

        @NotNull
        public final KeyframeEntity<T> atFraction(T t, float f) {
            return m61694at(t, AbstractC21140mr0.roundToInt(this.f12553a * f));
        }

        public boolean equals(@Nullable Object obj) {
            if (obj instanceof KeyframesSpecConfig) {
                KeyframesSpecConfig keyframesSpecConfig = (KeyframesSpecConfig) obj;
                if (this.f12554b == keyframesSpecConfig.f12554b && this.f12553a == keyframesSpecConfig.f12553a && Intrinsics.areEqual(this.f12555c, keyframesSpecConfig.f12555c)) {
                    return true;
                }
            }
            return false;
        ...
        public int hashCode() {
            return (((this.f12553a * 31) + this.f12554b) * 31) + this.f12555c.hashCode();
        }
    ...
    public boolean equals(@Nullable Object obj) {
        if ((obj instanceof KeyframesSpec) && Intrinsics.areEqual(this.f12550a, ((KeyframesSpec) obj).f12550a)) {
            return true;
        }
        return false;
    }
    ...
    public static final class KeyframeEntity<T> {
        ...
        public boolean equals(@Nullable Object obj) {
            if (obj instanceof KeyframeEntity) {
                ...
                if (Intrinsics.areEqual(keyframeEntity.f12551a, this.f12551a) && Intrinsics.areEqual(keyframeEntity.f12552b, this.f12552b)) {
                    return true;
                }
            }
            return false;
        ...
        public final T getValue$animation_core_release() {
            return (T) this.f12551a;
        }

        public int hashCode() {
            int i;
            Object obj = this.f12551a;
            if (obj != null) {
                i = obj.hashCode();
            } else {
                i = 0;
            }
            return (i * 31) + this.f12552b.hashCode();
        }
        ...
        public final <V extends AnimationVector> Pair<V, Easing> toPair$animation_core_release(@NotNull Function1<? super T, ? extends V> convertToVector) {
            ...
            return TuplesKt.m28844to(convertToVector.invoke((Object) this.f12551a), this.f12552b);
        }
    ...
    public <V extends AnimationVector> VectorizedKeyframesSpec<V> vectorize(@NotNull TwoWayConverter<T, V> converter) {
        ...
        Map<Integer, KeyframeEntity<T>> keyframes$animation_core_release = this.f12550a.getKeyframes$animation_core_release();
        LinkedHashMap linkedHashMap = new LinkedHashMap(AbstractC18515Tn0.mapCapacity(keyframes$animation_core_release.size()));
        ...
        return new VectorizedKeyframesSpec<>(linkedHashMap, this.f12550a.getDurationMillis(), this.f12550a.getDelayMillis());
    }
}
