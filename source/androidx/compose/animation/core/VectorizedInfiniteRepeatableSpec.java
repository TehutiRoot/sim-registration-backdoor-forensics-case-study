...
public final class VectorizedInfiniteRepeatableSpec<V extends AnimationVector> implements VectorizedAnimationSpec<V> {
    ...
    /* renamed from: a */
    private final long m61663a(long j) {
        long j2 = this.f12657d;
        if (j + j2 <= 0) {
            return 0L;
        }
        long j3 = j + j2;
        long j4 = this.f12656c;
        long j5 = j3 / j4;
        if (this.f12655b != RepeatMode.Restart && j5 % 2 != 0) {
            return ((j5 + 1) * j4) - j3;
        }
        Long.signum(j5);
        return j3 - (j5 * j4);
    ...
    /* renamed from: b */
    private final AnimationVector m61662b(long j, AnimationVector animationVector, AnimationVector animationVector2, AnimationVector animationVector3) {
        long j2 = this.f12657d;
    ...
    public V getValueFromNanos(long j, @NotNull V initialValue, @NotNull V targetValue, @NotNull V initialVelocity) {
        ...
        Intrinsics.checkNotNullParameter(targetValue, "targetValue");
        Intrinsics.checkNotNullParameter(initialVelocity, "initialVelocity");
        return (V) this.f12654a.getValueFromNanos(m61663a(j), initialValue, targetValue, m61662b(j, initialValue, initialVelocity, targetValue));
    }
    ...
    public V getVelocityFromNanos(long j, @NotNull V initialValue, @NotNull V targetValue, @NotNull V initialVelocity) {
        ...
        Intrinsics.checkNotNullParameter(targetValue, "targetValue");
        Intrinsics.checkNotNullParameter(initialVelocity, "initialVelocity");
        return (V) this.f12654a.getVelocityFromNanos(m61663a(j), initialValue, targetValue, m61662b(j, initialValue, initialVelocity, targetValue));
    }
    ...
    public VectorizedInfiniteRepeatableSpec(VectorizedDurationBasedAnimationSpec animation, RepeatMode repeatMode, long j) {
        ...
        this.f12655b = repeatMode;
        this.f12656c = (animation.getDelayMillis() + animation.getDurationMillis()) * 1000000;
        this.f12657d = j * 1000000;
    }
    ...
    public /* synthetic */ VectorizedInfiniteRepeatableSpec(VectorizedDurationBasedAnimationSpec vectorizedDurationBasedAnimationSpec, RepeatMode repeatMode, long j, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(vectorizedDurationBasedAnimationSpec, (i & 2) != 0 ? RepeatMode.Restart : repeatMode, (i & 4) != 0 ? StartOffset.m69281constructorimpl$default(0, 0, 2, null) : j, (DefaultConstructorMarker) null);
    }
