...
public final class AnimationVector1D extends AnimationVector {
    ...
    public boolean equals(@Nullable Object obj) {
        if ((obj instanceof AnimationVector1D) && ((AnimationVector1D) obj).f12446a == this.f12446a) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return "AnimationVector1D: value = " + this.f12446a;
    }
