...
public final class InfiniteTransitionKt {
    ...
    @Composable
    @NotNull
    public static final <T, V extends AnimationVector> State<T> animateValue(@NotNull InfiniteTransition infiniteTransition, T t, T t2, @NotNull TwoWayConverter<T, V> typeConverter, @NotNull InfiniteRepeatableSpec<T> animationSpec, @Nullable String str, @Nullable Composer composer, int i, int i2) {
        Intrinsics.checkNotNullParameter(infiniteTransition, "<this>");
