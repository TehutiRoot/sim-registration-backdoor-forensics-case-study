...
@Metadata(m28851d1 = {"\u0000\u0016\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\b\b\u0001\u0010\u0003*\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\n¢\u0006\u0002\b\u0007"}, m28850d2 = {"<anonymous>", "", "T", ExifInterface.GPS_MEASUREMENT_INTERRUPTED, "Landroidx/compose/animation/core/AnimationVector;", "it", "", "invoke"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
...
public final class SuspendAnimationKt$animate$6 extends Lambda implements Function1<Long, Unit> {
    ...
    /* loaded from: classes.dex */
    public static final class C27461 extends Lambda implements Function0<Unit> {
        final /* synthetic */ AnimationState<T, V> $this_animate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C27461(AnimationState<T, V> animationState) {
            super(0);
    ...
    public final void invoke(long j) {
        ...
        ?? animationScope = new AnimationScope(this.$initialValue, this.$animation.getTypeConverter(), this.$initialVelocityVector, j, this.$animation.getTargetValue(), j, true, new C27461(this.$this_animate));
        SuspendAnimationKt.m61680c(animationScope, j, this.$durationScale, this.$animation, this.$this_animate, this.$block);
