...
@DebugMetadata(m28801c = "androidx.compose.material.SwipeableState$animateInternalToOffset$2", m28800f = "Swipeable.kt", m28799i = {}, m28798l = {223}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
...
public final class SwipeableState$animateInternalToOffset$2 extends SuspendLambda implements Function2<DragScope, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes.dex */
    public static final class C31921 extends Lambda implements Function1<Animatable<Float, AnimationVector1D>, Unit> {
        final /* synthetic */ DragScope $$this$drag;
        final /* synthetic */ Ref.FloatRef $prevValue;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C31921(DragScope dragScope, Ref.FloatRef floatRef) {
            super(1);
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        try {
            if (i != 0) {
                ...
                mutableState2 = this.this$0.f14644h;
                mutableState2.setValue(Boxing.boxFloat(this.$target));
                this.this$0.m60796b(true);
                ...
                C31921 c31921 = new C31921(dragScope, floatRef);
                this.label = 1;
                if (Animatable.animateTo$default(Animatable$default, boxFloat, animationSpec, null, c31921, this, 4, null) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
            mutableState3 = this.this$0.f14644h;
            mutableState3.setValue(null);
            this.this$0.m60796b(false);
            return Unit.INSTANCE;
        } catch (Throwable th2) {
            mutableState = this.this$0.f14644h;
