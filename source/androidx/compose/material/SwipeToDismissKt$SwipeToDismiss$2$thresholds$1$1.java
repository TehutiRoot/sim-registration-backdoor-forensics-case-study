...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0003H\n¢\u0006\u0002\b\u0005"}, m28850d2 = {"<anonymous>", "Landroidx/compose/material/ThresholdConfig;", "from", "Landroidx/compose/material/DismissValue;", TypedValues.TransitionType.S_TO, "invoke"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
...
public final class SwipeToDismissKt$SwipeToDismiss$2$thresholds$1$1 extends Lambda implements Function2<DismissValue, DismissValue, ThresholdConfig> {
    ...
    public final ThresholdConfig invoke(@NotNull DismissValue from, @NotNull DismissValue to) {
        DismissDirection m60803a;
        Intrinsics.checkNotNullParameter(from, "from");
        Intrinsics.checkNotNullParameter(to, "to");
        Function1<DismissDirection, ThresholdConfig> function1 = this.$dismissThresholds;
        m60803a = SwipeToDismissKt.m60803a(from, to);
        Intrinsics.checkNotNull(m60803a);
        return function1.invoke(m60803a);
    }
}
