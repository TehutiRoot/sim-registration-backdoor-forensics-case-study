...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_autoFixOff", "Landroidx/compose/material/icons/Icons$TwoTone;", "getAutoFixOff", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "AutoFixOff", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nAutoFixOff.kt\nKotlin\n*S Kotlin\n*F\n+ 1 AutoFixOff.kt\nandroidx/compose/material/icons/twotone/AutoFixOffKt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,89:1\n122#2:90\n116#2,3:91\n119#2,3:95\n132#2,18:98\n152#2:135\n132#2,18:136\n152#2:173\n132#2,18:174\n152#2:211\n132#2,18:212\n152#2:249\n174#3:94\n694#4,2:116\n706#4,2:118\n708#4,11:124\n694#4,2:154\n706#4,2:156\n708#4,11:162\n694#4,2:192\n706#4,2:194\n708#4,11:200\n694#4,2:230\n706#4,2:232\n708#4,11:238\n64#5,4:120\n64#5,4:158\n64#5,4:196\n64#5,4:234\n*S KotlinDebug\n*F\n+ 1 AutoFixOff.kt\nandroidx/compose/material/icons/twotone/AutoFixOffKt\n*L\n29#1:90\n29#1:91,3\n29#1:95,3\n30#1:98,18\n30#1:135\n37#1:136,18\n37#1:173\n48#1:174,18\n48#1:211\n63#1:212,18\n63#1:249\n29#1:94\n30#1:116,2\n30#1:118,2\n30#1:124,11\n37#1:154,2\n37#1:156,2\n37#1:162,11\n48#1:192,2\n48#1:194,2\n48#1:200,11\n63#1:230,2\n63#1:232,2\n63#1:238,11\n30#1:120,4\n37#1:158,4\n48#1:196,4\n63#1:234,4\n*E\n"})
/* loaded from: classes.dex */
public final class AutoFixOffKt {

    /* renamed from: a */
    public static ImageVector f23429a;

    @NotNull
    public static final ImageVector getAutoFixOff(@NotNull Icons.TwoTone twoTone) {
        Intrinsics.checkNotNullParameter(twoTone, "<this>");
        ImageVector imageVector = f23429a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.AutoFixOff", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.moveTo(4.417f, 18.174f);
        pathBuilder.lineToRelative(5.466f, -5.466f);
        ...
        pathBuilder3.moveTo(14.17f, 8.42f);
        ...
        pathBuilder3.lineToRelative(-2.17f, 2.17f);
        pathBuilder3.lineToRelative(1.41f, 1.41f);
        pathBuilder3.lineTo(14.17f, 8.42f);
        pathBuilder3.close();
        ...
        pathBuilder4.lineToRelative(-6.17f, 6.17f);
        ...
        pathBuilder4.lineToRelative(-1.41f, -1.41f);
        pathBuilder4.lineToRelative(5.46f, -5.46f);
        pathBuilder4.lineToRelative(1.41f, 1.41f);
