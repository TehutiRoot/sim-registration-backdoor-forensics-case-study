...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_playLesson", "Landroidx/compose/material/icons/Icons$TwoTone;", "getPlayLesson", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "PlayLesson", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
...
public final class PlayLessonKt {
    ...
    /* renamed from: a */
    public static ImageVector f24667a;

    @NotNull
    public static final ImageVector getPlayLesson(@NotNull Icons.TwoTone twoTone) {
        Intrinsics.checkNotNullParameter(twoTone, "<this>");
        ImageVector imageVector = f24667a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.PlayLesson", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder2.verticalLineToRelative(7.08f);
        pathBuilder2.curveToRelative(0.33f, -0.05f, 0.66f, -0.08f, 1.0f, -0.08f);
        pathBuilder2.reflectiveCurveToRelative(0.67f, 0.03f, 1.0f, 0.08f);
        pathBuilder2.verticalLineTo(4.0f);
        ...
        pathBuilder2.curveToRelative(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        pathBuilder2.horizontalLineToRelative(7.26f);
        ...
        pathBuilder3.close();
        pathBuilder3.moveTo(16.75f, 20.5f);
        pathBuilder3.verticalLineToRelative(-5.0f);
        pathBuilder3.lineToRelative(4.0f, 2.5f);
        pathBuilder3.lineTo(16.75f, 20.5f);
        pathBuilder3.close();
