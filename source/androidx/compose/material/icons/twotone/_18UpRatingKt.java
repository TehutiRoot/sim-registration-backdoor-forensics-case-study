...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "__18UpRating", "Landroidx/compose/material/icons/Icons$TwoTone;", "get_18UpRating", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_18UpRating", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
...
public final class _18UpRatingKt {
    ...
    /* renamed from: a */
    public static ImageVector f25365a;

    @NotNull
    public static final ImageVector get_18UpRating(@NotNull Icons.TwoTone twoTone) {
        Intrinsics.checkNotNullParameter(twoTone, "<this>");
        ImageVector imageVector = f25365a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone._18UpRating", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder4.moveTo(8.5f, 15.0f);
        ...
        pathBuilder6.moveTo(12.5f, 15.0f);
        ...
        pathBuilder6.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilder6.verticalLineToRelative(4.0f);
        pathBuilder6.curveTo(11.5f, 14.55f, 11.95f, 15.0f, 12.5f, 15.0f);
        pathBuilder6.close();
        pathBuilder6.moveTo(13.0f, 10.0f);
        ...
        pathBuilder6.close();
        pathBuilder6.moveTo(13.0f, 12.5f);
        pathBuilder6.horizontalLineToRelative(1.5f);
        pathBuilder6.verticalLineTo(14.0f);
        pathBuilder6.horizontalLineTo(13.0f);
        pathBuilder6.verticalLineTo(12.5f);
        pathBuilder6.close();
