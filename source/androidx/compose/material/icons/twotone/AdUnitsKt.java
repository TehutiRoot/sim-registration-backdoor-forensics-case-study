...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_adUnits", "Landroidx/compose/material/icons/Icons$TwoTone;", "getAdUnits", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "AdUnits", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nAdUnits.kt\nKotlin\n*S Kotlin\n*F\n+ 1 AdUnits.kt\nandroidx/compose/material/icons/twotone/AdUnitsKt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,91:1\n122#2:92\n116#2,3:93\n119#2,3:97\n132#2,18:100\n152#2:137\n132#2,18:138\n152#2:175\n132#2,18:176\n152#2:213\n132#2,18:214\n152#2:251\n174#3:96\n694#4,2:118\n706#4,2:120\n708#4,11:126\n694#4,2:156\n706#4,2:158\n708#4,11:164\n694#4,2:194\n706#4,2:196\n708#4,11:202\n694#4,2:232\n706#4,2:234\n708#4,11:240\n64#5,4:122\n64#5,4:160\n64#5,4:198\n64#5,4:236\n*S KotlinDebug\n*F\n+ 1 AdUnits.kt\nandroidx/compose/material/icons/twotone/AdUnitsKt\n*L\n29#1:92\n29#1:93,3\n29#1:97,3\n30#1:100,18\n30#1:137\n37#1:138,18\n37#1:175\n44#1:176,18\n44#1:213\n78#1:214,18\n78#1:251\n29#1:96\n30#1:118,2\n30#1:120,2\n30#1:126,11\n37#1:156,2\n37#1:158,2\n37#1:164,11\n44#1:194,2\n44#1:196,2\n44#1:202,11\n78#1:232,2\n78#1:234,2\n78#1:240,11\n30#1:122,4\n37#1:160,4\n44#1:198,4\n78#1:236,4\n*E\n"})
/* loaded from: classes.dex */
public final class AdUnitsKt {

    /* renamed from: a */
    public static ImageVector f23295a;

    @NotNull
    public static final ImageVector getAdUnits(@NotNull Icons.TwoTone twoTone) {
        Intrinsics.checkNotNullParameter(twoTone, "<this>");
        ImageVector imageVector = f23295a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.AdUnits", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder3.lineTo(17.0f, 1.0f);
        pathBuilder3.close();
        pathBuilder3.moveTo(7.0f, 4.0f);
        pathBuilder3.verticalLineTo(3.0f);
        pathBuilder3.horizontalLineToRelative(10.0f);
        pathBuilder3.verticalLineToRelative(1.0f);
        pathBuilder3.horizontalLineTo(7.0f);
        pathBuilder3.lineTo(7.0f, 4.0f);
        pathBuilder3.close();
        ...
        pathBuilder3.horizontalLineTo(7.0f);
        pathBuilder3.lineTo(7.0f, 18.0f);
        pathBuilder3.close();
        pathBuilder3.moveTo(7.0f, 21.0f);
        pathBuilder3.verticalLineToRelative(-1.0f);
        pathBuilder3.horizontalLineToRelative(10.0f);
        pathBuilder3.verticalLineToRelative(1.0f);
        pathBuilder3.horizontalLineTo(7.0f);
        pathBuilder3.lineTo(7.0f, 21.0f);
        pathBuilder3.close();
        ...
        pathBuilder4.moveTo(16.0f, 7.0f);
