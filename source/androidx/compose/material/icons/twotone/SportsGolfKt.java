...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_sportsGolf", "Landroidx/compose/material/icons/Icons$TwoTone;", "getSportsGolf", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "SportsGolf", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nSportsGolf.kt\nKotlin\n*S Kotlin\n*F\n+ 1 SportsGolf.kt\nandroidx/compose/material/icons/twotone/SportsGolfKt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,107:1\n122#2:108\n116#2,3:109\n119#2,3:113\n132#2,18:116\n152#2:153\n132#2,18:154\n152#2:191\n132#2,18:192\n152#2:229\n132#2,18:230\n152#2:267\n132#2,18:268\n152#2:305\n132#2,18:306\n152#2:343\n174#3:112\n694#4,2:134\n706#4,2:136\n708#4,11:142\n694#4,2:172\n706#4,2:174\n708#4,11:180\n694#4,2:210\n706#4,2:212\n708#4,11:218\n694#4,2:248\n706#4,2:250\n708#4,11:256\n694#4,2:286\n706#4,2:288\n708#4,11:294\n694#4,2:324\n706#4,2:326\n708#4,11:332\n64#5,4:138\n64#5,4:176\n64#5,4:214\n64#5,4:252\n64#5,4:290\n64#5,4:328\n*S KotlinDebug\n*F\n+ 1 SportsGolf.kt\nandroidx/compose/material/icons/twotone/SportsGolfKt\n*L\n29#1:108\n29#1:109,3\n29#1:113,3\n30#1:116,18\n30#1:153\n56#1:154,18\n56#1:191\n70#1:192,18\n70#1:229\n76#1:230,18\n76#1:267\n82#1:268,18\n82#1:305\n88#1:306,18\n88#1:343\n29#1:112\n30#1:134,2\n30#1:136,2\n30#1:142,11\n56#1:172,2\n56#1:174,2\n56#1:180,11\n70#1:210,2\n70#1:212,2\n70#1:218,11\n76#1:248,2\n76#1:250,2\n76#1:256,11\n82#1:286,2\n82#1:288,2\n82#1:294,11\n88#1:324,2\n88#1:326,2\n88#1:332,11\n30#1:138,4\n56#1:176,4\n70#1:214,4\n76#1:252,4\n82#1:290,4\n88#1:328,4\n*E\n"})
/* loaded from: classes.dex */
public final class SportsGolfKt {

    /* renamed from: a */
    public static ImageVector f24997a;

    @NotNull
    public static final ImageVector getSportsGolf(@NotNull Icons.TwoTone twoTone) {
        Intrinsics.checkNotNullParameter(twoTone, "<this>");
        ImageVector imageVector = f24997a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.SportsGolf", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.reflectiveCurveTo(7.0f, 6.24f, 7.0f, 9.0f);
        pathBuilder.reflectiveCurveTo(9.24f, 14.0f, 12.0f, 14.0f);
        pathBuilder.close();
        ...
        pathBuilder.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        pathBuilder.reflectiveCurveToRelative(-1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilder.curveTo(11.0f, 5.45f, 11.45f, 5.0f, 12.0f, 5.0f);
        pathBuilder.close();
        pathBuilder.moveTo(10.0f, 7.0f);
        pathBuilder.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilder.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        pathBuilder.reflectiveCurveTo(9.0f, 8.55f, 9.0f, 8.0f);
        pathBuilder.curveTo(9.0f, 7.45f, 9.45f, 7.0f, 10.0f, 7.0f);
        pathBuilder.close();
        ...
        pathBuilder2.curveTo(5.0f, 12.87f, 8.13f, 16.0f, 12.0f, 16.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(12.0f, 4.0f);
        pathBuilder2.curveToRelative(2.76f, 0.0f, 5.0f, 2.24f, 5.0f, 5.0f);
        pathBuilder2.reflectiveCurveToRelative(-2.24f, 5.0f, -5.0f, 5.0f);
        pathBuilder2.reflectiveCurveToRelative(-5.0f, -2.24f, -5.0f, -5.0f);
        pathBuilder2.reflectiveCurveTo(9.24f, 4.0f, 12.0f, 4.0f);
        pathBuilder2.close();
        ...
        pathBuilder4.moveTo(14.0f, 8.0f);
        ...
        pathBuilder6.moveTo(7.0f, 19.0f);
