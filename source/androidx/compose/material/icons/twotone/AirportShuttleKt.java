...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_airportShuttle", "Landroidx/compose/material/icons/Icons$TwoTone;", "getAirportShuttle", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "AirportShuttle", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
...
public final class AirportShuttleKt {
    ...
    /* renamed from: a */
    public static ImageVector f23345a;

    @NotNull
    public static final ImageVector getAirportShuttle(@NotNull Icons.TwoTone twoTone) {
        Intrinsics.checkNotNullParameter(twoTone, "<this>");
        ImageVector imageVector = f23345a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.AirportShuttle", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.horizontalLineToRelative(7.56f);
        pathBuilder.curveToRelative(0.55f, -0.61f, 1.34f, -1.0f, 2.22f, -1.0f);
        pathBuilder.reflectiveCurveToRelative(1.67f, 0.39f, 2.22f, 1.0f);
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(6.0f, 17.25f);
        ...
        pathBuilder2.reflectiveCurveToRelative(-0.56f, 1.25f, -1.25f, 1.25f);
        pathBuilder2.close();
        pathBuilder2.moveTo(18.0f, 17.25f);
        pathBuilder2.curveToRelative(-0.69f, 0.0f, -1.25f, -0.56f, -1.25f, -1.25f);
        pathBuilder2.reflectiveCurveToRelative(0.56f, -1.25f, 1.25f, -1.25f);
        pathBuilder2.reflectiveCurveToRelative(1.25f, 0.56f, 1.25f, 1.25f);
        pathBuilder2.reflectiveCurveToRelative(-0.56f, 1.25f, -1.25f, 1.25f);
        ...
        pathBuilder2.lineTo(8.22f, 14.0f);
        pathBuilder2.curveToRelative(-0.55f, -0.61f, -1.33f, -1.0f, -2.22f, -1.0f);
        pathBuilder2.reflectiveCurveToRelative(-1.67f, 0.39f, -2.22f, 1.0f);
