...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_thumbUpOffAlt", "Landroidx/compose/material/icons/Icons$TwoTone;", "getThumbUpOffAlt", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "ThumbUpOffAlt", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
...
public final class ThumbUpOffAltKt {
    ...
    /* renamed from: a */
    public static ImageVector f25140a;

    @NotNull
    public static final ImageVector getThumbUpOffAlt(@NotNull Icons.TwoTone twoTone) {
        Intrinsics.checkNotNullParameter(twoTone, "<this>");
        ImageVector imageVector = f25140a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.ThumbUpOffAlt", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.moveTo(13.34f, 4.66f);
        ...
        pathBuilder.lineToRelative(-8.77f, 0.0f);
        pathBuilder.close();
        ...
        pathBuilder2.lineTo(7.59f, 7.59f);
        ...
        pathBuilder2.curveTo(22.95f, 12.5f, 23.0f, 12.26f, 23.0f, 12.0f);
        pathBuilder2.verticalLineToRelative(-2.0f);
        pathBuilder2.curveTo(23.0f, 8.9f, 22.1f, 8.0f, 21.0f, 8.0f);
        pathBuilder2.close();
        ...
        pathBuilder2.lineTo(12.23f, 10.0f);
