...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_transcribe", "Landroidx/compose/material/icons/Icons$TwoTone;", "getTranscribe", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "Transcribe", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
...
public final class TranscribeKt {
    ...
    /* renamed from: a */
    public static ImageVector f25171a;

    @NotNull
    public static final ImageVector getTranscribe(@NotNull Icons.TwoTone twoTone) {
        Intrinsics.checkNotNullParameter(twoTone, "<this>");
        ImageVector imageVector = f25171a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Transcribe", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder2.moveTo(14.48f, 17.34f);
        pathBuilder2.curveTo(13.29f, 16.73f, 11.37f, 16.0f, 9.0f, 16.0f);
        pathBuilder2.curveToRelative(-2.37f, 0.0f, -4.29f, 0.73f, -5.48f, 1.34f);
        pathBuilder2.curveTo(3.2f, 17.5f, 3.0f, 17.84f, 3.0f, 18.22f);
        pathBuilder2.verticalLineTo(19.0f);
        pathBuilder2.horizontalLineToRelative(12.0f);
        pathBuilder2.verticalLineToRelative(-0.78f);
        pathBuilder2.curveTo(15.0f, 17.84f, 14.8f, 17.5f, 14.48f, 17.34f);
        pathBuilder2.close();
        ...
        pathBuilder3.moveTo(17.93f, 2.0f);
        pathBuilder3.curveToRelative(-3.9f, 3.89f, -3.91f, 9.95f, 0.0f, 14.0f);
        pathBuilder3.lineToRelative(1.63f, -1.63f);
        pathBuilder3.curveToRelative(-2.77f, -3.02f, -2.77f, -7.56f, 0.0f, -10.74f);
        pathBuilder3.lineTo(17.93f, 2.0f);
        pathBuilder3.close();
        ...
        pathBuilder4.reflectiveCurveTo(5.0f, 6.79f, 5.0f, 9.0f);
        pathBuilder4.curveTo(5.0f, 11.21f, 6.79f, 13.0f, 9.0f, 13.0f);
        pathBuilder4.close();
        pathBuilder4.moveTo(9.0f, 7.0f);
        pathBuilder4.curveToRelative(1.1f, 0.0f, 2.0f, 0.9f, 2.0f, 2.0f);
        pathBuilder4.curveToRelative(0.0f, 1.1f, -0.9f, 2.0f, -2.0f, 2.0f);
        pathBuilder4.reflectiveCurveToRelative(-2.0f, -0.9f, -2.0f, -2.0f);
        pathBuilder4.curveTo(7.0f, 7.9f, 7.9f, 7.0f, 9.0f, 7.0f);
        pathBuilder4.close();
        ...
        pathBuilder5.moveTo(15.39f, 15.56f);
        pathBuilder5.curveTo(13.71f, 14.7f, 11.53f, 14.0f, 9.0f, 14.0f);
        pathBuilder5.curveToRelative(-2.53f, 0.0f, -4.71f, 0.7f, -6.39f, 1.56f);
        pathBuilder5.curveTo(1.61f, 16.07f, 1.0f, 17.1f, 1.0f, 18.22f);
        pathBuilder5.verticalLineTo(21.0f);
        pathBuilder5.horizontalLineToRelative(16.0f);
        pathBuilder5.verticalLineToRelative(-2.78f);
        pathBuilder5.curveTo(17.0f, 17.1f, 16.39f, 16.07f, 15.39f, 15.56f);
        pathBuilder5.close();
        pathBuilder5.moveTo(15.0f, 19.0f);
        ...
        pathBuilder5.curveTo(4.71f, 16.73f, 6.63f, 16.0f, 9.0f, 16.0f);
        pathBuilder5.curveToRelative(2.37f, 0.0f, 4.29f, 0.73f, 5.48f, 1.34f);
        pathBuilder5.curveTo(14.8f, 17.5f, 15.0f, 17.84f, 15.0f, 18.22f);
        ...
        pathBuilder6.moveTo(22.92f, 7.06f);
        pathBuilder6.lineToRelative(-1.68f, -1.69f);
        pathBuilder6.curveToRelative(-2.02f, 2.02f, -2.02f, 5.07f, 0.0f, 7.27f);
        pathBuilder6.lineToRelative(1.68f, -1.69f);
        pathBuilder6.curveTo(22.08f, 9.77f, 22.08f, 8.24f, 22.92f, 7.06f);
        pathBuilder6.close();
