...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_plagiarism", "Landroidx/compose/material/icons/Icons$TwoTone;", "getPlagiarism", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "Plagiarism", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
...
public final class PlagiarismKt {
    ...
    /* renamed from: a */
    public static ImageVector f24660a;

    @NotNull
    public static final ImageVector getPlagiarism(@NotNull Icons.TwoTone twoTone) {
        Intrinsics.checkNotNullParameter(twoTone, "<this>");
        ImageVector imageVector = f24660a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Plagiarism", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(13.97f, 11.03f);
        pathBuilder.curveToRelative(1.12f, 1.12f, 1.31f, 2.8f, 0.59f, 4.13f);
        pathBuilder.lineToRelative(1.88f, 1.88f);
        pathBuilder.lineToRelative(-1.41f, 1.41f);
        pathBuilder.lineToRelative(-1.88f, -1.88f);
        pathBuilder.curveToRelative(-1.33f, 0.71f, -3.01f, 0.53f, -4.13f, -0.59f);
        pathBuilder.curveToRelative(-1.37f, -1.37f, -1.37f, -3.58f, 0.0f, -4.95f);
        pathBuilder.curveTo(10.39f, 9.66f, 12.61f, 9.66f, 13.97f, 11.03f);
        pathBuilder.close();
        ...
        pathBuilder2.moveTo(11.5f, 13.5f);
        ...
        pathBuilder4.moveTo(9.03f, 11.03f);
        pathBuilder4.curveToRelative(-1.37f, 1.37f, -1.37f, 3.58f, 0.0f, 4.95f);
        pathBuilder4.curveToRelative(1.12f, 1.12f, 2.8f, 1.31f, 4.13f, 0.59f);
        ...
        pathBuilder4.curveTo(12.61f, 9.66f, 10.39f, 9.66f, 9.03f, 11.03f);
        pathBuilder4.close();
        pathBuilder4.moveTo(12.56f, 14.56f);
        pathBuilder4.curveToRelative(-0.59f, 0.59f, -1.54f, 0.59f, -2.12f, 0.0f);
        pathBuilder4.curveToRelative(-0.59f, -0.59f, -0.59f, -1.54f, 0.0f, -2.12f);
        pathBuilder4.curveToRelative(0.59f, -0.59f, 1.54f, -0.59f, 2.12f, 0.0f);
        pathBuilder4.curveTo(13.15f, 13.03f, 13.15f, 13.97f, 12.56f, 14.56f);
        pathBuilder4.close();
