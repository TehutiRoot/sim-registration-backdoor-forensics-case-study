...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_fiberNew", "Landroidx/compose/material/icons/Icons$TwoTone;", "getFiberNew", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "FiberNew", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nFiberNew.kt\nKotlin\n*S Kotlin\n*F\n+ 1 FiberNew.kt\nandroidx/compose/material/icons/twotone/FiberNewKt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,102:1\n122#2:103\n116#2,3:104\n119#2,3:108\n132#2,18:111\n152#2:148\n132#2,18:149\n152#2:186\n132#2,18:187\n152#2:224\n174#3:107\n694#4,2:129\n706#4,2:131\n708#4,11:137\n694#4,2:167\n706#4,2:169\n708#4,11:175\n694#4,2:205\n706#4,2:207\n708#4,11:213\n64#5,4:133\n64#5,4:171\n64#5,4:209\n*S KotlinDebug\n*F\n+ 1 FiberNew.kt\nandroidx/compose/material/icons/twotone/FiberNewKt\n*L\n29#1:103\n29#1:104,3\n29#1:108,3\n30#1:111,18\n30#1:148\n72#1:149,18\n72#1:186\n79#1:187,18\n79#1:224\n29#1:107\n30#1:129,2\n30#1:131,2\n30#1:137,11\n72#1:167,2\n72#1:169,2\n72#1:175,11\n79#1:205,2\n79#1:207,2\n79#1:213,11\n30#1:133,4\n72#1:171,4\n79#1:209,4\n*E\n"})
/* loaded from: classes.dex */
public final class FiberNewKt {

    /* renamed from: a */
    public static ImageVector f23948a;

    @NotNull
    public static final ImageVector getFiberNew(@NotNull Icons.TwoTone twoTone) {
        Intrinsics.checkNotNullParameter(twoTone, "<this>");
        ImageVector imageVector = f23948a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.FiberNew", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.moveTo(9.12f, 14.47f);
        pathBuilder.lineTo(9.12f, 9.53f);
        pathBuilder.lineTo(8.09f, 9.53f);
        pathBuilder.verticalLineToRelative(2.88f);
        pathBuilder.lineTo(6.03f, 9.53f);
        pathBuilder.lineTo(5.0f, 9.53f);
        pathBuilder.verticalLineToRelative(4.94f);
        pathBuilder.horizontalLineToRelative(1.03f);
        pathBuilder.verticalLineToRelative(-2.88f);
        pathBuilder.lineToRelative(2.1f, 2.88f);
        pathBuilder.close();
        pathBuilder.moveTo(13.24f, 10.57f);
        pathBuilder.lineTo(13.24f, 9.53f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(14.06f, 9.53f);
        pathBuilder.verticalLineToRelative(4.12f);
        pathBuilder.curveToRelative(0.0f, 0.45f, 0.37f, 0.82f, 0.82f, 0.82f);
        pathBuilder.horizontalLineToRelative(3.29f);
        pathBuilder.curveToRelative(0.45f, 0.0f, 0.82f, -0.37f, 0.82f, -0.82f);
        pathBuilder.lineTo(18.99f, 9.53f);
        pathBuilder.horizontalLineToRelative(-1.03f);
        ...
        pathBuilder.lineTo(15.08f, 9.53f);
