...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_flashlightOff", "Landroidx/compose/material/icons/Icons$TwoTone;", "getFlashlightOff", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "FlashlightOff", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nFlashlightOff.kt\nKotlin\n*S Kotlin\n*F\n+ 1 FlashlightOff.kt\nandroidx/compose/material/icons/twotone/FlashlightOffKt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,93:1\n122#2:94\n116#2,3:95\n119#2,3:99\n132#2,18:102\n152#2:139\n132#2,18:140\n152#2:177\n132#2,18:178\n152#2:215\n132#2,18:216\n152#2:253\n132#2,18:254\n152#2:291\n174#3:98\n694#4,2:120\n706#4,2:122\n708#4,11:128\n694#4,2:158\n706#4,2:160\n708#4,11:166\n694#4,2:196\n706#4,2:198\n708#4,11:204\n694#4,2:234\n706#4,2:236\n708#4,11:242\n694#4,2:272\n706#4,2:274\n708#4,11:280\n64#5,4:124\n64#5,4:162\n64#5,4:200\n64#5,4:238\n64#5,4:276\n*S KotlinDebug\n*F\n+ 1 FlashlightOff.kt\nandroidx/compose/material/icons/twotone/FlashlightOffKt\n*L\n29#1:94\n29#1:95,3\n29#1:99,3\n30#1:102,18\n30#1:139\n38#1:140,18\n38#1:177\n45#1:178,18\n45#1:215\n52#1:216,18\n52#1:253\n70#1:254,18\n70#1:291\n29#1:98\n30#1:120,2\n30#1:122,2\n30#1:128,11\n38#1:158,2\n38#1:160,2\n38#1:166,11\n45#1:196,2\n45#1:198,2\n45#1:204,11\n52#1:234,2\n52#1:236,2\n52#1:242,11\n70#1:272,2\n70#1:274,2\n70#1:280,11\n30#1:124,4\n38#1:162,4\n45#1:200,4\n52#1:238,4\n70#1:276,4\n*E\n"})
/* loaded from: classes.dex */
public final class FlashlightOffKt {

    /* renamed from: a */
    public static ImageVector f23999a;

    @NotNull
    public static final ImageVector getFlashlightOff(@NotNull Icons.TwoTone twoTone) {
        Intrinsics.checkNotNullParameter(twoTone, "<this>");
        ImageVector imageVector = f23999a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.FlashlightOff", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.lineToRelative(0.0f, -0.77f);
        ...
        pathBuilder2.moveTo(10.0f, 12.83f);
        pathBuilder2.lineToRelative(0.0f, 7.17f);
        pathBuilder2.lineToRelative(4.0f, 0.0f);
        pathBuilder2.lineToRelative(0.0f, -3.17f);
        pathBuilder2.close();
        ...
        pathBuilder3.lineToRelative(-9.17f, 0.0f);
        ...
        pathBuilder5.lineToRelative(0.0f, 1.0f);
        pathBuilder5.lineToRelative(-8.17f, 0.0f);
        pathBuilder5.lineToRelative(2.0f, 2.0f);
        pathBuilder5.lineToRelative(6.17f, 0.0f);
        pathBuilder5.lineToRelative(0.0f, 0.39f);
        pathBuilder5.lineToRelative(-2.0f, 3.01f);
        pathBuilder5.lineToRelative(0.0f, 0.77f);
        pathBuilder5.lineToRelative(2.0f, 2.0f);
        pathBuilder5.lineToRelative(0.0f, -2.17f);
        pathBuilder5.lineToRelative(2.0f, -3.0f);
        pathBuilder5.lineToRelative(0.0f, -6.0f);
        pathBuilder5.lineToRelative(-12.0f, 0.0f);
        pathBuilder5.lineToRelative(0.0f, 1.17f);
        pathBuilder5.lineToRelative(0.83f, 0.83f);
        pathBuilder5.close();
