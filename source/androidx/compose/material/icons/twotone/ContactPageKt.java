...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_contactPage", "Landroidx/compose/material/icons/Icons$TwoTone;", "getContactPage", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "ContactPage", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
...
public final class ContactPageKt {
    ...
    /* renamed from: a */
    public static ImageVector f23667a;

    @NotNull
    public static final ImageVector getContactPage(@NotNull Icons.TwoTone twoTone) {
        Intrinsics.checkNotNullParameter(twoTone, "<this>");
        ImageVector imageVector = f23667a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.ContactPage", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder2.moveTo(13.17f, 4.0f);
        ...
        pathBuilder2.curveTo(10.0f, 13.1f, 10.9f, 14.0f, 12.0f, 14.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(16.0f, 17.43f);
        pathBuilder2.curveToRelative(0.0f, -0.81f, -0.48f, -1.53f, -1.22f, -1.85f);
        pathBuilder2.curveTo(13.93f, 15.21f, 12.99f, 15.0f, 12.0f, 15.0f);
        pathBuilder2.curveToRelative(-0.99f, 0.0f, -1.93f, 0.21f, -2.78f, 0.58f);
        pathBuilder2.curveTo(8.48f, 15.9f, 8.0f, 16.62f, 8.0f, 17.43f);
        pathBuilder2.verticalLineTo(18.0f);
        pathBuilder2.horizontalLineToRelative(8.0f);
        pathBuilder2.verticalLineTo(17.43f);
        pathBuilder2.close();
