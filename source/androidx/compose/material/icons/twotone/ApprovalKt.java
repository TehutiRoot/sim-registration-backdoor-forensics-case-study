...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_approval", "Landroidx/compose/material/icons/Icons$TwoTone;", "getApproval", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "Approval", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nApproval.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Approval.kt\nandroidx/compose/material/icons/twotone/ApprovalKt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,81:1\n122#2:82\n116#2,3:83\n119#2,3:87\n132#2,18:90\n152#2:127\n132#2,18:128\n152#2:165\n132#2,18:166\n152#2:203\n132#2,18:204\n152#2:241\n174#3:86\n694#4,2:108\n706#4,2:110\n708#4,11:116\n694#4,2:146\n706#4,2:148\n708#4,11:154\n694#4,2:184\n706#4,2:186\n708#4,11:192\n694#4,2:222\n706#4,2:224\n708#4,11:230\n64#5,4:112\n64#5,4:150\n64#5,4:188\n64#5,4:226\n*S KotlinDebug\n*F\n+ 1 Approval.kt\nandroidx/compose/material/icons/twotone/ApprovalKt\n*L\n29#1:82\n29#1:83,3\n29#1:87,3\n30#1:90,18\n30#1:127\n37#1:128,18\n37#1:165\n45#1:166,18\n45#1:203\n59#1:204,18\n59#1:241\n29#1:86\n30#1:108,2\n30#1:110,2\n30#1:116,11\n37#1:146,2\n37#1:148,2\n37#1:154,11\n45#1:184,2\n45#1:186,2\n45#1:192,11\n59#1:222,2\n59#1:224,2\n59#1:230,11\n30#1:112,4\n37#1:150,4\n45#1:188,4\n59#1:226,4\n*E\n"})
/* loaded from: classes.dex */
public final class ApprovalKt {

    /* renamed from: a */
    public static ImageVector f23375a;

    @NotNull
    public static final ImageVector getApproval(@NotNull Icons.TwoTone twoTone) {
        Intrinsics.checkNotNullParameter(twoTone, "<this>");
        ImageVector imageVector = f23375a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Approval", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder2.lineToRelative(3.0f, -4.0f);
        pathBuilder2.curveTo(15.0f, 5.34f, 13.66f, 4.0f, 12.0f, 4.0f);
        pathBuilder2.close();
        ...
        pathBuilder3.curveTo(9.24f, 2.0f, 7.0f, 4.24f, 7.0f, 7.0f);
        pathBuilder3.lineToRelative(5.0f, 7.0f);
        pathBuilder3.lineToRelative(5.0f, -7.0f);
        pathBuilder3.curveTo(17.0f, 4.24f, 14.76f, 2.0f, 12.0f, 2.0f);
        pathBuilder3.close();
        ...
        pathBuilder3.lineTo(12.0f, 11.0f);
        pathBuilder3.close();
        ...
        pathBuilder4.verticalLineToRelative(-6.0f);
        pathBuilder4.curveTo(20.0f, 14.9f, 19.1f, 14.0f, 18.0f, 14.0f);
        pathBuilder4.close();
