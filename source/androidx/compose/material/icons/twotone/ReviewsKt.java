...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_reviews", "Landroidx/compose/material/icons/Icons$TwoTone;", "getReviews", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "Reviews", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nReviews.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Reviews.kt\nandroidx/compose/material/icons/twotone/ReviewsKt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,84:1\n122#2:85\n116#2,3:86\n119#2,3:90\n132#2,18:93\n152#2:130\n132#2,18:131\n152#2:168\n132#2,18:169\n152#2:206\n174#3:89\n694#4,2:111\n706#4,2:113\n708#4,11:119\n694#4,2:149\n706#4,2:151\n708#4,11:157\n694#4,2:187\n706#4,2:189\n708#4,11:195\n64#5,4:115\n64#5,4:153\n64#5,4:191\n*S KotlinDebug\n*F\n+ 1 Reviews.kt\nandroidx/compose/material/icons/twotone/ReviewsKt\n*L\n29#1:85\n29#1:86,3\n29#1:90,3\n30#1:93,18\n30#1:130\n49#1:131,18\n49#1:168\n68#1:169,18\n68#1:206\n29#1:89\n30#1:111,2\n30#1:113,2\n30#1:119,11\n49#1:149,2\n49#1:151,2\n49#1:157,11\n68#1:187,2\n68#1:189,2\n68#1:195,11\n30#1:115,4\n49#1:153,4\n68#1:191,4\n*E\n"})
/* loaded from: classes.dex */
public final class ReviewsKt {

    /* renamed from: a */
    public static ImageVector f24785a;

    @NotNull
    public static final ImageVector getReviews(@NotNull Icons.TwoTone twoTone) {
        Intrinsics.checkNotNullParameter(twoTone, "<this>");
        ImageVector imageVector = f24785a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Reviews", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder3.lineToRelative(1.57f, -3.43f);
        pathBuilder3.lineToRelative(3.43f, -1.57f);
        pathBuilder3.lineToRelative(-3.43f, -1.57f);
        pathBuilder3.lineToRelative(-1.57f, -3.43f);
        pathBuilder3.lineToRelative(-1.57f, 3.43f);
        pathBuilder3.lineToRelative(-3.43f, 1.57f);
