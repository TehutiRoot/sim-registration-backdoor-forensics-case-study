...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_bedroomChild", "Landroidx/compose/material/icons/Icons$TwoTone;", "getBedroomChild", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "BedroomChild", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
...
public final class BedroomChildKt {
    ...
    /* renamed from: a */
    public static ImageVector f23467a;

    @NotNull
    public static final ImageVector getBedroomChild(@NotNull Icons.TwoTone twoTone) {
        Intrinsics.checkNotNullParameter(twoTone, "<this>");
        ImageVector imageVector = f23467a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.BedroomChild", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.curveToRelative(0.0f, -1.0f, 0.62f, -1.85f, 1.5f, -2.2f);
        ...
        pathBuilder3.close();
        pathBuilder3.moveTo(9.0f, 8.5f);
        pathBuilder3.horizontalLineToRelative(6.0f);
        pathBuilder3.verticalLineToRelative(2.0f);
        pathBuilder3.horizontalLineTo(9.0f);
        pathBuilder3.verticalLineTo(8.5f);
        pathBuilder3.close();
        pathBuilder3.moveTo(8.37f, 12.0f);
        pathBuilder3.horizontalLineToRelative(7.27f);
        pathBuilder3.curveToRelative(0.48f, 0.0f, 0.87f, 0.39f, 0.87f, 0.87f);
        pathBuilder3.verticalLineTo(14.0f);
        pathBuilder3.horizontalLineToRelative(-9.0f);
        pathBuilder3.verticalLineToRelative(-1.13f);
        pathBuilder3.horizontalLineTo(7.5f);
        pathBuilder3.curveTo(7.5f, 12.39f, 7.89f, 12.0f, 8.37f, 12.0f);
        pathBuilder3.close();
