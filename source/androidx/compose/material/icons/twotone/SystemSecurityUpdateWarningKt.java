...
public final class SystemSecurityUpdateWarningKt {
    ...
    /* renamed from: a */
    public static ImageVector f25093a;

    @NotNull
    public static final ImageVector getSystemSecurityUpdateWarning(@NotNull Icons.TwoTone twoTone) {
        Intrinsics.checkNotNullParameter(twoTone, "<this>");
        ImageVector imageVector = f25093a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.SystemSecurityUpdateWarning", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
