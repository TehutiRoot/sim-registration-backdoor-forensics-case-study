...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "__4mp", "Landroidx/compose/material/icons/Icons$Rounded;", "get_4mp", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_4mp", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\n_4mp.kt\nKotlin\n*S Kotlin\n*F\n+ 1 _4mp.kt\nandroidx/compose/material/icons/rounded/_4mpKt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,106:1\n122#2:107\n116#2,3:108\n119#2,3:112\n132#2,18:115\n152#2:152\n132#2,18:153\n152#2:190\n174#3:111\n694#4,2:133\n706#4,2:135\n708#4,11:141\n694#4,2:171\n706#4,2:173\n708#4,11:179\n64#5,4:137\n64#5,4:175\n*S KotlinDebug\n*F\n+ 1 _4mp.kt\nandroidx/compose/material/icons/rounded/_4mpKt\n*L\n29#1:107\n29#1:108,3\n29#1:112,3\n30#1:115,18\n30#1:152\n37#1:153,18\n37#1:190\n29#1:111\n30#1:133,2\n30#1:135,2\n30#1:141,11\n37#1:171,2\n37#1:173,2\n37#1:179,11\n30#1:137,4\n37#1:175,4\n*E\n"})
/* loaded from: classes.dex */
public final class _4mpKt {

    /* renamed from: a */
    public static ImageVector f21128a;

    @NotNull
    public static final ImageVector get_4mp(@NotNull Icons.Rounded rounded) {
        Intrinsics.checkNotNullParameter(rounded, "<this>");
        ImageVector imageVector = f21128a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded._4mp", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(12.5f, 10.75f);
        pathBuilder2.verticalLineTo(10.0f);
        pathBuilder2.horizontalLineToRelative(-2.0f);
        pathBuilder2.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilder2.verticalLineTo(6.25f);
        pathBuilder2.curveToRelative(0.0f, -0.41f, 0.34f, -0.75f, 0.75f, -0.75f);
        pathBuilder2.reflectiveCurveTo(11.0f, 5.84f, 11.0f, 6.25f);
        pathBuilder2.verticalLineTo(8.5f);
        pathBuilder2.horizontalLineToRelative(1.5f);
        pathBuilder2.verticalLineTo(6.25f);
        pathBuilder2.curveToRelative(0.0f, -0.41f, 0.34f, -0.75f, 0.75f, -0.75f);
        pathBuilder2.reflectiveCurveTo(14.0f, 5.84f, 14.0f, 6.25f);
        pathBuilder2.verticalLineTo(8.5f);
        pathBuilder2.horizontalLineToRelative(0.25f);
        pathBuilder2.curveTo(14.66f, 8.5f, 15.0f, 8.84f, 15.0f, 9.25f);
        pathBuilder2.reflectiveCurveTo(14.66f, 10.0f, 14.25f, 10.0f);
        pathBuilder2.horizontalLineTo(14.0f);
        pathBuilder2.verticalLineToRelative(0.75f);
        pathBuilder2.curveToRelative(0.0f, 0.41f, -0.34f, 0.75f, -0.75f, 0.75f);
        pathBuilder2.reflectiveCurveTo(12.5f, 11.16f, 12.5f, 10.75f);
        pathBuilder2.close();
