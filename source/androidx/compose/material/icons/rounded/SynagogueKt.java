...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_synagogue", "Landroidx/compose/material/icons/Icons$Rounded;", "getSynagogue", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "Synagogue", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nSynagogue.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Synagogue.kt\nandroidx/compose/material/icons/rounded/SynagogueKt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,94:1\n122#2:95\n116#2,3:96\n119#2,3:100\n132#2,18:103\n152#2:140\n132#2,18:141\n152#2:178\n132#2,18:179\n152#2:216\n132#2,18:217\n152#2:254\n132#2,18:255\n152#2:292\n174#3:99\n694#4,2:121\n706#4,2:123\n708#4,11:129\n694#4,2:159\n706#4,2:161\n708#4,11:167\n694#4,2:197\n706#4,2:199\n708#4,11:205\n694#4,2:235\n706#4,2:237\n708#4,11:243\n694#4,2:273\n706#4,2:275\n708#4,11:281\n64#5,4:125\n64#5,4:163\n64#5,4:201\n64#5,4:239\n64#5,4:277\n*S KotlinDebug\n*F\n+ 1 Synagogue.kt\nandroidx/compose/material/icons/rounded/SynagogueKt\n*L\n29#1:95\n29#1:96,3\n29#1:100,3\n30#1:103,18\n30#1:140\n53#1:141,18\n53#1:178\n62#1:179,18\n62#1:216\n71#1:217,18\n71#1:254\n80#1:255,18\n80#1:292\n29#1:99\n30#1:121,2\n30#1:123,2\n30#1:129,11\n53#1:159,2\n53#1:161,2\n53#1:167,11\n62#1:197,2\n62#1:199,2\n62#1:205,11\n71#1:235,2\n71#1:237,2\n71#1:243,11\n80#1:273,2\n80#1:275,2\n80#1:281,11\n30#1:125,4\n53#1:163,4\n62#1:201,4\n71#1:239,4\n80#1:277,4\n*E\n"})
/* loaded from: classes.dex */
public final class SynagogueKt {

    /* renamed from: a */
    public static ImageVector f20821a;

    @NotNull
    public static final ImageVector getSynagogue(@NotNull Icons.Rounded rounded) {
        Intrinsics.checkNotNullParameter(rounded, "<this>");
        ImageVector imageVector = f20821a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Synagogue", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.moveTo(6.0f, 8.94f);
        pathBuilder.verticalLineTo(21.0f);
        pathBuilder.horizontalLineToRelative(4.0f);
        pathBuilder.lineToRelative(0.0f, -4.89f);
        pathBuilder.curveToRelative(0.0f, -1.0f, 0.68f, -1.92f, 1.66f, -2.08f);
        pathBuilder.curveTo(12.92f, 13.82f, 14.0f, 14.79f, 14.0f, 16.0f);
        pathBuilder.verticalLineToRelative(5.0f);
        pathBuilder.horizontalLineToRelative(4.0f);
        pathBuilder.verticalLineTo(8.94f);
        pathBuilder.curveToRelative(0.0f, -0.59f, -0.26f, -1.16f, -0.72f, -1.54f);
        pathBuilder.lineToRelative(-4.0f, -3.33f);
        pathBuilder.curveToRelative(-0.74f, -0.62f, -1.82f, -0.62f, -2.56f, 0.0f);
        pathBuilder.lineToRelative(-4.0f, 3.33f);
        pathBuilder.curveTo(6.26f, 7.78f, 6.0f, 8.34f, 6.0f, 8.94f);
        pathBuilder.close();
        ...
        pathBuilder3.curveTo(1.0f, 20.1f, 1.9f, 21.0f, 3.0f, 21.0f);
        pathBuilder3.close();
        ...
        pathBuilder5.moveTo(19.0f, 21.0f);
