...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_biotech", "Landroidx/compose/material/icons/Icons$Rounded;", "getBiotech", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "Biotech", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nBiotech.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Biotech.kt\nandroidx/compose/material/icons/rounded/BiotechKt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,78:1\n122#2:79\n116#2,3:80\n119#2,3:84\n132#2,18:87\n152#2:124\n132#2,18:125\n152#2:162\n132#2,18:163\n152#2:200\n174#3:83\n694#4,2:105\n706#4,2:107\n708#4,11:113\n694#4,2:143\n706#4,2:145\n708#4,11:151\n694#4,2:181\n706#4,2:183\n708#4,11:189\n64#5,4:109\n64#5,4:147\n64#5,4:185\n*S KotlinDebug\n*F\n+ 1 Biotech.kt\nandroidx/compose/material/icons/rounded/BiotechKt\n*L\n29#1:79\n29#1:80,3\n29#1:84,3\n30#1:87,18\n30#1:124\n50#1:125,18\n50#1:162\n67#1:163,18\n67#1:200\n29#1:83\n30#1:105,2\n30#1:107,2\n30#1:113,11\n50#1:143,2\n50#1:145,2\n50#1:151,11\n67#1:181,2\n67#1:183,2\n67#1:189,11\n30#1:109,4\n50#1:147,4\n67#1:185,4\n*E\n"})
/* loaded from: classes.dex */
public final class BiotechKt {

    /* renamed from: a */
    public static ImageVector f19210a;

    @NotNull
    public static final ImageVector getBiotech(@NotNull Icons.Rounded rounded) {
        Intrinsics.checkNotNullParameter(rounded, "<this>");
        ImageVector imageVector = f19210a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Biotech", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder2.lineToRelative(0.25f, 0.68f);
        ...
        pathBuilder2.curveToRelative(0.52f, -0.19f, 0.79f, -0.76f, 0.6f, -1.28f);
        pathBuilder2.lineTo(14.1f, 3.54f);
        pathBuilder2.curveToRelative(-0.19f, -0.52f, -0.76f, -0.79f, -1.28f, -0.6f);
        pathBuilder2.curveToRelative(-0.19f, -0.52f, -0.76f, -0.79f, -1.28f, -0.6f);
        pathBuilder2.curveToRelative(-0.52f, 0.19f, -0.79f, 0.76f, -0.6f, 1.28f);
        pathBuilder2.curveToRelative(-0.52f, 0.19f, -0.79f, 0.76f, -0.6f, 1.28f);
