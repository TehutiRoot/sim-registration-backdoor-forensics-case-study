...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_adsClick", "Landroidx/compose/material/icons/Icons$Rounded;", "getAdsClick", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "AdsClick", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nAdsClick.kt\nKotlin\n*S Kotlin\n*F\n+ 1 AdsClick.kt\nandroidx/compose/material/icons/rounded/AdsClickKt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,75:1\n122#2:76\n116#2,3:77\n119#2,3:81\n132#2,18:84\n152#2:121\n174#3:80\n694#4,2:102\n706#4,2:104\n708#4,11:110\n64#5,4:106\n*S KotlinDebug\n*F\n+ 1 AdsClick.kt\nandroidx/compose/material/icons/rounded/AdsClickKt\n*L\n29#1:76\n29#1:77,3\n29#1:81,3\n30#1:84,18\n30#1:121\n29#1:80\n30#1:102,2\n30#1:104,2\n30#1:110,11\n30#1:106,4\n*E\n"})
/* loaded from: classes.dex */
public final class AdsClickKt {

    /* renamed from: a */
    public static ImageVector f19064a;

    @NotNull
    public static final ImageVector getAdsClick(@NotNull Icons.Rounded rounded) {
        Intrinsics.checkNotNullParameter(rounded, "<this>");
        ImageVector imageVector = f19064a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.AdsClick", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.lineToRelative(2.27f, -0.76f);
        pathBuilder.curveToRelative(0.46f, -0.15f, 0.45f, -0.81f, -0.01f, -0.95f);
        pathBuilder.lineToRelative(-7.6f, -2.28f);
        pathBuilder.curveToRelative(-0.38f, -0.11f, -0.74f, 0.24f, -0.62f, 0.62f);
        pathBuilder.lineToRelative(2.28f, 7.6f);
        pathBuilder.curveToRelative(0.14f, 0.47f, 0.8f, 0.48f, 0.95f, 0.01f);
        pathBuilder.lineToRelative(0.76f, -2.27f);
        pathBuilder.lineToRelative(3.91f, 3.91f);
