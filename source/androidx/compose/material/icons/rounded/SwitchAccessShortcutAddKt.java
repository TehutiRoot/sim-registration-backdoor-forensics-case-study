...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_switchAccessShortcutAdd", "Landroidx/compose/material/icons/Icons$Rounded;", "getSwitchAccessShortcutAdd", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "SwitchAccessShortcutAdd", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
...
public final class SwitchAccessShortcutAddKt {
    ...
    /* renamed from: a */
    public static ImageVector f20814a;

    @NotNull
    public static final ImageVector getSwitchAccessShortcutAdd(@NotNull Icons.Rounded rounded) {
        Intrinsics.checkNotNullParameter(rounded, "<this>");
        ImageVector imageVector = f20814a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.SwitchAccessShortcutAdd", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.horizontalLineToRelative(1.0f);
        pathBuilder.verticalLineToRelative(1.0f);
        pathBuilder.curveTo(20.0f, 17.55f, 20.45f, 18.0f, 21.0f, 18.0f);
        pathBuilder.close();
        ...
        pathBuilder.close();
        pathBuilder.moveTo(19.0f, 20.41f);
        pathBuilder.curveToRelative(0.0f, 0.78f, -0.84f, 1.25f, -1.51f, 0.86f);
        pathBuilder.curveTo(14.21f, 19.36f, 12.0f, 15.79f, 12.0f, 12.0f);
        pathBuilder.curveToRelative(0.0f, -2.73f, 1.08f, -5.27f, 2.75f, -7.25f);
        pathBuilder.lineToRelative(-1.9f, -1.9f);
        pathBuilder.curveTo(12.54f, 2.54f, 12.76f, 2.0f, 13.21f, 2.0f);
        pathBuilder.horizontalLineToRelative(5.29f);
        pathBuilder.curveTo(18.78f, 2.0f, 19.0f, 2.22f, 19.0f, 2.5f);
        ...
        pathBuilder.curveToRelative(0.0f, 3.13f, 1.86f, 6.01f, 4.51f, 7.55f);
        pathBuilder.curveTo(18.81f, 19.73f, 19.0f, 20.06f, 19.0f, 20.41f);
        pathBuilder.close();
