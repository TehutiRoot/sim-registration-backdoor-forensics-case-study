...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_plumbing", "Landroidx/compose/material/icons/Icons$Rounded;", "getPlumbing", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "Plumbing", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nPlumbing.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Plumbing.kt\nandroidx/compose/material/icons/rounded/PlumbingKt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,73:1\n122#2:74\n116#2,3:75\n119#2,3:79\n132#2,18:82\n152#2:119\n132#2,18:120\n152#2:157\n132#2,18:158\n152#2:195\n174#3:78\n694#4,2:100\n706#4,2:102\n708#4,11:108\n694#4,2:138\n706#4,2:140\n708#4,11:146\n694#4,2:176\n706#4,2:178\n708#4,11:184\n64#5,4:104\n64#5,4:142\n64#5,4:180\n*S KotlinDebug\n*F\n+ 1 Plumbing.kt\nandroidx/compose/material/icons/rounded/PlumbingKt\n*L\n29#1:74\n29#1:75,3\n29#1:79,3\n30#1:82,18\n30#1:119\n41#1:120,18\n41#1:157\n51#1:158,18\n51#1:195\n29#1:78\n30#1:100,2\n30#1:102,2\n30#1:108,11\n41#1:138,2\n41#1:140,2\n41#1:146,11\n51#1:176,2\n51#1:178,2\n51#1:184,11\n30#1:104,4\n41#1:142,4\n51#1:180,4\n*E\n"})
/* loaded from: classes.dex */
public final class PlumbingKt {

    /* renamed from: a */
    public static ImageVector f20410a;

    @NotNull
    public static final ImageVector getPlumbing(@NotNull Icons.Rounded rounded) {
        Intrinsics.checkNotNullParameter(rounded, "<this>");
        ImageVector imageVector = f20410a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Plumbing", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder3.moveTo(14.33f, 8.46f);
        pathBuilder3.lineToRelative(-0.71f, 0.71f);
        pathBuilder3.lineToRelative(-3.18f, -3.18f);
        pathBuilder3.curveTo(9.85f, 5.4f, 8.9f, 5.4f, 8.32f, 5.99f);
        pathBuilder3.curveToRelative(-0.59f, 0.59f, -0.59f, 1.54f, 0.0f, 2.12f);
        pathBuilder3.lineToRelative(3.18f, 3.18f);
        pathBuilder3.lineToRelative(-7.0f, 7.0f);
        pathBuilder3.curveToRelative(-0.7f, 0.7f, -0.88f, 1.84f, -0.29f, 2.65f);
        pathBuilder3.curveToRelative(0.74f, 1.03f, 2.19f, 1.12f, 3.05f, 0.26f);
        ...
        pathBuilder3.curveTo(15.35f, 8.07f, 14.72f, 8.07f, 14.33f, 8.46f);
        pathBuilder3.close();
