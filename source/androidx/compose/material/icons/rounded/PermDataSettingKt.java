...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_permDataSetting", "Landroidx/compose/material/icons/Icons$Rounded;", "getPermDataSetting", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "PermDataSetting", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
...
public final class PermDataSettingKt {
    ...
    /* renamed from: a */
    public static ImageVector f20325a;

    @NotNull
    public static final ImageVector getPermDataSetting(@NotNull Icons.Rounded rounded) {
        Intrinsics.checkNotNullParameter(rounded, "<this>");
        ImageVector imageVector = f20325a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.PermDataSetting", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.curveToRelative(0.34f, 0.0f, 0.68f, 0.03f, 1.01f, 0.07f);
        pathBuilder.lineTo(20.0f, 2.42f);
        pathBuilder.curveToRelative(0.0f, -0.89f, -1.08f, -1.34f, -1.71f, -0.71f);
        pathBuilder.lineTo(1.71f, 18.29f);
        pathBuilder.curveToRelative(-0.63f, 0.63f, -0.19f, 1.71f, 0.7f, 1.71f);
        pathBuilder.horizontalLineToRelative(9.15f);
        ...
        pathBuilder.reflectiveCurveToRelative(-0.01f, -0.33f, -0.04f, -0.49f);
        ...
        pathBuilder.reflectiveCurveToRelative(0.01f, 0.33f, 0.03f, 0.49f);
        pathBuilder.lineToRelative(-1.06f, 0.83f);
        pathBuilder.curveToRelative(-0.09f, 0.08f, -0.12f, 0.21f, -0.06f, 0.32f);
        pathBuilder.lineToRelative(1.0f, 1.73f);
        pathBuilder.curveToRelative(0.06f, 0.11f, 0.19f, 0.15f, 0.31f, 0.11f);
