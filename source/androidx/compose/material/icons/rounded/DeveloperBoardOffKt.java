...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_developerBoardOff", "Landroidx/compose/material/icons/Icons$Rounded;", "getDeveloperBoardOff", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "DeveloperBoardOff", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nDeveloperBoardOff.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeveloperBoardOff.kt\nandroidx/compose/material/icons/rounded/DeveloperBoardOffKt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,128:1\n122#2:129\n116#2,3:130\n119#2,3:134\n132#2,18:137\n152#2:174\n174#3:133\n694#4,2:155\n706#4,2:157\n708#4,11:163\n64#5,4:159\n*S KotlinDebug\n*F\n+ 1 DeveloperBoardOff.kt\nandroidx/compose/material/icons/rounded/DeveloperBoardOffKt\n*L\n29#1:129\n29#1:130,3\n29#1:134,3\n30#1:137,18\n30#1:174\n29#1:133\n30#1:155,2\n30#1:157,2\n30#1:163,11\n30#1:159,4\n*E\n"})
/* loaded from: classes.dex */
public final class DeveloperBoardOffKt {

    /* renamed from: a */
    public static ImageVector f19493a;

    @NotNull
    public static final ImageVector getDeveloperBoardOff(@NotNull Icons.Rounded rounded) {
        Intrinsics.checkNotNullParameter(rounded, "<this>");
        ImageVector imageVector = f19493a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.DeveloperBoardOff", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.curveToRelative(-0.06f, 0.0f, -0.13f, -0.01f, -0.19f, -0.02f);
        pathBuilder.lineToRelative(-0.79f, -0.79f);
        pathBuilder.curveTo(12.01f, 9.13f, 12.0f, 9.06f, 12.0f, 9.0f);
        ...
        pathBuilder.curveTo(10.55f, 7.0f, 11.0f, 7.45f, 11.0f, 8.0f);
        pathBuilder.close();
        pathBuilder.moveTo(16.0f, 12.0f);
        pathBuilder.verticalLineToRelative(1.17f);
        pathBuilder.lineTo(13.83f, 11.0f);
        pathBuilder.horizontalLineTo(15.0f);
        pathBuilder.curveTo(15.55f, 11.0f, 16.0f, 11.45f, 16.0f, 12.0f);
        pathBuilder.close();
        pathBuilder.moveTo(1.39f, 2.81f);
        pathBuilder.lineTo(1.39f, 2.81f);
        ...
        pathBuilder.curveTo(10.13f, 13.01f, 10.06f, 13.0f, 10.0f, 13.0f);
        ...
        pathBuilder.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilder.verticalLineToRelative(-2.0f);
        pathBuilder.curveToRelative(0.0f, -0.06f, -0.01f, -0.13f, -0.02f, -0.19f);
        pathBuilder.lineTo(12.0f, 14.83f);
        pathBuilder.verticalLineToRelative(0.46f);
