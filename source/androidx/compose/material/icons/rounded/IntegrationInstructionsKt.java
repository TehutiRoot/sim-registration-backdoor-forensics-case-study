...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_integrationInstructions", "Landroidx/compose/material/icons/Icons$Rounded;", "getIntegrationInstructions", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "IntegrationInstructions", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
...
public final class IntegrationInstructionsKt {
    ...
    /* renamed from: a */
    public static ImageVector f19949a;

    @NotNull
    public static final ImageVector getIntegrationInstructions(@NotNull Icons.Rounded rounded) {
        Intrinsics.checkNotNullParameter(rounded, "<this>");
        ImageVector imageVector = f19949a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.IntegrationInstructions", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(10.3f, 14.88f);
        pathBuilder.lineTo(10.3f, 14.88f);
        ...
        pathBuilder.curveTo(10.68f, 13.85f, 10.69f, 14.49f, 10.3f, 14.88f);
        pathBuilder.close();
        ...
        pathBuilder.close();
        pathBuilder.moveTo(13.7f, 14.88f);
        pathBuilder.lineTo(13.7f, 14.88f);
        pathBuilder.curveToRelative(-0.39f, -0.39f, -0.39f, -1.02f, 0.0f, -1.41f);
        ...
        pathBuilder.curveToRelative(0.39f, 0.39f, 0.39f, 1.02f, 0.0f, 1.41f);
        pathBuilder.lineToRelative(-2.17f, 2.17f);
        pathBuilder.curveTo(14.73f, 15.27f, 14.09f, 15.27f, 13.7f, 14.88f);
        pathBuilder.close();
