...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_insertPageBreak", "Landroidx/compose/material/icons/Icons$Rounded;", "getInsertPageBreak", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "InsertPageBreak", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
...
public final class InsertPageBreakKt {
    ...
    /* renamed from: a */
    public static ImageVector f19944a;

    @NotNull
    public static final ImageVector getInsertPageBreak(@NotNull Icons.Rounded rounded) {
        Intrinsics.checkNotNullParameter(rounded, "<this>");
        ImageVector imageVector = f19944a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.InsertPageBreak", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder2.moveTo(19.41f, 7.41f);
        pathBuilder2.lineToRelative(-4.83f, -4.83f);
        pathBuilder2.curveTo(14.21f, 2.21f, 13.7f, 2.0f, 13.17f, 2.0f);
        pathBuilder2.horizontalLineTo(6.0f);
        pathBuilder2.curveTo(4.9f, 2.0f, 4.01f, 2.89f, 4.01f, 3.99f);
        pathBuilder2.lineToRelative(0.0f, 7.01f);
        pathBuilder2.horizontalLineTo(20.0f);
        pathBuilder2.verticalLineTo(8.83f);
        pathBuilder2.curveTo(20.0f, 8.3f, 19.79f, 7.79f, 19.41f, 7.41f);
        pathBuilder2.close();
        ...
        pathBuilder2.curveTo(13.45f, 9.0f, 13.0f, 8.55f, 13.0f, 8.0f);
        pathBuilder2.close();
        ...
        pathBuilder3.lineTo(15.0f, 14.0f);
        ...
        pathBuilder3.curveToRelative(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        pathBuilder3.horizontalLineToRelative(4.0f);
        pathBuilder3.curveTo(14.55f, 15.0f, 15.0f, 14.55f, 15.0f, 14.0f);
        pathBuilder3.close();
        ...
        pathBuilder4.lineTo(17.0f, 14.0f);
        ...
        pathBuilder4.curveToRelative(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        pathBuilder4.horizontalLineToRelative(-4.0f);
        pathBuilder4.curveTo(17.45f, 13.0f, 17.0f, 13.45f, 17.0f, 14.0f);
        pathBuilder4.close();
        ...
        pathBuilder5.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilder5.verticalLineToRelative(0.0f);
        pathBuilder5.curveTo(7.0f, 13.45f, 6.55f, 13.0f, 6.0f, 13.0f);
        pathBuilder5.close();
