...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_sentimentDissatisfied", "Landroidx/compose/material/icons/Icons$Rounded;", "getSentimentDissatisfied", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "SentimentDissatisfied", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
...
public final class SentimentDissatisfiedKt {
    ...
    /* renamed from: a */
    public static ImageVector f20605a;

    @NotNull
    public static final ImageVector getSentimentDissatisfied(@NotNull Icons.Rounded rounded) {
        Intrinsics.checkNotNullParameter(rounded, "<this>");
        ImageVector imageVector = f20605a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.SentimentDissatisfied", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder3.curveToRelative(-1.9f, 0.0f, -3.63f, 0.97f, -4.65f, 2.58f);
        pathBuilder3.curveToRelative(-0.22f, 0.35f, -0.11f, 0.81f, 0.24f, 1.03f);
        pathBuilder3.curveToRelative(0.35f, 0.22f, 0.81f, 0.11f, 1.03f, -0.24f);
        pathBuilder3.curveToRelative(0.74f, -1.18f, 2.0f, -1.88f, 3.38f, -1.88f);
        pathBuilder3.reflectiveCurveToRelative(2.64f, 0.7f, 3.38f, 1.88f);
        pathBuilder3.curveToRelative(0.14f, 0.23f, 0.39f, 0.35f, 0.64f, 0.35f);
        pathBuilder3.curveToRelative(0.14f, 0.0f, 0.27f, -0.04f, 0.4f, -0.11f);
        pathBuilder3.curveToRelative(0.35f, -0.22f, 0.46f, -0.68f, 0.24f, -1.03f);
        pathBuilder3.curveTo(15.63f, 14.96f, 13.9f, 14.0f, 12.0f, 14.0f);
        pathBuilder3.close();
