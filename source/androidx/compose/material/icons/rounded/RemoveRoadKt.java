...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_removeRoad", "Landroidx/compose/material/icons/Icons$Rounded;", "getRemoveRoad", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "RemoveRoad", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
...
public final class RemoveRoadKt {
    ...
    /* renamed from: a */
    public static ImageVector f20493a;

    @NotNull
    public static final ImageVector getRemoveRoad(@NotNull Icons.Rounded rounded) {
        Intrinsics.checkNotNullParameter(rounded, "<this>");
        ImageVector imageVector = f20493a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.RemoveRoad", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder3.curveTo(11.0f, 7.55f, 11.45f, 8.0f, 12.0f, 8.0f);
        pathBuilder3.close();
        ...
        pathBuilder4.lineTo(12.0f, 14.0f);
        ...
        pathBuilder4.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilder4.verticalLineToRelative(2.0f);
        pathBuilder4.curveTo(11.0f, 13.55f, 11.45f, 14.0f, 12.0f, 14.0f);
        pathBuilder4.close();
        ...
        pathBuilder5.lineTo(12.0f, 20.0f);
        ...
        pathBuilder5.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilder5.verticalLineToRelative(2.0f);
        pathBuilder5.curveTo(11.0f, 19.55f, 11.45f, 20.0f, 12.0f, 20.0f);
        pathBuilder5.close();
        ...
        pathBuilder6.moveTo(21.79f, 15.71f);
        pathBuilder6.lineTo(21.79f, 15.71f);
        pathBuilder6.curveToRelative(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        pathBuilder6.lineTo(19.0f, 17.09f);
        pathBuilder6.lineToRelative(-1.38f, -1.38f);
        pathBuilder6.curveToRelative(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        ...
        pathBuilder6.curveToRelative(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        pathBuilder6.lineTo(19.0f, 19.91f);
        pathBuilder6.lineToRelative(1.38f, 1.38f);
        pathBuilder6.curveToRelative(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        pathBuilder6.lineToRelative(0.0f, 0.0f);
        pathBuilder6.curveToRelative(0.39f, -0.39f, 0.39f, -1.02f, 0.0f, -1.41f);
        pathBuilder6.lineToRelative(-1.38f, -1.38f);
        pathBuilder6.lineToRelative(1.38f, -1.38f);
        pathBuilder6.curveTo(22.18f, 16.73f, 22.18f, 16.1f, 21.79f, 15.71f);
        pathBuilder6.close();
