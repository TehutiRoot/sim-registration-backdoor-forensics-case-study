...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_man2", "Landroidx/compose/material/icons/Icons$Rounded;", "getMan2", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "Man2", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nMan2.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Man2.kt\nandroidx/compose/material/icons/rounded/Man2Kt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,59:1\n122#2:60\n116#2,3:61\n119#2,3:65\n132#2,18:68\n152#2:105\n132#2,18:106\n152#2:143\n174#3:64\n694#4,2:86\n706#4,2:88\n708#4,11:94\n694#4,2:124\n706#4,2:126\n708#4,11:132\n64#5,4:90\n64#5,4:128\n*S KotlinDebug\n*F\n+ 1 Man2.kt\nandroidx/compose/material/icons/rounded/Man2Kt\n*L\n29#1:60\n29#1:61,3\n29#1:65,3\n30#1:68,18\n30#1:105\n48#1:106,18\n48#1:143\n29#1:64\n30#1:86,2\n30#1:88,2\n30#1:94,11\n48#1:124,2\n48#1:126,2\n48#1:132,11\n30#1:90,4\n48#1:128,4\n*E\n"})
/* loaded from: classes.dex */
public final class Man2Kt {

    /* renamed from: a */
    public static ImageVector f20098a;

    @NotNull
    public static final ImageVector getMan2(@NotNull Icons.Rounded rounded) {
        Intrinsics.checkNotNullParameter(rounded, "<this>");
        ImageVector imageVector = f20098a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Man2", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
