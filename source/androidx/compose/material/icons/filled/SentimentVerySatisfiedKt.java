...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_sentimentVerySatisfied", "Landroidx/compose/material/icons/Icons$Filled;", "getSentimentVerySatisfied", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "SentimentVerySatisfied", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nSentimentVerySatisfied.kt\nKotlin\n*S Kotlin\n*F\n+ 1 SentimentVerySatisfied.kt\nandroidx/compose/material/icons/filled/SentimentVerySatisfiedKt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,66:1\n122#2:67\n116#2,3:68\n119#2,3:72\n132#2,18:75\n152#2:112\n132#2,18:113\n152#2:150\n132#2,18:151\n152#2:188\n174#3:71\n694#4,2:93\n706#4,2:95\n708#4,11:101\n694#4,2:131\n706#4,2:133\n708#4,11:139\n694#4,2:169\n706#4,2:171\n708#4,11:177\n64#5,4:97\n64#5,4:135\n64#5,4:173\n*S KotlinDebug\n*F\n+ 1 SentimentVerySatisfied.kt\nandroidx/compose/material/icons/filled/SentimentVerySatisfiedKt\n*L\n29#1:67\n29#1:68,3\n29#1:72,3\n30#1:75,18\n30#1:112\n36#1:113,18\n36#1:150\n42#1:151,18\n42#1:188\n29#1:71\n30#1:93,2\n30#1:95,2\n30#1:101,11\n36#1:131,2\n36#1:133,2\n36#1:139,11\n42#1:169,2\n42#1:171,2\n42#1:177,11\n30#1:97,4\n36#1:135,4\n42#1:173,4\n*E\n"})
/* loaded from: classes.dex */
public final class SentimentVerySatisfiedKt {

    /* renamed from: a */
    public static ImageVector f16346a;

    @NotNull
    public static final ImageVector getSentimentVerySatisfied(@NotNull Icons.Filled filled) {
        Intrinsics.checkNotNullParameter(filled, "<this>");
        ImageVector imageVector = f16346a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Filled.SentimentVerySatisfied", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder3.curveToRelative(0.78f, 2.34f, 2.72f, 4.0f, 5.0f, 4.0f);
        pathBuilder3.reflectiveCurveToRelative(4.22f, -1.66f, 5.0f, -4.0f);
        pathBuilder3.lineTo(7.0f, 14.0f);
        pathBuilder3.close();
