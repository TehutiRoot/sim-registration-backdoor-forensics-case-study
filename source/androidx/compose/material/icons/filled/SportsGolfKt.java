...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_sportsGolf", "Landroidx/compose/material/icons/Icons$Filled;", "getSportsGolf", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "SportsGolf", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nSportsGolf.kt\nKotlin\n*S Kotlin\n*F\n+ 1 SportsGolf.kt\nandroidx/compose/material/icons/filled/SportsGolfKt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,81:1\n122#2:82\n116#2,3:83\n119#2,3:87\n132#2,18:90\n152#2:127\n132#2,18:128\n152#2:165\n132#2,18:166\n152#2:203\n132#2,18:204\n152#2:241\n132#2,18:242\n152#2:279\n174#3:86\n694#4,2:108\n706#4,2:110\n708#4,11:116\n694#4,2:146\n706#4,2:148\n708#4,11:154\n694#4,2:184\n706#4,2:186\n708#4,11:192\n694#4,2:222\n706#4,2:224\n708#4,11:230\n694#4,2:260\n706#4,2:262\n708#4,11:268\n64#5,4:112\n64#5,4:150\n64#5,4:188\n64#5,4:226\n64#5,4:264\n*S KotlinDebug\n*F\n+ 1 SportsGolf.kt\nandroidx/compose/material/icons/filled/SportsGolfKt\n*L\n29#1:82\n29#1:83,3\n29#1:87,3\n30#1:90,18\n30#1:127\n44#1:128,18\n44#1:165\n50#1:166,18\n50#1:203\n56#1:204,18\n56#1:241\n62#1:242,18\n62#1:279\n29#1:86\n30#1:108,2\n30#1:110,2\n30#1:116,11\n44#1:146,2\n44#1:148,2\n44#1:154,11\n50#1:184,2\n50#1:186,2\n50#1:192,11\n56#1:222,2\n56#1:224,2\n56#1:230,11\n62#1:260,2\n62#1:262,2\n62#1:268,11\n30#1:112,4\n44#1:150,4\n50#1:188,4\n56#1:226,4\n62#1:264,4\n*E\n"})
/* loaded from: classes.dex */
public final class SportsGolfKt {

    /* renamed from: a */
    public static ImageVector f16469a;

    @NotNull
    public static final ImageVector getSportsGolf(@NotNull Icons.Filled filled) {
        Intrinsics.checkNotNullParameter(filled, "<this>");
        ImageVector imageVector = f16469a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Filled.SportsGolf", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.reflectiveCurveTo(5.0f, 5.13f, 5.0f, 9.0f);
        pathBuilder.curveTo(5.0f, 12.87f, 8.13f, 16.0f, 12.0f, 16.0f);
        pathBuilder.close();
        pathBuilder.moveTo(12.0f, 4.0f);
        pathBuilder.curveToRelative(2.76f, 0.0f, 5.0f, 2.24f, 5.0f, 5.0f);
        pathBuilder.reflectiveCurveToRelative(-2.24f, 5.0f, -5.0f, 5.0f);
        pathBuilder.reflectiveCurveToRelative(-5.0f, -2.24f, -5.0f, -5.0f);
        pathBuilder.reflectiveCurveTo(9.24f, 4.0f, 12.0f, 4.0f);
        pathBuilder.close();
        ...
        pathBuilder5.moveTo(7.0f, 19.0f);
