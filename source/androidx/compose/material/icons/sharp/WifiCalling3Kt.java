...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_wifiCalling3", "Landroidx/compose/material/icons/Icons$Sharp;", "getWifiCalling3", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "WifiCalling3", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
...
public final class WifiCalling3Kt {
    ...
    /* renamed from: a */
    public static ImageVector f23190a;

    @NotNull
    public static final ImageVector getWifiCalling3(@NotNull Icons.Sharp sharp) {
        Intrinsics.checkNotNullParameter(sharp, "<this>");
        ImageVector imageVector = f23190a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.WifiCalling3", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder4.moveTo(21.0f, 15.0f);
        pathBuilder4.lineToRelative(-5.0f, -1.0f);
        pathBuilder4.lineToRelative(-2.9f, 2.9f);
        pathBuilder4.curveToRelative(-2.5f, -1.43f, -4.57f, -3.5f, -6.0f, -6.0f);
        pathBuilder4.lineTo(10.0f, 8.0f);
        pathBuilder4.lineTo(9.0f, 3.0f);
        pathBuilder4.lineTo(3.0f, 3.0f);
        pathBuilder4.curveToRelative(0.0f, 3.28f, 0.89f, 6.35f, 2.43f, 9.0f);
        pathBuilder4.curveToRelative(1.58f, 2.73f, 3.85f, 4.99f, 6.57f, 6.57f);
        pathBuilder4.curveToRelative(2.65f, 1.53f, 5.72f, 2.43f, 9.0f, 2.43f);
        pathBuilder4.lineTo(21.0f, 15.0f);
        pathBuilder4.close();
