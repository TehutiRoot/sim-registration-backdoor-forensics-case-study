...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_formatColorFill", "Landroidx/compose/material/icons/Icons$Sharp;", "getFormatColorFill", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "FormatColorFill", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
...
public final class FormatColorFillKt {
    ...
    /* renamed from: a */
    public static ImageVector f21906a;

    @NotNull
    public static final ImageVector getFormatColorFill(@NotNull Icons.Sharp sharp) {
        Intrinsics.checkNotNullParameter(sharp, "<this>");
        ImageVector imageVector = f21906a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.FormatColorFill", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.moveTo(10.0f, 17.62f);
        pathBuilder.lineTo(17.62f, 10.0f);
        pathBuilder.lineToRelative(-10.0f, -10.0f);
        pathBuilder.lineTo(6.21f, 1.41f);
        pathBuilder.lineToRelative(2.38f, 2.38f);
        pathBuilder.lineTo(2.38f, 10.0f);
        pathBuilder.lineTo(10.0f, 17.62f);
        pathBuilder.close();
