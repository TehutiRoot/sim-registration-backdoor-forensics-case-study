...
public final class WifiTetheringErrorRoundedKt {
    ...
    /* renamed from: a */
    public static ImageVector f23200a;

    @NotNull
    public static final ImageVector getWifiTetheringErrorRounded(@NotNull Icons.Sharp sharp) {
        Intrinsics.checkNotNullParameter(sharp, "<this>");
        ImageVector imageVector = f23200a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.WifiTetheringErrorRounded", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
