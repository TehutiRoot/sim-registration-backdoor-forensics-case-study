...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_autoFixHigh", "Landroidx/compose/material/icons/Icons$Sharp;", "getAutoFixHigh", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "AutoFixHigh", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nAutoFixHigh.kt\nKotlin\n*S Kotlin\n*F\n+ 1 AutoFixHigh.kt\nandroidx/compose/material/icons/sharp/AutoFixHighKt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,82:1\n122#2:83\n116#2,3:84\n119#2,3:88\n132#2,18:91\n152#2:128\n132#2,18:129\n152#2:166\n132#2,18:167\n152#2:204\n132#2,18:205\n152#2:242\n174#3:87\n694#4,2:109\n706#4,2:111\n708#4,11:117\n694#4,2:147\n706#4,2:149\n708#4,11:155\n694#4,2:185\n706#4,2:187\n708#4,11:193\n694#4,2:223\n706#4,2:225\n708#4,11:231\n64#5,4:113\n64#5,4:151\n64#5,4:189\n64#5,4:227\n*S KotlinDebug\n*F\n+ 1 AutoFixHigh.kt\nandroidx/compose/material/icons/sharp/AutoFixHighKt\n*L\n29#1:83\n29#1:84,3\n29#1:88,3\n30#1:91,18\n30#1:128\n41#1:129,18\n41#1:166\n52#1:167,18\n52#1:204\n63#1:205,18\n63#1:242\n29#1:87\n30#1:109,2\n30#1:111,2\n30#1:117,11\n41#1:147,2\n41#1:149,2\n41#1:155,11\n52#1:185,2\n52#1:187,2\n52#1:193,11\n63#1:223,2\n63#1:225,2\n63#1:231,11\n30#1:113,4\n41#1:151,4\n52#1:189,4\n63#1:227,4\n*E\n"})
/* loaded from: classes.dex */
public final class AutoFixHighKt {

    /* renamed from: a */
    public static ImageVector f21295a;

    @NotNull
    public static final ImageVector getAutoFixHigh(@NotNull Icons.Sharp sharp) {
        Intrinsics.checkNotNullParameter(sharp, "<this>");
        ImageVector imageVector = f21295a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.AutoFixHigh", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder4.moveTo(18.41f, 9.83f);
        pathBuilder4.lineToRelative(-4.24f, -4.24f);
        pathBuilder4.lineTo(1.59f, 18.17f);
        pathBuilder4.lineToRelative(4.24f, 4.24f);
        pathBuilder4.lineTo(18.41f, 9.83f);
        pathBuilder4.close();
