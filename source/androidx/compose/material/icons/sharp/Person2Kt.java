...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_person2", "Landroidx/compose/material/icons/Icons$Sharp;", "getPerson2", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "Person2", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nPerson2.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Person2.kt\nandroidx/compose/material/icons/sharp/Person2Kt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,57:1\n122#2:58\n116#2,3:59\n119#2,3:63\n132#2,18:66\n152#2:103\n132#2,18:104\n152#2:141\n174#3:62\n694#4,2:84\n706#4,2:86\n708#4,11:92\n694#4,2:122\n706#4,2:124\n708#4,11:130\n64#5,4:88\n64#5,4:126\n*S KotlinDebug\n*F\n+ 1 Person2.kt\nandroidx/compose/material/icons/sharp/Person2Kt\n*L\n29#1:58\n29#1:59,3\n29#1:63,3\n30#1:66,18\n30#1:103\n41#1:104,18\n41#1:141\n29#1:62\n30#1:84,2\n30#1:86,2\n30#1:92,11\n41#1:122,2\n41#1:124,2\n41#1:130,11\n30#1:88,4\n41#1:126,4\n*E\n"})
/* loaded from: classes.dex */
public final class Person2Kt {

    /* renamed from: a */
    public static ImageVector f22463a;

    @NotNull
    public static final ImageVector getPerson2(@NotNull Icons.Sharp sharp) {
        Intrinsics.checkNotNullParameter(sharp, "<this>");
        ImageVector imageVector = f22463a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.Person2", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
