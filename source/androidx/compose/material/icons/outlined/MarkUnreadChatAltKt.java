...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_markUnreadChatAlt", "Landroidx/compose/material/icons/Icons$Outlined;", "getMarkUnreadChatAlt", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "MarkUnreadChatAlt", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nMarkUnreadChatAlt.kt\nKotlin\n*S Kotlin\n*F\n+ 1 MarkUnreadChatAlt.kt\nandroidx/compose/material/icons/outlined/MarkUnreadChatAltKt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,81:1\n122#2:82\n116#2,3:83\n119#2,3:87\n132#2,18:90\n152#2:127\n132#2,18:128\n152#2:165\n132#2,18:166\n152#2:203\n132#2,18:204\n152#2:241\n132#2,18:242\n152#2:279\n174#3:86\n694#4,2:108\n706#4,2:110\n708#4,11:116\n694#4,2:146\n706#4,2:148\n708#4,11:154\n694#4,2:184\n706#4,2:186\n708#4,11:192\n694#4,2:222\n706#4,2:224\n708#4,11:230\n694#4,2:260\n706#4,2:262\n708#4,11:268\n64#5,4:112\n64#5,4:150\n64#5,4:188\n64#5,4:226\n64#5,4:264\n*S KotlinDebug\n*F\n+ 1 MarkUnreadChatAlt.kt\nandroidx/compose/material/icons/outlined/MarkUnreadChatAltKt\n*L\n29#1:82\n29#1:83,3\n29#1:87,3\n30#1:90,18\n30#1:127\n47#1:128,18\n47#1:165\n53#1:166,18\n53#1:203\n60#1:204,18\n60#1:241\n67#1:242,18\n67#1:279\n29#1:86\n30#1:108,2\n30#1:110,2\n30#1:116,11\n47#1:146,2\n47#1:148,2\n47#1:154,11\n53#1:184,2\n53#1:186,2\n53#1:192,11\n60#1:222,2\n60#1:224,2\n60#1:230,11\n67#1:260,2\n67#1:262,2\n67#1:268,11\n30#1:112,4\n47#1:150,4\n53#1:188,4\n60#1:226,4\n67#1:264,4\n*E\n"})
/* loaded from: classes.dex */
public final class MarkUnreadChatAltKt {

    /* renamed from: a */
    public static ImageVector f17982a;

    @NotNull
    public static final ImageVector getMarkUnreadChatAlt(@NotNull Icons.Outlined outlined) {
        Intrinsics.checkNotNullParameter(outlined, "<this>");
        ImageVector imageVector = f17982a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.MarkUnreadChatAlt", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.curveToRelative(-0.08f, -0.39f, -0.18f, -1.11f, 0.0f, -2.0f);
        pathBuilder.horizontalLineTo(4.0f);
        ...
        pathBuilder.verticalLineTo(6.98f);
        pathBuilder.curveToRelative(-0.58f, 0.44f, -1.26f, 0.77f, -2.0f, 0.92f);
        ...
        pathBuilder5.moveTo(6.0f, 8.0f);
        pathBuilder5.horizontalLineToRelative(12.0f);
        pathBuilder5.verticalLineTo(7.9f);
        pathBuilder5.curveToRelative(-1.21f, -0.25f, -2.25f, -0.95f, -2.97f, -1.9f);
