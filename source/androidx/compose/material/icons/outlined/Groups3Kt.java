...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_groups3", "Landroidx/compose/material/icons/Icons$Outlined;", "getGroups3", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "Groups3", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nGroups3.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Groups3.kt\nandroidx/compose/material/icons/outlined/Groups3Kt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,102:1\n122#2:103\n116#2,3:104\n119#2,3:108\n132#2,18:111\n152#2:148\n132#2,18:149\n152#2:186\n132#2,18:187\n152#2:224\n132#2,18:225\n152#2:262\n132#2,18:263\n152#2:300\n132#2,18:301\n152#2:338\n174#3:107\n694#4,2:129\n706#4,2:131\n708#4,11:137\n694#4,2:167\n706#4,2:169\n708#4,11:175\n694#4,2:205\n706#4,2:207\n708#4,11:213\n694#4,2:243\n706#4,2:245\n708#4,11:251\n694#4,2:281\n706#4,2:283\n708#4,11:289\n694#4,2:319\n706#4,2:321\n708#4,11:327\n64#5,4:133\n64#5,4:171\n64#5,4:209\n64#5,4:247\n64#5,4:285\n64#5,4:323\n*S KotlinDebug\n*F\n+ 1 Groups3.kt\nandroidx/compose/material/icons/outlined/Groups3Kt\n*L\n29#1:103\n29#1:104,3\n29#1:108,3\n30#1:111,18\n30#1:148\n48#1:149,18\n48#1:186\n59#1:187,18\n59#1:224\n70#1:225,18\n70#1:262\n84#1:263,18\n84#1:300\n91#1:301,18\n91#1:338\n29#1:107\n30#1:129,2\n30#1:131,2\n30#1:137,11\n48#1:167,2\n48#1:169,2\n48#1:175,11\n59#1:205,2\n59#1:207,2\n59#1:213,11\n70#1:243,2\n70#1:245,2\n70#1:251,11\n84#1:281,2\n84#1:283,2\n84#1:289,11\n91#1:319,2\n91#1:321,2\n91#1:327,11\n30#1:133,4\n48#1:171,4\n59#1:209,4\n70#1:247,4\n84#1:285,4\n91#1:323,4\n*E\n"})
/* loaded from: classes.dex */
public final class Groups3Kt {

    /* renamed from: a */
    public static ImageVector f17714a;

    @NotNull
    public static final ImageVector getGroups3(@NotNull Icons.Outlined outlined) {
        Intrinsics.checkNotNullParameter(outlined, "<this>");
        ImageVector imageVector = f17714a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Groups3", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.curveToRelative(0.09f, -0.23f, 0.27f, -0.42f, 0.49f, -0.52f);
        ...
        pathBuilder2.moveTo(1.22f, 14.58f);
        ...
        pathBuilder2.curveTo(3.01f, 14.0f, 2.07f, 14.21f, 1.22f, 14.58f);
        pathBuilder2.close();
        ...
        pathBuilder3.moveTo(22.78f, 14.58f);
        pathBuilder3.curveTo(21.93f, 14.21f, 20.99f, 14.0f, 20.0f, 14.0f);
        pathBuilder3.curveToRelative(-0.39f, 0.0f, -0.76f, 0.04f, -1.13f, 0.1f);
        pathBuilder3.curveToRelative(0.4f, 0.68f, 0.63f, 1.46f, 0.63f, 2.29f);
        pathBuilder3.verticalLineTo(18.0f);
        pathBuilder3.lineToRelative(4.5f, 0.0f);
        pathBuilder3.verticalLineToRelative(-1.57f);
        pathBuilder3.curveTo(24.0f, 15.62f, 23.52f, 14.9f, 22.78f, 14.58f);
        pathBuilder3.close();
        ...
        pathBuilder4.reflectiveCurveTo(9.0f, 7.34f, 9.0f, 9.0f);
        pathBuilder4.curveTo(9.0f, 10.66f, 10.34f, 12.0f, 12.0f, 12.0f);
        pathBuilder4.close();
        ...
        pathBuilder4.reflectiveCurveTo(11.45f, 8.0f, 12.0f, 8.0f);
        pathBuilder4.close();
        ...
        pathBuilder5.moveTo(1.497f, 11.0f);
        pathBuilder5.lineToRelative(2.503f, -2.503f);
        pathBuilder5.lineToRelative(2.503f, 2.503f);
        pathBuilder5.lineToRelative(-2.503f, 2.503f);
        pathBuilder5.close();
        ...
        pathBuilder6.lineToRelative(-2.5f, 4.0f);
        pathBuilder6.lineToRelative(5.0f, 0.0f);
        pathBuilder6.close();
