...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_sportsEsports", "Landroidx/compose/material/icons/Icons$Outlined;", "getSportsEsports", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "SportsEsports", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
...
public final class SportsEsportsKt {
    ...
    /* renamed from: a */
    public static ImageVector f18599a;

    @NotNull
    public static final ImageVector getSportsEsports(@NotNull Icons.Outlined outlined) {
        Intrinsics.checkNotNullParameter(outlined, "<this>");
        ImageVector imageVector = f18599a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.SportsEsports", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(19.48f, 16.81f);
        pathBuilder.curveTo(19.4f, 16.9f, 19.27f, 17.0f, 19.06f, 17.0f);
        pathBuilder.curveToRelative(-0.15f, 0.0f, -0.29f, -0.06f, -0.39f, -0.16f);
        pathBuilder.lineTo(15.83f, 14.0f);
        pathBuilder.horizontalLineTo(8.17f);
        pathBuilder.lineToRelative(-2.84f, 2.84f);
        pathBuilder.curveTo(5.23f, 16.94f, 5.09f, 17.0f, 4.94f, 17.0f);
        ...
        pathBuilder.lineToRelative(1.09f, -7.66f);
        pathBuilder.curveTo(5.63f, 7.74f, 6.48f, 7.0f, 7.47f, 7.0f);
        pathBuilder.horizontalLineToRelative(9.06f);
        pathBuilder.curveToRelative(0.99f, 0.0f, 1.84f, 0.74f, 1.98f, 1.72f);
        pathBuilder.lineToRelative(1.09f, 7.66f);
        pathBuilder.curveTo(19.63f, 16.58f, 19.55f, 16.72f, 19.48f, 16.81f);
        pathBuilder.close();
        ...
        pathBuilder4.moveTo(15.0f, 9.0f);
