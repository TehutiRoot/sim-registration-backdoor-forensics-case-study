...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_driveFileRenameOutline", "Landroidx/compose/material/icons/Icons$Outlined;", "getDriveFileRenameOutline", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "DriveFileRenameOutline", "material-icons-extended_release"}, m28849k = 2, m28848mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nDriveFileRenameOutline.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DriveFileRenameOutline.kt\nandroidx/compose/material/icons/outlined/DriveFileRenameOutlineKt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,69:1\n122#2:70\n116#2,3:71\n119#2,3:75\n132#2,18:78\n152#2:115\n132#2,18:116\n152#2:153\n132#2,18:154\n152#2:191\n174#3:74\n694#4,2:96\n706#4,2:98\n708#4,11:104\n694#4,2:134\n706#4,2:136\n708#4,11:142\n694#4,2:172\n706#4,2:174\n708#4,11:180\n64#5,4:100\n64#5,4:138\n64#5,4:176\n*S KotlinDebug\n*F\n+ 1 DriveFileRenameOutline.kt\nandroidx/compose/material/icons/outlined/DriveFileRenameOutlineKt\n*L\n29#1:70\n29#1:71,3\n29#1:75,3\n30#1:78,18\n30#1:115\n37#1:116,18\n37#1:153\n53#1:154,18\n53#1:191\n29#1:74\n30#1:96,2\n30#1:98,2\n30#1:104,11\n37#1:134,2\n37#1:136,2\n37#1:142,11\n53#1:172,2\n53#1:174,2\n53#1:180,11\n30#1:100,4\n37#1:138,4\n53#1:176,4\n*E\n"})
/* loaded from: classes.dex */
public final class DriveFileRenameOutlineKt {

    /* renamed from: a */
    public static ImageVector f17441a;

    @NotNull
    public static final ImageVector getDriveFileRenameOutline(@NotNull Icons.Outlined outlined) {
        Intrinsics.checkNotNullParameter(outlined, "<this>");
        ImageVector imageVector = f17441a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.DriveFileRenameOutline", C3641Dp.m73658constructorimpl(24.0f), C3641Dp.m73658constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder3.curveTo(16.17f, 4.09f, 15.92f, 4.0f, 15.66f, 4.0f);
