...
public final class FloatingActionButtonKt$ExtendedFloatingActionButton$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public FloatingActionButtonKt$ExtendedFloatingActionButton$2(Function2<? super Composer, ? super Integer, Unit> function2, int i, Function2<? super Composer, ? super Integer, Unit> function22) {
        super(2);
        this.$icon = function2;
        this.$$dirty = i;
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        float f3 = this.$icon == null ? FloatingActionButtonKt.f14493d : FloatingActionButtonKt.f14492c;
        Modifier.Companion companion = Modifier.Companion;
        f = FloatingActionButtonKt.f14493d;
        Modifier m69533paddingqDBjuR0$default = PaddingKt.m69533paddingqDBjuR0$default(companion, f3, 0.0f, f, 0.0f, 10, null);
        ...
        if (function2 != null) {
            ...
            f2 = FloatingActionButtonKt.f14492c;
