...
@DebugMetadata(m28801c = "androidx.compose.material.SwipeableKt$swipeable$3$4$1", m28800f = "Swipeable.kt", m28799i = {}, m28798l = {}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
...
public final class SwipeableKt$swipeable$3$4$1 extends SuspendLambda implements Function3<CoroutineScope, Float, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(m28801c = "androidx.compose.material.SwipeableKt$swipeable$3$4$1$1", m28800f = "Swipeable.kt", m28799i = {}, m28798l = {616}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
    /* renamed from: androidx.compose.material.SwipeableKt$swipeable$3$4$1$1 */
    /* loaded from: classes.dex */
    public static final class C31871 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ SwipeableState<T> $state;
        final /* synthetic */ float $velocity;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C31871(SwipeableState<T> swipeableState, float f, Continuation<? super C31871> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C31871(this.$state, this.$velocity, continuation);
        }
        ...
        public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C31871) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ResultKt.throwOnFailure(obj);
            AbstractC1552Vc.m65753e((CoroutineScope) this.L$0, null, null, new C31871(this.$state, this.F$0, null), 3, null);
            return Unit.INSTANCE;
        }
        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
    }
