...
public final class TextFieldKt$TextField$7 extends Lambda implements Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit> {
    ...
    public final void invoke(@NotNull Function2<? super Composer, ? super Integer, Unit> innerTextField, @Nullable Composer composer, int i) {
        ...
        int i3 = this.$$dirty;
        int i4 = this.$$dirty1;
        textFieldDefaults.TextFieldDecorationBox(text, innerTextField, z, z2, visualTransformation, mutableInteractionSource, z3, function2, function22, function23, function24, textFieldColors, null, composer, ((i4 >> 3) & 7168) | ((i2 << 3) & 112) | ((i3 >> 3) & 896) | ((i4 << 9) & 57344) | ((i4 >> 6) & 458752) | ((i4 << 18) & 3670016) | ((i3 << 3) & 29360128) | ((i3 << 3) & 234881024) | ((i3 << 3) & 1879048192), ((i3 >> 27) & 14) | 3072 | ((i4 >> 24) & 112), 4096);
        if (ComposerKt.isTraceInProgress()) {
