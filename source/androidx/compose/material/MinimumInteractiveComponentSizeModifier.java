...
public final class MinimumInteractiveComponentSizeModifier implements LayoutModifier {
    ...
    public boolean equals(Object obj) {
        ...
        return DpSize.m73753equalsimpl0(this.f14516a, minimumInteractiveComponentSizeModifier.f14516a);
    }
    ...
    public int hashCode() {
        return DpSize.m73758hashCodeimpl(this.f14516a);
    }
    ...
    public MeasureResult mo69160measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        int max = Math.max(mo72811measureBRTryo0.getWidth(), measure.mo69432roundToPx0680j_4(DpSize.m73756getWidthD9Ej5fM(this.f14516a)));
        int max2 = Math.max(mo72811measureBRTryo0.getHeight(), measure.mo69432roundToPx0680j_4(DpSize.m73754getHeightD9Ej5fM(this.f14516a)));
