...
public final class CardKt {
    ...
    public static final void m69947Card9VG74zQ(@NotNull Function0<Unit> onClick, @Nullable Modifier modifier, @Nullable Shape shape, long j, long j2, @Nullable BorderStroke borderStroke, float f, @Nullable MutableInteractionSource mutableInteractionSource, @Nullable Indication indication, boolean z, @Nullable String str, @Nullable Role role, @NotNull Function2<? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, int i, int i2, int i3) {
        ...
        long m69974getSurface0d7_KjU = (i3 & 8) != 0 ? MaterialTheme.INSTANCE.getColors(composer, 6).m69974getSurface0d7_KjU() : j;
        long m69988contentColorForek8zF_U = (i3 & 16) != 0 ? ColorsKt.m69988contentColorForek8zF_U(m69974getSurface0d7_KjU, composer, (i >> 9) & 14) : j2;
        BorderStroke borderStroke2 = (i3 & 32) != 0 ? null : borderStroke;
        float m73658constructorimpl = (i3 & 64) != 0 ? C3641Dp.m73658constructorimpl(1) : f;
        if ((i3 & 128) != 0) {
        ...
        SurfaceKt.m70103Surface9VG74zQ(onClick, modifier2, medium, m69974getSurface0d7_KjU, m69988contentColorForek8zF_U, borderStroke2, m73658constructorimpl, mutableInteractionSource2, indication2, z2, str2, role2, content, composer, i & 2147483646, i2 & 1022, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m69948CardFjzlyU(@Nullable Modifier modifier, @Nullable Shape shape, long j, long j2, @Nullable BorderStroke borderStroke, float f, @NotNull Function2<? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, int i, int i2) {
        Modifier modifier2;
        ...
        if ((i2 & 4) != 0) {
            j3 = MaterialTheme.INSTANCE.getColors(composer, 6).m69974getSurface0d7_KjU();
        } else {
            j3 = j;
        }
        if ((i2 & 8) != 0) {
            j4 = ColorsKt.m69988contentColorForek8zF_U(j3, composer, (i >> 6) & 14);
        } else {
            j4 = j2;
        }
        if ((i2 & 16) != 0) {
        ...
        if ((i2 & 32) != 0) {
            f2 = C3641Dp.m73658constructorimpl(1);
        } else {
            f2 = f;
        }
        if (ComposerKt.isTraceInProgress()) {
        ...
        SurfaceKt.m70104SurfaceFjzlyU(modifier2, cornerBasedShape, j3, j4, borderStroke2, f2, content, composer, i & 4194302, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final void m69949CardLPr_se0(@NotNull Function0<Unit> onClick, @Nullable Modifier modifier, boolean z, @Nullable Shape shape, long j, long j2, @Nullable BorderStroke borderStroke, float f, @Nullable MutableInteractionSource mutableInteractionSource, @NotNull Function2<? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, int i, int i2) {
        ...
        if ((i2 & 32) != 0) {
            j4 = ColorsKt.m69988contentColorForek8zF_U(j3, composer, (i >> 12) & 14);
        } else {
            j4 = j2;
        }
        if ((i2 & 64) != 0) {
        ...
        SurfaceKt.m70105SurfaceLPr_se0(onClick, modifier2, z2, cornerBasedShape, j3, j4, borderStroke2, f2, mutableInteractionSource2, content, composer, i & 2147483646, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
