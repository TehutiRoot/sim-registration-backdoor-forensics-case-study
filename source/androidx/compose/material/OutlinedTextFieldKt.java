...
public final class OutlinedTextFieldKt {
    ...
    /* renamed from: a */
    public static final float f14548a = C3641Dp.m73658constructorimpl(4);

    /* renamed from: b */
    public static final float f14549b = C3641Dp.m73658constructorimpl(8);
    ...
    */
    ...
    public static final void OutlinedTextFieldLayout(@NotNull Modifier modifier, @NotNull Function2<? super Composer, ? super Integer, Unit> textField, @Nullable Function3<? super Modifier, ? super Composer, ? super Integer, Unit> function3, @Nullable Function2<? super Composer, ? super Integer, Unit> function2, @Nullable Function2<? super Composer, ? super Integer, Unit> function22, @Nullable Function2<? super Composer, ? super Integer, Unit> function23, boolean z, float f, @NotNull Function1<? super Size, Unit> onLabelMeasured, @NotNull Function2<? super Composer, ? super Integer, Unit> border, @NotNull PaddingValues paddingValues, @Nullable Composer composer, int i, int i2) {
        ...
        if ((i5 & 1533916891) == 306783378 && (i6 & 11) == 2 && startRestartGroup.getSkipping()) {
            ...
            if (function3 != null) {
                function3.invoke(LayoutIdKt.layoutId(companion2, "Hint").then(m69533paddingqDBjuR0$default), startRestartGroup, Integer.valueOf((i5 >> 3) & 112));
            }
            startRestartGroup.endReplaceableGroup();
            Modifier then3 = LayoutIdKt.layoutId(companion2, "TextField").then(m69533paddingqDBjuR0$default);
            startRestartGroup.startReplaceableGroup(733328855);
    ...
    /* renamed from: a */
    public static final int m60864a(int i, int i2, int i3, int i4, int i5, float f, long j, float f2, PaddingValues paddingValues) {
        int max = Math.max(i3, Math.max(i5, MathHelpersKt.lerp(i4, 0, f)));
        float mo69159calculateTopPaddingD9Ej5fM = paddingValues.mo69159calculateTopPaddingD9Ej5fM() * f2;
        return Math.max(Constraints.m73627getMinHeightimpl(j), Math.max(i, Math.max(i2, AbstractC21140mr0.roundToInt(MathHelpersKt.lerp(mo69159calculateTopPaddingD9Ej5fM, Math.max(mo69159calculateTopPaddingD9Ej5fM, i4 / 2.0f), f) + max + (paddingValues.mo69156calculateBottomPaddingD9Ej5fM() * f2)))));
    }

    /* renamed from: b */
    public static final int m60863b(int i, int i2, int i3, int i4, int i5, float f, long j, float f2, PaddingValues paddingValues) {
        int max = i + Math.max(i3, Math.max(MathHelpersKt.lerp(i4, 0, f), i5)) + i2;
        LayoutDirection layoutDirection = LayoutDirection.Ltr;
        return Math.max(max, Math.max(AbstractC21140mr0.roundToInt((i4 + (C3641Dp.m73658constructorimpl(paddingValues.mo69157calculateLeftPaddingu2uoSUM(layoutDirection) + paddingValues.mo69158calculateRightPaddingu2uoSUM(layoutDirection)) * f2)) * f), Constraints.m73628getMinWidthimpl(j)));
    }

    /* renamed from: c */
    public static final void m60862c(Placeable.PlacementScope placementScope, int i, int i2, Placeable placeable, Placeable placeable2, Placeable placeable3, Placeable placeable4, Placeable placeable5, Placeable placeable6, float f, boolean z, float f2, LayoutDirection layoutDirection, PaddingValues paddingValues) {
        ...
        if (placeable4 != null) {
            Placeable.PlacementScope.placeRelative$default(placementScope, placeable4, AbstractC21140mr0.roundToInt(placeable == null ? 0.0f : (TextFieldImplKt.widthOrZero(placeable) - horizontalIconPadding) * (1 - f)) + roundToInt2, MathHelpersKt.lerp(z ? Alignment.Companion.getCenterVertically().align(placeable4.getHeight(), i) : roundToInt, -(placeable4.getHeight() / 2), f), 0.0f, 4, null);
        }
        ...
        Placeable.PlacementScope.m72850place70tqf50$default(placementScope, placeable6, IntOffset.Companion.m73786getZeronOccac(), 0.0f, 2, null);
    }
    ...
    public static final Modifier m70063outlineCutout12SF9DM(@NotNull Modifier outlineCutout, long j, @NotNull PaddingValues paddingValues) {
