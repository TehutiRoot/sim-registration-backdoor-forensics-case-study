...
public final class TabRowKt$ScrollableTabRow$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    /* loaded from: classes.dex */
    public static final class C31961 extends Lambda implements Function2<SubcomposeMeasureScope, Constraints, MeasureResult> {
        final /* synthetic */ int $$dirty;
        final /* synthetic */ Function2<Composer, Integer, Unit> $divider;
        final /* synthetic */ float $edgePadding;
        final /* synthetic */ Function3<List<TabPosition>, Composer, Integer, Unit> $indicator;
        ...
        /* loaded from: classes.dex */
        public static final class C31972 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
            final /* synthetic */ int $$dirty;
            ...
            /* loaded from: classes.dex */
            public static final class C31983 extends Lambda implements Function2<Composer, Integer, Unit> {
                final /* synthetic */ int $$dirty;
                final /* synthetic */ Function3<List<TabPosition>, Composer, Integer, Unit> $indicator;
                ...
                public C31983(Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function3, List<TabPosition> list, int i) {
                    super(2);
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                ...
                for (Measurable measurable : this.$this_SubcomposeLayout.subcompose(TabSlots.Divider, this.$divider)) {
                    ...
                    Placeable.PlacementScope.placeRelative$default(layout, mo72811measureBRTryo0, 0, intRef2.element - mo72811measureBRTryo0.getHeight(), 0.0f, 4, null);
                    intRef = intRef;
                    intRef2 = intRef2;
                    j = j;
                }
                ...
                for (Measurable measurable2 : this.$this_SubcomposeLayout.subcompose(TabSlots.Indicator, ComposableLambdaKt.composableLambdaInstance(230769237, true, new C31983(this.$indicator, arrayList, this.$$dirty)))) {
                    Placeable.PlacementScope.placeRelative$default(layout, measurable2.mo72811measureBRTryo0(Constraints.Companion.m73634fixedJhjzzOo(intRef3.element, intRef4.element)), 0, 0, 0.0f, 4, null);
                }
                this.$scrollableTabData.m60836c(this.$this_SubcomposeLayout, this.$padding, arrayList, this.$selectedTabIndex);
            }
        }

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C31961(float f, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, ScrollableTabData scrollableTabData, int i, Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function3, int i2) {
            super(2);
            this.$edgePadding = f;
            this.$tabs = function2;
        ...
        public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeMeasureScope subcomposeMeasureScope, Constraints constraints) {
            return m70131invoke0kLqBqw(subcomposeMeasureScope, constraints.m73632unboximpl());
        }

        @NotNull
        /* renamed from: invoke-0kLqBqw  reason: not valid java name */
        public final MeasureResult m70131invoke0kLqBqw(@NotNull SubcomposeMeasureScope SubcomposeLayout, long j) {
            float f;
            ...
            long m73618copyZbe2FdA$default = Constraints.m73618copyZbe2FdA$default(j, mo69432roundToPx0680j_4, 0, 0, 0, 14, null);
            ...
            intRef.element = mo69432roundToPx0680j_42 * 2;
            Ref.IntRef intRef2 = new Ref.IntRef();
            for (Placeable placeable : arrayList) {
                intRef.element += placeable.getWidth();
                intRef2.element = Math.max(intRef2.element, placeable.getHeight());
            }
            return MeasureScope.CC.m59532q(SubcomposeLayout, intRef.element, intRef2.element, null, new C31972(mo69432roundToPx0680j_42, arrayList, SubcomposeLayout, this.$divider, this.$scrollableTabData, this.$selectedTabIndex, j, intRef, intRef2, this.$indicator, this.$$dirty), 4, null);
        }
    }
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        composer.endReplaceableGroup();
        SubcomposeLayoutKt.SubcomposeLayout(ClipKt.clipToBounds(SelectableGroupKt.selectableGroup(ScrollKt.horizontalScroll$default(SizeKt.wrapContentSize$default(SizeKt.fillMaxWidth$default(Modifier.Companion, 0.0f, 1, null), Alignment.Companion.getCenterStart(), false, 2, null), rememberScrollState, false, null, false, 14, null))), new C31961(this.$edgePadding, this.$tabs, this.$divider, (ScrollableTabData) rememberedValue2, this.$selectedTabIndex, this.$indicator, this.$$dirty), composer, 0, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    }
