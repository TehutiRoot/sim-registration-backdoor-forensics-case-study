...
public final class SliderKt$Slider$3$draggableState$1$1 extends Lambda implements Function1<Float, Unit> {
    ...
    public final void invoke(float f) {
        ...
        invoke$scaleToUserValue = SliderKt$Slider$3.invoke$scaleToUserValue(this.$minPx, this.$maxPx, this.$valueRange, AbstractC11719c.coerceIn(this.$rawOffset.getFloatValue(), this.$minPx.element, this.$maxPx.element));
