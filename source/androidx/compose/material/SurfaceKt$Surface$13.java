...
public final class SurfaceKt$Surface$13 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        m60804b = SurfaceKt.m60804b(this.$color, (ElevationOverlay) composer.consume(ElevationOverlayKt.getLocalElevationOverlay()), this.$absoluteElevation, composer, (this.$$dirty >> 9) & 14);
        m60805a = SurfaceKt.m60805a(minimumInteractiveComponentSize, shape, m60804b, this.$border, this.$elevation);
        Modifier then = m60805a.then(ClickableKt.m69342clickableO2vRcR0(Modifier.Companion, this.$interactionSource, this.$indication, this.$enabled, this.$onClickLabel, this.$role, this.$onClick));
