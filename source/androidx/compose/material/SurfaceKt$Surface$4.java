...
public final class SurfaceKt$Surface$4 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        m60804b = SurfaceKt.m60804b(this.$color, (ElevationOverlay) composer.consume(ElevationOverlayKt.getLocalElevationOverlay()), this.$absoluteElevation, composer, (this.$$dirty >> 12) & 14);
        m60805a = SurfaceKt.m60805a(minimumInteractiveComponentSize, shape, m60804b, this.$border, this.$elevation);
        Modifier m69343clickableO2vRcR0$default = ClickableKt.m69343clickableO2vRcR0$default(m60805a, this.$interactionSource, RippleKt.m70180rememberRipple9IZ8Weo(false, 0.0f, 0L, composer, 0, 7), this.$enabled, null, null, this.$onClick, 24, null);
        ...
        Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> modifierMaterializerOf = LayoutKt.modifierMaterializerOf(m69343clickableO2vRcR0$default);
