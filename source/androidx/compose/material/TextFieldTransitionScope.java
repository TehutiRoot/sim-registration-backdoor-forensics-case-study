...
public final class TextFieldTransitionScope {
    ...
    /* renamed from: a */
    public static final TextFieldTransitionScope f14705a = new TextFieldTransitionScope();
    ...
    /* renamed from: b */
    public static final float m60763b(State state) {
        return ((Number) state.getValue()).floatValue();
    }

    /* renamed from: c */
    public static final float m60762c(State state) {
        return ((Number) state.getValue()).floatValue();
    }

    /* renamed from: d */
    public static final long m60761d(State state) {
        return ((Color) state.getValue()).m71745unboximpl();
    }

    /* renamed from: e */
    public static final long m60760e(State state) {
        return ((Color) state.getValue()).m71745unboximpl();
    }
    ...
    */
    public final void m60764a(androidx.compose.material.InputPhase r26, long r27, long r29, kotlin.jvm.functions.Function3 r31, boolean r32, kotlin.jvm.functions.Function6 r33, androidx.compose.runtime.Composer r34, int r35) {
        /*
            Method dump skipped, instructions count: 1049
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.TextFieldTransitionScope.m60764a(androidx.compose.material.InputPhase, long, long, kotlin.jvm.functions.Function3, boolean, kotlin.jvm.functions.Function6, androidx.compose.runtime.Composer, int):void");
    }
}
