...
public final class DragGestureDetectorCopyKt {
    ...
    /* renamed from: a */
    public static final float f14456a;

    /* renamed from: b */
    public static final float f14457b;

    /* renamed from: c */
    public static final float f14458c;

    static {
        float m73658constructorimpl = C3641Dp.m73658constructorimpl((float) 0.125d);
        f14456a = m73658constructorimpl;
        float m73658constructorimpl2 = C3641Dp.m73658constructorimpl(18);
        f14457b = m73658constructorimpl2;
        f14458c = m73658constructorimpl / m73658constructorimpl2;
    }

    /* renamed from: a */
    public static final boolean m60913a(PointerEvent pointerEvent, long j) {
    ...
    */
    public static final java.lang.Object m70005awaitHorizontalPointerSlopOrCancellationgDDlDlE(@org.jetbrains.annotations.NotNull androidx.compose.p003ui.input.pointer.AwaitPointerEventScope r20, long r21, int r23, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function2<? super androidx.compose.p003ui.input.pointer.PointerInputChange, ? super java.lang.Float, kotlin.Unit> r24, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super androidx.compose.p003ui.input.pointer.PointerInputChange> r25) {
        /*
            Method dump skipped, instructions count: 388
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.DragGestureDetectorCopyKt.m70005awaitHorizontalPointerSlopOrCancellationgDDlDlE(androidx.compose.ui.input.pointer.AwaitPointerEventScope, long, int, kotlin.jvm.functions.Function2, kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* renamed from: pointerSlop-E8SPZFQ  reason: not valid java name */
    public static final float m70006pointerSlopE8SPZFQ(@NotNull ViewConfiguration pointerSlop, int i) {
        ...
        if (PointerType.m72768equalsimpl0(i, PointerType.Companion.m72773getMouseT8wyACA())) {
            return pointerSlop.getTouchSlop() * f14458c;
        }
