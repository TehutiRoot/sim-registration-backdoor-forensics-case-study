...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\u000b¢\u0006\u0004\b\u0004\u0010\u0005"}, m28850d2 = {"<anonymous>", "", "refreshing", "", "invoke", "(ZLandroidx/compose/runtime/Composer;I)V"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
...
public final class PullRefreshIndicatorKt$PullRefreshIndicator$1$1 extends Lambda implements Function3<Boolean, Composer, Integer, Unit> {
    ...
    public final void invoke(boolean z, @Nullable Composer composer, int i) {
        ...
        float m73658constructorimpl = C3641Dp.m73658constructorimpl(C3641Dp.m73658constructorimpl(f + f2) * 2);
        if (z) {
            composer.startReplaceableGroup(-2035147035);
            f3 = PullRefreshIndicatorKt.f25438d;
            ProgressIndicatorKt.m70066CircularProgressIndicatorLxG7B9w(SizeKt.m69564size3ABfNKs(companion, m73658constructorimpl), j, f3, 0L, 0, composer, ((i3 >> 9) & 112) | 390, 24);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-2035146781);
            PullRefreshIndicatorKt.m60747b(pullRefreshState, j, SizeKt.m69564size3ABfNKs(companion, m73658constructorimpl), composer, ((i3 >> 9) & 112) | 392);
            composer.endReplaceableGroup();
        }
        composer.endReplaceableGroup();
        composer.endNode();
