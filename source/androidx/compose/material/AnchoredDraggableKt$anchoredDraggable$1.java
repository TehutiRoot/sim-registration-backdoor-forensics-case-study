...
@DebugMetadata(m28801c = "androidx.compose.material.AnchoredDraggableKt$anchoredDraggable$1", m28800f = "AnchoredDraggable.kt", m28799i = {}, m28798l = {}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
...
public final class AnchoredDraggableKt$anchoredDraggable$1 extends SuspendLambda implements Function3<CoroutineScope, Float, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(m28801c = "androidx.compose.material.AnchoredDraggableKt$anchoredDraggable$1$1", m28800f = "AnchoredDraggable.kt", m28799i = {}, m28798l = {EACTags.HISTORICAL_BYTES}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
    /* renamed from: androidx.compose.material.AnchoredDraggableKt$anchoredDraggable$1$1 */
    /* loaded from: classes.dex */
    public static final class C30571 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ AnchoredDraggableState<T> $state;
        final /* synthetic */ float $velocity;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C30571(AnchoredDraggableState<T> anchoredDraggableState, float f, Continuation<? super C30571> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C30571(this.$state, this.$velocity, continuation);
        }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ResultKt.throwOnFailure(obj);
            AbstractC1552Vc.m65753e((CoroutineScope) this.L$0, null, null, new C30571(this.$state, this.F$0, null), 3, null);
            return Unit.INSTANCE;
        }
        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
    }
