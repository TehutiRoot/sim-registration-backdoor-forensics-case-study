...
@DebugMetadata(m28801c = "androidx.compose.material.SliderKt$animateToTarget$2", m28800f = "Slider.kt", m28799i = {}, m28798l = {955}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
...
public final class SliderKt$animateToTarget$2 extends SuspendLambda implements Function2<DragScope, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes.dex */
    public static final class C31631 extends Lambda implements Function1<Animatable<Float, AnimationVector1D>, Unit> {
        final /* synthetic */ DragScope $$this$drag;
        final /* synthetic */ Ref.FloatRef $latestValue;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C31631(DragScope dragScope, Ref.FloatRef floatRef) {
            super(1);
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i != 0) {
            ...
            C31631 c31631 = new C31631((DragScope) this.L$0, floatRef);
            this.label = 1;
            if (Animatable$default.animateTo(boxFloat, tweenSpec, boxFloat2, c31631, this) == coroutine_suspended) {
