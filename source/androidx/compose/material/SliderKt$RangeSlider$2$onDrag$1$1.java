...
@Metadata(m28851d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0007\n\u0000\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\n¢\u0006\u0002\b\u0006"}, m28850d2 = {"<anonymous>", "", "isStart", "", TypedValues.CycleType.S_WAVE_OFFSET, "", "invoke"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
...
public final class SliderKt$RangeSlider$2$onDrag$1$1 extends Lambda implements Function2<Boolean, Float, Unit> {
    ...
    public final void invoke(boolean z, float f) {
        ...
        if (z) {
            ...
            rangeTo = AbstractC18012Lr1.rangeTo(AbstractC11719c.coerceIn(this.$rawOffsetStart.getFloatValue(), this.$minPx.element, floatValue), floatValue);
        } else {
            ...
            rangeTo = AbstractC18012Lr1.rangeTo(floatValue2, AbstractC11719c.coerceIn(this.$rawOffsetEnd.getFloatValue(), floatValue2, this.$maxPx.element));
        }
