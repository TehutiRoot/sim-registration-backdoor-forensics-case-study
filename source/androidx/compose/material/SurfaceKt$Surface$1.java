...
public final class SurfaceKt$Surface$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    /* loaded from: classes.dex */
    public static final class C31821 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
        public static final C31821 INSTANCE = new C31821();
    ...
    @DebugMetadata(m28801c = "androidx.compose.material.SurfaceKt$Surface$1$2", m28800f = "Surface.kt", m28799i = {}, m28798l = {}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
    /* renamed from: androidx.compose.material.SurfaceKt$Surface$1$2 */
    /* loaded from: classes.dex */
    public static final class C31832 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        int label;

        public C31832(Continuation<? super C31832> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C31832(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        @Nullable
        public final Object invoke(@NotNull PointerInputScope pointerInputScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C31832) create(pointerInputScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        m60804b = SurfaceKt.m60804b(this.$color, (ElevationOverlay) composer.consume(ElevationOverlayKt.getLocalElevationOverlay()), this.$absoluteElevation, composer, (this.$$dirty >> 6) & 14);
        m60805a = SurfaceKt.m60805a(modifier, shape, m60804b, this.$border, this.$elevation);
        Modifier pointerInput = SuspendingPointerInputFilterKt.pointerInput(SemanticsModifierKt.semantics(m60805a, false, C31821.INSTANCE), Unit.INSTANCE, new C31832(null));
