...
public final class BackdropScaffoldKt$BackdropScaffold$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    @Metadata(m28851d1 = {"\u0000\u0016\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0007\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u000b¢\u0006\u0004\b\u0006\u0010\u0007"}, m28850d2 = {"<anonymous>", "", "constraints", "Landroidx/compose/ui/unit/Constraints;", "backLayerHeight", "", "invoke-jYbf7pk", "(JFLandroidx/compose/runtime/Composer;I)V"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    /* loaded from: classes.dex */
    public static final class C30631 extends Lambda implements Function4<Constraints, Float, Composer, Integer, Unit> {
        final /* synthetic */ int $$dirty;
        final /* synthetic */ int $$dirty1;
        final /* synthetic */ long $frontLayerBackgroundColor;
        final /* synthetic */ Function2<Composer, Integer, Unit> $frontLayerContent;
        ...
        /* loaded from: classes.dex */
        public static final class C30642 extends Lambda implements Function2<Composer, Integer, Unit> {
            final /* synthetic */ int $$dirty;
            final /* synthetic */ int $$dirty1;
            final /* synthetic */ Function2<Composer, Integer, Unit> $frontLayerContent;
            final /* synthetic */ long $frontLayerScrimColor;
            ...
            public C30642(float f, Function2<? super Composer, ? super Integer, Unit> function2, int i, long j, BackdropScaffoldState backdropScaffoldState, int i2, boolean z, CoroutineScope coroutineScope) {
                super(2);
                this.$peekHeight = f;
            ...
            public final void invoke(@Nullable Composer composer, int i) {
                ...
                Modifier m69533paddingqDBjuR0$default = PaddingKt.m69533paddingqDBjuR0$default(Modifier.Companion, 0.0f, 0.0f, 0.0f, this.$peekHeight, 7, null);
                ...
                BackdropScaffoldKt.m60950d(j, new BackdropScaffoldKt$BackdropScaffold$1$1$2$1$1(z, backdropScaffoldState, coroutineScope), backdropScaffoldState.getTargetValue() == BackdropValue.Revealed, composer, (i3 >> 18) & 14);
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C30631(float f, boolean z, boolean z2, BackdropScaffoldState backdropScaffoldState, float f2, int i, Shape shape, long j, long j2, float f3, int i2, float f4, CoroutineScope coroutineScope, float f5, Function2<? super Composer, ? super Integer, Unit> function2, long j3, Function3<? super SnackbarHostState, ? super Composer, ? super Integer, Unit> function3) {
            super(4);
        ...
        public /* bridge */ /* synthetic */ Unit invoke(Constraints constraints, Float f, Composer composer, Integer num) {
            m69917invokejYbf7pk(constraints.m73632unboximpl(), f.floatValue(), composer, num.intValue());
            return Unit.INSTANCE;
        }
        ...
        public final void m69917invokejYbf7pk(long j, float f, @Nullable Composer composer, int i) {
            int i2;
            Modifier modifier;
            ...
            float m73625getMaxHeightimpl = Constraints.m73625getMaxHeightimpl(j);
            float f2 = m73625getMaxHeightimpl - this.$headerHeightPx;
            ...
            Modifier semantics$default = SemanticsModifierKt.semantics$default(SwipeableKt.m70113swipeablepPrIpRY$default(companion.then(modifier), this.$scaffoldState, AbstractC11687a.mapOf(TuplesKt.m28844to(Float.valueOf(this.$peekHeightPx), BackdropValue.Concealed), TuplesKt.m28844to(Float.valueOf(f3), BackdropValue.Revealed)), Orientation.Vertical, this.$gesturesEnabled, false, null, null, null, 0.0f, 496, null), false, new BackdropScaffoldKt$BackdropScaffold$1$1$swipeable$1(this.$scaffoldState, this.$scope), 1, null);
            BackdropScaffoldState backdropScaffoldState = this.$scaffoldState;
            ...
            ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer, -1065299503, true, new C30642(this.$peekHeight, this.$frontLayerContent, this.$$dirty, this.$frontLayerScrimColor, this.$scaffoldState, this.$$dirty1, this.$gesturesEnabled, this.$scope));
            int i5 = this.$$dirty1;
            SurfaceKt.m70104SurfaceFjzlyU(then, shape, j2, j3, null, f4, composableLambda, composer, ((i5 >> 3) & 112) | 1572864 | ((i5 >> 6) & 896) | ((i5 >> 6) & 7168) | ((i5 << 6) & 458752), 16);
            if (this.$scaffoldState.isRevealed() && f3 == m73625getMaxHeightimpl - this.$headerHeightPx) {
                m73658constructorimpl = this.$headerHeight;
            } else {
                m73658constructorimpl = C3641Dp.m73658constructorimpl(0);
            }
            Modifier m69533paddingqDBjuR0$default = PaddingKt.m69533paddingqDBjuR0$default(companion, 0.0f, 0.0f, 0.0f, m73658constructorimpl, 7, null);
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        composer.endReplaceableGroup();
        BackdropScaffoldKt.m60951c(SizeKt.fillMaxSize$default(this.$modifier, 0.0f, 1, null), this.$backLayer, this.$calculateBackLayerConstraints, ComposableLambdaKt.composableLambda(composer, 1800047509, true, new C30631(this.$headerHeightPx, this.$stickyFrontLayer, this.$gesturesEnabled, this.$scaffoldState, this.$peekHeightPx, this.$$dirty, this.$frontLayerShape, this.$frontLayerBackgroundColor, this.$frontLayerContentColor, this.$frontLayerElevation, this.$$dirty1, this.$headerHeight, coroutineScope, this.$peekHeight, this.$frontLayerContent, this.$frontLayerScrimColor, this.$snackbarHost)), composer, 3120);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    }
