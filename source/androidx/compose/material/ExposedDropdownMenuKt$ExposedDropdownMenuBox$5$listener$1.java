...
public final class ExposedDropdownMenuKt$ExposedDropdownMenuBox$5$listener$1 extends Lambda implements Function0<Unit> {
    ...
    /* loaded from: classes.dex */
    public static final class C31201 extends Lambda implements Function1<Integer, Unit> {
        final /* synthetic */ MutableIntState $menuHeight$delegate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C31201(MutableIntState mutableIntState) {
            super(1);
    ...
    public final void invoke2() {
        ...
        ExposedDropdownMenuKt.m60892f(rootView, this.$coordinates.getValue(), this.$verticalMarginInPx, new C31201(this.$menuHeight$delegate));
    }
}
