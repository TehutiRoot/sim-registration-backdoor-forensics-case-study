...
public final class ScaffoldKt$ScaffoldLayout$1$1 extends Lambda implements Function2<SubcomposeMeasureScope, Constraints, MeasureResult> {
    ...
    /* loaded from: classes.dex */
    public static final class C31551 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
        final /* synthetic */ int $$dirty;
        final /* synthetic */ Function2<Composer, Integer, Unit> $bottomBar;
        final /* synthetic */ Function3<PaddingValues, Composer, Integer, Unit> $content;
        final /* synthetic */ Function2<Composer, Integer, Unit> $fab;
        ...
        public C31551(SubcomposeMeasureScope subcomposeMeasureScope, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, int i, int i2, boolean z, int i3, long j, Function2<? super Composer, ? super Integer, Unit> function24, int i4, Function3<? super PaddingValues, ? super Composer, ? super Integer, Unit> function3) {
            super(1);
        ...
        */
        public final void invoke2(@org.jetbrains.annotations.NotNull androidx.compose.p003ui.layout.Placeable.PlacementScope r30) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.ScaffoldKt$ScaffoldLayout$1$1.C31551.invoke2(androidx.compose.ui.layout.Placeable$PlacementScope):void");
        }
    }
    ...
    public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeMeasureScope subcomposeMeasureScope, Constraints constraints) {
        return m70081invoke0kLqBqw(subcomposeMeasureScope, constraints.m73632unboximpl());
    }

    @NotNull
    /* renamed from: invoke-0kLqBqw  reason: not valid java name */
    public final MeasureResult m70081invoke0kLqBqw(@NotNull SubcomposeMeasureScope SubcomposeLayout, long j) {
        ...
        return MeasureScope.CC.m59532q(SubcomposeLayout, m73626getMaxWidthimpl, m73625getMaxHeightimpl, null, new C31551(SubcomposeLayout, this.$topBar, this.$snackbar, this.$fab, this.$fabPosition, m73626getMaxWidthimpl, this.$isFabDocked, m73625getMaxHeightimpl, Constraints.m73618copyZbe2FdA$default(j, 0, 0, 0, 0, 10, null), this.$bottomBar, this.$$dirty, this.$content), 4, null);
    }
}
