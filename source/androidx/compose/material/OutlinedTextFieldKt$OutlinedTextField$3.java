...
public final class OutlinedTextFieldKt$OutlinedTextField$3 extends Lambda implements Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit> {
    ...
    /* loaded from: classes.dex */
    public static final class C31501 extends Lambda implements Function2<Composer, Integer, Unit> {
        final /* synthetic */ int $$dirty;
        final /* synthetic */ int $$dirty1;
        final /* synthetic */ TextFieldColors $colors;
        final /* synthetic */ boolean $enabled;
        ...
        public C31501(boolean z, boolean z2, MutableInteractionSource mutableInteractionSource, TextFieldColors textFieldColors, Shape shape, int i, int i2) {
            super(2);
            this.$enabled = z;
            this.$isError = z2;
    ...
    public final void invoke(@NotNull Function2<? super Composer, ? super Integer, Unit> innerTextField, @Nullable Composer composer, int i) {
        ...
        TextFieldColors textFieldColors = this.$colors;
        int i3 = i2;
        ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer, -1823843281, true, new C31501(z, z3, mutableInteractionSource, textFieldColors, this.$shape, this.$$dirty, this.$$dirty1));
        int i4 = this.$$dirty;
        int i5 = this.$$dirty1;
        textFieldDefaults.OutlinedTextFieldDecorationBox(str, innerTextField, z, z2, visualTransformation, mutableInteractionSource, z3, function2, function22, function23, function24, textFieldColors, null, composableLambda, composer, ((i3 << 3) & 112) | (i4 & 14) | ((i4 >> 3) & 896) | ((i5 >> 3) & 7168) | ((i5 << 9) & 57344) | ((i5 >> 6) & 458752) | ((i5 << 18) & 3670016) | ((i4 << 3) & 29360128) | ((i4 << 3) & 234881024) | ((i4 << 3) & 1879048192), ((i4 >> 27) & 14) | 27648 | ((i5 >> 24) & 112), 4096);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    }
