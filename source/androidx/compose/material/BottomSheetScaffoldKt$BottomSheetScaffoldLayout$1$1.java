...
public final class BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1 extends Lambda implements Function2<SubcomposeMeasureScope, Constraints, MeasureResult> {
    ...
    /* loaded from: classes.dex */
    public static final class C30851 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
        ...
        public C30851(List<? extends Placeable> list, List<? extends Placeable> list2, List<? extends Placeable> list3, List<? extends Placeable> list4, List<? extends Placeable> list5, int i, int i2, int i3, int i4, int i5, int i6) {
            super(1);
    ...
    public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeMeasureScope subcomposeMeasureScope, Constraints constraints) {
        return m69936invoke0kLqBqw(subcomposeMeasureScope, constraints.m73632unboximpl());
    }
    ...
    */
    public final androidx.compose.p003ui.layout.MeasureResult m69936invoke0kLqBqw(@org.jetbrains.annotations.NotNull androidx.compose.p003ui.layout.SubcomposeMeasureScope r24, long r25) {
        /*
            Method dump skipped, instructions count: 771
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1.m69936invoke0kLqBqw(androidx.compose.ui.layout.SubcomposeMeasureScope, long):androidx.compose.ui.layout.MeasureResult");
    }
}
