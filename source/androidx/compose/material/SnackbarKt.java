...
public final class SnackbarKt {
    ...
    */
    public static final void m70087Snackbar7zSek6w(@org.jetbrains.annotations.Nullable androidx.compose.p003ui.Modifier r27, @org.jetbrains.annotations.Nullable kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r28, boolean r29, @org.jetbrains.annotations.Nullable androidx.compose.p003ui.graphics.Shape r30, long r31, long r33, float r35, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r36, @org.jetbrains.annotations.Nullable androidx.compose.runtime.Composer r37, int r38, int r39) {
        /*
            Method dump skipped, instructions count: 515
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.SnackbarKt.m70087Snackbar7zSek6w(androidx.compose.ui.Modifier, kotlin.jvm.functions.Function2, boolean, androidx.compose.ui.graphics.Shape, long, long, float, kotlin.jvm.functions.Function2, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final void m70088SnackbarsPrSdHI(@org.jetbrains.annotations.NotNull androidx.compose.material.SnackbarData r29, @org.jetbrains.annotations.Nullable androidx.compose.p003ui.Modifier r30, boolean r31, @org.jetbrains.annotations.Nullable androidx.compose.p003ui.graphics.Shape r32, long r33, long r35, long r37, float r39, @org.jetbrains.annotations.Nullable androidx.compose.runtime.Composer r40, int r41, int r42) {
        /*
            Method dump skipped, instructions count: 589
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.SnackbarKt.m70088SnackbarsPrSdHI(androidx.compose.material.SnackbarData, androidx.compose.ui.Modifier, boolean, androidx.compose.ui.graphics.Shape, long, long, long, float, androidx.compose.runtime.Composer, int, int):void");
    }

    /* renamed from: a */
    public static final void m60809a(Function2 function2, Function2 function22, Composer composer, int i) {
        int i2;
        int i3;
        int i4;
        ...
        if ((i2 & 91) == 18 && startRestartGroup.getSkipping()) {
            ...
            float f = f14611b;
            float f2 = f14612c;
            Modifier m69533paddingqDBjuR0$default = PaddingKt.m69533paddingqDBjuR0$default(fillMaxWidth$default, f, 0.0f, f2, f14613d, 2, null);
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> modifierMaterializerOf = LayoutKt.modifierMaterializerOf(m69533paddingqDBjuR0$default);
            ...
            Modifier m69533paddingqDBjuR0$default2 = PaddingKt.m69533paddingqDBjuR0$default(AlignmentLineKt.m69465paddingFromBaselineVpY3zN4(companion, f14610a, f14616g), 0.0f, 0.0f, f2, 0.0f, 11, null);
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> modifierMaterializerOf2 = LayoutKt.modifierMaterializerOf(m69533paddingqDBjuR0$default2);
            if (!(startRestartGroup.getApplier() instanceof Applier)) {
                ComposablesKt.invalidApplier();
            }
            startRestartGroup.startReusableNode();
    ...
    /* renamed from: b */
    public static final void m60808b(Function2 function2, Function2 function22, Composer composer, int i) {
        int i2;
        int i3;
        int i4;
        ...
        if ((i2 & 91) == 18 && startRestartGroup.getSkipping()) {
            ...
            Modifier.Companion companion = Modifier.Companion;
            Modifier m69533paddingqDBjuR0$default = PaddingKt.m69533paddingqDBjuR0$default(companion, f14611b, 0.0f, f14612c, 0.0f, 10, null);
                ...
                public final MeasureResult mo69194measure3p2s80s(MeasureScope Layout, List measurables, long j) {
                    ...
                    for (Measurable measurable : list) {
                        if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), str)) {
                            ...
                            int m73626getMaxWidthimpl = Constraints.m73626getMaxWidthimpl(j) - mo72811measureBRTryo0.getWidth();
                            f = SnackbarKt.f14615f;
                            int coerceAtLeast = AbstractC11719c.coerceAtLeast(m73626getMaxWidthimpl - Layout.mo69432roundToPx0680j_4(f), Constraints.m73628getMinWidthimpl(j));
                            String str2 = r2;
                            for (Measurable measurable2 : list) {
                                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), str2)) {
                                    Placeable mo72811measureBRTryo02 = measurable2.mo72811measureBRTryo0(Constraints.m73618copyZbe2FdA$default(j, 0, coerceAtLeast, 0, 0, 9, null));
                                    int i7 = mo72811measureBRTryo02.get(androidx.compose.p003ui.layout.AlignmentLineKt.getFirstBaseline());
                                    if (i7 != Integer.MIN_VALUE) {
                                        int i8 = mo72811measureBRTryo02.get(androidx.compose.p003ui.layout.AlignmentLineKt.getLastBaseline());
                                        if (i8 != Integer.MIN_VALUE) {
                                            ...
                                            int m73626getMaxWidthimpl2 = Constraints.m73626getMaxWidthimpl(j) - mo72811measureBRTryo0.getWidth();
                                            if (z) {
                                                f4 = SnackbarKt.f14617h;
                                                i5 = Math.max(Layout.mo69432roundToPx0680j_4(f4), mo72811measureBRTryo0.getHeight());
                                                int height2 = (i5 - mo72811measureBRTryo02.getHeight()) / 2;
                                                int i10 = mo72811measureBRTryo0.get(androidx.compose.p003ui.layout.AlignmentLineKt.getFirstBaseline());
                                                ...
                                                f2 = SnackbarKt.f14610a;
                                                int mo69432roundToPx0680j_4 = Layout.mo69432roundToPx0680j_4(f2) - i7;
                                                f3 = SnackbarKt.f14618i;
                                                int max = Math.max(Layout.mo69432roundToPx0680j_4(f3), mo72811measureBRTryo02.getHeight() + mo69432roundToPx0680j_4);
                                                i5 = max;
                                                i6 = mo69432roundToPx0680j_4;
                                                height = (max - mo72811measureBRTryo0.getHeight()) / 2;
                                            }
                                            return MeasureScope.CC.m59532q(Layout, Constraints.m73626getMaxWidthimpl(j), i5, null, new SnackbarKt$OneRowSnackbar$2$measure$4(mo72811measureBRTryo02, i6, mo72811measureBRTryo0, m73626getMaxWidthimpl2, height), 4, null);
                                        }
            ...
            modifierMaterializerOf.invoke(SkippableUpdater.m71384boximpl(SkippableUpdater.m71385constructorimpl(startRestartGroup)), startRestartGroup, 0);
            startRestartGroup.startReplaceableGroup(2058660585);
            Modifier m69531paddingVpY3zN4$default = PaddingKt.m69531paddingVpY3zN4$default(LayoutIdKt.layoutId(companion, TextBundle.TEXT_ENTRY), 0.0f, f14614e, 1, null);
            startRestartGroup.startReplaceableGroup(733328855);
    ...
    /* renamed from: c */
    public static final void m60807c(Function2 function2, Composer composer, int i) {
        int i2;
        int i3;
        ...
        if ((i2 & 11) == 2 && startRestartGroup.getSkipping()) {
            ...
            SnackbarKt$TextOnlySnackbar$2 snackbarKt$TextOnlySnackbar$2 = SnackbarKt$TextOnlySnackbar$2.f14621a;
            startRestartGroup.startReplaceableGroup(-1323940314);
            Modifier.Companion companion = Modifier.Companion;
            int currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(startRestartGroup, 0);
            CompositionLocalMap currentCompositionLocalMap = startRestartGroup.getCurrentCompositionLocalMap();
            ...
            Composer m71393constructorimpl = Updater.m71393constructorimpl(startRestartGroup);
            Updater.m71400setimpl(m71393constructorimpl, snackbarKt$TextOnlySnackbar$2, companion2.getSetMeasurePolicy());
            Updater.m71400setimpl(m71393constructorimpl, currentCompositionLocalMap, companion2.getSetResolvedCompositionLocals());
            Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash = companion2.getSetCompositeKeyHash();
            if (m71393constructorimpl.getInserting() || !Intrinsics.areEqual(m71393constructorimpl.rememberedValue(), Integer.valueOf(currentCompositeKeyHash))) {
                m71393constructorimpl.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash));
            ...
            modifierMaterializerOf.invoke(SkippableUpdater.m71384boximpl(SkippableUpdater.m71385constructorimpl(startRestartGroup)), startRestartGroup, 0);
            startRestartGroup.startReplaceableGroup(2058660585);
            Modifier m69530paddingVpY3zN4 = PaddingKt.m69530paddingVpY3zN4(companion, f14611b, f14614e);
            startRestartGroup.startReplaceableGroup(733328855);
            ...
            CompositionLocalMap currentCompositionLocalMap2 = startRestartGroup.getCurrentCompositionLocalMap();
            Function0<ComposeUiNode> constructor2 = companion2.getConstructor();
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> modifierMaterializerOf2 = LayoutKt.modifierMaterializerOf(m69530paddingVpY3zN4);
            if (!(startRestartGroup.getApplier() instanceof Applier)) {
                ComposablesKt.invalidApplier();
            }
            startRestartGroup.startReusableNode();
