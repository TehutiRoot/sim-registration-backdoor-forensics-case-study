...
public final class TextFieldMeasurePolicy$measure$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke2(@NotNull Placeable.PlacementScope layout) {
        ...
        if (this.$labelPlaceable != null) {
            int coerceAtLeast = AbstractC11719c.coerceAtLeast(this.$topPaddingValue - this.$lastBaseline, 0);
            int i = this.$width;
            int i2 = this.$height;
            ...
            z2 = this.this$0.f14702a;
            int i3 = this.$topPadding + this.$effectiveLabelBaseline;
            f = this.this$0.f14703b;
            TextFieldKt.m60771c(layout, i, i2, placeable, placeable2, placeable3, placeable4, placeable5, z2, coerceAtLeast, i3, f, this.$this_measure.getDensity());
            return;
        }
        int i4 = this.$width;
        int i5 = this.$height;
        ...
        z = this.this$0.f14702a;
        float density = this.$this_measure.getDensity();
        paddingValues = this.this$0.f14704c;
        TextFieldKt.m60770d(layout, i4, i5, placeable6, placeable7, placeable8, placeable9, z, density, paddingValues);
    }
}
