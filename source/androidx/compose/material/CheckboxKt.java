...
public final class CheckboxKt {
    ...
    static {
        float f = 2;
        f14404b = C3641Dp.m73658constructorimpl(f);
        f14406d = C3641Dp.m73658constructorimpl(f);
        f14407e = C3641Dp.m73658constructorimpl(f);
    }
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final void m60931a(boolean r32, androidx.compose.p003ui.state.ToggleableState r33, androidx.compose.p003ui.Modifier r34, androidx.compose.material.CheckboxColors r35, androidx.compose.runtime.Composer r36, int r37) {
        /*
            Method dump skipped, instructions count: 702
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.CheckboxKt.m60931a(boolean, androidx.compose.ui.state.ToggleableState, androidx.compose.ui.Modifier, androidx.compose.material.CheckboxColors, androidx.compose.runtime.Composer, int):void");
    }

    /* renamed from: b */
    public static final long m60930b(State state) {
        return ((Color) state.getValue()).m71745unboximpl();
    }

    /* renamed from: c */
    public static final float m60929c(State state) {
        return ((Number) state.getValue()).floatValue();
    }

    /* renamed from: d */
    public static final float m60928d(State state) {
        return ((Number) state.getValue()).floatValue();
    }

    /* renamed from: e */
    public static final long m60927e(State state) {
        return ((Color) state.getValue()).m71745unboximpl();
    }

    /* renamed from: f */
    public static final long m60926f(State state) {
        return ((Color) state.getValue()).m71745unboximpl();
    }

    /* renamed from: g */
    public static final void m60925g(DrawScope drawScope, long j, long j2, float f, float f2) {
        float f3 = f2 / 2.0f;
        ...
        if (Color.m71736equalsimpl0(j, j2)) {
            AbstractC12212lK.m26514M(drawScope, j, 0L, SizeKt.Size(m71571getWidthimpl, m71571getWidthimpl), CornerRadiusKt.CornerRadius$default(f, 0.0f, 2, null), Fill.INSTANCE, 0.0f, null, 0, 226, null);
            return;
        }
        float f4 = m71571getWidthimpl - (2 * f2);
        AbstractC12212lK.m26514M(drawScope, j, OffsetKt.Offset(f2, f2), SizeKt.Size(f4, f4), CornerRadiusKt.CornerRadius$default(Math.max(0.0f, f - f2), 0.0f, 2, null), Fill.INSTANCE, 0.0f, null, 0, 224, null);
        float f5 = m71571getWidthimpl - f2;
        AbstractC12212lK.m26514M(drawScope, j2, OffsetKt.Offset(f3, f3), SizeKt.Size(f5, f5), CornerRadiusKt.CornerRadius$default(f - f3, 0.0f, 2, null), stroke, 0.0f, null, 0, 224, null);
    }

    /* renamed from: h */
    public static final void m60924h(DrawScope drawScope, long j, float f, float f2, float f3, C10173ep c10173ep) {
        Stroke stroke = new Stroke(f3, 0.0f, StrokeCap.Companion.m72045getSquareKaPHkGw(), 0, null, 26, null);
        float m71571getWidthimpl = Size.m71571getWidthimpl(drawScope.mo72144getSizeNHjbRc());
        ...
        c10173ep.m31491a().reset();
        c10173ep.m31491a().moveTo(0.2f * m71571getWidthimpl, lerp3 * m71571getWidthimpl);
        c10173ep.m31491a().lineTo(lerp * m71571getWidthimpl, lerp2 * m71571getWidthimpl);
        c10173ep.m31491a().lineTo(0.8f * m71571getWidthimpl, m71571getWidthimpl * lerp4);
        c10173ep.m31490b().setPath(c10173ep.m31491a(), false);
        c10173ep.m31489c().reset();
        c10173ep.m31490b().getSegment(0.0f, c10173ep.m31490b().getLength() * f, c10173ep.m31489c(), true);
        AbstractC12212lK.m26520G(drawScope, c10173ep.m31489c(), j, 0.0f, stroke, null, 0, 52, null);
    }
}
