...
public final class SnackbarKt$Snackbar$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    /* loaded from: classes.dex */
    public static final class C31781 extends Lambda implements Function2<Composer, Integer, Unit> {
        final /* synthetic */ int $$dirty;
        final /* synthetic */ Function2<Composer, Integer, Unit> $action;
        final /* synthetic */ boolean $actionOnNewLine;
        final /* synthetic */ Function2<Composer, Integer, Unit> $content;
        ...
        /* loaded from: classes.dex */
        public static final class C31791 extends Lambda implements Function2<Composer, Integer, Unit> {
            final /* synthetic */ int $$dirty;
            final /* synthetic */ Function2<Composer, Integer, Unit> $action;
            final /* synthetic */ boolean $actionOnNewLine;
            final /* synthetic */ Function2<Composer, Integer, Unit> $content;
            ...
            public C31791(Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, int i, boolean z) {
                super(2);
            ...
            public final void invoke(@Nullable Composer composer, int i) {
                ...
                if (this.$action == null) {
                    ...
                    SnackbarKt.m60807c(this.$content, composer, (this.$$dirty >> 21) & 14);
                    ...
                    int i2 = this.$$dirty;
                    SnackbarKt.m60809a(function2, function22, composer, (i2 & 112) | ((i2 >> 21) & 14));
                    composer.endReplaceableGroup();
                } else {
                    ...
                    int i3 = this.$$dirty;
                    SnackbarKt.m60808b(function23, function24, composer, (i3 & 112) | ((i3 >> 21) & 14));
                    composer.endReplaceableGroup();
                }
                if (ComposerKt.isTraceInProgress()) {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C31781(Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, int i, boolean z) {
            super(2);
            this.$action = function2;
            this.$content = function22;
            this.$$dirty = i;
        ...
        public final void invoke(@Nullable Composer composer, int i) {
            ...
            TextKt.ProvideTextStyle(MaterialTheme.INSTANCE.getTypography(composer, 6).getBody2(), ComposableLambdaKt.composableLambda(composer, 225114541, true, new C31791(this.$action, this.$content, this.$$dirty, this.$actionOnNewLine)), composer, 48);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
