...
public final class SurfaceKt$Surface$10 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public SurfaceKt$Surface$10(Modifier modifier, Shape shape, long j, float f, int i, BorderStroke borderStroke, float f2, boolean z, MutableInteractionSource mutableInteractionSource, boolean z2, Function1<? super Boolean, Unit> function1, Function2<? super Composer, ? super Integer, Unit> function2, int i2) {
        super(2);
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-311657392, i, -1, "androidx.compose.material.Surface.<anonymous> (Surface.kt:456)");
        }
        Modifier minimumInteractiveComponentSize = InteractiveComponentSizeKt.minimumInteractiveComponentSize(this.$modifier);
        Shape shape = this.$shape;
        m60804b = SurfaceKt.m60804b(this.$color, (ElevationOverlay) composer.consume(ElevationOverlayKt.getLocalElevationOverlay()), this.$absoluteElevation, composer, (this.$$dirty >> 15) & 14);
        m60805a = SurfaceKt.m60805a(minimumInteractiveComponentSize, shape, m60804b, this.$border, this.$elevation);
        Modifier m69693toggleableO2vRcR0$default = ToggleableKt.m69693toggleableO2vRcR0$default(m60805a, this.$checked, this.$interactionSource, RippleKt.m70180rememberRipple9IZ8Weo(false, 0.0f, 0L, composer, 0, 7), this.$enabled, null, this.$onCheckedChange, 16, null);
        ...
        Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> modifierMaterializerOf = LayoutKt.modifierMaterializerOf(m69693toggleableO2vRcR0$default);
