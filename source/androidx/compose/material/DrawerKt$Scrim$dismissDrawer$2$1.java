...
public final class DrawerKt$Scrim$dismissDrawer$2$1 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    ...
    /* renamed from: androidx.compose.material.DrawerKt$Scrim$dismissDrawer$2$1$1 */
    /* loaded from: classes.dex */
    public static final class C31141 extends Lambda implements Function0<Boolean> {
        final /* synthetic */ Function0<Unit> $onClose;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C31141(Function0<Unit> function0) {
            super(0);
    ...
    public final void invoke2(@NotNull SemanticsPropertyReceiver semantics) {
        ...
        SemanticsPropertiesKt.onClick$default(semantics, null, new C31141(this.$onClose), 1, null);
    }
}
