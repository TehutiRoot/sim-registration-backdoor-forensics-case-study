...
public final class ButtonKt$Button$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    /* loaded from: classes.dex */
    public static final class C30921 extends Lambda implements Function2<Composer, Integer, Unit> {
        final /* synthetic */ int $$dirty;
        final /* synthetic */ Function3<RowScope, Composer, Integer, Unit> $content;
        final /* synthetic */ PaddingValues $contentPadding;
        ...
        /* loaded from: classes.dex */
        public static final class C30931 extends Lambda implements Function2<Composer, Integer, Unit> {
            final /* synthetic */ int $$dirty;
            final /* synthetic */ Function3<RowScope, Composer, Integer, Unit> $content;
            final /* synthetic */ PaddingValues $contentPadding;
            ...
            public C30931(PaddingValues paddingValues, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, int i) {
                super(2);
            ...
            public final void invoke(@Nullable Composer composer, int i) {
                ...
                Modifier padding = PaddingKt.padding(SizeKt.m69548defaultMinSizeVpY3zN4(companion, buttonDefaults.m69943getMinWidthD9Ej5fM(), buttonDefaults.m69942getMinHeightD9Ej5fM()), this.$contentPadding);
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C30921(PaddingValues paddingValues, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, int i) {
            super(2);
            this.$contentPadding = paddingValues;
            this.$content = function3;
            this.$$dirty = i;
        ...
        public final void invoke(@Nullable Composer composer, int i) {
            ...
            TextKt.ProvideTextStyle(MaterialTheme.INSTANCE.getTypography(composer, 6).getButton(), ComposableLambdaKt.composableLambda(composer, -630330208, true, new C30931(this.$contentPadding, this.$content, this.$$dirty)), composer, 48);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        m60932a = ButtonKt.m60932a(this.$contentColor$delegate);
        CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{localContentAlpha.provides(Float.valueOf(Color.m71737getAlphaimpl(m60932a)))}, ComposableLambdaKt.composableLambda(composer, -1699085201, true, new C30921(this.$contentPadding, this.$content, this.$$dirty)), composer, 56);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    }
