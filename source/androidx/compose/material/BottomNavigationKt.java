...
public final class BottomNavigationKt {
    ...
    /* renamed from: a */
    public static final TweenSpec f14373a = new TweenSpec(300, 0, EasingKt.getFastOutSlowInEasing(), 2, null);

    /* renamed from: b */
    public static final float f14374b = C3641Dp.m73658constructorimpl(56);

    /* renamed from: c */
    public static final float f14375c;

    /* renamed from: d */
    public static final float f14376d;

    /* renamed from: androidx.compose.material.BottomNavigationKt$a */
    /* loaded from: classes.dex */
    public static final class C3076a implements MeasurePolicy {

        /* renamed from: a */
        public final /* synthetic */ Function2 f14377a;

        /* renamed from: b */
        public final /* synthetic */ float f14378b;

        public C3076a(Function2 function2, float f) {
            this.f14377a = function2;
            this.f14378b = f;
        }
        ...
        public final MeasureResult mo69194measure3p2s80s(MeasureScope Layout, List measurables, long j) {
            ...
            for (Measurable measurable : list) {
                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "icon")) {
                    ...
                    placeable = null;
                    if (this.f14377a == null) {
                        return BottomNavigationKt.m60943d(Layout, mo72811measureBRTryo0, j);
                    }
                    Intrinsics.checkNotNull(placeable);
                    return BottomNavigationKt.m60942e(Layout, placeable, mo72811measureBRTryo0, j, this.f14378b);
                }
            }
            throw new NoSuchElementException("Collection contains no element matching the predicate.");
        }
    ...
    static {
        float f = 12;
        f14375c = C3641Dp.m73658constructorimpl(f);
        f14376d = C3641Dp.m73658constructorimpl(f);
    }
    ...
    */
    public static final void m69924BottomNavigationPEIptTM(@org.jetbrains.annotations.Nullable androidx.compose.p003ui.Modifier r24, long r25, long r27, float r29, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.RowScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r30, @org.jetbrains.annotations.Nullable androidx.compose.runtime.Composer r31, int r32, int r33) {
        /*
            Method dump skipped, instructions count: 362
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.BottomNavigationKt.m69924BottomNavigationPEIptTM(androidx.compose.ui.Modifier, long, long, float, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int):void");
    }

    @Composable
    @ComposableInferredTarget(scheme = "[androidx.compose.ui.UiComposable[androidx.compose.ui.UiComposable][androidx.compose.ui.UiComposable]]")
    /* renamed from: BottomNavigationItem-jY6E1Zs  reason: not valid java name */
    public static final void m69925BottomNavigationItemjY6E1Zs(@NotNull RowScope BottomNavigationItem, boolean z, @NotNull Function0<Unit> onClick, @NotNull Function2<? super Composer, ? super Integer, Unit> icon, @Nullable Modifier modifier, boolean z2, @Nullable Function2<? super Composer, ? super Integer, Unit> function2, boolean z3, @Nullable MutableInteractionSource mutableInteractionSource, long j, long j2, @Nullable Composer composer, int i, int i2, int i3) {
        int i4;
        Object obj;
        Object obj2;
        int i5;
        ...
        if ((1533916891 & i4) == 306783378 && (i5 & 11) == 2 && startRestartGroup.getSkipping()) {
            ...
            if ((i & 1) != 0 && !startRestartGroup.getDefaultsInvalid()) {
                ...
                if ((256 & i3) != 0) {
                    j3 = ((Color) startRestartGroup.consume(ContentColorKt.getLocalContentColor())).m71745unboximpl();
                    i4 &= -1879048193;
                } else {
                    j3 = j;
                }
                if ((i3 & 512) != 0) {
                    j4 = Color.m71734copywmQWz5c$default(j3, ContentAlpha.INSTANCE.getMedium(startRestartGroup, 6), 0.0f, 0.0f, 0.0f, 14, null);
                    i5 &= -15;
                } else {
                    j4 = j2;
                }
            ...
            Modifier m68013a = AbstractC17770Hy1.m68013a(BottomNavigationItem, SelectableKt.m69688selectableO2vRcR0(obj3, z, mutableInteractionSource2, RippleKt.m70180rememberRipple9IZ8Weo(false, 0.0f, j3, startRestartGroup, ((i4 >> 21) & 896) | 6, 2), z4, Role.m73063boximpl(Role.Companion.m73075getTabo7Vup1c()), onClick), 1.0f, false, 2, null);
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> modifierMaterializerOf = LayoutKt.modifierMaterializerOf(m68013a);
            ...
            m60945b(j3, j4, z, ComposableLambdaKt.composableLambda(startRestartGroup, -1411872801, true, new BottomNavigationKt$BottomNavigationItem$2$1(z5, icon, composableLambda, i4)), startRestartGroup, ((i5 << 3) & 112) | ((i4 >> 27) & 14) | 3072 | ((i4 << 3) & 896));
            startRestartGroup.endReplaceableGroup();
    ...
    /* renamed from: a */
    public static final void m60946a(Function2 function2, Function2 function22, float f, Composer composer, int i) {
        int i2;
        int i3;
        int i4;
        int i5;
        ...
        if ((i2 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            C3076a c3076a = new C3076a(function22, f);
            startRestartGroup.startReplaceableGroup(-1323940314);
            ...
            Composer m71393constructorimpl = Updater.m71393constructorimpl(startRestartGroup);
            Updater.m71400setimpl(m71393constructorimpl, c3076a, companion2.getSetMeasurePolicy());
            ...
            if (function22 != null) {
                Modifier m69531paddingVpY3zN4$default = PaddingKt.m69531paddingVpY3zN4$default(AlphaKt.alpha(LayoutIdKt.layoutId(companion, "label"), f), f14375c, 0.0f, 2, null);
                startRestartGroup.startReplaceableGroup(733328855);
                ...
                Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> modifierMaterializerOf3 = LayoutKt.modifierMaterializerOf(m69531paddingVpY3zN4$default);
                if (!(startRestartGroup.getApplier() instanceof Applier)) {
                    ComposablesKt.invalidApplier();
                }
                startRestartGroup.startReusableNode();
    ...
    /* renamed from: b */
    public static final void m60945b(long j, long j2, boolean z, Function3 function3, Composer composer, int i) {
        int i2;
        float f;
        Composer composer2;
        int i3;
        ...
        if ((i7 & 5851) == 1170 && startRestartGroup.getSkipping()) {
            ...
            composer2 = startRestartGroup;
            State<Float> animateFloatAsState = AnimateAsStateKt.animateFloatAsState(f, f14373a, 0.0f, null, null, startRestartGroup, 48, 28);
            long m71785lerpjxsXWHM = ColorKt.m71785lerpjxsXWHM(j2, j, m60944c(animateFloatAsState));
            CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m71725boximpl(Color.m71734copywmQWz5c$default(m71785lerpjxsXWHM, 1.0f, 0.0f, 0.0f, 0.0f, 14, null))), ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(Color.m71737getAlphaimpl(m71785lerpjxsXWHM)))}, ComposableLambdaKt.composableLambda(composer2, -138092754, true, new BottomNavigationKt$BottomNavigationTransition$1(function3, i7, animateFloatAsState)), composer2, 56);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    /* renamed from: c */
    public static final float m60944c(State state) {
        return ((Number) state.getValue()).floatValue();
    }

    /* renamed from: d */
    public static final MeasureResult m60943d(MeasureScope measureScope, Placeable placeable, long j) {
        int m73625getMaxHeightimpl = Constraints.m73625getMaxHeightimpl(j);
        return MeasureScope.CC.m59532q(measureScope, placeable.getWidth(), m73625getMaxHeightimpl, null, new BottomNavigationKt$placeIcon$1(placeable, (m73625getMaxHeightimpl - placeable.getHeight()) / 2), 4, null);
    }

    /* renamed from: e */
    public static final MeasureResult m60942e(MeasureScope measureScope, Placeable placeable, Placeable placeable2, long j, float f) {
        int m73625getMaxHeightimpl = Constraints.m73625getMaxHeightimpl(j);
        int mo69432roundToPx0680j_4 = measureScope.mo69432roundToPx0680j_4(f14376d) - placeable.get(AlignmentLineKt.getFirstBaseline());
        int coerceAtLeast = AbstractC11719c.coerceAtLeast((m73625getMaxHeightimpl - ((placeable2.getHeight() + placeable.getHeight()) + mo69432roundToPx0680j_4)) / 2, 0);
        int height = placeable2.getHeight() + coerceAtLeast + mo69432roundToPx0680j_4;
        int max = Math.max(placeable.getWidth(), placeable2.getWidth());
        return MeasureScope.CC.m59532q(measureScope, max, m73625getMaxHeightimpl, null, new BottomNavigationKt$placeLabelAndIcon$1(f, placeable, (max - placeable.getWidth()) / 2, height, AbstractC21140mr0.roundToInt((((m73625getMaxHeightimpl - placeable2.getHeight()) / 2) - coerceAtLeast) * (1 - f)), placeable2, (max - placeable2.getWidth()) / 2, coerceAtLeast), 4, null);
    }
}
