...
public final class ExposedDropdownMenuKt$expandable$2 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    ...
    /* renamed from: androidx.compose.material.ExposedDropdownMenuKt$expandable$2$1 */
    /* loaded from: classes.dex */
    public static final class C31221 extends Lambda implements Function0<Boolean> {
        final /* synthetic */ Function0<Unit> $onExpandedChange;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C31221(Function0<Unit> function0) {
            super(0);
    ...
    public final void invoke2(@NotNull SemanticsPropertyReceiver semantics) {
        ...
        SemanticsPropertiesKt.onClick$default(semantics, null, new C31221(this.$onExpandedChange), 1, null);
    }
}
