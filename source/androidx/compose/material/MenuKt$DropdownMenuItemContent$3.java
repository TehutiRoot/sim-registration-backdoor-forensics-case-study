...
public final class MenuKt$DropdownMenuItemContent$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public MenuKt$DropdownMenuItemContent$3(Function0<Unit> function0, Modifier modifier, boolean z, PaddingValues paddingValues, MutableInteractionSource mutableInteractionSource, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, int i, int i2) {
        super(2);
