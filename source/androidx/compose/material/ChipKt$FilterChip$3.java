...
public final class ChipKt$FilterChip$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    /* loaded from: classes.dex */
    public static final class C30961 extends Lambda implements Function2<Composer, Integer, Unit> {
        final /* synthetic */ int $$dirty;
        final /* synthetic */ int $$dirty1;
        final /* synthetic */ SelectableChipColors $colors;
        final /* synthetic */ Function3<RowScope, Composer, Integer, Unit> $content;
        ...
        /* loaded from: classes.dex */
        public static final class C30971 extends Lambda implements Function2<Composer, Integer, Unit> {
            final /* synthetic */ int $$dirty;
            final /* synthetic */ int $$dirty1;
            final /* synthetic */ SelectableChipColors $colors;
            final /* synthetic */ Function3<RowScope, Composer, Integer, Unit> $content;
            ...
            public C30971(Function2<? super Composer, ? super Integer, Unit> function2, boolean z, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, int i, SelectableChipColors selectableChipColors, boolean z2, int i2, State<Color> state) {
                super(2);
            ...
            public final void invoke(@Nullable Composer composer, int i) {
                ...
                Modifier m69549defaultMinSizeVpY3zN4$default = SizeKt.m69549defaultMinSizeVpY3zN4$default(companion, 0.0f, ChipDefaults.INSTANCE.m69956getMinHeightD9Ej5fM(), 1, null);
                if (this.$leadingIcon == null && (!this.$selected || this.$selectedIcon == null)) {
                    m73658constructorimpl = ChipKt.f14412a;
                } else {
                    m73658constructorimpl = C3641Dp.m73658constructorimpl(0);
                }
                float f6 = m73658constructorimpl;
                if (this.$trailingIcon == null) {
                    m73658constructorimpl2 = ChipKt.f14412a;
                } else {
                    m73658constructorimpl2 = C3641Dp.m73658constructorimpl(0);
                }
                Modifier m69533paddingqDBjuR0$default = PaddingKt.m69533paddingqDBjuR0$default(m69549defaultMinSizeVpY3zN4$default, f6, 0.0f, m73658constructorimpl2, 0.0f, 10, null);
                ...
                if (function2 != null || (z && function22 != null)) {
                    ...
                    if (function2 != null) {
                        ...
                        CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(leadingIconColor.getValue()), ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(Color.m71737getAlphaimpl(leadingIconColor.getValue().m71745unboximpl())))}, function2, composer, ((i5 >> 21) & 112) | 8);
                    }
                    composer.endReplaceableGroup();
                    composer.startReplaceableGroup(-1943411233);
                    if (z && function22 != null) {
                        long m71745unboximpl = state.getValue().m71745unboximpl();
                        composer.startReplaceableGroup(649986516);
                        if (function2 != null) {
                            f3 = ChipKt.f14416e;
                            modifier = ClipKt.clip(BackgroundKt.m69318backgroundbw27NRU(SizeKt.m69556requiredSize3ABfNKs(companion, f3), state.getValue().m71745unboximpl(), RoundedCornerShapeKt.getCircleShape()), RoundedCornerShapeKt.getCircleShape());
                            m71745unboximpl = selectableChipColors.backgroundColor(z2, z, composer, ((i5 >> 9) & 14) | ((i5 << 3) & 112) | ((i5 >> 15) & 896)).getValue().m71745unboximpl();
                        } else {
                            modifier = companion;
                        }
                        composer.endReplaceableGroup();
                        ...
                        composer.startReplaceableGroup(2058660585);
                        CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m71725boximpl(m71745unboximpl))}, function22, composer, ((i5 >> 24) & 112) | 8);
                        composer.endReplaceableGroup();
                        composer.endNode();
                        composer.endReplaceableGroup();
                        composer.endReplaceableGroup();
                ...
                if (function23 != null) {
                    f4 = ChipKt.f14415d;
                    SpacerKt.Spacer(SizeKt.m69569width3ABfNKs(companion, f4), composer, i3);
                    function23.invoke(composer, Integer.valueOf(i2 & 14));
                    f5 = ChipKt.f14415d;
                    SpacerKt.Spacer(SizeKt.m69569width3ABfNKs(companion, f5), composer, i3);
                }
                composer.endReplaceableGroup();
                composer.endReplaceableGroup();
                composer.endNode();
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C30961(Function2<? super Composer, ? super Integer, Unit> function2, boolean z, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, int i, SelectableChipColors selectableChipColors, boolean z2, int i2, State<Color> state) {
            super(2);
            this.$leadingIcon = function2;
            this.$selected = z;
            this.$selectedIcon = function22;
        ...
        public final void invoke(@Nullable Composer composer, int i) {
            ...
            TextKt.ProvideTextStyle(MaterialTheme.INSTANCE.getTypography(composer, 6).getBody2(), ComposableLambdaKt.composableLambda(composer, -1543702066, true, new C30971(this.$leadingIcon, this.$selected, this.$selectedIcon, this.$trailingIcon, this.$content, this.$$dirty1, this.$colors, this.$enabled, this.$$dirty, this.$contentColor)), composer, 48);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
