...
public final class ExposedDropdownMenuBoxScope$ExposedDropdownMenu$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        Modifier m60898c = ExposedDropdownMenuBoxScope.CC.m60898c(this.this$0, this.$modifier, false, 1, null);
        Function3<ColumnScope, Composer, Integer, Unit> function3 = this.$content;
        int i2 = this.$$dirty;
        MenuKt.DropdownMenuContent(mutableTransitionState, mutableState, scrollState, m60898c, function3, composer, MutableTransitionState.$stable | 48 | ((i2 >> 3) & 896) | (i2 & 57344), 0);
        if (ComposerKt.isTraceInProgress()) {
