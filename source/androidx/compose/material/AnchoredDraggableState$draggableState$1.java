...
public final class AnchoredDraggableState$draggableState$1 implements DraggableState {
    ...
    public AnchoredDraggableState$draggableState$1(final AnchoredDraggableState anchoredDraggableState) {
        this.f14345b = anchoredDraggableState;
        this.f14344a = new DragScope() { // from class: androidx.compose.material.AnchoredDraggableState$draggableState$1$dragScope$1
            @Override // androidx.compose.foundation.gestures.DragScope
            public void dragBy(float f) {
                AnchoredDragScope anchoredDragScope;
                anchoredDragScope = AnchoredDraggableState.this.f14342q;
                AbstractC0779L2.m67568a(anchoredDragScope, AnchoredDraggableState.this.newOffsetForDelta$material_release(f), 0.0f, 2, null);
            }
        };
    }
    ...
    public void dispatchRawDelta(float f) {
        this.f14345b.dispatchRawDelta(f);
    }
    ...
    public Object drag(@NotNull MutatePriority mutatePriority, @NotNull Function2<? super DragScope, ? super Continuation<? super Unit>, ? extends Object> function2, @NotNull Continuation<? super Unit> continuation) {
        Object anchoredDrag = this.f14345b.anchoredDrag(mutatePriority, new AnchoredDraggableState$draggableState$1$drag$2(this, function2, null), continuation);
        if (anchoredDrag == AbstractC18812Yf0.getCOROUTINE_SUSPENDED()) {
            return anchoredDrag;
        }
