...
public final class AndroidAutofill implements Autofill {
    ...
    public AndroidAutofill(@NotNull View view, @NotNull AutofillTree autofillTree) {
        ...
        this.f28863a = view;
        this.f28864b = autofillTree;
        systemService = view.getContext().getSystemService(AbstractC1796Z2.m65275a());
        AutofillManager m52059a = AbstractC5344b3.m52059a(systemService);
        if (m52059a != null) {
            this.f28865c = m52059a;
    ...
    public void cancelAutofillForNode(@NotNull AutofillNode autofillNode) {
        ...
        this.f28865c.notifyViewExited(this.f28863a, autofillNode.getId());
    }
    ...
    public void requestAutofillForNode(@NotNull AutofillNode autofillNode) {
        ...
        if (boundingBox != null) {
            this.f28865c.notifyViewEntered(this.f28863a, autofillNode.getId(), new android.graphics.Rect(AbstractC21140mr0.roundToInt(boundingBox.getLeft()), AbstractC21140mr0.roundToInt(boundingBox.getTop()), AbstractC21140mr0.roundToInt(boundingBox.getRight()), AbstractC21140mr0.roundToInt(boundingBox.getBottom())));
            return;
        }
