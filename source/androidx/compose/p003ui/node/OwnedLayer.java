...
public interface OwnedLayer {
    ...
    void mo73006inverseTransform58bKbWc(@NotNull float[] fArr);

    /* renamed from: isInLayer-k-4lQ0M  reason: not valid java name */
    boolean mo73007isInLayerk4lQ0M(long j);

    void mapBounds(@NotNull MutableRect mutableRect, boolean z);

    /* renamed from: mapOffset-8S9VItk  reason: not valid java name */
    long mo73008mapOffset8S9VItk(long j, boolean z);

    /* renamed from: move--gyyYBs  reason: not valid java name */
    void mo73009movegyyYBs(long j);

    /* renamed from: resize-ozmzZPI  reason: not valid java name */
    void mo73010resizeozmzZPI(long j);

    void reuseLayer(@NotNull Function1<? super Canvas, Unit> function1, @NotNull Function0<Unit> function0);

    /* renamed from: transform-58bKbWc  reason: not valid java name */
    void mo73011transform58bKbWc(@NotNull float[] fArr);

    void updateDisplayList();

    /* renamed from: updateLayerProperties-dDxr-wY  reason: not valid java name */
    void mo73012updateLayerPropertiesdDxrwY(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, @NotNull Shape shape, boolean z, @Nullable RenderEffect renderEffect, long j2, long j3, int i, @NotNull LayoutDirection layoutDirection, @NotNull Density density);
}
