...
public final class LayoutNodeDrawScope implements DrawScope, ContentDrawScope {
    ...
    /* renamed from: a */
    public final CanvasDrawScope f30284a;

    /* renamed from: b */
    public DrawModifierNode f30285b;
    ...
    public final void m72914drawx_KDEd0$ui_release(@NotNull Canvas canvas, long j, @NotNull NodeCoordinator coordinator, @NotNull Modifier.Node drawNode) {
        ...
        while (drawNode != null) {
            if (drawNode instanceof DrawModifierNode) {
                m72915drawDirectx_KDEd0$ui_release(canvas, j, coordinator, (DrawModifierNode) drawNode);
            } else if ((drawNode.getKindSet$ui_release() & m72961constructorimpl) != 0 && (drawNode instanceof DelegatingNode)) {
                int i = 0;
            ...
            drawNode = DelegatableNodeKt.m59509b(mutableVector);
        }
    }
    ...
    public void mo72124drawArcillE91I(@NotNull Brush brush, float f, float f2, boolean z, long j, long j2, float f3, @NotNull DrawStyle style, @Nullable ColorFilter colorFilter, int i) {
        ...
        this.f30284a.mo72124drawArcillE91I(brush, f, f2, z, j, j2, f3, style, colorFilter, i);
    }
    ...
    public void mo72125drawArcyD3GUKo(long j, float f, float f2, boolean z, long j2, long j3, float f3, @NotNull DrawStyle style, @Nullable ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(style, "style");
        this.f30284a.mo72125drawArcyD3GUKo(j, f, f2, z, j2, j3, f3, style, colorFilter, i);
    }
    ...
    public void mo72126drawCircleV9BoPsw(@NotNull Brush brush, float f, long j, float f2, @NotNull DrawStyle style, @Nullable ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(brush, "brush");
        Intrinsics.checkNotNullParameter(style, "style");
        this.f30284a.mo72126drawCircleV9BoPsw(brush, f, j, f2, style, colorFilter, i);
    }
    ...
    public void mo72127drawCircleVaOC9Bg(long j, float f, long j2, float f2, @NotNull DrawStyle style, @Nullable ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(style, "style");
        this.f30284a.mo72127drawCircleVaOC9Bg(j, f, j2, f2, style, colorFilter, i);
    }

    @Override // androidx.compose.p003ui.graphics.drawscope.ContentDrawScope
    public void drawContent() {
        Modifier.Node m59475a;
        Canvas canvas = getDrawContext().getCanvas();
        DrawModifierNode drawModifierNode = this.f30285b;
        Intrinsics.checkNotNull(drawModifierNode);
        m59475a = LayoutNodeDrawScopeKt.m59475a(drawModifierNode);
        if (m59475a != null) {
            int m72961constructorimpl = NodeKind.m72961constructorimpl(4);
            MutableVector mutableVector = null;
            while (m59475a != null) {
                if (m59475a instanceof DrawModifierNode) {
                    performDraw((DrawModifierNode) m59475a, canvas);
                } else if ((m59475a.getKindSet$ui_release() & m72961constructorimpl) != 0 && (m59475a instanceof DelegatingNode)) {
                    int i = 0;
                    for (Modifier.Node delegate$ui_release = ((DelegatingNode) m59475a).getDelegate$ui_release(); delegate$ui_release != null; delegate$ui_release = delegate$ui_release.getChild$ui_release()) {
                        if ((delegate$ui_release.getKindSet$ui_release() & m72961constructorimpl) != 0) {
                            i++;
                            if (i == 1) {
                                m59475a = delegate$ui_release;
                            } else {
                                if (mutableVector == null) {
                                    mutableVector = new MutableVector(new Modifier.Node[16], 0);
                                }
                                if (m59475a != null) {
                                    mutableVector.add(m59475a);
                                    m59475a = null;
                                }
                                mutableVector.add(delegate$ui_release);
                            }
                ...
                m59475a = DelegatableNodeKt.m59509b(mutableVector);
            }
            return;
        }
        NodeCoordinator m72894requireCoordinator64DMado = DelegatableNodeKt.m72894requireCoordinator64DMado(drawModifierNode, NodeKind.m72961constructorimpl(4));
        if (m72894requireCoordinator64DMado.getTail() == drawModifierNode.getNode()) {
            m72894requireCoordinator64DMado = m72894requireCoordinator64DMado.getWrapped$ui_release();
            Intrinsics.checkNotNull(m72894requireCoordinator64DMado);
        }
        m72894requireCoordinator64DMado.performDraw(canvas);
    }

    /* renamed from: drawDirect-x_KDEd0$ui_release  reason: not valid java name */
    public final void m72915drawDirectx_KDEd0$ui_release(@NotNull Canvas canvas, long j, @NotNull NodeCoordinator coordinator, @NotNull DrawModifierNode drawNode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(coordinator, "coordinator");
        Intrinsics.checkNotNullParameter(drawNode, "drawNode");
        DrawModifierNode drawModifierNode = this.f30285b;
        this.f30285b = drawNode;
        CanvasDrawScope canvasDrawScope = this.f30284a;
    ...
    public /* synthetic */ void mo72128drawImage9jGpkUE(ImageBitmap image, long j, long j2, long j3, long j4, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        ...
        Intrinsics.checkNotNullParameter(style, "style");
        this.f30284a.mo72128drawImage9jGpkUE(image, j, j2, j3, j4, f, style, colorFilter, i);
    }
    ...
    public void mo72129drawImageAZ2fEMs(@NotNull ImageBitmap image, long j, long j2, long j3, long j4, float f, @NotNull DrawStyle style, @Nullable ColorFilter colorFilter, int i, int i2) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(style, "style");
        this.f30284a.mo72129drawImageAZ2fEMs(image, j, j2, j3, j4, f, style, colorFilter, i, i2);
    }
    ...
    public void mo72130drawImagegbVJVH8(@NotNull ImageBitmap image, long j, float f, @NotNull DrawStyle style, @Nullable ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(style, "style");
        this.f30284a.mo72130drawImagegbVJVH8(image, j, f, style, colorFilter, i);
    }
    ...
    public void mo72131drawLine1RTmtNc(@NotNull Brush brush, long j, long j2, float f, int i, @Nullable PathEffect pathEffect, float f2, @Nullable ColorFilter colorFilter, int i2) {
        Intrinsics.checkNotNullParameter(brush, "brush");
        this.f30284a.mo72131drawLine1RTmtNc(brush, j, j2, f, i, pathEffect, f2, colorFilter, i2);
    }
    ...
    public void mo72132drawLineNGM6Ib0(long j, long j2, long j3, float f, int i, @Nullable PathEffect pathEffect, float f2, @Nullable ColorFilter colorFilter, int i2) {
        this.f30284a.mo72132drawLineNGM6Ib0(j, j2, j3, f, i, pathEffect, f2, colorFilter, i2);
    }
    ...
    public void mo72133drawOvalAsUm42w(@NotNull Brush brush, long j, long j2, float f, @NotNull DrawStyle style, @Nullable ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(brush, "brush");
        Intrinsics.checkNotNullParameter(style, "style");
        this.f30284a.mo72133drawOvalAsUm42w(brush, j, j2, f, style, colorFilter, i);
    }
    ...
    public void mo72134drawOvalnJ9OG0(long j, long j2, long j3, float f, @NotNull DrawStyle style, @Nullable ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(style, "style");
        this.f30284a.mo72134drawOvalnJ9OG0(j, j2, j3, f, style, colorFilter, i);
    }
    ...
    public void mo72135drawPathGBMwjPU(@NotNull Path path, @NotNull Brush brush, float f, @NotNull DrawStyle style, @Nullable ColorFilter colorFilter, int i) {
        ...
        Intrinsics.checkNotNullParameter(brush, "brush");
        Intrinsics.checkNotNullParameter(style, "style");
        this.f30284a.mo72135drawPathGBMwjPU(path, brush, f, style, colorFilter, i);
    }
    ...
    public void mo72136drawPathLG529CI(@NotNull Path path, long j, float f, @NotNull DrawStyle style, @Nullable ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(path, "path");
        Intrinsics.checkNotNullParameter(style, "style");
        this.f30284a.mo72136drawPathLG529CI(path, j, f, style, colorFilter, i);
    }
    ...
    public void mo72137drawPointsF8ZwMP8(@NotNull List<Offset> points, int i, long j, float f, int i2, @Nullable PathEffect pathEffect, float f2, @Nullable ColorFilter colorFilter, int i3) {
        ...
        this.f30284a.mo72137drawPointsF8ZwMP8(points, i, j, f, i2, pathEffect, f2, colorFilter, i3);
    }
    ...
    public void mo72138drawPointsGsft0Ws(@NotNull List<Offset> points, int i, @NotNull Brush brush, float f, int i2, @Nullable PathEffect pathEffect, float f2, @Nullable ColorFilter colorFilter, int i3) {
        Intrinsics.checkNotNullParameter(points, "points");
        Intrinsics.checkNotNullParameter(brush, "brush");
        this.f30284a.mo72138drawPointsGsft0Ws(points, i, brush, f, i2, pathEffect, f2, colorFilter, i3);
    }
    ...
    public void mo72139drawRectAsUm42w(@NotNull Brush brush, long j, long j2, float f, @NotNull DrawStyle style, @Nullable ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(brush, "brush");
        Intrinsics.checkNotNullParameter(style, "style");
        this.f30284a.mo72139drawRectAsUm42w(brush, j, j2, f, style, colorFilter, i);
    }
    ...
    public void mo72140drawRectnJ9OG0(long j, long j2, long j3, float f, @NotNull DrawStyle style, @Nullable ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(style, "style");
        this.f30284a.mo72140drawRectnJ9OG0(j, j2, j3, f, style, colorFilter, i);
    }
    ...
    public void mo72141drawRoundRectZuiqVtQ(@NotNull Brush brush, long j, long j2, long j3, float f, @NotNull DrawStyle style, @Nullable ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(brush, "brush");
        Intrinsics.checkNotNullParameter(style, "style");
        this.f30284a.mo72141drawRoundRectZuiqVtQ(brush, j, j2, j3, f, style, colorFilter, i);
    }
    ...
    public void mo72142drawRoundRectuAw5IA(long j, long j2, long j3, long j4, @NotNull DrawStyle style, float f, @Nullable ColorFilter colorFilter, int i) {
        Intrinsics.checkNotNullParameter(style, "style");
        this.f30284a.mo72142drawRoundRectuAw5IA(j, j2, j3, j4, style, f, colorFilter, i);
    }

    @Override // androidx.compose.p003ui.graphics.drawscope.DrawScope
    /* renamed from: getCenter-F1C5BW0 */
    public long mo72143getCenterF1C5BW0() {
        return this.f30284a.mo72143getCenterF1C5BW0();
    }

    @Override // androidx.compose.p003ui.unit.Density
    public float getDensity() {
        return this.f30284a.getDensity();
    }

    @Override // androidx.compose.p003ui.graphics.drawscope.DrawScope
    @NotNull
    public DrawContext getDrawContext() {
        return this.f30284a.getDrawContext();
    }

    @Override // androidx.compose.p003ui.unit.Density
    public float getFontScale() {
        return this.f30284a.getFontScale();
    }

    @Override // androidx.compose.p003ui.graphics.drawscope.DrawScope
    @NotNull
    public LayoutDirection getLayoutDirection() {
        return this.f30284a.getLayoutDirection();
    }

    @Override // androidx.compose.p003ui.graphics.drawscope.DrawScope
    /* renamed from: getSize-NH-jbRc */
    public long mo72144getSizeNHjbRc() {
        return this.f30284a.mo72144getSizeNHjbRc();
    }
    ...
    public final void performDraw(@NotNull DrawModifierNode drawModifierNode, @NotNull Canvas canvas) {
        ...
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        NodeCoordinator m72894requireCoordinator64DMado = DelegatableNodeKt.m72894requireCoordinator64DMado(drawModifierNode, NodeKind.m72961constructorimpl(4));
        m72894requireCoordinator64DMado.getLayoutNode().getMDrawScope$ui_release().m72915drawDirectx_KDEd0$ui_release(canvas, IntSizeKt.m73828toSizeozmzZPI(m72894requireCoordinator64DMado.mo72816getSizeYbymL2g()), m72894requireCoordinator64DMado, drawModifierNode);
    }
    ...
    public int mo69431roundToPxR2X_6o(long j) {
        return this.f30284a.mo69431roundToPxR2X_6o(j);
    }
    ...
    public int mo69432roundToPx0680j_4(float f) {
        return this.f30284a.mo69432roundToPx0680j_4(f);
    }
    ...
    public float mo69433toDpGaN1DYA(long j) {
        return this.f30284a.mo69433toDpGaN1DYA(j);
    }
    ...
    public float mo69434toDpu2uoSUM(float f) {
        return this.f30284a.mo69434toDpu2uoSUM(f);
    }
    ...
    public long mo69436toDpSizekrfVVM(long j) {
        return this.f30284a.mo69436toDpSizekrfVVM(j);
    }
    ...
    public float mo69437toPxR2X_6o(long j) {
        return this.f30284a.mo69437toPxR2X_6o(j);
    }
    ...
    public float mo69438toPx0680j_4(float f) {
        return this.f30284a.mo69438toPx0680j_4(f);
    }
    ...
    public Rect toRect(@NotNull DpRect dpRect) {
        ...
        return this.f30284a.toRect(dpRect);
    }
    ...
    public long mo69439toSizeXkaWNTQ(long j) {
        return this.f30284a.mo69439toSizeXkaWNTQ(j);
    }
    ...
    public long mo69440toSp0xMU5do(float f) {
        return this.f30284a.mo69440toSp0xMU5do(f);
    }
    ...
    public float mo69435toDpu2uoSUM(int i) {
        return this.f30284a.mo69435toDpu2uoSUM(i);
    }
    ...
    public long mo69442toSpkPz2Gy4(int i) {
        return this.f30284a.mo69442toSpkPz2Gy4(i);
    }
