...
public final class NestedVectorStack<T> {
    ...
    /* renamed from: c */
    public int[] f30370c = new int[16];

    /* renamed from: d */
    public final MutableVector f30371d = new MutableVector(new MutableVector[16], 0);

    /* renamed from: a */
    public final void m59432a(int i) {
        int i2 = this.f30369b;
    ...
    public final T pop() {
        int[] iArr;
        int i = this.f30368a;
        int i2 = this.f30370c[i];
        MutableVector mutableVector = (MutableVector) this.f30371d.getContent()[i];
        if (i2 > 0) {
            this.f30370c[i] = iArr[i] - 1;
        } else if (i2 == 0) {
            this.f30371d.removeAt(i);
            this.f30368a--;
        }
    ...
    public final void push(@NotNull MutableVector<T> vector) {
        ...
        if (vector.isNotEmpty()) {
            this.f30371d.add(vector);
            m59432a(vector.getSize() - 1);
            this.f30368a++;
        }
    }
}
