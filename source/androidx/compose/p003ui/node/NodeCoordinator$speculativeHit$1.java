...
public final class NodeCoordinator$speculativeHit$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke2() {
        ...
        m59394a = NodeCoordinatorKt.m59394a(this.$this_speculativeHit, this.$hitTestSource.mo72958entityTypeOLwlOKw(), NodeKind.m72961constructorimpl(2));
        nodeCoordinator.m59400n(m59394a, this.$hitTestSource, this.$pointerPosition, this.$hitTestResult, this.$isTouchEvent, this.$isInLayer, this.$distanceFromEdge);
    }
}
