...
public final class SemanticsModifierNodeKt {
    ...
    public static final Rect touchBoundsInRoot(@NotNull Modifier.Node node, boolean z) {
        ...
        if (!z) {
            return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m72894requireCoordinator64DMado(node, NodeKind.m72961constructorimpl(8)));
        }
        return DelegatableNodeKt.m72894requireCoordinator64DMado(node, NodeKind.m72961constructorimpl(8)).touchBoundsInRoot();
    }
}
