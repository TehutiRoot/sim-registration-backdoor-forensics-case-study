...
public final class LayoutNodeLayoutDelegate$MeasurePassDelegate$layoutChildren$1$1 extends Lambda implements Function0<Unit> {
    ...
    /* loaded from: classes2.dex */
    public static final class C35181 extends Lambda implements Function1<AlignmentLinesOwner, Unit> {
        public static final C35181 INSTANCE = new C35181();
    ...
    /* loaded from: classes2.dex */
    public static final class C35192 extends Lambda implements Function1<AlignmentLinesOwner, Unit> {
        public static final C35192 INSTANCE = new C35192();
    ...
    public final void invoke2() {
        this.this$0.m59463c();
        this.this$0.forEachChildAlignmentLinesOwner(C35181.INSTANCE);
        this.$this_with.getInnerCoordinator$ui_release().getMeasureResult$ui_release().placeChildren();
        this.this$0.m59464b();
        this.this$0.forEachChildAlignmentLinesOwner(C35192.INSTANCE);
    }
}
