...
public final class AndroidClipboardManager implements ClipboardManager {
    ...
    public boolean hasText() {
        ClipDescription primaryClipDescription = this.f30464a.getPrimaryClipDescription();
    ...
    public void setText(@NotNull AnnotatedString annotatedString) {
        ...
        this.f30464a.setPrimaryClip(ClipData.newPlainText("plain text", AndroidClipboardManager_androidKt.convertToCharSequence(annotatedString)));
    }
