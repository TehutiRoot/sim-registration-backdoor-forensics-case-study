...
public final class WeakCache<T> {
    ...
    /* renamed from: a */
    public final MutableVector f30801a = new MutableVector(new Reference[16], 0);

    /* renamed from: b */
    public final ReferenceQueue f30802b = new ReferenceQueue();

    /* renamed from: a */
    public final void m59190a() {
        Reference<? extends T> poll;
        do {
            poll = this.f30802b.poll();
            if (poll != null) {
                this.f30801a.remove(poll);
                continue;
            }
        } while (poll != null);
    }
    ...
    public final int getSize() {
        m59190a();
        return this.f30801a.getSize();
    }

    @Nullable
    public final T pop() {
        m59190a();
        while (this.f30801a.isNotEmpty()) {
            MutableVector mutableVector = this.f30801a;
    ...
    public final void push(T t) {
        m59190a();
        this.f30801a.add(new WeakReference(t, this.f30802b));
    }
}
