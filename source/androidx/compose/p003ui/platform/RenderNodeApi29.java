...
public final class RenderNodeApi29 implements DeviceRenderNode {
    ...
    /* renamed from: a */
    public final AndroidComposeView f30741a;

    /* renamed from: b */
    public final RenderNode f30742b;

    /* renamed from: c */
    public RenderEffect f30743c;
    ...
    public RenderNodeApi29(@NotNull AndroidComposeView ownerView) {
        ...
        this.f30741a = ownerView;
        this.f30742b = AbstractC17894Jw1.m67665a("Compose");
        this.f30744d = CompositingStrategy.Companion.m71816getAutoNrFUSI();
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void discardDisplayList() {
        this.f30742b.discardDisplayList();
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void drawInto(@NotNull Canvas canvas) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        canvas.drawRenderNode(this.f30742b);
    }
    ...
    public DeviceRenderNodeData dumpRenderNodeData() {
        ...
        float alpha;
        uniqueId = this.f30742b.getUniqueId();
        left = this.f30742b.getLeft();
        top = this.f30742b.getTop();
        right = this.f30742b.getRight();
        bottom = this.f30742b.getBottom();
        width = this.f30742b.getWidth();
        height = this.f30742b.getHeight();
        scaleX = this.f30742b.getScaleX();
        scaleY = this.f30742b.getScaleY();
        translationX = this.f30742b.getTranslationX();
        translationY = this.f30742b.getTranslationY();
        elevation = this.f30742b.getElevation();
        ambientShadowColor = this.f30742b.getAmbientShadowColor();
        spotShadowColor = this.f30742b.getSpotShadowColor();
        rotationZ = this.f30742b.getRotationZ();
        rotationX = this.f30742b.getRotationX();
        rotationY = this.f30742b.getRotationY();
        cameraDistance = this.f30742b.getCameraDistance();
        pivotX = this.f30742b.getPivotX();
        pivotY = this.f30742b.getPivotY();
        clipToOutline = this.f30742b.getClipToOutline();
        clipToBounds = this.f30742b.getClipToBounds();
        alpha = this.f30742b.getAlpha();
        return new DeviceRenderNodeData(uniqueId, left, top, right, bottom, width, height, scaleX, scaleY, translationX, translationY, elevation, ambientShadowColor, spotShadowColor, rotationZ, rotationX, rotationY, cameraDistance, pivotX, pivotY, clipToOutline, clipToBounds, alpha, this.f30743c, this.f30744d, null);
    }
    ...
    public boolean getHasDisplayList() {
        ...
        hasDisplayList = this.f30742b.hasDisplayList();
    ...
    public void getInverseMatrix(@NotNull Matrix matrix) {
        ...
        this.f30742b.getInverseMatrix(matrix);
    }
    ...
    public final boolean hasOverlappingRendering$ui_release() {
        ...
        hasOverlappingRendering = this.f30742b.hasOverlappingRendering();
        return hasOverlappingRendering;
    }

    public final boolean isUsingCompositingLayer$ui_release() {
        boolean useCompositingLayer;
        useCompositingLayer = this.f30742b.getUseCompositingLayer();
        return useCompositingLayer;
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void offsetLeftAndRight(int i) {
        this.f30742b.offsetLeftAndRight(i);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void offsetTopAndBottom(int i) {
        this.f30742b.offsetTopAndBottom(i);
    }
    ...
    public void record(@NotNull CanvasHolder canvasHolder, @Nullable Path path, @NotNull Function1<? super androidx.compose.p003ui.graphics.Canvas, Unit> drawBlock) {
        ...
        beginRecording = this.f30742b.beginRecording();
        ...
        this.f30742b.endRecording();
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setAlpha(float f) {
        this.f30742b.setAlpha(f);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setAmbientShadowColor(int i) {
        this.f30742b.setAmbientShadowColor(i);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setCameraDistance(float f) {
        this.f30742b.setCameraDistance(f);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setClipToBounds(boolean z) {
        this.f30742b.setClipToBounds(z);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setClipToOutline(boolean z) {
        this.f30742b.setClipToOutline(z);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    /* renamed from: setCompositingStrategy-aDBOjCE */
    public void mo73030setCompositingStrategyaDBOjCE(int i) {
        RenderNode renderNode = this.f30742b;
    ...
    public void setElevation(float f) {
        this.f30742b.setElevation(f);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public boolean setHasOverlappingRendering(boolean z) {
        boolean hasOverlappingRendering;
        hasOverlappingRendering = this.f30742b.setHasOverlappingRendering(z);
        return hasOverlappingRendering;
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setOutline(@Nullable Outline outline) {
        this.f30742b.setOutline(outline);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setPivotX(float f) {
        this.f30742b.setPivotX(f);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setPivotY(float f) {
        this.f30742b.setPivotY(f);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public boolean setPosition(int i, int i2, int i3, int i4) {
        boolean position;
        position = this.f30742b.setPosition(i, i2, i3, i4);
        return position;
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setRenderEffect(@Nullable RenderEffect renderEffect) {
        this.f30743c = renderEffect;
        if (Build.VERSION.SDK_INT >= 31) {
            C18342Qw1.f5219a.m66514a(this.f30742b, renderEffect);
        }
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setRotationX(float f) {
        this.f30742b.setRotationX(f);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setRotationY(float f) {
        this.f30742b.setRotationY(f);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setRotationZ(float f) {
        this.f30742b.setRotationZ(f);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setScaleX(float f) {
        this.f30742b.setScaleX(f);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setScaleY(float f) {
        this.f30742b.setScaleY(f);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setSpotShadowColor(int i) {
        this.f30742b.setSpotShadowColor(i);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setTranslationX(float f) {
        this.f30742b.setTranslationX(f);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setTranslationY(float f) {
        this.f30742b.setTranslationY(f);
    }
}
