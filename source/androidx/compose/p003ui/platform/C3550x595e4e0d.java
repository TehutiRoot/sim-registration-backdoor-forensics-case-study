...
public final class C3550x595e4e0d extends Lambda implements Function0<Unit> {
    final /* synthetic */ ScrollObservationScope $scrollObservationScope;
    final /* synthetic */ AndroidComposeViewAccessibilityDelegateCompat this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C3550x595e4e0d(ScrollObservationScope scrollObservationScope, AndroidComposeViewAccessibilityDelegateCompat androidComposeViewAccessibilityDelegateCompat) {
        super(0);
    ...
    public final void invoke2() {
        ...
        if (floatValue != 0.0f || floatValue2 != 0.0f) {
            m59318Q = this.this$0.m59318Q(this.$scrollObservationScope.getSemanticsNodeId());
            AndroidComposeViewAccessibilityDelegateCompat.m59313V(this.this$0, m59318Q, 2048, 1, null, 8, null);
            AccessibilityEvent createEvent$ui_release = this.this$0.createEvent$ui_release(m59318Q, 4096);
            ...
            if (Build.VERSION.SDK_INT >= 28) {
                AndroidComposeViewAccessibilityDelegateCompat.C3535b.m59268a(createEvent$ui_release, (int) floatValue, (int) floatValue2);
            }
            this.this$0.m59315T(createEvent$ui_release);
        }
        if (horizontalScrollAxisRange != null) {
