...
public final class LocalSoftwareKeyboardController {
    ...
    /* renamed from: a */
    public static final ProvidableCompositionLocal f30707a = CompositionLocalKt.compositionLocalOf$default(null, C3569x568c8b93.INSTANCE, 1, null);
    ...
    /* renamed from: a */
    public final SoftwareKeyboardController m59218a(Composer composer, int i) {
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new C1230RF(textInputService);
            composer.updateRememberedValue(rememberedValue);
        }
        composer.endReplaceableGroup();
        C1230RF c1230rf = (C1230RF) rememberedValue;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final SoftwareKeyboardController getCurrent(@Nullable Composer composer, int i) {
        ...
        SoftwareKeyboardController softwareKeyboardController = (SoftwareKeyboardController) composer.consume(f30707a);
        if (softwareKeyboardController == null) {
            softwareKeyboardController = m59218a(composer, i & 14);
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    ...
    public final ProvidedValue<SoftwareKeyboardController> provides(@NotNull SoftwareKeyboardController softwareKeyboardController) {
        ...
        return f30707a.provides(softwareKeyboardController);
    }
}
