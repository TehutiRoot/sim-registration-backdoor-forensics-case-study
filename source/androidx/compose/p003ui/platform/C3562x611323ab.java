...
public final class C3562x611323ab extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public C3562x611323ab(AndroidComposeView androidComposeView, AndroidUriHandler androidUriHandler, Function2<? super Composer, ? super Integer, Unit> function2, int i) {
        super(2);
