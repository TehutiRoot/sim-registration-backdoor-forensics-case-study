...
public final class C3510xd651ace7 extends Lambda implements Function1<InspectorInfo, Unit> {
    final /* synthetic */ ProvidableModifierLocal $key$inlined;
    final /* synthetic */ Function0 $value$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C3510xd651ace7(ProvidableModifierLocal providableModifierLocal, Function0 function0) {
        super(1);
    ...
    public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set(Action.KEY_ATTRIBUTE, this.$key$inlined);
