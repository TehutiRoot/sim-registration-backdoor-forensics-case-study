...
public final class ShadowKt$shadows4CzXII$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("elevation", C3641Dp.m73656boximpl(this.$elevation$inlined));
        ...
        inspectorInfo.getProperties().set("ambientColor", Color.m71725boximpl(this.$ambientColor$inlined));
        inspectorInfo.getProperties().set("spotColor", Color.m71725boximpl(this.$spotColor$inlined));
    }
}
