...
public final class TwoDimensionalFocusSearchKt$generateAndSearchChildren$1 extends Lambda implements Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean> {
    ...
    public final Boolean invoke(@NotNull BeyondBoundsLayout.BeyondBoundsScope searchBeyondBounds) {
        ...
        m59768p = TwoDimensionalFocusSearchKt.m59768p(this.$this_generateAndSearchChildren, this.$focusedItem, this.$direction, this.$onFound);
        Boolean valueOf = Boolean.valueOf(m59768p);
        if (m59768p || !searchBeyondBounds.getHasMoreContent()) {
            return valueOf;
        }
        return null;
    }
