...
public final class SimpleArrayMap<K, V> {
    ...
    public final void clear() {
        if (this.f31223c > 0) {
            this.f31221a = ContainerHelpersKt.EMPTY_INTS;
            this.f31222b = ContainerHelpersKt.EMPTY_OBJECTS;
            this.f31223c = 0;
        }
        if (this.f31223c <= 0) {
            return;
    ...
    public final void ensureCapacity(int i) {
        ...
        if (iArr.length < i) {
            ...
            this.f31221a = copyOf;
            Object[] copyOf2 = Arrays.copyOf(this.f31222b, i << 1);
            Intrinsics.checkNotNullExpressionValue(copyOf2, "copyOf(this, newSize)");
            this.f31222b = copyOf2;
        }
        if (this.f31223c == i2) {
            return;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        try {
            if (obj instanceof SimpleArrayMap) {
                ...
                return true;
            } else if (!(obj instanceof Map) || this.f31223c != ((Map) obj).size()) {
                return false;
            } else {
                int i3 = this.f31223c;
    ...
    public final V get(K k) {
        ...
        if (indexOfKey >= 0) {
            return (V) this.f31222b[(indexOfKey << 1) + 1];
        }
        return null;
    }
    ...
    public final int indexOf(@NotNull Object key, int i) {
        ...
        int binarySearchInternal = ContainerHelpersKt.binarySearchInternal(this.f31221a, i2, i);
        if (binarySearchInternal < 0) {
            return binarySearchInternal;
        }
        if (Intrinsics.areEqual(key, this.f31222b[binarySearchInternal << 1])) {
            return binarySearchInternal;
        }
        int i3 = binarySearchInternal + 1;
        while (i3 < i2 && this.f31221a[i3] == i) {
            if (Intrinsics.areEqual(key, this.f31222b[i3 << 1])) {
                return i3;
            }
            i3++;
        }
        for (int i4 = binarySearchInternal - 1; i4 >= 0 && this.f31221a[i4] == i; i4--) {
            if (Intrinsics.areEqual(key, this.f31222b[i4 << 1])) {
                return i4;
            }
        }
        return ~i3;
    ...
    public final int indexOfNull() {
        ...
        int binarySearchInternal = ContainerHelpersKt.binarySearchInternal(this.f31221a, i, 0);
        if (binarySearchInternal < 0) {
            return binarySearchInternal;
        }
        if (this.f31222b[binarySearchInternal << 1] == null) {
            return binarySearchInternal;
        }
        int i2 = binarySearchInternal + 1;
        while (i2 < i && this.f31221a[i2] == 0) {
            if (this.f31222b[i2 << 1] == null) {
                return i2;
            }
            i2++;
        }
        for (int i3 = binarySearchInternal - 1; i3 >= 0 && this.f31221a[i3] == 0; i3--) {
            if (this.f31222b[i3 << 1] == null) {
                return i3;
            }
        }
        return ~i2;
    ...
    public final V put(K k, V v) {
        ...
        if (i >= iArr.length) {
            ...
            Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(this, newSize)");
            this.f31221a = copyOf;
            Object[] copyOf2 = Arrays.copyOf(this.f31222b, i4 << 1);
            Intrinsics.checkNotNullExpressionValue(copyOf2, "copyOf(this, newSize)");
            this.f31222b = copyOf2;
            if (i != this.f31223c) {
                throw new ConcurrentModificationException();
        ...
        if (i3 < i) {
            int[] iArr2 = this.f31221a;
            int i5 = i3 + 1;
            ArraysKt___ArraysJvmKt.copyInto(iArr2, iArr2, i5, i3, i);
            Object[] objArr2 = this.f31222b;
            ArraysKt___ArraysJvmKt.copyInto(objArr2, objArr2, i5 << 1, i3 << 1, this.f31223c << 1);
        }
        int i6 = this.f31223c;
        if (i == i6) {
            int[] iArr3 = this.f31221a;
            if (i3 < iArr3.length) {
                iArr3[i3] = hashCode;
                Object[] objArr3 = this.f31222b;
                int i7 = i3 << 1;
                objArr3[i7] = k;
                objArr3[i7 + 1] = v;
                this.f31223c = i6 + 1;
    ...
    public final void putAll(@NotNull SimpleArrayMap<? extends K, ? extends V> array) {
        ...
        int i = array.f31223c;
        ensureCapacity(this.f31223c + i);
        if (this.f31223c == 0) {
            if (i > 0) {
                ArraysKt___ArraysJvmKt.copyInto(array.f31221a, this.f31221a, 0, 0, i);
                ArraysKt___ArraysJvmKt.copyInto(array.f31222b, this.f31222b, 0, 0, i << 1);
                this.f31223c = i;
                return;
            }
            return;
    ...
    public final V removeAt(int i) {
        ...
        if (i3 <= 1) {
            ...
            if (iArr.length > 8 && i3 < iArr.length / 3) {
                ...
                this.f31221a = iArr2;
                this.f31222b = new Object[i5 << 1];
                if (i > 0) {
                    ArraysKt___ArraysJvmKt.copyInto(iArr, iArr2, 0, 0, i);
                    ArraysKt___ArraysJvmKt.copyInto(objArr, this.f31222b, 0, 0, i2);
                }
                if (i < i4) {
                    int i6 = i + 1;
                    ArraysKt___ArraysJvmKt.copyInto(iArr, this.f31221a, i, i6, i3);
                    ArraysKt___ArraysJvmKt.copyInto(objArr, this.f31222b, i2, i6 << 1, i3 << 1);
                }
            } else {
                if (i < i4) {
                    int i7 = i + 1;
    ...
    public String toString() {
        ...
        StringBuilder sb = new StringBuilder(this.f31223c * 28);
        sb.append('{');
        int i = this.f31223c;
        for (int i2 = 0; i2 < i; i2++) {
            if (i2 > 0) {
