...
public final class PlatformParagraphStyle {
    ...
    /* renamed from: c */
    public static final PlatformParagraphStyle f31038c = new PlatformParagraphStyle();
    ...
    @Metadata(m28851d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, m28850d2 = {"Landroidx/compose/ui/text/PlatformParagraphStyle$Companion;", "", "()V", Constant.OnePostpaidVerifyKey.Default, "Landroidx/compose/ui/text/PlatformParagraphStyle;", "getDefault", "()Landroidx/compose/ui/text/PlatformParagraphStyle;", "ui-text_release"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    public static final class Companion {
        ...
        public final PlatformParagraphStyle getDefault() {
            return PlatformParagraphStyle.f31038c;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (this.f31039a == platformParagraphStyle.f31039a && EmojiSupportMatch.m73099equalsimpl0(this.f31040b, platformParagraphStyle.f31040b)) {
            return true;
        }
        return false;
    }
    ...
    public final int m73155getEmojiSupportMatch_3YsG6Y() {
        return this.f31040b;
    }
    ...
    public int hashCode() {
        return (AbstractC1705Xp.m65430a(this.f31039a) * 31) + EmojiSupportMatch.m73100hashCodeimpl(this.f31040b);
    }
    ...
    public String toString() {
        return "PlatformParagraphStyle(includeFontPadding=" + this.f31039a + ", emojiSupportMatch=" + ((Object) EmojiSupportMatch.m73101toStringimpl(this.f31040b)) + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
    ...
    public PlatformParagraphStyle(boolean z) {
        this.f31039a = z;
        this.f31040b = EmojiSupportMatch.Companion.m73103getDefault_3YsG6Y();
    }
    ...
    public /* synthetic */ PlatformParagraphStyle(int i, boolean z, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? EmojiSupportMatch.Companion.m73103getDefault_3YsG6Y() : i, (i2 & 2) != 0 ? true : z, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ PlatformParagraphStyle(int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? EmojiSupportMatch.Companion.m73103getDefault_3YsG6Y() : i, (DefaultConstructorMarker) null);
    }

    public PlatformParagraphStyle() {
        this(EmojiSupportMatch.Companion.m73103getDefault_3YsG6Y(), true, (DefaultConstructorMarker) null);
    }
}
