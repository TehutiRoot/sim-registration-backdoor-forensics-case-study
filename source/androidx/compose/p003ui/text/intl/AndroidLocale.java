...
public final class AndroidLocale implements PlatformLocale {
    ...
    public String getLanguage() {
        String language = this.f31466a.getLanguage();
    ...
    public String getRegion() {
        String country = this.f31466a.getCountry();
    ...
    public String getScript() {
        String script = this.f31466a.getScript();
    ...
    public String toLanguageTag() {
        String languageTag = this.f31466a.toLanguageTag();
