...
public final class TextPaintExtensions_androidKt {
    ...
    public static final SpanStyle m58979a(long j, boolean z, long j2, BaselineShift baselineShift) {
        ...
        if (z2) {
            m73850getUnspecifiedXSAIIZE = j;
        } else {
            m73850getUnspecifiedXSAIIZE = TextUnit.Companion.m73850getUnspecifiedXSAIIZE();
        }
        if (!z3) {
            j3 = companion.m71771getUnspecified0d7_KjU();
        }
        long j4 = j3;
        if (z4) {
        ...
        return new SpanStyle(0L, 0L, (FontWeight) null, (FontStyle) null, (FontSynthesis) null, (FontFamily) null, (String) null, m73850getUnspecifiedXSAIIZE, baselineShift2, (TextGeometricTransform) null, (LocaleList) null, j4, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 63103, (DefaultConstructorMarker) null);
    }
    ...
    public static final SpanStyle applySpanStyle(@NotNull AndroidTextPaint androidTextPaint, @NotNull SpanStyle style, @NotNull Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> resolveTypeface, @NotNull Density density, boolean z) {
        ...
        long m73838getTypeUIouoOA = TextUnit.m73838getTypeUIouoOA(style.m73177getFontSizeXSAIIZE());
        TextUnitType.Companion companion = TextUnitType.Companion;
        if (TextUnitType.m73867equalsimpl0(m73838getTypeUIouoOA, companion.m73872getSpUIouoOA())) {
            androidTextPaint.setTextSize(density.mo69437toPxR2X_6o(style.m73177getFontSizeXSAIIZE()));
        } else if (TextUnitType.m73867equalsimpl0(m73838getTypeUIouoOA, companion.m73871getEmUIouoOA())) {
            androidTextPaint.setTextSize(androidTextPaint.getTextSize() * TextUnit.m73839getValueimpl(style.m73177getFontSizeXSAIIZE()));
        }
        if (hasFontAttributes(style)) {
            ...
            androidTextPaint.setTypeface(resolveTypeface.invoke(fontFamily, fontWeight, m73308boximpl, FontSynthesis.m73317boximpl(m73326getAllGVVA2EU)));
        }
        ...
        androidTextPaint.m73440setColor8_81llA(style.m73176getColor0d7_KjU());
        androidTextPaint.m73439setBrush12SF9DM(style.getBrush(), Size.Companion.m71579getUnspecifiedNHjbRc(), style.getAlpha());
        ...
        if (TextUnitType.m73867equalsimpl0(TextUnit.m73838getTypeUIouoOA(style.m73180getLetterSpacingXSAIIZE()), companion.m73872getSpUIouoOA()) && TextUnit.m73839getValueimpl(style.m73180getLetterSpacingXSAIIZE()) != 0.0f) {
            float textSize = androidTextPaint.getTextSize() * androidTextPaint.getTextScaleX();
            float mo69437toPxR2X_6o = density.mo69437toPxR2X_6o(style.m73180getLetterSpacingXSAIIZE());
            if (textSize != 0.0f) {
                androidTextPaint.setLetterSpacing(mo69437toPxR2X_6o / textSize);
            }
        } else if (TextUnitType.m73867equalsimpl0(TextUnit.m73838getTypeUIouoOA(style.m73180getLetterSpacingXSAIIZE()), companion.m73871getEmUIouoOA())) {
            androidTextPaint.setLetterSpacing(TextUnit.m73839getValueimpl(style.m73180getLetterSpacingXSAIIZE()));
        }
        return m58979a(style.m73180getLetterSpacingXSAIIZE(), z, style.m73174getBackground0d7_KjU(), style.m73175getBaselineShift5SSeXJ0());
    }
    ...
    public static final boolean hasFontAttributes(@NotNull SpanStyle spanStyle) {
        ...
        if (spanStyle.getFontFamily() == null && spanStyle.m73178getFontStyle4Lr2A7w() == null && spanStyle.getFontWeight() == null) {
            return false;
        }
        return true;
    }
    ...
    public static final void setTextMotion(@NotNull AndroidTextPaint androidTextPaint, @Nullable TextMotion textMotion) {
        ...
        int m73574getLinearity4e0Vf04$ui_text_release = textMotion.m73574getLinearity4e0Vf04$ui_text_release();
        TextMotion.Linearity.Companion companion = TextMotion.Linearity.Companion;
        if (TextMotion.Linearity.m73577equalsimpl0(m73574getLinearity4e0Vf04$ui_text_release, companion.m73582getLinear4e0Vf04())) {
            androidTextPaint.setFlags(androidTextPaint.getFlags() | 64);
            androidTextPaint.setHinting(0);
        } else if (TextMotion.Linearity.m73577equalsimpl0(m73574getLinearity4e0Vf04$ui_text_release, companion.m73581getFontHinting4e0Vf04())) {
            androidTextPaint.getFlags();
            androidTextPaint.setHinting(1);
        } else if (TextMotion.Linearity.m73577equalsimpl0(m73574getLinearity4e0Vf04$ui_text_release, companion.m73583getNone4e0Vf04())) {
            androidTextPaint.getFlags();
            androidTextPaint.setHinting(0);
        } else {
            androidTextPaint.getFlags();
