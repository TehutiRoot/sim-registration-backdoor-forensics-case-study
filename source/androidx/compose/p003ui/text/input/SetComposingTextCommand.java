...
public final class SetComposingTextCommand implements EditCommand {
    ...
    /* renamed from: a */
    public final AnnotatedString f31435a;
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (Intrinsics.areEqual(getText(), setComposingTextCommand.getText()) && this.f31436b == setComposingTextCommand.f31436b) {
            return true;
        }
        return false;
    }
    ...
    public final String getText() {
        return this.f31435a.getText();
    }

    public int hashCode() {
        return (getText().hashCode() * 31) + this.f31436b;
    }

    @NotNull
    public String toString() {
        return "SetComposingTextCommand(text='" + getText() + "', newCursorPosition=" + this.f31436b + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
