...
public final class WordIterator {
    ...
    /* renamed from: d */
    public final BreakIterator f31175d;

    @Metadata(m28851d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0015\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u0004H\u0000¢\u0006\u0002\b\bR\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\t"}, m28850d2 = {"Landroidx/compose/ui/text/android/selection/WordIterator$Companion;", "", "()V", "WINDOW_WIDTH", "", "isPunctuation", "", "cp", "isPunctuation$ui_text_release", "ui-text_release"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    public WordIterator(@NotNull CharSequence charSequence, int i, int i2, @Nullable Locale locale) {
        ...
        if (i >= 0 && i <= charSequence.length()) {
            if (i2 >= 0 && i2 <= charSequence.length()) {
                ...
                this.f31175d = wordInstance;
                this.f31173b = Math.max(0, i - 50);
                this.f31174c = Math.min(charSequence.length(), i2 + 50);
    ...
    /* renamed from: a */
    public final void m59062a(int i) {
        int i2 = this.f31173b;
        if (i <= this.f31174c && i2 <= i) {
            return;
        }
        throw new IllegalArgumentException(("Invalid offset: " + i + ". Valid range is [" + this.f31173b + " , " + this.f31174c + AbstractJsonLexerKt.END_LIST).toString());
    }

    /* renamed from: b */
    public final int m59061b(int i, boolean z) {
        m59062a(i);
        if (m59058e(i)) {
            if (!this.f31175d.isBoundary(i) || (m59059d(i) && z)) {
                return this.f31175d.preceding(i);
            }
            return i;
        } else if (m59059d(i)) {
            return this.f31175d.preceding(i);
    ...
    /* renamed from: c */
    public final int m59060c(int i, boolean z) {
        m59062a(i);
        if (m59059d(i)) {
            if (!this.f31175d.isBoundary(i) || (m59058e(i) && z)) {
                return this.f31175d.following(i);
            }
            return i;
        } else if (m59058e(i)) {
            return this.f31175d.following(i);
    ...
    /* renamed from: d */
    public final boolean m59059d(int i) {
        int i2 = this.f31173b + 1;
        if (i <= this.f31174c && i2 <= i && Character.isLetterOrDigit(Character.codePointBefore(this.f31172a, i))) {
            return true;
        }
        return false;
    }
    ...
    /* renamed from: e */
    public final boolean m59058e(int i) {
        int i2 = this.f31173b;
        if (i < this.f31174c && i2 <= i && Character.isLetterOrDigit(Character.codePointAt(this.f31172a, i))) {
            return true;
        }
        return false;
    }
    ...
    /* renamed from: f */
    public final boolean m59057f(int i) {
    ...
    /* renamed from: g */
    public final boolean m59056g(int i) {
        if (isOnPunctuation(i) && !isAfterPunctuation(i)) {
            return true;
        }
        return false;
    ...
    public final boolean isAfterPunctuation(int i) {
        int i2 = this.f31173b + 1;
        if (i <= this.f31174c && i2 <= i) {
            return Companion.isPunctuation$ui_text_release(Character.codePointBefore(this.f31172a, i));
        }
        return false;
    }
    ...
    public final boolean isOnPunctuation(int i) {
        int i2 = this.f31173b;
        if (i < this.f31174c && i2 <= i) {
            return Companion.isPunctuation$ui_text_release(Character.codePointAt(this.f31172a, i));
        }
        return false;
    }
