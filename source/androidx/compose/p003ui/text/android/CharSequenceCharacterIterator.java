...
public final class CharSequenceCharacterIterator implements CharacterIterator {
    ...
    public char current() {
        ...
        return this.f31117a.charAt(i);
    }

    @Override // java.text.CharacterIterator
    public char first() {
        this.f31120d = this.f31118b;
        return current();
    }
    ...
    public char last() {
        ...
        int i3 = i2 - 1;
        this.f31120d = i3;
        return this.f31117a.charAt(i3);
    }

    @Override // java.text.CharacterIterator
    public char next() {
        int i = this.f31120d + 1;
        this.f31120d = i;
        int i2 = this.f31119c;
        if (i >= i2) {
            this.f31120d = i2;
    ...
    public char previous() {
        ...
        int i2 = i - 1;
        this.f31120d = i2;
        return this.f31117a.charAt(i2);
    }

    @Override // java.text.CharacterIterator
    public char setIndex(int i) {
        int i2 = this.f31118b;
        if (i <= this.f31119c && i2 <= i) {
            this.f31120d = i;
            return current();
        }
