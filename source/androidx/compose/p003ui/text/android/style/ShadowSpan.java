...
public final class ShadowSpan extends CharacterStyle {
    ...
    public void updateDrawState(@NotNull TextPaint tp) {
        ...
        tp.setShadowLayer(this.f31206d, this.f31204b, this.f31205c, this.f31203a);
    }
}
