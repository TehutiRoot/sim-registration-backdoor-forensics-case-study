...
public final class BoringLayoutFactory {
        ...
        if (i >= 0) {
            if (i2 >= 0) {
                if (Build.VERSION.SDK_INT >= 33) {
                    return C11546jc.m29189a(text, paint, i, alignment, 1.0f, 0.0f, metrics, z, z2, truncateAt, i2);
                }
                return C11666kc.m28912a(text, paint, i, alignment, 1.0f, 0.0f, metrics, z, truncateAt, i2);
            }
    ...
    public final boolean isFallbackLineSpacingEnabled(@NotNull BoringLayout layout) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            return C11546jc.f67311a.m29187c(layout);
        }
        return false;
    }
    ...
    public final BoringLayout.Metrics measure(@NotNull CharSequence text, @NotNull TextPaint paint, @NotNull TextDirectionHeuristic textDir) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            return C11546jc.m29188b(text, paint, textDir);
        }
        return C11666kc.m28911b(text, paint, textDir);
    }
}
