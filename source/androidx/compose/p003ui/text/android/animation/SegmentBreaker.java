...
@Metadata(m28851d1 = {"\u0000@\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\r\n\u0000\n\u0002\u0018\u0002\n\u0002\b\n\bÁ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J#\u0010\n\u001a\b\u0012\u0004\u0012\u00020\t0\b2\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u0006¢\u0006\u0004\b\n\u0010\u000bJ+\u0010\u000f\u001a\b\u0012\u0004\u0012\u00020\u000e0\b2\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\r\u001a\u00020\f¢\u0006\u0004\b\u000f\u0010\u0010J\u001d\u0010\u0011\u001a\b\u0012\u0004\u0012\u00020\t0\b2\u0006\u0010\u0005\u001a\u00020\u0004H\u0002¢\u0006\u0004\b\u0011\u0010\u0012J%\u0010\u0017\u001a\b\u0012\u0004\u0012\u00020\t0\b2\u0006\u0010\u0014\u001a\u00020\u00132\u0006\u0010\u0016\u001a\u00020\u0015H\u0002¢\u0006\u0004\b\u0017\u0010\u0018J\u001d\u0010\u0019\u001a\b\u0012\u0004\u0012\u00020\u000e0\b2\u0006\u0010\u0005\u001a\u00020\u0004H\u0002¢\u0006\u0004\b\u0019\u0010\u0012J\u001d\u0010\u001a\u001a\b\u0012\u0004\u0012\u00020\u000e0\b2\u0006\u0010\u0005\u001a\u00020\u0004H\u0002¢\u0006\u0004\b\u001a\u0010\u0012J%\u0010\u001b\u001a\b\u0012\u0004\u0012\u00020\u000e0\b2\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\r\u001a\u00020\fH\u0002¢\u0006\u0004\b\u001b\u0010\u001cJ%\u0010\u001d\u001a\b\u0012\u0004\u0012\u00020\u000e0\b2\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\r\u001a\u00020\fH\u0002¢\u0006\u0004\b\u001d\u0010\u001cJ%\u0010\u001e\u001a\b\u0012\u0004\u0012\u00020\u000e0\b2\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\r\u001a\u00020\fH\u0002¢\u0006\u0004\b\u001e\u0010\u001c¨\u0006\u001f"}, m28850d2 = {"Landroidx/compose/ui/text/android/animation/SegmentBreaker;", "", "<init>", "()V", "Landroidx/compose/ui/text/android/LayoutHelper;", "layoutHelper", "Landroidx/compose/ui/text/android/animation/SegmentType;", "segmentType", "", "", "breakOffsets", "(Landroidx/compose/ui/text/android/LayoutHelper;Landroidx/compose/ui/text/android/animation/SegmentType;)Ljava/util/List;", "", "dropSpaces", "Landroidx/compose/ui/text/android/animation/Segment;", "breakSegments", "(Landroidx/compose/ui/text/android/LayoutHelper;Landroidx/compose/ui/text/android/animation/SegmentType;Z)Ljava/util/List;", PDPageLabelRange.STYLE_LETTERS_LOWER, "(Landroidx/compose/ui/text/android/LayoutHelper;)Ljava/util/List;", "", TextBundle.TEXT_ENTRY, "Ljava/text/BreakIterator;", "breaker", OperatorName.NON_STROKING_GRAY, "(Ljava/lang/CharSequence;Ljava/text/BreakIterator;)Ljava/util/List;", OperatorName.CURVE_TO, "e", "d", "(Landroidx/compose/ui/text/android/LayoutHelper;Z)Ljava/util/List;", OperatorName.FILL_NON_ZERO, OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, "ui-text_release"}, m28849k = 1, m28848mv = {1, 8, 0})
...
public final class SegmentBreaker {
    ...
    /* renamed from: a */
    public final List m59069a(LayoutHelper layoutHelper) {
        ...
        List m59063g = m59063g(text, lineInstance);
        TreeSet treeSet = new TreeSet();
        int size = m59063g.size();
        for (int i = 0; i < size; i++) {
            treeSet.add(Integer.valueOf(((Number) m59063g.get(i)).intValue()));
        }
    ...
    /* renamed from: b */
    public final List m59068b(LayoutHelper layoutHelper, boolean z) {
        boolean z2;
        boolean z3;
                ...
                if (i2 != 3) {
                    if (i2 != 4) {
                        if (i2 == 5) {
                            ...
                            return m59063g(text, characterInstance);
                        }
                        throw new NoWhenBranchMatchedException();
                    }
                    return m59069a(layoutHelper);
                }
        ...
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
                    if (i != 4) {
                        if (i == 5) {
                            return m59068b(layoutHelper, z);
                        }
                        throw new NoWhenBranchMatchedException();
                    }
                    return m59064f(layoutHelper, z);
                }
                return m59066d(layoutHelper, z);
            }
            return m59065e(layoutHelper);
        }
        return m59067c(layoutHelper);
    }

    /* renamed from: c */
    public final List m59067c(LayoutHelper layoutHelper) {
        return AbstractC10108ds.listOf(new Segment(0, layoutHelper.getLayout().getText().length(), 0, 0, layoutHelper.getLayout().getWidth(), layoutHelper.getLayout().getHeight()));
    }

    /* renamed from: d */
    public final List m59066d(LayoutHelper layoutHelper, boolean z) {
        int i;
        int width;
        ArrayList arrayList = new ArrayList();
        Layout layout = layoutHelper.getLayout();
    ...
    /* renamed from: e */
    public final List m59065e(LayoutHelper layoutHelper) {
        ArrayList arrayList = new ArrayList();
        Layout layout = layoutHelper.getLayout();
        int paragraphCount = layoutHelper.getParagraphCount();
    ...
    /* renamed from: f */
    public final List m59064f(LayoutHelper layoutHelper, boolean z) {
        boolean z2;
        boolean z3;
        int i;
        Layout layout = layoutHelper.getLayout();
    ...
    /* renamed from: g */
    public final List m59063g(CharSequence charSequence, BreakIterator breakIterator) {
