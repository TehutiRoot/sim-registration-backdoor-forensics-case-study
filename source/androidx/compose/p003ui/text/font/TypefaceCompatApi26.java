...
public final class TypefaceCompatApi26 {
    ...
    /* renamed from: a */
    public static final TypefaceCompatApi26 f31336a = new TypefaceCompatApi26();

    /* renamed from: b */
    public static ThreadLocal f31337b = new ThreadLocal();

    /* renamed from: a */
    public final Typeface m59046a(Typeface typeface, FontVariation.Settings variationSettings, Context context) {
        ...
        Paint paint = (Paint) f31337b.get();
        if (paint == null) {
            paint = new Paint();
            f31337b.set(paint);
        }
        paint.setTypeface(typeface);
        paint.setFontVariationSettings(m59045b(variationSettings, context));
        return paint.getTypeface();
    }

    /* renamed from: b */
    public final String m59045b(FontVariation.Settings settings, Context context) {
