...
public final class AndroidAssetFont extends AndroidPreloadedFont {
    ...
    /* renamed from: h */
    public final AssetManager f31224h;
    ...
    public Typeface doLoad$ui_text_release(@Nullable Context context) {
        if (Build.VERSION.SDK_INT >= 26) {
            return C3621f.f31353a.m59039a(this.f31224h, this.f31225i, context, getVariationSettings());
        }
        return Typeface.createFromAsset(this.f31224h, this.f31225i);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (Intrinsics.areEqual(this.f31225i, androidAssetFont.f31225i) && Intrinsics.areEqual(getVariationSettings(), androidAssetFont.getVariationSettings())) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.f31225i.hashCode() * 31) + getVariationSettings().hashCode();
    }

    @NotNull
    public String toString() {
        return "Font(assetManager, path=" + this.f31225i + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m73313toStringimpl(mo73268getStyle_LCdwA())) + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
    ...
    public /* synthetic */ AndroidAssetFont(AssetManager assetManager, String str, FontWeight fontWeight, int i, FontVariation.Settings settings, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(assetManager, str, (i2 & 4) != 0 ? FontWeight.Companion.getNormal() : fontWeight, (i2 & 8) != 0 ? FontStyle.Companion.m73316getNormal_LCdwA() : i, settings, null);
    }
