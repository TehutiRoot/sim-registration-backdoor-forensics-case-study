...
public abstract class PointerInputFilter {
    ...
    /* renamed from: a */
    public LayoutCoordinates f29986a;
    ...
    public final long m72732getSizeYbymL2g() {
        LayoutCoordinates layoutCoordinates = this.f29986a;
        if (layoutCoordinates != null) {
            return layoutCoordinates.mo72816getSizeYbymL2g();
        }
    ...
    public abstract void mo72733onPointerEventH0pRuoY(@NotNull PointerEvent pointerEvent, @NotNull PointerEventPass pointerEventPass, long j);
    ...
    public final void setLayoutCoordinates$ui_release(@Nullable LayoutCoordinates layoutCoordinates) {
        this.f29986a = layoutCoordinates;
    }
}
