...
public final class PointerInteropUtils_androidKt {
    ...
    public static final void m59601a(PointerEvent pointerEvent, long j, Function1 function1, boolean z) {
        ...
        if (motionEvent$ui_release != null) {
            ...
            motionEvent$ui_release.offsetLocation(-Offset.m71502getXimpl(j), -Offset.m71503getYimpl(j));
    ...
    public static final void m72757toCancelMotionEventScoped4ec7I(@NotNull PointerEvent toCancelMotionEventScope, long j, @NotNull Function1<? super MotionEvent, Unit> block) {
        Intrinsics.checkNotNullParameter(toCancelMotionEventScope, "$this$toCancelMotionEventScope");
        Intrinsics.checkNotNullParameter(block, "block");
        m59601a(toCancelMotionEventScope, j, block, true);
    }

    /* renamed from: toMotionEventScope-d-4ec7I  reason: not valid java name */
    public static final void m72758toMotionEventScoped4ec7I(@NotNull PointerEvent toMotionEventScope, long j, @NotNull Function1<? super MotionEvent, Unit> block) {
        Intrinsics.checkNotNullParameter(toMotionEventScope, "$this$toMotionEventScope");
        Intrinsics.checkNotNullParameter(block, "block");
        m59601a(toMotionEventScope, j, block, false);
    }
}
