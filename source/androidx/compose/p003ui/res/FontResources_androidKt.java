...
public final class FontResources_androidKt {
    ...
    /* renamed from: a */
    public static final Object f30846a = new Object();

    /* renamed from: b */
    public static final Map f30847b = new LinkedHashMap();

    /* renamed from: a */
    public static final Typeface m59150a(Context context, FontFamily fontFamily) {
        Typeface typeface;
    ...
    public static final Typeface fontResource(@NotNull FontFamily fontFamily, @Nullable Composer composer, int i) {
        ...
        Typeface m59150a = m59150a((Context) composer.consume(AndroidCompositionLocals_androidKt.getLocalContext()), fontFamily);
        if (ComposerKt.isTraceInProgress()) {
