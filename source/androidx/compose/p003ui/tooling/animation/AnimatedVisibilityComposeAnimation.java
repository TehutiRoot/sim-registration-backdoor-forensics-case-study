...
public final class AnimatedVisibilityComposeAnimation implements ComposeAnimation {
    ...
    /* renamed from: a */
    public final Transition f31642a;

    /* renamed from: b */
    public final String f31643b;

    /* renamed from: c */
    public final ComposeAnimationType f31644c;

    /* renamed from: d */
    public final Set f31645d;
    ...
    public AnimatedVisibilityComposeAnimation(@NotNull Transition<Boolean> animationObject, @Nullable String str) {
        ...
        this.f31642a = animationObject;
        this.f31643b = str;
        this.f31644c = ComposeAnimationType.ANIMATED_VISIBILITY;
        AnimatedVisibilityState.Companion companion = AnimatedVisibilityState.Companion;
        this.f31645d = DG1.setOf((Object[]) new AnimatedVisibilityState[]{AnimatedVisibilityState.m73607boximpl(companion.m73613getEnterjXw82LU()), AnimatedVisibilityState.m73607boximpl(companion.m73614getExitjXw82LU())});
    }
    ...
    public final Transition<Object> getChildTransition() {
        Object orNull = CollectionsKt___CollectionsKt.getOrNull(m73602getAnimationObject().getTransitions(), 0);
    ...
    public Transition<Boolean> m73602getAnimationObject() {
        return this.f31642a;
    }
}
