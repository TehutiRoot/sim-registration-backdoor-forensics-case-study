...
public final class ComposeViewAdapter$init$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    /* loaded from: classes2.dex */
    public static final class C36281 extends Lambda implements Function2<Composer, Integer, Unit> {
        final /* synthetic */ long $animationClockStartTime;
        final /* synthetic */ String $className;
        final /* synthetic */ String $methodName;
        final /* synthetic */ Class<? extends PreviewParameterProvider<?>> $parameterProvider;
        ...
        /* loaded from: classes2.dex */
        public static final class C36291 extends Lambda implements Function0<Unit> {
            final /* synthetic */ ComposeViewAdapter this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C36291(ComposeViewAdapter composeViewAdapter) {
                super(0);
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C36281(long j, ComposeViewAdapter composeViewAdapter, String str, String str2, Class<? extends PreviewParameterProvider<?>> cls, int i) {
            super(2);
        ...
        public final void invoke(@Nullable Composer composer, int i) {
            ...
            if (this.$animationClockStartTime >= 0) {
                ...
                composeViewAdapter.setClock$ui_tooling_release(new PreviewAnimationClock(new C36291(composeViewAdapter)));
            }
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        ComposeViewAdapter composeViewAdapter = this.this$0;
        composeViewAdapter.m58958a(ComposableLambdaKt.composableLambda(composer, 1938351266, true, new C36281(this.$animationClockStartTime, composeViewAdapter, this.$className, this.$methodName, this.$parameterProvider, this.$parameterProviderIndex)), composer, 70);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    }
