...
public interface LayoutCoordinates {
    ...
    public static final class DefaultImpls {
        ...
        public static void m72822transformFromEL8BTi8(@NotNull LayoutCoordinates layoutCoordinates, @NotNull LayoutCoordinates sourceCoordinates, @NotNull float[] matrix) {
            Intrinsics.checkNotNullParameter(sourceCoordinates, "sourceCoordinates");
            Intrinsics.checkNotNullParameter(matrix, "matrix");
            AbstractC19909fi0.m31267a(layoutCoordinates, sourceCoordinates, matrix);
        }
    }
    ...
    long mo72817localPositionOfR5De75A(@NotNull LayoutCoordinates layoutCoordinates, long j);

    /* renamed from: localToRoot-MK-Hz9U  reason: not valid java name */
    long mo72818localToRootMKHz9U(long j);

    /* renamed from: localToWindow-MK-Hz9U  reason: not valid java name */
    long mo72819localToWindowMKHz9U(long j);

    /* renamed from: transformFrom-EL8BTi8  reason: not valid java name */
    void mo72820transformFromEL8BTi8(@NotNull LayoutCoordinates layoutCoordinates, @NotNull float[] fArr);

    /* renamed from: windowToLocal-MK-Hz9U  reason: not valid java name */
    long mo72821windowToLocalMKHz9U(long j);
}
