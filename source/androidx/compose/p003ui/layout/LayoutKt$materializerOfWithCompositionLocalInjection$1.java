...
public final class LayoutKt$materializerOfWithCompositionLocalInjection$1 extends Lambda implements Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> {
    ...
    public /* bridge */ /* synthetic */ Unit invoke(SkippableUpdater<ComposeUiNode> skippableUpdater, Composer composer, Integer num) {
        m72824invokeDeg8D_g(skippableUpdater.m71391unboximpl(), composer, num.intValue());
        return Unit.INSTANCE;
    }

    @Composable
    /* renamed from: invoke-Deg8D_g  reason: not valid java name */
    public final void m72824invokeDeg8D_g(@NotNull Composer composer, @Nullable Composer composer2, int i) {
        ...
        Updater.m71400setimpl(m71393constructorimpl, materializeWithCompositionLocalInjectionInternal, companion.getSetModifier());
