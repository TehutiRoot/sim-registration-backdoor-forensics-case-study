...
@Metadata(m28851d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001*\u00020\u00022\u0006\u0010\u0003\u001a\u00020\u0004H\n¢\u0006\u0002\b\u0005"}, m28850d2 = {"<anonymous>", "", "Landroidx/compose/ui/node/LayoutNode;", "it", "Landroidx/compose/ui/layout/SubcomposeLayoutState;", "invoke"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
...
public final class SubcomposeLayoutState$setRoot$1 extends Lambda implements Function2<LayoutNode, SubcomposeLayoutState, Unit> {
    ...
    public final void invoke2(@NotNull LayoutNode layoutNode, @NotNull SubcomposeLayoutState it) {
        ...
        LayoutNodeSubcompositionsState m59520a2;
        ...
        if (subcompositionsState$ui_release == null) {
            subcomposeSlotReusePolicy2 = this.this$0.f30160a;
        ...
        subcomposeLayoutState.f30161b = subcompositionsState$ui_release;
        m59520a = this.this$0.m59520a();
        m59520a.makeSureStateIsConsistent();
        m59520a2 = this.this$0.m59520a();
        subcomposeSlotReusePolicy = this.this$0.f30160a;
        m59520a2.setSlotReusePolicy(subcomposeSlotReusePolicy);
    }
}
