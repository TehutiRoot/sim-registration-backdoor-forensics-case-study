...
public final class LayoutIdElement extends ModifierNodeElement<LayoutIdModifier> {
    ...
    public LayoutIdElement(Object layoutId) {
        ...
        this.f30089b = layoutId;
    }

    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    /* renamed from: d */
    public LayoutIdModifier create() {
        return new LayoutIdModifier(this.f30089b);
    }
    ...
    public void update(LayoutIdModifier node) {
        ...
        node.setLayoutId$ui_release(this.f30089b);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof LayoutIdElement) && Intrinsics.areEqual(this.f30089b, ((LayoutIdElement) obj).f30089b);
    }
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.setValue(this.f30089b);
    }

    public String toString() {
        return "LayoutIdElement(layoutId=" + this.f30089b + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
}
