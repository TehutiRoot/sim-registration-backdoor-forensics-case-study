...
public final class LookaheadScopeKt {
    ...
    public static final void LookaheadScope(@NotNull Function3<? super LookaheadScope, ? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, int i) {
        ...
        if ((i2 & 11) == 2 && startRestartGroup.getSkipping()) {
            ...
            Updater.m71397initimpl(m71393constructorimpl, LookaheadScopeKt$LookaheadScope$2$1.INSTANCE);
            Updater.m71400setimpl(m71393constructorimpl, lookaheadScopeImpl, LookaheadScopeKt$LookaheadScope$2$2.INSTANCE);
