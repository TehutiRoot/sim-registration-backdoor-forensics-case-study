...
final class LayoutElement extends ModifierNodeElement<LayoutModifierImpl> {
    ...
    /* renamed from: b */
    public final Function3 f30088b;

    public LayoutElement(Function3 measure) {
        Intrinsics.checkNotNullParameter(measure, "measure");
        this.f30088b = measure;
    }

    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    /* renamed from: d */
    public LayoutModifierImpl create() {
        return new LayoutModifierImpl(this.f30088b);
    }
    ...
    public void update(LayoutModifierImpl node) {
        ...
        node.setMeasureBlock(this.f30088b);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof LayoutElement) && Intrinsics.areEqual(this.f30088b, ((LayoutElement) obj).f30088b);
    }
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("measure", this.f30088b);
    }

    public String toString() {
        return "LayoutElement(measure=" + this.f30088b + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
}
