...
public final class AppendedSemanticsElement extends ModifierNodeElement<CoreSemanticsModifierNode> implements SemanticsModifier {
    ...
    public static /* synthetic */ AppendedSemanticsElement copy$default(AppendedSemanticsElement appendedSemanticsElement, boolean z, Function1 function1, int i, Object obj) {
        if ((i & 1) != 0) {
            z = appendedSemanticsElement.f30855b;
        }
        if ((i & 2) != 0) {
            function1 = appendedSemanticsElement.f30856c;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof AppendedSemanticsElement) {
            ...
            return this.f30855b == appendedSemanticsElement.f30855b && Intrinsics.areEqual(this.f30856c, appendedSemanticsElement.f30856c);
        }
        return false;
    }
    ...
    public SemanticsConfiguration getSemanticsConfiguration() {
        ...
        semanticsConfiguration.setMergingSemanticsOfDescendants(this.f30855b);
        this.f30856c.invoke(semanticsConfiguration);
    ...
    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    public int hashCode() {
        boolean z = this.f30855b;
        ?? r0 = z;
        if (z) {
            r0 = 1;
        }
        return (r0 * 31) + this.f30856c.hashCode();
    }
    ...
    public void inspectableProperties(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("mergeDescendants", Boolean.valueOf(this.f30855b));
        SemanticsModifierKt.m59145a(inspectorInfo, getSemanticsConfiguration());
    }

    @NotNull
    public String toString() {
        return "AppendedSemanticsElement(mergeDescendants=" + this.f30855b + ", properties=" + this.f30856c + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }

    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    @NotNull
    public CoreSemanticsModifierNode create() {
        return new CoreSemanticsModifierNode(this.f30855b, false, this.f30856c);
    }

    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    public void update(@NotNull CoreSemanticsModifierNode node) {
        Intrinsics.checkNotNullParameter(node, "node");
        node.setMergeDescendants(this.f30855b);
        node.setProperties(this.f30856c);
    }
}
