...
public final class ClearAndSetSemanticsElement extends ModifierNodeElement<CoreSemanticsModifierNode> implements SemanticsModifier {
    ...
    public static /* synthetic */ ClearAndSetSemanticsElement copy$default(ClearAndSetSemanticsElement clearAndSetSemanticsElement, Function1 function1, int i, Object obj) {
        if ((i & 1) != 0) {
            function1 = clearAndSetSemanticsElement.f30857b;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return (obj instanceof ClearAndSetSemanticsElement) && Intrinsics.areEqual(this.f30857b, ((ClearAndSetSemanticsElement) obj).f30857b);
    }
    ...
    public SemanticsConfiguration getSemanticsConfiguration() {
        ...
        this.f30857b.invoke(semanticsConfiguration);
    ...
    public String toString() {
        return "ClearAndSetSemanticsElement(properties=" + this.f30857b + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }

    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    @NotNull
    public CoreSemanticsModifierNode create() {
        return new CoreSemanticsModifierNode(false, true, this.f30857b);
    }

    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    public void update(@NotNull CoreSemanticsModifierNode node) {
        Intrinsics.checkNotNullParameter(node, "node");
        node.setProperties(this.f30857b);
    }
}
