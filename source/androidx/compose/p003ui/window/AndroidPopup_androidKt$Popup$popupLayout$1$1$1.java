...
public final class AndroidPopup_androidKt$Popup$popupLayout$1$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    /* loaded from: classes2.dex */
    public static final class C36511 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
        public static final C36511 INSTANCE = new C36511();
    ...
    /* loaded from: classes2.dex */
    public static final class C36522 extends Lambda implements Function1<IntSize, Unit> {
        final /* synthetic */ PopupLayout $this_apply;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C36522(PopupLayout popupLayout) {
            super(1);
        ...
        public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
            m73897invokeozmzZPI(intSize.m73822unboximpl());
            return Unit.INSTANCE;
        }

        /* renamed from: invoke-ozmzZPI  reason: not valid java name */
        public final void m73897invokeozmzZPI(long j) {
            this.$this_apply.m73901setPopupContentSizefhxjrPA(IntSize.m73810boximpl(j));
    ...
    /* loaded from: classes2.dex */
    public static final class C36533 extends Lambda implements Function2<Composer, Integer, Unit> {
        final /* synthetic */ State<Function2<Composer, Integer, Unit>> $currentContent$delegate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C36533(State<? extends Function2<? super Composer, ? super Integer, Unit>> state) {
            super(2);
        ...
        public final void invoke(@Nullable Composer composer, int i) {
            ...
            m58851a = AndroidPopup_androidKt.m58851a(this.$currentContent$delegate);
            m58851a.invoke(composer, 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        Modifier alpha = AlphaKt.alpha(OnRemeasuredModifierKt.onSizeChanged(SemanticsModifierKt.semantics$default(Modifier.Companion, false, C36511.INSTANCE, 1, null), new C36522(this.$this_apply)), this.$this_apply.getCanCalculatePosition() ? 1.0f : 0.0f);
        ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer, 606497925, true, new C36533(this.$currentContent$delegate));
        ...
        Updater.m71400setimpl(m71393constructorimpl, androidPopup_androidKt$SimpleStack$1, companion.getSetMeasurePolicy());
