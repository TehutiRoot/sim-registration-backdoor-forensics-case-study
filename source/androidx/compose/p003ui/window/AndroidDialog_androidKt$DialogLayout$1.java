...
public final class AndroidDialog_androidKt$DialogLayout$1 implements MeasurePolicy {
    ...
    /* renamed from: a */
    public static final AndroidDialog_androidKt$DialogLayout$1 f31816a = new AndroidDialog_androidKt$DialogLayout$1();
    ...
    public final MeasureResult mo69194measure3p2s80s(MeasureScope Layout, List measurables, long j) {
        ...
        if (placeable2 != null) {
            m73628getMinWidthimpl = placeable2.getWidth();
        } else {
            m73628getMinWidthimpl = Constraints.m73628getMinWidthimpl(j);
        }
        int i4 = m73628getMinWidthimpl;
        if (!arrayList.isEmpty()) {
        ...
        if (placeable3 != null) {
            m73627getMinHeightimpl = placeable3.getHeight();
        } else {
            m73627getMinHeightimpl = Constraints.m73627getMinHeightimpl(j);
        }
        return MeasureScope.CC.m59532q(Layout, i4, m73627getMinHeightimpl, null, new AndroidDialog_androidKt$DialogLayout$1$measure$1(arrayList), 4, null);
    }
