...
public final class AndroidDialog_androidKt$Dialog$dialog$1$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    /* loaded from: classes2.dex */
    public static final class C36481 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
        public static final C36481 INSTANCE = new C36481();
    ...
    /* loaded from: classes2.dex */
    public static final class C36492 extends Lambda implements Function2<Composer, Integer, Unit> {
        final /* synthetic */ State<Function2<Composer, Integer, Unit>> $currentContent$delegate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C36492(State<? extends Function2<? super Composer, ? super Integer, Unit>> state) {
            super(2);
        ...
        public final void invoke(@Nullable Composer composer, int i) {
            ...
            m58853a = AndroidDialog_androidKt.m58853a(this.$currentContent$delegate);
            m58853a.invoke(composer, 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        AndroidDialog_androidKt.m58852b(SemanticsModifierKt.semantics$default(Modifier.Companion, false, C36481.INSTANCE, 1, null), ComposableLambdaKt.composableLambda(composer, -533674951, true, new C36492(this.$currentContent$delegate)), composer, 48, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    }
