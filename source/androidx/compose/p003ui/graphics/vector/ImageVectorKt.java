...
public final class ImageVectorKt {
    ...
    public static final ImageVector.Builder m72250pathR_LF3I(@NotNull ImageVector.Builder path, @NotNull String name, @Nullable Brush brush, float f, @Nullable Brush brush2, float f2, float f3, int i, int i2, float f4, int i3, @NotNull Function1<? super PathBuilder, Unit> pathBuilder) {
        ...
        return ImageVector.Builder.m72248addPathoIyEayM$default(path, pathBuilder2.getNodes(), i3, name, brush, f, brush2, f2, f3, i, i2, f4, 0.0f, 0.0f, 0.0f, 14336, null);
    }

    /* renamed from: path-R_LF-3I$default */
    public static /* synthetic */ ImageVector.Builder m72251pathR_LF3I$default(ImageVector.Builder path, String str, Brush brush, float f, Brush brush2, float f2, float f3, int i, int i2, float f4, int i3, Function1 pathBuilder, int i4, Object obj) {
        String name;
        Brush brush3;
        float f5;
        Brush brush4;
        ...
        PathBuilder pathBuilder2 = new PathBuilder();
        pathBuilder.invoke(pathBuilder2);
        return ImageVector.Builder.m72248addPathoIyEayM$default(path, pathBuilder2.getNodes(), i7, name, brush3, f5, brush4, f6, f7, i5, i6, f8, 0.0f, 0.0f, 0.0f, 14336, null);
    }
}
