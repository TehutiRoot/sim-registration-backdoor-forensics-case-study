...
public final class VectorComponent extends VNode {
    ...
    /* renamed from: b */
    public final GroupComponent f29490b;

    /* renamed from: c */
    public boolean f29491c;

    /* renamed from: d */
    public final DrawCache f29492d;

    /* renamed from: e */
    public Function0 f29493e;

    /* renamed from: f */
    public final MutableState f29494f;
    ...
    /* renamed from: j */
    public final Function1 f29498j;
    ...
    public VectorComponent() {
        ...
        this.f29490b = groupComponent;
        this.f29491c = true;
        this.f29492d = new DrawCache();
        this.f29493e = VectorComponent$invalidateCallback$1.INSTANCE;
        m31891g = AbstractC19508dK1.m31891g(null, null, 2, null);
        this.f29494f = m31891g;
        this.f29497i = Size.Companion.m71579getUnspecifiedNHjbRc();
        this.f29498j = new VectorComponent$drawVectorBlock$1(this);
    }

    /* renamed from: a */
    public final void m59646a() {
        this.f29491c = true;
        this.f29493e.invoke();
    }
    ...
    public final void draw(@NotNull DrawScope drawScope, float f, @Nullable ColorFilter colorFilter) {
        ...
        if (this.f29491c || !Size.m71567equalsimpl0(this.f29497i, drawScope.mo72144getSizeNHjbRc())) {
            this.f29490b.setScaleX(Size.m71571getWidthimpl(drawScope.mo72144getSizeNHjbRc()) / this.f29495g);
            this.f29490b.setScaleY(Size.m71568getHeightimpl(drawScope.mo72144getSizeNHjbRc()) / this.f29496h);
            this.f29492d.m72243drawCachedImageCJJARo(IntSizeKt.IntSize((int) Math.ceil(Size.m71571getWidthimpl(drawScope.mo72144getSizeNHjbRc())), (int) Math.ceil(Size.m71568getHeightimpl(drawScope.mo72144getSizeNHjbRc()))), drawScope, drawScope.getLayoutDirection(), this.f29498j);
            this.f29491c = false;
            this.f29497i = drawScope.mo72144getSizeNHjbRc();
        }
        this.f29492d.drawInto(drawScope, f, colorFilter);
    }

    @Nullable
    public final ColorFilter getIntrinsicColorFilter$ui_release() {
        return (ColorFilter) this.f29494f.getValue();
    }
    ...
    public String toString() {
        String str = "Params: \tname: " + getName() + "\n\tviewportWidth: " + this.f29495g + "\n\tviewportHeight: " + this.f29496h + "\n";
