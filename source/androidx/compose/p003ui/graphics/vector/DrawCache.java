...
public final class DrawCache {
    ...
    /* renamed from: a */
    public ImageBitmap f29348a;

    /* renamed from: b */
    public Canvas f29349b;

    /* renamed from: c */
    public Density f29350c;

    /* renamed from: d */
    public LayoutDirection f29351d = LayoutDirection.Ltr;

    /* renamed from: e */
    public long f29352e = IntSize.Companion.m73823getZeroYbymL2g();

    /* renamed from: f */
    public final CanvasDrawScope f29353f = new CanvasDrawScope();
    ...
    /* renamed from: a */
    public final void m59673a(DrawScope drawScope) {
        AbstractC12212lK.m26516K(drawScope, Color.Companion.m71761getBlack0d7_KjU(), 0L, 0L, 0.0f, null, null, BlendMode.Companion.m71659getClear0nO6VwU(), 62, null);
    }

    /* renamed from: drawCachedImage-CJJAR-o  reason: not valid java name */
    public final void m72243drawCachedImageCJJARo(long j, @NotNull Density density, @NotNull LayoutDirection layoutDirection, @NotNull Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Intrinsics.checkNotNullParameter(block, "block");
        this.f29350c = density;
        this.f29351d = layoutDirection;
        ImageBitmap imageBitmap = this.f29348a;
        Canvas canvas = this.f29349b;
        if (imageBitmap == null || canvas == null || IntSize.m73818getWidthimpl(j) > imageBitmap.getWidth() || IntSize.m73817getHeightimpl(j) > imageBitmap.getHeight()) {
            imageBitmap = ImageBitmapKt.m71924ImageBitmapx__hDU$default(IntSize.m73818getWidthimpl(j), IntSize.m73817getHeightimpl(j), 0, false, null, 28, null);
            canvas = CanvasKt.Canvas(imageBitmap);
            this.f29348a = imageBitmap;
            this.f29349b = canvas;
        }
        this.f29352e = j;
        CanvasDrawScope canvasDrawScope = this.f29353f;
        ...
        drawParams2.m72149setSizeuvyYCjk(m73828toSizeozmzZPI);
        canvas.save();
        m59673a(canvasDrawScope);
    ...
    public final void drawInto(@NotNull DrawScope target, float f, @Nullable ColorFilter colorFilter) {
        ...
        ImageBitmap imageBitmap = this.f29348a;
        if (imageBitmap != null) {
            AbstractC12212lK.m26488z(target, imageBitmap, 0L, this.f29352e, 0L, 0L, f, null, colorFilter, 0, 0, 858, null);
            return;
        }
