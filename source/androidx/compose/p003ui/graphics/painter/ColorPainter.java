...
public final class ColorPainter extends Painter {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if ((obj instanceof ColorPainter) && Color.m71736equalsimpl0(this.f29338g, ((ColorPainter) obj).f29338g)) {
            return true;
        }
        return false;
    }
    ...
    public final long m72240getColor0d7_KjU() {
        return this.f29338g;
    }
    ...
    public int hashCode() {
        return Color.m71742hashCodeimpl(this.f29338g);
    }

    @Override // androidx.compose.p003ui.graphics.painter.Painter
    public void onDraw(@NotNull DrawScope drawScope) {
        Intrinsics.checkNotNullParameter(drawScope, "<this>");
        AbstractC12212lK.m26516K(drawScope, this.f29338g, 0L, 0L, this.f29339h, null, this.f29340i, 0, 86, null);
    }

    @NotNull
    public String toString() {
        return "ColorPainter(color=" + ((Object) Color.m71743toStringimpl(this.f29338g)) + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }

    public ColorPainter(long j) {
        this.f29338g = j;
        this.f29339h = 1.0f;
        this.f29341j = Size.Companion.m71579getUnspecifiedNHjbRc();
    }
}
