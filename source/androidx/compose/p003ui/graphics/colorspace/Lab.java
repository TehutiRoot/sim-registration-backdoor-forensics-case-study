...
public final class Lab extends ColorSpace {
    ...
    @Metadata(m28851d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0007\n\u0002\b\u0004\b\u0080\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\b"}, m28850d2 = {"Landroidx/compose/ui/graphics/colorspace/Lab$Companion;", "", "()V", "A", "", "B", "C", "D", "ui-graphics_release"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    public float[] fromXyz(@NotNull float[] v) {
        ...
        v[0] = AbstractC11719c.coerceIn((116.0f * f2) - 16.0f, 0.0f, 100.0f);
        v[1] = AbstractC11719c.coerceIn((f - f2) * 500.0f, -128.0f, 128.0f);
        v[2] = AbstractC11719c.coerceIn((f2 - f3) * 200.0f, -128.0f, 128.0f);
        return v;
    }
    ...
    public long toXy$ui_graphics_release(float f, float f2, float f3) {
        float f4;
        float f5;
        float coerceIn = (AbstractC11719c.coerceIn(f, 0.0f, 100.0f) + 16.0f) / 116.0f;
        float coerceIn2 = (AbstractC11719c.coerceIn(f, -128.0f, 128.0f) * 0.002f) + coerceIn;
    ...
    public float[] toXyz(@NotNull float[] v) {
        ...
        float f3;
        Intrinsics.checkNotNullParameter(v, "v");
        v[0] = AbstractC11719c.coerceIn(v[0], 0.0f, 100.0f);
        v[1] = AbstractC11719c.coerceIn(v[1], -128.0f, 128.0f);
        float coerceIn = AbstractC11719c.coerceIn(v[2], -128.0f, 128.0f);
        v[2] = coerceIn;
    ...
    public float toZ$ui_graphics_release(float f, float f2, float f3) {
        float f4;
        float coerceIn = ((AbstractC11719c.coerceIn(f, 0.0f, 100.0f) + 16.0f) / 116.0f) - (AbstractC11719c.coerceIn(f3, -128.0f, 128.0f) * 0.005f);
        if (coerceIn > 0.20689656f) {
    ...
    public long mo72106xyzaToColorJlNiLsg$ui_graphics_release(float f, float f2, float f3, float f4, @NotNull ColorSpace colorSpace) {
        ...
        return ColorKt.Color(AbstractC11719c.coerceIn((116.0f * f6) - 16.0f, 0.0f, 100.0f), AbstractC11719c.coerceIn((f5 - f6) * 500.0f, -128.0f, 128.0f), AbstractC11719c.coerceIn((f6 - f7) * 200.0f, -128.0f, 128.0f), f4, colorSpace);
    }
}
