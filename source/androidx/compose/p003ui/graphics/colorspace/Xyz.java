...
public final class Xyz extends ColorSpace {
    ...
    public Xyz(@NotNull String name, int i) {
        super(name, ColorModel.Companion.m72104getXyzxdoWZVw(), i, null);
        Intrinsics.checkNotNullParameter(name, "name");
    }

    /* renamed from: a */
    public final float m59692a(float f) {
        return AbstractC11719c.coerceIn(f, -2.0f, 2.0f);
    }
    ...
    public long toXy$ui_graphics_release(float f, float f2, float f3) {
        float m59692a = m59692a(f);
        float m59692a2 = m59692a(f2);
        return (Float.floatToIntBits(m59692a2) & BodyPartID.bodyIdMax) | (Float.floatToIntBits(m59692a) << 32);
    }
    ...
    public long mo72106xyzaToColorJlNiLsg$ui_graphics_release(float f, float f2, float f3, float f4, @NotNull ColorSpace colorSpace) {
        ...
        return ColorKt.Color(m59692a(f), m59692a(f2), m59692a(f3), f4, colorSpace);
    }
}
