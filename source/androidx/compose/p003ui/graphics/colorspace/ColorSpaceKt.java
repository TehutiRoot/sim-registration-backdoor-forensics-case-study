...
public final class ColorSpaceKt {
    ...
    public static final Connector m72107connectYBCOT_4(@NotNull ColorSpace connect, @NotNull ColorSpace destination, int i) {
        ...
        if (connect == colorSpaces.getSrgb()) {
            ...
            if (destination == colorSpaces.getOklab() && RenderIntent.m72115equalsimpl0(i, RenderIntent.Companion.m72120getPerceptualuksYyKA())) {
                return Connector.Companion.getSrgbToOklabPerceptual$ui_graphics_release();
            }
        } else if (connect == colorSpaces.getOklab() && destination == colorSpaces.getSrgb() && RenderIntent.m72115equalsimpl0(i, RenderIntent.Companion.m72120getPerceptualuksYyKA())) {
        ...
        long m72105getModelxdoWZVw = connect.m72105getModelxdoWZVw();
        ColorModel.Companion companion = ColorModel.Companion;
        if (ColorModel.m72096equalsimpl0(m72105getModelxdoWZVw, companion.m72103getRgbxdoWZVw()) && ColorModel.m72096equalsimpl0(destination.m72105getModelxdoWZVw(), companion.m72103getRgbxdoWZVw())) {
    ...
    public static /* synthetic */ Connector m72108connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i2 & 2) != 0) {
            i = RenderIntent.Companion.m72120getPerceptualuksYyKA();
        }
        return m72107connectYBCOT_4(colorSpace, colorSpace2, i);
    }
