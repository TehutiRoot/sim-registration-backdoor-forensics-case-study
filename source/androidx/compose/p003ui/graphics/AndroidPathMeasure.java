...
public final class AndroidPathMeasure implements PathMeasure {
    ...
    /* renamed from: a */
    public final PathMeasure f28984a;
    ...
    public AndroidPathMeasure(@NotNull PathMeasure internalPathMeasure) {
        ...
        this.f28984a = internalPathMeasure;
    }

    @Override // androidx.compose.p003ui.graphics.PathMeasure
    public float getLength() {
        return this.f28984a.getLength();
    }

    @Override // androidx.compose.p003ui.graphics.PathMeasure
    /* renamed from: getPosition-tuRUvjQ  reason: not valid java name */
    public long mo71642getPositiontuRUvjQ(float f) {
        if (this.f28985b == null) {
            this.f28985b = new float[2];
        }
        if (this.f28986c == null) {
            this.f28986c = new float[2];
        }
        if (this.f28984a.getPosTan(f, this.f28985b, this.f28986c)) {
            float[] fArr = this.f28985b;
            Intrinsics.checkNotNull(fArr);
            float f2 = fArr[0];
            float[] fArr2 = this.f28985b;
    ...
    public boolean getSegment(float f, float f2, @NotNull Path destination, boolean z) {
        ...
        PathMeasure pathMeasure = this.f28984a;
    ...
    public long mo71643getTangenttuRUvjQ(float f) {
        if (this.f28985b == null) {
            this.f28985b = new float[2];
        }
        if (this.f28986c == null) {
        ...
        if (this.f28984a.getPosTan(f, this.f28985b, this.f28986c)) {
            float[] fArr = this.f28986c;
            Intrinsics.checkNotNull(fArr);
            float f2 = fArr[0];
            float[] fArr2 = this.f28986c;
            Intrinsics.checkNotNull(fArr2);
            return OffsetKt.Offset(f2, fArr2[1]);
        }
        return Offset.Companion.m71517getUnspecifiedF1C5BW0();
