...
public final class AndroidPathEffect_androidKt {
    ...
    public static final PathEffect m71640actualStampedPathEffect7aD1DOk(@NotNull Path shape, float f, float f2, int i) {
        Intrinsics.checkNotNullParameter(shape, "shape");
        if (shape instanceof AndroidPath) {
            return new AndroidPathEffect(new PathDashPathEffect(((AndroidPath) shape).getInternalPath(), f, f2, m71641toAndroidPathDashPathEffectStyleoQv6xUo(i)));
        }
    ...
    public static final PathDashPathEffect.Style m71641toAndroidPathDashPathEffectStyleoQv6xUo(int i) {
        StampedPathEffectStyle.Companion companion = StampedPathEffectStyle.Companion;
        if (StampedPathEffectStyle.m72029equalsimpl0(i, companion.m72033getMorphYpspkwk())) {
            return PathDashPathEffect.Style.MORPH;
        }
        if (StampedPathEffectStyle.m72029equalsimpl0(i, companion.m72034getRotateYpspkwk())) {
            return PathDashPathEffect.Style.ROTATE;
        }
        if (StampedPathEffectStyle.m72029equalsimpl0(i, companion.m72035getTranslateYpspkwk())) {
