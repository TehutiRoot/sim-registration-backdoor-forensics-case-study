...
public final class DerivedSnapshotState implements StateObject, DerivedState {
    ...
    public static final class ResultRecord<T> extends StateRecord implements DerivedState.Record<T> {
        ...
        /* renamed from: e */
        public IdentityArrayMap f28321e;

        /* renamed from: f */
        public Object f28322f = f28318h;
        ...
        /* renamed from: h */
        public static final Object f28318h = new Object();

        @Metadata(m28851d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0011\u0010\u0003\u001a\u00020\u0001¢\u0006\b\n\u0000\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, m28850d2 = {"Landroidx/compose/runtime/DerivedSnapshotState$ResultRecord$Companion;", "", "()V", "Unset", "getUnset", "()Ljava/lang/Object;", "runtime_release"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
        /* loaded from: classes2.dex */
        ...
        public void assign(@NotNull StateRecord value) {
            ...
            this.f28321e = resultRecord.f28321e;
            this.f28322f = resultRecord.f28322f;
            this.f28323g = resultRecord.f28323g;
        }
        ...
        public Object[] getDependencies() {
            Object[] keys;
            IdentityArrayMap identityArrayMap = this.f28321e;
        ...
        public final boolean isValid(@NotNull DerivedState<?> derivedState, @NotNull Snapshot snapshot) {
            ...
            synchronized (SnapshotKt.getLock()) {
                z = true;
                if (this.f28319c == snapshot.getId()) {
                    if (this.f28320d == snapshot.getWriteCount$runtime_release()) {
                        z2 = false;
                    }
                }
                z2 = true;
            }
            if (this.f28322f == f28318h || (z2 && this.f28323g != readableHash(derivedState, snapshot))) {
                z = false;
            }
            if (z && z2) {
                synchronized (SnapshotKt.getLock()) {
                    this.f28319c = snapshot.getId();
                    this.f28320d = snapshot.getWriteCount$runtime_release();
        ...
        */
        public final int readableHash(@org.jetbrains.annotations.NotNull androidx.compose.runtime.DerivedState<?> r10, @org.jetbrains.annotations.NotNull androidx.compose.runtime.snapshots.Snapshot r11) {
            /*
                ...
                monitor-enter(r1)
                androidx.compose.runtime.collection.IdentityArrayMap r2 = r9.f28321e     // Catch: java.lang.Throwable -> La6
                monitor-exit(r1)
                r1 = 7
                if (r2 == 0) goto La5
            ...
            L53:
                ...
                androidx.compose.runtime.snapshots.StateRecord r7 = r7.m60275a(r11)     // Catch: java.lang.Throwable -> L5e
                goto L68
            L5e:
                r11 = move-exception
                goto L8f
        ...
        public final void set_dependencies(@Nullable IdentityArrayMap<StateObject, Integer> identityArrayMap) {
            this.f28321e = identityArrayMap;
        }
    }

    public DerivedSnapshotState(Function0 calculation, SnapshotMutationPolicy snapshotMutationPolicy) {
        Intrinsics.checkNotNullParameter(calculation, "calculation");
        this.f28315a = calculation;
        this.f28316b = snapshotMutationPolicy;
        this.f28317c = new ResultRecord();
    }

    /* renamed from: a */
    public final StateRecord m60275a(Snapshot snapshot) {
        Intrinsics.checkNotNullParameter(snapshot, "snapshot");
        return m60274b((ResultRecord) SnapshotKt.current(this.f28317c, snapshot), snapshot, false, this.f28315a);
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final androidx.compose.runtime.DerivedSnapshotState.ResultRecord m60274b(androidx.compose.runtime.DerivedSnapshotState.ResultRecord r10, androidx.compose.runtime.snapshots.Snapshot r11, boolean r12, kotlin.jvm.functions.Function0 r13) {
        /*
            Method dump skipped, instructions count: 410
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.runtime.DerivedSnapshotState.m60274b(androidx.compose.runtime.DerivedSnapshotState$ResultRecord, androidx.compose.runtime.snapshots.Snapshot, boolean, kotlin.jvm.functions.Function0):androidx.compose.runtime.DerivedSnapshotState$ResultRecord");
    }

    /* renamed from: c */
    public final String m60273c() {
        ResultRecord resultRecord = (ResultRecord) SnapshotKt.current(this.f28317c);
    ...
    public DerivedState.Record getCurrentRecord() {
        return m60274b((ResultRecord) SnapshotKt.current(this.f28317c), Snapshot.Companion.getCurrent(), false, this.f28315a);
    }
    ...
    public Object getValue() {
        ...
        return m60274b((ResultRecord) SnapshotKt.current(this.f28317c), companion.getCurrent(), true, this.f28315a).getResult();
    }
    ...
    public void prependStateRecord(StateRecord value) {
        Intrinsics.checkNotNullParameter(value, "value");
        this.f28317c = (ResultRecord) value;
    }

    public String toString() {
        ResultRecord resultRecord = (ResultRecord) SnapshotKt.current(this.f28317c);
        return "DerivedState(value=" + m60273c() + ")@" + hashCode();
    }
}
