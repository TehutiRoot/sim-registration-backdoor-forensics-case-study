...
public final class IdentityScopeMap<T> {
    ...
    /* renamed from: c */
    public IdentityArraySet[] f28498c;
    ...
    public final int m60104a(Object obj) {
        ...
        while (i2 <= i) {
            ...
            if (identityHashCode2 < identityHashCode) {
                ...
                return m60103b(i3, obj, identityHashCode);
            }
        }
        return -(i2 + 1);
    }
    ...
    public final boolean add(@NotNull Object value, @NotNull T scope) {
        ...
        return m60102c(value).add(scope);
    }

    /* renamed from: b */
    public final int m60103b(int i, Object obj, int i2) {
        Object[] objArr = this.f28497b;
        int[] iArr = this.f28496a;
    ...
    /* renamed from: c */
    public final IdentityArraySet m60102c(Object obj) {
        int i;
        int i2 = this.f28499d;
        int[] iArr = this.f28496a;
        Object[] objArr = this.f28497b;
        IdentityArraySet[] identityArraySetArr = this.f28498c;
        if (i2 > 0) {
            i = m60104a(obj);
            if (i >= 0) {
                return m60101d(i);
        ...
        this.f28498c = identityArraySetArr2;
        this.f28497b = copyOf2;
        this.f28496a = iArr2;
        this.f28499d++;
    ...
    /* renamed from: d */
    public final IdentityArraySet m60101d(int i) {
        IdentityArraySet identityArraySet = this.f28498c[this.f28496a[i]];
    ...
    public final void forEachScopeOf(@NotNull Object value, @NotNull Function1<? super T, Unit> block) {
        ...
        int m60104a = m60104a(value);
        if (m60104a >= 0) {
            IdentityArraySet m60101d = m60101d(m60104a);
    ...
    public final boolean remove(@NotNull Object value, @NotNull T scope) {
        ...
        Object[] objArr = this.f28497b;
        int i2 = this.f28499d;
        if (m60104a < 0 || (identityArraySet = identityArraySetArr[(i = iArr[m60104a])]) == null) {
            return false;
        }
        ...
        if (identityArraySet.size() == 0) {
            int i3 = m60104a + 1;
            if (i3 < i2) {
                ArraysKt___ArraysJvmKt.copyInto(iArr, iArr, m60104a, i3, i2);
            }
            int i4 = i2 - 1;
            iArr[i4] = i;
            objArr[i] = null;
