...
public final class ComposableMethod {
    ...
    /* renamed from: a */
    public final Method f28678a;

    /* renamed from: b */
    public final ComposableInfo f28679b;
    ...
    public boolean equals(@Nullable Object obj) {
        if (obj instanceof ComposableMethod) {
            return Intrinsics.areEqual(this.f28678a, ((ComposableMethod) obj).f28678a);
        }
        return false;
    }

    public final int getParameterCount() {
        return this.f28679b.getRealParamsCount();
    }

    @NotNull
    public final Class<?>[] getParameterTypes() {
        Class<?>[] parameterTypes = this.f28678a.getParameterTypes();
        Intrinsics.checkNotNullExpressionValue(parameterTypes, "method.parameterTypes");
        return (Class[]) ArraysKt___ArraysJvmKt.copyOfRange(parameterTypes, 0, this.f28679b.getRealParamsCount());
    }

    @NotNull
    public final Parameter[] getParameters() {
        Parameter[] parameters;
        parameters = this.f28678a.getParameters();
        Intrinsics.checkNotNullExpressionValue(parameters, "method.parameters");
        return (Parameter[]) ArraysKt___ArraysJvmKt.copyOfRange(parameters, 0, this.f28679b.getRealParamsCount());
    }
    ...
    public final Object invoke(@NotNull Composer composer, @Nullable Object obj, @NotNull Object... args) {
        ...
        for (int i9 = 0; i9 < length; i9++) {
            if (i9 >= 0 && i9 < component2) {
                if (i9 >= 0 && i9 <= ArraysKt___ArraysKt.getLastIndex(args)) {
                    ...
                    Class<?> cls = this.f28678a.getParameterTypes()[i9];
                    Intrinsics.checkNotNullExpressionValue(cls, "method.parameterTypes[idx]");
                    obj2 = ComposableMethodKt.m59946d(cls);
                }
        ...
        return this.f28678a.invoke(obj, Arrays.copyOf(objArr2, length));
    }
}
