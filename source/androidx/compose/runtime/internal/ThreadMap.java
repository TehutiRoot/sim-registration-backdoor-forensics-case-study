...
public final class ThreadMap {
    ...
    /* renamed from: a */
    public final int m59950a(long j) {
        int i = this.f28670a - 1;
        if (i == -1) {
            return -1;
        }
        int i2 = 0;
        if (i != 0) {
            while (i2 <= i) {
                int i3 = (i2 + i) >>> 1;
                int i4 = ((this.f28671b[i3] - j) > 0L ? 1 : ((this.f28671b[i3] - j) == 0L ? 0 : -1));
                if (i4 < 0) {
                    i2 = i3 + 1;
                } else if (i4 > 0) {
                    i = i3 - 1;
    ...
    public final Object get(long j) {
        int m59950a = m59950a(j);
        if (m59950a >= 0) {
            return this.f28672c[m59950a];
        }
        return null;
    }
    ...
    public final ThreadMap newWith(long j, @Nullable Object obj) {
        ...
        if (i4 > 1) {
            ...
            while (true) {
                ...
                long j2 = this.f28671b[i5];
                Object obj3 = this.f28672c[i5];
                if (j2 > j) {
                    jArr[i2] = j;
                    objArr[i2] = obj;
                    i2++;
            ...
            if (i5 == i) {
                ...
                while (i2 < i4) {
                    long j3 = this.f28671b[i5];
                    Object obj4 = this.f28672c[i5];
                    if (obj4 != null) {
                        jArr[i2] = j3;
                        objArr[i2] = obj4;
                        i2++;
