...
public class PersistentHashMapBuilderBaseIterator<K, V, T> extends PersistentHashMapBaseIterator<K, V, T> implements Iterator<T>, KMutableIterator {
    ...
    /* renamed from: d */
    public final PersistentHashMapBuilder f28562d;
    ...
    public PersistentHashMapBuilderBaseIterator(@NotNull PersistentHashMapBuilder<K, V> builder, @NotNull TrieNodeBaseIterator<K, V, T>[] path) {
        ...
        this.f28562d = builder;
        this.f28565g = builder.getModCount$runtime_release();
    }

    /* renamed from: e */
    private final void m60040e() {
        if (this.f28562d.getModCount$runtime_release() == this.f28565g) {
            return;
        }
    ...
    /* renamed from: g */
    public final void m60038g(int i, TrieNode trieNode, Object obj, int i2) {
        int i3 = i2 * 5;
        if (i3 > 30) {
        ...
        m60038g(i, nodeAtIndex$runtime_release, obj, i2 + 1);
    }

    @Override // androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableMap.PersistentHashMapBaseIterator, java.util.Iterator
    public T next() {
        m60040e();
        this.f28563e = currentKey();
        this.f28564f = true;
        return (T) super.next();
    }
    ...
    public void remove() {
        ...
        if (hasNext()) {
            ...
            PersistentHashMapBuilder persistentHashMapBuilder = this.f28562d;
            TypeIntrinsics.asMutableMap(persistentHashMapBuilder).remove(this.f28563e);
            if (currentKey != null) {
                i = currentKey.hashCode();
            } else {
                i = 0;
            }
            m60038g(i, this.f28562d.getNode$runtime_release(), currentKey, 0);
        } else {
            PersistentHashMapBuilder persistentHashMapBuilder2 = this.f28562d;
            TypeIntrinsics.asMutableMap(persistentHashMapBuilder2).remove(this.f28563e);
        }
        this.f28563e = null;
        this.f28564f = false;
        this.f28565g = this.f28562d.getModCount$runtime_release();
    }

    public final void setValue(K k, V v) {
        int i;
        if (!this.f28562d.containsKey(k)) {
            return;
        }
        if (hasNext()) {
            K currentKey = currentKey();
            this.f28562d.put(k, v);
            if (currentKey != null) {
                i = currentKey.hashCode();
            } else {
                i = 0;
