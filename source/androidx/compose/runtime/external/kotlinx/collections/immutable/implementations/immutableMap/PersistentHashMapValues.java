...
public final class PersistentHashMapValues<K, V> extends AbstractCollection<V> implements ImmutableCollection<V> {
    ...
    public boolean contains(Object obj) {
        return this.f28572a.containsValue(obj);
    }
    ...
    public Iterator<V> iterator() {
        return new PersistentHashMapValuesIterator(this.f28572a.getNode$runtime_release());
    }
}
