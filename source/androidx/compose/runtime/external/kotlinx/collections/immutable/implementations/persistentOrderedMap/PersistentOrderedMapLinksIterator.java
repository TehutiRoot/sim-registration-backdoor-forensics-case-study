...
public class PersistentOrderedMapLinksIterator<K, V> implements Iterator<LinkedValue<V>>, KMappedMarker {
    ...
    public boolean hasNext() {
        if (this.f28634c < this.f28633b.size()) {
            return true;
        }
        return false;
    }
    ...
    public LinkedValue<V> next() {
        if (hasNext()) {
            Object obj = this.f28633b.get(this.f28632a);
            if (obj != null) {
                LinkedValue<V> linkedValue = (LinkedValue) obj;
                this.f28634c++;
                this.f28632a = linkedValue.getNext();
                return linkedValue;
            }
            throw new ConcurrentModificationException("Hash code of a key (" + this.f28632a + ") has changed after it was added to the persistent map.");
        }
