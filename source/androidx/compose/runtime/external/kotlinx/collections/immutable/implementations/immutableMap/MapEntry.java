...
public class MapEntry<K, V> implements Map.Entry<K, V>, KMappedMarker {
    ...
    @Override // java.util.Map.Entry
    public K getKey() {
        return (K) this.f28548a;
    }

    @Override // java.util.Map.Entry
    public V getValue() {
        return (V) this.f28549b;
    }
