...
public final class PersistentOrderedMapBuilderKeys<K, V> extends AbstractMutableSet<K> implements Set<K>, KMutableSet {
    ...
    public boolean contains(Object obj) {
        return this.f28618a.containsKey(obj);
    }
    ...
    public Iterator<K> iterator() {
        return new PersistentOrderedMapBuilderKeysIterator(this.f28618a);
    }

    @Override // java.util.AbstractCollection, java.util.Collection, java.util.Set
    public boolean remove(Object obj) {
        if (this.f28618a.containsKey(obj)) {
