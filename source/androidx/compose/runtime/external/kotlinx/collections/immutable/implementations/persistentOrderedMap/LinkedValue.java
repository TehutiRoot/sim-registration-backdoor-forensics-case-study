...
public final class LinkedValue<V> {
    ...
    public final boolean getHasNext() {
        if (this.f28607c != EndOfChain.INSTANCE) {
            return true;
        }
        return false;
    }
    ...
    public final boolean getHasPrevious() {
        if (this.f28606b != EndOfChain.INSTANCE) {
            return true;
        }
        return false;
    }
    ...
    public final V getValue() {
        return (V) this.f28605a;
    }

    @NotNull
    public final LinkedValue<V> withNext(@Nullable Object obj) {
        return new LinkedValue<>(this.f28605a, this.f28606b, obj);
    }

    @NotNull
    public final LinkedValue<V> withPrevious(@Nullable Object obj) {
        return new LinkedValue<>(this.f28605a, obj, this.f28607c);
    }

    @NotNull
    public final LinkedValue<V> withValue(V v) {
        return new LinkedValue<>(v, this.f28606b, this.f28607c);
    }
