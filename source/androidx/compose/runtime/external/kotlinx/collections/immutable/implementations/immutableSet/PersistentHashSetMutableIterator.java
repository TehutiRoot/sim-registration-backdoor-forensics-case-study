...
public final class PersistentHashSetMutableIterator<E> extends PersistentHashSetIterator<E> implements Iterator<E>, KMutableIterator {
    ...
    /* renamed from: d */
    public final PersistentHashSetBuilder f28595d;

    /* renamed from: e */
    public Object f28596e;
    ...
    public PersistentHashSetMutableIterator(@NotNull PersistentHashSetBuilder<E> builder) {
        ...
        this.f28595d = builder;
        this.f28598g = builder.getModCount$runtime_release();
    }

    /* renamed from: c */
    private final void m59994c() {
        if (this.f28595d.getModCount$runtime_release() == this.f28598g) {
            return;
        }
    ...
    /* renamed from: f */
    public final boolean m59992f(TrieNode trieNode) {
    ...
    /* renamed from: g */
    public final void m59991g(int i, TrieNode trieNode, Object obj, int i2) {
        boolean z = true;
        if (m59992f(trieNode)) {
        ...
        if (obj2 instanceof TrieNode) {
            m59991g(i, (TrieNode) obj2, obj, i2 + 1);
        } else {
            setPathLastIndex(i2);
        }
    }
    ...
    public void remove() {
        ...
        if (hasNext()) {
            ...
            PersistentHashSetBuilder persistentHashSetBuilder = this.f28595d;
            TypeIntrinsics.asMutableCollection(persistentHashSetBuilder).remove(this.f28596e);
            if (currentElement != null) {
                i = currentElement.hashCode();
            } else {
                i = 0;
            }
            m59991g(i, this.f28595d.getNode$runtime_release(), currentElement, 0);
        } else {
            PersistentHashSetBuilder persistentHashSetBuilder2 = this.f28595d;
            TypeIntrinsics.asMutableCollection(persistentHashSetBuilder2).remove(this.f28596e);
        }
        this.f28596e = null;
        this.f28597f = false;
        this.f28598g = this.f28595d.getModCount$runtime_release();
    }
}
