...
public final class PersistentHashMapKeys<K, V> extends AbstractSet<K> implements ImmutableSet<K> {
    ...
    /* renamed from: a */
    public final PersistentHashMap f28571a;
    ...
    public boolean contains(Object obj) {
        return this.f28571a.containsKey(obj);
    }
    ...
    public Iterator<K> iterator() {
        return new PersistentHashMapKeysIterator(this.f28571a.getNode$runtime_release());
    }
}
