...
public final class PersistentOrderedMapBuilderKeysIterator<K, V> implements Iterator<K>, KMutableIterator {
    ...
    /* renamed from: a */
    public final PersistentOrderedMapBuilderLinksIterator f28619a;

    public PersistentOrderedMapBuilderKeysIterator(@NotNull PersistentOrderedMapBuilder<K, V> map) {
        Intrinsics.checkNotNullParameter(map, "map");
        this.f28619a = new PersistentOrderedMapBuilderLinksIterator(map.getFirstKey$runtime_release(), map);
    }

    @Override // java.util.Iterator
    public boolean hasNext() {
        return this.f28619a.hasNext();
    }

    @Override // java.util.Iterator
    public K next() {
        this.f28619a.next();
        return (K) this.f28619a.getLastIteratedKey$runtime_release();
    }
