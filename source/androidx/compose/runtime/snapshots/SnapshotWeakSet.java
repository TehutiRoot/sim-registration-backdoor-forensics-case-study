...
@Metadata(m28851d1 = {"\u0000>\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0004\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0005\n\u0002\u0010\b\n\u0002\b\r\n\u0002\u0010\u0015\n\u0002\b\u0006\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\b\b\u0000\u0018\u0000*\b\b\u0000\u0010\u0002*\u00020\u00012\u00020\u0001B\u0007¢\u0006\u0004\b\u0003\u0010\u0004J\u0015\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00028\u0000¢\u0006\u0004\b\u0007\u0010\bJ'\u0010\f\u001a\u00020\u000b2\u0012\u0010\n\u001a\u000e\u0012\u0004\u0012\u00028\u0000\u0012\u0004\u0012\u00020\u00060\tH\u0086\bø\u0001\u0000¢\u0006\u0004\b\f\u0010\rJ\u000f\u0010\u0010\u001a\u00020\u0006H\u0000¢\u0006\u0004\b\u000e\u0010\u000fJ\u001f\u0010\u0013\u001a\u00020\u00112\u0006\u0010\u0005\u001a\u00028\u00002\u0006\u0010\u0012\u001a\u00020\u0011H\u0002¢\u0006\u0004\b\u0013\u0010\u0014J'\u0010\u0017\u001a\u00020\u00112\u0006\u0010\u0015\u001a\u00020\u00112\u0006\u0010\u0005\u001a\u00028\u00002\u0006\u0010\u0016\u001a\u00020\u0011H\u0002¢\u0006\u0004\b\u0017\u0010\u0018R\"\u0010\u001e\u001a\u00020\u00118\u0000@\u0000X\u0080\u000e¢\u0006\u0012\n\u0004\b\u0013\u0010\u0019\u001a\u0004\b\u001a\u0010\u001b\"\u0004\b\u001c\u0010\u001dR\"\u0010%\u001a\u00020\u001f8\u0000@\u0000X\u0080\u000e¢\u0006\u0012\n\u0004\b\u0017\u0010 \u001a\u0004\b!\u0010\"\"\u0004\b#\u0010$R0\u0010.\u001a\u0010\u0012\f\u0012\n\u0012\u0004\u0012\u00028\u0000\u0018\u00010'0&8\u0000@\u0000X\u0080\u000e¢\u0006\u0012\n\u0004\b(\u0010)\u001a\u0004\b*\u0010+\"\u0004\b,\u0010-\u0082\u0002\u0007\n\u0005\b\u009920\u0001¨\u0006/"}, m28850d2 = {"Landroidx/compose/runtime/snapshots/SnapshotWeakSet;", "", "T", "<init>", "()V", "value", "", ProductAction.ACTION_ADD, "(Ljava/lang/Object;)Z", "Lkotlin/Function1;", "block", "", "removeIf", "(Lkotlin/jvm/functions/Function1;)V", "isValid$runtime_release", "()Z", "isValid", "", "hash", PDPageLabelRange.STYLE_LETTERS_LOWER, "(Ljava/lang/Object;I)I", "midIndex", "valueHash", OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, "(ILjava/lang/Object;I)I", "I", "getSize$runtime_release", "()I", "setSize$runtime_release", "(I)V", "size", "", "[I", "getHashes$runtime_release", "()[I", "setHashes$runtime_release", "([I)V", "hashes", "", "Landroidx/compose/runtime/WeakReference;", OperatorName.CURVE_TO, "[Landroidx/compose/runtime/WeakReference;", "getValues$runtime_release", "()[Landroidx/compose/runtime/WeakReference;", "setValues$runtime_release", "([Landroidx/compose/runtime/WeakReference;)V", "values", "runtime_release"}, m28849k = 1, m28848mv = {1, 8, 0})
...
public final class SnapshotWeakSet<T> {
    ...
    /* renamed from: b */
    public int[] f28786b = new int[16];

    /* renamed from: c */
    public WeakReference[] f28787c = new WeakReference[16];

    /* renamed from: a */
    public final int m59876a(Object obj, int i) {
        T t;
        int i2 = this.f28785a - 1;
        int i3 = 0;
        while (i3 <= i2) {
            int i4 = (i3 + i2) >>> 1;
            int i5 = this.f28786b[i4];
            if (i5 < i) {
                i3 = i4 + 1;
            } else if (i5 > i) {
                i2 = i4 - 1;
            } else {
                WeakReference weakReference = this.f28787c[i4];
    ...
    public final boolean add(@NotNull T value) {
        ...
        if (i2 > 0) {
            i = m59876a(value, identityHashCode);
            if (i >= 0) {
                return false;
            }
        } else {
        ...
        int i3 = -(i + 1);
        WeakReference[] weakReferenceArr = this.f28787c;
        ...
        if (i2 == length) {
            ...
            ArraysKt___ArraysJvmKt.copyInto$default(this.f28787c, weakReferenceArr2, 0, 0, i3, 6, (Object) null);
            ArraysKt___ArraysJvmKt.copyInto(this.f28786b, iArr, i5, i3, i2);
            ArraysKt___ArraysJvmKt.copyInto$default(this.f28786b, iArr, 0, 0, i3, 6, (Object) null);
            this.f28787c = weakReferenceArr2;
            this.f28786b = iArr;
        } else {
            int i6 = i3 + 1;
            ArraysKt___ArraysJvmKt.copyInto(weakReferenceArr, weakReferenceArr, i6, i3, i2);
            int[] iArr2 = this.f28786b;
            ArraysKt___ArraysJvmKt.copyInto(iArr2, iArr2, i6, i3, i2);
        }
        this.f28787c[i3] = new WeakReference(value);
        this.f28786b[i3] = identityHashCode;
        this.f28785a++;
        return true;
    }
    ...
    */
    public final int m59875b(int r4, java.lang.Object r5, int r6) {
        /*
            r3 = this;
            int r0 = r4 + (-1)
        L2:
            ...
            goto L1d
        Ld:
            androidx.compose.runtime.WeakReference[] r2 = r3.f28787c
            r2 = r2[r0]
            if (r2 == 0) goto L17
        ...
        L3f:
            ...
            goto L29
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.runtime.snapshots.SnapshotWeakSet.m59875b(int, java.lang.Object, int):int");
    }
