...
public final class Recomposer$effectJob$1$1 extends Lambda implements Function1<Throwable, Unit> {
    ...
    public final void invoke2(@Nullable Throwable th2) {
        ...
        synchronized (obj) {
            try {
                job = recomposer.f28389d;
                cancellableContinuation = null;
                if (job != null) {
                    mutableStateFlow2 = recomposer.f28405t;
                    mutableStateFlow2.setValue(Recomposer.State.ShuttingDown);
                    z = recomposer.f28402q;
                    if (z) {
                        cancellableContinuation2 = recomposer.f28400o;
                        if (cancellableContinuation2 != null) {
                            cancellableContinuation3 = recomposer.f28400o;
                            recomposer.f28400o = null;
                    ...
                    recomposer.f28390e = CancellationException;
