...
public final class Latch {
    ...
    /* renamed from: b */
    public List f28342b = new ArrayList();

    /* renamed from: c */
    public List f28343c = new ArrayList();
    ...
    public final Object await(@NotNull Continuation<? super Unit> continuation) {
        ...
        synchronized (this.f28341a) {
            this.f28342b.add(cancellableContinuationImpl);
        }
    ...
    public final void openLatch() {
        synchronized (this.f28341a) {
            try {
                ...
                this.f28342b = this.f28343c;
                this.f28343c = list;
                this.f28344d = true;
                int size = list.size();
                for (int i = 0; i < size; i++) {
                    Result.Companion companion = Result.Companion;
                    ((Continuation) list.get(i)).resumeWith(Result.m74087constructorimpl(Unit.INSTANCE));
                }
                list.clear();
                Unit unit = Unit.INSTANCE;
            } catch (Throwable th2) {
