...
public final class BroadcastFrameClock implements MonotonicFrameClock {
    ...
    /* renamed from: a */
    public final Function0 f28192a;

    /* renamed from: b */
    public final Object f28193b;

    /* renamed from: c */
    public Throwable f28194c;
    ...
    public static final class C3435a {
        ...
        /* renamed from: a */
        public final Function1 f28197a;

        /* renamed from: b */
        public final Continuation f28198b;

        public C3435a(Function1 onFrame, Continuation continuation) {
            Intrinsics.checkNotNullParameter(onFrame, "onFrame");
            Intrinsics.checkNotNullParameter(continuation, "continuation");
            this.f28197a = onFrame;
            this.f28198b = continuation;
        }

        /* renamed from: a */
        public final Continuation m60396a() {
            return this.f28198b;
        }

        /* renamed from: b */
        public final void m60395b(long j) {
            Object m74087constructorimpl;
            Continuation continuation = this.f28198b;
            try {
                Result.Companion companion = Result.Companion;
                m74087constructorimpl = Result.m74087constructorimpl(this.f28197a.invoke(Long.valueOf(j)));
            } catch (Throwable th2) {
    ...
    /* renamed from: a */
    public final void m60397a(Throwable th2) {
        synchronized (this.f28193b) {
            try {
                ...
                this.f28194c = th2;
                List list = this.f28195d;
                int size = list.size();
                for (int i = 0; i < size; i++) {
                    Continuation m60396a = ((C3435a) list.get(i)).m60396a();
                    Result.Companion companion = Result.Companion;
                    m60396a.resumeWith(Result.m74087constructorimpl(ResultKt.createFailure(th2)));
                }
                this.f28195d.clear();
    ...
    public final void sendFrame(long j) {
        synchronized (this.f28193b) {
            try {
                List list = this.f28195d;
                this.f28195d = this.f28196e;
                this.f28196e = list;
                int size = list.size();
                for (int i = 0; i < size; i++) {
                    ((C3435a) list.get(i)).m60395b(j);
                }
                list.clear();
                Unit unit = Unit.INSTANCE;
            } catch (Throwable th2) {
    ...
    public <R> Object withFrameNanos(@NotNull Function1<? super Long, ? extends R> function1, @NotNull Continuation<? super R> continuation) {
        ...
        synchronized (this.f28193b) {
            ...
            if (th2 != null) {
                ...
                objectRef.element = new C3435a(function1, cancellableContinuationImpl);
                boolean z = !this.f28195d.isEmpty();
                List list = this.f28195d;
    ...
    public BroadcastFrameClock(@Nullable Function0<Unit> function0) {
        this.f28192a = function0;
        this.f28193b = new Object();
        this.f28195d = new ArrayList();
        this.f28196e = new ArrayList();
    }
