...
public final class RecomposerKt {
    ...
    /* renamed from: b */
    public static final Object f28415b = new Object();
    ...
    public static final <K, V> V removeLastMultiValue(@NotNull Map<K, List<V>> map, K k) {
        ...
        List<V> list = map.get(k);
        if (list != null) {
            V v = (V) AbstractC10410hs.removeFirst(list);
            if (list.isEmpty()) {
                map.remove(k);
                return v;
            }
