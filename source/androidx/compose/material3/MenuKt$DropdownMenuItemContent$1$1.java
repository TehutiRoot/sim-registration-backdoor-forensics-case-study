...
public final class MenuKt$DropdownMenuItemContent$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    /* loaded from: classes2.dex */
    public static final class C33101 extends Lambda implements Function2<Composer, Integer, Unit> {
        final /* synthetic */ int $$dirty;
        final /* synthetic */ Function2<Composer, Integer, Unit> $leadingIcon;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C33101(Function2<? super Composer, ? super Integer, Unit> function2, int i) {
            super(2);
        ...
        public final void invoke(@Nullable Composer composer, int i) {
            ...
            Modifier m69549defaultMinSizeVpY3zN4$default = SizeKt.m69549defaultMinSizeVpY3zN4$default(Modifier.Companion, MenuTokens.INSTANCE.m71101getListItemLeadingIconSizeD9Ej5fM(), 0.0f, 2, null);
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf = LayoutKt.materializerOf(m69549defaultMinSizeVpY3zN4$default);
    ...
    /* loaded from: classes2.dex */
    public static final class C33112 extends Lambda implements Function2<Composer, Integer, Unit> {
        final /* synthetic */ int $$dirty;
        final /* synthetic */ Function2<Composer, Integer, Unit> $leadingIcon;
        final /* synthetic */ Function2<Composer, Integer, Unit> $text;
        final /* synthetic */ RowScope $this_Row;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C33112(RowScope rowScope, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, int i) {
            super(2);
        ...
        public final void invoke(@Nullable Composer composer, int i) {
            ...
            Modifier m68013a = AbstractC17770Hy1.m68013a(this.$this_Row, Modifier.Companion, 1.0f, false, 2, null);
            if (this.$leadingIcon != null) {
                m73658constructorimpl = MenuKt.f25878b;
            } else {
                m73658constructorimpl = C3641Dp.m73658constructorimpl(0);
            }
            float f = m73658constructorimpl;
            if (this.$trailingIcon != null) {
                m73658constructorimpl2 = MenuKt.f25878b;
            } else {
                m73658constructorimpl2 = C3641Dp.m73658constructorimpl(0);
            }
            Modifier m69533paddingqDBjuR0$default = PaddingKt.m69533paddingqDBjuR0$default(m68013a, f, 0.0f, m73658constructorimpl2, 0.0f, 10, null);
    ...
    /* loaded from: classes2.dex */
    public static final class C33123 extends Lambda implements Function2<Composer, Integer, Unit> {
        final /* synthetic */ int $$dirty;
        final /* synthetic */ Function2<Composer, Integer, Unit> $trailingIcon;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C33123(Function2<? super Composer, ? super Integer, Unit> function2, int i) {
            super(2);
        ...
        public final void invoke(@Nullable Composer composer, int i) {
            ...
            Modifier m69549defaultMinSizeVpY3zN4$default = SizeKt.m69549defaultMinSizeVpY3zN4$default(Modifier.Companion, MenuTokens.INSTANCE.m71102getListItemTrailingIconSizeD9Ej5fM(), 0.0f, 2, null);
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        if (this.$leadingIcon != null) {
            ...
            int i2 = this.$$dirty;
            CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{localContentColor.provides(menuItemColors.leadingIconColor$material3_release(z, composer, ((i2 >> 15) & 112) | ((i2 >> 15) & 14)).getValue())}, ComposableLambdaKt.composableLambda(composer, 2035552199, true, new C33101(this.$leadingIcon, this.$$dirty)), composer, 56);
        }
        composer.endReplaceableGroup();
        ...
        if (this.$trailingIcon != null) {
            ...
            int i4 = this.$$dirty;
            CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{localContentColor3.provides(menuItemColors3.trailingIconColor$material3_release(z3, composer, ((i4 >> 15) & 112) | ((i4 >> 15) & 14)).getValue())}, ComposableLambdaKt.composableLambda(composer, 580312062, true, new C33123(this.$trailingIcon, this.$$dirty)), composer, 56);
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
