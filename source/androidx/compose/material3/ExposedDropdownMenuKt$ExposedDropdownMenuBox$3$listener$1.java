...
public final class ExposedDropdownMenuKt$ExposedDropdownMenuBox$3$listener$1 extends Lambda implements Function0<Unit> {
    ...
    @Metadata(m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
    /* renamed from: androidx.compose.material3.ExposedDropdownMenuKt$ExposedDropdownMenuBox$3$listener$1$1 */
    /* loaded from: classes2.dex */
    public static final class C32931 extends Lambda implements Function1<Integer, Unit> {
        final /* synthetic */ MutableState<Integer> $menuHeight$delegate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C32931(MutableState<Integer> mutableState) {
            super(1);
    ...
    public final void invoke2() {
        ...
        ExposedDropdownMenuKt.m60642f(rootView, this.$coordinates.getValue(), this.$verticalMarginInPx, new C32931(this.$menuHeight$delegate));
    }
}
