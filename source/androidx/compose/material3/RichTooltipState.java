...
@Metadata(m28851d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\f\b\u0007\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\u0013\u0010\u0005\u001a\u00020\u0004H\u0096@ø\u0001\u0000¢\u0006\u0004\b\u0005\u0010\u0006J\u0013\u0010\u0007\u001a\u00020\u0004H\u0096@ø\u0001\u0000¢\u0006\u0004\b\u0007\u0010\u0006R+\u0010\f\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\b8V@PX\u0096\u008e\u0002¢\u0006\u0012\n\u0004\b\n\u0010\u000b\u001a\u0004\b\f\u0010\r\"\u0004\b\u000e\u0010\u000fR+\u0010\u0013\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\b8@@@X\u0080\u008e\u0002¢\u0006\u0012\n\u0004\b\u0010\u0010\u000b\u001a\u0004\b\u0011\u0010\r\"\u0004\b\u0012\u0010\u000f\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\u0014"}, m28850d2 = {"Landroidx/compose/material3/RichTooltipState;", "Landroidx/compose/material3/TooltipState;", "<init>", "()V", "", "show", "(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "dismiss", "", "<set-?>", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/runtime/MutableState;", "isVisible", "()Z", "setVisible$material3_release", "(Z)V", OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, "isPersistent$material3_release", "setPersistent$material3_release", "isPersistent", "material3_release"}, m28849k = 1, m28848mv = {1, 8, 0})
@Stable
...
public final class RichTooltipState implements TooltipState {
    ...
    /* renamed from: a */
    public final MutableState f25983a;

    /* renamed from: b */
    public final MutableState f25984b;
    ...
    public final boolean isPersistent$material3_release() {
        return ((Boolean) this.f25984b.getValue()).booleanValue();
    }

    @Override // androidx.compose.material3.TooltipState
    public boolean isVisible() {
        return ((Boolean) this.f25983a.getValue()).booleanValue();
    }

    public final void setPersistent$material3_release(boolean z) {
        this.f25984b.setValue(Boolean.valueOf(z));
    }

    public void setVisible$material3_release(boolean z) {
        this.f25983a.setValue(Boolean.valueOf(z));
    }

    @Override // androidx.compose.material3.TooltipState
    @Nullable
    public Object show(@NotNull Continuation<? super Unit> continuation) {
        Object m60406c = TooltipSync.f26495a.m60406c(this, isPersistent$material3_release(), continuation);
