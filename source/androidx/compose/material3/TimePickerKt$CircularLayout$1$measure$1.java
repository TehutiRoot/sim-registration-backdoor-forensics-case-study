...
public final class TimePickerKt$CircularLayout$1$measure$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke2(@NotNull Placeable.PlacementScope layout) {
        ...
        while (it.hasNext()) {
            ...
            Placeable.PlacementScope.place$default(layout, (Placeable) next, AbstractC21140mr0.roundToInt((Math.cos(d2) * d) + ((Constraints.m73626getMaxWidthimpl(j) / 2) - (placeable.getWidth() / 2))), AbstractC21140mr0.roundToInt((d * Math.sin(d2)) + ((Constraints.m73625getMaxHeightimpl(j) / 2) - (placeable.getHeight() / 2))), 0.0f, 4, null);
            i = i2;
            it = it2;
        }
        Placeable placeable3 = this.$innerCirclePlaceable;
        if (placeable3 != null) {
            Placeable.PlacementScope.place$default(layout, placeable3, (Constraints.m73628getMinWidthimpl(this.$constraints) - this.$innerCirclePlaceable.getWidth()) / 2, (Constraints.m73627getMinHeightimpl(this.$constraints) - this.$innerCirclePlaceable.getHeight()) / 2, 0.0f, 4, null);
        }
    }
}
