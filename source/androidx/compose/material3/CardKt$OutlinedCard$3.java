...
public final class CardKt$OutlinedCard$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public CardKt$OutlinedCard$3(Function0<Unit> function0, Modifier modifier, boolean z, Shape shape, CardColors cardColors, CardElevation cardElevation, BorderStroke borderStroke, MutableInteractionSource mutableInteractionSource, Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, int i, int i2) {
        super(2);
