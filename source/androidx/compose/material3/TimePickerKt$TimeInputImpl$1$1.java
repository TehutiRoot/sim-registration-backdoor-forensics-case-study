...
public final class TimePickerKt$TimeInputImpl$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        int m70538getHourJiIwxys = companion2.m70538getHourJiIwxys();
        ImeAction.Companion companion3 = ImeAction.Companion;
        int m73368getNexteUduSuo = companion3.m73368getNexteUduSuo();
        KeyboardType.Companion companion4 = KeyboardType.Companion;
        KeyboardOptions keyboardOptions = new KeyboardOptions(0, false, companion4.m73414getNumberPjHm6EE(), m73368getNexteUduSuo, 3, null);
        ...
        int i2 = this.$$dirty;
        TimePickerKt.m60430o(onKeyEvent, m60434k, function1, timePickerState3, m70538getHourJiIwxys, keyboardOptions, keyboardActions, timePickerColors, composer, ((i2 << 3) & 7168) | 24576 | ((i2 << 18) & 29360128), 0);
        f = TimePickerKt.f26386e;
        TimePickerKt.m60439f(SizeKt.m69566sizeVpY3zN4(companion, f, TimeInputTokens.INSTANCE.m71294getPeriodSelectorContainerHeightD9Ej5fM()), composer, 6);
        ...
        int m70539getMinuteJiIwxys = companion2.m70539getMinuteJiIwxys();
        KeyboardOptions keyboardOptions2 = new KeyboardOptions(0, false, companion4.m73414getNumberPjHm6EE(), companion3.m73366getDoneeUduSuo(), 3, null);
        ...
        int i3 = this.$$dirty;
        TimePickerKt.m60430o(onPreviewKeyEvent, m60432m, function12, timePickerState7, m70539getMinuteJiIwxys, keyboardOptions2, keyboardActions2, timePickerColors2, composer, ((i3 << 3) & 7168) | 24576 | ((i3 << 18) & 29360128), 0);
        if (ComposerKt.isTraceInProgress()) {
