...
public final class ModalBottomSheet_androidKt$ModalBottomSheet$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    /* loaded from: classes2.dex */
    public static final class C33171 extends Lambda implements Function3<BoxWithConstraintsScope, Composer, Integer, Unit> {
        final /* synthetic */ int $$dirty;
        final /* synthetic */ int $$dirty1;
        final /* synthetic */ AnchorChangeHandler<SheetValue> $anchorChangeHandler;
        final /* synthetic */ Function0<Unit> $animateToDismiss;
        ...
        /* loaded from: classes2.dex */
        public static final class C33185 extends Lambda implements Function2<Composer, Integer, Unit> {
            final /* synthetic */ int $$dirty;
            final /* synthetic */ int $$dirty1;
            final /* synthetic */ Function0<Unit> $animateToDismiss;
            final /* synthetic */ Function3<ColumnScope, Composer, Integer, Unit> $content;
            ...
            public C33185(Function2<? super Composer, ? super Integer, Unit> function2, Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, int i, SheetState sheetState, Function0<Unit> function0, CoroutineScope coroutineScope, int i2) {
                super(2);
            ...
            public final void invoke(@Nullable Composer composer, int i) {
                ...
                if (function2 != null) {
                    ...
                    i2 = 6;
                    Modifier semantics = SemanticsModifierKt.semantics(columnScopeInstance.align(companion, companion2.getCenterHorizontally()), true, new ModalBottomSheet_androidKt$ModalBottomSheet$2$1$5$1$1(sheetState, Strings_androidKt.m70619getStringNWtq28(companion4.m70556getBottomSheetDismissDescriptionadMyvUU(), composer, 6), Strings_androidKt.m70619getStringNWtq28(companion4.m70558getBottomSheetExpandDescriptionadMyvUU(), composer, 6), m70619getStringNWtq28, function0, coroutineScope));
        ...
        public final void invoke(@NotNull BoxWithConstraintsScope BoxWithConstraints, @Nullable Composer composer, int i) {
            ...
            int m73625getMaxHeightimpl = Constraints.m73625getMaxHeightimpl(BoxWithConstraints.mo69493getConstraintsmsEJaDk());
            ModalBottomSheet_androidKt.m60615c(this.$scrimColor, this.$animateToDismiss, this.$sheetState.getTargetValue() != SheetValue.Hidden, composer, (this.$$dirty >> 21) & 14);
            String m70619getStringNWtq28 = Strings_androidKt.m70619getStringNWtq28(Strings.Companion.m70559getBottomSheetPaneTitleadMyvUU(), composer, 6);
            Modifier align = BoxWithConstraints.align(SizeKt.fillMaxWidth$default(SizeKt.m69571widthInVpY3zN4$default(this.$modifier, 0.0f, SheetDefaultsKt.getBottomSheetMaxWidth(), 1, null), 0.0f, 1, null), Alignment.Companion.getTopCenter());
            composer.startReplaceableGroup(1157296644);
            boolean changed = composer.changed(m70619getStringNWtq28);
            Object rememberedValue = composer.rememberedValue();
            if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                rememberedValue = new ModalBottomSheet_androidKt$ModalBottomSheet$2$1$1$1(m70619getStringNWtq28);
            ...
            float f = m73625getMaxHeightimpl;
            ...
            composer.endReplaceableGroup();
            m60613e = ModalBottomSheet_androidKt.m60613e(nestedScroll$default, sheetState3, anchorChangeHandler, f, (Function2) rememberedValue4);
            Shape shape = this.$shape;
            long j = this.$containerColor;
            long j2 = this.$contentColor;
            float f2 = this.$tonalElevation;
            ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer, 1371274015, true, new C33185(this.$dragHandle, this.$content, this.$$dirty1, this.$sheetState, this.$animateToDismiss, this.$scope, this.$$dirty));
            int i3 = this.$$dirty;
            SurfaceKt.m70628SurfaceT9BRK9s(m60613e, shape, j, j2, f2, 0.0f, null, composableLambda, composer, ((i3 >> 6) & 112) | 12582912 | ((i3 >> 6) & 896) | ((i3 >> 6) & 7168) | ((i3 >> 6) & 57344), 96);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
