...
@DebugMetadata(m28801c = "androidx.compose.material3.SliderKt$animateToTarget$2", m28800f = "Slider.kt", m28799i = {}, m28798l = {1221}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
...
public final class SliderKt$animateToTarget$2 extends SuspendLambda implements Function2<DragScope, Continuation<? super Unit>, Object> {
    ...
    /* renamed from: androidx.compose.material3.SliderKt$animateToTarget$2$1 */
    /* loaded from: classes2.dex */
    public static final class C33611 extends Lambda implements Function1<Animatable<Float, AnimationVector1D>, Unit> {
        final /* synthetic */ DragScope $$this$drag;
        final /* synthetic */ Ref.FloatRef $latestValue;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C33611(DragScope dragScope, Ref.FloatRef floatRef) {
            super(1);
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i != 0) {
            ...
            tweenSpec = SliderKt.f26086k;
            Float boxFloat2 = Boxing.boxFloat(this.$velocity);
            C33611 c33611 = new C33611((DragScope) this.L$0, floatRef);
            this.label = 1;
            if (Animatable$default.animateTo(boxFloat, tweenSpec, boxFloat2, c33611, this) == coroutine_suspended) {
