...
public final class DatePickerKt$MonthsNavigation$1$2$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        IconKt.m70427Iconww6aTOc(keyboardArrowRight, Strings_androidKt.m70619getStringNWtq28(Strings.Companion.m70580getDatePickerSwitchToNextMonthadMyvUU(), composer, 6), (Modifier) null, 0L, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
