...
@DebugMetadata(m28801c = "androidx.compose.material3.NavigationDrawerKt$Scrim$dismissDrawer$1$1", m28800f = "NavigationDrawer.kt", m28799i = {}, m28798l = {852}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
...
public final class NavigationDrawerKt$Scrim$dismissDrawer$1$1 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes2.dex */
    public static final class C33401 extends Lambda implements Function1<Offset, Unit> {
        final /* synthetic */ Function0<Unit> $onClose;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C33401(Function0<Unit> function0) {
            super(1);
        ...
        public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
            m70478invokek4lQ0M(offset.m71512unboximpl());
            return Unit.INSTANCE;
        }

        /* renamed from: invoke-k-4lQ0M  reason: not valid java name */
        public final void m70478invokek4lQ0M(long j) {
            this.$onClose.invoke();
        }
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i != 0) {
            ...
            C33401 c33401 = new C33401(this.$onClose);
            this.label = 1;
            if (TapGestureDetectorKt.detectTapGestures$default(pointerInputScope, null, null, null, c33401, this, 7, null) == coroutine_suspended) {
