...
public final class NavigationRailKt$NavigationRailItem$styledIcon$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    /* loaded from: classes2.dex */
    public static final class C33431 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
        public static final C33431 INSTANCE = new C33431();
    ...
    public NavigationRailKt$NavigationRailItem$styledIcon$1(NavigationRailItemColors navigationRailItemColors, boolean z, boolean z2, int i, Function2<? super Composer, ? super Integer, Unit> function2, boolean z3, Function2<? super Composer, ? super Integer, Unit> function22) {
        super(2);
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        Modifier clearAndSetSemantics = (this.$label == null || !(this.$alwaysShowLabel || this.$selected)) ? Modifier.Companion : SemanticsModifierKt.clearAndSetSemantics(Modifier.Companion, C33431.INSTANCE);
        ...
        CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m71725boximpl(invoke$lambda$0(iconColor$material3_release)))}, function2, composer, ((i3 >> 3) & 112) | 8);
