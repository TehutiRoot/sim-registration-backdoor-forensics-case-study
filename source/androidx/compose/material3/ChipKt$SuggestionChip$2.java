...
public final class ChipKt$SuggestionChip$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public ChipKt$SuggestionChip$2(Function0<Unit> function0, Function2<? super Composer, ? super Integer, Unit> function2, Modifier modifier, boolean z, Function2<? super Composer, ? super Integer, Unit> function22, Shape shape, ChipColors chipColors, ChipElevation chipElevation, ChipBorder chipBorder, MutableInteractionSource mutableInteractionSource, int i, int i2) {
        super(2);
