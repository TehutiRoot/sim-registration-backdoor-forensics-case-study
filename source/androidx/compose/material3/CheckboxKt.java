...
public final class CheckboxKt {
    ...
    static {
        float f = 2;
        f25623a = C3641Dp.m73658constructorimpl(f);
        f25625c = C3641Dp.m73658constructorimpl(f);
        f25626d = C3641Dp.m73658constructorimpl(f);
    }
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final void m60685a(boolean r32, androidx.compose.p003ui.state.ToggleableState r33, androidx.compose.p003ui.Modifier r34, androidx.compose.material3.CheckboxColors r35, androidx.compose.runtime.Composer r36, int r37) {
        /*
            Method dump skipped, instructions count: 702
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.CheckboxKt.m60685a(boolean, androidx.compose.ui.state.ToggleableState, androidx.compose.ui.Modifier, androidx.compose.material3.CheckboxColors, androidx.compose.runtime.Composer, int):void");
    }

    /* renamed from: b */
    public static final void m60684b(DrawScope drawScope, long j, long j2, float f, float f2) {
        float f3 = f2 / 2.0f;
    ...
    /* renamed from: c */
    public static final void m60683c(DrawScope drawScope, long j, float f, float f2, float f3, C10105dp c10105dp) {
        ...
        c10105dp.m31676a().reset();
        c10105dp.m31676a().moveTo(0.2f * m71571getWidthimpl, lerp3 * m71571getWidthimpl);
        c10105dp.m31676a().lineTo(lerp * m71571getWidthimpl, lerp2 * m71571getWidthimpl);
        c10105dp.m31676a().lineTo(0.8f * m71571getWidthimpl, m71571getWidthimpl * lerp4);
        c10105dp.m31675b().setPath(c10105dp.m31676a(), false);
        c10105dp.m31674c().reset();
        c10105dp.m31675b().getSegment(0.0f, c10105dp.m31675b().getLength() * f, c10105dp.m31674c(), true);
        AbstractC12212lK.m26520G(drawScope, c10105dp.m31674c(), j, 0.0f, stroke, null, 0, 52, null);
    }
}
