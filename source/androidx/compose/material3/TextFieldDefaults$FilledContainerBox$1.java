...
public final class TextFieldDefaults$FilledContainerBox$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public TextFieldDefaults$FilledContainerBox$1(TextFieldDefaults textFieldDefaults, boolean z, boolean z2, InteractionSource interactionSource, TextFieldColors textFieldColors, Shape shape, int i, int i2) {
        super(2);
