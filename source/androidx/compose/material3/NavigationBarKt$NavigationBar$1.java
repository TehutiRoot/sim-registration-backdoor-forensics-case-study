...
public final class NavigationBarKt$NavigationBar$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        f = NavigationBarKt.f25901a;
        Modifier selectableGroup = SelectableGroupKt.selectableGroup(SizeKt.m69550height3ABfNKs(windowInsetsPadding, f));
        Arrangement.HorizontalOrVertical m69478spacedBy0680j_4 = Arrangement.INSTANCE.m69478spacedBy0680j_4(NavigationBarKt.getNavigationBarItemHorizontalPadding());
        Function3<RowScope, Composer, Integer, Unit> function3 = this.$content;
        int i2 = ((this.$$dirty >> 6) & 7168) | 48;
        composer.startReplaceableGroup(693286680);
        MeasurePolicy rowMeasurePolicy = RowKt.rowMeasurePolicy(m69478spacedBy0680j_4, Alignment.Companion.getTop(), composer, 6);
