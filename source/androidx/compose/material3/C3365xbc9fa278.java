...
public final class C3365xbc9fa278 extends Lambda implements Function1<PointerInputChange, Unit> {
    ...
    public C3365xbc9fa278(State<? extends Function2<? super Boolean, ? super Float, Unit>> state, Ref.BooleanRef booleanRef, boolean z) {
        super(1);
        this.$onDrag = state;
