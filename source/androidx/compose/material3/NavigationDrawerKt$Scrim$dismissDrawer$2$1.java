...
public final class NavigationDrawerKt$Scrim$dismissDrawer$2$1 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    ...
    /* loaded from: classes2.dex */
    public static final class C33411 extends Lambda implements Function0<Boolean> {
        final /* synthetic */ Function0<Unit> $onClose;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C33411(Function0<Unit> function0) {
            super(0);
    ...
    public final void invoke2(@NotNull SemanticsPropertyReceiver semantics) {
        ...
        SemanticsPropertiesKt.onClick$default(semantics, null, new C33411(this.$onClose), 1, null);
    }
}
