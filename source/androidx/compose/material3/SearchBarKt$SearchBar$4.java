...
public final class SearchBarKt$SearchBar$4 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        State<C3641Dp> state3 = this.$topPadding;
        ...
        if (rememberedValue == companion4.getEmpty()) {
            rememberedValue = new C0297E4(state2, state3);
            composer.updateRememberedValue(rememberedValue);
        }
        composer.endReplaceableGroup();
        SearchBarKt.m60574a(str, function1, function12, z, function13, PaddingKt.padding(companion, (C0297E4) rememberedValue), z2, function2, function22, function23, searchBarColors.getInputFieldColors(), mutableInteractionSource, composer, (i2 & 14) | ProfileVerifier.CompilationStatus.f36531xf2722a21 | (i2 & 112) | (i2 & 896) | (i2 & 7168) | (57344 & i2) | (3670016 & i2) | (29360128 & i2) | (234881024 & i2) | (1879048192 & i2), (i3 >> 9) & 112, 0);
        composer.startReplaceableGroup(-492369756);
