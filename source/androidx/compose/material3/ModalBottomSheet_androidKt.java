...
public final class ModalBottomSheet_androidKt {
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final /* synthetic */ void m70457ModalBottomSheetxOkiWaM(kotlin.jvm.functions.Function0 r32, androidx.compose.p003ui.Modifier r33, androidx.compose.material3.SheetState r34, androidx.compose.p003ui.graphics.Shape r35, long r36, long r38, float r40, long r41, kotlin.jvm.functions.Function2 r43, kotlin.jvm.functions.Function3 r44, androidx.compose.runtime.Composer r45, int r46, int r47) {
        /*
            Method dump skipped, instructions count: 657
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.ModalBottomSheet_androidKt.m70457ModalBottomSheetxOkiWaM(kotlin.jvm.functions.Function0, androidx.compose.ui.Modifier, androidx.compose.material3.SheetState, androidx.compose.ui.graphics.Shape, long, long, float, long, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final void ModalBottomSheetPopup(@NotNull Function0<Unit> onDismissRequest, @NotNull WindowInsets windowInsets, @NotNull Function2<? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, int i) {
        ...
        if ((i6 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            UUID id2 = (UUID) RememberSaveableKt.m71406rememberSaveable(new Object[0], (Saver<Object, ? extends Object>) null, (String) null, (Function0<? extends Object>) ModalBottomSheet_androidKt$ModalBottomSheetPopup$id$1.INSTANCE, startRestartGroup, 3080, 6);
            ...
            if (rememberedValue == Composer.Companion.getEmpty()) {
                ...
                modalBottomSheetWindow2.m60618f(rememberCompositionContext, ComposableLambdaKt.composableLambdaInstance(861223805, true, new C3329x4d8b1701(windowInsets, rememberUpdatedState)));
    ...
    /* renamed from: a */
    public static final AnchorChangeHandler m60617a(final SheetState sheetState, final Function2 function2, final Function1 function1) {
    ...
    /* renamed from: b */
    public static final Function2 m60616b(State state) {
        return (Function2) state.getValue();
    }

    /* renamed from: c */
    public static final void m60615c(long j, Function0 function0, boolean z, Composer composer, int i) {
        int i2;
        float f;
        Modifier modifier;
        int i3;
        ...
        if ((i2 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            if (j != Color.Companion.m71771getUnspecified0d7_KjU()) {
                ...
                boolean changed2 = startRestartGroup.changed(m71725boximpl) | startRestartGroup.changed(animateFloatAsState);
    ...
    /* renamed from: d */
    public static final float m60614d(State state) {
        return ((Number) state.getValue()).floatValue();
    }

    /* renamed from: e */
    public static final Modifier m60613e(Modifier modifier, SheetState sheetState, AnchorChangeHandler anchorChangeHandler, float f, Function2 function2) {
        return SwipeableV2Kt.swipeAnchors(DraggableKt.draggable$default(modifier, sheetState.getSwipeableState$material3_release().getSwipeDraggableState$material3_release(), Orientation.Vertical, sheetState.isVisible(), null, sheetState.getSwipeableState$material3_release().isAnimationRunning(), null, new ModalBottomSheet_androidKt$modalBottomSheetSwipeable$1(function2), false, 168, null), sheetState.getSwipeableState$material3_release(), DG1.setOf((Object[]) new SheetValue[]{SheetValue.Hidden, SheetValue.PartiallyExpanded, SheetValue.Expanded}), anchorChangeHandler, new ModalBottomSheet_androidKt$modalBottomSheetSwipeable$2(f, sheetState));
    }

    /* renamed from: f */
    public static final /* synthetic */ Object m60612f(Function2 function2, CoroutineScope coroutineScope, float f, Continuation continuation) {
