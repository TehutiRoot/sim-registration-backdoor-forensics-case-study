...
public final class IconButtonKt$OutlinedIconToggleButton$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    final /* synthetic */ int $$dirty;
    final /* synthetic */ Function2<Composer, Integer, Unit> $content;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public IconButtonKt$OutlinedIconToggleButton$3(Function2<? super Composer, ? super Integer, Unit> function2, int i) {
        super(2);
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1207657396, i, -1, "androidx.compose.material3.OutlinedIconToggleButton.<anonymous> (IconButton.kt:523)");
        }
        Modifier m69564size3ABfNKs = SizeKt.m69564size3ABfNKs(Modifier.Companion, OutlinedIconButtonTokens.INSTANCE.m71142getContainerSizeD9Ej5fM());
        ...
        function2.invoke(composer, Integer.valueOf((i2 >> 24) & 14));
