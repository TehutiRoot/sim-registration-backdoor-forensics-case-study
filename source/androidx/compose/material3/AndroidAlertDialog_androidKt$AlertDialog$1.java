...
public final class AndroidAlertDialog_androidKt$AlertDialog$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    /* loaded from: classes2.dex */
    public static final class C32291 extends Lambda implements Function2<Composer, Integer, Unit> {
        final /* synthetic */ int $$dirty;
        final /* synthetic */ Function2<Composer, Integer, Unit> $confirmButton;
        final /* synthetic */ Function2<Composer, Integer, Unit> $dismissButton;
        ...
        /* loaded from: classes2.dex */
        public static final class C32301 extends Lambda implements Function2<Composer, Integer, Unit> {
            final /* synthetic */ int $$dirty;
            final /* synthetic */ Function2<Composer, Integer, Unit> $confirmButton;
            final /* synthetic */ Function2<Composer, Integer, Unit> $dismissButton;
            ...
            public C32301(Function2<? super Composer, ? super Integer, Unit> function2, int i, Function2<? super Composer, ? super Integer, Unit> function22) {
                super(2);
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C32291(Function2<? super Composer, ? super Integer, Unit> function2, int i, Function2<? super Composer, ? super Integer, Unit> function22) {
            super(2);
            this.$dismissButton = function2;
            this.$$dirty = i;
            this.$confirmButton = function22;
        ...
        public final void invoke(@Nullable Composer composer, int i) {
            ...
            f = AndroidAlertDialog_androidKt.f25534a;
            f2 = AndroidAlertDialog_androidKt.f25535b;
            AlertDialogKt.m70186AlertDialogFlowRowixp7dh8(f, f2, ComposableLambdaKt.composableLambda(composer, 628285581, true, new C32301(this.$dismissButton, this.$$dirty, this.$confirmButton)), composer, 438);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer, -1873210524, true, new C32291(this.$dismissButton, this.$$dirty, this.$confirmButton));
        ...
        int i2 = this.$$dirty;
        int i3 = this.$$dirty1;
        AlertDialogKt.m70185AlertDialogContent4hvqGtA(composableLambda, null, function2, function22, function23, shape, j, f, color, j2, j3, j4, composer, ((i2 >> 6) & 896) | 6 | ((i2 >> 6) & 7168) | ((i2 >> 6) & 57344) | ((i2 >> 6) & 458752) | ((i2 >> 6) & 3670016) | ((i3 << 15) & 29360128) | (i2 & 1879048192), i3 & WebSocketProtocol.PAYLOAD_SHORT, 2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    }
