...
public final class IconButtonKt$FilledTonalIconToggleButton$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    final /* synthetic */ int $$dirty;
    final /* synthetic */ Function2<Composer, Integer, Unit> $content;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public IconButtonKt$FilledTonalIconToggleButton$3(Function2<? super Composer, ? super Integer, Unit> function2, int i) {
        super(2);
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-58218680, i, -1, "androidx.compose.material3.FilledTonalIconToggleButton.<anonymous> (IconButton.kt:395)");
        }
        Modifier m69564size3ABfNKs = SizeKt.m69564size3ABfNKs(Modifier.Companion, FilledTonalIconButtonTokens.INSTANCE.m71055getContainerSizeD9Ej5fM());
