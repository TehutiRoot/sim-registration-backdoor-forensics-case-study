...
public final class OutlinedTextFieldMeasurePolicy$measure$2 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke2(@NotNull Placeable.PlacementScope layout) {
        ...
        f = this.this$0.f25941c;
        z = this.this$0.f25940b;
        float density = this.$this_measure.getDensity();
        LayoutDirection layoutDirection = this.$this_measure.getLayoutDirection();
        paddingValues = this.this$0.f25942d;
        OutlinedTextFieldKt.m60595c(layout, i, i2, placeable, placeable2, placeable3, placeable4, placeable5, placeable6, placeable7, placeable8, placeable9, f, z, density, layoutDirection, paddingValues);
    }
}
