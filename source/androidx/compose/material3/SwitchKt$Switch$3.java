...
public final class SwitchKt$Switch$3 extends Lambda implements Function1<DisposableEffectScope, DisposableEffectResult> {
    ...
    @Metadata(m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
    @DebugMetadata(m28801c = "androidx.compose.material3.SwitchKt$Switch$3$1", m28800f = "Switch.kt", m28799i = {}, m28798l = {125}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
    /* renamed from: androidx.compose.material3.SwitchKt$Switch$3$1 */
    /* loaded from: classes2.dex */
    public static final class C33931 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ Animatable<Float, AnimationVector1D> $offset;
        final /* synthetic */ float $targetValue;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C33931(Animatable<Float, AnimationVector1D> animatable, float f, Continuation<? super C33931> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C33931(this.$offset, this.$targetValue, continuation);
        }
        ...
        public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C33931) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public final DisposableEffectResult invoke(@NotNull DisposableEffectScope DisposableEffect) {
        ...
        if (floatValue != f) {
            AbstractC1552Vc.m65753e(this.$scope, null, null, new C33931(this.$offset, f, null), 3, null);
        }
