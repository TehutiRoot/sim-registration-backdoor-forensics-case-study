...
public final class ListItemKt$LeadingContent$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        f = ListItemKt.f25855d;
        Modifier m69533paddingqDBjuR0$default = PaddingKt.m69533paddingqDBjuR0$default(modifier, 0.0f, 0.0f, f, 0.0f, 11, null);
        if (!this.$topAlign) {
            modifier = this.$this_LeadingContent.align(modifier, Alignment.Companion.getCenterVertically());
        }
        Modifier then = m69533paddingqDBjuR0$default.then(modifier);
