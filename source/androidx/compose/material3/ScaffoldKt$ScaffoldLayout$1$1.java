...
public final class ScaffoldKt$ScaffoldLayout$1$1 extends Lambda implements Function2<SubcomposeMeasureScope, Constraints, MeasureResult> {
    ...
    /* loaded from: classes2.dex */
    public static final class C33541 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
        final /* synthetic */ int $$dirty;
        final /* synthetic */ Function2<Composer, Integer, Unit> $bottomBar;
        final /* synthetic */ Function3<PaddingValues, Composer, Integer, Unit> $content;
        final /* synthetic */ WindowInsets $contentWindowInsets;
        ...
        public C33541(SubcomposeMeasureScope subcomposeMeasureScope, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, int i, int i2, WindowInsets windowInsets, long j, Function2<? super Composer, ? super Integer, Unit> function24, int i3, Function3<? super PaddingValues, ? super Composer, ? super Integer, Unit> function3, int i4) {
            super(1);
        ...
        public final void invoke2(@NotNull Placeable.PlacementScope layout) {
            ...
            for (Measurable measurable : subcompose) {
                arrayList.add(measurable.mo72811measureBRTryo0(j));
            }
            ...
            ArrayList<Placeable> arrayList2 = new ArrayList(AbstractC10176es.collectionSizeOrDefault(subcompose2, 10));
            for (Measurable measurable2 : subcompose2) {
                arrayList2.add(measurable2.mo72811measureBRTryo0(ConstraintsKt.m73642offsetNN6EwU(j2, (-windowInsets.getLeft(subcomposeMeasureScope, subcomposeMeasureScope.getLayoutDirection())) - windowInsets.getRight(subcomposeMeasureScope, subcomposeMeasureScope.getLayoutDirection()), -windowInsets.getBottom(subcomposeMeasureScope))));
            }
            ...
            for (Measurable measurable3 : this.$this_SubcomposeLayout.subcompose(ScaffoldLayoutContent.Fab, this.$fab)) {
                Placeable mo72811measureBRTryo0 = measurable3.mo72811measureBRTryo0(ConstraintsKt.m73642offsetNN6EwU(j3, (-windowInsets2.getLeft(subcomposeMeasureScope2, subcomposeMeasureScope2.getLayoutDirection())) - windowInsets2.getRight(subcomposeMeasureScope2, subcomposeMeasureScope2.getLayoutDirection()), -windowInsets2.getBottom(subcomposeMeasureScope2)));
                mo72811measureBRTryo0 = (mo72811measureBRTryo0.getHeight() == 0 || mo72811measureBRTryo0.getWidth() == 0) ? null : null;
                if (mo72811measureBRTryo0 != null) {
                    arrayList3.add(mo72811measureBRTryo0);
                }
            }
            if (!arrayList3.isEmpty()) {
                ...
                if (FabPosition.m70392equalsimpl0(this.$fabPosition, FabPosition.Companion.m70397getEndERTFSPs())) {
                    if (this.$this_SubcomposeLayout.getLayoutDirection() == LayoutDirection.Ltr) {
                        ...
                        f4 = ScaffoldKt.f25986b;
                        i2 = (i3 - subcomposeMeasureScope3.mo69432roundToPx0680j_4(f4)) - width6;
                    } else {
                        SubcomposeMeasureScope subcomposeMeasureScope4 = this.$this_SubcomposeLayout;
                        f3 = ScaffoldKt.f25986b;
                        i2 = subcomposeMeasureScope4.mo69432roundToPx0680j_4(f3);
                    }
                } else {
            ...
            ArrayList arrayList4 = new ArrayList(AbstractC10176es.collectionSizeOrDefault(subcompose3, 10));
            for (Measurable measurable4 : subcompose3) {
                arrayList4.add(measurable4.mo72811measureBRTryo0(j4));
            }
            ...
            if (fabPlacement != null) {
                ...
                if (valueOf == null) {
                    ...
                    f2 = ScaffoldKt.f25986b;
                    mo69432roundToPx0680j_4 = height12 + subcomposeMeasureScope5.mo69432roundToPx0680j_4(f2) + windowInsets3.getBottom(subcomposeMeasureScope5);
                } else {
                    int intValue2 = valueOf.intValue() + fabPlacement.getHeight();
                    f = ScaffoldKt.f25986b;
                    mo69432roundToPx0680j_4 = intValue2 + subcomposeMeasureScope5.mo69432roundToPx0680j_4(f);
                }
                num = Integer.valueOf(mo69432roundToPx0680j_4);
            } else {
                num = null;
            }
            if (height6 != 0) {
            ...
            ArrayList<Placeable> arrayList5 = new ArrayList(AbstractC10176es.collectionSizeOrDefault(subcompose4, 10));
            for (Measurable measurable5 : subcompose4) {
                arrayList5.add(measurable5.mo72811measureBRTryo0(j5));
            }
    ...
    public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeMeasureScope subcomposeMeasureScope, Constraints constraints) {
        return m70519invoke0kLqBqw(subcomposeMeasureScope, constraints.m73632unboximpl());
    }

    @NotNull
    /* renamed from: invoke-0kLqBqw  reason: not valid java name */
    public final MeasureResult m70519invoke0kLqBqw(@NotNull SubcomposeMeasureScope SubcomposeLayout, long j) {
        ...
        return MeasureScope.CC.m59532q(SubcomposeLayout, m73626getMaxWidthimpl, m73625getMaxHeightimpl, null, new C33541(SubcomposeLayout, this.$topBar, this.$snackbar, this.$fab, this.$fabPosition, m73626getMaxWidthimpl, this.$contentWindowInsets, Constraints.m73618copyZbe2FdA$default(j, 0, 0, 0, 0, 10, null), this.$bottomBar, this.$$dirty, this.$content, m73625getMaxHeightimpl), 4, null);
    }
}
