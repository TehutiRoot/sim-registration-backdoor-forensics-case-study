...
public final class ChipKt {
    ...
    */
    ...
    /* renamed from: a */
    public static final void m60680a(Modifier modifier, Function0 function0, boolean z, Function2 function2, TextStyle textStyle, long j, Function2 function22, Function2 function23, Shape shape, ChipColors chipColors, ChipElevation chipElevation, BorderStroke borderStroke, float f, PaddingValues paddingValues, MutableInteractionSource mutableInteractionSource, Composer composer, int i, int i2) {
        int i3;
        int i4;
        Composer composer2;
        ...
        if ((i3 & 1533916891) == 306783378 && (46811 & i4) == 9362 && startRestartGroup.getSkipping()) {
            ...
            int i5 = (i3 >> 6) & 14;
            long m71745unboximpl = chipColors.containerColor$material3_release(z, startRestartGroup, i5 | ((i3 >> 24) & 112)).getValue().m71745unboximpl();
            startRestartGroup.startReplaceableGroup(64018752);
            State<C3641Dp> state = chipElevation == null ? null : chipElevation.tonalElevation$material3_release(z, mutableInteractionSource, startRestartGroup, ((i4 >> 9) & 112) | i5 | ((i4 << 6) & 896));
            startRestartGroup.endReplaceableGroup();
            float m73672unboximpl = state != null ? state.getValue().m73672unboximpl() : C3641Dp.m73658constructorimpl(0);
            startRestartGroup.startReplaceableGroup(64018848);
            State<C3641Dp> shadowElevation$material3_release = chipElevation == null ? null : chipElevation.shadowElevation$material3_release(z, mutableInteractionSource, startRestartGroup, i5 | ((i4 >> 9) & 112) | ((i4 << 6) & 896));
            startRestartGroup.endReplaceableGroup();
            int i6 = i3;
            int i7 = i4;
            composer2 = startRestartGroup;
            SurfaceKt.m70631Surfaceo_FOJdg(function0, semantics$default, z, shape, m71745unboximpl, 0L, m73672unboximpl, shadowElevation$material3_release != null ? shadowElevation$material3_release.getValue().m73672unboximpl() : C3641Dp.m73658constructorimpl(0), borderStroke, mutableInteractionSource, ComposableLambdaKt.composableLambda(composer2, -1985962652, true, new ChipKt$Chip$2(function2, textStyle, j, function22, function23, chipColors, z, i6, f, paddingValues, i7)), composer2, ((i6 >> 3) & 14) | (i6 & 896) | ((i6 >> 15) & 7168) | ((i7 << 21) & 234881024) | ((i7 << 15) & 1879048192), 6, 32);
            if (ComposerKt.isTraceInProgress()) {
    ...
    /* renamed from: b */
    public static final void m60679b(Function2 function2, TextStyle textStyle, long j, Function2 function22, Function2 function23, Function2 function24, long j2, long j3, float f, PaddingValues paddingValues, Composer composer, int i) {
        int i2;
        int i3;
        int i4;
        int i5;
        ...
        if ((1533916891 & i2) == 306783378 && startRestartGroup.getSkipping()) {
            ...
            CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m71725boximpl(j)), TextKt.getLocalTextStyle().provides(textStyle)}, ComposableLambdaKt.composableLambda(startRestartGroup, 1748799148, true, new ChipKt$ChipContent$1(f, paddingValues, function23, i2, function22, j2, function2, function24, j3)), startRestartGroup, 56);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final void m60678c(boolean z, Modifier modifier, Function0 function0, boolean z2, Function2 function2, TextStyle textStyle, Function2 function22, Function2 function23, Function2 function24, Shape shape, SelectableChipColors selectableChipColors, SelectableChipElevation selectableChipElevation, BorderStroke borderStroke, float f, PaddingValues paddingValues, MutableInteractionSource mutableInteractionSource, Composer composer, int i, int i2) {
        ...
        if ((i3 & 1533916891) == 306783378 && (374491 & i4) == 74898 && startRestartGroup.getSkipping()) {
            ...
            int i5 = (i3 >> 9) & 14;
            long m71745unboximpl = selectableChipColors.containerColor$material3_release(z2, z, startRestartGroup, ((i3 << 3) & 112) | i5 | ((i4 << 6) & 896)).getValue().m71745unboximpl();
            startRestartGroup.startReplaceableGroup(1036660941);
            State<C3641Dp> state = selectableChipElevation == null ? null : selectableChipElevation.tonalElevation$material3_release(z2, mutableInteractionSource, startRestartGroup, ((i4 >> 12) & 112) | i5 | ((i4 << 3) & 896));
            startRestartGroup.endReplaceableGroup();
            float m73672unboximpl = state != null ? state.getValue().m73672unboximpl() : C3641Dp.m73658constructorimpl(0);
            startRestartGroup.startReplaceableGroup(1036661049);
            State<C3641Dp> shadowElevation$material3_release = selectableChipElevation == null ? null : selectableChipElevation.shadowElevation$material3_release(z2, mutableInteractionSource, startRestartGroup, i5 | ((i4 >> 12) & 112) | ((i4 << 3) & 896));
            startRestartGroup.endReplaceableGroup();
            int i6 = i3;
            int i7 = i4;
            composer2 = startRestartGroup;
            SurfaceKt.m70629Surfaced85dljk(z, function0, semantics$default, z2, shape, m71745unboximpl, 0L, m73672unboximpl, shadowElevation$material3_release != null ? shadowElevation$material3_release.getValue().m73672unboximpl() : C3641Dp.m73658constructorimpl(0), borderStroke, mutableInteractionSource, ComposableLambdaKt.composableLambda(startRestartGroup, -577614814, true, new ChipKt$SelectableChip$2(selectableChipColors, z2, z, i6, i7, function2, textStyle, function22, function23, function24, f, paddingValues)), startRestartGroup, (i6 & 14) | ((i6 >> 3) & 112) | (i6 & 7168) | ((i6 >> 15) & 57344) | ((i7 << 21) & 1879048192), ((i7 >> 15) & 14) | 48, 64);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    /* renamed from: d */
    public static final PaddingValues m60677d(boolean z, boolean z2, boolean z3) {
        float f;
        float f2;
        if (!z && z2) {
            f = 8;
        ...
        return PaddingKt.m69526PaddingValuesa9UjIt4$default(m73658constructorimpl, 0.0f, C3641Dp.m73658constructorimpl(f2), 0.0f, 10, null);
    }
}
