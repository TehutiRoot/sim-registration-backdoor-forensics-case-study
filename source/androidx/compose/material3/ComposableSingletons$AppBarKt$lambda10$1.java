...
public final class ComposableSingletons$AppBarKt$lambda10$1 extends Lambda implements Function3<RowScope, Composer, Integer, Unit> {
    ...
    public final void invoke(@NotNull RowScope rowScope, @Nullable Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-703422839, i, -1, "androidx.compose.material3.ComposableSingletons$AppBarKt.lambda-10.<anonymous> (AppBar.kt:341)");
        }
        if (ComposerKt.isTraceInProgress()) {
