...
public final class DateRangePickerKt {
    ...
    */
    ...
    /* renamed from: a */
    public static final void m60660a(StateData stateData, DatePickerFormatter datePickerFormatter, Function1 function1, DatePickerColors datePickerColors, Composer composer, int i) {
        int i2;
        int i3;
        int i4;
        int i5;
        ...
        if ((i2 & 5851) == 1170 && startRestartGroup.getSkipping()) {
            ...
            Modifier m69531paddingVpY3zN4$default = PaddingKt.m69531paddingVpY3zN4$default(Modifier.Companion, DatePickerKt.getDatePickerHorizontalPadding(), 0.0f, 2, null);
            ...
            int i7 = i2 << 6;
            m60658c(function12, stateData, rememberLazyListState, datePickerFormatter, function1, datePickerColors, startRestartGroup, ((i2 << 3) & 112) | (i7 & 7168) | (57344 & i7) | (i7 & 458752));
            startRestartGroup.endReplaceableGroup();
    ...
    /* renamed from: b */
    public static final void m60659b(DateRangePickerState dateRangePickerState, DatePickerFormatter datePickerFormatter, Function1 function1, DatePickerColors datePickerColors, Composer composer, int i) {
        int i2;
        int i3;
        int i4;
        int i5;
    ...
    /* renamed from: c */
    public static final void m60658c(Function1 function1, StateData stateData, LazyListState lazyListState, DatePickerFormatter datePickerFormatter, Function1 function12, DatePickerColors datePickerColors, Composer composer, int i) {
        int i2;
        int i3;
        int i4;
        int i5;
    ...
    /* renamed from: d */
    public static final List m60657d(LazyListState lazyListState, CoroutineScope coroutineScope, String str, String str2) {
    ...
    public static final void m70354drawRangeBackgroundmxwnekA(@NotNull ContentDrawScope drawRangeBackground, @NotNull SelectedRangeInfo selectedRangeInfo, long j) {
        float f;
        boolean z;
        float m71571getWidthimpl;
        float m71571getWidthimpl2;
        float f2;
        ...
        float mo69438toPx0680j_4 = drawRangeBackground.mo69438toPx0680j_4(DatePickerKt.getRecommendedSizeForAccessibility());
        float mo69438toPx0680j_42 = drawRangeBackground.mo69438toPx0680j_4(DatePickerKt.getRecommendedSizeForAccessibility());
        float mo69438toPx0680j_43 = drawRangeBackground.mo69438toPx0680j_4(DatePickerModalTokens.INSTANCE.m70926getDateStateLayerHeightD9Ej5fM());
        float f3 = 2;
        float f4 = (mo69438toPx0680j_42 - mo69438toPx0680j_43) / f3;
        float f5 = 7;
        float m71571getWidthimpl3 = (Size.m71571getWidthimpl(drawRangeBackground.mo72144getSizeNHjbRc()) - (f5 * mo69438toPx0680j_4)) / f5;
        long m73785unboximpl = selectedRangeInfo.getGridCoordinates().getFirst().m73785unboximpl();
        int m73768component1impl = IntOffset.m73768component1impl(m73785unboximpl);
        int m73769component2impl = IntOffset.m73769component2impl(m73785unboximpl);
        long m73785unboximpl2 = selectedRangeInfo.getGridCoordinates().getSecond().m73785unboximpl();
        int m73768component1impl2 = IntOffset.m73768component1impl(m73785unboximpl2);
        int m73769component2impl2 = IntOffset.m73769component2impl(m73785unboximpl2);
        float f6 = mo69438toPx0680j_4 + m71571getWidthimpl3;
        float f7 = m73768component1impl * f6;
        if (selectedRangeInfo.getFirstIsSelectionStart()) {
            f = mo69438toPx0680j_4 / f3;
        } else {
            f = 0.0f;
        }
        float f8 = m71571getWidthimpl3 / f3;
        float f9 = f7 + f + f8;
        float f10 = (m73769component2impl * mo69438toPx0680j_42) + f4;
        float f11 = m73768component1impl2 * f6;
        if (selectedRangeInfo.getLastIsSelectionEnd()) {
            mo69438toPx0680j_4 /= f3;
        }
        float f12 = f11 + mo69438toPx0680j_4 + f8;
        float f13 = (m73769component2impl2 * mo69438toPx0680j_42) + f4;
        ...
        if (z) {
            f9 = Size.m71571getWidthimpl(drawRangeBackground.mo72144getSizeNHjbRc()) - f9;
            f12 = Size.m71571getWidthimpl(drawRangeBackground.mo72144getSizeNHjbRc()) - f12;
        }
        float f14 = f12;
        long Offset = OffsetKt.Offset(f9, f10);
        if (m73769component2impl == m73769component2impl2) {
            m71571getWidthimpl = f14 - f9;
        } else if (z) {
            m71571getWidthimpl = -f9;
        } else {
            m71571getWidthimpl = Size.m71571getWidthimpl(drawRangeBackground.mo72144getSizeNHjbRc()) - f9;
        }
        AbstractC12212lK.m26516K(drawRangeBackground, j, Offset, SizeKt.Size(m71571getWidthimpl, mo69438toPx0680j_43), 0.0f, null, null, 0, 120, null);
        if (m73769component2impl != m73769component2impl2) {
            for (int i = (m73769component2impl2 - m73769component2impl) - 1; i > 0; i--) {
                AbstractC12212lK.m26516K(drawRangeBackground, j, OffsetKt.Offset(0.0f, f10 + (i * mo69438toPx0680j_42)), SizeKt.Size(Size.m71571getWidthimpl(drawRangeBackground.mo72144getSizeNHjbRc()), mo69438toPx0680j_43), 0.0f, null, null, 0, 120, null);
            }
            if (drawRangeBackground.getLayoutDirection() == LayoutDirection.Ltr) {
                f2 = f13;
                m71571getWidthimpl2 = 0.0f;
            } else {
                m71571getWidthimpl2 = Size.m71571getWidthimpl(drawRangeBackground.mo72144getSizeNHjbRc());
                f2 = f13;
            }
            long Offset2 = OffsetKt.Offset(m71571getWidthimpl2, f2);
            if (z) {
                f14 -= Size.m71571getWidthimpl(drawRangeBackground.mo72144getSizeNHjbRc());
            }
            AbstractC12212lK.m26516K(drawRangeBackground, j, Offset2, SizeKt.Size(f14, mo69438toPx0680j_43), 0.0f, null, null, 0, 120, null);
        }
    }

    /* renamed from: e */
    public static final void m60656e(StateData stateData, long j) {
    ...
    public static final DateRangePickerState m70355rememberDateRangePickerStatepMw4iz8(@Nullable Long l, @Nullable Long l2, @Nullable Long l3, @Nullable IntRange intRange, int i, @Nullable Composer composer, int i2, int i3) {
        Long l4;
        Long l5;
        Long l6;
        IntRange intRange2;
        ...
        if ((i3 & 16) != 0) {
            i4 = DisplayMode.Companion.m70368getPickerjFl4v0();
        } else {
            i4 = i;
        }
        if (ComposerKt.isTraceInProgress()) {
        ...
        DateRangePickerState dateRangePickerState = (DateRangePickerState) RememberSaveableKt.m71406rememberSaveable(new Object[0], DateRangePickerState.Companion.Saver(), (String) null, (Function0<? extends Object>) new DateRangePickerKt$rememberDateRangePickerState$1(l4, l5, l6, intRange2, i4), composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
