...
public final class SnapFlingBehavior$animateSnap$2 extends Lambda implements Function1<AnimationScope<Float, AnimationVector1D>, Unit> {
    ...
    public final void invoke2(@NotNull AnimationScope<Float, AnimationVector1D> animateTo) {
        ...
        m60527e = this.this$0.m60527e(animateTo.getValue().floatValue(), this.$cancelOffset);
        float f = m60527e - this.$consumedUpToNow.element;
        float scrollBy = this.$this_animateSnap.scrollBy(f);
        if (Math.abs(f - scrollBy) > 0.5f || m60527e != animateTo.getValue().floatValue()) {
