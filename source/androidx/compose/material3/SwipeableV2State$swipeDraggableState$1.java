...
public final class SwipeableV2State$swipeDraggableState$1 implements DraggableState {
    ...
    public SwipeableV2State$swipeDraggableState$1(final SwipeableV2State swipeableV2State) {
        this.f26264b = swipeableV2State;
        this.f26263a = new DragScope() { // from class: androidx.compose.material3.SwipeableV2State$swipeDraggableState$1$dragScope$1
    ...
    public void dispatchRawDelta(float f) {
        this.f26264b.dispatchRawDelta(f);
    }
    ...
    public Object drag(@NotNull MutatePriority mutatePriority, @NotNull Function2<? super DragScope, ? super Continuation<? super Unit>, ? extends Object> function2, @NotNull Continuation<? super Unit> continuation) {
        Object m60485i;
        m60485i = this.f26264b.m60485i(mutatePriority, new SwipeableV2State$swipeDraggableState$1$drag$2(function2, this, null), continuation);
        if (m60485i == AbstractC18812Yf0.getCOROUTINE_SUSPENDED()) {
            return m60485i;
        }
