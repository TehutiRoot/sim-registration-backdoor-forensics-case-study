...
public final class NavigationRailKt$NavigationRailItem$styledLabel$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    @Metadata(m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
    /* renamed from: androidx.compose.material3.NavigationRailKt$NavigationRailItem$styledLabel$1$1$1 */
    /* loaded from: classes2.dex */
    public static final class C33441 extends Lambda implements Function2<Composer, Integer, Unit> {
        final /* synthetic */ int $$dirty;
        final /* synthetic */ Function2<Composer, Integer, Unit> $label;
        ...
        public C33441(TextStyle textStyle, Function2<? super Composer, ? super Integer, Unit> function2, int i) {
            super(2);
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        int i2 = this.$$dirty;
        CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m71725boximpl(invoke$lambda$0(navigationRailItemColors.textColor$material3_release(z, z2, composer, ((i2 >> 15) & 896) | (i2 & 14) | ((i2 >> 9) & 112)))))}, ComposableLambdaKt.composableLambda(composer, -288191647, true, new C33441(fromToken, this.$label, this.$$dirty)), composer, 56);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    }
