...
public final class DatePickerKt$Month$rangeSelectionDrawModifier$1$1 extends Lambda implements Function1<ContentDrawScope, Unit> {
    ...
    public final void invoke2(@NotNull ContentDrawScope drawWithContent) {
        ...
        if (value != null) {
            DateRangePickerKt.m70354drawRangeBackgroundmxwnekA(drawWithContent, value, this.$colors.m70337getDayInSelectionRangeContainerColor0d7_KjU$material3_release());
        }
