...
public final class TooltipKt {
    ...
    /* renamed from: a */
    public static final float f26478a;

    /* renamed from: b */
    public static final float f26479b;

    /* renamed from: c */
    public static final float f26480c = C3641Dp.m73658constructorimpl(40);

    /* renamed from: d */
    public static final float f26481d = C3641Dp.m73658constructorimpl(200);

    /* renamed from: e */
    public static final float f26482e;

    /* renamed from: f */
    public static final float f26483f;

    /* renamed from: g */
    public static final PaddingValues f26484g;

    /* renamed from: h */
    public static final float f26485h;

    /* renamed from: i */
    public static final float f26486i;

    /* renamed from: j */
    public static final float f26487j;

    /* renamed from: k */
    public static final float f26488k;

    /* renamed from: l */
    public static final float f26489l;

    /* renamed from: m */
    public static final float f26490m;

    /* renamed from: n */
    public static final float f26491n;

    static {
        float f = 4;
        f26478a = C3641Dp.m73658constructorimpl(f);
        float f2 = 24;
        f26479b = C3641Dp.m73658constructorimpl(f2);
        float m73658constructorimpl = C3641Dp.m73658constructorimpl(f);
        f26482e = m73658constructorimpl;
        float f3 = 8;
        float m73658constructorimpl2 = C3641Dp.m73658constructorimpl(f3);
        f26483f = m73658constructorimpl2;
        f26484g = PaddingKt.m69523PaddingValuesYgX7TsA(m73658constructorimpl2, m73658constructorimpl);
        f26485h = C3641Dp.m73658constructorimpl(320);
        float f4 = 16;
        f26486i = C3641Dp.m73658constructorimpl(f4);
        f26487j = C3641Dp.m73658constructorimpl(28);
        f26488k = C3641Dp.m73658constructorimpl(f2);
        f26489l = C3641Dp.m73658constructorimpl(f4);
        f26490m = C3641Dp.m73658constructorimpl(36);
        f26491n = C3641Dp.m73658constructorimpl(f3);
    }
    ...
    */
    ...
    /* renamed from: a */
    public static final void m60413a(long j, Function2 function2, Composer composer, int i) {
        int i2;
        int i3;
        int i4;
        ...
        if ((i2 & 91) == 18 && startRestartGroup.getSkipping()) {
            ...
            Modifier padding = PaddingKt.padding(Modifier.Companion, f26484g);
            ...
            CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m71725boximpl(j)), TextKt.getLocalTextStyle().provides(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography(startRestartGroup, 6), PlainTooltipTokens.INSTANCE.getSupportingTextFont()))}, function2, startRestartGroup, (i2 & 112) | 8);
    ...
    /* renamed from: b */
    public static final void m60412b(RichTooltipColors richTooltipColors, Function2 function2, Function2 function22, Function2 function23, Composer composer, int i) {
        int i2;
        ...
        if ((i2 & 5851) == 1170 && startRestartGroup.getSkipping()) {
            ...
            Modifier m69531paddingVpY3zN4$default = PaddingKt.m69531paddingVpY3zN4$default(companion, f26486i, 0.0f, 2, null);
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf = LayoutKt.materializerOf(m69531paddingVpY3zN4$default);
            if (!(startRestartGroup.getApplier() instanceof Applier)) {
                ComposablesKt.invalidApplier();
            }
            startRestartGroup.startReusableNode();
            ...
            if (function22 != null) {
                Modifier m69466paddingFromBaselineVpY3zN4$default = AlignmentLineKt.m69466paddingFromBaselineVpY3zN4$default(companion, f26487j, 0.0f, 2, null);
                startRestartGroup.startReplaceableGroup(733328855);
                ...
                Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf2 = LayoutKt.materializerOf(m69466paddingFromBaselineVpY3zN4$default);
                if (!(startRestartGroup.getApplier() instanceof Applier)) {
                    ComposablesKt.invalidApplier();
                }
                startRestartGroup.startReusableNode();
                ...
                startRestartGroup.startReplaceableGroup(2058660585);
                BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
                CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m71725boximpl(richTooltipColors.m70516getTitleContentColor0d7_KjU())), TextKt.getLocalTextStyle().provides(fromToken2)}, function22, startRestartGroup, 8);
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endNode();
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endReplaceableGroup();
            ...
            startRestartGroup.endReplaceableGroup();
            Modifier m60409e = m60409e(companion, function22 != null, function23 != null);
            startRestartGroup.startReplaceableGroup(733328855);
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf3 = LayoutKt.materializerOf(m60409e);
            if (!(startRestartGroup.getApplier() instanceof Applier)) {
                ComposablesKt.invalidApplier();
            }
            startRestartGroup.startReusableNode();
            ...
            CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m71725boximpl(richTooltipColors.m70515getContentColor0d7_KjU())), TextKt.getLocalTextStyle().provides(fromToken3)}, function2, startRestartGroup, (i2 & 112) | 8);
            startRestartGroup.endReplaceableGroup();
            startRestartGroup.endNode();
            startRestartGroup.endReplaceableGroup();
            startRestartGroup.endReplaceableGroup();
            ...
            if (function23 != null) {
                Modifier m69533paddingqDBjuR0$default = PaddingKt.m69533paddingqDBjuR0$default(SizeKt.m69555requiredHeightInVpY3zN4$default(companion, f26490m, 0.0f, 2, null), 0.0f, 0.0f, 0.0f, f26491n, 7, null);
                startRestartGroup.startReplaceableGroup(733328855);
                ...
                startRestartGroup.startReplaceableGroup(2058660585);
                CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m71725boximpl(richTooltipColors.m70513getActionContentColor0d7_KjU())), TextKt.getLocalTextStyle().provides(fromToken)}, function23, startRestartGroup, 8);
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endNode();
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endReplaceableGroup();
    ...
    /* renamed from: c */
    public static final void m60411c(Function2 function2, PopupPositionProvider popupPositionProvider, Modifier modifier, Shape shape, final TooltipState tooltipState, long j, float f, float f2, Function3 function3, Composer composer, int i) {
        int i2;
        int i3;
        int i4;
        int i5;
        ...
        if ((191739611 & i2) == 38347922 && startRestartGroup.getSkipping()) {
            ...
            final String m70619getStringNWtq28 = Strings_androidKt.m70619getStringNWtq28(companion2.m70617getTooltipLongPressLabeladMyvUU(), startRestartGroup, 6);
            startRestartGroup.startReplaceableGroup(-492369756);
            ...
            if (rememberedValue2 == companion.getEmpty()) {
                rememberedValue2 = new TooltipBoxScope() { // from class: androidx.compose.material3.TooltipKt$TooltipBox$scope$1$1
                    ...
                    public Modifier tooltipAnchor(@NotNull Modifier modifier2) {
                        ...
                        return SemanticsModifierKt.semantics(SuspendingPointerInputFilterKt.pointerInput(modifier2, TooltipState.this, new TooltipKt$TooltipBox$scope$1$1$tooltipAnchor$1(tooltipKt$TooltipBox$scope$1$1$tooltipAnchor$onLongPress$1, null)), true, new TooltipKt$TooltipBox$scope$1$1$tooltipAnchor$2(m70619getStringNWtq28, tooltipKt$TooltipBox$scope$1$1$tooltipAnchor$onLongPress$1));
                    }
                };
            ...
            startRestartGroup.disableReusing();
            Composer m71393constructorimpl = Updater.m71393constructorimpl(startRestartGroup);
            Updater.m71400setimpl(m71393constructorimpl, rememberBoxMeasurePolicy, companion4.getSetMeasurePolicy());
            ...
            if (((Boolean) updateTransition.getCurrentState()).booleanValue() || ((Boolean) updateTransition.getTargetState()).booleanValue()) {
                TooltipPopup_androidKt.TooltipPopup(popupPositionProvider, new TooltipKt$TooltipBox$1$1(tooltipState, coroutineScope), ComposableLambdaKt.composableLambda(startRestartGroup, -442150991, true, new TooltipKt$TooltipBox$1$2(modifier, f2, updateTransition, Strings_androidKt.m70619getStringNWtq28(companion2.m70618getTooltipPaneDescriptionadMyvUU(), startRestartGroup, 6), shape, j, f, function2, i2)), startRestartGroup, ((i2 >> 3) & 14) | 384);
            }
            startRestartGroup.endReplaceableGroup();
    ...
    /* renamed from: d */
    public static final Modifier m60410d(Modifier modifier, Transition transition) {
    ...
    /* renamed from: e */
    public static final Modifier m60409e(Modifier modifier, boolean z, boolean z2) {
        if (!z && !z2) {
            return PaddingKt.m69531paddingVpY3zN4$default(modifier, 0.0f, f26482e, 1, null);
        }
        return PaddingKt.m69533paddingqDBjuR0$default(AlignmentLineKt.m69466paddingFromBaselineVpY3zN4$default(modifier, f26488k, 0.0f, 2, null), 0.0f, 0.0f, 0.0f, f26489l, 7, null);
    }
