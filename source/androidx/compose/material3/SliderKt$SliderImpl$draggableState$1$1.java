...
public final class SliderKt$SliderImpl$draggableState$1$1 extends Lambda implements Function1<Float, Unit> {
    ...
    public final void invoke(float f) {
        ...
        m60539u = SliderKt.m60539u(this.$rawOffset.getValue().floatValue(), this.$tickFractions, min, max);
        m60548l = SliderKt.m60548l(this.$valueRange, min, max, m60539u);
        this.$onValueChangeState.getValue().invoke(Float.valueOf(m60548l));
    }
}
