...
public final class TextFieldImplKt$CommonDecorationBox$3 extends Lambda implements Function7<Float, Color, Color, Float, Float, Composer, Integer, Unit> {
    ...
    public /* bridge */ /* synthetic */ Unit invoke(Float f, Color color, Color color2, Float f2, Float f3, Composer composer, Integer num) {
        m70692invokeeopBjH0(f.floatValue(), color.m71745unboximpl(), color2.m71745unboximpl(), f2.floatValue(), f3.floatValue(), composer, num.intValue());
    ...
    public final void m70692invokeeopBjH0(float f, long j, long j2, float f2, float f3, @Nullable Composer composer, int i) {
        int i2;
        int i3;
        ?? r13;
        ...
        int i10 = this.$$dirty1;
        long m71745unboximpl = textFieldColors.prefixColor$material3_release(z, z2, interactionSource, composer, ((i10 >> 6) & 896) | ((i10 >> 6) & 14) | ((i10 >> 6) & 112) | ((i10 >> 9) & 7168)).getValue().m71745unboximpl();
        Function2<Composer, Integer, Unit> function22 = this.$prefix;
        if (function22 != null && f3 > 0.0f) {
            composableLambda3 = ComposableLambdaKt.composableLambda(composer, 1824482619, r13, new TextFieldImplKt$CommonDecorationBox$3$decoratedPrefix$1(f3, m71745unboximpl, this.$bodyLarge, function22, this.$$dirty));
        } else {
        ...
        int i11 = this.$$dirty1;
        long m71745unboximpl2 = textFieldColors2.suffixColor$material3_release(z3, z4, interactionSource2, composer, ((i11 >> 6) & 896) | ((i11 >> 6) & 14) | ((i11 >> 6) & 112) | ((i11 >> 9) & 7168)).getValue().m71745unboximpl();
        Function2<Composer, Integer, Unit> function23 = this.$suffix;
        if (function23 != null && f3 > 0.0f) {
            composableLambda4 = ComposableLambdaKt.composableLambda(composer, 907456412, r13, new TextFieldImplKt$CommonDecorationBox$3$decoratedSuffix$1(f3, m71745unboximpl2, this.$bodyLarge, function23, this.$$dirty));
        } else {
            composableLambda4 = null;
        }
        String m70619getStringNWtq28 = Strings_androidKt.m70619getStringNWtq28(Strings.Companion.m70594getDefaultErrorMessageadMyvUU(), composer, 6);
        Modifier.Companion companion = Modifier.Companion;
        Object valueOf = Boolean.valueOf(this.$isError);
        boolean z5 = this.$isError;
        composer.startReplaceableGroup(511388516);
        boolean changed = composer.changed(valueOf) | composer.changed(m70619getStringNWtq28);
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new TextFieldImplKt$CommonDecorationBox$3$decorationBoxModifier$1$1(z5, m70619getStringNWtq28);
        ...
        int i12 = this.$$dirty1;
        long m71745unboximpl3 = textFieldColors3.leadingIconColor$material3_release(z6, z7, interactionSource3, composer, ((i12 >> 6) & 14) | ((i12 >> 6) & 112) | ((i12 >> 6) & 896) | ((i12 >> 9) & 7168)).getValue().m71745unboximpl();
        Function2<Composer, Integer, Unit> function24 = this.$leadingIcon;
        if (function24 != null) {
            composableLambda5 = ComposableLambdaKt.composableLambda(composer, 90769583, r13, new TextFieldImplKt$CommonDecorationBox$3$decoratedLeading$1$1(m71745unboximpl3, function24));
        } else {
        ...
        int i13 = this.$$dirty1;
        long m71745unboximpl4 = textFieldColors4.trailingIconColor$material3_release(z8, z9, interactionSource4, composer, ((i13 >> 6) & 14) | ((i13 >> 6) & 112) | ((i13 >> 6) & 896) | ((i13 >> 9) & 7168)).getValue().m71745unboximpl();
        Function2<Composer, Integer, Unit> function25 = this.$trailingIcon;
        if (function25 != null) {
            composableLambda6 = ComposableLambdaKt.composableLambda(composer, 2077796155, r13, new TextFieldImplKt$CommonDecorationBox$3$decoratedTrailing$1$1(m71745unboximpl4, function25));
        } else {
        ...
        int i14 = this.$$dirty1;
        long m71745unboximpl5 = textFieldColors5.supportingTextColor$material3_release(z10, z11, interactionSource5, composer, ((i14 >> 9) & 7168) | ((i14 >> 6) & 14) | ((i14 >> 6) & 112) | ((i14 >> 6) & 896)).getValue().m71745unboximpl();
        Function2<Composer, Integer, Unit> function26 = this.$supportingText;
        if (function26 != null) {
            composableLambda7 = ComposableLambdaKt.composableLambda(composer, -1531019900, true, new TextFieldImplKt$CommonDecorationBox$3$decoratedSupporting$1$1(m71745unboximpl5, this.$bodySmall, function26));
        } else {
