...
public final class TextFieldImplKt$CommonDecorationBox$3$decoratedSuffix$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public TextFieldImplKt$CommonDecorationBox$3$decoratedSuffix$1(float f, long j, TextStyle textStyle, Function2<? super Composer, ? super Integer, Unit> function2, int i) {
        super(2);
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(907456412, i, -1, "androidx.compose.material3.CommonDecorationBox.<anonymous>.<anonymous> (TextFieldImpl.kt:163)");
        }
        ...
        TextFieldImplKt.m70691DecorationKTwxG1Y(j, textStyle, function2, composer, (i2 >> 21) & 896, 0);
