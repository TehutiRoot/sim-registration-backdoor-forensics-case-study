...
public final class SurfaceKt$Surface$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    /* loaded from: classes2.dex */
    public static final class C33781 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
        public static final C33781 INSTANCE = new C33781();
    ...
    @Metadata(m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
    @DebugMetadata(m28801c = "androidx.compose.material3.SurfaceKt$Surface$1$2", m28800f = "Surface.kt", m28799i = {}, m28798l = {}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
    /* renamed from: androidx.compose.material3.SurfaceKt$Surface$1$2 */
    /* loaded from: classes2.dex */
    public static final class C33792 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        int label;

        public C33792(Continuation<? super C33792> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C33792(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        @Nullable
        public final Object invoke(@NotNull PointerInputScope pointerInputScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C33792) create(pointerInputScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        m60510b = SurfaceKt.m60510b(this.$color, this.$absoluteElevation, composer, (this.$$changed >> 6) & 14);
        m60511a = SurfaceKt.m60511a(modifier, shape, m60510b, this.$border, this.$shadowElevation);
        Modifier pointerInput = SuspendingPointerInputFilterKt.pointerInput(SemanticsModifierKt.semantics(m60511a, false, C33781.INSTANCE), Unit.INSTANCE, new C33792(null));
