...
public final class ListItemKt$ListItem$decoratedTrailingContent$1$1 extends Lambda implements Function3<RowScope, Composer, Integer, Unit> {
    ...
    public final void invoke(@NotNull RowScope rowScope, @Nullable Composer composer, int i) {
        ...
        ListItemKt.m60627d(rowScope, this.$colors.trailingIconColor$material3_release(true, composer, ((this.$$dirty >> 15) & 112) | 6).getValue().m71745unboximpl(), ListItemType.m60622e(this.$listItemType, ListItemType.f25858a.m70453getThreeLineAlXitO8()), this.$it, composer, i & 14);
        if (ComposerKt.isTraceInProgress()) {
