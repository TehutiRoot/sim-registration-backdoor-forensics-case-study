...
public final class BottomSheetScaffoldKt$BottomSheetScaffold$1 extends Lambda implements Function3<Integer, Composer, Integer, Unit> {
    ...
    public final void invoke(int i, @Nullable Composer composer, int i2) {
        ...
        int i4 = this.$$dirty;
        BottomSheetScaffoldKt.m60694c(this.$scaffoldState.getBottomSheetState(), this.$sheetPeekHeight, this.$sheetSwipeEnabled, i, shape, j, j2, f, f2, function2, function3, composer, ((i4 >> 6) & 112) | ((this.$$dirty1 << 6) & 896) | (i4 & 57344) | (i4 & 458752) | (i4 & 3670016) | (i4 & 29360128) | (i4 & 234881024) | (i4 & 1879048192), i4 & 14);
        if (ComposerKt.isTraceInProgress()) {
