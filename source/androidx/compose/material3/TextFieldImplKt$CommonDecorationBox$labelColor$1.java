...
public final class TextFieldImplKt$CommonDecorationBox$labelColor$1 extends Lambda implements Function3<InputPhase, Composer, Integer, Color> {
    ...
    public /* bridge */ /* synthetic */ Color invoke(InputPhase inputPhase, Composer composer, Integer num) {
        return Color.m71725boximpl(m70694invokeXeAY9LY(inputPhase, composer, num.intValue()));
    }

    @Composable
    /* renamed from: invoke-XeAY9LY  reason: not valid java name */
    public final long m70694invokeXeAY9LY(@NotNull InputPhase it, @Nullable Composer composer, int i) {
        ...
        int i2 = this.$$dirty1;
        long m71745unboximpl = textFieldColors.labelColor$material3_release(z, z2, interactionSource, composer, ((i2 >> 6) & 14) | ((i2 >> 6) & 112) | ((i2 >> 6) & 896) | ((i2 >> 9) & 7168)).getValue().m71745unboximpl();
        if (ComposerKt.isTraceInProgress()) {
