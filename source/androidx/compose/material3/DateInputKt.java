...
public final class DateInputKt {
    ...
    /* renamed from: a */
    public static final PaddingValues f25683a;

    /* renamed from: b */
    public static final float f25684b = C3641Dp.m73658constructorimpl(16);

    static {
        float f = 24;
        f25683a = PaddingKt.m69526PaddingValuesa9UjIt4$default(C3641Dp.m73658constructorimpl(f), C3641Dp.m73658constructorimpl(10), C3641Dp.m73658constructorimpl(f), 0.0f, 8, null);
    }
    ...
    public static final void DateInputContent(@NotNull StateData stateData, @NotNull DatePickerFormatter dateFormatter, @NotNull Function1<? super Long, Boolean> dateValidator, @Nullable Composer composer, int i) {
        ...
        if ((i7 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            if (!changed2 && rememberedValue2 != Composer.Companion.getEmpty()) {
                ...
                i3 = 6;
                dateInputFormat = dateInputFormat2;
                DateInputValidator dateInputValidator = new DateInputValidator(stateData, dateInputFormat2, dateFormatter, dateValidator, m70619getStringNWtq28, m70619getStringNWtq282, m70619getStringNWtq283, "");
            ...
            String m70619getStringNWtq284 = Strings_androidKt.m70619getStringNWtq28(companion.m70568getDateInputLabeladMyvUU(), startRestartGroup, i3);
            Modifier padding = PaddingKt.padding(SizeKt.fillMaxWidth$default(Modifier.Companion, 0.0f, 1, null), f25683a);
            ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(startRestartGroup, -438341159, true, new DateInputKt$DateInputContent$1(m70619getStringNWtq284, upperCase));
            ...
            startRestartGroup.endReplaceableGroup();
            composer2 = startRestartGroup;
            m70334DateInputTextFieldzm97o8M(padding, composableLambda, composableLambda2, stateData, value, (Function1) rememberedValue3, InputIdentifier.Companion.m70442getSingleDateInputJ2x2o4M(), dateInputValidator2, dateInputFormat, defaultLocale, startRestartGroup, ((i7 << 9) & 7168) | 1075315126);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m70334DateInputTextFieldzm97o8M(@NotNull Modifier modifier, @Nullable Function2<? super Composer, ? super Integer, Unit> function2, @Nullable Function2<? super Composer, ? super Integer, Unit> function22, @NotNull StateData stateData, @Nullable CalendarDate calendarDate, @NotNull Function1<? super CalendarDate, Unit> onDateChanged, int i, @NotNull DateInputValidator dateInputValidator, @NotNull DateInputFormat dateInputFormat, @NotNull Locale locale, @Nullable Composer composer, int i2) {
        ...
        MutableState mutableState = (MutableState) RememberSaveableKt.m71406rememberSaveable(new Object[0], (Saver<Object, ? extends Object>) null, (String) null, (Function0<? extends Object>) DateInputKt$DateInputTextField$errorText$1.INSTANCE, startRestartGroup, 3080, 6);
        ...
        TextFieldValue m60676a = m60676a(rememberSaveable);
        ...
        if (!AbstractC20204hN1.isBlank((CharSequence) mutableState.getValue())) {
            f = C3641Dp.m73658constructorimpl(0);
        } else {
            f = f25684b;
        }
        Modifier m69533paddingqDBjuR0$default = PaddingKt.m69533paddingqDBjuR0$default(modifier, 0.0f, 0.0f, 0.0f, f, 7, null);
        startRestartGroup.startReplaceableGroup(1157296644);
        ...
        startRestartGroup.endReplaceableGroup();
        OutlinedTextFieldKt.OutlinedTextField(m60676a, (Function1<? super TextFieldValue, Unit>) dateInputKt$DateInputTextField$1, SemanticsModifierKt.semantics$default(m69533paddingqDBjuR0$default, false, (Function1) rememberedValue, 1, null), false, false, (TextStyle) null, function2, function22, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda(startRestartGroup, 785795078, true, new DateInputKt$DateInputTextField$3(mutableState)), !AbstractC20204hN1.isBlank((CharSequence) mutableState.getValue()), (VisualTransformation) new DateVisualTransformation(dateInputFormat), new KeyboardOptions(0, false, KeyboardType.Companion.m73414getNumberPjHm6EE(), ImeAction.Companion.m73366getDoneeUduSuo(), 1, null), (KeyboardActions) null, true, 0, 0, (MutableInteractionSource) null, (Shape) null, (TextFieldColors) null, startRestartGroup, (i2 << 15) & 33030144, 12779904, 0, 8195896);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    ...
    /* renamed from: a */
    public static final TextFieldValue m60676a(MutableState mutableState) {
        return (TextFieldValue) mutableState.getValue();
    }

    /* renamed from: b */
    public static final void m60675b(MutableState mutableState, TextFieldValue textFieldValue) {
