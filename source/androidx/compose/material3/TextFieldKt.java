...
public final class TextFieldKt {
    ...
    /* JADX WARN: Removed duplicated region for block: B:361:0x0686  */
    /* JADX WARN: Removed duplicated region for block: B:366:0x06ba  */
    ...
    */
    public static final void TextField(@org.jetbrains.annotations.NotNull java.lang.String r124, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function1<? super java.lang.String, kotlin.Unit> r125, @org.jetbrains.annotations.Nullable androidx.compose.p003ui.Modifier r126, boolean r127, boolean r128, @org.jetbrains.annotations.Nullable androidx.compose.p003ui.text.TextStyle r129, @org.jetbrains.annotations.Nullable kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r130, @org.jetbrains.annotations.Nullable kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r131, @org.jetbrains.annotations.Nullable kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r132, @org.jetbrains.annotations.Nullable kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r133, @org.jetbrains.annotations.Nullable kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r134, @org.jetbrains.annotations.Nullable kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r135, @org.jetbrains.annotations.Nullable kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r136, boolean r137, @org.jetbrains.annotations.Nullable androidx.compose.p003ui.text.input.VisualTransformation r138, @org.jetbrains.annotations.Nullable androidx.compose.foundation.text.KeyboardOptions r139, @org.jetbrains.annotations.Nullable androidx.compose.foundation.text.KeyboardActions r140, boolean r141, int r142, int r143, @org.jetbrains.annotations.Nullable androidx.compose.foundation.interaction.MutableInteractionSource r144, @org.jetbrains.annotations.Nullable androidx.compose.p003ui.graphics.Shape r145, @org.jetbrains.annotations.Nullable androidx.compose.material3.TextFieldColors r146, @org.jetbrains.annotations.Nullable androidx.compose.runtime.Composer r147, int r148, int r149, int r150, int r151) {
        /*
    ...
    public static final void TextFieldLayout(@NotNull Modifier modifier, @NotNull Function2<? super Composer, ? super Integer, Unit> textField, @Nullable Function2<? super Composer, ? super Integer, Unit> function2, @Nullable Function3<? super Modifier, ? super Composer, ? super Integer, Unit> function3, @Nullable Function2<? super Composer, ? super Integer, Unit> function22, @Nullable Function2<? super Composer, ? super Integer, Unit> function23, @Nullable Function2<? super Composer, ? super Integer, Unit> function24, @Nullable Function2<? super Composer, ? super Integer, Unit> function25, boolean z, float f, @NotNull Function2<? super Composer, ? super Integer, Unit> container, @Nullable Function2<? super Composer, ? super Integer, Unit> function26, @NotNull PaddingValues paddingValues, @Nullable Composer composer, int i, int i2) {
        ...
        if ((1879048192 & i) == 0) {
            i3 |= startRestartGroup.changed(f) ? PKIFailureInfo.duplicateCertReq : 268435456;
        }
        int i6 = i3;
        if ((i2 & 14) == 0) {
        ...
        if ((i6 & 1533916891) == 306783378 && (i7 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1830307184, i6, i7, "androidx.compose.material3.TextFieldLayout (TextField.kt:497)");
            }
            ...
            container.invoke(startRestartGroup, Integer.valueOf(i7 & 14));
            ...
            if (function23 != null) {
                calculateEndPadding = C3641Dp.m73658constructorimpl(AbstractC11719c.coerceAtLeast(C3641Dp.m73658constructorimpl(calculateEndPadding - TextFieldImplKt.getHorizontalIconPadding()), C3641Dp.m73658constructorimpl(i5)));
            }
            ...
            if (function24 != null) {
                ...
                function24.invoke(startRestartGroup, Integer.valueOf((i6 >> 18) & 14));
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endNode();
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endReplaceableGroup();
            ...
            if (function25 != null) {
                ...
                function25.invoke(startRestartGroup, Integer.valueOf((i6 >> 21) & 14));
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endNode();
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endReplaceableGroup();
            ...
            if (function2 != null) {
                ...
                Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf6 = LayoutKt.materializerOf(m69533paddingqDBjuR0$default3);
                if (!(startRestartGroup.getApplier() instanceof Applier)) {
                    ComposablesKt.invalidApplier();
                }
                startRestartGroup.startReusableNode();
            ...
            Modifier m69533paddingqDBjuR0$default4 = PaddingKt.m69533paddingqDBjuR0$default(SizeKt.wrapContentHeight$default(SizeKt.m69552heightInVpY3zN4$default(companion2, TextFieldImplKt.getMinTextLineHeight(), 0.0f, 2, null), null, false, 3, null), function24 == null ? f3 : C3641Dp.m73658constructorimpl(0), 0.0f, function25 == null ? f2 : C3641Dp.m73658constructorimpl(0), 0.0f, 10, null);
            startRestartGroup.startReplaceableGroup(-95269212);
            if (function3 != null) {
                function3.invoke(LayoutIdKt.layoutId(companion2, "Hint").then(m69533paddingqDBjuR0$default4), startRestartGroup, Integer.valueOf((i6 >> 6) & 112));
            }
            startRestartGroup.endReplaceableGroup();
            Modifier then3 = LayoutIdKt.layoutId(companion2, "TextField").then(m69533paddingqDBjuR0$default4);
            startRestartGroup.startReplaceableGroup(733328855);
            ...
            if (function26 != null) {
                ...
                startRestartGroup.startReplaceableGroup(2058660585);
                function26.invoke(startRestartGroup, Integer.valueOf((i7 >> 3) & 14));
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endNode();
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endReplaceableGroup();
    ...
    /* renamed from: a */
    public static final int m60462a(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, boolean z, long j, float f, PaddingValues paddingValues) {
        boolean z2;
        ...
        if (z2 && !z) {
            m73658constructorimpl = C3641Dp.m73658constructorimpl(TextFieldImplKt.getTextFieldPadding() * 2);
        } else {
            m73658constructorimpl = C3641Dp.m73658constructorimpl(paddingValues.mo69159calculateTopPaddingD9Ej5fM() + paddingValues.mo69156calculateBottomPaddingD9Ej5fM());
        }
        float f2 = f * m73658constructorimpl;
        if (z2 && z) {
            f2 += i2;
            max = Math.max(i, i7);
        } else {
        ...
        return Math.max(Constraints.m73627getMinHeightimpl(j), AbstractC16931vu.maxOf(i3, i4, i5, i6, AbstractC21140mr0.roundToInt(f2 + max)) + i8);
    }

    /* renamed from: b */
    public static final int m60461b(int i, int i2, int i3, int i4, int i5, int i6, int i7, long j) {
        int i8 = i3 + i4;
        return Math.max(i + Math.max(i5 + i8, Math.max(i7 + i8, i6)) + i2, Constraints.m73628getMinWidthimpl(j));
    }

    /* renamed from: c */
    public static final void m60460c(Placeable.PlacementScope placementScope, int i, int i2, Placeable placeable, Placeable placeable2, Placeable placeable3, Placeable placeable4, Placeable placeable5, Placeable placeable6, Placeable placeable7, Placeable placeable8, Placeable placeable9, boolean z, int i3, int i4, float f, float f2) {
        int roundToInt;
    ...
    /* renamed from: d */
    public static final void m60459d(Placeable.PlacementScope placementScope, int i, int i2, Placeable placeable, Placeable placeable2, Placeable placeable3, Placeable placeable4, Placeable placeable5, Placeable placeable6, Placeable placeable7, Placeable placeable8, boolean z, float f, PaddingValues paddingValues) {
        Placeable.PlacementScope.m72850place70tqf50$default(placementScope, placeable7, IntOffset.Companion.m73786getZeronOccac(), 0.0f, 2, null);
        ...
        if (placeable5 != null) {
            Placeable.PlacementScope.placeRelative$default(placementScope, placeable5, TextFieldImplKt.widthOrZero(placeable3), m60458e(z, heightOrZero, roundToInt, placeable5), 0.0f, 4, null);
        }
        if (placeable6 != null) {
            Placeable.PlacementScope.placeRelative$default(placementScope, placeable6, (i - TextFieldImplKt.widthOrZero(placeable4)) - placeable6.getWidth(), m60458e(z, heightOrZero, roundToInt, placeable6), 0.0f, 4, null);
        }
        int widthOrZero = TextFieldImplKt.widthOrZero(placeable3) + TextFieldImplKt.widthOrZero(placeable5);
        Placeable.PlacementScope.placeRelative$default(placementScope, placeable, widthOrZero, m60458e(z, heightOrZero, roundToInt, placeable), 0.0f, 4, null);
        if (placeable2 != null) {
            Placeable.PlacementScope.placeRelative$default(placementScope, placeable2, widthOrZero, m60458e(z, heightOrZero, roundToInt, placeable2), 0.0f, 4, null);
        }
        if (placeable8 != null) {
    ...
    /* renamed from: e */
    public static final int m60458e(boolean z, int i, int i2, Placeable placeable) {
        if (z) {
            return Alignment.Companion.getCenterVertically().align(placeable.getHeight(), i);
        }
        return i2;
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final void TextField(@org.jetbrains.annotations.NotNull androidx.compose.p003ui.text.input.TextFieldValue r124, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function1<? super androidx.compose.p003ui.text.input.TextFieldValue, kotlin.Unit> r125, @org.jetbrains.annotations.Nullable androidx.compose.p003ui.Modifier r126, boolean r127, boolean r128, @org.jetbrains.annotations.Nullable androidx.compose.p003ui.text.TextStyle r129, @org.jetbrains.annotations.Nullable kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r130, @org.jetbrains.annotations.Nullable kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r131, @org.jetbrains.annotations.Nullable kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r132, @org.jetbrains.annotations.Nullable kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r133, @org.jetbrains.annotations.Nullable kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r134, @org.jetbrains.annotations.Nullable kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r135, @org.jetbrains.annotations.Nullable kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r136, boolean r137, @org.jetbrains.annotations.Nullable androidx.compose.p003ui.text.input.VisualTransformation r138, @org.jetbrains.annotations.Nullable androidx.compose.foundation.text.KeyboardOptions r139, @org.jetbrains.annotations.Nullable androidx.compose.foundation.text.KeyboardActions r140, boolean r141, int r142, int r143, @org.jetbrains.annotations.Nullable androidx.compose.foundation.interaction.MutableInteractionSource r144, @org.jetbrains.annotations.Nullable androidx.compose.p003ui.graphics.Shape r145, @org.jetbrains.annotations.Nullable androidx.compose.material3.TextFieldColors r146, @org.jetbrains.annotations.Nullable androidx.compose.runtime.Composer r147, int r148, int r149, int r150, int r151) {
        /*
            Method dump skipped, instructions count: 1752
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final /* synthetic */ void TextField(java.lang.String r121, kotlin.jvm.functions.Function1 r122, androidx.compose.p003ui.Modifier r123, boolean r124, boolean r125, androidx.compose.p003ui.text.TextStyle r126, kotlin.jvm.functions.Function2 r127, kotlin.jvm.functions.Function2 r128, kotlin.jvm.functions.Function2 r129, kotlin.jvm.functions.Function2 r130, kotlin.jvm.functions.Function2 r131, boolean r132, androidx.compose.p003ui.text.input.VisualTransformation r133, androidx.compose.foundation.text.KeyboardOptions r134, androidx.compose.foundation.text.KeyboardActions r135, boolean r136, int r137, int r138, androidx.compose.foundation.interaction.MutableInteractionSource r139, androidx.compose.p003ui.graphics.Shape r140, androidx.compose.material3.TextFieldColors r141, androidx.compose.runtime.Composer r142, int r143, int r144, int r145, int r146) {
        /*
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final /* synthetic */ void TextField(androidx.compose.p003ui.text.input.TextFieldValue r121, kotlin.jvm.functions.Function1 r122, androidx.compose.p003ui.Modifier r123, boolean r124, boolean r125, androidx.compose.p003ui.text.TextStyle r126, kotlin.jvm.functions.Function2 r127, kotlin.jvm.functions.Function2 r128, kotlin.jvm.functions.Function2 r129, kotlin.jvm.functions.Function2 r130, kotlin.jvm.functions.Function2 r131, boolean r132, androidx.compose.p003ui.text.input.VisualTransformation r133, androidx.compose.foundation.text.KeyboardOptions r134, androidx.compose.foundation.text.KeyboardActions r135, boolean r136, int r137, int r138, androidx.compose.foundation.interaction.MutableInteractionSource r139, androidx.compose.p003ui.graphics.Shape r140, androidx.compose.material3.TextFieldColors r141, androidx.compose.runtime.Composer r142, int r143, int r144, int r145, int r146) {
        /*
            Method dump skipped, instructions count: 1432
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
