...
@Metadata(m28851d1 = {"\u0000\b\n\u0002\b\u0003\n\u0002\u0018\u0002\u0010\u0000\u001a\u0002H\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0001*\u00020\u0003H\u008a@"}, m28850d2 = {"<anonymous>", "R", "T", "Lkotlinx/coroutines/CoroutineScope;"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
@DebugMetadata(m28801c = "androidx.compose.material3.InternalMutatorMutex$mutateWith$2", m28800f = "InternalMutatorMutex.kt", m28799i = {0, 0, 1, 1}, m28798l = {177, 138}, m28797m = "invokeSuspend", m28796n = {"mutator", "$this$withLock_u24default$iv", "mutator", "$this$withLock_u24default$iv"}, m28795s = {"L$0", "L$1", "L$0", "L$1"})
...
public final class InternalMutatorMutex$mutateWith$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super R>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        Function2 function2;
        Object obj2;
        InternalMutatorMutex.C3306a c3306a;
        InternalMutatorMutex internalMutatorMutex;
        InternalMutatorMutex.C3306a c3306a2;
        Throwable th2;
                ...
                if (r1 != 0) {
                    if (r1 != 1) {
                        if (r1 == 2) {
                            ...
                            c3306a2 = (InternalMutatorMutex.C3306a) this.L$0;
                            try {
                                ResultKt.throwOnFailure(obj);
                                atomicReference2 = internalMutatorMutex2.f25835a;
                                AbstractC17300An1.m69050a(atomicReference2, c3306a2, null);
                                mutex2.unlock(null);
                                return obj;
                            } catch (Throwable th3) {
                                th2 = th3;
                                atomicReference = internalMutatorMutex2.f25835a;
                                AbstractC17300An1.m69050a(atomicReference, c3306a2, null);
                                throw th2;
                            }
                        }
                    ...
                    c3306a = (InternalMutatorMutex.C3306a) this.L$0;
                    ResultKt.throwOnFailure(obj);
                    ...
                    InternalMutatorMutex.C3306a c3306a3 = new InternalMutatorMutex.C3306a(mutatePriority, (Job) element);
                    this.this$0.m60637a(c3306a3);
                    mutex = this.this$0.f25836b;
