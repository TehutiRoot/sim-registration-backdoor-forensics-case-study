...
public final class DismissState {
    ...
    /* renamed from: a */
    public final SwipeableV2State f25745a;

    @Metadata(m28851d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n¢\u0006\u0004\b\u0004\u0010\u0005"}, m28850d2 = {"<anonymous>", "", "it", "Landroidx/compose/material3/DismissValue;", "invoke", "(Landroidx/compose/material3/DismissValue;)Ljava/lang/Boolean;"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
    /* renamed from: androidx.compose.material3.DismissState$1 */
    /* loaded from: classes2.dex */
    public static final class C32831 extends Lambda implements Function1<DismissValue, Boolean> {
        public static final C32831 INSTANCE = new C32831();
    ...
    @Metadata(m28851d1 = {"\u0000>\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0007\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002JT\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00060\u00042\u0012\u0010\u0007\u001a\u000e\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\t0\b2,\u0010\n\u001a(\u0012\u0004\u0012\u00020\f\u0012\u0013\u0012\u00110\r¢\u0006\f\b\u000e\u0012\b\b\u000f\u0012\u0004\b\b(\u0010\u0012\u0004\u0012\u00020\r0\u000b¢\u0006\u0002\b\u0011¨\u0006\u0012"}, m28850d2 = {"Landroidx/compose/material3/DismissState$Companion;", "", "()V", "Saver", "Landroidx/compose/runtime/saveable/Saver;", "Landroidx/compose/material3/DismissState;", "Landroidx/compose/material3/DismissValue;", "confirmValueChange", "Lkotlin/Function1;", "", "positionalThreshold", "Lkotlin/Function2;", "Landroidx/compose/ui/unit/Density;", "", "Lkotlin/ParameterName;", "name", "totalDistance", "Lkotlin/ExtensionFunctionType;", "material3_release"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    /* loaded from: classes2.dex */
    ...
    public DismissState(@NotNull DismissValue initialValue, @NotNull Function1<? super DismissValue, Boolean> confirmValueChange, @NotNull Function2<? super Density, ? super Float, Float> positionalThreshold) {
        ...
        Intrinsics.checkNotNullParameter(confirmValueChange, "confirmValueChange");
        Intrinsics.checkNotNullParameter(positionalThreshold, "positionalThreshold");
        f = SwipeToDismissKt.f26212a;
        this.f25745a = new SwipeableV2State(initialValue, null, confirmValueChange, positionalThreshold, f, 2, null);
    }
    ...
    public final Object dismiss(@NotNull DismissDirection dismissDirection, @NotNull Continuation<? super Unit> continuation) {
        ...
        Object animateTo$default = SwipeableV2State.animateTo$default(this.f25745a, dismissValue, 0.0f, continuation, 2, null);
    ...
    public final DismissValue getCurrentValue() {
        return (DismissValue) this.f25745a.getCurrentValue();
    }
    ...
    public final Float getOffset$material3_release() {
        return this.f25745a.getOffset();
    }

    public final float getProgress() {
        return this.f25745a.getProgress();
    }
    ...
    public final DismissValue getTargetValue() {
        return (DismissValue) this.f25745a.getTargetValue();
    }
    ...
    public final float requireOffset() {
        return this.f25745a.requireOffset();
    }

    @Nullable
    public final Object reset(@NotNull Continuation<? super Unit> continuation) {
        Object animateTo$default = SwipeableV2State.animateTo$default(this.f25745a, DismissValue.Default, 0.0f, continuation, 2, null);
        if (animateTo$default == AbstractC18812Yf0.getCOROUTINE_SUSPENDED()) {
            return animateTo$default;
        }
        return Unit.INSTANCE;
    ...
    public final Object snapTo(@NotNull DismissValue dismissValue, @NotNull Continuation<? super Unit> continuation) {
        Object snapTo = this.f25745a.snapTo(dismissValue, continuation);
    ...
    public /* synthetic */ DismissState(DismissValue dismissValue, Function1 function1, Function2<Density, Float, Float> function2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(dismissValue, (i & 2) != 0 ? C32831.INSTANCE : function1, (i & 4) != 0 ? SwipeToDismissDefaults.INSTANCE.getFixedPositionalThreshold() : function2);
    }
}
