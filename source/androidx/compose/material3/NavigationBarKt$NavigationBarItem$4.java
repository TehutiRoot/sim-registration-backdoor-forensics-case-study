...
public final class NavigationBarKt$NavigationBarItem$4 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public NavigationBarKt$NavigationBarItem$4(RowScope rowScope, boolean z, Function0<Unit> function0, Function2<? super Composer, ? super Integer, Unit> function2, Modifier modifier, boolean z2, Function2<? super Composer, ? super Integer, Unit> function22, boolean z3, NavigationBarItemColors navigationBarItemColors, MutableInteractionSource mutableInteractionSource, int i, int i2) {
        super(2);
