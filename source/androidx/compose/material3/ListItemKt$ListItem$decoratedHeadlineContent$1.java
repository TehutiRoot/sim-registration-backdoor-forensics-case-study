...
public final class ListItemKt$ListItem$decoratedHeadlineContent$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        ListItemKt.m60628c(this.$colors.headlineColor$material3_release(true, composer, ((this.$$dirty >> 15) & 112) | 6).getValue().m71745unboximpl(), ListTokens.INSTANCE.getListItemLabelTextFont(), this.$headlineContent, composer, ((this.$$dirty << 6) & 896) | 48);
        if (ComposerKt.isTraceInProgress()) {
