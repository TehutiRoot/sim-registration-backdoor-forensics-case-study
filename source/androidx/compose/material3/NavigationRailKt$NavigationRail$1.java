...
public final class NavigationRailKt$NavigationRail$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        Modifier selectableGroup = SelectableGroupKt.selectableGroup(PaddingKt.m69531paddingVpY3zN4$default(SizeKt.m69571widthInVpY3zN4$default(WindowInsetsPaddingKt.windowInsetsPadding(SizeKt.fillMaxHeight$default(companion, 0.0f, 1, null), this.$windowInsets), NavigationRailTokens.INSTANCE.m71117getContainerWidthD9Ej5fM(), 0.0f, 2, null), 0.0f, NavigationRailKt.getNavigationRailVerticalPadding(), 1, null));
        Alignment.Horizontal centerHorizontally = Alignment.Companion.getCenterHorizontally();
        Arrangement.HorizontalOrVertical m69478spacedBy0680j_4 = Arrangement.INSTANCE.m69478spacedBy0680j_4(NavigationRailKt.getNavigationRailVerticalPadding());
        ...
        MeasurePolicy columnMeasurePolicy = ColumnKt.columnMeasurePolicy(m69478spacedBy0680j_4, centerHorizontally, composer, 54);
        ...
        if (function3 != null) {
            ...
            f = NavigationRailKt.f25923b;
            SpacerKt.Spacer(SizeKt.m69550height3ABfNKs(companion, f), composer, 6);
        }
