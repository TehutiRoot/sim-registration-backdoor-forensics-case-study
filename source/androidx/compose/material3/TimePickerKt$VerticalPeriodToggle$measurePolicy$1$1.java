...
public final class TimePickerKt$VerticalPeriodToggle$measurePolicy$1$1 implements MeasurePolicy {
    ...
    /* renamed from: a */
    public static final TimePickerKt$VerticalPeriodToggle$measurePolicy$1$1 f26397a = new TimePickerKt$VerticalPeriodToggle$measurePolicy$1$1();
    ...
    public final MeasureResult mo69194measure3p2s80s(MeasureScope MeasurePolicy, List measurables, long j) {
        ...
        for (Measurable measurable : list) {
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "Spacer")) {
                Placeable mo72811measureBRTryo0 = measurable.mo72811measureBRTryo0(Constraints.m73618copyZbe2FdA$default(j, 0, 0, 0, AbstractC21140mr0.roundToInt(MeasurePolicy.mo69438toPx0680j_4(TimePickerTokens.INSTANCE.m71307getPeriodSelectorOutlineWidthD9Ej5fM())), 3, null));
                ...
                for (Measurable measurable2 : arrayList) {
                    arrayList2.add(measurable2.mo72811measureBRTryo0(Constraints.m73618copyZbe2FdA$default(j, 0, 0, 0, Constraints.m73625getMaxHeightimpl(j) / 2, 3, null)));
                }
                return MeasureScope.CC.m59532q(MeasurePolicy, Constraints.m73626getMaxWidthimpl(j), Constraints.m73625getMaxHeightimpl(j), null, new TimePickerKt$VerticalPeriodToggle$measurePolicy$1$1$measure$1(arrayList2, mo72811measureBRTryo0), 4, null);
            }
        }
