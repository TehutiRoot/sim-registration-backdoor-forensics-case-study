...
public final class SliderKt$sliderSemantics$1 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    ...
    /* loaded from: classes2.dex */
    public static final class C33661 extends Lambda implements Function1<Float, Boolean> {
        final /* synthetic */ float $coerced;
        final /* synthetic */ Function1<Float, Unit> $onValueChange;
        final /* synthetic */ Function0<Unit> $onValueChangeFinished;
        final /* synthetic */ int $steps;
        ...
        public C33661(ClosedFloatingPointRange<Float> closedFloatingPointRange, int i, float f, Function1<? super Float, Unit> function1, Function0<Unit> function0) {
            super(1);
    ...
    public final void invoke2(@NotNull SemanticsPropertyReceiver semantics) {
        ...
        SemanticsPropertiesKt.setProgress$default(semantics, null, new C33661(this.$valueRange, this.$steps, this.$coerced, this.$onValueChange, this.$onValueChangeFinished), 1, null);
    }
}
