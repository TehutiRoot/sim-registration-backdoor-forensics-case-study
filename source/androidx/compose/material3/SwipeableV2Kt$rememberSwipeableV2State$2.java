...
public final class SwipeableV2Kt$rememberSwipeableV2State$2 extends Lambda implements Function0<SwipeableV2State<T>> {
    ...
    public final SwipeableV2State<T> invoke() {
        ...
        return new SwipeableV2State<>(obj, animationSpec, function1, swipeableV2Defaults.getPositionalThreshold(), swipeableV2Defaults.m70641getVelocityThresholdD9Ej5fM(), null);
    }
}
