...
@DebugMetadata(m28801c = "androidx.compose.material3.RangeSliderLogic$captureThumb$1", m28800f = "Slider.kt", m28799i = {}, m28798l = {1333}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
...
public final class RangeSliderLogic$captureThumb$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i != 0) {
            ...
            ResultKt.throwOnFailure(obj);
            MutableInteractionSource m60581a = this.this$0.m60581a(this.$draggingStart);
            Interaction interaction = this.$interaction;
            this.label = 1;
            if (m60581a.emit(interaction, this) == coroutine_suspended) {
