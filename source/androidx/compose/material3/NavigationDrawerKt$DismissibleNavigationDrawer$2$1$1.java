...
public final class NavigationDrawerKt$DismissibleNavigationDrawer$2$1$1 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    ...
    /* loaded from: classes2.dex */
    public static final class C33351 extends Lambda implements Function0<Boolean> {
        final /* synthetic */ DrawerState $drawerState;
        final /* synthetic */ CoroutineScope $scope;

        @Metadata(m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
        @DebugMetadata(m28801c = "androidx.compose.material3.NavigationDrawerKt$DismissibleNavigationDrawer$2$1$1$1$1", m28800f = "NavigationDrawer.kt", m28799i = {}, m28798l = {383}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
        /* renamed from: androidx.compose.material3.NavigationDrawerKt$DismissibleNavigationDrawer$2$1$1$1$1 */
        /* loaded from: classes2.dex */
        public static final class C33361 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            final /* synthetic */ DrawerState $drawerState;
            int label;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C33361(DrawerState drawerState, Continuation<? super C33361> continuation) {
            ...
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                return new C33361(this.$drawerState, continuation);
            }
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C33351(DrawerState drawerState, CoroutineScope coroutineScope) {
            super(0);
            this.$drawerState = drawerState;
        ...
        public final Boolean invoke() {
            if (this.$drawerState.getSwipeableState$material3_release().getConfirmStateChange$material3_release().invoke(DrawerValue.Closed).booleanValue()) {
                AbstractC1552Vc.m65753e(this.$scope, null, null, new C33361(this.$drawerState, null), 3, null);
            }
            return Boolean.TRUE;
        }
    }
    ...
    public final void invoke2(@NotNull SemanticsPropertyReceiver semantics) {
        ...
        if (this.$drawerState.isOpen()) {
            SemanticsPropertiesKt.dismiss$default(semantics, null, new C33351(this.$drawerState, this.$scope), 1, null);
        }
    }
}
