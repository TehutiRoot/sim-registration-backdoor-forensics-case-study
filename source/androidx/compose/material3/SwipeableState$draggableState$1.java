...
public final class SwipeableState$draggableState$1 extends Lambda implements Function1<Float, Unit> {
    ...
    public final void invoke(float f) {
        ...
        mutableState = this.this$0.f26222g;
        float floatValue = ((Number) mutableState.getValue()).floatValue() + f;
        float coerceIn = AbstractC11719c.coerceIn(floatValue, this.this$0.getMinBound$material3_release(), this.this$0.getMaxBound$material3_release());
