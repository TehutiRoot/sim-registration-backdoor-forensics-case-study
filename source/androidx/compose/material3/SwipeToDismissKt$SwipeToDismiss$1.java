...
public final class SwipeToDismissKt$SwipeToDismiss$1 extends Lambda implements Function2<DismissValue, IntSize, Float> {
    ...
    public /* bridge */ /* synthetic */ Float invoke(DismissValue dismissValue, IntSize intSize) {
        return m70635invokeO0kMr_c(dismissValue, intSize.m73822unboximpl());
    }

    @Nullable
    /* renamed from: invoke-O0kMr_c  reason: not valid java name */
    public final Float m70635invokeO0kMr_c(@NotNull DismissValue value, long j) {
        Intrinsics.checkNotNullParameter(value, "value");
        float m73818getWidthimpl = IntSize.m73818getWidthimpl(j);
        ...
        if (i != 1) {
            if (i != 2) {
                ...
                return Float.valueOf(-m73818getWidthimpl);
            }
