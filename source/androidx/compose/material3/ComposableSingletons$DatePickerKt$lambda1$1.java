...
public final class ComposableSingletons$DatePickerKt$lambda1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public ComposableSingletons$DatePickerKt$lambda1$1() {
        super(2);
    }
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        IconKt.m70427Iconww6aTOc(EditKt.getEdit(Icons.Filled.INSTANCE), Strings_androidKt.m70619getStringNWtq28(Strings.Companion.m70579getDatePickerSwitchToInputModeadMyvUU(), composer, 6), (Modifier) null, 0L, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
