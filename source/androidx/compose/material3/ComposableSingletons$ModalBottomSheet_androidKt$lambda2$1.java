...
public final class ComposableSingletons$ModalBottomSheet_androidKt$lambda2$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public ComposableSingletons$ModalBottomSheet_androidKt$lambda2$1() {
        super(2);
    }
