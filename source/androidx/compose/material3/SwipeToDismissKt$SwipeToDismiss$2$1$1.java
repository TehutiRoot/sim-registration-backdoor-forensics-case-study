...
public final class SwipeToDismissKt$SwipeToDismiss$2$1$1 extends Lambda implements Function1<Density, IntOffset> {
    ...
    public /* bridge */ /* synthetic */ IntOffset invoke(Density density) {
        return IntOffset.m73767boximpl(m70636invokeBjo55l4(density));
    }

    /* renamed from: invoke-Bjo55l4  reason: not valid java name */
    public final long m70636invokeBjo55l4(@NotNull Density offset) {
        Intrinsics.checkNotNullParameter(offset, "$this$offset");
        return IntOffsetKt.IntOffset(AbstractC21140mr0.roundToInt(this.$state.requireOffset()), 0);
    }
}
