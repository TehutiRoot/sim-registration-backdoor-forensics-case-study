...
public final class ListItemKt$ListItem$decoratedSupportingContent$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        ListItemKt.m60628c(this.$colors.supportingColor$material3_release(composer, (this.$$dirty >> 18) & 14).getValue().m71745unboximpl(), ListTokens.INSTANCE.getListItemSupportingTextFont(), this.$it, composer, 48);
        if (ComposerKt.isTraceInProgress()) {
