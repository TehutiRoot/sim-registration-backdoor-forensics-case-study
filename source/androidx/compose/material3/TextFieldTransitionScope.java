...
public final class TextFieldTransitionScope {
    ...
    /* renamed from: a */
    public static final TextFieldTransitionScope f26366a = new TextFieldTransitionScope();
    ...
    /* renamed from: b */
    public static final float m60451b(State state) {
        return ((Number) state.getValue()).floatValue();
    }

    /* renamed from: c */
    public static final float m60450c(State state) {
        return ((Number) state.getValue()).floatValue();
    }

    /* renamed from: d */
    public static final float m60449d(State state) {
        return ((Number) state.getValue()).floatValue();
    }

    /* renamed from: e */
    public static final long m60448e(State state) {
        return ((Color) state.getValue()).m71745unboximpl();
    }

    /* renamed from: f */
    public static final long m60447f(State state) {
        return ((Color) state.getValue()).m71745unboximpl();
    }
    ...
    */
    public final void m60452a(androidx.compose.material3.InputPhase r27, long r28, long r30, kotlin.jvm.functions.Function3 r32, boolean r33, kotlin.jvm.functions.Function7 r34, androidx.compose.runtime.Composer r35, int r36) {
        /*
            Method dump skipped, instructions count: 1228
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TextFieldTransitionScope.m60452a(androidx.compose.material3.InputPhase, long, long, kotlin.jvm.functions.Function3, boolean, kotlin.jvm.functions.Function7, androidx.compose.runtime.Composer, int):void");
    }
}
