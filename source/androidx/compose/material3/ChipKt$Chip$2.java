...
public final class ChipKt$Chip$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        int i2 = this.$$dirty;
        long m71745unboximpl = chipColors.leadingIconContentColor$material3_release(z, composer, ((i2 >> 24) & 112) | ((i2 >> 6) & 14)).getValue().m71745unboximpl();
        ChipColors chipColors2 = this.$colors;
        boolean z2 = this.$enabled;
        int i3 = this.$$dirty;
        long m71745unboximpl2 = chipColors2.trailingIconContentColor$material3_release(z2, composer, ((i3 >> 24) & 112) | ((i3 >> 6) & 14)).getValue().m71745unboximpl();
        ...
        int i7 = this.$$dirty1;
        ChipKt.m60679b(function2, textStyle, j, function22, null, function23, m71745unboximpl, m71745unboximpl2, f, paddingValues, composer, i6 | ((i7 << 18) & 234881024) | ((i7 << 18) & 1879048192));
        if (ComposerKt.isTraceInProgress()) {
