...
public final class ListItemKt$LeadingContent$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ListItemKt.m60630a(this.$this_LeadingContent, this.$contentColor, this.$topAlign, this.$content, composer, RecomposeScopeImplKt.updateChangedFlags(this.$$changed | 1));
    }
}
