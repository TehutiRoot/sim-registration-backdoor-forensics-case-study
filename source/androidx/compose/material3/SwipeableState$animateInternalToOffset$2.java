...
@DebugMetadata(m28801c = "androidx.compose.material3.SwipeableState$animateInternalToOffset$2", m28800f = "Swipeable.kt", m28799i = {}, m28798l = {223}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
...
public final class SwipeableState$animateInternalToOffset$2 extends SuspendLambda implements Function2<DragScope, Continuation<? super Unit>, Object> {
    ...
    @Metadata(m28851d1 = {"\u0000\u0016\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0007\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u000e\u0012\u0004\u0012\u00020\u0004\u0012\u0004\u0012\u00020\u00050\u0003H\n¢\u0006\u0002\b\u0006"}, m28850d2 = {"<anonymous>", "", "T", "Landroidx/compose/animation/core/Animatable;", "", "Landroidx/compose/animation/core/AnimationVector1D;", "invoke"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
    /* renamed from: androidx.compose.material3.SwipeableState$animateInternalToOffset$2$1 */
    /* loaded from: classes2.dex */
    public static final class C33881 extends Lambda implements Function1<Animatable<Float, AnimationVector1D>, Unit> {
        final /* synthetic */ DragScope $$this$drag;
        final /* synthetic */ Ref.FloatRef $prevValue;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C33881(DragScope dragScope, Ref.FloatRef floatRef) {
            super(1);
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        try {
            if (i != 0) {
                ...
                C33881 c33881 = new C33881(dragScope, floatRef);
                this.label = 1;
                if (Animatable.animateTo$default(Animatable$default, boxFloat, animationSpec, null, c33881, this, 4, null) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
            mutableState4 = this.this$0.f26223h;
            mutableState4.setValue(null);
            this.this$0.m60503b(false);
            return Unit.INSTANCE;
        } catch (Throwable th2) {
            mutableState = this.this$0.f26223h;
