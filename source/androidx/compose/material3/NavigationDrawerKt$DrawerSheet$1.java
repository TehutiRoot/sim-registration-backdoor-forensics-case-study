...
public final class NavigationDrawerKt$DrawerSheet$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        f = NavigationDrawerKt.f25912b;
        Modifier windowInsetsPadding = WindowInsetsPaddingKt.windowInsetsPadding(SizeKt.m69568sizeInqDBjuR0$default(companion, f, 0.0f, DrawerDefaults.INSTANCE.m70374getMaximumDrawerWidthD9Ej5fM(), 0.0f, 10, null), this.$windowInsets);
