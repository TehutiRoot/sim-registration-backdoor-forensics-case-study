...
public final class ProgressIndicatorKt$LinearProgressIndicator$firstLineTail$1 extends Lambda implements Function1<KeyframesSpec.KeyframesSpecConfig<Float>, Unit> {
    ...
    public final void invoke2(@NotNull KeyframesSpec.KeyframesSpecConfig<Float> keyframes) {
        ...
        KeyframesSpec.KeyframeEntity<Float> m61694at = keyframes.m61694at(Float.valueOf(0.0f), 333);
        cubicBezierEasing = ProgressIndicatorKt.f25960e;
        keyframes.with(m61694at, cubicBezierEasing);
        keyframes.m61694at(Float.valueOf(1.0f), 1183);
    }
}
