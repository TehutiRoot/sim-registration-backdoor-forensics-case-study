...
public final class NavigationRailKt$placeLabelAndIcon$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public NavigationRailKt$placeLabelAndIcon$1(Placeable placeable, boolean z, float f, Placeable placeable2, int i, int i2, int i3, Placeable placeable3, int i4, int i5, Placeable placeable4, int i6, int i7, int i8, MeasureScope measureScope) {
        super(1);
    ...
    public final void invoke2(@NotNull Placeable.PlacementScope layout) {
        ...
        if (placeable != null) {
            ...
            Placeable.PlacementScope.placeRelative$default(layout, placeable, (i - placeable.getWidth()) / 2, this.$offset + (i2 - measureScope.mo69432roundToPx0680j_4(NavigationRailKt.f25928g)), 0.0f, 4, null);
        }
