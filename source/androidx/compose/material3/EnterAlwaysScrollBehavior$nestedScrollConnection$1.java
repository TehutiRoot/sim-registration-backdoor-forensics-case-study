    ...
    */
    public java.lang.Object mo69445onPostFlingRZ2iAVY(long r10, long r12, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super androidx.compose.p003ui.unit.Velocity> r14) {
        ...
        L55:
            ...
            androidx.compose.material3.EnterAlwaysScrollBehavior r11 = r10.f25771a
            ...
            androidx.compose.material3.EnterAlwaysScrollBehavior r13 = r10.f25771a
            androidx.compose.animation.core.DecayAnimationSpec r13 = r13.getFlingAnimationSpec()
            androidx.compose.material3.EnterAlwaysScrollBehavior r10 = r10.f25771a
        ...
        L80:
            ...
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.EnterAlwaysScrollBehavior$nestedScrollConnection$1.mo69445onPostFlingRZ2iAVY(long, long, kotlin.coroutines.Continuation):java.lang.Object");
    }

    @Override // androidx.compose.p003ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostScroll-DzOQY0M */
    public long mo69446onPostScrollDzOQY0M(long j, long j2, int i) {
        if (!((Boolean) this.f25771a.m60651a().invoke()).booleanValue()) {
            return Offset.Companion.m71518getZeroF1C5BW0();
        }
        TopAppBarState state = this.f25771a.getState();
        state.setContentOffset(state.getContentOffset() + Offset.m71503getYimpl(j));
        if ((this.f25771a.getState().getHeightOffset() == 0.0f || this.f25771a.getState().getHeightOffset() == this.f25771a.getState().getHeightOffsetLimit()) && Offset.m71503getYimpl(j) == 0.0f && Offset.m71503getYimpl(j2) > 0.0f) {
            this.f25771a.getState().setContentOffset(0.0f);
        }
        this.f25771a.getState().setHeightOffset(this.f25771a.getState().getHeightOffset() + Offset.m71503getYimpl(j));
        return Offset.Companion.m71518getZeroF1C5BW0();
    }
    ...
    public long mo69448onPreScrollOzD1aCk(long j, int i) {
        ...
        float heightOffset = this.f25771a.getState().getHeightOffset();
        this.f25771a.getState().setHeightOffset(this.f25771a.getState().getHeightOffset() + Offset.m71503getYimpl(j));
        if (heightOffset == this.f25771a.getState().getHeightOffset()) {
            return Offset.Companion.m71518getZeroF1C5BW0();
        }
