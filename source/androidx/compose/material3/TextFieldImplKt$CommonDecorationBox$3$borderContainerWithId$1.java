...
public final class TextFieldImplKt$CommonDecorationBox$3$borderContainerWithId$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public TextFieldImplKt$CommonDecorationBox$3$borderContainerWithId$1(MutableState<Size> mutableState, PaddingValues paddingValues, Function2<? super Composer, ? super Integer, Unit> function2, int i) {
        super(2);
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1902535592, i, -1, "androidx.compose.material3.CommonDecorationBox.<anonymous>.<anonymous> (TextFieldImpl.kt:230)");
        }
        Modifier m70494outlineCutout12SF9DM = OutlinedTextFieldKt.m70494outlineCutout12SF9DM(LayoutIdKt.layoutId(Modifier.Companion, TextFieldImplKt.ContainerId), this.$labelSize.getValue().m71576unboximpl(), this.$contentPadding);
        ...
        Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf = LayoutKt.materializerOf(m70494outlineCutout12SF9DM);
