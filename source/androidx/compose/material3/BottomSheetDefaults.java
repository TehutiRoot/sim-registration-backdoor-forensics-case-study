...
public final class BottomSheetDefaults {
    ...
    /* renamed from: a */
    public static final float f25558a = SheetBottomTokens.INSTANCE.m71249getDockedModalContainerElevationD9Ej5fM();

    /* renamed from: b */
    public static final float f25559b = C3641Dp.m73658constructorimpl(56);
    ...
    */
    public final void m70202DragHandlelgZ2HuY(@org.jetbrains.annotations.Nullable androidx.compose.p003ui.Modifier r25, float r26, float r27, @org.jetbrains.annotations.Nullable androidx.compose.p003ui.graphics.Shape r28, long r29, @org.jetbrains.annotations.Nullable androidx.compose.runtime.Composer r31, int r32, int r33) {
        /*
            Method dump skipped, instructions count: 444
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.BottomSheetDefaults.m70202DragHandlelgZ2HuY(androidx.compose.ui.Modifier, float, float, androidx.compose.ui.graphics.Shape, long, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public final float m70203getElevationD9Ej5fM() {
        return f25558a;
    }
    ...
    public final float m70204getSheetPeekHeightD9Ej5fM() {
        return f25559b;
    }
    ...
    public final WindowInsets getWindowInsets(@Nullable Composer composer, int i) {
        ...
        WindowInsets m69575onlybOOhFvg = WindowInsetsKt.m69575onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.Companion, composer, 8), WindowInsetsSides.Companion.m69595getVerticalJoeWqyM());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
