...
public final class DrawerState {
    ...
    /* renamed from: a */
    public final SwipeableState f25757a;

    @Metadata(m28851d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n¢\u0006\u0004\b\u0004\u0010\u0005"}, m28850d2 = {"<anonymous>", "", "it", "Landroidx/compose/material3/DrawerValue;", "invoke", "(Landroidx/compose/material3/DrawerValue;)Ljava/lang/Boolean;"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
    /* renamed from: androidx.compose.material3.DrawerState$1 */
    /* loaded from: classes2.dex */
    public static final class C32851 extends Lambda implements Function1<DrawerValue, Boolean> {
        public static final C32851 INSTANCE = new C32851();
    ...
    @Metadata(m28851d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J&\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00060\u00042\u0012\u0010\u0007\u001a\u000e\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\t0\b¨\u0006\n"}, m28850d2 = {"Landroidx/compose/material3/DrawerState$Companion;", "", "()V", "Saver", "Landroidx/compose/runtime/saveable/Saver;", "Landroidx/compose/material3/DrawerState;", "Landroidx/compose/material3/DrawerValue;", "confirmStateChange", "Lkotlin/Function1;", "", "material3_release"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    /* loaded from: classes2.dex */
    ...
    public DrawerState(@NotNull DrawerValue initialValue, @NotNull Function1<? super DrawerValue, Boolean> confirmStateChange) {
        ...
        Intrinsics.checkNotNullParameter(confirmStateChange, "confirmStateChange");
        tweenSpec = NavigationDrawerKt.f25913c;
        this.f25757a = new SwipeableState(initialValue, tweenSpec, confirmStateChange);
    }
    ...
    public final Object animateTo(@NotNull DrawerValue drawerValue, @NotNull AnimationSpec<Float> animationSpec, @NotNull Continuation<? super Unit> continuation) {
        Object animateTo$material3_release = this.f25757a.animateTo$material3_release(drawerValue, animationSpec, continuation);
        if (animateTo$material3_release == AbstractC18812Yf0.getCOROUTINE_SUSPENDED()) {
    ...
    public final DrawerValue getCurrentValue() {
        return (DrawerValue) this.f25757a.getCurrentValue();
    }

    @NotNull
    public final State<Float> getOffset() {
        return this.f25757a.getOffset();
    }
    ...
    public final DrawerValue getTargetValue() {
        return (DrawerValue) this.f25757a.getTargetValue$material3_release();
    }

    public final boolean isAnimationRunning() {
        return this.f25757a.isAnimationRunning();
    }
    ...
    public final Object snapTo(@NotNull DrawerValue drawerValue, @NotNull Continuation<? super Unit> continuation) {
        Object snapTo$material3_release = this.f25757a.snapTo$material3_release(drawerValue, continuation);
        if (snapTo$material3_release == AbstractC18812Yf0.getCOROUTINE_SUSPENDED()) {
    ...
    public /* synthetic */ DrawerState(DrawerValue drawerValue, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(drawerValue, (i & 2) != 0 ? C32851.INSTANCE : function1);
    }
}
