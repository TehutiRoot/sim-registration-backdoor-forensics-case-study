...
public final class DatePickerKt$SwitchableDateEntryContent$2 extends Lambda implements Function3<DisplayMode, Composer, Integer, Unit> {
    ...
    public /* bridge */ /* synthetic */ Unit invoke(DisplayMode displayMode, Composer composer, Integer num) {
        m70351invokeQujVXRc(displayMode.m70366unboximpl(), composer, num.intValue());
    ...
    public final void m70351invokeQujVXRc(int i, @Nullable Composer composer, int i2) {
        int i3;
        int i4;
        if ((i2 & 14) == 0) {
        ...
        if (DisplayMode.m70363equalsimpl0(i, companion.m70368getPickerjFl4v0())) {
            ...
            DatePickerKt.m60674a(this.$state.getStateData$material3_release(), this.$dateFormatter, this.$dateValidator, this.$colors, composer, this.$$dirty & 8176);
