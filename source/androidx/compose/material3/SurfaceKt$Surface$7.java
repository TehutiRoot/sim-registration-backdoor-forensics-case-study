...
public final class SurfaceKt$Surface$7 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        m60510b = SurfaceKt.m60510b(this.$color, this.$absoluteElevation, composer, (this.$$changed >> 15) & 14);
        m60511a = SurfaceKt.m60511a(minimumInteractiveComponentSize, shape, m60510b, this.$border, this.$shadowElevation);
        Modifier m69693toggleableO2vRcR0$default = ToggleableKt.m69693toggleableO2vRcR0$default(m60511a, this.$checked, this.$interactionSource, RippleKt.m70180rememberRipple9IZ8Weo(false, 0.0f, 0L, composer, 0, 7), this.$enabled, null, this.$onCheckedChange, 16, null);
        ...
        Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf = LayoutKt.materializerOf(m69693toggleableO2vRcR0$default);
