...
@DebugMetadata(m28801c = "androidx.compose.material3.FloatingActionButtonElevation$animateElevation$1$1", m28800f = "FloatingActionButton.kt", m28799i = {}, m28798l = {TypedValues.PositionType.TYPE_POSITION_TYPE}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
...
public final class FloatingActionButtonElevation$animateElevation$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public static final class C3300a implements FlowCollector {
        ...
        /* renamed from: a */
        public final /* synthetic */ SnapshotStateList f25806a;

        public C3300a(SnapshotStateList snapshotStateList) {
            this.f25806a = snapshotStateList;
        }
        ...
        public final Object emit(Interaction interaction, Continuation continuation) {
            if (interaction instanceof HoverInteraction.Enter) {
                this.f25806a.add(interaction);
            } else if (interaction instanceof HoverInteraction.Exit) {
                this.f25806a.remove(((HoverInteraction.Exit) interaction).getEnter());
            } else if (interaction instanceof FocusInteraction.Focus) {
                this.f25806a.add(interaction);
            } else if (interaction instanceof FocusInteraction.Unfocus) {
                this.f25806a.remove(((FocusInteraction.Unfocus) interaction).getFocus());
            } else if (interaction instanceof PressInteraction.Press) {
                this.f25806a.add(interaction);
            } else if (interaction instanceof PressInteraction.Release) {
                this.f25806a.remove(((PressInteraction.Release) interaction).getPress());
            } else if (interaction instanceof PressInteraction.Cancel) {
                this.f25806a.remove(((PressInteraction.Cancel) interaction).getPress());
            }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i != 0) {
            ...
            C3300a c3300a = new C3300a(this.$interactions);
            this.label = 1;
            if (interactions.collect(c3300a, this) == coroutine_suspended) {
