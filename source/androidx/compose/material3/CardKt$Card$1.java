...
public final class CardKt$Card$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public CardKt$Card$1(Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, int i) {
        super(2);
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(664103990, i, -1, "androidx.compose.material3.Card.<anonymous> (Card.kt:91)");
        }
