...
public final class IconButtonKt$FilledTonalIconButton$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public IconButtonKt$FilledTonalIconButton$3(Function2<? super Composer, ? super Integer, Unit> function2, int i) {
        super(2);
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1772884636, i, -1, "androidx.compose.material3.FilledTonalIconButton.<anonymous> (IconButton.kt:272)");
        }
