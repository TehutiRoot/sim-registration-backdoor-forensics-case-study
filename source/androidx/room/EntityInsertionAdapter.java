...
public abstract class EntityInsertionAdapter<T> extends SharedSQLiteStatement {
    ...
    public final List<Long> insertAndReturnIdsList(@NotNull T[] entities) {
        ...
        try {
            ...
            List<Long> build = AbstractC10108ds.build(createListBuilder);
            release(acquire);
            return build;
        } catch (Throwable th2) {
            release(acquire);
