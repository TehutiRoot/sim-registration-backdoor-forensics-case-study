...
public final class EntityUpsertionAdapter<T> {
    ...
    /* renamed from: a */
    public final EntityInsertionAdapter f37269a;

    /* renamed from: b */
    public final EntityDeletionOrUpdateAdapter f37270b;
    ...
    public EntityUpsertionAdapter(@NotNull EntityInsertionAdapter<T> insertionAdapter, @NotNull EntityDeletionOrUpdateAdapter<T> updateAdapter) {
        ...
        this.f37269a = insertionAdapter;
        this.f37270b = updateAdapter;
    }

    /* renamed from: a */
    public final void m52919a(SQLiteConstraintException sQLiteConstraintException) {
    ...
    public final void upsert(T t) {
        try {
            this.f37269a.insert((EntityInsertionAdapter) t);
        } catch (SQLiteConstraintException e) {
            m52919a(e);
            this.f37270b.handle(t);
        }
    }

    public final long upsertAndReturnId(T t) {
        try {
            return this.f37269a.insertAndReturnId(t);
        } catch (SQLiteConstraintException e) {
            m52919a(e);
            this.f37270b.handle(t);
            return -1L;
    ...
    public final long[] upsertAndReturnIdsArray(@NotNull T[] entities) {
        ...
        for (int i = 0; i < length; i++) {
            try {
                j = this.f37269a.insertAndReturnId(entities[i]);
            } catch (SQLiteConstraintException e) {
                m52919a(e);
                this.f37270b.handle(entities[i]);
                j = -1;
            }
            jArr[i] = j;
        }
    ...
    public final List<Long> upsertAndReturnIdsList(@NotNull T[] entities) {
        ...
        for (T t : entities) {
            try {
                createListBuilder.add(Long.valueOf(this.f37269a.insertAndReturnId(t)));
            } catch (SQLiteConstraintException e) {
                m52919a(e);
                this.f37270b.handle(t);
        ...
        return AbstractC10108ds.build(createListBuilder);
    }
    ...
    public final long[] upsertAndReturnIdsArray(@NotNull Collection<? extends T> entities) {
        ...
        for (int i = 0; i < size; i++) {
            T next = it.next();
            try {
                j = this.f37269a.insertAndReturnId(next);
            } catch (SQLiteConstraintException e) {
                m52919a(e);
                this.f37270b.handle(next);
                j = -1;
            }
            jArr[i] = j;
        }
