...
public final class QueryInterceptorOpenHelper implements SupportSQLiteOpenHelper, DelegatingOpenHelper {
    ...
    public QueryInterceptorOpenHelper(@NotNull SupportSQLiteOpenHelper delegate, @NotNull Executor queryCallbackExecutor, @NotNull RoomDatabase.QueryCallback queryCallback) {
        ...
        this.f37328a = delegate;
        this.f37329b = queryCallbackExecutor;
        this.f37330c = queryCallback;
    }
    ...
    public String getDatabaseName() {
        return this.f37328a.getDatabaseName();
    }
    ...
    public SupportSQLiteDatabase getReadableDatabase() {
        return new QueryInterceptorDatabase(getDelegate().getReadableDatabase(), this.f37329b, this.f37330c);
    }

    @Override // androidx.sqlite.p007db.SupportSQLiteOpenHelper
    @NotNull
    public SupportSQLiteDatabase getWritableDatabase() {
        return new QueryInterceptorDatabase(getDelegate().getWritableDatabase(), this.f37329b, this.f37330c);
    }

    @Override // androidx.sqlite.p007db.SupportSQLiteOpenHelper
    @RequiresApi(api = 16)
    public void setWriteAheadLoggingEnabled(boolean z) {
        this.f37328a.setWriteAheadLoggingEnabled(z);
    }
}
