...
public final class AutoCloser {
    ...
    /* renamed from: a */
    public final Handler f37245a;

    /* renamed from: b */
    public Runnable f37246b;
    ...
    /* renamed from: h */
    public SupportSQLiteDatabase f37252h;

    /* renamed from: i */
    public boolean f37253i;

    /* renamed from: j */
    public final Runnable f37254j;

    /* renamed from: k */
    public final Runnable f37255k;

    @Metadata(m28851d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000¨\u0006\u0005"}, m28850d2 = {"Landroidx/room/AutoCloser$Companion;", "", "()V", "autoCloseBug", "", "room-runtime_release"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    /* loaded from: classes2.dex */
    ...
    public AutoCloser(long j, @NotNull TimeUnit autoCloseTimeUnit, @NotNull Executor autoCloseExecutor) {
        ...
        this.f37245a = new Handler(Looper.getMainLooper());
        this.f37247c = new Object();
        this.f37248d = autoCloseTimeUnit.toMillis(j);
        this.f37249e = autoCloseExecutor;
        this.f37251g = SystemClock.uptimeMillis();
        this.f37254j = new Runnable() { // from class: X7
            {
                AutoCloser.this = this;
            }

            @Override // java.lang.Runnable
            public final void run() {
                AutoCloser.m52929a(AutoCloser.this);
            }
        };
        this.f37255k = new Runnable() { // from class: Y7
            {
                AutoCloser.this = this;
            }
            ...
            @Override // java.lang.Runnable
            public final void run() {
                AutoCloser.m52928b(AutoCloser.this);
            }
        };
    }

    /* renamed from: a */
    public static /* synthetic */ void m52929a(AutoCloser autoCloser) {
        m52926d(autoCloser);
    }

    /* renamed from: b */
    public static /* synthetic */ void m52928b(AutoCloser autoCloser) {
        m52927c(autoCloser);
    }

    /* renamed from: c */
    public static final void m52927c(AutoCloser this$0) {
        Unit unit;
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        synchronized (this$0.f37247c) {
            try {
                if (SystemClock.uptimeMillis() - this$0.f37251g < this$0.f37248d) {
                    return;
                }
                if (this$0.f37250f != 0) {
                    return;
                }
                Runnable runnable = this$0.f37246b;
                if (runnable != null) {
                    runnable.run();
                    unit = Unit.INSTANCE;
                } else {
                ...
                if (unit != null) {
                    SupportSQLiteDatabase supportSQLiteDatabase = this$0.f37252h;
    ...
    /* renamed from: d */
    public static final void m52926d(AutoCloser this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.f37249e.execute(this$0.f37255k);
    }
    ...
    public final void closeDatabaseIfOpen() throws IOException {
        synchronized (this.f37247c) {
            try {
                this.f37253i = true;
                SupportSQLiteDatabase supportSQLiteDatabase = this.f37252h;
            ...
            try {
                ...
                if (i > 0) {
                    ...
                    if (i2 == 0) {
                        ...
                        this.f37245a.postDelayed(this.f37254j, this.f37248d);
                    }
                    Unit unit = Unit.INSTANCE;
                    return;
                }
    ...
    public final SupportSQLiteDatabase incrementCountAndEnsureDbIsOpen() {
        synchronized (this.f37247c) {
            this.f37245a.removeCallbacks(this.f37254j);
            this.f37250f++;
            if (!this.f37253i) {
                SupportSQLiteDatabase supportSQLiteDatabase = this.f37252h;
                if (supportSQLiteDatabase != null && supportSQLiteDatabase.isOpen()) {
