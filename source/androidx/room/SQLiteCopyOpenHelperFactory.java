...
public final class SQLiteCopyOpenHelperFactory implements SupportSQLiteOpenHelper.Factory {
    ...
    /* renamed from: b */
    public final File f37414b;

    /* renamed from: c */
    public final Callable f37415c;

    /* renamed from: d */
    public final SupportSQLiteOpenHelper.Factory f37416d;
    ...
    public SQLiteCopyOpenHelperFactory(@Nullable String str, @Nullable File file, @Nullable Callable<InputStream> callable, @NotNull SupportSQLiteOpenHelper.Factory mDelegate) {
        ...
        this.f37413a = str;
        this.f37414b = file;
        this.f37415c = callable;
        this.f37416d = mDelegate;
    }
    ...
    public SupportSQLiteOpenHelper create(@NotNull SupportSQLiteOpenHelper.Configuration configuration) {
        ...
        return new SQLiteCopyOpenHelper(configuration.context, this.f37413a, this.f37414b, this.f37415c, configuration.callback.version, this.f37416d.create(configuration));
    }
}
