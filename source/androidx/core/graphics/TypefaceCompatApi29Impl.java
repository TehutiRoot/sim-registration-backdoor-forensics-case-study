...
public class TypefaceCompatApi29Impl extends CW1 {
    /* renamed from: j */
    public static int m57342j(FontStyle fontStyle, FontStyle fontStyle2) {
        int i;
    ...
    public Typeface createFromFontFamilyFilesResourceEntry(Context context, FontResourcesParserCompat.FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, Resources resources, int i) {
        ...
        try {
            ...
            return new Typeface.CustomFallbackBuilder(build2).setStyle(m57343i(build2, i).getStyle()).build();
    ...
    public Typeface createFromFontInfo(Context context, @Nullable CancellationSignal cancellationSignal, @NonNull FontsContractCompat.FontInfo[] fontInfoArr, int i) {
        ...
        try {
            ...
            for (FontsContractCompat.FontInfo fontInfo : fontInfoArr) {
                try {
                    openFileDescriptor = contentResolver.openFileDescriptor(fontInfo.getUri(), PDPageLabelRange.STYLE_ROMAN_LOWER, cancellationSignal);
                } catch (IOException unused) {
                }
    ...
    /* renamed from: i */
    public final Font m57343i(FontFamily fontFamily, int i) {
        int i2;
        int i3;
        if ((i & 1) != 0) {
            i2 = 700;
        ...
        int m57342j = m57342j(fontStyle, font.getStyle());
        for (int i4 = 1; i4 < fontFamily.getSize(); i4++) {
            Font font2 = fontFamily.getFont(i4);
            int m57342j2 = m57342j(fontStyle, font2.getStyle());
            if (m57342j2 < m57342j) {
                font = font2;
                m57342j = m57342j2;
            }
