...
public class PathParser {
    ...
    /* renamed from: a */
    public static void m57364a(ArrayList arrayList, char c, float[] fArr) {
        arrayList.add(new PathDataNode(c, fArr));
    }

    /* renamed from: b */
    public static float[] m57363b(float[] fArr, int i, int i2) {
        if (i <= i2) {
    ...
    */
    public static void m57362c(java.lang.String r8, int r9, androidx.core.graphics.PathParser.C3995a r10) {
        /*
            r0 = 0
            r10.f33852b = r0
            r1 = r9
        ...
        L3c:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.graphics.PathParser.m57362c(java.lang.String, int, androidx.core.graphics.PathParser$a):void");
    }
    ...
    public static PathDataNode[] createNodesFromPathData(String str) {
        ...
        int i2 = 0;
        while (i < str.length()) {
            int m57360e = m57360e(str, i);
            String trim = str.substring(i2, m57360e).trim();
            if (trim.length() > 0) {
                m57364a(arrayList, trim.charAt(0), m57361d(trim));
            }
            i2 = m57360e;
            i = m57360e + 1;
        }
        if (i - i2 == 1 && i2 < str.length()) {
            m57364a(arrayList, str.charAt(i2), new float[0]);
        }
    ...
    /* renamed from: d */
    public static float[] m57361d(String str) {
        if (str.charAt(0) != 'z' && str.charAt(0) != 'Z') {
            try {
                float[] fArr = new float[str.length()];
                C3995a c3995a = new C3995a();
                int length = str.length();
                int i = 1;
                int i2 = 0;
                while (i < length) {
                    m57362c(str, i, c3995a);
                    int i3 = c3995a.f33851a;
                    if (i < i3) {
    ...
    /* renamed from: e */
    public static int m57360e(String str, int i) {
        while (i < str.length()) {
    ...
    public static class PathDataNode {
        ...
        /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
        /* renamed from: a */
        public static void m57359a(Path path, float[] fArr, char c, char c2, float[] fArr2) {
            int i;
            int i2;
            boolean z;
            boolean z2;
            ...
            while (i3 < fArr2.length) {
                if (c3 != 'A') {
                            ...
                            if (c3 != 'Q') {
                                if (c3 != 'V') {
                                    if (c3 != 'a') {
                                        ...
                                        i2 = i3;
                                        m57357c(path, f15, f16, f26, f27, f28, f29, f30, z3, z4);
                                        f15 += fArr2[i21];
                                        f16 += fArr2[i22];
                                    }
                                } else {
                    ...
                    m57357c(path, f37, f36, f38, f39, f40, f41, f42, z, z2);
                    f15 = fArr2[i30];
                    f16 = fArr2[i31];
                }
                f12 = f16;
        ...
        /* renamed from: b */
        public static void m57358b(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
            double d10 = d3;
        ...
        /* renamed from: c */
        public static void m57357c(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            double d;
            double d2;
            boolean z3;
            ...
            if (d18 < 0.0d) {
                ...
                m57357c(path, f, f2, f3, f4, f5 * sqrt, f6 * sqrt, f7, z, z2);
                return;
            }
            ...
            double d21 = d * d6;
            double d22 = d2 * d8;
            m57358b(path, (d21 * cos) - (d22 * sin), (d21 * sin) + (d22 * cos), d6, d8, d3, d5, radians, atan2, atan22);
        }
        ...
        public static void nodesToPath(PathDataNode[] pathDataNodeArr, Path path) {
            ...
            for (int i = 0; i < pathDataNodeArr.length; i++) {
                PathDataNode pathDataNode = pathDataNodeArr[i];
                m57359a(path, fArr, c, pathDataNode.mType, pathDataNode.mParams);
        ...
        public PathDataNode(PathDataNode pathDataNode) {
            this.mType = pathDataNode.mType;
            float[] fArr = pathDataNode.mParams;
            this.mParams = PathParser.m57363b(fArr, 0, fArr.length);
        }
    }
}
