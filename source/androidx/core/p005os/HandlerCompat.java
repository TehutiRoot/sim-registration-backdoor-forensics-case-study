...
public final class HandlerCompat {
    ...
    public static class C4039a {
        /* renamed from: a */
        public static Handler m57191a(Looper looper) {
            return Handler.createAsync(looper);
        }

        /* renamed from: b */
        public static Handler m57190b(Looper looper, Handler.Callback callback) {
            return Handler.createAsync(looper, callback);
        }

        /* renamed from: c */
        public static boolean m57189c(Handler handler, Runnable runnable, Object obj, long j) {
    ...
    public static class C4040b {
        /* renamed from: a */
        public static boolean m57188a(Handler handler, Runnable runnable) {
    ...
    public static boolean hasCallbacks(@NonNull Handler handler, @NonNull Runnable runnable) {
        if (Build.VERSION.SDK_INT >= 29) {
            return C4040b.m57188a(handler, runnable);
        }
        try {
    ...
    public static boolean postDelayed(@NonNull Handler handler, @NonNull Runnable runnable, @Nullable Object obj, long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            return C4039a.m57189c(handler, runnable, obj, j);
        }
    ...
    public static Handler createAsync(@NonNull Looper looper, @NonNull Handler.Callback callback) {
        if (Build.VERSION.SDK_INT >= 28) {
            return C4039a.m57190b(looper, callback);
        }
        try {
