...
public abstract class SharedElementCallback {
    ...
    /* renamed from: a */
    public static Bitmap m57619a(Drawable drawable) {
    ...
    public Parcelable onCaptureSharedElementSnapshot(View view, Matrix matrix, RectF rectF) {
        ...
        if (view instanceof ImageView) {
            ...
            if (drawable != null && background == null && (m57619a = m57619a(drawable)) != null) {
                Bundle bundle = new Bundle();
                bundle.putParcelable("sharedElement:snapshot:bitmap", m57619a);
        ...
        if (round > 0 && round2 > 0) {
            ...
            if (this.f33719a == null) {
                this.f33719a = new Matrix();
            }
            this.f33719a.set(matrix);
            this.f33719a.postTranslate(-rectF.left, -rectF.top);
            this.f33719a.postScale(min, min);
            Bitmap createBitmap = Bitmap.createBitmap(i, i2, Bitmap.Config.ARGB_8888);
            Canvas canvas = new Canvas(createBitmap);
            canvas.concat(this.f33719a);
            view.draw(canvas);
            return createBitmap;
        }
        return null;
