...
public final class NavUtils {
    ...
    /* renamed from: androidx.core.app.NavUtils$a */
    /* loaded from: classes2.dex */
    public static class C3852a {
        @DoNotInline
        /* renamed from: a */
        public static Intent m57901a(Activity activity) {
            return activity.getParentActivityIntent();
        }

        @DoNotInline
        /* renamed from: b */
        public static boolean m57900b(Activity activity, Intent intent) {
            return activity.navigateUpTo(intent);
        }

        @DoNotInline
        /* renamed from: c */
        public static boolean m57899c(Activity activity, Intent intent) {
    ...
    public static Intent getParentActivityIntent(@NonNull Activity activity) {
        Intent m57901a = C3852a.m57901a(activity);
        if (m57901a != null) {
            return m57901a;
        }
