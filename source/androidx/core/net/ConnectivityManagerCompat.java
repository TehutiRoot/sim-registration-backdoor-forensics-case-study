...
public final class ConnectivityManagerCompat {
    ...
    public static class C4030a {
        ...
        @DoNotInline
        /* renamed from: a */
        public static boolean m57204a(ConnectivityManager connectivityManager) {
    ...
    public static class C4031b {
        @DoNotInline
        /* renamed from: a */
        public static int m57203a(ConnectivityManager connectivityManager) {
    ...
    public static int getRestrictBackgroundStatus(@NonNull ConnectivityManager connectivityManager) {
        if (Build.VERSION.SDK_INT >= 24) {
            return C4031b.m57203a(connectivityManager);
        }
        return 3;
    }
    ...
    public static boolean isActiveNetworkMetered(@NonNull ConnectivityManager connectivityManager) {
        return C4030a.m57204a(connectivityManager);
    }
}
