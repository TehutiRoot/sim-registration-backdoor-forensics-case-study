...
public final class MimeTypeFilter {
    /* renamed from: a */
    public static boolean m57459a(String[] strArr, String[] strArr2) {
        if (strArr2.length == 2) {
    ...
    public static boolean matches(@Nullable String str, @NonNull String str2) {
        ...
        return m57459a(str.split(RemoteSettings.FORWARD_SLASH_STRING), str2.split(RemoteSettings.FORWARD_SLASH_STRING));
    }
    ...
    public static String[] matchesMany(@Nullable String[] strArr, @NonNull String str) {
        ...
        for (String str2 : strArr) {
            if (m57459a(str2.split(RemoteSettings.FORWARD_SLASH_STRING), split)) {
                arrayList.add(str2);
            }
        }
    ...
    public static String matches(@Nullable String str, @NonNull String[] strArr) {
        ...
        String[] split = str.split(RemoteSettings.FORWARD_SLASH_STRING);
        for (String str2 : strArr) {
            if (m57459a(split, str2.split(RemoteSettings.FORWARD_SLASH_STRING))) {
                return str2;
            }
        }
        return null;
