...
public final class IntentCompat {
    ...
    /* loaded from: classes2.dex */
    public static class C3958a {
        @DoNotInline
        /* renamed from: a */
        public static Intent m57527a(String str, String str2) {
    ...
    public static class C3959b {
        @DoNotInline
        /* renamed from: a */
        public static <T> T[] m57526a(@NonNull Intent intent, @Nullable String str, @NonNull Class<T> cls) {
            return (T[]) intent.getParcelableArrayExtra(str, cls);
        }

        @DoNotInline
        /* renamed from: b */
        public static <T> ArrayList<T> m57525b(@NonNull Intent intent, @Nullable String str, @NonNull Class<? extends T> cls) {
            return intent.getParcelableArrayListExtra(str, cls);
        }

        @DoNotInline
        /* renamed from: c */
        public static <T> T m57524c(@NonNull Intent intent, @Nullable String str, @NonNull Class<T> cls) {
    ...
    public static Parcelable[] getParcelableArrayExtra(@NonNull Intent intent, @Nullable String str, @NonNull Class<? extends Parcelable> cls) {
        if (BuildCompat.isAtLeastU()) {
            return (Parcelable[]) C3959b.m57526a(intent, str, cls);
        }
    ...
    public static <T> ArrayList<T> getParcelableArrayListExtra(@NonNull Intent intent, @Nullable String str, @NonNull Class<? extends T> cls) {
        if (BuildCompat.isAtLeastU()) {
            return C3959b.m57525b(intent, str, cls);
        }
    ...
    public static <T> T getParcelableExtra(@NonNull Intent intent, @Nullable String str, @NonNull Class<T> cls) {
        if (BuildCompat.isAtLeastU()) {
            return (T) C3959b.m57524c(intent, str, cls);
        }
    ...
    public static Intent makeMainSelectorActivity(@NonNull String str, @NonNull String str2) {
        return C3958a.m57527a(str, str2);
    }
}
