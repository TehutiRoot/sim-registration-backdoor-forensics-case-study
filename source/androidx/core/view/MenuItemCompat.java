...
public final class MenuItemCompat {
    ...
    /* loaded from: classes2.dex */
    public class MenuItem$OnActionExpandListenerC4117a implements MenuItem.OnActionExpandListener {

        /* renamed from: a */
        public final /* synthetic */ OnActionExpandListener f34172a;

        public MenuItem$OnActionExpandListenerC4117a(OnActionExpandListener onActionExpandListener) {
            this.f34172a = onActionExpandListener;
        }

        @Override // android.view.MenuItem.OnActionExpandListener
        public boolean onMenuItemActionCollapse(MenuItem menuItem) {
            return this.f34172a.onMenuItemActionCollapse(menuItem);
        }

        @Override // android.view.MenuItem.OnActionExpandListener
        public boolean onMenuItemActionExpand(MenuItem menuItem) {
            return this.f34172a.onMenuItemActionExpand(menuItem);
        }
    }

    /* renamed from: androidx.core.view.MenuItemCompat$b */
    /* loaded from: classes2.dex */
    public static class C4118b {
        @DoNotInline
        /* renamed from: a */
        public static int m56980a(MenuItem menuItem) {
            return menuItem.getAlphabeticModifiers();
        }

        @DoNotInline
        /* renamed from: b */
        public static CharSequence m56979b(MenuItem menuItem) {
            return menuItem.getContentDescription();
        }

        @DoNotInline
        /* renamed from: c */
        public static ColorStateList m56978c(MenuItem menuItem) {
            return menuItem.getIconTintList();
        }

        @DoNotInline
        /* renamed from: d */
        public static PorterDuff.Mode m56977d(MenuItem menuItem) {
            return menuItem.getIconTintMode();
        }

        @DoNotInline
        /* renamed from: e */
        public static int m56976e(MenuItem menuItem) {
            return menuItem.getNumericModifiers();
        }

        @DoNotInline
        /* renamed from: f */
        public static CharSequence m56975f(MenuItem menuItem) {
            return menuItem.getTooltipText();
        }

        @DoNotInline
        /* renamed from: g */
        public static MenuItem m56974g(MenuItem menuItem, char c, int i) {
            return menuItem.setAlphabeticShortcut(c, i);
        }

        @DoNotInline
        /* renamed from: h */
        public static MenuItem m56973h(MenuItem menuItem, CharSequence charSequence) {
            return menuItem.setContentDescription(charSequence);
        }

        @DoNotInline
        /* renamed from: i */
        public static MenuItem m56972i(MenuItem menuItem, ColorStateList colorStateList) {
            return menuItem.setIconTintList(colorStateList);
        }

        @DoNotInline
        /* renamed from: j */
        public static MenuItem m56971j(MenuItem menuItem, PorterDuff.Mode mode) {
            return menuItem.setIconTintMode(mode);
        }

        @DoNotInline
        /* renamed from: k */
        public static MenuItem m56970k(MenuItem menuItem, char c, int i) {
            return menuItem.setNumericShortcut(c, i);
        }

        @DoNotInline
        /* renamed from: l */
        public static MenuItem m56969l(MenuItem menuItem, char c, char c2, int i, int i2) {
            return menuItem.setShortcut(c, c2, i, i2);
        }

        @DoNotInline
        /* renamed from: m */
        public static MenuItem m56968m(MenuItem menuItem, CharSequence charSequence) {
    ...
    public static int getAlphabeticModifiers(@NonNull MenuItem menuItem) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            return C4118b.m56980a(menuItem);
        }
        return 0;
    }
    ...
    public static CharSequence getContentDescription(@NonNull MenuItem menuItem) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            return C4118b.m56979b(menuItem);
        }
        return null;
    }
    ...
    public static ColorStateList getIconTintList(@NonNull MenuItem menuItem) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            return C4118b.m56978c(menuItem);
        }
        return null;
    }
    ...
    public static PorterDuff.Mode getIconTintMode(@NonNull MenuItem menuItem) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            return C4118b.m56977d(menuItem);
        }
        return null;
    }
    ...
    public static int getNumericModifiers(@NonNull MenuItem menuItem) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            return C4118b.m56976e(menuItem);
        }
        return 0;
    }
    ...
    public static CharSequence getTooltipText(@NonNull MenuItem menuItem) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            return C4118b.m56975f(menuItem);
        }
        return null;
    }
    ...
    public static void setContentDescription(@NonNull MenuItem menuItem, @Nullable CharSequence charSequence) {
        if (menuItem instanceof SupportMenuItem) {
            ...
            C4118b.m56973h(menuItem, charSequence);
        }
    }
    ...
    public static void setIconTintList(@NonNull MenuItem menuItem, @Nullable ColorStateList colorStateList) {
        if (menuItem instanceof SupportMenuItem) {
            ...
            C4118b.m56972i(menuItem, colorStateList);
        }
    }
    ...
    public static void setNumericShortcut(@NonNull MenuItem menuItem, char c, int i) {
        if (menuItem instanceof SupportMenuItem) {
            ...
            C4118b.m56970k(menuItem, c, i);
        }
    }

    @Deprecated
    public static MenuItem setOnActionExpandListener(MenuItem menuItem, OnActionExpandListener onActionExpandListener) {
        return menuItem.setOnActionExpandListener(new MenuItem$OnActionExpandListenerC4117a(onActionExpandListener));
    }
    ...
    public static void setShortcut(@NonNull MenuItem menuItem, char c, char c2, int i, int i2) {
        if (menuItem instanceof SupportMenuItem) {
            ...
            C4118b.m56969l(menuItem, c, c2, i, i2);
        }
    }
    ...
    public static void setTooltipText(@NonNull MenuItem menuItem, @Nullable CharSequence charSequence) {
        if (menuItem instanceof SupportMenuItem) {
            ...
            C4118b.m56968m(menuItem, charSequence);
        }
    }
