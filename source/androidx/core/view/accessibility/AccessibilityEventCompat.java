...
public final class AccessibilityEventCompat {
    ...
    /* loaded from: classes2.dex */
    public static class C4186a {
        @DoNotInline
        /* renamed from: a */
        public static int m56639a(AccessibilityEvent accessibilityEvent) {
            return accessibilityEvent.getAction();
        }

        @DoNotInline
        /* renamed from: b */
        public static int m56638b(AccessibilityEvent accessibilityEvent) {
            return accessibilityEvent.getMovementGranularity();
        }

        @DoNotInline
        /* renamed from: c */
        public static void m56637c(AccessibilityEvent accessibilityEvent, int i) {
            accessibilityEvent.setAction(i);
        }

        @DoNotInline
        /* renamed from: d */
        public static void m56636d(AccessibilityEvent accessibilityEvent, int i) {
    ...
    /* loaded from: classes2.dex */
    public static class C4187b {
        @DoNotInline
        /* renamed from: a */
        public static int m56635a(AccessibilityEvent accessibilityEvent) {
            return accessibilityEvent.getContentChangeTypes();
        }

        @DoNotInline
        /* renamed from: b */
        public static void m56634b(AccessibilityEvent accessibilityEvent, int i) {
