...
public final class EditorInfoCompat {
    ...
    /* renamed from: a */
    public static final String[] f34331a = new String[0];

    /* renamed from: androidx.core.view.inputmethod.EditorInfoCompat$a */
    /* loaded from: classes2.dex */
    public static class C4202a {
        /* renamed from: a */
        public static CharSequence m56582a(EditorInfo editorInfo, int i) {
            return editorInfo.getInitialSelectedText(i);
        }

        /* renamed from: b */
        public static CharSequence m56581b(EditorInfo editorInfo, int i, int i2) {
            return editorInfo.getInitialTextAfterCursor(i, i2);
        }

        /* renamed from: c */
        public static CharSequence m56580c(EditorInfo editorInfo, int i, int i2) {
            return editorInfo.getInitialTextBeforeCursor(i, i2);
        }

        /* renamed from: d */
        public static void m56579d(EditorInfo editorInfo, CharSequence charSequence, int i) {
            editorInfo.setInitialSurroundingSubText(charSequence, i);
        }
    }

    /* renamed from: a */
    public static int m56587a(EditorInfo editorInfo) {
    ...
    /* renamed from: b */
    public static boolean m56586b(CharSequence charSequence, int i, int i2) {
        if (i2 != 0) {
            if (i2 != 1) {
                return false;
            }
    ...
    /* renamed from: c */
    public static boolean m56585c(int i) {
        int i2 = i & 4095;
        return i2 == 129 || i2 == 225 || i2 == 18;
    }

    /* renamed from: d */
    public static void m56584d(EditorInfo editorInfo, CharSequence charSequence, int i, int i2) {
    ...
    /* renamed from: e */
    public static void m56583e(EditorInfo editorInfo, CharSequence charSequence, int i, int i2) {
        int i3;
        ...
        int i6 = i - min2;
        if (m56586b(charSequence, i6, 0)) {
            i6++;
            min2--;
        }
        if (m56586b(charSequence, (i2 + min) - 1, 1)) {
            min--;
        }
        int i7 = min2 + i3 + min;
        if (i3 != i4) {
        ...
        m56584d(editorInfo, subSequence, min2, i3 + min2);
    }
    ...
    public static CharSequence getInitialSelectedText(@NonNull EditorInfo editorInfo, int i) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            return C4202a.m56582a(editorInfo, i);
        }
        if (editorInfo.extras == null) {
            return null;
        }
    ...
    public static CharSequence getInitialTextAfterCursor(@NonNull EditorInfo editorInfo, int i, int i2) {
        CharSequence charSequence;
        if (Build.VERSION.SDK_INT >= 30) {
            return C4202a.m56581b(editorInfo, i, i2);
        }
        Bundle bundle = editorInfo.extras;
    ...
    public static CharSequence getInitialTextBeforeCursor(@NonNull EditorInfo editorInfo, int i, int i2) {
        CharSequence charSequence;
        if (Build.VERSION.SDK_INT >= 30) {
            return C4202a.m56580c(editorInfo, i, i2);
        }
        Bundle bundle = editorInfo.extras;
        if (bundle == null || (charSequence = bundle.getCharSequence("androidx.core.view.inputmethod.EditorInfoCompat.CONTENT_SURROUNDING_TEXT")) == null) {
            return null;
    ...
    public static void setInitialSurroundingSubText(@NonNull EditorInfo editorInfo, @NonNull CharSequence charSequence, int i) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            C4202a.m56579d(editorInfo, charSequence, i);
            return;
        }
        ...
        if (i >= 0 && i2 >= 0 && i3 <= length) {
            if (m56585c(editorInfo.inputType)) {
                m56584d(editorInfo, null, 0, 0);
                return;
            } else if (length <= 2048) {
                m56584d(editorInfo, charSequence, i2, i3);
                return;
            } else {
                m56583e(editorInfo, charSequence, i2, i3);
                return;
            }
        }
        m56584d(editorInfo, null, 0, 0);
    ...
    public static void setInitialSurroundingText(@NonNull EditorInfo editorInfo, @NonNull CharSequence charSequence) {
        if (Build.VERSION.SDK_INT >= 30) {
            C4202a.m56579d(editorInfo, charSequence, 0);
        } else {
