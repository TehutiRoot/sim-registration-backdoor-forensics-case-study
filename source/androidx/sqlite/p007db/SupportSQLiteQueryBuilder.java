...
public final class SupportSQLiteQueryBuilder {
    ...
    /* renamed from: j */
    public static final Pattern f37490j = Pattern.compile("\\s*\\d+\\s*(,\\s*\\d+\\s*)?");

    /* renamed from: a */
    public final String f37491a;

    /* renamed from: b */
    public boolean f37492b;
    ...
    /* renamed from: h */
    public String f37498h;

    /* renamed from: i */
    public String f37499i;

    @Metadata(m28851d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\tH\u0007R\u0016\u0010\u0003\u001a\n \u0005*\u0004\u0018\u00010\u00040\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\n"}, m28850d2 = {"Landroidx/sqlite/db/SupportSQLiteQueryBuilder$Companion;", "", "()V", "limitPattern", "Ljava/util/regex/Pattern;", "kotlin.jvm.PlatformType", "builder", "Landroidx/sqlite/db/SupportSQLiteQueryBuilder;", "tableName", "", "sqlite_release"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    ...
    /* renamed from: a */
    public final void m52808a(StringBuilder sb, String str, String str2) {
    ...
    /* renamed from: b */
    public final void m52807b(StringBuilder sb, String[] strArr) {
    ...
    public final SupportSQLiteQuery create() {
        ...
        if ((str2 == null || str2.length() == 0) && (str = this.f37497g) != null && str.length() != 0) {
        ...
        m52808a(sb, " WHERE ", this.f37494d);
        m52808a(sb, " GROUP BY ", this.f37496f);
        m52808a(sb, " HAVING ", this.f37497g);
        m52808a(sb, " ORDER BY ", this.f37498h);
        m52808a(sb, " LIMIT ", this.f37499i);
        String sb2 = sb.toString();
        Intrinsics.checkNotNullExpressionValue(sb2, "StringBuilder(capacity).…builderAction).toString()");
        return new SimpleSQLiteQuery(sb2, this.f37495e);
    }
    ...
    public final SupportSQLiteQueryBuilder limit(@NotNull String limit) {
        ...
        boolean matches = f37490j.matcher(limit).matches();
