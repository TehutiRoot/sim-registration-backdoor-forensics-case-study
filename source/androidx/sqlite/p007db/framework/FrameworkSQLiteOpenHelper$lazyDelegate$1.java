...
@Metadata(m28851d1 = {"\u0000\b\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001H\n¢\u0006\u0002\b\u0002"}, m28850d2 = {"<anonymous>", "Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;", "invoke"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
...
public final class FrameworkSQLiteOpenHelper$lazyDelegate$1 extends Lambda implements Function0<FrameworkSQLiteOpenHelper.OpenHelper> {
    ...
    public final FrameworkSQLiteOpenHelper.OpenHelper invoke() {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            str2 = this.this$0.f37504b;
            if (str2 != null) {
                z3 = this.this$0.f37506d;
                if (z3) {
                    context2 = this.this$0.f37503a;
                    File noBackupFilesDir = SupportSQLiteCompat.Api21Impl.getNoBackupFilesDir(context2);
                    str3 = this.this$0.f37504b;
                    File file = new File(noBackupFilesDir, str3);
                    context3 = this.this$0.f37503a;
                    String absolutePath = file.getAbsolutePath();
                    FrameworkSQLiteOpenHelper.C5043a c5043a = new FrameworkSQLiteOpenHelper.C5043a(null);
                    callback2 = this.this$0.f37505c;
                    z4 = this.this$0.f37507e;
                    openHelper = new FrameworkSQLiteOpenHelper.OpenHelper(context3, absolutePath, c5043a, callback2, z4);
                    z2 = this.this$0.f37509g;
                    SupportSQLiteCompat.Api16Impl.setWriteAheadLoggingEnabled(openHelper, z2);
                    return openHelper;
                }
            }
        }
        context = this.this$0.f37503a;
        str = this.this$0.f37504b;
        FrameworkSQLiteOpenHelper.C5043a c5043a2 = new FrameworkSQLiteOpenHelper.C5043a(null);
        callback = this.this$0.f37505c;
        z = this.this$0.f37507e;
        openHelper = new FrameworkSQLiteOpenHelper.OpenHelper(context, str, c5043a2, callback, z);
        z2 = this.this$0.f37509g;
        SupportSQLiteCompat.Api16Impl.setWriteAheadLoggingEnabled(openHelper, z2);
        return openHelper;
    }
