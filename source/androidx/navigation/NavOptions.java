...
public final class NavOptions {
    ...
    public static final class Builder {
        ...
        /* renamed from: g */
        public int f36368g = -1;

        /* renamed from: h */
        public int f36369h = -1;

        /* renamed from: i */
        public int f36370i = -1;

        /* renamed from: j */
        public int f36371j = -1;
        ...
        public final NavOptions build() {
            ...
            if (str != null) {
                return new NavOptions(this.f36362a, this.f36363b, str, this.f36366e, this.f36367f, this.f36368g, this.f36369h, this.f36370i, this.f36371j);
            }
            return new NavOptions(this.f36362a, this.f36363b, this.f36364c, this.f36366e, this.f36367f, this.f36368g, this.f36369h, this.f36370i, this.f36371j);
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (this.f36352a == navOptions.f36352a && this.f36353b == navOptions.f36353b && this.f36354c == navOptions.f36354c && Intrinsics.areEqual(this.f36361j, navOptions.f36361j) && this.f36355d == navOptions.f36355d && this.f36356e == navOptions.f36356e && this.f36357f == navOptions.f36357f && this.f36358g == navOptions.f36358g && this.f36359h == navOptions.f36359h && this.f36360i == navOptions.f36360i) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int i;
        int i2 = (((((shouldLaunchSingleTop() ? 1 : 0) * 31) + (shouldRestoreState() ? 1 : 0)) * 31) + this.f36354c) * 31;
        ...
        return ((((((((((((i2 + i) * 31) + (isPopUpToInclusive() ? 1 : 0)) * 31) + (shouldPopUpToSaveState() ? 1 : 0)) * 31) + this.f36357f) * 31) + this.f36358g) * 31) + this.f36359h) * 31) + this.f36360i;
    }
