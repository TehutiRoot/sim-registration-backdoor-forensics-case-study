...
public final class ActivityNavigatorDestinationBuilder extends NavDestinationBuilder<ActivityNavigator.Destination> {
    ...
    public ActivityNavigatorDestinationBuilder(@NotNull ActivityNavigator navigator, @IdRes int i) {
        ...
        this.f36176h = navigator.getContext();
    }
    ...
    public ActivityNavigator.Destination build() {
        ...
        destination.setTargetPackage(this.f36177i);
        KClass kClass = this.f36178j;
        if (kClass != null) {
            destination.setComponentName(new ComponentName(this.f36176h, JvmClassMappingKt.getJavaClass(kClass)));
        }
        destination.setAction(this.f36179k);
        destination.setData(this.f36180l);
        destination.setDataPattern(this.f36181m);
        return destination;
    }
