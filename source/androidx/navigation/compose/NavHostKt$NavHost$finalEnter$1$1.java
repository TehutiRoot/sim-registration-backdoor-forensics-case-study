...
@Metadata(m28851d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00030\u0002H\n¢\u0006\u0002\b\u0004"}, m28850d2 = {"<anonymous>", "Landroidx/compose/animation/EnterTransition;", "Landroidx/compose/animation/AnimatedContentTransitionScope;", "Landroidx/navigation/NavBackStackEntry;", "invoke"}, m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
...
public final class NavHostKt$NavHost$finalEnter$1$1 extends Lambda implements Function1<AnimatedContentTransitionScope<NavBackStackEntry>, EnterTransition> {
    ...
    public final EnterTransition invoke(@NotNull AnimatedContentTransitionScope<NavBackStackEntry> animatedContentTransitionScope) {
        EnterTransition m53820c;
        EnterTransition m53818e;
        ...
        if (this.$composeNavigator.isPop$navigation_compose_release().getValue().booleanValue()) {
            ...
            while (true) {
                ...
                m53818e = NavHostKt.m53818e(it.next(), animatedContentTransitionScope);
                if (m53818e != null) {
                    enterTransition = m53818e;
                    break;
                }
        ...
        while (true) {
            ...
            m53820c = NavHostKt.m53820c(it2.next(), animatedContentTransitionScope);
            if (m53820c != null) {
                enterTransition = m53820c;
                break;
            }
