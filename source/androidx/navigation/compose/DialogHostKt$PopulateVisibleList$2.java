...
public final class DialogHostKt$PopulateVisibleList$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        DialogHostKt.PopulateVisibleList(this.$this_PopulateVisibleList, this.$transitionsInProgress, composer, RecomposeScopeImplKt.updateChangedFlags(this.$$changed | 1));
    }
}
