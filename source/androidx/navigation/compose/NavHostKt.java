...
public final class NavHostKt {
    ...
    /* renamed from: a */
    public static final List m53822a(State state) {
        return (List) state.getValue();
    }

    /* renamed from: b */
    public static final List m53821b(State state) {
        return (List) state.getValue();
    }

    /* renamed from: c */
    public static final EnterTransition m53820c(NavDestination navDestination, AnimatedContentTransitionScope animatedContentTransitionScope) {
    ...
    /* renamed from: d */
    public static final ExitTransition m53819d(NavDestination navDestination, AnimatedContentTransitionScope animatedContentTransitionScope) {
    ...
    /* renamed from: e */
    public static final EnterTransition m53818e(NavDestination navDestination, AnimatedContentTransitionScope animatedContentTransitionScope) {
    ...
    /* renamed from: f */
    public static final ExitTransition m53817f(NavDestination navDestination, AnimatedContentTransitionScope animatedContentTransitionScope) {
        ...
        if (current != null) {
            ...
            if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                ...
                rememberedValue = new Flow<List<? extends NavBackStackEntry>>() { // from class: androidx.navigation.compose.NavHostKt$NavHost$lambda$5$$inlined$map$1
                    ...
                    /* loaded from: classes2.dex */
                    public static final class C48202<T> implements FlowCollector {

                        /* renamed from: a */
                        public final /* synthetic */ FlowCollector f36420a;

                        @Metadata(m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
                        @DebugMetadata(m28801c = "androidx.navigation.compose.NavHostKt$NavHost$lambda$5$$inlined$map$1$2", m28800f = "NavHost.kt", m28799i = {}, m28798l = {223}, m28797m = "emit", m28796n = {}, m28795s = {})
                        @SourceDebugExtension({"SMAP\nEmitters.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Emitters.kt\nkotlinx/coroutines/flow/FlowKt__EmittersKt$unsafeTransform$1$1$emit$1\n*L\n1#1,222:1\n*E\n"})
                        /* renamed from: androidx.navigation.compose.NavHostKt$NavHost$lambda$5$$inlined$map$1$2$1 */
                        /* loaded from: classes2.dex */
                        public static final class C48211 extends ContinuationImpl {
                            Object L$0;
                            int label;
                            /* synthetic */ Object result;

                            public C48211(Continuation continuation) {
                                super(continuation);
                            }
                            ...
                            public final Object invokeSuspend(@NotNull Object obj) {
                                ...
                                return C48202.this.emit(null, this);
                            }
                        }

                        public C48202(FlowCollector flowCollector) {
                            this.f36420a = flowCollector;
                        }
                        ...
                        */
                        public final java.lang.Object emit(java.lang.Object r8, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation r9) {
                            /*
                                r7 = this;
                                boolean r0 = r9 instanceof androidx.navigation.compose.NavHostKt$NavHost$lambda$5$$inlined$map$1.C48202.C48211
                                if (r0 == 0) goto L13
                                r0 = r9
                                androidx.navigation.compose.NavHostKt$NavHost$lambda$5$$inlined$map$1$2$1 r0 = (androidx.navigation.compose.NavHostKt$NavHost$lambda$5$$inlined$map$1.C48202.C48211) r0
                                int r1 = r0.label
                            ...
                            L31:
                                kotlin.ResultKt.throwOnFailure(r9)
                                kotlinx.coroutines.flow.FlowCollector r9 = r7.f36420a
                            ...
                            L6d:
                                ...
                                return r8
                            */
                            throw new UnsupportedOperationException("Method not decompiled: androidx.navigation.compose.NavHostKt$NavHost$lambda$5$$inlined$map$1.C48202.emit(java.lang.Object, kotlin.coroutines.Continuation):java.lang.Object");
                        }
                    }
                    ...
                    public Object collect(@NotNull FlowCollector<? super List<? extends NavBackStackEntry>> flowCollector, @NotNull Continuation continuation) {
                        Object collect = Flow.this.collect(new C48202(flowCollector), continuation);
            ...
            startRestartGroup.endReplaceableGroup();
            BackHandlerKt.BackHandler(m53821b(SnapshotStateKt.collectAsState((Flow) rememberedValue, CollectionsKt__CollectionsKt.emptyList(), null, startRestartGroup, 56, 2)).size() > 1, new NavHostKt$NavHost$10(navHostController), startRestartGroup, 0, 0);
            ...
            if (changed2 || rememberedValue2 == Composer.Companion.getEmpty()) {
                ...
                rememberedValue2 = new Flow<List<? extends NavBackStackEntry>>() { // from class: androidx.navigation.compose.NavHostKt$NavHost$lambda$9$$inlined$map$1
                    ...
                    /* loaded from: classes2.dex */
                    public static final class C48222<T> implements FlowCollector {

                        /* renamed from: a */
                        public final /* synthetic */ FlowCollector f36422a;

                        @Metadata(m28849k = 3, m28848mv = {1, 8, 0}, m28846xi = 48)
                        @DebugMetadata(m28801c = "androidx.navigation.compose.NavHostKt$NavHost$lambda$9$$inlined$map$1$2", m28800f = "NavHost.kt", m28799i = {}, m28798l = {223}, m28797m = "emit", m28796n = {}, m28795s = {})
                        @SourceDebugExtension({"SMAP\nEmitters.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Emitters.kt\nkotlinx/coroutines/flow/FlowKt__EmittersKt$unsafeTransform$1$1$emit$1\n*L\n1#1,222:1\n*E\n"})
                        /* renamed from: androidx.navigation.compose.NavHostKt$NavHost$lambda$9$$inlined$map$1$2$1 */
                        /* loaded from: classes2.dex */
                        public static final class C48231 extends ContinuationImpl {
                            Object L$0;
                            int label;
                            /* synthetic */ Object result;

                            public C48231(Continuation continuation) {
                                super(continuation);
                            }
                            ...
                            public final Object invokeSuspend(@NotNull Object obj) {
                                this.result = obj;
                                this.label |= Integer.MIN_VALUE;
                                return C48222.this.emit(null, this);
                            }
                        }

                        public C48222(FlowCollector flowCollector) {
                            this.f36422a = flowCollector;
                        }
                        ...
                        */
                        public final java.lang.Object emit(java.lang.Object r8, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation r9) {
                            /*
                                r7 = this;
                                boolean r0 = r9 instanceof androidx.navigation.compose.NavHostKt$NavHost$lambda$9$$inlined$map$1.C48222.C48231
                                if (r0 == 0) goto L13
                                r0 = r9
                                androidx.navigation.compose.NavHostKt$NavHost$lambda$9$$inlined$map$1$2$1 r0 = (androidx.navigation.compose.NavHostKt$NavHost$lambda$9$$inlined$map$1.C48222.C48231) r0
                                int r1 = r0.label
                                r2 = -2147483648(0xffffffff80000000, float:-0.0)
                                r3 = r1 & r2
                                if (r3 == 0) goto L13
                            ...
                            L31:
                                kotlin.ResultKt.throwOnFailure(r9)
                                kotlinx.coroutines.flow.FlowCollector r9 = r7.f36422a
                                java.util.List r8 = (java.util.List) r8
                                java.lang.Iterable r8 = (java.lang.Iterable) r8
                                java.util.ArrayList r2 = new java.util.ArrayList
                                r2.<init>()
                            ...
                            L6d:
                                ...
                                return r8
                            */
                            throw new UnsupportedOperationException("Method not decompiled: androidx.navigation.compose.NavHostKt$NavHost$lambda$9$$inlined$map$1.C48222.emit(java.lang.Object, kotlin.coroutines.Continuation):java.lang.Object");
                        }
                    }
                    ...
                    @Nullable
                    public Object collect(@NotNull FlowCollector<? super List<? extends NavBackStackEntry>> flowCollector, @NotNull Continuation continuation) {
                        Object collect = Flow.this.collect(new C48222(flowCollector), continuation);
                        if (collect == AbstractC18812Yf0.getCOROUTINE_SUSPENDED()) {
                            return collect;
                        }
                        return Unit.INSTANCE;
            ...
            if (((Boolean) startRestartGroup.consume(InspectionModeKt.getLocalInspectionMode())).booleanValue()) {
                ...
                navBackStackEntry = (NavBackStackEntry) CollectionsKt___CollectionsKt.lastOrNull((List<? extends Object>) m53822a(collectAsState));
            }
            ...
            if (navBackStackEntry != null) {
                ...
                if (Intrinsics.areEqual(updateTransition.getCurrentState(), updateTransition.getTargetState())) {
                    for (NavBackStackEntry navBackStackEntry2 : m53822a(collectAsState)) {
