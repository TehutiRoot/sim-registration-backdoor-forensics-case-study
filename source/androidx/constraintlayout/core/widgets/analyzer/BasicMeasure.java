...
public class BasicMeasure {
    ...
    /* renamed from: b */
    public Measure f32559b = new Measure();

    /* renamed from: c */
    public ConstraintWidgetContainer f32560c;
    ...
    public BasicMeasure(ConstraintWidgetContainer constraintWidgetContainer) {
        this.f32560c = constraintWidgetContainer;
    }

    /* renamed from: a */
    public final boolean m58595a(Measurer measurer, ConstraintWidget constraintWidget, int i) {
        boolean z;
        boolean z2;
        boolean z3;
        boolean z4;
        this.f32559b.horizontalBehavior = constraintWidget.getHorizontalDimensionBehaviour();
        this.f32559b.verticalBehavior = constraintWidget.getVerticalDimensionBehaviour();
        this.f32559b.horizontalDimension = constraintWidget.getWidth();
        this.f32559b.verticalDimension = constraintWidget.getHeight();
        Measure measure = this.f32559b;
        ...
        constraintWidget.setWidth(this.f32559b.measuredWidth);
        constraintWidget.setHeight(this.f32559b.measuredHeight);
        constraintWidget.setHasBaseline(this.f32559b.measuredHasBaseline);
        constraintWidget.setBaselineDistance(this.f32559b.measuredBaseline);
        Measure measure2 = this.f32559b;
    ...
    */
    public final void m58594b(androidx.constraintlayout.core.widgets.ConstraintWidgetContainer r13) {
        /*
            r12 = this;
        ...
        L30:
            ...
            if (r7 == 0) goto L48
            androidx.constraintlayout.core.widgets.analyzer.a r6 = r6.f32603c
            boolean r6 = r6.resolved
            if (r6 == 0) goto L48
            androidx.constraintlayout.core.widgets.analyzer.a r6 = r7.f32603c
            boolean r6 = r6.resolved
            if (r6 == 0) goto L48
            goto Lac
        L48:
        ...
        Lb0:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.core.widgets.analyzer.BasicMeasure.m58594b(androidx.constraintlayout.core.widgets.ConstraintWidgetContainer):void");
    }

    /* renamed from: c */
    public final void m58593c(ConstraintWidgetContainer constraintWidgetContainer, String str, int i, int i2, int i3) {
    ...
    public long solverMeasure(ConstraintWidgetContainer constraintWidgetContainer, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
        ...
        if (!z3 || i10 != 2) {
            ...
            if (size > 0) {
                m58594b(constraintWidgetContainer);
            }
            updateHierarchy(constraintWidgetContainer);
            int size2 = this.f32558a.size();
            if (size > 0) {
                m58593c(constraintWidgetContainer, "First pass", 0, width, height);
            }
            if (size2 > 0) {
                ...
                int max = Math.max(constraintWidgetContainer.getWidth(), this.f32560c.getMinWidth());
                int max2 = Math.max(constraintWidgetContainer.getHeight(), this.f32560c.getMinHeight());
                int i17 = 0;
                boolean z14 = false;
                while (i17 < size2) {
                    ConstraintWidget constraintWidget2 = (ConstraintWidget) this.f32558a.get(i17);
                    if (!(constraintWidget2 instanceof VirtualLayout)) {
                        ...
                        i14 = height;
                        boolean m58595a = m58595a(measurer2, constraintWidget2, Measure.TRY_GIVEN_DIMENSIONS) | z14;
                ...
                while (i22 < i21) {
                    int i23 = 0;
                    while (i23 < size2) {
                        ConstraintWidget constraintWidget3 = (ConstraintWidget) this.f32558a.get(i23);
                        if (((constraintWidget3 instanceof Helper) && !(constraintWidget3 instanceof VirtualLayout)) || (constraintWidget3 instanceof Guideline) || constraintWidget3.getVisibility() == 8 || ((z13 && constraintWidget3.horizontalRun.f32603c.resolved && constraintWidget3.verticalRun.f32603c.resolved) || (constraintWidget3 instanceof VirtualLayout))) {
                            z6 = z13;
                            i12 = size2;
                            measurer = measurer2;
                        } else {
                            ...
                            boolean m58595a2 = m58595a(measurer2, constraintWidget3, i24) | z14;
                    ...
                    i22++;
                    m58593c(constraintWidgetContainer, "intermediate pass", i22, i19, i20);
                    measurer2 = measurer3;
                    z13 = z15;
                    size2 = i25;
                    i21 = 2;
    ...
    public void updateHierarchy(ConstraintWidgetContainer constraintWidgetContainer) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (horizontalDimensionBehaviour == dimensionBehaviour || constraintWidget.getVerticalDimensionBehaviour() == dimensionBehaviour) {
                this.f32558a.add(constraintWidget);
            }
        }
        constraintWidgetContainer.invalidateGraph();
    }
