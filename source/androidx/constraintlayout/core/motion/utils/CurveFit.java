...
public abstract class CurveFit {
    ...
    /* loaded from: classes2.dex */
    public static class C3676a extends CurveFit {

        /* renamed from: a */
        public double f32144a;

        /* renamed from: b */
        public double[] f32145b;

        public C3676a(double d, double[] dArr) {
            this.f32144a = d;
            this.f32145b = dArr;
        }
        ...
        public double[] getTimePoints() {
            return new double[]{this.f32144a};
        }
        ...
        public void getSlope(double d, double[] dArr) {
            for (int i = 0; i < this.f32145b.length; i++) {
                dArr[i] = 0.0d;
            }
        }
    ...
    public static CurveFit get(int i, double[] dArr, double[][] dArr2) {
        ...
        if (i != 0) {
            ...
            return new C3676a(dArr[0], dArr2[0]);
        }
