...
public class Utils {
    ...
    /* renamed from: a */
    public static DebugHandle f32285a;
    ...
    /* renamed from: a */
    public static int m58698a(int i) {
        int i2 = (i & (~(i >> 31))) - 255;
        return (i2 & (i2 >> 31)) + 255;
    }
    ...
    public static int rgbaTocColor(float f, float f2, float f3, float f4) {
        int m58698a = m58698a((int) (f * 255.0f));
        int m58698a2 = m58698a((int) (f2 * 255.0f));
        return (m58698a << 16) | (m58698a((int) (f4 * 255.0f)) << 24) | (m58698a2 << 8) | m58698a((int) (f3 * 255.0f));
    }
    ...
    public int getInterpolatedColor(float[] fArr) {
        int m58698a = m58698a((int) (((float) Math.pow(fArr[0], 0.45454545454545453d)) * 255.0f));
        int m58698a2 = m58698a((int) (((float) Math.pow(fArr[1], 0.45454545454545453d)) * 255.0f));
        return (m58698a((int) (fArr[3] * 255.0f)) << 24) | (m58698a << 16) | (m58698a2 << 8) | m58698a((int) (((float) Math.pow(fArr[2], 0.45454545454545453d)) * 255.0f));
    }
    ...
    public static void log(String str) {
        ...
        DebugHandle debugHandle = f32285a;
        if (debugHandle != null) {
