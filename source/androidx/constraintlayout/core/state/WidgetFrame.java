...
public class WidgetFrame {
    ...
    /* renamed from: a */
    public static void m58665a(StringBuilder sb, String str, float f) {
        if (Float.isNaN(f)) {
            return;
        }
        sb.append(str);
    ...
    /* renamed from: b */
    public static void m58664b(StringBuilder sb, String str, int i) {
        sb.append(str);
        sb.append(": ");
        sb.append(i);
        sb.append(",\n");
    ...
    /* renamed from: c */
    public static float m58663c(float f, float f2, float f3, float f4) {
    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        if (widgetFrame.widget != null && transition.hasPositionKeyframes()) {
            Transition.C3690a findPreviousPosition = transition.findPreviousPosition(widgetFrame.widget.stringId, i13);
            i6 = i15;
            Transition.C3690a findNextPosition = transition.findNextPosition(widgetFrame.widget.stringId, i13);
            if (findPreviousPosition == findNextPosition) {
                findNextPosition = null;
            }
            if (findPreviousPosition != null) {
                int i22 = (int) (findPreviousPosition.f32376d * i);
                i10 = i16;
                i9 = i2;
                i6 = (int) (findPreviousPosition.f32377e * i9);
                i11 = findPreviousPosition.f32373a;
                i7 = i22;
            } else {
                i9 = i2;
                i10 = i16;
            ...
            if (findNextPosition != null) {
                i8 = (int) (findNextPosition.f32376d * i);
                i17 = (int) (findNextPosition.f32377e * i9);
                i12 = findNextPosition.f32373a;
            } else {
                i12 = 100;
                i8 = i10;
            }
        ...
        int i24 = (int) (i7 + ((i8 - i7) * f6));
        widgetFrame.left = i24;
        int i25 = (int) (i23 + (f6 * (i17 - i23)));
        widgetFrame.top = i25;
        float f10 = 1.0f - f;
        widgetFrame.right = i24 + ((int) ((i3 * f10) + (i20 * f)));
        widgetFrame.bottom = i25 + ((int) ((f10 * i4) + (i21 * f)));
        widgetFrame.pivotX = m58663c(widgetFrame2.pivotX, widgetFrame3.pivotX, 0.5f, f);
        widgetFrame.pivotY = m58663c(widgetFrame2.pivotY, widgetFrame3.pivotY, 0.5f, f);
        widgetFrame.rotationX = m58663c(widgetFrame2.rotationX, widgetFrame3.rotationX, 0.0f, f);
        widgetFrame.rotationY = m58663c(widgetFrame2.rotationY, widgetFrame3.rotationY, 0.0f, f);
        widgetFrame.rotationZ = m58663c(widgetFrame2.rotationZ, widgetFrame3.rotationZ, 0.0f, f);
        widgetFrame.scaleX = m58663c(widgetFrame2.scaleX, widgetFrame3.scaleX, 1.0f, f);
        widgetFrame.scaleY = m58663c(widgetFrame2.scaleY, widgetFrame3.scaleY, 1.0f, f);
        widgetFrame.translationX = m58663c(widgetFrame2.translationX, widgetFrame3.translationX, 0.0f, f);
        widgetFrame.translationY = m58663c(widgetFrame2.translationY, widgetFrame3.translationY, 0.0f, f);
        widgetFrame.translationZ = m58663c(widgetFrame2.translationZ, widgetFrame3.translationZ, 0.0f, f);
        widgetFrame.alpha = m58663c(f3, f5, 1.0f, f);
        ...
        for (String str : keySet) {
            if (widgetFrame2.mCustom.containsKey(str)) {
                ...
                if (customVariable.numberOfInterpolatedValues() == 1) {
                    customVariable3.setValue(Float.valueOf(m58663c(customVariable.getValueToInterpolate(), customVariable2.getValueToInterpolate(), 0.0f, f)));
                } else {
                    ...
                    for (int i26 = 0; i26 < numberOfInterpolatedValues; i26++) {
                        fArr[i26] = m58663c(fArr[i26], fArr2[i26], 0.0f, f);
    ...
    /* renamed from: d */
    public void m58662d(CLElement cLElement) {
    ...
    /* renamed from: e */
    public final void m58661e(StringBuilder sb, ConstraintAnchor.Type type) {
    ...
    public StringBuilder serialize(StringBuilder sb, boolean z) {
        sb.append("{\n");
        m58664b(sb, "left", this.left);
        m58664b(sb, "top", this.top);
        m58664b(sb, "right", this.right);
        m58664b(sb, "bottom", this.bottom);
        m58665a(sb, "pivotX", this.pivotX);
        m58665a(sb, "pivotY", this.pivotY);
        m58665a(sb, "rotationX", this.rotationX);
        m58665a(sb, "rotationY", this.rotationY);
        m58665a(sb, "rotationZ", this.rotationZ);
        m58665a(sb, "translationX", this.translationX);
        m58665a(sb, "translationY", this.translationY);
        m58665a(sb, "translationZ", this.translationZ);
        m58665a(sb, "scaleX", this.scaleX);
        m58665a(sb, "scaleY", this.scaleY);
        m58665a(sb, "alpha", this.alpha);
        m58664b(sb, "visibility", this.visibility);
        m58665a(sb, "interpolatedPos", this.interpolatedPos);
        if (this.widget != null) {
        ...
        if (z) {
            m58665a(sb, "phone_orientation", phone_orientation);
        }
        if (z) {
            m58665a(sb, "phone_orientation", phone_orientation);
        }
