...
public class State {
    ...
    /* renamed from: a */
    public HashMap f32361a = new HashMap();
    ...
    public static /* synthetic */ class C3689a {
        ...
        static {
            ...
            try {
                f32363a[Helper.VERTICAL_CHAIN.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f32363a[Helper.ALIGN_HORIZONTALLY.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f32363a[Helper.ALIGN_VERTICALLY.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f32363a[Helper.BARRIER.ordinal()] = 5;
    ...
    /* renamed from: b */
    public Reference m58689b(Object obj) {
    ...
    public ArrayList<String> getIdsForTag(String str) {
        if (this.f32361a.containsKey(str)) {
            return (ArrayList) this.f32361a.get(str);
        }
        return null;
    }
    ...
    public HelperReference helper(Object obj, Helper helper) {
        ...
        if (helperReference == null) {
            int i = C3689a.f32363a[helper.ordinal()];
            if (i != 1) {
                if (i != 2) {
                    if (i != 3) {
                        if (i != 4) {
    ...
    public void setTag(String str, String str2) {
        ...
        if (constraints instanceof ConstraintReference) {
            ...
            if (!this.f32361a.containsKey(str2)) {
                arrayList = new ArrayList();
                this.f32361a.put(str2, arrayList);
            } else {
                arrayList = (ArrayList) this.f32361a.get(str2);
            }
            arrayList.add(str);
        }
    }
