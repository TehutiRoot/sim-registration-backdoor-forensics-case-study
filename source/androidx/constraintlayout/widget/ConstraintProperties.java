...
public class ConstraintProperties {
    ...
    /* renamed from: a */
    public ConstraintLayout.LayoutParams f33302a;
    ...
    public ConstraintProperties(View view) {
        ...
        if (layoutParams instanceof ConstraintLayout.LayoutParams) {
            this.f33302a = (ConstraintLayout.LayoutParams) layoutParams;
            this.f33303b = view;
            return;
        }
    ...
    /* renamed from: a */
    public final String m58125a(int i) {
        switch (i) {
            case 1:
                return "left";
            case 2:
    ...
    public ConstraintProperties addToHorizontalChain(int i, int i2) {
        ...
        connect(2, i2, i4, 0);
        if (i != 0) {
            new ConstraintProperties(((ViewGroup) this.f33303b.getParent()).findViewById(i)).connect(2, this.f33303b.getId(), 1, 0);
        }
        if (i2 != 0) {
            new ConstraintProperties(((ViewGroup) this.f33303b.getParent()).findViewById(i2)).connect(1, this.f33303b.getId(), 2, 0);
        }
        return this;
    }
    ...
    public ConstraintProperties addToHorizontalChainRTL(int i, int i2) {
        ...
        connect(7, i2, i4, 0);
        if (i != 0) {
            new ConstraintProperties(((ViewGroup) this.f33303b.getParent()).findViewById(i)).connect(7, this.f33303b.getId(), 6, 0);
        }
        if (i2 != 0) {
            new ConstraintProperties(((ViewGroup) this.f33303b.getParent()).findViewById(i2)).connect(6, this.f33303b.getId(), 7, 0);
        }
        return this;
    }
    ...
    public ConstraintProperties addToVerticalChain(int i, int i2) {
        ...
        connect(4, i2, i4, 0);
        if (i != 0) {
            new ConstraintProperties(((ViewGroup) this.f33303b.getParent()).findViewById(i)).connect(4, this.f33303b.getId(), 3, 0);
        }
        if (i2 != 0) {
            new ConstraintProperties(((ViewGroup) this.f33303b.getParent()).findViewById(i2)).connect(3, this.f33303b.getId(), 4, 0);
        }
        return this;
    }

    public ConstraintProperties alpha(float f) {
        this.f33303b.setAlpha(f);
        return this;
    }
                ...
                if (f > 0.0f && f <= 1.0f) {
                    if (i2 != 1 && i2 != 2) {
                        if (i2 != 6 && i2 != 7) {
                            connect(3, i, i2, i3);
                            connect(4, i4, i5, i6);
                            this.f33302a.verticalBias = f;
                        } else {
                            connect(6, i, i2, i3);
                            connect(7, i4, i5, i6);
                            this.f33302a.horizontalBias = f;
                        }
                    } else {
                        connect(1, i, i2, i3);
                        connect(2, i4, i5, i6);
    ...
    public ConstraintProperties connect(int i, int i2, int i3, int i4) {
        switch (i) {
            case 1:
                if (i3 == 1) {
                    ConstraintLayout.LayoutParams layoutParams = this.f33302a;
                    layoutParams.leftToLeft = i2;
                    layoutParams.leftToRight = -1;
                } else if (i3 == 2) {
                    ConstraintLayout.LayoutParams layoutParams2 = this.f33302a;
                    layoutParams2.leftToRight = i2;
                    layoutParams2.leftToLeft = -1;
                } else {
                    throw new IllegalArgumentException("Left to " + m58125a(i3) + " undefined");
                }
                ((ViewGroup.MarginLayoutParams) this.f33302a).leftMargin = i4;
                break;
            case 2:
                if (i3 == 1) {
                    ConstraintLayout.LayoutParams layoutParams3 = this.f33302a;
                    layoutParams3.rightToLeft = i2;
                    layoutParams3.rightToRight = -1;
                } else if (i3 == 2) {
                    ConstraintLayout.LayoutParams layoutParams4 = this.f33302a;
                    layoutParams4.rightToRight = i2;
                    layoutParams4.rightToLeft = -1;
                } else {
                    throw new IllegalArgumentException("right to " + m58125a(i3) + " undefined");
                }
                ((ViewGroup.MarginLayoutParams) this.f33302a).rightMargin = i4;
                break;
            case 3:
                if (i3 == 3) {
                    ConstraintLayout.LayoutParams layoutParams5 = this.f33302a;
                    ...
                    ConstraintLayout.LayoutParams layoutParams6 = this.f33302a;
                ...
                ((ViewGroup.MarginLayoutParams) this.f33302a).topMargin = i4;
                break;
            case 4:
                if (i3 == 4) {
                    ConstraintLayout.LayoutParams layoutParams7 = this.f33302a;
                    ...
                    ConstraintLayout.LayoutParams layoutParams8 = this.f33302a;
                ...
                ((ViewGroup.MarginLayoutParams) this.f33302a).bottomMargin = i4;
                break;
            case 5:
                if (i3 == 5) {
                    ConstraintLayout.LayoutParams layoutParams9 = this.f33302a;
                ...
                if (i3 == 3) {
                    ConstraintLayout.LayoutParams layoutParams10 = this.f33302a;
                    ...
                    ConstraintLayout.LayoutParams layoutParams11 = this.f33302a;
                ...
                this.f33302a.baselineMargin = i4;
                break;
            case 6:
                if (i3 == 6) {
                    ConstraintLayout.LayoutParams layoutParams12 = this.f33302a;
                    layoutParams12.startToStart = i2;
                    layoutParams12.startToEnd = -1;
                } else if (i3 == 7) {
                    ConstraintLayout.LayoutParams layoutParams13 = this.f33302a;
                    layoutParams13.startToEnd = i2;
                    layoutParams13.startToStart = -1;
                } else {
                    throw new IllegalArgumentException("right to " + m58125a(i3) + " undefined");
                }
                this.f33302a.setMarginStart(i4);
                break;
            case 7:
                if (i3 == 7) {
                    ConstraintLayout.LayoutParams layoutParams14 = this.f33302a;
                    layoutParams14.endToEnd = i2;
                    layoutParams14.endToStart = -1;
                } else if (i3 == 6) {
                    ConstraintLayout.LayoutParams layoutParams15 = this.f33302a;
                    layoutParams15.endToStart = i2;
                    layoutParams15.endToEnd = -1;
                } else {
                    throw new IllegalArgumentException("right to " + m58125a(i3) + " undefined");
                }
                this.f33302a.setMarginEnd(i4);
                break;
            default:
                throw new IllegalArgumentException(m58125a(i) + " to " + m58125a(i3) + " unknown");
        }
        return this;
    }

    public ConstraintProperties constrainDefaultHeight(int i) {
        this.f33302a.matchConstraintDefaultHeight = i;
        return this;
    }

    public ConstraintProperties constrainDefaultWidth(int i) {
        this.f33302a.matchConstraintDefaultWidth = i;
        return this;
    }

    public ConstraintProperties constrainHeight(int i) {
        ((ViewGroup.MarginLayoutParams) this.f33302a).height = i;
        return this;
    }

    public ConstraintProperties constrainMaxHeight(int i) {
        this.f33302a.matchConstraintMaxHeight = i;
        return this;
    }

    public ConstraintProperties constrainMaxWidth(int i) {
        this.f33302a.matchConstraintMaxWidth = i;
        return this;
    }

    public ConstraintProperties constrainMinHeight(int i) {
        this.f33302a.matchConstraintMinHeight = i;
        return this;
    }

    public ConstraintProperties constrainMinWidth(int i) {
        this.f33302a.matchConstraintMinWidth = i;
        return this;
    }

    public ConstraintProperties constrainWidth(int i) {
        ((ViewGroup.MarginLayoutParams) this.f33302a).width = i;
        return this;
    }

    public ConstraintProperties dimensionRatio(String str) {
        this.f33302a.dimensionRatio = str;
        return this;
    }

    public ConstraintProperties elevation(float f) {
        this.f33303b.setElevation(f);
        return this;
    }
    ...
    public ConstraintProperties goneMargin(int i, int i2) {
        switch (i) {
            case 1:
                this.f33302a.goneLeftMargin = i2;
                break;
            case 2:
                this.f33302a.goneRightMargin = i2;
                break;
            case 3:
                this.f33302a.goneTopMargin = i2;
                break;
            case 4:
                this.f33302a.goneBottomMargin = i2;
                break;
            case 5:
                throw new IllegalArgumentException("baseline does not support margins");
            case 6:
                this.f33302a.goneStartMargin = i2;
                break;
            case 7:
                this.f33302a.goneEndMargin = i2;
                break;
            default:
    ...
    public ConstraintProperties horizontalChainStyle(int i) {
        this.f33302a.horizontalChainStyle = i;
        return this;
    }

    public ConstraintProperties horizontalWeight(float f) {
        this.f33302a.horizontalWeight = f;
        return this;
    }
    ...
    public ConstraintProperties margin(int i, int i2) {
        switch (i) {
            case 1:
                ((ViewGroup.MarginLayoutParams) this.f33302a).leftMargin = i2;
                break;
            case 2:
                ((ViewGroup.MarginLayoutParams) this.f33302a).rightMargin = i2;
                break;
            case 3:
                ((ViewGroup.MarginLayoutParams) this.f33302a).topMargin = i2;
                break;
            case 4:
                ((ViewGroup.MarginLayoutParams) this.f33302a).bottomMargin = i2;
                break;
            case 5:
                throw new IllegalArgumentException("baseline does not support margins");
            case 6:
                this.f33302a.setMarginStart(i2);
                break;
            case 7:
                this.f33302a.setMarginEnd(i2);
                break;
            default:
                throw new IllegalArgumentException("unknown constraint");
        }
    ...
    public ConstraintProperties removeConstraints(int i) {
        switch (i) {
            ...
            case 4:
                ...
                break;
            case 5:
                this.f33302a.baselineToBaseline = -1;
                break;
            case 6:
                ConstraintLayout.LayoutParams layoutParams5 = this.f33302a;
                ...
                this.f33302a.goneStartMargin = Integer.MIN_VALUE;
                break;
            case 7:
                ConstraintLayout.LayoutParams layoutParams6 = this.f33302a;
                ...
                this.f33302a.goneEndMargin = Integer.MIN_VALUE;
                break;
            default:
                throw new IllegalArgumentException("unknown constraint");
        }
    ...
    public ConstraintProperties removeFromHorizontalChain() {
        ...
        if (i == -1 && i2 == -1) {
            ...
            if (i3 != -1 || i4 != -1) {
                ConstraintProperties constraintProperties = new ConstraintProperties(((ViewGroup) this.f33303b.getParent()).findViewById(i3));
                ConstraintProperties constraintProperties2 = new ConstraintProperties(((ViewGroup) this.f33303b.getParent()).findViewById(i4));
                ConstraintLayout.LayoutParams layoutParams2 = this.f33302a;
                if (i3 != -1 && i4 != -1) {
            ...
            ConstraintProperties constraintProperties3 = new ConstraintProperties(((ViewGroup) this.f33303b.getParent()).findViewById(i));
            ConstraintProperties constraintProperties4 = new ConstraintProperties(((ViewGroup) this.f33303b.getParent()).findViewById(i2));
            ConstraintLayout.LayoutParams layoutParams3 = this.f33302a;
            if (i != -1 && i2 != -1) {
    ...
    public ConstraintProperties removeFromVerticalChain() {
        ...
        if (i != -1 || i2 != -1) {
            ConstraintProperties constraintProperties = new ConstraintProperties(((ViewGroup) this.f33303b.getParent()).findViewById(i));
            ConstraintProperties constraintProperties2 = new ConstraintProperties(((ViewGroup) this.f33303b.getParent()).findViewById(i2));
            ConstraintLayout.LayoutParams layoutParams2 = this.f33302a;
            if (i != -1 && i2 != -1) {
    ...
    public ConstraintProperties transformPivot(float f, float f2) {
        this.f33303b.setPivotX(f);
        this.f33303b.setPivotY(f2);
        return this;
    }
    ...
    public ConstraintProperties transformPivotY(float f) {
        this.f33303b.setPivotY(f);
        return this;
    }

    public ConstraintProperties translation(float f, float f2) {
        this.f33303b.setTranslationX(f);
        this.f33303b.setTranslationY(f2);
        return this;
    }
    ...
    public ConstraintProperties translationY(float f) {
        this.f33303b.setTranslationY(f);
        return this;
    }

    public ConstraintProperties translationZ(float f) {
        this.f33303b.setTranslationZ(f);
        return this;
    }
