...
public class Constraints extends ViewGroup {
    ...
    /* renamed from: a */
    public final void m58049a(AttributeSet attributeSet) {
    }

    public ConstraintSet getConstraintSet() {
        if (this.f33357a == null) {
            this.f33357a = new ConstraintSet();
        }
        this.f33357a.clone(this);
        return this.f33357a;
    }
