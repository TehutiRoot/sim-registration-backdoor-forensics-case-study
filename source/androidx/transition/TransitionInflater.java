...
public class TransitionInflater {
    ...
    /* renamed from: b */
    public static final Class[] f37789b = {Context.class, AttributeSet.class};

    /* renamed from: c */
    public static final ArrayMap f37790c = new ArrayMap();
    ...
    /* renamed from: a */
    public final Object m52628a(AttributeSet attributeSet, Class cls, String str) {
        Object newInstance;
        Class<? extends U> asSubclass;
        String attributeValue = attributeSet.getAttributeValue(null, Action.CLASS_ATTRIBUTE);
        if (attributeValue != null) {
            try {
                ArrayMap arrayMap = f37790c;
                synchronized (arrayMap) {
                    Constructor constructor = (Constructor) arrayMap.get(attributeValue);
                    if (constructor == null && (asSubclass = Class.forName(attributeValue, false, this.f37791a.getClassLoader()).asSubclass(cls)) != 0) {
                        constructor = asSubclass.getConstructor(f37789b);
                        constructor.setAccessible(true);
                        arrayMap.put(attributeValue, constructor);
                    }
                    newInstance = constructor.newInstance(this.f37791a, attributeSet);
                }
                return newInstance;
            } catch (Exception e) {
    ...
    */
    public final androidx.transition.Transition m52627b(org.xmlpull.v1.XmlPullParser r8, android.util.AttributeSet r9, androidx.transition.Transition r10) {
        /*
            Method dump skipped, instructions count: 382
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.transition.TransitionInflater.m52627b(org.xmlpull.v1.XmlPullParser, android.util.AttributeSet, androidx.transition.Transition):androidx.transition.Transition");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final androidx.transition.TransitionManager m52626c(org.xmlpull.v1.XmlPullParser r5, android.util.AttributeSet r6, android.view.ViewGroup r7) {
        /*
            r4 = this;
            int r0 = r5.getDepth()
            r1 = 0
        ...
        L54:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.transition.TransitionInflater.m52626c(org.xmlpull.v1.XmlPullParser, android.util.AttributeSet, android.view.ViewGroup):androidx.transition.TransitionManager");
    }

    /* renamed from: d */
    public final void m52625d(XmlPullParser xmlPullParser, AttributeSet attributeSet, Transition transition) {
            ...
            if ((next != 3 || xmlPullParser.getDepth() > depth) && next != 1) {
                if (next == 2) {
                    if (xmlPullParser.getName().equals(TypedValues.AttributesType.S_TARGET)) {
                        TypedArray obtainStyledAttributes = this.f37791a.obtainStyledAttributes(attributeSet, AbstractC20550jO1.f67265a);
    ...
    /* renamed from: e */
    public final void m52624e(AttributeSet attributeSet, XmlPullParser xmlPullParser, ViewGroup viewGroup, TransitionManager transitionManager) {
        Scene sceneForLayout;
        Transition inflateTransition;
        TypedArray obtainStyledAttributes = this.f37791a.obtainStyledAttributes(attributeSet, AbstractC20550jO1.f67266b);
        ...
        if (namedResourceId2 < 0) {
            ...
            sceneForLayout = Scene.getSceneForLayout(viewGroup, namedResourceId2, this.f37791a);
        }
        ...
        if (namedResourceId3 >= 0) {
            scene = Scene.getSceneForLayout(viewGroup, namedResourceId3, this.f37791a);
        }
    ...
    public Transition inflateTransition(int i) {
        XmlResourceParser xml = this.f37791a.getResources().getXml(i);
        try {
            try {
                return m52627b(xml, Xml.asAttributeSet(xml), null);
            } catch (IOException e) {
    ...
    public TransitionManager inflateTransitionManager(int i, ViewGroup viewGroup) {
        ...
        try {
            try {
                return m52626c(xml, Xml.asAttributeSet(xml), viewGroup);
            } catch (IOException e) {
