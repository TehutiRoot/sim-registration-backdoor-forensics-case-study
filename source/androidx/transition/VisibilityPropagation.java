...
public abstract class VisibilityPropagation extends TransitionPropagation {
    ...
    /* renamed from: a */
    public static final String[] f37828a = {"android:visibilityPropagation:visibility", "android:visibilityPropagation:center"};

    /* renamed from: a */
    public static int m52603a(TransitionValues transitionValues, int i) {
        int[] iArr;
    ...
    public int getViewX(TransitionValues transitionValues) {
        return m52603a(transitionValues, 0);
    }

    public int getViewY(TransitionValues transitionValues) {
        return m52603a(transitionValues, 1);
    }
}
