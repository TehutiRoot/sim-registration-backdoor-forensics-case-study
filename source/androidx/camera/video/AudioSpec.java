...
import androidx.camera.video.C2627a;
...
public abstract class AudioSpec {
    ...
    public static Builder builder() {
        return new C2627a.C2629b().setSourceFormat(-1).setSource(-1).setChannelCount(-1).setBitrate(BITRATE_RANGE_AUTO).setSampleRate(SAMPLE_RATE_RANGE_AUTO);
    }
