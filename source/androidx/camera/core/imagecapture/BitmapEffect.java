...
public class BitmapEffect implements Operation<Packet<Bitmap>, Packet<Bitmap>> {
    ...
    /* renamed from: a */
    public final InternalImageProcessor f10998a;

    public BitmapEffect(InternalImageProcessor internalImageProcessor) {
        this.f10998a = internalImageProcessor;
    }

    @Override // androidx.camera.core.processing.Operation
    @NonNull
    public Packet<Bitmap> apply(@NonNull Packet<Bitmap> packet) throws ImageCaptureException {
        ImageProxy outputImage = this.f10998a.safeProcess(new ImageProcessorRequest(new RgbaImageProxy(packet), 1)).getOutputImage();
        ...
        return Packet.m62705of(createBitmapFromPlane, exif, packet.getCropRect(), packet.getRotationDegrees(), packet.getSensorToBufferTransform(), packet.getCameraCaptureResult());
    }
}
