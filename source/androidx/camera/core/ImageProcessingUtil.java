...
public final class ImageProcessingUtil {
    ...
    /* renamed from: a */
    public static /* synthetic */ void m63242a(ImageProxy imageProxy, ImageProxy imageProxy2, ImageProxy imageProxy3) {
        m63235h(imageProxy, imageProxy2, imageProxy3);
    }

    public static boolean applyPixelShiftForYUV(@NonNull ImageProxy imageProxy) {
        if (!m63237f(imageProxy)) {
            Logger.m63228e("ImageProcessingUtil", "Unsupported format for YUV to RGB");
            return false;
        } else if (m63240c(imageProxy) == Result.ERROR_CONVERSION) {
            Logger.m63228e("ImageProcessingUtil", "One pixel shift for YUV failure");
            return false;
        } else {
            return true;
        }
    ...
    /* renamed from: b */
    public static /* synthetic */ void m63241b(ImageProxy imageProxy, ImageProxy imageProxy2, ImageProxy imageProxy3) {
        m63236g(imageProxy, imageProxy2, imageProxy3);
    }

    /* renamed from: c */
    public static Result m63240c(ImageProxy imageProxy) {
    ...
    public static ImageProxy convertJpegBytesToImage(@NonNull ImageReaderProxy imageReaderProxy, @NonNull byte[] bArr) {
        ...
        if (nativeWriteJpegToSurface(bArr, surface) != 0) {
            Logger.m63228e("ImageProcessingUtil", "Failed to enqueue JPEG image.");
            return null;
        }
        ImageProxy acquireLatestImage = imageReaderProxy.acquireLatestImage();
        if (acquireLatestImage == null) {
            Logger.m63228e("ImageProcessingUtil", "Failed to get acquire JPEG image.");
        }
    ...
    @Nullable
    public static ImageProxy convertYUVToRGB(@NonNull final ImageProxy imageProxy, @NonNull ImageReaderProxy imageReaderProxy, @Nullable ByteBuffer byteBuffer, @IntRange(from = 0, m64742to = 359) int i, boolean z) {
        if (!m63237f(imageProxy)) {
            Logger.m63228e("ImageProcessingUtil", "Unsupported format for YUV to RGB");
            return null;
        }
        ...
        if (!m63238e(i)) {
            Logger.m63228e("ImageProcessingUtil", "Unsupported rotation degrees for rotate RGB");
            return null;
        } else if (m63239d(imageProxy, imageReaderProxy.getSurface(), byteBuffer, i, z) == Result.ERROR_CONVERSION) {
            Logger.m63228e("ImageProcessingUtil", "YUV to RGB conversion failure");
            return null;
        } else {
            if (Log.isLoggable("MH", 3)) {
                Logger.m63230d("ImageProcessingUtil", String.format(Locale.US, "Image processing performance profiling, duration: [%d], image count: %d", Long.valueOf(System.currentTimeMillis() - currentTimeMillis), Integer.valueOf(f10844a)));
                f10844a++;
            }
            final ImageProxy acquireLatestImage = imageReaderProxy.acquireLatestImage();
            if (acquireLatestImage == null) {
                Logger.m63228e("ImageProcessingUtil", "YUV to RGB acquireLatestImage failure");
                return null;
            }
            EJ1 ej1 = new EJ1(acquireLatestImage);
            ej1.addOnImageCloseListener(new ForwardingImageProxy.OnImageCloseListener() { // from class: kd0
                @Override // androidx.camera.core.ForwardingImageProxy.OnImageCloseListener
                public final void onImageClose(ImageProxy imageProxy2) {
                    ImageProcessingUtil.m63241b(ImageProxy.this, imageProxy, imageProxy2);
                }
            });
            return ej1;
        }
    ...
    public static boolean convertYuvToJpegBytesIntoSurface(@NonNull ImageProxy imageProxy, @IntRange(from = 1, m64742to = 100) int i, int i2, @NonNull Surface surface) {
        try {
            return writeJpegBytesToSurface(surface, ImageUtil.yuvImageToJpegByteArray(imageProxy, null, i, i2));
        } catch (ImageUtil.CodecFailedException e) {
            Logger.m63227e("ImageProcessingUtil", "Failed to encode YUV to JPEG", e);
            return false;
        }
    }
    ...
    /* renamed from: d */
    public static Result m63239d(ImageProxy imageProxy, Surface surface, ByteBuffer byteBuffer, int i, boolean z) {
        int i2;
        int i3;
        int i4;
        int width = imageProxy.getWidth();
    ...
    /* renamed from: e */
    public static boolean m63238e(int i) {
        return i == 0 || i == 90 || i == 180 || i == 270;
    }

    /* renamed from: f */
    public static boolean m63237f(ImageProxy imageProxy) {
    ...
    /* renamed from: g */
    public static /* synthetic */ void m63236g(ImageProxy imageProxy, ImageProxy imageProxy2, ImageProxy imageProxy3) {
    ...
    /* renamed from: h */
    public static /* synthetic */ void m63235h(ImageProxy imageProxy, ImageProxy imageProxy2, ImageProxy imageProxy3) {
        if (imageProxy != null && imageProxy2 != null) {
            imageProxy2.close();
        }
    }
    ...
    /* renamed from: i */
    public static Result m63234i(ImageProxy imageProxy, ImageWriter imageWriter, ByteBuffer byteBuffer, ByteBuffer byteBuffer2, ByteBuffer byteBuffer3, int i) {
        int width = imageProxy.getWidth();
        int height = imageProxy.getHeight();
        int rowStride = imageProxy.getPlanes()[0].getRowStride();
        int rowStride2 = imageProxy.getPlanes()[1].getRowStride();
    ...
    @Nullable
    public static ImageProxy rotateYUV(@NonNull final ImageProxy imageProxy, @NonNull ImageReaderProxy imageReaderProxy, @NonNull ImageWriter imageWriter, @NonNull ByteBuffer byteBuffer, @NonNull ByteBuffer byteBuffer2, @NonNull ByteBuffer byteBuffer3, @IntRange(from = 0, m64742to = 359) int i) {
        Result result;
        if (!m63237f(imageProxy)) {
            Logger.m63228e("ImageProcessingUtil", "Unsupported format for rotate YUV");
            return null;
        } else if (!m63238e(i)) {
            Logger.m63228e("ImageProcessingUtil", "Unsupported rotation degrees for rotate YUV");
            return null;
        } else {
            Result result2 = Result.ERROR_CONVERSION;
            if (Build.VERSION.SDK_INT >= 23 && i > 0) {
                result = m63234i(imageProxy, imageWriter, byteBuffer, byteBuffer2, byteBuffer3, i);
            } else {
                result = result2;
            }
            if (result == result2) {
                Logger.m63228e("ImageProcessingUtil", "rotate YUV failure");
                return null;
            }
            final ImageProxy acquireLatestImage = imageReaderProxy.acquireLatestImage();
            if (acquireLatestImage == null) {
                Logger.m63228e("ImageProcessingUtil", "YUV rotation acquireLatestImage failure");
                return null;
            }
            EJ1 ej1 = new EJ1(acquireLatestImage);
            ej1.addOnImageCloseListener(new ForwardingImageProxy.OnImageCloseListener() { // from class: ld0
                @Override // androidx.camera.core.ForwardingImageProxy.OnImageCloseListener
                public final void onImageClose(ImageProxy imageProxy2) {
                    ImageProcessingUtil.m63242a(ImageProxy.this, imageProxy, imageProxy2);
                }
            });
            return ej1;
        }
