...
import androidx.camera.core.impl.C2523h;
...
public abstract class StreamSpec {
    ...
    public static Builder builder(@NonNull Size size) {
        return new C2523h.C2525b().setResolution(size).setExpectedFrameRateRange(FRAME_RATE_RANGE_UNSPECIFIED).setDynamicRange(DynamicRange.SDR);
    }
