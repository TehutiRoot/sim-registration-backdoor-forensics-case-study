...
public class JpegMetadataCorrector {
    ...
    /* renamed from: a */
    public final IncorrectJpegMetadataQuirk f11372a;

    public JpegMetadataCorrector(@NonNull Quirks quirks) {
        this.f11372a = (IncorrectJpegMetadataQuirk) quirks.get(IncorrectJpegMetadataQuirk.class);
    }

    @NonNull
    public byte[] jpegImageToJpegByteArray(@NonNull ImageProxy imageProxy) {
        IncorrectJpegMetadataQuirk incorrectJpegMetadataQuirk = this.f11372a;
