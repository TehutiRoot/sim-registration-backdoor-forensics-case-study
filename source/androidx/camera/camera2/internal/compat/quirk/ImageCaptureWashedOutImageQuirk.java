...
public class ImageCaptureWashedOutImageQuirk implements UseTorchAsFlashQuirk {
    ...
    /* renamed from: a */
    public static boolean m63599a(CameraCharacteristicsCompat cameraCharacteristicsCompat) {
        if (BUILD_MODELS.contains(Build.MODEL.toUpperCase(Locale.US)) && ((Integer) cameraCharacteristicsCompat.get(CameraCharacteristics.LENS_FACING)).intValue() == 1) {
            return true;
        }
        return false;
    }
