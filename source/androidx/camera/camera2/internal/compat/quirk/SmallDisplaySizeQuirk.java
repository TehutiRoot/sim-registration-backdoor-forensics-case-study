...
public class SmallDisplaySizeQuirk implements Quirk {
    ...
    /* renamed from: a */
    public static final Map f10542a;
    ...
    /* renamed from: a */
    public static boolean m63585a() {
        return f10542a.containsKey(Build.MODEL.toUpperCase(Locale.US));
    }

    @NonNull
    public Size getDisplaySize() {
        return (Size) f10542a.get(Build.MODEL.toUpperCase(Locale.US));
    }
}
