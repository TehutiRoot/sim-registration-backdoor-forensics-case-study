...
public final class DynamicRangeConversions {
    ...
    /* renamed from: a */
    public static final Map f10492a;

    /* renamed from: b */
    public static final Map f10493b;
    ...
    static {
        ...
        for (Long l : asList) {
            f10492a.put(l, DynamicRange.DOLBY_VISION_10_BIT);
        }
        f10493b.put(DynamicRange.DOLBY_VISION_10_BIT, asList);
        List<Long> asList2 = Arrays.asList(1024L, Long.valueOf((long) PlaybackStateCompat.ACTION_PLAY_FROM_SEARCH), 256L, 512L);
        for (Long l2 : asList2) {
            f10492a.put(l2, DynamicRange.DOLBY_VISION_8_BIT);
        }
        f10493b.put(DynamicRange.DOLBY_VISION_8_BIT, asList2);
    }
    ...
    public static Long dynamicRangeToFirstSupportedProfile(@NonNull DynamicRange dynamicRange, @NonNull DynamicRangeProfiles dynamicRangeProfiles) {
        ...
        List<Long> list = (List) f10493b.get(dynamicRange);
        if (list != null) {
    ...
    public static DynamicRange profileToDynamicRange(long j) {
        return (DynamicRange) f10492a.get(Long.valueOf(j));
    }
}
