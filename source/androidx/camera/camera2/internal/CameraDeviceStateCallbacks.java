...
public final class CameraDeviceStateCallbacks {
    ...
    /* loaded from: classes.dex */
    public static final class C2358a extends CameraDevice.StateCallback {

        /* renamed from: a */
        public final List f10379a = new ArrayList();

        public C2358a(List list) {
            Iterator it = list.iterator();
            while (it.hasNext()) {
                CameraDevice.StateCallback stateCallback = (CameraDevice.StateCallback) it.next();
                if (!(stateCallback instanceof C2359b)) {
                    this.f10379a.add(stateCallback);
                }
            }
        }
        ...
        public void onClosed(CameraDevice cameraDevice) {
            for (CameraDevice.StateCallback stateCallback : this.f10379a) {
    ...
    /* loaded from: classes.dex */
    public static final class C2359b extends CameraDevice.StateCallback {
        @Override // android.hardware.camera2.CameraDevice.StateCallback
        public void onClosed(CameraDevice cameraDevice) {
        }
