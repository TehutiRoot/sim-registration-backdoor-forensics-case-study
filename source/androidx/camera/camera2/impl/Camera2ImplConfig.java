...
public final class Camera2ImplConfig extends CaptureRequestOptions {
    ...
    public static final class Builder implements ExtendableBuilder<Camera2ImplConfig> {
        ...
        /* renamed from: a */
        public final MutableOptionsBundle f10255a = MutableOptionsBundle.create();
        ...
        public Builder insertAllOptions(@NonNull Config config) {
            for (Config.Option<?> option : config.listOptions()) {
                this.f10255a.insertOption(option, config.retrieveOption(option));
            }
            return this;
        }
        ...
        public <ValueT> Builder setCaptureRequestOption(@NonNull CaptureRequest.Key<ValueT> key, @NonNull ValueT valuet) {
            this.f10255a.insertOption(Camera2ImplConfig.createCaptureRequestOption(key), valuet);
            return this;
        }
        ...
        public <ValueT> Builder setCaptureRequestOptionWithPriority(@NonNull CaptureRequest.Key<ValueT> key, @NonNull ValueT valuet, @NonNull Config.OptionPriority optionPriority) {
            this.f10255a.insertOption(Camera2ImplConfig.createCaptureRequestOption(key), optionPriority, valuet);
            return this;
        }
        ...
        public Camera2ImplConfig build() {
            return new Camera2ImplConfig(OptionsBundle.from(this.f10255a));
        }
    }
    ...
    public static final class Extender<T> {
        ...
        /* renamed from: a */
        public ExtendableBuilder f10256a;

        public Extender(@NonNull ExtendableBuilder<T> extendableBuilder) {
            this.f10256a = extendableBuilder;
        }

        @NonNull
        public Extender<T> setCameraEventCallback(@NonNull CameraEventCallbacks cameraEventCallbacks) {
            this.f10256a.getMutableConfig().insertOption(Camera2ImplConfig.CAMERA_EVENT_CALLBACK_OPTION, cameraEventCallbacks);
            return this;
        }
    }
