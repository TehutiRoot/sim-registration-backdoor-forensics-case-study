...
public class PreviewProcessor {
    ...
    @NonNull
    final C2584b mCaptureResultImageMatcher = new C2584b();
    ...
    /* renamed from: a */
    public static /* synthetic */ void m62574a(PreviewProcessor previewProcessor, OnCaptureResultCallback onCaptureResultCallback, ImageReference imageReference, TotalCaptureResult totalCaptureResult, int i) {
    ...
    public void notifyCaptureResult(@NonNull TotalCaptureResult totalCaptureResult) {
        this.mCaptureResultImageMatcher.m62566a(totalCaptureResult);
    }
    ...
    public void start(@NonNull final OnCaptureResultCallback onCaptureResultCallback) {
        this.mCaptureResultImageMatcher.m62557j(new C2584b.InterfaceC2585a() { // from class: androidx.camera.extensions.internal.sessionprocessor.c
            {
                PreviewProcessor.this = this;
            }
            ...
            public final void mo62550a(ImageReference imageReference, TotalCaptureResult totalCaptureResult, int i) {
                PreviewProcessor.m62574a(PreviewProcessor.this, onCaptureResultCallback, imageReference, totalCaptureResult, i);
            }
        });
    }
}
