...
public final class ExtensionsUseCaseConfigFactory implements UseCaseConfigFactory {
    ...
    /* renamed from: a */
    public final ImageCaptureConfigProvider f11515a;

    /* renamed from: b */
    public final PreviewConfigProvider f11516b;

    /* renamed from: c */
    public final ImageAnalysisConfigProvider f11517c;

    /* renamed from: androidx.camera.extensions.internal.ExtensionsUseCaseConfigFactory$a */
    /* loaded from: classes.dex */
    public static /* synthetic */ class C2573a {
        ...
        static {
            ...
            try {
                f11518a[UseCaseConfigFactory.CaptureType.PREVIEW.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f11518a[UseCaseConfigFactory.CaptureType.IMAGE_ANALYSIS.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f11518a[UseCaseConfigFactory.CaptureType.VIDEO_CAPTURE.ordinal()] = 4;
    ...
    public ExtensionsUseCaseConfigFactory(int i, @NonNull VendorExtender vendorExtender) {
        this.f11515a = new ImageCaptureConfigProvider(i, vendorExtender);
        this.f11516b = new PreviewConfigProvider(i, vendorExtender);
        this.f11517c = new ImageAnalysisConfigProvider(vendorExtender);
    }

    /* renamed from: a */
    public final boolean m62605a(List list) {
        if (list == null) {
            return false;
        }
    ...
    public Config getConfig(@NonNull UseCaseConfigFactory.CaptureType captureType, int i) {
        ...
        int i2 = C2573a.f11518a[captureType.ordinal()];
        if (i2 != 1) {
            if (i2 != 2) {
                if (i2 != 3) {
                    if (i2 != 4) {
                ...
                ImageAnalysisConfig config = this.f11517c.getConfig();
                if (m62605a(config.getSupportedResolutions(null))) {
                ...
                from = MutableOptionsBundle.from((Config) this.f11516b.getConfig());
            }
        } else {
            from = MutableOptionsBundle.from((Config) this.f11515a.getConfig());
        }
