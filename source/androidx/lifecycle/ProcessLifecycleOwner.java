...
public final class ProcessLifecycleOwner implements LifecycleOwner {
    ...
    /* renamed from: e */
    public Handler f35821e;
    @NotNull
    public static final Companion Companion = new Companion(null);

    /* renamed from: i */
    public static final ProcessLifecycleOwner f35816i = new ProcessLifecycleOwner();

    /* renamed from: c */
    public boolean f35819c = true;

    /* renamed from: d */
    public boolean f35820d = true;

    /* renamed from: f */
    public final LifecycleRegistry f35822f = new LifecycleRegistry(this);

    /* renamed from: g */
    public final Runnable f35823g = new Runnable() { // from class: Wn1
        {
            ProcessLifecycleOwner.this = this;
        }

        @Override // java.lang.Runnable
        public final void run() {
            ProcessLifecycleOwner.m54110a(ProcessLifecycleOwner.this);
        }
    };

    /* renamed from: h */
    public final ReportFragment.ActivityInitializationListener f35824h = new ReportFragment.ActivityInitializationListener() { // from class: androidx.lifecycle.ProcessLifecycleOwner$initializationListener$1
    ...
    @RequiresApi(29)
    @Metadata(m28851d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bÁ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0018\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0007¨\u0006\t"}, m28850d2 = {"Landroidx/lifecycle/ProcessLifecycleOwner$Api29Impl;", "", "()V", "registerActivityLifecycleCallbacks", "", "activity", "Landroid/app/Activity;", "callback", "Landroid/app/Application$ActivityLifecycleCallbacks;", "lifecycle-process_release"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    /* loaded from: classes2.dex */
    ...
    @Metadata(m28851d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\b\u0010\b\u001a\u00020\tH\u0007J\u0015\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\rH\u0001¢\u0006\u0002\b\u000eR\u0016\u0010\u0003\u001a\u00020\u00048\u0000X\u0081T¢\u0006\b\n\u0000\u0012\u0004\b\u0005\u0010\u0002R\u000e\u0010\u0006\u001a\u00020\u0007X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u000f"}, m28850d2 = {"Landroidx/lifecycle/ProcessLifecycleOwner$Companion;", "", "()V", "TIMEOUT_MS", "", "getTIMEOUT_MS$lifecycle_process_release$annotations", "newInstance", "Landroidx/lifecycle/ProcessLifecycleOwner;", "get", "Landroidx/lifecycle/LifecycleOwner;", "init", "", CoreConstants.CONTEXT_SCOPE_VALUE, "Landroid/content/Context;", "init$lifecycle_process_release", "lifecycle-process_release"}, m28849k = 1, m28848mv = {1, 8, 0}, m28846xi = 48)
    /* loaded from: classes2.dex */
    public static final class Companion {
        ...
        public final LifecycleOwner get() {
            return ProcessLifecycleOwner.f35816i;
        }

        @JvmStatic
        public final void init$lifecycle_process_release(@NotNull Context context) {
            Intrinsics.checkNotNullParameter(context, "context");
            ProcessLifecycleOwner.f35816i.attach$lifecycle_process_release(context);
        }
    ...
    /* renamed from: a */
    public static /* synthetic */ void m54110a(ProcessLifecycleOwner processLifecycleOwner) {
        m54109b(processLifecycleOwner);
    }
    ...
    public static final /* synthetic */ ReportFragment.ActivityInitializationListener access$getInitializationListener$p(ProcessLifecycleOwner processLifecycleOwner) {
        return processLifecycleOwner.f35824h;
    }

    /* renamed from: b */
    public static final void m54109b(ProcessLifecycleOwner this$0) {
    ...
    public final void activityPaused$lifecycle_process_release() {
        int i = this.f35818b - 1;
        this.f35818b = i;
        if (i == 0) {
            Handler handler = this.f35821e;
            Intrinsics.checkNotNull(handler);
            handler.postDelayed(this.f35823g, 700L);
        }
    }
    ...
    public final void activityResumed$lifecycle_process_release() {
        ...
        if (i == 1) {
            if (this.f35819c) {
                this.f35822f.handleLifecycleEvent(Lifecycle.Event.ON_RESUME);
                this.f35819c = false;
                return;
            }
            Handler handler = this.f35821e;
            Intrinsics.checkNotNull(handler);
            handler.removeCallbacks(this.f35823g);
        }
    }

    public final void activityStarted$lifecycle_process_release() {
        int i = this.f35817a + 1;
        this.f35817a = i;
        if (i == 1 && this.f35820d) {
            this.f35822f.handleLifecycleEvent(Lifecycle.Event.ON_START);
            this.f35820d = false;
        }
    }
    ...
    public final void attach$lifecycle_process_release(@NotNull Context context) {
        Intrinsics.checkNotNullParameter(context, "context");
        this.f35821e = new Handler();
        this.f35822f.handleLifecycleEvent(Lifecycle.Event.ON_CREATE);
    ...
    public final void dispatchPauseIfNeeded$lifecycle_process_release() {
        if (this.f35818b == 0) {
            this.f35819c = true;
            this.f35822f.handleLifecycleEvent(Lifecycle.Event.ON_PAUSE);
        }
    }

    public final void dispatchStopIfNeeded$lifecycle_process_release() {
        if (this.f35817a == 0 && this.f35819c) {
            this.f35822f.handleLifecycleEvent(Lifecycle.Event.ON_STOP);
            this.f35820d = true;
        }
    }
