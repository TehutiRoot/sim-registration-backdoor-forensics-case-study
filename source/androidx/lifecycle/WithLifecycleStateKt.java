...
public final class WithLifecycleStateKt {
    ...
    /* loaded from: classes2.dex */
    public static final class RunnableC4684a implements Runnable {

        /* renamed from: a */
        public final /* synthetic */ Lifecycle f35884a;

        /* renamed from: b */
        public final /* synthetic */ C4686xfdb59cc4 f35885b;

        public RunnableC4684a(Lifecycle lifecycle, C4686xfdb59cc4 c4686xfdb59cc4) {
            this.f35884a = lifecycle;
            this.f35885b = c4686xfdb59cc4;
        }

        @Override // java.lang.Runnable
        public final void run() {
            this.f35884a.addObserver(this.f35885b);
        }
    }
    ...
    @PublishedApi
    @Nullable
    public static final <R> Object suspendWithStateAtLeastUnchecked(@NotNull final Lifecycle lifecycle, @NotNull final Lifecycle.State state, boolean z, @NotNull CoroutineDispatcher coroutineDispatcher, @NotNull final Function0<? extends R> function0, @NotNull Continuation<? super R> continuation) {
            ...
            public void onStateChanged(@NotNull LifecycleOwner lifecycleOwner, @NotNull Lifecycle.Event event) {
                ...
                if (event == Lifecycle.Event.Companion.upTo(Lifecycle.State.this)) {
                    ...
                    try {
                        ...
                        m74087constructorimpl = Result.m74087constructorimpl(function02.invoke());
                    } catch (Throwable th2) {
                    ...
                    cancellableContinuation2.resumeWith(Result.m74087constructorimpl(ResultKt.createFailure(new LifecycleDestroyedException())));
                }
            }
        };
        if (z) {
            coroutineDispatcher.dispatch(EmptyCoroutineContext.INSTANCE, new RunnableC4684a(lifecycle, r1));
        } else {
            lifecycle.addObserver(r1);
        }
        cancellableContinuationImpl.invokeOnCancellation(new WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$2$2(coroutineDispatcher, lifecycle, r1));
