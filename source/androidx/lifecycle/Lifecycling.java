...
public final class Lifecycling {
    ...
    /* renamed from: a */
    public static final Map f35787a = new HashMap();

    /* renamed from: b */
    public static final Map f35788b = new HashMap();

    @JvmStatic
    @NotNull
    public static final String getAdapterName(@NotNull String className) {
        Intrinsics.checkNotNullParameter(className, "className");
        return AbstractC20204hN1.replace$default(className, ".", "_", false, 4, (Object) null) + "_LifecycleAdapter";
    }
    ...
    public static final LifecycleEventObserver lifecycleEventObserver(@NotNull Object object) {
        ...
        if (lifecycling.m54124c(cls) == 2) {
            Object obj = f35788b.get(cls);
            Intrinsics.checkNotNull(obj);
            List list = (List) obj;
            if (list.size() == 1) {
                return new SingleGeneratedAdapterObserver(lifecycling.m54126a((Constructor) list.get(0), object));
            }
            int size = list.size();
            GeneratedAdapter[] generatedAdapterArr = new GeneratedAdapter[size];
            for (int i = 0; i < size; i++) {
                generatedAdapterArr[i] = INSTANCE.m54126a((Constructor) list.get(i), object);
            }
            return new CompositeGeneratedAdaptersObserver(generatedAdapterArr);
        }
        return new C4702d(object);
    }

    /* renamed from: a */
    public final GeneratedAdapter m54126a(Constructor constructor, Object obj) {
        try {
    ...
    /* renamed from: b */
    public final Constructor m54125b(Class cls) {
        String fullPackage;
        try {
    ...
    /* renamed from: c */
    public final int m54124c(Class cls) {
        Map map = f35787a;
        Integer num = (Integer) map.get(cls);
        if (num != null) {
            return num.intValue();
        }
        int m54122e = m54122e(cls);
        map.put(cls, Integer.valueOf(m54122e));
        return m54122e;
    }

    /* renamed from: d */
    public final boolean m54123d(Class cls) {
    ...
    /* renamed from: e */
    public final int m54122e(Class cls) {
        ArrayList arrayList;
        if (cls.getCanonicalName() == null) {
            return 1;
        }
        Constructor m54125b = m54125b(cls);
        if (m54125b != null) {
            f35788b.put(cls, AbstractC10108ds.listOf(m54125b));
            return 2;
        } else if (C4687a.f35892c.m54087d(cls)) {
            return 1;
        } else {
            Class superclass = cls.getSuperclass();
            if (m54123d(superclass)) {
                Intrinsics.checkNotNullExpressionValue(superclass, "superclass");
                if (m54124c(superclass) == 1) {
                    return 1;
                }
                Object obj = f35788b.get(superclass);
                Intrinsics.checkNotNull(obj);
            ...
            for (Class<?> intrface : interfaces) {
                if (m54123d(intrface)) {
                    ...
                    if (m54124c(intrface) == 1) {
                        return 1;
                    }
                    if (arrayList == null) {
                        arrayList = new ArrayList();
                    }
                    Object obj2 = f35788b.get(intrface);
