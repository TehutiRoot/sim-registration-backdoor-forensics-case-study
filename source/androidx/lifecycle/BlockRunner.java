...
public final class BlockRunner<T> {
    ...
    public final void cancel() {
        ...
        if (this.f35742g == null) {
            m65753e = AbstractC1552Vc.m65753e(this.f35739d, Dispatchers.getMain().getImmediate(), null, new BlockRunner$cancel$1(this, null), 2, null);
            this.f35742g = m65753e;
            return;
        }
    ...
    public final void maybeRun() {
        Job m65753e;
        Job job = this.f35742g;
        if (job != null) {
            Job.DefaultImpls.cancel$default(job, (CancellationException) null, 1, (Object) null);
        }
        this.f35742g = null;
        if (this.f35741f == null) {
            m65753e = AbstractC1552Vc.m65753e(this.f35739d, null, null, new BlockRunner$maybeRun$1(this, null), 3, null);
            this.f35741f = m65753e;
        }
    }
}
