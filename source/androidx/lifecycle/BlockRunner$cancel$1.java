...
@DebugMetadata(m28801c = "androidx.lifecycle.BlockRunner$cancel$1", m28800f = "CoroutineLiveData.kt", m28799i = {}, m28798l = {188}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
...
public final class BlockRunner$cancel$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i != 0) {
            ...
            ResultKt.throwOnFailure(obj);
            j = this.this$0.f35738c;
            this.label = 1;
            if (DelayKt.delay(j, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        }
        coroutineLiveData = this.this$0.f35736a;
        if (!coroutineLiveData.hasActiveObservers()) {
            job = this.this$0.f35741f;
            if (job != null) {
                Job.DefaultImpls.cancel$default(job, (CancellationException) null, 1, (Object) null);
            }
            this.this$0.f35741f = null;
        }
