...
@DebugMetadata(m28801c = "androidx.lifecycle.LifecycleCoroutineScopeImpl$register$1", m28800f = "Lifecycle.kt", m28799i = {}, m28798l = {}, m28797m = "invokeSuspend", m28796n = {}, m28795s = {})
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ...
            if (this.this$0.getLifecycle$lifecycle_common().getCurrentState().compareTo(Lifecycle.State.INITIALIZED) < 0) {
                AbstractC12039a.m27310i(coroutineScope.getCoroutineContext(), null, 1, null);
            } else {
