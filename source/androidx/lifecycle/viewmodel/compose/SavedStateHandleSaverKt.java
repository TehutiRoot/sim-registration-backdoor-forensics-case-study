...
public final class SavedStateHandleSaverKt {
    ...
    /* loaded from: classes2.dex */
    public /* synthetic */ class C4723a implements SaverScope, FunctionAdapter {

        /* renamed from: a */
        public final /* synthetic */ SavedStateHandle.Companion f35933a;

        public C4723a(SavedStateHandle.Companion companion) {
            this.f35933a = companion;
        }

        @Override // androidx.compose.runtime.saveable.SaverScope
        public final boolean canBeSaved(Object obj) {
            return this.f35933a.validateValue(obj);
        }
        ...
        public final Function getFunctionDelegate() {
            return new FunctionReferenceImpl(1, this.f35933a, SavedStateHandle.Companion.class, "validateValue", "validateValue(Ljava/lang/Object;)Z", 0);
        }
    ...
    /* renamed from: a */
    public static /* synthetic */ Bundle m54076a(Saver saver, Object obj) {
        return m54071f(saver, obj);
    }

    /* renamed from: b */
    public static /* synthetic */ ReadOnlyProperty m54075b(SavedStateHandle savedStateHandle, Saver saver, Function0 function0, Object obj, KProperty kProperty) {
        return m54070g(savedStateHandle, saver, function0, obj, kProperty);
    }

    /* renamed from: c */
    public static /* synthetic */ ReadWriteProperty m54074c(SavedStateHandle savedStateHandle, Saver saver, Function0 function0, Object obj, KProperty kProperty) {
        return m54068i(savedStateHandle, saver, function0, obj, kProperty);
    }

    /* renamed from: d */
    public static /* synthetic */ Object m54073d(Object obj, Object obj2, KProperty kProperty) {
        return m54069h(obj, obj2, kProperty);
    }

    /* renamed from: e */
    public static final Saver m54072e(Saver saver) {
    ...
    /* renamed from: f */
    public static final Bundle m54071f(Saver saver, Object obj) {
        return BundleKt.bundleOf(TuplesKt.m28844to("value", saver.save(new C4723a(SavedStateHandle.Companion), obj)));
    }

    /* renamed from: g */
    public static final ReadOnlyProperty m54070g(SavedStateHandle savedStateHandle, Saver saver, Function0 function0, Object obj, KProperty kProperty) {
        final Object m73910saveable = m73910saveable(savedStateHandle, kProperty.getName(), (Saver<Object, ? extends Object>) saver, (Function0<? extends Object>) function0);
        return new ReadOnlyProperty() { // from class: lE1
            @Override // kotlin.properties.ReadOnlyProperty
            public final Object getValue(Object obj2, KProperty kProperty2) {
                return SavedStateHandleSaverKt.m54073d(m73910saveable, obj2, kProperty2);
            }
        };
    }

    /* renamed from: h */
    public static final Object m54069h(Object obj, Object obj2, KProperty kProperty) {
        return obj;
    }

    /* renamed from: i */
    public static final ReadWriteProperty m54068i(SavedStateHandle savedStateHandle, Saver saver, Function0 function0, Object obj, KProperty kProperty) {
    ...
    public static final <T> T m73910saveable(@NotNull SavedStateHandle savedStateHandle, @NotNull String str, @NotNull final Saver<T, ? extends Object> saver, @NotNull Function0<? extends T> function0) {
        final T invoke;
        Object obj;
        ...
        savedStateHandle.setSavedStateProvider(str, new SavedStateRegistry.SavedStateProvider() { // from class: jE1
            @Override // androidx.savedstate.SavedStateRegistry.SavedStateProvider
            public final Bundle saveState() {
                return SavedStateHandleSaverKt.m54076a(Saver.this, invoke);
            }
        });
        return invoke;
    }
    ...
    public static /* synthetic */ Object saveable$default(SavedStateHandle savedStateHandle, String str, Saver saver, Function0 function0, int i, Object obj) {
        ...
        return m73910saveable(savedStateHandle, str, (Saver<Object, ? extends Object>) saver, (Function0<? extends Object>) function0);
    }
    ...
    public static final <T, M extends MutableState<T>> PropertyDelegateProvider<Object, ReadWriteProperty<Object, T>> saveableMutableState(@NotNull final SavedStateHandle savedStateHandle, @NotNull final Saver<T, ? extends Object> saver, @NotNull final Function0<? extends M> function0) {
        return new PropertyDelegateProvider() { // from class: kE1
            @Override // kotlin.properties.PropertyDelegateProvider
            public final Object provideDelegate(Object obj, KProperty kProperty) {
                return SavedStateHandleSaverKt.m54074c(SavedStateHandle.this, saver, function0, obj, kProperty);
            }
        };
    }
    ...
    public static final <T> MutableState<T> saveable(@NotNull SavedStateHandle savedStateHandle, @NotNull String str, @NotNull Saver<T, ? extends Object> saver, @NotNull Function0<? extends MutableState<T>> function0) {
        return (MutableState) m73910saveable(savedStateHandle, str, (Saver<Object, ? extends Object>) m54072e(saver), (Function0<? extends Object>) function0);
    }
    ...
    public static final <T> PropertyDelegateProvider<Object, ReadOnlyProperty<Object, T>> saveable(@NotNull final SavedStateHandle savedStateHandle, @NotNull final Saver<T, ? extends Object> saver, @NotNull final Function0<? extends T> function0) {
        return new PropertyDelegateProvider() { // from class: iE1
            @Override // kotlin.properties.PropertyDelegateProvider
            public final Object provideDelegate(Object obj, KProperty kProperty) {
                return SavedStateHandleSaverKt.m54075b(SavedStateHandle.this, saver, function0, obj, kProperty);
            }
        };
    }
}
