...
public abstract class Synchronized {
    ...
    public static final class SynchronizedAsMap<K, V> extends SynchronizedMap<K, Collection<V>> {
        ...
        public Collection<V> get(@CheckForNull Object obj) {
            Collection<V> m40507A;
            synchronized (this.mutex) {
                Collection collection = (Collection) super.get(obj);
                m40507A = collection == null ? null : Synchronized.m40507A(collection, this.mutex);
            }
            return m40507A;
        }
    }
    ...
    public static final class SynchronizedAsMapValues<V> extends SynchronizedCollection<Collection<V>> {
        ...
        /* loaded from: classes4.dex */
        public class C7885a extends VV1 {
            public C7885a(Iterator it) {
                super(it);
            }

            @Override // p000.VV1
            /* renamed from: b */
            public Collection mo40358a(Collection collection) {
                return Synchronized.m40507A(collection, SynchronizedAsMapValues.this.mutex);
            }
        }
        ...
        public Iterator<Collection<V>> iterator() {
            return new C7885a(super.iterator());
        }
    }
            ...
            synchronized (this.mutex) {
                try {
                    if (this.valueSet == null) {
                        this.valueSet = Synchronized.m40485u(delegate().values(), this.mutex);
                    }
                    set = this.valueSet;
                } catch (Throwable th2) {
                    throw th2;
    ...
    public static class SynchronizedList<E> extends SynchronizedCollection<E> implements List<E> {
        ...
        public List<E> subList(int i, int i2) {
            List<E> m40496j;
            synchronized (this.mutex) {
                m40496j = Synchronized.m40496j(delegate().subList(i, i2), this.mutex);
            }
            return m40496j;
        }
    ...
    public static final class SynchronizedListMultimap<K, V> extends SynchronizedMultimap<K, V> implements ListMultimap<K, V> {
        ...
        public List<V> get(K k) {
            List<V> m40496j;
            synchronized (this.mutex) {
                m40496j = Synchronized.m40496j(delegate().get((ListMultimap<K, V>) k), this.mutex);
            }
            return m40496j;
        }
    ...
    public static class SynchronizedMap<K, V> extends SynchronizedObject implements Map<K, V> {
            ...
            synchronized (this.mutex) {
                try {
                    if (this.entrySet == null) {
                        this.entrySet = Synchronized.m40485u(delegate().entrySet(), this.mutex);
                    }
                    set = this.entrySet;
                } catch (Throwable th2) {
                    throw th2;
        ...
        public Set<K> keySet() {
            ...
            synchronized (this.mutex) {
                try {
                    if (this.keySet == null) {
                        this.keySet = Synchronized.m40485u(delegate().keySet(), this.mutex);
                    }
                    set = this.keySet;
                } catch (Throwable th2) {
                    throw th2;
        ...
        public Collection<V> values() {
            ...
            synchronized (this.mutex) {
                try {
                    if (this.values == null) {
                        this.values = Synchronized.m40498h(delegate().values(), this.mutex);
                    }
    ...
    public static class SynchronizedMultimap<K, V> extends SynchronizedObject implements Multimap<K, V> {
            ...
            synchronized (this.mutex) {
                try {
                    if (this.entries == null) {
                        this.entries = Synchronized.m40507A(delegate().entries(), this.mutex);
                    }
        ...
        public Collection<V> get(K k) {
            Collection<V> m40507A;
            synchronized (this.mutex) {
                m40507A = Synchronized.m40507A(delegate().get(k), this.mutex);
            }
            return m40507A;
        }
        ...
        public Set<K> keySet() {
            ...
            synchronized (this.mutex) {
                try {
                    if (this.keySet == null) {
                        this.keySet = Synchronized.m40506B(delegate().keySet(), this.mutex);
                    }
                    set = this.keySet;
                } catch (Throwable th2) {
                    throw th2;
        ...
        public Multiset<K> keys() {
            ...
            synchronized (this.mutex) {
                try {
                    if (this.keys == null) {
                        this.keys = Synchronized.m40492n(delegate().keys(), this.mutex);
                    }
                    multiset = this.keys;
                } catch (Throwable th2) {
                    throw th2;
            ...
            synchronized (this.mutex) {
                try {
                    if (this.valuesCollection == null) {
                        this.valuesCollection = Synchronized.m40498h(delegate().values(), this.mutex);
                    }
    ...
    public static class SynchronizedSetMultimap<K, V> extends SynchronizedMultimap<K, V> implements SetMultimap<K, V> {
        ...
        public Set<Map.Entry<K, V>> entries() {
            ...
            synchronized (this.mutex) {
                try {
                    if (this.entrySet == null) {
                        this.entrySet = Synchronized.m40485u(delegate().entries(), this.mutex);
                    }
                    set = this.entrySet;
                } catch (Throwable th2) {
                    throw th2;
        ...
        public Set<V> get(K k) {
            Set<V> m40485u;
            synchronized (this.mutex) {
                m40485u = Synchronized.m40485u(delegate().get((SetMultimap<K, V>) k), this.mutex);
            }
            return m40485u;
        }
    ...
    public static final class SynchronizedSortedSetMultimap<K, V> extends SynchronizedSetMultimap<K, V> implements SortedSetMultimap<K, V> {
        ...
        public SortedSet<V> get(K k) {
            SortedSet<V> m40482x;
            synchronized (this.mutex) {
                m40482x = Synchronized.m40482x(delegate().get((SortedSetMultimap<K, V>) k), this.mutex);
            }
            return m40482x;
        }
    ...
    public static final class SynchronizedTable<R, C, V> extends SynchronizedObject implements Table<R, C, V> {
        ...
        /* loaded from: classes4.dex */
        public class C7886a implements Function {
            public C7886a() {
            }
            ...
            public Map apply(Map map) {
                return Synchronized.m40494l(map, SynchronizedTable.this.mutex);
            }
        }

        /* renamed from: com.google.common.collect.Synchronized$SynchronizedTable$b */
        /* loaded from: classes4.dex */
        public class C7887b implements Function {
            public C7887b() {
            }
        ...
        public Set<Table.Cell<R, C, V>> cellSet() {
            Set<Table.Cell<R, C, V>> m40485u;
            synchronized (this.mutex) {
                m40485u = Synchronized.m40485u(delegate().cellSet(), this.mutex);
            }
            return m40485u;
        }
        ...
        public Map<R, V> column(C c) {
            Map<R, V> m40494l;
            synchronized (this.mutex) {
                m40494l = Synchronized.m40494l(delegate().column(c), this.mutex);
            }
            return m40494l;
        }
        ...
        public Set<C> columnKeySet() {
            Set<C> m40485u;
            synchronized (this.mutex) {
                m40485u = Synchronized.m40485u(delegate().columnKeySet(), this.mutex);
            }
            return m40485u;
        }
        ...
        public Map<C, Map<R, V>> columnMap() {
            Map<C, Map<R, V>> m40494l;
            synchronized (this.mutex) {
                m40494l = Synchronized.m40494l(Maps.transformValues(delegate().columnMap(), new C7887b()), this.mutex);
            }
            return m40494l;
        }
        ...
        public Map<C, V> row(R r) {
            Map<C, V> m40494l;
            synchronized (this.mutex) {
                m40494l = Synchronized.m40494l(delegate().row(r), this.mutex);
            }
            return m40494l;
        }
        ...
        public Set<R> rowKeySet() {
            Set<R> m40485u;
            synchronized (this.mutex) {
                m40485u = Synchronized.m40485u(delegate().rowKeySet(), this.mutex);
            }
            return m40485u;
        }
        ...
        public Map<R, Map<C, V>> rowMap() {
            Map<R, Map<C, V>> m40494l;
            synchronized (this.mutex) {
                m40494l = Synchronized.m40494l(Maps.transformValues(delegate().rowMap(), new C7886a()), this.mutex);
            }
            return m40494l;
        }
        ...
        @Override // com.google.common.collect.Table
        public Collection<V> values() {
            Collection<V> m40498h;
            synchronized (this.mutex) {
                m40498h = Synchronized.m40498h(delegate().values(), this.mutex);
            }
            return m40498h;
        }
    ...
    /* renamed from: A */
    public static Collection m40507A(Collection collection, Object obj) {
        if (collection instanceof SortedSet) {
            return m40482x((SortedSet) collection, obj);
        }
        if (collection instanceof Set) {
            return m40485u((Set) collection, obj);
        }
        if (collection instanceof List) {
            return m40496j((List) collection, obj);
        }
        return m40498h(collection, obj);
    }

    /* renamed from: B */
    public static Set m40506B(Set set, Object obj) {
        if (set instanceof SortedSet) {
            return m40482x((SortedSet) set, obj);
        }
        return m40485u(set, obj);
    }

    /* renamed from: g */
    public static BiMap m40499g(BiMap biMap, Object obj) {
    ...
    /* renamed from: h */
    public static Collection m40498h(Collection collection, Object obj) {
        return new SynchronizedCollection(collection, obj);
    }

    /* renamed from: i */
    public static Deque m40497i(Deque deque, Object obj) {
        return new SynchronizedDeque(deque, obj);
    }

    /* renamed from: j */
    public static List m40496j(List list, Object obj) {
    ...
    /* renamed from: k */
    public static ListMultimap m40495k(ListMultimap listMultimap, Object obj) {
        if (!(listMultimap instanceof SynchronizedListMultimap) && !(listMultimap instanceof AbstractC0668Ja)) {
    ...
    /* renamed from: l */
    public static Map m40494l(Map map, Object obj) {
        return new SynchronizedMap(map, obj);
    }

    /* renamed from: m */
    public static Multimap m40493m(Multimap multimap, Object obj) {
        if (!(multimap instanceof SynchronizedMultimap) && !(multimap instanceof AbstractC0668Ja)) {
    ...
    /* renamed from: n */
    public static Multiset m40492n(Multiset multiset, Object obj) {
    ...
    /* renamed from: o */
    public static NavigableMap m40491o(NavigableMap navigableMap) {
        return m40490p(navigableMap, null);
    }

    /* renamed from: p */
    public static NavigableMap m40490p(NavigableMap navigableMap, Object obj) {
        return new SynchronizedNavigableMap(navigableMap, obj);
    }

    /* renamed from: q */
    public static NavigableSet m40489q(NavigableSet navigableSet) {
        return m40488r(navigableSet, null);
    }

    /* renamed from: r */
    public static NavigableSet m40488r(NavigableSet navigableSet, Object obj) {
        return new SynchronizedNavigableSet(navigableSet, obj);
    }

    /* renamed from: s */
    public static Map.Entry m40487s(Map.Entry entry, Object obj) {
        if (entry == null) {
            return null;
        }
    ...
    /* renamed from: t */
    public static Queue m40486t(Queue queue, Object obj) {
    ...
    /* renamed from: u */
    public static Set m40485u(Set set, Object obj) {
        return new SynchronizedSet(set, obj);
    }

    /* renamed from: v */
    public static SetMultimap m40484v(SetMultimap setMultimap, Object obj) {
        if (!(setMultimap instanceof SynchronizedSetMultimap) && !(setMultimap instanceof AbstractC0668Ja)) {
    ...
    /* renamed from: w */
    public static SortedMap m40483w(SortedMap sortedMap, Object obj) {
        return new SynchronizedSortedMap(sortedMap, obj);
    }

    /* renamed from: x */
    public static SortedSet m40482x(SortedSet sortedSet, Object obj) {
        return new SynchronizedSortedSet(sortedSet, obj);
    }

    /* renamed from: y */
    public static SortedSetMultimap m40481y(SortedSetMultimap sortedSetMultimap, Object obj) {
    ...
    /* renamed from: z */
    public static Table m40480z(Table table, Object obj) {
    ...
    public static final class SynchronizedMultiset<E> extends SynchronizedCollection<E> implements Multiset<E> {
            ...
            synchronized (this.mutex) {
                try {
                    if (this.elementSet == null) {
                        this.elementSet = Synchronized.m40506B(delegate().elementSet(), this.mutex);
                    }
                    set = this.elementSet;
                } catch (Throwable th2) {
                    throw th2;
        ...
        public Set<Multiset.Entry<E>> entrySet() {
            ...
            synchronized (this.mutex) {
                try {
                    if (this.entrySet == null) {
                        this.entrySet = Synchronized.m40506B(delegate().entrySet(), this.mutex);
                    }
                    set = this.entrySet;
                } catch (Throwable th2) {
                    throw th2;
    ...
    public static class SynchronizedSortedMap<K, V> extends SynchronizedMap<K, V> implements SortedMap<K, V> {
        ...
        public SortedMap<K, V> headMap(K k) {
            SortedMap<K, V> m40483w;
            synchronized (this.mutex) {
                m40483w = Synchronized.m40483w(delegate().headMap(k), this.mutex);
            }
            return m40483w;
        }
        ...
        public SortedMap<K, V> subMap(K k, K k2) {
            SortedMap<K, V> m40483w;
            synchronized (this.mutex) {
                m40483w = Synchronized.m40483w(delegate().subMap(k, k2), this.mutex);
            }
            return m40483w;
        }
        ...
        public SortedMap<K, V> tailMap(K k) {
            SortedMap<K, V> m40483w;
            synchronized (this.mutex) {
                m40483w = Synchronized.m40483w(delegate().tailMap(k), this.mutex);
            }
            return m40483w;
        }
    ...
    public static final class SynchronizedAsMapEntries<K, V> extends SynchronizedSet<Map.Entry<K, Collection<V>>> {
        ...
        /* loaded from: classes4.dex */
        public class C7883a extends VV1 {

            /* renamed from: com.google.common.collect.Synchronized$SynchronizedAsMapEntries$a$a */
            /* loaded from: classes4.dex */
            public class C7884a extends ForwardingMapEntry {

                /* renamed from: a */
                public final /* synthetic */ Map.Entry f53588a;

                /* renamed from: b */
                public final /* synthetic */ C7883a f53589b;

                public C7884a(C7883a c7883a, Map.Entry entry) {
                    this.f53588a = entry;
                    this.f53589b = c7883a;
                }
                ...
                public Collection getValue() {
                    return Synchronized.m40507A((Collection) this.f53588a.getValue(), SynchronizedAsMapEntries.this.mutex);
                }
        ...
        public boolean contains(@CheckForNull Object obj) {
            boolean m40685l;
            synchronized (this.mutex) {
                m40685l = Maps.m40685l(delegate(), obj);
            }
            return m40685l;
        }
        ...
        public boolean containsAll(Collection<?> collection) {
            boolean m41055b;
            synchronized (this.mutex) {
                m41055b = Collections2.m41055b(delegate(), collection);
            }
            return m41055b;
        }
        ...
        public boolean equals(@CheckForNull Object obj) {
            ...
            synchronized (this.mutex) {
                m40537a = Sets.m40537a(delegate(), obj);
            }
            return m40537a;
        }
        ...
        public Iterator<Map.Entry<K, Collection<V>>> iterator() {
            return new C7883a(super.iterator());
        }
        ...
        public boolean remove(@CheckForNull Object obj) {
            boolean m40715B;
            synchronized (this.mutex) {
                m40715B = Maps.m40715B(delegate(), obj);
            }
            return m40715B;
        }
        ...
        public Object[] toArray() {
            Object[] m40545e;
            synchronized (this.mutex) {
                m40545e = ObjectArrays.m40545e(delegate());
            }
            return m40545e;
        }
        ...
        public <T> T[] toArray(T[] tArr) {
            T[] tArr2;
            synchronized (this.mutex) {
                tArr2 = (T[]) ObjectArrays.m40544f(delegate(), tArr);
            }
            return tArr2;
        }
    }
    ...
    public static final class SynchronizedNavigableMap<K, V> extends SynchronizedSortedMap<K, V> implements NavigableMap<K, V> {
        ...
        public Map.Entry<K, V> ceilingEntry(K k) {
            Map.Entry<K, V> m40487s;
            synchronized (this.mutex) {
                m40487s = Synchronized.m40487s(delegate().ceilingEntry(k), this.mutex);
            }
            return m40487s;
        }
            ...
            synchronized (this.mutex) {
                try {
                    ...
                    if (navigableSet == null) {
                        NavigableSet<K> m40488r = Synchronized.m40488r(delegate().descendingKeySet(), this.mutex);
                        this.descendingKeySet = m40488r;
                        return m40488r;
                    }
                    return navigableSet;
                } catch (Throwable th2) {
            ...
            synchronized (this.mutex) {
                try {
                    ...
                    if (navigableMap == null) {
                        NavigableMap<K, V> m40490p = Synchronized.m40490p(delegate().descendingMap(), this.mutex);
                        this.descendingMap = m40490p;
                        return m40490p;
                    }
                    return navigableMap;
                } catch (Throwable th2) {
        ...
        public Map.Entry<K, V> firstEntry() {
            Map.Entry<K, V> m40487s;
            synchronized (this.mutex) {
                m40487s = Synchronized.m40487s(delegate().firstEntry(), this.mutex);
            }
            return m40487s;
        }
        ...
        public Map.Entry<K, V> floorEntry(K k) {
            Map.Entry<K, V> m40487s;
            synchronized (this.mutex) {
                m40487s = Synchronized.m40487s(delegate().floorEntry(k), this.mutex);
            }
            return m40487s;
        }
        ...
        public NavigableMap<K, V> headMap(K k, boolean z) {
            NavigableMap<K, V> m40490p;
            synchronized (this.mutex) {
                m40490p = Synchronized.m40490p(delegate().headMap(k, z), this.mutex);
            }
            return m40490p;
        }
        ...
        public Map.Entry<K, V> higherEntry(K k) {
            Map.Entry<K, V> m40487s;
            synchronized (this.mutex) {
                m40487s = Synchronized.m40487s(delegate().higherEntry(k), this.mutex);
            }
            return m40487s;
        }
        ...
        public Map.Entry<K, V> lastEntry() {
            Map.Entry<K, V> m40487s;
            synchronized (this.mutex) {
                m40487s = Synchronized.m40487s(delegate().lastEntry(), this.mutex);
            }
            return m40487s;
        }
        ...
        public Map.Entry<K, V> lowerEntry(K k) {
            Map.Entry<K, V> m40487s;
            synchronized (this.mutex) {
                m40487s = Synchronized.m40487s(delegate().lowerEntry(k), this.mutex);
            }
            return m40487s;
        }
        ...
        public NavigableSet<K> navigableKeySet() {
            synchronized (this.mutex) {
                try {
                    ...
                    if (navigableSet == null) {
                        NavigableSet<K> m40488r = Synchronized.m40488r(delegate().navigableKeySet(), this.mutex);
                        this.navigableKeySet = m40488r;
                        return m40488r;
                    }
                    return navigableSet;
                } catch (Throwable th2) {
        ...
        public Map.Entry<K, V> pollFirstEntry() {
            Map.Entry<K, V> m40487s;
            synchronized (this.mutex) {
                m40487s = Synchronized.m40487s(delegate().pollFirstEntry(), this.mutex);
            }
            return m40487s;
        }
        ...
        public Map.Entry<K, V> pollLastEntry() {
            Map.Entry<K, V> m40487s;
            synchronized (this.mutex) {
                m40487s = Synchronized.m40487s(delegate().pollLastEntry(), this.mutex);
            }
            return m40487s;
        }
        ...
        public NavigableMap<K, V> subMap(K k, boolean z, K k2, boolean z2) {
            NavigableMap<K, V> m40490p;
            synchronized (this.mutex) {
                m40490p = Synchronized.m40490p(delegate().subMap(k, z, k2, z2), this.mutex);
            }
            return m40490p;
        }
        ...
        public NavigableMap<K, V> tailMap(K k, boolean z) {
            NavigableMap<K, V> m40490p;
            synchronized (this.mutex) {
                m40490p = Synchronized.m40490p(delegate().tailMap(k, z), this.mutex);
            }
            return m40490p;
        }
    ...
    public static final class SynchronizedNavigableSet<E> extends SynchronizedSortedSet<E> implements NavigableSet<E> {
        ...
        public NavigableSet<E> descendingSet() {
            synchronized (this.mutex) {
                try {
                    ...
                    if (navigableSet == null) {
                        NavigableSet<E> m40488r = Synchronized.m40488r(delegate().descendingSet(), this.mutex);
                        this.descendingSet = m40488r;
                        return m40488r;
                    }
                    return navigableSet;
                } catch (Throwable th2) {
        ...
        public NavigableSet<E> headSet(E e, boolean z) {
            NavigableSet<E> m40488r;
            synchronized (this.mutex) {
                m40488r = Synchronized.m40488r(delegate().headSet(e, z), this.mutex);
            }
            return m40488r;
        }
        ...
        public NavigableSet<E> subSet(E e, boolean z, E e2, boolean z2) {
            NavigableSet<E> m40488r;
            synchronized (this.mutex) {
                m40488r = Synchronized.m40488r(delegate().subSet(e, z, e2, z2), this.mutex);
            }
            return m40488r;
        }
        ...
        public NavigableSet<E> tailSet(E e, boolean z) {
            NavigableSet<E> m40488r;
            synchronized (this.mutex) {
                m40488r = Synchronized.m40488r(delegate().tailSet(e, z), this.mutex);
            }
            return m40488r;
        }
    ...
    public static class SynchronizedSortedSet<E> extends SynchronizedSet<E> implements SortedSet<E> {
        ...
        public SortedSet<E> headSet(E e) {
            SortedSet<E> m40482x;
            synchronized (this.mutex) {
                m40482x = Synchronized.m40482x(delegate().headSet(e), this.mutex);
            }
            return m40482x;
        }
        ...
        public SortedSet<E> subSet(E e, E e2) {
            SortedSet<E> m40482x;
            synchronized (this.mutex) {
                m40482x = Synchronized.m40482x(delegate().subSet(e, e2), this.mutex);
            }
            return m40482x;
        }
        ...
        public SortedSet<E> tailSet(E e) {
            SortedSet<E> m40482x;
            synchronized (this.mutex) {
                m40482x = Synchronized.m40482x(delegate().tailSet(e), this.mutex);
            }
            return m40482x;
        }
