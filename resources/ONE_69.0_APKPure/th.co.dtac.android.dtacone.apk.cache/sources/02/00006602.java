...
public final class InspectableKt$InInspectionModeOnly$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public InspectableKt$InInspectionModeOnly$1(Function2<? super Composer, ? super Integer, Unit> function2, int i) {
        super(2);
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        InspectableKt.InInspectionModeOnly(this.$content, composer, RecomposeScopeImplKt.updateChangedFlags(this.$$changed | 1));
    }
}