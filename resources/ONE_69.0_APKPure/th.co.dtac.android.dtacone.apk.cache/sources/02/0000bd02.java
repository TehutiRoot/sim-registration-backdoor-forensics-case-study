...
public abstract class AbstractC9588mp implements InterfaceC9591ms {
    private static int ThreeDS2Service = 0;
    private static int valueOf = 1;
    private InterfaceC9505jt ThreeDS2ServiceInstance;

    @Override // com.netcetera.threeds.sdk.infrastructure.InterfaceC9591ms
    ...
    public InterfaceC9505jt getSDKInfo() {
        int i = valueOf;
        int i2 = ((i ^ 98) + ((i & 98) << 1)) - 1;
        ThreeDS2Service = i2 % 128;
        int i3 = i2 % 2;
        InterfaceC9505jt interfaceC9505jt = this.ThreeDS2ServiceInstance;
        if (i3 != 0) {
            int i4 = 74 / 0;
        }
        return interfaceC9505jt;
    }
    ...
    @Override // com.netcetera.threeds.sdk.infrastructure.InterfaceC9591ms
    public void ThreeDS2ServiceInstance(InterfaceC9505jt interfaceC9505jt) {
        int i = valueOf;
        int i2 = ((i | 90) << 1) - (i ^ 90);
        int i3 = ((~i2) + (i2 << 1)) % 128;
        ThreeDS2Service = i3;
        this.ThreeDS2ServiceInstance = interfaceC9505jt;
        int i4 = i3 & 115;
        int i5 = -(-((i3 ^ 115) | i4));
