...
public abstract class AbstractC9228af extends AbstractC9747w<LinearLayout> {
    ...
    private final C9226ad ConfigParameters;
    private final InterfaceC9500jo ThreeDS2Service$InitializationCallback;
    ...
    static {
        ...
        values = C9613nm.valueOf(48);
        addParam = (ConfigurationBuilder + 81) % 128;
    }

    public AbstractC9228af(Context context, InterfaceC9500jo interfaceC9500jo, C9226ad c9226ad, setProperty setproperty) {
        super(context);
        this.apiKey = true;
        this.ThreeDS2Service$InitializationCallback = interfaceC9500jo;
        this.ConfigParameters = c9226ad;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:10:0x0022, code lost:
        com.netcetera.threeds.sdk.infrastructure.AbstractC9228af.addParam = (com.netcetera.threeds.sdk.infrastructure.AbstractC9228af.ConfigurationBuilder + 117) % 128;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:9:0x0019, code lost:
        com.netcetera.threeds.sdk.infrastructure.AbstractC9228af.ConfigurationBuilder = (com.netcetera.threeds.sdk.infrastructure.AbstractC9228af.addParam + 1) % 128;
     */
    /*
    ...
    */
    private boolean values(com.netcetera.threeds.sdk.infrastructure.getVersion r4) {
        /*
            r3 = this;
            int r0 = com.netcetera.threeds.sdk.infrastructure.AbstractC9228af.addParam
            int r0 = r0 + 41
            int r1 = r0 % 128
            com.netcetera.threeds.sdk.infrastructure.AbstractC9228af.ConfigurationBuilder = r1
            int r0 = r0 % 2
            r1 = 0
            if (r0 == 0) goto L15
        ...
        L15:
            ...
            if (r0 != r4) goto L22
        L19:
            int r4 = com.netcetera.threeds.sdk.infrastructure.AbstractC9228af.addParam
            r1 = 1
            int r4 = r4 + r1
            int r4 = r4 % 128
            com.netcetera.threeds.sdk.infrastructure.AbstractC9228af.ConfigurationBuilder = r4
            goto L2a
        L22:
            int r4 = com.netcetera.threeds.sdk.infrastructure.AbstractC9228af.ConfigurationBuilder
            int r4 = r4 + 117
            int r4 = r4 % 128
            com.netcetera.threeds.sdk.infrastructure.AbstractC9228af.addParam = r4
        L2a:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.netcetera.threeds.sdk.infrastructure.AbstractC9228af.values(com.netcetera.threeds.sdk.infrastructure.getVersion):boolean");
    }
    ...
    public final LinearLayout ThreeDS2Service(Context context) {
        ...
        linearLayout.setPadding(i, i2, i, C9364et.ThreeDS2Service);
        ...
        C9366ev.get(this.getWarnings, this.ThreeDS2Service$InitializationCallback);
        C9366ev.values(this.initialize, this.ThreeDS2Service$InitializationCallback);
        C9366ev.valueOf(this.createTransaction, this.ThreeDS2Service$InitializationCallback, 1);
        int i5 = addParam + 89;
    ...
    */
    private static void valueOf(java.lang.String r12, int r13, java.lang.Object[] r14) {
        ...
        L28:
            ...
            int r9 = r8 + r4
            int r10 = r8 << 4
            char r11 = com.netcetera.threeds.sdk.infrastructure.AbstractC9228af.ThreeDS2ServiceInstance     // Catch: java.lang.Throwable -> L5b
            int r10 = r10 + r11
            r9 = r9 ^ r10
            int r10 = r8 >>> 5
            char r11 = com.netcetera.threeds.sdk.infrastructure.AbstractC9228af.ThreeDS2Service     // Catch: java.lang.Throwable -> L5b
            int r10 = r10 + r11
            r9 = r9 ^ r10
            int r7 = r7 - r9
            ...
            int r9 = r7 + r4
            int r10 = r7 << 4
            char r11 = com.netcetera.threeds.sdk.infrastructure.AbstractC9228af.get     // Catch: java.lang.Throwable -> L5b
            int r10 = r10 + r11
            r9 = r9 ^ r10
            int r7 = r7 >>> 5
            char r10 = com.netcetera.threeds.sdk.infrastructure.AbstractC9228af.valueOf     // Catch: java.lang.Throwable -> L5b
            int r7 = r7 + r10
            r7 = r7 ^ r9
            int r8 = r8 - r7
        ...
        L77:
            ...
            throw r12
        */
        throw new UnsupportedOperationException("Method not decompiled: com.netcetera.threeds.sdk.infrastructure.AbstractC9228af.valueOf(java.lang.String, int, java.lang.Object[]):void");
    }
    ...
    private void ThreeDS2Service(String str) {
        ...
        if (!(!this.apiKey) && !C9658om.values((CharSequence) str)) {
