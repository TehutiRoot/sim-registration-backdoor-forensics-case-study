...
public final class FlowableSequenceEqualSingle<T> extends Single<Boolean> implements FuseToFlowable<Boolean> {
    ...
    /* renamed from: a */
    public final Publisher f64583a;

    /* renamed from: b */
    public final Publisher f64584b;

    /* renamed from: c */
    public final BiPredicate f64585c;

    /* renamed from: d */
    public final int f64586d;

    /* loaded from: classes5.dex */
    public static final class EqualCoordinator<T> extends AtomicInteger implements Disposable, FlowableSequenceEqual.InterfaceC10879a {
    ...
    public FlowableSequenceEqualSingle(Publisher<? extends T> publisher, Publisher<? extends T> publisher2, BiPredicate<? super T, ? super T> biPredicate, int i) {
        this.f64583a = publisher;
        this.f64584b = publisher2;
        this.f64585c = biPredicate;
        this.f64586d = i;
    }

    @Override // io.reactivex.internal.fuseable.FuseToFlowable
    public Flowable<Boolean> fuseToFlowable() {
        return RxJavaPlugins.onAssembly(new FlowableSequenceEqual(this.f64583a, this.f64584b, this.f64585c, this.f64586d));
    }

    @Override // io.reactivex.Single
    public void subscribeActual(SingleObserver<? super Boolean> singleObserver) {
        EqualCoordinator equalCoordinator = new EqualCoordinator(singleObserver, this.f64586d, this.f64585c);
        singleObserver.onSubscribe(equalCoordinator);
        equalCoordinator.subscribe(this.f64583a, this.f64584b);
    }
}