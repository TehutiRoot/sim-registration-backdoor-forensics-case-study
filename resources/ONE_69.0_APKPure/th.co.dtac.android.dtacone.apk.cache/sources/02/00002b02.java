...
public final class DrawerKt$BottomDrawer$2 extends Lambda implements Function3<BoxWithConstraintsScope, Composer, Integer, Unit> {
    ...
    public final void invoke(@NotNull BoxWithConstraintsScope BoxWithConstraints, @Nullable Composer composer, int i) {
        ...
        boolean z = Constraints.m73810getMaxWidthimpl(BoxWithConstraints.mo69677getConstraintsmsEJaDk()) > Constraints.m73809getMaxHeightimpl(BoxWithConstraints.mo69677getConstraintsmsEJaDk());
        Density density = (Density) composer.consume(CompositionLocalsKt.getLocalDensity());
        Modifier modifier = Modifier.Companion;
        Modifier m69752sizeInqDBjuR0$default = SizeKt.m69752sizeInqDBjuR0$default(modifier, 0.0f, 0.0f, density.mo69619toDpu2uoSUM(Constraints.m73810getMaxWidthimpl(BoxWithConstraints.mo69677getConstraintsmsEJaDk())), density.mo69619toDpu2uoSUM(Constraints.m73809getMaxHeightimpl(BoxWithConstraints.mo69677getConstraintsmsEJaDk())), 3, null);
        ...
        DrawerKt.m60861b(j, new DrawerKt$BottomDrawer$2$1$1(z2, bottomDrawerState, coroutineScope), bottomDrawerState.getTargetValue() != BottomDrawerValue.Closed, composer, (i3 >> 24) & 14);
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = DrawerKt.m60862a(bottomDrawerState, coroutineScope);
            composer.updateRememberedValue(rememberedValue);
        }
        composer.endReplaceableGroup();
        int i4 = i3 >> 12;
        SurfaceKt.m70288SurfaceFjzlyU(SemanticsModifierKt.semantics$default(OffsetKt.offset(OnRemeasuredModifierKt.onSizeChanged(m69752sizeInqDBjuR0$default, new DrawerKt$BottomDrawer$2$1$2(bottomDrawerState, (AnchoredDraggableState.AnchorChangedCallback) rememberedValue, m73809getMaxHeightimpl, z)), new DrawerKt$BottomDrawer$2$1$3(bottomDrawerState)), false, new DrawerKt$BottomDrawer$2$1$4(m70286getString4foXLRw, bottomDrawerState, coroutineScope), 1, null), shape, j2, j3, null, f, ComposableLambdaKt.composableLambda(composer, 457750254, true, new DrawerKt$BottomDrawer$2$1$5(function3, i3)), composer, ((i3 >> 9) & 112) | 1572864 | (i4 & 896) | (i4 & 7168) | (458752 & i3), 16);
        composer.endReplaceableGroup();
        composer.endNode();
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
