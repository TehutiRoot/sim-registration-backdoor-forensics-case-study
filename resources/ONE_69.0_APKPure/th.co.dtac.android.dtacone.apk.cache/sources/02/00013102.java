...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.home.fragment.OneHomeFragment$onStart$3$7 */
/* loaded from: classes10.dex */
public final class OneHomeFragment$onStart$3$7 extends Lambda implements Function1<Resource<? extends GetPre2PostAuthorizationByRtrResponse>, Unit> {
    final /* synthetic */ OneHomeFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.home.fragment.OneHomeFragment$onStart$3$7$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneHomeFragment$onStart$3$7(OneHomeFragment oneHomeFragment) {
        super(1);
    ...
    public final void invoke2(Resource<GetPre2PostAuthorizationByRtrResponse> resource) {
        ...
        if (resourceContentIfNotHandled.getData() != null) {
            ...
            Intent intent = new Intent(oneHomeFragment.requireContext(), MrtrPre2PostActivity.class);
