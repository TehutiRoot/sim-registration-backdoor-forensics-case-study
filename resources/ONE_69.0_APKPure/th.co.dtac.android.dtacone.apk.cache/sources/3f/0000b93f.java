...
public final class TextViewAfterTextChangeEvent {
    ...
    public static /* synthetic */ TextViewAfterTextChangeEvent copy$default(TextViewAfterTextChangeEvent textViewAfterTextChangeEvent, TextView textView, Editable editable, int i, Object obj) {
        if ((i & 1) != 0) {
            textView = textViewAfterTextChangeEvent.f58329a;
        }
        if ((i & 2) != 0) {
            editable = textViewAfterTextChangeEvent.f58330b;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        if (this != obj) {
            if (obj instanceof TextViewAfterTextChangeEvent) {
                ...
                return Intrinsics.areEqual(this.f58329a, textViewAfterTextChangeEvent.f58329a) && Intrinsics.areEqual(this.f58330b, textViewAfterTextChangeEvent.f58330b);
            }
            return false;
        }
        return true;
    ...
    public int hashCode() {
        TextView textView = this.f58329a;
        int hashCode = (textView != null ? textView.hashCode() : 0) * 31;
        Editable editable = this.f58330b;
        return hashCode + (editable != null ? editable.hashCode() : 0);
    }

    @NotNull
    public String toString() {
        return "TextViewAfterTextChangeEvent(view=" + this.f58329a + ", editable=" + ((Object) this.f58330b) + ")";
    }
}