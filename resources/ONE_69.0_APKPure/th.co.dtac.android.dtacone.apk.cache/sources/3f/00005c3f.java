...
public final class TouchExplorationStateProvider_androidKt$ObserveState$3 extends Lambda implements Function1<DisposableEffectScope, DisposableEffectResult> {
    ...
    /* loaded from: classes2.dex */
    public static final class C3408a implements LifecycleEventObserver {

        /* renamed from: a */
        public final /* synthetic */ Function1 f26598a;

        public C3408a(Function1 function1) {
            this.f26598a = function1;
        }
    ...
    public final DisposableEffectResult invoke(@NotNull DisposableEffectScope DisposableEffect) {
        ...
        final C3408a c3408a = new C3408a(this.$handleEvent);
        this.$this_ObserveState.addObserver(c3408a);
        ...
        return new DisposableEffectResult() { // from class: androidx.compose.material3.TouchExplorationStateProvider_androidKt$ObserveState$3$invoke$$inlined$onDispose$1
            ...
            public void dispose() {
                ...
                lifecycle.removeObserver(c3408a);
            }
        };
    }
}