...
public final class Billing extends GeneratedMessageLite<Billing, Builder> implements BillingOrBuilder {
    ...
    public static final class BillingDestination extends GeneratedMessageLite<BillingDestination, Builder> implements BillingDestinationOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<BillingDestination, Builder> implements BillingDestinationOrBuilder {
            public /* synthetic */ Builder(C7187a c7187a) {
                this();
            }

            public Builder addAllMetrics(Iterable<String> iterable) {
                copyOnWrite();
                ((BillingDestination) this.instance).m43193K(iterable);
                return this;
            }

            public Builder addMetrics(String str) {
                copyOnWrite();
                ((BillingDestination) this.instance).m43192L(str);
                return this;
            }

            public Builder addMetricsBytes(ByteString byteString) {
                copyOnWrite();
                ((BillingDestination) this.instance).m43191M(byteString);
                return this;
            }

            public Builder clearMetrics() {
                copyOnWrite();
                ((BillingDestination) this.instance).m43190N();
                return this;
            }

            public Builder clearMonitoredResource() {
                copyOnWrite();
                ((BillingDestination) this.instance).m43189O();
                return this;
            }
            ...
            public Builder setMetrics(int i, String str) {
                copyOnWrite();
                ((BillingDestination) this.instance).m43187Q(i, str);
                return this;
            }

            public Builder setMonitoredResource(String str) {
                copyOnWrite();
                ((BillingDestination) this.instance).m43186R(str);
                return this;
            }

            public Builder setMonitoredResourceBytes(ByteString byteString) {
                copyOnWrite();
                ((BillingDestination) this.instance).m43185S(byteString);
                return this;
            }
        ...
        /* renamed from: K */
        public final void m43193K(Iterable iterable) {
            m43188P();
            AbstractMessageLite.addAll(iterable, (List) this.metrics_);
        }

        /* renamed from: L */
        public final void m43192L(String str) {
            str.getClass();
            m43188P();
        ...
        /* renamed from: M */
        public final void m43191M(ByteString byteString) {
        ...
        /* renamed from: N */
        public final void m43190N() {
            this.metrics_ = GeneratedMessageLite.emptyProtobufList();
        }

        /* renamed from: O */
        public final void m43189O() {
            this.monitoredResource_ = getDefaultInstance().getMonitoredResource();
        }

        /* renamed from: P */
        public final void m43188P() {
        ...
        /* renamed from: Q */
        public final void m43187Q(int i, String str) {
            str.getClass();
            m43188P();
        ...
        /* renamed from: R */
        public final void m43186R(String str) {
            str.getClass();
            this.monitoredResource_ = str;
        }

        /* renamed from: S */
        public final void m43185S(ByteString byteString) {
            AbstractMessageLite.checkByteStringIsUtf8(byteString);
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C7187a.f51618a[methodToInvoke.ordinal()]) {
                case 1:
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Billing, Builder> implements BillingOrBuilder {
        ...
        public Builder addAllConsumerDestinations(Iterable<? extends BillingDestination> iterable) {
            copyOnWrite();
            ((Billing) this.instance).m43209I(iterable);
            return this;
        }

        public Builder addConsumerDestinations(BillingDestination billingDestination) {
            copyOnWrite();
            ((Billing) this.instance).m43207K(billingDestination);
            return this;
        }

        public Builder clearConsumerDestinations() {
            copyOnWrite();
            ((Billing) this.instance).m43206L();
            return this;
        }
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C7187a {
    ...
    /* renamed from: I */
    public final void m43209I(Iterable iterable) {
        m43205M();
        AbstractMessageLite.addAll(iterable, (List) this.consumerDestinations_);
    }

    /* renamed from: J */
    public final void m43208J(int i, BillingDestination billingDestination) {
    ...
    /* renamed from: K */
    public final void m43207K(BillingDestination billingDestination) {
        billingDestination.getClass();
        m43205M();
    ...
    /* renamed from: L */
    public final void m43206L() {
        this.consumerDestinations_ = GeneratedMessageLite.emptyProtobufList();
    }

    /* renamed from: M */
    public final void m43205M() {
    ...
    /* renamed from: N */
    public final void m43204N(int i) {
        m43205M();
        this.consumerDestinations_.remove(i);
    }

    /* renamed from: O */
    public final void m43203O(int i, BillingDestination billingDestination) {
        billingDestination.getClass();
        m43205M();
