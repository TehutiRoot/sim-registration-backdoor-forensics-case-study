...
public final class TempListUtilsKt {
    ...
    /* renamed from: b */
    public static final Appendable m59046b(List list, Appendable appendable, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, Function1 function1) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            m59047a(appendable, obj, function1);
        }
        if (i >= 0 && i2 > i) {
    ...
    public static final <T> List<T> fastDrop(@NotNull List<? extends T> list, int i) {
        ...
        if (i >= 0) {
            ...
            if (size == 1) {
                return AbstractC10100ds.listOf(CollectionsKt___CollectionsKt.last((List<? extends Object>) list));
            }
    ...
    public static final <T, R> List<R> fastFlatMap(@NotNull List<? extends T> list, @NotNull Function1<? super T, ? extends Iterable<? extends R>> transform) {
        ...
        int size = list.size();
        for (int i = 0; i < size; i++) {
            AbstractC10396hs.addAll(arrayList, transform.invoke((T) list.get(i)));
        }
        return arrayList;
    }
    ...
    public static final <T> String fastJoinToString(@NotNull List<? extends T> list, @NotNull CharSequence separator, @NotNull CharSequence prefix, @NotNull CharSequence postfix, int i, @NotNull CharSequence truncated, @Nullable Function1<? super T, ? extends CharSequence> function1) {
        ...
        String sb = ((StringBuilder) m59046b(list, new StringBuilder(), separator, prefix, postfix, i, truncated, function1)).toString();
