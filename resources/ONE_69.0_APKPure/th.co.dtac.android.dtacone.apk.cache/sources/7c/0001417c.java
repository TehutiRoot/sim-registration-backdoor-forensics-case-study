...
@SourceDebugExtension({"SMAP\nOneTolNavGraph.kt\nKotlin\n*S Kotlin\n*F\n+ 1 OneTolNavGraph.kt\nth/co/dtac/android/dtacone/view/appOne/tol/screen/OneTolNavGraphKt$oneTolNavGraph$1$4$1\n+ 2 SnapshotState.kt\nandroidx/compose/runtime/SnapshotStateKt__SnapshotStateKt\n*L\n1#1,1518:1\n81#2:1519\n*S KotlinDebug\n*F\n+ 1 OneTolNavGraph.kt\nth/co/dtac/android/dtacone/view/appOne/tol/screen/OneTolNavGraphKt$oneTolNavGraph$1$4$1\n*L\n390#1:1519\n*E\n"})
/* renamed from: th.co.dtac.android.dtacone.view.appOne.tol.screen.OneTolNavGraphKt$oneTolNavGraph$1$4$1 */
/* loaded from: classes10.dex */
public final class OneTolNavGraphKt$oneTolNavGraph$1$4$1 extends Lambda implements Function4<AnimatedContentScope, NavBackStackEntry, Composer, Integer, Unit> {
    final /* synthetic */ NavController $navController;
    final /* synthetic */ OneRegisterTrueOnlineViewModel $viewModel;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.tol.screen.OneTolNavGraphKt$oneTolNavGraph$1$4$1$1 */
    /* loaded from: classes10.dex */
    public static final class C152881 extends Lambda implements Function1<String, Unit> {
        final /* synthetic */ NavController $navController;
        ...
        public C152881(NavController navController, OneRegisterTrueOnlineViewModel oneRegisterTrueOnlineViewModel, State<? extends ProductType> state) {
            super(1);
        ...
        public final void invoke2(@NotNull String it) {
            ...
            if (OneTolNavGraphKt$oneTolNavGraph$1$4$1.invoke$lambda$0(this.$productType$delegate) == ProductType.FOUR_P_OTT) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneTolNavGraphKt$oneTolNavGraph$1$4$1(OneRegisterTrueOnlineViewModel oneRegisterTrueOnlineViewModel, NavController navController) {
        super(4);
        this.$viewModel = oneRegisterTrueOnlineViewModel;
        this.$navController = navController;
    }
    ...
    public final void invoke(@NotNull AnimatedContentScope composable, @NotNull NavBackStackEntry it, @Nullable Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(627921229, i, -1, "th.co.dtac.android.dtacone.view.appOne.tol.screen.oneTolNavGraph.<anonymous>.<anonymous>.<anonymous> (OneTolNavGraph.kt:388)");
        }
        OneRegisterTrueOnlineSelectNumberScreenKt.OneRegisterTrueOnlineSelectNumberScreen(OneRegisterTrueOnlineCvgType.TRUE_MOVE_H, null, false, new C152881(this.$navController, this.$viewModel, SnapshotStateKt.collectAsState(this.$viewModel.getProductType(), null, composer, 8, 1)), composer, 6, 6);
        if (ComposerKt.isTraceInProgress()) {
