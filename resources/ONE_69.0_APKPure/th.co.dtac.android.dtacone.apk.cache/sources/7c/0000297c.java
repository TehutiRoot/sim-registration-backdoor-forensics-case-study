...
public final class TextStringSimpleNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    /* renamed from: o */
    public TextStyle f14289o;

    /* renamed from: p */
    public FontFamily.Resolver f14290p;

    /* renamed from: q */
    public int f14291q;

    /* renamed from: r */
    public boolean f14292r;
    ...
    /* renamed from: u */
    public ColorProducer f14295u;

    /* renamed from: v */
    public Map f14296v;

    /* renamed from: w */
    public ParagraphLayoutCache f14297w;

    /* renamed from: x */
    public Function1 f14298x;
    ...
    /* renamed from: a */
    public final ParagraphLayoutCache m60978a() {
        if (this.f14297w == null) {
            this.f14297w = new ParagraphLayoutCache(this.f14288n, this.f14289o, this.f14290p, this.f14291q, this.f14292r, this.f14293s, this.f14294t, null);
        }
        ParagraphLayoutCache paragraphLayoutCache = this.f14297w;
    ...
    public void applySemantics(@NotNull SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        Function1 function1 = this.f14298x;
        if (function1 == null) {
            function1 = new TextStringSimpleNode$applySemantics$1(this);
            this.f14298x = function1;
        }
        SemanticsPropertiesKt.setText(semanticsPropertyReceiver, new AnnotatedString(this.f14288n, null, null, 6, null));
        SemanticsPropertiesKt.getTextLayoutResult$default(semanticsPropertyReceiver, null, function1, 1, null);
    }

    /* renamed from: b */
    public final ParagraphLayoutCache m60977b(Density density) {
        ParagraphLayoutCache m60978a = m60978a();
        m60978a.setDensity$foundation_release(density);
        return m60978a;
    }
    ...
    public final void doInvalidations(boolean z, boolean z2, boolean z3) {
        ...
        if (z2 || z3) {
            m60978a().m70001updateL6sJoHM(this.f14288n, this.f14289o, this.f14290p, this.f14291q, this.f14292r, this.f14293s, this.f14294t);
    ...
    public void draw(@NotNull ContentDrawScope contentDrawScope) {
        long m71955getUnspecified0d7_KjU;
        Intrinsics.checkNotNullParameter(contentDrawScope, "<this>");
        Paragraph paragraph$foundation_release = m60978a().getParagraph$foundation_release();
        if (paragraph$foundation_release != null) {
            Canvas canvas = contentDrawScope.getDrawContext().getCanvas();
            boolean didOverflow$foundation_release = m60978a().getDidOverflow$foundation_release();
            if (didOverflow$foundation_release) {
                Rect m71726Recttz77jQw = RectKt.m71726Recttz77jQw(Offset.Companion.m71702getZeroF1C5BW0(), SizeKt.Size(IntSize.m74002getWidthimpl(m60978a().m69998getLayoutSizeYbymL2g$foundation_release()), IntSize.m74001getHeightimpl(m60978a().m69998getLayoutSizeYbymL2g$foundation_release())));
                canvas.save();
                AbstractC16859ul.m1053o(canvas, m71726Recttz77jQw, 0, 2, null);
            }
            try {
                TextDecoration textDecoration = this.f14289o.getTextDecoration();
                if (textDecoration == null) {
                    textDecoration = TextDecoration.Companion.getNone();
                }
                TextDecoration textDecoration2 = textDecoration;
                Shadow shadow = this.f14289o.getShadow();
                if (shadow == null) {
                    shadow = Shadow.Companion.getNone();
                }
                Shadow shadow2 = shadow;
                DrawStyle drawStyle = this.f14289o.getDrawStyle();
                if (drawStyle == null) {
                    drawStyle = Fill.INSTANCE;
                }
                DrawStyle drawStyle2 = drawStyle;
                Brush brush = this.f14289o.getBrush();
                if (brush != null) {
                    AbstractC17439Ci1.m68922d(paragraph$foundation_release, canvas, brush, this.f14289o.getAlpha(), shadow2, textDecoration2, drawStyle2, 0, 64, null);
                } else {
                    ColorProducer colorProducer = this.f14295u;
                    if (colorProducer != null) {
                        m71955getUnspecified0d7_KjU = colorProducer.mo70343invoke0d7_KjU();
                    } else {
                        m71955getUnspecified0d7_KjU = Color.Companion.m71955getUnspecified0d7_KjU();
                    }
                    Color.Companion companion = Color.Companion;
                    if (m71955getUnspecified0d7_KjU == companion.m71955getUnspecified0d7_KjU()) {
                        if (this.f14289o.m73421getColor0d7_KjU() != companion.m71955getUnspecified0d7_KjU()) {
                            m71955getUnspecified0d7_KjU = this.f14289o.m73421getColor0d7_KjU();
                        } else {
                            m71955getUnspecified0d7_KjU = companion.m71945getBlack0d7_KjU();
                        }
                    }
                    AbstractC17439Ci1.m68924b(paragraph$foundation_release, canvas, m71955getUnspecified0d7_KjU, shadow2, textDecoration2, drawStyle2, 0, 32, null);
                }
                if (didOverflow$foundation_release) {
                    canvas.restore();
                    return;
    ...
    public int maxIntrinsicHeight(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull IntrinsicMeasurable measurable, int i) {
        ...
        return m60977b(intrinsicMeasureScope).intrinsicHeight(i, intrinsicMeasureScope.getLayoutDirection());
    }
    ...
    public int maxIntrinsicWidth(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull IntrinsicMeasurable measurable, int i) {
        Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return m60977b(intrinsicMeasureScope).maxIntrinsicWidth(intrinsicMeasureScope.getLayoutDirection());
    }

    @Override // androidx.compose.p003ui.node.LayoutModifierNode
    @NotNull
    /* renamed from: measure-3p2s80s */
    public MeasureResult mo69341measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measure, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        ParagraphLayoutCache m60977b = m60977b(measure);
        boolean m69999layoutWithConstraintsK40F9xA = m60977b.m69999layoutWithConstraintsK40F9xA(j, measure.getLayoutDirection());
        m60977b.getObserveFontChanges$foundation_release();
        Paragraph paragraph$foundation_release = m60977b.getParagraph$foundation_release();
        Intrinsics.checkNotNull(paragraph$foundation_release);
        long m69998getLayoutSizeYbymL2g$foundation_release = m60977b.m69998getLayoutSizeYbymL2g$foundation_release();
        if (m69999layoutWithConstraintsK40F9xA) {
            LayoutModifierNodeKt.invalidateLayer(this);
            Map map = this.f14296v;
            if (map == null) {
                map = new LinkedHashMap(2);
            }
            map.put(AlignmentLineKt.getFirstBaseline(), Integer.valueOf(AbstractC22237sr0.roundToInt(paragraph$foundation_release.getFirstBaseline())));
            map.put(AlignmentLineKt.getLastBaseline(), Integer.valueOf(AbstractC22237sr0.roundToInt(paragraph$foundation_release.getLastBaseline())));
            this.f14296v = map;
        }
        Placeable mo72995measureBRTryo0 = measurable.mo72995measureBRTryo0(Constraints.Companion.m73818fixedJhjzzOo(IntSize.m74002getWidthimpl(m69998getLayoutSizeYbymL2g$foundation_release), IntSize.m74001getHeightimpl(m69998getLayoutSizeYbymL2g$foundation_release)));
        int m74002getWidthimpl = IntSize.m74002getWidthimpl(m69998getLayoutSizeYbymL2g$foundation_release);
        int m74001getHeightimpl = IntSize.m74001getHeightimpl(m69998getLayoutSizeYbymL2g$foundation_release);
        Map<AlignmentLine, Integer> map2 = this.f14296v;
        Intrinsics.checkNotNull(map2);
        return measure.layout(m74002getWidthimpl, m74001getHeightimpl, map2, new TextStringSimpleNode$measure$1(mo72995measureBRTryo0));
    }
    ...
    public int minIntrinsicWidth(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull IntrinsicMeasurable measurable, int i) {
        Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return m60977b(intrinsicMeasureScope).minIntrinsicWidth(intrinsicMeasureScope.getLayoutDirection());
    }
    ...
    public final boolean updateDraw(@Nullable ColorProducer colorProducer, @NotNull TextStyle style) {
        ...
        boolean z = !Intrinsics.areEqual(colorProducer, this.f14295u);
        this.f14295u = colorProducer;
        if (z || !style.hasSameDrawAffectingAttributes(this.f14289o)) {
            return true;
        }
        return false;
    }
    ...
    public final boolean m70012updateLayoutRelatedArgsHuAbxIM(@NotNull TextStyle style, int i, int i2, boolean z, @NotNull FontFamily.Resolver fontFamilyResolver, int i3) {
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(fontFamilyResolver, "fontFamilyResolver");
        boolean z2 = !this.f14289o.hasSameLayoutAffectingAttributes(style);
        this.f14289o = style;
        if (this.f14294t != i) {
            this.f14294t = i;
            z2 = true;
        ...
        if (!Intrinsics.areEqual(this.f14290p, fontFamilyResolver)) {
            this.f14290p = fontFamilyResolver;
            z2 = true;
        }
        if (!TextOverflow.m73771equalsimpl0(this.f14291q, i3)) {
            this.f14291q = i3;
            return true;
        }
        return z2;
    ...
    public final boolean updateText(@NotNull String text) {
        ...
        if (Intrinsics.areEqual(this.f14288n, text)) {
            return false;
        }
        this.f14288n = text;
        return true;
    ...
    public /* synthetic */ TextStringSimpleNode(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, ColorProducer colorProducer, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.Companion.m73778getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, (i4 & 128) != 0 ? null : colorProducer, null);
    }
