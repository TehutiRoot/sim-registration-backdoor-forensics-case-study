...
public final class ListValue extends GeneratedMessageLite<ListValue, Builder> implements ListValueOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<ListValue, Builder> implements ListValueOrBuilder {
        public /* synthetic */ Builder(C8884a c8884a) {
            this();
        }

        public Builder addAllValues(Iterable<? extends Value> iterable) {
            copyOnWrite();
            ((ListValue) this.instance).m35737I(iterable);
            return this;
        }

        public Builder addValues(Value value) {
            copyOnWrite();
            ((ListValue) this.instance).m35735K(value);
            return this;
        }

        public Builder clearValues() {
            copyOnWrite();
            ((ListValue) this.instance).m35734L();
            return this;
        }
        ...
        public Builder removeValues(int i) {
            copyOnWrite();
            ((ListValue) this.instance).m35732N(i);
            return this;
        }

        public Builder setValues(int i, Value value) {
            copyOnWrite();
            ((ListValue) this.instance).m35731O(i, value);
            return this;
        }
        ...
        public Builder addValues(int i, Value value) {
            copyOnWrite();
            ((ListValue) this.instance).m35736J(i, value);
            return this;
        }

        public Builder setValues(int i, Value.Builder builder) {
            copyOnWrite();
            ((ListValue) this.instance).m35731O(i, builder.build());
            return this;
        }

        public Builder addValues(Value.Builder builder) {
            copyOnWrite();
            ((ListValue) this.instance).m35735K(builder.build());
            return this;
        }

        public Builder addValues(int i, Value.Builder builder) {
            copyOnWrite();
            ((ListValue) this.instance).m35736J(i, builder.build());
            return this;
        }
    }
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C8884a {
        ...
        static {
            ...
            try {
                f57395a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f57395a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f57395a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f57395a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f57395a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f57395a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: I */
    public final void m35737I(Iterable iterable) {
        m35733M();
        AbstractMessageLite.addAll(iterable, (List) this.values_);
    }

    /* renamed from: J */
    public final void m35736J(int i, Value value) {
        value.getClass();
        m35733M();
    ...
    /* renamed from: K */
    public final void m35735K(Value value) {
        value.getClass();
        m35733M();
    ...
    /* renamed from: L */
    public final void m35734L() {
        this.values_ = GeneratedMessageLite.emptyProtobufList();
    }

    /* renamed from: M */
    public final void m35733M() {
    ...
    /* renamed from: N */
    public final void m35732N(int i) {
        m35733M();
        this.values_.remove(i);
    }

    /* renamed from: O */
    public final void m35731O(int i, Value value) {
        value.getClass();
        m35733M();
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C8884a.f57395a[methodToInvoke.ordinal()]) {
            case 1:
