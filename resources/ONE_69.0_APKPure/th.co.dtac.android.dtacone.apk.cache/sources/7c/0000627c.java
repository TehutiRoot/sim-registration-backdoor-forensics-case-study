...
public interface MeasureBlocks {
    ...
    MeasureResult m73116measure3p2s80s(@NotNull MeasureScope measureScope, @NotNull List<? extends Measurable> list, long j);
