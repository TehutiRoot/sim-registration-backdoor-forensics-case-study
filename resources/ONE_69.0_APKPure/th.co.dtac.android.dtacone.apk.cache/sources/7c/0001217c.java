...
/* renamed from: th.co.dtac.android.dtacone.presenter.address.QueryAddressPresenter$getPostcodeWithCache$3 */
/* loaded from: classes8.dex */
public final class QueryAddressPresenter$getPostcodeWithCache$3 extends Lambda implements Function1<List<? extends AddressItemData>, Unit> {
    final /* synthetic */ QueryAddressPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public QueryAddressPresenter$getPostcodeWithCache$3(QueryAddressPresenter queryAddressPresenter) {
        super(1);
    ...
    public final void invoke2(List<AddressItemData> list) {
        ...
        if (list.size() == 1) {
            ...
            view3.onAutoPostcodeSelected(list);
            return;
        }
        ...
        view3.onGetPostCodeListSuccess();
    }
}