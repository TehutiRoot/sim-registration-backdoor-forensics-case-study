...
@SourceDebugExtension({"SMAP\nOneChangeOwnerViewModel.kt\nKotlin\n*S Kotlin\n*F\n+ 1 OneChangeOwnerViewModel.kt\nth/co/dtac/android/dtacone/view/appOne/change_owner/viewModel/OneChangeOwnerViewModel$uploadImage$5\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,885:1\n1#2:886\n*E\n"})
/* renamed from: th.co.dtac.android.dtacone.view.appOne.change_owner.viewModel.OneChangeOwnerViewModel$uploadImage$5 */
/* loaded from: classes10.dex */
public final class OneChangeOwnerViewModel$uploadImage$5 extends Lambda implements Function1<UploadImageResponse, Unit> {
    final /* synthetic */ OneChangeOwnerViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneChangeOwnerViewModel$uploadImage$5(OneChangeOwnerViewModel oneChangeOwnerViewModel) {
        super(1);
    ...
    public final void invoke2(UploadImageResponse uploadImageResponse) {
        ...
        if (filename != null) {
            ...
            oneChangeOwnerRepository.getAttachmentNames().add(filename);
        }
    }
}