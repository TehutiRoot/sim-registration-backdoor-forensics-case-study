...
public final class zzbp extends zzbt {
    ...
    public final com.google.android.gms.internal.gtm.zzam zza(Map map) {
        ...
        if (zzamVar != null && zzamVar != zzfu.zza()) {
            ...
            try {
                if (TextBundle.TEXT_ENTRY.equals(zzm)) {
                ...
                if ("base16".equals(zzm2)) {
                    ...
                    "Encode: unknown output format: ".concat(String.valueOf(zzm2));
                    return zzfu.zza();
                }
