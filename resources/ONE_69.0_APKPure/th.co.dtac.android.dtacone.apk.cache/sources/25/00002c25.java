...
@Metadata(m29143d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0007\n\u0000\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\n¢\u0006\u0002\b\u0006"}, m29142d2 = {"<anonymous>", "", "isStart", "", TypedValues.CycleType.S_WAVE_OFFSET, "", "invoke"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
...
public final class SliderKt$RangeSlider$2$onDrag$1$1 extends Lambda implements Function2<Boolean, Float, Unit> {
    ...
    public final void invoke(boolean z, float f) {
        ...
        if (z) {
            ...
            rangeTo = AbstractC17854Is1.rangeTo(AbstractC11695c.coerceIn(this.$rawOffsetStart.getFloatValue(), this.$minPx.element, floatValue), floatValue);
        } else {
            ...
            rangeTo = AbstractC17854Is1.rangeTo(floatValue2, AbstractC11695c.coerceIn(this.$rawOffsetEnd.getFloatValue(), floatValue2, this.$maxPx.element));
        }
