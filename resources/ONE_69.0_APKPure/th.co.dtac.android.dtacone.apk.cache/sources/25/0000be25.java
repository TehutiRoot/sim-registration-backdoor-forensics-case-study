...
public class setEnabled implements setDarkTextColor.valueOf {
    private final setDarkTextColor valueOf;

    public setEnabled(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.ConfigurationBuilder(this.valueOf);
    }
}