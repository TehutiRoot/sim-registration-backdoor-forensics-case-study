...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.deviceSaleTrueCompany.viewModel.OneDeviceSaleTrueViewModel$validateExtraAdvancePayment$3 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleTrueViewModel$validateExtraAdvancePayment$3 extends Lambda implements Function1<OneValidateExtraAdvancePaymentResponse, Unit> {
    final /* synthetic */ OneDeviceSaleTrueViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneDeviceSaleTrueViewModel$validateExtraAdvancePayment$3(OneDeviceSaleTrueViewModel oneDeviceSaleTrueViewModel) {
        super(1);
    ...
    public final void invoke2(OneValidateExtraAdvancePaymentResponse oneValidateExtraAdvancePaymentResponse) {
        this.this$0.saveOrderPreToPostTrueCompany();
    }
}