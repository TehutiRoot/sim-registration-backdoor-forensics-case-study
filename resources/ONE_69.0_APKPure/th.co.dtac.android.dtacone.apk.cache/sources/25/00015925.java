...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_postpaid_registration.MrtrPostpaidValidateBarcodeViewModel$validateSimBarcode$3 */
/* loaded from: classes9.dex */
public final class MrtrPostpaidValidateBarcodeViewModel$validateSimBarcode$3 extends Lambda implements Function1<MrtrPostpaidValidateSimBarcodeResponse, Unit> {
    final /* synthetic */ String $barcode;
    final /* synthetic */ MrtrPostpaidValidateBarcodeViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrPostpaidValidateBarcodeViewModel$validateSimBarcode$3(MrtrPostpaidValidateBarcodeViewModel mrtrPostpaidValidateBarcodeViewModel, String str) {
        super(1);
    ...
    public final void invoke2(MrtrPostpaidValidateSimBarcodeResponse mrtrPostpaidValidateSimBarcodeResponse) {
        ...
        if (isWithDevice) {
            ...
            m2232f.postValue(Resource.Companion.success(mrtrPostpaidValidateSimBarcodeResponse));
        }
    }
}