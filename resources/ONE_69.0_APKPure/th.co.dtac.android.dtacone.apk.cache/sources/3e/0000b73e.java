...
public final class RequestInfo extends GeneratedMessageLite<RequestInfo, Builder> implements RequestInfoOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<RequestInfo, Builder> implements RequestInfoOrBuilder {
        public /* synthetic */ Builder(C8974a c8974a) {
            this();
        }

        public Builder clearRequestId() {
            copyOnWrite();
            ((RequestInfo) this.instance).m34812I();
            return this;
        }

        public Builder clearServingData() {
            copyOnWrite();
            ((RequestInfo) this.instance).m34811J();
            return this;
        }
        ...
        public Builder setRequestId(String str) {
            copyOnWrite();
            ((RequestInfo) this.instance).m34810K(str);
            return this;
        }

        public Builder setRequestIdBytes(ByteString byteString) {
            copyOnWrite();
            ((RequestInfo) this.instance).m34809L(byteString);
            return this;
        }

        public Builder setServingData(String str) {
            copyOnWrite();
            ((RequestInfo) this.instance).m34808M(str);
            return this;
        }

        public Builder setServingDataBytes(ByteString byteString) {
            copyOnWrite();
            ((RequestInfo) this.instance).m34807N(byteString);
            return this;
        }
    ...
    /* loaded from: classes5.dex */
    public static /* synthetic */ class C8974a {
    ...
    /* renamed from: I */
    public final void m34812I() {
        this.requestId_ = getDefaultInstance().getRequestId();
    }

    /* renamed from: J */
    public final void m34811J() {
        this.servingData_ = getDefaultInstance().getServingData();
    }

    /* renamed from: K */
    public final void m34810K(String str) {
        str.getClass();
        this.requestId_ = str;
    }

    /* renamed from: L */
    public final void m34809L(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.requestId_ = byteString.toStringUtf8();
    }

    /* renamed from: M */
    public final void m34808M(String str) {
        str.getClass();
        this.servingData_ = str;
    }

    /* renamed from: N */
    public final void m34807N(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C8974a.f57557a[methodToInvoke.ordinal()]) {
            case 1:
