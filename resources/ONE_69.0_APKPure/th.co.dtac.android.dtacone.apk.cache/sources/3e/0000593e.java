...
@DebugMetadata(m29093c = "androidx.compose.material3.InternalMutatorMutex$mutateWith$2", m29092f = "InternalMutatorMutex.kt", m29091i = {0, 0, 1, 1}, m29090l = {177, 138}, m29089m = "invokeSuspend", m29088n = {"mutator", "$this$withLock_u24default$iv", "mutator", "$this$withLock_u24default$iv"}, m29087s = {"L$0", "L$1", "L$0", "L$1"})
...
public final class InternalMutatorMutex$mutateWith$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super R>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        Function2 function2;
        Object obj2;
        InternalMutatorMutex.C3288a c3288a;
        InternalMutatorMutex internalMutatorMutex;
        InternalMutatorMutex.C3288a c3288a2;
        Throwable th2;
                ...
                if (r1 != 0) {
                    if (r1 != 1) {
                        if (r1 == 2) {
                            ...
                            c3288a2 = (InternalMutatorMutex.C3288a) this.L$0;
                            try {
                                ResultKt.throwOnFailure(obj);
                                atomicReference2 = internalMutatorMutex2.f25923a;
                                AbstractC23094xo1.m479a(atomicReference2, c3288a2, null);
                                mutex2.unlock(null);
                                return obj;
                            } catch (Throwable th3) {
                                th2 = th3;
                                atomicReference = internalMutatorMutex2.f25923a;
                                AbstractC23094xo1.m479a(atomicReference, c3288a2, null);
                                throw th2;
                            }
                        }
                    ...
                    c3288a = (InternalMutatorMutex.C3288a) this.L$0;
                    ResultKt.throwOnFailure(obj);
                    ...
                    InternalMutatorMutex.C3288a c3288a3 = new InternalMutatorMutex.C3288a(mutatePriority, (Job) element);
                    this.this$0.m60587a(c3288a3);
                    mutex = this.this$0.f25924b;
