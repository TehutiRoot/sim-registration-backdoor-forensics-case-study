...
public class getView {
    ...
    /* loaded from: classes5.dex */
    public static /* synthetic */ class C94125 {
    ...
    */
    ...
    public static getView values(setHighlightColor sethighlightcolor, InterfaceC9390fy interfaceC9390fy, setHighlights sethighlights, C9602nb c9602nb, InterfaceC9487jb interfaceC9487jb, setIndeterminateTintMode.ThreeDS2Service threeDS2Service) {
        equals equalsVar = interfaceC9390fy.get(c9602nb, sethighlightcolor);
        getView getview = new getView(new findFragmentById(equalsVar, c9602nb), new findFragmentByTag(equalsVar, c9602nb), setImeOptions.ThreeDS2Service(interfaceC9390fy), interfaceC9390fy.valueOf(interfaceC9487jb), new ordinal(), new setCollapsible(sethighlights, c9602nb, threeDS2Service));
    ...
    public void values(String str, setEditableFactory seteditablefactory) {
        try {
            ...
            int i = C94125.valueOf[settitletextcolor.get().ordinal()];
            if (i != 1) {
                if (i != 2) {
                    return;
                }
