...
public class ElementSelector extends ElementPath {
    ...
    /* renamed from: a */
    public final boolean m51500a(String str, String str2) {
    ...
    public boolean equals(Object obj) {
        ...
        for (int i = 0; i < size; i++) {
            if (!m51500a(get(i), elementSelector.get(i))) {
                return false;
            }
        }
        return true;
    ...
    public boolean fullPathMatch(ElementPath elementPath) {
        ...
        int size = size();
        for (int i = 0; i < size; i++) {
            if (!m51500a(get(i), elementPath.get(i))) {
                return false;
            }
        }
        return true;
    ...
    public int getPrefixMatchLength(ElementPath elementPath) {
        ...
        int size = this.f39803a.size();
        int size2 = elementPath.f39803a.size();
        if (size == 0 || size2 == 0) {
            return 0;
        }
        if (size > size2) {
        ...
        int i = 0;
        for (int i2 = 0; i2 < size && m51500a((String) this.f39803a.get(i2), (String) elementPath.f39803a.get(i2)); i2++) {
            i++;
        }
        return i;
    }
    ...
    public int getTailMatchLength(ElementPath elementPath) {
        ...
        if (size != 0 && size2 != 0) {
            ...
            for (int i3 = 1; i3 <= i2 && m51500a((String) this.f39803a.get(size - i3), (String) elementPath.f39803a.get(size2 - i3)); i3++) {
                i++;
            }
        }
        return i;
