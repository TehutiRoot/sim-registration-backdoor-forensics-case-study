...
public final class RoomLocationDatabase_Impl extends RoomLocationDatabase {
    ...
    /* renamed from: m */
    public volatile ProvinceDao f83556m;

    /* renamed from: n */
    public volatile DistrictDao f83557n;

    /* renamed from: o */
    public volatile SubDistrictDao f83558o;

    /* renamed from: p */
    public volatile PostCodeDao f83559p;

    /* renamed from: th.co.dtac.android.dtacone.data.cache.room.RoomLocationDatabase_Impl$a */
    /* loaded from: classes7.dex */
    public class C14200a extends RoomOpenHelper.Delegate {
        public C14200a(int i) {
            super(i);
        }
    ...
    public SupportSQLiteOpenHelper createOpenHelper(@NonNull DatabaseConfiguration databaseConfiguration) {
        return databaseConfiguration.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(databaseConfiguration.context).name(databaseConfiguration.name).callback(new RoomOpenHelper(databaseConfiguration, new C14200a(1), "238d80c17c8e3d42604a3f0ed8eb6ffd", "657d735b6a8eb9f5ed9380ace8708af0")).build());
    }

    @Override // th.p047co.dtac.android.dtacone.data.cache.room.RoomLocationDatabase
    public DistrictDao districtDao() {
        DistrictDao districtDao;
        if (this.f83557n != null) {
            return this.f83557n;
        }
        synchronized (this) {
            try {
                if (this.f83557n == null) {
                    this.f83557n = new DistrictDao_Impl(this);
                }
                districtDao = this.f83557n;
            } catch (Throwable th2) {
                throw th2;
            }
        }
    ...
    public PostCodeDao postCodeDao() {
        ...
        if (this.f83559p != null) {
            return this.f83559p;
        }
        synchronized (this) {
            try {
                if (this.f83559p == null) {
                    this.f83559p = new PostCodeDao_Impl(this);
                }
                postCodeDao = this.f83559p;
            } catch (Throwable th2) {
                throw th2;
            }
        }
    ...
    public ProvinceDao provinceDao() {
        ...
        if (this.f83556m != null) {
            return this.f83556m;
        }
        synchronized (this) {
            try {
                if (this.f83556m == null) {
                    this.f83556m = new ProvinceDao_Impl(this);
                }
                provinceDao = this.f83556m;
            } catch (Throwable th2) {
                throw th2;
            }
        }
    ...
    public SubDistrictDao subDistrictDao() {
        ...
        if (this.f83558o != null) {
            return this.f83558o;
        }
        synchronized (this) {
            try {
                if (this.f83558o == null) {
                    this.f83558o = new SubDistrictDao_Impl(this);
                }
                subDistrictDao = this.f83558o;
            } catch (Throwable th2) {
                throw th2;
            }
        }
