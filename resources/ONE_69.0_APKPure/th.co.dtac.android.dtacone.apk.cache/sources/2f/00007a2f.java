...
public class TimestampAction extends Action {
    ...
    /* renamed from: d */
    public static String f39790d = "datePattern";

    /* renamed from: e */
    public static String f39791e = "timeReference";

    /* renamed from: f */
    public static String f39792f = "contextBirth";

    /* renamed from: c */
    public boolean f39793c = false;
    ...
    public void begin(InterpretationContext interpretationContext, String str, Attributes attributes) throws ActionException {
        ...
        String value2 = attributes.getValue(f39790d);
        if (OptionHelper.isEmpty(value2)) {
            addError("Attribute named [" + f39790d + "] cannot be empty");
            this.f39793c = true;
        }
        if (f39792f.equalsIgnoreCase(attributes.getValue(f39791e))) {
