...
public class setFilterTouchesWhenObscured implements setDarkTextColor.valueOf {
    private final setDarkTextColor values;

    public setFilterTouchesWhenObscured(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.getEncryptionCertificate(this.values);
    }
}