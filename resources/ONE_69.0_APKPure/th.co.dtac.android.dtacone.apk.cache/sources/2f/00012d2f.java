...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.deviceSaleTrueCompany.fragment.OneDeviceSaleTrueSelectCampaignFragment$setupObserve$1$8 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleTrueSelectCampaignFragment$setupObserve$1$8 extends Lambda implements Function1<Resource<? extends String>, Unit> {
    ...
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.deviceSaleTrueCompany.fragment.OneDeviceSaleTrueSelectCampaignFragment$setupObserve$1$8$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneDeviceSaleTrueSelectCampaignFragment$setupObserve$1$8(OneDeviceSaleTrueSelectCampaignFragment oneDeviceSaleTrueSelectCampaignFragment, OneDeviceSaleTrueViewModel oneDeviceSaleTrueViewModel) {
        super(1);
    ...
    public final void invoke2(Resource<String> resource) {
        ...
        if (WhenMappings.$EnumSwitchMapping$0[resourceContentIfNotHandled.getStatus().ordinal()] == 1) {
            ...
            m15003q.showDialogConfirmTakeReferenceDoc(new OneDeviceSaleTrueSelectCampaignFragment$setupObserve$1$8$1$1(oneDeviceSaleTrueSelectCampaignFragment), new OneDeviceSaleTrueSelectCampaignFragment$setupObserve$1$8$1$2(str, oneDeviceSaleTrueViewModel));
        }
    }
}