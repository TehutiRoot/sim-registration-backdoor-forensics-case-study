...
public final class ObservableSwitchMapSingle<T, R> extends Observable<R> {
    ...
    /* renamed from: a */
    public final Observable f65041a;

    /* renamed from: b */
    public final Function f65042b;
    ...
    public static final class SwitchMapSingleMainObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public void drain() {
            ...
            while (!this.cancelled) {
                ...
                if (z2 && z) {
                    ...
                    AbstractC23094xo1.m479a(atomicReference, switchMapSingleObserver, null);
        ...
        public void innerError(SwitchMapSingleObserver<R> switchMapSingleObserver, Throwable th2) {
            if (AbstractC23094xo1.m479a(this.inner, switchMapSingleObserver, null) && this.errors.addThrowable(th2)) {
                if (!this.delayErrors) {
                    this.upstream.dispose();
                    disposeInner();
                }
        ...
        public void onNext(T t) {
            ...
            try {
                ...
                } while (!AbstractC23094xo1.m479a(this.inner, switchMapSingleObserver, switchMapSingleObserver3));
    ...
    public ObservableSwitchMapSingle(Observable<T> observable, Function<? super T, ? extends SingleSource<? extends R>> function, boolean z) {
        this.f65041a = observable;
        this.f65042b = function;
        this.f65043c = z;
    }

    @Override // io.reactivex.Observable
    public void subscribeActual(Observer<? super R> observer) {
        if (!AbstractC20753kF1.m29260c(this.f65041a, this.f65042b, observer)) {
            this.f65041a.subscribe(new SwitchMapSingleMainObserver(observer, this.f65042b, this.f65043c));
        }
    }
}