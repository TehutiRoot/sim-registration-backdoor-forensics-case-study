...
/* renamed from: th.co.dtac.android.dtacone.presenter.sellerID.ChangeTokenForPromoterPresenter$storeNewUserProfile$7 */
/* loaded from: classes8.dex */
public final class ChangeTokenForPromoterPresenter$storeNewUserProfile$7 extends Lambda implements Function1<SessionEntity, Unit> {
    final /* synthetic */ String $retailerNumber;
    final /* synthetic */ ChangeTokenForPromoterPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ChangeTokenForPromoterPresenter$storeNewUserProfile$7(ChangeTokenForPromoterPresenter changeTokenForPromoterPresenter, String str) {
        super(1);
    ...
    public final void invoke2(SessionEntity it) {
        ...
        view3.onGetPermissionAndDolStatusSuccess(str, it);
    }
}