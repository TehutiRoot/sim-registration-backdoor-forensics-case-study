...
public final class zzg extends com.google.android.gms.internal.maps.zza implements IGoogleMapDelegate {
    ...
    public final IProjectionDelegate getProjection() throws RemoteException {
        ...
        if (readStrongBinder == null) {
            ...
            if (queryLocalInterface instanceof IProjectionDelegate) {
                zzbuVar = (IProjectionDelegate) queryLocalInterface;
            } else {
    ...
    public final IUiSettingsDelegate getUiSettings() throws RemoteException {
        ...
        if (readStrongBinder == null) {
            ...
            if (queryLocalInterface instanceof IUiSettingsDelegate) {
                zzcaVar = (IUiSettingsDelegate) queryLocalInterface;
            } else {
                zzcaVar = new zzca(readStrongBinder);
            }
        }
        zzJ.recycle();
        return zzcaVar;
    ...
    public final void setBuildingsEnabled(boolean z) throws RemoteException {
        Parcel zza = zza();
        ClassLoader classLoader = com.google.android.gms.internal.maps.zzc.f46206a;
        zza.writeInt(z ? 1 : 0);
        zzc(41, zza);
    }
