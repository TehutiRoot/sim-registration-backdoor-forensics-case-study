...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_change_sim.MrtrChangeSimViewModel$autoTransferESim$1 */
/* loaded from: classes9.dex */
public final class MrtrChangeSimViewModel$autoTransferESim$1 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ MrtrChangeSimViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrChangeSimViewModel$autoTransferESim$1(MrtrChangeSimViewModel mrtrChangeSimViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable it) {
        ...
        mrtrErrorService.handleException(it, new MrtrErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.viewmodel.mrtr_change_sim.MrtrChangeSimViewModel$autoTransferESim$1.1
