...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.buyDol.viewModel.OneBuyDolViewModel$getTransactionById$3 */
/* loaded from: classes10.dex */
public final class OneBuyDolViewModel$getTransactionById$3 extends Lambda implements Function1<OneBuyDolChargeResponse, Unit> {
    final /* synthetic */ OneBuyDolViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneBuyDolViewModel$getTransactionById$3(OneBuyDolViewModel oneBuyDolViewModel) {
        super(1);
    ...
    public final void invoke2(OneBuyDolChargeResponse oneBuyDolChargeResponse) {
        ...
        m15882c0.setValue(Resource.Companion.success(oneBuyDolChargeResponse));
    }
}