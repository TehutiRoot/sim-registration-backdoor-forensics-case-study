...
@DebugMetadata(m29093c = "androidx.compose.material3.SliderKt$animateToTarget$2", m29092f = "Slider.kt", m29091i = {}, m29090l = {1221}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
...
public final class SliderKt$animateToTarget$2 extends SuspendLambda implements Function2<DragScope, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes2.dex */
    public static final class C33431 extends Lambda implements Function1<Animatable<Float, AnimationVector1D>, Unit> {
        final /* synthetic */ DragScope $$this$drag;
        final /* synthetic */ Ref.FloatRef $latestValue;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C33431(DragScope dragScope, Ref.FloatRef floatRef) {
            super(1);
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i != 0) {
            ...
            tweenSpec = SliderKt.f26174k;
            Float boxFloat2 = Boxing.boxFloat(this.$velocity);
            C33431 c33431 = new C33431((DragScope) this.L$0, floatRef);
            this.label = 1;
            if (Animatable$default.animateTo(boxFloat, tweenSpec, boxFloat2, c33431, this) == coroutine_suspended) {
