...
public final class CompletableMerge extends Completable {
    ...
    /* renamed from: a */
    public final Publisher f64009a;
    ...
    public void subscribeActual(CompletableObserver completableObserver) {
        this.f64009a.subscribe(new CompletableMergeSubscriber(completableObserver, this.f64010b, this.f64011c));
    }
}