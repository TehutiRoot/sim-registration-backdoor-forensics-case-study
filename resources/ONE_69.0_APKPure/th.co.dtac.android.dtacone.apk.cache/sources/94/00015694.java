...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.esim.ESimViewModel$checkSimStock$2 */
/* loaded from: classes9.dex */
public final class ESimViewModel$checkSimStock$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ Boolean $isPhysical;
    final /* synthetic */ ESimViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimViewModel$checkSimStock$2(Boolean bool, ESimViewModel eSimViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable it) {
        ...
        mrtrErrorService.handleException(it, new MrtrErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.viewmodel.esim.ESimViewModel$checkSimStock$2.1
            ...
            public void handle(@Nullable Throwable th2) {
                ...
                eSimRepository.setCheckSimStockError(errorCollection);
                ESimViewModel.this.setInProgressError(errorCollection);
                m2766J0 = ESimViewModel.this.m2766J0();
                m2766J0.setValue(Resource.Companion.success(errorCollection.getStatusCode()));
            }
