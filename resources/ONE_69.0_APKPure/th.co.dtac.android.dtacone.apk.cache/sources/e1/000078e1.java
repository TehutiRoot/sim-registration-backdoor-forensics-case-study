...
public final class C5411c9 extends SurfaceOutputConfig {
    ...
    public C5411c9(int i, int i2, String str, List list, Surface surface) {
        this.f39344a = i;
        this.f39345b = i2;
        this.f39346c = str;
        if (list != null) {
