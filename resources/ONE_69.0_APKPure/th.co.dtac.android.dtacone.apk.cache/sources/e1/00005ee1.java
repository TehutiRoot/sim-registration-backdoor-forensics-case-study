    ...
    public final void invoke2() {
        ...
        do {
            ...
            synchronized (mutableVector) {
                try {
                    z = snapshotStateObserver.f28853c;
                    if (!z) {
                        snapshotStateObserver.f28853c = true;
                        mutableVector2 = snapshotStateObserver.f28856f;
                        int size = mutableVector2.getSize();
                        if (size <= 0) {
                            snapshotStateObserver.f28853c = false;
                        } else {
                            Object[] content = mutableVector2.getContent();
                            int i = 0;
                            do {
                                ((SnapshotStateObserver.ObservedScopeMap) content[i]).m59834g();
                                i++;
                            } while (i < size);
                            snapshotStateObserver.f28853c = false;
                        }
