...
public final class SuspendFunctionTypesKt {
    ...
    /* renamed from: a */
    public static final MutableClassDescriptor f68578a;
    ...
    static {
        ...
        mutableClassDescriptor.setTypeParameterDescriptors(AbstractC10100ds.listOf(TypeParameterDescriptorImpl.createWithDefaultBound(mutableClassDescriptor, Annotations.Companion.getEMPTY(), false, Variance.IN_VARIANCE, Name.identifier("T"), 0, storageManager)));
        mutableClassDescriptor.createTypeConstructor();
        f68578a = mutableClassDescriptor;
    }
    ...
    public static final SimpleType transformSuspendFunctionToRuntimeFunctionType(@NotNull KotlinType suspendFunType) {
        ...
        ArrayList arrayList = new ArrayList(AbstractC10172es.collectionSizeOrDefault(valueParameterTypesFromFunctionType, 10));
        for (TypeProjection typeProjection : valueParameterTypesFromFunctionType) {
            arrayList.add(typeProjection.getType());
        }
        TypeAttributes empty = TypeAttributes.Companion.getEmpty();
        TypeConstructor typeConstructor = f68578a.getTypeConstructor();
        Intrinsics.checkNotNullExpressionValue(typeConstructor, "FAKE_CONTINUATION_CLASS_DESCRIPTOR.typeConstructor");
        List plus = CollectionsKt___CollectionsKt.plus((Collection<? extends SimpleType>) arrayList, KotlinTypeFactory.simpleType$default(empty, typeConstructor, AbstractC10100ds.listOf(TypeUtilsKt.asTypeProjection(FunctionTypesKt.getReturnTypeFromFunctionType(suspendFunType))), false, (KotlinTypeRefiner) null, 16, (Object) null));
