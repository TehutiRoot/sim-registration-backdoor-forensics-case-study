...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.report.fragment.OneRtrProfitReportFragment$setupObserve$4 */
/* loaded from: classes10.dex */
public final class OneRtrProfitReportFragment$setupObserve$4 extends Lambda implements Function1<Resource<? extends OneCommissionTrueCompanyResponse>, Unit> {
    final /* synthetic */ OneRtrProfitReportFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.report.fragment.OneRtrProfitReportFragment$setupObserve$4$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneRtrProfitReportFragment$setupObserve$4(OneRtrProfitReportFragment oneRtrProfitReportFragment) {
        super(1);
    ...
    public final void invoke2(Resource<OneCommissionTrueCompanyResponse> resource) {
        ...
        if (i == 1) {
            ...
            OneRtrProfitReportFragment.m10291H(oneRtrProfitReportFragment, null, resourceContentIfNotHandled.getData().getData().getCommission(), 1, null);
        } else if (i == 2) {
