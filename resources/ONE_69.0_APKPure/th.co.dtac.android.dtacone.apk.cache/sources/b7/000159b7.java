...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_prepaid_multi_sim.MrtrPrepaidMultiSimViewModel$callAPIGetConsentXSimTemplate$3 */
/* loaded from: classes9.dex */
public final class MrtrPrepaidMultiSimViewModel$callAPIGetConsentXSimTemplate$3 extends Lambda implements Function1<XSIMConsentResponse, Unit> {
    final /* synthetic */ MrtrPrepaidMultiSimViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrPrepaidMultiSimViewModel$callAPIGetConsentXSimTemplate$3(MrtrPrepaidMultiSimViewModel mrtrPrepaidMultiSimViewModel) {
        super(1);
    ...
    public final void invoke2(XSIMConsentResponse xSIMConsentResponse) {
        MutableLiveData m2103P;
        MutableLiveData m2094Y;
        this.this$0.getLiveDataState().setValue(StatusResource.DISMISS);
        m2103P = this.this$0.m2103P();
        Resource.Companion companion = Resource.Companion;
        m2103P.setValue(companion.success(xSIMConsentResponse.getConsentImage()));
        m2094Y = this.this$0.m2094Y();
        m2094Y.setValue(companion.success(FirebaseAnalytics.Param.SUCCESS));
    }
}