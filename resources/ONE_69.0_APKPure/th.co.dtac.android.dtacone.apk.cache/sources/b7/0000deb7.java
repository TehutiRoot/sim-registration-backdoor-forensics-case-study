...
public final class LazyJavaClassDescriptor$declaredParameters$1 extends Lambda implements Function0<List<? extends TypeParameterDescriptor>> {
    ...
    public final List<? extends TypeParameterDescriptor> invoke() {
        ...
        ArrayList arrayList = new ArrayList(AbstractC10172es.collectionSizeOrDefault(typeParameters, 10));
        for (JavaTypeParameter javaTypeParameter : typeParameters) {
            TypeParameterDescriptor resolveTypeParameter = lazyJavaClassDescriptor.f69155j.getTypeParameterResolver().resolveTypeParameter(javaTypeParameter);
