...
public class SM2Engine {
    ...
    /* loaded from: classes6.dex */
    public static /* synthetic */ class C127351 {
    ...
    private byte[] encrypt(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        ...
        return C127351.$SwitchMap$org$bouncycastle$crypto$engines$SM2Engine$Mode[this.mode.ordinal()] != 1 ? Arrays.concatenate(encoded, bArr2, bArr3) : Arrays.concatenate(encoded, bArr3, bArr2);
    }
