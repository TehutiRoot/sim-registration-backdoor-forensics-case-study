...
public class Joiner {
    ...
    public static final class MapJoiner {
        ...
        /* renamed from: a */
        public final Joiner f52761a;

        /* renamed from: b */
        public final String f52762b;

        public /* synthetic */ MapJoiner(Joiner joiner, String str, C7416a c7416a) {
            this(joiner, str);
        }
        ...
        public MapJoiner useForNull(String str) {
            return new MapJoiner(this.f52761a.useForNull(str), this.f52762b);
        }

        public MapJoiner(Joiner joiner, String str) {
            this.f52761a = joiner;
            this.f52762b = (String) Preconditions.checkNotNull(str);
        }
        ...
        public <A extends Appendable> A appendTo(A a, Iterator<? extends Map.Entry<?, ?>> it) throws IOException {
            ...
            if (it.hasNext()) {
                ...
                a.append(this.f52761a.mo41308c(next.getKey()));
                a.append(this.f52762b);
                a.append(this.f52761a.mo41308c(next.getValue()));
                while (it.hasNext()) {
                    a.append(this.f52761a.f52760a);
                    Map.Entry<?, ?> next2 = it.next();
                    a.append(this.f52761a.mo41308c(next2.getKey()));
                    a.append(this.f52762b);
                    a.append(this.f52761a.mo41308c(next2.getValue()));
                }
            }
            return a;
        }
    ...
    /* loaded from: classes4.dex */
    public class C7416a extends Joiner {

        /* renamed from: b */
        public final /* synthetic */ String f52763b;

        /* renamed from: c */
        public final /* synthetic */ Joiner f52764c;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C7416a(Joiner joiner, Joiner joiner2, String str) {
            super(joiner2, null);
            this.f52763b = str;
            this.f52764c = joiner;
        }
        ...
        /* renamed from: c */
        public CharSequence mo41308c(Object obj) {
            if (obj == null) {
                return this.f52763b;
            }
            return this.f52764c.mo41308c(obj);
        }
    ...
    /* loaded from: classes4.dex */
    public class C7417b extends Joiner {
        public C7417b(Joiner joiner) {
            super(joiner, null);
        }
        ...
        public Appendable appendTo(Appendable appendable, Iterator it) {
            ...
            while (true) {
                ...
                Object next = it.next();
                if (next != null) {
                    appendable.append(Joiner.this.mo41308c(next));
                    break;
                }
            }
            while (it.hasNext()) {
                ...
                if (next2 != null) {
                    appendable.append(Joiner.this.f52760a);
                    appendable.append(Joiner.this.mo41308c(next2));
                }
            }
            return appendable;
        }
    ...
    /* loaded from: classes4.dex */
    public class C7418c extends AbstractList {

        /* renamed from: a */
        public final /* synthetic */ Object[] f52766a;

        /* renamed from: b */
        public final /* synthetic */ Object f52767b;

        /* renamed from: c */
        public final /* synthetic */ Object f52768c;

        public C7418c(Object[] objArr, Object obj, Object obj2) {
            this.f52766a = objArr;
            this.f52767b = obj;
            this.f52768c = obj2;
        }
        ...
        public int size() {
            return this.f52766a.length + 2;
        }
    }

    public /* synthetic */ Joiner(Joiner joiner, C7416a c7416a) {
        this(joiner);
    }

    /* renamed from: b */
    public static Iterable m41311b(Object obj, Object obj2, Object[] objArr) {
        Preconditions.checkNotNull(objArr);
        return new C7418c(objArr, obj, obj2);
    }

    /* renamed from: on */
    public static Joiner m41309on(String str) {
    ...
    public Joiner skipNulls() {
        return new C7417b(this);
    }

    public Joiner useForNull(String str) {
        Preconditions.checkNotNull(str);
        return new C7416a(this, this, str);
    }
    ...
    public Joiner(String str) {
        this.f52760a = (String) Preconditions.checkNotNull(str);
    }

    /* renamed from: on */
    public static Joiner m41310on(char c) {
    ...
    public <A extends Appendable> A appendTo(A a, Iterator<? extends Object> it) throws IOException {
        Preconditions.checkNotNull(a);
        if (it.hasNext()) {
            a.append(mo41308c(it.next()));
            while (it.hasNext()) {
                a.append(this.f52760a);
                a.append(mo41308c(it.next()));
            }
        }
        return a;
    ...
    public final <A extends Appendable> A appendTo(A a, @CheckForNull Object obj, @CheckForNull Object obj2, Object... objArr) throws IOException {
        return (A) appendTo((Joiner) a, m41311b(obj, obj2, objArr));
    }
    ...
    public final StringBuilder appendTo(StringBuilder sb, @CheckForNull Object obj, @CheckForNull Object obj2, Object... objArr) {
        return appendTo(sb, m41311b(obj, obj2, objArr));
    }
}