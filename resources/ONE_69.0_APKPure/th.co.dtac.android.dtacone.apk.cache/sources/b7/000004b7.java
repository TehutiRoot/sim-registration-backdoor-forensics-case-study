...
public class C0348Ey extends AbstractC18154Ni1 {
    public C0348Ey(PointF[] pointFArr, float[][] fArr) {
        super(fArr);
        this.f4240a = m68561n(pointFArr);
        this.f4242c = m68563l();
        this.f4243d = m68562m();
    }
    ...
    public PointF[] mo735c() {
        return (PointF[]) this.f4240a[1].clone();
    }

    @Override // p000.AbstractC18154Ni1
    /* renamed from: e */
    public PointF[] mo734e() {
        PointF[] pointFArr = this.f4240a[3];
    ...
    /* renamed from: l */
    public final int[] m68563l() {
        int[] iArr = {4, 4};
        if (m67205j(this.f4240a[0]) && m67205j(this.f4240a[1])) {
            PointF[] pointFArr = this.f4240a[0];
            double m67207h = m67207h(pointFArr[0], pointFArr[3]);
            PointF[] pointFArr2 = this.f4240a[1];
        ...
        if (m67205j(this.f4240a[2]) && m67205j(this.f4240a[3])) {
            PointF[] pointFArr3 = this.f4240a[2];
            double m67207h3 = m67207h(pointFArr3[0], pointFArr3[3]);
            PointF[] pointFArr4 = this.f4240a[3];
            double m67207h4 = m67207h(pointFArr4[0], pointFArr4[3]);
    ...
    /* renamed from: m */
    public final List m68562m() {
        return m67206i(new C0417Fy[0]);
    }

    /* renamed from: n */
    public final PointF[][] m68561n(PointF[] pointFArr) {
