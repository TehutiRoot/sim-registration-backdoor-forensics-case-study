...
public final class OneCurrentPackagesResponse implements Parcelable {
    ...
    /* renamed from: d */
    private final String f82209d;
    @SerializedName("data")
    @Nullable

    /* renamed from: e */
    private final List<DataItem> f82210e;
    ...
    @StabilityInferred(parameters = 0)
    @Parcelize
    @Metadata(m29143d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u000e\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\r\b\u0087\b\u0018\u00002\u00020\u0001B7\u0012\n\b\u0002\u0010\u0003\u001a\u0004\u0018\u00010\u0002\u0012\n\b\u0002\u0010\u0004\u001a\u0004\u0018\u00010\u0002\u0012\n\b\u0002\u0010\u0005\u001a\u0004\u0018\u00010\u0002\u0012\n\b\u0002\u0010\u0007\u001a\u0004\u0018\u00010\u0006¢\u0006\u0004\b\b\u0010\tJ\u0012\u0010\n\u001a\u0004\u0018\u00010\u0002HÆ\u0003¢\u0006\u0004\b\n\u0010\u000bJ\u0012\u0010\f\u001a\u0004\u0018\u00010\u0002HÆ\u0003¢\u0006\u0004\b\f\u0010\u000bJ\u0012\u0010\r\u001a\u0004\u0018\u00010\u0002HÆ\u0003¢\u0006\u0004\b\r\u0010\u000bJ\u0012\u0010\u000e\u001a\u0004\u0018\u00010\u0006HÆ\u0003¢\u0006\u0004\b\u000e\u0010\u000fJ@\u0010\u0010\u001a\u00020\u00002\n\b\u0002\u0010\u0003\u001a\u0004\u0018\u00010\u00022\n\b\u0002\u0010\u0004\u001a\u0004\u0018\u00010\u00022\n\b\u0002\u0010\u0005\u001a\u0004\u0018\u00010\u00022\n\b\u0002\u0010\u0007\u001a\u0004\u0018\u00010\u0006HÆ\u0001¢\u0006\u0004\b\u0010\u0010\u0011J\u0010\u0010\u0012\u001a\u00020\u0002HÖ\u0001¢\u0006\u0004\b\u0012\u0010\u000bJ\u0010\u0010\u0013\u001a\u00020\u0006HÖ\u0001¢\u0006\u0004\b\u0013\u0010\u0014J\u001a\u0010\u0018\u001a\u00020\u00172\b\u0010\u0016\u001a\u0004\u0018\u00010\u0015HÖ\u0003¢\u0006\u0004\b\u0018\u0010\u0019J\u0010\u0010\u001a\u001a\u00020\u0006HÖ\u0001¢\u0006\u0004\b\u001a\u0010\u0014J \u0010\u001f\u001a\u00020\u001e2\u0006\u0010\u001c\u001a\u00020\u001b2\u0006\u0010\u001d\u001a\u00020\u0006HÖ\u0001¢\u0006\u0004\b\u001f\u0010 R\u001c\u0010\u0003\u001a\u0004\u0018\u00010\u00028\u0006X\u0087\u0004¢\u0006\f\n\u0004\b!\u0010\"\u001a\u0004\b#\u0010\u000bR\u001c\u0010\u0004\u001a\u0004\u0018\u00010\u00028\u0006X\u0087\u0004¢\u0006\f\n\u0004\b$\u0010\"\u001a\u0004\b%\u0010\u000bR\u001c\u0010\u0005\u001a\u0004\u0018\u00010\u00028\u0006X\u0087\u0004¢\u0006\f\n\u0004\b&\u0010\"\u001a\u0004\b'\u0010\u000bR\u001c\u0010\u0007\u001a\u0004\u0018\u00010\u00068\u0006X\u0087\u0004¢\u0006\f\n\u0004\b(\u0010)\u001a\u0004\b*\u0010\u000f¨\u0006+"}, m29142d2 = {"Lth/co/dtac/android/dtacone/app_one/model/stv/OneCurrentPackagesResponse$DataItem;", "Landroid/os/Parcelable;", "", "beginDate", "endDate", RemoteConfigConstants.RequestFieldKey.PACKAGE_NAME, "", "remaining", "<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Integer;)V", "component1", "()Ljava/lang/String;", "component2", "component3", "component4", "()Ljava/lang/Integer;", "copy", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Integer;)Lth/co/dtac/android/dtacone/app_one/model/stv/OneCurrentPackagesResponse$DataItem;", "toString", "hashCode", "()I", "", "other", "", "equals", "(Ljava/lang/Object;)Z", "describeContents", "Landroid/os/Parcel;", "parcel", "flags", "", "writeToParcel", "(Landroid/os/Parcel;I)V", PDPageLabelRange.STYLE_LETTERS_LOWER, "Ljava/lang/String;", "getBeginDate", OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, "getEndDate", OperatorName.CURVE_TO, "getPackageName", "d", "Ljava/lang/Integer;", "getRemaining", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0})
    ...
    public static final class DataItem implements Parcelable {
        ...
        public static /* synthetic */ DataItem copy$default(DataItem dataItem, String str, String str2, String str3, Integer num, int i, Object obj) {
            if ((i & 1) != 0) {
                str = dataItem.f82213a;
            }
            if ((i & 2) != 0) {
                str2 = dataItem.f82214b;
            }
            if ((i & 4) != 0) {
                str3 = dataItem.f82215c;
            }
            if ((i & 8) != 0) {
                num = dataItem.f82216d;
            }
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            if (obj instanceof DataItem) {
                ...
                return Intrinsics.areEqual(this.f82213a, dataItem.f82213a) && Intrinsics.areEqual(this.f82214b, dataItem.f82214b) && Intrinsics.areEqual(this.f82215c, dataItem.f82215c) && Intrinsics.areEqual(this.f82216d, dataItem.f82216d);
            }
            return false;
        }
        ...
        public int hashCode() {
            ...
            String str2 = this.f82214b;
            int hashCode2 = (hashCode + (str2 == null ? 0 : str2.hashCode())) * 31;
            String str3 = this.f82215c;
            int hashCode3 = (hashCode2 + (str3 == null ? 0 : str3.hashCode())) * 31;
            Integer num = this.f82216d;
        ...
        public void writeToParcel(@NotNull Parcel out, int i) {
            ...
            out.writeString(this.f82213a);
            out.writeString(this.f82214b);
            out.writeString(this.f82215c);
            Integer num = this.f82216d;
            if (num == null) {
                intValue = 0;
            } else {
    ...
    public static /* synthetic */ OneCurrentPackagesResponse copy$default(OneCurrentPackagesResponse oneCurrentPackagesResponse, String str, String str2, String str3, String str4, List list, List list2, String str5, int i, Object obj) {
        if ((i & 1) != 0) {
            str = oneCurrentPackagesResponse.f82206a;
        }
        if ((i & 2) != 0) {
            str2 = oneCurrentPackagesResponse.f82207b;
        }
        String str6 = str2;
        if ((i & 4) != 0) {
            str3 = oneCurrentPackagesResponse.f82208c;
        }
        String str7 = str3;
        if ((i & 8) != 0) {
            str4 = oneCurrentPackagesResponse.f82209d;
        }
        String str8 = str4;
        List<DataItem> list3 = list;
        if ((i & 16) != 0) {
            list3 = oneCurrentPackagesResponse.f82210e;
        }
        List list4 = list3;
        List<String> list5 = list2;
        if ((i & 32) != 0) {
            list5 = oneCurrentPackagesResponse.f82211f;
        }
        List list6 = list5;
        if ((i & 64) != 0) {
            str5 = oneCurrentPackagesResponse.f82212g;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof OneCurrentPackagesResponse) {
            ...
            return Intrinsics.areEqual(this.f82206a, oneCurrentPackagesResponse.f82206a) && Intrinsics.areEqual(this.f82207b, oneCurrentPackagesResponse.f82207b) && Intrinsics.areEqual(this.f82208c, oneCurrentPackagesResponse.f82208c) && Intrinsics.areEqual(this.f82209d, oneCurrentPackagesResponse.f82209d) && Intrinsics.areEqual(this.f82210e, oneCurrentPackagesResponse.f82210e) && Intrinsics.areEqual(this.f82211f, oneCurrentPackagesResponse.f82211f) && Intrinsics.areEqual(this.f82212g, oneCurrentPackagesResponse.f82212g);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode2 = (hashCode + (str2 == null ? 0 : str2.hashCode())) * 31;
        String str3 = this.f82208c;
        int hashCode3 = (hashCode2 + (str3 == null ? 0 : str3.hashCode())) * 31;
        String str4 = this.f82209d;
        int hashCode4 = (hashCode3 + (str4 == null ? 0 : str4.hashCode())) * 31;
        List<DataItem> list = this.f82210e;
        int hashCode5 = (hashCode4 + (list == null ? 0 : list.hashCode())) * 31;
        List<String> list2 = this.f82211f;
        int hashCode6 = (hashCode5 + (list2 == null ? 0 : list2.hashCode())) * 31;
        String str5 = this.f82212g;
    ...
    public void writeToParcel(@NotNull Parcel out, int i) {
        Intrinsics.checkNotNullParameter(out, "out");
        out.writeString(this.f82206a);
        out.writeString(this.f82207b);
        out.writeString(this.f82208c);
        out.writeString(this.f82209d);
        List<DataItem> list = this.f82210e;
        if (list == null) {
            out.writeInt(0);
        } else {
        ...
        out.writeStringList(this.f82211f);
        out.writeString(this.f82212g);
    }
