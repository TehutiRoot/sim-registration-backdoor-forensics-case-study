...
public final class NestedReadonlySnapshot extends Snapshot {
    ...
    public void dispose() {
        if (!getDisposed$runtime_release()) {
            if (getId() != this.f28806e.getId()) {
                closeAndReleasePinning$runtime_release();
            }
            this.f28806e.nestedDeactivated$runtime_release(this);
            super.dispose();
        }
    }
    ...
    public NestedReadonlySnapshot takeNestedSnapshot(@Nullable Function1<Object, Unit> function1) {
        return new NestedReadonlySnapshot(getId(), getInvalid$runtime_release(), function1, this.f28806e);
    }
}