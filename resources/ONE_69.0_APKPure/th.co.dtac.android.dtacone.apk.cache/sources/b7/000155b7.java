...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.device_sale.DeviceSaleViewModel$getAuthorizationDeviceSale$2 */
/* loaded from: classes9.dex */
public final class DeviceSaleViewModel$getAuthorizationDeviceSale$2 extends Lambda implements Function1<GetAuthDeviceSaleResponse, Unit> {
    final /* synthetic */ DeviceSaleViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DeviceSaleViewModel$getAuthorizationDeviceSale$2(DeviceSaleViewModel deviceSaleViewModel) {
        super(1);
    ...
    public final void invoke2(GetAuthDeviceSaleResponse getAuthDeviceSaleResponse) {
        ...
        deviceSaleRepository.setRequirePaymentInfo(getAuthDeviceSaleResponse.isRequirePaymentInfo());
    }
}