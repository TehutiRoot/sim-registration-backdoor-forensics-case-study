...
public class PDMarkedContentReference implements COSObjectable {
    ...
    /* renamed from: a */
    public final COSDictionary f60281a;

    public PDMarkedContentReference() {
        COSDictionary cOSDictionary = new COSDictionary();
        this.f60281a = cOSDictionary;
    ...
    public PDPage getPage() {
        COSDictionary cOSDictionary = (COSDictionary) getCOSObject().getDictionaryObject(COSName.f59828PG);
    ...
    public void setPage(PDPage pDPage) {
        getCOSObject().setItem(COSName.f59828PG, pDPage);
    }
