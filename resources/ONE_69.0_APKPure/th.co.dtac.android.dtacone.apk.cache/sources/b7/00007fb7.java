...
public class GradientColorParser implements K12 {
    ...
    /* renamed from: a */
    public final GradientColor m50696a(GradientColor gradientColor, List list) {
        int i = this.f41554a * 4;
        if (list.size() <= i) {
        ...
        for (int i3 = 0; i3 < length; i3++) {
            ...
            if (binarySearch >= 0 && binarySearch2 <= 0) {
                iArr[i3] = m50694c(f, colors[binarySearch], fArr, fArr2);
            } else {
                if (binarySearch2 < 0) {
                    binarySearch2 = -(binarySearch2 + 1);
                }
                iArr[i3] = m50695b(f, fArr2[binarySearch2], positions, colors);
            }
        }
    ...
    /* renamed from: b */
    public int m50695b(float f, float f2, float[] fArr, int[] iArr) {
    ...
    /* renamed from: c */
    public final int m50694c(float f, int i, float[] fArr, float[] fArr2) {
        float lerp;
    ...
    public GradientColor parse(JsonReader jsonReader, float f) throws IOException {
        ...
        int i2 = 0;
        int i3 = 0;
        for (int i4 = 0; i4 < this.f41554a * 4; i4++) {
            int i5 = i4 / 4;
        ...
        return m50696a(new GradientColor(fArr, iArr), arrayList);
    }
}