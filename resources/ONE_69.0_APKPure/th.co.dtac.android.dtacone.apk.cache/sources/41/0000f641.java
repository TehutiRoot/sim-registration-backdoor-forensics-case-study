...
public class SHA512tDigest extends LongDigest {
    ...
    */
    ...
    public int doFinal(byte[] bArr, int i) {
        finish();
        longToBigEndian(this.f74907H1, bArr, i, this.digestLength);
        longToBigEndian(this.f74908H2, bArr, i + 8, this.digestLength - 8);
        longToBigEndian(this.f74909H3, bArr, i + 16, this.digestLength - 16);
        longToBigEndian(this.f74910H4, bArr, i + 24, this.digestLength - 24);
        longToBigEndian(this.f74911H5, bArr, i + 32, this.digestLength - 32);
        longToBigEndian(this.f74912H6, bArr, i + 40, this.digestLength - 40);
        longToBigEndian(this.f74913H7, bArr, i + 48, this.digestLength - 48);
        longToBigEndian(this.f74914H8, bArr, i + 56, this.digestLength - 56);
        reset();
    ...
    public void reset() {
        super.reset();
        this.f74907H1 = this.H1t;
        this.f74908H2 = this.H2t;
        this.f74909H3 = this.H3t;
        this.f74910H4 = this.H4t;
        this.f74911H5 = this.H5t;
        this.f74912H6 = this.H6t;
        this.f74913H7 = this.H7t;
        this.f74914H8 = this.H8t;
    }
