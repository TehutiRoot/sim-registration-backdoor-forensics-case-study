...
public final class SingleTimer extends Single<Long> {
    ...
    /* renamed from: b */
    public final TimeUnit f66049b;

    /* renamed from: c */
    public final Scheduler f66050c;
    ...
    public SingleTimer(long j, TimeUnit timeUnit, Scheduler scheduler) {
        this.f66048a = j;
        this.f66049b = timeUnit;
        this.f66050c = scheduler;
    }
    ...
    public void subscribeActual(SingleObserver<? super Long> singleObserver) {
        ...
        timerDisposable.setFuture(this.f66050c.scheduleDirect(timerDisposable, this.f66048a, this.f66049b));
    }
}