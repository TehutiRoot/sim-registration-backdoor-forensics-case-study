...
public final class TextViewEditorActionEvent {
    ...
    public static /* synthetic */ TextViewEditorActionEvent copy$default(TextViewEditorActionEvent textViewEditorActionEvent, TextView textView, int i, KeyEvent keyEvent, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            textView = textViewEditorActionEvent.f58336a;
        }
        if ((i2 & 2) != 0) {
            i = textViewEditorActionEvent.f58337b;
        }
        if ((i2 & 4) != 0) {
            keyEvent = textViewEditorActionEvent.f58338c;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        if (this != obj) {
            if (obj instanceof TextViewEditorActionEvent) {
                ...
                return Intrinsics.areEqual(this.f58336a, textViewEditorActionEvent.f58336a) && this.f58337b == textViewEditorActionEvent.f58337b && Intrinsics.areEqual(this.f58338c, textViewEditorActionEvent.f58338c);
            }
            return false;
        }
        return true;
    ...
    public int hashCode() {
        TextView textView = this.f58336a;
        int hashCode = (((textView != null ? textView.hashCode() : 0) * 31) + this.f58337b) * 31;
        KeyEvent keyEvent = this.f58338c;
        return hashCode + (keyEvent != null ? keyEvent.hashCode() : 0);
    }

    @NotNull
    public String toString() {
        return "TextViewEditorActionEvent(view=" + this.f58336a + ", actionId=" + this.f58337b + ", keyEvent=" + this.f58338c + ")";
    }
}