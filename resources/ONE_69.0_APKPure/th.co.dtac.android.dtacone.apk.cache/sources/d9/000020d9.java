...
public abstract class VideoRecordEvent {
    ...
    /* renamed from: a */
    public final OutputOptions f11884a;

    /* renamed from: b */
    public final RecordingStats f11885b;
    ...
    public static final class Finalize extends VideoRecordEvent {
        ...
        /* renamed from: c */
        public final OutputResults f11886c;

        /* renamed from: d */
        public final int f11887d;

        /* renamed from: e */
        public final Throwable f11888e;
        ...
        public Finalize(OutputOptions outputOptions, RecordingStats recordingStats, OutputResults outputResults, int i, Throwable th2) {
            ...
            this.f11886c = outputResults;
            this.f11887d = i;
            this.f11888e = th2;
        }

        /* renamed from: g */
        public static String m62217g(int i) {
            switch (i) {
                case 0:
                    return "ERROR_NONE";
                case 1:
    ...
    public VideoRecordEvent(OutputOptions outputOptions, RecordingStats recordingStats) {
        this.f11884a = (OutputOptions) Preconditions.checkNotNull(outputOptions);
        this.f11885b = (RecordingStats) Preconditions.checkNotNull(recordingStats);
    }

    /* renamed from: a */
    public static Finalize m62223a(OutputOptions outputOptions, RecordingStats recordingStats, OutputResults outputResults) {
        return new Finalize(outputOptions, recordingStats, outputResults, 0, null);
    }

    /* renamed from: b */
    public static Finalize m62222b(OutputOptions outputOptions, RecordingStats recordingStats, OutputResults outputResults, int i, Throwable th2) {
        boolean z;
        if (i != 0) {
            z = true;
        } else {
    ...
    /* renamed from: c */
    public static Pause m62221c(OutputOptions outputOptions, RecordingStats recordingStats) {
        return new Pause(outputOptions, recordingStats);
    }

    /* renamed from: d */
    public static Resume m62220d(OutputOptions outputOptions, RecordingStats recordingStats) {
        return new Resume(outputOptions, recordingStats);
    }

    /* renamed from: e */
    public static Start m62219e(OutputOptions outputOptions, RecordingStats recordingStats) {
        return new Start(outputOptions, recordingStats);
    }

    /* renamed from: f */
    public static Status m62218f(OutputOptions outputOptions, RecordingStats recordingStats) {
