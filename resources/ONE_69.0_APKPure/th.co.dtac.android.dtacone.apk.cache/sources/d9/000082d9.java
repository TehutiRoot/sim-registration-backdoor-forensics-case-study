...
public final class TransactionCurlCommandSharable implements Sharable {
    ...
    /* renamed from: a */
    public final HttpTransaction f42995a;

    public TransactionCurlCommandSharable(@NotNull HttpTransaction transaction) {
        Intrinsics.checkNotNullParameter(transaction, "transaction");
        this.f42995a = transaction;
    }

    /* renamed from: a */
    public final boolean m49889a(HttpHeader httpHeader) {
        if ((AbstractC19741eO1.equals("Accept-Encoding", httpHeader.getName(), true) && StringsKt__StringsKt.contains((CharSequence) "gzip", (CharSequence) httpHeader.getValue(), true)) || StringsKt__StringsKt.contains((CharSequence) "br", (CharSequence) httpHeader.getValue(), true)) {
            return true;
        }
        return false;
    }
    ...
    public Source toSharableContent(@NotNull Context context) {
        ...
        String method = this.f42995a.getMethod();
        buffer.writeUtf8("curl -X " + method);
        List<HttpHeader> parsedRequestHeaders = this.f42995a.getParsedRequestHeaders();
        if (parsedRequestHeaders != null) {
            z = false;
            for (HttpHeader httpHeader : parsedRequestHeaders) {
                if (m49889a(httpHeader)) {
                    z = true;
                }
        ...
        String requestBody = this.f42995a.getRequestBody();
        if (requestBody != null && requestBody.length() != 0) {
            String replace$default = AbstractC19741eO1.replace$default(requestBody, "\n", "\\n", false, 4, (Object) null);
        ...
        String formattedUrl = this.f42995a.getFormattedUrl(false);
