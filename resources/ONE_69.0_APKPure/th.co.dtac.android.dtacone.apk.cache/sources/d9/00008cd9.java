...
public final class CollectionUtils {
    /* renamed from: a */
    public static Map m48321a(int i, boolean z) {
        if (i <= 256) {
    ...
    /* renamed from: b */
    public static Set m48320b(int i, boolean z) {
        int i2;
        float f;
        if (true != z) {
            i2 = 256;
    ...
    public static <K, V> Map<K, V> mapOf(@NonNull K k, @NonNull V v, @NonNull K k2, @NonNull V v2, @NonNull K k3, @NonNull V v3) {
        Map m48321a = m48321a(3, false);
        m48321a.put(k, v);
        m48321a.put(k2, v2);
        m48321a.put(k3, v3);
        return Collections.unmodifiableMap(m48321a);
    }
    ...
    public static <K, V> Map<K, V> mapOfKeyValueArrays(@NonNull K[] kArr, @NonNull V[] vArr) {
        ...
        if (length == length2) {
            if (length != 0) {
                if (length != 1) {
                    Map m48321a = m48321a(length, false);
                    for (int i = 0; i < kArr.length; i++) {
                        m48321a.put(kArr[i], vArr[i]);
                    }
                    return Collections.unmodifiableMap(m48321a);
                }
    ...
    public static <T> Set<T> setOf(@NonNull T t, @NonNull T t2, @NonNull T t3) {
        Set m48320b = m48320b(3, false);
        m48320b.add(t);
        m48320b.add(t2);
        m48320b.add(t3);
        return Collections.unmodifiableSet(m48320b);
    }
        ...
        if (length != 0) {
            if (length != 1) {
                if (length == 2) {
                    T t = tArr[0];
                    T t2 = tArr[1];
                    Set m48320b = m48320b(2, false);
                    m48320b.add(t);
                    m48320b.add(t2);
                    return Collections.unmodifiableSet(m48320b);
                } else if (length != 3) {
                    if (length != 4) {
                        Set m48320b2 = m48320b(length, false);
                        Collections.addAll(m48320b2, tArr);
                        return Collections.unmodifiableSet(m48320b2);
                    }
                    T t3 = tArr[0];
                    T t4 = tArr[1];
                    T t5 = tArr[2];
                    T t6 = tArr[3];
                    Set m48320b3 = m48320b(4, false);
                    m48320b3.add(t3);
                    m48320b3.add(t4);
                    m48320b3.add(t5);
                    m48320b3.add(t6);
                    return Collections.unmodifiableSet(m48320b3);
                } else {
