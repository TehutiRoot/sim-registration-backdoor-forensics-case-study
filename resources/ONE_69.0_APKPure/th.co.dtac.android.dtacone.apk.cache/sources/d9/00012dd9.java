...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.deviceSaleTrueCompany.viewModel.OneDeviceSaleTrueViewModel$fetchDataPricePlansDetail$apiCall$1$3 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleTrueViewModel$fetchDataPricePlansDetail$apiCall$1$3 extends Lambda implements Function1<OneGetPricePlansDetailResponse, Boolean> {
    public static final OneDeviceSaleTrueViewModel$fetchDataPricePlansDetail$apiCall$1$3 INSTANCE = new OneDeviceSaleTrueViewModel$fetchDataPricePlansDetail$apiCall$1$3();

    public OneDeviceSaleTrueViewModel$fetchDataPricePlansDetail$apiCall$1$3() {
        super(1);
    }
