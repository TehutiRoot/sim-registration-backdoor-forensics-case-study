...
public class X931RNG {
    ...
    /* renamed from: DT */
    private final byte[] f75319DT;

    /* renamed from: I */
    private final byte[] f75320I;

    /* renamed from: R */
    private final byte[] f75321R;

    /* renamed from: V */
    private byte[] f75322V;
    ...
    public X931RNG(BlockCipher blockCipher, byte[] bArr, EntropySource entropySource) {
        ...
        this.f75320I = new byte[blockCipher.getBlockSize()];
        this.f75321R = new byte[blockCipher.getBlockSize()];
    }
    ...
    public int generate(byte[] bArr, boolean z) {
        ...
        if (z || this.f75322V == null) {
            byte[] entropy = this.entropySource.getEntropy();
            this.f75322V = entropy;
            if (entropy.length != this.engine.getBlockSize()) {
                throw new IllegalStateException("Insufficient entropy returned");
            }
        }
        int length = bArr.length / this.f75321R.length;
        for (int i = 0; i < length; i++) {
            this.engine.processBlock(this.f75319DT, 0, this.f75320I, 0);
            process(this.f75321R, this.f75320I, this.f75322V);
            process(this.f75322V, this.f75321R, this.f75320I);
            byte[] bArr2 = this.f75321R;
            System.arraycopy(bArr2, 0, bArr, bArr2.length * i, bArr2.length);
            increment(this.f75319DT);
        }
        int length2 = bArr.length - (this.f75321R.length * length);
        if (length2 > 0) {
            this.engine.processBlock(this.f75319DT, 0, this.f75320I, 0);
            process(this.f75321R, this.f75320I, this.f75322V);
            process(this.f75322V, this.f75321R, this.f75320I);
            byte[] bArr3 = this.f75321R;
