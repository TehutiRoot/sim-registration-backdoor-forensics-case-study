...
public final class WG2 implements InterfaceC23065xe2 {
    ...
    /* renamed from: c */
    public final FaceDetectorOptions f7243c;

    /* renamed from: d */
    public final int f7244d;

    /* renamed from: e */
    public final zzoc f7245e;
    ...
    public WG2(Context context, FaceDetectorOptions faceDetectorOptions, zzoc zzocVar) {
        this.f7242b = context;
        this.f7243c = faceDetectorOptions;
        this.f7244d = GoogleApiAvailabilityLight.getInstance().getApkVersion(context);
        this.f7245e = zzocVar;
    }

    /* renamed from: b */
    public static int m65775b(int i) {
        if (i != 1) {
            if (i == 2) {
                return 1;
            }
    ...
    /* renamed from: c */
    public static int m65774c(int i) {
        if (i != 1) {
            if (i == 2) {
                return 1;
            }
    ...
    /* renamed from: d */
    public static int m65773d(int i) {
        if (i != 1) {
            if (i == 2) {
                return 1;
            }
    ...
    public final Pair mo494a(InputImage inputImage) {
        List list;
        if (this.f7246f == null && this.f7247g == null) {
            zzd();
        }
        zzj zzjVar = this.f7246f;
        if (zzjVar == null && this.f7247g == null) {
            throw new MlKitException("Waiting for the face detection module to be downloaded. Please wait.", 14);
        }
        List list2 = null;
        if (zzjVar != null) {
            list = m65772e(zzjVar, inputImage);
            if (!this.f7243c.zzg()) {
                zzh.m37170e(list);
            }
        } else {
        ...
        zzj zzjVar2 = this.f7247g;
        if (zzjVar2 != null) {
            list2 = m65772e(zzjVar2, inputImage);
            zzh.m37170e(list2);
        }
    ...
    */
    public final java.util.List m65772e(com.google.android.gms.internal.mlkit_vision_face.zzj r15, com.google.mlkit.vision.common.InputImage r16) {
        /*
            r14 = this;
            ...
            if (r0 != r1) goto L8b
            r13 = r14
            int r0 = r13.f7244d     // Catch: android.os.RemoteException -> L89
        ...
        Lbb:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.WG2.m65772e(com.google.android.gms.internal.mlkit_vision_face.zzj, com.google.mlkit.vision.common.InputImage):java.util.List");
    }
    ...
    public final boolean zzd() {
        ...
        try {
            zzm zza = zzl.zza(DynamiteModule.load(this.f7242b, DynamiteModule.PREFER_REMOTE, OptionalModuleUtils.DEPRECATED_DYNAMITE_MODULE_ID).instantiate("com.google.android.gms.vision.face.ChimeraNativeFaceDetectorCreator"));
            IObjectWrapper wrap = ObjectWrapper.wrap(this.f7242b);
            if (this.f7243c.zzc() == 2) {
                if (this.f7247g == null) {
                    this.f7247g = zza.zzd(wrap, new com.google.android.gms.internal.mlkit_vision_face.zzh(2, 2, 0, true, false, this.f7243c.zza()));
                }
                if ((this.f7243c.zzd() == 2 || this.f7243c.zzb() == 2 || this.f7243c.zze() == 2) && this.f7246f == null) {
                    this.f7246f = zza.zzd(wrap, new com.google.android.gms.internal.mlkit_vision_face.zzh(m65773d(this.f7243c.zze()), m65774c(this.f7243c.zzd()), m65775b(this.f7243c.zzb()), false, this.f7243c.zzg(), this.f7243c.zza()));
                }
            } else if (this.f7246f == null) {
                this.f7246f = zza.zzd(wrap, new com.google.android.gms.internal.mlkit_vision_face.zzh(m65773d(this.f7243c.zze()), m65774c(this.f7243c.zzd()), m65775b(this.f7243c.zzb()), false, this.f7243c.zzg(), this.f7243c.zza()));
            }
            if (this.f7246f == null && this.f7247g == null && !this.f7241a) {
                OptionalModuleUtils.requestDownload(this.f7242b, OptionalModuleUtils.BARCODE);
                this.f7241a = true;
            }
            com.google.mlkit.vision.face.internal.zzj.zzc(this.f7245e, false, zzks.NO_ERROR);
            return false;
