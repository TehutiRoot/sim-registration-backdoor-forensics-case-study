...
public final class TouchExplorationStateProvider_androidKt$touchExplorationState$1 extends Lambda implements Function1<Lifecycle.Event, Unit> {
    ...
    public TouchExplorationStateProvider_androidKt$touchExplorationState$1(accessibility.AccessibilityManager$AccessibilityStateChangeListenerC21521oj0 accessibility_accessibilitymanager_accessibilitystatechangelistenerc21521oj0, AccessibilityManager accessibilityManager) {
        super(1);
    ...
    public final void invoke2(@NotNull Lifecycle.Event event) {
        ...
        if (event == Lifecycle.Event.ON_RESUME) {
            this.$listener.m26063d(this.$accessibilityManager);
        }
    }
}