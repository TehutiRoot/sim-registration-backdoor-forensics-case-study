...
@Metadata(m29143d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m29142d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_sportsMma", "Landroidx/compose/material/icons/Icons$Outlined;", "getSportsMma", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "SportsMma", "material-icons-extended_release"}, m29141k = 2, m29140mv = {1, 8, 0})
...
public final class SportsMmaKt {
    ...
    /* renamed from: a */
    public static ImageVector f18696a;

    @NotNull
    public static final ImageVector getSportsMma(@NotNull Icons.Outlined outlined) {
        Intrinsics.checkNotNullParameter(outlined, "<this>");
        ImageVector imageVector = f18696a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.SportsMma", C3623Dp.m73842constructorimpl(24.0f), C3623Dp.m73842constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder2.curveToRelative(0.55f, 0.0f, 1.09f, -0.44f, 1.2f, -0.98f);
        pathBuilder2.lineToRelative(0.77f, -3.83f);
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(17.0f, 10.6f);
        pathBuilder2.curveToRelative(0.0f, 0.13f, -0.64f, 3.4f, -0.64f, 3.4f);
        pathBuilder2.horizontalLineTo(7.64f);
        pathBuilder2.curveToRelative(0.0f, 0.0f, -0.64f, -3.26f, -0.64f, -3.4f);
        pathBuilder2.verticalLineTo(5.0f);
        pathBuilder2.horizontalLineToRelative(8.0f);
        pathBuilder2.verticalLineToRelative(5.0f);
        pathBuilder2.horizontalLineToRelative(2.0f);
        pathBuilder2.verticalLineTo(10.6f);
        pathBuilder2.close();
