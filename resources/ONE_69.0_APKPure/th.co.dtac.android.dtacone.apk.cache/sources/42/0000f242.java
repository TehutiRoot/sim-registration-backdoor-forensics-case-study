...
public class ConnPoolByRoute extends AbstractConnPool {
    ...
    /* renamed from: b */
    public final Log f74398b;

    /* renamed from: c */
    public final Lock f74399c;
    ...
    public class C12600a implements PoolEntryRequest {
        ...
        /* renamed from: a */
        public final /* synthetic */ WaitingThreadAborter f74402a;

        /* renamed from: b */
        public final /* synthetic */ HttpRoute f74403b;

        /* renamed from: c */
        public final /* synthetic */ Object f74404c;

        public C12600a(WaitingThreadAborter waitingThreadAborter, HttpRoute httpRoute, Object obj) {
            this.f74402a = waitingThreadAborter;
            this.f74403b = httpRoute;
            this.f74404c = obj;
        }

        @Override // org.apache.http.impl.conn.tsccm.PoolEntryRequest
        public void abortRequest() {
            ConnPoolByRoute.this.f74399c.lock();
            try {
                this.f74402a.abort();
            } finally {
                ConnPoolByRoute.this.f74399c.unlock();
            }
        }

        @Override // org.apache.http.impl.conn.tsccm.PoolEntryRequest
        public BasicPoolEntry getPoolEntry(long j, TimeUnit timeUnit) {
            return ConnPoolByRoute.this.getEntryBlocking(this.f74403b, this.f74404c, j, timeUnit, this.f74402a);
        }
    }
    ...
    /* renamed from: b */
    public final void m24805b(BasicPoolEntry basicPoolEntry) {
        OperatedClientConnection connection = basicPoolEntry.getConnection();
        if (connection != null) {
            try {
                connection.close();
            } catch (IOException e) {
                this.f74398b.debug("I/O error closing connection", e);
            }
        }
    }
    ...
    public void closeExpiredConnections() {
        this.f74398b.debug("Closing expired connections");
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                if (next.isExpired(currentTimeMillis)) {
                    if (this.f74398b.isDebugEnabled()) {
                        Log log = this.f74398b;
    ...
    public void closeIdleConnections(long j, TimeUnit timeUnit) {
        ...
        if (this.f74398b.isDebugEnabled()) {
            this.f74398b.debug("Closing connections idle longer than " + j + HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR + timeUnit);
        }
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                if (next.getUpdated() <= currentTimeMillis) {
                    if (this.f74398b.isDebugEnabled()) {
                        this.f74398b.debug("Closing connection last used @ " + new Date(next.getUpdated()));
                    }
                    it.remove();
                    deleteEntry(next);
                }
    ...
    public BasicPoolEntry createEntry(RouteSpecificPool routeSpecificPool, ClientConnectionOperator clientConnectionOperator) {
        if (this.f74398b.isDebugEnabled()) {
            this.f74398b.debug("Creating new connection [" + routeSpecificPool.getRoute() + "]");
        }
        BasicPoolEntry basicPoolEntry = new BasicPoolEntry(clientConnectionOperator, routeSpecificPool.getRoute(), this.f74400d, this.f74401e);
        this.f74399c.lock();
        try {
    ...
    public void deleteEntry(BasicPoolEntry basicPoolEntry) {
        ...
        if (this.f74398b.isDebugEnabled()) {
            this.f74398b.debug("Deleting connection [" + plannedRoute + "][" + basicPoolEntry.getState() + "]");
        }
        this.f74399c.lock();
        try {
            m24805b(basicPoolEntry);
    ...
    public void deleteLeastUsedEntry() {
        ...
        try {
            ...
            if (remove != null) {
                deleteEntry(remove);
            } else if (this.f74398b.isDebugEnabled()) {
                this.f74398b.debug("No free connection to delete");
            }
            this.f74399c.unlock();
        } catch (Throwable th2) {
            this.f74399c.unlock();
    ...
    public void freeEntry(BasicPoolEntry basicPoolEntry, boolean z, long j, TimeUnit timeUnit) {
        ...
        HttpRoute plannedRoute = basicPoolEntry.getPlannedRoute();
        if (this.f74398b.isDebugEnabled()) {
            this.f74398b.debug("Releasing connection [" + plannedRoute + "][" + basicPoolEntry.getState() + "]");
        }
        this.f74399c.lock();
        try {
            if (this.shutdown) {
            ...
            if (z && routePool.getCapacity() >= 0) {
                if (this.f74398b.isDebugEnabled()) {
                    ...
                    this.f74398b.debug("Pooling connection [" + plannedRoute + "][" + basicPoolEntry.getState() + "]; keep alive " + str);
                }
        ...
        while (!z) {
            try {
                ...
                if (basicPoolEntry != null) {
                    if (this.f74398b.isDebugEnabled()) {
                        this.f74398b.debug("Getting free connection [" + routeSpecificPool.getRoute() + "][" + obj + "]");
                    }
                    this.freeConnections.remove(basicPoolEntry);
                    if (basicPoolEntry.isExpired(System.currentTimeMillis())) {
                        if (this.f74398b.isDebugEnabled()) {
                            this.f74398b.debug("Closing expired free connection [" + routeSpecificPool.getRoute() + "][" + obj + "]");
                        }
                        m24805b(basicPoolEntry);
                    ...
                    this.f74398b.debug("No free connections [" + routeSpecificPool.getRoute() + "][" + obj + "]");
                }
                z = true;
            } catch (Throwable th2) {
                this.f74399c.unlock();
    ...
    */
    public void notifyWaitingThread(org.apache.http.impl.conn.tsccm.RouteSpecificPool r4) {
        /*
            r3 = this;
            java.util.concurrent.locks.Lock r0 = r3.f74399c
            r0.lock()
            if (r4 == 0) goto L3c
            boolean r0 = r4.hasThread()     // Catch: java.lang.Throwable -> L35
            if (r0 == 0) goto L3c
            org.apache.commons.logging.Log r0 = r3.f74398b     // Catch: java.lang.Throwable -> L35
        ...
        L3c:
            ...
            if (r4 != 0) goto L5c
            org.apache.commons.logging.Log r4 = r3.f74398b     // Catch: java.lang.Throwable -> L35
        ...
        L71:
            java.util.concurrent.locks.Lock r4 = r3.f74399c
            r4.unlock()
            return
        L77:
            java.util.concurrent.locks.Lock r0 = r3.f74399c
    ...
    public ConnPoolByRoute(ClientConnectionOperator clientConnectionOperator, ConnPerRoute connPerRoute, int i, long j, TimeUnit timeUnit) {
        this.f74398b = LogFactory.getLog(getClass());
        Args.notNull(clientConnectionOperator, "Connection operator");
        Args.notNull(connPerRoute, "Connections per route");
        this.f74399c = this.poolLock;
