...
public class DESEngine implements BlockCipher {
    ...
    private static final byte[] pc1 = {56, 48, 40, 32, Ascii.CAN, 16, 8, 0, 57, Framer.STDOUT_FRAME_PREFIX, 41, Framer.ENTER_FRAME_PREFIX, Ascii.f52696EM, 17, 9, 1, 58, Framer.STDERR_FRAME_PREFIX, 42, 34, Ascii.SUB, 18, 10, 2, 59, 51, 43, 35, 62, 54, 46, 38, Ascii.f52703RS, Ascii.SYN, 14, 6, Base64.padSymbol, 53, Framer.STDIN_FRAME_PREFIX, 37, Ascii.f52699GS, Ascii.NAK, 13, 5, 60, 52, 44, 36, Ascii.f52698FS, Ascii.DC4, 12, 4, Ascii.ESC, 19, 11, 3};
    private static final byte[] totrot = {1, 2, 4, 6, 8, 10, 12, 14, 15, 17, 19, Ascii.NAK, Ascii.ETB, Ascii.f52696EM, Ascii.ESC, Ascii.f52698FS};
    private static final byte[] pc2 = {13, 16, 10, Ascii.ETB, 0, 4, 2, Ascii.ESC, 14, 5, Ascii.DC4, 9, Ascii.SYN, 18, 11, 3, Ascii.f52696EM, 7, 15, 6, Ascii.SUB, 19, 12, 1, 40, 51, Ascii.f52703RS, 36, 46, 54, Ascii.f52699GS, 39, Framer.STDERR_FRAME_PREFIX, 44, 32, 47, 43, 48, 38, 55, Framer.ENTER_FRAME_PREFIX, 52, Framer.STDIN_FRAME_PREFIX, 41, Framer.STDOUT_FRAME_PREFIX, 35, Ascii.f52698FS, Ascii.f52707US};
