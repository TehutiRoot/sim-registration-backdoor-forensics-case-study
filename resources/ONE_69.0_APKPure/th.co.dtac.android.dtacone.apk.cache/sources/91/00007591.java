...
public interface Animatable2Compat extends Animatable {
    ...
    public static abstract class AnimationCallback {
        ...
        /* renamed from: a */
        public Animatable2.AnimationCallback f37945a;

        /* renamed from: androidx.vectordrawable.graphics.drawable.Animatable2Compat$AnimationCallback$a */
        /* loaded from: classes2.dex */
        public class C5125a extends Animatable2.AnimationCallback {
            public C5125a() {
            }
        ...
        /* renamed from: a */
        public Animatable2.AnimationCallback m52532a() {
            if (this.f37945a == null) {
                this.f37945a = new C5125a();
            }
            return this.f37945a;
        }
