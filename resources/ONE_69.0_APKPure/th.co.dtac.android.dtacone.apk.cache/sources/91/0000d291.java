...
public final class ObservableWindow<T> extends AbstractC11078a {

    /* renamed from: a */
    public final long f65699a;

    /* renamed from: b */
    public final long f65700b;
    ...
    public void subscribeActual(Observer<? super Observable<T>> observer) {
        if (this.f65699a == this.f65700b) {
            this.source.subscribe(new WindowExactObserver(observer, this.f65699a, this.f65701c));
        } else {
            this.source.subscribe(new WindowSkipObserver(observer, this.f65699a, this.f65700b, this.f65701c));
        }
    }
}