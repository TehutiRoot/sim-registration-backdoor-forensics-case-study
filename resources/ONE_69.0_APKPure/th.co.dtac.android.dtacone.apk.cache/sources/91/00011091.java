...
public final class DataItem {
    ...
    /* renamed from: a */
    private final Total f82089a;
    @SerializedName("commission")
    @Nullable

    /* renamed from: b */
    private final List<CommissionItem> f82090b;
    @SerializedName("campaign")
    @Nullable

    /* renamed from: c */
    private ProfitSummaryReport.Data.Campaign f82091c;
    @SerializedName("profit")
    @Nullable

    /* renamed from: d */
    private final Profit f82092d;
    ...
    public static /* synthetic */ DataItem copy$default(DataItem dataItem, Total total, List list, ProfitSummaryReport.Data.Campaign campaign, Profit profit, int i, Object obj) {
        if ((i & 1) != 0) {
            total = dataItem.f82089a;
        }
        if ((i & 2) != 0) {
            list = dataItem.f82090b;
        }
        if ((i & 4) != 0) {
            campaign = dataItem.f82091c;
        }
        if ((i & 8) != 0) {
            profit = dataItem.f82092d;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof DataItem) {
            ...
            return Intrinsics.areEqual(this.f82089a, dataItem.f82089a) && Intrinsics.areEqual(this.f82090b, dataItem.f82090b) && Intrinsics.areEqual(this.f82091c, dataItem.f82091c) && Intrinsics.areEqual(this.f82092d, dataItem.f82092d);
        }
        return false;
    }
    ...
    public int hashCode() {
        Total total = this.f82089a;
        int hashCode = (total == null ? 0 : total.hashCode()) * 31;
        List<CommissionItem> list = this.f82090b;
        int hashCode2 = (hashCode + (list == null ? 0 : list.hashCode())) * 31;
        ProfitSummaryReport.Data.Campaign campaign = this.f82091c;
        int hashCode3 = (hashCode2 + (campaign == null ? 0 : campaign.hashCode())) * 31;
        Profit profit = this.f82092d;
