...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_mnp.MrtrMnpViewModel$submit$1$1 */
/* loaded from: classes9.dex */
public final class MrtrMnpViewModel$submit$1$1 extends Lambda implements Function1<Disposable, Unit> {
    final /* synthetic */ MrtrMnpViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrMnpViewModel$submit$1$1(MrtrMnpViewModel mrtrMnpViewModel) {
        super(1);
    ...
    public final void invoke2(Disposable disposable) {
        this.this$0.setMnpSubmitResponse(null);
