...
public class MagicIndicator extends FrameLayout {
    ...
    /* renamed from: a */
    public IPagerNavigator f72399a;
    ...
    public void onPageScrollStateChanged(int i) {
        IPagerNavigator iPagerNavigator = this.f72399a;
    ...
    public void setNavigator(IPagerNavigator iPagerNavigator) {
        IPagerNavigator iPagerNavigator2 = this.f72399a;
        ...
        this.f72399a = iPagerNavigator;
        removeAllViews();
        if (this.f72399a instanceof View) {
            addView((View) this.f72399a, new FrameLayout.LayoutParams(-1, -1));
            this.f72399a.onAttachToMagicIndicator();
        }
    }
