...
public final class FlowableMapNotification<T, R> extends AbstractC0558I {

    /* renamed from: b */
    public final Function f64451b;

    /* renamed from: c */
    public final Function f64452c;

    /* renamed from: d */
    public final Callable f64453d;
    ...
    public FlowableMapNotification(Flowable<T> flowable, Function<? super T, ? extends R> function, Function<? super Throwable, ? extends R> function2, Callable<? extends R> callable) {
        super(flowable);
        this.f64451b = function;
        this.f64452c = function2;
        this.f64453d = callable;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super R> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new MapNotificationSubscriber(subscriber, this.f64451b, this.f64452c, this.f64453d));
    }
}