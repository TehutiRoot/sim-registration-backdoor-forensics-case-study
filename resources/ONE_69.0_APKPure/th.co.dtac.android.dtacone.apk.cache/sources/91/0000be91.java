...
public class setLayoutDirection implements setDarkTextColor.valueOf {
    private final setDarkTextColor valueOf;

    public setLayoutDirection(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.jcbConfiguration(this.valueOf);
    }
}