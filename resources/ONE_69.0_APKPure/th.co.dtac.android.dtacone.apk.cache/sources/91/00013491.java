...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.notification.activity.OneNewsNotificationActivity$initViewModel$1$3 */
/* loaded from: classes10.dex */
public final class OneNewsNotificationActivity$initViewModel$1$3 extends Lambda implements Function1<StatusResource, Unit> {
    final /* synthetic */ OneNewsNotificationActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneNewsNotificationActivity$initViewModel$1$3(OneNewsNotificationActivity oneNewsNotificationActivity) {
        super(1);
