    ...
    public final Modifier invoke(@NotNull Modifier composed, @Nullable Composer composer, int i) {
        ...
        if (changed2 || rememberedValue2 == Composer.Companion.getEmpty()) {
            rememberedValue2 = new ScrollableState(textFieldScrollerPosition2) { // from class: androidx.compose.foundation.text.TextFieldScrollKt$textFieldScrollable$2$wrappedScrollableState$1$1
                ...
                /* renamed from: b */
                public final State f14130b;

                /* renamed from: c */
                public final State f14131c;

                {
                    this.f14130b = SnapshotStateKt.derivedStateOf(new C3006xe39168d8(textFieldScrollerPosition2));
                    this.f14131c = SnapshotStateKt.derivedStateOf(new C3005x355dcd8c(textFieldScrollerPosition2));
                }
                ...
                public boolean getCanScrollForward() {
                    return ((Boolean) this.f14130b.getValue()).booleanValue();
                }
