...
/* renamed from: th.co.dtac.android.dtacone.view.fragment.mrtr_prepaid_registration.MrtrPrepaidScanBarcodeFragment$setUpViewModel$1$1 */
/* loaded from: classes9.dex */
public final class MrtrPrepaidScanBarcodeFragment$setUpViewModel$1$1 extends Lambda implements Function1<FragmentNavEvent, Unit> {
    final /* synthetic */ MrtrPrepaidScanBarcodeFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrPrepaidScanBarcodeFragment$setUpViewModel$1$1(MrtrPrepaidScanBarcodeFragment mrtrPrepaidScanBarcodeFragment) {
        super(1);
        this.this$0 = mrtrPrepaidScanBarcodeFragment;
    }
    ...
    public final void invoke2(@NotNull FragmentNavEvent it) {
        ...
        MrtrPrepaidRegistrationActivity m4886o = this.this$0.m4886o();
        if (m4886o != null) {
            m4886o.replaceFragment(it.buildFragment(), it.getTag());
        }
    }
}