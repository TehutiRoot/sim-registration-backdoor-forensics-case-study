...
public class TrustedWebUtils {
    ...
    public static void launchBrowserSiteSettings(@NonNull Context context, @NonNull CustomTabsSession customTabsSession, @NonNull Uri uri) {
        ...
        intent.setPackage(customTabsSession.m63980g().getPackageName());
        intent.setData(uri);
        Bundle bundle = new Bundle();
        bundle.putBinder(CustomTabsIntent.EXTRA_SESSION, customTabsSession.m63981f());
        intent.putExtras(bundle);
        PendingIntent m63979h = customTabsSession.m63979h();
        if (m63979h != null) {
            intent.putExtra(CustomTabsIntent.EXTRA_SESSION_ID, m63979h);
        }
