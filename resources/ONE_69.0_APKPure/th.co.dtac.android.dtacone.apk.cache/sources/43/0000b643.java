...
public final class FieldType {
    ...
    public static /* synthetic */ class C8869a {
        ...
        /* renamed from: b */
        public static final /* synthetic */ int[] f57349b;
        ...
        static {
            ...
            try {
                f57349b[JavaType.MESSAGE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f57349b[JavaType.STRING.ordinal()] = 3;
            ...
            try {
                f57348a[Collection.VECTOR.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f57348a[Collection.SCALAR.ordinal()] = 3;
    ...
    static {
        ...
        for (FieldType fieldType : values) {
            VALUES[fieldType.f57347id] = fieldType;
        }
    }
    ...
    private FieldType(String str, int i, int i2, Collection collection, JavaType javaType) {
        ...
        int i4 = C8869a.f57348a[collection.ordinal()];
        boolean z = true;
        if (i4 != 1) {
            if (i4 != 2) {
        ...
        this.primitiveScalar = (collection != Collection.SCALAR || (i3 = C8869a.f57349b[javaType.ordinal()]) == 1 || i3 == 2 || i3 == 3) ? false : false;
    }
