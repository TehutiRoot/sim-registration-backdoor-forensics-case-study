...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.staff.fragment.OneStaffDetailFragment$setUpViewModel$1$5 */
/* loaded from: classes10.dex */
public final class OneStaffDetailFragment$setUpViewModel$1$5 extends Lambda implements Function1<StatusResource, Unit> {
    final /* synthetic */ OneStaffDetailFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneStaffDetailFragment$setUpViewModel$1$5(OneStaffDetailFragment oneStaffDetailFragment) {
        super(1);
    ...
    public final void invoke2(StatusResource statusResource) {
        this.this$0.m9968B(statusResource);
    }
}