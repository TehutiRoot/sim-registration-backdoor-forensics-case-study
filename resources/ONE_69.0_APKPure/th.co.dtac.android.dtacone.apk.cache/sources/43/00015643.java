...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.esim.ESimPostpaidViewModel$callSendSaleTransToRichPOS$3 */
/* loaded from: classes9.dex */
public final class ESimPostpaidViewModel$callSendSaleTransToRichPOS$3 extends Lambda implements Function1<SendSaleTransToRichPOSResponse, Unit> {
    final /* synthetic */ ESimPostpaidViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimPostpaidViewModel$callSendSaleTransToRichPOS$3(ESimPostpaidViewModel eSimPostpaidViewModel) {
        super(1);
    ...
    public final void invoke2(SendSaleTransToRichPOSResponse sendSaleTransToRichPOSResponse) {
        MutableLiveData m2814m0;
        this.this$0.getLiveDataState().setValue(StatusResource.SUCCESS);
        m2814m0 = this.this$0.m2814m0();
        m2814m0.setValue(new Event(new FragmentNavEvent(ESimShowQrCodeFragment.class, null, null, 4, null)));
    }
}