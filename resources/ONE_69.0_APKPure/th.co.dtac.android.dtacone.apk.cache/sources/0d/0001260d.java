...
/* renamed from: th.co.dtac.android.dtacone.repository.customer_enquiry.CustomerEnquiryRepository$getPre2PostRecommendedPackage$1 */
/* loaded from: classes8.dex */
public final class CustomerEnquiryRepository$getPre2PostRecommendedPackage$1 extends Lambda implements Function1<RecommendPackageResponse, RecommendPackageResponse> {
    final /* synthetic */ CustomerEnquiryRepository this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CustomerEnquiryRepository$getPre2PostRecommendedPackage$1(CustomerEnquiryRepository customerEnquiryRepository) {
        super(1);
    ...
    public final RecommendPackageResponse invoke(@NotNull RecommendPackageResponse it) {
        ...
        this.this$0.setRecommendPackageResponse(it);
        return it;
    }
}