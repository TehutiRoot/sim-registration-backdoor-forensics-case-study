...
public final class TransactionOverviewFragment extends Fragment {
    ...
    /* renamed from: a */
    public final Lazy f43030a;

    /* renamed from: b */
    public ChuckerFragmentTransactionOverviewBinding f43031b;

    public TransactionOverviewFragment() {
        Function0 function0 = TransactionOverviewFragment$viewModel$2.INSTANCE;
        this.f43030a = FragmentViewModelLazyKt.createViewModelLazy(this, Reflection.getOrCreateKotlinClass(TransactionViewModel.class), new C5969x86f486bd(this), new C5970x86f486be(null, this), function0 == null ? new C5971x86f486bf(this) : function0);
    }

    /* renamed from: l */
    public static /* synthetic */ void m49859l(Menu menu, Boolean bool) {
        m49856o(menu, bool);
    }

    /* renamed from: m */
    public static /* synthetic */ void m49858m(TransactionOverviewFragment transactionOverviewFragment, Pair pair) {
        m49855p(transactionOverviewFragment, pair);
    }

    /* renamed from: n */
    private final TransactionViewModel m49857n() {
        return (TransactionViewModel) this.f43030a.getValue();
    }

    /* renamed from: o */
    public static final void m49856o(Menu menu, Boolean it) {
    ...
    /* renamed from: p */
    public static final void m49855p(TransactionOverviewFragment this$0, Pair pair) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.m49854q((HttpTransaction) pair.component1(), ((Boolean) pair.component2()).booleanValue());
    }
    ...
    public void onCreateOptionsMenu(@NotNull final Menu menu, @NotNull MenuInflater inflater) {
        ...
        m49857n().getDoesUrlRequireEncoding().observe(getViewLifecycleOwner(), new Observer() { // from class: LV1
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                TransactionOverviewFragment.m49859l(menu, (Boolean) obj);
            }
        });
    ...
    public void onViewCreated(@NotNull View view, @Nullable Bundle bundle) {
        ...
        LiveDataUtilsKt.combineLatest(m49857n().getTransaction(), m49857n().getEncodeUrl()).observe(getViewLifecycleOwner(), new Observer() { // from class: MV1
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                TransactionOverviewFragment.m49858m(TransactionOverviewFragment.this, (Pair) obj);
            }
        });
    }

    /* renamed from: q */
    public final void m49854q(HttpTransaction httpTransaction, boolean z) {
        String str;
        String str2;
        String str3;
        ...
        String str10;
        String str11;
        ChuckerFragmentTransactionOverviewBinding chuckerFragmentTransactionOverviewBinding = this.f43031b;
        String str12 = null;
