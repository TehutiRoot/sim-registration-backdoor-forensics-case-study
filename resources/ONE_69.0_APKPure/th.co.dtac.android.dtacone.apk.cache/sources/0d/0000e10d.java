...
public final class CapturedType extends SimpleType implements CapturedTypeMarker {
    ...
    /* renamed from: b */
    public final TypeProjection f69927b;

    /* renamed from: c */
    public final CapturedTypeConstructor f69928c;

    /* renamed from: d */
    public final boolean f69929d;

    /* renamed from: e */
    public final TypeAttributes f69930e;
    ...
    public String toString() {
        ...
        sb.append("Captured(");
        sb.append(this.f69927b);
        sb.append(CoreConstants.RIGHT_PARENTHESIS_CHAR);
        if (isMarkedNullable()) {
            str = CallerData.f39637NA;
        } else {
            str = "";
        }
        sb.append(str);
    ...
    public SimpleType replaceAttributes(@NotNull TypeAttributes newAttributes) {
        ...
        return new CapturedType(this.f69927b, getConstructor(), isMarkedNullable(), newAttributes);
    }

    @Override // kotlin.reflect.jvm.internal.impl.types.SimpleType, kotlin.reflect.jvm.internal.impl.types.UnwrappedType
    @NotNull
    public CapturedType makeNullableAsSpecified(boolean z) {
        return z == isMarkedNullable() ? this : new CapturedType(this.f69927b, getConstructor(), z, getAttributes());
    }
    ...
    public CapturedType refine(@NotNull KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        TypeProjection refine = this.f69927b.refine(kotlinTypeRefiner);
    ...
    public CapturedType(@NotNull TypeProjection typeProjection, @NotNull CapturedTypeConstructor constructor, boolean z, @NotNull TypeAttributes attributes) {
        ...
        this.f69927b = typeProjection;
        this.f69928c = constructor;
        this.f69929d = z;
        this.f69930e = attributes;
    }
}