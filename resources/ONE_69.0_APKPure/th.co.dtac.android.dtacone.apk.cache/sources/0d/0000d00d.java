...
public final class FlowableSkipLast<T> extends AbstractC0558I {
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new SkipLastSubscriber(subscriber, this.f64607b));
    }
}