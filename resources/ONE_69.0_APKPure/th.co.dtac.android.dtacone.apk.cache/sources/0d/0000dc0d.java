...
public class CreateKCallableVisitor extends DeclarationDescriptorVisitorEmptyBodies<KCallableImpl<?>, Unit> {
    ...
    public KCallableImpl<?> visitFunctionDescriptor(@NotNull FunctionDescriptor descriptor, @NotNull Unit data) {
        ...
        return new KFunctionImpl(this.f68393a, descriptor);
    }
    ...
    public KCallableImpl<?> visitPropertyDescriptor(@NotNull PropertyDescriptor descriptor, @NotNull Unit data) {
        ...
        if (descriptor.isVar()) {
            if (i == 0) {
                return new KMutableProperty0Impl(this.f68393a, descriptor);
            }
            if (i == 1) {
                return new KMutableProperty1Impl(this.f68393a, descriptor);
            }
            if (i == 2) {
                return new KMutableProperty2Impl(this.f68393a, descriptor);
            }
        } else if (i == 0) {
            return new KProperty0Impl(this.f68393a, descriptor);
        } else {
            if (i == 1) {
                return new KProperty1Impl(this.f68393a, descriptor);
            }
            if (i == 2) {
                return new KProperty2Impl(this.f68393a, descriptor);
            }
        }
