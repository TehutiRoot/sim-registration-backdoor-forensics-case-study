...
public final class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerItemDecoration(@NotNull Drawable dividerDrawable) {
        ...
        this.f84824a = dividerDrawable;
        this.f84825b = 1;
    }

    /* renamed from: a */
    public final void m19694a(Canvas canvas, RecyclerView recyclerView) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            this.f84824a.setBounds(right, paddingTop, this.f84824a.getIntrinsicWidth() + right, height);
            this.f84824a.draw(canvas);
        }
    }

    /* renamed from: b */
    public final void m19693b(Canvas canvas, RecyclerView recyclerView) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            this.f84824a.setBounds(paddingLeft, bottom, width, this.f84824a.getIntrinsicHeight() + bottom);
            this.f84824a.draw(canvas);
        }
    }
    ...
    public void getItemOffsets(@NotNull Rect outRect, @NotNull View view, @NotNull RecyclerView parent, @NotNull RecyclerView.State state) {
        ...
        this.f84825b = orientation;
        if (orientation != 0) {
            if (orientation == 1) {
                outRect.top = this.f84824a.getIntrinsicHeight();
                return;
            }
            return;
        }
        outRect.left = this.f84824a.getIntrinsicWidth();
    }
    ...
    public void onDraw(@NotNull Canvas canvas, @NotNull RecyclerView parent, @NotNull RecyclerView.State state) {
        ...
        if (i != 0) {
            if (i == 1) {
                m19693b(canvas, parent);
                return;
            }
            return;
        }
        m19694a(canvas, parent);
    }
}