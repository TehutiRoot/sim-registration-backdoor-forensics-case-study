...
public final class GaugeMetadata extends GeneratedMessageLite<GaugeMetadata, Builder> implements GaugeMetadataOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<GaugeMetadata, Builder> implements GaugeMetadataOrBuilder {
        public /* synthetic */ Builder(C8584a c8584a) {
            this();
        }

        public Builder clearCpuClockRateKhz() {
            copyOnWrite();
            ((GaugeMetadata) this.instance).m38060P();
            return this;
        }

        public Builder clearCpuProcessorCount() {
            copyOnWrite();
            ((GaugeMetadata) this.instance).m38059Q();
            return this;
        }

        public Builder clearDeviceRamSizeKb() {
            copyOnWrite();
            ((GaugeMetadata) this.instance).m38058R();
            return this;
        }

        public Builder clearMaxAppJavaHeapMemoryKb() {
            copyOnWrite();
            ((GaugeMetadata) this.instance).m38057S();
            return this;
        }

        public Builder clearMaxEncouragedAppJavaHeapMemoryKb() {
            copyOnWrite();
            ((GaugeMetadata) this.instance).m38056T();
            return this;
        }
        ...
        public Builder clearProcessName() {
            copyOnWrite();
            ((GaugeMetadata) this.instance).m38055U();
            return this;
        }
        ...
        public Builder setCpuClockRateKhz(int i) {
            copyOnWrite();
            ((GaugeMetadata) this.instance).m38054V(i);
            return this;
        }

        public Builder setCpuProcessorCount(int i) {
            copyOnWrite();
            ((GaugeMetadata) this.instance).m38053W(i);
            return this;
        }

        public Builder setDeviceRamSizeKb(int i) {
            copyOnWrite();
            ((GaugeMetadata) this.instance).m38052X(i);
            return this;
        }

        public Builder setMaxAppJavaHeapMemoryKb(int i) {
            copyOnWrite();
            ((GaugeMetadata) this.instance).m38051Y(i);
            return this;
        }

        public Builder setMaxEncouragedAppJavaHeapMemoryKb(int i) {
            copyOnWrite();
            ((GaugeMetadata) this.instance).m38050Z(i);
            return this;
        }
        ...
        public Builder setProcessName(String str) {
            copyOnWrite();
            ((GaugeMetadata) this.instance).m38049a0(str);
            return this;
        }
        ...
        public Builder setProcessNameBytes(ByteString byteString) {
            copyOnWrite();
            ((GaugeMetadata) this.instance).m38048b0(byteString);
            return this;
        }
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C8584a {
    ...
    /* renamed from: P */
    public final void m38060P() {
        this.bitField0_ &= -3;
        this.cpuClockRateKhz_ = 0;
    }

    /* renamed from: Q */
    public final void m38059Q() {
        this.bitField0_ &= -5;
        this.cpuProcessorCount_ = 0;
    }

    /* renamed from: R */
    public final void m38058R() {
        this.bitField0_ &= -9;
        this.deviceRamSizeKb_ = 0;
    }

    /* renamed from: S */
    public final void m38057S() {
        this.bitField0_ &= -17;
        this.maxAppJavaHeapMemoryKb_ = 0;
    }

    /* renamed from: T */
    public final void m38056T() {
        this.bitField0_ &= -33;
        this.maxEncouragedAppJavaHeapMemoryKb_ = 0;
    }

    /* renamed from: U */
    public final void m38055U() {
        this.bitField0_ &= -2;
        this.processName_ = getDefaultInstance().getProcessName();
    }

    /* renamed from: V */
    public final void m38054V(int i) {
        this.bitField0_ |= 2;
        this.cpuClockRateKhz_ = i;
    }

    /* renamed from: W */
    public final void m38053W(int i) {
        this.bitField0_ |= 4;
        this.cpuProcessorCount_ = i;
    }

    /* renamed from: X */
    public final void m38052X(int i) {
        this.bitField0_ |= 8;
        this.deviceRamSizeKb_ = i;
    }

    /* renamed from: Y */
    public final void m38051Y(int i) {
        this.bitField0_ |= 16;
        this.maxAppJavaHeapMemoryKb_ = i;
    }

    /* renamed from: Z */
    public final void m38050Z(int i) {
        this.bitField0_ |= 32;
        this.maxEncouragedAppJavaHeapMemoryKb_ = i;
    }

    /* renamed from: a0 */
    public final void m38049a0(String str) {
        str.getClass();
        this.bitField0_ |= 1;
    ...
    /* renamed from: b0 */
    public final void m38048b0(ByteString byteString) {
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C8584a.f56307a[methodToInvoke.ordinal()]) {
            case 1:
