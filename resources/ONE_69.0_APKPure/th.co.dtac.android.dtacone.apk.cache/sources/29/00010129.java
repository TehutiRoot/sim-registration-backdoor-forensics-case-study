...
public class PKIXCertPathReviewer extends CertPathValidatorUtilities {
    ...
    private String IPtoString(byte[] bArr) {
        try {
            ...
            for (int i = 0; i != bArr.length; i++) {
                ...
                stringBuffer.append(TokenParser.f74644SP);
            }
    ...
    */
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(17:(2:91|92)|(15:94|95|96|(11:98|99|(2:102|100)|103|104|(2:107|105)|108|109|110|111|112)|119|99|(1:100)|103|104|(1:105)|108|109|110|111|112)|122|95|96|(0)|119|99|(1:100)|103|104|(1:105)|108|109|110|111|112) */
    /* JADX WARN: Can't wrap try/catch for region: R(19:30|(2:137|138)(2:32|(2:130|131)(20:34|(2:38|(17:40|41|42|43|44|(18:91|92|(15:94|95|96|(11:98|99|(2:102|100)|103|104|(2:107|105)|108|109|110|111|112)|119|99|(1:100)|103|104|(1:105)|108|109|110|111|112)|122|95|96|(0)|119|99|(1:100)|103|104|(1:105)|108|109|110|111|112)(1:46)|(1:90)(1:50)|51|(1:89)(7:53|(1:57)|58|59|(2:61|(1:63))(1:85)|64|(9:66|(1:83)|70|71|72|73|74|76|77))|84|70|71|72|73|74|76|77))|129|41|42|43|44|(0)(0)|(1:48)|90|51|(0)(0)|84|70|71|72|73|74|76|77))|132|42|43|44|(0)(0)|(0)|90|51|(0)(0)|84|70|71|72|73|74|76|77) */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:151:0x03fc, code lost:
        addError(new org.bouncycastle.i18n.ErrorBundle(r12, "CertPathReviewer.pubKeyError"), r11);
     */
    /* JADX WARN: Code restructure failed: missing block: B:81:0x0264, code lost:
        r2 = new java.lang.Object[r15];
        r2[0] = new org.bouncycastle.i18n.filter.TrustedInput(r3.getNotAfter());
        r0 = new org.bouncycastle.i18n.ErrorBundle(r9, "CertPathReviewer.certificateExpired", r2);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:83:0x027c, code lost:
        r2 = new java.lang.Object[r15];
        r2[0] = new org.bouncycastle.i18n.filter.TrustedInput(r3.getNotBefore());
        r0 = new org.bouncycastle.i18n.ErrorBundle(r9, "CertPathReviewer.certificateNotYetValid", r2);
     */
    /* JADX WARN: Code restructure failed: missing block: B:96:0x02bf, code lost:
        addError(new org.bouncycastle.i18n.ErrorBundle(r9, "CertPathReviewer.crlAuthInfoAccError"), r5);
     */
    /* JADX WARN: Removed duplicated region for block: B:101:0x02dd A[LOOP:1: B:99:0x02d7->B:101:0x02dd, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:105:0x0300 A[LOOP:2: B:103:0x02fa->B:105:0x0300, LOOP_END] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:164:0x0299 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:31:0x0104  */
    /* JADX WARN: Removed duplicated region for block: B:45:0x014c  */
    /* JADX WARN: Removed duplicated region for block: B:47:0x0150  */
    /* JADX WARN: Removed duplicated region for block: B:54:0x0175  */
    /* JADX WARN: Removed duplicated region for block: B:57:0x0186  */
    /* JADX WARN: Removed duplicated region for block: B:94:0x02ba A[Catch: AnnotatedException -> 0x02bf, TRY_LEAVE, TryCatch #11 {AnnotatedException -> 0x02bf, blocks: (B:92:0x02b2, B:94:0x02ba), top: B:171:0x02b2 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    private X509CRL getCRL(String str) throws CertPathReviewerException {
        try {
            URL url = new URL(str);
            if (!url.getProtocol().equals("http") && !url.getProtocol().equals(UriUtil.HTTPS_SCHEME)) {
                return null;
            }
        ...
        try {
            ...
            while (i3 < aSN1Sequence.size()) {
                ...
                if (ETSIQCObjectIdentifiers.id_etsi_qcs_QcCompliance.equals((ASN1Primitive) qCStatement.getStatementId())) {
                    errorBundle2 = new ErrorBundle(str2, "CertPathReviewer.QcEuCompliance");
                } else if (RFC3739QCObjectIdentifiers.id_qcs_pkixQCSyntax_v1.equals((ASN1Primitive) qCStatement.getStatementId())) {
                    str = str2;
                    i2 = 1;
                    i3 += i2;
                    str2 = str;
                    c = 2;
                } else if (ETSIQCObjectIdentifiers.id_etsi_qcs_QcSSCD.equals((ASN1Primitive) qCStatement.getStatementId())) {
                    errorBundle2 = new ErrorBundle(str2, "CertPathReviewer.QcSSCD");
                    ...
                    try {
                        ...
                        if (monetaryValue.getCurrency().isAlphabetic()) {
                            ...
                            TrustedInput trustedInput = new TrustedInput(new Double(doubleValue));
                            Object[] objArr = new Object[3];
                            objArr[0] = alphabetic;
                            objArr[1] = trustedInput;
                            objArr[c] = monetaryValue;
                            str = str3;
                            try {
                                errorBundle = new ErrorBundle(str, "CertPathReviewer.QcLimitValueAlpha", objArr);
                            } catch (AnnotatedException unused) {
                                addError(new ErrorBundle(str, "CertPathReviewer.QcStatementExtError"), i);
                                return false;
                            }
                        } else {
                            str = str3;
                            errorBundle = new ErrorBundle(str, "CertPathReviewer.QcLimitValueNum", new Object[]{Integers.valueOf(monetaryValue.getCurrency().getNumeric()), new TrustedInput(new Double(doubleValue)), monetaryValue});
                        }
                    ...
                    str = str2;
                    i2 = 1;
                    addNotification(new ErrorBundle(str, "CertPathReviewer.QcUnknownStatement", new Object[]{qCStatement.getStatementId(), new UntrustedInput(qCStatement)}), i);
                    z = true;
                    i3 += i2;
                    str2 = str;
                    c = 2;
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: BlockProcessor
        jadx.core.utils.exceptions.JadxRuntimeException: Unreachable block: B:52:0x017b
    ...
    public void init(CertPath certPath, PKIXParameters pKIXParameters) throws CertPathReviewerException {
        ...
        this.f75686n = certificates.size();
