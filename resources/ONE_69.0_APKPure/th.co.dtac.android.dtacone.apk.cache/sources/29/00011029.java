...
public final class WithDeviceCampaignAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    /* renamed from: a */
    public final Activity f81653a;

    /* renamed from: b */
    public final List f81654b;

    /* renamed from: c */
    public OnClickCampaign f81655c;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final int $stable = 8;

    @Metadata(m29143d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u000b\b\u0086\u0004\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005R\u0017\u0010\u000b\u001a\u00020\u00068\u0006¢\u0006\f\n\u0004\b\u0007\u0010\b\u001a\u0004\b\t\u0010\nR\u0017\u0010\u0011\u001a\u00020\f8\u0006¢\u0006\f\n\u0004\b\r\u0010\u000e\u001a\u0004\b\u000f\u0010\u0010R\u0017\u0010\u0016\u001a\u00020\u00028\u0006¢\u0006\f\n\u0004\b\u0012\u0010\u0013\u001a\u0004\b\u0014\u0010\u0015¨\u0006\u0017"}, m29142d2 = {"Lth/co/dtac/android/dtacone/adapter/withDevice/WithDeviceCampaignAdapter$CampaignItemViewHolder;", "Landroidx/recyclerview/widget/RecyclerView$ViewHolder;", "Landroid/view/View;", Promotion.ACTION_VIEW, "<init>", "(Lth/co/dtac/android/dtacone/adapter/withDevice/WithDeviceCampaignAdapter;Landroid/view/View;)V", "Landroid/widget/RelativeLayout;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroid/widget/RelativeLayout;", "getLayoutCampaignItem", "()Landroid/widget/RelativeLayout;", "layoutCampaignItem", "Landroid/widget/TextView;", OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, "Landroid/widget/TextView;", "getTvCampaignName", "()Landroid/widget/TextView;", "tvCampaignName", OperatorName.CURVE_TO, "Landroid/view/View;", "getVLineSeparate", "()Landroid/view/View;", "vLineSeparate", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0})
    ...
    public final class CampaignItemViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: a */
        public final RelativeLayout f81656a;

        /* renamed from: b */
        public final TextView f81657b;

        /* renamed from: c */
        public final View f81658c;

        /* renamed from: d */
        public final /* synthetic */ WithDeviceCampaignAdapter f81659d;
    ...
    @Metadata(m29143d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0005"}, m29142d2 = {"Lth/co/dtac/android/dtacone/adapter/withDevice/WithDeviceCampaignAdapter$Companion;", "", "()V", "VIEW_TYPE_NORMAL", "", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    @Metadata(m29143d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&¨\u0006\u0006"}, m29142d2 = {"Lth/co/dtac/android/dtacone/adapter/withDevice/WithDeviceCampaignAdapter$OnClickCampaign;", "", "onClickCampaignItem", "", "campaign", "Lth/co/dtac/android/dtacone/model/withDevice/validateImei/response/CampaignItem;", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    public WithDeviceCampaignAdapter(@NotNull Activity activity, @Nullable List<CampaignItem> list) {
        ...
        this.f81653a = activity;
        this.f81654b = list;
    }

    /* renamed from: a */
    public static /* synthetic */ void m20366a(OnClickCampaign onClickCampaign, CampaignItem campaignItem, View view) {
        m20365b(onClickCampaign, campaignItem, view);
    }

    /* renamed from: b */
    public static final void m20365b(OnClickCampaign theListener, CampaignItem campaign, View view) {
    ...
    public void onBindViewHolder(@NotNull RecyclerView.ViewHolder holder, int i) {
        ...
        if (holder instanceof CampaignItemViewHolder) {
            ...
            final OnClickCampaign onClickCampaign = this.f81655c;
            if (onClickCampaign != null) {
                campaignItemViewHolder.getLayoutCampaignItem().setOnClickListener(new View.OnClickListener() { // from class: q62
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        WithDeviceCampaignAdapter.m20366a(WithDeviceCampaignAdapter.OnClickCampaign.this, campaignItem, view);
                    }
                });
            }
            View vLineSeparate = campaignItemViewHolder.getVLineSeparate();
            if (i == this.f81654b.size() - 1) {
                i2 = 8;
            } else {
                i2 = 0;
            }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int i) {
        ...
        View view = LayoutInflater.from(this.f81653a).inflate(R.layout.item_with_device_campaign, parent, false);
