...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.pre2post.fragment.OnePre2PostSuccessFragment$setupObserve$1$1 */
/* loaded from: classes10.dex */
public final class OnePre2PostSuccessFragment$setupObserve$1$1 extends Lambda implements Function1<Resource<? extends OnePre2PostVerifySubscriberPreToPostResponse>, Unit> {
    final /* synthetic */ OnePre2PostViewModel $this_apply;
    final /* synthetic */ OnePre2PostSuccessFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.pre2post.fragment.OnePre2PostSuccessFragment$setupObserve$1$1$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OnePre2PostSuccessFragment$setupObserve$1$1(OnePre2PostSuccessFragment onePre2PostSuccessFragment, OnePre2PostViewModel onePre2PostViewModel) {
        super(1);
    ...
    public final void invoke2(Resource<OnePre2PostVerifySubscriberPreToPostResponse> resource) {
        ...
        if (i == 1) {
            onePre2PostSuccessFragment.showLoading();
        } else if (i == 2) {
            onePre2PostViewModel.getOneDeviceSaleAuthorization();
        } else if (i != 3) {
        } else {
