...
public abstract class SharedElementCallback {
    ...
    /* renamed from: a */
    public static Bitmap m57569a(Drawable drawable) {
    ...
    public Parcelable onCaptureSharedElementSnapshot(View view, Matrix matrix, RectF rectF) {
        ...
        if (view instanceof ImageView) {
            ...
            if (drawable != null && background == null && (m57569a = m57569a(drawable)) != null) {
                Bundle bundle = new Bundle();
                bundle.putParcelable("sharedElement:snapshot:bitmap", m57569a);
        ...
        if (round > 0 && round2 > 0) {
            ...
            this.f33807a.postTranslate(-rectF.left, -rectF.top);
            this.f33807a.postScale(min, min);
            Bitmap createBitmap = Bitmap.createBitmap(i, i2, Bitmap.Config.ARGB_8888);
            Canvas canvas = new Canvas(createBitmap);
            canvas.concat(this.f33807a);
            view.draw(canvas);
            return createBitmap;
        }
        return null;
