...
public final class MutableVectorWithMutationTracking<T> {
    ...
    /* renamed from: a */
    public final MutableVector f30454a;

    /* renamed from: b */
    public final Function0 f30455b;
    ...
    public MutableVectorWithMutationTracking(@NotNull MutableVector<T> vector, @NotNull Function0<Unit> onVectorMutated) {
        ...
        this.f30454a = vector;
        this.f30455b = onVectorMutated;
    }

    public final void add(int i, T t) {
        this.f30454a.add(i, t);
        this.f30455b.invoke();
    }

    @NotNull
    public final List<T> asList() {
        return this.f30454a.asMutableList();
    }
    ...
    public final T get(int i) {
        return (T) this.f30454a.getContent()[i];
    }
