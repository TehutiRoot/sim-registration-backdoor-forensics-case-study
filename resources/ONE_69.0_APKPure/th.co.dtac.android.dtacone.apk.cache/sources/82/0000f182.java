...
public final class PublicSuffixMatcher {
    ...
    /* renamed from: a */
    public final Map f73942a;

    /* renamed from: b */
    public final Map f73943b;
    ...
    /* renamed from: a */
    public static DomainType m24964a(Map map, String str) {
        if (map == null) {
            return null;
        }
    ...
    /* renamed from: b */
    public static boolean m24963b(DomainType domainType, DomainType domainType2) {
    ...
    public PublicSuffixMatcher(DomainType domainType, Collection<String> collection, Collection<String> collection2) {
        ...
        this.f73942a = new ConcurrentHashMap(collection.size());
        for (String str : collection) {
            this.f73942a.put(str, domainType);
        }
        this.f73943b = new ConcurrentHashMap();
        if (collection2 != null) {
            for (String str2 : collection2) {
                this.f73943b.put(str2, domainType);
            }
        }
    }
    ...
    public String getDomainRoot(String str, DomainType domainType) {
        ...
        while (normalize != null) {
            ...
            if (m24963b(m24964a(this.f73943b, unicode), domainType)) {
                return normalize;
            }
            DomainType m24964a = m24964a(this.f73942a, unicode);
            if (m24963b(m24964a, domainType)) {
                return m24964a == DomainType.PRIVATE ? normalize : str2;
            }
            int indexOf = normalize.indexOf(46);
            String substring = indexOf != -1 ? normalize.substring(indexOf + 1) : null;
            if (substring != null) {
                DomainType m24964a2 = m24964a(this.f73942a, "*." + IDN.toUnicode(substring));
                if (m24963b(m24964a2, domainType)) {
                    return m24964a2 == DomainType.PRIVATE ? normalize : str2;
                }
            }
            str2 = normalize;
            normalize = substring;
    ...
    public PublicSuffixMatcher(Collection<PublicSuffixList> collection) {
        ...
        this.f73942a = new ConcurrentHashMap();
        this.f73943b = new ConcurrentHashMap();
