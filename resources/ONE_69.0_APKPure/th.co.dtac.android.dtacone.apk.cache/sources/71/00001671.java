...
public abstract class AbstractC1674XY {
    /* renamed from: a */
    public static final int m65603a(String str) {
        int indexOf$default;
    ...
    public static final String getRootName(@NotNull File file) {
        ...
        String substring = path.substring(0, m65603a(path2));
    ...
    public static final FilePathComponents toComponents(@NotNull File file) {
        ...
        int m65603a = m65603a(path);
        String substring = path.substring(0, m65603a);
        Intrinsics.checkNotNullExpressionValue(substring, "substring(...)");
        String substring2 = path.substring(m65603a);
        ...
        if (substring2.length() == 0) {
            ...
            ArrayList arrayList = new ArrayList(AbstractC10172es.collectionSizeOrDefault(split$default, 10));
