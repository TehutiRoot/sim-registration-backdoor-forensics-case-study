...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.tol.screen.inputInfo.InputInfoScreenKt$SearchBox$1 */
/* loaded from: classes10.dex */
public final class InputInfoScreenKt$SearchBox$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    final /* synthetic */ int $$dirty;
    final /* synthetic */ String $placeholderText;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InputInfoScreenKt$SearchBox$1(String str, int i) {
        super(2);
