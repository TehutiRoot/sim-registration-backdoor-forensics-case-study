...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.buyDol.viewModel.OneBuyDolViewModel$charge$2 */
/* loaded from: classes10.dex */
public final class OneBuyDolViewModel$charge$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ OneBuyDolViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneBuyDolViewModel$charge$2(OneBuyDolViewModel oneBuyDolViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable throwable) {
        ...
        oneErrorService.handleException(throwable, new OneErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.view.appOne.buyDol.viewModel.OneBuyDolViewModel$charge$2.1
            ...
            public void handle(@Nullable Throwable th2) {
                ...
                try {
                    ...
                    if (Intrinsics.areEqual(((ServerErrorException) th2).error().getStatusCode(), BuyDolConfig.OTP_FAIL_CODE)) {
                        m15891V2 = OneBuyDolViewModel.this.m15891V();
                        m15891V2.setValue(Resource.Companion.error$default(Resource.Companion, "", null, null, 4, null));
                        ...
                        m15891V = OneBuyDolViewModel.this.m15891V();
                        m15891V.setValue(Resource.Companion.error$default(Resource.Companion, "", null, null, 4, null));
