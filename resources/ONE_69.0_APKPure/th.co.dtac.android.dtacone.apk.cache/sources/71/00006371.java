...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    /* renamed from: j */
    public static boolean f30818j;

    /* renamed from: a */
    public final AndroidComposeView f30820a;

    /* renamed from: b */
    public final RenderNode f30821b;
    ...
    /* renamed from: k */
    public static boolean f30819k = true;

    @Metadata(m29143d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0006\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u000e¢\u0006\u0002\n\u0000R\u001a\u0010\u0005\u001a\u00020\u0004X\u0080\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0006\u0010\u0007\"\u0004\b\b\u0010\t¨\u0006\n"}, m29142d2 = {"Landroidx/compose/ui/platform/RenderNodeApi23$Companion;", "", "()V", "needToValidateAccess", "", "testFailCreateRenderNode", "getTestFailCreateRenderNode$ui_release", "()Z", "setTestFailCreateRenderNode$ui_release", "(Z)V", "ui_release"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    public RenderNodeApi23(@NotNull AndroidComposeView ownerView) {
        ...
        this.f30820a = ownerView;
        RenderNode create = RenderNode.create("Compose", ownerView);
        Intrinsics.checkNotNullExpressionValue(create, "create(\"Compose\", ownerView)");
        this.f30821b = create;
        this.f30822c = CompositingStrategy.Companion.m72000getAutoNrFUSI();
        if (f30819k) {
    ...
    /* renamed from: a */
    public final void m59155a() {
        if (Build.VERSION.SDK_INT >= 24) {
            C18384Qx1.f5366a.m66714a(this.f30821b);
        } else {
            C18319Px1.f5075a.m66864a(this.f30821b);
        }
    }

    /* renamed from: b */
    public final void m59154b(RenderNode renderNode) {
        if (Build.VERSION.SDK_INT >= 28) {
            C18449Rx1 c18449Rx1 = C18449Rx1.f5687a;
            c18449Rx1.m66575c(renderNode, c18449Rx1.m66577a(renderNode));
            c18449Rx1.m66574d(renderNode, c18449Rx1.m66576b(renderNode));
        }
    }
    ...
    public void drawInto(@NotNull Canvas canvas) {
        ...
        ((DisplayListCanvas) canvas).drawRenderNode(this.f30821b);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    @NotNull
    public DeviceRenderNodeData dumpRenderNodeData() {
        return new DeviceRenderNodeData(0L, 0, 0, 0, 0, 0, 0, this.f30821b.getScaleX(), this.f30821b.getScaleY(), this.f30821b.getTranslationX(), this.f30821b.getTranslationY(), this.f30821b.getElevation(), getAmbientShadowColor(), getSpotShadowColor(), this.f30821b.getRotation(), this.f30821b.getRotationX(), this.f30821b.getRotationY(), this.f30821b.getCameraDistance(), this.f30821b.getPivotX(), this.f30821b.getPivotY(), this.f30821b.getClipToOutline(), getClipToBounds(), this.f30821b.getAlpha(), getRenderEffect(), this.f30822c, null);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public float getAlpha() {
        return this.f30821b.getAlpha();
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public int getAmbientShadowColor() {
        if (Build.VERSION.SDK_INT >= 28) {
            return C18449Rx1.f5687a.m66577a(this.f30821b);
        }
        return -16777216;
    }
    ...
    public float getCameraDistance() {
        return -this.f30821b.getCameraDistance();
    }
    ...
    public boolean getClipToOutline() {
        return this.f30821b.getClipToOutline();
    }
    ...
    public float getElevation() {
        return this.f30821b.getElevation();
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public boolean getHasDisplayList() {
        return this.f30821b.isValid();
    }
    ...
    public void getInverseMatrix(@NotNull Matrix matrix) {
        ...
        this.f30821b.getInverseMatrix(matrix);
    }

    public final int getLayerType$ui_release() {
        if (CompositingStrategy.m71996equalsimpl0(this.f30822c, CompositingStrategy.Companion.m72002getOffscreenNrFUSI())) {
            return 2;
        }
        return 0;
    }
    ...
    public float getPivotX() {
        return this.f30821b.getPivotX();
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public float getPivotY() {
        return this.f30821b.getPivotY();
    }
    ...
    public float getRotationX() {
        return this.f30821b.getRotationX();
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public float getRotationY() {
        return this.f30821b.getRotationY();
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public float getRotationZ() {
        return this.f30821b.getRotation();
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public float getScaleX() {
        return this.f30821b.getScaleX();
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public float getScaleY() {
        return this.f30821b.getScaleY();
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public int getSpotShadowColor() {
        if (Build.VERSION.SDK_INT >= 28) {
            return C18449Rx1.f5687a.m66576b(this.f30821b);
        }
        return -16777216;
    }
    ...
    public float getTranslationX() {
        return this.f30821b.getTranslationX();
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public float getTranslationY() {
        return this.f30821b.getTranslationY();
    }
    ...
    public final boolean hasOverlappingRendering$ui_release() {
        return this.f30821b.hasOverlappingRendering();
    }
    ...
    public void offsetLeftAndRight(int i) {
        setLeft(getLeft() + i);
        setRight(getRight() + i);
        this.f30821b.offsetLeftAndRight(i);
    }
    ...
    public void offsetTopAndBottom(int i) {
        ...
        this.f30821b.offsetTopAndBottom(i);
    }
    ...
    public void record(@NotNull CanvasHolder canvasHolder, @Nullable Path path, @NotNull Function1<? super androidx.compose.p003ui.graphics.Canvas, Unit> drawBlock) {
        ...
        DisplayListCanvas start = this.f30821b.start(getWidth(), getHeight());
        ...
        this.f30821b.end(start);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setAlpha(float f) {
        this.f30821b.setAlpha(f);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setAmbientShadowColor(int i) {
        if (Build.VERSION.SDK_INT >= 28) {
            C18449Rx1.f5687a.m66575c(this.f30821b, i);
        }
    }
    ...
    public void setCameraDistance(float f) {
        this.f30821b.setCameraDistance(-f);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setClipToBounds(boolean z) {
        this.f30828i = z;
        this.f30821b.setClipToBounds(z);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setClipToOutline(boolean z) {
        this.f30821b.setClipToOutline(z);
    }
    ...
    public void mo73214setCompositingStrategyaDBOjCE(int i) {
        ...
        if (CompositingStrategy.m71996equalsimpl0(i, companion.m72002getOffscreenNrFUSI())) {
            this.f30821b.setLayerType(2);
            this.f30821b.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m71996equalsimpl0(i, companion.m72001getModulateAlphaNrFUSI())) {
            this.f30821b.setLayerType(0);
            this.f30821b.setHasOverlappingRendering(false);
        } else {
            this.f30821b.setLayerType(0);
            this.f30821b.setHasOverlappingRendering(true);
        }
    ...
    public void setElevation(float f) {
        this.f30821b.setElevation(f);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public boolean setHasOverlappingRendering(boolean z) {
        return this.f30821b.setHasOverlappingRendering(z);
    }
    ...
    public void setOutline(@Nullable Outline outline) {
        this.f30821b.setOutline(outline);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setPivotX(float f) {
        this.f30821b.setPivotX(f);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setPivotY(float f) {
        this.f30821b.setPivotY(f);
    }
    ...
    public boolean setPosition(int i, int i2, int i3, int i4) {
        ...
        setRight(i3);
        setBottom(i4);
        return this.f30821b.setLeftTopRightBottom(i, i2, i3, i4);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setRenderEffect(@Nullable RenderEffect renderEffect) {
        this.f30827h = renderEffect;
    }
    ...
    public void setRotationX(float f) {
        this.f30821b.setRotationX(f);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setRotationY(float f) {
        this.f30821b.setRotationY(f);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setRotationZ(float f) {
        this.f30821b.setRotation(f);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setScaleX(float f) {
        this.f30821b.setScaleX(f);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setScaleY(float f) {
        this.f30821b.setScaleY(f);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setSpotShadowColor(int i) {
        if (Build.VERSION.SDK_INT >= 28) {
            C18449Rx1.f5687a.m66574d(this.f30821b, i);
        }
    }
    ...
    public void setTranslationX(float f) {
        this.f30821b.setTranslationX(f);
    }

    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void setTranslationY(float f) {
        this.f30821b.setTranslationY(f);
    }
}