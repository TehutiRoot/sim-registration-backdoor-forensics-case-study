...
public final class Oklab extends ColorSpace {
    ...
    /* renamed from: d */
    public static final float[] f29360d;

    /* renamed from: e */
    public static final float[] f29361e;

    /* renamed from: f */
    public static final float[] f29362f;

    /* renamed from: g */
    public static final float[] f29363g;

    @Metadata(m29143d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0014\n\u0002\b\u0004\b\u0080\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\b"}, m29142d2 = {"Landroidx/compose/ui/graphics/colorspace/Oklab$Companion;", "", "()V", "InverseM1", "", "InverseM2", "M1", "M2", "ui-graphics_release"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    static {
        ...
        f29361e = fArr;
        f29362f = ColorSpaceKt.inverse3x3(mul3x3);
        f29363g = ColorSpaceKt.inverse3x3(fArr);
    }
    ...
    public float[] fromXyz(@NotNull float[] v) {
        ...
        ColorSpaceKt.mul3x3Float3(f29360d, v);
        ...
        ColorSpaceKt.mul3x3Float3(f29361e, v);
        return v;
    }
    ...
    public long toXy$ui_graphics_release(float f, float f2, float f3) {
        float coerceIn = AbstractC11695c.coerceIn(f, 0.0f, 1.0f);
        float coerceIn2 = AbstractC11695c.coerceIn(f2, -0.5f, 0.5f);
        float coerceIn3 = AbstractC11695c.coerceIn(f3, -0.5f, 0.5f);
        float[] fArr = f29363g;
    ...
    public float[] toXyz(@NotNull float[] v) {
        Intrinsics.checkNotNullParameter(v, "v");
        v[0] = AbstractC11695c.coerceIn(v[0], 0.0f, 1.0f);
        v[1] = AbstractC11695c.coerceIn(v[1], -0.5f, 0.5f);
        v[2] = AbstractC11695c.coerceIn(v[2], -0.5f, 0.5f);
        ColorSpaceKt.mul3x3Float3(f29363g, v);
        float f = v[0];
        v[0] = f * f * f;
        float f2 = v[1];
        v[1] = f2 * f2 * f2;
        float f3 = v[2];
        v[2] = f3 * f3 * f3;
        ColorSpaceKt.mul3x3Float3(f29362f, v);
        return v;
    }
    ...
    public float toZ$ui_graphics_release(float f, float f2, float f3) {
        ...
        return ColorSpaceKt.mul3x3Float3_2(f29362f, mul3x3Float3_0 * mul3x3Float3_0 * mul3x3Float3_0, mul3x3Float3_1 * mul3x3Float3_1 * mul3x3Float3_1, f4);
    }
