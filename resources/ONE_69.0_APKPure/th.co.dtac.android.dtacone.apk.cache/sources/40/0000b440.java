...
public final class WaitOperationRequest extends GeneratedMessageLite<WaitOperationRequest, Builder> implements WaitOperationRequestOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<WaitOperationRequest, Builder> implements WaitOperationRequestOrBuilder {
        public /* synthetic */ Builder(C8796a c8796a) {
            this();
        }

        public Builder clearName() {
            copyOnWrite();
            ((WaitOperationRequest) this.instance).m37251I();
            return this;
        }

        public Builder clearTimeout() {
            copyOnWrite();
            ((WaitOperationRequest) this.instance).m37250J();
            return this;
        }
        ...
        public Builder mergeTimeout(Duration duration) {
            copyOnWrite();
            ((WaitOperationRequest) this.instance).m37249K(duration);
            return this;
        }

        public Builder setName(String str) {
            copyOnWrite();
            ((WaitOperationRequest) this.instance).m37248L(str);
            return this;
        }

        public Builder setNameBytes(ByteString byteString) {
            copyOnWrite();
            ((WaitOperationRequest) this.instance).m37247M(byteString);
            return this;
        }

        public Builder setTimeout(Duration duration) {
            copyOnWrite();
            ((WaitOperationRequest) this.instance).m37246N(duration);
            return this;
        }
        ...
        public Builder setTimeout(Duration.Builder builder) {
            copyOnWrite();
            ((WaitOperationRequest) this.instance).m37246N(builder.build());
            return this;
        }
    }
    ...
    public static /* synthetic */ class C8796a {
        ...
        static {
            ...
            try {
                f56877a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f56877a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f56877a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f56877a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f56877a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f56877a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: L */
    public void m37248L(String str) {
        str.getClass();
        this.name_ = str;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: M */
    public void m37247M(ByteString byteString) {
    ...
    /* renamed from: J */
    public final void m37250J() {
        this.timeout_ = null;
    }

    /* renamed from: K */
    public final void m37249K(Duration duration) {
        duration.getClass();
    ...
    /* renamed from: N */
    public final void m37246N(Duration duration) {
        duration.getClass();
        this.timeout_ = duration;
    }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C8796a.f56877a[methodToInvoke.ordinal()]) {
            case 1:
