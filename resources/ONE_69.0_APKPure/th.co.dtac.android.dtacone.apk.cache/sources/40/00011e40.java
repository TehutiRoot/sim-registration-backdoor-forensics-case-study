...
public final class SaveAdditionalRequest {
    ...
    @NotNull
    public final SaveAdditionalRequest copy(@NotNull String userFormatType, @NotNull String userCode, @NotNull String userLan, @NotNull String userName, @NotNull String channel, @NotNull String locationCode, @NotNull String rtrName, @NotNull String rtrCode, @NotNull String subChannel, @NotNull String subscriberNumber, @NotNull String customerNumber, @NotNull String companyCode, @NotNull String subscriberType, @NotNull String telephoneType, @NotNull String packageCode, @NotNull String packageDescription) {
        Intrinsics.checkNotNullParameter(userFormatType, "userFormatType");
        Intrinsics.checkNotNullParameter(userCode, "userCode");
        Intrinsics.checkNotNullParameter(userLan, "userLan");
        Intrinsics.checkNotNullParameter(userName, "userName");
        ...
        Intrinsics.checkNotNullParameter(packageCode, "packageCode");
        Intrinsics.checkNotNullParameter(packageDescription, "packageDescription");
        return new SaveAdditionalRequest(userFormatType, userCode, userLan, userName, channel, locationCode, rtrName, rtrCode, subChannel, subscriberNumber, customerNumber, companyCode, subscriberType, telephoneType, packageCode, packageDescription);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof SaveAdditionalRequest) {
            SaveAdditionalRequest saveAdditionalRequest = (SaveAdditionalRequest) obj;
            return Intrinsics.areEqual(this.userFormatType, saveAdditionalRequest.userFormatType) && Intrinsics.areEqual(this.userCode, saveAdditionalRequest.userCode) && Intrinsics.areEqual(this.userLan, saveAdditionalRequest.userLan) && Intrinsics.areEqual(this.userName, saveAdditionalRequest.userName) && Intrinsics.areEqual(this.channel, saveAdditionalRequest.channel) && Intrinsics.areEqual(this.locationCode, saveAdditionalRequest.locationCode) && Intrinsics.areEqual(this.rtrName, saveAdditionalRequest.rtrName) && Intrinsics.areEqual(this.rtrCode, saveAdditionalRequest.rtrCode) && Intrinsics.areEqual(this.subChannel, saveAdditionalRequest.subChannel) && Intrinsics.areEqual(this.subscriberNumber, saveAdditionalRequest.subscriberNumber) && Intrinsics.areEqual(this.customerNumber, saveAdditionalRequest.customerNumber) && Intrinsics.areEqual(this.companyCode, saveAdditionalRequest.companyCode) && Intrinsics.areEqual(this.subscriberType, saveAdditionalRequest.subscriberType) && Intrinsics.areEqual(this.telephoneType, saveAdditionalRequest.telephoneType) && Intrinsics.areEqual(this.packageCode, saveAdditionalRequest.packageCode) && Intrinsics.areEqual(this.packageDescription, saveAdditionalRequest.packageDescription);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        return "SaveAdditionalRequest(userFormatType=" + str + ", userCode=" + str2 + ", userLan=" + str3 + ", userName=" + str4 + ", channel=" + str5 + ", locationCode=" + str6 + ", rtrName=" + str7 + ", rtrCode=" + str8 + ", subChannel=" + str9 + ", subscriberNumber=" + str10 + ", customerNumber=" + str11 + ", companyCode=" + str12 + ", subscriberType=" + str13 + ", telephoneType=" + str14 + ", packageCode=" + str15 + ", packageDescription=" + str16 + ")";
    }
}