...
public class McElieceCCA2PrivateKey extends ASN1Object {
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f75547n));
        aSN1EncodableVector.add(new ASN1Integer(this.f75546k));
    ...
    private McElieceCCA2PrivateKey(ASN1Sequence aSN1Sequence) {
        this.f75547n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).intValueExact();
        this.f75546k = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).intValueExact();
