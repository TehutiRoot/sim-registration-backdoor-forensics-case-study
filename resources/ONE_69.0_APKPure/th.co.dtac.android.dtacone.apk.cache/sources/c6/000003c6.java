...
public class C0280Dy {

    /* renamed from: a */
    public final Converter[] f1197a;

    /* renamed from: b */
    public C0281a[] f1198b = new C0281a[16];
    ...
    public static class C0281a {
        ...
        /* renamed from: a */
        public final Class f1199a;

        /* renamed from: b */
        public final Converter f1200b;

        public C0281a(Class cls, Converter converter) {
            this.f1199a = cls;
            this.f1200b = converter;
        }
    }

    public C0280Dy(Converter[] converterArr) {
        this.f1197a = converterArr;
    }

    /* renamed from: f */
    public static Converter m68730f(C0280Dy c0280Dy, Class cls) {
        String name;
        Converter[] converterArr = c0280Dy.f1197a;
        ...
        while (true) {
            ...
            if (length >= 0) {
                ...
                if (supportedType == null || (cls != null && !supportedType.isAssignableFrom(cls))) {
                    c0280Dy = c0280Dy.m68733c(length, null);
                    converterArr = c0280Dy.f1197a;
                    ...
                    while (true) {
                        ...
                        if (i2 >= 0) {
                            if (i2 != i && converterArr[i2].getSupportedType().isAssignableFrom(supportedType2)) {
                                c0280Dy = c0280Dy.m68733c(i2, null);
                                converterArr = c0280Dy.f1197a;
    ...
    /* renamed from: a */
    public C0280Dy m68735a(Converter converter, Converter[] converterArr) {
        Converter[] converterArr2 = this.f1197a;
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (converter.equals(converter2)) {
                ...
                return new C0280Dy(converterArr3);
            }
        }
        ...
        return new C0280Dy(converterArr4);
    }

    /* renamed from: b */
    public void m68734b(Converter[] converterArr) {
        Converter[] converterArr2 = this.f1197a;
        System.arraycopy(converterArr2, 0, converterArr, 0, converterArr2.length);
    }

    /* renamed from: c */
    public C0280Dy m68733c(int i, Converter[] converterArr) {
        Converter[] converterArr2 = this.f1197a;
        int length = converterArr2.length;
        if (i < length) {
            if (converterArr != null) {
    ...
    /* renamed from: d */
    public C0280Dy m68732d(Converter converter, Converter[] converterArr) {
        Converter[] converterArr2 = this.f1197a;
        int length = converterArr2.length;
        for (int i = 0; i < length; i++) {
            if (converter.equals(converterArr2[i])) {
                return m68733c(i, converterArr);
            }
        }
        if (converterArr != null) {
            converterArr[0] = null;
    ...
    */
    public org.joda.time.convert.Converter m68731e(java.lang.Class r10) {
        /*
            r9 = this;
            Dy$a[] r0 = r9.f1198b
            int r1 = r0.length
        ...
        Le:
            r4 = r0[r3]
            if (r4 == 0) goto L1f
            java.lang.Class r5 = r4.f1199a
            if (r5 != r10) goto L19
            org.joda.time.convert.Converter r10 = r4.f1200b
            return r10
        L19:
            int r3 = r3 + 1
            if (r3 < r1) goto Le
        L1d:
            ...
            goto Le
        L1f:
            org.joda.time.convert.Converter r4 = m68730f(r9, r10)
            Dy$a r5 = new Dy$a
            r5.<init>(r10, r4)
            java.lang.Object r10 = r0.clone()
            Dy$a[] r10 = (p000.C0280Dy.C0281a[]) r10
            r10[r3] = r5
            r0 = 0
        L31:
            if (r0 >= r1) goto L3d
        ...
        L3d:
            int r0 = r1 << 1
            Dy$a[] r3 = new p000.C0280Dy.C0281a[r0]
            r5 = 0
        L42:
            if (r5 >= r1) goto L61
            r6 = r10[r5]
            java.lang.Class r7 = r6.f1199a
            if (r7 != 0) goto L4b
            goto L5a
        L4b:
            int r7 = r7.hashCode()
        ...
        L61:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.C0280Dy.m68731e(java.lang.Class):org.joda.time.convert.Converter");
    }

    /* renamed from: g */
    public int m68729g() {
        return this.f1197a.length;
    }
}