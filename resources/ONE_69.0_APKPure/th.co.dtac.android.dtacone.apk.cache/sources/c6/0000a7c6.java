...
public final class Preconditions {
    /* renamed from: a */
    public static String m41299a(int i, int i2, String str) {
        if (i < 0) {
    ...
    /* renamed from: b */
    public static String m41298b(int i, int i2, String str) {
        if (i < 0) {
            return Strings.lenientFormat("%s (%s) must not be negative", str, Integer.valueOf(i));
        }
        if (i2 >= 0) {
    ...
    public static void checkPositionIndexes(int i, int i2, int i3) {
        ...
        throw new IndexOutOfBoundsException(m41297c(i, i2, i3));
    }
    ...
    public static int checkElementIndex(int i, int i2, String str) {
        if (i < 0 || i >= i2) {
            throw new IndexOutOfBoundsException(m41299a(i, i2, str));
        }
        return i;
    }
    ...
    public static int checkPositionIndex(int i, int i2, String str) {
        if (i < 0 || i > i2) {
            throw new IndexOutOfBoundsException(m41298b(i, i2, str));
        }
        return i;
    }
    ...
    public static void checkArgument(boolean z, @CheckForNull String str, @CheckForNull Object obj, @CheckForNull Object obj2) {
        if (!z) {
