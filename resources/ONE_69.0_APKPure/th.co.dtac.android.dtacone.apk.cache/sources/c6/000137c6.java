...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.fragment.packages.OnePostpaidDefaultPackageFragment$onResume$1$3 */
/* loaded from: classes10.dex */
public final class OnePostpaidDefaultPackageFragment$onResume$1$3 extends Lambda implements Function1<Resource<? extends OnePostpaidPackageSet>, Unit> {
    final /* synthetic */ OnePostpaidDefaultPackageFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidDefaultPackageFragment$onResume$1$3(OnePostpaidDefaultPackageFragment onePostpaidDefaultPackageFragment) {
        super(1);
    ...
    public final void invoke2(Resource<OnePostpaidPackageSet> resource) {
        ...
        onePostpaidDefaultPackageFragment.gotoMailing(data);
    }
}