...
public final class OneStvPackageCollection implements Parcelable {
    ...
    /* renamed from: a */
    private String f82244a;
    @SerializedName("ussdCode")
    @Nullable

    /* renamed from: b */
    private String f82245b;
    @SerializedName("name")
    @Nullable

    /* renamed from: c */
    private String f82246c;
    ...
    /* renamed from: f */
    private String f82249f;
    @SerializedName("uom_order")
    @Nullable

    /* renamed from: g */
    private Integer f82250g;
    @SerializedName(TypedValues.CycleType.S_WAVE_PERIOD)
    @Nullable

    /* renamed from: h */
    private String f82251h;
    @SerializedName("periodUnit")
    @Nullable

    /* renamed from: i */
    private String f82252i;
    @SerializedName(FirebaseAnalytics.Param.PRICE)
    @Nullable

    /* renamed from: j */
    private String f82253j;
    @SerializedName("descriptions")
    @NotNull

    /* renamed from: k */
    private String[] f82254k;
    @SerializedName("commissionText")
    @Nullable

    /* renamed from: l */
    private String f82255l;
    @SerializedName("commissionColor")
    @Nullable

    /* renamed from: m */
    private String f82256m;
    @SerializedName("commissionValue")
    @Nullable

    /* renamed from: n */
    private Float f82257n;
    @SerializedName("seq")
    @Nullable

    /* renamed from: o */
    private Integer f82258o;
    ...
    public void writeToParcel(@NotNull Parcel out, int i) {
        ...
        out.writeString(this.f82244a);
        out.writeString(this.f82245b);
        out.writeString(this.f82246c);
        out.writeString(this.f82247d);
        out.writeString(this.f82248e);
        out.writeString(this.f82249f);
        Integer num = this.f82250g;
        if (num == null) {
            out.writeInt(0);
        } else {
            out.writeInt(1);
        ...
        out.writeString(this.f82251h);
        out.writeString(this.f82252i);
        out.writeString(this.f82253j);
        out.writeStringArray(this.f82254k);
        out.writeString(this.f82255l);
        out.writeString(this.f82256m);
        Float f = this.f82257n;
        if (f == null) {
            out.writeInt(0);
        } else {
            out.writeInt(1);
