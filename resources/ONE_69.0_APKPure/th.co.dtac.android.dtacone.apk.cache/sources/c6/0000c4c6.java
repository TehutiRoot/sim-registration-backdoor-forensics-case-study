...
public final class MapFactory<K, V> extends AbstractMapFactory {
    ...
    /* renamed from: b */
    public static final Provider f61284b = InstanceFactory.create(Collections.emptyMap());

    /* loaded from: classes5.dex */
    public static final class Builder<K, V> extends AbstractMapFactory.Builder<K, V, V> {
        public MapFactory<K, V> build() {
            return new MapFactory<>(this.f61276a);
        }
    ...
    public Map<K, V> get() {
        LinkedHashMap newLinkedHashMapWithExpectedSize = DaggerCollections.newLinkedHashMapWithExpectedSize(m31808b().size());
        for (Map.Entry<K, V> entry : m31808b().entrySet()) {
