...
public class setOnClickListener implements setDarkTextColor.valueOf {
    private final setDarkTextColor get;

    public setOnClickListener(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.rootPublicKeyFromAssetCertificate(this.get);
    }
}