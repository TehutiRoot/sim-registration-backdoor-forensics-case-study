...
public class AWTColor {
    ...
    static {
        ...
        white = aWTColor;
        WHITE = aWTColor;
        AWTColor aWTColor2 = new AWTColor((int) CertificateHolderAuthorization.CVCA, (int) CertificateHolderAuthorization.CVCA, (int) CertificateHolderAuthorization.CVCA);
        lightGray = aWTColor2;
