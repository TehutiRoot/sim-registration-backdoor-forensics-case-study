...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.onlineRegister.activity.OneOnlineRegistrationActivity$handleBackPress$3 */
/* loaded from: classes10.dex */
public final class OneOnlineRegistrationActivity$handleBackPress$3 extends Lambda implements Function0<Unit> {
    final /* synthetic */ OneOnlineRegistrationActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneOnlineRegistrationActivity$handleBackPress$3(OneOnlineRegistrationActivity oneOnlineRegistrationActivity) {
        super(0);
    ...
    public final void invoke2() {
        this.this$0.getViewModel().resetUpPassResult();
