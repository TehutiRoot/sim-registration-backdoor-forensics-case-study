...
public class C9713ri {
    public static MessageDigest get(String str, String str2) {
        try {
            ...
            throw new C9723rt("Unable to get MessageDigest instance with " + str);
        } catch (NoSuchProviderException e) {
            throw new C9723rt("Unable to get a MessageDigest implementation of algorithm name: " + str + " using provider " + str2, e);
        }
    }
