...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.esim.ESimViewModel$getConsentXSIM$3 */
/* loaded from: classes9.dex */
public final class ESimViewModel$getConsentXSIM$3 extends Lambda implements Function1<XSIMConsentResponse, Unit> {
    final /* synthetic */ ESimViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimViewModel$getConsentXSIM$3(ESimViewModel eSimViewModel) {
        super(1);
    ...
    public final void invoke2(XSIMConsentResponse xSIMConsentResponse) {
        MutableLiveData m2760M0;
        MutableLiveData m2778D0;
        this.this$0.getLiveDataState().setValue(StatusResource.DISMISS);
        m2760M0 = this.this$0.m2760M0();
        m2760M0.setValue(Resource.Companion.success(xSIMConsentResponse));
        m2778D0 = this.this$0.m2778D0();
        m2778D0.setValue(new Event(new FragmentNavEvent(ESimConsentXSIMFragment.class, null, null, 4, null)));
    }
}