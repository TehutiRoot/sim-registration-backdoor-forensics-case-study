...
public class FDFPage implements COSObjectable {
    ...
    /* renamed from: a */
    public final COSDictionary f60351a;

    public FDFPage() {
        this.f60351a = new COSDictionary();
    }

    public FDFPageInfo getPageInfo() {
        COSDictionary cOSDictionary = this.f60351a.getCOSDictionary(COSName.INFO);
    ...
    public List<FDFTemplate> getTemplates() {
        COSArray cOSArray = (COSArray) this.f60351a.getDictionaryObject(COSName.TEMPLATES);
        if (cOSArray != null) {
    ...
    public void setPageInfo(FDFPageInfo fDFPageInfo) {
        this.f60351a.setItem(COSName.INFO, fDFPageInfo);
    }

    public void setTemplates(List<FDFTemplate> list) {
        this.f60351a.setItem(COSName.TEMPLATES, (COSBase) COSArrayList.converterToCOSArray(list));
    }
