...
public final class FlowableConcatMapEager<T, R> extends AbstractC0558I {

    /* renamed from: b */
    public final Function f64218b;
    ...
    /* renamed from: e */
    public final ErrorMode f64221e;
    ...
    public FlowableConcatMapEager(Flowable<T> flowable, Function<? super T, ? extends Publisher<? extends R>> function, int i, int i2, ErrorMode errorMode) {
        super(flowable);
        this.f64218b = function;
        this.f64219c = i;
        this.f64220d = i2;
        this.f64221e = errorMode;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super R> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new ConcatMapEagerDelayErrorSubscriber(subscriber, this.f64218b, this.f64219c, this.f64220d, this.f64221e));
    }
}