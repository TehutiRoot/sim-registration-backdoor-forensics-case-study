...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.change_pack.ChangePackViewModel$callApiGetMainPackageGroupPrepaid$3 */
/* loaded from: classes9.dex */
public final class ChangePackViewModel$callApiGetMainPackageGroupPrepaid$3 extends Lambda implements Function1<GetMainPackageGroupResponse, Unit> {
    final /* synthetic */ ChangePackViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ChangePackViewModel$callApiGetMainPackageGroupPrepaid$3(ChangePackViewModel changePackViewModel) {
        super(1);
