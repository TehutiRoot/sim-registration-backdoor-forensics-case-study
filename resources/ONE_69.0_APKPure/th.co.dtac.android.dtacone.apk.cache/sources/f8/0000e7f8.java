...
public final class ObjectSerializer$descriptor$2 extends Lambda implements Function0<SerialDescriptor> {
    ...
    /* loaded from: classes6.dex */
    public static final class C121391 extends Lambda implements Function1<ClassSerialDescriptorBuilder, Unit> {
        final /* synthetic */ ObjectSerializer<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C121391(ObjectSerializer<T> objectSerializer) {
            super(1);
    ...
    public final SerialDescriptor invoke() {
        return SerialDescriptorsKt.buildSerialDescriptor(this.$serialName, StructureKind.OBJECT.INSTANCE, new SerialDescriptor[0], new C121391(this.this$0));
    }
}