...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.tol.screen.inputInfo.ComposableSingletons$InputInfoScreenKt$lambda-15$1$1$1$1  reason: invalid class name */
/* loaded from: classes10.dex */
public final class ComposableSingletons$InputInfoScreenKt$lambda15$1$1$1$1 extends Lambda implements Function1<CustomerInformation, Unit> {
    final /* synthetic */ MutableState<CustomerInformation> $customerInfo$delegate;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ComposableSingletons$InputInfoScreenKt$lambda15$1$1$1$1(MutableState<CustomerInformation> mutableState) {
        super(1);
