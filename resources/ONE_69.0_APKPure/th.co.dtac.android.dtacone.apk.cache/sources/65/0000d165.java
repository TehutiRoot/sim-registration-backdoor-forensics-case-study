...
public final class ObservableCombineLatest<T, R> extends Observable<R> {
    ...
    /* renamed from: a */
    public final ObservableSource[] f65191a;

    /* renamed from: b */
    public final Iterable f65192b;

    /* renamed from: c */
    public final Function f65193c;
    ...
    public ObservableCombineLatest(ObservableSource<? extends T>[] observableSourceArr, Iterable<? extends ObservableSource<? extends T>> iterable, Function<? super Object[], ? extends R> function, int i, boolean z) {
        this.f65191a = observableSourceArr;
        this.f65192b = iterable;
        this.f65193c = function;
        this.f65194d = i;
        this.f65195e = z;
    }
    ...
    public void subscribeActual(Observer<? super R> observer) {
        int length;
        ObservableSource<? extends T>[] observableSourceArr = this.f65191a;
        if (observableSourceArr == null) {
            observableSourceArr = new Observable[8];
            length = 0;
            for (ObservableSource<? extends T> observableSource : this.f65192b) {
        ...
        if (i == 0) {
            ...
            new LatestCoordinator(observer, this.f65193c, i, this.f65194d, this.f65195e).subscribe(observableSourceArr);
        }
    }
}