...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.fragment.common.OnePostpaidNavigateToCommonFragment$initView$1$4 */
/* loaded from: classes10.dex */
public final class OnePostpaidNavigateToCommonFragment$initView$1$4 extends Lambda implements Function1<Resource<? extends ErrorCollection>, Unit> {
    final /* synthetic */ OnePostpaidNavigateToCommonFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidNavigateToCommonFragment$initView$1$4(OnePostpaidNavigateToCommonFragment onePostpaidNavigateToCommonFragment) {
        super(1);
    ...
    public final void invoke2(Resource<ErrorCollection> resource) {
        ...
        if (resourceContentIfNotHandled.getStatus() == StatusResource.SUCCESS) {
            onePostpaidNavigateToCommonFragment.m12331u(resourceContentIfNotHandled.getData());
        }
    }
}