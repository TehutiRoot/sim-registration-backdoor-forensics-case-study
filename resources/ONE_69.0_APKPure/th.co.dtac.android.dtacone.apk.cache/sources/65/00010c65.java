...
public abstract class SyncOnSubscribe<S, T> implements Observable.OnSubscribe<T> {
    ...
    /* loaded from: classes7.dex */
    public static class C13820a implements Func2 {

        /* renamed from: a */
        public final /* synthetic */ Action2 f79554a;

        public C13820a(Action2 action2) {
            this.f79554a = action2;
        }

        @Override // p046rx.functions.Func2
        /* renamed from: a */
        public Object call(Object obj, Observer observer) {
            this.f79554a.call(obj, observer);
            return obj;
        }
    }
    ...
    /* loaded from: classes7.dex */
    public static class C13821b implements Func2 {

        /* renamed from: a */
        public final /* synthetic */ Action2 f79555a;

        public C13821b(Action2 action2) {
            this.f79555a = action2;
        }

        @Override // p046rx.functions.Func2
        /* renamed from: a */
        public Object call(Object obj, Observer observer) {
            this.f79555a.call(obj, observer);
            return obj;
        }
    }
    ...
    /* loaded from: classes7.dex */
    public static class C13822c implements Func2 {

        /* renamed from: a */
        public final /* synthetic */ Action1 f79556a;

        public C13822c(Action1 action1) {
            this.f79556a = action1;
        }

        @Override // p046rx.functions.Func2
        /* renamed from: a */
        public Void call(Void r2, Observer observer) {
            this.f79556a.call(observer);
            return r2;
        }
    }
    ...
    /* loaded from: classes7.dex */
    public static class C13823d implements Func2 {

        /* renamed from: a */
        public final /* synthetic */ Action1 f79557a;

        public C13823d(Action1 action1) {
            this.f79557a = action1;
        }

        @Override // p046rx.functions.Func2
        /* renamed from: a */
        public Void call(Void r1, Observer observer) {
            this.f79557a.call(observer);
            return null;
        }
    }
    ...
    /* loaded from: classes7.dex */
    public static class C13824e implements Action1 {

        /* renamed from: a */
        public final /* synthetic */ Action0 f79558a;

        public C13824e(Action0 action0) {
            this.f79558a = action0;
        }
    ...
    public static <S, T> SyncOnSubscribe<S, T> createSingleState(Func0<? extends S> func0, Action2<? super S, ? super Observer<? super T>> action2) {
        return new C13825f(func0, new C13820a(action2));
    }
    ...
    public static <S, T> SyncOnSubscribe<S, T> createStateful(Func0<? extends S> func0, Func2<? super S, ? super Observer<? super T>, ? extends S> func2) {
        return new C13825f(func0, func2);
    }
    ...
    public static <S, T> SyncOnSubscribe<S, T> createSingleState(Func0<? extends S> func0, Action2<? super S, ? super Observer<? super T>> action2, Action1<? super S> action1) {
        return new C13825f(func0, new C13821b(action2), action1);
    }

    public static <T> SyncOnSubscribe<Void, T> createStateless(Action1<? super Observer<? super T>> action1, Action0 action0) {
        return new C13825f(new C13823d(action1), new C13824e(action0));
    }

    /* renamed from: rx.observables.SyncOnSubscribe$f */
    /* loaded from: classes7.dex */
    public static final class C13825f extends SyncOnSubscribe {

        /* renamed from: a */
        public final Func0 f79559a;

        /* renamed from: b */
        public final Func2 f79560b;

        /* renamed from: c */
        public final Action1 f79561c;

        public C13825f(Func0 func0, Func2 func2, Action1 action1) {
            this.f79559a = func0;
            this.f79560b = func2;
            this.f79561c = action1;
        }
        ...
        public Object next(Object obj, Observer observer) {
            return this.f79560b.call(obj, observer);
        }

        @Override // p046rx.observables.SyncOnSubscribe
        public void onUnsubscribe(Object obj) {
            Action1 action1 = this.f79561c;
            if (action1 != null) {
                action1.call(obj);
            }
        }

        public C13825f(Func0 func0, Func2 func2) {
            this(func0, func2, null);
        }

        public C13825f(Func2 func2, Action1 action1) {
            this(null, func2, action1);
        }

        public C13825f(Func2 func2) {
