...
public class BeanDeserializer extends BeanDeserializerBase implements Serializable {
    ...
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C6076a {
        ...
        static {
            ...
            try {
                f43287a[JsonToken.VALUE_NUMBER_INT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f43287a[JsonToken.VALUE_NUMBER_FLOAT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f43287a[JsonToken.VALUE_EMBEDDED_OBJECT.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f43287a[JsonToken.VALUE_TRUE.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f43287a[JsonToken.VALUE_FALSE.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f43287a[JsonToken.VALUE_NULL.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f43287a[JsonToken.START_ARRAY.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f43287a[JsonToken.FIELD_NAME.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f43287a[JsonToken.END_OBJECT.ordinal()] = 10;
    ...
    /* loaded from: classes3.dex */
    public static class C6077b extends ReadableObjectId.Referring {

        /* renamed from: c */
        public final DeserializationContext f43288c;

        /* renamed from: d */
        public final SettableBeanProperty f43289d;

        /* renamed from: e */
        public Object f43290e;

        public C6077b(DeserializationContext deserializationContext, UnresolvedForwardReference unresolvedForwardReference, JavaType javaType, PropertyValueBuffer propertyValueBuffer, SettableBeanProperty settableBeanProperty) {
            super(unresolvedForwardReference, javaType);
            this.f43288c = deserializationContext;
            this.f43289d = settableBeanProperty;
        }

        /* renamed from: a */
        public void m49480a(Object obj) {
            this.f43290e = obj;
        }
        ...
        public void handleResolvedForwardReference(Object obj, Object obj2) {
            if (this.f43290e == null) {
                DeserializationContext deserializationContext = this.f43288c;
                SettableBeanProperty settableBeanProperty = this.f43289d;
                deserializationContext.reportInputMismatch(settableBeanProperty, "Cannot resolve ObjectId forward reference using property '%s' (of type %s): Bean not yet resolved", settableBeanProperty.getName(), this.f43289d.getDeclaringClass().getName());
            }
            this.f43289d.set(this.f43290e, obj2);
        }
    }
    ...
    private C6077b handleUnresolvedReference(DeserializationContext deserializationContext, SettableBeanProperty settableBeanProperty, PropertyValueBuffer propertyValueBuffer, UnresolvedForwardReference unresolvedForwardReference) throws JsonMappingException {
        C6077b c6077b = new C6077b(deserializationContext, unresolvedForwardReference, settableBeanProperty.getType(), propertyValueBuffer, settableBeanProperty);
        unresolvedForwardReference.getRoid().appendReferring(c6077b);
        return c6077b;
    }
    ...
    public final Object _deserializeOther(JsonParser jsonParser, DeserializationContext deserializationContext, JsonToken jsonToken) throws IOException {
        switch (C6076a.f43287a[jsonToken.ordinal()]) {
            case 1:
    ...
    public Object _deserializeUsingPropertyBased(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        ArrayList<C6077b> arrayList = null;
                ...
                if (findCreatorProperty != null) {
                    ...
                    if (find != null) {
                        try {
                            ...
                            C6077b handleUnresolvedReference = handleUnresolvedReference(deserializationContext, find, startBuilding, e2);
                            if (arrayList == null) {
