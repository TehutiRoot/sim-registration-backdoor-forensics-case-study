...
public final class NavDeepLinkBuilder {
    ...
    /* renamed from: b */
    public final Intent f36385b;

    /* renamed from: c */
    public NavGraph f36386c;

    /* renamed from: d */
    public final List f36387d;

    /* renamed from: e */
    public Bundle f36388e;

    /* loaded from: classes2.dex */
    public static final class PermissiveNavigatorProvider extends NavigatorProvider {

        /* renamed from: c */
        public final Navigator f36389c = new Navigator<NavDestination>() { // from class: androidx.navigation.NavDeepLinkBuilder$PermissiveNavigatorProvider$mDestNavigator$1
        ...
        public Navigator getNavigator(String name) {
            ...
            try {
                ...
                Navigator navigator = this.f36389c;
    ...
    public static final class C4793a {
        ...
        /* renamed from: b */
        public final Bundle f36391b;

        public C4793a(int i, Bundle bundle) {
            this.f36390a = i;
            this.f36391b = bundle;
        }

        /* renamed from: a */
        public final Bundle m53796a() {
            return this.f36391b;
        }

        /* renamed from: b */
        public final int m53795b() {
            return this.f36390a;
        }
    }
    ...
    public NavDeepLinkBuilder(@NotNull Context context) {
        ...
        this.f36385b = launchIntentForPackage;
    ...
    /* renamed from: a */
    public final void m53799a() {
        ArrayList arrayList = new ArrayList();
        ArrayList<? extends Parcelable> arrayList2 = new ArrayList<>();
        NavDestination navDestination = null;
        for (C4793a c4793a : this.f36387d) {
            int m53795b = c4793a.m53795b();
            Bundle m53796a = c4793a.m53796a();
            NavDestination m53798b = m53798b(m53795b);
            if (m53798b != null) {
                for (int i : m53798b.buildDeepLinkIds(navDestination)) {
                    arrayList.add(Integer.valueOf(i));
                    arrayList2.add(m53796a);
                }
                navDestination = m53798b;
            } else {
                throw new IllegalArgumentException("Navigation destination " + NavDestination.Companion.getDisplayName(this.f36384a, m53795b) + " cannot be found in the navigation graph " + this.f36386c);
            }
        }
        this.f36385b.putExtra(NavController.KEY_DEEP_LINK_IDS, CollectionsKt___CollectionsKt.toIntArray(arrayList));
        this.f36385b.putParcelableArrayListExtra(NavController.KEY_DEEP_LINK_ARGS, arrayList2);
    }
    ...
    /* renamed from: b */
    public final NavDestination m53798b(int i) {
        ArrayDeque arrayDeque = new ArrayDeque();
        NavGraph navGraph = this.f36386c;
    ...
    /* renamed from: c */
    public final void m53797c() {
        for (C4793a c4793a : this.f36387d) {
            int m53795b = c4793a.m53795b();
            if (m53798b(m53795b) == null) {
                String displayName = NavDestination.Companion.getDisplayName(this.f36384a, m53795b);
                throw new IllegalArgumentException("Navigation destination " + displayName + " cannot be found in the navigation graph " + this.f36386c);
            }
        }
    }
    ...
    public final PendingIntent createPendingIntent() {
        ...
        for (C4793a c4793a : this.f36387d) {
            i = (i * 31) + c4793a.m53795b();
            Bundle m53796a = c4793a.m53796a();
            if (m53796a != null) {
                for (String str2 : m53796a.keySet()) {
                    Object obj2 = m53796a.get(str2);
                    int i5 = i * 31;
                    if (obj2 != null) {
                        i2 = obj2.hashCode();
                    } else {
    ...
    public final TaskStackBuilder createTaskStackBuilder() {
        if (this.f36386c != null) {
            if (!this.f36387d.isEmpty()) {
                m53799a();
                TaskStackBuilder addNextIntentWithParentStack = TaskStackBuilder.create(this.f36384a).addNextIntentWithParentStack(new Intent(this.f36385b));
                ...
                for (int i = 0; i < intentCount; i++) {
                    ...
                    if (editIntentAt != null) {
                        editIntentAt.putExtra(NavController.KEY_DEEP_LINK_INTENT, this.f36385b);
                    }
                }
    ...
    public final NavDeepLinkBuilder setArguments(@Nullable Bundle bundle) {
        this.f36388e = bundle;
        this.f36385b.putExtra(NavController.KEY_DEEP_LINK_EXTRAS, bundle);
        return this;
    }
    ...
    public final NavDeepLinkBuilder setComponentName(@NotNull Class<? extends Activity> activityClass) {
        ...
        return setComponentName(new ComponentName(this.f36384a, activityClass));
    }
    ...
    public final NavDeepLinkBuilder setGraph(@NavigationRes int i) {
        return setGraph(new NavInflater(this.f36384a, new PermissiveNavigatorProvider()).inflate(i));
    }
    ...
    public final NavDeepLinkBuilder setComponentName(@NotNull ComponentName componentName) {
        ...
        this.f36385b.setComponent(componentName);
        return this;
    }
    ...
    public final NavDeepLinkBuilder addDestination(@IdRes int i, @Nullable Bundle bundle) {
        this.f36387d.add(new C4793a(i, bundle));
        if (this.f36386c != null) {
            m53797c();
        }
        return this;
    ...
    public final NavDeepLinkBuilder addDestination(@NotNull String route, @Nullable Bundle bundle) {
        Intrinsics.checkNotNullParameter(route, "route");
        this.f36387d.add(new C4793a(NavDestination.Companion.createRoute(route).hashCode(), bundle));
        if (this.f36386c != null) {
            m53797c();
        }
        return this;
    ...
    public final NavDeepLinkBuilder setDestination(@NotNull String destRoute, @Nullable Bundle bundle) {
        Intrinsics.checkNotNullParameter(destRoute, "destRoute");
        this.f36387d.clear();
        this.f36387d.add(new C4793a(NavDestination.Companion.createRoute(destRoute).hashCode(), bundle));
        if (this.f36386c != null) {
            m53797c();
        }
        return this;
    ...
    public NavDeepLinkBuilder(@NotNull NavController navController) {
        ...
        this.f36386c = navController.getGraph();
    }
}