...
public class BCodec extends AbstractC21722ps1 implements StringEncoder, StringDecoder {

    /* renamed from: b */
    public static final CodecPolicy f73300b = CodecPolicy.LENIENT;

    /* renamed from: a */
    public final CodecPolicy f73301a;
    ...
    public byte[] doDecoding(byte[] bArr) {
        ...
        return new Base64(0, BaseNCodec.getChunkSeparator(), false, this.f73301a).decode(bArr);
    }
    ...
    public boolean isStrictDecoding() {
        if (this.f73301a == CodecPolicy.STRICT) {
            return true;
        }
        return false;
    }
