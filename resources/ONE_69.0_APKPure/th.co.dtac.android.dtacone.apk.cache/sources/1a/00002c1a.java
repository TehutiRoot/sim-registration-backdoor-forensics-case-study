...
public final class SliderKt {
    ...
    /* renamed from: a */
    public static final float f14682a = C3623Dp.m73842constructorimpl(10);

    /* renamed from: b */
    public static final float f14683b = C3623Dp.m73842constructorimpl(24);

    /* renamed from: c */
    public static final float f14684c = C3623Dp.m73842constructorimpl(1);

    /* renamed from: d */
    public static final float f14685d = C3623Dp.m73842constructorimpl(6);

    /* renamed from: e */
    public static final float f14686e = C3623Dp.m73842constructorimpl(4);

    /* renamed from: f */
    public static final float f14687f;

    /* renamed from: g */
    public static final float f14688g;

    /* renamed from: h */
    public static final Modifier f14689h;

    /* renamed from: i */
    public static final TweenSpec f14690i;

    static {
        float m73842constructorimpl = C3623Dp.m73842constructorimpl(48);
        f14687f = m73842constructorimpl;
        float m73842constructorimpl2 = C3623Dp.m73842constructorimpl((float) SyslogConstants.LOG_LOCAL2);
        f14688g = m73842constructorimpl2;
        f14689h = SizeKt.m69736heightInVpY3zN4$default(SizeKt.m69755widthInVpY3zN4$default(Modifier.Companion, m73842constructorimpl2, 0.0f, 2, null), 0.0f, m73842constructorimpl, 1, null);
        f14690i = new TweenSpec(100, 0, null, 6, null);
    }
    ...
    */
    ...
    /* renamed from: a */
    public static final void m60779a(Function1 function1, ClosedFloatingPointRange closedFloatingPointRange, ClosedFloatingPointRange closedFloatingPointRange2, MutableState mutableState, float f, Composer composer, int i) {
        int i2;
        int i3;
        int i4;
        int i5;
    ...
    /* renamed from: b */
    public static final void m60778b(boolean z, float f, float f2, List list, SliderColors sliderColors, float f3, MutableInteractionSource mutableInteractionSource, MutableInteractionSource mutableInteractionSource2, Modifier modifier, Modifier modifier2, Modifier modifier3, Composer composer, int i, int i2) {
        ...
        String m70286getString4foXLRw = Strings_androidKt.m70286getString4foXLRw(companion.m70285getSliderRangeStartUdPEhr4(), startRestartGroup, 6);
        String m70286getString4foXLRw2 = Strings_androidKt.m70286getString4foXLRw(companion.m70284getSliderRangeEndUdPEhr4(), startRestartGroup, 6);
        Modifier then = modifier.then(f14689h);
        ...
        float mo69622toPx0680j_4 = density.mo69622toPx0680j_4(f14686e);
        float f4 = f14682a;
        float mo69622toPx0680j_42 = density.mo69622toPx0680j_4(f4);
        float mo69618toDpu2uoSUM = density.mo69618toDpu2uoSUM(f3);
        float m73842constructorimpl = C3623Dp.m73842constructorimpl(f4 * 2);
        float m73842constructorimpl2 = C3623Dp.m73842constructorimpl(mo69618toDpu2uoSUM * f);
        float m73842constructorimpl3 = C3623Dp.m73842constructorimpl(mo69618toDpu2uoSUM * f2);
        Modifier.Companion companion4 = Modifier.Companion;
        int i3 = i >> 9;
        int i4 = i << 6;
        m60775e(SizeKt.fillMaxSize$default(boxScopeInstance.align(companion4, companion2.getCenterStart()), 0.0f, 1, null), sliderColors, z, f, f2, list, mo69622toPx0680j_42, mo69622toPx0680j_4, startRestartGroup, (i3 & 112) | 262144 | (i4 & 896) | (i4 & 7168) | (i4 & 57344));
        startRestartGroup.startReplaceableGroup(1157296644);
        boolean changed = startRestartGroup.changed(m70286getString4foXLRw);
        Object rememberedValue = startRestartGroup.rememberedValue();
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new SliderKt$RangeSliderImpl$1$2$1(m70286getString4foXLRw);
            startRestartGroup.updateRememberedValue(rememberedValue);
        }
        startRestartGroup.endReplaceableGroup();
        int i5 = i & 57344;
        int i6 = (i << 15) & 458752;
        m60776d(boxScopeInstance, FocusableKt.focusable(SemanticsModifierKt.semantics(companion4, true, (Function1) rememberedValue), true, mutableInteractionSource).then(modifier2), m73842constructorimpl2, mutableInteractionSource, sliderColors, z, m73842constructorimpl, startRestartGroup, 1572870 | (i3 & 7168) | i5 | i6);
        startRestartGroup.startReplaceableGroup(1157296644);
        boolean changed2 = startRestartGroup.changed(m70286getString4foXLRw2);
        Object rememberedValue2 = startRestartGroup.rememberedValue();
        if (changed2 || rememberedValue2 == Composer.Companion.getEmpty()) {
            rememberedValue2 = new SliderKt$RangeSliderImpl$1$3$1(m70286getString4foXLRw2);
            startRestartGroup.updateRememberedValue(rememberedValue2);
        }
        startRestartGroup.endReplaceableGroup();
        m60776d(boxScopeInstance, FocusableKt.focusable(SemanticsModifierKt.semantics(companion4, true, (Function1) rememberedValue2), true, mutableInteractionSource2).then(modifier3), m73842constructorimpl3, mutableInteractionSource2, sliderColors, z, m73842constructorimpl, startRestartGroup, 1572870 | ((i >> 12) & 7168) | i5 | i6);
        startRestartGroup.endReplaceableGroup();
    ...
    /* renamed from: c */
    public static final void m60777c(boolean z, float f, List list, SliderColors sliderColors, float f2, MutableInteractionSource mutableInteractionSource, Modifier modifier, Composer composer, int i) {
        ...
        float mo69622toPx0680j_4 = density.mo69622toPx0680j_4(f14686e);
        float f3 = f14682a;
        float mo69622toPx0680j_42 = density.mo69622toPx0680j_4(f3);
        float mo69618toDpu2uoSUM = density.mo69618toDpu2uoSUM(f2);
        float m73842constructorimpl = C3623Dp.m73842constructorimpl(f3 * 2);
        float m73842constructorimpl2 = C3623Dp.m73842constructorimpl(mo69618toDpu2uoSUM * f);
        Modifier.Companion companion2 = Modifier.Companion;
        int i2 = i >> 6;
        m60775e(SizeKt.fillMaxSize$default(companion2, 0.0f, 1, null), sliderColors, z, 0.0f, f, list, mo69622toPx0680j_42, mo69622toPx0680j_4, startRestartGroup, (i2 & 112) | 265222 | ((i << 6) & 896) | ((i << 9) & 57344));
        m60776d(boxScopeInstance, companion2, m73842constructorimpl2, mutableInteractionSource, sliderColors, z, m73842constructorimpl, startRestartGroup, (i2 & 7168) | 1572918 | ((i << 3) & 57344) | ((i << 15) & 458752));
        startRestartGroup.endReplaceableGroup();
        startRestartGroup.endNode();
        startRestartGroup.endReplaceableGroup();
        startRestartGroup.endReplaceableGroup();
    ...
    /* renamed from: d */
    public static final void m60776d(BoxScope boxScope, Modifier modifier, float f, MutableInteractionSource mutableInteractionSource, SliderColors sliderColors, boolean z, float f2, Composer composer, int i) {
        int i2;
        float f3;
        ...
        if ((2995931 & i10) == 599186 && startRestartGroup.getSkipping()) {
            ...
            Modifier m69717paddingqDBjuR0$default = PaddingKt.m69717paddingqDBjuR0$default(Modifier.Companion, f, 0.0f, 0.0f, 0.0f, 14, null);
            Alignment.Companion companion = Alignment.Companion;
            Modifier align = boxScope.align(m69717paddingqDBjuR0$default, companion.getCenterStart());
            startRestartGroup.startReplaceableGroup(733328855);
            ...
            float f4 = f3;
            Modifier hoverable$default = HoverableKt.hoverable$default(IndicationKt.indication(SizeKt.m69750sizeVpY3zN4(modifier, f2, f2), mutableInteractionSource, RippleKt.m70364rememberRipple9IZ8Weo(false, f14683b, 0L, startRestartGroup, 54, 4)), mutableInteractionSource, false, 2, null);
            if (z) {
                m73842constructorimpl = f4;
            } else {
                m73842constructorimpl = C3623Dp.m73842constructorimpl(0);
            }
            SpacerKt.Spacer(BackgroundKt.m69504backgroundbw27NRU(ShadowKt.m71609shadows4CzXII$default(hoverable$default, m73842constructorimpl, RoundedCornerShapeKt.getCircleShape(), false, 0L, 0L, 24, null), sliderColors.thumbColor(z, startRestartGroup, ((i10 >> 15) & 14) | (i11 & 112)).getValue().m71929unboximpl(), RoundedCornerShapeKt.getCircleShape()), startRestartGroup, 0);
            startRestartGroup.endReplaceableGroup();
            startRestartGroup.endNode();
            startRestartGroup.endReplaceableGroup();
            startRestartGroup.endReplaceableGroup();
    ...
    /* renamed from: e */
    public static final void m60775e(Modifier modifier, SliderColors sliderColors, boolean z, float f, float f2, List list, float f3, float f4, Composer composer, int i) {
    ...
    /* renamed from: f */
    public static final Object m60774f(DraggableState draggableState, float f, float f2, float f3, Continuation continuation) {
        Object m31242a = AbstractC10356hK.m31242a(draggableState, null, new SliderKt$animateToTarget$2(f, f2, f3, null), continuation, 1, null);
        if (m31242a == AbstractC19782eg0.getCOROUTINE_SUSPENDED()) {
            return m31242a;
        }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final java.lang.Object m60773g(androidx.compose.p003ui.input.pointer.AwaitPointerEventScope r8, long r9, int r11, kotlin.coroutines.Continuation r12) {
        /*
        ...
        L37:
            ...
            r2 = r9
            r4 = r11
            java.lang.Object r8 = androidx.compose.material.DragGestureDetectorCopyKt.m70189awaitHorizontalPointerSlopOrCancellationgDDlDlE(r1, r2, r4, r5, r6)
            if (r8 != r0) goto L52
            return r0
        L52:
            r7 = r12
        ...
        L55:
            ...
            kotlin.Pair r8 = kotlin.TuplesKt.m29136to(r12, r8)
            goto L65
        L64:
            r8 = 0
        L65:
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.SliderKt.m60773g(androidx.compose.ui.input.pointer.AwaitPointerEventScope, long, int, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    /* renamed from: h */
    public static final float m60772h(float f, float f2, float f3) {
        float f4;
        float f5 = f2 - f;
        if (f5 == 0.0f) {
            f4 = 0.0f;
        ...
        return AbstractC11695c.coerceIn(f4, 0.0f, 1.0f);
    }

    /* renamed from: i */
    public static final Modifier m60771i(Modifier modifier, MutableInteractionSource mutableInteractionSource, MutableInteractionSource mutableInteractionSource2, State state, State state2, boolean z, boolean z2, float f, ClosedFloatingPointRange closedFloatingPointRange, State state3, State state4) {
        if (z) {
    ...
    /* renamed from: j */
    public static final float m60770j(float f, float f2, float f3, float f4, float f5) {
        return MathHelpersKt.lerp(f4, f5, m60772h(f, f2, f3));
    }

    /* renamed from: k */
    public static final ClosedFloatingPointRange m60769k(float f, float f2, ClosedFloatingPointRange closedFloatingPointRange, float f3, float f4) {
        return AbstractC17854Is1.rangeTo(m60770j(f, f2, ((Number) closedFloatingPointRange.getStart()).floatValue(), f3, f4), m60770j(f, f2, ((Number) closedFloatingPointRange.getEndInclusive()).floatValue(), f3, f4));
    }

    /* renamed from: l */
    public static final Modifier m60768l(Modifier modifier, float f, boolean z, Function1 function1, Function0 function0, ClosedFloatingPointRange closedFloatingPointRange, int i) {
        return ProgressSemanticsKt.progressSemantics(SemanticsModifierKt.semantics$default(modifier, false, new SliderKt$sliderSemantics$1(z, closedFloatingPointRange, i, AbstractC11695c.coerceIn(f, ((Number) closedFloatingPointRange.getStart()).floatValue(), ((Number) closedFloatingPointRange.getEndInclusive()).floatValue()), function1, function0), 1, null), f, closedFloatingPointRange, i);
    }

    /* renamed from: m */
    public static final Modifier m60767m(Modifier modifier, DraggableState draggableState, MutableInteractionSource mutableInteractionSource, float f, boolean z, State state, State state2, MutableState mutableState, boolean z2) {
    ...
    /* renamed from: n */
    public static final float m60766n(float f, List list, float f2, float f3) {
        Object obj;
    ...
    /* renamed from: o */
    public static final List m60765o(int i) {
        if (i == 0) {
