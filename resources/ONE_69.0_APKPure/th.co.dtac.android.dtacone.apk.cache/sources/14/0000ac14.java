...
public abstract class LittleEndianByteArray {
    ...
    /* renamed from: a */
    public static final InterfaceC8049b f53859a;

    /* loaded from: classes4.dex */
    public enum JavaLittleEndianBytes implements InterfaceC8049b {
        INSTANCE { // from class: com.google.common.hash.LittleEndianByteArray.JavaLittleEndianBytes.1
            @Override // com.google.common.hash.LittleEndianByteArray.JavaLittleEndianBytes, com.google.common.hash.LittleEndianByteArray.InterfaceC8049b
        ...
        @Override // com.google.common.hash.LittleEndianByteArray.InterfaceC8049b
    ...
    /* loaded from: classes4.dex */
    public enum UnsafeByteArray implements InterfaceC8049b {
        UNSAFE_LITTLE_ENDIAN { // from class: com.google.common.hash.LittleEndianByteArray.UnsafeByteArray.1
            @Override // com.google.common.hash.LittleEndianByteArray.UnsafeByteArray, com.google.common.hash.LittleEndianByteArray.InterfaceC8049b
            public long getLongLittleEndian(byte[] bArr, int i) {
        ...
        /* renamed from: a */
        public static /* synthetic */ Unsafe m40037a() {
                ...
                try {
                    ...
                    return (Unsafe) AccessController.doPrivileged(new PrivilegedExceptionAction() { // from class: com.google.common.hash.a
                        ...
                        public final Object run() {
                            return LittleEndianByteArray.UnsafeByteArray.m40037a();
                        }
                    });
                }
    ...
    static {
        InterfaceC8049b interfaceC8049b = JavaLittleEndianBytes.INSTANCE;
        try {
            if ("amd64".equals(System.getProperty("os.arch"))) {
                if (ByteOrder.nativeOrder().equals(ByteOrder.LITTLE_ENDIAN)) {
                    interfaceC8049b = UnsafeByteArray.UNSAFE_LITTLE_ENDIAN;
                } else {
                    interfaceC8049b = UnsafeByteArray.UNSAFE_BIG_ENDIAN;
                }
            }
        } catch (Throwable unused) {
        }
        f53859a = interfaceC8049b;
    }

    /* renamed from: a */
    public static int m40040a(byte[] bArr, int i) {
        return ((bArr[i + 3] & 255) << 24) | (bArr[i] & 255) | ((bArr[i + 1] & 255) << 8) | ((bArr[i + 2] & 255) << 16);
    }

    /* renamed from: b */
    public static long m40039b(byte[] bArr, int i) {
        return f53859a.getLongLittleEndian(bArr, i);
    }

    /* renamed from: c */
    public static long m40038c(byte[] bArr, int i, int i2) {
