...
public final class DrawerKt$BottomDrawerScrim$dismissModifier$2$1 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    ...
    /* loaded from: classes.dex */
    public static final class C30881 extends Lambda implements Function0<Boolean> {
        final /* synthetic */ Function0<Unit> $onDismiss;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C30881(Function0<Unit> function0) {
            super(0);
    ...
    public final void invoke2(@NotNull SemanticsPropertyReceiver semantics) {
        ...
        SemanticsPropertiesKt.onClick$default(semantics, null, new C30881(this.$onDismiss), 1, null);
    }
}