...
@Metadata(m29143d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m29142d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_cookie", "Landroidx/compose/material/icons/Icons$TwoTone;", "getCookie", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "Cookie", "material-icons-extended_release"}, m29141k = 2, m29140mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nCookie.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Cookie.kt\nandroidx/compose/material/icons/twotone/CookieKt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,96:1\n122#2:97\n116#2,3:98\n119#2,3:102\n132#2,18:105\n152#2:142\n132#2,18:143\n152#2:180\n132#2,18:181\n152#2:218\n132#2,18:219\n152#2:256\n132#2,18:257\n152#2:294\n174#3:101\n694#4,2:123\n706#4,2:125\n708#4,11:131\n694#4,2:161\n706#4,2:163\n708#4,11:169\n694#4,2:199\n706#4,2:201\n708#4,11:207\n694#4,2:237\n706#4,2:239\n708#4,11:245\n694#4,2:275\n706#4,2:277\n708#4,11:283\n64#5,4:127\n64#5,4:165\n64#5,4:203\n64#5,4:241\n64#5,4:279\n*S KotlinDebug\n*F\n+ 1 Cookie.kt\nandroidx/compose/material/icons/twotone/CookieKt\n*L\n29#1:97\n29#1:98,3\n29#1:102,3\n30#1:105,18\n30#1:142\n57#1:143,18\n57#1:180\n63#1:181,18\n63#1:218\n69#1:219,18\n69#1:256\n75#1:257,18\n75#1:294\n29#1:101\n30#1:123,2\n30#1:125,2\n30#1:131,11\n57#1:161,2\n57#1:163,2\n57#1:169,11\n63#1:199,2\n63#1:201,2\n63#1:207,11\n69#1:237,2\n69#1:239,2\n69#1:245,11\n75#1:275,2\n75#1:277,2\n75#1:283,11\n30#1:127,4\n57#1:165,4\n63#1:203,4\n69#1:241,4\n75#1:279,4\n*E\n"})
/* loaded from: classes.dex */
public final class CookieKt {

    /* renamed from: a */
    public static ImageVector f23770a;

    @NotNull
    public static final ImageVector getCookie(@NotNull Icons.TwoTone twoTone) {
        Intrinsics.checkNotNullParameter(twoTone, "<this>");
        ImageVector imageVector = f23770a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Cookie", C3623Dp.m73842constructorimpl(24.0f), C3623Dp.m73842constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.moveTo(17.07f, 8.93f);
        pathBuilder.curveToRelative(-2.55f, -0.39f, -4.57f, -2.41f, -4.99f, -4.94f);
        pathBuilder.curveTo(6.73f, 3.82f, 4.0f, 8.69f, 4.0f, 12.0f);
        pathBuilder.curveToRelative(0.0f, 4.41f, 3.59f, 8.0f, 8.0f, 8.0f);
        pathBuilder.curveToRelative(4.06f, 0.0f, 7.7f, -3.14f, 7.98f, -7.45f);
        pathBuilder.curveTo(17.59f, 11.48f, 17.14f, 9.29f, 17.07f, 8.93f);
        pathBuilder.close();
        ...
        pathBuilder2.moveTo(10.5f, 8.5f);
        ...
        pathBuilder5.moveTo(21.95f, 10.99f);
        pathBuilder5.curveToRelative(-1.79f, -0.03f, -3.7f, -1.95f, -2.68f, -4.22f);
        pathBuilder5.curveToRelative(-2.97f, 1.0f, -5.78f, -1.59f, -5.19f, -4.56f);
        pathBuilder5.curveTo(7.1f, 0.74f, 2.0f, 6.41f, 2.0f, 12.0f);
        pathBuilder5.curveToRelative(0.0f, 5.52f, 4.48f, 10.0f, 10.0f, 10.0f);
        pathBuilder5.curveTo(17.89f, 22.0f, 22.54f, 16.92f, 21.95f, 10.99f);
        pathBuilder5.close();
        pathBuilder5.moveTo(12.0f, 20.0f);
        pathBuilder5.curveToRelative(-4.41f, 0.0f, -8.0f, -3.59f, -8.0f, -8.0f);
        pathBuilder5.curveToRelative(0.0f, -3.31f, 2.73f, -8.18f, 8.08f, -8.02f);
        pathBuilder5.curveToRelative(0.42f, 2.54f, 2.44f, 4.56f, 4.99f, 4.94f);
        pathBuilder5.curveToRelative(0.07f, 0.36f, 0.52f, 2.55f, 2.92f, 3.63f);
        pathBuilder5.curveTo(19.7f, 16.86f, 16.06f, 20.0f, 12.0f, 20.0f);
        pathBuilder5.close();
