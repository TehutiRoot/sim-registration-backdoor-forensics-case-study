...
public class Bezier {
    ...
    public float length() {
        ...
        while (i <= 10) {
            float f2 = i / 10;
            double point = point(f2, this.startPoint.f43768x, this.control1.f43768x, this.control2.f43768x, this.endPoint.f43768x);
            double point2 = point(f2, this.startPoint.f43769y, this.control1.f43769y, this.control2.f43769y, this.endPoint.f43769y);
            if (i > 0) {
                double d3 = point - d;
                double d4 = point2 - d2;
