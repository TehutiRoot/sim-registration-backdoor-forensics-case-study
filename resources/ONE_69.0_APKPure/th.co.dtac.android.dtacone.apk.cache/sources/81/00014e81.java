package th.p047co.dtac.android.dtacone.view.fragment.mrtr_change_sim.payment;
...
/* renamed from: th.co.dtac.android.dtacone.view.fragment.mrtr_change_sim.payment.MrtrChangeSimPaymentFragment$initView$4$1 */
/* loaded from: classes9.dex */
public final class MrtrChangeSimPaymentFragment$initView$4$1 extends Lambda implements Function1<CharSequence, Unit> {
    final /* synthetic */ MrtrChangeSimPaymentFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrChangeSimPaymentFragment$initView$4$1(MrtrChangeSimPaymentFragment mrtrChangeSimPaymentFragment) {
        super(1);
        this.this$0 = mrtrChangeSimPaymentFragment;
    }
    ...
    public final void invoke2(CharSequence charSequence) {
        ...
        if (text == null || text.length() == 0) {
            editText2 = this.this$0.f101888r;
            if (editText2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("etCreditCardAmount");
                editText2 = null;
            }
        ...
        if (bigDecimal2.compareTo(bigDecimal) != 1) {
            ...
            editText5 = this.this$0.f101890t;
            if (editText5 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("etCashRemainForCombine");
            } else {
                editText6 = editText5;
