...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.nadOutbound.viewModel.OneNadOutboundViewModel$retryBillReminder$3 */
/* loaded from: classes10.dex */
public final class OneNadOutboundViewModel$retryBillReminder$3 extends Lambda implements Function1<List<? extends OneNadOutboundBillingItem>, Unit> {
    final /* synthetic */ OneNadOutboundViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneNadOutboundViewModel$retryBillReminder$3(OneNadOutboundViewModel oneNadOutboundViewModel) {
        super(1);
