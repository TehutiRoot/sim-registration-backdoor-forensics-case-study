...
public class TextInputEditText extends AppCompatEditText {
    ...
    /* renamed from: a */
    public final String m43843a(TextInputLayout textInputLayout) {
        String str;
    ...
    /* renamed from: b */
    public final boolean m43842b(TextInputLayout textInputLayout) {
        if (textInputLayout != null && this.f51021b) {
            return true;
        }
        return false;
    }
    ...
    public void getFocusedRect(@Nullable Rect rect) {
        ...
        TextInputLayout textInputLayout = getTextInputLayout();
        if (m43842b(textInputLayout) && rect != null) {
            textInputLayout.getFocusedRect(this.f51020a);
            rect.bottom = this.f51020a.bottom;
        }
    }
    ...
    public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (Build.VERSION.SDK_INT < 23 && textInputLayout != null) {
            accessibilityNodeInfo.setText(m43843a(textInputLayout));
        }
    }
    ...
    public boolean requestRectangleOnScreen(@Nullable Rect rect) {
        TextInputLayout textInputLayout = getTextInputLayout();
        if (m43842b(textInputLayout) && rect != null) {
            this.f51020a.set(rect.left, rect.top, rect.right, rect.bottom + (textInputLayout.getHeight() - getHeight()));
            return super.requestRectangleOnScreen(this.f51020a);
        }
