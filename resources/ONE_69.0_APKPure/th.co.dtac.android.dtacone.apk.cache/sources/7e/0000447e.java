...
@Metadata(m29143d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m29142d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_spatialAudioOff", "Landroidx/compose/material/icons/Icons$Rounded;", "getSpatialAudioOff", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "SpatialAudioOff", "material-icons-extended_release"}, m29141k = 2, m29140mv = {1, 8, 0})
...
public final class SpatialAudioOffKt {
    ...
    /* renamed from: a */
    public static ImageVector f20804a;

    @NotNull
    public static final ImageVector getSpatialAudioOff(@NotNull Icons.Rounded rounded) {
        Intrinsics.checkNotNullParameter(rounded, "<this>");
        ImageVector imageVector = f20804a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.SpatialAudioOff", C3623Dp.m73842constructorimpl(24.0f), C3623Dp.m73842constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder2.lineToRelative(0.0f, -0.78f);
        ...
        pathBuilder3.moveTo(21.11f, 1.85f);
        ...
        pathBuilder3.curveToRelative(-0.3f, 0.39f, -0.26f, 0.95f, 0.09f, 1.3f);
        pathBuilder3.lineToRelative(0.0f, 0.0f);
        pathBuilder3.curveToRelative(0.43f, 0.43f, 1.13f, 0.38f, 1.5f, -0.09f);
        pathBuilder3.curveTo(22.61f, 10.95f, 24.46f, 6.16f, 21.11f, 1.85f);
        pathBuilder3.close();
        ...
        pathBuilder4.moveTo(18.31f, 4.84f);
        ...
        pathBuilder4.curveToRelative(0.25f, 0.44f, 0.74f, 1.69f, -0.01f, 2.99f);
        pathBuilder4.curveToRelative(-0.23f, 0.4f, -0.19f, 0.9f, 0.14f, 1.22f);
        pathBuilder4.lineToRelative(0.0f, 0.0f);
        pathBuilder4.curveToRelative(0.47f, 0.47f, 1.25f, 0.35f, 1.58f, -0.22f);
        pathBuilder4.curveTo(19.47f, 7.88f, 18.89f, 5.85f, 18.31f, 4.84f);
        pathBuilder4.close();
