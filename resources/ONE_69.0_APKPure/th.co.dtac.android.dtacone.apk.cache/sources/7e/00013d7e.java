...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.registration.fragment.OneInputOTPFragment$initViewModel$1$3 */
/* loaded from: classes10.dex */
public final class OneInputOTPFragment$initViewModel$1$3 extends Lambda implements Function1<Resource<? extends Void>, Unit> {
    final /* synthetic */ OneRegistrationViewModel $this_with;
    final /* synthetic */ OneInputOTPFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneInputOTPFragment$initViewModel$1$3(OneInputOTPFragment oneInputOTPFragment, OneRegistrationViewModel oneRegistrationViewModel) {
        super(1);
    ...
    public final void invoke2(Resource<Void> resource) {
        ...
        if (resourceContentIfNotHandled.getStatus() == StatusResource.SUCCESS) {
            oneInputOTPFragment.m10432r();
            oneRegistrationViewModel.clearNextStepRequestOtpOnline();
        }
    }
}