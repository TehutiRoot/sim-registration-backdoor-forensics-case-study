...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.home.viewModel.OneHomeViewModel$getOneChangeOwnerAuthorization$3 */
/* loaded from: classes10.dex */
public final class OneHomeViewModel$getOneChangeOwnerAuthorization$3 extends Lambda implements Function1<GetAuthorizationByRtrResponse, Unit> {
    final /* synthetic */ OneHomeViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneHomeViewModel$getOneChangeOwnerAuthorization$3(OneHomeViewModel oneHomeViewModel) {
        super(1);
    ...
    public final void invoke2(GetAuthorizationByRtrResponse getAuthorizationByRtrResponse) {
        MutableLiveData m14064R;
        m14064R = this.this$0.m14064R();
        m14064R.setValue(Resource.Companion.success(getAuthorizationByRtrResponse));
    }
}