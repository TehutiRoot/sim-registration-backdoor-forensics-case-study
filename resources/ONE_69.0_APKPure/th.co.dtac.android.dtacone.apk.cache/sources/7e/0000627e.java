...
@Metadata(m29143d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0002\b\u0003\u001a#\u0010\u0004\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00030\u00020\u00022\u0006\u0010\u0001\u001a\u00020\u0000H\u0000¢\u0006\u0004\b\u0004\u0010\u0005\u001a\u0013\u0010\b\u001a\u00020\u0007*\u00020\u0006H\u0002¢\u0006\u0004\b\b\u0010\t¨\u0006\n"}, m29142d2 = {"Landroidx/compose/ui/layout/IntrinsicMeasureScope;", Action.SCOPE_ATTRIBUTE, "", "Landroidx/compose/ui/layout/Measurable;", "getChildrenOfVirtualChildren", "(Landroidx/compose/ui/layout/IntrinsicMeasureScope;)Ljava/util/List;", "Landroidx/compose/ui/node/LayoutNode;", "", PDPageLabelRange.STYLE_LETTERS_LOWER, "(Landroidx/compose/ui/node/LayoutNode;)Z", "ui_release"}, m29141k = 2, m29140mv = {1, 8, 0})
...
public final class MeasureScopeWithLayoutNodeKt {
    ...
    /* renamed from: a */
    public static final boolean m59390a(LayoutNode layoutNode) {
        ...
        if (i != 3 && i != 4) {
            if (i == 5) {
                ...
                if (parent$ui_release != null) {
                    return m59390a(parent$ui_release);
                }
    ...
    public static final List<List<Measurable>> getChildrenOfVirtualChildren(@NotNull IntrinsicMeasureScope scope) {
        ...
        boolean m59390a = m59390a(layoutNode);
