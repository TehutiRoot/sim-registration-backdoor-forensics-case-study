...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.device_sale.viewmodel.OneDeviceSaleViewModel$callAPIGetBlacklistSharingConsentTemplate$3 */
/* loaded from: classes10.dex */
public final class C14648xbe23bf47 extends Lambda implements Function1<OneBlacklistSharingConsentTemplateResponse, Unit> {
    final /* synthetic */ OneDeviceSaleViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C14648xbe23bf47(OneDeviceSaleViewModel oneDeviceSaleViewModel) {
        super(1);
    ...
    public final void invoke2(OneBlacklistSharingConsentTemplateResponse oneBlacklistSharingConsentTemplateResponse) {
        MutableLiveData m14372i0;
        MutableLiveData m14386b0;
        this.this$0.getLiveDataState().setValue(StatusResource.DISMISS);
        m14372i0 = this.this$0.m14372i0();
        Resource.Companion companion = Resource.Companion;
        m14372i0.setValue(companion.success(null));
        m14386b0 = this.this$0.m14386b0();
        GetBlacklistSharingConsentTemplateResponse data = oneBlacklistSharingConsentTemplateResponse.getData();
        m14386b0.setValue(companion.success(data != null ? data.getBlacklistSharingConsentImage() : null));
    }
}