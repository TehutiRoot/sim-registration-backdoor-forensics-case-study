...
public final class AdapterMultiSimPrepaidSubscriberList extends RecyclerView.Adapter<ViewHolder> {
    ...
    public static final class ViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: a */
        public final DtacFontTextView f81374a;

        /* renamed from: b */
        public final ImageView f81375b;
        ...
        public ViewHolder(@NotNull View itemView) {
            ...
            this.f81374a = (DtacFontTextView) findViewById;
            ...
            this.f81375b = (ImageView) findViewById2;
        }
        ...
        public final void bind(@NotNull String subscriber, int i, @NotNull Function2<? super Integer, ? super String, Unit> onRemove) {
            ...
            this.f81374a.setText(subscriber);
            OnSingleClickListenerKt.setOnSingleClickListener(this.f81375b, new AdapterMultiSimPrepaidSubscriberList$ViewHolder$bind$1(onRemove, i, subscriber));
        }
    }
    ...
    public final void removeItem(int i) {
        this.f81372a.remove(i);
        notifyItemRemoved(i);
        notifyItemRangeChanged(i, this.f81372a.size());
    }
    ...
    public AdapterMultiSimPrepaidSubscriberList(@NotNull List<String> list, @NotNull Function2<? super Integer, ? super String, Unit> onRemove) {
        ...
        Intrinsics.checkNotNullParameter(onRemove, "onRemove");
        this.f81372a = list;
        this.f81373b = onRemove;
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public void onBindViewHolder(@NotNull ViewHolder holder, int i) {
        Intrinsics.checkNotNullParameter(holder, "holder");
        holder.bind((String) this.f81372a.get(i), i, new AdapterMultiSimPrepaidSubscriberList$onBindViewHolder$1(this));
    }
