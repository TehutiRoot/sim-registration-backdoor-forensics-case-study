...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
    ...
    /* renamed from: m */
    public final ReentrantLock f70684m;

    /* renamed from: n */
    public List f70685n;

    /* renamed from: o */
    public Object f70686o;

    /* renamed from: p */
    public final HashMap f70687p;

    /* renamed from: kotlinx.coroutines.channels.BroadcastChannelImpl$a */
    /* loaded from: classes6.dex */
    public final class C12017a extends BufferedChannel {
        public C12017a() {
        ...
        public boolean cancelImpl$kotlinx_coroutines_core(Throwable th2) {
            ReentrantLock reentrantLock = BroadcastChannelImpl.this.f70684m;
            BroadcastChannelImpl broadcastChannelImpl = BroadcastChannelImpl.this;
            reentrantLock.lock();
            try {
                broadcastChannelImpl.m27575i0(this);
    ...
    /* loaded from: classes6.dex */
    public final class C12018b extends ConflatedBufferedChannel {
        public C12018b() {
        ...
        /* renamed from: n0 */
        public boolean cancelImpl$kotlinx_coroutines_core(Throwable th2) {
            BroadcastChannelImpl.this.m27575i0(this);
            return super.cancelImpl$kotlinx_coroutines_core(th2);
        }
    }
    ...
    public BroadcastChannelImpl(int i) {
        ...
        this.f70684m = new ReentrantLock();
        this.f70685n = CollectionsKt__CollectionsKt.emptyList();
        symbol = BroadcastChannelKt.f70690a;
        this.f70686o = symbol;
        this.f70687p = new HashMap();
    }
    ...
    public boolean cancelImpl$kotlinx_coroutines_core(@Nullable Throwable th2) {
        Symbol symbol;
        ReentrantLock reentrantLock = this.f70684m;
        reentrantLock.lock();
        try {
            for (BufferedChannel bufferedChannel : this.f70685n) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: i0 */
    public final void m27575i0(ReceiveChannel receiveChannel) {
        ReentrantLock reentrantLock = this.f70684m;
        reentrantLock.lock();
        try {
            ArrayList arrayList = new ArrayList();
    ...
    public ReceiveChannel<E> openSubscription() {
        ...
        try {
            ...
            if (isClosedForSend()) {
                Object obj = this.f70686o;
                symbol2 = BroadcastChannelKt.f70690a;
                if (obj == symbol2) {
                    ((BufferedChannel) c12017a).close(getCloseCause());
                    reentrantLock.unlock();
                    return c12017a;
                }
            }
            Object obj2 = this.f70686o;
            symbol = BroadcastChannelKt.f70690a;
            if (obj2 != symbol) {
                ((BufferedChannel) c12017a).mo74250trySendJP2dKIU(getValue());
            }
            this.f70685n = CollectionsKt___CollectionsKt.plus((Collection<? extends ReceiveChannel<E>>) this.f70685n, c12017a);
            reentrantLock.unlock();
            return c12017a;
        } catch (Throwable th2) {
            reentrantLock.unlock();
    ...
    public void registerSelectForSend(@NotNull SelectInstance<?> selectInstance, @Nullable Object obj) {
        ...
        reentrantLock.lock();
        try {
            Object remove = this.f70687p.remove(selectInstance);
            if (remove != null) {
            ...
            Unit unit = Unit.INSTANCE;
            reentrantLock.unlock();
            AbstractC1539Vc.m65885e(CoroutineScopeKt.CoroutineScope(selectInstance.getContext()), null, CoroutineStart.UNDISPATCHED, new BroadcastChannelImpl$registerSelectForSend$2(this, obj, selectInstance, null), 1, null);
        } finally {
            reentrantLock.unlock();
        }
    }
    ...
    */
    public java.lang.Object send(E r7, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        ...
        L3b:
            kotlin.ResultKt.throwOnFailure(r8)
            java.util.concurrent.locks.ReentrantLock r8 = r6.f70684m
            r8.lock()
            boolean r2 = r6.isClosedForSend()     // Catch: java.lang.Throwable -> L51
            if (r2 != 0) goto L99
            int r2 = r6.f70683l     // Catch: java.lang.Throwable -> L51
            r4 = -1
            if (r2 != r4) goto L53
            r6.f70686o = r7     // Catch: java.lang.Throwable -> L51
            goto L53
        L51:
            r7 = move-exception
            goto L9e
        L53:
            java.util.List r2 = r6.f70685n     // Catch: java.lang.Throwable -> L51
            r8.unlock()
    ...
    public String toString() {
        ...
        symbol = BroadcastChannelKt.f70690a;
        if (obj != symbol) {
            str = "CONFLATED_ELEMENT=" + this.f70686o + "; ";
        } else {
            str = "";
        }
        sb.append(str);
        ...
        sb.append(CollectionsKt___CollectionsKt.joinToString$default(this.f70685n, ";", "<", ">", 0, null, null, 56, null));
        return sb.toString();
    }
    ...
    public Object mo74250trySendJP2dKIU(E e) {
        ReentrantLock reentrantLock = this.f70684m;
        reentrantLock.lock();
        try {
            if (isClosedForSend()) {
                return super.mo74250trySendJP2dKIU(e);
            }
            List<BufferedChannel> list = this.f70685n;
            if (!(list instanceof Collection) || !list.isEmpty()) {
                for (BufferedChannel bufferedChannel : list) {
                    if (bufferedChannel.shouldSendSuspend$kotlinx_coroutines_core()) {
                        return ChannelResult.Companion.m74872failurePtdJZtk();
                    }
                }
            }
            if (this.f70683l == -1) {
            ...
            for (BufferedChannel bufferedChannel2 : this.f70685n) {
                bufferedChannel2.mo74250trySendJP2dKIU(e);
            }
