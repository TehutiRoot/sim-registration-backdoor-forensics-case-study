...
/* renamed from: th.co.dtac.android.dtacone.presenter.topup.ShowBalancePresenter$checkSubscriberPrepaid$2 */
/* loaded from: classes8.dex */
public final class ShowBalancePresenter$checkSubscriberPrepaid$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ ShowBalancePresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ShowBalancePresenter$checkSubscriberPrepaid$2(ShowBalancePresenter showBalancePresenter) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable it) {
        ...
        view.dismissLoading();
        serverErrorService = this.this$0.f86663c;
