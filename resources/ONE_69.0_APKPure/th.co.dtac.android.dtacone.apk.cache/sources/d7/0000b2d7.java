...
public final class ProcessDetailsProvider {
    ...
    /* renamed from: b */
    public static /* synthetic */ ProcessDetails m37629b(ProcessDetailsProvider processDetailsProvider, String str, int i, int i2, boolean z, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        return processDetailsProvider.m37630a(str, i, i2, z);
    }

    /* renamed from: a */
    public final ProcessDetails m37630a(String str, int i, int i2, boolean z) {
    ...
    public final ProcessDetails getCurrentProcessDetails(@NotNull Context context) {
        ...
        if (processDetails == null) {
            return m37629b(this, getProcessName$com_google_firebase_firebase_sessions(), myPid, 0, false, 12, null);
        }
    ...
    */
    public final java.lang.String getProcessName$com_google_firebase_firebase_sessions() {
        /*
            ...
            r1 = 33
            if (r0 < r1) goto L10
            java.lang.String r0 = p000.AbstractC18496So1.m66441a()
        ...
        L10:
            r1 = 28
            if (r0 < r1) goto L1b
            java.lang.String r0 = p000.AbstractC18626Uo1.m66091a()
            if (r0 == 0) goto L1b
            return r0
        L1b:
