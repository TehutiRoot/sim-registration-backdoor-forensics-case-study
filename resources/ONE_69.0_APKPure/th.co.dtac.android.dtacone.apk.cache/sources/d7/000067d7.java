...
public class Direct {
    ...
    /* renamed from: a */
    public static BasicMeasure.Measure f32667a = new BasicMeasure.Measure();

    /* renamed from: b */
    public static int f32668b = 0;

    /* renamed from: c */
    public static int f32669c = 0;

    /* renamed from: a */
    public static boolean m58534a(int i, ConstraintWidget constraintWidget) {
    ...
    /* renamed from: b */
    public static void m58533b(int i, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, boolean z) {
        boolean z2;
        ...
        if (!(constraintWidget instanceof ConstraintWidgetContainer) && constraintWidget.isMeasureRequested()) {
            int i2 = i + 1;
            if (m58534a(i2, constraintWidget)) {
        ...
        if (anchor.getDependents() != null && anchor.hasFinalValue()) {
            ...
            while (it.hasNext()) {
                ...
                int i3 = i + 1;
                boolean m58534a = m58534a(i3, constraintWidget2);
                if (constraintWidget2.isMeasureRequested() && m58534a) {
                ...
                if (horizontalDimensionBehaviour == dimensionBehaviour && !m58534a) {
                    if (constraintWidget2.getHorizontalDimensionBehaviour() == dimensionBehaviour && constraintWidget2.mMatchConstraintMaxWidth >= 0 && constraintWidget2.mMatchConstraintMinWidth >= 0 && ((constraintWidget2.getVisibility() == 8 || (constraintWidget2.mMatchConstraintDefaultWidth == 0 && constraintWidget2.getDimensionRatio() == 0.0f)) && !constraintWidget2.isInHorizontalChain() && !constraintWidget2.isInVirtualLayout() && z3 && !constraintWidget2.isInHorizontalChain())) {
                        m58530e(i3, constraintWidget, measurer, constraintWidget2, z);
                    }
                    ...
                    if (next == constraintAnchor5 && constraintWidget2.mRight.mTarget == null) {
                        ...
                        m58533b(i3, constraintWidget2, measurer, z);
                    } else {
                        ...
                        if (next == constraintAnchor6 && constraintAnchor5.mTarget == null) {
                            ...
                            m58531d(i3, measurer, constraintWidget2, z);
                        }
                    }
                }
            }
        ...
        if (anchor2.getDependents() != null && anchor2.hasFinalValue()) {
            ...
            while (it2.hasNext()) {
                ...
                int i4 = i + 1;
                boolean m58534a2 = m58534a(i4, constraintWidget3);
                if (constraintWidget3.isMeasureRequested() && m58534a2) {
                ...
                if (horizontalDimensionBehaviour2 == dimensionBehaviour2 && !m58534a2) {
                    if (constraintWidget3.getHorizontalDimensionBehaviour() == dimensionBehaviour2 && constraintWidget3.mMatchConstraintMaxWidth >= 0 && constraintWidget3.mMatchConstraintMinWidth >= 0 && (constraintWidget3.getVisibility() == 8 || (constraintWidget3.mMatchConstraintDefaultWidth == 0 && constraintWidget3.getDimensionRatio() == 0.0f))) {
                        if (!constraintWidget3.isInHorizontalChain() && !constraintWidget3.isInVirtualLayout() && z2 && !constraintWidget3.isInHorizontalChain()) {
                            m58530e(i4, constraintWidget, measurer, constraintWidget3, z);
                        }
                    }
                    ...
                    if (next2 == constraintAnchor7 && constraintWidget3.mRight.mTarget == null) {
                        ...
                        m58533b(i4, constraintWidget3, measurer, z);
                    } else {
                        ...
                        if (next2 == constraintAnchor8 && constraintAnchor7.mTarget == null) {
                            ...
                            m58531d(i4, measurer, constraintWidget3, z);
                        }
                    }
                }
            }
    ...
    /* renamed from: c */
    public static void m58532c(int i, Barrier barrier, BasicMeasure.Measurer measurer, int i2, boolean z) {
        if (barrier.allSolved()) {
            if (i2 == 0) {
                m58533b(i + 1, barrier, measurer, z);
            } else {
                m58527h(i + 1, barrier, measurer);
            }
        }
    }

    /* renamed from: d */
    public static void m58531d(int i, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget, boolean z) {
        float f;
        ...
        m58533b(i + 1, constraintWidget, measurer, z);
    }

    /* renamed from: e */
    public static void m58530e(int i, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget2, boolean z) {
        int width;
        ...
        if (finalValue2 >= finalValue) {
            ...
            m58533b(i + 1, constraintWidget2, measurer, z);
        }
    }

    /* renamed from: f */
    public static void m58529f(int i, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget) {
        float f;
        ...
        m58527h(i + 1, constraintWidget, measurer);
    }

    /* renamed from: g */
    public static void m58528g(int i, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget2) {
        int height;
        ...
        if (finalValue2 >= finalValue) {
            ...
            m58527h(i + 1, constraintWidget2, measurer);
        }
    }

    /* renamed from: h */
    public static void m58527h(int i, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer) {
        boolean z;
        ConstraintAnchor constraintAnchor;
        ConstraintAnchor constraintAnchor2;
        boolean z2;
        ...
        if (anchor.getDependents() != null && anchor.hasFinalValue()) {
            ...
            while (it.hasNext()) {
                ...
                ConstraintWidget.DimensionBehaviour dimensionBehaviour = ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT;
                if (verticalDimensionBehaviour == dimensionBehaviour && !m58534a) {
                    if (constraintWidget2.getVerticalDimensionBehaviour() == dimensionBehaviour && constraintWidget2.mMatchConstraintMaxHeight >= 0 && constraintWidget2.mMatchConstraintMinHeight >= 0 && (constraintWidget2.getVisibility() == 8 || (constraintWidget2.mMatchConstraintDefaultHeight == 0 && constraintWidget2.getDimensionRatio() == 0.0f))) {
                        if (!constraintWidget2.isInVerticalChain() && !constraintWidget2.isInVirtualLayout() && z2 && !constraintWidget2.isInVerticalChain()) {
                            m58528g(i3, constraintWidget, measurer, constraintWidget2);
                        }
                    }
                } else if (!constraintWidget2.isMeasureRequested()) {
                    ...
                    if (next == constraintAnchor5 && constraintWidget2.mBottom.mTarget == null) {
                        ...
                        m58527h(i3, constraintWidget2, measurer);
                    } else {
                        ...
                        if (next == constraintAnchor6 && constraintAnchor5.mTarget == null) {
                            ...
                            m58529f(i3, measurer, constraintWidget2);
                        }
                    }
                }
            }
        ...
        if (anchor2.getDependents() != null && anchor2.hasFinalValue()) {
            ...
            while (it2.hasNext()) {
                ...
                ConstraintWidget.DimensionBehaviour dimensionBehaviour2 = ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT;
                if (verticalDimensionBehaviour2 == dimensionBehaviour2 && !m58534a2) {
                    if (constraintWidget3.getVerticalDimensionBehaviour() == dimensionBehaviour2 && constraintWidget3.mMatchConstraintMaxHeight >= 0 && constraintWidget3.mMatchConstraintMinHeight >= 0 && (constraintWidget3.getVisibility() == 8 || (constraintWidget3.mMatchConstraintDefaultHeight == 0 && constraintWidget3.getDimensionRatio() == 0.0f))) {
                        if (!constraintWidget3.isInVerticalChain() && !constraintWidget3.isInVirtualLayout() && z && !constraintWidget3.isInVerticalChain()) {
                            m58528g(i4, constraintWidget, measurer, constraintWidget3);
                        }
                    }
                } else if (!constraintWidget3.isMeasureRequested()) {
                    ...
                    if (next2 == constraintAnchor7 && constraintWidget3.mBottom.mTarget == null) {
                        ...
                        m58527h(i4, constraintWidget3, measurer);
                    } else {
                        ...
                        if (next2 == constraintAnchor8 && constraintAnchor7.mTarget == null) {
                            ...
                            m58529f(i4, measurer, constraintWidget3);
                        }
                    }
                }
            }
        ...
        if (anchor3.getDependents() != null && anchor3.hasFinalValue()) {
            ...
            while (it3.hasNext()) {
                ...
                int i5 = i + 1;
                boolean m58534a3 = m58534a(i5, constraintWidget4);
                if (constraintWidget4.isMeasureRequested() && m58534a3) {
                ...
                if (constraintWidget4.getVerticalDimensionBehaviour() != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT || m58534a3) {
                    if (!constraintWidget4.isMeasureRequested() && next3 == constraintWidget4.mBaseline) {
                        ...
                        m58527h(i5, constraintWidget4, measurer);
                    }
                }
            }
        }
    ...
    /* renamed from: ls */
    public static String m58526ls(int i) {
    ...
    */
    ...
    public static void solvingPass(ConstraintWidgetContainer constraintWidgetContainer, BasicMeasure.Measurer measurer) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (constraintWidget2 instanceof Guideline) {
                    ...
                    if (guideline2.getOrientation() == 1) {
                        m58533b(0, guideline2, measurer, isRtl);
                    }
                }
            }
        }
        m58533b(0, constraintWidgetContainer, measurer, isRtl);
        if (z2) {
            for (int i4 = 0; i4 < size; i4++) {
                ...
                if (constraintWidget3 instanceof Barrier) {
                    ...
                    if (barrier.getOrientation() == 0) {
                        m58532c(0, barrier, measurer, 0, isRtl);
                    }
                }
            }
        }
            ...
            for (int i6 = 0; i6 < size; i6++) {
                ...
                if (constraintWidget5 instanceof Guideline) {
                    ...
                    if (guideline4.getOrientation() == 0) {
                        m58527h(1, guideline4, measurer);
                    }
                }
            }
        }
        m58527h(0, constraintWidgetContainer, measurer);
        if (z4) {
            for (int i7 = 0; i7 < size; i7++) {
                ...
                if (constraintWidget6 instanceof Barrier) {
                    ...
                    if (barrier2.getOrientation() == 1) {
                        m58532c(0, barrier2, measurer, 1, isRtl);
                    }
                }
            }
        }
        for (int i8 = 0; i8 < size; i8++) {
            ...
            if (constraintWidget7.isMeasureRequested() && m58534a(0, constraintWidget7)) {
                ConstraintWidgetContainer.measure(0, constraintWidget7, measurer, f32667a, BasicMeasure.Measure.SELF_DIMENSIONS);
                if (constraintWidget7 instanceof Guideline) {
                    if (((Guideline) constraintWidget7).getOrientation() == 0) {
                        m58527h(0, constraintWidget7, measurer);
                    } else {
                        m58533b(0, constraintWidget7, measurer, isRtl);
                    }
                } else {
                    m58533b(0, constraintWidget7, measurer, isRtl);
                    m58527h(0, constraintWidget7, measurer);
