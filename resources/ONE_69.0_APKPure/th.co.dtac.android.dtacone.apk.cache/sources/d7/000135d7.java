...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.online_activation.viewModel.OneOnlineActivationViewModel$verifyOTP$3 */
/* loaded from: classes10.dex */
public final class OneOnlineActivationViewModel$verifyOTP$3 extends Lambda implements Function1<OneCommonResponse, Unit> {
    final /* synthetic */ OneOnlineActivationViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneOnlineActivationViewModel$verifyOTP$3(OneOnlineActivationViewModel oneOnlineActivationViewModel) {
        super(1);
    ...
    public final void invoke2(OneCommonResponse oneCommonResponse) {
        ...
        mutableLiveData = this.this$0.f93019h;
