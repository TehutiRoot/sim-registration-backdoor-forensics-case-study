...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.change_owner.repository.OneChangeOwnerRepository$getPostCodeInfo$1 */
/* loaded from: classes10.dex */
public final class OneChangeOwnerRepository$getPostCodeInfo$1 extends Lambda implements Function1<GetPostCodeInfoResponse, Unit> {
    final /* synthetic */ OneChangeOwnerRepository this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneChangeOwnerRepository$getPostCodeInfo$1(OneChangeOwnerRepository oneChangeOwnerRepository) {
        super(1);
    ...
    public final void invoke2(@NotNull GetPostCodeInfoResponse response) {
        ...
        if (!response.getData().isEmpty()) {
            ...
            OneChangeOwnerRepository oneChangeOwnerRepository = this.this$0;
            Data data = (Data) first;
            oneChangeOwnerRepository.getModel().setPostcode(data.getPostcode());
            oneChangeOwnerRepository.getModel().setPostcodeSequence(String.valueOf(data.getPostcodeSequence()));
        }
    }
}