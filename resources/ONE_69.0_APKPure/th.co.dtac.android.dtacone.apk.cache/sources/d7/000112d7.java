...
public class OneCustomDialogBox extends AppCompatDialog {
    ...
    /* renamed from: g */
    public final Callback f83012g;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final int $stable = 8;

    @Metadata(m29143d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\b\u0010\u0002\u001a\u00020\u0003H&¨\u0006\u0004"}, m29142d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/dialog/OneCustomDialogBox$Callback;", "", "onButtonClick", "", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    @Metadata(m29143d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002¨\u0006\u0003"}, m29142d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/dialog/OneCustomDialogBox$Companion;", "", "()V", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    public OneCustomDialogBox(@NotNull Context mContext, boolean z, @Nullable DialogInterface.OnCancelListener onCancelListener, @Nullable Callback callback) {
        ...
        this.f83011f = mContext;
        this.f83012g = callback;
        requestWindowFeature(1);
        setContentView(R.layout.one_alert_box);
    }

    /* renamed from: f */
    public static /* synthetic */ void m19980f(OneCustomDialogBox oneCustomDialogBox, View view) {
        m19978h(oneCustomDialogBox, view);
    }

    /* renamed from: g */
    public static /* synthetic */ void m19979g(OneCustomDialogBox oneCustomDialogBox, View view) {
        m19977i(oneCustomDialogBox, view);
    }

    /* renamed from: h */
    public static final void m19978h(OneCustomDialogBox this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Callback callback = this$0.f83012g;
        if (callback != null) {
    ...
    /* renamed from: i */
    public static final void m19977i(OneCustomDialogBox this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.dismiss();
    }
        ...
        if (button != null) {
            button.setOnClickListener(new View.OnClickListener() { // from class: OO0
                ...
                public final void onClick(View view) {
                    OneCustomDialogBox.m19980f(OneCustomDialogBox.this, view);
                }
            });
        }
        if (oneFontButton != null) {
            oneFontButton.setOnClickListener(new View.OnClickListener() { // from class: PO0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    OneCustomDialogBox.m19979g(OneCustomDialogBox.this, view);
                }
            });
        }
    }
