...
public final class DenseImmutableTable<R, C, V> extends RegularImmutableTable<R, C, V> {
    ...
    public static abstract class ImmutableArrayMap<K, V> extends ImmutableMap.IteratorBasedImmutableMap<K, V> {
        ...
        /* loaded from: classes4.dex */
        public class C7587a extends AbstractIterator {

            /* renamed from: c */
            public int f53107c = -1;

            /* renamed from: d */
            public final int f53108d;

            public C7587a() {
                this.f53108d = ImmutableArrayMap.this.keyToIndex().size();
            }
            ...
            public Map.Entry computeNext() {
                ...
                while (true) {
                    ...
                    if (i2 < this.f53108d) {
                        ...
                        if (value != null) {
                            return Maps.immutableEntry(ImmutableArrayMap.this.getKey(this.f53107c), value);
                        }
                        i = this.f53107c;
                    } else {
    ...
    public DenseImmutableTable(ImmutableList<Table.Cell<R, C, V>> immutableList, ImmutableSet<R> immutableSet, ImmutableSet<C> immutableSet2) {
        ...
        ImmutableMap<R, Integer> m40676u = Maps.m40676u(immutableSet);
        this.rowKeyToIndex = m40676u;
        ImmutableMap<C, Integer> m40676u2 = Maps.m40676u(immutableSet2);
        this.columnKeyToIndex = m40676u2;
        this.rowCounts = new int[m40676u.size()];
        this.columnCounts = new int[m40676u2.size()];
    ...
    @Override // com.google.common.collect.ImmutableTable, com.google.common.collect.AbstractC7948e, com.google.common.collect.Table
    @CheckForNull
