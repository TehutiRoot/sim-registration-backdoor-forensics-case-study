...
public final class FlowableOnErrorNext<T> extends AbstractC0558I {
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        OnErrorNextSubscriber onErrorNextSubscriber = new OnErrorNextSubscriber(subscriber, this.f64471b, this.f64472c);
