...
public abstract class zzrz<ResultType> implements Closeable {
    ...
    /* renamed from: a */
    public final zzsc f46017a;

    /* renamed from: b */
    public final zzku f46018b;

    /* renamed from: c */
    public final zzqj f46019c;

    /* renamed from: d */
    public final zzkz f46020d;
    ...
    public final Task<ResultType> zza(@NonNull FirebaseVisionImage firebaseVisionImage) {
        ...
        return this.f46019c.zza((zzqc<T, zzsc>) this.f46017a, (zzsc) new zzsa((byte[]) zze.first, ((Float) zze.second).floatValue(), Collections.singletonList(this.f46018b), this.f46020d));
    }
    ...
    public zzrz(zzqn zzqnVar, zzku zzkuVar, zzkz zzkzVar, boolean z) {
        ...
        this.f46018b = (zzku) Preconditions.checkNotNull(zzkuVar);
        this.f46019c = zzqj.zza(zzqnVar);
        this.f46017a = new zzsc(this, zzqnVar.zzos(), z);
        this.zzbms = zzqnVar;
        this.f46020d = zzkzVar;
    }
}