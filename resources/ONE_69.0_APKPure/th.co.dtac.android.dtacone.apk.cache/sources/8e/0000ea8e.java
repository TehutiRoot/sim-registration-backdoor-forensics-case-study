...
public class ViewFinderView extends View implements IViewFinder {
    ...
    /* renamed from: h */
    public static final int[] f72063h = {0, 64, 128, CertificateHolderAuthorization.CVCA, 255, CertificateHolderAuthorization.CVCA, 128, 64};
    ...
    /* renamed from: e */
    public final int f72068e;

    /* renamed from: f */
    public final int f72069f;

    /* renamed from: g */
    public final int f72070g;
    ...
    public ViewFinderView(Context context) {
        super(context);
        this.f72066c = getResources().getColor(R.color.viewfinder_laser);
        this.f72067d = getResources().getColor(R.color.viewfinder_mask);
        this.f72068e = getResources().getColor(R.color.viewfinder_border);
        this.f72069f = getResources().getInteger(R.integer.viewfinder_border_width);
        this.f72070g = getResources().getInteger(R.integer.viewfinder_border_length);
        m26605a();
    }

    /* renamed from: a */
    public final void m26605a() {
        Paint paint = new Paint();
        this.mLaserPaint = paint;
        paint.setColor(this.f72066c);
        this.mLaserPaint.setStyle(Paint.Style.FILL);
        Paint paint2 = new Paint();
        this.mFinderMaskPaint = paint2;
        paint2.setColor(this.f72067d);
        Paint paint3 = new Paint();
        this.mBorderPaint = paint3;
        paint3.setColor(this.f72068e);
        this.mBorderPaint.setStyle(Paint.Style.STROKE);
        this.mBorderPaint.setStrokeWidth(this.f72069f);
        this.mBorderLineLength = this.f72070g;
    }
    ...
    public void drawLaser(Canvas canvas) {
        ...
        int[] iArr = f72063h;
        paint.setAlpha(iArr[this.f72065b]);
        this.f72065b = (this.f72065b + 1) % iArr.length;
    ...
    public synchronized void updateFramingRect() {
        ...
        try {
            ...
            int i2 = i / 2;
            int i3 = (point.y - i2) / 2;
            this.f72064a = new Rect(0, i3, point.x, i2 + i3);
        } catch (Throwable th2) {
            throw th2;
        }
    }
