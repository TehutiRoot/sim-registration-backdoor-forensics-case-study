...
public class ConfigAutoFetch {
    ...
    /* renamed from: a */
    public final Set f56362a;

    /* renamed from: b */
    public final HttpURLConnection f56363b;

    /* renamed from: c */
    public final ConfigFetchHandler f56364c;

    /* renamed from: d */
    public final ConfigCacheClient f56365d;

    /* renamed from: e */
    public final ConfigUpdateListener f56366e;

    /* renamed from: f */
    public final ScheduledExecutorService f56367f;

    /* renamed from: g */
    public final Random f56368g = new Random();
    ...
    public class RunnableC8619a implements Runnable {
        ...
        /* renamed from: b */
        public final /* synthetic */ long f56370b;

        public RunnableC8619a(int i, long j) {
            this.f56369a = i;
            this.f56370b = j;
        }
        ...
        public void run() {
            ConfigAutoFetch.this.fetchLatestConfig(this.f56369a, this.f56370b);
        }
    }
    ...
    public ConfigAutoFetch(HttpURLConnection httpURLConnection, ConfigFetchHandler configFetchHandler, ConfigCacheClient configCacheClient, Set<ConfigUpdateListener> set, ConfigUpdateListener configUpdateListener, ScheduledExecutorService scheduledExecutorService) {
        this.f56363b = httpURLConnection;
        this.f56364c = configFetchHandler;
        this.f56365d = configCacheClient;
        this.f56362a = set;
        this.f56366e = configUpdateListener;
        this.f56367f = scheduledExecutorService;
    }

    /* renamed from: d */
    public static Boolean m37765d(ConfigFetchHandler.FetchResponse fetchResponse, long j) {
        boolean z = false;
    ...
    /* renamed from: b */
    public final void m37767b(int i, long j) {
        if (i == 0) {
            m37760i(new FirebaseRemoteConfigServerException("Unable to fetch the latest version of the template.", FirebaseRemoteConfigException.Code.CONFIG_UPDATE_NOT_FETCHED));
            return;
        }
        this.f56367f.schedule(new RunnableC8619a(i, j), this.f56368g.nextInt(4), TimeUnit.SECONDS);
    }

    /* renamed from: c */
    public final synchronized void m37766c(ConfigUpdate configUpdate) {
        for (ConfigUpdateListener configUpdateListener : this.f56362a) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:15:0x004c, code lost:
        r9.f56366e.onError(new com.google.firebase.remoteconfig.FirebaseRemoteConfigServerException("The server is temporarily unavailable. Try again in a few minutes.", com.google.firebase.remoteconfig.FirebaseRemoteConfigException.Code.CONFIG_UPDATE_UNAVAILABLE));
     */
    /* JADX WARN: Code restructure failed: missing block: B:19:0x0061, code lost:
        if (m37763f() == false) goto L25;
     */
    /* JADX WARN: Code restructure failed: missing block: B:22:0x0068, code lost:
        if (r5.has("latestTemplateVersionNumber") == false) goto L35;
     */
    /* JADX WARN: Code restructure failed: missing block: B:23:0x006a, code lost:
        r6 = r9.f56364c.getTemplateVersionNumber();
    ...
    */
    public final void m37764e(java.io.InputStream r10) {
        /*
            r9 = this;
        ...
        L13:
            ...
            if (r5 == 0) goto L13
            java.lang.String r4 = r9.m37761h(r4)
        ...
        L3b:
            ...
            if (r4 == 0) goto L5d
            com.google.firebase.remoteconfig.ConfigUpdateListener r4 = r9.f56366e     // Catch: org.json.JSONException -> L5b
        ...
        L5b:
            ...
            goto L7d
        L5d:
            boolean r4 = r9.m37763f()     // Catch: org.json.JSONException -> L5b
            if (r4 == 0) goto L64
            goto L8e
        L64:
            boolean r4 = r5.has(r0)     // Catch: org.json.JSONException -> L5b
            if (r4 == 0) goto L12
            com.google.firebase.remoteconfig.internal.ConfigFetchHandler r4 = r9.f56364c     // Catch: org.json.JSONException -> L5b
            ...
            if (r8 <= 0) goto L12
            r6 = 3
            r9.m37767b(r6, r4)     // Catch: org.json.JSONException -> L5b
            goto L12
        L7d:
        ...
        L8e:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.remoteconfig.internal.ConfigAutoFetch.m37764e(java.io.InputStream):void");
    }

    /* renamed from: f */
    public final synchronized boolean m37763f() {
        return this.f56362a.isEmpty();
    }
    ...
    public synchronized Task<Void> fetchLatestConfig(int i, final long j) {
        ...
        i2 = i - 1;
        fetchNowWithTypeAndAttemptNumber = this.f56364c.fetchNowWithTypeAndAttemptNumber(ConfigFetchHandler.FetchType.REALTIME, 3 - i2);
        task = this.f56365d.get();
        return Tasks.whenAllComplete(fetchNowWithTypeAndAttemptNumber, task).continueWithTask(this.f56367f, new Continuation() { // from class: lw
            @Override // com.google.android.gms.tasks.Continuation
            public final Object then(Task task2) {
                Task m37762g;
                m37762g = ConfigAutoFetch.this.m37762g(fetchNowWithTypeAndAttemptNumber, task, j, i2, task2);
                return m37762g;
            }
        });
    }
    ...
    /* renamed from: g */
    public final /* synthetic */ Task m37762g(Task task, Task task2, long j, int i, Task task3) {
        ...
        if (!m37765d(fetchResponse, j).booleanValue()) {
            m37767b(i, j);
            ...
            m37766c(ConfigUpdate.create(changedParams));
            return Tasks.forResult(null);
        }
    }

    /* renamed from: h */
    public final String m37761h(String str) {
    ...
    /* renamed from: i */
    public final synchronized void m37760i(FirebaseRemoteConfigException firebaseRemoteConfigException) {
        for (ConfigUpdateListener configUpdateListener : this.f56362a) {
    ...
    public void listenForNotifications() {
        HttpURLConnection httpURLConnection = this.f56363b;
