...
/* renamed from: th.co.dtac.android.dtacone.view.fragment.eSIM.postpaid.sim.ESimPostpaidScanSimFragment$onStart$1$4 */
/* loaded from: classes9.dex */
public final class ESimPostpaidScanSimFragment$onStart$1$4 extends Lambda implements Function1<StatusResource, Unit> {
    final /* synthetic */ ESimPostpaidScanSimFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimPostpaidScanSimFragment$onStart$1$4(ESimPostpaidScanSimFragment eSimPostpaidScanSimFragment) {
        super(1);
    ...
    public final void invoke2(StatusResource statusResource) {
        this.this$0.m7013r(statusResource);
    }
}