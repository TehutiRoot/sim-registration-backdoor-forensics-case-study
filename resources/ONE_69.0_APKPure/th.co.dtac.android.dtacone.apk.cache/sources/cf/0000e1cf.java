...
public final class C11941xaf8327b7 extends Lambda implements Function1<Name, ClassDescriptor> {
    ...
    public C11941xaf8327b7(DeserializedClassDescriptor.EnumEntryClassDescriptors enumEntryClassDescriptors, DeserializedClassDescriptor deserializedClassDescriptor) {
        super(1);
    ...
    public final ClassDescriptor invoke(@NotNull Name name) {
        ...
        if (enumEntry != null) {
            ...
            notNullLazyValue = enumEntryClassDescriptors.f70155c;
            return EnumEntrySyntheticClassDescriptor.create(storageManager, deserializedClassDescriptor, name, notNullLazyValue, new DeserializedAnnotations(deserializedClassDescriptor.getC().getStorageManager(), new C11942x65bb8e11(deserializedClassDescriptor, enumEntry)), SourceElement.NO_SOURCE);
        }
        return null;
    }
}