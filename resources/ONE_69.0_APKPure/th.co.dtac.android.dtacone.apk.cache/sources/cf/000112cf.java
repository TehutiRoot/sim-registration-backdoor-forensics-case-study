...
public final class OneActivateSimErrorDialogBox extends AppCompatDialog {
    ...
    /* renamed from: f */
    public final Context f83003f;

    /* renamed from: g */
    public final Callback f83004g;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final int $stable = 8;

    @Metadata(m29143d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\b\u0010\u0002\u001a\u00020\u0003H&¨\u0006\u0004"}, m29142d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/dialog/OneActivateSimErrorDialogBox$Callback;", "", "onButtonClick", "", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    @Metadata(m29143d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002¨\u0006\u0003"}, m29142d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/dialog/OneActivateSimErrorDialogBox$Companion;", "", "()V", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    /* renamed from: f */
    public static /* synthetic */ void m19983f(OneActivateSimErrorDialogBox oneActivateSimErrorDialogBox, View view) {
        m19982g(oneActivateSimErrorDialogBox, view);
    }

    /* renamed from: g */
    public static final void m19982g(OneActivateSimErrorDialogBox this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Callback callback = this$0.f83004g;
        if (callback != null) {
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        if (oneFontButton != null) {
            oneFontButton.setOnClickListener(new View.OnClickListener() { // from class: GK0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    OneActivateSimErrorDialogBox.m19983f(OneActivateSimErrorDialogBox.this, view);
                }
            });
        }
    }
    ...
    public OneActivateSimErrorDialogBox(@NotNull Context mContext, boolean z, @Nullable DialogInterface.OnCancelListener onCancelListener, @Nullable Callback callback) {
        ...
        this.f83003f = mContext;
        this.f83004g = callback;
