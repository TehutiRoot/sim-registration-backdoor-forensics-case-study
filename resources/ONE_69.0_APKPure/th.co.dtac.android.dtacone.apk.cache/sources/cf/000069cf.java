...
public final class PackageInfoCompat {
    ...
    public static class C3951a {
        ...
        @DoNotInline
        /* renamed from: a */
        public static Signature[] m57402a(@NonNull SigningInfo signingInfo) {
            return signingInfo.getApkContentsSigners();
        }

        @DoNotInline
        /* renamed from: b */
        public static long m57401b(PackageInfo packageInfo) {
        ...
        @DoNotInline
        /* renamed from: c */
        public static Signature[] m57400c(@NonNull SigningInfo signingInfo) {
            return signingInfo.getSigningCertificateHistory();
        }

        @DoNotInline
        /* renamed from: d */
        public static boolean m57399d(@NonNull SigningInfo signingInfo) {
            return signingInfo.hasMultipleSigners();
        }

        @DoNotInline
        /* renamed from: e */
        public static boolean m57398e(@NonNull PackageManager packageManager, @NonNull String str, @NonNull byte[] bArr, int i) {
            return packageManager.hasSigningCertificate(str, bArr, i);
        }
    }

    /* renamed from: a */
    public static boolean m57404a(byte[][] bArr, byte[] bArr2) {
        for (byte[] bArr3 : bArr) {
    ...
    /* renamed from: b */
    public static byte[] m57403b(byte[] bArr) {
        try {
    ...
    public static long getLongVersionCode(@NonNull PackageInfo packageInfo) {
        if (Build.VERSION.SDK_INT >= 28) {
            return C3951a.m57401b(packageInfo);
        }
    ...
    public static List<Signature> getSignatures(@NonNull PackageManager packageManager, @NonNull String str) throws PackageManager.NameNotFoundException {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (C3951a.m57399d(signingInfo)) {
                signatureArr = C3951a.m57402a(signingInfo);
            } else {
                signatureArr = C3951a.m57400c(signingInfo);
            }
        } else {
    ...
    public static boolean hasSignatures(@NonNull PackageManager packageManager, @NonNull String str, @NonNull @Size(min = 1) Map<byte[], Integer> map, boolean z) throws PackageManager.NameNotFoundException {
        ...
        if (!z && Build.VERSION.SDK_INT >= 28) {
            for (byte[] bArr3 : keySet) {
                if (!C3951a.m57398e(packageManager, str, bArr3, map.get(bArr3).intValue())) {
                    return false;
                }
            }
            return true;
        ...
        if (signatures.size() != 0 && map.size() <= signatures.size() && (!z || map.size() == signatures.size())) {
            if (map.containsValue(1)) {
                ...
                for (int i = 0; i < signatures.size(); i++) {
                    bArr[i] = m57403b(signatures.get(i).toByteArray());
                }
            } else {
                bArr = null;
            }
