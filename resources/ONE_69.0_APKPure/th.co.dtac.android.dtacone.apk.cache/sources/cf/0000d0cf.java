...
public final class MaybeObserveOn<T> extends AbstractC1707Y {

    /* renamed from: a */
    public final Scheduler f64916a;
    ...
    public MaybeObserveOn(MaybeSource<T> maybeSource, Scheduler scheduler) {
        super(maybeSource);
        this.f64916a = scheduler;
    }

    @Override // io.reactivex.Maybe
    public void subscribeActual(MaybeObserver<? super T> maybeObserver) {
        this.source.subscribe(new ObserveOnMaybeObserver(maybeObserver, this.f64916a));
    }
}