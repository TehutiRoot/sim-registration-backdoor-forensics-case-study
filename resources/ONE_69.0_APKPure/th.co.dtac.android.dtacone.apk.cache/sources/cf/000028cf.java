...
@Metadata(m29143d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n¢\u0006\u0004\b\u0004\u0010\u0005"}, m29142d2 = {"<anonymous>", "", TypedValues.CycleType.S_WAVE_OFFSET, "Landroidx/compose/ui/geometry/Offset;", "invoke-k-4lQ0M", "(J)V"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
...
public final class CoreTextFieldKt$CoreTextField$pointerModifier$1 extends Lambda implements Function1<Offset, Unit> {
    ...
    public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
        m69915invokek4lQ0M(offset.m71696unboximpl());
        return Unit.INSTANCE;
    }

    /* renamed from: invoke-k-4lQ0M  reason: not valid java name */
    public final void m69915invokek4lQ0M(long j) {
        ...
        if (this.$state.getHasFocus()) {
            if (this.$state.getHandleState() != HandleState.Selection) {
                ...
                if (layoutResult != null) {
                    ...
                    TextFieldDelegate.Companion.m69968setCursorOffsetULxng0E$foundation_release(j, layoutResult, textFieldState.getProcessor(), this.$offsetMapping, textFieldState.getOnValueChange());
            ...
            this.$manager.m70074deselect_kEHs6E$foundation_release(Offset.m71675boximpl(j));
        }
    }
}