...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.viewmodel.OnePostpaidRegistrationViewModel$getPropositionRebate$3 */
/* loaded from: classes10.dex */
public final class OnePostpaidRegistrationViewModel$getPropositionRebate$3 extends Lambda implements Function1<OnePropositionRebateResponse, Unit> {
    final /* synthetic */ OnePostpaidRegistrationViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidRegistrationViewModel$getPropositionRebate$3(OnePostpaidRegistrationViewModel onePostpaidRegistrationViewModel) {
        super(1);
    ...
    public final void invoke2(OnePropositionRebateResponse onePropositionRebateResponse) {
        ...
        onePostpaidRepository.getModel().setPropositionRebateResponse(onePropositionRebateResponse.getData());
        ...
        m11600h2.setValue(new Event(new FragmentNavEvent(OnePostpaidTruePackageListFragment.class, null, null, 4, null)));
    }
}