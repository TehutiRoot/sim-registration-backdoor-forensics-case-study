...
public class TransitionBuilder {
    /* renamed from: a */
    public static void m58186a(MotionScene motionScene, MotionScene.Transition transition, ConstraintSet constraintSet, ConstraintSet constraintSet2) {
    ...
    public static MotionScene.Transition buildTransition(MotionScene motionScene, int i, int i2, ConstraintSet constraintSet, int i3, ConstraintSet constraintSet2) {
        ...
        m58186a(motionScene, transition, constraintSet, constraintSet2);
        return transition;
    }
    ...
    public static void validate(MotionLayout motionLayout) {
        ...
        if (motionScene != null) {
            if (motionScene.validateLayout(motionLayout)) {
                if (motionScene.f33046c != null && !motionScene.getDefinedTransitions().isEmpty()) {
                    return;
                }
