...
/* renamed from: th.co.dtac.android.dtacone.rx.RxBitmap$applySaveBitmap$1$1 */
/* loaded from: classes8.dex */
public final class RxBitmap$applySaveBitmap$1$1 extends Lambda implements Function1<BitmapCollection, ObservableSource<? extends BitmapCollection>> {
    final /* synthetic */ RxBitmap this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RxBitmap$applySaveBitmap$1$1(RxBitmap rxBitmap) {
        super(1);
    ...
    public static final BitmapCollection invoke$lambda$0(BitmapCollection bitmap, RxBitmap this$0) {
        ...
        if (Intrinsics.areEqual(bitmap.getName(), BitmapUtil.IMAGE_ID_CARD) || Intrinsics.areEqual(bitmap.getName(), BitmapUtil.IMAGE_ID_CARD_WITH_WATERMARK) || Intrinsics.areEqual(bitmap.getName(), BitmapUtil.IMAGE_ATTORNEY_ID_CARD) || Intrinsics.areEqual(bitmap.getName(), BitmapUtil.IMAGE_ATTORNEY_ID_CARD_WITH_WATERMARK) || Intrinsics.areEqual(bitmap.getName(), BitmapUtil.IMAGE_COMPARE) || Intrinsics.areEqual(bitmap.getName(), BitmapUtil.IMAGE_COMPARE_WATERMARK)) {
            ...
            byte[] cropImage = bitmapUtil.cropImage(bitmap3);
    ...
    public final ObservableSource<? extends BitmapCollection> invoke(@NotNull final BitmapCollection bitmap) {
        ...
        return Observable.fromCallable(new Callable() { // from class: th.co.dtac.android.dtacone.rx.b
            @Override // java.util.concurrent.Callable
            public final Object call() {
                BitmapCollection invoke$lambda$0;
                invoke$lambda$0 = RxBitmap$applySaveBitmap$1$1.invoke$lambda$0(BitmapCollection.this, rxBitmap);
