...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.esim.ESimPostpaidViewModel$checkSimStock$3 */
/* loaded from: classes9.dex */
public final class ESimPostpaidViewModel$checkSimStock$3 extends Lambda implements Function1<SimTermSukCheckSimStockResponse, Unit> {
    final /* synthetic */ ESimPostpaidViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimPostpaidViewModel$checkSimStock$3(ESimPostpaidViewModel eSimPostpaidViewModel) {
        super(1);
