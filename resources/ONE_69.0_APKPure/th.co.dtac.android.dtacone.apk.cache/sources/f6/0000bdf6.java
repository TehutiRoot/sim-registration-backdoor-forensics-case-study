...
public class setClipBounds implements setDarkTextColor.valueOf {
    private final setDarkTextColor ThreeDS2Service;

    public setClipBounds(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.getSDKReferenceNumber(this.ThreeDS2Service);
    }
}