...
public class DefaultNameProvider implements NameProvider {
    ...
    /* renamed from: a */
    public HashMap f76453a = m23969a();

    /* renamed from: b */
    public HashMap f76454b = m23969a();

    /* renamed from: a */
    public final HashMap m23969a() {
        return new HashMap(7);
    }

    /* renamed from: b */
    public final synchronized String[] m23968b(Locale locale, String str, String str2) {
        Object[] objArr;
        Object[] objArr2 = null;
        ...
        try {
            Map map = (Map) this.f76453a.get(locale);
            if (map == null) {
                HashMap hashMap = this.f76453a;
                HashMap m23969a = m23969a();
                hashMap.put(locale, m23969a);
                map = m23969a;
            }
    ...
    /* renamed from: c */
    public final synchronized String[] m23967c(Locale locale, String str, String str2, boolean z) {
        String[] strArr;
        String[] strArr2 = null;
        if (locale == null || str == null || str2 == null) {
            return null;
        ...
        try {
            ...
            Map map = (Map) this.f76454b.get(locale);
            if (map == null) {
                HashMap hashMap = this.f76454b;
                HashMap m23969a = m23969a();
                hashMap.put(locale, m23969a);
                map = m23969a;
            }
    ...
    public String getName(Locale locale, String str, String str2) {
        String[] m23968b = m23968b(locale, str, str2);
        if (m23968b == null) {
            return null;
        }
        return m23968b[1];
    ...
    public String getName(Locale locale, String str, String str2, boolean z) {
        String[] m23967c = m23967c(locale, str, str2, z);
        if (m23967c == null) {
            return null;
        }
        return m23967c[1];
