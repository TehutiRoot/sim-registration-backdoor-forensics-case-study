...
public final class CommissionSummaryAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    /* renamed from: a */
    public final List f81536a;

    /* renamed from: b */
    public final OnClickItemListener f81537b;

    @Metadata(m29143d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&¨\u0006\u0006"}, m29142d2 = {"Lth/co/dtac/android/dtacone/adapter/report/CommissionSummaryAdapter$OnClickItemListener;", "", "onClickCommission", "", "commission", "Lth/co/dtac/android/dtacone/model/rtr_performance/ProfitSummaryReport$Data$Commission;", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    public static final class ViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: a */
        public final RvCommissionReportItemBinding f81538a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public ViewHolder(@NotNull RvCommissionReportItemBinding binding) {
            super(binding.getRoot());
            Intrinsics.checkNotNullParameter(binding, "binding");
            this.f81538a = binding;
        }

        public final void bind(@NotNull ProfitSummaryReport.Data.Commission item) {
            Intrinsics.checkNotNullParameter(item, "item");
            this.f81538a.tvCommissionHeader.setText(item.getCommissionHeaderLabel());
            this.f81538a.tvCommissionRemark.setText(item.getCommissionRemarkLabel());
            this.f81538a.tvCommission.setText(item.getCommission());
            this.f81538a.tvCommissionDisplayLabel.setText(item.getDisplayLabel1());
        }
    }
    ...
    public CommissionSummaryAdapter(@NotNull List<ProfitSummaryReport.Data.Commission> items, @NotNull OnClickItemListener onClickItemListener) {
        ...
        this.f81536a = items;
        this.f81537b = onClickItemListener;
    }

    /* renamed from: a */
    public static /* synthetic */ void m20439a(CommissionSummaryAdapter commissionSummaryAdapter, int i, View view) {
        m20438b(commissionSummaryAdapter, i, view);
    }

    /* renamed from: b */
    public static final void m20438b(CommissionSummaryAdapter this$0, int i, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.f81537b.onClickCommission((ProfitSummaryReport.Data.Commission) this$0.f81536a.get(i));
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemCount() {
        return this.f81536a.size();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public void onBindViewHolder(@NotNull ViewHolder viewHolder, final int i) {
        Intrinsics.checkNotNullParameter(viewHolder, "viewHolder");
        viewHolder.bind((ProfitSummaryReport.Data.Commission) this.f81536a.get(i));
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: fu
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                CommissionSummaryAdapter.m20439a(CommissionSummaryAdapter.this, i, view);
            }
        });
    }
