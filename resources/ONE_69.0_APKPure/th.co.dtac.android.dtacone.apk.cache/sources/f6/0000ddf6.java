...
public final class ReflectKotlinClassFinder implements KotlinClassFinder {
    ...
    /* renamed from: a */
    public final ClassLoader f68910a;

    /* renamed from: b */
    public final BuiltInsResourceLoader f68911b;

    public ReflectKotlinClassFinder(@NotNull ClassLoader classLoader) {
        Intrinsics.checkNotNullParameter(classLoader, "classLoader");
        this.f68910a = classLoader;
        this.f68911b = new BuiltInsResourceLoader();
    }

    /* renamed from: a */
    public final KotlinClassFinder.Result m28747a(String str) {
        ReflectKotlinClass create;
        Class<?> tryLoadClass = ReflectJavaClassFinderKt.tryLoadClass(this.f68910a, str);
    ...
    public InputStream findBuiltInsData(@NotNull FqName packageFqName) {
        ...
        return this.f68911b.loadResource(BuiltInSerializerProtocol.INSTANCE.getBuiltInsFilePath(packageFqName));
    }
    ...
    public KotlinClassFinder.Result findKotlinClassOrContent(@NotNull ClassId classId, @NotNull JvmMetadataVersion jvmMetadataVersion) {
        ...
        m28746a = ReflectKotlinClassFinderKt.m28746a(classId);
        return m28747a(m28746a);
    }
