...
@Metadata(m29143d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\u000b¢\u0006\u0004\b\u0004\u0010\u0005"}, m29142d2 = {"<anonymous>", "Landroidx/compose/ui/graphics/Color;", "it", "Landroidx/compose/material/InputPhase;", "invoke-XeAY9LY", "(Landroidx/compose/material/InputPhase;Landroidx/compose/runtime/Composer;I)J"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
...
public final class TextFieldImplKt$CommonDecorationBox$labelColor$1 extends Lambda implements Function3<InputPhase, Composer, Integer, Color> {
    ...
    public /* bridge */ /* synthetic */ Color invoke(InputPhase inputPhase, Composer composer, Integer num) {
        return Color.m71909boximpl(m70336invokeXeAY9LY(inputPhase, composer, num.intValue()));
    }

    @Composable
    /* renamed from: invoke-XeAY9LY  reason: not valid java name */
    public final long m70336invokeXeAY9LY(@NotNull InputPhase it, @Nullable Composer composer, int i) {
        boolean z;
        ...
        int i2 = this.$$dirty1;
        long m71929unboximpl = textFieldColors.labelColor(z2, z, interactionSource, composer, ((this.$$dirty >> 27) & 14) | ((i2 << 3) & 896) | (i2 & 7168)).getValue().m71929unboximpl();
        if (ComposerKt.isTraceInProgress()) {
