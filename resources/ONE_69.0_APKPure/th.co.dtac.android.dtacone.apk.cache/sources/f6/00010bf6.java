...
public final class ActionNotificationObserver<T> implements Observer<T> {
    ...
    /* renamed from: a */
    public final Action1 f79370a;

    public ActionNotificationObserver(Action1<Notification<? super T>> action1) {
        this.f79370a = action1;
    }

    @Override // p046rx.Observer
    public void onCompleted() {
        this.f79370a.call(Notification.createOnCompleted());
    }

    @Override // p046rx.Observer
    public void onError(Throwable th2) {
        this.f79370a.call(Notification.createOnError(th2));
    }

    @Override // p046rx.Observer
    public void onNext(T t) {
        this.f79370a.call(Notification.createOnNext(t));
    }
}