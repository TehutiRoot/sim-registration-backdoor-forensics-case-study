...
public final class zzbr {
    /* renamed from: a */
    public static String m47419a(int i, int i2, String str) {
        if (i < 0) {
    ...
    public static int zzb(int i, int i2, String str) {
        ...
        throw new IndexOutOfBoundsException(m47419a(i, i2, FirebaseAnalytics.Param.INDEX));
    }
    ...
    public static void zzc(int i, int i2, int i3) {
        ...
        if (i >= 0 && i <= i3) {
            if (i2 >= 0 && i2 <= i3) {
                m47419a = zzbs.zza("end index (%s) must not be less than start index (%s)", Integer.valueOf(i2), Integer.valueOf(i));
            } else {
                m47419a = m47419a(i2, i3, "end index");
            }
        } else {
            m47419a = m47419a(i, i3, "start index");
        }
        throw new IndexOutOfBoundsException(m47419a);
    }
}