...
public class PDFreeTextAppearanceHandler extends PDAbstractAppearanceHandler {
    ...
    /* renamed from: e */
    public static final Pattern f60605e = Pattern.compile(".*color\\:\\s*\\#([0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F]).*");

    /* renamed from: c */
    public float f60606c;

    /* renamed from: d */
    public COSName f60607d;

    public PDFreeTextAppearanceHandler(PDAnnotation pDAnnotation) {
        super(pDAnnotation);
        this.f60606c = 10.0f;
        this.f60607d = COSName.HELV;
    }
    ...
    */
    ...
    /* renamed from: w */
    public final void m32328w(PDAnnotationMarkup pDAnnotationMarkup) {
        ...
        try {
            ...
            if (cOSArray2.size() >= 2) {
                ...
                if (cOSBase instanceof COSName) {
                    this.f60607d = (COSName) cOSBase;
                }
                COSBase cOSBase2 = cOSArray2.get(1);
                if (cOSBase2 instanceof COSNumber) {
                    this.f60606c = ((COSNumber) cOSBase2).floatValue();
                }
            }
        } catch (IOException e) {
    ...
    /* renamed from: x */
    public final PDColor m32327x(PDAnnotationMarkup pDAnnotationMarkup) {
        PDColor pDColor;
