...
public final class DateRangePickerKt$SwitchableDateEntryContent$2 extends Lambda implements Function3<DisplayMode, Composer, Integer, Unit> {
    ...
    public /* bridge */ /* synthetic */ Unit invoke(DisplayMode displayMode, Composer composer, Integer num) {
        m70541invokeQujVXRc(displayMode.m70550unboximpl(), composer, num.intValue());
    ...
    public final void m70541invokeQujVXRc(int i, @Nullable Composer composer, int i2) {
        int i3;
        int i4;
        if ((i2 & 14) == 0) {
        ...
        if (DisplayMode.m70547equalsimpl0(i, companion.m70552getPickerjFl4v0())) {
            ...
            DateRangePickerKt.m60610a(this.$state.getStateData$material3_release(), this.$dateFormatter, this.$dateValidator, this.$colors, composer, this.$$dirty & 8176);
