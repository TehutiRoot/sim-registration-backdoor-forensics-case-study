...
public final class ObservableFlatMapCompletableCompletable<T> extends Completable implements FuseToObservable<T> {
    ...
    /* renamed from: a */
    public final ObservableSource f65330a;

    /* renamed from: b */
    public final Function f65331b;
    ...
    public ObservableFlatMapCompletableCompletable(ObservableSource<T> observableSource, Function<? super T, ? extends CompletableSource> function, boolean z) {
        this.f65330a = observableSource;
        this.f65331b = function;
        this.f65332c = z;
    }

    @Override // io.reactivex.internal.fuseable.FuseToObservable
    public Observable<T> fuseToObservable() {
        return RxJavaPlugins.onAssembly(new ObservableFlatMapCompletable(this.f65330a, this.f65331b, this.f65332c));
    }

    @Override // io.reactivex.Completable
    public void subscribeActual(CompletableObserver completableObserver) {
        this.f65330a.subscribe(new FlatMapCompletableMainObserver(completableObserver, this.f65331b, this.f65332c));
    }
}