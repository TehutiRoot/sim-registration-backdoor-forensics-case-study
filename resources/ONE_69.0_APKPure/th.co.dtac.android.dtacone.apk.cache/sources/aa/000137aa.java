...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.fragment.consent.OnePostpaidTMNFragment$onStart$1$1 */
/* loaded from: classes10.dex */
public final class OnePostpaidTMNFragment$onStart$1$1 extends Lambda implements Function1<FragmentNavEvent, Unit> {
    final /* synthetic */ OnePostpaidTMNFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidTMNFragment$onStart$1$1(OnePostpaidTMNFragment onePostpaidTMNFragment) {
        super(1);
    ...
    public final void invoke2(@NotNull FragmentNavEvent it) {
        OnePostpaidRegistrationActivity m12296n;
        Intrinsics.checkNotNullParameter(it, "it");
        m12296n = this.this$0.m12296n();
        m12296n.replaceFragment(it.buildFragment(), it.getTag());
    }
}