...
public class Personalization {
    ...
    /* renamed from: a */
    public final Provider f56471a;

    /* renamed from: b */
    public final Map f56472b = Collections.synchronizedMap(new HashMap());

    public Personalization(Provider<AnalyticsConnector> provider) {
        this.f56471a = provider;
    }

    public void logArmActive(@NonNull String str, @NonNull ConfigContainer configContainer) {
        JSONObject optJSONObject;
        AnalyticsConnector analyticsConnector = (AnalyticsConnector) this.f56471a.get();
        ...
        synchronized (this.f56472b) {
            try {
                if (optString.equals(this.f56472b.get(str))) {
                    return;
                }
                this.f56472b.put(str, optString);
