...
public class HctSolver {
    ...
    /* renamed from: b */
    public static double[] m45270b(double d, double d2) {
        int m45267e;
        int m45266f;
        double[][] m45269c = m45269c(d, d2);
        double[] dArr = m45269c[0];
        double m45264h = m45264h(dArr);
        double[] dArr2 = m45269c[1];
        for (int i = 0; i < 3; i++) {
            double d3 = dArr[i];
            double d4 = dArr2[i];
            if (d3 != d4) {
                if (d3 < d4) {
                    m45267e = m45266f(m45255q(d3));
                    m45266f = m45267e(m45255q(dArr2[i]));
                } else {
                    m45267e = m45267e(m45255q(d3));
                    m45266f = m45266f(m45255q(dArr2[i]));
                }
                int i2 = m45267e;
                int i3 = m45266f;
                for (int i4 = 0; i4 < 8 && Math.abs(i3 - i2) > 1; i4++) {
                    int floor = (int) Math.floor((i2 + i3) / 2.0d);
                    double[] m45256p = m45256p(dArr, f49645d[floor], dArr2, i);
                    double m45264h2 = m45264h(m45256p);
                    if (m45271a(m45264h, d2, m45264h2)) {
                        dArr2 = m45256p;
                        i3 = floor;
                    } else {
                        dArr = m45256p;
        ...
        return m45259m(dArr, dArr2);
    }

    /* renamed from: c */
    public static double[][] m45269c(double d, double d2) {
        ...
        boolean z2 = true;
        for (int i = 0; i < 12; i++) {
            double[] m45258n = m45258n(d, i);
            if (m45258n[0] >= 0.0d) {
                double m45264h = m45264h(m45258n);
                if (!z) {
                    dArr = m45258n;
                    dArr2 = dArr;
                    d3 = m45264h;
                    d4 = d3;
                    z = true;
                } else if (z2 || m45271a(d3, m45264h, d4)) {
                    if (m45271a(d3, d2, m45264h)) {
                        dArr2 = m45258n;
                        d4 = m45264h;
                    } else {
                        dArr = m45258n;
    ...
    /* renamed from: d */
    public static double m45268d(double d) {
        double pow = Math.pow(Math.abs(d), 0.42d);
        return ((MathUtils.signum(d) * 400.0d) * pow) / (pow + 27.13d);
    }

    /* renamed from: e */
    public static int m45267e(double d) {
        return (int) Math.ceil(d - 0.5d);
    }

    /* renamed from: f */
    public static int m45266f(double d) {
        return (int) Math.floor(d - 0.5d);
    }

    /* renamed from: g */
    public static int m45265g(double d, double d2, double d3) {
        double d4;
        double sqrt = Math.sqrt(d3) * 11.0d;
        ViewingConditions viewingConditions = ViewingConditions.DEFAULT;
        double d5 = 1.0d;
        double pow = 1.0d / Math.pow(1.64d - Math.pow(0.29d, viewingConditions.getN()), 0.73d);
        double cos = (Math.cos(d + 2.0d) + 3.8d) * 0.25d * 3846.153846153846d * viewingConditions.m44918c() * viewingConditions.m44917d();
        ...
        while (i < 5) {
            ...
            double aw = (viewingConditions.getAw() * Math.pow(d6, (d5 / viewingConditions.m44920a()) / viewingConditions.m44916e())) / viewingConditions.getNbb();
            double d9 = (((0.305d + aw) * 23.0d) * pow2) / (((23.0d * d8) + ((pow2 * 11.0d) * cos2)) + ((pow2 * 108.0d) * sin));
            double d10 = d9 * cos2;
            double d11 = d9 * sin;
            double d12 = aw * 460.0d;
            double[] matrixMultiply = MathUtils.matrixMultiply(new double[]{m45262j((((451.0d * d10) + d12) + (288.0d * d11)) / 1403.0d), m45262j(((d12 - (891.0d * d10)) - (261.0d * d11)) / 1403.0d), m45262j(((d12 - (d10 * 220.0d)) - (d11 * 6300.0d)) / 1403.0d)}, f49643b);
    ...
    /* renamed from: h */
    public static double m45264h(double[] dArr) {
        double[] matrixMultiply = MathUtils.matrixMultiply(dArr, f49642a);
        double m45268d = m45268d(matrixMultiply[0]);
        double m45268d2 = m45268d(matrixMultiply[1]);
        double m45268d3 = m45268d(matrixMultiply[2]);
        return Math.atan2(((m45268d + m45268d2) - (m45268d3 * 2.0d)) / 9.0d, (((m45268d * 11.0d) + ((-12.0d) * m45268d2)) + m45268d3) / 11.0d);
    }

    /* renamed from: i */
    public static double m45263i(double d, double d2, double d3) {
        return (d2 - d) / (d3 - d);
    }

    /* renamed from: j */
    public static double m45262j(double d) {
        double abs = Math.abs(d);
        return MathUtils.signum(d) * Math.pow(Math.max(0.0d, (27.13d * abs) / (400.0d - abs)), 2.380952380952381d);
    }

    /* renamed from: k */
    public static boolean m45261k(double d) {
        return 0.0d <= d && d <= 100.0d;
    }

    /* renamed from: l */
    public static double[] m45260l(double[] dArr, double d, double[] dArr2) {
        double d2 = dArr[0];
        double d3 = dArr[1];
        double d4 = dArr[2];
    ...
    /* renamed from: m */
    public static double[] m45259m(double[] dArr, double[] dArr2) {
        return new double[]{(dArr[0] + dArr2[0]) / 2.0d, (dArr[1] + dArr2[1]) / 2.0d, (dArr[2] + dArr2[2]) / 2.0d};
    }

    /* renamed from: n */
    public static double[] m45258n(double d, int i) {
        double d2;
        double[] dArr = f49644c;
        double d3 = dArr[0];
        double d4 = dArr[1];
        ...
        if (i < 4) {
            ...
            return m45261k(d7) ? new double[]{d7, d2, d6} : new double[]{-1.0d, -1.0d, -1.0d};
        } else if (i < 8) {
            double d8 = ((d - (d3 * d6)) - (d5 * d2)) / d4;
            return m45261k(d8) ? new double[]{d6, d8, d2} : new double[]{-1.0d, -1.0d, -1.0d};
        } else {
            double d9 = ((d - (d3 * d2)) - (d4 * d6)) / d5;
            return m45261k(d9) ? new double[]{d2, d6, d9} : new double[]{-1.0d, -1.0d, -1.0d};
        }
    }

    /* renamed from: o */
    public static double m45257o(double d) {
        return (d + 25.132741228718345d) % 6.283185307179586d;
    }

    /* renamed from: p */
    public static double[] m45256p(double[] dArr, double d, double[] dArr2, int i) {
        return m45260l(dArr, m45263i(dArr[i], d, dArr2[i]), dArr2);
    }

    /* renamed from: q */
    public static double m45255q(double d) {
        double pow;
        double d2 = d / 100.0d;
        if (d2 <= 0.0031308d) {
            pow = d2 * 12.92d;
    ...
    public static int solveToInt(double d, double d2, double d3) {
        if (d2 >= 1.0E-4d && d3 >= 1.0E-4d && d3 <= 99.9999d) {
            ...
            int m45265g = m45265g(sanitizeDegreesDouble, d2, yFromLstar);
            if (m45265g != 0) {
                return m45265g;
            }
            return ColorUtils.argbFromLinrgb(m45270b(yFromLstar, sanitizeDegreesDouble));
        }
