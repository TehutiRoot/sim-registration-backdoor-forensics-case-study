...
public class InstructionSequence {
    ...
    /* renamed from: a */
    public final List f60225a = new ArrayList();

    public void addBoolean(boolean z) {
        this.f60225a.add(Boolean.valueOf(z));
    }

    public void addInteger(int i) {
        this.f60225a.add(Integer.valueOf(i));
    }

    public void addName(String str) {
        this.f60225a.add(str);
    }

    public void addProc(InstructionSequence instructionSequence) {
        this.f60225a.add(instructionSequence);
    }

    public void addReal(float f) {
        this.f60225a.add(Float.valueOf(f));
    }

    public void execute(ExecutionContext executionContext) {
        Stack<Object> stack = executionContext.getStack();
        for (Object obj : this.f60225a) {
