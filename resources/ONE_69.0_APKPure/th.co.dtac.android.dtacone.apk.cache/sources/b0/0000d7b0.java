...
public class GPUImage3x3ConvolutionFilter extends GPUImage3x3TextureSamplingFilter {
    ...
    public void onInit() {
        super.onInit();
        this.f67464l = GLES20.glGetUniformLocation(getProgram(), "convolutionMatrix");
        setConvolutionKernel(this.f67463k);
    }

    public void setConvolutionKernel(float[] fArr) {
        this.f67463k = fArr;
        setUniformMatrix3f(this.f67464l, fArr);
    }
