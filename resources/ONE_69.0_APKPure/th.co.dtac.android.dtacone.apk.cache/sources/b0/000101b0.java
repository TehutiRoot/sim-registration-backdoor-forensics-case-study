...
public class BsonArrayCodec implements Codec<BsonArray> {
    ...
    /* renamed from: b */
    public static final CodecRegistry f75887b = CodecRegistries.fromProviders(new BsonValueCodecProvider());

    /* renamed from: a */
    public final CodecRegistry f75888a;
    ...
    public BsonValue readValue(BsonReader bsonReader, DecoderContext decoderContext) {
        return (BsonValue) this.f75888a.get(BsonValueCodecProvider.getClassForBsonType(bsonReader.getCurrentBsonType())).decode(bsonReader, decoderContext);
    }

    public BsonArrayCodec(CodecRegistry codecRegistry) {
        this.f75888a = (CodecRegistry) Assertions.notNull("codecRegistry", codecRegistry);
    }
    ...
    public void encode(BsonWriter bsonWriter, BsonArray bsonArray, EncoderContext encoderContext) {
        ...
        while (it.hasNext()) {
            ...
            encoderContext.encodeWithChildContext(this.f75888a.get(next.getClass()), bsonWriter, next);
        }
