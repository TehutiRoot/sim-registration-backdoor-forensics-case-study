...
public class PDPolylineAppearanceHandler extends PDAbstractAppearanceHandler {
    ...
    public void generateNormalAppearance() {
        ...
        boolean z2;
        String str2 = "None";
        PDAnnotationMarkup pDAnnotationMarkup2 = (PDAnnotationMarkup) m32341k();
        PDRectangle rectangle = pDAnnotationMarkup2.getRectangle();
        float[] vertices = pDAnnotationMarkup2.getVertices();
        if (vertices != null && vertices.length >= 4) {
            C0978O4 m67156a = C0978O4.m67156a(pDAnnotationMarkup2, pDAnnotationMarkup2.getBorderStyle());
            PDColor color = pDAnnotationMarkup2.getColor();
            if (color != null && color.getComponents().length != 0 && Float.compare(m67156a.f4357c, 0.0f) != 0) {
                ...
                rectangle.setLowerLeftX(Math.min(f3 - (m67156a.f4357c * 10.0f), rectangle.getLowerLeftX()));
                rectangle.setLowerLeftY(Math.min(f4 - (m67156a.f4357c * 10.0f), rectangle.getLowerLeftY()));
                rectangle.setUpperRightX(Math.max(f + (m67156a.f4357c * 10.0f), rectangle.getUpperRightX()));
                rectangle.setUpperRightY(Math.max(f2 + (m67156a.f4357c * 10.0f), rectangle.getUpperRightY()));
                ...
                try {
                    try {
                        ...
                        m32331u(pDAppearanceContentStream, pDAnnotationMarkup2.getConstantOpacity());
                        boolean strokingColorOnDemand = pDAppearanceContentStream.setStrokingColorOnDemand(color);
                        float[] fArr = m67156a.f4355a;
                        if (fArr != null) {
                            pDAppearanceContentStream.setLineDashPattern(fArr, 0.0f);
                        }
                        pDAppearanceContentStream.setLineWidth(m67156a.f4357c);
                        int i3 = 0;
                        ...
                        if (!str3.equals(pDAnnotationMarkup3.getStartPointEndingStyle())) {
                            ...
                            m32342j(pDAnnotationMarkup3.getStartPointEndingStyle(), pDAppearanceContentStream, 0.0f, 0.0f, m67156a.f4357c, z3, z4, false);
                        ...
                        if (!str3.equals(pDAnnotationMarkup3.getEndPointEndingStyle())) {
                            ...
                            m32342j(pDAnnotationMarkup3.getEndPointEndingStyle(), pDAppearanceContentStream, 0.0f, 0.0f, m67156a.f4357c, z3, z4, true);
                        }
                    } catch (IOException e) {
                        e.getMessage();
                    }
