...
public final class CalendarModelImpl implements CalendarModel {
    ...
    /* renamed from: c */
    public static final ZoneId f25680c;
    ...
    @Metadata(m29143d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\t\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u001e\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\b2\u0006\u0010\f\u001a\u00020\rR\u0014\u0010\u0003\u001a\u00020\u0004X\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u000e"}, m29142d2 = {"Landroidx/compose/material3/CalendarModelImpl$Companion;", "", "()V", "utcTimeZoneId", "Ljava/time/ZoneId;", "getUtcTimeZoneId$material3_release", "()Ljava/time/ZoneId;", "formatWithPattern", "", "utcTimeMillis", "", "pattern", "locale", "Ljava/util/Locale;", "material3_release"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* loaded from: classes2.dex */
    public static final class Companion {
        ...
        public final ZoneId getUtcTimeZoneId$material3_release() {
            return CalendarModelImpl.f25680c;
        }
    ...
    public CalendarModelImpl() {
        ...
        for (DayOfWeek dayOfWeek : values) {
            ...
            arrayList.add(TuplesKt.m29136to(displayName, displayName2));
        }
        this.f25682b = arrayList;
    }

    /* renamed from: a */
    public final CalendarMonth m60640a(LocalDate localDate) {
        DayOfWeek dayOfWeek;
        int value;
        LocalTime localTime;
    ...
    /* renamed from: b */
    public final LocalDate m60639b(CalendarDate calendarDate) {
        LocalDate of;
    ...
    /* renamed from: c */
    public final LocalDate m60638c(CalendarMonth calendarMonth) {
        Instant ofEpochMilli;
        ZonedDateTime atZone;
        LocalDate localDate;
        ofEpochMilli = Instant.ofEpochMilli(calendarMonth.getStartUtcTimeMillis());
        atZone = ofEpochMilli.atZone(f25680c);
        localDate = atZone.toLocalDate();
    ...
    public /* synthetic */ String formatWithSkeleton(CalendarDate calendarDate, String str, Locale locale) {
        return AbstractC16854ug.m1081a(this, calendarDate, str, locale);
    }
    ...
    public int getDayOfWeek(@NotNull CalendarDate date) {
        ...
        dayOfWeek = m60639b(date).getDayOfWeek();
        value = dayOfWeek.getValue();
        return value;
    }
    ...
    public CalendarMonth minusMonths(@NotNull CalendarMonth from, int i) {
        ...
        if (i > 0) {
            earlierMonth = m60638c(from).minusMonths(i);
            Intrinsics.checkNotNullExpressionValue(earlierMonth, "earlierMonth");
            return m60640a(earlierMonth);
        }
        return from;
    }
    ...
    public CalendarMonth plusMonths(@NotNull CalendarMonth from, int i) {
        ...
        Intrinsics.checkNotNullParameter(from, "from");
        if (i > 0) {
            laterMonth = m60638c(from).plusMonths(i);
            Intrinsics.checkNotNullExpressionValue(laterMonth, "laterMonth");
            return m60640a(laterMonth);
        }
        return from;
    }
    ...
    public /* synthetic */ String formatWithSkeleton(CalendarMonth calendarMonth, String str, Locale locale) {
        return AbstractC16854ug.m1080b(this, calendarMonth, str, locale);
    }
