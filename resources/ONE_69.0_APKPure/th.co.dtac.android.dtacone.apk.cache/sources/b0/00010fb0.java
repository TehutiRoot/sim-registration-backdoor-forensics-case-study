...
@Metadata(m29143d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010!\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0002\b\f\b\u0007\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0001\u001eB)\u0012\u0006\u0010\u0004\u001a\u00020\u0003\u0012\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005\u0012\n\b\u0002\u0010\t\u001a\u0004\u0018\u00010\b¢\u0006\u0004\b\n\u0010\u000bJ\u001f\u0010\u000f\u001a\u00020\u00022\u0006\u0010\r\u001a\u00020\f2\u0006\u0010\t\u001a\u00020\u000eH\u0016¢\u0006\u0004\b\u000f\u0010\u0010J\u001f\u0010\u0014\u001a\u00020\u00132\u0006\u0010\u0011\u001a\u00020\u00022\u0006\u0010\u0012\u001a\u00020\u000eH\u0016¢\u0006\u0004\b\u0014\u0010\u0015J\u000f\u0010\u0016\u001a\u00020\u000eH\u0016¢\u0006\u0004\b\u0016\u0010\u0017R\u0014\u0010\u0004\u001a\u00020\u00038\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0018\u0010\u0019R\u001a\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\u00060\u00058\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u001a\u0010\u001bR\u0016\u0010\t\u001a\u0004\u0018\u00010\b8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u001c\u0010\u001d¨\u0006\u001f"}, m29142d2 = {"Lth/co/dtac/android/dtacone/adapter/multi_sim/AdapterMultiSimAllSubscriberList;", "Landroidx/recyclerview/widget/RecyclerView$Adapter;", "Lth/co/dtac/android/dtacone/adapter/multi_sim/AdapterMultiSimAllSubscriberList$ViewHolder;", "Lth/co/dtac/android/dtacone/view/activity/multi_sim/MrtrPrepaidMultiSimActivity;", "activity", "", "Lth/co/dtac/android/dtacone/model/mrtr_prepaid_multi_sim/MultiSubscriber;", "listSubscriber", "Lth/co/dtac/android/dtacone/util/enum/ViewTypeList;", "viewType", "<init>", "(Lth/co/dtac/android/dtacone/view/activity/multi_sim/MrtrPrepaidMultiSimActivity;Ljava/util/List;Lth/co/dtac/android/dtacone/util/enum/ViewTypeList;)V", "Landroid/view/ViewGroup;", "parent", "", "onCreateViewHolder", "(Landroid/view/ViewGroup;I)Lth/co/dtac/android/dtacone/adapter/multi_sim/AdapterMultiSimAllSubscriberList$ViewHolder;", "holder", "position", "", "onBindViewHolder", "(Lth/co/dtac/android/dtacone/adapter/multi_sim/AdapterMultiSimAllSubscriberList$ViewHolder;I)V", "getItemCount", "()I", PDPageLabelRange.STYLE_LETTERS_LOWER, "Lth/co/dtac/android/dtacone/view/activity/multi_sim/MrtrPrepaidMultiSimActivity;", OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, "Ljava/util/List;", OperatorName.CURVE_TO, "Lth/co/dtac/android/dtacone/util/enum/ViewTypeList;", "ViewHolder", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0})
...
public final class AdapterMultiSimAllSubscriberList extends RecyclerView.Adapter<ViewHolder> {
    ...
    public static final class ViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: a */
        public final ConstraintLayout f81368a;

        /* renamed from: b */
        public final DtacFontTextView f81369b;

        /* renamed from: c */
        public final View f81370c;

        /* renamed from: d */
        public final DtacFontTextView f81371d;
        ...
        public ViewHolder(@NotNull View itemView) {
            ...
            this.f81368a = (ConstraintLayout) findViewById;
            ...
            this.f81369b = (DtacFontTextView) findViewById2;
            ...
            this.f81371d = (DtacFontTextView) findViewById4;
        }
    ...
    public void onBindViewHolder(@NotNull ViewHolder holder, int i) {
        ...
        MultiSubscriber multiSubscriber = (MultiSubscriber) this.f81366b.get(i);
        DtacFontTextView tvItemSubscriberValue = holder.getTvItemSubscriberValue();
        MrtrPrepaidMultiSimViewModel viewModel = this.f81365a.getViewModel();
        ...
        if (i == this.f81366b.size() - 1) {
            ViewVisibleExtKt.toInVisible(holder.getVSeparateLine());
        }
        if (Intrinsics.areEqual(multiSubscriber.getRegisterType(), PrepaidRegisterType.REGISTER_ACTIVATION) && this.f81367c == ViewTypeList.SUCESS) {
            ...
            if (Intrinsics.areEqual(multiSubscriber.getActivateStatus(), Boolean.TRUE)) {
                holder.getTvItemAct().setText(this.f81365a.getResources().getString(R.string.act_success));
                holder.getTvItemAct().setTextColor(ContextCompat.getColor(this.f81365a, R.color.green2));
                return;
            }
            holder.getTvItemAct().setText(this.f81365a.getResources().getString(R.string.act_fail));
            holder.getTvItemAct().setTextColor(ContextCompat.getColor(this.f81365a, R.color.red));
            return;
        }
    ...
    public AdapterMultiSimAllSubscriberList(@NotNull MrtrPrepaidMultiSimActivity activity, @NotNull List<MultiSubscriber> listSubscriber, @Nullable ViewTypeList viewTypeList) {
        ...
        this.f81365a = activity;
        this.f81366b = listSubscriber;
        this.f81367c = viewTypeList;
    }
}