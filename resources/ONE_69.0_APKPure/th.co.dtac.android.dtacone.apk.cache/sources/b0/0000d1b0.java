...
public final class ObservableFlatMapSingle<T, R> extends AbstractC11078a {

    /* renamed from: a */
    public final Function f65335a;
    ...
    public ObservableFlatMapSingle(ObservableSource<T> observableSource, Function<? super T, ? extends SingleSource<? extends R>> function, boolean z) {
        ...
        this.f65335a = function;
        this.f65336b = z;
    }

    @Override // io.reactivex.Observable
    public void subscribeActual(Observer<? super R> observer) {
        this.source.subscribe(new FlatMapSingleObserver(observer, this.f65335a, this.f65336b));
    }
}