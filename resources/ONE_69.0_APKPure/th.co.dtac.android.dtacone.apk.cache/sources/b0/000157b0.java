...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.login_mrtr.GetProfileViewModel$saveFirebaseSessionId$1$1$2 */
/* loaded from: classes9.dex */
public final class GetProfileViewModel$saveFirebaseSessionId$1$1$2 extends Lambda implements Function1<ResponseBody, Unit> {
    final /* synthetic */ GetProfileViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GetProfileViewModel$saveFirebaseSessionId$1$1$2(GetProfileViewModel getProfileViewModel) {
        super(1);
    ...
    public final void invoke2(ResponseBody responseBody) {
        ...
        m2495x.setValue(companion.success(loginRepository.getUserName()));
    }
}