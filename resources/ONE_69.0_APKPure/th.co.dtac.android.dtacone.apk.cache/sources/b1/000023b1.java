...
public final class FocusableElement extends ModifierNodeElement<FocusableNode> {
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof FocusableElement) && Intrinsics.areEqual(this.f12928b, ((FocusableElement) obj).f12928b)) {
            return true;
        }
        return false;
    }
    ...
    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    public int hashCode() {
        MutableInteractionSource mutableInteractionSource = this.f12928b;
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("interactionSource", this.f12928b);
    }
}