...
public final class FlowableOnErrorReturn<T> extends AbstractC0558I {

    /* renamed from: b */
    public final Function f64473b;
    ...
    public FlowableOnErrorReturn(Flowable<T> flowable, Function<? super Throwable, ? extends T> function) {
        super(flowable);
        this.f64473b = function;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new OnErrorReturnSubscriber(subscriber, this.f64473b));
    }
}