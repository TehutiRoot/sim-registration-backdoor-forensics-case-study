...
public final class PolymorphicModuleBuilder<Base> {
    ...
    /* renamed from: a */
    public final KClass f71477a;

    /* renamed from: b */
    public final KSerializer f71478b;

    /* renamed from: c */
    public final List f71479c;

    /* renamed from: d */
    public Function1 f71480d;

    /* renamed from: e */
    public Function1 f71481e;

    @PublishedApi
    public PolymorphicModuleBuilder(@NotNull KClass<Base> baseClass, @Nullable KSerializer<Base> kSerializer) {
        Intrinsics.checkNotNullParameter(baseClass, "baseClass");
        this.f71477a = baseClass;
        this.f71478b = kSerializer;
    ...
    public final void buildTo(@NotNull SerializersModuleBuilder builder) {
        ...
        Function1<? super Base, ? extends SerializationStrategy<? super Base>> function1 = this.f71480d;
        if (function1 != null) {
            builder.registerDefaultPolymorphicSerializer(this.f71477a, function1, false);
        }
        Function1<? super String, ? extends DeserializationStrategy<? extends Base>> function12 = this.f71481e;
        if (function12 != null) {
            builder.registerDefaultPolymorphicDeserializer(this.f71477a, function12, false);
        }
    }
    ...
    public final void m74944default(@NotNull Function1<? super String, ? extends DeserializationStrategy<? extends Base>> defaultSerializerProvider) {
    ...
    public final void defaultDeserializer(@NotNull Function1<? super String, ? extends DeserializationStrategy<? extends Base>> defaultDeserializerProvider) {
        ...
        if (this.f71481e == null) {
            this.f71481e = defaultDeserializerProvider;
            return;
        }
        throw new IllegalArgumentException(("Default deserializer provider is already registered for class " + this.f71477a + ": " + this.f71481e).toString());
    }

    public final <T extends Base> void subclass(@NotNull KClass<T> subclass, @NotNull KSerializer<T> serializer) {
        Intrinsics.checkNotNullParameter(subclass, "subclass");
        Intrinsics.checkNotNullParameter(serializer, "serializer");
        this.f71479c.add(TuplesKt.m29136to(subclass, serializer));
    }
