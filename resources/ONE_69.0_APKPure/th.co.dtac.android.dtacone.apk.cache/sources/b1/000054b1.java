...
@Metadata(m29143d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m29142d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_sendToMobile", "Landroidx/compose/material/icons/Icons$TwoTone;", "getSendToMobile", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "SendToMobile", "material-icons-extended_release"}, m29141k = 2, m29140mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nSendToMobile.kt\nKotlin\n*S Kotlin\n*F\n+ 1 SendToMobile.kt\nandroidx/compose/material/icons/twotone/SendToMobileKt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,90:1\n122#2:91\n116#2,3:92\n119#2,3:96\n132#2,18:99\n152#2:136\n132#2,18:137\n152#2:174\n132#2,18:175\n152#2:212\n174#3:95\n694#4,2:117\n706#4,2:119\n708#4,11:125\n694#4,2:155\n706#4,2:157\n708#4,11:163\n694#4,2:193\n706#4,2:195\n708#4,11:201\n64#5,4:121\n64#5,4:159\n64#5,4:197\n*S KotlinDebug\n*F\n+ 1 SendToMobile.kt\nandroidx/compose/material/icons/twotone/SendToMobileKt\n*L\n29#1:91\n29#1:92,3\n29#1:96,3\n30#1:99,18\n30#1:136\n37#1:137,18\n37#1:174\n44#1:175,18\n44#1:212\n29#1:95\n30#1:117,2\n30#1:119,2\n30#1:125,11\n37#1:155,2\n37#1:157,2\n37#1:163,11\n44#1:193,2\n44#1:195,2\n44#1:201,11\n30#1:121,4\n37#1:159,4\n44#1:197,4\n*E\n"})
/* loaded from: classes.dex */
public final class SendToMobileKt {

    /* renamed from: a */
    public static ImageVector f24951a;

    @NotNull
    public static final ImageVector getSendToMobile(@NotNull Icons.TwoTone twoTone) {
        Intrinsics.checkNotNullParameter(twoTone, "<this>");
        ImageVector imageVector = f24951a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.SendToMobile", C3623Dp.m73842constructorimpl(24.0f), C3623Dp.m73842constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder3.moveTo(22.0f, 12.0f);
        ...
        pathBuilder3.horizontalLineToRelative(5.0f);
        pathBuilder3.verticalLineToRelative(3.0f);
        pathBuilder3.lineTo(22.0f, 12.0f);
        pathBuilder3.close();
        ...
        pathBuilder3.lineTo(7.0f, 1.01f);
        pathBuilder3.curveTo(5.9f, 1.01f, 5.0f, 1.9f, 5.0f, 3.0f);
