...
public abstract class AbstractC22237sr0 extends AbstractC22064rr0 {
    @SinceKotlin(version = "1.2")
    public static final double acosh(double d) {
        if (d < 1.0d) {
            return Double.NaN;
        }
        if (d > C12161kx.f71548f) {
            return Math.log(d) + C12161kx.f71544b;
        }
        double d2 = 1;
        double d3 = d - d2;
        if (d3 >= C12161kx.f71547e) {
            return Math.log(d + Math.sqrt((d * d) - d2));
        }
        double sqrt = Math.sqrt(d3);
        if (sqrt >= C12161kx.f71546d) {
    ...
    public static final double asinh(double d) {
        double d2 = C12161kx.f71547e;
        if (d >= d2) {
            if (d > C12161kx.f71549g) {
                if (d > C12161kx.f71548f) {
                    return Math.log(d) + C12161kx.f71544b;
                }
                double d3 = d * 2;
            ...
            if (Math.abs(d) >= C12161kx.f71546d) {
                return d - (((d * d) * d) / 6);
            }
            return d;
        }
    ...
    public static final double atanh(double d) {
        if (Math.abs(d) < C12161kx.f71547e) {
            if (Math.abs(d) > C12161kx.f71546d) {
                return d + (((d * d) * d) / 3);
            }
            return d;
    ...
    public static final float log2(float f) {
        return (float) (Math.log(f) / C12161kx.f71544b);
    }
