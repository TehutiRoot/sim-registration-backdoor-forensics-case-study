...
public final class AsyncImageKt {
    ...
    public static final void m74134AsyncImageMvsnxeU(@Nullable Object obj, @Nullable String str, @NotNull ImageLoader imageLoader, @Nullable Modifier modifier, @Nullable Function1<? super AsyncImagePainter.State, ? extends AsyncImagePainter.State> function1, @Nullable Function1<? super AsyncImagePainter.State, Unit> function12, @Nullable Alignment alignment, @Nullable ContentScale contentScale, float f, @Nullable ColorFilter colorFilter, int i, @Nullable Composer composer, int i2, int i3, int i4) {
        ...
        if ((i4 & 1024) != 0) {
            i6 = i3 & (-15);
            i5 = DrawScope.Companion.m72359getDefaultFilterQualityfv9h1I();
        } else {
            i5 = i;
            i6 = i3;
        }
        ...
        int i10 = i5;
        AsyncImagePainter m74141rememberAsyncImagePainter5jETZwI = AsyncImagePainterKt.m74141rememberAsyncImagePainter5jETZwI(updateRequest, imageLoader, function15, function16, contentScale3, i10, startRestartGroup, ((i6 << 15) & 458752) | (i7 & 7168) | (i7 & 896) | 72 | i9, 0);
        ...
        Content(modifier2, m74141rememberAsyncImagePainter5jETZwI, str, alignment2, contentScale2, f2, colorFilter2, startRestartGroup, (i8 & 7168) | ((i2 << 3) & 896) | i9 | (i8 & 458752) | (3670016 & i8));
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m74135AsyncImageQ4Kwu38(@Nullable Object obj, @Nullable String str, @NotNull ImageLoader imageLoader, @Nullable Modifier modifier, @Nullable Painter painter, @Nullable Painter painter2, @Nullable Painter painter3, @Nullable Function1<? super AsyncImagePainter.State.Loading, Unit> function1, @Nullable Function1<? super AsyncImagePainter.State.Success, Unit> function12, @Nullable Function1<? super AsyncImagePainter.State.Error, Unit> function13, @Nullable Alignment alignment, @Nullable ContentScale contentScale, float f, @Nullable ColorFilter colorFilter, int i, @Nullable Composer composer, int i2, int i3, int i4) {
        ...
        int m72359getDefaultFilterQualityfv9h1I = (i4 & 16384) != 0 ? DrawScope.Companion.m72359getDefaultFilterQualityfv9h1I() : i;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-245964807, i2, i3, "coil.compose.AsyncImage (AsyncImage.kt:64)");
        }
        int i5 = i3 << 18;
        m74134AsyncImageMvsnxeU(obj, str, imageLoader, companion, UtilsKt.transformOf(painter4, painter5, painter6), UtilsKt.onStateOf(function14, function15, function16), center, fit, f2, colorFilter2, m72359getDefaultFilterQualityfv9h1I, composer, (i2 & 7168) | (i2 & 112) | 520 | (3670016 & i5) | (29360128 & i5) | (234881024 & i5) | (i5 & 1879048192), (i3 >> 12) & 14, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    ...
    public static final void Content(@NotNull Modifier modifier, @NotNull Painter painter, @Nullable String str, @NotNull Alignment alignment, @NotNull ContentScale contentScale, float f, @Nullable ColorFilter colorFilter, @Nullable Composer composer, int i) {
        ...
        Modifier then = ClipKt.clipToBounds(m51141a(modifier, str)).then(new ContentPainterModifier(painter, alignment, contentScale, f, colorFilter));
        AsyncImageKt$Content$1 asyncImageKt$Content$1 = AsyncImageKt$Content$1.f40435a;
        ...
        Updater.m71584setimpl(m71577constructorimpl, asyncImageKt$Content$1, companion.getSetMeasurePolicy());
        ...
        Updater.m71584setimpl(m71577constructorimpl, materialize, companion.getSetModifier());
    ...
    /* renamed from: a */
    public static final Modifier m51141a(Modifier modifier, String str) {
        if (str != null) {
    ...
    /* renamed from: b */
    public static final Size m51140b(long j) {
        Dimension dimension;
        Dimension dimension2;
        if (Constraints.m73814isZeroimpl(j)) {
            return null;
        }
        if (Constraints.m73806getHasBoundedWidthimpl(j)) {
            dimension = Dimensions.Dimension(Constraints.m73810getMaxWidthimpl(j));
        } else {
            dimension = Dimension.Undefined.INSTANCE;
        }
        if (Constraints.m73805getHasBoundedHeightimpl(j)) {
            dimension2 = Dimensions.Dimension(Constraints.m73809getMaxHeightimpl(j));
        } else {
