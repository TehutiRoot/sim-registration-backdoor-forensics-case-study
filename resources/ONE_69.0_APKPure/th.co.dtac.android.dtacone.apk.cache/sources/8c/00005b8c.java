...
public final class TextFieldKt$TextField$5 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    /* loaded from: classes2.dex */
    public static final class C33831 extends Lambda implements Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit> {
        final /* synthetic */ int $$dirty;
        final /* synthetic */ int $$dirty1;
        final /* synthetic */ int $$dirty2;
        final /* synthetic */ TextFieldColors $colors;
        ...
        public final void invoke(@NotNull Function2<? super Composer, ? super Integer, Unit> innerTextField, @Nullable Composer composer, int i) {
            ...
            int i4 = this.$$dirty1;
            int i5 = this.$$dirty2;
            textFieldDefaults.DecorationBox(text, innerTextField, z, z2, visualTransformation, mutableInteractionSource, z3, function2, function22, function23, function24, function25, function26, function27, shape, textFieldColors, null, null, composer, ((i3 >> 3) & 896) | ((i2 << 3) & 112) | ((i4 >> 12) & 7168) | (i4 & 57344) | ((i5 << 15) & 458752) | ((i4 << 9) & 3670016) | ((i3 << 3) & 29360128) | ((i3 << 3) & 234881024) | ((i3 << 3) & 1879048192), ((i3 >> 27) & 14) | 100663296 | ((i4 << 3) & 112) | ((i4 << 3) & 896) | ((i4 << 3) & 7168) | ((i5 << 9) & 57344) | ((i5 << 9) & 458752), ProfileVerifier.CompilationStatus.f36619xf2722a21);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        TextFieldDefaults textFieldDefaults = TextFieldDefaults.INSTANCE;
        Modifier m69732defaultMinSizeVpY3zN4 = SizeKt.m69732defaultMinSizeVpY3zN4(modifier, textFieldDefaults.m70862getMinWidthD9Ej5fM(), textFieldDefaults.m70861getMinHeightD9Ej5fM());
        ...
        VisualTransformation visualTransformation = this.$visualTransformation;
        MutableInteractionSource mutableInteractionSource = this.$interactionSource;
        ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer, 1751957978, true, new C33831(textFieldValue, z, z3, visualTransformation, mutableInteractionSource, this.$isError, this.$label, this.$placeholder, this.$leadingIcon, this.$trailingIcon, this.$prefix, this.$suffix, this.$supportingText, this.$shape, this.$colors, this.$$dirty, this.$$dirty1, this.$$dirty2));
        int i4 = this.$$dirty1;
