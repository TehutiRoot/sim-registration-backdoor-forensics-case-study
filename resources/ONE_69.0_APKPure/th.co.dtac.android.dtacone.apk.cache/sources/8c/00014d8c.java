...
/* renamed from: th.co.dtac.android.dtacone.view.fragment.eSIM.postpaid.sim.ESimPostpaidScanSimFragment$onStart$1$2 */
/* loaded from: classes9.dex */
public final class ESimPostpaidScanSimFragment$onStart$1$2 extends Lambda implements Function1<Resource<? extends String>, Unit> {
    final /* synthetic */ ESimPostpaidScanSimFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimPostpaidScanSimFragment$onStart$1$2(ESimPostpaidScanSimFragment eSimPostpaidScanSimFragment) {
        super(1);
    ...
    public final void invoke2(Resource<String> resource) {
        ...
        eSimPostpaidScanSimFragment.m7007x(data);
    }
}