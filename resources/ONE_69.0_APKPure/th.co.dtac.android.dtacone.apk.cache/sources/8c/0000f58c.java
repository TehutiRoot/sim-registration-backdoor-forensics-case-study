...
public interface X509AttributeIdentifiers {
    ...
    static {
        ...
        id_pe_ac_auditIdentity = aSN1ObjectIdentifier.branch(OneNadOutboundSearchFragment.BILL_REMAINING_3_PLUS);
        ...
        id_aca_group = branch.branch(OneNadOutboundSearchFragment.BILL_REMAINING_3_PLUS);
