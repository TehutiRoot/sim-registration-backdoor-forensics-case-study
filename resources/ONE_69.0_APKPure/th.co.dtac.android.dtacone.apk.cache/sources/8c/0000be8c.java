...
public class setLabelFor implements setDarkTextColor.valueOf {
    private final setDarkTextColor values;

    public setLabelFor(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.CertificateInfo(this.values);
    }
}