...
public final class ObservableFlatMapCompletable<T> extends AbstractC11078a {

    /* renamed from: a */
    public final Function f65328a;
    ...
    public ObservableFlatMapCompletable(ObservableSource<T> observableSource, Function<? super T, ? extends CompletableSource> function, boolean z) {
        ...
        this.f65328a = function;
        this.f65329b = z;
    }

    @Override // io.reactivex.Observable
    public void subscribeActual(Observer<? super T> observer) {
        this.source.subscribe(new FlatMapCompletableMainObserver(observer, this.f65328a, this.f65329b));
    }
}