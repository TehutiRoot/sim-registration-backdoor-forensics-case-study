...
public final class CredentialsRetriever {
    ...
    /* renamed from: c */
    public static final Logger f54583c;

    /* renamed from: a */
    public final HttpTransport f54584a;

    /* renamed from: b */
    public final AppDistributionEnvironment f54585b;

    @Metadata(m29143d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0016\u0010\u0003\u001a\n \u0005*\u0004\u0018\u00010\u00040\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0006"}, m29142d2 = {"Lcom/google/firebase/appdistribution/gradle/CredentialsRetriever$Companion;", "", "()V", "logger", "Lorg/gradle/api/logging/Logger;", "kotlin.jvm.PlatformType", "appdistribution-gradle"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* loaded from: classes4.dex */
    ...
    static {
        ...
        Companion = companion;
        f54583c = Logging.getLogger(companion.getClass());
    }
    ...
    public final Credential getAuthCredential(@Nullable String str) {
        ...
        if (str2 != null) {
            try {
                f54583c.info("Using credentials token specified by environment variable {}", "FIREBASE_TOKEN");
                return new RefreshToken(str2, this.f54584a).generateNewCredentials();
        ...
        GoogleCredential firebaseCliLoginCredentials = this.f54585b.getFirebaseCliLoginCredentials(this.f54584a);
        if (firebaseCliLoginCredentials != null) {
            f54583c.info("Using cached Firebase CLI credentials");
            return firebaseCliLoginCredentials;
        }
        String str3 = System.getenv("GOOGLE_APPLICATION_CREDENTIALS");
        if (str3 != null) {
            f54583c.info("Using credentials file specified by environment variable {}: {}", "GOOGLE_APPLICATION_CREDENTIALS", str3);
            try {
    ...
    public CredentialsRetriever(@NotNull HttpTransport httpTransport, @NotNull AppDistributionEnvironment appDistributionEnvironment) {
        ...
        this.f54584a = httpTransport;
        this.f54585b = appDistributionEnvironment;
    }
