...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.device_sale.fragment.OneDeviceSaleScanIMEIFragment$onStart$1$5 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleScanIMEIFragment$onStart$1$5 extends Lambda implements Function1<Resource<? extends Void>, Unit> {
    final /* synthetic */ OneDeviceSaleScanIMEIFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.device_sale.fragment.OneDeviceSaleScanIMEIFragment$onStart$1$5$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneDeviceSaleScanIMEIFragment$onStart$1$5(OneDeviceSaleScanIMEIFragment oneDeviceSaleScanIMEIFragment) {
        super(1);
    ...
    public final void invoke2(Resource<Void> resource) {
        ...
        if (i != 1) {
            if (i == 2) {
                ...
                new Handler().postDelayed(new Runnable() { // from class: th.co.dtac.android.dtacone.view.appOne.device_sale.fragment.d
                    @Override // java.lang.Runnable
                    public final void run() {
                        OneDeviceSaleScanIMEIFragment$onStart$1$5.invoke$lambda$2$lambda$1(OneDeviceSaleScanIMEIFragment.this);
                    }
                }, 1000L);
                return;
            }
        ...
        if (ctx != null) {
            ...
            oneDeviceSaleScanIMEIFragment.getViewModel().showToastUpdatedVerify().postValue(new Event<>(toastMessage));
        }
        oneDeviceSaleScanIMEIFragment.dismissSecondaryLoading();
