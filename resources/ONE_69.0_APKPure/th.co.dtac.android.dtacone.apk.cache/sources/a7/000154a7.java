...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.customerenquiry.InfoAnalyticViewModel$callCheckBlocking$1 */
/* loaded from: classes9.dex */
public final class InfoAnalyticViewModel$callCheckBlocking$1 extends Lambda implements Function1<CheckBlockingResponse, CheckBlockingPackageTypeResponse> {
    public static final InfoAnalyticViewModel$callCheckBlocking$1 INSTANCE = new InfoAnalyticViewModel$callCheckBlocking$1();

    public InfoAnalyticViewModel$callCheckBlocking$1() {
        super(1);
    }
    ...
    public final CheckBlockingPackageTypeResponse invoke(@NotNull CheckBlockingResponse it) {
        ...
        return ControllerKt.checkIsBlocking(it);
    }
}