...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.deviceSaleTrueCompany.fragment.common.OneDeviceSaleNavigateToCommonFragment$navigateNextToCommon$onExitCallback$1 */
/* loaded from: classes10.dex */
public final class C14565x12d3d8ef extends Lambda implements Function1<ExitCallbackState, Unit> {
    final /* synthetic */ OneDeviceSaleNavigateToCommonFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C14565x12d3d8ef(OneDeviceSaleNavigateToCommonFragment oneDeviceSaleNavigateToCommonFragment) {
        super(1);
