...
@Metadata(m29143d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m29142d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_golfCourse", "Landroidx/compose/material/icons/Icons$TwoTone;", "getGolfCourse", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "GolfCourse", "material-icons-extended_release"}, m29141k = 2, m29140mv = {1, 8, 0})
...
public final class GolfCourseKt {
    ...
    /* renamed from: a */
    public static ImageVector f24173a;

    @NotNull
    public static final ImageVector getGolfCourse(@NotNull Icons.TwoTone twoTone) {
        Intrinsics.checkNotNullParameter(twoTone, "<this>");
        ImageVector imageVector = f24173a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.GolfCourse", C3623Dp.m73842constructorimpl(24.0f), C3623Dp.m73842constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder3.moveTo(19.5f, 19.5f);
        ...
        pathBuilder4.moveTo(17.0f, 5.92f);
        pathBuilder4.lineTo(9.0f, 2.0f);
        pathBuilder4.verticalLineToRelative(18.0f);
        pathBuilder4.horizontalLineTo(7.0f);
        pathBuilder4.verticalLineToRelative(-1.73f);
        pathBuilder4.curveToRelative(-1.79f, 0.35f, -3.0f, 0.99f, -3.0f, 1.73f);
        pathBuilder4.curveToRelative(0.0f, 1.1f, 2.69f, 2.0f, 6.0f, 2.0f);
        pathBuilder4.reflectiveCurveToRelative(6.0f, -0.9f, 6.0f, -2.0f);
        pathBuilder4.curveToRelative(0.0f, -0.99f, -2.16f, -1.81f, -5.0f, -1.97f);
        pathBuilder4.verticalLineTo(8.98f);
        pathBuilder4.lineToRelative(6.0f, -3.06f);
        pathBuilder4.close();
