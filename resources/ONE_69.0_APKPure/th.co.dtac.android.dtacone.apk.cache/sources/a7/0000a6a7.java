...
public class AwsCredentials extends ExternalAccountCredentials {
    ...
    public static class Builder extends ExternalAccountCredentials.Builder {
        ...
        /* renamed from: d */
        public AwsSecurityCredentialsSupplier f52415d;
        ...
        public Builder setAwsSecurityCredentialsSupplier(AwsSecurityCredentialsSupplier awsSecurityCredentialsSupplier) {
            this.f52415d = awsSecurityCredentialsSupplier;
            return this;
        }
        ...
        public Builder(AwsCredentials awsCredentials) {
            ...
            if (this.credentialSource == null) {
                this.f52415d = awsCredentials.awsSecurityCredentialsSupplier;
            }
            this.f52416e = awsCredentials.regionalCredentialVerificationUrlOverride;
        }
    ...
    public AwsCredentials(Builder builder) {
        ...
        if (builder.f52415d != null && builder.credentialSource != null) {
        ...
        if (builder.f52415d != null) {
            this.awsSecurityCredentialsSupplier = builder.f52415d;
    ...
    private String buildSubjectToken(C7357a c7357a) throws UnsupportedEncodingException {
        Map m41527b = c7357a.m41527b();
        ArrayList arrayList = new ArrayList();
        for (String str : m41527b.keySet()) {
            arrayList.add(formatTokenHeaderForSts(str, (String) m41527b.get(str)));
        }
        arrayList.add(formatTokenHeaderForSts("Authorization", c7357a.m41528a()));
        ...
        genericJson.put(FirebaseAnalytics.Param.METHOD, (Object) c7357a.m41526c());
        genericJson.put(ImagesContract.URL, (Object) this.regionalCredentialVerificationUrl.replace("{region}", c7357a.m41525d()));
    ...
    public String retrieveSubjectToken() throws IOException {
        ...
        return buildSubjectToken(C7360b.m41508g(credentials, "POST", this.regionalCredentialVerificationUrl.replace("{region}", region), region).m41504b(hashMap).m41505a().m41507h());
    }
