...
public class ModelLoader {
    ...
    /* renamed from: b */
    public static final GmsLogger f56966b = new GmsLogger("ModelLoader", "");

    /* renamed from: a */
    public final ModelLoadingLogger f56967a;
    @Nullable
    @KeepForSdk
    ...
    public ModelLoader(@Nullable RemoteModelLoader remoteModelLoader, @Nullable LocalModelLoader localModelLoader, @NonNull ModelLoadingLogger modelLoadingLogger) {
        ...
        this.f56967a = modelLoadingLogger;
    }

    /* renamed from: a */
    public final String m37215a() {
    ...
    /* renamed from: b */
    public final synchronized boolean m37214b(ModelContentHandler modelContentHandler, List list) {
        MappedByteBuffer load;
        LocalModelLoader localModelLoader = this.localModelLoader;
        if (localModelLoader != null && (load = localModelLoader.load()) != null) {
            try {
                modelContentHandler.constructModel(load);
                f56966b.m48405d("ModelLoader", "Local model source is loaded successfully");
                return true;
    ...
    /* renamed from: c */
    public final synchronized boolean m37213c(ModelContentHandler modelContentHandler, List list) {
        RemoteModelLoader remoteModelLoader = this.remoteModelLoader;
        if (remoteModelLoader != null) {
            try {
                ...
                if (load != null) {
                    try {
                        modelContentHandler.constructModel(load);
                        f56966b.m48405d("ModelLoader", "Remote model source is loaded successfully");
                        return true;
                    } catch (RuntimeException e) {
                        list.add(19);
                        throw e;
                ...
                f56966b.m48405d("ModelLoader", "Remote model source can NOT be loaded, try local model.");
                list.add(21);
    ...
    public synchronized void loadWithModelContentHandler(@NonNull ModelContentHandler modelContentHandler) throws MlKitException {
        ...
        Exception e = null;
        try {
            z = m37213c(modelContentHandler, arrayList);
            exc = null;
        } catch (Exception e2) {
            exc = e2;
            z = false;
        ...
        if (z) {
            this.f56967a.logErrorCodes(arrayList);
            this.modelLoadingState = ModelLoadingState.REMOTE_MODEL_LOADED;
            return;
        }
        try {
            z2 = m37214b(modelContentHandler, arrayList);
        } catch (Exception e3) {
            e = e3;
        }
        if (z2) {
        ...
        if (exc == null) {
            if (e != null) {
                throw new MlKitException("Local model load failed with the model options: ".concat(String.valueOf(m37215a())), 14, e);
            }
            throw new MlKitException("Cannot load any model with the model options: ".concat(String.valueOf(m37215a())), 14);
        }
        throw new MlKitException("Remote model load failed with the model options: ".concat(String.valueOf(m37215a())), 14, exc);
    }
}