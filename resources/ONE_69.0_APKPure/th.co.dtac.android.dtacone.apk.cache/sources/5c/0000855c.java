...
public @interface JsonAutoDetect {
    ...
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C6062a {
        ...
        static {
            ...
            try {
                f43107b[PropertyAccessor.FIELD.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f43107b[PropertyAccessor.GETTER.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f43107b[PropertyAccessor.IS_GETTER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f43107b[PropertyAccessor.NONE.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f43107b[PropertyAccessor.SETTER.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f43107b[PropertyAccessor.ALL.ordinal()] = 7;
            ...
            try {
                f43106a[Visibility.NONE.ordinal()] = 2;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f43106a[Visibility.NON_PRIVATE.ordinal()] = 3;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f43106a[Visibility.PROTECTED_AND_PUBLIC.ordinal()] = 4;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f43106a[Visibility.PUBLIC_ONLY.ordinal()] = 5;
    ...
    public static class Value implements JacksonAnnotationValue<JsonAutoDetect>, Serializable {
        ...
        public static Value construct(PropertyAccessor propertyAccessor, Visibility visibility) {
            ...
            int i = C6062a.f43107b[propertyAccessor.ordinal()];
            if (i != 1) {
                if (i == 2) {
