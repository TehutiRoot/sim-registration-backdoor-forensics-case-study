...
public final class ShareTarget {
    ...
    public static final class FileFormField {
        ...
        /* renamed from: a */
        public static FileFormField m63935a(Bundle bundle) {
            if (bundle == null) {
                return null;
            }
    ...
    public static class Params {
        ...
        /* renamed from: a */
        public static Params m63933a(Bundle bundle) {
            ...
            if (parcelableArrayList != null) {
                ...
                for (Bundle bundle2 : parcelableArrayList) {
                    arrayList.add(FileFormField.m63935a(bundle2));
                }
            }
        ...
        public Bundle m63932b() {
            ...
            if (this.files != null) {
                ...
                for (FileFormField fileFormField : this.files) {
                    arrayList.add(fileFormField.m63934b());
                }
    ...
    public static ShareTarget fromBundle(@NonNull Bundle bundle) {
        ...
        Params m63933a = Params.m63933a(bundle.getBundle(KEY_PARAMS));
        if (string != null && m63933a != null) {
            return new ShareTarget(string, string2, string3, m63933a);
        }
        return null;
    }
    ...
    public Bundle toBundle() {
        ...
        bundle.putBundle(KEY_PARAMS, this.params.m63932b());
        return bundle;
    }
}