...
public abstract /* synthetic */ class AbstractC19076ad0 {
    static {
        ImageBitmap.Companion companion = ImageBitmap.Companion;
    }

    /* renamed from: a */
    public static /* synthetic */ void m65108a(ImageBitmap imageBitmap, int[] iArr, int i, int i2, int i3, int i4, int i5, int i6, int i7, Object obj) {
        int i8;
        int i9;
        int i10;
        int i11;
