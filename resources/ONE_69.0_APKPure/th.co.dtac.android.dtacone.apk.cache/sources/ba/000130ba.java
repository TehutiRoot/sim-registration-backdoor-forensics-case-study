...
@DebugMetadata(m29093c = "th.co.dtac.android.dtacone.view.appOne.eSign.viewModel.OneConsentAndESignViewModel$getConsentTMN$1", m29092f = "OneConsentAndESignViewModel.kt", m29091i = {}, m29090l = {655}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
@SourceDebugExtension({"SMAP\nOneConsentAndESignViewModel.kt\nKotlin\n*S Kotlin\n*F\n+ 1 OneConsentAndESignViewModel.kt\nth/co/dtac/android/dtacone/view/appOne/eSign/viewModel/OneConsentAndESignViewModel$getConsentTMN$1\n+ 2 StateFlow.kt\nkotlinx/coroutines/flow/StateFlowKt\n*L\n1#1,1159:1\n230#2,5:1160\n230#2,5:1165\n*S KotlinDebug\n*F\n+ 1 OneConsentAndESignViewModel.kt\nth/co/dtac/android/dtacone/view/appOne/eSign/viewModel/OneConsentAndESignViewModel$getConsentTMN$1\n*L\n654#1:1160,5\n656#1:1165,5\n*E\n"})
/* renamed from: th.co.dtac.android.dtacone.view.appOne.eSign.viewModel.OneConsentAndESignViewModel$getConsentTMN$1 */
/* loaded from: classes10.dex */
public final class OneConsentAndESignViewModel$getConsentTMN$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ OneConsentAndESignViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneConsentAndESignViewModel$getConsentTMN$1(OneConsentAndESignViewModel oneConsentAndESignViewModel, Continuation<? super OneConsentAndESignViewModel$getConsentTMN$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new OneConsentAndESignViewModel$getConsentTMN$1(this.this$0, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i != 0) {
            ...
            this.label = 1;
            obj = oneConsentAndESignRepository.getOneConsentDataTMN(Constant.ConsentDomain.TMN, this);
    ...
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((OneConsentAndESignViewModel$getConsentTMN$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}