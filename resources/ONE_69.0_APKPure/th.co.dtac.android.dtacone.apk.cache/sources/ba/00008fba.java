...
public final class zzml {
    /* renamed from: a */
    public static String m47889a(int i, int i2, String str) {
        if (i < 0) {
    ...
    public static int zza(int i, int i2, @NullableDecl String str) {
        if (i < 0 || i > i2) {
            throw new IndexOutOfBoundsException(m47889a(i, i2, str));
        }
        return i;
    }
    ...
    public static int zzc(int i, int i2) {
        ...
        throw new IndexOutOfBoundsException(m47889a(i, i2, FirebaseAnalytics.Param.INDEX));
    }
    ...
    public static void zza(int i, int i2, int i3) {
        ...
        if (i < 0 || i2 < i || i2 > i3) {
            if (i < 0 || i > i3) {
                m47889a = m47889a(i, i3, "start index");
            } else if (i2 >= 0 && i2 <= i3) {
                m47889a = zzmt.zzb("end index (%s) must not be less than start index (%s)", Integer.valueOf(i2), Integer.valueOf(i));
            } else {
                m47889a = m47889a(i2, i3, "end index");
            }
            throw new IndexOutOfBoundsException(m47889a);
        }
    }
}