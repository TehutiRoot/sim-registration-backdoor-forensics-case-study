...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.onlineRegister.viewModel.OneOnlineRegisterViewModel$createRetailerProfile$1$2 */
/* loaded from: classes10.dex */
public final class OneOnlineRegisterViewModel$createRetailerProfile$1$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ OneOnlineRegisterViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneOnlineRegisterViewModel$createRetailerProfile$1$2(OneOnlineRegisterViewModel oneOnlineRegisterViewModel) {
        super(1);
