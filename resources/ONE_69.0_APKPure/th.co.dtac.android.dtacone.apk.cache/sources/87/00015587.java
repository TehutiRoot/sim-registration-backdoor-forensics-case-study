...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.device_sale.DeviceSaleViewModel$callAPIGetBlacklistSharingConsentTemplate$3 */
/* loaded from: classes9.dex */
public final class DeviceSaleViewModel$callAPIGetBlacklistSharingConsentTemplate$3 extends Lambda implements Function1<GetBlacklistSharingConsentTemplateResponse, Unit> {
    final /* synthetic */ DeviceSaleViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DeviceSaleViewModel$callAPIGetBlacklistSharingConsentTemplate$3(DeviceSaleViewModel deviceSaleViewModel) {
        super(1);
    ...
    public final void invoke2(GetBlacklistSharingConsentTemplateResponse getBlacklistSharingConsentTemplateResponse) {
        MutableLiveData m3012C0;
        MutableLiveData m2910u0;
        this.this$0.getLiveDataState().setValue(StatusResource.DISMISS);
        m3012C0 = this.this$0.m3012C0();
        Resource.Companion companion = Resource.Companion;
        m3012C0.setValue(companion.success(null));
        m2910u0 = this.this$0.m2910u0();
        m2910u0.setValue(companion.success(getBlacklistSharingConsentTemplateResponse.getBlacklistSharingConsentImage()));
    }
}