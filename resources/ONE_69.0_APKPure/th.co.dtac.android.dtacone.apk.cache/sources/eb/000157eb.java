...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.login_mrtr.LoginMrtrViewModel$callOneLoginApi$2 */
/* loaded from: classes9.dex */
public final class LoginMrtrViewModel$callOneLoginApi$2 extends Lambda implements Function1<LoginMrtrRequest, LoginMrtrRequest> {
    final /* synthetic */ String $userName;
    final /* synthetic */ LoginMrtrViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LoginMrtrViewModel$callOneLoginApi$2(LoginMrtrViewModel loginMrtrViewModel, String str) {
        super(1);
    ...
    public final LoginMrtrRequest invoke(@NotNull LoginMrtrRequest it) {
        ...
        loginRepository.setPromoterId(null);
        return it;
    }
}