...
public class setPreferKeepClearRects implements setDarkTextColor.valueOf {
    private final setDarkTextColor ThreeDS2ServiceInstance;

    public setPreferKeepClearRects(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.onError(this.ThreeDS2ServiceInstance);
    }
}