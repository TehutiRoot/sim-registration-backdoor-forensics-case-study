...
public class TextBoxCustomization implements setDarkTextColor.valueOf {
    private final setDarkTextColor valueOf;

    public TextBoxCustomization(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.getSDKAppID(this.valueOf);
    }
}