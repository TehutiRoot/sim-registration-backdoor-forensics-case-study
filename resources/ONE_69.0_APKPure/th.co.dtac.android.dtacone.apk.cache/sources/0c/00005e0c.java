...
public final class PersistentVector<E> extends AbstractPersistentList<E> implements PersistentList<E> {
    ...
    public PersistentVector(@NotNull Object[] root, @NotNull Object[] tail, int i, int i2) {
        ...
        this.f28615d = i2;
        if (size() > 32) {
            if (size() - UtilsKt.rootSize(size()) <= AbstractC11695c.coerceAtMost(tail.length, 32)) {
                z = true;
            } else {
                z = false;
            }
    ...
    /* renamed from: a */
    public final Object[] m60044a(int i) {
        if (m60035k() <= i) {
            return this.f28613b;
        }
        Object[] objArr = this.f28612a;
        for (int i2 = this.f28615d; i2 > 0; i2 -= 5) {
    ...
    /* renamed from: b */
    public final Object[] m60043b(Object[] objArr, int i, int i2, Object obj, ObjectRef objectRef) {
        Object[] copyOf;
        ...
        copyOf2[indexSegment] = m60043b((Object[]) obj2, i3, i2, obj, objectRef);
        int i4 = indexSegment + 1;
        while (i4 < 32 && copyOf2[i4] != null) {
            Object obj3 = objArr[i4];
            Intrinsics.checkNotNull(obj3, str);
            Object[] objArr2 = copyOf2;
            objArr2[i4] = m60043b((Object[]) obj3, i3, 0, objectRef.getValue(), objectRef);
            i4++;
            copyOf2 = objArr2;
            str = str;
        }
    ...
    /* renamed from: c */
    public final PersistentVector m60042c(Object[] objArr, int i, Object obj) {
        int size = size() - m60035k();
        Object[] copyOf = Arrays.copyOf(this.f28613b, 32);
        Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(this, newSize)");
        if (size < 32) {
            ArraysKt___ArraysJvmKt.copyInto(this.f28613b, copyOf, i + 1, i, size);
            copyOf[i] = obj;
            return new PersistentVector(objArr, copyOf, size() + 1, this.f28615d);
        }
        Object[] objArr2 = this.f28613b;
        Object obj2 = objArr2[31];
        ArraysKt___ArraysJvmKt.copyInto(objArr2, copyOf, i + 1, i, size - 1);
        copyOf[i] = obj;
        return m60039g(objArr, copyOf, UtilsKt.presizedBufferWith(obj2));
    }

    /* renamed from: e */
    public final Object[] m60041e(Object[] objArr, int i, int i2, ObjectRef objectRef) {
        Object[] m60041e;
        int indexSegment = UtilsKt.indexSegment(i2, i);
        if (i == 5) {
            ...
            m60041e = m60041e((Object[]) obj, i - 5, i2, objectRef);
        }
        if (m60041e == null && indexSegment == 0) {
            return null;
        }
        Object[] copyOf = Arrays.copyOf(objArr, 32);
        Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(this, newSize)");
        copyOf[indexSegment] = m60041e;
        return copyOf;
    }

    /* renamed from: f */
    public final PersistentList m60040f(Object[] objArr, int i, int i2) {
        if (i2 == 0) {
            if (objArr.length == 33) {
        ...
        Object[] m60041e = m60041e(objArr, i2, i - 1, objectRef);
        Intrinsics.checkNotNull(m60041e);
        Object value = objectRef.getValue();
        Intrinsics.checkNotNull(value, "null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
        Object[] objArr2 = (Object[]) value;
        if (m60041e[1] == null) {
            Object obj = m60041e[0];
            Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
            return new PersistentVector((Object[]) obj, objArr2, i, i2 - 5);
        }
        return new PersistentVector(m60041e, objArr2, i, i2);
    }

    /* renamed from: g */
    public final PersistentVector m60039g(Object[] objArr, Object[] objArr2, Object[] objArr3) {
        int size = size() >> 5;
        int i = this.f28615d;
        if (size > (1 << i)) {
            Object[] presizedBufferWith = UtilsKt.presizedBufferWith(objArr);
            int i2 = this.f28615d + 5;
            return new PersistentVector(m60038h(presizedBufferWith, i2, objArr2), objArr3, size() + 1, i2);
        }
        return new PersistentVector(m60038h(objArr, i, objArr2), objArr3, size() + 1, this.f28615d);
    }

    @Override // kotlin.collections.AbstractList, java.util.List
    public E get(int i) {
        ListImplementation.checkElementIndex$runtime_release(i, size());
        return (E) m60044a(i)[i & 31];
    }
    ...
    */
    public final java.lang.Object[] m60038h(java.lang.Object[] r4, int r5, java.lang.Object[] r6) {
        /*
            r3 = this;
            int r0 = r3.size()
            int r0 = r0 + (-1)
        ...
        L21:
            ...
            int r5 = r5 - r1
            java.lang.Object[] r5 = r3.m60038h(r2, r5, r6)
            r4[r0] = r5
        L2c:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableList.PersistentVector.m60038h(java.lang.Object[], int, java.lang.Object[]):java.lang.Object[]");
    }

    /* renamed from: i */
    public final Object[] m60037i(Object[] objArr, int i, int i2, ObjectRef objectRef) {
        Object[] copyOf;
        int indexSegment = UtilsKt.indexSegment(i2, i);
        int i3 = 31;
        if (i == 0) {
        ...
        if (objArr[31] == null) {
            i3 = UtilsKt.indexSegment(m60035k() - 1, i);
        }
        Object[] copyOf2 = Arrays.copyOf(objArr, 32);
        Intrinsics.checkNotNullExpressionValue(copyOf2, "copyOf(this, newSize)");
        int i4 = i - 5;
        ...
        if (i5 <= i3) {
            while (true) {
                ...
                Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
                copyOf2[i3] = m60037i((Object[]) obj, i4, 0, objectRef);
                if (i3 == i5) {
                    break;
                }
                i3--;
        ...
        Intrinsics.checkNotNull(obj2, "null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
        copyOf2[indexSegment] = m60037i((Object[]) obj2, i4, i2, objectRef);
        return copyOf2;
    }

    /* renamed from: j */
    public final PersistentList m60036j(Object[] objArr, int i, int i2, int i3) {
        boolean z;
        int size = size() - i;
        if (i3 < size) {
            z = true;
        ...
        CommonFunctionsKt.m71589assert(z);
        if (size == 1) {
            return m60040f(objArr, i, i2);
        }
        Object[] copyOf = Arrays.copyOf(this.f28613b, 32);
        Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(this, newSize)");
        int i4 = size - 1;
        if (i3 < i4) {
            ArraysKt___ArraysJvmKt.copyInto(this.f28613b, copyOf, i3, i3 + 1, size);
        }
        copyOf[i4] = null;
    ...
    /* renamed from: k */
    public final int m60035k() {
        return UtilsKt.rootSize(size());
    }

    /* renamed from: l */
    public final Object[] m60034l(Object[] objArr, int i, int i2, Object obj) {
        int indexSegment = UtilsKt.indexSegment(i2, i);
        Object[] copyOf = Arrays.copyOf(objArr, 32);
        Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(this, newSize)");
        if (i == 0) {
            ...
            Intrinsics.checkNotNull(obj2, "null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
            copyOf[indexSegment] = m60034l((Object[]) obj2, i - 5, i2, obj);
        }
        return copyOf;
    }
    ...
    public ListIterator<E> listIterator(int i) {
        ...
        return new PersistentVectorIterator(this.f28612a, this.f28613b, i, size(), (this.f28615d / 5) + 1);
    }
    ...
    public PersistentList<E> removeAt(int i) {
        ...
        int m60035k = m60035k();
        if (i >= m60035k) {
            return m60036j(this.f28612a, m60035k, this.f28615d, i - m60035k);
        }
        return m60036j(m60037i(this.f28612a, this.f28615d, i, new ObjectRef(this.f28613b[0])), m60035k, this.f28615d, 0);
    }
    ...
    public PersistentList<E> set(int i, E e) {
        ...
        if (m60035k() <= i) {
            ...
            Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(this, newSize)");
            copyOf[i & 31] = e;
            return new PersistentVector(this.f28612a, copyOf, size(), this.f28615d);
        }
        return new PersistentVector(m60034l(this.f28612a, this.f28615d, i, e), this.f28613b, size(), this.f28615d);
    }
    ...
    public PersistentList<E> add(E e) {
        ...
        if (size < 32) {
            ...
            Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(this, newSize)");
            copyOf[size] = e;
            return new PersistentVector(this.f28612a, copyOf, size() + 1, this.f28615d);
        }
        return m60039g(this.f28612a, this.f28613b, UtilsKt.presizedBufferWith(e));
    }
    ...
    public PersistentVectorBuilder<E> builder() {
        return new PersistentVectorBuilder<>(this, this.f28612a, this.f28613b, this.f28615d);
    }
    ...
    public PersistentList<E> add(int i, E e) {
        ...
        int m60035k = m60035k();
        if (i >= m60035k) {
            return m60042c(this.f28612a, i - m60035k, e);
        }
        ObjectRef objectRef = new ObjectRef(null);
        return m60042c(m60043b(this.f28612a, this.f28615d, i, e, objectRef), 0, objectRef.getValue());
    }
}