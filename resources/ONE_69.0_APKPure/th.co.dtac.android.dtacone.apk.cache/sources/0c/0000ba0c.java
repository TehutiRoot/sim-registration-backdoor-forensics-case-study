...
public class TakeoverInAppActivity extends Activity {
    ...
    /* renamed from: a */
    public MixpanelAPI f58749a;

    /* renamed from: b */
    public UpdateDisplayState f58750b;

    /* renamed from: c */
    public int f58751c = -1;

    /* renamed from: com.mixpanel.android.takeoverinapp.TakeoverInAppActivity$a */
    /* loaded from: classes5.dex */
    public class View$OnClickListenerC9187a implements View.OnClickListener {
        public View$OnClickListenerC9187a() {
        }

        @Override // android.view.View.OnClickListener
        public void onClick(View view) {
            TakeoverInAppActivity.this.finish();
            UpdateDisplayState.releaseDisplayState(TakeoverInAppActivity.this.f58751c);
        }
    }

    /* renamed from: com.mixpanel.android.takeoverinapp.TakeoverInAppActivity$b */
    /* loaded from: classes5.dex */
    public class View$OnTouchListenerC9188b implements View.OnTouchListener {

        /* renamed from: a */
        public final /* synthetic */ int f58753a;

        /* renamed from: b */
        public final /* synthetic */ GradientDrawable f58754b;

        /* renamed from: c */
        public final /* synthetic */ InAppButton f58755c;

        public View$OnTouchListenerC9188b(int i, GradientDrawable gradientDrawable, InAppButton inAppButton) {
            this.f58753a = i;
            this.f58754b = gradientDrawable;
            this.f58755c = inAppButton;
        }

        @Override // android.view.View.OnTouchListener
        public boolean onTouch(View view, MotionEvent motionEvent) {
            if (motionEvent.getAction() == 0) {
                this.f58754b.setColor(this.f58753a);
                return false;
            }
            this.f58754b.setColor(this.f58755c.getBackgroundColor());
            return false;
        }
    }
    ...
    /* loaded from: classes5.dex */
    public class View$OnClickListenerC9189c implements View.OnClickListener {

        /* renamed from: a */
        public final /* synthetic */ InAppButton f58757a;

        /* renamed from: b */
        public final /* synthetic */ InAppNotification f58758b;

        /* renamed from: c */
        public final /* synthetic */ int f58759c;

        public View$OnClickListenerC9189c(InAppButton inAppButton, InAppNotification inAppNotification, int i) {
            this.f58757a = inAppButton;
            this.f58758b = inAppNotification;
            this.f58759c = i;
        }
        ...
        */
        public void onClick(android.view.View r6) {
            /*
                r5 = this;
                com.mixpanel.android.mpmetrics.InAppButton r6 = r5.f58757a
            ...
            L22:
                ...
                com.mixpanel.android.util.MPLog.m33447i(r0, r2)
            L27:
            ...
            L34:
                ...
                com.mixpanel.android.util.MPLog.m33449e(r0, r6)
                goto L41
            L3a:
                r6 = move-exception
                java.lang.String r1 = "Can't parse notification URI, will not take any action"
                com.mixpanel.android.util.MPLog.m33446i(r0, r1, r6)
                return
            L41:
                com.mixpanel.android.mpmetrics.InAppNotification r6 = r5.f58758b
            ...
            L67:
                ...
                com.mixpanel.android.mpmetrics.MixpanelAPI r6 = com.mixpanel.android.takeoverinapp.TakeoverInAppActivity.m33464b(r6)
                com.mixpanel.android.mpmetrics.MixpanelAPI$People r6 = r6.getPeople()
                java.lang.String r0 = "$campaign_open"
                com.mixpanel.android.mpmetrics.InAppNotification r2 = r5.f58758b
                r6.trackNotification(r0, r2, r1)
                com.mixpanel.android.takeoverinapp.TakeoverInAppActivity r6 = com.mixpanel.android.takeoverinapp.TakeoverInAppActivity.this
                r6.finish()
                com.mixpanel.android.takeoverinapp.TakeoverInAppActivity r6 = com.mixpanel.android.takeoverinapp.TakeoverInAppActivity.this
                int r6 = com.mixpanel.android.takeoverinapp.TakeoverInAppActivity.m33465a(r6)
                com.mixpanel.android.mpmetrics.UpdateDisplayState.releaseDisplayState(r6)
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mixpanel.android.takeoverinapp.TakeoverInAppActivity.View$OnClickListenerC9189c.onClick(android.view.View):void");
        }
    }

    /* renamed from: c */
    public final void m33463c() {
        ...
        TakeoverInAppNotification takeoverInAppNotification = (TakeoverInAppNotification) ((UpdateDisplayState.DisplayState.InAppNotificationState) this.f58750b.getDisplayState()).getInAppNotification();
        ...
        for (int i = 0; i < arrayList.size(); i++) {
            m33462d((Button) arrayList.get(i), takeoverInAppNotification.getButton(i), takeoverInAppNotification, i);
        }
        ...
        linearLayout.setOnClickListener(new View$OnClickListenerC9187a());
        m33461e(fadingImageView, textView, textView2, arrayList, linearLayout);
    }

    /* renamed from: d */
    public final void m33462d(Button button, InAppButton inAppButton, InAppNotification inAppNotification, int i) {
        if (inAppButton != null) {
            ...
            button.setOnTouchListener(new View$OnTouchListenerC9188b(i2, gradientDrawable, inAppButton));
            ...
            button.setOnClickListener(new View$OnClickListenerC9189c(inAppButton, inAppNotification, i));
            return;
        }
    ...
    /* renamed from: e */
    public final void m33461e(ImageView imageView, TextView textView, TextView textView2, ArrayList arrayList, LinearLayout linearLayout) {
    ...
    public void onBackPressed() {
        UpdateDisplayState.releaseDisplayState(this.f58751c);
        super.onBackPressed();
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.f58751c = intExtra;
        UpdateDisplayState claimDisplayState = UpdateDisplayState.claimDisplayState(intExtra);
        this.f58750b = claimDisplayState;
        if (claimDisplayState == null) {
            MPLog.m33449e("MixpanelAPI.TakeoverInAppActivity", "TakeoverInAppActivity intent received, but nothing was found to show.");
            finish();
            return;
        }
        this.f58749a = MixpanelAPI.getInstance(this, claimDisplayState.getToken());
        m33463c();
    }
}