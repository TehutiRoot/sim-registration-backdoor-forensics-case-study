...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.customerenquiry.SubscriberInfoViewModel$sendQRCode$3 */
/* loaded from: classes9.dex */
public final class SubscriberInfoViewModel$sendQRCode$3 extends Lambda implements Function1<SendQRCodeResponse, Unit> {
    final /* synthetic */ String $type;
    final /* synthetic */ String $value;
    final /* synthetic */ SubscriberInfoViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SubscriberInfoViewModel$sendQRCode$3(SubscriberInfoViewModel subscriberInfoViewModel, String str, String str2) {
        super(1);
    ...
    public final void invoke2(SendQRCodeResponse sendQRCodeResponse) {
        ...
        m3083b0 = this.this$0.m3083b0();
        Resource.Companion companion = Resource.Companion;
        String str = Intrinsics.areEqual(this.$type, "email") ? this.$value : "";
        String str2 = this.$type;
        m3083b0.setValue(companion.success(new SendQRCodeRequest(null, null, null, null, null, str, str2, Intrinsics.areEqual(str2, Constant.SendQRType.mms) ? this.$value : "", 31, null)));
    }
}