...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.viewmodel.OnePostpaidRegistrationViewModel$callOpenMarketAddIMEI$2 */
/* loaded from: classes10.dex */
public final class OnePostpaidRegistrationViewModel$callOpenMarketAddIMEI$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ String $mode;
    final /* synthetic */ OnePostpaidRegistrationViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidRegistrationViewModel$callOpenMarketAddIMEI$2(OnePostpaidRegistrationViewModel onePostpaidRegistrationViewModel, String str) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable throwable) {
        ...
        oneErrorService.handleException(throwable, new OneErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.viewmodel.OnePostpaidRegistrationViewModel$callOpenMarketAddIMEI$2.1
