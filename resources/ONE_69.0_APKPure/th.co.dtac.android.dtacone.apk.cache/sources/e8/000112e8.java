...
public final class OneDialogSuccess extends AppCompatDialog {
    ...
    /* renamed from: f */
    public final Callback f83059f;

    /* renamed from: g */
    public final Integer f83060g;

    /* renamed from: h */
    public final Integer f83061h;
    ...
    /* renamed from: k */
    public OneDialogSuccessBinding f83064k;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final int $stable = 8;

    @Metadata(m29143d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\b\u0010\u0002\u001a\u00020\u0003H&¨\u0006\u0004"}, m29142d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/dialog/OneDialogSuccess$Callback;", "", "onButtonClick", "", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    @Metadata(m29143d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002¨\u0006\u0003"}, m29142d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/dialog/OneDialogSuccess$Companion;", "", "()V", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    /* renamed from: f */
    public static /* synthetic */ void m19923f(OneDialogSuccess oneDialogSuccess, View view) {
        m19922g(oneDialogSuccess, view);
    }

    /* renamed from: g */
    public static final void m19922g(OneDialogSuccess this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Callback callback = this$0.f83059f;
        if (callback != null) {
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        this.f83064k = inflate;
        OneDialogSuccessBinding oneDialogSuccessBinding = null;
        if (inflate == null) {
            Intrinsics.throwUninitializedPropertyAccessException("binding");
            inflate = null;
        }
        inflate.btnOK.setOnClickListener(new View.OnClickListener() { // from class: HS0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                OneDialogSuccess.m19923f(OneDialogSuccess.this, view);
            }
        });
        Integer num = this.f83060g;
        if (num != null) {
            int intValue = num.intValue();
            OneDialogSuccessBinding oneDialogSuccessBinding2 = this.f83064k;
        ...
        Integer num2 = this.f83061h;
        if (num2 != null) {
            int intValue2 = num2.intValue();
            OneDialogSuccessBinding oneDialogSuccessBinding3 = this.f83064k;
            ...
            OneDialogSuccessBinding oneDialogSuccessBinding4 = this.f83064k;
        ...
        if (this.f83062i != null) {
            OneDialogSuccessBinding oneDialogSuccessBinding5 = this.f83064k;
            if (oneDialogSuccessBinding5 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("binding");
                oneDialogSuccessBinding5 = null;
            }
            oneDialogSuccessBinding5.ivIconCheck.setImageResource(this.f83062i.intValue());
        }
        Integer num3 = this.f83063j;
        if (num3 != null) {
            int intValue3 = num3.intValue();
            OneDialogSuccessBinding oneDialogSuccessBinding6 = this.f83064k;
        ...
        OneDialogSuccessBinding oneDialogSuccessBinding7 = this.f83064k;
    ...
    public final void setMessage(@NotNull String s) {
        ...
        OneDialogSuccessBinding oneDialogSuccessBinding = this.f83064k;
    ...
    public OneDialogSuccess(@NotNull Context context, @Nullable Callback callback) {
        this(context, false, null, callback, null, null, null, null, C6139DK.ERROR_RECEIVE_LRC, null);
        Intrinsics.checkNotNullParameter(context, "context");
    }
