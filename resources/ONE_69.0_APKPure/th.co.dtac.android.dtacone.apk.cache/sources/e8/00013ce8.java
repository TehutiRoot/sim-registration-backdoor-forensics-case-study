...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.prepaid_registration.viewmodel.OnePrepaidViewModel$checkSim$1 */
/* loaded from: classes10.dex */
public final class OnePrepaidViewModel$checkSim$1 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ OnePrepaidViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePrepaidViewModel$checkSim$1(OnePrepaidViewModel onePrepaidViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable it) {
        ...
        oneErrorService.handleException(it, new OneErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.view.appOne.prepaid_registration.viewmodel.OnePrepaidViewModel$checkSim$1.1
            @Override // th.p047co.dtac.android.dtacone.manager.service.OneErrorService.ExceptionHandler
            public void handle(@Nullable Throwable th2) {
                OneErrorService oneErrorService2;
                OnePrepaidRepository onePrepaidRepository;
                MutableLiveData m10569R;
                ...
                onePrepaidRepository.setCheckSimStockError(errorCollection);
                m10569R = OnePrepaidViewModel.this.m10569R();
                m10569R.setValue(Resource.Companion.success(errorCollection));
            }
