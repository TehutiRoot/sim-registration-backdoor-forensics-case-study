...
public final class MurmurHash2 {
    /* renamed from: a */
    public static int m25796a(byte[] bArr, int i) {
        return ((bArr[i + 3] & 255) << 24) | (bArr[i] & 255) | ((bArr[i + 1] & 255) << 8) | ((bArr[i + 2] & 255) << 16);
    }

    /* renamed from: b */
    public static long m25795b(byte[] bArr, int i) {
    ...
    public static int hash32(byte[] bArr, int i, int i2) {
        ...
        for (int i5 = 0; i5 < i4; i5++) {
            int m25796a = m25796a(bArr, i5 << 2) * 1540483477;
            i3 = (i3 * 1540483477) ^ ((m25796a ^ (m25796a >>> 24)) * 1540483477);
        }
        int i6 = i4 << 2;
        int i7 = i - i6;
        if (i7 != 1) {
    ...
    public static long hash64(byte[] bArr, int i, int i2) {
        long j = (i2 & BodyPartID.bodyIdMax) ^ (i * (-4132994306676758123L));
        int i3 = i >> 3;
        for (int i4 = 0; i4 < i3; i4++) {
            long m25795b = m25795b(bArr, i4 << 3) * (-4132994306676758123L);
            j = (j ^ ((m25795b ^ (m25795b >>> 47)) * (-4132994306676758123L))) * (-4132994306676758123L);
        }
        int i5 = i3 << 3;
        switch (i - i5) {
            case 1:
