...
public final class C11949xb136a72d extends Lambda implements Function0<Map<Name, ? extends TypeAliasDescriptor>> {
    final /* synthetic */ DeserializedMemberScope.NoReorderImplementation this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C11949xb136a72d(DeserializedMemberScope.NoReorderImplementation noReorderImplementation) {
        super(0);
    ...
    public final Map<Name, ? extends TypeAliasDescriptor> invoke() {
        List m27938y;
        m27938y = this.this$0.m27938y();
        List list = m27938y;
        LinkedHashMap linkedHashMap = new LinkedHashMap(AbstractC11695c.coerceAtLeast(AbstractC18946Zn0.mapCapacity(AbstractC10172es.collectionSizeOrDefault(list, 10)), 16));
        for (Object obj : list) {
