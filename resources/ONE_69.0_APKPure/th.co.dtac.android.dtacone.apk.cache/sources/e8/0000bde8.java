...
public class setBottom implements setDarkTextColor.valueOf {
    public static final setBottom ThreeDS2Service = new setBottom();

    @Override // com.netcetera.threeds.sdk.infrastructure.setDarkTextColor.valueOf
    public getHeadingTextColor values() {
        return setDarkTextColor.setOnReceiveContentListener();
    }
}