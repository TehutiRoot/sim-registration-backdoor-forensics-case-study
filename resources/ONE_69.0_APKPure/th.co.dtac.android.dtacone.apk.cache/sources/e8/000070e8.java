...
public final class WithLifecycleStateKt {
    ...
    /* loaded from: classes2.dex */
    public static final class RunnableC4666a implements Runnable {

        /* renamed from: a */
        public final /* synthetic */ Lifecycle f35972a;

        /* renamed from: b */
        public final /* synthetic */ C4668xfdb59cc4 f35973b;

        public RunnableC4666a(Lifecycle lifecycle, C4668xfdb59cc4 c4668xfdb59cc4) {
            this.f35972a = lifecycle;
            this.f35973b = c4668xfdb59cc4;
        }

        @Override // java.lang.Runnable
        public final void run() {
            this.f35972a.addObserver(this.f35973b);
        }
    }
            ...
            public void onStateChanged(@NotNull LifecycleOwner lifecycleOwner, @NotNull Lifecycle.Event event) {
                ...
                if (event == Lifecycle.Event.Companion.upTo(Lifecycle.State.this)) {
                    ...
                    try {
                        ...
                        m74271constructorimpl = Result.m74271constructorimpl(function02.invoke());
                    } catch (Throwable th2) {
                    ...
                    cancellableContinuation2.resumeWith(Result.m74271constructorimpl(ResultKt.createFailure(new LifecycleDestroyedException())));
                }
            }
        };
        if (z) {
            coroutineDispatcher.dispatch(EmptyCoroutineContext.INSTANCE, new RunnableC4666a(lifecycle, r1));
        } else {
