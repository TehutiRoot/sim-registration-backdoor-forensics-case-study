...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.change_owner.viewModel.OneChangeOwnerValidateViewModel$validateCardDtac$1 */
/* loaded from: classes10.dex */
public final class OneChangeOwnerValidateViewModel$validateCardDtac$1 extends Lambda implements Function1<ValidateCardRequest, SingleSource<? extends ValidateCardResponse>> {
    final /* synthetic */ OneChangeOwnerValidateViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneChangeOwnerValidateViewModel$validateCardDtac$1(OneChangeOwnerValidateViewModel oneChangeOwnerValidateViewModel) {
        super(1);
