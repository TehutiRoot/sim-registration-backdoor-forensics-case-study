...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.viewModel.OneMnpViewModel$callCheckPrivilegeOCR$3 */
/* loaded from: classes10.dex */
public final class OneMnpViewModel$callCheckPrivilegeOCR$3 extends Lambda implements Function1<OnePrepaidRegisterTCheckPrivilegeResponse, Unit> {
    final /* synthetic */ OneMnpViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneMnpViewModel$callCheckPrivilegeOCR$3(OneMnpViewModel oneMnpViewModel) {
        super(1);
