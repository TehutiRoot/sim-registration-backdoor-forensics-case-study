...
public class FirebaseVisionCloudLandmark {
    ...
    /* renamed from: b */
    public final Rect f55925b;

    /* renamed from: c */
    public final float f55926c;

    /* renamed from: d */
    public final String f55927d;

    /* renamed from: e */
    public final List f55928e;

    public FirebaseVisionCloudLandmark(String str, float f, Rect rect, String str2, List list) {
        this.f55925b = rect;
        this.f55924a = zzmt.zzbb(str);
        this.f55927d = zzmt.zzbb(str2);
        this.f55928e = list;
    ...
    /* renamed from: a */
    public static FirebaseVisionCloudLandmark m38335a(zzkv zzkvVar, float f) {
        ArrayList arrayList;
        if (zzkvVar == null) {
            return null;
        }
