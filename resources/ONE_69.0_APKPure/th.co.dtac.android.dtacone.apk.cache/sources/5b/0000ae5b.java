...
public final class Timestamp implements Comparable<Timestamp>, Parcelable {
    ...
    public static final class Companion {
        ...
        /* renamed from: a */
        public final Pair m39299a(Date date) {
            long j = 1000;
            long time = date.getTime() / j;
            int time2 = (int) ((date.getTime() % j) * ((long) DurationKt.NANOS_IN_MILLIS));
            if (time2 < 0) {
                return TuplesKt.m29136to(Long.valueOf(time - 1), Integer.valueOf(time2 + 1000000000));
            }
            return TuplesKt.m29136to(Long.valueOf(time), Integer.valueOf(time2));
        }

        /* renamed from: b */
        public final void m39298b(long j, int i) {
            if (i >= 0 && i < 1000000000) {
    ...
    public int hashCode() {
        long j = this.f54538a;
        return (((((int) j) * 1369) + ((int) (j >> 32))) * 37) + this.f54539b;
    }

    @NotNull
    public final Date toDate() {
        return new Date((this.f54538a * 1000) + (this.f54539b / DurationKt.NANOS_IN_MILLIS));
    }
    ...
    public final Instant toInstant() {
        ...
        ofEpochSecond = Instant.ofEpochSecond(this.f54538a, this.f54539b);
    ...
    public String toString() {
        return "Timestamp(seconds=" + this.f54538a + ", nanoseconds=" + this.f54539b + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }

    @Override // android.os.Parcelable
    public void writeToParcel(@NotNull Parcel dest, int i) {
        Intrinsics.checkNotNullParameter(dest, "dest");
        dest.writeLong(this.f54538a);
        dest.writeInt(this.f54539b);
    }

    @Override // java.lang.Comparable
    public int compareTo(@NotNull Timestamp other) {
        Intrinsics.checkNotNullParameter(other, "other");
        return AbstractC16870uu.compareValuesBy(this, other, Timestamp$compareTo$1.INSTANCE, Timestamp$compareTo$2.INSTANCE);
    }

    public Timestamp(@NotNull Date date) {
        Intrinsics.checkNotNullParameter(date, "date");
        Companion companion = Companion;
        Pair m39299a = companion.m39299a(date);
        long longValue = ((Number) m39299a.component1()).longValue();
        int intValue = ((Number) m39299a.component2()).intValue();
        companion.m39298b(longValue, intValue);
        this.f54538a = longValue;
        this.f54539b = intValue;
    }
    ...
    */
    public Timestamp(@org.jetbrains.annotations.NotNull java.time.Instant r3) {
        /*
            ...
            long r0 = p000.AbstractC12206lT.m26809a(r3)
            int r3 = p000.AbstractC21483oU1.m26115a(r3)
            r2.<init>(r0, r3)
            return
        */
