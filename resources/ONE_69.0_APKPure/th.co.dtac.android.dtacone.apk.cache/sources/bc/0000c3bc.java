...
public final class BitmapKit {
    ...
    /* loaded from: classes5.dex */
    public static /* synthetic */ class C10008a {
        ...
        static {
            ...
            try {
                f60972a[Bitmap.Config.ALPHA_8.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f60972a[Bitmap.Config.ARGB_4444.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f60972a[Bitmap.Config.RGB_565.ordinal()] = 4;
    ...
    public static long getBitmapSizeInBytes(Bitmap bitmap) {
        ...
        if (bitmap != null && !bitmap.isRecycled()) {
            int i = C10008a.f60972a[bitmap.getConfig().ordinal()];
            if (i != 1) {
                if (i != 2) {
                    if (i != 3) {
                        if (i == 4) {
