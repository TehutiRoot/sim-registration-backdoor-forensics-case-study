...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.pre2post.viewModel.OnePre2PostViewModel$getPostCodeInfo$3 */
/* loaded from: classes10.dex */
public final class OnePre2PostViewModel$getPostCodeInfo$3 extends Lambda implements Function1<GetPostCodeInfoResponse, Unit> {
    final /* synthetic */ String $postCode;
    final /* synthetic */ OnePre2PostViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePre2PostViewModel$getPostCodeInfo$3(OnePre2PostViewModel onePre2PostViewModel, String str) {
        super(1);
    ...
    public final void invoke2(GetPostCodeInfoResponse it) {
        MutableLiveData m10869Y0;
        OnePre2PostRepository onePre2PostRepository;
        m10869Y0 = this.this$0.m10869Y0();
        m10869Y0.setValue(Resource.Companion.success(it));
        onePre2PostRepository = this.this$0.f95516c;
        Intrinsics.checkNotNullExpressionValue(it, "it");
        onePre2PostRepository.storePostCodeInfo(it, this.$postCode);
    }
}