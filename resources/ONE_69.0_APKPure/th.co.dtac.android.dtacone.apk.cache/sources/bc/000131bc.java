...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.activity.OneMnpActivity$setupObserve$1$6 */
/* loaded from: classes10.dex */
public final class OneMnpActivity$setupObserve$1$6 extends Lambda implements Function1<Resource<? extends ErrorCollection>, Unit> {
    final /* synthetic */ OneMnpActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneMnpActivity$setupObserve$1$6(OneMnpActivity oneMnpActivity) {
        super(1);
    ...
    public final void invoke2(Resource<ErrorCollection> resource) {
        ...
        if (resourceContentIfNotHandled.getStatus() == StatusResource.SUCCESS) {
            oneMnpActivity.m13987v0(resourceContentIfNotHandled.getData());
        }
    }
}