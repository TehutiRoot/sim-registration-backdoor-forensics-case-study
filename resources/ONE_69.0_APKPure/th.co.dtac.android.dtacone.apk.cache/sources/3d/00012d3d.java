...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.deviceSaleTrueCompany.fragment.OneDeviceSaleTrueSelectMaterialFragment$setObserve$1$1 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleTrueSelectMaterialFragment$setObserve$1$1 extends Lambda implements Function1<Resource<? extends ProductMasterData>, Unit> {
    ...
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.deviceSaleTrueCompany.fragment.OneDeviceSaleTrueSelectMaterialFragment$setObserve$1$1$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneDeviceSaleTrueSelectMaterialFragment$setObserve$1$1(OneDeviceSaleTrueSelectMaterialFragment oneDeviceSaleTrueSelectMaterialFragment, OneDeviceSaleTrueViewModel oneDeviceSaleTrueViewModel) {
        super(1);
    ...
    public final void invoke2(Resource<ProductMasterData> resource) {
        ...
        OneDeviceSaleTrueSelectMaterialFragment oneDeviceSaleTrueSelectMaterialFragment = this.this$0;
        OneDeviceSaleTrueViewModel oneDeviceSaleTrueViewModel = this.$this_apply;
        int i = WhenMappings.$EnumSwitchMapping$0[resourceContentIfNotHandled.getStatus().ordinal()];
        if (i != 1) {
            if (i != 2) {
                oneDeviceSaleTrueSelectMaterialFragment.m14995A();
                return;
            }
            ...
            oneFontTextView = oneDeviceSaleTrueSelectMaterialFragment.f89873l;
            if (oneFontTextView == null) {
                Intrinsics.throwUninitializedPropertyAccessException("oneDeviceSaleSelectMaterialWarningTextView");
                oneFontTextView = null;
            }
            oneFontTextView.setVisibility(8);
            recyclerView = oneDeviceSaleTrueSelectMaterialFragment.f89877p;
            if (recyclerView == null) {
                Intrinsics.throwUninitializedPropertyAccessException("oneDeviceSaleSelectMaterialCodeRecyclerView");
            } else {
                recyclerView2 = recyclerView;
            }
            recyclerView2.setVisibility(0);
            m14990q = oneDeviceSaleTrueSelectMaterialFragment.m14990q();
            List<ProductMasterInfoItem> productInfo2 = resourceContentIfNotHandled.getData().getProductInfo();
            String value = oneDeviceSaleTrueViewModel.getSearchQueryProductMaster().getValue();
            if (value == null) {
                value = "";
            }
            Intrinsics.checkNotNullExpressionValue(value, "searchQueryProductMaster.value ?: \"\"");
            m14990q.update(productInfo2, value, warningMessage);
        }
    }
}