...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.prepaid_registration.fragment.OnePrepaidCampaignListFragment$activity$2 */
/* loaded from: classes10.dex */
public final class OnePrepaidCampaignListFragment$activity$2 extends Lambda implements Function0<OnePrepaidRegistrationActivity> {
    final /* synthetic */ OnePrepaidCampaignListFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePrepaidCampaignListFragment$activity$2(OnePrepaidCampaignListFragment onePrepaidCampaignListFragment) {
        super(0);
