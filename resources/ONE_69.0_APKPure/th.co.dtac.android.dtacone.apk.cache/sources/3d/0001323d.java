...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.fragment.OneMnpReadSmartCardFragment$setupObserve$1$6 */
/* loaded from: classes10.dex */
public final class OneMnpReadSmartCardFragment$setupObserve$1$6 extends Lambda implements Function1<Resource<? extends ResponseBody>, Unit> {
    final /* synthetic */ OneMnpViewModel $this_apply;
    final /* synthetic */ OneMnpReadSmartCardFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.fragment.OneMnpReadSmartCardFragment$setupObserve$1$6$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneMnpReadSmartCardFragment$setupObserve$1$6(OneMnpReadSmartCardFragment oneMnpReadSmartCardFragment, OneMnpViewModel oneMnpViewModel) {
        super(1);
    ...
    public final void invoke2(Resource<? extends ResponseBody> resource) {
        ...
        if (i == 1) {
            ...
            if (oneMnpReadSmartCardFragment.m13787q().getPfViewModel().isCompanyTrue()) {
                oneMnpReadSmartCardFragment.m13785s();
            } else if (oneMnpViewModel.isPrepaid()) {
