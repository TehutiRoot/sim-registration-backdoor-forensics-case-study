...
public final class EnterExitTransitionKt$expandHorizontally$2 extends Lambda implements Function1<IntSize, IntSize> {
    ...
    public /* bridge */ /* synthetic */ IntSize invoke(IntSize intSize) {
        return IntSize.m73994boximpl(m69410invokemzRDjE0(intSize.m74006unboximpl()));
    }

    /* renamed from: invoke-mzRDjE0  reason: not valid java name */
    public final long m69410invokemzRDjE0(long j) {
        return IntSizeKt.IntSize(this.$initialWidth.invoke(Integer.valueOf(IntSize.m74002getWidthimpl(j))).intValue(), IntSize.m74001getHeightimpl(j));
    }
}