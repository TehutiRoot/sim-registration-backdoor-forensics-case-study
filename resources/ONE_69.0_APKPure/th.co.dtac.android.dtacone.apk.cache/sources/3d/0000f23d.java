...
public class Wire {
    ...
    /* renamed from: a */
    public final void m24807a(String str, InputStream inputStream) {
        ...
        while (true) {
            ...
            if (read == -1) {
                ...
                sb.insert(0, str);
                Log log = this.f74390a;
                log.debug(this.f74391b + HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR + sb.toString());
                sb.setLength(0);
        ...
        if (sb.length() > 0) {
            ...
            sb.insert(0, '\"');
            sb.insert(0, str);
            Log log2 = this.f74390a;
            log2.debug(this.f74391b + HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR + sb.toString());
        }
    }

    public boolean enabled() {
        return this.f74390a.isDebugEnabled();
    }
    ...
    public void input(byte[] bArr, int i, int i2) throws IOException {
        ...
        m24807a("<< ", new ByteArrayInputStream(bArr, i, i2));
    }
    ...
    public void input(byte[] bArr) throws IOException {
        Args.notNull(bArr, "Input");
        m24807a("<< ", new ByteArrayInputStream(bArr));
    }
