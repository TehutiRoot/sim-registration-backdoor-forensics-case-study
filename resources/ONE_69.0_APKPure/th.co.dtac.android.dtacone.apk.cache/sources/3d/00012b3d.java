...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.campaign.view_model.OneCampaignViewModel$joinCampaign$3 */
/* loaded from: classes10.dex */
public final class OneCampaignViewModel$joinCampaign$3 extends Lambda implements Function1<OneCommonResponse, Unit> {
    final /* synthetic */ OneCampaignViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneCampaignViewModel$joinCampaign$3(OneCampaignViewModel oneCampaignViewModel) {
        super(1);
    ...
    public final void invoke2(OneCommonResponse oneCommonResponse) {
        ...
        mutableLiveData = this.this$0.f88972D;
