...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_change_sim.MrtrChangeSimViewModel$getActivationCode$3 */
/* loaded from: classes9.dex */
public final class MrtrChangeSimViewModel$getActivationCode$3 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ MrtrChangeSimViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrChangeSimViewModel$getActivationCode$3(MrtrChangeSimViewModel mrtrChangeSimViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable it) {
        ...
        mrtrErrorService.handleException(it, new MrtrErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.viewmodel.mrtr_change_sim.MrtrChangeSimViewModel$getActivationCode$3.1
            ...
            public void handle(@Nullable Throwable th2) {
                ...
                m2382y = MrtrChangeSimViewModel.this.m2382y();
                m2382y.setValue(Resource.Companion.success(errorCollection));
            }
