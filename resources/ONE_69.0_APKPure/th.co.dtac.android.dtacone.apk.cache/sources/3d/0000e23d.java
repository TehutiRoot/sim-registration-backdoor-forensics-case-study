...
public final class DisjointKeysUnionTypeSubstitution extends TypeSubstitution {
    ...
    /* renamed from: a */
    public final TypeSubstitution f70261a;

    /* renamed from: b */
    public final TypeSubstitution f70262b;
    ...
    public boolean approximateCapturedTypes() {
        if (!this.f70261a.approximateCapturedTypes() && !this.f70262b.approximateCapturedTypes()) {
            return false;
        }
        return true;
    }
    ...
    public boolean approximateContravariantCapturedTypes() {
        if (!this.f70261a.approximateContravariantCapturedTypes() && !this.f70262b.approximateContravariantCapturedTypes()) {
            return false;
        }
        return true;
    }
    ...
    public Annotations filterAnnotations(@NotNull Annotations annotations) {
        ...
        return this.f70262b.filterAnnotations(this.f70261a.filterAnnotations(annotations));
    }
    ...
    public TypeProjection get(@NotNull KotlinType key) {
        ...
        TypeProjection typeProjection = this.f70261a.get(key);
        if (typeProjection == null) {
            return this.f70262b.get(key);
        }
    ...
    public KotlinType prepareTopLevelType(@NotNull KotlinType topLevelType, @NotNull Variance position) {
        ...
        return this.f70262b.prepareTopLevelType(this.f70261a.prepareTopLevelType(topLevelType, position), position);
    }

    public DisjointKeysUnionTypeSubstitution(TypeSubstitution typeSubstitution, TypeSubstitution typeSubstitution2) {
        this.f70261a = typeSubstitution;
        this.f70262b = typeSubstitution2;
    }
}