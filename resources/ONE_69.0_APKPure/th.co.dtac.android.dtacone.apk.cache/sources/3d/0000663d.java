...
public final class InfiniteTransitionComposeAnimation implements ComposeAnimation {
    ...
    /* renamed from: f */
    public static boolean f31750f;

    /* renamed from: a */
    public final ToolingState f31751a;

    /* renamed from: b */
    public final InfiniteTransition f31752b;

    /* renamed from: c */
    public final ComposeAnimationType f31753c;

    /* renamed from: d */
    public final Set f31754d;

    /* renamed from: e */
    public final String f31755e;

    @Metadata(m29143d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u0004J\u0013\u0010\u000b\u001a\u0004\u0018\u00010\f*\u00020\rH\u0000¢\u0006\u0002\b\u000eR\u001e\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0004@BX\u0086\u000e¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\u000f"}, m29142d2 = {"Landroidx/compose/ui/tooling/animation/InfiniteTransitionComposeAnimation$Companion;", "", "()V", "<set-?>", "", "apiAvailable", "getApiAvailable", "()Z", "testOverrideAvailability", "", "override", "parse", "Landroidx/compose/ui/tooling/animation/InfiniteTransitionComposeAnimation;", "Landroidx/compose/ui/tooling/animation/AnimationSearch$InfiniteTransitionSearchInfo;", "parse$ui_tooling_release", "ui-tooling_release"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    public static final class Companion {
        ...
        public final boolean getApiAvailable() {
            return InfiniteTransitionComposeAnimation.f31750f;
        }
        ...
        public final void testOverrideAvailability(boolean z) {
            InfiniteTransitionComposeAnimation.f31750f = z;
        }
    ...
    public final void setTimeNanos(long j) {
        this.f31751a.setValue(Long.valueOf(j));
    }

    public InfiniteTransitionComposeAnimation(ToolingState toolingState, InfiniteTransition infiniteTransition) {
        this.f31751a = toolingState;
        this.f31752b = infiniteTransition;
        this.f31753c = ComposeAnimationType.INFINITE_TRANSITION;
        this.f31754d = AbstractC23354zH1.setOf(0);
        this.f31755e = m73787getAnimationObject().getLabel();
    }

    @NotNull
    /* renamed from: getAnimationObject */
    public InfiniteTransition m73787getAnimationObject() {
        return this.f31752b;
    }
}