...
public final class LazyGridSnapLayoutInfoProviderKt {
    ...
    public static final SnapLayoutInfoProvider SnapLayoutInfoProvider(@NotNull final LazyGridState lazyGridState, @NotNull final SnapPositionInLayout positionInLayout) {
        ...
        return new SnapLayoutInfoProvider() { // from class: androidx.compose.foundation.gestures.snapping.LazyGridSnapLayoutInfoProviderKt$SnapLayoutInfoProvider$1
            /* renamed from: a */
            public final LazyGridLayoutInfo m61403a() {
                return LazyGridState.this.getLayoutInfo();
            }

            /* renamed from: b */
            public final List m61402b() {
            ...
            public float calculateApproachOffset(@NotNull Density density, float f) {
                ...
                float coerceAtLeast = AbstractC11695c.coerceAtLeast(Math.abs(DecayAnimationSpecKt.calculateTargetValue(SplineBasedDecayKt.splineBasedDecay(density), 0.0f, f)) - calculateSnapStepSize(density), 0.0f);
            ...
            public float calculateSnapStepSize(@NotNull Density density) {
                ...
                if (!m61402b().isEmpty()) {
                    int i2 = 0;
                    if (m61403a().getOrientation() == Orientation.Vertical) {
                        List m61402b = m61402b();
                        int size = m61402b.size();
                        i = 0;
                        while (i2 < size) {
                            i += IntSize.m74001getHeightimpl(((LazyGridItemInfo) m61402b.get(i2)).mo69808getSizeYbymL2g());
                            i2++;
                        }
                    } else {
                        List m61402b2 = m61402b();
                        int size2 = m61402b2.size();
                        i = 0;
                        while (i2 < size2) {
                            i += IntSize.m74002getWidthimpl(((LazyGridItemInfo) m61402b2.get(i2)).mo69808getSizeYbymL2g());
                            i2++;
                        }
                    }
                    return i / m61402b().size();
                }
                return 0.0f;
            }
            ...
            public float calculateSnappingOffset(@NotNull Density density, float f) {
                Intrinsics.checkNotNullParameter(density, "<this>");
                List<LazyGridItemInfo> visibleItemsInfo = m61403a().getVisibleItemsInfo();
                ...
                for (int i = 0; i < size; i++) {
                    LazyGridItemInfo lazyGridItemInfo = visibleItemsInfo.get(i);
                    float calculateDistanceToDesiredSnapPosition = SnapPositionInLayoutKt.calculateDistanceToDesiredSnapPosition(density, LazyGridSnapLayoutInfoProviderKt.getSingleAxisViewportSize(m61403a()), m61403a().getBeforeContentPadding(), m61403a().getAfterContentPadding(), LazyGridSnapLayoutInfoProviderKt.sizeOnMainAxis(lazyGridItemInfo, m61403a().getOrientation()), LazyGridSnapLayoutInfoProviderKt.offsetOnMainAxis(lazyGridItemInfo, m61403a().getOrientation()), lazyGridItemInfo.getIndex(), snapPositionInLayout);
    ...
    public static final int getSingleAxisViewportSize(@NotNull LazyGridLayoutInfo lazyGridLayoutInfo) {
        ...
        if (lazyGridLayoutInfo.getOrientation() == Orientation.Vertical) {
            return IntSize.m74001getHeightimpl(lazyGridLayoutInfo.mo69810getViewportSizeYbymL2g());
        }
        return IntSize.m74002getWidthimpl(lazyGridLayoutInfo.mo69810getViewportSizeYbymL2g());
    }
    ...
    public static final int offsetOnMainAxis(@NotNull LazyGridItemInfo lazyGridItemInfo, @NotNull Orientation orientation) {
        ...
        if (orientation == Orientation.Vertical) {
            return IntOffset.m73961getYimpl(lazyGridItemInfo.mo69807getOffsetnOccac());
        }
        return IntOffset.m73960getXimpl(lazyGridItemInfo.mo69807getOffsetnOccac());
    }
    ...
    public static final int sizeOnMainAxis(@NotNull LazyGridItemInfo lazyGridItemInfo, @NotNull Orientation orientation) {
        ...
        Intrinsics.checkNotNullParameter(orientation, "orientation");
        if (orientation == Orientation.Vertical) {
            return IntSize.m74001getHeightimpl(lazyGridItemInfo.mo69808getSizeYbymL2g());
        }
        return IntSize.m74002getWidthimpl(lazyGridItemInfo.mo69808getSizeYbymL2g());
    }
}