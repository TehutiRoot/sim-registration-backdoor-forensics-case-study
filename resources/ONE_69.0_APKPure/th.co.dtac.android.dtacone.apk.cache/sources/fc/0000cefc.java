...
public final class FlowableConcatWithCompletable<T> extends AbstractC0558I {

    /* renamed from: b */
    public final CompletableSource f64231b;

    public FlowableConcatWithCompletable(Flowable<T> flowable, CompletableSource completableSource) {
        super(flowable);
        this.f64231b = completableSource;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new ConcatWithSubscriber(subscriber, this.f64231b));
    }
