...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.login_mrtr.LoginMrtrViewModel$validateUsername$3 */
/* loaded from: classes9.dex */
public final class LoginMrtrViewModel$validateUsername$3 extends Lambda implements Function1<LoginCollection, LoginMrtrRequest> {
    final /* synthetic */ String $password;
    final /* synthetic */ LoginMrtrViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LoginMrtrViewModel$validateUsername$3(String str, LoginMrtrViewModel loginMrtrViewModel) {
        super(1);
        this.$password = str;
    ...
    public final LoginMrtrRequest invoke(@NotNull LoginCollection it) {
        ...
        return new LoginMrtrRequest(encryptCBC, UserNameType.USER_LAN.INSTANCE.getUserFormatType(), AESCryptUtil.encryptCBC(username, str2));
    }
}