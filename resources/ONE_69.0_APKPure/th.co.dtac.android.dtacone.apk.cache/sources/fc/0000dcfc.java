...
public final class JvmBuiltIns extends KotlinBuiltIns {
    ...
    /* renamed from: j */
    public static final /* synthetic */ KProperty[] f68628j = {Reflection.property1(new PropertyReference1Impl(Reflection.getOrCreateKotlinClass(JvmBuiltIns.class), "customizer", "getCustomizer()Lorg/jetbrains/kotlin/builtins/jvm/JvmBuiltInsCustomizer;"))};

    /* renamed from: g */
    public final Kind f68629g;

    /* renamed from: h */
    public Function0 f68630h;

    /* renamed from: i */
    public final NotNullLazyValue f68631i;
    ...
    public static final class Settings {
        ...
        /* renamed from: a */
        public final ModuleDescriptor f68632a;
        ...
        public Settings(@NotNull ModuleDescriptor ownerModuleDescriptor, boolean z) {
            ...
            this.f68632a = ownerModuleDescriptor;
            this.f68633b = z;
        }
    ...
    public JvmBuiltIns(@NotNull StorageManager storageManager, @NotNull Kind kind) {
        ...
        this.f68629g = kind;
        this.f68631i = storageManager.createLazyValue(new JvmBuiltIns$customizer$2(this, storageManager));
    ...
    public final JvmBuiltInsCustomizer getCustomizer() {
        return (JvmBuiltInsCustomizer) StorageKt.getValue(this.f68631i, this, f68628j[0]);
    }
