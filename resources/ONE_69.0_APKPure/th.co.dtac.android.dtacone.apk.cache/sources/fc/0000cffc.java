...
public final class FlowableScanSeed<T, R> extends AbstractC0558I {

    /* renamed from: b */
    public final BiFunction f64575b;

    /* renamed from: c */
    public final Callable f64576c;
    ...
    public FlowableScanSeed(Flowable<T> flowable, Callable<R> callable, BiFunction<R, ? super T, R> biFunction) {
        super(flowable);
        this.f64575b = biFunction;
        this.f64576c = callable;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super R> subscriber) {
        try {
            this.source.subscribe((FlowableSubscriber<? super Object>) new ScanSeedSubscriber(subscriber, this.f64575b, ObjectHelper.requireNonNull(this.f64576c.call(), "The seed supplied is null"), Flowable.bufferSize()));
        } catch (Throwable th2) {
            Exceptions.throwIfFatal(th2);
