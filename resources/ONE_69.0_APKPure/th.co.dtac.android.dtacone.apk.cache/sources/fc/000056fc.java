...
public final class C3196xed34cb43 extends Lambda implements Function1<InspectorInfo, Unit> {
    final /* synthetic */ boolean $scale$inlined;
    final /* synthetic */ PullRefreshState $state$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C3196xed34cb43(PullRefreshState pullRefreshState, boolean z) {
        super(1);
