...
public final class SessionLifecycleService extends Service {
    ...
    /* renamed from: a */
    public final HandlerThread f56604a = new HandlerThread("FirebaseSessions_HandlerThread");

    /* renamed from: b */
    public MessageHandler f56605b;

    /* renamed from: c */
    public Messenger f56606c;

    @Metadata(m29143d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0005\b\u0080\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0007X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u0007X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\u0007X\u0086T¢\u0006\u0002\n\u0000¨\u0006\f"}, m29142d2 = {"Lcom/google/firebase/sessions/SessionLifecycleService$Companion;", "", "()V", "BACKGROUNDED", "", "CLIENT_BOUND", "CLIENT_CALLBACK_MESSENGER", "", "FOREGROUNDED", "SESSION_UPDATED", "SESSION_UPDATE_EXTRA", "TAG", "com.google.firebase-firebase-sessions"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* loaded from: classes4.dex */
    ...
    public static final class MessageHandler extends Handler {
        ...
        /* renamed from: b */
        public final void m37609b(Message message) {
            StringBuilder sb = new StringBuilder();
            sb.append("Activity backgrounding at ");
            sb.append(message.getWhen());
            this.f56608b = message.getWhen();
        }

        /* renamed from: c */
        public final void m37608c(Message message) {
            this.f56609c.add(message.replyTo);
            ...
            sb.append(message.getWhen());
            sb.append(". Clients: ");
            sb.append(this.f56609c.size());
        }

        /* renamed from: d */
        public final void m37607d(Message message) {
            StringBuilder sb = new StringBuilder();
            ...
            if (!this.f56607a) {
                this.f56607a = true;
                m37604g();
            } else if (m37606e(message.getWhen())) {
                m37604g();
            }
            this.f56608b = message.getWhen();
        }
        ...
        /* renamed from: e */
        public final boolean m37606e(long j) {
            if (j - this.f56608b > Duration.m74731getInWholeMillisecondsimpl(SessionsSettings.Companion.getInstance().m74239getSessionRestartTimeoutUwyO8pc())) {
                return true;
            }
            return false;
        }
        ...
        /* renamed from: f */
        public final void m37605f(Messenger messenger) {
            if (this.f56607a) {
                m37603h(messenger, SessionGenerator.Companion.getInstance().getCurrentSession().getSessionId());
                return;
            }
            String currentSessionId = SessionDatastore.Companion.getInstance().getCurrentSessionId();
            if (currentSessionId != null) {
                m37603h(messenger, currentSessionId);
            }
        }

        /* renamed from: g */
        public final void m37604g() {
        ...
        /* renamed from: h */
        public final void m37603h(Messenger messenger, String str) {
            try {
    ...
    /* renamed from: a */
    public final Messenger m37611a(Intent intent) {
    ...
    public IBinder onBind(@Nullable Intent intent) {
        ...
        Messenger m37611a = m37611a(intent);
        if (m37611a != null) {
            Message obtain = Message.obtain(null, 4, 0, 0);
            obtain.replyTo = m37611a;
            MessageHandler messageHandler = this.f56605b;
            if (messageHandler != null) {
                messageHandler.sendMessage(obtain);
            }
        }
        Messenger messenger = this.f56606c;
        if (messenger == null) {
            return null;
        }
    ...
    public void onCreate() {
        super.onCreate();
        this.f56604a.start();
        Looper looper = this.f56604a.getLooper();
        Intrinsics.checkNotNullExpressionValue(looper, "handlerThread.looper");
        this.f56605b = new MessageHandler(looper);
        this.f56606c = new Messenger(this.f56605b);
    }
