...
public final class LazyGridItemProviderKt {
    ...
    public static final Function0<LazyGridItemProvider> rememberLazyGridItemProviderLambda(@NotNull LazyGridState state, @NotNull Function1<? super LazyGridScope, Unit> content, @Nullable Composer composer, int i) {
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            final State derivedStateOf = SnapshotStateKt.derivedStateOf(SnapshotStateKt.referentialEqualityPolicy(), new C2899xdf42a3b2(SnapshotStateKt.derivedStateOf(SnapshotStateKt.referentialEqualityPolicy(), new C2898x475f39b2(rememberUpdatedState)), state));
