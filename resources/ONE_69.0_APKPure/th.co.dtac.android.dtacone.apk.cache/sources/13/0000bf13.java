...
public class setScrollX implements setDarkTextColor.valueOf {
    private final setDarkTextColor values;

    public setScrollX(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.getIds(this.values);
    }
}