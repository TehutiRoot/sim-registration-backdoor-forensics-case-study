...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_change_sim.MrtrChangeSimValidateViewModel$checkSimStock$2 */
/* loaded from: classes9.dex */
public final class MrtrChangeSimValidateViewModel$checkSimStock$2 extends Lambda implements Function1<CheckSimStockResponse, Unit> {
    final /* synthetic */ MrtrChangeSimValidateViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrChangeSimValidateViewModel$checkSimStock$2(MrtrChangeSimValidateViewModel mrtrChangeSimValidateViewModel) {
        super(1);
    ...
    public final void invoke2(CheckSimStockResponse checkSimStockResponse) {
        ...
        mrtrChangeSimRepository.setCheckSimStockResponse(checkSimStockResponse);
        mutableLiveData = this.this$0.f106224m;
