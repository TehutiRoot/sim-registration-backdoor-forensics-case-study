...
public final class FlowableDebounceTimed<T> extends AbstractC0558I {

    /* renamed from: b */
    public final long f64247b;

    /* renamed from: c */
    public final TimeUnit f64248c;

    /* renamed from: d */
    public final Scheduler f64249d;
    ...
    public FlowableDebounceTimed(Flowable<T> flowable, long j, TimeUnit timeUnit, Scheduler scheduler) {
        super(flowable);
        this.f64247b = j;
        this.f64248c = timeUnit;
        this.f64249d = scheduler;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new DebounceTimedSubscriber(new SerializedSubscriber(subscriber), this.f64247b, this.f64248c, this.f64249d.createWorker()));
    }
}