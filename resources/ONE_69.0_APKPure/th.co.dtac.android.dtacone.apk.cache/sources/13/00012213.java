...
/* renamed from: th.co.dtac.android.dtacone.presenter.buy_dol.BuyDolConsentPresenter$getBuyDOLConsentByFeatureName$2 */
/* loaded from: classes8.dex */
public final class BuyDolConsentPresenter$getBuyDOLConsentByFeatureName$2 extends Lambda implements Function1<ConsentNonTelcoResponse, Unit> {
    final /* synthetic */ String $feature;
    final /* synthetic */ BuyDolConsentPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BuyDolConsentPresenter$getBuyDOLConsentByFeatureName$2(BuyDolConsentPresenter buyDolConsentPresenter, String str) {
        super(1);
    ...
    public final void invoke2(ConsentNonTelcoResponse consentNonTelcoResponse) {
        ...
        BuyDolConsentPresenter.View view3 = null;
        ...
        if ((consentNonTelco != null ? consentNonTelco.getConsent() : null) != null) {
            ...
            view3.onDisplayConsent(new BuyDolConsent(consentNonTelco.getMrtrConsentId(), consentNonTelco.getConsent()), this.$feature);
            return;
        }
        ...
        view3.onGoToNextPage(this.$feature);
    }
}