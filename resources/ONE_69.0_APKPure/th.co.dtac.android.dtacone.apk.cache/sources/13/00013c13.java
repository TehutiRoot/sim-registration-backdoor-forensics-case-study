...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.pre2post.viewModel.OnePre2PostViewModel$verifyOnePre2PostOTP$3 */
/* loaded from: classes10.dex */
public final class OnePre2PostViewModel$verifyOnePre2PostOTP$3 extends Lambda implements Function1<VerifyOtpTransactionResponse, Unit> {
    final /* synthetic */ String $otpStr;
    final /* synthetic */ OnePre2PostViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePre2PostViewModel$verifyOnePre2PostOTP$3(OnePre2PostViewModel onePre2PostViewModel, String str) {
        super(1);
    ...
    public final void invoke2(VerifyOtpTransactionResponse verifyOtpTransactionResponse) {
        MutableLiveData m10937B1;
        this.this$0.getOneModel().setOtpCode(this.$otpStr);
        m10937B1 = this.this$0.m10937B1();
        m10937B1.setValue(Resource.Companion.success(null));
    }
}