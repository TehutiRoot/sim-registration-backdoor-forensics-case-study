...
public class CameraDevice {
    ...
    */
    public static /* synthetic */ java.lang.Object m30889h(io.fotoapparat.hardware.CameraDevice r5, io.fotoapparat.hardware.metering.FocalRequest r6, kotlin.coroutines.Continuation r7) {
        /*
        ...
        L41:
            kotlin.ResultKt.throwOnFailure(r7)
            io.fotoapparat.log.Logger r7 = r5.f63020a
            r7.recordMethod()
            kotlinx.coroutines.CompletableDeferred r7 = r5.f63022c
            r0.L$0 = r5
            r0.L$1 = r6
            r0.label = r4
        ...
        L58:
            ...
            if (r7 == 0) goto L7b
            android.hardware.Camera r7 = r5.f63026g
            r2 = 0
            if (r7 != 0) goto L6b
        ...
        L6b:
            ...
            r0.L$1 = r2
            r0.label = r3
            java.lang.Object r5 = r5.m30885l(r7, r6, r0)
            if (r5 != r1) goto L78
            return r1
        L78:
        ...
        L7b:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: io.fotoapparat.hardware.CameraDevice.m30889h(io.fotoapparat.hardware.CameraDevice, io.fotoapparat.hardware.metering.FocalRequest, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static /* synthetic */ java.lang.Object m30884m(io.fotoapparat.hardware.CameraDevice r4, io.fotoapparat.parameter.camera.CameraParameters r5, kotlin.coroutines.Continuation r6) {
        /*
        ...
        L3a:
            kotlin.ResultKt.throwOnFailure(r6)
            io.fotoapparat.log.Logger r6 = r4.f63020a
            r6.recordMethod()
            io.fotoapparat.coroutines.AwaitBroadcastChannel r6 = r4.f63023d
            r0.L$0 = r4
            r0.L$1 = r5
            r0.label = r3
        ...
        L51:
            ...
            r6.log(r0)
            android.hardware.Camera$Parameters r6 = r4.f63027h
            if (r6 != 0) goto L79
            android.hardware.Camera r6 = r4.f63026g
            if (r6 != 0) goto L75
        ...
        L79:
            ...
            android.hardware.Camera$Parameters r5 = r4.m30895b(r5)
            r4.m30888i(r5)
            kotlin.Unit r4 = kotlin.Unit.INSTANCE
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: io.fotoapparat.hardware.CameraDevice.m30884m(io.fotoapparat.hardware.CameraDevice, io.fotoapparat.parameter.camera.CameraParameters, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public void attachRecordingCamera(@NotNull MediaRecorder mediaRecorder) {
        ...
        this.f63020a.recordMethod();
        Camera camera = this.f63026g;
        if (camera == null) {
    ...
    public FocusResult autoFocus() {
        ...
        return m30893d(camera);
    }

    /* renamed from: b */
    public final Camera.Parameters m30895b(Camera.Parameters parameters) {
        this.f63027h = parameters;
        return parameters;
    }

    /* renamed from: c */
    public final void m30894c(Camera camera) {
    ...
    /* renamed from: d */
    public final FocusResult m30893d(Camera camera) {
        final CountDownLatch countDownLatch = new CountDownLatch(1);
        try {
            camera.autoFocus(new Camera.AutoFocusCallback() { // from class: xj
                @Override // android.hardware.Camera.AutoFocusCallback
                public final void onAutoFocus(boolean z, Camera camera2) {
                    CameraDevice.m30896a(countDownLatch, z, camera2);
                }
            });
            try {
            ...
            Logger logger = this.f63020a;
            int cameraId = this.f63021b.getCameraId();
    ...
    public Object getCapabilities(@NotNull Continuation<? super Capabilities> continuation) {
        return m30891f(this, continuation);
    }
    ...
    public Object getParameters(@NotNull Continuation<? super CameraParameters> continuation) {
        return m30890g(this, continuation);
    }
    ...
    public Resolution getPreviewResolution() {
        ...
        Orientation orientation2 = this.f63030k;
        if (orientation2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("previewOrientation");
        } else {
            orientation = orientation2;
        }
        m30881c = CameraDeviceKt.m30881c(camera, orientation);
        this.f63020a.log("Preview resolution is: " + m30881c);
        return m30881c;
    }

    /* renamed from: i */
    public final Camera.Parameters m30888i(Camera.Parameters parameters) {
        Camera camera = this.f63026g;
        if (camera == null) {
            Intrinsics.throwUninitializedPropertyAccessException("camera");
            camera = null;
    ...
    /* renamed from: j */
    public final void m30887j(float f) {
        try {
            m30886k(f);
        } catch (Exception e) {
            Logger logger = this.f63020a;
    ...
    /* renamed from: k */
    public final void m30886k(float f) {
        Camera.Parameters parameters = this.f63027h;
        if (parameters == null) {
            Camera camera = this.f63026g;
            if (camera == null) {
                Intrinsics.throwUninitializedPropertyAccessException("camera");
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.Object m30885l(android.hardware.Camera r5, io.fotoapparat.hardware.metering.FocalRequest r6, kotlin.coroutines.Continuation r7) {
        /*
            r4 = this;
        ...
        L41:
            kotlin.ResultKt.throwOnFailure(r7)
            io.fotoapparat.hardware.orientation.Orientation r7 = r4.f63028i
            if (r7 != 0) goto L4e
        ...
        L4e:
            ...
            io.fotoapparat.characteristic.Characteristics r2 = r4.f63021b
            ...
            kotlinx.coroutines.CompletableDeferred r2 = r4.f63022c
            r0.L$0 = r6
            r0.L$1 = r7
            r0.L$2 = r7
            r0.L$3 = r5
        ...
        L9e:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: io.fotoapparat.hardware.CameraDevice.m30885l(android.hardware.Camera, io.fotoapparat.hardware.metering.FocalRequest, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public void open() {
        this.f63020a.recordMethod();
        LensPosition lensPosition = this.f63021b.getLensPosition();
        ...
        try {
            ...
            this.f63026g = open;
            CompletableDeferred completableDeferred = this.f63022c;
            Camera camera = null;
            if (open == null) {
                Intrinsics.throwUninitializedPropertyAccessException("camera");
                open = null;
            ...
            this.f63024e = new PreviewStream(camera);
    ...
    public void setDisplayOrientation(@NotNull OrientationState orientationState) {
        ...
        this.f63020a.recordMethod();
        this.f63029j = OrientationResolverKt.computeImageOrientation(orientationState.getDeviceOrientation(), this.f63021b.getCameraOrientation(), this.f63021b.isMirrored());
        this.f63028i = OrientationResolverKt.computeDisplayOrientation(orientationState.getScreenOrientation(), this.f63021b.getCameraOrientation(), this.f63021b.isMirrored());
        this.f63030k = OrientationResolverKt.computePreviewOrientation(orientationState.getScreenOrientation(), this.f63021b.getCameraOrientation(), this.f63021b.isMirrored());
        Logger logger = this.f63020a;
        ...
        Orientation cameraOrientation = this.f63021b.getCameraOrientation();
        String lineSeparator3 = StringExtensionsKt.getLineSeparator();
        if (this.f63021b.isMirrored()) {
            str = "mirrored.";
        } else {
            str = "not mirrored.";
        }
        ...
        Logger logger2 = this.f63020a;
        String lineSeparator4 = StringExtensionsKt.getLineSeparator();
        Orientation orientation = this.f63029j;
        ...
        Orientation orientation3 = this.f63028i;
        ...
        Orientation orientation4 = this.f63030k;
        ...
        PreviewStream previewStream = this.f63024e;
        if (previewStream == null) {
            Intrinsics.throwUninitializedPropertyAccessException("previewStream");
            previewStream = null;
        }
        Orientation orientation5 = this.f63030k;
        ...
        Orientation orientation6 = this.f63028i;
    ...
    public void setDisplaySurface(@NotNull Preview preview) throws IOException {
        ...
        m30880d = CameraDeviceKt.m30880d(camera, preview);
        this.f63025f = m30880d;
    }

    @Nullable
    public Object setFocalPoint(@NotNull FocalRequest focalRequest, @NotNull Continuation<? super Unit> continuation) {
        return m30889h(this, focalRequest, continuation);
    }

    public void setZoom(@FloatRange(from = 0.0d, m64694to = 1.0d) float f) {
        this.f63020a.recordMethod();
        m30887j(f);
    }
    ...
    public Photo takePhoto() {
        ...
        Orientation orientation2 = this.f63029j;
        if (orientation2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("imageOrientation");
        } else {
            orientation = orientation2;
        }
        m30879e = CameraDeviceKt.m30879e(camera, orientation.getDegrees());
        return m30879e;
    }
    ...
    public Object updateParameters(@NotNull CameraParameters cameraParameters, @NotNull Continuation<? super Unit> continuation) {
        return m30884m(this, cameraParameters, continuation);
    }
}