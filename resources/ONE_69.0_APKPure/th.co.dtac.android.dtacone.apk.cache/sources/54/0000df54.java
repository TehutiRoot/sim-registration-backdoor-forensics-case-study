...
public abstract class AbstractBinaryClassAnnotationAndConstantLoader<A, C> extends AbstractBinaryClassAnnotationLoader<A, AnnotationsContainerWithConstants<? extends A, ? extends C>> implements AnnotationAndConstantLoader<A, C> {
    ...
    /* renamed from: b */
    public final MemoizedFunctionToNotNull f69276b;
    ...
    public static final class AnnotationsContainerWithConstants<A, C> extends AbstractBinaryClassAnnotationLoader.AnnotationsContainer<A> {
        ...
        /* renamed from: a */
        public final Map f69277a;

        /* renamed from: b */
        public final Map f69278b;

        /* renamed from: c */
        public final Map f69279c;
        ...
        public AnnotationsContainerWithConstants(@NotNull Map<MemberSignature, ? extends List<? extends A>> memberAnnotations, @NotNull Map<MemberSignature, ? extends C> propertyConstants, @NotNull Map<MemberSignature, ? extends C> annotationParametersDefaultValues) {
            ...
            this.f69277a = memberAnnotations;
            this.f69278b = propertyConstants;
            this.f69279c = annotationParametersDefaultValues;
        }
    ...
    public AbstractBinaryClassAnnotationAndConstantLoader(@NotNull StorageManager storageManager, @NotNull KotlinClassFinder kotlinClassFinder) {
        ...
        this.f69276b = storageManager.createMemoizedFunction(new AbstractBinaryClassAnnotationAndConstantLoader$storage$1(this));
    }

    /* renamed from: f */
    public final AnnotationsContainerWithConstants m28560f(final KotlinJvmBinaryClass kotlinJvmBinaryClass) {
        ...
        kotlinJvmBinaryClass.visitMembers(new KotlinJvmBinaryClass.MemberVisitor() { // from class: kotlin.reflect.jvm.internal.impl.load.kotlin.AbstractBinaryClassAnnotationAndConstantLoader$loadAnnotationsAndInitializers$1
            ...
            public final class AnnotationVisitorForMethod extends MemberAnnotationVisitor implements KotlinJvmBinaryClass.MethodAnnotationVisitor {
                ...
                /* renamed from: d */
                public final /* synthetic */ C11812x2cf49cf1 f69285d;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public AnnotationVisitorForMethod(@NotNull C11812x2cf49cf1 c11812x2cf49cf1, MemberSignature signature) {
                    super(c11812x2cf49cf1, signature);
                    Intrinsics.checkNotNullParameter(signature, "signature");
                    this.f69285d = c11812x2cf49cf1;
                }
            ...
            public class MemberAnnotationVisitor implements KotlinJvmBinaryClass.AnnotationVisitor {
                ...
                /* renamed from: a */
                public final MemberSignature f69286a;

                /* renamed from: b */
                public final ArrayList f69287b;

                /* renamed from: c */
                public final /* synthetic */ C11812x2cf49cf1 f69288c;

                public MemberAnnotationVisitor(@NotNull C11812x2cf49cf1 c11812x2cf49cf1, MemberSignature signature) {
                    Intrinsics.checkNotNullParameter(signature, "signature");
                    this.f69288c = c11812x2cf49cf1;
                    this.f69286a = signature;
                    this.f69287b = new ArrayList();
                }
                ...
                public KotlinJvmBinaryClass.AnnotationArgumentVisitor visitAnnotation(@NotNull ClassId classId, @NotNull SourceElement source) {
                    Intrinsics.checkNotNullParameter(classId, "classId");
                    Intrinsics.checkNotNullParameter(source, "source");
                    return AbstractBinaryClassAnnotationAndConstantLoader.this.loadAnnotationIfNotSpecial(classId, source, this.f69287b);
                }

                @Override // kotlin.reflect.jvm.internal.impl.load.kotlin.KotlinJvmBinaryClass.AnnotationVisitor
                public void visitEnd() {
                    if (!this.f69287b.isEmpty()) {
                        hashMap.put(this.f69286a, this.f69287b);
                    }
                }
            }
    ...
    /* renamed from: g */
    public final Object m28559g(ProtoContainer protoContainer, ProtoBuf.Property property, AnnotatedCallableKind annotatedCallableKind, KotlinType kotlinType, Function2 function2) {
        Object invoke;
        ...
        if (callableSignature == null || (invoke = function2.invoke(this.f69276b.invoke(findClassWithAnnotationsAndInitializers), callableSignature)) == null) {
            return null;
        }
    ...
    public C loadAnnotationDefaultValue(@NotNull ProtoContainer container, @NotNull ProtoBuf.Property proto, @NotNull KotlinType expectedType) {
        ...
        return (C) m28559g(container, proto, AnnotatedCallableKind.PROPERTY_GETTER, expectedType, C11811xb1722d2c.INSTANCE);
    }
    ...
    public C loadPropertyConstant(@NotNull ProtoContainer container, @NotNull ProtoBuf.Property proto, @NotNull KotlinType expectedType) {
        ...
        Intrinsics.checkNotNullParameter(proto, "proto");
        Intrinsics.checkNotNullParameter(expectedType, "expectedType");
        return (C) m28559g(container, proto, AnnotatedCallableKind.PROPERTY, expectedType, C11813xb4efac6.INSTANCE);
    }
    ...
    public AnnotationsContainerWithConstants<A, C> getAnnotationsContainer(@NotNull KotlinJvmBinaryClass binaryClass) {
        ...
        return (AnnotationsContainerWithConstants) this.f69276b.invoke(binaryClass);
    }
}