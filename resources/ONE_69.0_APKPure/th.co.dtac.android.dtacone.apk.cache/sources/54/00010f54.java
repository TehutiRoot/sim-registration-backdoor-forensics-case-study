...
@Metadata(m29143d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0002\b\r\b\u0007\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0002\u001f B-\u0012\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003\u0012\n\b\u0002\u0010\u0007\u001a\u0004\u0018\u00010\u0006\u0012\n\b\u0002\u0010\t\u001a\u0004\u0018\u00010\b¢\u0006\u0004\b\n\u0010\u000bJ\u001f\u0010\u0010\u001a\u00020\u00022\u0006\u0010\r\u001a\u00020\f2\u0006\u0010\u000f\u001a\u00020\u000eH\u0016¢\u0006\u0004\b\u0010\u0010\u0011J\u001f\u0010\u0015\u001a\u00020\u00142\u0006\u0010\u0012\u001a\u00020\u00022\u0006\u0010\u0013\u001a\u00020\u000eH\u0016¢\u0006\u0004\b\u0015\u0010\u0016J\u000f\u0010\u0017\u001a\u00020\u000eH\u0016¢\u0006\u0004\b\u0017\u0010\u0018R\u001a\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00040\u00038\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0019\u0010\u001aR\u0016\u0010\u0007\u001a\u0004\u0018\u00010\u00068\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u001b\u0010\u001cR\u0016\u0010\t\u001a\u0004\u0018\u00010\b8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u001d\u0010\u001e¨\u0006!"}, m29142d2 = {"Lth/co/dtac/android/dtacone/adapter/customer_enquiry/DeviceSummaryInfoAdapter;", "Landroidx/recyclerview/widget/RecyclerView$Adapter;", "Lth/co/dtac/android/dtacone/adapter/customer_enquiry/DeviceSummaryInfoAdapter$ViewHolder;", "", "Lth/co/dtac/android/dtacone/model/customerenquiry/ContractItem;", "itemList", "", "isSamesub", "Lth/co/dtac/android/dtacone/adapter/customer_enquiry/DeviceSummaryInfoAdapter$Listener;", "listinner", "<init>", "(Ljava/util/List;Ljava/lang/Boolean;Lth/co/dtac/android/dtacone/adapter/customer_enquiry/DeviceSummaryInfoAdapter$Listener;)V", "Landroid/view/ViewGroup;", "parent", "", "viewType", "onCreateViewHolder", "(Landroid/view/ViewGroup;I)Lth/co/dtac/android/dtacone/adapter/customer_enquiry/DeviceSummaryInfoAdapter$ViewHolder;", "holder", "position", "", "onBindViewHolder", "(Lth/co/dtac/android/dtacone/adapter/customer_enquiry/DeviceSummaryInfoAdapter$ViewHolder;I)V", "getItemCount", "()I", PDPageLabelRange.STYLE_LETTERS_LOWER, "Ljava/util/List;", OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, "Ljava/lang/Boolean;", OperatorName.CURVE_TO, "Lth/co/dtac/android/dtacone/adapter/customer_enquiry/DeviceSummaryInfoAdapter$Listener;", "Listener", "ViewHolder", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0})
...
public final class DeviceSummaryInfoAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    /* renamed from: a */
    public final List f81203a;

    /* renamed from: b */
    public final Boolean f81204b;

    /* renamed from: c */
    public final Listener f81205c;

    @Metadata(m29143d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&¨\u0006\u0006"}, m29142d2 = {"Lth/co/dtac/android/dtacone/adapter/customer_enquiry/DeviceSummaryInfoAdapter$Listener;", "", "onClickDeviceExtendContract", "", "contractItem", "Lth/co/dtac/android/dtacone/model/customerenquiry/ContractItem;", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    public static final class ViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: a */
        public final Context f81206a;

        /* renamed from: b */
        public final View f81207b;

        /* renamed from: c */
        public final DtacFontTextView f81208c;

        /* renamed from: d */
        public final ConstraintLayout f81209d;

        /* renamed from: e */
        public final DtacFontTextView f81210e;

        /* renamed from: f */
        public final ImageView f81211f;

        /* renamed from: g */
        public final RecyclerView f81212g;
        ...
        public ViewHolder(@NotNull View itemView) {
            ...
            this.f81208c = (DtacFontTextView) findViewById2;
            ...
            this.f81209d = (ConstraintLayout) findViewById3;
            ...
            this.f81210e = (DtacFontTextView) findViewById4;
            ...
            this.f81211f = (ImageView) findViewById5;
            ...
            this.f81212g = (RecyclerView) findViewById6;
        }

        /* renamed from: b */
        public static /* synthetic */ void m20569b(Listener listener, ContractItem contractItem, View view) {
            m20568c(listener, contractItem, view);
        }
        ...
        /* renamed from: c */
        public static final void m20568c(Listener listener, ContractItem contractItem, View view) {
        ...
        public final void bind(int i, @NotNull final ContractItem contractItem, @Nullable Boolean bool, @Nullable final Listener listener) {
            Intrinsics.checkNotNullParameter(contractItem, "contractItem");
            if (i == 0) {
                ViewVisibleExtKt.toGone(this.f81207b);
            } else {
                ViewVisibleExtKt.toVisible(this.f81207b);
            }
            String str = null;
            if (i == 0 && Intrinsics.areEqual(bool, Boolean.TRUE)) {
                ViewVisibleExtKt.toVisible(this.f81209d);
                if (Intrinsics.areEqual(contractItem.getAllowExtendFlag(), "Y")) {
                    this.f81209d.setEnabled(true);
                    this.f81209d.setOnClickListener(new View.OnClickListener() { // from class: MI
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            DeviceSummaryInfoAdapter.ViewHolder.m20569b(DeviceSummaryInfoAdapter.Listener.this, contractItem, view);
                        }
                    });
                    this.f81210e.setTextColor(ResourcesCompat.getColor(this.f81206a.getResources(), R.color.white, null));
                    this.f81211f.setImageResource(R.drawable.icon_add);
                } else {
                    this.f81209d.setEnabled(false);
                    this.f81209d.setOnClickListener(null);
                    this.f81211f.setImageResource(R.drawable.icon_add_grey);
                    this.f81210e.setTextColor(ResourcesCompat.getColor(this.f81206a.getResources(), R.color.warmGrey, null));
                }
            } else {
                ViewVisibleExtKt.toGone(this.f81209d);
            }
            DtacFontTextView dtacFontTextView = this.f81208c;
            ...
            if (info != null) {
                RecyclerView recyclerView = this.f81212g;
                recyclerView.setLayoutManager(new LinearLayoutManager(this.itemView.getContext()));
                recyclerView.setNestedScrollingEnabled(false);
                this.f81212g.setAdapter(new DeviceSummarySubInfoAdapter(info));
            }
        }
    }
    ...
    public int getItemCount() {
        return this.f81203a.size();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public void onBindViewHolder(@NotNull ViewHolder holder, int i) {
        Intrinsics.checkNotNullParameter(holder, "holder");
        holder.bind(i, (ContractItem) this.f81203a.get(i), this.f81204b, this.f81205c);
    }
    ...
    public DeviceSummaryInfoAdapter(@NotNull List<ContractItem> itemList, @Nullable Boolean bool, @Nullable Listener listener) {
        ...
        this.f81203a = itemList;
        this.f81204b = bool;
        this.f81205c = listener;
    }
}