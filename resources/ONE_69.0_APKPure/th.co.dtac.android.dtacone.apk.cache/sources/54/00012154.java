...
/* renamed from: th.co.dtac.android.dtacone.presenter.address.QueryAddressFromDbPresenter$getProvince$1 */
/* loaded from: classes8.dex */
public final class QueryAddressFromDbPresenter$getProvince$1 extends Lambda implements Function1<SqlBrite.Query, List<? extends AddressItemData>> {
    ...
    public QueryAddressFromDbPresenter$getProvince$1(QueryAddressFromDbPresenter queryAddressFromDbPresenter, int i, int i2, int i3) {
        super(1);
    ...
    public final List<AddressItemData> invoke(SqlBrite.Query it) {
        ...
        int i = Intrinsics.areEqual(LanguageSupport.LANG_TH, this.this$0.getLanguageService().getLanguage()) ? this.$PROVINCE_NAME_TH : this.$PROVINCE_NAME_EN;
