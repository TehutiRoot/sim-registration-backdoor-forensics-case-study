...
import th.p047co.dtac.android.dtacone.model.appOne.onlineRegister.request.OneOnlineRegisterAuthorizationRequest;
...
public interface RTRApiRx2 {
    ...
    @POST("oneRetailer/onlineRegister/authorization")
    @NotNull
    Single<OneOnlineRegisterAuthorizationResponse> getOneOnlineRegisterAuthorization(@Body @NotNull OneOnlineRegisterAuthorizationRequest oneOnlineRegisterAuthorizationRequest);
