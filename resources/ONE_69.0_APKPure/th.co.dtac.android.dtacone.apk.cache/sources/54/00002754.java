...
public final class C2911xbaaa624f extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    /* loaded from: classes.dex */
    public static final class C29122 extends Lambda implements Function1<DisposableEffectScope, DisposableEffectResult> {
        final /* synthetic */ LazyLayoutItemContentFactory.CachedItemContent this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C29122(LazyLayoutItemContentFactory.CachedItemContent cachedItemContent) {
            super(1);
        ...
        public final DisposableEffectResult invoke(@NotNull DisposableEffectScope DisposableEffect) {
            ...
            return new DisposableEffectResult() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutItemContentFactory$CachedItemContent$createContentLambda$1$2$invoke$$inlined$onDispose$1
                ...
                public void dispose() {
                    LazyLayoutItemContentFactory.CachedItemContent.this.f13725d = null;
                }
            };
        }
    }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2911xbaaa624f(LazyLayoutItemContentFactory lazyLayoutItemContentFactory, LazyLayoutItemContentFactory.CachedItemContent cachedItemContent) {
        super(2);
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        int m61154f = this.this$1.m61154f();
        if ((m61154f >= invoke.getItemCount() || !Intrinsics.areEqual(invoke.getKey(m61154f), this.this$1.m61153g())) && (m61154f = invoke.getIndex(this.this$1.m61153g())) != -1) {
            this.this$1.f13724c = m61154f;
        }
        int i2 = m61154f;
        boolean z = i2 != -1;
        ...
        if (z) {
            saveableStateHolder = lazyLayoutItemContentFactory.f13719a;
            LazyLayoutItemContentFactoryKt.m61152a(invoke, OL1.m67119a(saveableStateHolder), i2, OL1.m67119a(cachedItemContent.m61153g()), composer, 0);
        } else {
            composer.deactivateToEndGroup(changed);
        }
        composer.endReusableGroup();
        EffectsKt.DisposableEffect(this.this$1.m61153g(), new C29122(this.this$1), composer, 8);
        if (ComposerKt.isTraceInProgress()) {
