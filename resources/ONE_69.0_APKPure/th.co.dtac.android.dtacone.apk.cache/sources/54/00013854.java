...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.fragment.true_company.OnePostpaidTruePackageListFragment$initView$7$1 */
/* loaded from: classes10.dex */
public final class OnePostpaidTruePackageListFragment$initView$7$1 extends Lambda implements Function1<FragmentNavEvent, Unit> {
    final /* synthetic */ OnePostpaidTruePackageListFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidTruePackageListFragment$initView$7$1(OnePostpaidTruePackageListFragment onePostpaidTruePackageListFragment) {
        super(1);
    ...
    public final void invoke2(@NotNull FragmentNavEvent it) {
        ...
        m11873s.replaceFragment(it.buildFragment(), it.getTag());
    }
}