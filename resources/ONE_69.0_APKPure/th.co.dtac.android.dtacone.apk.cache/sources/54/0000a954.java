...
final class ImmutableMapValues<K, V> extends ImmutableCollection<V> {
    ...
    /* loaded from: classes4.dex */
    public class C7618a extends UnmodifiableIterator {

        /* renamed from: a */
        public final UnmodifiableIterator f53169a;

        public C7618a() {
            this.f53169a = ImmutableMapValues.this.map.entrySet().iterator();
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            return this.f53169a.hasNext();
        }

        @Override // java.util.Iterator
        public Object next() {
            return ((Map.Entry) this.f53169a.next()).getValue();
        }
    }
