...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
    ...
    /* renamed from: a */
    public final ConstructorConstructor f56785a;
    ...
    public final class Adapter<K, V> extends TypeAdapter<Map<K, V>> {
        ...
        public void write(JsonWriter jsonWriter, Map<K, V> map) throws IOException {
            ...
            } else if (!MapTypeAdapterFactory.this.f56786b) {
    ...
    public MapTypeAdapterFactory(ConstructorConstructor constructorConstructor, boolean z) {
        this.f56785a = constructorConstructor;
        this.f56786b = z;
    }

    /* renamed from: a */
    public final TypeAdapter m37509a(Gson gson, Type type) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
        ...
        return new Adapter(gson, mapKeyAndValueTypes[0], m37509a(gson, mapKeyAndValueTypes[0]), mapKeyAndValueTypes[1], gson.getAdapter(TypeToken.get(mapKeyAndValueTypes[1])), this.f56785a.get(typeToken));
    }
}