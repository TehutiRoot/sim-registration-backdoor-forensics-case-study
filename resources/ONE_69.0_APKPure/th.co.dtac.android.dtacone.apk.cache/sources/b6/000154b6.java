...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.customerenquiry.InfoAnalyticViewModel$getPrepaidAuthorizationFamilySim$3 */
/* loaded from: classes9.dex */
public final class InfoAnalyticViewModel$getPrepaidAuthorizationFamilySim$3 extends Lambda implements Function1<GetAuthorizationByRtrResponse, Unit> {
    final /* synthetic */ InfoAnalyticViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InfoAnalyticViewModel$getPrepaidAuthorizationFamilySim$3(InfoAnalyticViewModel infoAnalyticViewModel) {
        super(1);
    ...
    public final void invoke2(GetAuthorizationByRtrResponse getAuthorizationByRtrResponse) {
        MutableLiveData m3126s0;
        m3126s0 = this.this$0.m3126s0();
        m3126s0.setValue(Resource.Companion.success(getAuthorizationByRtrResponse));
    }
}