...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.activity.OneMnpActivity$setupObserve$1$3 */
/* loaded from: classes10.dex */
public final class OneMnpActivity$setupObserve$1$3 extends Lambda implements Function1<Resource<? extends ResponseBody>, Unit> {
    final /* synthetic */ OneMnpViewModel $this_apply;
    final /* synthetic */ OneMnpActivity this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.activity.OneMnpActivity$setupObserve$1$3$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneMnpActivity$setupObserve$1$3(OneMnpActivity oneMnpActivity, OneMnpViewModel oneMnpViewModel) {
        super(1);
    ...
    public final void invoke2(Resource<? extends ResponseBody> resource) {
        ...
        OneMnpActivity oneMnpActivity = this.this$0;
        OneMnpViewModel oneMnpViewModel = this.$this_apply;
        int i = WhenMappings.$EnumSwitchMapping$0[resourceContentIfNotHandled.getStatus().ordinal()];
        if (i == 1) {
            mutableStateFlow = oneMnpActivity.f91349u;
            mutableStateFlow.setValue(Boolean.TRUE);
        } else if (i == 2) {
            mutableStateFlow2 = oneMnpActivity.f91349u;
            mutableStateFlow2.setValue(Boolean.FALSE);
            oneMnpViewModel.handleCallApiValidate();
        } else if (i != 3) {
        } else {
            mutableStateFlow3 = oneMnpActivity.f91349u;
