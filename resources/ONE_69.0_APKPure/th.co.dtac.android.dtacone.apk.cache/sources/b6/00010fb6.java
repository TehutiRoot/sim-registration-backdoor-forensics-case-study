...
public final class MrtrMultiSimPaymentDiscountAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    /* renamed from: a */
    public final Activity f81376a;

    /* renamed from: b */
    public final List f81377b;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final int $stable = 8;

    @Metadata(m29143d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0005"}, m29142d2 = {"Lth/co/dtac/android/dtacone/adapter/multi_sim/MrtrMultiSimPaymentDiscountAdapter$Companion;", "", "()V", "VIEW_TYPE_NORMAL", "", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    @Metadata(m29143d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\f\b\u0086\u0004\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005R\u0017\u0010\u000b\u001a\u00020\u00068\u0006¢\u0006\f\n\u0004\b\u0007\u0010\b\u001a\u0004\b\t\u0010\nR\u0017\u0010\u000e\u001a\u00020\u00068\u0006¢\u0006\f\n\u0004\b\f\u0010\b\u001a\u0004\b\r\u0010\nR\u0017\u0010\u0011\u001a\u00020\u00068\u0006¢\u0006\f\n\u0004\b\u000f\u0010\b\u001a\u0004\b\u0010\u0010\n¨\u0006\u0012"}, m29142d2 = {"Lth/co/dtac/android/dtacone/adapter/multi_sim/MrtrMultiSimPaymentDiscountAdapter$DiscountItemViewHolder;", "Landroidx/recyclerview/widget/RecyclerView$ViewHolder;", "Landroid/view/View;", Promotion.ACTION_VIEW, "<init>", "(Lth/co/dtac/android/dtacone/adapter/multi_sim/MrtrMultiSimPaymentDiscountAdapter;Landroid/view/View;)V", "Landroid/widget/TextView;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroid/widget/TextView;", "getTvDisCountLabel", "()Landroid/widget/TextView;", "tvDisCountLabel", OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, "getTvDisCountNumber", "tvDisCountNumber", OperatorName.CURVE_TO, "getTvDisCountValue", "tvDisCountValue", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0})
    ...
    public final class DiscountItemViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: d */
        public final /* synthetic */ MrtrMultiSimPaymentDiscountAdapter f81381d;
    ...
    public MrtrMultiSimPaymentDiscountAdapter(@NotNull Activity activity, @NotNull List<MultiSimDisCountItem> discountList) {
        ...
        this.f81376a = activity;
        this.f81377b = discountList;
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemCount() {
        return this.f81377b.size();
    }
    ...
    public void onBindViewHolder(@NotNull RecyclerView.ViewHolder holder, int i) {
        ...
        MultiSimDisCountItem multiSimDisCountItem = (MultiSimDisCountItem) this.f81377b.get(i);
        if (holder instanceof DiscountItemViewHolder) {
            ...
            discountItemViewHolder.getTvDisCountValue().setText(this.f81376a.getString(R.string.negative_value, MoneyFormatExtKt.toMoneyFormatNoFloating(multiSimDisCountItem.getCountValue())));
        }
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int i) {
        ...
        View view = LayoutInflater.from(this.f81376a).inflate(R.layout.item_multi_sim_discount, parent, false);
