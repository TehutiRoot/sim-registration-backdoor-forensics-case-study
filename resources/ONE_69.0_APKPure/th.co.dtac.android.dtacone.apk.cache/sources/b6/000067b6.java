...
public class HorizontalChainReference extends ChainReference {
    ...
    /* loaded from: classes2.dex */
    public static /* synthetic */ class C3675a {
        ...
        static {
            ...
            try {
                f32489a[State.Chain.SPREAD_INSIDE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f32489a[State.Chain.PACKED.ordinal()] = 3;
    ...
    public void apply() {
        ...
        int i = C3675a.f32489a[this.mStyle.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i == 3) {
