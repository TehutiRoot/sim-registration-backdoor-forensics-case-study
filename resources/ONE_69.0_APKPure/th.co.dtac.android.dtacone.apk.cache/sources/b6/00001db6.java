...
public class CameraAccessExceptionCompat extends Exception {
    ...
    public CameraAccessExceptionCompat(int i, @Nullable String str, @Nullable Throwable th2) {
        super(getCombinedMessage(i, str), th2);
        this.mReason = i;
        this.mCameraAccessException = PLATFORM_ERRORS.contains(Integer.valueOf(i)) ? new CameraAccessException(i, str, th2) : null;
    }

    public CameraAccessExceptionCompat(int i, @Nullable Throwable th2) {
        super(getDefaultMessage(i), th2);
        this.mReason = i;
        this.mCameraAccessException = PLATFORM_ERRORS.contains(Integer.valueOf(i)) ? new CameraAccessException(i, null, th2) : null;
    }
