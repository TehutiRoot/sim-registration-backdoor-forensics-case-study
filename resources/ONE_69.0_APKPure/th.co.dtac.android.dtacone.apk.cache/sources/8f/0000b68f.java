...
public final class NioByteString extends ByteString.LeafByteString {
    ...
    public NioByteString(ByteBuffer byteBuffer) {
        Internal.m35777b(byteBuffer, "buffer");
    ...
    public boolean isValidUtf8() {
        return Utf8.m35498s(this.buffer);
    }

    @Override // com.google.protobuf.ByteString
    public CodedInputStream newCodedInput() {
        return CodedInputStream.m37042b(this.buffer, true);
    }
    ...
    public int partialIsValidUtf8(int i, int i2, int i3) {
        return Utf8.m35495v(i, this.buffer, i2, i3 + i2);
    }
    ...
    public void writeToInternal(OutputStream outputStream, int i, int i2) throws IOException {
        ...
        AbstractC1104Pf.m66942g(slice(i, i2 + i), outputStream);
    }

    /* renamed from: com.google.protobuf.NioByteString$a */
    /* loaded from: classes4.dex */
    public class C8889a extends InputStream {

        /* renamed from: a */
        public final ByteBuffer f57406a;

        public C8889a() {
            this.f57406a = NioByteString.this.buffer.slice();
        }

        @Override // java.io.InputStream
        public int available() {
            return this.f57406a.remaining();
        }

        @Override // java.io.InputStream
        public void mark(int i) {
            ByteBuffer byteBuffer = (ByteBuffer) this.f57406a.mark();
        }
        ...
        @Override // java.io.InputStream
        public int read() {
            if (this.f57406a.hasRemaining()) {
                return this.f57406a.get() & 255;
            }
            return -1;
        }
        ...
        public void reset() {
            try {
                ByteBuffer byteBuffer = (ByteBuffer) this.f57406a.reset();
        ...
        public int read(byte[] bArr, int i, int i2) {
            if (this.f57406a.hasRemaining()) {
                int min = Math.min(i2, this.f57406a.remaining());
                this.f57406a.get(bArr, i, min);
                return min;
            }
            return -1;
        }
