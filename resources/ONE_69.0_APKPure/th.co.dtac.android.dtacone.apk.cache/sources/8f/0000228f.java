...
public final class AnimationVector2D extends AnimationVector {
    ...
    public boolean equals(@Nullable Object obj) {
        if (obj instanceof AnimationVector2D) {
            ...
            if (animationVector2D.f12536a == this.f12536a && animationVector2D.f12537b == this.f12537b) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return (Float.floatToIntBits(this.f12536a) * 31) + Float.floatToIntBits(this.f12537b);
    }
    ...
    public String toString() {
        return "AnimationVector2D: v1 = " + this.f12536a + ", v2 = " + this.f12537b;
    }
