...
/* renamed from: th.co.dtac.android.dtacone.view.fragment.customerenquiry.ShelfDownSellPackageViewFragment$createOfferPackageAdapter$1 */
/* loaded from: classes9.dex */
public final class ShelfDownSellPackageViewFragment$createOfferPackageAdapter$1 extends Lambda implements Function1<OffersPackage, Unit> {
    final /* synthetic */ List<Offer> $offerList;
    final /* synthetic */ ShelfDownSellPackageViewFragment this$0;

    @Metadata(m29143d1 = {"\u0000\b\n\u0000\n\u0002\u0010\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001H\n¢\u0006\u0002\b\u0002"}, m29142d2 = {"<anonymous>", "", "invoke"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.fragment.customerenquiry.ShelfDownSellPackageViewFragment$createOfferPackageAdapter$1$1 */
    /* loaded from: classes9.dex */
    public static final class C159371 extends Lambda implements Function0<Unit> {
        final /* synthetic */ List<Offer> $offerList;
        final /* synthetic */ OffersPackage $packageGroup;
        final /* synthetic */ ShelfDownSellPackageViewFragment this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C159371(List<Offer> list, OffersPackage offersPackage, ShelfDownSellPackageViewFragment shelfDownSellPackageViewFragment) {
            super(0);
            this.$offerList = list;
            this.$packageGroup = offersPackage;
            this.this$0 = shelfDownSellPackageViewFragment;
        }
        ...
        public final void invoke2() {
            ...
            offer.setSellingType(SellingType.Downsell);
            infoAnalyticViewModel = this.this$0.f99580m;
            ...
            if (Intrinsics.areEqual(telephoneType, TelephoneType.POSTPAID.getType())) {
                infoAnalyticViewModel3 = this.this$0.f99580m;
                ...
                infoAnalyticViewModel2 = this.this$0.f99580m;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ShelfDownSellPackageViewFragment$createOfferPackageAdapter$1(ShelfDownSellPackageViewFragment shelfDownSellPackageViewFragment, List<Offer> list) {
        super(1);
        this.this$0 = shelfDownSellPackageViewFragment;
        this.$offerList = list;
    }
    ...
    public final void invoke2(@NotNull OffersPackage packageGroup) {
        ...
        infoAnalyticViewModel.callApiExpressInterestOfferDownsell(packageGroup);
        subscriberInfoViewModel = this.this$0.f99579l;
        ...
        if (activity != null) {
            ...
            Dialog createConfirmDialogHtmlText = ActivityExtKt.createConfirmDialogHtmlText(activity, string, StringExtKt.formatMessageWithSubscriberAndPackage(string2, subscriberNumberDisplay, marketingDescriptionThai), new C159371(this.$offerList, packageGroup, this.this$0));
