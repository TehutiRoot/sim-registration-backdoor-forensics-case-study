...
public final class ObservableUsing<T, D> extends Observable<T> {
    ...
    /* renamed from: a */
    public final Callable f65695a;

    /* renamed from: b */
    public final Function f65696b;

    /* renamed from: c */
    public final Consumer f65697c;

    /* renamed from: d */
    public final boolean f65698d;
    ...
    public ObservableUsing(Callable<? extends D> callable, Function<? super D, ? extends ObservableSource<? extends T>> function, Consumer<? super D> consumer, boolean z) {
        this.f65695a = callable;
        this.f65696b = function;
        this.f65697c = consumer;
        this.f65698d = z;
    }
    ...
    public void subscribeActual(Observer<? super T> observer) {
        try {
            Object call = this.f65695a.call();
            try {
                ((ObservableSource) ObjectHelper.requireNonNull(this.f65696b.apply(call), "The sourceSupplier returned a null ObservableSource")).subscribe(new UsingObserver(observer, call, this.f65697c, this.f65698d));
            } catch (Throwable th2) {
                Exceptions.throwIfFatal(th2);
                try {
                    this.f65697c.accept(call);
