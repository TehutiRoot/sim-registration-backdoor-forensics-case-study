...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.viewModel.OneMnpViewModel$getPostCodeInfo$1$1 */
/* loaded from: classes10.dex */
public final class OneMnpViewModel$getPostCodeInfo$1$1 extends Lambda implements Function1<GetPostCodeInfoResponse, Unit> {
    final /* synthetic */ OneMnpViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneMnpViewModel$getPostCodeInfo$1$1(OneMnpViewModel oneMnpViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull GetPostCodeInfoResponse response) {
        ...
        if (!response.getData().isEmpty()) {
            ...
            oneMnpViewModel.setPostCode(data.getPostcode());
            oneMnpViewModel.setPostcodeSequenceString(String.valueOf(data.getPostcodeSequence()));
            oneMnpViewModel.setProvinceCode(data.getProvinceCode());
        }
    }
}