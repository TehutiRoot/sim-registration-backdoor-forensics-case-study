...
import androidx.camera.video.C2609a;
...
public abstract class AudioSpec {
    ...
    public static Builder builder() {
        return new C2609a.C2611b().setSourceFormat(-1).setSource(-1).setChannelCount(-1).setBitrate(BITRATE_RANGE_AUTO).setSampleRate(SAMPLE_RATE_RANGE_AUTO);
    }
