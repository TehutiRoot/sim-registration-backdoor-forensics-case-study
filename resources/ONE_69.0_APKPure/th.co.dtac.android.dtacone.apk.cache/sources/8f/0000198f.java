...
public interface ICustomTabsService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICustomTabsService {
        ...
        /* loaded from: classes.dex */
        public static class C1901a implements ICustomTabsService {

            /* renamed from: a */
            public IBinder f8525a;
            ...
            public Bundle extraCommand(String str, Bundle bundle) {
                ...
                try {
                    ...
                    _Parcel.m64987f(obtain, bundle, 0);
                    this.f8525a.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                    return (Bundle) _Parcel.m64989d(obtain2, Bundle.CREATOR);
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
            ...
            public boolean isEngagementSignalsApiAvailable(ICustomTabsCallback iCustomTabsCallback, Bundle bundle) {
                ...
                try {
                    ...
                    boolean z = false;
                    _Parcel.m64987f(obtain, bundle, 0);
                    this.f8525a.transact(13, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public boolean mayLaunchUrl(ICustomTabsCallback iCustomTabsCallback, Uri uri, Bundle bundle, List list) {
                ...
                try {
                    ...
                    obtain.writeStrongInterface(iCustomTabsCallback);
                    boolean z = false;
                    _Parcel.m64987f(obtain, uri, 0);
                    _Parcel.m64987f(obtain, bundle, 0);
                    _Parcel.m64988e(obtain, list, 0);
                    this.f8525a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public boolean newSession(ICustomTabsCallback iCustomTabsCallback) {
                ...
                try {
                    ...
                    obtain.writeStrongInterface(iCustomTabsCallback);
                    boolean z = false;
                    this.f8525a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public boolean newSessionWithExtras(ICustomTabsCallback iCustomTabsCallback, Bundle bundle) {
                ...
                try {
                    ...
                    boolean z = false;
                    _Parcel.m64987f(obtain, bundle, 0);
                    this.f8525a.transact(10, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public int postMessage(ICustomTabsCallback iCustomTabsCallback, String str, Bundle bundle) {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    _Parcel.m64987f(obtain, bundle, 0);
                    this.f8525a.transact(8, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public boolean receiveFile(ICustomTabsCallback iCustomTabsCallback, Uri uri, int i, Bundle bundle) {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    _Parcel.m64987f(obtain, bundle, 0);
                    this.f8525a.transact(12, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public boolean requestPostMessageChannel(ICustomTabsCallback iCustomTabsCallback, Uri uri) {
                ...
                try {
                    ...
                    boolean z = false;
                    _Parcel.m64987f(obtain, uri, 0);
                    this.f8525a.transact(7, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public boolean requestPostMessageChannelWithExtras(ICustomTabsCallback iCustomTabsCallback, Uri uri, Bundle bundle) {
                ...
                try {
                    ...
                    _Parcel.m64987f(obtain, uri, 0);
                    _Parcel.m64987f(obtain, bundle, 0);
                    this.f8525a.transact(11, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public boolean setEngagementSignalsCallback(ICustomTabsCallback iCustomTabsCallback, IBinder iBinder, Bundle bundle) {
                ...
                try {
                    ...
                    boolean z = false;
                    _Parcel.m64987f(obtain, bundle, 0);
                    this.f8525a.transact(14, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public boolean updateVisuals(ICustomTabsCallback iCustomTabsCallback, Bundle bundle) {
                ...
                try {
                    ...
                    boolean z = false;
                    _Parcel.m64987f(obtain, bundle, 0);
                    this.f8525a.transact(6, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public boolean validateRelationship(ICustomTabsCallback iCustomTabsCallback, int i, Uri uri, Bundle bundle) {
                ...
                try {
                    ...
                    _Parcel.m64987f(obtain, uri, 0);
                    _Parcel.m64987f(obtain, bundle, 0);
                    this.f8525a.transact(9, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public boolean warmup(long j) {
                ...
                try {
                    ...
                    obtain.writeLong(j);
                    boolean z = false;
                    this.f8525a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 4:
                    ...
                    boolean mayLaunchUrl = mayLaunchUrl(ICustomTabsCallback.Stub.asInterface(parcel.readStrongBinder()), (Uri) _Parcel.m64989d(parcel, Uri.CREATOR), (Bundle) _Parcel.m64989d(parcel, creator), parcel.createTypedArrayList(creator));
                    parcel2.writeNoException();
                    parcel2.writeInt(mayLaunchUrl ? 1 : 0);
                    break;
                case 5:
                    Bundle extraCommand = extraCommand(parcel.readString(), (Bundle) _Parcel.m64989d(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
                    _Parcel.m64987f(parcel2, extraCommand, 1);
                    break;
                case 6:
                    boolean updateVisuals = updateVisuals(ICustomTabsCallback.Stub.asInterface(parcel.readStrongBinder()), (Bundle) _Parcel.m64989d(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
                    parcel2.writeInt(updateVisuals ? 1 : 0);
                    break;
                case 7:
                    boolean requestPostMessageChannel = requestPostMessageChannel(ICustomTabsCallback.Stub.asInterface(parcel.readStrongBinder()), (Uri) _Parcel.m64989d(parcel, Uri.CREATOR));
                    parcel2.writeNoException();
                    parcel2.writeInt(requestPostMessageChannel ? 1 : 0);
                    break;
                case 8:
                    int postMessage = postMessage(ICustomTabsCallback.Stub.asInterface(parcel.readStrongBinder()), parcel.readString(), (Bundle) _Parcel.m64989d(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
                    parcel2.writeInt(postMessage);
                    break;
                case 9:
                    boolean validateRelationship = validateRelationship(ICustomTabsCallback.Stub.asInterface(parcel.readStrongBinder()), parcel.readInt(), (Uri) _Parcel.m64989d(parcel, Uri.CREATOR), (Bundle) _Parcel.m64989d(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
                    parcel2.writeInt(validateRelationship ? 1 : 0);
                    break;
                case 10:
                    boolean newSessionWithExtras = newSessionWithExtras(ICustomTabsCallback.Stub.asInterface(parcel.readStrongBinder()), (Bundle) _Parcel.m64989d(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
                    parcel2.writeInt(newSessionWithExtras ? 1 : 0);
                    break;
                case 11:
                    boolean requestPostMessageChannelWithExtras = requestPostMessageChannelWithExtras(ICustomTabsCallback.Stub.asInterface(parcel.readStrongBinder()), (Uri) _Parcel.m64989d(parcel, Uri.CREATOR), (Bundle) _Parcel.m64989d(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
                    parcel2.writeInt(requestPostMessageChannelWithExtras ? 1 : 0);
                    break;
                case 12:
                    boolean receiveFile = receiveFile(ICustomTabsCallback.Stub.asInterface(parcel.readStrongBinder()), (Uri) _Parcel.m64989d(parcel, Uri.CREATOR), parcel.readInt(), (Bundle) _Parcel.m64989d(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
                    parcel2.writeInt(receiveFile ? 1 : 0);
                    break;
                case 13:
                    boolean isEngagementSignalsApiAvailable = isEngagementSignalsApiAvailable(ICustomTabsCallback.Stub.asInterface(parcel.readStrongBinder()), (Bundle) _Parcel.m64989d(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
                    parcel2.writeInt(isEngagementSignalsApiAvailable ? 1 : 0);
                    break;
                case 14:
                    boolean engagementSignalsCallback = setEngagementSignalsCallback(ICustomTabsCallback.Stub.asInterface(parcel.readStrongBinder()), parcel.readStrongBinder(), (Bundle) _Parcel.m64989d(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
    ...
    public static class _Parcel {
        /* renamed from: d */
        public static Object m64989d(Parcel parcel, Parcelable.Creator creator) {
            if (parcel.readInt() != 0) {
        ...
        /* renamed from: e */
        public static void m64988e(Parcel parcel, List list, int i) {
            if (list == null) {
                parcel.writeInt(-1);
                return;
            }
            ...
            for (int i2 = 0; i2 < size; i2++) {
                m64987f(parcel, (Parcelable) list.get(i2), i);
            }
        }

        /* renamed from: f */
        public static void m64987f(Parcel parcel, Parcelable parcelable, int i) {
            if (parcelable != null) {
                parcel.writeInt(1);
