...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.fragment.true_company.OnePostpaidTruePackageListFragment$initView$7$2 */
/* loaded from: classes10.dex */
public final class OnePostpaidTruePackageListFragment$initView$7$2 extends Lambda implements Function1<StatusResource, Unit> {
    final /* synthetic */ OnePostpaidTruePackageListFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidTruePackageListFragment$initView$7$2(OnePostpaidTruePackageListFragment onePostpaidTruePackageListFragment) {
        super(1);
    ...
    public final void invoke2(StatusResource statusResource) {
        this.this$0.m11872t(statusResource);
    }
}