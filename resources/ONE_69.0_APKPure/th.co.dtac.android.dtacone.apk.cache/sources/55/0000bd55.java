...
public abstract class AbstractC9660oo {
    ...
    public AbstractC9660oo(int i, int i2, int i3, int i4) {
        int i5;
    ...
    public String ThreeDS2ServiceInstance(byte[] bArr) {
        return C9719ro.get(valueOf(bArr));
    }

    public byte[] ThreeDS2ServiceInstance(String str) {
        return values(C9719ro.ThreeDS2Service(str));
    }
}