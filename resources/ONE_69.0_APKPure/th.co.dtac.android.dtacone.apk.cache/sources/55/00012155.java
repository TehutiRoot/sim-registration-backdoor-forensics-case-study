...
/* renamed from: th.co.dtac.android.dtacone.presenter.address.QueryAddressFromDbPresenter$getProvince$2 */
/* loaded from: classes8.dex */
public final class QueryAddressFromDbPresenter$getProvince$2 extends Lambda implements Function1<List<? extends AddressItemData>, Unit> {
    final /* synthetic */ QueryAddressFromDbPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public QueryAddressFromDbPresenter$getProvince$2(QueryAddressFromDbPresenter queryAddressFromDbPresenter) {
        super(1);
