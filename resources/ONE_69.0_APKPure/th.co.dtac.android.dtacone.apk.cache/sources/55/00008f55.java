...
public final class zzhn implements zzjm {
    ...
    /* renamed from: a */
    public static Object m47914a(Type type, List list, String str) {
                    ...
                    if (zzar.length() != 0) {
                        ...
                        if (zzao != null) {
                            ...
                            if (zzjs.zzc(zza)) {
                                ...
                                zzisVar.zza(zzao.zzig(), zzb, m47914a(zzb, asList, zzar2));
                                ...
                                collection.add(m47914a(zze, asList, zzar2));
                            } else {
                                zzao.zzb(obj, m47914a(zza, asList, zzar2));
                            }
                        } else if (map != null) {
