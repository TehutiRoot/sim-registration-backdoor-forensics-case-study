...
public class DeviceName {
    ...
    public static final class DeviceInfo {
        ...
        public String getName() {
            if (TextUtils.isEmpty(this.marketName)) {
                return DeviceName.m33707b(this.model);
            }
    ...
    public static final class Request {
        ...
        /* renamed from: b */
        public final Handler f58373b;

        /* renamed from: c */
        public String f58374c;

        /* renamed from: d */
        public String f58375d;

        /* renamed from: com.jaredrummler.android.device.DeviceName$Request$a */
        /* loaded from: classes5.dex */
        public final class RunnableC9106a implements Runnable {

            /* renamed from: a */
            public final Callback f58376a;

            /* renamed from: b */
            public DeviceInfo f58377b;

            /* renamed from: c */
            public Exception f58378c;

            /* renamed from: com.jaredrummler.android.device.DeviceName$Request$a$a */
            /* loaded from: classes5.dex */
            public class RunnableC9107a implements Runnable {
                public RunnableC9107a() {
                }

                @Override // java.lang.Runnable
                public void run() {
                    RunnableC9106a runnableC9106a = RunnableC9106a.this;
                    runnableC9106a.f58376a.onFinished(runnableC9106a.f58377b, runnableC9106a.f58378c);
                }
            }

            public RunnableC9106a(Callback callback) {
            ...
            public void run() {
                try {
                    ...
                    this.f58377b = DeviceName.getDeviceInfo(request.f58372a, request.f58374c, request.f58375d);
                } catch (Exception e) {
                    this.f58378c = e;
                }
                Request.this.f58373b.post(new RunnableC9107a());
            }
        }

        public void request(Callback callback) {
            if (this.f58374c == null && this.f58375d == null) {
                this.f58374c = Build.DEVICE;
                this.f58375d = Build.MODEL;
            }
            RunnableC9106a runnableC9106a = new RunnableC9106a(callback);
            if (Looper.myLooper() == Looper.getMainLooper()) {
                new Thread(runnableC9106a).start();
            } else {
                runnableC9106a.run();
            }
        }
        ...
        public Request(Context context) {
            ...
            this.f58373b = new Handler(context.getMainLooper());
        }
    }

    /* renamed from: b */
    public static String m33707b(String str) {
        char[] charArray;
    ...
    /* renamed from: c */
    public static String m33706c(String str) {
    ...
    public static String getDeviceName() {
        ...
        return getDeviceName(str, str2, m33707b(str2));
    }
    ...
    public static DeviceInfo getDeviceInfo(Context context, String str, String str2) {
        ...
        if (context.checkCallingOrSelfPermission("android.permission.ACCESS_NETWORK_STATE") != 0 || ((activeNetworkInfo = ((ConnectivityManager) context.getSystemService("connectivity")).getActiveNetworkInfo()) != null && activeNetworkInfo.isConnected())) {
            try {
                JSONArray jSONArray = new JSONArray(m33706c(String.format("https://raw.githubusercontent.com/jaredrummler/AndroidDeviceNames/master/json/devices/%s.json", str.toLowerCase(Locale.ENGLISH))));
