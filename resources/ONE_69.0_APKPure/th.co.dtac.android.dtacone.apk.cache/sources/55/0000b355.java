...
public interface ReflectionAccessFilter {
    public static final ReflectionAccessFilter BLOCK_INACCESSIBLE_JAVA = new C8674a();
    public static final ReflectionAccessFilter BLOCK_ALL_JAVA = new C8675b();
    public static final ReflectionAccessFilter BLOCK_ALL_ANDROID = new C8676c();
    public static final ReflectionAccessFilter BLOCK_ALL_PLATFORM = new C8677d();
    ...
    /* loaded from: classes4.dex */
    public class C8674a implements ReflectionAccessFilter {
    ...
    /* loaded from: classes4.dex */
    public class C8675b implements ReflectionAccessFilter {
        @Override // com.google.gson.ReflectionAccessFilter
        public FilterResult check(Class cls) {
            if (ReflectionAccessFilterHelper.isJavaType(cls)) {
    ...
    /* loaded from: classes4.dex */
    public class C8676c implements ReflectionAccessFilter {
        @Override // com.google.gson.ReflectionAccessFilter
        public FilterResult check(Class cls) {
    ...
    /* loaded from: classes4.dex */
    public class C8677d implements ReflectionAccessFilter {
        @Override // com.google.gson.ReflectionAccessFilter
        public FilterResult check(Class cls) {
