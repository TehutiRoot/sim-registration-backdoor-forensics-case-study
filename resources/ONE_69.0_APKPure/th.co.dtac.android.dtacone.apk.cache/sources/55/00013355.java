...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.viewModel.OneMnpViewModel$callApiGetTrueLocation$4 */
/* loaded from: classes10.dex */
public final class OneMnpViewModel$callApiGetTrueLocation$4 extends Lambda implements Function1<OneCommonTrueLocationResponse, Unit> {
    final /* synthetic */ OneMnpViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneMnpViewModel$callApiGetTrueLocation$4(OneMnpViewModel oneMnpViewModel) {
        super(1);
