...
public interface ObservableCollection {
    ...
    public static class RealmChangeListenerWrapper<T> implements OrderedRealmCollectionChangeListener<T> {
        ...
        /* renamed from: a */
        public final RealmChangeListener f66745a;

        public RealmChangeListenerWrapper(RealmChangeListener<T> realmChangeListener) {
            this.f66745a = realmChangeListener;
        }

        public boolean equals(Object obj) {
            if ((obj instanceof RealmChangeListenerWrapper) && this.f66745a == ((RealmChangeListenerWrapper) obj).f66745a) {
                return true;
            }
            return false;
        }
