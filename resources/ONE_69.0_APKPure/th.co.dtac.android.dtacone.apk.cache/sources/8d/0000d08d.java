...
public final class MaybeDoFinally<T> extends AbstractC1707Y {

    /* renamed from: a */
    public final Action f64830a;
    ...
    public void subscribeActual(MaybeObserver<? super T> maybeObserver) {
        this.source.subscribe(new DoFinallyObserver(maybeObserver, this.f64830a));
    }
}