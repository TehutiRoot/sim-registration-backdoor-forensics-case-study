...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.registration.fragment.OneSetPasswordFragment$initViewModel$1$4 */
/* loaded from: classes10.dex */
public final class OneSetPasswordFragment$initViewModel$1$4 extends Lambda implements Function1<StatusResource, Unit> {
    final /* synthetic */ OneSetPasswordFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneSetPasswordFragment$initViewModel$1$4(OneSetPasswordFragment oneSetPasswordFragment) {
        super(1);
    ...
    public final void invoke2(StatusResource statusResource) {
        this.this$0.m10424s(statusResource);
    }
}