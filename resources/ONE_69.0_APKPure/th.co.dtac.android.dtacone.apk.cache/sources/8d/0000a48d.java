...
public final class Http extends GeneratedMessageLite<Http, Builder> implements HttpOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Http, Builder> implements HttpOrBuilder {
        ...
        public Builder addAllRules(Iterable<? extends HttpRule> iterable) {
            copyOnWrite();
            ((Http) this.instance).m42810K(iterable);
            return this;
        }

        public Builder addRules(HttpRule httpRule) {
            copyOnWrite();
            ((Http) this.instance).m42808M(httpRule);
            return this;
        }

        public Builder clearFullyDecodeReservedExpansion() {
            copyOnWrite();
            ((Http) this.instance).m42807N();
            return this;
        }

        public Builder clearRules() {
            copyOnWrite();
            ((Http) this.instance).m42806O();
            return this;
        }
        ...
        public Builder addRules(int i, HttpRule httpRule) {
            copyOnWrite();
            ((Http) this.instance).m42809L(i, httpRule);
            return this;
        }

        public Builder setRules(int i, HttpRule.Builder builder) {
            copyOnWrite();
            ((Http) this.instance).m42802S(i, builder.build());
            return this;
        }

        public Builder addRules(HttpRule.Builder builder) {
            copyOnWrite();
            ((Http) this.instance).m42808M(builder.build());
            return this;
        }

        public Builder addRules(int i, HttpRule.Builder builder) {
            copyOnWrite();
            ((Http) this.instance).m42809L(i, builder.build());
            return this;
        }
    }
    ...
    public static /* synthetic */ class C7201a {
        ...
        static {
            ...
            try {
                f51630a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f51630a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f51630a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f51630a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f51630a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f51630a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: K */
    public void m42810K(Iterable iterable) {
        m42805P();
    ...
    /* renamed from: L */
    public final void m42809L(int i, HttpRule httpRule) {
        httpRule.getClass();
        m42805P();
    ...
    /* renamed from: M */
    public final void m42808M(HttpRule httpRule) {
        httpRule.getClass();
        m42805P();
    ...
    /* renamed from: N */
    public final void m42807N() {
        this.fullyDecodeReservedExpansion_ = false;
    }

    /* renamed from: R */
    public final void m42803R(boolean z) {
        this.fullyDecodeReservedExpansion_ = z;
    }

    /* renamed from: S */
    public final void m42802S(int i, HttpRule httpRule) {
        httpRule.getClass();
        m42805P();
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C7201a.f51630a[methodToInvoke.ordinal()]) {
            case 1:
                return new Http();
            case 2:
