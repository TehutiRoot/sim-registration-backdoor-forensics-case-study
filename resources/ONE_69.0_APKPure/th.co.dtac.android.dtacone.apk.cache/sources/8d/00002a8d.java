...
public final class BottomSheetScaffoldKt$BottomSheetScaffold$child$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    @Metadata(m29143d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\u000b¢\u0006\u0004\b\u0004\u0010\u0005"}, m29142d2 = {"<anonymous>", "", "layoutHeight", "", "invoke", "(ILandroidx/compose/runtime/Composer;I)V"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    /* loaded from: classes.dex */
    public static final class C30631 extends Lambda implements Function3<Integer, Composer, Integer, Unit> {
        final /* synthetic */ int $$dirty;
        final /* synthetic */ int $$dirty1;
        final /* synthetic */ float $peekHeightPx;
        final /* synthetic */ BottomSheetScaffoldState $scaffoldState;
        ...
        public C30631(boolean z, BottomSheetScaffoldState bottomSheetScaffoldState, float f, float f2, Shape shape, float f3, long j, long j2, Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, int i, int i2) {
            super(3);
        ...
        public final void invoke(int i, @Nullable Composer composer, int i2) {
            ...
            if (this.$sheetGesturesEnabled) {
                ...
                if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                    rememberedValue = BottomSheetScaffoldKt.m60888d(bottomSheetScaffoldState.getBottomSheetState().getAnchoredDraggableState$material_release(), Orientation.Vertical);
            ...
            Modifier m69739requiredHeightInVpY3zN4$default = SizeKt.m69739requiredHeightInVpY3zN4$default(SizeKt.fillMaxWidth$default(modifier, 0.0f, 1, null), this.$sheetPeekHeight, 0.0f, 2, null);
            ...
            int i4 = this.$$dirty;
            int i5 = this.$$dirty1;
            BottomSheetScaffoldKt.m60891a(bottomSheetState, z, (Function1) rememberedValue2, shape, f2, j, j2, m69739requiredHeightInVpY3zN4$default, function3, composer, ((i4 >> 18) & 112) | ((i4 >> 15) & 7168) | ((i4 >> 15) & 57344) | ((i5 << 15) & 458752) | ((i5 << 15) & 3670016) | ((i4 << 24) & 234881024), 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final class C30642 extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C30642(Function3<? super SnackbarHostState, ? super Composer, ? super Integer, Unit> function3, BottomSheetScaffoldState bottomSheetScaffoldState, int i) {
            super(2);
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer, -1378534681, true, new C30631(this.$sheetGesturesEnabled, this.$scaffoldState, this.$sheetPeekHeight, this.$peekHeightPx, this.$sheetShape, this.$sheetElevation, this.$sheetBackgroundColor, this.$sheetContentColor, this.$sheetContent, this.$$dirty, this.$$dirty1));
        Function2<Composer, Integer, Unit> function22 = this.$floatingActionButton;
        ComposableLambda composableLambda2 = ComposableLambdaKt.composableLambda(composer, -486138068, true, new C30642(this.$snackbarHost, this.$scaffoldState, this.$$dirty));
        ...
        composer.endReplaceableGroup();
        int i3 = this.$$dirty;
        BottomSheetScaffoldKt.m60889c(function2, function3, composableLambda, function22, composableLambda2, f, i2, (Function0) rememberedValue, bottomSheetState, composer, ((i3 >> 9) & 14) | 24960 | ((this.$$dirty2 >> 3) & 112) | ((i3 >> 6) & 7168) | ((this.$$dirty1 << 9) & 458752) | (i3 & 3670016));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    }
