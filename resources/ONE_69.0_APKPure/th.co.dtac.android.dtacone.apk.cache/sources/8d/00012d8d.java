...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.deviceSaleTrueCompany.fragment.OneDeviceSaleTrueVerifyCampaignFragment$setupObserve$1$6 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleTrueVerifyCampaignFragment$setupObserve$1$6 extends Lambda implements Function1<Resource<? extends String>, Unit> {
    ...
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.deviceSaleTrueCompany.fragment.OneDeviceSaleTrueVerifyCampaignFragment$setupObserve$1$6$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneDeviceSaleTrueVerifyCampaignFragment$setupObserve$1$6(OneDeviceSaleTrueVerifyCampaignFragment oneDeviceSaleTrueVerifyCampaignFragment, OneDeviceSaleTrueViewModel oneDeviceSaleTrueViewModel) {
        super(1);
    ...
    public final void invoke2(Resource<String> resource) {
        ...
        if (WhenMappings.$EnumSwitchMapping$0[resourceContentIfNotHandled.getStatus().ordinal()] == 1) {
            ...
            m14944m = oneDeviceSaleTrueVerifyCampaignFragment.m14944m();
            m14944m.showDialogConfirmTakeReferenceDoc(new OneDeviceSaleTrueVerifyCampaignFragment$setupObserve$1$6$1$1(oneDeviceSaleTrueVerifyCampaignFragment), new OneDeviceSaleTrueVerifyCampaignFragment$setupObserve$1$6$1$2(str, oneDeviceSaleTrueViewModel));
        }
    }
}