...
public class GF2mMatrix extends Matrix {
    ...
    public GF2mMatrix(GF2mField gF2mField, byte[] bArr) {
        ...
        if (i3 > 0) {
            ...
            if ((bArr.length - 4) % i4 == 0) {
                ...
                this.matrix = (int[][]) Array.newInstance(Integer.TYPE, i3, length);
    ...
    public Matrix computeInverse() {
        ...
        if (i2 == this.numColumns) {
            int[][] iArr = (int[][]) Array.newInstance(Integer.TYPE, i2, i2);
            for (int i3 = this.numRows - 1; i3 >= 0; i3--) {
                iArr[i3] = IntUtils.clone(this.matrix[i3]);
            }
            int i4 = this.numRows;
            int[][] iArr2 = (int[][]) Array.newInstance(Integer.TYPE, i4, i4);
