...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.topup.viewModel.OneTopUpViewModel$getPriceList$3 */
/* loaded from: classes10.dex */
public final class OneTopUpViewModel$getPriceList$3 extends Lambda implements Function1<OneBuyDolPriceListResponse, Unit> {
    final /* synthetic */ String $featureCode;
    final /* synthetic */ OneTopUpViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneTopUpViewModel$getPriceList$3(String str, OneTopUpViewModel oneTopUpViewModel) {
        super(1);
    ...
    public final void invoke2(OneBuyDolPriceListResponse oneBuyDolPriceListResponse) {
        ...
        m9214Z.setValue(Resource.Companion.success(pair));
    }
}