        ...
        if (8 % i6 == 0) {
            ...
            while (i14 < i3) {
                ...
                while (i16 < i10) {
                    ...
                    bArr3[i20] = (byte) (bArr3[i20] >>> winternitzOTSVerify.f75574w);
                    i15++;
                    i16++;
                    i12 = i18;
                    i14 = i20;
            ...
            if (i6 < 8) {
                ...
                while (i31 < i26) {
                    ...
                    long j2 = 0;
                    int i33 = 0;
                    while (i33 < winternitzOTSVerify.f75574w) {
                    ...
                    while (i36 < i9) {
                        ...
                        j2 >>>= winternitzOTSVerify.f75574w;
                        i35++;
                        i36++;
                        i27 = i27;
                        i31 = i31;
                ...
                int i40 = log;
                int i41 = i27;
                int i42 = winternitzOTSVerify.mdsize % winternitzOTSVerify.f75574w;
                int i43 = 0;
                while (i43 < i42) {
                ...
                while (i46 < i45) {
                    ...
                    int i50 = winternitzOTSVerify.f75574w;
                    j >>>= i50;
                    i44++;
                    i46 += i50;
                    i29 = i48;
                }
                int i51 = (i5 << winternitzOTSVerify.f75574w) - i29;
                int i52 = 0;
                while (i52 < i40) {
                    int i53 = winternitzOTSVerify.mdsize;
                    hashSignatureBlock(bArr2, i44 * i53, i41 - (i51 & i41), bArr4, i44 * i53);
                    int i54 = winternitzOTSVerify.f75574w;
                    i51 >>>= i54;
                    i44++;
                    i52 += i54;
                }
                ...
                while (i57 <= i55) {
                    ...
                    int i61 = i57 % 8;
                    int i62 = i55;
                    int i63 = i57 + winternitzOTSVerify.f75574w;
                    int i64 = (i63 + 7) >>> 3;
                    long j3 = 0;
                    int i65 = 0;
                    while (i60 < i64) {
                ...
                int i76 = (i71 << winternitzOTSVerify.f75574w) - i58;
                int i77 = 0;
                while (i77 < log) {
                    ...
                    int i80 = winternitzOTSVerify.f75574w;
                    i76 >>>= i80;
                    i59++;
                    i77 += i80;
                }
