...
import th.p047co.dtac.android.dtacone.view.fragment.device_sale.DeviceSaleScanIMEIFragment$onStart$1$4;
import th.p047co.dtac.android.dtacone.viewmodel.device_sale.DeviceSaleViewModel;

/* renamed from: th.co.dtac.android.dtacone.view.fragment.device_sale.DeviceSaleScanIMEIFragment$onStart$1$4 */
/* loaded from: classes9.dex */
public final class DeviceSaleScanIMEIFragment$onStart$1$4 implements Observer {

    /* renamed from: a */
    public final /* synthetic */ DeviceSaleScanIMEIFragment f99985a;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.fragment.device_sale.DeviceSaleScanIMEIFragment$onStart$1$4$WhenMappings */
    /* loaded from: classes9.dex */
    ...
    public DeviceSaleScanIMEIFragment$onStart$1$4(DeviceSaleScanIMEIFragment deviceSaleScanIMEIFragment) {
        this.f99985a = deviceSaleScanIMEIFragment;
    }

    /* renamed from: c */
    public static final void m8080c(DeviceSaleScanIMEIFragment this$0) {
    ...
    public final void onChanged(Resource resource) {
        ...
        if (resource != null && (resourceContentIfNotHandled = resource.getResourceContentIfNotHandled()) != null) {
            final DeviceSaleScanIMEIFragment deviceSaleScanIMEIFragment = this.f99985a;
                    ...
                    if (i == 3) {
                        ...
                        new Handler().postDelayed(new Runnable() { // from class: XH
                            ...
                            public final void run() {
                                DeviceSaleScanIMEIFragment$onStart$1$4.m8080c(deviceSaleScanIMEIFragment);
                            }
                        }, 1000L);
                        return;
                    }
            ...
            if (ctx != null) {
                ...
                deviceSaleViewModel.getNeedUpdateSubscribeInfo().postValue(new Event<>(toastMessage));
            }
            deviceSaleScanIMEIFragment.dismissSecondaryLoading();
