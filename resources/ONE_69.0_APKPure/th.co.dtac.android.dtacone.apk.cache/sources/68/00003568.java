...
@Metadata(m29143d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m29142d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "__3dRotation", "Landroidx/compose/material/icons/Icons$Filled;", "get_3dRotation", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "_3dRotation", "material-icons-extended_release"}, m29141k = 2, m29140mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\n_3dRotation.kt\nKotlin\n*S Kotlin\n*F\n+ 1 _3dRotation.kt\nandroidx/compose/material/icons/filled/_3dRotationKt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,130:1\n122#2:131\n116#2,3:132\n119#2,3:136\n132#2,18:139\n152#2:176\n174#3:135\n694#4,2:157\n706#4,2:159\n708#4,11:165\n64#5,4:161\n*S KotlinDebug\n*F\n+ 1 _3dRotation.kt\nandroidx/compose/material/icons/filled/_3dRotationKt\n*L\n29#1:131\n29#1:132,3\n29#1:136,3\n30#1:139,18\n30#1:176\n29#1:135\n30#1:157,2\n30#1:159,2\n30#1:165,11\n30#1:161,4\n*E\n"})
/* loaded from: classes.dex */
public final class _3dRotationKt {

    /* renamed from: a */
    public static ImageVector f16942a;

    @NotNull
    public static final ImageVector get_3dRotation(@NotNull Icons.Filled filled) {
        Intrinsics.checkNotNullParameter(filled, "<this>");
        ImageVector imageVector = f16942a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Filled._3dRotation", C3623Dp.m73842constructorimpl(24.0f), C3623Dp.m73842constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.curveToRelative(0.13f, -0.29f, 0.2f, -0.61f, 0.2f, -0.97f);
        ...
        pathBuilder.curveToRelative(0.05f, -0.16f, 0.07f, -0.32f, 0.07f, -0.48f);
        pathBuilder.curveToRelative(0.0f, -0.36f, -0.06f, -0.68f, -0.18f, -0.96f);
        pathBuilder.curveToRelative(-0.12f, -0.28f, -0.29f, -0.51f, -0.51f, -0.69f);
        ...
        pathBuilder.curveToRelative(0.11f, -0.09f, 0.23f, -0.17f, 0.38f, -0.22f);
        pathBuilder.curveToRelative(0.15f, -0.05f, 0.3f, -0.08f, 0.48f, -0.08f);
        ...
        pathBuilder.curveToRelative(-0.05f, 0.15f, -0.14f, 0.27f, -0.25f, 0.37f);
        ...
        pathBuilder.curveToRelative(0.07f, 0.16f, 0.1f, 0.35f, 0.1f, 0.57f);
        ...
        pathBuilder.curveToRelative(0.45f, -0.18f, 0.84f, -0.43f, 1.16f, -0.76f);
