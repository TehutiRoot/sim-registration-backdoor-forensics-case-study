...
public final class Type1FontUtil {
    /* renamed from: a */
    public static byte[] m33000a(byte[] bArr, int i, int i2) {
    ...
    /* renamed from: b */
    public static byte[] m32999b(byte[] bArr, int i, int i2) {
        int length = bArr.length + i2;
