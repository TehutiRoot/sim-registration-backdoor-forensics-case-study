...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.prepaid_registration.fragment.OneScanBarcodeSimFragment$setUpViewModel$1$5 */
/* loaded from: classes10.dex */
public final class OneScanBarcodeSimFragment$setUpViewModel$1$5 extends Lambda implements Function1<Resource<? extends ErrorCollection>, Unit> {
    final /* synthetic */ OneScanBarcodeSimFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneScanBarcodeSimFragment$setUpViewModel$1$5(OneScanBarcodeSimFragment oneScanBarcodeSimFragment) {
        super(1);
    ...
    public final void invoke2(Resource<ErrorCollection> resource) {
        ...
        oneToast.createToastTop(m10674p, data).show();
