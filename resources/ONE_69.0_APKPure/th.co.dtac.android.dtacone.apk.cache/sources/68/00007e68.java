...
public final class RealViewSizeResolver<T extends View> implements ViewSizeResolver<T> {
    ...
    @NotNull
    public T getView() {
        return (T) this.f40842a;
    }

    public int hashCode() {
        return (getView().hashCode() * 31) + AbstractC1694Xp.m65565a(getSubtractPadding());
    }

    @Override // coil.size.ViewSizeResolver, coil.size.SizeResolver
    public /* synthetic */ Object size(Continuation continuation) {
        return ViewSizeResolver.CC.m51028b(this, continuation);
    }
}