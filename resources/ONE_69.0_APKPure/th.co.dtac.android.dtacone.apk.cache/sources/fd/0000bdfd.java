...
public class setCompoundDrawablePadding implements setSelected.valueOf {
    private final com.netcetera.threeds.sdk.api.ThreeDS2Service ThreeDS2ServiceInstance;

    public setCompoundDrawablePadding(com.netcetera.threeds.sdk.api.ThreeDS2Service threeDS2Service) {
    ...
    public Object ThreeDS2ServiceInstance() {
        return this.ThreeDS2ServiceInstance.getSDKInfo();
    }
}