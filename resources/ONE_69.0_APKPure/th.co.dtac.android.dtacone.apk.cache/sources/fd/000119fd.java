...
public class WhatNewCollection {
    ...
    public static class Android implements Parcelable {
        public static final Parcelable.Creator<Android> CREATOR = new C14222a();
        ...
        /* loaded from: classes8.dex */
        public class C14222a implements Parcelable.Creator {
    ...
    public static class IOS implements Parcelable {
        public static final Parcelable.Creator<IOS> CREATOR = new C14223a();
        @SerializedName("bannerUrl")
        private String bannerUrl;
        @SerializedName("latestBuild")
        private int latestBuild;
        ...
        /* loaded from: classes8.dex */
        public class C14223a implements Parcelable.Creator {
            @Override // android.os.Parcelable.Creator
            /* renamed from: a */
