...
public final class NavController$handleDeepLink$2 extends Lambda implements Function1<NavOptionsBuilder, Unit> {
    ...
    @Metadata(m29143d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n¢\u0006\u0002\b\u0003"}, m29142d2 = {"<anonymous>", "", "Landroidx/navigation/AnimBuilder;", "invoke"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: androidx.navigation.NavController$handleDeepLink$2$1 */
    /* loaded from: classes2.dex */
    public static final class C47881 extends Lambda implements Function1<AnimBuilder, Unit> {
    ...
    /* loaded from: classes2.dex */
    public static final class C47892 extends Lambda implements Function1<PopUpToBuilder, Unit> {
        public static final C47892 INSTANCE = new C47892();
    ...
    public final void invoke2(@NotNull NavOptionsBuilder navOptions) {
        ...
        navOptions.anim(C47881.INSTANCE);
        ...
        if (navDestination instanceof NavGraph) {
            ...
            z = NavController.f36318I;
            if (z) {
                navOptions.popUpTo(NavGraph.Companion.findStartDestination(this.this$0.getGraph()).getId(), C47892.INSTANCE);
            }
        }
    }
}