...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.sellerID.fragment.OneShopListFragment$onViewCreated$2$1 */
/* loaded from: classes10.dex */
public final class OneShopListFragment$onViewCreated$2$1 extends Lambda implements Function1<Resource<? extends String>, Unit> {
    final /* synthetic */ OneShopListFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneShopListFragment$onViewCreated$2$1(OneShopListFragment oneShopListFragment) {
        super(1);
    ...
    public final void invoke2(Resource<String> resource) {
        ...
        if (resourceContentIfNotHandled.getStatus() == StatusResource.SUCCESS) {
            m10038m = oneShopListFragment.m10038m();
            m10038m.goToOneHomeActivity();
        }
    }
}