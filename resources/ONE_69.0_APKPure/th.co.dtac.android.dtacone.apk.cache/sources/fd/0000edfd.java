...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    private final boolean verifyHostname(String str, String str2) {
        if (str != null && str.length() != 0 && !AbstractC19741eO1.startsWith$default(str, ".", false, 2, null) && !AbstractC19741eO1.endsWith$default(str, CallerDataConverter.DEFAULT_RANGE_DELIMITER, false, 2, null) && str2 != null && str2.length() != 0 && !AbstractC19741eO1.startsWith$default(str2, ".", false, 2, null) && !AbstractC19741eO1.endsWith$default(str2, CallerDataConverter.DEFAULT_RANGE_DELIMITER, false, 2, null)) {
            if (!AbstractC19741eO1.endsWith$default(str, ".", false, 2, null)) {
                str = Intrinsics.stringPlus(str, ".");
            }
            String str3 = str;
            if (!AbstractC19741eO1.endsWith$default(str2, ".", false, 2, null)) {
                str2 = Intrinsics.stringPlus(str2, ".");
            }
            String asciiToLowercase = asciiToLowercase(str2);
            if (!StringsKt__StringsKt.contains$default((CharSequence) asciiToLowercase, (CharSequence) Marker.ANY_MARKER, false, 2, (Object) null)) {
                return Intrinsics.areEqual(str3, asciiToLowercase);
            }
            if (!AbstractC19741eO1.startsWith$default(asciiToLowercase, "*.", false, 2, null) || StringsKt__StringsKt.indexOf$default((CharSequence) asciiToLowercase, '*', 1, false, 4, (Object) null) != -1 || str3.length() < asciiToLowercase.length() || Intrinsics.areEqual("*.", asciiToLowercase)) {
                return false;
            }
            String substring = asciiToLowercase.substring(1);
            Intrinsics.checkNotNullExpressionValue(substring, "this as java.lang.String).substring(startIndex)");
            if (AbstractC19741eO1.endsWith$default(str3, substring, false, 2, null)) {
