...
public final class MaybeUsing<T, D> extends Maybe<T> {
    ...
    /* renamed from: a */
    public final Callable f64966a;

    /* renamed from: b */
    public final Function f64967b;

    /* renamed from: c */
    public final Consumer f64968c;
    ...
    public MaybeUsing(Callable<? extends D> callable, Function<? super D, ? extends MaybeSource<? extends T>> function, Consumer<? super D> consumer, boolean z) {
        this.f64966a = callable;
        this.f64967b = function;
        this.f64968c = consumer;
        this.f64969d = z;
    }
    ...
    public void subscribeActual(MaybeObserver<? super T> maybeObserver) {
        try {
            Object call = this.f64966a.call();
            try {
                ((MaybeSource) ObjectHelper.requireNonNull(this.f64967b.apply(call), "The sourceSupplier returned a null MaybeSource")).subscribe(new UsingObserver(maybeObserver, call, this.f64968c, this.f64969d));
            } catch (Throwable th2) {
                Exceptions.throwIfFatal(th2);
                if (this.f64969d) {
                    try {
                        this.f64968c.accept(call);
                    } catch (Throwable th3) {
                        Exceptions.throwIfFatal(th3);
