...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.esim.ESimViewModel$cutSimStockForPhysical$1$2 */
/* loaded from: classes9.dex */
public final class ESimViewModel$cutSimStockForPhysical$1$2 extends Lambda implements Function1<CutSimStockResponse, Unit> {
    final /* synthetic */ ESimViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimViewModel$cutSimStockForPhysical$1$2(ESimViewModel eSimViewModel) {
        super(1);
    ...
    public final void invoke2(CutSimStockResponse cutSimStockResponse) {
        this.this$0.setCutSimStockResponsePhysical(cutSimStockResponse);
        this.this$0.m2769I();
    }
}