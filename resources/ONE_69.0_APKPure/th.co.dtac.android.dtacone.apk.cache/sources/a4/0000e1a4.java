...
public final class MemberDeserializer$loadProperty$4 extends Lambda implements Function0<NullableLazyValue<? extends ConstantValue<?>>> {
    ...
    /* loaded from: classes6.dex */
    public static final class C119321 extends Lambda implements Function0<ConstantValue<?>> {
        final /* synthetic */ DeserializedPropertyDescriptor $property;
        final /* synthetic */ ProtoBuf.Property $proto;
        final /* synthetic */ MemberDeserializer this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C119321(MemberDeserializer memberDeserializer, ProtoBuf.Property property, DeserializedPropertyDescriptor deserializedPropertyDescriptor) {
            super(0);
        ...
        public final ConstantValue<?> invoke() {
            ...
            return annotationAndConstantLoader.loadPropertyConstant(m28010a, property, returnType);
        }
    }
    ...
    public final NullableLazyValue<? extends ConstantValue<?>> invoke() {
        ...
        return deserializationContext.getStorageManager().createNullableLazyValue(new C119321(this.this$0, this.$proto, this.$property));
    }
}