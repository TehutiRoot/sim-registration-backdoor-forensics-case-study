...
/* renamed from: th.co.dtac.android.dtacone.view.fragment.mrtr_change_sim.qrCode.ESimChangeSIMShowQrCodeFragment$initViewModel$1$3 */
/* loaded from: classes9.dex */
public final class ESimChangeSIMShowQrCodeFragment$initViewModel$1$3 extends Lambda implements Function1<Resource<? extends SendQRCodeRequest>, Unit> {
    final /* synthetic */ ESimChangeSIMShowQrCodeFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.fragment.mrtr_change_sim.qrCode.ESimChangeSIMShowQrCodeFragment$initViewModel$1$3$WhenMappings */
    /* loaded from: classes9.dex */
    ...
    public ESimChangeSIMShowQrCodeFragment$initViewModel$1$3(ESimChangeSIMShowQrCodeFragment eSimChangeSIMShowQrCodeFragment) {
        super(1);
    ...
    public final void invoke2(Resource<SendQRCodeRequest> resource) {
        ...
        if (i == 2) {
            ...
            if (Intrinsics.areEqual(data != null ? data.getType() : null, "email")) {
                bottomSheetDialog2 = this.this$0.f101982j;
                ...
                bottomSheetDialog = this.this$0.f101989q;
            ...
            if (Intrinsics.areEqual(data2 != null ? data2.getType() : null, "email")) {
                ...
                textView2 = this.this$0.f101996x;
                if (textView2 == null) {
