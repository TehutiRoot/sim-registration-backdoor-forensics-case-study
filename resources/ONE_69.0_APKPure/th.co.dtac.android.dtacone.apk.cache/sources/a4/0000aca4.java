...
public final class Bytes {
    ...
    public static class ByteArrayAsList extends AbstractList<Byte> implements RandomAccess, Serializable {
        ...
        public boolean contains(@CheckForNull Object obj) {
            if ((obj instanceof Byte) && Bytes.m39861d(this.array, ((Byte) obj).byteValue(), this.start, this.end) != -1) {
                return true;
            }
            return false;
        }
        ...
        public int indexOf(@CheckForNull Object obj) {
            int m39861d;
            if ((obj instanceof Byte) && (m39861d = Bytes.m39861d(this.array, ((Byte) obj).byteValue(), this.start, this.end)) >= 0) {
                return m39861d - this.start;
            }
            return -1;
        }
        ...
        public int lastIndexOf(@CheckForNull Object obj) {
            int m39860e;
            if ((obj instanceof Byte) && (m39860e = Bytes.m39860e(this.array, ((Byte) obj).byteValue(), this.start, this.end)) >= 0) {
                return m39860e - this.start;
            }
            return -1;
        }
    ...
    /* renamed from: c */
    public static int m39862c(long j) {
        boolean z;
        int i = (int) j;
        if (j == i) {
            z = true;
    ...
    /* renamed from: d */
    public static int m39861d(byte[] bArr, byte b, int i, int i2) {
        while (i < i2) {
            if (bArr[i] == b) {
                return i;
            }
    ...
    /* renamed from: e */
    public static int m39860e(byte[] bArr, byte b, int i, int i2) {
    ...
    public static int indexOf(byte[] bArr, byte b) {
        return m39861d(bArr, b, 0, bArr.length);
    }

    public static int lastIndexOf(byte[] bArr, byte b) {
        return m39860e(bArr, b, 0, bArr.length);
    }
