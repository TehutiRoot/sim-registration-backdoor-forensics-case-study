...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.deviceSaleTrueCompany.fragment.common.OneDeviceSaleNavigateToCommonFragment$initView$1$2 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleNavigateToCommonFragment$initView$1$2 extends Lambda implements Function1<FragmentNavEvent, Unit> {
    final /* synthetic */ OneDeviceSaleNavigateToCommonFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneDeviceSaleNavigateToCommonFragment$initView$1$2(OneDeviceSaleNavigateToCommonFragment oneDeviceSaleNavigateToCommonFragment) {
        super(1);
    ...
    public final void invoke2(@NotNull FragmentNavEvent it) {
        ...
        viewModel.getOneModel().setChangeIMEI(false);
        this.this$0.m14940m().replaceFragment(it.buildFragment(), it.getTag());
    }
}