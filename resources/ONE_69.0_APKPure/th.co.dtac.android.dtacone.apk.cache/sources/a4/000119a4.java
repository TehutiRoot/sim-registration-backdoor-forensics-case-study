...
public final class CommonHeaderInterceptor implements Interceptor {
    ...
    /* renamed from: a */
    public final TemporaryCache f85044a;

    /* renamed from: b */
    public final UdidService f85045b;

    /* renamed from: c */
    public final TelephonyManager f85046c;

    /* renamed from: d */
    public final LocationManager f85047d;

    /* renamed from: e */
    public final LanguageService f85048e;

    /* renamed from: f */
    public final RtrRx2Repository f85049f;

    /* renamed from: g */
    public final PreferencesRepository f85050g;

    /* renamed from: h */
    public final PreferencesViewModel f85051h;

    /* renamed from: i */
    public final RtrRepository f85052i;
    ...
    public CommonHeaderInterceptor(@NotNull TemporaryCache temporaryCache, @NotNull UdidService udidService, @NotNull TelephonyManager telephonyManager, @NotNull LocationManager locationManager, @NotNull LanguageService languageService, @NotNull RtrRx2Repository rtrRepository, @NotNull PreferencesRepository pfRepository, @NotNull PreferencesViewModel pfViewModel, @NotNull RtrRepository oldRtrRepository) {
        ...
        this.f85044a = temporaryCache;
        this.f85045b = udidService;
        this.f85046c = telephonyManager;
        this.f85047d = locationManager;
        this.f85048e = languageService;
        this.f85049f = rtrRepository;
        this.f85050g = pfRepository;
        this.f85051h = pfViewModel;
        this.f85052i = oldRtrRepository;
    }

    /* renamed from: a */
    public final String m19455a() {
    ...
    /* renamed from: b */
    public final Request m19454b(Request request) {
        String str;
        String str2;
        String str3;
        String simR;
        ...
        String string = this.f85050g.getString(Constant.KEEP_FLAVOR_KEY);
        Intrinsics.checkNotNullExpressionValue(string, "pfRepository.getString(Constant.KEEP_FLAVOR_KEY)");
        string.length();
        Request.Builder newBuilder = request.newBuilder();
        Request.Builder header = newBuilder.header("Content-Type", "application/json").header("Accept", "application/json").header("App-Version", StringEscapeUtils.escapeString(BuildConfig.VERSION_NAME) + " 298").header("Client-OS", "android " + Build.VERSION.RELEASE).header("Jail-Status", str);
        String MODEL = Build.MODEL;
        Intrinsics.checkNotNullExpressionValue(MODEL, "MODEL");
        Request.Builder header2 = header.header("Client-Model", MODEL);
        String androidID = this.f85045b.getAndroidID();
        ...
        String language = this.f85048e.getLanguage();
        ...
        if (this.f85052i.getHeaderApplication() != null) {
            String headerApplication = this.f85052i.getHeaderApplication();
        ...
        if (this.f85047d.isProviderEnabled("gps") && (latitudeLongitude = this.f85044a.getLatitudeLongitude()) != null && latitudeLongitude.length() != 0) {
            String latitudeLongitude2 = this.f85044a.getLatitudeLongitude();
        ...
        SessionEntity sessionNow = this.f85049f.getSessionNow();
        ...
        } else if (StringUtil.hasText(this.f85044a.getToken())) {
            String token3 = this.f85044a.getToken();
        ...
        } else if (StringUtil.hasText(this.f85044a.getRetailerNumber())) {
            String retailerNumber = this.f85044a.getRetailerNumber();
        ...
        String cliNumber = this.f85044a.getCliNumber();
        if (cliNumber != null) {
            newBuilder.header("Cli-Number", cliNumber);
        }
        String sessionId = this.f85044a.getSessionId();
        if (sessionId != null) {
            newBuilder.header("X-Feature-Session-ID", sessionId);
        }
        String it = this.f85051h.getCompany();
        Intrinsics.checkNotNullExpressionValue(it, "it");
        newBuilder.header("X-Company", it);
        newBuilder.header("X-Request-Id", m19455a());
    ...
    public Response intercept(@NotNull Interceptor.Chain chain) throws IOException {
        ...
        return chain.proceed(m19454b(chain.request()));
    }
}