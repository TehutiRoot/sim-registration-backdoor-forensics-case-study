...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.deviceSaleTrueCompany.viewModel.OneDeviceSaleTrueViewModel$customerPreverify$3 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleTrueViewModel$customerPreverify$3 extends Lambda implements Function1<OneCustomerPreverifyResponse, Unit> {
    final /* synthetic */ OneDeviceSaleTrueViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneDeviceSaleTrueViewModel$customerPreverify$3(OneDeviceSaleTrueViewModel oneDeviceSaleTrueViewModel) {
        super(1);
    ...
    public final void invoke2(OneCustomerPreverifyResponse oneCustomerPreverifyResponse) {
        ...
        MutableLiveData m14795x0;
        this.this$0.getLiveDataState().setValue(StatusResource.DISMISS);
        oneDeviceSaleTrueRepository = this.this$0.f90027b;
        oneDeviceSaleTrueRepository.getDeviceSaleModel().setCustomerPreverifyResponse(oneCustomerPreverifyResponse.getData());
        m14795x0 = this.this$0.m14795x0();
        m14795x0.setValue(new Event(new FragmentNavEvent(OneDeviceSaleTrueScanIMEIFragment.class, null, OneDeviceSaleTrueScanIMEIFragment.TAG)));
    }
}