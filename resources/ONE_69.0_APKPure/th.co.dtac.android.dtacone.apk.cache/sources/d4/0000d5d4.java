...
@DebugMetadata(m29093c = "io.realm.internal.coroutines.InternalFlowFactory$from$5", m29092f = "InternalFlowFactory.kt", m29091i = {}, m29090l = {314, 342}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
...
public final class InternalFlowFactory$from$5 extends SuspendLambda implements Function2<ProducerScope<? super RealmList<T>>, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes5.dex */
    public static final class C113331 extends Lambda implements Function0<Unit> {
        public static final C113331 INSTANCE = new C113331();
    ...
    /* loaded from: classes5.dex */
    public static final class C113342 extends Lambda implements Function0<Unit> {
        final /* synthetic */ Realm $flowRealm;
        final /* synthetic */ RealmChangeListener<RealmList<T>> $listener;
        final /* synthetic */ RealmList<T> $realmList;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C113342(Realm realm, RealmList<T> realmList, RealmChangeListener<RealmList<T>> realmChangeListener) {
            super(0);
    ...
    public static final void m74261invokeSuspend$lambda0(ProducerScope producerScope, InternalFlowFactory internalFlowFactory, RealmList realmList) {
        boolean z;
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (!this.$realmList.isValid()) {
            C113331 c113331 = C113331.INSTANCE;
            this.label = 1;
            if (ProduceKt.awaitClose(producerScope, c113331, this) == coroutine_suspended) {
        ...
        RealmChangeListener realmChangeListener = new RealmChangeListener() { // from class: io.realm.internal.coroutines.k
            ...
            public final void onChange(Object obj2) {
                InternalFlowFactory$from$5.m74261invokeSuspend$lambda0(ProducerScope.this, internalFlowFactory, (RealmList) obj2);
            }
        };
        ...
        C113342 c113342 = new C113342(realm, this.$realmList, realmChangeListener);
        this.label = 2;
        if (ProduceKt.awaitClose(producerScope, c113342, this) == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Unit.INSTANCE;
    }
