...
public final class AndroidVectorParser {
    ...
    public static /* synthetic */ AndroidVectorParser copy$default(AndroidVectorParser androidVectorParser, XmlPullParser xmlPullParser, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            xmlPullParser = androidVectorParser.f29626a;
        }
        if ((i2 & 2) != 0) {
            i = androidVectorParser.f29627b;
        }
        return androidVectorParser.copy(xmlPullParser, i);
    }

    /* renamed from: a */
    public final void m59592a(int i) {
        this.f29627b = i | this.f29627b;
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof AndroidVectorParser) {
            ...
            return Intrinsics.areEqual(this.f29626a, androidVectorParser.f29626a) && this.f29627b == androidVectorParser.f29627b;
        }
        return false;
    }
    ...
    public final float getDimension(@NotNull TypedArray typedArray, int i, float f) {
        ...
        m59592a(typedArray.getChangingConfigurations());
        return dimension;
    }
    ...
    public final boolean getNamedBoolean(@NotNull TypedArray typedArray, @NotNull String attrName, @StyleableRes int i, boolean z) {
        ...
        boolean namedBoolean = TypedArrayUtils.getNamedBoolean(typedArray, this.f29626a, attrName, i, z);
        m59592a(typedArray.getChangingConfigurations());
        return namedBoolean;
    }
    ...
    public final ColorStateList getNamedColorStateList(@NotNull TypedArray typedArray, @Nullable Resources.Theme theme, @NotNull String attrName, @StyleableRes int i) {
        Intrinsics.checkNotNullParameter(typedArray, "typedArray");
        Intrinsics.checkNotNullParameter(attrName, "attrName");
        ColorStateList namedColorStateList = TypedArrayUtils.getNamedColorStateList(typedArray, this.f29626a, theme, attrName, i);
        m59592a(typedArray.getChangingConfigurations());
    ...
    public final ComplexColorCompat getNamedComplexColor(@NotNull TypedArray typedArray, @Nullable Resources.Theme theme, @NotNull String attrName, @StyleableRes int i, @ColorInt int i2) {
        Intrinsics.checkNotNullParameter(typedArray, "typedArray");
        Intrinsics.checkNotNullParameter(attrName, "attrName");
        ComplexColorCompat result = TypedArrayUtils.getNamedComplexColor(typedArray, this.f29626a, theme, attrName, i, i2);
        m59592a(typedArray.getChangingConfigurations());
    ...
    public final float getNamedFloat(@NotNull TypedArray typedArray, @NotNull String attrName, @StyleableRes int i, float f) {
        Intrinsics.checkNotNullParameter(typedArray, "typedArray");
        Intrinsics.checkNotNullParameter(attrName, "attrName");
        float namedFloat = TypedArrayUtils.getNamedFloat(typedArray, this.f29626a, attrName, i, f);
        m59592a(typedArray.getChangingConfigurations());
        return namedFloat;
    }
    ...
    public final int getNamedInt(@NotNull TypedArray typedArray, @NotNull String attrName, @StyleableRes int i, int i2) {
        Intrinsics.checkNotNullParameter(typedArray, "typedArray");
        Intrinsics.checkNotNullParameter(attrName, "attrName");
        int namedInt = TypedArrayUtils.getNamedInt(typedArray, this.f29626a, attrName, i, i2);
        m59592a(typedArray.getChangingConfigurations());
        return namedInt;
    }
    ...
    public int hashCode() {
        return (this.f29626a.hashCode() * 31) + this.f29627b;
    }
    ...
    public final TypedArray obtainAttributes(@NotNull Resources res, @Nullable Resources.Theme theme, @NotNull AttributeSet set, @NotNull int[] attrs) {
        ...
        m59592a(obtainAttributes.getChangingConfigurations());
    ...
    public String toString() {
        return "AndroidVectorParser(xmlParser=" + this.f29626a + ", config=" + this.f29627b + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
