...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.buyDol.viewModel.OneBuyDolViewModel$getPaymentInfo$2 */
/* loaded from: classes10.dex */
public final class OneBuyDolViewModel$getPaymentInfo$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ OneBuyDolViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneBuyDolViewModel$getPaymentInfo$2(OneBuyDolViewModel oneBuyDolViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable throwable) {
        ...
        m15884b0.setValue(Resource.Companion.error$default(Resource.Companion, "", null, null, 4, null));
