...
public class MagicNumberFileFilter extends AbstractFileFilter implements Serializable {
    ...
    /* renamed from: a */
    public static /* synthetic */ Boolean m25441a(MagicNumberFileFilter magicNumberFileFilter, RandomAccessFile randomAccessFile) {
    ...
    public boolean accept(File file) {
        ...
        if (file != null && file.isFile() && file.canRead()) {
            try {
                ...
                path = file.toPath();
                return ((Boolean) randomAccessFileMode.apply(path, new IOFunction() { // from class: Dn0
                    ...
                    public final Object apply(Object obj) {
                        return MagicNumberFileFilter.m25441a(MagicNumberFileFilter.this, (RandomAccessFile) obj);
                    }
