...
public final class ChuckerDatabase_Impl extends ChuckerDatabase {
    ...
    /* renamed from: m */
    public volatile HttpTransactionDao f42914m;

    /* renamed from: com.chuckerteam.chucker.internal.data.room.ChuckerDatabase_Impl$a */
    /* loaded from: classes3.dex */
    public class C5948a extends RoomOpenHelper.Delegate {
        public C5948a(int i) {
            super(i);
        }
    ...
    public SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration databaseConfiguration) {
        return databaseConfiguration.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(databaseConfiguration.context).name(databaseConfiguration.name).callback(new RoomOpenHelper(databaseConfiguration, new C5948a(9), "ac72c06b37efb89e6417a7707016d4f5", "a70b1841a05694f746087779f5a5c887")).build());
    }
    ...
    public HttpTransactionDao transactionDao() {
        ...
        synchronized (this) {
            try {
                if (this.f42914m == null) {
                    this.f42914m = new HttpTransactionDao_Impl(this);
                }
                httpTransactionDao = this.f42914m;
            } catch (Throwable th2) {
                throw th2;
            }
        }
