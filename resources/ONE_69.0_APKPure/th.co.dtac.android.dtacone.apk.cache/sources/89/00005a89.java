...
public final class SliderKt$Slider$4 extends Lambda implements Function3<SliderPositions, Composer, Integer, Unit> {
    ...
    public final void invoke(@NotNull SliderPositions sliderPositions, @Nullable Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(686671625, i, -1, "androidx.compose.material3.Slider.<anonymous> (Slider.kt:176)");
        }
