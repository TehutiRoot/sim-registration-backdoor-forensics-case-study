...
public final class QJ1 extends AbstractSignatureParts {

    /* renamed from: a */
    public final Annotated f5193a;

    /* renamed from: b */
    public final boolean f5194b;

    /* renamed from: c */
    public final LazyJavaResolverContext f5195c;

    /* renamed from: d */
    public final AnnotationQualifierApplicabilityType f5196d;

    /* renamed from: e */
    public final boolean f5197e;

    public /* synthetic */ QJ1(Annotated annotated, boolean z, LazyJavaResolverContext lazyJavaResolverContext, AnnotationQualifierApplicabilityType annotationQualifierApplicabilityType, boolean z2, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public Iterable getContainerAnnotations() {
        ...
        Annotated annotated = this.f5193a;
    ...
    public JavaTypeQualifiersByElementType getContainerDefaultTypeQualifiers() {
        return this.f5195c.getDefaultTypeQualifiers();
    }
    ...
    public boolean getEnableImprovementsInStrictMode() {
        return this.f5195c.getComponents().getSettings().getTypeEnhancementImprovementsInStrictMode();
    }
    ...
    public boolean isEqual(KotlinTypeMarker kotlinTypeMarker, KotlinTypeMarker other) {
        ...
        return this.f5195c.getComponents().getKotlinTypeChecker().equalTypes((KotlinType) kotlinTypeMarker, (KotlinType) other);
    }
    ...
    public AnnotationTypeQualifierResolver getAnnotationTypeQualifierResolver() {
        return this.f5195c.getComponents().getAnnotationTypeQualifierResolver();
    }
    ...
    public QJ1(Annotated annotated, boolean z, LazyJavaResolverContext containerContext, AnnotationQualifierApplicabilityType containerApplicabilityType, boolean z2) {
        Intrinsics.checkNotNullParameter(containerContext, "containerContext");
        Intrinsics.checkNotNullParameter(containerApplicabilityType, "containerApplicabilityType");
        this.f5193a = annotated;
        this.f5194b = z;
        this.f5195c = containerContext;
        this.f5196d = containerApplicabilityType;
        this.f5197e = z2;
    }
}