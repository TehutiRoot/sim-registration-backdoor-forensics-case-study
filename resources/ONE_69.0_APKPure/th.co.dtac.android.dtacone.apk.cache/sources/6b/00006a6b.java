...
public final class ConnectivityManagerCompat {
    ...
    /* renamed from: androidx.core.net.ConnectivityManagerCompat$a */
    /* loaded from: classes2.dex */
    public static class C4012a {
        @RequiresPermission("android.permission.ACCESS_NETWORK_STATE")
        @DoNotInline
        /* renamed from: a */
        public static boolean m57154a(ConnectivityManager connectivityManager) {
            return connectivityManager.isActiveNetworkMetered();
        }
    }

    /* renamed from: androidx.core.net.ConnectivityManagerCompat$b */
    /* loaded from: classes2.dex */
    public static class C4013b {
        @DoNotInline
        /* renamed from: a */
        public static int m57153a(ConnectivityManager connectivityManager) {
    ...
    public static int getRestrictBackgroundStatus(@NonNull ConnectivityManager connectivityManager) {
        if (Build.VERSION.SDK_INT >= 24) {
            return C4013b.m57153a(connectivityManager);
        }
        return 3;
    }
    ...
    public static boolean isActiveNetworkMetered(@NonNull ConnectivityManager connectivityManager) {
        return C4012a.m57154a(connectivityManager);
    }
}