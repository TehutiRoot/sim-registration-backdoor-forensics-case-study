...
public final class DefaultIntrinsicMeasurable implements Measurable {
    ...
    public DefaultIntrinsicMeasurable(@NotNull IntrinsicMeasurable measurable, @NotNull IntrinsicMinMax minMax, @NotNull IntrinsicWidthHeight widthHeight) {
        ...
        this.f30146a = measurable;
        this.f30147b = minMax;
        this.f30148c = widthHeight;
    }
    ...
    public Object getParentData() {
        return this.f30146a.getParentData();
    }

    @Override // androidx.compose.p003ui.layout.IntrinsicMeasurable
    public int maxIntrinsicHeight(int i) {
        return this.f30146a.maxIntrinsicHeight(i);
    }

    @Override // androidx.compose.p003ui.layout.IntrinsicMeasurable
    public int maxIntrinsicWidth(int i) {
        return this.f30146a.maxIntrinsicWidth(i);
    }
    ...
    public Placeable mo72995measureBRTryo0(long j) {
        ...
        if (this.f30148c == IntrinsicWidthHeight.Width) {
            if (this.f30147b == IntrinsicMinMax.Max) {
                minIntrinsicWidth = this.f30146a.maxIntrinsicWidth(Constraints.m73809getMaxHeightimpl(j));
            } else {
                minIntrinsicWidth = this.f30146a.minIntrinsicWidth(Constraints.m73809getMaxHeightimpl(j));
            }
            return new M20(minIntrinsicWidth, Constraints.m73809getMaxHeightimpl(j));
        }
        if (this.f30147b == IntrinsicMinMax.Max) {
            minIntrinsicHeight = this.f30146a.maxIntrinsicHeight(Constraints.m73810getMaxWidthimpl(j));
        } else {
            minIntrinsicHeight = this.f30146a.minIntrinsicHeight(Constraints.m73810getMaxWidthimpl(j));
        }
        return new M20(Constraints.m73810getMaxWidthimpl(j), minIntrinsicHeight);
    }

    @Override // androidx.compose.p003ui.layout.IntrinsicMeasurable
    public int minIntrinsicHeight(int i) {
        return this.f30146a.minIntrinsicHeight(i);
    }

    @Override // androidx.compose.p003ui.layout.IntrinsicMeasurable
    public int minIntrinsicWidth(int i) {
        return this.f30146a.minIntrinsicWidth(i);
    }
}