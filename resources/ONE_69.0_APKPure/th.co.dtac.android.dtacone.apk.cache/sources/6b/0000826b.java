...
public final class HttpTransactionTuple {
    ...
    /* renamed from: h */
    public String f42810h;

    /* renamed from: i */
    public Integer f42811i;
    ...
    /* renamed from: a */
    public final String m49962a(long j) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof HttpTransactionTuple) {
            ...
            return this.f42803a == httpTransactionTuple.f42803a && Intrinsics.areEqual(this.f42804b, httpTransactionTuple.f42804b) && Intrinsics.areEqual(this.f42805c, httpTransactionTuple.f42805c) && Intrinsics.areEqual(this.f42806d, httpTransactionTuple.f42806d) && Intrinsics.areEqual(this.f42807e, httpTransactionTuple.f42807e) && Intrinsics.areEqual(this.f42808f, httpTransactionTuple.f42808f) && Intrinsics.areEqual(this.f42809g, httpTransactionTuple.f42809g) && Intrinsics.areEqual(this.f42810h, httpTransactionTuple.f42810h) && Intrinsics.areEqual(this.f42811i, httpTransactionTuple.f42811i) && Intrinsics.areEqual(this.f42812j, httpTransactionTuple.f42812j) && Intrinsics.areEqual(this.f42813k, httpTransactionTuple.f42813k) && Intrinsics.areEqual(this.f42814l, httpTransactionTuple.f42814l) && this.f42815m == httpTransactionTuple.f42815m && Intrinsics.areEqual(this.f42816n, httpTransactionTuple.f42816n);
        }
        return false;
    }
    ...
    public int hashCode() {
        int m68395a = AbstractC17631Fh1.m68395a(this.f42803a) * 31;
        Long l = this.f42804b;
        int hashCode = (m68395a + (l == null ? 0 : l.hashCode())) * 31;
        Long l2 = this.f42805c;
        int hashCode2 = (hashCode + (l2 == null ? 0 : l2.hashCode())) * 31;
        String str = this.f42806d;
        int hashCode3 = (hashCode2 + (str == null ? 0 : str.hashCode())) * 31;
        String str2 = this.f42807e;
        int hashCode4 = (hashCode3 + (str2 == null ? 0 : str2.hashCode())) * 31;
        String str3 = this.f42808f;
        int hashCode5 = (hashCode4 + (str3 == null ? 0 : str3.hashCode())) * 31;
        String str4 = this.f42809g;
        int hashCode6 = (hashCode5 + (str4 == null ? 0 : str4.hashCode())) * 31;
        String str5 = this.f42810h;
        int hashCode7 = (hashCode6 + (str5 == null ? 0 : str5.hashCode())) * 31;
        Integer num = this.f42811i;
        int hashCode8 = (hashCode7 + (num == null ? 0 : num.hashCode())) * 31;
        Long l3 = this.f42812j;
        int hashCode9 = (hashCode8 + (l3 == null ? 0 : l3.hashCode())) * 31;
        Long l4 = this.f42813k;
        int hashCode10 = (hashCode9 + (l4 == null ? 0 : l4.hashCode())) * 31;
        String str6 = this.f42814l;
        int hashCode11 = (hashCode10 + (str6 == null ? 0 : str6.hashCode())) * 31;
        boolean z = this.f42815m;
        int i = z;
        if (z != 0) {
            i = 1;
        }
        int i2 = (hashCode11 + i) * 31;
        String str7 = this.f42816n;
        return i2 + (str7 != null ? str7.hashCode() : 0);
    }

    public final boolean isSsl() {
        return AbstractC19741eO1.equals(this.f42810h, UriUtil.HTTPS_SCHEME, true);
    }
