...
public class Type2CharStringParser {
    ...
    /* renamed from: a */
    public int f59344a = 0;

    /* renamed from: b */
    public int f59345b = 0;

    /* renamed from: c */
    public List f59346c = null;
    ...
    /* renamed from: a */
    public final int m32985a() {
        int i = this.f59344a + this.f59345b;
        int i2 = i / 8;
        if (i % 8 > 0) {
            return i2 + 1;
        }
    ...
    /* renamed from: b */
    public final List m32984b(byte[] bArr, byte[][] bArr2, byte[][] bArr3, boolean z) {
        boolean z2;
        boolean z3;
        if (z) {
            this.f59344a = 0;
            this.f59345b = 0;
            this.f59346c = new ArrayList();
        }
    ...
    /* renamed from: c */
    public final List m32983c() {
        ArrayList arrayList = new ArrayList();
        int size = this.f59346c.size();
        while (true) {
            size--;
            if (size > -1) {
                Object obj = this.f59346c.get(size);
    ...
    /* renamed from: d */
    public final CharStringCommand m32982d(int i, DataInput dataInput) {
        if (i == 1 || i == 18) {
            this.f59344a += m32983c().size() / 2;
        } else if (i == 3 || i == 19 || i == 20 || i == 23) {
            this.f59345b += m32983c().size() / 2;
        }
        if (i == 12) {
        ...
        int m32985a = m32985a() + 1;
        int[] iArr = new int[m32985a];
        iArr[0] = i;
        for (int i2 = 1; i2 < m32985a; i2++) {
    ...
    /* renamed from: e */
    public final Number m32981e(int i, DataInput dataInput) {
        if (i == 28) {
    ...
    public List<Object> parse(byte[] bArr, byte[][] bArr2, byte[][] bArr3) throws IOException {
        return m32984b(bArr, bArr2, bArr3, true);
    }

    public Type2CharStringParser(String str, int i) {
        this.f59347d = str;
        this.f59348e = String.format(Locale.US, "%04x", Integer.valueOf(i));
    }
}