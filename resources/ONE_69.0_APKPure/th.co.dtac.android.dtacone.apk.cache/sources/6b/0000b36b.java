...
public final class C$Gson$Types {
    ...
    /* renamed from: a */
    public static final Type[] f56708a = new Type[0];
    ...
    public static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public ParameterizedTypeImpl(Type type, Type type2, Type... typeArr) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                C$Gson$Types.m37561a(this.typeArguments[i]);
    ...
    public static final class WildcardTypeImpl implements WildcardType, Serializable {
        ...
        public WildcardTypeImpl(Type[] typeArr, Type[] typeArr2) {
            ...
            if (typeArr2.length == 1) {
                ...
                C$Gson$Types.m37561a(typeArr2[0]);
            ...
            C$Gson$Types.m37561a(typeArr[0]);
        ...
        public Type[] getLowerBounds() {
            ...
            return type != null ? new Type[]{type} : C$Gson$Types.f56708a;
        }
    ...
    /* renamed from: a */
    public static void m37561a(Type type) {
        boolean z;
    ...
    /* renamed from: b */
    public static Class m37560b(TypeVariable typeVariable) {
    ...
    /* renamed from: c */
    public static boolean m37559c(Object obj, Object obj2) {
    ...
    /* renamed from: d */
    public static Type m37558d(Type type, Class cls, Class cls2) {
        if (cls2 == cls) {
            return type;
        }
        if (cls2.isInterface()) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (cls2.isAssignableFrom(cls3)) {
                    return m37558d(cls.getGenericInterfaces()[i], interfaces[i], cls2);
                }
            }
        }
        if (!cls.isInterface()) {
            while (cls != Object.class) {
                ...
                if (cls2.isAssignableFrom(superclass)) {
                    return m37558d(cls.getGenericSuperclass(), superclass, cls2);
                }
                cls = superclass;
            }
        }
    ...
    /* renamed from: e */
    public static Type m37557e(Type type, Class cls, Class cls2) {
        if (type instanceof WildcardType) {
            type = ((WildcardType) type).getUpperBounds()[0];
        }
        C$Gson$Preconditions.checkArgument(cls2.isAssignableFrom(cls));
        return resolve(type, cls, m37558d(type, cls, cls2));
    }
    ...
    public static boolean equals(Type type, Type type2) {
        ...
        if (type instanceof ParameterizedType) {
            ...
            if (m37559c(parameterizedType.getOwnerType(), parameterizedType2.getOwnerType()) && parameterizedType.getRawType().equals(parameterizedType2.getRawType()) && Arrays.equals(parameterizedType.getActualTypeArguments(), parameterizedType2.getActualTypeArguments())) {
                return true;
            }
            return false;
        } else if (type instanceof GenericArrayType) {
    ...
    /* renamed from: f */
    public static int m37556f(Object[] objArr, Object obj) {
    ...
    */
    public static java.lang.reflect.Type m37555g(java.lang.reflect.Type r9, java.lang.Class r10, java.lang.reflect.Type r11, java.util.Map r12) {
        /*
            r0 = 0
        L1:
        ...
        L17:
            ...
            r0 = r1
        L1f:
            java.lang.reflect.Type r11 = m37554h(r9, r10, r1)
            if (r11 != r1) goto L1
            goto Ldf
        L27:
            ...
            java.lang.reflect.Type r9 = m37555g(r9, r10, r11, r12)
            boolean r10 = m37559c(r11, r9)
            if (r10 == 0) goto L45
            r11 = r1
            goto Ldf
        L45:
        ...
        L4c:
            ...
            java.lang.reflect.Type r9 = m37555g(r9, r10, r1, r12)
            boolean r10 = m37559c(r1, r9)
            if (r10 == 0) goto L62
            goto Ldf
        L62:
            java.lang.reflect.GenericArrayType r9 = arrayOf(r9)
        ...
        L67:
            ...
            java.lang.reflect.Type r4 = m37555g(r9, r10, r1, r12)
            boolean r1 = m37559c(r4, r1)
            r1 = r1 ^ r3
        ...
        L81:
            if (r2 >= r6) goto La0
            r7 = r5[r2]
            java.lang.reflect.Type r7 = m37555g(r9, r10, r7, r12)
            r8 = r5[r2]
            boolean r8 = m37559c(r7, r8)
            if (r8 != 0) goto L9d
            if (r1 != 0) goto L9b
        ...
        Lab:
            ...
            if (r5 != r3) goto Lcb
            r3 = r1[r2]
            java.lang.reflect.Type r9 = m37555g(r9, r10, r3, r12)
            r10 = r1[r2]
            if (r9 == r10) goto Ldf
        ...
        Lcb:
            ...
            if (r1 != r3) goto Ldf
            r1 = r4[r2]
            java.lang.reflect.Type r9 = m37555g(r9, r10, r1, r12)     // Catch: java.lang.Throwable -> Ldd
            r10 = r4[r2]
            if (r9 == r10) goto Ldf
        ...
        Le4:
            return r11
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.C$Gson$Types.m37555g(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type, java.util.Map):java.lang.reflect.Type");
    }
    ...
    public static Type getCollectionElementType(Type type, Class<?> cls) {
        Type m37557e = m37557e(type, cls, Collection.class);
        if (m37557e instanceof ParameterizedType) {
            return ((ParameterizedType) m37557e).getActualTypeArguments()[0];
        }
        return Object.class;
    }
    ...
    public static Type[] getMapKeyAndValueTypes(Type type, Class<?> cls) {
        ...
        Type m37557e = m37557e(type, cls, Map.class);
        return m37557e instanceof ParameterizedType ? ((ParameterizedType) m37557e).getActualTypeArguments() : new Type[]{Object.class, Object.class};
    }
    ...
    /* renamed from: h */
    public static Type m37554h(Type type, Class cls, TypeVariable typeVariable) {
        Class m37560b = m37560b(typeVariable);
        if (m37560b == null) {
            return typeVariable;
        }
        Type m37558d = m37558d(type, cls, m37560b);
        if (m37558d instanceof ParameterizedType) {
            return ((ParameterizedType) m37558d).getActualTypeArguments()[m37556f(m37560b.getTypeParameters(), typeVariable)];
        }
        return typeVariable;
    }
    ...
    public static Type resolve(Type type, Class<?> cls, Type type2) {
        return m37555g(type, cls, type2, new HashMap());
    }
    ...
    public static WildcardType subtypeOf(Type type) {
        ...
        return new WildcardTypeImpl(typeArr, f56708a);
    }
