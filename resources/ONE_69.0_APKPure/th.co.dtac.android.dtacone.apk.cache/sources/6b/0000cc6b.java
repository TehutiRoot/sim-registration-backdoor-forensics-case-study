...
public abstract class DerivedDoubleGauge {
    ...
    /* loaded from: classes5.dex */
    public static final class C10570a extends DerivedDoubleGauge {

        /* renamed from: a */
        public final int f63584a;

        public C10570a(String str, String str2, String str3, List list) {
            ...
            this.f63584a = list.size();
        }

        /* renamed from: b */
        public static C10570a m30596b(String str, String str2, String str3, List list) {
            return new C10570a(str, str2, str3, list);
        }
    ...
    /* renamed from: a */
    public static DerivedDoubleGauge m30597a(String str, String str2, String str3, List list) {
        return C10570a.m30596b(str, str2, str3, list);
    }
