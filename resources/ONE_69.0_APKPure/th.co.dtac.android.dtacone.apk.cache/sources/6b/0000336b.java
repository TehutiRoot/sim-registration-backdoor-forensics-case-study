...
public final class SentimentVeryDissatisfiedKt {
    ...
    /* renamed from: a */
    public static ImageVector f16433a;

    @NotNull
    public static final ImageVector getSentimentVeryDissatisfied(@NotNull Icons.Filled filled) {
        Intrinsics.checkNotNullParameter(filled, "<this>");
        ImageVector imageVector = f16433a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Filled.SentimentVeryDissatisfied", C3623Dp.m73842constructorimpl(24.0f), C3623Dp.m73842constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
