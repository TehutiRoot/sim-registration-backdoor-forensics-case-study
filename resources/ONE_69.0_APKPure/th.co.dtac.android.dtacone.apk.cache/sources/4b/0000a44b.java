...
public final class ConfigChange extends GeneratedMessageLite<ConfigChange, Builder> implements ConfigChangeOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<ConfigChange, Builder> implements ConfigChangeOrBuilder {
        ...
        public Builder addAdvices(Advice advice) {
            copyOnWrite();
            ((ConfigChange) this.instance).m43163V(advice);
            return this;
        }

        public Builder addAllAdvices(Iterable<? extends Advice> iterable) {
            copyOnWrite();
            ((ConfigChange) this.instance).m43162W(iterable);
            return this;
        }

        public Builder clearAdvices() {
            copyOnWrite();
            ((ConfigChange) this.instance).m43161X();
            return this;
        }

        public Builder clearChangeType() {
            copyOnWrite();
            ((ConfigChange) this.instance).m43160Y();
            return this;
        }

        public Builder clearElement() {
            copyOnWrite();
            ((ConfigChange) this.instance).m43159Z();
            return this;
        }

        public Builder clearNewValue() {
            copyOnWrite();
            ((ConfigChange) this.instance).m43158a0();
            return this;
        }

        public Builder clearOldValue() {
            copyOnWrite();
            ((ConfigChange) this.instance).m43157b0();
            return this;
        }
        ...
        public Builder removeAdvices(int i) {
            copyOnWrite();
            ((ConfigChange) this.instance).m43155d0(i);
            return this;
        }

        public Builder setAdvices(int i, Advice advice) {
            copyOnWrite();
            ((ConfigChange) this.instance).m43154e0(i, advice);
            return this;
        }

        public Builder setChangeType(ChangeType changeType) {
            copyOnWrite();
            ((ConfigChange) this.instance).m43153f0(changeType);
            return this;
        }

        public Builder setChangeTypeValue(int i) {
            copyOnWrite();
            ((ConfigChange) this.instance).m43152g0(i);
            return this;
        }

        public Builder setElement(String str) {
            copyOnWrite();
            ((ConfigChange) this.instance).m43151h0(str);
            return this;
        }

        public Builder setElementBytes(ByteString byteString) {
            copyOnWrite();
            ((ConfigChange) this.instance).m43150i0(byteString);
            return this;
        }

        public Builder setNewValue(String str) {
            copyOnWrite();
            ((ConfigChange) this.instance).m43149j0(str);
            return this;
        }

        public Builder setNewValueBytes(ByteString byteString) {
            copyOnWrite();
            ((ConfigChange) this.instance).m43148k0(byteString);
            return this;
        }

        public Builder setOldValue(String str) {
            copyOnWrite();
            ((ConfigChange) this.instance).m43147l0(str);
            return this;
        }

        public Builder setOldValueBytes(ByteString byteString) {
            copyOnWrite();
            ((ConfigChange) this.instance).m43146m0(byteString);
            return this;
        }
        ...
        public Builder addAdvices(int i, Advice advice) {
            copyOnWrite();
            ((ConfigChange) this.instance).m43164U(i, advice);
            return this;
        }

        public Builder setAdvices(int i, Advice.Builder builder) {
            copyOnWrite();
            ((ConfigChange) this.instance).m43154e0(i, builder.build());
            return this;
        }

        public Builder addAdvices(Advice.Builder builder) {
            copyOnWrite();
            ((ConfigChange) this.instance).m43163V(builder.build());
            return this;
        }

        public Builder addAdvices(int i, Advice.Builder builder) {
            copyOnWrite();
            ((ConfigChange) this.instance).m43164U(i, builder.build());
            return this;
        }
    }
    ...
    /* renamed from: U */
    public final void m43164U(int i, Advice advice) {
        advice.getClass();
        m43156c0();
    ...
    /* renamed from: V */
    public final void m43163V(Advice advice) {
        advice.getClass();
        m43156c0();
    ...
    /* renamed from: d0 */
    public final void m43155d0(int i) {
        m43156c0();
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C7190a.f51620a[methodToInvoke.ordinal()]) {
            case 1:
    ...
    /* renamed from: e0 */
    public final void m43154e0(int i, Advice advice) {
        advice.getClass();
        m43156c0();
    ...
    /* renamed from: f0 */
    public final void m43153f0(ChangeType changeType) {
        this.changeType_ = changeType.getNumber();
    }

    /* renamed from: g0 */
    public final void m43152g0(int i) {
        this.changeType_ = i;
    }
    ...
    /* renamed from: h0 */
    public final void m43151h0(String str) {
        str.getClass();
        this.element_ = str;
    }

    /* renamed from: i0 */
    public final void m43150i0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.element_ = byteString.toStringUtf8();
    }

    /* renamed from: j0 */
    public final void m43149j0(String str) {
        str.getClass();
        this.newValue_ = str;
    }

    /* renamed from: k0 */
    public final void m43148k0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.newValue_ = byteString.toStringUtf8();
    }

    /* renamed from: l0 */
    public final void m43147l0(String str) {
        str.getClass();
        this.oldValue_ = str;
    }

    /* renamed from: m0 */
    public final void m43146m0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
