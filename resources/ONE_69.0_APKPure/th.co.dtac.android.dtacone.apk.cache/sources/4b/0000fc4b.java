...
public final class GOST28147 {
    ...
    public static class AlgParamGen extends BaseAlgorithmParameterGenerator {
        ...
        public AlgorithmParameters engineGenerateParameters() {
            ...
            this.random.nextBytes(this.f75364iv);
            try {
                AlgorithmParameters createParametersInstance = createParametersInstance("GOST28147");
                createParametersInstance.init(new GOST28147ParameterSpec(this.sBox, this.f75364iv));
    ...
    public static class AlgParams extends BaseAlgParams {
        ...
        public void engineInit(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidParameterSpecException {
            if (algorithmParameterSpec instanceof IvParameterSpec) {
                this.f75365iv = ((IvParameterSpec) algorithmParameterSpec).getIV();
            } else if (!(algorithmParameterSpec instanceof GOST28147ParameterSpec)) {
                throw new InvalidParameterSpecException("IvParameterSpec required to initialise a IV parameters algorithm parameters object");
            } else {
                this.f75365iv = ((GOST28147ParameterSpec) algorithmParameterSpec).getIV();
                try {
        ...
        public AlgorithmParameterSpec localEngineGetParameterSpec(Class cls) throws InvalidParameterSpecException {
            if (cls == IvParameterSpec.class) {
                return new IvParameterSpec(this.f75365iv);
            }
            if (cls == GOST28147ParameterSpec.class || cls == AlgorithmParameterSpec.class) {
                return new GOST28147ParameterSpec(this.sBox, this.f75365iv);
            }
        ...
        public byte[] localGetEncoded() throws IOException {
            return new GOST28147Parameters(this.f75365iv, this.sBox).getEncoded();
        }
        ...
        public void localInit(byte[] bArr) throws IOException {
            ...
            if (fromByteArray instanceof ASN1OctetString) {
                this.f75365iv = ASN1OctetString.getInstance(fromByteArray).getOctets();
                ...
                this.f75365iv = gOST28147Parameters.getIV();
            }
        }
    }
    ...
    public static abstract class BaseAlgParams extends BaseAlgorithmParameters {
        ...
        public void engineInit(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidParameterSpecException {
            if (algorithmParameterSpec instanceof IvParameterSpec) {
                this.f75366iv = ((IvParameterSpec) algorithmParameterSpec).getIV();
            } else if (!(algorithmParameterSpec instanceof GOST28147ParameterSpec)) {
                throw new InvalidParameterSpecException("IvParameterSpec required to initialise a IV parameters algorithm parameters object");
            } else {
                this.f75366iv = ((GOST28147ParameterSpec) algorithmParameterSpec).getIV();
                try {
        ...
        public AlgorithmParameterSpec localEngineGetParameterSpec(Class cls) throws InvalidParameterSpecException {
            if (cls == IvParameterSpec.class) {
                return new IvParameterSpec(this.f75366iv);
            }
            if (cls == GOST28147ParameterSpec.class || cls == AlgorithmParameterSpec.class) {
                return new GOST28147ParameterSpec(this.sBox, this.f75366iv);
            }
            throw new InvalidParameterSpecException("AlgorithmParameterSpec not recognized: " + cls.getName());
        }

        public byte[] localGetEncoded() throws IOException {
            return new GOST28147Parameters(this.f75366iv, this.sBox).getEncoded();
        }
