...
public abstract class ComputableLiveData<T> {
    ...
    /* renamed from: a */
    public static /* synthetic */ void m54101a(ComputableLiveData computableLiveData) {
        m54098d(computableLiveData);
    }

    /* renamed from: b */
    public static /* synthetic */ void m54100b(ComputableLiveData computableLiveData) {
        m54099c(computableLiveData);
    }

    /* renamed from: c */
    public static final void m54099c(ComputableLiveData this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        boolean hasActiveObservers = this$0.getLiveData().hasActiveObservers();
        if (this$0.f35836d.compareAndSet(false, true) && hasActiveObservers) {
            this$0.f35833a.execute(this$0.refreshRunnable);
        }
    }

    /* renamed from: d */
    public static final void m54098d(ComputableLiveData this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        do {
            boolean z = false;
            if (this$0.f35837e.compareAndSet(false, true)) {
                T t = null;
                boolean z2 = false;
                while (this$0.f35836d.compareAndSet(true, false)) {
                    try {
                        t = (T) this$0.compute();
                        z2 = true;
                    } catch (Throwable th2) {
                        this$0.f35837e.set(false);
                        throw th2;
                    }
                }
                if (z2) {
    ...
    public ComputableLiveData(@NotNull Executor executor) {
        ...
        this.f35834b = liveData;
        this.f35835c = liveData;
        this.f35836d = new AtomicBoolean(true);
        this.f35837e = new AtomicBoolean(false);
        this.refreshRunnable = new Runnable() { // from class: Lv
            @Override // java.lang.Runnable
            public final void run() {
                ComputableLiveData.m54101a(ComputableLiveData.this);
            }
        };
        this.invalidationRunnable = new Runnable() { // from class: Mv
            @Override // java.lang.Runnable
            public final void run() {
                ComputableLiveData.m54100b(ComputableLiveData.this);
            }
        };
    }
