...
public final class GravityCompat {
    ...
    public static class C4094a {
        @DoNotInline
        /* renamed from: a */
        public static void m56951a(int i, int i2, int i3, Rect rect, int i4, int i5, Rect rect2, int i6) {
            Gravity.apply(i, i2, i3, rect, i4, i5, rect2, i6);
        }

        @DoNotInline
        /* renamed from: b */
        public static void m56950b(int i, int i2, int i3, Rect rect, Rect rect2, int i4) {
            Gravity.apply(i, i2, i3, rect, rect2, i4);
        }

        @DoNotInline
        /* renamed from: c */
        public static void m56949c(int i, Rect rect, Rect rect2, int i2) {
    ...
    public static void apply(int i, int i2, int i3, @NonNull Rect rect, int i4, int i5, @NonNull Rect rect2, int i6) {
        C4094a.m56951a(i, i2, i3, rect, i4, i5, rect2, i6);
    }
}