...
@DebugMetadata(m29093c = "androidx.compose.foundation.lazy.layout.LazyAnimateScrollKt$animateScrollToItem$2", m29092f = "LazyAnimateScroll.kt", m29091i = {0, 0, 0, 0, 0, 0, 0, 0, 1}, m29090l = {137, 237}, m29089m = "invokeSuspend", m29088n = {"$this$scroll", "loop", "anim", "loops", "targetDistancePx", "boundDistancePx", "minDistancePx", "forward", "$this$scroll"}, m29087s = {"L$0", "L$1", "L$2", "L$3", "F$0", "F$1", "F$2", "I$0", "L$0"})
...
public final class LazyAnimateScrollKt$animateScrollToItem$2 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes.dex */
    public static final class C29063 extends Lambda implements Function1<AnimationScope<Float, AnimationVector1D>, Unit> {
        ...
        public C29063(LazyAnimateScrollScope lazyAnimateScrollScope, int i, float f, Ref.FloatRef floatRef, ScrollScope scrollScope, Ref.BooleanRef booleanRef, boolean z, float f2, Ref.IntRef intRef, int i2, Ref.ObjectRef<AnimationState<Float, AnimationVector1D>> objectRef) {
            super(1);
        ...
        public final void invoke2(@NotNull AnimationScope<Float, AnimationVector1D> animateTo) {
            ...
            if (targetItemOffset == null) {
                if (this.$target > 0.0f) {
                    coerceAtLeast = AbstractC11695c.coerceAtMost(animateTo.getValue().floatValue(), this.$target);
                } else {
                    coerceAtLeast = AbstractC11695c.coerceAtLeast(animateTo.getValue().floatValue(), this.$target);
                }
    ...
    /* loaded from: classes.dex */
    public static final class C29075 extends Lambda implements Function1<AnimationScope<Float, AnimationVector1D>, Unit> {
        final /* synthetic */ ScrollScope $$this$scroll;
        final /* synthetic */ Ref.FloatRef $prevValue;
        final /* synthetic */ float $target;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C29075(float f, Ref.FloatRef floatRef, ScrollScope scrollScope) {
            super(1);
            this.$target = f;
            this.$prevValue = floatRef;
            this.$$this$scroll = scrollScope;
        ...
        public final void invoke2(@NotNull AnimationScope<Float, AnimationVector1D> animateTo) {
            ...
            float f2 = 0.0f;
            if (f > 0.0f) {
                f2 = AbstractC11695c.coerceAtMost(animateTo.getValue().floatValue(), this.$target);
            } else if (f < 0.0f) {
                f2 = AbstractC11695c.coerceAtLeast(animateTo.getValue().floatValue(), this.$target);
            }
