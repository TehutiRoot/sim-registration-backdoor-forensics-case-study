...
public final class BuiltinMethodsWithDifferentJvmName extends SpecialGenericSignatures {
    ...
    public final boolean isBuiltinFunctionWithDifferentNameInJvm(@NotNull SimpleFunctionDescriptor functionDescriptor) {
        Intrinsics.checkNotNullParameter(functionDescriptor, "functionDescriptor");
        if (!KotlinBuiltIns.isBuiltIn(functionDescriptor) || DescriptorUtilsKt.firstOverridden$default(functionDescriptor, false, new C11761x6ce919c0(functionDescriptor), 1, null) == null) {
            return false;
        }
        return true;
    }
