...
public final class C11799xb2505177 extends Lambda implements Function1<SignatureEnhancementBuilder.ClassEnhancementBuilder.FunctionEnhancementBuilder, Unit> {
    final /* synthetic */ String $JFFunction;
    final /* synthetic */ String $JLObject;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C11799xb2505177(String str, String str2) {
        super(1);
        this.$JLObject = str;
    ...
    public final void invoke2(@NotNull SignatureEnhancementBuilder.ClassEnhancementBuilder.FunctionEnhancementBuilder function) {
        ...
        javaTypeQualifiers4 = PredefinedEnhancementInfoKt.f69259b;
        function.parameter(str2, javaTypeQualifiers2, javaTypeQualifiers3, javaTypeQualifiers4);
        String str3 = this.$JLObject;
        javaTypeQualifiers5 = PredefinedEnhancementInfoKt.f69259b;
