...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.rectify.fragment.OneRectifyListFragment$initView$3$3 */
/* loaded from: classes10.dex */
public final class OneRectifyListFragment$initView$3$3 extends Lambda implements Function1<StatusResource, Unit> {
    final /* synthetic */ OneRectifyListFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneRectifyListFragment$initView$3$3(OneRectifyListFragment oneRectifyListFragment) {
        super(1);
    ...
    public final void invoke2(StatusResource statusResource) {
        this.this$0.m10493t(statusResource);
    }
}