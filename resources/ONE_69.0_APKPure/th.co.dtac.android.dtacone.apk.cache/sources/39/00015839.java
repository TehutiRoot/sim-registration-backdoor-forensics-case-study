...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_change_sim.MrtrChangeSimViewModel$cutSimStock$1$2 */
/* loaded from: classes9.dex */
public final class MrtrChangeSimViewModel$cutSimStock$1$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ MrtrChangeSimViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrChangeSimViewModel$cutSimStock$1$2(MrtrChangeSimViewModel mrtrChangeSimViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable it) {
        ...
        mrtrErrorService.handleException(it, new MrtrErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.viewmodel.mrtr_change_sim.MrtrChangeSimViewModel$cutSimStock$1$2.1
            ...
            public void handle(@Nullable Throwable th2) {
                ...
                if (!(th2 instanceof HttpException) || ((HttpException) th2).code() != 404) {
                    ...
                    MrtrChangeSimViewModel.this.setCutSimStockError(errorCollection);
                }
                if (MrtrChangeSimViewModel.this.isCheckSimStock()) {
                    MrtrChangeSimViewModel.this.m2411F();
                } else {
                    MrtrChangeSimViewModel.this.getLiveDataState().setValue(StatusResource.SUCCESS);
                }
            }
