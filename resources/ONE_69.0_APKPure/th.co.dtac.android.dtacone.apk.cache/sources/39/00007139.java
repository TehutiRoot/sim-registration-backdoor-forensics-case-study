...
public final class LocalViewModelStoreOwner {
    ...
    /* renamed from: a */
    public static final ProvidableCompositionLocal f36020a = CompositionLocalKt.compositionLocalOf$default(null, LocalViewModelStoreOwner$LocalViewModelStoreOwner$1.INSTANCE, 1, null);
    ...
    public final ViewModelStoreOwner getCurrent(@Nullable Composer composer, int i) {
        ...
        ViewModelStoreOwner viewModelStoreOwner = (ViewModelStoreOwner) composer.consume(f36020a);
    ...
    public final ProvidedValue<ViewModelStoreOwner> provides(@NotNull ViewModelStoreOwner viewModelStoreOwner) {
        return f36020a.provides(viewModelStoreOwner);
    }
}