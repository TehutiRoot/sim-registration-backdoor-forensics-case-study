...
public enum RandomAccessFileMode {
    READ_ONLY("r", 1),
    READ_WRITE(f73344RW, 2),
    READ_WRITE_SYNC_ALL(RWS, 4),
    READ_WRITE_SYNC_CONTENT(RWD, 3);
    

    /* renamed from: R */
    private static final String f73343R = "r";

    /* renamed from: RW */
    private static final String f73344RW = "rw";
    ...
    /* renamed from: io */
    public IORandomAccessFile m25504io(String str) throws FileNotFoundException {
    ...
    public static RandomAccessFileMode valueOf(OpenOption... openOptionArr) {
        ...
        for (OpenOption openOption : openOptionArr) {
            if (AbstractC23106xs1.m468a(openOption)) {
                int[] iArr = C12508a.f73345a;
                ordinal = AbstractC23279ys1.m230a(openOption).ordinal();
                int i = iArr[ordinal];
                if (i == 1) {
