...
public final class SwitchKt {
    ...
    /* renamed from: a */
    public static final float f26371a;

    /* renamed from: b */
    public static final float f26372b;

    /* renamed from: c */
    public static final float f26373c;

    /* renamed from: d */
    public static final float f26374d;

    /* renamed from: e */
    public static final float f26375e;

    /* renamed from: f */
    public static final float f26376f;

    /* renamed from: g */
    public static final TweenSpec f26377g;

    static {
        SwitchTokens switchTokens = SwitchTokens.INSTANCE;
        float m71466getSelectedHandleWidthD9Ej5fM = switchTokens.m71466getSelectedHandleWidthD9Ej5fM();
        f26371a = m71466getSelectedHandleWidthD9Ej5fM;
        f26372b = switchTokens.m71473getUnselectedHandleWidthD9Ej5fM();
        float m71471getTrackWidthD9Ej5fM = switchTokens.m71471getTrackWidthD9Ej5fM();
        f26373c = m71471getTrackWidthD9Ej5fM;
        float m71469getTrackHeightD9Ej5fM = switchTokens.m71469getTrackHeightD9Ej5fM();
        f26374d = m71469getTrackHeightD9Ej5fM;
        float m73842constructorimpl = C3623Dp.m73842constructorimpl(C3623Dp.m73842constructorimpl(m71469getTrackHeightD9Ej5fM - m71466getSelectedHandleWidthD9Ej5fM) / 2);
        f26375e = m73842constructorimpl;
        f26376f = C3623Dp.m73842constructorimpl(C3623Dp.m73842constructorimpl(m71471getTrackWidthD9Ej5fM - m71466getSelectedHandleWidthD9Ej5fM) - m73842constructorimpl);
        f26377g = new TweenSpec(100, 0, null, 6, null);
    }
    ...
    */
    ...
    /* renamed from: a */
    public static final void m60433a(BoxScope boxScope, boolean z, boolean z2, SwitchColors switchColors, State state, Function2 function2, InteractionSource interactionSource, Shape shape, float f, float f2, float f3, Composer composer, int i, int i2) {
        int i3;
        int i4;
        float m73842constructorimpl;
        float floatValue;
        Composer composer2;
        float m71470getTrackOutlineWidthD9Ej5fM;
        ...
        if ((i3 & 1533916891) == 306783378 && (i4 & 11) == 2 && startRestartGroup.getSkipping()) {
            ...
            int i6 = i3;
            float mo69618toDpu2uoSUM = ((Density) startRestartGroup.consume(CompositionLocalsKt.getLocalDensity())).mo69618toDpu2uoSUM(((Number) state.getValue()).floatValue());
            if (m60430d(collectIsPressedAsState)) {
                m73842constructorimpl = SwitchTokens.INSTANCE.m71464getPressedHandleWidthD9Ej5fM();
            } else {
                m73842constructorimpl = C3623Dp.m73842constructorimpl(C3623Dp.m73842constructorimpl(C3623Dp.m73842constructorimpl(f26371a - f) * (C3623Dp.m73842constructorimpl(mo69618toDpu2uoSUM - f2) / C3623Dp.m73842constructorimpl(f3 - f2))) + f);
            }
            startRestartGroup.startReplaceableGroup(-993794105);
            if (m60430d(collectIsPressedAsState)) {
                Density density = (Density) startRestartGroup.consume(CompositionLocalsKt.getLocalDensity());
                if (z) {
                    m71470getTrackOutlineWidthD9Ej5fM = C3623Dp.m73842constructorimpl(f26376f - SwitchTokens.INSTANCE.m71470getTrackOutlineWidthD9Ej5fM());
                } else {
                    m71470getTrackOutlineWidthD9Ej5fM = SwitchTokens.INSTANCE.m71470getTrackOutlineWidthD9Ej5fM();
                }
                floatValue = density.mo69622toPx0680j_4(m71470getTrackOutlineWidthD9Ej5fM);
            } else {
            ...
            Modifier m69504backgroundbw27NRU = BackgroundKt.m69504backgroundbw27NRU(BorderKt.m69512borderxT4_qwU(SizeKt.m69734height3ABfNKs(SizeKt.m69753width3ABfNKs(boxScope.align(companion, companion2.getCenter()), f26373c), f26374d), switchTokens.m71470getTrackOutlineWidthD9Ej5fM(), switchColors.borderColor$material3_release(z2, z, startRestartGroup, i5).getValue().m71929unboximpl(), shape2), m60431c(trackColor$material3_release), shape2);
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf = LayoutKt.materializerOf(m69504backgroundbw27NRU);
            ...
            Updater.m71584setimpl(m71577constructorimpl, density2, companion3.getSetDensity());
            ...
            long m60432b = m60432b(switchColors.thumbColor$material3_release(z2, z, startRestartGroup, i5));
            ...
            startRestartGroup.endReplaceableGroup();
            composer2 = startRestartGroup;
            Modifier m69504backgroundbw27NRU2 = BackgroundKt.m69504backgroundbw27NRU(SizeKt.m69740requiredSize3ABfNKs(IndicationKt.indication(OffsetKt.offset(align, (Function1) rememberedValue), interactionSource, RippleKt.m70364rememberRipple9IZ8Weo(false, C3623Dp.m73842constructorimpl(switchTokens.m71468getStateLayerSizeD9Ej5fM() / 2), 0L, composer2, 54, 4)), m73842constructorimpl), m60432b, shape);
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf2 = LayoutKt.materializerOf(m69504backgroundbw27NRU2);
            ...
            Updater.m71584setimpl(m71577constructorimpl2, density3, companion3.getSetDensity());
    ...
    /* renamed from: b */
    public static final long m60432b(State state) {
        return ((Color) state.getValue()).m71929unboximpl();
    }

    /* renamed from: c */
    public static final long m60431c(State state) {
        return ((Color) state.getValue()).m71929unboximpl();
    }

    /* renamed from: d */
    public static final boolean m60430d(State state) {
