...
@Metadata(m29143d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m29142d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_childFriendly", "Landroidx/compose/material/icons/Icons$Outlined;", "getChildFriendly", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "ChildFriendly", "material-icons-extended_release"}, m29141k = 2, m29140mv = {1, 8, 0})
...
public final class ChildFriendlyKt {
    ...
    /* renamed from: a */
    public static ImageVector f17308a;

    @NotNull
    public static final ImageVector getChildFriendly(@NotNull Icons.Outlined outlined) {
        Intrinsics.checkNotNullParameter(outlined, "<this>");
        ImageVector imageVector = f17308a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.ChildFriendly", C3623Dp.m73842constructorimpl(24.0f), C3623Dp.m73842constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.lineTo(15.0f, 4.34f);
        pathBuilder.curveToRelative(1.7f, 0.6f, 3.05f, 1.95f, 3.66f, 3.66f);
        pathBuilder.lineTo(15.0f, 8.0f);
        pathBuilder.close();
        pathBuilder.moveTo(6.44f, 11.0f);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(17.74f, 14.66f);
        pathBuilder.lineToRelative(-0.29f, 0.37f);
        pathBuilder.curveToRelative(-0.14f, -0.02f, -0.3f, -0.03f, -0.45f, -0.03f);
        pathBuilder.curveToRelative(-1.39f, 0.0f, -2.6f, 0.82f, -3.16f, 2.0f);
        pathBuilder.horizontalLineToRelative(-2.68f);
        pathBuilder.curveToRelative(-0.5f, -1.04f, -1.5f, -1.8f, -2.68f, -1.97f);
        pathBuilder.lineToRelative(-0.44f, -0.67f);
        pathBuilder.curveToRelative(-0.1f, -0.17f, -0.34f, -0.69f, -0.67f, -1.36f);
        pathBuilder.horizontalLineToRelative(11.29f);
        pathBuilder.curveToRelative(-0.21f, 0.59f, -0.52f, 1.15f, -0.92f, 1.66f);
        pathBuilder.close();
