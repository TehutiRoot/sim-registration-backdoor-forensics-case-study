...
/* renamed from: th.co.dtac.android.dtacone.presenter.bitmap.SaveBitmapPresenter$saveViewBitmapWithTransparent$3 */
/* loaded from: classes8.dex */
public final class SaveBitmapPresenter$saveViewBitmapWithTransparent$3 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ SaveBitmapPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SaveBitmapPresenter$saveViewBitmapWithTransparent$3(SaveBitmapPresenter saveBitmapPresenter) {
        super(1);
