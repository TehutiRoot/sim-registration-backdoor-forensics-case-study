...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.pre2post.viewModel.OnePre2PostViewModel$saveForms$3 */
/* loaded from: classes10.dex */
public final class OnePre2PostViewModel$saveForms$3 extends Lambda implements Function1<OneCommonResponse, Unit> {
    final /* synthetic */ OnePre2PostViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePre2PostViewModel$saveForms$3(OnePre2PostViewModel onePre2PostViewModel) {
        super(1);
    ...
    public final void invoke2(OneCommonResponse oneCommonResponse) {
        ...
        m10823k1.setValue(Resource.Companion.success(oneCommonResponse));
    }
}