...
public final class XmlVectorParser_androidKt {
    ...
    /* renamed from: a */
    public static final int f29665a = 0;

    /* renamed from: a */
    public static final int m59591a(int i, int i2) {
        if (i != 0) {
            if (i != 1) {
                if (i == 2) {
                    return StrokeCap.Companion.m72229getSquareKaPHkGw();
                }
                return i2;
            }
            return StrokeCap.Companion.m72228getRoundKaPHkGw();
        }
        return StrokeCap.Companion.m72227getButtKaPHkGw();
    }

    /* renamed from: b */
    public static final int m59590b(int i, int i2) {
        if (i != 0) {
            if (i != 1) {
                if (i == 2) {
                    return StrokeJoin.Companion.m72237getBevelLxFBmk8();
                }
                return i2;
            }
            return StrokeJoin.Companion.m72239getRoundLxFBmk8();
        }
        return StrokeJoin.Companion.m72238getMiterLxFBmk8();
    }

    /* renamed from: c */
    public static final Brush m59589c(ComplexColorCompat complexColorCompat) {
    ...
    public static final ImageVector.Builder createVectorImageBuilder(@NotNull AndroidVectorParser androidVectorParser, @NotNull Resources res, @Nullable Resources.Theme theme, @NotNull AttributeSet attrs) {
        ...
        if (namedFloat > 0.0f) {
            if (namedFloat2 > 0.0f) {
                ...
                if (obtainAttributes.hasValue(androidVectorResources.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
                    ...
                    if (typedValue.type == 2) {
                        ...
                        if (namedColorStateList != null) {
                            m71955getUnspecified0d7_KjU = ColorKt.Color(namedColorStateList.getDefaultColor());
                        } else {
                            m71955getUnspecified0d7_KjU = Color.Companion.m71955getUnspecified0d7_KjU();
                        }
                    }
                ...
                long j = m71955getUnspecified0d7_KjU;
                    ...
                    if (i != 3) {
                        if (i != 5) {
                            if (i != 9) {
                                switch (i) {
                                    case 14:
                                        m71868getSrcIn0nO6VwU = BlendMode.Companion.m71859getModulate0nO6VwU();
                                        break;
                                    case 15:
                                        m71868getSrcIn0nO6VwU = BlendMode.Companion.m71864getScreen0nO6VwU();
                                        break;
                                    case 16:
                                        m71868getSrcIn0nO6VwU = BlendMode.Companion.m71862getPlus0nO6VwU();
                                        break;
                                    default:
                                        m71868getSrcIn0nO6VwU = BlendMode.Companion.m71868getSrcIn0nO6VwU();
                                        break;
                                }
                            } else {
                                m71868getSrcIn0nO6VwU = BlendMode.Companion.m71867getSrcAtop0nO6VwU();
                            }
                        } else {
                            m71868getSrcIn0nO6VwU = BlendMode.Companion.m71868getSrcIn0nO6VwU();
                        }
                    } else {
                        m71868getSrcIn0nO6VwU = BlendMode.Companion.m71870getSrcOver0nO6VwU();
                    }
                } else {
                    m71868getSrcIn0nO6VwU = BlendMode.Companion.m71868getSrcIn0nO6VwU();
                }
                int i2 = m71868getSrcIn0nO6VwU;
                float m73842constructorimpl = C3623Dp.m73842constructorimpl(dimension / res.getDisplayMetrics().density);
                float m73842constructorimpl2 = C3623Dp.m73842constructorimpl(dimension2 / res.getDisplayMetrics().density);
                obtainAttributes.recycle();
                return new ImageVector.Builder(null, m73842constructorimpl, m73842constructorimpl2, namedFloat, namedFloat2, j, i2, namedBoolean, 1, null);
            }
    ...
    public static final void parsePath(@NotNull AndroidVectorParser androidVectorParser, @NotNull Resources res, @Nullable Resources.Theme theme, @NotNull AttributeSet attrs, @NotNull ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        if (TypedArrayUtils.hasAttribute(androidVectorParser.getXmlParser(), "pathData")) {
            ...
            int m59591a = m59591a(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineCap", androidVectorResources.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.Companion.m72227getButtKaPHkGw());
            int m59590b = m59590b(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineJoin", androidVectorResources.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.Companion.m72237getBevelLxFBmk8());
            ...
            int namedInt = androidVectorParser.getNamedInt(obtainAttributes, "fillType", androidVectorResources.getSTYLEABLE_VECTOR_DRAWABLE_PATH_TRIM_PATH_FILLTYPE(), f29665a);
            obtainAttributes.recycle();
            Brush m59589c = m59589c(namedComplexColor);
            Brush m59589c2 = m59589c(namedComplexColor2);
            PathFillType.Companion companion = PathFillType.Companion;
            if (namedInt == 0) {
                m72159getEvenOddRgk1Os = companion.m72160getNonZeroRgk1Os();
            } else {
                m72159getEvenOddRgk1Os = companion.m72159getEvenOddRgk1Os();
            }
            builder.m72433addPathoIyEayM(addPathNodes, m72159getEvenOddRgk1Os, str, m59589c, namedFloat, m59589c2, namedFloat3, namedFloat4, m59591a, m59590b, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
            return;
        }
