...
public final class PublicKeySecurityHandler extends SecurityHandler {
    ...
    /* renamed from: k */
    public final void m32509k(StringBuilder sb, KeyTransRecipientId keyTransRecipientId, X509Certificate x509Certificate, X509CertificateHolder x509CertificateHolder) {
        String str;
        Object issuer;
    ...
    /* renamed from: l */
    public final KeyTransRecipientInfo m32508l(X509Certificate x509Certificate, byte[] bArr) {
    ...
    /* renamed from: m */
    public final byte[][] m32507m(byte[] bArr) {
        ...
        while (recipientsIterator.hasNext()) {
            ...
            ASN1Primitive m32506n = m32506n(bArr3, x509);
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
            m32506n.encodeTo(byteArrayOutputStream, ASN1Encoding.DER);
    ...
    /* renamed from: n */
    public final ASN1Primitive m32506n(byte[] bArr, X509Certificate x509Certificate) {
        ...
        try {
            ...
            return new ContentInfo(PKCSObjectIdentifiers.envelopedData, new EnvelopedData((OriginatorInfo) null, new DERSet(new RecipientInfo(m32508l(x509Certificate, generateKey.getEncoded()))), new EncryptedContentInfo(PKCSObjectIdentifiers.data, new AlgorithmIdentifier(new ASN1ObjectIdentifier(id2), readObject), new DEROctetString(doFinal)), (ASN1Set) null)).toASN1Primitive();
        } catch (NoSuchAlgorithmException e) {
    ...
    /* renamed from: o */
    public final void m32505o(PDEncryption pDEncryption, COSName cOSName, byte[][] bArr) {
    ...
    public void prepareDocumentForEncryption(PDDocument pDDocument) throws IOException {
        ...
        try {
            ...
            try {
                ...
                byte[][] m32507m = m32507m(bArr);
                int i2 = 20;
                for (byte[] bArr2 : m32507m) {
                    i2 += bArr2.length;
                }
                byte[] bArr3 = new byte[i2];
                System.arraycopy(bArr, 0, bArr3, 0, 20);
                for (byte[] bArr4 : m32507m) {
                ...
                if (computeVersionNumber != 4) {
                    if (computeVersionNumber != 5) {
                        ...
                        digest = AbstractC21721ps0.m23734b().digest(bArr3);
                        encryption.setRecipients(m32507m);
                    } else {
                        encryption.setSubFilter("adbe.pkcs7.s5");
                        digest = AbstractC21721ps0.m23733c().digest(bArr3);
                        m32505o(encryption, COSName.AESV3, m32507m);
                    }
                } else {
                    encryption.setSubFilter("adbe.pkcs7.s5");
                    digest = AbstractC21721ps0.m23734b().digest(bArr3);
                    m32505o(encryption, COSName.AESV2, m32507m);
                }
                            ...
                            if (it.hasNext()) {
                                ...
                                if (certificate != null) {
                                    ...
                                    if (rid instanceof KeyTransRecipientId) {
                                        m32509k(sb, (KeyTransRecipientId) rid, certificate, x509CertificateHolder);
                                    }
                                }
                                i3 = i4;
                    ...
                    if (z2 && bArr != null) {
                        if (bArr.length == 24) {
                            ...
                            if (pDEncryption.getVersion() != 4 && pDEncryption.getVersion() != 5) {
                                digest = AbstractC21721ps0.m23734b().digest(bArr4);
                                setEncryptionKey(new byte[getKeyLength() / 8]);
                                System.arraycopy(digest, 0, getEncryptionKey(), 0, getKeyLength() / 8);
                                return;
                            }
                            ...
                            if (pDEncryption.getVersion() == 4) {
                                ...
                                digest = AbstractC21721ps0.m23733c().digest(bArr4);
                            }
