...
public final class NavigationDrawerKt$DrawerSheet$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public NavigationDrawerKt$DrawerSheet$1(WindowInsets windowInsets, Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, int i) {
        super(2);
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        f = NavigationDrawerKt.f26000b;
        Modifier windowInsetsPadding = WindowInsetsPaddingKt.windowInsetsPadding(SizeKt.m69752sizeInqDBjuR0$default(companion, f, 0.0f, DrawerDefaults.INSTANCE.m70558getMaximumDrawerWidthD9Ej5fM(), 0.0f, 10, null), this.$windowInsets);
