...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.deviceSaleTrueCompany.fragment.OneDeviceSaleTrueAdditionalAdvanceFragment$setObserve$1$6 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleTrueAdditionalAdvanceFragment$setObserve$1$6 extends Lambda implements Function1<Resource<? extends OneSubmitOrderResponse>, Unit> {
    final /* synthetic */ OneDeviceSaleTrueAdditionalAdvanceFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.deviceSaleTrueCompany.fragment.OneDeviceSaleTrueAdditionalAdvanceFragment$setObserve$1$6$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneDeviceSaleTrueAdditionalAdvanceFragment$setObserve$1$6(OneDeviceSaleTrueAdditionalAdvanceFragment oneDeviceSaleTrueAdditionalAdvanceFragment) {
        super(1);
    ...
    public final void invoke2(Resource<OneSubmitOrderResponse> resource) {
        ...
        OneDeviceSaleTrueActivity m15074m;
        ...
        if (i != 1) {
            if (i == 2) {
                ...
                m15074m = oneDeviceSaleTrueAdditionalAdvanceFragment.m15074m();
                m15074m.navigateToSuccess();
            } else if (i != 3) {
                oneDeviceSaleTrueAdditionalAdvanceFragment.dismissLoading();
            } else {
                oneDeviceSaleTrueAdditionalAdvanceFragment.dismissLoading();
