...
public class GPUImageColorBalanceFilter extends GPUImageFilter {
    ...
    /* renamed from: l */
    public boolean f67499l;

    public GPUImageColorBalanceFilter() {
        super(GPUImageFilter.NO_FILTER_VERTEX_SHADER, GPU_IMAGE_COLOR_BALANCE_FRAGMENT_SHADER);
        this.f67496i = new float[]{0.0f, 0.0f, 0.0f};
        this.f67497j = new float[]{0.0f, 0.0f, 0.0f};
        this.f67498k = new float[]{0.0f, 0.0f, 0.0f};
        this.f67499l = true;
    }
    ...
    public void onInit() {
        super.onInit();
        this.f67492e = GLES20.glGetUniformLocation(getProgram(), "shadowsShift");
        this.f67493f = GLES20.glGetUniformLocation(getProgram(), "midtonesShift");
        this.f67494g = GLES20.glGetUniformLocation(getProgram(), "highlightsShift");
        this.f67495h = GLES20.glGetUniformLocation(getProgram(), "preserveLuminosity");
    }

    @Override // jp.p022co.cyberagent.android.gpuimage.GPUImageFilter
    public void onInitialized() {
        super.onInitialized();
        setMidtones(this.f67497j);
        setShowdows(this.f67496i);
        setHighlights(this.f67498k);
        setPreserveLuminosity(this.f67499l);
    }

    public void setHighlights(float[] fArr) {
        this.f67498k = fArr;
        setFloatVec3(this.f67494g, fArr);
    }

    public void setMidtones(float[] fArr) {
        this.f67497j = fArr;
        setFloatVec3(this.f67493f, fArr);
    }

    public void setPreserveLuminosity(boolean z) {
        this.f67499l = z;
        setInteger(this.f67495h, z ? 1 : 0);
    }

    public void setShowdows(float[] fArr) {
        this.f67496i = fArr;
        setFloatVec3(this.f67492e, fArr);
    }
}