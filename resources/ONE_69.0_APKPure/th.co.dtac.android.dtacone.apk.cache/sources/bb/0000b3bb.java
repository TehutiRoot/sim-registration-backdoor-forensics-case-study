...
public final class ObjectTypeAdapter extends TypeAdapter<Object> {
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C8732a {
        ...
        static {
            ...
            try {
                f56790a[JsonToken.BEGIN_OBJECT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f56790a[JsonToken.STRING.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f56790a[JsonToken.NUMBER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f56790a[JsonToken.BOOLEAN.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f56790a[JsonToken.NULL.ordinal()] = 6;
    ...
    private Object readTerminal(JsonReader jsonReader, JsonToken jsonToken) throws IOException {
        int i = C8732a.f56790a[jsonToken.ordinal()];
        if (i != 3) {
            if (i != 4) {
                if (i != 5) {
                    if (i == 6) {
