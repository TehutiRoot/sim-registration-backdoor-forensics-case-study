...
public class BadgePagerTitleView extends FrameLayout implements IMeasurablePagerTitleView {
    ...
    /* renamed from: a */
    public IPagerTitleView f72507a;
    ...
    /* renamed from: d */
    public BadgeRule f72510d;

    /* renamed from: e */
    public BadgeRule f72511e;
    ...
    public int getContentBottom() {
        IPagerTitleView iPagerTitleView = this.f72507a;
    ...
    public int getContentLeft() {
        if (this.f72507a instanceof IMeasurablePagerTitleView) {
            return getLeft() + ((IMeasurablePagerTitleView) this.f72507a).getContentLeft();
        }
        return getLeft();
    }
    ...
    public int getContentRight() {
        if (this.f72507a instanceof IMeasurablePagerTitleView) {
            return getLeft() + ((IMeasurablePagerTitleView) this.f72507a).getContentRight();
        }
        return getRight();
    }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        IPagerTitleView iPagerTitleView = this.f72507a;
        if ((iPagerTitleView instanceof View) && this.f72508b != null) {
            int[] iArr = new int[14];
            ...
            IPagerTitleView iPagerTitleView2 = this.f72507a;
            ...
            BadgeRule badgeRule = this.f72510d;
            if (badgeRule != null) {
                int offset = iArr[badgeRule.getAnchor().ordinal()] + this.f72510d.getOffset();
                View view2 = this.f72508b;
                view2.offsetLeftAndRight(offset - view2.getLeft());
            }
            BadgeRule badgeRule2 = this.f72511e;
            if (badgeRule2 != null) {
                int offset2 = iArr[badgeRule2.getAnchor().ordinal()] + this.f72511e.getOffset();
                View view3 = this.f72508b;
    ...
    public void setBadgeView(View view) {
        if (this.f72508b == view) {
            return;
        }
        this.f72508b = view;
        removeAllViews();
        if (this.f72507a instanceof View) {
            addView((View) this.f72507a, new FrameLayout.LayoutParams(-1, -1));
        }
        if (this.f72508b != null) {
            addView(this.f72508b, new FrameLayout.LayoutParams(-2, -2));
        }
    }

    public void setInnerPagerTitleView(IPagerTitleView iPagerTitleView) {
        if (this.f72507a == iPagerTitleView) {
            return;
        }
        this.f72507a = iPagerTitleView;
        removeAllViews();
        if (this.f72507a instanceof View) {
            addView((View) this.f72507a, new FrameLayout.LayoutParams(-1, -1));
        }
