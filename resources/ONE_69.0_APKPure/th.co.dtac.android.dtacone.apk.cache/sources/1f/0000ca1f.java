...
public final class FotoapparatBuilder {
    ...
    /* renamed from: b */
    public Function1 f62968b;

    /* renamed from: c */
    public Function1 f62969c;

    /* renamed from: d */
    public CameraRenderer f62970d;

    /* renamed from: e */
    public FocusView f62971e;

    /* renamed from: f */
    public ScaleType f62972f;

    /* renamed from: g */
    public Logger f62973g;

    /* renamed from: h */
    public CameraConfiguration f62974h;

    public FotoapparatBuilder(@NotNull Context context) {
        Intrinsics.checkNotNullParameter(context, "context");
        this.f62967a = context;
        this.f62968b = SelectorsKt.firstAvailable(LensPositionSelectorsKt.back(), LensPositionSelectorsKt.front(), LensPositionSelectorsKt.external());
        this.f62969c = FotoapparatBuilder$cameraErrorCallback$1.INSTANCE;
        this.f62972f = ScaleType.CenterCrop;
        this.f62973g = LoggersKt.none();
        this.f62974h = CameraConfiguration.Companion.m74249default();
    }

    /* renamed from: a */
    public final Fotoapparat m30905a(CameraRenderer cameraRenderer) {
        if (cameraRenderer != null) {
            return new Fotoapparat(this.f62967a, cameraRenderer, this.f62971e, this.f62968b, this.f62972f, this.f62974h, this.f62969c, null, this.f62973g, 128, null);
        }
    ...
    public final FotoapparatBuilder exposureCompensation(@NotNull Function1<? super IntRange, Integer> selector) {
        ...
        this.f62974h = CameraConfiguration.copy$default(this.f62974h, null, null, null, selector, null, null, null, null, null, null, 1015, null);
        return this;
    }
    ...
    public final FotoapparatBuilder flash(@NotNull Function1<? super Iterable<? extends Flash>, ? extends Flash> selector) {
        Intrinsics.checkNotNullParameter(selector, "selector");
        this.f62974h = CameraConfiguration.copy$default(this.f62974h, selector, null, null, null, null, null, null, null, null, null, 1022, null);
        return this;
    }
    ...
    public final FotoapparatBuilder focusMode(@NotNull Function1<? super Iterable<? extends FocusMode>, ? extends FocusMode> selector) {
        Intrinsics.checkNotNullParameter(selector, "selector");
        this.f62974h = CameraConfiguration.copy$default(this.f62974h, null, selector, null, null, null, null, null, null, null, null, PointerIconCompat.TYPE_GRABBING, null);
        return this;
    }
    ...
    public final FotoapparatBuilder frameProcessor(@NotNull Function1<? super Frame, Unit> frameProcessor) {
        ...
        this.f62974h = CameraConfiguration.copy$default(this.f62974h, null, null, null, null, frameProcessor, null, null, null, null, null, 1007, null);
        return this;
    }
    ...
    public final FotoapparatBuilder jpegQuality(@NotNull Function1<? super IntRange, Integer> selector) {
        Intrinsics.checkNotNullParameter(selector, "selector");
        this.f62974h = CameraConfiguration.copy$default(this.f62974h, null, null, selector, null, null, null, null, null, null, null, PointerIconCompat.TYPE_ZOOM_OUT, null);
        return this;
    }
    ...
    public final FotoapparatBuilder photoResolution(@NotNull Function1<? super Iterable<Resolution>, Resolution> selector) {
        Intrinsics.checkNotNullParameter(selector, "selector");
        this.f62974h = CameraConfiguration.copy$default(this.f62974h, null, null, null, null, null, null, null, null, selector, null, 767, null);
        return this;
    }
    ...
    public final FotoapparatBuilder previewFpsRange(@NotNull Function1<? super Iterable<FpsRange>, FpsRange> selector) {
        Intrinsics.checkNotNullParameter(selector, "selector");
        this.f62974h = CameraConfiguration.copy$default(this.f62974h, null, null, null, null, null, selector, null, null, null, null, 991, null);
        return this;
    }
    ...
    public final FotoapparatBuilder previewResolution(@NotNull Function1<? super Iterable<Resolution>, Resolution> selector) {
        Intrinsics.checkNotNullParameter(selector, "selector");
        this.f62974h = CameraConfiguration.copy$default(this.f62974h, null, null, null, null, null, null, null, null, null, selector, FrameMetricsAggregator.EVERY_DURATION, null);
        return this;
    }
    ...
    public final FotoapparatBuilder sensorSensitivity(@NotNull Function1<? super Iterable<Integer>, Integer> selector) {
        Intrinsics.checkNotNullParameter(selector, "selector");
        this.f62974h = CameraConfiguration.copy$default(this.f62974h, null, null, null, null, null, null, null, selector, null, null, 895, null);
        return this;
    }
    ...
    public final void setConfiguration$fotoapparat_release(@NotNull CameraConfiguration cameraConfiguration) {
        ...
        this.f62974h = cameraConfiguration;
    }
    ...
    public final FotoapparatBuilder cameraErrorCallback(@NotNull Function1<? super CameraException, Unit> callback) {
        Intrinsics.checkNotNullParameter(callback, "callback");
        this.f62969c = callback;
        return this;
    }

    @NotNull
    public final FotoapparatBuilder frameProcessor(@Nullable FrameProcessor frameProcessor) {
        this.f62974h = CameraConfiguration.copy$default(this.f62974h, null, null, null, null, frameProcessor != null ? new FotoapparatBuilder$frameProcessor$2$1$1(frameProcessor) : null, null, null, null, null, null, 1007, null);
        return this;
    }
}