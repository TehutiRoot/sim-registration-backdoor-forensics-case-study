...
public final class PersistentHashMapBuilderKeys<K, V> extends AbstractMutableSet<K> implements Set<K>, KMutableSet {
    ...
    public boolean contains(Object obj) {
        return this.f28656a.containsKey(obj);
    }
    ...
    public Iterator<K> iterator() {
        return new PersistentHashMapBuilderKeysIterator(this.f28656a);
    }

    @Override // java.util.AbstractCollection, java.util.Collection, java.util.Set
    public boolean remove(Object obj) {
        if (this.f28656a.containsKey(obj)) {
            this.f28656a.remove(obj);
            return true;
        }
        return false;
    }
