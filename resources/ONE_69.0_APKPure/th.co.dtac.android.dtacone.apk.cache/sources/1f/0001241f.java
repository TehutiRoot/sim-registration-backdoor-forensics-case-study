...
/* renamed from: th.co.dtac.android.dtacone.presenter.newsfeed.NewsFeedPresenter$refreshNewsFeed$2 */
/* loaded from: classes8.dex */
public final class NewsFeedPresenter$refreshNewsFeed$2 extends Lambda implements Function1<List<NewsItem>, Unit> {
    final /* synthetic */ NewsFeedPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NewsFeedPresenter$refreshNewsFeed$2(NewsFeedPresenter newsFeedPresenter) {
        super(1);
    ...
    public final void invoke2(List<NewsItem> newsFeed) {
        ...
        view.onRefreshSuccess(newsFeed);
    }
}