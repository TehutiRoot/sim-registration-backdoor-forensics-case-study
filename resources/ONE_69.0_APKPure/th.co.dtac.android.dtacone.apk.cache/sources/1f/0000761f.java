...
public final class Data {
    ...
    /* renamed from: b */
    public static final String f38314b = Logger.tagWithPrefix(Constant.BenefitName.Data);
    ...
    public static final class Builder {
        ...
        /* renamed from: a */
        public Map f38316a = new HashMap();

        @NonNull
        public Data build() {
            Data data = new Data(this.f38316a);
        ...
        public Builder put(@NonNull String str, @Nullable Object obj) {
            if (obj == null) {
                this.f38316a.put(str, null);
            } else {
                Class<?> cls = obj.getClass();
                if (cls != Boolean.class && cls != Byte.class && cls != Integer.class && cls != Long.class && cls != Float.class && cls != Double.class && cls != String.class && cls != Boolean[].class && cls != Byte[].class && cls != Integer[].class && cls != Long[].class && cls != Float[].class && cls != Double[].class && cls != String[].class) {
                    if (cls == boolean[].class) {
                        this.f38316a.put(str, Data.convertPrimitiveBooleanArray((boolean[]) obj));
                    } else if (cls == byte[].class) {
                        this.f38316a.put(str, Data.convertPrimitiveByteArray((byte[]) obj));
                    } else if (cls == int[].class) {
                        this.f38316a.put(str, Data.convertPrimitiveIntArray((int[]) obj));
                    } else if (cls == long[].class) {
                        this.f38316a.put(str, Data.convertPrimitiveLongArray((long[]) obj));
                    } else if (cls == float[].class) {
                        this.f38316a.put(str, Data.convertPrimitiveFloatArray((float[]) obj));
                    } else if (cls == double[].class) {
                        this.f38316a.put(str, Data.convertPrimitiveDoubleArray((double[]) obj));
                    } else {
                        throw new IllegalArgumentException("Key " + str + " has invalid type " + cls);
                    }
                } else {
                    this.f38316a.put(str, obj);
                }
            }
            return this;
        }
    ...
    public Data(@NonNull Data data) {
        this.f38315a = new HashMap(data.f38315a);
    }
        ...
        try {
            try {
                ...
                try {
                    ...
                    for (Map.Entry entry : data.f38315a.entrySet()) {
    ...
    public boolean equals(Object obj) {
        ...
        Data data = (Data) obj;
        Set<String> keySet = this.f38315a.keySet();
        if (!keySet.equals(data.f38315a.keySet())) {
            return false;
        }
        for (String str : keySet) {
            Object obj2 = this.f38315a.get(str);
            Object obj3 = data.f38315a.get(str);
    ...
    public boolean getBoolean(@NonNull String str, boolean z) {
        Object obj = this.f38315a.get(str);
    ...
    public Map<String, Object> getKeyValueMap() {
        return Collections.unmodifiableMap(this.f38315a);
    }
    ...
    public int hashCode() {
        return this.f38315a.hashCode() * 31;
    }
    ...
    public String toString() {
        ...
        if (!this.f38315a.isEmpty()) {
            for (String str : this.f38315a.keySet()) {
                sb.append(str);
                sb.append(" : ");
                Object obj = this.f38315a.get(str);
