...
@Metadata(m29143d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010!\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\b\u0012\u0004\u0012\u00020\u00020\u0001*\u00020\u0003H\u008a@"}, m29142d2 = {"<anonymous>", "", "Lcom/chuckerteam/chucker/internal/ui/transaction/TransactionPayloadItem;", "Lkotlinx/coroutines/CoroutineScope;"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
@DebugMetadata(m29093c = "com.chuckerteam.chucker.internal.ui.transaction.TransactionPayloadFragment$processPayload$2", m29092f = "TransactionPayloadFragment.kt", m29091i = {0, 0}, m29090l = {364}, m29089m = "invokeSuspend", m29088n = {"result", "responseBitmap"}, m29087s = {"L$0", "L$1"})
...
public final class TransactionPayloadFragment$processPayload$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<TransactionPayloadItem>>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i != 0) {
            ...
            if (!AbstractC19741eO1.isBlank(responseHeadersString)) {
            ...
            if (this.$type == PayloadType.RESPONSE && responseImageBitmap != null) {
                ...
                } else if (!AbstractC19741eO1.isBlank(spannedResponseBody)) {
                    m49833u = this.this$0.m49833u(spannedResponseBody);
                    for (CharSequence charSequence : m49833u) {
