...
public class DefaultHttpResponseParserFactory implements HttpMessageParserFactory<HttpResponse> {
    ...
    /* renamed from: a */
    public final LineParser f74327a;

    /* renamed from: b */
    public final HttpResponseFactory f74328b;

    public DefaultHttpResponseParserFactory(LineParser lineParser, HttpResponseFactory httpResponseFactory) {
        this.f74327a = lineParser == null ? BasicLineParser.INSTANCE : lineParser;
        this.f74328b = httpResponseFactory == null ? DefaultHttpResponseFactory.INSTANCE : httpResponseFactory;
    }
    ...
    public HttpMessageParser<HttpResponse> create(SessionInputBuffer sessionInputBuffer, MessageConstraints messageConstraints) {
        return new DefaultHttpResponseParser(sessionInputBuffer, this.f74327a, this.f74328b, messageConstraints);
    }
