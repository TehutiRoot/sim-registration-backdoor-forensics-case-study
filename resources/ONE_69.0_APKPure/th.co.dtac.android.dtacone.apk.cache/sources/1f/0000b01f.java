...
public class RemoveRepeatsStrategy implements StackTraceTrimmingStrategy {
    ...
    /* renamed from: a */
    public static boolean m38759a(StackTraceElement[] stackTraceElementArr, int i, int i2) {
        int i3 = i2 - i;
    ...
    /* renamed from: b */
    public static StackTraceElement[] m38758b(StackTraceElement[] stackTraceElementArr, int i) {
        int i2;
        ...
        while (i3 < stackTraceElementArr.length) {
            ...
            if (num != null && m38759a(stackTraceElementArr, num.intValue(), i3)) {
    ...
    public StackTraceElement[] getTrimmedStackTrace(StackTraceElement[] stackTraceElementArr) {
        StackTraceElement[] m38758b = m38758b(stackTraceElementArr, this.f55419a);
        if (m38758b.length < stackTraceElementArr.length) {
            return m38758b;
        }
