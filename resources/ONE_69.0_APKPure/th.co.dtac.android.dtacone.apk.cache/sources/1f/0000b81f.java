...
public final class QRCodeMultiReader extends QRCodeReader implements MultipleBarcodeReader {
    ...
    /* renamed from: c */
    public static final Result[] f57853c = new Result[0];

    /* renamed from: d */
    public static final ResultPoint[] f57854d = new ResultPoint[0];
    ...
    /* renamed from: c */
    public static List m34063c(List list) {
        ...
        while (it.hasNext()) {
            if (((Result) it.next()).getResultMetadata().containsKey(ResultMetadataType.STRUCTURED_APPEND_SEQUENCE)) {
                ...
                Result result4 = new Result(sb.toString(), bArr2, f57854d, BarcodeFormat.QR_CODE);
                if (i2 > 0) {
    ...
    public Result[] decodeMultiple(BinaryBitmap binaryBitmap, Map<DecodeHintType, ?> map) throws NotFoundException {
        ...
        List m34063c = m34063c(arrayList);
        return (Result[]) m34063c.toArray(new Result[m34063c.size()]);
    }
}