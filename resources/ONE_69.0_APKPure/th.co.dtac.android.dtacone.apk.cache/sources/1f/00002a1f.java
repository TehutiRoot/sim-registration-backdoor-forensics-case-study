...
@DebugMetadata(m29093c = "androidx.compose.material.AnchoredDraggableState$doAnchoredDrag$2", m29092f = "AnchoredDraggable.kt", m29091i = {}, m29090l = {441}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
...
public final class AnchoredDraggableState$doAnchoredDrag$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(m29093c = "androidx.compose.material.AnchoredDraggableState$doAnchoredDrag$2$1", m29092f = "AnchoredDraggable.kt", m29091i = {}, m29090l = {WebSocket.DEFAULT_WSS_PORT}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
    /* renamed from: androidx.compose.material.AnchoredDraggableState$doAnchoredDrag$2$1 */
    /* loaded from: classes.dex */
    public static final class C30421 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        final /* synthetic */ Function3<AnchoredDragScope, Map<T, Float>, Continuation<? super Unit>, Object> $block;
        final /* synthetic */ T $targetValue;
        int label;
        final /* synthetic */ AnchoredDraggableState<T> this$0;
        ...
        public C30421(T t, AnchoredDraggableState<T> anchoredDraggableState, Function3<? super AnchoredDragScope, ? super Map<T, Float>, ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super C30421> continuation) {
        ...
        public final Continuation<Unit> create(@NotNull Continuation<?> continuation) {
            return new C30421(this.$targetValue, this.this$0, this.$block, continuation);
        }
        ...
        public final Object invoke2(@Nullable Continuation<? super Unit> continuation) {
            return ((C30421) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
        ...
        try {
            if (i != 0) {
                ...
                if (this.$targetValue == null || this.this$0.getAnchors$material_release().containsKey(this.$targetValue)) {
                    internalMutatorMutex = this.this$0.f14418e;
                    MutatePriority mutatePriority = this.$dragPriority;
                    C30421 c30421 = new C30421(this.$targetValue, this.this$0, this.$block, null);
                    this.label = 1;
                    if (internalMutatorMutex.mutate(mutatePriority, c30421, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (((Boolean) this.this$0.getConfirmValueChange$material_release().invoke(this.$targetValue)).booleanValue()) {
                        this.this$0.m60907f(this.$targetValue);
                    }
                    return Unit.INSTANCE;
                }
            }
            if (this.$targetValue != null) {
                this.this$0.m60908e(null);
            }
