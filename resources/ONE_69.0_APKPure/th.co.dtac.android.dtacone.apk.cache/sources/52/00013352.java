...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.viewModel.OneMnpViewModel$callApiGetTrueLocation$1 */
/* loaded from: classes10.dex */
public final class OneMnpViewModel$callApiGetTrueLocation$1 extends Lambda implements Function1<OneCommonTrueLocationResponse, SingleSource<? extends OneCommonTrueLocationResponse>> {
    final /* synthetic */ OneMnpViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneMnpViewModel$callApiGetTrueLocation$1(OneMnpViewModel oneMnpViewModel) {
        super(1);
    ...
    public final SingleSource<? extends OneCommonTrueLocationResponse> invoke(@NotNull OneCommonTrueLocationResponse response) {
        ...
        rtrRx2Repository = this.this$0.f92132g;
