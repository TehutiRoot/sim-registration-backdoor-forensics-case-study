...
public final class zzhb extends zzfu<zzhb> implements Cloneable {
    ...
    /* renamed from: c */
    public static volatile zzhb[] f45643c;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof zzhb) {
            ...
            if (str == null) {
                if (zzhbVar.f45644a != null) {
                    return false;
                }
            } else if (!str.equals(zzhbVar.f45644a)) {
                return false;
            }
            String str2 = this.f45645b;
            if (str2 == null) {
                if (zzhbVar.f45645b != null) {
                    return false;
                }
            } else if (!str2.equals(zzhbVar.f45645b)) {
                return false;
            }
    ...
    public final void zza(zzfs zzfsVar) throws IOException {
        ...
        if (str != null && !str.equals("")) {
            zzfsVar.zza(1, this.f45644a);
        }
        String str2 = this.f45645b;
        if (str2 != null && !str2.equals("")) {
            zzfsVar.zza(2, this.f45645b);
        }
        super.zza(zzfsVar);
    }
    ...
    public final int zzen() {
        ...
        String str = this.f45644a;
        if (str != null && !str.equals("")) {
            zzen += zzfs.zzb(1, this.f45644a);
        }
        String str2 = this.f45645b;
        return (str2 == null || str2.equals("")) ? zzen : zzen + zzfs.zzb(2, this.f45645b);
    }
