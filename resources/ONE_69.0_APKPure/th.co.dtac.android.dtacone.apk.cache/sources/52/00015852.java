...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_change_sim.MrtrChangeSimViewModel$submitChangeSim$1$2 */
/* loaded from: classes9.dex */
public final class MrtrChangeSimViewModel$submitChangeSim$1$2 extends Lambda implements Function1<StatusResponse, Unit> {
    final /* synthetic */ MrtrChangeSimViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrChangeSimViewModel$submitChangeSim$1$2(MrtrChangeSimViewModel mrtrChangeSimViewModel) {
        super(1);
