...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.esim.ESimPostpaidViewModel$mrtrPostpaidRegistration$4 */
/* loaded from: classes9.dex */
public final class ESimPostpaidViewModel$mrtrPostpaidRegistration$4 extends Lambda implements Function1<MrtrPostpaidRegistrationResponse, Unit> {
    final /* synthetic */ ESimPostpaidViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimPostpaidViewModel$mrtrPostpaidRegistration$4(ESimPostpaidViewModel eSimPostpaidViewModel) {
        super(1);
    ...
    public final void invoke2(MrtrPostpaidRegistrationResponse mrtrPostpaidRegistrationResponse) {
        ...
        if (this.this$0.isCheckSimStock()) {
            ...
            if (eSimRepository.getCheckSimStockResponse() != null) {
                this.this$0.callCutSIMStock(true);
                return;
            }
        }
        this.this$0.m2851N(true);
    }
}