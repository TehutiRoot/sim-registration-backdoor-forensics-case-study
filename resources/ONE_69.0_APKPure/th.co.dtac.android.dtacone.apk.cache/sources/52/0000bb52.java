...
public class C9296cm implements keys {
    ...
    private final InterfaceC9641ns valueOf = C9642nt.ThreeDS2ServiceInstance(C9296cm.class);
    private final String values;

    public C9296cm(isEmpty isempty, String str, String str2) {
    ...
    public void valueOf(setLineSpacing.ThreeDS2ServiceInstance threeDS2ServiceInstance) {
        ...
        if (!(isempty instanceof C9262bi)) {
            ...
            valueOf = ((C9262bi) isempty).valueOf();
        }
        KeyEvent.normalizeMetaState(0);
        PointF.length(0.0f, 0.0f);
        ViewConfiguration.getFadingEdgeLength();
        if (!C9365eu.values.ThreeDS2Service.get().equals(this.values)) {
