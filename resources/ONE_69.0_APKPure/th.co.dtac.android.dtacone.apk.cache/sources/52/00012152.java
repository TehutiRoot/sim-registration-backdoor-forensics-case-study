...
/* renamed from: th.co.dtac.android.dtacone.presenter.address.QueryAddressFromDbPresenter$getPostCodeFromSQLite$1 */
/* loaded from: classes8.dex */
public final class QueryAddressFromDbPresenter$getPostCodeFromSQLite$1 extends Lambda implements Function1<SqlBrite.Query, List<? extends AddressItemData>> {
    ...
    public QueryAddressFromDbPresenter$getPostCodeFromSQLite$1(QueryAddressFromDbPresenter queryAddressFromDbPresenter, int i, int i2) {
        super(1);
    ...
    public final List<AddressItemData> invoke(SqlBrite.Query query) {
        ...
        m19152L = queryAddressFromDbPresenter.m19152L(i, i2, query);
        return m19152L;
    }
}