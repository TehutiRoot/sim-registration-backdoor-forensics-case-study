...
public final class DefaultExecutor extends EventLoopImplBase implements Runnable {
    ...
    /* renamed from: g */
    public static final long f70626g;
    ...
    static {
        ...
        f70626g = timeUnit.toNanos(l.longValue());
    }
    ...
    /* renamed from: p */
    public final synchronized void m27680p() {
        if (!m27677s()) {
            return;
        }
        debugStatus = 3;
    ...
    /* renamed from: q */
    public final synchronized Thread m27679q() {
        Thread thread;
        thread = _thread;
        if (thread == null) {
        ...
        try {
            ...
            while (true) {
                ...
                if (processNextEvent == Long.MAX_VALUE) {
                    ...
                    processNextEvent = AbstractC11695c.coerceAtMost(processNextEvent, j2);
                } else {
                    j = Long.MAX_VALUE;
                }
    ...
    /* renamed from: t */
    public final synchronized boolean m27676t() {
        if (m27677s()) {
            return false;
        }
        debugStatus = 1;
