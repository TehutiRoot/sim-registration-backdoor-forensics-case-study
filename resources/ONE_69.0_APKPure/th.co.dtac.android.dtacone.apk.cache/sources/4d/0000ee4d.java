...
public final class Pipe {
    ...
    /* renamed from: b */
    public final Buffer f72945b = new Buffer();
    ...
    /* renamed from: g */
    public final ReentrantLock f72950g;

    /* renamed from: h */
    public final Condition f72951h;

    /* renamed from: i */
    public final Sink f72952i;

    /* renamed from: j */
    public final Source f72953j;

    public Pipe(long j) {
        this.f72944a = j;
        ReentrantLock reentrantLock = new ReentrantLock();
        this.f72950g = reentrantLock;
        Condition newCondition = reentrantLock.newCondition();
        Intrinsics.checkNotNullExpressionValue(newCondition, "lock.newCondition()");
        this.f72951h = newCondition;
        if (j >= 1) {
            this.f72952i = new Sink() { // from class: okio.Pipe$sink$1

                /* renamed from: a */
                public final Timeout f72954a = new Timeout();
            ...
            this.f72953j = new Source() { // from class: okio.Pipe$source$1

                /* renamed from: a */
                public final Timeout f72956a = new Timeout();
                        ...
                        if (!pipe.getSourceClosed$okio()) {
                            if (!pipe.getCanceled$okio()) {
                                while (pipe.getBuffer$okio().size() == 0) {
                                    ...
                                    this.f72956a.awaitSignal(pipe.getCondition());
                                    if (pipe.getCanceled$okio()) {
                                        throw new IOException("canceled");
                                    }
                                }
    ...
    public final Sink m75103deprecated_sink() {
        return this.f72952i;
    }
    ...
    public final Source m75104deprecated_source() {
        return this.f72953j;
    }

    public final void cancel() {
        ReentrantLock reentrantLock = this.f72950g;
        reentrantLock.lock();
        try {
            this.f72946c = true;
            this.f72945b.clear();
            this.f72951h.signalAll();
            Unit unit = Unit.INSTANCE;
        } finally {
        ...
        while (true) {
            ...
            try {
                if (this.f72949f == null) {
                    if (!this.f72946c) {
                        if (this.f72945b.exhausted()) {
                            this.f72948e = true;
                            this.f72949f = sink;
                            return;
                        }
                        boolean z = this.f72947d;
                        Buffer buffer = new Buffer();
                        Buffer buffer2 = this.f72945b;
