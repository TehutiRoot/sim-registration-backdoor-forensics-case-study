...
/* renamed from: th.co.dtac.android.dtacone.databinding.FragmentOneNadOutboundTrueOnlineBinding */
/* loaded from: classes7.dex */
public final class FragmentOneNadOutboundTrueOnlineBinding implements ViewBinding {

    /* renamed from: a */
    public final SwipeRefreshLayout f84092a;
    @NonNull
    ...
    @NonNull
    public static FragmentOneNadOutboundTrueOnlineBinding bind(@NonNull View view) {
    ...
    @NonNull
    public static FragmentOneNadOutboundTrueOnlineBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static FragmentOneNadOutboundTrueOnlineBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.fragment_one_nad_outbound_true_online, viewGroup, false);
        if (z) {
