...
@Metadata(m29143d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m29142d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_broadcastOnPersonal", "Landroidx/compose/material/icons/Icons$TwoTone;", "getBroadcastOnPersonal", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "BroadcastOnPersonal", "material-icons-extended_release"}, m29141k = 2, m29140mv = {1, 8, 0})
...
public final class BroadcastOnPersonalKt {
    ...
    /* renamed from: a */
    public static ImageVector f23615a;

    @NotNull
    public static final ImageVector getBroadcastOnPersonal(@NotNull Icons.TwoTone twoTone) {
        Intrinsics.checkNotNullParameter(twoTone, "<this>");
        ImageVector imageVector = f23615a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.BroadcastOnPersonal", C3623Dp.m73842constructorimpl(24.0f), C3623Dp.m73842constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.curveTo(9.21f, 18.07f, 9.0f, 17.06f, 9.0f, 16.0f);
        pathBuilder.curveToRelative(0.0f, -3.39f, 2.11f, -6.27f, 5.08f, -7.44f);
        ...
        pathBuilder2.lineToRelative(4.08f, 3.06f);
        pathBuilder2.curveToRelative(0.81f, -0.32f, 1.69f, -0.51f, 2.61f, -0.54f);
        pathBuilder2.lineTo(10.0f, 3.0f);
        pathBuilder2.lineTo(2.0f, 9.0f);
        pathBuilder2.verticalLineToRelative(12.0f);
        pathBuilder2.horizontalLineToRelative(8.76f);
        pathBuilder2.curveToRelative(-0.48f, -0.6f, -0.88f, -1.27f, -1.17f, -2.0f);
        ...
        pathBuilder3.curveTo(18.25f, 15.31f, 17.69f, 14.75f, 17.0f, 14.75f);
        pathBuilder3.close();
        ...
        pathBuilder4.curveTo(21.0f, 13.79f, 19.21f, 12.0f, 17.0f, 12.0f);
        pathBuilder4.close();
