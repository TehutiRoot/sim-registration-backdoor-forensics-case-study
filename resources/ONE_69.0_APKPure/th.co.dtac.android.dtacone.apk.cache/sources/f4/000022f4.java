...
public final class TransitionKt$animateDp$1 extends Lambda implements Function3<Transition.Segment<S>, Composer, Integer, SpringSpec<C3623Dp>> {
    ...
    public /* bridge */ /* synthetic */ SpringSpec<C3623Dp> invoke(Object obj, Composer composer, Integer num) {
        return invoke((Transition.Segment) obj, composer, num.intValue());
    }

    @Composable
    @NotNull
    public final SpringSpec<C3623Dp> invoke(@NotNull Transition.Segment<S> segment, @Nullable Composer composer, int i) {
