...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.deviceSaleTrueCompany.viewModel.OneDeviceSaleTrueViewModel$getPricePlansDetail$2 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleTrueViewModel$getPricePlansDetail$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ OneDeviceSaleTrueViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneDeviceSaleTrueViewModel$getPricePlansDetail$2(OneDeviceSaleTrueViewModel oneDeviceSaleTrueViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable throwable) {
        ...
        m14899C0.postValue(Resource.Companion.error("", null, 0));
