...
public final class Date extends GeneratedMessageLite<Date, Builder> implements DateOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Date, Builder> implements DateOrBuilder {
        ...
        public Builder clearDay() {
            copyOnWrite();
            ((Date) this.instance).m34476I();
            return this;
        }

        public Builder clearMonth() {
            copyOnWrite();
            ((Date) this.instance).m34475J();
            return this;
        }

        public Builder clearYear() {
            copyOnWrite();
            ((Date) this.instance).m34474K();
            return this;
        }
        ...
        public Builder setDay(int i) {
            copyOnWrite();
            ((Date) this.instance).m34473L(i);
            return this;
        }

        public Builder setMonth(int i) {
            copyOnWrite();
            ((Date) this.instance).m34472M(i);
            return this;
        }

        public Builder setYear(int i) {
            copyOnWrite();
            ((Date) this.instance).m34471N(i);
            return this;
        }
    ...
    /* renamed from: I */
    public final void m34476I() {
        this.day_ = 0;
    }

    /* renamed from: J */
    public final void m34475J() {
        this.month_ = 0;
    }

    /* renamed from: K */
    public final void m34474K() {
        this.year_ = 0;
    }

    /* renamed from: L */
    public final void m34473L(int i) {
        this.day_ = i;
    }

    /* renamed from: M */
    public final void m34472M(int i) {
        this.month_ = i;
    }

    /* renamed from: N */
    public final void m34471N(int i) {
        this.year_ = i;
    }

    @Override // com.google.protobuf.GeneratedMessageLite
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C8986a.f57568a[methodToInvoke.ordinal()]) {
            case 1:
                return new Date();
            case 2:
