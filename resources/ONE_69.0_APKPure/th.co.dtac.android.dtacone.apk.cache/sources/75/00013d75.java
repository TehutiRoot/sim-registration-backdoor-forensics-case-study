...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.registration.fragment.OneInputInfoFragment$initViewModel$1$1 */
/* loaded from: classes10.dex */
public final class OneInputInfoFragment$initViewModel$1$1 extends Lambda implements Function1<Resource<? extends Void>, Unit> {
    final /* synthetic */ OneInputInfoFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneInputInfoFragment$initViewModel$1$1(OneInputInfoFragment oneInputInfoFragment) {
        super(1);
    ...
    public final void invoke2(Resource<Void> resource) {
        ...
        OneRegistrationActivity m10441m;
        if (resource == null || (resourceContentIfNotHandled = resource.getResourceContentIfNotHandled()) == null) {
            return;
        }
        OneInputInfoFragment oneInputInfoFragment = this.this$0;
        if (resourceContentIfNotHandled.getStatus() == StatusResource.SUCCESS) {
            m10441m = oneInputInfoFragment.m10441m();
            m10441m.replaceFragment(OneInputOTPFragment.Companion.newInstance(), null);
        }
    }
}