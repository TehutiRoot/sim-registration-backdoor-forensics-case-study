...
public final class OneForgotPasswordViewModelFactory_Factory implements Factory<OneForgotPasswordViewModelFactory> {
    ...
    /* renamed from: a */
    public final Provider f82700a;

    /* renamed from: b */
    public final Provider f82701b;

    /* renamed from: c */
    public final Provider f82702c;

    /* renamed from: d */
    public final Provider f82703d;
    ...
    public OneForgotPasswordViewModelFactory_Factory(Provider<OneForgotPasswordRepository> provider, Provider<Rx2ThreadService> provider2, Provider<OneErrorService> provider3, Provider<TemporaryCache> provider4) {
        this.f82700a = provider;
        this.f82701b = provider2;
        this.f82702c = provider3;
        this.f82703d = provider4;
    }
    ...
    public OneForgotPasswordViewModelFactory get() {
        return newInstance((OneForgotPasswordRepository) this.f82700a.get(), (Rx2ThreadService) this.f82701b.get(), (OneErrorService) this.f82702c.get(), (TemporaryCache) this.f82703d.get());
    }
}