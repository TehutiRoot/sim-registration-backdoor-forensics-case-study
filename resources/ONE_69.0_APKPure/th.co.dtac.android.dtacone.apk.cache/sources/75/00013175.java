...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.home.viewModel.OneHomeViewModel$getMrtrPre2PostAuthorization$3 */
/* loaded from: classes10.dex */
public final class OneHomeViewModel$getMrtrPre2PostAuthorization$3 extends Lambda implements Function1<GetPre2PostAuthorizationByRtrResponse, Unit> {
    final /* synthetic */ OneHomeViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneHomeViewModel$getMrtrPre2PostAuthorization$3(OneHomeViewModel oneHomeViewModel) {
        super(1);
    ...
    public final void invoke2(GetPre2PostAuthorizationByRtrResponse getPre2PostAuthorizationByRtrResponse) {
        ...
        m14066P.setValue(Resource.Companion.success(getPre2PostAuthorizationByRtrResponse));
    }
}