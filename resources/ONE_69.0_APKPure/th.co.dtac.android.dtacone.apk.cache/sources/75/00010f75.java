...
public final class PlaceSuggestionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    /* renamed from: a */
    public final Activity f81267a;

    /* renamed from: b */
    public final List f81268b;

    /* renamed from: c */
    public String f81269c;

    /* renamed from: d */
    public OnClickPlaceSuggestion f81270d;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final int $stable = 8;

    @Metadata(m29143d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0005"}, m29142d2 = {"Lth/co/dtac/android/dtacone/adapter/dtacAtHome/PlaceSuggestionAdapter$Companion;", "", "()V", "VIEW_TYPE_NORMAL", "", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    @Metadata(m29143d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&¨\u0006\u0006"}, m29142d2 = {"Lth/co/dtac/android/dtacone/adapter/dtacAtHome/PlaceSuggestionAdapter$OnClickPlaceSuggestion;", "", "onClickPlaceSuggestionItem", "", "placeSuggest", "Lth/co/dtac/android/dtacone/model/dtacAtHome/placeSuggest/PlaceSuggestionItem;", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    public final class PlaceSuggestionItemViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: a */
        public final RelativeLayout f81271a;

        /* renamed from: b */
        public final TextView f81272b;

        /* renamed from: c */
        public final TextView f81273c;

        /* renamed from: d */
        public final TextView f81274d;

        /* renamed from: e */
        public final /* synthetic */ PlaceSuggestionAdapter f81275e;
    ...
    public PlaceSuggestionAdapter(@NotNull Activity activity, @Nullable List<PlaceSuggestionItem> list) {
        ...
        this.f81267a = activity;
        this.f81268b = list;
        this.f81269c = "";
    }

    /* renamed from: a */
    public static /* synthetic */ void m20544a(OnClickPlaceSuggestion onClickPlaceSuggestion, PlaceSuggestionItem placeSuggestionItem, View view) {
        m20543b(onClickPlaceSuggestion, placeSuggestionItem, view);
    }

    /* renamed from: b */
    public static final void m20543b(OnClickPlaceSuggestion theListener, PlaceSuggestionItem placeSuggest, View view) {
    ...
    /* renamed from: c */
    public final void m20542c(PlaceSuggestionItemViewHolder placeSuggestionItemViewHolder, String str, String str2, String str3) {
    ...
    public void onBindViewHolder(@NotNull RecyclerView.ViewHolder holder, int i) {
        ...
        if (holder instanceof PlaceSuggestionItemViewHolder) {
            ...
            if (locationName != null) {
                list = StringsKt__StringsKt.split$default((CharSequence) locationName, new String[]{this.f81269c}, false, 0, 6, (Object) null);
            } else {
                list = null;
            }
            List list3 = list;
            if (list3 != null && !list3.isEmpty()) {
                if (list.size() == 2 && ((CharSequence) list.get(0)).length() == 0) {
                    m20542c((PlaceSuggestionItemViewHolder) holder, "", String.valueOf(this.f81269c), (String) list.get(1));
                } else if (list.size() > 2) {
                    m20542c((PlaceSuggestionItemViewHolder) holder, "", "", placeSuggestionItem.getLocationName());
                } else {
                    m20542c((PlaceSuggestionItemViewHolder) holder, "", "", placeSuggestionItem.getLocationName());
                }
            } else {
                ...
                m20542c(placeSuggestionItemViewHolder, "", "", locationName2);
            }
            final OnClickPlaceSuggestion onClickPlaceSuggestion = this.f81270d;
            if (onClickPlaceSuggestion != null) {
                ((PlaceSuggestionItemViewHolder) holder).getLayoutPlaceSuggestion().setOnClickListener(new View.OnClickListener() { // from class: ol1
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        PlaceSuggestionAdapter.m20544a(PlaceSuggestionAdapter.OnClickPlaceSuggestion.this, placeSuggestionItem, view);
                    }
                });
            }
        }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int i) {
        ...
        View view = LayoutInflater.from(this.f81267a).inflate(R.layout.item_place_suggestion, parent, false);
