...
public final class LookaheadAlignmentLines extends AlignmentLines {
    ...
    @Override // androidx.compose.p003ui.node.AlignmentLines
    /* renamed from: calculatePositionInParent-R5De75A */
    public long mo73073calculatePositionInParentR5De75A(@NotNull NodeCoordinator calculatePositionInParent, long j) {
        Intrinsics.checkNotNullParameter(calculatePositionInParent, "$this$calculatePositionInParent");
        LookaheadDelegate lookaheadDelegate = calculatePositionInParent.getLookaheadDelegate();
        Intrinsics.checkNotNull(lookaheadDelegate);
        long mo73109getPositionnOccac = lookaheadDelegate.mo73109getPositionnOccac();
        return Offset.m71691plusMKHz9U(OffsetKt.Offset(IntOffset.m73960getXimpl(mo73109getPositionnOccac), IntOffset.m73961getYimpl(mo73109getPositionnOccac)), j);
    }

    @Override // androidx.compose.p003ui.node.AlignmentLines
    @NotNull
    public Map<AlignmentLine, Integer> getAlignmentLinesMap(@NotNull NodeCoordinator nodeCoordinator) {
    ...
    @Override // androidx.compose.p003ui.node.AlignmentLines
    public int getPositionFor(@NotNull NodeCoordinator nodeCoordinator, @NotNull AlignmentLine alignmentLine) {
        Intrinsics.checkNotNullParameter(nodeCoordinator, "<this>");
