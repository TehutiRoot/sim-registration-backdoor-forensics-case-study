...
/* renamed from: th.co.dtac.android.dtacone.presenter.address.QueryAddressFromDbPresenter$getPostcodeFromDb$1 */
/* loaded from: classes8.dex */
public final class QueryAddressFromDbPresenter$getPostcodeFromDb$1 extends Lambda implements Function1<List<? extends AddressItemData>, Unit> {
    final /* synthetic */ QueryAddressFromDbPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public QueryAddressFromDbPresenter$getPostcodeFromDb$1(QueryAddressFromDbPresenter queryAddressFromDbPresenter) {
        super(1);
    ...
    public final void invoke2(List<AddressItemData> list) {
        ...
        QueryAddressFromDbPresenter.View view2;
        QueryAddressFromDbPresenter.View view3;
        QueryAddressFromDbPresenter.View view4 = null;
        if (list.size() == 1) {
            view3 = this.this$0.f85248e;
            if (view3 == null) {
        ...
        view.onPostcodeComplete();
        view2 = this.this$0.f85248e;
        if (view2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException(Promotion.ACTION_VIEW);
        } else {
            view4 = view2;
        }
        view4.onQuerySuccess(list);
    }
}