...
public class PersistentOrderedSetIterator<E> implements Iterator<E>, KMappedMarker {
    ...
    public boolean hasNext() {
        if (this.f28737c < this.f28736b.size()) {
            return true;
        }
        return false;
    }
    ...
    public E next() {
        ...
        E e = (E) this.f28735a;
        this.f28737c++;
        Object obj = this.f28736b.get(e);
        if (obj != null) {
            this.f28735a = ((Links) obj).getNext();
            return e;
        }
