...
public final class TypeEnhancementUtilsKt {
    /* renamed from: a */
    public static final NullabilityQualifier m28563a(JavaTypeQualifiers javaTypeQualifiers) {
    ...
    /* renamed from: b */
    public static final Object m28562b(Set set, Object obj, Object obj2, Object obj3, boolean z) {
        Set set2;
        Object obj4;
        if (z) {
            if (set.contains(obj)) {
        ...
        if (obj3 != null && (set2 = CollectionsKt___CollectionsKt.toSet(BH1.plus(set, obj3))) != null) {
            set = set2;
        }
    ...
    /* renamed from: c */
    public static final NullabilityQualifier m28561c(Set set, NullabilityQualifier nullabilityQualifier, boolean z) {
        NullabilityQualifier nullabilityQualifier2 = NullabilityQualifier.FORCE_FLEXIBILITY;
        if (nullabilityQualifier != nullabilityQualifier2) {
            return (NullabilityQualifier) m28562b(set, NullabilityQualifier.NOT_NULL, NullabilityQualifier.NULLABLE, nullabilityQualifier, z);
        }
    ...
    public static final JavaTypeQualifiers computeQualifiersForOverride(@NotNull JavaTypeQualifiers javaTypeQualifiers, @NotNull Collection<JavaTypeQualifiers> superQualifiers, boolean z, boolean z2, boolean z3) {
        ...
        for (JavaTypeQualifiers javaTypeQualifiers2 : collection) {
            NullabilityQualifier m28563a = m28563a(javaTypeQualifiers2);
            if (m28563a != null) {
                arrayList.add(m28563a);
            }
        }
        NullabilityQualifier m28561c = m28561c(CollectionsKt___CollectionsKt.toSet(arrayList), m28563a(javaTypeQualifiers), z);
        if (m28561c == null) {
            ...
            nullabilityQualifier = m28561c(CollectionsKt___CollectionsKt.toSet(arrayList2), javaTypeQualifiers.getNullability(), z);
        } else {
            nullabilityQualifier = m28561c;
        }
        ...
        MutabilityQualifier mutabilityQualifier = (MutabilityQualifier) m28562b(CollectionsKt___CollectionsKt.toSet(arrayList3), MutabilityQualifier.MUTABLE, MutabilityQualifier.READ_ONLY, javaTypeQualifiers.getMutability(), z);
        ...
        if (nullabilityQualifier2 == NullabilityQualifier.NOT_NULL) {
            if (!javaTypeQualifiers.getDefinitelyNotNull()) {
                ...
                z4 = true;
                if (nullabilityQualifier2 != null && m28561c != nullabilityQualifier) {
                    z5 = true;
                }
