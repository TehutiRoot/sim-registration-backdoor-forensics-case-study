...
public final class KotlinTypeFactory$simpleType$1 extends Lambda implements Function1<KotlinTypeRefiner, SimpleType> {
    ...
    public final SimpleType invoke(@NotNull KotlinTypeRefiner refiner) {
        ...
        m27859b = KotlinTypeFactory.INSTANCE.m27859b(this.$constructor, refiner, this.$arguments);
        if (m27859b == null) {
            return null;
        }
        ...
        return KotlinTypeFactory.simpleType(typeAttributes, m27857b, this.$arguments, this.$nullable, refiner);
    }
}