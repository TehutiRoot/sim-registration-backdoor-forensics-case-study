...
public final class ChuckerInterceptor implements Interceptor {
    ...
    public static final class Builder {
        ...
        /* renamed from: b */
        public ChuckerCollector f42778b;

        /* renamed from: c */
        public long f42779c;

        /* renamed from: d */
        public CacheDirectoryProvider f42780d;
        ...
        public Builder(@NotNull Context context) {
            ...
            this.f42779c = 250000L;
            this.f42782f = AH1.emptySet();
            this.f42783g = CollectionsKt__CollectionsKt.emptyList();
            this.f42784h = true;
            this.f42785i = new LinkedHashSet();
        }

        @NotNull
        public final Builder addBodyDecoder(@NotNull BodyDecoder decoder) {
            Intrinsics.checkNotNullParameter(decoder, "decoder");
            this.f42783g = CollectionsKt___CollectionsKt.plus((Collection<? extends BodyDecoder>) this.f42783g, decoder);
            return this;
        }
        ...
        public final Builder redactHeaders(@NotNull Iterable<String> headerNames) {
            ...
            this.f42782f = CollectionsKt___CollectionsKt.toSet(headerNames);
            return this;
        }
        ...
        public final Builder skipPaths(@NotNull String... skipPaths) {
            ...
            for (String str : skipPaths) {
                this.f42785i.add(new HttpUrl.Builder().scheme(UriUtil.HTTPS_SCHEME).host("example.com").addPathSegment(str).build().encodedPath());
            }
            return this;
        }
        ...
        public final Builder redactHeaders(@NotNull String... headerNames) {
            Intrinsics.checkNotNullParameter(headerNames, "headerNames");
            this.f42782f = ArraysKt___ArraysKt.toSet(headerNames);
            return this;
        }
    }
    ...
    /* renamed from: a */
    public static /* synthetic */ File m49971a(Builder builder) {
        return m49970b(builder);
    }

    /* renamed from: b */
    public static final File m49970b(Builder builder) {
    ...
    public Response intercept(@NotNull Interceptor.Chain chain) throws IOException {
        ...
        boolean z2 = !z;
        if (z2) {
            this.f42774d.process(request, httpTransaction);
        }
        try {
            Response proceed = chain.proceed(request);
            if (z2) {
                return this.f42775e.process(proceed, httpTransaction);
            }
            return proceed;
        } catch (IOException e) {
            httpTransaction.setError(e.toString());
            this.f42773c.onResponseReceived$com_github_ChuckerTeam_Chucker_library(httpTransaction);
            throw e;
        }
    }
    ...
    public final void redactHeader(@NotNull String... headerName) {
        ...
        AbstractC10396hs.addAll(this.f42771a, headerName);
    }
    ...
    public ChuckerInterceptor(final Builder builder) {
        ...
        this.f42771a = mutableSet;
        List plus = CollectionsKt___CollectionsKt.plus((Collection) builder.getDecoders$com_github_ChuckerTeam_Chucker_library(), (Iterable) f42770h);
        this.f42772b = plus;
        ...
        this.f42773c = chuckerCollector;
        this.f42774d = new RequestProcessor(builder.getContext$com_github_ChuckerTeam_Chucker_library(), chuckerCollector, builder.getMaxContentLength$com_github_ChuckerTeam_Chucker_library(), mutableSet, plus);
        ...
        this.f42775e = new ResponseProcessor(chuckerCollector, cacheDirectoryProvider$com_github_ChuckerTeam_Chucker_library == null ? new CacheDirectoryProvider() { // from class: xp
            @Override // com.chuckerteam.chucker.internal.support.CacheDirectoryProvider
            public final File provide() {
                return ChuckerInterceptor.m49971a(ChuckerInterceptor.Builder.this);
            }
        ...
        this.f42776f = CollectionsKt___CollectionsKt.toSet(builder.getSkipPaths$com_github_ChuckerTeam_Chucker_library());
