...
public final class MaskFormatter implements TextWatcher {
    ...
    /* renamed from: b */
    public final EditText f84866b;

    /* renamed from: c */
    public final Lazy f84867c;

    public MaskFormatter(@NotNull String format, @NotNull EditText editText) {
        Intrinsics.checkNotNullParameter(format, "format");
        Intrinsics.checkNotNullParameter(editText, "editText");
        this.f84865a = format;
        this.f84866b = editText;
        this.f84867c = LazyKt__LazyJVMKt.lazy(new MaskFormatter$formatter$2(this));
    }

    /* renamed from: a */
    public final TextFormatter m19640a() {
        return (TextFormatter) this.f84867c.getValue();
    }
    ...
    /* renamed from: b */
    public final String m19639b(String str, boolean z) {
        if (z) {
            str = m19640a().delete(str);
        }
        return m19640a().maskText(m19640a().removeMaskText(str));
    }
    ...
    public void onTextChanged(@Nullable CharSequence charSequence, int i, int i2, int i3) {
        ...
        int selectionStart = this.f84866b.getSelectionStart();
        if (!z2 && selectionStart == valueOf.length()) {
            selectionStart++;
        }
        String m19639b = m19639b(valueOf, z2);
        this.f84866b.removeTextChangedListener(this);
        this.f84866b.setText(m19639b);
        EditText editText = this.f84866b;
        if (selectionStart > m19639b.length() || z) {
            selectionStart = m19639b.length();
        }
        editText.setSelection(selectionStart);
        this.f84866b.addTextChangedListener(this);
    }
}