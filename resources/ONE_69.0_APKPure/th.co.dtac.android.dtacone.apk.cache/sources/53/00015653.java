...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.esim.ESimPostpaidViewModel$uploadImage$1 */
/* loaded from: classes9.dex */
public final class ESimPostpaidViewModel$uploadImage$1 extends Lambda implements Function1<IndexedValue<? extends String>, ObservableSource<? extends UploadImageResponse>> {
    final /* synthetic */ ESimPostpaidViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimPostpaidViewModel$uploadImage$1(ESimPostpaidViewModel eSimPostpaidViewModel) {
        super(1);
    ...
    public final ObservableSource<? extends UploadImageResponse> invoke2(@NotNull IndexedValue<String> indexedValue) {
        ...
        UploadImageRequest m2840Y;
        Intrinsics.checkNotNullParameter(indexedValue, "<name for destructuring parameter 0>");
        eSimRepository = this.this$0.f105735b;
        m2840Y = this.this$0.m2840Y(indexedValue.component1(), indexedValue.component2());
        return eSimRepository.uploadImage(m2840Y).toObservable();
    }
