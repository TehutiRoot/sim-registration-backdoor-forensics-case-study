...
public class TaggedWriter extends ProxyWriter {
    ...
    /* renamed from: a */
    public final Serializable f73656a;

    public TaggedWriter(Writer writer) {
        super(writer);
        this.f73656a = UUID.randomUUID();
    }

    @Override // org.apache.commons.p028io.output.ProxyWriter
    public void handleIOException(IOException iOException) throws IOException {
        throw new TaggedIOException(iOException, this.f73656a);
    }

    public boolean isCauseOf(Exception exc) {
        return TaggedIOException.isTaggedWith(exc, this.f73656a);
    }

    public void throwIfCauseOf(Exception exc) throws IOException {
        TaggedIOException.throwCauseIfTaggedWith(exc, this.f73656a);
    }
}