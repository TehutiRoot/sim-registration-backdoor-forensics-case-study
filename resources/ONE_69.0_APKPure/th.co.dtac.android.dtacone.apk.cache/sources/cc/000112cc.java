...
public final class PhoneNumberVisualTransformation implements VisualTransformation {
    ...
    /* renamed from: a */
    public final PhoneNumberVisualTransformation$phoneNumberOffsetMappingThai$1 f83000a = new OffsetMapping() { // from class: th.co.dtac.android.dtacone.app_one.widget.composable.helper.PhoneNumberVisualTransformation$phoneNumberOffsetMappingThai$1
    ...
    public TransformedText filter(@NotNull AnnotatedString text) {
        ...
        return new TransformedText(new AnnotatedString(str, null, null, 6, null), this.f83000a);
    }
}