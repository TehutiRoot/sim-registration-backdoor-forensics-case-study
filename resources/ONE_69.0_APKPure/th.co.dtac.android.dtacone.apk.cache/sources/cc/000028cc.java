...
@Metadata(m29143d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n¢\u0006\u0002\b\u0004"}, m29142d2 = {"<anonymous>", "", "it", "Landroidx/compose/ui/focus/FocusState;", "invoke"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
...
public final class CoreTextFieldKt$CoreTextField$focusModifier$1 extends Lambda implements Function1<FocusState, Unit> {
    ...
    public final void invoke2(@NotNull FocusState it) {
        ...
        if (textInputService != null) {
            CoreTextFieldKt.m61023d(textInputService, this.$state, this.$value, this.$imeOptions, this.$offsetMapping);
            if (it.isFocused() && (layoutResult = this.$state.getLayoutResult()) != null) {
                AbstractC1539Vc.m65885e(this.$coroutineScope, null, null, new CoreTextFieldKt$CoreTextField$focusModifier$1$1$1(this.$bringIntoViewRequester, this.$value, this.$state, layoutResult, this.$offsetMapping, null), 3, null);
            }
        }
        if (it.isFocused()) {
            return;
        }
        TextFieldSelectionManager.m70072deselect_kEHs6E$foundation_release$default(this.$manager, null, 1, null);
    }
}