...
public final class EnumDescriptor extends PluginGeneratedSerialDescriptor {
    ...
    /* renamed from: m */
    public final SerialKind f71227m;

    /* renamed from: n */
    public final Lazy f71228n;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public EnumDescriptor(@NotNull String name, int i) {
        super(name, null, i, 2, null);
        Intrinsics.checkNotNullParameter(name, "name");
        this.f71227m = SerialKind.ENUM.INSTANCE;
        this.f71228n = LazyKt__LazyJVMKt.lazy(new EnumDescriptor$elementDescriptors$2(i, name, this));
    }

    /* renamed from: d */
    public final SerialDescriptor[] m27004d() {
        return (SerialDescriptor[]) this.f71228n.getValue();
    }
