...
@Metadata(m29143d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\t\b\u0000\u0018\u00002\u00020\u0001:\u0007\u0003\u0004\u0005\u0006\u0007\b\tB\u0005¢\u0006\u0002\u0010\u0002¨\u0006\n"}, m29142d2 = {"Landroidx/compose/ui/platform/AccessibilityIterators;", "", "()V", "AbstractTextSegmentIterator", "CharacterTextSegmentIterator", "LineTextSegmentIterator", "PageTextSegmentIterator", "ParagraphTextSegmentIterator", "TextSegmentIterator", "WordTextSegmentIterator", "ui_release"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
/* renamed from: androidx.compose.ui.platform.AccessibilityIterators */
/* loaded from: classes2.dex */
public final class AccessibilityIterators {

    @StabilityInferred(parameters = 0)
    @Metadata(m29143d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u0015\n\u0002\b\n\b'\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\u0017\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u0004H\u0016¢\u0006\u0004\b\u0007\u0010\bJ!\u0010\r\u001a\u0004\u0018\u00010\f2\u0006\u0010\n\u001a\u00020\t2\u0006\u0010\u000b\u001a\u00020\tH\u0004¢\u0006\u0004\b\r\u0010\u000eR\"\u0010\u0005\u001a\u00020\u00048\u0004@\u0004X\u0084.¢\u0006\u0012\n\u0004\b\u0005\u0010\u000f\u001a\u0004\b\u0010\u0010\u0011\"\u0004\b\u0012\u0010\bR\u0014\u0010\u0015\u001a\u00020\f8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0013\u0010\u0014¨\u0006\u0016"}, m29142d2 = {"Landroidx/compose/ui/platform/AccessibilityIterators$AbstractTextSegmentIterator;", "Landroidx/compose/ui/platform/AccessibilityIterators$TextSegmentIterator;", "<init>", "()V", "", TextBundle.TEXT_ENTRY, "", "initialize", "(Ljava/lang/String;)V", "", "start", "end", "", "getRange", "(II)[I", "Ljava/lang/String;", "getText", "()Ljava/lang/String;", "setText", PDPageLabelRange.STYLE_LETTERS_LOWER, "[I", "segment", "ui_release"}, m29141k = 1, m29140mv = {1, 8, 0})
    ...
    public static abstract class AbstractTextSegmentIterator implements TextSegmentIterator {
        ...
        /* renamed from: a */
        public final int[] f30534a = new int[2];
        protected String text;

        @Nullable
        public final int[] getRange(int i, int i2) {
            if (i >= 0 && i2 >= 0 && i != i2) {
                int[] iArr = this.f30534a;
                iArr[0] = i;
                iArr[1] = i2;
                return iArr;
            }
    ...
    public static class CharacterTextSegmentIterator extends AbstractTextSegmentIterator {
        ...
        /* renamed from: c */
        public static CharacterTextSegmentIterator f30535c;

        /* renamed from: b */
        public BreakIterator f30536b;
        @NotNull
        public static final Companion Companion = new Companion(null);
        public static final int $stable = 8;

        @Metadata(m29143d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0006\u001a\u00020\u0007R\u0010\u0010\u0003\u001a\u0004\u0018\u00010\u0004X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\b"}, m29142d2 = {"Landroidx/compose/ui/platform/AccessibilityIterators$CharacterTextSegmentIterator$Companion;", "", "()V", "instance", "Landroidx/compose/ui/platform/AccessibilityIterators$CharacterTextSegmentIterator;", "getInstance", "locale", "Ljava/util/Locale;", "ui_release"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
        ...
        public static final class Companion {
            ...
            public final CharacterTextSegmentIterator getInstance(@NotNull Locale locale) {
                ...
                if (CharacterTextSegmentIterator.f30535c == null) {
                    CharacterTextSegmentIterator.f30535c = new CharacterTextSegmentIterator(locale, null);
                }
                CharacterTextSegmentIterator characterTextSegmentIterator = CharacterTextSegmentIterator.f30535c;
        ...
        public int[] following(int i) {
            ...
            do {
                BreakIterator breakIterator = this.f30536b;
                if (breakIterator == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("impl");
                    breakIterator = null;
                }
                if (!breakIterator.isBoundary(i)) {
                    BreakIterator breakIterator2 = this.f30536b;
                    ...
                    BreakIterator breakIterator3 = this.f30536b;
    ...
    public static final class LineTextSegmentIterator extends AbstractTextSegmentIterator {
        ...
        /* renamed from: c */
        public static LineTextSegmentIterator f30537c;

        /* renamed from: b */
        public TextLayoutResult f30540b;
        @NotNull
        public static final Companion Companion = new Companion(null);
        public static final int $stable = 8;

        /* renamed from: d */
        public static final ResolvedTextDirection f30538d = ResolvedTextDirection.Rtl;

        /* renamed from: e */
        public static final ResolvedTextDirection f30539e = ResolvedTextDirection.Ltr;

        @Metadata(m29143d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0006\u0010\b\u001a\u00020\u0007R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u0006\u001a\u0004\u0018\u00010\u0007X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\t"}, m29142d2 = {"Landroidx/compose/ui/platform/AccessibilityIterators$LineTextSegmentIterator$Companion;", "", "()V", "DirectionEnd", "Landroidx/compose/ui/text/style/ResolvedTextDirection;", "DirectionStart", "lineInstance", "Landroidx/compose/ui/platform/AccessibilityIterators$LineTextSegmentIterator;", "getInstance", "ui_release"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
        ...
        public static final class Companion {
            ...
            public final LineTextSegmentIterator getInstance() {
                if (LineTextSegmentIterator.f30537c == null) {
                    LineTextSegmentIterator.f30537c = new LineTextSegmentIterator(null);
                }
                LineTextSegmentIterator lineTextSegmentIterator = LineTextSegmentIterator.f30537c;
        ...
        /* renamed from: a */
        public final int m59328a(int i, ResolvedTextDirection resolvedTextDirection) {
            TextLayoutResult textLayoutResult = this.f30540b;
            ...
            TextLayoutResult textLayoutResult3 = this.f30540b;
            if (textLayoutResult3 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("layoutResult");
                textLayoutResult3 = null;
            }
            if (resolvedTextDirection != textLayoutResult3.getParagraphDirection(lineStart)) {
                TextLayoutResult textLayoutResult4 = this.f30540b;
            ...
            TextLayoutResult textLayoutResult5 = this.f30540b;
        ...
        public int[] following(int i) {
            ...
            if (i < 0) {
                ...
                TextLayoutResult textLayoutResult2 = this.f30540b;
                if (textLayoutResult2 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("layoutResult");
                    textLayoutResult2 = null;
                }
                int lineForOffset = textLayoutResult2.getLineForOffset(i);
                if (m59328a(lineForOffset, f30538d) == i) {
                    i2 = lineForOffset;
                } else {
                    i2 = lineForOffset + 1;
                }
            ...
            return getRange(m59328a(i2, f30538d), m59328a(i2, f30539e) + 1);
        }
        ...
        public int[] preceding(int i) {
            ...
            if (i > getText().length()) {
                ...
                int lineForOffset = textLayoutResult2.getLineForOffset(i);
                if (m59328a(lineForOffset, f30539e) + 1 == i) {
                    i2 = lineForOffset;
                } else {
                    i2 = lineForOffset - 1;
                }
    ...
    public static final class PageTextSegmentIterator extends AbstractTextSegmentIterator {
        ...
        /* renamed from: e */
        public static PageTextSegmentIterator f30541e;

        /* renamed from: b */
        public TextLayoutResult f30544b;

        /* renamed from: c */
        public SemanticsNode f30545c;
        ...
        /* renamed from: f */
        public static final ResolvedTextDirection f30542f = ResolvedTextDirection.Rtl;

        /* renamed from: g */
        public static final ResolvedTextDirection f30543g = ResolvedTextDirection.Ltr;

        @Metadata(m29143d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0006\u0010\b\u001a\u00020\u0007R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u0006\u001a\u0004\u0018\u00010\u0007X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\t"}, m29142d2 = {"Landroidx/compose/ui/platform/AccessibilityIterators$PageTextSegmentIterator$Companion;", "", "()V", "DirectionEnd", "Landroidx/compose/ui/text/style/ResolvedTextDirection;", "DirectionStart", "pageInstance", "Landroidx/compose/ui/platform/AccessibilityIterators$PageTextSegmentIterator;", "getInstance", "ui_release"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
        ...
        public static final class Companion {
            ...
            public final PageTextSegmentIterator getInstance() {
                if (PageTextSegmentIterator.f30541e == null) {
                    PageTextSegmentIterator.f30541e = new PageTextSegmentIterator(null);
                }
                PageTextSegmentIterator pageTextSegmentIterator = PageTextSegmentIterator.f30541e;
        ...
        /* renamed from: a */
        private final int m59327a(int i, ResolvedTextDirection resolvedTextDirection) {
            TextLayoutResult textLayoutResult = this.f30544b;
            TextLayoutResult textLayoutResult2 = null;
            if (textLayoutResult == null) {
                Intrinsics.throwUninitializedPropertyAccessException("layoutResult");
                textLayoutResult = null;
            ...
            int lineStart = textLayoutResult.getLineStart(i);
            TextLayoutResult textLayoutResult3 = this.f30544b;
            if (textLayoutResult3 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("layoutResult");
                textLayoutResult3 = null;
            }
            if (resolvedTextDirection != textLayoutResult3.getParagraphDirection(lineStart)) {
                TextLayoutResult textLayoutResult4 = this.f30544b;
                if (textLayoutResult4 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("layoutResult");
                } else {
                    textLayoutResult2 = textLayoutResult4;
            ...
            TextLayoutResult textLayoutResult5 = this.f30544b;
            if (textLayoutResult5 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("layoutResult");
                textLayoutResult5 = null;
            }
        ...
        public int[] following(int i) {
            ...
            try {
                SemanticsNode semanticsNode = this.f30545c;
                if (semanticsNode == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("node");
                    semanticsNode = null;
                }
                int roundToInt = AbstractC22237sr0.roundToInt(semanticsNode.getBoundsInRoot().getHeight());
                int coerceAtLeast = AbstractC11695c.coerceAtLeast(0, i);
                TextLayoutResult textLayoutResult2 = this.f30544b;
                if (textLayoutResult2 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("layoutResult");
                    textLayoutResult2 = null;
                }
                ...
                if (lineTop < textLayoutResult4.getLineTop(textLayoutResult5.getLineCount() - 1)) {
                    TextLayoutResult textLayoutResult6 = this.f30544b;
                    ...
                    TextLayoutResult textLayoutResult7 = this.f30544b;
                ...
                return getRange(coerceAtLeast, m59327a(lineCount - 1, f30543g) + 1);
        ...
        public int[] preceding(int i) {
            ...
            try {
                ...
                int roundToInt = AbstractC22237sr0.roundToInt(semanticsNode.getBoundsInRoot().getHeight());
                int coerceAtMost = AbstractC11695c.coerceAtMost(getText().length(), i);
                TextLayoutResult textLayoutResult2 = this.f30544b;
                if (textLayoutResult2 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("layoutResult");
                    textLayoutResult2 = null;
                ...
                return getRange(m59327a(i2, f30542f), coerceAtMost);
            } catch (IllegalStateException unused) {
                return null;
            }
        }
        ...
        public PageTextSegmentIterator() {
            this.f30546d = new Rect();
        }
    }

    @StabilityInferred(parameters = 0)
    @Metadata(m29143d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0015\n\u0002\b\u0004\n\u0002\u0010\u000b\n\u0002\b\u0005\b\u0007\u0018\u0000 \u000f2\u00020\u0001:\u0001\u000fB\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0019\u0010\u0007\u001a\u0004\u0018\u00010\u00062\u0006\u0010\u0005\u001a\u00020\u0004H\u0016¢\u0006\u0004\b\u0007\u0010\bJ\u0019\u0010\t\u001a\u0004\u0018\u00010\u00062\u0006\u0010\u0005\u001a\u00020\u0004H\u0016¢\u0006\u0004\b\t\u0010\bJ\u0017\u0010\f\u001a\u00020\u000b2\u0006\u0010\n\u001a\u00020\u0004H\u0002¢\u0006\u0004\b\f\u0010\rJ\u0017\u0010\u000e\u001a\u00020\u000b2\u0006\u0010\n\u001a\u00020\u0004H\u0002¢\u0006\u0004\b\u000e\u0010\r¨\u0006\u0010"}, m29142d2 = {"Landroidx/compose/ui/platform/AccessibilityIterators$ParagraphTextSegmentIterator;", "Landroidx/compose/ui/platform/AccessibilityIterators$AbstractTextSegmentIterator;", "<init>", "()V", "", "current", "", "following", "(I)[I", "preceding", FirebaseAnalytics.Param.INDEX, "", OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, "(I)Z", PDPageLabelRange.STYLE_LETTERS_LOWER, "Companion", "ui_release"}, m29141k = 1, m29140mv = {1, 8, 0})
    ...
    public static final class ParagraphTextSegmentIterator extends AbstractTextSegmentIterator {
        ...
        /* renamed from: b */
        public static ParagraphTextSegmentIterator f30547b;

        @Metadata(m29143d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0006\u0010\u0005\u001a\u00020\u0004R\u0010\u0010\u0003\u001a\u0004\u0018\u00010\u0004X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, m29142d2 = {"Landroidx/compose/ui/platform/AccessibilityIterators$ParagraphTextSegmentIterator$Companion;", "", "()V", "instance", "Landroidx/compose/ui/platform/AccessibilityIterators$ParagraphTextSegmentIterator;", "getInstance", "ui_release"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
        ...
        public static final class Companion {
            ...
            public final ParagraphTextSegmentIterator getInstance() {
                if (ParagraphTextSegmentIterator.f30547b == null) {
                    ParagraphTextSegmentIterator.f30547b = new ParagraphTextSegmentIterator(null);
                }
                ParagraphTextSegmentIterator paragraphTextSegmentIterator = ParagraphTextSegmentIterator.f30547b;
        ...
        /* renamed from: a */
        public final boolean m59326a(int i) {
        ...
        /* renamed from: b */
        public final boolean m59325b(int i) {
    ...
    @Metadata(m29143d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0015\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\bf\u0018\u00002\u00020\u0001J\u0012\u0010\u0002\u001a\u0004\u0018\u00010\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&J\u0012\u0010\u0006\u001a\u0004\u0018\u00010\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&ø\u0001\u0000\u0082\u0002\u0006\n\u0004\b!0\u0001¨\u0006\u0007À\u0006\u0001"}, m29142d2 = {"Landroidx/compose/ui/platform/AccessibilityIterators$TextSegmentIterator;", "", "following", "", "current", "", "preceding", "ui_release"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    public static final class WordTextSegmentIterator extends AbstractTextSegmentIterator {
        ...
        /* renamed from: c */
        public static WordTextSegmentIterator f30548c;

        /* renamed from: b */
        public BreakIterator f30549b;
        @NotNull
        public static final Companion Companion = new Companion(null);
        public static final int $stable = 8;

        @Metadata(m29143d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0006\u001a\u00020\u0007R\u0010\u0010\u0003\u001a\u0004\u0018\u00010\u0004X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\b"}, m29142d2 = {"Landroidx/compose/ui/platform/AccessibilityIterators$WordTextSegmentIterator$Companion;", "", "()V", "instance", "Landroidx/compose/ui/platform/AccessibilityIterators$WordTextSegmentIterator;", "getInstance", "locale", "Ljava/util/Locale;", "ui_release"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
        ...
        public static final class Companion {
            ...
            public final WordTextSegmentIterator getInstance(@NotNull Locale locale) {
                Intrinsics.checkNotNullParameter(locale, "locale");
                if (WordTextSegmentIterator.f30548c == null) {
                    WordTextSegmentIterator.f30548c = new WordTextSegmentIterator(locale, null);
                }
                WordTextSegmentIterator wordTextSegmentIterator = WordTextSegmentIterator.f30548c;
        ...
        /* renamed from: a */
        private final boolean m59324a(int i) {
            if (i > 0 && m59323b(i - 1) && (i == getText().length() || !m59323b(i))) {
                return true;
            }
            return false;
        }
        ...
        /* renamed from: c */
        private final boolean m59322c(int i) {
            if (m59323b(i) && (i == 0 || !m59323b(i - 1))) {
                return true;
            }
            return false;
        }
        ...
        /* renamed from: d */
        private final void m59321d(Locale locale) {
            BreakIterator wordInstance = BreakIterator.getWordInstance(locale);
            Intrinsics.checkNotNullExpressionValue(wordInstance, "getWordInstance(locale)");
            this.f30549b = wordInstance;
        }

        /* renamed from: b */
        public final boolean m59323b(int i) {
        ...
        public int[] following(int i) {
            ...
            while (!m59323b(i) && !m59322c(i)) {
                BreakIterator breakIterator = this.f30549b;
                if (breakIterator == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("impl");
                    breakIterator = null;
                }
            ...
            BreakIterator breakIterator2 = this.f30549b;
            if (breakIterator2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("impl");
                breakIterator2 = null;
            }
            int following = breakIterator2.following(i);
            if (following == -1 || !m59324a(following)) {
                return null;
            }
            return getRange(i, following);
        }
        ...
        public int[] preceding(int i) {
            ...
            while (i > 0 && !m59323b(i - 1) && !m59324a(i)) {
                BreakIterator breakIterator = this.f30549b;
                if (breakIterator == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("impl");
                    breakIterator = null;
            ...
            if (preceding == -1 || !m59322c(preceding)) {
                return null;
            }
            return getRange(preceding, i);
        }
