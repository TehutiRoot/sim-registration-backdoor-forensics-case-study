...
@Metadata(m29143d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0000\u0018\u0000 \u00122\u00020\u0001:\u0001\u000fB\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005J/\u0010\f\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\b2\u0006\u0010\n\u001a\u00020\b2\u0006\u0010\u000b\u001a\u00020\bH\u0016¢\u0006\u0004\b\f\u0010\rR\u0014\u0010\u0011\u001a\u00020\u000e8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u000f\u0010\u0010¨\u0006\u0013"}, m29142d2 = {"Landroidx/compose/ui/platform/AndroidAccessibilityManager;", "Landroidx/compose/ui/platform/AccessibilityManager;", "Landroid/content/Context;", CoreConstants.CONTEXT_SCOPE_VALUE, "<init>", "(Landroid/content/Context;)V", "", "originalTimeoutMillis", "", "containsIcons", "containsText", "containsControls", "calculateRecommendedTimeoutMillis", "(JZZZ)J", "Landroid/view/accessibility/AccessibilityManager;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroid/view/accessibility/AccessibilityManager;", "accessibilityManager", OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, "ui_release"}, m29141k = 1, m29140mv = {1, 8, 0})
...
public final class AndroidAccessibilityManager implements AccessibilityManager {
    ...
    /* renamed from: b */
    public static final C3513a f30550b = new C3513a(null);

    /* renamed from: a */
    public final AccessibilityManager f30551a;
    ...
    public AndroidAccessibilityManager(@NotNull Context context) {
        ...
        this.f30551a = (AccessibilityManager) systemService;
    }
    ...
    public long calculateRecommendedTimeoutMillis(long j, boolean z, boolean z2, boolean z3) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            int recommendedTimeoutMillis = Api29Impl.INSTANCE.getRecommendedTimeoutMillis(this.f30551a, (int) j, i);
            if (recommendedTimeoutMillis != Integer.MAX_VALUE) {
                return recommendedTimeoutMillis;
            }
        } else if (!z3 || !this.f30551a.isTouchExplorationEnabled()) {
            return j;
        }
