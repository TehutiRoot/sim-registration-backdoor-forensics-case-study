...
public enum zzs implements zzef {
    ...
    PROVIDER_NATURAL_EARTH(AbstractSocketAppender.DEFAULT_PORT),
    PROVIDER_REGIO(4561),
    ...
    private static final zzeg zzmP = new zzeg() { // from class: KJ2
    };
    ...
    public static zzs zzb(int i) {
        if (i != 0) {
            switch (i) {
                ...
                case AbstractSocketAppender.DEFAULT_PORT /* 4560 */:
