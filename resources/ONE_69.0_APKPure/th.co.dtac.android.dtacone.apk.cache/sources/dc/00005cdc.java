...
public final class ComposerImpl$insertMovableContentGuarded$1$1$2$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke2() {
        ...
        List list2 = composerImpl.f28321e;
        try {
            composerImpl.f28321e = list;
            SlotReader slotReader2 = composerImpl.f28296H;
            int[] iArr = composerImpl.f28330n;
            composerImpl.f28330n = null;
            composerImpl.f28296H = slotReader;
            composerImpl.m60270y(movableContentStateReference.getContent$runtime_release(), movableContentStateReference.getLocals$runtime_release(), movableContentStateReference.getParameter$runtime_release(), true);
            Unit unit = Unit.INSTANCE;
            composerImpl.f28296H = slotReader2;
            composerImpl.f28330n = iArr;
        } finally {
            composerImpl.f28321e = list2;
        }
    }
}