...
public class DataBufferSafeParcelable<T extends SafeParcelable> extends AbstractDataBuffer<T> {
    ...
    /* renamed from: b */
    public static final String[] f44986b = {"data"};

    /* renamed from: a */
    public final Parcelable.Creator f44987a;

    @KeepForSdk
    public DataBufferSafeParcelable(@NonNull DataHolder dataHolder, @NonNull Parcelable.Creator<T> creator) {
        super(dataHolder);
        this.f44987a = creator;
    }
    ...
    public static DataHolder.Builder buildDataHolder() {
        return DataHolder.builder(f44986b);
    }
    ...
    public T get(int i) {
        ...
        T t = (T) this.f44987a.createFromParcel(obtain);
        obtain.recycle();
        return t;
    }
}