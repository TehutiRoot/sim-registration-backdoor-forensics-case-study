...
public final class StackTraceRecoveryKt {
    ...
    /* renamed from: a */
    public static final Pair m27121a(Throwable th2) {
        Throwable cause = th2.getCause();
        if (cause != null && Intrinsics.areEqual(cause.getClass(), th2.getClass())) {
            StackTraceElement[] stackTrace = th2.getStackTrace();
            for (StackTraceElement stackTraceElement : stackTrace) {
                if (isArtificial(stackTraceElement)) {
                    return TuplesKt.m29136to(cause, stackTrace);
                }
            }
            return TuplesKt.m29136to(th2, new StackTraceElement[0]);
        }
        return TuplesKt.m29136to(th2, new StackTraceElement[0]);
    }

    /* renamed from: b */
    public static final Throwable m27120b(Throwable th2, Throwable th3, ArrayDeque arrayDeque) {
        arrayDeque.addFirst(f71055a);
        StackTraceElement[] stackTrace = th2.getStackTrace();
        int m27117e = m27117e(stackTrace, f71056b);
        int i = 0;
        if (m27117e == -1) {
            th3.setStackTrace((StackTraceElement[]) arrayDeque.toArray(new StackTraceElement[0]));
            return th3;
        }
        StackTraceElement[] stackTraceElementArr = new StackTraceElement[arrayDeque.size() + m27117e];
        for (int i2 = 0; i2 < m27117e; i2++) {
            stackTraceElementArr[i2] = stackTrace[i2];
        }
        Iterator it = arrayDeque.iterator();
        while (it.hasNext()) {
            int i3 = i + 1;
            stackTraceElementArr[i + m27117e] = (StackTraceElement) it.next();
            i = i3;
        }
    ...
    /* renamed from: c */
    public static final ArrayDeque m27119c(CoroutineStackFrame coroutineStackFrame) {
    ...
    /* renamed from: d */
    public static final boolean m27118d(StackTraceElement stackTraceElement, StackTraceElement stackTraceElement2) {
    ...
    /* renamed from: e */
    public static final int m27117e(StackTraceElement[] stackTraceElementArr, String str) {
    ...
    /* renamed from: f */
    public static final void m27116f(StackTraceElement[] stackTraceElementArr, ArrayDeque arrayDeque) {
        int length = stackTraceElementArr.length;
        int i = 0;
        while (true) {
            if (i < length) {
        ...
        while (true) {
            if (m27118d(stackTraceElementArr[length2], (StackTraceElement) arrayDeque.getLast())) {
    ...
    /* renamed from: g */
    public static final Throwable m27115g(Throwable th2, CoroutineStackFrame coroutineStackFrame) {
        Pair m27121a = m27121a(th2);
        Throwable th3 = (Throwable) m27121a.component1();
        StackTraceElement[] stackTraceElementArr = (StackTraceElement[]) m27121a.component2();
        Throwable tryCopyException = ExceptionsConstructorKt.tryCopyException(th3);
        if (tryCopyException == null) {
            return th2;
        }
        ArrayDeque m27119c = m27119c(coroutineStackFrame);
        if (m27119c.isEmpty()) {
            return th2;
        }
        if (th3 != th2) {
            m27116f(stackTraceElementArr, m27119c);
        }
        return m27120b(th3, tryCopyException, m27119c);
    }
    ...
    public static final boolean isArtificial(@NotNull StackTraceElement stackTraceElement) {
        return AbstractC19741eO1.startsWith$default(stackTraceElement.getClassName(), CoroutineDebuggingKt.getARTIFICIAL_FRAME_PACKAGE_NAME(), false, 2, null);
    }
