...
public class PercentLayoutHelper {
    ...
    /* renamed from: a */
    public final ViewGroup f36560a;
    ...
    public static class PercentLayoutInfo {
        ...
        /* renamed from: a */
        public final C4835a f36561a = new C4835a(0, 0);

        public void fillLayoutParams(ViewGroup.LayoutParams layoutParams, int i, int i2) {
            boolean z;
            C4835a c4835a = this.f36561a;
            int i3 = layoutParams.width;
            ((ViewGroup.MarginLayoutParams) c4835a).width = i3;
            int i4 = layoutParams.height;
            ((ViewGroup.MarginLayoutParams) c4835a).height = i4;
            boolean z2 = false;
            if ((c4835a.f36563b || i3 == 0) && this.widthPercent < 0.0f) {
                z = true;
            } else {
                z = false;
            }
            if ((c4835a.f36562a || i4 == 0) && this.heightPercent < 0.0f) {
                z2 = true;
            }
        ...
        public void restoreLayoutParams(ViewGroup.LayoutParams layoutParams) {
            C4835a c4835a = this.f36561a;
            if (!c4835a.f36563b) {
                layoutParams.width = ((ViewGroup.MarginLayoutParams) c4835a).width;
            }
            if (!c4835a.f36562a) {
                layoutParams.height = ((ViewGroup.MarginLayoutParams) c4835a).height;
            }
            c4835a.f36563b = false;
            c4835a.f36562a = false;
        }
        ...
        public void restoreMarginLayoutParams(ViewGroup.MarginLayoutParams marginLayoutParams) {
            ...
            C4835a c4835a = this.f36561a;
            marginLayoutParams.leftMargin = ((ViewGroup.MarginLayoutParams) c4835a).leftMargin;
            marginLayoutParams.topMargin = ((ViewGroup.MarginLayoutParams) c4835a).topMargin;
            marginLayoutParams.rightMargin = ((ViewGroup.MarginLayoutParams) c4835a).rightMargin;
            marginLayoutParams.bottomMargin = ((ViewGroup.MarginLayoutParams) c4835a).bottomMargin;
            MarginLayoutParamsCompat.setMarginStart(marginLayoutParams, MarginLayoutParamsCompat.getMarginStart(c4835a));
            MarginLayoutParamsCompat.setMarginEnd(marginLayoutParams, MarginLayoutParamsCompat.getMarginEnd(this.f36561a));
        }
        ...
        public void fillMarginLayoutParams(View view, ViewGroup.MarginLayoutParams marginLayoutParams, int i, int i2) {
            ...
            C4835a c4835a = this.f36561a;
            ((ViewGroup.MarginLayoutParams) c4835a).leftMargin = marginLayoutParams.leftMargin;
            ((ViewGroup.MarginLayoutParams) c4835a).topMargin = marginLayoutParams.topMargin;
            ((ViewGroup.MarginLayoutParams) c4835a).rightMargin = marginLayoutParams.rightMargin;
            ((ViewGroup.MarginLayoutParams) c4835a).bottomMargin = marginLayoutParams.bottomMargin;
            MarginLayoutParamsCompat.setMarginStart(c4835a, MarginLayoutParamsCompat.getMarginStart(marginLayoutParams));
            MarginLayoutParamsCompat.setMarginEnd(this.f36561a, MarginLayoutParamsCompat.getMarginEnd(marginLayoutParams));
    ...
    /* loaded from: classes2.dex */
    public static class C4835a extends ViewGroup.MarginLayoutParams {
    ...
    /* renamed from: a */
    public static boolean m53721a(View view, PercentLayoutInfo percentLayoutInfo) {
        if ((view.getMeasuredHeightAndState() & (-16777216)) == 16777216 && percentLayoutInfo.heightPercent >= 0.0f && ((ViewGroup.MarginLayoutParams) percentLayoutInfo.f36561a).height == -2) {
            return true;
        }
        return false;
    }
    ...
    /* renamed from: b */
    public static boolean m53720b(View view, PercentLayoutInfo percentLayoutInfo) {
        if ((view.getMeasuredWidthAndState() & (-16777216)) == 16777216 && percentLayoutInfo.widthPercent >= 0.0f && ((ViewGroup.MarginLayoutParams) percentLayoutInfo.f36561a).width == -2) {
            return true;
        }
        return false;
    }
    ...
    public void adjustChildren(int i, int i2) {
        PercentLayoutInfo percentLayoutInfo;
        int size = (View.MeasureSpec.getSize(i) - this.f36560a.getPaddingLeft()) - this.f36560a.getPaddingRight();
        int size2 = (View.MeasureSpec.getSize(i2) - this.f36560a.getPaddingTop()) - this.f36560a.getPaddingBottom();
        int childCount = this.f36560a.getChildCount();
        for (int i3 = 0; i3 < childCount; i3++) {
            View childAt = this.f36560a.getChildAt(i3);
    ...
    public boolean handleMeasuredStateTooSmall() {
        ...
        for (int i = 0; i < childCount; i++) {
            View childAt = this.f36560a.getChildAt(i);
            ViewGroup.LayoutParams layoutParams = childAt.getLayoutParams();
            if ((layoutParams instanceof PercentLayoutParams) && (percentLayoutInfo = ((PercentLayoutParams) layoutParams).getPercentLayoutInfo()) != null) {
                if (m53720b(childAt, percentLayoutInfo)) {
                    layoutParams.width = -2;
                    z = true;
                }
                if (m53721a(childAt, percentLayoutInfo)) {
    ...
    public void restoreOriginalParams() {
        ...
        int childCount = this.f36560a.getChildCount();
        for (int i = 0; i < childCount; i++) {
            ViewGroup.LayoutParams layoutParams = this.f36560a.getChildAt(i).getLayoutParams();
            if ((layoutParams instanceof PercentLayoutParams) && (percentLayoutInfo = ((PercentLayoutParams) layoutParams).getPercentLayoutInfo()) != null) {
                if (layoutParams instanceof ViewGroup.MarginLayoutParams) {
