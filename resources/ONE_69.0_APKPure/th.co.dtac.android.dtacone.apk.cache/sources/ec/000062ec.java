...
public final class AndroidComposeView$resendMotionEventOnLayout$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke2() {
        ...
        motionEvent = this.this$0.f30597j0;
        if (motionEvent != null) {
            int actionMasked = motionEvent.getActionMasked();
            if (actionMasked == 7 || actionMasked == 9) {
                this.this$0.f30599k0 = SystemClock.uptimeMillis();
                AndroidComposeView androidComposeView = this.this$0;
                androidComposeView$resendMotionEventRunnable$1 = androidComposeView.f30605n0;
