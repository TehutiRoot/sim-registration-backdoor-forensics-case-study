...
import org.bouncycastle.asn1.p034x9.DHDomainParameters;
...
public class JCEDHPublicKey implements DHPublicKey {
    ...
    /* renamed from: y */
    private BigInteger f75379y;

    public JCEDHPublicKey(BigInteger bigInteger, DHParameterSpec dHParameterSpec) {
        this.f75379y = bigInteger;
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        this.f75379y = (BigInteger) objectInputStream.readObject();
    ...
    public byte[] getEncoded() {
        ...
        return subjectPublicKeyInfo != null ? KeyUtil.getEncodedSubjectPublicKeyInfo(subjectPublicKeyInfo) : KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.dhKeyAgreement, new DHParameter(this.dhSpec.getP(), this.dhSpec.getG(), this.dhSpec.getL())), new ASN1Integer(this.f75379y));
    }
    ...
    public JCEDHPublicKey(DHPublicKey dHPublicKey) {
        this.f75379y = dHPublicKey.getY();
        this.dhSpec = dHPublicKey.getParams();
    }

    public JCEDHPublicKey(DHPublicKeySpec dHPublicKeySpec) {
        this.f75379y = dHPublicKeySpec.getY();
    ...
    public JCEDHPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            this.f75379y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
    ...
    public JCEDHPublicKey(DHPublicKeyParameters dHPublicKeyParameters) {
        this.f75379y = dHPublicKeyParameters.getY();
