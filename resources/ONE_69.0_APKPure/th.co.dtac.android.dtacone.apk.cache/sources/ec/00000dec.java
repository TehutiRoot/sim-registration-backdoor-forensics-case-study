...
public final class C1023Oi implements SessionConfig.OptionUnpacker {

    /* renamed from: a */
    public static final C1023Oi f4516a = new C1023Oi();
    ...
    public void unpack(Size size, UseCaseConfig useCaseConfig, SessionConfig.Builder builder) {
        ...
        builder.addCameraCaptureCallback(C0054Al.m69195a(camera2ImplConfig.getSessionCaptureCallback(Camera2CaptureCallbacks.createNoOpCallback())));
