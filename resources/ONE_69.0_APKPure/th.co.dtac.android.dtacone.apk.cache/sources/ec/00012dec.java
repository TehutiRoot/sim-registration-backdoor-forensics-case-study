...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.deviceSaleTrueCompany.viewModel.OneDeviceSaleTrueViewModel$getExtraAdvanceMaster$3 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleTrueViewModel$getExtraAdvanceMaster$3 extends Lambda implements Function1<OneExtraAdvanceMasterResponse, Unit> {
    final /* synthetic */ OneDeviceSaleTrueViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneDeviceSaleTrueViewModel$getExtraAdvanceMaster$3(OneDeviceSaleTrueViewModel oneDeviceSaleTrueViewModel) {
        super(1);
    ...
    public final void invoke2(OneExtraAdvanceMasterResponse oneExtraAdvanceMasterResponse) {
        MutableLiveData m14903A0;
        m14903A0 = this.this$0.m14903A0();
        m14903A0.setValue(Resource.Companion.success(oneExtraAdvanceMasterResponse));
    }
}