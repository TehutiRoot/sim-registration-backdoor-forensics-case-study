...
public class FirebasePerfUrlConnection {
    /* renamed from: a */
    public static Object m38208a(URLWrapper uRLWrapper, TransportManager transportManager, Timer timer) {
        timer.reset();
    ...
    /* renamed from: b */
    public static Object m38207b(URLWrapper uRLWrapper, Class[] clsArr, TransportManager transportManager, Timer timer) {
        timer.reset();
        long micros = timer.getMicros();
        NetworkRequestMetricBuilder builder = NetworkRequestMetricBuilder.builder(transportManager);
        try {
    ...
    /* renamed from: c */
    public static InputStream m38206c(URLWrapper uRLWrapper, TransportManager transportManager, Timer timer) {
    ...
    public static Object getContent(URL url) throws IOException {
        return m38208a(new URLWrapper(url), TransportManager.getInstance(), new Timer());
    }
    ...
    public static InputStream openStream(URL url) throws IOException {
        return m38206c(new URLWrapper(url), TransportManager.getInstance(), new Timer());
    }

    @Keep
    public static Object getContent(URL url, Class[] clsArr) throws IOException {
        return m38207b(new URLWrapper(url), clsArr, TransportManager.getInstance(), new Timer());
    }
}