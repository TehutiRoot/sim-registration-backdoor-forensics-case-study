...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.fragment.OneMnpIdNumberFormFragment$setUpViewModel$1$6 */
/* loaded from: classes10.dex */
public final class OneMnpIdNumberFormFragment$setUpViewModel$1$6 extends Lambda implements Function1<Resource<? extends OneChangeOwnerValidateProfileResponse>, Unit> {
    final /* synthetic */ OneMnpIdNumberFormFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.fragment.OneMnpIdNumberFormFragment$setUpViewModel$1$6$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneMnpIdNumberFormFragment$setUpViewModel$1$6(OneMnpIdNumberFormFragment oneMnpIdNumberFormFragment) {
        super(1);
    ...
    public final void invoke2(Resource<OneChangeOwnerValidateProfileResponse> resource) {
        ...
        if (i == 1) {
            ...
            if (Intrinsics.areEqual(viewModel.getServiceType(), Constant.MrtrMnpServiceType.Prepaid)) {
                ...
                oneMnpIdNumberFormFragment.m13922y();
            }
        }
    }
}