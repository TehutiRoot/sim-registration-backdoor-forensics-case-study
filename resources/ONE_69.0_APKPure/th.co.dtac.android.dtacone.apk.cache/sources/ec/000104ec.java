...
public class CachedDateTimeZone extends DateTimeZone {
    ...
    public static final class C13023a {
        ...
        /* renamed from: b */
        public final DateTimeZone f76424b;

        /* renamed from: c */
        public C13023a f76425c;

        /* renamed from: d */
        public String f76426d;

        /* renamed from: e */
        public int f76427e = Integer.MIN_VALUE;

        /* renamed from: f */
        public int f76428f = Integer.MIN_VALUE;

        public C13023a(DateTimeZone dateTimeZone, long j) {
            this.f76423a = j;
            this.f76424b = dateTimeZone;
        }

        /* renamed from: a */
        public String m24012a(long j) {
            C13023a c13023a = this.f76425c;
            if (c13023a != null && j >= c13023a.f76423a) {
                return c13023a.m24012a(j);
            }
            if (this.f76426d == null) {
                this.f76426d = this.f76424b.getNameKey(this.f76423a);
            }
            return this.f76426d;
        }

        /* renamed from: b */
        public int m24011b(long j) {
            C13023a c13023a = this.f76425c;
            if (c13023a != null && j >= c13023a.f76423a) {
                return c13023a.m24011b(j);
            }
            if (this.f76427e == Integer.MIN_VALUE) {
                this.f76427e = this.f76424b.getOffset(this.f76423a);
            }
            return this.f76427e;
        }

        /* renamed from: c */
        public int m24010c(long j) {
            C13023a c13023a = this.f76425c;
            if (c13023a != null && j >= c13023a.f76423a) {
                return c13023a.m24010c(j);
            }
            if (this.f76428f == Integer.MIN_VALUE) {
                this.f76428f = this.f76424b.getStandardOffset(this.f76423a);
            }
            return this.f76428f;
        }
    }
    ...
    private C13023a getInfo(long j) {
        ...
        if (c13023a == null || ((int) (c13023a.f76423a >> 32)) != i) {
    ...
    public String getNameKey(long j) {
        return getInfo(j).m24012a(j);
    }

    @Override // org.joda.time.DateTimeZone
    public int getOffset(long j) {
        return getInfo(j).m24011b(j);
    }

    @Override // org.joda.time.DateTimeZone
    public int getStandardOffset(long j) {
        return getInfo(j).m24010c(j);
    }
