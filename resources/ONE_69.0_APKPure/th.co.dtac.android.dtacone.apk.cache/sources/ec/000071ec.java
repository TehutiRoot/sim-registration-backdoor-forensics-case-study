...
@Metadata(m29143d1 = {"\u0000\b\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001H\n¢\u0006\u0002\b\u0002"}, m29142d2 = {"<anonymous>", "Landroidx/lifecycle/SavedStateHandle;", "invoke"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
...
public final class NavBackStackEntry$savedStateHandle$2 extends Lambda implements Function0<SavedStateHandle> {
    ...
    public final SavedStateHandle invoke() {
        boolean z;
        z = this.this$0.f36308j;
        if (z) {
            if (this.this$0.getLifecycle().getCurrentState() != Lifecycle.State.DESTROYED) {
                return ((NavBackStackEntry.C4787b) new ViewModelProvider(this.this$0, new NavBackStackEntry.C4786a(this.this$0)).get(NavBackStackEntry.C4787b.class)).m53860b();
            }
