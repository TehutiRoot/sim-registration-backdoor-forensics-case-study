...
public final class OutlinedTextFieldKt$OutlinedTextField$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: androidx.compose.material3.OutlinedTextFieldKt$OutlinedTextField$2$1 */
    /* loaded from: classes2.dex */
    public static final class C33271 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
        public static final C33271 INSTANCE = new C33271();
    ...
    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: androidx.compose.material3.OutlinedTextFieldKt$OutlinedTextField$2$2 */
    /* loaded from: classes2.dex */
    public static final class C33282 extends Lambda implements Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit> {
        final /* synthetic */ int $$dirty;
        final /* synthetic */ int $$dirty1;
        final /* synthetic */ int $$dirty2;
        final /* synthetic */ TextFieldColors $colors;
        ...
        @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
        /* renamed from: androidx.compose.material3.OutlinedTextFieldKt$OutlinedTextField$2$2$1 */
        /* loaded from: classes2.dex */
        public static final class C33291 extends Lambda implements Function2<Composer, Integer, Unit> {
            final /* synthetic */ int $$dirty;
            final /* synthetic */ int $$dirty1;
            final /* synthetic */ int $$dirty2;
            final /* synthetic */ TextFieldColors $colors;
            ...
            public C33291(boolean z, boolean z2, MutableInteractionSource mutableInteractionSource, TextFieldColors textFieldColors, Shape shape, int i, int i2, int i3) {
                super(2);
                this.$enabled = z;
                this.$isError = z2;
        ...
        public final void invoke(@NotNull Function2<? super Composer, ? super Integer, Unit> innerTextField, @Nullable Composer composer, int i) {
            ...
            TextFieldColors textFieldColors = this.$colors;
            ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer, 2108828640, true, new C33291(z, z3, mutableInteractionSource, textFieldColors, this.$shape, this.$$dirty, this.$$dirty1, this.$$dirty2));
            int i3 = this.$$dirty;
            int i4 = this.$$dirty1;
            int i5 = this.$$dirty2;
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        if (this.$label != null) {
            modifier = PaddingKt.m69717paddingqDBjuR0$default(SemanticsModifierKt.semantics(this.$modifier, true, C33271.INSTANCE), 0.0f, OutlinedTextFieldKt.getOutlinedTextFieldTopPadding(), 0.0f, 0.0f, 13, null);
        } else {
