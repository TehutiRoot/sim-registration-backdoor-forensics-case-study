...
public final class ComposeViewAdapter extends FrameLayout {
    ...
    /* renamed from: g */
    public final CompositionDataRecord f31679g;
    ...
    /* renamed from: j */
    public final ThreadSafeException f31682j;

    /* renamed from: k */
    public Function2 f31683k;

    /* renamed from: l */
    public final MutableState f31684l;
    ...
    /* renamed from: p */
    public Function0 f31688p;

    /* renamed from: q */
    public boolean f31689q;

    /* renamed from: r */
    public final Paint f31690r;

    /* renamed from: s */
    public final ComposeViewAdapter$FakeSavedStateRegistryOwner$1 f31691s;

    /* renamed from: t */
    public final ComposeViewAdapter$FakeViewModelStoreOwner$1 f31692t;

    /* renamed from: u */
    public final ComposeViewAdapter$FakeOnBackPressedDispatcherOwner$1 f31693u;

    /* renamed from: v */
    public final ComposeViewAdapter$FakeActivityResultRegistryOwner$1 f31694v;
    ...
    public ComposeViewAdapter(@NotNull Context context, @NotNull AttributeSet attrs) {
        ...
        this.f31673a = "ComposeViewAdapter";
        Context context2 = getContext();
        Intrinsics.checkNotNullExpressionValue(context2, "context");
        this.f31674b = new ComposeView(context2, null, 0, 6, null);
        this.f31677e = CollectionsKt__CollectionsKt.emptyList();
        this.f31678f = CollectionsKt__CollectionsKt.emptyList();
        this.f31679g = CompositionDataRecord.Companion.create();
        this.f31680h = "";
        this.f31682j = new ThreadSafeException();
        this.f31683k = ComposableSingletons$ComposeViewAdapterKt.INSTANCE.m73782getLambda2$ui_tooling_release();
        function2 = ComposeViewAdapterKt.f31702a;
        m65148g = AbstractC19036aL1.m65148g(function2, null, 2, null);
        this.f31684l = m65148g;
        this.f31687o = "";
        this.f31688p = ComposeViewAdapter$onDraw$1.INSTANCE;
        this.f31689q = true;
        Paint paint = new Paint();
        paint.setPathEffect(new DashPathEffect(new float[]{5.0f, 10.0f, 15.0f, 20.0f}, 0.0f));
        paint.setStyle(Paint.Style.STROKE);
        paint.setColor(ColorKt.m71972toArgb8_81llA(Color.Companion.m71953getRed0d7_KjU()));
        this.f31690r = paint;
        this.f31691s = new ComposeViewAdapter$FakeSavedStateRegistryOwner$1();
        this.f31692t = new ComposeViewAdapter$FakeViewModelStoreOwner$1();
        this.f31693u = new OnBackPressedDispatcherOwner() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$FakeOnBackPressedDispatcherOwner$1

            /* renamed from: a */
            public final OnBackPressedDispatcher f31696a = new OnBackPressedDispatcher(null, 1, null);
            ...
            public LifecycleRegistry getLifecycle() {
                ...
                composeViewAdapter$FakeSavedStateRegistryOwner$1 = ComposeViewAdapter.this.f31691s;
                return composeViewAdapter$FakeSavedStateRegistryOwner$1.getLifecycleRegistry();
            }
        };
        this.f31694v = new ActivityResultRegistryOwner() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$FakeActivityResultRegistryOwner$1

            /* renamed from: a */
            public final C3609x466dc6c4 f31695a = new ActivityResultRegistry() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$FakeActivityResultRegistryOwner$1$activityResultRegistry$1
            ...
            @NotNull
            public C3609x466dc6c4 getActivityResultRegistry() {
                return this.f31695a;
            }
        };
        m58899j(attrs);
    ...
    /* renamed from: a */
    public final void m58908a(Function2 function2, Composer composer, int i) {
        ...
        Context context2 = getContext();
        Intrinsics.checkNotNullExpressionValue(context2, "context");
        CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{provides, localFontFamilyResolver.provides(FontFamilyResolver_androidKt.createFontFamilyResolver(context2)), LocalOnBackPressedDispatcherOwner.INSTANCE.provides(this.f31693u), LocalActivityResultRegistryOwner.INSTANCE.provides(this.f31694v)}, ComposableLambdaKt.composableLambda(startRestartGroup, -1966112531, true, new ComposeViewAdapter$WrapPreview$1(this, function2, i)), startRestartGroup, 56);
        if (ComposerKt.isTraceInProgress()) {
    ...
    /* renamed from: b */
    public final void m58907b() {
        Set<CompositionData> store = this.f31679g.getStore();
        ArrayList arrayList = new ArrayList(AbstractC10172es.collectionSizeOrDefault(store, 10));
        ...
        this.f31681i = animationSearch.getHasAnimations();
        if (this.clock != null) {
    ...
    /* renamed from: c */
    public final void m58906c() {
        Set<CompositionData> store = this.f31679g.getStore();
        ArrayList<Group> arrayList = new ArrayList(AbstractC10172es.collectionSizeOrDefault(store, 10));
        for (CompositionData compositionData : store) {
            arrayList.add(SlotTreeKt.asTree(compositionData));
        }
        ...
        for (Group group : arrayList) {
            ...
            for (Group group2 : PreviewUtilsKt.findAll(group, new ComposeViewAdapter$findDesignInfoProviders$1$1(this))) {
                String m58904e = m58904e(group2, group2.getBox());
                if (m58904e == null) {
                    Iterator<T> it = group2.getChildren().iterator();
                    while (true) {
                        if (it.hasNext()) {
                            String m58904e2 = m58904e((Group) it.next(), group2.getBox());
                            if (m58904e2 != null) {
                                m58904e = m58904e2;
                                break;
                            }
                ...
                if (m58904e != null) {
                    arrayList3.add(m58904e);
                }
            }
            AbstractC10396hs.addAll(arrayList2, arrayList3);
        }
        this.f31678f = arrayList2;
    }

    /* renamed from: d */
    public final Method m58905d(Object obj) {
        try {
    ...
    public void dispatchDraw(@NotNull Canvas canvas) {
        ...
        for (ViewInfo viewInfo : this.f31677e) {
            AbstractC10396hs.addAll(arrayList, CollectionsKt___CollectionsKt.plus((Collection) AbstractC10100ds.listOf(viewInfo), (Iterable) viewInfo.allChildren()));
        }
        for (ViewInfo viewInfo2 : arrayList) {
            if (viewInfo2.hasBounds()) {
                canvas.drawRect(new Rect(viewInfo2.getBounds().getLeft(), viewInfo2.getBounds().getTop(), viewInfo2.getBounds().getRight(), viewInfo2.getBounds().getBottom()), this.f31690r);
            }
        }
    }

    public final void dispose$ui_tooling_release() {
        this.f31674b.disposeComposition();
        if (this.clock != null) {
            getClock$ui_tooling_release().dispose();
        }
        this.f31691s.getLifecycleRegistry().setCurrentState(Lifecycle.State.DESTROYED);
        this.f31692t.getViewModelStore().clear();
    }

    /* renamed from: e */
    public final String m58904e(Group group, IntRect intRect) {
        String str;
        ...
        do {
            ...
            Object next = it.next();
            if (next != null) {
                str = m58897l(next, intRect.getLeft(), intRect.getRight());
                continue;
            }
        } while (str == null);
        return str;
    ...
    /* renamed from: f */
    public final String m58903f(Group group) {
        String sourceFile;
    ...
    /* renamed from: g */
    public final int m58902g(Group group) {
        SourceLocation location = group.getLocation();
        if (location != null) {
    ...
    /* renamed from: h */
    public final boolean m58901h(Group group) {
        Method method;
    ...
    /* renamed from: i */
    public final boolean m58900i(Group group) {
        if (m58903f(group).length() == 0 && m58902g(group) == -1) {
            return true;
        }
        return false;
    }
    ...
    public final void init$ui_tooling_release(@NotNull String className, @NotNull String methodName, @Nullable Class<? extends PreviewParameterProvider<?>> cls, int i, boolean z, boolean z2, long j, boolean z3, boolean z4, @Nullable String str, @NotNull Function0<Unit> onCommit, @NotNull Function0<Unit> onDraw) {
        ...
        this.f31683k = composableLambdaInstance;
        this.f31674b.setContent(composableLambdaInstance);
        invalidate();
    }

    /* renamed from: j */
    public final void m58899j(AttributeSet attributeSet) {
        long j;
        ViewTreeLifecycleOwner.set(this, this.f31691s);
        ViewTreeSavedStateRegistryOwner.set(this, this.f31691s);
        ViewTreeViewModelStoreOwner.set(this, this.f31692t);
        addView(this.f31674b);
        ...
        long j2 = j;
        init$ui_tooling_release$default(this, substringBeforeLast$default, substringAfterLast$default, cls2, attributeIntValue, attributeSet.getAttributeBooleanValue("http://schemas.android.com/tools", "paintBounds", this.f31676d), attributeSet.getAttributeBooleanValue("http://schemas.android.com/tools", "printViewInfos", this.f31675c), j2, attributeSet.getAttributeBooleanValue("http://schemas.android.com/tools", "forceCompositionInvalidation", false), attributeSet.getAttributeBooleanValue("http://schemas.android.com/tools", "findDesignInfoProviders", this.f31686n), attributeSet.getAttributeValue("http://schemas.android.com/tools", "designInfoProvidersArgument"), null, null, 3072, null);
    }

    /* renamed from: k */
    public final void m58898k() {
        this.f31684l.setValue(ComposableSingletons$ComposeViewAdapterKt.INSTANCE.m73783getLambda3$ui_tooling_release());
        this.f31684l.setValue(this.f31683k);
        invalidate();
    }

    /* renamed from: l */
    public final String m58897l(Object obj, int i, int i2) {
        Method m58905d = m58905d(obj);
        if (m58905d == null) {
            return null;
        }
        try {
            Object invoke = m58905d.invoke(obj, Integer.valueOf(i), Integer.valueOf(i2), this.f31687o);
    ...
    /* renamed from: m */
    public final boolean m58896m(Group group) {
        NodeGroup nodeGroup;
        Object obj;
        if (m58900i(group) && group.getChildren().isEmpty()) {
    ...
    /* renamed from: n */
    public final void m58895n() {
        Set<CompositionData> store = this.f31679g.getStore();
        ArrayList arrayList = new ArrayList(AbstractC10172es.collectionSizeOrDefault(store, 10));
        for (CompositionData compositionData : store) {
            arrayList.add(m58894o(SlotTreeKt.asTree(compositionData)));
        }
    ...
    /* renamed from: o */
    public final ViewInfo m58894o(Group group) {
        NodeGroup nodeGroup;
        Object obj;
        int i;
        LayoutInfo layoutInfo = null;
        ...
        if (group.getChildren().size() == 1 && m58900i(group) && layoutInfo2 == null) {
            return m58894o((Group) CollectionsKt___CollectionsKt.single(group.getChildren()));
        }
        ArrayList<Group> arrayList = new ArrayList();
        for (Object obj2 : group.getChildren()) {
            if (!m58896m((Group) obj2)) {
                arrayList.add(obj2);
            }
        }
        ArrayList arrayList2 = new ArrayList(AbstractC10172es.collectionSizeOrDefault(arrayList, 10));
        for (Group group2 : arrayList) {
            arrayList2.add(m58894o(group2));
        }
        SourceLocation location = group.getLocation();
    ...
    public void onAttachedToWindow() {
        View rootView = this.f31674b.getRootView();
        Intrinsics.checkNotNullExpressionValue(rootView, "composeView.rootView");
        ViewTreeLifecycleOwner.set(rootView, this.f31691s);
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        this.f31682j.throwIfPresent();
        m58895n();
        if (this.f31680h.length() > 0) {
            m58907b();
            if (this.f31686n) {
                m58906c();
            }
