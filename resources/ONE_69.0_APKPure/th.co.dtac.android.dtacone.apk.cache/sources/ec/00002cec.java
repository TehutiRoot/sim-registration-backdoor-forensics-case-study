...
@Metadata(m29143d1 = {"\u0000\u0016\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u0007\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00052\u0006\u0010\u0007\u001a\u00020\u0003H\u000b¢\u0006\u0004\b\b\u0010\t"}, m29142d2 = {"<anonymous>", "", "labelProgress", "", "labelTextStyleColor", "Landroidx/compose/ui/graphics/Color;", "labelContentColor", "placeholderAlphaProgress", "invoke-RIQooxk", "(FJJFLandroidx/compose/runtime/Composer;I)V"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
...
public final class TextFieldImplKt$CommonDecorationBox$3 extends Lambda implements Function6<Float, Color, Color, Float, Composer, Integer, Unit> {
    ...
    public /* bridge */ /* synthetic */ Unit invoke(Float f, Color color, Color color2, Float f2, Composer composer, Integer num) {
        m70334invokeRIQooxk(f.floatValue(), color.m71929unboximpl(), color2.m71929unboximpl(), f2.floatValue(), composer, num.intValue());
    ...
    public final void m70334invokeRIQooxk(float f, long j, long j2, float f2, @Nullable Composer composer, int i) {
        int i2;
        ?? r14;
        ...
        String m70286getString4foXLRw = Strings_androidKt.m70286getString4foXLRw(Strings.Companion.m70281getDefaultErrorMessageUdPEhr4(), composer, 6);
        Modifier.Companion companion = Modifier.Companion;
        Object valueOf = Boolean.valueOf(this.$isError);
        boolean z = this.$isError;
        composer.startReplaceableGroup(511388516);
        boolean changed = composer.changed(valueOf) | composer.changed(m70286getString4foXLRw);
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new TextFieldImplKt$CommonDecorationBox$3$decorationBoxModifier$1$1(z, m70286getString4foXLRw);
        ...
        if (this.$colors instanceof TextFieldColorsWithIcons) {
            ...
            int i8 = this.$$dirty1;
            m71929unboximpl = ((TextFieldColorsWithIcons) this.$colors).leadingIconColor(z2, z3, interactionSource, composer, ((i8 << 3) & 896) | ((this.$$dirty >> 27) & 14) | ((i8 << 3) & 112)).getValue().m71929unboximpl();
            composer.endReplaceableGroup();
        } else {
            ...
            int i9 = this.$$dirty1;
            m71929unboximpl = textFieldColors.leadingIconColor(z4, z5, composer, ((this.$$dirty >> 27) & 14) | ((i9 << 3) & 112) | ((i9 >> 3) & 896)).getValue().m71929unboximpl();
            composer.endReplaceableGroup();
        }
        Function2<Composer, Integer, Unit> function22 = this.$leadingIcon;
        if (function22 != null) {
            composableLambda3 = ComposableLambdaKt.composableLambda(composer, 1505327088, r14, new TextFieldImplKt$CommonDecorationBox$3$decoratedLeading$1$1(m71929unboximpl, function22));
        } else {
        ...
        if (this.$colors instanceof TextFieldColorsWithIcons) {
            ...
            int i10 = this.$$dirty1;
            m71929unboximpl2 = ((TextFieldColorsWithIcons) this.$colors).trailingIconColor(z6, z7, interactionSource2, composer, ((i10 << 3) & 896) | ((this.$$dirty >> 27) & 14) | ((i10 << 3) & 112)).getValue().m71929unboximpl();
            composer.endReplaceableGroup();
        } else {
            ...
            int i11 = this.$$dirty1;
            m71929unboximpl2 = textFieldColors2.trailingIconColor(z8, z9, composer, ((this.$$dirty >> 27) & 14) | ((i11 << 3) & 112) | ((i11 >> 3) & 896)).getValue().m71929unboximpl();
            composer.endReplaceableGroup();
        }
        Function2<Composer, Integer, Unit> function23 = this.$trailingIcon;
        if (function23 != null) {
            composableLambda4 = ComposableLambdaKt.composableLambda(composer, -1894727196, r14, new TextFieldImplKt$CommonDecorationBox$3$decoratedTrailing$1$1(m71929unboximpl2, function23));
        } else {
