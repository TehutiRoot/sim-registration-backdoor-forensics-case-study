...
public class setCameraDistance implements setDarkTextColor.valueOf {
    private final setDarkTextColor valueOf;

    public setCameraDistance(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.SDKNotInitializedException(this.valueOf);
    }
}