...
public final class ExposedDropdownMenuKt$ExposedDropdownMenuBox$3 extends Lambda implements Function1<DisposableEffectScope, DisposableEffectResult> {
    ...
    public final DisposableEffectResult invoke(@NotNull DisposableEffectScope DisposableEffect) {
        ...
        View view = this.$view;
        final View$OnAttachStateChangeListenerC22843wK0 view$OnAttachStateChangeListenerC22843wK0 = new View$OnAttachStateChangeListenerC22843wK0(view, new ExposedDropdownMenuKt$ExposedDropdownMenuBox$3$listener$1(view, this.$coordinates, this.$verticalMarginInPx, this.$menuHeight$delegate));
        return new DisposableEffectResult() { // from class: androidx.compose.material3.ExposedDropdownMenuKt$ExposedDropdownMenuBox$3$invoke$$inlined$onDispose$1
            ...
            public void dispose() {
                View$OnAttachStateChangeListenerC22843wK0.this.m758a();
            }
        };
    }
}