...
public abstract class CloudMessagingReceiver extends BroadcastReceiver {
    ...
    /* renamed from: a */
    public static SoftReference f44612a;

    /* renamed from: b */
    public static SoftReference f44613b;
    ...
    /* renamed from: a */
    public final /* synthetic */ void m48678a(Intent intent, final Context context, boolean z, BroadcastReceiver.PendingResult pendingResult) {
        Intent intent2;
        int i;
        try {
            ...
            if (intent2 != null) {
                ...
                synchronized (CloudMessagingReceiver.class) {
                    SoftReference softReference = f44613b;
                    ...
                    if (executor == null) {
                        ...
                        f44613b = new SoftReference(executor);
                    }
                }
                executor.execute(new Runnable() { // from class: com.google.android.gms.cloudmessaging.zzg
                    ...
                    public final void run() {
                        ...
                        if (TextUtils.isEmpty(cloudMessage2.getMessageId())) {
                            ...
                            Integer m48680b = cloudMessage2.m48680b();
                            if (m48680b != null) {
                                bundle.putInt(Constants.MessagePayloadKeys.PRODUCT_ID, m48680b.intValue());
                            }
    ...
    /* renamed from: b */
    public final int m48677b(Context context, Intent intent) {
    ...
    public Executor getBroadcastExecutor() {
        ...
        synchronized (CloudMessagingReceiver.class) {
            try {
                SoftReference softReference = f44612a;
                if (softReference != null) {
                ...
                if (executorService == null) {
                    ...
                    f44612a = new SoftReference(executorService);
                }
            } catch (Throwable th2) {
                throw th2;
            }
    ...
    public final void onReceive(@NonNull final Context context, @NonNull final Intent intent) {
        ...
        getBroadcastExecutor().execute(new Runnable() { // from class: com.google.android.gms.cloudmessaging.zzh
            @Override // java.lang.Runnable
            public final void run() {
                CloudMessagingReceiver.this.m48678a(intent, context, isOrderedBroadcast, goAsync);
            }
        });
    }
}