...
public final class C11951x48b4056b extends Lambda implements Function1<Name, TypeAliasDescriptor> {
    final /* synthetic */ DeserializedMemberScope.OptimizedImplementation this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C11951x48b4056b(DeserializedMemberScope.OptimizedImplementation optimizedImplementation) {
        super(1);
    ...
    public final TypeAliasDescriptor invoke(@NotNull Name it) {
        TypeAliasDescriptor m27929k;
        Intrinsics.checkNotNullParameter(it, "it");
        m27929k = this.this$0.m27929k(it);
        return m27929k;
    }
}