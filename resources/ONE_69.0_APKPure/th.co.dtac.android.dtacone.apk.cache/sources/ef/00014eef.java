...
/* renamed from: th.co.dtac.android.dtacone.view.fragment.mrtr_mnp.MrtrMnpScanSimFragment$setupViewModel$1$3 */
/* loaded from: classes9.dex */
public final class MrtrMnpScanSimFragment$setupViewModel$1$3 extends Lambda implements Function1<Resource<? extends String>, Unit> {
    final /* synthetic */ MrtrMnpScanSimFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrMnpScanSimFragment$setupViewModel$1$3(MrtrMnpScanSimFragment mrtrMnpScanSimFragment) {
        super(1);
    ...
    public final void invoke2(Resource<String> resource) {
        ...
        mrtrMnpScanSimFragment.onError(data);
    }
}