...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.viewmodel.OnePostpaidRegistrationViewModel$callAPICheckExternalBlacklistFlag$3 */
/* loaded from: classes10.dex */
public final class C14999x7f7266f6 extends Lambda implements Function1<OneCheckExternalBlacklistFlagResponse, Unit> {
    final /* synthetic */ OnePostpaidRegistrationViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C14999x7f7266f6(OnePostpaidRegistrationViewModel onePostpaidRegistrationViewModel) {
        super(1);
    ...
    public final void invoke2(OneCheckExternalBlacklistFlagResponse oneCheckExternalBlacklistFlagResponse) {
        ...
        onePostpaidRepository.setBlacklistFlag((data == null || (r1 = data.getBlacklistFlag()) == null) ? "" : "");
        CheckExternalBlacklistFlagResponse data2 = oneCheckExternalBlacklistFlagResponse.getData();
        if (Intrinsics.areEqual(data2 != null ? data2.getBlacklistFlag() : null, "Y")) {
            this.this$0.m11704J0();
        } else {
            this.this$0.navigateNextForExtranalBlacklist();
        }
    }
}