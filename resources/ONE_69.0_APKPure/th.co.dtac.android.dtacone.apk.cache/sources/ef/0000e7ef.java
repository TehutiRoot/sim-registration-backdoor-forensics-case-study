...
public abstract class MapLikeSerializer<Key, Value, Collection, Builder extends Map<Key, Value>> extends AbstractCollectionSerializer<Map.Entry<? extends Key, ? extends Value>, Collection, Builder> {
    ...
    /* renamed from: a */
    public final KSerializer f71258a;

    /* renamed from: b */
    public final KSerializer f71259b;
    ...
    public MapLikeSerializer(KSerializer kSerializer, KSerializer kSerializer2) {
        super(null);
        this.f71258a = kSerializer;
        this.f71259b = kSerializer2;
    }
    ...
    public final void readAll(@NotNull CompositeDecoder decoder, @NotNull Builder builder, int i, int i2) {
        ...
        if (i2 >= 0) {
            IntProgression step = AbstractC11695c.step(AbstractC11695c.until(0, i2 * 2), 2);
    ...
    public final void readElement(@NotNull CompositeDecoder decoder, int i, @NotNull Builder builder, boolean z) {
        ...
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        Intrinsics.checkNotNullParameter(builder, "builder");
        Object decodeSerializableElement$default2 = CompositeDecoder.DefaultImpls.decodeSerializableElement$default(decoder, getDescriptor(), i, this.f71258a, null, 8, null);
        if (z) {
        ...
        int i3 = i2;
        if (builder.containsKey(decodeSerializableElement$default2) && !(this.f71259b.getDescriptor().getKind() instanceof PrimitiveKind)) {
            decodeSerializableElement$default = decoder.decodeSerializableElement(getDescriptor(), i3, this.f71259b, AbstractC11663a.getValue(builder, decodeSerializableElement$default2));
        } else {
            decodeSerializableElement$default = CompositeDecoder.DefaultImpls.decodeSerializableElement$default(decoder, getDescriptor(), i3, this.f71259b, null, 8, null);
        }
