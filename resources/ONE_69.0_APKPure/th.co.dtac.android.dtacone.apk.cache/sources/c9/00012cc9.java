...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.deviceSaleTrueCompany.fragment.OneDeviceSaleTrueBlackListFragment$setupObserve$1$3 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleTrueBlackListFragment$setupObserve$1$3 extends Lambda implements Function1<Resource<? extends String>, Unit> {
    ...
    public OneDeviceSaleTrueBlackListFragment$setupObserve$1$3(OneDeviceSaleTrueBlackListFragment oneDeviceSaleTrueBlackListFragment, OneDeviceSaleTrueViewModel oneDeviceSaleTrueViewModel) {
        super(1);
    ...
    public final void invoke2(Resource<String> resource) {
        ...
        if (resourceContentIfNotHandled.getStatus() == StatusResource.SUCCESS) {
            ...
            m15065n.showDialogConfirmTakeReferenceDoc(new OneDeviceSaleTrueBlackListFragment$setupObserve$1$3$1$1(oneDeviceSaleTrueBlackListFragment), new OneDeviceSaleTrueBlackListFragment$setupObserve$1$3$1$2(oneDeviceSaleTrueViewModel));
        }
    }
}