...
public abstract class BucketBoundaries {
    ...
    /* renamed from: a */
    public static final Logger f63641a = Logger.getLogger(BucketBoundaries.class.getName());

    /* renamed from: a */
    public static List m30542a(List list) {
    ...
    public static final BucketBoundaries create(List<Double> list) {
        ...
        return new C11611k8(Collections.unmodifiableList(m30542a(arrayList)));
    }
