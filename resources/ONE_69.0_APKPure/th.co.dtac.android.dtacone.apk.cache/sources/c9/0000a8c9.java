...
import com.google.common.collect.AbstractC7940b;
import com.google.common.collect.AbstractC7972m;
...
public final class ConcurrentHashMultiset<E> extends AbstractC7940b implements Serializable {
    private static final long serialVersionUID = 1;
    private final transient ConcurrentMap<E, AtomicInteger> countMap;

    /* renamed from: com.google.common.collect.ConcurrentHashMultiset$b */
    /* loaded from: classes4.dex */
    public class C7582b extends AbstractIterator {

        /* renamed from: c */
        public final Iterator f53099c;

        public C7582b() {
            this.f53099c = ConcurrentHashMultiset.this.countMap.entrySet().iterator();
        }

        @Override // com.google.common.collect.AbstractIterator
        /* renamed from: b */
        public Multiset.Entry computeNext() {
            while (this.f53099c.hasNext()) {
                Map.Entry entry = (Map.Entry) this.f53099c.next();
    ...
    /* loaded from: classes4.dex */
    public class C7583c extends ForwardingIterator {

        /* renamed from: a */
        public Multiset.Entry f53101a;

        /* renamed from: b */
        public final /* synthetic */ Iterator f53102b;

        /* renamed from: c */
        public final /* synthetic */ ConcurrentHashMultiset f53103c;

        public C7583c(ConcurrentHashMultiset concurrentHashMultiset, Iterator it) {
            this.f53102b = it;
            this.f53103c = concurrentHashMultiset;
        }
        ...
        public void remove() {
            ...
            this.f53103c.setCount(this.f53101a.getElement(), 0);
            this.f53101a = null;
        }
    ...
    /* loaded from: classes4.dex */
    public class C7584d extends AbstractC7940b.C7942b {
        public C7584d() {
            super();
        }

        @Override // com.google.common.collect.AbstractC7940b.C7942b, com.google.common.collect.Multisets.AbstractC7812i
        /* renamed from: b */
        public ConcurrentHashMultiset mo40257a() {
            return ConcurrentHashMultiset.this;
        }

        /* renamed from: c */
        public final List m41023c() {
        ...
        public Object[] toArray() {
            return m41023c().toArray();
        }

        public /* synthetic */ C7584d(ConcurrentHashMultiset concurrentHashMultiset, C7581a c7581a) {
            this();
        }

        @Override // java.util.AbstractCollection, java.util.Collection, java.util.Set
        public Object[] toArray(Object[] objArr) {
            return m41023c().toArray(objArr);
        }
    }

    /* renamed from: com.google.common.collect.ConcurrentHashMultiset$e */
    /* loaded from: classes4.dex */
    public static class C7585e {

        /* renamed from: a */
        public static final AbstractC7972m.C7974b f53105a = AbstractC7972m.m40212a(ConcurrentHashMultiset.class, "countMap");
    }
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        C7585e.f53105a.m40200b(this, (ConcurrentMap) readObject);
    }
    ...
    */
    public int add(E r5, int r6) {
        ...
        La:
            ...
            p000.AbstractC5383bs.m51875d(r6, r0)
        Lf:
            java.util.concurrent.ConcurrentMap<E, java.util.concurrent.atomic.AtomicInteger> r0 = r4.countMap
            java.lang.Object r0 = com.google.common.collect.Maps.m40710G(r0, r5)
    ...
    public int count(@CheckForNull Object obj) {
        AtomicInteger atomicInteger = (AtomicInteger) Maps.m40710G(this.countMap, obj);
    ...
    public Set<E> createElementSet() {
        return new C7581a(this, this.countMap.keySet());
    }

    @Override // com.google.common.collect.AbstractC7940b
    @Deprecated
    public Set<Multiset.Entry<E>> createEntrySet() {
        return new C7584d(this, null);
    }
    ...
    public Iterator<Multiset.Entry<E>> entryIterator() {
        return new C7583c(this, new C7582b());
    }
    ...
    public int remove(@CheckForNull Object obj, int i) {
        ...
        AbstractC5383bs.m51875d(i, "occurrences");
        AtomicInteger atomicInteger = (AtomicInteger) Maps.m40710G(this.countMap, obj);
        if (atomicInteger == null) {
            return 0;
        }
    ...
    */
    public int setCount(E r5, int r6) {
        /*
            ...
            p000.AbstractC5383bs.m51877b(r6, r0)
        L8:
            java.util.concurrent.ConcurrentMap<E, java.util.concurrent.atomic.AtomicInteger> r0 = r4.countMap
            java.lang.Object r0 = com.google.common.collect.Maps.m40710G(r0, r5)
            java.util.concurrent.atomic.AtomicInteger r0 = (java.util.concurrent.atomic.AtomicInteger) r0
    ...
    /* loaded from: classes4.dex */
    public class C7581a extends ForwardingSet {

        /* renamed from: a */
        public final /* synthetic */ Set f53097a;

        /* renamed from: b */
        public final /* synthetic */ ConcurrentHashMultiset f53098b;

        public C7581a(ConcurrentHashMultiset concurrentHashMultiset, Set set) {
            this.f53097a = set;
            this.f53098b = concurrentHashMultiset;
        }

        @Override // com.google.common.collect.ForwardingCollection, java.util.Collection, java.util.Set
        public boolean contains(Object obj) {
            if (obj != null && Collections2.m41051f(this.f53097a, obj)) {
                return true;
            }
            return false;
        }
        ...
        public boolean remove(Object obj) {
            if (obj != null && Collections2.m41050g(this.f53097a, obj)) {
                return true;
            }
            return false;
        }
    ...
    public boolean setCount(E e, int i, int i2) {
        ...
        AtomicInteger atomicInteger = (AtomicInteger) Maps.m40710G(this.countMap, e);
        if (atomicInteger == null) {
            if (i != 0) {
                return false;
            }
