...
public final class ChecksumInputStream extends CountingInputStream {
    ...
    public static class Builder extends ProxyInputStream.AbstractBuilder<ChecksumInputStream, Builder> {
        ...
        /* renamed from: l */
        public Checksum f73448l;

        /* renamed from: m */
        public long f73449m = -1;
    ...
    */
    public synchronized void afterRead(int r6) throws java.io.IOException {
        /*
            ...
            long r0 = r5.f73447f     // Catch: java.lang.Throwable -> L17
            r2 = 0
            int r4 = (r0 > r2 ? 1 : (r0 == r2 ? 0 : -1))
            if (r4 <= 0) goto L19
            long r0 = r5.getByteCount()     // Catch: java.lang.Throwable -> L17
            long r2 = r5.f73447f     // Catch: java.lang.Throwable -> L17
            int r4 = (r0 > r2 ? 1 : (r0 == r2 ? 0 : -1))
            if (r4 >= 0) goto L1c
            goto L19
        L17:
        ...
        L19:
            ...
            if (r6 != r0) goto L33
        L1c:
            long r0 = r5.f73446e     // Catch: java.lang.Throwable -> L17
            java.util.zip.Checksum r6 = r5.m25305d()     // Catch: java.lang.Throwable -> L17
    ...
    */
    public ChecksumInputStream(org.apache.commons.p028io.input.ChecksumInputStream.Builder r5) {
        /*
            ...
            java.util.zip.Checksum r2 = org.apache.commons.p028io.input.ChecksumInputStream.Builder.m25304e(r5)
            java.lang.String r3 = "builder.checksum"
            java.util.Objects.requireNonNull(r2, r3)
            java.util.zip.Checksum r2 = (java.util.zip.Checksum) r2
            r0.<init>(r1, r2)
            r4.<init>(r0, r5)
            long r0 = org.apache.commons.p028io.input.ChecksumInputStream.Builder.m25303f(r5)
            r4.f73447f = r0
            long r0 = org.apache.commons.p028io.input.ChecksumInputStream.Builder.m25302g(r5)
            r4.f73446e = r0
            return
        */
