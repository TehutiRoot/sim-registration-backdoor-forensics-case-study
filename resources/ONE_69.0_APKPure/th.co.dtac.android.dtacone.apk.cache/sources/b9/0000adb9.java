...
public abstract class InterruptibleTask<T> extends AtomicReference<Runnable> implements Runnable {
    ...
    private static final Runnable DONE = new RunnableC8244b();
    private static final Runnable PARKED = new RunnableC8244b();
    ...
    /* loaded from: classes4.dex */
    public static final class RunnableC8244b implements Runnable {
        public RunnableC8244b() {
        }
        ...
        if (z) {
            try {
                ...
                try {
                    ...
                    if (z) {
                        afterRanInterruptiblySuccess(AbstractC22667vJ0.m933a(null));
                    }
                }
            }
        }
