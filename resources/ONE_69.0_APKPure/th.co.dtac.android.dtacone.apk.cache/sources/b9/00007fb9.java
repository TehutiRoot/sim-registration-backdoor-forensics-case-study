...
public class LayerParser {
    ...
    /* renamed from: a */
    public static final JsonReader.Options f41555a = JsonReader.Options.m50682of("nm", "ind", "refId", "ty", "parent", "sw", OperatorName.SHADING_FILL, OperatorName.NON_STROKING_COLOR, "ks", "tt", "masksProperties", "shapes", "t", "ef", "sr", "st", OperatorName.SET_LINE_WIDTH, OperatorName.CLOSE_PATH, "ip", "op", "tm", "cl", "hd");

    /* renamed from: b */
    public static final JsonReader.Options f41556b = JsonReader.Options.m50682of("d", PDPageLabelRange.STYLE_LETTERS_LOWER);

    /* renamed from: c */
    public static final JsonReader.Options f41557c = JsonReader.Options.m50682of("ty", "nm");

    /* renamed from: com.airbnb.lottie.parser.LayerParser$a */
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C5700a {
        ...
        static {
            ...
            try {
                f41558a[Layer.MatteType.LUMA_INVERTED.ordinal()] = 2;
    ...
    public static Layer parse(JsonReader jsonReader, LottieComposition lottieComposition) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            switch (jsonReader.selectName(f41555a)) {
                case 0:
                ...
                case 9:
                    ...
                    if (nextInt2 >= Layer.MatteType.values().length) {
                        ...
                        int i4 = C5700a.f41558a[matteType2.ordinal()];
                        if (i4 == 1) {
                ...
                case 10:
                    ...
                    while (jsonReader.hasNext()) {
                        arrayList3.add(AbstractC19633do0.m31762a(jsonReader, lottieComposition));
                    }
                ...
                case 12:
                    jsonReader.beginObject();
                    while (jsonReader.hasNext()) {
                        int selectName = jsonReader.selectName(f41556b);
                        if (selectName == 0) {
                            animatableTextFrame = AnimatableValueParser.m50704d(jsonReader, lottieComposition);
                ...
                case 13:
                    ...
                    while (jsonReader.hasNext()) {
                        jsonReader.beginObject();
                        while (jsonReader.hasNext()) {
                            int selectName2 = jsonReader.selectName(f41557c);
                            if (selectName2 == 0) {
                                int nextInt3 = jsonReader.nextInt();
                                if (nextInt3 == 29) {
                                    blurEffect = AbstractC1887ac.m65110b(jsonReader, lottieComposition);
                                } else if (nextInt3 == 25) {
                                    dropShadowEffect = new DropShadowEffectParser().m50697b(jsonReader, lottieComposition);
                                }
