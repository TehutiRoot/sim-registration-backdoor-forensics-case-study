...
public final class BlockingFlowableIterable<T> implements Iterable<T> {
    ...
    public Iterator<T> iterator() {
        BlockingFlowableIterator blockingFlowableIterator = new BlockingFlowableIterator(this.f64072b);
        this.f64071a.subscribe((FlowableSubscriber) blockingFlowableIterator);
