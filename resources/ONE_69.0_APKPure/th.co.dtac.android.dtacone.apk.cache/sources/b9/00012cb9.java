...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.deviceSaleTrueCompany.fragment.OneDeviceSaleTrueAdditionalAdvanceFragment$setObserve$1$5 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleTrueAdditionalAdvanceFragment$setObserve$1$5 extends Lambda implements Function1<Resource<? extends OneCommonResponse>, Unit> {
    ...
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.deviceSaleTrueCompany.fragment.OneDeviceSaleTrueAdditionalAdvanceFragment$setObserve$1$5$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneDeviceSaleTrueAdditionalAdvanceFragment$setObserve$1$5(OneDeviceSaleTrueViewModel oneDeviceSaleTrueViewModel, OneDeviceSaleTrueAdditionalAdvanceFragment oneDeviceSaleTrueAdditionalAdvanceFragment) {
        super(1);
    ...
    public final void invoke2(Resource<OneCommonResponse> resource) {
        ...
        if (i != 1) {
            if (i == 2) {
                oneDeviceSaleTrueViewModel.submitOrder();
            } else if (i != 3) {
