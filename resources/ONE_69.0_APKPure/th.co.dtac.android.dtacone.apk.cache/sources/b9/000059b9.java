...
public final class NavigationDrawerKt$DismissibleNavigationDrawer$2$2$measure$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke2(@NotNull Placeable.PlacementScope layout) {
        ...
        Placeable.PlacementScope.placeRelative$default(layout, this.$contentPlaceable, this.$sheetPlaceable.getWidth() + AbstractC22237sr0.roundToInt(this.$drawerState.getOffset().getValue().floatValue()), 0, 0.0f, 4, null);
        Placeable.PlacementScope.placeRelative$default(layout, this.$sheetPlaceable, AbstractC22237sr0.roundToInt(this.$drawerState.getOffset().getValue().floatValue()), 0, 0.0f, 4, null);
    }
}