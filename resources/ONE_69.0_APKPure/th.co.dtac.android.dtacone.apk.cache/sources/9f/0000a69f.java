    ...
    public static class Builder {
        ...
        public Builder setScopes(String str) {
            if (str != null && str.trim().length() > 0) {
                this.f52410c = Arrays.asList(str.split(HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR));
            }
            return this;
        }
        ...
        public Builder(AccessToken accessToken) {
            this.f52410c = new ArrayList();
            this.f52408a = accessToken.getTokenValue();
            this.f52409b = accessToken.getExpirationTime();
            this.f52410c = accessToken.getScopes();
        }
