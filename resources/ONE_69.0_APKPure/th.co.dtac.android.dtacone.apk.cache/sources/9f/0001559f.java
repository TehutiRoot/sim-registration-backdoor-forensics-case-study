...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.device_sale.DeviceSaleViewModel$callListCampaignPaymentTypeAdditional$3 */
/* loaded from: classes9.dex */
public final class DeviceSaleViewModel$callListCampaignPaymentTypeAdditional$3 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ DeviceSaleViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DeviceSaleViewModel$callListCampaignPaymentTypeAdditional$3(DeviceSaleViewModel deviceSaleViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable it) {
        ...
        deviceSaleRepository.setSearchPackageRefNo(null);
