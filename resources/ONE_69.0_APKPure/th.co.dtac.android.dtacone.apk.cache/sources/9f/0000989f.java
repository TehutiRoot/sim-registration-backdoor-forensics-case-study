...
public final class zzmu {
    /* renamed from: a */
    public static zzmt m46793a(int i, int i2, long j, int i3, int i4, int i5, int i6) {
    ...
    public static void zza(zzmj zzmjVar, int i, int i2, long j, int i3, int i4, int i5, int i6) {
        zzmjVar.zzc(m46793a(i, i2, j, i3, i4, i5, i6), zziv.INPUT_IMAGE_CONSTRUCTION);
    }

    @WorkerThread
    public static void zzb(zzmj zzmjVar, int i, int i2, long j, int i3, int i4, int i5, int i6) {
        zzmjVar.zzc(m46793a(i, i2, j, i3, i4, i5, i6), zziv.ODML_IMAGE);
    }
}