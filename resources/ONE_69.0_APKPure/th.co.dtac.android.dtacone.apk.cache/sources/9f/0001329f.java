...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.fragment.consent.OneMnpConsentNonTelcoFragment$initView$2 */
/* loaded from: classes10.dex */
public final class OneMnpConsentNonTelcoFragment$initView$2 extends Lambda implements Function1<String, Unit> {
    final /* synthetic */ OneMnpConsentNonTelcoFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneMnpConsentNonTelcoFragment$initView$2(OneMnpConsentNonTelcoFragment oneMnpConsentNonTelcoFragment) {
        super(1);
