...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.esim.ESimViewModel$cutSimStock$1$2 */
/* loaded from: classes9.dex */
public final class ESimViewModel$cutSimStock$1$2 extends Lambda implements Function1<Throwable, Unit> {
    ...
    public ESimViewModel$cutSimStock$1$2(ESimViewModel eSimViewModel, MrtrPrepaidRegisterResponse mrtrPrepaidRegisterResponse, boolean z, MrtrPrepaidRegisterRequest mrtrPrepaidRegisterRequest, String str) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable it) {
        ...
        mrtrErrorService.handleException(it, new MrtrErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.viewmodel.esim.ESimViewModel$cutSimStock$1$2.1
            ...
            public void handle(@Nullable Throwable th2) {
                ...
                if (!(th2 instanceof HttpException) || ((HttpException) th2).code() != 404) {
                    ...
                    ESimViewModel.this.setCutSimStockError(errorCollection);
                }
                if (ESimViewModel.this.isCheckSimStock()) {
                    ESimViewModel.this.m2750R0(mrtrPrepaidRegisterResponse, z, mrtrPrepaidRegisterRequest, str);
                } else {
                    ESimViewModel.this.m2771H(z);
                }
            }
