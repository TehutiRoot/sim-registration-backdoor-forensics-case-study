...
public class HC256Engine implements StreamCipher {
    ...
    /* renamed from: iv */
    private byte[] f75092iv;
    private byte[] key;

    /* renamed from: p */
    private int[] f75093p = new int[1024];

    /* renamed from: q */
    private int[] f75094q = new int[1024];
    private int cnt = 0;
    ...
    private void init() {
        ...
        byte[] bArr4 = this.f75092iv;
        if (bArr4.length < 32) {
            byte[] bArr5 = new byte[32];
            System.arraycopy(bArr4, 0, bArr5, 0, bArr4.length);
            byte[] bArr6 = this.f75092iv;
        ...
        for (int i3 = 0; i3 < 32; i3++) {
            int i4 = (i3 >> 2) + 8;
            iArr[i4] = iArr[i4] | ((this.f75092iv[i3] & 255) << ((i3 & 3) * 8));
        }
        ...
        System.arraycopy(iArr, 512, this.f75093p, 0, 1024);
        System.arraycopy(iArr, 1536, this.f75094q, 0, 1024);
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            this.f75092iv = parametersWithIV.getIV();
            cipherParameters2 = parametersWithIV.getParameters();
        } else {
            this.f75092iv = new byte[0];
