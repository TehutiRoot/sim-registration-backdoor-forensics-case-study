...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.viewmodel.OnePostpaidPackagesViewModel$getOnePostpaidAllPackageGroupRetailer$2 */
/* loaded from: classes10.dex */
public final class C14984x14393d9d extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ OnePostpaidPackagesViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C14984x14393d9d(OnePostpaidPackagesViewModel onePostpaidPackagesViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable it) {
        ...
        oneErrorService.handleException(it, new OneErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.viewmodel.OnePostpaidPackagesViewModel$getOnePostpaidAllPackageGroupRetailer$2.1
