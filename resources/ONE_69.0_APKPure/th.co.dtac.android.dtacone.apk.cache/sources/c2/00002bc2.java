...
public final class NavigationRailKt {
    ...
    /* renamed from: d */
    public static final float f14621d;

    /* renamed from: e */
    public static final float f14622e;

    /* renamed from: a */
    public static final TweenSpec f14618a = new TweenSpec(300, 0, EasingKt.getFastOutSlowInEasing(), 2, null);

    /* renamed from: b */
    public static final float f14619b = C3623Dp.m73842constructorimpl(72);

    /* renamed from: c */
    public static final float f14620c = C3623Dp.m73842constructorimpl(56);

    /* renamed from: f */
    public static final float f14623f = C3623Dp.m73842constructorimpl(16);

    /* renamed from: g */
    public static final float f14624g = C3623Dp.m73842constructorimpl(14);

    /* renamed from: androidx.compose.material.NavigationRailKt$a */
    /* loaded from: classes.dex */
    public static final class C3131a implements MeasurePolicy {

        /* renamed from: a */
        public final /* synthetic */ Function2 f14625a;

        /* renamed from: b */
        public final /* synthetic */ float f14626b;

        public C3131a(Function2 function2, float f) {
            this.f14625a = function2;
            this.f14626b = f;
        }
        ...
        public final MeasureResult mo69380measure3p2s80s(MeasureScope Layout, List measurables, long j) {
            ...
            for (Measurable measurable : list) {
                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "icon")) {
                    ...
                    placeable = null;
                    if (this.f14625a == null) {
                        return NavigationRailKt.m60817d(Layout, mo72995measureBRTryo0, j);
                    }
                    Intrinsics.checkNotNull(placeable);
                    return NavigationRailKt.m60816e(Layout, placeable, mo72995measureBRTryo0, j, this.f14626b);
                }
            }
            throw new NoSuchElementException("Collection contains no element matching the predicate.");
        }
    ...
    static {
        float f = 8;
        f14621d = C3623Dp.m73842constructorimpl(f);
        f14622e = C3623Dp.m73842constructorimpl(f);
    }
    ...
    */
    public static final void m70240NavigationRailHsRjFd4(@org.jetbrains.annotations.Nullable androidx.compose.p003ui.Modifier r22, long r23, long r25, float r27, @org.jetbrains.annotations.Nullable kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.ColumnScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r28, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.ColumnScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r29, @org.jetbrains.annotations.Nullable androidx.compose.runtime.Composer r30, int r31, int r32) {
        /*
            Method dump skipped, instructions count: 396
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.NavigationRailKt.m70240NavigationRailHsRjFd4(androidx.compose.ui.Modifier, long, long, float, kotlin.jvm.functions.Function3, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final void m70241NavigationRailItem0S3VyRs(boolean r26, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function0<kotlin.Unit> r27, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r28, @org.jetbrains.annotations.Nullable androidx.compose.p003ui.Modifier r29, boolean r30, @org.jetbrains.annotations.Nullable kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r31, boolean r32, @org.jetbrains.annotations.Nullable androidx.compose.foundation.interaction.MutableInteractionSource r33, long r34, long r36, @org.jetbrains.annotations.Nullable androidx.compose.runtime.Composer r38, int r39, int r40) {
        /*
            Method dump skipped, instructions count: 883
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.NavigationRailKt.m70241NavigationRailItem0S3VyRs(boolean, kotlin.jvm.functions.Function0, kotlin.jvm.functions.Function2, androidx.compose.ui.Modifier, boolean, kotlin.jvm.functions.Function2, boolean, androidx.compose.foundation.interaction.MutableInteractionSource, long, long, androidx.compose.runtime.Composer, int, int):void");
    }

    /* renamed from: a */
    public static final void m60820a(Function2 function2, Function2 function22, float f, Composer composer, int i) {
        int i2;
        int i3;
        int i4;
        int i5;
        ...
        if ((i2 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            C3131a c3131a = new C3131a(function22, f);
            ...
            Updater.m71584setimpl(m71577constructorimpl, c3131a, companion2.getSetMeasurePolicy());
    ...
    /* renamed from: b */
    public static final void m60819b(long j, long j2, boolean z, Function3 function3, Composer composer, int i) {
        int i2;
        float f;
        Composer composer2;
        int i3;
        ...
        if ((i7 & 5851) == 1170 && startRestartGroup.getSkipping()) {
            ...
            composer2 = startRestartGroup;
            State<Float> animateFloatAsState = AnimateAsStateKt.animateFloatAsState(f, f14618a, 0.0f, null, null, startRestartGroup, 48, 28);
            long m71969lerpjxsXWHM = ColorKt.m71969lerpjxsXWHM(j2, j, m60818c(animateFloatAsState));
            CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m71909boximpl(Color.m71918copywmQWz5c$default(m71969lerpjxsXWHM, 1.0f, 0.0f, 0.0f, 0.0f, 14, null))), ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(Color.m71921getAlphaimpl(m71969lerpjxsXWHM)))}, ComposableLambdaKt.composableLambda(composer2, -1688205042, true, new NavigationRailKt$NavigationRailTransition$1(function3, i7, animateFloatAsState)), composer2, 56);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    /* renamed from: c */
    public static final float m60818c(State state) {
        return ((Number) state.getValue()).floatValue();
    }

    /* renamed from: d */
    public static final MeasureResult m60817d(MeasureScope measureScope, Placeable placeable, long j) {
        return MeasureScope.CC.m59482q(measureScope, Constraints.m73810getMaxWidthimpl(j), Constraints.m73809getMaxHeightimpl(j), null, new NavigationRailKt$placeIcon$1(placeable, Math.max(0, (Constraints.m73810getMaxWidthimpl(j) - placeable.getWidth()) / 2), Math.max(0, (Constraints.m73809getMaxHeightimpl(j) - placeable.getHeight()) / 2)), 4, null);
    }

    /* renamed from: e */
    public static final MeasureResult m60816e(MeasureScope measureScope, Placeable placeable, Placeable placeable2, long j, float f) {
        int i = placeable.get(AlignmentLineKt.getLastBaseline());
        int m73809getMaxHeightimpl = (Constraints.m73809getMaxHeightimpl(j) - i) - measureScope.mo69616roundToPx0680j_4(f14623f);
        int m73810getMaxWidthimpl = (Constraints.m73810getMaxWidthimpl(j) - placeable.getWidth()) / 2;
        int mo69616roundToPx0680j_4 = measureScope.mo69616roundToPx0680j_4(f14624g);
        int m73810getMaxWidthimpl2 = (Constraints.m73810getMaxWidthimpl(j) - placeable2.getWidth()) / 2;
        return MeasureScope.CC.m59482q(measureScope, Constraints.m73810getMaxWidthimpl(j), Constraints.m73809getMaxHeightimpl(j), null, new NavigationRailKt$placeLabelAndIcon$1(f, placeable, m73810getMaxWidthimpl, m73809getMaxHeightimpl, AbstractC22237sr0.roundToInt((((Constraints.m73809getMaxHeightimpl(j) - placeable2.getHeight()) / 2) - mo69616roundToPx0680j_4) * (1 - f)), placeable2, m73810getMaxWidthimpl2, mo69616roundToPx0680j_4), 4, null);
    }
}