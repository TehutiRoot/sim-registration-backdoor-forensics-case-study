...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.buyDol.fragment.OneBuyDolBankAccountFragment$setupObserve$1 */
/* loaded from: classes10.dex */
public final class OneBuyDolBankAccountFragment$setupObserve$1 extends Lambda implements Function1<Resource<? extends Pair<? extends RequestOtpResponse, ? extends String>>, Unit> {
    final /* synthetic */ OneBuyDolBankAccountFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.buyDol.fragment.OneBuyDolBankAccountFragment$setupObserve$1$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneBuyDolBankAccountFragment$setupObserve$1(OneBuyDolBankAccountFragment oneBuyDolBankAccountFragment) {
        super(1);
    ...
    public final void invoke2(Resource<Pair<RequestOtpResponse, String>> resource) {
        ...
        OneBuyDolBankAccountFragment oneBuyDolBankAccountFragment = this.this$0;
        int i = WhenMappings.$EnumSwitchMapping$0[resourceContentIfNotHandled.getStatus().ordinal()];
        if (i == 1) {
            oneBuyDolBankAccountFragment.dismissLoading();
            Pair<RequestOtpResponse, String> data = resourceContentIfNotHandled.getData();
            oneBuyDolBankAccountFragment.m16052q(data != null ? data.getFirst() : null);
        } else if (i == 2) {
            oneBuyDolBankAccountFragment.showLoading();
        } else if (i != 3) {
        } else {
            oneBuyDolBankAccountFragment.dismissLoading();
        }
