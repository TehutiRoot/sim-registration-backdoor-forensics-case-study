...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.viewmodel.OnePostpaidRegistrationViewModel$callCutSIMStock$1$2 */
/* loaded from: classes10.dex */
public final class OnePostpaidRegistrationViewModel$callCutSIMStock$1$2 extends Lambda implements Function1<CutSimStockResponse, Unit> {
    final /* synthetic */ OnePostpaidRegistrationViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidRegistrationViewModel$callCutSIMStock$1$2(OnePostpaidRegistrationViewModel onePostpaidRegistrationViewModel) {
        super(1);
