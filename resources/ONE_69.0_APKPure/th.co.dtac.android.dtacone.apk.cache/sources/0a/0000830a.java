...
public final class TransactionBodyAdapter extends RecyclerView.Adapter<TransactionPayloadViewHolder> {
    ...
    /* renamed from: a */
    public final ArrayList f43027a = new ArrayList();

    @Metadata(m29143d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0007"}, m29142d2 = {"Lcom/chuckerteam/chucker/internal/ui/transaction/TransactionBodyAdapter$Companion;", "", "()V", "TYPE_BODY_LINE", "", "TYPE_HEADERS", "TYPE_IMAGE", "com.github.ChuckerTeam.Chucker.library"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    @Metadata(m29143d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\b\n\u0002\b\t\n\u0002\u0010\u000e\n\u0002\b\u0004\n\u0002\u0010\u000b\n\u0002\b\b\b\u0080\b\u0018\u00002\u00020\u0001B\u0017\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0004\u001a\u00020\u0002¢\u0006\u0004\b\u0005\u0010\u0006J\u0010\u0010\u0007\u001a\u00020\u0002HÆ\u0003¢\u0006\u0004\b\u0007\u0010\bJ\u0010\u0010\t\u001a\u00020\u0002HÆ\u0003¢\u0006\u0004\b\t\u0010\bJ$\u0010\n\u001a\u00020\u00002\b\b\u0002\u0010\u0003\u001a\u00020\u00022\b\b\u0002\u0010\u0004\u001a\u00020\u0002HÆ\u0001¢\u0006\u0004\b\n\u0010\u000bJ\u0010\u0010\r\u001a\u00020\fHÖ\u0001¢\u0006\u0004\b\r\u0010\u000eJ\u0010\u0010\u000f\u001a\u00020\u0002HÖ\u0001¢\u0006\u0004\b\u000f\u0010\bJ\u001a\u0010\u0012\u001a\u00020\u00112\b\u0010\u0010\u001a\u0004\u0018\u00010\u0001HÖ\u0003¢\u0006\u0004\b\u0012\u0010\u0013R\u0017\u0010\u0003\u001a\u00020\u00028\u0006¢\u0006\f\n\u0004\b\u0014\u0010\u0015\u001a\u0004\b\u0016\u0010\bR\u0017\u0010\u0004\u001a\u00020\u00028\u0006¢\u0006\f\n\u0004\b\u0017\u0010\u0015\u001a\u0004\b\u0018\u0010\b¨\u0006\u0019"}, m29142d2 = {"Lcom/chuckerteam/chucker/internal/ui/transaction/TransactionBodyAdapter$SearchItemBodyLine;", "", "", "indexBodyLine", "indexStartOfQuerySubString", "<init>", "(II)V", "component1", "()I", "component2", "copy", "(II)Lcom/chuckerteam/chucker/internal/ui/transaction/TransactionBodyAdapter$SearchItemBodyLine;", "", "toString", "()Ljava/lang/String;", "hashCode", "other", "", "equals", "(Ljava/lang/Object;)Z", PDPageLabelRange.STYLE_LETTERS_LOWER, "I", "getIndexBodyLine", OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, "getIndexStartOfQuerySubString", "com.github.ChuckerTeam.Chucker.library"}, m29141k = 1, m29140mv = {1, 8, 0})
    ...
    public static final class SearchItemBodyLine {
        ...
        public static /* synthetic */ SearchItemBodyLine copy$default(SearchItemBodyLine searchItemBodyLine, int i, int i2, int i3, Object obj) {
            if ((i3 & 1) != 0) {
                i = searchItemBodyLine.f43028a;
            }
            if ((i3 & 2) != 0) {
                i2 = searchItemBodyLine.f43029b;
            }
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            if (obj instanceof SearchItemBodyLine) {
                ...
                return this.f43028a == searchItemBodyLine.f43028a && this.f43029b == searchItemBodyLine.f43029b;
            }
            return false;
        }
        ...
        public int hashCode() {
            return (this.f43028a * 31) + this.f43029b;
        }
    ...
    /* renamed from: a */
    public final int m49861a(SpannableStringBuilder spannableStringBuilder) {
    ...
    public int getItemCount() {
        return this.f43027a.size();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemViewType(int i) {
        TransactionPayloadItem transactionPayloadItem = (TransactionPayloadItem) this.f43027a.get(i);
    ...
    public final void m49860xbb91ef2c(int i, int i2, @NotNull String queryText, int i3, int i4) {
        TransactionPayloadItem.BodyLineItem bodyLineItem;
        Intrinsics.checkNotNullParameter(queryText, "queryText");
        Object orNull = CollectionsKt___CollectionsKt.getOrNull(this.f43027a, i);
    ...
    public final List<SearchItemBodyLine> highlightQueryWithColors$com_github_ChuckerTeam_Chucker_library(@NotNull String newText, int i, int i2) {
        ...
        ArrayList arrayList2 = this.f43027a;
        ...
        for (IndexedValue indexedValue : CollectionsKt___CollectionsKt.withIndex(arrayList3)) {
            ...
            } else if (m49861a(bodyLineItem.getLine()) > 0) {
                notifyItemChanged(component1 + 1);
            }
        }
        return arrayList;
    ...
    public final void resetHighlight$com_github_ChuckerTeam_Chucker_library() {
        ArrayList arrayList = this.f43027a;
        ...
        for (IndexedValue indexedValue : CollectionsKt___CollectionsKt.withIndex(arrayList2)) {
            int component1 = indexedValue.component1();
            if (m49861a(((TransactionPayloadItem.BodyLineItem) indexedValue.component2()).getLine()) > 0) {
                notifyItemChanged(component1 + 1);
            }
        }
    }
    ...
    public final void setItems(@NotNull List<? extends TransactionPayloadItem> bodyItems) {
        ...
        this.f43027a.clear();
        this.f43027a.addAll(bodyItems);
        notifyItemRangeRemoved(0, size);
        notifyItemRangeInserted(0, this.f43027a.size());
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public void onBindViewHolder(@NotNull TransactionPayloadViewHolder holder, int i) {
        Intrinsics.checkNotNullParameter(holder, "holder");
        Object obj = this.f43027a.get(i);
