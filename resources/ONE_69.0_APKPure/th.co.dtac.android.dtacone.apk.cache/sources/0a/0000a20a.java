...
public class MaterialDivider extends View {
    ...
    /* renamed from: f */
    public static final int f49893f = R.style.Widget_MaterialComponents_MaterialDivider;

    /* renamed from: a */
    public final MaterialShapeDrawable f49894a;
    ...
    public void onDraw(@NonNull Canvas canvas) {
        ...
        this.f49894a.setBounds(i, 0, width - i2, getBottom() - getTop());
        this.f49894a.draw(canvas);
    }
    ...
    public void setDividerColor(@ColorInt int i) {
        if (this.f49896c != i) {
            this.f49896c = i;
            this.f49894a.setFillColor(ColorStateList.valueOf(i));
            invalidate();
        }
    }
    ...
    */
    public MaterialDivider(@androidx.annotation.NonNull android.content.Context r8, @androidx.annotation.Nullable android.util.AttributeSet r9, int r10) {
        /*
            r7 = this;
            int r4 = com.google.android.material.divider.MaterialDivider.f49893f
