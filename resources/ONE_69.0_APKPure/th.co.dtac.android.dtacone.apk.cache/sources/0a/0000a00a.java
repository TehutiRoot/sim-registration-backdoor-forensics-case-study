...
public class ImageLabelerOptions extends AbstractSafeParcelable {
    ...
    public ImageLabelerOptions(@SafeParcelable.Param(m48385id = 2) int i, @SafeParcelable.Param(m48385id = 3) int i2, @SafeParcelable.Param(m48385id = 4) float f, @SafeParcelable.Param(m48385id = 5) int i3) {
        if (i == 1) {
            this.f48711a = i;
            this.zzeb = i2;
            this.zzec = f;
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        SafeParcelWriter.writeInt(parcel, 2, this.f48711a);
