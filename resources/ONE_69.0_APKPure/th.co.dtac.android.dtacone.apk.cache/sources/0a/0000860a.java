...
public class VersionUtil {
    ...
    /* renamed from: a */
    public static final Pattern f43277a = Pattern.compile("[-_./;:]");

    /* renamed from: a */
    public static final void m49490a(Closeable closeable) {
        try {
            closeable.close();
    ...
    public static Version parseVersion(String str, String str2, String str3) {
        ...
        if (str != null) {
            ...
            if (trim.length() > 0) {
                String[] split = f43277a.split(trim);
