...
public final class OneVerifyPasswordDialog extends BaseDialogFragment {
    ...
    /* renamed from: b */
    public final CompositeDisposable f83104b = new CompositeDisposable();
    public OneFontButton btnOk;

    /* renamed from: c */
    public OneVerifyPasswordDialogBinding f83105c;

    /* renamed from: d */
    public OnButtonClickListener f83106d;
    ...
    @Metadata(m29143d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\"\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\n2\b\b\u0002\u0010\u000b\u001a\u00020\u00042\b\b\u0002\u0010\f\u001a\u00020\rJ\u0010\u0010\u0007\u001a\u00020\b2\b\b\u0002\u0010\u000b\u001a\u00020\u0004R\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000¨\u0006\u000e"}, m29142d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/dialog/OneVerifyPasswordDialog$Companion;", "", "()V", "EXTRA_BACKGROUND_CONFIRM_BUTTON", "", "EXTRA_IS_PREFILL_PASSWORD", "EXTRA_TITLE_MESAGE", "newInstance", "Lth/co/dtac/android/dtacone/app_one/widget/dialog/OneVerifyPasswordDialog;", "isPrefillPassword", "", "titleMessage", "backgroundConfirmButton", "", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    @Metadata(m29143d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\bf\u0018\u00002\u00020\u0001J\b\u0010\u0002\u001a\u00020\u0003H&J\u0010\u0010\u0004\u001a\u00020\u00032\u0006\u0010\u0005\u001a\u00020\u0006H&¨\u0006\u0007"}, m29142d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/dialog/OneVerifyPasswordDialog$OnButtonClickListener;", "", "onCancel", "", "onConfirm", HintConstants.AUTOFILL_HINT_PASSWORD, "", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    /* renamed from: A */
    public static final void m19891A(OneVerifyPasswordDialog this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.onClickCancel();
    }

    /* renamed from: B */
    public static final String m19890B(Function1 tmp0, Object obj) {
        Intrinsics.checkNotNullParameter(tmp0, "$tmp0");
        return (String) tmp0.invoke(obj);
    }

    /* renamed from: C */
    public static final boolean m19889C(Function1 tmp0, Object obj) {
        Intrinsics.checkNotNullParameter(tmp0, "$tmp0");
        return ((Boolean) tmp0.invoke(obj)).booleanValue();
    }

    /* renamed from: D */
    public static final void m19888D(Function1 tmp0, Object obj) {
        Intrinsics.checkNotNullParameter(tmp0, "$tmp0");
        tmp0.invoke(obj);
    }

    /* renamed from: E */
    public static final void m19887E(Function1 tmp0, Object obj) {
        Intrinsics.checkNotNullParameter(tmp0, "$tmp0");
        tmp0.invoke(obj);
    }

    /* renamed from: n */
    public static /* synthetic */ void m19886n(Function1 function1, Object obj) {
        m19887E(function1, obj);
    }

    /* renamed from: o */
    public static /* synthetic */ String m19885o(Function1 function1, Object obj) {
        return m19890B(function1, obj);
    }

    /* renamed from: p */
    public static /* synthetic */ void m19884p(OneVerifyPasswordDialog oneVerifyPasswordDialog, View view) {
        m19891A(oneVerifyPasswordDialog, view);
    }

    /* renamed from: q */
    public static /* synthetic */ void m19883q(OneVerifyPasswordDialog oneVerifyPasswordDialog, View view) {
        m19874z(oneVerifyPasswordDialog, view);
    }

    /* renamed from: r */
    public static /* synthetic */ boolean m19882r(Function1 function1, Object obj) {
        return m19889C(function1, obj);
    }

    /* renamed from: s */
    public static /* synthetic */ void m19881s(Function1 function1, Object obj) {
        m19888D(function1, obj);
    }

    /* renamed from: t */
    private final void m19880t() {
        DtacClearableEditText dtacClearableEditText = m19878v().edtPassword;
        Intrinsics.checkNotNullExpressionValue(dtacClearableEditText, "binding.edtPassword");
        setEdtPassword(dtacClearableEditText);
        OneFontTextView oneFontTextView = m19878v().tvErrorCode;
        Intrinsics.checkNotNullExpressionValue(oneFontTextView, "binding.tvErrorCode");
        setTvErrorCode(oneFontTextView);
        OneFontTextView oneFontTextView2 = m19878v().tvErrorMessage;
        Intrinsics.checkNotNullExpressionValue(oneFontTextView2, "binding.tvErrorMessage");
        setTvErrorMessage(oneFontTextView2);
        OneFontTextView oneFontTextView3 = m19878v().tvKycMessage;
        Intrinsics.checkNotNullExpressionValue(oneFontTextView3, "binding.tvKycMessage");
        setTvKycMessage(oneFontTextView3);
        OneFontButton oneFontButton = m19878v().incButtonOkCancel.btnOk;
        Intrinsics.checkNotNullExpressionValue(oneFontButton, "binding.incButtonOkCancel.btnOk");
        setBtnOk(oneFontButton);
    }

    /* renamed from: u */
    private final int m19879u() {
    ...
    /* renamed from: x */
    public final void m19876x() {
        ViewVisibleExtKt.toGone(getTvErrorMessage());
        ViewVisibleExtKt.toGone(getTvErrorCode());
    }

    /* renamed from: z */
    public static final void m19874z(OneVerifyPasswordDialog this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public final void onClickCancel() {
        dismiss();
        OnButtonClickListener onButtonClickListener = this.f83106d;
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        this.f83105c = OneVerifyPasswordDialogBinding.inflate(inflater, viewGroup, false);
        RelativeLayout root = m19878v().getRoot();
        Intrinsics.checkNotNullExpressionValue(root, "binding.root");
        m19880t();
        getBtnOk().setOnClickListener(new View.OnClickListener() { // from class: Cg1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                OneVerifyPasswordDialog.m19883q(OneVerifyPasswordDialog.this, view);
            }
        });
        m19878v().incButtonOkCancel.btnCancel.setOnClickListener(new View.OnClickListener() { // from class: Dg1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                OneVerifyPasswordDialog.m19884p(OneVerifyPasswordDialog.this, view);
            }
        });
        m19876x();
        if (m19875y()) {
            ...
            getBtnOk().setBackgroundResource(m19879u());
        } else {
            CompositeDisposable compositeDisposable = this.f83104b;
            ...
            Observable<R> map = skipInitialValue.map(new Function() { // from class: Eg1
                @Override // io.reactivex.functions.Function
                public final Object apply(Object obj) {
                    return OneVerifyPasswordDialog.m19885o(Function1.this, obj);
                }
            });
            ...
            Observable filter = map.filter(new Predicate() { // from class: Fg1
                @Override // io.reactivex.functions.Predicate
                public final boolean test(Object obj) {
                    return OneVerifyPasswordDialog.m19882r(Function1.this, obj);
                }
            });
            ...
            Consumer consumer = new Consumer() { // from class: Gg1
                @Override // io.reactivex.functions.Consumer
                public final void accept(Object obj) {
                    OneVerifyPasswordDialog.m19881s(Function1.this, obj);
                }
            };
            ...
            compositeDisposable.add(filter.subscribe(consumer, new Consumer() { // from class: Hg1
                @Override // io.reactivex.functions.Consumer
                public final void accept(Object obj) {
                    OneVerifyPasswordDialog.m19886n(Function1.this, obj);
                }
            }));
        }
        if (m19877w().length() > 0) {
            getTvKycMessage().setText(m19877w());
        }
        return root;
    }
    ...
    /* renamed from: v */
    public final OneVerifyPasswordDialogBinding m19878v() {
        OneVerifyPasswordDialogBinding oneVerifyPasswordDialogBinding = this.f83105c;
        Intrinsics.checkNotNull(oneVerifyPasswordDialogBinding);
        return oneVerifyPasswordDialogBinding;
    }

    /* renamed from: y */
    public final boolean m19875y() {
        Bundle arguments = getArguments();
        if (arguments == null) {
            return false;
        }
