...
public final class PredictiveBackHandlerKt {
        ...
        if (rememberedValue2 == companion.getEmpty()) {
            rememberedValue2 = new OnBackPressedCallback(z) { // from class: androidx.activity.compose.PredictiveBackHandlerKt$PredictiveBackHandler$backCallBack$1$1
                ...
                public void handleOnBackCancelled() {
                    ...
                    OnBackInstance onBackInstance = this.f8808a;
                    if (onBackInstance != null) {
                        onBackInstance.m64717a();
                    }
                }
                ...
                public void handleOnBackPressed() {
                    Function2 m64712a;
                    OnBackInstance onBackInstance = this.f8808a;
                    if (onBackInstance != null && !onBackInstance.m64714d()) {
                        onBackInstance.m64717a();
                        this.f8808a = null;
                    }
                    if (this.f8808a == null) {
                        CoroutineScope coroutineScope2 = coroutineScope;
                        m64712a = PredictiveBackHandlerKt.m64712a(rememberUpdatedState);
                        this.f8808a = new OnBackInstance(coroutineScope2, false, m64712a);
                    }
                    OnBackInstance onBackInstance2 = this.f8808a;
                    if (onBackInstance2 != null) {
                        onBackInstance2.m64716b();
                    }
                }
                ...
                public void handleOnBackProgressed(@NotNull BackEventCompat backEventCompat) {
                    ...
                    OnBackInstance onBackInstance = this.f8808a;
                    if (onBackInstance != null) {
                        ChannelResult.m74858boximpl(onBackInstance.m64713e(backEventCompat));
                    }
                }
                ...
                public void handleOnBackStarted(@NotNull BackEventCompat backEventCompat) {
                    ...
                    CoroutineScope coroutineScope2 = coroutineScope;
                    m64712a = PredictiveBackHandlerKt.m64712a(rememberUpdatedState);
                    this.f8808a = new OnBackInstance(coroutineScope2, true, m64712a);
                }

                public final void setOnBackInstance(@Nullable OnBackInstance onBackInstance) {
                    this.f8808a = onBackInstance;
                }
            };
    ...
    /* renamed from: a */
    public static final Function2 m64712a(State state) {
