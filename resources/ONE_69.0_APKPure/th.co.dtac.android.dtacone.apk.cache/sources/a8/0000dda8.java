...
public abstract class AbstractTypeAliasDescriptor extends DeclarationDescriptorNonRootImpl implements TypeAliasDescriptor {
    ...
    /* renamed from: e */
    public final DescriptorVisibility f68711e;

    /* renamed from: f */
    public List f68712f;

    /* renamed from: g */
    public final AbstractTypeAliasDescriptor$typeConstructor$1 f68713g;
    ...
    public AbstractTypeAliasDescriptor(@NotNull DeclarationDescriptor containingDeclaration, @NotNull Annotations annotations, @NotNull Name name, @NotNull SourceElement sourceElement, @NotNull DescriptorVisibility visibilityImpl) {
        ...
        this.f68711e = visibilityImpl;
        this.f68713g = new TypeConstructor() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor$typeConstructor$1
    ...
    public List<TypeParameterDescriptor> getDeclaredTypeParameters() {
        List<TypeParameterDescriptor> list = this.f68712f;
        if (list == null) {
    ...
    public final void initialize(@NotNull List<? extends TypeParameterDescriptor> declaredTypeParameters) {
        ...
        this.f68712f = declaredTypeParameters;
    }
