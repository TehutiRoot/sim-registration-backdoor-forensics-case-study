...
public class HttpResponseParser extends AbstractMessageParser<HttpMessage> {
    ...
    /* renamed from: f */
    public final HttpResponseFactory f74581f;

    /* renamed from: g */
    public final CharArrayBuffer f74582g;
    ...
    public HttpResponseParser(SessionInputBuffer sessionInputBuffer, LineParser lineParser, HttpResponseFactory httpResponseFactory, HttpParams httpParams) {
        ...
        this.f74581f = (HttpResponseFactory) Args.notNull(httpResponseFactory, "Response factory");
        this.f74582g = new CharArrayBuffer(128);
    }
    ...
    public HttpMessage parseHead(SessionInputBuffer sessionInputBuffer) throws IOException, HttpException, ParseException {
        this.f74582g.clear();
        if (sessionInputBuffer.readLine(this.f74582g) != -1) {
            return this.f74581f.newHttpResponse(this.lineParser.parseStatusLine(this.f74582g, new ParserCursor(0, this.f74582g.length())), null);
        }
