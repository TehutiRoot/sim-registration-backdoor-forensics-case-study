...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.deviceSaleTrueCompany.fragment.common.OneDeviceSaleNavigateToCommonFragment$navigateNextToCommon$upPassFormOnSuccessCallback$1 */
/* loaded from: classes10.dex */
public final class C14566x3319cfa6 extends Lambda implements Function1<UpPassFormResult, Unit> {
    final /* synthetic */ OneDeviceSaleNavigateToCommonFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C14566x3319cfa6(OneDeviceSaleNavigateToCommonFragment oneDeviceSaleNavigateToCommonFragment) {
        super(1);
    ...
    public final void invoke2(@NotNull UpPassFormResult result) {
        ...
        if (result.getFormType() instanceof UpPassFormType.Ocr) {
            ...
            viewModel.mapUpPassFromResultCommon(result);
            viewModel.checkSameThaiId();
        }
    }
}