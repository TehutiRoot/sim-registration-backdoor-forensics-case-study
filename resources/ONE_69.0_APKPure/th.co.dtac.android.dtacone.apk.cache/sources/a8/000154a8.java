...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.customerenquiry.InfoAnalyticViewModel$callCheckBlocking$2 */
/* loaded from: classes9.dex */
public final class InfoAnalyticViewModel$callCheckBlocking$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ InfoAnalyticViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InfoAnalyticViewModel$callCheckBlocking$2(InfoAnalyticViewModel infoAnalyticViewModel) {
        super(1);
