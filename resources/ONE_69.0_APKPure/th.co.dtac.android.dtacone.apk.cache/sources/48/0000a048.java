...
public final class ShippingAddressRequirements extends AbstractSafeParcelable {
    ...
    public final class Builder {
        ...
        public Builder addAllowedCountryCode(@NonNull String str) {
            ...
            if (shippingAddressRequirements.f48848a == null) {
                shippingAddressRequirements.f48848a = new ArrayList();
            }
            ShippingAddressRequirements.this.f48848a.add(str);
            return this;
        }
        ...
        public Builder addAllowedCountryCodes(@NonNull Collection<String> collection) {
            if (collection != null && !collection.isEmpty()) {
                ...
                ShippingAddressRequirements.this.f48848a.addAll(collection);
                return this;
            }
    ...
    public void writeToParcel(@NonNull Parcel parcel, int i) {
        ...
        SafeParcelWriter.writeStringList(parcel, 1, this.f48848a, false);
