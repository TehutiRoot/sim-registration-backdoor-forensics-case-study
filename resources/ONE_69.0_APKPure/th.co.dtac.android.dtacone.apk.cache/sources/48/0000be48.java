...
public class setHeaderText implements setDarkTextColor.valueOf {
    private final setDarkTextColor get;

    public setHeaderText(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.getSDKEphemeralPublicKey(this.get);
    }
}