...
public final class AH2 implements ObjectEncoder {
    ...
    /* renamed from: a */
    public static final AH2 f60a = new AH2();

    /* renamed from: b */
    public static final FieldDescriptor f61b;

    /* renamed from: c */
    public static final FieldDescriptor f62c;

    /* renamed from: d */
    public static final FieldDescriptor f63d;

    /* renamed from: e */
    public static final FieldDescriptor f64e;

    /* renamed from: f */
    public static final FieldDescriptor f65f;

    static {
        FieldDescriptor.Builder builder = FieldDescriptor.builder("detectorMode");
        zzfc zzfcVar = new zzfc();
        zzfcVar.zza(1);
        f61b = builder.withProperty(zzfcVar.zzb()).build();
        FieldDescriptor.Builder builder2 = FieldDescriptor.builder("personDetectionMode");
        zzfc zzfcVar2 = new zzfc();
        zzfcVar2.zza(2);
        f62c = builder2.withProperty(zzfcVar2.zzb()).build();
        FieldDescriptor.Builder builder3 = FieldDescriptor.builder("landmarkDetectionMode");
        zzfc zzfcVar3 = new zzfc();
        zzfcVar3.zza(3);
        f63d = builder3.withProperty(zzfcVar3.zzb()).build();
        FieldDescriptor.Builder builder4 = FieldDescriptor.builder("preferredHardwareConfigs");
        zzfc zzfcVar4 = new zzfc();
        zzfcVar4.zza(4);
        f64e = builder4.withProperty(zzfcVar4.zzb()).build();
        FieldDescriptor.Builder builder5 = FieldDescriptor.builder("runConfig");
        zzfc zzfcVar5 = new zzfc();
        zzfcVar5.zza(5);
        f65f = builder5.withProperty(zzfcVar5.zzb()).build();
    }
