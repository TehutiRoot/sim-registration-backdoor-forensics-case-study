...
public final class C9652og<T> implements Serializable {
    ...
    private C9652og(T t, T t2, Comparator<T> comparator) {
        if (t != null && t2 != null) {
            if (comparator == null) {
    ...
    public static C9652og ThreeDS2ServiceInstance(Comparable comparable, Comparable comparable2) {
        return get(comparable, comparable2, null);
    }

    public static <T> C9652og<T> get(T t, T t2, Comparator<T> comparator) {
        return new C9652og<>(t, t2, comparator);
    }
