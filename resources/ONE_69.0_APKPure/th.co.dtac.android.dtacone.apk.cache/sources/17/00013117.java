...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.home.fragment.OneHomeFragment$setupObserve$2 */
/* loaded from: classes10.dex */
public final class OneHomeFragment$setupObserve$2 extends Lambda implements Function1<Resource<? extends Pair<? extends String, ? extends OneBuyDolPriceListSimRModel>>, Unit> {
    final /* synthetic */ OneHomeFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.home.fragment.OneHomeFragment$setupObserve$2$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneHomeFragment$setupObserve$2(OneHomeFragment oneHomeFragment) {
        super(1);
    ...
    public final void invoke2(Resource<Pair<String, OneBuyDolPriceListSimRModel>> resource) {
        ...
        if (data != null) {
            ...
            if (Intrinsics.areEqual(data.getFirst(), PermissionConstant.M_BUY_DOL)) {
                oneHomeFragment.m14260B(second);
            } else {
                oneHomeFragment.m14262A(second);
            }
        }
    }
}