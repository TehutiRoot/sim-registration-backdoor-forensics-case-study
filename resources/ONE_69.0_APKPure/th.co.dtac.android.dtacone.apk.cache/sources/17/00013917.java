...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.viewmodel.OnePostpaidRegistrationViewModel$checkNumber$3 */
/* loaded from: classes10.dex */
public final class OnePostpaidRegistrationViewModel$checkNumber$3 extends Lambda implements Function1<OneCancelAndCheckNumberResponse, Unit> {
    final /* synthetic */ String $msisdn;
    final /* synthetic */ OnePostpaidRegistrationViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidRegistrationViewModel$checkNumber$3(OnePostpaidRegistrationViewModel onePostpaidRegistrationViewModel, String str) {
        super(1);
    ...
    public final void invoke2(OneCancelAndCheckNumberResponse oneCancelAndCheckNumberResponse) {
        ...
        onePostpaidRepository2.getModel().setReserveInputNumberAllResponse(oneCancelAndCheckNumberResponse);
