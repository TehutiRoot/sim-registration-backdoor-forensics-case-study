...
public class MlImage implements Closeable {
    ...
    /* renamed from: a */
    public final Pq2 f51603a;

    /* renamed from: b */
    public final int f51604b;

    /* renamed from: c */
    public final Rect f51605c;
    ...
    public static final class Internal {
        ...
        /* renamed from: a */
        public final MlImage f51609a;

        public /* synthetic */ Internal(MlImage mlImage, AbstractC19874fA2 abstractC19874fA2) {
            this.f51609a = mlImage;
        }

        public void acquire() {
            this.f51609a.m43402i();
        }
    }
    ...
    public MlImage(Pq2 pq2, int i, Rect rect, long j, int i2, int i3) {
        this.f51603a = pq2;
        this.f51604b = i;
        Rect rect2 = new Rect();
        this.f51605c = rect2;
    ...
    /* renamed from: g */
    public static void m43403g(int i) {
    ...
    /* renamed from: b */
    public final Pq2 m43405b() {
        return this.f51603a;
    }

    @Override // java.io.Closeable, java.lang.AutoCloseable
    public synchronized void close() {
        int i = this.f51608f - 1;
        this.f51608f = i;
        if (i == 0) {
            this.f51603a.zzc();
        }
    ...
    public List<ImageProperties> getContainedImageProperties() {
        return Collections.singletonList(this.f51603a.zzb());
    }
    ...
    /* renamed from: i */
    public final synchronized void m43402i() {
        this.f51608f++;
    }
}