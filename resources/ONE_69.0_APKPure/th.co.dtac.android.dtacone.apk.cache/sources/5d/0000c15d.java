...
public class COSParser extends BaseParser {
    ...
    /* renamed from: d */
    public final byte[] f60020d;

    /* renamed from: e */
    public AccessPermission f60021e;

    /* renamed from: f */
    public InputStream f60022f;
    protected long fileLen;

    /* renamed from: g */
    public String f60023g;
    ...
    /* renamed from: p */
    public PDEncryption f60032p;

    /* renamed from: q */
    public int f60033q;

    /* renamed from: r */
    public final byte[] f60034r;
    protected SecurityHandler securityHandler;
    protected final RandomAccessRead source;
    protected XrefTrailerResolver xrefTrailerResolver;

    /* renamed from: s */
    public static final char[] f60013s = {'x', 'r', 'e', 'f'};

    /* renamed from: t */
    public static final char[] f60014t = {'/', 'X', Matrix.MATRIX_TYPE_RANDOM_REGULAR, 'e', 'f'};

    /* renamed from: u */
    public static final char[] f60015u = {'s', 't', 'a', 'r', 't', 'x', 'r', 'e', 'f'};

    /* renamed from: v */
    public static final byte[] f60016v = {101, 110, 100, 115, 116, 114, 101, 97, 109};

    /* renamed from: w */
    public static final byte[] f60017w = {101, 110, 100, 111, 98, 106};
    ...
    /* renamed from: x */
    public static final char[] f60018x = {'t', 'r', 'a', 'i', 'l', 'e', 'r'};

    /* renamed from: y */
    public static final char[] f60019y = {'/', 'O', 'b', 'j', 'S', 't', 'm'};

    public COSParser(RandomAccessRead randomAccessRead) {
        super(new C17659Fs1(randomAccessRead));
        this.f60020d = new byte[2048];
        this.f60022f = null;
        this.f60023g = "";
        this.f60024h = null;
        this.f60026j = true;
        ...
        this.f60034r = new byte[8192];
        this.source = randomAccessRead;
    }

    /* renamed from: A */
    public final COSObject m32680A(COSObject cOSObject, Long l, COSObject cOSObject2, Long l2) {
        if (cOSObject2 != null) {
    ...
    /* renamed from: B */
    public final COSObjectKey m32679B(COSObjectKey cOSObjectKey, long j) {
        if (j < 6) {
            return null;
        }
        try {
            ...
            if (cOSObjectKey.getNumber() == readObjectNumber()) {
                ...
                if (this.f60026j && readGenerationNumber > cOSObjectKey.getGeneration()) {
    ...
    /* renamed from: C */
    public final COSNumber m32678C(COSBase cOSBase, COSName cOSName) {
        if (cOSBase == null) {
            return null;
        }
    ...
    /* renamed from: D */
    public final long m32677D(COSObject cOSObject) {
        return (cOSObject.getObjectNumber() << 32) | cOSObject.getGenerationNumber();
    }

    /* renamed from: E */
    public final boolean m32676E(COSDictionary cOSDictionary) {
        if (cOSDictionary.containsKey(COSName.PARENT) || cOSDictionary.containsKey(COSName.f59760A) || cOSDictionary.containsKey(COSName.DEST)) {
            return false;
        }
    ...
    /* renamed from: F */
    public final boolean m32675F(byte[] bArr) {
    ...
    /* renamed from: G */
    public final boolean m32674G(char[] cArr) {
        long position = this.source.getPosition();
    ...
    /* renamed from: H */
    public final void m32673H(COSObject cOSObject) {
    ...
    /* renamed from: I */
    public final void m32672I(Long l, COSObjectKey cOSObjectKey, COSObject cOSObject) {
        COSBase cOSBase;
    ...
    /* renamed from: J */
    public final boolean m32671J(String str, String str2) {
    ...
    /* renamed from: K */
    public final void m32670K(int i) {
    ...
    /* renamed from: M */
    public final boolean m32668M() {
        this.f60025i = this.source.getPosition();
        if (this.f60026j) {
            int peek = this.source.peek();
            while (peek != 116 && BaseParser.isDigit(peek)) {
                if (this.source.getPosition() == this.f60025i) {
                    Log.w("PdfBox-Android", "Expected trailer object at offset " + this.f60025i + ", keep trying");
                }
                readLine();
    ...
    /* renamed from: N */
    public final long m32667N(long j, boolean z) {
        long readObjectNumber = readObjectNumber();
        ...
        m32666O(parseCOSStream, j, z);
        parseCOSStream.close();
        return parseCOSDictionary.getLong(COSName.PREV);
    }

    /* renamed from: O */
    public final void m32666O(COSStream cOSStream, long j, boolean z) {
        if (z) {
    ...
    /* renamed from: P */
    public final void m32665P() {
        COSBase item;
        DecryptionMaterial standardDecryptionMaterial;
        if (this.f60032p == null && (item = this.document.getTrailer().getItem(COSName.ENCRYPT)) != null && !(item instanceof COSNull)) {
            if (item instanceof COSObject) {
                m32673H((COSObject) item);
            }
            try {
                try {
                    this.f60032p = new PDEncryption(this.document.getEncryptionDictionary());
                    if (this.f60022f != null) {
                        KeyStore keyStore = KeyStore.getInstance("PKCS12");
                        keyStore.load(this.f60022f, this.f60023g.toCharArray());
                        standardDecryptionMaterial = new PublicKeyDecryptionMaterial(keyStore, this.f60024h, this.f60023g);
                    } else {
                        standardDecryptionMaterial = new StandardDecryptionMaterial(this.f60023g);
                    }
                    SecurityHandler securityHandler = this.f60032p.getSecurityHandler();
                    this.securityHandler = securityHandler;
                    securityHandler.prepareForDecryption(this.f60032p, this.document.getDocumentID(), standardDecryptionMaterial);
                    this.f60021e = this.securityHandler.getCurrentAccessPermission();
                    InputStream inputStream = this.f60022f;
                    if (inputStream != null) {
                ...
                InputStream inputStream2 = this.f60022f;
    ...
    /* renamed from: Q */
    public final void m32664Q(OutputStream outputStream) {
        int i;
        byte b;
        byte[] bArr = f60016v;
        int i2 = 0;
        while (true) {
            int read = this.source.read(this.f60020d, i2, 2048 - i2);
            if (read <= 0) {
                break;
            }
            int i3 = read + i2;
            ...
            while (true) {
                ...
                int i6 = i2 + 5;
                if (i5 == 0 && i6 < i4 && ((b = this.f60020d[i6]) > 116 || b < 97)) {
                    i2 = i6;
                } else {
                    byte b2 = this.f60020d[i2];
                    if (b2 == bArr[i5]) {
                        i5++;
                        if (i5 == bArr.length) {
                            i2++;
            ...
            if (max > 0) {
                outputStream.write(this.f60020d, 0, max);
            }
            if (i5 == bArr.length) {
                this.source.rewind(i3 - max);
                break;
            } else {
                System.arraycopy(bArr, 0, this.f60020d, 0, i5);
                i2 = i5;
            }
        }
        outputStream.flush();
    ...
    /* renamed from: R */
    public final void m32663R(OutputStream outputStream, COSNumber cOSNumber) {
        int i;
        ...
        while (longValue > 0) {
            ...
            int read = this.source.read(this.f60034r, 0, i);
            if (read > 0) {
                outputStream.write(this.f60034r, 0, read);
                longValue -= read;
            } else {
    ...
    /* renamed from: S */
    public final COSDictionary m32662S(COSObject cOSObject) {
        COSObjectKey cOSObjectKey = new COSObjectKey(cOSObject);
        Long l = (Long) this.f60028l.get(cOSObjectKey);
        if (l != null) {
            long position = this.source.getPosition();
            COSDictionary m32661T = m32661T(cOSObjectKey, l.longValue());
            this.source.seek(position);
            return m32661T;
        }
        return null;
    ...
    /* renamed from: T */
    public final COSDictionary m32661T(COSObjectKey cOSObjectKey, long j) {
        if (j < 0) {
    ...
    /* renamed from: U */
    public final boolean m32660U(COSDictionary cOSDictionary) {
        COSObject objectFromPool;
        COSObject cOSObject = null;
        COSObject cOSObject2 = null;
        Long l = null;
        Long l2 = null;
        for (Map.Entry entry : this.f60028l.entrySet()) {
            COSDictionary m32661T = m32661T((COSObjectKey) entry.getKey(), ((Long) entry.getValue()).longValue());
            if (m32661T != null) {
                if (isCatalog(m32661T)) {
                    COSObject objectFromPool2 = this.document.getObjectFromPool((COSObjectKey) entry.getKey());
                    cOSObject = m32680A(objectFromPool2, (Long) entry.getValue(), cOSObject, l);
                    if (cOSObject == objectFromPool2) {
                        l = (Long) entry.getValue();
                    }
                } else if (m32676E(m32661T) && (cOSObject2 = m32680A((objectFromPool = this.document.getObjectFromPool((COSObjectKey) entry.getKey())), (Long) entry.getValue(), cOSObject2, l2)) == objectFromPool) {
    ...
    /* renamed from: V */
    public final long m32659V(List list, long j) {
        int size = list.size();
        Long l = null;
        int i = -1;
    ...
    /* renamed from: W */
    public final boolean m32658W(long j) {
        long position = this.source.getPosition();
        long j2 = position + j;
        boolean z = false;
        if (j2 > this.fileLen) {
    ...
    /* renamed from: X */
    public final boolean m32657X(Map map) {
        if (map == null) {
            return true;
        }
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            if (l != null && l.longValue() >= 0) {
                COSObjectKey m32679B = m32679B(cOSObjectKey, l.longValue());
                if (m32679B == null) {
                    StringBuilder sb = new StringBuilder();
                    ...
                    return false;
                } else if (m32679B != cOSObjectKey) {
                    hashMap.put(cOSObjectKey, m32679B);
                }
            }
        }
    ...
    public void checkPages(COSDictionary cOSDictionary) {
        if (this.f60027k && cOSDictionary != null) {
            COSBase dictionaryObject = cOSDictionary.getDictionaryObject(COSName.PAGES);
            if (dictionaryObject instanceof COSDictionary) {
                m32645w((COSDictionary) dictionaryObject, new HashSet());
            }
        }
    }
    ...
    public final long getStartxrefOffset() throws IOException {
        try {
            ...
            int lastIndexOf2 = lastIndexOf(f60015u, bArr, i);
            if (lastIndexOf2 >= 0) {
    ...
    /* renamed from: l */
    public final void m32656l(COSName[] cOSNameArr, COSDictionary cOSDictionary, Set set) {
        if (cOSNameArr != null) {
            for (COSName cOSName : cOSNameArr) {
                COSBase item = cOSDictionary.getItem(cOSName);
                if (item instanceof COSObject) {
                    set.add(Long.valueOf(m32677D((COSObject) item)));
                }
            }
        }
    }
    ...
    /* renamed from: m */
    public final void m32655m(Queue queue, COSBase cOSBase, Set set) {
        if (cOSBase instanceof COSObject) {
            if (!set.add(Long.valueOf(m32677D((COSObject) cOSBase)))) {
                return;
            }
            queue.add(cOSBase);
    ...
    /* renamed from: n */
    public final void m32654n(Queue queue, Collection collection, Set set) {
        Iterator it = collection.iterator();
        while (it.hasNext()) {
            m32655m(queue, (COSBase) it.next(), set);
        }
    }

    /* renamed from: o */
    public final void m32653o() {
        if (this.f60029m == null) {
            long position = this.source.getPosition();
            this.source.seek(6L);
            while (!this.source.isEOF()) {
                if (m32674G(EOF_MARKER)) {
                    ...
                    try {
                        ...
                        this.f60029m = Long.valueOf(position2);
                    }
                }
                this.source.read();
            }
            this.source.seek(position);
            if (this.f60029m == null) {
                this.f60029m = Long.MAX_VALUE;
            }
        }
    }

    /* renamed from: p */
    public final void m32652p() {
        boolean z;
        HashMap hashMap;
        long j;
        COSStream cOSStream;
        ...
        while (true) {
            ...
            if (m32674G(f60019y)) {
                ...
                this.source.seek(position2 + f60019y.length);
            }
            this.source.read();
        }
        for (Long l : hashMap3.keySet()) {
            Long l2 = (Long) this.f60028l.get(hashMap3.get(l));
            if (l2 == null) {
                ...
                if (l.equals(l2)) {
                    ...
                    try {
                        ...
                        i2 = parseCOSDictionary.getInt(COSName.f59819N);
                    } catch (IOException unused) {
                        hashMap = hashMap3;
                        j = position;
                        cOSStream = null;
                    ...
                    if (i != -1 && i2 != -1) {
                        ...
                        if (arrayList.size() < i2) {
                            ...
                            for (Long l3 : arrayList) {
                                ...
                                Long l4 = (Long) this.f60028l.get(cOSObjectKey);
                                if (l4 != null) {
                                    if (l4.longValue() < 0) {
                                        hashMap2 = hashMap3;
                                        j2 = position;
                                        l4 = (Long) this.f60028l.get(new COSObjectKey(Math.abs(l4.longValue()), 0));
                                    } else {
                                        hashMap2 = hashMap3;
                                        j2 = position;
                                    }
                                ...
                                if (l4 == null || l.longValue() > l4.longValue()) {
                                    ...
                                    this.f60028l.put(cOSObjectKey, Long.valueOf(j9));
    ...
    public COSStream parseCOSStream(COSDictionary cOSDictionary) throws IOException {
        ...
        COSNumber m32678C = m32678C(cOSDictionary.getItem(cOSName), cOSDictionary.getCOSName(COSName.TYPE));
        if (m32678C == null) {
            if (this.f60026j) {
        ...
        if (m32678C != null && m32658W(m32678C.longValue())) {
            OutputStream createRawOutputStream = createCOSStream.createRawOutputStream();
            try {
                m32663R(createRawOutputStream, m32678C);
                createRawOutputStream.close();
                createCOSStream.setItem(cOSName, (COSBase) m32678C);
            } catch (Throwable th2) {
                createRawOutputStream.close();
                createCOSStream.setItem(COSName.LENGTH, (COSBase) m32678C);
                throw th2;
            }
        } else {
            OutputStream createRawOutputStream2 = createCOSStream.createRawOutputStream();
            try {
                m32664Q(new C17215zS(createRawOutputStream2));
        ...
        String readString = readString();
        if (readString.equals("endobj") && this.f60026j) {
            Log.w("PdfBox-Android", "stream ends with 'endobj' instead of 'endstream' at offset " + this.source.getPosition());
            this.source.rewind(f60017w.length);
        } else if (readString.length() > 9 && this.f60026j && readString.startsWith("endstream")) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:72:0x01e3, code lost:
        r7.setObject(r8);
        m32655m(r1, r8, r4);
        r3.add(java.lang.Long.valueOf(m32677D(r7)));
     */
    /*
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void m32651q() {
        /*
            Method dump skipped, instructions count: 310
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tom_roush.pdfbox.pdfparser.COSParser.m32651q():void");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final boolean m32650r(com.tom_roush.pdfbox.cos.COSDictionary r12) {
        /*
            r11 = this;
        ...
        Ld:
            ...
            r3 = 0
            if (r2 != 0) goto L9c
            char[] r2 = com.tom_roush.pdfbox.pdfparser.COSParser.f60018x
            boolean r4 = r11.m32674G(r2)
            if (r4 == 0) goto L95
            ...
            r6 = 1
            if (r5 == 0) goto L4a
            com.tom_roush.pdfbox.cos.COSDictionary r7 = r11.m32662S(r5)     // Catch: java.io.IOException -> L48
            if (r7 == 0) goto L4a
        ...
        L4b:
            ...
            if (r9 == 0) goto L60
            com.tom_roush.pdfbox.cos.COSDictionary r10 = r11.m32662S(r9)     // Catch: java.io.IOException -> L48
            if (r10 == 0) goto L60
            boolean r10 = r11.m32676E(r10)     // Catch: java.io.IOException -> L48
            if (r10 == 0) goto L60
            r3 = 1
        L60:
            if (r7 == 0) goto L95
            ...
            if (r4 == 0) goto L81
            com.tom_roush.pdfbox.cos.COSDictionary r5 = r11.m32662S(r4)     // Catch: java.io.IOException -> L48
            if (r5 == 0) goto L81
            r12.setItem(r3, r4)     // Catch: java.io.IOException -> L48
        L81:
            com.tom_roush.pdfbox.cos.COSName r3 = com.tom_roush.pdfbox.cos.COSName.f59803ID     // Catch: java.io.IOException -> L48
            boolean r4 = r2.containsKey(r3)     // Catch: java.io.IOException -> L48
            if (r4 == 0) goto L94
        ...
        L9c:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tom_roush.pdfbox.pdfparser.COSParser.m32650r(com.tom_roush.pdfbox.cos.COSDictionary):boolean");
    }
    ...
    public final COSDictionary rebuildTrailer() throws IOException {
        ...
        if (this.f60028l != null) {
            ...
            if (!m32650r(cOSDictionary) && !m32660U(cOSDictionary)) {
                m32652p();
                m32660U(cOSDictionary);
                z = true;
            } else {
                z = false;
            }
    ...
    /* renamed from: s */
    public final long m32649s(long j, boolean z) {
        long j2;
        long j3;
        List list;
        if (!z) {
        ...
        m32648t();
        if (!z && (list = this.f60030n) != null) {
            j2 = m32659V(list, j);
        } else {
            j2 = -1;
        }
        List list2 = this.f60031o;
        if (list2 != null) {
            j3 = m32659V(list2, j);
        } else {
            j3 = -1;
        ...
        if (i > 0 && j3 > -1) {
            if (Math.abs(j - j2) > Math.abs(j - j3)) {
                this.f60031o.remove(Long.valueOf(j3));
                return j3;
            }
            this.f60030n.remove(Long.valueOf(j2));
            return j2;
        } else if (i > 0) {
            this.f60030n.remove(Long.valueOf(j2));
            return j2;
    ...
    /* renamed from: t */
    public final void m32648t() {
        if (this.f60031o == null) {
            this.f60031o = new ArrayList();
            long position = this.source.getPosition();
            this.source.seek(6L);
            char[] charArray = " obj".toCharArray();
            while (!this.source.isEOF()) {
                if (m32674G(f60014t)) {
                    ...
                    if (j > -1) {
                        this.f60031o.add(Long.valueOf(j));
                    }
    ...
    /* renamed from: u */
    public final void m32647u() {
        if (this.f60030n == null) {
            this.f60030n = new ArrayList();
            long position = this.source.getPosition();
            this.source.seek(6L);
            while (!this.source.isEOF()) {
                if (m32674G(f60013s)) {
                    ...
                    if (isWhitespace()) {
                        this.f60030n.add(Long.valueOf(position2));
                    }
    ...
    /* renamed from: v */
    public final long m32646v(long j, boolean z) {
        if (j < 0) {
            StringBuilder sb = new StringBuilder();
    ...
    /* renamed from: w */
    public final int m32645w(COSDictionary cOSDictionary, Set set) {
    ...
    /* renamed from: x */
    public final long m32644x(long j) {
        if (!this.f60026j) {
            return j;
        }
        this.source.seek(j);
        skipSpaces();
        if (this.source.peek() == 120 && m32674G(f60013s)) {
            return j;
        }
        if (j > 0) {
            if (m32643y(j)) {
            ...
            return m32646v(j, false);
        }
        return -1L;
    }

    /* renamed from: y */
    public final boolean m32643y(long j) {
        if (!this.f60026j || j == 0) {
            return true;
        }
    ...
    /* renamed from: z */
    public final void m32642z() {
        if (!this.f60026j) {
            return;
        }
        Map<COSObjectKey, Long> xrefTable = this.xrefTrailerResolver.getXrefTable();
        if (!m32657X(xrefTable)) {
            m32651q();
            Map map = this.f60028l;
            if (map != null && !map.isEmpty()) {
                xrefTable.clear();
                xrefTable.putAll(this.f60028l);
            }
        }
    }
    ...
    public COSBase parseObjectDynamically(long j, int i, boolean z) throws IOException {
        ...
        if (objectFromPool.getObject() == null) {
            ...
            if (l == null && this.f60026j && (map = this.f60028l) != null && (l = (Long) map.get(cOSObjectKey)) != null) {
                StringBuilder sb = new StringBuilder();
            ...
            if (l == null && this.f60026j && this.f60028l == null) {
                m32651q();
                Map map2 = this.f60028l;
            ...
            if (l == null) {
                ...
                m32672I(l, cOSObjectKey, objectFromPool);
            } else {
                m32670K((int) (-l.longValue()));
            }
        }
