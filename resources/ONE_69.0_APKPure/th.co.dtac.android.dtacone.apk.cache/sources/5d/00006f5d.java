...
public final class EmojiInputConnection extends InputConnectionWrapper {
    ...
    /* renamed from: b */
    public final EmojiCompatDeleteHelper f35371b;
    ...
    /* renamed from: a */
    public final Editable m54569a() {
        return this.f35370a.getEditableText();
    }

    @Override // android.view.inputmethod.InputConnectionWrapper, android.view.inputmethod.InputConnection
    public boolean deleteSurroundingText(int i, int i2) {
        if (!this.f35371b.handleDeleteSurroundingText(this, m54569a(), i, i2, false) && !super.deleteSurroundingText(i, i2)) {
            return false;
        }
        return true;
    }
    ...
    public boolean deleteSurroundingTextInCodePoints(int i, int i2) {
        if (!this.f35371b.handleDeleteSurroundingText(this, m54569a(), i, i2, true) && !super.deleteSurroundingTextInCodePoints(i, i2)) {
            return false;
        }
        return true;
    }
    ...
    public EmojiInputConnection(TextView textView, InputConnection inputConnection, EditorInfo editorInfo, EmojiCompatDeleteHelper emojiCompatDeleteHelper) {
        ...
        this.f35370a = textView;
        this.f35371b = emojiCompatDeleteHelper;
