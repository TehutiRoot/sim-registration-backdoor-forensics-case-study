...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.tol.screen.inputInfo.InputInfoScreenKt$InvoiceChannelSection$1$1$1 */
/* loaded from: classes10.dex */
public final class InputInfoScreenKt$InvoiceChannelSection$1$1$1 extends Lambda implements Function1<Boolean, Unit> {
    final /* synthetic */ CustomerInfoInvoiceChannel $channel;
    ...
    public InputInfoScreenKt$InvoiceChannelSection$1$1$1(Function1<? super CustomerInformation, Unit> function1, CustomerInformation customerInformation, CustomerInfoInvoiceChannel customerInfoInvoiceChannel) {
        super(1);
        this.$onCustomerInfoChange = function1;
        this.$customerInfo = customerInformation;
        this.$channel = customerInfoInvoiceChannel;
    }
