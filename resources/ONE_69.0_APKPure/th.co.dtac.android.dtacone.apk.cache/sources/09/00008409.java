...
public class MethodInvoker {
    ...
    public static abstract class TypedMethodInvoker<T> {
        ...
        public boolean invoke(Object obj, String str, String str2) {
            try {
                ...
                LogUtil.m49788w("IllegalAccessException: " + e.getMessage());
                return false;
            } catch (IllegalArgumentException e2) {
                LogUtil.m49788w("IllegalArgumentException: " + e2.getMessage());
                return false;
            } catch (NoSuchMethodException unused) {
                return false;
            } catch (InvocationTargetException e3) {
                LogUtil.m49788w("InvocationTargetException: " + e3.getMessage());
                return false;
            }
        }
    }
    ...
    public void invoke(Object obj, String str, String str2) {
        ...
        LogUtil.m49788w("Method with name " + str + " not found for any of the MethodInvoker supported argument types.");
    }
}