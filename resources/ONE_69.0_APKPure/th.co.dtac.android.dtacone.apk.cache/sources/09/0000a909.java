...
public abstract class ForwardingNavigableMap<K, V> extends ForwardingSortedMap<K, V> implements NavigableMap<K, V> {
    ...
    /* loaded from: classes4.dex */
    public class StandardDescendingMap extends Maps.AbstractC7754p {

        /* renamed from: com.google.common.collect.ForwardingNavigableMap$StandardDescendingMap$a */
        /* loaded from: classes4.dex */
        public class C7599a implements Iterator {

            /* renamed from: a */
            public Map.Entry f53127a = null;

            /* renamed from: b */
            public Map.Entry f53128b;

            public C7599a() {
                this.f53128b = StandardDescendingMap.this.mo40359f().lastEntry();
            }

            @Override // java.util.Iterator
            /* renamed from: a */
            public Map.Entry next() {
                Map.Entry entry = this.f53128b;
                if (entry != null) {
                    this.f53127a = entry;
                    this.f53128b = StandardDescendingMap.this.mo40359f().lowerEntry(this.f53128b.getKey());
                    return entry;
                }
            ...
            public void remove() {
                if (this.f53127a != null) {
                    StandardDescendingMap.this.mo40359f().remove(this.f53127a.getKey());
                    this.f53127a = null;
                    return;
                }
    ...
    /* loaded from: classes4.dex */
    public class StandardNavigableKeySet extends Maps.C7724B {
    ...
    public K standardCeilingKey(K k) {
        return (K) Maps.m40673x(ceilingEntry(k));
    }
    ...
    public K standardFloorKey(K k) {
        return (K) Maps.m40673x(floorEntry(k));
    }
    ...
    public K standardHigherKey(K k) {
        return (K) Maps.m40673x(higherEntry(k));
    }
    ...
    public K standardLowerKey(K k) {
        return (K) Maps.m40673x(lowerEntry(k));
    }

    @CheckForNull
    public Map.Entry<K, V> standardPollFirstEntry() {
        return (Map.Entry) Iterators.m40823j(entrySet().iterator());
    }

    @CheckForNull
    public Map.Entry<K, V> standardPollLastEntry() {
        return (Map.Entry) Iterators.m40823j(descendingMap().entrySet().iterator());
    }
