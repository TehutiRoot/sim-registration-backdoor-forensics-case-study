...
public final class FloatingActionButtonKt$ExtendedFloatingActionButton$5 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        float m71179getContainerWidthD9Ej5fM;
        ...
        if (this.$expanded) {
            m73842constructorimpl = FloatingActionButtonKt.f25895a;
        } else {
            m73842constructorimpl = C3623Dp.m73842constructorimpl(0);
        }
        float f = m73842constructorimpl;
        if (this.$expanded) {
            m73842constructorimpl2 = FloatingActionButtonKt.f25897c;
        } else {
            m73842constructorimpl2 = C3623Dp.m73842constructorimpl(0);
        }
        float f2 = m73842constructorimpl2;
        Modifier.Companion companion = Modifier.Companion;
        if (this.$expanded) {
            m71179getContainerWidthD9Ej5fM = FloatingActionButtonKt.f25898d;
        } else {
            m71179getContainerWidthD9Ej5fM = FabPrimaryTokens.INSTANCE.m71179getContainerWidthD9Ej5fM();
        }
        Modifier m69717paddingqDBjuR0$default = PaddingKt.m69717paddingqDBjuR0$default(SizeKt.m69752sizeInqDBjuR0$default(companion, m71179getContainerWidthD9Ej5fM, 0.0f, 0.0f, 0.0f, 14, null), f, 0.0f, f2, 0.0f, 10, null);
        ...
        enterTransition = FloatingActionButtonKt.f25900f;
        exitTransition = FloatingActionButtonKt.f25899e;
