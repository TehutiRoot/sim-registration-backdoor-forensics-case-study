...
public final class FlowableConcatMapCompletable<T> extends Completable {
    ...
    /* renamed from: a */
    public final Flowable f64980a;

    /* renamed from: b */
    public final Function f64981b;

    /* renamed from: c */
    public final ErrorMode f64982c;
    ...
    public FlowableConcatMapCompletable(Flowable<T> flowable, Function<? super T, ? extends CompletableSource> function, ErrorMode errorMode, int i) {
        this.f64980a = flowable;
        this.f64981b = function;
        this.f64982c = errorMode;
        this.f64983d = i;
    }

    @Override // io.reactivex.Completable
    public void subscribeActual(CompletableObserver completableObserver) {
        this.f64980a.subscribe((FlowableSubscriber) new ConcatMapCompletableObserver(completableObserver, this.f64981b, this.f64982c, this.f64983d));
    }
}