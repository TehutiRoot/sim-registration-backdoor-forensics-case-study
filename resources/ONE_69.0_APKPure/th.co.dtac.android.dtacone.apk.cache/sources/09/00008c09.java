...
public abstract class GmsClient<T extends IInterface> extends BaseGmsClient<T> implements Api.Client, zaj {
    ...
    /* renamed from: C */
    public final ClientSettings f45102C;

    /* renamed from: D */
    public final Set f45103D;

    /* renamed from: E */
    public final Account f45104E;
    ...
    public GmsClient(@NonNull Context context, @NonNull Handler handler, int i, @NonNull ClientSettings clientSettings) {
        ...
        this.f45102C = (ClientSettings) Preconditions.checkNotNull(clientSettings);
        this.f45104E = clientSettings.getAccount();
        this.f45103D = m48408o(clientSettings.getAllRequestedScopes());
    }
    ...
    /* renamed from: o */
    public final Set m48408o(Set set) {
    ...
    public GmsClient(@NonNull Context context, @NonNull Looper looper, @NonNull GmsClientSupervisor gmsClientSupervisor, @NonNull GoogleApiAvailability googleApiAvailability, int i, @NonNull ClientSettings clientSettings, @Nullable ConnectionCallbacks connectionCallbacks, @Nullable OnConnectionFailedListener onConnectionFailedListener) {
        super(context, looper, gmsClientSupervisor, googleApiAvailability, i, connectionCallbacks == null ? null : new C6342a(connectionCallbacks), onConnectionFailedListener == null ? null : new C6343b(onConnectionFailedListener), clientSettings.zac());
        this.f45102C = clientSettings;
        this.f45104E = clientSettings.getAccount();
        this.f45103D = m48408o(clientSettings.getAllRequestedScopes());
    }
}