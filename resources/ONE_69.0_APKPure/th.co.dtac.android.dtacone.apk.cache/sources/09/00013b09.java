...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.pre2post.fragment.form.OnePre2PostInputIdNumberFormFragment$setupObserve$1$2 */
/* loaded from: classes10.dex */
public final class OnePre2PostInputIdNumberFormFragment$setupObserve$1$2 extends Lambda implements Function1<Resource<? extends OneCheck1IDXDeviceResponse>, Unit> {
    final /* synthetic */ OnePre2PostInputIdNumberFormFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePre2PostInputIdNumberFormFragment$setupObserve$1$2(OnePre2PostInputIdNumberFormFragment onePre2PostInputIdNumberFormFragment) {
        super(1);
    ...
    public final void invoke2(Resource<OneCheck1IDXDeviceResponse> resource) {
        ...
        if (resourceContentIfNotHandled.getStatus() == StatusResource.SUCCESS) {
            onePre2PostInputIdNumberFormFragment.dismissSecondaryLoading();
            ...
            onePre2PostInputIdNumberFormFragment.m11091D(str2, str);
        }
    }
}