...
@Metadata(m29143d1 = {"\u0000\u0014\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\u001a\u0018\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u0000¨\u0006\u0006"}, m29142d2 = {"LazyLayoutSemanticState", "Landroidx/compose/foundation/lazy/layout/LazyLayoutSemanticState;", RemoteConfigConstants.ResponseFieldKey.STATE, "Landroidx/compose/foundation/pager/PagerState;", "isVertical", "", "foundation_release"}, m29141k = 2, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    public static final LazyLayoutSemanticState LazyLayoutSemanticState(@NotNull final PagerState state, final boolean z) {
        ...
        return new LazyLayoutSemanticState() { // from class: androidx.compose.foundation.pager.LazyLayoutSemanticStateKt$LazyLayoutSemanticState$1
            ...
            public Object scrollToItem(int i, @NotNull Continuation<? super Unit> continuation) {
                ...
                if (scrollToPage$default == AbstractC19782eg0.getCOROUTINE_SUSPENDED()) {
