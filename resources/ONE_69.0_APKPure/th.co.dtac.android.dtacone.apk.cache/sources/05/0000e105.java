...
public final class OverridingUtilTypeSystemContext implements ClassicTypeSystemContext {
    ...
    /* renamed from: a */
    public final Map f69920a;

    /* renamed from: b */
    public final KotlinTypeChecker.TypeConstructorEquality f69921b;

    /* renamed from: c */
    public final KotlinTypeRefiner f69922c;

    /* renamed from: d */
    public final KotlinTypePreparator f69923d;

    /* renamed from: e */
    public final Function2 f69924e;
    ...
    public OverridingUtilTypeSystemContext(@Nullable Map<TypeConstructor, ? extends TypeConstructor> map, @NotNull KotlinTypeChecker.TypeConstructorEquality equalityAxioms, @NotNull KotlinTypeRefiner kotlinTypeRefiner, @NotNull KotlinTypePreparator kotlinTypePreparator, @Nullable Function2<? super KotlinType, ? super KotlinType, Boolean> function2) {
        ...
        this.f69920a = map;
        this.f69921b = equalityAxioms;
        this.f69922c = kotlinTypeRefiner;
        this.f69923d = kotlinTypePreparator;
        this.f69924e = function2;
    }

    /* renamed from: a */
    public final boolean m28052a(TypeConstructor typeConstructor, TypeConstructor typeConstructor2) {
        if (this.f69921b.equals(typeConstructor, typeConstructor2)) {
            return true;
        }
        Map map = this.f69920a;
        if (map == null) {
            return false;
        }
        TypeConstructor typeConstructor3 = (TypeConstructor) map.get(typeConstructor);
        TypeConstructor typeConstructor4 = (TypeConstructor) this.f69920a.get(typeConstructor2);
    ...
    public boolean areEqualTypeConstructors(@NotNull TypeConstructorMarker c1, @NotNull TypeConstructorMarker c2) {
        ...
        if (c1 instanceof TypeConstructor) {
            if (c2 instanceof TypeConstructor) {
                if (!ClassicTypeSystemContext.DefaultImpls.areEqualTypeConstructors(this, c1, c2) && !m28052a((TypeConstructor) c1, (TypeConstructor) c2)) {
                    return false;
                }
                return true;
            }
    ...
    public TypeCheckerState newTypeCheckerState(final boolean z, final boolean z2) {
        if (this.f69924e == null) {
            return ClassicTypeCheckerStateKt.createClassicTypeCheckerState(z, z2, this, this.f69923d, this.f69922c);
        }
        final KotlinTypePreparator kotlinTypePreparator = this.f69923d;
        final KotlinTypeRefiner kotlinTypeRefiner = this.f69922c;
        return new TypeCheckerState(z, z2, this, kotlinTypePreparator, kotlinTypeRefiner) { // from class: kotlin.reflect.jvm.internal.impl.resolve.OverridingUtilTypeSystemContext$newTypeCheckerState$1
            ...
            /* renamed from: k */
            public final /* synthetic */ OverridingUtilTypeSystemContext f69925k;
            ...
            public boolean customIsSubtypeOf(@NotNull KotlinTypeMarker subType, @NotNull KotlinTypeMarker superType) {
                ...
                if (subType instanceof KotlinType) {
                    if (superType instanceof KotlinType) {
                        function2 = this.f69925k.f69924e;
