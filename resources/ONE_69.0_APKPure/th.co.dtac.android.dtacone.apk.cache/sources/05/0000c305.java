...
public class PDThread implements COSObjectable {
    ...
    /* renamed from: a */
    public COSDictionary f60747a;

    public PDThread(COSDictionary cOSDictionary) {
        this.f60747a = cOSDictionary;
    }

    public PDThreadBead getFirstBead() {
        COSDictionary cOSDictionary = (COSDictionary) this.f60747a.getDictionaryObject("F");
    ...
    public PDDocumentInformation getThreadInfo() {
        COSDictionary cOSDictionary = (COSDictionary) this.f60747a.getDictionaryObject("I");
        if (cOSDictionary != null) {
    ...
    public void setFirstBead(PDThreadBead pDThreadBead) {
        ...
        this.f60747a.setItem("F", pDThreadBead);
    }

    public void setThreadInfo(PDDocumentInformation pDDocumentInformation) {
        this.f60747a.setItem("I", pDDocumentInformation);
    }
