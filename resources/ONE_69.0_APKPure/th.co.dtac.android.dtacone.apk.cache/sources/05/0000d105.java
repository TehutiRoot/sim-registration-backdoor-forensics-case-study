...
public final class CompletableAndThenObservable<R> extends Observable<R> {
    ...
    /* renamed from: a */
    public final CompletableSource f64976a;

    /* renamed from: b */
    public final ObservableSource f64977b;
    ...
    public CompletableAndThenObservable(CompletableSource completableSource, ObservableSource<? extends R> observableSource) {
        this.f64976a = completableSource;
        this.f64977b = observableSource;
    }

    @Override // io.reactivex.Observable
    public void subscribeActual(Observer<? super R> observer) {
        AndThenObservableObserver andThenObservableObserver = new AndThenObservableObserver(observer, this.f64977b);
        observer.onSubscribe(andThenObservableObserver);
        this.f64976a.subscribe(andThenObservableObserver);
    }
}