...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_prepaid_registration.MrtrPrepaidRegistrationViewModel$getAuthorizationByRTR$2 */
/* loaded from: classes9.dex */
public final class MrtrPrepaidRegistrationViewModel$getAuthorizationByRTR$2 extends Lambda implements Function1<GetAuthorizationByRtrResponse, Unit> {
    final /* synthetic */ MrtrPrepaidRegistrationViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrPrepaidRegistrationViewModel$getAuthorizationByRTR$2(MrtrPrepaidRegistrationViewModel mrtrPrepaidRegistrationViewModel) {
        super(1);
    ...
    public final void invoke2(GetAuthorizationByRtrResponse getAuthorizationByRtrResponse) {
        ...
        mrtrPrepaidRepository.setRequireFaceRecognition(getAuthorizationByRtrResponse.getRequireFaceRecognition());
        mrtrPrepaidRepository2 = this.this$0.f106723b;
        Boolean isCheckSim = getAuthorizationByRtrResponse.isCheckSim();
        mrtrPrepaidRepository2.setCheckSimStock(isCheckSim != null ? isCheckSim.booleanValue() : false);
    }
}