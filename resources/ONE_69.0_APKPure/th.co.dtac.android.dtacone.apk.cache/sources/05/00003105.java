...
@Metadata(m29143d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m29142d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_landslide", "Landroidx/compose/material/icons/Icons$Filled;", "getLandslide", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "Landslide", "material-icons-extended_release"}, m29141k = 2, m29140mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nLandslide.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Landslide.kt\nandroidx/compose/material/icons/filled/LandslideKt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,78:1\n122#2:79\n116#2,3:80\n119#2,3:84\n132#2,18:87\n152#2:124\n132#2,18:125\n152#2:162\n132#2,18:163\n152#2:200\n132#2,18:201\n152#2:238\n132#2,18:239\n152#2:276\n174#3:83\n694#4,2:105\n706#4,2:107\n708#4,11:113\n694#4,2:143\n706#4,2:145\n708#4,11:151\n694#4,2:181\n706#4,2:183\n708#4,11:189\n694#4,2:219\n706#4,2:221\n708#4,11:227\n694#4,2:257\n706#4,2:259\n708#4,11:265\n64#5,4:109\n64#5,4:147\n64#5,4:185\n64#5,4:223\n64#5,4:261\n*S KotlinDebug\n*F\n+ 1 Landslide.kt\nandroidx/compose/material/icons/filled/LandslideKt\n*L\n29#1:79\n29#1:80,3\n29#1:84,3\n30#1:87,18\n30#1:124\n39#1:125,18\n39#1:162\n47#1:163,18\n47#1:200\n55#1:201,18\n55#1:238\n64#1:239,18\n64#1:276\n29#1:83\n30#1:105,2\n30#1:107,2\n30#1:113,11\n39#1:143,2\n39#1:145,2\n39#1:151,11\n47#1:181,2\n47#1:183,2\n47#1:189,11\n55#1:219,2\n55#1:221,2\n55#1:227,11\n64#1:257,2\n64#1:259,2\n64#1:265,11\n30#1:109,4\n39#1:147,4\n47#1:185,4\n55#1:223,4\n64#1:261,4\n*E\n"})
/* loaded from: classes.dex */
public final class LandslideKt {

    /* renamed from: a */
    public static ImageVector f15819a;

    @NotNull
    public static final ImageVector getLandslide(@NotNull Icons.Filled filled) {
        Intrinsics.checkNotNullParameter(filled, "<this>");
        ImageVector imageVector = f15819a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Landslide", C3623Dp.m73842constructorimpl(24.0f), C3623Dp.m73842constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder2.lineToRelative(-2.57f, -3.42f);
        pathBuilder2.lineToRelative(-6.0f, 0.0f);
        pathBuilder2.lineToRelative(0.0f, 3.61f);
        pathBuilder2.lineToRelative(4.0f, 1.34f);
        pathBuilder2.close();
        ...
        pathBuilder3.lineToRelative(0.0f, 4.28f);
        pathBuilder3.lineToRelative(20.0f, 0.0f);
        pathBuilder3.lineToRelative(-4.97f, -6.62f);
        pathBuilder3.close();
        ...
        pathBuilder4.moveTo(17.0f, 6.0f);
        pathBuilder4.lineToRelative(0.0f, -5.0f);
        pathBuilder4.lineToRelative(-5.0f, -1.0f);
        pathBuilder4.lineToRelative(-3.0f, 2.0f);
        ...
        pathBuilder5.lineToRelative(-2.5f, 2.0f);
        pathBuilder5.lineToRelative(0.0f, 3.0f);
        pathBuilder5.lineToRelative(2.5f, 2.0f);
        pathBuilder5.lineToRelative(4.5f, -2.0f);
