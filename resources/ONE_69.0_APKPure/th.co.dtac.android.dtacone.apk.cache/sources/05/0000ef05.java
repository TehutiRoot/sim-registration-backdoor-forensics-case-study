...
public class Lang {
    ...
    /* renamed from: c */
    public static final Map f73259c = new EnumMap(NameType.class);

    /* renamed from: a */
    public final Languages f73260a;
    ...
    public static final class C12497b {
        ...
        /* renamed from: b */
        public final Set f73263b;

        /* renamed from: c */
        public final Pattern f73264c;

        /* renamed from: c */
        public boolean m25694c(String str) {
            return this.f73264c.matcher(str).find();
        }

        public C12497b(Pattern pattern, Set set, boolean z) {
            this.f73264c = pattern;
            this.f73263b = set;
            this.f73262a = z;
        }
    }
    ...
    static {
        ...
        for (NameType nameType : NameType.values()) {
            f73259c.put(nameType, loadFromResource(String.format("org/apache/commons/codec/language/bm/%s_lang.txt", nameType.getName()), Languages.getInstance(nameType)));
        }
    }

    public Lang(List list, Languages languages) {
        this.f73261b = Collections.unmodifiableList(list);
        this.f73260a = languages;
    }

    /* renamed from: a */
    public static /* synthetic */ void m25698a(String str, Set set, C12497b c12497b) {
        m25697b(str, set, c12497b);
    }

    /* renamed from: b */
    public static /* synthetic */ void m25697b(String str, Set set, C12497b c12497b) {
        if (c12497b.m25694c(str)) {
            if (c12497b.f73262a) {
                set.retainAll(c12497b.f73263b);
            } else {
                set.removeAll(c12497b.f73263b);
            }
        }
    }

    public static Lang instance(NameType nameType) {
        return (Lang) f73259c.get(nameType);
    }
    ...
    */
    public static org.apache.commons.codec.language.p027bm.Lang loadFromResource(java.lang.String r9, org.apache.commons.codec.language.p027bm.Languages r10) {
        /*
            ...
            java.lang.String r3 = p000.AbstractC23297yy1.f109227a
            r1.<init>(r2, r3)
            r2 = 0
        L11:
            r3 = 0
    ...
    public Languages.LanguageSet guessLanguages(String str) {
        ...
        final HashSet hashSet = new HashSet(this.f73260a.getLanguages());
        this.f73261b.forEach(new Consumer() { // from class: Zh0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                Lang.m25698a(lowerCase, hashSet, (Lang.C12497b) obj);
            }
        });
