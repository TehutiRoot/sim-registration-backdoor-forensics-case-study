...
public final class AnimatedVisibilityKt {
    ...
    */
    ...
    /* renamed from: a */
    public static final void m61699a(Transition transition, Function1 function1, Modifier modifier, EnterTransition enterTransition, ExitTransition exitTransition, Function3 function3, Composer composer, int i) {
        int i2;
        ...
        if ((374491 & i9) == 74898 && startRestartGroup.getSkipping()) {
            ...
            if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                rememberedValue = AbstractC19036aL1.m65148g(function1.invoke(transition.getCurrentState()), null, 2, null);
            ...
            if (!((Boolean) function1.invoke(transition.getTargetState())).booleanValue() && !((Boolean) mutableState2.getValue()).booleanValue() && !transition.isSeeking()) {
                ...
                EnterExitState m61698b = m61698b(transition, function1, rememberedValue2, startRestartGroup, i12);
                if (ComposerKt.isTraceInProgress()) {
                ...
                EnterExitState m61698b2 = m61698b(transition, function1, targetState, startRestartGroup, i12);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                startRestartGroup.endReplaceableGroup();
                MutableState mutableState3 = mutableState;
                Transition createChildTransitionInternal = androidx.compose.animation.core.TransitionKt.createChildTransitionInternal(transition, m61698b, m61698b2, "EnterExitTransition", startRestartGroup, i11 | 3072);
                startRestartGroup.endReplaceableGroup();
    ...
    /* renamed from: b */
    public static final EnterExitState m61698b(Transition transition, Function1 function1, Object obj, Composer composer, int i) {
