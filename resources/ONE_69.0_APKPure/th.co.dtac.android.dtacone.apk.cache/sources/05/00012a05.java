...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.buyDol.fragment.OneBuyDolPaymentInfoFragment$setObserve$2 */
/* loaded from: classes10.dex */
public final class OneBuyDolPaymentInfoFragment$setObserve$2 extends Lambda implements Function1<Resource<? extends String>, Unit> {
    final /* synthetic */ OneBuyDolPaymentInfoFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneBuyDolPaymentInfoFragment$setObserve$2(OneBuyDolPaymentInfoFragment oneBuyDolPaymentInfoFragment) {
        super(1);
    ...
    public final void invoke2(Resource<String> resource) {
        ...
        if (resourceContentIfNotHandled.getStatus() == StatusResource.SUCCESS) {
            ...
            if (data == null) {
                data = OneBuyDolCreditCardFragment.LIST_VIEW_MODE;
            }
            oneBuyDolPaymentInfoFragment.f88434i = data;
        }
    }
}