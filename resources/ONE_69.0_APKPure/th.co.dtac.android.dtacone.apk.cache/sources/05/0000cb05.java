...
public final class CameraView extends FrameLayout implements CameraRenderer {
    ...
    /* renamed from: a */
    public static /* synthetic */ void m30813a(CameraView cameraView, Resolution resolution) {
        m30812b(cameraView, resolution);
    }

    /* renamed from: b */
    public static final void m30812b(CameraView this$0, Resolution resolution) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(resolution, "$resolution");
        this$0.f63110c = resolution;
    ...
    private final Preview.Texture getPreviewAfterLatch() {
        ...
        this.f63108a.await();
        SurfaceTexture surfaceTexture = this.f63112e;
    ...
    /* renamed from: c */
    public final SurfaceTexture m30811c(TextureView textureView) {
    ...
    public void setPreviewResolution(@NotNull final Resolution resolution) {
        ...
        post(new Runnable() { // from class: pk
            ...
            public final void run() {
                CameraView.m30813a(CameraView.this, resolution);
            }
        });
    }
    ...
    public CameraView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        this.f63108a = new CountDownLatch(1);
        TextureView textureView = new TextureView(context);
        this.f63109b = textureView;
        this.f63112e = m30811c(textureView);
        addView(textureView);
    }
}