...
public class RFC2965Spec extends RFC2109Spec {
    ...
    /* renamed from: c */
    public static CookieOrigin m24790c(CookieOrigin cookieOrigin) {
    ...
    /* renamed from: d */
    public final List m24789d(HeaderElement[] headerElementArr, CookieOrigin cookieOrigin) {
    ...
    public boolean match(Cookie cookie, CookieOrigin cookieOrigin) {
        ...
        return super.match(cookie, m24790c(cookieOrigin));
    }
    ...
    public List<Cookie> parse(Header header, CookieOrigin cookieOrigin) throws MalformedCookieException {
        ...
        if (header.getName().equalsIgnoreCase("Set-Cookie2")) {
            return m24789d(header.getElements(), m24790c(cookieOrigin));
        }
    ...
    public void validate(Cookie cookie, CookieOrigin cookieOrigin) throws MalformedCookieException {
        Args.notNull(cookie, "Cookie");
        Args.notNull(cookieOrigin, "Cookie origin");
        super.validate(cookie, m24790c(cookieOrigin));
    }

    public RFC2965Spec(String[] strArr, boolean z) {
        super(z, new RFC2965VersionAttributeHandler(), new C12606a(), new RFC2965DomainAttributeHandler(), new RFC2965PortAttributeHandler(), new BasicMaxAgeHandler(), new BasicSecureHandler(), new BasicCommentHandler(), new BasicExpiresHandler(strArr != null ? (String[]) strArr.clone() : RFC2109Spec.f74457c), new RFC2965CommentUrlAttributeHandler(), new RFC2965DiscardAttributeHandler());
    }
    ...
    public List<Cookie> parse(HeaderElement[] headerElementArr, CookieOrigin cookieOrigin) throws MalformedCookieException {
        return m24789d(headerElementArr, m24790c(cookieOrigin));
    }
}