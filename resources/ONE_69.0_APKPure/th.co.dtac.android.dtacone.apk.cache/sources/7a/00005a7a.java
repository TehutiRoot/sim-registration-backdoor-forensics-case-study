...
public final class SliderKt$RangeSlider$5 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public SliderKt$RangeSlider$5(ClosedFloatingPointRange<Float> closedFloatingPointRange, Function1<? super ClosedFloatingPointRange<Float>, Unit> function1, Modifier modifier, boolean z, ClosedFloatingPointRange<Float> closedFloatingPointRange2, int i, Function0<Unit> function0, SliderColors sliderColors, int i2, int i3) {
        super(2);
