...
public final class DateTime extends GeneratedMessageLite<DateTime, Builder> implements DateTimeOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<DateTime, Builder> implements DateTimeOrBuilder {
        public /* synthetic */ Builder(C8987a c8987a) {
            this();
        }

        public Builder clearDay() {
            copyOnWrite();
            ((DateTime) this.instance).m34448X();
            return this;
        }

        public Builder clearHours() {
            copyOnWrite();
            ((DateTime) this.instance).m34447Y();
            return this;
        }

        public Builder clearMinutes() {
            copyOnWrite();
            ((DateTime) this.instance).m34446Z();
            return this;
        }

        public Builder clearMonth() {
            copyOnWrite();
            ((DateTime) this.instance).m34445a0();
            return this;
        }

        public Builder clearNanos() {
            copyOnWrite();
            ((DateTime) this.instance).m34444b0();
            return this;
        }

        public Builder clearSeconds() {
            copyOnWrite();
            ((DateTime) this.instance).m34443c0();
            return this;
        }

        public Builder clearTimeOffset() {
            copyOnWrite();
            ((DateTime) this.instance).m34442d0();
            return this;
        }

        public Builder clearTimeZone() {
            copyOnWrite();
            ((DateTime) this.instance).m34441e0();
            return this;
        }

        public Builder clearUtcOffset() {
            copyOnWrite();
            ((DateTime) this.instance).m34440f0();
            return this;
        }

        public Builder clearYear() {
            copyOnWrite();
            ((DateTime) this.instance).m34439g0();
            return this;
        }
        ...
        public Builder mergeTimeZone(TimeZone timeZone) {
            copyOnWrite();
            ((DateTime) this.instance).m34438h0(timeZone);
            return this;
        }

        public Builder mergeUtcOffset(Duration duration) {
            copyOnWrite();
            ((DateTime) this.instance).m34437i0(duration);
            return this;
        }

        public Builder setDay(int i) {
            copyOnWrite();
            ((DateTime) this.instance).m34436j0(i);
            return this;
        }

        public Builder setHours(int i) {
            copyOnWrite();
            ((DateTime) this.instance).m34435k0(i);
            return this;
        }

        public Builder setMinutes(int i) {
            copyOnWrite();
            ((DateTime) this.instance).m34434l0(i);
            return this;
        }

        public Builder setMonth(int i) {
            copyOnWrite();
            ((DateTime) this.instance).m34433m0(i);
            return this;
        }

        public Builder setNanos(int i) {
            copyOnWrite();
            ((DateTime) this.instance).m34432n0(i);
            return this;
        }

        public Builder setSeconds(int i) {
            copyOnWrite();
            ((DateTime) this.instance).m34431o0(i);
            return this;
        }

        public Builder setTimeZone(TimeZone timeZone) {
            copyOnWrite();
            ((DateTime) this.instance).m34430p0(timeZone);
            return this;
        }

        public Builder setUtcOffset(Duration duration) {
            copyOnWrite();
            ((DateTime) this.instance).m34429q0(duration);
            return this;
        }

        public Builder setYear(int i) {
            copyOnWrite();
            ((DateTime) this.instance).m34428r0(i);
            return this;
        }
        ...
        public Builder setTimeZone(TimeZone.Builder builder) {
            copyOnWrite();
            ((DateTime) this.instance).m34430p0(builder.build());
            return this;
        }

        public Builder setUtcOffset(Duration.Builder builder) {
            copyOnWrite();
            ((DateTime) this.instance).m34429q0(builder.build());
            return this;
        }
    }
    ...
    /* loaded from: classes5.dex */
    public static /* synthetic */ class C8987a {
        ...
        static {
            ...
            try {
                f57569a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f57569a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f57569a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f57569a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f57569a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f57569a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: a0 */
    public void m34445a0() {
        this.month_ = 0;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: b0 */
    public void m34444b0() {
        this.nanos_ = 0;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: c0 */
    public void m34443c0() {
        this.seconds_ = 0;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: g0 */
    public void m34439g0() {
        this.year_ = 0;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: j0 */
    public void m34436j0(int i) {
        this.day_ = i;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: m0 */
    public void m34433m0(int i) {
        this.month_ = i;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: n0 */
    public void m34432n0(int i) {
        this.nanos_ = i;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: r0 */
    public void m34428r0(int i) {
        this.year_ = i;
    }

    /* renamed from: Y */
    public final void m34447Y() {
        this.hours_ = 0;
    }

    /* renamed from: Z */
    public final void m34446Z() {
        this.minutes_ = 0;
    }

    /* renamed from: d0 */
    public final void m34442d0() {
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C8987a.f57569a[methodToInvoke.ordinal()]) {
            case 1:
                return new DateTime();
            case 2:
    ...
    /* renamed from: h0 */
    public final void m34438h0(TimeZone timeZone) {
        timeZone.getClass();
    ...
    /* renamed from: i0 */
    public final void m34437i0(Duration duration) {
        duration.getClass();
    ...
    /* renamed from: k0 */
    public final void m34435k0(int i) {
        this.hours_ = i;
    }

    /* renamed from: l0 */
    public final void m34434l0(int i) {
        this.minutes_ = i;
    }

    /* renamed from: o0 */
    public final void m34431o0(int i) {
        this.seconds_ = i;
    }

    /* renamed from: p0 */
    public final void m34430p0(TimeZone timeZone) {
        timeZone.getClass();
        this.timeOffset_ = timeZone;
        this.timeOffsetCase_ = 9;
    }
    ...
    /* renamed from: q0 */
    public final void m34429q0(Duration duration) {
        duration.getClass();
        this.timeOffset_ = duration;
        this.timeOffsetCase_ = 8;
    }
