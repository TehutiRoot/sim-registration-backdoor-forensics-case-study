...
public class AsPropertyTypeDeserializer extends AsArrayTypeDeserializer {
    ...
    protected final JsonTypeInfo.EnumC6063As _inclusion;
    ...
    public AsPropertyTypeDeserializer(JavaType javaType, TypeIdResolver typeIdResolver, String str, boolean z, JavaType javaType2) {
        this(javaType, typeIdResolver, str, z, javaType2, JsonTypeInfo.EnumC6063As.PROPERTY);
    }
    ...
    @Override // com.fasterxml.jackson.databind.jsontype.impl.AsArrayTypeDeserializer, com.fasterxml.jackson.databind.jsontype.impl.TypeDeserializerBase, com.fasterxml.jackson.databind.jsontype.TypeDeserializer
    public JsonTypeInfo.EnumC6063As getTypeInclusion() {
        return this._inclusion;
    }

    public AsPropertyTypeDeserializer(JavaType javaType, TypeIdResolver typeIdResolver, String str, boolean z, JavaType javaType2, JsonTypeInfo.EnumC6063As enumC6063As) {
        super(javaType, typeIdResolver, str, z, javaType2);
        this._inclusion = enumC6063As;
    }
