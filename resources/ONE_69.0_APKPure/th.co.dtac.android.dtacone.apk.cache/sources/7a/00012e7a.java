...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.device_sale.fragment.OneDeviceSaleInputIMEIFragment$onStart$1$5 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleInputIMEIFragment$onStart$1$5 extends Lambda implements Function1<Resource<? extends Void>, Unit> {
    final /* synthetic */ OneDeviceSaleInputIMEIFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.device_sale.fragment.OneDeviceSaleInputIMEIFragment$onStart$1$5$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneDeviceSaleInputIMEIFragment$onStart$1$5(OneDeviceSaleInputIMEIFragment oneDeviceSaleInputIMEIFragment) {
        super(1);
    ...
    public final void invoke2(Resource<Void> resource) {
        ...
        if (ctx != null) {
            ...
            oneDeviceSaleInputIMEIFragment.getViewModel().showToastUpdatedVerify().postValue(new Event<>(toastMessage));
        }
        oneDeviceSaleInputIMEIFragment.dismissSecondaryLoading();
