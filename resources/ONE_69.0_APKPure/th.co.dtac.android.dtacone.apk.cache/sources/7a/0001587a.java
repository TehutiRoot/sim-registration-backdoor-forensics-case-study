...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_mnp.MrtrMnpValidateViewModel$getPostCodeInfo$1$1 */
/* loaded from: classes9.dex */
public final class MrtrMnpValidateViewModel$getPostCodeInfo$1$1 extends Lambda implements Function1<GetPostCodeInfoResponse, Unit> {
    final /* synthetic */ MrtrMnpValidateViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrMnpValidateViewModel$getPostCodeInfo$1$1(MrtrMnpValidateViewModel mrtrMnpValidateViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull GetPostCodeInfoResponse response) {
        ...
        if (!response.getData().isEmpty()) {
            ...
            mrtrMnpRepository.setPostCode(data.getPostcode());
            mrtrMnpRepository2 = mrtrMnpValidateViewModel.f106322b;
            mrtrMnpRepository2.setPostcodeSequenceString(String.valueOf(data.getPostcodeSequence()));
            mrtrMnpRepository3 = mrtrMnpValidateViewModel.f106322b;
            mrtrMnpRepository3.setProvinceCode(data.getProvinceCode());
        }
    }
}