...
/* renamed from: th.co.dtac.android.dtacone.view.fragment.mrtr_pre2post.MrtrPre2PostChooseWithDeviceFragment$onViewCreated$1 */
/* loaded from: classes9.dex */
public final class MrtrPre2PostChooseWithDeviceFragment$onViewCreated$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ MrtrPre2PostChooseWithDeviceFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrPre2PostChooseWithDeviceFragment$onViewCreated$1(MrtrPre2PostChooseWithDeviceFragment mrtrPre2PostChooseWithDeviceFragment) {
        super(0);
    ...
    public final void invoke2() {
        ...
        mrtrPre2PostViewModel.onSelectWithDevice();
        mrtrPre2PostViewModel.setWithDevice(true);
        ...
        ((MrtrPre2PostActivity) requireActivity).replaceFragment(new MrtrPre2PostChooseContractFragment(), Reflection.getOrCreateKotlinClass(MrtrPre2PostChooseContractFragment.class).getSimpleName());
    }
}