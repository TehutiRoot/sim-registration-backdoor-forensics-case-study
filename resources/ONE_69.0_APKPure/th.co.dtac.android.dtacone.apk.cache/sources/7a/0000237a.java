...
public final class BasicMarqueeKt {
    ...
    /* renamed from: b */
    public static final int f12882b = 1200;

    /* renamed from: c */
    public static final MarqueeSpacing f12883c = MarqueeSpacing.Companion.fractionOfContainer(0.33333334f);

    /* renamed from: d */
    public static final float f12884d = C3623Dp.m73842constructorimpl(30);

    /* renamed from: androidx.compose.foundation.BasicMarqueeKt$a */
    /* loaded from: classes.dex */
    public static final class C2752a implements MarqueeSpacing {

        /* renamed from: a */
        public final /* synthetic */ float f12885a;

        public C2752a(float f) {
            this.f12885a = f;
        }
        ...
        public final int calculateSpacing(Density MarqueeSpacing, int i, int i2) {
            ...
            return MarqueeSpacing.mo69616roundToPx0680j_4(this.f12885a);
        }
    }
    ...
    public static final MarqueeSpacing m69506MarqueeSpacing0680j_4(float f) {
        return new C2752a(f);
    }

    /* renamed from: a */
    public static final AnimationSpec m61568a(int i, float f, int i2, int i3, float f2, Density density) {
        TweenSpec m61567b = m61567b(Math.abs(density.mo69622toPx0680j_4(f2)), f, i3);
        long m69467constructorimpl$default = StartOffset.m69467constructorimpl$default((-i3) + i2, 0, 2, null);
        if (i == Integer.MAX_VALUE) {
            return AnimationSpecKt.m69448infiniteRepeatable9IiC70o$default(m61567b, null, m69467constructorimpl$default, 2, null);
        }
        return AnimationSpecKt.m69450repeatable91I0pcU$default(i, m61567b, null, m69467constructorimpl$default, 4, null);
    }

    /* renamed from: b */
    public static final TweenSpec m61567b(float f, float f2, int i) {
    ...
    public static final Modifier m69508basicMarquee1Mj1MLw(@NotNull Modifier basicMarquee, int i, int i2, int i3, int i4, @NotNull MarqueeSpacing spacing, float f) {
    ...
    public static /* synthetic */ Modifier m69509basicMarquee1Mj1MLw$default(Modifier modifier, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i = f12881a;
        }
        if ((i5 & 2) != 0) {
            i2 = MarqueeAnimationMode.Companion.m69563getImmediatelyZbEOnfQ();
        }
        int i6 = i2;
        if ((i5 & 4) != 0) {
            i3 = f12882b;
        ...
        int i7 = i3;
        if ((i5 & 8) != 0) {
            if (MarqueeAnimationMode.m69557equalsimpl0(i6, MarqueeAnimationMode.Companion.m69563getImmediatelyZbEOnfQ())) {
                i4 = i7;
            } else {
                i4 = 0;
            }
        ...
        int i8 = i4;
        if ((i5 & 16) != 0) {
            marqueeSpacing = f12883c;
        }
        MarqueeSpacing marqueeSpacing2 = marqueeSpacing;
        if ((i5 & 32) != 0) {
            f = f12884d;
        }
        return m69508basicMarquee1Mj1MLw(modifier, i, i6, i7, i8, marqueeSpacing2, f);
    }
