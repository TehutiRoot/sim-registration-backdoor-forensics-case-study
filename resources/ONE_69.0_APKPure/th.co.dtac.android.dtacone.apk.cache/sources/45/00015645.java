...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.esim.ESimPostpaidViewModel$checkSimStock$2 */
/* loaded from: classes9.dex */
public final class ESimPostpaidViewModel$checkSimStock$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ ESimPostpaidViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimPostpaidViewModel$checkSimStock$2(ESimPostpaidViewModel eSimPostpaidViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable it) {
        ...
        mrtrErrorService.handleException(it, new MrtrErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.viewmodel.esim.ESimPostpaidViewModel$checkSimStock$2.1
            ...
            public void handle(@Nullable Throwable th2) {
                ...
                m2802s0 = ESimPostpaidViewModel.this.m2802s0();
                m2802s0.setValue(Resource.Companion.success(errorCollection.getStatusCode()));
            }
