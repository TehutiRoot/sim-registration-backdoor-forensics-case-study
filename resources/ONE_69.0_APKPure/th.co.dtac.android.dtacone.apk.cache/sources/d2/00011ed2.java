...
public final class Owner {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof Owner) {
            ...
            return Intrinsics.areEqual(this.lastName, owner.lastName) && Intrinsics.areEqual(this.idType, owner.idType) && Intrinsics.areEqual(this.gender, owner.gender) && Intrinsics.areEqual(this.address2, owner.address2) && Intrinsics.areEqual(this.address1, owner.address1) && Intrinsics.areEqual(this.profileImage, owner.profileImage) && Intrinsics.areEqual(this.idNumber, owner.idNumber) && Intrinsics.areEqual(this.firstNameEnglish, owner.firstNameEnglish) && Intrinsics.areEqual(this.title, owner.title) && Intrinsics.areEqual(this.isSmartCard, owner.isSmartCard) && Intrinsics.areEqual(this.birthDate, owner.birthDate) && Intrinsics.areEqual(this.expiryDate, owner.expiryDate) && Intrinsics.areEqual(this.firstName, owner.firstName) && Intrinsics.areEqual(this.titleEnglish, owner.titleEnglish) && Intrinsics.areEqual(this.pictureID, owner.pictureID) && Intrinsics.areEqual(this.issueDate, owner.issueDate) && Intrinsics.areEqual(this.lastNameEnglish, owner.lastNameEnglish);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        String str15 = this.issueDate;
        String str16 = this.lastNameEnglish;
        return "Owner(lastName=" + str + ", idType=" + str2 + ", gender=" + str3 + ", address2=" + str4 + ", address1=" + str5 + ", profileImage=" + str6 + ", idNumber=" + str7 + ", firstNameEnglish=" + str8 + ", title=" + str9 + ", isSmartCard=" + bool + ", birthDate=" + str10 + ", expiryDate=" + str11 + ", firstName=" + str12 + ", titleEnglish=" + str13 + ", pictureID=" + str14 + ", issueDate=" + str15 + ", lastNameEnglish=" + str16 + ")";
    }

    public Owner(@Nullable String str, @Nullable String str2, @Nullable String str3, @Nullable String str4, @Nullable String str5, @Nullable String str6, @Nullable String str7, @Nullable String str8, @Nullable String str9, @Nullable Boolean bool, @Nullable String str10, @Nullable String str11, @Nullable String str12, @Nullable String str13, @Nullable String str14, @Nullable String str15, @Nullable String str16) {
        this.lastName = str;
        this.idType = str2;
        this.gender = str3;
        this.address2 = str4;
    ...
    public /* synthetic */ Owner(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, Boolean bool, String str10, String str11, String str12, String str13, String str14, String str15, String str16, int i, DefaultConstructorMarker defaultConstructorMarker) {
