...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.stvProSermOnline.fragment.OneProsermOnlineConfirmFragment$setupViewModel$9 */
/* loaded from: classes10.dex */
public final class OneProsermOnlineConfirmFragment$setupViewModel$9 extends Lambda implements Function1<Resource<? extends String>, Unit> {
    final /* synthetic */ OneProsermOnlineConfirmFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.stvProSermOnline.fragment.OneProsermOnlineConfirmFragment$setupViewModel$9$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneProsermOnlineConfirmFragment$setupViewModel$9(OneProsermOnlineConfirmFragment oneProsermOnlineConfirmFragment) {
        super(1);
    ...
    public final void invoke2(Resource<String> resource) {
        ...
        if (i == 1) {
            ...
            m9832q = oneProsermOnlineConfirmFragment.m9832q();
            if (data == null) {
                data = PermissionConstant.M_BUY_DOL;
            }
            m9832q.getPriceList(data);
        } else if (i == 2) {
