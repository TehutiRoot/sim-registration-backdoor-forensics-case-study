...
public final class LazyStaggeredGridMeasureKt {
    /* renamed from: a */
    public static final List m61107a(LazyStaggeredGridMeasureContext lazyStaggeredGridMeasureContext, ArrayDeque[] arrayDequeArr, int[] iArr, int i) {
        int i2;
        int i3 = 0;
            ...
            for (ArrayDeque arrayDeque2 : arrayDequeArr) {
                if (!arrayDeque2.isEmpty()) {
                    ...
                    if (lazyStaggeredGridMeasuredItem2.getLane() == i4) {
                        long m69847constructorimpl = SpanRange.m69847constructorimpl(lazyStaggeredGridMeasuredItem2.getLane(), lazyStaggeredGridMeasuredItem2.getSpan());
                        int m61103e = m61103e(iArr, m69847constructorimpl);
                        ...
                        if (lazyStaggeredGridMeasuredItem2.getPlaceablesCount() != 0) {
                            lazyStaggeredGridMeasuredItem2.position(m61103e, i7, i);
                            arrayList.add(lazyStaggeredGridMeasuredItem2);
                            int i8 = (int) (m69847constructorimpl & BodyPartID.bodyIdMax);
                            for (int i9 = (int) (m69847constructorimpl >> 32); i9 < i8; i9++) {
                                iArr[i9] = lazyStaggeredGridMeasuredItem2.getSizeWithSpacings() + m61103e;
                            }
                        }
                    }
                }
    ...
    /* renamed from: b */
    public static final void m61106b(LazyStaggeredGridMeasureContext lazyStaggeredGridMeasureContext, int[] iArr, int i) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                iArr[length] = m61105c(lazyStaggeredGridMeasureContext, iArr[length], length);
            }
    ...
    /* renamed from: c */
    public static final int m61105c(LazyStaggeredGridMeasureContext lazyStaggeredGridMeasureContext, int i, int i2) {
        return lazyStaggeredGridMeasureContext.getLaneInfo().findPreviousItemIndex(i, i2);
    }

    /* renamed from: d */
    public static final int m61104d(int[] iArr) {
    ...
    /* renamed from: e */
    public static final int m61103e(int[] iArr, long j) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:151:0x0300, code lost:
        if (m61100h(r13, r9, r8, r2) == false) goto L379;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:162:0x032f, code lost:
        return m61102f(r9, r27, r1, r3, false);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:164:0x033c, code lost:
        ...
        r40 = r14;
        r24 = r15;
        r14 = r9.m69840getSpanRangelOCCd4c(r37.getItemProvider(), r4, r2);
        r0 = r37.getLaneInfo();
        r23 = r3;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:168:0x036d, code lost:
        r0.setLane(r4, r11);
        r0 = r37.getMeasuredItemProvider().m69845getAndMeasurejy6DScQ(r4, r14);
        r11 = m61103e(r8, r14);
     */
    ...
    */
    public static final androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasureResult m61102f(androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasureContext r37, int r38, int[] r39, int[] r40, boolean r41) {
        /*
            Method dump skipped, instructions count: 2062
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasureKt.m61102f(androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasureContext, int, int[], int[], boolean):androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasureResult");
    }

    /* renamed from: g */
    public static final boolean m61101g(int[] iArr, int[] iArr2, LazyStaggeredGridMeasureContext lazyStaggeredGridMeasureContext) {
        int length = iArr.length;
    ...
    /* renamed from: h */
    public static final boolean m61100h(int[] iArr, LazyStaggeredGridMeasureContext lazyStaggeredGridMeasureContext, int[] iArr2, int i) {
        int length = iArr.length;
        for (int i2 = 0; i2 < length; i2++) {
            if (m61105c(lazyStaggeredGridMeasureContext, iArr[i2], i2) == -1 && iArr2[i2] != iArr2[i]) {
                return true;
            }
        }
        int length2 = iArr.length;
        for (int i3 = 0; i3 < length2; i3++) {
            if (m61105c(lazyStaggeredGridMeasureContext, iArr[i3], i3) != -1 && iArr2[i3] >= iArr2[i]) {
                return true;
            }
        }
    ...
    /* renamed from: i */
    public static final void m61099i(int[] iArr, int i) {
        int length = iArr.length;
        for (int i2 = 0; i2 < length; i2++) {
            iArr[i2] = iArr[i2] + i;
        }
