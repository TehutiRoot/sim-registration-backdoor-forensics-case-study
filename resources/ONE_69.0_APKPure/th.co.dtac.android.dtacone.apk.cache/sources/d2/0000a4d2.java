...
public final class MonitoredResource extends GeneratedMessageLite<MonitoredResource, Builder> implements MonitoredResourceOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<MonitoredResource, Builder> implements MonitoredResourceOrBuilder {
        ...
        public Builder clearLabels() {
            copyOnWrite();
            ((MonitoredResource) this.instance).m42471H().clear();
            return this;
        }

        public Builder clearType() {
            copyOnWrite();
            ((MonitoredResource) this.instance).m42472G();
            return this;
        }
        ...
        public Builder putAllLabels(Map<String, String> map) {
            copyOnWrite();
            ((MonitoredResource) this.instance).m42471H().putAll(map);
            return this;
        }
        ...
        public Builder putLabels(String str, String str2) {
            ...
            str2.getClass();
            copyOnWrite();
            ((MonitoredResource) this.instance).m42471H().put(str, str2);
            return this;
        }
        ...
        public Builder removeLabels(String str) {
            str.getClass();
            copyOnWrite();
            ((MonitoredResource) this.instance).m42471H().remove(str);
            return this;
        }

        public Builder setType(String str) {
            copyOnWrite();
            ((MonitoredResource) this.instance).m42468K(str);
            return this;
        }

        public Builder setTypeBytes(ByteString byteString) {
            copyOnWrite();
            ((MonitoredResource) this.instance).m42467L(byteString);
            return this;
        }
    ...
    /* loaded from: classes4.dex */
    public static final class C7222b {

        /* renamed from: a */
        public static final MapEntryLite f51648a;

        static {
            WireFormat.FieldType fieldType = WireFormat.FieldType.STRING;
            f51648a = MapEntryLite.newDefaultInstance(fieldType, "", fieldType, "");
        }
    }
    ...
    /* renamed from: I */
    private MapFieldLite m42470I() {
        return this.labels_;
    }

    /* renamed from: J */
    private MapFieldLite m42469J() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: K */
    public void m42468K(String str) {
        str.getClass();
        this.type_ = str;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: L */
    public void m42467L(ByteString byteString) {
    ...
    public boolean containsLabels(String str) {
        str.getClass();
        return m42470I().containsKey(str);
    }

    @Override // com.google.protobuf.GeneratedMessageLite
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C7221a.f51647a[methodToInvoke.ordinal()]) {
            case 1:
                return new MonitoredResource();
            case 2:
                return new Builder(null);
            case 3:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0002\u0002\u0001\u0000\u0000\u0001Ȉ\u00022", new Object[]{"type_", "labels_", C7222b.f51648a});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
    ...
    @Override // com.google.api.MonitoredResourceOrBuilder
    public Map<String, String> getLabelsMap() {
        return Collections.unmodifiableMap(m42470I());
    }

    @Override // com.google.api.MonitoredResourceOrBuilder
    public String getLabelsOrDefault(String str, String str2) {
        str.getClass();
        MapFieldLite m42470I = m42470I();
        if (m42470I.containsKey(str)) {
            return (String) m42470I.get(str);
        }
        return str2;
    }
