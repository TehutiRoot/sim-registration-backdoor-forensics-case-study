...
public final class SpanTextUtil {
    ...
    @Metadata(m29143d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004¨\u0006\u0005"}, m29142d2 = {"Lcom/chuckerteam/chucker/internal/support/SpanTextUtil$ChuckerForegroundColorSpan;", "Landroid/text/style/ForegroundColorSpan;", TypedValues.Custom.S_COLOR, "", "(I)V", "com.github.ChuckerTeam.Chucker.library"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* loaded from: classes3.dex */
    ...
    @Metadata(m29143d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0000\n\u0002\u0010\"\n\u0002\u0010\u000e\n\u0002\b\f\b\u0082\u0001\u0018\u0000 \u000f2\b\u0012\u0004\u0012\u00020\u00000\u0001:\u0001\u000fB\u0015\b\u0002\u0012\f\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003¢\u0006\u0002\u0010\u0005R\u0017\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007j\u0002\b\bj\u0002\b\tj\u0002\b\nj\u0002\b\u000bj\u0002\b\fj\u0002\b\rj\u0002\b\u000e¨\u0006\u0010"}, m29142d2 = {"Lcom/chuckerteam/chucker/internal/support/SpanTextUtil$TokenType;", "", "delimiters", "", "", "(Ljava/lang/String;ILjava/util/Set;)V", "getDelimiters", "()Ljava/util/Set;", "STRING", "ARRAY", "OBJECT", "KEY_SEPARATOR", "VALUE_SEPARATOR", "BOOLEAN", TopUpMixpanel.OFFER_NONE, "Companion", "com.github.ChuckerTeam.Chucker.library"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    @SourceDebugExtension({"SMAP\nSpanTextUtil.kt\nKotlin\n*S Kotlin\n*F\n+ 1 SpanTextUtil.kt\ncom/chuckerteam/chucker/internal/support/SpanTextUtil$TokenType\n+ 2 _Arrays.kt\nkotlin/collections/ArraysKt___ArraysKt\n*L\n1#1,188:1\n11335#2:189\n11670#2,3:190\n*S KotlinDebug\n*F\n+ 1 SpanTextUtil.kt\ncom/chuckerteam/chucker/internal/support/SpanTextUtil$TokenType\n*L\n44#1:189\n44#1:190,3\n*E\n"})
    /* loaded from: classes3.dex */
    public enum TokenType {
        STRING(AbstractC23354zH1.setOf(OperatorName.SHOW_TEXT_LINE_AND_SPACE)),
        ARRAY(AH1.setOf((Object[]) new String[]{"[", "]"})),
        OBJECT(AH1.setOf((Object[]) new String[]{"{", "}"})),
        KEY_SEPARATOR(AbstractC23354zH1.setOf(":")),
        VALUE_SEPARATOR(AbstractC23354zH1.setOf(",")),
        BOOLEAN(AH1.setOf((Object[]) new String[]{"true", "false"})),
        NONE(AH1.emptySet());
        ...
        @Metadata(m29143d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\"\n\u0002\u0010\u000e\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0017\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\b"}, m29142d2 = {"Lcom/chuckerteam/chucker/internal/support/SpanTextUtil$TokenType$Companion;", "", "()V", "allPossibleTokens", "", "", "getAllPossibleTokens", "()Ljava/util/Set;", "com.github.ChuckerTeam.Chucker.library"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
        /* loaded from: classes3.dex */
        ...
        static {
            ...
            allPossibleTokens = CollectionsKt___CollectionsKt.toSet(AbstractC10172es.flatten(arrayList));
        }
    ...
    public static final class C5964a {
        public /* synthetic */ C5964a(DefaultConstructorMarker defaultConstructorMarker) {
            this();
        }
    ...
    public SpanTextUtil(@NotNull Context context) {
        ...
        this.f42986a = ContextCompat.getColor(context, R.color.chucker_json_key_color);
        this.f42987b = ContextCompat.getColor(context, R.color.chucker_json_value_color);
        this.f42988c = ContextCompat.getColor(context, R.color.chucker_json_digit_and_null_value_color);
        this.f42989d = ContextCompat.getColor(context, R.color.chucker_json_elements_color);
        this.f42990e = ContextCompat.getColor(context, R.color.chucker_json_boolean_color);
    }

    /* renamed from: a */
    public final Pair m49896a(CharSequence charSequence, int i) {
        ...
        if (findAnyOf == null) {
            return TuplesKt.m29136to(-1, TokenType.NONE);
        }
        ...
        if (tokenType != null) {
            return TuplesKt.m29136to(Integer.valueOf(intValue), tokenType);
        }
        return TuplesKt.m29136to(-1, TokenType.NONE);
    }

    /* renamed from: b */
    public final int m49895b(CharSequence charSequence, int i) {
    ...
    /* renamed from: c */
    public final int m49894c(SpannableStringBuilder spannableStringBuilder, int i) {
        int i2;
        if (AbstractC5380bp.equals(spannableStringBuilder.charAt(i), 't', true)) {
            i2 = i + 4;
        } else {
            i2 = i + 5;
        }
        m49893d(spannableStringBuilder, i, i2, this.f42990e);
        return i2;
    }

    /* renamed from: d */
    public final SpannableStringBuilder m49893d(SpannableStringBuilder spannableStringBuilder, int i, int i2, int i3) {
        spannableStringBuilder.setSpan(new ChuckerForegroundColorSpan(i3), i, i2, 18);
        return spannableStringBuilder;
    }

    /* renamed from: e */
    public final Integer m49892e(SpannableStringBuilder spannableStringBuilder, int i, TokenType tokenType) {
        int i2;
        int i3;
        int i4 = -1;
        if (tokenType == null) {
        ...
        try {
            i4 = m49895b(spannableStringBuilder, i + 1);
        } catch (Exception unused) {
        }
        if (i4 < i) {
            return null;
        }
        m49893d(spannableStringBuilder, i, i4 + 1, i3);
    ...
    public final SpannableStringBuilder spanJson(@NotNull CharSequence input) {
        ...
        int i = 0;
        m49893d(spannableStringBuilder, 0, formatJson.length(), this.f42988c);
        TokenType tokenType = null;
        while (i < formatJson.length()) {
            Pair m49896a = m49896a(formatJson, i);
            int intValue = ((Number) m49896a.component1()).intValue();
            TokenType tokenType2 = (TokenType) m49896a.component2();
            switch (WhenMappings.$EnumSwitchMapping$0[tokenType2.ordinal()]) {
                case 1:
                    m49894c = m49894c(spannableStringBuilder, intValue);
                    break;
                case 2:
                case 3:
                case 4:
                case 5:
                    m49894c = intValue + 1;
                    m49893d(spannableStringBuilder, intValue, m49894c, this.f42989d);
                    break;
                case 6:
                    Integer m49892e = m49892e(spannableStringBuilder, intValue, tokenType);
                    if (m49892e != null) {
                        m49894c = m49892e.intValue() + 1;
                        break;
                    } else {
                        return spannableStringBuilder;
                    }
