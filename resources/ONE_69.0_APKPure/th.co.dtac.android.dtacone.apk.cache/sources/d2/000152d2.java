...
/* renamed from: th.co.dtac.android.dtacone.view.fragment.rtr_performance.WithHoldingTaxPreviewFragment$saveWithHoldingTaxPhoto$2 */
/* loaded from: classes9.dex */
public final class WithHoldingTaxPreviewFragment$saveWithHoldingTaxPhoto$2 extends Lambda implements Function1<Unit, Unit> {
    final /* synthetic */ WithHoldingTaxPreviewFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WithHoldingTaxPreviewFragment$saveWithHoldingTaxPhoto$2(WithHoldingTaxPreviewFragment withHoldingTaxPreviewFragment) {
        super(1);
    ...
    public final void invoke2(Unit unit) {
        ...
        dtacToast.createToast(m3853y, "Saved to folder dtac One").show();
    }
}