...
public class Argon2BytesGenerator {
    ...
    public static class Block {
        ...
        /* renamed from: v */
        private final long[] f75144v;

        private Block() {
            this.f75144v = new long[128];
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void copyBlock(Block block) {
            System.arraycopy(block.f75144v, 0, this.f75144v, 0, 128);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void xor(Block block, Block block2) {
            long[] jArr = this.f75144v;
            long[] jArr2 = block.f75144v;
            long[] jArr3 = block2.f75144v;
            for (int i = 0; i < 128; i++) {
        ...
        public void fromBytes(byte[] bArr) {
            ...
            Pack.littleEndianToLong(bArr, 0, this.f75144v);
        }
        ...
        public void toBytes(byte[] bArr) {
            ...
            Pack.longToLittleEndian(this.f75144v, bArr, 0);
        }
    ...
    public static class FillBlock {
        ...
        private FillBlock() {
            this.f75145R = new Block();
            this.f75146Z = new Block();
        ...
        private void applyBlake() {
            for (int i = 0; i < 8; i++) {
                int i2 = i * 16;
                Argon2BytesGenerator.roundFunction(this.f75146Z, i2, i2 + 1, i2 + 2, i2 + 3, i2 + 4, i2 + 5, i2 + 6, i2 + 7, i2 + 8, i2 + 9, i2 + 10, i2 + 11, i2 + 12, i2 + 13, i2 + 14, i2 + 15);
            }
            for (int i3 = 0; i3 < 8; i3++) {
                int i4 = i3 * 2;
                Argon2BytesGenerator.roundFunction(this.f75146Z, i4, i4 + 1, i4 + 16, i4 + 17, i4 + 32, i4 + 33, i4 + 48, i4 + 49, i4 + 64, i4 + 65, i4 + 80, i4 + 81, i4 + 96, i4 + 97, i4 + 112, i4 + 113);
            }
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void fillBlock(Block block, Block block2) {
            this.f75146Z.copyBlock(block);
            applyBlake();
            block2.xor(block, this.f75146Z);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void fillBlockWithXor(Block block, Block block2, Block block3) {
            this.f75145R.xor(block, block2);
            this.f75146Z.copyBlock(this.f75145R);
            applyBlake();
            block3.xorWith(this.f75145R, this.f75146Z);
        }
        ...
        public void fillBlock(Block block, Block block2, Block block3) {
            ...
            this.f75146Z.copyBlock(this.f75145R);
            applyBlake();
            block3.xor(this.f75145R, this.f75146Z);
        }
    }
    ...
    /* renamed from: F */
    private static void m24636F(long[] jArr, int i, int i2, int i3, int i4) {
    ...
    private long getPseudoRandom(FillBlock fillBlock, int i, Block block, Block block2, int i2, boolean z) {
        if (z) {
            ...
            return block.f75144v[i3];
        }
        return this.memory[i2].f75144v[0];
    }
    ...
    private void initAddressBlocks(FillBlock fillBlock, Position position, Block block, Block block2) {
        block.f75144v[0] = intToLong(position.pass);
        block.f75144v[1] = intToLong(position.lane);
        block.f75144v[2] = intToLong(position.slice);
        block.f75144v[3] = intToLong(this.memory.length);
        block.f75144v[4] = intToLong(this.parameters.getIterations());
        block.f75144v[5] = intToLong(this.parameters.getType());
    ...
    public static void roundFunction(Block block, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, int i13, int i14, int i15, int i16) {
        long[] jArr = block.f75144v;
        m24636F(jArr, i, i5, i9, i13);
        m24636F(jArr, i2, i6, i10, i14);
        m24636F(jArr, i3, i7, i11, i15);
        m24636F(jArr, i4, i8, i12, i16);
        m24636F(jArr, i, i6, i11, i16);
        m24636F(jArr, i2, i7, i12, i13);
        m24636F(jArr, i3, i8, i9, i14);
        m24636F(jArr, i4, i5, i10, i15);
    }
