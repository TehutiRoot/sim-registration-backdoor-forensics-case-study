...
public final class MaybeTimeoutMaybe<T, U> extends AbstractC1707Y {

    /* renamed from: a */
    public final MaybeSource f64950a;

    /* renamed from: b */
    public final MaybeSource f64951b;
    ...
    public MaybeTimeoutMaybe(MaybeSource<T> maybeSource, MaybeSource<U> maybeSource2, MaybeSource<? extends T> maybeSource3) {
        super(maybeSource);
        this.f64950a = maybeSource2;
        this.f64951b = maybeSource3;
    }

    @Override // io.reactivex.Maybe
    public void subscribeActual(MaybeObserver<? super T> maybeObserver) {
        TimeoutMainMaybeObserver timeoutMainMaybeObserver = new TimeoutMainMaybeObserver(maybeObserver, this.f64951b);
        maybeObserver.onSubscribe(timeoutMainMaybeObserver);
        this.f64950a.subscribe(timeoutMainMaybeObserver.other);
