...
public final class HeightInLinesModifierKt$heightInLines$2 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(@NotNull Modifier composed, @Nullable Composer composer, int i) {
        ...
        if (z || rememberedValue3 == Composer.Companion.getEmpty()) {
            rememberedValue3 = Integer.valueOf(IntSize.m74001getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(textStyle2, density, resolver, TextFieldDelegateKt.getEmptyTextReplacement(), 1)));
        ...
        if (z2 || rememberedValue4 == Composer.Companion.getEmpty()) {
            rememberedValue4 = Integer.valueOf(IntSize.m74001getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(textStyle2, density, resolver, TextFieldDelegateKt.getEmptyTextReplacement() + '\n' + TextFieldDelegateKt.getEmptyTextReplacement(), 2)));
        ...
        Modifier m69735heightInVpY3zN4 = SizeKt.m69735heightInVpY3zN4(Modifier.Companion, valueOf != null ? density.mo69619toDpu2uoSUM(valueOf.intValue()) : C3623Dp.Companion.m73862getUnspecifiedD9Ej5fM(), valueOf2 != null ? density.mo69619toDpu2uoSUM(valueOf2.intValue()) : C3623Dp.Companion.m73862getUnspecifiedD9Ej5fM());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m69735heightInVpY3zN4;
    }
}