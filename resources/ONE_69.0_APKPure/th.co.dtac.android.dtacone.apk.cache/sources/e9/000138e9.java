...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.viewmodel.OnePostpaidRegistrationViewModel$callAPICheckBlacklistSharing$2 */
/* loaded from: classes10.dex */
public final class OnePostpaidRegistrationViewModel$callAPICheckBlacklistSharing$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ OnePostpaidRegistrationViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidRegistrationViewModel$callAPICheckBlacklistSharing$2(OnePostpaidRegistrationViewModel onePostpaidRegistrationViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable throwable) {
        ...
        oneErrorService.handleException(throwable, new OneErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.viewmodel.OnePostpaidRegistrationViewModel$callAPICheckBlacklistSharing$2.1
            ...
            public void handle(@Nullable Throwable th2) {
                ...
                if (!Intrinsics.areEqual(oneErrorService2.getErrorCode(th2), "10055613")) {
                    m11691M1 = OnePostpaidRegistrationViewModel.this.m11691M1();
