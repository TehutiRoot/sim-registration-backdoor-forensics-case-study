...
public final class DeserializedMemberScope$NoReorderImplementation$variableNames$2 extends Lambda implements Function0<Set<? extends Name>> {
    ...
    public final Set<? extends Name> invoke() {
        ...
        list = noReorderImplementation.f70165b;
        LinkedHashSet linkedHashSet = new LinkedHashSet();
        DeserializedMemberScope deserializedMemberScope = noReorderImplementation.f70177n;
        ...
        return BH1.plus((Set) linkedHashSet, (Iterable) this.this$1.getNonDeclaredVariableNames());
    }
}