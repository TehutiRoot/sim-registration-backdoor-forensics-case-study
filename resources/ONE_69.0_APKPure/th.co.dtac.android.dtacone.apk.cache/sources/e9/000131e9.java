...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.fragment.OneMnpIdNumberFormFragment$setUpViewModel$1$4 */
/* loaded from: classes10.dex */
public final class OneMnpIdNumberFormFragment$setUpViewModel$1$4 extends Lambda implements Function1<Resource<? extends ErrorCollection>, Unit> {
    final /* synthetic */ OneMnpIdNumberFormFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneMnpIdNumberFormFragment$setUpViewModel$1$4(OneMnpIdNumberFormFragment oneMnpIdNumberFormFragment) {
        super(1);
    ...
    public final void invoke2(Resource<ErrorCollection> resource) {
        ...
        if (resourceContentIfNotHandled.getStatus() == StatusResource.SUCCESS) {
            oneMnpIdNumberFormFragment.m13935G(resourceContentIfNotHandled.getData());
        }
    }
}