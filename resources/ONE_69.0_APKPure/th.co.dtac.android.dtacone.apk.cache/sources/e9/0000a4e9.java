...
public final class OAuthRequirements extends GeneratedMessageLite<OAuthRequirements, Builder> implements OAuthRequirementsOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<OAuthRequirements, Builder> implements OAuthRequirementsOrBuilder {
        public /* synthetic */ Builder(C7227a c7227a) {
            this();
        }

        public Builder clearCanonicalScopes() {
            copyOnWrite();
            ((OAuthRequirements) this.instance).m42362F();
            return this;
        }
        ...
        public Builder setCanonicalScopes(String str) {
            copyOnWrite();
            ((OAuthRequirements) this.instance).m42361G(str);
            return this;
        }

        public Builder setCanonicalScopesBytes(ByteString byteString) {
            copyOnWrite();
            ((OAuthRequirements) this.instance).m42360H(byteString);
            return this;
        }
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C7227a {
    ...
    /* renamed from: F */
    public final void m42362F() {
        this.canonicalScopes_ = getDefaultInstance().getCanonicalScopes();
    }

    /* renamed from: G */
    public final void m42361G(String str) {
        str.getClass();
        this.canonicalScopes_ = str;
    }

    /* renamed from: H */
    public final void m42360H(ByteString byteString) {
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C7227a.f51653a[methodToInvoke.ordinal()]) {
            case 1:
