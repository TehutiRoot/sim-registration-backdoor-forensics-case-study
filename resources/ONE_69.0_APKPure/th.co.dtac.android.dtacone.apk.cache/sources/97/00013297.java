...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.fragment.OneMnpWriteSimFragment$setupViewModel$1$3 */
/* loaded from: classes10.dex */
public final class OneMnpWriteSimFragment$setupViewModel$1$3 extends Lambda implements Function1<Resource<? extends String>, Unit> {
    final /* synthetic */ OneMnpWriteSimFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneMnpWriteSimFragment$setupViewModel$1$3(OneMnpWriteSimFragment oneMnpWriteSimFragment) {
        super(1);
    ...
    public final void invoke2(Resource<String> resource) {
        ...
        oneMnpWriteSimFragment.m13675s(data);
    }
}