...
public final class ModalBottomSheetKt {
    ...
    /* renamed from: a */
    public static final float f14606a = C3623Dp.m73842constructorimpl(56);

    /* renamed from: b */
    public static final float f14607b = C3623Dp.m73842constructorimpl(125);

    /* renamed from: c */
    public static final float f14608c = C3623Dp.m73842constructorimpl(640);
    ...
    */
    public static final void m70234ModalBottomSheetLayoutGs3lGvM(@org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.ColumnScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r33, @org.jetbrains.annotations.Nullable androidx.compose.p003ui.Modifier r34, @org.jetbrains.annotations.Nullable androidx.compose.material.ModalBottomSheetState r35, boolean r36, @org.jetbrains.annotations.Nullable androidx.compose.p003ui.graphics.Shape r37, float r38, long r39, long r41, long r43, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r45, @org.jetbrains.annotations.Nullable androidx.compose.runtime.Composer r46, int r47, int r48) {
        /*
            Method dump skipped, instructions count: 815
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.ModalBottomSheetKt.m70234ModalBottomSheetLayoutGs3lGvM(kotlin.jvm.functions.Function3, androidx.compose.ui.Modifier, androidx.compose.material.ModalBottomSheetState, boolean, androidx.compose.ui.graphics.Shape, float, long, long, long, kotlin.jvm.functions.Function2, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /* renamed from: a */
    public static final NestedScrollConnection m60829a(AnchoredDraggableState anchoredDraggableState, Orientation orientation) {
        return new C3113x58e3e91b(anchoredDraggableState, orientation);
    }

    /* renamed from: b */
    public static final AnchoredDraggableState.AnchorChangedCallback m60828b(final ModalBottomSheetState modalBottomSheetState, final CoroutineScope coroutineScope) {
        return new AnchoredDraggableState.AnchorChangedCallback() { // from class: androidx.compose.material.ModalBottomSheetKt$ModalBottomSheetAnchorChangeCallback$1
            ...
            public final void onAnchorsChanged(ModalBottomSheetValue prevTarget, Map prevAnchors, Map newAnchors) {
                ...
                if (!Intrinsics.areEqual(((Number) AbstractC11663a.getValue(newAnchors, modalBottomSheetValue)).floatValue(), f)) {
                    if (ModalBottomSheetState.this.isAnimationRunning$material_release()) {
                        AbstractC1539Vc.m65885e(coroutineScope, null, null, new C3116xe2f4d0f4(ModalBottomSheetState.this, modalBottomSheetValue, null), 3, null);
                    } else if (!ModalBottomSheetState.this.trySnapTo$material_release(modalBottomSheetValue)) {
                        AbstractC1539Vc.m65885e(coroutineScope, null, null, new C3117xe2f4d0f5(ModalBottomSheetState.this, modalBottomSheetValue, null), 3, null);
                    }
                }
            }
        };
    ...
    /* renamed from: c */
    public static final void m60827c(long j, Function0 function0, boolean z, Composer composer, int i) {
        int i2;
        float f;
        Modifier modifier;
        int i3;
        ...
        if ((i2 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            if (j != Color.Companion.m71955getUnspecified0d7_KjU()) {
                ...
                String m70286getString4foXLRw = Strings_androidKt.m70286getString4foXLRw(Strings.Companion.m70280getCloseSheetUdPEhr4(), startRestartGroup, 6);
                ...
                if (z) {
                    ...
                    boolean changed2 = startRestartGroup.changed(m70286getString4foXLRw) | startRestartGroup.changed(function0);
                    Object rememberedValue2 = startRestartGroup.rememberedValue();
                    if (changed2 || rememberedValue2 == Composer.Companion.getEmpty()) {
                        rememberedValue2 = new ModalBottomSheetKt$Scrim$dismissModifier$2$1(m70286getString4foXLRw, function0);
                ...
                startRestartGroup.startReplaceableGroup(511388516);
                boolean changed3 = startRestartGroup.changed(m71909boximpl) | startRestartGroup.changed(animateFloatAsState);
    ...
    /* renamed from: d */
    public static final float m60826d(State state) {
