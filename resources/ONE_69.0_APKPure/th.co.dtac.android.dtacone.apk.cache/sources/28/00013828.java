...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.fragment.true_company.OnePostpaidNiceNumberTrueFragment$onViewCreated$1$1 */
/* loaded from: classes10.dex */
public final class OnePostpaidNiceNumberTrueFragment$onViewCreated$1$1 extends Lambda implements Function1<FragmentNavEvent, Unit> {
    final /* synthetic */ OnePostpaidNiceNumberTrueFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidNiceNumberTrueFragment$onViewCreated$1$1(OnePostpaidNiceNumberTrueFragment onePostpaidNiceNumberTrueFragment) {
        super(1);
    ...
    public final void invoke2(@NotNull FragmentNavEvent it) {
        OnePostpaidRegistrationActivity m11957v;
        Intrinsics.checkNotNullParameter(it, "it");
        m11957v = this.this$0.m11957v();
        m11957v.replaceFragment(it.buildFragment(), it.getTag());
    }
}