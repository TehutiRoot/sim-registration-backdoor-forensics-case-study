...
@Metadata(m29143d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n¢\u0006\u0002\b\u0003"}, m29142d2 = {"<anonymous>", "", "Landroidx/compose/foundation/text/selection/TextFieldPreparedSelection;", "invoke"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
...
public final class TextFieldKeyInput$process$2 extends Lambda implements Function1<TextFieldPreparedSelection, Unit> {
    ...
    /* loaded from: classes.dex */
    public static final class C29881 extends Lambda implements Function1<TextFieldPreparedSelection, Unit> {
        public static final C29881 INSTANCE = new C29881();
    ...
    /* loaded from: classes.dex */
    public static final class C29892 extends Lambda implements Function1<TextFieldPreparedSelection, Unit> {
        public static final C29892 INSTANCE = new C29892();
    ...
    @Metadata(m29143d1 = {"\u0000\f\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u0004\u0018\u00010\u0001*\u00020\u0002H\n¢\u0006\u0002\b\u0003"}, m29142d2 = {"<anonymous>", "Landroidx/compose/ui/text/input/EditCommand;", "Landroidx/compose/foundation/text/selection/TextFieldPreparedSelection;", "invoke"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: androidx.compose.foundation.text.TextFieldKeyInput$process$2$3 */
    /* loaded from: classes.dex */
    public static final class C29903 extends Lambda implements Function1<TextFieldPreparedSelection, EditCommand> {
        public static final C29903 INSTANCE = new C29903();
        ...
        public final EditCommand invoke(@NotNull TextFieldPreparedSelection deleteIfSelectedOr) {
            ...
            return new DeleteSurroundingTextCommand(TextRange.m73395getEndimpl(deleteIfSelectedOr.m70016getSelectiond9O1mEE()) - deleteIfSelectedOr.getPrecedingCharacterIndex(), 0);
        }
    }
    ...
    /* loaded from: classes.dex */
    public static final class C29914 extends Lambda implements Function1<TextFieldPreparedSelection, EditCommand> {
        public static final C29914 INSTANCE = new C29914();
        ...
        public final EditCommand invoke(@NotNull TextFieldPreparedSelection deleteIfSelectedOr) {
            ...
            if (nextCharacterIndex != -1) {
                return new DeleteSurroundingTextCommand(0, nextCharacterIndex - TextRange.m73395getEndimpl(deleteIfSelectedOr.m70016getSelectiond9O1mEE()));
            }
            return null;
        }
    }
    ...
    /* loaded from: classes.dex */
    public static final class C29925 extends Lambda implements Function1<TextFieldPreparedSelection, EditCommand> {
        public static final C29925 INSTANCE = new C29925();
        ...
        public final EditCommand invoke(@NotNull TextFieldPreparedSelection deleteIfSelectedOr) {
            ...
            if (previousWordOffset != null) {
                return new DeleteSurroundingTextCommand(TextRange.m73395getEndimpl(deleteIfSelectedOr.m70016getSelectiond9O1mEE()) - previousWordOffset.intValue(), 0);
            }
            return null;
        }
    }
    ...
    /* loaded from: classes.dex */
    public static final class C29936 extends Lambda implements Function1<TextFieldPreparedSelection, EditCommand> {
        public static final C29936 INSTANCE = new C29936();
        ...
        public final EditCommand invoke(@NotNull TextFieldPreparedSelection deleteIfSelectedOr) {
            ...
            if (nextWordOffset != null) {
                return new DeleteSurroundingTextCommand(0, nextWordOffset.intValue() - TextRange.m73395getEndimpl(deleteIfSelectedOr.m70016getSelectiond9O1mEE()));
            }
            return null;
        }
    }
    ...
    /* loaded from: classes.dex */
    public static final class C29947 extends Lambda implements Function1<TextFieldPreparedSelection, EditCommand> {
        public static final C29947 INSTANCE = new C29947();
        ...
        public final EditCommand invoke(@NotNull TextFieldPreparedSelection deleteIfSelectedOr) {
            ...
            if (lineStartByOffset != null) {
                return new DeleteSurroundingTextCommand(TextRange.m73395getEndimpl(deleteIfSelectedOr.m70016getSelectiond9O1mEE()) - lineStartByOffset.intValue(), 0);
            }
            return null;
        }
    }
    ...
    /* loaded from: classes.dex */
    public static final class C29958 extends Lambda implements Function1<TextFieldPreparedSelection, EditCommand> {
        public static final C29958 INSTANCE = new C29958();
        ...
        public final EditCommand invoke(@NotNull TextFieldPreparedSelection deleteIfSelectedOr) {
            ...
            if (lineEndByOffset != null) {
                return new DeleteSurroundingTextCommand(0, lineEndByOffset.intValue() - TextRange.m73395getEndimpl(deleteIfSelectedOr.m70016getSelectiond9O1mEE()));
            }
            return null;
        }
    }
    ...
    public final void invoke2(@NotNull TextFieldPreparedSelection commandExecutionContext) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[this.$command.ordinal()]) {
            ...
            case 3:
                ...
                return;
            case 4:
                commandExecutionContext.collapseLeftOr(C29881.INSTANCE);
                return;
            case 5:
                commandExecutionContext.collapseRightOr(C29892.INSTANCE);
                return;
            case 6:
            ...
            case 19:
                ...
                return;
            case 20:
                List<EditCommand> deleteIfSelectedOr = commandExecutionContext.deleteIfSelectedOr(C29903.INSTANCE);
                if (deleteIfSelectedOr != null) {
                    this.this$0.m61008b(deleteIfSelectedOr);
                    return;
                }
                return;
            case 21:
                List<EditCommand> deleteIfSelectedOr2 = commandExecutionContext.deleteIfSelectedOr(C29914.INSTANCE);
                if (deleteIfSelectedOr2 != null) {
                    this.this$0.m61008b(deleteIfSelectedOr2);
                    return;
                }
                return;
            case 22:
                List<EditCommand> deleteIfSelectedOr3 = commandExecutionContext.deleteIfSelectedOr(C29925.INSTANCE);
                if (deleteIfSelectedOr3 != null) {
                    this.this$0.m61008b(deleteIfSelectedOr3);
                    return;
                }
                return;
            case 23:
                List<EditCommand> deleteIfSelectedOr4 = commandExecutionContext.deleteIfSelectedOr(C29936.INSTANCE);
                if (deleteIfSelectedOr4 != null) {
                    this.this$0.m61008b(deleteIfSelectedOr4);
                    return;
                }
                return;
            case 24:
                List<EditCommand> deleteIfSelectedOr5 = commandExecutionContext.deleteIfSelectedOr(C29947.INSTANCE);
                if (deleteIfSelectedOr5 != null) {
                    this.this$0.m61008b(deleteIfSelectedOr5);
                    return;
                }
                return;
            case 25:
                List<EditCommand> deleteIfSelectedOr6 = commandExecutionContext.deleteIfSelectedOr(C29958.INSTANCE);
                if (deleteIfSelectedOr6 != null) {
                    this.this$0.m61008b(deleteIfSelectedOr6);
                    return;
                }
                return;
            case 26:
                if (!this.this$0.getSingleLine()) {
                    this.this$0.m61009a(new CommitTextCommand("\n", 1));
                    return;
                }
                Function1<ImeAction, Unit> onImeActionPerformed = this.this$0.getState().getOnImeActionPerformed();
                i = this.this$0.f14126l;
                onImeActionPerformed.invoke(ImeAction.m73534boximpl(i));
                return;
            case 27:
                if (!this.this$0.getSingleLine()) {
                    this.this$0.m61009a(new CommitTextCommand(SyslogAppender.DEFAULT_STACKTRACE_PATTERN, 1));
                    return;
                } else {
            ...
            case 47:
                ...
                function12 = this.this$0.f14125k;
