...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.pre2post.fragment.OnePre2PostReadSmartCardFragment$setupObserve$1$4 */
/* loaded from: classes10.dex */
public final class OnePre2PostReadSmartCardFragment$setupObserve$1$4 extends Lambda implements Function1<Resource<? extends ErrorCollection>, Unit> {
    final /* synthetic */ OnePre2PostReadSmartCardFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePre2PostReadSmartCardFragment$setupObserve$1$4(OnePre2PostReadSmartCardFragment onePre2PostReadSmartCardFragment) {
        super(1);
    ...
    public final void invoke2(Resource<ErrorCollection> resource) {
        ...
        if (resourceContentIfNotHandled.getStatus() == StatusResource.SUCCESS) {
            ...
            if (data != null) {
                onePre2PostReadSmartCardFragment.m11291z(data);
            }
        }
    }
}