...
public class NestedComplexPropertyIA extends ImplicitAction {
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C5458a {
        ...
        static {
            ...
            try {
                f39779a[AggregationType.AS_BASIC_PROPERTY.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f39779a[AggregationType.AS_BASIC_PROPERTY_COLLECTION.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f39779a[AggregationType.AS_COMPLEX_PROPERTY_COLLECTION.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f39779a[AggregationType.AS_COMPLEX_PROPERTY.ordinal()] = 5;
    ...
    public void begin(InterpretationContext interpretationContext, String str, Attributes attributes) {
        IADataForComplexProperty iADataForComplexProperty = (IADataForComplexProperty) this.f39778c.peek();
        String subst = interpretationContext.subst(attributes.getValue(Action.CLASS_ATTRIBUTE));
        try {
            Class<?> loadClass = !OptionHelper.isEmpty(subst) ? Loader.loadClass(subst, this.context) : iADataForComplexProperty.f39770a.getClassNameViaImplicitRules(iADataForComplexProperty.getComplexPropertyName(), iADataForComplexProperty.getAggregationType(), interpretationContext.getDefaultNestedComponentRegistry());
            if (loadClass == null) {
                iADataForComplexProperty.f39774e = true;
    ...
    public void end(InterpretationContext interpretationContext, String str) {
        String str2;
        IADataForComplexProperty iADataForComplexProperty = (IADataForComplexProperty) this.f39778c.pop();
        if (iADataForComplexProperty.f39774e) {
            return;
        }
        ...
        if (propertySetter.computeAggregationType("parent") == AggregationType.AS_COMPLEX_PROPERTY) {
            propertySetter.setComplexProperty("parent", iADataForComplexProperty.f39770a.getObj());
        }
        ...
        if (interpretationContext.peekObject() != iADataForComplexProperty.getNestedComplexProperty()) {
            ...
            int i = C5458a.f39779a[iADataForComplexProperty.f39771b.ordinal()];
            if (i == 4) {
                iADataForComplexProperty.f39770a.addComplexProperty(str, iADataForComplexProperty.getNestedComplexProperty());
                return;
            } else if (i == 5) {
                iADataForComplexProperty.f39770a.setComplexProperty(str, iADataForComplexProperty.getNestedComplexProperty());
                return;
            } else {
                str2 = "Unexpected aggregationType " + iADataForComplexProperty.f39771b;
            }
        }
        addError(str2);
    }
    ...
    public boolean isApplicable(ElementPath elementPath, Attributes attributes, InterpretationContext interpretationContext) {
        ...
        int i = C5458a.f39779a[computeAggregationType.ordinal()];
        if (i == 1 || i == 2 || i == 3) {
            return false;
        }
        if (i == 4 || i == 5) {
            this.f39778c.push(new IADataForComplexProperty(propertySetter, computeAggregationType, peekLast));
            return true;
        }
