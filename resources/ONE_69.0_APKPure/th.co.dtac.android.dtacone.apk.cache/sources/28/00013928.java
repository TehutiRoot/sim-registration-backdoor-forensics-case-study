...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.viewmodel.OnePostpaidRegistrationViewModel$getConsentNoticeDoc$3 */
/* loaded from: classes10.dex */
public final class OnePostpaidRegistrationViewModel$getConsentNoticeDoc$3 extends Lambda implements Function1<OneConsentNoticeDocResponse, Unit> {
    final /* synthetic */ OnePostpaidRegistrationViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidRegistrationViewModel$getConsentNoticeDoc$3(OnePostpaidRegistrationViewModel onePostpaidRegistrationViewModel) {
        super(1);
    ...
    public final void invoke2(OneConsentNoticeDocResponse oneConsentNoticeDocResponse) {
        ...
        m11651W1.setValue(Resource.Companion.success(oneConsentNoticeDocResponse));
        this.this$0.getLiveDataState().setValue(StatusResource.SUCCESS);
        this.this$0.getLiveDataState().setValue(StatusResource.DISMISS);
        m11590j2 = this.this$0.m11590j2();
        m11590j2.setValue(new Event(new FragmentNavEvent(OnePostpaidCheckBlacklistFragment.class, null, null, 4, null)));
    }
}