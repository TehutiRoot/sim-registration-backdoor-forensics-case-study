...
public class setFadingEdgeLength implements setDarkTextColor.valueOf {
    private final setDarkTextColor get;

    public setFadingEdgeLength(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.ThreeDS2Service$InitializationCallback(this.get);
    }
}