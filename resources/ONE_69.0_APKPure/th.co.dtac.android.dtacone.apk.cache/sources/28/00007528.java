...
public class ChangeClipBounds extends Transition {
    ...
    /* renamed from: K */
    public static final String[] f37751K = {"android:clipBounds:clip"};

    /* renamed from: androidx.transition.ChangeClipBounds$a */
    /* loaded from: classes2.dex */
    public class C5059a extends AnimatorListenerAdapter {

        /* renamed from: a */
        public final /* synthetic */ View f37752a;

        public C5059a(View view) {
            this.f37752a = view;
        }

        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        public void onAnimationEnd(Animator animator) {
            ViewCompat.setClipBounds(this.f37752a, null);
        }
    }
    ...
    /* renamed from: C */
    private void m52648C(TransitionValues transitionValues) {
    ...
    public Animator createAnimator(@NonNull ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        ObjectAnimator ofObject = ObjectAnimator.ofObject(transitionValues2.view, AbstractC21759q42.f77069c, new C18636Ut1(new Rect()), rect, rect2);
        if (z) {
            ofObject.addListener(new C5059a(transitionValues2.view));
        }
        return ofObject;
    }
