...
public final class BuyDolBanksAdapter extends RecyclerView.Adapter<BankViewHolder> {
    ...
    /* renamed from: b */
    public final Context f81086b;

    /* renamed from: c */
    public final OnClickListener f81087c;

    @StabilityInferred(parameters = 0)
    @Metadata(m29143d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\u000e\b\u0007\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005R\"\u0010\r\u001a\u00020\u00068\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\u0007\u0010\b\u001a\u0004\b\t\u0010\n\"\u0004\b\u000b\u0010\fR\"\u0010\u0015\u001a\u00020\u000e8\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\u000f\u0010\u0010\u001a\u0004\b\u0011\u0010\u0012\"\u0004\b\u0013\u0010\u0014R\"\u0010\u001d\u001a\u00020\u00168\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\u0017\u0010\u0018\u001a\u0004\b\u0019\u0010\u001a\"\u0004\b\u001b\u0010\u001cR\"\u0010#\u001a\u00020\u00028\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\u001e\u0010\u001f\u001a\u0004\b \u0010!\"\u0004\b\"\u0010\u0005¨\u0006$"}, m29142d2 = {"Lth/co/dtac/android/dtacone/adapter/buy_dol/BuyDolBanksAdapter$BankViewHolder;", "Landroidx/recyclerview/widget/RecyclerView$ViewHolder;", "Landroid/view/View;", Promotion.ACTION_VIEW, "<init>", "(Landroid/view/View;)V", "Landroidx/appcompat/widget/AppCompatImageView;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/appcompat/widget/AppCompatImageView;", "getIvBankBand", "()Landroidx/appcompat/widget/AppCompatImageView;", "setIvBankBand", "(Landroidx/appcompat/widget/AppCompatImageView;)V", "ivBankBand", "Landroid/widget/TextView;", OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, "Landroid/widget/TextView;", "getTvName", "()Landroid/widget/TextView;", "setTvName", "(Landroid/widget/TextView;)V", "tvName", "Landroid/widget/ImageView;", OperatorName.CURVE_TO, "Landroid/widget/ImageView;", "getIvAddMore", "()Landroid/widget/ImageView;", "setIvAddMore", "(Landroid/widget/ImageView;)V", "ivAddMore", "d", "Landroid/view/View;", "getRootView", "()Landroid/view/View;", "setRootView", "rootView", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0})
    ...
    public static final class BankViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: a */
        public AppCompatImageView f81088a;

        /* renamed from: b */
        public TextView f81089b;

        /* renamed from: c */
        public ImageView f81090c;
        ...
        public BankViewHolder(@NotNull View view) {
            ...
            this.f81090c = (ImageView) findViewById3;
        ...
        public final void setIvBankBand(@NotNull AppCompatImageView appCompatImageView) {
            ...
            this.f81088a = appCompatImageView;
        }
    ...
    @Metadata(m29143d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\bf\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&¨\u0006\u0006"}, m29142d2 = {"Lth/co/dtac/android/dtacone/adapter/buy_dol/BuyDolBanksAdapter$OnClickListener;", "", "OnBankSelected", "", "bankName", "", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    public BuyDolBanksAdapter(@NotNull List<String> banks, @NotNull Context context, @NotNull OnClickListener listener) {
        ...
        this.f81085a = banks;
        this.f81086b = context;
        this.f81087c = listener;
    }

    /* renamed from: a */
    public static /* synthetic */ void m20619a(BuyDolBanksAdapter buyDolBanksAdapter, int i, View view) {
        m20616d(buyDolBanksAdapter, i, view);
    }

    /* renamed from: d */
    public static final void m20616d(BuyDolBanksAdapter this$0, int i, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.f81087c.OnBankSelected((String) this$0.f81085a.get(i));
    }

    /* renamed from: b */
    public final int m20618b(String str) {
    ...
    /* renamed from: c */
    public final String m20617c(String str) {
        String upperCase = str.toUpperCase();
        Intrinsics.checkNotNullExpressionValue(upperCase, "toUpperCase(...)");
        BankAccountType bankAccountType = BankAccountType.INSTANCE;
        if (Intrinsics.areEqual(upperCase, bankAccountType.getSCB_L())) {
            String string = this.f81086b.getResources().getString(R.string.scb_title);
            ...
            String string2 = this.f81086b.getResources().getString(R.string.ktb_title);
            ...
            String string3 = this.f81086b.getResources().getString(R.string.ks_title);
            Intrinsics.checkNotNullExpressionValue(string3, "context.resources.getString(R.string.ks_title)");
            return string3;
        } else {
            String string4 = this.f81086b.getResources().getString(R.string.bank_title);
    ...
    public void onBindViewHolder(@NotNull BankViewHolder holder, final int i) {
        ...
        holder.getTvName().setText(m20617c((String) this.f81085a.get(i)));
        holder.getIvBankBand().setImageDrawable(ContextCompat.getDrawable(this.f81086b, m20618b((String) this.f81085a.get(i))));
        holder.getRootView().setOnClickListener(new View.OnClickListener() { // from class: qd
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                BuyDolBanksAdapter.m20619a(BuyDolBanksAdapter.this, i, view);
            }
        });
    }
