...
@Metadata(m29143d1 = {"\u0000D\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\b\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0007\u0018\u00002\u00020\u0001B\u0019\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\b\u0010\u0005\u001a\u0004\u0018\u00010\u0004¢\u0006\u0004\b\u0006\u0010\u0007J\u0017\u0010\u000b\u001a\u00020\n2\b\u0010\t\u001a\u0004\u0018\u00010\b¢\u0006\u0004\b\u000b\u0010\fJ\r\u0010\r\u001a\u00020\b¢\u0006\u0004\b\r\u0010\u000eJ\u0017\u0010\u000f\u001a\u00020\n2\b\u0010\t\u001a\u0004\u0018\u00010\b¢\u0006\u0004\b\u000f\u0010\fJ\r\u0010\u0010\u001a\u00020\b¢\u0006\u0004\b\u0010\u0010\u000eJ\u0015\u0010\u0012\u001a\u00020\n2\u0006\u0010\u0011\u001a\u00020\b¢\u0006\u0004\b\u0012\u0010\fJ\u0015\u0010\u0015\u001a\u00020\n2\u0006\u0010\u0014\u001a\u00020\u0013¢\u0006\u0004\b\u0015\u0010\u0016J\u001d\u0010\u0019\u001a\u00020\n2\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0018\u001a\u00020\u0017¢\u0006\u0004\b\u0019\u0010\u001aJ\u000f\u0010\u001b\u001a\u00020\nH\u0002¢\u0006\u0004\b\u001b\u0010\u001cR\u0016\u0010\u001f\u001a\u00020\u001d8\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u001b\u0010\u001eR\u0014\u0010\"\u001a\u00020 8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0014\u0010!¨\u0006#"}, m29142d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/OneTextLayoutView;", "Landroid/widget/FrameLayout;", "Landroid/content/Context;", CoreConstants.CONTEXT_SCOPE_VALUE, "Landroid/util/AttributeSet;", "attrs", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "", TextBundle.TEXT_ENTRY, "", "setText", "(Ljava/lang/String;)V", "getText", "()Ljava/lang/String;", "setTextLabel", "getTextLabel", "textHint", "setTextHint", "", OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, "isShowIconRight", "(Z)V", "", TypedValues.Custom.S_COLOR, "setTextLabelTextColor", "(Landroid/content/Context;I)V", PDPageLabelRange.STYLE_LETTERS_LOWER, "()V", "Landroid/content/res/TypedArray;", "Landroid/content/res/TypedArray;", "attributes", "Landroid/view/LayoutInflater;", "Landroid/view/LayoutInflater;", "inflater", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0})
...
public final class OneTextLayoutView extends FrameLayout {
    ...
    /* renamed from: a */
    public TypedArray f82973a;

    /* renamed from: b */
    public final LayoutInflater f82974b;
    ...
    public OneTextLayoutView(@NotNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.f82973a = obtainStyledAttributes;
        Object systemService = context.getSystemService("layout_inflater");
        Intrinsics.checkNotNull(systemService, "null cannot be cast to non-null type android.view.LayoutInflater");
        this.f82974b = (LayoutInflater) systemService;
        m20026a();
    }

    /* renamed from: a */
    public final void m20026a() {
        addView(this.f82974b.inflate(R.layout.one_text_layout, (ViewGroup) null));
        ...
        if (this.f82973a.hasValue(R.styleable.OneTextLayoutView_android_text)) {
            TypedArray typedArray = this.f82973a;
            oneFontTextView2.setText(typedArray.getText(typedArray.getResourceId(R.styleable.OneTextLayoutView_android_text, 0)));
        }
        if (this.f82973a.hasValue(R.styleable.OneTextLayoutView_android_textSize)) {
            oneFontTextView2.setTextSize(this.f82973a.getDimension(R.styleable.OneTextLayoutView_android_textSize, 0.0f));
        }
        if (this.f82973a.hasValue(R.styleable.OneTextLayoutView_label_text)) {
            setTextLabel(this.f82973a.getText(R.styleable.OneTextLayoutView_label_text).toString());
        }
        if (this.f82973a.hasValue(R.styleable.OneTextLayoutView_label_text_size)) {
            oneFontTextView.setTextSize(this.f82973a.getDimension(R.styleable.OneTextLayoutView_label_text_size, 0.0f));
        }
        if (this.f82973a.hasValue(R.styleable.OneTextLayoutView_isShowIconRight)) {
            if (this.f82973a.getBoolean(R.styleable.OneTextLayoutView_isShowIconRight, false)) {
