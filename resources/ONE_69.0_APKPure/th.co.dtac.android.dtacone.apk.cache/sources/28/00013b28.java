...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.pre2post.fragment.trueCompany.OnePre2PostSelectPropositionFragment$onStart$1$2 */
/* loaded from: classes10.dex */
public final class OnePre2PostSelectPropositionFragment$onStart$1$2 extends Lambda implements Function1<Resource<? extends ErrorCollection>, Unit> {
    final /* synthetic */ OnePre2PostSelectPropositionFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.pre2post.fragment.trueCompany.OnePre2PostSelectPropositionFragment$onStart$1$2$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OnePre2PostSelectPropositionFragment$onStart$1$2(OnePre2PostSelectPropositionFragment onePre2PostSelectPropositionFragment) {
        super(1);
    ...
    public final void invoke2(Resource<ErrorCollection> resource) {
        ...
        if (i == 1) {
            ...
            onePre2PostSelectPropositionFragment.dismissLoading();
            onePre2PostSelectPropositionFragment.m11047B(resourceContentIfNotHandled.getData());
        }
    }
}