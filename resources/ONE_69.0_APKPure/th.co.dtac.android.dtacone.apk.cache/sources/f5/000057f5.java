...
public final class ComposableSingletons$AppBarKt$lambda5$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    public static final ComposableSingletons$AppBarKt$lambda5$1 INSTANCE = new ComposableSingletons$AppBarKt$lambda5$1();

    public ComposableSingletons$AppBarKt$lambda5$1() {
        super(2);
    }
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1103559359, i, -1, "androidx.compose.material3.ComposableSingletons$AppBarKt.lambda-5.<anonymous> (AppBar.kt:227)");
        }
        if (ComposerKt.isTraceInProgress()) {
