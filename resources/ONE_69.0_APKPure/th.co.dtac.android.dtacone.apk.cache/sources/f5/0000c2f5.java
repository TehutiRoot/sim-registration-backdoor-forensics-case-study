...
public final class PDXFAResource implements COSObjectable {
    ...
    /* renamed from: a */
    public final COSBase f60714a;

    public PDXFAResource(COSBase cOSBase) {
        this.f60714a = cOSBase;
    }
    ...
    public byte[] getBytes() throws IOException {
        ...
        try {
            ...
            } else if (this.f60714a.getCOSObject() instanceof COSStream) {
                byte[] bArr2 = new byte[1024];
                cOSInputStream = ((COSStream) this.f60714a.getCOSObject()).createInputStream();
                while (true) {
