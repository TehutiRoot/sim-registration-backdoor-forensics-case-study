...
public final class MutatorMutex {
    ...
    public static final class C2766a {
        ...
        /* renamed from: a */
        public final MutatePriority f12986a;

        /* renamed from: b */
        public final Job f12987b;

        public C2766a(MutatePriority priority, Job job) {
            Intrinsics.checkNotNullParameter(priority, "priority");
            Intrinsics.checkNotNullParameter(job, "job");
            this.f12986a = priority;
            this.f12987b = job;
        }

        /* renamed from: a */
        public final boolean m61492a(C2766a other) {
            Intrinsics.checkNotNullParameter(other, "other");
            if (this.f12986a.compareTo(other.f12986a) >= 0) {
                return true;
            }
            return false;
        }
        ...
        /* renamed from: b */
        public final void m61491b() {
            this.f12987b.cancel((CancellationException) new MutationInterruptedException());
        }
    }
    ...
    /* renamed from: a */
    public final void m61493a(C2766a c2766a) {
        C2766a c2766a2;
        do {
            c2766a2 = (C2766a) this.f12984a.get();
            if (c2766a2 != null && !c2766a.m61492a(c2766a2)) {
                throw new CancellationException("Current mutation had a higher priority");
            }
        } while (!AbstractC23094xo1.m479a(this.f12984a, c2766a2, c2766a));
        if (c2766a2 != null) {
            c2766a2.m61491b();
        }
    }
