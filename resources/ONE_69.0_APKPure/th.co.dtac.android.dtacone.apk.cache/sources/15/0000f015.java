...
public final class UnsynchronizedBufferedInputStream extends UnsynchronizedFilterInputStream {
    ...
    /* renamed from: b */
    public final int m25174b(InputStream inputStream, byte[] bArr) {
        int i = this.markPos;
        if (i != -1) {
            int i2 = this.pos - i;
    ...
    public int read() throws IOException {
        ...
        if (bArr != null && inputStream != null) {
            if (this.pos < this.count || m25174b(inputStream, bArr) != -1) {
        ...
        if (bArr2 != null) {
            ...
            if (inputStream != null) {
                ...
                while (true) {
                    ...
                    } else if (m25174b(inputStream, bArr2) == -1) {
                        if (i3 == i2) {
                            return -1;
                        }
                        return i2 - i3;
