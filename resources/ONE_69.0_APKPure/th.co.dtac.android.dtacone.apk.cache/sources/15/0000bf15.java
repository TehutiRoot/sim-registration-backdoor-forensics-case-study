...
public class setScrollbarFadingEnabled implements setDarkTextColor.valueOf {
    private final setDarkTextColor ThreeDS2ServiceInstance;

    public setScrollbarFadingEnabled(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.toString(this.ThreeDS2ServiceInstance);
    }
}