...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_prepaid_registration.MrtrPrepaidRegistrationViewModel$uploadImage$1 */
/* loaded from: classes9.dex */
public final class MrtrPrepaidRegistrationViewModel$uploadImage$1 extends Lambda implements Function1<IndexedValue<? extends String>, ObservableSource<? extends UploadImageResponse>> {
    final /* synthetic */ MrtrPrepaidRegistrationViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrPrepaidRegistrationViewModel$uploadImage$1(MrtrPrepaidRegistrationViewModel mrtrPrepaidRegistrationViewModel) {
        super(1);
    ...
    public final ObservableSource<? extends UploadImageResponse> invoke2(@NotNull IndexedValue<String> indexedValue) {
        ...
        mrtrPrepaidRepository2 = this.this$0.f106723b;
        ...
        String simcardNumber = mrtrPrepaidValidateBarcodeResponse != null ? mrtrPrepaidValidateBarcodeResponse.getSimcardNumber() : null;
        m2021s = this.this$0.m2021s(component2);
        mrtrPrepaidRepository3 = this.this$0.f106723b;
        ...
        return mrtrPrepaidRepository.uploadImage(new UploadImageRequest(simcardNumber, m2021s, PermissionConstant.M_REGS_PRE, mrtrPrepaidValidateBarcodeResponse2 != null ? mrtrPrepaidValidateBarcodeResponse2.getSubscriberNumber() : null, null, 16, null)).toObservable();
    }
