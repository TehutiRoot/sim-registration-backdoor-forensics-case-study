...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.buyDol.fragment.OneBuyDolSummaryFragment$saveBillToImageGallery$2 */
/* loaded from: classes10.dex */
public final class OneBuyDolSummaryFragment$saveBillToImageGallery$2 extends Lambda implements Function1<Unit, Unit> {
    final /* synthetic */ OneBuyDolSummaryFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneBuyDolSummaryFragment$saveBillToImageGallery$2(OneBuyDolSummaryFragment oneBuyDolSummaryFragment) {
        super(1);
    ...
    public final void invoke2(Unit unit) {
        ...
        this.this$0.m15924u(string, true);
