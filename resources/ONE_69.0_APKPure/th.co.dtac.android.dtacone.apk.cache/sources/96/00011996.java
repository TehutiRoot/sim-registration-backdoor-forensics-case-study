...
public class UsbBroadcastReceiver extends BroadcastReceiver {
    ...
    /* renamed from: a */
    public static PendingIntent m19504a(Context context) {
        int i;
    ...
    /* renamed from: c */
    public static UsbDevice m19502c(Intent intent) {
    ...
    /* renamed from: b */
    public final CardReaderService m19503b(Context context) {
        return ((MobileRTRApplication) context.getApplicationContext()).component().getBluetoothService();
    }

    /* renamed from: d */
    public final boolean m19501d(UsbDevice usbDevice) {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        UsbDevice m19502c = m19502c(intent);
        ...
        if (m19501d(m19502c)) {
            ...
            switch (c) {
                case 0:
                    ...
                    if (usbManager.hasPermission(m19502c)) {
                        m19503b(context).connectDevice(m19502c);
                        return;
                    } else {
                        usbManager.requestPermission(m19502c, m19504a(context));
                        return;
                    }
                case 1:
                    if (m19503b(context).isConnected()) {
                        m19503b(context).disconnectDevice(m19502c);
                        return;
                    }
                    return;
                case 2:
                    ...
                    if (booleanExtra && usbDevice != null) {
                        m19503b(context).connectDevice(usbDevice);
                        return;
                    }
                    return;
                default:
