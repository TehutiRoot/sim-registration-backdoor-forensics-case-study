...
public final class NodeCoordinator$speculativeHit$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke2() {
        ...
        m59344a = NodeCoordinatorKt.m59344a(this.$this_speculativeHit, this.$hitTestSource.mo73142entityTypeOLwlOKw(), NodeKind.m73145constructorimpl(2));
        nodeCoordinator.m59350n(m59344a, this.$hitTestSource, this.$pointerPosition, this.$hitTestResult, this.$isTouchEvent, this.$isInLayer, this.$distanceFromEdge);
    }
}