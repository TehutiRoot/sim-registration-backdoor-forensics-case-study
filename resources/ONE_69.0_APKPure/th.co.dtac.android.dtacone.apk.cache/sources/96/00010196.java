...
public class Document implements Map<String, Object>, Serializable, Bson {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass() && this.documentAsMap.equals(((Document) obj).documentAsMap)) {
            return true;
        }
        return false;
    }
    ...
    public <T> T getEmbedded(List<?> list, Class<T> cls) {
        Assertions.notNull(UserMetadata.KEYDATA_FILENAME, list);
        Assertions.isTrue(UserMetadata.KEYDATA_FILENAME, !list.isEmpty());
        Assertions.notNull("clazz", cls);
