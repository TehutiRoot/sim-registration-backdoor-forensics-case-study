        ...
        if (obj2 != null) {
            if (this._isContainer) {
                if (obj2 instanceof Object[]) {
                    ...
                    throw new IllegalStateException("Unsupported container type (" + obj2.getClass().getName() + ") when resolving reference '" + this._referenceName + OperatorName.SHOW_TEXT_LINE);
                }
            } else {
