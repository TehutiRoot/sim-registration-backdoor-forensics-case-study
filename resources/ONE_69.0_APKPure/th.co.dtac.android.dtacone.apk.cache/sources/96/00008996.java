...
public final class C6229e extends ExternalPRequestContext {
    ...
    /* loaded from: classes3.dex */
    public static final class C6231b extends ExternalPRequestContext.Builder {

        /* renamed from: a */
        public Integer f43979a;
        ...
        public ExternalPRequestContext build() {
            return new C6229e(this.f43979a);
        }
    ...
    public String toString() {
        return "ExternalPRequestContext{originAssociatedProductId=" + this.f43978a + "}";
    }

    public C6229e(Integer num) {
        this.f43978a = num;
    }
}