...
public final class DrawableUtils {
    ...
    /* renamed from: a */
    public final boolean m51015a(Bitmap bitmap, Bitmap.Config config) {
    ...
    /* renamed from: b */
    public final boolean m51014b(boolean z, Bitmap bitmap, Size size, Scale scale) {
        int px;
        int px2;
        if (z) {
            return true;
    ...
    public final Bitmap convertToBitmap(@NotNull Drawable drawable, @NotNull Bitmap.Config config, @NotNull Size size, @NotNull Scale scale, boolean z) {
        ...
        if (drawable instanceof BitmapDrawable) {
            ...
            if (m51015a(bitmap, config) && m51014b(z, bitmap, size, scale)) {
                return bitmap;
            }
        }
        ...
        int roundToInt = AbstractC22237sr0.roundToInt(width * computeSizeMultiplier);
        int roundToInt2 = AbstractC22237sr0.roundToInt(computeSizeMultiplier * i);
