...
public abstract class AbstractC11481is extends AbstractC10396hs {
    @NotNull
    ...
    /* renamed from: e */
    public static final int m29648e(List list, int i) {
    ...
    /* renamed from: f */
    public static final int m29647f(List list, int i) {
        return CollectionsKt__CollectionsKt.getLastIndex(list) - i;
    }

    /* renamed from: g */
    public static final int m29646g(List list, int i) {
