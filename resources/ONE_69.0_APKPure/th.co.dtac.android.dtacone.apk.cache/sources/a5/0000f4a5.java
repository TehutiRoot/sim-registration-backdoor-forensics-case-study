...
public class CAST5CBCParameters extends ASN1Object {
    ...
    /* renamed from: iv */
    ASN1OctetString f74761iv;
    ASN1Integer keyLength;

    private CAST5CBCParameters(ASN1Sequence aSN1Sequence) {
        this.f74761iv = (ASN1OctetString) aSN1Sequence.getObjectAt(0);
    ...
    public byte[] getIV() {
        return Arrays.clone(this.f74761iv.getOctets());
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f74761iv);
        aSN1EncodableVector.add(this.keyLength);
        return new DERSequence(aSN1EncodableVector);
    }

    public CAST5CBCParameters(byte[] bArr, int i) {
        this.f74761iv = new DEROctetString(Arrays.clone(bArr));
