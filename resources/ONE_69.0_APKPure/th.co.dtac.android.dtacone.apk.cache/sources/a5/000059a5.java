...
public final class NavigationBarKt$NavigationBarItem$3$indicator$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        long m70647getIndicatorColor0d7_KjU$material3_release = this.$colors.m70647getIndicatorColor0d7_KjU$material3_release();
        m60558c = NavigationBarKt.m60558c(this.$animationProgress$delegate);
        BoxKt.Box(BackgroundKt.m69504backgroundbw27NRU(layoutId, Color.m71918copywmQWz5c$default(m70647getIndicatorColor0d7_KjU$material3_release, m60558c, 0.0f, 0.0f, 0.0f, 14, null), ShapesKt.toShape(NavigationBarTokens.INSTANCE.getActiveIndicatorShape(), composer, 6)), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
