...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.deviceSaleTrueCompany.fragment.common.OneDeviceSaleNavigateToCommonFragment$initView$1$3 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleNavigateToCommonFragment$initView$1$3 extends Lambda implements Function1<Resource<? extends ErrorCollection>, Unit> {
    final /* synthetic */ OneDeviceSaleNavigateToCommonFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneDeviceSaleNavigateToCommonFragment$initView$1$3(OneDeviceSaleNavigateToCommonFragment oneDeviceSaleNavigateToCommonFragment) {
        super(1);
    ...
    public final void invoke2(Resource<ErrorCollection> resource) {
        ...
        if (resourceContentIfNotHandled.getStatus() == StatusResource.ERROR) {
            oneDeviceSaleNavigateToCommonFragment.m14937p();
        }
    }
}