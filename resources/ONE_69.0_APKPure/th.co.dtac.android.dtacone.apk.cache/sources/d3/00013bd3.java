...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.pre2post.viewModel.OnePre2PostViewModel$requestOnePre2PostOTP$3 */
/* loaded from: classes10.dex */
public final class OnePre2PostViewModel$requestOnePre2PostOTP$3 extends Lambda implements Function1<RequestOtpV3Response, Unit> {
    final /* synthetic */ OnePre2PostViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePre2PostViewModel$requestOnePre2PostOTP$3(OnePre2PostViewModel onePre2PostViewModel) {
        super(1);
    ...
    public final void invoke2(RequestOtpV3Response requestOtpV3Response) {
        MutableLiveData m10831i1;
        this.this$0.getOneModel().setHref(requestOtpV3Response.getHref());
        m10831i1 = this.this$0.m10831i1();
        m10831i1.setValue(Resource.Companion.success(requestOtpV3Response));
    }
}