...
public final class C18202Oc2 extends zzae {
    public C18202Oc2(zzao zzaoVar, String str, Boolean bool) {
    ...
    public final Boolean zza(SharedPreferences sharedPreferences) {
        try {
            return Boolean.valueOf(sharedPreferences.getBoolean(this.f45531b, false));
