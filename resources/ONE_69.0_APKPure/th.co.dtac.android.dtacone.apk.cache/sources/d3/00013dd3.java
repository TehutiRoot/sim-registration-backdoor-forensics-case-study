...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.report.fragment.OneRtrPerformanceSellingCommissionFragment$setupViewModel$2 */
/* loaded from: classes10.dex */
public final class OneRtrPerformanceSellingCommissionFragment$setupViewModel$2 extends Lambda implements Function1<Resource<? extends OneCommissionTrueCompanyResponse>, Unit> {
    final /* synthetic */ OneRtrPerformanceSellingCommissionFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.report.fragment.OneRtrPerformanceSellingCommissionFragment$setupViewModel$2$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneRtrPerformanceSellingCommissionFragment$setupViewModel$2(OneRtrPerformanceSellingCommissionFragment oneRtrPerformanceSellingCommissionFragment) {
        super(1);
    ...
    public final void invoke2(Resource<OneCommissionTrueCompanyResponse> resource) {
        ...
        if (i == 1) {
            ...
            oneRtrPerformanceSellingCommissionFragment.m10313C(commission);
            oneRtrPerformanceSellingCommissionFragment.m10314B(commission);
            OneRtrPerformanceSellingCommissionFragment.m10301x(oneRtrPerformanceSellingCommissionFragment, commission, null, 2, null);
