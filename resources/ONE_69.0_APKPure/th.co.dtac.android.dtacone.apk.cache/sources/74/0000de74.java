...
public final class DescriptorResolverUtils {
    ...
    /* loaded from: classes6.dex */
    public static class C11768a extends NonReportingOverrideStrategy {

        /* renamed from: a */
        public final /* synthetic */ ErrorReporter f69051a;

        /* renamed from: b */
        public final /* synthetic */ Set f69052b;

        /* renamed from: c */
        public final /* synthetic */ boolean f69053c;

        /* renamed from: kotlin.reflect.jvm.internal.impl.load.java.components.DescriptorResolverUtils$a$a */
        /* loaded from: classes6.dex */
        public class C11769a implements Function1 {
            public C11769a() {
            }

            /* renamed from: a */
            private static /* synthetic */ void m28694a(int i) {
            ...
            public Unit invoke(CallableMemberDescriptor callableMemberDescriptor) {
                ...
                C11768a.this.f69051a.reportCannotInferVisibility(callableMemberDescriptor);
                return Unit.INSTANCE;
            }
        }

        public C11768a(ErrorReporter errorReporter, Set set, boolean z) {
            this.f69051a = errorReporter;
            this.f69052b = set;
            this.f69053c = z;
        }

        /* renamed from: a */
        private static /* synthetic */ void m28695a(int i) {
        ...
        public void addFakeOverride(CallableMemberDescriptor callableMemberDescriptor) {
            ...
            OverridingUtil.resolveUnknownVisibilityForMember(callableMemberDescriptor, new C11769a());
            this.f69052b.add(callableMemberDescriptor);
        }
        ...
        public void setOverriddenDescriptors(CallableMemberDescriptor callableMemberDescriptor, Collection collection) {
            ...
            if (this.f69053c && callableMemberDescriptor.getKind() != CallableMemberDescriptor.Kind.FAKE_OVERRIDE) {
                return;
            }
    ...
    /* renamed from: a */
    public static /* synthetic */ void m28697a(int i) {
    ...
    /* renamed from: b */
    public static Collection m28696b(Name name, Collection collection, Collection collection2, ClassDescriptor classDescriptor, ErrorReporter errorReporter, OverridingUtil overridingUtil, boolean z) {
        if (name == null) {
            m28697a(12);
        }
        if (collection == null) {
        ...
        overridingUtil.generateOverridesInFunctionGroup(name, collection, collection2, classDescriptor, new C11768a(errorReporter, linkedHashSet, z));
    ...
    public static <D extends CallableMemberDescriptor> Collection<D> resolveOverridesForNonStaticMembers(@NotNull Name name, @NotNull Collection<D> collection, @NotNull Collection<D> collection2, @NotNull ClassDescriptor classDescriptor, @NotNull ErrorReporter errorReporter, @NotNull OverridingUtil overridingUtil) {
        ...
        return m28696b(name, collection, collection2, classDescriptor, errorReporter, overridingUtil, false);
    }
    ...
    public static <D extends CallableMemberDescriptor> Collection<D> resolveOverridesForStaticMembers(@NotNull Name name, @NotNull Collection<D> collection, @NotNull Collection<D> collection2, @NotNull ClassDescriptor classDescriptor, @NotNull ErrorReporter errorReporter, @NotNull OverridingUtil overridingUtil) {
        ...
        return m28696b(name, collection, collection2, classDescriptor, errorReporter, overridingUtil, true);
    }
}