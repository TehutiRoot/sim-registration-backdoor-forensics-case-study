...
public final class BadRequest extends GeneratedMessageLite<BadRequest, Builder> implements BadRequestOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<BadRequest, Builder> implements BadRequestOrBuilder {
        ...
        public Builder removeFieldViolations(int i) {
            copyOnWrite();
            ((BadRequest) this.instance).m34970N(i);
            return this;
        }

        public Builder setFieldViolations(int i, FieldViolation fieldViolation) {
            copyOnWrite();
            ((BadRequest) this.instance).m34969O(i, fieldViolation);
            return this;
        }
    ...
    public static final class FieldViolation extends GeneratedMessageLite<FieldViolation, Builder> implements FieldViolationOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<FieldViolation, Builder> implements FieldViolationOrBuilder {
            ...
            public Builder clearDescription() {
                copyOnWrite();
                ((FieldViolation) this.instance).m34961I();
                return this;
            }

            public Builder clearField() {
                copyOnWrite();
                ((FieldViolation) this.instance).m34960J();
                return this;
            }
            ...
            public Builder setDescription(String str) {
                copyOnWrite();
                ((FieldViolation) this.instance).m34959K(str);
                return this;
            }

            public Builder setDescriptionBytes(ByteString byteString) {
                copyOnWrite();
                ((FieldViolation) this.instance).m34958L(byteString);
                return this;
            }

            public Builder setField(String str) {
                copyOnWrite();
                ((FieldViolation) this.instance).m34957M(str);
                return this;
            }

            public Builder setFieldBytes(ByteString byteString) {
                copyOnWrite();
                ((FieldViolation) this.instance).m34956N(byteString);
                return this;
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* renamed from: K */
        public void m34959K(String str) {
            str.getClass();
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* renamed from: L */
        public void m34958L(ByteString byteString) {
        ...
        /* renamed from: M */
        public final void m34957M(String str) {
            str.getClass();
            this.field_ = str;
        }

        /* renamed from: N */
        public final void m34956N(ByteString byteString) {
            AbstractMessageLite.checkByteStringIsUtf8(byteString);
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C8964a.f57547a[methodToInvoke.ordinal()]) {
                case 1:
    ...
    /* loaded from: classes5.dex */
    public static /* synthetic */ class C8964a {
        ...
        static {
            ...
            try {
                f57547a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f57547a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f57547a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f57547a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f57547a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f57547a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: I */
    public final void m34975I(Iterable iterable) {
        m34971M();
        AbstractMessageLite.addAll(iterable, (List) this.fieldViolations_);
    }

    /* renamed from: J */
    public final void m34974J(int i, FieldViolation fieldViolation) {
    ...
    /* renamed from: K */
    public final void m34973K(FieldViolation fieldViolation) {
        fieldViolation.getClass();
        m34971M();
    ...
    /* renamed from: N */
    public final void m34970N(int i) {
        m34971M();
        this.fieldViolations_.remove(i);
    }

    /* renamed from: O */
    public final void m34969O(int i, FieldViolation fieldViolation) {
        fieldViolation.getClass();
        m34971M();
