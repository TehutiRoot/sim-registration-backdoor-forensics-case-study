...
public class ServiceAccountJwtAccessCredentials extends Credentials implements JwtProvider, ServiceAccountSigner, QuotaProjectIdProvider {
    ...
    public static class Builder {
        ...
        public ServiceAccountJwtAccessCredentials build() {
            return new ServiceAccountJwtAccessCredentials(this.f52535a, this.f52536b, this.f52537c, this.f52538d, this.f52539e, this.f52540f, null);
        }
        ...
        public Builder(ServiceAccountJwtAccessCredentials serviceAccountJwtAccessCredentials) {
            this.f52535a = serviceAccountJwtAccessCredentials.clientId;
            this.f52536b = serviceAccountJwtAccessCredentials.clientEmail;
            this.f52537c = serviceAccountJwtAccessCredentials.privateKey;
            this.f52538d = serviceAccountJwtAccessCredentials.privateKeyId;
            this.f52539e = serviceAccountJwtAccessCredentials.defaultAudience;
            this.f52540f = serviceAccountJwtAccessCredentials.quotaProjectId;
        }
    }

    /* renamed from: com.google.auth.oauth2.ServiceAccountJwtAccessCredentials$a */
    /* loaded from: classes4.dex */
    public class C7347a extends CacheLoader {
        public C7347a() {
        }
    ...
    public /* synthetic */ ServiceAccountJwtAccessCredentials(String str, String str2, PrivateKey privateKey, String str3, URI uri, String str4, C7347a c7347a) {
        this(str, str2, privateKey, str3, uri, str4);
    }

    private LoadingCache<JwtClaims, JwtCredentials> createCache() {
        return CacheBuilder.newBuilder().maximumSize(100L).expireAfterWrite(LIFE_SPAN_SECS - CLOCK_SKEW, TimeUnit.SECONDS).ticker(new C7348b()).build(new C7347a());
    }
    ...
    public JwtCredentials jwtWithClaims(JwtClaims jwtClaims) {
        ...
        return JwtCredentials.newBuilder().setPrivateKey(this.privateKey).setPrivateKeyId(this.privateKeyId).setJwtClaims(subject.build().merge(jwtClaims)).setLifeSpanSeconds(Long.valueOf(LIFE_SPAN_SECS)).m41630b(this.clock).build();
    }
    ...
    public static ServiceAccountJwtAccessCredentials fromPkcs8(String str, String str2, String str3, String str4, URI uri, String str5) throws IOException {
        return new ServiceAccountJwtAccessCredentials(str, str2, IJ0.m68031d(str3), str4, uri, str5);
    }
}