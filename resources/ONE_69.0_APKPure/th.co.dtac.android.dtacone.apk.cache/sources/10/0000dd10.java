...
public final class JvmBuiltInsSignatures {
    ...
    static {
        ...
        f68648e = BH1.plus(plus, (Iterable) signatureBuildingComponents.inJavaLang("String", (String[]) Arrays.copyOf(constructors2, constructors2.length)));
        String[] constructors3 = signatureBuildingComponents.constructors("Ljava/lang/String;Ljava/lang/Throwable;ZZ");
        f68649f = signatureBuildingComponents.inJavaLang("Throwable", (String[]) Arrays.copyOf(constructors3, constructors3.length));
    }

    /* renamed from: a */
    public final Set m28866a() {
        SignatureBuildingComponents signatureBuildingComponents = SignatureBuildingComponents.INSTANCE;
        ...
        for (JvmPrimitiveType jvmPrimitiveType2 : CollectionsKt__CollectionsKt.listOf((Object[]) jvmPrimitiveTypeArr)) {
            ...
            AbstractC10396hs.addAll(linkedHashSet, signatureBuildingComponents.inJavaLang(asString, (String[]) Arrays.copyOf(constructors, constructors.length)));
        }
        return linkedHashSet;
    }

    /* renamed from: b */
    public final Set m28865b() {
        SignatureBuildingComponents signatureBuildingComponents = SignatureBuildingComponents.INSTANCE;
        ...
        for (JvmPrimitiveType jvmPrimitiveType : CollectionsKt__CollectionsKt.listOf((Object[]) jvmPrimitiveTypeArr)) {
            ...
            Intrinsics.checkNotNullExpressionValue(asString, "it.wrapperFqName.shortName().asString()");
            AbstractC10396hs.addAll(linkedHashSet, signatureBuildingComponents.inJavaLang(asString, jvmPrimitiveType.getJavaKeywordName() + "Value()" + jvmPrimitiveType.getDesc()));
        }
        return linkedHashSet;
    }
