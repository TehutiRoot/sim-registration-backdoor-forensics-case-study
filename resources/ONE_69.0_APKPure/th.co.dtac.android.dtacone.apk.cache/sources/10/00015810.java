...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_change_sim.MrtrChangeSimValidateViewModel$checkOwner$3 */
/* loaded from: classes9.dex */
public final class MrtrChangeSimValidateViewModel$checkOwner$3 extends Lambda implements Function1<StatusResponse, Unit> {
    final /* synthetic */ boolean $isSmartCard;
    final /* synthetic */ MrtrChangeSimValidateViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrChangeSimValidateViewModel$checkOwner$3(boolean z, MrtrChangeSimValidateViewModel mrtrChangeSimValidateViewModel) {
        super(1);
        this.$isSmartCard = z;
    ...
    public final void invoke2(StatusResponse statusResponse) {
        ...
        if (this.$isSmartCard) {
            ...
            mrtrChangeSimRepository = mrtrChangeSimValidateViewModel.f106213b;
            mrtrChangeSimValidateViewModel.getPostCodeInfo(mrtrChangeSimRepository.getCardInformation());
            return;
        }
        this.this$0.getLiveDataState().setValue(StatusResource.DISMISS);
        mutableLiveData = this.this$0.f106228q;
        mutableLiveData.setValue(Resource.Companion.success(FirebaseAnalytics.Param.SUCCESS));
    }
}