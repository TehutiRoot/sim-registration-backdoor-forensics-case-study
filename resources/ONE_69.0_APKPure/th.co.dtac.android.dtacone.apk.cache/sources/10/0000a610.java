...
public abstract class JsonGenerator implements Closeable, Flushable {
    /* renamed from: b */
    public final void m41718b(boolean z, Object obj) {
        boolean z2;
        ClassInfo m41696of;
        boolean z3;
        if (obj == null) {
        ...
        if (Data.isNull(obj)) {
            ...
            if (obj instanceof Number) {
                ...
                String name = FieldInfo.m41688of((Enum) obj).getName();
                if (name == null) {
                    writeNull();
                } else {
                    writeString(name);
                ...
                if (z2) {
                    ...
                    m41696of = ClassInfo.m41696of(cls);
                }
                for (Map.Entry<String, Object> entry : Data.mapOf(obj).entrySet()) {
                    ...
                    if (value != null) {
                        ...
                        if (z2) {
                            ...
                            Field field = m41696of.getField(key);
