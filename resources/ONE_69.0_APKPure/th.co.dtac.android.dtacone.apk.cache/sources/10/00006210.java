...
public final class ModifierLocalManager {
    ...
    /* renamed from: a */
    public final Owner f30261a;

    /* renamed from: b */
    public final MutableVector f30262b;

    /* renamed from: c */
    public final MutableVector f30263c;

    /* renamed from: d */
    public final MutableVector f30264d;

    /* renamed from: e */
    public final MutableVector f30265e;
    ...
    public ModifierLocalManager(@NotNull Owner owner) {
        ...
        this.f30261a = owner;
        this.f30262b = new MutableVector(new BackwardsCompatNode[16], 0);
        this.f30263c = new MutableVector(new ModifierLocal[16], 0);
        this.f30264d = new MutableVector(new LayoutNode[16], 0);
        this.f30265e = new MutableVector(new ModifierLocal[16], 0);
    }

    /* renamed from: a */
    public final void m59469a(Modifier.Node node, ModifierLocal modifierLocal, Set set) {
        int m73145constructorimpl = NodeKind.m73145constructorimpl(32);
        if (node.getNode().isAttached()) {
            MutableVector mutableVector = new MutableVector(new Modifier.Node[16], 0);
            Modifier.Node child$ui_release = node.getNode().getChild$ui_release();
            if (child$ui_release == null) {
                DelegatableNodeKt.m59460a(mutableVector, node.getNode());
            } else {
                mutableVector.add(child$ui_release);
            }
            while (mutableVector.isNotEmpty()) {
                Modifier.Node node2 = (Modifier.Node) mutableVector.removeAt(mutableVector.getSize() - 1);
                if ((node2.getAggregateChildKindSet$ui_release() & m73145constructorimpl) != 0) {
                    for (Modifier.Node node3 = node2; node3 != null; node3 = node3.getChild$ui_release()) {
                        if ((node3.getKindSet$ui_release() & m73145constructorimpl) != 0) {
                            ...
                            while (node4 != null) {
                                ...
                                } else if ((node4.getKindSet$ui_release() & m73145constructorimpl) != 0 && (node4 instanceof DelegatingNode)) {
                                    int i = 0;
                                ...
                                node4 = DelegatableNodeKt.m59459b(mutableVector2);
                            }
                            continue;
                        }
                    }
                }
                DelegatableNodeKt.m59460a(mutableVector, node2);
            }
            return;
        }
    ...
    public final void insertedProvider(@NotNull BackwardsCompatNode node, @NotNull ModifierLocal<?> key) {
        ...
        this.f30262b.add(node);
        this.f30263c.add(key);
        invalidate();
    }
    ...
    public final void invalidate() {
        if (!this.f30266f) {
            this.f30266f = true;
            this.f30261a.registerOnEndApplyChangesListener(new ModifierLocalManager$invalidate$1(this));
        }
    }
    ...
    public final void removedProvider(@NotNull BackwardsCompatNode node, @NotNull ModifierLocal<?> key) {
        Intrinsics.checkNotNullParameter(node, "node");
        Intrinsics.checkNotNullParameter(key, "key");
        this.f30264d.add(DelegatableNodeKt.requireLayoutNode(node));
        this.f30265e.add(key);
        invalidate();
    }
    ...
    */
    public final void triggerUpdates() {
        /*
            ...
            r1.<init>()
            androidx.compose.runtime.collection.MutableVector r2 = r8.f30264d
            int r3 = r2.getSize()
            if (r3 <= 0) goto L40
        ...
        L15:
            ...
            androidx.compose.runtime.collection.MutableVector r6 = r8.f30265e
        ...
        L40:
            androidx.compose.runtime.collection.MutableVector r2 = r8.f30264d
            r2.clear()
            androidx.compose.runtime.collection.MutableVector r2 = r8.f30265e
            r2.clear()
            androidx.compose.runtime.collection.MutableVector r2 = r8.f30262b
            int r3 = r2.getSize()
            if (r3 <= 0) goto L71
            java.lang.Object[] r2 = r2.getContent()
        L56:
            ...
            androidx.compose.runtime.collection.MutableVector r5 = r8.f30263c
        ...
        L6d:
            ...
            if (r0 < r3) goto L56
        L71:
            androidx.compose.runtime.collection.MutableVector r0 = r8.f30262b
            r0.clear()
            androidx.compose.runtime.collection.MutableVector r0 = r8.f30263c
            r0.clear()
