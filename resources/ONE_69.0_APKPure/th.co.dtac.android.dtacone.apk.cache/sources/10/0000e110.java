...
public final class CapturedTypeConstructorKt {
    /* renamed from: a */
    public static final TypeProjection m28051a(TypeProjection typeProjection, TypeParameterDescriptor typeParameterDescriptor) {
    ...
    public static final TypeSubstitution wrapWithCapturingSubstitution(@NotNull TypeSubstitution typeSubstitution, final boolean z) {
        ...
        if (typeSubstitution instanceof IndexedParametersSubstitution) {
            ...
            for (Pair pair : zip) {
                arrayList.add(m28051a((TypeProjection) pair.getFirst(), (TypeParameterDescriptor) pair.getSecond()));
            }
        ...
        return new DelegatedTypeSubstitution(typeSubstitution) { // from class: kotlin.reflect.jvm.internal.impl.resolve.calls.inference.CapturedTypeConstructorKt$wrapWithCapturingSubstitution$2
            ...
            public TypeProjection get(@NotNull KotlinType key) {
                ...
                m28051a = CapturedTypeConstructorKt.m28051a(typeProjection, typeParameterDescriptor);
                return m28051a;
            }
        };
    }
