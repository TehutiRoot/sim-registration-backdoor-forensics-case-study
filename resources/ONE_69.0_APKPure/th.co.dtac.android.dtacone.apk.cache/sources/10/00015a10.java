...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_prepaid_registration.MrtrPrepaidRegistrationViewModel$saveFamilySim$2$2 */
/* loaded from: classes9.dex */
public final class MrtrPrepaidRegistrationViewModel$saveFamilySim$2$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ MrtrPrepaidRegistrationViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrPrepaidRegistrationViewModel$saveFamilySim$2$2(MrtrPrepaidRegistrationViewModel mrtrPrepaidRegistrationViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable it) {
        ...
        mrtrErrorService.handleException(it, new MrtrErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.viewmodel.mrtr_prepaid_registration.MrtrPrepaidRegistrationViewModel$saveFamilySim$2$2.1
            ...
            public void handle(@Nullable Throwable th2) {
                ...
                if (!(th2 instanceof HttpException) || ((HttpException) th2).code() != 404) {
                    ...
                    MrtrPrepaidRegistrationViewModel.this.setSaveFamilySimError(errorCollection);
                }
