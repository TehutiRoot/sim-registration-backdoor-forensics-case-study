...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.pre2post.fragment.OnePre2PostInputIMEIFragment$setupObserve$1$1 */
/* loaded from: classes10.dex */
public final class OnePre2PostInputIMEIFragment$setupObserve$1$1 extends Lambda implements Function1<Resource<? extends GetNewIMEIResponse>, Unit> {
    final /* synthetic */ OnePre2PostInputIMEIFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.pre2post.fragment.OnePre2PostInputIMEIFragment$setupObserve$1$1$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OnePre2PostInputIMEIFragment$setupObserve$1$1(OnePre2PostInputIMEIFragment onePre2PostInputIMEIFragment) {
        super(1);
    ...
    public final void invoke2(Resource<GetNewIMEIResponse> resource) {
        ...
        if (i == 1) {
            onePre2PostInputIMEIFragment.showLoading();
        } else if (i == 2) {
            onePre2PostInputIMEIFragment.dismissLoading();
            m11396o = onePre2PostInputIMEIFragment.m11396o();
            m11396o.showChangeIMEIDialog();
        } else if (i != 3) {
            onePre2PostInputIMEIFragment.dismissLoading();
        } else {
            onePre2PostInputIMEIFragment.dismissLoading();
