...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.onlineRegister.fragment.OneOnlineRegistrationInputNumberFragment$setObserve$3 */
/* loaded from: classes10.dex */
public final class OneOnlineRegistrationInputNumberFragment$setObserve$3 extends Lambda implements Function1<Resource<? extends String>, Unit> {
    final /* synthetic */ OneOnlineRegistrationInputNumberFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.onlineRegister.fragment.OneOnlineRegistrationInputNumberFragment$setObserve$3$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneOnlineRegistrationInputNumberFragment$setObserve$3(OneOnlineRegistrationInputNumberFragment oneOnlineRegistrationInputNumberFragment) {
        super(1);
    ...
    public final void invoke2(Resource<String> resource) {
        ...
        if (i == 1) {
            ...
            oneOnlineRegistrationInputNumberFragment.f92700s = data;
