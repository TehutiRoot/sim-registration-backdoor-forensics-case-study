...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.deviceSaleTrueCompany.viewModel.OneDeviceSaleTrueViewModel$checkPrivilege$3 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleTrueViewModel$checkPrivilege$3 extends Lambda implements Function1<OneCheckPrivilegeResponse, Unit> {
    final /* synthetic */ OneDeviceSaleTrueViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneDeviceSaleTrueViewModel$checkPrivilege$3(OneDeviceSaleTrueViewModel oneDeviceSaleTrueViewModel) {
        super(1);
