...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.forgot_password.fragment.OneInputForgotPasswordFragment$initViewModel$1$1 */
/* loaded from: classes10.dex */
public final class OneInputForgotPasswordFragment$initViewModel$1$1 extends Lambda implements Function1<Resource<? extends Void>, Unit> {
    final /* synthetic */ OneForgotPasswordViewModel $this_with;
    final /* synthetic */ OneInputForgotPasswordFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneInputForgotPasswordFragment$initViewModel$1$1(OneInputForgotPasswordFragment oneInputForgotPasswordFragment, OneForgotPasswordViewModel oneForgotPasswordViewModel) {
        super(1);
    ...
    public final void invoke2(Resource<Void> resource) {
        ...
        if (resource != null) {
            ...
            if (resource.getStatus() == StatusResource.SUCCESS) {
                ...
                m14302o.edtVerifyOTP.enableEditText(true);
                m14302o2 = oneInputForgotPasswordFragment.m14302o();
                m14302o2.edtVerifyOTP.setText("");
                m14302o3 = oneInputForgotPasswordFragment.m14302o();
                m14302o3.edtVerifyOTP.showSoftKeyboard();
                oneForgotPasswordViewModel.clearNextStepRequestOtp();
            }
        }
    }
}