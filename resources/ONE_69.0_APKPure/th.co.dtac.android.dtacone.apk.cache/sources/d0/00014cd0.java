...
@SourceDebugExtension({"SMAP\nESimPrepaidFormFragment.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ESimPrepaidFormFragment.kt\nth/co/dtac/android/dtacone/view/fragment/eSIM/form/ESimPrepaidFormFragment$setUpViewModel$1$1\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,307:1\n1#2:308\n*E\n"})
/* renamed from: th.co.dtac.android.dtacone.view.fragment.eSIM.form.ESimPrepaidFormFragment$setUpViewModel$1$1 */
/* loaded from: classes9.dex */
public final class ESimPrepaidFormFragment$setUpViewModel$1$1 extends Lambda implements Function1<FragmentNavEvent, Unit> {
    final /* synthetic */ ESimPrepaidFormFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimPrepaidFormFragment$setUpViewModel$1$1(ESimPrepaidFormFragment eSimPrepaidFormFragment) {
        super(1);
    ...
    public final void invoke2(@NotNull FragmentNavEvent it) {
        ...
        m7484r.addFragment(it.buildFragment(), it.getTag());
    }
}