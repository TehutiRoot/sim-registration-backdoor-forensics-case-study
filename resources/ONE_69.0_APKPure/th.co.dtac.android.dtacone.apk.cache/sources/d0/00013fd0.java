...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.stvProSermOnline.fragment.OneProsermOnlineConfirmFragment$setupViewModel$8 */
/* loaded from: classes10.dex */
public final class OneProsermOnlineConfirmFragment$setupViewModel$8 extends Lambda implements Function1<Resource<? extends Pair<? extends String, ? extends OneBuyDolPriceListSimRModel>>, Unit> {
    final /* synthetic */ OneProsermOnlineConfirmFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.stvProSermOnline.fragment.OneProsermOnlineConfirmFragment$setupViewModel$8$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneProsermOnlineConfirmFragment$setupViewModel$8(OneProsermOnlineConfirmFragment oneProsermOnlineConfirmFragment) {
        super(1);
    ...
    public final void invoke2(Resource<Pair<String, OneBuyDolPriceListSimRModel>> resource) {
        ...
        if (data != null) {
            ...
            if (Intrinsics.areEqual(data.getFirst(), PermissionConstant.M_BUY_DOL)) {
                oneProsermOnlineConfirmFragment.m9834o(second);
            }
        }
    }
}