...
public final class LazyStaggeredGridMeasureContext {
    ...
    /* renamed from: g */
    public final LazyLayoutMeasureScope f13820g;
    ...
    /* renamed from: n */
    public final LazyStaggeredGridMeasureProvider f13827n;

    /* renamed from: o */
    public final LazyStaggeredGridLaneInfo f13828o;
    ...
    public final long m69837getConstraintsmsEJaDk() {
        return this.f13818e;
    }

    /* renamed from: getContentOffset-nOcc-ac  reason: not valid java name */
    public final long m69838getContentOffsetnOccac() {
        return this.f13822i;
    }
    ...
    public final int m69839getLaneInfoSZVOQXA(long j) {
        int i = (int) (j >> 32);
    ...
    public final long m69840getSpanRangelOCCd4c(@NotNull LazyStaggeredGridItemProvider getSpanRange, int i, int i2) {
        int i3;
        ...
        return SpanRange.m69847constructorimpl(i2, i3);
    }
    ...
    public final boolean m69841isFullSpanSZVOQXA(long j) {
    ...
    public LazyStaggeredGridMeasureContext(LazyStaggeredGridState state, List pinnedItems, final LazyStaggeredGridItemProvider itemProvider, final LazyStaggeredGridSlots resolvedSlots, long j, final boolean z, final LazyLayoutMeasureScope measureScope, int i, long j2, int i2, int i3, boolean z2, int i4) {
        ...
        this.f13814a = state;
        this.f13815b = pinnedItems;
        this.f13816c = itemProvider;
        this.f13817d = resolvedSlots;
        this.f13818e = j;
        this.f13819f = z;
        this.f13820g = measureScope;
        this.f13821h = i;
        this.f13822i = j2;
        this.f13823j = i2;
        this.f13824k = i3;
        this.f13825l = z2;
        this.f13826m = i4;
        this.f13827n = new LazyStaggeredGridMeasureProvider(z, itemProvider, measureScope, resolvedSlots) { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasureContext$measuredItemProvider$1
        ...
        this.f13828o = state.getLaneInfo$foundation_release();
        this.f13829p = resolvedSlots.getSizes().length;
    }
}