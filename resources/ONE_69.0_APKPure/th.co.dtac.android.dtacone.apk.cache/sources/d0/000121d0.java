...
/* renamed from: th.co.dtac.android.dtacone.presenter.bitmap.SaveBitmapPresenter$saveCustomerBitmap$5 */
/* loaded from: classes8.dex */
public final class SaveBitmapPresenter$saveCustomerBitmap$5 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ SaveBitmapPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SaveBitmapPresenter$saveCustomerBitmap$5(SaveBitmapPresenter saveBitmapPresenter) {
        super(1);
