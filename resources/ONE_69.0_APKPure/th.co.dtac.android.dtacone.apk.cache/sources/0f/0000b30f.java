...
public final class RemoteSettings implements SettingsProvider {
    ...
    /* renamed from: g */
    public static final C8656a f56620g = new C8656a(null);

    /* renamed from: a */
    public final CoroutineContext f56621a;

    /* renamed from: b */
    public final FirebaseInstallationsApi f56622b;

    /* renamed from: c */
    public final ApplicationInfo f56623c;

    /* renamed from: d */
    public final CrashlyticsSettingsFetcher f56624d;

    /* renamed from: e */
    public final Lazy f56625e;

    /* renamed from: f */
    public final Mutex f56626f;
    ...
    public RemoteSettings(@NotNull CoroutineContext backgroundDispatcher, @NotNull FirebaseInstallationsApi firebaseInstallationsApi, @NotNull ApplicationInfo appInfo, @NotNull CrashlyticsSettingsFetcher configsFetcher, @NotNull DataStore<Preferences> dataStore) {
        ...
        this.f56621a = backgroundDispatcher;
        this.f56622b = firebaseInstallationsApi;
        this.f56623c = appInfo;
        this.f56624d = configsFetcher;
        this.f56625e = LazyKt__LazyJVMKt.lazy(new RemoteSettings$settingsCache$2(dataStore));
        this.f56626f = MutexKt.Mutex$default(false, 1, null);
    }

    /* renamed from: a */
    public final SettingsCache m37596a() {
        return (SettingsCache) this.f56625e.getValue();
    }

    /* renamed from: b */
    public final String m37595b(String str) {
        return new Regex(FORWARD_SLASH_STRING).replace(str, "");
    }

    @VisibleForTesting
    public final void clearCachedSettings$com_google_firebase_firebase_sessions() {
        AbstractC1539Vc.m65885e(CoroutineScopeKt.CoroutineScope(this.f56621a), null, null, new RemoteSettings$clearCachedSettings$1(this, null), 3, null);
    }

    @Override // com.google.firebase.sessions.settings.SettingsProvider
    @Nullable
    public Double getSamplingRate() {
        return m37596a().sessionSamplingRate();
    }

    @Override // com.google.firebase.sessions.settings.SettingsProvider
    @Nullable
    public Boolean getSessionEnabled() {
        return m37596a().sessionsEnabled();
    }
    ...
    public Duration mo74238getSessionRestartTimeoutFghU774() {
        Integer sessionRestartTimeout = m37596a().sessionRestartTimeout();
        if (sessionRestartTimeout != null) {
            Duration.Companion companion = Duration.Companion;
            return Duration.m74711boximpl(DurationKt.toDuration(sessionRestartTimeout.intValue(), DurationUnit.SECONDS));
        }
        return null;
    }
    ...
    public boolean isSettingsStale() {
        return m37596a().hasCacheExpired$com_google_firebase_firebase_sessions();
    }
