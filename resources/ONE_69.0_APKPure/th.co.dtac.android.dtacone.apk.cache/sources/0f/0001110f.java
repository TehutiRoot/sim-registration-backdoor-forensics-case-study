...
public final class OneChangePasswordRepositoryImpl implements OneChangePasswordRepository {
    ...
    /* renamed from: a */
    public final RTRApiRx2 f82442a;

    /* renamed from: b */
    public final ConfigurationRepository f82443b;

    /* renamed from: c */
    public OneChangePasswordModel f82444c;
    ...
    public OneChangePasswordRepositoryImpl(@NotNull RTRApiRx2 api, @NotNull ConfigurationRepository configurationRepository) {
        ...
        this.f82442a = api;
        this.f82443b = configurationRepository;
        this.f82444c = new OneChangePasswordModel(null, 1, null);
    }
    ...
    public Single<ChangePasswordResponse> checkChangePassword(@NotNull ChangePasswordRequest request) {
        ...
        return this.f82442a.checkChangePassword(request);
    }
    ...
    public String decryptCBC(@NotNull String cipher) {
        ...
        return AESCryptUtil.decryptCBC(cipher, this.f82443b.dataPrivacyEncryptionAES256CBCKey());
    }
    ...
    public String encryptCBC(@NotNull String text) {
        ...
        return AESCryptUtil.encryptCBC(text, this.f82443b.dataPrivacyEncryptionAES256CBCKey());
    }
    ...
    public String encryptPhoneNumberString(@Nullable String str) {
        if (str != null && str.length() != 0) {
            ...
            return AESCryptUtil.encryptCBC(removeAllSpecialCharacter, this.f82443b.dataPrivacyEncryptionAES256CBCKey());
        }
        return "";
    }
    ...
    public OneChangePassword getChangePasswordData() {
        return this.f82444c.getChangePasswordData();
    }

    @Override // th.p047co.dtac.android.dtacone.app_one.repository.OneChangePasswordRepository
    public void setChangePasswordData(@Nullable OneChangePassword oneChangePassword) {
        this.f82444c.setChangePasswordData(oneChangePassword);
    }
}