...
@SourceDebugExtension({"SMAP\nMrtrPostpaidRegistrationViewModel.kt\nKotlin\n*S Kotlin\n*F\n+ 1 MrtrPostpaidRegistrationViewModel.kt\nth/co/dtac/android/dtacone/viewmodel/mrtr_postpaid_registration/MrtrPostpaidRegistrationViewModel$uploadImage$5\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,1909:1\n1#2:1910\n*E\n"})
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_postpaid_registration.MrtrPostpaidRegistrationViewModel$uploadImage$5 */
/* loaded from: classes9.dex */
public final class MrtrPostpaidRegistrationViewModel$uploadImage$5 extends Lambda implements Function1<UploadImageResponse, Unit> {
    final /* synthetic */ MrtrPostpaidRegistrationViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrPostpaidRegistrationViewModel$uploadImage$5(MrtrPostpaidRegistrationViewModel mrtrPostpaidRegistrationViewModel) {
        super(1);
    ...
    public final void invoke2(UploadImageResponse uploadImageResponse) {
        ...
        if (filename != null) {
            ...
            mrtrPostpaidRepository.getAttachmentNames().add(filename);
        }
    }
}