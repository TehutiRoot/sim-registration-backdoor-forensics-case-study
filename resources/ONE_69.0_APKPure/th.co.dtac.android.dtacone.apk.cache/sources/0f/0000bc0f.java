...
public class getPrivateKey implements setDarkTextColor.valueOf {
    private final setDarkTextColor.ThreeDS2Service get;
    private final setDarkTextColor valueOf;

    public getPrivateKey(setDarkTextColor setdarktextcolor, setDarkTextColor.ThreeDS2Service threeDS2Service) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.onCompleted(this.valueOf, this.get);
    }
}