...
public final class PagerDefaults {
    ...
    public final SnapFlingBehavior m69858flingBehaviorPfoAEA0(@NotNull PagerState state, @Nullable PagerSnapDistance pagerSnapDistance, @Nullable AnimationSpec<Float> animationSpec, @Nullable DecayAnimationSpec<Float> decayAnimationSpec, @Nullable AnimationSpec<Float> animationSpec2, float f, float f2, @Nullable Composer composer, int i, int i2) {
        ...
        float f3;
        float f4;
        SnapLayoutInfoProvider m61075a;
        ...
        if (0.0f <= f4 && f4 <= 1.0f) {
            ...
            if (z || rememberedValue == Composer.Companion.getEmpty()) {
                m61075a = PagerKt.m61075a(state, pagerSnapDistance2, decayAnimationSpec2, f4);
                rememberedValue = new SnapFlingBehavior(m61075a, tweenSpec, decayAnimationSpec2, springSpec, density, f3, null);
    ...
    public final NestedScrollConnection pageNestedScrollConnection(@NotNull Orientation orientation) {
        ...
        if (orientation == Orientation.Horizontal) {
            c13311rx2 = PagerKt.f13935a;
            return c13311rx2;
        }
        c13311rx = PagerKt.f13936b;
        return c13311rx;
    }
}