...
public abstract class ViewTimeCycle extends TimeCycleSplineSet {
    ...
    public static class CustomSet extends ViewTimeCycle {
        ...
        /* renamed from: b */
        public SparseArray f32764b;

        /* renamed from: c */
        public SparseArray f32765c = new SparseArray();
        ...
        public CustomSet(String str, SparseArray<ConstraintAttribute> sparseArray) {
            this.f32763a = str.split(",")[1];
            this.f32764b = sparseArray;
        }
        ...
        public boolean setProperty(View view, float f, long j, KeyCache keyCache) {
            boolean z;
            this.mCurveFit.getPos(f, this.f32766d);
            float[] fArr = this.f32766d;
            float f2 = fArr[fArr.length - 2];
            float f3 = fArr[fArr.length - 1];
            long j2 = j - this.last_time;
            if (Float.isNaN(this.last_cycle)) {
                float floatValue = keyCache.getFloatValue(view, this.f32763a, 0);
            ...
            int i = 0;
            while (true) {
                float[] fArr2 = this.f32767e;
                if (i >= fArr2.length) {
                    break;
                }
                boolean z2 = this.mContinue;
                float f5 = this.f32766d[i];
                if (f5 != 0.0d) {
                    z = true;
                } else {
                    z = false;
            ...
            CustomSupport.setInterpolatedValue((ConstraintAttribute) this.f32764b.valueAt(0), view, this.f32767e);
            if (f2 != 0.0f) {
                this.mContinue = true;
            }
        ...
        public void setup(int i) {
            int size = this.f32764b.size();
            int numberOfInterpolatedValues = ((ConstraintAttribute) this.f32764b.valueAt(0)).numberOfInterpolatedValues();
            double[] dArr = new double[size];
            int i2 = numberOfInterpolatedValues + 2;
            this.f32766d = new float[i2];
            this.f32767e = new float[numberOfInterpolatedValues];
            double[][] dArr2 = (double[][]) Array.newInstance(Double.TYPE, size, i2);
            for (int i3 = 0; i3 < size; i3++) {
                int keyAt = this.f32764b.keyAt(i3);
                float[] fArr = (float[]) this.f32765c.valueAt(i3);
                dArr[i3] = keyAt * 0.01d;
                ((ConstraintAttribute) this.f32764b.valueAt(i3)).getValuesToInterpolate(this.f32766d);
                int i4 = 0;
                while (true) {
                    float[] fArr2 = this.f32766d;
                    if (i4 < fArr2.length) {
        ...
        public void setPoint(int i, ConstraintAttribute constraintAttribute, float f, int i2, float f2) {
            this.f32764b.append(i, constraintAttribute);
            this.f32765c.append(i, new float[]{f, f2});
    ...
    /* loaded from: classes2.dex */
    public static class C3715a extends ViewTimeCycle {
        @Override // androidx.constraintlayout.motion.utils.ViewTimeCycle
        public boolean setProperty(View view, float f, long j, KeyCache keyCache) {
    ...
    /* loaded from: classes2.dex */
    public static class C3716b extends ViewTimeCycle {
        @Override // androidx.constraintlayout.motion.utils.ViewTimeCycle
        public boolean setProperty(View view, float f, long j, KeyCache keyCache) {
    ...
    /* loaded from: classes2.dex */
    public static class C3717c extends ViewTimeCycle {
    ...
    /* loaded from: classes2.dex */
    public static class C3718d extends ViewTimeCycle {
        @Override // androidx.constraintlayout.motion.utils.ViewTimeCycle
        public boolean setProperty(View view, float f, long j, KeyCache keyCache) {
    ...
    /* loaded from: classes2.dex */
    public static class C3719e extends ViewTimeCycle {
        @Override // androidx.constraintlayout.motion.utils.ViewTimeCycle
        public boolean setProperty(View view, float f, long j, KeyCache keyCache) {
    ...
    /* loaded from: classes2.dex */
    public static class C3720f extends ViewTimeCycle {
        @Override // androidx.constraintlayout.motion.utils.ViewTimeCycle
        public boolean setProperty(View view, float f, long j, KeyCache keyCache) {
    ...
    /* loaded from: classes2.dex */
    public static class C3721g extends ViewTimeCycle {
        @Override // androidx.constraintlayout.motion.utils.ViewTimeCycle
        public boolean setProperty(View view, float f, long j, KeyCache keyCache) {
    ...
    /* loaded from: classes2.dex */
    public static class C3722h extends ViewTimeCycle {
        @Override // androidx.constraintlayout.motion.utils.ViewTimeCycle
        public boolean setProperty(View view, float f, long j, KeyCache keyCache) {
    ...
    /* loaded from: classes2.dex */
    public static class C3723i extends ViewTimeCycle {
        @Override // androidx.constraintlayout.motion.utils.ViewTimeCycle
        public boolean setProperty(View view, float f, long j, KeyCache keyCache) {
    ...
    /* loaded from: classes2.dex */
    public static class C3724j extends ViewTimeCycle {
        @Override // androidx.constraintlayout.motion.utils.ViewTimeCycle
        public boolean setProperty(View view, float f, long j, KeyCache keyCache) {
    ...
    /* loaded from: classes2.dex */
    public static class C3725k extends ViewTimeCycle {
        @Override // androidx.constraintlayout.motion.utils.ViewTimeCycle
        public boolean setProperty(View view, float f, long j, KeyCache keyCache) {
