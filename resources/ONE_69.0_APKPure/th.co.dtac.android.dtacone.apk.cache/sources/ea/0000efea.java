...
public class QueueInputStream extends InputStream {
    ...
    /* renamed from: a */
    public final BlockingQueue f73488a;
    ...
    public static class Builder extends AbstractStreamBuilder<QueueInputStream, Builder> {
        ...
        /* renamed from: k */
        public BlockingQueue f73490k = new LinkedBlockingQueue();

        /* renamed from: l */
        public Duration f73491l;

        public Builder() {
            Duration duration;
            duration = Duration.ZERO;
            this.f73491l = duration;
        }
        ...
        public QueueInputStream get() {
            return new QueueInputStream(this.f73490k, this.f73491l);
        }
    }
    ...
    public QueueOutputStream newQueueOutputStream() {
        return new QueueOutputStream(this.f73488a);
    }

    @Override // java.io.InputStream
    public int read() {
        try {
            Integer num = (Integer) this.f73488a.poll(this.f73489b, TimeUnit.NANOSECONDS);
            if (num == null) {
                return -1;
            }
    ...
    */
    ...
    public QueueInputStream(BlockingQueue blockingQueue, Duration duration) {
        ...
        this.f73488a = blockingQueue;
        Objects.requireNonNull(duration, "timeout");
        nanos = EJ0.m68667a(duration).toNanos();
        this.f73489b = nanos;
    }
}