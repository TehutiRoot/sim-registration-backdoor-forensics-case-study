...
public final class Strings {
    /* renamed from: a */
    public static String m41262a(Object obj) {
        if (obj == null) {
    ...
    /* renamed from: b */
    public static boolean m41261b(CharSequence charSequence, int i) {
    ...
    public static String commonPrefix(CharSequence charSequence, CharSequence charSequence2) {
        ...
        int i2 = i - 1;
        if (m41261b(charSequence, i2) || m41261b(charSequence2, i2)) {
            i--;
        }
    ...
    public static String commonSuffix(CharSequence charSequence, CharSequence charSequence2) {
        ...
        if (m41261b(charSequence, (charSequence.length() - i) - 1) || m41261b(charSequence2, (charSequence2.length() - i) - 1)) {
            i--;
        }
    ...
    public static String emptyToNull(@CheckForNull String str) {
        return AbstractC7444a.m41243b(str);
    }

    public static boolean isNullOrEmpty(@CheckForNull String str) {
        return AbstractC7444a.m41236i(str);
    }
    ...
    public static String nullToEmpty(@CheckForNull String str) {
        return AbstractC7444a.m41239f(str);
    }
