...
@Metadata(m29143d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m29142d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_insertPageBreak", "Landroidx/compose/material/icons/Icons$TwoTone;", "getInsertPageBreak", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "InsertPageBreak", "material-icons-extended_release"}, m29141k = 2, m29140mv = {1, 8, 0})
...
public final class InsertPageBreakKt {
    ...
    /* renamed from: a */
    public static ImageVector f24296a;

    @NotNull
    public static final ImageVector getInsertPageBreak(@NotNull Icons.TwoTone twoTone) {
        Intrinsics.checkNotNullParameter(twoTone, "<this>");
        ImageVector imageVector = f24296a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.InsertPageBreak", C3623Dp.m73842constructorimpl(24.0f), C3623Dp.m73842constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder5.moveTo(17.0f, 13.0f);
        ...
        pathBuilder6.moveTo(1.0f, 13.0f);
        ...
        pathBuilder7.moveTo(6.0f, 17.0f);
        pathBuilder7.horizontalLineToRelative(12.0f);
        pathBuilder7.verticalLineToRelative(3.0f);
        pathBuilder7.horizontalLineToRelative(-12.0f);
        pathBuilder7.close();
        ImageVector build = ImageVector.Builder.m72432addPathoIyEayM$default(builder, pathBuilder7.getNodes(), defaultFillType7, "", solidColor7, 0.3f, null, 0.3f, 1.0f, m72227getButtKaPHkGw7, m72237getBevelLxFBmk87, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
        f24296a = build;
