...
/* renamed from: th.co.dtac.android.dtacone.databinding.FragmentOneDevicesaleSelectDiscountBinding */
/* loaded from: classes7.dex */
public final class FragmentOneDevicesaleSelectDiscountBinding implements ViewBinding {

    /* renamed from: a */
    public final ConstraintLayout f84049a;
    @NonNull
    ...
    public FragmentOneDevicesaleSelectDiscountBinding(ConstraintLayout constraintLayout, CardView cardView, ConstraintLayout constraintLayout2, OneCustomClearableEditText oneCustomClearableEditText, DtacCardView dtacCardView, RecyclerView recyclerView, ImageView imageView, ConstraintLayout constraintLayout3, OneFontTextView oneFontTextView, OneFontTextView oneFontTextView2, OneFontTextView oneFontTextView3) {
        ...
        this.textViewNoDiscount = oneFontTextView3;
    }

    @NonNull
    public static FragmentOneDevicesaleSelectDiscountBinding bind(@NonNull View view) {
        int i = R.id.cardList;
                            ...
                            if (imageView != null) {
                                ...
                                if (oneFontTextView != null) {
                                    ...
                                    if (oneFontTextView2 != null) {
                                        i = R.id.textViewNoDiscount;
                                        OneFontTextView oneFontTextView3 = (OneFontTextView) ViewBindings.findChildViewById(view, i);
                                        if (oneFontTextView3 != null) {
                                            return new FragmentOneDevicesaleSelectDiscountBinding(constraintLayout2, cardView, constraintLayout, oneCustomClearableEditText, dtacCardView, recyclerView, imageView, constraintLayout2, oneFontTextView, oneFontTextView2, oneFontTextView3);
                                        }
                                    }
                                }
                            }
    ...
    @NonNull
    public static FragmentOneDevicesaleSelectDiscountBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static FragmentOneDevicesaleSelectDiscountBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.fragment_one_devicesale_select_discount, viewGroup, false);
        if (z) {
