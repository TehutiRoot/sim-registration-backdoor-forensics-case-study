...
public final class AuthProvider extends GeneratedMessageLite<AuthProvider, Builder> implements AuthProviderOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<AuthProvider, Builder> implements AuthProviderOrBuilder {
        public /* synthetic */ Builder(C7179a c7179a) {
            this();
        }

        public Builder addAllJwtLocations(Iterable<? extends JwtLocation> iterable) {
            copyOnWrite();
            ((AuthProvider) this.instance).m43372X(iterable);
            return this;
        }

        public Builder addJwtLocations(JwtLocation jwtLocation) {
            copyOnWrite();
            ((AuthProvider) this.instance).m43370Z(jwtLocation);
            return this;
        }

        public Builder clearAudiences() {
            copyOnWrite();
            ((AuthProvider) this.instance).m43369a0();
            return this;
        }

        public Builder clearAuthorizationUrl() {
            copyOnWrite();
            ((AuthProvider) this.instance).m43368b0();
            return this;
        }

        public Builder clearId() {
            copyOnWrite();
            ((AuthProvider) this.instance).m43367c0();
            return this;
        }

        public Builder clearIssuer() {
            copyOnWrite();
            ((AuthProvider) this.instance).m43366d0();
            return this;
        }

        public Builder clearJwksUri() {
            copyOnWrite();
            ((AuthProvider) this.instance).m43365e0();
            return this;
        }

        public Builder clearJwtLocations() {
            copyOnWrite();
            ((AuthProvider) this.instance).m43364f0();
            return this;
        }
        ...
        public Builder removeJwtLocations(int i) {
            copyOnWrite();
            ((AuthProvider) this.instance).m43362h0(i);
            return this;
        }

        public Builder setAudiences(String str) {
            copyOnWrite();
            ((AuthProvider) this.instance).m43361i0(str);
            return this;
        }

        public Builder setAudiencesBytes(ByteString byteString) {
            copyOnWrite();
            ((AuthProvider) this.instance).m43360j0(byteString);
            return this;
        }

        public Builder setAuthorizationUrl(String str) {
            copyOnWrite();
            ((AuthProvider) this.instance).m43359k0(str);
            return this;
        }

        public Builder setAuthorizationUrlBytes(ByteString byteString) {
            copyOnWrite();
            ((AuthProvider) this.instance).m43358l0(byteString);
            return this;
        }

        public Builder setId(String str) {
            copyOnWrite();
            ((AuthProvider) this.instance).m43357m0(str);
            return this;
        }

        public Builder setIdBytes(ByteString byteString) {
            copyOnWrite();
            ((AuthProvider) this.instance).m43356n0(byteString);
            return this;
        }

        public Builder setIssuer(String str) {
            copyOnWrite();
            ((AuthProvider) this.instance).m43355o0(str);
            return this;
        }

        public Builder setIssuerBytes(ByteString byteString) {
            copyOnWrite();
            ((AuthProvider) this.instance).m43354p0(byteString);
            return this;
        }

        public Builder setJwksUri(String str) {
            copyOnWrite();
            ((AuthProvider) this.instance).m43353q0(str);
            return this;
        }

        public Builder setJwksUriBytes(ByteString byteString) {
            copyOnWrite();
            ((AuthProvider) this.instance).m43352r0(byteString);
            return this;
        }

        public Builder setJwtLocations(int i, JwtLocation jwtLocation) {
            copyOnWrite();
            ((AuthProvider) this.instance).m43351s0(i, jwtLocation);
            return this;
        }
        ...
        public Builder addJwtLocations(int i, JwtLocation jwtLocation) {
            copyOnWrite();
            ((AuthProvider) this.instance).m43371Y(i, jwtLocation);
            return this;
        }

        public Builder setJwtLocations(int i, JwtLocation.Builder builder) {
            copyOnWrite();
            ((AuthProvider) this.instance).m43351s0(i, builder.build());
            return this;
        }

        public Builder addJwtLocations(JwtLocation.Builder builder) {
            copyOnWrite();
            ((AuthProvider) this.instance).m43370Z(builder.build());
            return this;
        }

        public Builder addJwtLocations(int i, JwtLocation.Builder builder) {
            copyOnWrite();
            ((AuthProvider) this.instance).m43371Y(i, builder.build());
            return this;
        }
    }
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C7179a {
        ...
        static {
            ...
            try {
                f51611a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f51611a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f51611a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f51611a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f51611a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f51611a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: X */
    public final void m43372X(Iterable iterable) {
        m43363g0();
        AbstractMessageLite.addAll(iterable, (List) this.jwtLocations_);
    }

    /* renamed from: Y */
    public final void m43371Y(int i, JwtLocation jwtLocation) {
    ...
    /* renamed from: Z */
    public final void m43370Z(JwtLocation jwtLocation) {
        jwtLocation.getClass();
        m43363g0();
    ...
    /* renamed from: a0 */
    public final void m43369a0() {
        this.audiences_ = getDefaultInstance().getAudiences();
    }

    /* renamed from: b0 */
    public final void m43368b0() {
        this.authorizationUrl_ = getDefaultInstance().getAuthorizationUrl();
    }

    /* renamed from: c0 */
    public final void m43367c0() {
        this.id_ = getDefaultInstance().getId();
    }

    /* renamed from: d0 */
    public final void m43366d0() {
        this.issuer_ = getDefaultInstance().getIssuer();
    }

    @Override // com.google.protobuf.GeneratedMessageLite
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C7179a.f51611a[methodToInvoke.ordinal()]) {
            case 1:
    ...
    /* renamed from: h0 */
    public final void m43362h0(int i) {
        m43363g0();
        this.jwtLocations_.remove(i);
    }

    /* renamed from: i0 */
    public final void m43361i0(String str) {
        str.getClass();
        this.audiences_ = str;
    }

    /* renamed from: j0 */
    public final void m43360j0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.audiences_ = byteString.toStringUtf8();
    }

    /* renamed from: k0 */
    public final void m43359k0(String str) {
        str.getClass();
        this.authorizationUrl_ = str;
    }

    /* renamed from: l0 */
    public final void m43358l0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.authorizationUrl_ = byteString.toStringUtf8();
    }

    /* renamed from: m0 */
    public final void m43357m0(String str) {
        str.getClass();
        this.id_ = str;
    }

    /* renamed from: n0 */
    public final void m43356n0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.id_ = byteString.toStringUtf8();
    }

    /* renamed from: o0 */
    public final void m43355o0(String str) {
        str.getClass();
        this.issuer_ = str;
    }

    /* renamed from: p0 */
    public final void m43354p0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.issuer_ = byteString.toStringUtf8();
    }

    /* renamed from: q0 */
    public final void m43353q0(String str) {
        str.getClass();
        this.jwksUri_ = str;
    }

    /* renamed from: r0 */
    public final void m43352r0(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.jwksUri_ = byteString.toStringUtf8();
    }

    /* renamed from: s0 */
    public final void m43351s0(int i, JwtLocation jwtLocation) {
        jwtLocation.getClass();
        m43363g0();
