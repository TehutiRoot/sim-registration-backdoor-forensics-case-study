...
public class EditProtocol {
    ...
    /* renamed from: e */
    public static final Class[] f58772e = new Class[0];

    /* renamed from: f */
    public static final List f58773f = Collections.emptyList();

    /* renamed from: a */
    public final Context f58774a;

    /* renamed from: b */
    public final ResourceIds f58775b;

    /* renamed from: c */
    public final ImageStore f58776c;

    /* renamed from: d */
    public final ViewVisitor.OnLayoutErrorListener f58777d;
    ...
    public EditProtocol(Context context, ResourceIds resourceIds, ImageStore imageStore, ViewVisitor.OnLayoutErrorListener onLayoutErrorListener) {
        ...
        this.f58775b = resourceIds;
        this.f58776c = imageStore;
        this.f58777d = onLayoutErrorListener;
    }

    /* renamed from: a */
    public final Object m33441a(Object obj, String str, List list) {
        try {
                ...
                if (!"int".equals(str) && !"java.lang.Integer".equals(str)) {
                    if (!TypedValues.Custom.S_FLOAT.equals(str) && !"java.lang.Float".equals(str)) {
                        if ("android.graphics.drawable.Drawable".equals(str)) {
                            return m33440b((JSONObject) obj, list);
                        }
    ...
    /* renamed from: b */
    public final Drawable m33440b(JSONObject jSONObject, List list) {
        int i;
        int i2;
        int i3;
        int i4;
        ...
        try {
            if (!jSONObject.isNull(ImagesContract.URL)) {
                ...
                if (jSONObject.isNull("dimensions")) {
                    ...
                    i = jSONObject2.getInt(OneNadOutboundSearchFragment.POSITION_LEFT);
                    i2 = jSONObject2.getInt(OneNadOutboundSearchFragment.POSITION_RIGHT);
                    i3 = jSONObject2.getInt("top");
                    i4 = jSONObject2.getInt("bottom");
                    z = true;
                }
                try {
                    Bitmap image = this.f58776c.getImage(string);
                    list.add(string);
    ...
    /* renamed from: c */
    public Edit m33439c(JSONObject jSONObject) {
        ViewVisitor layoutUpdateVisitor;
        Integer m33433i;
        String str;
        ArrayList arrayList = new ArrayList();
        try {
            List m33437e = m33437e(jSONObject.getJSONArray(ClientCookie.PATH_ATTR), this.f58775b);
            if (m33437e.size() != 0) {
                if (jSONObject.getString("change_type").equals("property")) {
                    String string = jSONObject.getJSONObject("property").getString("classname");
                    if (string != null) {
                        try {
                            C17458Cp1 m33436f = m33436f(Class.forName(string), jSONObject.getJSONObject("property"));
                            JSONArray jSONArray = jSONObject.getJSONArray("args");
                            Object[] objArr = new Object[jSONArray.length()];
                            for (int i = 0; i < jSONArray.length(); i++) {
                                JSONArray jSONArray2 = jSONArray.getJSONArray(i);
                                objArr[i] = m33441a(jSONArray2.get(0), jSONArray2.getString(1), arrayList);
                            }
                            C13108ph m68912a = m33436f.m68912a(objArr);
                            if (m68912a != null) {
                                layoutUpdateVisitor = new ViewVisitor.PropertySetVisitor(m33437e, m68912a, m33436f.f849c);
                            } else {
                                throw new BadInstructionsException("Can't update a read-only property " + m33436f.f847a + " (add a mutator to make this work)");
                            }
                    ...
                    for (int i2 = 0; i2 < length; i2++) {
                        ...
                        Integer m33433i2 = m33433i(-1, string2, this.f58775b);
                        if (string3.equals("0")) {
                            m33433i = 0;
                        } else if (string3.equals("-1")) {
                            m33433i = -1;
                        } else {
                            m33433i = m33433i(-1, string3, this.f58775b);
                        }
                        if (m33433i2 != null && m33433i != null) {
                            arrayList2.add(new ViewVisitor.LayoutRule(m33433i2.intValue(), optJSONObject.getInt("verb"), m33433i.intValue()));
                        }
                        MPLog.m33443w("MixpanelAPI.EProtocol", "View (" + string2 + ") or anchor (" + string3 + ") not found.");
                    }
                    layoutUpdateVisitor = new ViewVisitor.LayoutUpdateVisitor(m33437e, arrayList2, jSONObject.getString("name"), this.f58777d);
                } else {
    ...
    /* renamed from: d */
    public ViewVisitor m33438d(JSONObject jSONObject, ViewVisitor.OnEventListener onEventListener) {
        try {
            ...
            if (m33437e.size() != 0) {
                if ("click".equals(string2)) {
                    return new ViewVisitor.AddAccessibilityEventVisitor(m33437e, 1, string, onEventListener);
                }
                if ("selected".equals(string2)) {
                    return new ViewVisitor.AddAccessibilityEventVisitor(m33437e, 4, string, onEventListener);
                }
                if ("text_changed".equals(string2)) {
                    return new ViewVisitor.AddTextChangeListener(m33437e, string, onEventListener);
                }
                if ("detected".equals(string2)) {
                    return new ViewVisitor.ViewDetectorVisitor(m33437e, string, onEventListener);
                }
    ...
    /* renamed from: e */
    public List m33437e(JSONArray jSONArray, ResourceIds resourceIds) {
        int i;
        ArrayList arrayList = new ArrayList();
        for (int i2 = 0; i2 < jSONArray.length(); i2++) {
            ...
            if ("shortest".equals(optionalStringKey)) {
                ...
                MPLog.m33443w("MixpanelAPI.EProtocol", "Unrecognized prefix type \"" + optionalStringKey + "\". No views will be matched");
                return f58773f;
            }
            Integer m33433i = m33433i(optInt2, optionalStringKey4, resourceIds);
            if (m33433i == null) {
                return f58773f;
            }
            arrayList.add(new Pathfinder.PathElement(i, optionalStringKey2, optInt, m33433i.intValue(), optionalStringKey3, optionalStringKey5));
        }
        return arrayList;
    }

    /* renamed from: f */
    public final C17458Cp1 m33436f(Class cls, JSONObject jSONObject) {
        C13108ph c13108ph;
        try {
            ...
            if (jSONObject.has("get")) {
                ...
                c13108ph = new C13108ph(cls, jSONObject2.getString("selector"), f58772e, Class.forName(jSONObject2.getJSONObject("result").getString("type")));
            } else {
                c13108ph = null;
            }
            ...
            return new C17458Cp1(string, cls, c13108ph, str);
        } catch (ClassNotFoundException e) {
    ...
    /* renamed from: g */
    public C19510d42 m33435g(JSONObject jSONObject) {
        ArrayList arrayList = new ArrayList();
        try {
            ...
            for (int i = 0; i < jSONArray.length(); i++) {
                ...
                for (int i2 = 0; i2 < jSONArray2.length(); i2++) {
                    arrayList.add(m33436f(cls, jSONArray2.getJSONObject(i2)));
                }
            }
            return new C19510d42(this.f58774a, arrayList, this.f58775b);
        } catch (ClassNotFoundException e) {
    ...
    /* renamed from: h */
    public MPPair m33434h(JSONObject jSONObject) {
        Object string;
        try {
    ...
    /* renamed from: i */
    public final Integer m33433i(int i, String str, ResourceIds resourceIds) {
        int i2;
        if (str != null) {
            if (resourceIds.knownIdName(str)) {
                i2 = resourceIds.idFromName(str);
            } else {
                MPLog.m33443w("MixpanelAPI.EProtocol", "Path element contains an id name not known to the system. No views will be matched.\nMake sure that you're not stripping your packages R class out with proguard.\nid name was \"" + str + OperatorName.SHOW_TEXT_LINE_AND_SPACE);
                return null;
            }
        } else {
            i2 = -1;
        ...
        if (-1 != i2 && -1 != i && i2 != i) {
            MPLog.m33449e("MixpanelAPI.EProtocol", "Path contains both a named and an explicit id, and they don't match. No views will be matched.");
            return null;
        } else if (-1 != i2) {
