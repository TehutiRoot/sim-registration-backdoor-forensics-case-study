...
public final class AndroidUiDispatcher extends CoroutineDispatcher {
    ...
    /* renamed from: a */
    public final Choreographer f30703a;

    /* renamed from: b */
    public final Handler f30704b;

    /* renamed from: c */
    public final Object f30705c;

    /* renamed from: d */
    public final ArrayDeque f30706d;
    ...
    /* renamed from: i */
    public final AndroidUiDispatcher$dispatchCallback$1 f30711i;

    /* renamed from: j */
    public final MonotonicFrameClock f30712j;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final int $stable = 8;

    /* renamed from: k */
    public static final Lazy f30701k = LazyKt__LazyJVMKt.lazy(AndroidUiDispatcher$Companion$Main$2.INSTANCE);

    /* renamed from: l */
    public static final ThreadLocal f30702l = new ThreadLocal<CoroutineContext>() { // from class: androidx.compose.ui.platform.AndroidUiDispatcher$Companion$currentThread$1
    ...
    @Metadata(m29143d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0011\u0010\u0003\u001a\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006R\u001b\u0010\u0007\u001a\u00020\u00048FX\u0086\u0084\u0002¢\u0006\f\n\u0004\b\t\u0010\n\u001a\u0004\b\b\u0010\u0006R\u0014\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\u00040\fX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\r"}, m29142d2 = {"Landroidx/compose/ui/platform/AndroidUiDispatcher$Companion;", "", "()V", "CurrentThread", "Lkotlin/coroutines/CoroutineContext;", "getCurrentThread", "()Lkotlin/coroutines/CoroutineContext;", "Main", "getMain", "Main$delegate", "Lkotlin/Lazy;", "currentThread", "Ljava/lang/ThreadLocal;", "ui_release"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    public static final class Companion {
        ...
        public final CoroutineContext getCurrentThread() {
            ...
            CoroutineContext coroutineContext = (CoroutineContext) AndroidUiDispatcher.f30702l.get();
        ...
        public final CoroutineContext getMain() {
            return (CoroutineContext) AndroidUiDispatcher.f30701k.getValue();
        }
    ...
    /* renamed from: d */
    public final Runnable m59187d() {
        Runnable runnable;
        synchronized (this.f30705c) {
            runnable = (Runnable) this.f30706d.removeFirstOrNull();
        }
        return runnable;
    }
    ...
    public void dispatch(@NotNull CoroutineContext context, @NotNull Runnable block) {
        ...
        synchronized (this.f30705c) {
            try {
                this.f30706d.addLast(block);
                if (!this.f30709g) {
                    this.f30709g = true;
                    this.f30704b.post(this.f30711i);
                    if (!this.f30710h) {
                        this.f30710h = true;
                        this.f30703a.postFrameCallback(this.f30711i);
                    }
                }
    ...
    /* renamed from: i */
    public final void m59186i(long j) {
        synchronized (this.f30705c) {
            if (!this.f30710h) {
                return;
            }
            this.f30710h = false;
            List list = this.f30707e;
            this.f30707e = this.f30708f;
            this.f30708f = list;
            int size = list.size();
    ...
    /* renamed from: j */
    public final void m59185j() {
        boolean z;
        do {
            Runnable m59187d = m59187d();
            while (m59187d != null) {
                m59187d.run();
                m59187d = m59187d();
            }
            synchronized (this.f30705c) {
                if (this.f30706d.isEmpty()) {
                    z = false;
                    this.f30709g = false;
                } else {
                    z = true;
    ...
    public final void removeFrameCallback$ui_release(@NotNull Choreographer.FrameCallback callback) {
        Intrinsics.checkNotNullParameter(callback, "callback");
        synchronized (this.f30705c) {
            this.f30707e.remove(callback);
        }
    }

    public AndroidUiDispatcher(Choreographer choreographer, Handler handler) {
        this.f30703a = choreographer;
        this.f30704b = handler;
        this.f30705c = new Object();
        this.f30706d = new ArrayDeque();
        this.f30707e = new ArrayList();
        this.f30708f = new ArrayList();
        this.f30711i = new AndroidUiDispatcher$dispatchCallback$1(this);
        this.f30712j = new AndroidUiFrameClock(choreographer, this);
    }
}