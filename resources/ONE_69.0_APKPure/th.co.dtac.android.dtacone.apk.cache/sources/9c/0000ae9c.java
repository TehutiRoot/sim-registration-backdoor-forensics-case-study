...
public final class AppDistributionPlugin implements Plugin<Project> {
    ...
    public static final class Companion {
        ...
        /* renamed from: a */
        public final String m39257a(ApplicationVariant applicationVariant) {
    ...
    /* renamed from: a */
    public final void m39259a(Project project) {
        ...
        appExtension.getBuildTypes().all(new C1848a6(AppDistributionPlugin$setUp$1.INSTANCE));
        appExtension.getProductFlavors().all(new C1848a6(AppDistributionPlugin$setUp$2.INSTANCE));
    ...
    /* renamed from: b */
    public final void m39258b(Project project) {
    ...
    public void apply(@NotNull Project project) {
        ...
        project.getPluginManager().withPlugin("com.android.application", new C1848a6(new AppDistributionPlugin$apply$1(this, project)));
        project.afterEvaluate(new C1848a6(new AppDistributionPlugin$apply$2(this)));
    }
}