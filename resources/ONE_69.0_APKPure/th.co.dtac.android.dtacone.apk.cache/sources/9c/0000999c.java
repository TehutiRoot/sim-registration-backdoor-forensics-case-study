...
public final class zzof implements zznr {
    ...
    /* renamed from: a */
    public final zzku f47238a;

    /* renamed from: b */
    public zzmt f47239b = new zzmt();

    /* renamed from: c */
    public final int f47240c;

    public zzof(zzku zzkuVar, int i) {
        this.f47238a = zzkuVar;
        zzoo.zza();
        this.f47240c = i;
    }
    ...
    public final zznr zzb(zzkt zzktVar) {
        this.f47238a.zzf(zzktVar);
        return this;
    }

    @Override // com.google.android.gms.internal.mlkit_vision_face.zznr
    public final zznr zzc(zzmt zzmtVar) {
        this.f47239b = zzmtVar;
        return this;
    }

    @Override // com.google.android.gms.internal.mlkit_vision_face.zznr
    public final String zzd() {
        zzmv zzf = this.f47238a.zzj().zzf();
    ...
    public final byte[] zze(int i, boolean z) {
        ...
        this.f47239b.zze(Boolean.FALSE);
        this.f47238a.zzi(this.f47239b.zzm());
        try {
            zzoo.zza();
            if (i == 0) {
                return new JsonDataEncoderBuilder().configureWith(zzix.zza).ignoreNullValues(true).build().encode(this.f47238a.zzj()).getBytes("utf-8");
            }
            zzkw zzj = this.f47238a.zzj();
