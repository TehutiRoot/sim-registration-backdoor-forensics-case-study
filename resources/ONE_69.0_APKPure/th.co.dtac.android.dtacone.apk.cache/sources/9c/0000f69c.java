...
public class Grain128Engine implements StreamCipher {
    ...
    private void setKey(byte[] bArr, byte[] bArr2) {
        ...
        while (true) {
            ...
            int i3 = i2 + 3;
            int i4 = i2 + 2;
            int i5 = (bArr3[i3] << Ascii.CAN) | ((bArr3[i4] << 16) & 16711680);
            int i6 = i2 + 1;
            iArr[i] = (bArr3[i2] & 255) | i5 | ((bArr3[i6] << 8) & MotionEventCompat.ACTION_POINTER_INDEX_MASK);
            int[] iArr2 = this.lfsr;
            byte[] bArr4 = this.workingIV;
            iArr2[i] = (bArr4[i2] & 255) | (bArr4[i3] << Ascii.CAN) | ((bArr4[i4] << 16) & 16711680) | ((bArr4[i6] << 8) & MotionEventCompat.ACTION_POINTER_INDEX_MASK);
            i2 += 4;
            i++;
        }
    }
