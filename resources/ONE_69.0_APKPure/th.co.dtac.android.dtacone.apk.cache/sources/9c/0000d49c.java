...
public class TestSubscriber<T> extends BaseTestConsumer<T, TestSubscriber<T>> implements FlowableSubscriber<T>, Subscription, Disposable {
    ...
    /* renamed from: a */
    public final Subscriber f66527a;

    /* renamed from: b */
    public volatile boolean f66528b;

    /* renamed from: c */
    public final AtomicReference f66529c;

    /* renamed from: d */
    public final AtomicLong f66530d;

    /* renamed from: e */
    public QueueSubscription f66531e;
    ...
    public final void cancel() {
        if (!this.f66528b) {
            this.f66528b = true;
            SubscriptionHelper.cancel(this.f66529c);
        }
    }
    ...
    public void onNext(T t) {
        ...
        if (this.establishedFusionMode != 2) {
            ...
            this.f66527a.onNext(t);
            return;
        }
        while (true) {
            try {
                T poll = this.f66531e.poll();
                if (poll != null) {
    ...
    public void onSubscribe(Subscription subscription) {
        ...
        if (subscription == null) {
        ...
        } else if (!AbstractC23094xo1.m479a(this.f66529c, null, subscription)) {
            subscription.cancel();
            if (this.f66529c.get() != SubscriptionHelper.CANCELLED) {
            ...
            if (i != 0 && (subscription instanceof QueueSubscription)) {
                ...
                this.f66531e = queueSubscription;
            ...
            this.f66527a.onSubscribe(subscription);
            long andSet = this.f66530d.getAndSet(0L);
            if (andSet != 0) {
    ...
    public final void request(long j) {
        SubscriptionHelper.deferredRequest(this.f66529c, this.f66530d, j);
    }
    ...
    public TestSubscriber(Subscriber<? super T> subscriber, long j) {
        if (j >= 0) {
            this.f66527a = subscriber;
            this.f66529c = new AtomicReference();
            this.f66530d = new AtomicLong(j);
            return;
        }
