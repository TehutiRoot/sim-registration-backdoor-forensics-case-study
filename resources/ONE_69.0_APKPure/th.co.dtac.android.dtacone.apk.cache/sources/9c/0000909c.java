...
public final class zzss implements zzqc<List<FirebaseVisionImageLabel>, zzsn>, zzqx {
    ...
    /* renamed from: e */
    public static boolean f46050e = true;

    /* renamed from: f */
    public static volatile Boolean f46051f;

    /* renamed from: a */
    public final Context f46052a;

    /* renamed from: b */
    public final FirebaseVisionOnDeviceImageLabelerOptions f46053b;

    /* renamed from: c */
    public final zzqo f46054c;

    /* renamed from: d */
    public ImageLabeler f46055d;
    ...
    public zzss(zzqn zzqnVar, FirebaseVisionOnDeviceImageLabelerOptions firebaseVisionOnDeviceImageLabelerOptions) {
        ...
        this.f46052a = zzqnVar.getApplicationContext();
        this.f46053b = firebaseVisionOnDeviceImageLabelerOptions;
        this.f46054c = zzqo.zza(zzqnVar, 1);
    }
        ...
        try {
            if (f46051f == null) {
                ...
                if (DynamiteModule.getLocalVersion(context, "com.google.android.gms.vision.dynamite.ica") <= 0 && DynamiteModule.getLocalVersion(context, "com.google.android.gms.vision.dynamite.imagelabel") <= 0) {
                    z = true;
                    f46051f = Boolean.valueOf(z);
                }
                z = false;
                f46051f = Boolean.valueOf(z);
            }
            if (!f46051f.booleanValue()) {
                long elapsedRealtime = SystemClock.elapsedRealtime();
                ImageLabeler imageLabeler = this.f46055d;
                if (imageLabeler != null) {
                    if (imageLabeler.isOperational()) {
                        SparseArray<ImageLabel> detect = this.f46055d.detect(zzsnVar.zzbuo);
                        ...
                        m47485c(zzoa.NO_ERROR, elapsedRealtime, zzsnVar);
                        f46050e = false;
                    } else {
                        m47485c(zzoa.MODEL_NOT_DOWNLOADED, elapsedRealtime, zzsnVar);
                        throw new FirebaseMLException("Waiting for the label detection model to be downloaded. Please wait.", 14);
                    }
                } else {
                    m47485c(zzoa.UNKNOWN_ERROR, elapsedRealtime, zzsnVar);
    ...
    /* renamed from: a */
    public final /* synthetic */ zznq.zzad.zza m47487a(long j, zzoa zzoaVar, zzsn zzsnVar) {
        return zznq.zzad.zzmg().zzb((zznq.zzar) ((zzxh) zznq.zzar.zzng().zze(zznq.zzaf.zzmk().zzj(j).zzk(zzoaVar).zzae(f46050e).zzaf(true).zzag(true)).zzc(this.f46053b.zzrg()).zzk(zzsi.zzc(zzsnVar)).zzvn()));
    }

    /* renamed from: c */
    public final void m47485c(zzoa zzoaVar, long j, zzsn zzsnVar) {
        long elapsedRealtime = SystemClock.elapsedRealtime() - j;
        this.f46054c.zza(new zzqw(this, elapsedRealtime, zzoaVar, zzsnVar) { // from class: AK2

            /* renamed from: a */
            public final zzss f72a;

            /* renamed from: b */
            public final long f73b;

            /* renamed from: c */
            public final zzoa f74c;

            /* renamed from: d */
            public final zzsn f75d;

            {
                this.f72a = this;
                this.f73b = elapsedRealtime;
                this.f74c = zzoaVar;
                this.f75d = zzsnVar;
            }
            ...
            public final zznq.zzad.zza zzov() {
                return this.f72a.m47487a(this.f73b, this.f74c, this.f75d);
            }
        }, zzoe.ON_DEVICE_IMAGE_LABEL_DETECT);
        zzqu zzquVar = C23364zK2.f109348a;
        this.f46054c.zza((zznq.zze.zza) ((zzxh) zznq.zze.zza.zzkp().zzf(zzoaVar).zzr(f46050e).zze(zzsi.zzc(zzsnVar)).zzb(this.f46053b.zzrg()).zzvn()), elapsedRealtime, zzoe.AGGREGATED_ON_DEVICE_IMAGE_LABEL_DETECTION, zzquVar);
    }
    ...
    public final synchronized void zzow() {
        if (this.f46055d == null) {
            this.f46055d = new ImageLabeler.Builder(this.f46052a).setScoreThreshold(this.f46053b.getConfidenceThreshold()).build();
        }
    }
}