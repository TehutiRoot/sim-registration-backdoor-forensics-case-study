...
public class FovUtil {
    ...
    public static int focalLengthToViewAngleDegrees(float f, float f2) {
        ...
        Preconditions.checkArgument(z, "Focal length should be positive.");
        if (f2 <= 0.0f) {
            z2 = false;
        }
        Preconditions.checkArgument(z2, "Sensor length should be positive.");
    ...
    public static float getDefaultFocalLength(@NonNull CameraCharacteristicsCompat cameraCharacteristicsCompat) {
    ...
    public static int getDeviceDefaultViewAngleDegrees(@NonNull CameraManagerCompat cameraManagerCompat, int i) {
        try {
    ...
    public static float getSensorHorizontalLength(@NonNull CameraCharacteristicsCompat cameraCharacteristicsCompat) {
