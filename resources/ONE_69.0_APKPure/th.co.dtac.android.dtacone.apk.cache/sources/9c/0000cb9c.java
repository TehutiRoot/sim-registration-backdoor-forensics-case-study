...
public final class InternalMetadata {
    ...
    @Internal
    public static final BaseEncoding BASE64_ENCODING_OMIT_PADDING = Metadata.f63355d;

    @Internal
    /* loaded from: classes5.dex */
    public interface TrustedAsciiMarshaller<T> extends Metadata.InterfaceC10528i {
        @Override // io.grpc.Metadata.InterfaceC10528i
    ...
    public static <T> Metadata.Key<T> keyOf(String str, TrustedAsciiMarshaller<T> trustedAsciiMarshaller) {
        ...
        return Metadata.Key.m30716e(str, z, trustedAsciiMarshaller);
    }
    ...
    public static <T> Metadata.Key<T> keyOf(String str, Metadata.AsciiMarshaller<T> asciiMarshaller) {
        ...
        return Metadata.Key.m30717d(str, z, asciiMarshaller);
    }
}