...
public final class NavHostKt$NavHost$14 extends Lambda implements Function4<AnimatedContentScope, NavBackStackEntry, Composer, Integer, Unit> {
    ...
    /* loaded from: classes2.dex */
    public static final class C48061 extends Lambda implements Function2<Composer, Integer, Unit> {
        final /* synthetic */ NavBackStackEntry $currentEntry;
        final /* synthetic */ AnimatedContentScope $this_AnimatedContent;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C48061(NavBackStackEntry navBackStackEntry, AnimatedContentScope animatedContentScope) {
            super(2);
    ...
    public final void invoke(@NotNull AnimatedContentScope animatedContentScope, @NotNull NavBackStackEntry navBackStackEntry, @Nullable Composer composer, int i) {
        List<NavBackStackEntry> m53773a;
        ...
        if (!((Boolean) composer.consume(InspectionModeKt.getLocalInspectionMode())).booleanValue()) {
            m53773a = NavHostKt.m53773a(this.$visibleEntries$delegate);
        } else {
            m53773a = this.$composeNavigator.getBackStack().getValue();
        }
        ListIterator<NavBackStackEntry> listIterator = m53773a.listIterator(m53773a.size());
        while (true) {
        ...
        if (navBackStackEntry3 != null) {
            NavBackStackEntryProviderKt.LocalOwnersProvider(navBackStackEntry3, this.$saveableStateHolder, ComposableLambdaKt.composableLambda(composer, -1425390790, true, new C48061(navBackStackEntry3, animatedContentScope)), composer, 456);
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
