...
public final class ObservableKt {
    ...
    /* loaded from: classes5.dex */
    public static final class C11177b implements Function {

        /* renamed from: a */
        public static final C11177b f66373a = new C11177b();
    ...
    /* loaded from: classes5.dex */
    public static final class C11178c implements Function {

        /* renamed from: a */
        public static final C11178c f66374a = new C11178c();
    ...
    /* loaded from: classes5.dex */
    public static final class C11179d implements Function {

        /* renamed from: a */
        public static final C11179d f66375a = new C11179d();
    ...
    /* loaded from: classes5.dex */
    public static final class C11180e implements Function {

        /* renamed from: a */
        public static final C11180e f66376a = new C11180e();
    ...
    /* loaded from: classes5.dex */
    public static final class C11181f implements Function {

        /* renamed from: a */
        public static final C11181f f66377a = new C11181f();
    ...
    /* loaded from: classes5.dex */
    public static final class C11182g implements Function {

        /* renamed from: a */
        public static final C11182g f66378a = new C11182g();
    ...
    /* loaded from: classes5.dex */
    public static final class C11183h implements Function {

        /* renamed from: a */
        public static final C11183h f66379a = new C11183h();
    ...
    /* loaded from: classes5.dex */
    public static final class C11184i implements Function {

        /* renamed from: a */
        public static final C11184i f66380a = new C11184i();
    ...
    /* renamed from: a */
    public static final Iterable m30163a(Iterator it) {
    ...
    public static final <T> Observable<T> concatAll(@NotNull Observable<Observable<T>> concatAll) {
        ...
        Observable<T> observable = (Observable<T>) concatAll.concatMap(C11176a.f66372a);
    ...
    public static final <T> Observable<T> concatMapIterable(@NotNull Observable<? extends Iterable<? extends T>> concatMapIterable) {
        ...
        Observable<T> observable = (Observable<T>) concatMapIterable.concatMapIterable(C11177b.f66373a);
    ...
    public static final <T> Observable<T> flatMapIterable(@NotNull Observable<? extends Iterable<? extends T>> flatMapIterable) {
        ...
        Observable<T> observable = (Observable<T>) flatMapIterable.flatMapIterable(C11178c.f66374a);
    ...
    public static final <T> Observable<T> mergeAll(@NotNull Observable<Observable<T>> mergeAll) {
        ...
        Observable<T> observable = (Observable<T>) mergeAll.flatMap(C11179d.f66375a);
    ...
    public static final <T> Observable<T> switchLatest(@NotNull Observable<Observable<T>> switchLatest) {
        ...
        Observable<T> observable = (Observable<T>) switchLatest.switchMap(C11180e.f66376a);
    ...
    public static final <A, B> Single<Map<A, B>> toMap(@NotNull Observable<Pair<A, B>> toMap) {
        ...
        Single<Map<A, B>> single = (Single<Map<A, B>>) toMap.toMap(C11181f.f66377a, C11182g.f66378a);
    ...
    public static final <A, B> Single<Map<A, Collection<B>>> toMultimap(@NotNull Observable<Pair<A, B>> toMultimap) {
        ...
        Single<Map<A, Collection<B>>> single = (Single<Map<A, Collection<B>>>) toMultimap.toMultimap(C11183h.f66379a, C11184i.f66380a);
    ...
    public static final <T> Observable<T> toObservable(@NotNull Iterator<? extends T> toObservable) {
        Intrinsics.checkParameterIsNotNull(toObservable, "$this$toObservable");
        return toObservable(m30163a(toObservable));
    }
