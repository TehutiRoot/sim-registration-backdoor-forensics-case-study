...
public final class PreconditionFailure extends GeneratedMessageLite<PreconditionFailure, Builder> implements PreconditionFailureOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<PreconditionFailure, Builder> implements PreconditionFailureOrBuilder {
        public /* synthetic */ Builder(C8972a c8972a) {
            this();
        }

        public Builder addAllViolations(Iterable<? extends Violation> iterable) {
            copyOnWrite();
            ((PreconditionFailure) this.instance).m34872I(iterable);
            return this;
        }

        public Builder addViolations(Violation violation) {
            copyOnWrite();
            ((PreconditionFailure) this.instance).m34870K(violation);
            return this;
        }

        public Builder clearViolations() {
            copyOnWrite();
            ((PreconditionFailure) this.instance).m34869L();
            return this;
        }
        ...
        public Builder removeViolations(int i) {
            copyOnWrite();
            ((PreconditionFailure) this.instance).m34867N(i);
            return this;
        }

        public Builder setViolations(int i, Violation violation) {
            copyOnWrite();
            ((PreconditionFailure) this.instance).m34866O(i, violation);
            return this;
        }
        ...
        public Builder addViolations(int i, Violation violation) {
            copyOnWrite();
            ((PreconditionFailure) this.instance).m34871J(i, violation);
            return this;
        }

        public Builder setViolations(int i, Violation.Builder builder) {
            copyOnWrite();
            ((PreconditionFailure) this.instance).m34866O(i, builder.build());
            return this;
        }

        public Builder addViolations(Violation.Builder builder) {
            copyOnWrite();
            ((PreconditionFailure) this.instance).m34870K(builder.build());
            return this;
        }

        public Builder addViolations(int i, Violation.Builder builder) {
            copyOnWrite();
            ((PreconditionFailure) this.instance).m34871J(i, builder.build());
            return this;
        }
    }
    ...
    public static final class Violation extends GeneratedMessageLite<Violation, Builder> implements ViolationOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<Violation, Builder> implements ViolationOrBuilder {
            ...
            public Builder clearDescription() {
                copyOnWrite();
                ((Violation) this.instance).m34855L();
                return this;
            }

            public Builder clearSubject() {
                copyOnWrite();
                ((Violation) this.instance).m34854M();
                return this;
            }

            public Builder clearType() {
                copyOnWrite();
                ((Violation) this.instance).m34853N();
                return this;
            }
            ...
            public Builder setDescription(String str) {
                copyOnWrite();
                ((Violation) this.instance).m34852O(str);
                return this;
            }

            public Builder setDescriptionBytes(ByteString byteString) {
                copyOnWrite();
                ((Violation) this.instance).m34851P(byteString);
                return this;
            }

            public Builder setSubject(String str) {
                copyOnWrite();
                ((Violation) this.instance).m34850Q(str);
                return this;
            }

            public Builder setSubjectBytes(ByteString byteString) {
                copyOnWrite();
                ((Violation) this.instance).m34849R(byteString);
                return this;
            }

            public Builder setType(String str) {
                copyOnWrite();
                ((Violation) this.instance).m34848S(str);
                return this;
            }

            public Builder setTypeBytes(ByteString byteString) {
                copyOnWrite();
                ((Violation) this.instance).m34847T(byteString);
                return this;
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* renamed from: O */
        public void m34852O(String str) {
            str.getClass();
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* renamed from: P */
        public void m34851P(ByteString byteString) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* renamed from: S */
        public void m34848S(String str) {
            str.getClass();
            this.type_ = str;
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* renamed from: T */
        public void m34847T(ByteString byteString) {
            AbstractMessageLite.checkByteStringIsUtf8(byteString);
        ...
        /* renamed from: M */
        public final void m34854M() {
            this.subject_ = getDefaultInstance().getSubject();
        }

        /* renamed from: Q */
        public final void m34850Q(String str) {
            str.getClass();
            this.subject_ = str;
        }

        /* renamed from: R */
        public final void m34849R(ByteString byteString) {
            AbstractMessageLite.checkByteStringIsUtf8(byteString);
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C8972a.f57555a[methodToInvoke.ordinal()]) {
                case 1:
    ...
    /* loaded from: classes5.dex */
    public static /* synthetic */ class C8972a {
        ...
        static {
            ...
            try {
                f57555a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f57555a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f57555a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f57555a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f57555a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f57555a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: I */
    public final void m34872I(Iterable iterable) {
        m34868M();
        AbstractMessageLite.addAll(iterable, (List) this.violations_);
    }

    /* renamed from: J */
    public final void m34871J(int i, Violation violation) {
        violation.getClass();
        m34868M();
    ...
    /* renamed from: K */
    public final void m34870K(Violation violation) {
        violation.getClass();
        m34868M();
    ...
    /* renamed from: N */
    public final void m34867N(int i) {
        m34868M();
        this.violations_.remove(i);
    }

    /* renamed from: O */
    public final void m34866O(int i, Violation violation) {
        violation.getClass();
        m34868M();
