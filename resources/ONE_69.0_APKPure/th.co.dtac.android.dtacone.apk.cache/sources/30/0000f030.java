...
public class AppendableWriter<T extends Appendable> extends Writer {
    ...
    /* renamed from: a */
    public final Appendable f73628a;
    ...
    public Writer append(char c) throws IOException {
        this.f73628a.append(c);
        return this;
    }

    @Override // java.io.Writer, java.lang.Appendable
    public Writer append(CharSequence charSequence) throws IOException {
        this.f73628a.append(charSequence);
        return this;
    }

    @Override // java.io.Writer
    public void write(int i) throws IOException {
        this.f73628a.append((char) i);
    }

    @Override // java.io.Writer, java.lang.Appendable
    public Writer append(CharSequence charSequence, int i, int i2) throws IOException {
        this.f73628a.append(charSequence, i, i2);
        return this;
    }
    ...
    public void write(String str, int i, int i2) throws IOException {
        ...
        this.f73628a.append(str, i, i2 + i);
    }
}