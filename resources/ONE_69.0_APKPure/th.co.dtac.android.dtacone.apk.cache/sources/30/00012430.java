...
/* renamed from: th.co.dtac.android.dtacone.presenter.password.VerifyPasswordPresenter$verifyPasswordPre2post$2 */
/* loaded from: classes8.dex */
public final class VerifyPasswordPresenter$verifyPasswordPre2post$2 extends Lambda implements Function1<StatusResponse, Unit> {
    final /* synthetic */ VerifyPasswordPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public VerifyPasswordPresenter$verifyPasswordPre2post$2(VerifyPasswordPresenter verifyPasswordPresenter) {
        super(1);
