...
public final class NioByteString extends ByteString.LeafByteString {
    ...
    public NioByteString(ByteBuffer byteBuffer) {
        Internal.m55679b(byteBuffer, "buffer");
    ...
    public boolean isValidUtf8() {
        return Utf8.m55374s(this.buffer);
    }

    @Override // androidx.datastore.preferences.protobuf.ByteString
    public CodedInputStream newCodedInput() {
        return CodedInputStream.m56040b(this.buffer, true);
    }
    ...
    public int partialIsValidUtf8(int i, int i2, int i3) {
        return Utf8.m55371v(i, this.buffer, i2, i3 + i2);
    }
    ...
    public void writeToInternal(OutputStream outputStream, int i, int i2) throws IOException {
        ...
        AbstractC1172Qf.m66743g(slice(i, i2 + i), outputStream);
    }

    /* renamed from: androidx.datastore.preferences.protobuf.NioByteString$a */
    /* loaded from: classes2.dex */
    public class C4371a extends InputStream {

        /* renamed from: a */
        public final ByteBuffer f34941a;

        public C4371a() {
            this.f34941a = NioByteString.this.buffer.slice();
        }

        @Override // java.io.InputStream
        public int available() {
            return this.f34941a.remaining();
        }
        ...
        @Override // java.io.InputStream
        public int read() {
            if (this.f34941a.hasRemaining()) {
                return this.f34941a.get() & 255;
            }
            return -1;
        }
        ...
        public int read(byte[] bArr, int i, int i2) {
            if (this.f34941a.hasRemaining()) {
                int min = Math.min(i2, this.f34941a.remaining());
                this.f34941a.get(bArr, i, min);
                return min;
            }
            return -1;
        }
