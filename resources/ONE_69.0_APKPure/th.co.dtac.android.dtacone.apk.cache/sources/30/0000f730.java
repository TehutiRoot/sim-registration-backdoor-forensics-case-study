...
public class G3413CBCBlockCipher implements BlockCipher {
    ...
    private int decrypt(byte[] bArr, int i, byte[] bArr2, int i2) {
        byte[] MSB = GOST3413CipherUtil.MSB(this.f75205R, this.blockSize);
    ...
    private int encrypt(byte[] bArr, int i, byte[] bArr2, int i2) {
        byte[] sum = GOST3413CipherUtil.sum(GOST3413CipherUtil.copyFromInput(bArr, this.blockSize, i), GOST3413CipherUtil.MSB(this.f75205R, this.blockSize));
    ...
    private void generateR(byte[] bArr) {
        byte[] LSB = GOST3413CipherUtil.LSB(this.f75205R, this.f75206m - this.blockSize);
        System.arraycopy(LSB, 0, this.f75205R, 0, LSB.length);
        System.arraycopy(bArr, 0, this.f75205R, LSB.length, this.f75206m - LSB.length);
    }

    private void initArrays() {
        int i = this.f75206m;
        this.f75205R = new byte[i];
        this.R_init = new byte[i];
    }

    private void setupDefaultParams() {
        this.f75206m = this.blockSize;
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (!(cipherParameters instanceof ParametersWithIV)) {
            ...
            System.arraycopy(bArr, 0, this.f75205R, 0, bArr.length);
        ...
        this.f75206m = iv.length;
        initArrays();
        byte[] clone = Arrays.clone(iv);
        this.R_init = clone;
        System.arraycopy(clone, 0, this.f75205R, 0, clone.length);
