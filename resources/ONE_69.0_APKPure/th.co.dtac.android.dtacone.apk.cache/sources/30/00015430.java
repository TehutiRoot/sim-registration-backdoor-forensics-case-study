...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.consent_nontelco.ConsentNonTelcoViewModel$getConsentNonTelco$1 */
/* loaded from: classes9.dex */
public final class ConsentNonTelcoViewModel$getConsentNonTelco$1 extends Lambda implements Function1<ConsentNonTelcoResponse, Unit> {
    final /* synthetic */ ConsentNonTelcoViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ConsentNonTelcoViewModel$getConsentNonTelco$1(ConsentNonTelcoViewModel consentNonTelcoViewModel) {
        super(1);
