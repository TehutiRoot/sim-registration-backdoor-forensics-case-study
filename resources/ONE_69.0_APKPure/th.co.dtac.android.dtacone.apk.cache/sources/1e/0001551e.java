...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.device_sale.DeviceSaleCampaignViewModel$callAPICheck1IDXDevice$3 */
/* loaded from: classes9.dex */
public final class DeviceSaleCampaignViewModel$callAPICheck1IDXDevice$3 extends Lambda implements Function1<Check1IDXDeviceResponse, Unit> {
    final /* synthetic */ DeviceSaleCampaignViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DeviceSaleCampaignViewModel$callAPICheck1IDXDevice$3(DeviceSaleCampaignViewModel deviceSaleCampaignViewModel) {
        super(1);
    ...
    public final void invoke2(Check1IDXDeviceResponse check1IDXDeviceResponse) {
        ...
        MutableLiveData m3026z;
        deviceSaleRepository = this.this$0.f105445b;
        deviceSaleRepository.setCanBuyDeviceWithContract(check1IDXDeviceResponse.getCanBuyDeviceWithContract());
        if (Intrinsics.areEqual(check1IDXDeviceResponse.getCanBuyDeviceWithContract(), "N")) {
            this.this$0.dismissSecondaryLoading();
            m3026z = this.this$0.m3026z();
            m3026z.setValue(Resource.Companion.success(check1IDXDeviceResponse));
            return;
        }
