...
public final class FlowableTake<T> extends AbstractC0558I {
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new TakeSubscriber(subscriber, this.f64631b));
    }
}