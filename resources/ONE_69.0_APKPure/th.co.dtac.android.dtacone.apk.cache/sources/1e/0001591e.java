...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_postpaid_registration.MrtrPostpaidValidateBarcodeViewModel$checkSimStock$1 */
/* loaded from: classes9.dex */
public final class MrtrPostpaidValidateBarcodeViewModel$checkSimStock$1 extends Lambda implements Function1<Disposable, Unit> {
    final /* synthetic */ MrtrPostpaidValidateBarcodeViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrPostpaidValidateBarcodeViewModel$checkSimStock$1(MrtrPostpaidValidateBarcodeViewModel mrtrPostpaidValidateBarcodeViewModel) {
        super(1);
    ...
    public final void invoke2(Disposable disposable) {
        ...
        mrtrPostpaidRepository.setCheckSimStockResponse(null);
    }
}