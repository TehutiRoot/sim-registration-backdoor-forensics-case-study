...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.campaign.view_model.OneCampaignViewModel$callOneTrueCampaignCount$3 */
/* loaded from: classes10.dex */
public final class OneCampaignViewModel$callOneTrueCampaignCount$3 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ OneCampaignViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneCampaignViewModel$callOneTrueCampaignCount$3(OneCampaignViewModel oneCampaignViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable it) {
        ...
        mutableLiveData.setValue(Resource.Companion.success(new CampaignCountResponse(null, new Campaign(0, 0, 0), 0)));
