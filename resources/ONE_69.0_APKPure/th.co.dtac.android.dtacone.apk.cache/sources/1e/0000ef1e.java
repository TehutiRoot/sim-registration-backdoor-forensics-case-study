...
public class URLCodec implements BinaryEncoder, BinaryDecoder, StringEncoder, StringDecoder {
    ...
    /* renamed from: a */
    public static final BitSet f73311a = new BitSet(256);
    @Deprecated
        ...
        while (i < bArr.length) {
            ...
            if (b == 43) {
                ...
                try {
                    ...
                    i += 2;
                    byteArrayOutputStream.write((char) ((m68713a << 4) + E12.m68713a(bArr[i])));
    ...
    public static final byte[] encodeUrl(BitSet bitSet, byte[] bArr) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (bitSet.get(i2)) {
                ...
                char m68712b = E12.m68712b(i2 >> 4);
                char m68712b2 = E12.m68712b(i2);
                byteArrayOutputStream.write(m68712b);
                byteArrayOutputStream.write(m68712b2);
            }
        }
        return byteArrayOutputStream.toByteArray();
    }
