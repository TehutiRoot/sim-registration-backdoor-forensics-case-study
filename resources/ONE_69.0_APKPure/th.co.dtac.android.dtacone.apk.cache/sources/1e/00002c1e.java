...
public final class SliderKt$RangeSlider$2 extends Lambda implements Function3<BoxWithConstraintsScope, Composer, Integer, Unit> {
    ...
    /* loaded from: classes.dex */
    public /* synthetic */ class C31382 extends FunctionReferenceImpl implements Function1<Float, Float> {
        final /* synthetic */ Ref.FloatRef $maxPx;
        final /* synthetic */ Ref.FloatRef $minPx;
        final /* synthetic */ ClosedFloatingPointRange<Float> $valueRange;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C31382(ClosedFloatingPointRange<Float> closedFloatingPointRange, Ref.FloatRef floatRef, Ref.FloatRef floatRef2) {
    ...
    /* loaded from: classes.dex */
    public /* synthetic */ class C31393 extends FunctionReferenceImpl implements Function1<Float, Float> {
        final /* synthetic */ Ref.FloatRef $maxPx;
        final /* synthetic */ Ref.FloatRef $minPx;
        final /* synthetic */ ClosedFloatingPointRange<Float> $valueRange;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C31393(ClosedFloatingPointRange<Float> closedFloatingPointRange, Ref.FloatRef floatRef, Ref.FloatRef floatRef2) {
            super(1, Intrinsics.Kotlin.class, "scaleToOffset", "invoke$scaleToOffset(Lkotlin/ranges/ClosedFloatingPointRange;Lkotlin/jvm/internal/Ref$FloatRef;Lkotlin/jvm/internal/Ref$FloatRef;F)F", 0);
            this.$valueRange = closedFloatingPointRange;
            this.$minPx = floatRef;
            this.$maxPx = floatRef2;
    ...
    public static final float invoke$scaleToOffset(ClosedFloatingPointRange<Float> closedFloatingPointRange, Ref.FloatRef floatRef, Ref.FloatRef floatRef2, float f) {
        float m60770j;
        m60770j = SliderKt.m60770j(closedFloatingPointRange.getStart().floatValue(), closedFloatingPointRange.getEndInclusive().floatValue(), f, floatRef.element, floatRef2.element);
        return m60770j;
    }
    ...
    public static final ClosedFloatingPointRange<Float> invoke$scaleToUserValue(Ref.FloatRef floatRef, Ref.FloatRef floatRef2, ClosedFloatingPointRange<Float> closedFloatingPointRange, ClosedFloatingPointRange<Float> closedFloatingPointRange2) {
        ClosedFloatingPointRange<Float> m60769k;
        m60769k = SliderKt.m60769k(floatRef.element, floatRef2.element, closedFloatingPointRange2, closedFloatingPointRange.getStart().floatValue(), closedFloatingPointRange.getEndInclusive().floatValue());
        return m60769k;
    }
    ...
    public final void invoke(@NotNull BoxWithConstraintsScope BoxWithConstraints, @Nullable Composer composer, int i) {
        ...
        float m73810getMaxWidthimpl = Constraints.m73810getMaxWidthimpl(BoxWithConstraints.mo69677getConstraintsmsEJaDk());
        Ref.FloatRef floatRef = new Ref.FloatRef();
        Ref.FloatRef floatRef2 = new Ref.FloatRef();
        Density density = (Density) composer.consume(CompositionLocalsKt.getLocalDensity());
        floatRef.element = m73810getMaxWidthimpl - density.mo69622toPx0680j_4(SliderKt.getThumbRadius());
        floatRef2.element = density.mo69622toPx0680j_4(SliderKt.getThumbRadius());
        ...
        SliderKt.m60779a(new C31382(this.$valueRange, floatRef2, floatRef), this.$valueRange, AbstractC17854Is1.rangeTo(floatRef2.element, floatRef.element), mutableFloatState, this.$value.getStart().floatValue(), composer, ((this.$$dirty >> 9) & 112) | 3072);
        SliderKt.m60779a(new C31393(this.$valueRange, floatRef2, floatRef), this.$valueRange, AbstractC17854Is1.rangeTo(floatRef2.element, floatRef.element), mutableFloatState2, this.$value.getEndInclusive().floatValue(), composer, ((this.$$dirty >> 9) & 112) | 3072);
        ...
        m60771i = SliderKt.m60771i(companion2, this.$startInteractionSource, this.$endInteractionSource, mutableFloatState, mutableFloatState2, this.$enabled, z, m73810getMaxWidthimpl, this.$valueRange, rememberUpdatedState, rememberUpdatedState2);
        float coerceIn = AbstractC11695c.coerceIn(this.$value.getStart().floatValue(), this.$valueRange.getStart().floatValue(), this.$value.getEndInclusive().floatValue());
        float coerceIn2 = AbstractC11695c.coerceIn(this.$value.getEndInclusive().floatValue(), this.$value.getStart().floatValue(), this.$valueRange.getEndInclusive().floatValue());
        m60772h = SliderKt.m60772h(this.$valueRange.getStart().floatValue(), this.$valueRange.getEndInclusive().floatValue(), coerceIn);
        m60772h2 = SliderKt.m60772h(this.$valueRange.getStart().floatValue(), this.$valueRange.getEndInclusive().floatValue(), coerceIn2);
        int floor = (int) Math.floor(this.$steps * m60772h2);
        int floor2 = (int) Math.floor(this.$steps * (1.0f - m60772h));
        ...
        composer.endReplaceableGroup();
        m60768l = SliderKt.m60768l(companion2, coerceIn, z3, rememberedValue5, this.$onValueChangeFinished, AbstractC17854Is1.rangeTo(this.$valueRange.getStart().floatValue(), coerceIn2), floor);
        ...
        composer.endReplaceableGroup();
        m60768l2 = SliderKt.m60768l(companion2, coerceIn2, z4, rememberedValue6, this.$onValueChangeFinished, AbstractC17854Is1.rangeTo(coerceIn, this.$valueRange.getEndInclusive().floatValue()), floor2);
        ...
        int i3 = this.$$dirty;
        SliderKt.m60778b(z5, m60772h, m60772h2, list, sliderColors, f, mutableInteractionSource, mutableInteractionSource2, m60771i, m60768l, m60768l2, composer, ((i3 >> 9) & 14) | 14159872 | ((i3 >> 9) & 57344), 0);
        if (ComposerKt.isTraceInProgress()) {
