...
public abstract class AbstractC5736a {
    ...
    /* loaded from: classes3.dex */
    public class C5737a implements GlideSuppliers.GlideSupplier {

        /* renamed from: a */
        public boolean f41765a;

        /* renamed from: b */
        public final /* synthetic */ Glide f41766b;

        /* renamed from: c */
        public final /* synthetic */ List f41767c;

        /* renamed from: d */
        public final /* synthetic */ AppGlideModule f41768d;

        public C5737a(Glide glide, List list, AppGlideModule appGlideModule) {
            this.f41766b = glide;
            this.f41767c = list;
            this.f41768d = appGlideModule;
        }
        ...
        public Registry get() {
            if (!this.f41765a) {
                ...
                this.f41765a = true;
                try {
                    return AbstractC5736a.m50576a(this.f41766b, this.f41767c, this.f41768d);
                } finally {
                    this.f41765a = false;
                    Trace.endSection();
                }
    ...
    /* renamed from: a */
    public static Registry m50576a(Glide glide, List list, AppGlideModule appGlideModule) {
        BitmapPool bitmapPool = glide.getBitmapPool();
        ArrayPool arrayPool = glide.getArrayPool();
        Context applicationContext = glide.m50621d().getApplicationContext();
        GlideExperiments experiments = glide.m50621d().getExperiments();
        Registry registry = new Registry();
        m50575b(applicationContext, registry, bitmapPool, arrayPool, experiments);
        m50574c(applicationContext, glide, registry, list, appGlideModule);
        return registry;
    }

    /* renamed from: b */
    public static void m50575b(Context context, Registry registry, BitmapPool bitmapPool, ArrayPool arrayPool, GlideExperiments glideExperiments) {
        ...
        if (i >= 28 && glideExperiments.isEnabled(GlideBuilder.C5719c.class)) {
    ...
    /* renamed from: c */
    public static void m50574c(Context context, Glide glide, Registry registry, List list, AppGlideModule appGlideModule) {
    ...
    /* renamed from: d */
    public static GlideSuppliers.GlideSupplier m50573d(Glide glide, List list, AppGlideModule appGlideModule) {
        return new C5737a(glide, list, appGlideModule);
    }
}