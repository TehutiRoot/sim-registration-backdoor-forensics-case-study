...
public final class OnlineRegistBankAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    /* renamed from: a */
    public final Activity f81436a;

    /* renamed from: b */
    public final List f81437b;

    /* renamed from: c */
    public ImageView f81438c;

    /* renamed from: d */
    public OnClickBank f81439d;
    ...
    @Metadata(m29143d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\bf\u0018\u00002\u00020\u0001J\u0018\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007H&¨\u0006\b"}, m29142d2 = {"Lth/co/dtac/android/dtacone/adapter/online_register/OnlineRegistBankAdapter$OnClickBank;", "", "onClickBank", "", "bank", "Lth/co/dtac/android/dtacone/model/mrtr_online_registration/AdditionalPicture;", "position", "", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    public OnlineRegistBankAdapter(@NotNull Activity activity, @NotNull List<AdditionalPicture> bankList) {
        ...
        this.f81436a = activity;
        this.f81437b = bankList;
    }

    /* renamed from: a */
    public static /* synthetic */ void m20473a(OnlineRegistBankAdapter onlineRegistBankAdapter, RecyclerView.ViewHolder viewHolder, AdditionalPicture additionalPicture, int i, View view) {
        m20470d(onlineRegistBankAdapter, viewHolder, additionalPicture, i, view);
    }

    /* renamed from: b */
    public static /* synthetic */ void m20472b(OnlineRegistBankAdapter onlineRegistBankAdapter, RecyclerView.ViewHolder viewHolder, AdditionalPicture additionalPicture, int i, View view) {
        m20469e(onlineRegistBankAdapter, viewHolder, additionalPicture, i, view);
    }

    /* renamed from: c */
    private final void m20471c(int i, ImageView imageView) {
        Glide.with(this.f81436a).clear(imageView);
        Glide.with(this.f81436a).m74227load(Integer.valueOf(i)).skipMemoryCache(true).error(ContextCompat.getDrawable(this.f81436a, R.drawable.image_default)).diskCacheStrategy(DiskCacheStrategy.NONE).into(imageView);
    }

    /* renamed from: d */
    public static final void m20470d(OnlineRegistBankAdapter this$0, RecyclerView.ViewHolder holder, AdditionalPicture item, int i, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(holder, "$holder");
        Intrinsics.checkNotNullParameter(item, "$item");
        ImageView imageView = this$0.f81438c;
        if (imageView != null) {
            imageView.setBackground(null);
        }
        ImageView ivBank = ((BankViewHolder) holder).getIvBank();
        this$0.f81438c = ivBank;
        if (ivBank != null) {
            ivBank.setBackground(ContextCompat.getDrawable(this$0.f81436a, R.drawable.one_bg_selected_bank_commission));
        }
        OnClickBank onClickBank = this$0.f81439d;
        if (onClickBank != null) {
    ...
    /* renamed from: e */
    public static final void m20469e(OnlineRegistBankAdapter this$0, RecyclerView.ViewHolder holder, AdditionalPicture item, int i, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(holder, "$holder");
        Intrinsics.checkNotNullParameter(item, "$item");
        ImageView imageView = this$0.f81438c;
    ...
    public int getItemCount() {
        return this.f81437b.size();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public void onBindViewHolder(@NotNull final RecyclerView.ViewHolder holder, final int i) {
        Intrinsics.checkNotNullParameter(holder, "holder");
        final AdditionalPicture additionalPicture = (AdditionalPicture) this.f81437b.get(i);
        if (holder instanceof BankViewHolder) {
            BankViewHolder bankViewHolder = (BankViewHolder) holder;
            m20471c(BankExtKt.getBankImage(additionalPicture.getKey()), bankViewHolder.getIvBank());
            holder.itemView.setOnClickListener(new View.OnClickListener() { // from class: Qg1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    OnlineRegistBankAdapter.m20473a(OnlineRegistBankAdapter.this, holder, additionalPicture, i, view);
                }
            });
            bankViewHolder.getIvBank().setOnClickListener(new View.OnClickListener() { // from class: Rg1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    OnlineRegistBankAdapter.m20472b(OnlineRegistBankAdapter.this, holder, additionalPicture, i, view);
                }
            });
        }
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NotNull ViewGroup p0, int i) {
        ...
        View view = LayoutInflater.from(this.f81436a).inflate(R.layout.item_bank_image, p0, false);
