...
public class setOnScrollChangeListener implements setDarkTextColor.valueOf {
    private final setDarkTextColor values;

    public setOnScrollChangeListener(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.getSchemeEncryptionPublicKeyId(this.values);
    }
}