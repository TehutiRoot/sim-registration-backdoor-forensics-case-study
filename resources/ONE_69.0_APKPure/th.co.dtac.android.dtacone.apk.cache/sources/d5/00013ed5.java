...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.retailerProfileUpdate.viewModel.OneRetailerProfileUpdateViewModel$updateOneRetailerProfile$3 */
/* loaded from: classes10.dex */
public final class OneRetailerProfileUpdateViewModel$updateOneRetailerProfile$3 extends Lambda implements Function1<StatusResponse, Unit> {
    final /* synthetic */ OneRetailerProfileUpdateViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneRetailerProfileUpdateViewModel$updateOneRetailerProfile$3(OneRetailerProfileUpdateViewModel oneRetailerProfileUpdateViewModel) {
        super(1);
    ...
    public final void invoke2(StatusResponse statusResponse) {
        ...
        m10060r.setValue(Resource.Companion.success(Boolean.TRUE));
    }
}