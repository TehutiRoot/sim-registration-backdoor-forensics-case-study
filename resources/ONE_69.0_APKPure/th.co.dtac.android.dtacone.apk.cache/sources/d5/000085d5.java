...
public final class NumberInput {
    ...
    /* renamed from: a */
    public static final String f43133a = String.valueOf(Long.MIN_VALUE).substring(1);

    /* renamed from: b */
    public static final String f43134b = String.valueOf(Long.MAX_VALUE);

    /* renamed from: a */
    public static NumberFormatException m49760a(String str) {
        return new NumberFormatException("Value \"" + str + "\" can not be represented as BigDecimal");
    }

    public static boolean inLongRange(char[] cArr, int i, int i2, boolean z) {
        String str = z ? f43133a : f43134b;
    ...
    public static BigDecimal parseBigDecimal(char[] cArr, int i, int i2) throws NumberFormatException {
        try {
            ...
            throw m49760a(new String(cArr, i, i2));
        }
    }
