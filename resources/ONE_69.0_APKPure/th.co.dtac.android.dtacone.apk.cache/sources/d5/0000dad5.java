...
@DebugMetadata(m29093c = "kotlin.io.path.PathTreeWalk$bfsIterator$1", m29092f = "PathTreeWalk.kt", m29091i = {0, 0, 0, 0, 0, 0, 1, 1, 1}, m29090l = {SyslogConstants.LOG_LOCAL7, 190}, m29089m = "invokeSuspend", m29088n = {"$this$iterator", "queue", "entriesReader", "pathNode", "this_$iv", "path$iv", "$this$iterator", "queue", "entriesReader"}, m29087s = {"L$0", "L$1", "L$2", "L$3", "L$4", "L$5", "L$0", "L$1", "L$2"})
