...
public class setAllowedHandwritingDelegatePackage implements setDarkTextColor.valueOf {
    private final setDarkTextColor get;

    public setAllowedHandwritingDelegatePackage(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.InvalidInputException(this.get);
    }
}