...
public class SignatureOptions implements Closeable {
    ...
    /* renamed from: a */
    public COSDocument f60645a;

    /* renamed from: b */
    public int f60646b;

    /* renamed from: d */
    public RandomAccessRead f60648d = null;

    /* renamed from: c */
    public int f60647c = 0;

    /* renamed from: b */
    public final void m32274b(RandomAccessRead randomAccessRead) {
        this.f60648d = randomAccessRead;
        PDFParser pDFParser = new PDFParser(this.f60648d);
        pDFParser.parse();
        this.f60645a = pDFParser.getDocument();
    }

    @Override // java.io.Closeable, java.lang.AutoCloseable
    public void close() throws IOException {
        try {
            COSDocument cOSDocument = this.f60645a;
            if (cOSDocument != null) {
                cOSDocument.close();
            }
        } finally {
            RandomAccessRead randomAccessRead = this.f60648d;
    ...
    public void setVisualSignature(File file) throws IOException {
        m32274b(new RandomAccessBufferedFileInputStream(file));
    }

    public void setVisualSignature(InputStream inputStream) throws IOException {
        m32274b(new RandomAccessBuffer(inputStream));
    }
