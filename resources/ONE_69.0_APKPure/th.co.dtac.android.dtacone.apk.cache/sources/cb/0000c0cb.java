...
public abstract class ImageInputStreamImpl implements ImageInputStream {
    ...
    /* renamed from: a */
    public boolean f59706a = false;

    /* renamed from: b */
    public final C9886b f59707b = new C9886b();

    /* renamed from: c */
    public final C9886b f59708c = new C9886b();

    /* renamed from: d */
    public final byte[] f59709d = new byte[8];

    /* renamed from: com.tom_roush.harmony.javax.imageio.stream.ImageInputStreamImpl$b */
    /* loaded from: classes5.dex */
    public static class C9886b {
        ...
        public C9886b() {
            this.f59710a = new long[10];
            this.f59711b = 0;
        }

        /* renamed from: a */
        public final void m32795a(int i) {
            long[] jArr = new long[Math.max(this.f59710a.length * 2, i)];
            long[] jArr2 = this.f59710a;
            System.arraycopy(jArr2, 0, jArr, 0, jArr2.length);
            this.f59710a = jArr;
        }

        /* renamed from: b */
        public boolean m32794b() {
            if (this.f59711b == 0) {
                return true;
            }
            return false;
        ...
        /* renamed from: c */
        public long m32793c() {
            long[] jArr = this.f59710a;
            int i = this.f59711b - 1;
            this.f59711b = i;
            return jArr[i];
        }

        /* renamed from: d */
        public void m32792d(long j) {
            int i = this.f59711b;
            if (i >= this.f59710a.length) {
                m32795a(i + 1);
            }
            long[] jArr = this.f59710a;
            int i2 = this.f59711b;
    ...
    public void mark() {
        try {
            this.f59707b.m32792d(getStreamPosition());
            this.f59708c.m32792d(getBitOffset());
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public int readInt() throws IOException {
        int i;
        byte b;
        if (read(this.f59709d, 0, 4) >= 0) {
            if (this.byteOrder == ByteOrder.BIG_ENDIAN) {
                byte[] bArr = this.f59709d;
                i = ((bArr[0] & 255) << 24) | ((bArr[1] & 255) << 16) | ((bArr[2] & 255) << 8);
                b = bArr[3];
            } else {
                byte[] bArr2 = this.f59709d;
    ...
    */
    ...
    public String readUTF() throws IOException {
        ...
        return new DataInputStream(new ByteArrayInputStream(this.f59709d)).readUTF();
    }
    ...
    public void reset() throws IOException {
        if (!this.f59707b.m32794b() && !this.f59708c.m32794b()) {
            long m32793c = this.f59707b.m32793c();
            if (m32793c >= this.flushedPos) {
                seek(m32793c);
                setBitOffset((int) this.f59708c.m32793c());
                return;
            }
