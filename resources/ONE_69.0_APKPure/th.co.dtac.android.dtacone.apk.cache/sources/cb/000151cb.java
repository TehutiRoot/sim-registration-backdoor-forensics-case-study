...
/* renamed from: th.co.dtac.android.dtacone.view.fragment.mrtr_prepaid_reregist.MrtrPrepaidReregistVerifyOtpFragment$onStart$3$5 */
/* loaded from: classes9.dex */
public final class MrtrPrepaidReregistVerifyOtpFragment$onStart$3$5 extends Lambda implements Function1<Resource<? extends ErrorCollection>, Unit> {
    final /* synthetic */ MrtrPrepaidReregistVerifyOtpFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrPrepaidReregistVerifyOtpFragment$onStart$3$5(MrtrPrepaidReregistVerifyOtpFragment mrtrPrepaidReregistVerifyOtpFragment) {
        super(1);
    ...
    public final void invoke2(Resource<ErrorCollection> resource) {
        ...
        MrtrPrepaidReregistVerifyOtpFragment mrtrPrepaidReregistVerifyOtpFragment = this.this$0;
        if (resourceContentIfNotHandled.getStatus() == StatusResource.ERROR) {
            mrtrPrepaidReregistViewModel = mrtrPrepaidReregistVerifyOtpFragment.f103849l;
            ...
            mrtrPrepaidReregistViewModel.setUpPassStepState(UpPassStepState.NONE);
            mrtrPrepaidReregistViewModel2 = mrtrPrepaidReregistVerifyOtpFragment.f103849l;
            if (mrtrPrepaidReregistViewModel2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("mrtrPrepaidReregistViewModel");
                mrtrPrepaidReregistViewModel2 = null;
            }
            mrtrPrepaidReregistViewModel2.setUpPassResult(null);
            mrtrPrepaidReregistViewModel3 = mrtrPrepaidReregistVerifyOtpFragment.f103849l;
            if (mrtrPrepaidReregistViewModel3 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("mrtrPrepaidReregistViewModel");
                mrtrPrepaidReregistViewModel3 = null;
            }
            mrtrPrepaidReregistViewModel3.setFaceCompareResult(null);
            mrtrPrepaidReregistVerifyOtpFragment.m4546S();
        }
    }
}