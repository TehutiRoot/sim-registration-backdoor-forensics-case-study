...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.login_mrtr.GetProfileViewModel$saveOneLoginSessionForOnlyGetProfile$3$7 */
/* loaded from: classes9.dex */
public final class GetProfileViewModel$saveOneLoginSessionForOnlyGetProfile$3$7 extends Lambda implements Function1<SessionEntity, Unit> {
    final /* synthetic */ SessionEntity $previousSession;
    final /* synthetic */ GetProfileViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GetProfileViewModel$saveOneLoginSessionForOnlyGetProfile$3$7(GetProfileViewModel getProfileViewModel, SessionEntity sessionEntity) {
        super(1);
    ...
    public final void invoke2(SessionEntity sessionEntity) {
        ...
        m2497v.setValue(Resource.Companion.success(this.$previousSession.getToken().getUserName()));
    }
}