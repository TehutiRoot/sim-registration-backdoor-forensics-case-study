...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.pre2post.viewModel.OnePre2PostViewModel$onePre2PostPreVerify$3 */
/* loaded from: classes10.dex */
public final class OnePre2PostViewModel$onePre2PostPreVerify$3 extends Lambda implements Function1<OneCommonResponse, Unit> {
    final /* synthetic */ OnePre2PostViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePre2PostViewModel$onePre2PostPreVerify$3(OnePre2PostViewModel onePre2PostViewModel) {
        super(1);
    ...
    public final void invoke2(OneCommonResponse oneCommonResponse) {
        ...
        m10839g1 = this.this$0.m10839g1();
        Resource.Companion companion = Resource.Companion;
        Data data = oneCommonResponse.getData();
        m10839g1.setValue(companion.success((data == null || (r3 = data.getStatus()) == null) ? "" : ""));
    }
}