...
@SourceDebugExtension({"SMAP\nOneProsermOnlineConfirmFragment.kt\nKotlin\n*S Kotlin\n*F\n+ 1 OneProsermOnlineConfirmFragment.kt\nth/co/dtac/android/dtacone/view/appOne/stvProSermOnline/fragment/OneProsermOnlineConfirmFragment$setupViewModel$5\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,468:1\n1#2:469\n*E\n"})
/* renamed from: th.co.dtac.android.dtacone.view.appOne.stvProSermOnline.fragment.OneProsermOnlineConfirmFragment$setupViewModel$5 */
/* loaded from: classes10.dex */
public final class OneProsermOnlineConfirmFragment$setupViewModel$5 extends Lambda implements Function1<Resource<? extends ErrorCollection>, Unit> {
    final /* synthetic */ OneProsermOnlineConfirmFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneProsermOnlineConfirmFragment$setupViewModel$5(OneProsermOnlineConfirmFragment oneProsermOnlineConfirmFragment) {
        super(1);
    ...
    public final void invoke2(Resource<ErrorCollection> resource) {
        ...
        if (resourceContentIfNotHandled != null) {
            ...
            oneProsermOnlineConfirmFragment.m9825x(data);
        }
    }
}