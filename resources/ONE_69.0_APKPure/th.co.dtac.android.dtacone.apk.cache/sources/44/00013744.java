...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.fragment.blacklist.OnePostpaidCheckBlacklistFragment$activity$2 */
/* loaded from: classes10.dex */
public final class OnePostpaidCheckBlacklistFragment$activity$2 extends Lambda implements Function0<OnePostpaidRegistrationActivity> {
    final /* synthetic */ OnePostpaidCheckBlacklistFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidCheckBlacklistFragment$activity$2(OnePostpaidCheckBlacklistFragment onePostpaidCheckBlacklistFragment) {
        super(0);
