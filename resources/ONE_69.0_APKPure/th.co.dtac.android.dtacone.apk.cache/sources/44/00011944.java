...
@Metadata(m29143d1 = {"\u0000\f\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u001a\n\u0010\u0000\u001a\u00020\u0001*\u00020\u0002¨\u0006\u0003"}, m29142d2 = {"toBitmap", "Landroid/graphics/Bitmap;", "Lio/fotoapparat/preview/Frame;", "app_prodRelease"}, m29141k = 2, m29140mv = {1, 8, 0}, m29138xi = 48)
...
public final class FrameExtenKt {
    ...
    public static final Bitmap toBitmap(@NotNull Frame frame) {
        ...
        Timber.m1420d("Size :" + length, new Object[0]);
        int i = frame.getSize().width;
        int i2 = frame.getSize().height;
        Timber.m1420d("w:" + i + "  h:" + i2, new Object[0]);
        ...
        try {
            ...
            int i9 = rect.right;
            int i10 = rect.bottom;
            Timber.m1420d("h:" + height + " w:" + width + " l:" + i7 + " t:" + i8 + " r:" + i9 + " b:" + i10, new Object[0]);
