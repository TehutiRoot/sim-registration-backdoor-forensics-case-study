...
public class MultiTransformation<T> implements Transformation<T> {
    ...
    /* renamed from: a */
    public final Collection f41851a;

    @SafeVarargs
    public MultiTransformation(@NonNull Transformation<T>... transformationArr) {
        if (transformationArr.length != 0) {
            this.f41851a = Arrays.asList(transformationArr);
            return;
        }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof MultiTransformation) {
            return this.f41851a.equals(((MultiTransformation) obj).f41851a);
        }
        return false;
    }
    ...
    public Resource<T> transform(@NonNull Context context, @NonNull Resource<T> resource, int i, int i2) {
        ...
        for (Transformation transformation : this.f41851a) {
