...
public final class FlowableFlatMapCompletableCompletable<T> extends Completable implements FuseToFlowable<T> {
    ...
    /* renamed from: a */
    public final Flowable f64346a;

    /* renamed from: b */
    public final Function f64347b;
    ...
    public FlowableFlatMapCompletableCompletable(Flowable<T> flowable, Function<? super T, ? extends CompletableSource> function, boolean z, int i) {
        this.f64346a = flowable;
        this.f64347b = function;
        this.f64349d = z;
        this.f64348c = i;
    }
    ...
    public Flowable<T> fuseToFlowable() {
        return RxJavaPlugins.onAssembly(new FlowableFlatMapCompletable(this.f64346a, this.f64347b, this.f64349d, this.f64348c));
    }

    @Override // io.reactivex.Completable
    public void subscribeActual(CompletableObserver completableObserver) {
        this.f64346a.subscribe((FlowableSubscriber) new FlatMapCompletableMainSubscriber(completableObserver, this.f64347b, this.f64349d, this.f64348c));
    }
}