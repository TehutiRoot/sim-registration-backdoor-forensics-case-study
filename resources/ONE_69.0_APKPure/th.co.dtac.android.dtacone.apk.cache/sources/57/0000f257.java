...
public class BrowserCompatSpec extends CookieSpecBase {
    ...
    public BrowserCompatSpec(String[] strArr, BrowserCompatSpecFactory.SecurityLevel securityLevel) {
        super(new BrowserCompatVersionAttributeHandler(), new BasicDomainHandler(), securityLevel == BrowserCompatSpecFactory.SecurityLevel.SECURITYLEVEL_IE_MEDIUM ? new C12603a() : new BasicPathHandler(), new BasicMaxAgeHandler(), new BasicSecureHandler(), new BasicCommentHandler(), new BasicExpiresHandler(strArr != null ? (String[]) strArr.clone() : f74421b));
    }

    /* renamed from: a */
    public static boolean m24801a(String str) {
    ...
    public List<Header> formatCookies(List<Cookie> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if (cookie.getVersion() > 0 && !m24801a(value)) {
