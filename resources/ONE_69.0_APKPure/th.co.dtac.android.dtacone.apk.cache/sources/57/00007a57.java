...
public class HardenedObjectInputStream extends ObjectInputStream {
    ...
    /* renamed from: b */
    public static final String[] f39861b = {"java.lang", "java.util"};
    ...
    /* renamed from: b */
    public final boolean m51452b(String str) {
        int i = 0;
        while (true) {
            String[] strArr = f39861b;
            if (i >= strArr.length) {
                for (String str2 : this.f39862a) {
                    if (str.equals(str2)) {
                        return true;
                    }
                }
    ...
    public Class<?> resolveClass(ObjectStreamClass objectStreamClass) throws IOException, ClassNotFoundException {
        if (m51452b(objectStreamClass.getName())) {
