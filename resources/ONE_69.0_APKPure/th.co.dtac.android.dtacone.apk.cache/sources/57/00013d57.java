...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.rectify.viewmodel.OneRectifyViewModel$getRectifyList$obs$4 */
/* loaded from: classes10.dex */
public final class OneRectifyViewModel$getRectifyList$obs$4 extends Lambda implements Function1<String, String> {
    final /* synthetic */ OneRectifyViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneRectifyViewModel$getRectifyList$obs$4(OneRectifyViewModel oneRectifyViewModel) {
        super(1);
