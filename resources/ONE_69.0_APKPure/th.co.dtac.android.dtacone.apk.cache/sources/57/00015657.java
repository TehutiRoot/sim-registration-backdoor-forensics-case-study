...
@SourceDebugExtension({"SMAP\nESimPostpaidViewModel.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ESimPostpaidViewModel.kt\nth/co/dtac/android/dtacone/viewmodel/esim/ESimPostpaidViewModel$uploadImage$5\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,2121:1\n1#2:2122\n*E\n"})
/* renamed from: th.co.dtac.android.dtacone.viewmodel.esim.ESimPostpaidViewModel$uploadImage$5 */
/* loaded from: classes9.dex */
public final class ESimPostpaidViewModel$uploadImage$5 extends Lambda implements Function1<UploadImageResponse, Unit> {
    final /* synthetic */ ESimPostpaidViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimPostpaidViewModel$uploadImage$5(ESimPostpaidViewModel eSimPostpaidViewModel) {
        super(1);
    ...
    public final void invoke2(UploadImageResponse uploadImageResponse) {
        ...
        if (filename != null) {
            ...
            eSimRepository.getAttachmentNames().add(filename);
        }
    }
}