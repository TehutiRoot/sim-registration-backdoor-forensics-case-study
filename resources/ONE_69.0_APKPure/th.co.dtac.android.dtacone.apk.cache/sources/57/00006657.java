...
public final class UtilsKt {
    ...
    /* renamed from: a */
    public static final List f31789a = AbstractC10100ds.listOf("TransformOriginInterruptionHandling");

    /* renamed from: a */
    public static final long m58862a(Lazy lazy) {
    ...
    public static final List<Transition<?>.TransitionAnimationState<?, ?>> allAnimations(@NotNull Transition<?> transition) {
        ...
        while (it.hasNext()) {
            AbstractC10396hs.addAll(arrayList, allAnimations((Transition) it.next()));
        }
        return CollectionsKt___CollectionsKt.plus((Collection) transition.getAnimations(), (Iterable) arrayList);
    }

    /* renamed from: b */
    public static final Map m58861b(Lazy lazy) {
        return (Map) lazy.getValue();
    }

    /* renamed from: c */
    public static final Map m58860c(Lazy lazy) {
        return (Map) lazy.getValue();
    }
    ...
    /* renamed from: d */
    public static final C3623Dp m58859d(Object obj) {
        C3623Dp c3623Dp;
        Float f;
        Double d;
        Integer num;
        if (obj instanceof C3623Dp) {
            c3623Dp = (C3623Dp) obj;
        } else {
            c3623Dp = null;
        }
        if (c3623Dp == null) {
            ...
            if (f != null) {
                c3623Dp = C3623Dp.m73840boximpl(C3623Dp.m73842constructorimpl(f.floatValue()));
            } else {
                c3623Dp = null;
            }
            if (c3623Dp == null) {
                ...
                if (d != null) {
                    c3623Dp = C3623Dp.m73840boximpl(C3623Dp.m73842constructorimpl((float) d.doubleValue()));
                } else {
                    c3623Dp = null;
                }
                if (c3623Dp == null) {
                    ...
                    return C3623Dp.m73840boximpl(C3623Dp.m73842constructorimpl(num.intValue()));
                }
            }
        }
        return c3623Dp;
    ...
    /* renamed from: e */
    public static final boolean m58858e(Object obj, Object obj2) {
    ...
    /* renamed from: f */
    public static final boolean m58857f(Object obj, Object obj2, Object obj3) {
    ...
    /* renamed from: g */
    public static final TargetState m58856g(Object obj, Object obj2, Object obj3) {
        if (!(obj instanceof C3623Dp) || obj3 == null) {
            return null;
        }
        if ((obj2 instanceof C3623Dp) && (obj3 instanceof C3623Dp)) {
            return new TargetState(obj2, obj3);
        }
        C3623Dp m58859d = m58859d(obj2);
        C3623Dp m58859d2 = m58859d(obj3);
        if (m58859d == null || m58859d2 == null) {
            return null;
        }
        return new TargetState(m58859d, m58859d2);
    }
    ...
    public static final <T> TargetState<T> parseParametersToValue(T t, @NotNull Object par1, @Nullable Object obj) {
        ...
        TargetState<T> m58856g = m58856g(t, par1, obj);
        if (m58856g != null) {
            return m58856g;
        }
        if (!m58858e(par1, obj)) {
        ...
        if ((par1 instanceof List) && (obj instanceof List)) {
            try {
                if (t instanceof IntSize) {
                    ...
                    IntSize m73994boximpl = IntSize.m73994boximpl(IntSizeKt.IntSize(intValue, ((Integer) obj3).intValue()));
                    Object obj4 = ((List) obj).get(0);
                    Intrinsics.checkNotNull(obj4, "null cannot be cast to non-null type kotlin.Int");
                    int intValue2 = ((Integer) obj4).intValue();
                    Object obj5 = ((List) obj).get(1);
                    Intrinsics.checkNotNull(obj5, "null cannot be cast to non-null type kotlin.Int");
                    targetState = new TargetState<>(m73994boximpl, IntSize.m73994boximpl(IntSizeKt.IntSize(intValue2, ((Integer) obj5).intValue())));
                    ...
                    IntOffset m73951boximpl = IntOffset.m73951boximpl(IntOffsetKt.IntOffset(intValue3, ((Integer) obj7).intValue()));
                    Object obj8 = ((List) obj).get(0);
                    Intrinsics.checkNotNull(obj8, "null cannot be cast to non-null type kotlin.Int");
                    int intValue4 = ((Integer) obj8).intValue();
                    Object obj9 = ((List) obj).get(1);
                    Intrinsics.checkNotNull(obj9, "null cannot be cast to non-null type kotlin.Int");
                    targetState = new TargetState<>(m73951boximpl, IntOffset.m73951boximpl(IntOffsetKt.IntOffset(intValue4, ((Integer) obj9).intValue())));
                    ...
                    Size m71743boximpl = Size.m71743boximpl(SizeKt.Size(floatValue, ((Float) obj11).floatValue()));
                    ...
                    targetState = new TargetState<>(m71743boximpl, Size.m71743boximpl(SizeKt.Size(floatValue2, ((Float) obj13).floatValue())));
                    ...
                    Offset m71675boximpl = Offset.m71675boximpl(OffsetKt.Offset(floatValue3, ((Float) obj15).floatValue()));
                    ...
                    targetState = new TargetState<>(m71675boximpl, Offset.m71675boximpl(OffsetKt.Offset(floatValue4, ((Float) obj17).floatValue())));
                    ...
                    Color m71909boximpl = Color.m71909boximpl(ColorKt.Color$default(floatValue11, floatValue12, floatValue13, ((Float) obj29).floatValue(), null, 16, null));
                    ...
                    targetState = new TargetState<>(m71909boximpl, Color.m71909boximpl(ColorKt.Color$default(floatValue14, floatValue15, floatValue16, ((Float) obj33).floatValue(), null, 16, null)));
                } else if (t instanceof C3623Dp) {
                    Object obj34 = ((List) par1).get(0);
                    Intrinsics.checkNotNull(obj34);
                    Object obj35 = ((List) obj).get(0);
                    Intrinsics.checkNotNull(obj35);
                    targetState = m58856g(t, obj34, obj35);
                } else if (m58858e(((List) par1).get(0), ((List) obj).get(0))) {
                    Object obj36 = ((List) par1).get(0);
                    Intrinsics.checkNotNull(obj36);
                    Object obj37 = ((List) obj).get(0);
                    Intrinsics.checkNotNull(obj37);
                    if (m58857f(t, obj36, obj37)) {
    ...
    public static final <T, V extends AnimationVector> TransitionInfo createTransitionInfo(@NotNull Animation<T, V> animation, @NotNull String label, @NotNull AnimationSpec<T> animationSpec, long j) {
        ...
        return new TransitionInfo(label, name, m58862a(lazy), nanosToMillis, m58861b(lazy2));
    }
    ...
    public static final <T, V extends AnimationVector> TransitionInfo createTransitionInfo(@NotNull InfiniteTransition.TransitionAnimationState<T, V> transitionAnimationState, long j, long j2) {
        ...
        Intrinsics.checkNotNullExpressionValue(name, "animationSpec.javaClass.name");
        return new TransitionInfo(label, name, 0L, j2, m58860c(lazy));
    }
}