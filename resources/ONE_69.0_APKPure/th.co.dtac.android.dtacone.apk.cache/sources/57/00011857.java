...
/* renamed from: th.co.dtac.android.dtacone.databinding.OnePackageMnpItemRowForSummaryBinding */
/* loaded from: classes7.dex */
public final class OnePackageMnpItemRowForSummaryBinding implements ViewBinding {

    /* renamed from: a */
    public final DtacCardView f84614a;
    @NonNull
    ...
    public OnePackageMnpItemRowForSummaryBinding(DtacCardView dtacCardView, DtacCardView dtacCardView2, AppCompatImageView appCompatImageView, AppCompatImageView appCompatImageView2, AppCompatImageView appCompatImageView3, RelativeLayout relativeLayout, ConstraintLayout constraintLayout, FlexboxLayout flexboxLayout, RelativeLayout relativeLayout2, LinearLayoutCompat linearLayoutCompat, LinearLayoutCompat linearLayoutCompat2, LinearLayoutCompat linearLayoutCompat3, OneFontTextView oneFontTextView, OneFontTextView oneFontTextView2, OneFontTextView oneFontTextView3, OneFontTextView oneFontTextView4, OneFontTextView oneFontTextView5, OneFontTextView oneFontTextView6, OneFontTextView oneFontTextView7, OneFontTextView oneFontTextView8) {
        this.f84614a = dtacCardView;
    ...
    @NonNull
    public static OnePackageMnpItemRowForSummaryBinding bind(@NonNull View view) {
                                                                    ...
                                                                    if (oneFontTextView6 != null) {
                                                                        ...
                                                                        if (oneFontTextView7 != null) {
                                                                            ...
                                                                            if (oneFontTextView8 != null) {
                                                                                return new OnePackageMnpItemRowForSummaryBinding(dtacCardView, dtacCardView, appCompatImageView, appCompatImageView2, appCompatImageView3, relativeLayout, constraintLayout, flexboxLayout, relativeLayout2, linearLayoutCompat, linearLayoutCompat2, linearLayoutCompat3, oneFontTextView, oneFontTextView2, oneFontTextView3, oneFontTextView4, oneFontTextView5, oneFontTextView6, oneFontTextView7, oneFontTextView8);
                                                                            }
                                                                        }
                                                                    }
                                                                }
    ...
    @NonNull
    public static OnePackageMnpItemRowForSummaryBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static OnePackageMnpItemRowForSummaryBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.one_package_mnp_item_row_for_summary, viewGroup, false);
        if (z) {
