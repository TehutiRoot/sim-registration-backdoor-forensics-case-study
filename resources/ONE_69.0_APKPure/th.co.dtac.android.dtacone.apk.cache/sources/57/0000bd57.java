...
import com.netcetera.threeds.sdk.infrastructure.AbstractC9660oo;
import kotlin.p023io.encoding.Base64;
import okio.Utf8;

/* renamed from: com.netcetera.threeds.sdk.infrastructure.op */
/* loaded from: classes5.dex */
public class C9661op extends AbstractC9660oo {
    ...
    @Override // com.netcetera.threeds.sdk.infrastructure.AbstractC9660oo
    public void ThreeDS2Service(byte[] bArr, int i, int i2, AbstractC9660oo.get getVar) {
    ...
    @Override // com.netcetera.threeds.sdk.infrastructure.AbstractC9660oo
    public void get(byte[] bArr, int i, int i2, AbstractC9660oo.get getVar) {
        byte b;
        if (getVar.getSDKVersion) {
            return;
        }
    ...
    public C9661op(int i) {
        this(i, ThreeDS2Service);
    }

    public C9661op(int i, byte[] bArr) {
        this(i, bArr, false);
    }

    public C9661op(int i, byte[] bArr, boolean z) {
        super(3, 4, i, bArr == null ? 0 : bArr.length);
        this.getSDKVersion = getWarnings;
        if (bArr != null) {
            if (get(bArr)) {
                String str = C9719ro.get(bArr);
