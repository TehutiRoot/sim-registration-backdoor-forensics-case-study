...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.prepaid_registration.fragment.OnePrepaidSummaryFragment$activity$2 */
/* loaded from: classes10.dex */
public final class OnePrepaidSummaryFragment$activity$2 extends Lambda implements Function0<OnePrepaidRegistrationActivity> {
    final /* synthetic */ OnePrepaidSummaryFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePrepaidSummaryFragment$activity$2(OnePrepaidSummaryFragment onePrepaidSummaryFragment) {
        super(0);
