...
/* renamed from: th.co.dtac.android.dtacone.presenter.dtacAtHome.DtacAtHomeVerifyOtpPresenter$verifyOtp$4 */
/* loaded from: classes8.dex */
public final class DtacAtHomeVerifyOtpPresenter$verifyOtp$4 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ DtacAtHomeVerifyOtpPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DtacAtHomeVerifyOtpPresenter$verifyOtp$4(DtacAtHomeVerifyOtpPresenter dtacAtHomeVerifyOtpPresenter) {
        super(1);
    ...
    public final void invoke2(Throwable th2) {
        ...
        final DtacAtHomeVerifyOtpPresenter dtacAtHomeVerifyOtpPresenter = this.this$0;
        errorService.handleException(th2, new ServerErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.presenter.dtacAtHome.DtacAtHomeVerifyOtpPresenter$verifyOtp$4.1
            ...
            public void handle(@Nullable Throwable th3) {
                ...
                try {
                    ...
                    if (Intrinsics.areEqual(serverErrorException.error().getStatusCode(), BuyDolConfig.OTP_FAIL_CODE)) {
                        view = DtacAtHomeVerifyOtpPresenter.this.f85744d;
                        if (view == null) {
                    ...
                    DtacAtHomeVerifyOtpPresenter.this.getErrorService().handleException(th3, new ServerErrorService.ExceptionHandler[0]);
                } catch (Exception e) {
                    DtacAtHomeVerifyOtpPresenter.this.getErrorService().handleException(e, new ServerErrorService.ExceptionHandler[0]);
                }
            }
