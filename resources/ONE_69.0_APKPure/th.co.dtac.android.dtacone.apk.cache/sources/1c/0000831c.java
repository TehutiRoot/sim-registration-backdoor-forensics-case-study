...
@DebugMetadata(m29093c = "com.chuckerteam.chucker.internal.ui.transaction.TransactionPayloadFragment$onQueryTextChange$1", m29092f = "TransactionPayloadFragment.kt", m29091i = {}, m29090l = {267, 470}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
...
public final class TransactionPayloadFragment$onQueryTextChange$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (!isDispatchNeeded) {
            if (lifecycle.getCurrentState() != Lifecycle.State.DESTROYED) {
                if (lifecycle.getCurrentState().compareTo(state) >= 0) {
                    arrayList = transactionPayloadFragment.f43041i;
                    if (!arrayList.isEmpty()) {
                        transactionPayloadFragment.m49848F(0);
                    } else {
                        transactionPayloadFragment.f43042j = -1;
                    }
        ...
        C5973x4e372e56 c5973x4e372e56 = new C5973x4e372e56(transactionPayloadFragment);
        this.label = 2;
        if (WithLifecycleStateKt.suspendWithStateAtLeastUnchecked(lifecycle, state, isDispatchNeeded, immediate, c5973x4e372e56, this) == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Unit.INSTANCE;
    }
