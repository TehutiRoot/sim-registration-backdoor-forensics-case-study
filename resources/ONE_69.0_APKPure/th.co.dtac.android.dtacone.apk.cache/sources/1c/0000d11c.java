...
public final class MaybeFlatMapObservable<T, R> extends Observable<R> {
    ...
    /* renamed from: a */
    public final MaybeSource f65011a;

    /* renamed from: b */
    public final Function f65012b;
    ...
    public MaybeFlatMapObservable(MaybeSource<T> maybeSource, Function<? super T, ? extends ObservableSource<? extends R>> function) {
        this.f65011a = maybeSource;
        this.f65012b = function;
    }

    @Override // io.reactivex.Observable
    public void subscribeActual(Observer<? super R> observer) {
        FlatMapObserver flatMapObserver = new FlatMapObserver(observer, this.f65012b);
        observer.onSubscribe(flatMapObserver);
        this.f65011a.subscribe(flatMapObserver);
    }
}