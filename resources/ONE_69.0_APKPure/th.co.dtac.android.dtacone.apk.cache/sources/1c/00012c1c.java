...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.change_owner.viewModel.OneChangeOwnerViewModel$submitReRegister$2 */
/* loaded from: classes10.dex */
public final class OneChangeOwnerViewModel$submitReRegister$2 extends Lambda implements Function1<ResponseBody, Unit> {
    final /* synthetic */ OneChangeOwnerViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneChangeOwnerViewModel$submitReRegister$2(OneChangeOwnerViewModel oneChangeOwnerViewModel) {
        super(1);
