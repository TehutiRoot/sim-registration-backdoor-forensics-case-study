...
public final class IconButtonKt$FilledIconToggleButton$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    final /* synthetic */ int $$dirty;
    final /* synthetic */ Function2<Composer, Integer, Unit> $content;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public IconButtonKt$FilledIconToggleButton$3(Function2<? super Composer, ? super Integer, Unit> function2, int i) {
        super(2);
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1235871670, i, -1, "androidx.compose.material3.FilledIconToggleButton.<anonymous> (IconButton.kt:331)");
        }
        Modifier m69748size3ABfNKs = SizeKt.m69748size3ABfNKs(Modifier.Companion, FilledIconButtonTokens.INSTANCE.m71223getContainerSizeD9Ej5fM());
