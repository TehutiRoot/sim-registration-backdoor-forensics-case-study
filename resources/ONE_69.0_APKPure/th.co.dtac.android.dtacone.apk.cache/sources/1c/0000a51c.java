...
public final class SystemParameter extends GeneratedMessageLite<SystemParameter, Builder> implements SystemParameterOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<SystemParameter, Builder> implements SystemParameterOrBuilder {
        public /* synthetic */ Builder(C7242a c7242a) {
            this();
        }

        public Builder clearHttpHeader() {
            copyOnWrite();
            ((SystemParameter) this.instance).m41939L();
            return this;
        }

        public Builder clearName() {
            copyOnWrite();
            ((SystemParameter) this.instance).m41938M();
            return this;
        }

        public Builder clearUrlQueryParameter() {
            copyOnWrite();
            ((SystemParameter) this.instance).m41937N();
            return this;
        }
        ...
        public Builder setHttpHeader(String str) {
            copyOnWrite();
            ((SystemParameter) this.instance).m41936O(str);
            return this;
        }

        public Builder setHttpHeaderBytes(ByteString byteString) {
            copyOnWrite();
            ((SystemParameter) this.instance).m41935P(byteString);
            return this;
        }

        public Builder setName(String str) {
            copyOnWrite();
            ((SystemParameter) this.instance).m41934Q(str);
            return this;
        }

        public Builder setNameBytes(ByteString byteString) {
            copyOnWrite();
            ((SystemParameter) this.instance).m41933R(byteString);
            return this;
        }

        public Builder setUrlQueryParameter(String str) {
            copyOnWrite();
            ((SystemParameter) this.instance).m41932S(str);
            return this;
        }

        public Builder setUrlQueryParameterBytes(ByteString byteString) {
            copyOnWrite();
            ((SystemParameter) this.instance).m41931T(byteString);
            return this;
        }
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C7242a {
        ...
        static {
            ...
            try {
                f51666a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f51666a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f51666a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f51666a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f51666a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f51666a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: Q */
    public void m41934Q(String str) {
        str.getClass();
        this.name_ = str;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: R */
    public void m41933R(ByteString byteString) {
    ...
    /* renamed from: L */
    public final void m41939L() {
        this.httpHeader_ = getDefaultInstance().getHttpHeader();
    }

    /* renamed from: N */
    public final void m41937N() {
        this.urlQueryParameter_ = getDefaultInstance().getUrlQueryParameter();
    }

    /* renamed from: O */
    public final void m41936O(String str) {
        str.getClass();
        this.httpHeader_ = str;
    }

    /* renamed from: P */
    public final void m41935P(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.httpHeader_ = byteString.toStringUtf8();
    }

    /* renamed from: S */
    public final void m41932S(String str) {
        str.getClass();
        this.urlQueryParameter_ = str;
    }

    /* renamed from: T */
    public final void m41931T(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C7242a.f51666a[methodToInvoke.ordinal()]) {
            case 1:
