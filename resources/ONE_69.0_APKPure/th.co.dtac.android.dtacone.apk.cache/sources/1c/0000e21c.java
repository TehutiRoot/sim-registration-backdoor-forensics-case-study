...
public final class AbstractNullabilityChecker {
    ...
    /* renamed from: a */
    public final boolean m27895a(TypeCheckerState typeCheckerState, SimpleTypeMarker simpleTypeMarker, TypeConstructorMarker typeConstructorMarker) {
    ...
    /* renamed from: b */
    public final boolean m27894b(TypeCheckerState typeCheckerState, SimpleTypeMarker simpleTypeMarker, SimpleTypeMarker simpleTypeMarker2) {
        TypeSystemContext typeSystemContext = typeCheckerState.getTypeSystemContext();
    ...
    public final boolean hasPathByNotMarkedNullableNodes(@NotNull TypeCheckerState state, @NotNull SimpleTypeMarker start, @NotNull TypeConstructorMarker end) {
        ...
        if (INSTANCE.m27895a(state, start, end)) {
            return true;
        }
        state.initialize();
                ...
                if (supertypesSet.add(current)) {
                    ...
                    if (supertypesPolicy == null) {
                        ...
                        for (KotlinTypeMarker kotlinTypeMarker : typeSystemContext2.supertypes(typeSystemContext2.typeConstructor(current))) {
                            ...
                            if (INSTANCE.m27895a(state, transformType, end)) {
                                state.clear();
                                return true;
                            }
                            supertypesDeque.add(transformType);
    ...
    public final boolean isPossibleSubtype(@NotNull TypeCheckerState state, @NotNull SimpleTypeMarker subType, @NotNull SimpleTypeMarker superType) {
        ...
        return m27894b(state, subType, superType);
    }
}