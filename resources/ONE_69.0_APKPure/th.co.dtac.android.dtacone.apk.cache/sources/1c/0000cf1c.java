...
public final class FlowableDelaySubscriptionOther<T, U> extends Flowable<T> {
    ...
    /* renamed from: b */
    public final Publisher f64266b;

    /* renamed from: c */
    public final Publisher f64267c;
    ...
    public FlowableDelaySubscriptionOther(Publisher<? extends T> publisher, Publisher<U> publisher2) {
        this.f64266b = publisher;
        this.f64267c = publisher2;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super T> subscriber) {
        MainSubscriber mainSubscriber = new MainSubscriber(subscriber, this.f64266b);
        subscriber.onSubscribe(mainSubscriber);
        this.f64267c.subscribe(mainSubscriber.other);
    }
}