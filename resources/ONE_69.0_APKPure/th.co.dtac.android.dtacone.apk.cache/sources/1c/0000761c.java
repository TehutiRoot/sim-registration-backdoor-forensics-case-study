...
public abstract class CoroutineWorker extends ListenableWorker {
    ...
    public CoroutineWorker(@NotNull Context appContext, @NotNull WorkerParameters params) {
        ...
        create.addListener(new Runnable() { // from class: Jy
            ...
            public final void run() {
                CoroutineWorker.m52309a(CoroutineWorker.this);
            }
        }, getTaskExecutor().getSerialTaskExecutor());
        this.f38313g = Dispatchers.getDefault();
    }

    /* renamed from: a */
    public static /* synthetic */ void m52309a(CoroutineWorker coroutineWorker) {
        m52308b(coroutineWorker);
    }

    /* renamed from: b */
    public static final void m52308b(CoroutineWorker this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        if (this$0.f38312f.isCancelled()) {
            Job.DefaultImpls.cancel$default((Job) this$0.f38311e, (CancellationException) null, 1, (Object) null);
        }
    }

    /* renamed from: c */
    public static /* synthetic */ Object m52307c(CoroutineWorker coroutineWorker, Continuation continuation) {
    ...
    public Object getForegroundInfo(@NotNull Continuation<? super ForegroundInfo> continuation) {
        return m52307c(this, continuation);
    }
    ...
    public final ListenableFuture<ForegroundInfo> getForegroundInfoAsync() {
        CompletableJob m27608c;
        m27608c = AbstractC12015a.m27608c(null, 1, null);
        CoroutineScope CoroutineScope = CoroutineScopeKt.CoroutineScope(getCoroutineContext().plus(m27608c));
        JobListenableFuture jobListenableFuture = new JobListenableFuture(m27608c, null, 2, null);
        AbstractC1539Vc.m65885e(CoroutineScope, null, null, new CoroutineWorker$getForegroundInfoAsync$1(jobListenableFuture, this, null), 3, null);
    ...
    public final ListenableFuture<ListenableWorker.Result> startWork() {
        AbstractC1539Vc.m65885e(CoroutineScopeKt.CoroutineScope(getCoroutineContext().plus(this.f38311e)), null, null, new CoroutineWorker$startWork$1(this, null), 3, null);
        return this.f38312f;
    }
}