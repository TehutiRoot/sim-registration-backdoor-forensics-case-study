...
public class GPUImageToonFilter extends GPUImage3x3TextureSamplingFilter {
    ...
    /* renamed from: k */
    public float f67684k;

    /* renamed from: l */
    public int f67685l;

    /* renamed from: m */
    public float f67686m;
    ...
    public void onInit() {
        super.onInit();
        this.f67685l = GLES20.glGetUniformLocation(getProgram(), "threshold");
        this.f67687n = GLES20.glGetUniformLocation(getProgram(), "quantizationLevels");
    }

    @Override // jp.p022co.cyberagent.android.gpuimage.GPUImageFilter
    public void onInitialized() {
        super.onInitialized();
        setThreshold(this.f67684k);
        setQuantizationLevels(this.f67686m);
    }

    public void setQuantizationLevels(float f) {
        this.f67686m = f;
        setFloat(this.f67687n, f);
    }

    public void setThreshold(float f) {
        this.f67684k = f;
        setFloat(this.f67685l, f);
    }
