...
@Metadata(m29143d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m29142d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_smokingRooms", "Landroidx/compose/material/icons/Icons$TwoTone;", "getSmokingRooms", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "SmokingRooms", "material-icons-extended_release"}, m29141k = 2, m29140mv = {1, 8, 0})
...
public final class SmokingRoomsKt {
    ...
    @NotNull
    public static final ImageVector getSmokingRooms(@NotNull Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.SmokingRooms", C3623Dp.m73842constructorimpl(24.0f), C3623Dp.m73842constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder2.verticalLineToRelative(-3.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(20.5f, 16.0f);
        pathBuilder2.lineTo(22.0f, 16.0f);
        pathBuilder2.verticalLineToRelative(3.0f);
        ...
        pathBuilder2.horizontalLineToRelative(1.5f);
        pathBuilder2.verticalLineToRelative(3.0f);
        pathBuilder2.lineTo(18.0f, 19.0f);
        pathBuilder2.verticalLineToRelative(-3.0f);
        pathBuilder2.close();
        pathBuilder2.moveTo(18.85f, 7.73f);
        pathBuilder2.curveToRelative(0.62f, -0.61f, 1.0f, -1.45f, 1.0f, -2.38f);
        pathBuilder2.curveTo(19.85f, 3.5f, 18.35f, 2.0f, 16.5f, 2.0f);
        pathBuilder2.verticalLineToRelative(1.5f);
        pathBuilder2.curveToRelative(1.02f, 0.0f, 1.85f, 0.83f, 1.85f, 1.85f);
        pathBuilder2.reflectiveCurveTo(17.52f, 7.2f, 16.5f, 7.2f);
        pathBuilder2.verticalLineToRelative(1.5f);
        pathBuilder2.curveToRelative(2.24f, 0.0f, 4.0f, 1.83f, 4.0f, 4.07f);
        pathBuilder2.lineTo(20.5f, 15.0f);
        pathBuilder2.lineTo(22.0f, 15.0f);
        pathBuilder2.verticalLineToRelative(-2.24f);
        pathBuilder2.curveToRelative(0.0f, -2.22f, -1.28f, -4.14f, -3.15f, -5.03f);
        pathBuilder2.close();
        pathBuilder2.moveTo(16.03f, 10.2f);
        pathBuilder2.lineTo(14.5f, 10.2f);
        pathBuilder2.curveToRelative(-1.02f, 0.0f, -1.85f, -0.98f, -1.85f, -2.0f);
        pathBuilder2.reflectiveCurveToRelative(0.83f, -1.75f, 1.85f, -1.75f);
        pathBuilder2.verticalLineToRelative(-1.5f);
        ...
        pathBuilder2.curveToRelative(1.05f, 0.0f, 1.97f, 0.74f, 1.97f, 2.05f);
        pathBuilder2.lineTo(18.0f, 15.0f);
        pathBuilder2.horizontalLineToRelative(1.5f);
        pathBuilder2.verticalLineToRelative(-1.64f);
        pathBuilder2.curveToRelative(0.0f, -1.81f, -1.6f, -3.16f, -3.47f, -3.16f);
        pathBuilder2.close();
