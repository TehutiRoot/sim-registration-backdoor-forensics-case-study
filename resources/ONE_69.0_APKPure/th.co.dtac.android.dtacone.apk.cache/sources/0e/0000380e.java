...
@Metadata(m29143d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m29142d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_faceRetouchingOff", "Landroidx/compose/material/icons/Icons$Outlined;", "getFaceRetouchingOff", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "FaceRetouchingOff", "material-icons-extended_release"}, m29141k = 2, m29140mv = {1, 8, 0})
...
public final class FaceRetouchingOffKt {
    ...
    /* renamed from: a */
    public static ImageVector f17620a;

    @NotNull
    public static final ImageVector getFaceRetouchingOff(@NotNull Icons.Outlined outlined) {
        Intrinsics.checkNotNullParameter(outlined, "<this>");
        ImageVector imageVector = f17620a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.FaceRetouchingOff", C3623Dp.m73842constructorimpl(24.0f), C3623Dp.m73842constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder3.close();
        pathBuilder3.moveTo(6.23f, 8.06f);
        pathBuilder3.curveTo(5.7f, 8.61f, 5.09f, 9.09f, 4.42f, 9.47f);
        pathBuilder3.curveTo(4.68f, 8.7f, 5.05f, 7.99f, 5.51f, 7.34f);
        pathBuilder3.lineTo(6.23f, 8.06f);
        pathBuilder3.close();
