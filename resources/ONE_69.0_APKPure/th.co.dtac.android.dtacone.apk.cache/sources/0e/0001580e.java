...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_change_sim.MrtrChangeSimValidateViewModel$checkOwner$2 */
/* loaded from: classes9.dex */
public final class MrtrChangeSimValidateViewModel$checkOwner$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ MrtrChangeSimValidateViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrChangeSimValidateViewModel$checkOwner$2(MrtrChangeSimValidateViewModel mrtrChangeSimValidateViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull final Throwable it) {
        ...
        mrtrErrorService.handleException(it, new MrtrErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.viewmodel.mrtr_change_sim.MrtrChangeSimValidateViewModel$checkOwner$2.1
            ...
            public void handle(@Nullable Throwable th2) {
                ...
                if ((th2 instanceof HttpException) && ((HttpException) th2).code() == 404) {
                    mrtrErrorService3 = MrtrChangeSimValidateViewModel.this.f106216e;
                ...
                mutableLiveData = MrtrChangeSimValidateViewModel.this.f106230s;
                mutableLiveData.setValue(Resource.Companion.error$default(Resource.Companion, Constants.IPC_BUNDLE_KEY_SEND_ERROR, errorCollection, null, 4, null));
            }
