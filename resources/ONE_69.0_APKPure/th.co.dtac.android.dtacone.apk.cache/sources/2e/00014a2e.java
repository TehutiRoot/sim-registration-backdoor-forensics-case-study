...
/* renamed from: th.co.dtac.android.dtacone.view.fragment.customerenquiry.InfoAnalyticFragment$onViewCreated$1$7 */
/* loaded from: classes9.dex */
public final class InfoAnalyticFragment$onViewCreated$1$7 extends Lambda implements Function1<OfferPackageData, Unit> {
    final /* synthetic */ InfoAnalyticFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InfoAnalyticFragment$onViewCreated$1$7(InfoAnalyticFragment infoAnalyticFragment) {
        super(1);
