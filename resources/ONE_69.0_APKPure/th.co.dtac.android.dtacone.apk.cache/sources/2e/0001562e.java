...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.esim.ESimPostpaidViewModel$callAPIHardwareNumber$2 */
/* loaded from: classes9.dex */
public final class ESimPostpaidViewModel$callAPIHardwareNumber$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ ESimPostpaidViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimPostpaidViewModel$callAPIHardwareNumber$2(ESimPostpaidViewModel eSimPostpaidViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable it) {
        ...
        m2828f0.setValue(Resource.Companion.error$default(Resource.Companion, "", null, null, 4, null));
        mrtrErrorService = this.this$0.f105745g;
        final ESimPostpaidViewModel eSimPostpaidViewModel = this.this$0;
        mrtrErrorService.handleException(it, new MrtrErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.viewmodel.esim.ESimPostpaidViewModel$callAPIHardwareNumber$2.1
