...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.viewmodel.OnePostpaidRegistrationViewModel$getForms$2 */
/* loaded from: classes10.dex */
public final class OnePostpaidRegistrationViewModel$getForms$2 extends Lambda implements Function1<OneGetFormsResponse, Unit> {
    final /* synthetic */ OnePostpaidRegistrationViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidRegistrationViewModel$getForms$2(OnePostpaidRegistrationViewModel onePostpaidRegistrationViewModel) {
        super(1);
    ...
    public final void invoke2(OneGetFormsResponse oneGetFormsResponse) {
        MutableLiveData m11655V1;
        MutableLiveData m11600h2;
        OnePostpaidRepository onePostpaidRepository;
        m11655V1 = this.this$0.m11655V1();
        m11655V1.setValue(Resource.Companion.success(oneGetFormsResponse));
        ...
        if (pdfForm != null) {
            ...
            String substring = oneGetFormsResponse.getData().getPdfForm().substring(28, pdfForm.length());
            Intrinsics.checkNotNullExpressionValue(substring, "substring(...)");
            onePostpaidRepository.setESignFormPDF(substring);
        }
        m11600h2 = this.this$0.m11600h2();
        m11600h2.setValue(new Event(new FragmentNavEvent(OnePostpaidNiceNumberTrueFragment.class, null, null, 4, null)));
