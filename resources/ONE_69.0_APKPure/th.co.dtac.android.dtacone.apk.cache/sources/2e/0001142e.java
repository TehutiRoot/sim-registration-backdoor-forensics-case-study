...
public abstract class OnSubscribeRealm<T> implements ObservableOnSubscribe<T> {
    ...
    /* renamed from: a */
    public final RealmConfiguration f83542a;

    /* renamed from: b */
    public final List f83543b;

    /* renamed from: c */
    public final AtomicBoolean f83544c;

    /* renamed from: d */
    public final Object f83545d;

    public OnSubscribeRealm(@NotNull RealmConfiguration configuration) {
        Intrinsics.checkNotNullParameter(configuration, "configuration");
        this.f83542a = configuration;
        this.f83543b = new ArrayList();
        this.f83544c = new AtomicBoolean();
        this.f83545d = new Object();
    }

    /* renamed from: a */
    public static /* synthetic */ void m19735a(OnSubscribeRealm onSubscribeRealm, ObservableEmitter observableEmitter) {
        m19733c(onSubscribeRealm, observableEmitter);
    }

    /* renamed from: c */
    public static final void m19733c(OnSubscribeRealm this$0, ObservableEmitter emitter) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(emitter, "$emitter");
        synchronized (this$0.f83545d) {
            try {
                this$0.f83543b.remove(emitter);
                if (this$0.f83543b.isEmpty()) {
                    this$0.f83544c.set(true);
                }
    ...
    /* renamed from: b */
    public final Disposable m19734b(final ObservableEmitter observableEmitter) {
        Disposable fromAction = Disposables.fromAction(new Action() { // from class: EK0
            @Override // io.reactivex.functions.Action
            public final void run() {
                OnSubscribeRealm.m19735a(OnSubscribeRealm.this, observableEmitter);
            }
        });
    ...
    /* renamed from: d */
    public final void m19732d() {
        int size = this.f83543b.size();
        for (int i = 0; i < size; i++) {
            ((ObservableEmitter) this.f83543b.get(i)).onComplete();
        }
    }

    /* renamed from: e */
    public final void m19731e(Throwable th2) {
        int size = this.f83543b.size();
        for (int i = 0; i < size; i++) {
            ((ObservableEmitter) this.f83543b.get(i)).onError(th2);
        }
    }

    /* renamed from: f */
    public final void m19730f(Object obj) {
        int size = this.f83543b.size();
        for (int i = 0; i < size; i++) {
            Intrinsics.checkNotNull(obj);
            ((ObservableEmitter) this.f83543b.get(i)).onNext(obj);
        }
    }
    ...
    */
    public void subscribe(@org.jetbrains.annotations.NotNull io.reactivex.ObservableEmitter<T> r7) {
        /*
            ...
            java.lang.Object r0 = r6.f83545d
            monitor-enter(r0)
            java.util.concurrent.atomic.AtomicBoolean r1 = r6.f83544c     // Catch: java.lang.Throwable -> L26
            boolean r1 = r1.get()     // Catch: java.lang.Throwable -> L26
            if (r1 != 0) goto L29
            java.util.List r2 = r6.f83543b     // Catch: java.lang.Throwable -> L26
            boolean r2 = r2.isEmpty()     // Catch: java.lang.Throwable -> L26
            if (r2 != 0) goto L29
            io.reactivex.disposables.Disposable r1 = r6.m19734b(r7)     // Catch: java.lang.Throwable -> L26
            r7.setDisposable(r1)     // Catch: java.lang.Throwable -> L26
            java.util.List r1 = r6.f83543b     // Catch: java.lang.Throwable -> L26
        ...
        L2d:
            ...
            monitor-exit(r0)
            java.util.List r0 = r6.f83543b
            r0.add(r7)
            io.realm.RealmConfiguration r7 = r6.f83542a
            io.realm.Realm r7 = io.realm.Realm.getInstance(r7)
            r0 = 0
            r1 = 1
            r2 = 0
            java.util.concurrent.atomic.AtomicBoolean r3 = r6.f83544c     // Catch: java.lang.Error -> L5b java.lang.RuntimeException -> L5d
        ...
        L7a:
            if (r2 == 0) goto L89
            java.util.concurrent.atomic.AtomicBoolean r4 = r6.f83544c
            boolean r4 = r4.get()
            if (r4 != 0) goto L89
            if (r3 != 0) goto L89
            r6.m19730f(r2)
        ...
        L92:
            ...
            r6.m19732d()
        L97:
            java.util.concurrent.atomic.AtomicBoolean r7 = r6.f83544c
            r7.set(r0)
            return
        L9d:
            monitor-exit(r0)
