...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.pre2post.fragment.trueCompany.OnePre2PostSelectPropositionFragment$onStart$1$5 */
/* loaded from: classes10.dex */
public final class OnePre2PostSelectPropositionFragment$onStart$1$5 extends Lambda implements Function1<StatusResource, Unit> {
    final /* synthetic */ OnePre2PostSelectPropositionFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePre2PostSelectPropositionFragment$onStart$1$5(OnePre2PostSelectPropositionFragment onePre2PostSelectPropositionFragment) {
        super(1);
    ...
    public final void invoke2(StatusResource statusResource) {
        this.this$0.m11038u(statusResource);
    }
}