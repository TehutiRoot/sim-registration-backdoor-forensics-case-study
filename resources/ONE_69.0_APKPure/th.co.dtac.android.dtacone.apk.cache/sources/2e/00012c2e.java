...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.change_owner.viewModel.OneChangeOwnerViewModel$verifyOtpTransaction$3 */
/* loaded from: classes10.dex */
public final class OneChangeOwnerViewModel$verifyOtpTransaction$3 extends Lambda implements Function1<VerifyOtpTransactionResponse, Unit> {
    final /* synthetic */ String $otp;
    final /* synthetic */ OneChangeOwnerViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneChangeOwnerViewModel$verifyOtpTransaction$3(OneChangeOwnerViewModel oneChangeOwnerViewModel, String str) {
        super(1);
    ...
    public final void invoke2(VerifyOtpTransactionResponse verifyOtpTransactionResponse) {
        ...
        mutableLiveData = this.this$0.f89408p;
        mutableLiveData.setValue(Resource.Companion.success(this.$otp));
    }
}