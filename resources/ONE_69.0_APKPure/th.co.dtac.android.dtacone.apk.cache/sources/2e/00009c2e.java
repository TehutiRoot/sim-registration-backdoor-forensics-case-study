...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    /* renamed from: b */
    public static boolean m46390b(Bundle bundle, Bundle bundle2) {
        int length;
        if (bundle == null) {
            if (bundle2 == null) {
                return true;
            ...
            for (String str : bundle.keySet()) {
                ...
                if (obj == null) {
                    ...
                    if (!m46390b(bundle.getBundle(str), bundle2.getBundle(str))) {
                        return false;
                    }
    ...
    */
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            ...
            if (this.f47709b == activityRecognitionResult.f47709b && this.f47710c == activityRecognitionResult.f47710c && this.f47711d == activityRecognitionResult.f47711d && Objects.equal(this.f47708a, activityRecognitionResult.f47708a) && m46390b(this.f47712e, activityRecognitionResult.f47712e)) {
                return true;
            }
        }
        return false;
    ...
    public int getActivityConfidence(int i) {
        for (DetectedActivity detectedActivity : this.f47708a) {
    ...
    public DetectedActivity getMostProbableActivity() {
        return (DetectedActivity) this.f47708a.get(0);
    }
    ...
    public final int hashCode() {
        return Objects.hashCode(Long.valueOf(this.f47709b), Long.valueOf(this.f47710c), Integer.valueOf(this.f47711d), this.f47708a, this.f47712e);
    }

    @NonNull
    public String toString() {
        String valueOf = String.valueOf(this.f47708a);
        long j = this.f47709b;
        long j2 = this.f47710c;
    ...
    public void writeToParcel(@NonNull Parcel parcel, int i) {
        ...
        SafeParcelWriter.writeTypedList(parcel, 1, this.f47708a, false);
        SafeParcelWriter.writeLong(parcel, 2, this.f47709b);
        SafeParcelWriter.writeLong(parcel, 3, this.f47710c);
        SafeParcelWriter.writeInt(parcel, 4, this.f47711d);
        SafeParcelWriter.writeBundle(parcel, 5, this.f47712e, false);
    ...
    public ActivityRecognitionResult(@NonNull @SafeParcelable.Param(m48385id = 1) List list, @SafeParcelable.Param(m48385id = 2) long j, @SafeParcelable.Param(m48385id = 3) long j2, @SafeParcelable.Param(m48385id = 4) int i, @Nullable @SafeParcelable.Param(m48385id = 5) Bundle bundle) {
        boolean z = true;
