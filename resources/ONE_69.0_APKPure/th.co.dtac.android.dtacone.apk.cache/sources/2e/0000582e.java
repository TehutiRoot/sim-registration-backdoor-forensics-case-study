...
public final class DatePickerDialog_androidKt$DatePickerDialog$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    /* loaded from: classes2.dex */
    public static final class C32331 extends Lambda implements Function2<Composer, Integer, Unit> {
        final /* synthetic */ int $$dirty;
        final /* synthetic */ Function2<Composer, Integer, Unit> $confirmButton;
        final /* synthetic */ Function3<ColumnScope, Composer, Integer, Unit> $content;
        final /* synthetic */ Function2<Composer, Integer, Unit> $dismissButton;
        ...
        public C32331(Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, int i, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22) {
            super(2);
        ...
        public final void invoke(@Nullable Composer composer, int i) {
            ...
            paddingValues = DatePickerDialog_androidKt.f25802a;
            ...
            CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m71909boximpl(ColorSchemeKt.toColor(DialogTokens.INSTANCE.getActionLabelTextColor(), composer, 6)))}, ComposableLambdaKt.composableLambda(composer, -926980325, true, new DatePickerDialog_androidKt$DatePickerDialog$1$1$1$1$1(function2, i2, function22)), composer, 56);
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        Modifier m69736heightInVpY3zN4$default = SizeKt.m69736heightInVpY3zN4$default(SizeKt.m69745requiredWidth3ABfNKs(companion, datePickerModalTokens.m71107getContainerWidthD9Ej5fM()), 0.0f, datePickerModalTokens.m71106getContainerHeightD9Ej5fM(), 1, null);
        Shape shape = this.$shape;
        long m70520getContainerColor0d7_KjU$material3_release = this.$colors.m70520getContainerColor0d7_KjU$material3_release();
        float f = this.$tonalElevation;
        ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer, 1763752415, true, new C32331(this.$content, this.$$dirty, this.$dismissButton, this.$confirmButton));
        int i2 = this.$$dirty;
        SurfaceKt.m70812SurfaceT9BRK9s(m69736heightInVpY3zN4$default, shape, m70520getContainerColor0d7_KjU$material3_release, 0L, f, 0.0f, null, composableLambda, composer, ((i2 >> 9) & 112) | 12582918 | ((i2 >> 3) & 57344), 104);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    }
