...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_prepaid_registration.MrtrPrepaidValidateBarcodeViewModel$validateFamilySim$2 */
/* loaded from: classes9.dex */
public final class MrtrPrepaidValidateBarcodeViewModel$validateFamilySim$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ MrtrPrepaidValidateBarcodeViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrPrepaidValidateBarcodeViewModel$validateFamilySim$2(MrtrPrepaidValidateBarcodeViewModel mrtrPrepaidValidateBarcodeViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable it) {
        ...
        mrtrErrorService.handleException(it, new MrtrErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.viewmodel.mrtr_prepaid_registration.MrtrPrepaidValidateBarcodeViewModel$validateFamilySim$2.1
