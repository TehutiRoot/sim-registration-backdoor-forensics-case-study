...
class ErrorCorrection {
    public static short LDDecode(int i, int i2, int i3, int i4) {
        return (short) (((((m24615g(i) + m24615g(i2)) + m24615g(i3)) + m24615g(i4)) - 98312) >>> 31);
    }
    ...
    /* renamed from: f */
    public static int m24616f(int[] iArr, int i, int i2, int i3) {
        int i4 = (i3 * 2730) >> 25;
    ...
    /* renamed from: g */
    public static int m24615g(int i) {
        int i2 = (i * 2730) >> 27;
    ...
    public static void helpRec(short[] sArr, short[] sArr2, byte[] bArr, byte b) {
        ...
        for (int i = 0; i < 256; i++) {
            ...
            int i3 = i + 256;
            int i4 = i + 512;
            int m24616f = m24616f(iArr, 0, 4, (sArr2[i] * 8) + i2) + m24616f(iArr, 1, 5, (sArr2[i3] * 8) + i2) + m24616f(iArr, 2, 6, (sArr2[i4] * 8) + i2);
            int i5 = i + ViewUtils.EDGE_TO_EDGE_FLAGS;
            int m24616f2 = (24577 - (m24616f + m24616f(iArr, 3, 7, (sArr2[i5] * 8) + i2))) >> 31;
            int i6 = ~m24616f2;
            int[] iArr2 = {(i6 & iArr[0]) ^ (iArr[4] & m24616f2), (i6 & iArr[1]) ^ (iArr[5] & m24616f2), (i6 & iArr[2]) ^ (iArr[6] & m24616f2), (iArr[7] & m24616f2) ^ (i6 & iArr[3])};
            int i7 = iArr2[0];
            int i8 = iArr2[3];
            sArr[i] = (short) ((i7 - i8) & 3);
            sArr[i3] = (short) ((iArr2[1] - i8) & 3);
            sArr[i4] = (short) ((iArr2[2] - i8) & 3);
            sArr[i5] = (short) (((-m24616f2) + (i8 * 2)) & 3);
        }
    }
