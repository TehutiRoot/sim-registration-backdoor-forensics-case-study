...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.esim.ESimViewModel$cutSimStock$1$3 */
/* loaded from: classes9.dex */
public final class ESimViewModel$cutSimStock$1$3 extends Lambda implements Function1<Unit, Unit> {
    ...
    public ESimViewModel$cutSimStock$1$3(ESimViewModel eSimViewModel, MrtrPrepaidRegisterResponse mrtrPrepaidRegisterResponse, boolean z, MrtrPrepaidRegisterRequest mrtrPrepaidRegisterRequest, String str) {
        super(1);
    ...
    public final void invoke2(Unit unit) {
        if (this.this$0.isCheckSimStock()) {
            this.this$0.m2750R0(this.$response, this.$redirectToActivate, this.$registerRequest, this.$nontelcoConsentType);
        } else {
            this.this$0.m2771H(this.$redirectToActivate);
        }
    }
}