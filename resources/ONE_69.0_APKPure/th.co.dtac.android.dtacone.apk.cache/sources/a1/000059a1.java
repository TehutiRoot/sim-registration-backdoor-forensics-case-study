...
public final class NavigationBarKt {
    ...
    /* renamed from: a */
    public static final float f25989a;

    /* renamed from: b */
    public static final float f25990b;

    /* renamed from: c */
    public static final float f25991c;

    /* renamed from: d */
    public static final float f25992d;

    /* renamed from: e */
    public static final float f25993e;

    /* renamed from: f */
    public static final float f25994f;

    /* renamed from: androidx.compose.material3.NavigationBarKt$a */
    /* loaded from: classes2.dex */
    public static final class C3314a implements MeasurePolicy {

        /* renamed from: a */
        public final /* synthetic */ float f25995a;

        /* renamed from: b */
        public final /* synthetic */ Function2 f25996b;

        /* renamed from: c */
        public final /* synthetic */ boolean f25997c;

        public C3314a(float f, Function2 function2, boolean z) {
            this.f25995a = f;
            this.f25996b = function2;
            this.f25997c = z;
        }
        ...
        public final MeasureResult mo69380measure3p2s80s(MeasureScope Layout, List measurables, long j) {
            ...
            for (Measurable measurable : list) {
                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "icon")) {
                    ...
                    float f = 2;
                    int width = mo72995measureBRTryo0.getWidth() + Layout.mo69616roundToPx0680j_4(C3623Dp.m73842constructorimpl(NavigationBarKt.f25992d * f));
                    int roundToInt = AbstractC22237sr0.roundToInt(width * this.f25995a);
                    int height = mo72995measureBRTryo0.getHeight() + Layout.mo69616roundToPx0680j_4(C3623Dp.m73842constructorimpl(NavigationBarKt.f25993e * f));
                    for (Measurable measurable2 : list) {
                        if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), "indicatorRipple")) {
                            Placeable mo72995measureBRTryo02 = measurable2.mo72995measureBRTryo0(Constraints.Companion.m73818fixedJhjzzOo(width, height));
                            ...
                            if (measurable3 != null) {
                                placeable = measurable3.mo72995measureBRTryo0(Constraints.Companion.m73818fixedJhjzzOo(roundToInt, height));
                            } else {
                                placeable = null;
                            }
                            if (this.f25996b != null) {
                                for (Measurable measurable4 : list) {
                                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable4), "label")) {
                                        placeable2 = measurable4.mo72995measureBRTryo0(Constraints.m73802copyZbe2FdA$default(j, 0, 0, 0, 0, 11, null));
                                    }
                                }
                            ...
                            placeable2 = null;
                            if (this.f25996b == null) {
                                return NavigationBarKt.m60556e(Layout, mo72995measureBRTryo0, mo72995measureBRTryo02, placeable, j);
                            }
                            Intrinsics.checkNotNull(placeable2);
                            return NavigationBarKt.m60555f(Layout, placeable2, mo72995measureBRTryo0, mo72995measureBRTryo02, placeable, j, this.f25997c, this.f25995a);
                        }
                    }
                    throw new NoSuchElementException("Collection contains no element matching the predicate.");
                }
    ...
    static {
        ...
        f25989a = navigationBarTokens.m71290getContainerHeightD9Ej5fM();
        f25990b = C3623Dp.m73842constructorimpl(8);
        f25991c = C3623Dp.m73842constructorimpl(16);
        float f = 2;
        f25992d = C3623Dp.m73842constructorimpl(C3623Dp.m73842constructorimpl(navigationBarTokens.m71288getActiveIndicatorWidthD9Ej5fM() - navigationBarTokens.m71291getIconSizeD9Ej5fM()) / f);
        f25993e = C3623Dp.m73842constructorimpl(C3623Dp.m73842constructorimpl(navigationBarTokens.m71287getActiveIndicatorHeightD9Ej5fM() - navigationBarTokens.m71291getIconSizeD9Ej5fM()) / f);
        f25994f = C3623Dp.m73842constructorimpl(12);
    }
    ...
    */
    ...
    /* renamed from: a */
    public static final int m60560a(MutableState mutableState) {
        return ((Number) mutableState.getValue()).intValue();
    }

    /* renamed from: b */
    public static final void m60559b(MutableState mutableState, int i) {
        mutableState.setValue(Integer.valueOf(i));
    }

    /* renamed from: c */
    public static final float m60558c(State state) {
        return ((Number) state.getValue()).floatValue();
    }

    /* renamed from: d */
    public static final void m60557d(Function2 function2, Function2 function22, Function2 function23, Function2 function24, boolean z, float f, Composer composer, int i) {
        int i2;
        float f2;
        int i3;
        int i4;
        ...
        if ((374491 & i2) == 74898 && startRestartGroup.getSkipping()) {
            ...
            C3314a c3314a = new C3314a(f, function24, z);
            ...
            Updater.m71584setimpl(m71577constructorimpl, c3314a, companion2.getSetMeasurePolicy());
            ...
            if (function24 != null) {
                ...
                Modifier m69715paddingVpY3zN4$default = PaddingKt.m69715paddingVpY3zN4$default(AlphaKt.alpha(layoutId2, f2), C3623Dp.m73842constructorimpl(f25990b / 2), 0.0f, 2, null);
                startRestartGroup.startReplaceableGroup(733328855);
                ...
                Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf3 = LayoutKt.materializerOf(m69715paddingVpY3zN4$default);
                if (!(startRestartGroup.getApplier() instanceof Applier)) {
                    ComposablesKt.invalidApplier();
                }
                startRestartGroup.startReusableNode();
    ...
    /* renamed from: e */
    public static final MeasureResult m60556e(MeasureScope measureScope, Placeable placeable, Placeable placeable2, Placeable placeable3, long j) {
        ...
        return MeasureScope.CC.m59482q(measureScope, m73810getMaxWidthimpl, m73809getMaxHeightimpl, null, new NavigationBarKt$placeIcon$1(placeable3, placeable, (m73810getMaxWidthimpl - placeable.getWidth()) / 2, (m73809getMaxHeightimpl - placeable.getHeight()) / 2, placeable2, (m73810getMaxWidthimpl - placeable2.getWidth()) / 2, (m73809getMaxHeightimpl - placeable2.getHeight()) / 2, m73810getMaxWidthimpl, m73809getMaxHeightimpl), 4, null);
    }

    /* renamed from: f */
    public static final MeasureResult m60555f(MeasureScope measureScope, Placeable placeable, Placeable placeable2, Placeable placeable3, Placeable placeable4, long j, boolean z, float f) {
        int height;
        int m73809getMaxHeightimpl = Constraints.m73809getMaxHeightimpl(j);
        float f2 = f25991c;
        int height2 = (m73809getMaxHeightimpl - placeable.getHeight()) - measureScope.mo69616roundToPx0680j_4(f2);
        int mo69616roundToPx0680j_4 = measureScope.mo69616roundToPx0680j_4(f2);
        if (z) {
            height = mo69616roundToPx0680j_4;
        } else {
            height = (m73809getMaxHeightimpl - placeable2.getHeight()) / 2;
        }
        int roundToInt = AbstractC22237sr0.roundToInt((height - mo69616roundToPx0680j_4) * (1 - f));
        int m73810getMaxWidthimpl = Constraints.m73810getMaxWidthimpl(j);
        return MeasureScope.CC.m59482q(measureScope, m73810getMaxWidthimpl, m73809getMaxHeightimpl, null, new NavigationBarKt$placeLabelAndIcon$1(placeable4, z, f, placeable, (m73810getMaxWidthimpl - placeable.getWidth()) / 2, height2, roundToInt, placeable2, (m73810getMaxWidthimpl - placeable2.getWidth()) / 2, mo69616roundToPx0680j_4, placeable3, (m73810getMaxWidthimpl - placeable3.getWidth()) / 2, mo69616roundToPx0680j_4 - measureScope.mo69616roundToPx0680j_4(f25993e), m73810getMaxWidthimpl, measureScope), 4, null);
    }
