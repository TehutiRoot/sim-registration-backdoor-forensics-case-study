...
public class CustomModelLoader {
    ...
    /* renamed from: h */
    public static final GmsLogger f56948h = new GmsLogger("CustomModelLoader", "");

    /* renamed from: i */
    public static final Map f56949i = new HashMap();

    /* renamed from: a */
    public final MlKitContext f56950a;

    /* renamed from: b */
    public final LocalModel f56951b;

    /* renamed from: c */
    public final CustomRemoteModel f56952c;

    /* renamed from: d */
    public final RemoteModelDownloadManager f56953d;

    /* renamed from: e */
    public final RemoteModelFileManager f56954e;

    /* renamed from: f */
    public final zzsh f56955f;

    /* renamed from: g */
    public boolean f56956g;
    ...
    public CustomModelLoader(MlKitContext mlKitContext, LocalModel localModel, CustomRemoteModel customRemoteModel) {
        if (customRemoteModel != null) {
            ...
            this.f56954e = remoteModelFileManager;
            this.f56953d = RemoteModelDownloadManager.getInstance(mlKitContext, customRemoteModel, new ModelFileHelper(mlKitContext), remoteModelFileManager, (ModelInfoRetrieverInterop) mlKitContext.get(ModelInfoRetrieverInterop.class));
            this.f56956g = true;
        } else {
            this.f56954e = null;
            this.f56953d = null;
        }
        this.f56950a = mlKitContext;
        this.f56951b = localModel;
        this.f56952c = customRemoteModel;
        this.f56955f = zzss.zzb("common");
    }

    /* renamed from: c */
    public static final LocalModel m37218c(File file) {
        if (file.isDirectory()) {
    ...
    /* renamed from: a */
    public final File m37220a() {
        String zzb = ((RemoteModelFileManager) Preconditions.checkNotNull(this.f56954e)).zzb();
        if (zzb == null) {
            f56948h.m48405d("CustomModelLoader", "No existing model file");
            return null;
        }
    ...
    /* renamed from: b */
    public final void m37219b() {
        ((RemoteModelDownloadManager) Preconditions.checkNotNull(this.f56953d)).removeOrCancelDownload();
    }
    ...
    public synchronized LocalModel createLocalModelByLatestExistingModel() throws MlKitException {
        f56948h.m48405d("CustomModelLoader", "Try to get the latest existing model file.");
        File m37220a = m37220a();
        if (m37220a == null) {
            return null;
        }
        return m37218c(m37220a);
    }
    ...
    */
    public synchronized com.google.mlkit.common.model.LocalModel createLocalModelByNewlyDownloadedModel() throws com.google.mlkit.common.MlKitException {
        /*
            r7 = this;
            monitor-enter(r7)
            com.google.android.gms.common.internal.GmsLogger r0 = com.google.mlkit.common.sdkinternal.model.CustomModelLoader.f56948h     // Catch: java.lang.Throwable -> L2f
            java.lang.String r1 = "CustomModelLoader"
            java.lang.String r2 = "Try to get newly downloaded model file."
            r0.m48405d(r1, r2)     // Catch: java.lang.Throwable -> L2f
            com.google.mlkit.common.sdkinternal.model.RemoteModelDownloadManager r1 = r7.f56953d     // Catch: java.lang.Throwable -> L2f
            ...
            com.google.mlkit.common.sdkinternal.model.RemoteModelDownloadManager r2 = r7.f56953d     // Catch: java.lang.Throwable -> L2f
            ...
            goto L8f
        L22:
            com.google.mlkit.common.sdkinternal.model.RemoteModelDownloadManager r4 = r7.f56953d     // Catch: java.lang.Throwable -> L2f
            java.lang.Integer r4 = r4.getDownloadingModelStatusCode()     // Catch: java.lang.Throwable -> L2f
            if (r4 != 0) goto L32
            r7.m37219b()     // Catch: java.lang.Throwable -> L2f
        L2d:
            r1 = r3
            goto L9a
        L2f:
        ...
        L32:
            ...
            r0.m48405d(r6, r5)     // Catch: java.lang.Throwable -> L2f
        ...
        L52:
            ...
            r0.m48405d(r6, r4)     // Catch: java.lang.Throwable -> L2f
            com.google.mlkit.common.sdkinternal.model.RemoteModelDownloadManager r0 = r7.f56953d     // Catch: java.lang.Throwable -> L2f
        ...
        L6b:
            ...
            r2 = 16
            if (r0 != r2) goto L2d
            com.google.android.gms.internal.mlkit_common.zzsh r0 = r7.f56955f     // Catch: java.lang.Throwable -> L2f
            com.google.mlkit.common.model.CustomRemoteModel r2 = r7.f56952c     // Catch: java.lang.Throwable -> L2f
            ...
            com.google.mlkit.common.sdkinternal.model.RemoteModelDownloadManager r5 = r7.f56953d     // Catch: java.lang.Throwable -> L2f
        ...
        L9a:
            ...
            return r3
        L9e:
            com.google.mlkit.common.model.LocalModel r0 = m37218c(r1)     // Catch: java.lang.Throwable -> L2f
            monitor-exit(r7)
            return r0
        La4:
    ...
    public void deleteLatestExistingModel() throws MlKitException {
        File m37220a = m37220a();
        if (m37220a != null) {
            ((RemoteModelFileManager) Preconditions.checkNotNull(this.f56954e)).zzc(m37220a);
            SharedPrefManager.getInstance(this.f56950a).clearLatestModelHash((RemoteModel) Preconditions.checkNotNull(this.f56952c));
        }
    }
    ...
    public void deleteOldModels(@NonNull LocalModel localModel) throws MlKitException {
        ...
        if (((RemoteModelFileManager) Preconditions.checkNotNull(this.f56954e)).zzd((File) Preconditions.checkNotNull(parentFile))) {
            f56948h.m48405d("CustomModelLoader", "All old models are deleted.");
            this.f56954e.zza(parentFile);
            return;
        }
        f56948h.m48403e("CustomModelLoader", "Failed to delete old models");
    }
    ...
    public synchronized void load(@NonNull CustomModelLoaderHelper customModelLoaderHelper) throws MlKitException {
        try {
            LocalModel localModel = this.f56951b;
            if (localModel == null) {
            ...
            if (localModel != null) {
                ...
                if (this.f56952c != null && this.f56956g) {
