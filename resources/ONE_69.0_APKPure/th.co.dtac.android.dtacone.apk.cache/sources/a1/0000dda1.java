...
public abstract class AbstractClassDescriptor extends ModuleAwareClassDescriptor {
    ...
    /* renamed from: a */
    public final Name f68704a;

    /* renamed from: b */
    public final NotNullLazyValue f68705b;

    /* renamed from: c */
    public final NotNullLazyValue f68706c;
    ...
    public class C11741a implements Function0 {
        ...
        public SimpleType invoke() {
            ...
            return TypeUtils.makeUnsubstitutedType(abstractClassDescriptor, abstractClassDescriptor.getUnsubstitutedMemberScope(), new C11742a());
        }
    }

    /* renamed from: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractClassDescriptor$b */
    /* loaded from: classes6.dex */
    public class C11743b implements Function0 {
        public C11743b() {
        }
    ...
    /* loaded from: classes6.dex */
    public class C11744c implements Function0 {
        public C11744c() {
        }
    ...
    public AbstractClassDescriptor(@NotNull StorageManager storageManager, @NotNull Name name) {
        ...
        this.f68704a = name;
        this.defaultType = storageManager.createLazyValue(new C11741a());
        this.f68705b = storageManager.createLazyValue(new C11743b());
        this.f68706c = storageManager.createLazyValue(new C11744c());
    }

    /* renamed from: a */
    private static /* synthetic */ void m28840a(int i) {
    ...
    public ReceiverParameterDescriptor getThisAsReceiverParameter() {
        ReceiverParameterDescriptor receiverParameterDescriptor = (ReceiverParameterDescriptor) this.f68706c.invoke();
    ...
    public MemberScope getUnsubstitutedInnerClassesScope() {
        MemberScope memberScope = (MemberScope) this.f68705b.invoke();
        if (memberScope == null) {
            m28840a(4);
        }
        return memberScope;
