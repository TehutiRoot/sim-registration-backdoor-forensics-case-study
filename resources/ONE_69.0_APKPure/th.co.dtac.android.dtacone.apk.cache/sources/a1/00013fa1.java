...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.staff.viewmodel.OneStaffViewModel$updateCreditLimitStaff$1 */
/* loaded from: classes10.dex */
public final class OneStaffViewModel$updateCreditLimitStaff$1 extends Lambda implements Function1<Disposable, Unit> {
    final /* synthetic */ OneStaffViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneStaffViewModel$updateCreditLimitStaff$1(OneStaffViewModel oneStaffViewModel) {
        super(1);
