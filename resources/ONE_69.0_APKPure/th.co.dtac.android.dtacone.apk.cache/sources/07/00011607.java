...
/* renamed from: th.co.dtac.android.dtacone.databinding.FragmentOneDeviceSaleCustomDialogChangeImeiTrueBinding */
/* loaded from: classes7.dex */
public final class FragmentOneDeviceSaleCustomDialogChangeImeiTrueBinding implements ViewBinding {

    /* renamed from: a */
    public final CardView f84022a;
    @NonNull
    ...
    public FragmentOneDeviceSaleCustomDialogChangeImeiTrueBinding(CardView cardView, OneFontButton oneFontButton, OneFontTextView oneFontTextView, OneFontButton oneFontButton2, ImageView imageView, ConstraintLayout constraintLayout, OneFontTextView oneFontTextView2, OneFontTextView oneFontTextView3, ConstraintLayout constraintLayout2, OneFontTextView oneFontTextView4, ConstraintLayout constraintLayout3, OneFontTextView oneFontTextView5, OneFontTextView oneFontTextView6) {
        this.f84022a = cardView;
    ...
    @NonNull
    public static FragmentOneDeviceSaleCustomDialogChangeImeiTrueBinding bind(@NonNull View view) {
                                            ...
                                            if (constraintLayout3 != null) {
                                                ...
                                                if (oneFontTextView5 != null) {
                                                    ...
                                                    if (oneFontTextView6 != null) {
                                                        return new FragmentOneDeviceSaleCustomDialogChangeImeiTrueBinding((CardView) view, oneFontButton, oneFontTextView, oneFontButton2, imageView, constraintLayout, oneFontTextView2, oneFontTextView3, constraintLayout2, oneFontTextView4, constraintLayout3, oneFontTextView5, oneFontTextView6);
                                                    }
                                                }
                                            }
                                        }
    ...
    @NonNull
    public static FragmentOneDeviceSaleCustomDialogChangeImeiTrueBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static FragmentOneDeviceSaleCustomDialogChangeImeiTrueBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.fragment_one_device_sale_custom_dialog_change_imei_true, viewGroup, false);
        if (z) {
