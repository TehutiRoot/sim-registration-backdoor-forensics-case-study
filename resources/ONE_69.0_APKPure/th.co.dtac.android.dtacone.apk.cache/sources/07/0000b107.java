...
public final class zzaf {
    ...
    /* renamed from: a */
    public static final GmsLogger f55761a = new GmsLogger("RmModelInfoRetriever", "");

    /* renamed from: a */
    public static zzac m38393a(zzqn zzqnVar, FirebaseRemoteModel firebaseRemoteModel, zzy zzyVar) {
        zzac m38376a;
        if (firebaseRemoteModel.isBaseModel()) {
            m38376a = AbstractC22039ri2.m23450a(firebaseRemoteModel, zzyVar);
        } else {
            m38376a = zzu.m38376a(zzqnVar, zzqnVar.zzos(), firebaseRemoteModel, zzyVar);
        }
        if (m38376a != null) {
            zzyVar.zza(zzoa.NO_ERROR, false, m38376a.zzpx(), zznq.zzak.zzb.MODEL_INFO_RETRIEVAL_SUCCEEDED);
        }
        return m38376a;
    }

    /* renamed from: b */
    public static HttpsURLConnection m38392b(String str, zzy zzyVar) {
        String str2;
        String str3;
        zzoa zzoaVar;
        String str4;
        ...
        try {
            ...
            GmsLogger gmsLogger = f55761a;
            if (str.length() != 0) {
                str3 = "Checking model URL: ".concat(str);
            } else {
                str3 = new String("Checking model URL: ");
            }
            gmsLogger.m48405d("RmModelInfoRetriever", str3);
            ...
            if (responseCode != 200 && responseCode != 304) {
                ...
                zzyVar.m38350a(zzoaVar, httpsURLConnection.getResponseCode());
            ...
            zzyVar.m38348c(zzoa.TIME_OUT_FETCHING_MODEL_METADATA);
