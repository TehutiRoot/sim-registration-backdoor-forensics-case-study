...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.fragment.OneMnpMailingFragment$getAddressFromOCRUpPassForTrueCompany$3 */
/* loaded from: classes10.dex */
public final class OneMnpMailingFragment$getAddressFromOCRUpPassForTrueCompany$3 extends Lambda implements Function1<SubDistrictItem, Unit> {
    final /* synthetic */ OneMnpMailingFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneMnpMailingFragment$getAddressFromOCRUpPassForTrueCompany$3(OneMnpMailingFragment oneMnpMailingFragment) {
        super(1);
    ...
    public final void invoke2(@NotNull SubDistrictItem subDistrict) {
        ...
        oneFontTextView = this.this$0.f91529G;
        ...
        oneFontTextView2 = this.this$0.f91529G;
