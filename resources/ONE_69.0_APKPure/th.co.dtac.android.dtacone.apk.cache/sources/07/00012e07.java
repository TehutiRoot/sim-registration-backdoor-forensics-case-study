...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.deviceSaleTrueCompany.viewModel.OneDeviceSaleTrueViewModel$saveForms$3 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleTrueViewModel$saveForms$3 extends Lambda implements Function1<OneCommonResponse, Unit> {
    final /* synthetic */ OneDeviceSaleTrueViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneDeviceSaleTrueViewModel$saveForms$3(OneDeviceSaleTrueViewModel oneDeviceSaleTrueViewModel) {
        super(1);
    ...
    public final void invoke2(OneCommonResponse oneCommonResponse) {
        ...
        m14889H0.setValue(Resource.Companion.success(oneCommonResponse));
    }
}