...
class getLicenseExpiryDate implements getSDKEphemeralPublicKey {
    private final SDKAlreadyInitializedException.ThreeDS2Service ThreeDS2Service;

    public getLicenseExpiryDate(SDKAlreadyInitializedException.ThreeDS2Service threeDS2Service) {
    ...
    public Object ThreeDS2Service() {
        setDividerHeight removeParam;
        removeParam = SDKAlreadyInitializedException.removeParam(this.ThreeDS2Service);
        return removeParam;
    }
}