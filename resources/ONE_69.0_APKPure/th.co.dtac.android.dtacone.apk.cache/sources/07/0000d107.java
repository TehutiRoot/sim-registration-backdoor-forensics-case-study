...
public final class CompletableAndThenPublisher<R> extends Flowable<R> {
    ...
    /* renamed from: b */
    public final CompletableSource f64978b;

    /* renamed from: c */
    public final Publisher f64979c;

    public CompletableAndThenPublisher(CompletableSource completableSource, Publisher<? extends R> publisher) {
        this.f64978b = completableSource;
        this.f64979c = publisher;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super R> subscriber) {
        this.f64978b.subscribe(new AndThenPublisherSubscriber(subscriber, this.f64979c));
    }
