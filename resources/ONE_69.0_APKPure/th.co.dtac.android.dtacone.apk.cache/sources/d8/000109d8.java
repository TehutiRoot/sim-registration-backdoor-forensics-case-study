...
public final class CompletableOnSubscribeConcatIterable implements Completable.OnSubscribe {
    ...
    public static final class ConcatInnerSubscriber extends AtomicInteger implements CompletableSubscriber {
        ...
        /* renamed from: sd */
        final SequentialSubscription f78015sd = new SequentialSubscription();
        ...
        public void next() {
            if (this.f78015sd.isUnsubscribed() || getAndIncrement() != 0) {
                return;
            }
            Iterator<? extends Completable> it = this.sources;
            while (!this.f78015sd.isUnsubscribed()) {
                try {
                    if (!it.hasNext()) {
    ...
    public void call(CompletableSubscriber completableSubscriber) {
        try {
            ...
            completableSubscriber.onSubscribe(concatInnerSubscriber.f78015sd);
