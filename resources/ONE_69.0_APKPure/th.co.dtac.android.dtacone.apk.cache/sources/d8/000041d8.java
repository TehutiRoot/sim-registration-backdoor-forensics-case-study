...
@Metadata(m29143d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m29142d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_localCarWash", "Landroidx/compose/material/icons/Icons$Rounded;", "getLocalCarWash", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "LocalCarWash", "material-icons-extended_release"}, m29141k = 2, m29140mv = {1, 8, 0})
...
public final class LocalCarWashKt {
    ...
    /* renamed from: a */
    public static ImageVector f20126a;

    @NotNull
    public static final ImageVector getLocalCarWash(@NotNull Icons.Rounded rounded) {
        Intrinsics.checkNotNullParameter(rounded, "<this>");
        ImageVector imageVector = f20126a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.LocalCarWash", C3623Dp.m73842constructorimpl(24.0f), C3623Dp.m73842constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.curveToRelative(0.0f, -0.66f, -0.66f, -1.64f, -1.11f, -2.22f);
        pathBuilder.curveToRelative(-0.2f, -0.26f, -0.59f, -0.26f, -0.79f, 0.0f);
        pathBuilder.curveToRelative(-0.44f, 0.58f, -1.1f, 1.56f, -1.1f, 2.22f);
        ...
        pathBuilder.curveToRelative(0.0f, 0.83f, 0.67f, 1.5f, 1.5f, 1.5f);
        pathBuilder.reflectiveCurveTo(6.0f, 22.33f, 6.0f, 21.5f);
        ...
        pathBuilder.curveToRelative(-0.83f, 0.0f, -1.5f, -0.67f, -1.5f, -1.5f);
        pathBuilder.reflectiveCurveTo(5.67f, 15.0f, 6.5f, 15.0f);
        pathBuilder.reflectiveCurveToRelative(1.5f, 0.67f, 1.5f, 1.5f);
        pathBuilder.reflectiveCurveTo(7.33f, 18.0f, 6.5f, 18.0f);
        pathBuilder.close();
