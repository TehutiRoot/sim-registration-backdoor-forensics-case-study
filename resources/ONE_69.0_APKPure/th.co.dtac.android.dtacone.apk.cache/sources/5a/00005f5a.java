...
public final class FocusInvalidationManager$invalidateNodes$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke2() {
        ...
        while (true) {
            ...
            int i4 = 1;
            if (!it.hasNext()) {
                set2 = this.this$0.f29002d;
                set2.clear();
                LinkedHashSet linkedHashSet = new LinkedHashSet();
                set3 = this.this$0.f29001c;
                ...
                for (FocusEventModifierNode focusEventModifierNode : set3) {
                    if (!focusEventModifierNode.getNode().isAttached()) {
                        ...
                        int m73145constructorimpl = NodeKind.m73145constructorimpl(i);
                        ...
                        while (node != null) {
                            if (node instanceof FocusTargetNode) {
                                ...
                                set11 = focusInvalidationManager2.f29000b;
                        ...
                        if (focusEventModifierNode.getNode().isAttached()) {
                            ...
                            if (child$ui_release == null) {
                                DelegatableNodeKt.m59460a(mutableVector2, focusEventModifierNode.getNode());
                            } else {
                            ...
                            while (mutableVector2.isNotEmpty()) {
                                ...
                                if ((node2.getAggregateChildKindSet$ui_release() & m73145constructorimpl) == 0) {
                                    DelegatableNodeKt.m59460a(mutableVector2, node2);
                                } else {
                                    while (node2 != null) {
                                        if ((node2.getKindSet$ui_release() & m73145constructorimpl) != 0) {
                                            ...
                                            while (node2 != null) {
                                                if (node2 instanceof FocusTargetNode) {
                                                    ...
                                                    set10 = focusInvalidationManager2.f29000b;
                                                    if (set10.contains(focusTargetNode3)) {
                                                        linkedHashSet.add(focusTargetNode3);
                                                        z = false;
                                                    }
                                                    focusTargetNode = focusTargetNode3;
                                                } else if ((node2.getKindSet$ui_release() & m73145constructorimpl) != 0 && (node2 instanceof DelegatingNode)) {
                                                    Modifier.Node delegate$ui_release2 = ((DelegatingNode) node2).getDelegate$ui_release();
                                                    int i6 = 0;
                                                    while (delegate$ui_release2 != null) {
                                                        if ((delegate$ui_release2.getKindSet$ui_release() & m73145constructorimpl) != 0) {
                                                            i6++;
                                                            if (i6 == 1) {
                                                    ...
                                                    node2 = DelegatableNodeKt.m59459b(mutableVector3);
                                                    i2 = 16;
                                                }
                                                node2 = DelegatableNodeKt.m59459b(mutableVector3);
                                                i2 = 16;
                ...
                set4 = this.this$0.f29001c;
                set4.clear();
                set5 = this.this$0.f29000b;
                ...
                set6 = this.this$0.f29000b;
                set6.clear();
                linkedHashSet.clear();
                set7 = this.this$0.f29002d;
                if (set7.isEmpty()) {
                    set8 = this.this$0.f29001c;
                    if (set8.isEmpty()) {
                        set9 = this.this$0.f29000b;
                        if (!set9.isEmpty()) {
            ...
            if (focusPropertiesModifierNode.getNode().isAttached()) {
                ...
                while (node3 != null) {
                    if (node3 instanceof FocusTargetNode) {
                        set13 = focusInvalidationManager.f29000b;
                    ...
                    node3 = DelegatableNodeKt.m59459b(mutableVector4);
                }
                if (focusPropertiesModifierNode.getNode().isAttached()) {
                    ...
                    if (child$ui_release2 == null) {
                        DelegatableNodeKt.m59460a(mutableVector5, focusPropertiesModifierNode.getNode());
                    } else {
                    ...
                    while (mutableVector5.isNotEmpty()) {
                        ...
                        if ((node4.getAggregateChildKindSet$ui_release() & m73145constructorimpl2) == 0) {
                            DelegatableNodeKt.m59460a(mutableVector5, node4);
                        } else {
                            while (true) {
                                if (node4 == null) {
                                    break;
                                } else if ((node4.getKindSet$ui_release() & m73145constructorimpl2) != 0) {
                                    MutableVector mutableVector6 = null;
                                    while (node4 != null) {
                                        if (node4 instanceof FocusTargetNode) {
                                            set12 = focusInvalidationManager.f29000b;
                                        ...
                                        node4 = DelegatableNodeKt.m59459b(mutableVector6);
                                    }
                                } else {
