...
public class BasicBSONCallback implements BSONCallback {
    ...
    /* renamed from: a */
    public Object f75799a;

    /* renamed from: b */
    public final LinkedList f75800b = new LinkedList();

    /* renamed from: c */
    public final LinkedList f75801c = new LinkedList();
    ...
    public BSONObject cur() {
        return (BSONObject) this.f75800b.getLast();
    }

    public String curName() {
        return (String) this.f75801c.peekLast();
    }
    ...
    public Object objectDone() {
        BSONObject bSONObject = (BSONObject) this.f75800b.removeLast();
        if (this.f75801c.size() > 0) {
            this.f75801c.removeLast();
        } else if (this.f75800b.size() > 0) {
    ...
    public void arrayStart(String str) {
        this.f75801c.addLast(str);
        BSONObject create = create(true, this.f75801c);
        ((BSONObject) this.f75800b.getLast()).put(str, create);
        this.f75800b.addLast(create);
    }

    @Override // org.bson.BSONCallback
    public void objectStart(String str) {
        this.f75801c.addLast(str);
        BSONObject create = create(false, this.f75801c);
        ((BSONObject) this.f75800b.getLast()).put(str, create);
        this.f75800b.addLast(create);
    }
}