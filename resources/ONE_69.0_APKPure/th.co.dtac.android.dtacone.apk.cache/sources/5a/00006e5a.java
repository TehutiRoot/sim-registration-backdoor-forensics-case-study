...
public final class Type extends GeneratedMessageLite<Type, Builder> implements TypeOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Type, Builder> implements TypeOrBuilder {
        public /* synthetic */ Builder(C4386a c4386a) {
            this();
        }

        public Builder addAllFields(Iterable<? extends Field> iterable) {
            copyOnWrite();
            ((Type) this.instance).m55464Y(iterable);
            return this;
        }

        public Builder addAllOneofs(Iterable<String> iterable) {
            copyOnWrite();
            ((Type) this.instance).m55463Z(iterable);
            return this;
        }

        public Builder addAllOptions(Iterable<? extends Option> iterable) {
            copyOnWrite();
            ((Type) this.instance).m55462a0(iterable);
            return this;
        }

        public Builder addFields(Field field) {
            copyOnWrite();
            ((Type) this.instance).m55458e0(field);
            return this;
        }

        public Builder addOneofs(String str) {
            copyOnWrite();
            ((Type) this.instance).m55457f0(str);
            return this;
        }

        public Builder addOneofsBytes(ByteString byteString) {
            copyOnWrite();
            ((Type) this.instance).m55456g0(byteString);
            return this;
        }

        public Builder addOptions(Option option) {
            copyOnWrite();
            ((Type) this.instance).m55452k0(option);
            return this;
        }

        public Builder clearFields() {
            copyOnWrite();
            ((Type) this.instance).m55451l0();
            return this;
        }

        public Builder clearName() {
            copyOnWrite();
            ((Type) this.instance).m55450m0();
            return this;
        }

        public Builder clearOneofs() {
            copyOnWrite();
            ((Type) this.instance).m55449n0();
            return this;
        }

        public Builder clearOptions() {
            copyOnWrite();
            ((Type) this.instance).m55448o0();
            return this;
        }

        public Builder clearSourceContext() {
            copyOnWrite();
            ((Type) this.instance).m55447p0();
            return this;
        }

        public Builder clearSyntax() {
            copyOnWrite();
            ((Type) this.instance).m55445q0();
            return this;
        }
        ...
        public Builder mergeSourceContext(SourceContext sourceContext) {
            copyOnWrite();
            ((Type) this.instance).m55437u0(sourceContext);
            return this;
        }

        public Builder removeFields(int i) {
            copyOnWrite();
            ((Type) this.instance).m55435v0(i);
            return this;
        }

        public Builder removeOptions(int i) {
            copyOnWrite();
            ((Type) this.instance).m55433w0(i);
            return this;
        }

        public Builder setFields(int i, Field field) {
            copyOnWrite();
            ((Type) this.instance).m55429y0(i, field);
            return this;
        }

        public Builder setName(String str) {
            copyOnWrite();
            ((Type) this.instance).m55427z0(str);
            return this;
        }

        public Builder setNameBytes(ByteString byteString) {
            copyOnWrite();
            ((Type) this.instance).m55495A0(byteString);
            return this;
        }

        public Builder setOneofs(int i, String str) {
            copyOnWrite();
            ((Type) this.instance).m55493B0(i, str);
            return this;
        }

        public Builder setOptions(int i, Option option) {
            copyOnWrite();
            ((Type) this.instance).m55489D0(i, option);
            return this;
        }

        public Builder setSourceContext(SourceContext sourceContext) {
            copyOnWrite();
            ((Type) this.instance).m55485F0(sourceContext);
            return this;
        }

        public Builder setSyntax(Syntax syntax) {
            copyOnWrite();
            ((Type) this.instance).m55483G0(syntax);
            return this;
        }

        public Builder setSyntaxValue(int i) {
            copyOnWrite();
            ((Type) this.instance).m55481H0(i);
            return this;
        }
        ...
        public Builder addFields(int i, Field field) {
            copyOnWrite();
            ((Type) this.instance).m55460c0(i, field);
            return this;
        }

        public Builder addOptions(int i, Option option) {
            copyOnWrite();
            ((Type) this.instance).m55454i0(i, option);
            return this;
        }

        public Builder setFields(int i, Field.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).m55431x0(i, builder);
            return this;
        }

        public Builder setOptions(int i, Option.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).m55491C0(i, builder);
            return this;
        }

        public Builder setSourceContext(SourceContext.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).m55487E0(builder);
            return this;
        }

        public Builder addFields(Field.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).m55459d0(builder);
            return this;
        }

        public Builder addOptions(Option.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).m55453j0(builder);
            return this;
        }

        public Builder addFields(int i, Field.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).m55461b0(i, builder);
            return this;
        }

        public Builder addOptions(int i, Option.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).m55455h0(i, builder);
            return this;
        }
    }
    ...
    /* loaded from: classes2.dex */
    public static /* synthetic */ class C4386a {
        ...
        static {
            ...
            try {
                f34975a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f34975a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f34975a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f34975a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f34975a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f34975a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: A0 */
    public void m55495A0(ByteString byteString) {
        byteString.getClass();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: C0 */
    public void m55491C0(int i, Option.Builder builder) {
        m55439t0();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: D0 */
    public void m55489D0(int i, Option option) {
        option.getClass();
        m55439t0();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: E0 */
    public void m55487E0(SourceContext.Builder builder) {
        this.sourceContext_ = builder.build();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: F0 */
    public void m55485F0(SourceContext sourceContext) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: G0 */
    public void m55483G0(Syntax syntax) {
        syntax.getClass();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: H0 */
    public void m55481H0(int i) {
        this.syntax_ = i;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: a0 */
    public void m55462a0(Iterable iterable) {
        m55439t0();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: h0 */
    public void m55455h0(int i, Option.Builder builder) {
        m55439t0();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: i0 */
    public void m55454i0(int i, Option option) {
        option.getClass();
        m55439t0();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: j0 */
    public void m55453j0(Option.Builder builder) {
        m55439t0();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: k0 */
    public void m55452k0(Option option) {
        option.getClass();
        m55439t0();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: o0 */
    public void m55448o0() {
        this.options_ = GeneratedMessageLite.emptyProtobufList();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: p0 */
    public void m55447p0() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: q0 */
    public void m55445q0() {
        this.syntax_ = 0;
    }

    /* renamed from: t0 */
    private void m55439t0() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: u0 */
    public void m55437u0(SourceContext sourceContext) {
        sourceContext.getClass();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: z0 */
    public void m55427z0(String str) {
        str.getClass();
        this.name_ = str;
    }

    /* renamed from: B0 */
    public final void m55493B0(int i, String str) {
        str.getClass();
        m55441s0();
    ...
    /* renamed from: Y */
    public final void m55464Y(Iterable iterable) {
        m55443r0();
        AbstractMessageLite.addAll(iterable, (List) this.fields_);
    }

    /* renamed from: Z */
    public final void m55463Z(Iterable iterable) {
        m55441s0();
        AbstractMessageLite.addAll(iterable, (List) this.oneofs_);
    }

    /* renamed from: b0 */
    public final void m55461b0(int i, Field.Builder builder) {
        m55443r0();
        this.fields_.add(i, builder.build());
    }

    /* renamed from: c0 */
    public final void m55460c0(int i, Field field) {
        field.getClass();
        m55443r0();
    ...
    /* renamed from: d0 */
    public final void m55459d0(Field.Builder builder) {
        m55443r0();
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C4386a.f34975a[methodToInvoke.ordinal()]) {
            case 1:
                return new Type();
            case 2:
    ...
    /* renamed from: e0 */
    public final void m55458e0(Field field) {
        field.getClass();
        m55443r0();
    ...
    /* renamed from: f0 */
    public final void m55457f0(String str) {
        str.getClass();
        m55441s0();
    ...
    /* renamed from: g0 */
    public final void m55456g0(ByteString byteString) {
        byteString.getClass();
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        m55441s0();
    ...
    /* renamed from: l0 */
    public final void m55451l0() {
        this.fields_ = GeneratedMessageLite.emptyProtobufList();
    }

    /* renamed from: n0 */
    public final void m55449n0() {
        this.oneofs_ = GeneratedMessageLite.emptyProtobufList();
    }

    /* renamed from: r0 */
    public final void m55443r0() {
    ...
    /* renamed from: v0 */
    public final void m55435v0(int i) {
        m55443r0();
        this.fields_.remove(i);
    }

    /* renamed from: x0 */
    public final void m55431x0(int i, Field.Builder builder) {
        m55443r0();
        this.fields_.set(i, builder.build());
    }

    /* renamed from: y0 */
    public final void m55429y0(int i, Field field) {
        field.getClass();
        m55443r0();
