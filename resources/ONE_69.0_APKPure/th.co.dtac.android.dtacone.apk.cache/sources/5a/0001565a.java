...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.esim.ESimPostpaidViewModel$validateExistingCustomer$3 */
/* loaded from: classes9.dex */
public final class ESimPostpaidViewModel$validateExistingCustomer$3 extends Lambda implements Function1<MrtrPostpaidValidateCustomerResponse, Unit> {
    final /* synthetic */ boolean $isFromSmartCard;
    final /* synthetic */ ESimPostpaidViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimPostpaidViewModel$validateExistingCustomer$3(ESimPostpaidViewModel eSimPostpaidViewModel, boolean z) {
        super(1);
    ...
    public final void invoke2(MrtrPostpaidValidateCustomerResponse mrtrPostpaidValidateCustomerResponse) {
        ...
        eSimPostpaidViewModel.setNewIdFlag(newIdFlag);
