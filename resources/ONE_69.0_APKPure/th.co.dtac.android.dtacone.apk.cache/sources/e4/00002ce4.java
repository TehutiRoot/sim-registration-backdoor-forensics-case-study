...
public final class C3183x343b27c2 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public C3183x343b27c2(boolean z, boolean z2, InteractionSource interactionSource, TextFieldColors textFieldColors, float f, float f2) {
        super(1);
    ...
    public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("focusedIndicatorLineThickness", C3623Dp.m73840boximpl(this.$focusedIndicatorLineThickness$inlined));
        inspectorInfo.getProperties().set("unfocusedIndicatorLineThickness", C3623Dp.m73840boximpl(this.$unfocusedIndicatorLineThickness$inlined));
    }
}