...
public class IterableCodec implements Codec<Iterable>, OverridableUuidRepresentationCodec<Iterable> {
    ...
    /* renamed from: a */
    public final CodecRegistry f75919a;

    /* renamed from: b */
    public final BsonTypeCodecMap f75920b;

    /* renamed from: c */
    public final Transformer f75921c;

    /* renamed from: d */
    public final UuidRepresentation f75922d;
    ...
    /* renamed from: a */
    private Object m24473a(BsonReader bsonReader, DecoderContext decoderContext) {
        ...
        Codec<?> codec = this.f75920b.get(currentBsonType);
        if (currentBsonType == BsonType.BINARY && bsonReader.peekBinarySize() == 16) {
            ...
            if (peekBinarySubType != 3) {
                if (peekBinarySubType == 4 && ((uuidRepresentation = this.f75922d) == UuidRepresentation.JAVA_LEGACY || uuidRepresentation == UuidRepresentation.STANDARD)) {
                    codec = this.f75919a.get(UUID.class);
                }
            } else {
                UuidRepresentation uuidRepresentation2 = this.f75922d;
        ...
        return this.f75921c.transform(codec.decode(bsonReader, decoderContext));
    }

    /* renamed from: b */
    private void m24472b(BsonWriter bsonWriter, EncoderContext encoderContext, Object obj) {
        if (obj == null) {
            bsonWriter.writeNull();
        } else {
            encoderContext.encodeWithChildContext(this.f75919a.get(obj.getClass()), bsonWriter, obj);
        }
    }
    ...
    public Codec<Iterable> withUuidRepresentation(UuidRepresentation uuidRepresentation) {
        return new IterableCodec(this.f75919a, this.f75920b, this.f75921c, uuidRepresentation);
    }
    ...
    public Iterable decode(BsonReader bsonReader, DecoderContext decoderContext) {
        ...
        while (bsonReader.readBsonType() != BsonType.END_OF_DOCUMENT) {
            arrayList.add(m24473a(bsonReader, decoderContext));
        }
    ...
    public void encode(BsonWriter bsonWriter, Iterable iterable, EncoderContext encoderContext) {
        ...
        for (Object obj : iterable) {
            m24472b(bsonWriter, encoderContext, obj);
        }
    ...
    public IterableCodec(CodecRegistry codecRegistry, BsonTypeCodecMap bsonTypeCodecMap, Transformer transformer, UuidRepresentation uuidRepresentation) {
        this.f75919a = (CodecRegistry) Assertions.notNull("registry", codecRegistry);
        this.f75920b = bsonTypeCodecMap;
        this.f75921c = transformer == null ? new C12914a() : transformer;
        this.f75922d = uuidRepresentation;
    }
}