...
public final class SurfaceKt$Surface$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        m60460b = SurfaceKt.m60460b(this.$color, this.$absoluteElevation, composer, (this.$$changed >> 12) & 14);
        m60461a = SurfaceKt.m60461a(minimumInteractiveComponentSize, shape, m60460b, this.$border, this.$shadowElevation);
        Modifier m69529clickableO2vRcR0$default = ClickableKt.m69529clickableO2vRcR0$default(m60461a, this.$interactionSource, RippleKt.m70364rememberRipple9IZ8Weo(false, 0.0f, 0L, composer, 0, 7), this.$enabled, null, null, this.$onClick, 24, null);
        ...
        Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf = LayoutKt.materializerOf(m69529clickableO2vRcR0$default);
