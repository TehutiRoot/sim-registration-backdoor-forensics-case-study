...
public class DSAParametersGenerator {
    ...
    private DSAParameters generateParameters_FIPS186_2() {
        ...
        int i2 = this.f75151L;
        int i3 = (i2 - 1) / SyslogConstants.LOG_LOCAL4;
        int i4 = i2 / 8;
        ...
        while (true) {
            ...
            if (isProbablePrime(bigInteger)) {
                ...
                while (i6 < 4096) {
                    ...
                    if (subtract.bitLength() == this.f75151L && isProbablePrime(subtract)) {
    ...
    private DSAParameters generateParameters_FIPS186_3() {
        ...
        byte[] bArr = new byte[this.f75152N / 8];
        int i2 = this.f75151L;
        ...
        loop0: while (true) {
            ...
            bit = new BigInteger(1, bArr3).mod(ONE.shiftLeft(this.f75152N - 1)).setBit(0).setBit(this.f75152N - 1);
            if (isProbablePrime(bit)) {
                byte[] clone = Arrays.clone(bArr);
                int i7 = this.f75151L * 4;
                i = 0;
                while (i < i7) {
    ...
    public void init(int i, int i2, SecureRandom secureRandom) {
        this.f75151L = i;
        this.f75152N = getDefaultN(i);
        this.certainty = i2;
        this.iterations = Math.max(getMinimumIterations(this.f75151L), (i2 + 1) / 2);
