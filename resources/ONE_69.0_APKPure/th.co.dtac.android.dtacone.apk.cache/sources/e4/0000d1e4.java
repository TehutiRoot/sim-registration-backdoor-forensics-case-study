...
public final class ObservableJoin<TLeft, TRight, TLeftEnd, TRightEnd, R> extends AbstractC11078a {

    /* renamed from: a */
    public final ObservableSource f65424a;

    /* renamed from: b */
    public final Function f65425b;

    /* renamed from: c */
    public final Function f65426c;

    /* renamed from: d */
    public final BiFunction f65427d;

    /* loaded from: classes5.dex */
    public static final class JoinDisposable<TLeft, TRight, TLeftEnd, TRightEnd, R> extends AtomicInteger implements Disposable, ObservableGroupJoin.InterfaceC10996a {
    ...
    public ObservableJoin(ObservableSource<TLeft> observableSource, ObservableSource<? extends TRight> observableSource2, Function<? super TLeft, ? extends ObservableSource<TLeftEnd>> function, Function<? super TRight, ? extends ObservableSource<TRightEnd>> function2, BiFunction<? super TLeft, ? super TRight, ? extends R> biFunction) {
        ...
        this.f65424a = observableSource2;
        this.f65425b = function;
        this.f65426c = function2;
        this.f65427d = biFunction;
    }

    @Override // io.reactivex.Observable
    public void subscribeActual(Observer<? super R> observer) {
        JoinDisposable joinDisposable = new JoinDisposable(observer, this.f65425b, this.f65426c, this.f65427d);
        ...
        this.f65424a.subscribe(leftRightObserver2);
    }
}