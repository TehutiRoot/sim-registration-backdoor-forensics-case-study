...
public final class TypeAliasConstructorDescriptorImpl$withDispatchReceiver$2 extends Lambda implements Function0<TypeAliasConstructorDescriptorImpl> {
    ...
    public final TypeAliasConstructorDescriptorImpl invoke() {
        ...
        m28755a = TypeAliasConstructorDescriptorImpl.Companion.m28755a(typeAliasConstructorDescriptorImpl3.getTypeAliasDescriptor());
        if (m28755a == null) {
            return null;
        }
        ReceiverParameterDescriptor dispatchReceiverParameter = classConstructorDescriptor2.getDispatchReceiverParameter();
        ReceiverParameterDescriptor substitute = dispatchReceiverParameter != null ? dispatchReceiverParameter.substitute(m28755a) : null;
        ...
        for (ReceiverParameterDescriptor receiverParameterDescriptor : list) {
            arrayList.add(receiverParameterDescriptor.substitute(m28755a));
        }
