...
public class GPUImageLaplacianFilter extends GPUImage3x3TextureSamplingFilter {
    ...
    private void setConvolutionKernel(float[] fArr) {
        this.f67580k = fArr;
        setUniformMatrix3f(this.f67581l, fArr);
    }
    ...
    public void onInit() {
        super.onInit();
        this.f67581l = GLES20.glGetUniformLocation(getProgram(), "convolutionMatrix");
        setConvolutionKernel(this.f67580k);
    }

    public GPUImageLaplacianFilter(float[] fArr) {
