...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_postpaid_registration.MrtrPostpaidRegistrationViewModel$callAPICheckExternalBlacklistFlag$3 */
/* loaded from: classes9.dex */
public final class C16611x2f6e1d9 extends Lambda implements Function1<CheckExternalBlacklistFlagResponse, Unit> {
    final /* synthetic */ MrtrPostpaidRegistrationViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C16611x2f6e1d9(MrtrPostpaidRegistrationViewModel mrtrPostpaidRegistrationViewModel) {
        super(1);
    ...
    public final void invoke2(CheckExternalBlacklistFlagResponse checkExternalBlacklistFlagResponse) {
        ...
        mrtrPostpaidRepository.setBlacklistFlag(checkExternalBlacklistFlagResponse.getBlacklistFlag());
