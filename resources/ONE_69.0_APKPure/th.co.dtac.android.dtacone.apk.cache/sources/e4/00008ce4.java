...
public final class JsonUtils {
    ...
    /* renamed from: a */
    public static final Pattern f45332a = Pattern.compile("\\\\.");

    /* renamed from: b */
    public static final Pattern f45333b = Pattern.compile("[\\\\\"/\b\f\n\r\t]");
    ...
    public static String escapeString(@Nullable String str) {
        if (!TextUtils.isEmpty(str)) {
            Matcher matcher = f45333b.matcher(str);
    ...
    public static String unescapeString(@NonNull String str) {
        if (!TextUtils.isEmpty(str)) {
            String m68614a = AbstractC17564Eg2.m68614a(str);
            Matcher matcher = f45332a.matcher(m68614a);
            StringBuffer stringBuffer = null;
            while (matcher.find()) {
                if (stringBuffer == null) {
                    stringBuffer = new StringBuffer();
