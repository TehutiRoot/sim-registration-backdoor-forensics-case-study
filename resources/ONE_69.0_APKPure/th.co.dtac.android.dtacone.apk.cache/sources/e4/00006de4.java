...
public final class FieldType {
    ...
    /* loaded from: classes2.dex */
    public static /* synthetic */ class C4351a {

        /* renamed from: a */
        public static final /* synthetic */ int[] f34884a;

        /* renamed from: b */
        public static final /* synthetic */ int[] f34885b;
        ...
        static {
            ...
            try {
                f34885b[JavaType.MESSAGE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f34885b[JavaType.STRING.ordinal()] = 3;
            ...
            try {
                f34884a[Collection.VECTOR.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f34884a[Collection.SCALAR.ordinal()] = 3;
    ...
    static {
        ...
        for (FieldType fieldType52 : values) {
            VALUES[fieldType52.f34883id] = fieldType52;
        }
    }
    ...
    private FieldType(String str, int i, int i2, Collection collection, JavaType javaType) {
        ...
        int i4 = C4351a.f34884a[collection.ordinal()];
        boolean z = true;
        if (i4 != 1) {
            if (i4 != 2) {
        ...
        this.primitiveScalar = (collection != Collection.SCALAR || (i3 = C4351a.f34885b[javaType.ordinal()]) == 1 || i3 == 2 || i3 == 3) ? false : false;
    }
