...
public final class DataScabResponse implements Parcelable {
    ...
    public static /* synthetic */ DataScabResponse copy$default(DataScabResponse dataScabResponse, String str, String str2, String str3, String str4, String str5, String str6, String str7, int i, Object obj) {
        if ((i & 1) != 0) {
            str = dataScabResponse.f81916a;
        }
        if ((i & 2) != 0) {
            str2 = dataScabResponse.f81917b;
        }
        String str8 = str2;
        if ((i & 4) != 0) {
            str3 = dataScabResponse.f81918c;
        }
        String str9 = str3;
        if ((i & 8) != 0) {
            str4 = dataScabResponse.f81919d;
        }
        String str10 = str4;
        if ((i & 16) != 0) {
            str5 = dataScabResponse.f81920e;
        }
        String str11 = str5;
        if ((i & 32) != 0) {
            str6 = dataScabResponse.f81921f;
        }
        String str12 = str6;
        if ((i & 64) != 0) {
            str7 = dataScabResponse.f81922g;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof DataScabResponse) {
            ...
            return Intrinsics.areEqual(this.f81916a, dataScabResponse.f81916a) && Intrinsics.areEqual(this.f81917b, dataScabResponse.f81917b) && Intrinsics.areEqual(this.f81918c, dataScabResponse.f81918c) && Intrinsics.areEqual(this.f81919d, dataScabResponse.f81919d) && Intrinsics.areEqual(this.f81920e, dataScabResponse.f81920e) && Intrinsics.areEqual(this.f81921f, dataScabResponse.f81921f) && Intrinsics.areEqual(this.f81922g, dataScabResponse.f81922g);
        }
        return false;
    }
    ...
    public int hashCode() {
        String str = this.f81916a;
        int hashCode = (str == null ? 0 : str.hashCode()) * 31;
        String str2 = this.f81917b;
        int hashCode2 = (hashCode + (str2 == null ? 0 : str2.hashCode())) * 31;
        String str3 = this.f81918c;
        int hashCode3 = (hashCode2 + (str3 == null ? 0 : str3.hashCode())) * 31;
        String str4 = this.f81919d;
        int hashCode4 = (hashCode3 + (str4 == null ? 0 : str4.hashCode())) * 31;
        String str5 = this.f81920e;
        int hashCode5 = (hashCode4 + (str5 == null ? 0 : str5.hashCode())) * 31;
        String str6 = this.f81921f;
        int hashCode6 = (hashCode5 + (str6 == null ? 0 : str6.hashCode())) * 31;
        String str7 = this.f81922g;
    ...
    public void writeToParcel(@NotNull Parcel out, int i) {
        ...
        out.writeString(this.f81916a);
        out.writeString(this.f81917b);
        out.writeString(this.f81918c);
        out.writeString(this.f81919d);
        out.writeString(this.f81920e);
        out.writeString(this.f81921f);
        out.writeString(this.f81922g);
    }
