...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.topup.fragment.OneTopupConfirmFragment$setUpViewModel$3 */
/* loaded from: classes10.dex */
public final class OneTopupConfirmFragment$setUpViewModel$3 extends Lambda implements Function1<Resource<? extends Pair<? extends String, ? extends OneBuyDolPriceListSimRModel>>, Unit> {
    final /* synthetic */ OneTopupConfirmFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.topup.fragment.OneTopupConfirmFragment$setUpViewModel$3$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneTopupConfirmFragment$setUpViewModel$3(OneTopupConfirmFragment oneTopupConfirmFragment) {
        super(1);
    ...
    public final void invoke2(Resource<Pair<String, OneBuyDolPriceListSimRModel>> resource) {
        ...
        if (data != null) {
            ...
            if (Intrinsics.areEqual(data.getFirst(), PermissionConstant.M_BUY_DOL)) {
                oneTopupConfirmFragment.m9310s(second);
            }
        }
    }
}