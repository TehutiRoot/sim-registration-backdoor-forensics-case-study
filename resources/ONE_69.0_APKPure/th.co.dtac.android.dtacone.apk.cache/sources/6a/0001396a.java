...
@SourceDebugExtension({"SMAP\nOnePostpaidRegistrationViewModel.kt\nKotlin\n*S Kotlin\n*F\n+ 1 OnePostpaidRegistrationViewModel.kt\nth/co/dtac/android/dtacone/view/appOne/postpaid_registration/viewmodel/OnePostpaidRegistrationViewModel$uploadImage$5\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,3696:1\n1#2:3697\n*E\n"})
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.viewmodel.OnePostpaidRegistrationViewModel$uploadImage$5 */
/* loaded from: classes10.dex */
public final class OnePostpaidRegistrationViewModel$uploadImage$5 extends Lambda implements Function1<UploadImageResponse, Unit> {
    final /* synthetic */ OnePostpaidRegistrationViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidRegistrationViewModel$uploadImage$5(OnePostpaidRegistrationViewModel onePostpaidRegistrationViewModel) {
        super(1);
    ...
    public final void invoke2(UploadImageResponse uploadImageResponse) {
        ...
        if (filename != null) {
            ...
            onePostpaidRepository.getAttachmentNames().add(filename);
        }
    }
}