...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_pre2post.MrtrPre2PostViewModel$getAllPackageGroupPre2PostByRefAPI$3 */
/* loaded from: classes9.dex */
public final class MrtrPre2PostViewModel$getAllPackageGroupPre2PostByRefAPI$3 extends Lambda implements Function1<GetAllPackageGroupBrandedPre2PostByRefResponse, Unit> {
    final /* synthetic */ MrtrPre2PostViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrPre2PostViewModel$getAllPackageGroupPre2PostByRefAPI$3(MrtrPre2PostViewModel mrtrPre2PostViewModel) {
        super(1);
    ...
    public final void invoke2(GetAllPackageGroupBrandedPre2PostByRefResponse getAllPackageGroupBrandedPre2PostByRefResponse) {
        ...
        MutableLiveData m2176T;
        m2159f0 = this.this$0.m2159f0();
        m2159f0.setValue(new Event(new FragmentNavEvent(MrtrPre2PostAllPackageUserLanFragment.class, null, null, 6, null)));
        m2176T = this.this$0.m2176T();
        m2176T.setValue(Resource.Companion.success(getAllPackageGroupBrandedPre2PostByRefResponse));
    }
}