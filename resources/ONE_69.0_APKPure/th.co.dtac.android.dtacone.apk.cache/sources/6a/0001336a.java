...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.viewModel.OneMnpViewModel$checkBlackList$3 */
/* loaded from: classes10.dex */
public final class OneMnpViewModel$checkBlackList$3 extends Lambda implements Function1<StatusResponse, Unit> {
    final /* synthetic */ OneMnpViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneMnpViewModel$checkBlackList$3(OneMnpViewModel oneMnpViewModel) {
        super(1);
    ...
    public final void invoke2(StatusResponse statusResponse) {
        ...
        m13422s1.setValue(Resource.Companion.success(null));
    }
}