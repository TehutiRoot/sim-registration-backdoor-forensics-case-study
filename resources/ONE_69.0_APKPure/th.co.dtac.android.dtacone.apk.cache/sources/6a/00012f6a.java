...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.device_sale.viewmodel.OneDeviceSalePackagesViewModel$getOneDeviceSalePostpaidAllPackageGroupRetailer$2 */
/* loaded from: classes10.dex */
public final class C14634xde26d7af extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ OneDeviceSalePackagesViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C14634xde26d7af(OneDeviceSalePackagesViewModel oneDeviceSalePackagesViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable it) {
        ...
        oneErrorService.handleException(it, new OneErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.view.appOne.device_sale.viewmodel.OneDeviceSalePackagesViewModel$getOneDeviceSalePostpaidAllPackageGroupRetailer$2.1
