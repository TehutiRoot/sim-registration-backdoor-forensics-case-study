...
public final class DraggableKt {
    ...
    /* JADX WARN: Removed duplicated region for block: B:91:0x02dd A[ORIG_RETURN, RETURN] */
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:66:0x0225 -> B:67:0x0234). Please submit an issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:77:0x028e -> B:78:0x0293). Please submit an issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:93:0x02df -> B:67:0x0234). Please submit an issue!!! */
    /* renamed from: a */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final java.lang.Object m61450a(androidx.compose.p003ui.input.pointer.AwaitPointerEventScope r20, kotlin.jvm.functions.Function1 r21, kotlin.jvm.functions.Function0 r22, androidx.compose.p003ui.input.pointer.util.VelocityTracker r23, androidx.compose.foundation.gestures.Orientation r24, kotlin.coroutines.Continuation r25) {
        /*
            Method dump skipped, instructions count: 743
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.DraggableKt.m61450a(androidx.compose.ui.input.pointer.AwaitPointerEventScope, kotlin.jvm.functions.Function1, kotlin.jvm.functions.Function0, androidx.compose.ui.input.pointer.util.VelocityTracker, androidx.compose.foundation.gestures.Orientation, kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* renamed from: b */
    public static final Object m61449b(AwaitPointerEventScope awaitPointerEventScope, PointerInputChange pointerInputChange, long j, VelocityTracker velocityTracker, SendChannel sendChannel, boolean z, Orientation orientation, Continuation continuation) {
        long j2;
        sendChannel.mo74250trySendJP2dKIU(new DragEvent.DragStarted(Offset.m71690minusMKHz9U(pointerInputChange.m72898getPositionF1C5BW0(), OffsetKt.Offset(Offset.m71686getXimpl(j) * Math.signum(Offset.m71686getXimpl(pointerInputChange.m72898getPositionF1C5BW0())), Offset.m71687getYimpl(j) * Math.signum(Offset.m71687getYimpl(pointerInputChange.m72898getPositionF1C5BW0())))), null));
        if (z) {
            j2 = Offset.m71693timestuRUvjQ(j, -1.0f);
        } else {
            j2 = j;
        }
        sendChannel.mo74250trySendJP2dKIU(new DragEvent.DragDelta(j2, null));
        return m61448c(awaitPointerEventScope, orientation, pointerInputChange.m72897getIdJ3iCeTQ(), new DraggableKt$awaitDrag$2(velocityTracker, sendChannel, z), continuation);
    }
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:26:0x0090 -> B:27:0x0097). Please submit an issue!!! */
    /* renamed from: c */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final java.lang.Object m61448c(androidx.compose.p003ui.input.pointer.AwaitPointerEventScope r18, androidx.compose.foundation.gestures.Orientation r19, long r20, kotlin.jvm.functions.Function1 r22, kotlin.coroutines.Continuation r23) {
        /*
            Method dump skipped, instructions count: 338
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.DraggableKt.m61448c(androidx.compose.ui.input.pointer.AwaitPointerEventScope, androidx.compose.foundation.gestures.Orientation, long, kotlin.jvm.functions.Function1, kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* renamed from: d */
    public static final float m61447d(long j, Orientation orientation) {
    ...
    /* renamed from: e */
    public static final float m61446e(long j, Orientation orientation) {
        if (orientation == Orientation.Vertical) {
