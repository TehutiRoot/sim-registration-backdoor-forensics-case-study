...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.stvProSermOnline.fragment.OneProsermOnlineConfirmFragment$setupViewModel$7 */
/* loaded from: classes10.dex */
public final class OneProsermOnlineConfirmFragment$setupViewModel$7 extends Lambda implements Function1<Resource<? extends Pair<? extends BuyDolConsent, ? extends String>>, Unit> {
    final /* synthetic */ OneProsermOnlineConfirmFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.stvProSermOnline.fragment.OneProsermOnlineConfirmFragment$setupViewModel$7$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneProsermOnlineConfirmFragment$setupViewModel$7(OneProsermOnlineConfirmFragment oneProsermOnlineConfirmFragment) {
        super(1);
    ...
    public final void invoke2(Resource<Pair<BuyDolConsent, String>> resource) {
        ...
        if (i != 1) {
            if (i == 2) {
                oneProsermOnlineConfirmFragment.showLoading();
                return;
            } else if (i != 3) {
                return;
            } else {
                oneProsermOnlineConfirmFragment.dismissLoading();
                return;
            }
        }
        ...
        if (data != null) {
            ...
            if (consentMessage == null || consentMessage.length() == 0) {
                oneProsermOnlineConfirmFragment.m9831r(second);
                return;
            }
            String mrtrConsentId = first.getMrtrConsentId();
            OneProsermOnlineConfirmFragment.MrtrConsentId.setConsentId(mrtrConsentId != null ? Integer.valueOf(Integer.parseInt(mrtrConsentId)) : null);
            oneProsermOnlineConfirmFragment.f97568x = OneConsentDialog.Companion.newInstance(first.getConsentMessage(), oneProsermOnlineConfirmFragment.getString(R.string.one_consent_dialog_ok_massage));
            oneConsentDialog = oneProsermOnlineConfirmFragment.f97568x;
            if (oneConsentDialog != null) {
                oneConsentDialog.setCallback(oneProsermOnlineConfirmFragment);
            }
            oneConsentDialog2 = oneProsermOnlineConfirmFragment.f97568x;
            if (oneConsentDialog2 != null) {
                Integer num = OneHomeFragment.Companion.getFeatures().get(second);
                oneConsentDialog2.setTargetFragment(oneProsermOnlineConfirmFragment, num != null ? num.intValue() : 0);
            }
            FragmentManager parentFragmentManager = oneProsermOnlineConfirmFragment.getParentFragmentManager();
            oneConsentDialog3 = oneProsermOnlineConfirmFragment.f97568x;
