...
@DebugMetadata(m29093c = "io.realm.internal.coroutines.InternalFlowFactory$from$3", m29092f = "InternalFlowFactory.kt", m29091i = {}, m29090l = {116, 142}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
...
public final class InternalFlowFactory$from$3 extends SuspendLambda implements Function2<ProducerScope<? super RealmResults<T>>, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes5.dex */
    public static final class C113291 extends Lambda implements Function0<Unit> {
        public static final C113291 INSTANCE = new C113291();
    ...
    /* loaded from: classes5.dex */
    public static final class C113302 extends Lambda implements Function0<Unit> {
        final /* synthetic */ Realm $flowRealm;
        final /* synthetic */ RealmChangeListener<RealmResults<T>> $listener;
        final /* synthetic */ RealmResults<T> $results;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C113302(Realm realm, RealmResults<T> realmResults, RealmChangeListener<RealmResults<T>> realmChangeListener) {
            super(0);
    ...
    public static final void m74259invokeSuspend$lambda0(ProducerScope producerScope, InternalFlowFactory internalFlowFactory, RealmResults realmResults) {
        boolean z;
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (!this.$results.isValid()) {
            C113291 c113291 = C113291.INSTANCE;
            this.label = 1;
            if (ProduceKt.awaitClose(producerScope, c113291, this) == coroutine_suspended) {
        ...
        RealmChangeListener realmChangeListener = new RealmChangeListener() { // from class: io.realm.internal.coroutines.i
            ...
            public final void onChange(Object obj2) {
                InternalFlowFactory$from$3.m74259invokeSuspend$lambda0(ProducerScope.this, internalFlowFactory, (RealmResults) obj2);
            }
        };
        ...
        C113302 c113302 = new C113302(realm, this.$results, realmChangeListener);
        this.label = 2;
        if (ProduceKt.awaitClose(producerScope, c113302, this) == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Unit.INSTANCE;
    }
