...
public final class SnapFlingBehavior$animateDecay$2 extends Lambda implements Function1<AnimationScope<Float, AnimationVector1D>, Unit> {
    ...
    public final void invoke2(@NotNull AnimationScope<Float, AnimationVector1D> animateDecay) {
        ...
        if (Math.abs(animateDecay.getValue().floatValue()) >= Math.abs(this.$targetOffset)) {
            m60477e = this.this$0.m60477e(animateDecay.getValue().floatValue(), this.$targetOffset);
            SnapFlingBehavior.m60480b(animateDecay, this.$this_animateDecay, m60477e - this.$previousValue.element);
            animateDecay.cancelAnimation();
            return;
        }
        SnapFlingBehavior.m60480b(animateDecay, this.$this_animateDecay, animateDecay.getValue().floatValue() - this.$previousValue.element);
