...
public final class HtmlCompat {
    ...
    public static class C4060a {
        @DoNotInline
        /* renamed from: a */
        public static Spanned m57039a(String str, int i) {
            return Html.fromHtml(str, i);
        }

        @DoNotInline
        /* renamed from: b */
        public static Spanned m57038b(String str, int i, Html.ImageGetter imageGetter, Html.TagHandler tagHandler) {
            return Html.fromHtml(str, i, imageGetter, tagHandler);
        }

        @DoNotInline
        /* renamed from: c */
        public static String m57037c(Spanned spanned, int i) {
    ...
    public static String toHtml(@NonNull Spanned spanned, int i) {
        if (Build.VERSION.SDK_INT >= 24) {
            return C4060a.m57037c(spanned, i);
        }
    ...
    public static Spanned fromHtml(@NonNull String str, int i, @Nullable Html.ImageGetter imageGetter, @Nullable Html.TagHandler tagHandler) {
        if (Build.VERSION.SDK_INT >= 24) {
            return C4060a.m57038b(str, i, imageGetter, tagHandler);
        }
