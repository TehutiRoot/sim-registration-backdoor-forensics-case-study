...
public class Base64 extends BaseNCodec {
    ...
    public static byte[] encodeInteger(BigInteger bigInteger) {
        ...
        return encodeBase64(m25868l(bigInteger), false);
    }
    ...
    /* renamed from: l */
    public static byte[] m25868l(BigInteger bigInteger) {
    ...
    /* renamed from: m */
    public static byte[] m25867m(boolean z) {
        if (z) {
            return f73111l;
        }
        return f73110k;
    ...
    public void mo25862c(byte[] bArr, int i, int i2, BaseNCodec.C12485a c12485a) {
        ...
        while (true) {
            ...
            if (b2 >= 0) {
                byte[] bArr2 = this.f73114g;
                if (b2 < bArr2.length && (b = bArr2[b2]) >= 0) {
                    int i6 = (c12485a.f73136h + 1) % 4;
                    c12485a.f73136h = i6;
                    int i7 = (c12485a.f73129a << 6) + b;
                    c12485a.f73129a = i7;
                    if (i6 == 0) {
                        int i8 = c12485a.f73132d;
                        int i9 = i8 + 1;
                        c12485a.f73132d = i9;
        ...
        if (c12485a.f73134f && c12485a.f73136h != 0) {
            ...
            int i11 = c12485a.f73136h;
            if (i11 != 1) {
                if (i11 != 2) {
                    if (i11 == 3) {
                        m25866n(3, c12485a);
                        int i12 = c12485a.f73129a;
                        int i13 = i12 >> 2;
                        c12485a.f73129a = i13;
                        int i14 = c12485a.f73132d;
                        int i15 = i14 + 1;
                        c12485a.f73132d = i15;
                        ensureBufferSize2[i14] = (byte) ((i12 >> 10) & 255);
                        c12485a.f73132d = i14 + 2;
                ...
                m25866n(15, c12485a);
                int i16 = c12485a.f73129a >> 4;
                c12485a.f73129a = i16;
                int i17 = c12485a.f73132d;
                c12485a.f73132d = i17 + 1;
    ...
    public void mo25861d(byte[] bArr, int i, int i2, BaseNCodec.C12485a c12485a) {
        ...
        if (i2 < 0) {
            ...
            byte[] ensureBufferSize = ensureBufferSize(this.f73116i, c12485a);
            int i3 = c12485a.f73132d;
            int i4 = c12485a.f73136h;
            if (i4 != 0) {
                if (i4 != 1) {
                    if (i4 == 2) {
                        int i5 = i3 + 1;
                        c12485a.f73132d = i5;
                        byte[] bArr2 = this.f73113f;
                        int i6 = c12485a.f73129a;
                    ...
                    int i9 = i3 + 1;
                    c12485a.f73132d = i9;
                    byte[] bArr3 = this.f73113f;
                    int i10 = c12485a.f73129a;
        ...
        int i16 = 0;
        while (i16 < i2) {
            byte[] ensureBufferSize2 = ensureBufferSize(this.f73116i, c12485a);
            int i17 = (c12485a.f73136h + 1) % 3;
            c12485a.f73136h = i17;
            int i18 = i + 1;
            int i19 = bArr[i];
            if (i19 < 0) {
            ...
            int i20 = (c12485a.f73129a << 8) + i19;
            c12485a.f73129a = i20;
            if (i17 == 0) {
                int i21 = c12485a.f73132d;
                int i22 = i21 + 1;
                c12485a.f73132d = i22;
                byte[] bArr5 = this.f73113f;
                ...
                int i26 = c12485a.f73135g + 4;
                c12485a.f73135g = i26;
                int i27 = this.lineLength;
                if (i27 > 0 && i27 <= i26) {
                    byte[] bArr6 = this.f73115h;
    ...
    /* renamed from: k */
    public final byte[] m25869k(byte[] bArr) {
    ...
    /* renamed from: n */
    public final void m25866n(int i, BaseNCodec.C12485a c12485a) {
        if (isStrictDecoding() && (i & c12485a.f73129a) != 0) {
    ...
    public static byte[] encodeBase64(byte[] bArr, boolean z, boolean z2, int i) {
        if (BinaryCodec.m25849a(bArr)) {
            return bArr;
        }
        Base64 base64 = z ? new Base64(z2) : new Base64(0, BaseNCodec.f73118e, z2);
    ...
    public Base64(int i, byte[] bArr, boolean z) {
        this(i, bArr, kotlin.p023io.encoding.Base64.padSymbol, m25867m(z), BaseNCodec.DECODING_POLICY_DEFAULT);
    }

    public Base64(int i, byte[] bArr, boolean z, CodecPolicy codecPolicy) {
        this(i, bArr, kotlin.p023io.encoding.Base64.padSymbol, m25867m(z), codecPolicy);
    }

    public Base64(int i, byte[] bArr, byte b, byte[] bArr2, CodecPolicy codecPolicy) {
        super(3, 4, i, BaseNCodec.m25857h(bArr), b, codecPolicy);
        Objects.requireNonNull(bArr2, "encodeTable");
        if (bArr2.length == 64) {
            boolean z = bArr2 == f73111l;
            this.f73117j = z;
            if (bArr2 != f73110k && !z) {
                byte[] bArr3 = (byte[]) bArr2.clone();
                this.f73113f = bArr3;
                this.f73114g = m25869k(bArr3);
            } else {
                this.f73114g = f73112m;
                this.f73113f = bArr2;
            }
            if (bArr != null) {
