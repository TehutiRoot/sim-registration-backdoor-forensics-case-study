...
public final class OneStvSubmitTrueRequest {
    ...
    /* renamed from: a */
    private final OneSecurePin f82308a;
    @SerializedName("removePackage")
    @Nullable

    /* renamed from: b */
    private final String f82309b;
    @SerializedName("ussdCode")
    @Nullable

    /* renamed from: c */
    private final String f82310c;
    @SerializedName("packageCode")
    @Nullable

    /* renamed from: d */
    private final String f82311d;
    @SerializedName(InputPostpaidFamilySimSubscriberFragment.SUB_NUM)
    @Nullable

    /* renamed from: e */
    private final String f82312e;
    @SerializedName("confirmMultiTrans")
    @Nullable

    /* renamed from: f */
    private final String f82313f;
    @SerializedName("categoryId")
    @Nullable

    /* renamed from: g */
    private final String f82314g;
    @SerializedName("poqItemId")
    @Nullable

    /* renamed from: h */
    private final String f82315h;
    @SerializedName("poqItemProductOfferingId")
    @Nullable

    /* renamed from: i */
    private final String f82316i;
    @SerializedName("transactionRefId")
    @Nullable

    /* renamed from: j */
    private final String f82317j;
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof OneStvSubmitTrueRequest) {
            ...
            return Intrinsics.areEqual(this.f82308a, oneStvSubmitTrueRequest.f82308a) && Intrinsics.areEqual(this.f82309b, oneStvSubmitTrueRequest.f82309b) && Intrinsics.areEqual(this.f82310c, oneStvSubmitTrueRequest.f82310c) && Intrinsics.areEqual(this.f82311d, oneStvSubmitTrueRequest.f82311d) && Intrinsics.areEqual(this.f82312e, oneStvSubmitTrueRequest.f82312e) && Intrinsics.areEqual(this.f82313f, oneStvSubmitTrueRequest.f82313f) && Intrinsics.areEqual(this.f82314g, oneStvSubmitTrueRequest.f82314g) && Intrinsics.areEqual(this.f82315h, oneStvSubmitTrueRequest.f82315h) && Intrinsics.areEqual(this.f82316i, oneStvSubmitTrueRequest.f82316i) && Intrinsics.areEqual(this.f82317j, oneStvSubmitTrueRequest.f82317j);
        }
        return false;
    }
    ...
    public int hashCode() {
        OneSecurePin oneSecurePin = this.f82308a;
        int hashCode = (oneSecurePin == null ? 0 : oneSecurePin.hashCode()) * 31;
        String str = this.f82309b;
        int hashCode2 = (hashCode + (str == null ? 0 : str.hashCode())) * 31;
        String str2 = this.f82310c;
        int hashCode3 = (hashCode2 + (str2 == null ? 0 : str2.hashCode())) * 31;
        String str3 = this.f82311d;
        int hashCode4 = (hashCode3 + (str3 == null ? 0 : str3.hashCode())) * 31;
        String str4 = this.f82312e;
        int hashCode5 = (hashCode4 + (str4 == null ? 0 : str4.hashCode())) * 31;
        String str5 = this.f82313f;
        int hashCode6 = (hashCode5 + (str5 == null ? 0 : str5.hashCode())) * 31;
        String str6 = this.f82314g;
        int hashCode7 = (hashCode6 + (str6 == null ? 0 : str6.hashCode())) * 31;
        String str7 = this.f82315h;
        int hashCode8 = (hashCode7 + (str7 == null ? 0 : str7.hashCode())) * 31;
        String str8 = this.f82316i;
        int hashCode9 = (hashCode8 + (str8 == null ? 0 : str8.hashCode())) * 31;
        String str9 = this.f82317j;
