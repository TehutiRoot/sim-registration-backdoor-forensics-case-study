...
public final class WrappedErrorResponse {
    ...
    /* renamed from: a */
    private final ErrorPayload f54661a;
    ...
    public static /* synthetic */ WrappedErrorResponse copy$default(WrappedErrorResponse wrappedErrorResponse, ErrorPayload errorPayload, int i, Object obj) {
        if ((i & 1) != 0) {
            errorPayload = wrappedErrorResponse.f54661a;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return (obj instanceof WrappedErrorResponse) && Intrinsics.areEqual(this.f54661a, ((WrappedErrorResponse) obj).f54661a);
    }
    ...
    public int hashCode() {
        ErrorPayload errorPayload = this.f54661a;
    ...
    public String toString() {
        return "WrappedErrorResponse(error=" + this.f54661a + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }

    public WrappedErrorResponse(@Nullable ErrorPayload errorPayload) {
        this.f54661a = errorPayload;
    }
