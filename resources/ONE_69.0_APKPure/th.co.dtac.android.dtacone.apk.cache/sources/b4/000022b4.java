...
@DebugMetadata(m29093c = "androidx.compose.animation.core.InfiniteTransition$run$1", m29092f = "InfiniteTransition.kt", m29091i = {0, 0, 1, 1}, m29090l = {181, 205}, m29089m = "invokeSuspend", m29088n = {"$this$LaunchedEffect", "durationScale", "$this$LaunchedEffect", "durationScale"}, m29087s = {"L$0", "L$1", "L$0", "L$1"})
...
public final class InfiniteTransition$run$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes.dex */
    public static final class C27231 extends Lambda implements Function1<Long, Unit> {
        ...
        public C27231(MutableState<State<Long>> mutableState, InfiniteTransition infiniteTransition, Ref.FloatRef floatRef, CoroutineScope coroutineScope) {
            super(1);
        ...
        public final void invoke(long j) {
            ...
            if (j2 == Long.MIN_VALUE || this.$durationScale.element != SuspendAnimationKt.getDurationScale(this.$$this$LaunchedEffect.getCoroutineContext())) {
                this.this$0.f12623d = j;
                mutableVector = this.this$0.f12621b;
            ...
            if (this.$durationScale.element == 0.0f) {
                mutableVector2 = this.this$0.f12621b;
            ...
            j3 = this.this$0.f12623d;
            this.this$0.m61647c(((float) (longValue - j3)) / this.$durationScale.element);
        }
    }
    ...
    /* loaded from: classes.dex */
    public static final class C27242 extends Lambda implements Function0<Float> {
        final /* synthetic */ CoroutineScope $$this$LaunchedEffect;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C27242(CoroutineScope coroutineScope) {
            super(0);
            this.$$this$LaunchedEffect = coroutineScope;
        }
    ...
    @Metadata(m29143d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0007\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\u008a@"}, m29142d2 = {"<anonymous>", "", "it", ""}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    @DebugMetadata(m29093c = "androidx.compose.animation.core.InfiniteTransition$run$1$3", m29092f = "InfiniteTransition.kt", m29091i = {}, m29090l = {}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
    /* renamed from: androidx.compose.animation.core.InfiniteTransition$run$1$3 */
    /* loaded from: classes.dex */
    public static final class C27253 extends SuspendLambda implements Function2<Float, Continuation<? super Boolean>, Object> {
        /* synthetic */ float F$0;
        int label;

        public C27253(Continuation<? super C27253> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C27253 c27253 = new C27253(continuation);
            c27253.F$0 = ((Number) obj).floatValue();
            return c27253;
        }

        @Nullable
        public final Object invoke(float f, @Nullable Continuation<? super Boolean> continuation) {
            return ((C27253) create(Float.valueOf(f), continuation)).invokeSuspend(Unit.INSTANCE);
        }
