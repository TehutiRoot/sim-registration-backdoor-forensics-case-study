...
public class C0567I7 implements AuthenticationStrategy {

    /* renamed from: a */
    public final Log f2578a = LogFactory.getLog(getClass());

    /* renamed from: b */
    public final AuthenticationHandler f2579b;

    public C0567I7(AuthenticationHandler authenticationHandler) {
        this.f2579b = authenticationHandler;
    }

    /* renamed from: b */
    private boolean m68058b(AuthScheme authScheme) {
    ...
    /* renamed from: a */
    public AuthenticationHandler m68059a() {
        return this.f2579b;
    }
    ...
    public Map getChallenges(HttpHost httpHost, HttpResponse httpResponse, HttpContext httpContext) {
        return this.f2579b.getChallenges(httpResponse, httpContext);
    }

    @Override // org.apache.http.client.AuthenticationStrategy
    public boolean isAuthenticationRequested(HttpHost httpHost, HttpResponse httpResponse, HttpContext httpContext) {
        return this.f2579b.isAuthenticationRequested(httpResponse, httpContext);
    }
    ...
    public Queue select(Map map, HttpHost httpHost, HttpResponse httpResponse, HttpContext httpContext) {
        ...
        if (credentialsProvider == null) {
            this.f2578a.debug("Credentials provider not set in the context");
            return linkedList;
        }
        try {
            AuthScheme selectScheme = this.f2579b.selectScheme(map, httpResponse, httpContext);
            ...
            if (this.f2578a.isWarnEnabled()) {
                this.f2578a.warn(e.getMessage(), e);
            }
            return linkedList;
        }
    }
