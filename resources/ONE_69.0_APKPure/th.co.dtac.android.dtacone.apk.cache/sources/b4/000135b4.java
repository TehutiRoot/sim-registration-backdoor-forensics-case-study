...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.onlineRegister.viewModel.OneOnlineRegisterViewModel$validateTrueNumber$3 */
/* loaded from: classes10.dex */
public final class OneOnlineRegisterViewModel$validateTrueNumber$3 extends Lambda implements Function1<OneOnlineRegisterValidateNumberResponse, Unit> {
    final /* synthetic */ String $simRNumber;
    final /* synthetic */ OneOnlineRegisterViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneOnlineRegisterViewModel$validateTrueNumber$3(OneOnlineRegisterViewModel oneOnlineRegisterViewModel, String str) {
        super(1);
    ...
    public final void invoke2(OneOnlineRegisterValidateNumberResponse oneOnlineRegisterValidateNumberResponse) {
        MutableLiveData m12870d0;
        this.this$0.setTrueOnlinePhone(PhoneNumberExtKt.toInternational(PhoneNumberFormat.removeAllSpecialCharacter(this.$simRNumber)));
        m12870d0 = this.this$0.m12870d0();
        m12870d0.setValue(Resource.Companion.success(new Pair(StatusResource.SUCCESS, this.$simRNumber)));
    }
}