...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.esim.ESimViewModel$getMrtrPrepaidReregistAuthorization$3 */
/* loaded from: classes9.dex */
public final class ESimViewModel$getMrtrPrepaidReregistAuthorization$3 extends Lambda implements Function1<GetAuthorizationByRtrResponse, Unit> {
    final /* synthetic */ ESimViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimViewModel$getMrtrPrepaidReregistAuthorization$3(ESimViewModel eSimViewModel) {
        super(1);
    ...
    public final void invoke2(GetAuthorizationByRtrResponse it) {
        ...
        eSimViewModel.storeAuthenData(it);
        this.this$0.getLiveDataState().setValue(StatusResource.DISMISS);
        mutableLiveData = this.this$0.f105831m;
