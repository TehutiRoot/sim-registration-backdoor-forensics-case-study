...
public final class ParallelCollect<T, C> extends ParallelFlowable<C> {
    ...
    /* renamed from: b */
    public final Callable f65798b;

    /* renamed from: c */
    public final BiConsumer f65799c;
    ...
    public ParallelCollect(ParallelFlowable<? extends T> parallelFlowable, Callable<? extends C> callable, BiConsumer<? super C, ? super T> biConsumer) {
        ...
        this.f65798b = callable;
        this.f65799c = biConsumer;
    }

    /* renamed from: a */
    public void m30272a(Subscriber[] subscriberArr, Throwable th2) {
    ...
    public void subscribe(Subscriber<? super C>[] subscriberArr) {
        ...
        for (int i = 0; i < length; i++) {
            try {
                subscriberArr2[i] = new ParallelCollectSubscriber(subscriberArr[i], ObjectHelper.requireNonNull(this.f65798b.call(), "The initialSupplier returned a null value"), this.f65799c);
            } catch (Throwable th2) {
                Exceptions.throwIfFatal(th2);
                m30272a(subscriberArr, th2);
                return;
            }
        }
