...
public final class MaybeFlatMapIterableFlowable<T, R> extends Flowable<R> {
    ...
    /* renamed from: b */
    public final MaybeSource f64859b;

    /* renamed from: c */
    public final Function f64860c;
    ...
    public static final class FlatMapIterableObserver<T, R> extends BasicIntQueueSubscription<R> implements MaybeObserver<T> {
        ...
        /* renamed from: it */
        volatile Iterator<? extends R> f64861it;
        ...
        public void drain() {
            ...
            Iterator<? extends R> it = this.f64861it;
    ...
    public MaybeFlatMapIterableFlowable(MaybeSource<T> maybeSource, Function<? super T, ? extends Iterable<? extends R>> function) {
        this.f64859b = maybeSource;
        this.f64860c = function;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super R> subscriber) {
        this.f64859b.subscribe(new FlatMapIterableObserver(subscriber, this.f64860c));
    }
}