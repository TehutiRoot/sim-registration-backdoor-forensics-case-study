...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.device_sale.fragment.OneDeviceSaleScanIMEIFragment$onStart$1$2 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleScanIMEIFragment$onStart$1$2 extends Lambda implements Function1<Resource<? extends Void>, Unit> {
    final /* synthetic */ OneDeviceSaleScanIMEIFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneDeviceSaleScanIMEIFragment$onStart$1$2(OneDeviceSaleScanIMEIFragment oneDeviceSaleScanIMEIFragment) {
        super(1);
    ...
    public final void invoke2(Resource<Void> resource) {
        ...
        if (resourceContentIfNotHandled.getStatus() == StatusResource.SUCCESS) {
            ...
            oneDeviceSaleScanIMEIFragment.dismissSecondaryLoading();
            new Handler().postDelayed(new Runnable() { // from class: th.co.dtac.android.dtacone.view.appOne.device_sale.fragment.a
                @Override // java.lang.Runnable
                public final void run() {
                    OneDeviceSaleScanIMEIFragment$onStart$1$2.invoke$lambda$1$lambda$0(OneDeviceSaleScanIMEIFragment.this);
                }
            }, 1000L);
        }
    }
