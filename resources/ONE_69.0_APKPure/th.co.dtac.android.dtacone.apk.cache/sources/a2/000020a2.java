...
import androidx.camera.video.C2619e;
...
public abstract class MediaSpec {
    ...
    public static abstract class Builder {
        /* renamed from: a */
        public abstract AudioSpec mo62202a();

        /* renamed from: b */
        public abstract VideoSpec mo62201b();
        ...
        public Builder configureAudio(@NonNull Consumer<AudioSpec.Builder> consumer) {
            AudioSpec.Builder builder = mo62202a().toBuilder();
        ...
        public Builder configureVideo(@NonNull Consumer<VideoSpec.Builder> consumer) {
            VideoSpec.Builder builder = mo62201b().toBuilder();
            consumer.accept(builder);
    ...
    /* renamed from: a */
    public static int m62475a(int i) {
        return i != 1 ? 0 : 1;
    }

    @NonNull
    public static Builder builder() {
        return new C2619e.C2621b().setOutputFormat(-1).setAudioSpec(AudioSpec.builder().build()).setVideoSpec(VideoSpec.builder().build());
    }
