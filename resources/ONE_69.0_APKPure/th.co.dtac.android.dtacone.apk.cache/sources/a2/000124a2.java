...
/* renamed from: th.co.dtac.android.dtacone.presenter.profile.ProfilePicturePresenter$deleteProfileImage$2 */
/* loaded from: classes8.dex */
public final class ProfilePicturePresenter$deleteProfileImage$2 extends Lambda implements Function1<StatusResponse, Unit> {
    final /* synthetic */ ProfilePicturePresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ProfilePicturePresenter$deleteProfileImage$2(ProfilePicturePresenter profilePicturePresenter) {
        super(1);
    ...
    public final void invoke2(StatusResponse statusResponse) {
        ...
        if (Intrinsics.areEqual(statusResponse.getStatus(), Status.getSUCCESS())) {
            ...
            view.onDeleteProfileImageSuccess();
            return;
        }
