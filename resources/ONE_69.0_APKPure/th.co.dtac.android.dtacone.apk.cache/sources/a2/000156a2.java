...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.esim.ESimViewModel$cutSimStockForPhysical$1$1 */
/* loaded from: classes9.dex */
public final class ESimViewModel$cutSimStockForPhysical$1$1 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ ESimViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimViewModel$cutSimStockForPhysical$1$1(ESimViewModel eSimViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable it) {
        ...
        mrtrErrorService.handleException(it, new MrtrErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.viewmodel.esim.ESimViewModel$cutSimStockForPhysical$1$1.1
            ...
            public void handle(@Nullable Throwable th2) {
                ...
                if (!(th2 instanceof HttpException) || ((HttpException) th2).code() != 404) {
                    ...
                    eSimRepository.setCutSimStockErrorPhysical(errorCollection);
                }
                ESimViewModel.this.m2769I();
            }
