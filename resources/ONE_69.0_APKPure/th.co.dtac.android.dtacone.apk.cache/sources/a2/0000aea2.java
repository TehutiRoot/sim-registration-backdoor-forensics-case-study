...
@Metadata(m29143d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n¢\u0006\u0002\b\u0004"}, m29142d2 = {"<anonymous>", "", "appVariant", "Lcom/android/build/api/variant/ApplicationVariant;", "invoke"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
...
public final class AppDistributionPlugin$setUp$3 extends Lambda implements Function1<ApplicationVariant, Unit> {
    ...
    @Metadata(m29143d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u00012\u000e\u0010\u0002\u001a\n \u0004*\u0004\u0018\u00010\u00030\u0003H\n¢\u0006\u0002\b\u0005"}, m29142d2 = {"<anonymous>", "", "task", "Lcom/google/firebase/appdistribution/gradle/tasks/UploadDistributionTask;", "kotlin.jvm.PlatformType", "invoke"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: com.google.firebase.appdistribution.gradle.AppDistributionPlugin$setUp$3$1 */
    /* loaded from: classes4.dex */
    public static final class C83281 extends Lambda implements Function1<UploadDistributionTask, Unit> {
        final /* synthetic */ ApplicationVariant $appVariant;
        final /* synthetic */ AppDistributionExtension $mergedExtension;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C83281(ApplicationVariant applicationVariant, AppDistributionExtension appDistributionExtension) {
            super(1);
    ...
    public final void invoke2(@NotNull ApplicationVariant appVariant) {
        ...
        for (BuildType buildType : this.$appExtension.getBuildTypes()) {
            if (appVariant.getBuildType() != null && Intrinsics.areEqual(appVariant.getBuildType(), buildType.getName())) {
                ...
                ArrayList arrayList = new ArrayList(AbstractC10172es.collectionSizeOrDefault(productFlavors, 10));
                ...
                AppDistributionExtension m39263a = appDistributionExtension.m39263a(buildType, arrayList2);
                TaskContainer tasks = this.$project.getTasks();
                m39257a = AppDistributionPlugin.Companion.m39257a(appVariant);
                tasks.register(m39257a, UploadDistributionTask.class, new C1848a6(new C83281(appVariant, m39263a)));
                return;
            }
        }
