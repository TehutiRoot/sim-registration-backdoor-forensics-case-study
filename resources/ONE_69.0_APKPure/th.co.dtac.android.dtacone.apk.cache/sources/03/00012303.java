...
/* renamed from: th.co.dtac.android.dtacone.presenter.dtacAtHome.CheckMapPresenter$checkDtacAtHomeValidateLocation$3 */
/* loaded from: classes8.dex */
public final class CheckMapPresenter$checkDtacAtHomeValidateLocation$3 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ CheckMapPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CheckMapPresenter$checkDtacAtHomeValidateLocation$3(CheckMapPresenter checkMapPresenter) {
        super(1);
    ...
    public final void invoke2(Throwable th2) {
        ...
        errorService.handleException(th2, new ServerErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.presenter.dtacAtHome.CheckMapPresenter$checkDtacAtHomeValidateLocation$3.1
            ...
            public void handle(@Nullable Throwable th3) {
                ...
                view.onCheckDtacAtHomeValidateFailed(errorCollection);
            }
