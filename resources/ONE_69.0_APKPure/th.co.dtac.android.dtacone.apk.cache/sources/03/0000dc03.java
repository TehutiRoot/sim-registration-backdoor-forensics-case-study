...
@Metadata(m29143d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u001a \u0010\u0000\u001a\n\u0012\u0004\u0012\u0002H\u0002\u0018\u00010\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u0003H\u0007¨\u0006\u0004"}, m29142d2 = {"reflect", "Lkotlin/reflect/KFunction;", "R", "Lkotlin/Function;", "kotlin-reflection"}, m29141k = 2, m29140mv = {1, 8, 0}, m29138xi = 48)
...
public final class ReflectLambdaKt {
    ...
    public static final <R> KFunction<R> reflect(@NotNull Function<? extends R> function) {
        ...
        String[] m29143d1 = metadata.m29143d1();
        if (m29143d1.length == 0) {
            m29143d1 = null;
        }
        if (m29143d1 == null) {
            return null;
        }
        Pair<JvmNameResolver, ProtoBuf.Function> readFunctionDataFrom = JvmProtoBufUtil.readFunctionDataFrom(m29143d1, metadata.m29142d2());
        JvmNameResolver component1 = readFunctionDataFrom.component1();
        ProtoBuf.Function component2 = readFunctionDataFrom.component2();
        int[] m29140mv = metadata.m29140mv();
        if ((metadata.m29138xi() & 8) != 0) {
            z = true;
        } else {
            z = false;
        }
        JvmMetadataVersion jvmMetadataVersion = new JvmMetadataVersion(m29140mv, z);
