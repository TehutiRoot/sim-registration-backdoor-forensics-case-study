...
public class PDAnnotationSquareCircle extends PDAnnotationMarkup {
    ...
    /* renamed from: c */
    public PDAppearanceHandler f60594c;
    ...
    public PDBorderEffectDictionary getBorderEffect() {
        COSDictionary cOSDictionary = (COSDictionary) getCOSObject().getDictionaryObject(COSName.f59767BE);
    ...
    public PDRectangle getRectDifference() {
        COSArray cOSArray = (COSArray) getCOSObject().getDictionaryObject(COSName.f59833RD);
        if (cOSArray != null) {
    ...
    public float[] getRectDifferences() {
        COSBase item = getCOSObject().getItem(COSName.f59833RD);
    ...
    public void setBorderEffect(PDBorderEffectDictionary pDBorderEffectDictionary) {
        getCOSObject().setItem(COSName.f59767BE, pDBorderEffectDictionary);
    }
    ...
    public void setCustomAppearanceHandler(PDAppearanceHandler pDAppearanceHandler) {
        this.f60594c = pDAppearanceHandler;
    }
    ...
    public void setRectDifference(PDRectangle pDRectangle) {
        getCOSObject().setItem(COSName.f59833RD, pDRectangle);
    }
    ...
    public void constructAppearances(PDDocument pDDocument) {
        PDAppearanceHandler pDAppearanceHandler = this.f60594c;
    ...
    public void setRectDifferences(float f, float f2, float f3, float f4) {
        ...
        getCOSObject().setItem(COSName.f59833RD, (COSBase) cOSArray);
    }
