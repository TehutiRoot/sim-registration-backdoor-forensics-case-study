...
@SourceDebugExtension({"SMAP\nESimViewModel.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ESimViewModel.kt\nth/co/dtac/android/dtacone/viewmodel/esim/ESimViewModel$checkSimStock$6\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,3149:1\n1855#2,2:3150\n*S KotlinDebug\n*F\n+ 1 ESimViewModel.kt\nth/co/dtac/android/dtacone/viewmodel/esim/ESimViewModel$checkSimStock$6\n*L\n2793#1:3150,2\n*E\n"})
/* renamed from: th.co.dtac.android.dtacone.viewmodel.esim.ESimViewModel$checkSimStock$6 */
/* loaded from: classes9.dex */
public final class ESimViewModel$checkSimStock$6 extends Lambda implements Function1<SimTermSukCheckSimStockResponse, Unit> {
    final /* synthetic */ ESimViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimViewModel$checkSimStock$6(ESimViewModel eSimViewModel) {
        super(1);
    ...
    public final void invoke2(SimTermSukCheckSimStockResponse simTermSukCheckSimStockResponse) {
        ...
        eSimRepository.setCheckSimStockResponsePhysical(simTermSukCheckSimStockResponse);
        eSimRepository2 = this.this$0.f105820b;
        Integer lineAmount = simTermSukCheckSimStockResponse.getLineAmount();
        eSimRepository2.setTotalAmountPhysical(lineAmount != null ? lineAmount.intValue() : 0);
        ...
        if (discount != null) {
            ...
            for (DiscountItem discountItem : discount) {
                ...
                int totalAmountPhysical = eSimRepository3.getTotalAmountPhysical();
                Integer lineAmount2 = discountItem.getLineAmount();
                eSimRepository3.setTotalAmountPhysical(totalAmountPhysical - (lineAmount2 != null ? lineAmount2.intValue() : 0));
            }
        }
        m2681y0 = this.this$0.m2681y0();
        m2681y0.postValue(Resource.Companion.success("onNext"));
