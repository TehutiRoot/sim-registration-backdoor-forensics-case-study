...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.buyDol.viewModel.OneBuyDolViewModel$requestOneBuyDolOTPAgain$3 */
/* loaded from: classes10.dex */
public final class OneBuyDolViewModel$requestOneBuyDolOTPAgain$3 extends Lambda implements Function1<RequestOtpResponse, Unit> {
    final /* synthetic */ RequestOtpBody $requestOtpBody;
    final /* synthetic */ OneBuyDolViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneBuyDolViewModel$requestOneBuyDolOTPAgain$3(RequestOtpBody requestOtpBody, OneBuyDolViewModel oneBuyDolViewModel) {
        super(1);
    ...
    public final void invoke2(RequestOtpResponse requestOtpResponse) {
        MutableLiveData m15880d0;
        String mobileNumber = this.$requestOtpBody.getMobileNumber();
        if (mobileNumber == null) {
            mobileNumber = "";
        }
        m15880d0 = this.this$0.m15880d0();
        m15880d0.setValue(Resource.Companion.success(new Pair(requestOtpResponse, mobileNumber)));
    }
}