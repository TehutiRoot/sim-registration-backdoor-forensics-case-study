...
public class C9702qy {
    ...
    public static byte[] get(BigInteger bigInteger) {
        if (bigInteger.signum() >= 0) {
            ...
            return (bigInteger.bitLength() % 8 == 0 && byteArray[0] == 0 && byteArray.length > 1) ? C9714rj.values(byteArray, 1, byteArray.length - 1) : byteArray;
        }
    ...
    public static String valueOf(BigInteger bigInteger, int i) {
        return new C9662oq().ThreeDS2Service(ThreeDS2Service(bigInteger, i));
    }
}