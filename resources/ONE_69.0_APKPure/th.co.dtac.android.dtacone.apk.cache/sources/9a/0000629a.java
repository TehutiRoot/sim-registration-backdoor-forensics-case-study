...
public final class NodeKindKt {
    /* renamed from: a */
    public static final void m59343a(Modifier.Node node, int i, int i2) {
        if (i2 == 0 && !node.getShouldAutoInvalidate()) {
            return;
        }
        if ((NodeKind.m73145constructorimpl(2) & i) != 0 && (node instanceof LayoutModifierNode)) {
            LayoutModifierNodeKt.invalidateMeasurement((LayoutModifierNode) node);
            if (i2 == 2) {
                DelegatableNodeKt.m73078requireCoordinator64DMado(node, NodeKind.m73145constructorimpl(2)).onRelease();
            }
        }
        if ((NodeKind.m73145constructorimpl(256) & i) != 0 && (node instanceof GlobalPositionAwareModifierNode)) {
            DelegatableNodeKt.requireLayoutNode(node).invalidateMeasurements$ui_release();
        }
        if ((NodeKind.m73145constructorimpl(4) & i) != 0 && (node instanceof DrawModifierNode)) {
            DrawModifierNodeKt.invalidateDraw((DrawModifierNode) node);
        }
        if ((NodeKind.m73145constructorimpl(8) & i) != 0 && (node instanceof SemanticsModifierNode)) {
            SemanticsModifierNodeKt.invalidateSemantics((SemanticsModifierNode) node);
        }
        if ((NodeKind.m73145constructorimpl(64) & i) != 0 && (node instanceof ParentDataModifierNode)) {
            ParentDataModifierNodeKt.invalidateParentData((ParentDataModifierNode) node);
        }
        if ((NodeKind.m73145constructorimpl(1024) & i) != 0 && (node instanceof FocusTargetNode)) {
            if (i2 == 2) {
                node.onReset();
            } else {
        ...
        if ((NodeKind.m73145constructorimpl(2048) & i) != 0 && (node instanceof FocusPropertiesModifierNode)) {
            FocusPropertiesModifierNode focusPropertiesModifierNode = (FocusPropertiesModifierNode) node;
            if (m59341c(focusPropertiesModifierNode)) {
                if (i2 == 2) {
                    m59342b(focusPropertiesModifierNode);
                } else {
                    FocusPropertiesModifierNodeKt.invalidateFocusProperties(focusPropertiesModifierNode);
                }
            }
        }
        if ((i & NodeKind.m73145constructorimpl(4096)) != 0 && (node instanceof FocusEventModifierNode)) {
    ...
    public static final void autoInvalidateNodeIncludingDelegates(@NotNull Modifier.Node node, int i, int i2) {
        ...
        if (node instanceof DelegatingNode) {
            ...
            m59343a(node, delegatingNode.getSelfKindSet$ui_release() & i, i2);
        ...
        m59343a(node, i & node.getKindSet$ui_release(), i2);
    }
    ...
    /* renamed from: b */
    public static final void m59342b(FocusPropertiesModifierNode focusPropertiesModifierNode) {
        ...
        if (focusPropertiesModifierNode.getNode().isAttached()) {
            ...
            if (child$ui_release == null) {
                DelegatableNodeKt.m59460a(mutableVector, focusPropertiesModifierNode.getNode());
            } else {
            ...
            while (mutableVector.isNotEmpty()) {
                ...
                if ((node.getAggregateChildKindSet$ui_release() & m73145constructorimpl) == 0) {
                    DelegatableNodeKt.m59460a(mutableVector, node);
                } else {
                    while (true) {
                        if (node == null) {
                            break;
                            ...
                            while (node != null) {
                                ...
                                node = DelegatableNodeKt.m59459b(mutableVector2);
                            }
                        } else {
    ...
    /* renamed from: c */
    public static final boolean m59341c(FocusPropertiesModifierNode focusPropertiesModifierNode) {
        C13112pl c13112pl = C13112pl.f76896a;
        c13112pl.m23772b();
        focusPropertiesModifierNode.applyFocusProperties(c13112pl);
        return c13112pl.m23773a();
    }
    ...
    public static final int calculateNodeKindSetFrom(@NotNull Modifier.Node node) {
        ...
        int m73145constructorimpl = NodeKind.m73145constructorimpl(1);
        if (node instanceof LayoutModifierNode) {
            m73145constructorimpl |= NodeKind.m73145constructorimpl(2);
        }
        if (node instanceof DrawModifierNode) {
            m73145constructorimpl |= NodeKind.m73145constructorimpl(4);
        }
        if (node instanceof SemanticsModifierNode) {
            m73145constructorimpl |= NodeKind.m73145constructorimpl(8);
        }
        if (node instanceof PointerInputModifierNode) {
            m73145constructorimpl |= NodeKind.m73145constructorimpl(16);
        }
        if (node instanceof ModifierLocalModifierNode) {
            m73145constructorimpl |= NodeKind.m73145constructorimpl(32);
        }
        if (node instanceof ParentDataModifierNode) {
            m73145constructorimpl |= NodeKind.m73145constructorimpl(64);
        }
        if (node instanceof LayoutAwareModifierNode) {
            m73145constructorimpl |= NodeKind.m73145constructorimpl(128);
        }
        if (node instanceof GlobalPositionAwareModifierNode) {
            m73145constructorimpl |= NodeKind.m73145constructorimpl(256);
        }
        if (node instanceof IntermediateLayoutModifierNode) {
            m73145constructorimpl |= NodeKind.m73145constructorimpl(512);
        }
        if (node instanceof FocusTargetNode) {
            m73145constructorimpl |= NodeKind.m73145constructorimpl(1024);
        }
        if (node instanceof FocusPropertiesModifierNode) {
            m73145constructorimpl |= NodeKind.m73145constructorimpl(2048);
        }
        if (node instanceof FocusEventModifierNode) {
            m73145constructorimpl |= NodeKind.m73145constructorimpl(4096);
        }
        if (node instanceof KeyInputModifierNode) {
            m73145constructorimpl |= NodeKind.m73145constructorimpl(8192);
        }
        if (node instanceof RotaryInputModifierNode) {
            m73145constructorimpl |= NodeKind.m73145constructorimpl(16384);
        }
        if (node instanceof CompositionLocalConsumerModifierNode) {
            m73145constructorimpl |= NodeKind.m73145constructorimpl(32768);
        }
        return node instanceof SoftKeyboardInterceptionModifierNode ? m73145constructorimpl | NodeKind.m73145constructorimpl(131072) : m73145constructorimpl;
    }
    ...
    public static final boolean m73153contains64DMado(int i, int i2) {
        return (i & i2) != 0;
    }

    /* renamed from: getIncludeSelfInTraversal-H91voCI  reason: not valid java name */
    public static final boolean m73154getIncludeSelfInTraversalH91voCI(int i) {
        if ((i & NodeKind.m73145constructorimpl(128)) != 0) {
            return true;
        }
        return false;
    }
    ...
    public static final int m73155or64DMado(int i, int i2) {
        return i | i2;
    }
    ...
    public static final int calculateNodeKindSetFrom(@NotNull Modifier.Element element) {
        ...
        return ((element instanceof OnPlacedModifier) || (element instanceof OnRemeasuredModifier)) ? m73145constructorimpl | NodeKind.m73145constructorimpl(128) : m73145constructorimpl;
    }
}