...
public final class C17663Fu1 {

    /* renamed from: a */
    public static final C17663Fu1 f1808a = new C17663Fu1();

    /* renamed from: a */
    public final ClassLiteralValue m68374a(Class cls) {
        int i = 0;
        while (cls.isArray()) {
            i++;
    ...
    /* renamed from: b */
    public final void m68373b(Class klass, KotlinJvmBinaryClass.AnnotationVisitor visitor) {
        ...
        for (Annotation annotation : declaredAnnotations) {
            ...
            m68369f(visitor, annotation);
        }
        visitor.visitEnd();
    }

    /* renamed from: c */
    public final void m68372c(Class cls, KotlinJvmBinaryClass.MemberVisitor memberVisitor) {
        boolean z;
        ...
        while (i2 < length) {
            ...
            KotlinJvmBinaryClass.MethodAnnotationVisitor visitMethod = memberVisitor.visitMethod(name, rj1.m66668a(constructor));
            if (visitMethod == null) {
                ...
                for (Annotation annotation : declaredAnnotations) {
                    Intrinsics.checkNotNullExpressionValue(annotation, "annotation");
                    m68369f(visitMethod, annotation);
                }
                    ...
                    for (int i3 = 0; i3 < length3; i3++) {
                        ...
                        while (i4 < length4) {
                            ...
                            if (visitParameterAnnotation != null) {
                                f1808a.m68367h(visitParameterAnnotation, annotation2, javaClass);
                            }
                            i4++;
    ...
    /* renamed from: d */
    public final void m68371d(Class cls, KotlinJvmBinaryClass.MemberVisitor memberVisitor) {
        ...
        for (Field field : declaredFields) {
            ...
            KotlinJvmBinaryClass.AnnotationVisitor visitField = memberVisitor.visitField(identifier, rj1.m66667b(field), null);
            if (visitField != null) {
                Annotation[] declaredAnnotations = field.getDeclaredAnnotations();
                Intrinsics.checkNotNullExpressionValue(declaredAnnotations, "field.declaredAnnotations");
                for (Annotation annotation : declaredAnnotations) {
                    Intrinsics.checkNotNullExpressionValue(annotation, "annotation");
                    m68369f(visitField, annotation);
                }
                visitField.visitEnd();
            }
        }
    ...
    /* renamed from: e */
    public final void m68370e(Class cls, KotlinJvmBinaryClass.MemberVisitor memberVisitor) {
        Method[] methodArr;
        ...
        while (i < length) {
            ...
            KotlinJvmBinaryClass.MethodAnnotationVisitor visitMethod = memberVisitor.visitMethod(identifier, rj1.m66666c(method));
            if (visitMethod == null) {
    ...
    /* renamed from: f */
    public final void m68369f(KotlinJvmBinaryClass.AnnotationVisitor annotationVisitor, Annotation annotation) {
        ...
        if (visitAnnotation != null) {
            f1808a.m68367h(visitAnnotation, annotation, javaClass);
        }
    }

    /* renamed from: g */
    public final void m68368g(KotlinJvmBinaryClass.AnnotationArgumentVisitor annotationArgumentVisitor, Name name, Object obj) {
        Set set;
        Class<?> cls = obj.getClass();
        if (!Intrinsics.areEqual(cls, Class.class)) {
            set = ReflectKotlinClassKt.f68912a;
            if (set.contains(cls)) {
                ...
                m68367h(visitAnnotation, (Annotation) obj, annotationClass);
                return;
            } else if (cls.isArray()) {
                ...
                if (componentType.isEnum()) {
                    ...
                    while (i < length2) {
                        ...
                        visitArray.visitClassLiteral(m68374a((Class) obj3));
                        i++;
                    }
                    ...
                    while (i < length3) {
                        ...
                        if (visitAnnotation2 != null) {
                            ...
                            m68367h(visitAnnotation2, (Annotation) obj4, componentType);
                        }
                        i++;
                    }
                } else {
        ...
        annotationArgumentVisitor.visitClassLiteral(name, m68374a((Class) obj));
    }

    /* renamed from: h */
    public final void m68367h(KotlinJvmBinaryClass.AnnotationArgumentVisitor annotationArgumentVisitor, Annotation annotation, Class cls) {
        Method[] declaredMethods = cls.getDeclaredMethods();
        ...
        for (Method method : declaredMethods) {
            try {
                ...
                Name identifier = Name.identifier(method.getName());
                Intrinsics.checkNotNullExpressionValue(identifier, "identifier(method.name)");
                m68368g(annotationArgumentVisitor, identifier, invoke);
    ...
    /* renamed from: i */
    public final void m68366i(Class klass, KotlinJvmBinaryClass.MemberVisitor memberVisitor) {
        Intrinsics.checkNotNullParameter(klass, "klass");
        Intrinsics.checkNotNullParameter(memberVisitor, "memberVisitor");
        m68370e(klass, memberVisitor);
        m68372c(klass, memberVisitor);
        m68371d(klass, memberVisitor);
    }
}