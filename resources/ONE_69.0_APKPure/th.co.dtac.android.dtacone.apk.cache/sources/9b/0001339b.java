...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.viewModel.OneMnpViewModel$oneMnpSaveOrder$1$1 */
/* loaded from: classes10.dex */
public final class OneMnpViewModel$oneMnpSaveOrder$1$1 extends Lambda implements Function1<Disposable, Unit> {
    final /* synthetic */ OneMnpViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneMnpViewModel$oneMnpSaveOrder$1$1(OneMnpViewModel oneMnpViewModel) {
        super(1);
    ...
    public final void invoke2(Disposable disposable) {
        ...
        mutableStateFlow.setValue(OneMnpSaveOrderState.Loading.INSTANCE);
    }
}