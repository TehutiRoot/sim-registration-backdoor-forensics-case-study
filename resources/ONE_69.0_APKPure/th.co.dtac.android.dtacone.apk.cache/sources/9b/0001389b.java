...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.viewmodel.OnePostpaidPackagesViewModel$getAllPackageGroupBranded$2 */
/* loaded from: classes10.dex */
final class OnePostpaidPackagesViewModel$getAllPackageGroupBranded$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ OnePostpaidPackagesViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidPackagesViewModel$getAllPackageGroupBranded$2(OnePostpaidPackagesViewModel onePostpaidPackagesViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable it) {
        ...
        oneErrorService.handleException(it, new OneErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.viewmodel.OnePostpaidPackagesViewModel$getAllPackageGroupBranded$2.1
