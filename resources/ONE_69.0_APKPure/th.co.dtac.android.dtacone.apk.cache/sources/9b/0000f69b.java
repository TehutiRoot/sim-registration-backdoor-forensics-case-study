...
public class GOST3412_2015Engine implements BlockCipher {
    ...
    /* renamed from: C */
    private void m24667C(byte[] bArr, int i) {
        Arrays.clear(bArr);
        bArr[15] = (byte) i;
        m24665L(bArr);
    }
    ...
    /* renamed from: F */
    private void m24666F(byte[] bArr, byte[] bArr2, byte[] bArr3) {
    ...
    private void GOST3412_2015Func(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        if (this.forEncryption) {
            ...
            m24662X(bArr4, bArr3[0]);
        }
        System.arraycopy(bArr4, 0, bArr2, i2, 16);
    }

    /* renamed from: L */
    private void m24665L(byte[] bArr) {
        for (int i = 0; i < 16; i++) {
            m24664R(bArr);
        }
    }
    ...
    /* renamed from: R */
    private void m24664R(byte[] bArr) {
        byte m24661l = m24661l(bArr);
        System.arraycopy(bArr, 0, bArr, 1, 15);
        bArr[0] = m24661l;
    }

    /* renamed from: S */
    private void m24663S(byte[] bArr) {
        for (int i = 0; i < bArr.length; i++) {
            bArr[i] = f75088PI[unsignedByte(bArr[i])];
        }
    }

    /* renamed from: X */
    private void m24662X(byte[] bArr, byte[] bArr2) {
        for (int i = 0; i < bArr.length; i++) {
    ...
    private void generateSubKeys(byte[] bArr) {
        ...
        for (int i5 = 1; i5 < 5; i5++) {
            for (int i6 = 1; i6 <= 8; i6++) {
                m24667C(bArr7, ((i5 - 1) * 8) + i6);
                m24666F(bArr7, bArr2, bArr3);
            }
            int i7 = i5 * 2;
    ...
    /* renamed from: l */
    private byte m24661l(byte[] bArr) {
        byte b = bArr[15];
        for (int i = 14; i >= 0; i--) {
