...
public final class SurfaceCombination {
    ...
    /* renamed from: a */
    public final List f11298a = new ArrayList();

    /* renamed from: a */
    public static void m62854a(List list, int i, int[] iArr, int i2) {
        if (i2 >= iArr.length) {
    ...
    public boolean addSurfaceConfig(@NonNull SurfaceConfig surfaceConfig) {
        return this.f11298a.add(surfaceConfig);
    }

    /* renamed from: b */
    public final List m62853b(int i) {
        ArrayList arrayList = new ArrayList();
        m62854a(arrayList, i, new int[i], 0);
        return arrayList;
    }
    ...
    */
    public java.util.List<androidx.camera.core.impl.SurfaceConfig> getOrderedSupportedSurfaceConfigList(@androidx.annotation.NonNull java.util.List<androidx.camera.core.impl.SurfaceConfig> r10) {
        ...
        Lc:
            int r0 = r10.size()
            java.util.List r1 = r9.f11298a
            int r1 = r1.size()
            r2 = 0
            if (r0 == r1) goto L1a
            return r2
        L1a:
            java.util.List r0 = r9.f11298a
            int r0 = r0.size()
            java.util.List r0 = r9.m62853b(r0)
            int r1 = r10.size()
    ...
    public boolean removeSurfaceConfig(@NonNull SurfaceConfig surfaceConfig) {
        return this.f11298a.remove(surfaceConfig);
    }
}