...
public class WildcardFilter extends AbstractFileFilter implements Serializable {
    ...
    /* renamed from: a */
    public static /* synthetic */ boolean m25429a(Path path, String str) {
        return lambda$accept$2(path, str);
    }

    /* renamed from: b */
    public static /* synthetic */ boolean m25428b(String str, String str2) {
        return FilenameUtils.wildcardMatch(str, str2);
    }

    /* renamed from: c */
    public static /* synthetic */ boolean m25427c(File file, String str) {
    ...
    public boolean accept(final File file) {
        ...
        anyMatch = of.anyMatch(new Predicate() { // from class: U42
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return WildcardFilter.m25427c(file, (String) obj);
            }
        });
        return anyMatch;
    }
    ...
    public boolean accept(File file, final String str) {
        ...
        if (file == null || !new File(file, str).isDirectory()) {
            of = Stream.of((Object[]) this.wildcards);
            anyMatch = of.anyMatch(new Predicate() { // from class: V42
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                    return WildcardFilter.m25428b(str, (String) obj);
                }
            });
            return anyMatch;
        }
    ...
    public FileVisitResult accept(final Path path, BasicFileAttributes basicFileAttributes) {
        ...
        of = Stream.of((Object[]) this.wildcards);
        anyMatch = of.anyMatch(new Predicate() { // from class: W42
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return WildcardFilter.m25429a(path, (String) obj);
            }
        });
