...
/* renamed from: th.co.dtac.android.dtacone.presenter.stv.StvPhoenixListPresenter$calculateStvMatrix$columnHeader$1 */
/* loaded from: classes8.dex */
public final class StvPhoenixListPresenter$calculateStvMatrix$columnHeader$1 extends Lambda implements Function1<StvPackageCollection, PackageKey<Integer, String>> {
    public static final StvPhoenixListPresenter$calculateStvMatrix$columnHeader$1 INSTANCE = new StvPhoenixListPresenter$calculateStvMatrix$columnHeader$1();

    public StvPhoenixListPresenter$calculateStvMatrix$columnHeader$1() {
        super(1);
    }
