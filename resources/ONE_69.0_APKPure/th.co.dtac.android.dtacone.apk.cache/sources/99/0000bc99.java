...
public class C9492jg implements setSubtitleTextColor<setCustomSelectionActionModeCallback, C9640nr> {
    ...
    public /* synthetic */ setCustomSelectionActionModeCallback valueOf(C9640nr c9640nr) {
        ...
        if (i % 2 != 0) {
            return values(c9640nr2);
        }
        values(c9640nr2);
        throw null;
    }

    public setCustomSelectionActionModeCallback values(C9640nr c9640nr) {
        ...
        String values = c9640nr.values(((String) objArr2[0]).intern());
        ...
        String values2 = c9640nr.values(((String) objArr3[0]).intern());
        ...
        String values3 = c9640nr.values(((String) objArr4[0]).intern());
        ...
        if (((String) objArr5[0]).intern().equalsIgnoreCase(values2)) {
            ...
            if (C9658om.ThreeDS2ServiceInstance(values)) {
                C9640nr c9640nr2 = C9640nr.get(values);
                setTitleMarginEnd.ThreeDS2Service threeDS2Service = setTitleMarginEnd.ThreeDS2Service.get(c9640nr2.values(wait.values.cleanup));
                if (!threeDS2Service.equals(setTitleMarginEnd.ThreeDS2Service.ThreeDS2Service)) {
                    if (threeDS2Service.equals(this.ThreeDS2ServiceInstance)) {
                        ...
                        C9640nr sDKVersion = c9640nr2.getSDKVersion(((String) objArr6[0]).intern());
    ...
    */
    private static void ThreeDS2ServiceInstance(int r6, int r7, java.lang.String r8, int r9, boolean r10, java.lang.Object[] r11) {
        ...
        L10:
            ...
            int r5 = com.netcetera.threeds.sdk.infrastructure.C9492jg.get     // Catch: java.lang.Throwable -> L2f
            int r4 = r4 - r5
            char r4 = (char) r4     // Catch: java.lang.Throwable -> L2f
            r1[r3] = r4     // Catch: java.lang.Throwable -> L2f
            int r3 = r3 + 1
        ...
        L69:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.netcetera.threeds.sdk.infrastructure.C9492jg.ThreeDS2ServiceInstance(int, int, java.lang.String, int, boolean, java.lang.Object[]):void");
    }
}