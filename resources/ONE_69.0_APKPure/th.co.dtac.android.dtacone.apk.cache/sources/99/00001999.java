...
public interface IPostMessageService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPostMessageService {
        ...
        /* loaded from: classes.dex */
        public static class C1903a implements IPostMessageService {

            /* renamed from: a */
            public IBinder f8527a;
            ...
            public void onMessageChannelReady(ICustomTabsCallback iCustomTabsCallback, Bundle bundle) {
                ...
                try {
                    ...
                    _Parcel.m64979d(obtain, bundle, 0);
                    this.f8527a.transact(2, obtain, obtain2, 0);
            ...
            public void onPostMessage(ICustomTabsCallback iCustomTabsCallback, String str, Bundle bundle) {
                ...
                try {
                    ...
                    _Parcel.m64979d(obtain, bundle, 0);
                    this.f8527a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i != 2) {
                ...
                onPostMessage(ICustomTabsCallback.Stub.asInterface(parcel.readStrongBinder()), parcel.readString(), (Bundle) _Parcel.m64980c(parcel, Bundle.CREATOR));
                parcel2.writeNoException();
            } else {
                onMessageChannelReady(ICustomTabsCallback.Stub.asInterface(parcel.readStrongBinder()), (Bundle) _Parcel.m64980c(parcel, Bundle.CREATOR));
                parcel2.writeNoException();
            }
            return true;
        }
    ...
    public static class _Parcel {
        /* renamed from: c */
        public static Object m64980c(Parcel parcel, Parcelable.Creator creator) {
            if (parcel.readInt() != 0) {
        ...
        /* renamed from: d */
        public static void m64979d(Parcel parcel, Parcelable parcelable, int i) {
            if (parcelable != null) {
                parcel.writeInt(1);
