...
public final class ImageLoaderOptions {
    ...
    /* renamed from: e */
    public final ExifOrientationPolicy f40879e;
    ...
    public static /* synthetic */ ImageLoaderOptions copy$default(ImageLoaderOptions imageLoaderOptions, boolean z, boolean z2, boolean z3, int i, ExifOrientationPolicy exifOrientationPolicy, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            z = imageLoaderOptions.f40875a;
        }
        if ((i2 & 2) != 0) {
            z2 = imageLoaderOptions.f40876b;
        }
        boolean z4 = z2;
        if ((i2 & 4) != 0) {
            z3 = imageLoaderOptions.f40877c;
        }
        boolean z5 = z3;
        if ((i2 & 8) != 0) {
            i = imageLoaderOptions.f40878d;
        }
        int i3 = i;
        if ((i2 & 16) != 0) {
            exifOrientationPolicy = imageLoaderOptions.f40879e;
        }
    ...
    public ImageLoaderOptions(boolean z, boolean z2, boolean z3, int i, @NotNull ExifOrientationPolicy exifOrientationPolicy) {
        ...
        this.f40877c = z3;
        this.f40878d = i;
        this.f40879e = exifOrientationPolicy;
    }
