...
public final class ObservableSwitchMap<T, R> extends AbstractC11078a {

    /* renamed from: a */
    public final Function f65627a;
        ...
        */
        ...
        public void onNext(T t) {
            ...
            try {
                ...
                } while (!AbstractC23094xo1.m479a(this.active, switchMapInnerObserver, switchMapInnerObserver3));
    ...
    public void subscribeActual(Observer<? super R> observer) {
        if (ObservableScalarXMap.tryScalarXMapSubscribe(this.source, observer, this.f65627a)) {
            return;
        }
        this.source.subscribe(new SwitchMapObserver(observer, this.f65627a, this.f65628b, this.f65629c));
    }
}