...
/* renamed from: th.co.dtac.android.dtacone.presenter.address.QueryAddressPresenter$getAddressFilter$2 */
/* loaded from: classes8.dex */
public final class QueryAddressPresenter$getAddressFilter$2 extends Lambda implements Function1<List<? extends AddressItemData>, Unit> {
    final /* synthetic */ QueryAddressPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public QueryAddressPresenter$getAddressFilter$2(QueryAddressPresenter queryAddressPresenter) {
        super(1);
