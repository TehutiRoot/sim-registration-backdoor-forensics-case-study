...
public final class AppBarKt$TwoRowsTopAppBar$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        int i3 = i2 << 3;
        AppBarKt.m60650c(ClipKt.clipToBounds(WindowInsetsPaddingKt.windowInsetsPadding(companion, windowInsets)), floatRef.element, topAppBarColors.m70994getNavigationIconContentColor0d7_KjU$material3_release(), topAppBarColors.m70995getTitleContentColor0d7_KjU$material3_release(), topAppBarColors.m70993getActionIconContentColor0d7_KjU$material3_release(), function2, textStyle, f, arrangement.getCenter(), arrangement.getStart(), 0, z, function22, function23, composer, (i3 & 458752) | 905969664 | (i3 & 3670016), ((i2 >> 12) & 896) | 3078);
        Modifier clipToBounds = ClipKt.clipToBounds(WindowInsetsPaddingKt.windowInsetsPadding(companion, WindowInsetsKt.m69759onlybOOhFvg(windowInsets, WindowInsetsSides.Companion.m69774getHorizontalJoeWqyM())));
        ...
        long m70994getNavigationIconContentColor0d7_KjU$material3_release = topAppBarColors.m70994getNavigationIconContentColor0d7_KjU$material3_release();
        long m70995getTitleContentColor0d7_KjU$material3_release = topAppBarColors.m70995getTitleContentColor0d7_KjU$material3_release();
        long m70993getActionIconContentColor0d7_KjU$material3_release = topAppBarColors.m70993getActionIconContentColor0d7_KjU$material3_release();
        Arrangement.Vertical bottom = arrangement.getBottom();
        Arrangement.Horizontal start = arrangement.getStart();
        int i4 = intRef.element;
        ComposableSingletons$AppBarKt composableSingletons$AppBarKt = ComposableSingletons$AppBarKt.INSTANCE;
        Function2<Composer, Integer, Unit> m70488getLambda11$material3_release = composableSingletons$AppBarKt.m70488getLambda11$material3_release();
        Function2<Composer, Integer, Unit> m70489getLambda12$material3_release = composableSingletons$AppBarKt.m70489getLambda12$material3_release();
        int i5 = i2 << 12;
        AppBarKt.m60650c(clipToBounds, heightOffset, m70994getNavigationIconContentColor0d7_KjU$material3_release, m70995getTitleContentColor0d7_KjU$material3_release, m70993getActionIconContentColor0d7_KjU$material3_release, function24, textStyle2, f2, bottom, start, i4, z2, m70488getLambda11$material3_release, m70489getLambda12$material3_release, composer, (i5 & 458752) | 905969664 | (i5 & 3670016), 3456);
