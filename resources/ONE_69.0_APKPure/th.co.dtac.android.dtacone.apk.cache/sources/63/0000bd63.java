...
public class C9669ow extends ArrayList implements InterfaceC9667ou, InterfaceC9668ov {
    ...
    @Override // com.netcetera.threeds.sdk.infrastructure.InterfaceC9668ov
    ...
    @Override // com.netcetera.threeds.sdk.infrastructure.InterfaceC9667ou
    ...
    public static void ThreeDS2Service(Object[] objArr, Writer writer) throws IOException {
        if (objArr == null) {
            ...
            writer.write("[");
            C9670ox.values(objArr[0], writer);
            for (int i = 1; i < objArr.length; i++) {
                writer.write(",");
                C9670ox.values(objArr[i], writer);
            }
            writer.write("]");
        }
    }
    ...
    public static void values(char[] cArr, Writer writer) throws IOException {
        if (cArr == null) {
            ...
            writer.write("[\"");
            writer.write(C9670ox.get(String.valueOf(cArr[0])));
            for (int i = 1; i < cArr.length; i++) {
                writer.write("\",\"");
                writer.write(C9670ox.get(String.valueOf(cArr[i])));
            }
            writer.write("\"]");
        }
    }
