...
public final class Camera2Config {
    ...
    /* renamed from: a */
    public static /* synthetic */ UseCaseConfigFactory m63931a(Context context) {
        return m63928d(context);
    }

    /* renamed from: b */
    public static /* synthetic */ CameraDeviceSurfaceManager m63930b(Context context, Object obj, Set set) {
        return m63929c(context, obj, set);
    }

    /* renamed from: c */
    public static /* synthetic */ CameraDeviceSurfaceManager m63929c(Context context, Object obj, Set set) {
        try {
    ...
    /* renamed from: d */
    public static /* synthetic */ UseCaseConfigFactory m63928d(Context context) {
    ...
    public static CameraXConfig defaultConfig() {
        ...
        CameraDeviceSurfaceManager.Provider provider2 = new CameraDeviceSurfaceManager.Provider() { // from class: Ii
            ...
            public final CameraDeviceSurfaceManager newInstance(Context context, Object obj, Set set) {
                return Camera2Config.m63930b(context, obj, set);
            }
        };
        return new CameraXConfig.Builder().setCameraFactoryProvider(provider).setDeviceSurfaceManagerProvider(provider2).setUseCaseConfigFactoryProvider(new UseCaseConfigFactory.Provider() { // from class: Ji
            ...
            public final UseCaseConfigFactory newInstance(Context context) {
                return Camera2Config.m63931a(context);
            }
        }).build();
    }
}