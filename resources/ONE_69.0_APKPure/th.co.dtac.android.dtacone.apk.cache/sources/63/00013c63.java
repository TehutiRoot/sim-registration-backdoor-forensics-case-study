...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.prepaid_registration.fragment.OneScanBarcodeSimFragment$activity$2 */
/* loaded from: classes10.dex */
public final class OneScanBarcodeSimFragment$activity$2 extends Lambda implements Function0<OnePrepaidRegistrationActivity> {
    final /* synthetic */ OneScanBarcodeSimFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneScanBarcodeSimFragment$activity$2(OneScanBarcodeSimFragment oneScanBarcodeSimFragment) {
        super(0);
