...
public final class Distribution extends GeneratedMessageLite<Distribution, Builder> implements DistributionOrBuilder {
    ...
    public static final class BucketOptions extends GeneratedMessageLite<BucketOptions, Builder> implements BucketOptionsOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<BucketOptions, Builder> implements BucketOptionsOrBuilder {
            public /* synthetic */ Builder(C7195a c7195a) {
                this();
            }

            public Builder clearExplicitBuckets() {
                copyOnWrite();
                ((BucketOptions) this.instance).m43002M();
                return this;
            }

            public Builder clearExponentialBuckets() {
                copyOnWrite();
                ((BucketOptions) this.instance).m43001N();
                return this;
            }

            public Builder clearLinearBuckets() {
                copyOnWrite();
                ((BucketOptions) this.instance).m43000O();
                return this;
            }

            public Builder clearOptions() {
                copyOnWrite();
                ((BucketOptions) this.instance).m42999P();
                return this;
            }
            ...
            public Builder mergeExplicitBuckets(Explicit explicit) {
                copyOnWrite();
                ((BucketOptions) this.instance).m42998Q(explicit);
                return this;
            }

            public Builder mergeExponentialBuckets(Exponential exponential) {
                copyOnWrite();
                ((BucketOptions) this.instance).m42997R(exponential);
                return this;
            }

            public Builder mergeLinearBuckets(Linear linear) {
                copyOnWrite();
                ((BucketOptions) this.instance).m42996S(linear);
                return this;
            }

            public Builder setExplicitBuckets(Explicit explicit) {
                copyOnWrite();
                ((BucketOptions) this.instance).m42995T(explicit);
                return this;
            }

            public Builder setExponentialBuckets(Exponential exponential) {
                copyOnWrite();
                ((BucketOptions) this.instance).m42994U(exponential);
                return this;
            }

            public Builder setLinearBuckets(Linear linear) {
                copyOnWrite();
                ((BucketOptions) this.instance).m42993V(linear);
                return this;
            }
            ...
            public Builder setExplicitBuckets(Explicit.Builder builder) {
                copyOnWrite();
                ((BucketOptions) this.instance).m42995T(builder.build());
                return this;
            }

            public Builder setExponentialBuckets(Exponential.Builder builder) {
                copyOnWrite();
                ((BucketOptions) this.instance).m42994U(builder.build());
                return this;
            }

            public Builder setLinearBuckets(Linear.Builder builder) {
                copyOnWrite();
                ((BucketOptions) this.instance).m42993V(builder.build());
                return this;
            }
        }
        ...
        public static final class Explicit extends GeneratedMessageLite<Explicit, Builder> implements ExplicitOrBuilder {
            ...
            public static final class Builder extends GeneratedMessageLite.Builder<Explicit, Builder> implements ExplicitOrBuilder {
                ...
                public Builder addAllBounds(Iterable<? extends Double> iterable) {
                    copyOnWrite();
                    ((Explicit) this.instance).m42987G(iterable);
                    return this;
                }

                public Builder addBounds(double d) {
                    copyOnWrite();
                    ((Explicit) this.instance).m42986H(d);
                    return this;
                }

                public Builder clearBounds() {
                    copyOnWrite();
                    ((Explicit) this.instance).m42985I();
                    return this;
                }
                ...
                public Builder setBounds(int i, double d) {
                    copyOnWrite();
                    ((Explicit) this.instance).m42983K(i, d);
                    return this;
                }
            ...
            /* renamed from: G */
            public final void m42987G(Iterable iterable) {
                m42984J();
                AbstractMessageLite.addAll(iterable, (List) this.bounds_);
            }

            /* renamed from: H */
            public final void m42986H(double d) {
                m42984J();
                this.bounds_.addDouble(d);
            }

            /* renamed from: I */
            public final void m42985I() {
                this.bounds_ = GeneratedMessageLite.emptyDoubleList();
            }

            /* renamed from: J */
            public final void m42984J() {
            ...
            /* renamed from: K */
            public final void m42983K(int i, double d) {
                m42984J();
            ...
            public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
                switch (C7195a.f51625a[methodToInvoke.ordinal()]) {
                    case 1:
                        return new Explicit();
                    case 2:
        ...
        public static final class Exponential extends GeneratedMessageLite<Exponential, Builder> implements ExponentialOrBuilder {
            ...
            public static final class Builder extends GeneratedMessageLite.Builder<Exponential, Builder> implements ExponentialOrBuilder {
                ...
                public Builder clearGrowthFactor() {
                    copyOnWrite();
                    ((Exponential) this.instance).m42975I();
                    return this;
                }

                public Builder clearNumFiniteBuckets() {
                    copyOnWrite();
                    ((Exponential) this.instance).m42974J();
                    return this;
                }

                public Builder clearScale() {
                    copyOnWrite();
                    ((Exponential) this.instance).m42973K();
                    return this;
                }
                ...
                public Builder setGrowthFactor(double d) {
                    copyOnWrite();
                    ((Exponential) this.instance).m42972L(d);
                    return this;
                }

                public Builder setNumFiniteBuckets(int i) {
                    copyOnWrite();
                    ((Exponential) this.instance).m42971M(i);
                    return this;
                }

                public Builder setScale(double d) {
                    copyOnWrite();
                    ((Exponential) this.instance).m42970N(d);
                    return this;
                }
            ...
            /* renamed from: L */
            public final void m42972L(double d) {
                this.growthFactor_ = d;
            }

            /* renamed from: M */
            public final void m42971M(int i) {
        ...
        public static final class Linear extends GeneratedMessageLite<Linear, Builder> implements LinearOrBuilder {
            ...
            public static final class Builder extends GeneratedMessageLite.Builder<Linear, Builder> implements LinearOrBuilder {
                ...
                public Builder clearNumFiniteBuckets() {
                    copyOnWrite();
                    ((Linear) this.instance).m42962I();
                    return this;
                }

                public Builder clearOffset() {
                    copyOnWrite();
                    ((Linear) this.instance).m42961J();
                    return this;
                }

                public Builder clearWidth() {
                    copyOnWrite();
                    ((Linear) this.instance).m42960K();
                    return this;
                }
                ...
                public Builder setNumFiniteBuckets(int i) {
                    copyOnWrite();
                    ((Linear) this.instance).m42959L(i);
                    return this;
                }

                public Builder setOffset(double d) {
                    copyOnWrite();
                    ((Linear) this.instance).m42958M(d);
                    return this;
                }

                public Builder setWidth(double d) {
                    copyOnWrite();
                    ((Linear) this.instance).m42957N(d);
                    return this;
                }
            ...
            /* renamed from: J */
            public final void m42961J() {
                this.offset_ = 0.0d;
            }

            /* renamed from: K */
            public final void m42960K() {
                this.width_ = 0.0d;
            }

            /* renamed from: M */
            public final void m42958M(double d) {
                this.offset_ = d;
            }

            /* renamed from: N */
            public final void m42957N(double d) {
                this.width_ = d;
            }
        ...
        /* renamed from: P */
        public final void m42999P() {
            this.optionsCase_ = 0;
            this.options_ = null;
        }

        /* renamed from: Q */
        public final void m42998Q(Explicit explicit) {
            explicit.getClass();
        ...
        /* renamed from: R */
        public final void m42997R(Exponential exponential) {
        ...
        /* renamed from: S */
        public final void m42996S(Linear linear) {
            linear.getClass();
        ...
        /* renamed from: T */
        public final void m42995T(Explicit explicit) {
            explicit.getClass();
            this.options_ = explicit;
            this.optionsCase_ = 3;
        }
        ...
        /* renamed from: U */
        public final void m42994U(Exponential exponential) {
            exponential.getClass();
            this.options_ = exponential;
            this.optionsCase_ = 2;
        }
        ...
        /* renamed from: V */
        public final void m42993V(Linear linear) {
            linear.getClass();
            this.options_ = linear;
            this.optionsCase_ = 1;
        }
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Distribution, Builder> implements DistributionOrBuilder {
        ...
        public Builder addAllBucketCounts(Iterable<? extends Long> iterable) {
            copyOnWrite();
            ((Distribution) this.instance).m43037Y(iterable);
            return this;
        }

        public Builder addAllExemplars(Iterable<? extends Exemplar> iterable) {
            copyOnWrite();
            ((Distribution) this.instance).m43036Z(iterable);
            return this;
        }

        public Builder addBucketCounts(long j) {
            copyOnWrite();
            ((Distribution) this.instance).m43035a0(j);
            return this;
        }

        public Builder addExemplars(Exemplar exemplar) {
            copyOnWrite();
            ((Distribution) this.instance).m43033c0(exemplar);
            return this;
        }

        public Builder clearBucketCounts() {
            copyOnWrite();
            ((Distribution) this.instance).m43032d0();
            return this;
        }

        public Builder clearBucketOptions() {
            copyOnWrite();
            ((Distribution) this.instance).m43031e0();
            return this;
        }

        public Builder clearCount() {
            copyOnWrite();
            ((Distribution) this.instance).m43030f0();
            return this;
        }

        public Builder clearExemplars() {
            copyOnWrite();
            ((Distribution) this.instance).m43029g0();
            return this;
        }

        public Builder clearMean() {
            copyOnWrite();
            ((Distribution) this.instance).m43028h0();
            return this;
        }

        public Builder clearRange() {
            copyOnWrite();
            ((Distribution) this.instance).m43027i0();
            return this;
        }

        public Builder clearSumOfSquaredDeviation() {
            copyOnWrite();
            ((Distribution) this.instance).m43026j0();
            return this;
        }
        ...
        public Builder mergeBucketOptions(BucketOptions bucketOptions) {
            copyOnWrite();
            ((Distribution) this.instance).m43023m0(bucketOptions);
            return this;
        }

        public Builder mergeRange(Range range) {
            copyOnWrite();
            ((Distribution) this.instance).m43022n0(range);
            return this;
        }

        public Builder removeExemplars(int i) {
            copyOnWrite();
            ((Distribution) this.instance).m43021o0(i);
            return this;
        }

        public Builder setBucketCounts(int i, long j) {
            copyOnWrite();
            ((Distribution) this.instance).m43020p0(i, j);
            return this;
        }

        public Builder setBucketOptions(BucketOptions bucketOptions) {
            copyOnWrite();
            ((Distribution) this.instance).m43019q0(bucketOptions);
            return this;
        }

        public Builder setCount(long j) {
            copyOnWrite();
            ((Distribution) this.instance).m43018r0(j);
            return this;
        }

        public Builder setExemplars(int i, Exemplar exemplar) {
            copyOnWrite();
            ((Distribution) this.instance).m43017s0(i, exemplar);
            return this;
        }

        public Builder setMean(double d) {
            copyOnWrite();
            ((Distribution) this.instance).m43016t0(d);
            return this;
        }

        public Builder setRange(Range range) {
            copyOnWrite();
            ((Distribution) this.instance).m43015u0(range);
            return this;
        }

        public Builder setSumOfSquaredDeviation(double d) {
            copyOnWrite();
            ((Distribution) this.instance).m43014v0(d);
            return this;
        }
        ...
        public Builder addExemplars(int i, Exemplar exemplar) {
            copyOnWrite();
            ((Distribution) this.instance).m43034b0(i, exemplar);
            return this;
        }

        public Builder setBucketOptions(BucketOptions.Builder builder) {
            copyOnWrite();
            ((Distribution) this.instance).m43019q0(builder.build());
            return this;
        }

        public Builder setExemplars(int i, Exemplar.Builder builder) {
            copyOnWrite();
            ((Distribution) this.instance).m43017s0(i, builder.build());
            return this;
        }

        public Builder setRange(Range.Builder builder) {
            copyOnWrite();
            ((Distribution) this.instance).m43015u0(builder.build());
            return this;
        }

        public Builder addExemplars(Exemplar.Builder builder) {
            copyOnWrite();
            ((Distribution) this.instance).m43033c0(builder.build());
            return this;
        }

        public Builder addExemplars(int i, Exemplar.Builder builder) {
            copyOnWrite();
            ((Distribution) this.instance).m43034b0(i, builder.build());
            return this;
        }
    }
    ...
    public static final class Exemplar extends GeneratedMessageLite<Exemplar, Builder> implements ExemplarOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<Exemplar, Builder> implements ExemplarOrBuilder {
            ...
            public Builder addAllAttachments(Iterable<? extends Any> iterable) {
                copyOnWrite();
                ((Exemplar) this.instance).m42944N(iterable);
                return this;
            }

            public Builder addAttachments(Any any) {
                copyOnWrite();
                ((Exemplar) this.instance).m42942P(any);
                return this;
            }

            public Builder clearAttachments() {
                copyOnWrite();
                ((Exemplar) this.instance).m42941Q();
                return this;
            }

            public Builder clearTimestamp() {
                copyOnWrite();
                ((Exemplar) this.instance).m42940R();
                return this;
            }

            public Builder clearValue() {
                copyOnWrite();
                ((Exemplar) this.instance).m42939S();
                return this;
            }
            ...
            public Builder mergeTimestamp(Timestamp timestamp) {
                copyOnWrite();
                ((Exemplar) this.instance).m42937U(timestamp);
                return this;
            }

            public Builder removeAttachments(int i) {
                copyOnWrite();
                ((Exemplar) this.instance).m42936V(i);
                return this;
            }

            public Builder setAttachments(int i, Any any) {
                copyOnWrite();
                ((Exemplar) this.instance).m42935W(i, any);
                return this;
            }

            public Builder setTimestamp(Timestamp timestamp) {
                copyOnWrite();
                ((Exemplar) this.instance).m42934X(timestamp);
                return this;
            }

            public Builder setValue(double d) {
                copyOnWrite();
                ((Exemplar) this.instance).m42933Y(d);
                return this;
            }
            ...
            public Builder addAttachments(int i, Any any) {
                copyOnWrite();
                ((Exemplar) this.instance).m42943O(i, any);
                return this;
            }

            public Builder setAttachments(int i, Any.Builder builder) {
                copyOnWrite();
                ((Exemplar) this.instance).m42935W(i, builder.build());
                return this;
            }

            public Builder setTimestamp(Timestamp.Builder builder) {
                copyOnWrite();
                ((Exemplar) this.instance).m42934X(builder.build());
                return this;
            }

            public Builder addAttachments(Any.Builder builder) {
                copyOnWrite();
                ((Exemplar) this.instance).m42942P(builder.build());
                return this;
            }

            public Builder addAttachments(int i, Any.Builder builder) {
                copyOnWrite();
                ((Exemplar) this.instance).m42943O(i, builder.build());
                return this;
            }
        }
        ...
        /* renamed from: N */
        public final void m42944N(Iterable iterable) {
            m42938T();
            AbstractMessageLite.addAll(iterable, (List) this.attachments_);
        }

        /* renamed from: O */
        public final void m42943O(int i, Any any) {
            any.getClass();
            m42938T();
        ...
        /* renamed from: P */
        public final void m42942P(Any any) {
            any.getClass();
            m42938T();
        ...
        /* renamed from: Q */
        public final void m42941Q() {
            this.attachments_ = GeneratedMessageLite.emptyProtobufList();
        }

        /* renamed from: R */
        public final void m42940R() {
            this.timestamp_ = null;
        }

        /* renamed from: S */
        public final void m42939S() {
            this.value_ = 0.0d;
        }

        /* renamed from: T */
        public final void m42938T() {
        ...
        /* renamed from: U */
        public final void m42937U(Timestamp timestamp) {
            timestamp.getClass();
        ...
        /* renamed from: V */
        public final void m42936V(int i) {
            m42938T();
            this.attachments_.remove(i);
        }

        /* renamed from: W */
        public final void m42935W(int i, Any any) {
            any.getClass();
            m42938T();
        ...
        /* renamed from: X */
        public final void m42934X(Timestamp timestamp) {
            timestamp.getClass();
            this.timestamp_ = timestamp;
        }

        /* renamed from: Y */
        public final void m42933Y(double d) {
            this.value_ = d;
        }
    ...
    public static final class Range extends GeneratedMessageLite<Range, Builder> implements RangeOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<Range, Builder> implements RangeOrBuilder {
            ...
            public Builder clearMax() {
                copyOnWrite();
                ((Range) this.instance).m42927G();
                return this;
            }

            public Builder clearMin() {
                copyOnWrite();
                ((Range) this.instance).m42926H();
                return this;
            }
            ...
            public Builder setMax(double d) {
                copyOnWrite();
                ((Range) this.instance).m42925I(d);
                return this;
            }

            public Builder setMin(double d) {
                copyOnWrite();
                ((Range) this.instance).m42924J(d);
                return this;
            }
        ...
        /* renamed from: G */
        public final void m42927G() {
            this.max_ = 0.0d;
        }

        /* renamed from: H */
        public final void m42926H() {
            this.min_ = 0.0d;
        }

        /* renamed from: I */
        public final void m42925I(double d) {
            this.max_ = d;
        }

        /* renamed from: J */
        public final void m42924J(double d) {
            this.min_ = d;
        }
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C7195a {
        ...
        static {
            ...
            try {
                f51625a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f51625a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f51625a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f51625a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f51625a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f51625a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: Y */
    public final void m43037Y(Iterable iterable) {
        m43025k0();
        AbstractMessageLite.addAll(iterable, (List) this.bucketCounts_);
    }

    /* renamed from: Z */
    public final void m43036Z(Iterable iterable) {
        m43024l0();
        AbstractMessageLite.addAll(iterable, (List) this.exemplars_);
    }

    /* renamed from: a0 */
    public final void m43035a0(long j) {
        m43025k0();
        this.bucketCounts_.addLong(j);
    }

    /* renamed from: b0 */
    public final void m43034b0(int i, Exemplar exemplar) {
        exemplar.getClass();
        m43024l0();
    ...
    /* renamed from: c0 */
    public final void m43033c0(Exemplar exemplar) {
        exemplar.getClass();
        m43024l0();
    ...
    /* renamed from: e0 */
    public final void m43031e0() {
        this.bucketOptions_ = null;
    }

    /* renamed from: f0 */
    public final void m43030f0() {
        this.count_ = 0L;
    }

    /* renamed from: g0 */
    public final void m43029g0() {
    ...
    /* renamed from: i0 */
    public final void m43027i0() {
        this.range_ = null;
    }

    /* renamed from: j0 */
    public final void m43026j0() {
        this.sumOfSquaredDeviation_ = 0.0d;
    }

    /* renamed from: k0 */
    public final void m43025k0() {
    ...
    /* renamed from: m0 */
    public final void m43023m0(BucketOptions bucketOptions) {
    ...
    /* renamed from: n0 */
    public final void m43022n0(Range range) {
        range.getClass();
    ...
    /* renamed from: o0 */
    public final void m43021o0(int i) {
        m43024l0();
        this.exemplars_.remove(i);
    }

    /* renamed from: p0 */
    public final void m43020p0(int i, long j) {
        m43025k0();
        this.bucketCounts_.setLong(i, j);
    }

    /* renamed from: q0 */
    public final void m43019q0(BucketOptions bucketOptions) {
        bucketOptions.getClass();
        this.bucketOptions_ = bucketOptions;
    }

    /* renamed from: r0 */
    public final void m43018r0(long j) {
        this.count_ = j;
    }

    /* renamed from: s0 */
    public final void m43017s0(int i, Exemplar exemplar) {
        exemplar.getClass();
        m43024l0();
    ...
    /* renamed from: t0 */
    public final void m43016t0(double d) {
        this.mean_ = d;
    }

    /* renamed from: u0 */
    public final void m43015u0(Range range) {
        range.getClass();
        this.range_ = range;
    }

    /* renamed from: v0 */
    public final void m43014v0(double d) {
