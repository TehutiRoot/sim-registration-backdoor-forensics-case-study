...
@SourceDebugExtension({"SMAP\nOCRPresenter.kt\nKotlin\n*S Kotlin\n*F\n+ 1 OCRPresenter.kt\nth/co/dtac/android/dtacone/presenter/prepaid/OCRPresenter$getRawTextOCR$2\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,404:1\n1#2:405\n*E\n"})
/* renamed from: th.co.dtac.android.dtacone.presenter.prepaid.OCRPresenter$getRawTextOCR$2 */
/* loaded from: classes8.dex */
public final class OCRPresenter$getRawTextOCR$2 extends Lambda implements Function1<Bitmap, Unit> {
    ...
    /* renamed from: th.co.dtac.android.dtacone.presenter.prepaid.OCRPresenter$getRawTextOCR$2$1 */
    /* loaded from: classes8.dex */
    public static final class C143571 extends Lambda implements Function1<FirebaseVisionText, Unit> {
        final /* synthetic */ OCRPresenter this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C143571(OCRPresenter oCRPresenter) {
            super(1);
        ...
        public final void invoke2(FirebaseVisionText firebaseVisionText) {
            ...
            OCRPresenter oCRPresenter2 = this.this$0;
            String text2 = firebaseVisionText.getText();
            Intrinsics.checkNotNullExpressionValue(text2, "firebaseVisionText.text");
            oCRPresenter2.m17672v(text2);
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OCRPresenter$getRawTextOCR$2(OCRPresenter oCRPresenter) {
        super(1);
        this.this$0 = oCRPresenter;
    }

    /* renamed from: b */
    public static /* synthetic */ void m17662b(Function1 function1, Object obj) {
    ...
    public final void invoke2(Bitmap bitmap) {
        ...
        final C143571 c143571 = new C143571(this.this$0);
        Task<FirebaseVisionText> addOnSuccessListener = processImage.addOnSuccessListener(new OnSuccessListener() { // from class: th.co.dtac.android.dtacone.presenter.prepaid.e
            @Override // com.google.android.gms.tasks.OnSuccessListener
            public final void onSuccess(Object obj) {
                OCRPresenter$getRawTextOCR$2.m17662b(Function1.this, obj);
            }
        });
        final OCRPresenter oCRPresenter = this.this$0;
        addOnSuccessListener.addOnFailureListener(new OnFailureListener() { // from class: th.co.dtac.android.dtacone.presenter.prepaid.f
            @Override // com.google.android.gms.tasks.OnFailureListener
            public final void onFailure(Exception exc) {
                OCRPresenter$getRawTextOCR$2.invoke$lambda$2(OCRPresenter.this, exc);
            }
        });
    }
}