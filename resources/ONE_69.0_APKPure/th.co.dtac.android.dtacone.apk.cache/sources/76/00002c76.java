...
public final class SurfaceKt$Surface$10 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        m60754b = SurfaceKt.m60754b(this.$color, (ElevationOverlay) composer.consume(ElevationOverlayKt.getLocalElevationOverlay()), this.$absoluteElevation, composer, (this.$$dirty >> 15) & 14);
        m60755a = SurfaceKt.m60755a(minimumInteractiveComponentSize, shape, m60754b, this.$border, this.$elevation);
        Modifier m69877toggleableO2vRcR0$default = ToggleableKt.m69877toggleableO2vRcR0$default(m60755a, this.$checked, this.$interactionSource, RippleKt.m70364rememberRipple9IZ8Weo(false, 0.0f, 0L, composer, 0, 7), this.$enabled, null, this.$onCheckedChange, 16, null);
        ...
        Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> modifierMaterializerOf = LayoutKt.modifierMaterializerOf(m69877toggleableO2vRcR0$default);
