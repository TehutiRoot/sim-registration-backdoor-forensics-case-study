...
public final class DisplayOrientedMeteringPointFactory extends MeteringPointFactory {
    ...
    /* renamed from: d */
    public final Display f10873d;

    /* renamed from: e */
    public final CameraInfo f10874e;

    public DisplayOrientedMeteringPointFactory(@NonNull Display display, @NonNull CameraInfo cameraInfo, float f, float f2) {
        this.f10871b = f;
        this.f10872c = f2;
        this.f10873d = display;
        this.f10874e = cameraInfo;
    }

    /* renamed from: a */
    public final int m63230a(boolean z) {
        try {
            int sensorRotationDegrees = this.f10874e.getSensorRotationDegrees(this.f10873d.getRotation());
            if (z) {
    ...
    */
    public android.graphics.PointF convertPoint(float r9, float r10) {
        /*
            ...
            float r0 = r8.f10871b
            float r1 = r8.f10872c
            androidx.camera.core.CameraInfo r2 = r8.f10874e
