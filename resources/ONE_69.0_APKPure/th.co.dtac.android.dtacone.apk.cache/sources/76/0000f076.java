...
public class SimpleLog implements Log, Serializable {
    ...
    private static InputStream getResourceAsStream(String str) {
        return (InputStream) AccessController.doPrivileged(new C22498uK1(str));
    }
    ...
    public void log(int i, Object obj, Throwable th2) {
        ...
        if (showShortName) {
            if (this.shortLogName == null) {
                ...
                this.shortLogName = substring.substring(substring.lastIndexOf(RemoteSettings.FORWARD_SLASH_STRING) + 1);
            }
