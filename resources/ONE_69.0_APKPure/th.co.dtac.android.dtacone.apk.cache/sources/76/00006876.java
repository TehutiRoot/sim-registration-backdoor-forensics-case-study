...
public class Constraints extends ViewGroup {
    ...
    /* renamed from: a */
    public final void m57999a(AttributeSet attributeSet) {
    }

    public ConstraintSet getConstraintSet() {
        if (this.f33445a == null) {
            this.f33445a = new ConstraintSet();
        }
        this.f33445a.clone(this);
        return this.f33445a;
    }
