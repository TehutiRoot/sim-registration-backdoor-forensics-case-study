...
public class TimePickerBindingAdapter {
    ...
    /* loaded from: classes2.dex */
    public class C4287a implements TimePicker.OnTimeChangedListener {

        /* renamed from: a */
        public final /* synthetic */ TimePicker.OnTimeChangedListener f34672a;

        /* renamed from: b */
        public final /* synthetic */ InverseBindingListener f34673b;

        /* renamed from: c */
        public final /* synthetic */ InverseBindingListener f34674c;

        public C4287a(TimePicker.OnTimeChangedListener onTimeChangedListener, InverseBindingListener inverseBindingListener, InverseBindingListener inverseBindingListener2) {
            this.f34672a = onTimeChangedListener;
            this.f34673b = inverseBindingListener;
            this.f34674c = inverseBindingListener2;
        }

        @Override // android.widget.TimePicker.OnTimeChangedListener
        public void onTimeChanged(TimePicker timePicker, int i, int i2) {
            TimePicker.OnTimeChangedListener onTimeChangedListener = this.f34672a;
            if (onTimeChangedListener != null) {
                onTimeChangedListener.onTimeChanged(timePicker, i, i2);
            }
            InverseBindingListener inverseBindingListener = this.f34673b;
            if (inverseBindingListener != null) {
                inverseBindingListener.onChange();
            }
            InverseBindingListener inverseBindingListener2 = this.f34674c;
    ...
    public static void setListeners(TimePicker timePicker, TimePicker.OnTimeChangedListener onTimeChangedListener, InverseBindingListener inverseBindingListener, InverseBindingListener inverseBindingListener2) {
        if (inverseBindingListener == null && inverseBindingListener2 == null) {
            ...
            timePicker.setOnTimeChangedListener(new C4287a(onTimeChangedListener, inverseBindingListener, inverseBindingListener2));
        }
    }
