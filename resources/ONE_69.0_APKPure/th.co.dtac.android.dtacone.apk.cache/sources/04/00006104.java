...
public final class HitPathTracker {
    ...
    /* renamed from: a */
    public final LayoutCoordinates f29991a;

    /* renamed from: b */
    public final NodeParent f29992b;

    public HitPathTracker(@NotNull LayoutCoordinates rootCoordinates) {
        Intrinsics.checkNotNullParameter(rootCoordinates, "rootCoordinates");
        this.f29991a = rootCoordinates;
        this.f29992b = new NodeParent();
    }
    ...
    public final void m72831addHitPathKNwqfcY(long j, @NotNull List<? extends Modifier.Node> pointerInputNodes) {
        Node node;
        Intrinsics.checkNotNullParameter(pointerInputNodes, "pointerInputNodes");
        NodeParent nodeParent = this.f29992b;
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (z) {
                ...
                if (node3 != null) {
                    node3.markIsIn();
                    if (!node3.getPointerIds().contains(PointerId.m72878boximpl(j))) {
                        node3.getPointerIds().add(PointerId.m72878boximpl(j));
                    }
                    nodeParent = node3;
                } else {
                    z = false;
            ...
            node4.getPointerIds().add(PointerId.m72878boximpl(j));
    ...
    public final boolean dispatchChanges(@NotNull InternalPointerEvent internalPointerEvent, boolean z) {
        ...
        if (!this.f29992b.buildCache(internalPointerEvent.getChanges(), this.f29991a, internalPointerEvent, z)) {
            return false;
        }
        boolean dispatchMainEventPass = this.f29992b.dispatchMainEventPass(internalPointerEvent.getChanges(), this.f29991a, internalPointerEvent, z);
        if (!this.f29992b.dispatchFinalEventPass(internalPointerEvent) && !dispatchMainEventPass) {
            return false;
        }
        return true;
    }
    ...
    public final void processCancel() {
        this.f29992b.dispatchCancel();
        this.f29992b.clear();
    }

    public final void removeDetachedPointerInputFilters() {
        this.f29992b.removeDetachedPointerInputFilters();
    }
}