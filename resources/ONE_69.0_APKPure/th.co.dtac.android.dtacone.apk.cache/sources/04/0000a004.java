...
public final class zzb {
    /* renamed from: a */
    public static void m45975a(Image.Plane plane, int i, int i2, byte[] bArr, int i3, int i4) {
    ...
    /* renamed from: b */
    public static byte[] m45974b(byte[] bArr, int i, int i2) {
    ...
    public static Bitmap zza(ByteBuffer byteBuffer, int i, int i2, int i3) throws IOException {
        ...
        byte[] m45974b = m45974b(bArr, i, i2);
        Bitmap decodeByteArray = BitmapFactory.decodeByteArray(m45974b, 0, m45974b.length);
    ...
    public static ByteBuffer zza(Image.Plane[] planeArr, int i, int i2) {
        ...
        if (z) {
            ...
            m45975a(planeArr[0], i, i2, bArr, 0, 1);
            m45975a(planeArr[1], i, i2, bArr, i3 + 1, 2);
            m45975a(planeArr[2], i, i2, bArr, i3, 2);
        }
