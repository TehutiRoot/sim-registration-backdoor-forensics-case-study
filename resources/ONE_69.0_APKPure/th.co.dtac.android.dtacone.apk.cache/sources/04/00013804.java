...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.fragment.true_company.OnePostpaidCampaignListFragment$initView$3$1 */
/* loaded from: classes10.dex */
public final class OnePostpaidCampaignListFragment$initView$3$1 extends Lambda implements Function1<FragmentNavEvent, Unit> {
    final /* synthetic */ OnePostpaidCampaignListFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidCampaignListFragment$initView$3$1(OnePostpaidCampaignListFragment onePostpaidCampaignListFragment) {
        super(1);
    ...
    public final void invoke2(@NotNull FragmentNavEvent it) {
        OnePostpaidRegistrationActivity m12014t;
        Intrinsics.checkNotNullParameter(it, "it");
        m12014t = this.this$0.m12014t();
        m12014t.replaceFragment(it.buildFragment(), it.getTag());
    }
}