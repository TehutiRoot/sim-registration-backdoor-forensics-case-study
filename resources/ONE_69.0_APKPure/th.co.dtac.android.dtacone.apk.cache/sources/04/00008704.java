...
public class CoreXMLDeserializers extends Deserializers.Base {
    ...
    /* renamed from: a */
    public static final DatatypeFactory f43333a;
    ...
    public static class Std extends FromStringDeserializer<Object> {
        ...
        public Object _deserialize(String str, DeserializationContext deserializationContext) throws IOException {
            ...
            if (i != 1) {
                ...
                try {
                    ...
                    return CoreXMLDeserializers.f43333a.newXMLGregorianCalendar(str);
                }
            }
            return CoreXMLDeserializers.f43333a.newDuration(str);
        }
        ...
        public XMLGregorianCalendar _gregorianFromDate(DeserializationContext deserializationContext, Date date) {
            ...
            return CoreXMLDeserializers.f43333a.newXMLGregorianCalendar(gregorianCalendar);
        }
    ...
    static {
        try {
            f43333a = DatatypeFactory.newInstance();
