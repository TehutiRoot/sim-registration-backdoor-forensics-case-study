...
public class setTranslationY implements setDarkTextColor.valueOf {
    public static final setTranslationY valueOf = new setTranslationY();

    @Override // com.netcetera.threeds.sdk.infrastructure.setDarkTextColor.valueOf
    public getHeadingTextColor values() {
        return setDarkTextColor.setOnKeyListener();
    }
}