...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.viewModel.OneMnpViewModel$getMailingPostCodeInfo$1$3 */
/* loaded from: classes10.dex */
public final class OneMnpViewModel$getMailingPostCodeInfo$1$3 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ OneMnpViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneMnpViewModel$getMailingPostCodeInfo$1$3(OneMnpViewModel oneMnpViewModel) {
        super(1);
