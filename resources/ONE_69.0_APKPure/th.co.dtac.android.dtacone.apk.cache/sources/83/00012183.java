...
/* renamed from: th.co.dtac.android.dtacone.presenter.address.QueryAddressPresenter$getSubDistrict$1 */
/* loaded from: classes8.dex */
public final class QueryAddressPresenter$getSubDistrict$1 extends Lambda implements Function1<SqlBrite.Query, List<? extends AddressItemData>> {
    ...
    public QueryAddressPresenter$getSubDistrict$1(QueryAddressPresenter queryAddressPresenter, int i, int i2, int i3) {
        super(1);
    ...
    public final List<AddressItemData> invoke(SqlBrite.Query it) {
        ...
        if (Intrinsics.areEqual(LanguageSupport.LANG_TH, this.this$0.getLanguageService().getLanguage())) {
            i = this.$SUB_DISTRICT_NAME_TH;
        } else {
            i = this.$SUB_DISTRICT_NAME_EN;
        }
