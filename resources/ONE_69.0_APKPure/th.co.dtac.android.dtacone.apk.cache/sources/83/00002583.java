...
public final class DerivedHeightModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    /* renamed from: c */
    public final WindowInsets f13213c;

    /* renamed from: d */
    public final Function2 f13214d;

    /* renamed from: e */
    public final MutableState f13215e;
    ...
    /* renamed from: d */
    public final WindowInsets m61358d() {
        return (WindowInsets) this.f13215e.getValue();
    }

    /* renamed from: e */
    public final void m61357e(WindowInsets windowInsets) {
        this.f13215e.setValue(windowInsets);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(this.f13213c, derivedHeightModifier.f13213c) && Intrinsics.areEqual(this.f13214d, derivedHeightModifier.f13214d)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.f13213c.hashCode() * 31) + this.f13214d.hashCode();
    }
    ...
    public MeasureResult mo69364measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        int intValue = ((Number) this.f13214d.invoke(m61358d(), measure)).intValue();
        if (intValue == 0) {
            return MeasureScope.CC.m59482q(measure, 0, 0, null, DerivedHeightModifier$measure$1.INSTANCE, 4, null);
        }
        Placeable mo72995measureBRTryo0 = measurable.mo72995measureBRTryo0(Constraints.m73802copyZbe2FdA$default(j, 0, 0, intValue, intValue, 3, null));
        return MeasureScope.CC.m59482q(measure, mo72995measureBRTryo0.getWidth(), intValue, null, new DerivedHeightModifier$measure$2(mo72995measureBRTryo0), 4, null);
    }
    ...
    public void onModifierLocalsUpdated(ModifierLocalReadScope scope) {
        ...
        m61357e(WindowInsetsKt.exclude(this.f13213c, (WindowInsets) scope.getCurrent(WindowInsetsPaddingKt.getModifierLocalConsumedWindowInsets())));
    }
