...
@Metadata(m29143d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m29142d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_railwayAlert", "Landroidx/compose/material/icons/Icons$Rounded;", "getRailwayAlert", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "RailwayAlert", "material-icons-extended_release"}, m29141k = 2, m29140mv = {1, 8, 0})
...
public final class RailwayAlertKt {
    ...
    /* renamed from: a */
    public static ImageVector f20553a;

    @NotNull
    public static final ImageVector getRailwayAlert(@NotNull Icons.Rounded rounded) {
        Intrinsics.checkNotNullParameter(rounded, "<this>");
        ImageVector imageVector = f20553a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.RailwayAlert", C3623Dp.m73842constructorimpl(24.0f), C3623Dp.m73842constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.curveTo(2.0f, 18.43f, 3.57f, 20.0f, 5.5f, 20.0f);
        pathBuilder.lineToRelative(-1.21f, 0.81f);
        pathBuilder.curveTo(4.11f, 20.93f, 4.0f, 21.13f, 4.0f, 21.35f);
        pathBuilder.verticalLineToRelative(0.0f);
        pathBuilder.curveTo(4.0f, 21.71f, 4.29f, 22.0f, 4.65f, 22.0f);
        ...
        pathBuilder.curveTo(11.5f, 16.33f, 10.83f, 17.0f, 10.0f, 17.0f);
        pathBuilder.close();
        ...
        pathBuilder2.curveTo(17.5f, 8.22f, 17.72f, 8.0f, 18.0f, 8.0f);
