...
public final class GroupServiceAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    /* renamed from: a */
    public final Activity f81293a;
    public ServiceItemAdapter adapter;

    /* renamed from: b */
    public final ServiceItemAdapter.OnClickServiceItem f81294b;

    /* renamed from: c */
    public final List f81295c;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final int $stable = 8;

    @Metadata(m29143d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0006"}, m29142d2 = {"Lth/co/dtac/android/dtacone/adapter/home/GroupServiceAdapter$Companion;", "", "()V", "VIEW_TYPE_GROUP_ITEM", "", "VIEW_TYPE_HEADER", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    @Metadata(m29143d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0086\u0004\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005R\u0017\u0010\u000b\u001a\u00020\u00068\u0006¢\u0006\f\n\u0004\b\u0007\u0010\b\u001a\u0004\b\t\u0010\n¨\u0006\f"}, m29142d2 = {"Lth/co/dtac/android/dtacone/adapter/home/GroupServiceAdapter$HeaderServiceItemViewHolder;", "Landroidx/recyclerview/widget/RecyclerView$ViewHolder;", "Landroid/view/View;", Promotion.ACTION_VIEW, "<init>", "(Lth/co/dtac/android/dtacone/adapter/home/GroupServiceAdapter;Landroid/view/View;)V", "Landroid/widget/TextView;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroid/widget/TextView;", "getTvGroupServiceTitle", "()Landroid/widget/TextView;", "tvGroupServiceTitle", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0})
    ...
    public GroupServiceAdapter(@NotNull Activity activity, @NotNull ServiceItemAdapter.OnClickServiceItem listener, @NotNull List<GroupServiceItem> groupServiceList) {
        ...
        this.f81293a = activity;
        this.f81294b = listener;
        this.f81295c = groupServiceList;
    }

    /* renamed from: a */
    public final void m20537a(GroupServiceItemViewHolder groupServiceItemViewHolder, List list) {
        setAdapter(new ServiceItemAdapter(this.f81293a, list));
        GridLayoutManager gridLayoutManager = new GridLayoutManager((Context) this.f81293a, 3, 1, false);
        DynamicVerticalGridItemDecorator dynamicVerticalGridItemDecorator = new DynamicVerticalGridItemDecorator(this.f81293a, 3, 8, 8, 16);
        ...
        getAdapter().setListener(this.f81294b);
    }
    ...
    public void onBindViewHolder(@NotNull RecyclerView.ViewHolder holder, int i) {
        ...
        GroupServiceItem groupServiceItem = (GroupServiceItem) this.f81295c.get(i);
        if (holder instanceof HeaderServiceItemViewHolder) {
            ...
            m20537a(groupServiceItemViewHolder, arrayList);
        }
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NotNull ViewGroup p0, int i) {
        ...
        if (getItemViewType(i) == 0) {
            View view = LayoutInflater.from(this.f81293a).inflate(R.layout.item_header_service, p0, false);
            Intrinsics.checkNotNullExpressionValue(view, "view");
            return new HeaderServiceItemViewHolder(this, view);
        }
        View view2 = LayoutInflater.from(this.f81293a).inflate(R.layout.item_group_service, p0, false);
