...
public class ToolbarUtils {
    ...
    /* renamed from: a */
    public static final Comparator f50301a = new C6990a();

    /* renamed from: com.google.android.material.internal.ToolbarUtils$a */
    /* loaded from: classes4.dex */
    public class C6990a implements Comparator {
    ...
    /* renamed from: a */
    public static ImageView m44524a(Toolbar toolbar, Drawable drawable) {
        ImageView imageView;
        Drawable drawable2;
        if (drawable == null) {
            return null;
    ...
    /* renamed from: b */
    public static List m44523b(Toolbar toolbar, CharSequence charSequence) {
    ...
    public static ImageView getLogoImageView(@NonNull Toolbar toolbar) {
        return m44524a(toolbar, toolbar.getLogo());
    }
    ...
    public static TextView getSubtitleTextView(@NonNull Toolbar toolbar) {
        List m44523b = m44523b(toolbar, toolbar.getSubtitle());
        if (m44523b.isEmpty()) {
            return null;
        }
        return (TextView) Collections.max(m44523b, f50301a);
    }

    @Nullable
    public static TextView getTitleTextView(@NonNull Toolbar toolbar) {
        List m44523b = m44523b(toolbar, toolbar.getTitle());
        if (m44523b.isEmpty()) {
            return null;
        }
        return (TextView) Collections.min(m44523b, f50301a);
    }
}