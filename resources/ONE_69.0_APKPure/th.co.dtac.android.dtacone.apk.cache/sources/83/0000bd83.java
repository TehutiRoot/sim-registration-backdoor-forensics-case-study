...
public class C9691qn extends AbstractC9705ra {
    ...
    public C9691qn() {
        if (!Boolean.getBoolean("org.jose4j.jws.default-allow-none")) {
            values(C9679pf.ThreeDS2Service);
        }
    }

    private String cleanup() {
        return C9719ro.ThreeDS2Service(this.valueOf, this.get);
    }

    private byte[] getWarnings() throws C9716rl {
        if (!get()) {
            return C9719ro.values(C9699qv.valueOf(createTransaction(), initialize()));
        }
        try {
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
            byteArrayOutputStream.write(C9719ro.values(createTransaction()));
            byteArrayOutputStream.write(46);
            byteArrayOutputStream.write(this.valueOf);
            return byteArrayOutputStream.toByteArray();
        } catch (IOException e) {
            throw new C9716rl("This should never happen from a ByteArrayOutputStream", e);
        }
    }

    public InterfaceC9695qr ThreeDS2Service() throws C9720rp {
        return valueOf(true);
    }

    @Override // com.netcetera.threeds.sdk.infrastructure.AbstractC9705ra
    ...
    @Override // com.netcetera.threeds.sdk.infrastructure.AbstractC9705ra
    /* renamed from: a_ */
    public void mo33344a_() {
        this.ThreeDS2ServiceInstance = null;
    }

    @Override // com.netcetera.threeds.sdk.infrastructure.AbstractC9705ra
    public void get(String[] strArr) throws C9716rl {
        if (strArr.length == 3) {
            getSDKInfo(strArr[0]);
            get(strArr[1]);
        ...
        throw new C9716rl("A JWS Compact Serialization must have exactly 3 parts separated by period ('.') characters");
    }
    ...
    public boolean valueOf() throws C9716rl {
        InterfaceC9695qr ThreeDS2Service = ThreeDS2Service();
        Key onError = onError();
    ...
    public String ThreeDS2ServiceInstance() throws C9716rl {
        if (!Boolean.getBoolean("org.jose4j.jws.getPayload-skip-verify") && !valueOf()) {
            throw new C9715rk("JWS signature is invalid.");
        }
        return cleanup();
    }
    ...
    private InterfaceC9695qr valueOf(boolean z) throws C9720rp {
        ...
        if (ThreeDS2Service$InitializationCallback != null) {
            ...
            return C9682ph.valueOf().ThreeDS2ServiceInstance().ThreeDS2ServiceInstance(ThreeDS2Service$InitializationCallback);
        }
        throw new C9720rp("Signature algorithm header (alg) not set.");
    }
