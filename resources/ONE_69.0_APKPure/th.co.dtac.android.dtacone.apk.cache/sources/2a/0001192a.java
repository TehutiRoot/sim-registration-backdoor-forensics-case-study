...
public final class DynamicHorizontalItemDecorator extends RecyclerView.ItemDecoration {
    ...
    public DynamicHorizontalItemDecorator(@NotNull Context context, int i, int i2, int i3) {
        ...
        this.f84826a = (int) TypedValue.applyDimension(1, i3, displayMetrics);
        this.f84827b = (int) TypedValue.applyDimension(1, i2, displayMetrics);
        this.f84828c = (int) TypedValue.applyDimension(1, i, displayMetrics);
    }
    ...
    public void getItemOffsets(@NotNull Rect outRect, @NotNull View view, @NotNull RecyclerView parent, @NotNull RecyclerView.State state) {
        ...
        if (childAdapterPosition == 0) {
            outRect.left = this.f84828c;
        } else {
            outRect.left = this.f84827b;
        }
        RecyclerView.Adapter adapter = parent.getAdapter();
        if (adapter != null && childAdapterPosition == adapter.getItemCount() - 1) {
            outRect.right = this.f84828c;
        }
        int i = this.f84826a;
        outRect.top = i;
        outRect.bottom = i;
