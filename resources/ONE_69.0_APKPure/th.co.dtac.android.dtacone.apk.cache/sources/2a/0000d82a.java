...
public class TextureRotationUtil {
    ...
    public static /* synthetic */ class C11585a {
        ...
        static {
            ...
            try {
                f67753a[Rotation.ROTATION_180.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f67753a[Rotation.ROTATION_270.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f67753a[Rotation.NORMAL.ordinal()] = 4;
    ...
    public static float[] getRotation(Rotation rotation, boolean z, boolean z2) {
        ...
        if (z) {
            fArr = new float[]{m29359a(fArr[0]), fArr[1], m29359a(fArr[2]), fArr[3], m29359a(fArr[4]), fArr[5], m29359a(fArr[6]), fArr[7]};
        }
        return z2 ? new float[]{fArr[0], m29359a(fArr[1]), fArr[2], m29359a(fArr[3]), fArr[4], m29359a(fArr[5]), fArr[6], m29359a(fArr[7])} : fArr;
    }
}