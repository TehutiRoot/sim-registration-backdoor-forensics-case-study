...
public final class FileImageSource extends ImageSource {
    ...
    public FileImageSource(@NotNull Path path, @NotNull FileSystem fileSystem, @Nullable String str, @Nullable Closeable closeable, @Nullable ImageSource.Metadata metadata) {
        super(null);
        this.f40500a = path;
        this.f40501b = fileSystem;
        this.f40502c = str;
        this.f40503d = closeable;
        this.f40504e = metadata;
    }
    ...
    public synchronized void close() {
        try {
            this.f40505f = true;
            BufferedSource bufferedSource = this.f40506g;
            if (bufferedSource != null) {
                Utils.closeQuietly(bufferedSource);
            }
            Closeable closeable = this.f40503d;
            if (closeable != null) {
    ...
    public synchronized BufferedSource source() {
        ...
        BufferedSource buffer = Okio.buffer(getFileSystem().source(this.f40500a));
        this.f40506g = buffer;
        return buffer;
    }
