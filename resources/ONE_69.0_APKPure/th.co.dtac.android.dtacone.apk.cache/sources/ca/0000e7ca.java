...
public final class ElementMarker {
    ...
    public ElementMarker(@NotNull SerialDescriptor descriptor, @NotNull Function2<? super SerialDescriptor, ? super Integer, Boolean> readIfAbsent) {
        ...
        this.f71223a = descriptor;
        this.f71224b = readIfAbsent;
        int elementsCount = descriptor.getElementsCount();
        if (elementsCount <= 64) {
            this.f71225c = elementsCount != 64 ? (-1) << elementsCount : 0L;
            this.f71226d = f71222f;
            return;
        }
        this.f71225c = 0L;
        this.f71226d = m27005c(elementsCount);
    }

    /* renamed from: a */
    public final void m27007a(int i) {
        int i2 = (i >>> 6) - 1;
        long[] jArr = this.f71226d;
        jArr[i2] = jArr[i2] | (1 << (i & 63));
    }

    /* renamed from: b */
    public final int m27006b() {
        int length = this.f71226d.length;
        int i = 0;
        while (i < length) {
            int i2 = i + 1;
            int i3 = i2 * 64;
            long j = this.f71226d[i];
            while (j != -1) {
                int numberOfTrailingZeros = Long.numberOfTrailingZeros(~j);
                j |= 1 << numberOfTrailingZeros;
                int i4 = numberOfTrailingZeros + i3;
                if (((Boolean) this.f71224b.invoke(this.f71223a, Integer.valueOf(i4))).booleanValue()) {
                    this.f71226d[i] = j;
                    return i4;
                }
            }
    ...
    /* renamed from: c */
    public final long[] m27005c(int i) {
    ...
    public final int nextUnmarkedIndex() {
        ...
        int elementsCount = this.f71223a.getElementsCount();
        do {
            long j = this.f71225c;
            if (j != -1) {
                numberOfTrailingZeros = Long.numberOfTrailingZeros(~j);
                this.f71225c |= 1 << numberOfTrailingZeros;
            } else if (elementsCount > 64) {
                return m27006b();
            } else {
                return -1;
            }
        } while (!((Boolean) this.f71224b.invoke(this.f71223a, Integer.valueOf(numberOfTrailingZeros))).booleanValue());
