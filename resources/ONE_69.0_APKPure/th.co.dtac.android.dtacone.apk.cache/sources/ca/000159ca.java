...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_prepaid_multi_sim.MrtrPrepaidMultiSimViewModel$cutSimStock$3 */
/* loaded from: classes9.dex */
public final class MrtrPrepaidMultiSimViewModel$cutSimStock$3 extends Lambda implements Function1<CutSimStockResponse, Unit> {
    ...
    public MrtrPrepaidMultiSimViewModel$cutSimStock$3(MultiSubscriber multiSubscriber, MrtrPrepaidRegisterResponse mrtrPrepaidRegisterResponse, MrtrPrepaidMultiSimViewModel mrtrPrepaidMultiSimViewModel) {
        super(1);
    ...
    public final void invoke2(CutSimStockResponse cutSimStockResponse) {
        ...
        MultiSimSubmitResult multiSimSubmitResult = new MultiSimSubmitResult(Boolean.valueOf(!(rtrTransactionId == null || rtrTransactionId.length() == 0)), Boolean.FALSE, this.$response, null, null, this.$subscriber);
