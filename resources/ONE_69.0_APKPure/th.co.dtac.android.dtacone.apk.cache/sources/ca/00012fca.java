...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.device_sale.viewmodel.OneDeviceSaleViewModel$callListCampaignPaymentTypeAdditional$3 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleViewModel$callListCampaignPaymentTypeAdditional$3 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ OneDeviceSaleViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneDeviceSaleViewModel$callListCampaignPaymentTypeAdditional$3(OneDeviceSaleViewModel oneDeviceSaleViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable it) {
        ...
        oneDeviceSaleRepository.setSearchPackageRefNo(null);
