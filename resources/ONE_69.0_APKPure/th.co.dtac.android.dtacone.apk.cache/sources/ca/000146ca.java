...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.topup.viewModel.OneTopUpViewModel$topUpTrueV1$1 */
/* loaded from: classes10.dex */
public final class OneTopUpViewModel$topUpTrueV1$1 extends Lambda implements Function1<Disposable, Unit> {
    final /* synthetic */ OneTopUpViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneTopUpViewModel$topUpTrueV1$1(OneTopUpViewModel oneTopUpViewModel) {
        super(1);
