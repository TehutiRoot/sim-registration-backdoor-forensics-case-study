...
@Metadata(m29143d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m29142d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_handyman", "Landroidx/compose/material/icons/Icons$Outlined;", "getHandyman", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "Handyman", "material-icons-extended_release"}, m29141k = 2, m29140mv = {1, 8, 0})
...
public final class HandymanKt {
    ...
    /* renamed from: a */
    public static ImageVector f17808a;

    @NotNull
    public static final ImageVector getHandyman(@NotNull Icons.Outlined outlined) {
        Intrinsics.checkNotNullParameter(outlined, "<this>");
        ImageVector imageVector = f17808a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Handyman", C3623Dp.m73842constructorimpl(24.0f), C3623Dp.m73842constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(18.84f, 19.59f);
        pathBuilder.lineToRelative(-4.24f, -4.24f);
        pathBuilder.lineToRelative(0.71f, -0.71f);
        pathBuilder.lineToRelative(4.24f, 4.24f);
        pathBuilder.lineTo(18.84f, 19.59f);
        pathBuilder.close();
        ...
        pathBuilder2.close();
        pathBuilder2.moveTo(9.36f, 15.34f);
        pathBuilder2.lineToRelative(-4.24f, 4.24f);
        pathBuilder2.lineToRelative(-0.71f, -0.71f);
        pathBuilder2.lineToRelative(4.24f, -4.24f);
        pathBuilder2.lineToRelative(0.0f, 0.0f);
        pathBuilder2.lineTo(9.36f, 15.34f);
        pathBuilder2.lineTo(9.36f, 15.34f);
        pathBuilder2.close();
