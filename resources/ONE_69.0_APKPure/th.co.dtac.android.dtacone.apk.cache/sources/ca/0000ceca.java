...
public final class FlowableAny<T> extends AbstractC0558I {

    /* renamed from: b */
    public final Predicate f64104b;
    ...
    public FlowableAny(Flowable<T> flowable, Predicate<? super T> predicate) {
        super(flowable);
        this.f64104b = predicate;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super Boolean> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new AnySubscriber(subscriber, this.f64104b));
    }
}