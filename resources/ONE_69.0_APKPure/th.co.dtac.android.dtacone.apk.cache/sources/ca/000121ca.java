...
/* renamed from: th.co.dtac.android.dtacone.presenter.bitmap.SaveBitmapPresenter$saveBitmapIdCard$3 */
/* loaded from: classes8.dex */
public final class SaveBitmapPresenter$saveBitmapIdCard$3 extends Lambda implements Function1<Bitmap, ObservableSource<? extends Unit>> {
    final /* synthetic */ BitmapCollection $bitmap;
    final /* synthetic */ SaveBitmapPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SaveBitmapPresenter$saveBitmapIdCard$3(SaveBitmapPresenter saveBitmapPresenter, BitmapCollection bitmapCollection) {
        super(1);
    ...
    public final ObservableSource<? extends Unit> invoke(@NotNull final Bitmap it) {
        ...
        return Observable.fromCallable(new Callable() { // from class: th.co.dtac.android.dtacone.presenter.bitmap.i
            @Override // java.util.concurrent.Callable
            public final Object call() {
                Unit invoke$lambda$0;
                invoke$lambda$0 = SaveBitmapPresenter$saveBitmapIdCard$3.invoke$lambda$0(SaveBitmapPresenter.this, it, bitmapCollection);
