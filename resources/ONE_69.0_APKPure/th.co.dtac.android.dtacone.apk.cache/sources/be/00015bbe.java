...
/* renamed from: th.co.dtac.android.dtacone.widget.compose.common.OneButtonKt$OneButtonOutlineRed$1 */
/* loaded from: classes9.dex */
public final class OneButtonKt$OneButtonOutlineRed$1 extends Lambda implements Function3<RowScope, Composer, Integer, Unit> {
    final /* synthetic */ int $$dirty;
    final /* synthetic */ String $text;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneButtonKt$OneButtonOutlineRed$1(String str, int i) {
        super(3);
        this.$text = str;
        this.$$dirty = i;
    }
