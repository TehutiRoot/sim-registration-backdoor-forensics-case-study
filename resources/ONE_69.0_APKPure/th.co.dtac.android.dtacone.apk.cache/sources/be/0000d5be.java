...
@DebugMetadata(m29093c = "io.realm.internal.coroutines.InternalFlowFactory$changesetFrom$3", m29092f = "InternalFlowFactory.kt", m29091i = {}, m29090l = {366, 394}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
...
public final class InternalFlowFactory$changesetFrom$3 extends SuspendLambda implements Function2<ProducerScope<? super CollectionChange<RealmList<T>>>, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes5.dex */
    public static final class C113191 extends Lambda implements Function0<Unit> {
        public static final C113191 INSTANCE = new C113191();
    ...
    /* loaded from: classes5.dex */
    public static final class C113202 extends Lambda implements Function0<Unit> {
        final /* synthetic */ Realm $flowRealm;
        final /* synthetic */ RealmList<T> $list;
        final /* synthetic */ OrderedRealmCollectionChangeListener<RealmList<T>> $listener;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C113202(Realm realm, RealmList<T> realmList, OrderedRealmCollectionChangeListener<RealmList<T>> orderedRealmCollectionChangeListener) {
            super(0);
    ...
    public static final void m74253invokeSuspend$lambda0(ProducerScope producerScope, InternalFlowFactory internalFlowFactory, RealmList realmList, OrderedCollectionChangeSet orderedCollectionChangeSet) {
        boolean z;
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (!this.$list.isValid()) {
            C113191 c113191 = C113191.INSTANCE;
            this.label = 1;
            if (ProduceKt.awaitClose(producerScope, c113191, this) == coroutine_suspended) {
        ...
        OrderedRealmCollectionChangeListener orderedRealmCollectionChangeListener = new OrderedRealmCollectionChangeListener() { // from class: io.realm.internal.coroutines.c
            ...
            public final void onChange(Object obj2, OrderedCollectionChangeSet orderedCollectionChangeSet) {
                InternalFlowFactory$changesetFrom$3.m74253invokeSuspend$lambda0(ProducerScope.this, internalFlowFactory, (RealmList) obj2, orderedCollectionChangeSet);
            }
        };
        ...
        C113202 c113202 = new C113202(realm, this.$list, orderedRealmCollectionChangeListener);
        this.label = 2;
        if (ProduceKt.awaitClose(producerScope, c113202, this) == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Unit.INSTANCE;
    }
