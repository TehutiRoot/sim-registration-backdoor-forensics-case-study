...
public class AuthenticationRequestParameters {
    ...
    public AuthenticationRequestParameters(String str, String str2, String str3, String str4, String str5, String str6) throws InvalidInputException {
        this.getSDKInfo = C9610nj.ThreeDS2ServiceInstance(str, "sdkTransactionID");
        this.valueOf = C9610nj.ThreeDS2ServiceInstance(str2, "deviceData");
        this.getSDKVersion = C9610nj.ThreeDS2ServiceInstance(str3, "sdkEphemeralPublicKey");
        this.cleanup = C9610nj.ThreeDS2ServiceInstance(str4, "sdkAppID");
        this.initialize = C9610nj.ThreeDS2ServiceInstance(str5, "sdkReferenceNumber");
        Object[] objArr = new Object[1];
        ThreeDS2ServiceInstance(127 - (ViewConfiguration.getScrollBarSize() >> 8), null, null, "\u008a\u0089\u0088\u0083\u0087\u0082\u0086\u0082\u0085\u0084\u0083\u0083\u0082\u0081", objArr);
        this.getWarnings = C9610nj.ThreeDS2ServiceInstance(str6, ((String) objArr[0]).intern());
    }
