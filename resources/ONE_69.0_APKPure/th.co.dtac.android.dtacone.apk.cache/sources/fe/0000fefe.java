...
public class SecT571K1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT571K1Curve() {
        ...
        this.f75411a = fromBigInteger(BigInteger.valueOf(0L));
        this.f75412b = fromBigInteger(BigInteger.valueOf(1L));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat576.copy64(((SecT571FieldElement) eCPoint.getRawXCoord()).f75509x, 0, jArr, i3);
            Nat576.copy64(((SecT571FieldElement) eCPoint.getRawYCoord()).f75509x, 0, jArr, i3 + 9);
            i3 += 18;
        }
