...
public abstract class Y60 {
    ...
    /* renamed from: a */
    public static final JsonReader.Options f7771a = JsonReader.Options.m50682of("nm", OperatorName.NON_STROKING_GRAY, "o", "t", OperatorName.CLOSE_AND_STROKE, "e", OperatorName.SET_LINE_WIDTH, "lc", "lj", "ml", "hd", "d");

    /* renamed from: b */
    public static final JsonReader.Options f7772b = JsonReader.Options.m50682of("p", OperatorName.NON_STROKING_CMYK);

    /* renamed from: c */
    public static final JsonReader.Options f7773c = JsonReader.Options.m50682of(OperatorName.ENDPATH, OperatorName.CURVE_TO_REPLICATE_INITIAL_POINT);

    /* renamed from: a */
    public static GradientStroke m65490a(JsonReader jsonReader, LottieComposition lottieComposition) {
        String str;
        ...
        while (jsonReader.hasNext()) {
            switch (jsonReader.selectName(f7771a)) {
                case 0:
                ...
                case 1:
                    ...
                    int i = -1;
                    while (jsonReader.hasNext()) {
                        int selectName = jsonReader.selectName(f7772b);
                        if (selectName != 0) {
                            ...
                            if (selectName != 1) {
                                ...
                                animatableGradientColorValue2 = AnimatableValueParser.m50703e(jsonReader, lottieComposition, i);
                            }
                        } else {
                            animatableGradientColorValue = animatableGradientColorValue2;
                    ...
                    break;
                case 2:
                    animatableIntegerValue = AnimatableValueParser.m50702f(jsonReader, lottieComposition);
                    continue;
                case 3:
                    str = str2;
                ...
                case 11:
                    ...
                    while (jsonReader.hasNext()) {
                        ...
                        while (jsonReader.hasNext()) {
                            int selectName2 = jsonReader.selectName(f7773c);
                            if (selectName2 != 0) {
