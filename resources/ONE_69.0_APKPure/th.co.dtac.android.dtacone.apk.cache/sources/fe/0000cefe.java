...
public final class FlowableConcatWithMaybe<T> extends AbstractC0558I {

    /* renamed from: b */
    public final MaybeSource f64232b;
    ...
    public FlowableConcatWithMaybe(Flowable<T> flowable, MaybeSource<? extends T> maybeSource) {
        super(flowable);
        this.f64232b = maybeSource;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new ConcatWithSubscriber(subscriber, this.f64232b));
    }
}