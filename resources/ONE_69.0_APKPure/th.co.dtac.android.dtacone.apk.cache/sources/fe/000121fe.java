...
/* renamed from: th.co.dtac.android.dtacone.presenter.buy_dol.BuyDolChargeDirectAccountPresenter$charge$2 */
/* loaded from: classes8.dex */
public final class BuyDolChargeDirectAccountPresenter$charge$2 extends Lambda implements Function1<BuyDolResponseCharge, Unit> {
    final /* synthetic */ BuyDolChargeDirectAccountPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BuyDolChargeDirectAccountPresenter$charge$2(BuyDolChargeDirectAccountPresenter buyDolChargeDirectAccountPresenter) {
        super(1);
    ...
    public final void invoke2(BuyDolResponseCharge it) {
        ...
        view = this.this$0.f85390d;
        if (view == null) {
            Intrinsics.throwUninitializedPropertyAccessException(Promotion.ACTION_VIEW);
            view = null;
        }
        Intrinsics.checkNotNullExpressionValue(it, "it");
        view.onChargeResult(it);
    }
}