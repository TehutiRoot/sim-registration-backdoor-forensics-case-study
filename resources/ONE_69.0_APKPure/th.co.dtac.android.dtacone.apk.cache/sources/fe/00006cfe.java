...
public class TableLayoutBindingAdapter {
    ...
    /* renamed from: a */
    public static Pattern f34667a = Pattern.compile("\\s*,\\s*");

    /* renamed from: a */
    public static SparseBooleanArray m56243a(CharSequence charSequence) {
        SparseBooleanArray sparseBooleanArray = new SparseBooleanArray();
        if (charSequence == null) {
            return sparseBooleanArray;
        }
        for (String str : f34667a.split(charSequence)) {
            try {
    ...
    public static void setCollapseColumns(TableLayout tableLayout, CharSequence charSequence) {
        SparseBooleanArray m56243a = m56243a(charSequence);
        for (int i = 0; i < 20; i++) {
            boolean z = m56243a.get(i, false);
    ...
    public static void setShrinkColumns(TableLayout tableLayout, CharSequence charSequence) {
        ...
        SparseBooleanArray m56243a = m56243a(charSequence);
        int size = m56243a.size();
        for (int i = 0; i < size; i++) {
            int keyAt = m56243a.keyAt(i);
            boolean valueAt = m56243a.valueAt(i);
            if (valueAt) {
