...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.change_pack.ChangePackViewModel$callApiSearchAdditionalPackageGroup$3 */
/* loaded from: classes9.dex */
public final class ChangePackViewModel$callApiSearchAdditionalPackageGroup$3 extends Lambda implements Function1<AdditionalPackageGroupList, Unit> {
    final /* synthetic */ ChangePackViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ChangePackViewModel$callApiSearchAdditionalPackageGroup$3(ChangePackViewModel changePackViewModel) {
        super(1);
    ...
    public final void invoke2(AdditionalPackageGroupList additionalPackageGroupList) {
        ...
        m3331U.postValue(additionalPackageGroupList);
        mutableLiveData = this.this$0.f105162o;
