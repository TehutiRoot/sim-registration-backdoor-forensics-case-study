...
public final class NavUtils {
    ...
    public static class C3834a {
        @DoNotInline
        /* renamed from: a */
        public static Intent m57851a(Activity activity) {
            return activity.getParentActivityIntent();
        }

        @DoNotInline
        /* renamed from: b */
        public static boolean m57850b(Activity activity, Intent intent) {
            return activity.navigateUpTo(intent);
        }

        @DoNotInline
        /* renamed from: c */
        public static boolean m57849c(Activity activity, Intent intent) {
    ...
    public static Intent getParentActivityIntent(@NonNull Activity activity) {
        Intent m57851a = C3834a.m57851a(activity);
        if (m57851a != null) {
            return m57851a;
        }
