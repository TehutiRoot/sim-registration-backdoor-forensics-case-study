...
/* renamed from: th.co.dtac.android.dtacone.view.fragment.eSIM.ESimCommonFragment$initView$1$2 */
/* loaded from: classes9.dex */
public final class ESimCommonFragment$initView$1$2 extends Lambda implements Function1<Resource<? extends ErrorCollection>, Unit> {
    final /* synthetic */ ESimCommonFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimCommonFragment$initView$1$2(ESimCommonFragment eSimCommonFragment) {
        super(1);
    ...
    public final void invoke2(Resource<ErrorCollection> resource) {
        ...
        ESimCommonFragment eSimCommonFragment = this.this$0;
        if (resourceContentIfNotHandled.getStatus() == StatusResource.ERROR) {
            eSimCommonFragment.m7820u();
        }
    }
}