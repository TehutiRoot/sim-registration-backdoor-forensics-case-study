...
public class TaggedReader extends ProxyReader {
    ...
    /* renamed from: a */
    public final Serializable f73537a;

    public TaggedReader(Reader reader) {
        super(reader);
        this.f73537a = UUID.randomUUID();
    }

    @Override // org.apache.commons.p028io.input.ProxyReader
    public void handleIOException(IOException iOException) throws IOException {
        throw new TaggedIOException(iOException, this.f73537a);
    }

    public boolean isCauseOf(Throwable th2) {
        return TaggedIOException.isTaggedWith(th2, this.f73537a);
    }

    public void throwIfCauseOf(Throwable th2) throws IOException {
        TaggedIOException.throwCauseIfTaggedWith(th2, this.f73537a);
    }
}