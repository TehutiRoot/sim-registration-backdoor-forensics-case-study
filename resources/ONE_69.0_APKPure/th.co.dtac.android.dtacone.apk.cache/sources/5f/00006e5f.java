...
public final class UInt32Value extends GeneratedMessageLite<UInt32Value, Builder> implements UInt32ValueOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<UInt32Value, Builder> implements UInt32ValueOrBuilder {
        ...
        public Builder clearValue() {
            copyOnWrite();
            ((UInt32Value) this.instance).m55422t();
            return this;
        }
        ...
        public Builder setValue(int i) {
            copyOnWrite();
            ((UInt32Value) this.instance).m55421u(i);
            return this;
        }
    ...
    /* renamed from: androidx.datastore.preferences.protobuf.UInt32Value$a */
    /* loaded from: classes2.dex */
    public static /* synthetic */ class C4387a {
        ...
        static {
            ...
            try {
                f34976a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f34976a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f34976a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f34976a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f34976a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f34976a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: of */
    public static UInt32Value m55426of(int i) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: u */
    public void m55421u(int i) {
        this.value_ = i;
    }

    @Override // androidx.datastore.preferences.protobuf.GeneratedMessageLite
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C4387a.f34976a[methodToInvoke.ordinal()]) {
            case 1:
