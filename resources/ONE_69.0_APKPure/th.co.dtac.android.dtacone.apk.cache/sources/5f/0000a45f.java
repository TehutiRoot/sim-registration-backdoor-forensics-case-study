...
public final class CustomHttpPattern extends GeneratedMessageLite<CustomHttpPattern, Builder> implements CustomHttpPatternOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<CustomHttpPattern, Builder> implements CustomHttpPatternOrBuilder {
        ...
        public Builder clearKind() {
            copyOnWrite();
            ((CustomHttpPattern) this.instance).m43066I();
            return this;
        }

        public Builder clearPath() {
            copyOnWrite();
            ((CustomHttpPattern) this.instance).m43065J();
            return this;
        }
        ...
        public Builder setKind(String str) {
            copyOnWrite();
            ((CustomHttpPattern) this.instance).m43064K(str);
            return this;
        }

        public Builder setKindBytes(ByteString byteString) {
            copyOnWrite();
            ((CustomHttpPattern) this.instance).m43063L(byteString);
            return this;
        }

        public Builder setPath(String str) {
            copyOnWrite();
            ((CustomHttpPattern) this.instance).m43062M(str);
            return this;
        }

        public Builder setPathBytes(ByteString byteString) {
            copyOnWrite();
            ((CustomHttpPattern) this.instance).m43061N(byteString);
            return this;
        }
    ...
    public static /* synthetic */ class C7194a {
        ...
        static {
            ...
            try {
                f51624a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f51624a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f51624a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f51624a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f51624a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f51624a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: I */
    public final void m43066I() {
        this.kind_ = getDefaultInstance().getKind();
    }

    /* renamed from: J */
    public final void m43065J() {
        this.path_ = getDefaultInstance().getPath();
    }

    /* renamed from: K */
    public final void m43064K(String str) {
        str.getClass();
        this.kind_ = str;
    }

    /* renamed from: L */
    public final void m43063L(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.kind_ = byteString.toStringUtf8();
    }

    /* renamed from: M */
    public final void m43062M(String str) {
        str.getClass();
        this.path_ = str;
    }

    /* renamed from: N */
    public final void m43061N(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C7194a.f51624a[methodToInvoke.ordinal()]) {
            case 1:
