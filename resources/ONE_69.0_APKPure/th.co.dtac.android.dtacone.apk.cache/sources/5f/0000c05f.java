...
public class CharStringCommand {
    ...
    static {
        ...
        linkedHashMap2.put(new Key(12, 10), ProductAction.ACTION_ADD);
    ...
    /* renamed from: a */
    public final void m33018a(Key key) {
        this.f59320a = key;
    }
    ...
    public static class Key {
        ...
        /* renamed from: a */
        public final void m33017a(int[] iArr) {
            this.f59321a = iArr;
        }
        ...
        public boolean equals(Object obj) {
            ...
            Key key = (Key) obj;
            int[] iArr = this.f59321a;
            int i = iArr[0];
            if (i == 12) {
                int[] iArr2 = key.f59321a;
                if (iArr2[0] == 12) {
    ...
    public CharStringCommand(int i, int i2) {
        m33018a(new Key(i, i2));
    }

    public CharStringCommand(int[] iArr) {
        m33018a(new Key(iArr));
    }
}