...
public final class Singles {
    ...
    /* loaded from: classes5.dex */
    public static final class C11194a implements BiFunction {

        /* renamed from: a */
        public static final C11194a f66415a = new C11194a();
    ...
    /* loaded from: classes5.dex */
    public static final class C11195b implements Function3 {

        /* renamed from: a */
        public static final C11195b f66416a = new C11195b();
    ...
    public final <T, U> Single<Pair<T, U>> zip(@NotNull SingleSource<T> s1, @NotNull SingleSource<U> s2) {
        Intrinsics.checkParameterIsNotNull(s1, "s1");
        Intrinsics.checkParameterIsNotNull(s2, "s2");
        Single<Pair<T, U>> zip = Single.zip(s1, s2, C11194a.f66415a);
    ...
    public final <T1, T2, T3> Single<Triple<T1, T2, T3>> zip(@NotNull SingleSource<T1> s1, @NotNull SingleSource<T2> s2, @NotNull SingleSource<T3> s3) {
        ...
        Intrinsics.checkParameterIsNotNull(s2, "s2");
        Intrinsics.checkParameterIsNotNull(s3, "s3");
        Single<Triple<T1, T2, T3>> zip = Single.zip(s1, s2, s3, C11195b.f66416a);
