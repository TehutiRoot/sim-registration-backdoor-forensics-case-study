...
@Metadata(m29143d1 = {"\u0000D\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u0003\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\b\u0000\u0018\u0000*\b\b\u0000\u0010\u0001*\u00020\u00022\u00020\u0003B;\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007\u0012\f\u0010\b\u001a\b\u0012\u0004\u0012\u00028\u00000\t\u0012\f\u0010\n\u001a\b\u0012\u0004\u0012\u00028\u00000\u000b\u0012\b\b\u0002\u0010\f\u001a\u00020\r¢\u0006\u0002\u0010\u000eJ\u0010\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u0012H\u0002J\u0010\u0010\u0013\u001a\u00020\u00102\u0006\u0010\u0014\u001a\u00020\u0002H\u0002J\u0006\u0010\u0015\u001a\u00020\u0010J\u0010\u0010\u0016\u001a\u00020\u00102\u0006\u0010\u0017\u001a\u00020\u0018H\u0002R\u000e\u0010\u0006\u001a\u00020\u0007X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\n\u001a\b\u0012\u0004\u0012\u00028\u00000\u000bX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\b\u001a\b\u0012\u0004\u0012\u00028\u00000\tX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\f\u001a\u00020\rX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0019"}, m29142d2 = {"Lco/omise/android/api/Invocation;", "T", "Lco/omise/android/models/Model;", "", "replyHandler", "Landroid/os/Handler;", "httpClient", "Lokhttp3/OkHttpClient;", "request", "Lco/omise/android/api/Request;", ServiceSpecificExtraArgs.CastExtraArgs.LISTENER, "Lco/omise/android/api/RequestListener;", "serializer", "Lco/omise/android/models/Serializer;", "(Landroid/os/Handler;Lokhttp3/OkHttpClient;Lco/omise/android/api/Request;Lco/omise/android/api/RequestListener;Lco/omise/android/models/Serializer;)V", "didFail", "", "e", "", "didSucceed", "model", "invoke", "processCall", NotificationCompat.CATEGORY_CALL, "Lco/omise/android/api/TypedCall;", "sdk_productionRelease"}, m29141k = 1, m29140mv = {1, 7, 1}, m29138xi = 48)
...
public final class Invocation<T extends Model> {
    ...
    /* renamed from: a */
    public static /* synthetic */ void m51295a(Invocation invocation, Throwable th2) {
        m74100didFail$lambda1(invocation, th2);
    }

    /* renamed from: b */
    public static /* synthetic */ void m51294b(Invocation invocation, Model model) {
        m74101didSucceed$lambda0(invocation, model);
    }

    private final void didFail(final Throwable th2) {
        this.replyHandler.post(new Runnable() { // from class: sg0
            @Override // java.lang.Runnable
            public final void run() {
                Invocation.m51295a(Invocation.this, th2);
            }
        });
    }

    /* renamed from: didFail$lambda-1 */
    public static final void m74100didFail$lambda1(Invocation this$0, Throwable e) {
    ...
    private final void didSucceed(final Model model) {
        this.replyHandler.post(new Runnable() { // from class: rg0
            @Override // java.lang.Runnable
            public final void run() {
                Invocation.m51294b(Invocation.this, model);
            }
        });
    }

    /* renamed from: didSucceed$lambda-0 */
    public static final void m74101didSucceed$lambda0(Invocation this$0, Model model) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    private final void processCall(TypedCall typedCall) {
        ...
        if (200 <= code && code < 300) {
            ...
            didFail(this.serializer.m74103deserialize(inputStream, typedCall.getErrorClazz()));
        }
    }
