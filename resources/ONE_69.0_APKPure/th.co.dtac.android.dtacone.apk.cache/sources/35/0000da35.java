...
public final class ComparisonsKt__ComparisonsKt$compareBy$3<T> implements Comparator {
    ...
    /* renamed from: a */
    public final /* synthetic */ Comparator f68196a;

    /* renamed from: b */
    public final /* synthetic */ Function1 f68197b;

    public ComparisonsKt__ComparisonsKt$compareBy$3(Comparator<Object> comparator, Function1<? super T, Object> function1) {
        this.f68196a = comparator;
        this.f68197b = function1;
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // java.util.Comparator
    public final int compare(T t, T t2) {
        Comparator comparator = this.f68196a;
        Function1 function1 = this.f68197b;
