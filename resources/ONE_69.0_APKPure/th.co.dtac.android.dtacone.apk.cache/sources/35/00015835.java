...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_change_sim.MrtrChangeSimViewModel$checkSimStock$1 */
/* loaded from: classes9.dex */
public final class MrtrChangeSimViewModel$checkSimStock$1 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ MrtrChangeSimViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrChangeSimViewModel$checkSimStock$1(MrtrChangeSimViewModel mrtrChangeSimViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable it) {
        ...
        mrtrErrorService.handleException(it, new MrtrErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.viewmodel.mrtr_change_sim.MrtrChangeSimViewModel$checkSimStock$1.1
            ...
            public void handle(@Nullable Throwable th2) {
                ...
                mrtrChangeSimRepository = MrtrChangeSimViewModel.this.f106258b;
                mrtrChangeSimRepository.setCheckSimStockError(errorCollection);
                m2414C = MrtrChangeSimViewModel.this.m2414C();
                m2414C.setValue(Resource.Companion.success(errorCollection.getStatusCode()));
            }
