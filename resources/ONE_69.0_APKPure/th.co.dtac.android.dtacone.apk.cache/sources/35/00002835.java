...
public final class PagerSnapDistanceMaxPages implements PagerSnapDistance {
    ...
    public int calculateTargetPage(int i, int i2, float f, int i3, int i4) {
        int i5 = this.f13967a;
        return AbstractC11695c.coerceIn(i2, i - i5, i + i5);
    }

    public boolean equals(@Nullable Object obj) {
        if (!(obj instanceof PagerSnapDistanceMaxPages) || this.f13967a != ((PagerSnapDistanceMaxPages) obj).f13967a) {
            return false;
        }
        return true;
    }
