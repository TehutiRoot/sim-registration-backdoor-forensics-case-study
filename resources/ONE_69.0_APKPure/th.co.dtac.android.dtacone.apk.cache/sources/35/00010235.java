...
public final class UuidHelper {
    ...
    public static /* synthetic */ class C12932a {
        ...
        static {
            ...
            try {
                f76026a[UuidRepresentation.JAVA_LEGACY.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f76026a[UuidRepresentation.PYTHON_LEGACY.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f76026a[UuidRepresentation.STANDARD.ordinal()] = 4;
    ...
    /* renamed from: a */
    public static long m24378a(byte[] bArr, int i) {
    ...
    /* renamed from: b */
    public static void m24377b(byte[] bArr, int i, int i2) {
    ...
    /* renamed from: c */
    public static void m24376c(byte[] bArr, int i, long j) {
        bArr[i + 7] = (byte) (j & 255);
    ...
    public static UUID decodeBinaryToUuid(byte[] bArr, byte b, UuidRepresentation uuidRepresentation) {
        if (bArr.length == 16) {
            if (b == BsonBinarySubType.UUID_LEGACY.getValue()) {
                int i = C12932a.f76026a[uuidRepresentation.ordinal()];
                if (i != 1) {
                    if (i != 2) {
                        if (i != 3) {
                            if (i != 4) {
            ...
            return new UUID(m24378a(bArr, 0), m24378a(bArr, 8));
        }
    ...
    public static byte[] encodeUuidToBinary(UUID uuid, UuidRepresentation uuidRepresentation) {
        ...
        m24376c(bArr, 0, uuid.getMostSignificantBits());
        m24376c(bArr, 8, uuid.getLeastSignificantBits());
        int i = C12932a.f76026a[uuidRepresentation.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i != 3 && i != 4) {
