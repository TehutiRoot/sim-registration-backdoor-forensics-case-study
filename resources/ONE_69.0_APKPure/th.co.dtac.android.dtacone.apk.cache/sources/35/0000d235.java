...
public final class ObservableRetryWhen<T> extends AbstractC11078a {

    /* renamed from: a */
    public final Function f65536a;
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        try {
            ObservableSource observableSource = (ObservableSource) ObjectHelper.requireNonNull(this.f65536a.apply(serialized), "The handler returned a null ObservableSource");
