...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.pre2post.fragment.OnePre2PostRecommendedPackageFragment$onStart$1$3 */
/* loaded from: classes10.dex */
public final class OnePre2PostRecommendedPackageFragment$onStart$1$3 extends Lambda implements Function1<FragmentNavEvent, Unit> {
    final /* synthetic */ OnePre2PostRecommendedPackageFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePre2PostRecommendedPackageFragment$onStart$1$3(OnePre2PostRecommendedPackageFragment onePre2PostRecommendedPackageFragment) {
        super(1);
    ...
    public final void invoke2(@NotNull FragmentNavEvent it) {
        ...
        m11287p.replaceFragment(OnePre2PostAllPackageTelephoneNumberFragment.Companion.newInstance());
    }
}