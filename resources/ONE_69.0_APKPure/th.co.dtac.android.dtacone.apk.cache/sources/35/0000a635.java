...
public class TestCertificates {
    ...
    /* renamed from: a */
    public static JsonWebSignature f52274a = null;
    ...
    public static class CertData {
        ...
        public byte[] getDer() throws IOException {
            return PemReader.readFirstSectionAndClose(new StringReader(this.f52275a), "CERTIFICATE").getBase64DecodedBytes();
        }
    ...
    public static JsonWebSignature getJsonWebSignature() throws IOException {
        if (f52274a == null) {
            ...
            f52274a = new JsonWebSignature(header, payload, Base64.decodeBase64(JWS_SIGNATURE.substring(indexOf + 1)), StringUtils.getBytesUtf8(JWS_SIGNATURE.substring(0, indexOf)));
        }
        return f52274a;
    }
}