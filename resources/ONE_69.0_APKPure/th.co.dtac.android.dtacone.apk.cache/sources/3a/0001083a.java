...
public abstract class ParameterHandler<T> {
    ...
    public static final class Body<T> extends ParameterHandler<T> {
        ...
        public void apply(RequestBuilder requestBuilder, @Nullable T t) {
            ...
            throw Utils.parameterError(this.method, this.f77565p, "Body parameter value must not be null.", new Object[0]);
        }
    }
            ...
            if (map != null) {
                for (Map.Entry<String, T> entry : map.entrySet()) {
                    ...
                    if (key != null) {
                        ...
                        throw Utils.parameterError(this.method, this.f77566p, "Field map contained null key.", new Object[0]);
                    }
                }
                return;
            }
            throw Utils.parameterError(this.method, this.f77566p, "Field map was null.", new Object[0]);
        }
    }
            ...
            if (map != null) {
                for (Map.Entry<String, T> entry : map.entrySet()) {
                    ...
                    if (key != null) {
                        ...
                        throw Utils.parameterError(this.method, this.f77567p, "Header map contained null key.", new Object[0]);
                    }
                }
                return;
            }
            throw Utils.parameterError(this.method, this.f77567p, "Header map was null.", new Object[0]);
        }
    }
    ...
    public static final class Headers extends ParameterHandler<okhttp3.Headers> {
        ...
        public void apply(RequestBuilder requestBuilder, @Nullable okhttp3.Headers headers) {
            ...
            throw Utils.parameterError(this.method, this.f77568p, "Headers parameter must not be null.", new Object[0]);
        }
    }
            ...
            if (map != null) {
                for (Map.Entry<String, T> entry : map.entrySet()) {
                    ...
                    if (key != null) {
                        T value = entry.getValue();
                        if (value != null) {
                            requestBuilder.addPart(okhttp3.Headers.m26053of(HttpHeaders.CONTENT_DISPOSITION, "form-data; name=\"" + key + OperatorName.SHOW_TEXT_LINE_AND_SPACE, "Content-Transfer-Encoding", this.transferEncoding), this.valueConverter.convert(value));
                        } else {
                            Method method = this.method;
                            int i = this.f77570p;
                        ...
                        throw Utils.parameterError(this.method, this.f77570p, "Part map contained null key.", new Object[0]);
                    }
                }
                return;
            }
            throw Utils.parameterError(this.method, this.f77570p, "Part map was null.", new Object[0]);
        }
    }
            ...
            if (map != null) {
                for (Map.Entry<String, T> entry : map.entrySet()) {
                    ...
                    if (key != null) {
                        ...
                        throw Utils.parameterError(this.method, this.f77572p, "Query map contained null key.", new Object[0]);
                    }
                }
                return;
            }
            throw Utils.parameterError(this.method, this.f77572p, "Query map was null", new Object[0]);
        }
    }
    ...
    public static final class RelativeUrl extends ParameterHandler<Object> {
        ...
        public void apply(RequestBuilder requestBuilder, @Nullable Object obj) {
            ...
            throw Utils.parameterError(this.method, this.f77573p, "@Url parameter is null.", new Object[0]);
        }
    }
