...
public final class OperationInfo extends GeneratedMessageLite<OperationInfo, Builder> implements OperationInfoOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<OperationInfo, Builder> implements OperationInfoOrBuilder {
        public /* synthetic */ Builder(C8795a c8795a) {
            this();
        }

        public Builder clearMetadataType() {
            copyOnWrite();
            ((OperationInfo) this.instance).m37264I();
            return this;
        }

        public Builder clearResponseType() {
            copyOnWrite();
            ((OperationInfo) this.instance).m37263J();
            return this;
        }
        ...
        public Builder setMetadataType(String str) {
            copyOnWrite();
            ((OperationInfo) this.instance).m37262K(str);
            return this;
        }

        public Builder setMetadataTypeBytes(ByteString byteString) {
            copyOnWrite();
            ((OperationInfo) this.instance).m37261L(byteString);
            return this;
        }

        public Builder setResponseType(String str) {
            copyOnWrite();
            ((OperationInfo) this.instance).m37260M(str);
            return this;
        }

        public Builder setResponseTypeBytes(ByteString byteString) {
            copyOnWrite();
            ((OperationInfo) this.instance).m37259N(byteString);
            return this;
        }
    ...
    public static /* synthetic */ class C8795a {
        ...
        static {
            ...
            try {
                f56876a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f56876a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f56876a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f56876a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f56876a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f56876a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: I */
    public final void m37264I() {
        this.metadataType_ = getDefaultInstance().getMetadataType();
    }

    /* renamed from: J */
    public final void m37263J() {
        this.responseType_ = getDefaultInstance().getResponseType();
    }

    /* renamed from: K */
    public final void m37262K(String str) {
        str.getClass();
        this.metadataType_ = str;
    }

    /* renamed from: L */
    public final void m37261L(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.metadataType_ = byteString.toStringUtf8();
    }

    /* renamed from: M */
    public final void m37260M(String str) {
        str.getClass();
        this.responseType_ = str;
    }

    /* renamed from: N */
    public final void m37259N(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C8795a.f56876a[methodToInvoke.ordinal()]) {
            case 1:
