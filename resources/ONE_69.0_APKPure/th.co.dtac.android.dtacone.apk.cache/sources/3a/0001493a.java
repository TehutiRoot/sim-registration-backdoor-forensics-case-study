...
/* renamed from: th.co.dtac.android.dtacone.view.fragment.buy_dol.BuyDolFormCreditFragment$onViewCreated$1$9 */
/* loaded from: classes9.dex */
public final class BuyDolFormCreditFragment$onViewCreated$1$9 extends Lambda implements Function1<Boolean, Unit> {
    final /* synthetic */ FragmentBuyDolFormCreditBinding $this_apply;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BuyDolFormCreditFragment$onViewCreated$1$9(FragmentBuyDolFormCreditBinding fragmentBuyDolFormCreditBinding) {
        super(1);
