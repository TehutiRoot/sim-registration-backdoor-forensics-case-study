...
public final class FieldMask extends GeneratedMessageLite<FieldMask, Builder> implements FieldMaskOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<FieldMask, Builder> implements FieldMaskOrBuilder {
        public /* synthetic */ Builder(C8867a c8867a) {
            this();
        }

        public Builder addAllPaths(Iterable<String> iterable) {
            copyOnWrite();
            ((FieldMask) this.instance).m35879H(iterable);
            return this;
        }

        public Builder addPaths(String str) {
            copyOnWrite();
            ((FieldMask) this.instance).m35878I(str);
            return this;
        }

        public Builder addPathsBytes(ByteString byteString) {
            copyOnWrite();
            ((FieldMask) this.instance).m35877J(byteString);
            return this;
        }

        public Builder clearPaths() {
            copyOnWrite();
            ((FieldMask) this.instance).m35876K();
            return this;
        }
        ...
        public Builder setPaths(int i, String str) {
            copyOnWrite();
            ((FieldMask) this.instance).m35874M(i, str);
            return this;
        }
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C8867a {
        ...
        static {
            ...
            try {
                f57340a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f57340a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f57340a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f57340a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f57340a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f57340a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: H */
    public final void m35879H(Iterable iterable) {
        m35875L();
        AbstractMessageLite.addAll(iterable, (List) this.paths_);
    }

    /* renamed from: I */
    public final void m35878I(String str) {
        str.getClass();
        m35875L();
        this.paths_.add(str);
    }
    ...
    /* renamed from: J */
    public final void m35877J(ByteString byteString) {
    ...
    /* renamed from: K */
    public final void m35876K() {
        this.paths_ = GeneratedMessageLite.emptyProtobufList();
    }

    /* renamed from: L */
    public final void m35875L() {
    ...
    /* renamed from: M */
    public final void m35874M(int i, String str) {
        str.getClass();
        m35875L();
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C8867a.f57340a[methodToInvoke.ordinal()]) {
            case 1:
