...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.fragment.OneMnpReadSmartCardFragment$setupObserve$1$4 */
/* loaded from: classes10.dex */
public final class OneMnpReadSmartCardFragment$setupObserve$1$4 extends Lambda implements Function1<Resource<? extends ErrorCollection>, Unit> {
    final /* synthetic */ OneMnpReadSmartCardFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneMnpReadSmartCardFragment$setupObserve$1$4(OneMnpReadSmartCardFragment oneMnpReadSmartCardFragment) {
        super(1);
    ...
    public final void invoke2(Resource<ErrorCollection> resource) {
        ...
        if (resourceContentIfNotHandled.getStatus() == StatusResource.SUCCESS) {
            oneMnpReadSmartCardFragment.m13794A(resourceContentIfNotHandled.getData());
        }
    }
}