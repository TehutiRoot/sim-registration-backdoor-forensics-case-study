...
public final class ObservableRetryBiPredicate<T> extends AbstractC11078a {

    /* renamed from: a */
    public final BiPredicate f65533a;
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        new RetryBiObserver(observer, this.f65533a, sequentialDisposable, this.source).subscribeNext();
    }
}