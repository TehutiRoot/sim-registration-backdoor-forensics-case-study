...
public interface IMultiInstanceInvalidationService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMultiInstanceInvalidationService {
        ...
        /* loaded from: classes2.dex */
        public static class C4999a implements IMultiInstanceInvalidationService {

            /* renamed from: a */
            public IBinder f37361a;

            public C4999a(IBinder iBinder) {
                this.f37361a = iBinder;
            }
            ...
            public void broadcastInvalidation(int i, String[] strArr) {
                ...
                try {
                    ...
                    this.f37361a.transact(3, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public int registerCallback(IMultiInstanceInvalidationCallback iMultiInstanceInvalidationCallback, String str) {
                ...
                try {
                    ...
                    this.f37361a.transact(1, obtain, obtain2, 0);
            ...
            public void unregisterCallback(IMultiInstanceInvalidationCallback iMultiInstanceInvalidationCallback, int i) {
                ...
                try {
                    ...
                    obtain.writeStrongInterface(iMultiInstanceInvalidationCallback);
                    obtain.writeInt(i);
                    this.f37361a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
