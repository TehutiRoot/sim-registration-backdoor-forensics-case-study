...
public final class DebugCoroutineInfo {
    ...
    public DebugCoroutineInfo(@NotNull DebugCoroutineInfoImpl debugCoroutineInfoImpl, @NotNull CoroutineContext coroutineContext) {
        this.f70762a = coroutineContext;
        this.f70763b = debugCoroutineInfoImpl.getCreationStackBottom();
        this.f70764c = debugCoroutineInfoImpl.sequenceNumber;
        this.f70765d = debugCoroutineInfoImpl.getCreationStackTrace();
        this.f70766e = debugCoroutineInfoImpl.getState();
        this.f70767f = debugCoroutineInfoImpl.lastObservedThread;
        this.f70768g = debugCoroutineInfoImpl.getLastObservedFrame$kotlinx_coroutines_core();
        this.f70769h = debugCoroutineInfoImpl.lastObservedStackTrace();
    }
