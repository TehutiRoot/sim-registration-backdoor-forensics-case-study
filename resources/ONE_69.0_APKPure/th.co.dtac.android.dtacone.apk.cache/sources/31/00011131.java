...
public final class OneAddNewStaff {
    ...
    /* renamed from: a */
    public String f82491a;

    /* renamed from: b */
    public String f82492b;

    /* renamed from: c */
    public String f82493c;

    /* renamed from: d */
    public String f82494d;

    /* renamed from: e */
    public String f82495e;

    /* renamed from: f */
    public String f82496f;
    ...
    public static /* synthetic */ OneAddNewStaff copy$default(OneAddNewStaff oneAddNewStaff, String str, String str2, String str3, String str4, String str5, String str6, Boolean bool, int i, Object obj) {
        if ((i & 1) != 0) {
            str = oneAddNewStaff.f82491a;
        }
        if ((i & 2) != 0) {
            str2 = oneAddNewStaff.f82492b;
        }
        String str7 = str2;
        if ((i & 4) != 0) {
            str3 = oneAddNewStaff.f82493c;
        }
        String str8 = str3;
        if ((i & 8) != 0) {
            str4 = oneAddNewStaff.f82494d;
        }
        String str9 = str4;
        if ((i & 16) != 0) {
            str5 = oneAddNewStaff.f82495e;
        }
        String str10 = str5;
        if ((i & 32) != 0) {
            str6 = oneAddNewStaff.f82496f;
        }
        String str11 = str6;
        if ((i & 64) != 0) {
            bool = oneAddNewStaff.f82497g;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof OneAddNewStaff) {
            ...
            return Intrinsics.areEqual(this.f82491a, oneAddNewStaff.f82491a) && Intrinsics.areEqual(this.f82492b, oneAddNewStaff.f82492b) && Intrinsics.areEqual(this.f82493c, oneAddNewStaff.f82493c) && Intrinsics.areEqual(this.f82494d, oneAddNewStaff.f82494d) && Intrinsics.areEqual(this.f82495e, oneAddNewStaff.f82495e) && Intrinsics.areEqual(this.f82496f, oneAddNewStaff.f82496f) && Intrinsics.areEqual(this.f82497g, oneAddNewStaff.f82497g);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        String str2 = this.f82492b;
        int hashCode2 = (hashCode + (str2 == null ? 0 : str2.hashCode())) * 31;
        String str3 = this.f82493c;
        int hashCode3 = (hashCode2 + (str3 == null ? 0 : str3.hashCode())) * 31;
        String str4 = this.f82494d;
        int hashCode4 = (hashCode3 + (str4 == null ? 0 : str4.hashCode())) * 31;
        String str5 = this.f82495e;
        int hashCode5 = (hashCode4 + (str5 == null ? 0 : str5.hashCode())) * 31;
        String str6 = this.f82496f;
        int hashCode6 = (hashCode5 + (str6 == null ? 0 : str6.hashCode())) * 31;
        Boolean bool = this.f82497g;
