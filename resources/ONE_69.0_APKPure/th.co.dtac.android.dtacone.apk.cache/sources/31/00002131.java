...
public final class AudioConfigUtil {
    /* renamed from: a */
    public static /* synthetic */ int m62020a(int i, Integer num, Integer num2) {
        return m62019b(i, num, num2);
    }

    /* renamed from: b */
    public static /* synthetic */ int m62019b(int i, Integer num, Integer num2) {
        float signum;
    ...
    /* renamed from: c */
    public static int m62018c(AudioSpec audioSpec) {
        int source = audioSpec.getSource();
        if (source == -1) {
            Logger.m63178d("AudioConfigUtil", "Using default AUDIO source: 5");
            return 5;
        }
        Logger.m63178d("AudioConfigUtil", "Using provided AUDIO source: " + source);
        return source;
    }

    /* renamed from: d */
    public static int m62017d(AudioSpec audioSpec) {
        int sourceFormat = audioSpec.getSourceFormat();
        if (sourceFormat == -1) {
            Logger.m63178d("AudioConfigUtil", "Using default AUDIO source format: 2");
            return 2;
        }
        Logger.m63178d("AudioConfigUtil", "Using provided AUDIO source format: " + sourceFormat);
        return sourceFormat;
    }

    /* renamed from: e */
    public static int m62016e(int i, int i2, int i3, int i4, int i5, Range range) {
        String str;
        Integer num;
        ...
        Logger.m63178d("AudioConfigUtil", str);
        return doubleValue;
    }

    /* renamed from: f */
    public static int m62015f(Range range, int i, int i2, final int i3) {
        ...
        while (true) {
            if (range.contains((Range) Integer.valueOf(i5))) {
                ...
                Logger.m63178d("AudioConfigUtil", "Sample rate " + i5 + "Hz is not supported by audio source with channel count " + i + " and source format " + i2);
            } else {
                Logger.m63178d("AudioConfigUtil", "Sample rate " + i5 + "Hz is not in target range " + range);
            }
            if (arrayList == null) {
                Logger.m63178d("AudioConfigUtil", "Trying common sample rates in proximity order to target " + i3 + "Hz");
                ...
                Collections.sort(arrayList, new Comparator() { // from class: l7
                    ...
                    public final int compare(Object obj, Object obj2) {
                        return AudioConfigUtil.m62020a(i3, (Integer) obj, (Integer) obj2);
                    }
                });
            }
            if (i4 < arrayList.size()) {
                ...
                Logger.m63178d("AudioConfigUtil", "No sample rate found in target range or supported by audio source. Falling back to default sample rate of 44100Hz");
                return 44100;
            }
        }
    }
    ...
    */
    public static androidx.camera.video.internal.config.AudioMimeInfo resolveAudioMimeInfo(@androidx.annotation.NonNull androidx.camera.video.MediaSpec r8, @androidx.annotation.Nullable androidx.camera.video.internal.VideoValidatedEncoderProfilesProxy r9) {
        /*
            ...
            androidx.camera.core.Logger.m63178d(r6, r8)
            goto Lca
        L51:
