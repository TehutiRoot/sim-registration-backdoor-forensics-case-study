...
@DebugMetadata(m29093c = "coil.disk.DiskLruCache$launchCleanup$1", m29092f = "DiskLruCache.kt", m29091i = {}, m29090l = {}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ...
            synchronized (diskLruCache) {
                z = diskLruCache.f40536n;
                if (z) {
                    z2 = diskLruCache.f40537o;
                    if (!z2) {
                        try {
                            diskLruCache.m51088q();
                        } catch (IOException unused) {
                            diskLruCache.f40538p = true;
                        }
                        try {
                            m51096i = diskLruCache.m51096i();
                            if (m51096i) {
                                diskLruCache.m51086s();
                            }
                        } catch (IOException unused2) {
                            diskLruCache.f40539q = true;
                            diskLruCache.f40534l = Okio.buffer(Okio.blackhole());
                        }
