...
public class DualECSP800DRBG implements SP80090DRBG {
    ...
    /* renamed from: _P */
    private ECPoint f75326_P;

    /* renamed from: _Q */
    private ECPoint f75327_Q;
    ...
    public int generate(byte[] bArr, byte[] bArr2, boolean z) {
        ...
        BigInteger bigInteger = bArr2 != null ? new BigInteger(1, xor(this.f75328_s, Utils.hash_df(this._digest, bArr2, this._seedlen))) : new BigInteger(1, this.f75328_s);
        int i = 0;
        Arrays.fill(bArr, (byte) 0);
        int i2 = 0;
        for (int i3 = 0; i3 < length2; i3++) {
            bigInteger = getScalarMultipleXCoord(this.f75326_P, bigInteger);
            byte[] byteArray = getScalarMultipleXCoord(this.f75327_Q, bigInteger).toByteArray();
        ...
        if (i2 < bArr.length) {
            bigInteger = getScalarMultipleXCoord(this.f75326_P, bigInteger);
            byte[] byteArray2 = getScalarMultipleXCoord(this.f75327_Q, bigInteger).toByteArray();
        ...
        this.f75328_s = BigIntegers.asUnsignedByteArray(this._sLength, getScalarMultipleXCoord(this.f75326_P, bigInteger));
        return length;
    }
    ...
    public void reseed(byte[] bArr) {
        ...
        this.f75328_s = Utils.hash_df(this._digest, Arrays.concatenate(pad8(this.f75328_s, this._seedlen), getEntropy(), bArr), this._seedlen);
        this._reseedCounter = 0L;
    }

    /* JADX WARN: Code restructure failed: missing block: B:20:0x0076, code lost:
        if (r2.f75326_P == null) goto L22;
     */
    ...
    */
    public DualECSP800DRBG(org.bouncycastle.crypto.prng.drbg.DualECPoints[] r3, org.bouncycastle.crypto.Digest r4, int r5, org.bouncycastle.crypto.prng.EntropySource r6, byte[] r7, byte[] r8) {
        ...
        L71:
            ...
            goto L2f
        L74:
            org.bouncycastle.math.ec.ECPoint r3 = r2.f75326_P
            if (r3 == 0) goto L8a
