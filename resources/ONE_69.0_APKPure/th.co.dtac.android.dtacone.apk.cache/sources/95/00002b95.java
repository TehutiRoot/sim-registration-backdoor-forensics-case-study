...
public final class MinimumInteractiveComponentSizeModifier$measure$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke2(@NotNull Placeable.PlacementScope layout) {
        ...
        Placeable.PlacementScope.place$default(layout, this.$placeable, AbstractC22237sr0.roundToInt((this.$width - this.$placeable.getWidth()) / 2.0f), AbstractC22237sr0.roundToInt((this.$height - this.$placeable.getHeight()) / 2.0f), 0.0f, 4, null);
    }
}