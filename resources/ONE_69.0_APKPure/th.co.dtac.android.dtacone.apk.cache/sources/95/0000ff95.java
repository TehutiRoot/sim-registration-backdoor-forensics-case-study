...
public class McElieceCipher implements MessageEncryptor {
    ...
    private GF2Vector computeMessageRepresentative(byte[] bArr) {
        byte[] bArr2 = new byte[this.maxPlainTextSize + ((this.f75611k & 7) != 0 ? 1 : 0)];
        System.arraycopy(bArr, 0, bArr2, 0, bArr.length);
        bArr2[bArr.length] = 1;
        return GF2Vector.OS2VP(this.f75611k, bArr2);
    }

    private void initCipherDecrypt(McEliecePrivateKeyParameters mcEliecePrivateKeyParameters) {
        this.f75612n = mcEliecePrivateKeyParameters.getN();
        int k = mcEliecePrivateKeyParameters.getK();
        this.f75611k = k;
        this.maxPlainTextSize = k >> 3;
        this.cipherTextSize = this.f75612n >> 3;
    }

    private void initCipherEncrypt(McEliecePublicKeyParameters mcEliecePublicKeyParameters) {
        this.f75612n = mcEliecePublicKeyParameters.getN();
        this.f75611k = mcEliecePublicKeyParameters.getK();
        this.f75614t = mcEliecePublicKeyParameters.getT();
        this.cipherTextSize = this.f75612n >> 3;
        this.maxPlainTextSize = this.f75611k >> 3;
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (!z) {
            ...
            this.f75613sr = CryptoServicesRegistrar.getSecureRandom();
            ...
            this.f75613sr = parametersWithRandom.getRandom();
    ...
    public byte[] messageDecrypt(byte[] bArr) throws InvalidCipherTextException {
        ...
        GF2Vector OS2VP = GF2Vector.OS2VP(this.f75612n, bArr);
        ...
        return computeMessage((GF2Vector) sInv.leftMultiply(((GF2Vector) ((GF2Vector) gF2Vector.add(syndromeDecode)).multiply(p1)).extractRightVector(this.f75611k)));
    }
    ...
    public byte[] messageEncrypt(byte[] bArr) {
        if (this.forEncryption) {
            ...
            return ((GF2Vector) ((McEliecePublicKeyParameters) this.key).getG().leftMultiply(computeMessageRepresentative).add(new GF2Vector(this.f75612n, this.f75614t, this.f75613sr))).getEncoded();
        }
        throw new IllegalStateException("cipher initialised for decryption");
    }
}