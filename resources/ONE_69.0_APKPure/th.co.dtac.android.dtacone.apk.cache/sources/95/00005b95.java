...
public final class TextFieldMeasurePolicy$measure$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke2(@NotNull Placeable.PlacementScope layout) {
        ...
        if (placeable != null) {
            ...
            z2 = this.this$0.f26451a;
            int i3 = this.$topPaddingValue;
            int height = i3 + this.$labelPlaceable.getHeight();
            f = this.this$0.f26452b;
            TextFieldKt.m60410c(layout, i, i2, placeable2, placeable, placeable3, placeable4, placeable5, placeable6, placeable7, placeable8, placeable9, z2, i3, height, f, this.$this_measure.getDensity());
            return;
        }
        int i4 = this.$width;
        ...
        z = this.this$0.f26451a;
        float density = this.$this_measure.getDensity();
        paddingValues = this.this$0.f26453c;
        TextFieldKt.m60409d(layout, i4, i5, placeable10, placeable11, placeable12, placeable13, placeable14, placeable15, placeable16, placeable17, z, density, paddingValues);
    }
}