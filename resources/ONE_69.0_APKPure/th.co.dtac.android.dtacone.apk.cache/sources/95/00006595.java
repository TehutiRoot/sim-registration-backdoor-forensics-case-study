...
@Metadata(m29143d1 = {"\u0000P\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0010$\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0001\u0018\u0000 %2\u00020\u0001:\u0001\u0017BB\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0005\u001a\u00020\u0004\u0012\u001c\b\u0002\u0010\n\u001a\u0016\u0012\u0010\u0012\u000e\u0012\u0004\u0012\u00020\b\u0012\u0004\u0012\u00020\t0\u0007\u0018\u00010\u0006\u0012\b\b\u0002\u0010\f\u001a\u00020\u000bø\u0001\u0000¢\u0006\u0004\b\r\u0010\u000eJ-\u0010\u0016\u001a\u00020\u00132\u0006\u0010\u000f\u001a\u00020\b2\u0006\u0010\u0010\u001a\u00020\t2\u0006\u0010\u0012\u001a\u00020\u0011H\u0016ø\u0001\u0001ø\u0001\u0000¢\u0006\u0004\b\u0014\u0010\u0015R\u0017\u0010\f\u001a\u00020\u000b8\u0006¢\u0006\f\n\u0004\b\u0017\u0010\u0018\u001a\u0004\b\u0019\u0010\u001aR \u0010\u001f\u001a\u000e\u0012\u0004\u0012\u00020\u001c\u0012\u0004\u0012\u00020\u00130\u001b8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u001d\u0010\u001eR\u001a\u0010\u0003\u001a\u00020 8\u0016X\u0096\u0004¢\u0006\f\n\u0004\b!\u0010\"\u001a\u0004\b#\u0010$\u0082\u0002\u000b\n\u0002\b\u0019\n\u0005\b¡\u001e0\u0001¨\u0006&"}, m29142d2 = {"Landroidx/compose/ui/text/platform/AndroidFontListTypeface;", "Landroidx/compose/ui/text/platform/AndroidTypeface;", "Landroidx/compose/ui/text/font/FontListFontFamily;", "fontFamily", "Landroid/content/Context;", CoreConstants.CONTEXT_SCOPE_VALUE, "", "Lkotlin/Pair;", "Landroidx/compose/ui/text/font/FontWeight;", "Landroidx/compose/ui/text/font/FontStyle;", "necessaryStyles", "Landroidx/compose/ui/text/font/FontMatcher;", "fontMatcher", "<init>", "(Landroidx/compose/ui/text/font/FontListFontFamily;Landroid/content/Context;Ljava/util/List;Landroidx/compose/ui/text/font/FontMatcher;)V", "fontWeight", "fontStyle", "Landroidx/compose/ui/text/font/FontSynthesis;", "synthesis", "Landroid/graphics/Typeface;", "getNativeTypeface-PYhJU0U", "(Landroidx/compose/ui/text/font/FontWeight;II)Landroid/graphics/Typeface;", "getNativeTypeface", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/text/font/FontMatcher;", "getFontMatcher", "()Landroidx/compose/ui/text/font/FontMatcher;", "", "Landroidx/compose/ui/text/font/Font;", OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, "Ljava/util/Map;", "loadedTypefaces", "Landroidx/compose/ui/text/font/FontFamily;", OperatorName.CURVE_TO, "Landroidx/compose/ui/text/font/FontFamily;", "getFontFamily", "()Landroidx/compose/ui/text/font/FontFamily;", "d", "ui-text_release"}, m29141k = 1, m29140mv = {1, 8, 0})
...
public final class AndroidFontListTypeface implements AndroidTypeface {
    ...
    /* renamed from: d */
    public static final C3608a f31563d = new C3608a(null);

    /* renamed from: e */
    public static final FontMatcher f31564e = new FontMatcher();

    /* renamed from: a */
    public final FontMatcher f31565a;

    /* renamed from: b */
    public final Map f31566b;

    /* renamed from: c */
    public final FontFamily f31567c;
    ...
    */
    public AndroidFontListTypeface(@org.jetbrains.annotations.NotNull androidx.compose.p003ui.text.font.FontListFontFamily r8, @org.jetbrains.annotations.NotNull android.content.Context r9, @org.jetbrains.annotations.Nullable java.util.List<kotlin.Pair<androidx.compose.p003ui.text.font.FontWeight, androidx.compose.p003ui.text.font.FontStyle>> r10, @org.jetbrains.annotations.NotNull androidx.compose.p003ui.text.font.FontMatcher r11) {
        ...
        L27:
            ...
            int r5 = r5.mo73442getLoadingStrategyPKNRLFQ()
            ...
            int r6 = r6.m73487getBlockingPKNRLFQ()
            boolean r5 = androidx.compose.p003ui.text.font.FontLoadingStrategy.m73482equalsimpl0(r5, r6)
            if (r5 == 0) goto L43
            r0.add(r4)
        L43:
            int r3 = r3 + 1
        ...
        L56:
            ...
            int r4 = r4.m73498unboximpl()
            androidx.compose.ui.text.font.FontMatcher r6 = r7.f31565a
            java.util.List r4 = r6.m73491matchFontRetOiIg(r0, r5, r4)
    ...
    public Typeface mo73612getNativeTypefacePYhJU0U(@NotNull FontWeight fontWeight, int i, int i2) {
        ...
        Font font = (Font) CollectionsKt___CollectionsKt.firstOrNull((List<? extends Object>) this.f31565a.m73491matchFontRetOiIg(new ArrayList(this.f31566b.keySet()), fontWeight, i));
        if (font != null) {
            Typeface typeface = (Typeface) this.f31566b.get(font);
            if (typeface != null) {
                Object m73514synthesizeTypefaceFxwP2eA = FontSynthesis_androidKt.m73514synthesizeTypefaceFxwP2eA(i2, typeface, font, fontWeight, i);
                Intrinsics.checkNotNull(m73514synthesizeTypefaceFxwP2eA, "null cannot be cast to non-null type android.graphics.Typeface");
                return (Typeface) m73514synthesizeTypefaceFxwP2eA;
            }
    ...
    public /* synthetic */ AndroidFontListTypeface(FontListFontFamily fontListFontFamily, Context context, List list, FontMatcher fontMatcher, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(fontListFontFamily, context, (i & 4) != 0 ? null : list, (i & 8) != 0 ? f31564e : fontMatcher);
    }
}