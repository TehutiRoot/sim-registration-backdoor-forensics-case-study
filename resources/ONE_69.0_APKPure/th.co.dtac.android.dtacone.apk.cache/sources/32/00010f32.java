...
public final class BuyDolPriceListAdapter extends RecyclerView.Adapter<PriceViewHolder> {
    ...
    public final class PriceViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: a */
        public final ZEpinItemRowBinding f81120a;

        /* renamed from: b */
        public final OnClickPrice f81121b;

        /* renamed from: c */
        public final /* synthetic */ BuyDolPriceListAdapter f81122c;
        ...
        public PriceViewHolder(@NotNull BuyDolPriceListAdapter buyDolPriceListAdapter, @Nullable ZEpinItemRowBinding binding, OnClickPrice<BuyDolPriceList.PriceListData> onClickPrice) {
            ...
            this.f81122c = buyDolPriceListAdapter;
            this.f81120a = binding;
            this.f81121b = onClickPrice;
        }

        /* renamed from: b */
        public static /* synthetic */ void m20598b(BuyDolPriceListAdapter buyDolPriceListAdapter, RadioGroup radioGroup, int i) {
            m20596d(buyDolPriceListAdapter, radioGroup, i);
        }

        /* renamed from: c */
        public static /* synthetic */ void m20597c(PriceViewHolder priceViewHolder, BuyDolPriceList buyDolPriceList, View view) {
            m20595e(priceViewHolder, buyDolPriceList, view);
        }

        /* renamed from: d */
        public static final void m20596d(BuyDolPriceListAdapter this$0, RadioGroup radioGroup, int i) {
            RadioGroup radioGroup2;
            Intrinsics.checkNotNullParameter(this$0, "this$0");
            if (this$0.f81117b != radioGroup && (radioGroup2 = this$0.f81117b) != null) {
                radioGroup2.clearCheck();
            }
            this$0.f81117b = radioGroup;
        }

        /* renamed from: e */
        public static final void m20595e(PriceViewHolder this$0, BuyDolPriceList buyDolPriceList, View view) {
            BuyDolPriceList.PriceListData priceListData;
            List<BuyDolPriceList.PriceListData> prices;
            Intrinsics.checkNotNullParameter(this$0, "this$0");
            OnClickPrice onClickPrice = this$0.f81121b;
        ...
        public final void bind(@Nullable final BuyDolPriceList buyDolPriceList) {
            ...
            ZEpinItemRowBinding zEpinItemRowBinding = this.f81120a;
            final BuyDolPriceListAdapter buyDolPriceListAdapter = this.f81122c;
            ...
            zEpinItemRowBinding.rdbGroupPrice.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: bf
                ...
                public final void onCheckedChanged(RadioGroup radioGroup, int i) {
                    BuyDolPriceListAdapter.PriceViewHolder.m20598b(BuyDolPriceListAdapter.this, radioGroup, i);
                }
            });
            DtacRadioButton dtacRadioButton2 = zEpinItemRowBinding.rdbPrice;
            BuyDolPriceList.PriceListData priceListData3 = buyDolPriceListAdapter.f81119d;
            ...
            dtacRadioButton3.setOnClickListener(new View.OnClickListener() { // from class: cf
                ...
                public final void onClick(View view) {
                    BuyDolPriceListAdapter.PriceViewHolder.m20597c(BuyDolPriceListAdapter.PriceViewHolder.this, buyDolPriceList, view);
                }
            });
    ...
    public int getItemCount() {
        List<BuyDolPriceList.PriceListData> prices;
        BuyDolPriceList buyDolPriceList = this.f81116a;
        if (buyDolPriceList != null && (prices = buyDolPriceList.getPrices()) != null) {
            return prices.size();
        }
        return 0;
    ...
    public PriceViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int i) {
        ...
        return new PriceViewHolder(this, inflate, this.f81118c);
    }
}