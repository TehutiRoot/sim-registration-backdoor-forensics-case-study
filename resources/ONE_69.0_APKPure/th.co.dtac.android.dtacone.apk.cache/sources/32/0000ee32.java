...
public abstract class FileHandle implements Closeable {
    ...
    /* renamed from: d */
    public final ReentrantLock f72899d = _JvmPlatformKt.newLock();
    ...
    public static final class C12468a implements Sink {
        ...
        /* renamed from: a */
        public final FileHandle f72900a;
        ...
        public C12468a(FileHandle fileHandle, long j) {
            ...
            this.f72900a = fileHandle;
            this.f72901b = j;
        }

        /* renamed from: b */
        public final boolean m26028b() {
            return this.f72902c;
        }
        ...
        public void close() {
            ...
            this.f72902c = true;
            ReentrantLock lock = this.f72900a.getLock();
            lock.lock();
            try {
                FileHandle fileHandle = this.f72900a;
                fileHandle.f72898c--;
                if (this.f72900a.f72898c == 0 && this.f72900a.f72897b) {
                    Unit unit = Unit.INSTANCE;
                    lock.unlock();
                    this.f72900a.protectedClose();
                }
            } finally {
                lock.unlock();
            }
        ...
        /* renamed from: d */
        public final FileHandle m26027d() {
            return this.f72900a;
        }
        ...
        /* renamed from: g */
        public final void m26026g(long j) {
            this.f72901b = j;
        }
        ...
        public void write(Buffer source, long j) {
            ...
            if (!this.f72902c) {
                this.f72900a.m26029d(this.f72901b, source, j);
                this.f72901b += j;
                return;
            }
            throw new IllegalStateException("closed".toString());
    ...
    public static final class C12469b implements Source {
        ...
        /* renamed from: a */
        public final FileHandle f72903a;
        ...
        public C12469b(FileHandle fileHandle, long j) {
            Intrinsics.checkNotNullParameter(fileHandle, "fileHandle");
            this.f72903a = fileHandle;
            this.f72904b = j;
        }

        /* renamed from: b */
        public final boolean m26025b() {
            return this.f72905c;
        }
        ...
        public void close() {
            ...
            this.f72905c = true;
            ReentrantLock lock = this.f72903a.getLock();
            lock.lock();
            try {
                FileHandle fileHandle = this.f72903a;
                fileHandle.f72898c--;
                if (this.f72903a.f72898c == 0 && this.f72903a.f72897b) {
                    Unit unit = Unit.INSTANCE;
                    lock.unlock();
                    this.f72903a.protectedClose();
                }
            } finally {
                lock.unlock();
            }
        ...
        /* renamed from: d */
        public final FileHandle m26024d() {
            return this.f72903a;
        }

        /* renamed from: g */
        public final void m26023g(long j) {
            this.f72904b = j;
        }
        ...
        public long read(Buffer sink, long j) {
            ...
            if (!this.f72905c) {
                long m26030b = this.f72903a.m26030b(this.f72904b, sink, j);
                if (m26030b != -1) {
                    this.f72904b += m26030b;
                }
                return m26030b;
            }
            throw new IllegalStateException("closed".toString());
    ...
    /* renamed from: b */
    public final long m26030b(long j, Buffer buffer, long j2) {
        int i;
        if (j2 >= 0) {
            long j3 = j2 + j;
            long j4 = j;
    ...
    public final void close() throws IOException {
        ReentrantLock reentrantLock = this.f72899d;
        reentrantLock.lock();
        try {
            if (this.f72897b) {
                return;
    ...
    /* renamed from: d */
    public final void m26029d(long j, Buffer buffer, long j2) {
    ...
    public final long position(@NotNull Source source) throws IOException {
        ...
        if ((source instanceof C12469b) && ((C12469b) source).m26024d() == this) {
    ...
    public final void reposition(@NotNull Source source, long j) throws IOException {
        ...
        if (source instanceof RealBufferedSource) {
            ...
            if ((source2 instanceof C12469b) && ((C12469b) source2).m26024d() == this) {
            ...
            throw new IllegalArgumentException("source was not created by this FileHandle".toString());
        } else if ((source instanceof C12469b) && ((C12469b) source).m26024d() == this) {
    ...
    public final long position(@NotNull Sink sink) throws IOException {
        ...
        if ((sink instanceof C12468a) && ((C12468a) sink).m26027d() == this) {
    ...
    public final void reposition(@NotNull Sink sink, long j) throws IOException {
        ...
        if (sink instanceof RealBufferedSink) {
            ...
            if ((sink2 instanceof C12468a) && ((C12468a) sink2).m26027d() == this) {
            ...
            throw new IllegalArgumentException("sink was not created by this FileHandle".toString());
        } else if ((sink instanceof C12468a) && ((C12468a) sink).m26027d() == this) {
