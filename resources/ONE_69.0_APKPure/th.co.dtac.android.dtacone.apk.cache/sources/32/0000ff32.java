...
public abstract class Mont256 {
    ...
    /* renamed from: M */
    private static final long f75539M = 4294967295L;
    ...
    public static void multAdd(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4, int i) {
        ...
        while (i2 < 8) {
            ...
            long j3 = j2 * j;
            long j4 = (j3 & 4294967295L) + (iArr3[c] & 4294967295L);
            long j5 = j;
            long j6 = (((int) j4) * i) & 4294967295L;
            int i4 = i2;
            int i5 = i3;
            ...
            for (int i7 = 8; i6 < i7; i7 = 8) {
                long j9 = (iArr2[i6] & 4294967295L) * j2;
    ...
    public static void reduce(int[] iArr, int[] iArr2, int i) {
        ...
        while (i2 < 8) {
            ...
            long j2 = (((iArr2[c] & 4294967295L) * j) + (i3 & 4294967295L)) >>> 32;
            int i4 = 1;
            while (i4 < 8) {
