...
/* renamed from: th.co.dtac.android.dtacone.view.fragment.mrtr_postpaid_registration.camera.MrtrPostpaidCommonFragment$initObservers$1$4 */
/* loaded from: classes9.dex */
public final class MrtrPostpaidCommonFragment$initObservers$1$4 extends Lambda implements Function1<Resource<? extends ErrorCollection>, Unit> {
    final /* synthetic */ MrtrPostpaidCommonFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrPostpaidCommonFragment$initObservers$1$4(MrtrPostpaidCommonFragment mrtrPostpaidCommonFragment) {
        super(1);
    ...
    public final void invoke2(Resource<ErrorCollection> resource) {
        ...
        MrtrPostpaidCommonFragment mrtrPostpaidCommonFragment = this.this$0;
        if (resourceContentIfNotHandled.getStatus() == StatusResource.ERROR) {
            mrtrPostpaidCommonFragment.m6006u();
        }
    }
}