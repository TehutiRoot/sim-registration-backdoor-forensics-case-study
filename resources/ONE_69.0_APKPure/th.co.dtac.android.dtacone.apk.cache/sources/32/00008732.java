...
public class JacksonAnnotationIntrospector extends AnnotationIntrospector implements Serializable {
    ...
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C6092a {
        ...
        static {
            ...
            try {
                f43359a[JsonSerialize.Inclusion.NON_NULL.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f43359a[JsonSerialize.Inclusion.NON_DEFAULT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f43359a[JsonSerialize.Inclusion.NON_EMPTY.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f43359a[JsonSerialize.Inclusion.DEFAULT_INCLUSION.ordinal()] = 5;
    ...
    private JsonInclude.Value _refinePropertyInclusion(Annotated annotated, JsonInclude.Value value) {
        ...
        if (jsonSerialize != null) {
            int i = C6092a.f43359a[jsonSerialize.include().ordinal()];
            if (i != 1) {
                if (i != 2) {
                    if (i != 3) {
                        if (i == 4) {
    ...
    public TypeResolverBuilder<?> _findTypeResolver(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) {
        ...
        if (jsonTypeResolver != null) {
            ...
            if (jsonTypeInfo.use() == JsonTypeInfo.EnumC6064Id.NONE) {
        ...
        JsonTypeInfo.EnumC6063As include = jsonTypeInfo.include();
        if (include == JsonTypeInfo.EnumC6063As.EXTERNAL_PROPERTY && (annotated instanceof AnnotatedClass)) {
            include = JsonTypeInfo.EnumC6063As.PROPERTY;
        }
    ...
    public JsonInclude.Value findPropertyInclusion(Annotated annotated) {
        ...
        if (jsonInclude == null) {
            from = JsonInclude.Value.empty();
        } else {
            from = JsonInclude.Value.from(jsonInclude);
        }
        if (from.getValueInclusion() == JsonInclude.Include.USE_DEFAULTS) {
            return _refinePropertyInclusion(annotated, from);
        }
        return from;
    }
    ...
    public JavaType refineDeserializationType(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) throws JsonMappingException {
        Class<?> _classIfExplicit;
        Class<?> _classIfExplicit2;
        Class<?> _classIfExplicit3;
        TypeFactory typeFactory = mapperConfig.getTypeFactory();
        JsonDeserialize jsonDeserialize = (JsonDeserialize) _findAnnotation(annotated, JsonDeserialize.class);
        if (jsonDeserialize == null) {
            _classIfExplicit = null;
        } else {
            _classIfExplicit = _classIfExplicit(jsonDeserialize.m49482as());
        }
        ...
        if (javaType.isMapLikeType()) {
            ...
            if (jsonDeserialize == null) {
                _classIfExplicit3 = null;
            } else {
                _classIfExplicit3 = _classIfExplicit(jsonDeserialize.keyAs());
            }
            if (_classIfExplicit3 != null && !_primitiveAndWrapper(keyType, _classIfExplicit3)) {
                try {
                    javaType = ((MapLikeType) javaType).withKeyType(typeFactory.constructSpecializedType(keyType, _classIfExplicit3));
                } catch (IllegalArgumentException e2) {
                    throw new JsonMappingException((Closeable) null, String.format("Failed to narrow key type of %s with concrete-type annotation (value %s), from '%s': %s", javaType, _classIfExplicit3.getName(), annotated.getName(), e2.getMessage()), e2);
                }
            }
        }
        ...
        if (contentType != null) {
            if (jsonDeserialize == null) {
                _classIfExplicit2 = null;
            } else {
                _classIfExplicit2 = _classIfExplicit(jsonDeserialize.contentAs());
            }
            if (_classIfExplicit2 != null && !_primitiveAndWrapper(contentType, _classIfExplicit2)) {
                try {
                    return javaType.withContentType(typeFactory.constructSpecializedType(contentType, _classIfExplicit2));
                } catch (IllegalArgumentException e3) {
                    throw new JsonMappingException((Closeable) null, String.format("Failed to narrow value type of %s with concrete-type annotation (value %s), from '%s': %s", javaType, _classIfExplicit2.getName(), annotated.getName(), e3.getMessage()), e3);
                }
            }
            return javaType;
        }
    ...
    public JavaType refineSerializationType(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) throws JsonMappingException {
        ...
        if (jsonSerialize == null) {
            ...
            _classIfExplicit = _classIfExplicit(jsonSerialize.m49481as());
        }
        ...
        if (javaType.isMapLikeType()) {
            ...
            if (jsonSerialize == null) {
                ...
                _classIfExplicit3 = _classIfExplicit(jsonSerialize.keyAs());
            }
            if (_classIfExplicit3 != null) {
                if (keyType.hasRawClass(_classIfExplicit3)) {
                    withStaticTyping2 = keyType.withStaticTyping();
                } else {
                    Class<?> rawClass2 = keyType.getRawClass();
                    try {
                        if (_classIfExplicit3.isAssignableFrom(rawClass2)) {
                            withStaticTyping2 = typeFactory.constructGeneralizedType(keyType, _classIfExplicit3);
                        } else if (rawClass2.isAssignableFrom(_classIfExplicit3)) {
                            withStaticTyping2 = typeFactory.constructSpecializedType(keyType, _classIfExplicit3);
                        } else if (_primitiveAndWrapper(rawClass2, _classIfExplicit3)) {
                            withStaticTyping2 = keyType.withStaticTyping();
                        } else {
                            throw new JsonMappingException((Closeable) null, String.format("Cannot refine serialization key type %s into %s; types not related", keyType, _classIfExplicit3.getName()));
                        }
                    } catch (IllegalArgumentException e2) {
                        throw new JsonMappingException((Closeable) null, String.format("Failed to widen key type of %s with concrete-type annotation (value %s), from '%s': %s", javaType, _classIfExplicit3.getName(), annotated.getName(), e2.getMessage()), e2);
                    }
                }
        ...
        if (contentType != null) {
            if (jsonSerialize == null) {
                ...
                _classIfExplicit2 = _classIfExplicit(jsonSerialize.contentAs());
            }
            if (_classIfExplicit2 != null) {
                if (contentType.hasRawClass(_classIfExplicit2)) {
                    withStaticTyping = contentType.withStaticTyping();
                } else {
                    Class<?> rawClass3 = contentType.getRawClass();
                    try {
                        if (_classIfExplicit2.isAssignableFrom(rawClass3)) {
                            withStaticTyping = typeFactory.constructGeneralizedType(contentType, _classIfExplicit2);
                        } else if (rawClass3.isAssignableFrom(_classIfExplicit2)) {
                            withStaticTyping = typeFactory.constructSpecializedType(contentType, _classIfExplicit2);
                        } else if (_primitiveAndWrapper(rawClass3, _classIfExplicit2)) {
                            withStaticTyping = contentType.withStaticTyping();
                        } else {
                            throw new JsonMappingException((Closeable) null, String.format("Cannot refine serialization content type %s into %s; types not related", contentType, _classIfExplicit2.getName()));
                        }
                    } catch (IllegalArgumentException e3) {
                        throw new JsonMappingException((Closeable) null, String.format("Internal error: failed to refine value type of %s with concrete-type annotation (value %s), from '%s': %s", javaType, _classIfExplicit2.getName(), annotated.getName(), e3.getMessage()), e3);
                    }
                }
