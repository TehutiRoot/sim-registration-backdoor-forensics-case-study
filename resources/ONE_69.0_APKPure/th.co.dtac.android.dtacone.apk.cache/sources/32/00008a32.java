...
public final class TimeModule_EventClockFactory implements Factory<Clock> {
    ...
    public static final class C6284a {
        ...
        /* renamed from: a */
        public static final TimeModule_EventClockFactory f44251a = new TimeModule_EventClockFactory();
    }

    public static TimeModule_EventClockFactory create() {
        return C6284a.f44251a;
    }

    public static Clock eventClock() {
        return (Clock) Preconditions.checkNotNullFromProvides(TimeModule.m48964a());
    }
