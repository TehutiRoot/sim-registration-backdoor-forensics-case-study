...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_postpaid_registration.MrtrPostpaidRegistrationViewModel$callAPICheckBlacklistSharing$2 */
/* loaded from: classes9.dex */
public final class MrtrPostpaidRegistrationViewModel$callAPICheckBlacklistSharing$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ MrtrPostpaidRegistrationViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrPostpaidRegistrationViewModel$callAPICheckBlacklistSharing$2(MrtrPostpaidRegistrationViewModel mrtrPostpaidRegistrationViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable throwable) {
        ...
        mrtrErrorService.handleException(throwable, new MrtrErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.viewmodel.mrtr_postpaid_registration.MrtrPostpaidRegistrationViewModel$callAPICheckBlacklistSharing$2.1
            ...
            public void handle(@NotNull Throwable e) {
                ...
                if (!Intrinsics.areEqual(mrtrErrorService2.getErrorCode(e), "10055613")) {
                    m2294Q = MrtrPostpaidRegistrationViewModel.this.m2294Q();
                    m2294Q.postValue(Resource.Companion.success(null));
                    return;
                }
                ErrorCollection errorCollection = new ErrorCollection();
                if (!(e instanceof ServerErrorException)) {
                    mrtrErrorService3 = MrtrPostpaidRegistrationViewModel.this.f106479g;
                ...
                m2270h0 = MrtrPostpaidRegistrationViewModel.this.m2270h0();
                m2270h0.setValue(Resource.Companion.success(errorCollection));
            }
