...
public final class PersistentHashMapKeys<K, V> extends AbstractSet<K> implements ImmutableSet<K> {
    ...
    /* renamed from: a */
    public final PersistentHashMap f28659a;
    ...
    public boolean contains(Object obj) {
        return this.f28659a.containsKey(obj);
    }
    ...
    public Iterator<K> iterator() {
        return new PersistentHashMapKeysIterator(this.f28659a.getNode$runtime_release());
    }
}