...
public final class C0965Nt {

    /* renamed from: a */
    public static final C0965Nt f4287a = new C0965Nt();

    /* renamed from: a */
    public static /* synthetic */ double m67183a(ColorSpace colorSpace, double d) {
        return m67174j(colorSpace, d);
    }

    /* renamed from: b */
    public static /* synthetic */ double m67182b(Function1 function1, double d) {
        return m67178f(function1, d);
    }

    /* renamed from: c */
    public static /* synthetic */ double m67181c(Function1 function1, double d) {
        return m67177g(function1, d);
    }

    /* renamed from: d */
    public static /* synthetic */ double m67180d(ColorSpace colorSpace, double d) {
        return m67175i(colorSpace, d);
    }
    ...
    @RequiresApi(26)
    /* renamed from: e */
    public static final ColorSpace m67179e(@NotNull androidx.compose.p003ui.graphics.colorspace.ColorSpace colorSpace) {
        ColorSpace.Named named;
        ColorSpace colorSpace2;
        ColorSpace.Rgb.TransferParameters transferParameters;
        ColorSpace.Rgb m69180a;
        ...
        if (Intrinsics.areEqual(colorSpace, colorSpaces.getSrgb())) {
            ...
            if (!(colorSpace instanceof Rgb)) {
                ...
                if (transferParameters2 != null) {
                    AbstractC0141Bt.m69033a();
                    transferParameters = AbstractC17169yt.m229a(transferParameters2.getA(), transferParameters2.getB(), transferParameters2.getC(), transferParameters2.getD(), transferParameters2.getE(), transferParameters2.getF(), transferParameters2.getGamma());
                } else {
                    transferParameters = null;
                }
                if (transferParameters != null) {
                    AbstractC0207Ct.m68907a();
                    m69180a = AbstractC17248zt.m56a(colorSpace.getName(), rgb.getPrimaries$ui_graphics_release(), xyz$ui_graphics_release, transferParameters);
                } else {
                    AbstractC0207Ct.m68907a();
                    ...
                    DoubleUnaryOperator doubleUnaryOperator = new DoubleUnaryOperator() { // from class: Jt
                        ...
                        public final double applyAsDouble(double d) {
                            return C0965Nt.m67182b(Function1.this, d);
                        }
                    };
                    final Function1<Double, Double> eotf = rgb.getEotf();
                    m69180a = AbstractC0062At.m69180a(name, primaries$ui_graphics_release, xyz$ui_graphics_release, doubleUnaryOperator, new DoubleUnaryOperator() { // from class: Kt
                        @Override // java.util.function.DoubleUnaryOperator
                        public final double applyAsDouble(double d) {
                            return C0965Nt.m67181c(Function1.this, d);
                        }
                    }, colorSpace.getMinValue(0), colorSpace.getMaxValue(0));
                }
                colorSpace2 = AbstractC1471Us.m66089a(m69180a);
            }
    ...
    /* renamed from: f */
    public static final double m67178f(Function1 tmp0, double d) {
        Intrinsics.checkNotNullParameter(tmp0, "$tmp0");
        return ((Number) tmp0.invoke(Double.valueOf(d))).doubleValue();
    }

    /* renamed from: g */
    public static final double m67177g(Function1 tmp0, double d) {
        Intrinsics.checkNotNullParameter(tmp0, "$tmp0");
        return ((Number) tmp0.invoke(Double.valueOf(d))).doubleValue();
    }
    ...
    @RequiresApi(26)
    /* renamed from: h */
    public static final androidx.compose.p003ui.graphics.colorspace.ColorSpace m67176h(@NotNull final ColorSpace colorSpace) {
        int id2;
        ColorSpace.Named named;
        int ordinal;
        ColorSpace.Named named2;
                                                        ...
                                                        if (id2 != ordinal13) {
                                                            ...
                                                            if (id2 != ordinal14) {
                                                                ...
                                                                if (id2 != ordinal15) {
                                                                    ...
                                                                    if (AbstractC5384bt.m51824a(colorSpace)) {
                                                                        transferParameters = AbstractC10020ct.m31953a(colorSpace).getTransferParameters();
                                                                        whitePoint = AbstractC10020ct.m31953a(colorSpace).getWhitePoint();
                                                                        if (whitePoint.length == 3) {
                                                                            whitePoint5 = AbstractC10020ct.m31953a(colorSpace).getWhitePoint();
                                                                            float f = whitePoint5[0];
                                                                            whitePoint6 = AbstractC10020ct.m31953a(colorSpace).getWhitePoint();
                                                                            float f2 = whitePoint6[1];
                                                                            whitePoint7 = AbstractC10020ct.m31953a(colorSpace).getWhitePoint();
                                                                            whitePoint2 = new WhitePoint(f, f2, whitePoint7[2]);
                                                                        } else {
                                                                            whitePoint3 = AbstractC10020ct.m31953a(colorSpace).getWhitePoint();
                                                                            float f3 = whitePoint3[0];
                                                                            whitePoint4 = AbstractC10020ct.m31953a(colorSpace).getWhitePoint();
                                                                        ...
                                                                        name = AbstractC10020ct.m31953a(colorSpace).getName();
                                                                        Intrinsics.checkNotNullExpressionValue(name, "this.name");
                                                                        primaries = AbstractC10020ct.m31953a(colorSpace).getPrimaries();
                                                                        Intrinsics.checkNotNullExpressionValue(primaries, "this.primaries");
                                                                        transform = AbstractC10020ct.m31953a(colorSpace).getTransform();
    ...
    /* renamed from: i */
    public static final double m67175i(ColorSpace this_composeColorSpace, double d) {
        DoubleUnaryOperator oetf;
        double applyAsDouble;
        Intrinsics.checkNotNullParameter(this_composeColorSpace, "$this_composeColorSpace");
        oetf = AbstractC10020ct.m31953a(this_composeColorSpace).getOetf();
        applyAsDouble = oetf.applyAsDouble(d);
        return applyAsDouble;
    }

    /* renamed from: j */
    public static final double m67174j(ColorSpace this_composeColorSpace, double d) {
        DoubleUnaryOperator eotf;
        double applyAsDouble;
        Intrinsics.checkNotNullParameter(this_composeColorSpace, "$this_composeColorSpace");
        eotf = AbstractC10020ct.m31953a(this_composeColorSpace).getEotf();
