...
public final class AuthRequirement extends GeneratedMessageLite<AuthRequirement, Builder> implements AuthRequirementOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<AuthRequirement, Builder> implements AuthRequirementOrBuilder {
        public /* synthetic */ Builder(C7180a c7180a) {
            this();
        }

        public Builder clearAudiences() {
            copyOnWrite();
            ((AuthRequirement) this.instance).m43343I();
            return this;
        }

        public Builder clearProviderId() {
            copyOnWrite();
            ((AuthRequirement) this.instance).m43342J();
            return this;
        }
        ...
        public Builder setAudiences(String str) {
            copyOnWrite();
            ((AuthRequirement) this.instance).m43341K(str);
            return this;
        }

        public Builder setAudiencesBytes(ByteString byteString) {
            copyOnWrite();
            ((AuthRequirement) this.instance).m43340L(byteString);
            return this;
        }

        public Builder setProviderId(String str) {
            copyOnWrite();
            ((AuthRequirement) this.instance).m43339M(str);
            return this;
        }

        public Builder setProviderIdBytes(ByteString byteString) {
            copyOnWrite();
            ((AuthRequirement) this.instance).m43338N(byteString);
            return this;
        }
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C7180a {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: K */
    public void m43341K(String str) {
        str.getClass();
        this.audiences_ = str;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: L */
    public void m43340L(ByteString byteString) {
    ...
    /* renamed from: J */
    public final void m43342J() {
        this.providerId_ = getDefaultInstance().getProviderId();
    }

    /* renamed from: M */
    public final void m43339M(String str) {
        str.getClass();
        this.providerId_ = str;
    }

    /* renamed from: N */
    public final void m43338N(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C7180a.f51612a[methodToInvoke.ordinal()]) {
            case 1:
