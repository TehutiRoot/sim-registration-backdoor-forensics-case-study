...
@DebugMetadata(m29093c = "th.co.dtac.android.dtacone.view.appOne.tol.viewmodel.OneRegisterTrueOnlineViewModel$onDeviceMeshDec$1", m29092f = "OneRegisterTrueOnlineViewModel.kt", m29091i = {}, m29090l = {}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
@SourceDebugExtension({"SMAP\nOneRegisterTrueOnlineViewModel.kt\nKotlin\n*S Kotlin\n*F\n+ 1 OneRegisterTrueOnlineViewModel.kt\nth/co/dtac/android/dtacone/view/appOne/tol/viewmodel/OneRegisterTrueOnlineViewModel$onDeviceMeshDec$1\n+ 2 StateFlow.kt\nkotlinx/coroutines/flow/StateFlowKt\n+ 3 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,2372:1\n230#2,3:2373\n233#2,2:2380\n1549#3:2376\n1620#3,3:2377\n*S KotlinDebug\n*F\n+ 1 OneRegisterTrueOnlineViewModel.kt\nth/co/dtac/android/dtacone/view/appOne/tol/viewmodel/OneRegisterTrueOnlineViewModel$onDeviceMeshDec$1\n*L\n1602#1:2373,3\n1602#1:2380,2\n1604#1:2376\n1604#1:2377,3\n*E\n"})
/* renamed from: th.co.dtac.android.dtacone.view.appOne.tol.viewmodel.OneRegisterTrueOnlineViewModel$onDeviceMeshDec$1 */
/* loaded from: classes10.dex */
public final class OneRegisterTrueOnlineViewModel$onDeviceMeshDec$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ String $meshModelCode;
    int label;
    final /* synthetic */ OneRegisterTrueOnlineViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneRegisterTrueOnlineViewModel$onDeviceMeshDec$1(OneRegisterTrueOnlineViewModel oneRegisterTrueOnlineViewModel, String str, Continuation<? super OneRegisterTrueOnlineViewModel$onDeviceMeshDec$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new OneRegisterTrueOnlineViewModel$onDeviceMeshDec$1(this.this$0, this.$meshModelCode, continuation);
    }
            ...
            do {
                ...
                if (deviceRouterItem2 != null) {
                    ...
                    for (DeviceMeshItem deviceMeshItem : deviceMeshList) {
                        if (Intrinsics.areEqual(deviceMeshItem.getMeshOfferCode(), str) && deviceMeshItem.getMeshQuantity() > 0) {
    ...
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((OneRegisterTrueOnlineViewModel$onDeviceMeshDec$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}