...
public final class TextFieldMeasurePolicy implements MeasurePolicy {
    ...
    /* renamed from: c */
    public final PaddingValues f26453c;

    public TextFieldMeasurePolicy(boolean z, float f, PaddingValues paddingValues) {
        Intrinsics.checkNotNullParameter(paddingValues, "paddingValues");
        this.f26451a = z;
        this.f26452b = f;
        this.f26453c = paddingValues;
    }

    /* renamed from: d */
    private final int m60404d(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i, Function2 function2) {
        Object obj;
        Object obj2;
        int i2;
        Object obj3;
        ...
        for (Object obj8 : list2) {
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) obj8), "TextField")) {
                ...
                if (this.f26452b == 1.0f) {
                    z = true;
                } else {
                    z = false;
                }
                m60412a = TextFieldKt.m60412a(intValue, i2, i4, i3, i5, i6, i7, i8, z, TextFieldImplKt.getZeroConstraints(), intrinsicMeasureScope.getDensity(), this.f26453c);
                return m60412a;
            }
        }
    ...
    /* renamed from: e */
    private final int m60403e(List list, int i, Function2 function2) {
        Object obj;
        Object obj2;
        int i2;
        Object obj3;
        ...
        for (Object obj7 : list2) {
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) obj7), "TextField")) {
                ...
                m60411b = TextFieldKt.m60411b(i6, i3, i4, i5, intValue, i2, i7, TextFieldImplKt.getZeroConstraints());
                return m60411b;
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    ...
    public int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List measurables, int i) {
        ...
        return m60404d(intrinsicMeasureScope, measurables, i, TextFieldMeasurePolicy$maxIntrinsicHeight$1.INSTANCE);
    }
    ...
    public int maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List measurables, int i) {
        Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
        Intrinsics.checkNotNullParameter(measurables, "measurables");
        return m60403e(measurables, i, TextFieldMeasurePolicy$maxIntrinsicWidth$1.INSTANCE);
    }
    ...
    public MeasureResult mo69380measure3p2s80s(MeasureScope measure, List measurables, long j) {
        ...
        Intrinsics.checkNotNullParameter(measurables, "measurables");
        int mo69616roundToPx0680j_4 = measure.mo69616roundToPx0680j_4(this.f26453c.mo69345calculateTopPaddingD9Ej5fM());
        int mo69616roundToPx0680j_42 = measure.mo69616roundToPx0680j_4(this.f26453c.mo69342calculateBottomPaddingD9Ej5fM());
        ...
        if (measurable3 != null) {
            ...
            placeable4 = measurable3.mo72995measureBRTryo0(ConstraintsKt.m73827offsetNN6EwU$default(m73802copyZbe2FdA$default, -widthOrZero2, 0, 2, null));
        } else {
            placeable3 = placeable2;
            placeable4 = null;
        }
        ...
        if (measurable4 != null) {
            placeable5 = measurable4.mo72995measureBRTryo0(ConstraintsKt.m73827offsetNN6EwU$default(m73802copyZbe2FdA$default, -widthOrZero3, 0, 2, null));
        } else {
            placeable5 = null;
        }
        ...
        int i3 = -widthOrZero4;
        long m73826offsetNN6EwU = ConstraintsKt.m73826offsetNN6EwU(m73802copyZbe2FdA$default, i3, -mo69616roundToPx0680j_42);
        ...
        if (measurable5 != null) {
            placeable6 = measurable5.mo72995measureBRTryo0(m73826offsetNN6EwU);
        } else {
            placeable6 = null;
        }
        int heightOrZero = TextFieldImplKt.heightOrZero(placeable6) + mo69616roundToPx0680j_4;
        long m73826offsetNN6EwU2 = ConstraintsKt.m73826offsetNN6EwU(Constraints.m73802copyZbe2FdA$default(j, 0, 0, 0, 0, 11, null), i3, (-heightOrZero) - mo69616roundToPx0680j_42);
        Iterator it7 = list.iterator();
        while (true) {
            int i4 = mo69616roundToPx0680j_4;
            if (it7.hasNext()) {
                Measurable measurable6 = (Measurable) it7.next();
                Iterator it8 = it7;
                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable6), "TextField")) {
                    Placeable mo72995measureBRTryo0 = measurable6.mo72995measureBRTryo0(m73826offsetNN6EwU2);
                    long m73802copyZbe2FdA$default2 = Constraints.m73802copyZbe2FdA$default(m73826offsetNN6EwU2, 0, 0, 0, 0, 14, null);
                    ...
                    if (measurable7 != null) {
                        placeable7 = measurable7.mo72995measureBRTryo0(m73802copyZbe2FdA$default2);
                    } else {
                        placeable7 = null;
                    }
                    long m73802copyZbe2FdA$default3 = Constraints.m73802copyZbe2FdA$default(ConstraintsKt.m73827offsetNN6EwU$default(m73802copyZbe2FdA$default, 0, -Math.max(max4, Math.max(TextFieldImplKt.heightOrZero(mo72995measureBRTryo0), TextFieldImplKt.heightOrZero(placeable7)) + heightOrZero + mo69616roundToPx0680j_42), 1, null), 0, 0, 0, 0, 11, null);
                    ...
                    if (measurable8 != null) {
                        placeable8 = measurable8.mo72995measureBRTryo0(m73802copyZbe2FdA$default3);
                    } else {
                        placeable8 = null;
                    }
                    int heightOrZero2 = TextFieldImplKt.heightOrZero(placeable8);
                    m60411b = TextFieldKt.m60411b(TextFieldImplKt.widthOrZero(placeable), TextFieldImplKt.widthOrZero(placeable3), TextFieldImplKt.widthOrZero(placeable4), TextFieldImplKt.widthOrZero(placeable5), mo72995measureBRTryo0.getWidth(), TextFieldImplKt.widthOrZero(placeable6), TextFieldImplKt.widthOrZero(placeable7), j);
                    int height = mo72995measureBRTryo0.getHeight();
                    ...
                    m60412a = TextFieldKt.m60412a(height, heightOrZero3, heightOrZero4, heightOrZero5, heightOrZero6, heightOrZero7, heightOrZero8, heightOrZero9, z, j, measure.getDensity(), this.f26453c);
                    int i5 = m60412a - heightOrZero2;
                    for (Measurable measurable9 : list) {
                        if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable9), TextFieldImplKt.ContainerId)) {
                            if (m60411b != Integer.MAX_VALUE) {
                                i = m60411b;
                            } else {
                                i = 0;
                            }
                            ...
                            return MeasureScope.CC.m59482q(measure, m60411b, m60412a, null, new TextFieldMeasurePolicy$measure$1(placeable6, m60411b, m60412a, mo72995measureBRTryo0, placeable7, placeable, placeable3, placeable4, placeable5, measurable9.mo72995measureBRTryo0(ConstraintsKt.Constraints(i, m60411b, i2, i5)), placeable8, this, i4, measure), 4, null);
                        }
                    }
                    throw new NoSuchElementException("Collection contains no element matching the predicate.");
                }
                it7 = it8;
                mo69616roundToPx0680j_4 = i4;
            } else {
                throw new NoSuchElementException("Collection contains no element matching the predicate.");
            }
        }
    ...
    public int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List measurables, int i) {
        Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
        Intrinsics.checkNotNullParameter(measurables, "measurables");
        return m60404d(intrinsicMeasureScope, measurables, i, TextFieldMeasurePolicy$minIntrinsicHeight$1.INSTANCE);
    }
    ...
    public int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List measurables, int i) {
        Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
        Intrinsics.checkNotNullParameter(measurables, "measurables");
        return m60403e(measurables, i, TextFieldMeasurePolicy$minIntrinsicWidth$1.INSTANCE);
    }
}