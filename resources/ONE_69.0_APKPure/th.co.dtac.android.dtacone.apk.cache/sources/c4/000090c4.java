...
public final class zzxe {
    ...
    static {
        ...
        for (zzxe zzxeVar52 : values) {
            zzcob[zzxeVar52.f46118id] = zzxeVar52;
        }
    }
    ...
    private zzxe(String str, int i, int i2, zzxg zzxgVar, zzxu zzxuVar) {
        ...
        this.zzcny = zzxgVar;
        this.zzcnx = zzxuVar;
        int i4 = AbstractC6424F0.f45690a[zzxgVar.ordinal()];
        boolean z = true;
        if (i4 != 1) {
            if (i4 != 2) {
                this.zzcnz = null;
        ...
        this.zzcoa = (zzxgVar != zzxg.SCALAR || (i3 = AbstractC6424F0.f45691b[zzxuVar.ordinal()]) == 1 || i3 == 2 || i3 == 3) ? false : false;
    }
    ...
    /* renamed from: id */
    public final int m47440id() {
        return this.f46118id;
    }
}