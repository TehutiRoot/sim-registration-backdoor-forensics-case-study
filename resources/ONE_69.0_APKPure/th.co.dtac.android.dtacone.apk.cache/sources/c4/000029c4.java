...
public final class SelectionManagerKt {
    ...
    /* renamed from: a */
    public static final long m60929a(SelectionManager selectionManager, long j, Selection.AnchorInfo anchorInfo, boolean z) {
        ...
        Offset m70048getCurrentDragPosition_m7T9E = selectionManager.m70048getCurrentDragPosition_m7T9E();
        Intrinsics.checkNotNull(m70048getCurrentDragPosition_m7T9E);
        float m71686getXimpl = Offset.m71686getXimpl(layoutCoordinates.mo73001localPositionOfR5De75A(containerLayoutCoordinates, m70048getCurrentDragPosition_m7T9E.m71696unboximpl()));
        long mo70020getRangeOfLineContainingjx7JFs = anchorSelectable$foundation_release.mo70020getRangeOfLineContainingjx7JFs(offset);
        Rect boundingBox = anchorSelectable$foundation_release.getBoundingBox(TextRange.m73398getMinimpl(mo70020getRangeOfLineContainingjx7JFs));
        Rect boundingBox2 = anchorSelectable$foundation_release.getBoundingBox(AbstractC11695c.coerceAtLeast(TextRange.m73397getMaximpl(mo70020getRangeOfLineContainingjx7JFs) - 1, TextRange.m73398getMinimpl(mo70020getRangeOfLineContainingjx7JFs)));
        float coerceIn = AbstractC11695c.coerceIn(m71686getXimpl, Math.min(boundingBox.getLeft(), boundingBox2.getLeft()), Math.max(boundingBox.getRight(), boundingBox2.getRight()));
        if (Math.abs(m71686getXimpl - coerceIn) > IntSize.m74002getWidthimpl(j) / 2) {
            return Offset.Companion.m71701getUnspecifiedF1C5BW0();
        }
        return containerLayoutCoordinates.mo73001localPositionOfR5De75A(layoutCoordinates, OffsetKt.Offset(coerceIn, Offset.m71687getYimpl(anchorSelectable$foundation_release.getBoundingBox(offset).m71716getCenterF1C5BW0())));
    }

    /* renamed from: calculateSelectionMagnifierCenterAndroid-O0kMr_c  reason: not valid java name */
    public static final long m70059calculateSelectionMagnifierCenterAndroidO0kMr_c(@NotNull SelectionManager manager, long j) {
        int i;
        ...
        if (i != -1) {
            if (i != 1) {
                ...
                return m60929a(manager, j, selection.getEnd(), false);
            }
            return m60929a(manager, j, selection.getStart(), true);
        }
        return Offset.Companion.m71701getUnspecifiedF1C5BW0();
    }

    /* renamed from: containsInclusive-Uv8p0NA  reason: not valid java name */
    public static final boolean m70060containsInclusiveUv8p0NA(@NotNull Rect containsInclusive, long j) {
    ...
    public static final Rect visibleBounds(@NotNull LayoutCoordinates layoutCoordinates) {
        ...
        return RectKt.m71724Rect0a9Yr6o(layoutCoordinates.mo73005windowToLocalMKHz9U(boundsInWindow.m71721getTopLeftF1C5BW0()), layoutCoordinates.mo73005windowToLocalMKHz9U(boundsInWindow.m71715getBottomRightF1C5BW0()));
    }
}