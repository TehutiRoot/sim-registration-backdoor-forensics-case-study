...
public class CallerData {
    ...
    /* renamed from: NA */
    public static final String f39637NA = "?";

    /* renamed from: a */
    public static boolean m51580a(String str, String str2, List list) {
        return str.equals(str2) || str.equals("org.apache.log4j.Category") || str.startsWith("org.slf4j.Logger") || m51579b(str, list);
    }

    /* renamed from: b */
    public static boolean m51579b(String str, List list) {
        if (list == null) {
            return false;
        }
    ...
    public static StackTraceElement[] extract(Throwable th2, String str, int i, List<String> list) {
        ...
        for (int i3 = 0; i3 < stackTrace.length; i3++) {
            if (m51580a(stackTrace[i3].getClassName(), str, list)) {
                i2 = i3 + 1;
            } else if (i2 != -1) {
                break;
            }
    ...
    public static StackTraceElement naInstance() {
        return new StackTraceElement(f39637NA, f39637NA, f39637NA, -1);
    }
}