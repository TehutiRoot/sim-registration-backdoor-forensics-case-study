...
public final class ConfigurationConstants$TraceEventCountBackground extends AbstractC17252zw {

    /* renamed from: a */
    public static ConfigurationConstants$TraceEventCountBackground f56127a;
    ...
    public static synchronized ConfigurationConstants$TraceEventCountBackground getInstance() {
        ...
        synchronized (ConfigurationConstants$TraceEventCountBackground.class) {
            try {
                if (f56127a == null) {
                    f56127a = new ConfigurationConstants$TraceEventCountBackground();
                }
                configurationConstants$TraceEventCountBackground = f56127a;
            } catch (Throwable th2) {
                throw th2;
            }
        }
