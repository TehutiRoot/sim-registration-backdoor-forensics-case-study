...
/* renamed from: th.co.dtac.android.dtacone.presenter.inactive_user.OwnerDetailPresenter$getOwnerDetail$2 */
/* loaded from: classes8.dex */
public final class OwnerDetailPresenter$getOwnerDetail$2 extends Lambda implements Function1<OwnerTransactionCollection, Unit> {
    final /* synthetic */ OwnerDetailPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OwnerDetailPresenter$getOwnerDetail$2(OwnerDetailPresenter ownerDetailPresenter) {
        super(1);
    ...
    public final void invoke2(OwnerTransactionCollection it) {
        ...
        if (it.getLastTransactions().size() > 0) {
