...
public final class ObservableGroupJoin<TLeft, TRight, TLeftEnd, TRightEnd, R> extends AbstractC11078a {

    /* renamed from: a */
    public final ObservableSource f65377a;

    /* renamed from: b */
    public final Function f65378b;

    /* renamed from: c */
    public final Function f65379c;

    /* renamed from: d */
    public final BiFunction f65380d;

    /* loaded from: classes5.dex */
    public static final class GroupJoinDisposable<TLeft, TRight, TLeftEnd, TRightEnd, R> extends AtomicInteger implements Disposable, InterfaceC10996a {
        ...
        @Override // io.reactivex.internal.operators.observable.ObservableGroupJoin.InterfaceC10996a
    ...
    public static final class LeftRightEndObserver extends AtomicReference<Disposable> implements Observer<Object>, Disposable {
        ...
        final InterfaceC10996a parent;

        public LeftRightEndObserver(InterfaceC10996a interfaceC10996a, boolean z, int i) {
            this.parent = interfaceC10996a;
            this.isLeft = z;
            this.index = i;
        }
    ...
    public static final class LeftRightObserver extends AtomicReference<Disposable> implements Observer<Object>, Disposable {
        ...
        public LeftRightObserver(InterfaceC10996a interfaceC10996a, boolean z) {
            this.parent = interfaceC10996a;
            this.isLeft = z;
        }
    ...
    public ObservableGroupJoin(ObservableSource<TLeft> observableSource, ObservableSource<? extends TRight> observableSource2, Function<? super TLeft, ? extends ObservableSource<TLeftEnd>> function, Function<? super TRight, ? extends ObservableSource<TRightEnd>> function2, BiFunction<? super TLeft, ? super Observable<TRight>, ? extends R> biFunction) {
        ...
        this.f65377a = observableSource2;
        this.f65378b = function;
        this.f65379c = function2;
        this.f65380d = biFunction;
    }

    @Override // io.reactivex.Observable
    public void subscribeActual(Observer<? super R> observer) {
        GroupJoinDisposable groupJoinDisposable = new GroupJoinDisposable(observer, this.f65378b, this.f65379c, this.f65380d);
        ...
        this.f65377a.subscribe(leftRightObserver2);
    }
}