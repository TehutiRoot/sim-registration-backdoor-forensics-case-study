...
@Metadata(m29143d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\b\b\u0000\u0010\u0002*\u00020\u0003*\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00020\u00050\u0004H\u008a@"}, m29142d2 = {"<anonymous>", "", "T", "Lio/realm/RealmModel;", "Lkotlinx/coroutines/channels/ProducerScope;", "Lio/realm/rx/ObjectChange;"}, m29141k = 3, m29140mv = {1, 6, 0}, m29138xi = 48)
@DebugMetadata(m29093c = "io.realm.internal.coroutines.InternalFlowFactory$changesetFrom$5", m29092f = "InternalFlowFactory.kt", m29091i = {}, m29090l = {569, 597}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
...
public final class InternalFlowFactory$changesetFrom$5 extends SuspendLambda implements Function2<ProducerScope<? super ObjectChange<T>>, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes5.dex */
    public static final class C113231 extends Lambda implements Function0<Unit> {
        public static final C113231 INSTANCE = new C113231();
    ...
    /* loaded from: classes5.dex */
    public static final class C113242 extends Lambda implements Function0<Unit> {
        ...
        public C113242(Realm realm, RealmModel realmModel, RealmObjectChangeListener realmObjectChangeListener) {
            super(0);
    ...
    public static final void m74255invokeSuspend$lambda0(ProducerScope producerScope, InternalFlowFactory internalFlowFactory, RealmModel realmModel, ObjectChangeSet objectChangeSet) {
        boolean z;
        if (CoroutineScopeKt.isActive(producerScope)) {
            z = internalFlowFactory.f66877a;
            if (z) {
                producerScope.mo74250trySendJP2dKIU(new ObjectChange(RealmObject.freeze(realmModel), objectChangeSet));
            } else {
                producerScope.mo74250trySendJP2dKIU(new ObjectChange(realmModel, objectChangeSet));
            }
        }
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.$realm.isClosed()) {
            C113231 c113231 = C113231.INSTANCE;
            this.label = 1;
            if (ProduceKt.awaitClose(producerScope, c113231, this) == coroutine_suspended) {
        ...
        RealmObjectChangeListener realmObjectChangeListener = new RealmObjectChangeListener() { // from class: io.realm.internal.coroutines.e
            ...
            public final void onChange(RealmModel realmModel, ObjectChangeSet objectChangeSet) {
                InternalFlowFactory$changesetFrom$5.m74255invokeSuspend$lambda0(ProducerScope.this, internalFlowFactory, realmModel, objectChangeSet);
            }
        };
        ...
        if (RealmObject.isLoaded(this.$realmObject)) {
            ...
            if (z) {
                producerScope.mo74250trySendJP2dKIU(new ObjectChange(RealmObject.freeze(this.$realmObject), null));
            } else {
                producerScope.mo74250trySendJP2dKIU(new ObjectChange(this.$realmObject, null));
            }
        }
        C113242 c113242 = new C113242(realm, this.$realmObject, realmObjectChangeListener);
        this.label = 2;
        if (ProduceKt.awaitClose(producerScope, c113242, this) == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Unit.INSTANCE;
    }
