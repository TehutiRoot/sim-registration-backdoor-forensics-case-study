...
/* renamed from: th.co.dtac.android.dtacone.presenter.bitmap.SaveBitmapPresenter$saveBitmapFromCamera$6 */
/* loaded from: classes8.dex */
public final class SaveBitmapPresenter$saveBitmapFromCamera$6 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ SaveBitmapPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SaveBitmapPresenter$saveBitmapFromCamera$6(SaveBitmapPresenter saveBitmapPresenter) {
        super(1);
