...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.deviceSaleTrueCompany.fragment.OneDeviceSaleTrueSelectPackageFragment$applyData$1$2 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleTrueSelectPackageFragment$applyData$1$2 extends Lambda implements Function1<FragmentNavEvent, Unit> {
    final /* synthetic */ OneDeviceSaleTrueSelectPackageFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneDeviceSaleTrueSelectPackageFragment$applyData$1$2(OneDeviceSaleTrueSelectPackageFragment oneDeviceSaleTrueSelectPackageFragment) {
        super(1);
    ...
    public final void invoke2(@NotNull FragmentNavEvent it) {
        ...
        m14974s = this.this$0.m14974s();
        m14974s.replaceFragment(it.buildFragment(), it.getTag());
    }
}