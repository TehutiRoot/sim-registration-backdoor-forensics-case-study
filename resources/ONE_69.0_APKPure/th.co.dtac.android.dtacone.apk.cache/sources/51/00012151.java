...
/* renamed from: th.co.dtac.android.dtacone.presenter.address.QueryAddressFromDbPresenter$getDistrict$2 */
/* loaded from: classes8.dex */
public final class QueryAddressFromDbPresenter$getDistrict$2 extends Lambda implements Function1<List<? extends AddressItemData>, Unit> {
    final /* synthetic */ QueryAddressFromDbPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public QueryAddressFromDbPresenter$getDistrict$2(QueryAddressFromDbPresenter queryAddressFromDbPresenter) {
        super(1);
