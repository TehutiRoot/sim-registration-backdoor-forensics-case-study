...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.fragment.blacklist.OnePostpaidCheckBlacklistFragment$onViewCreated$3$3 */
/* loaded from: classes10.dex */
public final class OnePostpaidCheckBlacklistFragment$onViewCreated$3$3 extends Lambda implements Function1<StatusResource, Unit> {
    final /* synthetic */ OnePostpaidCheckBlacklistFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidCheckBlacklistFragment$onViewCreated$3$3(OnePostpaidCheckBlacklistFragment onePostpaidCheckBlacklistFragment) {
        super(1);
    ...
    public final void invoke2(StatusResource statusResource) {
        OnePostpaidRegistrationActivity m12346t;
        m12346t = this.this$0.m12346t();
        m12346t.handleLoading(statusResource);
    }
}