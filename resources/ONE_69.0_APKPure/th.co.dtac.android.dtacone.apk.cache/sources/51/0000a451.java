...
public final class Context extends GeneratedMessageLite<Context, Builder> implements ContextOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Context, Builder> implements ContextOrBuilder {
        public /* synthetic */ Builder(C7191a c7191a) {
            this();
        }

        public Builder addAllRules(Iterable<? extends ContextRule> iterable) {
            copyOnWrite();
            ((Context) this.instance).m43138I(iterable);
            return this;
        }

        public Builder addRules(ContextRule contextRule) {
            copyOnWrite();
            ((Context) this.instance).m43136K(contextRule);
            return this;
        }

        public Builder clearRules() {
            copyOnWrite();
            ((Context) this.instance).m43135L();
            return this;
        }
        ...
        public Builder removeRules(int i) {
            copyOnWrite();
            ((Context) this.instance).m43133N(i);
            return this;
        }

        public Builder setRules(int i, ContextRule contextRule) {
            copyOnWrite();
            ((Context) this.instance).m43132O(i, contextRule);
            return this;
        }
        ...
        public Builder addRules(int i, ContextRule contextRule) {
            copyOnWrite();
            ((Context) this.instance).m43137J(i, contextRule);
            return this;
        }

        public Builder setRules(int i, ContextRule.Builder builder) {
            copyOnWrite();
            ((Context) this.instance).m43132O(i, builder.build());
            return this;
        }

        public Builder addRules(ContextRule.Builder builder) {
            copyOnWrite();
            ((Context) this.instance).m43136K(builder.build());
            return this;
        }

        public Builder addRules(int i, ContextRule.Builder builder) {
            copyOnWrite();
            ((Context) this.instance).m43137J(i, builder.build());
            return this;
        }
    }
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C7191a {
    ...
    /* renamed from: I */
    public void m43138I(Iterable iterable) {
        m43134M();
    ...
    /* renamed from: J */
    public final void m43137J(int i, ContextRule contextRule) {
    ...
    /* renamed from: K */
    public final void m43136K(ContextRule contextRule) {
        contextRule.getClass();
        m43134M();
    ...
    /* renamed from: O */
    public final void m43132O(int i, ContextRule contextRule) {
        contextRule.getClass();
        m43134M();
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C7191a.f51621a[methodToInvoke.ordinal()]) {
            case 1:
                return new Context();
            case 2:
