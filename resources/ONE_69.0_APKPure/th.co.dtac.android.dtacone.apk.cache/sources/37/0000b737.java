...
public final class QuotaFailure extends GeneratedMessageLite<QuotaFailure, Builder> implements QuotaFailureOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<QuotaFailure, Builder> implements QuotaFailureOrBuilder {
        public /* synthetic */ Builder(C8973a c8973a) {
            this();
        }

        public Builder addAllViolations(Iterable<? extends Violation> iterable) {
            copyOnWrite();
            ((QuotaFailure) this.instance).m34839I(iterable);
            return this;
        }

        public Builder addViolations(Violation violation) {
            copyOnWrite();
            ((QuotaFailure) this.instance).m34837K(violation);
            return this;
        }

        public Builder clearViolations() {
            copyOnWrite();
            ((QuotaFailure) this.instance).m34836L();
            return this;
        }
        ...
        public Builder removeViolations(int i) {
            copyOnWrite();
            ((QuotaFailure) this.instance).m34834N(i);
            return this;
        }

        public Builder setViolations(int i, Violation violation) {
            copyOnWrite();
            ((QuotaFailure) this.instance).m34833O(i, violation);
            return this;
        }
        ...
        public Builder addViolations(int i, Violation violation) {
            copyOnWrite();
            ((QuotaFailure) this.instance).m34838J(i, violation);
            return this;
        }

        public Builder setViolations(int i, Violation.Builder builder) {
            copyOnWrite();
            ((QuotaFailure) this.instance).m34833O(i, builder.build());
            return this;
        }

        public Builder addViolations(Violation.Builder builder) {
            copyOnWrite();
            ((QuotaFailure) this.instance).m34837K(builder.build());
            return this;
        }

        public Builder addViolations(int i, Violation.Builder builder) {
            copyOnWrite();
            ((QuotaFailure) this.instance).m34838J(i, builder.build());
            return this;
        }
    }
    ...
    public static final class Violation extends GeneratedMessageLite<Violation, Builder> implements ViolationOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<Violation, Builder> implements ViolationOrBuilder {
            ...
            public Builder clearDescription() {
                copyOnWrite();
                ((Violation) this.instance).m34825I();
                return this;
            }

            public Builder clearSubject() {
                copyOnWrite();
                ((Violation) this.instance).m34824J();
                return this;
            }
            ...
            public Builder setDescription(String str) {
                copyOnWrite();
                ((Violation) this.instance).m34823K(str);
                return this;
            }

            public Builder setDescriptionBytes(ByteString byteString) {
                copyOnWrite();
                ((Violation) this.instance).m34822L(byteString);
                return this;
            }

            public Builder setSubject(String str) {
                copyOnWrite();
                ((Violation) this.instance).m34821M(str);
                return this;
            }

            public Builder setSubjectBytes(ByteString byteString) {
                copyOnWrite();
                ((Violation) this.instance).m34820N(byteString);
                return this;
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* renamed from: K */
        public void m34823K(String str) {
            str.getClass();
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* renamed from: L */
        public void m34822L(ByteString byteString) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* renamed from: M */
        public void m34821M(String str) {
            str.getClass();
            this.subject_ = str;
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* renamed from: N */
        public void m34820N(ByteString byteString) {
            AbstractMessageLite.checkByteStringIsUtf8(byteString);
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C8973a.f57556a[methodToInvoke.ordinal()]) {
                case 1:
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: I */
    public void m34839I(Iterable iterable) {
        m34835M();
    ...
    /* renamed from: J */
    public final void m34838J(int i, Violation violation) {
        violation.getClass();
        m34835M();
    ...
    /* renamed from: K */
    public final void m34837K(Violation violation) {
        violation.getClass();
        m34835M();
    ...
    /* renamed from: O */
    public final void m34833O(int i, Violation violation) {
        violation.getClass();
        m34835M();
