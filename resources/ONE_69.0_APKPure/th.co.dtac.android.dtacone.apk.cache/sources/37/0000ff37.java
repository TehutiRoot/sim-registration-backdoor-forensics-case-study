...
public abstract class Nat224 {
    ...
    /* renamed from: M */
    private static final long f75544M = 4294967295L;
    ...
    /* renamed from: eq */
    public static boolean m24618eq(int[] iArr, int[] iArr2) {
        for (int i = 6; i >= 0; i--) {
            if (iArr[i] != iArr2[i]) {
                return false;
            }
    ...
    public static void mul(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        while (i5 < 7) {
            int i6 = i4 + 1;
            long j17 = iArr[i + i5] & 4294967295L;
            long j18 = j15;
            int i7 = i5;
            long j19 = (j17 * j) + (iArr3[i6] & 4294967295L);
            iArr3[i6] = (int) j19;
            int i8 = i4 + 2;
            long j20 = (j19 >>> 32) + (j17 * j2) + (iArr3[i8] & 4294967295L);
            iArr3[i8] = (int) j20;
            int i9 = i4 + 3;
            long j21 = j3;
            long j22 = (j20 >>> 32) + (j17 * j3) + (iArr3[i9] & 4294967295L);
            iArr3[i9] = (int) j22;
            int i10 = i4 + 4;
            int i11 = i4;
            long j23 = (j22 >>> 32) + (j17 * j4) + (iArr3[i10] & 4294967295L);
            iArr3[i10] = (int) j23;
            int i12 = i11 + 5;
            long j24 = (j23 >>> 32) + (j17 * j5) + (iArr3[i12] & 4294967295L);
            iArr3[i12] = (int) j24;
            int i13 = i11 + 6;
            long j25 = (j24 >>> 32) + (j17 * j6) + (iArr3[i13] & 4294967295L);
            iArr3[i13] = (int) j25;
            int i14 = i11 + 7;
            long j26 = (j25 >>> 32) + (j17 * j18) + (iArr3[i14] & 4294967295L);
            iArr3[i14] = (int) j26;
    ...
    public static void square(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        while (true) {
            ...
            if (i17 <= 0) {
                ...
                int i29 = (int) j47;
                iArr2[i2 + 9] = (i28 >>> 31) | (i29 << 1);
                int i30 = i29 >>> 31;
                int i31 = (int) j48;
                iArr2[i2 + 10] = i30 | (i31 << 1);
                int i32 = i31 >>> 31;
                int i33 = (int) j49;
                iArr2[i2 + 11] = i32 | (i33 << 1);
                int i34 = i33 >>> 31;
                int i35 = (int) j50;
                iArr2[i2 + 12] = i34 | (i35 << 1);
                int i36 = i35 >>> 31;
                int i37 = i2 + 13;
                iArr2[i37] = i36 | ((iArr2[i37] + ((int) (j50 >>> 32))) << 1);
                return;
            }
            i16 = i17;
        }
