...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_change_sim.MrtrChangeSimViewModel$checkSimStock$2 */
/* loaded from: classes9.dex */
public final class MrtrChangeSimViewModel$checkSimStock$2 extends Lambda implements Function1<CheckSimStockResponse, Unit> {
    final /* synthetic */ MrtrChangeSimViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrChangeSimViewModel$checkSimStock$2(MrtrChangeSimViewModel mrtrChangeSimViewModel) {
        super(1);
