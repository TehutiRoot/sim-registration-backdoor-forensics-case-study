...
public class SafeParcelWriter {
    /* renamed from: a */
    public static int m48390a(Parcel parcel, int i) {
    ...
    /* renamed from: b */
    public static void m48389b(Parcel parcel, int i) {
    ...
    public static int beginObjectHeader(@NonNull Parcel parcel) {
        return m48390a(parcel, 20293);
    }

    /* renamed from: c */
    public static void m48388c(Parcel parcel, int i, int i2) {
        parcel.writeInt(i | (i2 << 16));
    }

    /* renamed from: d */
    public static void m48387d(Parcel parcel, Parcelable parcelable, int i) {
        int dataPosition = parcel.dataPosition();
        parcel.writeInt(1);
    ...
    public static void writeBigDecimal(@NonNull Parcel parcel, int i, @NonNull BigDecimal bigDecimal, boolean z) {
        ...
        int m48390a = m48390a(parcel, i);
        parcel.writeByteArray(bigDecimal.unscaledValue().toByteArray());
        parcel.writeInt(bigDecimal.scale());
        m48389b(parcel, m48390a);
    }
