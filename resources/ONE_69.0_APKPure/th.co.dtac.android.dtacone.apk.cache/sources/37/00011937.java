...
public final class BitMapExtenKt {
    ...
    /* renamed from: a */
    public static /* synthetic */ void m19686a(Bitmap bitmap, ScaleAttr scaleAttr, ObservableEmitter observableEmitter) {
        m19684c(bitmap, scaleAttr, observableEmitter);
    }

    /* renamed from: b */
    public static final int m19685b(Bitmap bitmap) {
    ...
    /* renamed from: c */
    public static final void m19684c(Bitmap bitmap, ScaleAttr attr, ObservableEmitter it) {
        Intrinsics.checkNotNullParameter(bitmap, "$bitmap");
        Intrinsics.checkNotNullParameter(attr, "$attr");
        Intrinsics.checkNotNullParameter(it, "it");
        Four m19683d = m19683d(bitmap, attr);
        int component1 = m19683d.component1();
        int component2 = m19683d.component2();
        int component3 = m19683d.component3();
        int component4 = m19683d.component4();
        Timber.m1420d("Crop x: " + component1 + " y: " + component2 + "  w:" + component3 + "  h:" + component4, new Object[0]);
        try {
            Bitmap createBitmap = Bitmap.createBitmap(bitmap, component1, component2, component3, component4);
            if (m19685b(createBitmap) > 300000) {
            ...
            attr.setScale(0.8f);
            Four m19683d2 = m19683d(bitmap, attr);
            it.onNext(Bitmap.createBitmap(bitmap, m19683d2.component1(), m19683d2.component2(), m19683d2.component3(), m19683d2.component4()));
        }
    }
    ...
    public static final Bitmap cropAspectRatio(@NotNull Bitmap bitmap, int i, int i2, float f, float f2, float f3) {
        ...
        Timber.m1420d("Crop  originWidth: " + width + " originHeight: " + height + " ratio " + i + " x " + i2, new Object[0]);
        Four calcImageCrop = calcImageCrop(bitmap.getWidth(), bitmap.getHeight(), i, i2, f);
        StringBuilder sb = new StringBuilder();
        sb.append("Crop ");
        sb.append(calcImageCrop);
        Timber.m1420d(sb.toString(), new Object[0]);
    ...
    public static final Bitmap cropSquare(@NotNull Bitmap bitmap, float f, float f2, float f3) {
        ...
        int width = bitmap.getWidth();
        int height = bitmap.getHeight();
        Timber.m1420d("Crop  originWidth: " + width + " originHeight: " + height, new Object[0]);
    ...
    /* renamed from: d */
    public static final Four m19683d(Bitmap bitmap, ScaleAttr scaleAttr) {
        int width = bitmap.getWidth();
        int height = bitmap.getHeight();
        int ratioWidth = scaleAttr.getRatioWidth();
        int ratioHeight = scaleAttr.getRatioHeight();
        Timber.m1420d("Crop  originWidth: " + width + " originHeight: " + height + " ratio " + ratioWidth + " x " + ratioHeight, new Object[0]);
    ...
    public static final Observable<Bitmap> scaleDownBitmap(@NotNull final Bitmap bitmap, @NotNull final ScaleAttr attr) {
        ...
        Observable<Bitmap> create = Observable.create(new ObservableOnSubscribe() { // from class: mb
            ...
            public final void subscribe(ObservableEmitter observableEmitter) {
                BitMapExtenKt.m19686a(bitmap, attr, observableEmitter);
            }
        });
