...
/* renamed from: th.co.dtac.android.dtacone.databinding.FragmentEsimAddressReceiptBinding */
/* loaded from: classes7.dex */
public final class FragmentEsimAddressReceiptBinding implements ViewBinding {

    /* renamed from: a */
    public final LinearLayoutCompat f83813a;
    @NonNull
    ...
    @NonNull
    public static FragmentEsimAddressReceiptBinding bind(@NonNull View view) {
                ...
                if (findChildViewById3 != null) {
                    ...
                    if (dtacTabLayout != null) {
                        ...
                        if (wrapContentViewPager != null) {
                            return new FragmentEsimAddressReceiptBinding((LinearLayoutCompat) view, bind, constraintLayout, bind2, bind3, dtacTabLayout, wrapContentViewPager);
                        }
                    }
                }
            }
    ...
    @NonNull
    public static FragmentEsimAddressReceiptBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static FragmentEsimAddressReceiptBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.fragment_esim_address_receipt, viewGroup, false);
        if (z) {
