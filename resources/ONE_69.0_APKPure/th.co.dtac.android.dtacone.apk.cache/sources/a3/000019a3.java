...
public interface ITrustedWebActivityService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ITrustedWebActivityService {
        ...
        /* loaded from: classes.dex */
        public static class C1905a implements ITrustedWebActivityService {

            /* renamed from: a */
            public IBinder f8529a;

            public C1905a(IBinder iBinder) {
                this.f8529a = iBinder;
            }
            ...
            public Bundle areNotificationsEnabled(Bundle bundle) {
                ...
                try {
                    ...
                    _Parcel.m64971d(obtain, bundle, 0);
                    this.f8529a.transact(6, obtain, obtain2, 0);
                    obtain2.readException();
                    return (Bundle) _Parcel.m64972c(obtain2, Bundle.CREATOR);
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
            ...
            public void cancelNotification(Bundle bundle) {
                ...
                try {
                    obtain.writeInterfaceToken(ITrustedWebActivityService.DESCRIPTOR);
                    _Parcel.m64971d(obtain, bundle, 0);
                    this.f8529a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public Bundle extraCommand(String str, Bundle bundle, IBinder iBinder) {
                ...
                try {
                    ...
                    this.f8529a.transact(9, obtain, obtain2, 0);
                    obtain2.readException();
                    return (Bundle) _Parcel.m64972c(obtain2, Bundle.CREATOR);
                } finally {
                    obtain2.recycle();
            ...
            public Bundle getActiveNotifications() {
                ...
                try {
                    obtain.writeInterfaceToken(ITrustedWebActivityService.DESCRIPTOR);
                    this.f8529a.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                    return (Bundle) _Parcel.m64972c(obtain2, Bundle.CREATOR);
                } finally {
                    obtain2.recycle();
            ...
            public Bundle getSmallIconBitmap() {
                ...
                try {
                    obtain.writeInterfaceToken(ITrustedWebActivityService.DESCRIPTOR);
                    this.f8529a.transact(7, obtain, obtain2, 0);
                    obtain2.readException();
                    return (Bundle) _Parcel.m64972c(obtain2, Bundle.CREATOR);
                } finally {
                    obtain2.recycle();
            ...
            public int getSmallIconId() {
                ...
                try {
                    obtain.writeInterfaceToken(ITrustedWebActivityService.DESCRIPTOR);
                    this.f8529a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public Bundle notifyNotificationWithChannel(Bundle bundle) {
                ...
                try {
                    obtain.writeInterfaceToken(ITrustedWebActivityService.DESCRIPTOR);
                    _Parcel.m64971d(obtain, bundle, 0);
                    this.f8529a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                    return (Bundle) _Parcel.m64972c(obtain2, Bundle.CREATOR);
                } finally {
                    obtain2.recycle();
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                case 2:
                    Bundle notifyNotificationWithChannel = notifyNotificationWithChannel((Bundle) _Parcel.m64972c(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
                    _Parcel.m64971d(parcel2, notifyNotificationWithChannel, 1);
                    break;
                case 3:
                    cancelNotification((Bundle) _Parcel.m64972c(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
                    break;
                case 4:
                ...
                case 5:
                    ...
                    parcel2.writeNoException();
                    _Parcel.m64971d(parcel2, activeNotifications, 1);
                    break;
                case 6:
                    Bundle areNotificationsEnabled = areNotificationsEnabled((Bundle) _Parcel.m64972c(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
                    _Parcel.m64971d(parcel2, areNotificationsEnabled, 1);
                    break;
                case 7:
                    Bundle smallIconBitmap = getSmallIconBitmap();
                    parcel2.writeNoException();
                    _Parcel.m64971d(parcel2, smallIconBitmap, 1);
                    break;
                case 8:
                default:
                    return super.onTransact(i, parcel, parcel2, i2);
                case 9:
                    Bundle extraCommand = extraCommand(parcel.readString(), (Bundle) _Parcel.m64972c(parcel, Bundle.CREATOR), parcel.readStrongBinder());
                    parcel2.writeNoException();
                    _Parcel.m64971d(parcel2, extraCommand, 1);
                    break;
            }
            return true;
        }
    ...
    public static class _Parcel {
        /* renamed from: c */
        public static Object m64972c(Parcel parcel, Parcelable.Creator creator) {
            if (parcel.readInt() != 0) {
        ...
        /* renamed from: d */
        public static void m64971d(Parcel parcel, Parcelable parcelable, int i) {
            if (parcelable != null) {
                parcel.writeInt(1);
