...
public class Registry {
    ...
    /* renamed from: b */
    public static final Registry f32447b = new Registry();

    /* renamed from: a */
    public HashMap f32448a = new HashMap();
    ...
    public String currentContent(String str) {
        RegistryCallback registryCallback = (RegistryCallback) this.f32448a.get(str);
