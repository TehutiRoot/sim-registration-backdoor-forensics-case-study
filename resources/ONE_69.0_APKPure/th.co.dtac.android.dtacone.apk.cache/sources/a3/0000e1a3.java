...
public final class MemberDeserializer$getReceiverParameterAnnotations$1 extends Lambda implements Function0<List<? extends AnnotationDescriptor>> {
    ...
    public final List<? extends AnnotationDescriptor> invoke() {
        ...
        if (m28010a != null) {
            ...
            list = deserializationContext2.getComponents().getAnnotationAndConstantLoader().loadExtensionReceiverParameterAnnotations(m28010a, messageLite, annotatedCallableKind);
        } else {
            list = null;
        }
