...
@DebugMetadata(m29093c = "androidx.compose.material.SwipeableState$animateInternalToOffset$2", m29092f = "Swipeable.kt", m29091i = {}, m29090l = {223}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
...
public final class SwipeableState$animateInternalToOffset$2 extends SuspendLambda implements Function2<DragScope, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes.dex */
    public static final class C31741 extends Lambda implements Function1<Animatable<Float, AnimationVector1D>, Unit> {
        final /* synthetic */ DragScope $$this$drag;
        final /* synthetic */ Ref.FloatRef $prevValue;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C31741(DragScope dragScope, Ref.FloatRef floatRef) {
            super(1);
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        try {
            if (i != 0) {
                ...
                mutableState2 = this.this$0.f14732h;
                mutableState2.setValue(Boxing.boxFloat(this.$target));
                this.this$0.m60746b(true);
                ...
                C31741 c31741 = new C31741(dragScope, floatRef);
                this.label = 1;
                if (Animatable.animateTo$default(Animatable$default, boxFloat, animationSpec, null, c31741, this, 4, null) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
            mutableState3 = this.this$0.f14732h;
            mutableState3.setValue(null);
            this.this$0.m60746b(false);
            return Unit.INSTANCE;
        } catch (Throwable th2) {
            mutableState = this.this$0.f14732h;
