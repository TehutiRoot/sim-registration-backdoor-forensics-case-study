...
@Metadata(m29143d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m29142d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_permDataSetting", "Landroidx/compose/material/icons/Icons$Outlined;", "getPermDataSetting", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "PermDataSetting", "material-icons-extended_release"}, m29141k = 2, m29140mv = {1, 8, 0})
...
public final class PermDataSettingKt {
    ...
    /* renamed from: a */
    public static ImageVector f18281a;

    @NotNull
    public static final ImageVector getPermDataSetting(@NotNull Icons.Outlined outlined) {
        Intrinsics.checkNotNullParameter(outlined, "<this>");
        ImageVector imageVector = f18281a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.PermDataSetting", C3623Dp.m73842constructorimpl(24.0f), C3623Dp.m73842constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.Companion.m71945getBlack0d7_KjU(), null);
        int m72227getButtKaPHkGw = StrokeCap.Companion.m72227getButtKaPHkGw();
        int m72237getBevelLxFBmk8 = StrokeJoin.Companion.m72237getBevelLxFBmk8();
        PathBuilder pathBuilder = new PathBuilder();
        pathBuilder.moveTo(17.99f, 11.57f);
        pathBuilder.lineTo(20.0f, 11.57f);
        pathBuilder.lineTo(20.0f, 0.0f);
        pathBuilder.lineTo(0.0f, 20.0f);
        pathBuilder.horizontalLineToRelative(11.56f);
        pathBuilder.verticalLineToRelative(-2.0f);
        pathBuilder.lineTo(4.83f, 18.0f);
        pathBuilder.lineTo(17.99f, 4.83f);
        pathBuilder.verticalLineToRelative(6.74f);
        pathBuilder.close();
        pathBuilder.moveTo(23.77f, 20.32f);
