...
public final class remove implements printStackTrace {
    ...
    public static void ThreeDS2ServiceInstance() {
        valueOf = new char[]{CoreConstants.PERCENT_CHAR, 'G', 'K', 'Y', 'Y', 'K', 'D', 'E', 'K', 'M', 'N', 'z', 'e', 196, 198, 205, 196, 197, 210, 210, 196, Typography.half, 190, 196, 198, 199, 'y', Typography.less, 'q', 132, TokenParser.f74644SP, 'B', 'K', '8'};
    }
