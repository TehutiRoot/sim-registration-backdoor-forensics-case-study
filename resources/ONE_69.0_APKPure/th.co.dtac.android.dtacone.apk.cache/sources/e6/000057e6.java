...
public final class ChipKt$SelectableChip$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        int i2 = this.$$dirty;
        long m71929unboximpl = selectableChipColors.labelColor$material3_release(z, z2, composer, ((i2 << 3) & 112) | ((i2 >> 9) & 14) | ((this.$$dirty1 << 6) & 896)).getValue().m71929unboximpl();
        SelectableChipColors selectableChipColors2 = this.$colors;
        boolean z3 = this.$enabled;
        boolean z4 = this.$selected;
        int i3 = this.$$dirty;
        long m71929unboximpl2 = selectableChipColors2.leadingIconContentColor$material3_release(z3, z4, composer, ((i3 << 3) & 112) | ((i3 >> 9) & 14) | ((this.$$dirty1 << 6) & 896)).getValue().m71929unboximpl();
        SelectableChipColors selectableChipColors3 = this.$colors;
        boolean z5 = this.$enabled;
        boolean z6 = this.$selected;
        int i4 = this.$$dirty;
        long m71929unboximpl3 = selectableChipColors3.trailingIconContentColor$material3_release(z5, z6, composer, ((i4 << 3) & 112) | ((i4 >> 9) & 14) | ((this.$$dirty1 << 6) & 896)).getValue().m71929unboximpl();
        ...
        int i7 = this.$$dirty1;
        ChipKt.m60629b(function2, textStyle, m71929unboximpl, function22, function23, function24, m71929unboximpl2, m71929unboximpl3, f, paddingValues, composer, ((i7 << 15) & 1879048192) | i6 | ((i7 << 15) & 234881024));
        if (ComposerKt.isTraceInProgress()) {
