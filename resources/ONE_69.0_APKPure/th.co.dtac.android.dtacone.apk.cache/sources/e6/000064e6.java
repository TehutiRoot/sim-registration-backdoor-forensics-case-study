...
public final class DelegatingFontLoaderForBridgeUsage implements PlatformFontLoader {
    ...
    /* renamed from: a */
    public final Font.ResourceLoader f31343a;

    /* renamed from: b */
    public final Context f31344b;

    /* renamed from: c */
    public final Object f31345c;
    ...
    public Object awaitLoad(@NotNull Font font, @NotNull Continuation<Object> continuation) {
        if (font instanceof AndroidFont) {
            ...
            return androidFont.getTypefaceLoader().awaitLoad(this.f31344b, androidFont, continuation);
        }
        return this.f31343a.load(font);
    }
    ...
    public Object loadBlocking(@NotNull Font font) {
        ...
        if (font instanceof AndroidFont) {
            AndroidFont androidFont = (AndroidFont) font;
            return androidFont.getTypefaceLoader().loadBlocking(this.f31344b, androidFont);
        }
        return this.f31343a.load(font);
    }
}