...
import th.p047co.dtac.android.dtacone.presenter.login.NewRequestOtpPresenter;
...
/* renamed from: th.co.dtac.android.dtacone.presenter.login.NewRequestOtpPresenter$requestOtp$6 */
/* loaded from: classes8.dex */
public final class NewRequestOtpPresenter$requestOtp$6 extends Lambda implements Function1<RequestOtpResponse, Unit> {
    final /* synthetic */ NewRequestOtpPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NewRequestOtpPresenter$requestOtp$6(NewRequestOtpPresenter newRequestOtpPresenter) {
        super(1);
    ...
    public final void invoke2(RequestOtpResponse it) {
        NewRequestOtpPresenter.View view;
        view = this.this$0.f85957e;
        if (view == null) {
