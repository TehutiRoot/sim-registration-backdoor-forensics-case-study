...
public abstract class BaseMenuPresenter implements MenuPresenter {
    ...
    /* renamed from: a */
    public MenuPresenter.Callback f9343a;
    ...
    public MenuView.ItemView createItemView(ViewGroup viewGroup) {
        return (MenuView.ItemView) this.mSystemInflater.inflate(this.f9345c, viewGroup, false);
    }
    ...
    public MenuView getMenuView(ViewGroup viewGroup) {
        if (this.mMenuView == null) {
            MenuView menuView = (MenuView) this.mSystemInflater.inflate(this.f9344b, viewGroup, false);
    ...
    public void onCloseMenu(MenuBuilder menuBuilder, boolean z) {
        MenuPresenter.Callback callback = this.f9343a;
        if (callback != null) {
