...
public final class AccessibilityAction<T extends Function<? extends Boolean>> {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (Intrinsics.areEqual(this.f30941a, accessibilityAction.f30941a) && Intrinsics.areEqual(this.f30942b, accessibilityAction.f30942b)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int i3 = i * 31;
        Function function = this.f30942b;
        if (function != null) {
    ...
    public String toString() {
        return "AccessibilityAction(label=" + this.f30941a + ", action=" + this.f30942b + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
}