...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.pre2post.fragment.OnePre2PostAllPackageTelephoneNumberFragment$onStart$1$2 */
/* loaded from: classes10.dex */
public final class OnePre2PostAllPackageTelephoneNumberFragment$onStart$1$2 extends Lambda implements Function1<Resource<? extends ValidatePackageGroupCodeResponse>, Unit> {
    final /* synthetic */ OnePre2PostAllPackageTelephoneNumberFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.pre2post.fragment.OnePre2PostAllPackageTelephoneNumberFragment$onStart$1$2$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OnePre2PostAllPackageTelephoneNumberFragment$onStart$1$2(OnePre2PostAllPackageTelephoneNumberFragment onePre2PostAllPackageTelephoneNumberFragment) {
        super(1);
    ...
    public final void invoke2(Resource<ValidatePackageGroupCodeResponse> resource) {
        ...
        if (i == 1) {
            onePre2PostAllPackageTelephoneNumberFragment.gotoMailing();
        } else if (i == 2) {
            onePre2PostAllPackageTelephoneNumberFragment.showLoading();
        } else if (i != 3) {
        } else {
