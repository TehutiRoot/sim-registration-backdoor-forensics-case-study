...
public final class TimePickerKt$TimeSelector$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        int i3 = this.$value;
        int i4 = this.$$dirty;
        String m70901numberContentDescriptionYKJpE6Y = TimePickerKt.m70901numberContentDescriptionYKJpE6Y(i2, is24hour, i3, composer, ((i4 << 3) & 896) | ((i4 >> 9) & 14));
        ...
        boolean changed = composer.changed(m70901numberContentDescriptionYKJpE6Y);
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new TimePickerKt$TimeSelector$3$1$1$1(m70901numberContentDescriptionYKJpE6Y);
            composer.updateRememberedValue(rememberedValue);
        }
        composer.endReplaceableGroup();
        Modifier semantics$default = SemanticsModifierKt.semantics$default(companion, false, (Function1) rememberedValue, 1, null);
        m60369z = TimePickerKt.m60369z(i5, 2);
        TextKt.m70882Text4IGK_g(m60369z, semantics$default, j, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer, 0, 0, 131064);
        composer.endReplaceableGroup();
        composer.endNode();
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
