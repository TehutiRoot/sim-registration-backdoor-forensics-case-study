...
public final class CommissionDetailItem {
    ...
    /* renamed from: a */
    private final String f81726a;
    @SerializedName(FirebaseAnalytics.Param.QUANTITY)
    @Nullable

    /* renamed from: b */
    private final String f81727b;
    @SerializedName(MessageBundle.TITLE_ENTRY)
    @Nullable

    /* renamed from: c */
    private final String f81728c;
    ...
    public static /* synthetic */ CommissionDetailItem copy$default(CommissionDetailItem commissionDetailItem, String str, String str2, String str3, int i, Object obj) {
        if ((i & 1) != 0) {
            str = commissionDetailItem.f81726a;
        }
        if ((i & 2) != 0) {
            str2 = commissionDetailItem.f81727b;
        }
        if ((i & 4) != 0) {
            str3 = commissionDetailItem.f81728c;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof CommissionDetailItem) {
            ...
            return Intrinsics.areEqual(this.f81726a, commissionDetailItem.f81726a) && Intrinsics.areEqual(this.f81727b, commissionDetailItem.f81727b) && Intrinsics.areEqual(this.f81728c, commissionDetailItem.f81728c);
        }
        return false;
    }
    ...
    public int hashCode() {
        String str = this.f81726a;
        int hashCode = (str == null ? 0 : str.hashCode()) * 31;
        String str2 = this.f81727b;
        int hashCode2 = (hashCode + (str2 == null ? 0 : str2.hashCode())) * 31;
        String str3 = this.f81728c;
