...
public final class Keyframe<T> {
    ...
    public static /* synthetic */ Keyframe copy$default(Keyframe keyframe, float f, Object obj, Easing easing, int i, Object obj2) {
        ...
        if ((i & 2) != 0) {
            obj = keyframe.f12789b;
        }
        if ((i & 4) != 0) {
            easing = keyframe.f12790c;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof Keyframe) {
            ...
            return Float.compare(this.f12788a, keyframe.f12788a) == 0 && Intrinsics.areEqual(this.f12789b, keyframe.f12789b) && Intrinsics.areEqual(this.f12790c, keyframe.f12790c);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode;
        int floatToIntBits = Float.floatToIntBits(this.f12788a) * 31;
        ...
        return ((floatToIntBits + hashCode) * 31) + this.f12790c.hashCode();
    }

    @NotNull
    public String toString() {
        return "Keyframe(fraction=" + this.f12788a + ", value=" + this.f12789b + ", interpolator=" + this.f12790c + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
}