...
public class C9288ce extends AbstractC9274bt<FrameLayout> {
    private static int getSDKVersion = 0;
    private static int getWarnings = 1;
    getOrDefault ThreeDS2Service;
    private final InterfaceC9580mh ThreeDS2ServiceInstance;
    private final C9286cd get;
    private final InterfaceC9300compute valueOf;
    private final InterfaceC9504js values;

    public C9288ce(C9286cd c9286cd, InterfaceC9300compute interfaceC9300compute, InterfaceC9504js interfaceC9504js, InterfaceC9580mh interfaceC9580mh) {
        this.get = c9286cd;
        this.valueOf = interfaceC9300compute;
        this.values = interfaceC9504js;
        this.ThreeDS2ServiceInstance = interfaceC9580mh;
    }
    ...
    public void values(InterfaceC9362er interfaceC9362er) {
        ...
        if (getordefault != null) {
            ...
            getordefault.values(interfaceC9362er);
    ...
    public void ThreeDS2Service(InterfaceC9359eo interfaceC9359eo) {
        ...
        if (i2 % 2 == 0) {
            getOrDefault getordefault = this.ThreeDS2Service;
            if (getordefault != null) {
                getordefault.ThreeDS2ServiceInstance(interfaceC9359eo);
                int i3 = getWarnings;
                int i4 = i3 & 45;
    ...
    public FrameLayout values(Context context) {
        ...
        this.ThreeDS2ServiceInstance.ThreeDS2ServiceInstance(frameLayout, C9586mn.ThreeDS2ServiceInstance(), C9586mn.ThreeDS2ServiceInstance(0), C9586mn.ThreeDS2ServiceInstance(), C9586mn.ThreeDS2ServiceInstance());
        C9366ev.ThreeDS2ServiceInstance(frameLayout, this.values.get().ThreeDS2ServiceInstance());
        int i = getSDKVersion;
        getWarnings = ((i & 73) + (i | 73)) % 128;
        return frameLayout;
    }

    public InterfaceC9356elements ThreeDS2ServiceInstance() {
        int i = getSDKVersion;
        int i2 = ((i ^ 31) | (i & 31)) << 1;
        int i3 = -(((~i) & 31) | (i & (-32)));
