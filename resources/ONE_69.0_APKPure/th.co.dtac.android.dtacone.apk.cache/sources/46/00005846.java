...
public final class DatePickerKt$DatePickerContent$1$4$2 extends Lambda implements Function3<AnimatedVisibilityScope, Composer, Integer, Unit> {
    ...
    public final void invoke(@NotNull AnimatedVisibilityScope AnimatedVisibility, @Nullable Composer composer, int i) {
        ...
        String m70803getStringNWtq28 = Strings_androidKt.m70803getStringNWtq28(Strings.Companion.m70769getDatePickerYearPickerPaneTitleadMyvUU(), composer, 6);
        Modifier.Companion companion = Modifier.Companion;
        composer.startReplaceableGroup(1157296644);
        boolean changed = composer.changed(m70803getStringNWtq28);
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new DatePickerKt$DatePickerContent$1$4$2$1$1(m70803getStringNWtq28);
        ...
        DatePickerKt.m60616i(PaddingKt.m69715paddingVpY3zN4$default(SizeKt.m69737requiredHeight3ABfNKs(companion, C3623Dp.m73842constructorimpl(C3623Dp.m73842constructorimpl(DatePickerKt.getRecommendedSizeForAccessibility() * 7) - DividerDefaults.INSTANCE.m70553getThicknessD9Ej5fM())), DatePickerKt.getDatePickerHorizontalPadding(), 0.0f, 2, null), new DatePickerKt$DatePickerContent$1$4$2$2$1(coroutineScope, mutableState, stateData, lazyListState), datePickerColors, stateData, composer, ((i2 >> 3) & 896) | 6 | ((i2 << 9) & 7168));
        DividerKt.m70554Divider9IZ8Weo(null, 0.0f, 0L, composer, 0, 7);
        composer.endReplaceableGroup();
        composer.endNode();
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
