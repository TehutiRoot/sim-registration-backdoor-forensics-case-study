...
public class JsonScanner {
    ...
    /* renamed from: a */
    public final InterfaceC19785eh0 f76047a;
    ...
    public static /* synthetic */ class C12935a {
        ...
        /* renamed from: b */
        public static final /* synthetic */ int[] f76049b;
        ...
        static {
            ...
            try {
                f76049b[NumberState.SAW_LEADING_ZERO.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f76049b[NumberState.SAW_INTEGER_DIGITS.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f76049b[NumberState.SAW_DECIMAL_POINT.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f76049b[NumberState.SAW_FRACTION_DIGITS.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f76049b[NumberState.SAW_EXPONENT_LETTER.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f76049b[NumberState.SAW_EXPONENT_SIGN.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f76049b[NumberState.SAW_EXPONENT_DIGITS.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f76049b[NumberState.SAW_MINUS_I.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f76049b[NumberState.INVALID.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f76049b[NumberState.DONE.ordinal()] = 11;
            ...
            try {
                f76048a[RegularExpressionState.IN_ESCAPE_SEQUENCE.ordinal()] = 2;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f76048a[RegularExpressionState.IN_OPTIONS.ordinal()] = 3;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f76048a[RegularExpressionState.DONE.ordinal()] = 4;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                f76048a[RegularExpressionState.INVALID.ordinal()] = 5;
            } catch (NoSuchFieldError unused16) {
            }
        }
    }

    public JsonScanner(InterfaceC19785eh0 interfaceC19785eh0) {
        this.f76047a = interfaceC19785eh0;
    }

    /* renamed from: a */
    public void m24317a(int i) {
        this.f76047a.mo877b(i);
    }

    /* renamed from: b */
    public int m24316b() {
        return this.f76047a.mark();
    }

    /* renamed from: c */
    public C12941a m24315c() {
        int read = this.f76047a.read();
        while (read != -1 && Character.isWhitespace(read)) {
            read = this.f76047a.read();
        }
        if (read == -1) {
        ...
        return m24311g((char) read);
    }

    /* renamed from: d */
    public void m24314d(int i) {
        this.f76047a.mo876c(i);
    }

    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    /* renamed from: e */
    public final C12941a m24313e(char c) {
        ...
        while (true) {
            int read = this.f76047a.read();
            switch (C12935a.f76049b[numberState.ordinal()]) {
                case 1:
                    if (read != 48) {
                        if (read != 73) {
            ...
            int i2 = C12935a.f76049b[numberState2.ordinal()];
            if (i2 == 10) {
        ...
        while (true) {
            ...
            if (i2 != 4) {
                if (i2 != 5) {
                    ...
                    throw new JsonParseException("Invalid JSON regular expression. Position: %d.", Integer.valueOf(this.f76047a.getPosition()));
                }
            } else {
                this.f76047a.mo878a(read);
    ...
    /* renamed from: g */
    public final C12941a m24311g(char c) {
        int read;
        StringBuilder sb = new StringBuilder();
        do {
            read = this.f76047a.read();
                                    ...
                                    if (read != 102) {
                                        if (read != 110) {
                                            if (read != 114) {
                                                if (read != 116) {
                                                    if (read == 117) {
                                                        int read2 = this.f76047a.read();
                                                        int read3 = this.f76047a.read();
                                                        int read4 = this.f76047a.read();
                                                        int read5 = this.f76047a.read();
                                                        if (read5 != -1) {
    ...
    /* renamed from: h */
    public final C12941a m24310h(char c) {
        StringBuilder sb = new StringBuilder();
        sb.append(c);
        int read = this.f76047a.read();
        while (true) {
    ...
    public JsonScanner(String str) {
        this(new C22726vh0(str));
    }

    public JsonScanner(Reader reader) {
        this(new C22553uh0(reader));
    }
}