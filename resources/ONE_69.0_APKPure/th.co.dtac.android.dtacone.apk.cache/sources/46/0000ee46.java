...
public final class NioSystemFileSystem extends JvmSystemFileSystem {
    ...
    public void atomicMove(@NotNull Path source, @NotNull Path target) {
        ...
        try {
            ...
            Files.move(nioPath, nioPath2, KI0.m67728a(standardCopyOption), KI0.m67728a(standardCopyOption2));
    ...
    /* renamed from: d */
    public final Long m26012d(FileTime fileTime) {
        long millis;
    ...
    public FileMetadata metadataOrNull(@NotNull Path path) {
        ...
        Long l3 = null;
        try {
            Class m31340a = AbstractC20138gj1.m31340a();
            linkOption = LinkOption.NOFOLLOW_LINKS;
            readAttributes = Files.readAttributes(nioPath, m31340a, linkOption);
            ...
            if (creationTime != null) {
                l = m26012d(creationTime);
            } else {
                l = null;
            }
            lastModifiedTime = readAttributes.lastModifiedTime();
            if (lastModifiedTime != null) {
                l2 = m26012d(lastModifiedTime);
            } else {
                l2 = null;
            }
            lastAccessTime = readAttributes.lastAccessTime();
            if (lastAccessTime != null) {
                l3 = m26012d(lastAccessTime);
            }
