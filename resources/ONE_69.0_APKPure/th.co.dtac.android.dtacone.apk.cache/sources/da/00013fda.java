...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.stvProSermOnline.fragment.OneProsermOnlineInputNumberFragment$initViewModel$1$1 */
/* loaded from: classes10.dex */
public final class OneProsermOnlineInputNumberFragment$initViewModel$1$1 extends Lambda implements Function1<Resource<? extends BalanceResponse>, Unit> {
    final /* synthetic */ OneProsermOnlineInputNumberFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneProsermOnlineInputNumberFragment$initViewModel$1$1(OneProsermOnlineInputNumberFragment oneProsermOnlineInputNumberFragment) {
        super(1);
    ...
    public final void invoke2(Resource<BalanceResponse> resource) {
        ...
        if (resource.getStatus() == StatusResource.SUCCESS) {
            ...
            textView3.setText(oneProsermOnlineInputNumberFragment.getString(i, str));
