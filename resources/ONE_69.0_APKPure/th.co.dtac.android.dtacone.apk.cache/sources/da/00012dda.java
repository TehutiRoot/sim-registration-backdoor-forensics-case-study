...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.deviceSaleTrueCompany.viewModel.OneDeviceSaleTrueViewModel$fetchDataPricePlansDetail$apiCall$1$4 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleTrueViewModel$fetchDataPricePlansDetail$apiCall$1$4 extends Lambda implements Function1<List<OneGetPricePlansDetailResponse>, Unit> {
    ...
    public OneDeviceSaleTrueViewModel$fetchDataPricePlansDetail$apiCall$1$4(Integer num, OneDeviceSaleTrueViewModel oneDeviceSaleTrueViewModel, Function1<? super String, Unit> function1) {
        super(1);
    ...
    public final void invoke2(List<OneGetPricePlansDetailResponse> list) {
        ...
        if (num != null && size == num.intValue()) {
            List<PriceplanListItem> pricePlansDetailListResponse = this.this$0.getOneModel().getPricePlansDetailListResponse();
