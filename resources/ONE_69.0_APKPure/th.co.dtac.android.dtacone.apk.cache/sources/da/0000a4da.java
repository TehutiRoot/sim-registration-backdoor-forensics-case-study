...
public final class MonitoredResourceMetadata extends GeneratedMessageLite<MonitoredResourceMetadata, Builder> implements MonitoredResourceMetadataOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<MonitoredResourceMetadata, Builder> implements MonitoredResourceMetadataOrBuilder {
        public /* synthetic */ Builder(C7224a c7224a) {
            this();
        }

        public Builder clearSystemLabels() {
            copyOnWrite();
            ((MonitoredResourceMetadata) this.instance).m42417G();
            return this;
        }

        public Builder clearUserLabels() {
            copyOnWrite();
            ((MonitoredResourceMetadata) this.instance).m42416H().clear();
            return this;
        }
        ...
        public Builder mergeSystemLabels(Struct struct) {
            copyOnWrite();
            ((MonitoredResourceMetadata) this.instance).m42413K(struct);
            return this;
        }

        public Builder putAllUserLabels(Map<String, String> map) {
            copyOnWrite();
            ((MonitoredResourceMetadata) this.instance).m42416H().putAll(map);
            return this;
        }
        ...
        public Builder putUserLabels(String str, String str2) {
            ...
            str2.getClass();
            copyOnWrite();
            ((MonitoredResourceMetadata) this.instance).m42416H().put(str, str2);
            return this;
        }
        ...
        public Builder removeUserLabels(String str) {
            str.getClass();
            copyOnWrite();
            ((MonitoredResourceMetadata) this.instance).m42416H().remove(str);
            return this;
        }

        public Builder setSystemLabels(Struct struct) {
            copyOnWrite();
            ((MonitoredResourceMetadata) this.instance).m42412L(struct);
            return this;
        }
        ...
        public Builder setSystemLabels(Struct.Builder builder) {
            copyOnWrite();
            ((MonitoredResourceMetadata) this.instance).m42412L(builder.build());
            return this;
        }
    }
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C7224a {
    ...
    public static final class C7225b {
        ...
        /* renamed from: a */
        public static final MapEntryLite f51651a;

        static {
            WireFormat.FieldType fieldType = WireFormat.FieldType.STRING;
            f51651a = MapEntryLite.newDefaultInstance(fieldType, "", fieldType, "");
        }
    }
    ...
    /* renamed from: G */
    public final void m42417G() {
        this.systemLabels_ = null;
    }

    /* renamed from: H */
    public final Map m42416H() {
        return m42415I();
    }

    /* renamed from: I */
    public final MapFieldLite m42415I() {
    ...
    /* renamed from: J */
    public final MapFieldLite m42414J() {
        return this.userLabels_;
    }

    /* renamed from: K */
    public final void m42413K(Struct struct) {
        struct.getClass();
    ...
    /* renamed from: L */
    public final void m42412L(Struct struct) {
        struct.getClass();
        this.systemLabels_ = struct;
    }
    ...
    public boolean containsUserLabels(String str) {
        str.getClass();
        return m42414J().containsKey(str);
    }

    @Override // com.google.protobuf.GeneratedMessageLite
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C7224a.f51650a[methodToInvoke.ordinal()]) {
            case 1:
                return new MonitoredResourceMetadata();
            case 2:
                return new Builder(null);
            case 3:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0002\u0002\u0001\u0000\u0000\u0001\t\u00022", new Object[]{"systemLabels_", "userLabels_", C7225b.f51651a});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
    ...
    @Override // com.google.api.MonitoredResourceMetadataOrBuilder
    public Map<String, String> getUserLabelsMap() {
        return Collections.unmodifiableMap(m42414J());
    }

    @Override // com.google.api.MonitoredResourceMetadataOrBuilder
    public String getUserLabelsOrDefault(String str, String str2) {
        str.getClass();
        MapFieldLite m42414J = m42414J();
        if (m42414J.containsKey(str)) {
            return (String) m42414J.get(str);
        }
        return str2;
    }
