...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.esim.ESimViewModel$uploadImage$1 */
/* loaded from: classes9.dex */
public final class ESimViewModel$uploadImage$1 extends Lambda implements Function1<IndexedValue<? extends String>, ObservableSource<? extends UploadImageResponse>> {
    final /* synthetic */ ESimViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimViewModel$uploadImage$1(ESimViewModel eSimViewModel) {
        super(1);
    ...
    public final ObservableSource<? extends UploadImageResponse> invoke2(@NotNull IndexedValue<String> indexedValue) {
        ...
        UploadImageRequest m2701o0;
        Intrinsics.checkNotNullParameter(indexedValue, "<name for destructuring parameter 0>");
        eSimRepository = this.this$0.f105820b;
        m2701o0 = this.this$0.m2701o0(indexedValue.component1(), indexedValue.component2());
        return eSimRepository.uploadImage(m2701o0).toObservable();
    }
