...
public final class Floats extends AbstractC19678e30 {
    ...
    public static class FloatArrayAsList extends AbstractList<Float> implements RandomAccess, Serializable {
        ...
        public boolean contains(@CheckForNull Object obj) {
            if ((obj instanceof Float) && Floats.m39845d(this.array, ((Float) obj).floatValue(), this.start, this.end) != -1) {
                return true;
            }
            return false;
        }
        ...
        public int indexOf(@CheckForNull Object obj) {
            int m39845d;
            if ((obj instanceof Float) && (m39845d = Floats.m39845d(this.array, ((Float) obj).floatValue(), this.start, this.end)) >= 0) {
                return m39845d - this.start;
            }
            return -1;
        }
        ...
        public int lastIndexOf(@CheckForNull Object obj) {
            int m39844e;
            if ((obj instanceof Float) && (m39844e = Floats.m39844e(this.array, ((Float) obj).floatValue(), this.start, this.end)) >= 0) {
                return m39844e - this.start;
            }
            return -1;
        }
    ...
    /* renamed from: c */
    public static int m39846c(long j) {
        boolean z;
        int i = (int) j;
        if (j == i) {
            z = true;
    ...
    public static float[] concat(float[]... fArr) {
        ...
        float[] fArr3 = new float[m39846c(j)];
        int i = 0;
    ...
    /* renamed from: d */
    public static int m39845d(float[] fArr, float f, int i, int i2) {
        while (i < i2) {
            if (fArr[i] == f) {
                return i;
            }
    ...
    /* renamed from: e */
    public static int m39844e(float[] fArr, float f, int i, int i2) {
    ...
    public static int indexOf(float[] fArr, float f) {
        return m39845d(fArr, f, 0, fArr.length);
    }
    ...
    public static int lastIndexOf(float[] fArr, float f) {
        return m39844e(fArr, f, 0, fArr.length);
    }
    ...
    public static Float tryParse(String str) {
        if (Doubles.f54082a.matcher(str).matches()) {
            try {
