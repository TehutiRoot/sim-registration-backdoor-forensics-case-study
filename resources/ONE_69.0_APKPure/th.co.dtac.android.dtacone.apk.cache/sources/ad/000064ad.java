...
public final class TextLayoutKt {
    ...
    /* renamed from: a */
    public static final TextAndroidCanvas f31250a = new TextAndroidCanvas();

    /* renamed from: b */
    public static final long f31251b = VerticalPaddings(0, 0);

    public static final long VerticalPaddings(int i, int i2) {
        return VerticalPaddings.m73434constructorimpl((i2 & BodyPartID.bodyIdMax) | (i << 32));
    }

    /* renamed from: a */
    public static final Paint.FontMetricsInt m59023a(TextLayout textLayout, TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, LineHeightStyleSpan[] lineHeightStyleSpanArr) {
        boolean z;
    ...
    public static final /* synthetic */ Paint.FontMetricsInt access$getLastLineMetrics(TextLayout textLayout, TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, LineHeightStyleSpan[] lineHeightStyleSpanArr) {
        return m59023a(textLayout, textPaint, textDirectionHeuristic, lineHeightStyleSpanArr);
    }
    ...
    public static final /* synthetic */ long access$getVerticalPaddings(TextLayout textLayout) {
        return m59020d(textLayout);
    }

    /* renamed from: b */
    public static final long m59022b(TextLayout textLayout, LineHeightStyleSpan[] lineHeightStyleSpanArr) {
        int i = 0;
        int i2 = 0;
    ...
    /* renamed from: c */
    public static final LineHeightStyleSpan[] m59021c(TextLayout textLayout) {
    ...
    /* renamed from: d */
    public static final long m59020d(TextLayout textLayout) {
        int topPadding;
        int bottomPadding;
