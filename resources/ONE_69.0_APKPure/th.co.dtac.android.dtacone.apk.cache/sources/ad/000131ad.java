...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.activity.OneMnpActivity$navigateToOcr$upPassFormFragment$1 */
/* loaded from: classes10.dex */
public final class OneMnpActivity$navigateToOcr$upPassFormFragment$1 extends Lambda implements Function1<UpPassFormFragment, Unit> {
    final /* synthetic */ OneMnpActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneMnpActivity$navigateToOcr$upPassFormFragment$1(OneMnpActivity oneMnpActivity) {
        super(1);
