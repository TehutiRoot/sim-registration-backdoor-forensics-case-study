...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.viewModel.OneMnpViewModel$requestOtpTrueCompany$3 */
/* loaded from: classes10.dex */
public final class OneMnpViewModel$requestOtpTrueCompany$3 extends Lambda implements Function1<RequestOtpV3Response, Unit> {
    final /* synthetic */ OneMnpViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneMnpViewModel$requestOtpTrueCompany$3(OneMnpViewModel oneMnpViewModel) {
        super(1);
    ...
    public final void invoke2(RequestOtpV3Response requestOtpV3Response) {
        ...
        m13402x1.setValue(Resource.Companion.success(requestOtpV3Response));
    }
}