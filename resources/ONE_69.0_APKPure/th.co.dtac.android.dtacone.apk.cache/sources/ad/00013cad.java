...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.prepaid_registration.fragment.consent.OnePrepaidTelcoFragment$onStart$1$1 */
/* loaded from: classes10.dex */
public final class OnePrepaidTelcoFragment$onStart$1$1 extends Lambda implements Function1<FragmentNavEvent, Unit> {
    final /* synthetic */ OnePrepaidTelcoFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePrepaidTelcoFragment$onStart$1$1(OnePrepaidTelcoFragment onePrepaidTelcoFragment) {
        super(1);
    ...
    public final void invoke2(@NotNull FragmentNavEvent it) {
        OnePrepaidRegistrationActivity m10620n;
        Intrinsics.checkNotNullParameter(it, "it");
        m10620n = this.this$0.m10620n();
        m10620n.addFragment(it.buildFragment(), it.getTag());
    }
}