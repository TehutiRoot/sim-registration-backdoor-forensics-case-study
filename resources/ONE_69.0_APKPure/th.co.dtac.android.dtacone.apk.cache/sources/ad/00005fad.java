...
public final class AndroidImageBitmap implements ImageBitmap {
    ...
    public ColorSpace getColorSpace() {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            return Api26Bitmap.composeColorSpace$ui_graphics_release(this.f29061a);
        }
    ...
    public int mo71795getConfig_sVssgQ() {
        Bitmap.Config config = this.f29061a.getConfig();
    ...
    */
    public void readPixels(@org.jetbrains.annotations.NotNull int[] r11, int r12, int r13, int r14, int r15, int r16, int r17) {
        /*
            ...
            android.graphics.Bitmap$Config r3 = p000.AbstractC5328b4.m51994a()
            if (r1 == r3) goto L1c
            goto L25
        L1c:
