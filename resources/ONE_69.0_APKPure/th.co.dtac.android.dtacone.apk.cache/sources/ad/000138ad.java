...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.viewmodel.OnePostpaidPackagesViewModel$searchOnePackageGroupRetailer$4 */
/* loaded from: classes10.dex */
public final class OnePostpaidPackagesViewModel$searchOnePackageGroupRetailer$4 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ OnePostpaidPackagesViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidPackagesViewModel$searchOnePackageGroupRetailer$4(OnePostpaidPackagesViewModel onePostpaidPackagesViewModel) {
        super(1);
    ...
    public final void invoke2(final Throwable th2) {
        ...
        oneErrorService.handleException(th2, new OneErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.viewmodel.OnePostpaidPackagesViewModel$searchOnePackageGroupRetailer$4.1
            ...
            public void handle(@Nullable Throwable th3) {
                ...
                if (th3 instanceof SocketException) {
                    oneErrorService4 = OnePostpaidPackagesViewModel.this.f94520e;
                    ...
                    oneErrorService3 = OnePostpaidPackagesViewModel.this.f94520e;
