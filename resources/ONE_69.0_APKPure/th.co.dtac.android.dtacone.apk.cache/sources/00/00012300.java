...
/* renamed from: th.co.dtac.android.dtacone.presenter.dtacAtHome.CheckMapPresenter$checkDtacAtHomePlaceByWord$3 */
/* loaded from: classes8.dex */
public final class CheckMapPresenter$checkDtacAtHomePlaceByWord$3 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ CheckMapPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CheckMapPresenter$checkDtacAtHomePlaceByWord$3(CheckMapPresenter checkMapPresenter) {
        super(1);
    ...
    public final void invoke2(Throwable th2) {
        ...
        errorService.handleException(th2, new ServerErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.presenter.dtacAtHome.CheckMapPresenter$checkDtacAtHomePlaceByWord$3.1
