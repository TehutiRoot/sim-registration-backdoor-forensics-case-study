...
public final class OnTimeout {
    ...
    /* renamed from: b */
    public final SelectClause0 m27071b() {
    ...
    /* renamed from: c */
    public final void m27070c(final SelectInstance selectInstance, Object obj) {
        if (this.f71092a <= 0) {
        ...
        selectInstance.disposeOnCompletion(DelayKt.getDelay(context).invokeOnTimeout(this.f71092a, runnable, context));
    }
}