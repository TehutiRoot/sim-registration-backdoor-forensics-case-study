...
public class UriTemplate {
    ...
    /* renamed from: a */
    public static final Map f52171a = new HashMap();
    ...
    public enum CompositeOutput {
        ...
        QUERY('?', CallerData.f39637NA, "&", true, false),
        ...
        CompositeOutput(Character ch2, String str, String str2, boolean z, boolean z2) {
            ...
            if (ch2 != null) {
                UriTemplate.f52171a.put(ch2, this);
            }
        }
    ...
    /* renamed from: b */
    public static CompositeOutput m41732b(String str) {
        CompositeOutput compositeOutput = (CompositeOutput) f52171a.get(Character.valueOf(str.charAt(0)));
    ...
    /* renamed from: c */
    public static String m41731c(String str, Iterator it, boolean z, CompositeOutput compositeOutput) {
        String str2;
        if (!it.hasNext()) {
            return "";
        }
    ...
    /* renamed from: d */
    public static Map m41730d(Object obj) {
    ...
    /* renamed from: e */
    public static String m41729e(String str, Map map, boolean z, CompositeOutput compositeOutput) {
        String str2;
        if (map.isEmpty()) {
            return "";
        }
    ...
    /* renamed from: f */
    public static String m41728f(String str, String str2, CompositeOutput compositeOutput) {
        if (!compositeOutput.requiresVarAssignment()) {
    ...
    public static String expand(String str, Object obj, boolean z) {
        ...
        while (true) {
            ...
            if (indexOf != -1) {
                ...
                CompositeOutput m41732b = m41732b(substring);
                ListIterator<String> listIterator = Splitter.m41278on(',').splitToList(substring).listIterator();
                boolean z2 = true;
                while (listIterator.hasNext()) {
                    String next = listIterator.next();
                    boolean endsWith = next.endsWith(Marker.ANY_MARKER);
                    int varNameStartIndex = listIterator.nextIndex() == 1 ? m41732b.getVarNameStartIndex() : 0;
                    int length2 = next.length();
                    if (endsWith) {
                        length2--;
                    }
                    String substring2 = next.substring(varNameStartIndex, length2);
                    Object remove = m41730d.remove(substring2);
                    if (remove != null) {
                        if (!z2) {
                            sb.append(m41732b.getExplodeJoiner());
                        } else {
                            sb.append(m41732b.getOutputPrefix());
                            z2 = false;
                        }
                        if (remove instanceof Iterator) {
                            m41731c = m41731c(substring2, (Iterator) remove, endsWith, m41732b);
                        } else if (!(remove instanceof Iterable) && !remove.getClass().isArray()) {
                            if (remove.getClass().isEnum()) {
                                String name = FieldInfo.m41688of((Enum) remove).getName();
                                if (name == null) {
                                    name = remove.toString();
                                }
                                m41731c = m41728f(substring2, name, m41732b);
                            } else if (!Data.isValueOfPrimitiveType(remove)) {
                                m41731c = m41729e(substring2, m41730d(remove), endsWith, m41732b);
                            } else {
                                m41731c = m41728f(substring2, remove.toString(), m41732b);
                            }
                        } else {
                            m41731c = m41731c(substring2, Types.iterableOf(remove).iterator(), endsWith, m41732b);
                        }
                        sb.append((Object) m41731c);
                    }
                }
                i = i2;
            } else if (i == 0 && !z) {
        ...
        if (z) {
            GenericUrl.m41758a(m41730d.entrySet(), sb, false);
        }
        return sb.toString();
    }
}