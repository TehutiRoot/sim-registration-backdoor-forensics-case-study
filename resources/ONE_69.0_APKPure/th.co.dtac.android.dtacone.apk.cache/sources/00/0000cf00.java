...
public final class FlowableConcatWithSingle<T> extends AbstractC0558I {

    /* renamed from: b */
    public final SingleSource f64233b;
    ...
    public FlowableConcatWithSingle(Flowable<T> flowable, SingleSource<? extends T> singleSource) {
        super(flowable);
        this.f64233b = singleSource;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new ConcatWithSubscriber(subscriber, this.f64233b));
    }
}