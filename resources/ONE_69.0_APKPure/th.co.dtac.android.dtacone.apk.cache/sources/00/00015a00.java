...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_prepaid_registration.MrtrPrepaidRegistrationViewModel$cutSimStock$1$1 */
/* loaded from: classes9.dex */
public final class MrtrPrepaidRegistrationViewModel$cutSimStock$1$1 extends Lambda implements Function1<CutSimStockResponse, Unit> {
    final /* synthetic */ MrtrPrepaidRegistrationViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrPrepaidRegistrationViewModel$cutSimStock$1$1(MrtrPrepaidRegistrationViewModel mrtrPrepaidRegistrationViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull CutSimStockResponse it) {
        ...
        mrtrPrepaidRepository.setCutSimStockResponse(it);
    }
}