...
public final class FixedScale implements ContentScale {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return (obj instanceof FixedScale) && Float.compare(this.f30149a, ((FixedScale) obj).f30149a) == 0;
    }
    ...
    public int hashCode() {
        return Float.floatToIntBits(this.f30149a);
    }

    @NotNull
    public String toString() {
        return "FixedScale(value=" + this.f30149a + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
}