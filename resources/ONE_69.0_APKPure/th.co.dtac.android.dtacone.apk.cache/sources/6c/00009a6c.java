...
public enum zzov implements zzcv {
    UNKNOWN_EVENT(0),
    ...
    ODML_IMAGE(442),
    OPTIONAL_MODULE_BARCODE_DETECTION(WebSocket.DEFAULT_WSS_PORT),
    ...
    ON_DEVICE_FACE_MESH_CLOSE(SyslogConstants.SYSLOG_PORT),
    ...
    ON_DEVICE_DOCUMENT_DETECT_CLOSE(C6139DK.IFD_NOT_SUPPORTED),
