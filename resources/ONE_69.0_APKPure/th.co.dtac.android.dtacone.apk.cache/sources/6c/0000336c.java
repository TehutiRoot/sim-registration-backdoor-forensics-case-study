...
public final class SentimentVerySatisfiedKt {
    ...
    /* renamed from: a */
    public static ImageVector f16434a;

    @NotNull
    public static final ImageVector getSentimentVerySatisfied(@NotNull Icons.Filled filled) {
        Intrinsics.checkNotNullParameter(filled, "<this>");
        ImageVector imageVector = f16434a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Filled.SentimentVerySatisfied", C3623Dp.m73842constructorimpl(24.0f), C3623Dp.m73842constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
