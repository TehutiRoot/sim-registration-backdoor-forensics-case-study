...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.topup.fragment.OneTopupConfirmFragment$setUpViewModel$4 */
/* loaded from: classes10.dex */
public final class OneTopupConfirmFragment$setUpViewModel$4 extends Lambda implements Function1<Resource<? extends String>, Unit> {
    final /* synthetic */ OneTopupConfirmFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.topup.fragment.OneTopupConfirmFragment$setUpViewModel$4$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneTopupConfirmFragment$setUpViewModel$4(OneTopupConfirmFragment oneTopupConfirmFragment) {
        super(1);
    ...
    public final void invoke2(Resource<String> resource) {
        ...
        if (i == 1) {
            ...
            m9329E = oneTopupConfirmFragment.m9329E();
            if (data == null) {
                data = PermissionConstant.M_BUY_DOL;
            }
            m9329E.getPriceList(data);
        } else if (i == 2) {
