...
public final class AssistChipDefaults {
    ...
    /* renamed from: a */
    public static final float f25637a;

    /* renamed from: b */
    public static final float f25638b;

    static {
        AssistChipTokens assistChipTokens = AssistChipTokens.INSTANCE;
        f25637a = assistChipTokens.m71006getContainerHeightD9Ej5fM();
        f25638b = assistChipTokens.m71015getIconSizeD9Ej5fM();
    }

    @Composable
    @NotNull
    /* renamed from: assistChipBorder-d_3_b6Q  reason: not valid java name */
    public final ChipBorder m70377assistChipBorderd_3_b6Q(long j, long j2, float f, @Nullable Composer composer, int i, int i2) {
        long j3;
        long j4;
        float f2;
        ...
        if ((i2 & 2) != 0) {
            j4 = Color.m71918copywmQWz5c$default(ColorSchemeKt.toColor(AssistChipTokens.INSTANCE.getFlatDisabledOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null);
        } else {
            j4 = j2;
        }
        if ((i2 & 4) != 0) {
            f2 = AssistChipTokens.INSTANCE.m71014getFlatOutlineWidthD9Ej5fM();
        } else {
            f2 = f;
        }
    ...
    public final ChipColors m70378assistChipColorsoq7We08(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, @Nullable Composer composer, int i, int i2) {
        long j9;
        long j10;
        long j11;
        long j12;
        ...
        if ((i2 & 16) != 0) {
            j13 = Color.Companion.m71954getTransparent0d7_KjU();
        } else {
            j13 = j5;
        }
        if ((i2 & 32) != 0) {
            j14 = Color.m71918copywmQWz5c$default(ColorSchemeKt.toColor(AssistChipTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null);
        } else {
            j14 = j6;
        }
        if ((i2 & 64) != 0) {
            j15 = Color.m71918copywmQWz5c$default(ColorSchemeKt.toColor(AssistChipTokens.INSTANCE.getDisabledIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null);
        } else {
            j15 = j7;
        }
        if ((i2 & 128) != 0) {
    ...
    public final ChipElevation m70379assistChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, @Nullable Composer composer, int i, int i2) {
        float f7;
        float f8;
        float f9;
        float f10;
        ...
        if ((i2 & 1) != 0) {
            f7 = AssistChipTokens.INSTANCE.m71013getFlatContainerElevationD9Ej5fM();
        } else {
            f7 = f;
        }
        if ((i2 & 2) != 0) {
        ...
        if ((i2 & 16) != 0) {
            f11 = AssistChipTokens.INSTANCE.m71007getDraggedContainerElevationD9Ej5fM();
        } else {
            f11 = f5;
        }
        if ((i2 & 32) != 0) {
    ...
    public final ChipColors m70380elevatedAssistChipColorsoq7We08(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, @Nullable Composer composer, int i, int i2) {
        long j9;
        long j10;
        long j11;
        long j12;
        ...
        if ((i2 & 16) != 0) {
            j13 = Color.m71918copywmQWz5c$default(ColorSchemeKt.toColor(AssistChipTokens.INSTANCE.getElevatedDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null);
        } else {
            j13 = j5;
        }
        if ((i2 & 32) != 0) {
    ...
    public final ChipElevation m70381elevatedAssistChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, @Nullable Composer composer, int i, int i2) {
        float f7;
        float f8;
        float f9;
        float f10;
        ...
        if ((i2 & 1) != 0) {
            f7 = AssistChipTokens.INSTANCE.m71008getElevatedContainerElevationD9Ej5fM();
        } else {
            f7 = f;
        }
        if ((i2 & 2) != 0) {
            f8 = AssistChipTokens.INSTANCE.m71012getElevatedPressedContainerElevationD9Ej5fM();
        } else {
            f8 = f2;
        }
        if ((i2 & 4) != 0) {
            f9 = AssistChipTokens.INSTANCE.m71010getElevatedFocusContainerElevationD9Ej5fM();
        } else {
            f9 = f3;
        }
        if ((i2 & 8) != 0) {
            f10 = AssistChipTokens.INSTANCE.m71011getElevatedHoverContainerElevationD9Ej5fM();
        } else {
            f10 = f4;
        }
        if ((i2 & 16) != 0) {
        ...
        if ((i2 & 32) != 0) {
            f12 = AssistChipTokens.INSTANCE.m71009getElevatedDisabledContainerElevationD9Ej5fM();
        } else {
            f12 = f6;
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final float m70382getHeightD9Ej5fM() {
        return f25637a;
    }

    /* renamed from: getIconSize-D9Ej5fM  reason: not valid java name */
    public final float m70383getIconSizeD9Ej5fM() {
        return f25638b;
    }
