...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_mnp.MrtrMnpValidateViewModel$checkBlackList$1$2 */
/* loaded from: classes9.dex */
public final class MrtrMnpValidateViewModel$checkBlackList$1$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ MrtrMnpValidateViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrMnpValidateViewModel$checkBlackList$1$2(MrtrMnpValidateViewModel mrtrMnpValidateViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable throwable) {
        ...
        mrtrErrorService.handleException(throwable, new MrtrErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.viewmodel.mrtr_mnp.MrtrMnpValidateViewModel$checkBlackList$1$2.1
            ...
            public void handle(@Nullable Throwable th2) {
                ...
                m2360v = MrtrMnpValidateViewModel.this.m2360v();
                m2360v.postValue(Resource.Companion.error("", errorCollection, 0));
            }
