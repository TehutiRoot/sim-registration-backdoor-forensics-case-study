...
public class PDShadingType4 extends AbstractC21173mi1 {
    public PDShadingType4(COSDictionary cOSDictionary) {
        super(cOSDictionary);
    }

    @Override // p000.AbstractC21173mi1
    /* renamed from: b */
    public List mo26589b(AffineTransform affineTransform, Matrix matrix) {
        byte b;
                ...
                while (!z) {
                    if (b != 0) {
                        if (b != b3 && b != b2) {
                            ...
                            try {
                                ...
                                if (size < 0) {
                                    ...
                                    GH1 gh1 = (GH1) arrayList3.get(size);
                                    ...
                                    try {
                                        try {
                                            D22 readVertex4 = readVertex(memoryCacheImageInputStream3, pow, pow2, decodeForParameter, decodeForParameter2, pDRangeArr2, matrix, affineTransform);
                                            if (b == 1) {
                                                try {
                                                    pointF3 = gh1.f1931a[1];
                                                ...
                                                pointF3 = gh1.f1931a[c];
                                            }
                                            PointF pointF4 = gh1.f1931a[2];
                                            PointF pointF5 = readVertex4.f906a;
                                            try {
                                                ...
                                                float[] fArr3 = gh1.f1932b[2];
                                                float[] fArr4 = readVertex4.f907b;
                                                fArr2 = new float[3];
                                                fArr2[c] = fArr;
                                                fArr2[1] = fArr3;
                                                fArr2[2] = fArr4;
                                        ...
                                        try {
                                            arrayList.add(new GH1(pointFArr2, fArr2));
                                            memoryCacheImageInputStream2 = memoryCacheImageInputStream4;
                                            i2 = i4;
                                            try {
                        ...
                        try {
                            try {
                                ...
                                try {
                                    ...
                                    PointF pointF6 = readVertex.f906a;
                                    pointF = readVertex2.f906a;
                                    pointF2 = readVertex3.f906a;
                        ...
                        try {
                            pointFArr[1] = pointF;
                            pointFArr[2] = pointF2;
                            float[] fArr5 = readVertex.f907b;
                            float[] fArr6 = readVertex2.f907b;
                            float[] fArr7 = readVertex3.f907b;
                            try {
                                ...
                                try {
                                    ...
                                    try {
                                        ...
                                        try {
                                            fArr8[2] = fArr7;
                                            GH1 gh12 = new GH1(pointFArr, fArr8);
                                            arrayList2 = arrayList;
                                            try {
                                                arrayList2.add(gh12);
                                                b = (byte) (memoryCacheImageInputStream.readBits(i) & 3);
    ...
    @Override // p000.AbstractC21173mi1, com.tom_roush.pdfbox.pdmodel.graphics.shading.PDShading
