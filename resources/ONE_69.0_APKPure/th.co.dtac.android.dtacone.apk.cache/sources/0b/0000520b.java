...
@Metadata(m29143d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m29142d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_hvac", "Landroidx/compose/material/icons/Icons$TwoTone;", "getHvac", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "Hvac", "material-icons-extended_release"}, m29141k = 2, m29140mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nHvac.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Hvac.kt\nandroidx/compose/material/icons/twotone/HvacKt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,97:1\n122#2:98\n116#2,3:99\n119#2,3:103\n132#2,18:106\n152#2:143\n132#2,18:144\n152#2:181\n132#2,18:182\n152#2:219\n174#3:102\n694#4,2:124\n706#4,2:126\n708#4,11:132\n694#4,2:162\n706#4,2:164\n708#4,11:170\n694#4,2:200\n706#4,2:202\n708#4,11:208\n64#5,4:128\n64#5,4:166\n64#5,4:204\n*S KotlinDebug\n*F\n+ 1 Hvac.kt\nandroidx/compose/material/icons/twotone/HvacKt\n*L\n29#1:98\n29#1:99,3\n29#1:103,3\n30#1:106,18\n30#1:143\n44#1:144,18\n44#1:181\n62#1:182,18\n62#1:219\n29#1:102\n30#1:124,2\n30#1:126,2\n30#1:132,11\n44#1:162,2\n44#1:164,2\n44#1:170,11\n62#1:200,2\n62#1:202,2\n62#1:208,11\n30#1:128,4\n44#1:166,4\n62#1:204,4\n*E\n"})
/* loaded from: classes.dex */
public final class HvacKt {

    /* renamed from: a */
    public static ImageVector f24273a;

    @NotNull
    public static final ImageVector getHvac(@NotNull Icons.TwoTone twoTone) {
        Intrinsics.checkNotNullParameter(twoTone, "<this>");
        ImageVector imageVector = f24273a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Hvac", C3623Dp.m73842constructorimpl(24.0f), C3623Dp.m73842constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder3.curveTo(13.91f, 15.61f, 13.01f, 16.0f, 12.0f, 16.0f);
        pathBuilder3.close();
        pathBuilder3.moveTo(12.0f, 8.0f);
        pathBuilder3.curveToRelative(1.01f, 0.0f, 1.91f, 0.39f, 2.62f, 1.0f);
        pathBuilder3.horizontalLineTo(9.38f);
        pathBuilder3.curveTo(10.09f, 8.39f, 10.99f, 8.0f, 12.0f, 8.0f);
        pathBuilder3.close();
        pathBuilder3.moveTo(8.56f, 10.0f);
        pathBuilder3.horizontalLineToRelative(6.89f);
        pathBuilder3.curveToRelative(0.26f, 0.45f, 0.44f, 0.96f, 0.51f, 1.5f);
        pathBuilder3.horizontalLineToRelative(-7.9f);
        pathBuilder3.curveTo(8.12f, 10.96f, 8.29f, 10.45f, 8.56f, 10.0f);
        pathBuilder3.close();
