...
public final class MainPackAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    /* renamed from: a */
    public final Context f81022a;

    /* renamed from: b */
    public final List f81023b;

    /* renamed from: c */
    public OnClickMainPack f81024c;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final int $stable = 8;

    @Metadata(m29143d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0005"}, m29142d2 = {"Lth/co/dtac/android/dtacone/adapter/MainPackAdapter$Companion;", "", "()V", "VIEW_TYPE_NORMAL", "", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    @Metadata(m29143d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\b\b\u0086\u0004\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005R\"\u0010\r\u001a\u00020\u00068\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\u0007\u0010\b\u001a\u0004\b\t\u0010\n\"\u0004\b\u000b\u0010\fR\"\u0010\u0015\u001a\u00020\u000e8\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\u000f\u0010\u0010\u001a\u0004\b\u0011\u0010\u0012\"\u0004\b\u0013\u0010\u0014¨\u0006\u0016"}, m29142d2 = {"Lth/co/dtac/android/dtacone/adapter/MainPackAdapter$MainPackItemViewHolder;", "Landroidx/recyclerview/widget/RecyclerView$ViewHolder;", "Landroid/view/View;", Promotion.ACTION_VIEW, "<init>", "(Lth/co/dtac/android/dtacone/adapter/MainPackAdapter;Landroid/view/View;)V", "Landroid/widget/LinearLayout;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroid/widget/LinearLayout;", "getItemLayout", "()Landroid/widget/LinearLayout;", "setItemLayout", "(Landroid/widget/LinearLayout;)V", "itemLayout", "Landroid/widget/TextView;", OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, "Landroid/widget/TextView;", "getTvMainPackName", "()Landroid/widget/TextView;", "setTvMainPackName", "(Landroid/widget/TextView;)V", "tvMainPackName", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0})
    ...
    public final class MainPackItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public final void setItemLayout(@NotNull LinearLayout linearLayout) {
            ...
            this.f81025a = linearLayout;
        }

        public final void setTvMainPackName(@NotNull TextView textView) {
            Intrinsics.checkNotNullParameter(textView, "<set-?>");
            this.f81026b = textView;
        }
    }

    @Metadata(m29143d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&¨\u0006\u0006"}, m29142d2 = {"Lth/co/dtac/android/dtacone/adapter/MainPackAdapter$OnClickMainPack;", "", "onClickMainPackItem", "", "mainPack", "Lth/co/dtac/android/dtacone/model/changeMainPack/packageList/response/MainPackage;", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    public MainPackAdapter(@NotNull Context mContext, @NotNull List<MainPackage> mainPackList) {
        ...
        this.f81022a = mContext;
        this.f81023b = mainPackList;
    }

    /* renamed from: a */
    public static /* synthetic */ void m20667a(MainPackAdapter mainPackAdapter, MainPackage mainPackage, View view) {
        m20666b(mainPackAdapter, mainPackage, view);
    }

    /* renamed from: b */
    public static final void m20666b(MainPackAdapter this$0, MainPackage mainPack, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(mainPack, "$mainPack");
        OnClickMainPack onClickMainPack = this$0.f81024c;
    ...
    public void onBindViewHolder(@NotNull RecyclerView.ViewHolder holder, int i) {
        ...
        final MainPackage mainPackage = (MainPackage) this.f81023b.get(i);
        if (holder instanceof MainPackItemViewHolder) {
            ...
            mainPackItemViewHolder.getItemLayout().setOnClickListener(new View.OnClickListener() { // from class: In0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    MainPackAdapter.m20667a(MainPackAdapter.this, mainPackage, view);
                }
            });
        }
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int i) {
        ...
        View view = LayoutInflater.from(this.f81022a).inflate(R.layout.item_main_pack_row, parent, false);
