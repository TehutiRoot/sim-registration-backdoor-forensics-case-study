...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.prepaid_registration.viewmodel.OnePrepaidViewModel$submitOrder$3 */
/* loaded from: classes10.dex */
public final class OnePrepaidViewModel$submitOrder$3 extends Lambda implements Function1<OnePrepaidSubmitOrderResponse, Unit> {
    final /* synthetic */ String $nontelcoConsentType;
    final /* synthetic */ OnePrepaidViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePrepaidViewModel$submitOrder$3(String str, OnePrepaidViewModel onePrepaidViewModel) {
        super(1);
    ...
    public final void invoke2(OnePrepaidSubmitOrderResponse onePrepaidSubmitOrderResponse) {
        if (Intrinsics.areEqual(this.$nontelcoConsentType, "Y")) {
            this.this$0.m10560a0();
        }
        this.this$0.m10564W(onePrepaidSubmitOrderResponse.getData());
    }
}