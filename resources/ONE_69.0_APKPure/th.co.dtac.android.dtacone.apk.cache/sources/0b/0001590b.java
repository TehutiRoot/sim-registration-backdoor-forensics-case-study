...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_postpaid_registration.MrtrPostpaidRegistrationViewModel$uploadImage$1 */
/* loaded from: classes9.dex */
public final class MrtrPostpaidRegistrationViewModel$uploadImage$1 extends Lambda implements Function1<IndexedValue<? extends String>, ObservableSource<? extends UploadImageResponse>> {
    final /* synthetic */ MrtrPostpaidRegistrationViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrPostpaidRegistrationViewModel$uploadImage$1(MrtrPostpaidRegistrationViewModel mrtrPostpaidRegistrationViewModel) {
        super(1);
    ...
    public final ObservableSource<? extends UploadImageResponse> invoke2(@NotNull IndexedValue<String> indexedValue) {
        ...
        UploadImageRequest m2296O;
        Intrinsics.checkNotNullParameter(indexedValue, "<name for destructuring parameter 0>");
        mrtrPostpaidRepository = this.this$0.f106470b;
        m2296O = this.this$0.m2296O(indexedValue.component1(), indexedValue.component2());
        return mrtrPostpaidRepository.uploadImage(m2296O).toObservable();
    }
