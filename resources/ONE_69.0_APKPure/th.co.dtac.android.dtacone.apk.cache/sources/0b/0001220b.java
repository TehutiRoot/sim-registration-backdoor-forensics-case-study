...
/* renamed from: th.co.dtac.android.dtacone.presenter.buy_dol.BuyDolChargeV2Presenter$charge$3 */
/* loaded from: classes8.dex */
public final class BuyDolChargeV2Presenter$charge$3 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ BuyDolChargeV2Presenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BuyDolChargeV2Presenter$charge$3(BuyDolChargeV2Presenter buyDolChargeV2Presenter) {
        super(1);
    ...
    public final void invoke2(Throwable th2) {
        ...
        serverErrorService = this.this$0.f85406c;
        final BuyDolChargeV2Presenter buyDolChargeV2Presenter = this.this$0;
        serverErrorService.handleException(th2, new ServerErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.presenter.buy_dol.BuyDolChargeV2Presenter$charge$3.1
            ...
            public void handle(@Nullable Throwable th3) {
                ...
                try {
                    ...
                    if (Intrinsics.areEqual(serverErrorException.error().getStatusCode(), BuyDolConfig.OTP_FAIL_CODE)) {
                        view = BuyDolChargeV2Presenter.this.f85408e;
                        if (view == null) {
                    ...
                    serverErrorService3 = BuyDolChargeV2Presenter.this.f85406c;
                    serverErrorService3.handleException(th3, new ServerErrorService.ExceptionHandler[0]);
                } catch (Exception e) {
                    serverErrorService2 = BuyDolChargeV2Presenter.this.f85406c;
