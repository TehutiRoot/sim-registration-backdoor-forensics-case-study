...
@Metadata(m29143d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m29142d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_spatialTracking", "Landroidx/compose/material/icons/Icons$TwoTone;", "getSpatialTracking", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "SpatialTracking", "material-icons-extended_release"}, m29141k = 2, m29140mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nSpatialTracking.kt\nKotlin\n*S Kotlin\n*F\n+ 1 SpatialTracking.kt\nandroidx/compose/material/icons/twotone/SpatialTrackingKt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,102:1\n122#2:103\n116#2,3:104\n119#2,3:108\n132#2,18:111\n152#2:148\n132#2,18:149\n152#2:186\n132#2,18:187\n152#2:224\n132#2,18:225\n152#2:262\n132#2,18:263\n152#2:300\n132#2,18:301\n152#2:338\n174#3:107\n694#4,2:129\n706#4,2:131\n708#4,11:137\n694#4,2:167\n706#4,2:169\n708#4,11:175\n694#4,2:205\n706#4,2:207\n708#4,11:213\n694#4,2:243\n706#4,2:245\n708#4,11:251\n694#4,2:281\n706#4,2:283\n708#4,11:289\n694#4,2:319\n706#4,2:321\n708#4,11:327\n64#5,4:133\n64#5,4:171\n64#5,4:209\n64#5,4:247\n64#5,4:285\n64#5,4:323\n*S KotlinDebug\n*F\n+ 1 SpatialTracking.kt\nandroidx/compose/material/icons/twotone/SpatialTrackingKt\n*L\n29#1:103\n29#1:104,3\n29#1:108,3\n30#1:111,18\n30#1:148\n38#1:149,18\n38#1:186\n46#1:187,18\n46#1:224\n57#1:225,18\n57#1:262\n63#1:263,18\n63#1:300\n77#1:301,18\n77#1:338\n29#1:107\n30#1:129,2\n30#1:131,2\n30#1:137,11\n38#1:167,2\n38#1:169,2\n38#1:175,11\n46#1:205,2\n46#1:207,2\n46#1:213,11\n57#1:243,2\n57#1:245,2\n57#1:251,11\n63#1:281,2\n63#1:283,2\n63#1:289,11\n77#1:319,2\n77#1:321,2\n77#1:327,11\n30#1:133,4\n38#1:171,4\n46#1:209,4\n57#1:247,4\n63#1:285,4\n77#1:323,4\n*E\n"})
/* loaded from: classes.dex */
public final class SpatialTrackingKt {

    /* renamed from: a */
    public static ImageVector f25069a;

    @NotNull
    public static final ImageVector getSpatialTracking(@NotNull Icons.TwoTone twoTone) {
        Intrinsics.checkNotNullParameter(twoTone, "<this>");
        ImageVector imageVector = f25069a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.SpatialTracking", C3623Dp.m73842constructorimpl(24.0f), C3623Dp.m73842constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.curveToRelative(-3.51f, 3.51f, -3.51f, 9.21f, 0.0f, 12.73f);
        pathBuilder.lineToRelative(1.41f, -1.41f);
        pathBuilder.curveTo(17.32f, 9.58f, 17.32f, 5.14f, 20.05f, 2.41f);
        pathBuilder.close();
        ...
        pathBuilder2.moveTo(22.88f, 5.24f);
        pathBuilder2.lineToRelative(-1.41f, -1.41f);
        pathBuilder2.curveToRelative(-1.95f, 1.95f, -1.95f, 5.12f, 0.0f, 7.07f);
        pathBuilder2.lineToRelative(1.41f, -1.41f);
        pathBuilder2.curveTo(21.71f, 8.32f, 21.71f, 6.41f, 22.88f, 5.24f);
        pathBuilder2.close();
        ...
        pathBuilder3.moveTo(15.48f, 17.34f);
        pathBuilder3.curveTo(14.29f, 16.73f, 12.37f, 16.0f, 10.0f, 16.0f);
        pathBuilder3.curveToRelative(-2.37f, 0.0f, -4.29f, 0.73f, -5.48f, 1.34f);
        pathBuilder3.curveTo(4.2f, 17.5f, 4.0f, 17.84f, 4.0f, 18.22f);
        pathBuilder3.verticalLineTo(19.0f);
        pathBuilder3.horizontalLineToRelative(12.0f);
        pathBuilder3.verticalLineToRelative(-0.78f);
        pathBuilder3.curveTo(16.0f, 17.84f, 15.8f, 17.5f, 15.48f, 17.34f);
        pathBuilder3.close();
        ...
        pathBuilder4.moveTo(10.0f, 9.0f);
        ...
        pathBuilder6.moveTo(16.39f, 15.56f);
        pathBuilder6.curveTo(14.71f, 14.7f, 12.53f, 14.0f, 10.0f, 14.0f);
        pathBuilder6.curveToRelative(-2.53f, 0.0f, -4.71f, 0.7f, -6.39f, 1.56f);
        pathBuilder6.curveTo(2.61f, 16.07f, 2.0f, 17.1f, 2.0f, 18.22f);
        pathBuilder6.verticalLineTo(21.0f);
        pathBuilder6.horizontalLineToRelative(16.0f);
        pathBuilder6.verticalLineToRelative(-2.78f);
        pathBuilder6.curveTo(18.0f, 17.1f, 17.39f, 16.07f, 16.39f, 15.56f);
        pathBuilder6.close();
        pathBuilder6.moveTo(16.0f, 19.0f);
        pathBuilder6.horizontalLineTo(4.0f);
        pathBuilder6.verticalLineToRelative(-0.78f);
        pathBuilder6.curveToRelative(0.0f, -0.38f, 0.2f, -0.72f, 0.52f, -0.88f);
        pathBuilder6.curveTo(5.71f, 16.73f, 7.63f, 16.0f, 10.0f, 16.0f);
        pathBuilder6.curveToRelative(2.37f, 0.0f, 4.29f, 0.73f, 5.48f, 1.34f);
        pathBuilder6.curveTo(15.8f, 17.5f, 16.0f, 17.84f, 16.0f, 18.22f);
