...
public final class AnnotatedStringKt {
    ...
    /* renamed from: a */
    public static final AnnotatedString f31070a = new AnnotatedString("", null, null, 6, null);
    ...
    public static final AnnotatedString AnnotatedString(@NotNull String text, @NotNull SpanStyle spanStyle, @Nullable ParagraphStyle paragraphStyle) {
        ...
        return new AnnotatedString(text, AbstractC10100ds.listOf(new AnnotatedString.Range(spanStyle, 0, text.length())), paragraphStyle == null ? CollectionsKt__CollectionsKt.emptyList() : AbstractC10100ds.listOf(new AnnotatedString.Range(paragraphStyle, 0, text.length())));
    }
    ...
    /* renamed from: a */
    public static final List m59067a(List list, int i, int i2) {
        if (i <= i2) {
            if (list == null) {
                return null;
            }
    ...
    public static final /* synthetic */ List access$filterRanges(List list, int i, int i2) {
        return m59067a(list, i, i2);
    }

    public static final /* synthetic */ List access$getLocalAnnotations(AnnotatedString annotatedString, int i, int i2) {
        return m59066b(annotatedString, i, i2);
    }

    public static final /* synthetic */ List access$getLocalParagraphStyles(AnnotatedString annotatedString, int i, int i2) {
        return m59065c(annotatedString, i, i2);
    }

    public static final /* synthetic */ List access$getLocalSpanStyles(AnnotatedString annotatedString, int i, int i2) {
        return m59064d(annotatedString, i, i2);
    }

    public static final /* synthetic */ AnnotatedString access$substringWithoutParagraphStyles(AnnotatedString annotatedString, int i, int i2) {
        return m59063e(annotatedString, i, i2);
    }

    /* renamed from: b */
    public static final List m59066b(AnnotatedString annotatedString, int i, int i2) {
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            ...
            arrayList2.add(new AnnotatedString.Range(range3.getItem(), AbstractC11695c.coerceIn(range3.getStart(), i, i2) - i, AbstractC11695c.coerceIn(range3.getEnd(), i, i2) - i, range3.getTag()));
        }
        return arrayList2;
    }
    ...
    /* renamed from: c */
    public static final List m59065c(AnnotatedString annotatedString, int i, int i2) {
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            AnnotatedString.Range range3 = (AnnotatedString.Range) arrayList.get(i4);
            arrayList2.add(new AnnotatedString.Range(range3.getItem(), AbstractC11695c.coerceIn(range3.getStart(), i, i2) - i, AbstractC11695c.coerceIn(range3.getEnd(), i, i2) - i));
        }
        return arrayList2;
    }
    ...
    /* renamed from: d */
    public static final List m59064d(AnnotatedString annotatedString, int i, int i2) {
    ...
    /* renamed from: e */
    public static final AnnotatedString m59063e(AnnotatedString annotatedString, int i, int i2) {
        String str;
        if (i != i2) {
        ...
        return new AnnotatedString(str, m59064d(annotatedString, i, i2), null, null, 12, null);
    }
    ...
    public static final <T> List<T> mapEachParagraphStyle(@NotNull AnnotatedString annotatedString, @NotNull ParagraphStyle defaultParagraphStyle, @NotNull Function2<? super AnnotatedString, ? super AnnotatedString.Range<ParagraphStyle>, ? extends T> block) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            arrayList.add(block.invoke(m59063e(annotatedString, range.getStart(), range.getEnd()), range));
        }
        return arrayList;
    }
    ...
    public static final AnnotatedString AnnotatedString(@NotNull String text, @NotNull ParagraphStyle paragraphStyle) {
        ...
        return new AnnotatedString(text, CollectionsKt__CollectionsKt.emptyList(), AbstractC10100ds.listOf(new AnnotatedString.Range(paragraphStyle, 0, text.length())));
    }
