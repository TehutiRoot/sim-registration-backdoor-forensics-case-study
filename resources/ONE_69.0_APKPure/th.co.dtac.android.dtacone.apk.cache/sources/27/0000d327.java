...
public final class SingleInternalHelper {
    ...
    /* loaded from: classes5.dex */
    public static final class C11116a implements Iterable {

        /* renamed from: a */
        public final Iterable f66020a;

        public C11116a(Iterable iterable) {
            this.f66020a = iterable;
        }

        @Override // java.lang.Iterable
        public Iterator iterator() {
            return new C11117b(this.f66020a.iterator());
        }
    }

    /* renamed from: io.reactivex.internal.operators.single.SingleInternalHelper$b */
    /* loaded from: classes5.dex */
    public static final class C11117b implements Iterator {

        /* renamed from: a */
        public final Iterator f66021a;

        public C11117b(Iterator it) {
            this.f66021a = it;
        }
        ...
        public Flowable next() {
            return new SingleToFlowable((SingleSource) this.f66021a.next());
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            return this.f66021a.hasNext();
        }
