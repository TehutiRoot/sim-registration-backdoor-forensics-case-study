...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_postpaid_registration.MrtrPostpaidPackagesViewModel$validatePackageGroupCode$3 */
/* loaded from: classes9.dex */
public final class MrtrPostpaidPackagesViewModel$validatePackageGroupCode$3 extends Lambda implements Function1<PackageGroupCodeResponse, Unit> {
    final /* synthetic */ PackageSet $pack;
    final /* synthetic */ MrtrPostpaidPackagesViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrPostpaidPackagesViewModel$validatePackageGroupCode$3(MrtrPostpaidPackagesViewModel mrtrPostpaidPackagesViewModel, PackageSet packageSet) {
        super(1);
    ...
    public final void invoke2(PackageGroupCodeResponse packageGroupCodeResponse) {
        MutableLiveData m2320q;
        this.this$0.getLiveDataState().setValue(StatusResource.DISMISS);
        this.this$0.setPackageGroupCodeResponse(packageGroupCodeResponse);
        m2320q = this.this$0.m2320q();
        m2320q.postValue(Resource.Companion.success(this.$pack));
    }
}