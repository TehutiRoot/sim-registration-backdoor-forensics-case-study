...
public abstract class InAppNotification implements Parcelable {
    ...
    /* renamed from: c */
    public static String m33619c(String str, String str2) {
    ...
    public JSONObject m33621a() {
        ...
        try {
            ...
            MPLog.m33448e("MixpanelAPI.InAppNotif", "Impossible JSON Exception", e);
        }
        return jSONObject;
    }

    /* renamed from: b */
    public void m33620b(Bitmap bitmap) {
        this.f58556e = bitmap;
    }
    ...
    public String getImage2xUrl() {
        return m33619c(this.f58555d, "@2x");
    }

    public String getImage4xUrl() {
        return m33619c(this.f58555d, "@4x");
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeInt(this.f58552a);
        parcel.writeString(this.f58553b);
        parcel.writeInt(this.f58554c);
        parcel.writeString(this.f58555d);
        parcel.writeParcelable(this.f58556e, i);
    }
    ...
    public InAppNotification(Parcel parcel) {
        ...
        try {
            ...
            MPLog.m33449e("MixpanelAPI.InAppNotif", "Error reading JSON when creating InAppNotification from Parcel");
            jSONObject = jSONObject2;
            this.mDescription = jSONObject;
            this.mExtras = jSONObject3;
            this.mId = parcel.readInt();
            this.mMessageId = parcel.readInt();
            this.f58552a = parcel.readInt();
            this.f58553b = parcel.readString();
            this.f58554c = parcel.readInt();
            this.f58555d = parcel.readString();
            this.f58556e = (Bitmap) parcel.readParcelable(Bitmap.class.getClassLoader());
        }
        this.mDescription = jSONObject;
        this.mExtras = jSONObject3;
        this.mId = parcel.readInt();
    ...
    public InAppNotification(JSONObject jSONObject) {
        try {
            ...
            this.f58552a = jSONObject.getInt("bg_color");
            this.f58553b = JSONUtils.optionalStringKey(jSONObject, "body");
            this.f58554c = jSONObject.optInt("body_color");
            this.f58555d = jSONObject.getString("image_url");
            this.f58556e = Bitmap.createBitmap(500, 500, Bitmap.Config.ARGB_8888);
        } catch (JSONException e) {
