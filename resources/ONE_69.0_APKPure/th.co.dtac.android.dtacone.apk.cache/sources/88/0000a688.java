...
public abstract class UnicodeEscaper extends Escaper {
    /* renamed from: a */
    public static char[] m41673a(char[] cArr, int i, int i2) {
    ...
    public final String escapeSlow(String str, int i) {
        ...
        char[] m485a = AbstractC23085xl1.m485a();
        int i3 = 0;
        int i4 = 0;
        while (i < length) {
            ...
            if (codePointAt >= 0) {
                ...
                if (escape != null) {
                    ...
                    if (m485a.length < length2) {
                        m485a = m41673a(m485a, i4, ((length2 + length) - i) + 32);
                    }
                    if (i6 > 0) {
                        str.getChars(i3, i, m485a, i4);
                        i4 = i7;
                    }
                    if (escape.length > 0) {
                        System.arraycopy(escape, 0, m485a, i4, escape.length);
                        i4 += escape.length;
                    }
                    i3 = i5;
                }
        ...
        if (i8 > 0) {
            int i9 = i8 + i4;
            if (m485a.length < i9) {
                m485a = m41673a(m485a, i4, i9);
            }
            str.getChars(i3, length, m485a, i4);
            i4 = i9;
        }
        return new String(m485a, 0, i4);
    }
