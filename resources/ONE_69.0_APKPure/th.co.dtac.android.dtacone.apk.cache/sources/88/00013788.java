...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.fragment.consent.OnePostpaidConsentNonTelcoFragment$updateAppFormObserver$1 */
/* loaded from: classes10.dex */
public final class OnePostpaidConsentNonTelcoFragment$updateAppFormObserver$1 extends Lambda implements Function1<UpdateEventAppForm, Unit> {
    final /* synthetic */ OnePostpaidConsentNonTelcoFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.fragment.consent.OnePostpaidConsentNonTelcoFragment$updateAppFormObserver$1$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OnePostpaidConsentNonTelcoFragment$updateAppFormObserver$1(OnePostpaidConsentNonTelcoFragment onePostpaidConsentNonTelcoFragment) {
        super(1);
    ...
    public final void invoke2(@NotNull UpdateEventAppForm updateEvent) {
        ...
        if (i == 1) {
            this.this$0.getViewModelRegistration().handleEsignEvent();
        } else if (i == 2) {
            this.this$0.getViewModelRegistration().handlePdpaEvent();
        } else if (i != 3) {
        } else {
            this.this$0.getViewModelRegistration().handleTmnEvent();
        }
    }
}