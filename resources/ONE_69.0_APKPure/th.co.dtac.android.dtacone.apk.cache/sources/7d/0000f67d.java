...
public class AESEngine implements BlockCipher {
    ...
    private static int FFmulX(int i) {
        return (((i & f75018m1) >>> 7) * 27) ^ ((f75019m2 & i) << 1);
    }

    private static int FFmulX2(int i) {
        int i2 = i & f75021m4;
        int i3 = i2 ^ (i2 >>> 1);
        return (i3 >>> 5) ^ (((f75022m5 & i) << 2) ^ (i3 >>> 2));
    }
    ...
    private void decryptBlock(int[][] iArr) {
        ...
        int i3 = i ^ iArr2[0];
        int i4 = 1;
        int i5 = this.f75024C1 ^ iArr2[1];
        int i6 = this.f75025C2 ^ iArr2[2];
        int i7 = i2 - 1;
        char c2 = 3;
        int i8 = iArr2[3] ^ this.f75026C3;
        while (i7 > i4) {
            int[] iArr3 = Tinv0;
        ...
        byte[] bArr = f75016Si;
        byte[] bArr2 = this.f75027s;
        int[] iArr5 = iArr[0];
        this.f75023C0 = ((((bArr[shift7 & 255] & 255) ^ ((bArr2[(shift10 >> 8) & 255] & 255) << 8)) ^ ((bArr2[(shift9 >> 16) & 255] & 255) << 16)) ^ (bArr[(shift8 >> 24) & 255] << Ascii.CAN)) ^ iArr5[0];
        this.f75024C1 = ((((bArr2[shift8 & 255] & 255) ^ ((bArr2[(shift7 >> 8) & 255] & 255) << 8)) ^ ((bArr[(shift10 >> 16) & 255] & 255) << 16)) ^ (bArr2[(shift9 >> 24) & 255] << Ascii.CAN)) ^ iArr5[1];
        this.f75025C2 = ((((bArr2[shift9 & 255] & 255) ^ ((bArr[(shift8 >> 8) & 255] & 255) << 8)) ^ ((bArr[(shift7 >> 16) & 255] & 255) << 16)) ^ (bArr2[(shift10 >> 24) & 255] << Ascii.CAN)) ^ iArr5[2];
        this.f75026C3 = ((((bArr[shift10 & 255] & 255) ^ ((bArr2[(shift9 >> 8) & 255] & 255) << 8)) ^ ((bArr2[(shift8 >> 16) & 255] & 255) << 16)) ^ (bArr2[(shift7 >> 24) & 255] << Ascii.CAN)) ^ iArr5[3];
    }
    ...
    private void encryptBlock(int[][] iArr) {
        ...
        int i2 = i ^ iArr2[0];
        int i3 = 1;
        int i4 = this.f75024C1 ^ iArr2[1];
        int i5 = this.f75025C2 ^ iArr2[2];
        char c2 = 3;
        int i6 = iArr2[3] ^ this.f75026C3;
        int i7 = 1;
        ...
        byte[] bArr2 = this.f75027s;
        int[] iArr5 = iArr[i7 + 1];
        this.f75023C0 = ((i12 ^ ((bArr2[(shift9 >> 16) & 255] & 255) << 16)) ^ (bArr2[(i11 >> 24) & 255] << Ascii.CAN)) ^ iArr5[0];
        this.f75024C1 = ((((bArr2[shift8 & 255] & 255) ^ ((bArr[(shift9 >> 8) & 255] & 255) << 8)) ^ ((bArr[(i11 >> 16) & 255] & 255) << 16)) ^ (bArr2[(shift7 >> 24) & 255] << Ascii.CAN)) ^ iArr5[1];
        this.f75025C2 = ((((bArr2[shift9 & 255] & 255) ^ ((bArr[(i11 >> 8) & 255] & 255) << 8)) ^ ((bArr[(shift7 >> 16) & 255] & 255) << 16)) ^ (bArr[(shift8 >> 24) & 255] << Ascii.CAN)) ^ iArr5[2];
        this.f75026C3 = ((((bArr2[i11 & 255] & 255) ^ ((bArr2[(shift7 >> 8) & 255] & 255) << 8)) ^ ((bArr2[(shift8 >> 16) & 255] & 255) << 16)) ^ (bArr[(shift9 >> 24) & 255] << Ascii.CAN)) ^ iArr5[3];
    }
    ...
    private void packBlock(byte[] bArr, int i) {
        int i2 = this.f75023C0;
        bArr[i] = (byte) i2;
        bArr[i + 1] = (byte) (i2 >> 8);
        bArr[i + 2] = (byte) (i2 >> 16);
        bArr[i + 3] = (byte) (i2 >> 24);
        int i3 = this.f75024C1;
        bArr[i + 4] = (byte) i3;
        bArr[i + 5] = (byte) (i3 >> 8);
        bArr[i + 6] = (byte) (i3 >> 16);
        bArr[i + 7] = (byte) (i3 >> 24);
        int i4 = this.f75025C2;
        bArr[i + 8] = (byte) i4;
        bArr[i + 9] = (byte) (i4 >> 8);
        bArr[i + 10] = (byte) (i4 >> 16);
        bArr[i + 11] = (byte) (i4 >> 24);
        int i5 = this.f75026C3;
        bArr[i + 12] = (byte) i5;
        bArr[i + 13] = (byte) (i5 >> 8);
    ...
    private void unpackBlock(byte[] bArr, int i) {
        ...
        this.f75023C0 = i4;
        this.f75023C0 = i4 | (bArr[i + 3] << Ascii.CAN);
        int i5 = bArr[i + 4] & 255;
        this.f75024C1 = i5;
        ...
        this.f75024C1 = i7;
        this.f75024C1 = i7 | (bArr[i + 7] << Ascii.CAN);
        int i8 = bArr[i + 8] & 255;
        this.f75025C2 = i8;
        ...
        this.f75025C2 = i10;
        this.f75025C2 = i10 | (bArr[i + 11] << Ascii.CAN);
        ...
        this.f75026C3 = i13;
        this.f75026C3 = (bArr[i + 15] << Ascii.CAN) | i13;
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (z) {
            this.f75027s = Arrays.clone(f75015S);
        } else {
            this.f75027s = Arrays.clone(f75016Si);
        }
    }
