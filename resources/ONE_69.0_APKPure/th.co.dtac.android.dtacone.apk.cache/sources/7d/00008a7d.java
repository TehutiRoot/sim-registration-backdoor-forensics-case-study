...
public class ProductAction {
    ...
    /* renamed from: a */
    public final Map f44407a = new HashMap();
    ...
    /* renamed from: a */
    public final void m48740a(String str, String str2) {
        Preconditions.checkNotNull(str, "Name should be non-null");
        this.f44407a.put(str, str2);
    }
    ...
    public ProductAction setCheckoutStep(int i) {
        m48740a("&cos", Integer.toString(i));
        return this;
    }
    ...
    public String toString() {
        ...
        for (Map.Entry entry : this.f44407a.entrySet()) {
    ...
    public final Map zza() {
        return new HashMap(this.f44407a);
    }
}