...
public final class CountryListDialogFragment extends DialogFragment {
    ...
    @NotNull
    private final Lazy listView$delegate = LazyKt__LazyJVMKt.lazy(new C5547a());
    @NotNull
    private final Lazy toolbar$delegate = LazyKt__LazyJVMKt.lazy(new C5549c());

    @Metadata(m29143d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&¨\u0006\u0006"}, m29142d2 = {"Lco/omise/android/ui/CountryListDialogFragment$CountryListDialogListener;", "", "onCountrySelected", "", "country", "Lco/omise/android/models/CountryInfo;", "sdk_productionRelease"}, m29141k = 1, m29140mv = {1, 7, 1}, m29138xi = 48)
    ...
    /* loaded from: classes3.dex */
    public static final class C5547a extends Lambda implements Function0 {
        ...
        public final RecyclerView invoke() {
            return (RecyclerView) CountryListDialogFragment.this._$_findCachedViewById(C5500R.C5503id.country_list);
        }
    }

    /* renamed from: co.omise.android.ui.CountryListDialogFragment$b */
    /* loaded from: classes3.dex */
    public /* synthetic */ class C5548b extends FunctionReferenceImpl implements Function1 {
        public C5548b(Object obj) {
            super(1, obj, CountryListDialogFragment.class, "onCountryClick", "onCountryClick(Lco/omise/android/models/CountryInfo;)V", 0);
        }

        /* renamed from: a */
        public final void m51234a(CountryInfo p0) {
    ...
    /* loaded from: classes3.dex */
    public static final class C5549c extends Lambda implements Function0 {
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C5549c() {
            super(0);
            CountryListDialogFragment.this = r1;
        ...
        public final Toolbar invoke() {
            return (Toolbar) CountryListDialogFragment.this._$_findCachedViewById(C5500R.C5503id.toolbar_country_list);
        }
    }
    ...
    /* renamed from: n */
    public static /* synthetic */ int m51237n(CountryInfo countryInfo, CountryInfo countryInfo2) {
        return m74125onViewCreated$lambda1(countryInfo, countryInfo2);
    }

    /* renamed from: o */
    public static /* synthetic */ boolean m51236o(CountryListDialogFragment countryListDialogFragment, MenuItem menuItem) {
        return m74124onViewCreated$lambda0(countryListDialogFragment, menuItem);
    }
    ...
    public static final boolean m74124onViewCreated$lambda0(CountryListDialogFragment this$0, MenuItem menuItem) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        if (menuItem.getItemId() == C5500R.C5503id.close_menu) {
            this$0.dismiss();
            return true;
        }
        return true;
    ...
    public static final int m74125onViewCreated$lambda1(CountryInfo countryInfo, CountryInfo countryInfo2) {
    ...
    public int getTheme() {
        return C5500R.C5508style.OmiseFullScreenDialogTheme;
    }
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        return inflater.inflate(C5500R.C5504layout.dialog_country_list, viewGroup);
    }
    ...
    public void onViewCreated(@NotNull View view, @Nullable Bundle bundle) {
        ...
        getToolbar().setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() { // from class: Oy
            ...
            public final boolean onMenuItemClick(MenuItem menuItem) {
                return CountryListDialogFragment.m51236o(CountryListDialogFragment.this, menuItem);
            }
        });
        CountryListAdapter countryListAdapter = new CountryListAdapter(new C5548b(this));
        ...
        countryListAdapter.submitList(CollectionsKt___CollectionsKt.sortedWith(CountryInfo.Companion.getALL(), new Comparator() { // from class: Py
            ...
            public final int compare(Object obj, Object obj2) {
                return CountryListDialogFragment.m51237n((CountryInfo) obj, (CountryInfo) obj2);
            }
        }));
    }
