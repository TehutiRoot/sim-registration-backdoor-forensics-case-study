...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.viewmodel.OnePostpaidRegistrationViewModel$validateExistingCustomer$3 */
/* loaded from: classes10.dex */
public final class OnePostpaidRegistrationViewModel$validateExistingCustomer$3 extends Lambda implements Function1<MrtrPostpaidValidateCustomerResponse, Unit> {
    final /* synthetic */ boolean $isFromSmartCard;
    final /* synthetic */ OnePostpaidRegistrationViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidRegistrationViewModel$validateExistingCustomer$3(OnePostpaidRegistrationViewModel onePostpaidRegistrationViewModel, boolean z) {
        super(1);
    ...
    public final void invoke2(MrtrPostpaidValidateCustomerResponse mrtrPostpaidValidateCustomerResponse) {
        ...
        onePostpaidRegistrationViewModel.setNewIdFlag(newIdFlag);
