...
public final class SQLiteCopyOpenHelper implements SupportSQLiteOpenHelper, DelegatingOpenHelper {
    ...
    /* renamed from: c */
    public final File f37494c;

    /* renamed from: d */
    public final Callable f37495d;

    /* renamed from: e */
    public final int f37496e;

    /* renamed from: f */
    public final SupportSQLiteOpenHelper f37497f;

    /* renamed from: g */
    public DatabaseConfiguration f37498g;
    ...
    public SQLiteCopyOpenHelper(@NotNull Context context, @Nullable String str, @Nullable File file, @Nullable Callable<InputStream> callable, int i, @NotNull SupportSQLiteOpenHelper delegate) {
        ...
        this.f37493b = str;
        this.f37494c = file;
        this.f37495d = callable;
        this.f37496e = i;
        this.f37497f = delegate;
    }

    /* renamed from: b */
    public final void m52806b(File file, boolean z) {
        ReadableByteChannel newChannel;
        if (this.f37493b != null) {
            newChannel = Channels.newChannel(this.f37492a.getAssets().open(this.f37493b));
            Intrinsics.checkNotNullExpressionValue(newChannel, "newChannel(context.assets.open(copyFromAssetPath))");
        } else if (this.f37494c != null) {
            newChannel = new FileInputStream(this.f37494c).getChannel();
            Intrinsics.checkNotNullExpressionValue(newChannel, "FileInputStream(copyFromFile).channel");
        } else {
            Callable callable = this.f37495d;
            if (callable != null) {
                try {
        ...
        File intermediateFile = File.createTempFile("room-copy-helper", ".tmp", this.f37492a.getCacheDir());
    ...
    /* renamed from: d */
    public final SupportSQLiteOpenHelper m52805d(File file) {
        try {
            final int readVersion = DBUtil.readVersion(file);
            FrameworkSQLiteOpenHelperFactory frameworkSQLiteOpenHelperFactory = new FrameworkSQLiteOpenHelperFactory();
            SupportSQLiteOpenHelper.Configuration.Builder name = SupportSQLiteOpenHelper.Configuration.Companion.builder(this.f37492a).name(file.getAbsolutePath());
            final int coerceAtLeast = AbstractC11695c.coerceAtLeast(readVersion, 1);
    ...
    /* renamed from: g */
    public final void m52804g(File file, boolean z) {
        SupportSQLiteDatabase readableDatabase;
        DatabaseConfiguration databaseConfiguration = this.f37498g;
        ...
        SupportSQLiteOpenHelper m52805d = m52805d(file);
        try {
            if (z) {
                readableDatabase = m52805d.getWritableDatabase();
            } else {
                readableDatabase = m52805d.getReadableDatabase();
            }
            DatabaseConfiguration databaseConfiguration2 = this.f37498g;
            ...
            CloseableKt.closeFinally(m52805d, null);
        } finally {
        }
    }
    ...
    /* renamed from: i */
    public final void m52803i(boolean z) {
        String databaseName = getDatabaseName();
        if (databaseName != null) {
            File databaseFile = this.f37492a.getDatabasePath(databaseName);
            DatabaseConfiguration databaseConfiguration = this.f37498g;
            ...
            ProcessLock processLock = new ProcessLock(databaseName, this.f37492a.getFilesDir(), databaseConfiguration.multiInstanceInvalidation);
            try {
                ProcessLock.lock$default(processLock, false, 1, null);
                if (!databaseFile.exists()) {
                    try {
                        Intrinsics.checkNotNullExpressionValue(databaseFile, "databaseFile");
                        m52806b(databaseFile, z);
                        processLock.unlock();
                        return;
                    } catch (IOException e) {
                ...
                try {
                    ...
                    if (readVersion == this.f37496e) {
                        processLock.unlock();
                        return;
                    }
                    DatabaseConfiguration databaseConfiguration3 = this.f37498g;
                    if (databaseConfiguration3 == null) {
                        Intrinsics.throwUninitializedPropertyAccessException("databaseConfiguration");
                    } else {
                        databaseConfiguration2 = databaseConfiguration3;
                    }
                    if (databaseConfiguration2.isMigrationRequired(readVersion, this.f37496e)) {
                        processLock.unlock();
                        return;
                    }
                    if (this.f37492a.deleteDatabase(databaseName)) {
                        try {
                            m52806b(databaseFile, z);
    ...
    public final void setDatabaseConfiguration(@NotNull DatabaseConfiguration databaseConfiguration) {
        ...
        this.f37498g = databaseConfiguration;
    }
