...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.consent_nontelco.viewModel.OneConsentNonTelcoViewModel$getConsentTmn$2 */
/* loaded from: classes10.dex */
public final class OneConsentNonTelcoViewModel$getConsentTmn$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ OneConsentNonTelcoViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneConsentNonTelcoViewModel$getConsentTmn$2(OneConsentNonTelcoViewModel oneConsentNonTelcoViewModel) {
        super(1);
    ...
    public final void invoke2(Throwable th2) {
        ...
        errorService.handleException(th2, new OneErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.view.appOne.consent_nontelco.viewModel.OneConsentNonTelcoViewModel$getConsentTmn$2.1
