...
@Metadata(m29143d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00030\u0002H\u008a@"}, m29142d2 = {"<anonymous>", "", "Lkotlinx/coroutines/channels/ProducerScope;", "Landroid/graphics/Rect;"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
@DebugMetadata(m29093c = "androidx.activity.PipHintTrackerKt$trackPipAnimationHintView$flow$1", m29092f = "PipHintTracker.kt", m29091i = {}, m29090l = {CustomerEnquiry700MhzFragment.hiddenSubProdHeight}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
...
public final class PipHintTrackerKt$trackPipAnimationHintView$flow$1 extends SuspendLambda implements Function2<ProducerScope<? super Rect>, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes.dex */
    public static final class C20131 extends Lambda implements Function0<Unit> {
        final /* synthetic */ View$OnAttachStateChangeListenerC2014x7c5261f5 $attachStateChangeListener;
        ...
        public C20131(View view, ViewTreeObserver.OnScrollChangedListener onScrollChangedListener, View.OnLayoutChangeListener onLayoutChangeListener, View$OnAttachStateChangeListenerC2014x7c5261f5 view$OnAttachStateChangeListenerC2014x7c5261f5) {
            super(0);
            this.$view = view;
            this.$scrollChangeListener = onScrollChangedListener;
            this.$layoutChangeListener = onLayoutChangeListener;
            this.$attachStateChangeListener = view$OnAttachStateChangeListenerC2014x7c5261f5;
        }
    ...
    /* renamed from: a */
    public static /* synthetic */ void m64723a(ProducerScope producerScope, View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        invokeSuspend$lambda$0(producerScope, view, i, i2, i3, i4, i5, i6, i7, i8);
    }

    /* renamed from: b */
    public static /* synthetic */ void m64722b(ProducerScope producerScope, View view) {
    ...
    public static final void invokeSuspend$lambda$0(ProducerScope producerScope, View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        ...
        if (i != i5 || i3 != i7 || i2 != i6 || i4 != i8) {
            m64724a = PipHintTrackerKt.m64724a(view);
            producerScope.mo74250trySendJP2dKIU(m64724a);
        }
    }
        ...
        if (i != 0) {
            ...
            final View.OnLayoutChangeListener onLayoutChangeListener = new View.OnLayoutChangeListener() { // from class: androidx.activity.a
                ...
                public final void onLayoutChange(View view, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
                    PipHintTrackerKt$trackPipAnimationHintView$flow$1.m64723a(ProducerScope.this, view, i2, i3, i4, i5, i6, i7, i8, i9);
                }
            };
            ...
            final ViewTreeObserver.OnScrollChangedListener onScrollChangedListener = new ViewTreeObserver.OnScrollChangedListener() { // from class: androidx.activity.b
                ...
                public final void onScrollChanged() {
                    PipHintTrackerKt$trackPipAnimationHintView$flow$1.m64722b(ProducerScope.this, view);
                }
            };
            ...
            ?? r3 = new View.OnAttachStateChangeListener() { // from class: androidx.activity.PipHintTrackerKt$trackPipAnimationHintView$flow$1$attachStateChangeListener$1
                ...
                public void onViewAttachedToWindow(@NotNull View view3) {
                    ...
                    m64724a2 = PipHintTrackerKt.m64724a(view2);
                    producerScope2.mo74250trySendJP2dKIU(m64724a2);
            ...
            if (Api19Impl.INSTANCE.isAttachedToWindow(this.$view)) {
                m64724a = PipHintTrackerKt.m64724a(this.$view);
                producerScope.mo74250trySendJP2dKIU(m64724a);
                this.$view.getViewTreeObserver().addOnScrollChangedListener(onScrollChangedListener);
                this.$view.addOnLayoutChangeListener(onLayoutChangeListener);
            }
            this.$view.addOnAttachStateChangeListener(r3);
            C20131 c20131 = new C20131(this.$view, onScrollChangedListener, onLayoutChangeListener, r3);
            this.label = 1;
            if (ProduceKt.awaitClose(producerScope, c20131, this) == coroutine_suspended) {
