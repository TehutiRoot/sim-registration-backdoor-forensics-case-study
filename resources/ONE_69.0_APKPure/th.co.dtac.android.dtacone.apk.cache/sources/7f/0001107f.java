...
public final class OnePrepaidRegisterTCheckPrivilegeRequest {
    ...
    public static /* synthetic */ OnePrepaidRegisterTCheckPrivilegeRequest copy$default(OnePrepaidRegisterTCheckPrivilegeRequest onePrepaidRegisterTCheckPrivilegeRequest, String str, String str2, String str3, String str4, int i, Object obj) {
        if ((i & 1) != 0) {
            str = onePrepaidRegisterTCheckPrivilegeRequest.f81985a;
        }
        if ((i & 2) != 0) {
            str2 = onePrepaidRegisterTCheckPrivilegeRequest.f81986b;
        }
        if ((i & 4) != 0) {
            str3 = onePrepaidRegisterTCheckPrivilegeRequest.f81987c;
        }
        if ((i & 8) != 0) {
            str4 = onePrepaidRegisterTCheckPrivilegeRequest.f81988d;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof OnePrepaidRegisterTCheckPrivilegeRequest) {
            ...
            return Intrinsics.areEqual(this.f81985a, onePrepaidRegisterTCheckPrivilegeRequest.f81985a) && Intrinsics.areEqual(this.f81986b, onePrepaidRegisterTCheckPrivilegeRequest.f81986b) && Intrinsics.areEqual(this.f81987c, onePrepaidRegisterTCheckPrivilegeRequest.f81987c) && Intrinsics.areEqual(this.f81988d, onePrepaidRegisterTCheckPrivilegeRequest.f81988d);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        String str2 = this.f81986b;
        int hashCode2 = (hashCode + (str2 == null ? 0 : str2.hashCode())) * 31;
        String str3 = this.f81987c;
        int hashCode3 = (hashCode2 + (str3 == null ? 0 : str3.hashCode())) * 31;
        String str4 = this.f81988d;
