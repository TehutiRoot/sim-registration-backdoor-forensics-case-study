...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.registration.fragment.OneInputOTPFragment$initViewModel$1$4 */
/* loaded from: classes10.dex */
public final class OneInputOTPFragment$initViewModel$1$4 extends Lambda implements Function1<StatusResource, Unit> {
    final /* synthetic */ OneInputOTPFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneInputOTPFragment$initViewModel$1$4(OneInputOTPFragment oneInputOTPFragment) {
        super(1);
    ...
    public final void invoke2(StatusResource statusResource) {
        this.this$0.m10434p(statusResource);
    }
}