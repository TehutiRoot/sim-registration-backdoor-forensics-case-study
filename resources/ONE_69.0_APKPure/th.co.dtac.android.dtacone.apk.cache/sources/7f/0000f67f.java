...
public class AESLightEngine implements BlockCipher {
    ...
    private static int FFmulX(int i) {
        return (((i & f75042m1) >>> 7) * 27) ^ ((f75043m2 & i) << 1);
    }

    private static int FFmulX2(int i) {
        int i2 = i & f75045m4;
        int i3 = i2 ^ (i2 >>> 1);
        return (i3 >>> 5) ^ (((f75046m5 & i) << 2) ^ (i3 >>> 2));
    }
    ...
    private void decryptBlock(int[][] iArr) {
        ...
        int[] iArr2 = iArr[i2];
        int i3 = i ^ iArr2[0];
        int i4 = this.f75048C1 ^ iArr2[1];
        int i5 = this.f75049C2 ^ iArr2[2];
        int i6 = i2 - 1;
        int i7 = iArr2[3] ^ this.f75050C3;
        while (true) {
            byte[] bArr = f75041Si;
            int i8 = i3 & 255;
            if (i6 <= 1) {
                ...
                int[] iArr3 = iArr[0];
                this.f75047C0 = i9 ^ iArr3[0];
                this.f75048C1 = ((((bArr[inv_mcol2 & 255] & 255) ^ ((bArr[(inv_mcol >> 8) & 255] & 255) << 8)) ^ ((bArr[(inv_mcol4 >> 16) & 255] & 255) << 16)) ^ (bArr[(inv_mcol3 >> 24) & 255] << Ascii.CAN)) ^ iArr3[1];
                this.f75049C2 = ((((bArr[inv_mcol3 & 255] & 255) ^ ((bArr[(inv_mcol2 >> 8) & 255] & 255) << 8)) ^ ((bArr[(inv_mcol >> 16) & 255] & 255) << 16)) ^ (bArr[(inv_mcol4 >> 24) & 255] << Ascii.CAN)) ^ iArr3[2];
                this.f75050C3 = ((((bArr[inv_mcol4 & 255] & 255) ^ ((bArr[(inv_mcol3 >> 8) & 255] & 255) << 8)) ^ ((bArr[(inv_mcol2 >> 16) & 255] & 255) << 16)) ^ (bArr[(inv_mcol >> 24) & 255] << Ascii.CAN)) ^ iArr3[3];
                return;
            }
    ...
    private void encryptBlock(int[][] iArr) {
        ...
        int[] iArr2 = iArr[0];
        int i2 = i ^ iArr2[0];
        int i3 = this.f75048C1 ^ iArr2[1];
        int i4 = this.f75049C2 ^ iArr2[2];
        int i5 = iArr2[3] ^ this.f75050C3;
        int i6 = 1;
        ...
        int[] iArr3 = iArr[i6 + 1];
        this.f75047C0 = iArr3[0] ^ ((((bArr2[mcol7 & 255] & 255) ^ ((bArr2[(mcol8 >> 8) & 255] & 255) << 8)) ^ ((bArr2[(mcol9 >> 16) & 255] & 255) << 16)) ^ (bArr2[(mcol10 >> 24) & 255] << Ascii.CAN));
        this.f75048C1 = ((((bArr2[mcol8 & 255] & 255) ^ ((bArr2[(mcol9 >> 8) & 255] & 255) << 8)) ^ ((bArr2[(mcol10 >> 16) & 255] & 255) << 16)) ^ (bArr2[(mcol7 >> 24) & 255] << Ascii.CAN)) ^ iArr3[1];
        this.f75049C2 = ((((bArr2[mcol9 & 255] & 255) ^ ((bArr2[(mcol10 >> 8) & 255] & 255) << 8)) ^ ((bArr2[(mcol7 >> 16) & 255] & 255) << 16)) ^ (bArr2[(mcol8 >> 24) & 255] << Ascii.CAN)) ^ iArr3[2];
        this.f75050C3 = ((((bArr2[mcol10 & 255] & 255) ^ ((bArr2[(mcol7 >> 8) & 255] & 255) << 8)) ^ ((bArr2[(mcol8 >> 16) & 255] & 255) << 16)) ^ (bArr2[(mcol9 >> 24) & 255] << Ascii.CAN)) ^ iArr3[3];
    }
    ...
    private void packBlock(byte[] bArr, int i) {
        int i2 = this.f75047C0;
        bArr[i] = (byte) i2;
        bArr[i + 1] = (byte) (i2 >> 8);
        bArr[i + 2] = (byte) (i2 >> 16);
        bArr[i + 3] = (byte) (i2 >> 24);
        int i3 = this.f75048C1;
        bArr[i + 4] = (byte) i3;
        bArr[i + 5] = (byte) (i3 >> 8);
        bArr[i + 6] = (byte) (i3 >> 16);
        bArr[i + 7] = (byte) (i3 >> 24);
        int i4 = this.f75049C2;
        bArr[i + 8] = (byte) i4;
        bArr[i + 9] = (byte) (i4 >> 8);
        bArr[i + 10] = (byte) (i4 >> 16);
        bArr[i + 11] = (byte) (i4 >> 24);
        int i5 = this.f75050C3;
        bArr[i + 12] = (byte) i5;
        bArr[i + 13] = (byte) (i5 >> 8);
    ...
    private void unpackBlock(byte[] bArr, int i) {
        ...
        this.f75047C0 = i4;
        this.f75047C0 = i4 | (bArr[i + 3] << Ascii.CAN);
        int i5 = bArr[i + 4] & 255;
        this.f75048C1 = i5;
        ...
        this.f75048C1 = i7;
        this.f75048C1 = i7 | (bArr[i + 7] << Ascii.CAN);
        int i8 = bArr[i + 8] & 255;
        this.f75049C2 = i8;
        ...
        this.f75049C2 = i10;
        this.f75049C2 = i10 | (bArr[i + 11] << Ascii.CAN);
        ...
        this.f75050C3 = i13;
        this.f75050C3 = (bArr[i + 15] << Ascii.CAN) | i13;
    }
