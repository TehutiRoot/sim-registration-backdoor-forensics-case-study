...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.fragment.consent.OnePostpaidTMNFragment$activity$2 */
/* loaded from: classes10.dex */
public final class OnePostpaidTMNFragment$activity$2 extends Lambda implements Function0<OnePostpaidRegistrationActivity> {
    final /* synthetic */ OnePostpaidTMNFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidTMNFragment$activity$2(OnePostpaidTMNFragment onePostpaidTMNFragment) {
        super(0);
