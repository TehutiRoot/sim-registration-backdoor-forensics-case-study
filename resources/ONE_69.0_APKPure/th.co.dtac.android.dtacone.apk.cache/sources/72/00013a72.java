...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.pre2post.fragment.OnePre2PostSignatureFragment$setupObserve$1$3 */
/* loaded from: classes10.dex */
public final class OnePre2PostSignatureFragment$setupObserve$1$3 extends Lambda implements Function1<Resource<? extends OneCommonResponse>, Unit> {
    final /* synthetic */ OnePre2PostViewModel $this_apply;
    final /* synthetic */ OnePre2PostSignatureFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.pre2post.fragment.OnePre2PostSignatureFragment$setupObserve$1$3$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OnePre2PostSignatureFragment$setupObserve$1$3(OnePre2PostViewModel onePre2PostViewModel, OnePre2PostSignatureFragment onePre2PostSignatureFragment) {
        super(1);
    ...
    public final void invoke2(Resource<OneCommonResponse> resource) {
        ...
        if (i == 2) {
            onePre2PostViewModel.submitPre2PostTrueCompany();
        } else if (i != 3) {
        } else {
