...
@DebugMetadata(m29093c = "androidx.compose.foundation.gestures.DraggableKt$draggable$5", m29092f = "Draggable.kt", m29091i = {}, m29090l = {194}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
...
public final class DraggableKt$draggable$5 extends SuspendLambda implements Function3<CoroutineScope, Velocity, Continuation<? super Unit>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(CoroutineScope coroutineScope, Velocity velocity, Continuation<? super Unit> continuation) {
        return m69602invokeLuvzFrg(coroutineScope, velocity.m74076unboximpl(), continuation);
    }

    @Nullable
    /* renamed from: invoke-LuvzFrg  reason: not valid java name */
    public final Object m69602invokeLuvzFrg(@NotNull CoroutineScope coroutineScope, long j, @Nullable Continuation<? super Unit> continuation) {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i != 0) {
            ...
            m61446e = DraggableKt.m61446e(j, this.$orientation);
            Float boxFloat = Boxing.boxFloat(m61446e);
            this.label = 1;
