...
public class PDFontSetting implements COSObjectable {
    ...
    /* renamed from: a */
    public COSArray f60470a;

    public PDFontSetting() {
        this.f60470a = null;
        COSArray cOSArray = new COSArray();
        this.f60470a = cOSArray;
        cOSArray.add((COSBase) null);
        this.f60470a.add((COSBase) new COSFloat(1.0f));
    }
    ...
    public PDFont getFont() throws IOException {
        COSBase object = this.f60470a.getObject(0);
    ...
    public float getFontSize() {
        return ((COSNumber) this.f60470a.get(1)).floatValue();
    }

    public void setFont(PDFont pDFont) {
        this.f60470a.set(0, pDFont);
    }

    public void setFontSize(float f) {
        this.f60470a.set(1, (COSBase) new COSFloat(f));
    }
