...
public final class ObservableRetryPredicate<T> extends AbstractC11078a {

    /* renamed from: a */
    public final Predicate f65534a;
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        new RepeatObserver(observer, this.f65535b, this.f65534a, sequentialDisposable, this.source).subscribeNext();
    }
}