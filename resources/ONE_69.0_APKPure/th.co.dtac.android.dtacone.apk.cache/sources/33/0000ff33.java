...
public abstract class Nat {
    ...
    /* renamed from: M */
    private static final long f75540M = 4294967295L;
    ...
    public static int add33At(int i, int i2, int[] iArr, int i3) {
        ...
        iArr[i3] = (int) j;
        int i4 = i3 + 1;
        long j2 = (j >>> 32) + (4294967295L & iArr[i4]) + 1;
        iArr[i4] = (int) j2;
        if ((j2 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addBothTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            int i6 = i4 + i5;
            long j2 = j + (iArr[i2 + i5] & 4294967295L) + (iArr2[i3 + i5] & 4294967295L) + (4294967295L & iArr3[i6]);
            iArr3[i6] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addDWordAt(int i, long j, int[] iArr, int i2) {
        ...
        iArr[i2] = (int) j2;
        int i3 = i2 + 1;
        long j3 = (j2 >>> 32) + (4294967295L & iArr[i3]) + (j >>> 32);
        iArr[i3] = (int) j3;
        if ((j3 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addToEachOther(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        for (int i4 = 0; i4 < i; i4++) {
            int i5 = i2 + i4;
            int i6 = i3 + i4;
            long j2 = j + (iArr[i5] & 4294967295L) + (4294967295L & iArr2[i6]);
            int i7 = (int) j2;
            iArr[i5] = i7;
            iArr2[i6] = i7;
            j = j2 >>> 32;
    ...
    public static int csub(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4, int[] iArr3, int i5) {
        ...
        long j2 = 0;
        for (int i6 = 0; i6 < i; i6++) {
            long j3 = j2 + ((iArr[i3 + i6] & 4294967295L) - (iArr2[i4 + i6] & j));
            iArr3[i5 + i6] = (int) j3;
            j2 = j3 >> 32;
        }
        return (int) j2;
    ...
    /* renamed from: eq */
    public static boolean m24622eq(int i, int[] iArr, int[] iArr2) {
    ...
    public static int lessThan(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        long j = 0;
        for (int i4 = 0; i4 < i; i4++) {
            j = (j + ((iArr[i2 + i4] & 4294967295L) - (4294967295L & iArr2[i3 + i4]))) >> 32;
        }
        return (int) j;
    }
    ...
    public static int mulAddTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            int i6 = i4 + i;
            long mulWordAddTo = j + (mulWordAddTo(i, iArr[i2 + i5], iArr2, i3, iArr3, i4) & 4294967295L) + (iArr3[i6] & 4294967295L);
    ...
    public static int mulWord(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        int i5 = 0;
        do {
            long j3 = j2 + ((iArr[i3 + i5] & 4294967295L) * j);
            iArr2[i4 + i5] = (int) j3;
            j2 = j3 >>> 32;
            i5++;
        } while (i5 < i);
    ...
    public static int squareWordAdd(int[] iArr, int i, int i2, int[] iArr2, int i3) {
        int i4;
        long j = iArr[i + i2] & 4294967295L;
        long j2 = 0;
        int i5 = 0;
        int i6 = i3;
        do {
            long j3 = j2 + ((iArr[i + i5] & 4294967295L) * j) + (iArr2[i4] & 4294967295L);
            iArr2[i2 + i6] = (int) j3;
            j2 = j3 >>> 32;
            i6++;
            i5++;
    ...
    public static int subBothFrom(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            int i6 = i4 + i5;
            long j2 = j + (((iArr3[i6] & 4294967295L) - (iArr[i2 + i5] & 4294967295L)) - (4294967295L & iArr2[i3 + i5]));
            iArr3[i6] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int addTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            int i6 = i3 + i5;
            long j2 = j + (iArr[i2 + i5] & 4294967295L) + (iArr2[i6] & 4294967295L);
            iArr2[i6] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int mulAddTo(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            int i3 = i2 + i;
            long mulWordAddTo = j + (mulWordAddTo(i, iArr[i2], iArr2, 0, iArr3, i2) & 4294967295L) + (iArr3[i3] & 4294967295L);
    ...
    public static int squareWordAdd(int[] iArr, int i, int[] iArr2) {
        ...
        do {
            int i3 = i + i2;
            long j3 = j2 + ((iArr[i2] & 4294967295L) * j) + (iArr2[i3] & 4294967295L);
            iArr2[i3] = (int) j3;
            j2 = j3 >>> 32;
            i2++;
        } while (i2 < i);
