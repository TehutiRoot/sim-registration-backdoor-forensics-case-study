...
public final class SearchBarDefaults {
    ...
    /* renamed from: a */
    public static final float f26081a;

    /* renamed from: b */
    public static final float f26082b;

    static {
        SearchBarTokens searchBarTokens = SearchBarTokens.INSTANCE;
        f26081a = searchBarTokens.m71426getContainerElevationD9Ej5fM();
        f26082b = searchBarTokens.m71427getContainerHeightD9Ej5fM();
    }

    @Composable
    @NotNull
    /* renamed from: colors-Klgx-Pg  reason: not valid java name */
    public final SearchBarColors m70706colorsKlgxPg(long j, long j2, @Nullable TextFieldColors textFieldColors, @Nullable Composer composer, int i, int i2) {
        long j3;
        long j4;
        ...
        if ((i2 & 4) != 0) {
            textFieldColors2 = m70710inputFieldColorsITpI4ow(0L, 0L, 0L, 0L, null, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, composer, 0, (i << 3) & 57344, 16383);
        } else {
    ...
    public final float m70707getElevationD9Ej5fM() {
        return f26081a;
    }
    ...
    public final float m70708getInputFieldHeightD9Ej5fM() {
        return f26082b;
    }
    ...
    public final /* synthetic */ TextFieldColors m70709inputFieldColorsuKgnY(long j, long j2, long j3, TextSelectionColors textSelectionColors, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, Composer composer, int i, int i2, int i3) {
        ...
        long m71918copywmQWz5c$default = (i3 & 2) != 0 ? Color.m71918copywmQWz5c$default(ColorSchemeKt.toColor(FilledTextFieldTokens.INSTANCE.getDisabledInputColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j2;
        ...
        long m71918copywmQWz5c$default2 = (i3 & 64) != 0 ? Color.m71918copywmQWz5c$default(ColorSchemeKt.toColor(FilledTextFieldTokens.INSTANCE.getDisabledLeadingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j6;
        ...
        long m71918copywmQWz5c$default3 = (i3 & 512) != 0 ? Color.m71918copywmQWz5c$default(ColorSchemeKt.toColor(FilledTextFieldTokens.INSTANCE.getDisabledTrailingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j9;
        long color7 = (i3 & 1024) != 0 ? ColorSchemeKt.toColor(SearchBarTokens.INSTANCE.getSupportingTextColor(), composer, 6) : j10;
        long m71918copywmQWz5c$default4 = (i3 & 2048) != 0 ? Color.m71918copywmQWz5c$default(ColorSchemeKt.toColor(FilledTextFieldTokens.INSTANCE.getDisabledInputColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j11;
        if (ComposerKt.isTraceInProgress()) {
        ...
        int i4 = i << 3;
        int i5 = i2 << 6;
        TextFieldColors m70710inputFieldColorsITpI4ow = m70710inputFieldColorsITpI4ow(color, color, m71918copywmQWz5c$default, color2, textSelectionColors2, color3, color4, m71918copywmQWz5c$default2, color5, color6, m71918copywmQWz5c$default3, color7, color7, m71918copywmQWz5c$default4, composer, (i & 14) | (i4 & 112) | (i4 & 896) | (i4 & 7168) | (i4 & 57344) | (458752 & i4) | (3670016 & i4) | (29360128 & i4) | (234881024 & i4) | (i4 & 1879048192), ((i >> 27) & 14) | ((i2 << 3) & 112) | (i5 & 896) | (i5 & 7168) | (i5 & 57344), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m70710inputFieldColorsITpI4ow;
    }

    @Composable
    @NotNull
    /* renamed from: inputFieldColors-ITpI4ow  reason: not valid java name */
    public final TextFieldColors m70710inputFieldColorsITpI4ow(long j, long j2, long j3, long j4, @Nullable TextSelectionColors textSelectionColors, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, @Nullable Composer composer, int i, int i2, int i3) {
        ...
        long m71918copywmQWz5c$default = (i3 & 4) != 0 ? Color.m71918copywmQWz5c$default(ColorSchemeKt.toColor(FilledTextFieldTokens.INSTANCE.getDisabledInputColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        ...
        long m71918copywmQWz5c$default2 = (i3 & 128) != 0 ? Color.m71918copywmQWz5c$default(ColorSchemeKt.toColor(FilledTextFieldTokens.INSTANCE.getDisabledLeadingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j7;
        long color6 = (i3 & 256) != 0 ? ColorSchemeKt.toColor(SearchBarTokens.INSTANCE.getTrailingIconColor(), composer, 6) : j8;
        long color7 = (i3 & 512) != 0 ? ColorSchemeKt.toColor(SearchBarTokens.INSTANCE.getTrailingIconColor(), composer, 6) : j9;
        long m71918copywmQWz5c$default3 = (i3 & 1024) != 0 ? Color.m71918copywmQWz5c$default(ColorSchemeKt.toColor(FilledTextFieldTokens.INSTANCE.getDisabledTrailingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j10;
        ...
        long m71918copywmQWz5c$default4 = (i3 & 8192) != 0 ? Color.m71918copywmQWz5c$default(ColorSchemeKt.toColor(FilledTextFieldTokens.INSTANCE.getDisabledInputColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j13;
        if (ComposerKt.isTraceInProgress()) {
        ...
        int i4 = i2 << 18;
        TextFieldColors m70856colors0hiis_0 = TextFieldDefaults.INSTANCE.m70856colors0hiis_0(color, color2, m71918copywmQWz5c$default, 0L, 0L, 0L, 0L, 0L, color3, 0L, textSelectionColors2, 0L, 0L, 0L, 0L, color4, color5, m71918copywmQWz5c$default2, 0L, color6, color7, m71918copywmQWz5c$default3, 0L, 0L, 0L, 0L, 0L, color8, color9, m71918copywmQWz5c$default4, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, composer, (i & 1022) | ((i << 15) & 234881024), ((i >> 12) & 14) | (458752 & i) | (3670016 & i) | (i & 29360128) | ((i << 3) & 1879048192), ((i >> 27) & 14) | ((i2 << 3) & 112) | (i4 & 29360128) | (i4 & 234881024) | (i4 & 1879048192), 0, 3072, 1204058872, 4095);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
