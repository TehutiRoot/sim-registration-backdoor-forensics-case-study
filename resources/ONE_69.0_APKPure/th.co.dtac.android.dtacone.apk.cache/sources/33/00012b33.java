...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.campaign.view_model.OneCampaignViewModel$getTrueCampaignImageForRegister$2 */
/* loaded from: classes10.dex */
public final class OneCampaignViewModel$getTrueCampaignImageForRegister$2 extends Lambda implements Function1<OneTrueCampaignImageResponse, Unit> {
    final /* synthetic */ OneCampaignViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneCampaignViewModel$getTrueCampaignImageForRegister$2(OneCampaignViewModel oneCampaignViewModel) {
        super(1);
    ...
    public final void invoke2(OneTrueCampaignImageResponse oneTrueCampaignImageResponse) {
        ...
        mutableLiveData = this.this$0.f88982N;
        Resource.Companion companion = Resource.Companion;
        Data data = oneTrueCampaignImageResponse.getData();
        mutableLiveData.setValue(companion.success(data != null ? data.getCpPhotoBase64() : null));
    }
}