...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.buyDol.viewModel.OneBuyDolViewModel$chargeBankAccount$3 */
/* loaded from: classes10.dex */
public final class OneBuyDolViewModel$chargeBankAccount$3 extends Lambda implements Function1<OneBuyDolChargeResponse, Unit> {
    final /* synthetic */ OneBuyDolViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneBuyDolViewModel$chargeBankAccount$3(OneBuyDolViewModel oneBuyDolViewModel) {
        super(1);
    ...
    public final void invoke2(OneBuyDolChargeResponse oneBuyDolChargeResponse) {
        ...
        m15892U = this.this$0.m15892U();
        m15892U.setValue(Resource.Companion.success(oneBuyDolChargeResponse));
    }
}