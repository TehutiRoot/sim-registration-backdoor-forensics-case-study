...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.consent_nontelco.viewModel.OneConsentNonTelcoViewModel$getConsentNonTelco$2 */
/* loaded from: classes10.dex */
public final class OneConsentNonTelcoViewModel$getConsentNonTelco$2 extends Lambda implements Function1<ConsentNonTelcoResponse, Unit> {
    final /* synthetic */ OneConsentNonTelcoViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneConsentNonTelcoViewModel$getConsentNonTelco$2(OneConsentNonTelcoViewModel oneConsentNonTelcoViewModel) {
        super(1);
