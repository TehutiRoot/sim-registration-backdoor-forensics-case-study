...
public class AbstractWrappedByteChannel implements WrappedByteChannel {
    ...
    public boolean isBlocking() {
        ByteChannel byteChannel = this.f58426a;
    ...
    public boolean isOpen() {
        return this.f58426a.isOpen();
    }

    @Override // java.nio.channels.ReadableByteChannel
    public int read(ByteBuffer byteBuffer) throws IOException {
        return this.f58426a.read(byteBuffer);
    }
    ...
    public int write(ByteBuffer byteBuffer) throws IOException {
        return this.f58426a.write(byteBuffer);
    }
    ...
    public AbstractWrappedByteChannel(WrappedByteChannel wrappedByteChannel) {
        this.f58426a = wrappedByteChannel;
    }
}