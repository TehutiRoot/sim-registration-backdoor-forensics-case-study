...
public final class Response {
    ...
    /* renamed from: d */
    private final List<Object> f42865d;
    @SerializedName("headers")
    @NotNull

    /* renamed from: e */
    private final List<Header> f42866e;
    @SerializedName("content")
    @Nullable

    /* renamed from: f */
    private final Content f42867f;
    ...
    /* renamed from: h */
    private final long f42869h;
    @SerializedName("bodySize")

    /* renamed from: i */
    private final long f42870i;
    @SerializedName("totalSize")

    /* renamed from: j */
    private final long f42871j;
    ...
    public Response(int i, @NotNull String statusText, @NotNull String httpVersion, @NotNull List<? extends Object> cookies, @NotNull List<Header> headers, @Nullable Content content, @NotNull String redirectUrl, long j, long j2, long j3, @Nullable String str) {
        ...
        this.f42862a = i;
        this.f42863b = statusText;
        this.f42864c = httpVersion;
        this.f42865d = cookies;
        this.f42866e = headers;
        this.f42867f = content;
        this.f42868g = redirectUrl;
        this.f42869h = j;
        this.f42870i = j2;
        this.f42871j = j3;
        this.f42872k = str;
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof Response) {
            ...
            return this.f42862a == response.f42862a && Intrinsics.areEqual(this.f42863b, response.f42863b) && Intrinsics.areEqual(this.f42864c, response.f42864c) && Intrinsics.areEqual(this.f42865d, response.f42865d) && Intrinsics.areEqual(this.f42866e, response.f42866e) && Intrinsics.areEqual(this.f42867f, response.f42867f) && Intrinsics.areEqual(this.f42868g, response.f42868g) && this.f42869h == response.f42869h && this.f42870i == response.f42870i && this.f42871j == response.f42871j && Intrinsics.areEqual(this.f42872k, response.f42872k);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((((((((this.f42862a * 31) + this.f42863b.hashCode()) * 31) + this.f42864c.hashCode()) * 31) + this.f42865d.hashCode()) * 31) + this.f42866e.hashCode()) * 31;
        Content content = this.f42867f;
        int hashCode2 = (((((((((hashCode + (content == null ? 0 : content.hashCode())) * 31) + this.f42868g.hashCode()) * 31) + AbstractC17631Fh1.m68395a(this.f42869h)) * 31) + AbstractC17631Fh1.m68395a(this.f42870i)) * 31) + AbstractC17631Fh1.m68395a(this.f42871j)) * 31;
        String str = this.f42872k;
    ...
    public String toString() {
        ...
        List<Object> list = this.f42865d;
        List<Header> list2 = this.f42866e;
        Content content = this.f42867f;
        String str3 = this.f42868g;
        long j = this.f42869h;
        long j2 = this.f42870i;
        long j3 = this.f42871j;
        String str4 = this.f42872k;
    ...
    */
    public Response(@org.jetbrains.annotations.NotNull com.chuckerteam.chucker.internal.data.entity.HttpTransaction r20) {
        ...
        L29:
            ...
            r6 = 10
            int r6 = p000.AbstractC10172es.collectionSizeOrDefault(r1, r6)
            r2.<init>(r6)
