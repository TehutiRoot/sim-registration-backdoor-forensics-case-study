...
public class setWillNotDraw implements setDarkTextColor.valueOf {
    private final setDarkTextColor get;

    public setWillNotDraw(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.get(this.get);
    }
}