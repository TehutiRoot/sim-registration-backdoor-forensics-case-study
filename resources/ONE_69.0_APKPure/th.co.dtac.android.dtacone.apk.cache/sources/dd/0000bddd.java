...
public class setBackgroundResource implements setDarkTextColor.valueOf {
    private final setDarkTextColor ThreeDS2ServiceInstance;

    public setBackgroundResource(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.SDKInfo(this.ThreeDS2ServiceInstance);
    }
}