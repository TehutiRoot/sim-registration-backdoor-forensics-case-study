...
public final class Operator {
    ...
    /* renamed from: d */
    public static final ConcurrentMap f59732d = new ConcurrentHashMap();
    ...
    public static Operator getOperator(String str) {
        if (!str.equals(OperatorName.BEGIN_INLINE_IMAGE_DATA) && !OperatorName.BEGIN_INLINE_IMAGE.equals(str)) {
            ConcurrentMap concurrentMap = f59732d;
    ...
    public void setImageParameters(COSDictionary cOSDictionary) {
        this.f59735c = cOSDictionary;
    }

    public String toString() {
        return "PDFOperator{" + this.f59733a + "}";
    }
}