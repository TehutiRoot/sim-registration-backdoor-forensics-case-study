...
public final class OneCustomFragmentDialog extends BaseDialogFragment {
    ...
    public static final class Companion {
        ...
        public final OneCustomFragmentDialog newInstance(int i, @NotNull String message, @NotNull String positiveButton, @NotNull String negativeButton, boolean z, @NotNull CustomAlertDialogListener listener) {
            ...
            OneCustomFragmentDialog.f83044b = listener;
    ...
    @Metadata(m29143d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\bf\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&J\u0010\u0010\u0006\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&¨\u0006\u0007"}, m29142d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/dialog/OneCustomFragmentDialog$CustomAlertDialogListener;", "", "onNegative", "", DialogNavigator.NAME, "Landroidx/fragment/app/DialogFragment;", "onPositive", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    /* renamed from: A */
    public static final void m19955A(OneCustomFragmentDialog this_run, View view) {
        Intrinsics.checkNotNullParameter(this_run, "$this_run");
        CustomAlertDialogListener customAlertDialogListener = f83044b;
    ...
    /* renamed from: B */
    public static final void m19954B(OneCustomFragmentDialog this_run, View view) {
        Intrinsics.checkNotNullParameter(this_run, "$this_run");
        CustomAlertDialogListener customAlertDialogListener = f83044b;
        if (customAlertDialogListener != null) {
            Intrinsics.checkNotNull(customAlertDialogListener);
    ...
    /* renamed from: C */
    public static final void m19953C(OneCustomFragmentDialog this_run, View view) {
        Intrinsics.checkNotNullParameter(this_run, "$this_run");
        CustomAlertDialogListener customAlertDialogListener = f83044b;
        if (customAlertDialogListener != null) {
            Intrinsics.checkNotNull(customAlertDialogListener);
    ...
    /* renamed from: D */
    public static final void m19952D(OneCustomFragmentDialog this_run, View view) {
        Intrinsics.checkNotNullParameter(this_run, "$this_run");
        CustomAlertDialogListener customAlertDialogListener = f83044b;
        if (customAlertDialogListener != null) {
            Intrinsics.checkNotNull(customAlertDialogListener);
    ...
    /* renamed from: E */
    public static final void m19951E(OneCustomFragmentDialog this_run, View view) {
        Intrinsics.checkNotNullParameter(this_run, "$this_run");
        CustomAlertDialogListener customAlertDialogListener = f83044b;
        if (customAlertDialogListener != null) {
            Intrinsics.checkNotNull(customAlertDialogListener);
    ...
    /* renamed from: F */
    public static final void m19950F(OneCustomFragmentDialog this_run, View view) {
        Intrinsics.checkNotNullParameter(this_run, "$this_run");
        CustomAlertDialogListener customAlertDialogListener = f83044b;
        if (customAlertDialogListener != null) {
            Intrinsics.checkNotNull(customAlertDialogListener);
    ...
    /* renamed from: n */
    public static /* synthetic */ void m19949n(OneCustomFragmentDialog oneCustomFragmentDialog, View view) {
        m19953C(oneCustomFragmentDialog, view);
    }

    /* renamed from: o */
    public static /* synthetic */ void m19948o(OneCustomFragmentDialog oneCustomFragmentDialog, View view) {
        m19952D(oneCustomFragmentDialog, view);
    }

    /* renamed from: p */
    public static /* synthetic */ void m19947p(OneCustomFragmentDialog oneCustomFragmentDialog, View view) {
        m19950F(oneCustomFragmentDialog, view);
    }

    /* renamed from: q */
    public static /* synthetic */ void m19946q(OneCustomFragmentDialog oneCustomFragmentDialog, View view) {
        m19955A(oneCustomFragmentDialog, view);
    }

    /* renamed from: r */
    public static /* synthetic */ void m19945r(OneCustomFragmentDialog oneCustomFragmentDialog, View view) {
        m19937z(oneCustomFragmentDialog, view);
    }

    /* renamed from: s */
    public static /* synthetic */ void m19944s(OneCustomFragmentDialog oneCustomFragmentDialog, View view) {
        m19954B(oneCustomFragmentDialog, view);
    }

    /* renamed from: t */
    public static /* synthetic */ void m19943t(OneCustomFragmentDialog oneCustomFragmentDialog, View view) {
        m19938y(oneCustomFragmentDialog, view);
    }

    /* renamed from: u */
    public static /* synthetic */ void m19942u(OneCustomFragmentDialog oneCustomFragmentDialog, View view) {
        m19951E(oneCustomFragmentDialog, view);
    }

    /* renamed from: v */
    public static /* synthetic */ void m19941v(OneCustomFragmentDialog oneCustomFragmentDialog, View view) {
        m19939x(oneCustomFragmentDialog, view);
    }

    /* renamed from: x */
    public static final void m19939x(OneCustomFragmentDialog this_run, View view) {
        Intrinsics.checkNotNullParameter(this_run, "$this_run");
        CustomAlertDialogListener customAlertDialogListener = f83044b;
        if (customAlertDialogListener != null) {
            Intrinsics.checkNotNull(customAlertDialogListener);
    ...
    /* renamed from: y */
    public static final void m19938y(OneCustomFragmentDialog this_run, View view) {
        Intrinsics.checkNotNullParameter(this_run, "$this_run");
        CustomAlertDialogListener customAlertDialogListener = f83044b;
        if (customAlertDialogListener != null) {
            Intrinsics.checkNotNull(customAlertDialogListener);
    ...
    /* renamed from: z */
    public static final void m19937z(OneCustomFragmentDialog this_run, View view) {
        Intrinsics.checkNotNullParameter(this_run, "$this_run");
        CustomAlertDialogListener customAlertDialogListener = f83044b;
        if (customAlertDialogListener != null) {
            Intrinsics.checkNotNull(customAlertDialogListener);
    ...
    public Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
                    if (i != 4) {
                        if (i == 5) {
                            ...
                            button.setOnClickListener(new View.OnClickListener() { // from class: ZO0
                                @Override // android.view.View.OnClickListener
                                public final void onClick(View view) {
                                    OneCustomFragmentDialog.m19943t(OneCustomFragmentDialog.this, view);
                                }
                            });
                            textView.setOnClickListener(new View.OnClickListener() { // from class: aP0
                                @Override // android.view.View.OnClickListener
                                public final void onClick(View view) {
                                    OneCustomFragmentDialog.m19945r(OneCustomFragmentDialog.this, view);
                                }
                            });
                        }
                    } else {
                        ...
                        button2.setOnClickListener(new View.OnClickListener() { // from class: WO0
                            @Override // android.view.View.OnClickListener
                            public final void onClick(View view) {
                                OneCustomFragmentDialog.m19942u(OneCustomFragmentDialog.this, view);
                            }
                        });
                        textView2.setOnClickListener(new View.OnClickListener() { // from class: XO0
                            @Override // android.view.View.OnClickListener
                            public final void onClick(View view) {
                                OneCustomFragmentDialog.m19947p(OneCustomFragmentDialog.this, view);
                            }
                        });
                    }
                } else {
                    ...
                    button3.setOnClickListener(new View.OnClickListener() { // from class: UO0
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            OneCustomFragmentDialog.m19949n(OneCustomFragmentDialog.this, view);
                        }
                    });
                    textView3.setOnClickListener(new View.OnClickListener() { // from class: VO0
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            OneCustomFragmentDialog.m19948o(OneCustomFragmentDialog.this, view);
                        }
                    });
                }
            } else {
                ...
                m19940w(i2, ivivDialogImage);
                button4.setOnClickListener(new View.OnClickListener() { // from class: YO0
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        OneCustomFragmentDialog.m19941v(OneCustomFragmentDialog.this, view);
                    }
                });
            }
        } else {
            ...
            button5.setOnClickListener(new View.OnClickListener() { // from class: SO0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    OneCustomFragmentDialog.m19946q(OneCustomFragmentDialog.this, view);
                }
            });
            textView4.setOnClickListener(new View.OnClickListener() { // from class: TO0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    OneCustomFragmentDialog.m19944s(OneCustomFragmentDialog.this, view);
                }
            });
        }
        setCancelable(z);
    ...
    /* renamed from: w */
    public final void m19940w(int i, ImageView imageView) {
        Glide.with(this).clear(imageView);
        Glide.with(this).m74227load(Integer.valueOf(i)).transition(DrawableTransitionOptions.withCrossFade()).error(ContextCompat.getDrawable(requireContext(), R.drawable.image_banner_default)).diskCacheStrategy(DiskCacheStrategy.DATA).into(imageView);
    }
}