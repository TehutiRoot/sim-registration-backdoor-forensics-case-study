...
public abstract class FDFAnnotation implements COSObjectable {
    ...
    /* renamed from: a */
    public final String m32474a(Node node, boolean z) {
        StringBuilder sb = new StringBuilder();
        NodeList childNodes = node.getChildNodes();
        for (int i = 0; i < childNodes.getLength(); i++) {
            Node item = childNodes.item(i);
            if (item instanceof Element) {
                sb.append(m32474a(item, false));
    ...
    public PDBorderEffectDictionary getBorderEffect() {
        COSDictionary cOSDictionary = (COSDictionary) this.annot.getDictionaryObject(COSName.f59767BE);
        if (cOSDictionary != null) {
    ...
    public PDBorderStyleDictionary getBorderStyle() {
        COSDictionary cOSDictionary = (COSDictionary) this.annot.getDictionaryObject(COSName.f59770BS);
        if (cOSDictionary != null) {
    ...
    public AWTColor getColor() {
        COSArray cOSArray = (COSArray) this.annot.getDictionaryObject(COSName.f59771C);
        if (cOSArray != null) {
    ...
    public String getDate() {
        return this.annot.getString(COSName.f59816M);
    }

    public String getIntent() {
        return this.annot.getNameAsString(COSName.f59806IT);
    }

    public String getName() {
        return this.annot.getString(COSName.f59820NM);
    }

    public float getOpacity() {
        return this.annot.getFloat(COSName.f59774CA, 1.0f);
    }
    ...
    public String getRichContents() {
        return getStringOrStream(this.annot.getDictionaryObject(COSName.f59832RC));
    }
    ...
    public String getTitle() {
        return this.annot.getString(COSName.f59845T);
    }

    public boolean isHidden() {
        return this.annot.getFlag(COSName.f59794F, 2);
    }

    public boolean isInvisible() {
        return this.annot.getFlag(COSName.f59794F, 1);
    }

    public boolean isLocked() {
        return this.annot.getFlag(COSName.f59794F, 128);
    }

    public boolean isLockedContents() {
        return this.annot.getFlag(COSName.f59794F, 512);
    }

    public boolean isNoRotate() {
        return this.annot.getFlag(COSName.f59794F, 16);
    }

    public boolean isNoView() {
        return this.annot.getFlag(COSName.f59794F, 32);
    }

    public boolean isNoZoom() {
        return this.annot.getFlag(COSName.f59794F, 8);
    }

    public boolean isPrinted() {
        return this.annot.getFlag(COSName.f59794F, 4);
    }

    public boolean isReadOnly() {
        return this.annot.getFlag(COSName.f59794F, 64);
    }

    public boolean isToggleNoView() {
        return this.annot.getFlag(COSName.f59794F, 256);
    }

    public final void setBorderEffect(PDBorderEffectDictionary pDBorderEffectDictionary) {
        this.annot.setItem(COSName.f59767BE, pDBorderEffectDictionary);
    }

    public final void setBorderStyle(PDBorderStyleDictionary pDBorderStyleDictionary) {
        this.annot.setItem(COSName.f59770BS, pDBorderStyleDictionary);
    }
    ...
    public final void setColor(AWTColor aWTColor) {
        ...
        this.annot.setItem(COSName.f59771C, (COSBase) cOSArray);
    }
    ...
    public final void setDate(String str) {
        this.annot.setString(COSName.f59816M, str);
    }

    public final void setHidden(boolean z) {
        this.annot.setFlag(COSName.f59794F, 2, z);
    }

    public final void setIntent(String str) {
        this.annot.setName(COSName.f59806IT, str);
    }

    public final void setInvisible(boolean z) {
        this.annot.setFlag(COSName.f59794F, 1, z);
    }

    public final void setLocked(boolean z) {
        this.annot.setFlag(COSName.f59794F, 128, z);
    }

    public void setLockedContents(boolean z) {
        this.annot.setFlag(COSName.f59794F, 512, z);
    }

    public final void setName(String str) {
        this.annot.setString(COSName.f59820NM, str);
    }

    public final void setNoRotate(boolean z) {
        this.annot.setFlag(COSName.f59794F, 16, z);
    }

    public final void setNoView(boolean z) {
        this.annot.setFlag(COSName.f59794F, 32, z);
    }

    public final void setNoZoom(boolean z) {
        this.annot.setFlag(COSName.f59794F, 8, z);
    }

    public final void setOpacity(float f) {
        this.annot.setFloat(COSName.f59774CA, f);
    }
    ...
    public final void setPrinted(boolean z) {
        this.annot.setFlag(COSName.f59794F, 4, z);
    }

    public final void setReadOnly(boolean z) {
        this.annot.setFlag(COSName.f59794F, 64, z);
    }
    ...
    public final void setRichContents(String str) {
        this.annot.setItem(COSName.f59832RC, (COSBase) new COSString(str));
    }
    ...
    public final void setTitle(String str) {
        this.annot.setString(COSName.f59845T, str);
    }

    public final void setToggleNoView(boolean z) {
        this.annot.setFlag(COSName.f59794F, 256, z);
    }
            ...
            if (attribute4 != null) {
                ...
                if (split2.length == 4) {
                    ...
                    try {
                        ...
                        if (node != null) {
                            setRichContents(m32474a(node, true));
