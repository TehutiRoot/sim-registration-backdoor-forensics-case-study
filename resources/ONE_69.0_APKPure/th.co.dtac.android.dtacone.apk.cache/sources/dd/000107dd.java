...
public abstract /* synthetic */ class AbstractC21996rR1 {
    /* renamed from: a */
    public static final int m23512a(String str, int i, int i2, int i3) {
        return (int) SystemPropsKt.systemProp(str, i, i2, i3);
    }

    /* renamed from: b */
    public static final long m23511b(String str, long j, long j2, long j3) {
        String systemProp = SystemPropsKt.systemProp(str);
        if (systemProp == null) {
            return j;
        }
        Long longOrNull = AbstractC19568dO1.toLongOrNull(systemProp);
        if (longOrNull != null) {
    ...
    /* renamed from: c */
    public static final String m23510c(String str, String str2) {
        String systemProp = SystemPropsKt.systemProp(str);
        if (systemProp != null) {
            return systemProp;
        }
    ...
    /* renamed from: d */
    public static final boolean m23509d(String str, boolean z) {
        String systemProp = SystemPropsKt.systemProp(str);
        if (systemProp != null) {
    ...
    /* renamed from: e */
    public static /* synthetic */ int m23508e(String str, int i, int i2, int i3, int i4, Object obj) {
        if ((i4 & 4) != 0) {
            i2 = 1;
        }
        if ((i4 & 8) != 0) {
    ...
    /* renamed from: f */
    public static /* synthetic */ long m23507f(String str, long j, long j2, long j3, int i, Object obj) {
        if ((i & 4) != 0) {
            j2 = 1;
        }
        long j4 = j2;
