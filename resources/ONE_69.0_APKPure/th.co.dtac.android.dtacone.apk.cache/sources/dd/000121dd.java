...
/* renamed from: th.co.dtac.android.dtacone.presenter.bitmap.SaveBitmapWithWaterMarkPresenter$saveImageWatermarkFront$1 */
/* loaded from: classes8.dex */
public final class SaveBitmapWithWaterMarkPresenter$saveImageWatermarkFront$1 extends Lambda implements Function1<Bitmap, Unit> {
    final /* synthetic */ SaveBitmapWithWaterMarkPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SaveBitmapWithWaterMarkPresenter$saveImageWatermarkFront$1(SaveBitmapWithWaterMarkPresenter saveBitmapWithWaterMarkPresenter) {
        super(1);
