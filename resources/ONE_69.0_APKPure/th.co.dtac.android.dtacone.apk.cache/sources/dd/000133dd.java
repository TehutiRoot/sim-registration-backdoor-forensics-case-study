...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.viewModel.OneMnpViewModel$validateSimMnpProcess$2 */
/* loaded from: classes10.dex */
public final class OneMnpViewModel$validateSimMnpProcess$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ OneMnpViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneMnpViewModel$validateSimMnpProcess$2(OneMnpViewModel oneMnpViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable throwable) {
        ...
        m13541L1.setValue(Resource.Companion.error$default(Resource.Companion, "", null, null, 4, null));
        oneErrorService = this.this$0.f92124e;
        final OneMnpViewModel oneMnpViewModel = this.this$0;
        oneErrorService.handleException(throwable, new OneErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.view.appOne.mnp.viewModel.OneMnpViewModel$validateSimMnpProcess$2.1
