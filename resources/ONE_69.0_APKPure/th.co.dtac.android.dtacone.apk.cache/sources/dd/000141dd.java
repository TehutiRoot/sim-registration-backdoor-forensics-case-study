...
@SourceDebugExtension({"SMAP\nDeviceSelectScreen.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeviceSelectScreen.kt\nth/co/dtac/android/dtacone/view/appOne/tol/screen/device/ComposableSingletons$DeviceSelectScreenKt$lambda-7$1$1$1\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,796:1\n288#2,2:797\n*S KotlinDebug\n*F\n+ 1 DeviceSelectScreen.kt\nth/co/dtac/android/dtacone/view/appOne/tol/screen/device/ComposableSingletons$DeviceSelectScreenKt$lambda-7$1$1$1\n*L\n728#1:797,2\n*E\n"})
/* renamed from: th.co.dtac.android.dtacone.view.appOne.tol.screen.device.ComposableSingletons$DeviceSelectScreenKt$lambda-7$1$1$1  reason: invalid class name */
/* loaded from: classes10.dex */
public final class ComposableSingletons$DeviceSelectScreenKt$lambda7$1$1$1 extends Lambda implements Function1<String, Unit> {
    ...
    public ComposableSingletons$DeviceSelectScreenKt$lambda7$1$1$1(MutableState<DeviceListState.Success> mutableState, MutableState<DeviceRouterItem> mutableState2) {
        super(1);
    ...
    public final void invoke2(@NotNull String it) {
        ...
        Iterator<T> it2 = ComposableSingletons$DeviceSelectScreenKt$lambda7$1.invoke$lambda$1(this.$deviceListState$delegate).getData().iterator();
        while (true) {
            if (!it2.hasNext()) {
                obj = null;
                break;
