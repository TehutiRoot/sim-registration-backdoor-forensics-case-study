...
public abstract class AbstractAuthenticationHandler implements AuthenticationHandler {
    ...
    /* renamed from: b */
    public static final List f74118b = Collections.unmodifiableList(Arrays.asList("Negotiate", "NTLM", "Digest", "Basic"));

    /* renamed from: a */
    public final Log f74119a = LogFactory.getLog(getClass());
    ...
    public AuthScheme selectScheme(Map<String, Header> map, HttpResponse httpResponse, HttpContext httpContext) throws AuthenticationException {
        ...
        if (authPreferences == null) {
            authPreferences = f74118b;
        }
        if (this.f74119a.isDebugEnabled()) {
            Log log = this.f74119a;
            ...
            if (it.hasNext()) {
                ...
                if (map.get(next.toLowerCase(Locale.ENGLISH)) != null) {
                    ...
                    try {
                        ...
                        if (this.f74119a.isWarnEnabled()) {
                            Log log3 = this.f74119a;
                            log3.warn("Authentication scheme " + next + " not supported");
                        }
                    }
                } else if (this.f74119a.isDebugEnabled()) {
                    Log log4 = this.f74119a;
