...
@Metadata(m29143d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00030\u0002H\u008a@"}, m29142d2 = {"<anonymous>", "", "Lkotlinx/coroutines/channels/ProducerScope;", "Lio/realm/DynamicRealmObject;"}, m29141k = 3, m29140mv = {1, 6, 0}, m29138xi = 48)
@DebugMetadata(m29093c = "io.realm.internal.coroutines.InternalFlowFactory$from$8", m29092f = "InternalFlowFactory.kt", m29091i = {}, m29090l = {622, 650}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
...
public final class InternalFlowFactory$from$8 extends SuspendLambda implements Function2<ProducerScope<? super DynamicRealmObject>, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes5.dex */
    public static final class C113391 extends Lambda implements Function0<Unit> {
        public static final C113391 INSTANCE = new C113391();
    ...
    /* loaded from: classes5.dex */
    public static final class C113402 extends Lambda implements Function0<Unit> {
        final /* synthetic */ DynamicRealmObject $dynamicRealmObject;
        final /* synthetic */ DynamicRealm $flowRealm;
        final /* synthetic */ RealmChangeListener<DynamicRealmObject> $listener;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C113402(DynamicRealm dynamicRealm, DynamicRealmObject dynamicRealmObject, RealmChangeListener<DynamicRealmObject> realmChangeListener) {
            super(0);
    ...
    public static final void m74264invokeSuspend$lambda0(ProducerScope producerScope, InternalFlowFactory internalFlowFactory, DynamicRealmObject dynamicRealmObject) {
        boolean z;
        if (CoroutineScopeKt.isActive(producerScope)) {
            ...
            producerScope.mo74250trySendJP2dKIU(dynamicRealmObject);
        }
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.$dynamicRealm.isClosed()) {
            C113391 c113391 = C113391.INSTANCE;
            this.label = 1;
            if (ProduceKt.awaitClose(producerScope, c113391, this) == coroutine_suspended) {
        ...
        RealmChangeListener realmChangeListener = new RealmChangeListener() { // from class: io.realm.internal.coroutines.n
            ...
            public final void onChange(Object obj2) {
                InternalFlowFactory$from$8.m74264invokeSuspend$lambda0(ProducerScope.this, internalFlowFactory, (DynamicRealmObject) obj2);
            }
        };
        ...
        if (RealmObject.isLoaded(this.$dynamicRealmObject)) {
            ...
            if (z) {
                ...
                producerScope.mo74250trySendJP2dKIU(this.$dynamicRealmObject);
            }
        }
        C113402 c113402 = new C113402(dynamicRealm, this.$dynamicRealmObject, realmChangeListener);
        this.label = 2;
        if (ProduceKt.awaitClose(producerScope, c113402, this) == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Unit.INSTANCE;
    }
