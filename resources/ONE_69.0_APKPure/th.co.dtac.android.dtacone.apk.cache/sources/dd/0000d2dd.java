...
public final class ParallelRunOn<T> extends ParallelFlowable<T> {
    ...
    /* renamed from: a */
    public final ParallelFlowable f65892a;

    /* renamed from: b */
    public final Scheduler f65893b;
    ...
    /* renamed from: io.reactivex.internal.operators.parallel.ParallelRunOn$a */
    /* loaded from: classes5.dex */
    public final class C11096a implements SchedulerMultiWorkerSupport.WorkerCallback {

        /* renamed from: a */
        public final Subscriber[] f65895a;

        /* renamed from: b */
        public final Subscriber[] f65896b;

        public C11096a(Subscriber[] subscriberArr, Subscriber[] subscriberArr2) {
            this.f65895a = subscriberArr;
            this.f65896b = subscriberArr2;
        }

        @Override // io.reactivex.internal.schedulers.SchedulerMultiWorkerSupport.WorkerCallback
        public void onWorker(int i, Scheduler.Worker worker) {
            ParallelRunOn.this.m30270a(i, this.f65895a, this.f65896b, worker);
        }
    }

    public ParallelRunOn(ParallelFlowable<? extends T> parallelFlowable, Scheduler scheduler, int i) {
        this.f65892a = parallelFlowable;
        this.f65893b = scheduler;
        this.f65894c = i;
    }

    /* renamed from: a */
    public void m30270a(int i, Subscriber[] subscriberArr, Subscriber[] subscriberArr2, Scheduler.Worker worker) {
        Subscriber subscriber = subscriberArr[i];
        SpscArrayQueue spscArrayQueue = new SpscArrayQueue(this.f65894c);
        if (subscriber instanceof ConditionalSubscriber) {
            subscriberArr2[i] = new RunOnConditionalSubscriber((ConditionalSubscriber) subscriber, this.f65894c, spscArrayQueue, worker);
        } else {
            subscriberArr2[i] = new RunOnSubscriber(subscriber, this.f65894c, spscArrayQueue, worker);
        }
    }

    @Override // io.reactivex.parallel.ParallelFlowable
    public int parallelism() {
        return this.f65892a.parallelism();
    }
    ...
    public void subscribe(Subscriber<? super T>[] subscriberArr) {
        ...
        Scheduler scheduler = this.f65893b;
        if (scheduler instanceof SchedulerMultiWorkerSupport) {
            ((SchedulerMultiWorkerSupport) scheduler).createWorkers(length, new C11096a(subscriberArr, subscriberArr2));
        } else {
            for (int i = 0; i < length; i++) {
                m30270a(i, subscriberArr, subscriberArr2, this.f65893b.createWorker());
            }
        }
        this.f65892a.subscribe(subscriberArr2);
    }
}