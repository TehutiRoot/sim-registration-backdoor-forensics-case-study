...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.pre2post.fragment.dialog.OnePre2PostChangeIMEIDialogFragment$setupView$3 */
/* loaded from: classes10.dex */
public final class OnePre2PostChangeIMEIDialogFragment$setupView$3 extends Lambda implements Function0<Unit> {
    final /* synthetic */ OnePre2PostChangeIMEIDialogFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePre2PostChangeIMEIDialogFragment$setupView$3(OnePre2PostChangeIMEIDialogFragment onePre2PostChangeIMEIDialogFragment) {
        super(0);
    ...
    public final void invoke2() {
        ...
        if (onePre2PostChangeIMEIDialogCallback != null) {
            onePre2PostChangeIMEIDialogCallback.onConfirm();
        }
        this.this$0.dismiss();
    }
}