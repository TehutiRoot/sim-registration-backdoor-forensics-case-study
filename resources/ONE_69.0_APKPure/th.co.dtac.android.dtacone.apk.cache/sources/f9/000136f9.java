...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.fragment.OnePostpaidScanIMEIFragment$onStart$2$1 */
/* loaded from: classes10.dex */
public final class OnePostpaidScanIMEIFragment$onStart$2$1 extends Lambda implements Function1<FragmentNavEvent, Unit> {
    final /* synthetic */ OnePostpaidScanIMEIFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidScanIMEIFragment$onStart$2$1(OnePostpaidScanIMEIFragment onePostpaidScanIMEIFragment) {
        super(1);
    ...
    public final void invoke2(@NotNull FragmentNavEvent it) {
        OnePostpaidRegistrationActivity m12483o;
        Intrinsics.checkNotNullParameter(it, "it");
        m12483o = this.this$0.m12483o();
        m12483o.replaceFragment(it.buildFragment(), it.getTag());
    }
}