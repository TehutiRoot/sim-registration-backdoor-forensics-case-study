...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.fragment.packages.OnePostpaidDefaultPackageFragment$onResume$1$4 */
/* loaded from: classes10.dex */
public final class OnePostpaidDefaultPackageFragment$onResume$1$4 extends Lambda implements Function1<StatusResource, Unit> {
    final /* synthetic */ OnePostpaidDefaultPackageFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidDefaultPackageFragment$onResume$1$4(OnePostpaidDefaultPackageFragment onePostpaidDefaultPackageFragment) {
        super(1);
    ...
    public final void invoke2(StatusResource statusResource) {
        this.this$0.m12199w(statusResource);
    }
}