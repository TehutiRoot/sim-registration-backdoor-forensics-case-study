...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_prepaid_multi_sim.MrtrPrepaidMultiSimViewModel$checkSimStock$2 */
/* loaded from: classes9.dex */
public final class MrtrPrepaidMultiSimViewModel$checkSimStock$2 extends Lambda implements Function1<SimTermSukCheckSimStockResponse, Unit> {
    ...
    public MrtrPrepaidMultiSimViewModel$checkSimStock$2(MrtrPrepaidMultiSimViewModel mrtrPrepaidMultiSimViewModel, MrtrPrepaidValidateBarcodeResponse mrtrPrepaidValidateBarcodeResponse) {
        super(1);
    ...
    public final void invoke2(SimTermSukCheckSimStockResponse simTermSukCheckSimStockResponse) {
        this.this$0.uploadBarcode(new MultiSubscriber(null, null, this.$response, null, null, null, 59, null), simTermSukCheckSimStockResponse);
    }
}