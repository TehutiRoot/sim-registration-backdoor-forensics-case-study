...
public final class Shorts extends FJ1 {
    ...
    public static class ShortArrayAsList extends AbstractList<Short> implements RandomAccess, Serializable {
        ...
        public boolean contains(@CheckForNull Object obj) {
            if ((obj instanceof Short) && Shorts.m39798d(this.array, ((Short) obj).shortValue(), this.start, this.end) != -1) {
                return true;
            }
            return false;
        }
        ...
        public int indexOf(@CheckForNull Object obj) {
            int m39798d;
            if ((obj instanceof Short) && (m39798d = Shorts.m39798d(this.array, ((Short) obj).shortValue(), this.start, this.end)) >= 0) {
                return m39798d - this.start;
            }
            return -1;
        }
        ...
        public int lastIndexOf(@CheckForNull Object obj) {
            int m39797e;
            if ((obj instanceof Short) && (m39797e = Shorts.m39797e(this.array, ((Short) obj).shortValue(), this.start, this.end)) >= 0) {
                return m39797e - this.start;
            }
            return -1;
        }
    ...
    /* renamed from: c */
    public static int m39799c(long j) {
        boolean z;
        int i = (int) j;
        if (j == i) {
            z = true;
    ...
    public static short[] concat(short[]... sArr) {
        ...
        short[] sArr3 = new short[m39799c(j)];
        int i = 0;
    ...
    /* renamed from: d */
    public static int m39798d(short[] sArr, short s, int i, int i2) {
        while (i < i2) {
            if (sArr[i] == s) {
                return i;
            }
    ...
    /* renamed from: e */
    public static int m39797e(short[] sArr, short s, int i, int i2) {
    ...
    public static int indexOf(short[] sArr, short s) {
        return m39798d(sArr, s, 0, sArr.length);
    }
    ...
    public static int lastIndexOf(short[] sArr, short s) {
        return m39797e(sArr, s, 0, sArr.length);
    }
