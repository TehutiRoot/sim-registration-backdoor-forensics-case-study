...
public final class LoginCredentialFieldHints {
    ...
    public static /* synthetic */ LoginCredentialFieldHints copy$default(LoginCredentialFieldHints loginCredentialFieldHints, String str, String str2, int i, Object obj) {
        if ((i & 1) != 0) {
            str = loginCredentialFieldHints.f54644a;
        }
        if ((i & 2) != 0) {
            str2 = loginCredentialFieldHints.f54645b;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof LoginCredentialFieldHints) {
            ...
            return Intrinsics.areEqual(this.f54644a, loginCredentialFieldHints.f54644a) && Intrinsics.areEqual(this.f54645b, loginCredentialFieldHints.f54645b);
        }
        return false;
    }
    ...
    public String toString() {
        return "LoginCredentialFieldHints(passwordResourceName=" + this.f54644a + ", usernameResourceName=" + this.f54645b + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
