...
@Metadata(m29143d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0004\bÀ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J'\u0010\u000b\u001a\u00020\n2\b\u0010\u0005\u001a\u0004\u0018\u00010\u00042\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\b¢\u0006\u0004\b\u000b\u0010\fJ\u001d\u0010\u0010\u001a\u00020\r2\u0006\u0010\u000e\u001a\u00020\r2\u0006\u0010\u000f\u001a\u00020\n¢\u0006\u0004\b\u0010\u0010\u0011R\u0014\u0010\u0015\u001a\u00020\u00128\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0013\u0010\u0014¨\u0006\u0016"}, m29142d2 = {"Lcoil/decode/ExifUtils;", "", "<init>", "()V", "", "mimeType", "Lokio/BufferedSource;", "source", "Lcoil/decode/ExifOrientationPolicy;", "policy", "Lcoil/decode/ExifData;", "getExifData", "(Ljava/lang/String;Lokio/BufferedSource;Lcoil/decode/ExifOrientationPolicy;)Lcoil/decode/ExifData;", "Landroid/graphics/Bitmap;", "inBitmap", "exifData", "reverseTransformations", "(Landroid/graphics/Bitmap;Lcoil/decode/ExifData;)Landroid/graphics/Bitmap;", "Landroid/graphics/Paint;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroid/graphics/Paint;", "PAINT", "coil-base_release"}, m29141k = 1, m29140mv = {1, 8, 0})
...
public final class ExifUtils {
    ...
    /* renamed from: a */
    public static final Paint f40498a = new Paint(3);
    ...
    public final ExifData getExifData(@Nullable String str, @NotNull BufferedSource bufferedSource, @NotNull ExifOrientationPolicy exifOrientationPolicy) {
        if (ExifUtilsKt.supports(exifOrientationPolicy, str)) {
            ExifInterface exifInterface = new ExifInterface(new C0030AT(bufferedSource.peek().inputStream()));
    ...
    public final Bitmap reverseTransformations(@NotNull Bitmap bitmap, @NotNull ExifData exifData) {
        ...
        new Canvas(createBitmap).drawBitmap(bitmap, matrix, f40498a);
        bitmap.recycle();
        return createBitmap;
    }
}