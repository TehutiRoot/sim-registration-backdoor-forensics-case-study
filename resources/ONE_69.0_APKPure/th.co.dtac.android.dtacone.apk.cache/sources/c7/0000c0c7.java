...
public class AffineTransform implements Cloneable, Serializable {
    ...
    public PointF deltaTransform(PointF pointF, PointF pointF2) {
        ...
        float f = pointF.x;
        float f2 = pointF.y;
        pointF2.set((float) ((f * this.m00) + (f2 * this.m01)), (float) ((f * this.m10) + (f2 * this.m11)));
        return pointF2;
    }
    ...
    public PointF transform(PointF pointF, PointF pointF2) {
        float f = pointF.x;
        float f2 = pointF.y;
        pointF2.set((float) ((f * this.m00) + (f2 * this.m01) + this.m02), (float) ((f * this.m10) + (f2 * this.m11) + this.m12));
        return pointF2;
    }
