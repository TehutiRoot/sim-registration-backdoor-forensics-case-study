...
/* renamed from: th.co.dtac.android.dtacone.view.fragment.device_sale.payment.DeviceSaleInputAddressReceiptFragment$onStart$1 */
/* loaded from: classes9.dex */
public final class DeviceSaleInputAddressReceiptFragment$onStart$1 extends Lambda implements Function1<FragmentNavEvent, Unit> {
    final /* synthetic */ DeviceSaleInputAddressReceiptFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DeviceSaleInputAddressReceiptFragment$onStart$1(DeviceSaleInputAddressReceiptFragment deviceSaleInputAddressReceiptFragment) {
        super(1);
        this.this$0 = deviceSaleInputAddressReceiptFragment;
    }
    ...
    public final void invoke2(@NotNull FragmentNavEvent it) {
        ...
        ((DeviceSaleActivity) requireActivity).replaceFragment(it.buildFragment(), it.getTag());
    }
}