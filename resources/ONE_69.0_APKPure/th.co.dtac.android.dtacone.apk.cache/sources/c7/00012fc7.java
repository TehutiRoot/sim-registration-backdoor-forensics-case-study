...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.device_sale.viewmodel.OneDeviceSaleViewModel$callGetNewIMEI$3 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleViewModel$callGetNewIMEI$3 extends Lambda implements Function1<GetNewIMEIResponse, Unit> {
    final /* synthetic */ OneDeviceSaleViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneDeviceSaleViewModel$callGetNewIMEI$3(OneDeviceSaleViewModel oneDeviceSaleViewModel) {
        super(1);
    ...
    public final void invoke2(GetNewIMEIResponse getNewIMEIResponse) {
        ...
        MutableLiveData m14394U;
        this.this$0.getLiveDataState().setValue(StatusResource.DISMISS);
        oneDeviceSaleRepository = this.this$0.f90680b;
        oneDeviceSaleRepository.setTmpNewIMEIResponse(getNewIMEIResponse);
        m14394U = this.this$0.m14394U();
        m14394U.setValue(Resource.Companion.success(getNewIMEIResponse));
    }
}