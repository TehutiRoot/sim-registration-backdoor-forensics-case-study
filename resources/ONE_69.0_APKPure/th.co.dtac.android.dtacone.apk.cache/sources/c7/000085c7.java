...
public class DataFormatDetector {
    ...
    /* renamed from: a */
    public final DataFormatMatcher m49771a(InputAccessor.Std std) {
    ...
    public DataFormatMatcher findFormat(InputStream inputStream) throws IOException {
        return m49771a(new InputAccessor.Std(inputStream, new byte[this._maxInputLookahead]));
    }
    ...
    public DataFormatMatcher findFormat(byte[] bArr) throws IOException {
        return m49771a(new InputAccessor.Std(bArr));
    }
    ...
    public DataFormatMatcher findFormat(byte[] bArr, int i, int i2) throws IOException {
        return m49771a(new InputAccessor.Std(bArr, i, i2));
    }
}