...
public final class FlowableReduce<T> extends AbstractC0558I {
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new ReduceSubscriber(subscriber, this.f64506b));
    }
}