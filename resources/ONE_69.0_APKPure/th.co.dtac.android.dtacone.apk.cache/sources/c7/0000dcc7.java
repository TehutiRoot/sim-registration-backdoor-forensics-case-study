...
public interface BuiltInsLoader {
    @NotNull
    public static final Companion Companion = Companion.f68547a;

    /* loaded from: classes6.dex */
    public static final class Companion {

        /* renamed from: a */
        public static final /* synthetic */ Companion f68547a = new Companion();

        /* renamed from: b */
        public static final Lazy f68548b = LazyKt__LazyJVMKt.lazy(LazyThreadSafetyMode.PUBLICATION, (Function0) BuiltInsLoader$Companion$Instance$2.INSTANCE);

        @NotNull
        public final BuiltInsLoader getInstance() {
            return (BuiltInsLoader) f68548b.getValue();
        }
    }
