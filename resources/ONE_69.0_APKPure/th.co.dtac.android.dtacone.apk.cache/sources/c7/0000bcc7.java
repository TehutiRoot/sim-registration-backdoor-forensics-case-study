...
abstract class AbstractC9536kt {
    private static int ThreeDS2ServiceInstance = 0;
    private static int values = 1;

    /* renamed from: com.netcetera.threeds.sdk.infrastructure.kt$ThreeDS2ServiceInstance */
    /* loaded from: classes5.dex */
    public interface ThreeDS2ServiceInstance<O, C extends InterfaceC9503jr> {
        O values(C c);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static <O, C extends InterfaceC9503jr> O ThreeDS2Service(C c, C c2, ThreeDS2ServiceInstance<O, C> threeDS2ServiceInstance) {
        int i = ThreeDS2ServiceInstance;
        int i2 = i & 43;
        values = ((((i ^ 43) | i2) << 1) - ((i | 43) & (~i2))) % 128;
        O o = (O) C9653oh.ThreeDS2Service(threeDS2ServiceInstance.values((InterfaceC9503jr) C9653oh.ThreeDS2Service(c, c2)), threeDS2ServiceInstance.values(c2));
    ...
    public static <O extends Integer, C extends InterfaceC9503jr> O values(C c, C c2, ThreeDS2ServiceInstance<O, C> threeDS2ServiceInstance) {
        int i = ThreeDS2ServiceInstance;
        int i2 = i & 119;
        int i3 = ((i ^ 119) | i2) << 1;
        int i4 = -((i | 119) & (~i2));
