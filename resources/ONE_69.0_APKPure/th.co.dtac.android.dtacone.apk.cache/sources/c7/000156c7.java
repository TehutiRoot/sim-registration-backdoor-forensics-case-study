...
@SourceDebugExtension({"SMAP\nESimViewModel.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ESimViewModel.kt\nth/co/dtac/android/dtacone/viewmodel/esim/ESimViewModel$getSimCardNumberForPhysical$2\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,3149:1\n1#2:3150\n*E\n"})
/* renamed from: th.co.dtac.android.dtacone.viewmodel.esim.ESimViewModel$getSimCardNumberForPhysical$2 */
/* loaded from: classes9.dex */
public final class ESimViewModel$getSimCardNumberForPhysical$2 extends Lambda implements Function1<SimCardNumberResponse, Unit> {
    final /* synthetic */ ESimViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimViewModel$getSimCardNumberForPhysical$2(ESimViewModel eSimViewModel) {
        super(1);
    ...
    public final void invoke2(SimCardNumberResponse simCardNumberResponse) {
        ...
        if (simCardNumber != null) {
            ...
            eSimRepository3.setSimCardNumber(simCardNumber);
        }
        m2681y0 = this.this$0.m2681y0();
        Resource.Companion companion = Resource.Companion;
        m2681y0.postValue(companion.success("onNext"));
        if (this.this$0.checkCallAutoTransferEDMS()) {
            m2681y03 = this.this$0.m2681y0();
            m2681y03.postValue(companion.success("onNext"));
            ESimViewModel eSimViewModel = this.this$0;
            eSimRepository2 = eSimViewModel.f105820b;
            eSimViewModel.m2773G(eSimRepository2.getSimCardNumber());
            return;
        }
        m2681y02 = this.this$0.m2681y0();
        m2681y02.postValue(companion.success("onNext"));
        ESimViewModel eSimViewModel2 = this.this$0;
        eSimRepository = eSimViewModel2.f105820b;
        eSimViewModel2.m2777E(eSimRepository.getSimCardNumber());
    }
}