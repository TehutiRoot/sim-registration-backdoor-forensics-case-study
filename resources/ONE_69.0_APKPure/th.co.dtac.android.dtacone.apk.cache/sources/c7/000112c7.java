...
public final class KeyboardHelperKt$clearFocusOnKeyboardDismiss$1 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    @DebugMetadata(m29093c = "th.co.dtac.android.dtacone.app_one.widget.composable.helper.KeyboardHelperKt$clearFocusOnKeyboardDismiss$1$1", m29092f = "KeyboardHelper.kt", m29091i = {}, m29090l = {}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
    ...
    /* loaded from: classes7.dex */
    public static final class C141721 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public C141721(FocusManager focusManager, State<Boolean> state, MutableState<Boolean> mutableState, Continuation<? super C141721> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C141721(this.$focusManager, this.$isKeyboardOpen$delegate, this.$keyboardAppearedSinceLastFocused$delegate, continuation);
        }
        ...
        public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C141721) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public final Modifier invoke(@NotNull Modifier composed, @Nullable Composer composer, int i) {
        ...
        if (invoke$lambda$1(mutableState)) {
            ...
            EffectsKt.LaunchedEffect(Boolean.valueOf(invoke$lambda$6(rememberIsKeyboardOpen)), new C141721((FocusManager) composer.consume(CompositionLocalsKt.getLocalFocusManager()), rememberIsKeyboardOpen, mutableState2, null), composer, 64);
        }
        composer.endReplaceableGroup();
