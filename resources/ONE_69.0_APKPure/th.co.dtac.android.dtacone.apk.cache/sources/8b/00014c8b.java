...
/* renamed from: th.co.dtac.android.dtacone.view.fragment.eSIM.consent.ESimPrepaidNonTelcoFragment$initView$7$1 */
/* loaded from: classes9.dex */
public final class ESimPrepaidNonTelcoFragment$initView$7$1 extends Lambda implements Function1<Resource<? extends ErrorCollection>, Unit> {
    final /* synthetic */ ESimPrepaidNonTelcoFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimPrepaidNonTelcoFragment$initView$7$1(ESimPrepaidNonTelcoFragment eSimPrepaidNonTelcoFragment) {
        super(1);
        this.this$0 = eSimPrepaidNonTelcoFragment;
    }
    ...
    public final void invoke2(Resource<ErrorCollection> resource) {
        ...
        ESimPrepaidNonTelcoFragment eSimPrepaidNonTelcoFragment = this.this$0;
        if (resourceContentIfNotHandled.getStatus() != StatusResource.SUCCESS || (data = resourceContentIfNotHandled.getData()) == null) {
            return;
        }
        MrtrErrorDialog = eSimPrepaidNonTelcoFragment.MrtrErrorDialog(eSimPrepaidNonTelcoFragment.requireContext(), data, null);
