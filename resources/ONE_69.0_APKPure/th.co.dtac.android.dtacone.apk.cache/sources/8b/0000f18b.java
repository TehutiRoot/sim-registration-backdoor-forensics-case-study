...
public class CookiePriorityComparator implements Comparator<Cookie> {
    ...
    /* renamed from: a */
    public final int m24961a(Cookie cookie) {
    ...
    public int compare(Cookie cookie, Cookie cookie2) {
        int m24961a = m24961a(cookie2) - m24961a(cookie);
        if (m24961a == 0 && (cookie instanceof BasicClientCookie) && (cookie2 instanceof BasicClientCookie)) {
