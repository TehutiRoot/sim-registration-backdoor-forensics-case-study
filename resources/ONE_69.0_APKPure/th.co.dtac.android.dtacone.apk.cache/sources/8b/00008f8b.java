...
public abstract class zzkd extends zzjz {
    /* renamed from: a */
    public static char[] m47893a(char[] cArr, int i, int i2) {
    ...
    public final String zza(String str, int i) {
            ...
            if (i < length) {
                ...
                if (c >= 0) {
                    ...
                    if (zzan != null) {
                        ...
                        if (m66022a.length < length2) {
                            m66022a = m47893a(m66022a, i3, ((length2 + length) - i) + 32);
                        }
                        if (i6 > 0) {
                            str.getChars(i2, i, m66022a, i3);
                            i3 = i7;
                        }
                        if (zzan.length > 0) {
                            System.arraycopy(zzan, 0, m66022a, i3, zzan.length);
                            i3 += zzan.length;
                        }
                        i2 = i5;
                    }
        ...
        if (i8 > 0) {
            int i9 = i8 + i3;
            if (m66022a.length < i9) {
                m66022a = m47893a(m66022a, i3, i9);
            }
            str.getChars(i2, length, m66022a, i3);
            i3 = i9;
        }
        return new String(m66022a, 0, i3);
    }
