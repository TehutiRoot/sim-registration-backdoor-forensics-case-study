...
public final class FlowableAll<T> extends AbstractC0558I {

    /* renamed from: b */
    public final Predicate f64092b;
    ...
    public FlowableAll(Flowable<T> flowable, Predicate<? super T> predicate) {
        super(flowable);
        this.f64092b = predicate;
    }

    @Override // io.reactivex.Flowable
    public void subscribeActual(Subscriber<? super Boolean> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new AllSubscriber(subscriber, this.f64092b));
    }
}