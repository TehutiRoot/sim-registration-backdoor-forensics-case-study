...
public class DateTimeFormatterBuilder {
    ...
    /* renamed from: a */
    public ArrayList f76258a = new ArrayList();

    /* renamed from: b */
    public Object f76259b;

    /* loaded from: classes5.dex */
    public enum TimeZoneId implements InterfaceC19085ag0, InterfaceC18859Yf0 {
        INSTANCE;
        ...
        private static int prefixedStartPosition(CharSequence charSequence, int i) {
            ...
            while (i2 <= size) {
                int i3 = (i2 + size) >>> 1;
                int m24207f = DateTimeFormatterBuilder.m24207f(charSequence, i, ALL_IDS.get(i3));
                if (m24207f > 0) {
                    size = i3 - 1;
                } else if (m24207f < 0) {
                    i2 = i3 + 1;
        ...
        public int parseInto(DateTimeParserBucket dateTimeParserBucket, CharSequence charSequence, int i) {
            ...
            while (true) {
                ...
                if (!DateTimeFormatterBuilder.m24206g(charSequence, i, str2)) {
                    break;
                }
    ...
    /* loaded from: classes5.dex */
    public static class C12995a implements InterfaceC19085ag0, InterfaceC18859Yf0 {

        /* renamed from: a */
        public final char f76260a;
        ...
        public void printTo(Appendable appendable, long j, Chronology chronology, int i, DateTimeZone dateTimeZone, Locale locale) {
            appendable.append(this.f76260a);
        }
    ...
    public static class C12997c extends C13001g {
        ...
        @Override // org.joda.time.format.DateTimeFormatterBuilder.AbstractC13000f, p000.InterfaceC18859Yf0
        public int parseInto(DateTimeParserBucket dateTimeParserBucket, CharSequence charSequence, int i) {
            char charAt;
            ...
            int i2 = this.f76271b + i;
            if (parseInto != i2) {
                if (this.f76272c && ((charAt = charSequence.charAt(i)) == '-' || charAt == '+')) {
                    i2++;
                }
                if (parseInto > i2) {
                    return ~(i2 + 1);
    ...
    /* loaded from: classes5.dex */
    public static class C12998d implements InterfaceC19085ag0, InterfaceC18859Yf0 {

        /* renamed from: a */
        public final DateTimeFieldType f76265a;
        ...
        public C12998d(DateTimeFieldType dateTimeFieldType, int i, int i2) {
            this.f76265a = dateTimeFieldType;
            i2 = i2 > 18 ? 18 : i2;
            this.f76266b = i;
            this.f76267c = i2;
        }
        ...
        */
        public final long[] m24196a(long r8, org.joda.time.DateTimeField r10) {
            /*
                r7 = this;
            ...
            L7a:
                ...
                goto La
            */
            throw new UnsupportedOperationException("Method not decompiled: org.joda.time.format.DateTimeFormatterBuilder.C12998d.m24196a(long, org.joda.time.DateTimeField):long[]");
        }

        /* renamed from: b */
        public void m24195b(Appendable appendable, long j, Chronology chronology) {
            String l;
            DateTimeField field = this.f76265a.getField(chronology);
            int i = this.f76266b;
            try {
                long remainder = field.remainder(j);
                if (remainder != 0) {
                    long[] m24196a = m24196a(remainder, field);
                    long j2 = m24196a[0];
                    int i2 = (int) m24196a[1];
                ...
                DateTimeFormatterBuilder.m24210c(appendable, i);
            }
        }
        ...
        @Override // p000.InterfaceC18859Yf0
        public int parseInto(DateTimeParserBucket dateTimeParserBucket, CharSequence charSequence, int i) {
            DateTimeField field = this.f76265a.getField(dateTimeParserBucket.getChronology());
            int min = Math.min(this.f76267c, charSequence.length() - i);
        ...
        @Override // p000.InterfaceC19085ag0
        public void printTo(Appendable appendable, long j, Chronology chronology, int i, DateTimeZone dateTimeZone, Locale locale) {
            m24195b(appendable, j, chronology);
        }

        @Override // p000.InterfaceC19085ag0
        public void printTo(Appendable appendable, ReadablePartial readablePartial, Locale locale) {
            m24195b(appendable, readablePartial.getChronology().set(readablePartial, 0L), readablePartial.getChronology());
        }
    }

    /* renamed from: org.joda.time.format.DateTimeFormatterBuilder$e */
    /* loaded from: classes5.dex */
    public static class C12999e implements InterfaceC18859Yf0 {

        /* renamed from: a */
        public final InterfaceC18859Yf0[] f76268a;

        /* renamed from: b */
        public final int f76269b;

        public C12999e(InterfaceC18859Yf0[] interfaceC18859Yf0Arr) {
            int estimateParsedLength;
            this.f76268a = interfaceC18859Yf0Arr;
            int length = interfaceC18859Yf0Arr.length;
            int i = 0;
            while (true) {
                length--;
                if (length >= 0) {
                    InterfaceC18859Yf0 interfaceC18859Yf0 = interfaceC18859Yf0Arr[length];
                    if (interfaceC18859Yf0 != null && (estimateParsedLength = interfaceC18859Yf0.estimateParsedLength()) > i) {
        ...
        public int parseInto(DateTimeParserBucket dateTimeParserBucket, CharSequence charSequence, int i) {
            int i2;
            int i3;
            InterfaceC18859Yf0[] interfaceC18859Yf0Arr = this.f76268a;
            int length = interfaceC18859Yf0Arr.length;
            ...
            while (true) {
                ...
                InterfaceC18859Yf0 interfaceC18859Yf0 = interfaceC18859Yf0Arr[i6];
                if (interfaceC18859Yf0 == null) {
                    if (i4 <= i) {
                        return i;
                    }
                    z = true;
                } else {
                    int parseInto = interfaceC18859Yf0.parseInto(dateTimeParserBucket, charSequence, i);
                    if (parseInto >= i) {
                        if (parseInto <= i4) {
                            continue;
                        } else if (parseInto >= charSequence.length() || (i3 = i6 + 1) >= length || interfaceC18859Yf0Arr[i3] == null) {
                            break;
                        } else {
    ...
    /* loaded from: classes5.dex */
    public static abstract class AbstractC13000f implements InterfaceC19085ag0, InterfaceC18859Yf0 {

        /* renamed from: a */
        public final DateTimeFieldType f76270a;
        ...
        public AbstractC13000f(DateTimeFieldType dateTimeFieldType, int i, boolean z) {
            this.f76270a = dateTimeFieldType;
            this.f76271b = i;
            this.f76272c = z;
        }
    ...
    /* loaded from: classes5.dex */
    public static class C13002h implements InterfaceC19085ag0, InterfaceC18859Yf0 {
        ...
        @Override // p000.InterfaceC18859Yf0
        public int parseInto(DateTimeParserBucket dateTimeParserBucket, CharSequence charSequence, int i) {
            if (DateTimeFormatterBuilder.m24205h(charSequence, i, this.f76274a)) {
                return i + this.f76274a.length();
            }
            return ~i;
        }
        ...
        @Override // p000.InterfaceC19085ag0
        public void printTo(Appendable appendable, long j, Chronology chronology, int i, DateTimeZone dateTimeZone, Locale locale) {
            appendable.append(this.f76274a);
        }
    ...
    /* loaded from: classes5.dex */
    public static class C13004j implements InterfaceC19085ag0, InterfaceC18859Yf0 {

        /* renamed from: a */
        public final Map f76278a;
        ...
        /* renamed from: a */
        public final String m24192a(long j, DateTimeZone dateTimeZone, Locale locale) {
        ...
        @Override // p000.InterfaceC18859Yf0
        public int parseInto(DateTimeParserBucket dateTimeParserBucket, CharSequence charSequence, int i) {
            Map<String, DateTimeZone> map = this.f76278a;
            if (map == null) {
                map = DateTimeUtils.getDefaultTimeZoneNames();
            }
            String str = null;
            for (String str2 : map.keySet()) {
                if (DateTimeFormatterBuilder.m24206g(charSequence, i, str2) && (str == null || str2.length() > str.length())) {
                    str = str2;
                }
            }
            if (str != null) {
        ...
        @Override // p000.InterfaceC19085ag0
        public void printTo(Appendable appendable, long j, Chronology chronology, int i, DateTimeZone dateTimeZone, Locale locale) {
            appendable.append(m24192a(j - i, dateTimeZone, locale));
        }
    }

    /* renamed from: org.joda.time.format.DateTimeFormatterBuilder$k */
    /* loaded from: classes5.dex */
    public static class C13005k implements InterfaceC19085ag0, InterfaceC18859Yf0 {
        ...
        /* renamed from: c */
        public final boolean f76282c;

        /* renamed from: d */
        public final int f76283d;

        /* renamed from: e */
        public final int f76284e;
        ...
        /* renamed from: a */
        public final int m24191a(CharSequence charSequence, int i, int i2) {
            int i3 = 0;
    ...
    /* renamed from: c */
    public static void m24210c(Appendable appendable, int i) {
        while (true) {
            i--;
            if (i >= 0) {
    ...
    /* renamed from: f */
    public static int m24207f(CharSequence charSequence, int i, String str) {
    ...
    /* renamed from: g */
    public static boolean m24206g(CharSequence charSequence, int i, String str) {
    ...
    /* renamed from: h */
    public static boolean m24205h(CharSequence charSequence, int i, String str) {
        char upperCase;
        char upperCase2;
        int length = str.length();
        if (charSequence.length() - i < length) {
    ...
    /* renamed from: a */
    public final DateTimeFormatterBuilder m24212a(InterfaceC19085ag0 interfaceC19085ag0, InterfaceC18859Yf0 interfaceC18859Yf0) {
        this.f76259b = null;
        this.f76258a.add(interfaceC19085ag0);
        this.f76258a.add(interfaceC18859Yf0);
        return this;
    }

    public DateTimeFormatterBuilder append(DateTimeFormatter dateTimeFormatter) {
        if (dateTimeFormatter != null) {
            return m24212a(dateTimeFormatter.m24217b(), dateTimeFormatter.m24218a());
        }
    ...
    public DateTimeFormatterBuilder appendDecimal(DateTimeFieldType dateTimeFieldType, int i, int i2) {
        if (dateTimeFieldType != null) {
            ...
            if (i >= 0 && i2 > 0) {
                if (i <= 1) {
                    return m24211b(new C13007m(dateTimeFieldType, i2, false));
                }
                return m24211b(new C13001g(dateTimeFieldType, i2, false, i));
            }
            throw new IllegalArgumentException();
        }
    ...
    public DateTimeFormatterBuilder appendFixedDecimal(DateTimeFieldType dateTimeFieldType, int i) {
        if (dateTimeFieldType != null) {
            if (i > 0) {
                return m24211b(new C12997c(dateTimeFieldType, i, false));
            }
    ...
    public DateTimeFormatterBuilder appendFixedSignedDecimal(DateTimeFieldType dateTimeFieldType, int i) {
        if (dateTimeFieldType != null) {
            if (i > 0) {
                return m24211b(new C12997c(dateTimeFieldType, i, true));
            }
            throw new IllegalArgumentException("Illegal number of digits: " + i);
        }
        throw new IllegalArgumentException("Field type must not be null");
    ...
    public DateTimeFormatterBuilder appendFraction(DateTimeFieldType dateTimeFieldType, int i, int i2) {
        if (dateTimeFieldType != null) {
            ...
            if (i >= 0 && i2 > 0) {
                return m24211b(new C12998d(dateTimeFieldType, i, i2));
            }
            throw new IllegalArgumentException();
        }
        throw new IllegalArgumentException("Field type must not be null");
    ...
    public DateTimeFormatterBuilder appendOptional(DateTimeParser dateTimeParser) {
        m24209d(dateTimeParser);
        return m24212a(null, new C12999e(new InterfaceC18859Yf0[]{C1789ZD.m65250b(dateTimeParser), null}));
    }

    public DateTimeFormatterBuilder appendPattern(String str) {
        DateTimeFormat.m24229a(this, str);
        return this;
    }
    ...
    public DateTimeFormatterBuilder appendShortText(DateTimeFieldType dateTimeFieldType) {
        if (dateTimeFieldType != null) {
            return m24211b(new C13003i(dateTimeFieldType, true));
        }
        throw new IllegalArgumentException("Field type must not be null");
    }
    ...
    public DateTimeFormatterBuilder appendSignedDecimal(DateTimeFieldType dateTimeFieldType, int i, int i2) {
        if (dateTimeFieldType != null) {
            ...
            if (i >= 0 && i2 > 0) {
                if (i <= 1) {
                    return m24211b(new C13007m(dateTimeFieldType, i2, true));
                }
                return m24211b(new C13001g(dateTimeFieldType, i2, true, i));
            }
            throw new IllegalArgumentException();
        }
        throw new IllegalArgumentException("Field type must not be null");
    ...
    public DateTimeFormatterBuilder appendText(DateTimeFieldType dateTimeFieldType) {
        if (dateTimeFieldType != null) {
            return m24211b(new C13003i(dateTimeFieldType, false));
        }
        throw new IllegalArgumentException("Field type must not be null");
    }
    ...
    public DateTimeFormatterBuilder appendTimeZoneId() {
        ...
        return m24212a(timeZoneId, timeZoneId);
    }

    public DateTimeFormatterBuilder appendTimeZoneName() {
        return m24212a(new C13004j(0, null), null);
    }

    public DateTimeFormatterBuilder appendTimeZoneOffset(String str, boolean z, int i, int i2) {
        return m24211b(new C13005k(str, str, z, i, i2));
    }

    public DateTimeFormatterBuilder appendTimeZoneShortName() {
        return m24212a(new C13004j(1, null), null);
    }
    ...
    /* renamed from: b */
    public final DateTimeFormatterBuilder m24211b(Object obj) {
        this.f76259b = null;
        this.f76258a.add(obj);
        this.f76258a.add(obj);
        return this;
    }

    public boolean canBuildFormatter() {
        return m24203j(m24204i());
    }

    public boolean canBuildParser() {
        return m24202k(m24204i());
    }

    public boolean canBuildPrinter() {
        return m24201l(m24204i());
    }
    ...
    /* renamed from: d */
    public final void m24209d(DateTimeParser dateTimeParser) {
    ...
    /* renamed from: e */
    public final void m24208e(DateTimePrinter dateTimePrinter) {
    ...
    /* renamed from: i */
    public final Object m24204i() {
        Object obj = this.f76259b;
        if (obj == null) {
            if (this.f76258a.size() == 2) {
                Object obj2 = this.f76258a.get(0);
                Object obj3 = this.f76258a.get(1);
                if (obj2 != null) {
    ...
    /* renamed from: j */
    public final boolean m24203j(Object obj) {
        if (!m24201l(obj) && !m24202k(obj)) {
            return false;
        }
        return true;
    }
    ...
    /* renamed from: k */
    public final boolean m24202k(Object obj) {
        if (obj instanceof InterfaceC18859Yf0) {
            if (obj instanceof C12996b) {
                return ((C12996b) obj).m24198c();
            }
            return true;
        }
        return false;
    ...
    /* renamed from: l */
    public final boolean m24201l(Object obj) {
        if (obj instanceof InterfaceC19085ag0) {
            if (obj instanceof C12996b) {
                return ((C12996b) obj).m24197d();
            }
            return true;
        }
        return false;
    ...
    public DateTimeFormatter toFormatter() {
        InterfaceC19085ag0 interfaceC19085ag0;
        Object m24204i = m24204i();
        InterfaceC18859Yf0 interfaceC18859Yf0 = null;
        if (m24201l(m24204i)) {
            interfaceC19085ag0 = (InterfaceC19085ag0) m24204i;
        } else {
            interfaceC19085ag0 = null;
        }
        if (m24202k(m24204i)) {
            interfaceC18859Yf0 = (InterfaceC18859Yf0) m24204i;
        }
        if (interfaceC19085ag0 == null && interfaceC18859Yf0 == null) {
            throw new UnsupportedOperationException("Both printing and parsing not supported");
        }
        return new DateTimeFormatter(interfaceC19085ag0, interfaceC18859Yf0);
    }

    public DateTimeParser toParser() {
        Object m24204i = m24204i();
        if (m24202k(m24204i)) {
            return C18923Zf0.m65206a((InterfaceC18859Yf0) m24204i);
        }
    ...
    public DateTimePrinter toPrinter() {
        Object m24204i = m24204i();
        if (m24201l(m24204i)) {
            return C19263bg0.m51898a((InterfaceC19085ag0) m24204i);
        }
    ...
    /* loaded from: classes5.dex */
    public static class C13003i implements InterfaceC19085ag0, InterfaceC18859Yf0 {

        /* renamed from: c */
        public static Map f76275c = new ConcurrentHashMap();

        /* renamed from: a */
        public final DateTimeFieldType f76276a;

        /* renamed from: b */
        public final boolean f76277b;

        public C13003i(DateTimeFieldType dateTimeFieldType, boolean z) {
            this.f76276a = dateTimeFieldType;
            this.f76277b = z;
        }

        /* renamed from: a */
        public final String m24194a(long j, Chronology chronology, Locale locale) {
            DateTimeField field = this.f76276a.getField(chronology);
            if (this.f76277b) {
        ...
        /* renamed from: b */
        public final String m24193b(ReadablePartial readablePartial, Locale locale) {
            if (readablePartial.isSupported(this.f76276a)) {
                DateTimeField field = this.f76276a.getField(readablePartial.getChronology());
                if (this.f76277b) {
        ...
        public int parseInto(DateTimeParserBucket dateTimeParserBucket, CharSequence charSequence, int i) {
            ...
            Map map2 = (Map) f76275c.get(locale);
            if (map2 == null) {
                map2 = new ConcurrentHashMap();
                f76275c.put(locale, map2);
            }
            Object[] objArr = (Object[]) map2.get(this.f76276a);
            if (objArr == null) {
                map = new ConcurrentHashMap(32);
                MutableDateTime.Property property = new MutableDateTime(0L, DateTimeZone.UTC).property(this.f76276a);
                ...
                if (LanguageSupport.LANG_EN.equals(locale.getLanguage()) && this.f76276a == DateTimeFieldType.era()) {
                ...
                map2.put(this.f76276a, new Object[]{map, Integer.valueOf(intValue)});
            } else {
            ...
            for (int min = Math.min(charSequence.length(), intValue + i); min > i; min--) {
                ...
                if (map.containsKey(obj)) {
                    dateTimeParserBucket.saveField(this.f76276a, obj, locale);
                    return min;
                }
            }
            return ~i;
        ...
        public void printTo(Appendable appendable, long j, Chronology chronology, int i, DateTimeZone dateTimeZone, Locale locale) {
            try {
                appendable.append(m24194a(j, chronology, locale));
            } catch (RuntimeException unused) {
                appendable.append(Utf8.REPLACEMENT_CHARACTER);
            }
        }
        ...
        public void printTo(Appendable appendable, ReadablePartial readablePartial, Locale locale) {
            try {
                appendable.append(m24193b(readablePartial, locale));
            } catch (RuntimeException unused) {
                appendable.append(Utf8.REPLACEMENT_CHARACTER);
            }
        }
    ...
    public DateTimeFormatterBuilder appendLiteral(String str) {
        if (str != null) {
            ...
            if (length != 0) {
                if (length != 1) {
                    return m24211b(new C13002h(str));
                }
                return m24211b(new C12995a(str.charAt(0)));
            }
            return this;
        }
    ...
    public DateTimeFormatterBuilder appendTwoDigitWeekyear(int i, boolean z) {
        return m24211b(new C13006l(DateTimeFieldType.weekyear(), i, z));
    }

    public DateTimeFormatterBuilder appendTwoDigitYear(int i, boolean z) {
        return m24211b(new C13006l(DateTimeFieldType.year(), i, z));
    }
    ...
    public static class C13001g extends AbstractC13000f {
        ...
        public void printTo(Appendable appendable, long j, Chronology chronology, int i, DateTimeZone dateTimeZone, Locale locale) {
            try {
                FormatUtils.appendPaddedInteger(appendable, this.f76270a.getField(chronology).get(j), this.f76273d);
            } catch (RuntimeException unused) {
                DateTimeFormatterBuilder.m24210c(appendable, this.f76273d);
            }
        }

        @Override // p000.InterfaceC19085ag0
        public void printTo(Appendable appendable, ReadablePartial readablePartial, Locale locale) {
            if (readablePartial.isSupported(this.f76270a)) {
                try {
                    FormatUtils.appendPaddedInteger(appendable, readablePartial.get(this.f76270a), this.f76273d);
                    return;
                } catch (RuntimeException unused) {
                    DateTimeFormatterBuilder.m24210c(appendable, this.f76273d);
                    return;
    ...
    public static class C13007m extends AbstractC13000f {
        ...
        public void printTo(Appendable appendable, long j, Chronology chronology, int i, DateTimeZone dateTimeZone, Locale locale) {
            try {
                FormatUtils.appendUnpaddedInteger(appendable, this.f76270a.getField(chronology).get(j));
            } catch (RuntimeException unused) {
                appendable.append(Utf8.REPLACEMENT_CHARACTER);
            }
        }
        ...
        public void printTo(Appendable appendable, ReadablePartial readablePartial, Locale locale) {
            if (readablePartial.isSupported(this.f76270a)) {
                try {
                    FormatUtils.appendUnpaddedInteger(appendable, readablePartial.get(this.f76270a));
                    return;
                } catch (RuntimeException unused) {
                    appendable.append(Utf8.REPLACEMENT_CHARACTER);
                    return;
    ...
    public DateTimeFormatterBuilder append(DateTimePrinter dateTimePrinter) {
        m24208e(dateTimePrinter);
        return m24212a(C1857aE.m65164b(dateTimePrinter), null);
    }

    /* renamed from: org.joda.time.format.DateTimeFormatterBuilder$l */
    /* loaded from: classes5.dex */
    public static class C13006l implements InterfaceC19085ag0, InterfaceC18859Yf0 {

        /* renamed from: a */
        public final DateTimeFieldType f76285a;

        /* renamed from: b */
        public final int f76286b;

        /* renamed from: c */
        public final boolean f76287c;

        public C13006l(DateTimeFieldType dateTimeFieldType, int i, boolean z) {
            this.f76285a = dateTimeFieldType;
            this.f76286b = i;
            this.f76287c = z;
        }

        /* renamed from: a */
        public final int m24190a(long j, Chronology chronology) {
            try {
                int i = this.f76285a.getField(chronology).get(j);
                if (i < 0) {
                    i = -i;
                }
                return i % 100;
        ...
        /* renamed from: b */
        public final int m24189b(ReadablePartial readablePartial) {
            if (readablePartial.isSupported(this.f76285a)) {
                try {
                    int i = readablePartial.get(this.f76285a);
                    if (i < 0) {
                        i = -i;
                    }
                    return i % 100;
        ...
        public int parseInto(DateTimeParserBucket dateTimeParserBucket, CharSequence charSequence, int i) {
            ...
            if (!this.f76287c) {
                ...
                if (z || i7 != 2) {
                    ...
                    dateTimeParserBucket.saveField(this.f76285a, i4);
                    return i3;
                }
            }
            ...
            if (charAt3 >= '0' && charAt3 <= '9') {
                ...
                if (charAt4 >= '0' && charAt4 <= '9') {
                    ...
                    dateTimeParserBucket.saveField(this.f76285a, i10 + ((i12 + i6) - i5));
                    return i + 2;
                }
                return ~i;
            }
        ...
        @Override // p000.InterfaceC19085ag0
        public void printTo(Appendable appendable, long j, Chronology chronology, int i, DateTimeZone dateTimeZone, Locale locale) {
            int m24190a = m24190a(j, chronology);
            if (m24190a < 0) {
                appendable.append(Utf8.REPLACEMENT_CHARACTER);
                appendable.append(Utf8.REPLACEMENT_CHARACTER);
                return;
            }
            FormatUtils.appendPaddedInteger(appendable, m24190a, 2);
        }

        @Override // p000.InterfaceC19085ag0
        public void printTo(Appendable appendable, ReadablePartial readablePartial, Locale locale) {
            int m24189b = m24189b(readablePartial);
            if (m24189b < 0) {
                appendable.append(Utf8.REPLACEMENT_CHARACTER);
                appendable.append(Utf8.REPLACEMENT_CHARACTER);
                return;
            }
            FormatUtils.appendPaddedInteger(appendable, m24189b, 2);
        }
    }

    /* renamed from: org.joda.time.format.DateTimeFormatterBuilder$b */
    /* loaded from: classes5.dex */
    public static class C12996b implements InterfaceC19085ag0, InterfaceC18859Yf0 {

        /* renamed from: a */
        public final InterfaceC19085ag0[] f76261a;

        /* renamed from: b */
        public final InterfaceC18859Yf0[] f76262b;
        ...
        public C12996b(List list) {
            ...
            m24199b(list, arrayList, arrayList2);
            if (!arrayList.contains(null) && !arrayList.isEmpty()) {
                int size = arrayList.size();
                this.f76261a = new InterfaceC19085ag0[size];
                int i = 0;
                for (int i2 = 0; i2 < size; i2++) {
                    InterfaceC19085ag0 interfaceC19085ag0 = (InterfaceC19085ag0) arrayList.get(i2);
                    i += interfaceC19085ag0.estimatePrintedLength();
                    this.f76261a[i2] = interfaceC19085ag0;
                }
                this.f76263c = i;
            } else {
                this.f76261a = null;
            ...
            if (!arrayList2.contains(null) && !arrayList2.isEmpty()) {
                ...
                this.f76262b = new InterfaceC18859Yf0[size2];
                int i3 = 0;
                for (int i4 = 0; i4 < size2; i4++) {
                    InterfaceC18859Yf0 interfaceC18859Yf0 = (InterfaceC18859Yf0) arrayList2.get(i4);
                    i3 += interfaceC18859Yf0.estimateParsedLength();
                    this.f76262b[i4] = interfaceC18859Yf0;
                }
                this.f76264d = i3;
                return;
            }
        ...
        /* renamed from: a */
        public final void m24200a(List list, Object[] objArr) {
            if (objArr != null) {
        ...
        /* renamed from: b */
        public final void m24199b(List list, List list2, List list3) {
            int size = list.size();
            for (int i = 0; i < size; i += 2) {
                Object obj = list.get(i);
                if (obj instanceof C12996b) {
                    m24200a(list2, ((C12996b) obj).f76261a);
                } else {
                    list2.add(obj);
                }
                Object obj2 = list.get(i + 1);
                if (obj2 instanceof C12996b) {
                    m24200a(list3, ((C12996b) obj2).f76262b);
                } else {
                    list3.add(obj2);
                }
            }
        ...
        @Override // p000.InterfaceC18859Yf0
        public int parseInto(DateTimeParserBucket dateTimeParserBucket, CharSequence charSequence, int i) {
            InterfaceC18859Yf0[] interfaceC18859Yf0Arr = this.f76262b;
            if (interfaceC18859Yf0Arr != null) {
                int length = interfaceC18859Yf0Arr.length;
                for (int i2 = 0; i2 < length && i >= 0; i2++) {
                    i = interfaceC18859Yf0Arr[i2].parseInto(dateTimeParserBucket, charSequence, i);
                }
                return i;
            }
        ...
        @Override // p000.InterfaceC19085ag0
        public void printTo(Appendable appendable, long j, Chronology chronology, int i, DateTimeZone dateTimeZone, Locale locale) {
            InterfaceC19085ag0[] interfaceC19085ag0Arr = this.f76261a;
            if (interfaceC19085ag0Arr != null) {
                Locale locale2 = locale == null ? Locale.getDefault() : locale;
                for (InterfaceC19085ag0 interfaceC19085ag0 : interfaceC19085ag0Arr) {
                    interfaceC19085ag0.printTo(appendable, j, chronology, i, dateTimeZone, locale2);
                }
                return;
            }
            throw new UnsupportedOperationException();
        ...
        public void printTo(Appendable appendable, ReadablePartial readablePartial, Locale locale) {
            ...
            if (interfaceC19085ag0Arr != null) {
                ...
                for (InterfaceC19085ag0 interfaceC19085ag0 : interfaceC19085ag0Arr) {
                    interfaceC19085ag0.printTo(appendable, readablePartial, locale);
                }
                return;
            }
            throw new UnsupportedOperationException();
    ...
    public DateTimeFormatterBuilder append(DateTimeParser dateTimeParser) {
        m24209d(dateTimeParser);
        return m24212a(null, C1789ZD.m65250b(dateTimeParser));
    }

    public DateTimeFormatterBuilder append(DateTimePrinter dateTimePrinter, DateTimeParser dateTimeParser) {
        m24208e(dateTimePrinter);
        m24209d(dateTimeParser);
        return m24212a(C1857aE.m65164b(dateTimePrinter), C1789ZD.m65250b(dateTimeParser));
    }
        ...
        if (dateTimeParserArr != null) {
            ...
            if (length == 1) {
                if (dateTimeParserArr[0] != null) {
                    return m24212a(C1857aE.m65164b(dateTimePrinter), C1789ZD.m65250b(dateTimeParserArr[0]));
                }
                throw new IllegalArgumentException("No parser supplied");
            }
            InterfaceC18859Yf0[] interfaceC18859Yf0Arr = new InterfaceC18859Yf0[length];
            while (i < length - 1) {
                InterfaceC18859Yf0 m65250b = C1789ZD.m65250b(dateTimeParserArr[i]);
                interfaceC18859Yf0Arr[i] = m65250b;
                if (m65250b == null) {
                    throw new IllegalArgumentException("Incomplete parser array");
                }
                i++;
            }
            interfaceC18859Yf0Arr[i] = C1789ZD.m65250b(dateTimeParserArr[i]);
            return m24212a(C1857aE.m65164b(dateTimePrinter), new C12999e(interfaceC18859Yf0Arr));
        }
