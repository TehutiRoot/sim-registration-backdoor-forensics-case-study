...
public final class HoverableElement extends ModifierNodeElement<HoverableNode> {
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof HoverableElement) && Intrinsics.areEqual(((HoverableElement) obj).f12948b, this.f12948b)) {
            return true;
        }
        return false;
    }
    ...
    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    public int hashCode() {
        return this.f12948b.hashCode() * 31;
    }
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("interactionSource", this.f12948b);
    }
}