...
public final class NavigationRailKt$NavigationRail$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        f = NavigationRailKt.f14621d;
        Modifier selectableGroup = SelectableGroupKt.selectableGroup(PaddingKt.m69715paddingVpY3zN4$default(fillMaxHeight$default, 0.0f, f, 1, null));
        ...
        if (function3 != null) {
            ...
            f2 = NavigationRailKt.f14622e;
            SpacerKt.Spacer(SizeKt.m69734height3ABfNKs(companion, f2), composer, 6);
        }
