...
/* renamed from: th.co.dtac.android.dtacone.presenter.bitmap.SaveBitmapPresenter$saveBitmapFromCamera$5 */
/* loaded from: classes8.dex */
public final class SaveBitmapPresenter$saveBitmapFromCamera$5 extends Lambda implements Function1<Unit, Unit> {
    final /* synthetic */ SaveBitmapPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SaveBitmapPresenter$saveBitmapFromCamera$5(SaveBitmapPresenter saveBitmapPresenter) {
        super(1);
