...
public class MockTokenServerTransport extends MockHttpTransport {
    ...
    /* renamed from: j */
    public static final Logger f52018j = Logger.getLogger(MockTokenServerTransport.class.getName());

    /* renamed from: k */
    public static final JsonFactory f52019k = new GsonFactory();
    ...
    /* loaded from: classes4.dex */
    public class C7276a extends MockLowLevelHttpRequest {
        public C7276a(String str) {
            super(str);
        }
        ...
        public LowLevelHttpResponse execute() {
            ...
            if (str2 != null) {
                if (MockTokenServerTransport.this.f52022h.containsKey(str2)) {
                    String str3 = parseQuery.get("client_secret");
                    String str4 = (String) MockTokenServerTransport.this.f52022h.get(str2);
                    if (str3 != null && str3.equals(str4)) {
                        String str5 = parseQuery.get("refresh_token");
                        if (MockTokenServerTransport.this.f52023i.containsKey(str5)) {
                            str = (String) MockTokenServerTransport.this.f52023i.get(str5);
                        } else {
                ...
                if ("urn:ietf:params:oauth:grant-type:jwt-bearer".equals(parseQuery.get("grant_type"))) {
                    JsonWebSignature parse = JsonWebSignature.parse(MockTokenServerTransport.f52019k, parseQuery.get("assertion"));
                    String issuer = parse.getPayload().getIssuer();
                    if (MockTokenServerTransport.this.f52021g.containsKey(issuer)) {
                        String str6 = (String) MockTokenServerTransport.this.f52021g.get(issuer);
            ...
            genericJson.setFactory(MockTokenServerTransport.f52019k);
    ...
    public void addClient(String str, String str2) {
        this.f52022h.put(str, str2);
    }

    public void addRefreshToken(String str, String str2) {
        this.f52023i.put(str, str2);
    }

    public void addServiceAccount(String str, String str2) {
        this.f52021g.put(str, str2);
    }

    /* renamed from: b */
    public final MockLowLevelHttpRequest m41759b(String str) {
        return new C7276a(str);
    }

    @Override // com.google.api.client.testing.http.MockHttpTransport, com.google.api.client.http.HttpTransport
    public LowLevelHttpRequest buildRequest(String str, String str2) throws IOException {
        if (str2.equals(this.f52020f)) {
            return m41759b(str2);
        }
        if (str2.equals("https://accounts.google.com/o/oauth2/token")) {
            f52018j.warning("Your configured token_uri is using a legacy endpoint. You may want to redownload your credentials.");
            return m41759b(str2);
        }
    ...
    public MockTokenServerTransport(String str) {
        this.f52021g = new HashMap();
        this.f52022h = new HashMap();
