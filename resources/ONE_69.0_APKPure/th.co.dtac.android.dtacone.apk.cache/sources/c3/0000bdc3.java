...
public class setAccessibilityTraversalBefore implements setDarkTextColor.valueOf {
    private final setDarkTextColor values;

    public setAccessibilityTraversalBefore(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.getId(this.values);
    }
}