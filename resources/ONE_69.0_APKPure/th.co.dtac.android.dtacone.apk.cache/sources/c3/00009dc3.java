...
public class AppMeasurement {
    ...
    /* renamed from: b */
    public static volatile AppMeasurement f48064b;

    /* renamed from: a */
    public final AbstractC17570Ei2 f48065a;
    ...
    public AppMeasurement(zzfy zzfyVar) {
        this.f48065a = new C17481Da2(zzfyVar);
    }
    ...
    public static com.google.android.gms.measurement.AppMeasurement getInstance(@androidx.annotation.NonNull android.content.Context r17) {
        /*
            ...
            r2 = 0
            r3 = 2
            com.google.android.gms.measurement.AppMeasurement r4 = com.google.android.gms.measurement.AppMeasurement.f48064b
            if (r4 != 0) goto L60
            ...
            monitor-enter(r4)
            com.google.android.gms.measurement.AppMeasurement r5 = com.google.android.gms.measurement.AppMeasurement.f48064b     // Catch: java.lang.Throwable -> L30
            if (r5 != 0) goto L5c
            r5 = 0
        ...
        L36:
            ...
            com.google.android.gms.measurement.AppMeasurement.f48064b = r0     // Catch: java.lang.Throwable -> L30
            goto L5c
        L40:
            ...
            com.google.android.gms.measurement.AppMeasurement.f48064b = r1     // Catch: java.lang.Throwable -> L30
        L5c:
        ...
        L5e:
            ...
            throw r0
        L60:
            com.google.android.gms.measurement.AppMeasurement r0 = com.google.android.gms.measurement.AppMeasurement.f48064b
            return r0
        */
    ...
    public void clearConditionalUserProperty(@NonNull @Size(max = 24, min = 1) String str, @NonNull String str2, @NonNull Bundle bundle) {
        this.f48065a.zzq(str, str2, bundle);
    }

    @Keep
    public void endAdUnitExposure(@NonNull @Size(min = 1) String str) {
        this.f48065a.zzr(str);
    }

    @Keep
    public long generateEventId() {
        return this.f48065a.zzb();
    }

    @NonNull
    @Keep
    public String getAppInstanceId() {
        return this.f48065a.zzh();
    }

    @NonNull
    @KeepForSdk
    public Boolean getBoolean() {
        return this.f48065a.mo68591a();
    }
    ...
    public List<ConditionalUserProperty> getConditionalUserProperties(@NonNull String str, @NonNull @Size(max = 23, min = 1) String str2) {
        int size;
        List<Bundle> zzm = this.f48065a.zzm(str, str2);
        if (zzm == null) {
            size = 0;
        } else {
            size = zzm.size();
    ...
    public String getCurrentScreenClass() {
        return this.f48065a.zzi();
    }

    @NonNull
    @Keep
    public String getCurrentScreenName() {
        return this.f48065a.zzj();
    }

    @NonNull
    @KeepForSdk
    public Double getDouble() {
        return this.f48065a.mo68590b();
    }

    @NonNull
    @Keep
    public String getGmpAppId() {
        return this.f48065a.zzk();
    }

    @NonNull
    @KeepForSdk
    public Integer getInteger() {
        return this.f48065a.mo68589c();
    }

    @NonNull
    @KeepForSdk
    public Long getLong() {
        return this.f48065a.mo68588d();
    }
    ...
    public int getMaxUserProperties(@NonNull @Size(min = 1) String str) {
        return this.f48065a.zza(str);
    }

    @NonNull
    @KeepForSdk
    public String getString() {
        return this.f48065a.mo68587e();
    }
    ...
    public void setConditionalUserProperty(@NonNull ConditionalUserProperty conditionalUserProperty) {
        Preconditions.checkNotNull(conditionalUserProperty);
        AbstractC17570Ei2 abstractC17570Ei2 = this.f48065a;
    ...
    public Map<String, Object> getUserProperties(boolean z) {
        return this.f48065a.mo68586f(z);
    }
}