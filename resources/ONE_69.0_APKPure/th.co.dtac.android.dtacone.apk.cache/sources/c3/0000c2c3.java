...
public class PDPropBuild implements COSObjectable {
    ...
    /* renamed from: a */
    public COSDictionary f60638a;

    public PDPropBuild() {
        COSDictionary cOSDictionary = new COSDictionary();
        this.f60638a = cOSDictionary;
        cOSDictionary.setDirect(true);
    }

    public PDPropBuildDataDict getApp() {
        COSDictionary cOSDictionary = this.f60638a.getCOSDictionary(COSName.APP);
    ...
    public PDPropBuildDataDict getFilter() {
        COSDictionary cOSDictionary = this.f60638a.getCOSDictionary(COSName.FILTER);
        if (cOSDictionary != null) {
            return new PDPropBuildDataDict(cOSDictionary);
        }
        return null;
    ...
    public PDPropBuildDataDict getPubSec() {
        COSDictionary cOSDictionary = this.f60638a.getCOSDictionary(COSName.PUB_SEC);
        if (cOSDictionary != null) {
            return new PDPropBuildDataDict(cOSDictionary);
        }
        return null;
    ...
    public void setPDPropBuildApp(PDPropBuildDataDict pDPropBuildDataDict) {
        this.f60638a.setItem(COSName.APP, pDPropBuildDataDict);
    }

    public void setPDPropBuildFilter(PDPropBuildDataDict pDPropBuildDataDict) {
        this.f60638a.setItem(COSName.FILTER, pDPropBuildDataDict);
    }

    public void setPDPropBuildPubSec(PDPropBuildDataDict pDPropBuildDataDict) {
        this.f60638a.setItem(COSName.PUB_SEC, pDPropBuildDataDict);
    }
