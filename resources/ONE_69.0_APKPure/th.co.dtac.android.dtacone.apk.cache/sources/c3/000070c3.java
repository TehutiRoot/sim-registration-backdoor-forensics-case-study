...
@Metadata(m29143d1 = {"\u0000\u001c\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\u001a\u001e\u0010\u0000\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u0001H\u0007\u001aB\u0010\u0003\u001a\b\u0012\u0004\u0012\u0002H\u00040\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0004*\b\u0012\u0004\u0012\u0002H\u00020\u00012\u001c\u0010\u0005\u001a\u0018\u0012\t\u0012\u0007H\u0002¢\u0006\u0002\b\u0007\u0012\t\u0012\u0007H\u0004¢\u0006\u0002\b\u00070\u0006H\u0007\u001a8\u0010\u0003\u001a\b\u0012\u0004\u0012\u0002H\u00040\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0004*\b\u0012\u0004\u0012\u0002H\u00020\u00012\u0012\u0010\b\u001a\u000e\u0012\u0004\u0012\u0002H\u0002\u0012\u0004\u0012\u0002H\u00040\tH\u0007\u001aJ\u0010\n\u001a\b\u0012\u0004\u0012\u0002H\u00040\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0004*\b\u0012\u0004\u0012\u0002H\u00020\u00012$\u0010\u0005\u001a \u0012\t\u0012\u0007H\u0002¢\u0006\u0002\b\u0007\u0012\u0011\u0012\u000f\u0012\u0004\u0012\u0002H\u0004\u0018\u00010\u0001¢\u0006\u0002\b\u00070\u0006H\u0007\u001a>\u0010\n\u001a\b\u0012\u0004\u0012\u0002H\u00040\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0004*\b\u0012\u0004\u0012\u0002H\u00020\u00012\u0018\u0010\u000b\u001a\u0014\u0012\u0004\u0012\u0002H\u0002\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00040\u00010\tH\u0007¨\u0006\f"}, m29142d2 = {"distinctUntilChanged", "Landroidx/lifecycle/LiveData;", "X", "map", "Y", "transform", "Lkotlin/Function1;", "Lkotlin/jvm/JvmSuppressWildcards;", "mapFunction", "Landroidx/arch/core/util/Function;", "switchMap", "switchMapFunction", "lifecycle-livedata_release"}, m29141k = 2, m29140mv = {1, 8, 0}, m29138xi = 48)
...
public final class Transformations {
    ...
    /* loaded from: classes2.dex */
    public static final class C4661a implements Observer, FunctionAdapter {

        /* renamed from: a */
        public final /* synthetic */ Function1 f35953a;

        public C4661a(Function1 function) {
            Intrinsics.checkNotNullParameter(function, "function");
            this.f35953a = function;
        }
    ...
    public static final <X> LiveData<X> distinctUntilChanged(@NotNull LiveData<X> liveData) {
        ...
        mediatorLiveData.addSource(liveData, new C4661a(new Transformations$distinctUntilChanged$1(mediatorLiveData, booleanRef)));
    ...
    public static final <X, Y> LiveData<Y> map(@NotNull LiveData<X> liveData, @NotNull Function1<X, Y> transform) {
        ...
        mediatorLiveData.addSource(liveData, new C4661a(new Transformations$map$1(mediatorLiveData, transform)));
        return mediatorLiveData;
    }
    ...
    public static final <X, Y> LiveData<Y> switchMap(@NotNull LiveData<X> liveData, @NotNull Function1<X, LiveData<Y>> transform) {
        ...
        mediatorLiveData.addSource(liveData, new C4661a(new Transformations$switchMap$1(transform, objectRef, mediatorLiveData)));
        return mediatorLiveData;
    }
    ...
    public static final /* synthetic */ LiveData map(LiveData liveData, androidx.arch.core.util.Function mapFunction) {
        ...
        MediatorLiveData mediatorLiveData = new MediatorLiveData();
        mediatorLiveData.addSource(liveData, new C4661a(new Transformations$map$2(mediatorLiveData, mapFunction)));
        return mediatorLiveData;
    }
    ...
    public static final /* synthetic */ LiveData switchMap(LiveData liveData, final androidx.arch.core.util.Function switchMapFunction) {
        ...
        mediatorLiveData.addSource(liveData, new Observer() { // from class: androidx.lifecycle.Transformations$switchMap$2
            ...
            public void onChanged(Object obj) {
                ...
                LiveData liveData3 = this.f35954a;
                ...
                this.f35954a = liveData2;
                if (liveData2 != null) {
                    MediatorLiveData mediatorLiveData3 = mediatorLiveData;
                    Intrinsics.checkNotNull(liveData2);
                    mediatorLiveData3.addSource(liveData2, new Transformations.C4661a(new Transformations$switchMap$2$onChanged$1(mediatorLiveData)));
                }
            }
