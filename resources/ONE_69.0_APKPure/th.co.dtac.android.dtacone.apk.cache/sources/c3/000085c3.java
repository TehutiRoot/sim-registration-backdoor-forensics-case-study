...
public class FilteringParserDelegate extends JsonParserDelegate {
                    ...
                    if (m49778id != 3) {
                        if (m49778id != 4) {
                            if (m49778id != 5) {
                                ...
                                TokenFilter tokenFilter2 = TokenFilter.INCLUDE_ALL;
                                if (tokenFilter == tokenFilter2) {
                                    return m49774b(tokenFilterContext);
                                }
    ...
    /* renamed from: b */
    public final JsonToken m49774b(TokenFilterContext tokenFilterContext) {
    ...
    public final int currentTokenId() {
        ...
        return jsonToken.m49778id();
    }

    /* renamed from: d */
    public final boolean m49773d() {
                    ...
                    if (m49778id != 4) {
                        if (m49778id != 5) {
                            ...
                            if (tokenFilter == tokenFilter2) {
                                this._currToken = nextToken;
                                return nextToken;
                            } else if (tokenFilter != null && (((checkValue = this._headContext.checkValue(tokenFilter)) == tokenFilter2 || (checkValue != null && checkValue.includeValue(this.delegate))) && m49773d())) {
                                this._currToken = nextToken;
                                return nextToken;
                            }
                        } else {
