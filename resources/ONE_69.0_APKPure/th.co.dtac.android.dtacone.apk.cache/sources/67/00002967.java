...
public final class MultiParagraphLayoutCache {
    ...
    /* renamed from: i */
    public MinLinesConstrainer f14196i;

    /* renamed from: j */
    public Density f14197j;

    /* renamed from: k */
    public MultiParagraphIntrinsics f14198k;

    /* renamed from: l */
    public LayoutDirection f14199l;

    /* renamed from: m */
    public TextLayoutResult f14200m;
    ...
    /* renamed from: a */
    public final MultiParagraph m60991a(long j, LayoutDirection layoutDirection) {
        MultiParagraphIntrinsics m60988d = m60988d(layoutDirection);
        return new MultiParagraph(m60988d, LayoutUtilsKt.m69991finalConstraintstfFHcEY(j, this.f14192e, this.f14191d, m60988d.getMaxIntrinsicWidth()), LayoutUtilsKt.m69992finalMaxLinesxdlQI24(this.f14192e, this.f14191d, this.f14193f), TextOverflow.m73771equalsimpl0(this.f14191d, TextOverflow.Companion.m73779getEllipsisgIe3tQ8()), null);
    }

    /* renamed from: b */
    public final void m60990b() {
        this.f14198k = null;
        this.f14200m = null;
    }

    /* renamed from: c */
    public final boolean m60989c(TextLayoutResult textLayoutResult, long j, LayoutDirection layoutDirection) {
        ...
        if (Constraints.m73804equalsimpl0(j, textLayoutResult.getLayoutInput().m73369getConstraintsmsEJaDk())) {
            return false;
        }
        if (Constraints.m73810getMaxWidthimpl(j) != Constraints.m73810getMaxWidthimpl(textLayoutResult.getLayoutInput().m73369getConstraintsmsEJaDk()) || Constraints.m73809getMaxHeightimpl(j) < textLayoutResult.getMultiParagraph().getHeight() || textLayoutResult.getMultiParagraph().getDidExceedMaxLines()) {
            return true;
        }
        return false;
    }
    ...
    /* renamed from: d */
    public final MultiParagraphIntrinsics m60988d(LayoutDirection layoutDirection) {
        MultiParagraphIntrinsics multiParagraphIntrinsics = this.f14198k;
        if (multiParagraphIntrinsics == null || layoutDirection != this.f14199l || multiParagraphIntrinsics.getHasStaleResolvedFonts()) {
            this.f14199l = layoutDirection;
            AnnotatedString annotatedString = this.f14188a;
            TextStyle resolveDefaults = TextStyleKt.resolveDefaults(this.f14189b, layoutDirection);
            Density density = this.f14197j;
            Intrinsics.checkNotNull(density);
            FontFamily.Resolver resolver = this.f14190c;
            List list = this.f14195h;
            if (list == null) {
                list = CollectionsKt__CollectionsKt.emptyList();
            }
            multiParagraphIntrinsics = new MultiParagraphIntrinsics(annotatedString, resolveDefaults, list, density, resolver);
        }
        this.f14198k = multiParagraphIntrinsics;
        return multiParagraphIntrinsics;
    }

    /* renamed from: e */
    public final TextLayoutResult m60987e(LayoutDirection layoutDirection, long j, MultiParagraph multiParagraph) {
        AnnotatedString annotatedString = this.f14188a;
        TextStyle textStyle = this.f14189b;
        List list = this.f14195h;
        if (list == null) {
            list = CollectionsKt__CollectionsKt.emptyList();
        }
        int i = this.f14193f;
        boolean z = this.f14192e;
        int i2 = this.f14191d;
        Density density = this.f14197j;
        Intrinsics.checkNotNull(density);
        return new TextLayoutResult(new TextLayoutInput(annotatedString, textStyle, list, i, z, i2, density, layoutDirection, this.f14190c, j, (DefaultConstructorMarker) null), multiParagraph, ConstraintsKt.m73821constrain4WqzIAM(j, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(multiParagraph.getWidth()), TextDelegateKt.ceilToIntPx(multiParagraph.getHeight()))), null);
    }
    ...
    public final TextLayoutResult getTextLayoutResult() {
        TextLayoutResult textLayoutResult = this.f14200m;
    ...
    public final int intrinsicHeight(int i, @NotNull LayoutDirection layoutDirection) {
        ...
        int ceilToIntPx = TextDelegateKt.ceilToIntPx(m60991a(ConstraintsKt.Constraints(0, i, 0, Integer.MAX_VALUE), layoutDirection).getHeight());
        this.f14201n = i;
        this.f14202o = ceilToIntPx;
        return ceilToIntPx;
    }

    /* renamed from: layoutWithConstraints-K40F9xA  reason: not valid java name */
    public final boolean m69996layoutWithConstraintsK40F9xA(long j, @NotNull LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        if (this.f14194g > 1) {
            MinLinesConstrainer.Companion companion = MinLinesConstrainer.Companion;
            MinLinesConstrainer minLinesConstrainer = this.f14196i;
            TextStyle textStyle = this.f14189b;
            Density density = this.f14197j;
            Intrinsics.checkNotNull(density);
            MinLinesConstrainer from = companion.from(minLinesConstrainer, layoutDirection, textStyle, density, this.f14190c);
            this.f14196i = from;
            j = from.m69994coerceMinLinesOh53vG4$foundation_release(j, this.f14194g);
        }
        if (!m60989c(this.f14200m, j, layoutDirection)) {
            TextLayoutResult textLayoutResult = this.f14200m;
            Intrinsics.checkNotNull(textLayoutResult);
            if (Constraints.m73804equalsimpl0(j, textLayoutResult.getLayoutInput().m73369getConstraintsmsEJaDk())) {
                return false;
            }
            TextLayoutResult textLayoutResult2 = this.f14200m;
            Intrinsics.checkNotNull(textLayoutResult2);
            this.f14200m = m60987e(layoutDirection, j, textLayoutResult2.getMultiParagraph());
            return true;
        }
        this.f14200m = m60987e(layoutDirection, j, m60991a(j, layoutDirection));
        return true;
    }

    public final int maxIntrinsicWidth(@NotNull LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return TextDelegateKt.ceilToIntPx(m60988d(layoutDirection).getMaxIntrinsicWidth());
    }

    public final int minIntrinsicWidth(@NotNull LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return TextDelegateKt.ceilToIntPx(m60988d(layoutDirection).getMinIntrinsicWidth());
    }

    public final void setDensity$foundation_release(@Nullable Density density) {
        Density density2 = this.f14197j;
        if (density2 == null) {
            this.f14197j = density;
    ...
    public final void m69997updateZNqEYIc(@NotNull AnnotatedString text, @NotNull TextStyle style, @NotNull FontFamily.Resolver fontFamilyResolver, int i, boolean z, int i2, int i3, @Nullable List<AnnotatedString.Range<Placeholder>> list) {
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(fontFamilyResolver, "fontFamilyResolver");
        this.f14188a = text;
        this.f14189b = style;
        this.f14190c = fontFamilyResolver;
        this.f14191d = i;
        this.f14192e = z;
        this.f14193f = i2;
        this.f14194g = i3;
    ...
    public /* synthetic */ MultiParagraphLayoutCache(AnnotatedString annotatedString, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, List list, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.Companion.m73778getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, (i4 & 128) != 0 ? null : list, null);
    }
}