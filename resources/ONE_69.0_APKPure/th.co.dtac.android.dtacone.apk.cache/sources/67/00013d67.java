...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.registration.activity.OneRegistrationActivity$initViewModelLogin$6 */
/* loaded from: classes10.dex */
public final class OneRegistrationActivity$initViewModelLogin$6 extends Lambda implements Function1<Event<? extends String>, Unit> {
    final /* synthetic */ String $phoneNumber;
    final /* synthetic */ OneRegistrationActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneRegistrationActivity$initViewModelLogin$6(OneRegistrationActivity oneRegistrationActivity, String str) {
        super(1);
    ...
    public final void invoke2(Event<String> event) {
        if (event.getContentIfNotHandled() != null) {
            ...
            intent.putExtra(Constant.IntentConstant.RETAILER_PHONE_NUMBER, str);
            intent.putExtra(Constant.IntentConstant.HOME_FROM_LOGIN, true);
            oneRegistrationActivity.startActivity(intent);
