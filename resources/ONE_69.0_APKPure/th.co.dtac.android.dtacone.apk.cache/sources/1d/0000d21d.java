...
public final class ObservableRepeatWhen<T> extends AbstractC11078a {

    /* renamed from: a */
    public final Function f65515a;
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        try {
            ObservableSource observableSource = (ObservableSource) ObjectHelper.requireNonNull(this.f65515a.apply(serialized), "The handler returned a null ObservableSource");
