...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.viewmodel.OnePostpaidRegistrationViewModel$generateForm$2 */
/* loaded from: classes10.dex */
public final class OnePostpaidRegistrationViewModel$generateForm$2 extends Lambda implements Function1<OneGenerateFormResponse, Unit> {
    final /* synthetic */ OnePostpaidRegistrationViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidRegistrationViewModel$generateForm$2(OnePostpaidRegistrationViewModel onePostpaidRegistrationViewModel) {
        super(1);
    ...
    public final void invoke2(OneGenerateFormResponse oneGenerateFormResponse) {
        ...
        MutableLiveData m11683O1;
        onePostpaidRepository = this.this$0.f94609b;
        onePostpaidRepository.setPdfData(oneGenerateFormResponse.getData());
        onePostpaidRepository2 = this.this$0.f94609b;
        DataItem propositionTrueItem = onePostpaidRepository2.getPropositionTrueItem();
        if (!(propositionTrueItem != null ? Intrinsics.areEqual(propositionTrueItem.getContractFlag(), Boolean.TRUE) : false)) {
            m11683O1 = this.this$0.m11683O1();
            m11683O1.setValue(Resource.Companion.success(oneGenerateFormResponse));
            return;
        }
        this.this$0.getForms();
    }
}