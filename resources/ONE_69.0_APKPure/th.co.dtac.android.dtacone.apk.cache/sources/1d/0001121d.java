...
public final class OneTextInputLayoutIDCard extends FrameLayout implements TextWatcher, View.OnFocusChangeListener, OneEditText.UpdateListener {
    ...
    /* renamed from: b */
    public boolean f82948b;

    /* renamed from: c */
    public boolean f82949c;

    /* renamed from: d */
    public OnTextChangListener f82950d;

    /* renamed from: e */
    public final LayoutInflater f82951e;

    /* renamed from: f */
    public final TypedArray f82952f;

    @Metadata(m29143d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\u0012\u0010\u0002\u001a\u00020\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005H&¨\u0006\u0006"}, m29142d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/OneTextInputLayoutIDCard$OnTextChangListener;", "", "afterTextChanged", "", OperatorName.CLOSE_AND_STROKE, "Landroid/text/Editable;", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    public OneTextInputLayoutIDCard(@NotNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.f82947a = Boolean.TRUE;
        Object systemService = context.getSystemService("layout_inflater");
        Intrinsics.checkNotNull(systemService, "null cannot be cast to non-null type android.view.LayoutInflater");
        this.f82951e = (LayoutInflater) systemService;
        ...
        this.f82952f = obtainStyledAttributes;
        m20036b();
    }

    /* renamed from: a */
    public static /* synthetic */ void m20037a(OneEditText oneEditText, View view) {
        m20035c(oneEditText, view);
    }

    /* renamed from: c */
    public static final void m20035c(OneEditText idCardEditText, View view) {
    ...
    public void afterTextChanged(@Nullable Editable editable) {
        ...
        OnTextChangListener onTextChangListener = this.f82950d;
        ...
        if (i > 0 && Intrinsics.areEqual(this.f82947a, Boolean.TRUE) && this.f82949c) {
    ...
    /* renamed from: b */
    public final void m20036b() {
        addView(this.f82951e.inflate(R.layout.one_text_input_layout_id_card, (ViewGroup) null));
        View findViewById = findViewById(R.id.btnClearText);
        Intrinsics.checkNotNullExpressionValue(findViewById, "findViewById(R.id.btnClearText)");
        View findViewById2 = findViewById(R.id.idCardEditText);
        Intrinsics.checkNotNullExpressionValue(findViewById2, "findViewById(R.id.idCardEditText)");
        ...
        ((ImageView) findViewById).setOnClickListener(new View.OnClickListener() { // from class: sf1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                OneTextInputLayoutIDCard.m20037a(OneEditText.this, view);
            }
        });
        ...
        if (this.f82952f.hasValue(R.styleable.OneTextInputLayoutIdCard_is_enable)) {
            if (this.f82952f.getBoolean(R.styleable.OneTextInputLayoutIdCard_is_enable, true)) {
                ViewEnableKt.toEnable(oneEditText);
            } else {
                ViewEnableKt.toDisable(oneEditText);
            }
        }
        if (this.f82952f.hasValue(R.styleable.OneTextInputLayoutIdCard_input_hint)) {
            oneTextInputLayout.setHint(this.f82952f.getText(R.styleable.OneTextInputLayoutIdCard_input_hint));
        }
        if (this.f82952f.hasValue(R.styleable.OneTextInputLayoutIdCard_isShowClear)) {
            this.f82947a = Boolean.valueOf(this.f82952f.getBoolean(R.styleable.OneTextInputLayoutIdCard_isShowClear, true));
        }
        if (this.f82952f.hasValue(R.styleable.OneTextInputLayoutIdCard_isBlockPaste)) {
            this.f82948b = this.f82952f.getBoolean(R.styleable.OneTextInputLayoutIdCard_isBlockPaste, false);
        }
        if (this.f82952f.hasValue(R.styleable.OneTextInputLayoutIdCard_android_imeOptions)) {
            oneEditText.setImeOptions(this.f82952f.getInt(R.styleable.OneTextInputLayoutIdCard_android_imeOptions, 0));
        }
    }
    ...
    public void onFocusChange(@Nullable View view, boolean z) {
        ...
        if (z) {
            ...
            if (i > 0 && Intrinsics.areEqual(this.f82947a, Boolean.TRUE)) {
                ViewVisibleExtKt.toVisible(imageView);
                return;
            } else {
                ViewVisibleExtKt.toGone(imageView);
