...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.device_sale.fragment.OneDeviceSaleDeviceInfoFragment$setObserveViewModel$1$2 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleDeviceInfoFragment$setObserveViewModel$1$2 extends Lambda implements Function1<Resource<? extends Pair<? extends Integer, ? extends String>>, Unit> {
    final /* synthetic */ OneDeviceSaleDeviceInfoFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneDeviceSaleDeviceInfoFragment$setObserveViewModel$1$2(OneDeviceSaleDeviceInfoFragment oneDeviceSaleDeviceInfoFragment) {
        super(1);
    ...
    public final void invoke2(Resource<Pair<Integer, String>> resource) {
        Resource<Pair<Integer, String>> resourceContentIfNotHandled;
        ...
        oneDeviceSaleBundleAdapter = oneDeviceSaleDeviceInfoFragment.f90189j;
        if (oneDeviceSaleBundleAdapter == null) {
            Intrinsics.throwUninitializedPropertyAccessException("adapter");
            oneDeviceSaleBundleAdapter = null;
        }
        oneDeviceSaleBundleAdapter.updateVerifiedBundleItem(data.getSecond(), data.getFirst().intValue(), true);
    }
}