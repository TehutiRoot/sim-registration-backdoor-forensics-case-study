...
public final class ObservableConcatMapEager<T, R> extends AbstractC11078a {

    /* renamed from: a */
    public final Function f65199a;

    /* renamed from: b */
    public final ErrorMode f65200b;
    ...
    public ObservableConcatMapEager(ObservableSource<T> observableSource, Function<? super T, ? extends ObservableSource<? extends R>> function, ErrorMode errorMode, int i, int i2) {
        ...
        this.f65199a = function;
        this.f65200b = errorMode;
        this.f65201c = i;
        this.f65202d = i2;
    }
    ...
    public void subscribeActual(Observer<? super R> observer) {
        this.source.subscribe(new ConcatMapEagerMainObserver(observer, this.f65199a, this.f65201c, this.f65202d, this.f65200b));
    }
}