...
@SourceDebugExtension({"SMAP\nMrtrPrepaidReregistViewModel.kt\nKotlin\n*S Kotlin\n*F\n+ 1 MrtrPrepaidReregistViewModel.kt\nth/co/dtac/android/dtacone/viewmodel/mrtr_prepaid_reregist/MrtrPrepaidReregistViewModel$uploadImage$5\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,459:1\n1#2:460\n*E\n"})
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_prepaid_reregist.MrtrPrepaidReregistViewModel$uploadImage$5 */
/* loaded from: classes9.dex */
public final class MrtrPrepaidReregistViewModel$uploadImage$5 extends Lambda implements Function1<UploadImageResponse, Unit> {
    final /* synthetic */ MrtrPrepaidReregistViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrPrepaidReregistViewModel$uploadImage$5(MrtrPrepaidReregistViewModel mrtrPrepaidReregistViewModel) {
        super(1);
    ...
    public final void invoke2(UploadImageResponse uploadImageResponse) {
        ...
        if (filename != null) {
            this.this$0.getRepository().getAttachmentNames().add(filename);
        }
    }
}