...
public final class ModalBottomSheetWindow extends AbstractComposeView implements ViewTreeObserver.OnGlobalLayoutListener, ViewRootForInspector {
    ...
    /* renamed from: i */
    public Function0 f25971i;

    /* renamed from: j */
    public final View f25972j;

    /* renamed from: k */
    public final WindowManager f25973k;

    /* renamed from: l */
    public final WindowManager.LayoutParams f25974l;

    /* renamed from: m */
    public final MutableState f25975m;
    ...
    */
    public ModalBottomSheetWindow(kotlin.jvm.functions.Function0 r8, android.view.View r9, java.util.UUID r10) {
        /*
            ...
            kotlin.jvm.functions.Function2 r8 = r8.m70505getLambda3$material3_release()
            r9 = 0
            r10 = 2
    ...
    private final Function2 getContent() {
        return (Function2) this.f25975m.getValue();
    }

    private final void setContent(Function2 function2) {
        this.f25975m.setValue(function2);
    }
    ...
    public final void dismiss() {
        ...
        this.f25972j.getViewTreeObserver().removeOnGlobalLayoutListener(this);
        this.f25973k.removeViewImmediate(this);
    }
    ...
    /* renamed from: f */
    public final void m60568f(CompositionContext compositionContext, Function2 content) {
    ...
    public /* synthetic */ AbstractComposeView getSubCompositionView() {
        return Y32.m65499a(this);
    }

    @Override // androidx.compose.p003ui.platform.ViewRootForInspector
    public /* synthetic */ View getViewRoot() {
        return Y32.m65498b(this);
    }
    ...
    public final void show() {
        this.f25973k.addView(this, this.f25974l);
    }
}