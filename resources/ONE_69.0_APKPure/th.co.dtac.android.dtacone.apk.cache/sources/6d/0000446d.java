...
@Metadata(m29143d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m29142d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_snowshoeing", "Landroidx/compose/material/icons/Icons$Rounded;", "getSnowshoeing", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "Snowshoeing", "material-icons-extended_release"}, m29141k = 2, m29140mv = {1, 8, 0})
...
public final class SnowshoeingKt {
    ...
    /* renamed from: a */
    public static ImageVector f20787a;

    @NotNull
    public static final ImageVector getSnowshoeing(@NotNull Icons.Rounded rounded) {
        Intrinsics.checkNotNullParameter(rounded, "<this>");
        ImageVector imageVector = f20787a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Snowshoeing", C3623Dp.m73842constructorimpl(24.0f), C3623Dp.m73842constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.close();
        pathBuilder.moveTo(20.0f, 11.91f);
        pathBuilder.curveToRelative(0.0f, -0.49f, -0.36f, -0.9f, -0.84f, -0.98f);
        pathBuilder.curveToRelative(-1.53f, -0.25f, -2.79f, -1.16f, -3.47f, -2.35f);
        pathBuilder.lineToRelative(-1.0f, -1.58f);
        pathBuilder.curveToRelative(-0.4f, -0.6f, -1.0f, -1.0f, -1.7f, -1.0f);
        pathBuilder.curveToRelative(-0.68f, 0.0f, -1.28f, 0.28f, -4.77f, 1.76f);
        pathBuilder.curveTo(7.49f, 8.07f, 7.0f, 8.8f, 7.0f, 9.6f);
        ...
        pathBuilder.lineToRelative(-2.88f, 2.03f);
        ...
        pathBuilder.lineToRelative(2.85f, -2.01f);
        pathBuilder.curveToRelative(0.38f, -0.27f, 0.65f, -0.66f, 0.77f, -1.1f);
        pathBuilder.lineToRelative(0.7f, -2.53f);
        ...
        pathBuilder.lineToRelative(0.0f, -5.16f);
        pathBuilder.curveToRelative(0.0f, -0.55f, -0.23f, -1.07f, -0.62f, -1.45f);
        pathBuilder.lineToRelative(-1.49f, -1.41f);
        pathBuilder.lineToRelative(0.6f, -3.0f);
        pathBuilder.curveToRelative(1.07f, 1.24f, 2.63f, 2.15f, 4.37f, 2.43f);
        pathBuilder.curveTo(19.46f, 13.01f, 20.0f, 12.52f, 20.0f, 11.91f);
        pathBuilder.close();
