...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.buyDol.viewModel.OneBuyDolViewModel$_requestOTPLiveData$2 */
/* loaded from: classes10.dex */
public final class OneBuyDolViewModel$_requestOTPLiveData$2 extends Lambda implements Function0<MutableLiveData<Resource<? extends Pair<? extends RequestOtpResponse, ? extends String>>>> {
    public static final OneBuyDolViewModel$_requestOTPLiveData$2 INSTANCE = new OneBuyDolViewModel$_requestOTPLiveData$2();

    public OneBuyDolViewModel$_requestOTPLiveData$2() {
        super(0);
    }
