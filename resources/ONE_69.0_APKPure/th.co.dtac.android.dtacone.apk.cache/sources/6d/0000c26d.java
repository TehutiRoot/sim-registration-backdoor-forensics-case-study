...
public class PDShadingType5 extends AbstractC21173mi1 {
    ...
    public List mo26589b(AffineTransform affineTransform, Matrix matrix) {
        ...
        if (Float.compare(decodeForParameter.getMin(), decodeForParameter.getMax()) != 0 && Float.compare(decodeForParameter2.getMin(), decodeForParameter2.getMax()) != 0) {
            ...
            D22[][] d22Arr = (D22[][]) Array.newInstance(D22.class, size, i3);
            ...
            for (int i4 = 0; i4 < size; i4++) {
                for (int i5 = 0; i5 < i3; i5++) {
                    d22Arr[i4][i5] = (D22) arrayList3.get((i4 * i3) + i5);
                }
            }
            ...
            while (true) {
                ...
                if (i6 < size - 1) {
                    int i7 = 0;
                    while (i7 < i3 - 1) {
                        pointFArr[0] = d22Arr[i6][i7].f906a;
                        int i8 = i7 + 1;
                        pointFArr[c] = d22Arr[i6][i8].f906a;
                        int i9 = i6 + 1;
                        pointFArr[2] = d22Arr[i9][i7].f906a;
                        fArr[0] = d22Arr[i6][i7].f907b;
                        fArr[1] = d22Arr[i6][i8].f907b;
                        fArr[2] = d22Arr[i9][i7].f907b;
                        arrayList4.add(new GH1(pointFArr, fArr));
                        pointFArr[0] = d22Arr[i6][i8].f906a;
                        pointFArr[1] = d22Arr[i9][i7].f906a;
                        pointFArr[2] = d22Arr[i9][i8].f906a;
                        fArr[0] = d22Arr[i6][i8].f907b;
                        fArr[1] = d22Arr[i9][i7].f907b;
                        fArr[2] = d22Arr[i9][i8].f907b;
                        arrayList4.add(new GH1(pointFArr, fArr));
                        i7 = i8;
                        c = 1;
                    }
