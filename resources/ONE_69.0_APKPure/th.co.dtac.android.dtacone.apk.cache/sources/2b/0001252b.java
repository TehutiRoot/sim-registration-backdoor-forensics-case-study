...
/* renamed from: th.co.dtac.android.dtacone.presenter.sellerID.ChangeTokenForPromoterPresenter$storeNewUserProfile$5 */
/* loaded from: classes8.dex */
public final class ChangeTokenForPromoterPresenter$storeNewUserProfile$5 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ ChangeTokenForPromoterPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ChangeTokenForPromoterPresenter$storeNewUserProfile$5(ChangeTokenForPromoterPresenter changeTokenForPromoterPresenter) {
        super(1);
    ...
    public final void invoke2(Throwable th2) {
        ...
        errorService.handleException(th2, new ServerErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.presenter.sellerID.ChangeTokenForPromoterPresenter$storeNewUserProfile$5.1
