...
public final class SliderKt$Slider$3 extends Lambda implements Function3<BoxWithConstraintsScope, Composer, Integer, Unit> {
    ...
    /* loaded from: classes.dex */
    public /* synthetic */ class C31422 extends FunctionReferenceImpl implements Function1<Float, Float> {
        final /* synthetic */ Ref.FloatRef $maxPx;
        final /* synthetic */ Ref.FloatRef $minPx;
        final /* synthetic */ ClosedFloatingPointRange<Float> $valueRange;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C31422(ClosedFloatingPointRange<Float> closedFloatingPointRange, Ref.FloatRef floatRef, Ref.FloatRef floatRef2) {
    ...
    public static final float invoke$scaleToUserValue(Ref.FloatRef floatRef, Ref.FloatRef floatRef2, ClosedFloatingPointRange<Float> closedFloatingPointRange, float f) {
        float m60770j;
        m60770j = SliderKt.m60770j(floatRef.element, floatRef2.element, f, closedFloatingPointRange.getStart().floatValue(), closedFloatingPointRange.getEndInclusive().floatValue());
        return m60770j;
    }
    ...
    public final void invoke(@NotNull BoxWithConstraintsScope BoxWithConstraints, @Nullable Composer composer, int i) {
        ...
        floatRef.element = Math.max(m73810getMaxWidthimpl - density.mo69622toPx0680j_4(SliderKt.getThumbRadius()), 0.0f);
        floatRef2.element = Math.min(density.mo69622toPx0680j_4(SliderKt.getThumbRadius()), floatRef.element);
        ...
        C31422 c31422 = new C31422(this.$valueRange, floatRef2, floatRef);
        ClosedFloatingPointRange<Float> closedFloatingPointRange3 = this.$valueRange;
        ClosedFloatingPointRange<Float> rangeTo = AbstractC17854Is1.rangeTo(floatRef2.element, floatRef.element);
        float f2 = this.$value;
        int i3 = this.$$dirty;
        SliderKt.m60779a(c31422, closedFloatingPointRange3, rangeTo, mutableFloatState, f2, composer, ((i3 >> 9) & 112) | 3072 | ((i3 << 12) & 57344));
        ...
        m60767m = SliderKt.m60767m(companion2, sliderDraggableState2, this.$interactionSource, m73810getMaxWidthimpl, z, mutableFloatState, rememberUpdatedState, mutableFloatState2, this.$enabled);
        Orientation orientation = Orientation.Horizontal;
        boolean m60781e = sliderDraggableState2.m60781e();
        ...
        composer.endReplaceableGroup();
        Modifier draggable$default = DraggableKt.draggable$default(companion2, sliderDraggableState2, orientation, z2, mutableInteractionSource, m60781e, null, (Function3) rememberedValue5, z, 32, null);
        m60772h = SliderKt.m60772h(this.$valueRange.getStart().floatValue(), this.$valueRange.getEndInclusive().floatValue(), AbstractC11695c.coerceIn(this.$value, this.$valueRange.getStart().floatValue(), this.$valueRange.getEndInclusive().floatValue()));
        MutableInteractionSource mutableInteractionSource2 = this.$interactionSource;
        Modifier then = m60767m.then(draggable$default);
        int i4 = this.$$dirty;
        SliderKt.m60777c(this.$enabled, m60772h, this.$tickFractions, this.$colors, floatRef.element - floatRef2.element, mutableInteractionSource2, then, composer, ((i4 >> 9) & 14) | 512 | ((i4 >> 15) & 7168) | ((i4 >> 6) & 458752));
        if (ComposerKt.isTraceInProgress()) {
