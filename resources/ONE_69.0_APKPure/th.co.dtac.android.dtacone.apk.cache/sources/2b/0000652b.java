...
@Metadata(m29143d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n¢\u0006\u0002\b\u0004"}, m29142d2 = {"<anonymous>", "", "finalResult", "Landroidx/compose/ui/text/font/TypefaceResult;", "invoke"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
        ...
        synchronized (lock$ui_text_release) {
            try {
                if (finalResult.getCacheable()) {
                    lruCache2 = typefaceRequestCache.f31432b;
                    lruCache2.put(typefaceRequest, finalResult);
                } else {
                    lruCache = typefaceRequestCache.f31432b;
