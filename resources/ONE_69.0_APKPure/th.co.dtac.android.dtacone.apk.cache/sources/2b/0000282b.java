...
public final class PagerMeasurePolicyKt$rememberPagerMeasurePolicy$1$1 extends Lambda implements Function2<LazyLayoutMeasureScope, Constraints, PagerMeasureResult> {
    ...
    /* loaded from: classes.dex */
    public static final class C29462 extends Lambda implements Function3<Integer, Integer, Function1<? super Placeable.PlacementScope, ? extends Unit>, MeasureResult> {
        ...
        public C29462(LazyLayoutMeasureScope lazyLayoutMeasureScope, long j, int i, int i2) {
            super(3);
    ...
    public /* bridge */ /* synthetic */ PagerMeasureResult invoke(LazyLayoutMeasureScope lazyLayoutMeasureScope, Constraints constraints) {
        return m69867invoke0kLqBqw(lazyLayoutMeasureScope, constraints.m73816unboximpl());
    }

    @NotNull
    /* renamed from: invoke-0kLqBqw  reason: not valid java name */
    public final PagerMeasureResult m69867invoke0kLqBqw(@NotNull LazyLayoutMeasureScope lazyLayoutMeasureScope, long j) {
        boolean z;
        ...
        int i5 = mo69616roundToPx0680j_43 + mo69616roundToPx0680j_44;
        int i6 = mo69616roundToPx0680j_4 + mo69616roundToPx0680j_42;
        if (z) {
            i = i5;
        } else {
            i = i6;
        ...
        int i7 = i - i2;
        long m73826offsetNN6EwU = ConstraintsKt.m73826offsetNN6EwU(j, -i6, -i5);
        this.$state.setDensity$foundation_release(lazyLayoutMeasureScope);
        int mo69616roundToPx0680j_45 = lazyLayoutMeasureScope.mo69616roundToPx0680j_4(this.$pageSpacing);
        if (z) {
            m73810getMaxWidthimpl = Constraints.m73809getMaxHeightimpl(j) - i5;
        } else {
            m73810getMaxWidthimpl = Constraints.m73810getMaxWidthimpl(j) - i6;
        }
        if (this.$reverseLayout && m73810getMaxWidthimpl <= 0) {
            if (!z) {
                mo69616roundToPx0680j_4 += m73810getMaxWidthimpl;
            }
            if (z) {
                mo69616roundToPx0680j_43 += m73810getMaxWidthimpl;
            }
        ...
        long j2 = IntOffset;
        int calculateMainAxisPageSize = this.$pageSize.calculateMainAxisPageSize(lazyLayoutMeasureScope, m73810getMaxWidthimpl, mo69616roundToPx0680j_45);
        PagerState pagerState = this.$state;
        if (this.$orientation == orientation3) {
            i3 = Constraints.m73810getMaxWidthimpl(m73826offsetNN6EwU);
        } else {
            i3 = calculateMainAxisPageSize;
        }
        if (this.$orientation != orientation3) {
            i4 = Constraints.m73809getMaxHeightimpl(m73826offsetNN6EwU);
        } else {
            i4 = calculateMainAxisPageSize;
        }
        pagerState.m69870setPremeasureConstraintsBRTryo0$foundation_release(ConstraintsKt.Constraints$default(0, i3, 0, i4, 5, null));
        ...
        try {
            ...
            if (Intrinsics.areEqual(pagerState2.getLayoutInfo$foundation_release(), PagerStateKt.getEmptyLayoutInfo())) {
                firstVisiblePageOffset$foundation_release = AbstractC22237sr0.roundToInt(pagerState2.getInitialPageOffsetFraction() * calculateMainAxisPageSize);
            } else {
            ...
            PagerMeasureResult m69865measurePagerntgEbfI = PagerMeasureKt.m69865measurePagerntgEbfI(lazyLayoutMeasureScope, this.$pageCount.invoke().intValue(), invoke, m73810getMaxWidthimpl, i2, i7, mo69616roundToPx0680j_45, firstVisiblePage$foundation_release, i8, this.$state.getScrollToBeConsumed$foundation_release(), m73826offsetNN6EwU, this.$orientation, this.$verticalAlignment, this.$horizontalAlignment, this.$reverseLayout, j2, calculateMainAxisPageSize, this.$beyondBoundsPageCount, calculateLazyLayoutPinnedIndices, new C29462(lazyLayoutMeasureScope, j, i6, i5));
            this.$state.applyMeasureResult$foundation_release(m69865measurePagerntgEbfI);
            return m69865measurePagerntgEbfI;
        } catch (Throwable th2) {
            createNonObservableSnapshot.dispose();
            throw th2;
        }
