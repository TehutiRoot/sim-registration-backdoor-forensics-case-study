...
@DebugMetadata(m29093c = "androidx.compose.material3.SwipeableV2State$animateTo$2", m29092f = "SwipeableV2.kt", m29091i = {}, m29090l = {353}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
...
public final class SwipeableV2State$animateTo$2 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    @Metadata(m29143d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u0007\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0004H\n¢\u0006\u0002\b\u0006"}, m29142d2 = {"<anonymous>", "", "T", "value", "", "velocity", "invoke"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: androidx.compose.material3.SwipeableV2State$animateTo$2$1 */
    /* loaded from: classes2.dex */
    public static final class C33741 extends Lambda implements Function2<Float, Float, Unit> {
        final /* synthetic */ Ref.FloatRef $prev;
        final /* synthetic */ SwipeableV2State<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C33741(SwipeableV2State<T> swipeableV2State, Ref.FloatRef floatRef) {
            super(2);
        ...
        public final void invoke(float f, float f2) {
            this.this$0.m60437g(Float.valueOf(f));
            this.$prev.element = f;
            this.this$0.m60438f(f2);
        }
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i != 0) {
            ...
            ResultKt.throwOnFailure(obj);
            this.this$0.m60440d(this.$targetValue);
            ...
            C33741 c33741 = new C33741(this.this$0, floatRef);
            this.label = 1;
            if (SuspendAnimationKt.animate(f, floatValue, f2, animationSpec$material3_release, c33741, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        }
        this.this$0.m60438f(0.0f);
        return Unit.INSTANCE;
    }
