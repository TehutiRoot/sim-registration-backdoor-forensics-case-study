...
public final class Longs {
    ...
    public static class LongArrayAsList extends AbstractList<Long> implements RandomAccess, Serializable {
        ...
        public boolean contains(@CheckForNull Object obj) {
            if ((obj instanceof Long) && Longs.m39805d(this.array, ((Long) obj).longValue(), this.start, this.end) != -1) {
                return true;
            }
            return false;
        }
        ...
        public int indexOf(@CheckForNull Object obj) {
            int m39805d;
            if ((obj instanceof Long) && (m39805d = Longs.m39805d(this.array, ((Long) obj).longValue(), this.start, this.end)) >= 0) {
                return m39805d - this.start;
            }
            return -1;
        }
        ...
        public int lastIndexOf(@CheckForNull Object obj) {
            int m39804e;
            if ((obj instanceof Long) && (m39804e = Longs.m39804e(this.array, ((Long) obj).longValue(), this.start, this.end)) >= 0) {
                return m39804e - this.start;
            }
            return -1;
        }
    ...
    /* renamed from: com.google.common.primitives.Longs$a */
    /* loaded from: classes4.dex */
    public static final class C8122a {

        /* renamed from: a */
        public static final byte[] f54089a;
        ...
        /* renamed from: a */
        public static int m39803a(char c) {
            if (c < 128) {
                return f54089a[c];
            }
            return -1;
    ...
    /* renamed from: c */
    public static int m39806c(long j) {
        boolean z;
        int i = (int) j;
        if (j == i) {
            z = true;
        ...
        Preconditions.checkArgument(z, "the total number of elements (%s) in the arrays must fit in an int", j);
        return i;
    }
    ...
    /* renamed from: d */
    public static int m39805d(long[] jArr, long j, int i, int i2) {
        while (i < i2) {
            if (jArr[i] == j) {
                return i;
            }
    ...
    /* renamed from: e */
    public static int m39804e(long[] jArr, long j, int i, int i2) {
    ...
    public static int indexOf(long[] jArr, long j) {
        return m39805d(jArr, j, 0, jArr.length);
    }
    ...
    public static int lastIndexOf(long[] jArr, long j) {
        return m39804e(jArr, j, 0, jArr.length);
    }
    ...
    */
    ...
    public static Long tryParse(String str, int i) {
        ...
        if (i >= 2 && i <= 36) {
            ...
            int i3 = i2 + 1;
            int m39803a = C8122a.m39803a(str.charAt(i2));
            if (m39803a < 0 || m39803a >= i) {
                return null;
            }
            long j = -m39803a;
            long j2 = i;
            ...
            while (i3 < str.length()) {
                int i4 = i3 + 1;
                int m39803a2 = C8122a.m39803a(str.charAt(i3));
                if (m39803a2 < 0 || m39803a2 >= i || j < j3) {
                    return null;
                }
                long j4 = j * j2;
                long j5 = m39803a2;
