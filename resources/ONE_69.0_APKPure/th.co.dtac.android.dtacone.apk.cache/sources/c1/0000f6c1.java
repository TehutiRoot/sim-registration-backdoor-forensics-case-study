...
public class ThreefishEngine implements BlockCipher {
    ...
    /* renamed from: kw */
    private long[] f75131kw;

    /* renamed from: t */
    private long[] f75132t;
    ...
    public static final class Threefish1024Cipher extends ThreefishCipher {
        ...
        public void decryptBlock(long[] jArr, long[] jArr2) {
            long[] jArr3 = this.f75133kw;
            long[] jArr4 = this.f75134t;
    ...
    public static abstract class ThreefishCipher {
        ...
        /* renamed from: kw */
        protected final long[] f75133kw;

        /* renamed from: t */
        protected final long[] f75134t;
    ...
    private void setKey(long[] jArr) {
        ...
        while (true) {
            ...
            if (i >= i2) {
                long[] jArr2 = this.f75131kw;
                jArr2[i2] = j;
                System.arraycopy(jArr2, 0, jArr2, i2 + 1, i2);
                return;
            }
            long[] jArr3 = this.f75131kw;
            long j2 = jArr[i];
            jArr3[i] = j2;
            j ^= j2;
            i++;
