...
public final class CloneableClassScope extends GivenFunctionsMemberScope {
    ...
    /* renamed from: d */
    public static final Name f68599d;
    ...
    public static final class Companion {
        ...
        public final Name getCLONE_NAME() {
            return CloneableClassScope.f68599d;
        }
    ...
    public List<FunctionDescriptor> computeDeclaredFunctions() {
        SimpleFunctionDescriptorImpl create = SimpleFunctionDescriptorImpl.create(getContainingClass(), Annotations.Companion.getEMPTY(), f68599d, CallableMemberDescriptor.Kind.DECLARATION, SourceElement.NO_SOURCE);
        ...
        return AbstractC10100ds.listOf(create);
    }
}