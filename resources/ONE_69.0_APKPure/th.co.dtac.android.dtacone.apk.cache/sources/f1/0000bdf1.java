...
public class setChallengeViewBackgroundColor implements setDarkTextColor.valueOf {
    private final setDarkTextColor valueOf;

    public setChallengeViewBackgroundColor(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.set3DSServerTransactionID(this.valueOf);
    }
}