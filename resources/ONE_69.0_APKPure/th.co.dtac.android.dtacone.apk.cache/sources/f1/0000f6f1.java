...
public class KDFCounterBytesGenerator implements MacDerivationFunction {
    ...
    /* renamed from: h */
    private final int f75153h;
    private byte[] ios;

    /* renamed from: k */
    private byte[] f75154k;
    ...
    public KDFCounterBytesGenerator(Mac mac) {
        ...
        this.f75153h = macSize;
        this.f75154k = new byte[macSize];
    }

    private void generateNext() {
        int i = (this.generatedBytes / this.f75153h) + 1;
        byte[] bArr = this.ios;
        ...
        this.prf.doFinal(this.f75154k, 0);
    }
    ...
    public int generateBytes(byte[] bArr, int i, int i2) throws DataLengthException, IllegalArgumentException {
        ...
        System.arraycopy(this.f75154k, i7, bArr, i, min);
        ...
        while (true) {
            ...
            generateNext();
            min = Math.min(this.f75153h, i8);
            System.arraycopy(this.f75154k, 0, bArr, i, min);
            this.generatedBytes += min;
            i8 -= min;
        }
    }
    ...
    public void init(DerivationParameters derivationParameters) {
        ...
        BigInteger multiply = TWO.pow(r).multiply(BigInteger.valueOf(this.f75153h));
