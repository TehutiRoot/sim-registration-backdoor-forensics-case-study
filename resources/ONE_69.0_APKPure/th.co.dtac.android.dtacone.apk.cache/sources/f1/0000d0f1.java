...
public final class MaybeTimer extends Maybe<Long> {
    ...
    /* renamed from: b */
    public final TimeUnit f64955b;

    /* renamed from: c */
    public final Scheduler f64956c;
    ...
    public MaybeTimer(long j, TimeUnit timeUnit, Scheduler scheduler) {
        this.f64954a = j;
        this.f64955b = timeUnit;
        this.f64956c = scheduler;
    }
    ...
    public void subscribeActual(MaybeObserver<? super Long> maybeObserver) {
        ...
        timerDisposable.setFuture(this.f64956c.scheduleDirect(timerDisposable, this.f64954a, this.f64955b));
    }
}