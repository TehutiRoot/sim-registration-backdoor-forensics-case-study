...
public class PatternCodec implements Codec<Pattern> {
    ...
    /* renamed from: a */
    public static int m24469a(BsonRegularExpression bsonRegularExpression) {
    ...
    /* renamed from: b */
    public static String m24468b(Pattern pattern) {
        RegexFlag[] values;
    ...
    public Pattern decode(BsonReader bsonReader, DecoderContext decoderContext) {
        ...
        return Pattern.compile(readRegularExpression.getPattern(), m24469a(readRegularExpression));
    }

    @Override // org.bson.codecs.Encoder
    public void encode(BsonWriter bsonWriter, Pattern pattern, EncoderContext encoderContext) {
        bsonWriter.writeRegularExpression(new BsonRegularExpression(pattern.pattern(), m24468b(pattern)));
    }
}