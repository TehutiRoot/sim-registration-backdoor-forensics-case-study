...
public final class CompositeException extends RuntimeException {
    ...
    /* loaded from: classes5.dex */
    public static abstract class AbstractC10735a {
        /* renamed from: a */
        public abstract void mo30437a(Object obj);
    }

    /* renamed from: io.reactivex.exceptions.CompositeException$b */
    /* loaded from: classes5.dex */
    public static final class C10736b extends AbstractC10735a {

        /* renamed from: a */
        public final PrintStream f63882a;

        public C10736b(PrintStream printStream) {
            this.f63882a = printStream;
        }

        @Override // io.reactivex.exceptions.CompositeException.AbstractC10735a
        /* renamed from: a */
        public void mo30437a(Object obj) {
            this.f63882a.println(obj);
        }
    }

    /* renamed from: io.reactivex.exceptions.CompositeException$c */
    /* loaded from: classes5.dex */
    public static final class C10737c extends AbstractC10735a {

        /* renamed from: a */
        public final PrintWriter f63883a;

        public C10737c(PrintWriter printWriter) {
            this.f63883a = printWriter;
        }

        @Override // io.reactivex.exceptions.CompositeException.AbstractC10735a
        /* renamed from: a */
        public void mo30437a(Object obj) {
            this.f63883a.println(obj);
        }
    }
    ...
    public void printStackTrace(PrintStream printStream) {
        printStackTrace(new C10736b(printStream));
    }

    @Override // java.lang.Throwable
    public void printStackTrace(PrintWriter printWriter) {
        printStackTrace(new C10737c(printWriter));
    }
    ...
    private void printStackTrace(AbstractC10735a abstractC10735a) {
        StackTraceElement[] stackTrace;
        ...
        abstractC10735a.mo30437a(sb.toString());
    }
}