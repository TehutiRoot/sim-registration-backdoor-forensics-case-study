...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.tol.screen.inputInfo.ComposableSingletons$InputInfoScreenKt$lambda-12$1$1$2$1  reason: invalid class name */
/* loaded from: classes10.dex */
public final class ComposableSingletons$InputInfoScreenKt$lambda12$1$1$2$1 extends Lambda implements Function1<CustomerInformation, Unit> {
    final /* synthetic */ MutableState<CustomerInformation> $customerInfo$delegate;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ComposableSingletons$InputInfoScreenKt$lambda12$1$1$2$1(MutableState<CustomerInformation> mutableState) {
        super(1);
