...
public final class ProjectProperties extends GeneratedMessageLite<ProjectProperties, Builder> implements ProjectPropertiesOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<ProjectProperties, Builder> implements ProjectPropertiesOrBuilder {
        ...
        public Builder addAllProperties(Iterable<? extends Property> iterable) {
            copyOnWrite();
            ((ProjectProperties) this.instance).m42326I(iterable);
            return this;
        }

        public Builder addProperties(Property property) {
            copyOnWrite();
            ((ProjectProperties) this.instance).m42324K(property);
            return this;
        }

        public Builder clearProperties() {
            copyOnWrite();
            ((ProjectProperties) this.instance).m42323L();
            return this;
        }
        ...
        public Builder removeProperties(int i) {
            copyOnWrite();
            ((ProjectProperties) this.instance).m42321N(i);
            return this;
        }

        public Builder setProperties(int i, Property property) {
            copyOnWrite();
            ((ProjectProperties) this.instance).m42320O(i, property);
            return this;
        }
        ...
        public Builder addProperties(int i, Property property) {
            copyOnWrite();
            ((ProjectProperties) this.instance).m42325J(i, property);
            return this;
        }

        public Builder setProperties(int i, Property.Builder builder) {
            copyOnWrite();
            ((ProjectProperties) this.instance).m42320O(i, builder.build());
            return this;
        }

        public Builder addProperties(Property.Builder builder) {
            copyOnWrite();
            ((ProjectProperties) this.instance).m42324K(builder.build());
            return this;
        }

        public Builder addProperties(int i, Property.Builder builder) {
            copyOnWrite();
            ((ProjectProperties) this.instance).m42325J(i, builder.build());
            return this;
        }
    }
    ...
    /* renamed from: I */
    public final void m42326I(Iterable iterable) {
        m42322M();
        AbstractMessageLite.addAll(iterable, (List) this.properties_);
    }

    /* renamed from: J */
    public final void m42325J(int i, Property property) {
        property.getClass();
        m42322M();
    ...
    /* renamed from: K */
    public final void m42324K(Property property) {
        property.getClass();
        m42322M();
    ...
    /* renamed from: N */
    public final void m42321N(int i) {
        m42322M();
        this.properties_.remove(i);
    }

    /* renamed from: O */
    public final void m42320O(int i, Property property) {
        property.getClass();
        m42322M();
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C7229a.f51655a[methodToInvoke.ordinal()]) {
            case 1:
