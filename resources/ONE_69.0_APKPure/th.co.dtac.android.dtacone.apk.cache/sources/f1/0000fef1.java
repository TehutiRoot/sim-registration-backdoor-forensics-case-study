...
public class SecT283R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT283R1Curve() {
        ...
        this.f75412b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("027B680AC8B8596DA5A4AF8A19A0303FCA97FD7645309FA2A581485AF6263E313B79A2F5")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat320.copy64(((SecT283FieldElement) eCPoint.getRawXCoord()).f75507x, 0, jArr, i3);
            Nat320.copy64(((SecT283FieldElement) eCPoint.getRawYCoord()).f75507x, 0, jArr, i3 + 5);
            i3 += 10;
        }
