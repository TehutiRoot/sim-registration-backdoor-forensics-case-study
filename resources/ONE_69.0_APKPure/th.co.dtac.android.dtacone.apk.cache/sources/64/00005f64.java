...
public final class FocusOwnerImpl implements FocusOwner {
    ...
    /* renamed from: a */
    public FocusTargetNode f29006a;

    /* renamed from: b */
    public final FocusInvalidationManager f29007b;

    /* renamed from: c */
    public final Modifier f29008c;
    ...
    public FocusOwnerImpl(@NotNull Function1<? super Function0<Unit>, Unit> onRequestApplyChangesListener) {
        ...
        this.f29006a = new FocusTargetNode();
        this.f29007b = new FocusInvalidationManager(onRequestApplyChangesListener);
        this.f29008c = new ModifierNodeElement<FocusTargetNode>() { // from class: androidx.compose.ui.focus.FocusOwnerImpl$modifier$1
    ...
    /* renamed from: a */
    public final Modifier.Node m59776a(DelegatableNode delegatableNode) {
        int m73145constructorimpl = NodeKind.m73145constructorimpl(1024) | NodeKind.m73145constructorimpl(8192);
        if (delegatableNode.getNode().isAttached()) {
            Modifier.Node node = delegatableNode.getNode();
            Modifier.Node node2 = null;
            if ((node.getAggregateChildKindSet$ui_release() & m73145constructorimpl) != 0) {
                for (Modifier.Node child$ui_release = node.getChild$ui_release(); child$ui_release != null; child$ui_release = child$ui_release.getChild$ui_release()) {
                    if ((child$ui_release.getKindSet$ui_release() & m73145constructorimpl) != 0) {
                        if ((NodeKind.m73145constructorimpl(1024) & child$ui_release.getKindSet$ui_release()) != 0) {
                            return node2;
                        }
    ...
    /* renamed from: b */
    public final boolean m59775b(int i) {
        boolean m71616equalsimpl0;
        if (this.f29006a.getFocusState().getHasFocus() && !this.f29006a.getFocusState().isFocused()) {
            FocusDirection.Companion companion = FocusDirection.Companion;
            if (FocusDirection.m71616equalsimpl0(i, companion.m71629getNextdhqQ8s())) {
                m71616equalsimpl0 = true;
            } else {
                m71616equalsimpl0 = FocusDirection.m71616equalsimpl0(i, companion.m71631getPreviousdhqQ8s());
            }
            if (m71616equalsimpl0) {
                clearFocus(false);
                if (!this.f29006a.getFocusState().isFocused()) {
                    return false;
                }
                return mo71634moveFocus3ESFkO8(i);
            }
        }
        return false;
    }
    ...
    public boolean mo71635dispatchInterceptedSoftKeyboardEventZmokQxo(@NotNull KeyEvent keyEvent) {
        ...
        FocusTargetNode findActiveFocusNode = FocusTraversalKt.findActiveFocusNode(this.f29006a);
        if (findActiveFocusNode != null) {
            int m73145constructorimpl = NodeKind.m73145constructorimpl(131072);
            if (findActiveFocusNode.getNode().isAttached()) {
                ...
                loop0: while (true) {
                    if (requireLayoutNode != null) {
                        if ((requireLayoutNode.getNodes$ui_release().getHead$ui_release().getAggregateChildKindSet$ui_release() & m73145constructorimpl) != 0) {
                            while (parent$ui_release != null) {
                                if ((parent$ui_release.getKindSet$ui_release() & m73145constructorimpl) != 0) {
                                    ...
                                    while (node != null) {
                                        ...
                                        if ((node.getKindSet$ui_release() & m73145constructorimpl) != 0 && (node instanceof DelegatingNode)) {
                                            int i2 = 0;
                                        ...
                                        node = DelegatableNodeKt.m59459b(mutableVector);
                                    }
                                    continue;
                                }
        ...
        if (softKeyboardInterceptionModifierNode != null) {
            int m73145constructorimpl2 = NodeKind.m73145constructorimpl(131072);
            if (softKeyboardInterceptionModifierNode.getNode().isAttached()) {
                ...
                while (requireLayoutNode2 != null) {
                    if ((requireLayoutNode2.getNodes$ui_release().getHead$ui_release().getAggregateChildKindSet$ui_release() & m73145constructorimpl2) != 0) {
                        while (parent$ui_release2 != null) {
                            if ((parent$ui_release2.getKindSet$ui_release() & m73145constructorimpl2) != 0) {
                                ...
                                while (node2 != null) {
                                    if (node2 instanceof SoftKeyboardInterceptionModifierNode) {
                                        ...
                                        arrayList.add(node2);
                                    } else if ((node2.getKindSet$ui_release() & m73145constructorimpl2) != 0 && (node2 instanceof DelegatingNode)) {
                                        int i3 = 0;
                                        for (Modifier.Node delegate$ui_release2 = ((DelegatingNode) node2).getDelegate$ui_release(); delegate$ui_release2 != null; delegate$ui_release2 = delegate$ui_release2.getChild$ui_release()) {
                                            if ((delegate$ui_release2.getKindSet$ui_release() & m73145constructorimpl2) != 0) {
                                                i3++;
                                                if (i3 == 1) {
                                    ...
                                    node2 = DelegatableNodeKt.m59459b(mutableVector2);
                                }
                            }
                ...
                if (arrayList != null && arrayList.size() - 1 >= 0) {
                    while (true) {
                        int i4 = i - 1;
                        if (((SoftKeyboardInterceptionModifierNode) arrayList.get(i)).mo69370onPreInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                            return true;
                        }
                        if (i4 < 0) {
                            break;
                ...
                while (node3 != null) {
                    if (node3 instanceof SoftKeyboardInterceptionModifierNode) {
                        if (((SoftKeyboardInterceptionModifierNode) node3).mo69370onPreInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                            return true;
                        }
                    } else if ((node3.getKindSet$ui_release() & m73145constructorimpl2) != 0 && (node3 instanceof DelegatingNode)) {
                        int i5 = 0;
                        for (Modifier.Node delegate$ui_release3 = ((DelegatingNode) node3).getDelegate$ui_release(); delegate$ui_release3 != null; delegate$ui_release3 = delegate$ui_release3.getChild$ui_release()) {
                            if ((delegate$ui_release3.getKindSet$ui_release() & m73145constructorimpl2) != 0) {
                                i5++;
                                if (i5 == 1) {
                    ...
                    node3 = DelegatableNodeKt.m59459b(mutableVector3);
                }
                ...
                while (node4 != null) {
                    if (node4 instanceof SoftKeyboardInterceptionModifierNode) {
                        if (((SoftKeyboardInterceptionModifierNode) node4).mo69369onInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                            return true;
                        }
                    } else if ((node4.getKindSet$ui_release() & m73145constructorimpl2) != 0 && (node4 instanceof DelegatingNode)) {
                        int i6 = 0;
                        for (Modifier.Node delegate$ui_release4 = ((DelegatingNode) node4).getDelegate$ui_release(); delegate$ui_release4 != null; delegate$ui_release4 = delegate$ui_release4.getChild$ui_release()) {
                            if ((delegate$ui_release4.getKindSet$ui_release() & m73145constructorimpl2) != 0) {
                                i6++;
                                if (i6 == 1) {
                    ...
                    node4 = DelegatableNodeKt.m59459b(mutableVector4);
                }
                if (arrayList != null) {
                    int size = arrayList.size();
                    for (int i7 = 0; i7 < size; i7++) {
                        if (((SoftKeyboardInterceptionModifierNode) arrayList.get(i7)).mo69369onInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                            return true;
                        }
                    }
                }
    ...
    public boolean mo71636dispatchKeyEventZmokQxo(@NotNull KeyEvent keyEvent) {
        int i;
        NodeChain nodes$ui_release;
        Modifier.Node node;
        NodeChain nodes$ui_release2;
        ...
        FocusTargetNode findActiveFocusNode = FocusTraversalKt.findActiveFocusNode(this.f29006a);
        if (findActiveFocusNode != null) {
            Modifier.Node m59776a = m59776a(findActiveFocusNode);
            if (m59776a == null) {
                int m73145constructorimpl = NodeKind.m73145constructorimpl(8192);
                if (findActiveFocusNode.getNode().isAttached()) {
                    Modifier.Node parent$ui_release = findActiveFocusNode.getNode().getParent$ui_release();
                    LayoutNode requireLayoutNode = DelegatableNodeKt.requireLayoutNode(findActiveFocusNode);
                    loop0: while (true) {
                    ...
                    if (keyInputModifierNode != null) {
                        m59776a = keyInputModifierNode.getNode();
                    } else {
                        m59776a = null;
                    }
                } else {
            ...
            if (m59776a != null) {
                int m73145constructorimpl2 = NodeKind.m73145constructorimpl(8192);
                if (m59776a.getNode().isAttached()) {
                    Modifier.Node parent$ui_release2 = m59776a.getNode().getParent$ui_release();
                    LayoutNode requireLayoutNode2 = DelegatableNodeKt.requireLayoutNode(m59776a);
                    ArrayList arrayList = null;
                    while (requireLayoutNode2 != null) {
                        if ((requireLayoutNode2.getNodes$ui_release().getHead$ui_release().getAggregateChildKindSet$ui_release() & m73145constructorimpl2) != 0) {
                            while (parent$ui_release2 != null) {
                    ...
                    if (arrayList != null && arrayList.size() - 1 >= 0) {
                        while (true) {
                            int i4 = i - 1;
                            if (((KeyInputModifierNode) arrayList.get(i)).mo69366onPreKeyEventZmokQxo(keyEvent)) {
                                return true;
                            }
                            if (i4 < 0) {
                                break;
                    ...
                    Modifier.Node node3 = m59776a.getNode();
                    MutableVector mutableVector3 = null;
                    while (node3 != null) {
                        if (node3 instanceof KeyInputModifierNode) {
                            if (((KeyInputModifierNode) node3).mo69366onPreKeyEventZmokQxo(keyEvent)) {
                                return true;
                            }
                        } else if ((node3.getKindSet$ui_release() & m73145constructorimpl2) != 0 && (node3 instanceof DelegatingNode)) {
                            int i5 = 0;
                    ...
                    Modifier.Node node4 = m59776a.getNode();
                    MutableVector mutableVector4 = null;
                    while (node4 != null) {
                        if (node4 instanceof KeyInputModifierNode) {
                            if (((KeyInputModifierNode) node4).mo69365onKeyEventZmokQxo(keyEvent)) {
                                return true;
                            }
                        } else if ((node4.getKindSet$ui_release() & m73145constructorimpl2) != 0 && (node4 instanceof DelegatingNode)) {
                            int i6 = 0;
                    ...
                    if (arrayList != null) {
                        int size = arrayList.size();
                        for (int i7 = 0; i7 < size; i7++) {
                            if (((KeyInputModifierNode) arrayList.get(i7)).mo69365onKeyEventZmokQxo(keyEvent)) {
                                return true;
                            }
                        }
                    }
    ...
    public boolean dispatchRotaryEvent(@NotNull RotaryScrollEvent event) {
        ...
        FocusTargetNode findActiveFocusNode = FocusTraversalKt.findActiveFocusNode(this.f29006a);
        if (findActiveFocusNode != null) {
            int m73145constructorimpl = NodeKind.m73145constructorimpl(16384);
            if (findActiveFocusNode.getNode().isAttached()) {
                Modifier.Node parent$ui_release = findActiveFocusNode.getNode().getParent$ui_release();
                LayoutNode requireLayoutNode = DelegatableNodeKt.requireLayoutNode(findActiveFocusNode);
                loop0: while (true) {
        ...
        if (rotaryInputModifierNode != null) {
            int m73145constructorimpl2 = NodeKind.m73145constructorimpl(16384);
    ...
    public boolean mo71634moveFocus3ESFkO8(int i) {
        FocusTargetNode findActiveFocusNode = FocusTraversalKt.findActiveFocusNode(this.f29006a);
        if (findActiveFocusNode == null) {
            return false;
        }
        FocusRequester m71645customFocusSearchOMvw8 = FocusTraversalKt.m71645customFocusSearchOMvw8(findActiveFocusNode, i, getLayoutDirection());
        FocusRequester.Companion companion = FocusRequester.Companion;
        if (m71645customFocusSearchOMvw8 != companion.getDefault()) {
            if (m71645customFocusSearchOMvw8 == companion.getCancel() || !m71645customFocusSearchOMvw8.focus$ui_release()) {
                return false;
            }
            return true;
        }
        Ref.BooleanRef booleanRef = new Ref.BooleanRef();
        boolean m71646focusSearchsMXa3k8 = FocusTraversalKt.m71646focusSearchsMXa3k8(this.f29006a, i, getLayoutDirection(), new FocusOwnerImpl$moveFocus$foundNextItem$1(findActiveFocusNode, i, booleanRef));
        if (booleanRef.element) {
            return false;
        }
        if (!m71646focusSearchsMXa3k8 && !m59775b(i)) {
            return false;
        }
        return true;
    }
    ...
    public void releaseFocus() {
        FocusTransactionsKt.clearFocus(this.f29006a, true, true);
    }

    @Override // androidx.compose.p003ui.focus.FocusOwner
    public void scheduleInvalidation(@NotNull FocusTargetNode node) {
        Intrinsics.checkNotNullParameter(node, "node");
        this.f29007b.scheduleInvalidation(node);
    }
    ...
    public final void setRootFocusNode$ui_release(@NotNull FocusTargetNode focusTargetNode) {
        ...
        this.f29006a = focusTargetNode;
    }

    @Override // androidx.compose.p003ui.focus.FocusOwner
    public void takeFocus() {
        if (this.f29006a.getFocusState() == FocusStateImpl.Inactive) {
            this.f29006a.setFocusState(FocusStateImpl.Active);
        }
    }
    ...
    public void clearFocus(boolean z, boolean z2) {
        ...
        if (!z) {
            int i = WhenMappings.$EnumSwitchMapping$0[FocusTransactionsKt.m71643performCustomClearFocusMxy_nc0(this.f29006a, FocusDirection.Companion.m71626getExitdhqQ8s()).ordinal()];
            if (i == 1 || i == 2 || i == 3) {
                return;
            }
        }
        FocusStateImpl focusState = this.f29006a.getFocusState();
        if (FocusTransactionsKt.clearFocus(this.f29006a, z, z2)) {
            FocusTargetNode focusTargetNode = this.f29006a;
