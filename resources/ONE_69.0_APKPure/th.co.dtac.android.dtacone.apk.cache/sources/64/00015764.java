...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.home.HomeViewModel$getMrtrPrepaidReregistAuthorization$3 */
/* loaded from: classes9.dex */
public final class HomeViewModel$getMrtrPrepaidReregistAuthorization$3 extends Lambda implements Function1<GetAuthorizationByRtrResponse, Unit> {
    final /* synthetic */ HomeViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public HomeViewModel$getMrtrPrepaidReregistAuthorization$3(HomeViewModel homeViewModel) {
        super(1);
    ...
    public final void invoke2(GetAuthorizationByRtrResponse getAuthorizationByRtrResponse) {
        MutableLiveData m2603A;
        m2603A = this.this$0.m2603A();
        m2603A.setValue(Resource.Companion.success(getAuthorizationByRtrResponse));
    }
}