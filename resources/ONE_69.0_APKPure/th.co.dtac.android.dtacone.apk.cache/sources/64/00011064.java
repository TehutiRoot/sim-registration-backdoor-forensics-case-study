...
public final class OneNewsNotificationResponse {
    ...
    /* renamed from: e */
    private final OneNewsItem f81874e;
    @SerializedName("replaceMessage")
    @Nullable

    /* renamed from: f */
    private final List<String> f81875f;
    @SerializedName("desc")
    @Nullable
    ...
    public static /* synthetic */ OneNewsNotificationResponse copy$default(OneNewsNotificationResponse oneNewsNotificationResponse, String str, String str2, String str3, String str4, OneNewsItem oneNewsItem, List list, String str5, int i, Object obj) {
        if ((i & 1) != 0) {
            str = oneNewsNotificationResponse.f81870a;
        }
        if ((i & 2) != 0) {
            str2 = oneNewsNotificationResponse.f81871b;
        }
        String str6 = str2;
        if ((i & 4) != 0) {
            str3 = oneNewsNotificationResponse.f81872c;
        }
        String str7 = str3;
        if ((i & 8) != 0) {
            str4 = oneNewsNotificationResponse.f81873d;
        }
        String str8 = str4;
        if ((i & 16) != 0) {
            oneNewsItem = oneNewsNotificationResponse.f81874e;
        }
        OneNewsItem oneNewsItem2 = oneNewsItem;
        List<String> list2 = list;
        if ((i & 32) != 0) {
            list2 = oneNewsNotificationResponse.f81875f;
        }
        List list3 = list2;
        if ((i & 64) != 0) {
            str5 = oneNewsNotificationResponse.f81876g;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof OneNewsNotificationResponse) {
            ...
            return Intrinsics.areEqual(this.f81870a, oneNewsNotificationResponse.f81870a) && Intrinsics.areEqual(this.f81871b, oneNewsNotificationResponse.f81871b) && Intrinsics.areEqual(this.f81872c, oneNewsNotificationResponse.f81872c) && Intrinsics.areEqual(this.f81873d, oneNewsNotificationResponse.f81873d) && Intrinsics.areEqual(this.f81874e, oneNewsNotificationResponse.f81874e) && Intrinsics.areEqual(this.f81875f, oneNewsNotificationResponse.f81875f) && Intrinsics.areEqual(this.f81876g, oneNewsNotificationResponse.f81876g);
        }
        return false;
    }
    ...
    public int hashCode() {
        String str = this.f81870a;
        int hashCode = (str == null ? 0 : str.hashCode()) * 31;
        String str2 = this.f81871b;
        int hashCode2 = (hashCode + (str2 == null ? 0 : str2.hashCode())) * 31;
        String str3 = this.f81872c;
        int hashCode3 = (hashCode2 + (str3 == null ? 0 : str3.hashCode())) * 31;
        String str4 = this.f81873d;
        int hashCode4 = (hashCode3 + (str4 == null ? 0 : str4.hashCode())) * 31;
        OneNewsItem oneNewsItem = this.f81874e;
        int hashCode5 = (hashCode4 + (oneNewsItem == null ? 0 : oneNewsItem.hashCode())) * 31;
        List<String> list = this.f81875f;
        int hashCode6 = (hashCode5 + (list == null ? 0 : list.hashCode())) * 31;
        String str5 = this.f81876g;
