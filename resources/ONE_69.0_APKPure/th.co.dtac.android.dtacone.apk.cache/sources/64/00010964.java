...
public abstract class MainThreadSubscription implements Subscription {
    ...
    /* renamed from: a */
    public final AtomicBoolean f77905a = new AtomicBoolean();

    /* renamed from: rx.android.MainThreadSubscription$a */
    /* loaded from: classes5.dex */
    public class C13398a implements Action0 {
        public C13398a() {
        }
    ...
    public final void unsubscribe() {
        if (this.f77905a.compareAndSet(false, true)) {
            if (Looper.myLooper() == Looper.getMainLooper()) {
                onUnsubscribe();
            } else {
                AndroidSchedulers.mainThread().createWorker().schedule(new C13398a());
            }
        }
    }
}