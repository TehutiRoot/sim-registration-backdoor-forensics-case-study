...
public final class CustomerInfoAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public static final class ViewHolder extends RecyclerView.ViewHolder {
        ...
        /* renamed from: a */
        public final BlacklistCustomerInfoItemBinding f81199a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public ViewHolder(@NotNull BlacklistCustomerInfoItemBinding binding) {
            super(binding.getRoot());
            Intrinsics.checkNotNullParameter(binding, "binding");
            this.f81199a = binding;
        }

        /* renamed from: b */
        public static /* synthetic */ void m20577b(Function1 function1, BCustInfo bCustInfo, View view) {
            m20576c(function1, bCustInfo, view);
        }

        /* renamed from: c */
        public static final void m20576c(Function1 listener, BCustInfo item, View view) {
        ...
        public final void bind(@NotNull final BCustInfo item, @NotNull final Function1<? super String, Unit> listener, @NotNull Function1<? super Boolean, Unit> hasRefresh) {
            ...
            this.f81199a.textViewCustomerNumber.setText(item.getCustomerNumber());
            if (item.isLoading()) {
                Intrinsics.checkNotNullExpressionValue(bind$lambda$4, "bind$lambda$4");
                m20573f(bind$lambda$4);
            } else {
                Intrinsics.checkNotNullExpressionValue(bind$lambda$4, "bind$lambda$4");
                m20572g(bind$lambda$4);
            }
            if (item.getBlacklistAmount() != null) {
                m20575d(bind$lambda$4);
                m20574e(bind$lambda$4);
            } else {
            ...
            if (blacklistAmount != null) {
                DtacFontTextView dtacFontTextView = this.f81199a.valueBlacklistPay;
            ...
            if (unit == null) {
                Group group = this.f81199a.amountGroup;
            ...
            if (blacklistOtherChange != null) {
                DtacFontTextView dtacFontTextView2 = this.f81199a.valueFine;
            ...
            if (unit2 == null) {
                Group group2 = this.f81199a.otherChangeGroup;
            ...
            if (blacklistNetAmount != null) {
                DtacFontTextView dtacFontTextView3 = this.f81199a.valueBlacklistTotal;
            ...
            if (unit3 == null) {
                Group group3 = this.f81199a.netAmountGroup;
            ...
            bind$lambda$4.setOnClickListener(new View.OnClickListener() { // from class: mB
                ...
                public final void onClick(View view) {
                    CustomerInfoAdapter.ViewHolder.m20577b(Function1.this, item, view);
                }
            });
        }

        /* renamed from: d */
        public final void m20575d(View view) {
            ShimmerFrameLayout shimmerFrameLayout = this.f81199a.shimmerAmount;
            Intrinsics.checkNotNullExpressionValue(shimmerFrameLayout, "binding.shimmerAmount");
            ShimmerExtenKt.finish(shimmerFrameLayout);
            ShimmerFrameLayout shimmerFrameLayout2 = this.f81199a.shimmerOtherChange;
            ...
            ShimmerFrameLayout shimmerFrameLayout3 = this.f81199a.shimmerNetAmount;
        ...
        /* renamed from: e */
        public final void m20574e(View view) {
            Group group = this.f81199a.amountGroup;
            Intrinsics.checkNotNullExpressionValue(group, "binding.amountGroup");
        ...
        /* renamed from: f */
        public final void m20573f(View view) {
            ShimmerFrameLayout shimmerFrameLayout = this.f81199a.shimmerAmount;
            Intrinsics.checkNotNullExpressionValue(shimmerFrameLayout, "binding.shimmerAmount");
            ViewVisibleExtKt.toVisible(shimmerFrameLayout);
            this.f81199a.shimmerAmount.startShimmer();
            ShimmerFrameLayout shimmerFrameLayout2 = this.f81199a.shimmerOtherChange;
            Intrinsics.checkNotNullExpressionValue(shimmerFrameLayout2, "binding.shimmerOtherChange");
            ViewVisibleExtKt.toVisible(shimmerFrameLayout2);
            this.f81199a.shimmerOtherChange.startShimmer();
            ShimmerFrameLayout shimmerFrameLayout3 = this.f81199a.shimmerNetAmount;
            Intrinsics.checkNotNullExpressionValue(shimmerFrameLayout3, "binding.shimmerNetAmount");
            ViewVisibleExtKt.toVisible(shimmerFrameLayout3);
            this.f81199a.shimmerNetAmount.startShimmer();
        }

        /* renamed from: g */
        public final void m20572g(View view) {
            ShimmerFrameLayout shimmerFrameLayout = this.f81199a.shimmerAmount;
            Intrinsics.checkNotNullExpressionValue(shimmerFrameLayout, "binding.shimmerAmount");
            ViewVisibleExtKt.toVisible(shimmerFrameLayout);
            this.f81199a.shimmerAmount.stopShimmer();
            ShimmerFrameLayout shimmerFrameLayout2 = this.f81199a.shimmerOtherChange;
            Intrinsics.checkNotNullExpressionValue(shimmerFrameLayout2, "binding.shimmerOtherChange");
            ViewVisibleExtKt.toVisible(shimmerFrameLayout2);
            this.f81199a.shimmerOtherChange.stopShimmer();
            ShimmerFrameLayout shimmerFrameLayout3 = this.f81199a.shimmerNetAmount;
            Intrinsics.checkNotNullExpressionValue(shimmerFrameLayout3, "binding.shimmerNetAmount");
            ViewVisibleExtKt.toVisible(shimmerFrameLayout3);
            this.f81199a.shimmerNetAmount.stopShimmer();
        }
    }
    ...
    public CustomerInfoAdapter(@NotNull List<BCustInfo> items, @NotNull Function1<? super String, Unit> listener, @NotNull Function1<? super Boolean, Unit> hasRefresh) {
        ...
        Intrinsics.checkNotNullParameter(hasRefresh, "hasRefresh");
        this.f81196a = items;
        this.f81197b = listener;
        this.f81198c = hasRefresh;
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemCount() {
        return this.f81196a.size();
    }
    ...
    public final void loadingState() {
        for (BCustInfo bCustInfo : this.f81196a) {
    ...
    public void onBindViewHolder(@NotNull ViewHolder viewHolder, int i) {
        ...
        viewHolder.bind((BCustInfo) this.f81196a.get(i), this.f81197b, this.f81198c);
    }
