...
public final class PDJPXColorSpace extends PDColorSpace {
    ...
    /* renamed from: a */
    public final ColorSpace f60482a;

    public PDJPXColorSpace(ColorSpace colorSpace) {
        this.f60482a = colorSpace;
    }
    ...
    public float[] getDefaultDecode(int i) {
        ...
        if (Build.VERSION.SDK_INT > 26) {
            ...
            for (int i2 = 0; i2 < numberOfComponents; i2++) {
                int i3 = i2 * 2;
                minValue = this.f60482a.getMinValue(i2);
                fArr[i3] = minValue;
                maxValue = this.f60482a.getMaxValue(i2);
                fArr[i3 + 1] = maxValue;
            }
            return fArr;
        }
    ...
    public int getNumberOfComponents() {
        int componentCount;
        if (Build.VERSION.SDK_INT > 26) {
            componentCount = this.f60482a.getComponentCount();
    ...
    public Bitmap toRGBImage(Bitmap bitmap) throws IOException {
        Bitmap createBitmap;
        if (Build.VERSION.SDK_INT > 26) {
            createBitmap = Bitmap.createBitmap(bitmap.getWidth(), bitmap.getHeight(), Bitmap.Config.RGB_565, false, this.f60482a);
