...
public enum zzb {
    ...
    DEBUG("debug"),
    DEBUG_MODE_METADATA("debug_mode_metadata"),
    DECODE("decode"),
    ...
    DIMENSION(TypedValues.Custom.S_DIMENSION),
    ...
    NUMBER("number"),
    ONCE_ON_LOAD("once_on_load"),
    ONCE_PER_EVENT("once_per_event"),
    ONCE_PER_LOAD("once_per_load"),
    OPTOUT("optout"),
    OPT_AUDIENCE_TARGETING_RULE("opt_audience_targeting_rule"),
    ORDER("order"),
    ORDER_ID("order_id"),
    ...
    RESPECTED_CONSENT_TYPES("respected_consent_types"),
    REVENUE("revenue"),
