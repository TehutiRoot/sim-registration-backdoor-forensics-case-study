...
public final class ListItemKt$ListItem$decoratedTrailingContent$1$1 extends Lambda implements Function3<RowScope, Composer, Integer, Unit> {
    ...
    public final void invoke(@NotNull RowScope rowScope, @Nullable Composer composer, int i) {
        ...
        ListItemKt.m60577d(rowScope, this.$colors.trailingIconColor$material3_release(true, composer, ((this.$$dirty >> 15) & 112) | 6).getValue().m71929unboximpl(), ListItemType.m60572e(this.$listItemType, ListItemType.f25946a.m70637getThreeLineAlXitO8()), this.$it, composer, i & 14);
        if (ComposerKt.isTraceInProgress()) {
