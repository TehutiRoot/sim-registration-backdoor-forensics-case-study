...
@SourceDebugExtension({"SMAP\nInputInfoScreen.kt\nKotlin\n*S Kotlin\n*F\n+ 1 InputInfoScreen.kt\nth/co/dtac/android/dtacone/view/appOne/tol/screen/inputInfo/InputInfoScreenKt$InputInfoScreen$4\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,1296:1\n1559#2:1297\n1590#2,4:1298\n*S KotlinDebug\n*F\n+ 1 InputInfoScreen.kt\nth/co/dtac/android/dtacone/view/appOne/tol/screen/inputInfo/InputInfoScreenKt$InputInfoScreen$4\n*L\n185#1:1297\n185#1:1298,4\n*E\n"})
/* renamed from: th.co.dtac.android.dtacone.view.appOne.tol.screen.inputInfo.InputInfoScreenKt$InputInfoScreen$4 */
/* loaded from: classes10.dex */
public final class InputInfoScreenKt$InputInfoScreen$4 extends Lambda implements Function1<Province, Unit> {
    ...
    public InputInfoScreenKt$InputInfoScreen$4(Function1<? super CustomerInformation, Unit> function1, CustomerInformation customerInformation, MutableState<AddressSelectType> mutableState) {
        super(1);
    ...
    public final void invoke2(@NotNull Province it) {
        ...
        for (Object obj : addressList) {
            ...
            if (i == customerInformation2.getAddressType().ordinal()) {
                customerInfoAddress = CustomerInfoAddress.copy$default(customerInfoAddress, null, null, "", "", it.getName(), "", 3, null);
            }
        ...
        InputInfoScreenKt.m9503r(this.$targetSheet$delegate, AddressSelectType.DISTRICT);
    }
}