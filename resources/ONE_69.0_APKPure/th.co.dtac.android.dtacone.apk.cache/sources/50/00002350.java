...
public final class PropertyValuesHolder2D extends PropertyValuesHolder<Pair<? extends Float, ? extends Float>> {
    ...
    public PropertyValuesHolder2D(@NotNull String xPropertyName, @NotNull String yPropertyName, @NotNull List<? extends PathNode> pathData, @NotNull Easing interpolator) {
        ...
        this.f12799a = xPropertyName;
        this.f12800b = yPropertyName;
        this.f12801c = pathData;
        this.f12802d = interpolator;
    }
    ...
    public static /* synthetic */ PropertyValuesHolder2D copy$default(PropertyValuesHolder2D propertyValuesHolder2D, String str, String str2, List list, Easing easing, int i, Object obj) {
        if ((i & 1) != 0) {
            str = propertyValuesHolder2D.f12799a;
        }
        if ((i & 2) != 0) {
            str2 = propertyValuesHolder2D.f12800b;
        }
        if ((i & 4) != 0) {
            list = propertyValuesHolder2D.f12801c;
        }
        if ((i & 8) != 0) {
            easing = propertyValuesHolder2D.f12802d;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof PropertyValuesHolder2D) {
            ...
            return Intrinsics.areEqual(this.f12799a, propertyValuesHolder2D.f12799a) && Intrinsics.areEqual(this.f12800b, propertyValuesHolder2D.f12800b) && Intrinsics.areEqual(this.f12801c, propertyValuesHolder2D.f12801c) && Intrinsics.areEqual(this.f12802d, propertyValuesHolder2D.f12802d);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((this.f12799a.hashCode() * 31) + this.f12800b.hashCode()) * 31) + this.f12801c.hashCode()) * 31) + this.f12802d.hashCode();
    }

    @NotNull
    public String toString() {
        return "PropertyValuesHolder2D(xPropertyName=" + this.f12799a + ", yPropertyName=" + this.f12800b + ", pathData=" + this.f12801c + ", interpolator=" + this.f12802d + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
}