...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_prepaid_multi_sim.MrtrPrepaidMultiSimViewModel$validateBarcode$2 */
/* loaded from: classes9.dex */
public final class MrtrPrepaidMultiSimViewModel$validateBarcode$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ MrtrPrepaidMultiSimViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrPrepaidMultiSimViewModel$validateBarcode$2(MrtrPrepaidMultiSimViewModel mrtrPrepaidMultiSimViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable it) {
        ...
        mrtrErrorService.handleException(it, new MrtrErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.viewmodel.mrtr_prepaid_multi_sim.MrtrPrepaidMultiSimViewModel$validateBarcode$2.1
            ...
            public void handle(@Nullable Throwable th2) {
                ...
                m2097V = MrtrPrepaidMultiSimViewModel.this.m2097V();
