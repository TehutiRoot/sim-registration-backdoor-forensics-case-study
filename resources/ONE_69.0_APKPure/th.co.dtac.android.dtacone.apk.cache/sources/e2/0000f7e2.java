...
class Utils {
    ...
    static {
        ...
        hashtable.put("SHA-224", Integers.valueOf(CertificateHolderAuthorization.CVCA));
        ...
        hashtable.put(MessageDigestAlgorithms.SHA_512_224, Integers.valueOf(CertificateHolderAuthorization.CVCA));
