...
public final class ExtraAdvanceAdapter extends ListAdapter<PackagePriceTierResponse.ExtraAdvance, ExtraAdvanceViewHolder> {
    ...
    @Metadata(m29143d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0006\b\u0086\u0004\u0018\u00002\u00020\u00012\u00020\u0002B\u000f\u0012\u0006\u0010\u0004\u001a\u00020\u0003¢\u0006\u0004\b\u0005\u0010\u0006J\u0019\u0010\n\u001a\u00020\t2\b\u0010\b\u001a\u0004\u0018\u00010\u0007H\u0016¢\u0006\u0004\b\n\u0010\u000bJ\u001d\u0010\u0010\u001a\u00020\t2\u0006\u0010\r\u001a\u00020\f2\u0006\u0010\u000f\u001a\u00020\u000e¢\u0006\u0004\b\u0010\u0010\u0011R\u0014\u0010\u0004\u001a\u00020\u00038\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0012\u0010\u0013¨\u0006\u0014"}, m29142d2 = {"Lth/co/dtac/android/dtacone/adapter/postpaid_register/ExtraAdvanceAdapter$ExtraAdvanceViewHolder;", "Landroidx/recyclerview/widget/RecyclerView$ViewHolder;", "Landroid/view/View$OnClickListener;", "Lth/co/dtac/android/dtacone/databinding/ItemExtraAdvanceBinding;", "binding", "<init>", "(Lth/co/dtac/android/dtacone/adapter/postpaid_register/ExtraAdvanceAdapter;Lth/co/dtac/android/dtacone/databinding/ItemExtraAdvanceBinding;)V", "Landroid/view/View;", OperatorName.CURVE_TO_REPLICATE_INITIAL_POINT, "", "onClick", "(Landroid/view/View;)V", "Lth/co/dtac/android/dtacone/model/blacklist/PackagePriceTierResponse$ExtraAdvance;", "item", "", "position", "bind", "(Lth/co/dtac/android/dtacone/model/blacklist/PackagePriceTierResponse$ExtraAdvance;I)V", PDPageLabelRange.STYLE_LETTERS_LOWER, "Lth/co/dtac/android/dtacone/databinding/ItemExtraAdvanceBinding;", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0})
    ...
    public final class ExtraAdvanceViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        /* renamed from: a */
        public final ItemExtraAdvanceBinding f81490a;

        /* renamed from: b */
        public final /* synthetic */ ExtraAdvanceAdapter f81491b;
        ...
        public ExtraAdvanceViewHolder(@NotNull ExtraAdvanceAdapter extraAdvanceAdapter, ItemExtraAdvanceBinding binding) {
            ...
            this.f81491b = extraAdvanceAdapter;
            this.f81490a = binding;
            this.itemView.setOnClickListener(this);
        }

        public final void bind(@NotNull PackagePriceTierResponse.ExtraAdvance item, int i) {
            Intrinsics.checkNotNullParameter(item, "item");
            this.f81490a.tvPriceRange.setText(item.getRrpText());
            this.f81490a.tvPrice.setText(item.getExtraAdvance2());
            if (i % 2 != 0) {
                this.f81490a.itemContainer.setBackgroundColor(-1);
            }
        }
        ...
        public void onClick(@Nullable View view) {
            ...
            ExtraAdvanceAdapter.access$getItem(this.f81491b, getAdapterPosition());
        }
    }

    /* renamed from: th.co.dtac.android.dtacone.adapter.postpaid_register.ExtraAdvanceAdapter$a */
    /* loaded from: classes7.dex */
    public static final class C14131a extends DiffUtil.ItemCallback {
