...
/* renamed from: jp.co.cyberagent.android.gpuimage.GPUImageHueFilter */
...
public class GPUImageHueFilter extends GPUImageFilter {
    ...
    public void onInit() {
        super.onInit();
        this.f67577f = GLES20.glGetUniformLocation(getProgram(), "hueAdjust");
    }
    ...
    public void setHue(float f) {
        this.f67576e = f;
        setFloat(this.f67577f, ((f % 360.0f) * 3.1415927f) / 180.0f);
    }
