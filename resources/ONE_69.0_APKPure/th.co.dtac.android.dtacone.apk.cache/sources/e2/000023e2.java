...
public final class MagnifierKt$magnifier$4$sourceCenterInRoot$2$1 extends Lambda implements Function0<Offset> {
    ...
    public /* bridge */ /* synthetic */ Offset invoke() {
        return Offset.m71675boximpl(m69551invokeF1C5BW0());
    }

    /* renamed from: invoke-F1C5BW0  reason: not valid java name */
    public final long m69551invokeF1C5BW0() {
        Function1 invoke$lambda$3;
        invoke$lambda$3 = MagnifierKt$magnifier$4.invoke$lambda$3(this.$updatedSourceCenter$delegate);
        long m71696unboximpl = ((Offset) invoke$lambda$3.invoke(this.$density)).m71696unboximpl();
        if (OffsetKt.m71705isSpecifiedk4lQ0M(MagnifierKt$magnifier$4.invoke$lambda$1(this.$anchorPositionInRoot$delegate)) && OffsetKt.m71705isSpecifiedk4lQ0M(m71696unboximpl)) {
            return Offset.m71691plusMKHz9U(MagnifierKt$magnifier$4.invoke$lambda$1(this.$anchorPositionInRoot$delegate), m71696unboximpl);
        }
