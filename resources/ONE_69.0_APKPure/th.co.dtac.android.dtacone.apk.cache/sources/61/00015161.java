...
/* renamed from: th.co.dtac.android.dtacone.view.fragment.mrtr_prepaid_registration.common.MrtrPrepaidNavigateToCommonFragment$initView$1$4 */
/* loaded from: classes9.dex */
public final class MrtrPrepaidNavigateToCommonFragment$initView$1$4 extends Lambda implements Function1<Resource<? extends ErrorCollection>, Unit> {
    final /* synthetic */ MrtrPrepaidNavigateToCommonFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrPrepaidNavigateToCommonFragment$initView$1$4(MrtrPrepaidNavigateToCommonFragment mrtrPrepaidNavigateToCommonFragment) {
        super(1);
    ...
    public final void invoke2(Resource<ErrorCollection> resource) {
        ...
        MrtrPrepaidNavigateToCommonFragment mrtrPrepaidNavigateToCommonFragment = this.this$0;
        if (resourceContentIfNotHandled.getStatus() == StatusResource.ERROR) {
            mrtrPrepaidNavigateToCommonFragment.m4809t();
        }
    }
}