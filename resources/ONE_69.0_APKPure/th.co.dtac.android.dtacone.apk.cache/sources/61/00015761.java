...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.home.HomeViewModel$getMrtrPrepaidMultiSimAuthorization$3 */
/* loaded from: classes9.dex */
public final class HomeViewModel$getMrtrPrepaidMultiSimAuthorization$3 extends Lambda implements Function1<GetAuthorizationByRtrResponse, Unit> {
    final /* synthetic */ String $featureCode;
    final /* synthetic */ HomeViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public HomeViewModel$getMrtrPrepaidMultiSimAuthorization$3(HomeViewModel homeViewModel, String str) {
        super(1);
    ...
    public final void invoke2(GetAuthorizationByRtrResponse getAuthorizationByRtrResponse) {
        ...
        MutableLiveData m2574z;
        m2579u = this.this$0.m2579u();
        m2579u.setValue(this.$featureCode);
        m2574z = this.this$0.m2574z();
        m2574z.setValue(Resource.Companion.success(getAuthorizationByRtrResponse));
    }
}