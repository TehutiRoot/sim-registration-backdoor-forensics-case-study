...
public class SwitchMaterial extends SwitchCompat {
    ...
    /* renamed from: b0 */
    public static final int f50901b0 = R.style.Widget_MaterialComponents_CompoundButton_Switch;

    /* renamed from: c0 */
    public static final int[][] f50902c0 = {new int[]{16842910, 16842912}, new int[]{16842910, -16842912}, new int[]{-16842910, 16842912}, new int[]{-16842910, -16842912}};

    /* renamed from: U */
    public final ElevationOverlayProvider f50903U;

    /* renamed from: V */
    public ColorStateList f50904V;

    /* renamed from: W */
    public ColorStateList f50905W;

    /* renamed from: a0 */
    public boolean f50906a0;
    ...
    private ColorStateList getMaterialThemeColorsThumbTintList() {
        if (this.f50904V == null) {
            ...
            if (this.f50903U.isThemeElevationOverlayEnabled()) {
                dimension += ViewUtils.getParentAbsoluteElevation(this);
            }
            int compositeOverlayIfNeeded = this.f50903U.compositeOverlayIfNeeded(color, dimension);
            int[][] iArr = f50902c0;
            ...
            this.f50904V = new ColorStateList(iArr, iArr2);
        }
        return this.f50904V;
    }
    ...
    private ColorStateList getMaterialThemeColorsTrackTintList() {
        if (this.f50905W == null) {
            ...
            this.f50905W = new ColorStateList(iArr, iArr2);
        }
        return this.f50905W;
    }

    public boolean isUseMaterialThemeColors() {
        return this.f50906a0;
    }

    @Override // android.widget.TextView, android.view.View
    public void onAttachedToWindow() {
        super.onAttachedToWindow();
        if (this.f50906a0 && getThumbTintList() == null) {
            setThumbTintList(getMaterialThemeColorsThumbTintList());
        }
        if (this.f50906a0 && getTrackTintList() == null) {
    ...
    */
    public SwitchMaterial(@androidx.annotation.NonNull android.content.Context r7, @androidx.annotation.Nullable android.util.AttributeSet r8, int r9) {
        /*
            r6 = this;
            int r4 = com.google.android.material.switchmaterial.SwitchMaterial.f50901b0
