...
public class BCECGOST3410PrivateKey implements ECPrivateKey, org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    /* renamed from: d */
    private transient BigInteger f75351d;
    ...
    */
    public byte[] getEncoded() {
        ...
        Lc5:
            ...
            r4.<init>(r0, r5, r3)
        Lce:
            org.bouncycastle.asn1.pkcs.PrivateKeyInfo r0 = new org.bouncycastle.asn1.pkcs.PrivateKeyInfo     // Catch: java.io.IOException -> Le7
            org.bouncycastle.asn1.x509.AlgorithmIdentifier r5 = new org.bouncycastle.asn1.x509.AlgorithmIdentifier     // Catch: java.io.IOException -> Le7
            org.bouncycastle.asn1.ASN1ObjectIdentifier r6 = org.bouncycastle.asn1.cryptopro.CryptoProObjectIdentifiers.gostR3410_2001     // Catch: java.io.IOException -> Le7
            org.bouncycastle.asn1.ASN1Primitive r3 = r3.toASN1Primitive()     // Catch: java.io.IOException -> Le7
            r5.<init>(r6, r3)     // Catch: java.io.IOException -> Le7
            org.bouncycastle.asn1.ASN1Primitive r3 = r4.toASN1Primitive()     // Catch: java.io.IOException -> Le7
            r0.<init>(r5, r3)     // Catch: java.io.IOException -> Le7
            byte[] r0 = r0.getEncoded(r1)     // Catch: java.io.IOException -> Le7
            return r0
        Le7:
            return r2
        */
    ...
    public String toString() {
        return ECUtil.privateKeyToString(this.algorithm, this.f75351d, engineGetSpec());
    }
    ...
    public BCECGOST3410PrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f75351d = eCPrivateKeyParameters.getD();
        this.ecSpec = null;
    }
    ...
    public BCECGOST3410PrivateKey(ECPrivateKey eCPrivateKey) {
        this.algorithm = "ECGOST3410";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f75351d = eCPrivateKey.getS();
    ...
    public BCECGOST3410PrivateKey(ECPrivateKeySpec eCPrivateKeySpec) {
        this.algorithm = "ECGOST3410";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f75351d = eCPrivateKeySpec.getS();
    ...
    public BCECGOST3410PrivateKey(BCECGOST3410PrivateKey bCECGOST3410PrivateKey) {
        this.algorithm = "ECGOST3410";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f75351d = bCECGOST3410PrivateKey.f75351d;
    ...
    public BCECGOST3410PrivateKey(org.bouncycastle.jce.spec.ECPrivateKeySpec eCPrivateKeySpec) {
        this.algorithm = "ECGOST3410";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f75351d = eCPrivateKeySpec.getD();
