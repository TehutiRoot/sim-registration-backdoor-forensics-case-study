...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.fragment.consent.OnePostpaidConsentTelcoFragment$initView$4$1 */
/* loaded from: classes10.dex */
public final class OnePostpaidConsentTelcoFragment$initView$4$1 extends Lambda implements Function1<FragmentNavEvent, Unit> {
    final /* synthetic */ OnePostpaidConsentTelcoFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidConsentTelcoFragment$initView$4$1(OnePostpaidConsentTelcoFragment onePostpaidConsentTelcoFragment) {
        super(1);
    ...
    public final void invoke2(@NotNull FragmentNavEvent it) {
        ...
        m12303n.replaceFragment(it.buildFragment(), it.getTag());
    }
}