...
public class setLayoutParams implements setDarkTextColor.valueOf {
    public static final setLayoutParams valueOf = new setLayoutParams();

    @Override // com.netcetera.threeds.sdk.infrastructure.setDarkTextColor.valueOf
    public getHeadingTextColor values() {
        return setDarkTextColor.setOnHoverListener();
    }
}