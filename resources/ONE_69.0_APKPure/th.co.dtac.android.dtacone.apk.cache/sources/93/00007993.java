...
public class SSLSocketReceiver extends SocketReceiver implements SSLComponent {
    ...
    /* renamed from: l */
    public SSLConfiguration f39566l;

    /* renamed from: m */
    public SocketFactory f39567m;
    ...
    public SSLConfiguration getSsl() {
        if (this.f39566l == null) {
            this.f39566l = new SSLConfiguration();
        }
        return this.f39566l;
    }
    ...
    public boolean shouldStart() {
        try {
            ...
            this.f39567m = new ConfigurableSSLSocketFactory(parameters, createContext.getSocketFactory());
