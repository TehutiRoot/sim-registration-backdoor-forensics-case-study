...
public final class VectorComposeKt {
    ...
    */
    ...
    public static final void m72442Path9cdaXJ4(@NotNull List<? extends PathNode> pathData, int i, @Nullable String str, @Nullable Brush brush, float f, @Nullable Brush brush2, float f2, float f3, int i2, int i3, float f4, float f5, float f6, float f7, @Nullable Composer composer, int i4, int i5, int i6) {
        ...
        Updater.m71584setimpl(m71577constructorimpl, str2, VectorComposeKt$Path$2$1.INSTANCE);
        Updater.m71584setimpl(m71577constructorimpl, pathData, VectorComposeKt$Path$2$2.INSTANCE);
        Updater.m71584setimpl(m71577constructorimpl, PathFillType.m72152boximpl(defaultFillType), VectorComposeKt$Path$2$3.INSTANCE);
        Updater.m71584setimpl(m71577constructorimpl, brush3, VectorComposeKt$Path$2$4.INSTANCE);
        Updater.m71584setimpl(m71577constructorimpl, Float.valueOf(f8), VectorComposeKt$Path$2$5.INSTANCE);
        Updater.m71584setimpl(m71577constructorimpl, brush4, VectorComposeKt$Path$2$6.INSTANCE);
        Updater.m71584setimpl(m71577constructorimpl, Float.valueOf(f9), VectorComposeKt$Path$2$7.INSTANCE);
        Updater.m71584setimpl(m71577constructorimpl, Float.valueOf(f10), VectorComposeKt$Path$2$8.INSTANCE);
        Updater.m71584setimpl(m71577constructorimpl, StrokeJoin.m72230boximpl(defaultStrokeLineJoin), VectorComposeKt$Path$2$9.INSTANCE);
        Updater.m71584setimpl(m71577constructorimpl, StrokeCap.m72220boximpl(defaultStrokeLineCap), VectorComposeKt$Path$2$10.INSTANCE);
        Updater.m71584setimpl(m71577constructorimpl, Float.valueOf(f11), VectorComposeKt$Path$2$11.INSTANCE);
        Updater.m71584setimpl(m71577constructorimpl, Float.valueOf(f12), VectorComposeKt$Path$2$12.INSTANCE);
        Updater.m71584setimpl(m71577constructorimpl, Float.valueOf(f13), VectorComposeKt$Path$2$13.INSTANCE);
        Updater.m71584setimpl(m71577constructorimpl, Float.valueOf(f14), VectorComposeKt$Path$2$14.INSTANCE);
