...
public final class C3311x4d8b1701 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    /* loaded from: classes2.dex */
    public static final class C33121 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
        public static final C33121 INSTANCE = new C33121();
    ...
    public C3311x4d8b1701(WindowInsets windowInsets, State<? extends Function2<? super Composer, ? super Integer, Unit>> state) {
        super(2);
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        Modifier imePadding = WindowInsetsPadding_androidKt.imePadding(WindowInsetsPaddingKt.windowInsetsPadding(SemanticsModifierKt.semantics$default(Modifier.Companion, false, C33121.INSTANCE, 1, null), this.$windowInsets));
        ...
        m60566b = ModalBottomSheet_androidKt.m60566b(state);
        m60566b.invoke(composer, 0);
