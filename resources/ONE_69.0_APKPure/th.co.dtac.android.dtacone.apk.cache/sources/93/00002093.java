...
public abstract class AudioStats {
    ...
    /* renamed from: a */
    public static final Set f11702a = Collections.unmodifiableSet(new HashSet(Arrays.asList(2, 3, 4)));
    ...
    /* renamed from: b */
    public static AudioStats m62476b(int i, Throwable th2, double d) {
        return new C10430i8(i, d, th2);
    }

    /* renamed from: a */
    public abstract double mo31037a();
    ...
    public boolean hasError() {
        return f11702a.contains(Integer.valueOf(getAudioState()));
    }
}