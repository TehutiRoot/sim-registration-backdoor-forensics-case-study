...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.staff.viewmodel.OneStaffViewModel$callGetStaffDetail$4 */
/* loaded from: classes10.dex */
public final class OneStaffViewModel$callGetStaffDetail$4 extends Lambda implements Function1<OneStaffDetailResponse, Unit> {
    final /* synthetic */ OneStaffViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneStaffViewModel$callGetStaffDetail$4(OneStaffViewModel oneStaffViewModel) {
        super(1);
    ...
    public final void invoke2(OneStaffDetailResponse oneStaffDetailResponse) {
        MutableLiveData m9893D;
        this.this$0.getLiveDataState().setValue(StatusResource.DISMISS);
        m9893D = this.this$0.m9893D();
        m9893D.setValue(Resource.Companion.success(oneStaffDetailResponse));
    }
}