...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.fragment.OneMnpWriteSimFragment$setupViewModel$1$1 */
/* loaded from: classes10.dex */
public final class OneMnpWriteSimFragment$setupViewModel$1$1 extends Lambda implements Function1<Resource<? extends MnpCheckSimInfoResponse>, Unit> {
    final /* synthetic */ OneMnpWriteSimFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.fragment.OneMnpWriteSimFragment$setupViewModel$1$1$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneMnpWriteSimFragment$setupViewModel$1$1(OneMnpWriteSimFragment oneMnpWriteSimFragment) {
        super(1);
    ...
    public final void invoke2(Resource<MnpCheckSimInfoResponse> resource) {
        ...
        if (i == 1) {
            ...
            oneMnpWriteSimFragment.dismissLoading();
            MnpCheckSimInfoResponse data = resourceContentIfNotHandled.getData();
            if (data != null) {
                if (Intrinsics.areEqual(data.getDummyFlag(), "N")) {
                    oneMnpWriteSimFragment.gotoNext();
                } else {
                    oneMnpWriteSimFragment.getSimReaderPresenter().writeIMSI(data.getEncapADM(), data.getImsiNumber());
                }
            }
        }
    }
