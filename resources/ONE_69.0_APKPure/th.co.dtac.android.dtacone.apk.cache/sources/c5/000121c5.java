...
/* renamed from: th.co.dtac.android.dtacone.presenter.bitmap.SaveBitmapPresenter$saveBitmapFromSmartCard$3 */
/* loaded from: classes8.dex */
public final class SaveBitmapPresenter$saveBitmapFromSmartCard$3 extends Lambda implements Function1<Unit, Unit> {
    final /* synthetic */ SaveBitmapPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SaveBitmapPresenter$saveBitmapFromSmartCard$3(SaveBitmapPresenter saveBitmapPresenter) {
        super(1);
