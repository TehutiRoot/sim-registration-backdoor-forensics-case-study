...
public final class LazyJavaClassMemberScope$nestedClasses$1 extends Lambda implements Function1<Name, ClassDescriptor> {
    ...
    /* renamed from: $c */
    final /* synthetic */ LazyJavaResolverContext f69180$c;
    ...
    public LazyJavaClassMemberScope$nestedClasses$1(LazyJavaClassMemberScope lazyJavaClassMemberScope, LazyJavaResolverContext lazyJavaResolverContext) {
        ...
        this.f69180$c = lazyJavaResolverContext;
    }
    ...
    public final ClassDescriptor invoke(@NotNull Name name) {
        ...
        notNullLazyValue = this.this$0.f69174q;
        if (!((Set) notNullLazyValue.invoke()).contains(name)) {
            notNullLazyValue2 = this.this$0.f69175r;
            if (!((Set) notNullLazyValue2.invoke()).contains(name)) {
                notNullLazyValue3 = this.this$0.f69176s;
                JavaField javaField = (JavaField) ((Map) notNullLazyValue3.invoke()).get(name);
                if (javaField != null) {
                    return EnumEntrySyntheticClassDescriptor.create(this.f69180$c.getStorageManager(), this.this$0.getOwnerDescriptor(), name, this.f69180$c.getStorageManager().createLazyValue(new LazyJavaClassMemberScope$nestedClasses$1$enumMemberNames$1(this.this$0)), LazyJavaAnnotationsKt.resolveAnnotations(this.f69180$c, javaField), this.f69180$c.getComponents().getSourceElementFactory().source(javaField));
                }
                return null;
            }
            LazyJavaResolverContext lazyJavaResolverContext = this.f69180$c;
            LazyJavaClassMemberScope lazyJavaClassMemberScope = this.this$0;
            List<ClassDescriptor> createListBuilder = AbstractC10100ds.createListBuilder();
            ...
            List build = AbstractC10100ds.build(createListBuilder);
            int size = build.size();
            if (size != 0) {
                if (size == 1) {
        ...
        JavaClassFinder finder = this.f69180$c.getComponents().getFinder();
        ...
        if (findClass != null) {
            LazyJavaResolverContext lazyJavaResolverContext2 = this.f69180$c;
