...
public final class C12309mq extends TextFormat {

    /* renamed from: b */
    public static final List f72180b = Collections.singletonList("X-Cloud-Trace-Context");

    /* renamed from: c */
    public static final TraceOptions f72181c = TraceOptions.builder().setIsSampled(true).build();

    /* renamed from: d */
    public static final TraceOptions f72182d = TraceOptions.DEFAULT;

    /* renamed from: e */
    public static final int f72183e = 3;

    /* renamed from: f */
    public static final Tracestate f72184f = Tracestate.builder().build();

    /* renamed from: b */
    public static SpanId m26507b(long j) {
    ...
    /* renamed from: c */
    public static long m26506c(SpanId spanId) {
        ByteBuffer allocate = ByteBuffer.allocate(8);
    ...
    public SpanContext extract(Object obj, TextFormat.Getter getter) {
        ...
        try {
            ...
            if (str != null && str.length() >= 34) {
                ...
                SpanId m26507b = m26507b(UnsignedLongs.parseUnsignedLong(str.subSequence(33, i).toString(), 10));
                TraceOptions traceOptions = f72182d;
                if (indexOf > 0 && (UnsignedInts.parseUnsignedInt(str.substring(indexOf + f72183e), 10) & 1) != 0) {
                    traceOptions = f72181c;
                }
                return SpanContext.create(fromLowerBase16, m26507b, traceOptions, f72184f);
            }
    ...
    public void inject(SpanContext spanContext, Object obj, TextFormat.Setter setter) {
        ...
        sb.append('/');
        sb.append(UnsignedLongs.toString(m26506c(spanContext.getSpanId())));
        sb.append(";o=");
