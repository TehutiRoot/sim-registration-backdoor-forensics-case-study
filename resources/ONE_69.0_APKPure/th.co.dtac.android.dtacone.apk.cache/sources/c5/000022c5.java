...
public final class MutatorMutex {
    ...
    public static final class C2726a {
        ...
        /* renamed from: a */
        public final MutatePriority f12650a;

        /* renamed from: b */
        public final Job f12651b;

        public C2726a(MutatePriority priority, Job job) {
            Intrinsics.checkNotNullParameter(priority, "priority");
            Intrinsics.checkNotNullParameter(job, "job");
            this.f12650a = priority;
            this.f12651b = job;
        }

        /* renamed from: a */
        public final boolean m61642a(C2726a other) {
            Intrinsics.checkNotNullParameter(other, "other");
            if (this.f12650a.compareTo(other.f12650a) >= 0) {
                return true;
            }
            return false;
        }
        ...
        /* renamed from: b */
        public final void m61641b() {
            this.f12651b.cancel((CancellationException) new MutationInterruptedException());
        }
    }
    ...
    /* renamed from: a */
    public final void m61643a(C2726a c2726a) {
        C2726a c2726a2;
        do {
            c2726a2 = (C2726a) this.f12648a.get();
            if (c2726a2 != null && !c2726a.m61642a(c2726a2)) {
                throw new CancellationException("Current mutation had a higher priority");
            }
        } while (!AbstractC23094xo1.m479a(this.f12648a, c2726a2, c2726a));
        if (c2726a2 != null) {
            c2726a2.m61641b();
        }
    }
