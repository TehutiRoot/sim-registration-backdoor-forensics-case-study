...
public class setSystemGestureExclusionRects implements setDarkTextColor.valueOf {
    private final setDarkTextColor ThreeDS2ServiceInstance;

    public setSystemGestureExclusionRects(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.getSchemePublicRootKeys(this.ThreeDS2ServiceInstance);
    }
}