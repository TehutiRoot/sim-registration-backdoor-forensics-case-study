...
public final class AlignmentLineKt$alignmentLineOffsetMeasure$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke2(@NotNull Placeable.PlacementScope layout) {
        ...
        m61384b = AlignmentLineKt.m61384b(this.$alignmentLine);
        if (m61384b) {
            width = 0;
        } else {
            width = !C3623Dp.m73847equalsimpl0(this.$before, C3623Dp.Companion.m73862getUnspecifiedD9Ej5fM()) ? this.$paddingBefore : (this.$width - this.$paddingAfter) - this.$placeable.getWidth();
        }
        m61384b2 = AlignmentLineKt.m61384b(this.$alignmentLine);
        if (m61384b2) {
            height = !C3623Dp.m73847equalsimpl0(this.$before, C3623Dp.Companion.m73862getUnspecifiedD9Ej5fM()) ? this.$paddingBefore : (this.$height - this.$paddingAfter) - this.$placeable.getHeight();
        } else {
            height = 0;
        }
