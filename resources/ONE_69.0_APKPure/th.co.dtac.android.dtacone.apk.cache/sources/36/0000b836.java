...
public final class MultiFormatUPCEANReader extends OneDReader {
    ...
    /* renamed from: a */
    public final UPCEANReader[] f57890a;
    ...
    public MultiFormatUPCEANReader(Map<DecodeHintType, ?> map) {
        ...
        this.f57890a = (UPCEANReader[]) arrayList.toArray(new UPCEANReader[arrayList.size()]);
    }
    ...
    public Result decodeRow(int i, BitArray bitArray, Map<DecodeHintType, ?> map) throws NotFoundException {
        boolean z;
        Collection collection;
        int[] m34021f = UPCEANReader.m34021f(bitArray);
        boolean z2 = false;
        for (UPCEANReader uPCEANReader : this.f57890a) {
            try {
                Result decodeRow = uPCEANReader.decodeRow(i, bitArray, m34021f, map);
