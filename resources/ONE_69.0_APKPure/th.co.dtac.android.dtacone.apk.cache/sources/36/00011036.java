...
public final class OneGetAddressFromPostcodeResponse implements Parcelable {
    ...
    public static /* synthetic */ OneGetAddressFromPostcodeResponse copy$default(OneGetAddressFromPostcodeResponse oneGetAddressFromPostcodeResponse, String str, List list, Integer num, String str2, Integer num2, int i, Object obj) {
        if ((i & 1) != 0) {
            str = oneGetAddressFromPostcodeResponse.f81679a;
        }
        List<OneAmphoeResponse> list2 = list;
        if ((i & 2) != 0) {
            list2 = oneGetAddressFromPostcodeResponse.f81680b;
        }
        List list3 = list2;
        if ((i & 4) != 0) {
            num = oneGetAddressFromPostcodeResponse.f81681c;
        }
        Integer num3 = num;
        if ((i & 8) != 0) {
            str2 = oneGetAddressFromPostcodeResponse.f81682d;
        }
        String str3 = str2;
        if ((i & 16) != 0) {
            num2 = oneGetAddressFromPostcodeResponse.f81683e;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof OneGetAddressFromPostcodeResponse) {
            ...
            return Intrinsics.areEqual(this.f81679a, oneGetAddressFromPostcodeResponse.f81679a) && Intrinsics.areEqual(this.f81680b, oneGetAddressFromPostcodeResponse.f81680b) && Intrinsics.areEqual(this.f81681c, oneGetAddressFromPostcodeResponse.f81681c) && Intrinsics.areEqual(this.f81682d, oneGetAddressFromPostcodeResponse.f81682d) && Intrinsics.areEqual(this.f81683e, oneGetAddressFromPostcodeResponse.f81683e);
        }
        return false;
    }
    ...
    public int hashCode() {
        String str = this.f81679a;
        int hashCode = (str == null ? 0 : str.hashCode()) * 31;
        List<OneAmphoeResponse> list = this.f81680b;
        int hashCode2 = (hashCode + (list == null ? 0 : list.hashCode())) * 31;
        Integer num = this.f81681c;
        int hashCode3 = (hashCode2 + (num == null ? 0 : num.hashCode())) * 31;
        String str2 = this.f81682d;
        int hashCode4 = (hashCode3 + (str2 == null ? 0 : str2.hashCode())) * 31;
        Integer num2 = this.f81683e;
    ...
    public void writeToParcel(@NotNull Parcel parcel, int i) {
        Intrinsics.checkNotNullParameter(parcel, "parcel");
        parcel.writeString(this.f81679a);
        parcel.writeTypedList(this.f81680b);
        parcel.writeValue(this.f81681c);
        parcel.writeString(this.f81682d);
        parcel.writeValue(this.f81683e);
    }
