...
public class SingleClientConnManager implements ClientConnectionManager {
    ...
    public class C12598a implements ClientConnectionRequest {
        ...
        /* renamed from: a */
        public final /* synthetic */ HttpRoute f74385a;

        /* renamed from: b */
        public final /* synthetic */ Object f74386b;

        public C12598a(HttpRoute httpRoute, Object obj) {
            this.f74385a = httpRoute;
            this.f74386b = obj;
        }
        ...
        public ManagedClientConnection getConnection(long j, TimeUnit timeUnit) {
            return SingleClientConnManager.this.getConnection(this.f74385a, this.f74386b);
        }
    }
            ...
            if (this.managedConn == null && this.uniquePoolEntry.connection.isOpen()) {
                if (this.lastReleaseTime <= System.currentTimeMillis() - timeUnit.toMillis(j)) {
                    try {
                        ...
                        this.f74382a.debug("Problem closing idle connection.", e);
                    }
                }
            }
        }
    ...
    public ManagedClientConnection getConnection(HttpRoute httpRoute, Object obj) {
        ...
        assertStillUp();
        if (this.f74382a.isDebugEnabled()) {
            Log log = this.f74382a;
        ...
        synchronized (this) {
            ...
            if (z4) {
                try {
                    ...
                    this.f74382a.debug("Problem shutting down connection.", e);
                }
            } else {
                z5 = z2;
            }
            ...
            try {
                ...
                try {
                    if (connAdapter.isOpen()) {
                        ...
                        if (this.f74382a.isDebugEnabled()) {
                            this.f74382a.debug("Released connection open but not reusable.");
                        }
                    ...
                    if (this.f74382a.isDebugEnabled()) {
                        this.f74382a.debug("Exception shutting down released connection.", e);
                    }
                    connAdapter.detach();
                    synchronized (this) {
                        this.managedConn = null;
    ...
    public void revokeConnection() {
        ...
        synchronized (this) {
            try {
                ...
                this.f74382a.debug("Problem while shutting down connection.", e);
            }
        }
    }
    ...
    public void shutdown() {
        ...
        synchronized (this) {
            try {
                ...
                this.f74382a.debug("Problem while shutting down manager.", e);
                this.uniquePoolEntry = null;
            }
            this.managedConn = null;
        }
    ...
    public SingleClientConnManager(SchemeRegistry schemeRegistry) {
        this.f74382a = LogFactory.getLog(getClass());
