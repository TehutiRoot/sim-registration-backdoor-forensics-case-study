...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.home.fragment.OneOtherMenuFragment$setupObserve$1 */
/* loaded from: classes10.dex */
public final class OneOtherMenuFragment$setupObserve$1 extends Lambda implements Function1<Resource<? extends Pair<? extends BuyDolConsent, ? extends String>>, Unit> {
    final /* synthetic */ OneOtherMenuFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.home.fragment.OneOtherMenuFragment$setupObserve$1$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneOtherMenuFragment$setupObserve$1(OneOtherMenuFragment oneOtherMenuFragment) {
        super(1);
    ...
    public final void invoke2(Resource<Pair<BuyDolConsent, String>> resource) {
        ...
        if (data != null) {
            ...
            if (consentMessage == null || consentMessage.length() == 0) {
                oneOtherMenuFragment.m14146B(second);
                return;
            }
            String mrtrConsentId = first.getMrtrConsentId();
            OneOtherMenuFragment.MrtrConsentId.setConsentId(mrtrConsentId != null ? Integer.valueOf(Integer.parseInt(mrtrConsentId)) : null);
            oneOtherMenuFragment.f91175m = OneConsentDialog.Companion.newInstance(first.getConsentMessage(), oneOtherMenuFragment.getString(R.string.one_consent_dialog_ok_massage));
            oneConsentDialog = oneOtherMenuFragment.f91175m;
            if (oneConsentDialog != null) {
                oneConsentDialog.setCallback(oneOtherMenuFragment);
            }
            oneConsentDialog2 = oneOtherMenuFragment.f91175m;
            if (oneConsentDialog2 != null) {
                Integer num = OneHomeFragment.Companion.getFeatures().get(second);
                oneConsentDialog2.setTargetFragment(oneOtherMenuFragment, num != null ? num.intValue() : 0);
            }
            FragmentManager parentFragmentManager = oneOtherMenuFragment.getParentFragmentManager();
            oneConsentDialog3 = oneOtherMenuFragment.f91175m;
