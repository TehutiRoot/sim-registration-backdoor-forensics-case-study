...
public final class LaunchedEffectImpl implements RememberObserver {
    ...
    public LaunchedEffectImpl(@NotNull CoroutineContext parentCoroutineContext, @NotNull Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> task) {
        ...
        this.f28433a = task;
        this.f28434b = CoroutineScopeKt.CoroutineScope(parentCoroutineContext);
    }

    @Override // androidx.compose.runtime.RememberObserver
    public void onAbandoned() {
        Job job = this.f28435c;
        if (job != null) {
    ...
    public void onRemembered() {
        ...
        Job job = this.f28435c;
        if (job != null) {
            AbstractC12015a.m27601j(job, "Old job was still running!", null, 2, null);
        }
        m65885e = AbstractC1539Vc.m65885e(this.f28434b, null, null, this.f28433a, 3, null);
        this.f28435c = m65885e;
    }
}