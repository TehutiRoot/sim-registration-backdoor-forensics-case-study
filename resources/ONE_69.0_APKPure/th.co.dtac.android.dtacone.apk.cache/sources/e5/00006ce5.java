...
public class NumberPickerBindingAdapter {
    ...
    /* loaded from: classes2.dex */
    public class C4279a implements NumberPicker.OnValueChangeListener {

        /* renamed from: a */
        public final /* synthetic */ NumberPicker.OnValueChangeListener f34651a;

        /* renamed from: b */
        public final /* synthetic */ InverseBindingListener f34652b;

        public C4279a(NumberPicker.OnValueChangeListener onValueChangeListener, InverseBindingListener inverseBindingListener) {
            this.f34651a = onValueChangeListener;
            this.f34652b = inverseBindingListener;
        }

        @Override // android.widget.NumberPicker.OnValueChangeListener
        public void onValueChange(NumberPicker numberPicker, int i, int i2) {
            NumberPicker.OnValueChangeListener onValueChangeListener = this.f34651a;
            if (onValueChangeListener != null) {
                onValueChangeListener.onValueChange(numberPicker, i, i2);
            }
            this.f34652b.onChange();
        }
    }
    ...
    public static void setListeners(NumberPicker numberPicker, NumberPicker.OnValueChangeListener onValueChangeListener, InverseBindingListener inverseBindingListener) {
        if (inverseBindingListener == null) {
            ...
            numberPicker.setOnValueChangedListener(new C4279a(onValueChangeListener, inverseBindingListener));
        }
    }
