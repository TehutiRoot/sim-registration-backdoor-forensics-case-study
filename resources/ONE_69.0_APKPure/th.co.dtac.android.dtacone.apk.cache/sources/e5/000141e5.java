...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.tol.screen.device.ComposableSingletons$DeviceSelectScreenKt$lambda-8$1$3$1  reason: invalid class name */
/* loaded from: classes10.dex */
public final class ComposableSingletons$DeviceSelectScreenKt$lambda8$1$3$1 extends Lambda implements Function1<String, Unit> {
    final /* synthetic */ MutableState<DeviceMeshItem> $mesh$delegate;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ComposableSingletons$DeviceSelectScreenKt$lambda8$1$3$1(MutableState<DeviceMeshItem> mutableState) {
        super(1);
