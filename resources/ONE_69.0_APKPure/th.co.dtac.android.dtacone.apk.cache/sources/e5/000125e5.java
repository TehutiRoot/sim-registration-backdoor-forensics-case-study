...
/* renamed from: th.co.dtac.android.dtacone.presenter.withDevice.WithDeviceConfirmPresenter$getBase64Image$1 */
/* loaded from: classes8.dex */
public final class WithDeviceConfirmPresenter$getBase64Image$1 extends Lambda implements Function1<Bitmap, Unit> {
    final /* synthetic */ WithDeviceConfirmPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WithDeviceConfirmPresenter$getBase64Image$1(WithDeviceConfirmPresenter withDeviceConfirmPresenter) {
        super(1);
    ...
    public final void invoke2(Bitmap it) {
        ...
        view.onConvertBitmapSuccess(BitmapExtKt.toBase64(it));
    }
}