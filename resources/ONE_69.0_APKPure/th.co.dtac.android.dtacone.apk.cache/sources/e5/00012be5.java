...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.change_owner.viewModel.OneChangeOwnerValidateViewModel$isAllowCamera$2 */
/* loaded from: classes10.dex */
public final class OneChangeOwnerValidateViewModel$isAllowCamera$2 extends Lambda implements Function1<String, SingleSource<? extends UpdatePrepaidAllowCamera>> {
    final /* synthetic */ OneChangeOwnerValidateViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneChangeOwnerValidateViewModel$isAllowCamera$2(OneChangeOwnerValidateViewModel oneChangeOwnerValidateViewModel) {
        super(1);
    ...
    public final SingleSource<? extends UpdatePrepaidAllowCamera> invoke(@NotNull String phoneNumber) {
        ...
        return oneChangeOwnerRepository.getAllowCamera(phoneNumber);
    }
}