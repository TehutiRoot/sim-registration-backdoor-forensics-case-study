...
public final class FlowableRange extends Flowable<Integer> {
    ...
    public void subscribeActual(Subscriber<? super Integer> subscriber) {
        if (subscriber instanceof ConditionalSubscriber) {
            subscriber.onSubscribe(new RangeConditionalSubscription((ConditionalSubscriber) subscriber, this.f64502b, this.f64503c));
        } else {
            subscriber.onSubscribe(new RangeSubscription(subscriber, this.f64502b, this.f64503c));
        }
    }
}