...
public final class TabKt {
    ...
    /* renamed from: a */
    public static final float f14763a = C3623Dp.m73842constructorimpl(48);

    /* renamed from: b */
    public static final float f14764b = C3623Dp.m73842constructorimpl(72);

    /* renamed from: c */
    public static final float f14765c = C3623Dp.m73842constructorimpl(16);

    /* renamed from: d */
    public static final float f14766d = C3623Dp.m73842constructorimpl(14);

    /* renamed from: e */
    public static final float f14767e = C3623Dp.m73842constructorimpl(6);

    /* renamed from: f */
    public static final long f14768f = TextUnitKt.getSp(20);

    /* renamed from: g */
    public static final float f14769g = C3623Dp.m73842constructorimpl(8);
    ...
    */
        ...
        if ((i2 & 91) == 18 && startRestartGroup.getSkipping()) {
            ...
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material.TabKt$TabBaselineLayout$2
                ...
                public final MeasureResult mo69380measure3p2s80s(MeasureScope Layout, List measurables, long j) {
                    ...
                    int mo69616roundToPx0680j_4 = Layout.mo69616roundToPx0680j_4((placeable == null || placeable2 == null) ? TabKt.f14763a : TabKt.f14764b);
                    if (placeable != null) {
                    ...
                    return MeasureScope.CC.m59482q(Layout, max, mo69616roundToPx0680j_4, null, new TabKt$TabBaselineLayout$2$measure$1(placeable, placeable2, Layout, max, mo69616roundToPx0680j_4, num, num2), 4, null);
                }
            ...
            if (function2 != null) {
                Modifier m69715paddingVpY3zN4$default = PaddingKt.m69715paddingVpY3zN4$default(LayoutIdKt.layoutId(companion, TextBundle.TEXT_ENTRY), f14765c, 0.0f, 2, null);
    ...
    /* renamed from: b */
    public static final void m60729b(long j, long j2, boolean z, Function2 function2, Composer composer, int i) {
        int i2;
        long j3;
        long j4;
        long j5;
        ...
        if ((i2 & 5851) == 1170 && startRestartGroup.getSkipping()) {
            ...
            startRestartGroup.endReplaceableGroup();
            startRestartGroup.endReplaceableGroup();
            CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m71909boximpl(Color.m71918copywmQWz5c$default(m60728c(createTransitionAnimation), 1.0f, 0.0f, 0.0f, 0.0f, 14, null))), ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(Color.m71921getAlphaimpl(m60728c(createTransitionAnimation))))}, function2, startRestartGroup, (i7 & 112) | 8);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    /* renamed from: c */
    public static final long m60728c(State state) {
        return ((Color) state.getValue()).m71929unboximpl();
    }

    /* renamed from: d */
    public static final void m60727d(Placeable.PlacementScope placementScope, Density density, Placeable placeable, Placeable placeable2, int i, int i2, int i3, int i4) {
        float f;
        if (i3 == i4) {
            f = f14766d;
        } else {
        ...
        int mo69616roundToPx0680j_4 = density.mo69616roundToPx0680j_4(f) + density.mo69616roundToPx0680j_4(TabRowDefaults.INSTANCE.m70311getIndicatorHeightD9Ej5fM());
        ...
        Placeable.PlacementScope.placeRelative$default(placementScope, placeable2, (i - placeable2.getWidth()) / 2, i5 - ((placeable2.getHeight() + density.mo69615roundToPxR2X_6o(f14768f)) - i3), 0.0f, 4, null);
    }

    /* renamed from: e */
    public static final void m60726e(Placeable.PlacementScope placementScope, Placeable placeable, int i) {
