...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.customerenquiry.InfoAnalyticViewModel$onSelectPostpaidUpsellPackage$5 */
/* loaded from: classes9.dex */
public final class InfoAnalyticViewModel$onSelectPostpaidUpsellPackage$5 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ Offer $offer;
    final /* synthetic */ InfoAnalyticViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InfoAnalyticViewModel$onSelectPostpaidUpsellPackage$5(InfoAnalyticViewModel infoAnalyticViewModel, Offer offer) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable it) {
        ...
        mrtrErrorService.handleException(it, new MrtrErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.viewmodel.customerenquiry.InfoAnalyticViewModel$onSelectPostpaidUpsellPackage$5.1
