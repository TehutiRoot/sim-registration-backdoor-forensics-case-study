...
public final class SelectionManager$modifier$4 extends Lambda implements Function1<KeyEvent, Boolean> {
    ...
    public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
        return m70057invokeZmokQxo(keyEvent.m72777unboximpl());
    }

    @NotNull
    /* renamed from: invoke-ZmokQxo  reason: not valid java name */
    public final Boolean m70057invokeZmokQxo(@NotNull android.view.KeyEvent it) {
        boolean z;
        Intrinsics.checkNotNullParameter(it, "it");
        if (SelectionManager_androidKt.m70061isCopyKeyEventZmokQxo(it)) {
