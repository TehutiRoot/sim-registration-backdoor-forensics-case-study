...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.viewModel.OneMnpViewModel$updateAppForms$1 */
/* loaded from: classes10.dex */
public final class OneMnpViewModel$updateAppForms$1 extends Lambda implements Function1<Disposable, Unit> {
    final /* synthetic */ OneMnpViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneMnpViewModel$updateAppForms$1(OneMnpViewModel oneMnpViewModel) {
        super(1);
    ...
    public final void invoke2(Disposable disposable) {
        ...
        m13561G1.setValue(Resource.Companion.loading(null));
