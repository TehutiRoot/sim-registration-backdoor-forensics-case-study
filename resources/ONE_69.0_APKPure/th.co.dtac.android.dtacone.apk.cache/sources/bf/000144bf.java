...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.tol.screen.takePhoto.TakePhotoOptionalScreenKt$TakePhotoOptionalScreen$2$3$1 */
/* loaded from: classes10.dex */
public final class TakePhotoOptionalScreenKt$TakePhotoOptionalScreen$2$3$1 extends Lambda implements Function1<Context, PreviewView> {
    final /* synthetic */ LifecycleCameraController $cameraController;
    final /* synthetic */ LifecycleOwner $lifecycleOwner;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TakePhotoOptionalScreenKt$TakePhotoOptionalScreen$2$3$1(LifecycleCameraController lifecycleCameraController, LifecycleOwner lifecycleOwner) {
        super(1);
