...
/* renamed from: th.co.dtac.android.dtacone.view.fragment.eSIM.select_sku.ESimSelectSKUFragment$initObserve$1$2 */
/* loaded from: classes9.dex */
public final class ESimSelectSKUFragment$initObserve$1$2 extends Lambda implements Function1<Resource<? extends ESIMNumberResponse>, Unit> {
    final /* synthetic */ ESimSelectSKUFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimSelectSKUFragment$initObserve$1$2(ESimSelectSKUFragment eSimSelectSKUFragment) {
        super(1);
    ...
    public final void invoke2(Resource<ESIMNumberResponse> resource) {
        ...
        if (resourceContentIfNotHandled.getStatus() == StatusResource.SUCCESS) {
            m6907o = eSimSelectSKUFragment.m6907o();
            m6907o.addFragment(ESimSelectNumberFragment.Companion.newInstance(), ESimSelectNumberFragment.TAG);
        }
    }
}