...
public class findFragmentByTag {
    ...
    public findFragmentByTag(equals equalsVar, C9602nb c9602nb) {
        this.valueOf = equalsVar;
        this.ThreeDS2ServiceInstance = c9602nb;
    }

    public C9640nr values(C9640nr c9640nr) {
        ...
        for (setContentInsetEndWithActions setcontentinsetendwithactions : this.valueOf.ThreeDS2Service()) {
            ...
            c9640nr = setcontentinsetendwithactions.get(c9640nr, this.ThreeDS2ServiceInstance.get());
            int i6 = get;
            int i7 = i6 & 13;
            int i8 = ((i6 ^ 13) | i7) << 1;
            int i9 = -((i6 | 13) & (~i7));
