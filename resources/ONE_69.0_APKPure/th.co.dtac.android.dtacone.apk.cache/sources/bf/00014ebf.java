...
/* renamed from: th.co.dtac.android.dtacone.view.fragment.mrtr_mnp.MrtrMnpMailingFragment$setUpViewModel$1$2 */
/* loaded from: classes9.dex */
public final class MrtrMnpMailingFragment$setUpViewModel$1$2 extends Lambda implements Function1<StatusResource, Unit> {
    final /* synthetic */ MrtrMnpMailingFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrMnpMailingFragment$setUpViewModel$1$2(MrtrMnpMailingFragment mrtrMnpMailingFragment) {
        super(1);
    ...
    public final void invoke2(StatusResource statusResource) {
        this.this$0.m6233O(statusResource);
    }
}