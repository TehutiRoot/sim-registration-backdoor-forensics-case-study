...
public abstract class BaseTestConsumer<T, U extends BaseTestConsumer<T, U>> implements Disposable {
    ...
    public final U assertError(Throwable th2) {
        return assertError(Functions.equalsWith(th2));
    }
    ...
    public final U assertValues(T... tArr) {
        ...
        throw fail("Value count differs; expected: " + tArr.length + HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR + Arrays.toString(tArr) + " but was: " + size + HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR + this.values);
    }
    ...
    public final U awaitCount(int i) {
        return awaitCount(i, TestWaitStrategy.SLEEP_10MS, CoroutineLiveDataKt.DEFAULT_TIMEOUT);
    }
    ...
    public final U awaitCount(int i, Runnable runnable) {
        return awaitCount(i, runnable, CoroutineLiveDataKt.DEFAULT_TIMEOUT);
    }

    public final U assertError(Predicate<Throwable> predicate) {
        int size = this.errors.size();
        if (size != 0) {
            for (Throwable th2 : this.errors) {
                try {
