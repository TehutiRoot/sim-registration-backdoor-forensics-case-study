...
public class ReflectProperties {
    ...
    public static class LazySoftVal<T> extends Val<T> implements Function0<T> {
        ...
        /* renamed from: b */
        public final Function0 f68507b;

        /* renamed from: c */
        public volatile SoftReference f68508c;
        ...
        public LazySoftVal(@Nullable T t, @NotNull Function0<T> function0) {
            ...
            this.f68508c = null;
            this.f68507b = function0;
            if (t != null) {
                this.f68508c = new SoftReference(escape(t));
            }
        }

        /* renamed from: a */
        public static /* synthetic */ void m28956a(int i) {
        ...
        public T invoke() {
            Object obj;
            SoftReference softReference = this.f68508c;
            if (softReference != null && (obj = softReference.get()) != null) {
                return unescape(obj);
            }
            T t = (T) this.f68507b.invoke();
            this.f68508c = new SoftReference(escape(t));
            return t;
        }
    }
    ...
    public static class LazyVal<T> extends Val<T> {
        ...
        /* renamed from: b */
        public final Function0 f68509b;

        /* renamed from: c */
        public volatile Object f68510c;
        ...
        public LazyVal(@NotNull Function0<T> function0) {
            ...
            this.f68510c = null;
            this.f68509b = function0;
        }

        /* renamed from: a */
        private static /* synthetic */ void m28955a(int i) {
            throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "initializer", "kotlin/reflect/jvm/internal/ReflectProperties$LazyVal", "<init>"));
        }

        @Override // kotlin.reflect.jvm.internal.ReflectProperties.Val, kotlin.jvm.functions.Function0
        public T invoke() {
            Object obj = this.f68510c;
            if (obj != null) {
                return unescape(obj);
            }
            T t = (T) this.f68509b.invoke();
            this.f68510c = escape(t);
            return t;
        }
    }
    ...
    public static abstract class Val<T> {
        ...
        /* renamed from: a */
        public static final Object f68511a = new C11704a();
    ...
    /* renamed from: a */
    public static /* synthetic */ void m28957a(int i) {
