...
public final class SerialDescriptorImpl implements SerialDescriptor, CachedNames {
    ...
    /* renamed from: b */
    public final SerialKind f71181b;

    /* renamed from: c */
    public final int f71182c;

    /* renamed from: d */
    public final List f71183d;

    /* renamed from: e */
    public final Set f71184e;

    /* renamed from: f */
    public final String[] f71185f;

    /* renamed from: g */
    public final SerialDescriptor[] f71186g;

    /* renamed from: h */
    public final List[] f71187h;

    /* renamed from: i */
    public final boolean[] f71188i;

    /* renamed from: j */
    public final Map f71189j;

    /* renamed from: k */
    public final SerialDescriptor[] f71190k;

    /* renamed from: l */
    public final Lazy f71191l;
    ...
    public SerialDescriptorImpl(@NotNull String serialName, @NotNull SerialKind kind, int i, @NotNull List<? extends SerialDescriptor> typeParameters, @NotNull ClassSerialDescriptorBuilder builder) {
        ...
        this.f71180a = serialName;
        this.f71181b = kind;
        this.f71182c = i;
        this.f71183d = builder.getAnnotations();
        this.f71184e = CollectionsKt___CollectionsKt.toHashSet(builder.getElementNames$kotlinx_serialization_core());
        String[] strArr = (String[]) builder.getElementNames$kotlinx_serialization_core().toArray(new String[0]);
        this.f71185f = strArr;
        this.f71186g = Platform_commonKt.compactArray(builder.getElementDescriptors$kotlinx_serialization_core());
        this.f71187h = (List[]) builder.getElementAnnotations$kotlinx_serialization_core().toArray(new List[0]);
        this.f71188i = CollectionsKt___CollectionsKt.toBooleanArray(builder.getElementOptionality$kotlinx_serialization_core());
        Iterable<IndexedValue> withIndex = ArraysKt___ArraysKt.withIndex(strArr);
        ArrayList arrayList = new ArrayList(AbstractC10172es.collectionSizeOrDefault(withIndex, 10));
        for (IndexedValue indexedValue : withIndex) {
            arrayList.add(TuplesKt.m29136to(indexedValue.getValue(), Integer.valueOf(indexedValue.getIndex())));
        }
        this.f71189j = AbstractC11663a.toMap(arrayList);
        this.f71190k = Platform_commonKt.compactArray(typeParameters);
        this.f71191l = LazyKt__LazyJVMKt.lazy(new SerialDescriptorImpl$_hashCode$2(this));
    }

    /* renamed from: a */
    public final int m27011a() {
        return ((Number) this.f71191l.getValue()).intValue();
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof SerialDescriptorImpl) {
            ...
            if (Intrinsics.areEqual(getSerialName(), serialDescriptor.getSerialName()) && Arrays.equals(this.f71190k, ((SerialDescriptorImpl) obj).f71190k) && getElementsCount() == serialDescriptor.getElementsCount()) {
    ...
    public List<Annotation> getElementAnnotations(int i) {
        return this.f71187h[i];
    }

    @Override // kotlinx.serialization.descriptors.SerialDescriptor
    @NotNull
    public SerialDescriptor getElementDescriptor(int i) {
        return this.f71186g[i];
    }

    @Override // kotlinx.serialization.descriptors.SerialDescriptor
    public int getElementIndex(@NotNull String name) {
        Intrinsics.checkNotNullParameter(name, "name");
        Integer num = (Integer) this.f71189j.get(name);
        if (num != null) {
            return num.intValue();
        }
        return -3;
    ...
    public String toString() {
        IntRange until = AbstractC11695c.until(0, getElementsCount());
