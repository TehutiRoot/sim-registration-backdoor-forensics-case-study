...
import th.p047co.dtac.android.dtacone.view.appOne.topup.fragment.OneTopupPriceListFragment;
...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.topup.fragment.OneTopupPriceListFragment$setUpViewModel$2 */
/* loaded from: classes10.dex */
public final class OneTopupPriceListFragment$setUpViewModel$2 extends Lambda implements Function1<Resource<? extends Pair<? extends BuyDolConsent, ? extends String>>, Unit> {
    final /* synthetic */ OneTopupPriceListFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.topup.fragment.OneTopupPriceListFragment$setUpViewModel$2$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneTopupPriceListFragment$setUpViewModel$2(OneTopupPriceListFragment oneTopupPriceListFragment) {
        super(1);
    ...
    public final void invoke2(Resource<Pair<BuyDolConsent, String>> resource) {
        ...
        if (data != null) {
            ...
            if (consentMessage == null || consentMessage.length() == 0) {
                oneTopupPriceListFragment.m9283T(second);
                return;
            }
            String mrtrConsentId = first.getMrtrConsentId();
            OneTopupPriceListFragment.MrtrConsentId.setConsentId(mrtrConsentId != null ? Integer.valueOf(Integer.parseInt(mrtrConsentId)) : null);
            oneTopupPriceListFragment.f98473e0 = OneConsentDialog.Companion.newInstance(first.getConsentMessage(), oneTopupPriceListFragment.getString(R.string.one_consent_dialog_ok_massage));
            oneConsentDialog = oneTopupPriceListFragment.f98473e0;
            if (oneConsentDialog != null) {
                oneConsentDialog.setCallback(oneTopupPriceListFragment);
            }
            oneConsentDialog2 = oneTopupPriceListFragment.f98473e0;
            if (oneConsentDialog2 != null) {
                Integer num = OneHomeFragment.Companion.getFeatures().get(second);
                oneConsentDialog2.setTargetFragment(oneTopupPriceListFragment, num != null ? num.intValue() : 0);
            }
            FragmentManager parentFragmentManager = oneTopupPriceListFragment.getParentFragmentManager();
            oneConsentDialog3 = oneTopupPriceListFragment.f98473e0;
