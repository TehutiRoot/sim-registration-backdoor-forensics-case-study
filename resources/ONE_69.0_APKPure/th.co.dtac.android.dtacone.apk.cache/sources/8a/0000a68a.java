...
public abstract class AbstractDataStoreFactory implements DataStoreFactory {
    ...
    /* renamed from: c */
    public static final Pattern f52394c = Pattern.compile("\\w{1,30}");

    /* renamed from: a */
    public final Lock f52395a = new ReentrantLock();

    /* renamed from: b */
    public final Map f52396b = Maps.newHashMap();
