...
public abstract class FormattingConverter<E> extends Converter<E> {
    ...
    public final void write(StringBuilder sb, E e) {
        ...
        if (length > max) {
            convert = this.f39973b.isLeftTruncate() ? convert.substring(length - max) : convert.substring(0, max);
        } else if (length < min) {
            if (this.f39973b.isLeftPad()) {
