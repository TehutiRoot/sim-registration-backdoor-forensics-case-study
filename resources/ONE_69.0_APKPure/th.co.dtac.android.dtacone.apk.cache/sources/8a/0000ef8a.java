...
public class NameFileFilter extends AbstractFileFilter implements Serializable {
    ...
    /* renamed from: a */
    public static /* synthetic */ boolean m25440a(NameFileFilter nameFileFilter, String str, String str2) {
    ...
    private boolean acceptBaseName(final String str) {
        ...
        anyMatch = of.anyMatch(new Predicate() { // from class: SG0
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return NameFileFilter.m25440a(NameFileFilter.this, str, (String) obj);
            }
        });
        return anyMatch;
    }
