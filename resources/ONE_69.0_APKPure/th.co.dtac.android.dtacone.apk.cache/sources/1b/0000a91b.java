...
public final class GeneralRange<T> implements Serializable {
    ...
    private GeneralRange(Comparator<? super T> comparator, boolean z, @CheckForNull T t, BoundType boundType, boolean z2, @CheckForNull T t2, BoundType boundType2) {
        ...
        if (z) {
            comparator.compare((Object) AbstractC22494uJ0.m1205a(t), (Object) AbstractC22494uJ0.m1205a(t));
        }
        if (z2) {
            comparator.compare((Object) AbstractC22494uJ0.m1205a(t2), (Object) AbstractC22494uJ0.m1205a(t2));
        }
        if (z && z2) {
            int compare = comparator.compare((Object) AbstractC22494uJ0.m1205a(t), (Object) AbstractC22494uJ0.m1205a(t2));
            boolean z4 = false;
            if (compare <= 0) {
                z3 = true;
            } else {
    ...
    public boolean isEmpty() {
        if ((hasUpperBound() && tooLow(AbstractC22494uJ0.m1205a(getUpperEndpoint()))) || (hasLowerBound() && tooHigh(AbstractC22494uJ0.m1205a(getLowerEndpoint())))) {
            return true;
        }
        return false;
    }
    ...
    public boolean tooHigh(T t) {
        ...
        int compare = this.comparator.compare(t, AbstractC22494uJ0.m1205a(getUpperEndpoint()));
        if (compare > 0) {
            z = true;
        } else {
            z = false;
    ...
    public boolean tooLow(T t) {
        ...
        int compare = this.comparator.compare(t, AbstractC22494uJ0.m1205a(getLowerEndpoint()));
        if (compare < 0) {
            z = true;
        } else {
            z = false;
