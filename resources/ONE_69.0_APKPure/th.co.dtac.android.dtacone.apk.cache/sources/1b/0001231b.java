...
/* renamed from: th.co.dtac.android.dtacone.presenter.dtacAtHome.DtacAtHomeVerifyOtpPresenter$verifyOtp$3 */
/* loaded from: classes8.dex */
public final class DtacAtHomeVerifyOtpPresenter$verifyOtp$3 extends Lambda implements Function1<String, Unit> {
    final /* synthetic */ DtacAtHomeVerifyOtpPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DtacAtHomeVerifyOtpPresenter$verifyOtp$3(DtacAtHomeVerifyOtpPresenter dtacAtHomeVerifyOtpPresenter) {
        super(1);
