...
public class SignerIdentifier extends ASN1Object implements ASN1Choice {
    ...
    /* renamed from: id */
    private ASN1Encodable f74740id;

    public SignerIdentifier(ASN1OctetString aSN1OctetString) {
        this.f74740id = new DERTaggedObject(false, 0, aSN1OctetString);
    }
    ...
    public ASN1Encodable getId() {
        ASN1Encodable aSN1Encodable = this.f74740id;
    ...
    public boolean isTagged() {
        return this.f74740id instanceof ASN1TaggedObject;
    }

    @Override // org.bouncycastle.asn1.ASN1Object, org.bouncycastle.asn1.ASN1Encodable
    public ASN1Primitive toASN1Primitive() {
        return this.f74740id.toASN1Primitive();
    }

    public SignerIdentifier(ASN1Primitive aSN1Primitive) {
        this.f74740id = aSN1Primitive;
    }

    public SignerIdentifier(IssuerAndSerialNumber issuerAndSerialNumber) {
        this.f74740id = issuerAndSerialNumber;
    }
}