...
public final class ObservableRepeatUntil<T> extends AbstractC11078a {

    /* renamed from: a */
    public final BooleanSupplier f65514a;
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        new RepeatUntilObserver(observer, this.f65514a, sequentialDisposable, this.source).subscribeNext();
    }
}