...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.esim.ESimPostpaidViewModel$callOpenMarketAddIMEI$2 */
/* loaded from: classes9.dex */
public final class ESimPostpaidViewModel$callOpenMarketAddIMEI$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ ESimPostpaidViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimPostpaidViewModel$callOpenMarketAddIMEI$2(ESimPostpaidViewModel eSimPostpaidViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable it) {
        ...
        mrtrErrorService.handleException(it, new MrtrErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.viewmodel.esim.ESimPostpaidViewModel$callOpenMarketAddIMEI$2.1
