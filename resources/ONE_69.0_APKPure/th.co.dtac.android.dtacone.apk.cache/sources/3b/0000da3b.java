...
public final class ComparisonsKt__ComparisonsKt$thenByDescending$2<T> implements Comparator {
    ...
    /* renamed from: a */
    public final /* synthetic */ Comparator f68208a;

    /* renamed from: b */
    public final /* synthetic */ Comparator f68209b;

    /* renamed from: c */
    public final /* synthetic */ Function1 f68210c;
    ...
    public ComparisonsKt__ComparisonsKt$thenByDescending$2(Comparator<T> comparator, Comparator<Object> comparator2, Function1<? super T, Object> function1) {
        this.f68208a = comparator;
        this.f68209b = comparator2;
        this.f68210c = function1;
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // java.util.Comparator
    public final int compare(T t, T t2) {
        int compare = this.f68208a.compare(t, t2);
        if (compare == 0) {
            Comparator comparator = this.f68209b;
            Function1 function1 = this.f68210c;
