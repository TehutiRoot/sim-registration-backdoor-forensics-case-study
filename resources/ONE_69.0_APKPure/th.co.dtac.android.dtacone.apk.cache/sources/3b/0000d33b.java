...
public final class SingleTakeUntil<T, U> extends Single<T> {
    ...
    /* renamed from: a */
    public final SingleSource f66041a;

    /* renamed from: b */
    public final Publisher f66042b;
    ...
    public SingleTakeUntil(SingleSource<T> singleSource, Publisher<U> publisher) {
        this.f66041a = singleSource;
        this.f66042b = publisher;
    }
    ...
    public void subscribeActual(SingleObserver<? super T> singleObserver) {
        ...
        this.f66042b.subscribe(takeUntilMainObserver.other);
        this.f66041a.subscribe(takeUntilMainObserver);
    }
}