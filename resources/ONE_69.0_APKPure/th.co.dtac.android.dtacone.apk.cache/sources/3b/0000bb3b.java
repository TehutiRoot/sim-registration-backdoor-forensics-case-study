...
public abstract class AbstractC9279bx implements getOrDefault {
    ...
    protected final InterfaceC9641ns values = C9642nt.ThreeDS2ServiceInstance(AbstractC9279bx.class);
    private final List<contains> cleanup = new ArrayList();
    private final List<InterfaceC9356elements> initialize = new ArrayList();
    private final C9336dw getWarnings = new C9336dw();

    public AbstractC9279bx(Context context) {
    ...
    @Override // com.netcetera.threeds.sdk.infrastructure.getOrDefault
    public void ThreeDS2ServiceInstance(InterfaceC9359eo interfaceC9359eo) {
        int i = onCompleted + 1;
        onError = i % 128;
        if (i % 2 != 0) {
            for (contains containsVar : this.cleanup) {
                ...
                if (!(!(containsVar instanceof save))) {
                    ((save) containsVar).valueOf(interfaceC9359eo);
                }
            }
            return;
        }
    ...
    @Override // com.netcetera.threeds.sdk.infrastructure.getOrDefault
    public void valueOf(InterfaceC9300compute interfaceC9300compute, setAllCaps setallcaps) {
        if (this.getSDKVersion == null) {
            onCompleted = (onError + 33) % 128;
            valueOf();
        }
        this.getWarnings.get(interfaceC9300compute);
    ...
    public final void ThreeDS2Service(InterfaceC9356elements interfaceC9356elements) {
        int i = onCompleted + 69;
        onError = i % 128;
        if (i % 2 != 0) {
            this.initialize.add(interfaceC9356elements);
        } else {
            this.initialize.add(interfaceC9356elements);
            throw null;
        }
    ...
    @Override // com.netcetera.threeds.sdk.infrastructure.InterfaceC9356elements
    public keys get(keys keysVar) {
        onCompleted = (onError + 83) % 128;
        Iterator<InterfaceC9356elements> it = this.initialize.iterator();
        ...
        while (it.hasNext()) {
            ...
            if (i % 2 == 0) {
                ...
                if (next instanceof save) {
                    ((save) next).values(interfaceC9362er);
    ...
    private void valueOf(View view, String str) {
        ...
        try {
            ...
            interfaceC9641ns.valueOf(String.format(((String) objArr2[0]).intern(), str, th2.getMessage()));
        }
    ...
    */
    private static void values(java.lang.String r12, int r13, java.lang.Object[] r14) {
        ...
        L28:
            ...
            int r9 = r8 + r4
            int r10 = r8 << 4
            char r11 = com.netcetera.threeds.sdk.infrastructure.AbstractC9279bx.ThreeDS2Service     // Catch: java.lang.Throwable -> L5b
            int r10 = r10 + r11
            r9 = r9 ^ r10
            int r10 = r8 >>> 5
            char r11 = com.netcetera.threeds.sdk.infrastructure.AbstractC9279bx.ThreeDS2ServiceInstance     // Catch: java.lang.Throwable -> L5b
            int r10 = r10 + r11
            r9 = r9 ^ r10
            int r7 = r7 - r9
            ...
            int r9 = r7 + r4
            int r10 = r7 << 4
            char r11 = com.netcetera.threeds.sdk.infrastructure.AbstractC9279bx.valueOf     // Catch: java.lang.Throwable -> L5b
            int r10 = r10 + r11
            r9 = r9 ^ r10
            int r7 = r7 >>> 5
            char r10 = com.netcetera.threeds.sdk.infrastructure.AbstractC9279bx.get     // Catch: java.lang.Throwable -> L5b
            int r7 = r7 + r10
            r7 = r7 ^ r9
            int r8 = r8 - r7
        ...
        L77:
            ...
            throw r12
        */
        throw new UnsupportedOperationException("Method not decompiled: com.netcetera.threeds.sdk.infrastructure.AbstractC9279bx.values(java.lang.String, int, java.lang.Object[]):void");
    }
}