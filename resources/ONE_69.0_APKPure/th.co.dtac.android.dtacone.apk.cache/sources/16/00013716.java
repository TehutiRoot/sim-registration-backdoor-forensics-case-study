...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.fragment.OnePostpaidSmartCardFragment$onStart$1$2 */
/* loaded from: classes10.dex */
public final class OnePostpaidSmartCardFragment$onStart$1$2 extends Lambda implements Function1<Resource<? extends ErrorCollection>, Unit> {
    final /* synthetic */ OnePostpaidSmartCardFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidSmartCardFragment$onStart$1$2(OnePostpaidSmartCardFragment onePostpaidSmartCardFragment) {
        super(1);
    ...
    public final void invoke2(Resource<ErrorCollection> resource) {
        ...
        OnePostpaidSmartCardFragment onePostpaidSmartCardFragment = this.this$0;
        if (resourceContentIfNotHandled.getStatus() == StatusResource.SUCCESS) {
            onePostpaidSmartCardFragment.m12446F(resourceContentIfNotHandled.getData());
        }
    }
}