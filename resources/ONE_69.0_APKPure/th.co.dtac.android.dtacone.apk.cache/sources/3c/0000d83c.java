...
public class SupportRSBlurTransformation extends BitmapTransformation {
    ...
    /* renamed from: c */
    public static int f67773c = 25;

    /* renamed from: d */
    public static int f67774d = 1;
    ...
    public boolean equals(Object obj) {
        if (obj instanceof SupportRSBlurTransformation) {
            ...
            if (supportRSBlurTransformation.f67775a == this.f67775a && supportRSBlurTransformation.f67776b == this.f67776b) {
                return true;
            }
        }
        return false;
    ...
    @Override // jp.wasabeef.glide.transformations.BitmapTransformation, com.bumptech.glide.load.Key
    public int hashCode() {
        return 1842095596 + (this.f67775a * 1000) + (this.f67776b * 10);
    }

    public String toString() {
        return "SupportRSBlurTransformation(radius=" + this.f67775a + ", sampling=" + this.f67776b + ")";
    }
    ...
    public Bitmap transform(@NonNull Context context, @NonNull BitmapPool bitmapPool, @NonNull Bitmap bitmap, int i, int i2) {
        ...
        try {
            return SupportRSBlur.blur(context, bitmap2, this.f67775a);
        } catch (NoClassDefFoundError unused) {
            return RSBlur.blur(context, bitmap2, this.f67775a);
        } catch (RuntimeException unused2) {
            return FastBlur.blur(bitmap2, this.f67775a, true);
        }
    }

    @Override // jp.wasabeef.glide.transformations.BitmapTransformation, com.bumptech.glide.load.Key
    public void updateDiskCacheKey(@NonNull MessageDigest messageDigest) {
        messageDigest.update(("jp.wasabeef.glide.transformations.SupportRSBlurTransformation.1" + this.f67775a + this.f67776b).getBytes(Key.CHARSET));
    }
