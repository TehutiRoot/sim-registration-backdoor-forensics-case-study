...
public final class ChangePasswordResponse implements Parcelable {
    ...
    /* renamed from: e */
    private final List<String> f81693e;
    @SerializedName("responseDateTime")
    @Nullable

    /* renamed from: f */
    private final String f81694f;
    @SerializedName("data")
    @Nullable

    /* renamed from: g */
    private final Data f81695g;
    ...
    @StabilityInferred(parameters = 0)
    @Parcelize
    @Metadata(m29143d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\b\b\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0006\b\u0087\b\u0018\u00002\u00020\u0001B\u0013\u0012\n\b\u0002\u0010\u0003\u001a\u0004\u0018\u00010\u0002¢\u0006\u0004\b\u0004\u0010\u0005J\u0012\u0010\u0006\u001a\u0004\u0018\u00010\u0002HÆ\u0003¢\u0006\u0004\b\u0006\u0010\u0007J\u001c\u0010\b\u001a\u00020\u00002\n\b\u0002\u0010\u0003\u001a\u0004\u0018\u00010\u0002HÆ\u0001¢\u0006\u0004\b\b\u0010\tJ\u0010\u0010\n\u001a\u00020\u0002HÖ\u0001¢\u0006\u0004\b\n\u0010\u0007J\u0010\u0010\f\u001a\u00020\u000bHÖ\u0001¢\u0006\u0004\b\f\u0010\rJ\u001a\u0010\u0011\u001a\u00020\u00102\b\u0010\u000f\u001a\u0004\u0018\u00010\u000eHÖ\u0003¢\u0006\u0004\b\u0011\u0010\u0012J\u0010\u0010\u0013\u001a\u00020\u000bHÖ\u0001¢\u0006\u0004\b\u0013\u0010\rJ \u0010\u0018\u001a\u00020\u00172\u0006\u0010\u0015\u001a\u00020\u00142\u0006\u0010\u0016\u001a\u00020\u000bHÖ\u0001¢\u0006\u0004\b\u0018\u0010\u0019R\u001c\u0010\u0003\u001a\u0004\u0018\u00010\u00028\u0006X\u0087\u0004¢\u0006\f\n\u0004\b\u001a\u0010\u001b\u001a\u0004\b\u001c\u0010\u0007¨\u0006\u001d"}, m29142d2 = {"Lth/co/dtac/android/dtacone/app_one/model/changePassword/ChangePasswordResponse$Data;", "Landroid/os/Parcelable;", "", NotificationCompat.CATEGORY_STATUS, "<init>", "(Ljava/lang/String;)V", "component1", "()Ljava/lang/String;", "copy", "(Ljava/lang/String;)Lth/co/dtac/android/dtacone/app_one/model/changePassword/ChangePasswordResponse$Data;", "toString", "", "hashCode", "()I", "", "other", "", "equals", "(Ljava/lang/Object;)Z", "describeContents", "Landroid/os/Parcel;", "parcel", "flags", "", "writeToParcel", "(Landroid/os/Parcel;I)V", PDPageLabelRange.STYLE_LETTERS_LOWER, "Ljava/lang/String;", "getStatus", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0})
    ...
    public static final class Data implements Parcelable {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            return (obj instanceof Data) && Intrinsics.areEqual(this.f81696a, ((Data) obj).f81696a);
        }
    ...
    public static /* synthetic */ ChangePasswordResponse copy$default(ChangePasswordResponse changePasswordResponse, String str, String str2, String str3, String str4, List list, String str5, Data data, int i, Object obj) {
        if ((i & 1) != 0) {
            str = changePasswordResponse.f81689a;
        }
        if ((i & 2) != 0) {
            str2 = changePasswordResponse.f81690b;
        }
        String str6 = str2;
        if ((i & 4) != 0) {
            str3 = changePasswordResponse.f81691c;
        }
        String str7 = str3;
        if ((i & 8) != 0) {
            str4 = changePasswordResponse.f81692d;
        }
        String str8 = str4;
        List<String> list2 = list;
        if ((i & 16) != 0) {
            list2 = changePasswordResponse.f81693e;
        }
        List list3 = list2;
        if ((i & 32) != 0) {
            str5 = changePasswordResponse.f81694f;
        }
        String str9 = str5;
        if ((i & 64) != 0) {
            data = changePasswordResponse.f81695g;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof ChangePasswordResponse) {
            ...
            return Intrinsics.areEqual(this.f81689a, changePasswordResponse.f81689a) && Intrinsics.areEqual(this.f81690b, changePasswordResponse.f81690b) && Intrinsics.areEqual(this.f81691c, changePasswordResponse.f81691c) && Intrinsics.areEqual(this.f81692d, changePasswordResponse.f81692d) && Intrinsics.areEqual(this.f81693e, changePasswordResponse.f81693e) && Intrinsics.areEqual(this.f81694f, changePasswordResponse.f81694f) && Intrinsics.areEqual(this.f81695g, changePasswordResponse.f81695g);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        List<String> list = this.f81693e;
        int hashCode5 = (hashCode4 + (list == null ? 0 : list.hashCode())) * 31;
        String str5 = this.f81694f;
        int hashCode6 = (hashCode5 + (str5 == null ? 0 : str5.hashCode())) * 31;
        Data data = this.f81695g;
    ...
    public void writeToParcel(@NotNull Parcel out, int i) {
        Intrinsics.checkNotNullParameter(out, "out");
        out.writeString(this.f81689a);
        out.writeString(this.f81690b);
        out.writeString(this.f81691c);
        out.writeString(this.f81692d);
        out.writeStringList(this.f81693e);
        out.writeString(this.f81694f);
        Data data = this.f81695g;
        if (data == null) {
            out.writeInt(0);
            return;
