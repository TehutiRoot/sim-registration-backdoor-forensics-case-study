...
public final class InlineClassRepresentation<Type extends SimpleTypeMarker> extends ValueClassRepresentation<Type> {
    ...
    /* renamed from: a */
    public final Name f68655a;

    /* renamed from: b */
    public final SimpleTypeMarker f68656b;
    ...
    public InlineClassRepresentation(@NotNull Name underlyingPropertyName, @NotNull Type underlyingType) {
        ...
        this.f68655a = underlyingPropertyName;
        this.f68656b = underlyingType;
    }
    ...
    public List<Pair<Name, Type>> getUnderlyingPropertyNamesToTypes() {
        return AbstractC10100ds.listOf(TuplesKt.m29136to(this.f68655a, this.f68656b));
    }

    @NotNull
    public final Type getUnderlyingType() {
        return (Type) this.f68656b;
    }

    @NotNull
    public String toString() {
        return "InlineClassRepresentation(underlyingPropertyName=" + this.f68655a + ", underlyingType=" + this.f68656b + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
}