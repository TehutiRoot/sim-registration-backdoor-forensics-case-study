...
public class AppCompatMultiAutoCompleteTextView extends MultiAutoCompleteTextView implements TintableBackgroundView, EmojiCompatConfigurationView, TintableCompoundDrawablesView {
    ...
    /* renamed from: d */
    public static final int[] f9698d = {16843126};

    /* renamed from: a */
    public final C13161q5 f9699a;

    /* renamed from: b */
    public final C1414U5 f9700b;

    /* renamed from: c */
    public final C0704K5 f9701c;
    ...
    /* renamed from: a */
    public void m64286a(C0704K5 c0704k5) {
    ...
    public void drawableStateChanged() {
        ...
        C13161q5 c13161q5 = this.f9699a;
        if (c13161q5 != null) {
            c13161q5.m23701b();
        }
        C1414U5 c1414u5 = this.f9700b;
        if (c1414u5 != null) {
            c1414u5.m66267b();
        }
    }
    ...
    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f9700b.m66258k();
    }

    @Override // androidx.appcompat.widget.EmojiCompatConfigurationView
    public boolean isEmojiCompatEnabled() {
        return this.f9701c.m67764c();
    }

    @Override // android.widget.TextView, android.view.View
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        return this.f9701c.m67762e(AbstractC0842M5.m67452a(super.onCreateInputConnection(editorInfo), editorInfo, this), editorInfo);
    }
    ...
    public void setEmojiCompatEnabled(boolean z) {
        this.f9701c.m67761f(z);
    }

    @Override // android.widget.TextView
    public void setKeyListener(@Nullable KeyListener keyListener) {
        super.setKeyListener(this.f9701c.m67766a(keyListener));
    }
    ...
    public void setSupportCompoundDrawablesTintList(@Nullable ColorStateList colorStateList) {
        this.f9700b.m66246w(colorStateList);
        this.f9700b.m66267b();
    }
    ...
    public AppCompatMultiAutoCompleteTextView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getContext(), attributeSet, f9698d, i, 0);
        if (obtainStyledAttributes.hasValue(0)) {
            setDropDownBackgroundDrawable(obtainStyledAttributes.getDrawable(0));
        }
        obtainStyledAttributes.recycle();
        C13161q5 c13161q5 = new C13161q5(this);
        this.f9699a = c13161q5;
