...
public final class PageTimings {
    ...
    public static /* synthetic */ PageTimings copy$default(PageTimings pageTimings, Long l, Long l2, String str, int i, Object obj) {
        if ((i & 1) != 0) {
            l = pageTimings.f42905a;
        }
        if ((i & 2) != 0) {
            l2 = pageTimings.f42906b;
        }
        if ((i & 4) != 0) {
            str = pageTimings.f42907c;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof PageTimings) {
            ...
            return Intrinsics.areEqual(this.f42905a, pageTimings.f42905a) && Intrinsics.areEqual(this.f42906b, pageTimings.f42906b) && Intrinsics.areEqual(this.f42907c, pageTimings.f42907c);
        }
        return false;
    }
