...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_pre2post.MrtrPre2PostViewModel$recommendedPackage$3 */
/* loaded from: classes9.dex */
public final class MrtrPre2PostViewModel$recommendedPackage$3 extends Lambda implements Function2<RecommendPackageResponse, DataUsageInfoResponse, Pair<? extends RecommendPackageResponse, ? extends DataUsageInfoResponse>> {
    public static final MrtrPre2PostViewModel$recommendedPackage$3 INSTANCE = new MrtrPre2PostViewModel$recommendedPackage$3();

    public MrtrPre2PostViewModel$recommendedPackage$3() {
        super(2);
    }
