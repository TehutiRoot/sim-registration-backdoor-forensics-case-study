...
@Metadata(m29143d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001*\u00020\u00022\u0006\u0010\u0003\u001a\u00020\u0004H\n¢\u0006\u0002\b\u0005"}, m29142d2 = {"<anonymous>", "", "Landroidx/compose/ui/node/LayoutNode;", "it", "Landroidx/compose/ui/layout/SubcomposeLayoutState;", "invoke"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
...
public final class SubcomposeLayoutState$setRoot$1 extends Lambda implements Function2<LayoutNode, SubcomposeLayoutState, Unit> {
    ...
    public final void invoke2(@NotNull LayoutNode layoutNode, @NotNull SubcomposeLayoutState it) {
        LayoutNodeSubcompositionsState m59470a;
        LayoutNodeSubcompositionsState m59470a2;
        ...
        if (subcompositionsState$ui_release == null) {
            subcomposeSlotReusePolicy2 = this.this$0.f30248a;
        ...
        subcomposeLayoutState.f30249b = subcompositionsState$ui_release;
        m59470a = this.this$0.m59470a();
        m59470a.makeSureStateIsConsistent();
        m59470a2 = this.this$0.m59470a();
        subcomposeSlotReusePolicy = this.this$0.f30248a;
        m59470a2.setSlotReusePolicy(subcomposeSlotReusePolicy);
    }
}