...
public class C9581mi implements InterfaceC9579mg, InterfaceC9580mh {
    private static int ThreeDS2ServiceInstance = 0;
    private static int valueOf = 1;

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ WindowInsets get(C9586mn c9586mn, C9586mn c9586mn2, C9586mn c9586mn3, C9586mn c9586mn4, View view, WindowInsets windowInsets) {
        int systemBars;
        int systemBars2;
        ...
        if (i7 % 2 == 0) {
            ...
            C9586mn.values values = c9586mn.values();
        ...
        c9586mn.values();
        C9586mn.values valuesVar2 = C9586mn.values.ThreeDS2Service;
        throw null;
    }
    ...
    public void ThreeDS2ServiceInstance(View view, C9586mn c9586mn, C9586mn c9586mn2, C9586mn c9586mn3, C9586mn c9586mn4) {
        view.setOnApplyWindowInsetsListener(new View$OnApplyWindowInsetsListenerC9582mj(c9586mn, c9586mn2, c9586mn3, c9586mn4));
        int i = valueOf;
        int i2 = ((i | 1) << 1) - (i ^ 1);
