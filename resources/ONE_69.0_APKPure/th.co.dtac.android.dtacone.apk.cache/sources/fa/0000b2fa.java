...
@DebugMetadata(m29093c = "com.google.firebase.sessions.SessionLifecycleClient$sendLifecycleEvents$1", m29092f = "SessionLifecycleClient.kt", m29091i = {}, m29090l = {151}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
            ...
            if (!(values instanceof Collection) || !values.isEmpty()) {
                ...
                while (true) {
                    if (!it.hasNext()) {
                        ...
                        m37617b = this.this$0.m37617b(this.$messages, 2);
                        m37617b2 = this.this$0.m37617b(this.$messages, 1);
                        SessionLifecycleClient sessionLifecycleClient = this.this$0;
                        for (Message message : CollectionsKt___CollectionsKt.sortedWith(CollectionsKt___CollectionsKt.filterNotNull(CollectionsKt__CollectionsKt.mutableListOf(m37617b, m37617b2)), new Comparator() { // from class: com.google.firebase.sessions.SessionLifecycleClient$sendLifecycleEvents$1$invokeSuspend$$inlined$sortedBy$1
                            @Override // java.util.Comparator
                            public final int compare(T t, T t2) {
                                return AbstractC16870uu.compareValues(Long.valueOf(((Message) t).getWhen()), Long.valueOf(((Message) t2).getWhen()));
                            }
                        })) {
                            sessionLifecycleClient.m37613f(message);
                        }
                    }
                }
            }
