...
public final class IndexedValue<T> {
    ...
    public static /* synthetic */ IndexedValue copy$default(IndexedValue indexedValue, int i, Object obj, int i2, Object obj2) {
        if ((i2 & 1) != 0) {
            i = indexedValue.f68152a;
        }
        if ((i2 & 2) != 0) {
            obj = indexedValue.f68153b;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof IndexedValue) {
            ...
            return this.f68152a == indexedValue.f68152a && Intrinsics.areEqual(this.f68153b, indexedValue.f68153b);
        }
        return false;
    }
    ...
    public String toString() {
        return "IndexedValue(index=" + this.f68152a + ", value=" + this.f68153b + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
}