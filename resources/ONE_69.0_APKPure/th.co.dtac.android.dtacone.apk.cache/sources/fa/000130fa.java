...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.home.fragment.OneHomeFragment$navigateToOneDeviceSaleTrueAuthorization$1$1 */
/* loaded from: classes10.dex */
public final class OneHomeFragment$navigateToOneDeviceSaleTrueAuthorization$1$1 extends Lambda implements Function1<Resource<? extends OneDeviceSaleAuthorizationData>, Unit> {
    final /* synthetic */ OneHomeFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.home.fragment.OneHomeFragment$navigateToOneDeviceSaleTrueAuthorization$1$1$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneHomeFragment$navigateToOneDeviceSaleTrueAuthorization$1$1(OneHomeFragment oneHomeFragment) {
        super(1);
    ...
    public final void invoke2(Resource<OneDeviceSaleAuthorizationData> resource) {
        ...
        if (i == 1) {
            ...
            oneHomeFragment.dismissLoading();
            Intent intent = new Intent(oneHomeFragment.m14235R(), OneDeviceSaleTrueActivity.class);
            intent.putExtra(OneDeviceSaleTrueActivity.EXTRA_AUTHORIZATION_DEVICE_SALE, resourceContentIfNotHandled.getData());
            intent.putExtra("EXTRA_FEATURE_CODE", PermissionConstant.M_SALE_ORDR);
