...
public class setPivotY implements setDarkTextColor.valueOf {
    public static final setPivotY get = new setPivotY();

    @Override // com.netcetera.threeds.sdk.infrastructure.setDarkTextColor.valueOf
    public getHeadingTextColor values() {
        return setDarkTextColor.setOnContextClickListener();
    }
}