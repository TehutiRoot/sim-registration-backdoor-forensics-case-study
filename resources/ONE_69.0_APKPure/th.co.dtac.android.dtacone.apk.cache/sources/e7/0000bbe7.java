...
public class getDarkModeSupported implements setDarkTextColor.valueOf {
    private final setDarkTextColor get;
    private final setDarkTextColor.ThreeDS2Service values;

    public getDarkModeSupported(setDarkTextColor setdarktextcolor, setDarkTextColor.ThreeDS2Service threeDS2Service) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.restrictedParameters(this.get, this.values);
    }
}