...
public final class LazyGridDslKt$rememberColumnWidthSums$1$1 extends Lambda implements Function2<Density, Constraints, LazyGridSlots> {
    ...
    public /* bridge */ /* synthetic */ LazyGridSlots invoke(Density density, Constraints constraints) {
        return m69803invoke0kLqBqw(density, constraints.m73816unboximpl());
    }

    @NotNull
    /* renamed from: invoke-0kLqBqw  reason: not valid java name */
    public final LazyGridSlots m69803invoke0kLqBqw(@NotNull Density $receiver, long j) {
        Intrinsics.checkNotNullParameter($receiver, "$this$$receiver");
        if (Constraints.m73810getMaxWidthimpl(j) != Integer.MAX_VALUE) {
            PaddingValues paddingValues = this.$contentPadding;
            LayoutDirection layoutDirection = LayoutDirection.Ltr;
            int m73810getMaxWidthimpl = Constraints.m73810getMaxWidthimpl(j) - $receiver.mo69616roundToPx0680j_4(C3623Dp.m73842constructorimpl(PaddingKt.calculateStartPadding(paddingValues, layoutDirection) + PaddingKt.calculateEndPadding(this.$contentPadding, layoutDirection)));
            GridCells gridCells = this.$columns;
            Arrangement.Horizontal horizontal = this.$horizontalArrangement;
            int[] intArray = CollectionsKt___CollectionsKt.toIntArray(gridCells.calculateCrossAxisCellSizes($receiver, m73810getMaxWidthimpl, $receiver.mo69616roundToPx0680j_4(horizontal.mo69668getSpacingD9Ej5fM())));
            int[] iArr = new int[intArray.length];
            horizontal.arrange($receiver, m73810getMaxWidthimpl, intArray, layoutDirection, iArr);
