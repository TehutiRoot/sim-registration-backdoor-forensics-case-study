...
public class UTF8StreamJsonParser extends ParserBase {
    ...
    /* renamed from: b */
    public static final int f43183b = JsonParser.Feature.ALLOW_TRAILING_COMMA.getMask();

    /* renamed from: c */
    public static final int f43184c = JsonParser.Feature.ALLOW_NUMERIC_LEADING_ZEROS.getMask();

    /* renamed from: d */
    public static final int f43185d = JsonParser.Feature.ALLOW_NON_NUMERIC_NUMBERS.getMask();

    /* renamed from: e */
    public static final int f43186e = JsonParser.Feature.ALLOW_MISSING_VALUES.getMask();

    /* renamed from: f */
    public static final int f43187f = JsonParser.Feature.ALLOW_SINGLE_QUOTES.getMask();

    /* renamed from: g */
    public static final int f43188g = JsonParser.Feature.ALLOW_UNQUOTED_FIELD_NAMES.getMask();

    /* renamed from: h */
    public static final int f43189h = JsonParser.Feature.ALLOW_COMMENTS.getMask();

    /* renamed from: i */
    public static final int f43190i = JsonParser.Feature.ALLOW_YAML_COMMENTS.getMask();

    /* renamed from: j */
    public static final int[] f43191j = CharTypes.getInputCodeUtf8();
    ...
    /* renamed from: A */
    private final int m49637A(int i) {
        ...
        this._inputPtr = i2 - 1;
        return m49595z(false);
    }

    /* renamed from: B */
    private final void m49636B() {
        if ((this._features & f43189h) == 0) {
    ...
    /* renamed from: K */
    private final boolean m49627K() {
        if ((this._features & f43190i) == 0) {
            return false;
        }
        m49635C();
        return true;
    ...
    /* renamed from: O */
    private final void m49623O(int i) {
    ...
    */
    private final java.lang.String m49622P(int[] r17, int r18, int r19) {
        /*
            Method dump skipped, instructions count: 260
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.json.UTF8StreamJsonParser.m49622P(int[], int, int):java.lang.String");
    }

    /* renamed from: Q */
    private final String m49621Q(int i, int i2) {
        ...
        iArr[0] = _padLastQuad;
        return m49622P(iArr, 1, i2);
    }

    /* renamed from: R */
    private final String m49620R(int i, int i2, int i3) {
        ...
        iArr[0] = i;
        iArr[1] = _padLastQuad;
        return m49622P(iArr, 2, i3);
    }

    /* renamed from: S */
    private final String m49619S(int i, int i2, int i3, int i4) {
        ...
        return m49622P(iArr, 3, i4);
    }

    /* renamed from: T */
    private final String m49618T(int[] iArr, int i, int i2, int i3) {
        if (i >= iArr.length) {
        ...
        if (findName == null) {
            return m49622P(iArr, i4, i3);
        }
        return findName;
    }

    /* renamed from: V */
    private final String m49616V(int i, int i2, int i3) {
        return parseEscapedName(this._quadBuffer, 0, i, i2, i3);
    }

    /* renamed from: W */
    private final String m49615W(int i, int i2, int i3, int i4) {
        int[] iArr = this._quadBuffer;
        iArr[0] = i;
    ...
    /* renamed from: X */
    private final String m49614X(int i, int i2, int i3, int i4, int i5) {
        int[] iArr = this._quadBuffer;
        iArr[0] = i;
        iArr[1] = i2;
    ...
    /* renamed from: g */
    private final void m49613g(String str, int i, int i2) {
    ...
    /* renamed from: l */
    private final int m49609l(int i) {
        if (this._inputPtr >= this._inputEnd) {
            _loadMoreGuaranteed();
        }
        byte[] bArr = this._inputBuffer;
    ...
    /* renamed from: m */
    private final int m49608m(int i) {
        if (this._inputPtr >= this._inputEnd) {
            _loadMoreGuaranteed();
        }
        int i2 = i & 15;
    ...
    /* renamed from: o */
    private final int m49606o(int i) {
        if (this._inputPtr >= this._inputEnd) {
            _loadMoreGuaranteed();
        }
        byte[] bArr = this._inputBuffer;
    ...
    /* renamed from: r */
    private final void m49603r(int i) {
    ...
    /* renamed from: s */
    private final void m49602s(String str, int i) {
        int i2;
        int i3;
    ...
    /* renamed from: t */
    private final JsonToken m49601t() {
    ...
    /* renamed from: u */
    private final JsonToken m49600u(int i) {
        if (i == 34) {
            this._tokenIncomplete = true;
    ...
    /* renamed from: v */
    private final JsonToken m49599v(char[] cArr, int i, int i2, boolean z, int i3) {
        int i4;
        boolean z2;
        int i5 = 0;
        if (i2 == 46) {
    ...
    */
    private final void m49597x() {
        ...
        L6e:
            ...
            goto L4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.json.UTF8StreamJsonParser.m49597x():void");
    }

    /* renamed from: y */
    private final int m49596y() {
        int i = this._inputPtr;
    ...
    /* renamed from: z */
    private final int m49595z(boolean z) {
        while (true) {
            if (this._inputPtr >= this._inputEnd && !_loadMore()) {
    ...
    /* renamed from: F */
    public final void m49632F(int i) {
        if (this._inputPtr >= this._inputEnd) {
            _loadMoreGuaranteed();
        }
        byte[] bArr = this._inputBuffer;
    ...
    */
    ...
    public String _finishAndReturnString() throws IOException {
        ...
        this._inputPtr = i;
        m49605p(emptyAndGetCurrentSegment, i2);
    ...
    public final String _getText2(JsonToken jsonToken) {
        ...
        int m49778id = jsonToken.m49778id();
        if (m49778id != 5) {
            if (m49778id != 6 && m49778id != 7 && m49778id != 8) {
    ...
    */
    public com.fasterxml.jackson.core.JsonToken _handleApos() throws java.io.IOException {
        /*
            ...
            int[] r1 = com.fasterxml.jackson.core.json.UTF8StreamJsonParser.f43191j
        ...
        L8c:
            ...
            int r5 = r5 - r7
            if (r5 < r8) goto L96
            int r6 = r10.m49607n(r6)
            goto La4
        L96:
            int r6 = r10.m49608m(r6)
            goto La4
        L9b:
            int r6 = r10.m49609l(r6)
            goto La4
        La0:
    ...
    public String _handleOddName(int i) throws IOException {
        if (i == 39 && (this._features & f43187f) != 0) {
            return _parseAposName();
        }
        if ((this._features & f43188g) == 0) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:28:0x0050, code lost:
        if ((r3._features & com.fasterxml.jackson.core.json.UTF8StreamJsonParser.f43186e) == 0) goto L32;
     */
    ...
    */
    public com.fasterxml.jackson.core.JsonToken _handleUnexpectedValue(int r4) throws java.io.IOException {
        ...
        L4b:
            int r0 = r3._features
            int r2 = com.fasterxml.jackson.core.json.UTF8StreamJsonParser.f43186e
            r0 = r0 & r2
            if (r0 == 0) goto L5a
            int r4 = r3._inputPtr
            int r4 = r4 - r1
        ...
        L60:
            ...
            int r1 = r3._features
            int r2 = com.fasterxml.jackson.core.json.UTF8StreamJsonParser.f43185d
            r1 = r1 & r2
            if (r1 == 0) goto L73
        ...
        L92:
            int r0 = r3._features
            int r1 = com.fasterxml.jackson.core.json.UTF8StreamJsonParser.f43187f
            r0 = r0 & r1
            if (r0 == 0) goto L9e
    ...
    public final void _matchNull() throws IOException {
        ...
        m49602s(AbstractJsonLexerKt.NULL, 1);
    }
    ...
    public final JsonToken _parseFloatThatStartsWithPeriod() throws IOException {
        ...
        return m49599v(this._textBuffer.emptyAndGetCurrentSegment(), 0, 46, false, 0);
    }
                ...
                if (iArr[i9] == 0) {
                    ...
                    if (iArr[i12] == 0) {
                        ...
                        if (iArr[i14] == 0) {
                            ...
                            return m49621Q(i13, 4);
                        } else {
                            return m49616V(i13, i14, 4);
                        }
                    } else if (i12 == 34) {
                        return m49621Q(i10, 3);
                    } else {
                        return m49616V(i10, i12, 3);
                    }
                } else if (i9 == 34) {
                    return m49621Q(i7, 2);
                } else {
                    return m49616V(i7, i9, 2);
                }
            } else if (i6 == 34) {
                return m49621Q(i4, 1);
            } else {
                return m49616V(i4, i6, 1);
            }
        } else if (i4 == 34) {
            return "";
        } else {
            return m49616V(0, i4, 0);
        }
    }
    ...
    public JsonToken _parseNegNumber() throws IOException {
        ...
        while (true) {
            i = this._inputPtr;
            if (i >= min) {
                return m49598w(emptyAndGetCurrentSegment, i5, true, i6);
            }
            byte[] bArr2 = this._inputBuffer;
            this._inputPtr = i + 1;
            i2 = bArr2[i] & 255;
        ...
        return m49599v(emptyAndGetCurrentSegment, i5, i2, true, i6);
    }
    ...
    public JsonToken _parsePosNumber(int i) throws IOException {
        ...
        while (true) {
            i2 = this._inputPtr;
            if (i2 >= min) {
                return m49598w(emptyAndGetCurrentSegment, i4, false, i5);
            }
            byte[] bArr = this._inputBuffer;
            this._inputPtr = i2 + 1;
            i3 = bArr[i2] & 255;
        ...
        return m49599v(emptyAndGetCurrentSegment, i4, i3, false, i5);
    }
    ...
    */
    ...
    /* renamed from: k */
    public final JsonToken m49610k(int i) {
        if (i == 125) {
            m49611j();
    ...
    /* renamed from: n */
    public final int m49607n(int i) {
        int i2 = i & 15;
        byte[] bArr = this._inputBuffer;
        int i3 = this._inputPtr;
        int i4 = i3 + 1;
    ...
    public boolean nextFieldName(SerializableString serializableString) throws IOException {
        ...
        if (m49629I == 93) {
            ...
            if (this._parsingContext.expectComma()) {
                if (m49629I != 44) {
                    _reportUnexpectedChar(m49629I, "was expecting comma to separate " + this._parsingContext.typeDesc() + " entries");
                }
                m49629I = m49631G();
                if ((this._features & f43183b) != 0 && (m49629I == 93 || m49629I == 125)) {
                    m49610k(m49629I);
                    return false;
                }
            }
            ...
            if (m49629I == 34) {
                ...
                if (i2 + length + 4 < this._inputEnd) {
                    ...
                    if (this._inputBuffer[i3] == 34) {
                        ...
                        m49603r(m49637A(i2 + 1));
                        return true;
                    }
                }
            }
            return m49604q(m49629I, serializableString);
        }
    }
    ...
    public JsonToken nextToken() throws IOException {
        ...
        if (m49629I == 93) {
            ...
            if (this._parsingContext.expectComma()) {
                ...
                m49629I = m49631G();
                if ((this._features & f43183b) != 0 && (m49629I == 93 || m49629I == 125)) {
                    return m49610k(m49629I);
                }
            }
            if (!this._parsingContext.inObject()) {
                m49626L();
                return m49600u(m49629I);
            }
            m49625M();
            this._parsingContext.setCurrentName(_parseName(m49629I));
            this._currToken = jsonToken2;
            int m49596y = m49596y();
            m49626L();
            if (m49596y == 34) {
                                ...
                                if (m49596y != 116) {
                                    if (m49596y != 123) {
                                        switch (m49596y) {
                                            ...
                                            case 56:
                                            case 57:
                                                _parseNegNumber = _parsePosNumber(m49596y);
                                                break;
                                            default:
                                                _parseNegNumber = _handleUnexpectedValue(m49596y);
                                                break;
                                        }
                                    } else {
    ...
    /* renamed from: p */
    public final void m49605p(char[] cArr, int i) {
        int[] iArr = f43191j;
        byte[] bArr = this._inputBuffer;
        while (true) {
            int i2 = this._inputPtr;
                            ...
                            if (i6 != 2) {
                                if (i6 != 3) {
                                    if (i6 != 4) {
                                        ...
                                        int m49606o = m49606o(i5);
                                        int i7 = i + 1;
                                        cArr[i] = (char) ((m49606o >> 10) | GeneratorBase.SURR1_FIRST);
                                        if (i7 >= cArr.length) {
                                            cArr = this._textBuffer.finishCurrentSegment();
                                            i = 0;
                                        } else {
                                        ...
                                        i5 = (m49606o & 1023) | 56320;
                                    }
                                } else {
                                    i5 = this._inputEnd - i4 >= 2 ? m49607n(i5) : m49608m(i5);
                                }
                            } else {
                                i5 = m49609l(i5);
                            }
    ...
    public final String parseLongName(int i, int i2, int i3) throws IOException {
        ...
        while (true) {
            ...
            if (i6 + 4 <= this._inputEnd) {
                ...
                if (iArr2[i8] != 0) {
                    if (i8 == 34) {
                        return m49618T(this._quadBuffer, i5, i4, 1);
                    }
                ...
                if (iArr2[i11] != 0) {
                    if (i11 == 34) {
                        return m49618T(this._quadBuffer, i5, i9, 2);
                    }
                ...
                if (iArr2[i14] != 0) {
                    if (i14 == 34) {
                        return m49618T(this._quadBuffer, i5, i12, 3);
                    }
                ...
                if (iArr2[i16] != 0) {
                    if (i16 == 34) {
                        return m49618T(this._quadBuffer, i5, i15, 4);
                    }
    ...
    public final String parseMediumName(int i) throws IOException {
        ...
        if (iArr[i4] != 0) {
            if (i4 == 34) {
                return m49620R(this.f43192a, i, 1);
            }
            return m49615W(this.f43192a, i, i4, 1);
        }
        int i5 = (i << 8) | i4;
        int i6 = i2 + 2;
        this._inputPtr = i6;
        ...
        if (iArr[i7] != 0) {
            if (i7 == 34) {
                return m49620R(this.f43192a, i5, 2);
            }
            return m49615W(this.f43192a, i5, i7, 2);
        }
        int i8 = (i5 << 8) | i7;
        int i9 = i2 + 3;
        this._inputPtr = i9;
        ...
        if (iArr[i10] != 0) {
            if (i10 == 34) {
                return m49620R(this.f43192a, i8, 3);
            }
            return m49615W(this.f43192a, i8, i10, 3);
        }
        int i11 = (i8 << 8) | i10;
        this._inputPtr = i2 + 4;
        int i12 = bArr[i9] & 255;
        if (iArr[i12] != 0) {
            if (i12 == 34) {
                return m49620R(this.f43192a, i11, 4);
            }
            return m49615W(this.f43192a, i11, i12, 4);
        }
    ...
    public final String parseMediumName2(int i, int i2) throws IOException {
        ...
        if (iArr[i5] != 0) {
            if (i5 == 34) {
                return m49619S(this.f43192a, i2, i, 1);
            }
            return m49614X(this.f43192a, i2, i, i5, 1);
        }
        int i6 = (i << 8) | i5;
        int i7 = i3 + 2;
        this._inputPtr = i7;
        ...
        if (iArr[i8] != 0) {
            if (i8 == 34) {
                return m49619S(this.f43192a, i2, i6, 2);
            }
            return m49614X(this.f43192a, i2, i6, i8, 2);
        }
        int i9 = (i6 << 8) | i8;
        int i10 = i3 + 3;
        this._inputPtr = i10;
        ...
        if (iArr[i11] != 0) {
            if (i11 == 34) {
                return m49619S(this.f43192a, i2, i9, 3);
            }
            return m49614X(this.f43192a, i2, i9, i11, 3);
        }
        int i12 = (i9 << 8) | i11;
        this._inputPtr = i3 + 4;
        ...
        if (iArr[i13] != 0) {
            if (i13 == 34) {
                return m49619S(this.f43192a, i2, i12, 4);
            }
            return m49614X(this.f43192a, i2, i12, i13, 4);
        }
        return parseLongName(i13, i2, i12);
    }

    /* renamed from: q */
    public final boolean m49604q(int i, SerializableString serializableString) {
        JsonToken _parseNegNumber;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:27:0x005e, code lost:
        m49623O(r6._inputBuffer[r6._inputPtr] & 255);
     */
    /* JADX WARN: Code restructure failed: missing block: B:29:0x006d, code lost:
        return resetInt(r9, r5);
     */
    /* JADX WARN: Code restructure failed: missing block: B:31:0x0074, code lost:
        return m49599v(r1, r2, r3, r9, r5);
     */
    /* renamed from: w */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final com.fasterxml.jackson.core.JsonToken m49598w(char[] r7, int r8, boolean r9, int r10) {
        /*
            r6 = this;
            r1 = r7
            r2 = r8
        ...
        L6e:
            r0 = r6
            r4 = r9
            com.fasterxml.jackson.core.JsonToken r7 = r0.m49599v(r1, r2, r3, r4, r5)
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.json.UTF8StreamJsonParser.m49598w(char[], int, boolean, int):com.fasterxml.jackson.core.JsonToken");
    }
    ...
    public String nextFieldName() throws IOException {
        ...
        if (m49629I == 93) {
            ...
            m49625M();
            String _parseName = _parseName(m49629I);
            this._parsingContext.setCurrentName(_parseName);
            this._currToken = jsonToken2;
            int m49596y = m49596y();
            m49626L();
