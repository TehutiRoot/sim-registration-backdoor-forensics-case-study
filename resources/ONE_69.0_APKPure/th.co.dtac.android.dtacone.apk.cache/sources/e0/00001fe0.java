...
public final class SequentialExecutor implements Executor {
    ...
    /* renamed from: a */
    public final Deque f11409a = new ArrayDeque();

    /* renamed from: c */
    public final RunnableC2525b f11411c = new RunnableC2525b();

    /* renamed from: d */
    public WorkerRunningState f11412d = WorkerRunningState.IDLE;
    ...
    public class RunnableC2524a implements Runnable {
        ...
        public RunnableC2524a(Runnable runnable) {
    ...
    /* loaded from: classes.dex */
    public final class RunnableC2525b implements Runnable {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:30:0x0052, code lost:
            androidx.camera.core.Logger.m63175e("SequentialExecutor", "Exception while executing runnable " + r3, r2);
         */
        ...
        */
        public final void m62788a() {
            ...
            L2:
                ...
                java.util.Deque r2 = r2.f11409a     // Catch: java.lang.Throwable -> L4f
                ...
                androidx.camera.core.impl.utils.executor.SequentialExecutor$WorkerRunningState r3 = r0.f11412d     // Catch: java.lang.Throwable -> L1c
            ...
            L1c:
                ...
                goto L69
            L1e:
                long r5 = r0.f11413e     // Catch: java.lang.Throwable -> L1c
                r7 = 1
                long r5 = r5 + r7
                r0.f11413e = r5     // Catch: java.lang.Throwable -> L1c
                r0.f11412d = r4     // Catch: java.lang.Throwable -> L1c
                r0 = 1
            L28:
                ...
                java.util.Deque r3 = r3.f11409a     // Catch: java.lang.Throwable -> L1c
                ...
                r0.f11412d = r3     // Catch: java.lang.Throwable -> L1c
                monitor-exit(r2)     // Catch: java.lang.Throwable -> L1c
                if (r1 == 0) goto L44
                java.lang.Thread r0 = java.lang.Thread.currentThread()
                r0.interrupt()
            ...
            L51:
                ...
                androidx.camera.core.Logger.m63175e(r4, r3, r2)     // Catch: java.lang.Throwable -> L4f
                goto L2
            L69:
                monitor-exit(r2)     // Catch: java.lang.Throwable -> L1c
            ...
            L74:
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.camera.core.impl.utils.executor.SequentialExecutor.RunnableC2525b.m62788a():void");
        }
        ...
        public void run() {
            try {
                ...
                synchronized (SequentialExecutor.this.f11409a) {
                    SequentialExecutor.this.f11412d = WorkerRunningState.IDLE;
                    throw e;
                }
            }
        }
    ...
    */
    public void execute(java.lang.Runnable r8) {
        /*
            ...
            java.util.Deque r0 = r7.f11409a
            monitor-enter(r0)
            androidx.camera.core.impl.utils.executor.SequentialExecutor$WorkerRunningState r1 = r7.f11412d     // Catch: java.lang.Throwable -> L6d
            ...
            goto L6f
        L11:
            long r3 = r7.f11413e     // Catch: java.lang.Throwable -> L6d
            ...
            java.util.Deque r8 = r7.f11409a     // Catch: java.lang.Throwable -> L6d
            ...
            r7.f11412d = r8     // Catch: java.lang.Throwable -> L6d
            monitor-exit(r0)     // Catch: java.lang.Throwable -> L6d
            java.util.concurrent.Executor r0 = r7.f11410b     // Catch: java.lang.Error -> L44 java.lang.RuntimeException -> L46
            androidx.camera.core.impl.utils.executor.SequentialExecutor$b r5 = r7.f11411c     // Catch: java.lang.Error -> L44 java.lang.RuntimeException -> L46
            r0.execute(r5)     // Catch: java.lang.Error -> L44 java.lang.RuntimeException -> L46
            androidx.camera.core.impl.utils.executor.SequentialExecutor$WorkerRunningState r0 = r7.f11412d
            if (r0 == r8) goto L2e
            return
        L2e:
            java.util.Deque r0 = r7.f11409a
            monitor-enter(r0)
            long r5 = r7.f11413e     // Catch: java.lang.Throwable -> L3e
            int r1 = (r5 > r3 ? 1 : (r5 == r3 ? 0 : -1))
            if (r1 != 0) goto L40
            androidx.camera.core.impl.utils.executor.SequentialExecutor$WorkerRunningState r1 = r7.f11412d     // Catch: java.lang.Throwable -> L3e
            if (r1 != r8) goto L40
            r7.f11412d = r2     // Catch: java.lang.Throwable -> L3e
            goto L40
        L3e:
            r8 = move-exception
            goto L42
        ...
        L46:
            r8 = move-exception
        L47:
            java.util.Deque r2 = r7.f11409a
            monitor-enter(r2)
            androidx.camera.core.impl.utils.executor.SequentialExecutor$WorkerRunningState r0 = r7.f11412d     // Catch: java.lang.Throwable -> L55
        ...
        L55:
            ...
            goto L6b
        L57:
            java.util.Deque r0 = r7.f11409a     // Catch: java.lang.Throwable -> L55
        ...
        L6d:
            ...
            goto L76
        L6f:
            java.util.Deque r1 = r7.f11409a     // Catch: java.lang.Throwable -> L6d
