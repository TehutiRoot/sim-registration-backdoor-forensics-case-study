...
public class DeflateInputStream extends InputStream {
    ...
    /* renamed from: a */
    public final InputStream f73764a;
    ...
    public DeflateInputStream(InputStream inputStream) throws IOException {
        ...
        if (read != -1 && read2 != -1) {
            ...
            this.f73764a = new C12558a(pushbackInputStream, new Inflater(z));
            return;
        }
    ...
    public boolean markSupported() {
        return this.f73764a.markSupported();
    }

    @Override // java.io.InputStream
    public int read() throws IOException {
        return this.f73764a.read();
    }
    ...
    public long skip(long j) throws IOException {
        return this.f73764a.skip(j);
    }

    @Override // java.io.InputStream
    public int read(byte[] bArr) throws IOException {
        return this.f73764a.read(bArr);
    }

    @Override // java.io.InputStream
    public int read(byte[] bArr, int i, int i2) throws IOException {
        return this.f73764a.read(bArr, i, i2);
    }
}