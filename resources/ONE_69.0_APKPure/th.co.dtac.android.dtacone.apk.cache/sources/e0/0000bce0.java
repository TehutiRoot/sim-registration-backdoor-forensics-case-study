...
public final class EnumC9560load implements printStackTrace {
    public static long ThreeDS2Service = 0;
    public static final EnumC9560load ThreeDS2ServiceInstance;
    private static final /* synthetic */ EnumC9560load[] cleanup;
    ...
    static {
        ...
        EnumC9560load enumC9560load = new EnumC9560load(intern, 0, ((String) objArr2[0]).intern());
        ThreeDS2ServiceInstance = enumC9560load;
        cleanup = new EnumC9560load[]{enumC9560load};
        getSDKInfo = (getSDKVersion + 47) % 128;
    }

    private EnumC9560load(String str, int i, String str2) {
        this.get = str2;
    }
    ...
    */
    private static void get(int r8, char r9, java.lang.String r10, java.lang.String r11, java.lang.String r12, java.lang.Object[] r13) {
        ...
        L3b:
            ...
            long r6 = com.netcetera.threeds.sdk.infrastructure.EnumC9560load.ThreeDS2Service     // Catch: java.lang.Throwable -> L7c
            long r4 = r4 ^ r6
            int r2 = com.netcetera.threeds.sdk.infrastructure.EnumC9560load.valueOf     // Catch: java.lang.Throwable -> L7c
            long r6 = (long) r2     // Catch: java.lang.Throwable -> L7c
            long r4 = r4 ^ r6
            char r2 = com.netcetera.threeds.sdk.infrastructure.EnumC9560load.values     // Catch: java.lang.Throwable -> L7c
            long r6 = (long) r2     // Catch: java.lang.Throwable -> L7c
            long r4 = r4 ^ r6
        ...
        L87:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.netcetera.threeds.sdk.infrastructure.EnumC9560load.get(int, char, java.lang.String, java.lang.String, java.lang.String, java.lang.Object[]):void");
    }
    ...
    public static EnumC9560load[] values() {
        int i = getSDKInfo + 109;
        getSDKVersion = i % 128;
        if (i % 2 == 0) {
            return (EnumC9560load[]) cleanup.clone();
        }
        cleanup.clone();
        throw null;
    }
    ...
    public static EnumC9560load valueOf(String str) {
        int i = getSDKInfo + CameraActivity.REQUEST_CODE;
        getSDKVersion = i % 128;
        if (i % 2 == 0) {
            return (EnumC9560load) Enum.valueOf(EnumC9560load.class, str);
        }
        Enum.valueOf(EnumC9560load.class, str);
        throw null;
    }
}