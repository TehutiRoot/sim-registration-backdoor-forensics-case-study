...
public final class LazyJavaScope$resolveProperty$1 extends Lambda implements Function0<NullableLazyValue<? extends ConstantValue<?>>> {
    ...
    /* loaded from: classes6.dex */
    public static final class C117761 extends Lambda implements Function0<ConstantValue<?>> {
        final /* synthetic */ JavaField $field;
        final /* synthetic */ PropertyDescriptorImpl $propertyDescriptor;
        final /* synthetic */ LazyJavaScope this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C117761(LazyJavaScope lazyJavaScope, JavaField javaField, PropertyDescriptorImpl propertyDescriptorImpl) {
            super(0);
    ...
    public final NullableLazyValue<? extends ConstantValue<?>> invoke() {
        return this.this$0.getC().getStorageManager().createNullableLazyValue(new C117761(this.this$0, this.$field, this.$propertyDescriptor));
    }
}