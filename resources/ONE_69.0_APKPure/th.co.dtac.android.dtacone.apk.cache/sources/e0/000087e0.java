...
import com.fasterxml.jackson.core.p011io.SerializedString;
...
public class UnwrappingBeanPropertyWriter extends BeanPropertyWriter implements Serializable {
    ...
    /* loaded from: classes3.dex */
    public class C6121a extends JsonFormatVisitorWrapper.Base {

        /* renamed from: a */
        public final /* synthetic */ JsonObjectFormatVisitor f43429a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C6121a(SerializerProvider serializerProvider, JsonObjectFormatVisitor jsonObjectFormatVisitor) {
            super(serializerProvider);
            this.f43429a = jsonObjectFormatVisitor;
        }
    ...
    public void depositSchemaProperty(JsonObjectFormatVisitor jsonObjectFormatVisitor, SerializerProvider serializerProvider) throws JsonMappingException {
        ...
        if (unwrappingSerializer.isUnwrappingSerializer()) {
            unwrappingSerializer.acceptJsonFormatVisitor(new C6121a(serializerProvider, jsonObjectFormatVisitor), getType());
        } else {
