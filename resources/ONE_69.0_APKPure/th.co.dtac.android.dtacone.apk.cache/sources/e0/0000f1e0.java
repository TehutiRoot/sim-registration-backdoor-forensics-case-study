...
public class AutoRetryHttpClient implements HttpClient {
    ...
    public ClientConnectionManager getConnectionManager() {
        return this.f74140a.getConnectionManager();
    }

    @Override // org.apache.http.client.HttpClient
    public HttpParams getParams() {
        return this.f74140a.getParams();
    }
    ...
    public HttpResponse execute(HttpHost httpHost, HttpRequest httpRequest, HttpContext httpContext) throws IOException {
        int i = 1;
        while (true) {
            HttpResponse execute = this.f74140a.execute(httpHost, httpRequest, httpContext);
            try {
                if (!this.f74141b.retryRequest(execute, i, httpContext)) {
                    return execute;
                }
                EntityUtils.consume(execute.getEntity());
                long retryInterval = this.f74141b.getRetryInterval();
                try {
                    Log log = this.f74142c;
                ...
                try {
                    ...
                    this.f74142c.warn("I/O error consuming response content", e2);
                }
                throw e;
            }
        }
