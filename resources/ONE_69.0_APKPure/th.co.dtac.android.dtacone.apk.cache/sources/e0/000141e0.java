...
@SourceDebugExtension({"SMAP\nDeviceSelectScreen.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DeviceSelectScreen.kt\nth/co/dtac/android/dtacone/view/appOne/tol/screen/device/ComposableSingletons$DeviceSelectScreenKt$lambda-7$1$4$1\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,796:1\n1549#2:797\n1620#2,3:798\n*S KotlinDebug\n*F\n+ 1 DeviceSelectScreen.kt\nth/co/dtac/android/dtacone/view/appOne/tol/screen/device/ComposableSingletons$DeviceSelectScreenKt$lambda-7$1$4$1\n*L\n736#1:797\n736#1:798,3\n*E\n"})
/* renamed from: th.co.dtac.android.dtacone.view.appOne.tol.screen.device.ComposableSingletons$DeviceSelectScreenKt$lambda-7$1$4$1  reason: invalid class name */
/* loaded from: classes10.dex */
public final class ComposableSingletons$DeviceSelectScreenKt$lambda7$1$4$1 extends Lambda implements Function1<String, Unit> {
    final /* synthetic */ MutableState<List<DeviceMeshItem>> $meshList$delegate;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ComposableSingletons$DeviceSelectScreenKt$lambda7$1$4$1(MutableState<List<DeviceMeshItem>> mutableState) {
        super(1);
