...
public class SubpackagesScope extends MemberScopeImpl {
    ...
    public Collection<DeclarationDescriptor> getContributedDescriptors(@NotNull DescriptorKindFilter kindFilter, @NotNull Function1<? super Name, Boolean> nameFilter) {
        ...
        if (this.f68886b.isRoot() && kindFilter.getExcludes().contains(DescriptorKindExclude.TopLevelPackages.INSTANCE)) {
            return CollectionsKt__CollectionsKt.emptyList();
        }
        Collection<FqName> subPackagesOf = this.f68885a.getSubPackagesOf(this.f68886b, nameFilter);
    ...
    public final PackageViewDescriptor getPackage(@NotNull Name name) {
        ...
        ModuleDescriptor moduleDescriptor = this.f68885a;
        FqName child = this.f68886b.child(name);
    ...
    public String toString() {
        return "subpackages of " + this.f68886b + " from " + this.f68885a;
    }
}