...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.home.HomeViewModel$callRedeemNoti$1 */
/* loaded from: classes9.dex */
public final class HomeViewModel$callRedeemNoti$1 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ HomeViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public HomeViewModel$callRedeemNoti$1(HomeViewModel homeViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable it) {
        ...
        m2581s.setValue(Resource.Companion.success(Boolean.FALSE));
    }
}