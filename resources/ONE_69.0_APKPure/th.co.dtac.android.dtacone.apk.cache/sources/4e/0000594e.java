...
public final class ListItemKt$ListItem$decoratedOverlineContent$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        ListItemKt.m60578c(this.$colors.overlineColor$material3_release(composer, (this.$$dirty >> 18) & 14).getValue().m71929unboximpl(), ListTokens.INSTANCE.getListItemOverlineFont(), this.$it, composer, 48);
        if (ComposerKt.isTraceInProgress()) {
