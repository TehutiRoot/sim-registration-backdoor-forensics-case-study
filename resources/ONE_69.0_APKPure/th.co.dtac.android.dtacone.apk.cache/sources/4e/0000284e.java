...
public abstract class BringIntoViewChildNode extends Modifier.Node implements ModifierLocalModifierNode, LayoutAwareModifierNode, CompositionLocalConsumerModifierNode {
    ...
    /* renamed from: n */
    public final BringIntoViewParent f14021n = BringIntoViewResponder_androidKt.defaultBringIntoViewParent(this);

    /* renamed from: o */
    public LayoutCoordinates f14022o;

    /* renamed from: a */
    public final BringIntoViewParent m61046a() {
    ...
    public final LayoutCoordinates getLayoutCoordinates() {
        LayoutCoordinates layoutCoordinates = this.f14022o;
    ...
    public final BringIntoViewParent getParent() {
        BringIntoViewParent m61046a = m61046a();
        if (m61046a == null) {
            return this.f14021n;
        }
        return m61046a;
