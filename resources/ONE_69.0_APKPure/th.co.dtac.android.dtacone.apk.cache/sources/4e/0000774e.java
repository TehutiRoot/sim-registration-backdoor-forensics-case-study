...
public class PackageManagerHelper {
    ...
    /* renamed from: a */
    public static final String f38804a = Logger.tagWithPrefix("PackageManagerHelper");

    /* renamed from: a */
    public static int m52117a(Context context, String str) {
        return context.getPackageManager().getComponentEnabledSetting(new ComponentName(context, str));
    }

    /* renamed from: b */
    public static boolean m52116b(int i, boolean z) {
        return i == 0 ? z : i == 1;
    }

    public static boolean isComponentExplicitlyEnabled(@NonNull Context context, @NonNull Class<?> cls) {
        return m52116b(m52117a(context, cls.getName()), false);
    }
    ...
    public static void setComponentEnabled(@NonNull Context context, @NonNull Class<?> cls, boolean z) {
        ...
        try {
            if (z == m52116b(m52117a(context, cls.getName()), false)) {
