...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.viewModel.OneMnpViewModel$getMailingPostCodeInfo$2$1 */
/* loaded from: classes10.dex */
public final class OneMnpViewModel$getMailingPostCodeInfo$2$1 extends Lambda implements Function1<GetPostCodeInfoResponse, Unit> {
    final /* synthetic */ OneMnpViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneMnpViewModel$getMailingPostCodeInfo$2$1(OneMnpViewModel oneMnpViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull GetPostCodeInfoResponse response) {
        ...
        if (!response.getData().isEmpty()) {
            ...
            oneMnpViewModel.f92109a0 = data.getPostcode();
            oneMnpViewModel.f92117c0 = data.getProvinceCode();
            oneMnpViewModel.f92113b0 = String.valueOf(data.getPostcodeSequence());
        }
    }
}