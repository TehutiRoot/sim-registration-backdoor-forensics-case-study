...
public final class PhotoSizeSelectSmallKt {
    ...
    /* renamed from: a */
    public static ImageVector f16203a;

    @NotNull
    public static final ImageVector getPhotoSizeSelectSmall(@NotNull Icons.Filled filled) {
        Intrinsics.checkNotNullParameter(filled, "<this>");
        ImageVector imageVector = f16203a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Filled.PhotoSizeSelectSmall", C3623Dp.m73842constructorimpl(24.0f), C3623Dp.m73842constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
