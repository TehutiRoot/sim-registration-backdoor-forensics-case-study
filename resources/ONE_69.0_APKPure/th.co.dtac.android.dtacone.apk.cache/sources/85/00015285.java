...
/* renamed from: th.co.dtac.android.dtacone.view.fragment.otp_v3.OtpV3Fragment$setUpView$eventKeyDel$1 */
/* loaded from: classes9.dex */
public final class OtpV3Fragment$setUpView$eventKeyDel$1 extends Lambda implements Function0<Boolean> {
    final /* synthetic */ EditText $current;
    final /* synthetic */ KeyEvent $event;
    final /* synthetic */ EditText $previewView;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OtpV3Fragment$setUpView$eventKeyDel$1(KeyEvent keyEvent, EditText editText, EditText editText2) {
        super(0);
        this.$event = keyEvent;
