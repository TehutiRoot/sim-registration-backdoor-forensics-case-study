...
public final class Any extends GeneratedMessageLite<Any, Builder> implements AnyOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Any, Builder> implements AnyOrBuilder {
        public /* synthetic */ Builder(C4314a c4314a) {
            this();
        }

        public Builder clearTypeUrl() {
            copyOnWrite();
            ((Any) this.instance).m56149w();
            return this;
        }

        public Builder clearValue() {
            copyOnWrite();
            ((Any) this.instance).m56148x();
            return this;
        }
        ...
        public Builder setTypeUrl(String str) {
            copyOnWrite();
            ((Any) this.instance).m56147y(str);
            return this;
        }

        public Builder setTypeUrlBytes(ByteString byteString) {
            copyOnWrite();
            ((Any) this.instance).m56146z(byteString);
            return this;
        }

        public Builder setValue(ByteString byteString) {
            copyOnWrite();
            ((Any) this.instance).m56156A(byteString);
            return this;
        }
    ...
    /* loaded from: classes2.dex */
    public static /* synthetic */ class C4314a {
        ...
        static {
            ...
            try {
                f34749a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f34749a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f34749a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f34749a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f34749a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f34749a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: A */
    public final void m56156A(ByteString byteString) {
        byteString.getClass();
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C4314a.f34749a[methodToInvoke.ordinal()]) {
            case 1:
                return new Any();
            case 2:
    ...
    /* renamed from: w */
    public final void m56149w() {
        this.typeUrl_ = getDefaultInstance().getTypeUrl();
    }

    /* renamed from: y */
    public final void m56147y(String str) {
        str.getClass();
        this.typeUrl_ = str;
    }

    /* renamed from: z */
    public final void m56146z(ByteString byteString) {
        byteString.getClass();
