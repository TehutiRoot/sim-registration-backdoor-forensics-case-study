...
public final class ObservableTimer extends Observable<Long> {
    ...
    /* renamed from: a */
    public final Scheduler f65681a;

    /* renamed from: b */
    public final long f65682b;

    /* renamed from: c */
    public final TimeUnit f65683c;
    ...
    public ObservableTimer(long j, TimeUnit timeUnit, Scheduler scheduler) {
        this.f65682b = j;
        this.f65683c = timeUnit;
        this.f65681a = scheduler;
    }
    ...
    public void subscribeActual(Observer<? super Long> observer) {
        ...
        timerObserver.setResource(this.f65681a.scheduleDirect(timerObserver, this.f65682b, this.f65683c));
    }
}