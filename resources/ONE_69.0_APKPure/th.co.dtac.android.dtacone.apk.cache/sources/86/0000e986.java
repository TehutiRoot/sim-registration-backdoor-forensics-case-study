...
public final class C20983lc2 implements zzk {

    /* renamed from: a */
    public final zzqn f71758a;

    /* renamed from: b */
    public final String f71759b;

    public C20983lc2(zzqn zzqnVar, String str) {
        this.f71758a = zzqnVar;
        this.f71759b = str;
    }
    ...
    public final File zza(File file) {
        ...
        File m38382c = new zzi(this.f71758a).m38382c(this.f71759b, zzn.CUSTOM);
