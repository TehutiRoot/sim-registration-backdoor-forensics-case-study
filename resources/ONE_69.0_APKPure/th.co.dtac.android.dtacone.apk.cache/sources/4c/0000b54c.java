...
public final class zzn extends MobileVisionBase implements TextRecognizer {
    ...
    /* renamed from: g */
    public final TextRecognizerOptionsInterface f57191g;
    ...
    public zzn(TextRecognizerTaskWithResource textRecognizerTaskWithResource, Executor executor, zzuc zzucVar, TextRecognizerOptionsInterface textRecognizerOptionsInterface) {
        ...
        zzot zzotVar;
        this.f57191g = textRecognizerOptionsInterface;
        ...
        zzsaVar.zza(LoggingUtils.m37167a(textRecognizerOptionsInterface.getLoggingLanguageOption()));
    ...
    public final Feature[] getOptionalFeatures() {
        return TextOptionalModuleUtils.m37165a(this.f57191g);
    }
