...
public final class VelocityTracker1D {
    ...
    /* renamed from: b */
    public final Strategy f30115b;

    /* renamed from: c */
    public final int f30116c;

    /* renamed from: d */
    public final DataPointAtTime[] f30117d;
    ...
    /* renamed from: g */
    public final float[] f30120g;

    /* renamed from: h */
    public final float[] f30121h;

    @Metadata(m29143d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0004\b\u0080\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004¨\u0006\u0005"}, m29142d2 = {"Landroidx/compose/ui/input/pointer/util/VelocityTracker1D$Strategy;", "", "(Ljava/lang/String;I)V", "Lsq2", "Impulse", "ui_release"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    /* renamed from: a */
    public final float m59543a(float[] fArr, float[] fArr2, int i) {
        try {
            return VelocityTrackerKt.polyFitLeastSquares(fArr2, fArr, i, 2, this.f30121h)[1];
    ...
    public final void addDataPoint(long j, float f) {
        int i = (this.f30118e + 1) % 20;
        this.f30118e = i;
        VelocityTrackerKt.m59540c(this.f30117d, i, j, f);
    }

    public final float calculateVelocity() {
        float m59542a;
        float[] fArr = this.f30119f;
        float[] fArr2 = this.f30120g;
        int i = this.f30118e;
        DataPointAtTime dataPointAtTime = this.f30117d[i];
        ...
        while (true) {
            DataPointAtTime dataPointAtTime3 = this.f30117d[i];
        ...
        int i3 = WhenMappings.$EnumSwitchMapping$0[this.f30115b.ordinal()];
        if (i3 == 1) {
            m59542a = VelocityTrackerKt.m59542a(fArr, fArr2, i2, this.f30114a);
        } else if (i3 == 2) {
            m59542a = m59543a(fArr, fArr2, i2);
        } else {
    ...
    public final void resetTracking() {
        ArraysKt___ArraysJvmKt.fill$default(this.f30117d, (Object) null, 0, 0, 6, (Object) null);
        this.f30118e = 0;
    }
    ...
    public VelocityTracker1D(boolean z, @NotNull Strategy strategy) {
        ...
        this.f30116c = i2;
        this.f30117d = new DataPointAtTime[20];
        this.f30119f = new float[20];
        this.f30120g = new float[20];
        this.f30121h = new float[3];
    }
