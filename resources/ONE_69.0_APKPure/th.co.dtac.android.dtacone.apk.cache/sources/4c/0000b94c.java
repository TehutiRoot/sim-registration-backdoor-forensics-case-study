...
public final class ReplayRelay<T> extends Relay<T> {
    ...
    /* renamed from: c */
    public static final ReplayDisposable[] f58368c = new ReplayDisposable[0];

    /* renamed from: d */
    public static final Object[] f58369d = new Object[0];

    /* renamed from: a */
    public final InterfaceC9105a f58370a;

    /* renamed from: b */
    public final AtomicReference f58371b = new AtomicReference(f58368c);
    ...
    /* loaded from: classes5.dex */
    public static final class SizeAndTimeBoundReplayBuffer<T> extends AtomicReference<Object> implements InterfaceC9105a {
        ...
        @Override // com.jakewharton.rxrelay2.ReplayRelay.InterfaceC9105a
        public void add(T t) {
    ...
    /* loaded from: classes5.dex */
    public static final class SizeBoundReplayBuffer<T> extends AtomicReference<Object> implements InterfaceC9105a {
    ...
    /* loaded from: classes5.dex */
    public static final class UnboundedReplayBuffer<T> extends AtomicReference<Object> implements InterfaceC9105a {
    ...
    /* loaded from: classes5.dex */
    public interface InterfaceC9105a {
        void add(Object obj);
    ...
    public ReplayRelay(InterfaceC9105a interfaceC9105a) {
        this.f58370a = interfaceC9105a;
    }
    ...
    public void accept(T t) {
        if (t != null) {
            InterfaceC9105a interfaceC9105a = this.f58370a;
            interfaceC9105a.add(t);
            for (ReplayDisposable replayDisposable : (ReplayDisposable[]) this.f58371b.get()) {
                interfaceC9105a.replay(replayDisposable);
            }
            return;
        }
    ...
    /* renamed from: d */
    public boolean m33710d(ReplayDisposable replayDisposable) {
        ReplayDisposable[] replayDisposableArr;
        ReplayDisposable[] replayDisposableArr2;
        do {
            replayDisposableArr = (ReplayDisposable[]) this.f58371b.get();
            int length = replayDisposableArr.length;
            replayDisposableArr2 = new ReplayDisposable[length + 1];
            System.arraycopy(replayDisposableArr, 0, replayDisposableArr2, 0, length);
            replayDisposableArr2[length] = replayDisposable;
        } while (!AbstractC23094xo1.m479a(this.f58371b, replayDisposableArr, replayDisposableArr2));
        return true;
    }

    /* renamed from: e */
    public void m33709e(ReplayDisposable replayDisposable) {
        ReplayDisposable[] replayDisposableArr;
        ReplayDisposable[] replayDisposableArr2;
        do {
            replayDisposableArr = (ReplayDisposable[]) this.f58371b.get();
            if (replayDisposableArr == f58368c) {
                return;
            }
            int length = replayDisposableArr.length;
            int i = 0;
    ...
    public T getValue() {
        return (T) this.f58370a.getValue();
    }

    /* JADX WARN: Multi-variable type inference failed */
    public Object[] getValues() {
        Object[] objArr = f58369d;
    ...
    public boolean hasObservers() {
        if (((ReplayDisposable[]) this.f58371b.get()).length != 0) {
            return true;
        }
        return false;
    }
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        if (!replayDisposable.cancelled) {
            if (m33710d(replayDisposable) && replayDisposable.cancelled) {
                m33709e(replayDisposable);
            } else {
                this.f58370a.replay(replayDisposable);
            }
        }
    }
    ...
    public T[] getValues(T[] tArr) {
        return (T[]) this.f58370a.getValues(tArr);
    }
}