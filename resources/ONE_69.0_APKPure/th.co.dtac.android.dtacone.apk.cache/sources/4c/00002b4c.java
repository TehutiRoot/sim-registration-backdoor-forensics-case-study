...
public final class ExposedDropdownMenuKt$ExposedDropdownMenuBox$1 extends Lambda implements Function1<LayoutCoordinates, Unit> {
    ...
    /* loaded from: classes.dex */
    public static final class C31011 extends Lambda implements Function1<Integer, Unit> {
        final /* synthetic */ MutableIntState $menuHeight$delegate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C31011(MutableIntState mutableIntState) {
            super(1);
    ...
    public final void invoke2(@NotNull LayoutCoordinates it) {
        ...
        ExposedDropdownMenuKt.m60846b(this.$width$delegate, IntSize.m74002getWidthimpl(it.mo73000getSizeYbymL2g()));
        this.$coordinates.setValue(it);
        View rootView = this.$view.getRootView();
        Intrinsics.checkNotNullExpressionValue(rootView, "view.rootView");
        ExposedDropdownMenuKt.m60842f(rootView, this.$coordinates.getValue(), this.$verticalMarginInPx, new C31011(this.$menuHeight$delegate));
    }
}