...
public final class DropSequence$iterator$1 implements Iterator<T>, KMappedMarker {
    ...
    public DropSequence$iterator$1(DropSequence dropSequence) {
        Sequence sequence;
        int i;
        sequence = dropSequence.f70444a;
        this.f70446a = sequence.iterator();
        i = dropSequence.f70445b;
        this.f70447b = i;
    }

    /* renamed from: a */
    public final void m27773a() {
        while (this.f70447b > 0 && this.f70446a.hasNext()) {
            this.f70446a.next();
            this.f70447b--;
        }
    }
