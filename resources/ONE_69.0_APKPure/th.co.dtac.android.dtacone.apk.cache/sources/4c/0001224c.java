...
/* renamed from: th.co.dtac.android.dtacone.presenter.buy_dol.BuyDolTokenPresenter$getTokenObservable$1 */
/* loaded from: classes8.dex */
public final class BuyDolTokenPresenter$getTokenObservable$1 extends Lambda implements Function1<OmisePublicKey, ObservableSource<? extends Token>> {
    final /* synthetic */ Request<Token> $tokenRequest;
    final /* synthetic */ BuyDolTokenPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BuyDolTokenPresenter$getTokenObservable$1(BuyDolTokenPresenter buyDolTokenPresenter, Request<Token> request) {
        super(1);
    ...
    public final ObservableSource<? extends Token> invoke(@NotNull OmisePublicKey it) {
        ...
        m18669n = this.this$0.m18669n(this.$tokenRequest, it.getPublicKey());
        return m18669n;
    }
}