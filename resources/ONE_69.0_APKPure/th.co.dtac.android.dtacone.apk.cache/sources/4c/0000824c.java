...
public final class ChuckerCollector {
    ...
    /* renamed from: b */
    public final RetentionManager f42766b;

    /* renamed from: c */
    public final NotificationHelper f42767c;

    /* renamed from: d */
    public final CoroutineScope f42768d;
    ...
    public final void onRequestSent$com_github_ChuckerTeam_Chucker_library(@NotNull HttpTransaction transaction) {
        ...
        AbstractC1539Vc.m65885e(this.f42768d, null, null, new ChuckerCollector$onRequestSent$1(this, transaction, null), 3, null);
    }

    public final void onResponseReceived$com_github_ChuckerTeam_Chucker_library(@NotNull HttpTransaction transaction) {
        Intrinsics.checkNotNullParameter(transaction, "transaction");
        AbstractC1539Vc.m65885e(this.f42768d, null, null, new ChuckerCollector$onResponseReceived$1(this, transaction, null), 3, null);
    }
    ...
    public ChuckerCollector(@NotNull Context context, boolean z, @NotNull RetentionManager.Period retentionPeriod) {
        ...
        this.f42765a = z;
        this.f42766b = new RetentionManager(context, retentionPeriod);
        this.f42767c = new NotificationHelper(context);
        this.f42768d = CoroutineScopeKt.MainScope();
