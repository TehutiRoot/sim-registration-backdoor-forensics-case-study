...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.device_sale.fragment.OneDeviceSaleDeviceInfoFragment$setObserveViewModel$1$3 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleDeviceInfoFragment$setObserveViewModel$1$3 extends Lambda implements Function1<Resource<? extends Void>, Unit> {
    final /* synthetic */ OneDeviceSaleDeviceInfoFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneDeviceSaleDeviceInfoFragment$setObserveViewModel$1$3(OneDeviceSaleDeviceInfoFragment oneDeviceSaleDeviceInfoFragment) {
        super(1);
    ...
    public final void invoke2(Resource<Void> resource) {
        ...
        if (resourceContentIfNotHandled.getStatus() == StatusResource.SUCCESS) {
            oneDeviceSaleDeviceInfoFragment.hideKeyboard();
        }
    }
}