...
public final class ObservableTakeUntil<T, U> extends AbstractC11078a {

    /* renamed from: a */
    public final ObservableSource f65645a;
    ...
    public ObservableTakeUntil(ObservableSource<T> observableSource, ObservableSource<? extends U> observableSource2) {
        ...
        this.f65645a = observableSource2;
    }
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        this.f65645a.subscribe(takeUntilMainObserver.otherObserver);
