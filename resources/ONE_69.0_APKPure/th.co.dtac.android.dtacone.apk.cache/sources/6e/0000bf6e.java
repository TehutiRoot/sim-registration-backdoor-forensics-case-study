...
public class setVisibility implements setDarkTextColor.valueOf {
    private final setDarkTextColor get;

    public setVisibility(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.getLicenseExpiryDate(this.get);
    }
}