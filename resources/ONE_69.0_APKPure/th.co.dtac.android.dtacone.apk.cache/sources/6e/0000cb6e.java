...
public final class HttpConnectProxiedSocketAddress extends ProxiedSocketAddress {
    ...
    public static final class Builder {
        ...
        /* renamed from: a */
        public SocketAddress f63242a;

        /* renamed from: b */
        public InetSocketAddress f63243b;

        /* renamed from: c */
        public String f63244c;

        /* renamed from: d */
        public String f63245d;

        public HttpConnectProxiedSocketAddress build() {
            return new HttpConnectProxiedSocketAddress(this.f63242a, this.f63243b, this.f63244c, this.f63245d);
        }
        ...
        public Builder setProxyAddress(SocketAddress socketAddress) {
            this.f63242a = (SocketAddress) Preconditions.checkNotNull(socketAddress, "proxyAddress");
            return this;
        }

        public Builder setTargetAddress(InetSocketAddress inetSocketAddress) {
            this.f63243b = (InetSocketAddress) Preconditions.checkNotNull(inetSocketAddress, "targetAddress");
            return this;
        }
