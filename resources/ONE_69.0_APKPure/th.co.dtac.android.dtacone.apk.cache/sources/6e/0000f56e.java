...
public class PKIXNameConstraintValidator implements NameConstraintValidator {
    ...
    */
    ...
    private Set intersectIPRange(byte[] bArr, byte[] bArr2) {
        ...
        return compareTo(max(minMaxIPs[0], minMaxIPs[2]), min(minMaxIPs[1], minMaxIPs[3])) == 1 ? Collections.EMPTY_SET : Collections.singleton(ipWithSubnetMask(m24732or(minMaxIPs[0], minMaxIPs[2]), m24732or(bArr4, bArr6)));
    }
    ...
    /* renamed from: or */
    private static byte[] m24732or(byte[] bArr, byte[] bArr2) {
