...
/* renamed from: th.co.dtac.android.dtacone.presenter.address.QueryAddressPresenter$getMNPPostcodeWithCache$1 */
/* loaded from: classes8.dex */
public final class QueryAddressPresenter$getMNPPostcodeWithCache$1 extends Lambda implements Function1<List<? extends AddressItemData>, Boolean> {
    public static final QueryAddressPresenter$getMNPPostcodeWithCache$1 INSTANCE = new QueryAddressPresenter$getMNPPostcodeWithCache$1();

    public QueryAddressPresenter$getMNPPostcodeWithCache$1() {
        super(1);
    }
