...
public class CloudShellCredential extends GoogleCredential {
    ...
    public TokenResponse executeRefreshToken() throws IOException {
        ...
        try {
            ...
            tokenResponse.setAccessToken(((List) this.f51810v.createJsonParser(bufferedReader).parseArray(LinkedList.class, Object.class)).get(2).toString());
