...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.pre2post.fragment.OnePre2PostSignatureFragment$setupObserve$1$1 */
/* loaded from: classes10.dex */
public final class OnePre2PostSignatureFragment$setupObserve$1$1 extends Lambda implements Function1<Resource<? extends OneCommonResponse>, Unit> {
    final /* synthetic */ OnePre2PostSignatureFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.pre2post.fragment.OnePre2PostSignatureFragment$setupObserve$1$1$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OnePre2PostSignatureFragment$setupObserve$1$1(OnePre2PostSignatureFragment onePre2PostSignatureFragment) {
        super(1);
    ...
    public final void invoke2(Resource<OneCommonResponse> resource) {
        ...
        if (i == 1) {
            ...
            onePre2PostSignatureFragment.m11219t();
        } else if (i != 3) {
        } else {
            onePre2PostSignatureFragment.dismissLoading();
        }
