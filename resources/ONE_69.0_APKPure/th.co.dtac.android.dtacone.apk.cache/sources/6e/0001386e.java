...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.repository.OnePostpaidRepository$oneCommonGetPackage$1 */
/* loaded from: classes10.dex */
public final class OnePostpaidRepository$oneCommonGetPackage$1 extends Lambda implements Function1<OneCommonPackageResponse, List<? extends PriceplanListItem>> {
    public static final OnePostpaidRepository$oneCommonGetPackage$1 INSTANCE = new OnePostpaidRepository$oneCommonGetPackage$1();

    public OnePostpaidRepository$oneCommonGetPackage$1() {
        super(1);
    }
