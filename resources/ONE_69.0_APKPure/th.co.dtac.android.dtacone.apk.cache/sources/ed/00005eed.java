...
public final class TransparentObserverSnapshot extends Snapshot {
    ...
    /* renamed from: h */
    public final Function1 f28893h;

    /* renamed from: i */
    public final Function1 f28894i;

    /* renamed from: j */
    public final Snapshot f28895j;
    ...
    public TransparentObserverSnapshot(@Nullable Snapshot snapshot, @Nullable Function1<Object, Unit> function1, boolean z, boolean z2) {
        ...
        m59865f = SnapshotKt.m59865f(function1, readObserver$runtime_release, z);
        this.f28893h = m59865f;
        this.f28895j = this;
    }

    /* renamed from: a */
    public final Snapshot m59819a() {
        AtomicReference atomicReference;
        Snapshot snapshot = this.f28890e;
        if (snapshot == null) {
            atomicReference = SnapshotKt.f28837j;
    ...
    public void dispose() {
        ...
        if (this.f28892g && (snapshot = this.f28890e) != null) {
            snapshot.dispose();
        }
    }
    ...
    @Override // androidx.compose.runtime.snapshots.Snapshot
    public int getId() {
        return m59819a().getId();
    }

    @Override // androidx.compose.runtime.snapshots.Snapshot
    @NotNull
    public SnapshotIdSet getInvalid$runtime_release() {
        return m59819a().getInvalid$runtime_release();
    }

    @Override // androidx.compose.runtime.snapshots.Snapshot
    @Nullable
    public IdentityArraySet<StateObject> getModified$runtime_release() {
        return m59819a().getModified$runtime_release();
    }
    ...
    public boolean hasPendingChanges() {
        return m59819a().hasPendingChanges();
    }

    @Override // androidx.compose.runtime.snapshots.Snapshot
    public void notifyObjectsInitialized$runtime_release() {
        m59819a().notifyObjectsInitialized$runtime_release();
    }

    @Override // androidx.compose.runtime.snapshots.Snapshot
    public void recordModified$runtime_release(@NotNull StateObject state) {
        Intrinsics.checkNotNullParameter(state, "state");
        m59819a().recordModified$runtime_release(state);
    }
    ...
    public Snapshot takeNestedSnapshot(@Nullable Function1<Object, Unit> function1) {
        ...
        if (!this.f28891f) {
            m59867d = SnapshotKt.m59867d(m59819a().takeNestedSnapshot(null), m59864g, true);
            return m59867d;
        }
        return m59819a().takeNestedSnapshot(m59864g);
    }
