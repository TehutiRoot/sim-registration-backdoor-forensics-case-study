...
public final class EnumMultiset<E extends Enum<E>> extends AbstractC7940b implements Serializable {
    @GwtIncompatible
    ...
    /* loaded from: classes4.dex */
    public class C7591a extends AbstractC7594c {
        public C7591a() {
            super();
        }

        @Override // com.google.common.collect.EnumMultiset.AbstractC7594c
        /* renamed from: b */
        public Enum mo41018a(int i) {
    ...
    /* loaded from: classes4.dex */
    public class C7592b extends AbstractC7594c {

        /* renamed from: com.google.common.collect.EnumMultiset$b$a */
        /* loaded from: classes4.dex */
        public class C7593a extends Multisets.AbstractC7809f {

            /* renamed from: a */
            public final /* synthetic */ int f53112a;

            /* renamed from: b */
            public final /* synthetic */ C7592b f53113b;

            public C7593a(C7592b c7592b, int i) {
                this.f53112a = i;
                this.f53113b = c7592b;
            }
            ...
            public Enum getElement() {
                return EnumMultiset.this.enumConstants[this.f53112a];
            }

            @Override // com.google.common.collect.Multiset.Entry
            public int getCount() {
                return EnumMultiset.this.counts[this.f53112a];
            }
        }
        ...
        @Override // com.google.common.collect.EnumMultiset.AbstractC7594c
        /* renamed from: b */
        public Multiset.Entry mo41018a(int i) {
            return new C7593a(this, i);
        }
    }

    /* renamed from: com.google.common.collect.EnumMultiset$c */
    /* loaded from: classes4.dex */
    public abstract class AbstractC7594c implements Iterator {
        ...
        public boolean hasNext() {
            while (this.f53114a < EnumMultiset.this.enumConstants.length) {
        ...
        public Object next() {
            if (hasNext()) {
                Object mo41018a = mo41018a(this.f53114a);
                int i = this.f53114a;
                this.f53115b = i;
                this.f53114a = i + 1;
                return mo41018a;
        ...
        public void remove() {
            ...
            if (EnumMultiset.this.counts[this.f53115b] > 0) {
                EnumMultiset.access$210(EnumMultiset.this);
                EnumMultiset enumMultiset = EnumMultiset.this;
                EnumMultiset.access$322(enumMultiset, enumMultiset.counts[this.f53115b]);
                EnumMultiset.this.counts[this.f53115b] = 0;
            }
            this.f53115b = -1;
        }
    }
