...
public final class MaybeTimeoutPublisher<T, U> extends AbstractC1707Y {

    /* renamed from: a */
    public final Publisher f64952a;

    /* renamed from: b */
    public final MaybeSource f64953b;
    ...
    public MaybeTimeoutPublisher(MaybeSource<T> maybeSource, Publisher<U> publisher, MaybeSource<? extends T> maybeSource2) {
        super(maybeSource);
        this.f64952a = publisher;
        this.f64953b = maybeSource2;
    }

    @Override // io.reactivex.Maybe
    public void subscribeActual(MaybeObserver<? super T> maybeObserver) {
        TimeoutMainMaybeObserver timeoutMainMaybeObserver = new TimeoutMainMaybeObserver(maybeObserver, this.f64953b);
        maybeObserver.onSubscribe(timeoutMainMaybeObserver);
        this.f64952a.subscribe(timeoutMainMaybeObserver.other);
