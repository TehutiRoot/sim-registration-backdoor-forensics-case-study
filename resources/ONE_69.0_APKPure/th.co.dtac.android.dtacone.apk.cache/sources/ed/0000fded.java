    ...
    */
    private void populateFromPrivKeyInfo(org.bouncycastle.asn1.pkcs.PrivateKeyInfo r11) throws java.io.IOException {
        /*
            ...
            org.bouncycastle.asn1.x9.X962Parameters r0 = org.bouncycastle.asn1.p034x9.X962Parameters.getInstance(r0)
        ...
        L7c:
            org.bouncycastle.asn1.ASN1Primitive r0 = r0.getParameters()
            org.bouncycastle.asn1.x9.X9ECParameters r0 = org.bouncycastle.asn1.p034x9.X9ECParameters.getInstance(r0)
    ...
    public String toString() {
        ...
        stringBuffer.append(this.f75380d.toString(16));
        stringBuffer.append(lineSeparator);
    ...
    public JCEECPrivateKey(String str, ECPrivateKeySpec eCPrivateKeySpec) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f75380d = eCPrivateKeySpec.getS();
    ...
    public JCEECPrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f75380d = eCPrivateKeyParameters.getD();
        this.ecSpec = null;
    }
    ...
    public JCEECPrivateKey(String str, JCEECPrivateKey jCEECPrivateKey) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f75380d = jCEECPrivateKey.f75380d;
    ...
    public JCEECPrivateKey(String str, org.bouncycastle.jce.spec.ECPrivateKeySpec eCPrivateKeySpec) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f75380d = eCPrivateKeySpec.getD();
    ...
    public JCEECPrivateKey(ECPrivateKey eCPrivateKey) {
        this.algorithm = "EC";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f75380d = eCPrivateKey.getS();
