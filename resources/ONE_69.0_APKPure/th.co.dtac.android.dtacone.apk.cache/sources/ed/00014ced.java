...
/* renamed from: th.co.dtac.android.dtacone.view.fragment.eSIM.payment.ESimPostpaidPaymentFragment$initView$4$1 */
/* loaded from: classes9.dex */
public final class ESimPostpaidPaymentFragment$initView$4$1 extends Lambda implements Function1<CharSequence, Unit> {
    final /* synthetic */ ESimPostpaidPaymentFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimPostpaidPaymentFragment$initView$4$1(ESimPostpaidPaymentFragment eSimPostpaidPaymentFragment) {
        super(1);
        this.this$0 = eSimPostpaidPaymentFragment;
    }
    ...
    public final void invoke2(CharSequence charSequence) {
        ...
        if (text == null || text.length() == 0) {
            editText2 = this.this$0.f100865v;
            if (editText2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("etCreditCardAmount");
                editText2 = null;
            }
            ...
            if (text2 == null || text2.length() == 0) {
                editText3 = this.this$0.f100867x;
                if (editText3 == null) {
        ...
        try {
            ...
            editText4 = this.this$0.f100865v;
            if (editText4 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("etCreditCardAmount");
                editText4 = null;
            }
            ...
            if (bigDecimal2.compareTo(bigDecimal) != 1) {
                ...
                editText5 = this.this$0.f100867x;
                if (editText5 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("etCashRemainForCombine");
                } else {
                    editText6 = editText5;
