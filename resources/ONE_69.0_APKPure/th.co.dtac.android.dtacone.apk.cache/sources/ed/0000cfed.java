...
public final class FlowableRetryWhen<T> extends AbstractC0558I {

    /* renamed from: b */
    public final Function f64558b;
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        ...
        try {
            Publisher publisher = (Publisher) ObjectHelper.requireNonNull(this.f64558b.apply(serialized), "handler returned a null Publisher");
