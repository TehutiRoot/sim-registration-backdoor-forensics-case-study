...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.customerenquiry.SubscriberInfoViewModel$callCheckBlocking$4 */
/* loaded from: classes9.dex */
public final class SubscriberInfoViewModel$callCheckBlocking$4 extends Lambda implements Function1<CheckBlockingPackageTypeResponse, Unit> {
    final /* synthetic */ SubscriberInfoViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SubscriberInfoViewModel$callCheckBlocking$4(SubscriberInfoViewModel subscriberInfoViewModel) {
        super(1);
    ...
    public final void invoke2(CheckBlockingPackageTypeResponse checkBlockingPackageTypeResponse) {
        MutableLiveData m3085a0;
        m3085a0 = this.this$0.m3085a0();
        m3085a0.postValue(Resource.Companion.success(checkBlockingPackageTypeResponse));
    }
}