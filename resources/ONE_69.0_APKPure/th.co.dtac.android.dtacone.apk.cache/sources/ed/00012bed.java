...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.change_owner.viewModel.OneChangeOwnerValidateViewModel$validateCardTrue$1 */
/* loaded from: classes10.dex */
public final class OneChangeOwnerValidateViewModel$validateCardTrue$1 extends Lambda implements Function1<OneChangeOwnerValidateProfileRequest, SingleSource<? extends OneChangeOwnerValidateProfileResponse>> {
    final /* synthetic */ OneChangeOwnerValidateViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneChangeOwnerValidateViewModel$validateCardTrue$1(OneChangeOwnerValidateViewModel oneChangeOwnerValidateViewModel) {
        super(1);
