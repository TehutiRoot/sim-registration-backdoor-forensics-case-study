...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.pre2post.viewModel.OnePre2PostViewModel$getPackage$2 */
/* loaded from: classes10.dex */
public final class OnePre2PostViewModel$getPackage$2 extends Lambda implements Function1<List<? extends PriceplanListItem>, Unit> {
    final /* synthetic */ OnePre2PostViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePre2PostViewModel$getPackage$2(OnePre2PostViewModel onePre2PostViewModel) {
        super(1);
    ...
    public final void invoke2(List<PriceplanListItem> list) {
        ...
        m10875W0.setValue(Resource.Companion.success(list));
    }
}