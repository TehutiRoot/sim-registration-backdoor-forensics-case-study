...
public final class ImmutableIntArray implements Serializable {
    ...
    /* renamed from: of */
    public static ImmutableIntArray m39833of() {
        return EMPTY;
    }
    ...
    /* renamed from: of */
    public static ImmutableIntArray m39832of(int i) {
    ...
    public static final class Builder {
        ...
        /* renamed from: b */
        public int f54086b = 0;

        public Builder(int i) {
            this.f54085a = new int[i];
        }

        /* renamed from: b */
        public static int m39824b(int i, int i2) {
            if (i2 >= 0) {
                int i3 = i + (i >> 1) + 1;
                if (i3 < i2) {
        ...
        /* renamed from: a */
        public final void m39825a(int i) {
            int i2 = this.f54086b + i;
            int[] iArr = this.f54085a;
            if (i2 > iArr.length) {
                this.f54085a = Arrays.copyOf(iArr, m39824b(iArr.length, i2));
            }
        }
        ...
        public Builder addAll(int[] iArr) {
            m39825a(iArr.length);
            System.arraycopy(iArr, 0, this.f54085a, this.f54086b, iArr.length);
            this.f54086b += iArr.length;
            return this;
        }
        ...
        public ImmutableIntArray build() {
            ...
            return new ImmutableIntArray(this.f54085a, 0, this.f54086b);
        }
        ...
        public Builder addAll(ImmutableIntArray immutableIntArray) {
            m39825a(immutableIntArray.length());
            System.arraycopy(immutableIntArray.array, immutableIntArray.start, this.f54085a, this.f54086b, immutableIntArray.length());
            this.f54086b += immutableIntArray.length();
            return this;
        }
    }
    ...
    /* renamed from: of */
    public static ImmutableIntArray m39831of(int i, int i2) {
        return new ImmutableIntArray(new int[]{i, i2});
    }

    /* renamed from: of */
    public static ImmutableIntArray m39830of(int i, int i2, int i3) {
        return new ImmutableIntArray(new int[]{i, i2, i3});
    }

    /* renamed from: of */
    public static ImmutableIntArray m39829of(int i, int i2, int i3, int i4) {
        return new ImmutableIntArray(new int[]{i, i2, i3, i4});
    }

    /* renamed from: of */
    public static ImmutableIntArray m39828of(int i, int i2, int i3, int i4, int i5) {
        return new ImmutableIntArray(new int[]{i, i2, i3, i4, i5});
    }

    /* renamed from: of */
    public static ImmutableIntArray m39827of(int i, int i2, int i3, int i4, int i5, int i6) {
        return new ImmutableIntArray(new int[]{i, i2, i3, i4, i5, i6});
    }

    /* renamed from: of */
    public static ImmutableIntArray m39826of(int i, int... iArr) {
