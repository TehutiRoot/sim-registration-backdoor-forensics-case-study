...
public class PatternOptionBuilder {
    ...
    /* renamed from: a */
    public static final Converter f73088a = new Converter() { // from class: zk1
        @Override // org.apache.commons.cli.Converter
        public final Object apply(String str) {
            Object m25886b;
            m25886b = PatternOptionBuilder.m25886b(str);
            return m25886b;
        }
    };

    /* renamed from: b */
    public static /* synthetic */ Object m25886b(String str) {
        throw new UnsupportedOperationException("Not yet implemented");
    }

    /* renamed from: c */
    public static Object m25885c() {
        return f73088a;
    }
    ...
    public static Options parsePattern(String str) {
        ...
        while (true) {
            ...
            if (!isValueCode(charAt)) {
                ...
                createDefaultMap.put(FILES_VALUE, (Converter) m25885c());
