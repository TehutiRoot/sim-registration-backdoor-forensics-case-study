...
@DebugMetadata(m29093c = "androidx.compose.ui.platform.WindowRecomposer_androidKt$createLifecycleAwareWindowRecomposer$2$onStateChanged$1", m29092f = "WindowRecomposer.android.kt", m29091i = {0}, m29090l = {394}, m29089m = "invokeSuspend", m29088n = {"durationScaleJob"}, m29087s = {"L$0"})
...
public final class C3568x149b840a extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ Recomposer $recomposer;
    final /* synthetic */ C3567xff837ba9 $self;
    final /* synthetic */ LifecycleOwner $source;
    final /* synthetic */ Ref.ObjectRef<C17725Gt0> $systemDurationScaleSettingConsumer;
    final /* synthetic */ View $this_createLifecycleAwareWindowRecomposer;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C3568x149b840a(Ref.ObjectRef<C17725Gt0> objectRef, Recomposer recomposer, LifecycleOwner lifecycleOwner, C3567xff837ba9 c3567xff837ba9, View view, Continuation<? super C3568x149b840a> continuation) {
        super(2, continuation);
        this.$systemDurationScaleSettingConsumer = objectRef;
        this.$recomposer = recomposer;
        this.$source = lifecycleOwner;
        this.$self = c3567xff837ba9;
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        C3568x149b840a c3568x149b840a = new C3568x149b840a(this.$systemDurationScaleSettingConsumer, this.$recomposer, this.$source, this.$self, this.$this_createLifecycleAwareWindowRecomposer, continuation);
        c3568x149b840a.L$0 = obj;
        return c3568x149b840a;
    }
    ...
    */
    public final java.lang.Object invokeSuspend(@org.jetbrains.annotations.NotNull java.lang.Object r12) {
        ...
        L1f:
            ...
            kotlin.jvm.internal.Ref$ObjectRef<Gt0> r12 = r11.$systemDurationScaleSettingConsumer     // Catch: java.lang.Throwable -> L5d
            T r12 = r12.element     // Catch: java.lang.Throwable -> L5d
            Gt0 r12 = (p000.C17725Gt0) r12     // Catch: java.lang.Throwable -> L5d
            if (r12 == 0) goto L60
            ...
            kotlinx.coroutines.flow.StateFlow r1 = androidx.compose.p003ui.platform.WindowRecomposer_androidKt.access$getAnimationScaleFlowFor(r1)     // Catch: java.lang.Throwable -> L5d
            ...
            r12.m68194a(r5)     // Catch: java.lang.Throwable -> L5d
        ...
        L8b:
            ...
            throw r12
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.p003ui.platform.C3568x149b840a.invokeSuspend(java.lang.Object):java.lang.Object");
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((C3568x149b840a) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}