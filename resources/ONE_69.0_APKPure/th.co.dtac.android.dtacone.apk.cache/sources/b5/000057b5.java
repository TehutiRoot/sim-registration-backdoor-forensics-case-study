...
public final class CardColors {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (Color.m71920equalsimpl0(this.f25689a, cardColors.f25689a) && Color.m71920equalsimpl0(this.f25690b, cardColors.f25690b) && Color.m71920equalsimpl0(this.f25691c, cardColors.f25691c) && Color.m71920equalsimpl0(this.f25692d, cardColors.f25692d)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((Color.m71926hashCodeimpl(this.f25689a) * 31) + Color.m71926hashCodeimpl(this.f25690b)) * 31) + Color.m71926hashCodeimpl(this.f25691c)) * 31) + Color.m71926hashCodeimpl(this.f25692d);
    }
