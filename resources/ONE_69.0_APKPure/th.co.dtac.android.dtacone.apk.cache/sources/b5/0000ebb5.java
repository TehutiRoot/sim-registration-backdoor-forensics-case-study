...
public class CommonPagerTitleView extends FrameLayout implements IMeasurablePagerTitleView {
    ...
    /* renamed from: a */
    public OnPagerTitleChangeListener f72505a;

    /* renamed from: b */
    public ContentPositionDataProvider f72506b;
    ...
    public int getContentBottom() {
        ContentPositionDataProvider contentPositionDataProvider = this.f72506b;
    ...
    public void onDeselected(int i, int i2) {
        OnPagerTitleChangeListener onPagerTitleChangeListener = this.f72505a;
    ...
    public void setContentPositionDataProvider(ContentPositionDataProvider contentPositionDataProvider) {
        this.f72506b = contentPositionDataProvider;
    }
    ...
    public void setOnPagerTitleChangeListener(OnPagerTitleChangeListener onPagerTitleChangeListener) {
        this.f72505a = onPagerTitleChangeListener;
    }
