...
public final class MultiFormatReader implements Reader {
    ...
    /* renamed from: b */
    public Reader[] f57592b;

    /* renamed from: a */
    public final Result m34246a(BinaryBitmap binaryBitmap) {
        Reader[] readerArr = this.f57592b;
        if (readerArr != null) {
            for (Reader reader : readerArr) {
                try {
                    return reader.decode(binaryBitmap, this.f57591a);
    ...
    public void setHints(Map<DecodeHintType, ?> map) {
        ...
        this.f57592b = (Reader[]) arrayList.toArray(new Reader[arrayList.size()]);
    }
