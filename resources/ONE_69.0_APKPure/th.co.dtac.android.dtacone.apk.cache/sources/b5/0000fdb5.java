...
public class ECNamedCurveTable {
    public static Enumeration getNames() {
        return org.bouncycastle.asn1.p034x9.ECNamedCurveTable.getNames();
    }

    /* JADX WARN: Code restructure failed: missing block: B:8:0x0013, code lost:
        r0 = org.bouncycastle.asn1.p034x9.ECNamedCurveTable.getByName(r8);
     */
    /*
    ...
    */
    public static org.bouncycastle.jce.spec.ECNamedCurveParameterSpec getParameterSpec(java.lang.String r8) {
        /*
            org.bouncycastle.asn1.x9.X9ECParameters r0 = org.bouncycastle.crypto.p035ec.CustomNamedCurves.getByName(r8)
            if (r0 != 0) goto L24
            ...
            org.bouncycastle.asn1.x9.X9ECParameters r0 = org.bouncycastle.crypto.p035ec.CustomNamedCurves.getByOID(r1)     // Catch: java.lang.IllegalArgumentException -> L10
            goto L11
        L10:
        L11:
            if (r0 != 0) goto L24
            org.bouncycastle.asn1.x9.X9ECParameters r0 = org.bouncycastle.asn1.p034x9.ECNamedCurveTable.getByName(r8)
            if (r0 != 0) goto L24
            ...
            org.bouncycastle.asn1.x9.X9ECParameters r0 = org.bouncycastle.asn1.p034x9.ECNamedCurveTable.getByOID(r1)     // Catch: java.lang.IllegalArgumentException -> L23
            goto L24
        L23:
        L24:
            if (r0 != 0) goto L28
