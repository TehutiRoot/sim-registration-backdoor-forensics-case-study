...
public final class FloatingActionButtonKt$ExtendedFloatingActionButton$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        float f3 = this.$icon == null ? FloatingActionButtonKt.f14581d : FloatingActionButtonKt.f14580c;
        Modifier.Companion companion = Modifier.Companion;
        f = FloatingActionButtonKt.f14581d;
        Modifier m69717paddingqDBjuR0$default = PaddingKt.m69717paddingqDBjuR0$default(companion, f3, 0.0f, f, 0.0f, 10, null);
        ...
        if (function2 != null) {
            ...
            f2 = FloatingActionButtonKt.f14580c;
