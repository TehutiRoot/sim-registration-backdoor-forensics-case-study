...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.adapter.CampaignVerifyKeyAdapter$onBindViewHolder$6$1 */
/* loaded from: classes10.dex */
public final class CampaignVerifyKeyAdapter$onBindViewHolder$6$1 extends Lambda implements Function1<BirthDayCollection, Unit> {
    final /* synthetic */ RecyclerView.ViewHolder $holder;
    final /* synthetic */ VerifyKeyListItem $item;
    final /* synthetic */ CampaignVerifyKeyAdapter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CampaignVerifyKeyAdapter$onBindViewHolder$6$1(CampaignVerifyKeyAdapter campaignVerifyKeyAdapter, RecyclerView.ViewHolder viewHolder, VerifyKeyListItem verifyKeyListItem) {
        super(1);
        this.this$0 = campaignVerifyKeyAdapter;
    ...
    public final void invoke2(@NotNull BirthDayCollection birthDay) {
        ...
        this.this$0.f93259i = birthDay;
        ((CampaignVerifyKeyAdapter.BirthDateViewHolder) this.$holder).getBirthDayTextInputLayout().setText("");
        ((CampaignVerifyKeyAdapter.BirthDateViewHolder) this.$holder).getBirthDayTextInputLayout().setText(DateFormatExtKt.toThaiFormat(birthDay));
        ViewVisibleExtKt.toVisible(((CampaignVerifyKeyAdapter.BirthDateViewHolder) this.$holder).getBirthDayTextInputLayout());
        ViewVisibleExtKt.toGone(((CampaignVerifyKeyAdapter.BirthDateViewHolder) this.$holder).getTvHintBirthDay());
