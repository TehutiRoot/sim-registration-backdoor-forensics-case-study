...
public final class AppBarKt$TopAppBarLayout$2$measure$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke2(@NotNull Placeable.PlacementScope layout) {
        ...
        if (Intrinsics.areEqual(horizontal, arrangement.getCenter())) {
            max = (Constraints.m73810getMaxWidthimpl(this.$constraints) - this.$titlePlaceable.getWidth()) / 2;
        } else if (Intrinsics.areEqual(horizontal, arrangement.getEnd())) {
            max = (Constraints.m73810getMaxWidthimpl(this.$constraints) - this.$titlePlaceable.getWidth()) - this.$actionIconsPlaceable.getWidth();
        } else {
            MeasureScope measureScope = this.$this_Layout;
            f = AppBarKt.f25632i;
            max = Math.max(measureScope.mo69616roundToPx0680j_4(f), this.$navigationIconPlaceable.getWidth());
        }
        int i3 = max;
        ...
        if (Intrinsics.areEqual(vertical, arrangement.getCenter())) {
        ...
        } else if (Intrinsics.areEqual(vertical, arrangement.getBottom())) {
            ...
            Placeable.PlacementScope.placeRelative$default(layout, this.$actionIconsPlaceable, Constraints.m73810getMaxWidthimpl(this.$constraints) - this.$actionIconsPlaceable.getWidth(), (this.$layoutHeight - this.$actionIconsPlaceable.getHeight()) / 2, 0.0f, 4, null);
        }
        i = i2;
        Placeable.PlacementScope.placeRelative$default(layout, placeable2, i3, i, 0.0f, 4, null);
        Placeable.PlacementScope.placeRelative$default(layout, this.$actionIconsPlaceable, Constraints.m73810getMaxWidthimpl(this.$constraints) - this.$actionIconsPlaceable.getWidth(), (this.$layoutHeight - this.$actionIconsPlaceable.getHeight()) / 2, 0.0f, 4, null);
