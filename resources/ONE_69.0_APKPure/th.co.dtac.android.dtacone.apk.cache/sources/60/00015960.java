...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_pre2post.MrtrPre2PostViewModel$callAPIHardwareNumber$1$3 */
/* loaded from: classes9.dex */
public final class MrtrPre2PostViewModel$callAPIHardwareNumber$1$3 extends Lambda implements Function1<GetNewIMEIResponse, Unit> {
    final /* synthetic */ MrtrPre2PostViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrPre2PostViewModel$callAPIHardwareNumber$1$3(MrtrPre2PostViewModel mrtrPre2PostViewModel) {
        super(1);
    ...
    public final void invoke2(GetNewIMEIResponse getNewIMEIResponse) {
        ...
        m2172X.setValue(Resource.Companion.success(getNewIMEIResponse));
    }
}