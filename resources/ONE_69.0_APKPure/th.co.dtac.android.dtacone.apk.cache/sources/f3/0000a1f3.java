...
public class MaterialStyledDatePickerDialog extends DatePickerDialog {
    ...
    /* renamed from: c */
    public static final int f49828c = R.style.MaterialAlertDialog_MaterialComponents_Picker_Date_Spinner;

    /* renamed from: a */
    public final Drawable f49829a;

    /* renamed from: b */
    public final Rect f49830b;
    ...
    public void onCreate(Bundle bundle) {
        ...
        getWindow().setBackgroundDrawable(this.f49829a);
        getWindow().getDecorView().setOnTouchListener(new InsetDialogOnTouchListener(this, this.f49830b));
    }
    ...
    public MaterialStyledDatePickerDialog(@NonNull Context context, int i, @Nullable DatePickerDialog.OnDateSetListener onDateSetListener, int i2, int i3, int i4) {
        ...
        this.f49830b = dialogBackgroundInsets;
        this.f49829a = MaterialDialogs.insetDrawable(materialShapeDrawable, dialogBackgroundInsets);
    }
}