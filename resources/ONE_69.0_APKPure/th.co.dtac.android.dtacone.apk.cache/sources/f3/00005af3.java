...
public final class SwipeableDefaults {
    ...
    /* renamed from: a */
    public static final SpringSpec f26301a = new SpringSpec(0.0f, 0.0f, null, 7, null);

    /* renamed from: b */
    public static final float f26302b = C3623Dp.m73842constructorimpl(125);
    ...
    public final float m70821getVelocityThresholdD9Ej5fM$material3_release() {
        return f26302b;
    }
    ...
    public final ResistanceConfig resistanceConfig$material3_release(@NotNull Set<Float> anchors, float f, float f2) {
        ...
        Float m74382maxOrNull = CollectionsKt___CollectionsKt.m74382maxOrNull((Iterable<Float>) set);
        Intrinsics.checkNotNull(m74382maxOrNull);
        float floatValue = m74382maxOrNull.floatValue();
        Float m74386minOrNull = CollectionsKt___CollectionsKt.m74386minOrNull((Iterable<Float>) set);
        Intrinsics.checkNotNull(m74386minOrNull);
        return new ResistanceConfig(floatValue - m74386minOrNull.floatValue(), f, f2);
    }
}