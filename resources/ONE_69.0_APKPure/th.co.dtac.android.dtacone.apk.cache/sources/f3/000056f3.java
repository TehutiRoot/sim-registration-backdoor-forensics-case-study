...
public final class PullRefreshIndicatorKt {
    ...
    /* renamed from: a */
    public static final float f25523a = C3623Dp.m73842constructorimpl(40);

    /* renamed from: b */
    public static final RoundedCornerShape f25524b = RoundedCornerShapeKt.getCircleShape();

    /* renamed from: c */
    public static final float f25525c = C3623Dp.m73842constructorimpl((float) 7.5d);

    /* renamed from: d */
    public static final float f25526d = C3623Dp.m73842constructorimpl((float) 2.5d);

    /* renamed from: e */
    public static final float f25527e = C3623Dp.m73842constructorimpl(10);

    /* renamed from: f */
    public static final float f25528f = C3623Dp.m73842constructorimpl(5);

    /* renamed from: g */
    public static final float f25529g = C3623Dp.m73842constructorimpl(6);

    /* renamed from: h */
    public static final TweenSpec f25530h = AnimationSpecKt.tween$default(300, 0, EasingKt.getLinearEasing(), 2, null);

    @ComposableTarget(applier = "androidx.compose.ui.UiComposable")
    @Composable
    @ExperimentalMaterialApi
    /* renamed from: PullRefreshIndicator-jB83MbM  reason: not valid java name */
    public static final void m70353PullRefreshIndicatorjB83MbM(boolean z, @NotNull PullRefreshState state, @Nullable Modifier modifier, long j, long j2, boolean z2, @Nullable Composer composer, int i, int i2) {
        ...
        if ((i2 & 8) != 0) {
            i3 = i & (-7169);
            j3 = MaterialTheme.INSTANCE.getColors(startRestartGroup, 6).m70158getSurface0d7_KjU();
        } else {
            j3 = j;
            i3 = i;
        }
        if ((i2 & 16) != 0) {
            i3 &= -57345;
            j4 = ColorsKt.m70172contentColorForek8zF_U(j3, startRestartGroup, (i3 >> 9) & 14);
        } else {
            j4 = j2;
        }
        if ((i2 & 32) != 0) {
        ...
        if (elevationOverlay == null) {
            ...
            m71909boximpl = Color.m71909boximpl(elevationOverlay.mo70207apply7g2Lkgo(j3, f25529g, startRestartGroup, ((i3 >> 9) & 14) | 48));
        }
        startRestartGroup.endReplaceableGroup();
        if (m71909boximpl != null) {
            i4 = i5;
            j5 = m71909boximpl.m71929unboximpl();
        } else {
            i4 = i5;
            j5 = j3;
        }
        Modifier pullRefreshIndicatorTransform = PullRefreshIndicatorTransformKt.pullRefreshIndicatorTransform(SizeKt.m69748size3ABfNKs(companion, f25523a), state, z3);
        if (m60695d(state2)) {
            m73842constructorimpl = f25529g;
        } else {
            m73842constructorimpl = C3623Dp.m73842constructorimpl(0);
        }
        float f = m73842constructorimpl;
        RoundedCornerShape roundedCornerShape = f25524b;
        Modifier m69504backgroundbw27NRU = BackgroundKt.m69504backgroundbw27NRU(ShadowKt.m71609shadows4CzXII$default(pullRefreshIndicatorTransform, f, roundedCornerShape, true, 0L, 0L, 24, null), j5, roundedCornerShape);
    ...
    /* renamed from: a */
    public static final C5332b7 m60698a(float f) {
        float max = (Math.max(Math.min(1.0f, f) - 0.4f, 0.0f) * 5) / 3;
        float coerceIn = AbstractC11695c.coerceIn(Math.abs(f) - 1.0f, 0.0f, 2.0f);
        float pow = (((0.4f * max) - 0.25f) + (coerceIn - (((float) Math.pow(coerceIn, 2)) / 4))) * 0.5f;
        float f2 = 360;
        return new C5332b7(pow, pow * f2, ((0.8f * max) + pow) * f2, Math.min(1.0f, max));
    }

    /* renamed from: b */
    public static final void m60697b(PullRefreshState pullRefreshState, long j, Modifier modifier, Composer composer, int i) {
        ...
        if (rememberedValue == companion.getEmpty()) {
            ...
            Path.mo71821setFillTypeoQ8Xj4U(PathFillType.Companion.m72159getEvenOddRgk1Os());
        ...
        startRestartGroup.endReplaceableGroup();
        CanvasKt.Canvas(SemanticsModifierKt.semantics$default(modifier, false, PullRefreshIndicatorKt$CircularArrowIndicator$1.INSTANCE, 1, null), new PullRefreshIndicatorKt$CircularArrowIndicator$2(pullRefreshState, AnimateAsStateKt.animateFloatAsState(m60696c((State) rememberedValue2), f25530h, 0.0f, null, null, startRestartGroup, 48, 28), j, path2), startRestartGroup, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ScopeUpdateScope endRestartGroup = startRestartGroup.endRestartGroup();
    ...
    /* renamed from: c */
    public static final float m60696c(State state) {
        return ((Number) state.getValue()).floatValue();
    }

    /* renamed from: d */
    public static final boolean m60695d(State state) {
        return ((Boolean) state.getValue()).booleanValue();
    }

    /* renamed from: e */
    public static final void m60694e(DrawScope drawScope, Path path, Rect rect, long j, float f, C5332b7 c5332b7) {
        path.reset();
        path.moveTo(0.0f, 0.0f);
        float f2 = f25527e;
        path.lineTo(drawScope.mo69622toPx0680j_4(f2) * c5332b7.m51985c(), 0.0f);
        path.lineTo((drawScope.mo69622toPx0680j_4(f2) * c5332b7.m51985c()) / 2, drawScope.mo69622toPx0680j_4(f25528f) * c5332b7.m51985c());
        path.mo71823translatek4lQ0M(OffsetKt.Offset(((Math.min(rect.getWidth(), rect.getHeight()) / 2.0f) + Offset.m71686getXimpl(rect.m71716getCenterF1C5BW0())) - ((drawScope.mo69622toPx0680j_4(f2) * c5332b7.m51985c()) / 2.0f), Offset.m71687getYimpl(rect.m71716getCenterF1C5BW0()) + (drawScope.mo69622toPx0680j_4(f25526d) / 2.0f)));
        path.close();
        float m51987a = c5332b7.m51987a();
        long mo72327getCenterF1C5BW0 = drawScope.mo72327getCenterF1C5BW0();
        DrawContext drawContext = drawScope.getDrawContext();
        long mo72334getSizeNHjbRc = drawContext.mo72334getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo72340rotateUv8p0NA(m51987a, mo72327getCenterF1C5BW0);
        AbstractC12264mK.m26709G(drawScope, path, j, f, null, null, 0, 56, null);
