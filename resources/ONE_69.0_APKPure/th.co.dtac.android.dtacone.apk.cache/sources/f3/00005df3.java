...
public final class MutableVectorKt {
    ...
    /* renamed from: a */
    public static final void m60046a(List list, int i) {
        int size = list.size();
        if (i >= 0 && i < size) {
            return;
        }
    ...
    /* renamed from: b */
    public static final void m60045b(List list, int i, int i2) {
        int size = list.size();
        if (i <= i2) {
            if (i >= 0) {
                if (i2 <= size) {
