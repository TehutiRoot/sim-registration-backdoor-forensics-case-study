...
/* renamed from: th.co.dtac.android.dtacone.presenter.login.NewVerifyOtpPresenter$verifyOtp$8 */
/* loaded from: classes8.dex */
public final class NewVerifyOtpPresenter$verifyOtp$8 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ NewVerifyOtpPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NewVerifyOtpPresenter$verifyOtp$8(NewVerifyOtpPresenter newVerifyOtpPresenter) {
        super(1);
        this.this$0 = newVerifyOtpPresenter;
    }
    ...
    public final void invoke2(Throwable th2) {
        ...
        final NewVerifyOtpPresenter newVerifyOtpPresenter = this.this$0;
        errorService.handleException(th2, new ServerErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.presenter.login.NewVerifyOtpPresenter$verifyOtp$8.1
            ...
            public void handle(@Nullable Throwable th3) {
                NewVerifyOtpPresenter.View view;
                ...
                view = NewVerifyOtpPresenter.this.f85967e;
                if (view == null) {
