...
@DebugMetadata(m29093c = "io.realm.internal.coroutines.InternalFlowFactory$changesetFrom$1", m29092f = "InternalFlowFactory.kt", m29091i = {}, m29090l = {166, CertificateHolderAuthorization.CVCA}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
...
public final class InternalFlowFactory$changesetFrom$1 extends SuspendLambda implements Function2<ProducerScope<? super CollectionChange<RealmResults<T>>>, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes5.dex */
    public static final class C113151 extends Lambda implements Function0<Unit> {
        public static final C113151 INSTANCE = new C113151();
    ...
    /* loaded from: classes5.dex */
    public static final class C113162 extends Lambda implements Function0<Unit> {
        ...
        public C113162(Realm realm, RealmResults<T> realmResults, OrderedRealmCollectionChangeListener<RealmResults<T>> orderedRealmCollectionChangeListener) {
            super(0);
    ...
    public static final void m74251invokeSuspend$lambda0(ProducerScope producerScope, InternalFlowFactory internalFlowFactory, RealmResults realmResults, OrderedCollectionChangeSet orderedCollectionChangeSet) {
        boolean z;
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (!this.$results.isValid()) {
            C113151 c113151 = C113151.INSTANCE;
            this.label = 1;
            if (ProduceKt.awaitClose(producerScope, c113151, this) == coroutine_suspended) {
        ...
        OrderedRealmCollectionChangeListener orderedRealmCollectionChangeListener = new OrderedRealmCollectionChangeListener() { // from class: io.realm.internal.coroutines.a
            ...
            public final void onChange(Object obj2, OrderedCollectionChangeSet orderedCollectionChangeSet) {
                InternalFlowFactory$changesetFrom$1.m74251invokeSuspend$lambda0(ProducerScope.this, internalFlowFactory, (RealmResults) obj2, orderedCollectionChangeSet);
            }
        };
        ...
        C113162 c113162 = new C113162(realm, this.$results, orderedRealmCollectionChangeListener);
        this.label = 2;
        if (ProduceKt.awaitClose(producerScope, c113162, this) == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Unit.INSTANCE;
    }
