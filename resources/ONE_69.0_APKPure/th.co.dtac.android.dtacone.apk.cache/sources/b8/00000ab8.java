...
public abstract class LH1 {
    ...
    /* renamed from: a */
    public static final JsonReader.Options f3567a = JsonReader.Options.m50682of("nm", OperatorName.CURVE_TO, OperatorName.SET_LINE_WIDTH, "o", "lc", "lj", "ml", "hd", "d");

    /* renamed from: b */
    public static final JsonReader.Options f3568b = JsonReader.Options.m50682of(OperatorName.ENDPATH, OperatorName.CURVE_TO_REPLICATE_INITIAL_POINT);

    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    /* renamed from: a */
    public static ShapeStroke m67609a(JsonReader jsonReader, LottieComposition lottieComposition) {
        ...
        while (jsonReader.hasNext()) {
            switch (jsonReader.selectName(f3567a)) {
                case 0:
                ...
                case 8:
                    ...
                    while (jsonReader.hasNext()) {
                        ...
                        while (jsonReader.hasNext()) {
                            int selectName = jsonReader.selectName(f3568b);
                            if (selectName != 0) {
                                if (selectName != 1) {
                                    jsonReader.skipName();
