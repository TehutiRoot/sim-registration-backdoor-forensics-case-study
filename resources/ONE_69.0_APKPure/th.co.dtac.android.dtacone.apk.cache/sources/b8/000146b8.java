...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.topup.viewModel.OneTopUpViewModel$getOneBalance$1 */
/* loaded from: classes10.dex */
public final class OneTopUpViewModel$getOneBalance$1 extends Lambda implements Function1<BalanceResponse, Unit> {
    final /* synthetic */ OneTopUpViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneTopUpViewModel$getOneBalance$1(OneTopUpViewModel oneTopUpViewModel) {
        super(1);
    ...
    public final void invoke2(BalanceResponse balanceResponse) {
        ...
        m9215Y = this.this$0.m9215Y();
        m9215Y.setValue(Resource.Companion.success(balanceResponse));
    }
}