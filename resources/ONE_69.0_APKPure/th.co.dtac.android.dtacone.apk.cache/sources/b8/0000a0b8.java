...
public class BarhopperV3 implements Closeable {
    ...
    /* renamed from: b */
    public static final String f48943b = "BarhopperV3";
    ...
    /* renamed from: b */
    public static BarhopperProto$BarhopperResponse m45962b(byte[] bArr) {
        bArr.getClass();
        try {
    ...
    public void create() {
        if (this.f48944a != 0) {
            Log.w(f48943b, "Native context already exists.");
            return;
        }
        long createNative = createNative();
        this.f48944a = createNative;
        if (createNative == 0) {
    ...
    public BarhopperProto$BarhopperResponse recognize(int i, int i2, int i3, @NonNull ByteBuffer byteBuffer, @NonNull RecognitionOptions recognitionOptions) {
        long j = this.f48944a;
        if (j != 0) {
            return m45962b(recognizeStridedBufferNative(j, i, i2, i3, byteBuffer, recognitionOptions));
        }
    ...
    public void create(@NonNull BarhopperV3Options barhopperV3Options) {
        if (this.f48944a == 0) {
            try {
                ...
                this.f48944a = createNativeWithClientOptions;
    ...
    public BarhopperProto$BarhopperResponse recognize(int i, int i2, int i3, @NonNull byte[] bArr, @NonNull RecognitionOptions recognitionOptions) {
        long j = this.f48944a;
        if (j != 0) {
            return m45962b(recognizeStridedNative(j, i, i2, i3, bArr, recognitionOptions));
        }
        throw new IllegalStateException("Native context does not exist.");
    }
    ...
    public BarhopperProto$BarhopperResponse recognize(int i, int i2, @NonNull ByteBuffer byteBuffer, @NonNull RecognitionOptions recognitionOptions) {
        long j = this.f48944a;
        if (j != 0) {
            return m45962b(recognizeBufferNative(j, i, i2, byteBuffer, recognitionOptions));
        }
        throw new IllegalStateException("Native context does not exist.");
    }
    ...
    public BarhopperProto$BarhopperResponse recognize(int i, int i2, @NonNull byte[] bArr, @NonNull RecognitionOptions recognitionOptions) {
        long j = this.f48944a;
        if (j != 0) {
            return m45962b(recognizeNative(j, i, i2, bArr, recognitionOptions));
        }
        throw new IllegalStateException("Native context does not exist.");
    }
    ...
    public BarhopperProto$BarhopperResponse recognize(@NonNull Bitmap bitmap, @NonNull RecognitionOptions recognitionOptions) {
        if (this.f48944a != 0) {
            ...
            return m45962b(recognizeBitmapNative(this.f48944a, bitmap, recognitionOptions));
        }
        throw new IllegalStateException("Native context does not exist.");
    }
}