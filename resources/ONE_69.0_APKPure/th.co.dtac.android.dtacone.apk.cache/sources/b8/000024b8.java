...
@DebugMetadata(m29093c = "androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2", m29092f = "Scrollable.kt", m29091i = {}, m29090l = {500}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
...
public final class ScrollingLogic$doFlingAnimation$2 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i != 0) {
            ...
            ScrollScope scrollScope = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$scope$1
                ...
                public float scrollBy(float f) {
                    ...
                    return scrollingLogic4.m61413p(((Offset) scrollingLogic$doFlingAnimation$2$outerScopeScroll$1.invoke(Offset.m71675boximpl(scrollingLogic4.m61412q(f)))).m71696unboximpl());
                }
            };
            scrollingLogic = this.this$0;
            Ref.LongRef longRef2 = this.$result;
            long j2 = this.$available;
            FlingBehavior m61426c = scrollingLogic.m61426c();
            long j3 = longRef2.element;
            float m61419j = scrollingLogic.m61419j(scrollingLogic.m61414o(j2));
            this.L$0 = scrollingLogic;
            this.L$1 = scrollingLogic;
            this.L$2 = longRef2;
            this.J$0 = j3;
            this.label = 1;
            obj = m61426c.performFling(scrollScope, m61419j, this);
        ...
        longRef.element = scrollingLogic.m61411r(j, scrollingLogic2.m61419j(((Number) obj).floatValue()));
