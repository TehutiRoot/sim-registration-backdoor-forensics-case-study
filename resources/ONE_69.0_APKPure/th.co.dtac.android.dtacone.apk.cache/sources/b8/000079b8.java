...
public class TargetLengthBasedClassNameAbbreviator implements Abbreviator {
    ...
    /* renamed from: a */
    public static int m51590a(String str, int[] iArr) {
        int i = 0;
        int i2 = 0;
        while (true) {
    ...
    public String abbreviate(String str) {
        String substring;
        StringBuilder sb = new StringBuilder(this.f39627a);
        if (str != null) {
            if (str.length() < this.f39627a) {
                return str;
            }
            int[] iArr = new int[16];
            int[] iArr2 = new int[17];
            int m51590a = m51590a(str, iArr);
            if (m51590a == 0) {
                return str;
            }
            m51589b(str, iArr, iArr2, m51590a);
            for (int i = 0; i <= m51590a; i++) {
                if (i == 0) {
    ...
    /* renamed from: b */
    public void m51589b(String str, int[] iArr, int[] iArr2, int i) {
        int length = str.length() - this.f39627a;
        int i2 = 0;
        while (i2 < i) {
