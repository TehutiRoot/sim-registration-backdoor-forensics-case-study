...
public final class Creator {
    ...
    public static /* synthetic */ Creator copy$default(Creator creator, String str, String str2, String str3, int i, Object obj) {
        ...
        if ((i & 2) != 0) {
            str2 = creator.f42828b;
        }
        if ((i & 4) != 0) {
            str3 = creator.f42829c;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof Creator) {
            ...
            return Intrinsics.areEqual(this.f42827a, creator.f42827a) && Intrinsics.areEqual(this.f42828b, creator.f42828b) && Intrinsics.areEqual(this.f42829c, creator.f42829c);
        }
        return false;
    }
