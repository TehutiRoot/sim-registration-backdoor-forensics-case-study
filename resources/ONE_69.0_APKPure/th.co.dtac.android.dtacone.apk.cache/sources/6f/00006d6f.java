...
public final class SharedPreferencesMigrationKt {
    ...
    /* renamed from: a */
    public static final Function3 m56168a() {
        return new SharedPreferencesMigrationKt$getMigrationFunction$1(null);
    }

    /* renamed from: b */
    public static final Function2 m56167b(Set set) {
    ...
    public static final SharedPreferencesMigration<Preferences> SharedPreferencesMigration(@NotNull Function0<? extends SharedPreferences> produceSharedPreferences, @NotNull Set<String> keysToMigrate) {
        ...
        if (keysToMigrate == f34739a) {
            return new SharedPreferencesMigration<>(produceSharedPreferences, (Set) null, m56167b(keysToMigrate), m56168a(), 2, (DefaultConstructorMarker) null);
        }
        return new SharedPreferencesMigration<>(produceSharedPreferences, keysToMigrate, m56167b(keysToMigrate), m56168a());
    }
    ...
    public static final SharedPreferencesMigration<Preferences> SharedPreferencesMigration(@NotNull Context context, @NotNull String sharedPreferencesName, @NotNull Set<String> keysToMigrate) {
        ...
        Intrinsics.checkNotNullParameter(keysToMigrate, "keysToMigrate");
        if (keysToMigrate == f34739a) {
            return new SharedPreferencesMigration<>(context, sharedPreferencesName, null, m56167b(keysToMigrate), m56168a(), 4, null);
        }
        return new SharedPreferencesMigration<>(context, sharedPreferencesName, keysToMigrate, m56167b(keysToMigrate), m56168a());
    }
}