...
public class setImportantForAccessibility implements setDarkTextColor.valueOf {
    private final setDarkTextColor values;

    public setImportantForAccessibility(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.ThreeDS2ServiceInstance(this.values);
    }
}