...
public final class ObservableConcatWithCompletable<T> extends AbstractC11078a {

    /* renamed from: a */
    public final CompletableSource f65203a;
    ...
    public ObservableConcatWithCompletable(Observable<T> observable, CompletableSource completableSource) {
        super(observable);
        this.f65203a = completableSource;
    }

    @Override // io.reactivex.Observable
    public void subscribeActual(Observer<? super T> observer) {
        this.source.subscribe(new ConcatWithObserver(observer, this.f65203a));
    }
}