...
@SourceDebugExtension({"SMAP\nOnePrepaidViewModel.kt\nKotlin\n*S Kotlin\n*F\n+ 1 OnePrepaidViewModel.kt\nth/co/dtac/android/dtacone/view/appOne/prepaid_registration/viewmodel/OnePrepaidViewModel$uploadImage$5\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,1710:1\n1#2:1711\n*E\n"})
/* renamed from: th.co.dtac.android.dtacone.view.appOne.prepaid_registration.viewmodel.OnePrepaidViewModel$uploadImage$5 */
/* loaded from: classes10.dex */
public final class OnePrepaidViewModel$uploadImage$5 extends Lambda implements Function1<UploadImageResponse, Unit> {
    final /* synthetic */ OnePrepaidViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePrepaidViewModel$uploadImage$5(OnePrepaidViewModel onePrepaidViewModel) {
        super(1);
    ...
    public final void invoke2(UploadImageResponse uploadImageResponse) {
        ...
        if (filename != null) {
            ...
            List<String> attachmentNames = onePrepaidRepository.getAttachmentNames();
