...
public final class PlatformRipple extends Ripple {
    ...
    /* renamed from: a */
    public final ViewGroup m60673a(Composer composer, int i) {
    ...
    public RippleIndicationInstance mo70357rememberUpdatedRippleInstance942rkJo(@NotNull InteractionSource interactionSource, boolean z, float f, @NotNull State<Color> color, @NotNull State<RippleAlpha> rippleAlpha, @Nullable Composer composer, int i) {
        ...
        ViewGroup m60673a = m60673a(composer, (i >> 15) & 14);
        composer.startReplaceableGroup(1643267286);
        if (m60673a.isInEditMode()) {
        ...
        composer.endReplaceableGroup();
        int childCount = m60673a.getChildCount();
        int i2 = 0;
        while (true) {
            if (i2 < childCount) {
                view = m60673a.getChildAt(i2);
        ...
        if (view == null) {
            Context context = m60673a.getContext();
            Intrinsics.checkNotNullExpressionValue(context, "view.context");
            view = new RippleContainer(context);
            m60673a.addView(view);
        }
