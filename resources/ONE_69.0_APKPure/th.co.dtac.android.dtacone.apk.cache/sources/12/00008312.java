...
public final class TransactionPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public TransactionPagerAdapter(@NotNull Context context, @NotNull FragmentManager fm) {
        ...
        this.f43032j = new String[]{context.getString(R.string.chucker_overview), context.getString(R.string.chucker_request), context.getString(R.string.chucker_response)};
    }

    @Override // androidx.viewpager.widget.PagerAdapter
    public int getCount() {
        return this.f43032j.length;
    }
