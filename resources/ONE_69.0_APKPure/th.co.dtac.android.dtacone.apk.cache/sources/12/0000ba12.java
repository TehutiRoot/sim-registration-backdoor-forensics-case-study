...
public class HttpService implements RemoteService {
    ...
    /* renamed from: a */
    public static boolean f58763a;

    /* renamed from: com.mixpanel.android.util.HttpService$a */
    /* loaded from: classes5.dex */
    public class RunnableC9190a implements Runnable {
        public RunnableC9190a() {
        }
        ...
        */
        public void run() {
            ...
            L27:
                r0 = 1
            L28:
                com.mixpanel.android.util.HttpService.m33459b(r0)     // Catch: java.lang.Exception -> L38
                boolean r0 = com.mixpanel.android.util.HttpService.m33460a()     // Catch: java.lang.Exception -> L38
                if (r0 == 0) goto L38
                java.lang.String r0 = "MixpanelAPI.Message"
                java.lang.String r1 = "AdBlocker is enabled. Won't be able to use Mixpanel services."
                com.mixpanel.android.util.MPLog.m33445v(r0, r1)     // Catch: java.lang.Exception -> L38
            L38:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mixpanel.android.util.HttpService.RunnableC9190a.run():void");
        }
    }

    /* renamed from: d */
    public static byte[] m33457d(InputStream inputStream) {
    ...
    /* renamed from: c */
    public final boolean m33458c(OfflineMode offlineMode) {
        if (offlineMode == null) {
            return false;
        }
        try {
            ...
            MPLog.m33444v("MixpanelAPI.Message", "Client State should not throw exception, will assume is not on offline mode", e);
            return false;
        }
    }
    ...
    public void checkIsMixpanelBlocked() {
        new Thread(new RunnableC9190a()).start();
    }
    ...
    public boolean isOnline(Context context, OfflineMode offlineMode) {
        String str;
        if (f58763a || m33458c(offlineMode)) {
            return false;
        }
        boolean z = true;
        try {
            ...
            if (activeNetworkInfo == null) {
                MPLog.m33445v("MixpanelAPI.Message", "A default network has not been set so we cannot be certain whether we are offline");
            } else {
                ...
                sb.append(str);
                sb.append(" online");
                MPLog.m33445v("MixpanelAPI.Message", sb.toString());
                z = isConnectedOrConnecting;
            }
        } catch (SecurityException unused) {
            MPLog.m33445v("MixpanelAPI.Message", "Don't have permission to check connectivity, will assume we are online");
        }
        return z;
    }
