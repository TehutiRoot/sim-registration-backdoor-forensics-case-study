...
public final class ValueInsets implements WindowInsets {
    ...
    /* renamed from: b */
    public final MutableState f13363b;
    ...
    public final InsetsValues getValue$foundation_layout_release() {
        return (InsetsValues) this.f13363b.getValue();
    }
    ...
    public final void setValue$foundation_layout_release(@NotNull InsetsValues insetsValues) {
        ...
        this.f13363b.setValue(insetsValues);
    }

    @NotNull
    public String toString() {
        return this.f13362a + "(left=" + getValue$foundation_layout_release().getLeft() + ", top=" + getValue$foundation_layout_release().getTop() + ", right=" + getValue$foundation_layout_release().getRight() + ", bottom=" + getValue$foundation_layout_release().getBottom() + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
}