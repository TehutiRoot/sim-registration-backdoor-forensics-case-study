...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.home.fragment.OneHomeFragment$setupObserve$3 */
/* loaded from: classes10.dex */
public final class OneHomeFragment$setupObserve$3 extends Lambda implements Function1<Resource<? extends String>, Unit> {
    final /* synthetic */ OneHomeFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.home.fragment.OneHomeFragment$setupObserve$3$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneHomeFragment$setupObserve$3(OneHomeFragment oneHomeFragment) {
        super(1);
    ...
    public final void invoke2(Resource<String> resource) {
        ...
        oneHomeViewModel = oneHomeFragment.f91077i;
        if (oneHomeViewModel == null) {
            Intrinsics.throwUninitializedPropertyAccessException("homeViewModel");
            oneHomeViewModel = null;
        }
        if (data == null) {
            data = PermissionConstant.M_BUY_DOL;
        }
        oneHomeViewModel.getPriceList(data);
    }
}