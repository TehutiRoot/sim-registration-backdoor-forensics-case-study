...
public final class ObservableRepeat<T> extends AbstractC11078a {
    ...
    public static final class RepeatObserver<T> extends AtomicInteger implements Observer<T> {
        ...
        /* renamed from: sd */
        final SequentialDisposable f65513sd;
        ...
        public RepeatObserver(Observer<? super T> observer, long j, SequentialDisposable sequentialDisposable, ObservableSource<? extends T> observableSource) {
            ...
            this.f65513sd = sequentialDisposable;
        ...
        public void onSubscribe(Disposable disposable) {
            this.f65513sd.replace(disposable);
        }

        public void subscribeNext() {
            if (getAndIncrement() == 0) {
                int i = 1;
                while (!this.f65513sd.isDisposed()) {
