...
public final class OneStvRepositoryImpl implements OneStvRepository {
    ...
    /* renamed from: a */
    public final RTRApiRx2 f82455a;

    /* renamed from: b */
    public final RtrRx2Repository f82456b;

    /* renamed from: c */
    public final ConfigurationRepository f82457c;

    /* renamed from: d */
    public PreferencesViewModel f82458d;

    /* renamed from: e */
    public StvProsermOnline f82459e;
    ...
    public OneStvRepositoryImpl(@NotNull RTRApiRx2 api, @NotNull RtrRx2Repository rtrRx2Repository, @NotNull ConfigurationRepository configurationRepository, @NotNull PreferencesViewModel pfViewModel) {
        ...
        this.f82455a = api;
        this.f82456b = rtrRx2Repository;
        this.f82457c = configurationRepository;
        this.f82458d = pfViewModel;
        this.f82459e = new StvProsermOnline(null, null, null, null, null, 31, null);
    }

    /* renamed from: a */
    public static /* synthetic */ BalanceResponse m20265a(Function1 function1, Object obj) {
        return m20264b(function1, obj);
    }

    /* renamed from: b */
    public static final BalanceResponse m20264b(Function1 tmp0, Object obj) {
    ...
    public Single<OneTopUpCheckSubscriberResponse> checkSubscriberPrepaid(@NotNull OneTopUpCheckSubscriberRequest request) {
        ...
        return this.f82455a.checkSubscriberPrepaid(request);
    }
    ...
    public String decryptCBC(@NotNull String cipher) {
        ...
        return AESCryptUtil.decryptCBC(cipher, this.f82457c.dataPrivacyEncryptionAES256CBCKey());
    }
    ...
    public String encryptCBC(@NotNull String text) {
        ...
        return AESCryptUtil.encryptCBC(text, this.f82457c.dataPrivacyEncryptionAES256CBCKey());
    }

    @Override // th.p047co.dtac.android.dtacone.app_one.repository.OneStvRepository
    @NotNull
    public Observable<BalanceResponse> getBalance() {
        Observable<BalanceResponse> oneGetBalance = this.f82455a.oneGetBalance(this.f82458d.getSuffixApi());
        final OneStvRepositoryImpl$getBalance$1 oneStvRepositoryImpl$getBalance$1 = new OneStvRepositoryImpl$getBalance$1(this);
        Observable map = oneGetBalance.map(new Function() { // from class: kf1
            @Override // io.reactivex.functions.Function
            public final Object apply(Object obj) {
                return OneStvRepositoryImpl.m20265a(Function1.this, obj);
            }
        });
    ...
    public BalanceResponse getGetBalanceResponse() {
        return this.f82459e.getGetBalanceResponse();
    }
    ...
    public Single<OneTopUpGetMainBalanceResponse> getMainBalance(@NotNull OneTopUpGetMainBalanceRequest request) {
        Intrinsics.checkNotNullParameter(request, "request");
        return this.f82455a.getMainBalance(request);
    }
    ...
    public Single<OneTopUpGetMainBalanceTrueCompanyResponse> getMainBalanceTrueCompany(@NotNull OneTopUpGetMainBalanceTrueCompanyRequest request) {
        Intrinsics.checkNotNullParameter(request, "request");
        return this.f82455a.getMainBalanceTrueCompany(request);
    }
    ...
    public OneStvRecommendPackageResp getPackageResp() {
        return this.f82459e.getPackageResp();
    }

    @Override // th.p047co.dtac.android.dtacone.app_one.repository.OneStvRepository
    public List<String> getPermissions() {
        return this.f82456b.getSessionNow().getPermissions();
    }

    @Override // th.p047co.dtac.android.dtacone.app_one.repository.OneStvRepository
    @Nullable
    public SimRCollectionResponse getSimRCollection() {
        return this.f82459e.getSimRCollection();
    }

    @Override // th.p047co.dtac.android.dtacone.app_one.repository.OneStvRepository
    @NotNull
    public Observable<SimRCollectionResponse> getSimRList() {
        return this.f82455a.oneGetSimRList();
    }

    @Override // th.p047co.dtac.android.dtacone.app_one.repository.OneStvRepository
    @NotNull
    public String getSimRNumberDisplay() {
        String simR = this.f82456b.getSessionNow().getToken().getSimR();
    ...
    public String getSubscriberGroup() {
        return this.f82459e.getSubscriberGroup();
    }

    @Override // th.p047co.dtac.android.dtacone.app_one.repository.OneStvRepository
    @Nullable
    public String getSubscriberNumber() {
        return this.f82459e.getSubscriberNumber();
    }

    @Override // th.p047co.dtac.android.dtacone.app_one.repository.OneStvRepository
    @NotNull
    public String getTogglePrepaidEnable() {
        return this.f82457c.togglePrepaidEnable();
    }

    @Override // th.p047co.dtac.android.dtacone.app_one.repository.OneStvRepository
    public String getUserCode() {
        return this.f82456b.getUserSession().getUserCode();
    }
    ...
    public Observable<OneCurrentPackagesResponse> oneCurrentPackages(@NotNull OneCurrentPackagesRequest request) {
        Intrinsics.checkNotNullParameter(request, "request");
        return this.f82455a.oneCurrentPackages(this.f82458d.getSuffixApi(), request);
    }

    @Override // th.p047co.dtac.android.dtacone.app_one.repository.OneStvRepository
    @NotNull
    public Observable<OneStvGroupListCollection> oneGetSTVPackages(@Nullable String str) {
        return this.f82455a.oneGetPackages(this.f82458d.getSuffixApi(), str);
    }
    ...
    public Observable<OneStvRecommendPackageResponse> oneGetSTVRecommendPackages(@NotNull OneStvRecommendPackageRequest request) {
        Intrinsics.checkNotNullParameter(request, "request");
        return this.f82455a.oneGetSTVRecommendPackages(this.f82458d.getSuffixApi(), request);
    }
    ...
    public Observable<OneTrueRecommendPackageAdditionalResponse> oneGetTrueRecommendPackagesAdditional(@NotNull OneStvRecommendPackageRequest request) {
        Intrinsics.checkNotNullParameter(request, "request");
        return this.f82455a.oneGetTrueRecommendPackagesAdditional(request);
    }
    ...
    public Single<OneSubmitSTVProsermResponse> oneProsermRecommend(@NotNull OneSubmitProsermRecommendReq request) {
        Intrinsics.checkNotNullParameter(request, "request");
        return this.f82455a.oneProsermRecommend(this.f82458d.getSuffixApi(), request.getSubscriberNumber(), request);
    }
    ...
    public Single<OneSubmitSTVProsermResponse> oneStvSubmit(@NotNull OneStvSubmitCollection request) {
        Intrinsics.checkNotNullParameter(request, "request");
        return this.f82455a.oneStvSubmit(this.f82458d.getSuffixApi(), request.getSubscriberNumber(), request);
    }
    ...
    public Single<OneSubmitSTVProsermResponse> oneStvSubmitTrue(@NotNull OneStvSubmitTrueRequest request) {
        Intrinsics.checkNotNullParameter(request, "request");
        return this.f82455a.oneStvSubmitTrue(this.f82458d.getSuffixApi(), request);
    }
    ...
    public Single<QueryTransactionResponse> queryTransaction(@NotNull String trackingID) {
        ...
        return this.f82455a.queryTransaction(new QueryTransactionRequest(null, "PROSERM", trackingID, 1, null));
    }

    @Override // th.p047co.dtac.android.dtacone.app_one.repository.OneStvRepository
    public void setGetBalanceResponse(@Nullable BalanceResponse balanceResponse) {
        this.f82459e.setGetBalanceResponse(balanceResponse);
    }
    ...
    public Observable<OneCommonResponse> updateInterestRecommendForTrue(@NotNull UpdateInterestRecommendRequest request) {
        Intrinsics.checkNotNullParameter(request, "request");
        return this.f82455a.oneUpdateInterestRecommendForTrue(request);
    }
}