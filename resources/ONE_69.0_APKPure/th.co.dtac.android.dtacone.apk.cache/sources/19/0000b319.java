...
public final class SessionConfigs {
    ...
    /* renamed from: b */
    public final Double f56631b;

    /* renamed from: c */
    public final Integer f56632c;

    /* renamed from: d */
    public final Integer f56633d;

    /* renamed from: e */
    public final Long f56634e;
    ...
    public static /* synthetic */ SessionConfigs copy$default(SessionConfigs sessionConfigs, Boolean bool, Double d, Integer num, Integer num2, Long l, int i, Object obj) {
        if ((i & 1) != 0) {
            bool = sessionConfigs.f56630a;
        }
        if ((i & 2) != 0) {
            d = sessionConfigs.f56631b;
        }
        Double d2 = d;
        if ((i & 4) != 0) {
            num = sessionConfigs.f56632c;
        }
        Integer num3 = num;
        if ((i & 8) != 0) {
            num2 = sessionConfigs.f56633d;
        }
        Integer num4 = num2;
        if ((i & 16) != 0) {
            l = sessionConfigs.f56634e;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof SessionConfigs) {
            ...
            return Intrinsics.areEqual(this.f56630a, sessionConfigs.f56630a) && Intrinsics.areEqual((Object) this.f56631b, (Object) sessionConfigs.f56631b) && Intrinsics.areEqual(this.f56632c, sessionConfigs.f56632c) && Intrinsics.areEqual(this.f56633d, sessionConfigs.f56633d) && Intrinsics.areEqual(this.f56634e, sessionConfigs.f56634e);
        }
        return false;
    }
    ...
    public int hashCode() {
        Boolean bool = this.f56630a;
        int hashCode = (bool == null ? 0 : bool.hashCode()) * 31;
        Double d = this.f56631b;
        int hashCode2 = (hashCode + (d == null ? 0 : d.hashCode())) * 31;
        Integer num = this.f56632c;
        int hashCode3 = (hashCode2 + (num == null ? 0 : num.hashCode())) * 31;
        Integer num2 = this.f56633d;
    ...
    public String toString() {
        return "SessionConfigs(sessionEnabled=" + this.f56630a + ", sessionSamplingRate=" + this.f56631b + ", sessionRestartTimeout=" + this.f56632c + ", cacheDuration=" + this.f56633d + ", cacheUpdatedTime=" + this.f56634e + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
}