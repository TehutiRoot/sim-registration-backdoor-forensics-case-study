...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.deviceSaleTrueCompany.viewModel.OneDeviceSaleTrueViewModel$validateAllowProtection$3 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleTrueViewModel$validateAllowProtection$3 extends Lambda implements Function1<OneValidateAllowProtectionResponse, Unit> {
    final /* synthetic */ OneDeviceSaleTrueViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneDeviceSaleTrueViewModel$validateAllowProtection$3(OneDeviceSaleTrueViewModel oneDeviceSaleTrueViewModel) {
        super(1);
    ...
    public final void invoke2(OneValidateAllowProtectionResponse oneValidateAllowProtectionResponse) {
        ...
        String name = OneDeviceSaleTrueProtectFragment.class.getName();
        Intrinsics.checkNotNullExpressionValue(name, "OneDeviceSaleTrueProtectFragment::class.java.name");
        m14895E0.setValue(new Event(new FragmentNavEvent(OneDeviceSaleTrueProtectFragment.class, null, name)));
    }
}