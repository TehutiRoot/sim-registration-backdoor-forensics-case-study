...
@SourceDebugExtension({"SMAP\nMrtrPrepaidRegistrationViewModel.kt\nKotlin\n*S Kotlin\n*F\n+ 1 MrtrPrepaidRegistrationViewModel.kt\nth/co/dtac/android/dtacone/viewmodel/mrtr_prepaid_registration/MrtrPrepaidRegistrationViewModel$uploadImage$5\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,1360:1\n1#2:1361\n*E\n"})
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_prepaid_registration.MrtrPrepaidRegistrationViewModel$uploadImage$5 */
/* loaded from: classes9.dex */
public final class MrtrPrepaidRegistrationViewModel$uploadImage$5 extends Lambda implements Function1<UploadImageResponse, Unit> {
    final /* synthetic */ MrtrPrepaidRegistrationViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrPrepaidRegistrationViewModel$uploadImage$5(MrtrPrepaidRegistrationViewModel mrtrPrepaidRegistrationViewModel) {
        super(1);
    ...
    public final void invoke2(UploadImageResponse uploadImageResponse) {
        ...
        if (filename != null) {
            ...
            mrtrPrepaidRepository.getAttachmentNames().add(filename);
        }
    }
}