...
public final class TooltipKt$TooltipBox$1$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        m60360d = TooltipKt.m60360d(SizeKt.m69752sizeInqDBjuR0$default(this.$modifier, TooltipKt.getTooltipMinWidth(), TooltipKt.getTooltipMinHeight(), this.$maxWidth, 0.0f, 8, null), this.$transition);
        ...
        Modifier semantics$default = SemanticsModifierKt.semantics$default(m60360d, false, (Function1) rememberedValue, 1, null);
        Shape shape = this.$shape;
        long j = this.$containerColor;
        float f = this.$elevation;
        Function2<Composer, Integer, Unit> function2 = this.$tooltipContent;
        int i2 = this.$$dirty;
        SurfaceKt.m70812SurfaceT9BRK9s(semantics$default, shape, j, 0L, f, f, null, function2, composer, ((i2 >> 6) & 112) | ((i2 >> 9) & 896) | (57344 & (i2 >> 6)) | ((i2 >> 3) & 458752) | ((i2 << 21) & 29360128), 72);
        if (ComposerKt.isTraceInProgress()) {
