...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.sellerID.viewModel.OneSellerViewModel$selectShop$1 */
/* loaded from: classes10.dex */
public final class OneSellerViewModel$selectShop$1 extends Lambda implements Function1<Disposable, Unit> {
    final /* synthetic */ OneSellerViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneSellerViewModel$selectShop$1(OneSellerViewModel oneSellerViewModel) {
        super(1);
    ...
    public final void invoke2(Disposable disposable) {
        ...
        mutableStateFlow.setValue(OneSelectShopState.Loading.INSTANCE);
    }
}