...
public final class C3454c extends WK1 {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C3454c(SnapshotStateMap map) {
        super(map);
    ...
    public /* bridge */ /* synthetic */ boolean add(Object obj) {
        return ((Boolean) m59812c(obj)).booleanValue();
    }

    @Override // java.util.Set, java.util.Collection
    public /* bridge */ /* synthetic */ boolean addAll(Collection collection) {
        return ((Boolean) m59811e(collection)).booleanValue();
    }

    /* renamed from: c */
    public Void m59812c(Object obj) {
    ...
    public boolean contains(Object obj) {
        return m65767a().containsKey(obj);
    }
    ...
    /* renamed from: e */
    public Void m59811e(Collection elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
        SnapshotStateMapKt.unsupported();
        throw new KotlinNothingValueException();
    }
    ...
    /* renamed from: f */
    public TM1 iterator() {
        return new TM1(m65767a(), ((ImmutableSet) m65767a().getReadable$runtime_release().getMap$runtime_release().entrySet()).iterator());
    }

    @Override // java.util.Set, java.util.Collection
    public boolean remove(Object obj) {
        if (m65767a().remove(obj) != null) {
            return true;
        }
        return false;
    }
