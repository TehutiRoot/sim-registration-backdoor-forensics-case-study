...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.change_pack.ChangePackViewModel$callApiCheckBlocking$2 */
/* loaded from: classes9.dex */
public final class ChangePackViewModel$callApiCheckBlocking$2 extends Lambda implements Function1<CheckBlockingResponse, CheckBlockingPackageTypeResponse> {
    public static final ChangePackViewModel$callApiCheckBlocking$2 INSTANCE = new ChangePackViewModel$callApiCheckBlocking$2();

    public ChangePackViewModel$callApiCheckBlocking$2() {
        super(1);
    }
