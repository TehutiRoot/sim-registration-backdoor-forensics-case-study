...
public class FDFCatalog implements COSObjectable {
    ...
    /* renamed from: a */
    public COSDictionary f60343a;

    public FDFCatalog() {
        this.f60343a = new COSDictionary();
    }

    public FDFDictionary getFDF() {
        COSDictionary cOSDictionary = (COSDictionary) this.f60343a.getDictionaryObject(COSName.FDF);
    ...
    public PDSignature getSignature() {
        COSDictionary cOSDictionary = (COSDictionary) this.f60343a.getDictionaryObject(COSName.SIG);
        if (cOSDictionary != null) {
    ...
    public String getVersion() {
        return this.f60343a.getNameAsString(COSName.VERSION);
    }

    public void setFDF(FDFDictionary fDFDictionary) {
        this.f60343a.setItem(COSName.FDF, fDFDictionary);
    }

    public void setSignature(PDSignature pDSignature) {
        this.f60343a.setItem(COSName.SIG, pDSignature);
    }

    public void setVersion(String str) {
        this.f60343a.setName(COSName.VERSION, str);
    }
