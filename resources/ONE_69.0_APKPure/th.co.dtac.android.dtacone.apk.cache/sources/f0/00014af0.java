...
/* renamed from: th.co.dtac.android.dtacone.view.fragment.customerenquiry.qrCode.CustomerEnquiryESimShowQrCodeFragment$initViewModel$1$3 */
/* loaded from: classes9.dex */
public final class CustomerEnquiryESimShowQrCodeFragment$initViewModel$1$3 extends Lambda implements Function1<Resource<? extends SendQRCodeRequest>, Unit> {
    final /* synthetic */ CustomerEnquiryESimShowQrCodeFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.fragment.customerenquiry.qrCode.CustomerEnquiryESimShowQrCodeFragment$initViewModel$1$3$WhenMappings */
    /* loaded from: classes9.dex */
    ...
    public CustomerEnquiryESimShowQrCodeFragment$initViewModel$1$3(CustomerEnquiryESimShowQrCodeFragment customerEnquiryESimShowQrCodeFragment) {
        super(1);
    ...
    public final void invoke2(Resource<SendQRCodeRequest> resource) {
        ...
        if (i == 2) {
            ...
            if (Intrinsics.areEqual(data != null ? data.getType() : null, "email")) {
                bottomSheetDialog2 = this.this$0.f99726i;
                ...
                bottomSheetDialog = this.this$0.f99732o;
