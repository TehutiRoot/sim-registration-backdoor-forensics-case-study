...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.prepaid_registration.viewmodel.OnePrepaidViewModel$registerPrepaid$1$3 */
/* loaded from: classes10.dex */
public final class OnePrepaidViewModel$registerPrepaid$1$3 extends Lambda implements Function1<OnePrepaidRegisterResponse, Unit> {
    final /* synthetic */ OnePrepaidViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePrepaidViewModel$registerPrepaid$1$3(OnePrepaidViewModel onePrepaidViewModel) {
        super(1);
    ...
    public final void invoke2(OnePrepaidRegisterResponse onePrepaidRegisterResponse) {
        ...
        if (onePrepaidRepository2.isCutSim()) {
            this.this$0.m10520z(false, null);
        } else if (this.this$0.isCheckSim()) {
            this.this$0.m10546h0(false, null);
        } else {
