...
public final class ObservablePublishAlt<T> extends ConnectableObservable<T> implements HasUpstreamObservableSource<T>, ResettableConnectable {
    ...
    /* renamed from: a */
    public final ObservableSource f65480a;

    /* renamed from: b */
    public final AtomicReference f65481b = new AtomicReference();
    ...
    public void connect(Consumer<? super Disposable> consumer) {
        ...
        while (true) {
            publishConnection = (PublishConnection) this.f65481b.get();
            if (publishConnection != null && !publishConnection.isDisposed()) {
                break;
            }
            PublishConnection publishConnection2 = new PublishConnection(this.f65481b);
            if (AbstractC23094xo1.m479a(this.f65481b, publishConnection, publishConnection2)) {
        ...
        try {
            ...
            if (z) {
                this.f65480a.subscribe(publishConnection);
            }
        } catch (Throwable th2) {
    ...
    public void resetIf(Disposable disposable) {
        AbstractC23094xo1.m479a(this.f65481b, (PublishConnection) disposable, null);
    }
