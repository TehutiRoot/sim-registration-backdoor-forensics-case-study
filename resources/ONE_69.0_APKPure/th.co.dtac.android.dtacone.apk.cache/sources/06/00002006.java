...
public final class ImageCaptureRotationOptionQuirk implements Quirk {
    ...
    /* renamed from: b */
    public static boolean m62739b() {
        if (m62740a() && Build.VERSION.SDK_INT == 21) {
            return true;
        }
        return false;
    }
    ...
    /* renamed from: e */
    public static boolean m62736e() {
        if (!m62737d() && !m62738c() && !m62739b()) {
            return false;
        }
        return true;
    }
