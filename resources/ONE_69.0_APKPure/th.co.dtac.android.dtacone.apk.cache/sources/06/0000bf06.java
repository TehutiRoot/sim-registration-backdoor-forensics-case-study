...
public class setScaleX implements setDarkTextColor.valueOf {
    public static final setScaleX valueOf = new setScaleX();

    @Override // com.netcetera.threeds.sdk.infrastructure.setDarkTextColor.valueOf
    public getHeadingTextColor values() {
        return setDarkTextColor.setAccessibilityPaneTitle();
    }
}