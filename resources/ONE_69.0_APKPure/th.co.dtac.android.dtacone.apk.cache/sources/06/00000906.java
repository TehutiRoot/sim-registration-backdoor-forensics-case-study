...
public class JW1 {
    ...
    /* renamed from: a */
    public void m67869a(long j, double d, double d2) {
        float f;
        float f2;
        double d3;
        ...
        if (sin2 >= 1.0d) {
            ...
            this.f3027a = Math.round((round + acos) * 8.64E7d) + 946728000000L;
            long round2 = Math.round((round - acos) * 8.64E7d) + 946728000000L;
            this.f3028b = round2;
            if (round2 < j && this.f3027a > j) {
                this.f3029c = 0;
            } else {
                this.f3029c = 1;
            }
