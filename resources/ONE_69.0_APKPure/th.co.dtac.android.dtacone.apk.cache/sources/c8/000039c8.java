...
@Metadata(m29143d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0007\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m29142d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_mapsHomeWork", "Landroidx/compose/material/icons/Icons$Outlined;", "getMapsHomeWork", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "MapsHomeWork", "material-icons-extended_release"}, m29141k = 2, m29140mv = {1, 8, 0})
@SourceDebugExtension({"SMAP\nMapsHomeWork.kt\nKotlin\n*S Kotlin\n*F\n+ 1 MapsHomeWork.kt\nandroidx/compose/material/icons/outlined/MapsHomeWorkKt\n+ 2 Icons.kt\nandroidx/compose/material/icons/IconsKt\n+ 3 Dp.kt\nandroidx/compose/ui/unit/DpKt\n+ 4 ImageVector.kt\nandroidx/compose/ui/graphics/vector/ImageVectorKt\n+ 5 Vector.kt\nandroidx/compose/ui/graphics/vector/VectorKt\n*L\n1#1,93:1\n122#2:94\n116#2,3:95\n119#2,3:99\n132#2,18:102\n152#2:139\n132#2,18:140\n152#2:177\n132#2,18:178\n152#2:215\n132#2,18:216\n152#2:253\n132#2,18:254\n152#2:291\n174#3:98\n694#4,2:120\n706#4,2:122\n708#4,11:128\n694#4,2:158\n706#4,2:160\n708#4,11:166\n694#4,2:196\n706#4,2:198\n708#4,11:204\n694#4,2:234\n706#4,2:236\n708#4,11:242\n694#4,2:272\n706#4,2:274\n708#4,11:280\n64#5,4:124\n64#5,4:162\n64#5,4:200\n64#5,4:238\n64#5,4:276\n*S KotlinDebug\n*F\n+ 1 MapsHomeWork.kt\nandroidx/compose/material/icons/outlined/MapsHomeWorkKt\n*L\n29#1:94\n29#1:95,3\n29#1:99,3\n30#1:102,18\n30#1:139\n37#1:140,18\n37#1:177\n44#1:178,18\n44#1:215\n51#1:216,18\n51#1:253\n75#1:254,18\n75#1:291\n29#1:98\n30#1:120,2\n30#1:122,2\n30#1:128,11\n37#1:158,2\n37#1:160,2\n37#1:166,11\n44#1:196,2\n44#1:198,2\n44#1:204,11\n51#1:234,2\n51#1:236,2\n51#1:242,11\n75#1:272,2\n75#1:274,2\n75#1:280,11\n30#1:124,4\n37#1:162,4\n44#1:200,4\n51#1:238,4\n75#1:276,4\n*E\n"})
/* loaded from: classes.dex */
public final class MapsHomeWorkKt {

    /* renamed from: a */
    public static ImageVector f18062a;

    @NotNull
    public static final ImageVector getMapsHomeWork(@NotNull Icons.Outlined outlined) {
        Intrinsics.checkNotNullParameter(outlined, "<this>");
        ImageVector imageVector = f18062a;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.MapsHomeWork", C3623Dp.m73842constructorimpl(24.0f), C3623Dp.m73842constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder3.moveTo(17.0f, 15.0f);
        ...
        pathBuilder4.moveTo(1.0f, 11.0f);
        ...
        pathBuilder4.lineTo(1.0f, 11.0f);
        pathBuilder4.close();
        pathBuilder4.moveTo(13.0f, 19.0f);
        pathBuilder4.horizontalLineToRelative(-2.0f);
        pathBuilder4.verticalLineToRelative(-5.0f);
        ...
        pathBuilder4.lineToRelative(5.0f, -3.5f);
        pathBuilder4.lineToRelative(5.0f, 3.5f);
        ...
        pathBuilder5.moveTo(10.0f, 3.0f);
        pathBuilder5.lineToRelative(0.0f, 1.97f);
        pathBuilder5.lineToRelative(2.0f, 1.43f);
        pathBuilder5.lineToRelative(0.0f, -1.4f);
        pathBuilder5.lineToRelative(9.0f, 0.0f);
        pathBuilder5.lineToRelative(0.0f, 14.0f);
        pathBuilder5.lineToRelative(-4.0f, 0.0f);
        pathBuilder5.lineToRelative(0.0f, 2.0f);
        pathBuilder5.lineToRelative(6.0f, 0.0f);
        pathBuilder5.lineToRelative(0.0f, -18.0f);
        pathBuilder5.close();
