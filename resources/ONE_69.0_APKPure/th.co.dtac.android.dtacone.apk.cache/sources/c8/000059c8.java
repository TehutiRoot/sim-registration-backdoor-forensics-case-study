...
public final class NavigationDrawerKt$NavigationDrawerItem$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        Modifier m69717paddingqDBjuR0$default = PaddingKt.m69717paddingqDBjuR0$default(companion, C3623Dp.m73842constructorimpl(16), 0.0f, C3623Dp.m73842constructorimpl(24), 0.0f, 10, null);
        ...
        if (function2 != null) {
            CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m71909boximpl(navigationDrawerItemColors.iconColor(z, composer, ((i2 >> 3) & 14) | ((i2 >> 18) & 112)).getValue().m71929unboximpl()))}, function2, composer, ((i2 >> 9) & 112) | 8);
            SpacerKt.Spacer(SizeKt.m69753width3ABfNKs(companion, C3623Dp.m73842constructorimpl(12)), composer, 6);
        }
        ...
        Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf2 = LayoutKt.materializerOf(m68554a);
        if (!(composer.getApplier() instanceof Applier)) {
            ComposablesKt.invalidApplier();
        }
        composer.startReusableNode();
        ...
        CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m71909boximpl(navigationDrawerItemColors.textColor(z, composer, i3).getValue().m71929unboximpl()))}, function23, composer, ((i2 << 3) & 112) | 8);
        composer.endReplaceableGroup();
        composer.endNode();
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
        ...
        if (function22 != null) {
            SpacerKt.Spacer(SizeKt.m69753width3ABfNKs(companion, C3623Dp.m73842constructorimpl(12)), composer, 6);
            CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m71909boximpl(navigationDrawerItemColors.badgeColor(z, composer, i3).getValue().m71929unboximpl()))}, function22, composer, ((i2 >> 12) & 112) | 8);
        }
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
        composer.endNode();
