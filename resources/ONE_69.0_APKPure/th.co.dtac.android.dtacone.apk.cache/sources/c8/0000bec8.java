...
public class setOnCreateContextMenuListener implements setDarkTextColor.valueOf {
    private final setDarkTextColor ThreeDS2Service;

    public setOnCreateContextMenuListener(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.ChallengeParameters(this.ThreeDS2Service);
    }
}