...
public class VMPCEngine implements StreamCipher {
    ...
    /* renamed from: n */
    protected byte f75137n = 0;

    /* renamed from: P */
    protected byte[] f75136P = null;

    /* renamed from: s */
    protected byte f75138s = 0;
    ...
    public void initKey(byte[] bArr, byte[] bArr2) {
        this.f75138s = (byte) 0;
        this.f75136P = new byte[256];
        for (int i = 0; i < 256; i++) {
            this.f75136P[i] = (byte) i;
        }
        for (int i2 = 0; i2 < 768; i2++) {
            byte[] bArr3 = this.f75136P;
            byte b = this.f75138s;
            int i3 = i2 & 255;
            byte b2 = bArr3[i3];
        ...
        for (int i4 = 0; i4 < 768; i4++) {
            byte[] bArr4 = this.f75136P;
            byte b4 = this.f75138s;
            int i5 = i4 & 255;
            byte b5 = bArr4[i5];
    ...
    public byte returnByte(byte b) {
        byte[] bArr = this.f75136P;
        byte b2 = this.f75138s;
        byte b3 = this.f75137n;
