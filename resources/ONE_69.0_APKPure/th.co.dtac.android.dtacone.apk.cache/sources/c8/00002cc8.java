...
public final class TabKt$TabBaselineLayout$2$measure$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke2(@NotNull Placeable.PlacementScope layout) {
        ...
        if (placeable2 == null || (placeable = this.$iconPlaceable) == null) {
            if (placeable2 != null) {
                TabKt.m60726e(layout, placeable2, this.$tabHeight);
                return;
            }
            Placeable placeable3 = this.$iconPlaceable;
            if (placeable3 != null) {
                TabKt.m60726e(layout, placeable3, this.$tabHeight);
                return;
            }
            return;
        }
        ...
        TabKt.m60727d(layout, measureScope, placeable2, placeable, i, i2, intValue, num2.intValue());
    }
}