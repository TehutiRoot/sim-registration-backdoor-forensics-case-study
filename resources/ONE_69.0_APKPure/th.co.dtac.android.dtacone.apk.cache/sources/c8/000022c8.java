...
@DebugMetadata(m29093c = "androidx.compose.animation.core.MutatorMutex$mutateWith$2", m29092f = "InternalMutatorMutex.kt", m29091i = {0, 0, 1, 1}, m29090l = {SyslogConstants.LOG_LOCAL7, 171}, m29089m = "invokeSuspend", m29088n = {"mutator", "$this$withLock_u24default$iv", "mutator", "$this$withLock_u24default$iv"}, m29087s = {"L$0", "L$1", "L$0", "L$1"})
...
public final class MutatorMutex$mutateWith$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super R>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        Function2 function2;
        Object obj2;
        MutatorMutex.C2726a c2726a;
        MutatorMutex mutatorMutex;
        MutatorMutex.C2726a c2726a2;
        Throwable th2;
                ...
                if (r1 != 0) {
                    if (r1 != 1) {
                        if (r1 == 2) {
                            ...
                            c2726a2 = (MutatorMutex.C2726a) this.L$0;
                            try {
                                ResultKt.throwOnFailure(obj);
                                atomicReference2 = mutatorMutex2.f12648a;
                                AbstractC23094xo1.m479a(atomicReference2, c2726a2, null);
                                mutex2.unlock(null);
                                return obj;
                            } catch (Throwable th3) {
                                th2 = th3;
                                atomicReference = mutatorMutex2.f12648a;
                                AbstractC23094xo1.m479a(atomicReference, c2726a2, null);
                                throw th2;
                            }
                        }
                    ...
                    c2726a = (MutatorMutex.C2726a) this.L$0;
                    ResultKt.throwOnFailure(obj);
                    ...
                    MutatorMutex.C2726a c2726a3 = new MutatorMutex.C2726a(mutatePriority, (Job) element);
                    this.this$0.m61643a(c2726a3);
                    mutex = this.this$0.f12649b;
