...
public final class AddressListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    /* renamed from: a */
    public final Context f81422a;

    /* renamed from: b */
    public final GetAddressFromPostcodeResponse f81423b;
    ...
    /* renamed from: e */
    public OnClickData f81426e;
    @NotNull
    public static final Companion Companion = new Companion(null);
    public static final int $stable = 8;

    @Metadata(m29143d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0007X\u0082T¢\u0006\u0002\n\u0000¨\u0006\b"}, m29142d2 = {"Lth/co/dtac/android/dtacone/adapter/online_register/AddressListAdapter$Companion;", "", "()V", "AMPHUR", "", "TUMBON", "VIEW_TYPE_NORMAL", "", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    public final class MainPackItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public final void setItemLayout(@NotNull LinearLayout linearLayout) {
            ...
            this.f81427a = linearLayout;
        }

        public final void setTvMainPackName(@NotNull TextView textView) {
            Intrinsics.checkNotNullParameter(textView, "<set-?>");
            this.f81428b = textView;
        }
    }

    @Metadata(m29143d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\u0018\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007H&J\u0018\u0010\b\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\t2\u0006\u0010\u0006\u001a\u00020\u0007H&¨\u0006\n"}, m29142d2 = {"Lth/co/dtac/android/dtacone/adapter/online_register/AddressListAdapter$OnClickData;", "", "onClickAmphur", "", "data", "Lth/co/dtac/android/dtacone/model/mrtr_online_registration/address_from_postcode/response/AmphurItem;", "pos", "", "onClicktumbon", "Lth/co/dtac/android/dtacone/model/mrtr_online_registration/address_from_postcode/response/TumbonItem;", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    public AddressListAdapter(@NotNull Context mContext, @NotNull GetAddressFromPostcodeResponse data, @NotNull String dataType, int i) {
        ...
        this.f81422a = mContext;
        this.f81423b = data;
        this.f81424c = dataType;
        this.f81425d = i;
    }

    /* renamed from: a */
    public static /* synthetic */ void m20479a(AmphurItem amphurItem, AddressListAdapter addressListAdapter, int i, View view) {
        m20477c(amphurItem, addressListAdapter, i, view);
    }

    /* renamed from: b */
    public static /* synthetic */ void m20478b(TumbonItem tumbonItem, AddressListAdapter addressListAdapter, int i, View view) {
        m20476d(tumbonItem, addressListAdapter, i, view);
    }

    /* renamed from: c */
    public static final void m20477c(AmphurItem amphurItem, AddressListAdapter this$0, int i, View view) {
        OnClickData onClickData;
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        if (amphurItem != null && (onClickData = this$0.f81426e) != null) {
            onClickData.onClickAmphur(amphurItem, i);
        }
    }

    /* renamed from: d */
    public static final void m20476d(TumbonItem tumbonItem, AddressListAdapter this$0, int i, View view) {
        OnClickData onClickData;
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        if (tumbonItem != null && (onClickData = this$0.f81426e) != null) {
    ...
    public int getItemCount() {
        ...
        if (Intrinsics.areEqual(this.f81424c, "AMPHUR")) {
            List<AmphurItem> amphur = this.f81423b.getAmphur();
            if (amphur == null) {
                return 0;
            }
            return amphur.size();
        }
        List<AmphurItem> amphur2 = this.f81423b.getAmphur();
        if (amphur2 == null || (amphurItem = amphur2.get(this.f81425d)) == null || (tumbon = amphurItem.getTumbon()) == null) {
            return 0;
        }
        return tumbon.size();
    }
    ...
    public void onBindViewHolder(@NotNull RecyclerView.ViewHolder holder, final int i) {
            ...
            if (holder instanceof MainPackItemViewHolder) {
                ...
                mainPackItemViewHolder.getItemLayout().setOnClickListener(new View.OnClickListener() { // from class: w2
                    ...
                    public final void onClick(View view) {
                        AddressListAdapter.m20479a(AmphurItem.this, this, i, view);
                    }
                });
                return;
            }
        ...
        if (holder instanceof MainPackItemViewHolder) {
            ...
            mainPackItemViewHolder2.getItemLayout().setOnClickListener(new View.OnClickListener() { // from class: x2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    AddressListAdapter.m20478b(TumbonItem.this, this, i, view);
                }
            });
        }
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int i) {
        ...
        View view = LayoutInflater.from(this.f81422a).inflate(R.layout.item_main_pack_row, parent, false);
