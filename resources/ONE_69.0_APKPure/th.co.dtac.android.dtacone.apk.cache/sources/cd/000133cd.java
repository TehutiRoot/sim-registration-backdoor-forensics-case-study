...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.viewModel.OneMnpViewModel$validateOperator$2 */
/* loaded from: classes10.dex */
public final class OneMnpViewModel$validateOperator$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ OneMnpViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneMnpViewModel$validateOperator$2(OneMnpViewModel oneMnpViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable throwable) {
        ...
        m13549J1.setValue(Resource.Companion.error$default(Resource.Companion, "", null, null, 4, null));
