...
public final class UploadResponse {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return (obj instanceof UploadResponse) && Intrinsics.areEqual(this.f54660a, ((UploadResponse) obj).f54660a);
    }
    ...
    public String toString() {
        return "UploadResponse(name=" + this.f54660a + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
}