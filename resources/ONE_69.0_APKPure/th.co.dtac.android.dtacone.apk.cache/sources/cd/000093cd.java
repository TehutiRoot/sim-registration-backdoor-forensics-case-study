...
public final class zzha {
    ...
    /* renamed from: a */
    public static UserManager f46296a;

    /* renamed from: b */
    public static volatile boolean f46297b = !zzb();
    ...
    */
    public static boolean zza(android.content.Context r8) {
        /*
            ...
            r1 = 0
            if (r0 == 0) goto L60
            boolean r0 = com.google.android.gms.internal.measurement.zzha.f46297b
            if (r0 == 0) goto Lc
            goto L60
        Lc:
            ...
            monitor-enter(r0)
            boolean r2 = com.google.android.gms.internal.measurement.zzha.f46297b     // Catch: java.lang.Throwable -> L15
            if (r2 == 0) goto L17
        ...
        L19:
            ...
            r5 = 0
            if (r3 > r4) goto L43
            android.os.UserManager r4 = com.google.android.gms.internal.measurement.zzha.f46296a     // Catch: java.lang.Throwable -> L15
            if (r4 != 0) goto L2b
            java.lang.Class<android.os.UserManager> r4 = android.os.UserManager.class
            java.lang.Object r4 = p000.AbstractC1845a3.m65187a(r8, r4)     // Catch: java.lang.Throwable -> L15
            android.os.UserManager r4 = (android.os.UserManager) r4     // Catch: java.lang.Throwable -> L15
            com.google.android.gms.internal.measurement.zzha.f46296a = r4     // Catch: java.lang.Throwable -> L15
        L2b:
            android.os.UserManager r4 = com.google.android.gms.internal.measurement.zzha.f46296a     // Catch: java.lang.Throwable -> L15
            if (r4 != 0) goto L31
            r8 = 1
            goto L56
        L31:
            boolean r6 = p000.AbstractC21499ob2.m26096a(r4)     // Catch: java.lang.Throwable -> L15 java.lang.NullPointerException -> L45
            if (r6 != 0) goto L41
        ...
        L45:
            ...
            com.google.android.gms.internal.measurement.zzha.f46296a = r5     // Catch: java.lang.Throwable -> L15
            int r3 = r3 + 1
            goto L19
        L52:
            if (r8 == 0) goto L56
        ...
        L56:
            if (r8 == 0) goto L5a
            com.google.android.gms.internal.measurement.zzha.f46297b = r2     // Catch: java.lang.Throwable -> L15
        L5a:
            monitor-exit(r0)     // Catch: java.lang.Throwable -> L15
            if (r8 != 0) goto L60
            return r2
