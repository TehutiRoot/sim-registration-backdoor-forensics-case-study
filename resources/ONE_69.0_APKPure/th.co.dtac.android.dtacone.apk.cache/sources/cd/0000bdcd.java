...
public class setAlpha implements setDarkTextColor.valueOf {
    public static final setAlpha get = new setAlpha();

    @Override // com.netcetera.threeds.sdk.infrastructure.setDarkTextColor.valueOf
    public getHeadingTextColor values() {
        return setDarkTextColor.setVerticalScrollbarPosition();
    }
}