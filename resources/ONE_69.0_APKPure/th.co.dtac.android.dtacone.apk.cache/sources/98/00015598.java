...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.device_sale.DeviceSaleViewModel$callGetBundledItemsStock$2 */
/* loaded from: classes9.dex */
public final class DeviceSaleViewModel$callGetBundledItemsStock$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ MutableLiveData<Resource<Void>> $response;
    final /* synthetic */ DeviceSaleViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DeviceSaleViewModel$callGetBundledItemsStock$2(DeviceSaleViewModel deviceSaleViewModel, MutableLiveData<Resource<Void>> mutableLiveData) {
        super(1);
