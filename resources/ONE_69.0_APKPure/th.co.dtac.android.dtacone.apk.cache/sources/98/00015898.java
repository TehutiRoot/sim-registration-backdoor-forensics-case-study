...
@SourceDebugExtension({"SMAP\nMrtrMnpViewModel.kt\nKotlin\n*S Kotlin\n*F\n+ 1 MrtrMnpViewModel.kt\nth/co/dtac/android/dtacone/viewmodel/mrtr_mnp/MrtrMnpViewModel$uploadImage$5\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,859:1\n1#2:860\n*E\n"})
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_mnp.MrtrMnpViewModel$uploadImage$5 */
/* loaded from: classes9.dex */
public final class MrtrMnpViewModel$uploadImage$5 extends Lambda implements Function1<UploadImageResponse, Unit> {
    final /* synthetic */ MrtrMnpViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrMnpViewModel$uploadImage$5(MrtrMnpViewModel mrtrMnpViewModel) {
        super(1);
    ...
    public final void invoke2(UploadImageResponse uploadImageResponse) {
        ...
        if (filename != null) {
            ...
            mrtrMnpRepository.getAttachmentNames().add(filename);
        }
    }
}