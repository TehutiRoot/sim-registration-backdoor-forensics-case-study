...
import com.google.firebase.installations.local.C8516a;
...
public abstract class PersistedInstallationEntry {
    ...
    public static Builder builder() {
        return new C8516a.C8518b().setTokenCreationEpochInSecs(0L).setRegistrationStatus(PersistedInstallation.RegistrationStatus.ATTEMPT_MIGRATION).setExpiresInSecs(0L);
    }
