...
public final class AndroidPopup_androidKt$Popup$popupLayout$1$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    /* renamed from: androidx.compose.ui.window.AndroidPopup_androidKt$Popup$popupLayout$1$1$1$1 */
    /* loaded from: classes2.dex */
    public static final class C36331 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    ...
    @Metadata(m29143d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n¢\u0006\u0004\b\u0004\u0010\u0005"}, m29142d2 = {"<anonymous>", "", "it", "Landroidx/compose/ui/unit/IntSize;", "invoke-ozmzZPI", "(J)V"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: androidx.compose.ui.window.AndroidPopup_androidKt$Popup$popupLayout$1$1$1$2 */
    /* loaded from: classes2.dex */
    public static final class C36342 extends Lambda implements Function1<IntSize, Unit> {
        final /* synthetic */ PopupLayout $this_apply;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C36342(PopupLayout popupLayout) {
            super(1);
        ...
        public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
            m74081invokeozmzZPI(intSize.m74006unboximpl());
            return Unit.INSTANCE;
        }

        /* renamed from: invoke-ozmzZPI  reason: not valid java name */
        public final void m74081invokeozmzZPI(long j) {
            this.$this_apply.m74085setPopupContentSizefhxjrPA(IntSize.m73994boximpl(j));
            this.$this_apply.updatePosition();
        }
    }

    @Metadata(m29143d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001H\u000b¢\u0006\u0004\b\u0002\u0010\u0003"}, m29142d2 = {"<anonymous>", "", "invoke", "(Landroidx/compose/runtime/Composer;I)V"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: androidx.compose.ui.window.AndroidPopup_androidKt$Popup$popupLayout$1$1$1$3 */
    /* loaded from: classes2.dex */
    public static final class C36353 extends Lambda implements Function2<Composer, Integer, Unit> {
        final /* synthetic */ State<Function2<Composer, Integer, Unit>> $currentContent$delegate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C36353(State<? extends Function2<? super Composer, ? super Integer, Unit>> state) {
            super(2);
        ...
        public final void invoke(@Nullable Composer composer, int i) {
            ...
            m58801a = AndroidPopup_androidKt.m58801a(this.$currentContent$delegate);
            m58801a.invoke(composer, 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        Modifier alpha = AlphaKt.alpha(OnRemeasuredModifierKt.onSizeChanged(SemanticsModifierKt.semantics$default(Modifier.Companion, false, C36331.INSTANCE, 1, null), new C36342(this.$this_apply)), this.$this_apply.getCanCalculatePosition() ? 1.0f : 0.0f);
        ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer, 606497925, true, new C36353(this.$currentContent$delegate));
        ...
        Updater.m71584setimpl(m71577constructorimpl, androidPopup_androidKt$SimpleStack$1, companion.getSetMeasurePolicy());
