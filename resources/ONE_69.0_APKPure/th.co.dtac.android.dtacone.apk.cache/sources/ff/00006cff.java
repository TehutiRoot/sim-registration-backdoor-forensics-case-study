...
public class TextViewBindingAdapter {
    ...
    /* loaded from: classes2.dex */
    public class C4286a implements TextWatcher {

        /* renamed from: a */
        public final /* synthetic */ BeforeTextChanged f34668a;

        /* renamed from: b */
        public final /* synthetic */ OnTextChanged f34669b;

        /* renamed from: c */
        public final /* synthetic */ InverseBindingListener f34670c;

        /* renamed from: d */
        public final /* synthetic */ AfterTextChanged f34671d;

        public C4286a(BeforeTextChanged beforeTextChanged, OnTextChanged onTextChanged, InverseBindingListener inverseBindingListener, AfterTextChanged afterTextChanged) {
            this.f34668a = beforeTextChanged;
            this.f34669b = onTextChanged;
            this.f34670c = inverseBindingListener;
            this.f34671d = afterTextChanged;
        }

        @Override // android.text.TextWatcher
        public void afterTextChanged(Editable editable) {
            AfterTextChanged afterTextChanged = this.f34671d;
        ...
        public void beforeTextChanged(CharSequence charSequence, int i, int i2, int i3) {
            BeforeTextChanged beforeTextChanged = this.f34668a;
        ...
        public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
            OnTextChanged onTextChanged = this.f34669b;
            if (onTextChanged != null) {
                onTextChanged.onTextChanged(charSequence, i, i2, i3);
            }
            InverseBindingListener inverseBindingListener = this.f34670c;
    ...
    /* renamed from: a */
    public static boolean m56242a(CharSequence charSequence, CharSequence charSequence2) {
        boolean z;
        boolean z2;
    ...
    /* renamed from: b */
    public static void m56241b(Drawable drawable) {
        if (drawable != null) {
    ...
    public static void setText(TextView textView, CharSequence charSequence) {
        ...
        if (charSequence != text) {
            if (charSequence != null || text.length() != 0) {
                ...
                } else if (!m56242a(charSequence, text)) {
                    return;
                }
    ...
    public static void setTextWatcher(TextView textView, BeforeTextChanged beforeTextChanged, OnTextChanged onTextChanged, AfterTextChanged afterTextChanged, InverseBindingListener inverseBindingListener) {
        ...
        if (beforeTextChanged == null && afterTextChanged == null && onTextChanged == null && inverseBindingListener == null) {
            ...
            c4286a = new C4286a(beforeTextChanged, onTextChanged, inverseBindingListener, afterTextChanged);
        }
        TextWatcher textWatcher = (TextWatcher) ListenerUtil.trackListener(textView, c4286a, R.id.textWatcher);
        if (textWatcher != null) {
            textView.removeTextChangedListener(textWatcher);
        }
        if (c4286a != null) {
            textView.addTextChangedListener(c4286a);
        }
    }
