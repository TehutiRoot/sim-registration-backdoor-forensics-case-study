...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.prepaid_registration.viewmodel.OnePrepaidViewModel$queryTransaction$2 */
/* loaded from: classes10.dex */
public final class OnePrepaidViewModel$queryTransaction$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ OnePrepaidViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePrepaidViewModel$queryTransaction$2(OnePrepaidViewModel onePrepaidViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable it) {
        ...
        onePrepaidRepository.setQueryTransactionResponse(null);
