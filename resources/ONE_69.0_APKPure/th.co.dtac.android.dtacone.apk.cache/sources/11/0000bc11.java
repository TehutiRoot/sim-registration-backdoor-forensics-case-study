...
public class getProgressViewBackgroundColor implements setDarkTextColor.valueOf {
    private final setDarkTextColor ThreeDS2ServiceInstance;

    public getProgressViewBackgroundColor(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.cleanup(this.ThreeDS2ServiceInstance);
    }
}