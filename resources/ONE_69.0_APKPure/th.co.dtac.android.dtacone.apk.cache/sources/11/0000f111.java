...
public class RequestProxyAuthentication extends AbstractC18903Yx1 {
    ...
    public void process(HttpRequest httpRequest, HttpContext httpContext) throws HttpException, IOException {
        ...
        if (httpRoutedConnection == null) {
            this.f8064a.debug("HTTP connection not set in the context");
            ...
            if (authState == null) {
                this.f8064a.debug("Proxy auth state not set in the context");
                return;
            }
            ...
            m65272c(authState, httpRequest, httpContext);
        }
    }
}