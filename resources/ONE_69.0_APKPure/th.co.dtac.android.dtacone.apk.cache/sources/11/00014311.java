...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.tol.screen.inputInfo.InputInfoScreenKt$ProvinceList$1$2$invoke$$inlined$items$default$4 */
/* loaded from: classes10.dex */
public final class C15469x59ea0278 extends Lambda implements Function4<LazyItemScope, Integer, Composer, Integer, Unit> {
    final /* synthetic */ int $$dirty$inlined;
    final /* synthetic */ List $items;
    final /* synthetic */ Function1 $onProvinceSelect$inlined;
    final /* synthetic */ int $provinceId$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C15469x59ea0278(List list, int i, Function1 function1, int i2) {
        super(4);
        this.$items = list;
        this.$provinceId$inlined = i;
        this.$onProvinceSelect$inlined = function1;
    ...
    public final void invoke(@NotNull LazyItemScope items, int i, @Nullable Composer composer, int i2) {
        ...
        Province province = (Province) this.$items.get(i);
        String name = province.getName();
        boolean z = province.getId() == this.$provinceId$inlined;
        composer.startReplaceableGroup(511388516);
        boolean changed = composer.changed(this.$onProvinceSelect$inlined) | composer.changed(province);
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new InputInfoScreenKt$ProvinceList$1$2$1$1$1(this.$onProvinceSelect$inlined, province);
