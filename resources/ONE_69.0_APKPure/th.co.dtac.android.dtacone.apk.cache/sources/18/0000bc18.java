...
public final class getSDKReferenceNumber {
    ...
    public static final class get<T> implements getSDKEphemeralPublicKey<T> {
        private final AbstractC9605ne<T> get;

        public get(final getSDKEphemeralPublicKey<T> getsdkephemeralpublickey) {
            this.get = new AbstractC9605ne<T>() { // from class: com.netcetera.threeds.sdk.infrastructure.getSDKReferenceNumber.get.1
                @Override // com.netcetera.threeds.sdk.infrastructure.AbstractC9605ne
