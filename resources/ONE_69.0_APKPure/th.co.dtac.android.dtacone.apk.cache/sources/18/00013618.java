...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.ownerManagement.viewModel.OneOwnerManagementViewModel$deleteOneOwner$3 */
/* loaded from: classes10.dex */
public final class OneOwnerManagementViewModel$deleteOneOwner$3 extends Lambda implements Function1<StatusResponse, Unit> {
    final /* synthetic */ OneOwnerManagementViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneOwnerManagementViewModel$deleteOneOwner$3(OneOwnerManagementViewModel oneOwnerManagementViewModel) {
        super(1);
    ...
    public final void invoke2(StatusResponse statusResponse) {
        ...
        m12772j.setValue(Resource.Companion.success(null));
    }
}