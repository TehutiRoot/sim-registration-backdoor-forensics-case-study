...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.prepaid_registration.viewmodel.OnePrepaidViewModel$validateBarcodeTrue$2 */
/* loaded from: classes10.dex */
public final class OnePrepaidViewModel$validateBarcodeTrue$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ int $configCounter;
    final /* synthetic */ OnePrepaidViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePrepaidViewModel$validateBarcodeTrue$2(OnePrepaidViewModel onePrepaidViewModel, int i) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable it) {
        ...
        oneErrorService.handleException(it, new OneErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.view.appOne.prepaid_registration.viewmodel.OnePrepaidViewModel$validateBarcodeTrue$2.1
