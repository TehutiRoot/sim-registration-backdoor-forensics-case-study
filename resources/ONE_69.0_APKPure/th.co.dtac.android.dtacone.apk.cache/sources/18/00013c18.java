...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.pre2post.viewModel.OnePre2PostViewModel$verifySubscriberPreToPost$3 */
/* loaded from: classes10.dex */
public final class OnePre2PostViewModel$verifySubscriberPreToPost$3 extends Lambda implements Function1<OnePre2PostVerifySubscriberPreToPostResponse, Unit> {
    final /* synthetic */ OnePre2PostViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePre2PostViewModel$verifySubscriberPreToPost$3(OnePre2PostViewModel onePre2PostViewModel) {
        super(1);
    ...
    public final void invoke2(OnePre2PostVerifySubscriberPreToPostResponse onePre2PostVerifySubscriberPreToPostResponse) {
        MutableLiveData m10934C1;
        m10934C1 = this.this$0.m10934C1();
        m10934C1.setValue(Resource.Companion.success(onePre2PostVerifySubscriberPreToPostResponse));
    }
}