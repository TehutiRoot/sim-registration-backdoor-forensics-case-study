...
public final class CompletableTakeUntilCompletable extends Completable {
    ...
    /* renamed from: a */
    public final Completable f64040a;

    /* renamed from: b */
    public final CompletableSource f64041b;
    ...
    public CompletableTakeUntilCompletable(Completable completable, CompletableSource completableSource) {
        this.f64040a = completable;
        this.f64041b = completableSource;
    }
    ...
    public void subscribeActual(CompletableObserver completableObserver) {
        ...
        this.f64041b.subscribe(takeUntilMainObserver.other);
        this.f64040a.subscribe(takeUntilMainObserver);
    }
}