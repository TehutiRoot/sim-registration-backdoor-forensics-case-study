...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.customerenquiry.InfoAnalyticViewModel$callCheckBlocking$3 */
/* loaded from: classes9.dex */
public final class InfoAnalyticViewModel$callCheckBlocking$3 extends Lambda implements Function1<CheckBlockingPackageTypeResponse, Unit> {
    final /* synthetic */ InfoAnalyticViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InfoAnalyticViewModel$callCheckBlocking$3(InfoAnalyticViewModel infoAnalyticViewModel) {
        super(1);
    ...
    public final void invoke2(CheckBlockingPackageTypeResponse checkBlockingPackageTypeResponse) {
        ...
        m3196B0.postValue(Resource.Companion.success(checkBlockingPackageTypeResponse));
    }
}