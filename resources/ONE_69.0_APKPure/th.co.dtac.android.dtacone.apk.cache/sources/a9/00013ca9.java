...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.prepaid_registration.fragment.consent.OnePrepaidTelcoFragment$activity$2 */
/* loaded from: classes10.dex */
public final class OnePrepaidTelcoFragment$activity$2 extends Lambda implements Function0<OnePrepaidRegistrationActivity> {
    final /* synthetic */ OnePrepaidTelcoFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePrepaidTelcoFragment$activity$2(OnePrepaidTelcoFragment onePrepaidTelcoFragment) {
        super(0);
