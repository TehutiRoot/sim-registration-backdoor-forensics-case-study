...
public final class FlowableOnBackpressureDrop<T> extends AbstractC0558I implements Consumer<T> {

    /* renamed from: b */
    public final Consumer f64470b;
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe((FlowableSubscriber<? super Object>) new BackpressureDropSubscriber(subscriber, this.f64470b));
    }

    public FlowableOnBackpressureDrop(Flowable<T> flowable, Consumer<? super T> consumer) {
        super(flowable);
        this.f64470b = consumer;
    }
}