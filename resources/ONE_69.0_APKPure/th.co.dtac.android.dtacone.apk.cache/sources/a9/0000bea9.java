...
class setMaxLines implements setFontFeatureSettings, Runnable {
    ...
    private final InterfaceC9641ns ThreeDS2ServiceInstance = C9642nt.ThreeDS2ServiceInstance(setMaxLines.class);
    ...
    public void ThreeDS2ServiceInstance() {
        InterfaceC9641ns interfaceC9641ns;
        Object obj;
        ...
        if (this.get.valueOf()) {
            ...
            getSDKVersion = i % 128;
            if (i % 2 == 0) {
                interfaceC9641ns = this.ThreeDS2ServiceInstance;
            ...
            interfaceC9641ns.valueOf(((String) obj).intern());
            return;
        }
