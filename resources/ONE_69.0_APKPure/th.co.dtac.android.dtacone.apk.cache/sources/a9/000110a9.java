...
public final class OneRegisterOwnerRequest implements Parcelable {
    ...
    public static /* synthetic */ OneRegisterOwnerRequest copy$default(OneRegisterOwnerRequest oneRegisterOwnerRequest, String str, String str2, String str3, String str4, String str5, String str6, int i, Object obj) {
        if ((i & 1) != 0) {
            str = oneRegisterOwnerRequest.f82174a;
        }
        if ((i & 2) != 0) {
            str2 = oneRegisterOwnerRequest.f82175b;
        }
        String str7 = str2;
        if ((i & 4) != 0) {
            str3 = oneRegisterOwnerRequest.f82176c;
        }
        String str8 = str3;
        if ((i & 8) != 0) {
            str4 = oneRegisterOwnerRequest.f82177d;
        }
        String str9 = str4;
        if ((i & 16) != 0) {
            str5 = oneRegisterOwnerRequest.f82178e;
        }
        String str10 = str5;
        if ((i & 32) != 0) {
            str6 = oneRegisterOwnerRequest.f82179f;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof OneRegisterOwnerRequest) {
            ...
            return Intrinsics.areEqual(this.f82174a, oneRegisterOwnerRequest.f82174a) && Intrinsics.areEqual(this.f82175b, oneRegisterOwnerRequest.f82175b) && Intrinsics.areEqual(this.f82176c, oneRegisterOwnerRequest.f82176c) && Intrinsics.areEqual(this.f82177d, oneRegisterOwnerRequest.f82177d) && Intrinsics.areEqual(this.f82178e, oneRegisterOwnerRequest.f82178e) && Intrinsics.areEqual(this.f82179f, oneRegisterOwnerRequest.f82179f);
        }
        return false;
    }
    ...
    public int hashCode() {
        String str = this.f82174a;
        int hashCode = (str == null ? 0 : str.hashCode()) * 31;
        String str2 = this.f82175b;
        int hashCode2 = (hashCode + (str2 == null ? 0 : str2.hashCode())) * 31;
        String str3 = this.f82176c;
        int hashCode3 = (hashCode2 + (str3 == null ? 0 : str3.hashCode())) * 31;
        String str4 = this.f82177d;
        int hashCode4 = (hashCode3 + (str4 == null ? 0 : str4.hashCode())) * 31;
        String str5 = this.f82178e;
        int hashCode5 = (hashCode4 + (str5 == null ? 0 : str5.hashCode())) * 31;
        String str6 = this.f82179f;
    ...
    public void writeToParcel(@NotNull Parcel out, int i) {
        ...
        out.writeString(this.f82177d);
        out.writeString(this.f82178e);
