...
public abstract class CommonNavigatorAdapter {
    ...
    /* renamed from: a */
    public final DataSetObservable f72445a = new DataSetObservable();
    ...
    public final void notifyDataSetChanged() {
        this.f72445a.notifyChanged();
    }

    public final void notifyDataSetInvalidated() {
        this.f72445a.notifyInvalidated();
    }

    public final void registerDataSetObserver(DataSetObserver dataSetObserver) {
        this.f72445a.registerObserver(dataSetObserver);
    }

    public final void unregisterDataSetObserver(DataSetObserver dataSetObserver) {
        this.f72445a.unregisterObserver(dataSetObserver);
    }
}