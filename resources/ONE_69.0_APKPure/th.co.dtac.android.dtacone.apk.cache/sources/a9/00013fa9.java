...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.staff.viewmodel.OneStaffViewModel$updateStaffDetailName$3 */
/* loaded from: classes10.dex */
public final class OneStaffViewModel$updateStaffDetailName$3 extends Lambda implements Function1<OneCommonResponse, Unit> {
    final /* synthetic */ OneStaffViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneStaffViewModel$updateStaffDetailName$3(OneStaffViewModel oneStaffViewModel) {
        super(1);
    ...
    public final void invoke2(OneCommonResponse oneCommonResponse) {
        MutableLiveData m9888I;
        MutableLiveData m9888I2;
        this.this$0.getLiveDataState().setValue(StatusResource.DISMISS);
        Data data = oneCommonResponse.getData();
        if (Intrinsics.areEqual(data != null ? data.getStatus() : null, Status.getSUCCESS())) {
            m9888I2 = this.this$0.m9888I();
            m9888I2.setValue(Resource.Companion.success(oneCommonResponse.getData().getStatus()));
            return;
        }
        m9888I = this.this$0.m9888I();
        m9888I.setValue(Resource.Companion.error("", null, null));
    }
}