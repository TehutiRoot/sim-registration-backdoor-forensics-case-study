...
@Metadata(m29143d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00030\u0002H\n¢\u0006\u0002\b\u0004"}, m29142d2 = {"<anonymous>", "Landroidx/compose/animation/ExitTransition;", "Landroidx/compose/animation/AnimatedContentTransitionScope;", "Landroidx/navigation/NavBackStackEntry;", "invoke"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
...
public final class NavHostKt$NavHost$finalExit$1$1 extends Lambda implements Function1<AnimatedContentTransitionScope<NavBackStackEntry>, ExitTransition> {
    ...
    public final ExitTransition invoke(@NotNull AnimatedContentTransitionScope<NavBackStackEntry> animatedContentTransitionScope) {
        ExitTransition m53770d;
        ExitTransition m53768f;
        ...
        if (this.$composeNavigator.isPop$navigation_compose_release().getValue().booleanValue()) {
            ...
            while (true) {
                ...
                m53768f = NavHostKt.m53768f(it.next(), animatedContentTransitionScope);
                if (m53768f != null) {
                    exitTransition = m53768f;
                    break;
                }
        ...
        while (true) {
            ...
            m53770d = NavHostKt.m53770d(it2.next(), animatedContentTransitionScope);
            if (m53770d != null) {
                exitTransition = m53770d;
                break;
            }
