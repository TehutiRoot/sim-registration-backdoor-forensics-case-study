...
public class NotificationParams {
    ...
    /* renamed from: a */
    public final Bundle f55649a;

    public NotificationParams(@NonNull Bundle bundle) {
        if (bundle != null) {
            this.f55649a = new Bundle(bundle);
            return;
        }
    ...
    /* renamed from: a */
    public static int m38455a(String str) {
    ...
    /* renamed from: f */
    public static boolean m38450f(String str) {
    ...
    /* renamed from: g */
    public static boolean m38449g(String str) {
    ...
    /* renamed from: h */
    public static String m38448h(String str) {
    ...
    /* renamed from: j */
    public static String m38446j(String str) {
        if (str.startsWith(Constants.MessageNotificationKeys.NOTIFICATION_PREFIX)) {
    ...
    public int[] m38454b() {
        ...
        try {
            if (jSONArray.length() == 3) {
                iArr[0] = m38455a(jSONArray.optString(0));
    ...
    public Integer getInteger(String str) {
        ...
        if (!TextUtils.isEmpty(string)) {
            try {
                ...
                Log.w("NotificationParams", "Couldn't parse value of " + m38446j(str) + "(" + string + ") into an int");
                return null;
            }
        }
        return null;
    ...
    public JSONArray getJSONArray(String str) {
        ...
        if (!TextUtils.isEmpty(string)) {
            try {
                ...
                Log.w("NotificationParams", "Malformed JSON for key " + m38446j(str) + ": " + string + ", falling back to default");
                return null;
            }
        }
        return null;
    ...
    public String getLocalizedString(Resources resources, String str, String str2) {
        ...
        if (identifier == 0) {
            Log.w("NotificationParams", m38446j(str2 + Constants.MessageNotificationKeys.TEXT_RESOURCE_SUFFIX) + " resource not found: " + str2 + " Default value will be used.");
            return null;
        }
        ...
        try {
            ...
            Log.w("NotificationParams", "Missing format argument for " + m38446j(str2) + ": " + Arrays.toString(localizationArgsForKey) + " Default value will be used.", e);
            return null;
        }
    }
    ...
    public Long getLong(String str) {
        ...
        if (!TextUtils.isEmpty(string)) {
            try {
                ...
                Log.w("NotificationParams", "Couldn't parse value of " + m38446j(str) + "(" + string + ") into a long");
                return null;
            }
        }
        return null;
    ...
    public String getString(String str) {
        return this.f55649a.getString(m38447i(str));
    }
    ...
    /* renamed from: i */
    public final String m38447i(String str) {
        if (!this.f55649a.containsKey(str) && str.startsWith(Constants.MessageNotificationKeys.NOTIFICATION_PREFIX)) {
            String m38448h = m38448h(str);
            if (this.f55649a.containsKey(m38448h)) {
                return m38448h;
            }
        }
        return str;
    ...
    public Bundle paramsForAnalyticsIntent() {
        Bundle bundle = new Bundle(this.f55649a);
        for (String str : this.f55649a.keySet()) {
            if (!m38450f(str)) {
                bundle.remove(str);
            }
        }
    ...
    public static boolean isNotification(Bundle bundle) {
        return "1".equals(bundle.getString(Constants.MessageNotificationKeys.ENABLE_NOTIFICATION)) || "1".equals(bundle.getString(m38448h(Constants.MessageNotificationKeys.ENABLE_NOTIFICATION)));
    }
}