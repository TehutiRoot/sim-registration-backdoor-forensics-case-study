...
public final class UTF8Writer extends Writer {
    ...
    /* renamed from: a */
    public final IOContext f43147a;

    /* renamed from: b */
    public OutputStream f43148b;
    ...
    public UTF8Writer(IOContext iOContext, OutputStream outputStream) {
        this.f43147a = iOContext;
        this.f43148b = outputStream;
        byte[] allocWriteEncodingBuffer = iOContext.allocWriteEncodingBuffer();
        this.f43149c = allocWriteEncodingBuffer;
        this.f43150d = allocWriteEncodingBuffer.length - 4;
        this.f43151e = 0;
    }
    ...
    public void close() throws IOException {
        OutputStream outputStream = this.f43148b;
        if (outputStream != null) {
            int i = this.f43151e;
            if (i > 0) {
                outputStream.write(this.f43149c, 0, i);
                this.f43151e = 0;
            }
            OutputStream outputStream2 = this.f43148b;
            this.f43148b = null;
            byte[] bArr = this.f43149c;
            if (bArr != null) {
                this.f43149c = null;
                this.f43147a.releaseWriteEncodingBuffer(bArr);
            }
            outputStream2.close();
            int i2 = this.f43152f;
            this.f43152f = 0;
    ...
    */
    ...
    public void write(int i) throws IOException {
        ...
        int i3 = this.f43151e;
        if (i3 >= this.f43150d) {
            this.f43148b.write(this.f43149c, 0, i3);
            this.f43151e = 0;
        }
        if (i < 128) {
            byte[] bArr = this.f43149c;
        ...
        if (i < 2048) {
            ...
            byte[] bArr4 = this.f43149c;
            bArr4[i5] = (byte) ((i >> 18) | C6139DK.ERROR_RECEIVE_LRC);
