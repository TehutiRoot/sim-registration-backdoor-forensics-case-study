...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.viewModel.OneMnpViewModel$validateSim$3 */
/* loaded from: classes10.dex */
public final class OneMnpViewModel$validateSim$3 extends Lambda implements Function1<OneValidateSimTrueResponse, Unit> {
    final /* synthetic */ OneMnpViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneMnpViewModel$validateSim$3(OneMnpViewModel oneMnpViewModel) {
        super(1);
    ...
    public final void invoke2(OneValidateSimTrueResponse oneValidateSimTrueResponse) {
        ...
        this.this$0.f92069P0 = 0;
        this.this$0.setValidateSimTrueResponse(oneValidateSimTrueResponse);
        m13537M1 = this.this$0.m13537M1();
        m13537M1.setValue(Resource.Companion.success(oneValidateSimTrueResponse));
    }
}