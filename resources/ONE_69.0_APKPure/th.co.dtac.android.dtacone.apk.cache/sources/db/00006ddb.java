...
public final class FieldMask extends GeneratedMessageLite<FieldMask, Builder> implements FieldMaskOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<FieldMask, Builder> implements FieldMaskOrBuilder {
        public /* synthetic */ Builder(C4349a c4349a) {
            this();
        }

        public Builder addAllPaths(Iterable<String> iterable) {
            copyOnWrite();
            ((FieldMask) this.instance).m55765w(iterable);
            return this;
        }

        public Builder addPaths(String str) {
            copyOnWrite();
            ((FieldMask) this.instance).m55764x(str);
            return this;
        }

        public Builder addPathsBytes(ByteString byteString) {
            copyOnWrite();
            ((FieldMask) this.instance).m55763y(byteString);
            return this;
        }

        public Builder clearPaths() {
            copyOnWrite();
            ((FieldMask) this.instance).m55762z();
            return this;
        }
        ...
        public Builder setPaths(int i, String str) {
            copyOnWrite();
            ((FieldMask) this.instance).m55772B(i, str);
            return this;
        }
    ...
    /* loaded from: classes2.dex */
    public static /* synthetic */ class C4349a {
        ...
        static {
            ...
            try {
                f34876a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f34876a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f34876a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f34876a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f34876a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f34876a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: B */
    public final void m55772B(int i, String str) {
        str.getClass();
        m55773A();
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C4349a.f34876a[methodToInvoke.ordinal()]) {
            case 1:
    ...
    /* renamed from: w */
    public final void m55765w(Iterable iterable) {
        m55773A();
        AbstractMessageLite.addAll(iterable, (List) this.paths_);
    }

    /* renamed from: x */
    public final void m55764x(String str) {
        str.getClass();
        m55773A();
        this.paths_.add(str);
    }
    ...
    /* renamed from: y */
    public final void m55763y(ByteString byteString) {
        byteString.getClass();
