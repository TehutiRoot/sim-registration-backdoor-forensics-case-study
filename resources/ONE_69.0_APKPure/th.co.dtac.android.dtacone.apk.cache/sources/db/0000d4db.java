...
public class RealmAny {
    ...
    /* renamed from: a */
    public final RealmAnyOperator f66601a;
    ...
    public RealmAny(RealmAnyOperator realmAnyOperator) {
        this.f66601a = realmAnyOperator;
    }

    /* renamed from: c */
    public static RealmAny m30046c(Object obj) {
        if (obj == null) {
            return nullValue();
        }
    ...
    public static RealmAny nullValue() {
        return new RealmAny(new C11408o());
    }

    public static RealmAny valueOf(@Nullable Byte b) {
        return new RealmAny(b == null ? new C11408o() : new C11400j(b));
    }

    /* renamed from: a */
    public void m30048a(BaseRealm baseRealm) {
        this.f66601a.checkValidObject(baseRealm);
    }

    public byte[] asBinary() {
        return (byte[]) this.f66601a.mo29662g(byte[].class);
    }

    public Boolean asBoolean() {
        return (Boolean) this.f66601a.mo29662g(Boolean.class);
    }

    public Byte asByte() {
        Number number = (Number) this.f66601a.mo29662g(Number.class);
        if (number == null) {
            return null;
        }
    ...
    public Date asDate() {
        return (Date) this.f66601a.mo29662g(Date.class);
    }

    public Decimal128 asDecimal128() {
        return (Decimal128) this.f66601a.mo29662g(Decimal128.class);
    }

    public Double asDouble() {
        return (Double) this.f66601a.mo29662g(Double.class);
    }

    public Float asFloat() {
        return (Float) this.f66601a.mo29662g(Float.class);
    }
    ...
    public ObjectId asObjectId() {
        return (ObjectId) this.f66601a.mo29662g(ObjectId.class);
    }

    public <T extends RealmModel> T asRealmModel(Class<T> cls) {
        return (T) this.f66601a.mo29662g(cls);
    }
    ...
    public String asString() {
        return (String) this.f66601a.mo29662g(String.class);
    }

    public UUID asUUID() {
        return (UUID) this.f66601a.mo29662g(UUID.class);
    }

    /* renamed from: b */
    public final long m30047b() {
        return this.f66601a.m30043c();
    }
    ...
    public final boolean coercedEquals(@Nullable RealmAny realmAny) {
        ...
        return this.f66601a.m30045a(realmAny.f66601a);
    }
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        return this.f66601a.equals(((RealmAny) obj).f66601a);
    }

    public Type getType() {
        return this.f66601a.m30041e();
    }

    @Nullable
    public Class<?> getValueClass() {
        return this.f66601a.mo29663f();
    }
    ...
    public String toString() {
        return this.f66601a.toString();
    }

    public static RealmAny valueOf(@Nullable Short sh) {
        return new RealmAny(sh == null ? new C11408o() : new C11400j(sh));
    }

    public static RealmAny valueOf(@Nullable Integer num) {
        return new RealmAny(num == null ? new C11408o() : new C11400j(num));
    }

    public static RealmAny valueOf(@Nullable Long l) {
        return new RealmAny(l == null ? new C11408o() : new C11400j(l));
    }

    public static RealmAny valueOf(@Nullable Boolean bool) {
        return new RealmAny(bool == null ? new C11408o() : new C11276b(bool));
    }

    public static RealmAny valueOf(@Nullable Float f) {
        return new RealmAny(f == null ? new C11408o() : new C11281g(f));
    }

    public static RealmAny valueOf(@Nullable Double d) {
        return new RealmAny(d == null ? new C11408o() : new C11280f(d));
    }

    public static RealmAny valueOf(@Nullable String str) {
        return new RealmAny(str == null ? new C11408o() : new C11476x(str));
    }

    public static RealmAny valueOf(@Nullable byte[] bArr) {
        return new RealmAny(bArr == null ? new C11408o() : new C11275a(bArr));
    }

    public static RealmAny valueOf(@Nullable Date date) {
        return new RealmAny(date == null ? new C11408o() : new C11278d(date));
    }

    public static RealmAny valueOf(@Nullable ObjectId objectId) {
        return new RealmAny(objectId == null ? new C11408o() : new C11409p(objectId));
    }

    public static RealmAny valueOf(@Nullable Decimal128 decimal128) {
        return new RealmAny(decimal128 == null ? new C11408o() : new C11279e(decimal128));
    }

    public static RealmAny valueOf(@Nullable UUID uuid) {
        return new RealmAny(uuid == null ? new C11408o() : new C11477y(uuid));
    }

    public static RealmAny valueOf(@Nullable RealmModel realmModel) {
        return new RealmAny(realmModel == null ? new C11408o() : new C11473u(realmModel));
    }
}