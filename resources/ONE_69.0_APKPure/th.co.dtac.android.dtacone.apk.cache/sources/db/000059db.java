...
public final class NavigationRailKt$NavigationRailItem$2$indicator$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        m60551a = NavigationRailKt.m60551a(this.$animationProgress$delegate);
        BoxKt.Box(BackgroundKt.m69504backgroundbw27NRU(layoutId, Color.m71918copywmQWz5c$default(indicatorColor, m60551a, 0.0f, 0.0f, 0.0f, 14, null), this.$indicatorShape), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
