...
public class StatusPrinter {
    ...
    /* renamed from: a */
    public static PrintStream f40182a = System.out;

    /* renamed from: b */
    public static CachingDateFormatter f40183b = new CachingDateFormatter("HH:mm:ss,SSS");

    /* renamed from: a */
    public static void m51310a(StringBuilder sb, Throwable th2) {
        String[] convert;
    ...
    /* renamed from: b */
    public static void m51309b(StringBuilder sb, List list) {
        if (list == null) {
            return;
        }
    ...
    public static void buildStr(StringBuilder sb, String str, Status status) {
        ...
        CachingDateFormatter cachingDateFormatter = f40183b;
        ...
        if (status.getThrowable() != null) {
            m51310a(sb, status.getThrowable());
        }
        if (status.hasChildren()) {
    ...
    public static void printIfErrorsOccured(Context context) {
        ...
        PrintStream printStream = f40182a;
    ...
    public static void print(StatusManager statusManager, long j) {
        ...
        m51309b(sb, StatusUtil.filterStatusListByTimeThreshold(statusManager.getCopyOfStatusList(), j));
        f40182a.println(sb.toString());
    }
