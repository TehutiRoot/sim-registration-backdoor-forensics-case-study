...
/* renamed from: th.co.dtac.android.dtacone.view.fragment.customerenquiry.InfoAnalyticFragment$createOfferUpsellPackageAdapter$1 */
/* loaded from: classes9.dex */
public final class InfoAnalyticFragment$createOfferUpsellPackageAdapter$1 extends Lambda implements Function1<OffersPackage, Unit> {
    final /* synthetic */ List<Offer> $list;
    final /* synthetic */ InfoAnalyticFragment this$0;

    @Metadata(m29143d1 = {"\u0000\b\n\u0000\n\u0002\u0010\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001H\n¢\u0006\u0002\b\u0002"}, m29142d2 = {"<anonymous>", "", "invoke"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.fragment.customerenquiry.InfoAnalyticFragment$createOfferUpsellPackageAdapter$1$1 */
    /* loaded from: classes9.dex */
    public static final class C159281 extends Lambda implements Function0<Unit> {
        final /* synthetic */ List<Offer> $list;
        final /* synthetic */ OffersPackage $packageGroup;
        final /* synthetic */ InfoAnalyticFragment this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C159281(List<Offer> list, OffersPackage offersPackage, InfoAnalyticFragment infoAnalyticFragment) {
            super(0);
            this.$list = list;
        ...
        public final void invoke2() {
            ...
            infoAnalyticViewModel = this.this$0.f99356n;
            ...
            infoAnalyticViewModel.onSelectPrepaidUpsellPackage(offer);
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InfoAnalyticFragment$createOfferUpsellPackageAdapter$1(InfoAnalyticFragment infoAnalyticFragment, List<Offer> list) {
        super(1);
        this.this$0 = infoAnalyticFragment;
        this.$list = list;
    }
    ...
    public final void invoke2(@NotNull OffersPackage packageGroup) {
        ...
        if ((packageGroup.getPackageCode().length() == 0) & (packageGroup.getPackageGroupCode().length() == 0)) {
            this.this$0.navigateToShelf(new ShelfPackageViewFragment(), ShelfPackageViewFragment.TAG);
            return;
        }
        ...
        if (activity != null) {
            ...
            Dialog createConfirmDialogHtmlText = ActivityExtKt.createConfirmDialogHtmlText(activity, string, StringExtKt.formatMessageWithSubscriberAndPackage(string2, subscriberNumberDisplay, marketingDescriptionThai), new C159281(this.$list, packageGroup, this.this$0));
