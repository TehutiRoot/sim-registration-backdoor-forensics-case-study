...
@Metadata(m29143d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00010\u0002H\u008a@"}, m29142d2 = {"<anonymous>", "", "Lkotlinx/coroutines/channels/ProducerScope;"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
@DebugMetadata(m29093c = "kotlinx.coroutines.channels.TickerChannelsKt$ticker$3", m29092f = "TickerChannels.kt", m29091i = {}, m29090l = {72, 73}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
        ...
        if (i != 0) {
            ...
            if (i2 != 1) {
                if (i2 == 2) {
                    ...
                    this.label = 2;
                    m27419a = TickerChannelsKt.m27419a(j, j2, channel, this);
                    if (m27419a == coroutine_suspended) {
                ...
                this.label = 1;
                m27418b = TickerChannelsKt.m27418b(j3, j4, channel2, this);
                if (m27418b == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
        }
