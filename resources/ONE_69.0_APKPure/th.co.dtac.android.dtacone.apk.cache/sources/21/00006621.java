...
public final class AnimatedContentComposeAnimation<T> implements ComposeAnimation, TransitionBasedAnimation<T> {
    ...
    /* renamed from: e */
    public static boolean f31725e;

    /* renamed from: a */
    public final Transition f31726a;

    /* renamed from: b */
    public final Set f31727b;

    /* renamed from: c */
    public final String f31728c;

    /* renamed from: d */
    public final ComposeAnimationType f31729d;

    @Metadata(m29143d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u0004J\u0014\u0010\u000b\u001a\b\u0012\u0002\b\u0003\u0018\u00010\f*\u0006\u0012\u0002\b\u00030\rR\u001e\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0004@BX\u0086\u000e¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\u000e"}, m29142d2 = {"Landroidx/compose/ui/tooling/animation/AnimatedContentComposeAnimation$Companion;", "", "()V", "<set-?>", "", "apiAvailable", "getApiAvailable", "()Z", "testOverrideAvailability", "", "override", "parseAnimatedContent", "Landroidx/compose/ui/tooling/animation/AnimatedContentComposeAnimation;", "Landroidx/compose/animation/core/Transition;", "ui-tooling_release"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    ...
    public static final class Companion {
        ...
        public final boolean getApiAvailable() {
            return AnimatedContentComposeAnimation.f31725e;
        }
        ...
        */
        public final androidx.compose.p003ui.tooling.animation.AnimatedContentComposeAnimation<?> parseAnimatedContent(@org.jetbrains.annotations.NotNull androidx.compose.animation.core.Transition<?> r6) {
            ...
            Ld:
                ...
                if (r2 != 0) goto L2c
            L28:
                java.util.Set r2 = p000.AbstractC23354zH1.setOf(r0)
            L2c:
        ...
        public final void testOverrideAvailability(boolean z) {
            AnimatedContentComposeAnimation.f31725e = z;
        }
    ...
    public AnimatedContentComposeAnimation(Transition transition, Set set, String str) {
        this.f31726a = transition;
        this.f31727b = set;
        this.f31728c = str;
        this.f31729d = ComposeAnimationType.ANIMATED_CONTENT;
    }
