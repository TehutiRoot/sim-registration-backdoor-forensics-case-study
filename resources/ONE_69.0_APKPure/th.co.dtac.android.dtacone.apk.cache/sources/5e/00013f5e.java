...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.staff.fragment.OneStaffPermissionFragment$setUpViewModel$1$1 */
/* loaded from: classes10.dex */
public final class OneStaffPermissionFragment$setUpViewModel$1$1 extends Lambda implements Function1<Resource<? extends OneStaffDetailResponse>, Unit> {
    final /* synthetic */ OneStaffPermissionFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneStaffPermissionFragment$setUpViewModel$1$1(OneStaffPermissionFragment oneStaffPermissionFragment) {
        super(1);
    ...
    public final void invoke2(Resource<OneStaffDetailResponse> resource) {
        ...
        if (resource != null) {
            ...
            oneStaffPermissionFragment.m9900r(data2);
            oneStaffPermissionFragment.m9899s(data2);
        }
    }
}