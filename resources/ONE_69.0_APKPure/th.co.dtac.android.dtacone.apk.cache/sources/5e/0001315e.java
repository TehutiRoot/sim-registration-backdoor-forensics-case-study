...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.home.viewModel.OneHomeViewModel$acceptBuyDOLConsent$3 */
/* loaded from: classes10.dex */
public final class OneHomeViewModel$acceptBuyDOLConsent$3 extends Lambda implements Function1<OnePrepaidStatusResponse, Unit> {
    final /* synthetic */ String $feature;
    final /* synthetic */ OneHomeViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneHomeViewModel$acceptBuyDOLConsent$3(OneHomeViewModel oneHomeViewModel, String str) {
        super(1);
    ...
    public final void invoke2(OnePrepaidStatusResponse onePrepaidStatusResponse) {
        ...
        if (Intrinsics.areEqual(onePrepaidStatusResponse.getStatus(), Status.getSUCCESS())) {
            ...
            m14075G.setValue(Resource.Companion.success(this.$feature));
            return;
        }
