...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.registration.activity.OneRegistrationActivity$initViewModelLogin$8 */
/* loaded from: classes10.dex */
public final class OneRegistrationActivity$initViewModelLogin$8 extends Lambda implements Function1<Resource<? extends String>, Unit> {
    final /* synthetic */ OneRegistrationActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneRegistrationActivity$initViewModelLogin$8(OneRegistrationActivity oneRegistrationActivity) {
        super(1);
    ...
    public final void invoke2(Resource<String> resource) {
        ...
        if (data != null) {
            ...
            errorCollection.setDescription(data);
            oneRegistrationActivity.m10453f0(errorCollection);
        }
    }
}