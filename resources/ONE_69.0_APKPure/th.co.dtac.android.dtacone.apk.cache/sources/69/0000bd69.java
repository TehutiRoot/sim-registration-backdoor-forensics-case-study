...
class C9675pb {
    ...
    public C9674pa values() throws IOException, C9672oz {
        char c;
        int i;
        int i2 = this.createTransaction;
        char[] cArr = this.ConfigParameters;
        ...
        while (true) {
            ...
            switch (i6) {
                case 1:
                    throw new C9672oz(this.apiKey, 0, new Character(ThreeDS2ServiceInstance(0)));
                case 2:
                    String str = get();
                    try {
                        return new C9674pa(0, Long.valueOf(str));
                    } catch (NumberFormatException unused) {
                        return new C9674pa(0, new BigInteger(str));
                    }
                case 3:
                case 25:
                case 26:
                ...
                case 4:
                    ...
                    break;
                case 5:
                    return new C9674pa(1, null);
                case 6:
                    return new C9674pa(2, null);
                case 7:
                    return new C9674pa(3, null);
                case 8:
                    return new C9674pa(4, null);
                case 9:
                    return new C9674pa(5, null);
                case 10:
                    return new C9674pa(6, null);
                case 11:
                ...
                case 13:
                    values(0);
                    return new C9674pa(0, this.SchemeConfiguration.toString());
                case 14:
                    this.SchemeConfiguration.append('\"');
                    break;
                case 15:
                ...
                case 18:
                    ...
                    break;
                case 19:
                    this.SchemeConfiguration.append(TokenParser.f74641CR);
                    break;
                case 20:
                    this.SchemeConfiguration.append('\t');
                    break;
                case 21:
                    return new C9674pa(0, Double.valueOf(get()));
                case 22:
                    return new C9674pa(0, null);
                case 23:
                    return new C9674pa(0, Boolean.valueOf(get()));
                case 24:
                    try {
                        this.SchemeConfiguration.append((char) Integer.parseInt(get().substring(2), 16));
                        break;
                    } catch (Exception e) {
                        throw new C9672oz(this.apiKey, 2, e);
                    }
                default:
