...
public final class BottomDrawerState {
    ...
    @Metadata(m29143d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J(\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00060\u00042\u0012\u0010\u0007\u001a\u000e\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\t0\bH\u0007J.\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00060\u00042\u0006\u0010\n\u001a\u00020\u000b2\u0012\u0010\u0007\u001a\u000e\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\t0\b¨\u0006\f"}, m29142d2 = {"Landroidx/compose/material/BottomDrawerState$Companion;", "", "()V", "Saver", "Landroidx/compose/runtime/saveable/Saver;", "Landroidx/compose/material/BottomDrawerState;", "Landroidx/compose/material/BottomDrawerValue;", "confirmStateChange", "Lkotlin/Function1;", "", "density", "Landroidx/compose/ui/unit/Density;", "material_release"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* loaded from: classes.dex */
    ...
    public BottomDrawerState(@NotNull BottomDrawerValue initialValue, @NotNull Function1<? super BottomDrawerValue, Boolean> confirmStateChange) {
        TweenSpec tweenSpec;
        NestedScrollConnection m60859d;
        Intrinsics.checkNotNullParameter(initialValue, "initialValue");
        Intrinsics.checkNotNullParameter(confirmStateChange, "confirmStateChange");
        tweenSpec = DrawerKt.f14551d;
        ...
        this.f14457a = anchoredDraggableState;
        m60859d = DrawerKt.m60859d(anchoredDraggableState);
        this.f14458b = m60859d;
    }
    ...
    public static /* synthetic */ Object animateTo$material_release$default(BottomDrawerState bottomDrawerState, BottomDrawerValue bottomDrawerValue, float f, Continuation continuation, int i, Object obj) {
        if ((i & 2) != 0) {
            f = bottomDrawerState.f14457a.getLastVelocity();
        }
    ...
    /* renamed from: a */
    public final boolean m60898a() {
        return this.f14457a.hasAnchorForValue(BottomDrawerValue.Open);
    }
    ...
    public final Object animateTo$material_release(@NotNull BottomDrawerValue bottomDrawerValue, float f, @NotNull Continuation<? super Unit> continuation) {
        Object animateTo = AnchoredDraggableKt.animateTo(this.f14457a, bottomDrawerValue, f, continuation);
    ...
    /* renamed from: b */
    public final Density m60897b() {
        Density density = this.f14459c;
        if (density != null) {
            return density;
        }
    ...
    public final Object close(@NotNull Continuation<? super Unit> continuation) {
        Object animateTo$default = AnchoredDraggableKt.animateTo$default(this.f14457a, BottomDrawerValue.Closed, 0.0f, continuation, 2, null);
    ...
    public final boolean confirmStateChange$material_release(@NotNull BottomDrawerValue value) {
        ...
        return ((Boolean) this.f14457a.getConfirmValueChange$material_release().invoke(value)).booleanValue();
    }

    @Nullable
    public final Object expand(@NotNull Continuation<? super Unit> continuation) {
        Object animateTo$default = AnchoredDraggableKt.animateTo$default(this.f14457a, BottomDrawerValue.Expanded, 0.0f, continuation, 2, null);
        if (animateTo$default == AbstractC19782eg0.getCOROUTINE_SUSPENDED()) {
            return animateTo$default;
        }
        return Unit.INSTANCE;
    ...
    public final BottomDrawerValue getCurrentValue() {
        return (BottomDrawerValue) this.f14457a.getCurrentValue();
    }
    ...
    public final float getLastVelocity$material_release() {
        return this.f14457a.getLastVelocity();
    }
    ...
    public final float getOffset() {
        return this.f14457a.getOffset();
    }

    public final float getProgress() {
        return this.f14457a.getProgress();
    }

    @NotNull
    public final BottomDrawerValue getTargetValue() {
        return (BottomDrawerValue) this.f14457a.getTargetValue();
    }

    public final boolean isAnimationRunning$material_release() {
        return this.f14457a.isAnimationRunning();
    }

    public final boolean isClosed() {
        if (this.f14457a.getCurrentValue() == BottomDrawerValue.Closed) {
            return true;
        }
        return false;
    }
    ...
    public final boolean isExpanded() {
        if (this.f14457a.getCurrentValue() == BottomDrawerValue.Expanded) {
            return true;
        }
        return false;
    }
    ...
    public final Object open(@NotNull Continuation<? super Unit> continuation) {
        ...
        Object animateTo$default = AnchoredDraggableKt.animateTo$default(this.f14457a, bottomDrawerValue, 0.0f, continuation, 2, null);
        if (animateTo$default == AbstractC19782eg0.getCOROUTINE_SUSPENDED()) {
            return animateTo$default;
        }
        return Unit.INSTANCE;
    ...
    public final Object snapTo$material_release(@NotNull BottomDrawerValue bottomDrawerValue, @NotNull Continuation<? super Unit> continuation) {
        Object snapTo = AnchoredDraggableKt.snapTo(this.f14457a, bottomDrawerValue, continuation);
    ...
    public final boolean trySnapTo$material_release(@NotNull BottomDrawerValue target) {
        ...
        return this.f14457a.trySnapTo$material_release(target);
    }
    ...
    public /* synthetic */ BottomDrawerState(BottomDrawerValue bottomDrawerValue, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(bottomDrawerValue, (i & 2) != 0 ? C30571.INSTANCE : function1);
    }
}