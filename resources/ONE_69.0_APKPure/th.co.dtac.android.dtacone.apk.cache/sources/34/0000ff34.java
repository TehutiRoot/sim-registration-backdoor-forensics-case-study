...
public abstract class Nat128 {
    ...
    /* renamed from: M */
    private static final long f75541M = 4294967295L;
    ...
    /* renamed from: eq */
    public static boolean m24621eq(int[] iArr, int[] iArr2) {
        for (int i = 3; i >= 0; i--) {
            if (iArr[i] != iArr2[i]) {
                return false;
            }
    ...
    public static void mul(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        while (i5 < 4) {
            int i6 = i4 + 1;
            long j10 = iArr[i + i5] & 4294967295L;
            long j11 = j;
            long j12 = (j10 * j) + (iArr3[i6] & 4294967295L);
            iArr3[i6] = (int) j12;
            int i7 = i4 + 2;
            long j13 = (j12 >>> c) + (j10 * j2) + (iArr3[i7] & 4294967295L);
            iArr3[i7] = (int) j13;
            int i8 = i4 + 3;
            long j14 = (j13 >>> 32) + (j10 * j3) + (iArr3[i8] & 4294967295L);
            iArr3[i8] = (int) j14;
            int i9 = i4 + 4;
            long j15 = (j14 >>> 32) + (j10 * j4) + (iArr3[i9] & 4294967295L);
            iArr3[i9] = (int) j15;
