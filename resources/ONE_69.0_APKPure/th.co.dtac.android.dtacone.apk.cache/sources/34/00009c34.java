...
public class ActivityTransitionResult extends AbstractSafeParcelable {
    ...
    /* renamed from: b */
    public Bundle f47725b;

    public ActivityTransitionResult(@NonNull @SafeParcelable.Param(m48385id = 1) List<ActivityTransitionEvent> list) {
        this.f47725b = null;
        ...
        this.f47724a = Collections.unmodifiableList(list);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            return this.f47724a.equals(((ActivityTransitionResult) obj).f47724a);
        }
        return false;
    }
    ...
    public void writeToParcel(@NonNull Parcel parcel, int i) {
        ...
        SafeParcelWriter.writeBundle(parcel, 2, this.f47725b, false);
        SafeParcelWriter.finishObjectHeader(parcel, beginObjectHeader);
    }

    @ShowFirstParty
    @SafeParcelable.Constructor
    public ActivityTransitionResult(@NonNull @SafeParcelable.Param(m48385id = 1) List list, @Nullable @SafeParcelable.Param(m48385id = 2) Bundle bundle) {
        this(list);
        this.f47725b = bundle;
    }
}