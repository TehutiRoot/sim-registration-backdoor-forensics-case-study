...
import th.p047co.dtac.android.dtacone.presenter.password.VerifyPasswordPresenter;
...
/* renamed from: th.co.dtac.android.dtacone.presenter.password.VerifyPasswordPresenter$verifyPasswordUpdatePrepaid$2 */
/* loaded from: classes8.dex */
public final class VerifyPasswordPresenter$verifyPasswordUpdatePrepaid$2 extends Lambda implements Function1<StatusResponse, Unit> {
    final /* synthetic */ String $laserId;
    final /* synthetic */ VerifyPasswordPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public VerifyPasswordPresenter$verifyPasswordUpdatePrepaid$2(VerifyPasswordPresenter verifyPasswordPresenter, String str) {
        super(1);
    ...
    public final void invoke2(StatusResponse statusResponse) {
        VerifyPasswordPresenter.View view;
        if (Intrinsics.areEqual(statusResponse.getStatus(), Status.getSUCCESS())) {
            view = this.this$0.f86105e;
            if (view == null) {
                Intrinsics.throwUninitializedPropertyAccessException(Promotion.ACTION_VIEW);
                view = null;
            }
            view.onPasswordCorrect(this.$laserId);
            return;
        }
