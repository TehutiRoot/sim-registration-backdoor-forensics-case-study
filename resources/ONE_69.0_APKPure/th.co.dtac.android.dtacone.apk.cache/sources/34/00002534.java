...
public final class C2820x29bde906 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public C2820x29bde906(AlignmentLine alignmentLine, float f, float f2) {
        super(1);
    ...
    public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("before", C3623Dp.m73840boximpl(this.$before$inlined));
        inspectorInfo.getProperties().set("after", C3623Dp.m73840boximpl(this.$after$inlined));
    }
}