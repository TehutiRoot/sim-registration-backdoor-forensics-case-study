...
public final class FaceDetectorFactory implements FaceDetector {
    ...
    /* renamed from: a */
    public FirebaseVisionFaceDetector f84877a;

    /* renamed from: a */
    public final FirebaseVisionFaceDetectorOptions m19618a() {
    ...
    public void close() {
        FirebaseVisionFaceDetector firebaseVisionFaceDetector = this.f84877a;
    ...
    public void detectInImage(@NotNull Bitmap image, @NotNull Function1<? super Bitmap, Unit> onSuccess, @NotNull Function2<? super Err, ? super Bitmap, Unit> onFail) {
        ...
        Single observeOn = Single.just(image).observeOn(Schedulers.m30138io());
    ...
    @Override // th.p047co.dtac.android.dtacone.facedector.FaceDetector
    public void init() {
        FirebaseVisionFaceDetector visionFaceDetector = FirebaseVision.getInstance().getVisionFaceDetector(m19618a());
        Intrinsics.checkNotNullExpressionValue(visionFaceDetector, "getInstance()\n          …ildFaceDetectionOption())");
        this.f84877a = visionFaceDetector;
    }
}