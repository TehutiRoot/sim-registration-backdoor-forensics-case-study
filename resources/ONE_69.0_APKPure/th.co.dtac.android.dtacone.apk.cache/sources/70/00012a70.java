...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.buyDol.viewModel.OneBuyDolViewModel$charge$1 */
/* loaded from: classes10.dex */
public final class OneBuyDolViewModel$charge$1 extends Lambda implements Function1<Disposable, Unit> {
    final /* synthetic */ OneBuyDolViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneBuyDolViewModel$charge$1(OneBuyDolViewModel oneBuyDolViewModel) {
        super(1);
    ...
    public final void invoke2(Disposable disposable) {
        ...
        m15891V.setValue(Resource.Companion.loading(null));
    }
}