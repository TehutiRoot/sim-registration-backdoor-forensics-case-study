...
final class IntermediateLayoutElement extends ModifierNodeElement<IntermediateLayoutModifierNode> {
    ...
    public void update(IntermediateLayoutModifierNode node) {
        ...
        node.setMeasureBlock$ui_release(this.f30150b);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof IntermediateLayoutElement) && Intrinsics.areEqual(this.f30150b, ((IntermediateLayoutElement) obj).f30150b);
    }
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("measure", this.f30150b);
    }

    public String toString() {
        return "IntermediateLayoutElement(measure=" + this.f30150b + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
}