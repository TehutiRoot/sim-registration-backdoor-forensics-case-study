...
public final class Struct extends GeneratedMessageLite<Struct, Builder> implements StructOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Struct, Builder> implements StructOrBuilder {
        public /* synthetic */ Builder(C4381a c4381a) {
            this();
        }

        public Builder clearFields() {
            copyOnWrite();
            ((Struct) this.instance).m55511s().clear();
            return this;
        }
        ...
        public Builder putAllFields(Map<String, Value> map) {
            copyOnWrite();
            ((Struct) this.instance).m55511s().putAll(map);
            return this;
        }
        ...
        public Builder putFields(String str, Value value) {
            ...
            value.getClass();
            copyOnWrite();
            ((Struct) this.instance).m55511s().put(str, value);
            return this;
        }
        ...
        public Builder removeFields(String str) {
            str.getClass();
            copyOnWrite();
            ((Struct) this.instance).m55511s().remove(str);
            return this;
        }
    ...
    /* loaded from: classes2.dex */
    public static /* synthetic */ class C4381a {
    ...
    /* loaded from: classes2.dex */
    public static final class C4382b {

        /* renamed from: a */
        public static final MapEntryLite f34961a = MapEntryLite.newDefaultInstance(WireFormat.FieldType.STRING, "", WireFormat.FieldType.MESSAGE, Value.getDefaultInstance());
    }
    ...
    public boolean containsFields(String str) {
        str.getClass();
        return m55510t().containsKey(str);
    }

    @Override // androidx.datastore.preferences.protobuf.GeneratedMessageLite
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C4381a.f34960a[methodToInvoke.ordinal()]) {
            case 1:
                return new Struct();
            case 2:
                return new Builder(null);
            case 3:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0001\u0000\u0000\u0001\u0001\u0001\u0001\u0000\u0000\u00012", new Object[]{"fields_", C4382b.f34961a});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
    ...
    @Override // androidx.datastore.preferences.protobuf.StructOrBuilder
    public Map<String, Value> getFieldsMap() {
        return Collections.unmodifiableMap(m55510t());
    }

    @Override // androidx.datastore.preferences.protobuf.StructOrBuilder
    public Value getFieldsOrDefault(String str, Value value) {
        str.getClass();
        MapFieldLite m55510t = m55510t();
        if (m55510t.containsKey(str)) {
            return (Value) m55510t.get(str);
        }
        return value;
    }
    ...
    /* renamed from: s */
    public final Map m55511s() {
        return m55509u();
    }

    /* renamed from: t */
    public final MapFieldLite m55510t() {
        return this.fields_;
    }

    /* renamed from: u */
    public final MapFieldLite m55509u() {
