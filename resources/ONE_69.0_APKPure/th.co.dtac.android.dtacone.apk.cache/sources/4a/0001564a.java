...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.esim.ESimPostpaidViewModel$getMrtrPostpaidReregistAuthorization$3 */
/* loaded from: classes9.dex */
public final class ESimPostpaidViewModel$getMrtrPostpaidReregistAuthorization$3 extends Lambda implements Function1<GetAuthorizationByRtrPostpaidResponse, Unit> {
    final /* synthetic */ ESimPostpaidViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimPostpaidViewModel$getMrtrPostpaidReregistAuthorization$3(ESimPostpaidViewModel eSimPostpaidViewModel) {
        super(1);
    ...
    public final void invoke2(GetAuthorizationByRtrPostpaidResponse getAuthorizationByRtrPostpaidResponse) {
        ...
        this.this$0.setAuthorization(getAuthorizationByRtrPostpaidResponse);
        this.this$0.getLiveDataState().setValue(StatusResource.DISMISS);
        mutableLiveData = this.this$0.f105725R;
        mutableLiveData.setValue(Resource.Companion.success(getAuthorizationByRtrPostpaidResponse));
    }
}