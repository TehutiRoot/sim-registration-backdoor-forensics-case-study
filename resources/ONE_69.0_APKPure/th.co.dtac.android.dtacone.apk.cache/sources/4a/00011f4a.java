...
public final class SubmitPre2PostRequest {
    ...
    @NotNull
    public final SubmitPre2PostRequest copy(@NotNull String userFormatType, @NotNull String userNameLogin, @NotNull String userCode, @NotNull String userLan, @NotNull String userName, @NotNull String channel, @NotNull String subChannel, @NotNull String rtrCode, @NotNull String rtrName, boolean z, @NotNull String deviceCampaignType, @NotNull String subscriberNumber, @NotNull String otpCode, @NotNull String customerNumber, @NotNull String subscriberStatus, @NotNull String subscriberLastChangeDateTime, @NotNull String companyCode, @NotNull String simCardNumber, @NotNull String dealerNumber, @NotNull String switchOffReasonCode, @NotNull String groupCode, @NotNull String subscriberType, @NotNull String hardwareNumber, @NotNull String brandName, @NotNull String brandCode, @NotNull String modelName, @NotNull String modelCode, boolean z2, boolean z3, @NotNull String idNumber, @NotNull String idType, boolean z4, @NotNull String verifyIDNumber, @NotNull String verifyType, int i, @NotNull String manualReason, @NotNull String nbtcConfidence, @NotNull String nbtcMessage, @NotNull String nbtcStatus, @NotNull String packageGroupCode, @NotNull String packageDescription, @NotNull String switchOnReasonCode, @NotNull String requesterId, @NotNull String firstName, @NotNull String title, @NotNull String firstNameEnglish, @NotNull String lastName, @NotNull String lastNameEnglish, @NotNull String birthDate, @NotNull String expiryDate, @NotNull String issueDate, @NotNull String gender, @NotNull Address legalAddress, @NotNull Address mailingAddress, @NotNull String email, @NotNull String contactNumber, @NotNull String invoiceAlertLanguage, @NotNull String invoiceAlertMethod, @NotNull String consentAcceptType, @NotNull String consentVersion, @NotNull List<String> attachmentNames, @NotNull String identityPhotoName, @NotNull String profileImage, @NotNull String existingHardwareNumber, @NotNull String existingBrand, @NotNull String existingModel, @NotNull List<OffersPackage> offersPackage, @Nullable String str, @NotNull String requesterChannel, @NotNull String requesterApplication, @NotNull String requesterZone, @Nullable String str2, @Nullable String str3, @Nullable String str4, boolean z5) {
        Intrinsics.checkNotNullParameter(userFormatType, "userFormatType");
        Intrinsics.checkNotNullParameter(userNameLogin, "userNameLogin");
        Intrinsics.checkNotNullParameter(userCode, "userCode");
        Intrinsics.checkNotNullParameter(userLan, "userLan");
        ...
        Intrinsics.checkNotNullParameter(requesterApplication, "requesterApplication");
        Intrinsics.checkNotNullParameter(requesterZone, "requesterZone");
        return new SubmitPre2PostRequest(userFormatType, userNameLogin, userCode, userLan, userName, channel, subChannel, rtrCode, rtrName, z, deviceCampaignType, subscriberNumber, otpCode, customerNumber, subscriberStatus, subscriberLastChangeDateTime, companyCode, simCardNumber, dealerNumber, switchOffReasonCode, groupCode, subscriberType, hardwareNumber, brandName, brandCode, modelName, modelCode, z2, z3, idNumber, idType, z4, verifyIDNumber, verifyType, i, manualReason, nbtcConfidence, nbtcMessage, nbtcStatus, packageGroupCode, packageDescription, switchOnReasonCode, requesterId, firstName, title, firstNameEnglish, lastName, lastNameEnglish, birthDate, expiryDate, issueDate, gender, legalAddress, mailingAddress, email, contactNumber, invoiceAlertLanguage, invoiceAlertMethod, consentAcceptType, consentVersion, attachmentNames, identityPhotoName, profileImage, existingHardwareNumber, existingBrand, existingModel, offersPackage, str, requesterChannel, requesterApplication, requesterZone, str2, str3, str4, z5);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof SubmitPre2PostRequest) {
            SubmitPre2PostRequest submitPre2PostRequest = (SubmitPre2PostRequest) obj;
            return Intrinsics.areEqual(this.userFormatType, submitPre2PostRequest.userFormatType) && Intrinsics.areEqual(this.userNameLogin, submitPre2PostRequest.userNameLogin) && Intrinsics.areEqual(this.userCode, submitPre2PostRequest.userCode) && Intrinsics.areEqual(this.userLan, submitPre2PostRequest.userLan) && Intrinsics.areEqual(this.userName, submitPre2PostRequest.userName) && Intrinsics.areEqual(this.channel, submitPre2PostRequest.channel) && Intrinsics.areEqual(this.subChannel, submitPre2PostRequest.subChannel) && Intrinsics.areEqual(this.rtrCode, submitPre2PostRequest.rtrCode) && Intrinsics.areEqual(this.rtrName, submitPre2PostRequest.rtrName) && this.isWithDevice == submitPre2PostRequest.isWithDevice && Intrinsics.areEqual(this.deviceCampaignType, submitPre2PostRequest.deviceCampaignType) && Intrinsics.areEqual(this.subscriberNumber, submitPre2PostRequest.subscriberNumber) && Intrinsics.areEqual(this.otpCode, submitPre2PostRequest.otpCode) && Intrinsics.areEqual(this.customerNumber, submitPre2PostRequest.customerNumber) && Intrinsics.areEqual(this.subscriberStatus, submitPre2PostRequest.subscriberStatus) && Intrinsics.areEqual(this.subscriberLastChangeDateTime, submitPre2PostRequest.subscriberLastChangeDateTime) && Intrinsics.areEqual(this.companyCode, submitPre2PostRequest.companyCode) && Intrinsics.areEqual(this.simCardNumber, submitPre2PostRequest.simCardNumber) && Intrinsics.areEqual(this.dealerNumber, submitPre2PostRequest.dealerNumber) && Intrinsics.areEqual(this.switchOffReasonCode, submitPre2PostRequest.switchOffReasonCode) && Intrinsics.areEqual(this.groupCode, submitPre2PostRequest.groupCode) && Intrinsics.areEqual(this.subscriberType, submitPre2PostRequest.subscriberType) && Intrinsics.areEqual(this.hardwareNumber, submitPre2PostRequest.hardwareNumber) && Intrinsics.areEqual(this.brandName, submitPre2PostRequest.brandName) && Intrinsics.areEqual(this.brandCode, submitPre2PostRequest.brandCode) && Intrinsics.areEqual(this.modelName, submitPre2PostRequest.modelName) && Intrinsics.areEqual(this.modelCode, submitPre2PostRequest.modelCode) && this.isNewIMEI == submitPre2PostRequest.isNewIMEI && this.isDtacDevice == submitPre2PostRequest.isDtacDevice && Intrinsics.areEqual(this.idNumber, submitPre2PostRequest.idNumber) && Intrinsics.areEqual(this.idType, submitPre2PostRequest.idType) && this.isSmartCard == submitPre2PostRequest.isSmartCard && Intrinsics.areEqual(this.verifyIDNumber, submitPre2PostRequest.verifyIDNumber) && Intrinsics.areEqual(this.verifyType, submitPre2PostRequest.verifyType) && this.verifyAttempt == submitPre2PostRequest.verifyAttempt && Intrinsics.areEqual(this.manualReason, submitPre2PostRequest.manualReason) && Intrinsics.areEqual(this.nbtcConfidence, submitPre2PostRequest.nbtcConfidence) && Intrinsics.areEqual(this.nbtcMessage, submitPre2PostRequest.nbtcMessage) && Intrinsics.areEqual(this.nbtcStatus, submitPre2PostRequest.nbtcStatus) && Intrinsics.areEqual(this.packageGroupCode, submitPre2PostRequest.packageGroupCode) && Intrinsics.areEqual(this.packageDescription, submitPre2PostRequest.packageDescription) && Intrinsics.areEqual(this.switchOnReasonCode, submitPre2PostRequest.switchOnReasonCode) && Intrinsics.areEqual(this.requesterId, submitPre2PostRequest.requesterId) && Intrinsics.areEqual(this.firstName, submitPre2PostRequest.firstName) && Intrinsics.areEqual(this.title, submitPre2PostRequest.title) && Intrinsics.areEqual(this.firstNameEnglish, submitPre2PostRequest.firstNameEnglish) && Intrinsics.areEqual(this.lastName, submitPre2PostRequest.lastName) && Intrinsics.areEqual(this.lastNameEnglish, submitPre2PostRequest.lastNameEnglish) && Intrinsics.areEqual(this.birthDate, submitPre2PostRequest.birthDate) && Intrinsics.areEqual(this.expiryDate, submitPre2PostRequest.expiryDate) && Intrinsics.areEqual(this.issueDate, submitPre2PostRequest.issueDate) && Intrinsics.areEqual(this.gender, submitPre2PostRequest.gender) && Intrinsics.areEqual(this.legalAddress, submitPre2PostRequest.legalAddress) && Intrinsics.areEqual(this.mailingAddress, submitPre2PostRequest.mailingAddress) && Intrinsics.areEqual(this.email, submitPre2PostRequest.email) && Intrinsics.areEqual(this.contactNumber, submitPre2PostRequest.contactNumber) && Intrinsics.areEqual(this.invoiceAlertLanguage, submitPre2PostRequest.invoiceAlertLanguage) && Intrinsics.areEqual(this.invoiceAlertMethod, submitPre2PostRequest.invoiceAlertMethod) && Intrinsics.areEqual(this.consentAcceptType, submitPre2PostRequest.consentAcceptType) && Intrinsics.areEqual(this.consentVersion, submitPre2PostRequest.consentVersion) && Intrinsics.areEqual(this.attachmentNames, submitPre2PostRequest.attachmentNames) && Intrinsics.areEqual(this.identityPhotoName, submitPre2PostRequest.identityPhotoName) && Intrinsics.areEqual(this.profileImage, submitPre2PostRequest.profileImage) && Intrinsics.areEqual(this.existingHardwareNumber, submitPre2PostRequest.existingHardwareNumber) && Intrinsics.areEqual(this.existingBrand, submitPre2PostRequest.existingBrand) && Intrinsics.areEqual(this.existingModel, submitPre2PostRequest.existingModel) && Intrinsics.areEqual(this.offersPackage, submitPre2PostRequest.offersPackage) && Intrinsics.areEqual(this.togglePrepaidEnable, submitPre2PostRequest.togglePrepaidEnable) && Intrinsics.areEqual(this.requesterChannel, submitPre2PostRequest.requesterChannel) && Intrinsics.areEqual(this.requesterApplication, submitPre2PostRequest.requesterApplication) && Intrinsics.areEqual(this.requesterZone, submitPre2PostRequest.requesterZone) && Intrinsics.areEqual(this.campaignID, submitPre2PostRequest.campaignID) && Intrinsics.areEqual(this.offerPOID, submitPre2PostRequest.offerPOID) && Intrinsics.areEqual(this.requesterLocation, submitPre2PostRequest.requesterLocation) && this.updateConsent == submitPre2PostRequest.updateConsent;
        }
        return false;
    }
