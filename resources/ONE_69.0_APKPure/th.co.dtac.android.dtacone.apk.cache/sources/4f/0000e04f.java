...
public class BitEncoding {
    ...
    /* renamed from: a */
    public static final boolean f69600a;
    ...
    static {
        ...
        f69600a = "true".equals(str);
    }

    /* renamed from: a */
    public static /* synthetic */ void m28323a(int i) {
    ...
    /* renamed from: b */
    public static void m28322b(byte[] bArr, int i) {
        if (bArr == null) {
            m28323a(4);
        }
    ...
    /* renamed from: c */
    public static byte[] m28321c(String[] strArr) {
        if (strArr == null) {
            m28323a(11);
        }
        int i = 0;
    ...
    /* renamed from: d */
    public static byte[] m28320d(byte[] bArr) {
        if (bArr == null) {
            m28323a(13);
        }
    ...
    public static byte[] decodeBytes(@NotNull String[] strArr) {
        ...
        if (strArr.length > 0 && !strArr[0].isEmpty()) {
            ...
            if (charAt == 0) {
                byte[] stringsToBytes = UtfEncodingKt.stringsToBytes(m28319e(strArr));
                if (stringsToBytes == null) {
                    m28323a(8);
                }
                return stringsToBytes;
            } else if (charAt == 65535) {
                strArr = m28319e(strArr);
            }
        }
        byte[] m28321c = m28321c(strArr);
        m28322b(m28321c, 127);
        return m28320d(m28321c);
    }

    /* renamed from: e */
    public static String[] m28319e(String[] strArr) {
        if (strArr == null) {
            m28323a(9);
        }
