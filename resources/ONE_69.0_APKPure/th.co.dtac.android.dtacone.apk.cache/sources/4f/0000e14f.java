...
public final class ChainedMemberScope implements MemberScope {
    ...
    /* renamed from: b */
    public final MemberScope[] f69966b;
            ...
            for (MemberScope memberScope : scopes) {
                if (memberScope != MemberScope.Empty.INSTANCE) {
                    if (memberScope instanceof ChainedMemberScope) {
                        AbstractC10396hs.addAll(smartList, ((ChainedMemberScope) memberScope).f69966b);
                    } else {
    ...
    public Set<Name> getClassifierNames() {
        return MemberScopeKt.flatMapClassifierNamesOrNull(ArraysKt___ArraysKt.asIterable(this.f69966b));
    }
    ...
    public ClassifierDescriptor getContributedClassifier(@NotNull Name name, @NotNull LookupLocation location) {
        ...
        for (MemberScope memberScope : this.f69966b) {
    ...
    public Collection<DeclarationDescriptor> getContributedDescriptors(@NotNull DescriptorKindFilter kindFilter, @NotNull Function1<? super Name, Boolean> nameFilter) {
        ...
        MemberScope[] memberScopeArr = this.f69966b;
