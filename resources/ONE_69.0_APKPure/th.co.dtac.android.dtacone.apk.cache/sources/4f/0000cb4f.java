...
public final class Contexts {
    ...
    /* loaded from: classes5.dex */
    public static class C10505a extends ForwardingServerCallListener.SimpleForwardingServerCallListener {

        /* renamed from: b */
        public final Context f63220b;

        public C10505a(ServerCall.Listener listener, Context context) {
            super(listener);
            this.f63220b = context;
        }

        @Override // io.grpc.ForwardingServerCallListener.SimpleForwardingServerCallListener, io.grpc.ForwardingServerCallListener, io.grpc.AbstractC10555b, io.grpc.ServerCall.Listener
        public void onCancel() {
            Context attach = this.f63220b.attach();
            try {
                super.onCancel();
            } finally {
                this.f63220b.detach(attach);
            }
        }
    ...
    public static <ReqT, RespT> ServerCall.Listener<ReqT> interceptCall(Context context, ServerCall<ReqT, RespT> serverCall, Metadata metadata, ServerCallHandler<ReqT, RespT> serverCallHandler) {
        ...
        try {
            return new C10505a(serverCallHandler.startCall(serverCall, metadata), context);
        } finally {
