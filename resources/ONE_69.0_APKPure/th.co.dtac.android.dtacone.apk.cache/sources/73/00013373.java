...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.viewModel.OneMnpViewModel$generateForm$2 */
/* loaded from: classes10.dex */
public final class OneMnpViewModel$generateForm$2 extends Lambda implements Function1<OneGenerateFormResponse, Unit> {
    final /* synthetic */ OneMnpViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneMnpViewModel$generateForm$2(OneMnpViewModel oneMnpViewModel) {
        super(1);
    ...
    public final void invoke2(OneGenerateFormResponse it) {
        MutableStateFlow mutableStateFlow;
        MutableStateFlow mutableStateFlow2;
        mutableStateFlow = this.this$0.f92195v2;
        List<PDFFormData> data = it.getData();
        if (data == null) {
            data = CollectionsKt__CollectionsKt.emptyList();
        }
        mutableStateFlow.setValue(data);
        mutableStateFlow2 = this.this$0.f92187t2;
        Intrinsics.checkNotNullExpressionValue(it, "it");
        mutableStateFlow2.setValue(new OneMnpGenerateFormState.Success(it));
