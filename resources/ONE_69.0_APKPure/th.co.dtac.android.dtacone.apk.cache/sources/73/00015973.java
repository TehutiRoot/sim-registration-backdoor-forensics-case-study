...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_pre2post.MrtrPre2PostViewModel$getAuthorize$3 */
/* loaded from: classes9.dex */
public final class MrtrPre2PostViewModel$getAuthorize$3 extends Lambda implements Function1<GetPre2PostAuthorizationByRtrResponse, Unit> {
    final /* synthetic */ MrtrPre2PostViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrPre2PostViewModel$getAuthorize$3(MrtrPre2PostViewModel mrtrPre2PostViewModel) {
        super(1);
    ...
    public final void invoke2(GetPre2PostAuthorizationByRtrResponse getPre2PostAuthorizationByRtrResponse) {
        MutableLiveData m2169a0;
        m2169a0 = this.this$0.m2169a0();
        m2169a0.setValue(Resource.Companion.success(getPre2PostAuthorizationByRtrResponse));
    }
}