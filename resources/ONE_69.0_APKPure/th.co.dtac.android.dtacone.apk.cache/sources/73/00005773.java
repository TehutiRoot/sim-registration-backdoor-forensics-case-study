...
public final class BadgeKt$BadgedBox$2$measure$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke2(@NotNull Placeable.PlacementScope layout) {
        ...
        boolean z = this.$badgePlaceable.getWidth() > this.$this_Layout.mo69616roundToPx0680j_4(BadgeTokens.INSTANCE.m71017getSizeD9Ej5fM());
        ...
        Placeable.PlacementScope.placeRelative$default(layout, this.$badgePlaceable, this.$anchorPlaceable.getWidth() + this.$this_Layout.mo69616roundToPx0680j_4(badgeWithContentHorizontalOffset), ((-this.$badgePlaceable.getHeight()) / 2) + this.$this_Layout.mo69616roundToPx0680j_4(badgeWithContentVerticalOffset), 0.0f, 4, null);
    }
}