...
public class GoogleAuthorizationCodeFlow extends AuthorizationCodeFlow {
    ...
    /* renamed from: p */
    public final String f51815p;

    /* renamed from: q */
    public final String f51816q;
    ...
    public GoogleAuthorizationCodeFlow(Builder builder) {
        super(builder);
        this.f51816q = builder.f51818q;
        this.f51815p = builder.f51817p;
    }

    @Override // com.google.api.client.auth.oauth2.AuthorizationCodeFlow
    public GoogleAuthorizationCodeRequestUrl newAuthorizationUrl() {
        return new GoogleAuthorizationCodeRequestUrl(getAuthorizationServerEncodedUrl(), getClientId(), "", getScopes()).setAccessType(this.f51816q).setApprovalPrompt(this.f51815p);
    }
