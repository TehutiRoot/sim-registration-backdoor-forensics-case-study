...
@Metadata(m29143d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\n\u0002\b\t\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\b\u0087\b\u0018\u00002\u00020\u0001B\u001d\u0012\n\b\u0002\u0010\u0002\u001a\u0004\u0018\u00010\u0003\u0012\n\b\u0002\u0010\u0004\u001a\u0004\u0018\u00010\u0003¢\u0006\u0002\u0010\u0005J\u000b\u0010\t\u001a\u0004\u0018\u00010\u0003HÆ\u0003J\u000b\u0010\n\u001a\u0004\u0018\u00010\u0003HÆ\u0003J!\u0010\u000b\u001a\u00020\u00002\n\b\u0002\u0010\u0002\u001a\u0004\u0018\u00010\u00032\n\b\u0002\u0010\u0004\u001a\u0004\u0018\u00010\u0003HÆ\u0001J\u0013\u0010\f\u001a\u00020\r2\b\u0010\u000e\u001a\u0004\u0018\u00010\u0001HÖ\u0003J\t\u0010\u000f\u001a\u00020\u0010HÖ\u0001J\t\u0010\u0011\u001a\u00020\u0003HÖ\u0001R\u0018\u0010\u0002\u001a\u0004\u0018\u00010\u00038\u0006X\u0087\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007R\u0018\u0010\u0004\u001a\u0004\u0018\u00010\u00038\u0006X\u0087\u0004¢\u0006\b\n\u0000\u001a\u0004\b\b\u0010\u0007¨\u0006\u0012"}, m29142d2 = {"Lth/co/dtac/android/dtacone/model/appOne/postpaid/true_company/ConsentNoticeDocData;", "", "pdf", "", NotificationCompat.CATEGORY_STATUS, "(Ljava/lang/String;Ljava/lang/String;)V", "getPdf", "()Ljava/lang/String;", "getStatus", "component1", "component2", "copy", "equals", "", "other", "hashCode", "", "toString", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
/* renamed from: th.co.dtac.android.dtacone.model.appOne.postpaid.true_company.ConsentNoticeDocData */
...
public final class ConsentNoticeDocData {
    ...
    public static /* synthetic */ ConsentNoticeDocData copy$default(ConsentNoticeDocData consentNoticeDocData, String str, String str2, int i, Object obj) {
        if ((i & 1) != 0) {
            str = consentNoticeDocData.pdf;
        }
        if ((i & 2) != 0) {
            str2 = consentNoticeDocData.status;
        }
    ...
    @NotNull
    public final ConsentNoticeDocData copy(@Nullable String str, @Nullable String str2) {
        return new ConsentNoticeDocData(str, str2);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof ConsentNoticeDocData) {
            ...
            return Intrinsics.areEqual(this.pdf, consentNoticeDocData.pdf) && Intrinsics.areEqual(this.status, consentNoticeDocData.status);
        }
        return false;
    }
    ...
    public String toString() {
        String str = this.pdf;
        String str2 = this.status;
        return "ConsentNoticeDocData(pdf=" + str + ", status=" + str2 + ")";
    }

    public ConsentNoticeDocData(@Nullable String str, @Nullable String str2) {
        this.pdf = str;
        this.status = str2;
    }
