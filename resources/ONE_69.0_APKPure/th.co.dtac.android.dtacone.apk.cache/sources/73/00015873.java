...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_mnp.MrtrMnpValidateViewModel$checkSimStock$1$1 */
/* loaded from: classes9.dex */
public final class MrtrMnpValidateViewModel$checkSimStock$1$1 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ MrtrMnpRepository $this_run;
    final /* synthetic */ MrtrMnpValidateViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrMnpValidateViewModel$checkSimStock$1$1(MrtrMnpValidateViewModel mrtrMnpValidateViewModel, MrtrMnpRepository mrtrMnpRepository) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable it) {
        ...
        final MrtrMnpRepository mrtrMnpRepository = this.$this_run;
        mrtrErrorService.handleException(it, new MrtrErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.viewmodel.mrtr_mnp.MrtrMnpValidateViewModel$checkSimStock$1$1.1
            ...
            public void handle(@Nullable Throwable th2) {
                ...
                MutableLiveData m2359w;
                ErrorCollection errorCollection = new ErrorCollection();
                if (!(th2 instanceof ServerErrorException)) {
                    mrtrErrorService2 = MrtrMnpValidateViewModel.this.f106325e;
                ...
                mrtrMnpRepository.setCheckSimStockError(errorCollection);
                m2359w = MrtrMnpValidateViewModel.this.m2359w();
                m2359w.setValue(Resource.Companion.success(errorCollection.getStatusCode()));
            }
