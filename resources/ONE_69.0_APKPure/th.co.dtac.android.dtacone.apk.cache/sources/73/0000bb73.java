...
public class C9318df implements keys {
    ...
    /* loaded from: classes5.dex */
    public static /* synthetic */ class C93191 {
    ...
    public C9318df(setFastScrollEnabled.valueOf valueof, String str) {
        this(valueof, str, C9365eu.ThreeDS2Service.values.valueOf(), false);
    }
    ...
    public void valueOf(setLineSpacing.ThreeDS2ServiceInstance threeDS2ServiceInstance) {
        ...
        int i = C93191.ThreeDS2ServiceInstance[this.get.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i == 3) {
    ...
    public C9318df(setFastScrollEnabled.valueOf valueof, String str, String str2) {
        this(valueof, str, str2, false);
    }

    public C9318df(setFastScrollEnabled.valueOf valueof, String str, String str2, boolean z) {
        this.ThreeDS2Service = C9642nt.ThreeDS2ServiceInstance(C9318df.class);
        this.get = valueof;
