...
/* renamed from: th.co.dtac.android.dtacone.presenter.campaign.detail.MyCampaignDetailPresenter$getMyCampaignDetail$3 */
/* loaded from: classes8.dex */
public final class MyCampaignDetailPresenter$getMyCampaignDetail$3 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ MyCampaignDetailPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MyCampaignDetailPresenter$getMyCampaignDetail$3(MyCampaignDetailPresenter myCampaignDetailPresenter) {
        super(1);
    ...
    public final void invoke2(Throwable th2) {
        ...
        errorService.handleException(th2, new ServerErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.presenter.campaign.detail.MyCampaignDetailPresenter$getMyCampaignDetail$3.1
            ...
            public void handle(@Nullable Throwable th3) {
                ...
                view.onGetMyCampaignDetailFailed(errorMessage);
            }
