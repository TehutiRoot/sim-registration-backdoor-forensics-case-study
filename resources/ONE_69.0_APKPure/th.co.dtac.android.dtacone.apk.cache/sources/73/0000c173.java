...
public final class PDAppearanceContentStream extends AbstractC19616di1 implements Closeable {
    ...
    public void setBorderLine(float f, PDBorderStyleDictionary pDBorderStyleDictionary, COSArray cOSArray) throws IOException {
        if (pDBorderStyleDictionary != null && pDBorderStyleDictionary.getCOSObject().containsKey(COSName.f59782D) && pDBorderStyleDictionary.getStyle().equals("D")) {
