...
public final class AppBarKt$SingleRowTopAppBar$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        float mo69622toPx0680j_4 = ((Density) consume).mo69622toPx0680j_4(TopAppBarSmallTokens.INSTANCE.m71512getContainerHeightD9Ej5fM()) + ((topAppBarScrollBehavior == null || (state = topAppBarScrollBehavior.getState()) == null) ? 0.0f : state.getHeightOffset());
        Modifier clipToBounds = ClipKt.clipToBounds(WindowInsetsPaddingKt.windowInsetsPadding(Modifier.Companion, this.$windowInsets));
        long m70994getNavigationIconContentColor0d7_KjU$material3_release = this.$colors.m70994getNavigationIconContentColor0d7_KjU$material3_release();
        long m70995getTitleContentColor0d7_KjU$material3_release = this.$colors.m70995getTitleContentColor0d7_KjU$material3_release();
        long m70993getActionIconContentColor0d7_KjU$material3_release = this.$colors.m70993getActionIconContentColor0d7_KjU$material3_release();
