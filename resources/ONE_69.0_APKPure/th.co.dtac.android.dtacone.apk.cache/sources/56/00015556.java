...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.device_sale.DeviceSaleViewModel$_getExtraAdvanceMaster$2 */
/* loaded from: classes9.dex */
public final class DeviceSaleViewModel$_getExtraAdvanceMaster$2 extends Lambda implements Function0<MutableLiveData<Resource<? extends List<? extends PackagePriceTierResponse.ExtraAdvance>>>> {
    public static final DeviceSaleViewModel$_getExtraAdvanceMaster$2 INSTANCE = new DeviceSaleViewModel$_getExtraAdvanceMaster$2();

    public DeviceSaleViewModel$_getExtraAdvanceMaster$2() {
        super(0);
    }
