...
@Metadata(m29143d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010%\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0000\u0018\u00002\u00020\u0001B\u001a\u0012\u0006\u0010\u0002\u001a\u00020\u0001\u0012\u0006\u0010\u0004\u001a\u00020\u0003ø\u0001\u0000¢\u0006\u0004\b\u0005\u0010\u0006J\u0017\u0010\t\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\u0007H\u0002¢\u0006\u0004\b\t\u0010\nR\u001d\u0010\u0004\u001a\u00020\u00038\u0002X\u0082\u0004ø\u0001\u0000ø\u0001\u0001ø\u0001\u0002¢\u0006\u0006\n\u0004\b\t\u0010\u000bR \u0010\u000f\u001a\u000e\u0012\u0004\u0012\u00020\u0007\u0012\u0004\u0012\u00020\u00070\f8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\r\u0010\u000eR \u0010\u0016\u001a\b\u0012\u0004\u0012\u00020\u00110\u00108\u0016X\u0096\u0004¢\u0006\f\n\u0004\b\u0012\u0010\u0013\u001a\u0004\b\u0014\u0010\u0015\u0082\u0002\u000f\n\u0002\b\u0019\n\u0005\b¡\u001e0\u0001\n\u0002\b!¨\u0006\u0017"}, m29142d2 = {"Landroidx/compose/material3/MappedInteractionSource;", "Landroidx/compose/foundation/interaction/InteractionSource;", "underlyingInteractionSource", "Landroidx/compose/ui/geometry/Offset;", "delta", "<init>", "(Landroidx/compose/foundation/interaction/InteractionSource;JLkotlin/jvm/internal/DefaultConstructorMarker;)V", "Landroidx/compose/foundation/interaction/PressInteraction$Press;", "press", PDPageLabelRange.STYLE_LETTERS_LOWER, "(Landroidx/compose/foundation/interaction/PressInteraction$Press;)Landroidx/compose/foundation/interaction/PressInteraction$Press;", OperatorName.SET_LINE_CAPSTYLE, "", OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, "Ljava/util/Map;", "mappedPresses", "Lkotlinx/coroutines/flow/Flow;", "Landroidx/compose/foundation/interaction/Interaction;", OperatorName.CURVE_TO, "Lkotlinx/coroutines/flow/Flow;", "getInteractions", "()Lkotlinx/coroutines/flow/Flow;", "interactions", "material3_release"}, m29141k = 1, m29140mv = {1, 8, 0})
...
public final class MappedInteractionSource implements InteractionSource {
    ...
    /* renamed from: b */
    public final Map f25951b;

    /* renamed from: c */
    public final Flow f25952c;
    ...
    /* renamed from: a */
    public final PressInteraction.Press m60571a(PressInteraction.Press press) {
        return new PressInteraction.Press(Offset.m71690minusMKHz9U(press.m69643getPressPositionF1C5BW0(), this.f25950a), null);
    }
    ...
    public MappedInteractionSource(InteractionSource underlyingInteractionSource, long j) {
        ...
        this.f25950a = j;
        this.f25951b = new LinkedHashMap();
        final Flow<Interaction> interactions = underlyingInteractionSource.getInteractions();
        this.f25952c = new Flow<Interaction>() { // from class: androidx.compose.material3.MappedInteractionSource$special$$inlined$map$1
            ...
            /* loaded from: classes2.dex */
            public static final class C32902<T> implements FlowCollector {

                /* renamed from: a */
                public final /* synthetic */ FlowCollector f25955a;

                /* renamed from: b */
                public final /* synthetic */ MappedInteractionSource f25956b;

                @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
                @DebugMetadata(m29093c = "androidx.compose.material3.MappedInteractionSource$special$$inlined$map$1$2", m29092f = "MappedInteractionSource.kt", m29091i = {}, m29090l = {223}, m29089m = "emit", m29088n = {}, m29087s = {})
                @SourceDebugExtension({"SMAP\nEmitters.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Emitters.kt\nkotlinx/coroutines/flow/FlowKt__EmittersKt$unsafeTransform$1$1$emit$1\n*L\n1#1,222:1\n*E\n"})
                /* renamed from: androidx.compose.material3.MappedInteractionSource$special$$inlined$map$1$2$1 */
                /* loaded from: classes2.dex */
                public static final class C32911 extends ContinuationImpl {
                    Object L$0;
                    int label;
                    /* synthetic */ Object result;

                    public C32911(Continuation continuation) {
                        super(continuation);
                    }
                    ...
                    public final Object invokeSuspend(@NotNull Object obj) {
                        ...
                        return C32902.this.emit(null, this);
                    }
                }

                public C32902(FlowCollector flowCollector, MappedInteractionSource mappedInteractionSource) {
                    this.f25955a = flowCollector;
                    this.f25956b = mappedInteractionSource;
                }
                ...
                */
                public final java.lang.Object emit(java.lang.Object r6, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation r7) {
                    /*
                        r5 = this;
                        boolean r0 = r7 instanceof androidx.compose.material3.MappedInteractionSource$special$$inlined$map$1.C32902.C32911
                        if (r0 == 0) goto L13
                        r0 = r7
                        androidx.compose.material3.MappedInteractionSource$special$$inlined$map$1$2$1 r0 = (androidx.compose.material3.MappedInteractionSource$special$$inlined$map$1.C32902.C32911) r0
                        int r1 = r0.label
                    ...
                    L32:
                        kotlin.ResultKt.throwOnFailure(r7)
                        kotlinx.coroutines.flow.FlowCollector r7 = r5.f25955a
                        androidx.compose.foundation.interaction.Interaction r6 = (androidx.compose.foundation.interaction.Interaction) r6
                        boolean r2 = r6 instanceof androidx.compose.foundation.interaction.PressInteraction.Press
                        if (r2 == 0) goto L51
                        androidx.compose.material3.MappedInteractionSource r2 = r5.f25956b
                        r4 = r6
                        ...
                        androidx.compose.material3.MappedInteractionSource r4 = r5.f25956b
                    ...
                    L97:
                        ...
                        return r6
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.MappedInteractionSource$special$$inlined$map$1.C32902.emit(java.lang.Object, kotlin.coroutines.Continuation):java.lang.Object");
                }
            }
            ...
            public Object collect(@NotNull FlowCollector<? super Interaction> flowCollector, @NotNull Continuation continuation) {
                Object collect = Flow.this.collect(new C32902(flowCollector, this), continuation);
