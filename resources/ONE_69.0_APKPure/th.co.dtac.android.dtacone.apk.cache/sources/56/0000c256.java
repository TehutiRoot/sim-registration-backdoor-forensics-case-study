...
public final class CCITTFactory {
    /* renamed from: a */
    public static PDImageXObject m32395a(PDDocument pDDocument, RandomAccess randomAccess, int i) {
        COSDictionary cOSDictionary = new COSDictionary();
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
        m32394b(randomAccess, byteArrayOutputStream, cOSDictionary, i);
    ...
    /* renamed from: b */
    public static void m32394b(RandomAccess randomAccess, OutputStream outputStream, COSDictionary cOSDictionary, int i) {
        char read;
        int read2;
        try {
        ...
        try {
            if (((char) randomAccess.read()) == read) {
                ...
                if (m32391e(read, randomAccess) == 42) {
                    int m32392d = m32392d(read, randomAccess);
                    randomAccess.seek(m32392d);
                    for (int i2 = 0; i2 < i; i2++) {
                        int m32391e = m32391e(read, randomAccess);
                        if (m32391e <= 50) {
                            randomAccess.seek(m32392d + 2 + (m32391e * 12));
                            m32392d = m32392d(read, randomAccess);
                            if (m32392d == 0) {
                                outputStream.close();
                                return;
                            }
                    ...
                    int m32391e2 = m32391e(read, randomAccess);
                    if (m32391e2 <= 50) {
                        int i3 = NotificationManagerCompat.IMPORTANCE_UNSPECIFIED;
                        int i4 = 0;
                        int i5 = 0;
                        for (int i6 = 0; i6 < m32391e2; i6++) {
                            int m32391e3 = m32391e(read, randomAccess);
                            int m32391e4 = m32391e(read, randomAccess);
                            int m32392d2 = m32392d(read, randomAccess);
                            if (m32391e4 != 1) {
                                if (m32391e4 != 3) {
                                    read2 = m32392d(read, randomAccess);
                                } else {
                                    read2 = m32391e(read, randomAccess);
                                    randomAccess.read();
                                    randomAccess.read();
                                }
                            } else {
                        ...
                        if (i3 != -1000) {
                            if (i4 != 0) {
                                cOSDictionary.setInt(COSName.f59809K, i3);
    ...
    /* renamed from: c */
    public static PDImageXObject m32393c(PDDocument pDDocument, byte[] bArr, int i, int i2, PDColorSpace pDColorSpace) {
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
        ...
        cOSDictionary.setInt(COSName.f59809K, -1);
        pDImageXObject.getCOSObject().setItem(COSName.DECODE_PARMS, (COSBase) cOSDictionary);
        return pDImageXObject;
    }
    ...
    public static PDImageXObject createFromImage(PDDocument pDDocument, Bitmap bitmap) throws IOException {
        if (bitmap.getConfig() == Bitmap.Config.ALPHA_8) {
            ...
            return m32393c(pDDocument, byteArrayOutputStream.toByteArray(), width, height, PDDeviceGray.INSTANCE);
        }
    ...
    public static PDImageXObject createFromRandomAccess(PDDocument pDDocument, RandomAccess randomAccess) throws IOException {
        return m32395a(pDDocument, randomAccess, 0);
    }

    /* renamed from: d */
    public static int m32392d(char c, RandomAccess randomAccess) {
        int read;
        int read2;
        if (c == 'I') {
    ...
    /* renamed from: e */
    public static int m32391e(char c, RandomAccess randomAccess) {
        int read;
        int read2;
        if (c == 'I') {
    ...
    public static PDImageXObject createFromByteArray(PDDocument pDDocument, byte[] bArr, int i) throws IOException {
        ...
        try {
            return m32395a(pDDocument, randomAccessBuffer, i);
        } finally {
    ...
    public static PDImageXObject createFromFile(PDDocument pDDocument, File file, int i) throws IOException {
        ...
        try {
            return m32395a(pDDocument, randomAccessFile, i);
        } finally {
    ...
    public static PDImageXObject createFromRandomAccess(PDDocument pDDocument, RandomAccess randomAccess, int i) throws IOException {
        return m32395a(pDDocument, randomAccess, i);
    }
}