...
public final class KDFFeedbackParameters implements DerivationParameters {
    ...
    /* renamed from: iv */
    private final byte[] f75301iv;

    /* renamed from: ki */
    private final byte[] f75302ki;

    /* renamed from: r */
    private final int f75303r;
    ...
    private KDFFeedbackParameters(byte[] bArr, byte[] bArr2, byte[] bArr3, int i, boolean z) {
        ...
        this.f75302ki = Arrays.clone(bArr);
        if (bArr3 == null) {
        ...
        this.f75303r = i;
        if (bArr2 == null) {
            this.f75301iv = new byte[0];
        } else {
            this.f75301iv = Arrays.clone(bArr2);
        }
        this.useCounter = z;
    }
    ...
    public byte[] getIV() {
        return this.f75301iv;
    }

    public byte[] getKI() {
        return this.f75302ki;
    }
