...
@Metadata(m29143d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u000b¢\u0006\u0004\b\u0003\u0010\u0004"}, m29142d2 = {"<anonymous>", "", "Landroidx/compose/foundation/layout/BoxWithConstraintsScope;", "invoke", "(Landroidx/compose/foundation/layout/BoxWithConstraintsScope;Landroidx/compose/runtime/Composer;I)V"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
...
public final class ModalBottomSheetKt$ModalBottomSheetLayout$2 extends Lambda implements Function3<BoxWithConstraintsScope, Composer, Integer, Unit> {
    ...
    /* loaded from: classes.dex */
    public static final class C31183 extends Lambda implements Function1<Density, IntOffset> {
        final /* synthetic */ ModalBottomSheetState $sheetState;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C31183(ModalBottomSheetState modalBottomSheetState) {
            super(1);
        ...
        public /* bridge */ /* synthetic */ IntOffset invoke(Density density) {
            return IntOffset.m73951boximpl(m70236invokeBjo55l4(density));
        }

        /* renamed from: invoke-Bjo55l4  reason: not valid java name */
        public final long m70236invokeBjo55l4(@NotNull Density offset) {
            Intrinsics.checkNotNullParameter(offset, "$this$offset");
            return IntOffsetKt.IntOffset(0, AbstractC22237sr0.roundToInt(this.$sheetState.getAnchoredDraggableState$material_release().requireOffset()));
        }
    }

    @Metadata(m29143d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n¢\u0006\u0004\b\u0004\u0010\u0005"}, m29142d2 = {"<anonymous>", "", "sheetSize", "Landroidx/compose/ui/unit/IntSize;", "invoke-ozmzZPI", "(J)V"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: androidx.compose.material.ModalBottomSheetKt$ModalBottomSheetLayout$2$4 */
    /* loaded from: classes.dex */
    public static final class C31194 extends Lambda implements Function1<IntSize, Unit> {
        final /* synthetic */ AnchoredDraggableState.AnchorChangedCallback<ModalBottomSheetValue> $anchorChangeCallback;
        final /* synthetic */ float $fullHeight;
        final /* synthetic */ ModalBottomSheetState $sheetState;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C31194(ModalBottomSheetState modalBottomSheetState, AnchoredDraggableState.AnchorChangedCallback<ModalBottomSheetValue> anchorChangedCallback, float f) {
            super(1);
            this.$sheetState = modalBottomSheetState;
        ...
        public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
            m70237invokeozmzZPI(intSize.m74006unboximpl());
            return Unit.INSTANCE;
        }

        /* renamed from: invoke-ozmzZPI  reason: not valid java name */
        public final void m70237invokeozmzZPI(long j) {
            ...
            float f2 = f / 2.0f;
            if (!modalBottomSheetState.isSkipHalfExpanded$material_release() && IntSize.m74001getHeightimpl(j) > f2) {
                createMapBuilder.put(ModalBottomSheetValue.HalfExpanded, Float.valueOf(f2));
            }
            if (IntSize.m74001getHeightimpl(j) != 0) {
                createMapBuilder.put(ModalBottomSheetValue.Expanded, Float.valueOf(Math.max(0.0f, f - IntSize.m74001getHeightimpl(j))));
            }
            this.$sheetState.getAnchoredDraggableState$material_release().updateAnchors$material_release(AbstractC18946Zn0.build(createMapBuilder), this.$anchorChangeCallback);
        }
    }
    ...
    /* loaded from: classes.dex */
    public static final class C31205 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
        final /* synthetic */ CoroutineScope $scope;
        final /* synthetic */ ModalBottomSheetState $sheetState;
        ...
        /* loaded from: classes.dex */
        public static final class C31211 extends Lambda implements Function0<Boolean> {
            final /* synthetic */ CoroutineScope $scope;
            final /* synthetic */ ModalBottomSheetState $sheetState;

            @Metadata(m29143d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, m29142d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
            @DebugMetadata(m29093c = "androidx.compose.material.ModalBottomSheetKt$ModalBottomSheetLayout$2$5$1$1", m29092f = "ModalBottomSheet.kt", m29091i = {}, m29090l = {653}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
            /* renamed from: androidx.compose.material.ModalBottomSheetKt$ModalBottomSheetLayout$2$5$1$1 */
            /* loaded from: classes.dex */
            public static final class C31221 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                final /* synthetic */ ModalBottomSheetState $sheetState;
                int label;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C31221(ModalBottomSheetState modalBottomSheetState, Continuation<? super C31221> continuation) {
                ...
                public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                    return new C31221(this.$sheetState, continuation);
                }
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C31211(ModalBottomSheetState modalBottomSheetState, CoroutineScope coroutineScope) {
                super(0);
                this.$sheetState = modalBottomSheetState;
            ...
            public final Boolean invoke() {
                if (this.$sheetState.getAnchoredDraggableState$material_release().getConfirmValueChange$material_release().invoke(ModalBottomSheetValue.Hidden).booleanValue()) {
                    AbstractC1539Vc.m65885e(this.$scope, null, null, new C31221(this.$sheetState, null), 3, null);
                }
                return Boolean.TRUE;
            }
        }
        ...
        /* loaded from: classes.dex */
        public static final class C31232 extends Lambda implements Function0<Boolean> {
            final /* synthetic */ CoroutineScope $scope;
            final /* synthetic */ ModalBottomSheetState $sheetState;

            @Metadata(m29143d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, m29142d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
            @DebugMetadata(m29093c = "androidx.compose.material.ModalBottomSheetKt$ModalBottomSheetLayout$2$5$2$1", m29092f = "ModalBottomSheet.kt", m29091i = {}, m29090l = {665}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
            /* renamed from: androidx.compose.material.ModalBottomSheetKt$ModalBottomSheetLayout$2$5$2$1 */
            /* loaded from: classes.dex */
            public static final class C31241 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                final /* synthetic */ ModalBottomSheetState $sheetState;
                int label;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C31241(ModalBottomSheetState modalBottomSheetState, Continuation<? super C31241> continuation) {
                    super(2, continuation);
                    this.$sheetState = modalBottomSheetState;
                }
                ...
                @NotNull
                public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                    return new C31241(this.$sheetState, continuation);
                }
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C31232(ModalBottomSheetState modalBottomSheetState, CoroutineScope coroutineScope) {
                super(0);
                this.$sheetState = modalBottomSheetState;
                this.$scope = coroutineScope;
            }
            ...
            public final Boolean invoke() {
                if (this.$sheetState.getAnchoredDraggableState$material_release().getConfirmValueChange$material_release().invoke(ModalBottomSheetValue.Expanded).booleanValue()) {
                    AbstractC1539Vc.m65885e(this.$scope, null, null, new C31241(this.$sheetState, null), 3, null);
                }
                return Boolean.TRUE;
            }
        }
        ...
        /* loaded from: classes.dex */
        public static final class C31253 extends Lambda implements Function0<Boolean> {
            final /* synthetic */ CoroutineScope $scope;
            final /* synthetic */ ModalBottomSheetState $sheetState;

            @Metadata(m29143d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, m29142d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
            @DebugMetadata(m29093c = "androidx.compose.material.ModalBottomSheetKt$ModalBottomSheetLayout$2$5$3$1", m29092f = "ModalBottomSheet.kt", m29091i = {}, m29090l = {675}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
            /* renamed from: androidx.compose.material.ModalBottomSheetKt$ModalBottomSheetLayout$2$5$3$1 */
            /* loaded from: classes.dex */
            public static final class C31261 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                final /* synthetic */ ModalBottomSheetState $sheetState;
                int label;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C31261(ModalBottomSheetState modalBottomSheetState, Continuation<? super C31261> continuation) {
                    super(2, continuation);
                    this.$sheetState = modalBottomSheetState;
                }
                ...
                @NotNull
                public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                    return new C31261(this.$sheetState, continuation);
                }
                ...
                @Nullable
                public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
                    return ((C31261) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
                }
            }

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C31253(ModalBottomSheetState modalBottomSheetState, CoroutineScope coroutineScope) {
                super(0);
                this.$sheetState = modalBottomSheetState;
                this.$scope = coroutineScope;
            }
            ...
            public final Boolean invoke() {
                if (this.$sheetState.getAnchoredDraggableState$material_release().getConfirmValueChange$material_release().invoke(ModalBottomSheetValue.HalfExpanded).booleanValue()) {
                    AbstractC1539Vc.m65885e(this.$scope, null, null, new C31261(this.$sheetState, null), 3, null);
                }
                return Boolean.TRUE;
            }
        }
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C31205(ModalBottomSheetState modalBottomSheetState, CoroutineScope coroutineScope) {
            super(1);
            this.$sheetState = modalBottomSheetState;
            this.$scope = coroutineScope;
        }
        ...
        public final void invoke2(@NotNull SemanticsPropertyReceiver semantics) {
            ...
            if (this.$sheetState.isVisible()) {
                SemanticsPropertiesKt.dismiss$default(semantics, null, new C31211(this.$sheetState, this.$scope), 1, null);
                if (this.$sheetState.getAnchoredDraggableState$material_release().getCurrentValue() == ModalBottomSheetValue.HalfExpanded) {
                    SemanticsPropertiesKt.expand$default(semantics, null, new C31232(this.$sheetState, this.$scope), 1, null);
                } else if (this.$sheetState.getHasHalfExpandedState$material_release()) {
                    SemanticsPropertiesKt.collapse$default(semantics, null, new C31253(this.$sheetState, this.$scope), 1, null);
                }
            }
        }
    }
    ...
    /* loaded from: classes.dex */
    public static final class C31276 extends Lambda implements Function2<Composer, Integer, Unit> {
        final /* synthetic */ int $$dirty;
        final /* synthetic */ Function3<ColumnScope, Composer, Integer, Unit> $sheetContent;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C31276(Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, int i) {
            super(2);
    ...
    public final void invoke(@NotNull BoxWithConstraintsScope BoxWithConstraints, @Nullable Composer composer, int i) {
        ...
        float m73809getMaxHeightimpl = Constraints.m73809getMaxHeightimpl(BoxWithConstraints.mo69677getConstraintsmsEJaDk());
        ...
        ModalBottomSheetKt.m60827c(j, modalBottomSheetKt$ModalBottomSheetLayout$2$1$1, targetValue != modalBottomSheetValue, composer, (i3 >> 24) & 14);
        composer.endReplaceableGroup();
        composer.endNode();
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
        Modifier align = BoxWithConstraints.align(modifier2, companion.getTopCenter());
        f = ModalBottomSheetKt.f14608c;
        Modifier fillMaxWidth$default = SizeKt.fillMaxWidth$default(SizeKt.m69755widthInVpY3zN4$default(align, 0.0f, f, 1, null), 0.0f, 1, null);
        ...
        if (this.$sheetGesturesEnabled) {
            ...
            if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                rememberedValue = ModalBottomSheetKt.m60829a(modalBottomSheetState2.getAnchoredDraggableState$material_release(), orientation);
        ...
        composer.endReplaceableGroup();
        Modifier onSizeChanged = OnRemeasuredModifierKt.onSizeChanged(AnchoredDraggableKt.anchoredDraggable$default(OffsetKt.offset(fillMaxWidth$default.then(modifier), new C31183(this.$sheetState)), this.$sheetState.getAnchoredDraggableState$material_release(), this.$orientation, this.$sheetGesturesEnabled && this.$sheetState.getAnchoredDraggableState$material_release().getCurrentValue() != modalBottomSheetValue, false, null, 24, null), new C31194(this.$sheetState, this.$anchorChangeCallback, m73809getMaxHeightimpl));
        if (this.$sheetGesturesEnabled) {
            modifier2 = SemanticsModifierKt.semantics$default(modifier2, false, new C31205(this.$sheetState, this.$scope), 1, null);
        }
        ...
        ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer, 1552994302, true, new C31276(this.$sheetContent, this.$$dirty));
        int i4 = this.$$dirty;
        SurfaceKt.m70288SurfaceFjzlyU(then, shape, j2, j3, null, f2, composableLambda, composer, ((i4 >> 9) & 112) | 1572864 | ((i4 >> 12) & 896) | ((i4 >> 12) & 7168) | (i4 & 458752), 16);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    }
