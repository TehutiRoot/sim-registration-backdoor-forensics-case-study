...
@DebugMetadata(m29093c = "th.co.dtac.android.dtacone.view.appOne.tol.viewmodel.OneRegisterTrueOnlineViewModel$reserveServiceNumbFlp$1", m29092f = "OneRegisterTrueOnlineViewModel.kt", m29091i = {}, m29090l = {1964}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
@SourceDebugExtension({"SMAP\nOneRegisterTrueOnlineViewModel.kt\nKotlin\n*S Kotlin\n*F\n+ 1 OneRegisterTrueOnlineViewModel.kt\nth/co/dtac/android/dtacone/view/appOne/tol/viewmodel/OneRegisterTrueOnlineViewModel$reserveServiceNumbFlp$1\n+ 2 StateFlow.kt\nkotlinx/coroutines/flow/StateFlowKt\n*L\n1#1,2372:1\n230#2,5:2373\n230#2,5:2378\n230#2,5:2383\n230#2,5:2388\n230#2,5:2393\n230#2,5:2398\n230#2,5:2403\n*S KotlinDebug\n*F\n+ 1 OneRegisterTrueOnlineViewModel.kt\nth/co/dtac/android/dtacone/view/appOne/tol/viewmodel/OneRegisterTrueOnlineViewModel$reserveServiceNumbFlp$1\n*L\n1962#1:2373,5\n1966#1:2378,5\n1969#1:2383,5\n1977#1:2388,5\n1979#1:2393,5\n1982#1:2398,5\n1984#1:2403,5\n*E\n"})
/* renamed from: th.co.dtac.android.dtacone.view.appOne.tol.viewmodel.OneRegisterTrueOnlineViewModel$reserveServiceNumbFlp$1 */
/* loaded from: classes10.dex */
public final class OneRegisterTrueOnlineViewModel$reserveServiceNumbFlp$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public OneRegisterTrueOnlineViewModel$reserveServiceNumbFlp$1(OneRegisterTrueOnlineViewModel oneRegisterTrueOnlineViewModel, String str, int i, Continuation<? super OneRegisterTrueOnlineViewModel$reserveServiceNumbFlp$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new OneRegisterTrueOnlineViewModel$reserveServiceNumbFlp$1(this.this$0, this.$number, this.$index, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        try {
            if (i != 0) {
                ...
                ResultKt.throwOnFailure(obj);
                MutableStateFlow mutableStateFlow = this.this$0.f98229e1;
                do {
                ...
                this.label = 1;
                obj = oneTolRepository.reserveServiceNumbFlp(str3, this);
            ...
            MutableStateFlow mutableStateFlow2 = this.this$0.f98229e1;
            do {
            ...
            if (response == null || (headers = response.headers()) == null || (str2 = headers.get("Content-Type")) == null || !StringsKt__StringsKt.contains$default((CharSequence) str2, (CharSequence) "application/json", false, 2, (Object) null)) {
                MutableStateFlow mutableStateFlow3 = this.this$0.f98229e1;
                do {
                ...
                MutableStateFlow mutableStateFlow4 = this.this$0.f98229e1;
                do {
            ...
            MutableStateFlow mutableStateFlow5 = this.this$0.f98229e1;
            do {
        ...
        if (!Intrinsics.areEqual(reserveServiceNumbResponse.getCode(), "200")) {
            MutableStateFlow mutableStateFlow6 = this.this$0.f98229e1;
        ...
        MutableStateFlow mutableStateFlow7 = this.this$0.f98229e1;
        int i2 = this.$index;
        do {
            value6 = mutableStateFlow7.getValue();
            ReserveServiceNumbState reserveServiceNumbState7 = (ReserveServiceNumbState) value6;
        } while (!mutableStateFlow7.compareAndSet(value6, new ReserveServiceNumbState.Success(reserveServiceNumbResponse.getData(), Boxing.boxInt(i2))));
    ...
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((OneRegisterTrueOnlineViewModel$reserveServiceNumbFlp$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}