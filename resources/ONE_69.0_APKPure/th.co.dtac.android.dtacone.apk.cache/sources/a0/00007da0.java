...
public final class ImageLoaderProvidableCompositionLocal {
    ...
    /* renamed from: a */
    public final ProvidableCompositionLocal f40482a;

    @Metadata(m29143d1 = {"\u0000\b\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u0004\u0018\u00010\u0001H\n¢\u0006\u0002\b\u0002"}, m29142d2 = {"<anonymous>", "Lcoil/ImageLoader;", "invoke"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: coil.compose.ImageLoaderProvidableCompositionLocal$1 */
    /* loaded from: classes3.dex */
    public static final class C56351 extends Lambda implements Function0<ImageLoader> {
        public static final C56351 INSTANCE = new C56351();
    ...
    public /* synthetic */ ImageLoaderProvidableCompositionLocal(ProvidableCompositionLocal providableCompositionLocal) {
        this.f40482a = providableCompositionLocal;
    }

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ ImageLoaderProvidableCompositionLocal m74144boximpl(ProvidableCompositionLocal providableCompositionLocal) {
        return new ImageLoaderProvidableCompositionLocal(providableCompositionLocal);
    }

    @NotNull
    /* renamed from: constructor-impl  reason: not valid java name */
    public static ProvidableCompositionLocal<ImageLoader> m74145constructorimpl(@NotNull ProvidableCompositionLocal<ImageLoader> providableCompositionLocal) {
        return providableCompositionLocal;
    }

    /* renamed from: constructor-impl$default  reason: not valid java name */
    public static /* synthetic */ ProvidableCompositionLocal m74146constructorimpl$default(ProvidableCompositionLocal providableCompositionLocal, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            providableCompositionLocal = CompositionLocalKt.staticCompositionLocalOf(C56351.INSTANCE);
        }
        return m74145constructorimpl(providableCompositionLocal);
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m74147equalsimpl(ProvidableCompositionLocal<ImageLoader> providableCompositionLocal, Object obj) {
        return (obj instanceof ImageLoaderProvidableCompositionLocal) && Intrinsics.areEqual(providableCompositionLocal, ((ImageLoaderProvidableCompositionLocal) obj).m74152unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m74148equalsimpl0(ProvidableCompositionLocal<ImageLoader> providableCompositionLocal, ProvidableCompositionLocal<ImageLoader> providableCompositionLocal2) {
    ...
    public static int m74149hashCodeimpl(ProvidableCompositionLocal<ImageLoader> providableCompositionLocal) {
    ...
    public static final ProvidedValue<ImageLoader> m74150providesimpl(ProvidableCompositionLocal<ImageLoader> providableCompositionLocal, @NotNull ImageLoader imageLoader) {
        return providableCompositionLocal.provides(imageLoader);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m74151toStringimpl(ProvidableCompositionLocal<ImageLoader> providableCompositionLocal) {
    ...
    public boolean equals(Object obj) {
        return m74147equalsimpl(this.f40482a, obj);
    }

    public int hashCode() {
        return m74149hashCodeimpl(this.f40482a);
    }

    public String toString() {
        return m74151toStringimpl(this.f40482a);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ ProvidableCompositionLocal m74152unboximpl() {
        return this.f40482a;
    }
}