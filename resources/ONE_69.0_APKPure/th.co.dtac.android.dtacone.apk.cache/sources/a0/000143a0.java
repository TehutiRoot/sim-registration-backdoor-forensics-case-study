...
@SourceDebugExtension({"SMAP\nInstallContactScreen.kt\nKotlin\n*S Kotlin\n*F\n+ 1 InstallContactScreen.kt\nth/co/dtac/android/dtacone/view/appOne/tol/screen/installation/InstallContactScreenKt$ContactSection$1$6\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,371:1\n1559#2:372\n1590#2,4:373\n*S KotlinDebug\n*F\n+ 1 InstallContactScreen.kt\nth/co/dtac/android/dtacone/view/appOne/tol/screen/installation/InstallContactScreenKt$ContactSection$1$6\n*L\n189#1:372\n189#1:373,4\n*E\n"})
/* renamed from: th.co.dtac.android.dtacone.view.appOne.tol.screen.installation.InstallContactScreenKt$ContactSection$1$6 */
/* loaded from: classes10.dex */
public final class InstallContactScreenKt$ContactSection$1$6 extends Lambda implements Function1<String, Unit> {
    ...
    public InstallContactScreenKt$ContactSection$1$6(Function1<? super InstallContact, Unit> function1, InstallContact installContact) {
        super(1);
    ...
    public final void invoke2(@NotNull String value) {
        ...
        for (Object obj : infoList) {
            ...
            if (i == installContact2.getType().ordinal()) {
                installContactInfo = InstallContactInfo.copy$default(installContactInfo, null, null, StringHelperKt.toValidThaiMobileNumber(value), 3, null);
            }
