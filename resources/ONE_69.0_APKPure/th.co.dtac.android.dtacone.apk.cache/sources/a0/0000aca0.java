...
public final class Booleans {
    ...
    public static class BooleanArrayAsList extends AbstractList<Boolean> implements RandomAccess, Serializable {
        ...
        public boolean contains(@CheckForNull Object obj) {
            if ((obj instanceof Boolean) && Booleans.m39866d(this.array, ((Boolean) obj).booleanValue(), this.start, this.end) != -1) {
                return true;
            }
            return false;
        }
        ...
        public int indexOf(@CheckForNull Object obj) {
            int m39866d;
            if ((obj instanceof Boolean) && (m39866d = Booleans.m39866d(this.array, ((Boolean) obj).booleanValue(), this.start, this.end)) >= 0) {
                return m39866d - this.start;
            }
            return -1;
        }
        ...
        public int lastIndexOf(@CheckForNull Object obj) {
            int m39865e;
            if ((obj instanceof Boolean) && (m39865e = Booleans.m39865e(this.array, ((Boolean) obj).booleanValue(), this.start, this.end)) >= 0) {
                return m39865e - this.start;
            }
            return -1;
        }
    ...
    /* renamed from: c */
    public static int m39867c(long j) {
        boolean z;
        int i = (int) j;
        if (j == i) {
            z = true;
    ...
    public static boolean[] concat(boolean[]... zArr) {
        ...
        boolean[] zArr3 = new boolean[m39867c(j)];
        int i = 0;
        for (boolean[] zArr4 : zArr) {
            System.arraycopy(zArr4, 0, zArr3, i, zArr4.length);
            i += zArr4.length;
        }
        return zArr3;
    }
    ...
    /* renamed from: d */
    public static int m39866d(boolean[] zArr, boolean z, int i, int i2) {
        while (i < i2) {
            if (zArr[i] == z) {
                return i;
            }
    ...
    /* renamed from: e */
    public static int m39865e(boolean[] zArr, boolean z, int i, int i2) {
    ...
    public static int indexOf(boolean[] zArr, boolean z) {
        return m39866d(zArr, z, 0, zArr.length);
    }
    ...
    public static int lastIndexOf(boolean[] zArr, boolean z) {
        return m39865e(zArr, z, 0, zArr.length);
    }
