...
public class BottomNavigationView extends NavigationBarView {
    ...
    /* loaded from: classes4.dex */
    public class C6820a implements ViewUtils.OnApplyWindowInsetsListener {
        public C6820a() {
        }
    ...
    /* renamed from: d */
    public final void m45648d(Context context) {
    ...
    /* renamed from: e */
    public final void m45647e() {
        ViewUtils.doOnApplyWindowInsets(this, new C6820a());
    }

    /* renamed from: f */
    public final int m45646f(int i) {
    ...
    public BottomNavigationView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
        ...
        if (obtainTintedStyledAttributes.getBoolean(R.styleable.BottomNavigationView_compatShadowEnabled, true) && m45645g()) {
            m45648d(context2);
        }
