...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.fragment.true_company.OnePostpaidMaterialCodeFragment$setObserve$1$2 */
/* loaded from: classes10.dex */
public final class OnePostpaidMaterialCodeFragment$setObserve$1$2 extends Lambda implements Function1<StatusResource, Unit> {
    final /* synthetic */ OnePostpaidMaterialCodeFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidMaterialCodeFragment$setObserve$1$2(OnePostpaidMaterialCodeFragment onePostpaidMaterialCodeFragment) {
        super(1);
    ...
    public final void invoke2(StatusResource statusResource) {
        this.this$0.m11979s(statusResource);
    }
}