...
public class Blake2bDigest implements ExtendedDigest {
    ...
    /* renamed from: t0 */
    private long f74872t0;

    /* renamed from: t1 */
    private long f74873t1;
    ...
    /* renamed from: G */
    private void m24729G(long j, long j2, int i, int i2, int i3, int i4) {
    ...
    private void compress(byte[] bArr, int i) {
        ...
        for (int i4 = 0; i4 < ROUNDS; i4++) {
            ...
            byte[] bArr3 = bArr2[i4];
            m24729G(jArr[bArr3[0]], jArr[bArr3[1]], 0, 4, 8, 12);
            byte[] bArr4 = bArr2[i4];
            m24729G(jArr[bArr4[2]], jArr[bArr4[3]], 1, 5, 9, 13);
            byte[] bArr5 = bArr2[i4];
            m24729G(jArr[bArr5[4]], jArr[bArr5[5]], 2, 6, 10, 14);
            byte[] bArr6 = bArr2[i4];
            m24729G(jArr[bArr6[6]], jArr[bArr6[7]], 3, 7, 11, 15);
            byte[] bArr7 = bArr2[i4];
            m24729G(jArr[bArr7[8]], jArr[bArr7[9]], 0, 5, 10, 15);
            byte[] bArr8 = bArr2[i4];
            m24729G(jArr[bArr8[10]], jArr[bArr8[11]], 1, 6, 11, 12);
            byte[] bArr9 = bArr2[i4];
            m24729G(jArr[bArr9[12]], jArr[bArr9[13]], 2, 7, 8, 13);
            byte[] bArr10 = bArr2[i4];
            m24729G(jArr[bArr10[14]], jArr[bArr10[15]], 3, 4, 9, 14);
        }
        while (true) {
    ...
    private void init() {
        if (this.chainValue == null) {
            ...
            long j = jArr[4];
            long[] jArr2 = {jArr[0] ^ ((this.digestLength | (this.keyLength << 8)) | 16842752), jArr[1], jArr[2], jArr[3], j, jArr[5]};
            byte[] bArr = this.salt;
            if (bArr != null) {
    ...
    private void initializeInternalState() {
        ...
        long[] jArr3 = this.internalState;
        jArr3[12] = this.f74872t0 ^ jArr2[4];
        jArr3[13] = this.f74873t1 ^ jArr2[5];
        jArr3[14] = this.f74871f0 ^ jArr2[6];
        jArr3[15] = jArr2[7];
    }
    ...
    public Blake2bDigest(Blake2bDigest blake2bDigest) {
        ...
        this.f74872t0 = blake2bDigest.f74872t0;
        this.f74873t1 = blake2bDigest.f74873t1;
        this.f74871f0 = blake2bDigest.f74871f0;
    }
