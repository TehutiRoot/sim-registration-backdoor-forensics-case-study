...
public final class FocusInvalidationManager {
    ...
    /* renamed from: e */
    public final Function0 f29003e;
    ...
    public FocusInvalidationManager(@NotNull Function1<? super Function0<Unit>, Unit> onRequestApplyChangesListener) {
        ...
        this.f28999a = onRequestApplyChangesListener;
        this.f29000b = new LinkedHashSet();
        this.f29001c = new LinkedHashSet();
        this.f29002d = new LinkedHashSet();
        this.f29003e = new FocusInvalidationManager$invalidateNodes$1(this);
    }

    /* renamed from: a */
    public final void m59777a(Set set, Object obj) {
        if (set.add(obj) && this.f29000b.size() + this.f29001c.size() + this.f29002d.size() == 1) {
            this.f28999a.invoke(this.f29003e);
        }
    }

    public final void scheduleInvalidation(@NotNull FocusTargetNode node) {
        Intrinsics.checkNotNullParameter(node, "node");
        m59777a(this.f29000b, node);
    }

    public final void scheduleInvalidation(@NotNull FocusEventModifierNode node) {
        Intrinsics.checkNotNullParameter(node, "node");
        m59777a(this.f29001c, node);
    }

    public final void scheduleInvalidation(@NotNull FocusPropertiesModifierNode node) {
        Intrinsics.checkNotNullParameter(node, "node");
        m59777a(this.f29002d, node);
    }
}