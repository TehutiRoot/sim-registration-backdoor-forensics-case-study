...
public final class DoubleCounterMetricInstrument extends AbstractC17959Ki1 {
    public DoubleCounterMetricInstrument(int i, String str, String str2, String str3, List<String> list, List<String> list2, boolean z) {
