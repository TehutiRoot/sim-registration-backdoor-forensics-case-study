...
public class GMSSKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    private AsymmetricCipherKeyPair genKeyPair() {
        ...
        while (true) {
            ...
            treehashArr[i5] = new Treehash[i7 - this.f75563K[i5]];
            if (i5 > 0) {
                int i8 = i5 - 1;
                bArr2[i8] = (byte[][]) Array.newInstance(cls, i7, this.mdLength);
                treehashArr2[i8] = new Treehash[this.heightOfTrees[i5] - this.f75563K[i5]];
            }
        ...
        byte[][] bArr4 = (byte[][]) Array.newInstance(cls2, this.numLayer - 1, this.mdLength);
        byte[][] bArr5 = (byte[][]) Array.newInstance(cls2, this.numLayer, this.mdLength);
        int i9 = 0;
        while (true) {
            i2 = this.numLayer;
            if (i9 >= i2) {
        ...
        this.currentRootSigs = (byte[][]) Array.newInstance(Byte.TYPE, i2 - 1, this.mdLength);
        int i10 = this.numLayer - 1;
        while (i10 >= 0) {
            GMSSRootCalc generateCurrentAuthpathAndRoot = i10 == this.numLayer - i4 ? generateCurrentAuthpathAndRoot(null, vectorArr[i10], bArr5[i10], i10) : generateCurrentAuthpathAndRoot(bArr3[i10 + 1], vectorArr[i10], bArr5[i10], i10);
            int i11 = 0;
    ...
    private GMSSRootCalc generateCurrentAuthpathAndRoot(byte[] bArr, Vector vector, byte[] bArr2, int i) {
        ...
        GMSSRootCalc gMSSRootCalc = new GMSSRootCalc(this.heightOfTrees[i], this.f75563K[i], this.digestProvider);
    ...
    public void initialize(KeyGenerationParameters keyGenerationParameters) {
        ...
        this.f75563K = this.gmssPS.getK();
        int[] iArr = {this.numLayer, this.mdLength};
        Class cls = Byte.TYPE;
        this.currentSeeds = (byte[][]) Array.newInstance(cls, iArr);
        this.nextNextSeeds = (byte[][]) Array.newInstance(cls, this.numLayer - 1, this.mdLength);
