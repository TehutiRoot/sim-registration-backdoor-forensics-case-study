...
public class HttpClientHandler<Q, P, C> extends AbstractC0835M {

    /* renamed from: b */
    public final TextFormat.Setter f63537b;

    /* renamed from: c */
    public final TextFormat f63538c;

    /* renamed from: d */
    public final Tracer f63539d;

    /* renamed from: e */
    public final StatsRecorder f63540e;

    /* renamed from: f */
    public final Tagger f63541f;
    ...
    public HttpClientHandler(Tracer tracer, HttpExtractor<Q, P> httpExtractor, TextFormat textFormat, TextFormat.Setter<C> setter) {
        ...
        this.f63537b = setter;
        this.f63538c = textFormat;
        this.f63539d = tracer;
        this.f63540e = Stats.getStatsRecorder();
        this.f63541f = Tags.getTagger();
    }

    /* renamed from: g */
    public final void m30606g(HttpRequestContext httpRequestContext, Object obj, int i) {
        String method;
        String host;
        String num;
        ...
        if (obj == null) {
            ...
            method = this.f3782a.getMethod(obj);
        }
        if (obj == null) {
            host = "null_request";
        } else {
            host = this.f3782a.getHost(obj);
        }
        TagContextBuilder builder = this.f63541f.toBuilder(httpRequestContext.f63549g);
        ...
        this.f63540e.newMeasureMap().put(HttpMeasureConstants.HTTP_CLIENT_ROUNDTRIP_LATENCY, millis).put(HttpMeasureConstants.HTTP_CLIENT_SENT_BYTES, httpRequestContext.f63545c.get()).put(HttpMeasureConstants.HTTP_CLIENT_RECEIVED_BYTES, httpRequestContext.f63546d.get()).record(put2.put(tagKey3, TagValue.create(num), tagMetadata).build());
    }
    ...
    public void handleEnd(HttpRequestContext httpRequestContext, @Nullable Q q, @Nullable P p, @Nullable Throwable th2) {
        ...
        m30606g(httpRequestContext, q, statusCode);
    ...
    public HttpRequestContext handleStart(@Nullable Span span, C c, Q q) {
        ...
        if (span == null) {
            span = this.f63539d.getCurrentSpan();
        }
        Span startSpan = this.f63539d.spanBuilderWithExplicitParent(m67461c(q, this.f3782a), span).setSpanKind(Span.Kind.CLIENT).startSpan();
        ...
        if (!context.equals(SpanContext.INVALID)) {
            this.f63538c.inject(context, c, this.f63537b);
        }
        return m67462b(startSpan, this.f63541f.getCurrentTagContext());
    }
}