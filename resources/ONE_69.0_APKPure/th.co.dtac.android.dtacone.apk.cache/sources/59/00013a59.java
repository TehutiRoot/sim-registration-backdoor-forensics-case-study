...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.pre2post.fragment.OnePre2PostSearchPackageFragment$setupObserve$1$4 */
/* loaded from: classes10.dex */
public final class OnePre2PostSearchPackageFragment$setupObserve$1$4 extends Lambda implements Function1<Resource<? extends ErrorCollection>, Unit> {
    final /* synthetic */ OnePre2PostSearchPackageFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePre2PostSearchPackageFragment$setupObserve$1$4(OnePre2PostSearchPackageFragment onePre2PostSearchPackageFragment) {
        super(1);
    ...
    public final void invoke2(Resource<ErrorCollection> resource) {
        ...
        onePre2PostSearchPackageFragment.m11246G(new OnePostpaidSearchPackage(new ArrayList(), new OnePostpaidSearchPackagePaginate(0, 0), data.getDescription()));
    }
}