...
public class SleepClassifyEvent extends AbstractSafeParcelable {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (this.f47798a == sleepClassifyEvent.f47798a && this.f47799b == sleepClassifyEvent.f47799b) {
            return true;
        }
        return false;
    }
    ...
    public long getTimestampMillis() {
        return this.f47798a * 1000;
    }

    public int hashCode() {
        return Objects.hashCode(Integer.valueOf(this.f47798a), Integer.valueOf(this.f47799b));
    }
    ...
    public void writeToParcel(@NonNull Parcel parcel, int i) {
        ...
        SafeParcelWriter.writeInt(parcel, 1, this.f47798a);
        ...
        SafeParcelWriter.writeInt(parcel, 5, this.f47802e);
        SafeParcelWriter.writeInt(parcel, 6, this.f47803f);
        SafeParcelWriter.writeInt(parcel, 7, this.f47804g);
        SafeParcelWriter.writeBoolean(parcel, 8, this.f47805h);
        SafeParcelWriter.writeInt(parcel, 9, this.f47806i);
