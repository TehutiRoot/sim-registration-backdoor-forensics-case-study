...
public abstract class DispatchedTask<T> extends Task {
    ...
    public final void handleFatalException(@Nullable Throwable th2, @Nullable Throwable th3) {
        ...
        if (th2 != null && th3 != null) {
            AbstractC10223fT.addSuppressed(th2, th3);
        }
        if (th2 == null) {
            th2 = th3;
        }
    ...
    public final void run() {
        ...
        try {
            ...
            if (job != null && !job.isActive()) {
                ...
                continuation.resumeWith(Result.m74271constructorimpl(ResultKt.createFailure(cancellationException)));
            } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                Result.Companion companion2 = Result.Companion;
                continuation.resumeWith(Result.m74271constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
            } else {
                Result.Companion companion3 = Result.Companion;
                continuation.resumeWith(Result.m74271constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(takeState$kotlinx_coroutines_core)));
            }
            ...
            try {
                ...
                m74271constructorimpl2 = Result.m74271constructorimpl(Unit.INSTANCE);
            } catch (Throwable th2) {
                Result.Companion companion4 = Result.Companion;
                m74271constructorimpl2 = Result.m74271constructorimpl(ResultKt.createFailure(th2));
            }
            handleFatalException(null, Result.m74274exceptionOrNullimpl(m74271constructorimpl2));
        } catch (Throwable th3) {
            try {
                Result.Companion companion5 = Result.Companion;
                taskContext.afterTask();
                m74271constructorimpl = Result.m74271constructorimpl(Unit.INSTANCE);
            } catch (Throwable th4) {
                Result.Companion companion6 = Result.Companion;
                m74271constructorimpl = Result.m74271constructorimpl(ResultKt.createFailure(th4));
            }
            handleFatalException(th3, Result.m74274exceptionOrNullimpl(m74271constructorimpl));
        }
    }
