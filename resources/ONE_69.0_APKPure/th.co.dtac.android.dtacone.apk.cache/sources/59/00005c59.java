...
public final class C3412x6408c734 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    /* loaded from: classes2.dex */
    public static final class C34131 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
        public static final C34131 INSTANCE = new C34131();
    ...
    /* loaded from: classes2.dex */
    public static final class C34142 extends Lambda implements Function1<IntSize, Unit> {
        final /* synthetic */ PopupLayout $this_apply;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C34142(PopupLayout popupLayout) {
            super(1);
        ...
        public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
            m71002invokeozmzZPI(intSize.m74006unboximpl());
            return Unit.INSTANCE;
        }

        /* renamed from: invoke-ozmzZPI  reason: not valid java name */
        public final void m71002invokeozmzZPI(long j) {
            this.$this_apply.m71004setPopupContentSizefhxjrPA(IntSize.m73994boximpl(j));
    ...
    /* loaded from: classes2.dex */
    public static final class C34153 extends Lambda implements Function2<Composer, Integer, Unit> {
        final /* synthetic */ State<Function2<Composer, Integer, Unit>> $currentContent$delegate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C34153(State<? extends Function2<? super Composer, ? super Integer, Unit>> state) {
            super(2);
        ...
        public final void invoke(@Nullable Composer composer, int i) {
            ...
            m60354a = ExposedDropdownMenuPopupKt.m60354a(this.$currentContent$delegate);
            m60354a.invoke(composer, 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public C3412x6408c734(PopupLayout popupLayout, State<? extends Function2<? super Composer, ? super Integer, Unit>> state) {
        super(2);
        this.$this_apply = popupLayout;
        this.$currentContent$delegate = state;
    }
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        Modifier alpha = AlphaKt.alpha(OnRemeasuredModifierKt.onSizeChanged(SemanticsModifierKt.semantics$default(Modifier.Companion, false, C34131.INSTANCE, 1, null), new C34142(this.$this_apply)), this.$this_apply.getCanCalculatePosition() ? 1.0f : 0.0f);
        ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer, 588819933, true, new C34153(this.$currentContent$delegate));
