...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_prepaid_reregist.MrtrPrepaidReregistValidateCardViewModel$validateSmartCard$2 */
/* loaded from: classes9.dex */
public final class MrtrPrepaidReregistValidateCardViewModel$validateSmartCard$2 extends Lambda implements Function1<ValidateCardResponse, ValidateCardResponse> {
    final /* synthetic */ BitmapCollection $bitmap;
    final /* synthetic */ MrtrPrepaidReregistValidateCardViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrPrepaidReregistValidateCardViewModel$validateSmartCard$2(MrtrPrepaidReregistValidateCardViewModel mrtrPrepaidReregistValidateCardViewModel, BitmapCollection bitmapCollection) {
        super(1);
    ...
    public final ValidateCardResponse invoke(@NotNull ValidateCardResponse response) {
        ...
        bitmapUtil = this.this$0.f106838d;
