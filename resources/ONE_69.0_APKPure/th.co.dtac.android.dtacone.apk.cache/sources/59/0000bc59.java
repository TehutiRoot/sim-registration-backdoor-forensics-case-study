...
public class hasAlgorithm implements setDarkTextColor.valueOf {
    private final setDarkTextColor valueOf;

    public hasAlgorithm(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.setAcsTransactionID(this.valueOf);
    }
}