...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.activateSim.viewModel.OneActivateSimViewModel$checkActivateSimTrueCompany$2 */
/* loaded from: classes10.dex */
public final class OneActivateSimViewModel$checkActivateSimTrueCompany$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ OneActivateSimViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneActivateSimViewModel$checkActivateSimTrueCompany$2(OneActivateSimViewModel oneActivateSimViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable throwable) {
        ...
        oneErrorService.handleExceptionNopopup(throwable, new OneErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.view.appOne.activateSim.viewModel.OneActivateSimViewModel$checkActivateSimTrueCompany$2.1
            ...
            public void handle(@Nullable Throwable th2) {
                ...
                m16113m = OneActivateSimViewModel.this.m16113m();
                Resource.Companion companion = Resource.Companion;
                m16113m.setValue(Resource.Companion.error$default(companion, "", null, null, 4, null));
