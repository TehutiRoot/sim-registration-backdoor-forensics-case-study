...
public class PrefixFileFilter extends AbstractFileFilter implements Serializable {
    ...
    /* renamed from: a */
    public static /* synthetic */ boolean m25434a(PrefixFileFilter prefixFileFilter, String str, String str2) {
    ...
    public FileVisitResult accept(Path path, BasicFileAttributes basicFileAttributes) {
        return toFileVisitResult(accept((File) PathUtils.getFileName(path, new Function() { // from class: jn1
    ...
    private boolean accept(final String str) {
        ...
        anyMatch = of.anyMatch(new Predicate() { // from class: in1
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return PrefixFileFilter.m25434a(PrefixFileFilter.this, str, (String) obj);
            }
        });
        return anyMatch;
    }
