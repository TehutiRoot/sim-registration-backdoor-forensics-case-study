...
public final class LayoutKt$materializerOf$1 extends Lambda implements Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> {
    ...
    public /* bridge */ /* synthetic */ Unit invoke(SkippableUpdater<ComposeUiNode> skippableUpdater, Composer composer, Integer num) {
        m73007invokeDeg8D_g(skippableUpdater.m71575unboximpl(), composer, num.intValue());
        return Unit.INSTANCE;
    }

    @Composable
    /* renamed from: invoke-Deg8D_g  reason: not valid java name */
    public final void m73007invokeDeg8D_g(@NotNull Composer composer, @Nullable Composer composer2, int i) {
        ...
        Updater.m71584setimpl(m71577constructorimpl, materializeModifier, companion.getSetModifier());
