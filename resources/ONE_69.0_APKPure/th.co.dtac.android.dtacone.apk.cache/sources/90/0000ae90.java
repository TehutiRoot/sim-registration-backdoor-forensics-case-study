...
public final class ApiService {
    ...
    /* renamed from: b */
    public static final Logger f54577b;

    /* renamed from: a */
    public final AuthenticatedHttpClient f54578a;

    @Metadata(m29143d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u0016\u0010\u0005\u001a\n \u0007*\u0004\u0018\u00010\u00060\u0006X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\b"}, m29142d2 = {"Lcom/google/firebase/appdistribution/gradle/ApiService$Companion;", "", "()V", "MAX_TESTER_EMAILS", "", "logger", "Lorg/gradle/api/logging/Logger;", "kotlin.jvm.PlatformType", "appdistribution-gradle"}, m29141k = 1, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* loaded from: classes4.dex */
    ...
    static {
        ...
        Companion = companion;
        f54577b = Logging.getLogger(companion.getClass());
    }

    public ApiService(@NotNull AuthenticatedHttpClient httpClient) {
        Intrinsics.checkNotNullParameter(httpClient, "httpClient");
        this.f54578a = httpClient;
    }

    /* renamed from: d */
    public static final void m39266d(JsonArray jsonArray, String string) {
    ...
    /* renamed from: b */
    public final ByteArrayContent m39268b(JsonElement jsonElement) {
    ...
    public final boolean batchAddTesters(long j, @NotNull Collection<String> emails) {
        ...
        if (emails.size() <= 1000) {
            f54577b.info("Adding {} testers to project {}...", Integer.valueOf(emails.size()), Long.valueOf(j));
            return m39265e(AuthenticatedHttpClient.newPostRequest$default(this.f54578a, ApiEndpoints.INSTANCE.getBatchAddTestersEndpoint(j), null, 2, null).setContent(m39268b(buildTesterEmailsJson(emails))).execute().isSuccessStatusCode(), "Testers added successfully [" + execute.getStatusCode() + AbstractJsonLexerKt.END_LIST, "Unable to add testers. Response code: " + execute.getStatusCode());
        }
    ...
    public final boolean batchRemoveTesters(long j, @NotNull Collection<String> emails) {
        ...
        Intrinsics.checkNotNullParameter(emails, "emails");
        if (emails.size() <= 1000) {
            Logger logger = f54577b;
            logger.info("Removing {} testers from project {}...", Integer.valueOf(emails.size()), Long.valueOf(j));
            HttpResponse execute = AuthenticatedHttpClient.newPostRequest$default(this.f54578a, ApiEndpoints.INSTANCE.getBatchRemoveTestersEndpoint(j), null, 2, null).setContent(m39268b(buildTesterEmailsJson(emails))).execute();
    ...
    public final JsonObject buildDistributeReleaseJson(@NotNull String releaseName, @NotNull List<String> emails, @NotNull List<String> groupIds) {
        ...
        JsonObject jsonObject = new JsonObject();
        jsonObject.add("name", new JsonPrimitive(releaseName));
        jsonObject.add("testerEmails", m39267c(emails));
        jsonObject.add("groupAliases", m39267c(groupIds));
        return jsonObject;
    }
    ...
    public final JsonObject buildTesterEmailsJson(@NotNull Collection<String> emails) {
        Intrinsics.checkNotNullParameter(emails, "emails");
        JsonObject jsonObject = new JsonObject();
        jsonObject.add("emails", m39267c(emails));
        return jsonObject;
    }

    /* renamed from: c */
    public final JsonArray m39267c(Collection collection) {
        final JsonArray jsonArray = new JsonArray();
        collection.forEach(new Consumer() { // from class: j5
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                ApiService.m39266d(JsonArray.this, (String) obj);
            }
        });
        return jsonArray;
    }
    ...
    public final boolean createReleaseNotes(@NotNull String releaseName, @NotNull String releaseNotes) {
        ...
        Intrinsics.checkNotNullExpressionValue(bytes, "getBytes(...)");
        return m39265e(this.f54578a.newPatchRequest(ApiEndpoints.INSTANCE.getCreateReleaseNotesEndpoint(releaseName), new ByteArrayContent("application/json", bytes)).execute().isSuccessStatusCode(), "Added release notes successfully " + execute.getStatusCode(), "Unable to add release notes. Response code: " + execute.getStatusCode());
    }
    ...
    public final boolean distributeRelease(@NotNull String releaseName, @NotNull List<String> emails, @NotNull List<String> groupIds) {
        ...
        Intrinsics.checkNotNullParameter(emails, "emails");
        Intrinsics.checkNotNullParameter(groupIds, "groupIds");
        return m39265e(this.f54578a.newPostRequest(ApiEndpoints.INSTANCE.getDistributeReleaseEndpoint(releaseName), m39268b(buildDistributeReleaseJson(releaseName, emails, groupIds))).execute().isSuccessStatusCode(), "Added testers/groups successfully " + execute.getStatusCode(), "Unable to add testers/groups. Response code: " + execute.getStatusCode());
    }

    /* renamed from: e */
    public final boolean m39265e(boolean z, String str, String str2) {
        if (z) {
            f54577b.info(str);
            return true;
        }
    ...
    public final AabInfo getAabInfo(@NotNull String appName) {
        ...
        Object fromJson = new Gson().fromJson(this.f54578a.newGetRequest(ApiEndpoints.INSTANCE.getAabInfo(appName)).execute().parseAsString(), (Class<Object>) AabInfo.class);
    ...
    public final ReleaseTest getReleaseTest(@NotNull String releaseTestName) {
        ...
        HttpResponse execute = this.f54578a.newGetRequest(ApiEndpoints.INSTANCE.getReleaseTestEndpoint(releaseTestName)).execute();
        if (execute.isSuccessStatusCode()) {
            return (ReleaseTest) new Gson().fromJson(execute.parseAsString(), (Class<Object>) ReleaseTest.class);
        }
        f54577b.warn("Unable to retrieve test. Response code: {}", Integer.valueOf(execute.getStatusCode()));
        return null;
    }
    ...
    public final UploadStatusResponse getUploadStatus(@NotNull String operationName, @NotNull BinaryType binaryType) {
        ...
        try {
            Object fromJson = new Gson().fromJson(this.f54578a.newGetRequest(ApiEndpoints.INSTANCE.getUploadStatusEndpoint(operationName)).execute().parseAsString(), (Class<Object>) UploadStatusResponse.class);
    ...
    public final ReleaseTest testRelease(@NotNull String releaseName, @NotNull List<TestDevice> testDevices, @Nullable LoginCredential loginCredential, @Nullable String str) {
        ...
        try {
            AuthenticatedHttpClient authenticatedHttpClient = this.f54578a;
            ...
            HttpResponse execute = authenticatedHttpClient.newPostRequest(createReleaseTestEndpoint, m39268b(jsonTree)).execute();
            if (execute.isSuccessStatusCode()) {
                if (str != null) {
                ...
                f54577b.lifecycle("{} successfully [{}]. Note: This feature is in beta.", new Object[]{str2, Integer.valueOf(execute.getStatusCode())});
                return (ReleaseTest) new Gson().fromJson(execute.parseAsString(), (Class<Object>) ReleaseTest.class);
            }
            f54577b.warn("Unable to start test. Response code: {}", Integer.valueOf(execute.getStatusCode()));
            return null;
        } catch (HttpResponseException e) {
