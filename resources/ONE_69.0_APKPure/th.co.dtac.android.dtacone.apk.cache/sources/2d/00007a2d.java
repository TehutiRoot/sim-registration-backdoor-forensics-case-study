...
public class ShutdownHookAction extends Action {
    ...
    /* renamed from: c */
    public ShutdownHookBase f39785c;
    ...
    public void begin(InterpretationContext interpretationContext, String str, Attributes attributes) throws ActionException {
        ...
        try {
            ...
            this.f39785c = shutdownHookBase;
            shutdownHookBase.setContext(this.context);
            interpretationContext.pushObject(this.f39785c);
        } catch (Exception e) {
            this.f39786d = true;
    ...
    public void end(InterpretationContext interpretationContext, String str) throws ActionException {
        ...
        if (interpretationContext.peekObject() != this.f39785c) {
            addWarn("The object at the of the stack is not the hook pushed earlier.");
            return;
        }
        interpretationContext.popObject();
        ShutdownHookBase shutdownHookBase = this.f39785c;
        Thread thread = new Thread(shutdownHookBase, "Logback shutdown hook [" + this.context.getName() + "]");
