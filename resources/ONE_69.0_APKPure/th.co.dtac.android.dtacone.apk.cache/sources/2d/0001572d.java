...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.home.GetProfileImageViewModel$deleteProfileImage$2 */
/* loaded from: classes9.dex */
public final class GetProfileImageViewModel$deleteProfileImage$2 extends Lambda implements Function1<StatusResponse, Unit> {
    final /* synthetic */ GetProfileImageViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GetProfileImageViewModel$deleteProfileImage$2(GetProfileImageViewModel getProfileImageViewModel) {
        super(1);
    ...
    public final void invoke2(StatusResponse statusResponse) {
        MutableLiveData m2606x;
        m2606x = this.this$0.m2606x();
        m2606x.setValue(Resource.Companion.success(null));
    }
}