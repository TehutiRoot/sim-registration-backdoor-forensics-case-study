...
public enum FileSystem {
    ...
    FileSystem(int i, boolean z, boolean z2, int i2, int i3, int[] iArr, String[] strArr, boolean z3, boolean z4, char c) {
        ...
        this.nameSeparatorOther = FilenameUtils.m25541d(c);
    }

    /* renamed from: a */
    public static /* synthetic */ int m25613a(FileSystem fileSystem, char c, int i) {
        return fileSystem.lambda$toLegalFileName$0(c, i);
    }

    /* renamed from: b */
    public static /* synthetic */ boolean m25612b(FileSystem fileSystem, int i) {
    ...
    public boolean isLegalFileName(CharSequence charSequence) {
        ...
        noneMatch = chars.noneMatch(new IntPredicate() { // from class: vX
            @Override // java.util.function.IntPredicate
            public final boolean test(int i) {
                return FileSystem.m25612b(FileSystem.this, i);
            }
        });
        return noneMatch;
    }
    ...
    public String toLegalFileName(String str, final char c) {
        ...
        chars = str.chars();
        map = chars.map(new IntUnaryOperator() { // from class: uX
            @Override // java.util.function.IntUnaryOperator
            public final int applyAsInt(int i2) {
                return FileSystem.m25613a(FileSystem.this, c, i2);
            }
        });
        array = map.toArray();
