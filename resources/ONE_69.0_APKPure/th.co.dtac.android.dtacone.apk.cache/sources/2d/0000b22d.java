...
public final class GaugeMetric extends GeneratedMessageLite<GaugeMetric, Builder> implements GaugeMetricOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<GaugeMetric, Builder> implements GaugeMetricOrBuilder {
        ...
        public Builder mergeGaugeMetadata(GaugeMetadata gaugeMetadata) {
            copyOnWrite();
            ((GaugeMetric) this.instance).m38016g0(gaugeMetadata);
            return this;
        }

        public Builder removeAndroidMemoryReadings(int i) {
            copyOnWrite();
            ((GaugeMetric) this.instance).m38015h0(i);
            return this;
        }

        public Builder removeCpuMetricReadings(int i) {
            copyOnWrite();
            ((GaugeMetric) this.instance).m38014i0(i);
            return this;
        }

        public Builder setAndroidMemoryReadings(int i, AndroidMemoryReading androidMemoryReading) {
            copyOnWrite();
            ((GaugeMetric) this.instance).m38013j0(i, androidMemoryReading);
            return this;
        }

        public Builder setCpuMetricReadings(int i, CpuMetricReading cpuMetricReading) {
            copyOnWrite();
            ((GaugeMetric) this.instance).m38012k0(i, cpuMetricReading);
            return this;
        }

        public Builder setGaugeMetadata(GaugeMetadata gaugeMetadata) {
            copyOnWrite();
            ((GaugeMetric) this.instance).m38011l0(gaugeMetadata);
            return this;
        }

        public Builder setSessionId(String str) {
            copyOnWrite();
            ((GaugeMetric) this.instance).m38010m0(str);
            return this;
        }

        public Builder setSessionIdBytes(ByteString byteString) {
            copyOnWrite();
            ((GaugeMetric) this.instance).m38009n0(byteString);
            return this;
        }
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C8585a {
        ...
        static {
            ...
            try {
                f56308a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f56308a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f56308a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f56308a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f56308a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f56308a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* renamed from: U */
    public final void m38028U(Iterable iterable) {
        m38018e0();
        AbstractMessageLite.addAll(iterable, (List) this.androidMemoryReadings_);
    }

    /* renamed from: V */
    public final void m38027V(Iterable iterable) {
        m38017f0();
        AbstractMessageLite.addAll(iterable, (List) this.cpuMetricReadings_);
    }

    /* renamed from: W */
    public final void m38026W(int i, AndroidMemoryReading androidMemoryReading) {
    ...
    /* renamed from: X */
    public final void m38025X(AndroidMemoryReading androidMemoryReading) {
        androidMemoryReading.getClass();
        m38018e0();
    ...
    /* renamed from: Y */
    public final void m38024Y(int i, CpuMetricReading cpuMetricReading) {
    ...
    /* renamed from: Z */
    public final void m38023Z(CpuMetricReading cpuMetricReading) {
        cpuMetricReading.getClass();
        m38017f0();
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C8585a.f56308a[methodToInvoke.ordinal()]) {
            case 1:
    ...
    /* renamed from: g0 */
    public final void m38016g0(GaugeMetadata gaugeMetadata) {
    ...
    /* renamed from: h0 */
    public final void m38015h0(int i) {
        m38018e0();
    ...
    /* renamed from: i0 */
    public final void m38014i0(int i) {
        m38017f0();
        this.cpuMetricReadings_.remove(i);
    }

    /* renamed from: j0 */
    public final void m38013j0(int i, AndroidMemoryReading androidMemoryReading) {
        androidMemoryReading.getClass();
        m38018e0();
    ...
    /* renamed from: k0 */
    public final void m38012k0(int i, CpuMetricReading cpuMetricReading) {
        cpuMetricReading.getClass();
        m38017f0();
    ...
    /* renamed from: l0 */
    public final void m38011l0(GaugeMetadata gaugeMetadata) {
        gaugeMetadata.getClass();
        this.gaugeMetadata_ = gaugeMetadata;
        this.bitField0_ |= 2;
    }
    ...
    /* renamed from: m0 */
    public final void m38010m0(String str) {
        str.getClass();
        this.bitField0_ |= 1;
        this.sessionId_ = str;
    }
    ...
    /* renamed from: n0 */
    public final void m38009n0(ByteString byteString) {
