...
public abstract class AbstractByteArrayOutputStream extends OutputStream {
    ...
    /* renamed from: a */
    public final List f73622a = new ArrayList();

    /* renamed from: e */
    public boolean f73626e = true;
    ...
    public void needNewBuffer(int i) {
        if (this.f73623b < this.f73622a.size() - 1) {
            this.f73624c += this.f73625d.length;
            int i2 = this.f73623b + 1;
            this.f73623b = i2;
            this.f73625d = (byte[]) this.f73622a.get(i2);
            return;
        }
        byte[] bArr = this.f73625d;
        if (bArr == null) {
            this.f73624c = 0;
        } else {
            i = Math.max(bArr.length << 1, i - this.f73624c);
            this.f73624c += this.f73625d.length;
        }
        this.f73623b++;
        byte[] byteArray = IOUtils.byteArray(i);
        this.f73625d = byteArray;
        this.f73622a.add(byteArray);
    }
    ...
    public void resetImpl() {
        ...
        this.f73623b = 0;
        if (this.f73626e) {
            this.f73625d = (byte[]) this.f73622a.get(0);
            return;
        }
        this.f73625d = null;
        int length = ((byte[]) this.f73622a.get(0)).length;
        this.f73622a.clear();
    ...
    public <T extends InputStream> InputStream toInputStream(InputStreamConstructor<T> inputStreamConstructor) {
        ...
        ArrayList arrayList = new ArrayList(this.f73622a.size());
        for (byte[] bArr : this.f73622a) {
            int min = Math.min(bArr.length, i);
    ...
    public void writeImpl(byte[] bArr, int i, int i2) {
        int i3 = this.count;
        int i4 = i3 + i2;
        int i5 = i3 - this.f73624c;
        int i6 = i2;
        while (i6 > 0) {
            int min = Math.min(i6, this.f73625d.length - i5);
            System.arraycopy(bArr, (i + i2) - i6, this.f73625d, i5, min);
            i6 -= min;
            if (i6 > 0) {
                needNewBuffer(i4);
                i5 = 0;
    ...
    public int writeImpl(InputStream inputStream) throws IOException {
        ...
        while (read != -1) {
            ...
            i += read;
            this.count += read;
            byte[] bArr2 = this.f73625d;
            if (i == bArr2.length) {
                needNewBuffer(bArr2.length);
                i = 0;
            }
            byte[] bArr3 = this.f73625d;
    ...
    public void writeImpl(int i) {
        int i2 = this.count;
        int i3 = i2 - this.f73624c;
        if (i3 == this.f73625d.length) {
            needNewBuffer(i2 + 1);
            i3 = 0;
        }
        this.f73625d[i3] = (byte) i;
        this.count++;
    }
}