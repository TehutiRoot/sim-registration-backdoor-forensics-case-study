...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.rectify.fragment.OneRectifyConfirmFragment$initView$1$3 */
/* loaded from: classes10.dex */
public final class OneRectifyConfirmFragment$initView$1$3 extends Lambda implements Function1<StatusResource, Unit> {
    final /* synthetic */ OneRectifyConfirmFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneRectifyConfirmFragment$initView$1$3(OneRectifyConfirmFragment oneRectifyConfirmFragment) {
        super(1);
    ...
    public final void invoke2(StatusResource statusResource) {
        this.this$0.m10503p(statusResource);
    }
}