...
public class setHeadingDarkTextColor implements setDarkTextColor.valueOf {
    private final setDarkTextColor valueOf;

    public setHeadingDarkTextColor(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.close(this.valueOf);
    }
}