...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.fragment.OneMnpScanSimFragment$setupViewModel$1$1 */
/* loaded from: classes10.dex */
public final class OneMnpScanSimFragment$setupViewModel$1$1 extends Lambda implements Function1<Resource<? extends MnpCheckSimInfoResponse>, Unit> {
    final /* synthetic */ OneMnpScanSimFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.fragment.OneMnpScanSimFragment$setupViewModel$1$1$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneMnpScanSimFragment$setupViewModel$1$1(OneMnpScanSimFragment oneMnpScanSimFragment) {
        super(1);
    ...
    public final void invoke2(Resource<MnpCheckSimInfoResponse> resource) {
        ...
        OneMnpScanSimFragment oneMnpScanSimFragment = this.this$0;
        int i = WhenMappings.$EnumSwitchMapping$0[resourceContentIfNotHandled.getStatus().ordinal()];
        if (i == 1) {
            oneMnpScanSimFragment.showLoading();
        } else if (i != 2) {
            if (i != 3) {
                return;
            }
            oneMnpScanSimFragment.dismissLoading();
        } else {
            oneMnpScanSimFragment.dismissLoading();
            if (resourceContentIfNotHandled.getData() != null) {
                oneMnpScanSimFragment.gotoNext();
            }
        }
    }
}