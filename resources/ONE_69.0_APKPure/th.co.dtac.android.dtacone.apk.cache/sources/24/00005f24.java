...
@Metadata(m29143d1 = {"\u0000\u001e\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\u001a\u001a\u0010\u0000\u001a\u00020\u0001*\u00020\u00022\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004H\u0001\u001a\u0014\u0010\u0006\u001a\u00020\u0001*\u00020\u00022\u0006\u0010\u0007\u001a\u00020\bH\u0001¨\u0006\t"}, m29142d2 = {"performAutofill", "", "Landroidx/compose/ui/autofill/AndroidAutofill;", "values", "Landroid/util/SparseArray;", "Landroid/view/autofill/AutofillValue;", "populateViewStructure", "root", "Landroid/view/ViewStructure;", "ui_release"}, m29141k = 2, m29140mv = {1, 8, 0}, m29138xi = 48)
...
public final class AndroidAutofill_androidKt {
    ...
    public static final void performAutofill(@NotNull AndroidAutofill androidAutofill, @NotNull SparseArray<AutofillValue> values) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            AutofillValue value = AbstractC10032d3.m31942a(values.get(keyAt));
        ...
        for (Map.Entry<Integer, AutofillNode> entry : androidAutofill.getAutofillTree().getChildren().entrySet()) {
            ...
            if (newChild != null) {
                ...
                if (boundingBox == null) {
                    ...
                    int roundToInt = AbstractC22237sr0.roundToInt(boundingBox.getLeft());
                    int roundToInt2 = AbstractC22237sr0.roundToInt(boundingBox.getTop());
                    int roundToInt3 = AbstractC22237sr0.roundToInt(boundingBox.getRight());
                    AutofillApi23Helper.INSTANCE.setDimens(newChild, roundToInt, roundToInt2, 0, 0, roundToInt3 - roundToInt, AbstractC22237sr0.roundToInt(boundingBox.getBottom()) - roundToInt2);
                }
            }
            addChildCount++;
        }
