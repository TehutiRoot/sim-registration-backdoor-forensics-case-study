...
public class DSTU7564Digest implements ExtendedDigest, Memoable {
    ...
    /* renamed from: P */
    private void m24727P(long[] jArr) {
    ...
    /* renamed from: Q */
    private void m24726Q(long[] jArr) {
        for (int i = 0; i < this.rounds; i++) {
    ...
    private void processBlock(byte[] bArr, int i) {
        ...
        m24727P(this.tempState1);
        m24726Q(this.tempState2);
