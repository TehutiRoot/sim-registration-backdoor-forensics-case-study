...
public final class TwoLine$ListItem$1$4 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public TwoLine$ListItem$1$4(float f, Function2<? super Composer, ? super Integer, Unit> function2, int i) {
        super(2);
        this.$minHeight = f;
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        Modifier m69736heightInVpY3zN4$default = SizeKt.m69736heightInVpY3zN4$default(Modifier.Companion, this.$minHeight, 0.0f, 2, null);
        f = TwoLine.f14823o;
        Modifier m69717paddingqDBjuR0$default = PaddingKt.m69717paddingqDBjuR0$default(m69736heightInVpY3zN4$default, 0.0f, 0.0f, f, 0.0f, 11, null);
