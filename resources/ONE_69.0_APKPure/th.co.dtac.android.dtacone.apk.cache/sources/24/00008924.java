...
public final class DrawablePainter extends Painter implements RememberObserver {
    ...
    /* renamed from: g */
    public final Drawable f43804g;

    /* renamed from: h */
    public final MutableState f43805h;

    /* renamed from: i */
    public final MutableState f43806i;

    /* renamed from: j */
    public final Lazy f43807j;
    ...
    public DrawablePainter(@NotNull Drawable drawable) {
        ...
        this.f43804g = drawable;
        m65148g = AbstractC19036aL1.m65148g(0, null, 2, null);
        this.f43805h = m65148g;
        m49248a = DrawablePainterKt.m49248a(drawable);
        m65148g2 = AbstractC19036aL1.m65148g(Size.m71743boximpl(m49248a), null, 2, null);
        this.f43806i = m65148g2;
        this.f43807j = LazyKt__LazyJVMKt.lazy(new DrawablePainter$callback$2(this));
    ...
    public boolean applyAlpha(float f) {
        this.f43804g.setAlpha(AbstractC11695c.coerceIn(AbstractC22237sr0.roundToInt(f * 255), 0, 255));
        return true;
    }
    ...
    public boolean applyColorFilter(@Nullable ColorFilter colorFilter) {
        ...
        Drawable drawable = this.f43804g;
        if (colorFilter != null) {
    ...
    /* renamed from: e */
    public final Drawable.Callback m49253e() {
        return (Drawable.Callback) this.f43807j.getValue();
    }

    /* renamed from: f */
    public final int m49252f() {
        return ((Number) this.f43805h.getValue()).intValue();
    }

    /* renamed from: g */
    public final long m49251g() {
        return ((Size) this.f43806i.getValue()).m71760unboximpl();
    }
    ...
    /* renamed from: h */
    public final void m49250h(int i) {
        this.f43805h.setValue(Integer.valueOf(i));
    }

    /* renamed from: i */
    public final void m49249i(long j) {
        this.f43806i.setValue(Size.m71743boximpl(j));
    }
    ...
    public void onDraw(@NotNull DrawScope drawScope) {
        ...
        m49252f();
        this.f43804g.setBounds(0, 0, AbstractC22237sr0.roundToInt(Size.m71755getWidthimpl(drawScope.mo72328getSizeNHjbRc())), AbstractC22237sr0.roundToInt(Size.m71752getHeightimpl(drawScope.mo72328getSizeNHjbRc())));
        try {
            canvas.save();
            this.f43804g.draw(AndroidCanvas_androidKt.getNativeCanvas(canvas));
        } finally {
            canvas.restore();
        }
    }
    ...
    public void onForgotten() {
        ...
        this.f43804g.setVisible(false, false);
        this.f43804g.setCallback(null);
    }

    @Override // androidx.compose.runtime.RememberObserver
    public void onRemembered() {
        this.f43804g.setCallback(m49253e());
        this.f43804g.setVisible(true, true);
        Drawable drawable = this.f43804g;
        if (drawable instanceof Animatable) {
