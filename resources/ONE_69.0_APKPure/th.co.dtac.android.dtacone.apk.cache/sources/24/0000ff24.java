package org.bouncycastle.math.p041ec.tools;
...
/* renamed from: org.bouncycastle.math.ec.tools.DiscoverEndomorphisms */
...
public class DiscoverEndomorphisms {
    ...
    private static BigInteger[] solveQuadraticEquation(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4) {
        ECFieldElement sqrt = new ECFieldElement.C12825Fp(bigInteger, bigInteger3.multiply(bigInteger3).subtract(bigInteger2.multiply(bigInteger4).shiftLeft(2)).mod(bigInteger)).sqrt();
        if (sqrt != null) {
