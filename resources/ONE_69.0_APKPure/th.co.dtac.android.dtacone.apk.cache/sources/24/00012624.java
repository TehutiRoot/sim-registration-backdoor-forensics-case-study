...
/* renamed from: th.co.dtac.android.dtacone.repository.mrtr_postpaid.MrtrPostpaidRepository$getPostCodeInfo$1 */
/* loaded from: classes8.dex */
public final class MrtrPostpaidRepository$getPostCodeInfo$1 extends Lambda implements Function1<GetPostCodeInfoResponse, Unit> {
    final /* synthetic */ MrtrPostpaidRepository this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrPostpaidRepository$getPostCodeInfo$1(MrtrPostpaidRepository mrtrPostpaidRepository) {
        super(1);
        this.this$0 = mrtrPostpaidRepository;
    }
    ...
    public final void invoke2(@NotNull GetPostCodeInfoResponse response) {
        ...
        if (!response.getData().isEmpty()) {
            ...
            MrtrPostpaidRepository mrtrPostpaidRepository = this.this$0;
            Data data = (Data) first;
            mrtrPostpaidRepository.setPostcode(data.getPostcode());
            mrtrPostpaidRepository.setPostcodeSequenceString(String.valueOf(data.getPostcodeSequence()));
        }
    }
}