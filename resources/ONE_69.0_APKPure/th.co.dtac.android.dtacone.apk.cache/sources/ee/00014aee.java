...
/* renamed from: th.co.dtac.android.dtacone.view.fragment.customerenquiry.qrCode.CustomerEnquiryESimShowQrCodeFragment$initViewModel$1$1 */
/* loaded from: classes9.dex */
public final class CustomerEnquiryESimShowQrCodeFragment$initViewModel$1$1 extends Lambda implements Function1<Resource<? extends ActivationCodeResponse>, Unit> {
    final /* synthetic */ CustomerEnquiryESimShowQrCodeFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CustomerEnquiryESimShowQrCodeFragment$initViewModel$1$1(CustomerEnquiryESimShowQrCodeFragment customerEnquiryESimShowQrCodeFragment) {
        super(1);
    ...
    public final void invoke2(Resource<ActivationCodeResponse> resource) {
        ...
        CustomerEnquiryESimShowQrCodeFragment customerEnquiryESimShowQrCodeFragment = this.this$0;
        String activationCode = data.getActivationCode();
        if (activationCode != null && activationCode.length() != 0) {
            customerEnquiryESimShowQrCodeFragment.m8226x(data.getActivationCode());
            return;
        }
        customerEnquiryESimShowQrCodeFragment.dismissSecondaryLoading();
        String string = customerEnquiryESimShowQrCodeFragment.getString(R.string.show_qr_code_empty_activation_code);
        Intrinsics.checkNotNullExpressionValue(string, "getString(R.string.show_…de_empty_activation_code)");
        customerEnquiryESimShowQrCodeFragment.m8230t(new ErrorCollection(Constant.SERVER_ERROR_CODE, string));
    }
}