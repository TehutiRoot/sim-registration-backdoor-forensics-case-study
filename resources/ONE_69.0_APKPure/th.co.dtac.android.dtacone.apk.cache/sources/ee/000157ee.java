...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.login_mrtr.LoginMrtrViewModel$callOneLoginApi$5 */
/* loaded from: classes9.dex */
public final class LoginMrtrViewModel$callOneLoginApi$5 extends Lambda implements Function1<Map<String, ? extends String>, SingleSource<? extends Map<String, ? extends String>>> {
    final /* synthetic */ LoginMrtrViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LoginMrtrViewModel$callOneLoginApi$5(LoginMrtrViewModel loginMrtrViewModel) {
        super(1);
