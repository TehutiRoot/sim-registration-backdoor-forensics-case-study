...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.home.GetProfileImageViewModel$acceptBuyDOLConsent$3 */
/* loaded from: classes9.dex */
public final class GetProfileImageViewModel$acceptBuyDOLConsent$3 extends Lambda implements Function1<OnePrepaidStatusResponse, Unit> {
    final /* synthetic */ String $feature;
    final /* synthetic */ GetProfileImageViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GetProfileImageViewModel$acceptBuyDOLConsent$3(GetProfileImageViewModel getProfileImageViewModel, String str) {
        super(1);
    ...
    public final void invoke2(OnePrepaidStatusResponse onePrepaidStatusResponse) {
        ...
        MutableLiveData m2608v;
        if (Intrinsics.areEqual(onePrepaidStatusResponse.getStatus(), Status.getSUCCESS())) {
            m2608v = this.this$0.m2608v();
            m2608v.setValue(Resource.Companion.success(this.$feature));
            return;
        }
        serverErrorService = this.this$0.f105947e;
