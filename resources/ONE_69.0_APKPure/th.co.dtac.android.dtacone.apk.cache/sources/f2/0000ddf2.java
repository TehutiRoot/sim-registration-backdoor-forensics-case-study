...
public final class ReflectJavaClassFinder implements JavaClassFinder {
    ...
    public JavaClass findClass(@NotNull JavaClassFinder.Request request) {
        ...
        String replace$default = AbstractC19741eO1.replace$default(asString, '.', '$', false, 4, (Object) null);
        if (!packageFqName.isRoot()) {
            replace$default = packageFqName.asString() + '.' + replace$default;
        }
        Class<?> tryLoadClass = ReflectJavaClassFinderKt.tryLoadClass(this.f68907a, replace$default);
