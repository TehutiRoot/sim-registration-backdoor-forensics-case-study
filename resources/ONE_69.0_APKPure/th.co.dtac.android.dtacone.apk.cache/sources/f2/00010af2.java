...
public final class OperatorOnBackpressureLatest<T> implements Observable.Operator<T, T> {
                        ...
                        try {
                            ...
                            if (j != Long.MIN_VALUE) {
                                ...
                                if (j > 0 && obj2 != (obj = EMPTY)) {
                                    ...
                                    AbstractC23094xo1.m479a(this.value, obj2, obj);
                                    produced(1L);
                                    obj2 = obj;
                                }
    ...
    public static final class C13602a {
        ...
        /* renamed from: a */
        public static final OperatorOnBackpressureLatest f78741a = new OperatorOnBackpressureLatest();
    }

    /* renamed from: rx.internal.operators.OperatorOnBackpressureLatest$b */
    /* loaded from: classes7.dex */
    public static final class C13603b extends Subscriber {

        /* renamed from: a */
        public final LatestEmitter f78742a;

        public C13603b(LatestEmitter latestEmitter) {
            this.f78742a = latestEmitter;
        }

        @Override // p046rx.Observer
        public void onCompleted() {
            this.f78742a.onCompleted();
        }

        @Override // p046rx.Observer
        public void onError(Throwable th2) {
            this.f78742a.onError(th2);
        }

        @Override // p046rx.Observer
        public void onNext(Object obj) {
            this.f78742a.onNext(obj);
        }
    ...
    public Subscriber<? super T> call(Subscriber<? super T> subscriber) {
        ...
        C13603b c13603b = new C13603b(latestEmitter);
        latestEmitter.parent = c13603b;
        subscriber.add(c13603b);
