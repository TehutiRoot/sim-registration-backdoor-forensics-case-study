...
public class RrtProfileCollection implements Parcelable {
    public static final Parcelable.Creator<RrtProfileCollection> CREATOR = new C14220a();
    @SerializedName("dtrCode")
    private String dtrCode;
    @SerializedName("id")

    /* renamed from: id */
    private Long f85148id;
    ...
    /* loaded from: classes8.dex */
    public class C14220a implements Parcelable.Creator {
    ...
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeSerializable(this.f85148id);
    ...
    public RrtProfileCollection(Parcel parcel) {
        this.f85148id = (Long) parcel.readSerializable();
