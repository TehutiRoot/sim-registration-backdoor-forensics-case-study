...
public class GPUImagePixelationFilter extends GPUImageFilter {
    ...
    public void onInit() {
        super.onInit();
        this.f67602e = GLES20.glGetUniformLocation(getProgram(), "imageWidthFactor");
        this.f67603f = GLES20.glGetUniformLocation(getProgram(), "imageHeightFactor");
        this.f67605h = GLES20.glGetUniformLocation(getProgram(), "pixel");
        setPixel(this.f67604g);
    }

    @Override // jp.p022co.cyberagent.android.gpuimage.GPUImageFilter
    public void onOutputSizeChanged(int i, int i2) {
        super.onOutputSizeChanged(i, i2);
        setFloat(this.f67602e, 1.0f / i);
        setFloat(this.f67603f, 1.0f / i2);
    }

    public void setPixel(float f) {
        this.f67604g = f;
        setFloat(this.f67605h, f);
    }
}