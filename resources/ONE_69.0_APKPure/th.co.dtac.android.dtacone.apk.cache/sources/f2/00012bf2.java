...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.change_owner.viewModel.OneChangeOwnerValidateViewModel$validateSmartCardDtac$1 */
/* loaded from: classes10.dex */
public final class OneChangeOwnerValidateViewModel$validateSmartCardDtac$1 extends Lambda implements Function1<ValidateCardRequest, SingleSource<? extends ValidateCardResponse>> {
    final /* synthetic */ OneChangeOwnerValidateViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneChangeOwnerValidateViewModel$validateSmartCardDtac$1(OneChangeOwnerValidateViewModel oneChangeOwnerValidateViewModel) {
        super(1);
    ...
    public final SingleSource<? extends ValidateCardResponse> invoke(@NotNull ValidateCardRequest it) {
        ...
        return oneChangeOwnerRepository.validateCard(it);
    }
}