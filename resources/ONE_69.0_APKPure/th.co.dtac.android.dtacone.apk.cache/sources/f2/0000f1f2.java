...
public class DefaultRequestDirector implements RequestDirector {
    ...
    /* renamed from: a */
    public final Log f74157a;

    /* renamed from: b */
    public final HttpAuthenticator f74158b;
    ...
    /* renamed from: e */
    public final int f74161e;

    /* renamed from: f */
    public HttpHost f74162f;
    ...
    public DefaultRequestDirector(HttpRequestExecutor httpRequestExecutor, ClientConnectionManager clientConnectionManager, ConnectionReuseStrategy connectionReuseStrategy, ConnectionKeepAliveStrategy connectionKeepAliveStrategy, HttpRoutePlanner httpRoutePlanner, HttpProcessor httpProcessor, HttpRequestRetryHandler httpRequestRetryHandler, RedirectHandler redirectHandler, AuthenticationHandler authenticationHandler, AuthenticationHandler authenticationHandler2, UserTokenHandler userTokenHandler, HttpParams httpParams) {
        this(LogFactory.getLog(DefaultRequestDirector.class), httpRequestExecutor, clientConnectionManager, connectionReuseStrategy, connectionKeepAliveStrategy, httpRoutePlanner, httpProcessor, httpRequestRetryHandler, new C0851ME(redirectHandler), new C0567I7(authenticationHandler), new C0567I7(authenticationHandler2), userTokenHandler, httpParams);
    }

    /* renamed from: a */
    public final void m24867a() {
        ...
        if (managedClientConnection != null) {
            ...
            try {
                ...
                if (this.f74157a.isDebugEnabled()) {
                    this.f74157a.debug(e.getMessage(), e);
                }
            }
            try {
                managedClientConnection.releaseConnection();
            } catch (IOException e2) {
                this.f74157a.debug("Error releasing connection", e2);
            }
        }
    }

    /* renamed from: b */
    public final void m24866b(RoutedRequest routedRequest, HttpContext httpContext) {
    ...
    /* renamed from: c */
    public final HttpResponse m24865c(RoutedRequest routedRequest, HttpContext httpContext) {
        RequestWrapper request = routedRequest.getRequest();
        HttpRoute route = routedRequest.getRoute();
        IOException e = null;
        while (true) {
            ...
            if (!request.isRepeatable()) {
                this.f74157a.debug("Cannot retry non-repeatable request");
                if (e != null) {
            ...
            try {
                if (!this.managedConn.isOpen()) {
                    if (!route.isTunnelled()) {
                        this.f74157a.debug("Reopening the direct connection.");
                        this.managedConn.open(route, httpContext, this.params);
                    } else {
                        this.f74157a.debug("Proxied connection. Need to start over.");
                        return null;
                    }
                }
                if (this.f74157a.isDebugEnabled()) {
                    this.f74157a.debug("Attempt " + this.f74159c + " to execute request");
                }
                return this.requestExec.execute(request, this.managedConn, httpContext);
            } catch (IOException e2) {
                e = e2;
                this.f74157a.debug("Closing the connection.");
                try {
                    this.managedConn.close();
                } catch (IOException unused) {
                }
                if (this.retryHandler.retryRequest(e, request.getExecCount(), httpContext)) {
                    if (this.f74157a.isInfoEnabled()) {
                        this.f74157a.info("I/O exception (" + e.getClass().getName() + ") caught when processing request to " + route + ": " + e.getMessage());
                    }
                    if (this.f74157a.isDebugEnabled()) {
                        this.f74157a.debug(e.getMessage(), e);
                    }
                    if (this.f74157a.isInfoEnabled()) {
                        this.f74157a.info("Retrying request to " + route);
                    }
        ...
        while (true) {
            ...
            if (execute.getStatusLine().getStatusCode() >= 200) {
                if (HttpClientParams.isAuthenticating(this.params)) {
                    if (!this.f74158b.isAuthenticationRequested(proxyHost, execute, this.proxyAuthStrategy, this.proxyAuthState, httpContext) || !this.f74158b.authenticate(proxyHost, execute, this.proxyAuthStrategy, this.proxyAuthState, httpContext)) {
                        break;
                    } else if (this.reuseStrategy.keepAlive(execute, httpContext)) {
                        this.f74157a.debug("Connection kept alive");
    ...
    /* renamed from: d */
    public final RequestWrapper m24864d(HttpRequest httpRequest) {
        ...
        do {
            ...
            switch (nextStep) {
                ...
                case 3:
                    ...
                    this.f74157a.debug("Tunnel to target created.");
                ...
                case 4:
                    ...
                    this.f74157a.debug("Tunnel to proxy created.");
    ...
    */
    ...
    public RoutedRequest handleResponse(RoutedRequest routedRequest, HttpResponse httpResponse, HttpContext httpContext) throws HttpException, IOException {
        ...
        if (HttpClientParams.isAuthenticating(params)) {
            ...
            boolean isAuthenticationRequested = this.f74158b.isAuthenticationRequested(httpHost, httpResponse, this.targetAuthStrategy, this.targetAuthState, httpContext);
            HttpHost proxyHost = route.getProxyHost();
            if (proxyHost == null) {
                proxyHost = route.getTargetHost();
            }
            HttpHost httpHost3 = proxyHost;
            boolean isAuthenticationRequested2 = this.f74158b.isAuthenticationRequested(httpHost3, httpResponse, this.proxyAuthStrategy, this.proxyAuthState, httpContext);
            if (isAuthenticationRequested) {
                if (this.f74158b.authenticate(httpHost, httpResponse, this.targetAuthStrategy, this.targetAuthState, httpContext)) {
                    return routedRequest;
                }
            }
            if (isAuthenticationRequested2 && this.f74158b.authenticate(httpHost3, httpResponse, this.proxyAuthStrategy, this.proxyAuthState, httpContext)) {
                return routedRequest;
            }
        }
        ...
        if (i < this.f74161e) {
            ...
            if (extractHost != null) {
                if (!route.getTargetHost().equals(extractHost)) {
                    this.f74157a.debug("Resetting target auth state");
                    this.targetAuthState.reset();
                    AuthScheme authScheme = this.proxyAuthState.getAuthScheme();
                    if (authScheme != null && authScheme.isConnectionBased()) {
                        this.f74157a.debug("Resetting proxy auth state");
                        this.proxyAuthState.reset();
                    }
                }
                RequestWrapper m24864d = m24864d(redirect);
                m24864d.setParams(params);
                HttpRoute determineRoute = determineRoute(extractHost, m24864d, httpContext);
                RoutedRequest routedRequest2 = new RoutedRequest(m24864d, determineRoute);
                if (this.f74157a.isDebugEnabled()) {
                    Log log = this.f74157a;
        ...
        throw new RedirectException("Maximum redirects (" + this.f74161e + ") exceeded");
    }
    ...
    public void releaseConnection() {
        try {
            ...
            this.f74157a.debug("IOException releasing connection", e);
        }
        this.managedConn = null;
    }
    ...
    public DefaultRequestDirector(Log log, HttpRequestExecutor httpRequestExecutor, ClientConnectionManager clientConnectionManager, ConnectionReuseStrategy connectionReuseStrategy, ConnectionKeepAliveStrategy connectionKeepAliveStrategy, HttpRoutePlanner httpRoutePlanner, HttpProcessor httpProcessor, HttpRequestRetryHandler httpRequestRetryHandler, RedirectStrategy redirectStrategy, AuthenticationHandler authenticationHandler, AuthenticationHandler authenticationHandler2, UserTokenHandler userTokenHandler, HttpParams httpParams) {
        this(LogFactory.getLog(DefaultRequestDirector.class), httpRequestExecutor, clientConnectionManager, connectionReuseStrategy, connectionKeepAliveStrategy, httpRoutePlanner, httpProcessor, httpRequestRetryHandler, redirectStrategy, new C0567I7(authenticationHandler), new C0567I7(authenticationHandler2), userTokenHandler, httpParams);
    }
    ...
    public DefaultRequestDirector(Log log, HttpRequestExecutor httpRequestExecutor, ClientConnectionManager clientConnectionManager, ConnectionReuseStrategy connectionReuseStrategy, ConnectionKeepAliveStrategy connectionKeepAliveStrategy, HttpRoutePlanner httpRoutePlanner, HttpProcessor httpProcessor, HttpRequestRetryHandler httpRequestRetryHandler, RedirectStrategy redirectStrategy, AuthenticationStrategy authenticationStrategy, AuthenticationStrategy authenticationStrategy2, UserTokenHandler userTokenHandler, HttpParams httpParams) {
        ...
        this.f74157a = log;
        this.f74158b = new HttpAuthenticator(log);
        ...
        if (redirectStrategy instanceof C0851ME) {
            this.redirectHandler = ((C0851ME) redirectStrategy).m67438a();
        } else {
            this.redirectHandler = null;
        }
        if (authenticationStrategy instanceof C0567I7) {
            this.targetAuthHandler = ((C0567I7) authenticationStrategy).m68059a();
        } else {
            this.targetAuthHandler = null;
        }
        if (authenticationStrategy2 instanceof C0567I7) {
            this.proxyAuthHandler = ((C0567I7) authenticationStrategy2).m68059a();
        } else {
        ...
        this.f74161e = httpParams.getIntParameter(ClientPNames.MAX_REDIRECTS, 100);
    }
}