...
@Metadata(m29143d1 = {"\u0000B\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0007\u0018\u00002\u00020\u0001B'\b\u0007\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\n\b\u0002\u0010\u0005\u001a\u0004\u0018\u00010\u0004\u0012\b\b\u0002\u0010\u0007\u001a\u00020\u0006¢\u0006\u0004\b\b\u0010\tJ\u0015\u0010\r\u001a\u00020\f2\u0006\u0010\u000b\u001a\u00020\n¢\u0006\u0004\b\r\u0010\u000eJ\u0015\u0010\u0010\u001a\u00020\f2\u0006\u0010\u000f\u001a\u00020\u0006¢\u0006\u0004\b\u0010\u0010\u0011R\u0016\u0010\u0015\u001a\u00020\u00128\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0013\u0010\u0014R\u0016\u0010\u0019\u001a\u00020\u00168\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0017\u0010\u0018R\u0018\u0010\u001d\u001a\u0004\u0018\u00010\u001a8\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u001b\u0010\u001c¨\u0006\u001e"}, m29142d2 = {"Lth/co/dtac/android/dtacone/app_one/widget/OneButtonBlue;", "Landroid/widget/FrameLayout;", "Landroid/content/Context;", CoreConstants.CONTEXT_SCOPE_VALUE, "Landroid/util/AttributeSet;", "attrs", "", "defStyleAttr", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "", TextBundle.TEXT_ENTRY, "", "setText", "(Ljava/lang/String;)V", "background", "setButtonBackground", "(I)V", "Lth/co/dtac/android/dtacone/app_one/widget/OneFontTextView;", PDPageLabelRange.STYLE_LETTERS_LOWER, "Lth/co/dtac/android/dtacone/app_one/widget/OneFontTextView;", "tvBtn", "Landroidx/constraintlayout/widget/ConstraintLayout;", OperatorName.CLOSE_FILL_NON_ZERO_AND_STROKE, "Landroidx/constraintlayout/widget/ConstraintLayout;", "rootButton", "Landroid/content/res/TypedArray;", OperatorName.CURVE_TO, "Landroid/content/res/TypedArray;", "attributes", "app_prodRelease"}, m29141k = 1, m29140mv = {1, 8, 0})
...
public final class OneButtonBlue extends FrameLayout {
    ...
    /* renamed from: a */
    public OneFontTextView f82838a;

    /* renamed from: b */
    public ConstraintLayout f82839b;

    /* renamed from: c */
    public TypedArray f82840c;
    ...
    public final void setButtonBackground(int i) {
        this.f82839b.setBackgroundResource(i);
    }

    public final void setText(@NotNull String text) {
        Intrinsics.checkNotNullParameter(text, "text");
        this.f82838a.setText(text);
    }
    ...
    public OneButtonBlue(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        this.f82840c = attributeSet != null ? context.obtainStyledAttributes(attributeSet, R.styleable.OneButton) : null;
        ...
        this.f82838a = (OneFontTextView) findViewById;
        ...
        this.f82839b = (ConstraintLayout) findViewById2;
        TypedArray typedArray = this.f82840c;
        if (typedArray != null) {
            ...
            if (typedArray.hasValue(R.styleable.OneButton_android_textSize)) {
                this.f82838a.setTextSize(0, typedArray.getDimension(R.styleable.OneButton_android_textSize, this.f82838a.getTextSize()));
            }
            if (typedArray.hasValue(R.styleable.OneButton_android_textColor)) {
                OneFontTextView oneFontTextView = this.f82838a;
