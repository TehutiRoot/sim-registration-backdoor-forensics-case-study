...
public class KDFDoublePipelineIterationBytesGenerator implements MacDerivationFunction {
    ...
    /* renamed from: a */
    private byte[] f75155a;
    private byte[] fixedInputData;
    private int generatedBytes;

    /* renamed from: h */
    private final int f75156h;
    private byte[] ios;

    /* renamed from: k */
    private byte[] f75157k;
    ...
    public KDFDoublePipelineIterationBytesGenerator(Mac mac) {
        ...
        this.f75156h = macSize;
        this.f75155a = new byte[macSize];
        this.f75157k = new byte[macSize];
    }
    ...
    private void generateNext() {
        if (this.generatedBytes == 0) {
            ...
            this.prf.doFinal(this.f75155a, 0);
        } else {
            Mac mac2 = this.prf;
            byte[] bArr2 = this.f75155a;
            mac2.update(bArr2, 0, bArr2.length);
            this.prf.doFinal(this.f75155a, 0);
        }
        Mac mac3 = this.prf;
        byte[] bArr3 = this.f75155a;
        mac3.update(bArr3, 0, bArr3.length);
        if (this.useCounter) {
            int i = (this.generatedBytes / this.f75156h) + 1;
            byte[] bArr4 = this.ios;
        ...
        this.prf.doFinal(this.f75157k, 0);
    }
    ...
    public int generateBytes(byte[] bArr, int i, int i2) throws DataLengthException, IllegalArgumentException {
        ...
        System.arraycopy(this.f75157k, i7, bArr, i, min);
        ...
        while (true) {
            ...
            generateNext();
            min = Math.min(this.f75156h, i8);
            System.arraycopy(this.f75157k, 0, bArr, i, min);
            this.generatedBytes += min;
            i8 -= min;
        }
    }
    ...
    public void init(DerivationParameters derivationParameters) {
        ...
        if (kDFDoublePipelineIterationParameters.useCounter()) {
            BigInteger multiply = TWO.pow(r).multiply(BigInteger.valueOf(this.f75156h));
