...
public final class LayoutHelper {
    ...
    public static final class C3589a {
        ...
        public C3589a(int i, int i2, boolean z) {
            this.f31217a = i;
            this.f31218b = i2;
            this.f31219c = z;
        }
        ...
        /* renamed from: a */
        public final int m59038a() {
            return this.f31218b;
        }

        /* renamed from: b */
        public final int m59037b() {
            return this.f31217a;
        }

        /* renamed from: c */
        public final boolean m59036c() {
            return this.f31219c;
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof C3589a) {
                ...
                return this.f31217a == c3589a.f31217a && this.f31218b == c3589a.f31218b && this.f31219c == c3589a.f31219c;
            }
            return false;
        }
        ...
        public int hashCode() {
            int i = ((this.f31217a * 31) + this.f31218b) * 31;
        ...
        public String toString() {
            return "BidiRun(start=" + this.f31217a + ", end=" + this.f31218b + ", isRtl=" + this.f31219c + CoreConstants.RIGHT_PARENTHESIS_CHAR;
        }
    }
    ...
    public LayoutHelper(@NotNull Layout layout) {
        ...
        int i2 = 0;
        do {
            CharSequence text = this.f31211a.getText();
            Intrinsics.checkNotNullExpressionValue(text, "layout.text");
            int indexOf$default = StringsKt__StringsKt.indexOf$default(text, '\n', i2, false, 4, (Object) null);
            if (indexOf$default < 0) {
                i = this.f31211a.getText().length();
            } else {
                i = indexOf$default + 1;
            }
            i2 = i;
            arrayList.add(Integer.valueOf(i2));
        } while (i2 < this.f31211a.getText().length());
        this.f31212b = arrayList;
        int size = arrayList.size();
        ArrayList arrayList2 = new ArrayList(size);
        for (int i3 = 0; i3 < size; i3++) {
            arrayList2.add(null);
        }
        this.f31213c = arrayList2;
        this.f31214d = new boolean[this.f31212b.size()];
        this.f31216f = this.f31212b.size();
    }
    ...
    /* renamed from: a */
    public final float m59040a(int i, boolean z) {
        if (z) {
            return this.f31211a.getPrimaryHorizontal(i);
        }
        return this.f31211a.getSecondaryHorizontal(i);
    }
    ...
    */
    public final java.text.Bidi analyzeBidi(int r12) {
        /*
            r11 = this;
            boolean[] r0 = r11.f31214d
            boolean r0 = r0[r12]
            if (r0 == 0) goto Lf
            java.util.List r0 = r11.f31213c
        ...
        Lf:
            ...
            goto L22
        L14:
            java.util.List r1 = r11.f31212b
            int r2 = r12 + (-1)
            java.lang.Object r1 = r1.get(r2)
            java.lang.Number r1 = (java.lang.Number) r1
            int r1 = r1.intValue()
        L22:
            java.util.List r2 = r11.f31212b
        ...
        L3a:
            ...
            goto L38
        L3d:
            android.text.Layout r3 = r11.f31211a
        ...
        L62:
            r0 = r1
        L63:
            java.util.List r3 = r11.f31213c
            r3.set(r12, r0)
            boolean[] r3 = r11.f31214d
            r3[r12] = r2
            if (r0 == 0) goto L75
            char[] r12 = r11.f31215e
            if (r10 != r12) goto L74
            r10 = r1
            goto L75
        L74:
    ...
    /* renamed from: b */
    public final int m59039b(int i) {
        while (i > 0 && isLineEndSpace(this.f31211a.getText().charAt(i - 1))) {
            i--;
        }
        return i;
    }
    ...
    public final float getHorizontalPosition(int i, boolean z, boolean z2) {
        ...
        int lineForOffset = LayoutCompatKt.getLineForOffset(this.f31211a, i2, z2);
        int lineStart = this.f31211a.getLineStart(lineForOffset);
        int lineEnd = this.f31211a.getLineEnd(lineForOffset);
        if (i2 != lineStart && i2 != lineEnd) {
            return m59040a(i, z);
        }
        if (i2 != 0 && i2 != this.f31211a.getText().length()) {
            int paragraphForOffset = getParagraphForOffset(i2, z2);
            boolean isRtlParagraph = isRtlParagraph(paragraphForOffset);
            int m59039b = m59039b(lineEnd);
            int paragraphStart = getParagraphStart(paragraphForOffset);
            int i3 = lineStart - paragraphStart;
            int i4 = m59039b - paragraphStart;
            ...
            if (bidi != null && bidi.getRunCount() != 1) {
                ...
                C3589a[] c3589aArr = new C3589a[runCount];
                for (int i5 = 0; i5 < runCount; i5++) {
                    ...
                    c3589aArr[i5] = new C3589a(runStart, runLimit, z3);
                }
                ...
                Bidi.reorderVisually(bArr, 0, c3589aArr, 0, runCount);
                int i7 = -1;
                if (i2 == lineStart) {
                    int i8 = 0;
                    while (true) {
                        if (i8 >= runCount) {
                            break;
                        } else if (c3589aArr[i8].m59037b() == i2) {
                            i7 = i8;
                            break;
                        } else {
                            i8++;
                    ...
                    C3589a c3589a = c3589aArr[i7];
                    if (z || isRtlParagraph == c3589a.m59036c()) {
                        if (!isRtlParagraph) {
                            isRtlParagraph = true;
                        } else {
                    ...
                    if (i7 == 0 && isRtlParagraph) {
                        return this.f31211a.getLineLeft(lineForOffset);
                    }
                    if (i7 == ArraysKt___ArraysKt.getLastIndex(c3589aArr) && !isRtlParagraph) {
                        return this.f31211a.getLineRight(lineForOffset);
                    }
                    if (isRtlParagraph) {
                        return this.f31211a.getPrimaryHorizontal(c3589aArr[i7 - 1].m59037b());
                    }
                    return this.f31211a.getPrimaryHorizontal(c3589aArr[i7 + 1].m59037b());
                }
                if (i2 > m59039b) {
                ...
                while (true) {
                    if (i9 >= runCount) {
                        break;
                    } else if (c3589aArr[i9].m59038a() == i2) {
                        i7 = i9;
                        break;
                    } else {
                        i9++;
                ...
                C3589a c3589a2 = c3589aArr[i7];
                if (!z && isRtlParagraph != c3589a2.m59036c()) {
                ...
                if (isRtlParagraph) {
                    return this.f31211a.getPrimaryHorizontal(c3589aArr[i7 - 1].m59038a());
                }
                return this.f31211a.getPrimaryHorizontal(c3589aArr[i7 + 1].m59038a());
            }
            boolean isRtlCharAt = this.f31211a.isRtlCharAt(lineStart);
    ...
    public final int getParagraphEnd(@IntRange(from = 0) int i) {
        return ((Number) this.f31212b.get(i)).intValue();
    }

    public final int getParagraphForOffset(@IntRange(from = 0) int i, boolean z) {
        int i2;
        int binarySearch$default = CollectionsKt__CollectionsKt.binarySearch$default(this.f31212b, Integer.valueOf(i), 0, 0, 6, (Object) null);
        ...
        if (z && i2 > 0) {
            int i3 = i2 - 1;
            if (i == ((Number) this.f31212b.get(i3)).intValue()) {
                return i3;
            }
        }
        return i2;
    ...
    public final int getParagraphStart(@IntRange(from = 0) int i) {
        ...
        return ((Number) this.f31212b.get(i - 1)).intValue();
    }
    ...
    public final boolean isRtlParagraph(@IntRange(from = 0) int i) {
        if (this.f31211a.getParagraphDirection(this.f31211a.getLineForOffset(getParagraphStart(i))) == -1) {
            return true;
        }
        return false;
    }
