...
public class FragmentFactory {
    ...
    /* renamed from: a */
    public static final SimpleArrayMap f35540a = new SimpleArrayMap();

    /* renamed from: a */
    public static boolean m54401a(ClassLoader classLoader, String str) {
        try {
            return Fragment.class.isAssignableFrom(m54400b(classLoader, str));
    ...
    /* renamed from: b */
    public static Class m54400b(ClassLoader classLoader, String str) {
        SimpleArrayMap simpleArrayMap = f35540a;
    ...
    public static Class<? extends Fragment> loadFragmentClass(@NonNull ClassLoader classLoader, @NonNull String str) {
        try {
            return m54400b(classLoader, str);
