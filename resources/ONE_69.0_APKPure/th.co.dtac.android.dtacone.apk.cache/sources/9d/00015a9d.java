...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.otp_transaction.OtpTransactionViewModel$verifyOtpTransaction$3 */
/* loaded from: classes9.dex */
public final class OtpTransactionViewModel$verifyOtpTransaction$3 extends Lambda implements Function1<VerifyOtpTransactionResponse, Unit> {
    final /* synthetic */ String $otp;
    final /* synthetic */ OtpTransactionViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OtpTransactionViewModel$verifyOtpTransaction$3(OtpTransactionViewModel otpTransactionViewModel, String str) {
        super(1);
    ...
    public final void invoke2(VerifyOtpTransactionResponse verifyOtpTransactionResponse) {
        ...
        mutableLiveData = this.this$0.f106984i;
