...
public final class ContentResolverCompat {
    ...
    public static class C3926a {
        @DoNotInline
        /* renamed from: a */
        public static Cursor m57509a(ContentResolver contentResolver, Uri uri, String[] strArr, String str, String[] strArr2, String str2, CancellationSignal cancellationSignal) {
    ...
    public static Cursor query(@NonNull ContentResolver contentResolver, @NonNull Uri uri, @Nullable String[] strArr, @Nullable String str, @Nullable String[] strArr2, @Nullable String str2, @Nullable androidx.core.p005os.CancellationSignal cancellationSignal) {
        ...
        return C3926a.m57509a(contentResolver, uri, strArr, str, strArr2, str2, (CancellationSignal) cancellationSignalObject);
    }
}