...
public final class ImageProcessingUtil {
    ...
    public static boolean applyPixelShiftForYUV(@NonNull ImageProxy imageProxy) {
        if (!m63185f(imageProxy)) {
            Logger.m63176e("ImageProcessingUtil", "Unsupported format for YUV to RGB");
            return false;
        } else if (m63188c(imageProxy) == Result.ERROR_CONVERSION) {
            Logger.m63176e("ImageProcessingUtil", "One pixel shift for YUV failure");
            return false;
        } else {
            return true;
        }
    ...
    /* renamed from: c */
    public static Result m63188c(ImageProxy imageProxy) {
    ...
    public static ImageProxy convertJpegBytesToImage(@NonNull ImageReaderProxy imageReaderProxy, @NonNull byte[] bArr) {
        ...
        if (nativeWriteJpegToSurface(bArr, surface) != 0) {
            Logger.m63176e("ImageProcessingUtil", "Failed to enqueue JPEG image.");
            return null;
        }
        ImageProxy acquireLatestImage = imageReaderProxy.acquireLatestImage();
        if (acquireLatestImage == null) {
            Logger.m63176e("ImageProcessingUtil", "Failed to get acquire JPEG image.");
        }
    ...
    @Nullable
    public static ImageProxy convertYUVToRGB(@NonNull final ImageProxy imageProxy, @NonNull ImageReaderProxy imageReaderProxy, @Nullable ByteBuffer byteBuffer, @IntRange(from = 0, m64693to = 359) int i, boolean z) {
        if (!m63185f(imageProxy)) {
            Logger.m63176e("ImageProcessingUtil", "Unsupported format for YUV to RGB");
            return null;
        }
        ...
        if (!m63186e(i)) {
            Logger.m63176e("ImageProcessingUtil", "Unsupported rotation degrees for rotate RGB");
            return null;
        } else if (m63187d(imageProxy, imageReaderProxy.getSurface(), byteBuffer, i, z) == Result.ERROR_CONVERSION) {
            Logger.m63176e("ImageProcessingUtil", "YUV to RGB conversion failure");
            return null;
        } else {
            if (Log.isLoggable("MH", 3)) {
                Logger.m63178d("ImageProcessingUtil", String.format(Locale.US, "Image processing performance profiling, duration: [%d], image count: %d", Long.valueOf(System.currentTimeMillis() - currentTimeMillis), Integer.valueOf(f10932a)));
                f10932a++;
            }
            final ImageProxy acquireLatestImage = imageReaderProxy.acquireLatestImage();
            if (acquireLatestImage == null) {
                Logger.m63176e("ImageProcessingUtil", "YUV to RGB acquireLatestImage failure");
                return null;
            }
            BK1 bk1 = new BK1(acquireLatestImage);
            bk1.addOnImageCloseListener(new ForwardingImageProxy.OnImageCloseListener() { // from class: qd0
                @Override // androidx.camera.core.ForwardingImageProxy.OnImageCloseListener
                public final void onImageClose(ImageProxy imageProxy2) {
                    ImageProcessingUtil.m63184g(ImageProxy.this, imageProxy, imageProxy2);
                }
            });
            return bk1;
        }
    ...
    public static boolean convertYuvToJpegBytesIntoSurface(@NonNull ImageProxy imageProxy, @IntRange(from = 1, m64693to = 100) int i, int i2, @NonNull Surface surface) {
        try {
            return writeJpegBytesToSurface(surface, ImageUtil.yuvImageToJpegByteArray(imageProxy, null, i, i2));
        } catch (ImageUtil.CodecFailedException e) {
            Logger.m63175e("ImageProcessingUtil", "Failed to encode YUV to JPEG", e);
            return false;
        }
    }
    ...
    /* renamed from: d */
    public static Result m63187d(ImageProxy imageProxy, Surface surface, ByteBuffer byteBuffer, int i, boolean z) {
        int i2;
        int i3;
        int i4;
        int width = imageProxy.getWidth();
    ...
    /* renamed from: e */
    public static boolean m63186e(int i) {
        return i == 0 || i == 90 || i == 180 || i == 270;
    }

    /* renamed from: f */
    public static boolean m63185f(ImageProxy imageProxy) {
    ...
    /* renamed from: g */
    public static /* synthetic */ void m63184g(ImageProxy imageProxy, ImageProxy imageProxy2, ImageProxy imageProxy3) {
    ...
    /* renamed from: h */
    public static /* synthetic */ void m63183h(ImageProxy imageProxy, ImageProxy imageProxy2, ImageProxy imageProxy3) {
        if (imageProxy != null && imageProxy2 != null) {
            imageProxy2.close();
        }
    }
    ...
    /* renamed from: i */
    public static Result m63182i(ImageProxy imageProxy, ImageWriter imageWriter, ByteBuffer byteBuffer, ByteBuffer byteBuffer2, ByteBuffer byteBuffer3, int i) {
        int width = imageProxy.getWidth();
        int height = imageProxy.getHeight();
        int rowStride = imageProxy.getPlanes()[0].getRowStride();
        int rowStride2 = imageProxy.getPlanes()[1].getRowStride();
    ...
    @Nullable
    public static ImageProxy rotateYUV(@NonNull final ImageProxy imageProxy, @NonNull ImageReaderProxy imageReaderProxy, @NonNull ImageWriter imageWriter, @NonNull ByteBuffer byteBuffer, @NonNull ByteBuffer byteBuffer2, @NonNull ByteBuffer byteBuffer3, @IntRange(from = 0, m64693to = 359) int i) {
        Result result;
        if (!m63185f(imageProxy)) {
            Logger.m63176e("ImageProcessingUtil", "Unsupported format for rotate YUV");
            return null;
        } else if (!m63186e(i)) {
            Logger.m63176e("ImageProcessingUtil", "Unsupported rotation degrees for rotate YUV");
            return null;
        } else {
            Result result2 = Result.ERROR_CONVERSION;
            if (Build.VERSION.SDK_INT >= 23 && i > 0) {
                result = m63182i(imageProxy, imageWriter, byteBuffer, byteBuffer2, byteBuffer3, i);
            } else {
                result = result2;
            }
            if (result == result2) {
                Logger.m63176e("ImageProcessingUtil", "rotate YUV failure");
                return null;
            }
            final ImageProxy acquireLatestImage = imageReaderProxy.acquireLatestImage();
            if (acquireLatestImage == null) {
                Logger.m63176e("ImageProcessingUtil", "YUV rotation acquireLatestImage failure");
                return null;
            }
            BK1 bk1 = new BK1(acquireLatestImage);
            bk1.addOnImageCloseListener(new ForwardingImageProxy.OnImageCloseListener() { // from class: rd0
                @Override // androidx.camera.core.ForwardingImageProxy.OnImageCloseListener
                public final void onImageClose(ImageProxy imageProxy2) {
                    ImageProcessingUtil.m63183h(ImageProxy.this, imageProxy, imageProxy2);
                }
            });
            return bk1;
        }
