...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.esim.ESimViewModel$commonValidateIdCardNumber$3 */
/* loaded from: classes9.dex */
public final class ESimViewModel$commonValidateIdCardNumber$3 extends Lambda implements Function1<MrtrPrepaidValidateIdCardResponse, Unit> {
    ...
    public ESimViewModel$commonValidateIdCardNumber$3(ESimViewModel eSimViewModel, IdCardInformationCollection idCardInformationCollection, String str, String str2, boolean z) {
        super(1);
    ...
    public final void invoke2(MrtrPrepaidValidateIdCardResponse mrtrPrepaidValidateIdCardResponse) {
        ...
        if (this.$cardInformation != null) {
            ...
            eSimRepository7 = eSimViewModel.f105820b;
            MrtrPrepaidValidateBarcodeResponse mrtrPrepaidValidateBarcodeResponse = eSimRepository7.getMrtrPrepaidValidateBarcodeResponse();
            String str = "";
            String str2 = (mrtrPrepaidValidateBarcodeResponse == null || (str2 = mrtrPrepaidValidateBarcodeResponse.getSubscriberNumber()) == null) ? "" : "";
            eSimRepository8 = this.this$0.f105820b;
            MrtrPrepaidValidateBarcodeResponse mrtrPrepaidValidateBarcodeResponse2 = eSimRepository8.getMrtrPrepaidValidateBarcodeResponse();
