...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.buyDol.viewModel.OneBuyDolViewModel$verifyOneBuyDolOTP$3 */
/* loaded from: classes10.dex */
public final class OneBuyDolViewModel$verifyOneBuyDolOTP$3 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ OneBuyDolViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneBuyDolViewModel$verifyOneBuyDolOTP$3(OneBuyDolViewModel oneBuyDolViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable throwable) {
        ...
        oneErrorService.handleException(throwable, new OneErrorService.ExceptionHandler() { // from class: th.co.dtac.android.dtacone.view.appOne.buyDol.viewModel.OneBuyDolViewModel$verifyOneBuyDolOTP$3.1
            @Override // th.p047co.dtac.android.dtacone.manager.service.OneErrorService.ExceptionHandler
            public void handle(@Nullable Throwable th2) {
                OneErrorService oneErrorService2;
                MutableLiveData m15876f0;
                OneErrorService oneErrorService3;
                MutableLiveData m15876f02;
                ...
                try {
                    ...
                    if (Intrinsics.areEqual(((ServerErrorException) th2).error().getStatusCode(), BuyDolConfig.OTP_FAIL_CODE)) {
                        m15876f02 = OneBuyDolViewModel.this.m15876f0();
                        m15876f02.setValue(Resource.Companion.error$default(Resource.Companion, "", null, null, 4, null));
                        ...
                        m15876f0 = OneBuyDolViewModel.this.m15876f0();
                        m15876f0.setValue(Resource.Companion.error$default(Resource.Companion, "", null, null, 4, null));
