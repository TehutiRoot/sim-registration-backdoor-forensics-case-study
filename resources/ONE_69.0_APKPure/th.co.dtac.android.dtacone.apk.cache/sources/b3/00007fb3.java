...
public class DocumentDataParser implements K12 {
    public static final DocumentDataParser INSTANCE = new DocumentDataParser();

    /* renamed from: a */
    public static final JsonReader.Options f41541a = JsonReader.Options.m50682of("t", OperatorName.FILL_NON_ZERO, OperatorName.CLOSE_AND_STROKE, OperatorName.SET_LINE_JOINSTYLE, "tr", "lh", "ls", "fc", OperatorName.NON_STROKING_COLOR, "sw", "of", "ps", "sz");
    ...
    public DocumentData parse(JsonReader jsonReader, float f) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            switch (jsonReader.selectName(f41541a)) {
                case 0:
                ...
                case 6:
                    ...
                    break;
                case 7:
                    i2 = AbstractC17500Dh0.m68803d(jsonReader);
                    break;
                case 8:
                    i3 = AbstractC17500Dh0.m68803d(jsonReader);
                    break;
                case 9:
