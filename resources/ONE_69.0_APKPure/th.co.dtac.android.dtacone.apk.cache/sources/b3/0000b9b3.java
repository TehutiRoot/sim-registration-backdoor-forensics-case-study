...
public class GCMReceiver extends BroadcastReceiver {
    ...
    public static class NotificationData {
        ...
        public /* synthetic */ NotificationData(int i, int i2, int i3, CharSequence charSequence, String str, Intent intent, int i4, C9129a c9129a) {
    ...
    /* loaded from: classes5.dex */
    public class C9129a implements MixpanelAPI.InterfaceC9147d {

        /* renamed from: a */
        public final /* synthetic */ String f58523a;

        public C9129a(String str) {
            this.f58523a = str;
        }
        ...
        public void mo33484a(MixpanelAPI mixpanelAPI) {
            mixpanelAPI.getPeople().setPushRegistrationId(this.f58523a);
        }
    }

    /* renamed from: com.mixpanel.android.mpmetrics.GCMReceiver$b */
    /* loaded from: classes5.dex */
    public class C9130b implements MixpanelAPI.InterfaceC9147d {
        public C9130b() {
        }
    ...
    /* loaded from: classes5.dex */
    public class C9131c implements MixpanelAPI.InterfaceC9147d {
        ...
        public C9131c(String str, String str2, String str3) {
            this.f58526a = str;
            this.f58527b = str2;
            this.f58528c = str3;
        }
            ...
            if (mixpanelAPI.isAppInForeground()) {
                ...
                try {
                    if (this.f58526a != null) {
                        jSONObject = new JSONObject(this.f58526a);
                    }
                } catch (JSONException unused) {
                }
                try {
                    jSONObject.put("campaign_id", Integer.valueOf(this.f58527b).intValue());
                    jSONObject.put(Constants.MessagePayloadKeys.MSGID_SERVER, Integer.valueOf(this.f58528c).intValue());
    ...
    /* renamed from: a */
    public final Notification m33638a(Context context, Intent intent, ResourceIds resourceIds) {
        NotificationData m33633f = m33633f(context, intent, resourceIds);
        if (m33633f == null) {
            return null;
        }
        MPLog.m33451d("MixpanelAPI.GCMReceiver", "MP GCM notification received: " + m33633f.message);
        PendingIntent activity = PendingIntent.getActivity(context, 0, m33633f.intent, 134217728);
        if (Build.VERSION.SDK_INT >= 26) {
            return makeNotificationSDK26OrHigher(context, activity, m33633f);
        }
        return makeNotificationSDK21OrHigher(context, activity, m33633f);
    }

    /* renamed from: b */
    public final Intent m33637b(Context context, String str, String str2, String str3, String str4) {
        Uri uri;
        Intent intent;
        if (str != null) {
            uri = Uri.parse(str);
    ...
    /* renamed from: c */
    public Intent m33636c(Context context) {
        return context.getPackageManager().getLaunchIntentForPackage(context.getPackageName());
    }

    /* renamed from: d */
    public final void m33635d(Context context, Intent intent) {
        ...
        Notification m33638a = m33638a(context.getApplicationContext(), intent, new ResourceReader.Drawables(resourcePackageName, context));
        if (m33638a != null) {
            ((NotificationManager) context.getSystemService("notification")).notify(0, m33638a);
        }
    }

    /* renamed from: e */
    public final void m33634e(Intent intent) {
        String stringExtra = intent.getStringExtra("registration_id");
        if (intent.getStringExtra(Constants.IPC_BUNDLE_KEY_SEND_ERROR) != null) {
            MPLog.m33449e("MixpanelAPI.GCMReceiver", "Error when registering for GCM: " + intent.getStringExtra(Constants.IPC_BUNDLE_KEY_SEND_ERROR));
        } else if (stringExtra != null) {
            MPLog.m33451d("MixpanelAPI.GCMReceiver", "Registering GCM ID: " + stringExtra);
            MixpanelAPI.m33577o(new C9129a(stringExtra));
        } else if (intent.getStringExtra("unregistered") != null) {
            MPLog.m33451d("MixpanelAPI.GCMReceiver", "Unregistering from GCM");
            MixpanelAPI.m33577o(new C9130b());
        }
    }
    ...
    */
    public com.mixpanel.android.mpmetrics.GCMReceiver.NotificationData m33633f(android.content.Context r19, android.content.Intent r20, com.mixpanel.android.mpmetrics.ResourceIds r21) {
        /*
            r18 = this;
            r0 = r20
            r1 = r21
        ...
        Lb1:
            r10 = r18
            r11 = r19
            android.content.Intent r10 = r10.m33637b(r11, r12, r13, r14, r15)
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mixpanel.android.mpmetrics.GCMReceiver.m33633f(android.content.Context, android.content.Intent, com.mixpanel.android.mpmetrics.ResourceIds):com.mixpanel.android.mpmetrics.GCMReceiver$NotificationData");
    }

    /* renamed from: g */
    public final void m33632g(String str, String str2, String str3) {
        if (str != null && str2 != null) {
            MixpanelAPI.m33577o(new C9131c(str3, str, str2));
        }
    }
    ...
    public Notification makeNotificationSDK26OrHigher(Context context, PendingIntent pendingIntent, NotificationData notificationData) {
        ...
        NotificationChannel m65241a = ZI0.m65241a(notificationChannelId, MPConfig.getInstance(context).getNotificationChannelName(), MPConfig.getInstance(context).getNotificationChannelImportance());
        ...
        if (notificationDefaults == 2 || notificationDefaults == -1) {
            m65241a.enableVibration(true);
        }
        if (notificationDefaults == 4 || notificationDefaults == -1) {
            m65241a.enableLights(true);
            m65241a.setLightColor(-1);
        }
        notificationManager.createNotificationChannel(m65241a);
