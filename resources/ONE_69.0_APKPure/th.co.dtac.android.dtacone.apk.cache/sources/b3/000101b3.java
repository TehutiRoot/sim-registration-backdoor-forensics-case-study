...
public class BsonCodec implements Codec<Bson> {
    ...
    /* renamed from: b */
    public static final Codec f75889b = new BsonDocumentCodec();

    /* renamed from: a */
    public final CodecRegistry f75890a;

    public BsonCodec(CodecRegistry codecRegistry) {
        this.f75890a = codecRegistry;
    }
    ...
    public void encode(BsonWriter bsonWriter, Bson bson, EncoderContext encoderContext) {
        try {
            f75889b.encode(bsonWriter, bson.toBsonDocument(BsonDocument.class, this.f75890a), encoderContext);
        } catch (Exception e) {
