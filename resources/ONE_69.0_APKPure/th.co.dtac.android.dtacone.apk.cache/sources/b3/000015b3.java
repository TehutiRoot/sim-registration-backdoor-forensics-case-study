...
public final class C18745Wk1 {

    /* renamed from: a */
    public static final C18745Wk1 f7365a = new C18745Wk1();

    @JvmStatic
    @DoNotInline
    @NotNull
    /* renamed from: a */
    public static final PersistableBundle m65660a(int i) {
    ...
    @DoNotInline
    /* renamed from: b */
    public static final void m65659b(@NotNull PersistableBundle persistableBundle, @Nullable String str, @Nullable Object obj) {
        Intrinsics.checkNotNullParameter(persistableBundle, "persistableBundle");
        if (obj == null) {
            persistableBundle.putString(str, null);
        } else if (obj instanceof Boolean) {
            if (Build.VERSION.SDK_INT >= 22) {
                C18810Xk1.m65573a(persistableBundle, str, ((Boolean) obj).booleanValue());
                return;
            }
            ...
            if (Build.VERSION.SDK_INT >= 22) {
                C18810Xk1.m65572b(persistableBundle, str, (boolean[]) obj);
                return;
            }
            throw new IllegalArgumentException("Illegal value type boolean[] for key \"" + str + '\"');
        } else if (obj instanceof double[]) {
