...
public final class PermissionInfoCompat {
    ...
    /* loaded from: classes2.dex */
    public static class C3952a {
        @DoNotInline
        /* renamed from: a */
        public static int m57397a(PermissionInfo permissionInfo) {
            return permissionInfo.getProtection();
        }

        @DoNotInline
        /* renamed from: b */
        public static int m57396b(PermissionInfo permissionInfo) {
    ...
    public static int getProtection(@NonNull PermissionInfo permissionInfo) {
        if (Build.VERSION.SDK_INT >= 28) {
            return C3952a.m57397a(permissionInfo);
        }
    ...
    public static int getProtectionFlags(@NonNull PermissionInfo permissionInfo) {
        if (Build.VERSION.SDK_INT >= 28) {
            return C3952a.m57396b(permissionInfo);
        }
