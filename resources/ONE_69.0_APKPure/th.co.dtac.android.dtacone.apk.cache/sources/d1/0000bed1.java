...
public class setOnKeyListener implements setDarkTextColor.valueOf {
    private final setDarkTextColor valueOf;

    public setOnKeyListener(setDarkTextColor setdarktextcolor) {
    ...
    public getHeadingTextColor values() {
        return setDarkTextColor.mastercardSchemeConfiguration(this.valueOf);
    }
}