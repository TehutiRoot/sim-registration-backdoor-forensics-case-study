...
/* renamed from: th.co.dtac.android.dtacone.presenter.change_sim.ChangeSimReasonPresenter$getAuthorizationByRTR$2 */
/* loaded from: classes8.dex */
public final class ChangeSimReasonPresenter$getAuthorizationByRTR$2 extends Lambda implements Function1<GetAuthorizationByRtrResponse, Unit> {
    final /* synthetic */ ChangeSimReasonPresenter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ChangeSimReasonPresenter$getAuthorizationByRTR$2(ChangeSimReasonPresenter changeSimReasonPresenter) {
        super(1);
    ...
    public final void invoke2(GetAuthorizationByRtrResponse it) {
        ChangeSimReasonPresenter changeSimReasonPresenter = this.this$0;
        Intrinsics.checkNotNullExpressionValue(it, "it");
        changeSimReasonPresenter.getReasonChangeSim(it);
    }
}