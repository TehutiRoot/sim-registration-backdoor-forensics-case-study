...
@Metadata(m29143d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00020\u00040\u0003H\u008a@"}, m29142d2 = {"<anonymous>", "", "T", "Lkotlinx/coroutines/channels/ProducerScope;", "Lio/realm/RealmResults;"}, m29141k = 3, m29140mv = {1, 6, 0}, m29138xi = 48)
@DebugMetadata(m29093c = "io.realm.internal.coroutines.InternalFlowFactory$from$4", m29092f = "InternalFlowFactory.kt", m29091i = {}, m29090l = {216, 242}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
...
public final class InternalFlowFactory$from$4 extends SuspendLambda implements Function2<ProducerScope<? super RealmResults<T>>, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes5.dex */
    public static final class C113311 extends Lambda implements Function0<Unit> {
        public static final C113311 INSTANCE = new C113311();
    ...
    /* loaded from: classes5.dex */
    public static final class C113322 extends Lambda implements Function0<Unit> {
        final /* synthetic */ DynamicRealm $flowRealm;
        final /* synthetic */ RealmChangeListener<RealmResults<T>> $listener;
        final /* synthetic */ RealmResults<T> $results;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C113322(DynamicRealm dynamicRealm, RealmResults<T> realmResults, RealmChangeListener<RealmResults<T>> realmChangeListener) {
            super(0);
    ...
    public static final void m74260invokeSuspend$lambda0(ProducerScope producerScope, InternalFlowFactory internalFlowFactory, RealmResults realmResults) {
        boolean z;
        if (CoroutineScopeKt.isActive(producerScope)) {
            ...
            producerScope.mo74250trySendJP2dKIU(realmResults);
        }
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (!this.$results.isValid()) {
            C113311 c113311 = C113311.INSTANCE;
            this.label = 1;
            if (ProduceKt.awaitClose(producerScope, c113311, this) == coroutine_suspended) {
        ...
        RealmChangeListener realmChangeListener = new RealmChangeListener() { // from class: io.realm.internal.coroutines.j
            ...
            public final void onChange(Object obj2) {
                InternalFlowFactory$from$4.m74260invokeSuspend$lambda0(ProducerScope.this, internalFlowFactory, (RealmResults) obj2);
            }
        };
        ...
        if (z) {
            ...
            producerScope.mo74250trySendJP2dKIU(this.$results);
        }
        C113322 c113322 = new C113322(dynamicRealm, this.$results, realmChangeListener);
        this.label = 2;
        if (ProduceKt.awaitClose(producerScope, c113322, this) == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Unit.INSTANCE;
    }
