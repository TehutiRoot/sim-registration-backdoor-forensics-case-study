...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.deviceSaleTrueCompany.viewModel.OneDeviceSaleTrueViewModel$customerPreverify$1 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleTrueViewModel$customerPreverify$1 extends Lambda implements Function1<Disposable, Unit> {
    final /* synthetic */ OneDeviceSaleTrueViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneDeviceSaleTrueViewModel$customerPreverify$1(OneDeviceSaleTrueViewModel oneDeviceSaleTrueViewModel) {
        super(1);
