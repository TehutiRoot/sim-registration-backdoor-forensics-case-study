...
public class NegotiateScheme extends GGSSchemeBase {
    ...
    /* renamed from: g */
    public final Log f74071g;

    /* renamed from: h */
    public final SpnegoTokenGenerator f74072h;

    public NegotiateScheme(SpnegoTokenGenerator spnegoTokenGenerator, boolean z) {
        super(z);
        this.f74071g = LogFactory.getLog(getClass());
        this.f74072h = spnegoTokenGenerator;
    }
    ...
    public byte[] generateToken(byte[] bArr, String str, Credentials credentials) throws GSSException {
        ...
        try {
            ...
            if (e.getMajor() == 2) {
                this.f74071g.debug("GSSException BAD_MECH, retry with Kerberos MECH");
                z = true;
            } else {
                throw e;
            }
