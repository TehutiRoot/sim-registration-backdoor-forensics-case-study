...
public final class FlowableRepeat<T> extends AbstractC0558I {
    ...
    public static final class RepeatSubscriber<T> extends AtomicInteger implements FlowableSubscriber<T> {
        ...
        /* renamed from: sa */
        final SubscriptionArbiter f64531sa;
        ...
        public RepeatSubscriber(Subscriber<? super T> subscriber, long j, SubscriptionArbiter subscriptionArbiter, Publisher<? extends T> publisher) {
            ...
            this.f64531sa = subscriptionArbiter;
        ...
        public void onSubscribe(Subscription subscription) {
            this.f64531sa.setSubscription(subscription);
        }

        public void subscribeNext() {
            if (getAndIncrement() == 0) {
                int i = 1;
                while (!this.f64531sa.isCancelled()) {
                    long j = this.produced;
                    if (j != 0) {
                        this.produced = 0L;
                        this.f64531sa.produced(j);
                    }
