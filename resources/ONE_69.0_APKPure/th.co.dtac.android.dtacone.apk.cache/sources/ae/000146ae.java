...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.topup.viewModel.OneTopUpViewModel$getBuyDOLConsentByFeatureName$3 */
/* loaded from: classes10.dex */
public final class OneTopUpViewModel$getBuyDOLConsentByFeatureName$3 extends Lambda implements Function1<OneConsentResponse, Unit> {
    final /* synthetic */ String $featureCode;
    final /* synthetic */ OneTopUpViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneTopUpViewModel$getBuyDOLConsentByFeatureName$3(String str, OneTopUpViewModel oneTopUpViewModel) {
        super(1);
    ...
    public final void invoke2(OneConsentResponse oneConsentResponse) {
        ...
        m9220T.setValue(Resource.Companion.success(pair));
    }
}