...
public class CloudShellCredentials extends GoogleCredentials {
    ...
    public static class Builder extends GoogleCredentials.Builder {
        ...
        public Builder(CloudShellCredentials cloudShellCredentials) {
            this.f52424d = cloudShellCredentials.authPort;
        }
    ...
    public AccessToken refreshAccessToken() throws IOException {
        ...
        try {
            ...
            return new AccessToken(((List) IJ0.f2657f.createJsonParser(bufferedReader).parseArray(ArrayList.class, Object.class)).get(2).toString(), (Date) null);
        } finally {
            socket.close();
        }
    }
