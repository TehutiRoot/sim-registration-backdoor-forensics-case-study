...
@DebugMetadata(m29093c = "androidx.compose.foundation.text.selection.SelectionMagnifierKt$rememberAnimatedMagnifierPosition$1", m29092f = "SelectionMagnifier.kt", m29091i = {}, m29090l = {87}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
...
public final class SelectionMagnifierKt$rememberAnimatedMagnifierPosition$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes.dex */
    public static final class C30151 extends Lambda implements Function0<Offset> {
        final /* synthetic */ State<Offset> $targetValue$delegate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C30151(State<Offset> state) {
            super(0);
        ...
        public /* bridge */ /* synthetic */ Offset invoke() {
            return Offset.m71675boximpl(m70039invokeF1C5BW0());
        }

        /* renamed from: invoke-F1C5BW0  reason: not valid java name */
        public final long m70039invokeF1C5BW0() {
            return SelectionMagnifierKt.m60945b(this.$targetValue$delegate);
        }
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i != 0) {
            ...
            Flow snapshotFlow = SnapshotStateKt.snapshotFlow(new C30151(this.$targetValue$delegate));
            ...
            FlowCollector flowCollector = new FlowCollector() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$rememberAnimatedMagnifierPosition$1.2
                /* renamed from: a */
                public final Object m60944a(long j, Continuation continuation) {
                    if (OffsetKt.m71705isSpecifiedk4lQ0M(((Offset) Animatable.this.getValue()).m71696unboximpl()) && OffsetKt.m71705isSpecifiedk4lQ0M(j) && Offset.m71687getYimpl(((Offset) Animatable.this.getValue()).m71696unboximpl()) != Offset.m71687getYimpl(j)) {
                        AbstractC1539Vc.m65885e(coroutineScope, null, null, new C3017x2d93455c(Animatable.this, j, null), 3, null);
                        return Unit.INSTANCE;
                    }
                    Object snapTo = Animatable.this.snapTo(Offset.m71675boximpl(j), continuation);
                ...
                public /* bridge */ /* synthetic */ Object emit(Object obj2, Continuation continuation) {
                    return m60944a(((Offset) obj2).m71696unboximpl(), continuation);
                }
            };
            this.label = 1;
