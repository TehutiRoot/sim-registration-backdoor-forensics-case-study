...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.device_sale.DeviceSaleViewModel$checkBlockingPackage$1$1 */
/* loaded from: classes9.dex */
public final class DeviceSaleViewModel$checkBlockingPackage$1$1 extends Lambda implements Function1<Disposable, Unit> {
    final /* synthetic */ DeviceSaleViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DeviceSaleViewModel$checkBlockingPackage$1$1(DeviceSaleViewModel deviceSaleViewModel) {
        super(1);
