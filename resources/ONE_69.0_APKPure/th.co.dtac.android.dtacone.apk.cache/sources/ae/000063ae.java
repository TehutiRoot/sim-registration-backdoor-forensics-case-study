...
public final class WindowRecomposerPolicy {
    ...
    /* renamed from: a */
    public static final AtomicReference f30897a = new AtomicReference(WindowRecomposerFactory.Companion.getLifecycleAware());
    ...
    public final boolean compareAndSetFactory(@NotNull WindowRecomposerFactory expected, @NotNull WindowRecomposerFactory factory) {
        ...
        return AbstractC23094xo1.m479a(f30897a, expected, factory);
    }
    ...
    public final Recomposer createAndInstallWindowRecomposer$ui_release(@NotNull View rootView) {
        ...
        Recomposer createRecomposer = ((WindowRecomposerFactory) f30897a.get()).createRecomposer(rootView);
        WindowRecomposer_androidKt.setCompositionContext(rootView, createRecomposer);
        GlobalScope globalScope = GlobalScope.INSTANCE;
        Handler handler = rootView.getHandler();
        Intrinsics.checkNotNullExpressionValue(handler, "rootView.handler");
        m65885e = AbstractC1539Vc.m65885e(globalScope, HandlerDispatcherKt.from(handler, "windowRecomposer cleanup").getImmediate(), null, new C3565xbfd085b3(createRecomposer, rootView, null), 2, null);
    ...
    public final WindowRecomposerFactory getAndSetFactory(@NotNull WindowRecomposerFactory factory) {
        Intrinsics.checkNotNullParameter(factory, "factory");
        Object andSet = f30897a.getAndSet(factory);
    ...
    public final <R> R withFactory(@NotNull WindowRecomposerFactory factory, @NotNull Function0<? extends R> block) {
        ...
        try {
            ...
            try {
                ...
                InlineMarker.finallyStart(1);
                if (!compareAndSetFactory(factory, andSetFactory)) {
                    AbstractC10223fT.addSuppressed(th2, new IllegalStateException("WindowRecomposerFactory was set to unexpected value; cannot safely restore old state"));
                    throw th2;
                }
                InlineMarker.finallyEnd(1);
                throw th3;
