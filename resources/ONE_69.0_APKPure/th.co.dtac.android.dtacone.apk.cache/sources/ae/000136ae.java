...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.fragment.OnePostpaidIdCardFormFragment$onStart$1$5 */
/* loaded from: classes10.dex */
public final class OnePostpaidIdCardFormFragment$onStart$1$5 extends Lambda implements Function1<Resource<? extends Void>, Unit> {
    ...
    public OnePostpaidIdCardFormFragment$onStart$1$5(OnePostpaidRegistrationViewModel onePostpaidRegistrationViewModel, OnePostpaidIdCardFormFragment onePostpaidIdCardFormFragment) {
        super(1);
    ...
    public final void invoke2(Resource<Void> resource) {
        ...
        if (resourceContentIfNotHandled.getStatus() == StatusResource.SUCCESS) {
            onePostpaidRegistrationViewModel.clearSignatureFile();
            onePostpaidIdCardFormFragment.m12615A();
        }
    }
}