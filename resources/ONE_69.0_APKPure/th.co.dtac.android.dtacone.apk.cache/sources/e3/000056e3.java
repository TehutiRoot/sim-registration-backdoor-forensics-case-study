...
public final class C3191x6408c734 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    /* loaded from: classes.dex */
    public static final class C31921 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    ...
    /* loaded from: classes.dex */
    public static final class C31932 extends Lambda implements Function1<IntSize, Unit> {
        final /* synthetic */ PopupLayout $this_apply;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C31932(PopupLayout popupLayout) {
            super(1);
        ...
        public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
            m70347invokeozmzZPI(intSize.m74006unboximpl());
            return Unit.INSTANCE;
        }

        /* renamed from: invoke-ozmzZPI  reason: not valid java name */
        public final void m70347invokeozmzZPI(long j) {
            this.$this_apply.m70349setPopupContentSizefhxjrPA(IntSize.m73994boximpl(j));
    ...
    /* loaded from: classes.dex */
    public static final class C31943 extends Lambda implements Function2<Composer, Integer, Unit> {
        final /* synthetic */ State<Function2<Composer, Integer, Unit>> $currentContent$delegate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C31943(State<? extends Function2<? super Composer, ? super Integer, Unit>> state) {
            super(2);
        ...
        public final void invoke(@Nullable Composer composer, int i) {
            ...
            m60705a = ExposedDropdownMenuPopupKt.m60705a(this.$currentContent$delegate);
            m60705a.invoke(composer, 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public C3191x6408c734(PopupLayout popupLayout, State<? extends Function2<? super Composer, ? super Integer, Unit>> state) {
        super(2);
        this.$this_apply = popupLayout;
        this.$currentContent$delegate = state;
    }
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        Modifier alpha = AlphaKt.alpha(OnRemeasuredModifierKt.onSizeChanged(SemanticsModifierKt.semantics$default(Modifier.Companion, false, C31921.INSTANCE, 1, null), new C31932(this.$this_apply)), this.$this_apply.getCanCalculatePosition() ? 1.0f : 0.0f);
        ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer, 2080999218, true, new C31943(this.$currentContent$delegate));
        ...
        Updater.m71584setimpl(m71577constructorimpl, exposedDropdownMenuPopupKt$SimpleStack$1, companion.getSetMeasurePolicy());
