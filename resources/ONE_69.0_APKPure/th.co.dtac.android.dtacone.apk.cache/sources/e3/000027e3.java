...
@Metadata(m29143d1 = {"\u0000\u0016\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\u001a\u001d\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u0001¢\u0006\u0002\u0010\u0006¨\u0006\u0007"}, m29142d2 = {"rememberLazyStaggeredGridSemanticState", "Landroidx/compose/foundation/lazy/layout/LazyLayoutSemanticState;", RemoteConfigConstants.ResponseFieldKey.STATE, "Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridState;", "reverseScrolling", "", "(Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridState;ZLandroidx/compose/runtime/Composer;I)Landroidx/compose/foundation/lazy/layout/LazyLayoutSemanticState;", "foundation_release"}, m29141k = 2, m29140mv = {1, 8, 0}, m29138xi = 48)
...
public final class LazyStaggeredGridSemanticsKt {
    ...
    public static final LazyLayoutSemanticState rememberLazyStaggeredGridSemanticState(@NotNull final LazyStaggeredGridState state, boolean z, @Nullable Composer composer, int i) {
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new LazyLayoutSemanticState() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridSemanticsKt$rememberLazyStaggeredGridSemanticState$1$1
                ...
                public Object animateScrollBy(float f, @NotNull Continuation<? super Unit> continuation) {
                    ...
                    if (animateScrollBy$default == AbstractC19782eg0.getCOROUTINE_SUSPENDED()) {
                ...
                public Object scrollToItem(int i2, @NotNull Continuation<? super Unit> continuation) {
                    ...
                    if (scrollToItem$default == AbstractC19782eg0.getCOROUTINE_SUSPENDED()) {
        ...
        C2937x9388a700 c2937x9388a700 = (C2937x9388a700) rememberedValue;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return c2937x9388a700;
    }
}