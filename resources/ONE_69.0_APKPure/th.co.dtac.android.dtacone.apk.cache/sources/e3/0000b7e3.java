...
public final class SMSMMSResultParser extends ResultParser {
    /* renamed from: g */
    public static void m34178g(Collection collection, Collection collection2, String str) {
    ...
    public SMSParsedResult parse(Result result) {
        ...
        if (m34180e == null || m34180e.isEmpty()) {
            z = false;
            str = null;
        } else {
            str2 = (String) m34180e.get("subject");
            str = (String) m34180e.get("body");
            z = true;
        }
        ...
        while (true) {
            ...
            if (indexOf2 > i) {
                m34178g(arrayList, arrayList2, substring.substring(i2, indexOf2));
                i = indexOf2;
            } else {
                m34178g(arrayList, arrayList2, substring.substring(i2));
