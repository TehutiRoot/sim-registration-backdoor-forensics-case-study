...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.device_sale.fragment.OneDeviceSaleInputIMEIFragment$onStart$1$4 */
/* loaded from: classes10.dex */
public final class OneDeviceSaleInputIMEIFragment$onStart$1$4 extends Lambda implements Function1<Resource<? extends Void>, Unit> {
    final /* synthetic */ OneDeviceSaleInputIMEIFragment this$0;

    @Metadata(m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    /* renamed from: th.co.dtac.android.dtacone.view.appOne.device_sale.fragment.OneDeviceSaleInputIMEIFragment$onStart$1$4$WhenMappings */
    /* loaded from: classes10.dex */
    ...
    public OneDeviceSaleInputIMEIFragment$onStart$1$4(OneDeviceSaleInputIMEIFragment oneDeviceSaleInputIMEIFragment) {
        super(1);
    ...
    public final void invoke2(Resource<Void> resource) {
        ...
        if (i != 1) {
            ...
            oneDeviceSaleInputIMEIFragment.dismissSecondaryLoading();
            return;
        }
        FragmentActivity ctx = oneDeviceSaleInputIMEIFragment.getActivity();
        if (ctx != null) {
            ...
            oneDeviceSaleInputIMEIFragment.getViewModel().getNeedUpdateSubscribeInfo().postValue(new Event<>(toastMessage));
        }
        oneDeviceSaleInputIMEIFragment.dismissSecondaryLoading();
        FragmentActivity activity = oneDeviceSaleInputIMEIFragment.getActivity();
