...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.home.viewModel.OneHomeViewModel$getMrtrPrepaidMultiSimAuthorization$3 */
/* loaded from: classes10.dex */
public final class OneHomeViewModel$getMrtrPrepaidMultiSimAuthorization$3 extends Lambda implements Function1<GetAuthorizationByRtrResponse, Unit> {
    final /* synthetic */ String $featureCode;
    final /* synthetic */ OneHomeViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneHomeViewModel$getMrtrPrepaidMultiSimAuthorization$3(OneHomeViewModel oneHomeViewModel, String str) {
        super(1);
    ...
    public final void invoke2(GetAuthorizationByRtrResponse getAuthorizationByRtrResponse) {
        ...
        m14065Q.setValue(Resource.Companion.success(getAuthorizationByRtrResponse));
    }
}