...
public final class BundleCompat {
    ...
    public static class C4016a {
        @DoNotInline
        /* renamed from: a */
        public static <T> T m57150a(@NonNull Bundle bundle, @Nullable String str, @NonNull Class<T> cls) {
            return (T) bundle.getParcelable(str, cls);
        }

        @DoNotInline
        /* renamed from: b */
        public static <T> T[] m57149b(@NonNull Bundle bundle, @Nullable String str, @NonNull Class<T> cls) {
            return (T[]) bundle.getParcelableArray(str, cls);
        }

        @DoNotInline
        /* renamed from: c */
        public static <T> ArrayList<T> m57148c(@NonNull Bundle bundle, @Nullable String str, @NonNull Class<? extends T> cls) {
            return bundle.getParcelableArrayList(str, cls);
        }

        @DoNotInline
        /* renamed from: d */
        public static <T> SparseArray<T> m57147d(@NonNull Bundle bundle, @Nullable String str, @NonNull Class<? extends T> cls) {
    ...
    public static <T> T getParcelable(@NonNull Bundle bundle, @Nullable String str, @NonNull Class<T> cls) {
        if (BuildCompat.isAtLeastU()) {
            return (T) C4016a.m57150a(bundle, str, cls);
        }
    ...
    public static Parcelable[] getParcelableArray(@NonNull Bundle bundle, @Nullable String str, @NonNull Class<? extends Parcelable> cls) {
        if (BuildCompat.isAtLeastU()) {
            return (Parcelable[]) C4016a.m57149b(bundle, str, cls);
        }
    ...
    public static <T> ArrayList<T> getParcelableArrayList(@NonNull Bundle bundle, @Nullable String str, @NonNull Class<? extends T> cls) {
        if (BuildCompat.isAtLeastU()) {
            return C4016a.m57148c(bundle, str, cls);
        }
    ...
    public static <T> SparseArray<T> getSparseParcelableArray(@NonNull Bundle bundle, @Nullable String str, @NonNull Class<? extends T> cls) {
        if (BuildCompat.isAtLeastU()) {
            return C4016a.m57147d(bundle, str, cls);
        }
