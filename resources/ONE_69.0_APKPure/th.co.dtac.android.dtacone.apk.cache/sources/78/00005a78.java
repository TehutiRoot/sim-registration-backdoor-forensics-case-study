...
public final class SliderKt$RangeSlider$3 extends Lambda implements Function3<SliderPositions, Composer, Integer, Unit> {
    ...
    public SliderKt$RangeSlider$3(MutableInteractionSource mutableInteractionSource, SliderColors sliderColors, boolean z, int i) {
        super(3);
    ...
    public final void invoke(@NotNull SliderPositions it, @Nullable Composer composer, int i) {
        ...
        int i2 = this.$$dirty;
        sliderDefaults.m70724Thumb9LiSoMs(mutableInteractionSource, null, sliderColors, z, 0L, composer, ((i2 >> 15) & 896) | 196614 | (i2 & 7168), 18);
        if (ComposerKt.isTraceInProgress()) {
