...
public final class DialogHostKt {
    ...
    public static final void DialogHost(@NotNull DialogNavigator dialogNavigator, @Nullable Composer composer, int i) {
        ...
        if ((i2 & 11) == 2 && startRestartGroup.getSkipping()) {
            ...
            SnapshotStateList<NavBackStackEntry> rememberVisibleList = rememberVisibleList(m53777a(collectAsState), startRestartGroup, 8);
            PopulateVisibleList(rememberVisibleList, m53777a(collectAsState), startRestartGroup, 64);
    ...
    /* renamed from: a */
    public static final List m53777a(State state) {
