...
public enum zzoe implements zzxk {
    UNKNOWN_EVENT(0),
    ...
    ON_DEVICE_IMAGE_LABEL_LOAD(SyslogConstants.LOG_LOCAL2),
    ON_DEVICE_SMART_REPLY_DETECT(151),
    ON_DEVICE_SMART_REPLY_CREATE(SyslogConstants.LOG_LOCAL3),
    ...
    ON_DEVICE_OBJECT_LOAD(CertificateHolderAuthorization.CVCA),
    ...
    CLOUD_TEXT_CLOSE(CameraActivity.REQUEST_CODE),
    ...
    AUTOML_IMAGE_LABELING_LOAD(SyslogConstants.LOG_LOCAL7),
    MODEL_DOWNLOAD(100),
    MODEL_UPDATE(101),
    ...
    private static final zzxn<zzoe> zzac = new zzxn() { // from class: pJ2
    };
    ...
    public static zzoe zzax(int i) {
        switch (i) {
            ...
            case SyslogConstants.LOG_LOCAL2 /* 144 */:
                return ON_DEVICE_IMAGE_LABEL_LOAD;
            case 151:
            ...
            case 361:
                return INPUT_IMAGE_CONSTRUCTION;
            case 371:
                return HANDLE_LEAKED;
            default:
                return null;
        }
    }
    ...
    public static zzxm zzf() {
        return C21804qJ2.f77164a;
    }

    @Override // java.lang.Enum
    public final String toString() {
        return "<" + zzoe.class.getName() + '@' + Integer.toHexString(System.identityHashCode(this)) + " number=" + this.value + " name=" + name() + Typography.greater;
    }
