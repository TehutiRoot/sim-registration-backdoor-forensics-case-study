...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.change_owner.fragment.OneChangeOwnerVerifyOtpFragment$onStart$1$4 */
/* loaded from: classes10.dex */
public final class OneChangeOwnerVerifyOtpFragment$onStart$1$4 extends Lambda implements Function1<FragmentNavEvent, Unit> {
    final /* synthetic */ OneChangeOwnerVerifyOtpFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneChangeOwnerVerifyOtpFragment$onStart$1$4(OneChangeOwnerVerifyOtpFragment oneChangeOwnerVerifyOtpFragment) {
        super(1);
    ...
    public final void invoke2(@NotNull FragmentNavEvent event) {
        ...
        if (Intrinsics.areEqual(event.getClazz(), UpPassFormFragment.class)) {
            ...
            this.this$0.getChangeOwnerActivity().replaceFragment(event.buildFragment(), event.getTag());
        }
    }
}