...
public final class SurfaceKt$Surface$13 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        m60754b = SurfaceKt.m60754b(this.$color, (ElevationOverlay) composer.consume(ElevationOverlayKt.getLocalElevationOverlay()), this.$absoluteElevation, composer, (this.$$dirty >> 9) & 14);
        m60755a = SurfaceKt.m60755a(minimumInteractiveComponentSize, shape, m60754b, this.$border, this.$elevation);
        Modifier then = m60755a.then(ClickableKt.m69528clickableO2vRcR0(Modifier.Companion, this.$interactionSource, this.$indication, this.$enabled, this.$onClickLabel, this.$role, this.$onClick));
