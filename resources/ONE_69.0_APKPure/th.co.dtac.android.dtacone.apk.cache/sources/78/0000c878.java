...
public abstract class AbstractC20231hE1 {
    /* renamed from: a */
    public static Rect m31261a(PDImage pDImage, Rect rect) {
        if (rect == null) {
    ...
    */
    public static android.graphics.Bitmap m31260b(java.io.InputStream r7, int r8, int r9, int r10) {
        /*
        ...
        L71:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.AbstractC20231hE1.m31260b(java.io.InputStream, int, int, int):android.graphics.Bitmap");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static android.graphics.Bitmap m31259c(com.tom_roush.pdfbox.pdmodel.graphics.image.PDImage r22, android.graphics.Rect r23, int r24, int r25, int r26) {
        /*
            Method dump skipped, instructions count: 246
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.AbstractC20231hE1.m31259c(com.tom_roush.pdfbox.pdmodel.graphics.image.PDImage, android.graphics.Rect, int, int, int):android.graphics.Bitmap");
    }

    /* renamed from: d */
    public static Bitmap m31258d(PDImage pDImage, Rect rect, int i, int i2, int i3) {
        int i4;
        int width;
        int height;
        int i5;
        ...
        try {
            ...
            if (i5 == 0 && i4 == 0 && width == i2 && height == i3) {
                return m31260b(createInputStream, i6, numberOfComponents, i7);
            }
            Bitmap m31260b = m31260b(createInputStream, i6, numberOfComponents, i7);
            if (i7 > 1) {
                i5 /= i7;
                i4 /= i7;
            }
            return Bitmap.createBitmap(m31260b, i5, i4, i2, i3);
        } finally {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static float[] m31257e(com.tom_roush.pdfbox.pdmodel.graphics.image.PDImage r10) {
        /*
            r0 = 1
            r1 = 0
            r2 = 2
        ...
        La4:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.AbstractC20231hE1.m31257e(com.tom_roush.pdfbox.pdmodel.graphics.image.PDImage):float[]");
    }

    /* renamed from: f */
    public static Bitmap m31256f(PDImage pDImage, Rect rect, int i, COSArray cOSArray) {
        if (!pDImage.isEmpty()) {
            Rect m31261a = m31261a(pDImage, rect);
            int numberOfComponents = pDImage.getColorSpace().getNumberOfComponents();
            int ceil = (int) Math.ceil(m31261a.width() / i);
            int ceil2 = (int) Math.ceil(m31261a.height() / i);
            ...
            if (ceil > 0 && ceil2 > 0 && pDImage.getWidth() > 0 && pDImage.getHeight() > 0) {
                try {
                    if (bitsPerComponent == 1 && cOSArray == null && numberOfComponents == 1) {
                        return m31259c(pDImage, m31261a, i, ceil, ceil2);
                    }
                    float[] defaultDecode = pDImage.getColorSpace().getDefaultDecode(8);
                    float[] m31257e = m31257e(pDImage);
                    if (pDImage.getSuffix() != null && pDImage.getSuffix().equals("jpg") && i == 1) {
                        return BitmapFactory.decodeStream(pDImage.createInputStream());
                    }
                    if (bitsPerComponent == 8 && cOSArray == null && Arrays.equals(m31257e, defaultDecode)) {
                        return m31258d(pDImage, m31261a, i, ceil, ceil2);
                    }
                    return m31258d(pDImage, m31261a, i, ceil, ceil2);
    ...
    /* renamed from: g */
    public static Bitmap m31255g(PDImage pDImage, COSArray cOSArray) {
        return m31256f(pDImage, null, 1, cOSArray);
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static android.graphics.Bitmap m31254h(com.tom_roush.pdfbox.pdmodel.graphics.image.PDImage r17, android.graphics.Paint r18) {
        /*
            int r0 = r17.getWidth()
            ...
            float[] r3 = m31257e(r17)     // Catch: java.lang.Throwable -> L67
            r5 = 0
        ...
        L97:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.AbstractC20231hE1.m31254h(com.tom_roush.pdfbox.pdmodel.graphics.image.PDImage, android.graphics.Paint):android.graphics.Bitmap");
    }
}