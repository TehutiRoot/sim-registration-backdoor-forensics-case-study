...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.home.viewModel.OneHomeViewModel$getPriceList$3 */
/* loaded from: classes10.dex */
public final class OneHomeViewModel$getPriceList$3 extends Lambda implements Function1<OneBuyDolPriceListResponse, Unit> {
    final /* synthetic */ String $featureCode;
    final /* synthetic */ OneHomeViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneHomeViewModel$getPriceList$3(String str, OneHomeViewModel oneHomeViewModel) {
        super(1);
    ...
    public final void invoke2(OneBuyDolPriceListResponse oneBuyDolPriceListResponse) {
        ...
        m14061U.setValue(Resource.Companion.success(pair));
    }
}