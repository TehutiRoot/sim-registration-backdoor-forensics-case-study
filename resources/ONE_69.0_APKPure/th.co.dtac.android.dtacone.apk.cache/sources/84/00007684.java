...
public final class WorkDatabase_Impl extends WorkDatabase {
    ...
    /* renamed from: m */
    public volatile WorkSpecDao f38418m;

    /* renamed from: n */
    public volatile DependencyDao f38419n;

    /* renamed from: o */
    public volatile WorkTagDao f38420o;

    /* renamed from: p */
    public volatile SystemIdInfoDao f38421p;

    /* renamed from: q */
    public volatile WorkNameDao f38422q;

    /* renamed from: r */
    public volatile WorkProgressDao f38423r;

    /* renamed from: s */
    public volatile PreferenceDao f38424s;

    /* renamed from: t */
    public volatile RawWorkInfoDao f38425t;

    /* renamed from: androidx.work.impl.WorkDatabase_Impl$a */
    /* loaded from: classes.dex */
    public class C5206a extends RoomOpenHelper.Delegate {
        public C5206a(int i) {
            super(i);
        }
        ...
        public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase supportSQLiteDatabase) {
            ...
            hashMap.put("work_spec_id", new TableInfo.Column("work_spec_id", Constant.CampaignType.TYPE_TEXT, true, 1, null, 1));
            hashMap.put("prerequisite_id", new TableInfo.Column("prerequisite_id", Constant.CampaignType.TYPE_TEXT, true, 2, null, 1));
            ...
            hashMap2.put("id", new TableInfo.Column("id", Constant.CampaignType.TYPE_TEXT, true, 1, null, 1));
            ...
            hashMap2.put("worker_class_name", new TableInfo.Column("worker_class_name", Constant.CampaignType.TYPE_TEXT, true, 0, null, 1));
            hashMap2.put("input_merger_class_name", new TableInfo.Column("input_merger_class_name", Constant.CampaignType.TYPE_TEXT, true, 0, null, 1));
            ...
            hashMap3.put("tag", new TableInfo.Column("tag", Constant.CampaignType.TYPE_TEXT, true, 1, null, 1));
            hashMap3.put("work_spec_id", new TableInfo.Column("work_spec_id", Constant.CampaignType.TYPE_TEXT, true, 2, null, 1));
            ...
            hashMap4.put("work_spec_id", new TableInfo.Column("work_spec_id", Constant.CampaignType.TYPE_TEXT, true, 1, null, 1));
            ...
            hashMap5.put("name", new TableInfo.Column("name", Constant.CampaignType.TYPE_TEXT, true, 1, null, 1));
            hashMap5.put("work_spec_id", new TableInfo.Column("work_spec_id", Constant.CampaignType.TYPE_TEXT, true, 2, null, 1));
            ...
            hashMap6.put("work_spec_id", new TableInfo.Column("work_spec_id", Constant.CampaignType.TYPE_TEXT, true, 1, null, 1));
            ...
            hashMap7.put(Action.KEY_ATTRIBUTE, new TableInfo.Column(Action.KEY_ATTRIBUTE, Constant.CampaignType.TYPE_TEXT, true, 1, null, 1));
    ...
    public SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration databaseConfiguration) {
        return databaseConfiguration.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(databaseConfiguration.context).name(databaseConfiguration.name).callback(new RoomOpenHelper(databaseConfiguration, new C5206a(20), "7d73d21f1bd82c9e5268b6dcf9fde2cb", "3071c8717539de5d5353f4c8cd59a032")).build());
    }
    ...
    public DependencyDao dependencyDao() {
        ...
        synchronized (this) {
            try {
                if (this.f38419n == null) {
                    this.f38419n = new DependencyDao_Impl(this);
                }
                dependencyDao = this.f38419n;
            } catch (Throwable th2) {
                throw th2;
            }
        }
    ...
    public List<Migration> getAutoMigrations(@NonNull Map<Class<? extends AutoMigrationSpec>, AutoMigrationSpec> map) {
        return Arrays.asList(new C19173b72(), new C19346c72(), new C19519d72(), new C19692e72(), new C19865f72(), new C20038g72());
    }
    ...
    public PreferenceDao preferenceDao() {
        ...
        if (this.f38424s != null) {
            return this.f38424s;
        }
        synchronized (this) {
            try {
                if (this.f38424s == null) {
                    this.f38424s = new PreferenceDao_Impl(this);
                }
                preferenceDao = this.f38424s;
            } catch (Throwable th2) {
                throw th2;
            }
        }
    ...
    public RawWorkInfoDao rawWorkInfoDao() {
        ...
        synchronized (this) {
            try {
                if (this.f38425t == null) {
                    this.f38425t = new RawWorkInfoDao_Impl(this);
                }
                rawWorkInfoDao = this.f38425t;
            } catch (Throwable th2) {
                throw th2;
            }
        }
    ...
    public SystemIdInfoDao systemIdInfoDao() {
        ...
        if (this.f38421p != null) {
            return this.f38421p;
        }
        synchronized (this) {
            try {
                if (this.f38421p == null) {
                    this.f38421p = new SystemIdInfoDao_Impl(this);
                }
                systemIdInfoDao = this.f38421p;
            } catch (Throwable th2) {
                throw th2;
            }
        }
    ...
    public WorkNameDao workNameDao() {
        ...
        synchronized (this) {
            try {
                if (this.f38422q == null) {
                    this.f38422q = new WorkNameDao_Impl(this);
                }
                workNameDao = this.f38422q;
            } catch (Throwable th2) {
                throw th2;
            }
        }
    ...
    public WorkProgressDao workProgressDao() {
        ...
        if (this.f38423r != null) {
            return this.f38423r;
        }
        synchronized (this) {
            try {
                if (this.f38423r == null) {
                    this.f38423r = new WorkProgressDao_Impl(this);
                }
                workProgressDao = this.f38423r;
            } catch (Throwable th2) {
                throw th2;
            }
        }
    ...
    public WorkSpecDao workSpecDao() {
        ...
        synchronized (this) {
            try {
                if (this.f38418m == null) {
                    this.f38418m = new WorkSpecDao_Impl(this);
                }
                workSpecDao = this.f38418m;
            } catch (Throwable th2) {
                throw th2;
            }
        }
    ...
    public WorkTagDao workTagDao() {
        ...
        synchronized (this) {
            try {
                if (this.f38420o == null) {
                    this.f38420o = new WorkTagDao_Impl(this);
                }
                workTagDao = this.f38420o;
            } catch (Throwable th2) {
                throw th2;
            }
        }
