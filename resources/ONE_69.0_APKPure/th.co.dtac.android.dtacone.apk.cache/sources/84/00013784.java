...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.postpaid_registration.fragment.consent.OnePostpaidConsentNonTelcoFragment$onStart$1$1 */
/* loaded from: classes10.dex */
public final class OnePostpaidConsentNonTelcoFragment$onStart$1$1 extends Lambda implements Function1<FragmentNavEvent, Unit> {
    final /* synthetic */ OnePostpaidConsentNonTelcoFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePostpaidConsentNonTelcoFragment$onStart$1$1(OnePostpaidConsentNonTelcoFragment onePostpaidConsentNonTelcoFragment) {
        super(1);
    ...
    public final void invoke2(@NotNull FragmentNavEvent it) {
        OnePostpaidRegistrationActivity m12319s;
        Intrinsics.checkNotNullParameter(it, "it");
        m12319s = this.this$0.m12319s();
        m12319s.replaceFragment(it.buildFragment(), it.getTag());
    }
}