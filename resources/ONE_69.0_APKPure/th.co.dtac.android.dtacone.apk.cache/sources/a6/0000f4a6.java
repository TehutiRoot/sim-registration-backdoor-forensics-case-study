...
public class IDEACBCPar extends ASN1Object {
    ...
    /* renamed from: iv */
    ASN1OctetString f74762iv;

    private IDEACBCPar(ASN1Sequence aSN1Sequence) {
        this.f74762iv = aSN1Sequence.size() == 1 ? (ASN1OctetString) aSN1Sequence.getObjectAt(0) : null;
    }
    ...
    public byte[] getIV() {
        ASN1OctetString aSN1OctetString = this.f74762iv;
    ...
    public IDEACBCPar(byte[] bArr) {
        this.f74762iv = new DEROctetString(bArr);
    }
}