...
public final class StreamUseCaseUtil {
    ...
    /* renamed from: a */
    public static final Map f10530a;

    /* renamed from: b */
    public static final Map f10531b;
    ...
    /* renamed from: a */
    public static boolean m63685a(Set set, Set set2) {
    ...
    public static boolean areCaptureTypesEligible(@NonNull Map<Integer, AttachedSurfaceInfo> map, @NonNull Map<Integer, UseCaseConfig<?>> map2, @NonNull List<SurfaceConfig> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if (map.containsKey(Integer.valueOf(i))) {
                ...
                if (!m63683c(captureType, streamUseCase, attachedSurfaceInfo.getCaptureTypes())) {
                    return false;
                }
                ...
                if (!m63683c(captureType2, streamUseCase, emptyList)) {
                    return false;
                }
            } else {
    ...
    /* renamed from: b */
    public static Config m63684b(Config config, long j) {
    ...
    /* renamed from: c */
    public static boolean m63683c(UseCaseConfigFactory.CaptureType captureType, long j, List list) {
        if (Build.VERSION.SDK_INT < 33) {
            return false;
        }
    ...
    public static boolean containsZslUseCase(@NonNull List<AttachedSurfaceInfo> list, @NonNull List<UseCaseConfig<?>> list2) {
        for (AttachedSurfaceInfo attachedSurfaceInfo : list) {
            if (m63681e(attachedSurfaceInfo.getImplementationOptions(), attachedSurfaceInfo.getCaptureTypes().get(0))) {
                return true;
            }
        }
        for (UseCaseConfig<?> useCaseConfig : list2) {
            if (m63681e(useCaseConfig, useCaseConfig.getCaptureType())) {
                return true;
            }
        }
        return false;
    ...
    */
    public static boolean m63682d(java.util.List r10, java.util.List r11, java.util.Set r12) {
        /*
        ...
        L87:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.camera.camera2.internal.StreamUseCaseUtil.m63682d(java.util.List, java.util.List, java.util.Set):boolean");
    }

    /* renamed from: e */
    public static boolean m63681e(Config config, UseCaseConfigFactory.CaptureType captureType) {
    ...
    public static boolean populateStreamUseCaseStreamSpecOptionWithInteropOverride(@NonNull CameraCharacteristicsCompat cameraCharacteristicsCompat, @NonNull List<AttachedSurfaceInfo> list, @NonNull Map<UseCaseConfig<?>, StreamSpec> map, @NonNull Map<AttachedSurfaceInfo, StreamSpec> map2) {
        ...
        if (jArr != null && jArr.length != 0) {
            ...
            if (m63682d(list, arrayList, hashSet)) {
                for (AttachedSurfaceInfo attachedSurfaceInfo2 : list) {
                    ...
                    Config m63684b = m63684b(implementationOptions, ((Long) implementationOptions.retrieveOption(Camera2ImplConfig.STREAM_USE_CASE_OPTION)).longValue());
                    if (m63684b != null) {
                        map2.put(attachedSurfaceInfo2, attachedSurfaceInfo2.toStreamSpec(m63684b));
                    }
                }
                ...
                while (it.hasNext()) {
                    ...
                    Config m63684b2 = m63684b(implementationOptions2, ((Long) implementationOptions2.retrieveOption(Camera2ImplConfig.STREAM_USE_CASE_OPTION)).longValue());
                    if (m63684b2 != null) {
                        map.put(useCaseConfig2, streamSpec.toBuilder().setImplementationOptions(m63684b2).build());
                    }
                }
                return true;
            }
    ...
    public static void populateStreamUseCaseStreamSpecOptionWithSupportedSurfaceConfigs(@NonNull Map<UseCaseConfig<?>, StreamSpec> map, @NonNull Map<AttachedSurfaceInfo, StreamSpec> map2, @NonNull Map<Integer, AttachedSurfaceInfo> map3, @NonNull Map<Integer, UseCaseConfig<?>> map4, @NonNull List<SurfaceConfig> list) {
        for (int i = 0; i < list.size(); i++) {
            ...
            if (map3.containsKey(Integer.valueOf(i))) {
                ...
                Config m63684b = m63684b(attachedSurfaceInfo.getImplementationOptions(), streamUseCase);
                if (m63684b != null) {
                    map2.put(attachedSurfaceInfo, attachedSurfaceInfo.toStreamSpec(m63684b));
                }
                ...
                Config m63684b2 = m63684b(streamSpec.getImplementationOptions(), streamUseCase);
                if (m63684b2 != null) {
                    map.put(useCaseConfig, streamSpec.toBuilder().setImplementationOptions(m63684b2).build());
                }
            } else {
                throw new AssertionError("SurfaceConfig does not map to any use case");
            }
    ...
    public static void populateSurfaceToStreamUseCaseMapping(@NonNull Collection<SessionConfig> collection, @NonNull Collection<UseCaseConfig<?>> collection2, @NonNull Map<DeferrableSurface, Long> map) {
        ...
        for (SessionConfig sessionConfig : collection) {
            ...
            if (implementationOptions.containsOption(option) && sessionConfig.getSurfaces().size() != 1) {
                Logger.m63176e("Camera2CameraImpl", String.format("SessionConfig has stream use case but also contains %d surfaces, abort populateSurfaceToStreamUseCaseMapping().", Integer.valueOf(sessionConfig.getSurfaces().size())));
                return;
    ...
    public static boolean shouldUseStreamUseCase(@NonNull C2411j.AbstractC2413b abstractC2413b) {
        if (abstractC2413b.mo63345a() == 0 && abstractC2413b.mo63344b() == 8) {
            return true;
        }
        return false;
    }
