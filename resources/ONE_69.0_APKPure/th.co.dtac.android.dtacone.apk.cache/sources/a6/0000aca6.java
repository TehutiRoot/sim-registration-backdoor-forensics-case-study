...
public final class Chars {
    ...
    public static class CharArrayAsList extends AbstractList<Character> implements RandomAccess, Serializable {
        ...
        public boolean contains(@CheckForNull Object obj) {
            if ((obj instanceof Character) && Chars.m39856d(this.array, ((Character) obj).charValue(), this.start, this.end) != -1) {
                return true;
            }
            return false;
        }
        ...
        public int indexOf(@CheckForNull Object obj) {
            int m39856d;
            if ((obj instanceof Character) && (m39856d = Chars.m39856d(this.array, ((Character) obj).charValue(), this.start, this.end)) >= 0) {
                return m39856d - this.start;
            }
            return -1;
        }
        ...
        public int lastIndexOf(@CheckForNull Object obj) {
            int m39855e;
            if ((obj instanceof Character) && (m39855e = Chars.m39855e(this.array, ((Character) obj).charValue(), this.start, this.end)) >= 0) {
                return m39855e - this.start;
            }
            return -1;
        }
    ...
    /* renamed from: c */
    public static int m39857c(long j) {
        boolean z;
        int i = (int) j;
        if (j == i) {
            z = true;
    ...
    /* renamed from: d */
    public static int m39856d(char[] cArr, char c, int i, int i2) {
        while (i < i2) {
            if (cArr[i] == c) {
                return i;
            }
    ...
    /* renamed from: e */
    public static int m39855e(char[] cArr, char c, int i, int i2) {
    ...
    public static int indexOf(char[] cArr, char c) {
        return m39856d(cArr, c, 0, cArr.length);
    }
    ...
    public static int lastIndexOf(char[] cArr, char c) {
        return m39855e(cArr, c, 0, cArr.length);
    }
