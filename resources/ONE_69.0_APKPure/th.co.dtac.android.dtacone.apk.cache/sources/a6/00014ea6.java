...
/* renamed from: th.co.dtac.android.dtacone.view.fragment.mrtr_change_sim.qrCode.ESimChangeSIMShowQrCodeFragment$initViewModel$1$4 */
/* loaded from: classes9.dex */
public final class ESimChangeSIMShowQrCodeFragment$initViewModel$1$4 extends Lambda implements Function1<StatusResource, Unit> {
    final /* synthetic */ ESimChangeSIMShowQrCodeFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimChangeSIMShowQrCodeFragment$initViewModel$1$4(ESimChangeSIMShowQrCodeFragment eSimChangeSIMShowQrCodeFragment) {
        super(1);
    ...
    public final void invoke2(StatusResource statusResource) {
        this.this$0.m6310H(statusResource);
    }
}