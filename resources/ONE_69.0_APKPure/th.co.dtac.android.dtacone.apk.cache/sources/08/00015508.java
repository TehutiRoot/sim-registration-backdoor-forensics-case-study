...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.customerenquiry.SubscriberInfoViewModel$getActivationCode$4 */
/* loaded from: classes9.dex */
public final class SubscriberInfoViewModel$getActivationCode$4 extends Lambda implements Function1<ActivationCodeResponse, Unit> {
    final /* synthetic */ SubscriberInfoViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SubscriberInfoViewModel$getActivationCode$4(SubscriberInfoViewModel subscriberInfoViewModel) {
        super(1);
    ...
    public final void invoke2(ActivationCodeResponse activationCodeResponse) {
        MutableLiveData m3092T;
        m3092T = this.this$0.m3092T();
        m3092T.setValue(Resource.Companion.success(activationCodeResponse));
    }
}