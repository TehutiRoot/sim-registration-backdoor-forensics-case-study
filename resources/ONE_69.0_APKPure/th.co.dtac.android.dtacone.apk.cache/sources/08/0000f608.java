...
public class SM2KeyExchange {
    ...
    /* renamed from: S1 */
    private byte[] m24731S1(Digest digest, ECPoint eCPoint, byte[] bArr) {
    ...
    /* renamed from: S2 */
    private byte[] m24730S2(Digest digest, ECPoint eCPoint, byte[] bArr) {
    ...
    private BigInteger reduce(BigInteger bigInteger) {
        return bigInteger.and(BigInteger.valueOf(1L).shiftLeft(this.f74832w).subtract(BigInteger.valueOf(1L))).setBit(this.f74832w);
    }
    ...
    public byte[][] calculateKeyWithConfirmation(int i, byte[] bArr, CipherParameters cipherParameters) {
        ...
        if (!this.initiator) {
            ...
            return new byte[][]{kdf, m24731S1(this.digest, calculateU, calculateInnerHash), m24730S2(this.digest, calculateU, calculateInnerHash)};
        }
        ...
        if (Arrays.constantTimeAreEqual(m24731S1(this.digest, calculateU, calculateInnerHash2), bArr)) {
            return new byte[][]{kdf2, m24730S2(this.digest, calculateU, calculateInnerHash2)};
        }
    ...
    public void init(CipherParameters cipherParameters) {
        ...
        this.f74832w = (this.ecParams.getCurve().getFieldSize() / 2) - 1;
    }
