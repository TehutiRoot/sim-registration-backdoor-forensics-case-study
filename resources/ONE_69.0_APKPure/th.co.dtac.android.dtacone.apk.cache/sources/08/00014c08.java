...
/* renamed from: th.co.dtac.android.dtacone.view.fragment.eSIM.ESimCommonFragment$navigateNextToCommon$onExitCallback$1 */
/* loaded from: classes9.dex */
public final class ESimCommonFragment$navigateNextToCommon$onExitCallback$1 extends Lambda implements Function1<ExitCallbackState, Unit> {
    final /* synthetic */ ESimCommonFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimCommonFragment$navigateNextToCommon$onExitCallback$1(ESimCommonFragment eSimCommonFragment) {
        super(1);
    ...
    public final void invoke2(@NotNull ExitCallbackState state) {
        ...
        sb.append("onExitCallback: state = ");
        sb.append(json);
        if (state instanceof ExitCallbackState.UpPassForm) {
            ExitCallbackState.UpPassForm upPassForm = (ExitCallbackState.UpPassForm) state;
            UpPassFormType formType = upPassForm.getFormType();
            StringBuilder sb2 = new StringBuilder();
            sb2.append("onExitCallback: UpPassForm = ");
            sb2.append(formType);
            if (upPassForm.getFormType() instanceof UpPassFormType.Ocr) {
                this.this$0.m7819v();
                return;
            } else {
                this.this$0.m7820u();
