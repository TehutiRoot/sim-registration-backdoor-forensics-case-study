...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.mnp.fragment.OneMnpMailingFragment$getAddressFromOCRUpPassForTrueCompany$4 */
/* loaded from: classes10.dex */
public final class OneMnpMailingFragment$getAddressFromOCRUpPassForTrueCompany$4 extends Lambda implements Function1<String, Unit> {
    final /* synthetic */ OneMnpMailingFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OneMnpMailingFragment$getAddressFromOCRUpPassForTrueCompany$4(OneMnpMailingFragment oneMnpMailingFragment) {
        super(1);
    ...
    public final void invoke2(@NotNull String postCode) {
        ...
        oneFontTextView = this.this$0.f91530H;
        ...
        oneFontTextView2 = this.this$0.f91530H;
