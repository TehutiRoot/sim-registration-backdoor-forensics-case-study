...
public final class PropertiesConventionUtilKt {
    /* renamed from: a */
    public static final Name m28701a(Name name, String str, boolean z, String str2) {
        if (name.isSpecial()) {
            return null;
        }
        String identifier = name.getIdentifier();
        Intrinsics.checkNotNullExpressionValue(identifier, "methodName.identifier");
        if (!AbstractC19741eO1.startsWith$default(identifier, str, false, 2, null) || identifier.length() == str.length()) {
            return null;
        }
    ...
    /* renamed from: b */
    public static /* synthetic */ Name m28700b(Name name, String str, boolean z, String str2, int i, Object obj) {
        if ((i & 4) != 0) {
            z = true;
        }
        if ((i & 8) != 0) {
        ...
        return m28701a(name, str, z, str2);
    }
    ...
    public static final Name propertyNameByGetMethodName(@NotNull Name methodName) {
        ...
        Name m28700b = m28700b(methodName, "get", false, null, 12, null);
        if (m28700b == null) {
            return m28700b(methodName, "is", false, null, 8, null);
        }
        return m28700b;
    }
    ...
    public static final Name propertyNameBySetMethodName(@NotNull Name methodName, boolean z) {
        ...
        return m28700b(methodName, "set", false, str, 4, null);
    }
