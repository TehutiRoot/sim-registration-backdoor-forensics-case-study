...
public @interface JsonFormat {
    ...
    public static class Features {
        ...
        /* renamed from: c */
        public static final Features f43108c = new Features(0, 0);
        ...
        public boolean equals(Object obj) {
            ...
            if (features.f43109a == this.f43109a && features.f43110b == this.f43110b) {
                return true;
            }
            return false;
        }
        ...
        public Boolean get(Feature feature) {
            ...
            if ((this.f43110b & ordinal) != 0) {
                return Boolean.FALSE;
            }
            if ((ordinal & this.f43109a) != 0) {
                return Boolean.TRUE;
            }
            return null;
        }
        ...
        public int hashCode() {
            return this.f43110b + this.f43109a;
        }
        ...
        public Features with(Feature... featureArr) {
            ...
            return new Features(i, this.f43110b);
        }
        ...
        public Features withOverrides(Features features) {
            ...
            int i = features.f43110b;
            int i2 = features.f43109a;
            if (i == 0 && i2 == 0) {
                return this;
            }
            int i3 = this.f43109a;
            if (i3 == 0 && this.f43110b == 0) {
                return features;
            }
            int i4 = ((~i) & i3) | i2;
            int i5 = this.f43110b;
        ...
        public Features without(Feature... featureArr) {
            ...
            return new Features(this.f43109a, i);
        }
