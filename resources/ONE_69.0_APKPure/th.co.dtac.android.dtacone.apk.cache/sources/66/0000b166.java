...
public class FirebaseVisionDocumentText {
    ...
    /* renamed from: c */
    public static final FirebaseVisionDocumentText f55954c = new FirebaseVisionDocumentText("", new ArrayList());

    /* renamed from: a */
    public final String f55955a;

    /* renamed from: b */
    public final List f55956b;

    /* renamed from: com.google.firebase.ml.vision.document.FirebaseVisionDocumentText$Block */
    /* loaded from: classes4.dex */
    public static class Block extends C8554a {

        /* renamed from: f */
        public final List f55957f;
        ...
        /* renamed from: a */
        public static Block m38326a(zzkm zzkmVar, float f) {
            ...
            if (zzkmVar.getParagraphs() != null) {
                for (zzle zzleVar : zzkmVar.getParagraphs()) {
                    if (zzleVar != null) {
                        Paragraph m38324a = Paragraph.m38324a(zzleVar, f);
                        if (sb.length() != 0) {
                            sb.append("\n");
                        }
                        sb.append(m38324a.getText());
                        arrayList.add(m38324a);
                    }
                }
            }
        ...
        @Override // com.google.firebase.p015ml.vision.document.FirebaseVisionDocumentText.C8554a
        @Nullable
    ...
    /* loaded from: classes4.dex */
    public static class Paragraph extends C8554a {

        /* renamed from: f */
        public final List f55958f;
        ...
        /* renamed from: a */
        public static Paragraph m38324a(zzle zzleVar, float f) {
            ArrayList arrayList = new ArrayList();
            StringBuilder sb = new StringBuilder();
            ...
            if (zzleVar.getWords() != null) {
                for (zzlq zzlqVar : zzleVar.getWords()) {
                    if (zzlqVar != null) {
                        Word m38318a = Word.m38318a(zzlqVar, f);
                        sb.append(m38318a.getText());
                        sb.append(FirebaseVisionDocumentText.m38330b(m38318a.getRecognizedBreak()));
                        arrayList.add(m38318a);
                    }
                }
            }
    ...
    public static class RecognizedBreak {
        ...
        */
        public static com.google.firebase.p015ml.vision.document.FirebaseVisionDocumentText.RecognizedBreak m38322a(com.google.android.gms.internal.firebase_ml.zzln r8) {
            /*
                r0 = 4
                r1 = 3
                r2 = 2
            ...
            L8c:
                ...
                return r8
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.p015ml.vision.document.FirebaseVisionDocumentText.RecognizedBreak.m38322a(com.google.android.gms.internal.firebase_ml.zzln):com.google.firebase.ml.vision.document.FirebaseVisionDocumentText$RecognizedBreak");
        }
    ...
    /* loaded from: classes4.dex */
    public static class Symbol extends C8554a {
        public Symbol(List list, RecognizedBreak recognizedBreak, Rect rect, String str, Float f) {
            super(list, recognizedBreak, rect, str, f);
        }

        /* renamed from: a */
        public static Symbol m38320a(zzll zzllVar, float f) {
            return new Symbol(FirebaseVisionDocumentText.m38329c(zzllVar.zzis()), RecognizedBreak.m38322a(zzllVar.zzis()), zzry.zza(zzllVar.zzir(), f), zzry.zzcd(zzllVar.getText()), zzllVar.getConfidence());
        }
    ...
    /* loaded from: classes4.dex */
    public static class Word extends C8554a {

        /* renamed from: f */
        public final List f55961f;
        ...
        /* renamed from: a */
        public static Word m38318a(zzlq zzlqVar, float f) {
            ArrayList arrayList = new ArrayList();
            StringBuilder sb = new StringBuilder();
            ...
            if (zzlqVar.getSymbols() != null) {
                for (zzll zzllVar : zzlqVar.getSymbols()) {
                    if (zzllVar != null) {
                        Symbol m38320a = Symbol.m38320a(zzllVar, f);
                        RecognizedBreak recognizedBreak2 = m38320a.getRecognizedBreak();
                        sb.append(m38320a.getText());
                        arrayList.add(Symbol.m38320a(zzllVar, f));
    ...
    /* loaded from: classes4.dex */
    public static class C8554a {

        /* renamed from: a */
        public final List f55962a;

        /* renamed from: b */
        public final RecognizedBreak f55963b;

        /* renamed from: c */
        public final Rect f55964c;
        ...
        public C8554a(List list, RecognizedBreak recognizedBreak, Rect rect, String str, Float f) {
            this.f55965d = str;
            this.f55962a = list;
            this.f55963b = recognizedBreak;
            this.f55964c = rect;
            this.f55966e = f;
        }
    ...
    /* renamed from: a */
    public static FirebaseVisionDocumentText m38331a(zzlk zzlkVar, float f) {
        if (zzlkVar == null) {
            return f55954c;
        }
            ...
            for (zzlf zzlfVar : zzlkVar.getPages()) {
                if (zzlfVar != null) {
                    for (zzkm zzkmVar : zzlfVar.getBlocks()) {
                        if (zzkmVar != null) {
                            arrayList.add(Block.m38326a(zzkmVar, f));
                        }
                    }
                }
            }
    ...
    /* renamed from: b */
    public static String m38330b(RecognizedBreak recognizedBreak) {
    ...
    /* renamed from: c */
    public static List m38329c(zzln zzlnVar) {
        if (zzlnVar == null) {
            return zzmx.zzju();
        }
        ArrayList arrayList = new ArrayList();
