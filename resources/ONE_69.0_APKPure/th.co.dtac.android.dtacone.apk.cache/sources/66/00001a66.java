...
public class ComponentDialog extends Dialog implements LifecycleOwner, OnBackPressedDispatcherOwner, SavedStateRegistryOwner {
    ...
    /* renamed from: a */
    public static /* synthetic */ void m64737a(ComponentDialog componentDialog) {
        m64735c(componentDialog);
    }

    /* renamed from: b */
    private final LifecycleRegistry m64736b() {
        LifecycleRegistry lifecycleRegistry = this.f8749a;
        if (lifecycleRegistry == null) {
            LifecycleRegistry lifecycleRegistry2 = new LifecycleRegistry(this);
            this.f8749a = lifecycleRegistry2;
    ...
    /* renamed from: c */
    public static final void m64735c(ComponentDialog this$0) {
    ...
    public SavedStateRegistry getSavedStateRegistry() {
        return this.f8750b.getSavedStateRegistry();
    }
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            OnBackPressedDispatcher onBackPressedDispatcher = this.f8751c;
            onBackInvokedDispatcher = getOnBackInvokedDispatcher();
            Intrinsics.checkNotNullExpressionValue(onBackInvokedDispatcher, "onBackInvokedDispatcher");
            onBackPressedDispatcher.setOnBackInvokedDispatcher(onBackInvokedDispatcher);
        }
        this.f8750b.performRestore(bundle);
        m64736b().handleLifecycleEvent(Lifecycle.Event.ON_CREATE);
    }
    ...
    public Bundle onSaveInstanceState() {
        ...
        this.f8750b.performSave(onSaveInstanceState);
    ...
    public void onStart() {
        super.onStart();
        m64736b().handleLifecycleEvent(Lifecycle.Event.ON_RESUME);
    }

    @Override // android.app.Dialog
    @CallSuper
    public void onStop() {
        m64736b().handleLifecycleEvent(Lifecycle.Event.ON_DESTROY);
        this.f8749a = null;
        super.onStop();
    }
    ...
    public ComponentDialog(@NotNull Context context, @StyleRes int i) {
        super(context, i);
        Intrinsics.checkNotNullParameter(context, "context");
        this.f8750b = SavedStateRegistryController.Companion.create(this);
        this.f8751c = new OnBackPressedDispatcher(new Runnable() { // from class: Wu
            @Override // java.lang.Runnable
            public final void run() {
                ComponentDialog.m64737a(ComponentDialog.this);
            }
        });
    }
