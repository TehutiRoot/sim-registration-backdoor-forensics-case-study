...
public class PDShadingPattern extends PDAbstractPattern {
    ...
    /* renamed from: b */
    public PDExtendedGraphicsState f60524b;

    /* renamed from: c */
    public PDShading f60525c;
    ...
    public PDExtendedGraphicsState getExtendedGraphicsState() {
        if (this.f60524b == null) {
            ...
            if (dictionaryObject instanceof COSDictionary) {
                this.f60524b = new PDExtendedGraphicsState((COSDictionary) dictionaryObject);
            }
        }
        return this.f60524b;
    }
    ...
    public PDShading getShading() throws IOException {
        if (this.f60525c == null) {
            ...
            if (dictionaryObject instanceof COSDictionary) {
                this.f60525c = PDShading.create((COSDictionary) dictionaryObject);
            }
        }
        return this.f60525c;
    }
