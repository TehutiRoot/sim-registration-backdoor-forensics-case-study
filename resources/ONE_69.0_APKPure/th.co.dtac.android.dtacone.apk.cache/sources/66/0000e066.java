...
public final class Name implements Comparable<Name> {
    ...
    /* renamed from: a */
    public static /* synthetic */ void m28307a(int i) {
    ...
    public boolean equals(Object obj) {
        ...
        Name name = (Name) obj;
        if (this.f69639b == name.f69639b && this.f69638a.equals(name.f69638a)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.f69638a.hashCode() * 31) + (this.f69639b ? 1 : 0);
    }
    ...
    public int compareTo(Name name) {
        return this.f69638a.compareTo(name.f69638a);
    }
}