...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.mrtr_postpaid_registration.MrtrPostpaidPackagesViewModel$getAllPackageGroupBranded$3 */
/* loaded from: classes9.dex */
public final class MrtrPostpaidPackagesViewModel$getAllPackageGroupBranded$3 extends Lambda implements Function1<MrtrBrandedAllPackageGroupResponse, Unit> {
    final /* synthetic */ MrtrPostpaidPackagesViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MrtrPostpaidPackagesViewModel$getAllPackageGroupBranded$3(MrtrPostpaidPackagesViewModel mrtrPostpaidPackagesViewModel) {
        super(1);
    ...
    public final void invoke2(MrtrBrandedAllPackageGroupResponse mrtrBrandedAllPackageGroupResponse) {
        ...
        mrtrPostpaidRepository = this.this$0.f106402b;
        mrtrPostpaidRepository.setPackageGroupRefNo(mrtrBrandedAllPackageGroupResponse.getPackageGroupRefNo());
