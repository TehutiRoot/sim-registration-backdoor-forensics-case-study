...
public abstract class AbstractCollectionSerializer<Element, Collection, Builder> implements KSerializer<Collection> {
    ...
    /* renamed from: a */
    public final int m27010a(CompositeDecoder compositeDecoder, Object obj) {
    ...
    public final Collection merge(@NotNull Decoder decoder, @Nullable Collection collection) {
        ...
        if (!beginStructure.decodeSequentially()) {
            ...
            readAll(beginStructure, builder, builderSize, m27010a(beginStructure, builder));
        }
