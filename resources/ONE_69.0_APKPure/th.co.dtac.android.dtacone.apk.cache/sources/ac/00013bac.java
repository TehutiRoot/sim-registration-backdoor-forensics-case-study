...
/* renamed from: th.co.dtac.android.dtacone.view.appOne.pre2post.viewModel.OnePre2PostViewModel$getForms$2 */
/* loaded from: classes10.dex */
public final class OnePre2PostViewModel$getForms$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ OnePre2PostViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OnePre2PostViewModel$getForms$2(OnePre2PostViewModel onePre2PostViewModel) {
        super(1);
    ...
    public final void invoke2(@NotNull Throwable throwable) {
        ...
        m10878V0.setValue(Resource.Companion.error$default(Resource.Companion, "", null, null, 4, null));
