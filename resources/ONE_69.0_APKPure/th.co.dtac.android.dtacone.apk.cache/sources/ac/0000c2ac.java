...
public class PDInkAppearanceHandler extends PDAbstractAppearanceHandler {
    ...
    public void generateNormalAppearance() {
        ...
        if (color != null && color.getComponents().length != 0) {
            C0978O4 m67156a = C0978O4.m67156a(pDAnnotationMarkup, pDAnnotationMarkup.getBorderStyle());
            if (Float.compare(m67156a.f4357c, 0.0f) == 0) {
                return;
            }
            ...
            rectangle.setLowerLeftX(Math.min(f3 - (m67156a.f4357c * 2.0f), rectangle.getLowerLeftX()));
            rectangle.setLowerLeftY(Math.min(f4 - (m67156a.f4357c * 2.0f), rectangle.getLowerLeftY()));
            rectangle.setUpperRightX(Math.max(f + (m67156a.f4357c * 2.0f), rectangle.getUpperRightX()));
            rectangle.setUpperRightY(Math.max(f2 + (m67156a.f4357c * 2.0f), rectangle.getUpperRightY()));
