...
public final class LottieAnimationKt {
    ...
    public static final void LottieAnimation(@Nullable LottieComposition lottieComposition, @NotNull Function0<Float> progress, @Nullable Modifier modifier, boolean z, boolean z2, boolean z3, @Nullable RenderMode renderMode, boolean z4, @Nullable LottieDynamicProperties lottieDynamicProperties, @Nullable Alignment alignment, @Nullable ContentScale contentScale, boolean z5, @Nullable Map<String, ? extends Typeface> map, @Nullable Composer composer, int i, int i2, int i3) {
        ...
        if (rememberedValue3 == companion2.getEmpty()) {
            rememberedValue3 = AbstractC19036aL1.m65148g(null, null, 2, null);
        ...
        if (lottieComposition != null && lottieComposition.getDuration() != 0.0f) {
            ...
            CanvasKt.Canvas(SizeKt.m69750sizeVpY3zN4(companion, C3623Dp.m73842constructorimpl(lottieComposition.getBounds().width() / dpScale), C3623Dp.m73842constructorimpl(lottieComposition.getBounds().height() / dpScale)), new LottieAnimationKt$LottieAnimation$2(lottieComposition, fit, center, matrix, lottieDrawable, z8, renderMode2, map2, lottieDynamicProperties2, z6, z7, z9, z10, progress, mutableState), startRestartGroup, 0);
    ...
    /* renamed from: a */
    public static final LottieDynamicProperties m50821a(MutableState mutableState) {
        return (LottieDynamicProperties) mutableState.getValue();
    }

    /* renamed from: b */
    public static final void m50820b(MutableState mutableState, LottieDynamicProperties lottieDynamicProperties) {
        mutableState.setValue(lottieDynamicProperties);
    }

    /* renamed from: c */
    public static final float m50819c(LottieAnimationState lottieAnimationState) {
        return lottieAnimationState.getValue().floatValue();
    }

    /* renamed from: d */
    public static final long m50818d(long j, long j2) {
        return IntSizeKt.IntSize((int) (Size.m71755getWidthimpl(j) * ScaleFactor.m73053getScaleXimpl(j2)), (int) (Size.m71752getHeightimpl(j) * ScaleFactor.m73054getScaleYimpl(j2)));
    }

    @Deprecated(message = "Pass progress as a lambda instead of a float. This overload will be removed in the next release.")
    @Composable
    public static final void LottieAnimation(@Nullable LottieComposition lottieComposition, @FloatRange(from = 0.0d, m64694to = 1.0d) float f, @Nullable Modifier modifier, boolean z, boolean z2, boolean z3, @Nullable RenderMode renderMode, boolean z4, @Nullable LottieDynamicProperties lottieDynamicProperties, @Nullable Alignment alignment, @Nullable ContentScale contentScale, boolean z5, @Nullable Composer composer, int i, int i2, int i3) {
