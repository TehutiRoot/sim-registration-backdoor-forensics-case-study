...
public abstract class AbstractC18244Os1 {

    /* renamed from: a */
    public static final CodecRegistry f4599a = CodecRegistries.fromProviders(new BsonValueCodecProvider());

    /* renamed from: a */
    public static BsonValue m67033a(byte[] bArr, BsonBinaryReader bsonBinaryReader) {
        ...
        if (currentBsonType != bsonType && bsonBinaryReader.getCurrentBsonType() != BsonType.ARRAY) {
            return (BsonValue) f4599a.get(BsonValueCodecProvider.getClassForBsonType(bsonBinaryReader.getCurrentBsonType())).decode(bsonBinaryReader, DecoderContext.builder().build());
        }
