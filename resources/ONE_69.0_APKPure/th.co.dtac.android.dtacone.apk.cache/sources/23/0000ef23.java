...
public abstract class DirectoryWalker<T> {
    ...
    /* renamed from: a */
    public final FileFilter f73313a;
    ...
    /* renamed from: a */
    public final void m25619a(File file, int i, Collection collection) {
        ...
        if (handleDirectory(file, i, collection)) {
            ...
            if (i3 < 0 || i2 <= i3) {
                checkIfCancelled(file, i, collection);
                File[] filterDirectoryContents = filterDirectoryContents(file, i, file.listFiles(this.f73313a));
                if (filterDirectoryContents == null) {
                    handleRestricted(file, i2, collection);
                } else {
                    for (File file2 : filterDirectoryContents) {
                        if (file2.isDirectory()) {
                            m25619a(file2, i2, collection);
                        } else {
    ...
    public DirectoryWalker(IOFileFilter iOFileFilter, IOFileFilter iOFileFilter2, int i) {
        if (iOFileFilter == null && iOFileFilter2 == null) {
            ...
            this.f73313a = FileFilterUtils.makeDirectoryOnly(iOFileFilter == null ? TrueFileFilter.TRUE : iOFileFilter).mo25431or(FileFilterUtils.makeFileOnly(iOFileFilter2 == null ? TrueFileFilter.TRUE : iOFileFilter2));
        }
        this.f73314b = i;
    }
