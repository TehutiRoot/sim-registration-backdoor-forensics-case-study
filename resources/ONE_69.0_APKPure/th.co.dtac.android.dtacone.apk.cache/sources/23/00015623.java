...
/* renamed from: th.co.dtac.android.dtacone.viewmodel.esim.ESimPostpaidViewModel$callAPICheckExternalBlacklistFlag$3 */
/* loaded from: classes9.dex */
public final class ESimPostpaidViewModel$callAPICheckExternalBlacklistFlag$3 extends Lambda implements Function1<CheckExternalBlacklistFlagResponse, Unit> {
    final /* synthetic */ ESimPostpaidViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ESimPostpaidViewModel$callAPICheckExternalBlacklistFlag$3(ESimPostpaidViewModel eSimPostpaidViewModel) {
        super(1);
    ...
    public final void invoke2(CheckExternalBlacklistFlagResponse checkExternalBlacklistFlagResponse) {
        ...
        eSimRepository.setBlacklistFlag(checkExternalBlacklistFlagResponse.getBlacklistFlag());
