...
public final class ComparisonsKt__ComparisonsKt$thenBy$1<T> implements Comparator {
    ...
    /* renamed from: a */
    public final /* synthetic */ Comparator f68201a;

    /* renamed from: b */
    public final /* synthetic */ Function1 f68202b;

    public ComparisonsKt__ComparisonsKt$thenBy$1(Comparator<T> comparator, Function1<? super T, ? extends Comparable<?>> function1) {
        this.f68201a = comparator;
        this.f68202b = function1;
    }

    @Override // java.util.Comparator
    public final int compare(T t, T t2) {
        int compare = this.f68201a.compare(t, t2);
        if (compare == 0) {
            Function1 function1 = this.f68202b;
            return AbstractC16870uu.compareValues((Comparable) function1.invoke(t), (Comparable) function1.invoke(t2));
        }
        return compare;
    }
}