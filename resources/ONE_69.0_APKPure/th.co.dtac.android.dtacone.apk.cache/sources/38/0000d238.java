...
public final class ObservableSampleTimed<T> extends AbstractC11078a {

    /* renamed from: a */
    public final long f65537a;

    /* renamed from: b */
    public final TimeUnit f65538b;

    /* renamed from: c */
    public final Scheduler f65539c;
    ...
    public ObservableSampleTimed(ObservableSource<T> observableSource, long j, TimeUnit timeUnit, Scheduler scheduler, boolean z) {
        ...
        this.f65537a = j;
        this.f65538b = timeUnit;
        this.f65539c = scheduler;
        this.f65540d = z;
    }
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        if (this.f65540d) {
            this.source.subscribe(new SampleTimedEmitLast(serializedObserver, this.f65537a, this.f65538b, this.f65539c));
        } else {
            this.source.subscribe(new SampleTimedNoLast(serializedObserver, this.f65537a, this.f65538b, this.f65539c));
        }
    }
}