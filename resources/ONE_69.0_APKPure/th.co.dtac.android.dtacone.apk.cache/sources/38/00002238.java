...
public final class EnterExitTransitionKt$createModifier$1$1 extends Lambda implements Function1<GraphicsLayerScope, Unit> {
    ...
    public final void invoke2(@NotNull GraphicsLayerScope graphicsLayer) {
        ...
        m61692b = EnterExitTransitionKt.m61692b(this.$scale$delegate);
        graphicsLayer.setScaleX(m61692b);
        m61692b2 = EnterExitTransitionKt.m61692b(this.$scale$delegate);
        graphicsLayer.setScaleY(m61692b2);
        m61691c = EnterExitTransitionKt.m61691c(this.$transformOrigin$delegate);
        graphicsLayer.mo72075setTransformOrigin__ExYCQ(m61691c);
    }
}