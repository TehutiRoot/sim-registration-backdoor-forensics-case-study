...
@DebugMetadata(m29093c = "androidx.compose.foundation.gestures.DefaultTransformableState$transform$2", m29092f = "TransformableState.kt", m29091i = {}, m29090l = {249}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
...
public final class DefaultTransformableState$transform$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    @Metadata(m29143d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, m29142d2 = {"<anonymous>", "", "Landroidx/compose/foundation/gestures/TransformScope;"}, m29141k = 3, m29140mv = {1, 8, 0}, m29138xi = 48)
    @DebugMetadata(m29093c = "androidx.compose.foundation.gestures.DefaultTransformableState$transform$2$1", m29092f = "TransformableState.kt", m29091i = {}, m29090l = {252}, m29089m = "invokeSuspend", m29088n = {}, m29087s = {})
    /* renamed from: androidx.compose.foundation.gestures.DefaultTransformableState$transform$2$1 */
    /* loaded from: classes.dex */
    public static final class C27771 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ Function2<TransformScope, Continuation<? super Unit>, Object> $block;
        ...
        public C27771(DefaultTransformableState defaultTransformableState, Function2<? super TransformScope, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super C27771> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C27771 c27771 = new C27771(this.this$0, this.$block, continuation);
            c27771.L$0 = obj;
            return c27771;
        }
        ...
        public final Object invoke(@NotNull TransformScope transformScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C27771) create(transformScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            try {
                if (i != 0) {
                    ...
                    mutableState2 = this.this$0.f13048d;
                ...
                mutableState3 = this.this$0.f13048d;
                mutableState3.setValue(Boxing.boxBoolean(false));
                return Unit.INSTANCE;
            } catch (Throwable th2) {
                mutableState = this.this$0.f13048d;
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i != 0) {
            ...
            ResultKt.throwOnFailure(obj);
            mutatorMutex = this.this$0.f13047c;
            transformScope = this.this$0.f13046b;
            MutatePriority mutatePriority = this.$transformPriority;
            C27771 c27771 = new C27771(this.this$0, this.$block, null);
            this.label = 1;
            if (mutatorMutex.mutateWith(transformScope, mutatePriority, c27771, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        }
        return Unit.INSTANCE;
